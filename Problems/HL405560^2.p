...
thf(conj_thm_2Eordinal_2Epreds__11,lemma,(
    ! [A_27a: del,V0w1: $i] :
      ( ( mem @ V0w1 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1w2: $i] :
          ( ( mem @ V1w2 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ( ( ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0w1 )
              = ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1w2 ) )
          <=> ( V0w1 = V1w2 ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Epreds__lt__PSUBSET,conjecture,(
    ! [A_27a: del,V0w1: $i] :
      ( ( mem @ V0w1 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1w2: $i] :
          ( ( mem @ V1w2 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
