...
thf(f13500_0_2E0,type,(
    f13500_0_2E0: u )).

thf(f13500_0_2E1,type,(
    f13500_0_2E1: du > u )).

thf(f13500_0_2E2,type,(
    f13500_0_2E2: du > du > u )).

thf(f13501_0_2E0,type,(
    f13501_0_2E0: u )).

thf(f13501_0_2E1,type,(
    f13501_0_2E1: du > u )).

thf(f13501_0_2E2,type,(
    f13501_0_2E2: du > du > u )).

thf(f13501_1_2E0,type,(
    f13501_1_2E0: u )).

thf(f13501_1_2E1,type,(
    f13501_1_2E1: du > u )).

thf(f13501_1_2E2,type,(
...
thf(mono_2Ef13500_0,type,(
    mono_2Ef13500_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13501_0,type,(
    mono_2Ef13501_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13501_1,type,(
    mono_2Ef13501_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__LT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13501_1 @ V0a @ V2x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V2x @ ( mono_2Ec_2Ereal_2Ereal__lte @ V2x @ V0a ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__LT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13501_0 @ V0a @ V1x )
...
thf(thm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__LT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Eclosure @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13501_0 @ V0a ) ) )
      = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13501_1 @ V0a ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13500_0 @ V0a @ V1x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1x @ ( mono_2Ec_2Erealax_2Ereal__lt @ V1x @ V0a ) ) ) )).

thf(thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LT,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( (~) @ ( mono_2Ec_2Ereal__topology_2Ebounded__def @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13500_0 @ V0a ) ) ) ) )).
