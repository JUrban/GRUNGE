...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__3__EXPAND,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EBETWEEN__REFL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EBETWEEN__IMP__COLLINEAR,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__BETWEEN__CASES,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
