...
thf(stp_fo_c_2Emarker_2E_3A_2D,type,(
    fo__c_2Emarker_2E_3A_2D: tp__i > $o > $o )).

thf(stp_eq_fo_c_2Emarker_2E_3A_2D,axiom,(
    ! [X0: tp__i,X1: $o] :
      ( ( inj__o @ ( fo__c_2Emarker_2E_3A_2D @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Emarker_2E_3A_2D @ ( inj__i @ X0 ) ) @ ( inj__o @ X1 ) ) ) )).
...
thf(conj_thm_2Esorting_2EPERM__SWAP__AT__FRONT,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ A_27a )
