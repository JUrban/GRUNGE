...
fof(conj_thm_2Erich__list_2Elongest__prefix__EMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(c_2Erich__list_2Elongest__prefix(A_27a),c_2Epred__set_2EEMPTY(ty_2Elist_2Elist(A_27a))) = c_2Elist_2ENIL(A_27a) ) )).
