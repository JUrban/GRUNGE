...
tff(lameq_f4010,axiom,(
    ! [V1f: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Enum_2Enum,bool))
         => ! [V2l: tp__ty_2Erealax_2Ereal] : ap(f4010(V1f,V0s),inj__ty_2Erealax_2Ereal(V2l)) = ap(ap(ap(c_2Ereal__topology_2Esums,V1f),inj__ty_2Erealax_2Ereal(V2l)),V0s) ) ) )).

tff(ax_thm_2Ereal__topology_2Einfsum,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V0s),V1f)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f4010(V1f,V0s))) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EINFSUM__EQ,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2k),V0f))
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V2k),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V2k),V1g)) ) ) ) ) )).
