...
fof(lamtp_f3749,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l] :
          ( mem(V2l,ty_2Erealax_2Ereal)
         => mem(f3749(A_27a,V1f,V2l),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3749,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l] :
          ( mem(V2l,ty_2Erealax_2Ereal)
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3749(A_27a,V1f,V2l),V3x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V1f,V3x)),V2l) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__NULL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
         ...
         => ! [V1f] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),V2l),V0net))
                  <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3749(A_27a,V1f,V2l)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net)) ) ) ) ) ) )).
