...
fof(conj_thm_2Epred__set_2EPREIMAGE__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Emeasure_2ESIGMA__PROPERTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0sp] :
          ( mem(V0sp,arr(A_27a,bool))
...
fof(conj_thm_2Emeasure_2EMEASURABLE__SIGMA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
