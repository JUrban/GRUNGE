...
thf(ax_thm_2Eutil__prob_2Edisjoint__def,axiom,(
    ! [A_27a: del,V0A: $i] :
...
thf(conj_thm_2Eutil__prob_2Edisjoint__union,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1B: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Eutil__prob_2Edisjoint @ A_27a ) @ V0A ) )
              ...
              & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ V0A ) ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ V1B ) )
                = ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
