...
fof(conj_thm_2Epath_2Enth__label__pmap,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V1g] :
                         ...
                         => ! [V2i] :
                             ...
                             => ! [V3p] :
                                 ...
                                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Enum_2ESUC,V2i)),ap(c_2Epath_2EPL(A_27a,A_27a),V3p)))
                                   => ap(ap(c_2Epath_2Enth__label(A_27c,A_27c),V2i),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V3p)) = ap(V1g,ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V2i),V3p)) ) ) ) ) ) ) ) ) ) )).
