...
tff(conj_thm_2Earithmetic_2EMIN__COMM,lemma,(
...
tff(conj_thm_2Earithmetic_2EMIN__ASSOC,lemma,(
...
tff(ax_thm_2Ewords_2Ew2w__def,axiom,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
     ...
     => ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w) = ap(c_2Ewords_2En2w(A_27b),ap(c_2Ewords_2Ew2n(A_27a),V0w)) ) )).
...
tff(conj_thm_2Ewords_2Eword__bits__w2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1h: tp__ty_2Enum_2Enum,V2l: tp__ty_2Enum_2Enum] : ap(ap(ap(c_2Ewords_2Eword__bits(A_27b),inj__ty_2Enum_2Enum(V1h)),inj__ty_2Enum_2Enum(V2l)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2EMIN,inj__ty_2Enum_2Enum(V1h)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Enum_2Enum(V2l)),V0w)) ) )).
