...
thf(conj_thm_2Eproduct_2EPRODUCT__INV,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
         ...
         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
           => ( ( surj__ty_2Erealax_2Ereal
                @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ c_2Erealax_2Einv @ ( ap @ V0f @ V2x ) ) ) ) )
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Einv @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s ) @ V0f ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eproduct_2EPRODUCT__DIV,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
