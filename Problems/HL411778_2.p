...
tff(lameq_f4033,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3i: tp__ty_2Enum_2Enum] : ap(f4033(V0x,V1y),inj__ty_2Enum_2Enum(V3i)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,inj__ty_2Enum_2Enum(V3i))),ap(V1y,inj__ty_2Enum_2Enum(V3i))) ) ) )).

tff(conj_thm_2Ereal__topology_2EINFSUM__SUB,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2s),V0x))
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V2s),f4033(V0x,V1y))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal__topology_2Einfsum,V2s),V0x)),ap(ap(c_2Ereal__topology_2Einfsum,V2s),V1y))) ) ) ) ) )).
