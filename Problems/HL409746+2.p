...
fof(conj_thm_2Eiterate_2ENSUM__MULTICOUNT__GEN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eiterate_2ENSUM__MULTICOUNT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2t] :
                     ...
                     => ! [V3k] :
                         ...
                         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                           ...
                           => ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3326(A_27b,A_27a,V2t,V0R)) = ap(ap(c_2Earithmetic_2E_2A,V3k),ap(c_2Epred__set_2ECARD(A_27b),V2t)) ) ) ) ) ) ) ) )).
