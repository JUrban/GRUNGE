...
fof(mem_c_2Efcp_2EFCP__MAP,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efcp_2EFCP__MAP(A_27a,A_27a,A_27a),arr(arr(A_27a,A_27b),arr(ty_2Efcp_2Ecart(A_27a,A_27a),ty_2Efcp_2Ecart(A_27b,A_27b)))) ) ) ) )).
...
fof(lameq_f1096,axiom,(
    ! [A_27a,A_27c,A_27b,V1v] :
     ...
     => ! [V0f] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f1096(A_27a,A_27c,A_27b,V1v,V0f),V2i) = ap(V0f,ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1v),V2i)) ) ) ) )).
...
fof(conj_thm_2Efcp_2EFCP__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
