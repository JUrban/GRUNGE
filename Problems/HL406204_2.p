...
tff(lmtp_f2250,type,(
    f2250: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * tp__o ) > $i )).

tff(lamtp_f2250,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o] : mem(f2250(A_27a,V0a,V1b,V2sa),arr(bool,bool)) )).

tff(lameq_f2250,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o,V3sb: tp__o] : ap(f2250(A_27a,V0a,V1b,V2sa),inj__o(V3sb)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(bool),inj__o(V2sa)),inj__o(V3sb))),ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V0a)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1b)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))))),ap(ap(c_2Ebool_2E_2F_5C,inj__o(V2sa)),ap(c_2Ebool_2E_7E,inj__o(V3sb)))) )).

tff(lmtp_f2249,type,(
    f2249: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2249,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] : mem(f2249(A_27a,V0a,V1b),arr(bool,arr(bool,bool))) )).

tff(lameq_f2249,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o] : ap(f2249(A_27a,V0a,V1b),inj__o(V2sa)) = f2250(A_27a,V0a,V1b,V2sa) )).

tff(conj_thm_2Ewords_2Eword__lt__n2w,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__LT__EQ__LO,conjecture,(
    ! [A_27a: del,V0x: $i] :
