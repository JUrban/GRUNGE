...
tff(conj_thm_2Earithmetic_2ELE__MULT__CANCEL__RBARE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ewords_2EZERO__LT__INT__MAX,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Ewords_2EWORD__SUB__ADD,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__SUB__INTRO,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0x: $i] :
...
tff(conj_thm_2Ewords_2Eword__T__not__zero,lemma,(
...
tff(conj_thm_2Elift__ieee_2Eerror__is__zero,lemma,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
      ( mem(V0a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
...
tff(conj_thm_2Elift__ieee_2Erelative__error,conjecture,(
    ! [A_27t: del,A_27w: del,V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Elift__ieee_2Enormalizes(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),inj__ty_2Erealax_2Ereal(V0x)))
