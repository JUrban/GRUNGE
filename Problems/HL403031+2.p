...
fof(mem_c_2EindexedLists_2EdelN,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EindexedLists_2EdelN(A_27a),arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))) ) )).

fof(conj_thm_2EindexedLists_2ELT__SUC,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Enum_2ESUC,V1m)))
          <=> ( V0n = c_2Enum_2E0
              | ? [V2n0] :
                  ( mem(V2n0,ty_2Enum_2Enum)
                  & V0n = ap(c_2Enum_2ESUC,V2n0)
                  & p(ap(ap(c_2Eprim__rec_2E_3C,V2n0),V1m)) ) ) ) ) ) )).

fof(ax_thm_2EindexedLists_2EdelN__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0i] :
            ( mem(V0i,ty_2Enum_2Enum)
           => ap(ap(c_2EindexedLists_2EdelN(A_27a),V0i),c_2Elist_2ENIL(A_27a)) = c_2Elist_2ENIL(A_27a) )
        & ! [V1i] :
           ...
           => ! [V2h] :
               ...
               => ! [V3t] :
                   ...
                   => ap(ap(c_2EindexedLists_2EdelN(A_27a),V1i),ap(ap(c_2Elist_2ECONS(A_27a),V2h),V3t)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1i),c_2Enum_2E0)),V3t),ap(ap(c_2Elist_2ECONS(A_27a),V2h),ap(ap(c_2EindexedLists_2EdelN(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3t))) ) ) ) ) ) )).

fof(conj_thm_2EindexedLists_2EdelN__shortens,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
         ...
         => ! [V1i] :
              ( mem(V1i,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V1i),ap(c_2Elist_2ELENGTH(A_27a),V0l)))
               => ap(c_2Elist_2ELENGTH(A_27a),ap(ap(c_2EindexedLists_2EdelN(A_27a),V1i),V0l)) = ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V0l)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) ) ) ) ) )).
