...
tff(lmtp_f4036,type,(
    f4036: ( tp__ty_2Erealax_2Ereal * $i * $i ) > $i )).

tff(lamtp_f4036,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1x: $i] :
      ( mem(V1x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Enum_2Enum,bool))
         => mem(f4036(V2e,V1x,V0s),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f4036,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1x: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Enum_2Enum,bool))
         => ! [V3n: tp__ty_2Enum_2Enum] : ap(f4036(V2e,V1x,V0s),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3n)),V0s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(V1x,inj__ty_2Enum_2Enum(V3n)))),inj__ty_2Erealax_2Ereal(V2e))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__GOESTOZERO,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1x: $i] :
          ( mem(V1x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( p(ap(ap(c_2Ereal__topology_2Esummable,V0s),V1x))
           => ! [V2e: tp__ty_2Erealax_2Ereal] :
               ...
               => p(ap(ap(c_2Ereal__topology_2Eeventually(ty_2Enum_2Enum),f4036(V2e,V1x,V0s)),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).
