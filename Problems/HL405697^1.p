...
thf(arityeq2_2Emono_2Ec_2Ewellorder_2Eorderlt_2E2_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderlt_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) ) )
...
thf(thm_2Eordinal_2Eordlt__SUC,axiom,(
    ! [A_27a: d,V0a_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) ) ) ) ) )).

thf(thm_2Eordinal_2Eordlt__SUC__DISCRETE,axiom,(
    ! [A_27a: d,V0b_2E0: u,V1a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) )
        | ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 )
          = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) ) )).

thf(thm_2Eordinal_2Epredimage__suplt__ELIM,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1b_2E0: u,V2a_2E0: u] :
     ...
     => ! [V3d_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3d_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2a_2E0 ) ) ) )
         => ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3d_2E0 ) ) ) ) ) ) ) ) ) )).

thf(thm_2Eordinal_2Eomax__NONE,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2Eomax_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) )
    <=> ! [V1a_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
         => ? [V2b_2E0: u] :
...
thf(thm_2Eordinal_2Eislimit__SUC__lt,axiom,(
    ! [A_27a: d,V0b_2E0: u,V1a_2E0: u] :
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2Eomax_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eordinal_2Epreds_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) ) ) )).
...
thf(thm_2Ewellorder_2Eorderlt__REFL,axiom,(
    ! [A_27a: d,V0w_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderlt_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2EF ) )).
...
thf(thm_2Eordinal_2Ex__le__ordEXP__x,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) ) )
     => ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordEXP_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1x_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1x_2E0 ) ) ) ) ) ) )).
