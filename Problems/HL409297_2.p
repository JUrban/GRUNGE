...
tff(conj_thm_2Elift__ieee_2Eis__finite__closest,lemma,(
...
tff(conj_thm_2Elift__ieee_2Efloat__round__finite,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: tp__o,V1x: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),inj__o(V0b)),inj__ty_2Erealax_2Ereal(V1x)))) ) )).
