...
fof(conj_thm_2Eextreal_2Emin__le,lemma,(
    ! [V0z] :
...
fof(conj_thm_2Eextreal_2Emin__le2,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(c_2Eextreal_2Eextreal__min,V0x),V1y)),V1y)) ) ) )).
