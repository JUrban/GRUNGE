...
fof(ax_thm_2Epred__set_2EBIGUNION,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
...
fof(lamtp_f281,axiom,(
    ! [A_27a,V0sp] :
      ( mem(V0sp,arr(A_27a,bool))
     => mem(f281(A_27a,V0sp),arr(arr(A_27a,bool),arr(A_27a,bool))) ) )).

fof(lameq_f281,axiom,(
    ! [A_27a,V0sp] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V2u] :
          ( mem(V2u,arr(A_27a,bool))
         => ap(f281(A_27a,V0sp),V2u) = ap(ap(c_2Epred__set_2EDIFF(A_27a),V0sp),V2u) ) ) )).

fof(conj_thm_2Epred__set_2EDIFF__BIGINTER1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0sp] :
          ( mem(V0sp,arr(A_27a,bool))
