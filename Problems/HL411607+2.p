...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EMPTY,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EEXTENSION__FROM__CLOPEN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
             ...
             => ! [V3u] :
                 ...
                 => ( ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V2t))
                   ...
                   => ? [V4g] :
                        ...
                        & ! [V5x] :
                            ( mem(V5x,ty_2Erealax_2Ereal)
                           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V2t))
                             => ap(V4g,V5x) = ap(V0f,V5x) ) ) ) ) ) ) ) ) )).
