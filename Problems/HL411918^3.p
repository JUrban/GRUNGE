...
thf(c_2Ereal__topology_2Ecauchy,type,(
    c_2Ereal__topology_2Ecauchy: ( tyop_2Enum_2Enum > tyop_2Erealax_2Ereal ) > $o )).
...
thf(thm_2Ereal__topology_2Ecompact,axiom,(
    ...
    <=> ! [V1f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
          ( ! [V2n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V1f @ V2n ) @ V0s )
         => ? [V3l: tyop_2Erealax_2Ereal,V4r: tyop_2Enum_2Enum > tyop_2Enum_2Enum] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3l @ V0s )
              & ! [V5m: tyop_2Enum_2Enum,V6n: tyop_2Enum_2Enum] :
                  ( ( c_2Eprim__rec_2E_3C @ V5m @ V6n )
                 => ( c_2Eprim__rec_2E_3C @ ( V4r @ V5m ) @ ( V4r @ V6n ) ) )
              & ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum @ V1f @ V4r ) @ V3l @ c_2Ereal__topology_2Esequentially ) ) ) ) )).

thf(thm_2Ereal__topology_2Ecauchy,axiom,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Ecauchy @ V0s )
    <=> ! [V1e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V2N: tyop_2Enum_2Enum] :
            ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
             ...
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0s @ V3m ) @ ( V0s @ V4n ) ) ) @ V1e ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EISOMETRY__ON__IMP__CONTINUOUS__ON,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
      ( ! [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
         ...
         => ( ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V1f @ V2x ) @ ( V1f @ V3y ) ) )
...
thf(thm_2Ereal__topology_2ESETDIST__EQ__0__SING,axiom,
    ( ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
        ( ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0s ) )
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
      <=> ( ( V0s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
          | ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ ( c_2Ereal__topology_2Eclosure @ V0s ) ) ) )
    & ! [V2s: tyop_2Erealax_2Ereal > $o,V3x: tyop_2Erealax_2Ereal] :
        ( ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V2s @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V3x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
      <=> ( ( V2s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
          | ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ ( c_2Ereal__topology_2Eclosure @ V2s ) ) ) ) )).

thf(thm_2Ereal__topology_2EISOMETRY__IMP__EMBEDDING,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s )
        ...
        & ! [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
           ...
           => ( ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ ( V0f @ V4y ) ) )
              = ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V3x @ V4y ) ) ) ) )
     => ? [V5g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2Ehomeomorphism @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ V2t ) @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ V0f @ V5g ) ) ) )).
...
thf(thm_2Ereal__topology_2EISOMETRY__IMP__HOMEOMORPHISM__COMPACT,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ecompact @ V1s )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) @ V1s )
        & ! [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V1s )
              & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3y @ V1s ) )
           => ( ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V2x ) @ ( V0f @ V3y ) ) )
              = ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2x @ V3y ) ) ) ) )
     => ? [V4g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2Ehomeomorphism @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ V1s ) @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ V0f @ V4g ) ) ) )).
