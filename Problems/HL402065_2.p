...
tff(lamtp_f369,axiom,(
    ! [A_27a: del,A_27a: del,V1xs: $i] :
      ( mem(V1xs,arr(A_27a,bool))
     => ! [V0xss: $i] :
          ( mem(V0xss,arr(arr(A_27a,bool),bool))
         => mem(f369(A_27a,A_27a,V1xs,V0xss),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).
...
tff(lameq_f369,axiom,(
    ! [A_27a: del,A_27a: del,V1xs: $i] :
     ...
     => ! [V0xss: $i] :
          ( mem(V0xss,arr(arr(A_27a,bool),bool))
         => ! [V2xs_27: $i] :
              ( mem(V2xs_27,arr(A_27a,bool))
             => ap(f369(A_27a,A_27a,V1xs,V0xss),V2xs_27) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EINTER(A_27a),V2xs_27),V1xs)),ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2xs_27),V0xss)) ) ) ) )).
...
tff(ax_thm_2Eset__relation_2Eper__restrict__def,axiom,(
    ! [A_27a: del,V0xss: $i] :
     ...
     => ! [V1xs: $i] :
          ( mem(V1xs,arr(A_27a,bool))
         => ap(ap(c_2Eset__relation_2Eper__restrict(A_27a),V0xss),V1xs) = ap(ap(c_2Epred__set_2EDELETE(arr(A_27a,bool)),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f369(A_27a,A_27a,V1xs,V0xss))),c_2Epred__set_2EEMPTY(A_27a)) ) ) )).

tff(conj_thm_2Eset__relation_2Eper__restrict__per,conjecture,(
    ! [A_27a: del,V0r: $i] :
