...
tff(conj_thm_2Epred__set_2ECROSS__UNIV,lemma,(
    ! [A_27a: del,A_27b: del] : c_2Epred__set_2EUNIV(ty_2Epair_2Eprod(A_27a,A_27a)) = ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(A_27b)) )).

tff(conj_thm_2Epred__set_2Ecross__countable__IFF,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ( p(ap(c_2Epred__set_2Ecountable(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1t)))
...
tff(conj_thm_2Epred__set_2Ecountable__Uprod,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( p(ap(c_2Epred__set_2Ecountable(ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epred__set_2EUNIV(ty_2Epair_2Eprod(A_27a,A_27a))))
