...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__CARD__LE__DIM,lemma,(
    ! [V0v: $i] :
...
thf(conj_thm_2Ereal__topology_2ESPAN__CARD__GE__DIM,lemma,(
    ! [V0v: $i] :
      ( ( mem @ V0v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EBASIS__CARD__EQ__DIM,conjecture,(
    ! [V0v: $i] :
      ( ( mem @ V0v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
