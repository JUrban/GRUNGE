...
thf(conj_thm_2Ellist_2ELNTH__LUNFOLD__compute,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V1x ) )
              = ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) @ ( c_2Epair_2ESND @ A_27b @ A_27a ) ) @ ( ap @ V0f @ V1x ) ) )
            & ! [V2n: tp__ty_2Enum_2Enum] :
                ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V1x ) )
                = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V1x ) ) @ ( c_2Eoption_2ENONE @ A_27a ) )
                  @ ( lam @ ( ty_2Epair_2Eprod @ A_27b @ A_27a )
                    @ ^ [V3v: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2Epair__CASE @ ( ty_2Eoption_2Eoption @ A_27a ) @ A_27b @ A_27a ) @ V3v )
                        @ ( lam @ A_27b
                          @ ^ [V4tx: $i] :
                              ( lam @ A_27a
                              @ ^ [V5hx: $i] :
                                  ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V4tx ) ) ) ) ) ) ) )
            & ! [V6n: tp__ty_2Enum_2Enum] :
                ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V1x ) )
                = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V1x ) ) @ ( c_2Eoption_2ENONE @ A_27a ) )
                  @ ( lam @ ( ty_2Epair_2Eprod @ A_27b @ A_27a )
                    @ ^ [V7v: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2Epair__CASE @ ( ty_2Eoption_2Eoption @ A_27a ) @ A_27b @ A_27a ) @ V7v )
                        @ ( lam @ A_27b
                          @ ^ [V8tx: $i] :
                              ( lam @ A_27a
                              @ ^ [V9hx: $i] :
                                  ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V8tx ) ) ) ) ) ) ) ) ) ) ) )).
