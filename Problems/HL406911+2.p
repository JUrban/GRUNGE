...
fof(conj_thm_2Efmapal_2Emerge__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
              ( mem(V0P,arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),bool))))
             => ( ( ! [V1cmp] :
                      ( mem(V1cmp,ty_2Etoto_2Etoto(A_27a))
                     => ! [V2l] :
                          ( mem(V2l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                         => p(ap(ap(ap(V0P,V1cmp),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))),V2l)) ) )
                  & ! [V3cmp] :
                      ( mem(V3cmp,ty_2Etoto_2Etoto(A_27a))
                     => ! [V4v4] :
                          ( mem(V4v4,ty_2Epair_2Eprod(A_27a,A_27a))
                         => ! [V5v5] :
                              ( mem(V5v5,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                             => p(ap(ap(ap(V0P,V3cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),V4v4),V5v5)),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )
                  & ! [V6cmp] :
                     ...
                     => ! [V7a1] :
                         ...
                         => ! [V8b1] :
                              ( mem(V8b1,A_27b)
                             => ! [V9l1] :
                                  ( mem(V9l1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                                 => ! [V10a2] :
                                      ( mem(V10a2,A_27a)
                                     => ! [V11b2] :
                                          ( mem(V11b2,A_27b)
                                         => ! [V12l2] :
                                              ( mem(V12l2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                                             => ( ( ( ap(ap(ap(c_2Etoto_2Eapto(A_27a),V6cmp),V7a1),V10a2) = c_2EternaryComparisons_2EEQUAL
                                                  ...
                                                  & ( ap(ap(ap(c_2Etoto_2Eapto(A_27a),V6cmp),V7a1),V10a2) = c_2EternaryComparisons_2EGREATER
                                                   => p(ap(ap(ap(V0P,V6cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V7a1),V8b1)),V9l1)),V12l2)) )
                                                  & ( ap(ap(ap(c_2Etoto_2Eapto(A_27a),V6cmp),V7a1),V10a2) = c_2EternaryComparisons_2ELESS
                                                   => p(ap(ap(ap(V0P,V6cmp),V9l1),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V10a2),V11b2)),V12l2))) ) )
                                               => p(ap(ap(ap(V0P,V6cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V7a1),V8b1)),V9l1)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V10a2),V11b2)),V12l2))) ) ) ) ) ) ) ) ) )
               => ! [V13v] :
                    ( mem(V13v,ty_2Etoto_2Etoto(A_27a))
                   => ! [V14v1] :
                        ( mem(V14v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                       => ! [V15v2] :
                            ( mem(V15v2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
