...
thf(thm_2Eextreal_2EEXTREAL__ARCH__POW,axiom,(
    ! [V0x: tyop_2Eextreal_2Eextreal] :
     ...
     => ? [V1n: tyop_2Enum_2Enum] :
          ( c_2Eextreal_2Eextreal__lt @ V0x @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V1n ) ) ) )).
...
thf(thm_2Elebesgue_2Elemma__fn__sup,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2x: A_27a] :
