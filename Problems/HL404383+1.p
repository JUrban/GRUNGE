...
fof(thm_2Eoption_2Eoption__case__eq,axiom,(
    ! [A_27a,A_27b,V0v_2E0,V1sc_2E0,V2opt_2E0,V3nc_2E0] :
      ( s(A_27b,c_2Eoption_2Eoption__CASE_2E3(s(tyop_2Eoption_2Eoption(A_27a),V2opt_2E0),s(A_27b,V3nc_2E0),s(tyop_2Emin_2Efun(A_27a,A_27b),V1sc_2E0))) = s(A_27b,V0v_2E0)
    <=> ( ( s(tyop_2Eoption_2Eoption(A_27a),V2opt_2E0) = s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ENONE_2E0)
          & s(A_27b,V3nc_2E0) = s(A_27b,V0v_2E0) )
        | ? [V4x_2E0] :
            ( s(tyop_2Eoption_2Eoption(A_27a),V2opt_2E0) = s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ESOME_2E1(s(A_27a,V4x_2E0)))
            & s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1sc_2E0),s(A_27a,V4x_2E0))) = s(A_27b,V0v_2E0) ) ) ) )).
...
fof(thm_2Epred__set_2ECHOICE__DEF,axiom,(
    ! [A_27a,V0s_2E0] :
      ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
     => p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,c_2Epred__set_2ECHOICE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0)))) ) )).
...
fof(thm_2Ecardinal_2Eset__exp__cardle__cong,conjecture,(
