...
tff(mem_c_2Etc_2ERELN__TO__FMAP,axiom,(
    ! [A_27a: del] : mem(c_2Etc_2ERELN__TO__FMAP(A_27a),arr(arr(A_27a,arr(A_27a,bool)),ty_2Efinite__map_2Efmap(A_27a,A_27a))) )).
...
tff(conj_thm_2Etc_2EFDOM__RDOM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Etc_2ERELN__TO__FMAP__TO__RELN__ID,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Erelation_2ERDOM(A_27a,A_27a),V0R)))
