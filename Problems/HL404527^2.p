...
thf(conj_thm_2Ecardinal_2ECARD__LE__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ecardinal_2ECARD__LE__IMAGE,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__LE__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
