...
fof(conj_thm_2Eiterate_2EREAL__POLYFUN__EQ__0,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1c] :
          ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( ! [V2x] :
                ( mem(V2x,ty_2Erealax_2Ereal)
               => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V0n)),f3424(V1c,V2x)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) )
          <=> ! [V4i] :
                ( mem(V4i,ty_2Enum_2Enum)
...
fof(conj_thm_2Eiterate_2EREAL__POLYFUN__EQ__CONST,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1c] :
          ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2k] :
             ...
             => ( ! [V3x] :
                    ( mem(V3x,ty_2Erealax_2Ereal)
                   => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V0n)),f3420(V1c,V3x)) = V2k )
