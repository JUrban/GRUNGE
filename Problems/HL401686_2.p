...
tff(lamtp_f274,axiom,(
    ! [A_27b: del,A_27a: del,V1x: $i] :
      ( mem(V1x,A_27b)
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => mem(f274(A_27b,A_27a,V1x,V0f),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f274,axiom,(
    ! [A_27b: del,A_27a: del,V1x: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V2y: $i] :
              ( mem(V2y,A_27a)
             => ap(f274(A_27b,A_27a,V1x,V0f),V2y) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2y),ap(ap(c_2Emin_2E_3D(A_27b),V1x),ap(V0f,V2y))) ) ) ) )).

tff(conj_thm_2Epred__set_2EFINITELY__INJECTIVE__IMAGE__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1x: $i] :
            ( mem(V1x,A_27b)
...
tff(conj_thm_2Epred__set_2EBIGUNION__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Epred__set_2EFINITE__BIGUNION,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Epred__set_2EFINITE__BIGUNION__EQ,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V0P)))
      <=> ( p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),V0P))
