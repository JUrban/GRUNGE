...
thf(conj_thm_2Eiterate_2EREAL__SUP__LE__EQ,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EHAUSDIST__NONTRIVIAL__ALT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE__EQ,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
