...
thf(f9993_0_2E0,type,(
    f9993_0_2E0: u )).

thf(f9993_0_2E1,type,(
    f9993_0_2E1: du > u )).
...
thf(def0_2Ethm_2EHolSmt_2Ed025,axiom,(
    ! [V1q: $o] :
      ( ( mono_2Ef9993_0 @ V1q )
    <=> ( (~) @ V1q ) ) )).

thf(thm_2EHolSmt_2Ed025,conjecture,(
    ! [V0r: $o,V1q: $o,V2p: $o] :
      ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V2p @ ( mono_2Ef9993_0 @ V1q ) @ V0r )
      | ( (~) @ V2p )
      | V1q ) )).
