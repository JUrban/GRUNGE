            ...
            & ? [V3x: A_27a > tyop_2Enum_2Enum,V4y: A_27a > tyop_2Enum_2Enum] :
                ( ( (~)
                  @ ( V3x
                    = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )
                & ( c_2Ebag_2ESUB__BAG @ A_27a @ V3x @ V2b2 )
                & ( c_2Ebag_2EBAG__DISJOINT @ A_27a @ V3x @ V4y )
                & ( V1b1
                  = ( c_2Ebag_2EBAG__UNION @ A_27a @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V2b2 @ V3x ) @ V4y ) )
                & ( c_2Ebag_2Edominates @ A_27a @ A_27a @ V0R @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V4y ) @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V3x ) ) ) ) ) ) )).
...
thf(thm_2Ebag_2EmltLT__SING0,conjecture,(
    ! [V0b: tyop_2Enum_2Enum > tyop_2Enum_2Enum] :
      ( ( c_2Erelation_2ETC @ ( tyop_2Enum_2Enum > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ tyop_2Enum_2Enum @ c_2Eprim__rec_2E_3C ) @ ( c_2Ebag_2EBAG__INSERT @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ ( c_2Ebag_2EEMPTY__BAG @ tyop_2Enum_2Enum ) ) @ V0b )
    <=> ( ( c_2Ebag_2EFINITE__BAG @ tyop_2Enum_2Enum @ V0b )
        & ( (~)
          @ ( V0b
            = ( c_2Ebag_2EBAG__INSERT @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ ( c_2Ebag_2EEMPTY__BAG @ tyop_2Enum_2Enum ) ) ) )
        & ( (~)
          @ ( V0b
