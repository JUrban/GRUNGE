...
tff(conj_thm_2Ereal__topology_2EJOINABLE__CONNECTED__COMPONENT__EQ,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Ereal__topology_2Econnected,V1t))
                ...
                & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2x))),V1t) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V3y))),V1t) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
             => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V3y)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EJOINABLE__COMPONENTS__EQ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2c1: $i] :
             ...
             => ! [V3c2: $i] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Econnected,V1t))
                      ...
                      & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V2c1),V1t) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                      & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V3c2),V1t) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
                   => V2c1 = V3c2 ) ) ) ) ) )).
