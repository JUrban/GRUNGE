...
tff(conj_thm_2Eieee_2Eccode2num__11,lemma,(
    ! [V0a: tp__ty_2Eieee_2Eccode,V1a_27: tp__ty_2Eieee_2Eccode] :
      ( surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(V0a))) = surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(V1a_27)))
    <=> V0a = V1a_27 ) )).

tff(conj_thm_2Eieee_2Eccode__EQ__ccode,conjecture,(
    ! [V0a: tp__ty_2Eieee_2Eccode,V1a_27: tp__ty_2Eieee_2Eccode] :
      ( V0a = V1a_27
    <=> surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(V0a))) = surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(V1a_27))) ) )).
