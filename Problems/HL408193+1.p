...
fof(thm_2Epoly_2EPOLY__DIVIDES__ZERO,conjecture,(
    ! [V0p_2E0,V1q_2E0] :
     ...
     => p(s(tyop_2Emin_2Ebool,c_2Epoly_2Epoly__divides_2E2(s(tyop_2Elist_2Elist(tyop_2Erealax_2Ereal),V1q_2E0),s(tyop_2Elist_2Elist(tyop_2Erealax_2Ereal),V0p_2E0)))) ) )).
