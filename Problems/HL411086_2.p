...
tff(conj_thm_2Ereal__topology_2ECLOSED__BIGINTER,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__BIGINTER,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ? [V1s: $i] :
            ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__BIGINTER,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( ! [V1s: $i] :
              ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
