...
fof(lameq_f2861,axiom,(
    ! [V0R] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f2861(V0R),V1n) = ap(ap(V0R,ap(c_2Enum_2ESUC,V1n)),ap(c_2Enum_2ESUC,ap(c_2Enum_2ESUC,V1n))) ) ) )).

fof(lamtp_f2860,axiom,(
...
fof(lameq_f2865,axiom,(
    ! [V2rat__of__num] :
     ...
     => ! [V5n] :
          ( mem(V5n,ty_2Enum_2Enum)
         => ap(f2865(V2rat__of__num),V5n) = ap(c_2Ecombin_2EI(ty_2Erat_2Erat),ap(ap(c_2Erat_2Erat__add,ap(V2rat__of__num,ap(c_2Enum_2ESUC,V5n))),c_2Erat_2Erat__1)) ) ) )).

fof(lamtp_f2864,axiom,(
    ! [V2rat__of__num] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
...
fof(lameq_f2864,axiom,(
    ! [V2rat__of__num] :
     ...
     => ! [V4v] :
         ...
         => ap(f2864(V2rat__of__num),V4v) = ap(ap(ap(c_2Earithmetic_2Enum__CASE(ty_2Erat_2Erat),V4v),ap(c_2Ecombin_2EI(ty_2Erat_2Erat),c_2Erat_2Erat__1)),f2865(V2rat__of__num)) ) ) )).

fof(lamtp_f2863,axiom,(
    ! [V2rat__of__num] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
...
fof(lameq_f2863,axiom,(
    ! [V2rat__of__num] :
     ...
     => ! [V3a] :
         ...
         => ap(f2863(V2rat__of__num),V3a) = ap(ap(ap(c_2Earithmetic_2Enum__CASE(ty_2Erat_2Erat),V3a),ap(c_2Ecombin_2EI(ty_2Erat_2Erat),c_2Erat_2Erat__0)),f2864(V2rat__of__num)) ) ) )).

fof(lamtp_f2862,axiom,(
...
fof(conj_thm_2Erat_2ERAT__OF__NUM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,A_27a)
