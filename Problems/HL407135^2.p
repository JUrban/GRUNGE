...
thf(conj_thm_2Ebasis__emit_2EFCPi__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( ty_2Epair_2Eprod @ ( arr @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Ebool_2Eitself @ A_27b ) ) @ bool ) )
     => ( ! [V1f: $i] :
            ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
           => ( p @ ( ap @ V0P @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Ebool_2Eitself @ A_27b ) ) @ V1f ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) ) )
       => ! [V2v: $i] :
            ( ( mem @ V2v @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
           => ! [V3v1: $i] :
                ( ( mem @ V3v1 @ ( ty_2Ebool_2Eitself @ A_27b ) )
               => ( p @ ( ap @ V0P @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Ebool_2Eitself @ A_27b ) ) @ V2v ) @ V3v1 ) ) ) ) ) ) ) )).
