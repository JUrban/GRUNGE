...
tff(conj_thm_2Eiterate_2EFINREC__SUC__LEMMA,lemma,(
...
tff(conj_thm_2Eiterate_2EFINREC__UNIQUE__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
     => ! [V1b: $i] :
          ( mem(V1b,A_27b)
         => ( ! [V2x: $i] :
           ...
           => ! [V5n1: tp__ty_2Enum_2Enum,V6n2: tp__ty_2Enum_2Enum,V7s: $i] :
               ...
               => ! [V8a1: $i] :
                   ...
                   => ! [V9a2: $i] :
                        ( mem(V9a2,A_27b)
                       => ( ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V7s),V8a1),inj__ty_2Enum_2Enum(V5n1)))
                            & p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V7s),V9a2),inj__ty_2Enum_2Enum(V6n2))) )
                         => ( V8a1 = V9a2
                            & V5n1 = V6n2 ) ) ) ) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EFINREC__EXISTS__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
     => ! [V1b: $i] :
          ( mem(V1b,A_27b)
         => ! [V2s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               => ? [V3a: $i] :
                    ( mem(V3a,A_27b)
                    & ? [V4n: tp__ty_2Enum_2Enum] : p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V2s),V3a),inj__ty_2Enum_2Enum(V4n))) ) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EFINREC__FUN__LEMMA,lemma,(
...
tff(conj_thm_2Eiterate_2EFINREC__FUN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
     => ! [V1b: $i] :
          ( mem(V1b,A_27b)
