...
thf(thm_2Ellist_2ELTAKE__NIL__EQ__NONE,axiom,(
    ! [A_27a: d,V0m: mono_2Etyop_2Enum_2Enum] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0m ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) )
...
thf(thm_2Ellist_2ELTAKE__CONS__EQ__NONE,axiom,(
    ! [A_27a: d,V0m: mono_2Etyop_2Enum_2Enum,V1h_2E0: u,V2t_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0m ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2t_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) )
    <=> ? [V3n: mono_2Etyop_2Enum_2Enum] :
          ( ( V0m
            = ( mono_2Ec_2Enum_2ESUC @ V3n ) )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2t_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) )).
...
thf(thm_2Ellist_2ELTAKE__LLENGTH__NONE,conjecture,(
