...
fof(lamtp_f3002,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3002(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3002,axiom,(
    ! [V0x] :
     ...
     => ! [V3m] :
         ...
         => ap(f3002(V0x),V3m) = ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2Epow,V0x),V3m)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V3m))) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN__EXP__LT,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1n] :
         ...
         => ( ( V0x != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
           ...
           => ? [V2t] :
                ...
                & ap(c_2Etransc_2Eexp,V0x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V1n)),f3002(V0x))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(c_2Etransc_2Eexp,V2t)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V1n)))),ap(ap(c_2Ereal_2Epow,V0x),V1n))) ) ) ) ) )).
