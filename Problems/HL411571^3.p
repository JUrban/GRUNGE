...
thf(thm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,conjecture,
    ( ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal,V2v: tyop_2Erealax_2Ereal] :
        ( ( c_2Ereal__topology_2Eclosed__segment @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__mul @ V0a @ V2v ) @ ( c_2Erealax_2Ereal__mul @ V1b @ V2v ) ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) )
        = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V3x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__mul @ V3x @ V2v ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal_2Ereal__lte @ V0a @ V3x ) @ ( c_2Ereal_2Ereal__lte @ V3x @ V1b ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal_2Ereal__lte @ V1b @ V3x ) @ ( c_2Ereal_2Ereal__lte @ V3x @ V0a ) ) ) ) ) )
    & ! [V4a: tyop_2Erealax_2Ereal,V5b: tyop_2Erealax_2Ereal,V6v: tyop_2Erealax_2Ereal] :
        ( ( (~)
          @ ( V6v
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
       => ( ( c_2Ereal__topology_2Eopen__segment @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__mul @ V4a @ V6v ) @ ( c_2Erealax_2Ereal__mul @ V5b @ V6v ) ) )
          = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V7x: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__mul @ V7x @ V6v ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( c_2Erealax_2Ereal__lt @ V4a @ V7x ) @ ( c_2Erealax_2Ereal__lt @ V7x @ V5b ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Erealax_2Ereal__lt @ V5b @ V7x ) @ ( c_2Erealax_2Ereal__lt @ V7x @ V4a ) ) ) ) ) ) ) )).
