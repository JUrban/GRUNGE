...
fof(conj_thm_2Ereal__topology_2EAT__NEGINFINITY,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
...
fof(conj_thm_2Ereal__topology_2ETRIVIAL__LIMIT__AT__NEGINFINITY,lemma,(
...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__AT__NEGINFINITY,conjecture,(
    ! [V0p] :
