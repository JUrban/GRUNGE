...
fof(def0_2Ethm_2Ecardinal_2EHAS__SIZE__INDEX,axiom,(
    ! [A_27a,V1n_2E0,V2f_2E0,V4x_2E0,V5m_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f5011_0_2E4(s(tyop_2Enum_2Enum,V1n_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V2f_2E0),s(A_27a,V4x_2E0),s(tyop_2Enum_2Enum,V5m_2E0))))
    ...
    ! [A_27a,V0s_2E0,V1n_2E0] :
     ...
     => ? [V2f_2E0] :
          ...
          & ! [V4x_2E0] :
             ...
             => p(s(tyop_2Emin_2Ebool,c_2Ebool_2E_3F_21_2E1(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),f5011_0_2E3(s(tyop_2Enum_2Enum,V1n_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V2f_2E0),s(A_27a,V4x_2E0)))))) ) ) ) )).
...
fof(thm_2Eiterate_2EFINITE__INDEX__NUMSEG,conjecture,(
    ! [A_27a,V0s_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0))))
    <=> ? [V1f_2E0] :
          ( ! [V2i_2E0,V3j_2E0] :
