...
thf(f3661_0_2E0,type,(
    f3661_0_2E0: u )).

thf(f3661_0_2E1,type,(
    f3661_0_2E1: du > u )).

thf(f3661_1_2E0,type,(
    f3661_1_2E0: u )).

thf(f3661_1_2E1,type,(
    f3661_1_2E1: du > u )).

thf(f3661_1_2E2,type,(
    f3661_1_2E2: du > du > u )).
...
thf(mono_2Ef3661_0,type,(
    mono_2Ef3661_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3661_1,type,(
    mono_2Ef3661_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EALWAYS__AS__WHEN,axiom,(
    ! [V1t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3661_0 @ V1t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EALWAYS__AS__WHEN,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3661_1 @ V0a @ V2t )
    <=> ( (~) @ ( V0a @ V2t ) ) ) )).

thf(thm_2ETemporal__Logic_2EALWAYS__AS__WHEN,conjecture,(
    ! [V0a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ V0a )
      = ( mono_2Ec_2ETemporal__Logic_2EWHEN @ mono_2Ef3661_0 @ ( mono_2Ef3661_1 @ V0a ) ) ) )).
