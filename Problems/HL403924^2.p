...
thf(conj_thm_2Ellist_2ELFLATTEN__THM,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0t: $i] :
      ( ( mem @ V0t @ ( ty_2Ellist_2Ellist @ ( ty_2Ellist_2Ellist @ A_27c ) ) )
     => ( ( ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27a ) @ ( c_2Ellist_2ELNIL @ ( ty_2Ellist_2Ellist @ A_27a ) ) )
          = ( c_2Ellist_2ELNIL @ A_27a ) )
        & ! [V1tl: $i] :
            ( ( mem @ V1tl @ A_27b )
           => ( ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27c ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ ( ty_2Ellist_2Ellist @ A_27c ) ) @ ( c_2Ellist_2ELNIL @ A_27c ) ) @ V0t ) )
              = ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27c ) @ V0t ) ) )
        & ! [V2h: $i] :
            ( ( mem @ V2h @ A_27d )
           => ! [V3t: $i] :
               ...
               => ! [V4tl: $i] :
                   ...
                   => ( ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27d ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ ( ty_2Ellist_2Ellist @ A_27d ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27d ) @ V2h ) @ V3t ) ) @ V4tl ) )
                      = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27d ) @ V2h ) @ ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27d ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ ( ty_2Ellist_2Ellist @ A_27d ) ) @ V3t ) @ V4tl ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELFLATTEN__SINGLETON,conjecture,(
    ! [A_27a: del,V0h: $i] :
      ( ( mem @ V0h @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELFLATTEN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V0h ) @ ( c_2Ellist_2ELNIL @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) )
        = V0h ) ) )).
