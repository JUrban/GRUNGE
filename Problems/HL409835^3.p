...
thf(thm_2Eiterate_2ESUM__SUM__RESTRICT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0R: A_27a > A_27b > $o,V1f: A_27a > A_27b > tyop_2Erealax_2Ereal,V2s: A_27a > $o,V3t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V3t ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2s
          @ ^ [V4x: A_27a] :
              ( c_2Eiterate_2ESum @ A_27b
              @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b
                @ ^ [V5y: A_27b] :
                    ( c_2Epair_2E_2C @ A_27b @ $o @ V5y @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27b @ V5y @ V3t ) @ ( V0R @ V4x @ V5y ) ) ) )
              @ ^ [V6y: A_27b] :
                  ( V1f @ V4x @ V6y ) ) )
        = ( c_2Eiterate_2ESum @ A_27b @ V3t
          @ ^ [V7y: A_27b] :
              ...
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V8x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V8x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V8x @ V2s ) @ ( V0R @ V8x @ V7y ) ) ) )
              @ ^ [V9x: A_27a] :
                  ( V1f @ V9x @ V7y ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__IMAGE__GEN,conjecture,(
