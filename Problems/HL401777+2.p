...
fof(conj_thm_2Earithmetic_2EEQ__ADD__RCANCEL,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Epred__set_2EINTER__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2ECARD__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ! [V1t] :
               ...
               => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1t))
                 => ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epred__set_2ECARD(A_27a),ap(ap(c_2Epred__set_2EUNION(A_27a),V0s),V1t))),ap(c_2Epred__set_2ECARD(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),V0s),V1t))) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epred__set_2ECARD(A_27a),V0s)),ap(c_2Epred__set_2ECARD(A_27a),V1t)) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EFINITE__BIJ__CARD__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0S] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0S))
               => ! [V1t] :
                   ...
                   => ! [V2f] :
                        ( mem(V2f,arr(A_27a,A_27b))
                       => ( ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V2f),V0S),V1t))
...
fof(lamtp_f290,axiom,(
    ! [A_27a,V0e] :
      ( mem(V0e,A_27a)
     => mem(f290(A_27a,V0e),arr(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool))) ) )).

fof(lameq_f290,axiom,(
    ! [A_27a,V0e] :
      ( mem(V0e,A_27a)
     => ! [V2ps] :
          ( mem(V2ps,arr(arr(A_27a,bool),bool))
         => ap(f290(A_27a,V0e),V2ps) = ap(ap(c_2Epred__set_2EUNION(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Epred__set_2EINSERT(A_27a),V0e)),V2ps)),V2ps) ) ) )).

fof(conj_thm_2Epred__set_2EPOW__EQNS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Epred__set_2EFINITE__POW,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2ECARD__POW,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ap(c_2Epred__set_2ECARD(arr(A_27a,bool)),ap(c_2Epred__set_2EPOW(A_27a),V0s)) = ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),ap(c_2Epred__set_2ECARD(A_27a),V0s)) ) ) ) )).
