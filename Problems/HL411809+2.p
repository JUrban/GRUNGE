...
fof(conj_thm_2Eiterate_2ENUMSEG__RREC,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__CMUL,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__EQ,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__FROM__ELSEWHERE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__BILINEAR__PARTIAL__PRE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET__BILINEAR,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
