...
thf(thm_2Ereal_2EREAL__ADD__SUB__ALT,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal_2Ereal__sub @ ( c_2Erealax_2Ereal__add @ V0x @ V1y ) @ V1y )
      = V0x ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__CONST,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1c: tyop_2Erealax_2Ereal] :
...
thf(thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__GE,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V1x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V1x @ ( c_2Ereal_2Ereal__ge @ V1x @ V0a ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__AT__ABS,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ c_2Ereal_2Eabs @ ( c_2Ereal__topology_2Eat @ V0x ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__MUL,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal,V2c: A_27a > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous @ A_27a @ V2c @ V0net )
        & ( c_2Ereal__topology_2Econtinuous @ A_27a @ V1f @ V0net ) )
     => ( c_2Ereal__topology_2Econtinuous @ A_27a
        @ ^ [V3x: A_27a] :
            ( c_2Erealax_2Ereal__mul @ ( V2c @ V3x ) @ ( V1f @ V3x ) )
        @ V0net ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__INV,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous @ A_27a @ V1f @ V0net )
        & ( (~)
          @ ( ( V1f @ ( c_2Ereal__topology_2Enetlimit @ A_27a @ V0net ) )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ A_27a @ ( c_2Ecombin_2Eo @ A_27a @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ c_2Erealax_2Einv @ V1f ) @ V0net ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__CASES,axiom,(
    ! [V0P: tyop_2Erealax_2Ereal > $o,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3s: tyop_2Erealax_2Ereal > $o,V4t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2EClosed @ V3s )
        & ( c_2Ereal__topology_2EClosed @ V4t )
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__TRANS,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2u: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ehomeomorphic @ V0s @ V1t )
        & ( c_2Ereal__topology_2Ehomeomorphic @ V1t @ V2u ) )
     => ( c_2Ereal__topology_2Ehomeomorphic @ V0s @ V2u ) ) )).
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__MINIMAL,axiom,(
    ...
    <=> ? [V2f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ! [V4x: tyop_2Erealax_2Ereal] :
             ...
             => ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V2f @ V4x ) @ V1t )
                & ( ( V3g @ ( V2f @ V4x ) )
                  = V4x ) ) )
          & ! [V5y: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5y @ V1t )
             => ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V3g @ V5y ) @ V0s )
                & ( ( V2f @ ( V3g @ V5y ) )
                  = V5y ) ) )
          & ( c_2Ereal__topology_2Econtinuous__on @ V2f @ V0s )
          & ( c_2Ereal__topology_2Econtinuous__on @ V3g @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVALS,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal,V2c: tyop_2Erealax_2Ereal,V3d: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Erealax_2Ereal__lt @ V0a @ V1b )
        & ( c_2Erealax_2Ereal__lt @ V2c @ V3d ) )
     => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) ) @ ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2c @ V3d ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVAL__UNIV,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ( ( c_2Erealax_2Ereal__lt @ V0a @ V1b )
     => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) ) @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) ) ) )).
