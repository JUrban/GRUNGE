...
thf(thm_2Ereal__topology_2EHEINE__BOREL__IMP__BOLZANO__WEIERSTRASS,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ! [V4t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( ( (~) @ ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ V4t ) )
            & ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V4t @ V0s ) )
         => ? [V5x: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V5x @ V0s )
              & ( mono_2Ec_2Ereal__topology_2Elimit__point__of @ V5x @ V4t ) ) ) ) )).

thf(thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__BOUNDED,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ! [V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( ( (~) @ ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ V1t ) )
            & ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V1t @ V0s ) )
         => ? [V2x: mono_2Etyop_2Erealax_2Ereal] :
              ( mono_2Ec_2Ereal__topology_2Elimit__point__of @ V2x @ V1t ) )
     => ( mono_2Ec_2Ereal__topology_2Ebounded__def @ V0s ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPACT__EQ__BOLZANO__WEIERSTRASS,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ecompact @ V0s )
    <=> ! [V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( ( (~) @ ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ V1t ) )
