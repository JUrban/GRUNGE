...
tff(lmtp_f3460,type,(
    f3460: ( del * $i * $i * tp__ty_2Eextreal_2Eextreal ) > $i )).

tff(lamtp_f3460,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V2z: tp__ty_2Eextreal_2Eextreal] : mem(f3460(A_27a,V1f,V0s,V2z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3460,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V2z: tp__ty_2Eextreal_2Eextreal,V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3460(A_27a,V1f,V0s,V2z),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s)),ap(V1f,V3x)),inj__ty_2Eextreal_2Eextreal(V2z)) ) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IN__IF__ALT,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2z: tp__ty_2Eextreal_2Eextreal] :
              ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
             => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3460(A_27a,V1f,V0s,V2z)),V0s)) ) ) ) )).
