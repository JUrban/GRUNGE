...
tff(conj_thm_2Eproduct_2ENPRODUCT__MUL,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(A_27a),V2s),f3502(A_27a,V0f,V1g))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,ap(ap(c_2Eproduct_2Enproduct(A_27a),V2s),V0f)),ap(ap(c_2Eproduct_2Enproduct(A_27a),V2s),V1g))) ) ) ) ) )).

tff(lmtp_f3503,type,(
    f3503: ( $i * $i ) > $i )).

tff(lamtp_f3503,axiom,(
    ! [V0f: $i] :
...
tff(lameq_f3503,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => ! [V4x: tp__ty_2Enum_2Enum] : ap(f3503(V0f,V1g),inj__ty_2Enum_2Enum(V4x)) = ap(ap(c_2Earithmetic_2E_2A,ap(V0f,inj__ty_2Enum_2Enum(V4x))),ap(V1g,inj__ty_2Enum_2Enum(V4x))) ) ) )).

tff(conj_thm_2Eproduct_2ENPRODUCT__MUL__NUMSEG,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f3503(V0f,V1g))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,ap(ap(c_2Eproduct_2Enproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V0f)),ap(ap(c_2Eproduct_2Enproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V1g))) ) ) )).
