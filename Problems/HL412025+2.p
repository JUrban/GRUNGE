...
fof(conj_thm_2Eextreal_2Eabs__bounds,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1k] :
          ( mem(V1k,ty_2Eextreal_2Eextreal)
         => ( p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__abs,V0x)),V1k))
          <=> ( p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__ainv,V1k)),V0x))
              & p(ap(ap(c_2Eextreal_2Eextreal__le,V0x),V1k)) ) ) ) ) )).

fof(conj_thm_2Eextreal_2Eneg__neg,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ap(c_2Eextreal_2Eextreal__ainv,ap(c_2Eextreal_2Eextreal__ainv,V0x)) = V0x ) )).
...
fof(conj_thm_2Elebesgue_2Eintegrable__bounded,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
