...
thf(conj_thm_2Ereal__topology_2EOPEN__IN__SUBTOPOLOGY,lemma,(
    ! [A_27a: del,V0top: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ A_27a ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ A_27a ) @ V0top ) @ V1u ) ) @ V2s ) )
              <=> ? [V3t: $i] :
                    ...
                    & ( V2s
                      = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V3t ) @ V1u ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2Eopen__in,conjecture,(
    ! [V0u: $i] :
