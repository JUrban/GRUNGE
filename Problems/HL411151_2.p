...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SING,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EMPTY,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
