...
thf(ax_thm_2Ereal__topology_2Eclosure,axiom,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Eclosure @ V0s )
        = ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V1x: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ V1x ) @ V0s ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__CLOSED__IMP__COMPACT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__IMP__COMPLETE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
       => ( p @ ( ap @ c_2Ereal__topology_2Ecomplete @ V0s ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECOMPLETE__UNIV,conjecture,(
