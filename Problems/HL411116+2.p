...
fof(conj_thm_2Ecardinal_2ELE__CASES,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ECLOSED__APPROACHABLE,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal__topology_2ECOMPLETE__UNIV,lemma,(
    p(ap(c_2Ereal__topology_2Ecomplete,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).

fof(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => p(ap(c_2Ereal__topology_2EClosed,ap(V0s,V1n))) )
          & ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(V0s,V2n) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
          & ! [V3m] :
              ( mem(V3m,ty_2Enum_2Enum)
             => ! [V4n] :
                  ( mem(V4n,ty_2Enum_2Enum)
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3m),V4n))
                   => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0s,V4n)),ap(V0s,V3m))) ) ) )
          & ! [V5e] :
               ...
               => ? [V6n] :
                    ...
                    & ! [V7x] :
                       ...
                       => ! [V8y] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),ap(V0s,V6n)))
                                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V8y),ap(V0s,V6n))) )
                             => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V7x),V8y))),V5e)) ) ) ) ) ) ) )
       => ? [V9a] :
            ( mem(V9a,ty_2Erealax_2Ereal)
            & ! [V10n] :
                ( mem(V10n,ty_2Enum_2Enum)
               => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V9a),ap(V0s,V10n))) ) ) ) ) )).
