...
thf(conj_thm_2Eint__arith_2Eelim__eq__coeffs,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1x: tp__ty_2Einteger_2Eint,V2y: tp__ty_2Einteger_2Eint] :
      ( ( V0m != fo__c_2Enum_2E0 )
     => ( ( ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( inj__ty_2Einteger_2Eint @ V1x ) ) )
          = V2y )
      <=> ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__divides @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( inj__ty_2Einteger_2Eint @ V2y ) ) )
          & ( V1x
            = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__div @ ( inj__ty_2Einteger_2Eint @ V2y ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) ) ) ) ) ) )).
