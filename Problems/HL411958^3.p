    ...
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( ! [V3k: tyop_2Erealax_2Ereal > $o] :
           ...
           => ( c_2Ereal__topology_2Ecompact
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V4x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V4x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V1s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V4x ) @ V3k ) ) ) ) ) )
      <=> ( ! [V5k: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V1s ) @ V5k )
             => ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2t ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V5k ) ) )
             ...
             => ( c_2Ereal__topology_2Ecompact
                @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                  @ ^ [V7x: tyop_2Erealax_2Ereal] :
                      ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V7x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V1s ) @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V0f @ V7x ) @ V6a ) ) ) ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__ALT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
...
thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__COMPACT__ALT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ V0s )
...
thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__PROPER__IMAGE__EQ,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V1s )
