...
tff(lamtp_f3355,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => mem(f3355(A_27a,V0f,V2s),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f3355,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3355(A_27a,V0f,V2s),V3x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,V3x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))))) ) ) ) )).

tff(lmtp_f3356,type,(
    f3356: ( del * $i * $i ) > $i )).

tff(lamtp_f3356,axiom,(
    ! [A_27a: del,V1g: $i] :
      ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => mem(f3356(A_27a,V1g,V2s),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f3356,axiom,(
    ! [A_27a: del,V1g: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3356(A_27a,V1g,V2s),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V4x),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1g,V4x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))))) ) ) ) )).

tff(lmtp_f3357,type,(
    f3357: ( del * $i * $i ) > $i )).

tff(lamtp_f3357,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3357(A_27a,V0f,V1g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3357,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V5x: $i] :
              ( mem(V5x,A_27a)
             => ap(f3357(A_27a,V0f,V1g),V5x) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V5x)),ap(V1g,V5x)) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__ADD__GEN,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
              ( mem(V2s,arr(A_27a,bool))
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3355(A_27a,V0f,V2s))))
                  & p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3356(A_27a,V1g,V2s)))) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3357(A_27a,V0f,V1g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V0f)),ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g))) ) ) ) ) )).
