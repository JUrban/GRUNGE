...
tff(conj_thm_2Ellist_2Ellength__rel__rules,conjecture,(
    ! [A_27a: del] :
      ( p(ap(ap(c_2Ellist_2Ellength__rel(A_27a),c_2Ellist_2ELNIL(A_27a)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
      & ! [V0h: $i] :
          ( mem(V0h,A_27a)
         => ! [V1n: tp__ty_2Enum_2Enum,V2t: $i] :
              ( mem(V2t,ty_2Ellist_2Ellist(A_27a))
             => ( p(ap(ap(c_2Ellist_2Ellength__rel(A_27a),V2t),inj__ty_2Enum_2Enum(V1n)))
               => p(ap(ap(c_2Ellist_2Ellength__rel(A_27a),ap(ap(c_2Ellist_2ELCONS(A_27a),V0h),V2t)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))) ) ) ) ) )).
