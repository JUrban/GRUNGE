...
thf(conj_thm_2Erich__list_2EEL__CONS,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V1x ) @ V2l ) )
                = ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( ap @ c_2Eprim__rec_2EPRE @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V2l ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2EDROP__EL__CONS,conjecture,(
    ! [A_27a: del,V0ls: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0ls )
            = ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0ls ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V0ls ) ) ) ) ) )).
