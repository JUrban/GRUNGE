...
thf(f3708_0_2E0,type,(
    f3708_0_2E0: u )).

thf(f3708_0_2E1,type,(
    f3708_0_2E1: du > u )).

thf(f3708_0_2E2,type,(
    f3708_0_2E2: du > du > u )).
...
thf(mono_2Ef3708_0,type,(
    mono_2Ef3708_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EBEFORE__AS__SBEFORE,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3708_0 @ V0b @ V3t )
    <=> ( (~) @ ( V0b @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EBEFORE__AS__SBEFORE,axiom,(
    ...
    <=> ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V1a @ V0b @ V2x )
        | ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ ( mono_2Ef3708_0 @ V0b ) @ V2x ) ) ) )).
...
thf(thm_2EOmega__Automata_2EBEFORE__AS__CO__BUECHI,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum > $o,V2a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V2a @ V1b @ V0t0 )
    <=> ? [V3q: mono_2Etyop_2Enum_2Enum > $o] :
          ( ( (~) @ ( V3q @ V0t0 ) )
          & ! [V4t: mono_2Etyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( (~) @ ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( (~) @ ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( (~) @ ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0t0 ) ) ) ) )
              | ( ( (~) @ ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) )
                & ( (~) @ ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0t0 ) ) ) )
          ...
          & ? [V5t1: mono_2Etyop_2Enum_2Enum] :
            ! [V6t2: mono_2Etyop_2Enum_2Enum] :
              ( ( (~) @ ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t2 @ V0t0 ) ) ) )
              | ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t2 @ V0t0 ) ) ) ) ) ) )).
