...
thf(thm_2Ecomplex_2ECOMPLEX__OF__REAL__EQ,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ecomplex_2Ecomplex__of__real @ V0x )
        = ( mono_2Ec_2Ecomplex_2Ecomplex__of__real @ V1y ) )
    <=> ( V0x = V1y ) ) )).
...
thf(thm_2Ecomplex_2ECOMPLEX__OF__NUM__EQ,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Ecomplex_2Ecomplex__of__num @ V0m )
        = ( mono_2Ec_2Ecomplex_2Ecomplex__of__num @ V1n ) )
    <=> ( V0m = V1n ) ) )).
