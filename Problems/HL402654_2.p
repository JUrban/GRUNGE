...
tff(conj_thm_2Erich__list_2EFILTER__SNOC,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(lmtp_f801,type,(
    f801: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f801,axiom,(
...
tff(conj_thm_2Erich__list_2EFOLDL__FILTER,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27a)))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
