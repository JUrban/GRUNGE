...
thf(thm_2Ereal_2EABS__SUB__ABS,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( c_2Ereal_2Eabs @ V0x ) @ ( c_2Ereal_2Eabs @ V1y ) ) ) @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V0x @ V1y ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__INTER,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        | ( c_2Ereal__topology_2Ebounded__def @ V1t ) )
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V0s @ V1t ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__RANGE,axiom,(
             ...
             => ? [V4d: tyop_2Erealax_2Ereal] :
                  ...
                  & ! [V5x_27: tyop_2Erealax_2Ereal] :
                      ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x_27 @ V1s )
                        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V5x_27 @ V2x ) ) @ V4d ) )
                     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V0f @ V5x_27 ) @ ( V0f @ V2x ) ) ) @ V3e ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__INF,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
     ...
     => ? [V2x: tyop_2Erealax_2Ereal] :
          ...
          & ! [V3y: tyop_2Erealax_2Ereal] :
             ...
             => ( c_2Ereal_2Ereal__lte @ ( V0f @ V2x ) @ ( V0f @ V3y ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EDISTANCE__ATTAINS__INF,conjecture,(
