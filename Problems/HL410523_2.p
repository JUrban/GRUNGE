...
tff(conj_thm_2Epred__set_2EEXISTS__IN__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
...
tff(conj_thm_2Eiterate_2ESUM__IMAGE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EFINITE__SUBSET__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2ELINEAR__CMUL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ELINEAR__SUM,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
               ...
               => surj__ty_2Erealax_2Ereal(ap(V0f,ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V0f),V1g))) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ESPAN__SUPERSET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESPAN__0,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESPAN__SUM,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
...
tff(conj_thm_2Ereal__topology_2EDEPENDENT__EXPLICIT,lemma,(
    ! [V0p: $i] :
...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__INJECTIVE__IMAGE__GEN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
