...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__COMPARISON,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3a: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V1g ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) @ V2s ) ) )
                    & ! [V4x: tp__ty_2Erealax_2Ereal] :
                        ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) @ V2s ) )
                       => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) ) ) )
                 => ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) @ V2s ) ) ) ) ) ) ) )).
