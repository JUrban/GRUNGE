...
thf(thm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
...
thf(thm_2ETemporal__Logic_2EBEFORE__SIMP,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
...
thf(thm_2ETemporal__Logic_2ESWHEN__SIMP,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ...
      & ( ( c_2ETemporal__Logic_2ESWHEN @ V1a
          @ ^ [V5t: tyop_2Enum_2Enum] : c_2Ebool_2EF )
        = ( ^ [V6t: tyop_2Enum_2Enum] : c_2Ebool_2EF ) )
      & ( ( c_2ETemporal__Logic_2ESWHEN @ V1a
          @ ^ [V7t: tyop_2Enum_2Enum] : c_2Ebool_2ET )
...
thf(thm_2ETemporal__Logic_2ESUNTIL__SIMP,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
...
thf(thm_2ETemporal__Logic_2ESBEFORE__SIMP,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
...
thf(thm_2EPast__Temporal__Logic_2ESIMPLIFY,conjecture,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ...
      & ( ( c_2ETemporal__Logic_2EBEFORE
          ...
          @ V0b )
        = ( c_2ETemporal__Logic_2EALWAYS
          @ ^ [V49t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V49t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V50t: tyop_2Enum_2Enum] : c_2Ebool_2ET
          @ V0b )
        = ( ^ [V51t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V51t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V1a
      ...
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V1a @ V1a )
        = ( c_2ETemporal__Logic_2EALWAYS
          @ ^ [V56t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V1a @ V56t ) ) ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPSNEXT
        ...
        = ( ^ [V63t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V63t ) ) ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPWHEN
          ...
          @ V0b )
        = ( c_2EPast__Temporal__Logic_2EPALWAYS
          @ ^ [V91t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V91t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPWHEN
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPSBEFORE
          ...
          @ V0b )
        = ( ^ [V101t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V101t ) ) ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPBEFORE
          ...
          @ V0b )
        = ( c_2EPast__Temporal__Logic_2EPALWAYS
          @ ^ [V107t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V107t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPBEFORE
          @ ^ [V108t: tyop_2Enum_2Enum] : c_2Ebool_2ET
          @ V0b )
        = ( ^ [V109t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0b @ V109t ) ) ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1a @ V1a )
        = ( c_2EPast__Temporal__Logic_2EPALWAYS
          @ ^ [V114t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V1a @ V114t ) ) ) ) ) )).
