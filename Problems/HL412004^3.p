...
thf(thm_2Elebesgue_2Elebesgue__monotone__convergence__lemma,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2fi: tyop_2Enum_2Enum > A_27a > tyop_2Eextreal_2Eextreal,V3g: A_27a > tyop_2Eextreal_2Eextreal,V4r_27: tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ! [V5i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ ( V2fi @ V5i ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) @ c_2Emeasure_2EBorel ) )
        & ! [V6x: A_27a] :
        ...
        & ! [V8x: A_27a] :
           ...
           => ( ( c_2Eextreal_2Eextreal__sup
              ...
              = ( V1f @ V8x ) ) )
        & ( c_2Ebool_2EIN @ tyop_2Eextreal_2Eextreal @ V4r_27 @ ( c_2Elebesgue_2Epsfis @ A_27a @ V0m @ V3g ) )
        & ! [V10x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( V3g @ V10x ) @ ( V1f @ V10x ) )
        & ! [V11i: tyop_2Enum_2Enum,V12x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( V2fi @ V11i @ V12x ) ) )
     => ( c_2Eextreal_2Eextreal__le @ V4r_27
        @ ( c_2Eextreal_2Eextreal__sup
          @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Eextreal_2Eextreal
