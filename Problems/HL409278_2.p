...
tff(lameq_f3203,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3203(V0f,V1g),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),ap(V1g,inj__ty_2Erealax_2Ereal(V6x))) ) ) )).

tff(conj_thm_2Eintegral_2EDINT__ADD,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4i: tp__ty_2Erealax_2Ereal,V5j: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),f3203(V0f,V1g)),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V4i)),inj__ty_2Erealax_2Ereal(V5j)))) ) ) ) )).
...
tff(conj_thm_2Eintegral_2EINTEGRAL__ADD,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
