...
thf(conj_thm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EQ__T,conjecture,(
    ! [V0v: $o] :
      ( p @ ( ap @ ( ap @ ( ap @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS @ bool ) @ ( inj__o @ V0v ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( inj__o @ V0v ) ) ) )).
