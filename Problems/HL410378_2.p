...
tff(lameq_f3638,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3638(V0f,V1g),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),ap(V1g,inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__ADD,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
