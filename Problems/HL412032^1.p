...
thf(f12267_0_2E0,type,(
    f12267_0_2E0: u )).

thf(f12267_0_2E2,type,(
    f12267_0_2E2: du > du > u )).

thf(f12267_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef12267_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( f12267_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef12267_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12267_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(def0_2Ethm_2Elebesgue_2Eintegrable__add__pos,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2g_2E0: u,V5x_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12267_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V2g_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) )
...
thf(thm_2Elebesgue_2Eintegrable__add__pos,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1f_2E0: u,V2g_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Emeasure_2Emeasure__space_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) ) ) )
        ...
        & ! [V4x_2E0: u] :
            ( mono_2Ec_2Eextreal_2Eextreal__le @ ( mono_2Ec_2Eextreal_2Eextreal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V2g_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) )
