...
thf(arityeq1_2Emono_2Ec_2Ebag_2EBAG__ALL__DISTINCT_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__ALL__DISTINCT_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ c_2Ebag_2EBAG__ALL__DISTINCT_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__ALL__DISTINCT__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__ALL__DISTINCT_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) ) ) )
      & ! [V0e_2E0: u,V1b_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__ALL__DISTINCT_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__INSERT_2E2 @ ( s @ A_27b @ V0e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ V1b_2E0 ) ) ) ) ) )
        <=> ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__IN_2E2 @ ( s @ A_27b @ V0e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ V1b_2E0 ) ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__ALL__DISTINCT_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ V1b_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Econtainer_2ELIST__TO__BAG__DISTINCT,conjecture,(
    ! [A_27a: d,V0b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__ALL__DISTINCT_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0b_2E0 ) ) ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0b_2E0 ) ) ) ) ) )).
