...
tff(conj_thm_2Efinite__map_2EFRANGE__FUPDATE__SUBSET,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V1kv: $i] :
          ( mem(V1kv,ty_2Epair_2Eprod(A_27b,A_27b))
         => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE(A_27b,A_27b),V0fm),V1kv))),ap(ap(c_2Epred__set_2EUNION(A_27a),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),V0fm)),ap(ap(c_2Epred__set_2EINSERT(A_27a),ap(c_2Epair_2ESND(A_27b,A_27b),V1kv)),c_2Epred__set_2EEMPTY(A_27a))))) ) ) )).

tff(conj_thm_2Efinite__map_2EIN__FRANGE__FUPDATE__suff,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ! [V2kv: $i] :
              ( mem(V2kv,ty_2Epair_2Eprod(A_27b,A_27b))
             => ( ( ! [V3v: $i] :
                      ( mem(V3v,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),V0fm)))
                       => p(ap(V1P,V3v)) ) )
                  & p(ap(V1P,ap(c_2Epair_2ESND(A_27b,A_27b),V2kv))) )
               => ! [V4v: $i] :
                    ( mem(V4v,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE(A_27b,A_27b),V0fm),V2kv))))
                     => p(ap(V1P,V4v)) ) ) ) ) ) ) )).
