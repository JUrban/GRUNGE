...
tff(lamtp_f926,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f926(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f926,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V2t0: tp__ty_2Enum_2Enum] : ap(f926(V1b,V0a),inj__ty_2Enum_2Enum(V2t0)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f889(V0a)),V1b),inj__ty_2Enum_2Enum(V2t0)))),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V0a),inj__ty_2Enum_2Enum(V2t0))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2ESBEFORE__AS__SUNTIL,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2ESBEFORE,V0a),V1b) = f926(V1b,V0a) ) ) )).
