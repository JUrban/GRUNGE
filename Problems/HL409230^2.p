...
thf(conj_thm_2Eintegral_2EDINT__NEG,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eintegral_2EDINT__LE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Eintegral_2EDINT__TRIANGLE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3i: tp__ty_2Erealax_2Ereal,V4j: tp__ty_2Erealax_2Ereal] :
            ...
            & ( p
              @ ( ap
                @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V5x: $i] :
                        ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V5x ) ) ) )
                @ ( inj__ty_2Erealax_2Ereal @ V4j ) ) ) )
         => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3i ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4j ) ) ) ) ) )).
