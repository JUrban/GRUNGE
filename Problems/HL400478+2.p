...
fof(conj_thm_2Erelation_2EO__MONO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1R2] :
                     ...
                     => ! [V2S1] :
                         ...
                         => ! [V3S2] :
                             ...
                             => ( ( p(ap(ap(c_2Erelation_2ERSUBSET(A_27a,A_27a),V0R1),V1R2))
                                  & p(ap(ap(c_2Erelation_2ERSUBSET(A_27c,A_27c),V2S1),V3S2)) )
                               => p(ap(ap(c_2Erelation_2ERSUBSET(A_27c,A_27c),ap(ap(c_2Erelation_2EO(A_27c,A_27c,A_27c),V0R1),V2S1)),ap(ap(c_2Erelation_2EO(A_27c,A_27c,A_27c),V1R2),V3S2))) ) ) ) ) ) ) ) ) )).
