...
fof(thm_2EordinalNotation_2Eis__ord__def,axiom,(
    ! [V0x_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eis__ord_2E1(s(tyop_2EordinalNotation_2Eosyntax,V0x_2E0))))
    <=> ! [V1is__ord_27_2E0] :
          ( ! [V2a0_2E0] :
              ( ( ? [V3k_2E0] : s(tyop_2EordinalNotation_2Eosyntax,V2a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,V3k_2E0)))
                | ? [V4e_2E0,V5k_2E0,V6t_2E0] :
                    ( s(tyop_2EordinalNotation_2Eosyntax,V2a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V4e_2E0),s(tyop_2Enum_2Enum,V5k_2E0),s(tyop_2EordinalNotation_2Eosyntax,V6t_2E0)))
                    & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V1is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V4e_2E0))))
                    & s(tyop_2EordinalNotation_2Eosyntax,V4e_2E0) != s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0)))
                    & p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0),s(tyop_2Enum_2Enum,V5k_2E0))))
                    & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V1is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V6t_2E0))))
                    & p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eoless_2E2(s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2Eexpt_2E1(s(tyop_2EordinalNotation_2Eosyntax,V6t_2E0))),s(tyop_2EordinalNotation_2Eosyntax,V4e_2E0)))) ) )
             => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V1is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V2a0_2E0)))) )
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V1is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V0x_2E0)))) ) ) )).

fof(thm_2EordinalNotation_2Eis__ord__strongind,conjecture,(
    ! [V0is__ord_27_2E0] :
      ( ( ! [V1k_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V0is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,V1k_2E0))))))
        & ! [V2e_2E0,V3k_2E0,V4t_2E0] :
            ( ( p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eis__ord_2E1(s(tyop_2EordinalNotation_2Eosyntax,V2e_2E0))))
              & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V0is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V2e_2E0))))
              ...
              & p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0),s(tyop_2Enum_2Enum,V3k_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eis__ord_2E1(s(tyop_2EordinalNotation_2Eosyntax,V4t_2E0))))
              & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V0is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V4t_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eoless_2E2(s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2Eexpt_2E1(s(tyop_2EordinalNotation_2Eosyntax,V4t_2E0))),s(tyop_2EordinalNotation_2Eosyntax,V2e_2E0)))) )
           => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V0is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V2e_2E0),s(tyop_2Enum_2Enum,V3k_2E0),s(tyop_2EordinalNotation_2Eosyntax,V4t_2E0)))))) ) )
     => ! [V5a0_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eis__ord_2E1(s(tyop_2EordinalNotation_2Eosyntax,V5a0_2E0))))
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EordinalNotation_2Eosyntax,tyop_2Emin_2Ebool),V0is__ord_27_2E0),s(tyop_2EordinalNotation_2Eosyntax,V5a0_2E0)))) ) ) )).
