...
tff(conj_thm_2Epred__set_2EUNION__COMM,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EBIGUNION__SING,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Ereal_2EREAL__EQ__LADD,lemma,(
...
tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IN__IF,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EPROB__EMPTY,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),c_2Epred__set_2EEMPTY(A_27a))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__UNIV,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(c_2Eprobability_2Ep__space(A_27a),V0p))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3u: $i] :
                 ...
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                   ...
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V3u)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t))) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EEVENTS__DIFF,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lmtp_f4237,type,(
    f4237: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4237,axiom,(
    ! [A_27a: del,A_27b: del,V2e: $i] :
      ( mem(V2e,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,arr(A_27a,bool)))
         => ! [V0p: $i] :
              ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             => mem(f4237(A_27a,A_27b,V2e,V1f,V0p),arr(A_27b,ty_2Erealax_2Ereal)) ) ) ) )).

tff(lameq_f4237,axiom,(
    ! [A_27a: del,A_27b: del,V2e: $i] :
      ( mem(V2e,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,arr(A_27a,bool)))
         => ! [V0p: $i] :
             ...
             => ! [V7x: $i] :
                  ( mem(V7x,A_27b)
                 => ap(f4237(A_27a,A_27b,V2e,V1f,V0p),V7x) = ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINTER(A_27a),V2e),ap(V1f,V7x))) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__REAL__SUM__IMAGE__FN,conjecture,(
         ...
         => ! [V2e: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                      ...
                      & ap(ap(c_2Epred__set_2EINTER(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V1f),V3s))),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) = ap(c_2Eprobability_2Ep__space(A_27a),V0p) )
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2e)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4237(A_27a,A_27b,V2e,V1f,V0p)),V3s)) ) ) ) ) ) )).
