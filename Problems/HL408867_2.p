...
tff(conj_thm_2EHolSmt_2Er246,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
         ...
         => ! [V2z: $i] :
             ...
             => ap(ap(c_2Ewords_2Eword__and(A_27a),V0x),ap(ap(c_2Ewords_2Eword__and(A_27a),V1y),V2z)) = ap(ap(c_2Ewords_2Eword__and(A_27a),V1y),ap(ap(c_2Ewords_2Eword__and(A_27a),V0x),V2z)) ) ) ) )).
