...
thf(thm_2Etoto_2Elistorder__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( A_27a > A_27a > $o ) > ( tyop_2Elist_2Elist @ A_27a ) > ( tyop_2Elist_2Elist @ A_27a ) > $o] :
      ( ( ! [V1V: A_27a > A_27a > $o,V2l: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V1V @ V2l @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V3V: A_27a > A_27a > $o,V4s: A_27a,V5m: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V3V @ ( c_2Elist_2ENIL @ A_27a ) @ ( c_2Elist_2ECONS @ A_27a @ V4s @ V5m ) )
