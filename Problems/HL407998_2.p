...
tff(conj_thm_2Eseq_2ESEQ__ABS,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2876(V0f)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))
      <=> p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0f),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).

tff(lmtp_f2879,type,(
    f2879: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2879,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f2879(V0c),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2879,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2879(V0c),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0c))),inj__ty_2Enum_2Enum(V1n)) )).

tff(conj_thm_2Eseq_2ESEQ__POWER__ABS,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2879(V0c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) )).
...
tff(conj_thm_2Eseq_2ESEQ__POWER,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0c))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
