...
thf(conj_thm_2Erich__list_2ELENGTH__FLAT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ V0l ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Elist_2ESUM @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Elist_2Elist @ A_27a ) @ ty_2Enum_2Enum ) @ ( c_2Elist_2ELENGTH @ A_27a ) ) @ V0l ) ) ) ) ) )).
