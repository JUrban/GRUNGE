...
thf(thm_2Ereal__topology_2ESYMMETRIC__CLOSURE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
     ...
     => ! [V2x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Ereal__topology_2Eclosure @ V0s ) )
         => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V2x ) @ ( c_2Ereal__topology_2Eclosure @ V0s ) ) ) ) )).
