...
tff(mem_c_2Efmapal_2Einter__merge,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efmapal_2Einter__merge(A_27a,A_27a),arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))) )).
...
tff(conj_thm_2Efmapal_2EORL__DRESTRICT__IMP,lemma,(
    ! [A_27a: del,A_27b: del,V0cmp: $i] :
      ( mem(V0cmp,ty_2Etoto_2Etoto(A_27a))
     => ! [V1l: $i] :
...
tff(conj_thm_2Efmapal_2EORWL__DRESTRICT__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0cmp: $i] :
      ( mem(V0cmp,ty_2Etoto_2Etoto(A_27a))
     => ! [V1s: $i] :
