...
tff(tp_c_2Efinite__map_2EFCARD,type,(
    c_2Efinite__map_2EFCARD: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2EFCARD,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2EFCARD(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Enum_2Enum)) )).
...
tff(conj_thm_2Efinite__map_2EFUPDATE__COMMUTES,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
         => ! [V2b: $i] :
             ...
             => ! [V3c: $i] :
                 ...
                 => ! [V4d: $i] :
                      ( mem(V4d,A_27b)
                     => ( V1a != V3c
                       => ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b))),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3c),V4d)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3c),V4d))),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b)) ) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFUPDATE__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(conj_thm_2Efinite__map_2ENOT__EQ__FEMPTY__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
         => ! [V2b: $i] :
              ( mem(V2b,A_27b)
             => c_2Efinite__map_2EFEMPTY(A_27a,A_27a) != ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b)) ) ) ) )).

tff(conj_thm_2Efinite__map_2Efmap__SIMPLE__INDUCT,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
...
tff(ax_thm_2Efinite__map_2EFCARD__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0fm)) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm))) ) )).

tff(conj_thm_2Efinite__map_2EFCARD__0__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ( surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0f)) = fo__c_2Enum_2E0
      <=> V0f = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) ) )).
...
tff(conj_thm_2Efinite__map_2ENOT__FDOM__FAPPLY__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)))
           => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0f),V1x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1x) ) ) ) )).

tff(conj_thm_2Efinite__map_2Efmap__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
         ...
         => ( ( ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f) = ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1g)
              & ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0f) = ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1g) )
          <=> V0f = V1g ) ) ) )).
