...
tff(lamtp_f1041,axiom,(
    ! [A_27a: del,A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => mem(f1041(A_27a,A_27a,V0e,V1w),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )).

tff(lameq_f1041,axiom,(
    ! [A_27a: del,A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f1041(A_27a,A_27a,V0e,V1w),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V0e)),ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Ewellorder_2EelsOf(A_27a),V1w))) ) ) ) )).

tff(ax_thm_2Ewellorder_2EADD1__def,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ap(ap(c_2Ewellorder_2EADD1(A_27a),V0e),V1w) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Ewellorder_2Ewellorder(A_27a)),ap(ap(c_2Ebool_2EIN(A_27a),V0e),ap(c_2Ewellorder_2EelsOf(A_27a),V1w))),V1w),ap(c_2Ewellorder_2Ewellorder__ABS(A_27a),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ewellorder_2Ewellorder__REP(A_27a),V1w)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),f1041(A_27a,A_27a,V0e,V1w)))),ap(ap(c_2Epred__set_2EINSERT(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0e),V0e)),c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(A_27a,A_27a)))))) ) ) )).

tff(conj_thm_2Ewellorder_2Ewellorder__ADD1,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V0e),ap(c_2Ewellorder_2EelsOf(A_27a),V1w)))
           => p(ap(c_2Ewellorder_2Ewellorder(A_27a),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ewellorder_2Ewellorder__REP(A_27a),V1w)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),f1041(A_27a,A_27a,V0e,V1w)))),ap(ap(c_2Epred__set_2EINSERT(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0e),V0e)),c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(A_27a,A_27a)))))) ) ) ) )).

tff(conj_thm_2Ewellorder_2EelsOf__ADD1,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
