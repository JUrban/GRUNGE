...
thf(f7893_0_2E0,type,(
    f7893_0_2E0: u )).

thf(f7893_0_2E2,type,(
    f7893_0_2E2: du > du > u )).

thf(f7953_0_2E0,type,(
    f7953_0_2E0: u )).

thf(f7953_0_2E1,type,(
    f7953_0_2E1: du > u )).

thf(f7953_0_2E2,type,(
    f7953_0_2E2: du > du > u )).
...
thf(mono_2Ef7893_0,type,(
    mono_2Ef7893_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef7953_0,type,(
    mono_2Ef7953_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq2_2Emono_2Ec_2Epatricia_2EPEEK_2E2_2Emono_2EA_27a,axiom,(
...
thf(thm_2Elist_2EMEM__FILTER,axiom,(
    ! [A_27a: d,V0P_2E0: u,V1L_2E0: u,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFILTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) ) ) ) ) ) ) )
...
thf(thm_2Elist_2EALL__DISTINCT__FILTER,axiom,(
    ...
    <=> ! [V1x_2E0: u] :
         ...
         => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFILTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Emin_2E_3D_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
...
thf(def0_2Ethm_2Epatricia_2EPEEK__REMOVE,axiom,(
    ! [V1k: mono_2Etyop_2Enum_2Enum,V2j: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7893_0 @ V1k @ V2j )
    <=> ( V1k = V2j ) ) )).

thf(thm_2Epatricia_2EPEEK__REMOVE,axiom,(
    ! [A_27a: d,V0t_2E0: u,V1k: mono_2Etyop_2Enum_2Enum,V2j: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epatricia_2EIS__PTREE_2E1 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ V0t_2E0 ) ) ) )
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Epatricia_2EPEEK_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ ( c_2Epatricia_2EREMOVE_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ V0t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2j ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef7893_0 @ V1k @ V2j ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Epatricia_2EPEEK_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ V0t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2j ) ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Epatricia_2EPERM__DELETE__PTREE,axiom,(
    ! [V1k: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7953_0 @ V1k @ V2x )
    <=> ( (~) @ ( V2x = V1k ) ) ) )).

thf(thm_2Epatricia_2EPERM__DELETE__PTREE,conjecture,(
    ! [V0t: mono_2Etyop_2Epatricia_2Eptree_28tyop_2Eone_2Eone_29,V1k: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( mono_2Ec_2Esorting_2EPERM_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epatricia_2ETRAVERSE_2Emono_2Etyop_2Eone_2Eone @ ( mono_2Ec_2Epatricia_2EREMOVE_2Emono_2Etyop_2Eone_2Eone @ V0t @ V1k ) ) @ ( mono_2Ec_2Elist_2EFILTER_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef7953_0 @ V1k ) @ ( mono_2Ec_2Epatricia_2ETRAVERSE_2Emono_2Etyop_2Eone_2Eone @ V0t ) ) ) ) )).
