...
fof(lamtp_f3634,axiom,(
    ! [A_27a,A_27a,V0p] :
      ( mem(V0p,arr(A_27a,A_27a))
     => ! [V3y] :
          ( mem(V3y,A_27a)
         => mem(f3634(A_27a,A_27a,V0p,V3y),arr(A_27a,bool)) ) ) )).
...
fof(lameq_f3634,axiom,(
    ! [A_27a,A_27a,V0p] :
     ...
     => ! [V3y] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3634(A_27a,A_27a,V0p,V3y),V4x) = ap(ap(c_2Emin_2E_3D(A_27a),ap(V0p,V4x)),V3y) ) ) ) )).
         ...
         => ! [V1s] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Epermutes(A_27a),V0p),V1s))
              <=> ( ! [V2x] :
                  ...
                  & ! [V3y] :
                      ( mem(V3y,A_27a)
                     => p(ap(c_2Ebool_2E_3F_21(A_27a),f3634(A_27a,A_27a,V0p,V3y))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EPERMUTES__INJECTIVE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,A_27a))
