...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1f_27: $i] :
            ( mem(V1f_27,arr(A_27a,A_27b))
           => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V1f_27),V0s),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0s)))
             => ! [V2f: $i] :
                  ( mem(V2f,arr(A_27b,ty_2Eextreal_2Eextreal))
                 => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0s))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2f),V1f_27)),V0s)) ) ) ) ) ) )).

tff(lmtp_f3462,type,(
    f3462: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3462,axiom,(
    ! [A_27a: del,A_27b: del,V3x: $i] :
      ( mem(V3x,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
         => mem(f3462(A_27a,A_27b,V3x,V0f),arr(A_27b,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3462,axiom,(
    ! [A_27a: del,A_27b: del,V3x: $i] :
      ( mem(V3x,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
         => ! [V4y: $i] :
              ( mem(V4y,A_27b)
             => ap(f3462(A_27a,A_27b,V3x,V0f),V4y) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),V4y)) ) ) ) )).

tff(lmtp_f3461,type,(
    f3461: ( del * del * $i ) > $i )).

tff(lamtp_f3461,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
     => mem(f3461(A_27b,A_27a,V0f),arr(A_27a,arr(A_27b,ty_2Eextreal_2Eextreal))) ) )).

tff(lameq_f3461,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3461(A_27b,A_27a,V0f),V3x) = f3462(A_27a,A_27b,V3x,V0f) ) ) )).

tff(lmtp_f3464,type,(
    f3464: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3464,axiom,(
    ! [A_27b: del,A_27a: del,V5y: $i] :
      ( mem(V5y,A_27b)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
         => mem(f3464(A_27b,A_27a,V5y,V0f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3464,axiom,(
    ! [A_27b: del,A_27a: del,V5y: $i] :
      ( mem(V5y,A_27b)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
         => ! [V6x: $i] :
              ( mem(V6x,A_27a)
             => ap(f3464(A_27b,A_27a,V5y,V0f),V6x) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6x),V5y)) ) ) ) )).

tff(lmtp_f3463,type,(
    f3463: ( del * del * $i ) > $i )).

tff(lamtp_f3463,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
     => mem(f3463(A_27a,A_27b,V0f),arr(A_27b,arr(A_27a,ty_2Eextreal_2Eextreal))) ) )).

tff(lameq_f3463,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
     => ! [V5y: $i] :
          ( mem(V5y,A_27b)
         => ap(f3463(A_27a,A_27b,V0f),V5y) = f3464(A_27b,A_27a,V5y,V0f) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__CROSS__SYM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Eextreal_2Eextreal))
     => ! [V1s1: $i] :
         ...
         => ! [V2s2: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s1))
               ...
               => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f3461(A_27b,A_27a,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V1s1),V2s2))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Epair_2EUNCURRY(A_27b,A_27b,A_27b),f3463(A_27a,A_27b,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V2s2),V1s1))) ) ) ) ) )).
