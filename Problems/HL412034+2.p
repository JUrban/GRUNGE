...
fof(conj_thm_2Eextreal_2Emul__not__infty,lemma,
    ( ! [V0c] :
...
fof(conj_thm_2Elebesgue_2Eintegrable__zero,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0m] :
             ...
             => ! [V1c] :
                  ( mem(V1c,A_27b)
                 => ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                   => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),k(A_27a,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)))) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Eintegrable__cmul,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
