...
fof(conj_thm_2EHolSmt_2Et027,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1p] :
          ( mem(V1p,bool)
         => ( ( V0x = ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))
            <=> p(V1p) )
