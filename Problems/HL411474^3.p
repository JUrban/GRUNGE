...
thf(thm_2Ereal__topology_2Ediameter,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ...
      = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 )
        @ ( c_2Ereal_2Esup
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
            @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
              @ ^ [V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V1x @ V2y ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EDIAMETER__BOUNDED,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
     => ( ! [V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal] :
        ...
        & ! [V3d: tyop_2Erealax_2Ereal] :
            ( ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V3d )
              & ( c_2Erealax_2Ereal__lt @ V3d @ ( c_2Ereal__topology_2Ediameter @ V0s ) ) )
           => ? [V4x: tyop_2Erealax_2Ereal,V5y: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s )
                & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5y @ V0s )
                & ( c_2Ereal_2Ereal__gt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V4x @ V5y ) ) @ V3d ) ) ) ) ) )).
