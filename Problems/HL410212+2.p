...
fof(conj_thm_2Emeasure_2EMEASURE__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  ...
                  & p(ap(c_2Epred__set_2EFINITE(A_27a),V1s)) )
               => ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3540(A_27a,A_27a,V0m)),V1s) ) ) ) ) )).
