...
thf(conj_thm_2Elebesgue_2Epsfis__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
...
thf(conj_thm_2Elebesgue_2Epsfis__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
             ...
             => ( p
                @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V3z ) ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V2a ) ) )
                  @ ( ap @ ( ap @ ( c_2Elebesgue_2Epsfis @ A_27a ) @ V0m )
                    @ ( lam @ A_27a
                      @ ^ [V4x: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V3z ) ) ) @ ( ap @ V1f @ V4x ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elebesgue_2Epsfis__sum,lemma,(
...
thf(conj_thm_2Elebesgue_2Epsfis__intro,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1a: $i] :
                          ...
                          @ ( ap @ c_2Eextreal_2ENormal
                            @ ( ap
                              @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27b )
                                @ ( lam @ A_27b
                                  @ ^ [V6i: $i] :
                                      ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2x @ V6i ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27a ) @ V0m ) @ ( ap @ V1a @ V6i ) ) ) ) )
                              @ V3P ) ) )
                        @ ( ap @ ( ap @ ( c_2Elebesgue_2Epsfis @ A_27a ) @ V0m )
                          @ ( lam @ A_27a
                            @ ^ [V7t: $i] :
                                ...
                                @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27b )
                                  @ ( lam @ A_27b
                                    @ ^ [V8i: $i] :
                                        ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ V2x @ V8i ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ ( ap @ V1a @ V8i ) ) @ V7t ) ) ) )
                                @ V3P ) ) ) ) ) ) ) ) ) ) )).
