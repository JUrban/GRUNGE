...
tff(conj_thm_2Eprobability_2EPROB__SPACE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Eprobability_2EEVENTS__COMPL,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EEVENTS__COUNTABLE__INTER,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: $i] :
          ( mem(V1c,arr(arr(A_27a,bool),bool))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              & p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,bool)),V1c),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
              & p(ap(c_2Epred__set_2Ecountable(arr(A_27a,bool)),V1c))
              & V1c != c_2Epred__set_2EEMPTY(arr(A_27a,bool)) )
