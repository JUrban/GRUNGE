...
thf(thm_2Eiterate_2ESUM__ADD__GEN,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1g: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V3x: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V3x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3x @ V2s ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) ) )
        & ( c_2Epred__set_2EFINITE @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V4x: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V4x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V2s ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V1g @ V4x ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) ) ) )
