...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__COMPONENT__GE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                      & ! [V4y] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1s))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,V3b),ap(V0f,V4y))) ) )
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),ap(c_2Ereal__topology_2Eclosure,V1s))) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,V3b),ap(V0f,V2x))) ) ) ) ) ) )).
