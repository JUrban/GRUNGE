...
thf(c_2EEncode_2Ebiprefix_2E0,type,(
    c_2EEncode_2Ebiprefix_2E0: u )).

thf(c_2EEncode_2Ebiprefix_2E2,type,(
...
thf(arityeq2_2Emono_2Ec_2EEncode_2Ebiprefix_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EEncode_2Ebiprefix_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ c_2EEncode_2Ebiprefix_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2EEncode_2Ebiprefix__def,axiom,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EEncode_2Ebiprefix_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1b_2E0 ) ) ) )
...
thf(thm_2EEncode_2Ebiprefix__cons,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u,V2c_2E0: u,V3d_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EEncode_2Ebiprefix_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1b_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2c_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3d_2E0 ) ) ) ) ) )
    <=> ( ( ( s @ A_27a @ V0a_2E0 )
          = ( s @ A_27a @ V2c_2E0 ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EEncode_2Ebiprefix_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1b_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3d_2E0 ) ) ) ) ) ) )).
