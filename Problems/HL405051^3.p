    ...
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPUNTIL @ V1a @ V0b )
        = ( ^ [V7t: tyop_2Enum_2Enum] :
              ...
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                ...
                @ ^ [V9t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1a @ V9t ) ) @ ( c_2Ebool_2E_7E @ ( V0b @ V9t ) ) )
                @ V7t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPWHEN @ V1a @ V0b )
        = ( ^ [V10t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                @ ^ [V11t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_7E @ ( V1a @ V11t ) ) @ ( c_2Ebool_2E_7E @ ( V0b @ V11t ) ) )
                @ ^ [V12t: tyop_2Enum_2Enum] :
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPSWHEN @ V1a @ V0b )
        = ( ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2EPast__Temporal__Logic_2EPSUNTIL
              @ ^ [V16t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_7E @ ( V0b @ V16t ) )
              @ ^ [V17t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_2F_5C @ ( V1a @ V17t ) @ ( V0b @ V17t ) )
              @ V15t ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V1a @ V0b )
        = ( ^ [V18t: tyop_2Enum_2Enum] :
              ( c_2EPast__Temporal__Logic_2EPSUNTIL
              @ ^ [V19t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_7E @ ( V0b @ V19t ) )
              @ ^ [V20t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_2F_5C @ ( V1a @ V20t ) @ ( c_2Ebool_2E_7E @ ( V0b @ V20t ) ) )
              @ V18t ) ) ) ) )).
    ...
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPUNTIL @ V1a @ V0b )
        = ( ^ [V9t: tyop_2Enum_2Enum] :
              ...
              @ ^ [V10t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1a @ V10t ) ) @ ( c_2Ebool_2E_7E @ ( V0b @ V10t ) ) )
              @ V9t ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSWHEN @ V1a @ V0b )
        = ( ^ [V11t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E
              @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V0b
                @ ^ [V12t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V1a @ V12t ) @ ( V0b @ V12t ) )
                @ V11t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPWHEN @ V1a @ V0b )
        = ( ^ [V13t: tyop_2Enum_2Enum] :
              ( c_2EPast__Temporal__Logic_2EPBEFORE
              ...
              @ ^ [V15t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1a @ V15t ) ) @ ( V0b @ V15t ) )
              @ V13t ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V1a @ V0b )
        = ( ^ [V16t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E
              @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V0b
                @ ^ [V17t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V1a @ V17t ) @ ( c_2Ebool_2E_7E @ ( V0b @ V17t ) ) )
                @ V16t ) ) ) ) ) )).
...
thf(thm_2EOmega__Automata_2EAUTOMATON__TEMP__CLOSURE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0phi: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o,V3Phi__R2: ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > A_27b ) @ ( tyop_2Enum_2Enum > A_27a ) ) > $o,V4Phi__R1: ( tyop_2Enum_2Enum > A_27a ) > $o,V5Phi__I2: ( tyop_2Enum_2Enum > A_27b ) > $o,V6Phi__I1: ( tyop_2Enum_2Enum > A_27a ) > $o,V7Phi__F: ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Enum_2Enum > A_27b ) ) > $o,V8Phi: ( tyop_2Enum_2Enum > $o ) > $o] :
      ( ( ? [V9q1: tyop_2Enum_2Enum > A_27a] :
            ( ( V6Phi__I1 @ V9q1 )
            & ( V4Phi__R1 @ V9q1 )
            & ? [V10q2: tyop_2Enum_2Enum > A_27b] :
                ( ( V5Phi__I2 @ V10q2 )
                & ( V3Phi__R2 @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27b ) @ ( tyop_2Enum_2Enum > A_27a ) @ V10q2 @ V9q1 ) )
                & ( V7Phi__F @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Enum_2Enum > A_27b ) @ V9q1 @ V10q2 ) ) ) )
      <=> ? [V11q1: tyop_2Enum_2Enum > A_27a,V12q2: tyop_2Enum_2Enum > A_27b] :
            ( ( V6Phi__I1 @ V11q1 )
            & ( V5Phi__I2 @ V12q2 )
            & ( V4Phi__R1 @ V11q1 )
            & ( V3Phi__R2 @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27b ) @ ( tyop_2Enum_2Enum > A_27a ) @ V12q2 @ V11q1 ) )
            & ( V7Phi__F @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Enum_2Enum > A_27b ) @ V11q1 @ V12q2 ) ) ) )
      & ( ( V8Phi @ ( c_2ETemporal__Logic_2ENEXT @ V0phi ) )
      <=> ? [V13q0: tyop_2Enum_2Enum > $o,V14q1: tyop_2Enum_2Enum > $o] :
            ( c_2Ebool_2ET
            & ! [V15t: tyop_2Enum_2Enum] :
                ( ( ( V13q0 @ V15t )
                  = ( V0phi @ V15t ) )
                & ( ( V14q1 @ V15t )
                  = ( V13q0 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
            & ( V8Phi @ V14q1 ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0phi ) )
      <=> ? [V16q: tyop_2Enum_2Enum > $o] :
            ( ( V16q @ c_2Enum_2E0 )
            & ! [V17t: tyop_2Enum_2Enum] :
                ( ( V16q @ ( c_2Earithmetic_2E_2B @ V17t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
                = ( V0phi @ V17t ) )
            & ( V8Phi @ V16q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V0phi ) )
      <=> ? [V18q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V18q @ c_2Enum_2E0 ) )
            & ! [V19t: tyop_2Enum_2Enum] :
                ( ( V18q @ ( c_2Earithmetic_2E_2B @ V19t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
                = ( V0phi @ V19t ) )
            & ( V8Phi @ V18q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPALWAYS @ V2a ) ) )
      <=> ? [V20q: tyop_2Enum_2Enum > $o] :
            ( ( V20q @ c_2Enum_2E0 )
            & ! [V21t: tyop_2Enum_2Enum] :
                ( ( V20q @ ( c_2Earithmetic_2E_2B @ V21t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( V2a @ V21t )
                  & ( V20q @ V21t ) ) )
            & ( V8Phi @ V20q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V2a ) ) )
      <=> ? [V22q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V22q @ c_2Enum_2E0 ) )
            & ! [V23t: tyop_2Enum_2Enum] :
                ( ( V22q @ ( c_2Earithmetic_2E_2B @ V23t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( V2a @ V23t )
                  | ( V22q @ V23t ) ) )
            & ( V8Phi @ V22q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V1b ) ) )
      <=> ? [V24q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V24q @ c_2Enum_2E0 ) )
            & ! [V25t: tyop_2Enum_2Enum] :
                ( ( V24q @ ( c_2Earithmetic_2E_2B @ V25t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( V1b @ V25t )
                  | ( ( V2a @ V25t )
                    & ( V24q @ V25t ) ) ) )
            & ( V8Phi @ V24q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V2a @ V1b ) ) )
      <=> ? [V26q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V26q @ c_2Enum_2E0 ) )
            & ! [V27t: tyop_2Enum_2Enum] :
                ( ( V26q @ ( c_2Earithmetic_2E_2B @ V27t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( ( V2a @ V27t )
                    & ( V1b @ V27t ) )
                  | ( ( (~) @ ( V1b @ V27t ) )
                    & ( V26q @ V27t ) ) ) )
            & ( V8Phi @ V26q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V2a @ V1b ) ) )
      <=> ? [V28q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V28q @ c_2Enum_2E0 ) )
            & ! [V29t: tyop_2Enum_2Enum] :
                ( ( V28q @ ( c_2Earithmetic_2E_2B @ V29t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( (~) @ ( V1b @ V29t ) )
                  & ( ( V2a @ V29t )
                    | ( V28q @ V29t ) ) ) )
            & ( V8Phi @ V28q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V1b ) ) )
      <=> ? [V30q: tyop_2Enum_2Enum > $o] :
            ( ( V30q @ c_2Enum_2E0 )
            & ! [V31t: tyop_2Enum_2Enum] :
                ( ( V30q @ ( c_2Earithmetic_2E_2B @ V31t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( V1b @ V31t )
                  | ( ( V2a @ V31t )
                    & ( V30q @ V31t ) ) ) )
            & ( V8Phi @ V30q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V2a @ V1b ) ) )
      <=> ? [V32q: tyop_2Enum_2Enum > $o] :
            ( ( V32q @ c_2Enum_2E0 )
            & ! [V33t: tyop_2Enum_2Enum] :
                ( ( V32q @ ( c_2Earithmetic_2E_2B @ V33t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( ( V2a @ V33t )
                    & ( V1b @ V33t ) )
                  | ( ( (~) @ ( V1b @ V33t ) )
                    & ( V32q @ V33t ) ) ) )
            & ( V8Phi @ V32q ) ) )
      & ( ( V8Phi @ ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V2a @ V1b ) ) )
      <=> ? [V34q: tyop_2Enum_2Enum > $o] :
            ( ( V34q @ c_2Enum_2E0 )
            & ! [V35t: tyop_2Enum_2Enum] :
                ( ( V34q @ ( c_2Earithmetic_2E_2B @ V35t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
              <=> ( ( (~) @ ( V1b @ V35t ) )
                  & ( ( V2a @ V35t )
                    | ( V34q @ V35t ) ) ) )
            & ( V8Phi @ V34q ) ) ) ) )).
