...
tff(conj_thm_2Eiterate_2ENSUM__UNION__NONZERO,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lamtp_f3340,axiom,(
    ! [A_27a: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => mem(f3340(A_27a,A_27a,V0f),arr(arr(A_27a,bool),ty_2Enum_2Enum)) ) )).
...
tff(lameq_f3340,axiom,(
    ! [A_27a: del,A_27a: del,V0f: $i] :
     ...
     => ! [V6t: $i] :
         ...
         => ap(f3340(A_27a,A_27a,V0f),V6t) = ap(ap(c_2Eiterate_2Ensum(A_27a),V6t),V0f) ) ) )).

tff(conj_thm_2Eiterate_2ENSUM__BIGUNION__NONZERO,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),V1s))
           ...
           => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V1s)),V0f)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(arr(A_27a,bool)),V1s),f3340(A_27a,A_27a,V0f))) ) ) ) )).
