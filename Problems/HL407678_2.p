...
tff(tp_c_2EternaryComparisons_2Enum2ordering,type,(
    c_2EternaryComparisons_2Enum2ordering: $i )).

tff(mem_c_2EternaryComparisons_2Enum2ordering,axiom,(
    mem(c_2EternaryComparisons_2Enum2ordering,arr(ty_2Enum_2Enum,ty_2EternaryComparisons_2Eordering)) )).

tff(stp_fo_c_2EternaryComparisons_2Enum2ordering,type,(
    fo__c_2EternaryComparisons_2Enum2ordering: tp__ty_2Enum_2Enum > tp__ty_2EternaryComparisons_2Eordering )).

tff(stp_eq_fo_c_2EternaryComparisons_2Enum2ordering,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] : inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2Enum2ordering(X0)) = ap(c_2EternaryComparisons_2Enum2ordering,inj__ty_2Enum_2Enum(X0)) )).
...
tff(conj_thm_2EternaryComparisons_2Eordering__eq__dec,lemma,
    ...
    <=> $false )
    & surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS))) = fo__c_2Enum_2E0
    & surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2EEQUAL))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2EGREATER))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2EternaryComparisons_2Eordering(ap(c_2EternaryComparisons_2Enum2ordering,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = fo__c_2EternaryComparisons_2ELESS
    & surj__ty_2EternaryComparisons_2Eordering(ap(c_2EternaryComparisons_2Enum2ordering,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = fo__c_2EternaryComparisons_2EEQUAL
    & surj__ty_2EternaryComparisons_2Eordering(ap(c_2EternaryComparisons_2Enum2ordering,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = fo__c_2EternaryComparisons_2EGREATER )).

tff(conj_thm_2EternaryComparisons_2Elist__compare__def,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0cmp: $i] :
          ( mem(V0cmp,arr(A_27a,arr(A_27b,ty_2EternaryComparisons_2Eordering)))
         => surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(c_2EternaryComparisons_2Elist__compare(A_27a,A_27a),V0cmp),c_2Elist_2ENIL(A_27a)),c_2Elist_2ENIL(A_27b))) = fo__c_2EternaryComparisons_2EEQUAL )
      & ! [V1v9: $i] :
         ...
         => ! [V2v8: $i] :
             ...
             => ! [V3cmp: $i] :
                 ...
                 => surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(c_2EternaryComparisons_2Elist__compare(A_27a,A_27a),V3cmp),c_2Elist_2ENIL(A_27a)),ap(ap(c_2Elist_2ECONS(A_27b),V2v8),V1v9))) = fo__c_2EternaryComparisons_2ELESS ) ) )
      & ! [V4v5: $i] :
         ...
         => ! [V5v4: $i] :
             ...
             => ! [V6cmp: $i] :
                 ...
                 => surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(c_2EternaryComparisons_2Elist__compare(A_27a,A_27a),V6cmp),ap(ap(c_2Elist_2ECONS(A_27a),V5v4),V4v5)),c_2Elist_2ENIL(A_27b))) = fo__c_2EternaryComparisons_2EGREATER ) ) )
      & ! [V7y: $i] :
          ( mem(V7y,A_27b)
         => ! [V8x: $i] :
              ( mem(V8x,A_27a)
...
tff(conj_thm_2EnumRing_2Enum__rewrites,lemma,(
...
tff(conj_thm_2EintegerRing_2Eint__rewrites,lemma,(
...
tff(conj_thm_2Efrac_2EFRAC__SUB__SUB,conjecture,(
