...
tff(mem_c_2Ebinary__ieee_2Efloat__greater__equal,axiom,(
    ! [A_27t: del,A_27w: del] : mem(c_2Ebinary__ieee_2Efloat__greater__equal(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),bool))) )).
...
tff(conj_thm_2Ebinary__ieee_2Efloat__compare__case__def,lemma,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( mem(V0v0,A_27a)
         => ! [V1v1: $i] :
...
tff(lmtp_f3148,type,(
    f3148: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3148,axiom,(
    ! [V4r1: tp__ty_2Erealax_2Ereal] : mem(f3148(V4r1),arr(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat__compare)) )).

tff(lameq_f3148,axiom,(
    ! [V4r1: tp__ty_2Erealax_2Ereal,V5r2: tp__ty_2Erealax_2Ereal] : ap(f3148(V4r1),inj__ty_2Erealax_2Ereal(V5r2)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V4r1)),inj__ty_2Erealax_2Ereal(V5r2))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2ELT)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4r1)),inj__ty_2Erealax_2Ereal(V5r2))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EEQ)),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EGT))) )).

tff(lmtp_f3147,type,(
    f3147: ( del * del * $i * tp__ty_2Ebinary__ieee_2Efloat__value ) > $i )).

tff(lamtp_f3147,axiom,(
    ! [A_27t: del,A_27w: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V3v1: tp__ty_2Ebinary__ieee_2Efloat__value] : mem(f3147(A_27t,A_27w,V1y,V3v1),arr(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat__compare)) ) )).

tff(lameq_f3147,axiom,(
    ! [A_27t: del,A_27w: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V3v1: tp__ty_2Ebinary__ieee_2Efloat__value,V4r1: tp__ty_2Erealax_2Ereal] : ap(f3147(A_27t,A_27w,V1y,V3v1),inj__ty_2Erealax_2Ereal(V4r1)) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),inj__ty_2Ebinary__ieee_2Efloat__value(V3v1)),f3148(V4r1)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1y)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EGT)),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2ELT))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EUN)) ) )).

tff(lmtp_f3146,type,(
    f3146: ( del * del * $i * $i * tp__ty_2Ebinary__ieee_2Efloat__value ) > $i )).

tff(lamtp_f3146,axiom,(
    ! [A_27t: del,A_27w: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V2v: tp__ty_2Ebinary__ieee_2Efloat__value] : mem(f3146(A_27t,A_27w,V1y,V0x,V2v),arr(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__compare)) ) ) )).

tff(lameq_f3146,axiom,(
    ! [A_27t: del,A_27w: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V2v: tp__ty_2Ebinary__ieee_2Efloat__value,V3v1: tp__ty_2Ebinary__ieee_2Efloat__value] : ap(f3146(A_27t,A_27w,V1y,V0x,V2v),inj__ty_2Ebinary__ieee_2Efloat__value(V3v1)) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),inj__ty_2Ebinary__ieee_2Efloat__value(V2v)),f3147(A_27t,A_27w,V1y,V3v1)),ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),inj__ty_2Ebinary__ieee_2Efloat__value(V3v1)),k(ty_2Erealax_2Ereal,ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2ELT)),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EGT)))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1y))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EEQ)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2ELT)),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EGT)))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EUN))),inj__ty_2Ebinary__ieee_2Efloat__compare(fo__c_2Ebinary__ieee_2EUN)) ) ) )).

tff(lmtp_f3145,type,(
    f3145: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3145,axiom,(
    ! [A_27w: del,A_27t: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => mem(f3145(A_27w,A_27t,V1y,V0x),arr(ty_2Ebinary__ieee_2Efloat__value,arr(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__compare))) ) ) )).

tff(lameq_f3145,axiom,(
    ! [A_27w: del,A_27t: del,V1y: $i] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V2v: tp__ty_2Ebinary__ieee_2Efloat__value] : ap(f3145(A_27w,A_27t,V1y,V0x),inj__ty_2Ebinary__ieee_2Efloat__value(V2v)) = f3146(A_27t,A_27w,V1y,V0x,V2v) ) ) )).
...
tff(ax_thm_2Ebinary__ieee_2Efloat__compare__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => surj__ty_2Ebinary__ieee_2Efloat__compare(ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),V0x),V1y)) = surj__ty_2Ebinary__ieee_2Efloat__compare(ap(ap(c_2Epair_2Epair__CASE(ty_2Ebinary__ieee_2Efloat__compare,ty_2Ebinary__ieee_2Efloat__compare,ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V0x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V1y))),f3145(A_27w,A_27t,V1y,V0x))) ) ) )).
...
tff(ax_thm_2Ebinary__ieee_2Efloat__greater__equal__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__greater__equal(A_27t,A_27t),V0x),V1y))
          <=> p(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(bool),ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),V0x),V1y)),inj__o(fo__c_2Ebool_2EF)),inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2EF))) ) ) ) )).

tff(conj_thm_2Elift__ieee_2Efloat__ge,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0x))
              & p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V1y)) )
           => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__greater__equal(A_27a,A_27a),V0x),V1y))
            <=> p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0x)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V1y))) ) ) ) ) )).
