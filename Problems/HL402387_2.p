...
tff(mem_c_2Estate__transformer_2EFOREACH,axiom,(
    ! [A_27a: del,A_27state: del] : mem(c_2Estate__transformer_2EFOREACH(A_27a,A_27a),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))) )).
...
tff(lmtp_f511,type,(
    f511: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f511,axiom,(
    ! [A_27state: del,A_27a: del,A_27a: del,V0R: $i] :
...
tff(lmtp_f510,type,(
    f510: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f510,axiom,(
    ! [A_27a: del,A_27state: del,A_27a: del,V1h: $i] :
      ( mem(V1h,A_27a)
     => ! [V0R: $i] :
          ( mem(V0R,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool)))
...
tff(lmtp_f509,type,(
    f509: ( del * del * del * $i ) > $i )).

tff(lamtp_f509,axiom,(
    ! [A_27a: del,A_27state: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool)))
...
tff(lmtp_f508,type,(
    f508: ( del * del * del * del ) > $i )).

tff(lamtp_f508,axiom,(
    ! [A_27state: del,A_27a: del,A_27state: del,A_27a: del] : mem(f508(A_27state,A_27a,A_27state,A_27a),arr(arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool)),bool)) )).

tff(lameq_f508,axiom,(
    ! [A_27state: del,A_27a: del,A_27state: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool)))
...
tff(lmtp_f517,type,(
    f517: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f517,axiom,(
    ! [A_27state: del,A_27a: del,A_27a: del,V7a: $i] :
...
tff(lmtp_f516,type,(
    f516: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f516,axiom,(
    ! [A_27a: del,A_27a: del,A_27state: del,A_27a: del,V7a: $i] :
      ( mem(V7a,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
     => ! [V4FOREACH: $i] :
          ( mem(V4FOREACH,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
...
tff(lmtp_f515,type,(
    f515: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f515,axiom,(
    ! [A_27state: del,A_27a: del,A_27a: del,A_27state: del,V4FOREACH: $i] :
      ( mem(V4FOREACH,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
     => ! [V6v: $i] :
...
tff(lameq_f515,axiom,(
    ! [A_27state: del,A_27a: del,A_27a: del,A_27state: del,V4FOREACH: $i] :
     ...
     => ! [V6v: $i] :
         ...
         => ! [V7a: $i] :
              ( mem(V7a,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
             => ap(f515(A_27state,A_27a,A_27a,A_27state,V4FOREACH,V6v),V7a) = ap(ap(ap(c_2Elist_2Elist__CASE(A_27a,A_27a),V6v),ap(c_2Ecombin_2EI(arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))),ap(c_2Estate__transformer_2EUNIT(A_27state,A_27state),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone)))),f516(A_27a,A_27a,A_27state,A_27a,V7a,V4FOREACH)) ) ) ) )).

tff(lmtp_f514,type,(
    f514: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f514,axiom,(
    ! [A_27state: del,A_27a: del,A_27state: del,A_27a: del,V4FOREACH: $i] :
      ( mem(V4FOREACH,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
...
tff(ax_thm_2Estate__transformer_2EFOREACH__primitive__def,axiom,(
    ! [A_27a: del,A_27state: del] : c_2Estate__transformer_2EFOREACH(A_27a,A_27a) = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))),ap(c_2Emin_2E_40(arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool))),f508(A_27state,A_27a,A_27state,A_27a))),f512(A_27state,A_27a,A_27state,A_27a)) )).

tff(conj_thm_2Estate__transformer_2EFOREACH__def,conjecture,(
    ! [A_27a: del,A_27state: del] :
      ( ! [V0a: $i] :
          ( mem(V0a,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
         => ap(c_2Estate__transformer_2EFOREACH(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),c_2Elist_2ENIL(A_27a)),V0a)) = ap(c_2Estate__transformer_2EUNIT(A_27state,A_27state),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone)) )
      & ! [V1t: $i] :
