...
thf(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__SUNTIL__THM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ! [V3d: $i] :
                 ...
                 => ( ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                      ...
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V5t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V1b ) @ V5t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V2c ) @ V5t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V6t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V6t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V6t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V7t: $i] :
                            ...
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V8t: $i] :
                                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V8t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2c @ V8t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V8t ) ) ) ) )
                              @ V7t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V9t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V9t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V2c ) @ V9t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V10t: $i] :
                            ...
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V11t: $i] :
                                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V11t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2c @ V11t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V11t ) ) ) ) )
                              @ V10t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V12t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V12t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V2c ) @ V3d ) @ V12t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V13t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V14t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V14t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V14t ) ) ) )
                                    @ V1b )
                                  @ V13t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                                      ...
                                      @ ( ap
                                        @ ( ap
                                          @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V16t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V16t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V16t ) ) ) )
                                          @ V1b )
                                        @ V15t ) ) ) )
                              @ V13t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V17t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V17t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V2c ) @ V3d ) @ V17t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V18t: $i] :
                            ( ap
                            @ ( ap @ c_2Ebool_2E_5C_2F
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V19t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V19t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V3d ) @ V19t ) ) ) ) )
                                    @ V1b )
                                  @ V18t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a )
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V21t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V21t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V3d ) @ V21t ) ) ) ) )
                                            @ V1b )
                                          @ V20t ) ) ) ) )
                              @ V18t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V22t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V22t ) ) @ ( ap @ V1b @ V22t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V23t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V2c ) @ V23t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V1b ) @ V2c ) @ V23t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V24t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V24t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V24t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V25t: $i] :
                              ...
                              @ ( ap
                                @ ( ap
                                  @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V26t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V26t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V26t ) ) ) )
                    ...
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V27t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V27t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V27t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V28t: $i] :
                              ...
                              @ ( ap
                                @ ( ap
                                  @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V29t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V29t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V29t ) ) ) )
                                  @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) )
                                @ V28t ) ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V30t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V30t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V30t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V31t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V32t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V32t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V32t ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V33t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V33t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V33t ) ) ) ) )
                                  @ V31t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                          ...
                                          @ ( ap
                                            @ ( ap
                                              @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                                @ ( lam @ ty_2Enum_2Enum
                                                  @ ^ [V35t: $i] :
                                                      ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V35t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V35t ) ) ) )
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V36t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V36t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V36t ) ) ) ) )
                                            @ V34t ) ) ) ) )
                                @ V3d )
                              @ V31t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V37t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V37t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1b ) @ V2c ) @ V37t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V38t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V39t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V39t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V39t ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V40t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V40t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V40t ) ) ) ) )
                                  @ V38t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V42t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V42t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V42t ) ) ) )
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V43t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V43t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V43t ) ) ) ) )
                                          @ V41t ) ) ) )
                                @ V3d )
                              @ V38t ) ) ) ) ) ) ) ) ) )).
