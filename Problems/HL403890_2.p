...
tff(conj_thm_2Ellist_2ELNTH__HD__LDROP,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27a,A_27a),ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll)),c_2Ellist_2ELHD(A_27a)) ) )).
