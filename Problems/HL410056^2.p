...
thf(conj_thm_2Eiterate_2EITERATE__IMAGE,lemma,(
...
thf(conj_thm_2Eproduct_2EPRODUCT__IMAGE,conjecture,(
                   ...
                   => ! [V4y: $i] :
                       ...
                       => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2s ) )
                            ...
                            & ( ( ap @ V0f @ V3x )
                              = ( ap @ V0f @ V4y ) ) )
                         => ( V3x = V4y ) ) ) )
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V2s ) ) @ V1g ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2s ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ ty_2Erealax_2Ereal @ A_27b ) @ V1g ) @ V0f ) ) ) ) ) ) ) ) )).
