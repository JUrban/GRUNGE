...
thf(conj_thm_2Eseq_2ESEQ__ABS__IMP,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Eseq_2ESER__ACONV,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p
          @ ( ap @ c_2Eseq_2Esummable
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1n: $i] :
                  ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V1n ) ) ) ) )
       => ( p @ ( ap @ c_2Eseq_2Esummable @ V0f ) ) ) ) )).

thf(conj_thm_2Eseq_2ESER__ABS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p
          @ ( ap @ c_2Eseq_2Esummable
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1n: $i] :
                  ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V1n ) ) ) ) )
       => ( p
          @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ c_2Eseq_2Esuminf @ V0f ) ) )
            @ ( ap @ c_2Eseq_2Esuminf
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2n: $i] :
                    ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V2n ) ) ) ) ) ) ) ) )).
