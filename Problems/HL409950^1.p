...
thf(f11354_0_2E0,type,(
    f11354_0_2E0: u )).

thf(f11354_0_2E1,type,(
    f11354_0_2E1: du > u )).

thf(f11354_0_2E2,type,(
    f11354_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef11354_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11354_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f11354_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef11354_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11354_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f11354_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eextreal_2EEXTREAL__SUM__IMAGE__INTER__NONZERO,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2p_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11354_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ A_27a @ V2p_2E0 ) ) ) )
    <=> ( (~)
        @ ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ A_27a @ V2p_2E0 ) ) ) )
          = ( mono_2Ec_2Eextreal_2Eextreal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) )).

thf(thm_2Eextreal_2EEXTREAL__SUM__IMAGE__INTER__NONZERO,conjecture,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
     => ! [V1f_2E0: u] :
          ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11354_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) ) ) ) ) ) ) )
