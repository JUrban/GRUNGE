...
tff(conj_thm_2Elbtree_2Emap__eq__Lf,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(conj_thm_2Elbtree_2Emap__eq__Nd,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27a))
     => ! [V1t: $i] :
          ( mem(V1t,ty_2Elbtree_2Elbtree(A_27b))
...
tff(conj_thm_2Elbtree_2Efinite__thm,lemma,(
...
tff(conj_thm_2Elbtree_2Efinite__map,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27a))
     => ! [V1t: $i] :
          ( mem(V1t,ty_2Elbtree_2Elbtree(A_27b))
