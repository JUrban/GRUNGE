...
fof(conj_thm_2Ewords_2Eword__1__lsl,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ealignment_2Ealigned__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealignment_2Ealigned__add__sub__prod,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
...
fof(conj_thm_2Ealignment_2Ealigned__add__sub__123,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0w] :
            ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
