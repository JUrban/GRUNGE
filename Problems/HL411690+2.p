...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SYM,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(lamtp_f3999,axiom,(
    ! [V1b] :
      ( mem(V1b,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,ty_2Erealax_2Ereal)
         => mem(f3999(V1b,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
fof(lameq_f3999,axiom,(
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V4x] :
              ( mem(V4x,ty_2Erealax_2Ereal)
             => ap(f3999(V1b,V0a),V4x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V0a),V4x)),V1b)) ) ) ) )).

fof(lamtp_f4000,axiom,(
    ! [V3d] :
      ( mem(V3d,ty_2Erealax_2Ereal)
     => ! [V2c] :
          ( mem(V2c,ty_2Erealax_2Ereal)
         => mem(f4000(V3d,V2c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
    ...
    ! [V3d] :
     ...
     => ! [V2c] :
         ...
         => ! [V5x] :
             ...
             => ap(f4000(V3d,V2c),V5x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5x),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V2c),V5x)),V3d)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANES,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
