...
thf(thm_2Equotient_2EK__RSP,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6x1_2E0: u,V7x2_2E0: u,V8y1_2E0: u,V9y2_2E0: u] :
              ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) @ ( s @ A_27a @ V6x1_2E0 ) ) ) @ ( s @ A_27a @ V7x2_2E0 ) ) ) )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3R2_2E0 ) @ ( s @ A_27b @ V8y1_2E0 ) ) ) @ ( s @ A_27b @ V9y2_2E0 ) ) ) ) )
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) @ ( s @ A_27a @ ( c_2Ecombin_2EK_2E2 @ ( s @ A_27a @ V6x1_2E0 ) @ ( s @ A_27b @ V8y1_2E0 ) ) ) ) ) @ ( s @ A_27a @ ( c_2Ecombin_2EK_2E2 @ ( s @ A_27a @ V7x2_2E0 ) @ ( s @ A_27b @ V9y2_2E0 ) ) ) ) ) ) ) ) ) )).
