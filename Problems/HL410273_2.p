...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__INDICATOR,lemma,(
    ! [A_27a: del,V0a: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                  ...
                  & ! [V3x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Espace(A_27a),V0a)))
                       => surj__ty_2Eextreal_2Eextreal(ap(V2f,V3x)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1A),V3x)) ) ) )
...
tff(lmtp_f3588,type,(
    f3588: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3588,axiom,(
    ! [A_27a: del,V2s: $i] :
      ( mem(V2s,arr(A_27a,bool))
     => ! [V1z: tp__ty_2Erealax_2Ereal] : mem(f3588(A_27a,V2s,V1z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3588,axiom,(
    ! [A_27a: del,V2s: $i] :
      ( mem(V2s,arr(A_27a,bool))
     => ! [V1z: tp__ty_2Erealax_2Ereal,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3588(A_27a,V2s,V1z),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V1z))),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V2s),V3x)) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__CMUL__INDICATOR,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1z: tp__ty_2Erealax_2Ereal,V2s: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
           ...
           => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),f3588(A_27a,V2s,V1z)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),c_2Emeasure_2EBorel))) ) ) ) )).
