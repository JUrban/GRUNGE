...
thf(thm_2Ereal__topology_2EEVENTUALLY__AT__POSINFINITY,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Eeventually_2Emono_2Etyop_2Erealax_2Ereal @ V0p @ mono_2Ec_2Ereal__topology_2Eat__posinfinity )
    <=> ? [V1b: mono_2Etyop_2Erealax_2Ereal] :
        ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Ereal_2Ereal__ge @ V2x @ V1b )
         => ( V0p @ V2x ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__AT__POSINFINITY,conjecture,(
