...
thf(thm_2Ebit_2EBIT__TWO__POW,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ebit_2EBIT @ V0n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1m ) )
    <=> ( V1m = V0n ) ) )).
...
thf(thm_2Ewords_2Eword__L,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum] :
