...
tff(conj_thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EINJECTIVE__IMP__ISOMETRIC,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V1s))
           ...
           => ? [V3e: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V4x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Erealax_2Ereal(V4x)))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3e)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V4x))))) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__IMAGE__SUBSPACE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
