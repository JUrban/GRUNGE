...
thf(conj_thm_2Ewords_2Eword__extract__eq__n2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1h: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__extract @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1h ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0x )
              = ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V2y ) ) )
          <=> ( V0x
              = ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2y ) ) ) ) ) ) )).
