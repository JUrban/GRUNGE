...
thf(c_2Efinite__map_2EFCARD_2E0,type,(
    c_2Efinite__map_2EFCARD_2E0: u )).

thf(c_2Efinite__map_2EFCARD_2E1,type,(
    c_2Efinite__map_2EFCARD_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Efinite__map_2EFCARD_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ tyop_2Enum_2Enum ) @ c_2Efinite__map_2EFCARD_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2ENOT__EQ__FEMPTY__FUPDATE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u] :
      ...
      @ ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 )
        = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ A_27b @ V2b_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFCARD__FEMPTY,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 ) ) ) )
      = mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Efinite__map_2EFCARD__FUPDATE,axiom,(
    ! [A_27a: d,A_27b: d,V0fm_2E0: u,V1a_2E0: u,V2b_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ A_27b @ V2b_2E0 ) ) ) ) ) ) ) )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) ) ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFCARD__0__FEMPTY,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) )
        = mono_2Ec_2Enum_2E0 )
