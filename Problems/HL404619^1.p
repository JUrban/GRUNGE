...
thf(f5312_0_2E0,type,(
    f5312_0_2E0: u )).

thf(f5312_0_2E2,type,(
    f5312_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef5312_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5312_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f5312_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efinite__map_2Eis__fmap__cases,axiom,(
    ! [A_27a: d,V5x_2E0: u,V3a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5312_0_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V3a_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V5x_2E0 )
        = ( s @ A_27a @ V3a_2E0 ) ) ) )).

thf(thm_2Efinite__map_2Eis__fmap__cases,conjecture,(
    ! [A_27a: d,A_27b: d,V0a0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efinite__map_2Eis__fmap_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V0a0_2E0 ) ) ) )
    <=> ( ! [V1x_2E0: u] :
            ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V0a0_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) )
            = ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Esum_2EINR_2E1 @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ mono_2Ec_2Eone_2Eone ) ) ) ) )
        | ? [V2f_2E0: u,V3a_2E0: u,V4b_2E0: u] :
            ( ! [V5x_2E0: u] :
                ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V0a0_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) )
                = ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5312_0_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V3a_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27b @ V4b_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V2f_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) ) )
