...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__SUC,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27a,ty_2Eoption_2Eoption(A_27b)))
         => ! [V2rs: $i] :
             ...
             => ! [V3i: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1r),V2rs)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3i))))
                <=> ( ( ap(V1r,V0v) != c_2Eoption_2ENONE(A_27b)
                      & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3i)),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V2rs))) )
                    | p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V2rs),inj__ty_2Enum_2Enum(V3i))) ) ) ) ) ) )).
...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__CONS,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1row: $i] :
