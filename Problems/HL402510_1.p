...
tff(thm_2EquantHeuristics_2ERIGHT__IMP__OR__INTRO,conjecture,(
    ! [V0x_2E0: mono_2Etyop_2Emin_2Ebool,V1t1_2E0: mono_2Etyop_2Emin_2Ebool,V2t2_2E0: mono_2Etyop_2Emin_2Ebool] :
      ( ( p(V1t1_2E0)
       => p(V2t2_2E0) )
     => ( ( p(V1t1_2E0)
          | p(V0x_2E0) )
