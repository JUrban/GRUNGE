...
thf(conj_thm_2Ellist_2ELFILTER__APPEND,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ll1: $i] :
         ...
         => ! [V2ll2: $i] :
             ...
             => ( ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V1ll1 ) )
               => ( ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1ll1 ) @ V2ll2 ) )
                  = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ V1ll1 ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ V2ll2 ) ) ) ) ) ) ) )).
