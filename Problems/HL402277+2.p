...
fof(conj_thm_2Epred__set_2EIMAGE__applied,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0y] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2f] :
                     ...
                     => ( p(ap(ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2f),V1s),V0y))
                      <=> ? [V3x] :
                            ( mem(V3x,A_27a)
                            & V0y = ap(V2f,V3x)
...
fof(conj_thm_2Elist_2ESHORTLEX__LENGTH__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Elist_2EWF__SHORTLEX__same__lengths,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Elist_2EWF__SHORTLEX,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
