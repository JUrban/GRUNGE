...
thf(thm_2Elist_2ELENGTH__FILTER__LEQ__MONO,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1Q: A_27a > $o] :
      ( ! [V2x: A_27a] :
          ( ( V0P @ V2x )
         => ( V1Q @ V2x ) )
     => ! [V3ls: tyop_2Elist_2Elist @ A_27a] :
          ( c_2Earithmetic_2E_3C_3D @ ( c_2Elist_2ELENGTH @ A_27a @ ( c_2Elist_2EFILTER @ A_27a @ V0P @ V3ls ) ) @ ( c_2Elist_2ELENGTH @ A_27a @ ( c_2Elist_2EFILTER @ A_27a @ V1Q @ V3ls ) ) ) ) )).
