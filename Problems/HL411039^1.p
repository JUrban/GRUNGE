...
thf(thm_2Ereal__topology_2ECONVERGENT__BOUNDED__MONOTONE,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
        ...
        ! [V8e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V9N: mono_2Etyop_2Enum_2Enum] :
            ! [V10n: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V9N @ V10n )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0s @ V10n ) @ V7l ) ) @ V8e ) ) ) ) )).
