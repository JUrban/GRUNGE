...
tff(conj_thm_2Epred__set_2EDISJOINT__ALT,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EPROB__INCREASING,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Eprobability_2EPROB__SUBADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3u: $i] :
                 ...
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                      ...
                      & V1s = ap(ap(c_2Epred__set_2EUNION(A_27a),V2t),V3u) )
