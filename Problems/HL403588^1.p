...
thf(thm_2Ewellorder_2EFLATTEN__LEMMA,axiom,(
    ! [A_27a: d,A_27b: d,V0g_2E0: u,V1f_2E0: u,V2s_2E0: u] :
      ( ! [V3x_2E0: u] :
         ...
         => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) )
            = ( s @ A_27a @ V3x_2E0 ) ) )
    <=> ! [V4y_2E0: u,V5x_2E0: u] :
          ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) )
            & ( ( s @ A_27b @ V4y_2E0 )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) )
         => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) @ ( s @ A_27b @ V4y_2E0 ) ) )
            = ( s @ A_27a @ V5x_2E0 ) ) ) ) )).

thf(thm_2Ewellorder_2EINJECTIVE__LEFT__INVERSE__NONEMPTY,conjecture,(
     ...
     => ( ! [V4x_2E0: u,V5y_2E0: u] :
      ...
      <=> ? [V6g_2E0: u] :
            ( ! [V7y_2E0: u] :
               ...
               => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V6g_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) )
            & ! [V8x_2E0: u] :
               ...
               => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V6g_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) )
                  = ( s @ A_27a @ V8x_2E0 ) ) ) ) ) ) )).
