...
thf(thm_2Eiterate_2ESUM__POS__LT__ALL,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
        & ! [V2i: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V2i @ V0s )
           => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V1f @ V2i ) ) ) )
     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Eiterate_2ESum @ A_27a @ V0s @ V1f ) ) ) )).
