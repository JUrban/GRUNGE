...
thf(thm_2Ealignment_2Ealigned__extract,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ V1w )
    <=> ( ( V0p = c_2Enum_2E0 )
        | ( ( c_2Ewords_2Eword__extract @ A_27a @ A_27a @ ( c_2Earithmetic_2E_2D @ V0p @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ c_2Enum_2E0 @ V1w )
          = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) ) ) )).

thf(thm_2Ealignment_2Ealigned__ge__dim,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ V0p )
     => ( ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ V1w )
      <=> ( V1w
          = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) ) ) )).
...
thf(thm_2Ewords_2EWORD__MUL__LSL,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__lsl @ A_27a @ V0a @ V1n )
      = ( c_2Ewords_2Eword__mul @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) ) @ V0a ) ) )).

thf(thm_2Ealignment_2Ealigned__mul__shift__1,conjecture,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ ( c_2Ewords_2Eword__mul @ A_27a @ ( c_2Ewords_2Eword__lsl @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0p ) @ V1w ) ) )).
