...
thf(thm_2Eiterate_2EREAL__SUP__ASCLOSE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1l: tyop_2Erealax_2Ereal,V2e: tyop_2Erealax_2Ereal] :
      ( ( ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
        & ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V3x @ V1l ) ) @ V2e ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( c_2Ereal_2Esup @ V0s ) @ V1l ) ) @ V2e ) ) )).
