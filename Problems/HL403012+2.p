...
fof(mem_c_2EindexedLists_2EMAPi__ACC,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,arr(A_27b,A_27a)),arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(A_27a),arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27a)))))) ) ) )).
...
fof(ax_thm_2EindexedLists_2EMAPi__ACC__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0f] :
               ...
               => ! [V1i] :
                   ...
                   => ! [V2a] :
                       ...
                       => ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),V1i),V2a),c_2Elist_2ENIL(A_27b)) = ap(c_2Elist_2EREVERSE(A_27a),V2a) ) ) )
            & ! [V3f] :
                   ...
                   => ! [V5a] :
                       ...
                       => ! [V6h] :
                           ...
                           => ! [V7t] :
                               ...
                               => ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V3f),V4i),V5a),ap(ap(c_2Elist_2ECONS(A_27b),V6h),V7t)) = ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V3f),ap(ap(c_2Earithmetic_2E_2B,V4i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Elist_2ECONS(A_27a),ap(ap(V3f,V4i),V6h)),V5a)),V7t) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2EindexedLists_2EMAPi__ACC__MAPi,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1n] :
                 ...
                 => ! [V2a] :
                     ...
                     => ! [V3l] :
                         ...
                         => ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),V1n),V2a),V3l) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(c_2Elist_2EREVERSE(A_27a),V2a)),ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),ap(c_2Earithmetic_2E_2B,V1n))),V3l)) ) ) ) ) ) ) )).
