...
fof(conj_thm_2Elift__ieee_2Efloat__mul__relative,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
                   ...
                   => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__mul(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b))))
                      & ? [V2e] :
...
fof(conj_thm_2Elift__machine__ieee_2Efp16__float__mul__relative,conjecture,(
    ! [V0a] :
