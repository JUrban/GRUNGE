...
tff(lmtp_f3630,type,(
    f3630: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3630,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4y: tp__ty_2Erealax_2Ereal] : mem(f3630(V0s,V1t,V4y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
tff(lameq_f3630,axiom,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4y: tp__ty_2Erealax_2Ereal,V5x: tp__ty_2Erealax_2Ereal] : ap(f3630(V0s,V1t,V4y),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V4y)),inj__ty_2Erealax_2Ereal(V5x))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4y)),V1t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V0s))) ) ) )).

tff(lmtp_f3629,type,(
    f3629: ( $i * $i ) > $i )).

tff(lamtp_f3629,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3629,axiom,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4y: tp__ty_2Erealax_2Ereal] : ap(f3629(V0s,V1t),inj__ty_2Erealax_2Ereal(V4y)) = f3630(V0s,V1t,V4y) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMS__SYM,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f3955,type,(
    f3955: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3955,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : mem(f3955(V1t,V0s,V4x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f3955,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x: tp__ty_2Erealax_2Ereal,V5y: tp__ty_2Erealax_2Ereal] : ap(f3955(V1t,V0s,V4x),inj__ty_2Erealax_2Ereal(V5y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V4x)),inj__ty_2Erealax_2Ereal(V5y))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(c_2Ereal__topology_2Eclosure,V0s))),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5y)),ap(c_2Ereal__topology_2Eclosure,V1t)))) ) ) )).

tff(lmtp_f3954,type,(
    f3954: ( $i * $i ) > $i )).

tff(lamtp_f3954,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3954,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3954(V1t,V0s),inj__ty_2Erealax_2Ereal(V4x)) = f3955(V1t,V0s,V4x) ) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSURE__SUMS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
