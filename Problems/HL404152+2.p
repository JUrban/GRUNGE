...
fof(conj_thm_2Epath_2Eel__pmap,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V0f] :
                     ...
                     => ! [V1g] :
                         ...
                         => ! [V2i] :
                             ...
                             => ! [V3p] :
                                  ( mem(V3p,ty_2Epath_2Epath(A_27a,A_27a))
                                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2i),ap(c_2Epath_2EPL(A_27a,A_27a),V3p)))
                                   => ap(ap(c_2Epath_2Eel(A_27c,A_27c),V2i),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V3p)) = ap(V0f,ap(ap(c_2Epath_2Eel(A_27a,A_27a),V2i),V3p)) ) ) ) ) ) ) ) ) ) )).
