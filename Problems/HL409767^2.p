...
thf(conj_thm_2Eiterate_2ENSUM__EQ__0__IFF,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eiterate_2ENSUM__EQ__0__IFF__NUMSEG,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
        ...
        <=> ! [V3i: tp__ty_2Enum_2Enum] :
             ...
             => ( ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3i ) ) )
                = fo__c_2Enum_2E0 ) ) ) ) )).
