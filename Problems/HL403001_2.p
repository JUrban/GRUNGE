...
tff(lmtp_f861,type,(
    f861: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f861,axiom,(
    ...
    ! [A_27d: del,A_27c: del,A_27a: del,V4p_27: $i] :
     ...
     => ! [V5g_27: $i] :
         ...
         => ! [V6r_27: $i] :
             ...
             => ! [V7x: $i] :
                  ( mem(V7x,A_27a)
                 => ap(f861(A_27d,A_27c,A_27a,V4p_27,V5g_27,V6r_27),V7x) = ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27d,A_27d,A_27d),V4p_27),ap(V5g_27,V7x)),ap(V6r_27,V7x)) ) ) ) ) )).

tff(lmtp_f862,type,(
    f862: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f862,axiom,(
...
tff(lmtp_f863,type,(
    f863: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f863,axiom,(
    ...
    ! [A_27a: del,A_27c: del,V3g: $i] :
     ...
     => ! [V5g_27: $i] :
         ...
         => ! [V4p_27: $i] :
             ...
             => ! [V9x: $i] :
                  ( mem(V9x,A_27c)
                 => ap(f863(A_27a,A_27c,V3g,V5g_27,V4p_27),V9x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V3g,ap(V4p_27,V9x))),ap(ap(V5g_27,ap(V4p_27,V9x)),V9x)) ) ) ) ) )).

tff(lmtp_f864,type,(
    f864: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f864,axiom,(
...
tff(lameq_f864,axiom,(
    ! [A_27d: del,A_27a: del,A_27c: del,V6r_27: $i] :
     ...
     => ! [V4p_27: $i] :
         ...
         => ! [V10x: $i] :
              ( mem(V10x,A_27c)
             => ap(f864(A_27d,A_27a,A_27c,V6r_27,V4p_27),V10x) = ap(ap(V6r_27,ap(V4p_27,V10x)),V10x) ) ) ) )).

tff(conj_thm_2EpatternMatches_2EPMATCH__FLATTEN__FUN__PMATCH__ROW,conjecture,(
