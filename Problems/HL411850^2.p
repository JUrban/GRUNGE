...
thf(conj_thm_2Epred__set_2EDISJOINT__SYM,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EDIFF__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EENDS__IN__SEGMENT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EDIST__IN__CLOSED__SEGMENT,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__SEGMENT,lemma,
    ( ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
        ( p @ ( ap @ c_2Ereal__topology_2Econnected @ ( ap @ c_2Ereal__topology_2Eclosed__segment @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ ( c_2Elist_2ENIL @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) ) ) ) )
    & ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
        ( p @ ( ap @ c_2Ereal__topology_2Econnected @ ( ap @ c_2Ereal__topology_2Eopen__segment @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__SUBSET,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__INTER__FRONTIER,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
              ...
              & ( ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t )
               != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )
           => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V1t ) )
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESETDIST__SUBSETS__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2s_27: $i] :
             ...
             => ! [V3t_27: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V2s_27 ) @ V0s ) )
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2s_27 ) @ V3t_27 ) ) )
...
thf(conj_thm_2Ereal__topology_2ESETDIST__SYM,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ V1t ) ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1t ) @ V0s ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESETDIST__FRONTIER,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ! [V1t: $i] :
            ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
           => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2EDISJOINT @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) )
             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) @ V1t ) ) )
                = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ V1t ) ) ) ) ) ) )
    & ! [V2s: $i] :
        ( ( mem @ V2s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ! [V3t: $i] :
           ...
           => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2EDISJOINT @ ty_2Erealax_2Ereal ) @ V2s ) @ V3t ) )
             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2s ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V3t ) ) ) )
                = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2s ) @ V3t ) ) ) ) ) ) ) )).
