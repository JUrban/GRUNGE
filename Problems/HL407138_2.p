...
tff(mem_c_2Ewords_2En2w__itself,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2En2w__itself(A_27a),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lmtp_f2258,type,(
    f2258: del > $i )).

tff(lamtp_f2258,axiom,(
    ! [A_27a: del] : mem(f2258(A_27a),arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool)),bool)) )).
...
tff(lameq_f2258,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ap(f2258(A_27a),V0R) = ap(c_2Erelation_2EWF(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0R) ) )).

tff(tp_c_2Ebasis__emit_2EfromNum,type,(
    c_2Ebasis__emit_2EfromNum: del > $i )).

tff(mem_c_2Ebasis__emit_2EfromNum,axiom,(
    ! [A_27a: del] : mem(c_2Ebasis__emit_2EfromNum(A_27a),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lmtp_f2719,type,(
    f2719: ( del * del ) > $i )).

tff(lamtp_f2719,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2719(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Ebool_2Eitself(A_27a),ty_2Efcp_2Ecart(bool,bool)))) )).

tff(lameq_f2719,axiom,(
    ! [A_27a: del,A_27a: del,V3v: tp__ty_2Enum_2Enum] : ap(f2719(A_27a,A_27a),inj__ty_2Enum_2Enum(V3v)) = k(ty_2Ebool_2Eitself(A_27a),ap(c_2Ecombin_2EI(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w__itself(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V3v)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),c_2Ebool_2Ethe__value(A_27a))))) )).

tff(lmtp_f2718,type,(
    f2718: del > $i )).

tff(lamtp_f2718,axiom,(
    ! [A_27a: del] : mem(f2718(A_27a),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2718,axiom,(
    ! [A_27a: del,V2a: $i] :
      ( mem(V2a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(f2718(A_27a),V2a) = ap(ap(c_2Epair_2Epair__CASE(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V2a),f2719(A_27a,A_27a)) ) )).

tff(ax_thm_2Ebasis__emit_2EfromNum__primitive__def,axiom,(
    ! [A_27a: del] : c_2Ebasis__emit_2EfromNum(A_27a) = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Emin_2E_40(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))),f2258(A_27a))),k(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool)),f2718(A_27a))) )).

tff(conj_thm_2Ebasis__emit_2EfromNum__def,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(c_2Ebasis__emit_2EfromNum(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),c_2Ebool_2Ethe__value(A_27a))) = ap(c_2Ewords_2En2w__itself(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V0n)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),c_2Ebool_2Ethe__value(A_27a))) )).
