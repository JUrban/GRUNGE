...
tff(mem_c_2Efcp_2Edest__cart,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efcp_2Edest__cart(A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Efcp_2Efinite__image(A_27b),A_27a))) )).
...
tff(mem_c_2Efcp_2Emk__cart,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efcp_2Emk__cart(A_27a,A_27a),arr(arr(ty_2Efcp_2Efinite__image(A_27b),A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) )).
...
tff(lameq_f1077,axiom,(
    ! [A_27a: del,V1x: $i] :
     ...
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f1077(A_27a,V1x,V0f),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Emin_2E_3D(A_27a),ap(V0f,inj__ty_2Enum_2Enum(V2n))),V1x)) ) ) )).

tff(lmtp_f1076,type,(
    f1076: ( del * $i ) > $i )).

tff(lamtp_f1076,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
...
tff(lamtp_f1075,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f1075(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,A_27a),bool)) )).
...
tff(ax_thm_2Efcp_2Efinite__index__def,axiom,(
    ! [A_27a: del] : c_2Efcp_2Efinite__index(A_27a) = ap(c_2Emin_2E_40(arr(ty_2Enum_2Enum,A_27a)),f1075(A_27a,A_27a)) )).
...
tff(ax_thm_2Efcp_2Efcp__index,axiom,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0x),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Efcp_2Edest__cart(A_27a,A_27a),V0x),ap(c_2Efcp_2Efinite__index(ty_2Efcp_2Efinite__image(A_27b)),inj__ty_2Enum_2Enum(V1i))) ) )).

tff(lmtp_f1080,type,(
    f1080: ( del * del * $i * $i ) > $i )).

tff(lamtp_f1080,axiom,(
...
tff(lameq_f1080,axiom,(
    ! [A_27b: del,A_27a: del,V0g: $i] :
     ...
     => ! [V1f: $i] :
          ( mem(V1f,ty_2Efcp_2Ecart(A_27a,A_27a))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f1080(A_27b,A_27a,V0g,V1f),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1f),inj__ty_2Enum_2Enum(V2i))),ap(V0g,inj__ty_2Enum_2Enum(V2i)))) ) ) )).

tff(lmtp_f1079,type,(
    f1079: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f1079,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,A_27b: del,V0g: $i] :
      ( mem(V0g,arr(ty_2Enum_2Enum,A_27a))
...
tff(lamtp_f1078,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del] : mem(f1078(A_27a,A_27b,A_27a),arr(arr(ty_2Enum_2Enum,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) )).

tff(lameq_f1078,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V0g: $i] :
      ( mem(V0g,arr(ty_2Enum_2Enum,A_27a))
...
tff(ax_thm_2Efcp_2EFCP,axiom,(
    ! [A_27a: del,A_27b: del] : c_2Efcp_2EFCP(A_27a,A_27a) = f1078(A_27a,A_27b,A_27a) )).

tff(conj_thm_2Efcp_2EFCP__BETA,conjecture,(
