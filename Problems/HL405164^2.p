...
thf(conj_thm_2Econtainer_2EBAG__TO__LIST__INV,lemma,(
    ! [A_27a: del,V0b: $i] :
...
thf(conj_thm_2Econtainer_2ECARD__LIST__TO__BAG,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
thf(conj_thm_2Econtainer_2EBAG__TO__LIST__CARD,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
