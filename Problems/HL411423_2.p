...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__EMPTY,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EQ__COMPONENTS__SUBSET__SING,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
