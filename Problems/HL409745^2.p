...
thf(conj_thm_2Eiterate_2EFINITE__RESTRICT,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eiterate_2ECARD__EQ__NSUM,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
...
thf(conj_thm_2Eiterate_2ENSUM__MULTICOUNT__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27b @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
                      ...
                      & ! [V4j: $i] :
                         ...
                         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V4j ) @ V2t ) )
                           => ( ( surj__ty_2Enum_2Enum
                                @ ( ap @ ( c_2Epred__set_2ECARD @ A_27a )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                    @ ( lam @ A_27a
                                      @ ^ [V5i: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V5i ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5i ) @ V1s ) ) @ ( ap @ ( ap @ V0R @ V5i ) @ V4j ) ) ) ) ) ) )
                              = ( surj__ty_2Enum_2Enum @ ( ap @ V3k @ V4j ) ) ) ) ) )
                   => ( ( surj__ty_2Enum_2Enum
                        @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V1s )
                          @ ( lam @ A_27a
                            @ ^ [V6i: $i] :
                                ...
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b )
                                  @ ( lam @ A_27b
                                    @ ^ [V7j: $i] :
                                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ V7j ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V7j ) @ V2t ) ) @ ( ap @ ( ap @ V0R @ V6i ) @ V7j ) ) ) ) ) ) ) ) )
                      = ( surj__ty_2Enum_2Enum
