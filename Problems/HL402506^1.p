...
thf(thm_2EquantHeuristics_2EUNWIND__EXISTS__THM,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1P_2E0: u] :
      ( ? [V2x_2E0: u] :
    ...
    <=> ( ! [V3x_2E0: u] :
       ...
       => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V0a_2E0 ) ) ) ) ) ) )).
