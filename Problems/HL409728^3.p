...
thf(thm_2Eiterate_2ENSUM__DELTA,conjecture,(
    ! [A_27a: $tType,V0b: tyop_2Enum_2Enum,V1s: A_27a > $o,V2a: A_27a] :
      ( ( c_2Eiterate_2Ensum @ A_27a @ V1s
        @ ^ [V3x: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ A_27a @ V3x @ V2a ) @ V0b @ c_2Enum_2E0 ) )
      = ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebool_2EIN @ A_27a @ V2a @ V1s ) @ V0b @ c_2Enum_2E0 ) ) )).
