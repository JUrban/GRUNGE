...
fof(conj_thm_2EindexedLists_2EMAPi__CONG_27,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ( V0l1 = V1l2
                           => ( ! [V4x] :
                                 ...
                                 => ! [V5n] :
                                     ...
                                     => ( V4x = ap(ap(c_2Elist_2EEL(A_27a),V5n),V1l2)
                                       => ( p(ap(ap(c_2Eprim__rec_2E_3C,V5n),ap(c_2Elist_2ELENGTH(A_27a),V1l2)))
