...
fof(conj_thm_2EerrorStateMonad_2EFOREACH__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27state] :
          ( ne(A_27state)
         => ! [V0P] :
              ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool))
             => ( ( ! [V1a] :
                      ( mem(V1a,arr(A_27a,arr(A_27state,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))))
                     => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),c_2Elist_2ENIL(A_27a)),V1a))) )
                  & ! [V2h] :
                      ( mem(V2h,A_27a)
                     => ! [V3t] :
                          ( mem(V3t,ty_2Elist_2Elist(A_27a))
                         => ! [V4a] :
                              ( mem(V4a,arr(A_27a,arr(A_27state,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))))
                             => ( p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V3t),V4a)))
                               => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2ECONS(A_27a),V2h),V3t)),V4a))) ) ) ) ) )
               => ! [V5v] :
                    ( mem(V5v,ty_2Elist_2Elist(A_27a))
                   => ! [V6v1] :
                        ( mem(V6v1,arr(A_27a,arr(A_27state,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))))
                       => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V5v),V6v1))) ) ) ) ) ) ) )).
