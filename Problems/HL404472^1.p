...
thf(f5075_0_2E0,type,(
    f5075_0_2E0: u )).

thf(f5075_0_2E3,type,(
    f5075_0_2E3: du > du > du > u )).

thf(f5075_0_2E4,type,(
...
thf(arityeq3_2Emono_2Ef5075_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f5075_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef5075_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5075_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
...
thf(def0_2Ethm_2Ecardinal_2EBIJECTIVE__INJECTIVE__SURJECTIVE,axiom,(
    ! [A_27a: d,A_27b: d,V1s_2E0: u,V0f_2E0: u,V4y_2E0: u,V5x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5075_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27b @ V4y_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) )
...
thf(thm_2Ecardinal_2EBIJECTIVE__INJECTIVE__SURJECTIVE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1s_2E0: u,V2t_2E0: u] :
      ( ( ! [V3x_2E0: u] :
        ...
        & ! [V4y_2E0: u] :
           ...
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f5075_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27b @ V4y_2E0 ) ) ) ) ) ) ) )
    <=> ( ! [V6x_2E0: u] :
        ...
        & ! [V7x_2E0: u,V8y_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
              & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V8y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
              & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) ) )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V8y_2E0 ) ) ) ) )
           => ( ( s @ A_27a @ V7x_2E0 )
              = ( s @ A_27a @ V8y_2E0 ) ) )
        & ! [V9y_2E0: u] :
           ...
           => ? [V10x_2E0: u] :
                ...
                & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V10x_2E0 ) ) )
                  = ( s @ A_27b @ V9y_2E0 ) ) ) ) ) ) )).
