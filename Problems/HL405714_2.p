...
tff(conj_thm_2Eordinal_2Eordlt__SUC__DISCRETE,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
...
tff(conj_thm_2Eordinal_2Esup__thm,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Eordinal_2Esuple__thm,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1s: $i] :
...
tff(conj_thm_2Eordinal_2EordADD__0L,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMULT__1R,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMULT__le__MONO__R,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMULT__lt__MONO__R__EQN,lemma,(
    ! [A_27a: del,V0c: $i] :
...
tff(conj_thm_2Eordinal_2EordADD__le__MONO__L,lemma,(
    ! [A_27a: del,V0y: $i] :
...
tff(conj_thm_2Eordinal_2EIFF__ZERO__lt,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ( ( V0x != ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))
        <=> p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0x)) )
...
tff(conj_thm_2Eordinal_2EordADD__EQ__0,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMULT__EQ__0,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EZERO__lt__ordEXP,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordEXP__le__MONO__R,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordEXP__continuous,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
tff(conj_thm_2Eordinal_2Eis__polyform__ELthm,lemma,(
         ...
         => ( p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V0a),V1ces))
          <=> ( ! [V2i: tp__ty_2Enum_2Enum,V3j: tp__ty_2Enum_2Enum] :
                  ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V3j)))
                    & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3j)),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),V1ces))) )
                 => p(ap(ap(c_2Eordinal_2Eordlt(A_27b),ap(c_2Epair_2ESND(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(ap(c_2Elist_2EEL(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),inj__ty_2Enum_2Enum(V3j)),V1ces))),ap(c_2Epair_2ESND(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(ap(c_2Elist_2EEL(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),inj__ty_2Enum_2Enum(V2i)),V1ces)))) )
              & ! [V4c: $i] :
...
tff(conj_thm_2Eordinal_2Epolyform__exists,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Eordinal_2Eordinal(A_27a))
