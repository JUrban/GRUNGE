...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__CLOSED__MAP,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__IMP__CLOSED__MAP,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__CLOSED__MAP__EQ,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
