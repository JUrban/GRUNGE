...
thf(thm_2EindexedLists_2EMAPi__CONG_27,conjecture,(
    ! [A_27a: d,A_27b: d,V0l2_2E0: u,V1l1_2E0: u,V2f2_2E0: u,V3f1_2E0: u] :
      ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) )
     => ( ! [V4x_2E0: u,V5n: mono_2Etyop_2Enum_2Enum] :
            ( ( ( s @ A_27a @ V4x_2E0 )
              = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) )
           => ( ( mono_2Ec_2Eprim__rec_2E_3C @ V5n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) )
             => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V3f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) ) ) @ ( s @ A_27a @ V4x_2E0 ) ) )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V2f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) ) ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) )
       => ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2EindexedLists_2EMAPi_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V3f1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2EindexedLists_2EMAPi_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V2f2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) ) )).
