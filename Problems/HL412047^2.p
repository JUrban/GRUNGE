...
thf(conj_thm_2Elebesgue_2Emeasure__space__finite__prod__measure__POW1,lemma,(
    ! [A_27a: del,A_27b: del,V0m0: $i] :
      ( ( mem @ V0m0 @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1m1: $i] :
          ( ( mem @ V1m1 @ ( ty_2Epair_2Eprod @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
...
thf(conj_thm_2Elebesgue_2Efinite__prod__measure__space__POW,lemma,(
...
thf(conj_thm_2Elebesgue_2Efinite__POW__prod__measure__reduce3,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0m0: $i] :
      ( ( mem @ V0m0 @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1m1: $i] :
          ( ( mem @ V1m1 @ ( ty_2Epair_2Eprod @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
         => ! [V2m2: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m0 ) )
                  ...
                  & ( ( ap @ ( c_2Epred__set_2EPOW @ A_27b ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27b ) @ V1m1 ) )
                    = ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27b ) @ V1m1 ) )
                  & ( ( ap @ ( c_2Epred__set_2EPOW @ A_27c ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27c ) @ V2m2 ) )
                    = ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27c ) @ V2m2 ) ) )
               => ! [V3a0: $i] :
                   ...
                   => ! [V4a1: $i] :
                       ...
                       => ! [V5a2: $i] :
                           ...
                           => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V3a0 ) @ ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V0m0 ) ) )
                             ...
                             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Eprod__measure3 @ A_27a @ A_27b @ A_27c ) @ V0m0 ) @ V1m1 ) @ V2m2 ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ V3a0 ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c ) @ V4a1 ) @ V5a2 ) ) ) )
                                = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27a ) @ V0m0 ) @ V3a0 ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27b ) @ V1m1 ) @ V4a1 ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27c ) @ V2m2 ) @ V5a2 ) ) ) ) ) ) ) ) ) ) ) ) )).
