...
tff(conj_thm_2EHolSmt_2Er243,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0y: tp__ty_2Enum_2Enum,V1x: $i] :
     ...
     => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c))))
       => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0y)),ap(c_2Ewords_2Edimword(A_27b),c_2Ebool_2Ethe__value(A_27b))))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
           => ( ap(c_2Ewords_2En2w(A_27c),inj__ty_2Enum_2Enum(V0y)) = ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V1x)
