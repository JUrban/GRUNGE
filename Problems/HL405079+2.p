...
fof(conj_thm_2Efmaptree_2Ewf__rules,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0a] :
             ...
             => ! [V1fm] :
                 ...
                 => ( ! [V2k] :
                        ( mem(V2k,A_27b)
                       => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V2k),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V1fm)))
                         => p(ap(c_2Efmaptree_2Ewf(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V1fm),V2k))) ) )
                   => p(ap(c_2Efmaptree_2Ewf(A_27a,A_27a),ap(ap(c_2Efmaptree_2Econstruct(A_27a,A_27a),V0a),V1fm))) ) ) ) ) ) )).
