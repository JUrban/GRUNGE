...
tff(conj_thm_2Epred__set_2Efinite__countable,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
...
tff(mem_c_2Elebesgue_2Eprod__measure__space3,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Elebesgue_2Eprod__measure__space3(A_27a,A_27a,A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)),arr(ty_2Epair_2Eprod(arr(A_27c,bool),arr(A_27c,bool)),ty_2Epair_2Eprod(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)))))) )).

tff(tp_c_2Elebesgue_2Eprod__sets3,type,(
    c_2Elebesgue_2Eprod__sets3: ( del * del * del ) > $i )).

tff(mem_c_2Elebesgue_2Eprod__sets3,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Elebesgue_2Eprod__sets3(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,bool),bool),arr(arr(arr(A_27b,bool),bool),arr(arr(arr(A_27c,bool),bool),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool))))) )).

tff(lmtp_f4110,type,(
    f4110: ( del * del * del * del * $i * $i * $i * $i * $i ) > $i )).

tff(lamtp_f4110,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27c: del,V0a: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                     ...
                     => mem(f4110(A_27a,A_27b,A_27c,A_27c,V0a,V1b,V2c,V3s,V4t),arr(arr(A_27c,bool),ty_2Epair_2Eprod(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)))) ) ) ) ) ) )).

tff(lameq_f4110,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27c: del,V0a: $i] :
      ( mem(V0a,arr(arr(A_27a,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V2c: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                      ( mem(V4t,arr(A_27b,bool))
                     => ! [V5u: $i] :
                          ( mem(V5u,arr(A_27c,bool))
                         => ap(f4110(A_27a,A_27b,A_27c,A_27c,V0a,V1b,V2c,V3s,V4t),V5u) = ap(ap(c_2Epair_2E_2C(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V3s),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V4t),V5u))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V3s),V0a)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V4t),V1b)),ap(ap(c_2Ebool_2EIN(arr(A_27c,bool)),V5u),V2c)))) ) ) ) ) ) ) )).

tff(lmtp_f4109,type,(
    f4109: ( del * del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f4109,axiom,(
    ! [A_27c: del,A_27c: del,A_27b: del,A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,arr(arr(A_27a,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V2c: $i] :
             ...
             => ! [V3s: $i] :
                  ( mem(V3s,arr(A_27a,bool))
                 => mem(f4109(A_27c,A_27c,A_27b,A_27a,A_27b,V0a,V1b,V2c,V3s),arr(arr(A_27b,bool),arr(arr(A_27c,bool),ty_2Epair_2Eprod(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))))) ) ) ) ) )).

tff(lameq_f4109,axiom,(
    ! [A_27c: del,A_27c: del,A_27b: del,A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,arr(arr(A_27a,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V2c: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                      ( mem(V4t,arr(A_27b,bool))
                     => ap(f4109(A_27c,A_27c,A_27b,A_27a,A_27b,V0a,V1b,V2c,V3s),V4t) = f4110(A_27a,A_27b,A_27c,A_27c,V0a,V1b,V2c,V3s,V4t) ) ) ) ) ) )).

tff(lmtp_f4108,type,(
    f4108: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4108,axiom,(
    ! [A_27b: del,A_27a: del,A_27c: del,A_27a: del,V2c: $i] :
      ( mem(V2c,arr(arr(A_27c,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V0a: $i] :
              ( mem(V0a,arr(arr(A_27a,bool),bool))
             => mem(f4108(A_27b,A_27a,A_27c,A_27a,V2c,V1b,V0a),arr(arr(A_27a,bool),arr(ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)),ty_2Epair_2Eprod(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))))) ) ) ) )).

tff(lameq_f4108,axiom,(
    ! [A_27b: del,A_27a: del,A_27c: del,A_27a: del,V2c: $i] :
      ( mem(V2c,arr(arr(A_27c,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V0a: $i] :
             ...
             => ! [V3s: $i] :
                  ( mem(V3s,arr(A_27a,bool))
                 => ap(f4108(A_27b,A_27a,A_27c,A_27a,V2c,V1b,V0a),V3s) = ap(c_2Epair_2EUNCURRY(arr(A_27b,bool),arr(A_27b,bool),arr(A_27b,bool)),f4109(A_27c,A_27c,A_27b,A_27a,A_27b,V0a,V1b,V2c,V3s)) ) ) ) ) )).
...
tff(ax_thm_2Elebesgue_2Eprod__sets3__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2c: $i] :
              ( mem(V2c,arr(arr(A_27c,bool),bool))
             => ap(ap(ap(c_2Elebesgue_2Eprod__sets3(A_27a,A_27a,A_27a),V0a),V1b),V2c) = ap(c_2Epred__set_2EGSPEC(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)),ap(c_2Epair_2EUNCURRY(arr(A_27a,bool),arr(A_27a,bool),arr(A_27a,bool)),f4108(A_27b,A_27a,A_27c,A_27a,V2c,V1b,V0a))) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,A_27c: del,V0m0: $i] :
     ...
     => ! [V1m1: $i] :
         ...
         => ! [V2m2: $i] :
             ...
             => ap(ap(ap(c_2Elebesgue_2Eprod__measure__space3(A_27a,A_27a,A_27a),V0m0),V1m1),V2m2) = ap(ap(c_2Epair_2E_2C(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m0)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(c_2Emeasure_2Em__space(A_27b),V1m1)),ap(c_2Emeasure_2Em__space(A_27c),V2m2)))),ap(ap(c_2Epair_2E_2C(arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool)),ap(c_2Emeasure_2Esubsets(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Emeasure_2Esigma(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m0)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(c_2Emeasure_2Em__space(A_27b),V1m1)),ap(c_2Emeasure_2Em__space(A_27c),V2m2)))),ap(ap(ap(c_2Elebesgue_2Eprod__sets3(A_27a,A_27a,A_27a),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m0)),ap(c_2Emeasure_2Emeasurable__sets(A_27b),V1m1)),ap(c_2Emeasure_2Emeasurable__sets(A_27c),V2m2))))),ap(ap(ap(c_2Elebesgue_2Eprod__measure3(A_27a,A_27a,A_27a),V0m0),V1m1),V2m2))) ) ) ) )).

tff(conj_thm_2Elebesgue_2Efinite__prod__measure__space__POW3,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s1: $i] :
      ( mem(V0s1,arr(A_27a,bool))
     => ! [V1s2: $i] :
          ( mem(V1s2,arr(A_27b,bool))
         => ! [V2s3: $i] :
              ( mem(V2s3,arr(A_27c,bool))
             => ! [V3u: $i] :
                  ( mem(V3u,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
                 => ! [V4v: $i] :
                      ( mem(V4v,arr(arr(A_27b,bool),ty_2Erealax_2Ereal))
                     => ! [V5w: $i] :
                          ( mem(V5w,arr(arr(A_27c,bool),ty_2Erealax_2Ereal))
                         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s1))
                              & p(ap(c_2Epred__set_2EFINITE(A_27b),V1s2))
                              & p(ap(c_2Epred__set_2EFINITE(A_27c),V2s3)) )
                           => ap(ap(ap(c_2Elebesgue_2Eprod__measure__space3(A_27a,A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s1),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Epred__set_2EPOW(A_27a),V0s1)),V3u))),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),V1s2),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),ap(c_2Epred__set_2EPOW(A_27b),V1s2)),V4v))),ap(ap(c_2Epair_2E_2C(arr(A_27c,bool),arr(A_27c,bool)),V2s3),ap(ap(c_2Epair_2E_2C(arr(arr(A_27c,bool),bool),arr(arr(A_27c,bool),bool)),ap(c_2Epred__set_2EPOW(A_27c),V2s3)),V5w))) = ap(ap(c_2Epair_2E_2C(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s1),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1s2),V2s3))),ap(ap(c_2Epair_2E_2C(arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool)),ap(c_2Epred__set_2EPOW(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s1),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1s2),V2s3)))),ap(ap(ap(c_2Elebesgue_2Eprod__measure3(A_27a,A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s1),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Epred__set_2EPOW(A_27a),V0s1)),V3u))),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),V1s2),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),ap(c_2Epred__set_2EPOW(A_27b),V1s2)),V4v))),ap(ap(c_2Epair_2E_2C(arr(A_27c,bool),arr(A_27c,bool)),V2s3),ap(ap(c_2Epair_2E_2C(arr(arr(A_27c,bool),bool),arr(arr(A_27c,bool),bool)),ap(c_2Epred__set_2EPOW(A_27c),V2s3)),V5w))))) ) ) ) ) ) ) ) )).
