...
tff(conj_thm_2Eprobability_2Ejoint__distribution__sym,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                       => surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b))) = surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27c,A_27c,A_27c),V0p),V2Y),V1X),ap(ap(c_2Epred__set_2ECROSS(A_27c,A_27c),V4b),V3a))) ) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Ejoint__distribution__pos,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
              ( mem(V2Y,arr(A_27a,A_27c))
             => ! [V3a: $i] :
                  ( mem(V3a,arr(ty_2Epair_2Eprod(A_27b,A_27b),bool))
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                      & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),V3a))) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Ejoint__distribution__le,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b))),ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V3a))) ) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Ejoint__conditional,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                       => surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V2Y),V1X),V4b),V3a)),ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V3a))) ) ) ) ) ) ) )).
