...
thf(thm_2Eoption_2EOPTION__MAP2__cong,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0x1_2E0: u,V1x2_2E0: u,V2y1_2E0: u,V3y2_2E0: u,V4f1_2E0: u,V5f2_2E0: u] :
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V0x1_2E0 )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x2_2E0 ) )
        & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V2y1_2E0 )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V3y2_2E0 ) )
        & ! [V6x_2E0: u,V7y_2E0: u] :
            ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x2_2E0 )
                = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V6x_2E0 ) ) ) )
              & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V3y2_2E0 )
                = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V7y_2E0 ) ) ) ) )
           => ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V4f1_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) @ ( s @ A_27b @ V7y_2E0 ) ) )
              = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V5f2_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) @ ( s @ A_27b @ V7y_2E0 ) ) ) ) ) )
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2EOPTION__MAP2_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V4f1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V0x1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V2y1_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2EOPTION__MAP2_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V5f2_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x2_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V3y2_2E0 ) ) ) ) ) )).
