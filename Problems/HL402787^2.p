...
thf(conj_thm_2Elist_2EAPPEND__eq__NIL,lemma,(
    ! [A_27a: del] :
      ( ! [V0l1: $i] :
...
thf(conj_thm_2Elist_2EDROP__nil,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( c_2Elist_2ENIL @ A_27a ) )
      = ( c_2Elist_2ENIL @ A_27a ) ) )).

thf(conj_thm_2Elist_2EDROP__cons,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: $i] :
      ( ( mem @ V1x @ A_27a )
     => ! [V2xs: $i] :
          ( ( mem @ V2xs @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Elist_2ETAKE__0,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0l )
        = ( c_2Elist_2ENIL @ A_27a ) ) ) )).

thf(conj_thm_2Elist_2ETAKE__DROP,lemma,(
...
thf(conj_thm_2Erich__list_2ETAKE__SEG__DROP,conjecture,(
