...
tff(thm_2Ellist_2Eexists__strong__ind,axiom,(
    ! [A_27a: d,V0P_2E0: u,V1Q_2E0: u] :
     ...
     => ! [V6a0_2E0: u] :
         ...
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool),V1Q_2E0),s(tyop_2Ellist_2Ellist(A_27a),V6a0_2E0))))) ) ) )).
...
tff(thm_2Ellist_2Eexists__LDROP,conjecture,(
    ! [A_27a: d,V0ll_2E0: u,V1P_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0)))))
    <=> ? [V2n_2E0: mono_2Etyop_2Enum_2Enum,V3a_2E0: u,V4t_2E0: u] :
          ( s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V2n_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELCONS_2E2(s(A_27a,V3a_2E0),s(tyop_2Ellist_2Ellist(A_27a),V4t_2E0)))))
          & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V3a_2E0))))) ) ) )).
