...
fof(conj_thm_2Eint__arith_2Eelim__le__coeffs,lemma,(
    ! [V0m] :
...
fof(mem_c_2Einteger__word_2Esaturate__w2sw,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Einteger__word_2Esaturate__w2sw(A_27a,A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) ) )).
...
fof(ax_thm_2Einteger__word_2Esaturate__w2sw__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0w] :
              ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
             => ap(c_2Einteger__word_2Esaturate__w2sw(A_27a,A_27a),V0w) = ap(c_2Einteger__word_2Esaturate__i2sw(A_27b),ap(c_2Einteger_2Eint__of__num,ap(c_2Ewords_2Ew2n(A_27a),V0w))) ) ) ) )).

fof(conj_thm_2Einteger__word_2Esaturate__w2sw,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0w] :
              ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
             => ap(c_2Einteger__word_2Esaturate__w2sw(A_27a,A_27a),V0w) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Ewords_2Eword__ls(A_27a),ap(c_2Ewords_2Ew2w(A_27b,A_27b),c_2Ewords_2Eword__H(A_27b))),V0w))),c_2Ewords_2Eword__H(A_27b)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) ) ) ) )).
