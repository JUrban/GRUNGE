...
tff(conj_thm_2Ellist_2ELNTH__LDROP,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( mem(V1l,ty_2Ellist_2Ellist(A_27a))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ( ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l) = ap(c_2Eoption_2ESOME(A_27a),V2x)
           => ap(c_2Ellist_2ELHD(A_27a),ap(c_2Eoption_2ETHE(ty_2Ellist_2Ellist(A_27a)),ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l))) = ap(c_2Eoption_2ESOME(A_27a),V2x) ) ) ) )).
