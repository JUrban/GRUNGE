...
thf(conj_thm_2Equotient_2EEXISTS__UNIQUE__REGULAR,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1E: $i] :
         ...
         => ! [V2Q: $i] :
             ...
             => ( ( ! [V3x: $i] :
                      ( ( mem @ V3x @ A_27a )
                     => ( ( p @ ( ap @ V0P @ V3x ) )
                       => ( ( p @ ( ap @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V1E ) @ V3x ) )
                          & ( p @ ( ap @ V2Q @ V3x ) ) ) ) )
                  & ! [V4x: $i] :
                      ( ( mem @ V4x @ A_27a )
                     => ! [V5y: $i] :
                          ( ( mem @ V5y @ A_27a )
                         => ( ( ( p @ ( ap @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V1E ) @ V4x ) )
                              & ( p @ ( ap @ V2Q @ V4x ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V1E ) @ V5y ) )
                              & ( p @ ( ap @ V2Q @ V5y ) ) )
                           => ( p @ ( ap @ ( ap @ V1E @ V4x ) @ V5y ) ) ) ) ) )
