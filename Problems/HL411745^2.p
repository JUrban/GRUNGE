...
thf(conj_thm_2Ereal__topology_2ESUMS__EQ,lemma,(
     ...
     => ! [V2g: $i] :
         ...
         => ! [V3k: $i] :
             ...
             => ( ( ! [V4x: tp__ty_2Enum_2Enum] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V4x ) ) )
                        = ( surj__ty_2Erealax_2Ereal @ ( ap @ V2g @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ESUMS__0,conjecture,(
    ! [V0f: $i] :
