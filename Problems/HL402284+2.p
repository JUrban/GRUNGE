...
fof(conj_thm_2Elist_2ESUM__MAP__PLUS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
         => ! [V1g] :
             ...
             => ! [V2ls] :
                 ...
                 => ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),f453(A_27a,V0f,V1g)),V2ls)) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2ls))),ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1g),V2ls))) ) ) ) ) )).
