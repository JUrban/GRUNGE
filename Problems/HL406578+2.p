...
fof(mem_c_2Esptree_2Emk__wf,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Esptree_2Emk__wf(A_27a),arr(ty_2Esptree_2Espt(A_27a),ty_2Esptree_2Espt(A_27a))) ) )).
...
fof(conj_thm_2Esptree_2Ewf__mk__wf,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
...
fof(conj_thm_2Esptree_2Elookup__mk__wf,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
         ...
         => ! [V1t] :
             ...
             => ap(ap(c_2Esptree_2Elookup(A_27a),V0x),ap(c_2Esptree_2Emk__wf(A_27a),V1t)) = ap(ap(c_2Esptree_2Elookup(A_27a),V0x),V1t) ) ) ) )).

fof(conj_thm_2Esptree_2Emk__wf__eq,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t1] :
          ( mem(V0t1,ty_2Esptree_2Espt(A_27a))
         => ! [V1t2] :
             ...
             => ( ap(c_2Esptree_2Emk__wf(A_27a),V0t1) = ap(c_2Esptree_2Emk__wf(A_27a),V1t2)
              <=> ! [V2x] :
                   ...
                   => ap(ap(c_2Esptree_2Elookup(A_27a),V2x),V0t1) = ap(ap(c_2Esptree_2Elookup(A_27a),V2x),V1t2) ) ) ) ) ) )).
