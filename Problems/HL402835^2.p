...
thf(conj_thm_2Erich__list_2Ecommon__prefixes__PAIR,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ A_27b )
         => ! [V2xs: $i] :
             ...
             => ! [V3b: $i] :
                 ...
                 => ! [V4ys: $i] :
                     ...
                     => ( ( ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0x ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) )
                          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
                        & ( ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0x ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) )
                          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
                        & ( ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V1a ) @ V2xs ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V3b ) @ V4ys ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27b ) ) ) ) )
                          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( c_2Elist_2ENIL @ A_27b ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ ( ty_2Elist_2Elist @ A_27b ) @ bool ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ V1a ) @ V3b ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Elist_2Elist @ A_27b ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V1a ) ) @ ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27b ) ) @ V2xs ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27b ) ) @ V4ys ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27b ) ) ) ) ) ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27b ) ) ) ) ) ) ) ) ) ) ) )).
