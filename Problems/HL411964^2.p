...
thf(conj_thm_2Ereal__topology_2EDEPENDENT__CHOICE,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__NONEMPTY__OPEN__INTER,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EBAIRE,conjecture,(
    ! [V0g: $i] :
