...
tff(lmtp_f3330,type,(
    f3330: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3330,axiom,(
...
tff(lmtp_f3332,type,(
    f3332: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3332,axiom,(
    ! [A_27b: del,A_27a: del,V2s: $i] :
      ( mem(V2s,arr(A_27a,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => ! [V4y: $i] :
              ( mem(V4y,A_27b)
             => mem(f3332(A_27b,A_27a,V2s,V0f,V4y),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V4y: $i] :
             ...
             => ! [V5x: $i] :
                  ( mem(V5x,A_27a)
                 => ap(f3332(A_27b,A_27a,V2s,V0f,V4y),V5x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V5x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V5x),V2s)),ap(ap(c_2Emin_2E_3D(A_27b),ap(V0f,V5x)),V4y))) ) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__EQ__0,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(lmtp_f3375,type,(
    f3375: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3375,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
...
tff(conj_thm_2Eiterate_2ESUM__IMAGE__GEN,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),f3375(A_27a,A_27b,V0f,V2s,V1g))) ) ) ) ) )).

tff(lmtp_f3376,type,(
    f3376: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3376,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V1g: $i] :
              ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
             => mem(f3376(A_27a,A_27b,V0f,V2s,V1g),arr(A_27b,ty_2Erealax_2Ereal)) ) ) ) )).

tff(lameq_f3376,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V1g: $i] :
             ...
             => ! [V4y: $i] :
                  ( mem(V4y,A_27b)
                 => ap(f3376(A_27a,A_27b,V0f,V2s,V1g),V4y) = ap(ap(c_2Eiterate_2ESum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3332(A_27b,A_27a,V2s,V0f,V4y))),V1g) ) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__GROUP,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),V3t)) )
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27b),V3t),f3376(A_27a,A_27b,V0f,V2s,V1g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g)) ) ) ) ) ) )).
