...
fof(conj_thm_2Elim_2ECONT__CONST,lemma,(
    ! [V0k] :
...
fof(lameq_f2909,axiom,(
    ! [V0f] :
     ...
     => ! [V2x] :
         ...
         => ap(f2909(V0f),V2x) = ap(c_2Erealax_2Einv,ap(V0f,V2x)) ) ) )).

fof(conj_thm_2Elim_2ECONT__INV,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Elim_2Econtl,V0f),V1x))
           ...
           => p(ap(ap(c_2Elim_2Econtl,f2909(V0f)),V1x)) ) ) ) )).
...
fof(conj_thm_2Elim_2ECONT__SUB,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x] :
             ...
             => ( ( p(ap(ap(c_2Elim_2Econtl,V0f),V2x))
               ...
               => p(ap(ap(c_2Elim_2Econtl,f2910(V0f,V1g)),V2x)) ) ) ) ) )).

fof(conj_thm_2Elim_2ECONT__BOUNDED,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
...
fof(conj_thm_2Elim_2ECONT__HASSUP,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Elim_2ECONT__ATTAINS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
