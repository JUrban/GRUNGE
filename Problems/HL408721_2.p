...
tff(conj_thm_2Einteger_2EINT__LE__RADD,lemma,(
...
tff(conj_thm_2EHolSmt_2Er100,conjecture,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
      ( p(ap(ap(c_2Einteger_2Eint__gt,inj__ty_2Einteger_2Eint(V0x)),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V1y)),inj__ty_2Einteger_2Eint(V2z))))
    <=> ~ p(ap(ap(c_2Einteger_2Eint__ge,ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V2z)),ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Einteger_2Eint(V0x)))),ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V1y)))) ) )).
