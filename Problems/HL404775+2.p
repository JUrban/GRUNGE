...
fof(conj_thm_2Efinite__map_2EFUNION__ASSOC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2h] :
                     ...
                     => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V1g),V2h)) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g)),V2h) ) ) ) ) ) )).
