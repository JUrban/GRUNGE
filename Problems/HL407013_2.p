...
tff(conj_thm_2Ewords_2EZERO__LT__UINT__MAX,lemma,(
...
tff(mem_c_2Einteger__word_2Esaturate__i2w,axiom,(
    ! [A_27a: del] : mem(c_2Einteger__word_2Esaturate__i2w(A_27a),arr(ty_2Einteger_2Eint,ty_2Efcp_2Ecart(bool,bool))) )).

tff(ax_thm_2Einteger__word_2Esaturate__i2w__def,axiom,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] : ap(c_2Einteger__word_2Esaturate__i2w(A_27a),inj__ty_2Einteger_2Eint(V0i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger__word_2EUINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Einteger_2Eint(V0i))),c_2Ewords_2Eword__T(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__lt,inj__ty_2Einteger_2Eint(V0i)),ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ewords_2En2w(A_27a),ap(c_2Einteger_2ENum,inj__ty_2Einteger_2Eint(V0i))))) )).

tff(conj_thm_2Einteger__word_2EUINT__MAX,lemma,(
...
tff(conj_thm_2Einteger__word_2Esaturate__i2sw,conjecture,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] : ap(c_2Einteger__word_2Esaturate__i2w(A_27a),inj__ty_2Einteger_2Eint(V0i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__lt,inj__ty_2Einteger_2Eint(V0i)),ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ewords_2Esaturate__n2w(A_27a),ap(c_2Einteger_2ENum,inj__ty_2Einteger_2Eint(V0i)))) )).
