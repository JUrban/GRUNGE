...
tff(conj_thm_2Eordinal_2EordEXP__lt__MONO__R,lemma,(
    ! [A_27a: del,V0y: $i] :
...
tff(lamtp_f2161,axiom,(
    ! [A_27a: del] : mem(f2161(A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) )).

tff(lameq_f2161,axiom,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ap(f2161(A_27a),V0x) = ap(ap(c_2Emin_2E_3D(ty_2Eordinal_2Eordinal(A_27a)),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0x)),V0x) ) )).

tff(ax_thm_2Eordinal_2Eepsilon0__def,axiom,(
    ! [A_27a: del] : c_2Eordinal_2Eepsilon0(A_27a) = ap(c_2Eordinal_2Eoleast(A_27a),f2161(A_27a)) )).

tff(conj_thm_2Eordinal_2Eepsilon0__fixpoint,lemma,(
...
tff(conj_thm_2Eordinal_2Eepsilon0__least__fixpoint,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
