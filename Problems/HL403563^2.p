...
thf(conj_thm_2Ewellorder_2EelsOf__remove,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
         => ( ( ap @ ( c_2Ewellorder_2EelsOf @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewellorder_2Eremove @ A_27a ) @ V0e ) @ V1w ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27a ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27a ) @ V1w ) ) @ V0e ) ) ) ) )).
