...
tff(conj_thm_2Epred__set_2EITSET__THM,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2b: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
               => ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V1f),V0s),V2b) = ap(ap(ap(c_2Ebool_2ECOND(A_27b),ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V0s),c_2Epred__set_2EEMPTY(A_27a))),V2b),ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V1f),ap(c_2Epred__set_2EREST(A_27a),V0s)),ap(ap(V1f,ap(c_2Epred__set_2ECHOICE(A_27a),V0s)),V2b))) ) ) ) ) )).
...
tff(lamtp_f3171,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => mem(f3171(A_27a,V0f,V2e),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3171,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ! [V3acc: tp__ty_2Erealax_2Ereal] : ap(f3171(A_27a,V0f,V2e),inj__ty_2Erealax_2Ereal(V3acc)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V2e)),inj__ty_2Erealax_2Ereal(V3acc)) ) ) )).

tff(lmtp_f3170,type,(
    f3170: ( del * $i ) > $i )).

tff(lamtp_f3170,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3170(A_27a,V0f),arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
tff(lameq_f3170,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ap(f3170(A_27a,V0f),V2e) = f3171(A_27a,V0f,V2e) ) ) )).
...
tff(ax_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__DEF,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V0f),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),f3170(A_27a,V0f)),V1s),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__THM,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
