...
tff(conj_thm_2Ereal__topology_2EIMAGE__CLOSURE__SUBSET,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
               ...
               => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eclosure,V1s))),V2t)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__COMPONENT__LE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                & ! [V4y: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4y)),V1s))
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Erealax_2Ereal(V4y))),inj__ty_2Erealax_2Ereal(V3b))) )
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Ereal__topology_2Eclosure,V1s))) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V3b))) ) ) ) )).
