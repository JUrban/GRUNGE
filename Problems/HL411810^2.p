...
thf(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__BOUNDED,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__EQ__EVENTUALLY,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET__BILINEAR,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
         => ! [V2N: tp__ty_2Enum_2Enum,V3k: tp__ty_2Enum_2Enum,V4m: tp__ty_2Enum_2Enum] :
              ( ( ( p
                  @ ( ap @ c_2Ereal__topology_2Ebounded__def
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V5n: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ V5n ) ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V5n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )
             ...
             => ( p
                @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V3k ) ) )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V7n: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1g @ V7n ) ) @ ( ap @ V0f @ V7n ) ) ) ) ) ) ) ) )).
