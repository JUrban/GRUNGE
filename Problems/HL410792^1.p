...
thf(thm_2Ereal__topology_2EOPEN__SUBSET__INTERIOR,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V0s @ ( mono_2Ec_2Ereal__topology_2Einterior @ V1t ) )
        = ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V0s @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2ECLOSURE__CLOSURE,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Eclosure @ ( mono_2Ec_2Ereal__topology_2Eclosure @ V0s ) )
...
thf(thm_2Ereal__topology_2EINTERIOR__CLOSURE__IDEMP,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Einterior @ ( mono_2Ec_2Ereal__topology_2Eclosure @ ( mono_2Ec_2Ereal__topology_2Einterior @ ( mono_2Ec_2Ereal__topology_2Eclosure @ V0s ) ) ) )
