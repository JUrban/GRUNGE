...
tff(conj_thm_2Equotient_2ECOND__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
         => ! [V2rep: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => ! [V3a: tp__o,V4b: $i] :
                   ...
                   => ! [V5c: $i] :
                        ( mem(V5c,A_27b)
                       => ap(ap(ap(c_2Ebool_2ECOND(A_27b),inj__o(V3a)),V4b),V5c) = ap(V1abs,ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V3a)),ap(V2rep,V4b)),ap(V2rep,V5c))) ) ) ) ) ) ) )).
