...
thf(thm_2Emeasure_2ESIGMA__POW,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( c_2Emeasure_2Esigma @ A_27a @ V0s @ ( c_2Epred__set_2EPOW @ A_27a @ V0s ) )
      = ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ V0s @ ( c_2Epred__set_2EPOW @ A_27a @ V0s ) ) ) )).
