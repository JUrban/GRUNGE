...
tff(f6505_0_2E0,type,(
    f6505_0_2E0: 
      !>[A_27a: $tType] : tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool))) )).

tff(f6505_0_2E1,type,(
    f6505_0_2E1: 
      !>[A_27a: $tType] :
        ( tyop_2Eordinal_2Eordinal(A_27a) > tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool)) ) )).

tff(f6505_0_2E2,type,(
    f6505_0_2E2: 
      !>[A_27a: $tType] :
        ( ( tyop_2Eordinal_2Eordinal(A_27a) * tyop_2Eordinal_2Eordinal(A_27a) ) > tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool) ) )).
...
tff(arityeq1_2Ef6505_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: $tType,X0_2E0: tyop_2Eordinal_2Eordinal(A_27a)] : f6505_0_2E1(A_27a,X0_2E0) = app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool)),f6505_0_2E0(A_27a),X0_2E0) )).

tff(arityeq2_2Ef6505_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: $tType,X0_2E0: tyop_2Eordinal_2Eordinal(A_27a),X1_2E0: tyop_2Eordinal_2Eordinal(A_27a)] : f6505_0_2E2(A_27a,X0_2E0,X1_2E0) = app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Epair_2Eprod(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool)),f6505_0_2E0(A_27a),X0_2E0),X1_2E0) )).
...
tff(def0_2Ethm_2Eordinal_2Epreds__def,axiom,(
    ! [A_27a: $tType,V0w_2E0: tyop_2Eordinal_2Eordinal(A_27a),V1w0_2E0: tyop_2Eordinal_2Eordinal(A_27a)] : f6505_0_2E2(A_27a,V0w_2E0,V1w0_2E0) = c_2Epair_2E_2C_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool,V1w0_2E0,c_2Eordinal_2Eordlt_2E2(A_27a,V1w0_2E0,V0w_2E0)) )).

tff(thm_2Eordinal_2Epreds__def,axiom,(
    ! [A_27a: $tType,V0w_2E0: tyop_2Eordinal_2Eordinal(A_27a)] : c_2Eordinal_2Epreds_2E1(A_27a,V0w_2E0) = c_2Epred__set_2EGSPEC_2E1(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),f6505_0_2E1(A_27a,V0w_2E0)) )).
...
tff(thm_2Eordinal_2Epreds__0,conjecture,(
    ! [A_27a: $tType] : c_2Eordinal_2Epreds_2E1(A_27a,c_2Eordinal_2EfromNat_2E1(A_27a,c_2Enum_2E0_2E0)) = c_2Epred__set_2EEMPTY_2E0(tyop_2Eordinal_2Eordinal(A_27a)) )).
