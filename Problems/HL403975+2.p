...
fof(conj_thm_2Ellist_2ENOT__LFINITE__NO__LENGTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
          ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELFINITE__LGENLIST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
...
fof(lameq_f1248,axiom,(
    ! [A_27a,V0l] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f1248(A_27a,V0l),V1n) = ap(ap(c_2Elist_2EEL(A_27a),ap(ap(c_2Earithmetic_2EMOD,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l))),V0l) ) ) )).
...
fof(conj_thm_2Ellist_2ELLENGTH__LREPEAT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
