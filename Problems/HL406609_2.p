...
tff(conj_thm_2Ebool_2ERES__EXISTS__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(lamtp_f2443,axiom,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => mem(f2443(A_27a,V0phi),arr(ty_2Elist_2Elist(A_27a),bool)) ) )).

tff(lameq_f2443,axiom,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ! [V2w: $i] :
          ( mem(V2w,ty_2Elist_2Elist(A_27a))
         => ap(f2443(A_27a,V0phi),V2w) = ap(V0phi,V2w) ) ) )).

tff(lmtp_f2444,type,(
    f2444: ( del * $i * $i ) > $i )).

tff(lamtp_f2444,axiom,(
    ! [A_27a: del,V3x: $i] :
      ( mem(V3x,A_27a)
     => ! [V0phi: $i] :
          ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
         => mem(f2444(A_27a,V3x,V0phi),arr(ty_2Elist_2Elist(A_27a),bool)) ) ) )).
...
tff(lameq_f2444,axiom,(
    ! [A_27a: del,V3x: $i] :
     ...
     => ! [V0phi: $i] :
          ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
         => ! [V4w: $i] :
              ( mem(V4w,ty_2Elist_2Elist(A_27a))
             => ap(f2444(A_27a,V3x,V0phi),V4w) = ap(V0phi,ap(ap(c_2Elist_2ECONS(A_27a),V3x),V4w)) ) ) ) )).

tff(conj_thm_2EEncodeVar_2Eof__length__exists__suc,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))),f2443(A_27a,V0phi)))
        <=> ? [V3x: $i] :
              ( mem(V3x,A_27a)
              & p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),inj__ty_2Enum_2Enum(V1n))),f2444(A_27a,V3x,V0phi))) ) ) ) )).
