...
thf(conj_thm_2Ereal__topology_2ECLOSED__FORALL__IN,lemma,(
    ! [A_27a: del,V0P: $i] :
                    ...
                    @ ( ap @ c_2Ereal__topology_2EClosed
                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ V1Q @ V2a ) @ V3x ) ) ) ) ) ) ) )
           => ( p
              @ ( ap @ c_2Ereal__topology_2EClosed
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V4x: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V4x )
                        @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5a: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V0P @ V5a ) ) @ ( ap @ ( ap @ V1Q @ V5a ) @ V4x ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSED__FORALL,conjecture,(
    ! [A_27a: del,V0Q: $i] :
           ...
           => ( p
              @ ( ap @ c_2Ereal__topology_2EClosed
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ V0Q @ V1a ) @ V2x ) ) ) ) ) ) )
       => ( p
          @ ( ap @ c_2Ereal__topology_2EClosed
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
