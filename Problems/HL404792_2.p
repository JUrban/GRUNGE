...
tff(conj_thm_2Elist_2ELIST__REL__CONS1,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1h: $i] :
          ( mem(V1h,A_27a)
...
tff(conj_thm_2Efinite__map_2Efmap__rel__FUPDATE__same,lemma,(
...
tff(conj_thm_2Efinite__map_2Efmap__rel__FUPDATE__LIST__same,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1ls1: $i] :
