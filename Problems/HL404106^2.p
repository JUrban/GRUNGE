...
thf(conj_thm_2Earithmetic_2ELESS__MULT2,lemma,(
...
thf(conj_thm_2Ebag_2EBAG__GEN__PROD__UNION,lemma,(
    ! [V0b1: $i] :
     ...
     => ! [V1b2: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b1 ) )
           ...
           => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ ty_2Enum_2Enum ) @ V0b1 ) @ V1b2 ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
...
thf(conj_thm_2EprimeFactor_2EPRIME__FACTORS__MULT,conjecture,(
