...
tff(tp_c_2Ebag_2EBAG__EVERY,type,(
    c_2Ebag_2EBAG__EVERY: del > $i )).

tff(mem_c_2Ebag_2EBAG__EVERY,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__EVERY(A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,ty_2Enum_2Enum),bool))) )).
...
tff(tp_c_2Ebag_2EBAG__IMAGE,type,(
    c_2Ebag_2EBAG__IMAGE: ( del * del ) > $i )).

tff(mem_c_2Ebag_2EBAG__IMAGE,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ebag_2EBAG__IMAGE(A_27a,A_27a),arr(arr(A_27b,A_27a),arr(arr(A_27b,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)))) )).
...
tff(conj_thm_2Ebag_2EBAG__cases,lemma,(
    ! [A_27a: del,V0b: $i] :
...
tff(conj_thm_2Ebag_2EBAG__INSERT__ONE__ONE,lemma,(
    ! [A_27a: del,V0b1: $i] :
...
tff(conj_thm_2Ebag_2EBAG__INSERT__commutes,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e1: $i] :
          ( mem(V1e1,A_27a)
...
tff(conj_thm_2Ebag_2EBAG__INSERT__EQUAL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,A_27a)
     => ! [V1M: $i] :
...
tff(conj_thm_2Ebag_2EFINITE__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__CARD__EMPTY,lemma,(
    ! [A_27a: del] : surj__ty_2Enum_2Enum(ap(c_2Ebag_2EBAG__CARD(A_27a),c_2Ebag_2EEMPTY__BAG(A_27a))) = fo__c_2Enum_2E0 )).
...
tff(lamtp_f973,axiom,(
    ! [A_27b: del] : mem(f973(A_27b),arr(arr(A_27b,ty_2Enum_2Enum),ty_2Enum_2Enum)) )).

tff(lameq_f973,axiom,(
    ! [A_27b: del,V3sb: $i] :
      ( mem(V3sb,arr(A_27b,ty_2Enum_2Enum))
     => ap(f973(A_27b),V3sb) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(c_2Ebag_2EFINITE__BAG(A_27b),V3sb)),ap(c_2Ebag_2EBAG__CARD(A_27b),V3sb)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))) ) )).

tff(lmtp_f974,type,(
    f974: ( del * del * $i * $i ) > $i )).

tff(lamtp_f974,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(ax_thm_2Ebag_2EBAG__IMAGE__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27b,ty_2Enum_2Enum))
...
tff(ax_thm_2Ebag_2EBAG__EVERY,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
         => ( ap(ap(c_2Ebag_2EBAG__FILTER(A_27a),V0P),V1b) = c_2Ebag_2EEMPTY__BAG(A_27a)
          <=> p(ap(ap(c_2Ebag_2EBAG__EVERY(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Ebool_2E_7E),V0P)),V1b)) ) ) ) )).

tff(conj_thm_2Ebag_2ESET__OF__BAG__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27b,ty_2Enum_2Enum))
         => ap(c_2Ebag_2ESET__OF__BAG(A_27a),ap(ap(c_2Ebag_2EBAG__IMAGE(A_27a,A_27a),V0f),V1b)) = ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V0f),ap(c_2Ebag_2ESET__OF__BAG(A_27b),V1b)) ) ) )).
