...
tff(conj_thm_2Ecardinal_2ECARD__EQ__BIJECTIONS,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__EQ__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__IMP__CARD__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__FINITE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
           ...
           => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V0s),V1t))
            <=> surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(ty_2Erealax_2Ereal),V0s)) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(ty_2Erealax_2Ereal),V1t)) ) ) ) ) )).
