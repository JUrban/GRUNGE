...
thf(c_2Eiterate_2EFINREC_2E0,type,(
    c_2Eiterate_2EFINREC_2E0: u )).

thf(c_2Eiterate_2EFINREC_2E5,type,(
    c_2Eiterate_2EFINREC_2E5: du > du > du > du > du > u )).
...
thf(thm_2Eiterate_2EFINREC__def,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0f_2E0: u,V1b_2E0: u,V2s_2E0: u,V3a_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eiterate_2EFINREC_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V1b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ A_27b @ V3a_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) )
        <=> ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 )
              = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) )
            & ( ( s @ A_27b @ V3a_2E0 )
              = ( s @ A_27b @ V1b_2E0 ) ) ) )
      & ! [V4f_2E0: u,V5b_2E0: u,V6s_2E0: u,V7a_2E0: u,V8n: mono_2Etyop_2Enum_2Enum] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eiterate_2EFINREC_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V4f_2E0 ) @ ( s @ A_27b @ V5b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V6s_2E0 ) @ ( s @ A_27b @ V7a_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V8n ) ) ) ) ) )
        <=> ? [V9x_2E0: u,V10c_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V9x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V6s_2E0 ) ) ) )
              & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eiterate_2EFINREC_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V4f_2E0 ) @ ( s @ A_27b @ V5b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EDELETE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V6s_2E0 ) @ ( s @ A_27a @ V9x_2E0 ) ) ) @ ( s @ A_27b @ V10c_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V8n ) ) ) ) )
              & ( ( s @ A_27b @ V7a_2E0 )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V4f_2E0 ) @ ( s @ A_27a @ V9x_2E0 ) ) ) @ ( s @ A_27b @ V10c_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EFINREC__EXISTS__LEMMA,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1b_2E0: u,V2s_2E0: u] :
     ...
     => ? [V3a_2E0: u,V4n: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eiterate_2EFINREC_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V1b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ A_27b @ V3a_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) ) ) )).
