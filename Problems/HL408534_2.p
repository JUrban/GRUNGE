...
tff(conj_thm_2Ebinary__ieee_2Eround__roundTowardNegative__minus__infinity,lemma,(
...
tff(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardNegative__minus__infinity,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: tp__o,V1y: $i] :
     ...
     => ! [V2x: tp__ty_2Erealax_2Ereal] :
         ...
         => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTowardNegative)),inj__o(V0b)),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) )).
