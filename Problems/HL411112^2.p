...
thf(conj_thm_2Ereal__topology_2ECLOSED__IMP__FIP,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
              ...
              & ? [V3t: $i] :
                  ...
                  & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V3t ) @ V1f ) )
                  & ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V3t ) ) )
              & ! [V4f_27: $i] :
                  ( ( mem @ V4f_27 @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V4f_27 ) )
                      & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V4f_27 ) @ V1f ) ) )
                   => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V4f_27 ) )
                     != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )
           => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V1f ) )
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__IMP__FIP__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
              & ! [V2t: $i] :
                  ( ( mem @ V2t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2t ) @ V1f ) )
                   => ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V2t ) ) ) )
              & ! [V3f_27: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V3f_27 ) )
                   ...
                   => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V3f_27 ) )
                     != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )
           => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V1f ) )
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).
