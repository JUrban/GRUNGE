...
thf(thm_2Ebag_2EEL__BAG__BAG__INSERT,conjecture,(
    ! [A_27a: $tType,V0y: A_27a,V1x: A_27a,V2b: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__INSERT @ A_27a @ V1x @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
        = ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0y @ V2b ) )
    <=> ( ( V1x = V0y )
        & ( V2b
          = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) )).
