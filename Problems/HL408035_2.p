...
tff(conj_thm_2Ereal_2ESUP__EPSILON,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
...
tff(ax_thm_2Eseq_2Emono__increasing__def,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eseq_2Emono__increasing__converges__to__sup,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1r: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Eseq_2Emono__increasing,V0f))
            & p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0f),inj__ty_2Erealax_2Ereal(V1r))) )
         => V1r = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Esup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) )).
