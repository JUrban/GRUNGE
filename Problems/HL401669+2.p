...
fof(conj_thm_2Epred__set_2EIN__GSPEC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0s] :
         ...
         => ! [V4n] :
             ...
             => ap(f276(A_27a,V1f,V0s),V4n) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V1f,V4n)),ap(ap(c_2Eprim__rec_2E_3C,V4n),ap(c_2Epred__set_2ECARD(A_27a),V0s))) ) ) ) )).

fof(conj_thm_2Epred__set_2EFINITE__ISO__NUM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
           ...
           => ? [V1f] :
                ...
                & ! [V2n] :
                   ...
                   => ! [V3m] :
                       ...
                       => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V2n),ap(c_2Epred__set_2ECARD(A_27a),V0s)))
                            & p(ap(ap(c_2Eprim__rec_2E_3C,V3m),ap(c_2Epred__set_2ECARD(A_27a),V0s))) )
                         => ( ap(V1f,V2n) = ap(V1f,V3m)
                           => V2n = V3m ) ) ) )
