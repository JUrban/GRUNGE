...
thf(conj_thm_2Efinite__map_2EFAPPLY__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2Efinite__map_2EFUPDATE__COMMUTES,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ A_27a )
...
thf(conj_thm_2Efinite__map_2EFUPDATE__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ A_27a )
...
thf(conj_thm_2Efinite__map_2ENOT__EQ__FEMPTY__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ A_27a )
...
thf(conj_thm_2Efinite__map_2Efmap__SIMPLE__INDUCT,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
...
thf(conj_thm_2Efinite__map_2EFCARD__0__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
...
thf(conj_thm_2Efinite__map_2ENOT__FDOM__FAPPLY__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Efinite__map_2Efmap__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1g: $i] :
