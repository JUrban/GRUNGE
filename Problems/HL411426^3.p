...
thf(thm_2Ereal__topology_2ECOMPONENTS__MAXIMAL,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2c: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2c @ ( c_2Ereal__topology_2Ecomponents @ V0s ) )
        & ( c_2Ereal__topology_2Econnected @ V1t )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1t @ V0s )
        & ( (~)
          @ ( ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V2c @ V1t )
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )
     => ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1t @ V2c ) ) )).
