...
tff(conj_thm_2Ecardinal_2Ecardeq__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eordinal_2Epreds__lt__PSUBSET,lemma,(
    ! [A_27a: del,V0w1: $i] :
...
tff(conj_thm_2Eordinal_2Epreds__surj,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eordinal_2Eno__maximal__ordinal,conjecture,(
    ! [A_27a: del,V0a: $i] :
