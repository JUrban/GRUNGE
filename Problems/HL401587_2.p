...
tff(conj_thm_2Ebool_2ESELECT__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ELINV__OPT__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2y: $i] :
             ...
             => ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ( ap(ap(ap(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),V0f),V1s),V2y) = ap(c_2Eoption_2ESOME(A_27a),V3x)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                      & ap(V0f,V3x) = V2y ) ) ) ) ) ) )).
