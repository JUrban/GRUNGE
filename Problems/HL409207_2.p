...
tff(conj_thm_2Eintegral_2EDIVISION__BOUNDS,lemma,(
    ! [V0d: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => ! [V3n: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),ap(V0d,inj__ty_2Enum_2Enum(V3n))))
              & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,inj__ty_2Enum_2Enum(V3n))),inj__ty_2Erealax_2Ereal(V2b))) ) ) ) )).

tff(conj_thm_2Eintegral_2ETDIV__BOUNDS,conjecture,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
