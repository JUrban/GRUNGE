...
tff(lamtp_f3625,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(arr(A_27a,bool),bool))
     => mem(f3625(A_27a,A_27a,V0s),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).
...
tff(lameq_f3625,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
     ...
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
         => ap(f3625(A_27a,A_27a,V0s),V1t) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EDIFF(A_27a),c_2Epred__set_2EUNIV(A_27a)),V1t)),ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1t),V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EBIGINTER__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(arr(A_27a,bool),bool))
     => ap(c_2Epred__set_2EBIGINTER(A_27a),V0s) = ap(ap(c_2Epred__set_2EDIFF(A_27a),c_2Epred__set_2EUNIV(A_27a)),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f3625(A_27a,A_27a,V0s)))) ) )).

tff(conj_thm_2Ereal__topology_2EBIGUNION__BIGINTER,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(arr(A_27a,bool),bool))
     => ap(c_2Epred__set_2EBIGUNION(A_27a),V0s) = ap(ap(c_2Epred__set_2EDIFF(A_27a),c_2Epred__set_2EUNIV(A_27a)),ap(c_2Epred__set_2EBIGINTER(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f3625(A_27a,A_27a,V0s)))) ) )).
...
tff(conj_thm_2Ereal__topology_2EOPEN__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(ax_thm_2Ereal__topology_2Egdelta,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Egdelta,V0s))
      <=> ? [V1g: $i] :
            ( mem(V1g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
            & p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V1g))
            & ! [V2u: $i] :
                ( mem(V2u,arr(ty_2Erealax_2Ereal,bool))
               => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2u),V1g))
                 => p(ap(c_2Ereal__topology_2EOpen,V2u)) ) )
            & ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),V1g) = V0s ) ) ) )).

tff(ax_thm_2Ereal__topology_2Efsigma,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Efsigma,V0s))
      <=> ? [V1g: $i] :
            ( mem(V1g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
            & p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V1g))
            & ! [V2c: $i] :
                ( mem(V2c,arr(ty_2Erealax_2Ereal,bool))
               => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2c),V1g))
                 => p(ap(c_2Ereal__topology_2EClosed,V2c)) ) )
            & ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V1g) = V0s ) ) ) )).

tff(conj_thm_2Ereal__topology_2EGDELTA__COMPLEMENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Egdelta,ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),V0s)))
      <=> p(ap(c_2Ereal__topology_2Efsigma,V0s)) ) ) )).
