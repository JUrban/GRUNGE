...
thf(thm_2Esptree_2Esubspt__def,axiom,(
    ! [A_27a: d,V0sp1_2E0: u,V1sp2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Esubspt_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1sp2_2E0 ) ) ) )
    <=> ! [V2k: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2k @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp1_2E0 ) ) ) ) )
         => ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2k @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1sp2_2E0 ) ) ) ) )
            & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2k ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1sp2_2E0 ) ) )
              = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2k ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp1_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Esptree_2Esubspt__refl,conjecture,(
    ! [A_27a: d,V0sp_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Esubspt_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp_2E0 ) ) ) ) )).
