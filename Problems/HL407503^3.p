      ...
      = ( c_2Erealax_2Ereal__neg
        @ ( c_2Ereal_2Esup
          @ ^ [V1r: tyop_2Erealax_2Ereal] :
              ( V0p @ ( c_2Erealax_2Ereal__neg @ V1r ) ) ) ) ) )).

thf(thm_2Ereal_2EREAL__LE__SUP,axiom,(
...
thf(thm_2Ereal_2EREAL__INF__LE,conjecture,(
    ! [V0p: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
      ( ( ? [V2y: tyop_2Erealax_2Ereal] :
            ( V0p @ V2y )
        & ? [V3y: tyop_2Erealax_2Ereal] :
          ! [V4z: tyop_2Erealax_2Ereal] :
            ( ( V0p @ V4z )
           => ( c_2Ereal_2Ereal__lte @ V3y @ V4z ) ) )
     => ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Einf @ V0p ) @ V1x )
      <=> ! [V5y: tyop_2Erealax_2Ereal] :
            ( ! [V6z: tyop_2Erealax_2Ereal] :
                ( ( V0p @ V6z )
               => ( c_2Ereal_2Ereal__lte @ V5y @ V6z ) )
           => ( c_2Ereal_2Ereal__lte @ V5y @ V1x ) ) ) ) )).
