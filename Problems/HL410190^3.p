...
thf(thm_2Emeasure_2ESIGMA__PROPERTY,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1p: ( A_27a > $o ) > $o,V2a: ( A_27a > $o ) > $o] :
      ( ( ( c_2Emeasure_2Esubset__class @ A_27a @ V0sp @ V1p )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V1p )
        ...
        & ! [V4c: ( A_27a > $o ) > $o] :
            ( ( ( c_2Epred__set_2Ecountable @ ( A_27a > $o ) @ V4c )
              & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ V4c @ ( c_2Epred__set_2EINTER @ ( A_27a > $o ) @ V1p @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V2a ) ) ) ) )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V4c ) @ V1p ) ) )
...
thf(thm_2Emeasure_2ESPACE__SIGMA,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1a: ( A_27a > $o ) > $o] :
      ( ( c_2Emeasure_2Espace @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1a ) )
      = V0sp ) )).
...
thf(thm_2Emeasure_2EMEASURABLE__SIGMA,conjecture,(
