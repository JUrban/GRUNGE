...
thf(conj_thm_2Ebag_2EBAG__INN__0,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27a )
...
thf(conj_thm_2Ebag_2EBAG__INN__BAG__UNION,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1e: $i] :
     ...
     => ! [V2b1: $i] :
         ...
         => ! [V3b2: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V1e ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2b1 ) @ V3b2 ) ) )
              <=> ? [V4m1: tp__ty_2Enum_2Enum,V5m2: tp__ty_2Enum_2Enum] :
                    ( ( V0n
                      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V4m1 ) ) @ ( inj__ty_2Enum_2Enum @ V5m2 ) ) ) )
                    & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V1e ) @ ( inj__ty_2Enum_2Enum @ V4m1 ) ) @ V2b1 ) )
                    & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V1e ) @ ( inj__ty_2Enum_2Enum @ V5m2 ) ) @ V3b2 ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EBAG__EXTENSION,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EBAG__INN__BAG__FILTER,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
...
thf(conj_thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27a )
         => ! [V2s: $i] :
              ( ( mem @ V2s @ ( arr @ A_27a @ bool ) )
             => ( ( ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1e ) @ V2s )
              ...
              <=> ? [V3b0: $i] :
                    ...
                    & ? [V4eb: $i] :
                        ...
                        & ( V0b
                          = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V4eb ) @ V3b0 ) )
                        & ( V2s
                          = ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ V3b0 ) )
                        & ! [V5e_27: $i] :
                            ( ( mem @ V5e_27 @ A_27a )
