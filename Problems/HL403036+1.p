...
fof(arityeq1_2Ef3425_0_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),X0_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),f3425_0_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0))) )).
...
fof(arityeq2_2Ec_2EindexedLists_2EfupdLast_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) = s(tyop_2Elist_2Elist(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27a),tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a))),c_2EindexedLists_2EfupdLast_2E0),s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0))),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) )).
...
fof(thm_2EindexedLists_2EfupdLast__def,axiom,(
    ! [A_27a] :
      ( ! [V0f_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)
      & ! [V1h_2E0,V2f_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V1h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(A_27a,V1h_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)))
      & ! [V3v5_2E0,V4v4_2E0,V5h_2E0,V6f_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V6f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V5h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V4v4_2E0),s(tyop_2Elist_2Elist(A_27a),V3v5_2E0))))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V5h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V6f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V4v4_2E0),s(tyop_2Elist_2Elist(A_27a),V3v5_2E0))))))) ) )).
...
fof(def0_2Ethm_2EindexedLists_2EfupdLast__FRONT__LAST,axiom,(
    ! [A_27a,V0l_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))))
    <=> s(tyop_2Elist_2Elist(A_27a),V0l_2E0) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0) ) )).

fof(thm_2EindexedLists_2EfupdLast__FRONT__LAST,conjecture,(
    ! [A_27a,V0l_2E0,V1f_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V1f_2E0),s(tyop_2Elist_2Elist(A_27a),V0l_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFRONT_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V1f_2E0),s(A_27a,c_2Elist_2ELAST_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))))))) )).
