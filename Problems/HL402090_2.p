...
tff(conj_thm_2Elist_2EMAP__EQ__CONS,lemma,(
     ...
     => ! [V1l: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1l) = ap(ap(c_2Elist_2ECONS(A_27b),V2h),V3t)
                  <=> ? [V4x0: $i] :
                        ( mem(V4x0,A_27a)
                        & ? [V5t0: $i] :
                            ...
                            & V2h = ap(V0f,V4x0)
                            & V3t = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V5t0) ) ) ) ) ) ) ) )).

tff(conj_thm_2Elist_2EMAP__EQ__SING,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
