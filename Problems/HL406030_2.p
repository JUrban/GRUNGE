...
tff(conj_thm_2Earithmetic_2EDA,lemma,(
...
tff(conj_thm_2Earithmetic_2EMOD__TIMES,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
tff(lmtp_f2213,type,(
    f2213: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2213,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2213(A_27a,V1n,V0w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2213,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2213(A_27a,V1n,V0w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V1n))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) )).

tff(ax_thm_2Ewords_2Eword__ror__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__ror(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Efcp_2EFCP(bool,bool),f2213(A_27a,V1n,V0w)) ) )).
...
tff(lameq_f2243,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2x: tp__ty_2Enum_2Enum] : ap(f2243(A_27a,V0w),inj__ty_2Enum_2Enum(V2x)) = ap(ap(c_2Ewords_2Eword__or(A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V2x)),V0w)),ap(ap(c_2Ewords_2Eword__lsl(A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2x)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0w)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Enum_2Enum(V2x)))) ) )).

tff(conj_thm_2Ewords_2Eword__ror,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__ror(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2243(A_27a,V0w)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) )).
