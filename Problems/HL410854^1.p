...
thf(thm_2Ereal__topology_2EREAL__CHOOSE__SIZE,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0c )
     => ? [V1x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Ereal_2Eabs @ V1x )
          = V0c ) ) )).

thf(thm_2Ereal__topology_2EAT__INFINITY,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Enetord_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eat__infinity @ V0x @ V1y )
      = ( mono_2Ec_2Ereal_2Ereal__ge @ ( mono_2Ec_2Ereal_2Eabs @ V0x ) @ ( mono_2Ec_2Ereal_2Eabs @ V1y ) ) ) )).

thf(thm_2Ereal__topology_2ETRIVIAL__LIMIT__AT__INFINITY,axiom,(
    (~) @ ( mono_2Ec_2Ereal__topology_2Etrivial__limit_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eat__infinity ) )).

thf(thm_2Ereal__topology_2Eeventually,axiom,(
    ! [A_27a: d,V0p_2E0: u,V1net_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Eeventually_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V1net_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Etrivial__limit_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V1net_2E0 ) ) ) )
        | ? [V2y_2E0: u] :
            ( ? [V3x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V1net_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
            & ! [V4x_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V1net_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
...
thf(thm_2Ereal__topology_2EEVENTUALLY__AT__INFINITY,conjecture,(
