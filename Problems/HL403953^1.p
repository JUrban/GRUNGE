...
thf(thm_2Ellist_2ENOT__LFINITE__DROP__LFINITE,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1l_2E0: u,V2t_2E0: u] :
      ( ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) ) ) )
        & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2t_2E0 ) ) ) ) )
...
thf(thm_2Ellist_2ELDROP__APPEND1,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1l2_2E0: u,V2l1_2E0: u,V3l_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l1_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3l_2E0 ) ) ) )
     => ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l2_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3l_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l2_2E0 ) ) ) ) ) ) ) )).
