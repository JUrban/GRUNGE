...
tff(lmtp_f3765,type,(
    f3765: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3765,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3765(A_27a,V1f,V3b),arr(A_27a,bool)) ) )).

tff(lameq_f3765,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3765(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3b)),ap(c_2Ereal_2Eabs,ap(V1f,V4x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__ABS__LBOUND,conjecture,(
    ! [A_27a: del,V0net: $i] :
