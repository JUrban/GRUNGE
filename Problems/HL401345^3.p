...
thf(thm_2Ebit_2EMOD__PLUS__1,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ! [V1x: tyop_2Enum_2Enum] :
          ( ( ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2B @ V1x @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0n )
            = c_2Enum_2E0 )
        <=> ( ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2EMOD @ V1x @ V0n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) )
            = V0n ) ) ) )).
...
thf(thm_2Ebit_2EMOD__ADD__1,conjecture,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ! [V1x: tyop_2Enum_2Enum] :
          ( ( (~)
