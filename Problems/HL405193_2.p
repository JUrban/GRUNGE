...
tff(conj_thm_2Ealist_2EFLOOKUP__FUPDATE__LIST__ALOOKUP__NONE,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
     ...
     => ! [V1k: $i] :
         ...
         => ! [V2fm: $i] :
             ...
             => ( ap(ap(c_2Ealist_2EALOOKUP(A_27a,A_27a),V0ls),V1k) = c_2Eoption_2ENONE(A_27a)
               => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27b,A_27b),V2fm),ap(c_2Elist_2EREVERSE(ty_2Epair_2Eprod(A_27b,A_27b)),V0ls))),V1k) = ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),V2fm),V1k) ) ) ) ) )).
