...
thf(f11768_0_2E0,type,(
    f11768_0_2E0: u )).

thf(f11768_0_2E1,type,(
    f11768_0_2E1: du > u )).

thf(f11768_0_2E2,type,(
    f11768_0_2E2: du > du > u )).

thf(f11769_0_2E0,type,(
    f11769_0_2E0: u )).

thf(f11769_0_2E1,type,(
    f11769_0_2E1: du > u )).

thf(f11769_0_2E2,type,(
    f11769_0_2E2: du > du > u )).
...
thf(mono_2Ef11768_0,type,(
    mono_2Ef11768_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11769_0,type,(
    mono_2Ef11769_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2EREAL__SUB__POW__R1,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V2i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11768_0 @ V0x @ V2i )
...
thf(thm_2Eiterate_2EREAL__SUB__POW__R1,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ef11768_0 @ V0x ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EREAL__SUB__POW__L1,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V2i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11769_0 @ V0x @ V2i )
      = ( mono_2Ec_2Ereal_2Epow @ V0x @ V2i ) ) )).

thf(thm_2Eiterate_2EREAL__SUB__POW__L1,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n )
     => ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) )
        = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0x ) @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ef11769_0 @ V0x ) ) ) ) ) )).
