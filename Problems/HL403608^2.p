        ...
        @ ^ [V0g: $i] :
            ...
            @ ( lam @ ( ty_2Efcp_2Ecart @ A_27a @ A_27b )
              @ ^ [V1f: $i] :
                  ...
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2i: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2i ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27b ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ A_27a @ A_27b ) @ V1f ) @ V2i ) ) @ ( ap @ V0g @ V2i ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Efcp_2EFCP__BETA,conjecture,(
