...
fof(conj_thm_2Epred__set_2EEMPTY__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EFORALL__IN__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ereal_2EREAL__LE__MAX,lemma,(
    ! [V0z] :
...
fof(conj_thm_2Eiterate_2EREAL__LE__SUP,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EREAL__LE__HAUSDIST,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
