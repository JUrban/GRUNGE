...
thf(conj_thm_2Elist_2ELENGTH__TAKE,lemma,(
...
thf(conj_thm_2Erich__list_2EEL__TAKE,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V2l ) )
          = ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ V2l ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Eword__lsr__v2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] :
