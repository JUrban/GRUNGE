...
tff(mem_c_2Elbtree_2Emap,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Elbtree_2Emap(A_27a,A_27a),arr(arr(A_27a,A_27b),arr(ty_2Elbtree_2Elbtree(A_27a),ty_2Elbtree_2Elbtree(A_27b)))) )).
...
tff(conj_thm_2Elbtree_2Emap__eq__Lf,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
