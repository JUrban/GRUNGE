...
tff(tp_c_2Ebag_2EBAG__DISJOINT,type,(
    c_2Ebag_2EBAG__DISJOINT: del > $i )).

tff(mem_c_2Ebag_2EBAG__DISJOINT,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__DISJOINT(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool))) )).
...
tff(conj_thm_2Ebag_2EBAG__OF__EMPTY,lemma,(
    ! [A_27a: del] : ap(c_2Ebag_2ESET__OF__BAG(A_27a),c_2Ebag_2EEMPTY__BAG(A_27a)) = c_2Epred__set_2EEMPTY(A_27a) )).
...
tff(conj_thm_2Ebag_2EBAG__DISJOINT__BAG__IN,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2Emlt__dominates__thm1,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Ebag_2Emlt__dominates__thm2,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Ebag_2EmltLT__SING0,conjecture,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(ap(ap(c_2Erelation_2ETC(arr(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Ebag_2Emlt1(ty_2Enum_2Enum),c_2Eprim__rec_2E_3C)),ap(ap(c_2Ebag_2EBAG__INSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),c_2Ebag_2EEMPTY__BAG(ty_2Enum_2Enum))),V0b))
      <=> ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
          & V0b != ap(ap(c_2Ebag_2EBAG__INSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),c_2Ebag_2EEMPTY__BAG(ty_2Enum_2Enum))
