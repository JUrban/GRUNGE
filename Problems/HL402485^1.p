...
thf(f2885_0_2E0,type,(
    f2885_0_2E0: u )).

thf(f2885_0_2E1,type,(
    f2885_0_2E1: du > u )).

thf(f2885_0_2E2,type,(
    f2885_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2885_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0: $o] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f2885_0_2E1 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ f2885_0_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2885_0_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0: $o,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2885_0_2E2 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ f2885_0_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__CONSTANT__EXISTS,axiom,(
    ! [A_27b: d,V0p: $o,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2885_0_2E2 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V0p ) ) @ ( s @ A_27b @ V2x_2E0 ) ) ) )
      = V0p ) )).

thf(thm_2EquantHeuristics_2EGUESS__RULES__CONSTANT__EXISTS,conjecture,(
    ! [A_27a: d,A_27b: d,V0p: $o,V1i_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1i_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f2885_0_2E1 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V0p ) ) ) ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).
