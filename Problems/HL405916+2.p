...
fof(conj_thm_2Ewords_2EWORD__LITERAL__OR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0n] :
            ( mem(V0n,ty_2Enum_2Enum)
        ...
        & ! [V2n] :
           ...
           => ! [V3m] :
                ( mem(V3m,ty_2Enum_2Enum)
               => ap(ap(c_2Ewords_2Eword__or(A_27a),ap(c_2Ewords_2En2w(A_27a),V2n)),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),V3m))) = ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,V3m))),f2227),V3m),V2n))) ) )
        & ! [V6n] :
            ( mem(V6n,ty_2Enum_2Enum)
           => ! [V7m] :
                ( mem(V7m,ty_2Enum_2Enum)
               => ap(ap(c_2Ewords_2Eword__or(A_27a),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),V7m))),ap(c_2Ewords_2En2w(A_27a),V6n)) = ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,V7m))),f2229),V7m),V6n))) ) )
        & ! [V10n] :
            ( mem(V10n,ty_2Enum_2Enum)
           => ! [V11m] :
                ( mem(V11m,ty_2Enum_2Enum)
