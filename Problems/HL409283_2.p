...
tff(ax_thm_2Ebinary__ieee_2Efloat__less__equal__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__less__equal(A_27t,A_27t),V0x),V1y))
          <=> p(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(bool),ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),V0x),V1y)),inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2EF)),inj__o(fo__c_2Ebool_2EF))) ) ) ) )).

tff(conj_thm_2Elift__ieee_2Efloat__le,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
         ...
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0x))
           ...
           => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__less__equal(A_27a,A_27a),V0x),V1y))
            <=> p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0x)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V1y))) ) ) ) ) )).
