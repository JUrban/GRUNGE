...
thf(f13461_0_2E0,type,(
    f13461_0_2E0: u )).

thf(f13461_0_2E2,type,(
    f13461_0_2E2: du > du > u )).

thf(f13461_0_2E3,type,(
    f13461_0_2E3: du > du > du > u )).

thf(f13462_0_2E0,type,(
    f13462_0_2E0: u )).

thf(f13462_0_2E1,type,(
    f13462_0_2E1: du > u )).

thf(f13462_0_2E2,type,(
...
thf(mono_2Ef13461_0,type,(
    mono_2Ef13461_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13462_0,type,(
    mono_2Ef13462_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EOPEN__SCALING,axiom,(
    ! [V1c: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13462_0 @ V1c @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ V2x ) ) )).

thf(thm_2Ereal__topology_2EOPEN__SCALING,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1c: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Ereal__topology_2EOpen @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13462_0 @ V1c ) @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EOPEN__TRANSLATION,axiom,(
...
thf(def0_2Ethm_2Ereal__topology_2EOPEN__AFFINITY,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13461_0 @ V1a @ V2c @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2c @ V3x ) ) ) )).

thf(thm_2Ereal__topology_2EOPEN__AFFINITY,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal__topology_2EOpen @ V0s )
        & ( (~)
          @ ( V2c
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )
     => ( mono_2Ec_2Ereal__topology_2EOpen @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13461_0 @ V1a @ V2c ) @ V0s ) ) ) )).
