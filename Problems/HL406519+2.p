...
fof(conj_thm_2Earithmetic_2ESUB__LEFT__SUB,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elist_2ENULL__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Elist_2ENULL__LENGTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Elist_2ELAST__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0x] :
            ( mem(V0x,A_27a)
...
fof(conj_thm_2Elist_2EGENLIST__AUX__compute,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0f] :
...
fof(conj_thm_2Erich__list_2ELASTN__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Erich__list_2EDROP__LASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Elist_2EDROP(A_27a),V0n),V1l) = ap(ap(c_2Erich__list_2ELASTN(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n)),V1l) ) ) ) ) )).
...
fof(lamtp_f2310,axiom,(
    mem(f2310,arr(ty_2Elist_2Elist(bool),bool)) )).

fof(lameq_f2310,axiom,(
    ! [V2l] :
      ( mem(V2l,ty_2Elist_2Elist(bool))
     => ap(f2310,V2l) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(c_2Elist_2ENULL(bool),V2l))),ap(c_2Elist_2ELAST(bool),V2l)) ) )).

fof(conj_thm_2Ebitstring_2Eword__bit__last__shiftr,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
         ...
         => ! [V1v] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0i),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
               => ( p(ap(ap(c_2Ewords_2Eword__bit(A_27a),V0i),ap(c_2Ebitstring_2Ev2w(A_27a),V1v)))
                <=> p(ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2310),ap(ap(c_2Ebitstring_2Eshiftr,V1v),V0i))) ) ) ) ) ) )).
