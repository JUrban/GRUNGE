...
thf(tp_c_2Ebag_2ESING__BAG,type,(
    c_2Ebag_2ESING__BAG: del > $i )).

thf(mem_c_2Ebag_2ESING__BAG,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Ebag_2ESING__BAG,axiom,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Ebag_2ESING__BAG @ A_27a ) @ V0b ) )
      <=> ? [V1x: $i] :
            ( ( mem @ V1x @ A_27a )
            & ( V0b
              = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1x ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2ESING__BAG__THM,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
