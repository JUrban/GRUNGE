...
tff(conj_thm_2Efcp_2EFCP__UPDATE__COMMUTES,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
     ...
     => ! [V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum,V3c: $i] :
         ...
         => ! [V4d: $i] :
              ( mem(V4d,A_27a)
             => ( V1a != V2b
               => ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),V3c),ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V2b)),V4d),V0m)) = ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V2b)),V4d),ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),V3c),V0m)) ) ) ) ) )).
