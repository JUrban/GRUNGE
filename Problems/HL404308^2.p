...
thf(conj_thm_2Estring_2ECHR__ORD,lemma,(
    ! [V0a: tp__ty_2Estring_2Echar] :
      ( ( surj__ty_2Estring_2Echar @ ( ap @ c_2Estring_2ECHR @ ( ap @ c_2Estring_2EORD @ ( inj__ty_2Estring_2Echar @ V0a ) ) ) )
      = V0a ) )).

thf(conj_thm_2Estring_2EORD__BOUND,lemma,(
    ! [V0c: tp__ty_2Estring_2Echar] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Estring_2EORD @ ( inj__ty_2Estring_2Echar @ V0c ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Estring__num_2En2s__s2n,conjecture,(
