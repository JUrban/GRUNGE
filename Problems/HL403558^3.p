...
thf(thm_2Ewellorder_2Ewo__INDUCTION,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1w: tyop_2Ewellorder_2Ewellorder @ A_27a] :
      ( ! [V2x: A_27a] :
          ( ! [V3y: A_27a] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V3y @ V2x ) @ ( c_2Eset__relation_2Estrict @ A_27a @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a @ V1w ) ) )
             => ( ( c_2Ebool_2EIN @ A_27a @ V3y @ ( c_2Ewellorder_2EelsOf @ A_27a @ V1w ) )
               => ( V0P @ V3y ) ) )
         => ( ( c_2Ebool_2EIN @ A_27a @ V2x @ ( c_2Ewellorder_2EelsOf @ A_27a @ V1w ) )
           => ( V0P @ V2x ) ) )
     => ! [V4x: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V4x @ ( c_2Ewellorder_2EelsOf @ A_27a @ V1w ) )
         => ( V0P @ V4x ) ) ) )).
