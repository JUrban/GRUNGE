...
fof(lameq_f2313,axiom,(
    ! [A_27a,V1y] :
     ...
     => ! [V0x] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2313(A_27a,V1y,V0x),V2i) = ap(ap(ap(ap(c_2Eblast_2EBSUM,V2i),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(c_2Efcp_2Efcp__index(bool,bool),V1y)),c_2Ebool_2EF) ) ) ) )).

fof(conj_thm_2Eblast_2EBITWISE__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
