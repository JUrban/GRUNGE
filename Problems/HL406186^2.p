...
thf(conj_thm_2Ewords_2Eword__L,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ewords_2Eword__rrx__0,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ( ( ap @ ( c_2Ewords_2Eword__rrx @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
        = ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
      & ( ( ap @ ( c_2Ewords_2Eword__rrx @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
        = ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( c_2Ewords_2Eword__L @ A_27b ) ) ) ) )).
