...
tff(conj_thm_2EternaryComparisons_2Ebool__compare__ind,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(bool,arr(bool,bool)))
     => ( ( p(ap(ap(V0P,inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2ET)))
          & p(ap(ap(V0P,inj__o(fo__c_2Ebool_2EF)),inj__o(fo__c_2Ebool_2EF)))
          & p(ap(ap(V0P,inj__o(fo__c_2Ebool_2ET)),inj__o(fo__c_2Ebool_2EF)))
          & p(ap(ap(V0P,inj__o(fo__c_2Ebool_2EF)),inj__o(fo__c_2Ebool_2ET))) )
       => ! [V1v: tp__o,V2v1: tp__o] : p(ap(ap(V0P,inj__o(V1v)),inj__o(V2v1))) ) ) )).
