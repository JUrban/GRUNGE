...
tff(lmtp_f2245,type,(
    f2245: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2245,axiom,(
     ...
     => ! [V1c: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ! [V3x: $i] :
                 ...
                 => ap(f2245(A_27a,A_27a,V0b,V1c,V2a),V3x) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ewords_2Eword__ls(A_27a),V2a),V3x)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V0b),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))),ap(ap(c_2Ewords_2Eword__ls(A_27a),ap(ap(c_2Ewords_2Eword__add(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V1c)),V3x)),V2a))) ) ) ) ) )).

tff(conj_thm_2Ewords_2EWORD__ADD__LEFT__LS,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1c: $i] :
          ( mem(V1c,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__ADD__LEFT__LS2,conjecture,(
    ! [A_27a: del,V0c: $i] :
