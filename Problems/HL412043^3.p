...
thf(thm_2Elebesgue_2Eintegral__mono,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f1: A_27a > tyop_2Eextreal_2Eextreal,V2f2: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ! [V3t: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3t @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) )
           => ( c_2Eextreal_2Eextreal__le @ ( V1f1 @ V3t ) @ ( V2f2 @ V3t ) ) ) )
     => ( c_2Eextreal_2Eextreal__le @ ( c_2Elebesgue_2Eintegral @ A_27a @ V0m @ V1f1 ) @ ( c_2Elebesgue_2Eintegral @ A_27a @ V0m @ V2f2 ) ) ) )).
