...
tff(ax_thm_2Erelation_2EO__DEF,axiom,(
...
tff(conj_thm_2Erelation_2EO__ASSOC,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27c,arr(A_27b,bool)))
     => ! [V1R2: $i] :
          ( mem(V1R2,arr(A_27d,arr(A_27c,bool)))
         => ! [V2R3: $i] :
              ( mem(V2R3,arr(A_27a,arr(A_27d,bool)))
             => ap(ap(c_2Erelation_2EO(A_27a,A_27a,A_27a),V0R1),ap(ap(c_2Erelation_2EO(A_27a,A_27a,A_27a),V1R2),V2R3)) = ap(ap(c_2Erelation_2EO(A_27a,A_27a,A_27a),ap(ap(c_2Erelation_2EO(A_27d,A_27d,A_27d),V0R1),V1R2)),V2R3) ) ) ) )).
