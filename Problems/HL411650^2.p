...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE,lemma,(
    ! [V0f: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ V2s ) )
                  ...
                  & ! [V3x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) )
                        = V3x ) ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
