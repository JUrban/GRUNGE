...
fof(conj_thm_2Ebag_2EITBAG__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1x] :
                 ...
                 => ! [V2f] :
                     ...
                     => ! [V3acc] :
                          ( mem(V3acc,A_27b)
                         => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
                           => ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),V2f),ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V1x),V0b)),V3acc) = ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),V2f),ap(c_2Ebag_2EBAG__REST(A_27a),ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V1x),V0b))),ap(ap(V2f,ap(c_2Ebag_2EBAG__CHOICE(A_27a),ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V1x),V0b))),V3acc)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ebag_2ECOMMUTING__ITBAG__INSERT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
