...
thf(thm_2Emeasure_2Ecountably__subadditive__def,axiom,(
    ...
    <=> ! [V1f: tyop_2Enum_2Enum > A_27a > $o] :
         ...
         => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) @ ( c_2Eseq_2Esuminf @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m ) @ V1f ) ) ) ) ) )).
