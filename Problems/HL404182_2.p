...
tff(conj_thm_2Epath_2Enth__label__take,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1p: $i] :
     ...
     => ! [V2i: tp__ty_2Enum_2Enum] :
         ...
         => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V2i)),ap(ap(c_2Epath_2Etake(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),V1p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V2i)),V1p) ) ) )).
