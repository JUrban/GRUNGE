...
fof(conj_thm_2Ereal__topology_2EINDEPENDENT__SPAN__BOUND,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EBASIS__EXISTS,lemma,(
    ! [V0v] :
...
fof(conj_thm_2Ereal__topology_2ESPAN__CARD__GE__DIM,conjecture,(
    ! [V0v] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Erealax_2Ereal,bool))
