...
fof(conj_thm_2Ereal__topology_2ESPAN__INDUCT,lemma,(
    ! [V0s] :
...
fof(lamtp_f3661,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3661(V0f),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f3661,axiom,(
    ! [V0f] :
     ...
     => ! [V1x] :
         ...
         => ap(f3661(V0f),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,V1x)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUBSPACE__KERNEL,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
       => p(ap(c_2Ereal__topology_2Esubspace,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3661(V0f)))) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__EQ__0__SPAN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b] :
