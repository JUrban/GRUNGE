...
tff(conj_thm_2Eiterate_2ESUM__UNION__NONZERO,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lamtp_f3381,axiom,(
    ! [A_27a: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3381(A_27a,A_27a,V0f),arr(arr(A_27a,bool),ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3381,axiom,(
    ! [A_27a: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V6t: $i] :
          ( mem(V6t,arr(A_27a,bool))
         => ap(f3381(A_27a,A_27a,V0f),V6t) = ap(ap(c_2Eiterate_2ESum(A_27a),V6t),V0f) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__BIGUNION__NONZERO,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),V1s))
           ...
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V1s)),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(arr(A_27a,bool)),V1s),f3381(A_27a,A_27a,V0f))) ) ) ) )).
