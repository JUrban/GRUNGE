...
thf(thm_2Earithmetic_2Enum__case__eq,conjecture,(
    ! [A_27a: d,V0zc_2E0: u,V1v_2E0: u,V2sc_2E0: u,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( s @ A_27a @ ( c_2Earithmetic_2Enum__CASE_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ A_27a @ V0zc_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2sc_2E0 ) ) )
        = ( s @ A_27a @ V1v_2E0 ) )
    <=> ( ( ( V3n = mono_2Ec_2Enum_2E0 )
        ...
        | ? [V4x: mono_2Etyop_2Enum_2Enum] :
            ...
            & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2sc_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4x ) ) ) )
              = ( s @ A_27a @ V1v_2E0 ) ) ) ) ) )).
