...
thf(ax_thm_2Ellist_2ELDROP,axiom,(
    ! [A_27a: del] :
      ( ! [V0ll: $i] :
      ...
      & ! [V1n: tp__ty_2Enum_2Enum,V2ll: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V2ll )
            = ( ap @ ( c_2Eoption_2EOPTION__JOIN @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ( ty_2Ellist_2Ellist @ A_27a ) @ ( ty_2Eoption_2Eoption @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V2ll ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELDROP__THM,conjecture,(
