...
thf(thm_2Elim_2EINTERVAL__ABS,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1z: mono_2Etyop_2Erealax_2Ereal,V2d: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ V2d ) @ V1z )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V1z @ ( mono_2Ec_2Erealax_2Ereal__add @ V0x @ V2d ) ) )
    <=> ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V1z @ V0x ) ) @ V2d ) ) )).
...
thf(thm_2Elim_2EINTERVAL__CLEMMA,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ? [V3d: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V4y: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V4y @ V2x ) ) @ V3d )
             => ( ( mono_2Ec_2Erealax_2Ereal__lt @ V0a @ V4y )
                & ( mono_2Ec_2Erealax_2Ereal__lt @ V4y @ V1b ) ) ) ) ) )).
