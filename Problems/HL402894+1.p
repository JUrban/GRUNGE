...
fof(thm_2Erich__list_2EEL__REPLICATE,axiom,(
    ! [A_27a,V0n1_2E0,V1n2_2E0,V2x_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V0n1_2E0),s(tyop_2Enum_2Enum,V1n2_2E0))))
     => s(A_27a,c_2Elist_2EEL_2E2(s(tyop_2Enum_2Enum,V0n1_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2EREPLICATE_2E2(s(tyop_2Enum_2Enum,V1n2_2E0),s(A_27a,V2x_2E0))))) = s(A_27a,V2x_2E0) ) )).

fof(thm_2Erich__list_2EDROP__REPLICATE,conjecture,(
    ! [A_27a,V0n_2E0,V1m_2E0,V2a_2E0] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EDROP_2E2(s(tyop_2Enum_2Enum,V0n_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2EREPLICATE_2E2(s(tyop_2Enum_2Enum,V1m_2E0),s(A_27a,V2a_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2EREPLICATE_2E2(s(tyop_2Enum_2Enum,c_2Earithmetic_2E_2D_2E2(s(tyop_2Enum_2Enum,V1m_2E0),s(tyop_2Enum_2Enum,V0n_2E0))),s(A_27a,V2a_2E0))) )).
