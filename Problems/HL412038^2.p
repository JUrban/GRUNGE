...
thf(conj_thm_2Eextreal_2Eadd__comm,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Esub__rzero,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Esub__lzero,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Eextreal__sub__add,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Esub__rneg,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Esub__lneg,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
      ( ( ( ( V0x != fo__c_2Eextreal_2ENegInf )
...
thf(conj_thm_2Eextreal_2Eadd2__sub2,lemma,(
...
thf(conj_thm_2Elebesgue_2Eintegrable__fn__plus,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
...
thf(conj_thm_2Elebesgue_2Eintegrable__fn__minus,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
...
thf(conj_thm_2Elebesgue_2Eintegrable__add,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f1: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
               ...
               => ( p
                  @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegrable @ A_27a ) @ V0m )
                    @ ( lam @ A_27a
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ V1f1 @ V3x ) ) @ ( ap @ V2f2 @ V3x ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elebesgue_2Eintegral__add__lemma,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
             ...
             => ! [V3f2: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
                      ...
                      & ( V1f
                        = ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ c_2Eextreal_2Eextreal__sub @ ( ap @ V2f1 @ V4x ) ) @ ( ap @ V3f2 @ V4x ) ) ) )
                      & ! [V5x: $i] :
                          ( ( mem @ V5x @ A_27a )
                   ...
                   => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegral @ A_27a ) @ V0m ) @ V1f ) )
                      = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__sub @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m ) @ V2f1 ) ) @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m ) @ V3f2 ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EFN__PLUS__POS,lemma,(
    ! [A_27a: del,V0g: $i] :
...
thf(conj_thm_2Emeasure_2EFN__MINUS__POS,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__FN__PLUS,lemma,(
    ! [A_27a: del,V0a: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ V1f ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) )
           => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a ) @ V1f ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) ) ) ) ) )).

thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__FN__MINUS,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ V1f ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) )
           => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a ) @ V1f ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Eintegral__add,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
             ...
             => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
               ...
               => ( ( surj__ty_2Eextreal_2Eextreal
                    @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegral @ A_27a ) @ V0m )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ V1f @ V3x ) ) @ ( ap @ V2g @ V3x ) ) ) ) )
                  = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegral @ A_27a ) @ V0m ) @ V1f ) ) @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegral @ A_27a ) @ V0m ) @ V2g ) ) ) ) ) ) ) ) )).
