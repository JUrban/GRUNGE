...
thf(conj_thm_2Elist_2ELAST__SNOC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
...
thf(ax_thm_2Erich__list_2EELL,axiom,(
    ! [A_27a: del] :
      ( ! [V0l: $i] :
          ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0l )
            = ( ap @ ( c_2Elist_2ELAST @ A_27a ) @ V0l ) ) )
      & ! [V1n: tp__ty_2Enum_2Enum,V2l: $i] :
          ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V2l )
            = ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V2l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EELL__0__SNOC,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
