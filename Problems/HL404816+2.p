...
fof(conj_thm_2Efinite__map_2EDOMSUB__SUBMAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2x] :
                     ...
                     => ( ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V1g))
                          & ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f))) )
                       => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V1g),V2x))) ) ) ) ) ) ) )).
