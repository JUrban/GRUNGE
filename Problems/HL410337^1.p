...
thf(f11476_0_2E0,type,(
    f11476_0_2E0: u )).

thf(f11476_0_2E2,type,(
    f11476_0_2E2: du > du > u )).

thf(f11476_0_2E3,type,(
    f11476_0_2E3: du > du > du > u )).
...
thf(f13861_0_2E0,type,(
    f13861_0_2E0: u )).

thf(f13861_0_2E1,type,(
    f13861_0_2E1: du > u )).

thf(f13861_0_2E2,type,(
    f13861_0_2E2: du > du > u )).

thf(f13862_0_2E0,type,(
    f13862_0_2E0: u )).

thf(f13862_0_2E1,type,(
    f13862_0_2E1: du > u )).

thf(f13862_0_2E2,type,(
    f13862_0_2E2: du > du > u )).
...
thf(mono_2Ef11476_0,type,(
    mono_2Ef11476_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13861_0,type,(
    mono_2Ef13861_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13862_0,type,(
    mono_2Ef13862_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2ESUM__OFFSET__0,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1m: mono_2Etyop_2Enum_2Enum,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11476_0 @ V0f @ V1m @ V3i )
      = ( V0f @ ( mono_2Ec_2Earithmetic_2E_2B @ V3i @ V1m ) ) ) )).

thf(thm_2Eiterate_2ESUM__OFFSET__0,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ V0f )
        = ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2D @ V2n @ V1m ) ) @ ( mono_2Ef11476_0 @ V0f @ V1m ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUM__GP__BASIC,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V2i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef13862_0 @ V0x @ V2i )
...
thf(def0_2Ethm_2Ereal__topology_2ESUM__GP__MULTIPLIED,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef13861_0 @ V0x @ V3i )
      = ( mono_2Ec_2Ereal_2Epow @ V0x @ V3i ) ) )).

thf(thm_2Ereal__topology_2ESUM__GP__MULTIPLIED,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1m @ V2n )
     => ( ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0x ) @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ ( mono_2Ef13861_0 @ V0x ) ) )
