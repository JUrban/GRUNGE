...
fof(lamtp_f311,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
     => mem(f311(A_27a,V0f),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).
...
fof(lameq_f311,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1X] :
          ( mem(V1X,arr(A_27a,bool))
         => ap(f311(A_27a,V0f),V1X) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1X),ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1X),ap(V0f,V1X))) ) ) )).
...
fof(conj_thm_2EfixedPoint_2Egfp__greatest__dense,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
