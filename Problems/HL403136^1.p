...
thf(f3717_0_2E0,type,(
    f3717_0_2E0: u )).

thf(f3717_0_2E2,type,(
    f3717_0_2E2: du > du > u )).

thf(f3717_0_2E3,type,(
    f3717_0_2E3: du > du > du > u )).
...
thf(mono_2Ef3717_0,type,(
    mono_2Ef3717_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EBEFORE__EVENT,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3717_0 @ V1a @ V0b @ V2t )
    <=> ( ( V1a @ V2t )
        & ( (~) @ ( V0b @ V2t ) ) ) ) )).

thf(thm_2ETemporal__Logic_2EBEFORE__EVENT,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V1a @ V0b )
      = ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ ( mono_2Ef3717_0 @ V1a @ V0b ) @ V0b ) ) )).
