    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0s] :
         ...
         => ! [V2z] :
             ...
             => mem(f3189(A_27a,V1f,V0s,V2z),arr(A_27a,ty_2Erealax_2Ereal)) ) ) ) )).
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0s] :
         ...
         => ! [V2z] :
             ...
             => ! [V3x] :
                  ( mem(V3x,A_27a)
                 => ap(f3189(A_27a,V1f,V0s,V2z),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s)),ap(V1f,V3x)),V2z) ) ) ) ) )).

fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IN__IF__ALT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1f] :
             ...
             => ! [V2z] :
                  ( mem(V2z,ty_2Erealax_2Ereal)
                 => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                   => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0s) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3189(A_27a,V1f,V0s,V2z)),V0s) ) ) ) ) ) )).
