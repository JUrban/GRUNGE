    ...
    ! [V1k] :
     ...
     => ! [V2f] :
         ...
         => ! [V3m] :
             ...
             => ap(f2737(V1k,V2f),V3m) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,V3m),V1k)),V1k)),V2f) ) ) ) )).

fof(conj_thm_2Ereal_2ESUM__GROUP,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1k] :
          ( mem(V1k,ty_2Enum_2Enum)
         => ! [V2f] :
              ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
             => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V0n)),f2737(V1k,V2f)) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2A,V0n),V1k))),V2f) ) ) ) )).
...
fof(lameq_f2884,axiom,(
    ! [V1k] :
     ...
     => ! [V0f] :
         ...
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(f2884(V1k,V0f),V2n) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,V2n),V1k)),V1k)),V0f) ) ) ) )).

fof(conj_thm_2Eseq_2ESER__GROUP,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k] :
          ( mem(V1k,ty_2Enum_2Enum)
