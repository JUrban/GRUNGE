...
tff(conj_thm_2Efinite__map_2EFMERGE__ASSOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,arr(A_27b,arr(A_27b,A_27b)))
     => ( p(ap(c_2Ecombin_2EASSOC(ty_2Efinite__map_2Efmap(A_27a,A_27a)),ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m)))
