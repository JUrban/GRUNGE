...
tff(lameq_f2184,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f2184(A_27a,V0w),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1i))) ) )).
...
tff(mem_c_2Ebitstring_2Ew2v,axiom,(
    ! [A_27a: del] : mem(c_2Ebitstring_2Ew2v(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Elist_2Elist(bool))) )).

tff(ax_thm_2Ebitstring_2Ew2v__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => surj__c_ty_2Elist_2Elist_o(ap(c_2Ebitstring_2Ew2v(A_27a),V0w)) = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Elist_2EGENLIST(bool),f2184(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) )).
...
tff(conj_thm_2Ebitstring_2Ev2w__w2v,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
