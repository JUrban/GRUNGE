...
fof(conj_thm_2Elist_2EEVERY__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0v] :
             ...
             => ! [V1r] :
                 ...
                 => ! [V2rs] :
                     ...
                     => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1r),V2rs)),c_2Enum_2E0))
                      <=> ap(V1r,V0v) = c_2Eoption_2ENONE(A_27b) ) ) ) ) ) ) )).

fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__LT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2rs2] :
                     ...
                     => ! [V3i] :
                         ...
                         => ( p(ap(ap(c_2Eprim__rec_2E_3C,V3i),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1)))
                           => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2EAPPEND(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1),V2rs2)),V3i))
                            <=> p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V1rs1),V3i)) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__GE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1rs1] :
                 ...
                 => ! [V2rs2] :
                     ...
                     => ! [V3i] :
                         ...
                         => ( ~ p(ap(ap(c_2Eprim__rec_2E_3C,V3i),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1)))
                           => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2EAPPEND(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1),V2rs2)),V3i))
                            <=> ( ( ~ p(ap(ap(c_2Elist_2EEVERY(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),f839(A_27b,A_27a,A_27a,A_27b,V0v)),V1rs1))
                                ...
                                | p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V2rs2),ap(ap(c_2Earithmetic_2E_2D,V3i),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1)))) ) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__SNOC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                     ...
                                     => ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),V2c),V3infos))
                                       => ( ( ap(V4r,V0v) = c_2Eoption_2ENONE(A_27b)
                                         ...
                                         => ( ( p(V2c)
                                             => ( p(V5i)
                                               => ap(V4r,V0v) = c_2Eoption_2ENONE(A_27b) ) )
                                           => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ESNOC(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V4r),V1rows)),V6c_27),ap(ap(c_2Elist_2ESNOC(bool),V5i),V3infos))) ) ) ) ) ) ) ) ) ) ) ) ) )).
