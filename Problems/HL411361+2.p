     ...
     => ! [V0f] :
         ...
         => ! [V1s] :
             ...
             => ! [V4u] :
                 ...
                 => ! [V5y] :
                      ( mem(V5y,ty_2Erealax_2Ereal)
                     => ap(f3927(V2t,V0f,V1s,V4u),V5y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5y),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V2t)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3861(V1s,V0f,V5y))),V4u))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EOPEN__MAP__IFF__LOWER__HEMICONTINUOUS__PREIMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
               ...
               => ( ! [V3u] :
                ...
                <=> ! [V4u] :
                     ...
                     => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V4u))
                       => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2t)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3927(V2t,V0f,V1s,V4u)))) ) ) ) ) ) ) ) )).
