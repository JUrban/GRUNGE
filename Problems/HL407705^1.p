...
thf(thm_2EordNotationSemantics_2Eadd__nat1__disappears,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1a_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ c_2Eordinal_2Eomega_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordADD_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) )
...
thf(thm_2EordNotationSemantics_2Eadd__nat1__disappears__kexp,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1k: mono_2Etyop_2Enum_2Enum,V2e_2E0: u] :
      ( ( ( (~)
          @ ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2e_2E0 )
            = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V1k ) )
     => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordADD_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordMULT_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordEXP_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ c_2Eordinal_2Eomega_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2e_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) ) ) ) ) ) )
        = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordMULT_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordEXP_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ c_2Eordinal_2Eomega_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2e_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) ) ) ) ) ) ) )).
