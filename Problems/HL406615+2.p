...
fof(mem_c_2EEncode_2Eencode__bnum,axiom,(
    mem(c_2EEncode_2Eencode__bnum,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool)))) )).

fof(conj_thm_2EEncode_2Eencode__bnum__length,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(c_2Elist_2ELENGTH(bool),ap(ap(c_2EEncode_2Eencode__bnum,V0m),V1n)) = V0m ) ) )).
...
fof(mem_c_2ECoder_2Ebnum__coder,axiom,(
...
fof(ax_thm_2ECoder_2Ebnum__coder__def,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ECoder_2Ebnum__coder,V0m),V1p) = ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,bool),arr(ty_2Enum_2Enum,bool)),V1p),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool)),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))),ap(c_2EEncode_2Eencode__bnum,V0m)),ap(ap(c_2EDecode_2Edecode__bnum,V0m),V1p))) ) ) )).

fof(mem_c_2EEncodeVar_2Efixed__width,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EEncodeVar_2Efixed__width(A_27a),arr(ty_2Enum_2Enum,arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool))) ) )).
...
fof(conj_thm_2EEncodeVar_2Efixed__width__bnum,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
