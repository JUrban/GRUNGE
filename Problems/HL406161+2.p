...
fof(mem_c_2Ewords_2Esaturate__sub,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Esaturate__sub(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(conj_thm_2Ewords_2En2w__sub__eq__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Esaturate__sub,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1b] :
              ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Esaturate__sub(A_27a),V0a),V1b) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__ls(A_27a),V0a),V1b)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),ap(ap(c_2Ewords_2Eword__sub(A_27a),V0a),V1b)) ) ) ) )).
