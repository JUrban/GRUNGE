...
tff(mem_c_2Efcp_2EFCP__CONS,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Efcp_2EFCP__CONS(A_27a,A_27a,A_27a),arr(A_27a,arr(ty_2Efcp_2Ecart(A_27a,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a)))) )).
...
tff(lamtp_f1095,axiom,(
    ! [A_27a: del,A_27b: del,V1v: $i] :
      ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => mem(f1095(A_27a,A_27b,V1v),arr(ty_2Enum_2Enum,A_27a)) ) )).

tff(lameq_f1095,axiom,(
    ! [A_27a: del,A_27b: del,V1v: $i] :
      ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f1095(A_27a,A_27b,V1v),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1v),ap(c_2Eprim__rec_2EPRE,inj__ty_2Enum_2Enum(V2i))) ) )).
...
tff(ax_thm_2Efcp_2EFCP__CONS__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0h: $i] :
     ...
     => ! [V1v: $i] :
          ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
         => ap(ap(c_2Efcp_2EFCP__CONS(A_27a,A_27a,A_27a),V0h),V1v) = ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0h),ap(c_2Efcp_2EFCP(A_27a,A_27a),f1095(A_27a,A_27b,V1v))) ) ) )).
...
tff(conj_thm_2Efcp_2EFCP__CONS,conjecture,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,A_27a)
     => ! [V1v: $i] :
          ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
         => ap(ap(c_2Efcp_2EFCP__CONS(A_27a,A_27a,A_27a),V0a),V1v) = ap(c_2Efcp_2EL2V(A_27a,A_27a),ap(ap(c_2Elist_2ECONS(A_27a),V0a),ap(c_2Efcp_2EV2L(A_27a,A_27a),V1v))) ) ) )).
