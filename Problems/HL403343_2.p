...
tff(conj_thm_2Ebag_2EBCARD__SUC,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
       => ! [V1n: tp__ty_2Enum_2Enum] :
            ( surj__ty_2Enum_2Enum(ap(c_2Ebag_2EBAG__CARD(A_27a),V0b)) = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))
          <=> ? [V2b0: $i] :
                ( mem(V2b0,arr(A_27a,ty_2Enum_2Enum))
                & ? [V3e: $i] :
                    ( mem(V3e,A_27a)
                    & V0b = ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V3e),V2b0)
                    & surj__ty_2Enum_2Enum(ap(c_2Ebag_2EBAG__CARD(A_27a),V2b0)) = V1n ) ) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__FILTER__BAG__INSERT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
...
tff(conj_thm_2Ebag_2EBAG__IN__FINITE__BAG__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0b: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
               => ( p(ap(ap(c_2Ebag_2EBAG__IN(A_27b),V1x),ap(ap(c_2Ebag_2EBAG__IMAGE(A_27b,A_27b),V2f),V0b)))
                <=> ? [V3y: $i] :
                      ( mem(V3y,A_27a)
                      & ap(V2f,V3y) = V1x
