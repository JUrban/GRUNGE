...
tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__OPEN__IN,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN__IN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
