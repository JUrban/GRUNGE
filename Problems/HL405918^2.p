...
thf(conj_thm_2Earithmetic_2ELESS__EQ__ADD__EXISTS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Earithmetic_2EMULT__SUC,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Elist_2EAPPEND__11__LENGTH,lemma,(
    ! [A_27a: del] :
      ( ! [V0l1: $i] :
          ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ! [V1l2: $i] :
    ...
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
     ...
     => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__replicate @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1w )
        = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27b )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V2i: $i] :
                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2i ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ V2i ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Eword__replicate__concat__word__list,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__replicate @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1w )
