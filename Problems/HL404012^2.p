...
thf(conj_thm_2Equotient_2ELET__RES__ABSTRACT,conjecture,(
     ...
     => ! [V1lam: $i] :
         ...
         => ! [V2v: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2v ) @ V0r ) )
               => ( ( ap @ ( ap @ ( c_2Ebool_2ELET @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Ebool_2ERES__ABSTRACT @ A_27a @ A_27b ) @ V0r ) @ V1lam ) ) @ V2v )
                  = ( ap @ ( ap @ ( c_2Ebool_2ELET @ A_27a @ A_27b ) @ V1lam ) @ V2v ) ) ) ) ) ) )).
