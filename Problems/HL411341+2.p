...
fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__IMP__CONTINUOUS,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__EXTENDS__TO__CLOSURE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                   ...
                   => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V4h),ap(c_2Ereal__topology_2Eclosure,V1s)))
                        & ! [V5x] :
                           ...
                           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V1s))
                             => ap(V4h,V5x) = ap(V0f,V5x) ) ) )
                     => ! [V6x] :
                          ( mem(V6x,ty_2Erealax_2Ereal)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6x),ap(c_2Ereal__topology_2Eclosure,V1s)))
                           => ap(V4h,V6x) = ap(V2g,V6x) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOUNDED__UNIFORMLY__CONTINUOUS__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
