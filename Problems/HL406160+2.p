...
fof(conj_thm_2Ewords_2Edimindex__dimword__iso,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ewords_2Esaturate__w2w__n2w,lemma,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0n] :
              ( mem(V0n,ty_2Enum_2Enum)
             => ap(c_2Ewords_2Esaturate__w2w(A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),V0n)) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2257(A_27b,A_27a)),ap(ap(c_2Earithmetic_2EMOD,V0n),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).

fof(conj_thm_2Ewords_2Esaturate__w2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
