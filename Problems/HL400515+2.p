...
fof(conj_thm_2Eoption_2EOPTION__MAP__CONG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2f1] :
                     ...
                     => ! [V3f2] :
                         ...
                         => ( ( V0opt1 = V1opt2
                           ...
                           => ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V2f1),V0opt1) = ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V3f2),V1opt2) ) ) ) ) ) ) ) )).
