...
fof(conj_thm_2EOmega__Automata_2EOMEGA__CONJ__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b1] :
          ( ne(A_27b1)
                                              ...
                                              <=> ? [V12q1] :
                                                    ...
                                                    & ? [V13q2] :
                                                        ...
                                                        & ! [V14t] :
                                                           ...
                                                           => ( p(ap(V2Phi__R1,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V14t),V1t0))),ap(V12q1,ap(ap(c_2Earithmetic_2E_2B,V14t),V1t0)))))
