...
thf(conj_thm_2Ereal__topology_2ECONNECTED__UNION,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIQUE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS,lemma,(
    ! [V0u: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1s ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0u ) ) )
          <=> ? [V2x: tp__ty_2Erealax_2Ereal] :
                ...
                & ( V1s
                  = ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0u ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECOMPONENTS__UNIQUE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
         => ( ( ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V1k )
                = V0s )
              & ! [V2c: $i] :
