...
fof(conj_thm_2Ereal__topology_2EFORALL__POS__MONO,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2EFORALL__SUC,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2EFORALL__POS__MONO__1,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ( ( ! [V1d] :
              ( mem(V1d,ty_2Erealax_2Ereal)
          ...
          & ! [V3n] :
              ( mem(V3n,ty_2Enum_2Enum)
             => p(ap(V0P,ap(c_2Erealax_2Einv,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,V3n)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))) ) )
       => ! [V4e] :
            ( mem(V4e,ty_2Erealax_2Ereal)
           => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V4e))
             => p(ap(V0P,V4e)) ) ) ) ) )).
