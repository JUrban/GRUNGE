...
fof(conj_thm_2Epred__set_2ECOUNTABLE__IMAGE__NUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Epred__set_2ECOUNTABLE__ENUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
...
fof(conj_thm_2Eprobability_2EEVENTS__COUNTABLE__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Eprobability_2EPROB__COUNTABLY__SUBADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Eprobability_2EPROB__COUNTABLY__ZERO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  ...
                  & ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2x),V1c))
                       => ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2x) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) )
               => ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(c_2Epred__set_2EBIGUNION(A_27a),V1c)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) )).
