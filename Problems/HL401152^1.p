...
thf(thm_2Eind__type_2EISO__USAGE,conjecture,(
    ! [A_27a: d,A_27b: d,V0g_2E0: u,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eind__type_2EISO_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) ) ) )
     => ( ! [V2P_2E0: u] :
            ( ! [V3x_2E0: u] :
          ...
          <=> ! [V4x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) @ ( s @ A_27b @ V4x_2E0 ) ) ) ) ) ) )
        & ! [V5P_2E0: u] :
            ( ? [V6x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V5P_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) )
          <=> ? [V7x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V5P_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) @ ( s @ A_27b @ V7x_2E0 ) ) ) ) ) ) )
        & ! [V8a_2E0: u,V9b_2E0: u] :
            ( ( ( s @ A_27a @ V8a_2E0 )
              = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V0g_2E0 ) @ ( s @ A_27b @ V9b_2E0 ) ) ) )
          <=> ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V8a_2E0 ) ) )
              = ( s @ A_27b @ V9b_2E0 ) ) ) ) ) )).
