...
thf(f11461_0_2E0,type,(
    f11461_0_2E0: u )).

thf(f11461_0_2E1,type,(
    f11461_0_2E1: du > u )).
...
thf(f12638_0_2E0,type,(
    f12638_0_2E0: u )).

thf(f12638_0_2E1,type,(
    f12638_0_2E1: du > u )).
...
thf(mono_2Ef12638_0,type,(
    mono_2Ef12638_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(arityeq1_2Emono_2Ef11461_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f11461_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ f11461_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2ESUM__0,axiom,(
    ! [A_27a: d,V1n_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f11461_0_2E1 @ ( s @ A_27a @ V1n_2E0 ) ) ) )
      = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Eiterate_2ESUM__0,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ f11461_0_2E0 ) ) ) )
      = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESERIES__0,axiom,(
    ! [V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12638_0 @ V1n )
      = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Ereal__topology_2ESERIES__0,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o] :
      ( mono_2Ec_2Ereal__topology_2Esums @ mono_2Ef12638_0 @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0s ) )).
