...
thf(thm_2Equotient__pred__set_2EFINITER__EMPTY,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ( c_2Equotient__pred__set_2EFINITER @ A_27a @ V0R @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )).
...
thf(thm_2Equotient__pred__set_2EFINITER__INSERTR,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ...
      @ ^ [V1s: A_27a > $o] :
          ...
          @ ( c_2Ebool_2ERES__FORALL @ A_27a @ ( c_2Equotient_2Erespects @ A_27a @ $o @ V0R )
            @ ^ [V2x: A_27a] :
                ( c_2Equotient__pred__set_2EFINITER @ A_27a @ V0R @ ( c_2Equotient__pred__set_2EINSERTR @ A_27a @ V0R @ V2x @ V1s ) ) ) ) ) )).
...
thf(thm_2Equotient__pred__set_2EABSORPTIONR,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ...
      @ ^ [V1x: A_27a] :
          ( c_2Ebool_2ERES__FORALL @ ( A_27a > $o ) @ ( c_2Equotient_2Erespects @ ( A_27a > $o ) @ $o @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ $o @ V0R @ ( c_2Emin_2E_3D @ $o ) ) )
          @ ^ [V2s: A_27a > $o] :
              ( c_2Emin_2E_3D @ $o @ ( c_2Ebool_2EIN @ A_27a @ V1x @ V2s ) @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ $o @ V0R @ ( c_2Emin_2E_3D @ $o ) @ ( c_2Equotient__pred__set_2EINSERTR @ A_27a @ V0R @ V1x @ V2s ) @ V2s ) ) ) ) )).
          ...
          @ ( c_2Ebool_2E_2F_5C @ ( V1P @ ( c_2Epred__set_2EEMPTY @ A_27a ) )
            @ ( c_2Ebool_2ERES__FORALL @ ( A_27a > $o ) @ ( c_2Equotient_2Erespects @ ( A_27a > $o ) @ $o @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ $o @ V0R @ ( c_2Emin_2E_3D @ $o ) ) )
              @ ^ [V2s: A_27a > $o] :
                  ...
                  @ ( c_2Ebool_2ERES__FORALL @ A_27a @ ( c_2Equotient_2Erespects @ A_27a @ $o @ V0R )
                    @ ^ [V3e: A_27a] :
                        ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2E_7E @ ( c_2Ebool_2EIN @ A_27a @ V3e @ V2s ) ) @ ( V1P @ ( c_2Equotient__pred__set_2EINSERTR @ A_27a @ V0R @ V3e @ V2s ) ) ) ) ) ) )
          @ ( c_2Ebool_2ERES__FORALL @ ( A_27a > $o ) @ ( c_2Equotient_2Erespects @ ( A_27a > $o ) @ $o @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ $o @ V0R @ ( c_2Emin_2E_3D @ $o ) ) )
            @ ^ [V4s: A_27a > $o] :
                ( c_2Emin_2E_3D_3D_3E @ ( c_2Equotient__pred__set_2EFINITER @ A_27a @ V0R @ V4s ) @ ( V1P @ V4s ) ) ) ) ) )).
