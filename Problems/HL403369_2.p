...
tff(conj_thm_2Ebag_2EBAG__INN__0,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
         => p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V1e),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0b)) ) ) )).

tff(conj_thm_2Ebag_2EBAG__INN__LESS,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
         => ! [V2n: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum] :
              ( ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V1e),inj__ty_2Enum_2Enum(V2n)),V0b))
                & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V2n))) )
             => p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V1e),inj__ty_2Enum_2Enum(V3m)),V0b)) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__EXTENSION,lemma,(
    ! [A_27a: del,V0b1: $i] :
     ...
     => ! [V1b2: $i] :
         ...
         => ( V0b1 = V1b2
          <=> ! [V2n: tp__ty_2Enum_2Enum,V3e: $i] :
                ( mem(V3e,A_27a)
               => ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V3e),inj__ty_2Enum_2Enum(V2n)),V0b1))
                <=> p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V3e),inj__ty_2Enum_2Enum(V2n)),V1b2)) ) ) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__INN__EMPTY__BAG,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V0e),inj__ty_2Enum_2Enum(V1n)),c_2Ebag_2EEMPTY__BAG(A_27a)))
        <=> V1n = fo__c_2Enum_2E0 ) ) )).

tff(conj_thm_2Ebag_2EBAG__INN__BAG__FILTER,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1n: tp__ty_2Enum_2Enum,V2P: $i] :
         ...
         => ! [V3b: $i] :
             ...
             => ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V0e),inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Ebag_2EBAG__FILTER(A_27a),V2P),V3b)))
              <=> ( V1n = fo__c_2Enum_2E0
                  | ( p(ap(V2P,V0e))
                    & p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V0e),inj__ty_2Enum_2Enum(V1n)),V3b)) ) ) ) ) ) ) )).
...
tff(conj_thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
