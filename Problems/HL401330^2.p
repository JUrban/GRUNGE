...
thf(conj_thm_2Earithmetic_2EEVEN__MULT,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Earithmetic_2EEVEN__EXP,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Earithmetic_2EDIV__P,lemma,(
    ! [V0P: $i] :
     ...
     => ! [V1p: tp__ty_2Enum_2Enum,V2q: tp__ty_2Enum_2Enum] :
         ...
         => ( ( p @ ( ap @ V0P @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( inj__ty_2Enum_2Enum @ V1p ) ) @ ( inj__ty_2Enum_2Enum @ V2q ) ) ) )
          <=> ? [V3k: tp__ty_2Enum_2Enum,V4r: tp__ty_2Enum_2Enum] :
                ( ( V1p
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V3k ) ) @ ( inj__ty_2Enum_2Enum @ V2q ) ) ) @ ( inj__ty_2Enum_2Enum @ V4r ) ) ) )
...
thf(conj_thm_2Ebit_2EBIT__SHIFT__THM3,conjecture,(
