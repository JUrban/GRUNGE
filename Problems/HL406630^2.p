                        ...
                        @ ^ [V3x: $i] :
                            ...
                            @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1t ) )
                              @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                                @ ( lam @ A_27a
                                  @ ^ [V4z: $i] :
                                      ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4z ) @ V2u ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2EternaryComparisons_2Eordering ) @ ( ap @ ( ap @ ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ V0cmp ) @ V3x ) @ V4z ) ) @ ( inj__ty_2EternaryComparisons_2Eordering @ fo__c_2EternaryComparisons_2ELESS ) ) ) ) ) ) ) ) ) )
                  @ V2u ) ) ) ) ) )).
...
thf(conj_thm_2Eenumeral_2ELESS__ALL__OU,lemma,(
    ! [A_27a: del,V0cmp: $i] :
      ( ( mem @ V0cmp @ ( ty_2Etoto_2Etoto @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Etoto_2Eall__cpn__distinct,lemma,
...
thf(conj_thm_2Etoto_2Etoto__refl,lemma,(
    ! [A_27a: del,V0c: $i] :
...
thf(conj_thm_2Eenumeral_2EOU__ASSOC,conjecture,(
    ! [A_27a: del,V0cmp: $i] :
      ( ( mem @ V0cmp @ ( ty_2Etoto_2Etoto @ A_27a ) )
     => ! [V1a: $i] :
