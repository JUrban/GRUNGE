...
thf(arityeq3_2Emono_2Ef160_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f160_0_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) ) @ f160_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) @ ( s @ A_27b @ X2_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef160_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ A_27b @ ( f160_0_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) ) @ f160_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) @ ( s @ A_27b @ X2_2E0 ) ) ) @ ( s @ A_27a @ X3_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef160_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f160_1_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f160_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ebool_2Eliteral__case__id,axiom,(
    ! [A_27a: d,V3x_2E0: u,V2a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f160_1_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V3x_2E0 )
        = ( s @ A_27a @ V2a_2E0 ) ) ) )).

thf(def1_2Ethm_2Ebool_2Eliteral__case__id,axiom,(
    ! [A_27a: d,A_27b: d,V2a_2E0: u,V1t_2E0: u,V0u_2E0: u,V3x_2E0: u] :
      ( ( s @ A_27b @ ( f160_0_2E4 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27b @ V1t_2E0 ) @ ( s @ A_27b @ V0u_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
      = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f160_1_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) ) ) @ ( s @ A_27b @ V1t_2E0 ) @ ( s @ A_27b @ V0u_2E0 ) ) ) ) )).

thf(thm_2Ebool_2Eliteral__case__id,conjecture,(
    ! [A_27a: d,A_27b: d,V0u_2E0: u,V1t_2E0: u,V2a_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ebool_2Eliteral__case_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f160_0_2E3 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27b @ V1t_2E0 ) @ ( s @ A_27b @ V0u_2E0 ) ) ) @ ( s @ A_27a @ V2a_2E0 ) ) )
      = ( s @ A_27b @ V1t_2E0 ) ) )).
