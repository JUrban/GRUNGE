...
thf(conj_thm_2Ehrat_2ETRAT__ADD__WELLDEFINED2,lemma,(
...
thf(conj_thm_2Ehrat_2ETRAT__ADD__TOTAL,lemma,(
    ! [V0h: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum,V1i: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
      ...
      | ? [V2d: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Ehrat_2Etrat__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0h ) ) @ ( ap @ ( ap @ c_2Ehrat_2Etrat__add @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V1i ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V2d ) ) ) )
      | ? [V3d: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Ehrat_2Etrat__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V1i ) ) @ ( ap @ ( ap @ c_2Ehrat_2Etrat__add @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0h ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V3d ) ) ) ) ) )).

thf(conj_thm_2Ehrat_2ETRAT__EQ__EQUIV,lemma,(
...
thf(conj_thm_2Ehrat_2Ehrat__QUOTIENT,lemma,(
...
thf(conj_thm_2Equotient_2EEXISTS__PRS,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1abs: $i] :
          ( ( mem @ V1abs @ ( arr @ A_27a @ A_27b ) )
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27a @ A_27b ) @ V0R ) @ V1abs ) @ V2rep ) )
               => ! [V3f: $i] :
                   ...
                   => ( ( p @ ( ap @ ( c_2Ebool_2E_3F @ A_27b ) @ V3f ) )
                    <=> ( p @ ( ap @ ( ap @ ( c_2Ebool_2ERES__EXISTS @ A_27a ) @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V0R ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ bool @ A_27b @ bool ) @ V1abs ) @ ( c_2Ecombin_2EI @ bool ) ) @ V3f ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Equotient_2ERES__EXISTS__RSP,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1abs: $i] :
          ( ( mem @ V1abs @ ( arr @ A_27a @ A_27b ) )
...
thf(conj_thm_2Equotient_2EEQUIV__RES__EXISTS,lemma,(
    ! [A_27a: del,V0E: $i] :
      ( ( mem @ V0E @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27a @ bool ) )
         => ( ( p @ ( ap @ ( c_2Equotient_2EEQUIV @ A_27a ) @ V0E ) )
           => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2ERES__EXISTS @ A_27a ) @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V0E ) ) @ V1P ) )
            <=> ( p @ ( ap @ ( c_2Ebool_2E_3F @ A_27a ) @ V1P ) ) ) ) ) ) )).

thf(conj_thm_2Ehrat_2EHRAT__ADD__TOTAL,conjecture,(
