...
thf(c_2EDecode_2Edecode__num,type,(
    c_2EDecode_2Edecode__num: ( tyop_2Enum_2Enum > $o ) > ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) )).
...
thf(c_2ECoder_2Enum__coder,type,(
    c_2ECoder_2Enum__coder: ( tyop_2Enum_2Enum > $o ) > ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > $o ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) ) ) ) )).
...
thf(thm_2ECoder_2Enum__coder__def,axiom,(
    ! [V0p: tyop_2Enum_2Enum > $o] :
      ( ( c_2ECoder_2Enum__coder @ V0p )
      = ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > $o ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) ) ) @ V0p @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) ) @ c_2EEncode_2Eencode__num @ ( c_2EDecode_2Edecode__num @ V0p ) ) ) ) )).

thf(thm_2EDecode_2Edecode__num__def,axiom,(
    ! [V0p: tyop_2Enum_2Enum > $o] :
      ( ( c_2EDecode_2Edecode__num @ V0p )
      = ( c_2EDecode_2Eenc2dec @ tyop_2Enum_2Enum @ V0p @ c_2EEncode_2Eencode__num ) ) )).

thf(thm_2EEncode_2Ewf__encode__num,axiom,(
    ! [V0p: tyop_2Enum_2Enum > $o] :
      ( c_2EEncode_2Ewf__encoder @ tyop_2Enum_2Enum @ V0p @ c_2EEncode_2Eencode__num ) )).
...
thf(thm_2ECoder_2Ewf__coder__num,conjecture,(
    ! [V0p: tyop_2Enum_2Enum > $o] :
      ( ( c_2EEncode_2Ewf__pred @ tyop_2Enum_2Enum @ V0p )
     => ( c_2ECoder_2Ewf__coder @ tyop_2Enum_2Enum @ ( c_2ECoder_2Enum__coder @ V0p ) ) ) )).
