...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM,lemma,(
    ! [A_27a: del,V0net: $i] :
                      ...
                      @ ( ap
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V4x: $i] :
                                  ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V1f @ V4x ) ) @ ( ap @ V2g @ V4x ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN,conjecture,(
