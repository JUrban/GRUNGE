...
thf(f1340_0_2E0,type,(
    f1340_0_2E0: u )).

thf(f1340_0_2E1,type,(
    f1340_0_2E1: du > u )).
...
thf(c_2Eind__type_2EFCONS_2E3,type,(
...
thf(mono_2Ef1340_0,type,(
    mono_2Ef1340_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq3_2Emono_2Ec_2Eind__type_2EFCONS_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( c_2Eind__type_2EFCONS_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X2 ) ) ) )
...
thf(thm_2Eind__type_2EFCONS,axiom,(
    ! [A_27a: d] :
      ( ! [V0a_2E0: u,V1f_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eind__type_2EFCONS_2E3 @ ( s @ A_27a @ V0a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) )
          = ( s @ A_27a @ V0a_2E0 ) )
      & ! [V2a_2E0: u,V3f_2E0: u,V4n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ A_27a @ ( c_2Eind__type_2EFCONS_2E3 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V4n ) ) ) ) )
          = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eind__type_2EFCONS__DEST,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1340_0 @ V0n )
    <=> ( V0n = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Eind__type_2EFCONS__DEST,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1f_2E0: u,V2a_2E0: u] :
      ( ( s @ A_27a @ ( c_2Eind__type_2EFCONS_2E3 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef1340_0 @ V0n ) ) ) @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V0n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) )).
