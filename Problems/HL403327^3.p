...
thf(thm_2Ebag_2ESUB__BAG__INSERT,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESUB__BAG @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V1b1 ) @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V2b2 ) )
      = ( c_2Ebag_2ESUB__BAG @ A_27a @ V1b1 @ V2b2 ) ) )).
...
thf(thm_2Ebag_2ENOT__IN__SUB__BAG__INSERT,axiom,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum,V2e: A_27a] :
     ...
     => ( ( c_2Ebag_2ESUB__BAG @ A_27a @ V0b1 @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V2e @ V1b2 ) )
...
thf(thm_2Ebag_2ESUB__BAG__CARD,axiom,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V1b2 )
        & ( c_2Ebag_2ESUB__BAG @ A_27a @ V0b1 @ V1b2 ) )
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Ebag_2EBAG__CARD @ A_27a @ V0b1 ) @ ( c_2Ebag_2EBAG__CARD @ A_27a @ V1b2 ) ) ) )).
...
thf(thm_2Ebag_2EBAG__CARD__DIFF,conjecture,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V0b )
     => ! [V1c: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2ESUB__BAG @ A_27a @ V1c @ V0b )
         => ( ( c_2Ebag_2EBAG__CARD @ A_27a @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V0b @ V1c ) )
            = ( c_2Earithmetic_2E_2D @ ( c_2Ebag_2EBAG__CARD @ A_27a @ V0b ) @ ( c_2Ebag_2EBAG__CARD @ A_27a @ V1c ) ) ) ) ) )).
