...
thf(f10019_0_2E0,type,(
    f10019_0_2E0: u )).

thf(f10019_0_2E2,type,(
...
thf(mono_2Ef10019_0,type,(
    mono_2Ef10019_0: $o > $o > $o )).
...
thf(def0_2Ethm_2EHolSmt_2Er024,axiom,(
    ! [V3p: $o,V2q: $o] :
      ( ( mono_2Ef10019_0 @ V3p @ V2q )
    <=> ( V3p
        | V2q ) ) )).

thf(thm_2EHolSmt_2Er024,conjecture,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u,V2q: $o,V3p: $o] :
      ...
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef10019_0 @ V3p @ V2q ) ) ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V0y_2E0 ) ) ) ) )).
