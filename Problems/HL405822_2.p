...
tff(lameq_f1081,axiom,(
    ! [A_27a: del,A_27b: del,V0g: $i] :
      ( mem(V0g,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f1081(A_27a,A_27b,V0g),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0g),inj__ty_2Enum_2Enum(V1i)) ) )).

tff(conj_thm_2Efcp_2EFCP__ETA,lemma,(
    ! [A_27a: del,A_27b: del,V0g: $i] :
      ( mem(V0g,ty_2Efcp_2Ecart(A_27a,A_27a))
...
tff(conj_thm_2Ewords_2EWORD__AND__IDEM,conjecture,(
    ! [A_27a: del,V0a: $i] :
