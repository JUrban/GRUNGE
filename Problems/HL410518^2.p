...
thf(conj_thm_2Ereal__topology_2ELINEAR__EQ,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__EQ__STDBASIS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              ...
              & ! [V2i: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2i ) ) )
                    = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V2i ) ) ) ) ) )
           => ( V0f = V1g ) ) ) ) )).
