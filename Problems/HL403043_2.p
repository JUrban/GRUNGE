...
tff(conj_thm_2EindexedLists_2ELT__SUC,lemma,(
...
tff(conj_thm_2EindexedLists_2ELIST__RELi__EL__EQN,lemma,(
...
tff(conj_thm_2EindexedLists_2ELIST__RELi__thm,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(A_27a,arr(A_27b,bool))))
     => ! [V1x: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4l: $i] :
                     ...
                     => ( ( p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),c_2Elist_2ENIL(A_27a)),V1x))
                        <=> V1x = c_2Elist_2ENIL(A_27b) )
                        & ( p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),ap(ap(c_2Elist_2ECONS(A_27a),V2h),V3t)),V4l))
                        <=> ? [V5h_27: $i] :
                              ( mem(V5h_27,A_27b)
                              & ? [V6t_27: $i] :
                                  ...
                                  & p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0R),c_2Enum_2ESUC)),V3t),V6t_27)) ) ) ) ) ) ) ) ) ) )).
