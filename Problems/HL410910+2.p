...
fof(conj_thm_2Ereal__topology_2ECONDENSATION__POINT__INFINITE__BALL__CBALL,lemma,
    ( ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONDENSATION__POINT__INFINITE__CBALL,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
