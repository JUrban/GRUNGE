...
thf(conj_thm_2Ehreal_2EHRAT__MUL__RID,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat] :
      ( ( surj__ty_2Ehrat_2Ehrat @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ ( inj__ty_2Ehrat_2Ehrat @ V0x ) ) @ ( inj__ty_2Ehrat_2Ehrat @ fo__c_2Ehrat_2Ehrat__1 ) ) )
      = V0x ) )).

thf(conj_thm_2Ehreal_2EHRAT__LT__NE,lemma,(
...
thf(conj_thm_2Ehreal_2EHRAT__LT__ADD2,lemma,(
...
thf(conj_thm_2Ehreal_2EHRAT__LT__LMUL1,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
...
thf(conj_thm_2Ehreal_2EHRAT__LT__R1,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
...
thf(conj_thm_2Ehreal_2EHREAL__ADD__ISACUT,conjecture,(
          ...
          @ ^ [V2w: $i] :
              ...
              @ ( lam @ ty_2Ehrat_2Ehrat
                @ ^ [V3x: $i] :
                    ...
                    @ ( lam @ ty_2Ehrat_2Ehrat
                      @ ^ [V4y: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Ehrat_2Ehrat ) @ V2w ) @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__add @ V3x ) @ V4y ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ V3x ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) @ V4y ) ) ) ) ) ) ) ) ) ) )).
