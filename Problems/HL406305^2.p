...
thf(ax_thm_2Etoto_2Eto__bij,axiom,(
    ! [A_27a: del] :
      ( ! [V0a: $i] :
      ...
      & ! [V1r: $i] :
         ...
         => ( ( p @ ( ap @ ( c_2Etoto_2ETotOrd @ A_27a ) @ V1r ) )
          <=> ( ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ ( ap @ ( c_2Etoto_2ETO @ A_27a ) @ V1r ) )
              = V1r ) ) ) ) )).

thf(conj_thm_2Etoto_2ETO__11,conjecture,(
    ! [A_27a: del,V0r: $i] :
     ...
     => ! [V1r_27: $i] :
         ...
         => ( ( p @ ( ap @ ( c_2Etoto_2ETotOrd @ A_27a ) @ V0r ) )
           => ( ( p @ ( ap @ ( c_2Etoto_2ETotOrd @ A_27a ) @ V1r_27 ) )
             => ( ( ( ap @ ( c_2Etoto_2ETO @ A_27a ) @ V0r )
                  = ( ap @ ( c_2Etoto_2ETO @ A_27a ) @ V1r_27 ) )
              <=> ( V0r = V1r_27 ) ) ) ) ) ) )).
