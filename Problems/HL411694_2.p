...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
        ...
        <=> ! [V2x: $i] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V2x),inj__ty_2Erealax_2Ereal(V1a)),c_2Ereal__topology_2Esequentially))
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V2x)),ap(V0f,inj__ty_2Erealax_2Ereal(V1a))),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2e: tp__ty_2Erealax_2Ereal,V3x: $i] :
             ...
             => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2e)))
                  ...
                  & ! [V4x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Erealax_2Ereal(V4x)))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2e)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V4x))))) )
                  & ! [V5n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V3x,inj__ty_2Enum_2Enum(V5n))),V1s))
                  & p(ap(c_2Ereal__topology_2Ecauchy,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V3x))) )
               => p(ap(c_2Ereal__topology_2Ecauchy,V3x)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2e: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2e)))
                ...
                & ! [V3x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Erealax_2Ereal(V3x)))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2e)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V3x))))) )
