...
thf(thm_2Ereal__topology_2ECONNECTED__EQUIVALENCE__RELATION,axiom,(
    ! [V0R: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econnected @ V1s )
        & ! [V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( V0R @ V2x @ V3y )
           => ( V0R @ V3y @ V2x ) )
        & ! [V4x: mono_2Etyop_2Erealax_2Ereal,V5y: mono_2Etyop_2Erealax_2Ereal,V6z: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0R @ V4x @ V5y )
              & ( V0R @ V5y @ V6z ) )
           => ( V0R @ V4x @ V6z ) )
        & ! [V7a: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V7a @ V1s )
           => ? [V8t: mono_2Etyop_2Erealax_2Ereal > $o] :
                ( ( mono_2Ec_2Etopology_2Eopen__in_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Esubtopology_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eeuclidean @ V1s ) @ V8t )
                & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V7a @ V8t )
                & ! [V9x: mono_2Etyop_2Erealax_2Ereal] :
                    ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V9x @ V8t )
                   => ( V0R @ V7a @ V9x ) ) ) ) )
     => ! [V10a: mono_2Etyop_2Erealax_2Ereal,V11b: mono_2Etyop_2Erealax_2Ereal] :
          ( ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V10a @ V1s )
            & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V11b @ V1s ) )
         => ( V0R @ V10a @ V11b ) ) ) )).

thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__IN,axiom,(
...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQUIVALENCE__RELATION,conjecture,(
    ! [V0R: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ! [V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( V0R @ V2x @ V3y )
           => ( V0R @ V3y @ V2x ) )
        ...
        & ! [V7a: mono_2Etyop_2Erealax_2Ereal] :
           ...
           => ? [V8t: mono_2Etyop_2Erealax_2Ereal > $o] :
                ...
                & ! [V9x: mono_2Etyop_2Erealax_2Ereal] :
                   ...
                   => ( V0R @ V7a @ V9x ) ) ) ) )
     => ! [V10a: mono_2Etyop_2Erealax_2Ereal,V11b: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Ereal__topology_2Econnected__component @ V1s @ V10a @ V11b )
         => ( V0R @ V10a @ V11b ) ) ) )).
