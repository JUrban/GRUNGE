...
fof(conj_thm_2Elebesgue_2Epsfis__add,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
                 ...
                 => ! [V3a] :
                     ...
                     => ! [V4b] :
                         ...
                         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                           ...
                           => p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),ap(ap(c_2Eextreal_2Eextreal__add,V3a),V4b)),ap(ap(c_2Elebesgue_2Epsfis(A_27a),V0m),f4126(A_27a,V1f,V2g)))) ) ) ) ) ) ) ) )).
