...
thf(f5179_0_2E0,type,(
    f5179_0_2E0: u )).

thf(f5179_0_2E2,type,(
    f5179_0_2E2: du > du > u )).

thf(f8022_0_2E0,type,(
    f8022_0_2E0: u )).

thf(f8022_0_2E2,type,(
    f8022_0_2E2: du > du > u )).
...
thf(mono_2Ef8022_0,type,(
    mono_2Ef8022_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq2_2Emono_2Ef5179_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5179_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f5179_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFAPPLY__FUPDATE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27b @ V2y_2E0 ) ) ) ) ) @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ A_27b @ V2y_2E0 ) ) )).

thf(thm_2Efinite__map_2EFDOM__FUPDATE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ A_27b @ V2b_2E0 ) ) ) ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) ) ) ) )).

thf(def0_2Ethm_2Efinite__map_2EFAPPLY__FUPDATE__THM,axiom,(
    ! [A_27a: d,V3x_2E0: u,V1a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5179_0_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V3x_2E0 )
        = ( s @ A_27a @ V1a_2E0 ) ) ) )).

thf(thm_2Efinite__map_2EFAPPLY__FUPDATE__THM,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u,V3x_2E0: u] :
      ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ A_27b @ V2b_2E0 ) ) ) ) ) @ ( s @ A_27a @ V3x_2E0 ) ) )
      = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5179_0_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) @ ( s @ A_27b @ V2b_2E0 ) @ ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Esptree_2Elookup__insert1,axiom,(
    ! [A_27a: d,V0k: mono_2Etyop_2Enum_2Enum,V1a_2E0: u,V2t_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0k ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0k ) ) @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V1a_2E0 ) ) ) ) )).

thf(def0_2Ethm_2Esptree_2Elookup__insert,axiom,(
    ! [V3k1: mono_2Etyop_2Enum_2Enum,V0k2: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef8022_0 @ V3k1 @ V0k2 )
    <=> ( V3k1 = V0k2 ) ) )).

thf(thm_2Esptree_2Elookup__insert,axiom,(
    ! [A_27a: d,V0k2: mono_2Etyop_2Enum_2Enum,V1v_2E0: u,V2t_2E0: u,V3k1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3k1 ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0k2 ) ) @ ( s @ A_27a @ V1v_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef8022_0 @ V3k1 @ V0k2 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V1v_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3k1 ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Efmsp_2EFMSP__FUPDATE,conjecture,(
