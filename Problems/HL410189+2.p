...
fof(lamtp_f3529,axiom,(
    ! [A_27b,A_27a,A_27b,V0a] :
...
fof(lamtp_f3528,axiom,(
    ! [A_27b,A_27a,A_27b,A_27a,V0a] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1b] :
          ( mem(V1b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
...
fof(ax_thm_2Emeasure_2Emeasurable__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Emeasure_2EIN__MEASURABLE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
