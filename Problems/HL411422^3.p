...
thf(thm_2Ereal__topology_2ECOMPONENTS__UNIV,conjecture,
    ( ( c_2Ereal__topology_2Ecomponents @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) )
    = ( c_2Epred__set_2EINSERT @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EEMPTY @ ( tyop_2Erealax_2Ereal > $o ) ) ) )).
