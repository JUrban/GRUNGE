...
fof(lamtp_f2104,axiom,(
    ! [A_27b] : mem(f2104(A_27b),arr(A_27b,ty_2Eoption_2Eoption(A_27b))) )).
...
fof(conj_thm_2Ealist_2EALOOKUP__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2EALOOKUP__APPEND__same,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ! [V2l] :
                     ...
                     => ( ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0l1) = ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V1l2)
                       => ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),V0l1),V2l)) = ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),V1l2),V2l)) ) ) ) ) ) ) )).
