...
tff(conj_thm_2Emetric_2EMETRIC__SAME,lemma,(
    ! [A_27a: del,V0m: $i] :
...
tff(conj_thm_2Emetric_2EBALL__OPEN,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Emetric_2Emetric(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2e: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Etopology_2Eopen__in(A_27a),ap(c_2Emetric_2Emtop(A_27a),V0m)),ap(ap(c_2Emetric_2EB(A_27a),V0m),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),inj__ty_2Erealax_2Ereal(V2e))))) ) ) ) )).

tff(conj_thm_2Emetric_2EBALL__NEIGH,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Emetric_2Emetric(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
