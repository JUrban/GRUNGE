...
tff(conj_thm_2Ewords_2Esaturate__w2w,lemma,(
...
tff(mem_c_2Einteger__word_2Esaturate__sw2w,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Einteger__word_2Esaturate__sw2w(A_27a,A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(conj_thm_2Einteger__word_2Ew2i__lt__0,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Einteger__word_2Esaturate__i2sw,lemma,(
...
tff(conj_thm_2Einteger__word_2Esaturate__sw2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ap(c_2Einteger__word_2Esaturate__sw2w(A_27a,A_27a),V0w) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__lt(A_27a),V0w),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ewords_2Esaturate__w2w(A_27a,A_27a),V0w)) ) )).
