...
fof(conj_thm_2Ereal__topology_2ESERIES__UNIQUE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
         ...
         => ! [V2l_27] :
             ...
             => ! [V3s] :
                 ...
                 => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),V3s))
                      & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V2l_27),V3s)) )
                   => V1l = V2l_27 ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EINFSUM__UNIQUE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
