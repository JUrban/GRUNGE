...
tff(thm_2Equotient_2EEQUALS__IMPLIES,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1P_27_2E0: u,V2Q_2E0: u,V3Q_27_2E0: u] :
      ( ( s(A_27a,V0P_2E0) = s(A_27a,V2Q_2E0)
        & s(A_27a,V1P_27_2E0) = s(A_27a,V3Q_27_2E0) )
     => ( s(A_27a,V0P_2E0) = s(A_27a,V1P_27_2E0)
       => s(A_27a,V2Q_2E0) = s(A_27a,V3Q_27_2E0) ) ) )).
