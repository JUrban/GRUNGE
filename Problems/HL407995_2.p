...
tff(lamtp_f2852,axiom,(
    ! [A_27a: del,V1x: $i] :
      ( mem(V1x,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f2852(A_27a,V1x),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f2852,axiom,(
    ! [A_27a: del,V1x: $i] :
     ...
     => ! [V3n: $i] :
          ( mem(V3n,A_27a)
         => ap(f2852(A_27a,V1x),V3n) = ap(c_2Ereal_2Eabs,ap(V1x,V3n)) ) ) )).

tff(conj_thm_2Enets_2ENET__ABS,lemma,(
    ! [A_27a: del,V0g: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2x0: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Enets_2Etends(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f2852(A_27a,V1x)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V2x0))),ap(ap(c_2Epair_2E_2C(ty_2Etopology_2Etopology(ty_2Erealax_2Ereal),ty_2Etopology_2Etopology(ty_2Erealax_2Ereal)),ap(c_2Emetric_2Emtop(ty_2Erealax_2Ereal),c_2Emetric_2Emr1)),V0g))) ) ) ) )).
...
tff(conj_thm_2Eseq_2ESEQ__ABS__IMP,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0f),inj__ty_2Erealax_2Ereal(V1l)))
         => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2877(V0f)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1l)))) ) ) )).
