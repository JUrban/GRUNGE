...
thf(f9923_0_2E0,type,(
    f9923_0_2E0: u )).

thf(f9923_0_2E1,type,(
    f9923_0_2E1: du > u )).

thf(f9923_0_2E2,type,(
    f9923_0_2E2: du > du > u )).
...
thf(mono_2Ef9923_0,type,(
    mono_2Ef9923_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Etransc_2EDIFF__EXP,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Ediffl @ mono_2Ec_2Etransc_2Eexp @ ( mono_2Ec_2Etransc_2Eexp @ V0x ) @ V0x ) )).

thf(thm_2Etransc_2EEXP__0,axiom,
    ( ( mono_2Ec_2Etransc_2Eexp @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
...
thf(def0_2Ethm_2Etransc_2EMCLAURIN__EXP__LE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V3m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9923_0 @ V0x @ V3m )
      = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V3m ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V3m ) ) ) ) )).

thf(thm_2Etransc_2EMCLAURIN__EXP__LE,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
    ? [V2t: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ V2t ) @ ( mono_2Ec_2Ereal_2Eabs @ V0x ) )
      & ( ( mono_2Ec_2Etransc_2Eexp @ V0x )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ V1n ) @ ( mono_2Ef9923_0 @ V0x ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Etransc_2Eexp @ V2t ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) ) ) ) ) )).
