...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__AT,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__AVOID,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__OPEN__AVOID,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
