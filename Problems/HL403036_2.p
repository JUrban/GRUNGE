...
tff(conj_thm_2Elist_2ELAST__CONS,lemma,(
    ! [A_27a: del] :
      ( ! [V0x: $i] :
          ( mem(V0x,A_27a)
...
tff(conj_thm_2Elist_2EFRONT__CONS,lemma,(
    ! [A_27a: del] :
      ( ! [V0x: $i] :
          ( mem(V0x,A_27a)
...
tff(conj_thm_2EindexedLists_2EfupdLast__def,lemma,(
    ! [A_27a: del] :
      ( ! [V0f: $i] :
...
tff(conj_thm_2EindexedLists_2EfupdLast__FRONT__LAST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27a))
     => ! [V1l: $i] :
