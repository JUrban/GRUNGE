...
thf(thm_2Eproduct_2ENPRODUCT__DELTA,conjecture,(
    ! [A_27a: $tType,V0b: tyop_2Enum_2Enum,V1s: A_27a > $o,V2a: A_27a] :
      ( ( c_2Eproduct_2Enproduct @ A_27a @ V1s
        @ ^ [V3x: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ A_27a @ V3x @ V2a ) @ V0b @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
