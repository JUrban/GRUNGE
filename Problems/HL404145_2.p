...
tff(conj_thm_2Epath_2Einfinite__PL,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( ~ p(ap(c_2Epath_2Efinite(A_27a,A_27a),V0p))
       => ! [V1i: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1i)),ap(c_2Epath_2EPL(A_27a,A_27a),V0p))) ) ) )).
