...
tff(lamtp_f2313,axiom,(
    ! [A_27a: del,V1y: $i] :
      ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2313(A_27a,V1y,V0x),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2313,axiom,(
    ! [A_27a: del,V1y: $i] :
     ...
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2313(A_27a,V1y,V0x),inj__ty_2Enum_2Enum(V2i)) = ap(ap(ap(ap(c_2Eblast_2EBSUM,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(c_2Efcp_2Efcp__index(bool,bool),V1y)),inj__o(fo__c_2Ebool_2EF)) ) ) )).

tff(conj_thm_2Eblast_2EBITWISE__ADD,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Ewords_2Eword__add(A_27a),V0x),V1y) = ap(c_2Efcp_2EFCP(bool,bool),f2313(A_27a,V1y,V0x)) ) ) )).
