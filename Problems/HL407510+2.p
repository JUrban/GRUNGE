...
fof(conj_thm_2Ereal_2EREAL__DIV__DENOM__CANCEL,lemma,(
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ! [V2z] :
             ...
             => ( V0x != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
               => ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2E_2F,V1y),V0x)),ap(ap(c_2Ereal_2E_2F,V2z),V0x)) = ap(ap(c_2Ereal_2E_2F,V1y),V2z) ) ) ) ) )).

fof(conj_thm_2Ereal_2EREAL__DIV__DENOM__CANCEL2,conjecture,(
    ! [V0y] :
