...
thf(thm_2Ebit_2EBIT__OF__BITS__THM,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1h: tyop_2Enum_2Enum,V2l: tyop_2Enum_2Enum,V3a: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2E_2B @ V2l @ V0n ) @ V1h )
     => ( ( c_2Ebit_2EBIT @ V0n @ ( c_2Ebit_2EBITS @ V1h @ V2l @ V3a ) )
        = ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2B @ V2l @ V0n ) @ V3a ) ) ) )).
...
thf(thm_2Ewords_2EROR__MOD,axiom,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__ror @ A_27a @ V0w @ ( c_2Earithmetic_2EMOD @ V1n @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
      = ( c_2Ewords_2Eword__ror @ A_27a @ V0w @ V1n ) ) )).

thf(thm_2Ewords_2Eword__ror__n2w,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__ror @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V1a ) @ V0n )
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ ( tyop_2Efcp_2Ecart @ $o @ A_27a )
        @ ^ [V2x: tyop_2Enum_2Enum] :
            ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBITS @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2x @ V1a ) @ ( c_2Earithmetic_2E_2A @ ( c_2Ebit_2EBITS @ ( c_2Earithmetic_2E_2D @ V2x @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ c_2Enum_2E0 @ V1a ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ V2x ) ) ) ) )
        @ ( c_2Earithmetic_2EMOD @ V0n @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) )).
