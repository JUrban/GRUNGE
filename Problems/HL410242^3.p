...
thf(thm_2Eextreal_2ESIMP__EXTREAL__ARCH,axiom,(
    ! [V0x: tyop_2Eextreal_2Eextreal] :
     ...
     => ? [V1n: tyop_2Enum_2Enum] :
          ( c_2Eextreal_2Eextreal__le @ V0x @ ( c_2Eextreal_2Eextreal__of__num @ V1n ) ) ) )).
    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Eextreal_2Eextreal,V1a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
     ...
     => ( c_2Ebool_2EIN @ ( A_27a > $o )
        @ ( c_2Epred__set_2EINTER @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V2x: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V2x @ ( c_2Emin_2E_3D @ tyop_2Eextreal_2Eextreal @ ( V0f @ V2x ) @ c_2Eextreal_2ENegInf ) ) )
          @ ( c_2Emeasure_2Espace @ A_27a @ V1a ) )
        @ ( c_2Emeasure_2Esubsets @ A_27a @ V1a ) ) ) )).
...
thf(thm_2Eseq_2ELE__SEQ__IMP__LE__LIM,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ V0x @ ( V2f @ V3n ) )
