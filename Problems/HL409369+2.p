...
fof(mem_c_2Ebinary__ieee_2Efloat__to__int,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => mem(c_2Ebinary__ieee_2Efloat__to__int(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),ty_2Eoption_2Eoption(ty_2Einteger_2Eint)))) ) ) )).
...
fof(mem_c_2Emachine__ieee_2Efp32__to__int,axiom,(
    mem(c_2Emachine__ieee_2Efp32__to__int,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),ty_2Eoption_2Eoption(ty_2Einteger_2Eint)))) )).

fof(ax_thm_2Emachine__ieee_2Efp32__to__int__def,axiom,(
    ! [V0mode] :
      ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
     => ap(c_2Emachine__ieee_2Efp32__to__int,V0mode) = ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__to__int(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0mode)),c_2Emachine__ieee_2Efp32__to__float) ) )).
...
fof(conj_thm_2Emachine__ieee_2Efp32__to__int,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1a] :
           ...
           => ap(ap(c_2Emachine__ieee_2Efp32__to__int,V0mode),ap(c_2Emachine__ieee_2Efloat__to__fp32,V1a)) = ap(ap(c_2Ebinary__ieee_2Efloat__to__int(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0mode),V1a) ) )
    & ! [V2mode] :
        ( mem(V2mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V3a] :
            ( mem(V3a,ty_2Enum_2Enum)
           => ap(ap(c_2Emachine__ieee_2Efp32__to__int,V2mode),ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))),V3a)) = ap(ap(c_2Ebinary__ieee_2Efloat__to__int(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V2mode),ap(c_2Emachine__ieee_2Efp32__to__float,ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))),V3a))) ) ) )).
