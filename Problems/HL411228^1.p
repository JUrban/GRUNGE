...
thf(f13340_0_2E0,type,(
    f13340_0_2E0: u )).

thf(f13340_0_2E1,type,(
    f13340_0_2E1: du > u )).

thf(f13340_0_2E2,type,(
...
thf(mono_2Ef13340_0,type,(
    mono_2Ef13340_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECOMPACT__TRANSLATION,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13340_0 @ V1a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ V2x ) ) )).

thf(thm_2Ereal__topology_2ECOMPACT__TRANSLATION,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Ecompact @ V0s )
     => ( mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13340_0 @ V1a ) @ V0s ) ) ) )).
