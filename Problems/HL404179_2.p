...
tff(conj_thm_2Epath_2Efinite__take,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1i)),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)))
         => p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),inj__ty_2Enum_2Enum(V1i)),V0p))) ) ) )).

tff(conj_thm_2Epath_2Elength__take,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1i)),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)))
         => surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Epath_2Elength(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),inj__ty_2Enum_2Enum(V1i)),V0p))) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1i)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).
