...
fof(lamtp_f3708,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3708(V1s),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

fof(lameq_f3708,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2y] :
          ( mem(V2y,ty_2Erealax_2Ereal)
         => ap(f3708(V1s),V2y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2y),ap(ap(c_2Ereal__topology_2Elimit__point__of,V2y),V1s)) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIMPT__OF__LIMPTS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V0x),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3708(V1s))))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__LIMPTS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3709(V0s)))) ) )).
