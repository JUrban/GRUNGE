...
tff(conj_thm_2Epred__set_2EFINITE__CROSS__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27b,bool))
...
tff(conj_thm_2Efloat_2EIS__VALID,lemma,(
...
tff(conj_thm_2Efloat_2EIS__VALID__FINITE,conjecture,(
