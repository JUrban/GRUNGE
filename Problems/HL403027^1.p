...
thf(thm_2EindexedLists_2EFOLDRi__CONG_27,conjecture,(
    ! [A_27a: d,A_27b: d,V0l2_2E0: u,V1l1_2E0: u,V2f2_2E0: u,V3f1_2E0: u,V4a2_2E0: u,V5a1_2E0: u] :
      ( ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 )
        ...
        & ! [V6n: mono_2Etyop_2Enum_2Enum,V7a_2E0: u] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V6n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) )
           => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V3f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) ) ) @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) @ ( s @ A_27b @ V7a_2E0 ) ) )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V2f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) ) ) @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) @ ( s @ A_27b @ V7a_2E0 ) ) ) ) )
        & ( ( s @ A_27b @ V5a1_2E0 )
          = ( s @ A_27b @ V4a2_2E0 ) ) )
     => ( ( s @ A_27b @ ( c_2EindexedLists_2EFOLDRi_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V3f1_2E0 ) @ ( s @ A_27b @ V5a1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) )
        = ( s @ A_27b @ ( c_2EindexedLists_2EFOLDRi_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V2f2_2E0 ) @ ( s @ A_27b @ V4a2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) )).
