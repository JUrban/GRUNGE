...
thf(f8982_0_2E0,type,(
    f8982_0_2E0: u )).

thf(f8982_0_2E1,type,(
    f8982_0_2E1: du > u )).

thf(f8982_0_2E2,type,(
    f8982_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef8982_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( f8982_0_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emetric_2Emetric @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) ) @ f8982_0_2E0 ) @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef8982_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f8982_0_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2Emetric_2Emtop,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1S_27_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f8982_0_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1S_27_2E0 ) ) ) )
    <=> ! [V2x_2E0: u] :
...
thf(thm_2Emetric_2Emtop,axiom,(
    ! [A_27a: d,V0m_2E0: u] :
      ( ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( c_2Emetric_2Emtop_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) ) )
      = ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( c_2Etopology_2Etopology_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( f8982_0_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) ) ) ) ) ) )).
