...
thf(thm_2Eset__relation_2Emaximal__union,conjecture,(
    ! [A_27a: $tType,V0e: A_27a,V1s: A_27a > $o,V2r1: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V3r2: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o] :
      ( ( c_2Ebool_2EIN @ A_27a @ V0e @ ( c_2Eset__relation_2Emaximal__elements @ A_27a @ V1s @ ( c_2Epred__set_2EUNION @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ V2r1 @ V3r2 ) ) )
     => ( ( c_2Ebool_2EIN @ A_27a @ V0e @ ( c_2Eset__relation_2Emaximal__elements @ A_27a @ V1s @ V2r1 ) )
        & ( c_2Ebool_2EIN @ A_27a @ V0e @ ( c_2Eset__relation_2Emaximal__elements @ A_27a @ V1s @ V3r2 ) ) ) ) )).
