...
thf(thm_2Ereal__topology_2Econtinuous__at,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V1f @ ( c_2Ereal__topology_2Eat @ V0x ) )
    <=> ! [V2e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V3d: tyop_2Erealax_2Ereal] :
              ...
              & ! [V4x_27: tyop_2Erealax_2Ereal] :
                  ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V4x_27 @ V0x ) ) @ V3d )
                 => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V1f @ V4x_27 ) @ ( V1f @ V0x ) ) ) @ V2e ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ESETDIST__LIPSCHITZ,axiom,(
    ! [A_27a: $tType,V0s: tyop_2Erealax_2Ereal > $o,V1t: A_27a,V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0s ) ) @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V3y @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0s ) ) ) ) @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2x @ V3y ) ) ) )).
