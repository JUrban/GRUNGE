...
fof(lamtp_f4004,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Erealax_2Ereal)
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f4004(V0m,V1c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0m] :
     ...
     => ! [V1c] :
         ...
         => ! [V2x] :
             ...
             => ap(f4004(V0m,V1c),V2x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V2x)),V1c) ) ) ) )).

fof(lamtp_f4005,axiom,(
    ! [V1c] :
      ( mem(V1c,ty_2Erealax_2Ereal)
     => ! [V0m] :
          ( mem(V0m,ty_2Erealax_2Ereal)
         => mem(f4005(V1c,V0m),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V1c] :
     ...
     => ! [V0m] :
         ...
         => ! [V3x] :
             ...
             => ap(f4005(V1c,V0m),V3x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V3x)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V1c))) ) ) ) )).

fof(lamtp_f4006,axiom,(
    ! [V1c] :
      ( mem(V1c,ty_2Erealax_2Ereal)
     => ! [V0m] :
          ( mem(V0m,ty_2Erealax_2Ereal)
         => mem(f4006(V1c,V0m),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V1c] :
     ...
     => ! [V0m] :
         ...
         => ! [V5x] :
             ...
             => ap(f4006(V1c,V0m),V5x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V5x)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V1c))) ) ) ) )).

fof(lamtp_f4007,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Erealax_2Ereal)
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f4007(V0m,V1c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0m] :
     ...
     => ! [V1c] :
         ...
         => ! [V6x] :
             ...
             => ap(f4007(V0m,V1c),V6x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V6x)),V1c) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EAFFINITY__INVERSES,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Erealax_2Ereal)
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
