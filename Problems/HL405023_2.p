...
tff(conj_thm_2Equotient__pair_2ESND__PRS,conjecture,(
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6p: $i] :
                                 ...
                                 => ap(c_2Epair_2ESND(A_27c,A_27c),V6p) = ap(V4abs2,ap(c_2Epair_2ESND(A_27a,A_27a),ap(ap(ap(c_2Epair_2E_23_23(A_27c,A_27c,A_27c,A_27c),V2rep1),V5rep2),V6p))) ) ) ) ) ) ) ) ) ) )).
