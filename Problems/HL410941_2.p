...
tff(lmtp_f3773,type,(
    f3773: ( del * del * tp__ty_2Erealax_2Ereal * $i * $i * $i * $i * $i * $i ) > $i )).

tff(lamtp_f3773,axiom,(
     ...
     => ! [V5m: $i] :
         ...
         => ! [V4l: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ! [V2f: $i] :
                      ( mem(V2f,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
                     => ! [V12e: tp__ty_2Erealax_2Ereal] : mem(f3772(A_27b,A_27a,V1P,V5m,V4l,V3g,V2f,V12e),arr(A_27a,bool)) ) ) ) ) ) )).

tff(lameq_f3772,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m: $i] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2EUNIFORM__LIM__SUB,conjecture,(
