...
thf(f2346_0_2E0,type,(
    f2346_0_2E0: u )).

thf(f2346_0_2E1,type,(
    f2346_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2346_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2346_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ f2346_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Elist_2ELAST_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ A_27b ) @ c_2Elist_2ELAST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2ELAST__DEF,axiom,(
    ! [A_27a: d,V1t_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2346_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) )
...
thf(thm_2Elist_2ELAST__DEF,axiom,(
    ! [A_27a: d,V0h_2E0: u,V1t_2E0: u] :
      ( ( s @ A_27a @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f2346_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ A_27a @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Elist_2ELAST__compute,conjecture,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0x_2E0: u] :
          ( ( s @ A_27a @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) ) )
          = ( s @ A_27a @ V0x_2E0 ) )
      & ! [V1h1_2E0: u,V2h2_2E0: u,V3t_2E0: u] :
          ( ( s @ A_27b @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V1h1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V2h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V3t_2E0 ) ) ) ) ) ) )
          = ( s @ A_27b @ ( c_2Elist_2ELAST_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V2h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V3t_2E0 ) ) ) ) ) ) ) )).
