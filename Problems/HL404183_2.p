...
tff(conj_thm_2Epath_2Esingleton__seg,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0i)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
       => ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V0i)),V1p) = ap(c_2Epath_2Estopped__at(A_27a,A_27a),ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),V1p)) ) ) )).
