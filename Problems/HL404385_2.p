...
tff(conj_thm_2Epred__set_2Ecount__EQN,lemma,(
...
tff(conj_thm_2Ecardinal_2ESET__SQUARED__CARDEQ__SET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2ESING__set__exp__CARD,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: $i] :
     ...
     => ! [V1B: $i] :
         ...
         => ! [V2A: $i] :
             ...
             => ( p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,ty_2Eoption_2Eoption(A_27b)),arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27b),V0x),c_2Epred__set_2EEMPTY(A_27b))),V1B)),ap(c_2Epred__set_2Ecount,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
                & p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27b,ty_2Eoption_2Eoption(A_27c)),arr(A_27b,ty_2Eoption_2Eoption(A_27c))),ap(ap(c_2Ecardinal_2Eset__exp(A_27b,A_27b),V2A),ap(ap(c_2Epred__set_2EINSERT(A_27b),V0x),c_2Epred__set_2EEMPTY(A_27b)))),V2A)) ) ) ) ) )).

tff(conj_thm_2Ecardinal_2Eexp__INSERT__cardeq,lemma,(
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2A: $i] :
             ...
             => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V0e),V1s))
               => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,ty_2Eoption_2Eoption(A_27b)),arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),V2A),ap(ap(c_2Epred__set_2EINSERT(A_27a),V0e),V1s))),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V2A),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),V2A),V1s)))) ) ) ) ) )).

tff(conj_thm_2Ecardinal_2Eexp__count__cardeq,conjecture,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))),ap(ap(c_2Ecardinal_2Eset__exp(ty_2Enum_2Enum,ty_2Enum_2Enum),V0A),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1n)))),V0A)) ) ) )).
