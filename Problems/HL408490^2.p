...
thf(stp_fo_c_2Ebinary__ieee_2Eis__integral,type,(
    fo__c_2Ebinary__ieee_2Eis__integral: tp__ty_2Erealax_2Ereal > $o )).

thf(stp_eq_fo_c_2Ebinary__ieee_2Eis__integral,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] :
      ( ( inj__o @ ( fo__c_2Ebinary__ieee_2Eis__integral @ X0 ) )
      = ( ap @ c_2Ebinary__ieee_2Eis__integral @ ( inj__ty_2Erealax_2Ereal @ X0 ) ) ) )).
          ...
          @ ( ap
            @ ( ap
              @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value__CASE @ bool ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value @ A_27t @ A_27w ) @ V0x ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V1r: $i] :
                      ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V1r ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
              @ ( inj__o @ fo__c_2Ebool_2EF ) )
            @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) ) ) )).
          ...
          @ ( ap
            @ ( ap
              @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value__CASE @ bool ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value @ A_27t @ A_27w ) @ V0x ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V1r: $i] :
                      ( ap @ c_2Ebinary__ieee_2Eis__integral @ V1r ) ) )
              @ ( inj__o @ fo__c_2Ebool_2EF ) )
            @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebinary__ieee_2Emin__properties,conjecture,(
    ! [A_27t: del,A_27w: del] :
