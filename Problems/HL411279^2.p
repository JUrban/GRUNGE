...
thf(conj_thm_2Ereal__topology_2EPASTING__LEMMA,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EPASTING__LEMMA__EXISTS,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
     => ! [V1t: $i] :
                 ...
                 => ( ( ( p
                      ...
                      & ! [V5i: $i] :
                         ...
                         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5i ) @ V3k ) )
                           => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) ) @ ( ap @ V1t @ V5i ) ) )
