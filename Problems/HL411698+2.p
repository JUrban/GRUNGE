...
fof(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__AT,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V1a))) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EOPEN__BIJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
