...
fof(conj_thm_2EEncode_2Ewf__pred__bnum,lemma,(
    ! [V0m] :
...
fof(conj_thm_2EEncode_2Ewf__encode__bnum__collision__free,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2EEncode_2Ewf__encode__bnum,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
