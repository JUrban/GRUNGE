...
tff(conj_thm_2Eordinal_2Esup__EQ__0,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Eordinal_2EIMAGE__EQ__SING,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ( ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V0f),V1s) = ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),c_2Epred__set_2EEMPTY(A_27a))
              <=> ( ? [V3y: $i] :
                      ( mem(V3y,A_27b)
...
tff(conj_thm_2Eordinal_2EordEXP__EQ__0,conjecture,(
    ! [A_27a: del,V0y: $i] :
