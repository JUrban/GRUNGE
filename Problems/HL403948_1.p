...
tff(arityeq1_2Ec_2Eoption_2ESOME_2E1_001,axiom,(
...
tff(arityeq3_2Ec_2Eoption_2Eoption__CASE_2E3_002,axiom,(
...
tff(thm_2Ellist_2ELTAKE__TAKE__LESS,axiom,(
    ! [A_27a: d,V0n_2E0: mono_2Etyop_2Enum_2Enum,V1m_2E0: mono_2Etyop_2Enum_2Enum,V2ll_2E0: u,V3l_2E0: u] :
      ( ( s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Ellist_2ELTAKE_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V2ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Elist_2Elist(A_27a),V3l_2E0)))
        & p(mono_2Ec_2Earithmetic_2E_3C_3D_2E2(V1m_2E0,V0n_2E0)) )
     => s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Ellist_2ELTAKE_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1m_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V2ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ETAKE_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1m_2E0)),s(tyop_2Elist_2Elist(A_27a),V3l_2E0))))) ) )).
...
tff(thm_2Erich__list_2EIS__PREFIX__APPEND,axiom,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V1l2_2E0),s(tyop_2Elist_2Elist(A_27a),V0l1_2E0)))))
    <=> ? [V2l_2E0: u] : s(tyop_2Elist_2Elist(A_27a),V0l1_2E0) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V1l2_2E0),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))) ) )).

tff(thm_2Erich__list_2Eprefixes__is__prefix__total,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1l1_2E0: u,V2l2_2E0: u] :
      ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V1l1_2E0),s(tyop_2Elist_2Elist(A_27a),V0l_2E0)))))
        & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V2l2_2E0),s(tyop_2Elist_2Elist(A_27a),V0l_2E0))))) )
     => ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V1l1_2E0),s(tyop_2Elist_2Elist(A_27a),V2l2_2E0)))))
        | p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(A_27a),V2l2_2E0),s(tyop_2Elist_2Elist(A_27a),V1l1_2E0))))) ) ) )).
...
tff(thm_2Ellist_2Eprefixes__lprefix__total,conjecture,(
    ! [A_27a: d,V0ll_2E0: u,V1l1_2E0: u,V2l2_2E0: u] :
      ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0)))))
        & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),V2l2_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0))))) )
     => ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0),s(tyop_2Ellist_2Ellist(A_27a),V2l2_2E0)))))
        | p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),V2l2_2E0),s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0))))) ) ) )).
