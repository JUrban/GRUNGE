...
fof(conj_thm_2EDecode_2Edec2enc__decode__blist,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
             ...
             => ! [V2d] :
                 ...
                 => ! [V3l] :
                     ...
                     => ( ( p(ap(ap(c_2EDecode_2Ewf__decoder(A_27a),V1p),V2d))
                       ...
                       => ap(ap(c_2EDecode_2Edec2enc(ty_2Elist_2Elist(A_27a)),ap(ap(ap(c_2EDecode_2Edecode__blist(A_27a),ap(ap(c_2EEncode_2Elift__blist(A_27a),V0m),V1p)),V0m),V2d)),V3l) = ap(ap(ap(c_2EEncode_2Eencode__blist(bool,bool),V0m),ap(c_2EDecode_2Edec2enc(A_27a),V2d)),V3l) ) ) ) ) ) ) )).
