...
tff(conj_thm_2Eprobability_2EEVENTS__INTER,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EPROB__ZERO__UNION,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2t),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                  & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),V2t))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__EQ__COMPL,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2t),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                  & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)),V1s))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)),V2t))) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t)) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__ONE__INTER,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
