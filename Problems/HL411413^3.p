...
thf(thm_2Ereal__topology_2ECLOSED__IN__COMPONENT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V0s ) @ V1c ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__COMPONENTS__FINITE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2Ecomponents @ V1s ) )
