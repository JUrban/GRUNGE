...
tff(lmtp_f2068,type,(
    f2068: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2068,axiom,(
    ! [A_27a: del,A_27a: del,V2s: $i] :
      ( mem(V2s,arr(A_27a,bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V0R: $i] :
              ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
             => mem(f2068(A_27a,A_27a,V2s,V1x,V0R),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) ) )).
    ...
    ! [A_27a: del,A_27a: del,V2s: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V0R: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27a)
                 => ap(f2068(A_27a,A_27a,V2s,V1x,V0R),V3y) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3y),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(V0R,V3y),V1x)),ap(ap(c_2Ebool_2EIN(A_27a),V3y),V2s))) ) ) ) ) )).
...
tff(ax_thm_2Equotient__pred__set_2EINSERTR__def,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,arr(A_27a,bool))
             => ap(ap(ap(c_2Equotient__pred__set_2EINSERTR(A_27a),V0R),V1x),V2s) = ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f2068(A_27a,A_27a,V2s,V1x,V0R)) ) ) ) )).

tff(conj_thm_2Equotient__pred__set_2EIN__INSERTR,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
