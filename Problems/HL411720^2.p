...
thf(conj_thm_2Ereal__topology_2EAFFINITY__INVERSES,conjecture,(
    ! [V0m: tp__ty_2Erealax_2Ereal,V1c: tp__ty_2Erealax_2Ereal] :
      ( ( V0m
       != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
     => ( ( ( ap
            @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V2x: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V3x: $i] :
                  ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) ) @ V3x ) ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) ) ) )
          = ( lam @ ty_2Erealax_2Ereal
            @ ^ [V4x: $i] : V4x ) )
        & ( ( ap
            @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V5x: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) ) @ V5x ) ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) ) ) )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V6x: $i] :
                  ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0m ) ) @ V6x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) )
          = ( lam @ ty_2Erealax_2Ereal
            @ ^ [V7x: $i] : V7x ) ) ) ) )).
