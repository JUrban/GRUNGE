...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s: $i] :
           ...
           => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1f),V0s))
             ...
             => ? [V2a: tp__ty_2Erealax_2Ereal] :
                ! [V3x: tp__ty_2Erealax_2Ereal] :
                 ...
                 => surj__ty_2Erealax_2Ereal(ap(V1f,inj__ty_2Erealax_2Ereal(V3x))) = V2a ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Econnected,V1s))
              ...
              & p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s))) )
           => ? [V2a: tp__ty_2Erealax_2Ereal] :
              ! [V3x: tp__ty_2Erealax_2Ereal] :
