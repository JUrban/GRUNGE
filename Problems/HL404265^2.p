...
thf(conj_thm_2EDecode_2Edec2enc__decode__bool,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ bool @ bool ) )
     => ! [V1x: $o] :
          ( ( p @ ( ap @ V0p @ ( inj__o @ V1x ) ) )
         => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EDecode_2Edec2enc @ bool ) @ ( ap @ c_2EDecode_2Edecode__bool @ V0p ) ) @ ( inj__o @ V1x ) ) )
            = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ c_2EEncode_2Eencode__bool @ ( inj__o @ V1x ) ) ) ) ) ) )).
