...
fof(conj_thm_2Epred__set_2EPREIMAGE__DIFF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Emeasure_2EMEASUBABLE__BIGUNION__LEMMA,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                          ...
                          & ! [V3s] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V3s),ap(c_2Emeasure_2Esubsets(A_27b),V1b)))
                               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f),V3s)),ap(c_2Emeasure_2Esubsets(A_27a),V0a))) ) ) )
                       => ! [V4c] :
                            ( mem(V4c,arr(arr(A_27a,bool),bool))
                           => ( ( p(ap(c_2Epred__set_2Ecountable(arr(A_27a,bool)),V4c))
                                & p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,bool)),V4c),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f)),ap(c_2Emeasure_2Esubsets(A_27b),V1b)))) )
                             => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(c_2Epred__set_2EBIGUNION(A_27a),V4c)),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f)),ap(c_2Emeasure_2Esubsets(A_27b),V1b)))) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Emeasure_2EMEASURABLE__SIGMA__PREIMAGES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2f] :
                     ...
                     => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                          ...
                          & ! [V3s] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V3s),ap(c_2Emeasure_2Esubsets(A_27b),V1b)))
                               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f),V3s)),ap(c_2Emeasure_2Esubsets(A_27a),V0a))) ) ) )
                       => p(ap(c_2Emeasure_2Esigma__algebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0a)),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f)),ap(c_2Emeasure_2Esubsets(A_27b),V1b))))) ) ) ) ) ) ) )).
