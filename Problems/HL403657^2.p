...
thf(conj_thm_2Elist_2EEVERY__SIMP,lemma,(
    ! [A_27a: del,V0c: $o,V1l: $i] :
...
thf(conj_thm_2Esorting_2EPERM__SPLIT__IF,lemma,(
    ! [A_27a: del,V0P: $i] :
             ...
             => ( ( p
                  @ ( ap
                    @ ( ap @ ( c_2Elist_2EEVERY @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V0P @ V3x ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1Q @ V3x ) ) ) ) )
                    @ V2l ) )
...
thf(conj_thm_2Esorting_2EPERM__SPLIT,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
