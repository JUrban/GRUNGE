...
fof(lameq_f3668,axiom,(
    ! [V2u] :
     ...
     => ! [V4v] :
         ...
         => ap(f3668(V2u),V4v) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2u,V4v)),V4v) ) ) )).

fof(conj_thm_2Ereal__topology_2EDEPENDENT__EXPLICIT,lemma,(
    ! [V0p] :
     ...
     => ( p(ap(c_2Ereal__topology_2Edependent,V0p))
      <=> ? [V1s] :
            ...
            & ? [V2u] :
                ...
                & ap(ap(c_2Eiterate_2ESum(ty_2Erealax_2Ereal),V1s),f3668(V2u)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EINDEPENDENT__INJECTIVE__IMAGE__GEN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
