...
thf(tp_c_2Erich__list_2ESPLITP__AUX,type,(
    c_2Erich__list_2ESPLITP__AUX: del > $i )).

thf(mem_c_2Erich__list_2ESPLITP__AUX,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Erich__list_2ESPLITP__AUX__def,axiom,(
    ! [A_27a: del] :
      ( ! [V0acc: $i] :
          ( ( mem @ V0acc @ ( ty_2Elist_2Elist @ A_27a ) )
         => ! [V1P: $i] :
              ( ( mem @ V1P @ ( arr @ A_27a @ bool ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP__AUX @ A_27a ) @ V0acc ) @ V1P ) @ ( c_2Elist_2ENIL @ A_27a ) )
                = ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0acc ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) )
      & ! [V2acc: $i] :
         ...
         => ! [V3P: $i] :
             ...
             => ! [V4h: $i] :
                 ...
                 => ! [V5t: $i] :
                     ...
                     => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP__AUX @ A_27a ) @ V2acc ) @ V3P ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V4h ) @ V5t ) )
                        = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Epair_2Eprod @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ V3P @ V4h ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2acc ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V4h ) @ V5t ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP__AUX @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2acc ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V4h ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) @ V3P ) @ V5t ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2ESPLITP__compute,conjecture,(
    ! [A_27a: del] :
      ( ( c_2Erich__list_2ESPLITP @ A_27a )
      = ( ap @ ( c_2Erich__list_2ESPLITP__AUX @ A_27a ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) )).
