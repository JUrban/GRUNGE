...
thf(thm_2Earithmetic_2EABS__DIFF__SUMS,axiom,(
    ! [V0n1: tyop_2Enum_2Enum,V1n2: tyop_2Enum_2Enum,V2m1: tyop_2Enum_2Enum,V3m2: tyop_2Enum_2Enum] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EABS__DIFF @ ( c_2Earithmetic_2E_2B @ V0n1 @ V1n2 ) @ ( c_2Earithmetic_2E_2B @ V2m1 @ V3m2 ) ) @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2EABS__DIFF @ V0n1 @ V2m1 ) @ ( c_2Earithmetic_2EABS__DIFF @ V1n2 @ V3m2 ) ) ) )).
    ...
    ! [A_27a: $tType,V0g: A_27a > tyop_2Enum_2Enum,V1f: A_27a > tyop_2Enum_2Enum,V2s: A_27a > $o] :
     ...
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EABS__DIFF @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a @ V1f @ V2s ) @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a @ V0g @ V2s ) )
        @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a
          @ ^ [V3x: A_27a] :
              ( c_2Earithmetic_2EABS__DIFF @ ( V1f @ V3x ) @ ( V0g @ V3x ) )
          @ V2s ) ) ) )).
