...
thf(thm_2Eset__relation_2ERRUNIV__def,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ...
      = ( ^ [V1x: A_27a,V2y: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V1x @ V0s ) @ ( c_2Ebool_2EIN @ A_27a @ V2y @ V0s ) ) ) ) )).
...
thf(thm_2Eset__relation_2ERREFL__EXP__def,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o,V1s: A_27a > $o] :
      ...
      = ( c_2Erelation_2ERUNION @ A_27a @ A_27a @ V0R
        @ ^ [V2x: A_27a,V3y: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ A_27a @ V2x @ V3y ) @ ( c_2Ebool_2E_7E @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1s ) ) ) ) ) )).
...
thf(thm_2Eset__relation_2Epartial__order__reln__to__rel__conv,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o] :
      ( ( c_2Eset__relation_2Epartial__order @ A_27a @ V1r @ V0s )
    <=> ( ( c_2Erelation_2ERSUBSET @ A_27a @ A_27a @ ( c_2Eset__relation_2Ereln__to__rel @ A_27a @ A_27a @ V1r ) @ ( c_2Eset__relation_2ERRUNIV @ A_27a @ V0s ) )
        & ( c_2Erelation_2EWeakOrder @ A_27a @ ( c_2Eset__relation_2ERREFL__EXP @ A_27a @ ( c_2Eset__relation_2Ereln__to__rel @ A_27a @ A_27a @ V1r ) @ V0s ) ) ) ) )).
