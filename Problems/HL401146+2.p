...
fof(conj_thm_2Eind__type_2EINJA__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a1] :
          ( mem(V0a1,A_27a)
...
fof(conj_thm_2Eind__type_2EINJF__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f1] :
...
fof(conj_thm_2Eind__type_2EMK__REC__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Eind__type_2EDEST__REC__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Eind__type_2ECONSTR__INJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c1] :
