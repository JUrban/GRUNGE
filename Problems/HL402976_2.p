...
tff(conj_thm_2EpatternMatches_2EPMATCH__EQUIV__ROWS__EQUIV__EXPAND,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rows1: $i] :
          ( mem(V1rows1,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
...
tff(conj_thm_2EpatternMatches_2EPMATCH__EQUIV__ROWS__CONS__NONE,lemma,(
...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__CONS,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1row: $i] :
         ...
         => ! [V2rows: $i] :
             ...
             => ! [V3c: tp__o,V4i: tp__o,V5infos_27: tp__c_ty_2Elist_2Elist_o] :
                  ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1row),V2rows)),inj__o(V3c)),ap(ap(c_2Elist_2ECONS(bool),inj__o(V4i)),inj__c_ty_2Elist_2Elist_o(V5infos_27))))
                <=> ( surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V2rows)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(bool),inj__c_ty_2Elist_2Elist_o(V5infos_27)))
                    ...
                    & ( ap(V1row,V0v) = c_2Eoption_2ENONE(A_27b)
                     => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V2rows),inj__o(V3c)),inj__c_ty_2Elist_2Elist_o(V5infos_27))) ) ) ) ) ) ) )).
...
tff(conj_thm_2EpatternMatches_2EAPPLY__REDUNDANT__ROWS__INFO__THMS,lemma,(
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__REDUNDANT__ROWS__INFO__EQUIV,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1c: tp__o,V2rows: $i] :
          ( mem(V2rows,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
