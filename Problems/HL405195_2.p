...
tff(conj_thm_2Efinite__map_2EMAP__KEYS__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
...
tff(conj_thm_2Efinite__map_2EMAP__KEYS__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1fm: $i] :
          ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__MAP,conjecture,(
