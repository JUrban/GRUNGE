...
fof(thm_2Ellist_2ELNTH__LMAP,conjecture,(
    ! [A_27a,A_27b,V0n_2E0,V1f_2E0,V2l_2E0] : s(tyop_2Eoption_2Eoption(A_27b),c_2Ellist_2ELNTH_2E2(s(tyop_2Enum_2Enum,V0n_2E0),s(tyop_2Ellist_2Ellist(A_27b),c_2Ellist_2ELMAP_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0),s(tyop_2Ellist_2Ellist(A_27a),V2l_2E0))))) = s(tyop_2Eoption_2Eoption(A_27b),c_2Eoption_2EOPTION__MAP_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0),s(tyop_2Eoption_2Eoption(A_27a),c_2Ellist_2ELNTH_2E2(s(tyop_2Enum_2Enum,V0n_2E0),s(tyop_2Ellist_2Ellist(A_27a),V2l_2E0))))) )).
