...
fof(conj_thm_2Ecardinal_2ECARDEQ__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EEMPTY__CARDLEQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0t] :
             ...
             => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),c_2Epred__set_2EEMPTY(A_27a)),V0t)) ) ) ) )).

fof(conj_thm_2Ecardinal_2Ecardleq__lteq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s1] :
             ...
             => ! [V1s2] :
                 ...
                 => ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s1),V1s2))
                  <=> ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V1s2),V0s1))
                      | p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s1),V1s2)) ) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2Ecardleq__empty,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
              ( mem(V0x,arr(A_27a,bool))
             => ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0x),c_2Epred__set_2EEMPTY(A_27b)))
              <=> V0x = c_2Epred__set_2EEMPTY(A_27a) ) ) ) ) )).
