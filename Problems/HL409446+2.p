...
fof(conj_thm_2Efloat_2EFLOAT__DISTINCT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Efloat_2EZERO__IS__ZERO,lemma,
    ( p(ap(c_2Eieee_2EIszero,c_2Eieee_2EPlus__zero))
    & p(ap(c_2Eieee_2EIszero,c_2Eieee_2EMinus__zero)) )).

fof(conj_thm_2Efloat_2EZERO__NOT__NAN,conjecture,
    ( ~ p(ap(c_2Eieee_2EIsnan,c_2Eieee_2EPlus__zero))
    & ~ p(ap(c_2Eieee_2EIsnan,c_2Eieee_2EMinus__zero)) )).
