...
fof(conj_thm_2Erich__list_2EREPLICATE__GENLIST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1x] :
              ( mem(V1x,A_27a)
             => ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V0n),V1x) = ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V1x)),V0n) ) ) ) )).

fof(conj_thm_2Erich__list_2ELIST__REL__REPLICATE__same,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1n] :
                 ...
                 => ! [V2x] :
                     ...
                     => ! [V3y] :
                          ( mem(V3y,A_27b)
                         => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V1n),V2x)),ap(ap(c_2Erich__list_2EREPLICATE(A_27b),V1n),V3y)))
