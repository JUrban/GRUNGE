...
fof(lameq_f2235,axiom,(
    ! [V1l] :
     ...
     => ap(f2235,V1l) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__or(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),V1l)),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),V1l)) ) )).

fof(conj_thm_2Ewords_2Efoldl__reduce__or,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ereduce__or(A_27a),V0w) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2235),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).
