...
fof(conj_thm_2Earithmetic_2EODD__MULT,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Estring__num_2Es2n__n2s,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Estring__num_2Es2n,ap(c_2Estring__num_2En2s,V0n)) = V0n ) )).

fof(conj_thm_2Estring__num_2En2s__s2n,lemma,(
    ! [V0s] :
...
fof(ax_thm_2Estring__num_2Es2ssum__def,axiom,(
    ! [V0s] :
      ( mem(V0s,ty_2Elist_2Elist(ty_2Estring_2Echar))
     => ap(c_2Estring__num_2Es2ssum,V0s) = ap(ap(ap(c_2Esum_2E_2B_2B(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Estring__num_2En2s),c_2Estring__num_2En2s),ap(c_2Estring__num_2En2nsum,ap(c_2Estring__num_2Es2n,V0s))) ) )).
...
fof(ax_thm_2Estring__num_2Essum2s__def,axiom,(
    ! [V0sm] :
     ...
     => ap(c_2Estring__num_2Essum2s,V0sm) = ap(c_2Estring__num_2En2s,ap(c_2Estring__num_2Ensum2n,ap(ap(ap(c_2Esum_2E_2B_2B(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),c_2Estring__num_2Es2n),c_2Estring__num_2Es2n),V0sm))) ) )).

fof(conj_thm_2Estring__num_2Es2ssum__ssum2s,conjecture,(
    ! [V0sm] :
      ( mem(V0sm,ty_2Esum_2Esum(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)))
