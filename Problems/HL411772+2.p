...
fof(conj_thm_2Ereal__topology_2ESERIES__DROP__LE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
                 ...
                 => ! [V4b] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V3a),V2s))
                          ...
                          & ! [V5x] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5x),V2s))
                               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V5x)),ap(V1g,V5x))) ) ) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,V3a),V4b)) ) ) ) ) ) ) )).
