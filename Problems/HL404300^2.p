...
thf(ax_thm_2Emergesort_2Estable__def,axiom,(
    ! [A_27a: del,V0R: $i] :
                   ...
                   => ( ! [V4x: $i] :
                         ...
                         => ! [V5y: $i] :
                             ...
                             => ( ( ( p @ ( ap @ V3p @ V4x ) )
                                  & ( p @ ( ap @ V3p @ V5y ) ) )
                               => ( p @ ( ap @ ( ap @ V0R @ V4x ) @ V5y ) ) ) ) )
                     => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V3p ) @ V1l1 )
                        = ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V3p ) @ V2l2 ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Emergesort_2Emergesort__perm,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
...
thf(conj_thm_2Emergesort_2Emergesort__sorted,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Emergesort_2Emergesort__stable,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Emergesort_2Emergesort__STABLE__SORT,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) )
          & ( p @ ( ap @ ( c_2Erelation_2Etotal @ A_27a ) @ V0R ) ) )
