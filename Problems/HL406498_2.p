...
tff(lamtp_f2303,axiom,(
    ! [V0x: tp__o] : mem(f2303(V0x),arr(bool,bool)) )).

tff(lameq_f2303,axiom,(
    ! [V0x: tp__o,V1y: tp__o] : ap(f2303(V0x),inj__o(V1y)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,inj__o(V0x)),inj__o(V1y))) )).

tff(lmtp_f2302,type,(
    f2302: $i )).

tff(lamtp_f2302,axiom,(
    mem(f2302,arr(bool,arr(bool,bool))) )).

tff(lameq_f2302,axiom,(
    ! [V0x: tp__o] : ap(f2302,inj__o(V0x)) = f2303(V0x) )).
...
tff(conj_thm_2Ebitstring_2Efixwidth__fixwidth,lemma,(
...
tff(conj_thm_2Ebitstring_2Eword__nand__v2w,conjecture,(
