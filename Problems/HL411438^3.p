...
thf(thm_2Ereal__topology_2ECONTINUOUS__UNIFORM__LIMIT,conjecture,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( (~) @ ( c_2Ereal__topology_2Etrivial__limit @ A_27a @ V0net ) )
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V4n: A_27a] :
              ( c_2Ereal__topology_2Econtinuous__on @ ( V1f @ V4n ) @ V3s )
          @ V0net )
           ...
           => ( c_2Ereal__topology_2Eeventually @ A_27a
              @ ^ [V6n: A_27a] :
                  ...
                  @ ^ [V7x: tyop_2Erealax_2Ereal] :
                      ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V3s ) @ ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V1f @ V6n @ V7x ) @ ( V2g @ V7x ) ) ) @ V5e ) ) )
              @ V0net ) ) )
