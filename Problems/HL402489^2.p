...
thf(conj_thm_2EquantHeuristics_2EGUESS__RULES__IMP,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: $i] :
      ( ( mem @ V0i @ ( arr @ A_27a @ A_27b ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27b @ bool ) )
                      ...
                      ( ( ( p
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V7x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V7x ) ) @ ( ap @ V2Q @ V7x ) ) ) ) ) )
                      & ( ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V8x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V9x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V9x ) ) @ ( ap @ V2Q @ V9x ) ) ) ) ) )
                      & ( ( ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V10x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V12x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V12x ) ) @ ( ap @ V2Q @ V12x ) ) ) ) ) )
                      & ( ( ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V13x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V15x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V15x ) ) @ ( ap @ V2Q @ V15x ) ) ) ) ) )
                      & ( ( ( p
                            @ ( ap
                      ...
                      & ( ( p
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V23x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V23x ) ) @ ( inj__o @ V4q ) ) ) ) ) )
                      & ( ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V24x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V25x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( inj__o @ V5p ) ) @ ( ap @ V2Q @ V25x ) ) ) ) ) )
                      & ( ( ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V26x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V28x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V28x ) ) @ ( ap @ V2Q @ V28x ) ) ) ) ) )
                      & ( ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V29x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V30x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V30x ) ) @ ( ap @ V2Q @ V30x ) ) ) ) ) )
                      & ( ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V31x: $i] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                            @ ( lam @ A_27b
                              @ ^ [V32x: $i] :
                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V32x ) ) @ ( ap @ V2Q @ V32x ) ) ) ) ) ) ) ) ) ) ) )).
