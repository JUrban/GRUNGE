...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V2s))
                     => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V3x))) = surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) )
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPOSE__QUOTIENT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2EFUNCTION__FACTORS__LEFT__GEN,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
         => ! [V2g: $i] :
              ( mem(V2g,arr(A_27a,A_27c))
             => ( ! [V3x: $i] :
                    ( mem(V3x,A_27a)
                   => ! [V4y: $i] :
                        ( mem(V4y,A_27a)
                       => ( ( p(ap(V0P,V3x))
                            & p(ap(V0P,V4y))
                            & ap(V2g,V3x) = ap(V2g,V4y) )
                         => ap(V1f,V3x) = ap(V1f,V4y) ) ) )
              <=> ? [V5h: $i] :
                    ( mem(V5h,arr(A_27c,A_27b))
                    & ! [V6x: $i] :
                        ( mem(V6x,A_27a)
                       => ( p(ap(V0P,V6x))
                         => ap(V1f,V6x) = ap(V5h,ap(V2g,V6x)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1h: $i] :
