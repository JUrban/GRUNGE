...
tff(conj_thm_2Equotient_2EW__PRS,conjecture,(
                   ...
                   => ! [V4abs2: $i] :
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6f: $i] :
                                  ( mem(V6f,arr(A_27c,arr(A_27c,A_27d)))
                                 => ! [V7x: $i] :
                                      ( mem(V7x,A_27c)
                                     => ap(ap(c_2Ecombin_2EW(A_27c,A_27c),V6f),V7x) = ap(V4abs2,ap(ap(c_2Ecombin_2EW(A_27a,A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),V5rep2)),V6f)),ap(V2rep1,V7x))) ) ) ) ) ) ) ) ) ) ) )).
