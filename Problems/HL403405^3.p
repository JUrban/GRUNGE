...
thf(thm_2Ebag_2Emlt__NOT__REFL,conjecture,(
    ! [A_27a: $tType,V0a: A_27a > tyop_2Enum_2Enum,V1R: A_27a > A_27a > $o] :
      ( ( c_2Erelation_2EWF @ A_27a @ V1R )
     => ( (~) @ ( c_2Erelation_2ETC @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ A_27a @ V1R ) @ V0a @ V0a ) ) ) )).
