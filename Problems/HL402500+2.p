...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__STRENGTHEN__FORALL__GAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1P] :
                 ...
                 => ! [V2Q] :
                     ...
                     => ( ! [V3x] :
                           ...
                           => ( p(ap(V1P,V3x))
                             => p(ap(V2Q,V3x)) ) )
                       => ( p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27b,A_27b),V0i),V1P))
                         => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27b,A_27b),V0i),V2Q)) ) ) ) ) ) ) ) )).
