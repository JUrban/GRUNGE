...
tff(conj_thm_2Ereal__topology_2EOPEN__DIFF,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__EQ__EMPTY__ALT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ENOWHERE__DENSE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
