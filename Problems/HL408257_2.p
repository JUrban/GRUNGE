...
tff(conj_thm_2Ereal_2EREAL__INV__LT1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x)))) ) )).
...
tff(conj_thm_2Etransc_2EEXP__NEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x)))) )).

tff(conj_thm_2Etransc_2EEXP__TOTAL__LEMMA,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V0y)))
     => ? [V1x: tp__ty_2Erealax_2Ereal] :
          ...
          & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0y)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))
          & surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V1x))) = V0y ) ) )).

tff(conj_thm_2Etransc_2EEXP__TOTAL,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
     ...
     => ? [V1x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V1x))) = V0y ) )).
