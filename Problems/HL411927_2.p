...
tff(conj_thm_2Ereal__topology_2ELOCALLY__SING,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Ereal__topology_2Elocally,V0P),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))))
        <=> p(ap(V0P,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) ) ) )).
