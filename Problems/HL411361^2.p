...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__IFF__LOWER__HEMICONTINUOUS__PREIMAGE,conjecture,(
    ! [V0f: $i] :
               ...
               => ( ! [V3u: $i] :
                ...
                <=> ! [V4u: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V1s ) ) @ V4u ) )
                       => ( p
                          @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2t ) )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V5y: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5y )
                                    @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5y ) @ V2t ) )
                                      @ ( ap
                                        @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                            @ ( lam @ ty_2Erealax_2Ereal
                                              @ ^ [V6x: $i] :
                                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V5y ) ) ) ) ) )
                                        @ V4u ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
