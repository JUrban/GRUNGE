...
fof(mem_c_2Eprobability_2Euniform__distribution,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [A_27d] :
                  ( ne(A_27d)
                 => mem(c_2Eprobability_2Euniform__distribution(A_27a,A_27a,A_27a,A_27a),arr(A_27b,arr(A_27c,arr(ty_2Epair_2Eprod(arr(A_27d,bool),arr(A_27d,bool)),arr(arr(A_27a,bool),ty_2Erealax_2Ereal))))) ) ) ) ) )).
...
fof(ax_thm_2Eprobability_2Euniform__distribution__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2Euniform__distribution__prob__space,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
