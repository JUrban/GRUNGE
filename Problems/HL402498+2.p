...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__EXISTS__UNIQUE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
