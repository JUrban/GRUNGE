...
tff(conj_thm_2EindexedLists_2EMAPi__CONG_27,conjecture,(
             ...
             => ! [V3f2: $i] :
                 ...
                 => ( V0l1 = V1l2
                   => ( ! [V4x: $i] :
                     ...
                     => ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V2f1),V0l1) = ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V3f2),V1l2) ) ) ) ) ) ) )).
