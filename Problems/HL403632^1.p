...
thf(f4072_0_2E0,type,(
    f4072_0_2E0: u )).

thf(f4072_0_2E1,type,(
    f4072_0_2E1: du > u )).

thf(f4072_0_2E2,type,(
    f4072_0_2E2: du > du > u )).
...
thf(c_2Efcp_2EL2V_2E0,type,(
    c_2Efcp_2EL2V_2E0: u )).

thf(c_2Efcp_2EL2V_2E1,type,(
...
thf(arityeq1_2Emono_2Ef4072_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4072_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4072_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4072_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4072_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4072_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Efcp_2EL2V_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EL2V_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) ) @ c_2Efcp_2EL2V_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Efcp_2EL2V__def,axiom,(
    ! [A_27a: d,V0L_2E0: u,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4072_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) ) )
...
thf(thm_2Efcp_2EL2V__def,axiom,(
    ! [A_27a: d,A_27b: d,V0L_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EL2V_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4072_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L_2E0 ) ) ) ) ) ) )).

thf(thm_2Efcp_2EREAD__L2V,conjecture,(
    ! [A_27a: d,A_27b: d,V0i: mono_2Etyop_2Enum_2Enum,V1a_2E0: u] :
     ...
     => ( ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EL2V_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) ) )
        = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a_2E0 ) ) ) ) ) )).
