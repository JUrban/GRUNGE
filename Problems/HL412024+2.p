...
fof(mem_c_2Emeasure_2Enull__set,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Emeasure_2Enull__set(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),bool))) ) )).
...
fof(ax_thm_2Emeasure_2Enull__set__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
         ...
         => ! [V1s] :
             ...
             => ( p(ap(ap(c_2Emeasure_2Enull__set(A_27a),V0m),V1s))
              <=> ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                  & ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Eintegrable__infty,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(lameq_f4194,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V0m] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f4194(A_27a,V1f,V0m),V2x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Emeasure_2Em__space(A_27a),V0m))),ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V2x)),c_2Eextreal_2EPosInf))) ) ) ) )).

fof(conj_thm_2Elebesgue_2Eintegrable__infty__null,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
