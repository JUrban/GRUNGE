...
thf(c_2Elebesgue_2Eprod__sets3,type,(
    c_2Elebesgue_2Eprod__sets3: 
      !>[A_27a: $tType,A_27b: $tType,A_27c: $tType] :
        ( ( ( A_27a > $o ) > $o ) > ( ( A_27b > $o ) > $o ) > ( ( A_27c > $o ) > $o ) > ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) > $o ) )).
...
thf(thm_2Elebesgue_2Efinite__prod__measure__space__POW3,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0s1: A_27a > $o,V1s2: A_27b > $o,V2s3: A_27c > $o,V3u: ( A_27a > $o ) > tyop_2Erealax_2Ereal,V4v: ( A_27b > $o ) > tyop_2Erealax_2Ereal,V5w: ( A_27c > $o ) > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s1 )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1s2 )
        & ( c_2Epred__set_2EFINITE @ A_27c @ V2s3 ) )
     => ( ( c_2Elebesgue_2Eprod__measure__space3 @ A_27a @ A_27b @ A_27c @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ V0s1 @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ V0s1 ) @ V3u ) ) @ ( c_2Epair_2E_2C @ ( A_27b > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27b > $o ) > $o ) @ ( ( A_27b > $o ) > tyop_2Erealax_2Ereal ) ) @ V1s2 @ ( c_2Epair_2E_2C @ ( ( A_27b > $o ) > $o ) @ ( ( A_27b > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27b @ V1s2 ) @ V4v ) ) @ ( c_2Epair_2E_2C @ ( A_27c > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27c > $o ) > $o ) @ ( ( A_27c > $o ) > tyop_2Erealax_2Ereal ) ) @ V2s3 @ ( c_2Epair_2E_2C @ ( ( A_27c > $o ) > $o ) @ ( ( A_27c > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27c @ V2s3 ) @ V5w ) ) )
        = ( c_2Epair_2E_2C @ ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) @ ( tyop_2Epair_2Eprod @ ( ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) > $o ) @ ( ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Epred__set_2ECROSS @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ V0s1 @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c @ V1s2 @ V2s3 ) ) @ ( c_2Epair_2E_2C @ ( ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) > $o ) @ ( ( ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) @ ( c_2Epred__set_2ECROSS @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ V0s1 @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c @ V1s2 @ V2s3 ) ) ) @ ( c_2Elebesgue_2Eprod__measure3 @ A_27a @ A_27b @ A_27c @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ V0s1 @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ V0s1 ) @ V3u ) ) @ ( c_2Epair_2E_2C @ ( A_27b > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27b > $o ) > $o ) @ ( ( A_27b > $o ) > tyop_2Erealax_2Ereal ) ) @ V1s2 @ ( c_2Epair_2E_2C @ ( ( A_27b > $o ) > $o ) @ ( ( A_27b > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27b @ V1s2 ) @ V4v ) ) @ ( c_2Epair_2E_2C @ ( A_27c > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27c > $o ) > $o ) @ ( ( A_27c > $o ) > tyop_2Erealax_2Ereal ) ) @ V2s3 @ ( c_2Epair_2E_2C @ ( ( A_27c > $o ) > $o ) @ ( ( A_27c > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27c @ V2s3 ) @ V5w ) ) ) ) ) ) ) )).
