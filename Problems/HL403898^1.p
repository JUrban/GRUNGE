...
thf(thm_2Ellist_2ENOT__LFINITE__TAKE,axiom,(
    ! [A_27a: d,V0ll_2E0: u] :
     ...
     => ! [V1n: mono_2Etyop_2Enum_2Enum] :
        ? [V2y_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2y_2E0 ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELFINITE__LNTH__NONE,conjecture,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) )
    <=> ? [V1n: mono_2Etyop_2Enum_2Enum] :
