...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__ABS__LE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                & ! [V4y: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Erealax_2Ereal(V4y)))),inj__ty_2Erealax_2Ereal(V3b))) )
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Ereal__topology_2Eclosure,V1s))) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V3b))) ) ) ) )).
