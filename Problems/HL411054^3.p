...
thf(thm_2Ereal__topology_2ECOMPACT__IMP__TOTALLY__BOUNDED,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
     ...
     => ! [V1e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V2k: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ V2k )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2k @ V0s )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0s
                @ ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal
                  @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ ( tyop_2Erealax_2Ereal > $o )
                    @ ^ [V3x: tyop_2Erealax_2Ereal] :
                        ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V3x @ V1e ) )
                    @ V2k ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2EHEINE__BOREL__LEMMA,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ecompact @ V0s )
     => ! [V1t: ( tyop_2Erealax_2Ereal > $o ) > $o] :
          ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V1t ) )
            & ! [V2b: tyop_2Erealax_2Ereal > $o] :
                ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2b @ V1t )
               => ( c_2Ereal__topology_2EOpen @ V2b ) ) )
         => ? [V3e: tyop_2Erealax_2Ereal] :
              ...
              & ! [V4x: tyop_2Erealax_2Ereal] :
                 ...
                 => ? [V5b: tyop_2Erealax_2Ereal > $o] :
                      ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V5b @ V1t )
                      & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V4x @ V3e ) ) @ V5b ) ) ) ) ) ) )).
