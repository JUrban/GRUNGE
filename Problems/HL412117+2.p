...
fof(conj_thm_2Eprobability_2Edistribution__lebesgue__thm1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V3A] :
                         ...
                         => ( ( p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),V2s))
                           ...
                           => ap(c_2Eextreal_2ENormal,ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),V3A)) = ap(ap(c_2Elebesgue_2Eintegral(A_27a),V1p),ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0X),V3A)),ap(c_2Eprobability_2Ep__space(A_27a),V1p)))) ) ) ) ) ) ) ) )).
