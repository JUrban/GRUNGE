...
fof(lamtp_f1870,axiom,(
    ! [A_27b,A_27a,A_27b,A_27a,V1t] :
      ( mem(V1t,arr(A_27b,bool))
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2EFINITE__PRODUCT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                   ...
                   => p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1870(A_27b,A_27a,A_27b,A_27a,V1t,V0s))))) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2Emul__c,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__MUL__FINITE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                      & p(ap(c_2Epred__set_2EFINITE(A_27b),V1t)) )
                   => p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1t))) ) ) ) ) ) )).
