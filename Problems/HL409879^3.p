    ...
    ! [A_27a: $tType,A_27b: $tType] :
      ...
      & ! [V5f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V6g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V7a: tyop_2Enum_2Enum,V8b: tyop_2Enum_2Enum] :
          ( ! [V9i: tyop_2Enum_2Enum] :
             ...
             => ( ( V5f @ V9i )
                = ( V6g @ V9i ) ) )
         => ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V7a @ V8b )
              @ ^ [V10i: tyop_2Enum_2Enum] :
                  ( V5f @ V10i ) )
            = ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V7a @ V8b ) @ V6g ) ) )
      & ! [V11f: A_27b > tyop_2Erealax_2Ereal,V12g: A_27b > tyop_2Erealax_2Ereal,V13p: A_27b > $o] :
         ...
         => ( ( c_2Eiterate_2ESum @ A_27b
              @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b
                @ ^ [V15y: A_27b] :
                    ( c_2Epair_2E_2C @ A_27b @ $o @ V15y @ ( V13p @ V15y ) ) )
              @ ^ [V16i: A_27b] :
                  ( V11f @ V16i ) )
            = ( c_2Eiterate_2ESum @ A_27b
              @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b
                @ ^ [V17y: A_27b] :
                    ( c_2Epair_2E_2C @ A_27b @ $o @ V17y @ ( V13p @ V17y ) ) )
              @ V12g ) ) ) ) )).
