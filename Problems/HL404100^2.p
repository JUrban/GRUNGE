...
thf(tp_c_2Ebag_2EBAG__GEN__PROD,type,(
    c_2Ebag_2EBAG__GEN__PROD: $i )).

thf(mem_c_2Ebag_2EBAG__GEN__PROD,axiom,(
...
thf(conj_thm_2Earithmetic_2EMULT__EQ__ID,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        = V1n )
    <=> ( ( V0m
...
thf(conj_thm_2Ebag_2EBAG__GEN__PROD__EMPTY,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ ( c_2Ebag_2EEMPTY__BAG @ ty_2Enum_2Enum ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      = V0n ) )).

thf(conj_thm_2Ebag_2EBAG__GEN__PROD__TAILREC,lemma,(
    ! [V0b: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ V0b ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ V0b ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EBAG__GEN__PROD__REC,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ V0b ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ V0b ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Edivides_2ENOT__PRIME__1,lemma,(
...
thf(conj_thm_2Edivides_2EPRIME__FACTOR,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( V0n
       != ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
...
thf(conj_thm_2EprimeFactor_2EPRIME__FACTORS__EXIST,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
