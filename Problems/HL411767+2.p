...
fof(conj_thm_2Ereal__topology_2ESERIES__FINITE,lemma,(
    ! [V0f] :
...
fof(lameq_f4015,axiom,(
    ! [V0x] :
     ...
     => ! [V2y] :
         ...
         => ! [V5n] :
              ( mem(V5n,ty_2Enum_2Enum)
             => ap(f4015(V0x,V2y),V5n) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,V5n)),ap(V2y,V5n)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__SUB,lemma,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0] :
             ...
             => ! [V3y0] :
                 ...
                 => ! [V4s] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),V1x0),V4s))
                       ...
                       => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4015(V0x,V2y)),ap(ap(c_2Ereal_2Ereal__sub,V1x0),V3y0)),V4s)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESUMS__FINITE__DIFF,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1t] :
         ...
         => ! [V2s] :
             ...
             => ! [V3l] :
                 ...
                 => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),V1t),V2s))
                      ...
                      & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V3l),V2s)) )
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Ereal_2Ereal__sub,V3l),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),V1t),V0f))),ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),V2s),V1t))) ) ) ) ) ) )).
