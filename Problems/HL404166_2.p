...
tff(conj_thm_2Epath_2Enumeral__drop,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0n: tp__ty_2Enum_2Enum,V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
         => ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V0n)))),V1p) = ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V0n)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Epath_2Etail(A_27a,A_27a),V1p)) )
      & ! [V2n: tp__ty_2Enum_2Enum,V3p: $i] :
          ( mem(V3p,ty_2Epath_2Epath(A_27a,A_27a))
         => ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(V2n)))),V3p) = ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V2n)))),ap(c_2Epath_2Etail(A_27a,A_27a),V3p)) ) ) )).
