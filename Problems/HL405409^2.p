...
thf(conj_thm_2Einteger_2EINT__LE__SQUARE,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V0x ) ) ) ) )).
...
thf(conj_thm_2Einteger_2EINT__POASQ,conjecture,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
