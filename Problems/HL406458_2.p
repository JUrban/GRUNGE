...
tff(lmtp_f2294,type,(
    f2294: ( tp__ty_2Enum_2Enum * tp__c_ty_2Elist_2Elist_o ) > $i )).

tff(lamtp_f2294,axiom,(
    ! [V2l: tp__ty_2Enum_2Enum,V0v: tp__c_ty_2Elist_2Elist_o] : mem(f2294(V2l,V0v),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))) )).

tff(lameq_f2294,axiom,(
    ! [V2l: tp__ty_2Enum_2Enum,V0v: tp__c_ty_2Elist_2Elist_o,V3x: tp__ty_2Enum_2Enum] : ap(f2294(V2l,V0v),inj__ty_2Enum_2Enum(V3x)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(bool)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2l)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3x)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),inj__c_ty_2Elist_2Elist_o(V0v)),ap(ap(c_2Elist_2EAPPEND(bool),ap(ap(ap(c_2Ebitstring_2Efield,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3x)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__c_ty_2Elist_2Elist_o(V0v))),ap(ap(ap(c_2Ebitstring_2Efield,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2l)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V3x)),inj__c_ty_2Elist_2Elist_o(V0v)))) )).

tff(lmtp_f2293,type,(
    f2293: ( tp__c_ty_2Elist_2Elist_o * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2293,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1m: tp__ty_2Enum_2Enum] : mem(f2293(V0v,V1m),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))) )).

tff(lameq_f2293,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1m: tp__ty_2Enum_2Enum,V2l: tp__ty_2Enum_2Enum] : ap(f2293(V0v,V1m),inj__ty_2Enum_2Enum(V2l)) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2294(V2l,V0v)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2l))) )).

tff(ax_thm_2Ebitstring_2Erotate__def,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1m: tp__ty_2Enum_2Enum] : surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Ebitstring_2Erotate,inj__c_ty_2Elist_2Elist_o(V0v)),inj__ty_2Enum_2Enum(V1m))) = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2293(V0v,V1m)),ap(c_2Elist_2ELENGTH(bool),inj__c_ty_2Elist_2Elist_o(V0v)))) )).
...
tff(conj_thm_2Ebitstring_2Elength__rotate,conjecture,(
