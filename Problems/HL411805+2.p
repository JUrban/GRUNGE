...
fof(conj_thm_2Ereal__topology_2ESERIES__CAUCHY__UNIFORM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
                           ...
                           => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V4e))
                             => ? [V5N] :
                                  ...
                                  & ! [V6n] :
                                     ...
                                     => ! [V7x] :
                                          ( mem(V7x,A_27a)
                                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V5N),V6n))
                                              & p(ap(V0P,V7x)) )
                                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V2k),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V6n))),ap(V1f,V7x))),ap(V3l,V7x)))),V4e)) ) ) ) ) ) ) )
                  <=> ! [V8e] :
                         ...
                         => ? [V9N] :
                              ...
                              & ! [V10m] :
                                 ...
                                 => ! [V11n] :
                                     ...
                                     => ! [V12x] :
                                          ( mem(V12x,A_27a)
                                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V9N),V10m))
                                              & p(ap(V0P,V12x)) )
                                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V2k),ap(ap(c_2Eiterate_2E_2E_2E,V10m),V11n))),ap(V1f,V12x)))),V8e)) ) ) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__COMPARISON__UNIFORM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
         => ! [V1g] :
             ...
             => ! [V2P] :
                 ...
                 => ! [V3s] :
                     ...
                     => ( ( ? [V4l] :
                              ...
                              & p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),V4l),V3s)) )
                          & ? [V5N] :
                              ( mem(V5N,ty_2Enum_2Enum)
                              & ! [V6n] :
                                  ( mem(V6n,ty_2Enum_2Enum)
                                 => ! [V7x] :
                                      ( mem(V7x,A_27a)
                                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V5N),V6n))
                                          & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V6n),V3s))
                                          & p(ap(V2P,V7x)) )
                                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(V0f,V7x),V6n))),ap(V1g,V6n))) ) ) ) ) )
                       => ? [V8l] :
                            ( mem(V8l,arr(A_27a,ty_2Erealax_2Ereal))
                            & ! [V9e] :
                                      ...
                                      & ! [V11n] :
                                         ...
                                         => ! [V12x] :
                                             ...
                                             => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V10N),V11n))
                                                  & p(ap(V2P,V12x)) )
                                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V3s),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V11n))),ap(V0f,V12x))),ap(V8l,V12x)))),V9e)) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
