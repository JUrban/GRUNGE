...
tff(conj_thm_2Epred__set_2EINJ__IMAGE__SUBSET,lemma,(
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),V1s),V2t))
               => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)),V2t)) ) ) ) ) )).

tff(conj_thm_2Epred__set_2EFINITE__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ECARD__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Epred__set_2EINJ__CARD__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1t: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),V2s),V1t))
                 => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s))) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),V2s)) ) ) ) ) ) )).

tff(conj_thm_2Epred__set_2EINJ__CARD,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
