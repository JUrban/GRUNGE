    ...
    ! [A_27a: del,V0cmp: $i] :
     ...
     => ! [V3x: $i] :
         ...
         => ! [V2u: $i] :
             ...
             => ! [V4z: $i] :
                  ( mem(V4z,A_27a)
                 => ap(f2481(A_27a,V0cmp,V3x,V2u),V4z) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(A_27a),V4z),V2u)),ap(ap(c_2Emin_2E_3D(ty_2EternaryComparisons_2Eordering),ap(ap(ap(c_2Etoto_2Eapto(A_27a),V0cmp),V3x),V4z)),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS))) ) ) ) ) )).

tff(lmtp_f2480,type,(
    f2480: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2480,axiom,(
...
tff(conj_thm_2Eenumeral_2ELESS__ALL__UO__LEM,lemma,(
    ! [A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,ty_2Etoto_2Etoto(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(conj_thm_2Eenumeral_2ELESS__ALL__OU__UO__LEM,conjecture,(
    ! [A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,ty_2Etoto_2Etoto(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
