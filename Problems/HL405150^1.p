...
thf(c_2Econtainer_2ELIST__TO__BAG_2E0,type,(
    c_2Econtainer_2ELIST__TO__BAG_2E0: u )).

thf(c_2Econtainer_2ELIST__TO__BAG_2E1,type,(
...
thf(arityeq1_2Emono_2Ec_2Econtainer_2ELIST__TO__BAG_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) @ c_2Econtainer_2ELIST__TO__BAG_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Econtainer_2ELIST__TO__BAG__def,axiom,(
    ! [A_27a: d] :
      ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__INSERT_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Econtainer_2EBAG__TO__LIST__INV,conjecture,(
    ! [A_27a: d,V0b_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Econtainer_2EBAG__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) )).
