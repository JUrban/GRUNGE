...
thf(thm_2Ecomplex_2Earg,axiom,(
    ! [V0z: mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29] :
      ( ( mono_2Ec_2Ecomplex_2Earg @ V0z )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Ecomplex_2EIM @ V0z ) ) @ ( mono_2Ec_2Etransc_2Eacs @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ecomplex_2ERE @ V0z ) @ ( mono_2Ec_2Ecomplex_2Emodu @ V0z ) ) ) @ ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Etransc_2Eacs @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ecomplex_2ERE @ V0z ) @ ( mono_2Ec_2Ecomplex_2Emodu @ V0z ) ) ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ mono_2Ec_2Etransc_2Epi ) ) ) ) )).
...
thf(thm_2Ecomplex_2ERE__DIV__MODU__ACS__COS,axiom,(
    ! [V0z: mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29] :
     ...
     => ( ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Etransc_2Eacs @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ecomplex_2ERE @ V0z ) @ ( mono_2Ec_2Ecomplex_2Emodu @ V0z ) ) ) )
        = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ecomplex_2ERE @ V0z ) @ ( mono_2Ec_2Ecomplex_2Emodu @ V0z ) ) ) ) )).

thf(thm_2Etransc_2ECOS__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Erealax_2Ereal__neg @ V0x ) )
      = ( mono_2Ec_2Etransc_2Ecos @ V0x ) ) )).

thf(thm_2Etransc_2ECOS__PERIODIC,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Erealax_2Ereal__add @ V0x @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ mono_2Ec_2Etransc_2Epi ) ) )
      = ( mono_2Ec_2Etransc_2Ecos @ V0x ) ) )).

thf(thm_2Ecomplex_2EARG__COS,conjecture,(
    ! [V0z: mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29] :
      ( ( (~)
        @ ( V0z
          = ( mono_2Ec_2Ecomplex_2Ecomplex__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ( ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Ecomplex_2Earg @ V0z ) )
        = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ecomplex_2ERE @ V0z ) @ ( mono_2Ec_2Ecomplex_2Emodu @ V0z ) ) ) ) )).
