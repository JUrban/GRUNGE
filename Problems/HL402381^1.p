...
thf(thm_2Eres__quan_2ERES__ABSTRACT__EQUAL,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1m1_2E0: u,V2m2_2E0: u] :
      ( ! [V3x_2E0: u] :
         ...
         => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1m1_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
            = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2m2_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1m1_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2m2_2E0 ) ) ) ) ) )).

thf(thm_2Eres__quan_2ERES__ABSTRACT__IDEMPOT,conjecture,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1m_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1m_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1m_2E0 ) ) ) ) )).
