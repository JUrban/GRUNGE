...
thf(thm_2EOmega__Automata_2EEXISTS__FORALL__THM,conjecture,(
    ! [V0P: tyop_2Enum_2Enum > $o] :
      ( ? [V1t1: tyop_2Enum_2Enum] :
        ! [V2t2: tyop_2Enum_2Enum] :
          ( V0P @ ( c_2Earithmetic_2E_2B @ V1t1 @ V2t2 ) )
    <=> ? [V3t1: tyop_2Enum_2Enum] :
        ! [V4t2: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ V3t1 @ V4t2 )
         => ( V0P @ V4t2 ) ) ) )).
