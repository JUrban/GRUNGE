...
thf(conj_thm_2Ereal__topology_2ECONNECTED__IVT__HYPERPLANE,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3a: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] :
         ...
         => ? [V5z: tp__ty_2Erealax_2Ereal] :
              ...
              & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) )
                = V4b ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
