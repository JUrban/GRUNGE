...
thf(ax_thm_2Enumeral_2EiZ,axiom,(
    ! [V0x: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral_2EiZ @ ( inj__ty_2Enum_2Enum @ V0x ) ) )
      = V0x ) )).

thf(ax_thm_2Enumeral_2EiiSUC,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral_2EiiSUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).
...
thf(conj_thm_2Enumeral_2Enumeral__add,conjecture,(
