...
fof(conj_thm_2EHolSmt_2Et029,conjecture,(
    ! [V0p] :
      ( mem(V0p,bool)
     => ! [V1x] :
          ( mem(V1x,ty_2Efcp_2Ecart(bool,bool))
         => ( ( p(V0p)
            <=> V1x = ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) )
