...
fof(conj_thm_2Efloat_2EFLOAT__SUB,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Efloat_2EFLOAT__SUB__FINITE,conjecture,(
    ! [V0b] :
     ...
     => ! [V1a] :
         ...
         => ( ( p(ap(c_2Eieee_2EFinite,V1a))
              ...
              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Eieee_2EVal,V1a)),ap(c_2Eieee_2EVal,V0b)))),ap(c_2Eieee_2Ethreshold,c_2Eieee_2Efloat__format))) )
           => p(ap(c_2Eieee_2EFinite,ap(ap(c_2Eieee_2Efloat__sub,V1a),V0b))) ) ) ) )).
