...
thf(f13888_0_2E0,type,(
    f13888_0_2E0: u )).

thf(f13888_0_2E1,type,(
    f13888_0_2E1: du > u )).

thf(f13888_0_2E2,type,(
    f13888_0_2E2: du > du > u )).

thf(f13889_0_2E0,type,(
    f13889_0_2E0: u )).

thf(f13889_0_2E1,type,(
    f13889_0_2E1: du > u )).

thf(f13889_0_2E2,type,(
...
thf(mono_2Ef13888_0,type,(
    mono_2Ef13888_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13889_0,type,(
    mono_2Ef13889_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONNECTED__TRANSLATION,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13889_0 @ V0a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V2x ) ) )).

thf(thm_2Ereal__topology_2ECONNECTED__TRANSLATION,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Econnected @ V1s )
     => ( mono_2Ec_2Ereal__topology_2Econnected @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13889_0 @ V0a ) @ V1s ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONNECTED__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13888_0 @ V0a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V2x ) ) )).

thf(thm_2Ereal__topology_2ECONNECTED__TRANSLATION__EQ,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Econnected @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13888_0 @ V0a ) @ V1s ) )
      = ( mono_2Ec_2Ereal__topology_2Econnected @ V1s ) ) )).
