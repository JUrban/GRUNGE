...
thf(conj_thm_2Eproduct_2EPRODUCT__CONST,lemma,(
    ! [A_27a: del,V0c: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
       => ( ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s )
              @ ( lam @ A_27a
                @ ^ [V2x: $i] :
                    ( inj__ty_2Erealax_2Ereal @ V0c ) ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ ( ap @ ( c_2Epred__set_2ECARD @ A_27a ) @ V1s ) ) ) ) ) ) )).

thf(conj_thm_2Eproduct_2EPRODUCT__CONST__NUMSEG,conjecture,(
      ...
      ( ( surj__ty_2Erealax_2Ereal
        @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V3x: $i] :
                ( inj__ty_2Erealax_2Ereal @ V0c ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) ) ) )).
