    ...
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ? [V3B: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
              ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Eabs @ V4x ) @ V3B ) @ ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V4x ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__SELF,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
        & ! [V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V2x )
              = ( V0f @ V3y ) )
           => ( V2x = V3y ) ) )
     => ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V1s ) @ V1s ) ) )).
