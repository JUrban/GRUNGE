...
tff(lmtp_f4127,type,(
    f4127: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4127,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z: tp__ty_2Erealax_2Ereal] : mem(f4127(A_27a,V1f,V5z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4127,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z: tp__ty_2Erealax_2Ereal,V6x: $i] :
          ( mem(V6x,A_27a)
         => ap(f4127(A_27a,V1f,V5z),V6x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V5z))),ap(V1f,V6x)) ) ) )).

tff(lmtp_f4128,type,(
    f4128: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4128,axiom,(
    ! [V4x: $i] :
      ( mem(V4x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5z: tp__ty_2Erealax_2Ereal] : mem(f4128(V4x,V5z),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4128,axiom,(
    ! [V4x: $i] :
      ( mem(V4x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5z: tp__ty_2Erealax_2Ereal,V8i: tp__ty_2Enum_2Enum] : ap(f4128(V4x,V5z),inj__ty_2Enum_2Enum(V8i)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V5z)),ap(V4x,inj__ty_2Enum_2Enum(V8i))) ) )).

tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
                 ...
                 => ! [V4x: $i] :
                     ...
                     => ! [V5z: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( p(ap(ap(ap(ap(ap(c_2Emeasure_2Epos__simple__fn(A_27a),V0m),f4127(A_27a,V1f,V5z)),V2s),V3a),f4117(V4x,V5z)))
                            & surj__ty_2Eextreal_2Eextreal(ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),f4128(V4x,V5z))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V5z))),ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),V4x))) ) ) ) ) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Epsfis__cmul,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
