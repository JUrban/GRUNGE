...
tff(conj_thm_2Ereal__topology_2EOPEN__IN__SUBTOPOLOGY__INTER__SUBSET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1u: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__BIGUNION,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
      <=> ! [V1k: $i] :
