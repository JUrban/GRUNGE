...
tff(conj_thm_2Ereal_2EREAL__LT__DIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__EQ__IMP__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( V0x = V1y
     => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) ) )).
...
tff(lmtp_f3213,type,(
    f3213: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3213,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : mem(f3213(V1a,V2b),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3213,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V5x: tp__ty_2Erealax_2Ereal] : ap(f3213(V1a,V2b),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V5x))),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V5x)),inj__ty_2Erealax_2Ereal(V2b))) )).

tff(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
        ...
        <=> ! [V3e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V4g: $i] :
                  ...
                  & p(ap(ap(c_2Etransc_2Egauge,f3213(V1a,V2b)),V4g))
                  & ! [V6d1: $i] :
...
tff(lmtp_f3217,type,(
    f3217: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3217,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : mem(f3217(V1a,V2b),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3217,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V7x: tp__ty_2Erealax_2Ereal] : ap(f3217(V1a,V2b),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V7x))),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V7x)),inj__ty_2Erealax_2Ereal(V2b))) )).

tff(conj_thm_2Eintegral_2EINTEGRABLE__SPLIT__SIDES,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3c)))
            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3c)),inj__ty_2Erealax_2Ereal(V2b)))
            & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f)) )
         => ? [V4i: tp__ty_2Erealax_2Ereal] :
            ! [V5e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V6g: $i] :
                  ...
                  & p(ap(ap(c_2Etransc_2Egauge,f3217(V1a,V2b)),V6g))
                  & ! [V8d1: $i] :
                      ( mem(V8d1,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                     => ! [V9p1: $i] :
                          ( mem(V9p1,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                         => ! [V10d2: $i] :
                              ( mem(V10d2,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                             => ! [V11p2: $i] :
                                  ( mem(V11p2,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                                 => ( ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3c))),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d1),V9p1)))
                                      & p(ap(ap(c_2Etransc_2Efine,V6g),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d1),V9p1)))
                                      & p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3c)),inj__ty_2Erealax_2Ereal(V2b))),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V10d2),V11p2)))
                                      & p(ap(ap(c_2Etransc_2Efine,V6g),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V10d2),V11p2))) )
                                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d1),V9p1)),V0f)),ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V10d2),V11p2)),V0f))),inj__ty_2Erealax_2Ereal(V4i)))),inj__ty_2Erealax_2Ereal(V5e))) ) ) ) ) ) ) ) ) ) )).

tff(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__LEFT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3c)))
            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3c)),inj__ty_2Erealax_2Ereal(V2b)))
            & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f)) )
         => p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3c))),V0f)) ) ) )).
