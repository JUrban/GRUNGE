...
thf(conj_thm_2Ebag_2EBAG__INN__LESS,lemma,(
    ! [A_27a: del,V0b: $i] :
...
thf(conj_thm_2Ebag_2EBAG__INN__BAG__INSERT,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1b: $i] :
      ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V2e1: $i] :
          ( ( mem @ V2e1 @ A_27a )
         => ! [V3e2: $i] :
              ( ( mem @ V3e2 @ A_27a )
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V3e2 ) @ V1b ) ) )
              <=> ( ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V1b ) )
                    & ( V2e1 = V3e2 ) )
                  | ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__INN__BAG__INSERT__STRONG,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2e1: $i] :
          ( ( mem @ V2e1 @ A_27a )
         => ! [V3e2: $i] :
              ( ( mem @ V3e2 @ A_27a )
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V3e2 ) @ V0b ) ) )
              <=> ( ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V0b ) )
                    & ( V2e1 = V3e2 ) )
                  | ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INN @ A_27a ) @ V2e1 ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0b ) )
                    & ( V2e1 != V3e2 ) ) ) ) ) ) ) )).
