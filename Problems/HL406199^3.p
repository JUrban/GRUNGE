...
thf(thm_2Ewords_2ESUC__WORD__PRED,conjecture,(
    ! [A_27a: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( (~)
        @ ( V0x
          = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) )
     => ( ( c_2Enum_2ESUC @ ( c_2Ewords_2Ew2n @ A_27a @ ( c_2Ewords_2Eword__sub @ A_27a @ V0x @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
        = ( c_2Ewords_2Ew2n @ A_27a @ V0x ) ) ) )).
