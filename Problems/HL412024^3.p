...
thf(c_2Emeasure_2Enull__set,type,(
    c_2Emeasure_2Enull__set: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) ) > ( A_27a > $o ) > $o ) )).
...
thf(thm_2Elebesgue_2Eintegrable__infty,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        ...
        & ! [V3x: A_27a] :
           ...
           => ( ( V1f @ V3x )
              = c_2Eextreal_2EPosInf ) ) )
     => ( ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2s )
...
thf(thm_2Emeasure_2Enull__set__def,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o] :
      ( ( c_2Emeasure_2Enull__set @ A_27a @ V0m @ V1s )
...
thf(thm_2Elebesgue_2Eintegrable__infty__null,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f ) )
     => ( c_2Emeasure_2Enull__set @ A_27a @ V0m
        @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
          @ ^ [V2x: A_27a] :
              ( c_2Epair_2E_2C @ A_27a @ $o @ V2x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) ) @ ( c_2Emin_2E_3D @ tyop_2Eextreal_2Eextreal @ ( V1f @ V2x ) @ c_2Eextreal_2EPosInf ) ) ) ) ) ) )).
