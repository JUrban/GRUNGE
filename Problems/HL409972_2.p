...
tff(conj_thm_2Eextreal_2Esup__const__over__set,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1k: tp__ty_2Eextreal_2Eextreal] :
          ( V0s != c_2Epred__set_2EEMPTY(A_27a)
         => surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),k(A_27a,inj__ty_2Eextreal_2Eextreal(V1k))),V0s))) = V1k ) ) )).

tff(lmtp_f3474,type,(
    f3474: ( $i * $i ) > $i )).

tff(lamtp_f3474,axiom,(
    ! [V0f: $i] :
...
tff(lameq_f3474,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
         => ! [V6n: tp__ty_2Enum_2Enum] : ap(f3474(V0f,V1g),inj__ty_2Enum_2Enum(V6n)) = ap(ap(c_2Eextreal_2Eextreal__add,ap(V0f,inj__ty_2Enum_2Enum(V6n))),ap(V1g,inj__ty_2Enum_2Enum(V6n))) ) ) )).

tff(conj_thm_2Eextreal_2Esup__add__mono,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
...
tff(lameq_f3475,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V6n: tp__ty_2Enum_2Enum] : ap(f3475(V0f,V1s),inj__ty_2Enum_2Enum(V6n)) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Enum_2Enum),f3476(V0f,V6n)),V1s) ) ) )).

tff(lmtp_f3477,type,(
    f3477: $i > $i )).

tff(lamtp_f3477,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => mem(f3477(V0f),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3477,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V8i: tp__ty_2Enum_2Enum] : ap(f3477(V0f),inj__ty_2Enum_2Enum(V8i)) = ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(V0f,inj__ty_2Enum_2Enum(V8i))),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).

tff(conj_thm_2Eextreal_2Esup__sum__mono,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V1s))
           ...
           => surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3475(V0f,V1s)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Enum_2Enum),f3477(V0f)),V1s)) ) ) ) )).
