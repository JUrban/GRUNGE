...
fof(lamtp_f1196,axiom,(
    ! [A_27a,A_27a,V1ll] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => mem(f1196(A_27a,A_27a,V1ll,V0n),arr(ty_2Elist_2Elist(A_27a),ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))) ) ) )).
...
fof(lameq_f1196,axiom,(
    ! [A_27a,A_27a,V1ll] :
     ...
     => ! [V0n] :
         ...
         => ! [V2l] :
              ( mem(V2l,ty_2Elist_2Elist(A_27a))
             => ap(f1196(A_27a,A_27a,V1ll,V0n),V2l) = ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),V1ll)),c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))),f1197(A_27a,A_27a,V2l)) ) ) ) )).

fof(conj_thm_2Ellist_2ELTAKE__SNOC__LNTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1ll] :
              ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
             => ap(ap(c_2Ellist_2ELTAKE(A_27a),ap(c_2Enum_2ESUC,V0n)),V1ll) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Ellist_2ELTAKE(A_27a),V0n),V1ll)),c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))),f1196(A_27a,A_27a,V1ll,V0n)) ) ) ) )).

fof(conj_thm_2Ellist_2ELTAKE__LENGTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(mem_c_2Epath_2Enth__label,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Epath_2Enth__label(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Epath_2Epath(A_27b,A_27b),A_27a))) ) ) )).

fof(conj_thm_2Epath_2Enth__label__LNTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0n] :
             ...
             => ! [V1p] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27b)
                     => ( ap(ap(c_2Ellist_2ELNTH(A_27b),V0n),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p)) = ap(c_2Eoption_2ESOME(A_27b),V2x)
                      <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                          & ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V0n),V1p) = V2x ) ) ) ) ) ) ) )).

fof(conj_thm_2Epath_2Enth__label__LTAKE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1p] :
                     ...
                     => ! [V2l] :
                         ...
                         => ! [V3i] :
                             ...
                             => ! [V4v] :
                                  ( mem(V4v,A_27c)
                                 => ( ( ap(ap(c_2Ellist_2ELTAKE(A_27b),V0n),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p)) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27b)),V2l)
                                      & p(ap(ap(c_2Eprim__rec_2E_3C,V3i),ap(c_2Elist_2ELENGTH(A_27b),V2l))) )
                                   => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V3i),V1p) = ap(ap(c_2Elist_2EEL(A_27b),V3i),V2l) ) ) ) ) ) ) ) ) ) )).
