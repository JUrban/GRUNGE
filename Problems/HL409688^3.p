     ...
     => ( c_2Epred__set_2EFINITE @ A_27c
        @ ( c_2Epred__set_2EGSPEC @ A_27c @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )
          @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27b @ ( tyop_2Epair_2Eprod @ A_27c @ $o )
            @ ^ [V4x: A_27a,V5y: A_27b] :
                ( c_2Epair_2E_2C @ A_27c @ $o @ ( V0f @ V4x @ V5y ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V1s ) @ ( c_2Ebool_2EIN @ A_27b @ V5y @ ( V2t @ V4x ) ) ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__CLAUSES,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27a > A_27a > A_27a] :
     ...
     => ( ! [V1f: A_27b > A_27a] :
            ( ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ ( c_2Epred__set_2EEMPTY @ A_27b ) @ V1f )
            = ( c_2Eiterate_2Eneutral @ A_27a @ V0op ) )
        & ! [V2f: A_27b > A_27a,V3x: A_27b,V4s: A_27b > $o] :
            ( ( c_2Epred__set_2EFINITE @ A_27b @ V4s )
           => ( ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ ( c_2Epred__set_2EINSERT @ A_27b @ V3x @ V4s ) @ V2f )
              = ( c_2Ebool_2ECOND @ A_27a @ ( c_2Ebool_2EIN @ A_27b @ V3x @ V4s ) @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ V4s @ V2f ) @ ( V0op @ ( V2f @ V3x ) @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ V4s @ V2f ) ) ) ) ) ) ) )).
    ...
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27a > A_27a > A_27a] :
     ...
     => ! [V1f: A_27b > A_27a,V2s: A_27b > $o,V3t: A_27b > $o] :
          ( ( ( c_2Epred__set_2EFINITE @ A_27b @ V2s )
            & ( c_2Epred__set_2EFINITE @ A_27b @ V3t )
            & ( c_2Epred__set_2EDISJOINT @ A_27b @ V2s @ V3t ) )
         => ( ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ ( c_2Epred__set_2EUNION @ A_27b @ V2s @ V3t ) @ V1f )
            = ( V0op @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ V2s @ V1f ) @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ V3t @ V1f ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__IMAGE,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0op: A_27c > A_27c > A_27c] :
     ...
     => ! [V1f: A_27a > A_27b,V2g: A_27b > A_27c,V3s: A_27a > $o] :
          ( ! [V4x: A_27a,V5y: A_27a] :
              ( ( ( c_2Ebool_2EIN @ A_27a @ V4x @ V3s )
                ...
                & ( ( V1f @ V4x )
                  = ( V1f @ V5y ) ) )
             => ( V4x = V5y ) )
         => ( ( c_2Eiterate_2Eiterate @ A_27b @ A_27c @ V0op @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V1f @ V3s ) @ V2g )
            = ( c_2Eiterate_2Eiterate @ A_27a @ A_27c @ V0op @ V3s @ ( c_2Ecombin_2Eo @ A_27a @ A_27c @ A_27b @ V2g @ V1f ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__ITERATE__PRODUCT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0op: A_27c > A_27c > A_27c] :
      ( ( c_2Eiterate_2Emonoidal @ A_27c @ V0op )
