...
thf(conj_thm_2Ereal__topology_2ESUMS__REINDEX,conjecture,(
            ...
            @ ( ap
              @ ( ap
                @ ( ap @ c_2Ereal__topology_2Esums
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4x: $i] :
                        ( ap @ V1a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V4x ) @ ( inj__ty_2Enum_2Enum @ V0k ) ) ) ) )
                @ ( inj__ty_2Erealax_2Ereal @ V2l ) )
              @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) )
