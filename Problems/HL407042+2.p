...
fof(lamtp_f2695,axiom,(
    ! [V2bs] :
      ( mem(V2bs,ty_2Elist_2Elist(bool))
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => mem(f2695(V2bs,V0n),arr(bool,ty_2Einteger_2Eint)) ) ) )).
...
fof(lameq_f2695,axiom,(
    ! [V2bs] :
     ...
     => ! [V0n] :
         ...
         => ! [V3r] :
              ( mem(V3r,bool)
             => ap(f2695(V2bs,V0n),V3r) = ap(c_2Eint__bitwise_2Eint__of__bits,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Elist_2EAPPEND(bool),ap(ap(c_2Elist_2EGENLIST(bool),ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2EF)),V0n)),V2bs)),V3r)) ) ) ) )).

fof(lamtp_f2694,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f2694(V0n),arr(ty_2Elist_2Elist(bool),arr(bool,ty_2Einteger_2Eint))) ) )).
...
fof(lameq_f2694,axiom,(
    ! [V0n] :
     ...
     => ! [V2bs] :
          ( mem(V2bs,ty_2Elist_2Elist(bool))
         => ap(f2694(V0n),V2bs) = f2695(V2bs,V0n) ) ) )).
...
fof(ax_thm_2Eint__bitwise_2Eint__shift__left__def,axiom,(
    ! [V0n] :
     ...
     => ! [V1i] :
         ...
         => ap(ap(c_2Eint__bitwise_2Eint__shift__left,V0n),V1i) = ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool))),ap(c_2Epair_2EUNCURRY(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2694(V0n))),ap(c_2Eint__bitwise_2Ebits__of__int,V1i)) ) ) )).
...
fof(conj_thm_2Eint__bitwise_2Eint__bit__shift__left,conjecture,(
    ! [V0b] :
