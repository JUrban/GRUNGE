...
fof(conj_thm_2Ereal__topology_2EBILINEAR__CONTINUOUS__COMPOSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(lamtp_f3845,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3845(V0x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3845,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(f3845(V0x),V1y) = ap(ap(c_2Erealax_2Ereal__mul,V0x),V1y) ) ) )).

fof(lamtp_f3844,axiom,(
    mem(f3844,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

fof(lameq_f3844,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(f3844,V0x) = f3845(V0x) ) )).

fof(conj_thm_2Ereal__topology_2EBILINEAR__DOT,lemma,(
    p(ap(c_2Ereal__topology_2Ebilinear,f3844)) )).

fof(lamtp_f3846,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3846(A_27a,V1f,V2g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3846,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3846(A_27a,V1f,V2g),V3x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1f,V3x)),ap(V2g,V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DOT2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V1f] :
             ...
             => ! [V2g] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1f),V0net))
                      & p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V2g),V0net)) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3846(A_27a,V1f,V2g)),V0net)) ) ) ) ) ) )).
