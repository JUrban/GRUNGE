...
thf(thm_2Elebesgue_2Eintegrable__fn__plus,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f ) )
     => ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ ( c_2Emeasure_2Efn__plus @ A_27a @ V1f ) ) ) )).

thf(thm_2Elebesgue_2Eintegrable__fn__minus,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f ) )
...
thf(thm_2Elebesgue_2Eintegrable__add,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f1: A_27a > tyop_2Eextreal_2Eextreal,V2f2: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f1 )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V2f2 ) )
     => ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m
        @ ^ [V3x: A_27a] :
            ( c_2Eextreal_2Eextreal__add @ ( V1f1 @ V3x ) @ ( V2f2 @ V3x ) ) ) ) )).

thf(thm_2Elebesgue_2Eintegral__add__lemma,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2f1: A_27a > tyop_2Eextreal_2Eextreal,V3f2: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V2f1 )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V3f2 )
        & ( V1f
          = ( ^ [V4x: A_27a] :
                ( c_2Eextreal_2Eextreal__sub @ ( V2f1 @ V4x ) @ ( V3f2 @ V4x ) ) ) )
        & ! [V5x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( V2f1 @ V5x ) )
        & ! [V6x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( V3f2 @ V6x ) ) )
     => ( ( c_2Elebesgue_2Eintegral @ A_27a @ V0m @ V1f )
        = ( c_2Eextreal_2Eextreal__sub @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m @ V2f1 ) @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m @ V3f2 ) ) ) ) )).
...
thf(thm_2Elebesgue_2Eintegral__add,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2g: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Elebesgue_2Eintegrable @ A_27a @ V0m @ V1f )
     ...
     => ( ( c_2Elebesgue_2Eintegral @ A_27a @ V0m
          @ ^ [V3x: A_27a] :
              ( c_2Eextreal_2Eextreal__add @ ( V1f @ V3x ) @ ( V2g @ V3x ) ) )
        = ( c_2Eextreal_2Eextreal__add @ ( c_2Elebesgue_2Eintegral @ A_27a @ V0m @ V1f ) @ ( c_2Elebesgue_2Eintegral @ A_27a @ V0m @ V2g ) ) ) ) )).
