...
thf(tp_c_2Ehreal_2Ehreal__sup,type,(
    c_2Ehreal_2Ehreal__sup: $i )).

thf(mem_c_2Ehreal_2Ehreal__sup,axiom,(
...
thf(tp_c_2Erealax_2Etreal__of__hreal,type,(
    c_2Erealax_2Etreal__of__hreal: $i )).

thf(mem_c_2Erealax_2Etreal__of__hreal,axiom,(
...
thf(tp_c_2Erealax_2Ehreal__of__treal,type,(
    c_2Erealax_2Ehreal__of__treal: $i )).

thf(mem_c_2Erealax_2Ehreal__of__treal,axiom,(
    mem @ c_2Erealax_2Ehreal__of__treal @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Ehreal_2Ehreal @ ty_2Ehreal_2Ehreal ) @ ty_2Ehreal_2Ehreal ) )).

thf(stp_fo_c_2Erealax_2Ehreal__of__treal,type,(
    fo__c_2Erealax_2Ehreal__of__treal: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal > tp__ty_2Ehreal_2Ehreal )).

thf(stp_eq_fo_c_2Erealax_2Ehreal__of__treal,axiom,(
    ! [X0: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( ( inj__ty_2Ehreal_2Ehreal @ ( fo__c_2Erealax_2Ehreal__of__treal @ X0 ) )
      = ( ap @ c_2Erealax_2Ehreal__of__treal @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ X0 ) ) ) )).

thf(tp_c_2Erealax_2Ehreal__of__real,type,(
    c_2Erealax_2Ehreal__of__real: $i )).

thf(mem_c_2Erealax_2Ehreal__of__real,axiom,(
    mem @ c_2Erealax_2Ehreal__of__real @ ( arr @ ty_2Erealax_2Ereal @ ty_2Ehreal_2Ehreal ) )).

thf(stp_fo_c_2Erealax_2Ehreal__of__real,type,(
    fo__c_2Erealax_2Ehreal__of__real: tp__ty_2Erealax_2Ereal > tp__ty_2Ehreal_2Ehreal )).

thf(stp_eq_fo_c_2Erealax_2Ehreal__of__real,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] :
      ( ( inj__ty_2Ehreal_2Ehreal @ ( fo__c_2Erealax_2Ehreal__of__real @ X0 ) )
      = ( ap @ c_2Erealax_2Ehreal__of__real @ ( inj__ty_2Erealax_2Ereal @ X0 ) ) ) )).
...
thf(conj_thm_2Ehreal_2EHREAL__SUP,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Ehreal_2Ehreal @ bool ) )
     => ( ( ? [V1X: tp__ty_2Ehreal_2Ehreal] :
              ( p @ ( ap @ V0P @ ( inj__ty_2Ehreal_2Ehreal @ V1X ) ) )
          & ? [V2Y: tp__ty_2Ehreal_2Ehreal] :
            ! [V3X: tp__ty_2Ehreal_2Ehreal] :
              ( ( p @ ( ap @ V0P @ ( inj__ty_2Ehreal_2Ehreal @ V3X ) ) )
             => ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V3X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V2Y ) ) ) ) )
       => ! [V4Y: tp__ty_2Ehreal_2Ehreal] :
            ( ? [V5X: tp__ty_2Ehreal_2Ehreal] :
                ( ( p @ ( ap @ V0P @ ( inj__ty_2Ehreal_2Ehreal @ V5X ) ) )
                & ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V4Y ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V5X ) ) ) )
          <=> ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V4Y ) ) @ ( ap @ c_2Ehreal_2Ehreal__sup @ V0P ) ) ) ) ) ) )).
...
thf(conj_thm_2Erealax_2ETREAL__BIJ,lemma,
    ( ! [V0h: tp__ty_2Ehreal_2Ehreal] :
        ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__treal @ ( ap @ c_2Erealax_2Etreal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V0h ) ) ) )
        = V0h )
...
thf(conj_thm_2Erealax_2ETREAL__BIJ__WELLDEF,lemma,(
    ! [V0h: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V1i: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
     ...
     => ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__treal @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0h ) ) )
        = ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__treal @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V1i ) ) ) ) ) )).
...
thf(ax_thm_2Erealax_2Ereal__of__hreal,axiom,(
    ! [V0T1: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V0T1 ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__ABS @ ( ap @ c_2Erealax_2Etreal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V0T1 ) ) ) ) ) )).

thf(ax_thm_2Erealax_2Ehreal__of__real,axiom,(
    ! [V0T1: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__real @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) )
      = ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__treal @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) ) ) ) )).

thf(conj_thm_2Erealax_2EREAL__ISO__EQ,lemma,(
...
thf(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA1,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA2,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1X: tp__ty_2Ehreal_2Ehreal] :
...
thf(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA3,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ! [V1x: tp__ty_2Erealax_2Ereal] :
       ...
       => ( ? [V5X: tp__ty_2Ehreal_2Ehreal] :
              ...
              @ ( ap
                @ ( lam @ ty_2Ehreal_2Ehreal
                  @ ^ [V6h: $i] :
                      ( ap @ V0P @ ( ap @ c_2Erealax_2Ereal__of__hreal @ V6h ) ) )
                @ ( inj__ty_2Ehreal_2Ehreal @ V5X ) ) )
            ...
            ! [V8X: tp__ty_2Ehreal_2Ehreal] :
              ( ( p
                @ ( ap
                  @ ( lam @ ty_2Ehreal_2Ehreal
                    @ ^ [V9h: $i] :
                        ( ap @ V0P @ ( ap @ c_2Erealax_2Ereal__of__hreal @ V9h ) ) )
                  @ ( inj__ty_2Ehreal_2Ehreal @ V8X ) ) )
             => ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V8X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V7Y ) ) ) ) ) ) ) )).

thf(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA4,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
     ...
     => ! [V1x: tp__ty_2Ehreal_2Ehreal] :
          ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) @ ( ap @ c_2Erealax_2Ereal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V1x ) ) ) ) ) )).
...
thf(conj_thm_2Erealax_2EREAL__SUP__ALLPOS,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ! [V1x: tp__ty_2Erealax_2Ereal] :
              ( ( p @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
