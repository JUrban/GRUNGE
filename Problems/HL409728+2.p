...
fof(lameq_f3312,axiom,(
    ! [A_27a,A_27a,V0b] :
     ...
     => ! [V2a] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3312(A_27a,A_27a,V0b,V2a),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2a)),V0b),c_2Enum_2E0) ) ) ) )).

fof(conj_thm_2Eiterate_2ENSUM__DELTA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,ty_2Enum_2Enum)
         => ! [V1s] :
             ...
             => ! [V2a] :
                  ( mem(V2a,A_27a)
                 => ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3312(A_27a,A_27a,V0b,V2a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V2a),V1s)),V0b),c_2Enum_2E0) ) ) ) ) )).
