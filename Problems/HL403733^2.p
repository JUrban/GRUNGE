...
thf(conj_thm_2Esorting_2ESORTED__PERM__EQ,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) )
          & ( p @ ( ap @ ( c_2Erelation_2Eantisymmetric @ A_27a ) @ V0R ) ) )
...
thf(conj_thm_2Esorting_2Esorted__count__list,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ ( c_2Esorting_2ESORTED @ ty_2Enum_2Enum ) @ c_2Earithmetic_2E_3C_3D ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).

thf(conj_thm_2Esorting_2Esorted__map,lemma,(
...
thf(conj_thm_2Esorting_2Esorted__perm__count__list,conjecture,(
