...
thf(f10770_0_2E0,type,(
    f10770_0_2E0: u )).

thf(f10770_0_2E1,type,(
    f10770_0_2E1: du > u )).

thf(f10770_0_2E2,type,(
    f10770_0_2E2: du > du > u )).

thf(f10770_1_2E0,type,(
    f10770_1_2E0: u )).

thf(f10770_1_2E2,type,(
    f10770_1_2E2: du > du > u )).
...
thf(mono_2Ef10770_0,type,(
    mono_2Ef10770_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef10770_1,type,(
    mono_2Ef10770_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Eintegral_2EDINT__DELTA,axiom,(
    ! [V3x: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10770_1 @ V3x @ V2c )
    <=> ( V3x = V2c ) ) )).

thf(def1_2Ethm_2Eintegral_2EDINT__DELTA,axiom,(
    ! [V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10770_0 @ V2c @ V3x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef10770_1 @ V3x @ V2c ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).
...
thf(thm_2Eintegral_2EDINT__DELTA,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef10770_0 @ V2c ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).
...
thf(thm_2Eintegral_2EDINT__POINT__SPIKE,conjecture,(
