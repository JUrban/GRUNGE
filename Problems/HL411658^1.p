...
thf(f12871_0_2E0,type,(
    f12871_0_2E0: u )).

thf(f12871_0_2E2,type,(
    f12871_0_2E2: du > du > u )).

thf(f12871_0_2E3,type,(
...
thf(f12873_0_2E0,type,(
    f12873_0_2E0: u )).

thf(f12873_0_2E1,type,(
    f12873_0_2E1: du > u )).

thf(f12873_0_2E2,type,(
...
thf(mono_2Ef12871_0,type,(
    mono_2Ef12871_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ef12873_0,type,(
    mono_2Ef12873_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__SCALING,axiom,(
...
thf(def0_2Ethm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12873_0 @ V1a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ V2x ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V0s @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12873_0 @ V1a ) @ V0s ) ) )).

thf(def0_2Ethm_2Ereal__topology_2EHOMEOMORPHIC__AFFINITY,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12871_0 @ V1a @ V2c @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2c @ V3x ) ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__AFFINITY,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V2c
          = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V0s @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12871_0 @ V1a @ V2c ) @ V0s ) ) ) )).
