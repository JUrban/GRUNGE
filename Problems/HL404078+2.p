...
fof(lameq_f1382,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1382(V0a),V2t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),f882(V0a)),V2t) ) ) )).

fof(lamtp_f1383,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1383,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f1383(V0a),V5t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0a),V5t)) ) ) )).

fof(lamtp_f1384,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V7t] :
             ...
             => ap(f1384(V0a,V1b),V7t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1296(V1b)),f1327(V0a,V1b)),V7t)) ) ) ) )).

fof(lamtp_f1385,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V10t] :
             ...
             => ap(f1385(V1b,V0a),V10t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V1b),f1329(V0a,V1b)),V10t) ) ) ) )).

fof(lamtp_f1386,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V12t] :
             ...
             => ap(f1386(V0a,V1b),V12t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1331(V0a)),V1b),V12t)) ) ) ) )).

fof(lamtp_f1387,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V14t] :
             ...
             => ap(f1387(V1b,V0a),V14t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1333(V1b)),f1334(V0a,V1b)),V14t) ) ) ) )).

fof(lamtp_f1388,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V17t] :
             ...
             => ap(f1388(V0a,V1b),V17t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V1b),f1336(V0a,V1b)),V17t)) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EPWHEN__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
