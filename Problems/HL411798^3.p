...
thf(thm_2Ereal__topology_2ESUMMABLE__IMP__TOZERO,axiom,(
...
thf(thm_2Ereal__topology_2ESUMMABLE__IMP__BOUNDED,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1k: tyop_2Enum_2Enum > $o] :
      ( ( c_2Ereal__topology_2Esummable @ V1k @ V0f )
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ V0f @ V1k ) ) ) )).
