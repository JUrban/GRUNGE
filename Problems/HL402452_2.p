...
tff(conj_thm_2EerrorStateMonad_2EES__CHOICE__ASSOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0xM: $i] :
     ...
     => ! [V1yM: $i] :
         ...
         => ! [V2zM: $i] :
             ...
             => ap(ap(c_2EerrorStateMonad_2EES__CHOICE(A_27b,A_27b),V0xM),ap(ap(c_2EerrorStateMonad_2EES__CHOICE(A_27b,A_27b),V1yM),V2zM)) = ap(ap(c_2EerrorStateMonad_2EES__CHOICE(A_27b,A_27b),ap(ap(c_2EerrorStateMonad_2EES__CHOICE(A_27b,A_27b),V0xM),V1yM)),V2zM) ) ) ) )).
