...
tff(mem_c_2Epred__set_2ELINV__OPT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),arr(arr(A_27a,A_27b),arr(arr(A_27a,bool),arr(A_27b,ty_2Eoption_2Eoption(A_27a))))) )).

tff(tp_c_2Epred__set_2ERINV,type,(
    c_2Epred__set_2ERINV: ( del * del ) > $i )).

tff(mem_c_2Epred__set_2ERINV,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epred__set_2ERINV(A_27a,A_27a),arr(arr(A_27a,A_27b),arr(arr(A_27a,bool),arr(A_27b,A_27a)))) )).
...
tff(conj_thm_2Epred__set_2EIMAGE__SURJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
              ( mem(V2t,arr(A_27b,bool))
             => ( p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V0f),V1s),V2t))
              <=> ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s) = V2t ) ) ) ) )).

tff(lmtp_f273,type,(
    f273: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f273,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V2y: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1s: $i] :
              ( mem(V1s,arr(A_27a,bool))
             => mem(f273(A_27a,A_27b,A_27a,V2y,V0f,V1s),arr(A_27a,bool)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,A_27a: del,V2y: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1s: $i] :
             ...
             => ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ap(f273(A_27a,A_27b,A_27a,V2y,V0f,V1s),V3x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s)),ap(ap(c_2Emin_2E_3D(A_27b),ap(V0f,V3x)),V2y)) ) ) ) ) )).
...
tff(ax_thm_2Epred__set_2ELINV__OPT__def,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2y: $i] :
              ( mem(V2y,A_27b)
             => ap(ap(ap(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),V0f),V1s),V2y) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Ebool_2EIN(A_27b),V2y),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s))),ap(c_2Eoption_2ESOME(A_27a),ap(c_2Emin_2E_40(A_27a),f273(A_27a,A_27b,A_27a,V2y,V0f,V1s)))),c_2Eoption_2ENONE(A_27a)) ) ) ) )).
...
tff(ax_thm_2Epred__set_2ERINV__LO,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2y: $i] :
              ( mem(V2y,A_27b)
             => ap(ap(ap(c_2Epred__set_2ERINV(A_27a,A_27a),V0f),V1s),V2y) = ap(c_2Eoption_2ETHE(A_27a),ap(ap(ap(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),V0f),V1s),V2y)) ) ) ) )).

tff(conj_thm_2Epred__set_2ERINV__DEF,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V0f),V1s),V2t))
               => ! [V3x: $i] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V3x),V2t))
                     => ap(V0f,ap(ap(ap(c_2Epred__set_2ERINV(A_27a,A_27a),V0f),V1s),V3x)) = V3x ) ) ) ) ) ) )).
