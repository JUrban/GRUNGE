...
fof(conj_thm_2Ebag_2EBAG__INN__EMPTY__BAG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Ebag_2ESET__OF__BAG__EQ__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EFINITE__SET__OF__BAG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
