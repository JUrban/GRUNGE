...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f4059(V0s)),V1t)) ) ) ) )).
