...
thf(conj_thm_2Ewords_2ELSL__ONE,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V0w ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) )
        = ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0w ) @ V0w ) ) ) )).

thf(conj_thm_2Ewords_2ESHIFT__1__SUB__1,lemma,(
