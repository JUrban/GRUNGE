...
fof(conj_thm_2Epred__set_2EPREIMAGE__I,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),c_2Ecombin_2EI(A_27a)) = c_2Ecombin_2EI(arr(A_27a,bool)) ) )).
...
fof(conj_thm_2Emeasure_2EMEASURABLE__I,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
           => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27a)),c_2Ecombin_2EI(A_27a)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),V0a))) ) ) ) )).
