...
thf(c_2Enumeral_2EiSQR_2E0,type,(
    c_2Enumeral_2EiSQR_2E0: u )).

thf(c_2Enumeral_2EiSQR_2E1,type,(
...
thf(mono_2Ec_2Enumeral_2EiSQR,type,(
    mono_2Ec_2Enumeral_2EiSQR: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Enumeral_2EiSQR,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumeral_2EiSQR @ V0x )
      = ( mono_2Ec_2Earithmetic_2E_2A @ V0x @ V0x ) ) )).

thf(thm_2Enumeral_2Enumeral__exp,conjecture,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2EEXP @ V0n @ mono_2Ec_2Earithmetic_2EZERO )
        = ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) )
    & ! [V1n: mono_2Etyop_2Enum_2Enum,V2m: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2EEXP @ V1n @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2m ) )
        = ( mono_2Ec_2Earithmetic_2E_2A @ V1n @ ( mono_2Ec_2Enumeral_2EiSQR @ ( mono_2Ec_2Earithmetic_2EEXP @ V1n @ V2m ) ) ) )
    & ! [V3n: mono_2Etyop_2Enum_2Enum,V4m: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2EEXP @ V3n @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V4m ) )
        = ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Enumeral_2EiSQR @ V3n ) @ ( mono_2Ec_2Enumeral_2EiSQR @ ( mono_2Ec_2Earithmetic_2EEXP @ V3n @ V4m ) ) ) ) )).
