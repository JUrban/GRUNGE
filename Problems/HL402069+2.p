...
fof(conj_thm_2Epred__set_2EFINITE__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f375,axiom,(
    ! [A_27a,V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => mem(f375(A_27a,V1s,V0f,V2x),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) ) )).
    ...
    ! [A_27a,V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2x] :
             ...
             => ! [V3y] :
                  ( mem(V3y,A_27a)
                 => ap(f375(A_27a,V1s,V0f,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3y),V1s)),ap(ap(c_2Earithmetic_2E_3C_3D,ap(V0f,V2x)),ap(V0f,V3y))))) ) ) ) ) )).

fof(lamtp_f374,axiom,(
    ! [A_27a,A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
         => mem(f374(A_27a,A_27a,V1s,V0f),arr(A_27a,arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a))))) ) ) )).
...
fof(lameq_f374,axiom,(
    ! [A_27a,A_27a,V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f374(A_27a,A_27a,V1s,V0f),V2x) = f375(A_27a,V1s,V0f,V2x) ) ) ) )).
...
fof(ax_thm_2Eset__relation_2Enum__order__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0f] :
         ...
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ap(ap(c_2Eset__relation_2Enum__order(A_27a),V0f),V1s) = ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f374(A_27a,A_27a,V1s,V0f))) ) ) ) )).

fof(conj_thm_2Eset__relation_2Enum__order__finite__prefix,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
