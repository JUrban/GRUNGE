...
thf(f11774_0_2E0,type,(
    f11774_0_2E0: u )).

thf(f11774_0_2E2,type,(
    f11774_0_2E2: du > du > u )).

thf(f11774_0_2E3,type,(
    f11774_0_2E3: du > du > du > u )).

thf(f11774_1_2E0,type,(
    f11774_1_2E0: u )).

thf(f11774_1_2E3,type,(
    f11774_1_2E3: du > du > du > u )).

thf(f11774_2_2E0,type,(
    f11774_2_2E0: u )).

thf(f11774_2_2E2,type,(
    f11774_2_2E2: du > du > u )).

thf(f11774_2_2E3,type,(
    f11774_2_2E3: du > du > du > u )).
...
thf(mono_2Ef11774_0,type,(
    mono_2Ef11774_0: mono_2Etyop_2Enum_2Enum > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef11774_1,type,(
    mono_2Ef11774_1: mono_2Etyop_2Enum_2Enum > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef11774_2,type,(
    mono_2Ef11774_2: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eiterate_2Ereal__INFINITE,axiom,(
    (~) @ ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Erealax_2Ereal ) )).
...
thf(thm_2Eiterate_2EREAL__POLYFUN__ROOTBOUND,axiom,(
...
thf(def0_2Ethm_2Eiterate_2EREAL__POLYFUN__FINITE__ROOTS,axiom,(
    ! [V1c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11774_2 @ V1c @ V2x @ V3i )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V1c @ V3i ) @ ( mono_2Ec_2Ereal_2Epow @ V2x @ V3i ) ) ) )).

thf(def1_2Ethm_2Eiterate_2EREAL__POLYFUN__FINITE__ROOTS,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11774_1 @ V0n @ V1c @ V2x )
    <=> ( ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V0n ) @ ( mono_2Ef11774_2 @ V1c @ V2x ) )
        = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(def2_2Ethm_2Eiterate_2EREAL__POLYFUN__FINITE__ROOTS,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11774_0 @ V0n @ V1c @ V2x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V2x @ ( mono_2Ef11774_1 @ V0n @ V1c @ V2x ) ) ) )).

thf(thm_2Eiterate_2EREAL__POLYFUN__FINITE__ROOTS,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef11774_0 @ V0n @ V1c ) ) )
    <=> ? [V4i: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V4i @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V0n ) )
          & ( (~)
            @ ( ( V1c @ V4i )
              = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )).
