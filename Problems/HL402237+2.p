...
fof(conj_thm_2Elist_2ELENGTH__TL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Elist_2ETL__GENLIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(c_2Elist_2ETL(A_27a),ap(ap(c_2Elist_2EGENLIST(A_27a),V0f),ap(c_2Enum_2ESUC,V1n))) = ap(ap(c_2Elist_2EGENLIST(A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Enum_2ESUC)),V1n) ) ) ) )).
