...
thf(thm_2Estring_2Estring__lt__ind,conjecture,(
    ! [V0P: ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > $o] :
      ( ( ! [V1s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( V0P @ V1s @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) )
        & ! [V2c: tyop_2Estring_2Echar,V3s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( V0P @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V2c @ V3s ) )
        & ! [V4c1: tyop_2Estring_2Echar,V5s1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V6c2: tyop_2Estring_2Echar,V7s2: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( ( V0P @ V5s1 @ V7s2 )
           => ( V0P @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V4c1 @ V5s1 ) @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V6c2 @ V7s2 ) ) ) )
     => ! [V8v: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V9v1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
          ( V0P @ V8v @ V9v1 ) ) )).
