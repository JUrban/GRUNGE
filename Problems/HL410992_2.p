...
tff(conj_thm_2Ereal__topology_2ECENTRE__IN__CBALL,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELIMPT__SUBSET,lemma,(
...
tff(conj_thm_2Ereal__topology_2ETRIVIAL__LIMIT__WITHIN,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELIMPT__BALL,lemma,(
...
tff(conj_thm_2Ereal__topology_2ENETLIMIT__WITHIN__INTERIOR,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
