...
thf(ax_thm_2Eiterate_2Einf,axiom,(
    ! [V0s: $i] :
              ...
              @ ^ [V1a: $i] :
                  ...
                  @ ( ap @ c_2Ebool_2E_2F_5C
                    @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Erealax_2Ereal )
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V2x: $i] :
                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2x ) @ V0s ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V1a ) @ V2x ) ) ) ) )
                  @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Erealax_2Ereal )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3b: $i] :
                          ( ap
                          @ ( ap @ c_2Emin_2E_3D_3D_3E
                            @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V4x: $i] :
                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V4x ) @ V0s ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V3b ) @ V4x ) ) ) ) )
                          @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V3b ) @ V1a ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2EREAL__INF__UNIQUE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
