    ...
    ! [V2a] :
     ...
     => ! [V0f] :
         ...
         => ! [V3x] :
             ...
             => ap(f3783(V2a,V0f),V3x) = ap(V0f,ap(ap(c_2Erealax_2Ereal__add,V2a),V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__AT__ZERO,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2a] :
              ( mem(V2a,ty_2Erealax_2Ereal)
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),V1l),ap(c_2Ereal__topology_2Eat,V2a)))
              <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3783(V2a,V0f)),V1l),ap(c_2Ereal__topology_2Eat,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))) ) ) ) ) )).
