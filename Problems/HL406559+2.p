...
fof(conj_thm_2Esptree_2Elookup__inter__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ! [V1t1] :
                 ...
                 => ! [V2t2] :
                     ...
                     => ! [V3y] :
                          ( mem(V3y,A_27a)
                         => ( ( ap(ap(c_2Esptree_2Elookup(A_27a),V0x),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V1t1),V2t2)) = ap(c_2Eoption_2ESOME(A_27a),V3y)
                            <=> ( ap(ap(c_2Esptree_2Elookup(A_27a),V0x),V1t1) = ap(c_2Eoption_2ESOME(A_27a),V3y)
                                & ap(ap(c_2Esptree_2Elookup(A_27b),V0x),V2t2) != c_2Eoption_2ENONE(A_27b) ) )
                            & ( ap(ap(c_2Esptree_2Elookup(A_27a),V0x),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V1t1),V2t2)) = c_2Eoption_2ENONE(A_27a)
                            <=> ( ap(ap(c_2Esptree_2Elookup(A_27a),V0x),V1t1) = c_2Eoption_2ENONE(A_27a)
                                | ap(ap(c_2Esptree_2Elookup(A_27b),V0x),V2t2) = c_2Eoption_2ENONE(A_27b) ) ) ) ) ) ) ) ) ) )).
