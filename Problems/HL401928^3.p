...
thf(thm_2Earithmetic_2EZERO__LESS__EXP,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ ( c_2Earithmetic_2EEXP @ ( c_2Enum_2ESUC @ V1n ) @ V0m ) ) )).
...
thf(thm_2Ebit_2EMOD__2EXP__MAX__def,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EMOD__2EXP__MAX @ V0n @ V1a )
    <=> ( ( c_2Ebit_2EMOD__2EXP @ V0n @ V1a )
        = ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
...
thf(thm_2Ebit_2EBIT__DIV2,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1i: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V0n @ ( c_2Earithmetic_2EDIV @ V1i @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) )
      = ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ V1i ) ) )).

thf(thm_2Ebit_2EBIT__EXP__SUB1,axiom,(
    ! [V0b: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V0b @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
      = ( c_2Eprim__rec_2E_3C @ V0b @ V1n ) ) )).
