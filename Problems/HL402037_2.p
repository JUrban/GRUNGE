...
tff(conj_thm_2Eset__relation_2Errestrict__SUBSET,lemma,(
    ! [A_27a: del,V0r: $i] :
...
tff(conj_thm_2Eset__relation_2Edomain__rrestrict__SUBSET,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eset__relation_2Erange__rrestrict__SUBSET,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eset__relation_2Etc__mono,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
...
tff(conj_thm_2Eset__relation_2Eacyclic__rrestrict,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eset__relation_2Eacyclic__WF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
...
tff(conj_thm_2Eset__relation_2Eminimal__elements__rrestrict,lemma,(
    ! [A_27a: del,V0xs: $i] :
...
tff(conj_thm_2Eset__relation_2EWF__has__minimal__path,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Eset__relation_2Efinite__acyclic__has__minimal__path,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
          ( mem(V1r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
