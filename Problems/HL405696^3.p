...
thf(thm_2Eordinal_2Efixpoints__exist,conjecture,(
    ! [A_27a: $tType,V0f: ( tyop_2Eordinal_2Eordinal @ A_27a ) > ( tyop_2Eordinal_2Eordinal @ A_27a )] :
      ( ( ! [V1s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
            ( ( ( (~)
                @ ( V1s
                  = ( c_2Epred__set_2EEMPTY @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) )
              & ( c_2Ecardinal_2Ecardleq @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) @ V1s @ ( c_2Epred__set_2EUNIV @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) ) )
           => ( ( V0f @ ( c_2Eordinal_2Esup @ A_27a @ V1s ) )
              = ( c_2Eordinal_2Esup @ A_27a @ ( c_2Epred__set_2EIMAGE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0f @ V1s ) ) ) )
        & ! [V2x: tyop_2Eordinal_2Eordinal @ A_27a] :
            ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ ( V0f @ V2x ) @ V2x ) ) )
