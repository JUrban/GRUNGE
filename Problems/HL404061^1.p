...
thf(thm_2Equotient_2ELEFT__RES__EXISTS__REGULAR,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1R_2E0: u,V2Q_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2ERES__EXISTS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1R_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2Q_2E0 ) ) ) )
