...
tff(lmtp_f1936,type,(
    f1936: ( del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f1936,axiom,(
    ! [A_27d: del,A_27c: del,A_27a: del,A_27b: del,V1f2: $i] :
...
tff(lmtp_f1935,type,(
    f1935: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1935,axiom,(
    ! [A_27b: del,A_27c: del,A_27d: del,A_27a: del,V1f2: $i] :
      ( mem(V1f2,arr(A_27a,arr(A_27b,A_27d)))
     => ! [V0f1: $i] :
          ( mem(V0f1,arr(A_27a,arr(A_27b,A_27c)))
         => ! [V5fm: $i] :
...
tff(lmtp_f1934,type,(
    f1934: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f1934,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V1f2: $i] :
      ( mem(V1f2,arr(A_27a,arr(A_27b,A_27d)))
     => ! [V0f1: $i] :
          ( mem(V0f1,arr(A_27a,arr(A_27b,A_27c)))
...
tff(conj_thm_2Efinite__map_2EFOLDL2__FUPDATE__LIST,conjecture,(
         ...
         => ! [V2bs: $i] :
             ...
             => ! [V3cs: $i] :
                 ...
                 => ! [V4a: $i] :
                     ...
                     => ( surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V2bs)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),V3cs))
