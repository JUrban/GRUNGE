...
tff(conj_thm_2Ecardinal_2Ege__c,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__AS__INJECTIVE__IMAGE,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0s))
       ...
       => ? [V1f: $i] :
            ...
            & ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
                ( ap(V1f,inj__ty_2Enum_2Enum(V2m)) = ap(V1f,inj__ty_2Enum_2Enum(V3n))
               => V2m = V3n ) ) ) ) )).
