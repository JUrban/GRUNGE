...
fof(conj_thm_2Ereal__topology_2ECLOSED__BIGINTER__COMPACT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
      <=> ! [V1e] :
            ( mem(V1e,ty_2Erealax_2Ereal)
           => p(ap(c_2Ereal__topology_2Ecompact,ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V1e))),V0s))) ) ) ) )).
