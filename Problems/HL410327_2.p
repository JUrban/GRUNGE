...
tff(lamtp_f3622,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => mem(f3622(A_27b,A_27a,V0f,V1P),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))) ) ) )).
...
tff(lameq_f3622,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3622(A_27b,A_27a,V0f,V1P),V2x) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),ap(V0f,V2x)),ap(V1P,V2x)) ) ) ) )).

tff(lmtp_f3623,type,(
    f3623: ( del * $i ) > $i )).

tff(lamtp_f3623,axiom,(
    ! [A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27a,bool))
     => mem(f3623(A_27a,V1P),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f3623,axiom,(
    ! [A_27a: del,V1P: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3623(A_27a,V1P),V3x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),ap(V1P,V3x)) ) ) )).

tff(conj_thm_2Ereal__topology_2ESIMPLE__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f3622(A_27b,A_27a,V0f,V1P)) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3623(A_27a,V1P))) ) ) )).
