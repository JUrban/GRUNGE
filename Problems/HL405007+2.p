...
fof(conj_thm_2Equotient__option_2ESOME__PRS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1abs] :
                 ...
                 => ! [V2rep] :
                     ...
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => ! [V3x] :
                            ( mem(V3x,A_27b)
                           => ap(c_2Eoption_2ESOME(A_27b),V3x) = ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V1abs),ap(c_2Eoption_2ESOME(A_27a),ap(V2rep,V3x))) ) ) ) ) ) ) ) )).
