...
thf(thm_2Ereal_2EREAL__DIV__INNER__CANCEL,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2z: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2E_2F @ V1y @ V0x ) @ ( c_2Ereal_2E_2F @ V0x @ V2z ) )
...
thf(thm_2Ereal_2EREAL__DIV__INNER__CANCEL3,conjecture,(
    ! [V0y: tyop_2Erealax_2Ereal,V1z: tyop_2Erealax_2Ereal] :
      ( ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2E_2F @ V0y @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ ( c_2Ereal_2E_2F @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V1z ) )
