...
thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__FINITE__ROOTS,conjecture,(
    ! [V0p: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1a: tyop_2Erealax_2Ereal] :
      ( ( c_2Eiterate_2Epolynomial__function @ V0p )
     => ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2x: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V0p @ V2x ) @ V1a ) ) ) )
      <=> ( (~)
          @ ! [V3x: tyop_2Erealax_2Ereal] :
              ( ( V0p @ V3x )
              = V1a ) ) ) ) )).
