...
fof(conj_thm_2Ebag_2EBAG__IN__BAG__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2ESUB__BAG__INSERT__I,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__DISJOINT__BAG__IN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2Emlt__dominates__thm2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(conj_thm_2Ebag_2EBAG__DIFF__INSERT__SUB__BAG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
...
fof(conj_thm_2Ebag_2Emlt__INSERT__CANCEL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
