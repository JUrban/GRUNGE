...
fof(conj_thm_2Earithmetic_2EMOD__EQ__0,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Earithmetic_2EEXP__SUB,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ! [V1q] :
          ( mem(V1q,ty_2Enum_2Enum)
    ...
    ! [V0l] :
     ...
     => ! [V2n] :
         ...
         => ! [V1h] :
             ...
             => mem(f250(V0l,V2n,V1h),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) ) )).
...
fof(conj_thm_2Ebit_2EBITSLT__THM,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ebit_2EBITS__ZERO,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITS__ZERO4,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EDIV__MULT__THM,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__SIGN__EXTEND,conjecture,(
    ! [V0l] :
      ( mem(V0l,ty_2Enum_2Enum)
     => ! [V1h] :
          ( mem(V1h,ty_2Enum_2Enum)
