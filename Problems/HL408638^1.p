...
thf(f10012_0_2E0,type,(
    f10012_0_2E0: u )).

thf(f10012_0_2E1,type,(
    f10012_0_2E1: du > u )).
...
thf(def0_2Ethm_2EHolSmt_2Er017,axiom,(
    ! [V0q: $o] :
      ( ( mono_2Ef10012_0 @ V0q )
    <=> ( (~) @ V0q ) ) )).

thf(thm_2EHolSmt_2Er017,conjecture,(
    ! [V0q: $o,V1p: $o] :
      ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V1p @ ( mono_2Ef10012_0 @ V0q ) @ V0q )
    <=> ( ( (~) @ V0q )
      <=> V1p ) ) )).
