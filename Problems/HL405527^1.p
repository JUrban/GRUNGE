...
thf(thm_2Einteger_2EINT__MOD__CALCULATE,conjecture,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
        ( ( (~) @ ( V1m = mono_2Ec_2Enum_2E0 ) )
       => ( ( mono_2Ec_2Einteger_2Eint__mod @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1m ) )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2EMOD @ V0n @ V1m ) ) ) )
    & ! [V2p: mono_2Etyop_2Einteger_2Eint,V3q: mono_2Etyop_2Einteger_2Eint] :
        ( ( (~)
          @ ( V3q
            = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
       => ( ( mono_2Ec_2Einteger_2Eint__mod @ V2p @ ( mono_2Ec_2Einteger_2Eint__neg @ V3q ) )
          = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__mod @ ( mono_2Ec_2Einteger_2Eint__neg @ V2p ) @ V3q ) ) ) )
