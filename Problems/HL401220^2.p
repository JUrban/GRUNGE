...
thf(conj_thm_2Enumpair_2Einvtri0__thm,lemma,(
...
thf(conj_thm_2Enumpair_2ESND__invtri0,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ ( c_2Epair_2EFST @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Enumpair_2Einvtri0 @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( ap @ ( c_2Epair_2ESND @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Enumpair_2Einvtri0 @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) ) ) )).

thf(conj_thm_2Enumpair_2Einvtri__upper,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
