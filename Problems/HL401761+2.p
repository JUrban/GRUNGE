...
fof(conj_thm_2Epred__set_2EMIN__SET__THM,conjecture,
    ( ! [V0e] :
        ( mem(V0e,ty_2Enum_2Enum)
       => ap(c_2Epred__set_2EMIN__SET,ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),V0e),c_2Epred__set_2EEMPTY(ty_2Enum_2Enum))) = V0e )
    & ! [V1s] :
        ( mem(V1s,arr(ty_2Enum_2Enum,bool))
       => ! [V2e1] :
            ( mem(V2e1,ty_2Enum_2Enum)
           => ! [V3e2] :
                ( mem(V3e2,ty_2Enum_2Enum)
               => ap(c_2Epred__set_2EMIN__SET,ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),V2e1),ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),V3e2),V1s))) = ap(ap(c_2Earithmetic_2EMIN,V2e1),ap(c_2Epred__set_2EMIN__SET,ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),V3e2),V1s))) ) ) ) )).
