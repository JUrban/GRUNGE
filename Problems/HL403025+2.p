...
fof(mem_c_2EindexedLists_2EFOLDRi,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EindexedLists_2EFOLDRi(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,arr(A_27b,arr(A_27a,A_27a))),arr(A_27a,arr(ty_2Elist_2Elist(A_27b),A_27a)))) ) ) )).

fof(ax_thm_2EindexedLists_2EFOLDRi__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V3a] :
                   ...
                   => ! [V4h] :
                       ...
                       => ! [V5t] :
                           ...
                           => ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27a,A_27a),V2f),V3a),ap(ap(c_2Elist_2ECONS(A_27b),V4h),V5t)) = ap(ap(ap(V2f,c_2Enum_2E0),V4h),ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),c_2Enum_2ESUC)),V3a),V5t)) ) ) ) ) ) ) ) )).

fof(conj_thm_2EindexedLists_2EFOLDRi__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1l1] :
                 ...
                 => ! [V2l2] :
                     ...
                     => ! [V3f] :
                         ...
                         => ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27b,A_27b),V3f),V0a),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V2l2)) = ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27b,A_27b),V3f),ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V3f),ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),V1l1)))),V0a),V2l2)),V1l1) ) ) ) ) ) ) )).
