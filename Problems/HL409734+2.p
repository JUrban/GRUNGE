...
fof(lameq_f3316,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1s] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f3316(A_27a,V0f,V1s),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)),ap(V0f,V2x)),c_2Enum_2E0) ) ) ) )).

fof(conj_thm_2Eiterate_2ENSUM__RESTRICT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
         => ! [V1s] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3316(A_27a,V0f,V1s)) = ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),V0f) ) ) ) ) )).
