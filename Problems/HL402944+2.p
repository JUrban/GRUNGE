...
fof(conj_thm_2EpatternMatches_2EPMATCH__EXTEND__BOTH__ID,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1rows__old] :
                 ...
                 => ! [V2rows__new] :
                     ...
                     => ! [V3r] :
                         ...
                         => ( ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),V1rows__old) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),V2rows__new)
                           => ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V3r),V1rows__old)) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V3r),V2rows__new)) ) ) ) ) ) ) ) )).
