...
tff(conj_thm_2Equotient_2Eo__PRS,conjecture,(
                                 ...
                                 => ! [V7abs3: $i] :
                                     ...
                                     => ! [V8rep3: $i] :
                                         ...
                                         => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27c,A_27c),V6R3),V7abs3),V8rep3))
                                           => ! [V9f: $i] :
                                                ( mem(V9f,arr(A_27e,A_27f))
                                               => ! [V10g: $i] :
                                                    ( mem(V10g,arr(A_27d,A_27e))
                                                   => ap(ap(c_2Ecombin_2Eo(A_27d,A_27d,A_27d),V9f),V10g) = ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27d,A_27d,A_27d,A_27d),V2rep1),V7abs3),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27b,A_27b,A_27b,A_27b),V4abs2),V8rep3),V9f)),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),V5rep2),V10g))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
