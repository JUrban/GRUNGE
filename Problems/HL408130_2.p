...
tff(conj_thm_2Elim_2EDIFF__CARAT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(ap(c_2Elim_2Ediffl,V0f),inj__ty_2Erealax_2Ereal(V1l)),inj__ty_2Erealax_2Ereal(V2x)))
...
tff(lamtp_f2912,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f2912(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f2912,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2912(V0f,V1g),inj__ty_2Erealax_2Ereal(V3x)) = ap(V1g,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(conj_thm_2Elim_2ECONT__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Elim_2Econtl,f2912(V0f,V1g)),inj__ty_2Erealax_2Ereal(V2x))) ) ) ) )).
...
tff(conj_thm_2Elim_2ECONT__INVERSE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Elim_2EDIFF__INVERSE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
