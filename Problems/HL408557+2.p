...
fof(conj_thm_2Ebinary__ieee_2Efloat__sub__plus__infinity__finite,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
