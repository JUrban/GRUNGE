...
tff(conj_thm_2EpatternMatches_2EEL1__STRONGEST__REDUNDANT__ROWS__INFO__AUX,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
     ...
     => ! [V1rows: $i] :
         ...
         => ! [V2p: tp__o,V3infos: tp__c_ty_2Elist_2Elist_o,V4i: tp__ty_2Enum_2Enum] :
             ...
             => ( p(ap(ap(c_2Elist_2EEL(bool),inj__ty_2Enum_2Enum(V4i)),ap(c_2Epair_2ESND(bool,bool),ap(ap(ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX(A_27a,A_27a),V0v),V1rows),inj__o(V2p)),inj__c_ty_2Elist_2Elist_o(V3infos)))))
              <=> p(ap(ap(c_2Elist_2EEL(bool),inj__ty_2Enum_2Enum(V4i)),inj__c_ty_2Elist_2Elist_o(V3infos))) ) ) ) ) )).

tff(conj_thm_2EpatternMatches_2EEL2__STRONGEST__REDUNDANT__ROWS__INFO__AUX,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rows: $i] :
          ( mem(V1rows,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
         => ! [V2p: tp__o,V3infos: tp__c_ty_2Elist_2Elist_o,V4i: tp__ty_2Enum_2Enum] :
             ...
             => ( p(ap(ap(c_2Elist_2EEL(bool),inj__ty_2Enum_2Enum(V4i)),ap(c_2Epair_2ESND(bool,bool),ap(ap(ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX(A_27a,A_27a),V0v),V1rows),inj__o(V2p)),inj__c_ty_2Elist_2Elist_o(V3infos)))))
              <=> ( ( p(inj__o(V2p))
                    & p(ap(ap(c_2Elist_2EEVERY(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),f840(A_27b,A_27a,A_27a,A_27b,V0v)),ap(ap(c_2Elist_2ETAKE(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V4i)),ap(c_2Elist_2ELENGTH(bool),inj__c_ty_2Elist_2Elist_o(V3infos)))),V1rows))) )
