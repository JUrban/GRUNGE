...
thf(conj_thm_2Erealax_2EREAL__POS,conjecture,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Erealax_2Ereal__0 ) ) @ ( ap @ c_2Erealax_2Ereal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) ) ) )).
