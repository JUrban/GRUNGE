...
tff(conj_thm_2Ereal__topology_2EDIST__POS__LT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( V0x != V1y
...
tff(conj_thm_2Ereal__topology_2EWLOG__LT,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LT,lemma,(
    ! [V0R: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL__INJ,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elimit__point__of,inj__ty_2Erealax_2Ereal(V0x)),V1s))
      <=> ? [V2f: $i] :
