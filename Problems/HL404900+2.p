...
fof(conj_thm_2Elist_2EEXISTS__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ellist_2Eexists__ind,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Elbtree_2Ebf__flatten__eq__lnil,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
...
fof(conj_thm_2Elbtree_2Ebf__flatten__append,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l2] :
...
fof(conj_thm_2Elbtree_2EEXISTS__FIRST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Elbtree_2Eexists__bf__flatten,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
