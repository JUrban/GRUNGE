...
tff(lamtp_f1197,axiom,(
    ! [A_27a: del,A_27a: del,V2l: $i] :
      ( mem(V2l,ty_2Elist_2Elist(A_27a))
     => mem(f1197(A_27a,A_27a,V2l),arr(A_27a,ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))) ) )).

tff(lameq_f1197,axiom,(
    ! [A_27a: del,A_27a: del,V2l: $i] :
      ( mem(V2l,ty_2Elist_2Elist(A_27a))
     => ! [V3e: $i] :
          ( mem(V3e,A_27a)
         => ap(f1197(A_27a,A_27a,V2l),V3e) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l),ap(ap(c_2Elist_2ECONS(A_27a),V3e),c_2Elist_2ENIL(A_27a)))) ) ) )).

tff(lmtp_f1196,type,(
    f1196: ( del * del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1196,axiom,(
    ! [A_27a: del,A_27a: del,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V0n: tp__ty_2Enum_2Enum] : mem(f1196(A_27a,A_27a,V1ll,V0n),arr(ty_2Elist_2Elist(A_27a),ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))) ) )).

tff(lameq_f1196,axiom,(
    ! [A_27a: del,A_27a: del,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V0n: tp__ty_2Enum_2Enum,V2l: $i] :
          ( mem(V2l,ty_2Elist_2Elist(A_27a))
         => ap(f1196(A_27a,A_27a,V1ll,V0n),V2l) = ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll)),c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))),f1197(A_27a,A_27a,V2l)) ) ) )).

tff(conj_thm_2Ellist_2ELTAKE__SNOC__LNTH,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELTAKE(A_27a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n))),V1ll) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll)),c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))),f1196(A_27a,A_27a,V1ll,V0n)) ) )).
