...
tff(conj_thm_2Ereal__topology_2ELIM__AT__POSINFINITY,lemma,(
    ! [V0f: $i] :
...
tff(lamtp_f3737,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3737(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3737,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f3737(V0f),inj__ty_2Enum_2Enum(V2n)) = ap(V0f,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V2n))) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__POSINFINITY__SEQUENTIALLY,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),inj__ty_2Erealax_2Ereal(V1l)),c_2Ereal__topology_2Eat__posinfinity))
         => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f3737(V0f)),inj__ty_2Erealax_2Ereal(V1l)),c_2Ereal__topology_2Esequentially)) ) ) )).
