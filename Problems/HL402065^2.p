...
thf(ax_thm_2Eset__relation_2Eper__def,axiom,(
    ! [A_27a: del,V0xs: $i] :
...
thf(ax_thm_2Eset__relation_2Eper__restrict__def,axiom,(
    ! [A_27a: del,V0xss: $i] :
      ( ( mem @ V0xss @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1xs: $i] :
          ( ( mem @ V1xs @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Eset__relation_2Eper__restrict @ A_27a ) @ V0xss ) @ V1xs )
            = ( ap
              @ ( ap @ ( c_2Epred__set_2EDELETE @ ( arr @ A_27a @ bool ) )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V2xs_27: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V2xs_27 ) @ V1xs ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2xs_27 ) @ V0xss ) ) ) ) )
              @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) )).

thf(conj_thm_2Eset__relation_2Eper__restrict__per,conjecture,(
    ! [A_27a: del,V0r: $i] :
