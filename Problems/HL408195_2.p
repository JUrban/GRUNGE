...
tff(conj_thm_2Epoly_2EPOLY__EXP__DIVIDES,lemma,(
...
tff(conj_thm_2Epoly_2EPOLY__ORDER__EXISTS,lemma,(
...
tff(conj_thm_2Epoly_2EPOLY__ORDER,conjecture,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal,V1a: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(c_2Ebool_2E_3F_21(ty_2Enum_2Enum),f2928(V0p,V1a))) ) )).
