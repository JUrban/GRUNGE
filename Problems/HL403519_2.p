...
tff(conj_thm_2Ewellorder_2EINJ__preserves__linear__order,lemma,(
...
tff(conj_thm_2Ewellorder_2Edomain__IMAGE__ff,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
...
tff(conj_thm_2Ewellorder_2Erange__IMAGE__ff,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
...
tff(conj_thm_2Ewellorder_2EINJ__preserves__wellorder,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
