...
fof(conj_thm_2EEncode_2Ebiprefix__refl,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2EEncode_2Ebiprefix__append,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2EEncode_2Ewf__encoder__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2EEncode_2Ewf__encoder__eq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2EDecode_2Eenc2dec__some__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2ECoder_2Ewf__coder__op,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
