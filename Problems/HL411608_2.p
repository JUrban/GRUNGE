...
tff(conj_thm_2Ereal__topology_2EOPEN__HALFSPACE__GT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3904(V1b,V0a)))) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__IVT__HYPERPLANE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3a: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
            ...
            & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V4b)))
            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V4b)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V2y)))) )
         => ? [V5z: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5z)),V0s))
              & surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V5z))) = V4b ) ) ) )).
