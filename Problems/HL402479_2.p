...
tff(conj_thm_2EquantHeuristics_2EGUESS__RULES__TRIVIAL__FORALL__POINT,conjecture,(
    ! [A_27a: del,V0i: $i] :
      ( mem(V0i,A_27a)
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ( ~ p(ap(V1P,V0i))
           => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(ty_2Eone_2Eone,ty_2Eone_2Eone),k(ty_2Eone_2Eone,V0i)),V1P)) ) ) ) )).
