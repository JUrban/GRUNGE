...
tff(lmtp_f3719,type,(
    f3719: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3719,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f3719(V0x),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3719,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : ap(f3719(V0x),inj__ty_2Erealax_2Ereal(V1y)) = ap(ap(c_2Ereal_2Ereal__ge,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)) )).

tff(lmtp_f3718,type,(
    f3718: $i )).

tff(lamtp_f3718,axiom,(
    mem(f3718,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

tff(lameq_f3718,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3718,inj__ty_2Erealax_2Ereal(V0x)) = f3719(V0x) )).

tff(ax_thm_2Ereal__topology_2Eat__posinfinity,axiom,(
    surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(c_2Ereal__topology_2Eat__posinfinity) = surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Emk__net(ty_2Erealax_2Ereal),f3718)) )).

tff(conj_thm_2Ereal__topology_2EAT__POSINFINITY,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
