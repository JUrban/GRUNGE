...
fof(conj_thm_2Eoption_2ESOME__SOME__APPLY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1x] :
                  ( mem(V1x,A_27b)
                 => ap(ap(c_2Eoption_2EOPTION__APPLY(A_27a,A_27a),ap(c_2Eoption_2ESOME(arr(A_27b,A_27a)),V0f)),ap(c_2Eoption_2ESOME(A_27b),V1x)) = ap(c_2Eoption_2ESOME(A_27a),ap(V0f,V1x)) ) ) ) ) )).
