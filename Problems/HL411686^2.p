...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT__EQ,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
      <=> ! [V1f: $i] :
            ( ( mem @ V1f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
           => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V1f ) @ V0s ) )
                & ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1f ) @ V0s ) ) ) )
