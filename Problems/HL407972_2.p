...
tff(lamtp_f2869,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2869(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2869,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2869(V0x),inj__ty_2Enum_2Enum(V2n)) = ap(c_2Erealax_2Einv,ap(V0x,inj__ty_2Enum_2Enum(V2n))) ) )).

tff(conj_thm_2Eseq_2ESEQ__INV,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0x),inj__ty_2Erealax_2Ereal(V1x0)))
            & V1x0 != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
         => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2869(V0x)),ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V1x0)))) ) ) )).
