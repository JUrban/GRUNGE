...
fof(conj_thm_2Epred__set_2EPREIMAGE__COMPL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                  ( mem(V1s,arr(A_27b,bool))
                 => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2ECOMPL(A_27b),V1s)) = ap(c_2Epred__set_2ECOMPL(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s)) ) ) ) ) )).
