...
fof(conj_thm_2Esptree_2Edomain__FOLDR__delete,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
         ...
         => ! [V1live] :
             ...
             => ap(c_2Esptree_2Edomain(A_27a),ap(ap(ap(c_2Elist_2EFOLDR(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Esptree_2Edelete(A_27a)),V1live),V0ls)) = ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),ap(c_2Esptree_2Edomain(A_27a),V1live)),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),V0ls)) ) ) ) )).
