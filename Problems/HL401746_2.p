...
tff(conj_thm_2Epred__set_2EINJ__SUBSET,lemma,(
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__INJ__o,lemma,(
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__PERMUTES,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1g: $i] :
           ...
           => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V1g),V0s),V0s))
             => ! [V2f: $i] :
                  ( mem(V2f,arr(A_27a,ty_2Enum_2Enum))
                 => surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2f),V1g)),V0s)) = surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V2f),V0s)) ) ) ) ) ) )).
