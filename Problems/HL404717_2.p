...
tff(conj_thm_2Efinite__map_2EDOMSUB__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0k: $i] :
      ( mem(V0k,A_27a)
     => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V0k) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) )).
