...
tff(lamtp_f775,axiom,(
    ! [A_27a: del,A_27a: del,V2l_27: $i] :
      ( mem(V2l_27,ty_2Elist_2Elist(A_27a))
     => mem(f775(A_27a,A_27a,V2l_27),arr(A_27a,ty_2Elist_2Elist(A_27a))) ) )).
...
tff(lameq_f775,axiom,(
    ! [A_27a: del,A_27a: del,V2l_27: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f775(A_27a,A_27a,V2l_27),V3x) = ap(ap(c_2Elist_2ESNOC(A_27a),V3x),V2l_27) ) ) )).

tff(lmtp_f774,type,(
    f774: ( del * del ) > $i )).

tff(lamtp_f774,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f774(A_27a,A_27a),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,ty_2Elist_2Elist(A_27a)))) )).

tff(lameq_f774,axiom,(
    ! [A_27a: del,A_27a: del,V2l_27: $i] :
      ( mem(V2l_27,ty_2Elist_2Elist(A_27a))
     => ap(f774(A_27a,A_27a),V2l_27) = f775(A_27a,A_27a,V2l_27) ) )).

tff(conj_thm_2Erich__list_2EAPPEND__FOLDL,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
         => ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f774(A_27a,A_27a)),V0l1),V1l2) ) ) )).
