...
thf(conj_thm_2ETemporal__Logic_2EDELTA__CASES,lemma,(
    ! [V0b: $i] :
...
thf(conj_thm_2ETemporal__Logic_2ESUNTIL__SIGNAL,lemma,(
    ! [V0a: $i] :
...
thf(conj_thm_2ETemporal__Logic_2ESBEFORE__SIGNAL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EWHEN__AS__UNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V0a ) @ V1b )
            = ( ap
              ...
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V3t ) ) @ ( ap @ V1b @ V3t ) ) ) ) ) ) ) )).

thf(conj_thm_2ETemporal__Logic_2EALWAYS__AS__BEFORE,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__BEFORE,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESWHEN__AS__SUNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EMORE__EVENT,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2EWHEN
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V2t ) ) @ ( ap @ V1b @ V2t ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EUNTIL @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2EUNTIL
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V3t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V3t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V4t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V4t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2ESWHEN
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V5t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V5t ) ) @ ( ap @ V1b @ V5t ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V6t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V6t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V6t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESBEFORE @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2ETemporal__Logic_2ESBEFORE
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V7t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V7t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V7t ) ) ) ) )
                @ V1b ) ) ) ) ) )).

thf(conj_thm_2ETemporal__Logic_2ENOT__UNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ENOT__BEFORE,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EPast__Temporal__Logic_2EBEFORE__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
