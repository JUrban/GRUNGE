...
fof(conj_thm_2Ereal__topology_2EIN__FROM,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESUMS__FINITE__UNION,lemma,(
    ! [V0f] :
         ...
         => ! [V2t] :
             ...
             => ! [V3l] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V2t))
                      & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V3l),V1s)) )
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Erealax_2Ereal__add,V3l),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),V2t),V1s)),V0f))),ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),V1s),V2t))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUMS__OFFSET__REV,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
         ...
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),ap(c_2Ereal__topology_2Efrom,V2m)))
                   ...
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Erealax_2Ereal__add,V1l),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V3n),ap(ap(c_2Earithmetic_2E_2D,V2m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0f))),ap(c_2Ereal__topology_2Efrom,V3n))) ) ) ) ) ) )).
