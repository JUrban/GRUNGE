...
thf(thm_2Epred__set_2EINJ__IMAGE__BIJ,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1f: A_27a > A_27b] :
      ( ? [V2t: A_27b > $o] :
          ( c_2Epred__set_2EINJ @ A_27a @ A_27b @ V1f @ V0s @ V2t )
...
thf(thm_2Epred__set_2EBIJ__SYM__IMP,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
     ...
     => ? [V3g: A_27b > A_27a] :
          ( c_2Epred__set_2EBIJ @ A_27b @ A_27a @ V3g @ V1t @ V0s ) ) )).

thf(thm_2Epred__set_2EBIJ__TRANS,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0s: A_27a > $o,V1t: A_27c > $o,V2u: A_27b > $o] :
      ( ( ? [V3f: A_27a > A_27c] :
            ( c_2Epred__set_2EBIJ @ A_27a @ A_27c @ V3f @ V0s @ V1t )
        & ? [V4g: A_27c > A_27b] :
            ( c_2Epred__set_2EBIJ @ A_27c @ A_27b @ V4g @ V1t @ V2u ) )
     => ? [V5h: A_27a > A_27b] :
          ( c_2Epred__set_2EBIJ @ A_27a @ A_27b @ V5h @ V0s @ V2u ) ) )).
...
thf(thm_2Epred__set_2ESCHROEDER__BERNSTEIN,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ? [V2f: A_27a > A_27b] :
        ...
        & ? [V3g: A_27b > A_27a] :
            ( c_2Epred__set_2EINJ @ A_27b @ A_27a @ V3g @ V1t @ V0s ) )
     => ? [V4h: A_27a > A_27b] :
