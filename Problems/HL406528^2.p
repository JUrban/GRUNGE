...
thf(conj_thm_2Eblast_2EBSUM__EQ,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $o,V2x1: $i] :
...
thf(conj_thm_2Eblast_2EBSUM__LEM,lemma,(
    ! [V0i: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum,V3c: $o] :
      ( ( p
        @ ( ap
          @ ( ap
            @ ( ap @ ( ap @ c_2Eblast_2EBSUM @ ( inj__ty_2Enum_2Enum @ V0i ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4i: $i] :
                    ( ap @ ( ap @ c_2Ebit_2EBIT @ V4i ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V5i: $i] :
                  ( ap @ ( ap @ c_2Ebit_2EBIT @ V5i ) @ ( inj__ty_2Enum_2Enum @ V2y ) ) ) )
          @ ( inj__o @ V3c ) ) )
...
thf(conj_thm_2Ewords_2Eword__1comp__n2w,lemma,(
...
thf(conj_thm_2Ewords_2EWORD__NEG,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Eblast_2EBITWISE__SUB,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ V0x ) @ V1y )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ ( ap @ ( ap @ ( ap @ c_2Eblast_2EBSUM @ V2i ) @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0x ) ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ bool @ bool ) @ c_2Ebool_2E_7E ) @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1y ) ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) ) ) ) ) )).
