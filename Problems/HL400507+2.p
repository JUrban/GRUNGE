...
fof(conj_thm_2Eoption_2Eoption__case__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Eoption_2Eoption(A_27a))
         => ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V0x),c_2Eoption_2ENONE(A_27a)),c_2Eoption_2ESOME(A_27a)) = V0x ) ) )).

fof(conj_thm_2Eoption_2Eoption__case__SOME__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Eoption_2Eoption(A_27a))
         => ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V0x),V0x),c_2Eoption_2ESOME(A_27a)) = V0x ) ) )).

fof(conj_thm_2Eoption_2Eoption__CLAUSES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
