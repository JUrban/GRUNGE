...
thf(conj_thm_2Ebool_2ERES__FORALL__CONG,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__EMPTY,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2ERES__EXISTS @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V0p ) ) ) )).

thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__EMPTY,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
