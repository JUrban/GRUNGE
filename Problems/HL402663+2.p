...
fof(conj_thm_2Erich__list_2ENOT__NIL__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Erich__list_2ENULL__FOLDL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ( p(ap(c_2Elist_2ENULL(A_27a),V0l))
          <=> p(ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),k(bool,k(A_27a,c_2Ebool_2EF))),c_2Ebool_2ET),V0l)) ) ) ) )).
