...
thf(conj_thm_2Ereal__topology_2ESUMS__SYM,conjecture,(
    ! [V0s: $i] :
              ...
              @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V4y: $i] :
                      ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V5x: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ V4y ) @ V5x ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V4y ) @ V1t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V0s ) ) ) ) ) ) ) ) ) ) )).
