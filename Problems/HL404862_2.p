...
tff(conj_thm_2EternaryComparisons_2Eordering2num__num2ordering,conjecture,(
    ...
    <=> surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,ap(c_2EternaryComparisons_2Enum2ordering,inj__ty_2Enum_2Enum(V0r)))) = V0r ) )).
