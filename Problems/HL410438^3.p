...
thf(thm_2Etopology_2EHULL__UNION__SUBSET,axiom,(
    ! [A_27a: $tType,V0P: ( A_27a > $o ) > $o,V1s: A_27a > $o,V2t: A_27a > $o] :
      ( c_2Epred__set_2ESUBSET @ A_27a @ ( c_2Epred__set_2EUNION @ A_27a @ ( c_2Etopology_2Ehull @ A_27a @ V0P @ V1s ) @ ( c_2Etopology_2Ehull @ A_27a @ V0P @ V2t ) ) @ ( c_2Etopology_2Ehull @ A_27a @ V0P @ ( c_2Epred__set_2EUNION @ A_27a @ V1s @ V2t ) ) ) )).

thf(thm_2Ereal__topology_2ESPAN__UNION__SUBSET,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Espan @ V0s ) @ ( c_2Ereal__topology_2Espan @ V1t ) ) @ ( c_2Ereal__topology_2Espan @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V0s @ V1t ) ) ) )).
