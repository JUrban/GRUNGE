...
thf(thm_2EOmega__Automata_2EBOREL__HIERARCHY__FG,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ? [V2t1: mono_2Etyop_2Enum_2Enum] :
          ! [V3t2: mono_2Etyop_2Enum_2Enum] :
            ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V2t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V3t2 @ V0t0 ) ) )
      <=> ? [V4q: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V4q @ V0t0 ) )
            & ! [V5t: mono_2Etyop_2Enum_2Enum] :
                ( ( V4q @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t @ V0t0 ) )
               => ( ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t @ V0t0 ) )
                  & ( V4q @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t @ V0t0 ) ) ) ) )
            & ? [V6t: mono_2Etyop_2Enum_2Enum] :
                ( V4q @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) ) )
      & ( ? [V7t1: mono_2Etyop_2Enum_2Enum] :
          ! [V8t2: mono_2Etyop_2Enum_2Enum] :
            ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t2 @ V0t0 ) ) )
      <=> ? [V9p: mono_2Etyop_2Enum_2Enum > $o,V10q: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V9p @ V0t0 ) )
            & ( (~) @ ( V10q @ V0t0 ) )
            & ! [V11t: mono_2Etyop_2Enum_2Enum] :
                ( ( ( V9p @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                 => ( V9p @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) )
                & ( ( V9p @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                 => ( ( V9p @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                    | ( (~) @ ( V10q @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) ) )
                & ( ( V10q @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                <=> ( ( ( V9p @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                      & ( (~) @ ( V10q @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                      & ( (~) @ ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) )
                    | ( ( V9p @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                      & ( V10q @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) ) ) )
            & ! [V12t1: mono_2Etyop_2Enum_2Enum] :
              ? [V13t2: mono_2Etyop_2Enum_2Enum] :
                ( ( V9p @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V13t2 @ V0t0 ) ) )
                & ( (~) @ ( V10q @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V13t2 @ V0t0 ) ) ) ) ) ) ) ) )).
