...
tff(f7053_0_2E0,type,(
    f7053_0_2E0: tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool)) )).

tff(f7053_0_2E2,type,(
    f7053_0_2E2: ( tyop_2Emin_2Ebool * tyop_2Emin_2Ebool ) > tyop_2Emin_2Ebool )).

tff(f7053_1_2E0,type,(
    f7053_1_2E0: tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool)) )).

tff(f7053_1_2E2,type,(
    f7053_1_2E2: ( tyop_2Emin_2Ebool * tyop_2Emin_2Ebool ) > tyop_2Emin_2Ebool )).
...
tff(arityeq2_2Ef7053_0_2E2,axiom,(
    ! [X0_2E0: tyop_2Emin_2Ebool,X1_2E0: tyop_2Emin_2Ebool] : f7053_0_2E2(X0_2E0,X1_2E0) = app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool,app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool),f7053_0_2E0,X0_2E0),X1_2E0) )).

tff(arityeq2_2Ef7053_1_2E2,axiom,(
    ! [X0_2E0: tyop_2Emin_2Ebool,X1_2E0: tyop_2Emin_2Ebool] : f7053_1_2E2(X0_2E0,X1_2E0) = app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool,app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool),f7053_1_2E0,X0_2E0),X1_2E0) )).
...
tff(def0_2Ethm_2Ewords_2EWORD__LITERAL__OR,axiom,(
    ! [V8a_2E0: tyop_2Emin_2Ebool,V9b_2E0: tyop_2Emin_2Ebool] :
      ( p(f7053_1_2E2(V8a_2E0,V9b_2E0))
    <=> ( p(V8a_2E0)
        & ~ p(V9b_2E0) ) ) )).

tff(def1_2Ethm_2Ewords_2EWORD__LITERAL__OR,axiom,(
    ! [V4a_2E0: tyop_2Emin_2Ebool,V5b_2E0: tyop_2Emin_2Ebool] :
      ( p(f7053_0_2E2(V4a_2E0,V5b_2E0))
    <=> ( p(V4a_2E0)
        & ~ p(V5b_2E0) ) ) )).

tff(thm_2Ewords_2EWORD__LITERAL__OR,conjecture,(
    ! [A_27a: $tType] :
