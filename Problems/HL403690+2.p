...
fof(conj_thm_2Erelation_2EALT__equivalence,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(conj_thm_2Esorting_2EPERM__EQUIVALENCE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => p(ap(c_2Erelation_2Eequivalence(ty_2Elist_2Elist(A_27a)),c_2Esorting_2EPERM(A_27a))) ) )).

fof(conj_thm_2Esorting_2EPERM__EQUIVALENCE__ALT__DEF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
