...
tff(conj_thm_2Epred__set_2EDIFF__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(tp_c_2Ereal_2Einf,type,(
    c_2Ereal_2Einf: $i )).

tff(mem_c_2Ereal_2Einf,axiom,(
...
tff(conj_thm_2Eseq_2ESUMS__EQ,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Eseq_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1x)))
        <=> ( p(ap(c_2Eseq_2Esummable,V0f))
            & surj__ty_2Erealax_2Ereal(ap(c_2Eseq_2Esuminf,V0f)) = V1x ) ) ) )).

tff(conj_thm_2Eseq_2ESER__POS__COMPARE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V0f,inj__ty_2Enum_2Enum(V2n))))
              & p(ap(c_2Eseq_2Esummable,V1g))
              & ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Enum_2Enum(V3n))),ap(V1g,inj__ty_2Enum_2Enum(V3n)))) )
           => ( p(ap(c_2Eseq_2Esummable,V0f))
...
tff(conj_thm_2Eutil__prob_2EINF__LE,lemma,(
    ! [V0p: $i] :
...
tff(conj_thm_2Eutil__prob_2EMINIMAL__EXISTS,lemma,(
    ! [V0P: $i] :
...
tff(tp_c_2Emeasure_2Einf__measure,type,(
    c_2Emeasure_2Einf__measure: del > $i )).

tff(mem_c_2Emeasure_2Einf__measure,axiom,(
    ! [A_27a: del] : mem(c_2Emeasure_2Einf__measure(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),ty_2Erealax_2Ereal))) )).
...
tff(lmtp_f3526,type,(
    f3526: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3526,axiom,(
    ! [A_27a: del,V3f: $i] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V4m: tp__ty_2Enum_2Enum] : mem(f3526(A_27a,V3f,V4m),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3526,axiom,(
    ! [A_27a: del,V3f: $i] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] : ap(f3526(A_27a,V3f,V4m),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4m)),inj__ty_2Enum_2Enum(V5n)))),ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V3f,inj__ty_2Enum_2Enum(V4m))),ap(V3f,inj__ty_2Enum_2Enum(V5n)))) ) )).

tff(lmtp_f3525,type,(
    f3525: ( del * $i ) > $i )).

tff(lamtp_f3525,axiom,(
    ! [A_27a: del,V3f: $i] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => mem(f3525(A_27a,V3f),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3525,axiom,(
    ! [A_27a: del,V3f: $i] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V4m: tp__ty_2Enum_2Enum] : ap(f3525(A_27a,V3f),inj__ty_2Enum_2Enum(V4m)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3526(A_27a,V3f,V4m)) ) )).

tff(lmtp_f3524,type,(
    f3524: ( del * tp__ty_2Erealax_2Ereal * $i * $i ) > $i )).

tff(lamtp_f3524,axiom,(
    ! [A_27a: del,V2r: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f3524(A_27a,V2r,V1s,V0m),arr(arr(ty_2Enum_2Enum,arr(A_27a,bool)),bool)) ) ) )).
...
tff(lameq_f3524,axiom,(
    ! [A_27a: del,V2r: tp__ty_2Erealax_2Ereal,V1s: $i] :
     ...
     => ! [V0m: $i] :
         ...
         => ! [V3f: $i] :
              ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
             => ap(f3524(A_27a,V2r,V1s,V0m),V3f) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V3f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3525(A_27a,V3f))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1s),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V3f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))),ap(ap(c_2Eseq_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emeasure_2Emeasure(A_27a),V0m)),V3f)),inj__ty_2Erealax_2Ereal(V2r))))) ) ) ) )).

tff(lmtp_f3523,type,(
    f3523: ( del * $i * $i ) > $i )).

tff(lamtp_f3523,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f3523(A_27a,V1s,V0m),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
tff(lameq_f3523,axiom,(
    ! [A_27a: del,V1s: $i] :
     ...
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2r: tp__ty_2Erealax_2Ereal] : ap(f3523(A_27a,V1s,V0m),inj__ty_2Erealax_2Ereal(V2r)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2r)),ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,arr(A_27a,bool))),f3524(A_27a,V2r,V1s,V0m))) ) ) )).

tff(ax_thm_2Emeasure_2Einf__measure__def,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Einf__measure(A_27a),V0m),V1s)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Einf,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3523(A_27a,V1s,V0m)))) ) ) )).

tff(conj_thm_2Emeasure_2EALGEBRA__DIFF,lemma,(
    ! [A_27a: del,V0a: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
               ...
               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EDIFF(A_27a),V1s),V2t)),ap(c_2Emeasure_2Esubsets(A_27a),V0a))) ) ) ) ) )).
...
tff(lmtp_f3537,type,(
    f3537: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3537,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5m: tp__ty_2Enum_2Enum] : mem(f3537(A_27a,V4f,V5m),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3537,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] : ap(f3537(A_27a,V4f,V5m),inj__ty_2Enum_2Enum(V6n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V6n)))),ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V4f,inj__ty_2Enum_2Enum(V5m))),ap(V4f,inj__ty_2Enum_2Enum(V6n)))) ) )).

tff(lmtp_f3536,type,(
    f3536: ( del * $i ) > $i )).

tff(lamtp_f3536,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => mem(f3536(A_27a,V4f),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3536,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5m: tp__ty_2Enum_2Enum] : ap(f3536(A_27a,V4f),inj__ty_2Enum_2Enum(V5m)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3537(A_27a,V4f,V5m)) ) )).

tff(lmtp_f3535,type,(
    f3535: ( del * tp__ty_2Erealax_2Ereal * $i * $i ) > $i )).

tff(lamtp_f3535,axiom,(
    ! [A_27a: del,V3r: tp__ty_2Erealax_2Ereal,V1g: $i] :
      ( mem(V1g,arr(A_27a,bool))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f3535(A_27a,V3r,V1g,V0m),arr(arr(ty_2Enum_2Enum,arr(A_27a,bool)),bool)) ) ) )).
...
tff(lameq_f3535,axiom,(
    ! [A_27a: del,V3r: tp__ty_2Erealax_2Ereal,V1g: $i] :
     ...
     => ! [V0m: $i] :
         ...
         => ! [V4f: $i] :
              ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
             => ap(f3535(A_27a,V3r,V1g,V0m),V4f) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V4f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3536(A_27a,V4f))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1g),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V4f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))),ap(ap(c_2Eseq_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emeasure_2Emeasure(A_27a),V0m)),V4f)),inj__ty_2Erealax_2Ereal(V3r))))) ) ) ) )).

tff(lmtp_f3534,type,(
    f3534: ( del * $i * $i ) > $i )).

tff(lamtp_f3534,axiom,(
    ! [A_27a: del,V1g: $i] :
      ( mem(V1g,arr(A_27a,bool))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f3534(A_27a,V1g,V0m),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
tff(lameq_f3534,axiom,(
    ! [A_27a: del,V1g: $i] :
     ...
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V3r: tp__ty_2Erealax_2Ereal] : ap(f3534(A_27a,V1g,V0m),inj__ty_2Erealax_2Ereal(V3r)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3r)),ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,arr(A_27a,bool))),f3535(A_27a,V3r,V1g,V0m))) ) ) )).

tff(conj_thm_2Emeasure_2EINF__MEASURE__POS0,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
                & p(ap(c_2Emeasure_2Epositive(A_27a),V0m))
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3534(A_27a,V1g,V0m)))) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2x))) ) ) ) )).

tff(conj_thm_2Emeasure_2EINCREASING,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lmtp_f3539,type,(
    f3539: ( del * $i * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3539,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V3r: tp__ty_2Erealax_2Ereal,V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(lameq_f3538,axiom,(
    ! [A_27a: del,V1s: $i] :
     ...
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V3r: tp__ty_2Erealax_2Ereal] : ap(f3538(A_27a,V1s,V0m),inj__ty_2Erealax_2Ereal(V3r)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3r)),ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,arr(A_27a,bool))),f3539(A_27a,V1s,V3r,V0m))) ) ) )).

tff(conj_thm_2Emeasure_2EINF__MEASURE__LE,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
                & p(ap(c_2Emeasure_2Epositive(A_27a),V0m))
                & p(ap(c_2Emeasure_2Eincreasing(A_27a),V0m))
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3538(A_27a,V1s,V0m)))) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Emeasure_2Einf__measure(A_27a),V0m),V1s)),inj__ty_2Erealax_2Ereal(V2x))) ) ) ) )).
