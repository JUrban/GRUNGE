...
thf(arityeq1_2Emono_2Ec_2Epred__set_2EFINITE_2E1_2Emono_2Etyop_2Esum_2Esum_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EFINITE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Ecardinal_2ECARD__LE__FINITE,axiom,(
...
thf(thm_2Ecardinal_2ECARD__LE__ADDR,axiom,(
    ! [A_27a: d,A_27b: d,V0s_2E0: u,V1t_2E0: u] :
...
thf(thm_2Ecardinal_2ECARD__LE__ADDL,axiom,(
    ! [A_27a: d,A_27b: d,V0s_2E0: u,V1t_2E0: u] :
...
thf(thm_2Ecardinal_2ECARD__ADD__FINITE,axiom,(
    ! [A_27a: d,A_27b: d,V0s_2E0: u,V1t_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2E_2B__c_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD__FINITE__EQ,conjecture,(
    ! [A_27a: d,A_27b: d,V0s_2E0: u,V1t_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2E_2B__c_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) ) ) ) )).
