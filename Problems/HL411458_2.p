...
tff(lmtp_f3836,type,(
    f3836: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3836,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2v: tp__ty_2Erealax_2Ereal] : mem(f3836(V1c,V2v),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3836,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2v: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3836(V1c,V2v),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,inj__ty_2Erealax_2Ereal(V3x))),inj__ty_2Erealax_2Ereal(V2v)) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__VMUL,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__VMUL,conjecture,(
    ! [V0s: $i] :
     ...
     => ! [V1c: $i] :
         ...
         => ! [V2v: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3836(V1c,V2v)),V0s)) ) ) ) )).
