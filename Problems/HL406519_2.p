...
tff(conj_thm_2Elist_2ENULL__LENGTH,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ( p(ap(c_2Elist_2ENULL(A_27a),V0l))
      <=> surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V0l)) = fo__c_2Enum_2E0 ) ) )).
...
tff(conj_thm_2Erich__list_2ELASTN__1,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ( V0l != c_2Elist_2ENIL(A_27a)
...
tff(conj_thm_2Erich__list_2EDROP__LASTN,lemma,(
...
tff(lamtp_f2310,axiom,(
    mem(f2310,arr(ty_2Elist_2Elist(bool),bool)) )).

tff(lameq_f2310,axiom,(
    ! [V2l: tp__c_ty_2Elist_2Elist_o] : ap(f2310,inj__c_ty_2Elist_2Elist_o(V2l)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(c_2Elist_2ENULL(bool),inj__c_ty_2Elist_2Elist_o(V2l)))),ap(c_2Elist_2ELAST(bool),inj__c_ty_2Elist_2Elist_o(V2l))) )).

tff(conj_thm_2Ebitstring_2Eword__bit__last__shiftr,conjecture,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] :
     ...
     => ( p(ap(ap(c_2Ewords_2Eword__bit(A_27a),inj__ty_2Enum_2Enum(V0i)),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V1v))))
      <=> p(ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2310),ap(ap(c_2Ebitstring_2Eshiftr,inj__c_ty_2Elist_2Elist_o(V1v)),inj__ty_2Enum_2Enum(V0i)))) ) ) )).
