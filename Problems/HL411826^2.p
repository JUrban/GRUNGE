...
thf(conj_thm_2Ereal__topology_2EDIST__CLOSEST__POINT__LIPSCHITZ,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
              ...
              @ ( ap
                @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2x: $i] :
                        ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal__topology_2Eclosest__point @ V0s ) @ V2x ) ) ) ) )
                @ V1t ) ) ) ) ) )).
