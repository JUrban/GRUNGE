...
tff(f10009_0_2E0,type,(
    f10009_0_2E0: tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool) )).

tff(f10009_0_2E1,type,(
    f10009_0_2E1: tyop_2Emin_2Ebool > tyop_2Emin_2Ebool )).
...
tff(arityeq1_2Ef10009_0_2E1,axiom,(
    ! [X0_2E0: tyop_2Emin_2Ebool] : f10009_0_2E1(X0_2E0) = app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool,f10009_0_2E0,X0_2E0) )).
...
tff(def0_2Ethm_2EHolSmt_2Er014,axiom,(
    ! [V0q_2E0: tyop_2Emin_2Ebool] :
      ( p(f10009_0_2E1(V0q_2E0))
    <=> ~ p(V0q_2E0) ) )).

tff(thm_2EHolSmt_2Er014,conjecture,(
    ! [V0q_2E0: tyop_2Emin_2Ebool,V1p_2E0: tyop_2Emin_2Ebool] :
      ( p(c_2Ebool_2ECOND_2E3(tyop_2Emin_2Ebool,V1p_2E0,V0q_2E0,f10009_0_2E1(V0q_2E0)))
    <=> V1p_2E0 = V0q_2E0 ) )).
