...
thf(tp_c_2Eordinal_2Edownward__closed,type,(
    c_2Eordinal_2Edownward__closed: del > $i )).

thf(mem_c_2Eordinal_2Edownward__closed,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Eordinal_2Edownward__closed__def,axiom,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eordinal_2Epreds__bij,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Eordinal_2Esup__thm,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
