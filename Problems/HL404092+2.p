...
fof(lameq_f934,axiom,(
    ! [V0b] :
     ...
     => ! [V3t] :
         ...
         => ap(f934(V0b),V3t) = ap(c_2Ebool_2E_7E,ap(V0b,V3t)) ) ) )).
...
fof(lameq_f1529,axiom,(
    ! [V2a] :
     ...
     => ! [V4t] :
          ( mem(V4t,ty_2Enum_2Enum)
         => ap(f1529(V2a),V4t) = ap(c_2Ebool_2E_7E,ap(V2a,V4t)) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ENO__PAST__EVENT,conjecture,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1t] :
         ...
         => ! [V2a] :
              ( mem(V2a,arr(ty_2Enum_2Enum,bool))
             => ( p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,f934(V0b)),V1t))
               => ( ( p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V2a),V0b),V1t))
                  ...
                  <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,f1529(V2a)),V1t)) )
