...
thf(conj_thm_2Ereal__topology_2ESEPARATION__T2,lemma,(
    ...
    <=> ? [V2u: $i] :
          ...
          & ? [V3v: $i] :
              ...
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V2u ) )
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ V3v ) )
              & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V2u ) @ V3v )
...
thf(conj_thm_2Ereal__topology_2ESEPARATION__T1,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( V0x != V1y )
    <=> ? [V2u: $i] :
          ( ( mem @ V2u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
          & ? [V3v: $i] :
              ...
              & ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V3v ) )
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V2u ) )
              & ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ V2u ) )
              & ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V3v ) )
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ V3v ) ) ) ) ) )).
