...
fof(conj_thm_2Earithmetic_2EMAX__0,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ( ap(ap(c_2Earithmetic_2EMAX,V0n),c_2Enum_2E0) = V0n
        & ap(ap(c_2Earithmetic_2EMAX,c_2Enum_2E0),V0n) = V0n ) ) )).

fof(conj_thm_2Enumeral_2Enumeral__MAX,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1y] :
          ( mem(V1y,ty_2Enum_2Enum)
         => ( ap(ap(c_2Earithmetic_2EMAX,c_2Enum_2E0),V0x) = V0x
            & ap(ap(c_2Earithmetic_2EMAX,V0x),c_2Enum_2E0) = V0x
            & ap(ap(c_2Earithmetic_2EMAX,ap(c_2Earithmetic_2ENUMERAL,V0x)),ap(c_2Earithmetic_2ENUMERAL,V1y)) = ap(c_2Earithmetic_2ENUMERAL,ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V0x),V1y)),V1y),V0x)) ) ) ) )).
