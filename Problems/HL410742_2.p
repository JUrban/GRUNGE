...
tff(conj_thm_2Ereal__topology_2EDIST__NZ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( V0x != V1y
...
tff(conj_thm_2Ereal__topology_2EREAL__CHOOSE__DIST,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELIMPT__APPROACHABLE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EIN__INTERIOR,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__LIMIT__POINT,conjecture,(
    ! [V0s: $i] :
