...
fof(conj_thm_2Ereal__topology_2EDIFF__BIGINTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0u] :
          ( mem(V0u,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2EBIGUNION__MONO__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2ECLOSURE__APPROACHABLE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EBAIRE__ALT,conjecture,(
    ! [V0g] :
      ( mem(V0g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
