...
tff(conj_thm_2Ereal_2EREAL__LNEG__UNIQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
...
tff(conj_thm_2Elim_2ELIM__CONST,lemma,(
...
tff(conj_thm_2Elim_2ELIM__ADD,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Elim_2ELIM__NEG,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Elim_2ELIM__INV,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(ap(c_2Elim_2Etends__real__real,V0f),inj__ty_2Erealax_2Ereal(V1l)),inj__ty_2Erealax_2Ereal(V2x)))
            & V1l != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
         => p(ap(ap(ap(c_2Elim_2Etends__real__real,f2899(V0f)),ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V1l))),inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Elim_2ELIM__X,lemma,(
...
tff(lameq_f2903,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f2903(V0f,V1g),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),ap(V1g,inj__ty_2Erealax_2Ereal(V4x))) ) ) )).

tff(conj_thm_2Elim_2ELIM__TRANSFORM,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x0: tp__ty_2Erealax_2Ereal,V3l: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(ap(c_2Elim_2Etends__real__real,f2903(V0f,V1g)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2x0)))
...
tff(lamtp_f2916,axiom,(
    mem(f2916,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f2916,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal] : ap(f2916,inj__ty_2Erealax_2Ereal(V1x)) = ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V1x)) )).

tff(conj_thm_2Elim_2EDIFF__XM1,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( V0x != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
     => p(ap(ap(ap(c_2Elim_2Ediffl,f2916),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2Epow,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0x))) ) )).
