...
thf(conj_thm_2ETemporal__Logic_2EALWAYS__SIGNAL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1t0: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ V0a ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) )
        <=> ! [V2t: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) ) )).
...
thf(conj_thm_2ETemporal__Logic_2EUNTIL__AS__SUNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ap @ ( ap @ c_2ETemporal__Logic_2EUNTIL @ V0a ) @ V1b )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V2t: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V1b ) @ V2t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ V0a ) @ V2t ) ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2EWOP,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2EOmega__Automata_2ECO__BUECHI__UNTIL__CLOSURE,conjecture,(
                                              ...
                                              @ ( ap
                                                @ ( ap @ c_2Ebool_2E_2F_5C
                                                  @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                                                    @ ( lam @ ty_2Enum_2Enum
                                                      @ ^ [V9t: $i] :
                                                          ( ap @ V2Phi__R @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V3i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t ) @ V7t0 ) ) ) @ ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t ) @ V7t0 ) ) ) ) ) ) )
                                                @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                                  @ ( lam @ ty_2Enum_2Enum
                                                    @ ^ [V10t1: $i] :
                                                        ...
                                                        @ ( lam @ ty_2Enum_2Enum
                                                          @ ^ [V11t2: $i] :
                                                              ( ap @ V4Psi @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V3i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V11t2 ) @ V7t0 ) ) ) ) @ ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V11t2 ) @ V7t0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
