...
thf(thm_2Enets_2EMR1__BOUNDED,axiom,(
    ! [A_27a: d,V0g_2E0: u,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Enets_2Ebounded_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emetric_2Emetric @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ tyop_2Erealax_2Ereal ) @ ( i_mono_2Etyop_2Emetric_2Emetric_28tyop_2Erealax_2Ereal_29 @ mono_2Ec_2Emetric_2Emr1 ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) ) ) )
    <=> ? [V2k: mono_2Etyop_2Erealax_2Ereal,V3N_2E0: u] :
          ...
          & ! [V4n_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V4n_2E0 ) ) ) @ ( s @ A_27a @ V3N_2E0 ) ) ) )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V4n_2E0 ) ) ) ) ) @ V2k ) ) ) ) )).
...
thf(thm_2Eseq_2ESEQ__BOUNDED,conjecture,(
    ...
    <=> ? [V1k: mono_2Etyop_2Erealax_2Ereal] :
        ! [V2n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( V0s @ V2n ) ) @ V1k ) ) )).
