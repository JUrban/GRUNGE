...
fof(lamtp_f3111,axiom,(
    ! [A_27t,A_27w,V1toneg] :
      ( mem(V1toneg,bool)
     => mem(f3111(A_27t,A_27w,V1toneg),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))) ) )).

fof(lameq_f3111,axiom,(
    ! [A_27t,A_27w,V1toneg] :
      ( mem(V1toneg,bool)
     => ! [V3x] :
          ( mem(V3x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ap(f3111(A_27t,A_27w,V1toneg),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27t,A_27t),V3x)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),V1toneg),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))),V3x) ) ) )).
         ...
         => ! [V0mode] :
             ...
             => ! [V1toneg] :
                 ...
                 => ! [V2r] :
                     ...
                     => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),V0mode),V1toneg),V2r) = ap(ap(c_2Ebool_2ELET(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),f3111(A_27t,A_27w,V1toneg)),ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),V0mode),V2r)) ) ) ) ) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTiesToEven__is__zero,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0x] :
             ...
             => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Ereal_2Eabs,V0x))),ap(c_2Ebinary__ieee_2Eulp(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
               => ( ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0x) = ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))
                  | ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0x) = ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Eround__roundTiesToEven__is__minus__zero,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
