...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__SELF,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3805(V0a)),V1s)),V1s)) ) )).

tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__LEFT__EQ,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3924(V0a)),V1s)),V2t))
