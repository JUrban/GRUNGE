...
thf(conj_thm_2Erich__list_2EFILTER__MAP,lemma,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f1 ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27b @ A_27a ) @ V1f2 ) @ V2l ) )
                = ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27b @ A_27a ) @ V1f2 ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27b ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27b @ bool @ A_27a ) @ V0f1 ) @ V1f2 ) ) @ V2l ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EMAP__SND__FILTER__NEQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0z: $i] :
      ( ( mem @ V0z @ A_27a )
     => ! [V1ls: $i] :
          ( ( mem @ V1ls @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) @ ( c_2Epair_2ESND @ A_27b @ A_27a ) )
              @ ( ap
                @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) )
                  @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27b @ A_27a @ bool )
                    @ ( lam @ A_27b
                      @ ^ [V2x: $i] :
                          ( lam @ A_27a
                          @ ^ [V3y: $i] :
                              ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V3y ) @ V0z ) ) ) ) ) )
                @ V1ls ) )
            = ( ap
              @ ( ap @ ( c_2Elist_2EFILTER @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V4y: $i] :
                      ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V0z ) @ V4y ) ) ) )
              @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) @ ( c_2Epair_2ESND @ A_27b @ A_27a ) ) @ V1ls ) ) ) ) ) )).
