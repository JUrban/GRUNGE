...
thf(conj_thm_2Ebag_2EBAG__IMAGE__FINITE__UNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0b1: $i] :
     ...
     => ! [V1b2: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b1 ) )
                  & ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V1b2 ) ) )
               => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27b @ A_27a ) @ V2f ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V1b2 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27b ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27b @ A_27a ) @ V2f ) @ V0b1 ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27b @ A_27a ) @ V2f ) @ V1b2 ) ) ) ) ) ) ) )).
