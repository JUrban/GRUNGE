...
tff(conj_thm_2Epred__set_2Ecountable__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
...
tff(conj_thm_2Eordinal_2Epreds__ordSUC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EcountableOrds__dclosed,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
...
tff(mem_c_2Eucord_2Eomega1,axiom,(
    ! [A_27a: del] : mem(c_2Eucord_2Eomega1(A_27a),ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))) )).

tff(lmtp_f2281,type,(
    f2281: del > $i )).

tff(lamtp_f2281,axiom,(
    ! [A_27a: del] : mem(f2281(A_27a),arr(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a)),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a)),ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))))) )).
...
tff(conj_thm_2Eucord_2Eucord__sup__exists__lemma,lemma,(
    ! [A_27a: del] : p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a)),ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a)),ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))),f2281(A_27a))),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).

tff(ax_thm_2Eucord_2Eomega1__def,axiom,(
    ! [A_27a: del] : c_2Eucord_2Eomega1(A_27a) = ap(c_2Eordinal_2Esup(ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a)),ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))),f2281(A_27a))) )).

tff(conj_thm_2Eucord_2Ex__lt__omega1__countable,conjecture,(
    ! [A_27a: del,V0x: $i] :
