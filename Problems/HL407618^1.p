...
thf(thm_2EordinalNotation_2Eoless__imp__rank__leq,axiom,(
...
thf(thm_2EordinalNotation_2Elemma,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1P: mono_2Etyop_2EordinalNotation_2Eosyntax > $o] :
      ( ? [V2x: mono_2Etyop_2EordinalNotation_2Eosyntax] :
          ( ( mono_2Ec_2EordinalNotation_2Eis__ord @ V2x )
          & ( V1P @ V2x )
          & ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2EordinalNotation_2Erank @ V2x ) @ V0n ) )
     => ? [V3m: mono_2Etyop_2EordinalNotation_2Eosyntax] :
          ( ( mono_2Ec_2EordinalNotation_2Eis__ord @ V3m )
          & ( V1P @ V3m )
          & ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2EordinalNotation_2Erank @ V3m ) @ V0n )
          & ! [V4y: mono_2Etyop_2EordinalNotation_2Eosyntax] :
              ( ( ( mono_2Ec_2EordinalNotation_2Eis__ord @ V4y )
                & ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2EordinalNotation_2Erank @ V4y ) @ V0n )
                & ( mono_2Ec_2EordinalNotation_2Eoless @ V4y @ V3m ) )
             => ( (~) @ ( V1P @ V4y ) ) ) ) ) )).
...
thf(thm_2EordinalNotation_2Emain__lemma,conjecture,(
