...
fof(lamtp_f3719,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3719(V0x),arr(ty_2Erealax_2Ereal,bool)) ) )).

fof(lameq_f3719,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(f3719(V0x),V1y) = ap(ap(c_2Ereal_2Ereal__ge,V0x),V1y) ) ) )).

fof(lamtp_f3718,axiom,(
    mem(f3718,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

fof(lameq_f3718,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(f3718,V0x) = f3719(V0x) ) )).

fof(ax_thm_2Ereal__topology_2Eat__posinfinity,axiom,(
    c_2Ereal__topology_2Eat__posinfinity = ap(c_2Ereal__topology_2Emk__net(ty_2Erealax_2Ereal),f3718) )).

fof(conj_thm_2Ereal__topology_2EAT__POSINFINITY,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
