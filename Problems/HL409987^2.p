...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__POS__MEM__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eextreal_2Esup__lt__infty,lemma,(
    ! [V0p: $i] :
...
thf(conj_thm_2Eextreal_2Eext__suminf__lt__infty,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal ) )
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
          & ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ c_2Eextreal_2Eext__suminf @ V0f ) )
           != fo__c_2Eextreal_2EPosInf ) )
       => ! [V2n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( inj__ty_2Eextreal_2Eextreal @ fo__c_2Eextreal_2EPosInf ) ) ) ) ) )).
