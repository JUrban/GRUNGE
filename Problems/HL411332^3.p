...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE,conjecture,(
    ...
    <=> ! [V2x: tyop_2Erealax_2Ereal,V3e: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
            & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V3e ) )
         => ? [V4d: tyop_2Erealax_2Ereal] :
              ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V4d )
              & ! [V5y: tyop_2Erealax_2Ereal] :
                  ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5y @ V1s )
                    & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V5y @ V2x ) ) @ V4d ) )
                 => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V5y ) @ ( V0f @ V2x ) ) ) @ V3e ) ) ) ) ) )).
