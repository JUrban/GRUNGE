...
tff(lameq_f1162,axiom,(
    ! [A_27a: del,V2h: $i] :
      ( mem(V2h,A_27a)
     => ! [V3t: $i] :
          ( mem(V3t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f1162(A_27a,V2h,V3t),inj__ty_2Enum_2Enum(V4n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Eoption_2ESOME(A_27a),V2h)),ap(V3t,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V4n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).

tff(conj_thm_2Ellist_2Elrep__ok__cases,conjecture,(
    ! [A_27a: del,V0a0: $i] :
      ( mem(V0a0,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
