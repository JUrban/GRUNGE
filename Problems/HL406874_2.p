...
tff(conj_thm_2Ehrat_2EHRAT__ADD__SYM,lemma,(
...
tff(tp_c_2Ehreal_2Ehreal__sub,type,(
    c_2Ehreal_2Ehreal__sub: $i )).

tff(mem_c_2Ehreal_2Ehreal__sub,axiom,(
    mem(c_2Ehreal_2Ehreal__sub,arr(ty_2Ehreal_2Ehreal,arr(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))) )).

tff(stp_fo_c_2Ehreal_2Ehreal__sub,type,(
    fo__c_2Ehreal_2Ehreal__sub: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal ) > tp__ty_2Ehreal_2Ehreal )).

tff(stp_eq_fo_c_2Ehreal_2Ehreal__sub,axiom,(
    ! [X0: tp__ty_2Ehreal_2Ehreal,X1: tp__ty_2Ehreal_2Ehreal] : inj__ty_2Ehreal_2Ehreal(fo__c_2Ehreal_2Ehreal__sub(X0,X1)) = ap(ap(c_2Ehreal_2Ehreal__sub,inj__ty_2Ehreal_2Ehreal(X0)),inj__ty_2Ehreal_2Ehreal(X1)) )).
...
tff(conj_thm_2Ehreal_2EHRAT__DOWN2,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
    ? [V2z: tp__ty_2Ehrat_2Ehrat] :
      ( p(ap(ap(c_2Ehreal_2Ehrat__lt,inj__ty_2Ehrat_2Ehrat(V2z)),inj__ty_2Ehrat_2Ehrat(V0x)))
...
tff(conj_thm_2Ehreal_2EEQUAL__CUTS,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V0X)) = ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V1Y))
     => V0X = V1Y ) )).
...
tff(lmtp_f2576,type,(
    f2576: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehrat_2Ehrat * tp__ty_2Ehrat_2Ehrat ) > $i )).

tff(lamtp_f2576,axiom,(
    ! [V1Y: tp__ty_2Ehreal_2Ehreal,V0X: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat,V3x: tp__ty_2Ehrat_2Ehrat] : mem(f2576(V1Y,V0X,V2w,V3x),arr(ty_2Ehrat_2Ehrat,bool)) )).

tff(lameq_f2576,axiom,(
    ! [V1Y: tp__ty_2Ehreal_2Ehreal,V0X: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat,V3x: tp__ty_2Ehrat_2Ehrat,V4y: tp__ty_2Ehrat_2Ehrat] : ap(f2576(V1Y,V0X,V2w,V3x),inj__ty_2Ehrat_2Ehrat(V4y)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Ehrat_2Ehrat),inj__ty_2Ehrat_2Ehrat(V2w)),ap(ap(c_2Ehrat_2Ehrat__add,inj__ty_2Ehrat_2Ehrat(V3x)),inj__ty_2Ehrat_2Ehrat(V4y)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V0X)),inj__ty_2Ehrat_2Ehrat(V3x))),ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V1Y)),inj__ty_2Ehrat_2Ehrat(V4y)))) )).

tff(lmtp_f2575,type,(
    f2575: ( tp__ty_2Ehrat_2Ehrat * tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal ) > $i )).

tff(lamtp_f2575,axiom,(
    ! [V2w: tp__ty_2Ehrat_2Ehrat,V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] : mem(f2575(V2w,V0X,V1Y),arr(ty_2Ehrat_2Ehrat,bool)) )).

tff(lameq_f2575,axiom,(
    ! [V2w: tp__ty_2Ehrat_2Ehrat,V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal,V3x: tp__ty_2Ehrat_2Ehrat] : ap(f2575(V2w,V0X,V1Y),inj__ty_2Ehrat_2Ehrat(V3x)) = ap(c_2Ebool_2E_3F(ty_2Ehrat_2Ehrat),f2576(V1Y,V0X,V2w,V3x)) )).

tff(lmtp_f2574,type,(
    f2574: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal ) > $i )).

tff(lamtp_f2574,axiom,(
    ! [V1Y: tp__ty_2Ehreal_2Ehreal,V0X: tp__ty_2Ehreal_2Ehreal] : mem(f2574(V1Y,V0X),arr(ty_2Ehrat_2Ehrat,bool)) )).

tff(lameq_f2574,axiom,(
    ! [V1Y: tp__ty_2Ehreal_2Ehreal,V0X: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat] : ap(f2574(V1Y,V0X),inj__ty_2Ehrat_2Ehrat(V2w)) = ap(c_2Ebool_2E_3F(ty_2Ehrat_2Ehrat),f2575(V2w,V0X,V1Y)) )).

tff(ax_thm_2Ehreal_2Ehreal__add,axiom,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] : surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__add,inj__ty_2Ehreal_2Ehreal(V0X)),inj__ty_2Ehreal_2Ehreal(V1Y))) = surj__ty_2Ehreal_2Ehreal(ap(c_2Ehreal_2Ehreal,f2574(V1Y,V0X))) )).

tff(conj_thm_2Ehreal_2EHREAL__ADD__ISACUT,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] : p(ap(c_2Ehreal_2Eisacut,f2574(V1Y,V0X))) )).

tff(lmtp_f2586,type,(
    f2586: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehrat_2Ehrat * tp__ty_2Ehreal_2Ehreal ) > $i )).

tff(lamtp_f2586,axiom,(
    ! [V0Y: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat,V1X: tp__ty_2Ehreal_2Ehreal] : mem(f2586(V0Y,V2w,V1X),arr(ty_2Ehrat_2Ehrat,bool)) )).

tff(lameq_f2586,axiom,(
    ! [V0Y: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat,V1X: tp__ty_2Ehreal_2Ehreal,V3x: tp__ty_2Ehrat_2Ehrat] : ap(f2586(V0Y,V2w,V1X),inj__ty_2Ehrat_2Ehrat(V3x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V1X)),inj__ty_2Ehrat_2Ehrat(V3x)))),ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V0Y)),ap(ap(c_2Ehrat_2Ehrat__add,inj__ty_2Ehrat_2Ehrat(V3x)),inj__ty_2Ehrat_2Ehrat(V2w)))) )).

tff(lmtp_f2585,type,(
    f2585: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal ) > $i )).

tff(lamtp_f2585,axiom,(
    ! [V1X: tp__ty_2Ehreal_2Ehreal,V0Y: tp__ty_2Ehreal_2Ehreal] : mem(f2585(V1X,V0Y),arr(ty_2Ehrat_2Ehrat,bool)) )).

tff(lameq_f2585,axiom,(
    ! [V1X: tp__ty_2Ehreal_2Ehreal,V0Y: tp__ty_2Ehreal_2Ehreal,V2w: tp__ty_2Ehrat_2Ehrat] : ap(f2585(V1X,V0Y),inj__ty_2Ehrat_2Ehrat(V2w)) = ap(c_2Ebool_2E_3F(ty_2Ehrat_2Ehrat),f2586(V0Y,V2w,V1X)) )).

tff(ax_thm_2Ehreal_2Ehreal__sub,axiom,(
    ! [V0Y: tp__ty_2Ehreal_2Ehreal,V1X: tp__ty_2Ehreal_2Ehreal] : surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__sub,inj__ty_2Ehreal_2Ehreal(V0Y)),inj__ty_2Ehreal_2Ehreal(V1X))) = surj__ty_2Ehreal_2Ehreal(ap(c_2Ehreal_2Ehreal,f2585(V1X,V0Y))) )).
...
tff(conj_thm_2Ehreal_2EHREAL__SUB__ISACUT,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( p(ap(ap(c_2Ehreal_2Ehreal__lt,inj__ty_2Ehreal_2Ehreal(V0X)),inj__ty_2Ehreal_2Ehreal(V1Y)))
     => p(ap(c_2Ehreal_2Eisacut,f2587(V0X,V1Y))) ) )).

tff(conj_thm_2Ehreal_2EHREAL__SUB__ADD,conjecture,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( p(ap(ap(c_2Ehreal_2Ehreal__lt,inj__ty_2Ehreal_2Ehreal(V0X)),inj__ty_2Ehreal_2Ehreal(V1Y)))
     => surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__add,ap(ap(c_2Ehreal_2Ehreal__sub,inj__ty_2Ehreal_2Ehreal(V1Y)),inj__ty_2Ehreal_2Ehreal(V0X))),inj__ty_2Ehreal_2Ehreal(V0X))) = V1Y ) )).
