...
thf(conj_thm_2Elist_2EFRONT__CONS__EQ__NIL,lemma,(
    ! [A_27a: del] :
      ( ! [V0x: $i] :
          ( ( mem @ V0x @ A_27a )
         => ! [V1xs: $i] :
...
thf(conj_thm_2Erich__list_2ETAKE__PRE__LENGTH,conjecture,(
    ! [A_27a: del,V0ls: $i] :
      ( ( mem @ V0ls @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( V0ls
         != ( c_2Elist_2ENIL @ A_27a ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( ap @ c_2Eprim__rec_2EPRE @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0ls ) ) ) @ V0ls )
          = ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V0ls ) ) ) ) )).
