...
thf(conj_thm_2Ereal__topology_2EOPEN__SCALING,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__TRANSLATION,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__AFFINITY,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
            ...
            @ ( ap @ c_2Ereal__topology_2EOpen
              @ ( ap
                @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V3x: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ V3x ) ) ) )
                @ V0s ) ) ) ) ) )).
