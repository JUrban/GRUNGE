...
tff(conj_thm_2Erich__list_2EREPLICATE__GENLIST,lemma,(
...
tff(conj_thm_2Erich__list_2ELIST__REL__REPLICATE__same,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
         ...
         => ! [V3y: $i] :
              ( mem(V3y,A_27b)
             => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),inj__ty_2Enum_2Enum(V1n)),V2x)),ap(ap(c_2Erich__list_2EREPLICATE(A_27b),inj__ty_2Enum_2Enum(V1n)),V3y)))
