...
fof(conj_thm_2Epred__set_2ESUBSET__INSERT__RIGHT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Epred__set_2ESUBSET__DELETE__BOTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s1] :
...
fof(conj_thm_2Epred__set_2EPOW__INSERT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
