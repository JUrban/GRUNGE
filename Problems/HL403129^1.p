...
thf(f3710_0_2E0,type,(
    f3710_0_2E0: u )).

thf(f3710_0_2E1,type,(
    f3710_0_2E1: du > u )).

thf(f3710_1_2E0,type,(
    f3710_1_2E0: u )).

thf(f3710_1_2E1,type,(
    f3710_1_2E1: du > u )).

thf(f3710_2_2E0,type,(
    f3710_2_2E0: u )).

thf(f3710_2_2E1,type,(
    f3710_2_2E1: du > u )).

thf(f3710_3_2E0,type,(
    f3710_3_2E0: u )).

thf(f3710_3_2E1,type,(
    f3710_3_2E1: du > u )).
...
thf(mono_2Ef3710_0,type,(
    mono_2Ef3710_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3710_1,type,(
    mono_2Ef3710_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3710_2,type,(
    mono_2Ef3710_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3710_3,type,(
    mono_2Ef3710_3: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EUNTIL__SIMP,axiom,(
    ! [V8t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3710_3 @ V8t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EUNTIL__SIMP,axiom,(
    ! [V5t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3710_1 @ V5t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2EUNTIL__SIMP,axiom,(
    ! [V6t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3710_2 @ V6t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2EUNTIL__SIMP,axiom,(
    ! [V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3710_0 @ V3t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2ETemporal__Logic_2EUNTIL__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ mono_2Ef3710_0 @ V0b @ V2x )
          = ( V0b @ V2x ) )
      & ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ mono_2Ef3710_1 @ V0b @ V4x )
          = mono_2Ec_2Ebool_2ET )
      & ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ V1a @ mono_2Ef3710_2 )
        = ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ V1a ) )
      & ! [V7x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ V1a @ mono_2Ef3710_3 @ V7x )
          = mono_2Ec_2Ebool_2ET )
      & ! [V9x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ V1a @ V1a @ V9x )
          = ( V1a @ V9x ) ) ) )).
