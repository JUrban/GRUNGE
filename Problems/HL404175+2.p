...
fof(conj_thm_2Epath_2Enth__label__drop,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                      ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Enum_2ESUC,ap(ap(c_2Earithmetic_2E_2B,V0i),V1j))),ap(c_2Epath_2EPL(A_27a,A_27a),V2p)))
                       => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V0i),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),V1j),V2p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),ap(ap(c_2Earithmetic_2E_2B,V0i),V1j)),V2p) ) ) ) ) ) ) )).
