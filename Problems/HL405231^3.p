...
thf(thm_2ECoder_2Ebnum__coder__def,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1p: tyop_2Enum_2Enum > $o] :
      ( ( c_2ECoder_2Ebnum__coder @ V0m @ V1p )
      = ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > $o ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) ) ) @ V1p @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o ) ) ) ) @ ( c_2EEncode_2Eencode__bnum @ V0m ) @ ( c_2EDecode_2Edecode__bnum @ V0m @ V1p ) ) ) ) )).
...
thf(thm_2ECoder_2Ewf__coder__bnum,conjecture,(
    ! [V0m: tyop_2Enum_2Enum,V1p: tyop_2Enum_2Enum > $o] :
      ( ( c_2EEncode_2Ewf__pred__bnum @ V0m @ V1p )
     => ( c_2ECoder_2Ewf__coder @ tyop_2Enum_2Enum @ ( c_2ECoder_2Ebnum__coder @ V0m @ V1p ) ) ) )).
