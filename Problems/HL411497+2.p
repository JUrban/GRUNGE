...
fof(lamtp_f3957,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => mem(f3957(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3957,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V5x] :
          ( mem(V5x,ty_2Erealax_2Ereal)
         => ap(f3957(V0a),V5x) = ap(ap(c_2Erealax_2Ereal__add,V0a),V5x) ) ) )).

fof(conj_thm_2Ereal__topology_2ETRANSLATION__DIFF,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
