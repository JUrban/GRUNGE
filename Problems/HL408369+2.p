...
fof(conj_thm_2Etransc_2ECOS__BOUNDS,lemma,(
    ! [V0x] :
...
fof(lamtp_f2987,axiom,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => mem(f2987(V0y),arr(ty_2Erealax_2Ereal,bool)) ) )).
...
fof(lameq_f2987,axiom,(
    ! [V0y] :
     ...
     => ! [V1x] :
         ...
         => ap(f2987(V0y),V1x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V1x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,V1x),c_2Etransc_2Epi)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Etransc_2Ecos,V1x)),V0y))) ) ) )).

fof(conj_thm_2Etransc_2ECOS__TOTAL,lemma,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0y))
       ...
       => p(ap(c_2Ebool_2E_3F_21(ty_2Erealax_2Ereal),f2987(V0y))) ) ) )).

fof(conj_thm_2Etransc_2EACS,lemma,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0y))
          & p(ap(ap(c_2Ereal_2Ereal__lte,V0y),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) )
...
fof(conj_thm_2Etransc_2ECOS__ACS,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
