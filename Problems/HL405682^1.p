...
thf(arityeq1_2Emono_2Ec_2Eoption_2ESOME_2E1_2Emono_2Etyop_2Eordinal_2Eordinal_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) @ c_2Eoption_2ESOME_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Eordinal_2Epreds__omax__SOME__SUC,axiom,(
    ! [A_27a: d,V0b_2E0: u,V1a_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2Eomax_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eordinal_2Epreds_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0b_2E0 ) ) ) )
...
thf(thm_2Eordinal_2EordMULT__0R,axiom,(
    ! [A_27a: d,V0a_2E0: u] :
      ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordMULT_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )
...
thf(thm_2Eordinal_2EordEXP__ZERO__nonlimit,conjecture,(
    ! [A_27a: d,V0x_2E0: u] :
      ( ( (~)
        @ ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2Eomax_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eordinal_2Epreds_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0x_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) ) )
     => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordEXP_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0x_2E0 ) ) )
        = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) ) )).
