...
fof(conj_thm_2EHolSmt_2Et030,conjecture,(
    ! [V0p] :
      ( mem(V0p,bool)
     => ! [V1x] :
          ( mem(V1x,ty_2Efcp_2Ecart(bool,bool))
         => ( ( p(V0p)
            <=> ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) = V1x )
          <=> V1x = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),V0p),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0)) ) ) ) )).
