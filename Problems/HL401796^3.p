    ...
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ( ! [V1x: A_27a] :
          ...
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V2y: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V2y @ ( V0R @ V1x @ V2y ) ) ) )
     => ! [V3x: A_27a] :
          ( ( (~)
            @ ( c_2Epred__set_2EFINITE @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V4y: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V4y @ ( c_2Erelation_2ERTC @ A_27a @ V0R @ V3x @ V4y ) ) ) ) )
         => ? [V5f: tyop_2Enum_2Enum > A_27a] :
              ( ( ( V5f @ c_2Enum_2E0 )
                = V3x )
              & ! [V6n: tyop_2Enum_2Enum] :
                  ( V0R @ ( V5f @ V6n ) @ ( V5f @ ( c_2Enum_2ESUC @ V6n ) ) ) ) ) ) )).
...
thf(thm_2Epred__set_2EKoenigsLemma__WF,conjecture,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ( ( ! [V1x: A_27a] :
            ( c_2Epred__set_2EFINITE @ A_27a
            @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
