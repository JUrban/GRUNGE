...
thf(thm_2Eiterate_2ESUM__POS__EQ__0,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
...
thf(thm_2Eiterate_2ESUM__ZERO__EXISTS,conjecture,(
    ! [A_27a: $tType,V0u: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
        & ( ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0u )
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( ! [V2i: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V2i @ V1s )
           => ( ( V0u @ V2i )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
        | ? [V3j: A_27a,V4k: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3j @ V1s )
            & ( c_2Erealax_2Ereal__lt @ ( V0u @ V3j ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
            & ( c_2Ebool_2EIN @ A_27a @ V4k @ V1s )
            & ( c_2Ereal_2Ereal__gt @ ( V0u @ V4k ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) )).
