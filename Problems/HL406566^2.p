...
thf(mem_c_2Esptree_2Eunion,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Esptree_2Eunion @ A_27a ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27a ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27a ) @ ( ty_2Esptree_2Espt @ A_27a ) ) ) ) )).
...
thf(conj_thm_2Esptree_2Elookup__union,lemma,(
    ! [A_27a: del,V0m1: $i] :
     ...
     => ! [V1m2: $i] :
         ...
         => ! [V2k: tp__ty_2Enum_2Enum] :
              ...
              = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ A_27a @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Esptree_2Elookup @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) @ V0m1 ) ) @ ( ap @ ( ap @ ( c_2Esptree_2Elookup @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) @ V1m2 ) )
                @ ( lam @ A_27a
                  @ ^ [V3v: $i] :
                      ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V3v ) ) ) ) ) ) )).
...
thf(conj_thm_2Esptree_2Edomain__union,conjecture,(
    ! [A_27a: del,V0t1: $i] :
