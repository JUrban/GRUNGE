...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SCALING,lemma,(
            ...
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ V2x ) ) )
              @ V1s ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBOUNDED__NEGATIONS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
       => ( p
