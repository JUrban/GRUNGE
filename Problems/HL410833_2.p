...
tff(lmtp_f3717,type,(
    f3717: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3717,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f3717(V0x),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3717,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : ap(f3717(V0x),inj__ty_2Erealax_2Ereal(V1y)) = ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1y))) )).

tff(lmtp_f3716,type,(
    f3716: $i )).

tff(lamtp_f3716,axiom,(
    mem(f3716,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

tff(lameq_f3716,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3716,inj__ty_2Erealax_2Ereal(V0x)) = f3717(V0x) )).

tff(ax_thm_2Ereal__topology_2Eat__infinity,axiom,(
    surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(c_2Ereal__topology_2Eat__infinity) = surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Emk__net(ty_2Erealax_2Ereal),f3716)) )).

tff(conj_thm_2Ereal__topology_2EAT__INFINITY,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
