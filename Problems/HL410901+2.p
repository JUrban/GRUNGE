...
fof(conj_thm_2Epred__set_2EIMAGE__11__INFINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2EINFINITE__FROM,lemma,(
    ! [V0n] :
...
fof(conj_thm_2Ereal__topology_2EINFINITE__SUPERSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2ELIMPT__INFINITE__OPEN__BALL__CBALL,conjecture,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1x] :
            ( mem(V1x,ty_2Erealax_2Ereal)
