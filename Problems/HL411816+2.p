...
fof(conj_thm_2Ereal__topology_2EREAL__POW__1__LE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EDIST__TRIANGLE__HALF__R,lemma,(
    ! [V0e] :
      ( mem(V0e,ty_2Erealax_2Ereal)
     => ! [V1x1] :
...
fof(conj_thm_2Ereal__topology_2EREAL__ARCH__POW__INV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECAUCHY,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
             ...
             => ? [V2N] :
                  ...
                  & ! [V3n] :
                     ...
                     => ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V3n),V2N))
                       => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0s,V3n)),ap(V0s,V2N)))),V1e)) ) ) ) ) ) ) ) )).

fof(lamtp_f4053,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f4053(V1s,V0f),arr(ty_2Erealax_2Ereal,bool)) ) ) )).

fof(lameq_f4053,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V5x] :
             ...
             => ap(f4053(V1s,V0f),V5x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,V5x)),V5x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBANACH__FIX,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2c] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ecomplete,V1s))
                  ...
                  & p(ap(ap(c_2Erealax_2Ereal__lt,V2c),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))
                  ...
                  & ! [V3x] :
                     ...
                     => ! [V4y] :
                         ...
                         => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V1s))
                           ...
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V3x)),ap(V0f,V4y)))),ap(ap(c_2Erealax_2Ereal__mul,V2c),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),V4y))))) ) ) ) )
               => p(ap(c_2Ebool_2E_3F_21(ty_2Erealax_2Ereal),f4053(V1s,V0f))) ) ) ) ) )).
