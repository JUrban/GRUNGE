...
fof(ax_thm_2Epred__set_2Eequiv__on__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(lamtp_f302,axiom,(
    ! [A_27a,V1s] :
     ...
     => ! [V3x] :
         ...
         => ! [V0R] :
              ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
             => mem(f302(A_27a,V1s,V3x,V0R),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) ) )).

fof(lameq_f302,axiom,(
    ! [A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V3x] :
          ( mem(V3x,A_27a)
         => ! [V0R] :
             ...
             => ! [V4y] :
                  ( mem(V4y,A_27a)
                 => ap(f302(A_27a,V1s,V3x,V0R),V4y) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4y),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V4y),V1s)),ap(ap(V0R,V3x),V4y))) ) ) ) ) )).

fof(lamtp_f301,axiom,(
    ! [A_27a,A_27a,V2t] :
     ...
     => ! [V0R] :
         ...
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => mem(f301(A_27a,A_27a,V2t,V0R,V1s),arr(A_27a,bool)) ) ) ) )).

fof(lameq_f301,axiom,(
    ! [A_27a,A_27a,V2t] :
      ( mem(V2t,arr(A_27a,bool))
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ! [V3x] :
                  ( mem(V3x,A_27a)
                 => ap(f301(A_27a,A_27a,V2t,V0R,V1s),V3x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s)),ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V2t),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f302(A_27a,V1s,V3x,V0R)))) ) ) ) ) )).

fof(lamtp_f300,axiom,(
    ! [A_27a,A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1s] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f300(A_27a,A_27a,V0R,V1s),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).

fof(lameq_f300,axiom,(
    ! [A_27a,A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1s] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t] :
              ( mem(V2t,arr(A_27a,bool))
             => ap(f300(A_27a,A_27a,V0R,V1s),V2t) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V2t),ap(c_2Ebool_2E_3F(A_27a),f301(A_27a,A_27a,V2t,V0R,V1s))) ) ) ) )).

fof(ax_thm_2Epred__set_2Epartition__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ap(ap(c_2Epred__set_2Epartition(A_27a),V0R),V1s) = ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f300(A_27a,A_27a,V0R,V1s)) ) ) ) )).

fof(conj_thm_2Epred__set_2Epartition__elements__interrelate,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
