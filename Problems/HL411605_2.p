...
tff(conj_thm_2Ebool_2ENOT__AND,lemma,(
    ! [V0t: tp__o] :
      ~ ( p(inj__o(V0t))
        & ~ p(inj__o(V0t)) ) )).
...
tff(conj_thm_2Ebool_2ELEFT__EXISTS__IMP__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Ebool_2ERIGHT__EXISTS__IMP__THM,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
               ...
               => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3838(V1s,V0f,V2t)))) ) ) ) ) )).

tff(lmtp_f3890,type,(
    f3890: ( $i * $i * $i ) > $i )).

tff(lamtp_f3890,axiom,(
    ! [V1f: $i] :
     ...
     => ! [V0P: $i] :
         ...
         => ! [V2g: $i] :
             ...
             => mem(f3890(V1f,V0P,V2g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) ) )).

tff(lameq_f3890,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V0P: $i] :
          ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2g: $i] :
              ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3890(V1f,V0P,V2g),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(V0P,inj__ty_2Erealax_2Ereal(V6x))),ap(V1f,inj__ty_2Erealax_2Ereal(V6x))),ap(V2g,inj__ty_2Erealax_2Ereal(V6x))) ) ) ) )).

tff(lmtp_f3900,type,(
    f3900: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3900,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3900(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3900,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3900(V0a),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V0a))) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__LE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3900(V0a)))) )).

tff(lmtp_f3901,type,(
    f3901: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3901,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3901(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3901,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3901(V0a),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__ge,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V0a))) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__GE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3901(V0a)))) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LOCAL,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                     ...
                     => ( ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V3s),V4t))),V3s))
                          & p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V3s),V4t))),V4t))
                       ...
                       => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3890(V1f,V0P,V2g)),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V3s),V4t))) ) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
