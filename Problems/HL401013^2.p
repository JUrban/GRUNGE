...
thf(ax_thm_2Earithmetic_2Efindq__def,axiom,
    ( c_2Earithmetic_2Efindq
    = ( ap
      @ ( ap @ ( c_2Erelation_2EWFREC @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ ty_2Enum_2Enum )
        @ ( ap @ ( c_2Eprim__rec_2Emeasure @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) )
          @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V0a: $i] :
                  ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V1m: $i] :
                        ( lam @ ty_2Enum_2Enum
                        @ ^ [V2n: $i] :
                            ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V1m ) @ V2n ) ) ) ) ) ) ) )
      @ ( lam @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ ty_2Enum_2Enum )
        @ ^ [V3f: $i] :
            ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V4a: $i] :
                  ...
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V5m: $i] :
                        ( lam @ ty_2Enum_2Enum
                        @ ^ [V6n: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V6n ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V4a )
                            @ ( ap
                              @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V7d: $i] :
                                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V5m ) @ V7d ) ) @ V4a ) @ ( ap @ V3f @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ V4a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ V5m ) @ V7d ) ) ) ) ) )
                              @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ V6n ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2Efindq__thm,conjecture,(
