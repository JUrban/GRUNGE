...
tff(f2445_0_2E0,type,(
    f2445_0_2E0: u )).

tff(f2445_0_2E2,type,(
    f2445_0_2E2: ( du * du ) > u )).
...
tff(arityeq2_2Ef2445_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2445_0_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)),s(tyop_2Elist_2Elist(A_27a),X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool)),f2445_0_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)))),s(tyop_2Elist_2Elist(A_27a),X1_2E0)))) )).
...
tff(thm_2Elist_2ELUPDATE__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0e_2E0: u,V1n_2E0: mono_2Etyop_2Enum_2Enum] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V0e_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1n_2E0)),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)
      & ! [V2e_2E0: u,V3x_2E0: u,V4l_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V2e_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V3x_2E0),s(tyop_2Elist_2Elist(A_27a),V4l_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V2e_2E0),s(tyop_2Elist_2Elist(A_27a),V4l_2E0)))
      & ! [V5e_2E0: u,V6n_2E0: mono_2Etyop_2Enum_2Enum,V7x_2E0: u,V8l_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V5e_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2ESUC_2E1(V6n_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V7x_2E0),s(tyop_2Elist_2Elist(A_27a),V8l_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V7x_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V5e_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V6n_2E0)),s(tyop_2Elist_2Elist(A_27a),V8l_2E0))))) ) )).
...
tff(def0_2Ethm_2Elist_2ELUPDATE__SNOC,axiom,(
    ! [A_27a: d,V1k_2E0: mono_2Etyop_2Enum_2Enum,V0ys_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2445_0_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1k_2E0)),s(tyop_2Elist_2Elist(A_27a),V0ys_2E0)))))
    <=> V1k_2E0 = j_mono_2Etyop_2Enum_2Enum(s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(A_27a),V0ys_2E0)))) ) )).

tff(thm_2Elist_2ELUPDATE__SNOC,conjecture,(
    ! [A_27a: d,V0ys_2E0: u,V1k_2E0: mono_2Etyop_2Enum_2Enum,V2x_2E0: u,V3y_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V2x_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1k_2E0)),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V3y_2E0),s(tyop_2Elist_2Elist(A_27a),V0ys_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f2445_0_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1k_2E0)),s(tyop_2Elist_2Elist(A_27a),V0ys_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V2x_2E0),s(tyop_2Elist_2Elist(A_27a),V0ys_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V3y_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ELUPDATE_2E3(s(A_27a,V2x_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1k_2E0)),s(tyop_2Elist_2Elist(A_27a),V0ys_2E0))))))) )).
