...
thf(thm_2Ewhile_2EOLEAST__INTRO,axiom,(
    ! [V0Q: mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 > $o,V1P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( ! [V2n: mono_2Etyop_2Enum_2Enum] :
              ( (~) @ ( V1P @ V2n ) )
         => ( V0Q @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) )
        & ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( ( ( V1P @ V3n )
              & ! [V4m: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Eprim__rec_2E_3C @ V4m @ V3n )
                 => ( (~) @ ( V1P @ V4m ) ) ) )
           => ( V0Q @ ( mono_2Ec_2Eoption_2ESOME_2Emono_2Etyop_2Enum_2Enum @ V3n ) ) ) )
     => ( V0Q @ ( mono_2Ec_2Ewhile_2EOLEAST @ V1P ) ) ) )).
...
thf(thm_2Ewhile_2EOLEAST__EQNS,conjecture,(
