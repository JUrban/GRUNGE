...
thf(f8898_0_2E0,type,(
    f8898_0_2E0: u )).

thf(f8898_0_2E1,type,(
    f8898_0_2E1: du > u )).

thf(f8898_1_2E0,type,(
    f8898_1_2E0: u )).

thf(f8898_1_2E3,type,(
    f8898_1_2E3: du > du > du > u )).

thf(f8898_2_2E0,type,(
    f8898_2_2E0: u )).

thf(f8898_2_2E3,type,(
...
thf(mono_2Ef8898_0,type,(
    mono_2Ef8898_0: mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef8898_1,type,(
    mono_2Ef8898_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef8898_2,type,(
    mono_2Ef8898_2: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal_2Eeq__ratl,axiom,(
    ! [V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8898_0 @ V1y )
    <=> ( V1y
        = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(def1_2Ethm_2Ereal_2Eeq__ratl,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal,V0z: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8898_1 @ V2x @ V1y @ V0z )
    <=> ( ( mono_2Ec_2Emarker_2Eunint_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2E_2F @ V2x @ V1y ) )
        = V0z ) ) )).

thf(def2_2Ethm_2Ereal_2Eeq__ratl,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal,V0z: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8898_2 @ V2x @ V1y @ V0z )
    <=> ( V2x
        = ( mono_2Ec_2Erealax_2Ereal__mul @ V1y @ V0z ) ) ) )).

thf(thm_2Ereal_2Eeq__ratl,conjecture,(
    ! [V0z: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal_2E_2F @ V2x @ V1y )
        = V0z )
    <=> ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef8898_0 @ V1y ) @ ( mono_2Ef8898_1 @ V2x @ V1y @ V0z ) @ ( mono_2Ef8898_2 @ V2x @ V1y @ V0z ) ) ) )).
