...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__IMP__OPEN__IN,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__SYM,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),V3t)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V0f),V1g)))
                  <=> p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V3t),V2s)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V1g),V0f))) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__LOCALLY,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1Q: $i] :
