...
fof(conj_thm_2Ereal_2ENUM__FLOOR__DIV,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
           ...
           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,V0x),V1y)))),V1y)),V0x)) ) ) ) )).
