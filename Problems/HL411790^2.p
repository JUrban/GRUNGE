...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__IFF__EVENTUALLY,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ( ? [V3N: tp__ty_2Enum_2Enum] :
                  ! [V4n: tp__ty_2Enum_2Enum] :
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
                      = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) )
