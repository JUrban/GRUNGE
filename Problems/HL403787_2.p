...
tff(lamtp_f1160,axiom,(
    ! [A_27a: del,V1h: $i] :
      ( mem(V1h,A_27a)
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => mem(f1160(A_27a,V1h,V2t),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))) ) ) )).

tff(lameq_f1160,axiom,(
    ! [A_27a: del,V1h: $i] :
      ( mem(V1h,A_27a)
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => ! [V3n: tp__ty_2Enum_2Enum] : ap(f1160(A_27a,V1h,V2t),inj__ty_2Enum_2Enum(V3n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Eoption_2ESOME(A_27a),V1h)),ap(V2t,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).

tff(conj_thm_2Ellist_2Elrep__ok__rules,conjecture,(
    ! [A_27a: del] :
      ...
      & ! [V1h: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(c_2Ellist_2Elrep__ok(A_27a),V2t))
               => p(ap(c_2Ellist_2Elrep__ok(A_27a),f1160(A_27a,V1h,V2t))) ) ) ) ) )).
