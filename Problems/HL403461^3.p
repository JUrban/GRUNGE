...
thf(thm_2EEncode_2Edatatype__tree,conjecture,(
    ! [A_27a: $tType,V0tree: ( A_27a > ( tyop_2Elist_2Elist @ ( tyop_2EEncode_2Etree @ A_27a ) ) > ( tyop_2EEncode_2Etree @ A_27a ) ) > $o] :
      ( c_2Ebool_2EDATATYPE @ $o @ ( V0tree @ ( c_2EEncode_2ENode @ A_27a ) ) ) )).
