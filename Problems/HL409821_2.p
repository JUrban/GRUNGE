...
tff(lameq_f3367,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3367(A_27a,V0f,V1s),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)),ap(V0f,V2x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__RESTRICT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3367(A_27a,V0f,V1s))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),V0f)) ) ) ) )).
