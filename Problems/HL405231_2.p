...
tff(tp_c_2ECoder_2Ebnum__coder,type,(
    c_2ECoder_2Ebnum__coder: $i )).

tff(mem_c_2ECoder_2Ebnum__coder,axiom,(
    mem(c_2ECoder_2Ebnum__coder,arr(ty_2Enum_2Enum,arr(arr(ty_2Enum_2Enum,bool),ty_2Epair_2Eprod(arr(ty_2Enum_2Enum,bool),arr(ty_2Enum_2Enum,bool))))) )).
...
tff(ax_thm_2ECoder_2Ebnum__coder__def,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,arr(ty_2Enum_2Enum,bool))
     => ap(ap(c_2ECoder_2Ebnum__coder,inj__ty_2Enum_2Enum(V0m)),V1p) = ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,bool),arr(ty_2Enum_2Enum,bool)),V1p),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool)),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))),ap(c_2EEncode_2Eencode__bnum,inj__ty_2Enum_2Enum(V0m))),ap(ap(c_2EDecode_2Edecode__bnum,inj__ty_2Enum_2Enum(V0m)),V1p))) ) )).

tff(conj_thm_2ECoder_2Ewf__coder__bnum,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,arr(ty_2Enum_2Enum,bool))
     => ( p(ap(ap(c_2EEncode_2Ewf__pred__bnum,inj__ty_2Enum_2Enum(V0m)),V1p))
       => p(ap(c_2ECoder_2Ewf__coder(ty_2Enum_2Enum),ap(ap(c_2ECoder_2Ebnum__coder,inj__ty_2Enum_2Enum(V0m)),V1p))) ) ) )).
