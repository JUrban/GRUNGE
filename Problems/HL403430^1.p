...
thf(f4645_0_2E0,type,(
    f4645_0_2E0: u )).

thf(f4645_0_2E1,type,(
    f4645_0_2E1: du > u )).

thf(f4645_0_2E2,type,(
    f4645_0_2E2: du > du > u )).

thf(f4645_1_2E0,type,(
    f4645_1_2E0: u )).

thf(f4645_1_2E1,type,(
    f4645_1_2E1: du > u )).

thf(f4645_1_2E2,type,(
    f4645_1_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4645_0_2E1_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( f4645_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) ) @ f4645_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4645_0_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27c @ ( f4645_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) ) @ f4645_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4645_1_2E1_2Emono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27b: d,A_27d: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( f4645_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) ) @ f4645_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4645_1_2E2_2Emono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27b: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27d @ ( f4645_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
      = ( s @ A_27d @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) ) @ f4645_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Etransfer_2EFUN__REL__ABS,axiom,(
    ! [A_27b: d,A_27d: d,V0g_2E0: u,V7b_2E0: u] :
      ( ( s @ A_27d @ ( f4645_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V0g_2E0 ) @ ( s @ A_27b @ V7b_2E0 ) ) )
      = ( s @ A_27d @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V0g_2E0 ) @ ( s @ A_27b @ V7b_2E0 ) ) ) ) )).

thf(def1_2Ethm_2Etransfer_2EFUN__REL__ABS,axiom,(
    ! [A_27a: d,A_27c: d,V1f_2E0: u,V6a_2E0: u] :
      ( ( s @ A_27c @ ( f4645_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ A_27a @ V6a_2E0 ) ) )
...
thf(thm_2Etransfer_2EFUN__REL__ABS,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0g_2E0: u,V1f_2E0: u,V2CD_2E0: u,V3AB_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2EFUN__REL_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3AB_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27d @ tyop_2Emin_2Ebool ) ) @ V2CD_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ ( f4645_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ ( f4645_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V0g_2E0 ) ) ) ) ) ) ) )).
