...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__COMPACT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f4087,type,(
    f4087: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4087,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal] : mem(f4087(V1s,V0f,V3y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f4087,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f4087(V1s,V0f,V3y),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),inj__ty_2Erealax_2Ereal(V3y)))) ) ) )).

tff(lmtp_f4088,type,(
    f4088: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4088,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal] : mem(f4088(V1s,V0f,V3y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f4088,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal,V7x: tp__ty_2Erealax_2Ereal] : ap(f4088(V1s,V0f,V3y),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),inj__ty_2Erealax_2Ereal(V3y)))) ) ) )).

tff(lmtp_f4089,type,(
    f4089: ( $i * $i * $i ) > $i )).

tff(lamtp_f4089,axiom,(
    ! [V5u: $i] :
...
tff(lameq_f4089,axiom,(
    ! [V5u: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V8k: $i] :
              ( mem(V8k,arr(ty_2Erealax_2Ereal,bool))
             => ! [V9x: tp__ty_2Erealax_2Ereal] : ap(f4089(V5u,V0f,V8k),inj__ty_2Erealax_2Ereal(V9x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9x)),V5u)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V9x))),V8k))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EMUMFORD__LEMMA,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
