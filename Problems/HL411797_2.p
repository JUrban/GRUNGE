...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__IMP__TOZERO,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: $i] :
          ( mem(V1k,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Esummable,V1k),V0f))
           => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4030(V0f,V1k)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ereal__topology_2Esequentially)) ) ) ) )).
