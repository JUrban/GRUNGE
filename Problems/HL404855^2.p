...
thf(conj_thm_2Efinite__map_2Efupdate__list__foldl,conjecture,(
                    ...
                    @ ^ [V2env: $i] :
                        ...
                        @ ( lam @ A_27a
                          @ ^ [V3k: $i] :
                              ( lam @ A_27b
                              @ ^ [V4v: $i] :
                                  ( ap @ ( ap @ ( c_2Efinite__map_2EFUPDATE @ A_27a @ A_27b ) @ V2env ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V3k ) @ V4v ) ) ) ) ) ) )
                @ V0m )
              @ V1l )
