...
tff(conj_thm_2Ereal__topology_2ESUBSET__BIGUNION,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EEXISTS__IN__INSERT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__BIGINTER,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( ! [V1s: $i] :
              ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
