...
thf(f13493_0_2E0,type,(
    f13493_0_2E0: u )).

thf(f13493_0_2E3,type,(
    f13493_0_2E3: du > du > du > u )).

thf(f13493_0_2E4,type,(
    f13493_0_2E4: du > du > du > du > u )).

thf(f13493_1_2E0,type,(
    f13493_1_2E0: u )).

thf(f13493_1_2E4,type,(
...
thf(mono_2Ef13493_0,type,(
    mono_2Ef13493_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13493_1,type,(
    mono_2Ef13493_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__CONSTANT,axiom,(
    ! [V3x: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o,V1f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13493_1 @ V3x @ V2s @ V1f @ V0a )
    <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3x @ V2s )
        & ( ( V1f @ V3x )
          = V0a ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__CONSTANT,axiom,(
    ! [V2s: mono_2Etyop_2Erealax_2Ereal > $o,V1f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13493_0 @ V2s @ V1f @ V0a @ V3x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V3x @ ( mono_2Ef13493_1 @ V3x @ V2s @ V1f @ V0a ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__CONSTANT,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ V1f @ V2s )
        & ( mono_2Ec_2Ereal__topology_2EClosed @ V2s ) )
     => ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13493_0 @ V2s @ V1f @ V0a ) ) ) ) )).
