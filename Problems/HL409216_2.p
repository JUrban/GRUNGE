...
tff(lamtp_f3205,axiom,(
    ! [V2D: $i] :
      ( mem(V2D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3205(V2D),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3205,axiom,(
    ! [V2D: $i] :
      ( mem(V2D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f3205(V2D),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V2D,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))),ap(V2D,inj__ty_2Enum_2Enum(V3n))) ) )).

tff(conj_thm_2Eintegral_2EDSIZE__EQ,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2D: $i] :
      ( mem(V2D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2D))
       => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Etransc_2Edsize,V2D))),f3205(V2D))),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1b)),inj__ty_2Erealax_2Ereal(V0a)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Eintegral_2EDINT__CONST,conjecture,(
