...
tff(f9994_0_2E0,type,(
    f9994_0_2E0: tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool) )).

tff(f9994_0_2E1,type,(
    f9994_0_2E1: tyop_2Emin_2Ebool > tyop_2Emin_2Ebool )).
...
tff(arityeq1_2Ef9994_0_2E1,axiom,(
    ! [X0_2E0: tyop_2Emin_2Ebool] : f9994_0_2E1(X0_2E0) = app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool,f9994_0_2E0,X0_2E0) )).
...
tff(def0_2Ethm_2EHolSmt_2Ed026,axiom,(
    ! [V0r_2E0: tyop_2Emin_2Ebool] :
      ( p(f9994_0_2E1(V0r_2E0))
    <=> ~ p(V0r_2E0) ) )).

tff(thm_2EHolSmt_2Ed026,conjecture,(
    ! [V0r_2E0: tyop_2Emin_2Ebool,V1q_2E0: tyop_2Emin_2Ebool,V2p_2E0: tyop_2Emin_2Ebool] :
      ( p(c_2Ebool_2ECOND_2E3(tyop_2Emin_2Ebool,V2p_2E0,V1q_2E0,f9994_0_2E1(V0r_2E0)))
      | p(V2p_2E0)
      | p(V0r_2E0) ) )).
