...
thf(conj_thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__GF,conjecture,(
    ! [V0a: $i] :
     ...
     => ! [V1t0: tp__ty_2Enum_2Enum,V2b: $i] :
         ...
         => ( ( ~ ! [V3t1: tp__ty_2Enum_2Enum] :
                  ? [V4t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V3t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V4t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
            ...
            & ( ( ! [V7t1: tp__ty_2Enum_2Enum] :
                  ? [V8t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V7t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V8t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
                | ! [V9t1: tp__ty_2Enum_2Enum] :
                  ? [V10t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V2b @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V10t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
            ...
            & ( ( ! [V13t1: tp__ty_2Enum_2Enum] :
                  ? [V14t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V13t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V14t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
                & ! [V15t1: tp__ty_2Enum_2Enum] :
                  ? [V16t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V2b @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V15t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V16t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
            <=> ? [V17q: $i] :
