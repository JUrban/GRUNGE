...
fof(lamtp_f758,axiom,(
    ! [A_27b,V2P] :
      ( mem(V2P,arr(A_27b,bool))
     => mem(f758(A_27b,V2P),arr(A_27b,bool)) ) )).
...
fof(lameq_f758,axiom,(
    ! [A_27b,V2P] :
     ...
     => ! [V4v2] :
          ( mem(V4v2,A_27b)
         => ap(f758(A_27b,V2P),V4v2) = ap(V2P,V4v2) ) ) )).

fof(conj_thm_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS__EXISTS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
