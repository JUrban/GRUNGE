...
fof(conj_thm_2Ereal_2Eeq__ratl,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal_2Eeq__ratr,conjecture,(
    ! [V0z] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ( V0z = ap(ap(c_2Ereal_2E_2F,V1x),V2y)
              <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V2y),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V0z),ap(c_2Emarker_2Eunint(ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2E_2F,V1x),V2y)))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V2y),V0z)),V1x))) ) ) ) ) )).
