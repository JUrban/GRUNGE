...
thf(thm_2Ebag_2ESUB__BAG__EMPTY,axiom,(
    ! [A_27a: $tType] :
      ( ! [V0b: A_27a > tyop_2Enum_2Enum] :
          ( c_2Ebag_2ESUB__BAG @ A_27a @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) @ V0b )
      & ! [V1b: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2ESUB__BAG @ A_27a @ V1b @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
        <=> ( V1b
...
thf(thm_2Ebag_2EFINITE__SUB__BAG,conjecture,(
