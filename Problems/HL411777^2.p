...
thf(conj_thm_2Ereal__topology_2EINFSUM__UNIQUE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2s: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ V2s ) )
           => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s ) @ V0f ) )
              = V1l ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESERIES__ADD,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2EINFSUM__ADD,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1y: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2s ) @ V0x ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal
                    @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3i: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V0x @ V3i ) ) @ ( ap @ V1y @ V3i ) ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s ) @ V0x ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s ) @ V1y ) ) ) ) ) ) ) ) )).
