...
thf(conj_thm_2Ewords_2EROL__MOD,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ewords_2Eword__rol @ A_27a ) @ V0w ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
          = ( ap @ ( ap @ ( c_2Ewords_2Eword__rol @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
