...
thf(f4074_0_2E0,type,(
    f4074_0_2E0: u )).

thf(f4074_0_2E1,type,(
    f4074_0_2E1: du > u )).

thf(f4074_0_2E2,type,(
    f4074_0_2E2: du > du > u )).
...
thf(c_2Efcp_2EFCP__TL_2E0,type,(
    c_2Efcp_2EFCP__TL_2E0: u )).

thf(c_2Efcp_2EFCP__TL_2E1,type,(
...
thf(arityeq1_2Emono_2Ef4074_0_2E1_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4074_0_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4074_0_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4074_0_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4074_0_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4074_0_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Efcp_2EFCP__TL_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP__TL_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) ) @ c_2Efcp_2EFCP__TL_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Efcp_2Efcp__index_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ c_2Efcp_2Efcp__index_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efcp_2EFCP__TL__def,axiom,(
    ! [A_27a: d,A_27c: d,V0v_2E0: u,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4074_0_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V0v_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) ) )
      = ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V0v_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1i ) ) ) ) ) ) )).

thf(thm_2Efcp_2EFCP__TL__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP__TL_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V0v_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4074_0_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V0v_2E0 ) ) ) ) ) ) )).

thf(thm_2Efcp_2EREAD__TL,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0i: mono_2Etyop_2Enum_2Enum,V1a_2E0: u] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0i @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27b ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
     => ( ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP__TL_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V1a_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) ) )
        = ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ V1a_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V0i ) ) ) ) ) ) ) )).
