...
fof(conj_thm_2Equotient__option_2EOPTION__REL__def,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Equotient__option_2EOPTION__QUOTIENT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0R] :
             ...
             => ! [V1abs] :
                 ...
                 => ! [V2rep] :
                      ( mem(V2rep,arr(A_27b,A_27a))
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => p(ap(ap(ap(c_2Equotient_2EQUOTIENT(ty_2Eoption_2Eoption(A_27a),ty_2Eoption_2Eoption(A_27a)),ap(c_2Eoption_2EOPTREL(A_27a,A_27a),V0R)),ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V1abs)),ap(c_2Eoption_2EOPTION__MAP(A_27b,A_27b),V2rep))) ) ) ) ) ) ) )).
