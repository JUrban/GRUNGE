...
fof(conj_thm_2Estring_2EIMPLODE__STRING,conjecture,(
    ! [V0clist] :
      ( mem(V0clist,ty_2Elist_2Elist(ty_2Estring_2Echar))
     => ap(c_2Estring_2EIMPLODE,V0clist) = ap(ap(ap(c_2Elist_2EFOLDR(ty_2Estring_2Echar,ty_2Estring_2Echar),c_2Elist_2ECONS(ty_2Estring_2Echar)),c_2Elist_2ENIL(ty_2Estring_2Echar)),V0clist) ) )).
