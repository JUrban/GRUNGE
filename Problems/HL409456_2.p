...
tff(conj_thm_2Efloat_2ECLOSEST__IN__SET,lemma,(
    ! [V0v: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V3s))
               => ( V3s != c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
                 => p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(ap(ap(c_2Eieee_2Eclosest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V1p),V3s),inj__ty_2Erealax_2Ereal(V2x))),V3s)) ) ) ) ) ) )).
...
tff(conj_thm_2Efloat_2EIS__FINITE__CLOSEST,conjecture,(
