...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__NEST,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
       ...
       => p(ap(c_2Ereal__topology_2Econnected,ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3820(V0s))))) ) ) )).
