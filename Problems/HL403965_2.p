...
tff(conj_thm_2Ellist_2ELNTH__LMAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(A_27a,A_27b))
     => ! [V2l: $i] :
          ( mem(V2l,ty_2Ellist_2Ellist(A_27a))
         => ap(ap(c_2Ellist_2ELNTH(A_27b),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Ellist_2ELMAP(A_27a,A_27a),V1f),V2l)) = ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V1f),ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V2l)) ) ) )).
