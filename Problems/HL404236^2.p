...
thf(conj_thm_2Elist_2EFILTER__ALL__DISTINCT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Erich__list_2EFILTER__EQ,lemma,(
    ! [A_27a: del,V0P1: $i] :
...
thf(conj_thm_2Eupdate_2ELIST__UPDATE__OVERRIDE,lemma,(
...
thf(conj_thm_2Eupdate_2ELIST__UPDATE__ALL__DISTINCT,lemma,(
...
thf(conj_thm_2Eupdate_2ELIST__UPDATE__SORT__OVERRIDE,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
