...
fof(conj_thm_2Elift__ieee_2Efloat__add__relative,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Elift__machine__ieee_2Efp64__float__add__relative,conjecture,(
    ! [V0a] :
