...
tff(lamtp_f3825,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3825(A_27a,V0f,V1g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3825,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3825(A_27a,V0f,V1g),V3x) = ap(ap(c_2Ereal_2Emax,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MAX,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2net: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V0f),V2net))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3825(A_27a,V0f,V1g)),V2net)) ) ) ) ) )).
