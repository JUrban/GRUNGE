...
fof(lamtp_f2398,axiom,(
    ! [V0R] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => mem(f2398(V0R),arr(ty_2Enum_2Enum,bool)) ) )).

fof(lameq_f2398,axiom,(
    ! [V0R] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f2398(V0R),V1n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1n),c_2Enum_2E0))),ap(ap(V0R,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),V1n)) ) ) )).

fof(lamtp_f2397,axiom,(
    mem(f2397,arr(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)),bool)) )).

fof(lameq_f2397,axiom,(
    ! [V0R] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ap(f2397,V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(ty_2Enum_2Enum),V0R)),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2398(V0R))) ) )).

fof(lamtp_f2400,axiom,(
    ! [V2lrnext] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f2400(V2lrnext),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

fof(lameq_f2400,axiom,(
    ! [V2lrnext] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V3a] :
          ( mem(V3a,ty_2Enum_2Enum)
         => ap(f2400(V2lrnext),V3a) = ap(c_2Ecombin_2EI(ty_2Enum_2Enum),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V3a),c_2Enum_2E0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),ap(V2lrnext,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V3a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))))))) ) ) )).

fof(lamtp_f2399,axiom,(
    mem(f2399,arr(arr(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

fof(lameq_f2399,axiom,(
    ! [V2lrnext] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(f2399,V2lrnext) = f2400(V2lrnext) ) )).

fof(ax_thm_2Esptree_2Elrnext__primitive__def,axiom,(
...
fof(conj_thm_2Esptree_2Elrnext__def,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Esptree_2Elrnext,V0n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0n),c_2Enum_2E0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),ap(c_2Esptree_2Elrnext,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))))) ) )).
