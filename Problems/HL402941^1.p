...
thf(f3495_0_2E0,type,(
    f3495_0_2E0: u )).

thf(f3495_0_2E3,type,(
    f3495_0_2E3: du > du > du > u )).

thf(f3495_0_2E4,type,(
    f3495_0_2E4: du > du > du > du > u )).
...
thf(arityeq3_2Emono_2Ef3495_0_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f3495_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) ) @ f3495_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) @ ( s @ A_27c @ X2_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef3495_0_2E4_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3495_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) @ ( s @ A_27b @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) ) @ f3495_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) @ ( s @ A_27c @ X2_2E0 ) ) ) @ ( s @ A_27b @ X3_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2ECONS_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27c_2Ctyop_2Eoption_2Eoption_28A_27a_29_29,axiom,(
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
...
thf(thm_2EpatternMatches_2EPMATCH__ROW__EQ__NONE,axiom,(
    ...
    <=> ! [V4x_2E0: u] :
          ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EpatternMatches_2EPMATCH__ROW__COND_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V1p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V3g_2E0 ) @ ( s @ A_27c @ V2i_2E0 ) @ ( s @ A_27b @ V4x_2E0 ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__EVAL__MATCH,axiom,(
    ! [A_27b: d,A_27c: d,V3p_2E0: u,V4g_2E0: u,V0v_2E0: u,V5x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3495_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V3p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V4g_2E0 ) @ ( s @ A_27c @ V0v_2E0 ) @ ( s @ A_27b @ V5x_2E0 ) ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__EVAL__MATCH,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u,V1rs_2E0: u,V2r_2E0: u,V3p_2E0: u,V4g_2E0: u] :
      ( ( (~)
     ...
     => ( ( s @ A_27a @ ( c_2EpatternMatches_2EPMATCH_2E2 @ ( s @ A_27c @ V0v_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( c_2EpatternMatches_2EPMATCH__ROW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V3p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V4g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2r_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ V1rs_2E0 ) ) ) ) )
        = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2r_2E0 ) @ ( s @ A_27b @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f3495_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V3p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V4g_2E0 ) @ ( s @ A_27c @ V0v_2E0 ) ) ) ) ) ) ) ) ) )).
