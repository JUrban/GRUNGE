...
thf(conj_thm_2Elim_2ELIM__INV,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2ELIM__TRANSFORM,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
                  ...
                  @ ( ap
                    @ ( ap
                      @ ( ap @ c_2Elim_2Etends__real__real
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V4x ) ) @ ( ap @ V1g @ V4x ) ) ) )
...
thf(conj_thm_2Elim_2EDIFF__CARAT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( ap @ c_2Elim_2Ediffl @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) )
...
thf(conj_thm_2Elim_2ECONT__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2ECONT__INJ__RANGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2ECONT__INVERSE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2EDIFF__INVERSE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
