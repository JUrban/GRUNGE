...
fof(conj_thm_2Elist_2ELENGTH__DROP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
     ...
     => ! [V0c] :
         ...
         => ! [V1n] :
             ...
             => ! [V2s] :
                 ...
                 => ap(ap(ap(c_2Elist_2EPAD__LEFT(A_27a),V0c),V1n),V2s) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V0c)),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V2s)))),V2s) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2EEL__DROP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1n] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2E_2B,V0m),V1n)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(ap(c_2Elist_2EEL(A_27a),V0m),ap(ap(c_2Elist_2EDROP(A_27a),V1n),V2l)) = ap(ap(c_2Elist_2EEL(A_27a),ap(ap(c_2Earithmetic_2E_2B,V0m),V1n)),V2l) ) ) ) ) ) )).
...
fof(mem_c_2Ebitstring_2Ew2v,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ebitstring_2Ew2v(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Elist_2Elist(bool))) ) )).
...
fof(ax_thm_2Ebitstring_2Ew2v__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ebitstring_2Ew2v(A_27a),V0w) = ap(ap(c_2Elist_2EGENLIST(bool),f2184(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))) ) ) )).
...
fof(conj_thm_2Ebitstring_2Ew2v__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
