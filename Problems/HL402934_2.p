...
tff(conj_thm_2EpatternMatches_2EPMATCH__CONG,conjecture,(
                 ...
                 => ! [V4r: $i] :
                     ...
                     => ! [V5r_27: $i] :
                         ...
                         => ( ( V0v = V1v_27
                              ...
                              & ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V1v_27),V2rows) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V1v_27),V3rows_27) )
                           => ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V4r),V2rows)) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V1v_27),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V5r_27),V3rows_27)) ) ) ) ) ) ) ) )).
