...
fof(conj_thm_2Ecomplex_2ECOMPLEX__SCALAR__LMUL__NEG,lemma,(
    ! [V0k] :
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__NEG__SCALAR__LMUL,lemma,(
    ! [V0k] :
      ( mem(V0k,ty_2Erealax_2Ereal)
     => ! [V1z] :
          ( mem(V1z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__ADD__SCALAR__LMUL,lemma,(
    ! [V0k] :
      ( mem(V0k,ty_2Erealax_2Ereal)
     => ! [V1z] :
          ( mem(V1z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__SUB__SCALAR__LMUL,conjecture,(
    ! [V0k] :
      ( mem(V0k,ty_2Erealax_2Ereal)
     => ! [V1z] :
          ( mem(V1z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
