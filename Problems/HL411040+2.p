...
fof(conj_thm_2Ereal__topology_2EMONOTONE__SUBSEQUENCE,lemma,(
    ! [V0s] :
          ...
          & ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2m),V3n))
                   => p(ap(ap(c_2Eprim__rec_2E_3C,ap(V1r,V2m)),ap(V1r,V3n))) ) ) )
          & ( ! [V4m] :
                ( mem(V4m,ty_2Enum_2Enum)
               => ! [V5n] :
                    ( mem(V5n,ty_2Enum_2Enum)
                   => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V4m),V5n))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,ap(V1r,V4m))),ap(V0s,ap(V1r,V5n)))) ) ) )
            | ! [V6m] :
                ( mem(V6m,ty_2Enum_2Enum)
               => ! [V7n] :
                    ( mem(V7n,ty_2Enum_2Enum)
                   => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V6m),V7n))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,ap(V1r,V7n))),ap(V0s,ap(V1r,V6m)))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
