...
thf(conj_thm_2Ebag_2EITBAG__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1acc: $i] :
          ( ( mem @ V1acc @ A_27b )
         => ( ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ A_27b ) @ V0f ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) @ V1acc )
            = V1acc ) ) ) )).

thf(ax_thm_2Ebag_2EBAG__GEN__PROD__def,axiom,(
    ! [V0bag: $i] :
      ( ( mem @ V0bag @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ V0bag ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ c_2Earithmetic_2E_2A ) @ V0bag ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__GEN__PROD__EMPTY,conjecture,(
