...
fof(lamtp_f3391,axiom,(
    ! [V1m] :
      ( mem(V1m,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f3391(V1m,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3391,axiom,(
    ! [V1m] :
      ( mem(V1m,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3i] :
             ...
             => ap(f3391(V1m,V0f),V3i) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,V3i),V1m)) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__OFFSET__0,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2n] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V2n))
               => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)),V0f) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,V2n),V1m))),f3391(V1m,V0f)) ) ) ) ) )).

fof(lamtp_f3406,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3406(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3406,axiom,(
    ! [V0x] :
     ...
     => ! [V2i] :
         ...
         => ap(f3406(V0x),V2i) = ap(ap(c_2Ereal_2Epow,V0x),V2i) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUM__GP__BASIC,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0x)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V1n)),f3406(V0x))) = ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Ereal_2Epow,V0x),ap(c_2Enum_2ESUC,V1n))) ) ) )).

fof(lamtp_f3626,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3626(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3626,axiom,(
    ! [V0x] :
     ...
     => ! [V3i] :
          ( mem(V3i,ty_2Enum_2Enum)
         => ap(f3626(V0x),V3i) = ap(ap(c_2Ereal_2Epow,V0x),V3i) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUM__GP__MULTIPLIED,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V2n))
               => ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0x)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)),f3626(V0x))) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal_2Epow,V0x),V1m)),ap(ap(c_2Ereal_2Epow,V0x),ap(c_2Enum_2ESUC,V2n))) ) ) ) ) )).
