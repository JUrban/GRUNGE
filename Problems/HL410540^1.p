...
thf(thm_2Ereal__topology_2EDIM__SUBSET,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Ereal__topology_2Edim @ V0s ) @ ( mono_2Ec_2Ereal__topology_2Edim @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2EDIM__SUBSET__UNIV,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Ereal__topology_2Edim @ V0s ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )).
