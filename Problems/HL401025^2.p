...
thf(conj_thm_2Earithmetic_2EMODEQ__THM,lemma,(
    ...
    <=> ( ( ( V0n = fo__c_2Enum_2E0 )
          & ( V1m1 = V2m2 ) )
        | ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1m1 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V2m2 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2EMODEQ__PLUS__CONG,conjecture,(
