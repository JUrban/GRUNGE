...
tff(tp_c_2Ereal_2ENUM__FLOOR,type,(
    c_2Ereal_2ENUM__FLOOR: $i )).

tff(mem_c_2Ereal_2ENUM__FLOOR,axiom,(
    mem(c_2Ereal_2ENUM__FLOOR,arr(ty_2Erealax_2Ereal,ty_2Enum_2Enum)) )).

tff(stp_fo_c_2Ereal_2ENUM__FLOOR,type,(
    fo__c_2Ereal_2ENUM__FLOOR: tp__ty_2Erealax_2Ereal > tp__ty_2Enum_2Enum )).

tff(stp_eq_fo_c_2Ereal_2ENUM__FLOOR,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] : inj__ty_2Enum_2Enum(fo__c_2Ereal_2ENUM__FLOOR(X0)) = ap(c_2Ereal_2ENUM__FLOOR,inj__ty_2Erealax_2Ereal(X0)) )).
...
tff(conj_thm_2Ereal_2EREAL__NEG__LE0,lemma,(
...
tff(lmtp_f2748,type,(
    f2748: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2748,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2748(V0x),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2748,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2748(V0x),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ereal_2Ereal__gt,ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0x)) )).

tff(ax_thm_2Ereal_2ENUM__FLOOR__def,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Enum_2Enum(ap(c_2Ewhile_2ELEAST,f2748(V0x))) )).

tff(conj_thm_2Ereal_2ENUM__FLOOR__BASE,lemma,(
    ! [V0r: tp__ty_2Erealax_2Ereal] :
     ...
     => surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,inj__ty_2Erealax_2Ereal(V0r))) = fo__c_2Enum_2E0 ) )).

tff(conj_thm_2Ereal_2ENUM__FLOOR__EQNS,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n)))) = V0n
      & surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n))))) = fo__c_2Enum_2E0
      & ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1m)))
       => surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1m))))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EDIV,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m))) )
      & ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1m)))
       => surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n)))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1m))))) = fo__c_2Enum_2E0 ) ) )).
