...
thf(conj_thm_2Einteger__word_2EINT__ZERO__LT__UINT__MAX,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Einteger__word_2EUINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )).

thf(conj_thm_2Einteger__word_2Ew2i__UINT__MAXw,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Einteger__word_2Ew2i__minus__1,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Einteger__word_2Ei2w__UINT__MAX,conjecture,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ ( c_2Einteger__word_2EUINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
      = ( c_2Ewords_2Eword__T @ A_27a ) ) )).
