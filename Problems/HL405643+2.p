...
fof(conj_thm_2Ecardinal_2EINFINITE__UNIV__INF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ~ p(ap(c_2Epred__set_2EFINITE(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).
...
fof(conj_thm_2Eordinal_2Edclose__cardleq__univinf,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
