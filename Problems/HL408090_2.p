...
tff(conj_thm_2Elim_2ELIM__SUB,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3m: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Elim_2Etends__real__real,f2900(V0f,V1g)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V2l)),inj__ty_2Erealax_2Ereal(V3m))),inj__ty_2Erealax_2Ereal(V4x))) ) ) ) )).
...
tff(conj_thm_2Elim_2ECONT__SUB,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
