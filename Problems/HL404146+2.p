...
fof(conj_thm_2Epath_2Efinite__thm,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f1686,axiom,(
    ! [A_27a,A_27b,V0p] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => mem(f1686(A_27a,A_27b,V0p),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).
...
fof(lameq_f1686,axiom,(
    ! [A_27a,A_27b,V0p] :
     ...
     => ! [V1i] :
         ...
         => ap(f1686(A_27a,A_27b,V0p),V1i) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1i),ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Epath_2Efinite(A_27a,A_27a),V0p)),ap(ap(c_2Eprim__rec_2E_3C,V1i),ap(c_2Eoption_2ETHE(ty_2Enum_2Enum),ap(c_2Epath_2Elength(A_27a,A_27a),V0p))))) ) ) )).
...
fof(ax_thm_2Epath_2EPL__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0p] :
              ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
             => ap(c_2Epath_2EPL(A_27a,A_27a),V0p) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1686(A_27a,A_27b,V0p)) ) ) ) )).

fof(conj_thm_2Epath_2EPL__pcons,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ! [V1r] :
                 ...
                 => ! [V2q] :
                     ...
                     => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V0x),V1r),V2q)) = ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),c_2Enum_2E0),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2ESUC),ap(c_2Epath_2EPL(A_27a,A_27a),V2q))) ) ) ) ) ) )).
