...
thf(conj_thm_2Estring_2ECHR__ONTO,lemma,(
...
thf(conj_thm_2Estring_2ECHAR__INDUCT__THM,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ! [V1n: tp__ty_2Enum_2Enum] :
       ...
       => ! [V2c: tp__ty_2Estring_2Echar] :
            ( p @ ( ap @ V0P @ ( inj__ty_2Estring_2Echar @ V2c ) ) ) ) ) )).
