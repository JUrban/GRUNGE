...
thf(c_2EConseqConv_2EASM__MARKER_2E0,type,(
    c_2EConseqConv_2EASM__MARKER_2E0: u )).

thf(c_2EConseqConv_2EASM__MARKER_2E2,type,(
    c_2EConseqConv_2EASM__MARKER_2E2: du > du > u )).
...
thf(mono_2Ec_2EConseqConv_2EASM__MARKER,type,(
    mono_2Ec_2EConseqConv_2EASM__MARKER: $o > $o > $o )).
...
thf(thm_2EConseqConv_2EASM__MARKER__DEF,axiom,(
    ! [V0x: $o,V1x_27: $o] :
      ( ( mono_2Ec_2EConseqConv_2EASM__MARKER @ V0x @ V1x_27 )
      = V1x_27 ) )).
...
thf(thm_2EConseqConv_2EASM__MARKER__THM,conjecture,(
    ! [V0y: $o,V1x: $o] :
      ( ( mono_2Ec_2EConseqConv_2EASM__MARKER @ V0y @ V1x )
      = V1x ) )).
