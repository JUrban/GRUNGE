...
tff(lmtp_f3802,type,(
    f3802: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3802,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3802(V0a),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f3802,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f3802(V0a),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Erealax_2Einv,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1n))),inj__ty_2Erealax_2Ereal(V0a))) )).

tff(conj_thm_2Ereal__topology_2ESEQ__HARMONIC__OFFSET,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f3802(V0a)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ereal__topology_2Esequentially)) )).

tff(lmtp_f3803,type,(
    f3803: $i )).

tff(lamtp_f3803,axiom,(
    mem(f3803,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f3803,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : ap(f3803,inj__ty_2Enum_2Enum(V0n)) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n))) )).

tff(conj_thm_2Ereal__topology_2ESEQ__HARMONIC,conjecture,(
    p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f3803),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ereal__topology_2Esequentially)) )).
