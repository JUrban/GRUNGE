...
thf(conj_thm_2Estring_2EEXPLODE__11,lemma,(
...
thf(conj_thm_2Estring_2EEXPLODE__DEST__STRING,conjecture,(
            ...
            @ ^ [V1v: $i] :
                ...
                @ ( lam @ ty_2Estring_2Echar
                  @ ^ [V2c: $i] :
                      ...
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ ( c_2Elist_2ECONS @ ty_2Estring_2Echar ) @ V2c ) @ ( ap @ c_2Estring_2EEXPLODE @ V3t ) ) ) ) ) ) ) ) ) )).
