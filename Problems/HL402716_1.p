...
tff(c_2Erich__list_2EELL_2E0,type,(
    c_2Erich__list_2EELL_2E0: u )).

tff(c_2Erich__list_2EELL_2E2,type,(
...
tff(c_2Erich__list_2ESEG_2E0,type,(
    c_2Erich__list_2ESEG_2E0: u )).

tff(c_2Erich__list_2ESEG_2E3,type,(
...
tff(arityeq2_2Ec_2Erich__list_2EELL_2E2,axiom,(
    ! [A_27a: d,X0_2E0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] : s(A_27a,c_2Erich__list_2EELL_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27a)),c_2Erich__list_2EELL_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)))),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) )).

tff(arityeq1_2Ec_2Elist_2EFRONT_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFRONT_2E1(s(tyop_2Elist_2Elist(A_27a),X0_2E0))) = s(tyop_2Elist_2Elist(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a)),c_2Elist_2EFRONT_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0))) )).
...
tff(arityeq3_2Ec_2Erich__list_2ESEG_2E3,axiom,(
    ! [A_27a: d,X0_2E0: mono_2Etyop_2Enum_2Enum,X1_2E0: mono_2Etyop_2Enum_2Enum,X2_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2ESEG_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X1_2E0)),s(tyop_2Elist_2Elist(A_27a),X2_2E0))) = s(tyop_2Elist_2Elist(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a)))),c_2Erich__list_2ESEG_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)))),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X1_2E0)))),s(tyop_2Elist_2Elist(A_27a),X2_2E0))) )).
...
tff(thm_2Earithmetic_2ESUB__LESS__0,axiom,(
    ! [V0n_2E0: mono_2Etyop_2Enum_2Enum,V1m_2E0: mono_2Etyop_2Enum_2Enum] : mono_2Ec_2Eprim__rec_2E_3C_2E2(V1m_2E0,V0n_2E0) = mono_2Ec_2Eprim__rec_2E_3C_2E2(mono_2Ec_2Enum_2E0_2E0,mono_2Ec_2Earithmetic_2E_2D_2E2(V0n_2E0,V1m_2E0)) )).

tff(thm_2Earithmetic_2ESUC__PRE,axiom,(
    ! [V0m_2E0: mono_2Etyop_2Enum_2Enum] :
      ( p(mono_2Ec_2Eprim__rec_2E_3C_2E2(mono_2Ec_2Enum_2E0_2E0,V0m_2E0))
    <=> mono_2Ec_2Enum_2ESUC_2E1(mono_2Ec_2Eprim__rec_2EPRE_2E1(V0m_2E0)) = V0m_2E0 ) )).
...
tff(thm_2Elist_2ELAST__SNOC,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1l_2E0: u] : s(A_27a,c_2Elist_2ELAST_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V0x_2E0),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))))) = s(A_27a,V0x_2E0) )).

tff(thm_2Elist_2EFRONT__SNOC,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1l_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFRONT_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V0x_2E0),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))))) = s(tyop_2Elist_2Elist(A_27a),V1l_2E0) )).
...
tff(thm_2Erich__list_2EELL,axiom,(
    ! [A_27a: d] :
      ( ! [V0l_2E0: u] : s(A_27a,c_2Erich__list_2EELL_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)),s(tyop_2Elist_2Elist(A_27a),V0l_2E0))) = s(A_27a,c_2Elist_2ELAST_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0)))
      & ! [V1n_2E0: mono_2Etyop_2Enum_2Enum,V2l_2E0: u] : s(A_27a,c_2Erich__list_2EELL_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2ESUC_2E1(V1n_2E0))),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))) = s(A_27a,c_2Erich__list_2EELL_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1n_2E0)),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFRONT_2E1(s(tyop_2Elist_2Elist(A_27a),V2l_2E0))))) ) )).

tff(thm_2Erich__list_2ESEG__LENGTH__SNOC,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1x_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2ESEG_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Earithmetic_2ENUMERAL_2E1(mono_2Ec_2Earithmetic_2EBIT1_2E1(mono_2Ec_2Earithmetic_2EZERO_2E0)))),s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V1x_2E0),s(tyop_2Elist_2Elist(A_27a),V0l_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V1x_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))) )).

tff(thm_2Erich__list_2ESEG__SNOC,axiom,(
    ! [A_27a: d,V0n_2E0: mono_2Etyop_2Enum_2Enum,V1m_2E0: mono_2Etyop_2Enum_2Enum,V2l_2E0: u] :
     ...
     => ! [V3x_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2ESEG_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1m_2E0)),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V3x_2E0),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2ESEG_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1m_2E0)),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))) ) )).

tff(thm_2Erich__list_2EELL__SEG,conjecture,(
    ! [A_27a: d,V0n_2E0: mono_2Etyop_2Enum_2Enum,V1l_2E0: u] :
     ...
     => s(A_27a,c_2Erich__list_2EELL_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))) = s(A_27a,c_2Elist_2EHD_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Erich__list_2ESEG_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Earithmetic_2ENUMERAL_2E1(mono_2Ec_2Earithmetic_2EBIT1_2E1(mono_2Ec_2Earithmetic_2EZERO_2E0)))),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Eprim__rec_2EPRE_2E1(mono_2Ec_2Earithmetic_2E_2D_2E2(j_mono_2Etyop_2Enum_2Enum(s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(A_27a),V1l_2E0)))),V0n_2E0)))),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))))) ) )).
