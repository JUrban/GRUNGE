...
thf(f11779_0_2E0,type,(
    f11779_0_2E0: u )).

thf(f11779_0_2E1,type,(
    f11779_0_2E1: du > u )).
...
thf(mono_2Ef11779_0,type,(
    mono_2Ef11779_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ID,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11779_0 @ V0x )
      = V0x ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ID,conjecture,(
    mono_2Ec_2Eiterate_2Epolynomial__function @ mono_2Ef11779_0 )).
