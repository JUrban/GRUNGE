...
thf(conj_thm_2Ewords_2Eword__join__word__T,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ( ap @ ( ap @ ( c_2Ewords_2Eword__join @ A_27a @ A_27b ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
      = ( ap @ ( c_2Ewords_2Eword__2comp @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ ( c_2Ewords_2En2w @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Eword__concat__word__T,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del] :
      ( ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27a @ A_27b @ A_27c ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
      = ( ap @ ( c_2Ewords_2Ew2w @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) @ A_27c ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ ( c_2Ewords_2En2w @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).
