...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER__CBALLS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact ) @ V0s ) )
      <=> ! [V1x: tp__ty_2Erealax_2Ereal] :
           ...
           => ? [V2e: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V3d: tp__ty_2Erealax_2Ereal] :
                    ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) )
                   => ( p @ ( ap @ c_2Ereal__topology_2EClosed @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Ecball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) ) @ V0s ) ) ) ) ) ) ) ) )).
