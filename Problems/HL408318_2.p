...
tff(conj_thm_2Etransc_2ESIN__POS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )
...
tff(conj_thm_2Etransc_2ECOS__2,lemma,(
    p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Etransc_2Ecos,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) )).

tff(lmtp_f2986,type,(
    f2986: $i )).

tff(lamtp_f2986,axiom,(
    mem(f2986,arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2986,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f2986,inj__ty_2Erealax_2Ereal(V0x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) )).

tff(conj_thm_2Etransc_2ECOS__ISZERO,conjecture,(
    p(ap(c_2Ebool_2E_3F_21(ty_2Erealax_2Ereal),f2986)) )).
