...
fof(lamtp_f3712,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3712(V0s),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

fof(lameq_f3712,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3712(V0s),V1t) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1t),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2EOpen,V1t)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1t),V0s))) ) ) )).

fof(conj_thm_2Ereal__topology_2EINTERIOR__UNIONS__OPEN__SUBSETS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3712(V0s))) = ap(c_2Ereal__topology_2Einterior,V0s) ) )).
