...
thf(conj_thm_2Erich__list_2EFOLDR__CONS__NIL,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ECONS @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ V0l )
        = V0l ) ) )).
