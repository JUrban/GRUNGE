...
tff(lmtp_f3001,type,(
    f3001: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3001,axiom,(
    ! [V0diff: $i] :
      ( mem(V0diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : mem(f3001(V0diff,V2x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3001,axiom,(
    ! [V0diff: $i] :
      ( mem(V0diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2x: tp__ty_2Erealax_2Ereal,V3m: tp__ty_2Enum_2Enum] : ap(f3001(V0diff,V2x),inj__ty_2Enum_2Enum(V3m)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V0diff,inj__ty_2Enum_2Enum(V3m)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,inj__ty_2Enum_2Enum(V3m))))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Enum_2Enum(V3m))) ) )).

tff(conj_thm_2Etransc_2EMCLAURIN__ZERO,lemma,(
    ! [V0diff: $i] :
      ( mem(V0diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: tp__ty_2Erealax_2Ereal] :
          ( ( V2x = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
            & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1n))) )
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1n))),f3001(V0diff,V2x))) = surj__ty_2Erealax_2Ereal(ap(ap(V0diff,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).

tff(conj_thm_2Etransc_2EMCLAURIN__ALL__LE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1diff: $i] :
          ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
