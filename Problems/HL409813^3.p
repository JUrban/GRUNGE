...
thf(thm_2Eiterate_2ESUM__DELETE__CASES,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o,V2a: A_27a] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
     => ( ( c_2Eiterate_2ESum @ A_27a @ ( c_2Epred__set_2EDELETE @ A_27a @ V1s @ V2a ) @ V0f )
        = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ A_27a @ V2a @ V1s ) @ ( c_2Ereal_2Ereal__sub @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) @ ( V0f @ V2a ) ) @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) ) ) ) )).
