...
tff(conj_thm_2Erelation_2EWF__TC__EQN,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Ebag_2ETC__mlt1__UNION2__I,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2Emlt__UNION__CANCEL__EQN,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1b1: $i] :
          ( mem(V1b1,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2Emlt__UNION__EMPTY__EQN,conjecture,(
    $true )).
