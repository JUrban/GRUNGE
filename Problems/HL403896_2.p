...
tff(conj_thm_2Earithmetic_2EFUNPOW__ADD,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(lamtp_f1212,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f1212(A_27a,A_27a),arr(ty_2Eoption_2Eoption(ty_2Ellist_2Ellist(A_27a)),ty_2Eoption_2Eoption(ty_2Ellist_2Ellist(A_27a)))) )).

tff(lameq_f1212,axiom,(
    ! [A_27a: del,A_27a: del,V2m: $i] :
...
tff(conj_thm_2Ellist_2ELDROP__FUNPOW,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(ap(ap(c_2Earithmetic_2EFUNPOW(ty_2Eoption_2Eoption(ty_2Ellist_2Ellist(A_27a))),f1212(A_27a,A_27a)),inj__ty_2Enum_2Enum(V0n)),ap(c_2Eoption_2ESOME(ty_2Ellist_2Ellist(A_27a)),V1ll)) ) )).

tff(lmtp_f1213,type,(
    f1213: ( del * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1213,axiom,(
    ! [A_27a: del,V1k2: tp__ty_2Enum_2Enum] : mem(f1213(A_27a,V1k2),arr(ty_2Ellist_2Ellist(A_27a),ty_2Eoption_2Eoption(ty_2Ellist_2Ellist(A_27a)))) )).

tff(lameq_f1213,axiom,(
    ! [A_27a: del,V1k2: tp__ty_2Enum_2Enum,V3ll: $i] :
      ( mem(V3ll,ty_2Ellist_2Ellist(A_27a))
     => ap(f1213(A_27a,V1k2),V3ll) = ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V1k2)),V3ll) ) )).

tff(conj_thm_2Ellist_2ELDROP__ADD,conjecture,(
    ! [A_27a: del,V0k1: tp__ty_2Enum_2Enum,V1k2: tp__ty_2Enum_2Enum,V2x: $i] :
      ( mem(V2x,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELDROP(A_27a),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0k1)),inj__ty_2Enum_2Enum(V1k2))),V2x) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Ellist_2Ellist(A_27a),ty_2Ellist_2Ellist(A_27a)),ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0k1)),V2x)),c_2Eoption_2ENONE(ty_2Ellist_2Ellist(A_27a))),f1213(A_27a,V1k2)) ) )).
