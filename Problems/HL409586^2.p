...
thf(tp_c_2Eiterate_2EFINREC,type,(
    c_2Eiterate_2EFINREC: del > del > $i )).

thf(mem_c_2Eiterate_2EFINREC,axiom,(
    ! [A_27a: del,A_27b: del] :
...
thf(ax_thm_2Eiterate_2EFINREC__def,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
...
thf(conj_thm_2Eiterate_2EFINREC__SUC__LEMMA,lemma,(
...
thf(conj_thm_2Eiterate_2EFINREC__UNIQUE__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ A_27b )
...
thf(conj_thm_2Eiterate_2EFINREC__EXISTS__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ A_27b )
             ...
             => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V2s ) )
               => ? [V3a: $i] :
                    ...
                    & ? [V4n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2EFINREC @ A_27a @ A_27b ) @ V0f ) @ V1b ) @ V2s ) @ V3a ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2EFINREC__FUN__LEMMA,lemma,(
...
thf(conj_thm_2Eiterate_2EFINREC__FUN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ A_27b )
