...
fof(conj_thm_2Efinite__map_2ESUBMAP__FUNION__ABSORPTION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EDRESTRICT__FUNION__SUBSET,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s2] :
             ...
             => ! [V1s1] :
                 ...
                 => ! [V2f] :
                     ...
                     => ! [V3g] :
                          ( mem(V3g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                         => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V0s2),V1s1))
                           => ? [V4h] :
                                ( mem(V4h,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                                & ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V2f),V1s1)),V3g) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V2f),V0s2)),V4h) ) ) ) ) ) ) ) ) )).
