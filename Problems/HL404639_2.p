...
tff(conj_thm_2Efinite__map_2EFM__PULL__APART,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1k: $i] :
          ( mem(V1k,A_27a)
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1k),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm)))
           => ? [V2fm0: $i] :
                ( mem(V2fm0,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                & ? [V3v: $i] :
                    ( mem(V3v,A_27b)
                    & V0fm = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2fm0),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V3v))
                    & ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1k),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2fm0))) ) ) ) ) ) )).
