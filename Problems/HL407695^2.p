...
thf(conj_thm_2Efrac_2EFRAC__AINV__SAVE,conjecture,(
    ! [V0a1: tp__ty_2Einteger_2Eint,V1b1: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__ainv @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ V0a1 ) ) @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) )
      = ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( ap @ c_2Einteger_2Eint__neg @ ( inj__ty_2Einteger_2Eint @ V0a1 ) ) ) @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) ) )).
