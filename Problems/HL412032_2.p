...
tff(conj_thm_2Elebesgue_2Eintegrable__plus__minus,lemma,(
    ! [A_27a: del,V0m: $i] :
...
tff(conj_thm_2Elebesgue_2Eintegrable__add__pos,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2g: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  ...
                  & ! [V4x: $i] :
                      ( mem(V4x,A_27a)
                     => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V2g,V4x))) ) )
               => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4126(A_27a,V1f,V2g))) ) ) ) ) )).

tff(lmtp_f4195,type,(
    f4195: ( del * $i * $i ) > $i )).

tff(lamtp_f4195,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Eintegrable__add__lemma,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
