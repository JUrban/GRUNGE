...
fof(conj_thm_2Elbtree_2Elbtree__cases,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
...
fof(conj_thm_2Elbtree_2Elbtree__bisimulation,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Elbtree_2Elbtree(A_27a))
...
fof(conj_thm_2Elbtree_2Elbtree__strong__bisimulation,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Elbtree_2Elbtree(A_27a))
