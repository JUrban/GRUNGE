...
thf(thm_2Ereal__topology_2EEVENTUALLY__AND,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1p: A_27a > $o,V2q: A_27a > $o] :
      ( ( c_2Ereal__topology_2Eeventually @ A_27a
        @ ^ [V3x: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( V1p @ V3x ) @ ( V2q @ V3x ) )
        @ V0net )
      ...
      ( ( ( c_2Ereal__topology_2Ebilinear @ V2h )
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V9x: A_27a] :
              ...
              @ ^ [V10n: A_27b] :
                  ( c_2Emin_2E_3D_3D_3E @ ( V1P @ V10n ) @ ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V5l @ V10n ) ) @ V7b1 ) ) )
          @ V0net )
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V11x: A_27a] :
              ( c_2Ebool_2E_21 @ A_27b
              @ ^ [V12n: A_27b] :
                  ( c_2Emin_2E_3D_3D_3E @ ( V1P @ V12n ) @ ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V6m @ V12n ) ) @ V8b2 ) ) )
          @ V0net )
        & ! [V13e: tyop_2Erealax_2Ereal] :
           ...
           => ( c_2Ereal__topology_2Eeventually @ A_27a
              @ ^ [V14x: A_27a] :
                  ( c_2Ebool_2E_21 @ A_27b
                  @ ^ [V15n: A_27b] :
                      ( c_2Emin_2E_3D_3D_3E @ ( V1P @ V15n ) @ ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V3f @ V15n @ V14x ) @ ( V5l @ V15n ) ) ) @ V13e ) ) )
              @ V0net ) )
        & ! [V16e: tyop_2Erealax_2Ereal] :
           ...
           => ( c_2Ereal__topology_2Eeventually @ A_27a
              @ ^ [V17x: A_27a] :
                  ( c_2Ebool_2E_21 @ A_27b
                  @ ^ [V18n: A_27b] :
                      ( c_2Emin_2E_3D_3D_3E @ ( V1P @ V18n ) @ ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V4g @ V18n @ V17x ) @ ( V6m @ V18n ) ) ) @ V16e ) ) )
              @ V0net ) ) )
     => ! [V19e: tyop_2Erealax_2Ereal] :
         ...
         => ( c_2Ereal__topology_2Eeventually @ A_27a
            @ ^ [V20x: A_27a] :
                ( c_2Ebool_2E_21 @ A_27b
                @ ^ [V21n: A_27b] :
                    ( c_2Emin_2E_3D_3D_3E @ ( V1P @ V21n ) @ ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V2h @ ( V3f @ V21n @ V20x ) @ ( V4g @ V21n @ V20x ) ) @ ( V2h @ ( V5l @ V21n ) @ ( V6m @ V21n ) ) ) ) @ V19e ) ) )
            @ V0net ) ) ) )).
