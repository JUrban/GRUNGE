...
fof(conj_thm_2Ealist_2Ealist__to__fmap__prefix,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ls] :
             ...
             => ! [V1l1] :
                  ( mem(V1l1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                 => ! [V2l2] :
                      ( mem(V2l2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                     => ( ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V1l1) = ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V2l2)
                       => ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),V0ls),V1l1)) = ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),V0ls),V2l2)) ) ) ) ) ) ) )).
