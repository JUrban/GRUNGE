                    ...
                    @ ( ap @ c_2Ebool_2E_2F_5C
                      @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) ) ) )
                        @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) ) )
                          @ ^ [V1l: $i] :
                              ( ap @ ( ap @ V0R @ V1l ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27z ) ) ) @ V1l ) ) ) ) )
                    @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Elist_2Elist @ A_27z ) )
                      @ ( lam @ ( ty_2Elist_2Elist @ A_27z )
                        @ ^ [V2a: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) ) )
                              @ ^ [V3l: $i] :
                                  ( ap @ ( ap @ V0R @ V3l ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27z ) ) @ V2a ) ) @ V3l ) ) ) ) ) ) ) ) ) ) )
                  ...
                  @ ( lam @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27z ) )
                    @ ^ [V6v: $i] :
                        ...
                        @ ^ [V7l: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ A_27z )
                              @ ^ [V8a: $i] :
                                  ( ap @ ( c_2Ecombin_2EI @ ( ty_2Elist_2Elist @ A_27z ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27z ) @ V8a ) @ ( ap @ V4OPTION__FLAT @ V7l ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Efmapal_2EOPTION__FLAT,conjecture,(
    ! [A_27z: del] :
