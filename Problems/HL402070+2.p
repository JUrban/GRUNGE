...
fof(mem_c_2Eset__relation_2Eget__min,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Eset__relation_2Eget__min(A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),ty_2Eoption_2Eoption(A_27a)))) ) )).

fof(conj_thm_2Eset__relation_2Enth__min__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
         ...
         => ( ( ! [V1r_27] :
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V3r] :
                         ...
                         => p(ap(ap(ap(V0P,V1r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V2s),V3r)),c_2Enum_2E0)) ) ) )
              & ! [V4r_27] :
                         ...
                         => ! [V7n] :
                             ...
                             => ( ! [V8min] :
                                   ...
                                   => ( ( V8min = ap(ap(c_2Eset__relation_2Eget__min(A_27a),V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V5s),V6r))
                                     ...
                                     => p(ap(ap(ap(V0P,V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EDELETE(A_27a),V5s),ap(c_2Eoption_2ETHE(A_27a),V8min))),V6r)),V7n)) ) )
                               => p(ap(ap(ap(V0P,V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V5s),V6r)),ap(c_2Enum_2ESUC,V7n))) ) ) ) ) ) )
           => ! [V9v] :
               ...
               => ! [V10v1] :
                   ...
                   => ! [V11v2] :
                       ...
                       => ! [V12v3] :
                           ...
                           => p(ap(ap(ap(V0P,V9v),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V10v1),V11v2)),V12v3)) ) ) ) ) ) ) ) )).
