...
fof(lamtp_f2296,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f2296(V0n),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
fof(lameq_f2296,axiom,(
    ! [V0n] :
     ...
     => ! [V1i] :
         ...
         => ap(f2296(V0n),V1i) = ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1i) ) ) )).

fof(ax_thm_2Ebitstring_2Erev__count__list__def,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Ebitstring_2Erev__count__list,V0n) = ap(ap(c_2Elist_2EGENLIST(ty_2Enum_2Enum),f2296(V0n)),V0n) ) )).

fof(conj_thm_2Ebitstring_2Elength__rev__count__list,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
