...
fof(conj_thm_2Ecardinal_2ELT,lemma,
    ( ! [V0m] :
        ( mem(V0m,ty_2Enum_2Enum)
...
fof(lamtp_f3815,axiom,(
    ! [V1e] :
      ( mem(V1e,ty_2Erealax_2Ereal)
     => mem(f3815(V1e),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) ) )).

fof(lameq_f3815,axiom,(
    ! [V1e] :
      ( mem(V1e,ty_2Erealax_2Ereal)
     => ! [V3x] :
          ( mem(V3x,ty_2Erealax_2Ereal)
         => ap(f3815(V1e),V3x) = ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),V1e)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOMPACT__IMP__TOTALLY__BOUNDED,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => ! [V1e] :
