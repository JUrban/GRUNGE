...
tff(conj_thm_2Earithmetic_2EEXP__ADD,lemma,(
...
tff(conj_thm_2Earithmetic_2EZERO__LESS__MULT,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Earithmetic_2EEXP__EQ__0,lemma,(
...
tff(conj_thm_2Elogroot_2ELOG__ADD,lemma,(
...
tff(conj_thm_2Ebit_2EDIVMOD__2EXP,lemma,(
...
tff(conj_thm_2Ebit_2EDIV__MULT__1,lemma,(
...
tff(conj_thm_2Enumeral__bit_2Enumeral__imod__2exp,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Enumeral__bit_2EMOD__2EXP,lemma,
...
tff(conj_thm_2Enumeral__bit_2ENUMERAL__iDIV2,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Enumeral__bit_2ENUMERAL__DIV__2EXP,lemma,
...
tff(conj_thm_2Enumeral__bit_2ENUMERAL__SFUNPOW__iDIV2,lemma,
...
tff(conj_thm_2Enumeral__bit_2EFDUB__iDIV2,lemma,(
...
tff(conj_thm_2Elist_2EAPPEND__NIL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EMAP__APPEND,lemma,(
...
tff(conj_thm_2Elist_2EREVERSE__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EREVERSE__EQ__NIL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EREVERSE__REV,lemma,(
    ! [A_27a: del,V0L: $i] :
      ( mem(V0L,ty_2Elist_2Elist(A_27a))
     => ap(c_2Elist_2EREVERSE(A_27a),V0L) = ap(ap(c_2Elist_2EREV(A_27a),V0L),c_2Elist_2ENIL(A_27a)) ) )).

tff(conj_thm_2Erich__list_2EMAP__REVERSE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l: $i] :
...
tff(conj_thm_2Enumposrep_2En2l__def,lemma,(
...
tff(conj_thm_2Enumposrep_2ELENGTH__n2l,lemma,(
...
tff(conj_thm_2Enumposrep_2EEL__n2l,lemma,(
...
tff(conj_thm_2Enumposrep_2En2l__BOUND,lemma,(
    ! [V0b: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Enumposrep_2El2n__pow2__compute,lemma,
...
tff(lmtp_f822,type,(
    f822: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f822,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum,V2q: tp__ty_2Enum_2Enum] : mem(f822(V0p,V2q),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Enum_2Enum))) )).

tff(lameq_f822,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum,V2q: tp__ty_2Enum_2Enum,V3r: tp__ty_2Enum_2Enum] : ap(f822(V0p,V2q),inj__ty_2Enum_2Enum(V3r)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Enum_2Enum)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2q)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3r)),c_2Elist_2ENIL(ty_2Enum_2Enum))),ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3r)),ap(ap(c_2Enumposrep_2En2l,ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0p))),inj__ty_2Enum_2Enum(V2q)))) )).

tff(lmtp_f821,type,(
    f821: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f821,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum] : mem(f821(V0p),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Enum_2Enum)))) )).

tff(lameq_f821,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum,V2q: tp__ty_2Enum_2Enum] : ap(f821(V0p),inj__ty_2Enum_2Enum(V2q)) = f822(V0p,V2q) )).

tff(conj_thm_2Enumposrep_2En2l__pow2__compute,lemma,(
    ! [V0p: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
     ...
     => surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(ap(c_2Enumposrep_2En2l,ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0p))),inj__ty_2Enum_2Enum(V1n))) = surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f821(V0p))),ap(ap(c_2Ebit_2EDIVMOD__2EXP,inj__ty_2Enum_2Enum(V0p)),inj__ty_2Enum_2Enum(V1n)))) ) )).
...
tff(conj_thm_2Estring_2EORD__CHR__RWT,lemma,(
    ! [V0r: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))))
     => surj__ty_2Enum_2Enum(ap(c_2Estring_2EORD,ap(c_2Estring_2ECHR,inj__ty_2Enum_2Enum(V0r)))) = V0r ) )).

tff(conj_thm_2Estring_2EORD__CHR__COMPUTE,lemma,(
    ! [V0_3E_20255: tp__o,V1n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(c_2Estring_2EORD,ap(c_2Estring_2ECHR,inj__ty_2Enum_2Enum(V1n)))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))))))),inj__ty_2Enum_2Enum(V1n)),ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Estring_2Echar,ty_2Enum_2Enum),arr(ty_2Estring_2Echar,ty_2Enum_2Enum)),c_2Estring_2EORD),inj__o(V0_3E_20255)),ap(c_2Estring_2ECHR,inj__ty_2Enum_2Enum(V1n))))) )).

tff(conj_thm_2Estring_2Eranged__char__nchotomy,lemma,(
    ! [V0c: tp__ty_2Estring_2Echar] :
    ? [V1n: tp__ty_2Enum_2Enum] :
      ( V0c = surj__ty_2Estring_2Echar(ap(c_2Estring_2ECHR,inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2EASCIInumbers_2Es2n__n2s,lemma,(
    ! [V0c2n: $i] :
...
tff(conj_thm_2Epatricia__casts_2El2n__APPEND,lemma,(
...
tff(conj_thm_2Epatricia__casts_2El2n__LENGTH,lemma,(
...
tff(conj_thm_2Epatricia__casts_2EIMAGE__string__to__num,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
    ...
    <=> p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),c_2Epatricia__casts_2Estring__to__num),c_2Epred__set_2EUNIV(ty_2Elist_2Elist(ty_2Estring_2Echar))))) ) )).
