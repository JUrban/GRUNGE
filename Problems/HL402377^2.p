...
thf(conj_thm_2Eres__quan_2ERES__SELECT,lemma,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ebool_2ERES__SELECT @ A_27a ) @ V0P ) @ V1f )
            = ( ap @ ( c_2Emin_2E_40 @ A_27a )
              @ ( lam @ A_27a
                @ ^ [V2x: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ V0P ) ) @ ( ap @ V1f @ V2x ) ) ) ) ) ) ) )).

thf(conj_thm_2Eres__quan_2ERES__SELECT__EMPTY,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
