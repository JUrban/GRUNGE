...
thf(conj_thm_2Ereal__topology_2EBOUNDS__LINEAR,lemma,(
    ! [V0A: tp__ty_2Enum_2Enum,V1B: tp__ty_2Enum_2Enum,V2C: tp__ty_2Enum_2Enum] :
      ( ! [V3n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0A ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1B ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( inj__ty_2Enum_2Enum @ V2C ) ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0A ) ) @ ( inj__ty_2Enum_2Enum @ V1B ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBOUNDS__LINEAR__0,conjecture,(
    ! [V0A: tp__ty_2Enum_2Enum,V1B: tp__ty_2Enum_2Enum] :
      ( ! [V2n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0A ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( inj__ty_2Enum_2Enum @ V1B ) ) )
    <=> ( V0A = fo__c_2Enum_2E0 ) ) )).
