...
tff(conj_thm_2Eproduct_2EPRODUCT__ABS,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3362(A_27a,V0f))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Eabs,ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),V0f))) ) ) ) )).
