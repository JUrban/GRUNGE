...
thf(conj_thm_2Ereal__topology_2EDIST__0,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2ELIMPT__APPROACHABLE,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSED__LIMPT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__INTER,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
           ...
           => ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__BIGINTER__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
      <=> ! [V1e: tp__ty_2Erealax_2Ereal] :
            ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Ecball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1e ) ) ) ) @ V0s ) ) ) ) ) )).
