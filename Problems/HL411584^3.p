...
thf(thm_2Ereal__topology_2EIS__INTERVAL__EMPTY,axiom,(
    c_2Ereal__topology_2Eis__interval @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )).

thf(thm_2Ereal__topology_2EIS__INTERVAL__SING,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal] :
      ( c_2Ereal__topology_2Eis__interval @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V0a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).

thf(thm_2Ereal__topology_2EIS__INTERVAL__SCALING,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Eis__interval @ V0s )
     => ( c_2Ereal__topology_2Eis__interval
...
thf(thm_2Ereal__topology_2EIS__INTERVAL__SCALING__EQ,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Eis__interval
        @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V2x: tyop_2Erealax_2Ereal] :
