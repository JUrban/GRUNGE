...
tff(conj_thm_2Ereal__topology_2ECOMPLETE__EQ__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecomplete,V0s))
      <=> p(ap(c_2Ereal__topology_2EClosed,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
         ...
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
          <=> ! [V2x: $i] :
               ...
               => ! [V3a: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V2x)),ap(V0f,inj__ty_2Erealax_2Ereal(V3a))),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IMP__CAUCHY__CONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
           ...
           => ! [V2x: $i] :
               ...
               => ( ( p(ap(c_2Ereal__topology_2Ecauchy,V2x))
                    & ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V2x,inj__ty_2Enum_2Enum(V3n))),V1s)) )
