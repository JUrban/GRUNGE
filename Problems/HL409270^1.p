...
thf(f10784_0_2E0,type,(
    f10784_0_2E0: u )).

thf(f10784_0_2E1,type,(
    f10784_0_2E1: du > u )).

thf(f10784_0_2E2,type,(
    f10784_0_2E2: du > du > u )).
...
thf(c_2Elim_2Econtl_2E0,type,(
    c_2Elim_2Econtl_2E0: u )).

thf(c_2Elim_2Econtl_2E2,type,(
    c_2Elim_2Econtl_2E2: du > du > u )).
...
thf(mono_2Ef10784_0,type,(
    mono_2Ef10784_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Elim_2Econtl,type,(
    mono_2Ec_2Elim_2Econtl: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > $o )).
      ...
      ( ! [V3e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V4g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
              ( ! [V5x: mono_2Etyop_2Erealax_2Ereal] :
                 ...
                 => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ V5x ) @ ( V4g @ V5x ) ) ) @ V3e ) )
              & ( mono_2Ec_2Eintegral_2Eintegrable @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1a @ V2b ) @ V4g ) ) )
...
thf(def0_2Ethm_2Eintegral_2EINTEGRABLE__CONST,axiom,(
    ! [V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10784_0 @ V2c @ V3x )
      = V2c ) )).
...
thf(thm_2Eintegral_2EINTEGRABLE__CONST,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eintegral_2Eintegrable @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef10784_0 @ V2c ) ) )).
...
thf(thm_2Eintegral_2EINTEGRABLE__COMBINE,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal,V3c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V2b )
        ...
        & ( mono_2Ec_2Eintegral_2Eintegrable @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1a @ V2b ) @ V0f )
        & ( mono_2Ec_2Eintegral_2Eintegrable @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V2b @ V3c ) @ V0f ) )
     => ( mono_2Ec_2Eintegral_2Eintegrable @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1a @ V3c ) @ V0f ) ) )).

thf(thm_2Eintegral_2EINTEGRABLE__POINT__SPIKE,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2a: mono_2Etyop_2Erealax_2Ereal,V3b: mono_2Etyop_2Erealax_2Ereal,V4c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ! [V5x: mono_2Etyop_2Erealax_2Ereal] :
      ...
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V2b )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V3x )
              & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V2b ) )
           => ( mono_2Ec_2Elim_2Econtl @ V0f @ V3x ) ) )
     => ! [V4e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V5d: mono_2Etyop_2Erealax_2Ereal] :
              ...
              & ! [V6x: mono_2Etyop_2Erealax_2Ereal,V7y: mono_2Etyop_2Erealax_2Ereal] :
                  ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V6x )
                    & ( mono_2Ec_2Ereal_2Ereal__lte @ V6x @ V2b )
                    & ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V7y )
                    & ( mono_2Ec_2Ereal_2Ereal__lte @ V7y @ V2b )
                    & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V6x @ V7y ) ) @ V5d ) )
                 => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ V6x ) @ ( V0f @ V7y ) ) ) @ V4e ) ) ) ) ) )).
...
thf(thm_2Ereal_2EREAL__LE__SUB__CANCEL2,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal,V2z: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ V2z ) @ ( mono_2Ec_2Ereal_2Ereal__sub @ V1y @ V2z ) )
      = ( mono_2Ec_2Ereal_2Ereal__lte @ V0x @ V1y ) ) )).
...
thf(thm_2Eintegral_2EINTEGRABLE__CONTINUOUS,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V3x )
            & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V2b ) )
