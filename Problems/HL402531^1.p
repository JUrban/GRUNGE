...
thf(f2933_0_2E0,type,(
    f2933_0_2E0: u )).

thf(f2933_0_2E1,type,(
    f2933_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2933_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2933_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ f2933_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__EXISTS,axiom,(
    ! [A_27b: d,V2P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2933_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) ) ) )
    <=> ? [V4v2_2E0: u] :
...
thf(thm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__EXISTS,conjecture,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1i_2E0: u,V2P_2E0: u] :
      ( ! [V3v2_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27b @ V3v2_2E0 ) ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f2933_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) ) ) ) ) ) ) )).
