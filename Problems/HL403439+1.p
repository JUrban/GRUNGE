...
fof(thm_2EEncode_2Ebiprefix__cons,conjecture,(
    ! [A_27a,V0a_2E0,V1b_2E0,V2c_2E0,V3d_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V0a_2E0),s(tyop_2Elist_2Elist(A_27a),V1b_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V2c_2E0),s(tyop_2Elist_2Elist(A_27a),V3d_2E0))))))
    <=> ( s(A_27a,V0a_2E0) = s(A_27a,V2c_2E0)
        & p(s(tyop_2Emin_2Ebool,c_2EEncode_2Ebiprefix_2E2(s(tyop_2Elist_2Elist(A_27a),V1b_2E0),s(tyop_2Elist_2Elist(A_27a),V3d_2E0)))) ) ) )).
