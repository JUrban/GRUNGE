...
fof(conj_thm_2Einteger__word_2EINT__ZERO__LT__UINT__MAX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ew2i__UINT__MAXw,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ew2i__minus__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ei2w__UINT__MAX,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
