    ...
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ! [V2a: tyop_2Erealax_2Ereal] :
          ( ! [V3x: tyop_2Erealax_2Ereal] :
             ...
             => ( c_2Ereal_2Ereal__lte @ V2a @ V3x ) )
        <=> ! [V4x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V1t )
             => ( c_2Ereal_2Ereal__lte @ V2a @ V4x ) ) )
     => ( ( c_2Eiterate_2Einf @ V0s )
        = ( c_2Eiterate_2Einf @ V1t ) ) ) )).
...
thf(thm_2Ereal__topology_2Esetdist,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ...
      = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2E_5C_2F @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ V1t @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 )
        @ ( c_2Eiterate_2Einf
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
            @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
              @ ^ [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2x @ V3y ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3y @ V1t ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESETDIST__SUBSETS__EQ,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2s_27: tyop_2Erealax_2Ereal > $o,V3t_27: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2s_27 @ V0s )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3t_27 @ V1t )
        & ! [V4x: tyop_2Erealax_2Ereal,V5y: tyop_2Erealax_2Ereal] :
           ...
           => ? [V6x_27: tyop_2Erealax_2Ereal,V7y_27: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x_27 @ V2s_27 )
                & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7y_27 @ V3t_27 )
                & ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V6x_27 @ V7y_27 ) ) @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V4x @ V5y ) ) ) ) ) )
     => ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V2s_27 @ V3t_27 ) )
        = ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) ) ) )).
