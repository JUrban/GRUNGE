...
tff(tp_c_2Etransc_2Erpow,type,(
    c_2Etransc_2Erpow: $i )).

tff(mem_c_2Etransc_2Erpow,axiom,(
    mem(c_2Etransc_2Erpow,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(stp_fo_c_2Etransc_2Erpow,type,(
    fo__c_2Etransc_2Erpow: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > tp__ty_2Erealax_2Ereal )).

tff(stp_eq_fo_c_2Etransc_2Erpow,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal,X1: tp__ty_2Erealax_2Ereal] : inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Erpow(X0,X1)) = ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(X0)),inj__ty_2Erealax_2Ereal(X1)) )).

tff(conj_thm_2Etransc_2EEXP__ADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V1y)))) )).

tff(conj_thm_2Etransc_2ELN__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
     ...
     => surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eln,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V1y)))) ) )).

tff(ax_thm_2Etransc_2Erpow__def,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))) = surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1b)),ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V0a))))) )).

tff(conj_thm_2Etransc_2ERPOW__MUL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0a)))
     ...
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Erpow,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),inj__ty_2Erealax_2Ereal(V2c))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V2c))),ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V1b)),inj__ty_2Erealax_2Ereal(V2c)))) ) )).
