...
thf(conj_thm_2Elebesgue_2Eintegrable__plus__minus,lemma,(
    ! [A_27a: del,V0m: $i] :
...
thf(conj_thm_2Elebesgue_2Eintegrable__add__pos,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
...
thf(conj_thm_2Elebesgue_2Eintegrable__add__lemma,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
             ...
             => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
               ...
               => ( ( p
                    @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegrable @ A_27a ) @ V0m )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a ) @ V1f ) @ V3x ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a ) @ V2g ) @ V3x ) ) ) ) )
                  & ( p
                    @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegrable @ A_27a ) @ V0m )
                      @ ( lam @ A_27a
                        @ ^ [V4x: $i] :
                            ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a ) @ V1f ) @ V4x ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a ) @ V2g ) @ V4x ) ) ) ) ) ) ) ) ) ) )).
