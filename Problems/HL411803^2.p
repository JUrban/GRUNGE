...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET__ABSCONV,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2t: $i] :
             ...
             => ( ( ( p
                  ...
                  & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Enum_2Enum ) @ V2t ) @ V1s ) ) )
               => ( p
                  @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2t )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V4n: $i] :
