...
tff(conj_thm_2Equotient__pred__set_2EINTER__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => ! [V3s: $i] :
                   ...
                   => ! [V4t: $i] :
                       ...
                       => ap(ap(c_2Epred__set_2EINTER(A_27b),V3s),V4t) = ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27b,A_27b,A_27b,A_27b),V2rep),c_2Ecombin_2EI(bool)),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V3s)),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V4t))) ) ) ) ) ) ) )).
