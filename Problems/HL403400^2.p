...
thf(conj_thm_2Ebag_2EFINITE__BAG__INDUCT,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ebag_2EBAG__NOT__LESS__EMPTY,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EBAG__LESS__ADD,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1N: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2Emlt1 @ A_27a ) @ V0r ) @ V1N ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2M0 ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V3a ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) )
                   => ( ? [V4M: $i] :
                          ...
                          & ( V1N
                            = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V4M ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V3a ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) )
                      | ? [V5KK: $i] :
                          ...
                          & ! [V6b: $i] :
                             ...
                             => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IN @ A_27a ) @ V6b ) @ V5KK ) )
                               => ( p @ ( ap @ ( ap @ V0r @ V6b ) @ V3a ) ) ) )
                          & ( V1N
                            = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2M0 ) @ V5KK ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2Emlt1__all__accessible,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
       => ! [V1M: $i] :
