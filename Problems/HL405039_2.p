...
tff(lmtp_f2025,type,(
    f2025: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2025,axiom,(
    ! [A_27state: del,V0t0: tp__ty_2Enum_2Enum,V5q: $i] :
      ( mem(V5q,arr(ty_2Enum_2Enum,A_27state))
     => mem(f2025(A_27state,V0t0,V5q),arr(ty_2Enum_2Enum,A_27state)) ) )).

tff(lameq_f2025,axiom,(
    ! [A_27state: del,V0t0: tp__ty_2Enum_2Enum,V5q: $i] :
      ( mem(V5q,arr(ty_2Enum_2Enum,A_27state))
     => ! [V7t: tp__ty_2Enum_2Enum] : ap(f2025(A_27state,V0t0,V5q),inj__ty_2Enum_2Enum(V7t)) = ap(V5q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V7t)),inj__ty_2Enum_2Enum(V0t0))) ) )).

tff(lmtp_f2026,type,(
    f2026: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2026,axiom,(
    ! [A_27state: del,V0t0: tp__ty_2Enum_2Enum,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27state))
     => mem(f2026(A_27state,V0t0,V8q),arr(ty_2Enum_2Enum,A_27state)) ) )).

tff(lameq_f2026,axiom,(
    ! [A_27state: del,V0t0: tp__ty_2Enum_2Enum,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27state))
     => ! [V10t: tp__ty_2Enum_2Enum] : ap(f2026(A_27state,V0t0,V8q),inj__ty_2Enum_2Enum(V10t)) = ap(V8q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V10t)),inj__ty_2Enum_2Enum(V0t0))) ) )).

tff(conj_thm_2EOmega__Automata_2EDET__OMEGA__EXISTS__FORALL__THEOREM,conjecture,(
    ! [A_27input: del,A_27state: del,V0t0: tp__ty_2Enum_2Enum,V1InitVal: $i] :
      ( mem(V1InitVal,A_27state)
     => ! [V2TransRel: $i] :
          ( mem(V2TransRel,arr(ty_2Epair_2Eprod(A_27input,A_27input),A_27state))
         => ! [V3i: $i] :
              ( mem(V3i,arr(ty_2Enum_2Enum,A_27input))
             => ! [V4Accept: $i] :
                  ( mem(V4Accept,arr(ty_2Epair_2Eprod(arr(ty_2Enum_2Enum,A_27input),arr(ty_2Enum_2Enum,A_27input)),bool))
                 => ( ? [V5q: $i] :
                        ( mem(V5q,arr(ty_2Enum_2Enum,A_27state))
                        & ap(V5q,inj__ty_2Enum_2Enum(V0t0)) = V1InitVal
                        & ! [V6t: tp__ty_2Enum_2Enum] : ap(V5q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) = ap(V2TransRel,ap(ap(c_2Epair_2E_2C(A_27input,A_27input),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6t)),inj__ty_2Enum_2Enum(V0t0)))),ap(V5q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6t)),inj__ty_2Enum_2Enum(V0t0)))))
                        & p(ap(V4Accept,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,A_27input),arr(ty_2Enum_2Enum,A_27input)),V3i),f2025(A_27state,V0t0,V5q)))) )
                  <=> ! [V8q: $i] :
                        ( mem(V8q,arr(ty_2Enum_2Enum,A_27state))
                       => ( ( ap(V8q,inj__ty_2Enum_2Enum(V0t0)) = V1InitVal
                         ...
                         => p(ap(V4Accept,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,A_27input),arr(ty_2Enum_2Enum,A_27input)),V3i),f2026(A_27state,V0t0,V8q)))) ) ) ) ) ) ) ) )).
