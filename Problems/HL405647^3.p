...
thf(thm_2Eordinal_2Eomax__sup,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( ( c_2Eordinal_2Eomax @ A_27a @ V0s )
        = ( c_2Eoption_2ESOME @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a ) )
     => ( ( c_2Eordinal_2Esup @ A_27a @ V0s )
        = V1a ) ) )).
...
thf(thm_2Eordinal_2Edclose__def,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( c_2Eordinal_2Edclose @ A_27a @ V0s )
      = ( c_2Epred__set_2EGSPEC @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a )
        @ ^ [V1x: tyop_2Eordinal_2Eordinal @ A_27a] :
            ( c_2Epair_2E_2C @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ $o @ V1x
            @ ( c_2Ebool_2E_3F @ ( tyop_2Eordinal_2Eordinal @ A_27a )
              @ ^ [V2y: tyop_2Eordinal_2Eordinal @ A_27a] :
                  ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2y @ V0s ) @ ( c_2Eordinal_2Eordlt @ A_27a @ V1x @ V2y ) ) ) ) ) ) )).
...
thf(thm_2Eordinal_2Edclose__cardleq__univinf,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( c_2Ecardinal_2Ecardleq @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) @ V0s @ ( c_2Epred__set_2EUNIV @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) )
     => ( c_2Ecardinal_2Ecardleq @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) @ ( c_2Eordinal_2Edclose @ A_27a @ V0s ) @ ( c_2Epred__set_2EUNIV @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) ) ) )).

thf(thm_2Eordinal_2Esup__eq__max,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( ! [V2b: tyop_2Eordinal_2Eordinal @ A_27a] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2b @ V0s )
           => ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ V1a @ V2b ) ) )
...
thf(thm_2Eordinal_2Esup__eq__SUC,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( ( c_2Ecardinal_2Ecardleq @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) @ V0s @ ( c_2Epred__set_2EUNIV @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) )
        & ( ( c_2Eordinal_2Esup @ A_27a @ V0s )
          = ( c_2Eordinal_2EordSUC @ A_27a @ V1a ) ) )
     => ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC @ A_27a @ V1a ) @ V0s ) ) )).
...
thf(thm_2Eordinal_2Egeneric__continuity,conjecture,(
