...
thf(thm_2Epred__set_2EMAX__SET__UNION,conjecture,(
    ! [V0A: mono_2Etyop_2Enum_2Enum > $o,V1B: mono_2Etyop_2Enum_2Enum > $o] :
     ...
     => ( ( mono_2Ec_2Epred__set_2EMAX__SET @ ( mono_2Ec_2Epred__set_2EUNION_2Emono_2Etyop_2Enum_2Enum @ V0A @ V1B ) )
        = ( mono_2Ec_2Earithmetic_2EMAX @ ( mono_2Ec_2Epred__set_2EMAX__SET @ V0A ) @ ( mono_2Ec_2Epred__set_2EMAX__SET @ V1B ) ) ) ) )).
