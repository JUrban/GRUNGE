...
tff(conj_thm_2Ellist_2Ellength__rel__cases,conjecture,(
    ! [A_27a: del,V0a0: $i] :
      ( mem(V0a0,ty_2Ellist_2Ellist(A_27a))
     => ! [V1a1: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ellist_2Ellength__rel(A_27a),V0a0),inj__ty_2Enum_2Enum(V1a1)))
        <=> ( ( V0a0 = c_2Ellist_2ELNIL(A_27a)
              & V1a1 = fo__c_2Enum_2E0 )
            | ? [V2h: $i] :
                ( mem(V2h,A_27a)
                & ? [V3n: tp__ty_2Enum_2Enum,V4t: $i] :
                    ( mem(V4t,ty_2Ellist_2Ellist(A_27a))
                    & V0a0 = ap(ap(c_2Ellist_2ELCONS(A_27a),V2h),V4t)
                    & V1a1 = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))
                    & p(ap(ap(c_2Ellist_2Ellength__rel(A_27a),V4t),inj__ty_2Enum_2Enum(V3n))) ) ) ) ) ) )).
