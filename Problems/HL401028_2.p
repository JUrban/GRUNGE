...
tff(conj_thm_2Earithmetic_2EMODEQ__SUC__CONG,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum] :
     ...
     => p(ap(ap(ap(c_2Earithmetic_2EMODEQ,inj__ty_2Enum_2Enum(V0n)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1x))),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2y)))) ) )).
