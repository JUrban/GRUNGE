...
fof(conj_thm_2Elebesgue_2Epsfis__indicator,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
...
fof(conj_thm_2Elebesgue_2Epsfis__sum,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Elebesgue_2Epsfis__intro,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
