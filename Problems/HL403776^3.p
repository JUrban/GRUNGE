...
thf(thm_2Estring_2ESTRCAT__EQNS,conjecture,(
    ! [V0s2: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V1s1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V2s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V3c: tyop_2Estring_2Echar] :
      ( ( ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) @ V2s )
        = V2s )
      & ( ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ V2s @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) )
        = V2s )
      & ( ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V3c @ V1s1 ) @ V0s2 )
        = ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V3c @ ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ V1s1 @ V0s2 ) ) ) ) )).
