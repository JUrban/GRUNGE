...
tff(conj_thm_2Efinite__map_2ESUBMAP__FRANGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V1g))
           => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V0f)),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V1g))) ) ) ) )).
