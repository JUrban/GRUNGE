...
thf(conj_thm_2Ereal__topology_2EDIST__EQ__0,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESETDIST__UNIQUE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4d: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ V0s ) )
                ...
                & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) ) )
                  = V4d )
                & ! [V5x: tp__ty_2Erealax_2Ereal,V6y: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) ) ) @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) @ ( inj__ty_2Erealax_2Ereal @ V6y ) ) ) ) ) ) )
             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ V1t ) ) )
                = V4d ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESETDIST__UNIV,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
    & ! [V1t: $i] :
        ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V1t ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )).
