...
thf(f1053_0_2E0,type,(
    f1053_0_2E0: u )).

thf(f1053_0_2E1,type,(
    f1053_0_2E1: du > u )).
...
thf(mono_2Ef1053_0,type,(
    mono_2Ef1053_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Earithmetic_2EZERO__EXP,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1053_0 @ V0x )
    <=> ( V0x = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Earithmetic_2EZERO__EXP,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2EEXP @ mono_2Ec_2Enum_2E0 @ V0x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef1053_0 @ V0x ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ mono_2Ec_2Enum_2E0 ) ) )).
