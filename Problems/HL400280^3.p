...
thf(thm_2Esum_2Esum__axiom,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0f: A_27a > A_27c,V1g: A_27b > A_27c] :
      ...
      @ ^ [V2h: ( tyop_2Esum_2Esum @ A_27a @ A_27b ) > A_27c] :
          ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ ( A_27a > A_27c ) @ ( c_2Ecombin_2Eo @ A_27a @ A_27c @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2h @ ( c_2Esum_2EINL @ A_27a @ A_27b ) ) @ V0f ) @ ( c_2Emin_2E_3D @ ( A_27b > A_27c ) @ ( c_2Ecombin_2Eo @ A_27b @ A_27c @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2h @ ( c_2Esum_2EINR @ A_27a @ A_27b ) ) @ V1g ) ) ) )).

thf(thm_2Esum_2Esum__INDUCT,conjecture,(
