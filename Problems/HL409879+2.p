...
fof(conj_thm_2Eiterate_2ETH,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V1g] :
                   ...
                   => ! [V2s] :
                       ...
                       => ( ! [V3x] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                               => ap(V0f,V3x) = ap(V1g,V3x) ) )
                         => ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3400(A_27a,V0f)) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g) ) ) ) )
            & ! [V5f] :
                ( mem(V5f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
               => ! [V6g] :
                   ...
                   => ! [V7a] :
                       ...
                       => ! [V8b] :
                           ...
                           => ( ! [V9i] :
                             ...
                             => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V7a),V8b)),f3401(V5f)) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V7a),V8b)),V6g) ) ) ) ) )
            & ! [V11f] :
                ( mem(V11f,arr(A_27b,ty_2Erealax_2Ereal))
               => ! [V12g] :
                   ...
                   => ! [V13p] :
                       ...
                       => ( ! [V14x] :
                         ...
                         => ap(ap(c_2Eiterate_2ESum(A_27b),ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f3402(A_27b,V13p))),f3403(A_27b,V11f)) = ap(ap(c_2Eiterate_2ESum(A_27b),ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f3404(A_27b,V13p))),V12g) ) ) ) ) ) ) ) )).
