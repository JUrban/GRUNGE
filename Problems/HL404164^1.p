...
thf(c_2Epath_2Emem_2E0,type,(
    c_2Epath_2Emem_2E0: u )).

thf(c_2Epath_2Emem_2E2,type,(
    c_2Epath_2Emem_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ec_2Epath_2Emem_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ c_2Epath_2Emem_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Epath_2Emem_2E2_2Emono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27c @ X0_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ tyop_2Emin_2Ebool ) ) @ c_2Epath_2Emem_2E0 ) @ ( s @ A_27c @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2Epath_2Eel__def,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Efirst_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etail_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Epath_2Emem__def,axiom,(
    ! [A_27a: d,A_27b: d,V0s_2E0: u,V1p_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27a @ V0s_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) )
    <=> ? [V2i: mono_2Etyop_2Enum_2Enum] :
          ...
          & ( ( s @ A_27a @ V0s_2E0 )
            = ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Epath_2Emem__thm,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d] :
      ( ! [V0x_2E0: u,V1s_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27a @ V1s_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) ) ) )
        <=> ( ( s @ A_27a @ V1s_2E0 )
            = ( s @ A_27a @ V0x_2E0 ) ) )
      & ! [V2x_2E0: u,V3r_2E0: u,V4p_2E0: u,V5s_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27c @ V5s_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27c @ V2x_2E0 ) @ ( s @ A_27d @ V3r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ V4p_2E0 ) ) ) ) ) )
        <=> ( ( ( s @ A_27c @ V5s_2E0 )
              = ( s @ A_27c @ V2x_2E0 ) )
            | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Emem_2E2 @ ( s @ A_27c @ V5s_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ V4p_2E0 ) ) ) ) ) ) ) )).
