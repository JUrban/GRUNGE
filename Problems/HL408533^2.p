...
thf(conj_thm_2Ebinary__ieee_2Etop__properties,lemma,(
    ! [A_27t: del,A_27w: del] :
...
thf(conj_thm_2Ebinary__ieee_2Eround__roundTowardNegative__top,lemma,(
    ! [A_27t: del,A_27w: del,V0y: $i] :
      ( ( mem @ V0y @ ( ty_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ ( c_2Ebinary__ieee_2Elargest @ A_27t @ A_27w ) @ ( c_2Ebool_2Ethe__value @ ( ty_2Epair_2Eprod @ A_27t @ A_27w ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
         => ( ( ap @ ( ap @ ( c_2Ebinary__ieee_2Eround @ A_27t @ A_27w ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ fo__c_2Ebinary__ieee_2EroundTowardNegative ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) )
...
thf(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardNegative__top,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: $o,V1y: $i] :
      ( ( mem @ V1y @ ( ty_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) )
     => ! [V2x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ ( c_2Ebinary__ieee_2Elargest @ A_27t @ A_27w ) @ ( c_2Ebool_2Ethe__value @ ( ty_2Epair_2Eprod @ A_27t @ A_27w ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) )
         => ( ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__round @ A_27t @ A_27w ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ fo__c_2Ebinary__ieee_2EroundTowardNegative ) ) @ ( inj__o @ V0b ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) )
            = ( ap @ ( c_2Ebinary__ieee_2Efloat__top @ A_27t @ A_27w ) @ ( c_2Ebool_2Ethe__value @ ( ty_2Epair_2Eprod @ A_27t @ A_27w ) ) ) ) ) ) )).
