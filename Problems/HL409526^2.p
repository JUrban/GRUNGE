...
thf(conj_thm_2Eutil__prob_2EREAL__X__LE__SUP,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Eutil__prob_2EINF__DEF__ALT,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
          ...
          @ ( ap @ c_2Erealax_2Ereal__neg
            @ ( ap @ c_2Ereal_2Esup
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V1r: $i] :
                    ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Erealax_2Ereal__neg @ V1r ) ) @ V0p ) ) ) ) ) ) ) )).

thf(conj_thm_2Eutil__prob_2EINF__LE,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
