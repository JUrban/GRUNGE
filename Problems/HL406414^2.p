...
thf(conj_thm_2Eordinal_2Epreds__ordSUC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ V0a ) )
        = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0a ) ) ) ) )).

thf(conj_thm_2Eordinal_2EcountableOrds__dclosed,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
...
thf(conj_thm_2Eucord_2Eucord__sup__exists__lemma,lemma,(
    ! [A_27a: del] :
      ( p
      @ ( ap
...
thf(conj_thm_2Eucord_2Ex__lt__omega1__countable,conjecture,(
    ! [A_27a: del,V0x: $i] :
