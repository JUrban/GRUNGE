...
thf(thm_2Ewellorder_2Ewleast__def,axiom,(
    ! [A_27a: $tType,V0w: tyop_2Ewellorder_2Ewellorder @ A_27a,V1s: A_27a > $o] :
      ...
      = ( c_2Eoption_2Esome @ A_27a
        @ ^ [V2x: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w ) )
            @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1s ) )
              @ ( c_2Ebool_2E_21 @ A_27a
                @ ^ [V3y: A_27a] :
                    ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3y @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2Ebool_2EIN @ A_27a @ V3y @ V1s ) ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ A_27a @ V2x @ V3y ) ) ) ) @ ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V2x @ V3y ) @ ( c_2Eset__relation_2Estrict @ A_27a @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a @ V0w ) ) ) ) ) ) ) ) ) )).
