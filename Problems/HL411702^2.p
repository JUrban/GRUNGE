...
thf(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
     ...
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
       ...
       => ! [V3s: $i] :
           ...
           => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V3s ) )
             => ( p @ ( ap @ c_2Ereal__topology_2EClosed @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V3s ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSURE__LINEAR__IMAGE__SUBSET,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              & ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( V2x = V3y ) ) )
           => ( ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) )
              = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1s ) ) ) ) ) ) )).
