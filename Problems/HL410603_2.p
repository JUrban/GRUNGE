...
tff(lamtp_f3699,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3699(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3699,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] : ap(f3699(V0a),inj__ty_2Erealax_2Ereal(V3y)) = ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V3y)) )).

tff(conj_thm_2Ereal__topology_2ECBALL__TRANSLATION,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2r: tp__ty_2Erealax_2Ereal] : ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V2r))) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3699(V0a)),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2r)))) )).
