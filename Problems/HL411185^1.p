...
thf(f13913_0_2E0,type,(
    f13913_0_2E0: u )).

thf(f13913_0_2E1,type,(
    f13913_0_2E1: du > u )).

thf(f13913_0_2E2,type,(
    f13913_0_2E2: du > du > u )).

thf(f13915_0_2E0,type,(
    f13915_0_2E0: u )).

thf(f13915_0_2E2,type,(
    f13915_0_2E2: du > du > u )).

thf(f13915_0_2E3,type,(
...
thf(mono_2Ef13913_0,type,(
    mono_2Ef13913_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13915_0,type,(
    mono_2Ef13915_0: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__CMUL,axiom,(
    ! [V1c: mono_2Etyop_2Erealax_2Ereal,V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13915_0 @ V1c @ V0f @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ ( V0f @ V3x ) ) ) )).

thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__CMUL,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ ( mono_2Ef13915_0 @ V1c @ V0f ) @ V2s ) ) )).

thf(def0_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__NEG,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13913_0 @ V0f @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0f @ V2x ) ) ) )).

thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__NEG,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ ( mono_2Ef13913_0 @ V0f ) @ V1s ) ) )).
