...
thf(thm_2Emeasure_2Esubadditive__def,axiom,(
    ...
    <=> ! [V1s: A_27a > $o,V2t: A_27a > $o] :
         ...
         => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ ( c_2Epred__set_2EUNION @ A_27a @ V1s @ V2t ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2t ) ) ) ) ) )).
