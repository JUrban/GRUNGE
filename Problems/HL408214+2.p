...
fof(conj_thm_2Ereal_2EREAL__ADD__LID__UNIQ,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lamtp_f2931,axiom,(
    ! [V2y] :
     ...
     => ! [V0n] :
         ...
         => ! [V1x] :
              ( mem(V1x,ty_2Erealax_2Ereal)
             => mem(f2931(V2y,V0n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).
     ...
     => ! [V0n] :
         ...
         => ! [V1x] :
             ...
             => ! [V3p] :
                 ...
                 => ap(f2931(V2y,V0n,V1x),V3p) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,V1x),V3p)),ap(ap(c_2Ereal_2Epow,V2y),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Enum_2ESUC,V0n)),V3p))) ) ) ) ) )).

fof(lamtp_f2932,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Erealax_2Ereal)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1x] :
              ( mem(V1x,ty_2Erealax_2Ereal)
             => mem(f2932(V2y,V0n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).
     ...
     => ! [V0n] :
         ...
         => ! [V1x] :
             ...
             => ! [V4p] :
                 ...
                 => ap(f2932(V2y,V0n,V1x),V4p) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,V1x),V4p)),ap(ap(c_2Ereal_2Epow,V2y),ap(ap(c_2Earithmetic_2E_2D,V0n),V4p))) ) ) ) ) )).

fof(conj_thm_2Epowser_2EPOWDIFF__LEMMA,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
              ( mem(V2y,ty_2Erealax_2Ereal)
             => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),ap(c_2Enum_2ESUC,V0n))),f2931(V2y,V0n,V1x)) = ap(ap(c_2Erealax_2Ereal__mul,V2y),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),ap(c_2Enum_2ESUC,V0n))),f2932(V2y,V0n,V1x))) ) ) ) )).
...
fof(conj_thm_2Epowser_2EPOWDIFF,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
