...
tff(thm_2Ecombin_2EAPPLY__UPDATE__ID,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u] : s(tyop_2Emin_2Efun(A_27a,A_27b),c_2Ecombin_2EUPDATE_2E3(s(A_27a,V1a_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V1a_2E0))),s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0))) = s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0) )).

tff(thm_2EHolSmt_2Er061,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1f_2E0: u] : s(tyop_2Emin_2Efun(A_27a,A_27b),c_2Ecombin_2EUPDATE_2E3(s(A_27a,V0x_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0),s(A_27a,V0x_2E0))),s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0))) = s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0) )).
