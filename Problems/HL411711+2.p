...
fof(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE__EQ,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECOMPLETE__INJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
