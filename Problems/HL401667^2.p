...
thf(conj_thm_2Epred__set_2EFINITE__BIJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT__EQ,conjecture,(
    ! [A_27a: del,V0s: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
      <=> ? [V1c: $i] :
            ...
            & ? [V2n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EBIJ @ ty_2Enum_2Enum @ A_27a ) @ V1c ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V0s ) ) ) ) ) )).
