...
thf(c_2Ebitstring_2Ew2v,type,(
    c_2Ebitstring_2Ew2v: 
      !>[A_27a: $tType] :
        ( ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > ( tyop_2Elist_2Elist @ $o ) ) )).
    ...
    ! [V0n: tyop_2Enum_2Enum,V1v: tyop_2Elist_2Elist @ $o] :
      ...
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ $o )
        @ ^ [V2l: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ ( tyop_2Elist_2Elist @ $o ) @ ( c_2Eprim__rec_2E_3C @ V2l @ V0n ) @ ( c_2Ebitstring_2Ezero__extend @ V0n @ V1v ) @ ( c_2Elist_2EDROP @ $o @ ( c_2Earithmetic_2E_2D @ V2l @ V0n ) @ V1v ) )
