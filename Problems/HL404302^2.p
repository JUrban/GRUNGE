...
thf(tp_c_2Emergesort_2Esort2__tail,type,(
    c_2Emergesort_2Esort2__tail: del > $i )).

thf(mem_c_2Emergesort_2Esort2__tail,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Emergesort_2Esort2__tail__def,axiom,(
    ! [A_27a: del,V0neg: $o,V1R: $i] :
      ( ( mem @ V1R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V2x: $i] :
          ( ( mem @ V2x @ A_27a )
         => ! [V3y: $i] :
              ( ( mem @ V3y @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort2__tail @ A_27a ) @ ( inj__o @ V0neg ) ) @ V1R ) @ V2x ) @ V3y )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ ( ap @ V1R @ V2x ) @ V3y ) ) @ ( inj__o @ V0neg ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3y ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3y ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Emergesort_2Esort2__tail__correct,conjecture,(
    ! [A_27a: del,V0neg: $o,V1R: $i] :
      ( ( mem @ V1R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V2x: $i] :
          ( ( mem @ V2x @ A_27a )
         => ! [V3y: $i] :
              ( ( mem @ V3y @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort2__tail @ A_27a ) @ ( inj__o @ V0neg ) ) @ V1R ) @ V2x ) @ V3y )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( inj__o @ V0neg ) ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort2 @ A_27a ) @ V1R ) @ V2x ) @ V3y ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort2 @ A_27a ) @ V1R ) @ V2x ) @ V3y ) ) ) ) ) ) )).
