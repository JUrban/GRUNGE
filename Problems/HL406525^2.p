...
thf(stp_fo_c_2Eblast_2Ebsum,type,(
    fo__c_2Eblast_2Ebsum: $o > $o > $o > $o )).

thf(stp_eq_fo_c_2Eblast_2Ebsum,axiom,(
    ! [X0: $o,X1: $o,X2: $o] :
      ( ( inj__o @ ( fo__c_2Eblast_2Ebsum @ X0 @ X1 @ X2 ) )
      = ( ap @ ( ap @ ( ap @ c_2Eblast_2Ebsum @ ( inj__o @ X0 ) ) @ ( inj__o @ X1 ) ) @ ( inj__o @ X2 ) ) ) )).
...
thf(conj_thm_2Eblast_2EBCARRY__EQ,lemma,(
...
thf(conj_thm_2Eblast_2EBSUM__EQ,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $o,V2x1: $i] :
      ( ( mem @ V2x1 @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V3x2: $i] :
          ( ( mem @ V3x2 @ ( arr @ ty_2Enum_2Enum @ bool ) )
