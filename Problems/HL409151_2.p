...
tff(conj_thm_2Eieee_2Eroundmode2num__ONTO,conjecture,(
    ...
    <=> ? [V1a: tp__ty_2Eieee_2Eroundmode] : V0r = surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(V1a))) ) )).
