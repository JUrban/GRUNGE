...
tff(lamtp_f630,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f630(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f630,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V7x: $i] :
              ( mem(V7x,A_27b)
             => ap(f630(A_27b,V1P,V2Q),V7x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V7x)),ap(V2Q,V7x)) ) ) ) )).

tff(lmtp_f631,type,(
    f631: ( del * $i * $i ) > $i )).

tff(lamtp_f631,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f631(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f631,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V9x: $i] :
              ( mem(V9x,A_27b)
             => ap(f631(A_27b,V1P,V2Q),V9x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V9x)),ap(V2Q,V9x)) ) ) ) )).

tff(lmtp_f632,type,(
    f632: ( del * $i * $i ) > $i )).

tff(lamtp_f632,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f632(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f632,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V12x: $i] :
              ( mem(V12x,A_27b)
             => ap(f632(A_27b,V1P,V2Q),V12x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V12x)),ap(V2Q,V12x)) ) ) ) )).

tff(lmtp_f633,type,(
    f633: ( del * $i * $i ) > $i )).

tff(lamtp_f633,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f633(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f633,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V15x: $i] :
              ( mem(V15x,A_27b)
             => ap(f633(A_27b,V1P,V2Q),V15x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V15x)),ap(V2Q,V15x)) ) ) ) )).

tff(lmtp_f634,type,(
    f634: ( del * $i * $i ) > $i )).

tff(lamtp_f634,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f634(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f634,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V21x: $i] :
              ( mem(V21x,A_27b)
             => ap(f634(A_27b,V1P,V2Q),V21x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V21x)),ap(V2Q,V21x)) ) ) ) )).

tff(lmtp_f635,type,(
    f635: ( del * $i * tp__o ) > $i )).

tff(lamtp_f635,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V4q: tp__o] : mem(f635(A_27b,V1P,V4q),arr(A_27b,bool)) ) )).
...
tff(lameq_f635,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V4q: tp__o,V23x: $i] :
          ( mem(V23x,A_27b)
         => ap(f635(A_27b,V1P,V4q),V23x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V23x)),inj__o(V4q)) ) ) )).

tff(lmtp_f636,type,(
    f636: ( del * $i * tp__o ) > $i )).

tff(lamtp_f636,axiom,(
    ! [A_27b: del,V2Q: $i] :
      ( mem(V2Q,arr(A_27b,bool))
     => ! [V5p: tp__o] : mem(f636(A_27b,V2Q,V5p),arr(A_27b,bool)) ) )).
...
tff(lameq_f636,axiom,(
    ! [A_27b: del,V2Q: $i] :
     ...
     => ! [V5p: tp__o,V25x: $i] :
          ( mem(V25x,A_27b)
         => ap(f636(A_27b,V2Q,V5p),V25x) = ap(ap(c_2Ebool_2E_2F_5C,inj__o(V5p)),ap(V2Q,V25x)) ) ) )).

tff(lmtp_f637,type,(
    f637: ( del * $i * $i ) > $i )).

tff(lamtp_f637,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f637(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f637,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V28x: $i] :
              ( mem(V28x,A_27b)
             => ap(f637(A_27b,V1P,V2Q),V28x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V28x)),ap(V2Q,V28x)) ) ) ) )).

tff(lmtp_f638,type,(
    f638: ( del * $i * $i ) > $i )).

tff(lamtp_f638,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f638(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f638,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V30x: $i] :
              ( mem(V30x,A_27b)
             => ap(f638(A_27b,V1P,V2Q),V30x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V30x)),ap(V2Q,V30x)) ) ) ) )).

tff(lmtp_f639,type,(
    f639: ( del * $i * $i ) > $i )).

tff(lamtp_f639,axiom,(
    ! [A_27b: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(A_27b,bool))
         => mem(f639(A_27b,V1P,V2Q),arr(A_27b,bool)) ) ) )).
...
tff(lameq_f639,axiom,(
    ! [A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V32x: $i] :
              ( mem(V32x,A_27b)
             => ap(f639(A_27b,V1P,V2Q),V32x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V32x)),ap(V2Q,V32x)) ) ) ) )).

tff(conj_thm_2EquantHeuristics_2EGUESS__RULES__CONJ,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: $i] :
      ( mem(V0i,arr(A_27a,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27b,bool))
             ...
             => ! [V3iK: $i] :
                 ...
                 => ! [V4q: tp__o,V5p: tp__o] :
                      ( ( p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27a,A_27a),V0i),f601(A_27b,V1P)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27a,A_27a),V0i),f630(A_27b,V1P,V2Q))) )
                      & ( p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27a,A_27a),V0i),f610(A_27b,V2Q)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27a,A_27a),V0i),f631(A_27b,V1P,V2Q))) )
                      & ( ( p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL(A_27a,A_27a),V0i),f605(A_27b,V1P)))
                          & p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL(A_27a,A_27a),V0i),f612(A_27b,V2Q))) )
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL(A_27a,A_27a),V0i),f632(A_27b,V1P,V2Q))) )
                      & ( ( p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27a,A_27a),V0i),f592(A_27b,V1P)))
                          & p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27a,A_27a),V0i),f614(A_27b,V2Q))) )
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27a,A_27a),V0i),f633(A_27b,V1P,V2Q))) )
                      & ( ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(ty_2Eone_2Eone,ty_2Eone_2Eone),k(ty_2Eone_2Eone,V3iK)),f616(A_27b,V1P)))
                          & p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(ty_2Eone_2Eone,ty_2Eone_2Eone),k(ty_2Eone_2Eone,V3iK)),f617(A_27b,V2Q))) )
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(ty_2Eone_2Eone,ty_2Eone_2Eone),k(ty_2Eone_2Eone,V3iK)),f634(A_27b,V1P,V2Q))) )
                      & ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(A_27a,A_27a),V0i),f619(A_27b,V1P)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(A_27a,A_27a),V0i),f635(A_27b,V1P,V4q))) )
                      & ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(A_27a,A_27a),V0i),f621(A_27b,V2Q)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(A_27a,A_27a),V0i),f636(A_27b,V2Q,V5p))) )
                      & ( ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__POINT(A_27a,A_27a),V0i),f623(A_27b,V1P)))
                       ...
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__POINT(A_27a,A_27a),V0i),f637(A_27b,V1P,V2Q))) )
                      & ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27a,A_27a),V0i),f626(A_27b,V1P)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27a,A_27a),V0i),f638(A_27b,V1P,V2Q))) )
                      & ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27a,A_27a),V0i),f628(A_27b,V2Q)))
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27a,A_27a),V0i),f639(A_27b,V1P,V2Q))) ) ) ) ) ) ) )).
