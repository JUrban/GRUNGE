...
tff(lmtp_f1040,type,(
    f1040: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1040,axiom,(
...
tff(lmtp_f1039,type,(
    f1039: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f1039,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
...
tff(ax_thm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
...
tff(conj_thm_2Ewellorder_2Ewellorder__remove,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
...
tff(conj_thm_2Ewellorder_2EelsOf__remove,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
