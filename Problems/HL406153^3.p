...
thf(thm_2Ewords_2EWORD__GE,axiom,(
    ...
    <=> ( ( ( ( c_2Ewords_2Eword__msb @ A_27a @ V1b )
          ...
          & ( c_2Earithmetic_2E_3E_3D @ ( c_2Ewords_2Ew2n @ A_27a @ V0a ) @ ( c_2Ewords_2Ew2n @ A_27a @ V1b ) ) )
        | ( ( c_2Ewords_2Eword__msb @ A_27a @ V1b )
          & ( (~) @ ( c_2Ewords_2Eword__msb @ A_27a @ V0a ) ) ) ) ) )).

thf(thm_2Ewords_2Eword__ge__n2w,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__ge @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V0a ) @ ( c_2Ewords_2En2w @ A_27a @ V1b ) )
      = ( c_2Ebool_2ELET @ $o @ $o
        @ ( c_2Ebool_2ELET @ $o @ ( $o > $o )
          @ ^ [V2sa: $o,V3sb: $o] :
              ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ $o @ V2sa @ V3sb ) @ ( c_2Earithmetic_2E_3E_3D @ ( c_2Earithmetic_2EMOD @ V0a @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( c_2Earithmetic_2EMOD @ V1b @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ V2sa ) @ V3sb ) )
