...
thf(conj_thm_2Ebag_2EBAG__IN__DIVIDES,lemma,(
    ! [V0b: $i] :
     ...
     => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
          ( ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
            & ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IN @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ V0b ) ) )
         => ( p @ ( ap @ ( ap @ c_2Edivides_2Edivides @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ V0b ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) ) ) ) )).
...
thf(conj_thm_2EprimeFactor_2EPRIME__FACTOR__DIVIDES,conjecture,(
