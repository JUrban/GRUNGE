...
tff(tp_c_2Efinite__map_2ERRESTRICT,type,(
    c_2Efinite__map_2ERRESTRICT: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2ERRESTRICT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2ERRESTRICT(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(arr(A_27b,bool),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).
...
tff(ax_thm_2Efinite__map_2ERRESTRICT__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27b,bool))
...
tff(conj_thm_2Efinite__map_2ERRESTRICT__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(A_27a,bool))
     => ap(ap(c_2Efinite__map_2ERRESTRICT(A_27b,A_27b),c_2Efinite__map_2EFEMPTY(A_27b,A_27b)),V0r) = c_2Efinite__map_2EFEMPTY(A_27b,A_27b) ) )).
