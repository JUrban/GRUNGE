...
thf(thm_2Eiterate_2ENUMSEG__COMBINE__L,conjecture,(
    ! [V0m: tyop_2Enum_2Enum,V1p: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ V0m @ V1p )
        & ( c_2Earithmetic_2E_3C_3D @ V1p @ ( c_2Earithmetic_2E_2B @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
     => ( ( c_2Epred__set_2EUNION @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V0m @ ( c_2Earithmetic_2E_2D @ V1p @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Eiterate_2E_2E_2E @ V1p @ V2n ) )
