...
thf(conj_thm_2Ellist_2ELAPPEND__ASSOC,conjecture,(
    ! [A_27a: del,V0ll1: $i] :
      ( ( mem @ V0ll1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1ll2: $i] :
          ( ( mem @ V1ll2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ! [V2ll3: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0ll1 ) @ V1ll2 ) ) @ V2ll3 )
                = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0ll1 ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1ll2 ) @ V2ll3 ) ) ) ) ) ) )).
