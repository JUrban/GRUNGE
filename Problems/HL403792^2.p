...
thf(conj_thm_2Ellist_2Elrep__ok__alt,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eoption_2EIS__SOME__BIND,lemma,(
...
thf(conj_thm_2Ellist_2Elrep__ok__FUNPOW__BIND,conjecture,(
    ! [A_27a: del,V0g: $i] :
            ...
            @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2n: $i] :
                    ( ap
                    @ ( ap
                      @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ ( ty_2Eoption_2Eoption @ A_27a ) )
                        @ ( lam @ ( ty_2Eoption_2Eoption @ A_27a )
                          @ ^ [V3m: $i] :
                              ( ap @ ( ap @ ( c_2Eoption_2EOPTION__BIND @ A_27a @ A_27a ) @ V3m ) @ V0g ) ) )
                      @ V2n )
                    @ V1fz ) ) ) ) ) ) )).
