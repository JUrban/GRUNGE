...
tff(conj_thm_2Ellist_2ELAPPEND__NIL__2ND,lemma,(
    ! [A_27a: del,V0ll: $i] :
...
tff(conj_thm_2Ellist_2ELLENGTH__APPEND,lemma,(
    ! [A_27a: del,V0ll1: $i] :
      ( mem(V0ll1,ty_2Ellist_2Ellist(A_27a))
     => ! [V1ll2: $i] :
          ( mem(V1ll2,ty_2Ellist_2Ellist(A_27a))
...
tff(conj_thm_2Ellist_2ELTAKE__LLENGTH__NONE,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum,V2m: tp__ty_2Enum_2Enum] :
         ...
         => ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V2m)),V0ll) = c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a)) ) ) )).

tff(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
