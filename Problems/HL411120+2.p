...
fof(conj_thm_2Ereal__topology_2EWLOG__LE,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__CHAIN,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__NEST,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n] :
