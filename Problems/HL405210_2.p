...
tff(conj_thm_2Ealist_2Ealist__to__fmap__FAPPLY__MEM,lemma,(
...
tff(conj_thm_2Ealist_2EFRANGE__alist__to__fmap__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b)))
     => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(c_2Ealist_2Ealist__to__fmap(A_27b,A_27b),V0ls))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2ESND(A_27b,A_27b)),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27b,A_27b)),V0ls)))) ) )).
