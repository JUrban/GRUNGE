...
thf(f9545_0_2E0,type,(
    f9545_0_2E0: u )).

thf(f9545_0_2E1,type,(
    f9545_0_2E1: du > u )).

thf(f9545_0_2E2,type,(
    f9545_0_2E2: du > du > u )).

thf(f9547_0_2E0,type,(
    f9547_0_2E0: u )).

thf(f9547_0_2E2,type,(
    f9547_0_2E2: du > du > u )).

thf(f9547_0_2E3,type,(
...
thf(mono_2Ef9545_0,type,(
    mono_2Ef9545_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9547_0,type,(
    mono_2Ef9547_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Elim_2EDIFF__CONST,axiom,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9545_0 @ V0k @ V2x )
      = V0k ) )).

thf(thm_2Elim_2EDIFF__CONST,axiom,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Ediffl @ ( mono_2Ef9545_0 @ V0k ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V1x ) )).

thf(def0_2Ethm_2Elim_2EDIFF__MUL,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V5x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9547_0 @ V0f @ V1g @ V5x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0f @ V5x ) @ ( V1g @ V5x ) ) ) )).
...
thf(thm_2Elim_2EDIFF__MUL,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3m: mono_2Etyop_2Erealax_2Ereal,V4x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Elim_2Ediffl @ ( mono_2Ef9547_0 @ V0f @ V1g ) @ ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2l @ ( V1g @ V4x ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V3m @ ( V0f @ V4x ) ) ) @ V4x ) ) )).
...
thf(thm_2Elim_2EDIFF__CMUL,conjecture,(
