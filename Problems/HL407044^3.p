...
thf(thm_2Epatricia__casts_2Edatatype__word__ptree,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0word__ptree: ( ( A_27a > tyop_2Eone_2Eone ) > ( tyop_2Epatricia_2Eptree @ A_27b ) > ( tyop_2Epatricia__casts_2Eword__ptree @ A_27a @ A_27b ) ) > $o] :
      ( c_2Ebool_2EDATATYPE @ $o @ ( V0word__ptree @ ( c_2Epatricia__casts_2EWord__ptree @ A_27a @ A_27b ) ) ) )).
