...
thf(conj_thm_2Ecardinal_2EEMPTY__set__exp,lemma,(
...
thf(conj_thm_2Ecardinal_2Eexp__count__cardeq,lemma,(
    ! [A_27a: del,V0A: $i] :
...
thf(conj_thm_2Ecardinal_2EINFINITE__cardleq__INSERT,lemma,(
    ! [A_27a: del,A_27b: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ A_27a @ bool ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
...
thf(conj_thm_2Ecardinal_2Elist__BIGUNION__EXP,lemma,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ A_27a @ bool ) )
     => ( p
...
thf(conj_thm_2Ecardinal_2EINFINITE__A__list__BIJ__A,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ A_27a @ bool ) )
     => ( ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0A ) )
