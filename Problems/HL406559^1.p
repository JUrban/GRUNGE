...
thf(thm_2Esptree_2Elookup__inter__EQ,conjecture,(
    ! [A_27a: d,A_27b: d,V0y_2E0: u,V1x: mono_2Etyop_2Enum_2Enum,V2t2_2E0: u,V3t1_2E0: u] :
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V3t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V2t2_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0y_2E0 ) ) ) )
      <=> ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V3t1_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0y_2E0 ) ) ) )
          & ( (~)
            @ ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V2t2_2E0 ) ) )
