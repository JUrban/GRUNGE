...
thf(thm_2Ereal__topology_2EBOUNDED__SUBSET__OPEN__INTERVAL__SYMMETRIC,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
     => ? [V1a: tyop_2Erealax_2Ereal] :
          ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V1a ) @ V1a ) ) ) ) )).
