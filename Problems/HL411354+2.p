...
fof(lamtp_f3657,axiom,(
    ! [V1a] :
      ( mem(V1a,ty_2Erealax_2Ereal)
     => mem(f3657(V1a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3657,axiom,(
    ! [V1a] :
     ...
     => ! [V2x] :
         ...
         => ap(f3657(V1a),V2x) = ap(ap(c_2Erealax_2Ereal__add,V1a),V2x) ) ) )).
    ...
    ! [V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V3x] :
             ...
             => ap(f3839(V1s,V0f),V3x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V3x)),V1s)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__PREIMAGE__UNIV,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EOPEN__TRANSLATION,conjecture,(
    ! [V0s] :
