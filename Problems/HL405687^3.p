...
thf(thm_2Eordinal_2Eislimit__fromNat,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Enum_2Enum] :
      ( ( ( c_2Eordinal_2Eomax @ A_27a @ ( c_2Eordinal_2Epreds @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ V0x ) ) )
        = ( c_2Eoption_2ENONE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) )
    <=> ( V0x = c_2Enum_2E0 ) ) )).
...
thf(thm_2Eordinal_2EIMAGE__EQ__SING,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0x: A_27a,V1s: A_27b > $o,V2f: A_27b > A_27a] :
      ( ( ( c_2Epred__set_2EIMAGE @ A_27b @ A_27a @ V2f @ V1s )
        = ( c_2Epred__set_2EINSERT @ A_27a @ V0x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
    <=> ( ? [V3y: A_27b] :
            ( c_2Ebool_2EIN @ A_27b @ V3y @ V1s )
        & ! [V4y: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V4y @ V1s )
           => ( ( V2f @ V4y )
              = V0x ) ) ) ) )).
