...
tff(conj_thm_2Ereal_2EREAL__LE__SUB__CANCEL2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__LIMIT,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__CONST,lemma,(
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__COMBINE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__POINT__SPIKE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Eintegral_2EBOLZANO__LEMMA__ALT,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Eintegral_2ECONT__UNIFORM,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b)))
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__CONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ! [V3x: tp__ty_2Erealax_2Ereal] :
