...
tff(tp_c_2Eextreal_2Emono__increasing,type,(
    c_2Eextreal_2Emono__increasing: $i )).

tff(mem_c_2Eextreal_2Emono__increasing,axiom,(
    mem(c_2Eextreal_2Emono__increasing,arr(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),bool)) )).

tff(ax_thm_2Eextreal_2Emono__increasing__def,axiom,(
    ! [V0f: $i] :
...
tff(conj_thm_2Eextreal_2Emono__increasing__suc,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eextreal_2Emono__increasing,V0f))
