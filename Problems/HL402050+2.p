...
fof(conj_thm_2Eset__relation_2Eacyclic__irreflexive,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
fof(conj_thm_2Eset__relation_2Estrict__linear__order__acyclic,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
fof(conj_thm_2Eset__relation_2Estrict__linear__order__union__acyclic,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r1] :
