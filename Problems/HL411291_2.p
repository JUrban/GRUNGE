...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3892(V0a)),V1s)) ) )).

tff(lmtp_f3893,type,(
    f3893: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3893,axiom,(
    ! [V0b: tp__ty_2Erealax_2Ereal] : mem(f3893(V0b),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3893,axiom,(
    ! [V0b: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3893(V0b),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V0b))) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__INTERVAL__LEFT,lemma,(
    ! [V0b: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3893(V0b)))) )).
...
tff(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__LE,conjecture,(
