...
tff(conj_thm_2Ereal__topology_2ECARD__GE__DIM__INDEPENDENT,lemma,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__INJECTIVE__IMAGE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESPAN__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__IMP__SURJECTIVE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
