...
fof(conj_thm_2Eoption_2Eoption__case__cong,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V4v] :
                             ...
                             => ! [V5f] :
                                 ...
                                 => ( ( V2M = V3M_27
                                   ...
                                   => ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V2M),V4v),V5f) = ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V3M_27),V0v_27),V1f_27) ) ) ) ) ) ) ) ) ) )).
