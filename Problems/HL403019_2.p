...
tff(conj_thm_2EindexedLists_2EMAP__MAPi,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),V1g),V2l)) = ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0f)),V1g)),V2l) ) ) ) )).
