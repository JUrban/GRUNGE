...
thf(ax_thm_2Earithmetic_2EFACT,axiom,
    ( ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2EFACT @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).

thf(conj_thm_2Earithmetic_2EFACT__LESS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
...
thf(conj_thm_2Elim_2EDIFF__UNIQ,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2EDIFF__CONST,lemma,(
...
thf(conj_thm_2Elim_2EDIFF__ADD,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Elim_2EDIFF__MUL,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2EDIFF__SUB,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ c_2Elim_2Ediffl
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V5x ) ) @ ( ap @ V1g @ V5x ) ) ) )
                    @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) @ ( inj__ty_2Erealax_2Ereal @ V3m ) ) )
                  @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) ) )).

thf(conj_thm_2Elim_2EDIFF__CHAIN,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2EDIFF__X,lemma,(
...
thf(conj_thm_2Elim_2EDIFF__POW,lemma,(
      ...
      @ ( ap
        @ ( ap
          @ ( ap @ c_2Elim_2Ediffl
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2x: $i] :
                  ( ap @ ( ap @ c_2Ereal_2Epow @ V2x ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
...
thf(conj_thm_2Elim_2EDIFF__DIV,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ c_2Elim_2Ediffl
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ V0f @ V5x ) ) @ ( ap @ V1g @ V5x ) ) ) )
...
thf(conj_thm_2Elim_2EDIFF__SUM,lemma,(
    ! [V0f: $i] :
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ c_2Elim_2Ediffl
                          @ ( lam @ ty_2Erealax_2Ereal
                            @ ^ [V6x: $i] :
                                ( ap @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V5r ) ) @ V6x ) ) )
                ...
                @ ( ap
                  @ ( ap
                    ...
                    @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V9r: $i] :
                            ( ap @ ( ap @ V1f_27 @ V9r ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) )
                  @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) ) )).

thf(conj_thm_2Elim_2EROLLE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal_2EREAL__ADD__LID__UNIQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
        = V1y )
    <=> ( V0x
...
thf(conj_thm_2Ereal_2EREAL__SUB__REFL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__INV__POS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EREAL__MUL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ereal_2EREAL__EQ__SUB__RADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
        = V2z )
    <=> ( V0x
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__FACT__NZ,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
     != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).
...
thf(conj_thm_2Ereal_2ESUM__OFFSET,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3m: $i] :
                    ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3m ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) ) ) )
...
thf(conj_thm_2Ereal_2ESUM__0,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Erealax_2Ereal
        @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V2r: $i] :
                ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).
...
thf(conj_thm_2Etransc_2EMCLAURIN,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1diff: $i] :
         ...
         => ! [V2h: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum] :
              ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2h ) ) )
                ...
                & ( ( ap @ V1diff @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) )
                  = V0f )
             ...
             => ? [V6t: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2h ) ) )
                    = ( surj__ty_2Erealax_2Ereal
                      @ ( ap
                        @ ( ap @ c_2Erealax_2Ereal__add
                          @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) )
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V7m: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ V1diff @ V7m ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V7m ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2h ) ) @ V7m ) ) ) ) )
                        @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ V1diff @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ ( inj__ty_2Erealax_2Ereal @ V6t ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2h ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) ) ) ) ) )).
