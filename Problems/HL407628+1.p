...
fof(arityeq1_2Ec_2Emetric_2Eismet_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Ebool,c_2Emetric_2Eismet_2E1(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),X0_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),tyop_2Emin_2Ebool),c_2Emetric_2Eismet_2E0),s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),X0_2E0))) )).
...
fof(thm_2Emetric_2Eismet,axiom,(
    ! [A_27a,V0m_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Emetric_2Eismet_2E1(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),V0m_2E0))))
    <=> ( ! [V1x_2E0,V2y_2E0] :
            ( s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V1x_2E0),s(A_27a,V2y_2E0))))) = s(tyop_2Erealax_2Ereal,c_2Ereal_2Ereal__of__num_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0)))
          <=> s(A_27a,V1x_2E0) = s(A_27a,V2y_2E0) )
        & ! [V3x_2E0,V4y_2E0,V5z_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ereal_2Ereal__lte_2E2(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V4y_2E0),s(A_27a,V5z_2E0))))),s(tyop_2Erealax_2Ereal,c_2Erealax_2Ereal__add_2E2(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V3x_2E0),s(A_27a,V4y_2E0))))),s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V3x_2E0),s(A_27a,V5z_2E0)))))))))) ) ) )).

fof(thm_2Emetric_2EMETRIC__ISMET,axiom,(
    ! [A_27a,V0m_2E0] : p(s(tyop_2Emin_2Ebool,c_2Emetric_2Eismet_2E1(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Erealax_2Ereal),c_2Emetric_2Edist_2E1(s(tyop_2Emetric_2Emetric(A_27a),V0m_2E0)))))) )).

fof(thm_2Emetric_2EMETRIC__ZERO,axiom,(
    ! [A_27a,V0m_2E0,V1x_2E0,V2y_2E0] :
      ( s(tyop_2Erealax_2Ereal,c_2Emetric_2Edist_2E2(s(tyop_2Emetric_2Emetric(A_27a),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V1x_2E0),s(A_27a,V2y_2E0))))) = s(tyop_2Erealax_2Ereal,c_2Ereal_2Ereal__of__num_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0)))
    <=> s(A_27a,V1x_2E0) = s(A_27a,V2y_2E0) ) )).
...
fof(thm_2Emetric_2EMETRIC__POS,conjecture,(
    ! [A_27a,V0m_2E0,V1x_2E0,V2y_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ereal_2Ereal__lte_2E2(s(tyop_2Erealax_2Ereal,c_2Ereal_2Ereal__of__num_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0))),s(tyop_2Erealax_2Ereal,c_2Emetric_2Edist_2E2(s(tyop_2Emetric_2Emetric(A_27a),V0m_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V1x_2E0),s(A_27a,V2y_2E0)))))))) )).
