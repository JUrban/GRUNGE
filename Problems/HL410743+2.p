...
fof(conj_thm_2Ereal__topology_2ELIMPT__SING,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__LIMIT__POINT,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__SING,conjecture,(
    ! [V0a] :
