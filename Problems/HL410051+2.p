...
fof(conj_thm_2Earithmetic_2EMULT__SUC__EQ,lemma,(
    ! [V0p] :
...
fof(conj_thm_2Eproduct_2ENPRODUCT__CLAUSES__NUMSEG,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Eproduct_2ENPRODUCT__FACT,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
