...
fof(conj_thm_2Ereal__topology_2EINFSUM__EQ,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ! [V2k] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2k),V0f))
                  ...
                  & ! [V3x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3x),V2k))
                       => ap(V0f,V3x) = ap(V1g,V3x) ) ) )
               => ap(ap(c_2Ereal__topology_2Einfsum,V2k),V0f) = ap(ap(c_2Ereal__topology_2Einfsum,V2k),V1g) ) ) ) ) )).
