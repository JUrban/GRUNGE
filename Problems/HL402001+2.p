...
fof(lamtp_f344,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a,V0r] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => mem(f344(A_27b,A_27b,A_27a,A_27a,V0r),arr(A_27a,arr(A_27b,bool))) ) )).
...
fof(lameq_f344,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a,V0r] :
     ...
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => ap(f344(A_27b,A_27b,A_27a,A_27a,V0r),V1x) = f318(A_27a,A_27b,A_27b,V1x,V0r) ) ) )).
...
fof(ax_thm_2Eset__relation_2Ereln__to__rel__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0r] :
              ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ap(c_2Eset__relation_2Ereln__to__rel(A_27a,A_27a),V0r) = f344(A_27b,A_27b,A_27a,A_27a,V0r) ) ) ) )).

fof(lamtp_f346,axiom,(
    ! [A_27a,A_27b,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => mem(f346(A_27a,A_27b,V0R,V1x),arr(A_27b,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )).
...
fof(lameq_f346,axiom,(
    ! [A_27a,A_27b,V0R] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
              ( mem(V2y,A_27b)
             => ap(f346(A_27a,A_27b,V0R,V1x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y)),ap(ap(V0R,V1x),V2y)) ) ) ) )).

fof(lamtp_f345,axiom,(
    ! [A_27b,A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => mem(f345(A_27b,A_27a,V0R),arr(A_27a,arr(A_27b,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a))))) ) )).
...
fof(lameq_f345,axiom,(
    ! [A_27b,A_27a,V0R] :
     ...
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => ap(f345(A_27b,A_27a,V0R),V1x) = f346(A_27a,A_27b,V0R,V1x) ) ) )).
...
fof(ax_thm_2Eset__relation_2Erel__to__reln__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0R] :
              ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
             => ap(c_2Eset__relation_2Erel__to__reln(A_27a,A_27a),V0R) = ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f345(A_27b,A_27a,V0R))) ) ) ) )).
