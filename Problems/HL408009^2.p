...
thf(conj_thm_2Eseq_2ESER__GROUP,lemma,(
    ! [V0f: $i] :
         ...
         => ( p
            @ ( ap
              @ ( ap @ c_2Eseq_2Esums
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ V2n ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ V0f ) ) )
              @ ( ap @ c_2Eseq_2Esuminf @ V0f ) ) ) ) ) )).

thf(conj_thm_2Eseq_2ESER__PAIR,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Eseq_2Esummable @ V0f ) )
       => ( p
