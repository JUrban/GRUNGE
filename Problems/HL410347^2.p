...
thf(conj_thm_2Ereal__topology_2EPAIRWISE__IMAGE,conjecture,(
                    ...
                    @ ( ap @ ( c_2Ereal__topology_2Epairwise @ A_27b )
                      @ ( lam @ A_27b
                        @ ^ [V3x: $i] :
                            ( lam @ A_27b
                            @ ^ [V4y: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ V2f @ V3x ) ) @ ( ap @ V2f @ V4y ) ) ) ) @ ( ap @ ( ap @ V1r @ ( ap @ V2f @ V3x ) ) @ ( ap @ V2f @ V4y ) ) ) ) ) )
                    @ V0s ) ) ) ) ) ) )).
