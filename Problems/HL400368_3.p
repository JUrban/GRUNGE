...
tff(thm_2Erelation_2ERTC__CASES2,conjecture,(
    ...
    <=> ( V1x_2E0 = V2y_2E0
        | ? [V3u_2E0: A_27a] :
            ( p(c_2Erelation_2ERTC_2E3(A_27a,V0R_2E0,V1x_2E0,V3u_2E0))
            & p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0R_2E0,V3u_2E0),V2y_2E0)) ) ) ) )).
