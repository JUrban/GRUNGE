...
tff(conj_thm_2Epred__set_2EIMAGE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27c,A_27a))
         => ! [V2s: $i] :
             ...
             => ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EIMAGE(A_27c,A_27c),V1g),V2s)) = ap(ap(c_2Epred__set_2EIMAGE(A_27c,A_27c),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0f),V1g)),V2s) ) ) ) )).
...
tff(conj_thm_2Epred__set_2EPREIMAGE__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),c_2Epred__set_2EEMPTY(A_27b)) = c_2Epred__set_2EEMPTY(A_27a) ) )).

tff(conj_thm_2Epred__set_2EPREIMAGE__BIGUNION,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(arr(A_27b,bool),bool))
         => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2EBIGUNION(A_27b),V1s)) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f)),V1s)) ) ) )).

tff(conj_thm_2Epred__set_2EPREIMAGE__DIFF,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
...
tff(conj_thm_2Epred__set_2EPREIMAGE__DISJOINT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27b),V1s),V2t))
               => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V2t))) ) ) ) ) )).

tff(conj_thm_2Epred__set_2EPREIMAGE__SUBSET,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),V1s),V2t))
               => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V2t))) ) ) ) ) )).
...
tff(tp_c_2Emeasure_2Emeasure__preserving,type,(
    c_2Emeasure_2Emeasure__preserving: ( del * del ) > $i )).

tff(mem_c_2Emeasure_2Emeasure__preserving,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Emeasure_2Emeasure__preserving(A_27a,A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)),arr(arr(A_27a,A_27b),bool)))) )).
...
tff(conj_thm_2Emeasure_2ESPACE,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0a)),ap(c_2Emeasure_2Esubsets(A_27a),V0a)) = V0a ) )).
...
tff(conj_thm_2Emeasure_2EMEASURE__COMPL,lemma,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m)),V1s))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(c_2Emeasure_2Em__space(A_27a),V0m))),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) )).

tff(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT,lemma,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1p: $i] :
...
tff(conj_thm_2Emeasure_2EMEASURE__COUNTABLY__ADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2f: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => p(ap(ap(c_2Eseq_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emeasure_2Emeasure(A_27a),V0m)),V2f)),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) ) )).

tff(conj_thm_2Emeasure_2EMEASURE__COUNTABLE__INCREASING,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2f: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V2f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
                  & ap(V2f,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) = c_2Epred__set_2EEMPTY(A_27a)
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE,lemma,(
...
tff(conj_thm_2Emeasure_2EMEASURABLE__LIFT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2b: $i] :
              ( mem(V2b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
             => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V0f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V1a),V2b)))
               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V0f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V1a),ap(ap(c_2Emeasure_2Esigma(A_27b),ap(c_2Emeasure_2Espace(A_27b),V2b)),ap(c_2Emeasure_2Esubsets(A_27b),V2b))))) ) ) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURE__PRESERVING,lemma,(
              ...
              <=> ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V2f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m1)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m1))),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Em__space(A_27b),V1m2)),ap(c_2Emeasure_2Emeasurable__sets(A_27b),V1m2)))))
                  ...
                  & ! [V3s: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V3s),ap(c_2Emeasure_2Emeasurable__sets(A_27b),V1m2)))
                       => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m1),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f),V3s)),ap(c_2Emeasure_2Em__space(A_27a),V0m1)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27b),V1m2),V3s)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Emeasure_2EMEASURE__PRESERVING__LIFT,conjecture,(
    ! [A_27a: del,A_27b: del,V0m1: $i] :
      ( mem(V0m1,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1m2: $i] :
          ( mem(V1m2,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
         => ! [V2a: $i] :
              ( mem(V2a,arr(arr(A_27b,bool),bool))
             => ! [V3f: $i] :
                  ( mem(V3f,arr(A_27a,A_27b))
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m1))
                      & p(ap(c_2Emeasure_2Emeasure__space(A_27b),V1m2))
                      & ap(c_2Emeasure_2Emeasurable__sets(A_27b),V1m2) = ap(c_2Emeasure_2Esubsets(A_27b),ap(ap(c_2Emeasure_2Esigma(A_27b),ap(c_2Emeasure_2Em__space(A_27b),V1m2)),V2a))
                      & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V3f),ap(ap(c_2Emeasure_2Emeasure__preserving(A_27a,A_27a),V0m1),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Em__space(A_27b),V1m2)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),V2a),ap(c_2Emeasure_2Emeasure(A_27b),V1m2)))))) )
                   => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V3f),ap(ap(c_2Emeasure_2Emeasure__preserving(A_27a,A_27a),V0m1),V1m2))) ) ) ) ) ) )).
