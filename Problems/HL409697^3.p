    ...
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27b > A_27b > A_27b] :
     ...
     => ! [V1f: A_27a > A_27b,V2g: A_27a > A_27b,V3s: A_27a > $o] :
         ...
         => ( ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ V3s @ V1f )
            = ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ V3s @ V2g ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__CASES,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27b > A_27b > A_27b] :
      ( ( c_2Eiterate_2Emonoidal @ A_27b @ V0op )
     => ! [V1s: A_27a > $o,V2P: A_27a > $o,V3f: A_27a > A_27b,V4g: A_27a > A_27b] :
          ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
         => ( ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ V1s
              @ ^ [V5x: A_27a] :
                  ( c_2Ebool_2ECOND @ A_27b @ ( V2P @ V5x ) @ ( V3f @ V5x ) @ ( V4g @ V5x ) ) )
            = ( V0op
              @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op
                @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                  @ ^ [V6x: A_27a] :
                      ( c_2Epair_2E_2C @ A_27a @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V6x @ V1s ) @ ( V2P @ V6x ) ) ) )
                @ V3f )
              @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op
                @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                  @ ^ [V7x: A_27a] :
                      ( c_2Epair_2E_2C @ A_27a @ $o @ V7x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V7x @ V1s ) @ ( c_2Ebool_2E_7E @ ( V2P @ V7x ) ) ) ) )
                @ V4g ) ) ) ) ) )).
