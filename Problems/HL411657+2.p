...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V0s),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3657(V1a)),V0s))) ) ) )).
