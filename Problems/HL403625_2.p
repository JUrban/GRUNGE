...
tff(conj_thm_2Elist_2EEXISTS__GENLIST,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(mem_c_2Efcp_2EFCP__EXISTS,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efcp_2EFCP__EXISTS(A_27a,A_27a),arr(arr(A_27b,bool),arr(ty_2Efcp_2Ecart(A_27b,A_27b),bool))) )).
...
tff(conj_thm_2Efcp_2EFCP__EXISTS,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1v: $i] :
