...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__COMPOSE__QUOTIENT,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o,V4u: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) @ V3t )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1g @ V3t ) @ V4u )
        & ! [V5v: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V5v @ V3t )
           => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2s )
                @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                  @ ^ [V6x: tyop_2Erealax_2Ereal] :
                      ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V2s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V6x ) @ V5v ) ) ) ) )
              = ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3t ) @ V5v ) ) )
        & ( c_2Ereal__topology_2Econtinuous__on @ ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1g @ V0f ) @ V2s ) )
     => ( c_2Ereal__topology_2Econtinuous__on @ V1g @ V3t ) ) )).

thf(thm_2Ereal__topology_2EFUNCTION__FACTORS__LEFT__GEN,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0P: A_27a > $o,V1f: A_27a > A_27b,V2g: A_27a > A_27c] :
      ( ! [V3x: A_27a,V4y: A_27a] :
          ( ( ( V0P @ V3x )
            & ( V0P @ V4y )
            & ( ( V2g @ V3x )
...
thf(thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1h: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o,V4u: tyop_2Erealax_2Ereal > $o] :
           ...
           => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2s )
                @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                  @ ^ [V6x: tyop_2Erealax_2Ereal] :
                      ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V2s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V6x ) @ V5v ) ) ) ) )
              = ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3t ) @ V5v ) ) )
        & ( c_2Ereal__topology_2Econtinuous__on @ V1h @ V2s )
        & ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1h @ V2s )
          = V4u )
        & ! [V7x: tyop_2Erealax_2Ereal,V8y: tyop_2Erealax_2Ereal] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V2s )
              & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8y @ V2s )
              & ( ( V0f @ V7x )
                = ( V0f @ V8y ) ) )
           => ( ( V1h @ V7x )
              = ( V1h @ V8y ) ) ) )
     => ? [V9g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ( c_2Ereal__topology_2Econtinuous__on @ V9g @ V3t )
          & ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V9g @ V3t )
            = V4u )
          & ! [V10x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V10x @ V2s )
             => ( ( V1h @ V10x )
                = ( V9g @ ( V0f @ V10x ) ) ) ) ) ) )).
