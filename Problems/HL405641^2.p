...
thf(ax_thm_2Eordinal_2Edclose__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eordinal_2Edclose @ A_27a ) @ V0s )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ V1x )
                @ ( ap @ ( c_2Ebool_2E_3F @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
                  @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
                    @ ^ [V2y: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V2y ) @ V0s ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V1x ) @ V2y ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Edclose__BIGUNION,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eordinal_2Edclose @ A_27a ) @ V0s )
