...
thf(thm_2Eset__relation_2Enat__order__iso__thm,conjecture,(
    ! [A_27a: $tType,V0f: tyop_2Enum_2Enum > ( tyop_2Eoption_2Eoption @ A_27a ),V1s: A_27a > $o] :
      ( ( ! [V2n: tyop_2Enum_2Enum,V3m: tyop_2Enum_2Enum] :
            ( ( ( ( V0f @ V3m )
                = ( V0f @ V2n ) )
              & ( (~)
        ...
        & ! [V6m: tyop_2Enum_2Enum,V7x: A_27a] :
            ( ( ( V0f @ V6m )
     ...
     => ( ( c_2Eset__relation_2Elinear__order @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a )
            @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o )
              @ ^ [V8x: A_27a,V9y: A_27a] :
                  ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V8x @ V9y )
                  @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                    @ ^ [V10m: tyop_2Enum_2Enum] :
                        ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                        @ ^ [V11n: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( c_2Earithmetic_2E_3C_3D @ V10m @ V11n ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( V0f @ V10m ) @ ( c_2Eoption_2ESOME @ A_27a @ V8x ) ) @ ( c_2Emin_2E_3D @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( V0f @ V11n ) @ ( c_2Eoption_2ESOME @ A_27a @ V9y ) ) ) ) ) ) ) ) )
          @ V1s )
        & ( c_2Eset__relation_2Efinite__prefixes @ A_27a @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a )
            @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o )
              @ ^ [V12x: A_27a,V13y: A_27a] :
                  ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V12x @ V13y )
                  @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                    @ ^ [V14m: tyop_2Enum_2Enum] :
                        ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                        @ ^ [V15n: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( c_2Earithmetic_2E_3C_3D @ V14m @ V15n ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( V0f @ V14m ) @ ( c_2Eoption_2ESOME @ A_27a @ V12x ) ) @ ( c_2Emin_2E_3D @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( V0f @ V15n ) @ ( c_2Eoption_2ESOME @ A_27a @ V13y ) ) ) ) ) ) ) ) )
          @ V1s ) ) ) )).
