...
fof(lamtp_f2205,axiom,(
    ! [V3z] :
      ( mem(V3z,bool)
     => mem(f2205(V3z),arr(bool,arr(bool,bool))) ) )).
...
fof(lameq_f2205,axiom,(
    ! [V3z] :
     ...
     => ! [V4c] :
          ( mem(V4c,bool)
         => ap(f2205(V3z),V4c) = k(bool,ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,V4c)),V3z)) ) ) )).

fof(lamtp_f2204,axiom,(
    mem(f2204,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2204,axiom,(
    ! [V3z] :
      ( mem(V3z,bool)
     => ap(f2204,V3z) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2205(V3z)) ) )).
     ...
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ( p(ap(ap(c_2Ewords_2Eword__ls(A_27a),V0a),V1b))
              <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2204)))),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) ) )).
...
fof(conj_thm_2Ewords_2EWORD__SUB__REFL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__LS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
