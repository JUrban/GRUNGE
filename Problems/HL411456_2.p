...
tff(lmtp_f3941,type,(
    f3941: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3941,axiom,(
    ! [A_27a: del,V1c: $i] :
      ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3v: tp__ty_2Erealax_2Ereal] : mem(f3941(A_27a,V1c,V3v),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3941,axiom,(
    ! [A_27a: del,V1c: $i] :
      ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3v: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3941(A_27a,V1c,V3v),V4x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,V4x)),inj__ty_2Erealax_2Ereal(V3v)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__VMUL,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1c: $i] :
          ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2d: tp__ty_2Erealax_2Ereal,V3v: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1c),inj__ty_2Erealax_2Ereal(V2d)),V0net))
             => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3941(A_27a,V1c,V3v)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2d)),inj__ty_2Erealax_2Ereal(V3v))),V0net)) ) ) ) )).

tff(lmtp_f3942,type,(
    f3942: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3942,axiom,(
    ! [A_27a: del,V1c: $i] :
      ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2v: tp__ty_2Erealax_2Ereal] : mem(f3942(A_27a,V1c,V2v),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3942,axiom,(
    ! [A_27a: del,V1c: $i] :
      ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2v: tp__ty_2Erealax_2Ereal,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3942(A_27a,V1c,V2v),V3x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,V3x)),inj__ty_2Erealax_2Ereal(V2v)) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__VMUL,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1c: $i] :
          ( mem(V1c,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2v: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1c),V0net))
             => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3942(A_27a,V1c,V2v)),V0net)) ) ) ) )).
