...
thf(thm_2Eprim__rec_2EPRIM__REC,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1f_2E0: u,V2m: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( c_2Eprim__rec_2EPRIM__REC_2E3 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2m ) ) ) )
      = ( s @ A_27a @ ( c_2Eprim__rec_2EPRIM__REC__FUN_2E4 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2m ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2EPRE @ V2m ) ) ) ) ) ) )).

thf(thm_2Eprim__rec_2EPRIM__REC__THM,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1f_2E0: u] :
