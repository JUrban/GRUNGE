...
tff(lmtp_f3801,type,(
    f3801: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3801,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3801(V2k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3801,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3i: tp__ty_2Enum_2Enum] : ap(f3801(V2k,V0f),inj__ty_2Enum_2Enum(V3i)) = ap(V0f,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3i)),inj__ty_2Enum_2Enum(V2k))) ) )).

tff(conj_thm_2Ereal__topology_2ESEQ__OFFSET__NEG,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2k: tp__ty_2Enum_2Enum] :
         ...
         => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f3801(V2k,V0f)),inj__ty_2Erealax_2Ereal(V1l)),c_2Ereal__topology_2Esequentially)) ) ) )).
