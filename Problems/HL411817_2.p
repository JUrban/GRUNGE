...
tff(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL__SUBTOPOLOGY,lemma,(
    ! [V0s: $i] :
...
tff(lmtp_f4054,type,(
    f4054: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4054,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal] : mem(f4054(V0f,V4x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4054,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal,V5n: tp__ty_2Enum_2Enum] : ap(f4054(V0f,V4x),inj__ty_2Enum_2Enum(V5n)) = ap(ap(V0f,inj__ty_2Enum_2Enum(V5n)),inj__ty_2Erealax_2Ereal(V4x)) ) )).

tff(lmtp_f4056,type,(
    f4056: ( tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * $i * $i * $i ) > $i )).

tff(lamtp_f4056,axiom,(
    ! [V8e: tp__ty_2Erealax_2Ereal,V9n: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
...
tff(lameq_f4056,axiom,(
    ! [V8e: tp__ty_2Erealax_2Ereal,V9n: tp__ty_2Enum_2Enum,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
             => ! [V10x: tp__ty_2Erealax_2Ereal] : ap(f4056(V8e,V9n,V0f,V1g,V2s),inj__ty_2Erealax_2Ereal(V10x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V10x)),V2s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V0f,inj__ty_2Enum_2Enum(V9n)),inj__ty_2Erealax_2Ereal(V10x))),ap(V1g,inj__ty_2Erealax_2Ereal(V10x))))),inj__ty_2Erealax_2Ereal(V8e))) ) ) ) )).

tff(lmtp_f4055,type,(
    f4055: ( $i * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4055,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0f: $i] :
              ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
             => ! [V8e: tp__ty_2Erealax_2Ereal] : mem(f4055(V2s,V1g,V0f,V8e),arr(ty_2Enum_2Enum,bool)) ) ) ) )).

tff(lameq_f4055,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0f: $i] :
              ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
             => ! [V8e: tp__ty_2Erealax_2Ereal,V9n: tp__ty_2Enum_2Enum] : ap(f4055(V2s,V1g,V0f,V8e),inj__ty_2Enum_2Enum(V9n)) = ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f4056(V8e,V9n,V0f,V1g,V2s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EDINI,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ecompact,V2s))
                  & ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal__topology_2Econtinuous__on,ap(V0f,inj__ty_2Enum_2Enum(V3n))),V2s))
                  & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1g),V2s))
                  & ! [V4x: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V2s))
                     => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4054(V0f,V4x)),ap(V1g,inj__ty_2Erealax_2Ereal(V4x))),c_2Ereal__topology_2Esequentially)) )
                  & ! [V6n: tp__ty_2Enum_2Enum,V7x: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V2s))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(V0f,inj__ty_2Enum_2Enum(V6n)),inj__ty_2Erealax_2Ereal(V7x))),ap(ap(V0f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V7x)))) ) )
