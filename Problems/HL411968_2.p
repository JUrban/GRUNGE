...
tff(lmtp_f3363,type,(
    f3363: ( del * del * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3363,axiom,(
...
tff(lameq_f3363,axiom,(
    ! [A_27a: del,A_27a: del,V0b: tp__ty_2Erealax_2Ereal,V2a: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3363(A_27a,A_27a,V0b,V2a),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2a)),inj__ty_2Erealax_2Ereal(V0b)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__DELTA,lemma,(
    ! [A_27a: del,V0b: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2a: $i] :
          ( mem(V2a,A_27a)
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3363(A_27a,A_27a,V0b,V2a))) = surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V2a),V1s)),inj__ty_2Erealax_2Ereal(V0b)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__EQ__SUPERSET,lemma,(
    ! [A_27a: del,V0g: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN__IN,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INV,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__SETDIST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESETDIST__EQ__0__CLOSED__IN,lemma,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f4091,type,(
    f4091: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4091,axiom,(
    ! [V6f: $i] :
      ( mem(V6f,arr(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V11x: tp__ty_2Erealax_2Ereal] : mem(f4091(V6f,V11x),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4091,axiom,(
    ! [V6f: $i] :
      ( mem(V6f,arr(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V11x: tp__ty_2Erealax_2Ereal,V12u: $i] :
          ( mem(V12u,arr(ty_2Erealax_2Ereal,bool))
         => ap(f4091(V6f,V11x),V12u) = ap(ap(V6f,V12u),inj__ty_2Erealax_2Ereal(V11x)) ) ) )).

tff(lmtp_f4093,type,(
    f4093: ( $i * $i * $i ) > $i )).

tff(lamtp_f4093,axiom,(
    ! [V6f: $i] :
      ( mem(V6f,arr(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V15u: $i] :
...
tff(lameq_f4093,axiom,(
    ! [V6f: $i] :
     ...
     => ! [V15u: $i] :
         ...
         => ! [V14n: $i] :
              ( mem(V14n,arr(ty_2Erealax_2Ereal,bool))
             => ! [V16x: tp__ty_2Erealax_2Ereal] : ap(f4093(V6f,V15u,V14n),inj__ty_2Erealax_2Ereal(V16x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V16x)),V14n)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(V6f,V15u),inj__ty_2Erealax_2Ereal(V16x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) ) )).

tff(lmtp_f4092,type,(
    f4092: ( $i * $i * $i ) > $i )).

tff(lamtp_f4092,axiom,(
    ! [V0c: $i] :
      ( mem(V0c,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V6f: $i] :
          ( mem(V6f,arr(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
...
tff(conj_thm_2Ereal__topology_2ESUBORDINATE__PARTITION__OF__UNITY,conjecture,(
    ! [V0c: $i] :
      ( mem(V0c,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1s),ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0c)))
              ...
              & ! [V3x: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ? [V4v: $i] :
                      ...
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V4v))
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V7u),V0c))
                     => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,ap(V6f,V7u)),V1s))
                        & ! [V8x: tp__ty_2Erealax_2Ereal] :
                            ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),V1s))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(V6f,V7u),inj__ty_2Erealax_2Ereal(V8x)))) ) ) ) )
                & ! [V9x: tp__ty_2Erealax_2Ereal,V10u: $i] :
                    ( mem(V10u,arr(ty_2Erealax_2Ereal,bool))
                   => ( ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V10u),V0c))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9x)),V1s))
                        & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9x)),V10u)) )
                     => surj__ty_2Erealax_2Ereal(ap(ap(V6f,V10u),inj__ty_2Erealax_2Ereal(V9x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )
                & ! [V11x: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V11x)),V1s))
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(arr(ty_2Erealax_2Ereal,bool)),V0c),f4091(V6f,V11x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )
                & ! [V13x: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V13x)),V1s))
                   => ? [V14n: $i] :
                        ( mem(V14n,arr(ty_2Erealax_2Ereal,bool))
                        & p(ap(c_2Ereal__topology_2EOpen,V14n))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V13x)),V14n))
