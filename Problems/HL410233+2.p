...
fof(conj_thm_2Emeasure_2EMONOTONE__CONVERGENCE__BIGINTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
...
fof(conj_thm_2Emeasure_2EMONOTONE__CONVERGENCE__BIGINTER2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  ...
                  & ! [V2n] :
                     ...
                     => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(V1f,ap(c_2Enum_2ESUC,V2n))),ap(V1f,V2n))) ) )
