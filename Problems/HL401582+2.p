...
fof(conj_thm_2Epred__set_2EINJ__IMAGE__BIJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1f] :
                 ...
                 => ( ? [V2t] :
                        ( mem(V2t,arr(A_27b,bool))
                        & p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V1f),V0s),V2t)) )
                   => p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V1f),V0s),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),V0s))) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EBIJ__SYM__IMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1t] :
                 ...
                 => ( ? [V2f] :
                   ...
                   => ? [V3g] :
                        ...
                        & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27b,A_27b),V3g),V1t),V0s)) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EBIJ__TRANS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1t] :
                     ...
                     => ! [V2u] :
                         ...
                         => ( ( ? [V3f] :
                                  ...
                                  & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V3f),V0s),V1t)) )
                              & ? [V4g] :
                                  ( mem(V4g,arr(A_27c,A_27b))
                                  & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27c,A_27c),V4g),V1t),V2u)) ) )
                           => ? [V5h] :
                                ( mem(V5h,arr(A_27a,A_27b))
                                & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V5h),V0s),V2u)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN__AUTO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                 ...
                 => ( ( ? [V2f] :
                      ...
                      & ? [V3g] :
                          ( mem(V3g,arr(A_27b,A_27a))
                          & p(ap(ap(ap(c_2Epred__set_2EINJ(A_27b,A_27b),V3g),V1t),V0s)) ) )
                   => ? [V4h] :
