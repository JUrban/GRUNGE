...
fof(conj_thm_2Erich__list_2EBUTLASTN__APPEND2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ! [V2l2] :
                  ( mem(V2l2,ty_2Elist_2Elist(A_27a))
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V2l2)))
                   => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V2l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),V2l2)) ) ) ) ) ) )).
