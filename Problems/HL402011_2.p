...
tff(lamtp_f329,axiom,(
    ! [A_27a: del,A_27a: del,V0xs: $i] :
      ( mem(V0xs,arr(A_27a,bool))
     => ! [V1x1: $i] :
          ( mem(V1x1,A_27a)
         => mem(f329(A_27a,A_27a,V0xs,V1x1),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )).
...
tff(lameq_f329,axiom,(
    ! [A_27a: del,A_27a: del,V0xs: $i] :
     ...
     => ! [V1x1: $i] :
         ...
         => ! [V2x2: $i] :
              ( mem(V2x2,A_27a)
             => ap(f329(A_27a,A_27a,V0xs,V1x1),V2x2) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x1),V2x2)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V1x1),V0xs)),ap(ap(c_2Ebool_2EIN(A_27a),V2x2),V0xs))) ) ) ) )).

tff(lmtp_f328,type,(
    f328: ( del * del * del * $i ) > $i )).

tff(lamtp_f328,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V0xs: $i] :
      ( mem(V0xs,arr(A_27a,bool))
     => mem(f328(A_27a,A_27a,A_27a,V0xs),arr(A_27a,arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a))))) ) )).
...
tff(lameq_f328,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V0xs: $i] :
     ...
     => ! [V1x1: $i] :
          ( mem(V1x1,A_27a)
         => ap(f328(A_27a,A_27a,A_27a,V0xs),V1x1) = f329(A_27a,A_27a,V0xs,V1x1) ) ) )).

tff(ax_thm_2Eset__relation_2Euniv__reln__def,axiom,(
    ! [A_27a: del,V0xs: $i] :
      ( mem(V0xs,arr(A_27a,bool))
     => ap(c_2Eset__relation_2Euniv__reln(A_27a),V0xs) = ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f328(A_27a,A_27a,A_27a,V0xs))) ) )).

tff(lmtp_f348,type,(
    f348: ( del * del * $i * $i ) > $i )).

tff(lamtp_f348,axiom,(
...
tff(lmtp_f347,type,(
    f347: ( del * del * del * $i ) > $i )).

tff(lamtp_f347,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Eset__relation_2Euniv__reln__to__rel__conv,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
