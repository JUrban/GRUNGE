...
thf(thm_2Estring_2EisPREFIX__STRCAT,conjecture,(
    ...
    <=> ? [V2s3: mono_2Etyop_2Elist_2Elist_28tyop_2Estring_2Echar_29] :
          ( V1s2
          = ( mono_2Ec_2Elist_2EAPPEND_2Emono_2Etyop_2Estring_2Echar @ V0s1 @ V2s3 ) ) ) )).
