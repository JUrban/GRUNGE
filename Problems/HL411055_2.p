...
tff(lmtp_f1866,type,(
    f1866: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1866,axiom,(
...
tff(conj_thm_2Ecardinal_2EFINITE__IMAGE__INJ__GENERAL,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1A: $i] :
          ( mem(V1A,arr(A_27b,bool))
...
tff(conj_thm_2Ereal__topology_2EHEINE__BOREL__IMP__BOLZANO__WEIERSTRASS,conjecture,(
    ! [V0s: $i] :
