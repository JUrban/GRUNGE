...
fof(arityeq2_2Ec_2Esptree_2Elist__insert_2E2,axiom,(
    ! [X0_2E0,X1_2E0] : s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Elist__insert_2E2(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),X0_2E0),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),X1_2E0))) = s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),tyop_2Esptree_2Espt(tyop_2Eone_2Eone)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2Enum_2Enum),tyop_2Emin_2Efun(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),tyop_2Esptree_2Espt(tyop_2Eone_2Eone))),c_2Esptree_2Elist__insert_2E0),s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),X0_2E0))),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),X1_2E0))) )).
...
fof(thm_2Esptree_2Elist__insert__def,axiom,
    ( ! [V0t_2E0] : s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Elist__insert_2E2(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),c_2Elist_2ENIL_2E0),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V0t_2E0))) = s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V0t_2E0)
    & ! [V1n_2E0,V2ns_2E0,V3t_2E0] : s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Elist__insert_2E2(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),c_2Elist_2ECONS_2E2(s(tyop_2Enum_2Enum,V1n_2E0),s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),V2ns_2E0))),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V3t_2E0))) = s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Elist__insert_2E2(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),V2ns_2E0),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Einsert_2E3(s(tyop_2Enum_2Enum,V1n_2E0),s(tyop_2Eone_2Eone,c_2Eone_2Eone_2E0),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V3t_2E0))))) )).

fof(thm_2Esptree_2Edomain__list__insert,conjecture,(
    ! [V0xs_2E0,V1x_2E0,V2t_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),c_2Esptree_2Elist__insert_2E2(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),V0xs_2E0),s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V2t_2E0))))))))
    <=> ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),V0xs_2E0))))))
        | p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(tyop_2Eone_2Eone),V2t_2E0)))))) ) ) )).
