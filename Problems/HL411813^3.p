...
thf(thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE,axiom,(
...
thf(thm_2Ereal__topology_2ESERIES__REARRANGE__EQ,conjecture,(
    ! [V0x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2p: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V3l: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Esummable @ V1s
          @ ^ [V4n: tyop_2Enum_2Enum] :
              ( c_2Ereal_2Eabs @ ( V0x @ V4n ) ) )
        & ( c_2Ereal__topology_2Epermutes @ tyop_2Enum_2Enum @ V2p @ V1s ) )
     => ( ( c_2Ereal__topology_2Esums @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum @ V0x @ V2p ) @ V3l @ V1s )
        = ( c_2Ereal__topology_2Esums @ V0x @ V3l @ V1s ) ) ) )).
