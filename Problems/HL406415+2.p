...
fof(conj_thm_2Eucord_2Ex__lt__omega1__countable,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Eucord_2Eomega1__not__countable,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ~ p(ap(c_2Epred__set_2Ecountable(ty_2Eordinal_2Eordinal(ty_2Esum_2Esum(A_27a,A_27a))),ap(c_2Eordinal_2Epreds(ty_2Esum_2Esum(A_27a,A_27a)),c_2Eucord_2Eomega1(A_27a)))) ) )).
