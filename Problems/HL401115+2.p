...
fof(conj_thm_2Edivides_2EDIVIDES__REFL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => p(ap(ap(c_2Edivides_2Edivides,V0a),V0a)) ) )).

fof(conj_thm_2Edivides_2EDIVIDES__TRANS,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
...
fof(conj_thm_2Edivides_2EDIVIDES__LEQ__OR__ZERO,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Edivides_2EPRIME__FACTOR,conjecture,(
    ! [V0n] :
