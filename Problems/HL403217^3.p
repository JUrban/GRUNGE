...
thf(c_2Ebag_2EBAG__MERGE,type,(
    c_2Ebag_2EBAG__MERGE: 
      !>[A_27a: $tType] :
...
thf(thm_2Ebag_2EBAG__MERGE,axiom,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__MERGE @ A_27a @ V0b1 @ V1b2 )
      = ( ^ [V2x: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Eprim__rec_2E_3C @ ( V0b1 @ V2x ) @ ( V1b2 @ V2x ) ) @ ( V1b2 @ V2x ) @ ( V0b1 @ V2x ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INN__BAG__MERGE,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1e: A_27a,V2b1: A_27a > tyop_2Enum_2Enum,V3b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ ( c_2Ebag_2EBAG__MERGE @ A_27a @ V2b1 @ V3b2 ) )
    <=> ( ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ V2b1 )
        | ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ V3b2 ) ) ) )).
