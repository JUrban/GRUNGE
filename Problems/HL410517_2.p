...
tff(lamtp_f3639,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3639(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3639,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3639(V0f,V1g),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),ap(V1g,inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUB,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
           ...
           => p(ap(c_2Ereal__topology_2Elinear,f3639(V0f,V1g))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__EQ__0,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b: $i] :
...
tff(conj_thm_2Ereal__topology_2ELINEAR__EQ,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
