...
tff(conj_thm_2Ecardinal_2EINJECTIVE__ON__IMAGE,lemma,(
         ...
         => ( ! [V2s: $i] :
               ...
               => ! [V3t: $i] :
                   ...
                   => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V2s),V1u))
                        ...
                        & ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V3t) )
                     => V2s = V3t ) ) )
          <=> ! [V4x: $i] :
                ( mem(V4x,A_27a)
               => ! [V5y: $i] :
...
tff(conj_thm_2Ecardinal_2EINJECTIVE__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1s: $i] :
           ...
           => ! [V2t: $i] :
               ...
               => ( ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2t)
                 => V1s = V2t ) ) )
      <=> ! [V3x: $i] :
            ( mem(V3x,A_27a)
           => ! [V4y: $i] :
