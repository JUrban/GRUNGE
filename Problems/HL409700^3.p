...
thf(thm_2Eiterate_2EITERATE__CLAUSES__NUMSEG,axiom,(
    ! [A_27a: $tType,V0f: tyop_2Enum_2Enum > A_27a,V1op: A_27a > A_27a > A_27a] :
      ( ( c_2Eiterate_2Emonoidal @ A_27a @ V1op )
     => ( ! [V2m: tyop_2Enum_2Enum] :
            ( ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V1op @ ( c_2Eiterate_2E_2E_2E @ V2m @ c_2Enum_2E0 ) @ V0f )
            = ( c_2Ebool_2ECOND @ A_27a @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V2m @ c_2Enum_2E0 ) @ ( V0f @ c_2Enum_2E0 ) @ ( c_2Eiterate_2Eneutral @ A_27a @ V1op ) ) )
        & ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
            ( ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V1op @ ( c_2Eiterate_2E_2E_2E @ V3m @ ( c_2Enum_2ESUC @ V4n ) ) @ V0f )
            = ( c_2Ebool_2ECOND @ A_27a @ ( c_2Earithmetic_2E_3C_3D @ V3m @ ( c_2Enum_2ESUC @ V4n ) ) @ ( V1op @ ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V1op @ ( c_2Eiterate_2E_2E_2E @ V3m @ V4n ) @ V0f ) @ ( V0f @ ( c_2Enum_2ESUC @ V4n ) ) ) @ ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V1op @ ( c_2Eiterate_2E_2E_2E @ V3m @ V4n ) @ V0f ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__PAIR,conjecture,(
    ! [A_27a: $tType,V0op: A_27a > A_27a > A_27a] :
      ( ( c_2Eiterate_2Emonoidal @ A_27a @ V0op )
     => ! [V1f: tyop_2Enum_2Enum > A_27a,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
          ( ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V0op @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V2m ) @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V3n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V1f )
          = ( c_2Eiterate_2Eiterate @ tyop_2Enum_2Enum @ A_27a @ V0op @ ( c_2Eiterate_2E_2E_2E @ V2m @ V3n )
            @ ^ [V4i: tyop_2Enum_2Enum] :
                ( V0op @ ( V1f @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V4i ) ) @ ( V1f @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V4i ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
