...
fof(conj_thm_2Eiterate_2EITERATE__CLAUSES__NUMSEG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1op] :
             ...
             => ( p(ap(c_2Eiterate_2Emonoidal(A_27a),V1op))
               => ( ! [V2m] :
                     ...
                     => ap(ap(ap(c_2Eiterate_2Eiterate(ty_2Enum_2Enum,ty_2Enum_2Enum),V1op),ap(ap(c_2Eiterate_2E_2E_2E,V2m),c_2Enum_2E0)),V0f) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2m),c_2Enum_2E0)),ap(V0f,c_2Enum_2E0)),ap(c_2Eiterate_2Eneutral(A_27a),V1op)) )
                  & ! [V3m] :
                      ( mem(V3m,ty_2Enum_2Enum)
                     => ! [V4n] :
                          ( mem(V4n,ty_2Enum_2Enum)
                         => ap(ap(ap(c_2Eiterate_2Eiterate(ty_2Enum_2Enum,ty_2Enum_2Enum),V1op),ap(ap(c_2Eiterate_2E_2E_2E,V3m),ap(c_2Enum_2ESUC,V4n))),V0f) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Earithmetic_2E_3C_3D,V3m),ap(c_2Enum_2ESUC,V4n))),ap(ap(V1op,ap(ap(ap(c_2Eiterate_2Eiterate(ty_2Enum_2Enum,ty_2Enum_2Enum),V1op),ap(ap(c_2Eiterate_2E_2E_2E,V3m),V4n)),V0f)),ap(V0f,ap(c_2Enum_2ESUC,V4n)))),ap(ap(ap(c_2Eiterate_2Eiterate(ty_2Enum_2Enum,ty_2Enum_2Enum),V1op),ap(ap(c_2Eiterate_2E_2E_2E,V3m),V4n)),V0f)) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eiterate_2EITERATE__PAIR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0op] :
          ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
