...
thf(conj_thm_2Ereal__topology_2EDIAMETER__SUBSET__CBALL__NONEMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
          & ( V0s
...
thf(conj_thm_2Ereal__topology_2ELEBESGUE__COVERING__LEMMA,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
              & ( V1c
               != ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
              & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V1c ) ) )
              & ! [V2b: $i] :
                  ( ( mem @ V2b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2b ) @ V1c ) )
                   => ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V2b ) ) ) ) )
           => ? [V3d: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V4t: $i] :
                   ...
                   => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V4t ) @ V0s ) )
                        & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal__topology_2Ediameter @ V4t ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) )
                     => ? [V5b: $i] :
                          ( ( mem @ V5b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                          & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V5b ) @ V1c ) )
                          & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V4t ) @ V5b ) ) ) ) ) ) ) ) ) )).
