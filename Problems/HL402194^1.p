...
thf(arityeq2_2Emono_2Ec_2Elist_2EMAP_2E2_2Emono_2EA_27a_20mono_2Etyop_2Enum_2Enum,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Elist_2Elist_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Elist_2Elist @ tyop_2Enum_2Enum ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Elist_2Elist_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Elist_2Elist @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ tyop_2Enum_2Enum ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ tyop_2Enum_2Enum ) ) ) @ c_2Elist_2EMAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2Elist_2ESUM,axiom,
    ( ( ( mono_2Ec_2Elist_2ESUM @ mono_2Ec_2Elist_2ENIL_2Emono_2Etyop_2Enum_2Enum )
      = mono_2Ec_2Enum_2E0 )
    & ! [V0h: mono_2Etyop_2Enum_2Enum,V1t: mono_2Etyop_2Elist_2Elist_28tyop_2Enum_2Enum_29] :
        ( ( mono_2Ec_2Elist_2ESUM @ ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Enum_2Enum @ V0h @ V1t ) )
        = ( mono_2Ec_2Earithmetic_2E_2B @ V0h @ ( mono_2Ec_2Elist_2ESUM @ V1t ) ) ) )).
...
thf(thm_2Epred__set_2ESUM__IMAGE__DELETE,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1s_2E0: u] :
     ...
     => ! [V2e_2E0: u] :
          ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EDELETE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) ) ) )
          = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2E_2D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Elist_2ESUM__IMAGE__LIST__TO__SET__upper__bound,conjecture,(
    ! [A_27a: d,V0f_2E0: u,V1ls_2E0: u] :
      ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1ls_2E0 ) ) ) ) ) ) @ ( mono_2Ec_2Elist_2ESUM @ ( j_mono_2Etyop_2Elist_2Elist_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Elist_2Elist @ tyop_2Enum_2Enum ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1ls_2E0 ) ) ) ) ) ) )).
