...
thf(conj_thm_2Equotient_2EABSTRACT__PRS,conjecture,(
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27b @ A_27d ) @ V3R2 ) @ V4abs2 ) @ V5rep2 ) )
                             => ! [V6f: $i] :
                                 ...
                                 => ( V6f
                                    = ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27c @ A_27b @ A_27a @ A_27d ) @ V2rep1 ) @ V4abs2 ) @ ( ap @ ( ap @ ( c_2Ebool_2ERES__ABSTRACT @ A_27a @ A_27b ) @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V0R1 ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ A_27d @ A_27c @ A_27b ) @ V1abs1 ) @ V5rep2 ) @ V6f ) ) ) ) ) ) ) ) ) ) ) ) ) )).
