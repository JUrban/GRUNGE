...
thf(conj_thm_2Eprobability_2EPROB__UNIV,lemma,(
    ! [A_27a: del,V0p: $i] :
              ...
              = ( surj__ty_2Erealax_2Ereal
                @ ( ap
                  @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27a )
                    @ ( lam @ A_27a
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ ( c_2Eprobability_2Eprob @ A_27a ) @ V0p ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V3x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) )
                  @ V1s ) ) ) ) ) ) )).

thf(conj_thm_2Eprobability_2EPROB__REAL__SUM__IMAGE__SPACE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ( ( ( p @ ( ap @ ( c_2Eprobability_2Eprob__space @ A_27a ) @ V0p ) )
          & ! [V1x: $i] :
