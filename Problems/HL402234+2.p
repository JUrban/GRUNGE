...
fof(lamtp_f425,axiom,(
    ! [A_27a,V2b] :
      ( mem(V2b,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => mem(f425(A_27a,V2b,V0f),arr(ty_2Enum_2Enum,A_27a)) ) ) )).
    ...
    ! [A_27a,V2b] :
     ...
     => ! [V0f] :
         ...
         => ! [V3t] :
             ...
             => ap(f425(A_27a,V2b,V0f),V3t) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,V3t),V2b)) ) ) ) )).

fof(conj_thm_2Elist_2EGENLIST__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
