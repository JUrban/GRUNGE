...
tff(mem_c_2Ewords_2Eword__hs,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__hs(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),bool))) )).
...
tff(lamtp_f2208,axiom,(
    mem(f2208,arr(bool,arr(bool,bool))) )).

tff(lameq_f2208,axiom,(
    ! [V4c: tp__o] : ap(f2208,inj__o(V4c)) = k(bool,ap(c_2Ebool_2E_7E,inj__o(V4c))) )).
...
tff(lamtp_f2209,axiom,(
    mem(f2209,arr(bool,arr(bool,bool))) )).

tff(lameq_f2209,axiom,(
    ! [V4c: tp__o] : ap(f2209,inj__o(V4c)) = k(bool,inj__o(V4c)) )).
...
tff(conj_thm_2Ewords_2EWORD__HS,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
