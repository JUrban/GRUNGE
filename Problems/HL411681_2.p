...
tff(conj_thm_2Ereal__topology_2ECBALL__TRIVIAL,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__CBALL,lemma,(
...
tff(conj_thm_2Ereal__topology_2EEMPTY__INTERIOR__FINITE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EFINITE__CBALL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1r: tp__ty_2Erealax_2Ereal] :
      ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r)))))
