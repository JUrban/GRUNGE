...
fof(lamtp_f1906,axiom,(
    ! [A_27b,A_27b] : mem(f1906(A_27b,A_27b),arr(A_27b,arr(A_27b,A_27b))) )).
...
fof(conj_thm_2Efinite__map_2EFMERGE__FUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Efinite__map_2EFUNION(A_27a,A_27a) = ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),f1906(A_27b,A_27b)) ) ) )).
