...
thf(thm_2EquantHeuristics_2EGUESS__RULES__IMP,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0q: $o,V1p: $o,V2iK: A_27b,V3i: A_27a > A_27b,V4Q: A_27b > $o,V5P: A_27b > $o] :
      ( ( ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b @ V3i
          @ ^ [V6x: A_27b] :
              ( V5P @ V6x ) )
       => ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b @ V3i
          @ ^ [V7x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V7x ) @ ( V4Q @ V7x ) ) ) )
      & ( ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b @ V3i
          @ ^ [V8x: A_27b] :
              ( V4Q @ V8x ) )
       => ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b @ V3i
          @ ^ [V9x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V9x ) @ ( V4Q @ V9x ) ) ) )
      & ( ( ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b @ V3i
            @ ^ [V10x: A_27b] :
                ( V5P @ V10x ) )
          & ( c_2EquantHeuristics_2EGUESS__EXISTS @ A_27a @ A_27b @ V3i
       ...
       => ( c_2EquantHeuristics_2EGUESS__EXISTS @ A_27a @ A_27b @ V3i
          @ ^ [V12x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V12x ) @ ( V4Q @ V12x ) ) ) )
      & ( ( ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b @ V3i
            @ ^ [V13x: A_27b] :
                ( V5P @ V13x ) )
          & ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b @ V3i
       ...
       => ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b @ V3i
          @ ^ [V15x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V15x ) @ ( V4Q @ V15x ) ) ) )
      & ( ( ( c_2EquantHeuristics_2EGUESS__EXISTS @ tyop_2Eone_2Eone @ A_27b
       ...
       => ( c_2EquantHeuristics_2EGUESS__FORALL @ tyop_2Eone_2Eone @ A_27b
          @ ^ [V20xxx: tyop_2Eone_2Eone] : V2iK
          @ ^ [V21x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V21x ) @ ( V4Q @ V21x ) ) ) )
      & ( ( c_2EquantHeuristics_2EGUESS__EXISTS @ A_27a @ A_27b @ V3i
          @ ^ [V22x: A_27b] :
              ( V5P @ V22x ) )
       => ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b @ V3i
          @ ^ [V23x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V23x ) @ V0q ) ) )
      & ( ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b @ V3i
          @ ^ [V24x: A_27b] :
              ( V4Q @ V24x ) )
       => ( c_2EquantHeuristics_2EGUESS__FORALL @ A_27a @ A_27b @ V3i
          @ ^ [V25x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ V1p @ ( V4Q @ V25x ) ) ) )
      & ( ( ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b @ V3i
            @ ^ [V26x: A_27b] :
                ( V5P @ V26x ) )
          & ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b @ V3i
       ...
       => ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b @ V3i
          @ ^ [V28x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V28x ) @ ( V4Q @ V28x ) ) ) )
      & ( ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b @ V3i
          @ ^ [V29x: A_27b] :
              ( V5P @ V29x ) )
       => ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b @ V3i
          @ ^ [V30x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V30x ) @ ( V4Q @ V30x ) ) ) )
      & ( ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b @ V3i
          @ ^ [V31x: A_27b] :
              ( V4Q @ V31x ) )
       => ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b @ V3i
          @ ^ [V32x: A_27b] :
              ( c_2Emin_2E_3D_3D_3E @ ( V5P @ V32x ) @ ( V4Q @ V32x ) ) ) ) ) )).
