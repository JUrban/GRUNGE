...
thf(conj_thm_2Ereal__topology_2EOPEN__TRANSLATION__EQ,lemma,(
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__TRANSLATION,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Einterior
          @ ( ap
            @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V2x: $i] :
