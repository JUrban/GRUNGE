...
thf(c_2EordinalNotation_2Erestn_2E0,type,(
    c_2EordinalNotation_2Erestn_2E0: u )).

thf(c_2EordinalNotation_2Erestn_2E2,type,(
...
thf(mono_2Ec_2EordinalNotation_2Erestn,type,(
    mono_2Ec_2EordinalNotation_2Erestn: mono_2Etyop_2EordinalNotation_2Eosyntax > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2EordinalNotation_2Eosyntax )).
...
thf(thm_2EordinalNotation_2Erestn__def,axiom,
    ( ! [V0a: mono_2Etyop_2EordinalNotation_2Eosyntax] :
        ( ( mono_2Ec_2EordinalNotation_2Erestn @ V0a @ mono_2Ec_2Enum_2E0 )
        = V0a )
    & ! [V1a: mono_2Etyop_2EordinalNotation_2Eosyntax,V2n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EordinalNotation_2Erestn @ V1a @ ( mono_2Ec_2Enum_2ESUC @ V2n ) )
        = ( mono_2Ec_2EordinalNotation_2Erestn @ ( mono_2Ec_2EordinalNotation_2Etail @ V1a ) @ V2n ) ) )).

thf(thm_2EordinalNotation_2Erestn__def__compute,conjecture,
    ( ! [V0a: mono_2Etyop_2EordinalNotation_2Eosyntax] :
        ( ( mono_2Ec_2EordinalNotation_2Erestn @ V0a @ mono_2Ec_2Enum_2E0 )
        = V0a )
    & ! [V1a: mono_2Etyop_2EordinalNotation_2Eosyntax,V2n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EordinalNotation_2Erestn @ V1a @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2n ) ) )
        = ( mono_2Ec_2EordinalNotation_2Erestn @ ( mono_2Ec_2EordinalNotation_2Etail @ V1a ) @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2n ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
    & ! [V3a: mono_2Etyop_2EordinalNotation_2Eosyntax,V4n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EordinalNotation_2Erestn @ V3a @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V4n ) ) )
        = ( mono_2Ec_2EordinalNotation_2Erestn @ ( mono_2Ec_2EordinalNotation_2Etail @ V3a ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V4n ) ) ) ) )).
