...
tff(lamtp_f3172,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => mem(f3172(A_27a,V2f,V1P),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3172,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3172(A_27a,V2f,V1P),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(V1P,V4x)),ap(V2f,V4x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IF__ELIM,conjecture,(
    ! [A_27a: del,V0s: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                  & ! [V3x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s))
                       => p(ap(V1P,V3x)) ) ) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3172(A_27a,V2f,V1P)),V0s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V2f),V0s)) ) ) ) ) )).
