...
thf(conj_thm_2Estring__num_2En2s__def,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
                      ...
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V2r: $i] :
                            ...
                            @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ ty_2Estring_2Echar ) @ ( ty_2Elist_2Elist @ ty_2Estring_2Echar ) )
                              @ ( lam @ ( ty_2Elist_2Elist @ ty_2Estring_2Echar )
                                @ ^ [V3s0: $i] :
                                    ( ap @ ( ap @ ( c_2Elist_2ECONS @ ty_2Estring_2Echar ) @ ( ap @ c_2Estring_2ECHR @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V2r ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ V3s0 ) ) )
