...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__CONST,lemma,(
    ! [A_27a: del,V0a: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
              & ! [V3x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Espace(A_27a),V0a)))
                   => surj__ty_2Eextreal_2Eextreal(ap(V2f,V3x)) = V1k ) ) )
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__zero,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
...
tff(lmtp_f4149,type,(
    f4149: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4149,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f4149(A_27a,V1s,V2c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4149,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2c: tp__ty_2Erealax_2Ereal,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f4149(A_27a,V1s,V2c),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V2c))),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s),V3x)) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4149(A_27a,V1s,V2c))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)))) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__const,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
         => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),k(A_27a,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V1c))))) ) ) )).
