...
fof(lameq_f881,axiom,(
    ! [V1b] :
     ...
     => ! [V4t] :
          ( mem(V4t,ty_2Enum_2Enum)
         => ap(f881(V1b),V4t) = ap(c_2Ebool_2E_7E,ap(V1b,V4t)) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EUNTIL__LINORD,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             ...
             => ( p(ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0a),V1b),V2t0))
              <=> ! [V3t1] :
                   ...
                   => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2t0),V3t1))
                        & ~ p(ap(V1b,V3t1))
                        & p(ap(c_2ETemporal__Logic_2EUPTO,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2t0),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3t1),f881(V1b))))) )
                     => p(ap(V0a,V3t1)) ) ) ) ) ) ) )).
