...
fof(conj_thm_2Epred__set_2EFINITE__CROSS__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efloat_2ESIGN,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(c_2Eieee_2Esign,V0a) = ap(c_2Epair_2EFST(ty_2Enum_2Enum,ty_2Enum_2Enum),V0a) ) )).

fof(conj_thm_2Efloat_2EEXPONENT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(c_2Eieee_2Eexponent,V0a) = ap(c_2Epair_2EFST(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum),V0a)) ) )).

fof(conj_thm_2Efloat_2EFRACTION,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(c_2Eieee_2Efraction,V0a) = ap(c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum),V0a)) ) )).

fof(conj_thm_2Efloat_2EIS__VALID,lemma,(
    ! [V0X] :
     ...
     => ! [V1a] :
         ...
         => ( p(ap(ap(c_2Eieee_2Eis__valid,V0X),V1a))
          <=> ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Eieee_2Esign,V1a)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))))
              & p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Eieee_2Eexponent,V1a)),ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),ap(c_2Eieee_2Eexpwidth,V0X))))
              & p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Eieee_2Efraction,V1a)),ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),ap(c_2Eieee_2Efracwidth,V0X)))) ) ) ) ) )).

fof(lamtp_f3239,axiom,(
    ! [V0X] :
      ( mem(V0X,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f3239(V0X),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).
...
fof(lameq_f3239,axiom,(
    ! [V0X] :
     ...
     => ! [V1a] :
          ( mem(V1a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => ap(f3239(V0X),V1a) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V1a),ap(ap(c_2Eieee_2Eis__valid,V0X),V1a)) ) ) )).

fof(conj_thm_2Efloat_2EIS__VALID__FINITE,conjecture,(
    ! [V0X] :
      ( mem(V0X,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),f3239(V0X)))) ) )).
