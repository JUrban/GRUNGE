...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__IMP__OPEN__IN,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V1s )
        & ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) @ V2t ) )
...
thf(thm_2Ereal__topology_2EHOMEOMORPHISM__SYM,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o] :
      ...
      = ( c_2Ereal__topology_2Ehomeomorphism @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V3t @ V2s ) @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ ( tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal ) @ V1g @ V0f ) ) ) )).

thf(thm_2Ereal__topology_2Elocally,axiom,(
    ! [V0P: ( tyop_2Erealax_2Ereal > $o ) > $o,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Elocally @ V0P @ V1s )
    <=> ! [V2w: tyop_2Erealax_2Ereal > $o,V3x: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V1s ) @ V2w )
            & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V2w ) )
         => ? [V4u: tyop_2Erealax_2Ereal > $o,V5v: tyop_2Erealax_2Ereal > $o] :
              ...
              & ( V0P @ V5v )
              & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V4u )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V4u @ V5v )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V5v @ V2w ) ) ) ) )).
