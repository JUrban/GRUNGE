...
tff(conj_thm_2Efmapal_2EORL__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),bool)))
     => ( ( ! [V1cmp: $i] :
              ( mem(V1cmp,ty_2Etoto_2Etoto(A_27a))
             => p(ap(ap(V0P,V1cmp),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a)))) )
          & ! [V2cmp: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ! [V5l: $i] :
                         ...
                         => ( p(ap(ap(V0P,V2cmp),V5l))
                           => p(ap(ap(V0P,V2cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3a),V4b)),V5l))) ) ) ) ) ) )
       => ! [V6v: $i] :
            ( mem(V6v,ty_2Etoto_2Etoto(A_27a))
           => ! [V7v1: $i] :
                ( mem(V7v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
