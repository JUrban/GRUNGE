...
tff(conj_thm_2Efinite__map_2EFUPD__SAME__KEY__UNWIND,lemma,(
...
tff(conj_thm_2Efinite__map_2EFMEQ__ENUMERATE__CASES,lemma,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1kvl: $i] :
...
tff(conj_thm_2Efinite__map_2EFMEQ__SINGLE__SIMPLE__ELIM,conjecture,(
             ...
             => ! [V3ck: $i] :
                 ...
                 => ! [V4cv: $i] :
                     ...
                     => ! [V5nv: $i] :
                          ( mem(V5nv,A_27b)
                         => ( ? [V6fm: $i] :
                                ( mem(V6fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                                & ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V6fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V2v)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3ck),V4cv))
                                & p(ap(V0P,ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V6fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V5nv)))) )
                          <=> ( V1k = V3ck
                              & V2v = V4cv
                              & p(ap(V0P,ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3ck),V5nv)))) ) ) ) ) ) ) ) ) )).
