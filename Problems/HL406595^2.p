...
thf(conj_thm_2Esptree_2Ewf__fromAList,lemma,(
    ! [A_27a: del,V0ls: $i] :
      ( ( mem @ V0ls @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) )
     => ( p @ ( ap @ ( c_2Esptree_2Ewf @ A_27a ) @ ( ap @ ( c_2Esptree_2EfromAList @ A_27a ) @ V0ls ) ) ) ) )).

thf(conj_thm_2Esptree_2Ewf__mapi,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2Esptree_2Emapi__Alist,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27b @ A_27a ) ) )
     => ! [V1pt: $i] :
          ( ( mem @ V1pt @ ( ty_2Esptree_2Espt @ A_27b ) )
              ...
              @ ( ap
                @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27b ) @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) )
                  @ ( lam @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27b )
                    @ ^ [V2kv: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ ty_2Enum_2Enum @ A_27b ) @ V2kv ) ) @ ( ap @ ( ap @ V0f @ ( ap @ ( c_2Epair_2EFST @ ty_2Enum_2Enum @ A_27b ) @ V2kv ) ) @ ( ap @ ( c_2Epair_2ESND @ ty_2Enum_2Enum @ A_27b ) @ V2kv ) ) ) ) )
