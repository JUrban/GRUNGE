...
tff(conj_thm_2Equotient__list_2EFOLDL__RSP,conjecture,(
                                     ...
                                     => ! [V8f1: $i] :
                                         ...
                                         => ! [V9f2: $i] :
                                             ...
                                             => ! [V10e1: $i] :
                                                 ...
                                                 => ! [V11e2: $i] :
                                                      ( mem(V11e2,A_27a)
                                                     => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27b,A_27b),V3R2),V0R1)),V8f1),V9f2))
                                                          & p(ap(ap(V0R1,V10e1),V11e2))
                                                          & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27b,A_27b),V3R2),V6l1),V7l2)) )
                                                       => p(ap(ap(V0R1,ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V8f1),V10e1),V6l1)),ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V9f2),V11e2),V7l2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
