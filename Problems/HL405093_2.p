...
tff(conj_thm_2Efmaptree_2Erelrec__cases,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0h: $i] :
     ...
     => ! [V1a0: $i] :
         ...
         => ! [V2a1: $i] :
              ( mem(V2a1,A_27c)
             => ( p(ap(ap(ap(c_2Efmaptree_2Erelrec(A_27a,A_27a,A_27a),V0h),V1a0),V2a1))
              <=> ? [V3i: $i] :
                    ( mem(V3i,A_27a)
                    & ? [V4fm: $i] :
                        ( mem(V4fm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
                        & ? [V5rfm: $i] :
                            ( mem(V5rfm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
                            & V1a0 = ap(ap(c_2Efmaptree_2EFTNode(A_27b,A_27b),V3i),V4fm)
                            & V2a1 = ap(ap(ap(V0h,V3i),V5rfm),V4fm)
                            & ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V5rfm) = ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V4fm)
                            & ! [V6d: $i] :
                                ( mem(V6d,A_27b)
                               => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V6d),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V4fm)))
                                 => p(ap(ap(ap(c_2Efmaptree_2Erelrec(A_27a,A_27a,A_27a),V0h),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V4fm),V6d)),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V5rfm),V6d))) ) ) ) ) ) ) ) ) ) )).
