...
fof(conj_thm_2Eintegral_2EDINT__NEG,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
...
fof(lameq_f3204,axiom,(
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V6x] :
              ( mem(V6x,ty_2Erealax_2Ereal)
             => ap(f3204(V0f,V1g),V6x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V6x)),ap(V1g,V6x)) ) ) ) )).

fof(conj_thm_2Eintegral_2EDINT__SUB,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             ...
             => ! [V3b] :
                 ...
                 => ! [V4i] :
                     ...
                     => ! [V5j] :
                         ...
                         => ( ( p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V0f),V4i))
                              & p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V1g),V5j)) )
                           => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),f3204(V0f,V1g)),ap(ap(c_2Ereal_2Ereal__sub,V4i),V5j))) ) ) ) ) ) ) ) )).
