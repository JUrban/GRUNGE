...
tff(conj_thm_2Ereal__topology_2ESERIES__FINITE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V1s))
           => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),V1s),V0f)),V1s)) ) ) ) )).

tff(lmtp_f4014,type,(
    f4014: ( $i * $i ) > $i )).

tff(lamtp_f4014,axiom,(
    ! [V0x: $i] :
...
tff(lameq_f4014,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V5n: tp__ty_2Enum_2Enum] : ap(f4014(V0x,V2y),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0x,inj__ty_2Enum_2Enum(V5n))),ap(V2y,inj__ty_2Enum_2Enum(V5n))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__ADD,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3y0: tp__ty_2Erealax_2Ereal,V4s: $i] :
              ( mem(V4s,arr(ty_2Enum_2Enum,bool))
             => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V1x0)),V4s))
                  & p(ap(ap(ap(c_2Ereal__topology_2Esums,V2y),inj__ty_2Erealax_2Ereal(V3y0)),V4s)) )
               => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4014(V0x,V2y)),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V1x0)),inj__ty_2Erealax_2Ereal(V3y0))),V4s)) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ESUMS__FINITE__UNION,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V2t))
                    & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V3l)),V1s)) )
                 => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V3l)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),V2t),V1s)),V0f))),ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),V1s),V2t))) ) ) ) ) )).
