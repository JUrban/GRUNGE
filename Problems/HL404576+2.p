...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ__GENERAL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( ( ! [V2x] :
                         ...
                         => ! [V3y] :
                             ...
                             => ( ap(V0f,V2x) = ap(V0f,V3y)
                               => V2x = V3y ) ) )
                      & p(ap(c_2Epred__set_2Ecountable(A_27b),V1A)) )
                   => p(ap(c_2Epred__set_2Ecountable(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f1867(A_27b,A_27a,V1A,V0f)))) ) ) ) ) ) )).
