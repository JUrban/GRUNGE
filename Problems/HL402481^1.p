...
thf(f2881_0_2E0,type,(
    f2881_0_2E0: u )).

thf(f2881_0_2E1,type,(
    f2881_0_2E1: du > u )).

thf(f2881_0_2E2,type,(
    f2881_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2881_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2881_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2881_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2881_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2881_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2881_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__TWO__CASES,axiom,(
    ! [A_27a: d,V0y_2E0: u,V4x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2881_0_2E2 @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V4x_2E0 )
        = ( s @ A_27a @ V0y_2E0 ) ) ) )).

thf(thm_2EquantHeuristics_2EGUESS__RULES__TWO__CASES,conjecture,(
    ! [A_27a: d,A_27b: d,V0y_2E0: u,V1Q_2E0: u] :
      ( ! [V2x_2E0: u] :
          ( ( ( s @ A_27a @ V2x_2E0 )
            = ( s @ A_27a @ V0y_2E0 ) )
          | ? [V3fv_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2881_0_2E1 @ ( s @ A_27a @ V0y_2E0 ) ) ) ) ) ) ) )).
