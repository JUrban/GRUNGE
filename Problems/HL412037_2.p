...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Eintegral__indicator,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
              & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) )).
