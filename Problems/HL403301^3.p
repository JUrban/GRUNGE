...
thf(thm_2Ebag_2ESET__OF__BAG__DIFF__SUBSET__down,conjecture,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( c_2Epred__set_2ESUBSET @ A_27a @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V0b1 ) @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V1b2 ) ) @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V0b1 @ V1b2 ) ) ) )).
