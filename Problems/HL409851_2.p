...
tff(conj_thm_2Eiterate_2ESUM__LE__INCLUDED,lemma,(
...
tff(conj_thm_2Eiterate_2ESUM__IMAGE__LE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27b,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Eiterate_2ESum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),V1g)),ap(ap(c_2Eiterate_2ESum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V1g),V0f)))) ) ) ) ) )).
