...
fof(conj_thm_2Ewords_2Eword__bits__w2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0w] :
             ...
             => ! [V1h] :
                 ...
                 => ! [V2l] :
                     ...
                     => ap(ap(ap(c_2Ewords_2Eword__bits(A_27b),V1h),V2l),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2EMIN,V1h),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V2l),V0w)) ) ) ) ) ) )).
