    ...
    ! [V0p] :
     ...
     => ! [V1f] :
         ...
         => ! [V4i] :
             ...
             => ap(f3348(V0p,V1f),V4i) = ap(V1f,ap(ap(c_2Earithmetic_2E_2B,V4i),V0p)) ) ) ) )).

fof(conj_thm_2Eiterate_2ENSUM__OFFSET,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ap(ap(c_2Eiterate_2Ensum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,V2m),V0p)),ap(ap(c_2Earithmetic_2E_2B,V3n),V0p))),V1f) = ap(ap(c_2Eiterate_2Ensum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),f3348(V0p,V1f)) ) ) ) ) )).

fof(lamtp_f3349,axiom,(
    ! [V1m] :
      ( mem(V1m,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => mem(f3349(V1m,V0f),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) )).
    ...
    ! [V1m] :
     ...
     => ! [V0f] :
         ...
         => ! [V3i] :
             ...
             => ap(f3349(V1m,V0f),V3i) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,V3i),V1m)) ) ) ) )).

fof(conj_thm_2Eiterate_2ENSUM__OFFSET__0,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2n] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V2n))
               => ap(ap(c_2Eiterate_2Ensum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)),V0f) = ap(ap(c_2Eiterate_2Ensum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,V2n),V1m))),f3349(V1m,V0f)) ) ) ) ) )).
