...
tff(conj_thm_2Einftree_2Erelrec__strongind,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0relrec_27: $i] :
      ( mem(V0relrec_27,arr(arr(A_27a,A_27b),arr(arr(A_27c,arr(arr(A_27d,A_27b),A_27b)),arr(ty_2Einftree_2Einftree(A_27a,A_27a,A_27a),arr(A_27b,bool)))))
     => ( ( ! [V1lf: $i] :
             ...
             => ! [V2nd: $i] :
                 ...
                 => ! [V3a: $i] :
                      ( mem(V3a,A_27a)
                     => p(ap(ap(ap(ap(V0relrec_27,V1lf),V2nd),ap(c_2Einftree_2EiLf(A_27a,A_27a,A_27a),V3a)),ap(V1lf,V3a))) ) ) )
          & ! [V4lf: $i] :
             ...
             => ! [V5nd: $i] :
                 ...
                 => ! [V6b: $i] :
                      ( mem(V6b,A_27c)
                     => ! [V7df: $i] :
                          ( mem(V7df,arr(A_27d,ty_2Einftree_2Einftree(A_27a,A_27a,A_27a)))
                         => ! [V8g: $i] :
                              ( mem(V8g,arr(A_27d,A_27b))
                             => ( ! [V9d: $i] :
                                    ( mem(V9d,A_27d)
                                   => ( p(ap(ap(ap(ap(c_2Einftree_2Erelrec(A_27a,A_27a,A_27a,A_27a),V4lf),V5nd),ap(V7df,V9d)),ap(V8g,V9d)))
                                      & p(ap(ap(ap(ap(V0relrec_27,V4lf),V5nd),ap(V7df,V9d)),ap(V8g,V9d))) ) )
                               => p(ap(ap(ap(ap(V0relrec_27,V4lf),V5nd),ap(ap(c_2Einftree_2EiNd(A_27a,A_27a,A_27a),V6b),V7df)),ap(ap(V5nd,V6b),V8g))) ) ) ) ) ) ) )
       => ! [V10a0: $i] :
            ( mem(V10a0,arr(A_27a,A_27b))
           => ! [V11a1: $i] :
                ( mem(V11a1,arr(A_27c,arr(arr(A_27d,A_27b),A_27b)))
               => ! [V12a2: $i] :
                    ( mem(V12a2,ty_2Einftree_2Einftree(A_27a,A_27a,A_27a))
                   => ! [V13a3: $i] :
                        ( mem(V13a3,A_27b)
                       => ( p(ap(ap(ap(ap(c_2Einftree_2Erelrec(A_27a,A_27a,A_27a,A_27a),V10a0),V11a1),V12a2),V13a3))
