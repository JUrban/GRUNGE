...
tff(lameq_f4120,axiom,(
    ! [V5x: $i] :
      ( mem(V5x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V6y: $i] :
          ( mem(V6y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V8i: tp__ty_2Enum_2Enum] : ap(f4120(V5x,V6y),inj__ty_2Enum_2Enum(V8i)) = ap(ap(c_2Erealax_2Ereal__add,ap(V5x,inj__ty_2Enum_2Enum(V8i))),ap(V6y,inj__ty_2Enum_2Enum(V8i))) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__simple__fn__add__alt,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(lamtp_f4125,axiom,(
    ! [V4x: $i] :
      ( mem(V4x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V6y: $i] :
          ( mem(V6y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4125(V4x,V6y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f4125,axiom,(
    ! [V4x: $i] :
      ( mem(V4x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V6y: $i] :
          ( mem(V6y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V7i: tp__ty_2Enum_2Enum] : ap(f4125(V4x,V6y),inj__ty_2Enum_2Enum(V7i)) = ap(ap(c_2Erealax_2Ereal__add,ap(V4x,inj__ty_2Enum_2Enum(V7i))),ap(V6y,inj__ty_2Enum_2Enum(V7i))) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__add__alt,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(lameq_f4132,axiom,(
    ! [A_27a: del,A_27b: del,V1f: $i] :
     ...
     => ! [V7t: $i] :
         ...
         => ! [V8i: $i] :
              ( mem(V8i,A_27b)
             => ap(f4132(A_27a,A_27b,V1f,V7t),V8i) = ap(ap(V1f,V8i),V7t) ) ) ) )).

tff(lmtp_f4131,type,(
    f4131: ( del * del * $i * $i ) > $i )).

tff(lamtp_f4131,axiom,(
    ! [A_27b: del,A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27b,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => mem(f4131(A_27b,A_27a,V1f,V5P),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f4131,axiom,(
    ! [A_27b: del,A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27b,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => ! [V7t: $i] :
              ( mem(V7t,A_27a)
             => ap(f4131(A_27b,A_27a,V1f,V5P),V7t) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f4132(A_27a,A_27b,V1f,V7t)),V5P) ) ) ) )).

tff(lmtp_f4134,type,(
    f4134: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f4134,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V9i: tp__ty_2Enum_2Enum] : mem(f4134(A_27b,V4x,V9i),arr(A_27b,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4134,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V9i: tp__ty_2Enum_2Enum,V10j: $i] :
          ( mem(V10j,A_27b)
         => ap(f4134(A_27b,V4x,V9i),V10j) = ap(ap(V4x,V10j),inj__ty_2Enum_2Enum(V9i)) ) ) )).

tff(lmtp_f4133,type,(
    f4133: ( del * $i * $i ) > $i )).

tff(lamtp_f4133,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => mem(f4133(A_27b,V4x,V5P),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f4133,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => ! [V9i: tp__ty_2Enum_2Enum] : ap(f4133(A_27b,V4x,V5P),inj__ty_2Enum_2Enum(V9i)) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4134(A_27b,V4x,V9i)),V5P) ) ) )).

tff(lmtp_f4136,type,(
    f4136: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f4136,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V11j: tp__ty_2Enum_2Enum] : mem(f4136(A_27b,V4x,V11j),arr(A_27b,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4136,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V11j: tp__ty_2Enum_2Enum,V12i: $i] :
          ( mem(V12i,A_27b)
         => ap(f4136(A_27b,V4x,V11j),V12i) = ap(ap(V4x,V12i),inj__ty_2Enum_2Enum(V11j)) ) ) )).

tff(lmtp_f4135,type,(
    f4135: ( del * $i * $i ) > $i )).

tff(lamtp_f4135,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => mem(f4135(A_27b,V4x,V5P),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f4135,axiom,(
    ! [A_27b: del,V4x: $i] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P: $i] :
          ( mem(V5P,arr(A_27b,bool))
         => ! [V11j: tp__ty_2Enum_2Enum] : ap(f4135(A_27b,V4x,V5P),inj__ty_2Enum_2Enum(V11j)) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4136(A_27b,V4x,V11j)),V5P) ) ) )).

tff(lmtp_f4137,type,(
    f4137: ( del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f4137,axiom,(
    ! [A_27a: del,A_27b: del,V3a: $i] :
     ...
     => ! [V0m: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V4x: $i] :
                  ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
                 => mem(f4137(A_27a,A_27b,V3a,V0m,V2s,V4x),arr(A_27b,ty_2Eextreal_2Eextreal)) ) ) ) ) )).

tff(lameq_f4137,axiom,(
    ! [A_27a: del,A_27b: del,V3a: $i] :
      ( mem(V3a,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2s: $i] :
             ...
             => ! [V4x: $i] :
                 ...
                 => ! [V13i: $i] :
                      ( mem(V13i,A_27b)
                     => ap(f4137(A_27a,A_27b,V3a,V0m,V2s,V4x),V13i) = ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),ap(V4x,V13i)) ) ) ) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__sum,conjecture,(
                 ...
                 => ! [V4x: $i] :
                     ...
                     => ! [V5P: $i] :
                         ...
                         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                           ...
                           => ( p(ap(ap(ap(ap(ap(c_2Emeasure_2Epos__simple__fn(A_27a),V0m),f4131(A_27b,A_27a,V1f,V5P)),V2s),V3a),f4133(A_27b,V4x,V5P)))
                              & surj__ty_2Eextreal_2Eextreal(ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),f4135(A_27b,V4x,V5P))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f4137(A_27a,A_27b,V3a,V0m,V2s,V4x)),V5P)) ) ) ) ) ) ) ) ) )).
