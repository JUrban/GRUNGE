...
thf(thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,axiom,(
    ...
    <=> ! [V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
                    ...
                    & ! [V4y: tyop_2Erealax_2Ereal] :
                        ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V0s )
                          & ( (~)
                            @ ( ( V1f @ V4y )
                              = ( V1f @ V2x ) ) ) )
                       => ( c_2Ereal_2Ereal__lte @ V3e @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V1f @ V4y ) @ ( V1f @ V2x ) ) ) ) ) ) ) )
                ...
                & ! [V4y: tyop_2Erealax_2Ereal] :
                    ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V1s )
                      & ( (~)
                        @ ( ( V0f @ V4y )
                          = ( V0f @ V2x ) ) ) )
                   => ( c_2Ereal_2Ereal__lte @ V3e @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V0f @ V4y ) @ ( V0f @ V2x ) ) ) ) ) ) ) )
     => ? [V5a: tyop_2Erealax_2Ereal] :
        ! [V6x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V1s )
         => ( ( V0f @ V6x )
            = V5a ) ) ) )).
