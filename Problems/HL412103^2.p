...
thf(conj_thm_2Epred__set_2ECOUNTABLE__ENUM,lemma,(
    ! [A_27a: del,V0c: $i] :
...
thf(conj_thm_2Eprobability_2EPROB__COUNTABLY__SUBADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Eprobability_2EPROB__COUNTABLY__ZERO,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
