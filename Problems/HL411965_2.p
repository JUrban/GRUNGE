...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(lamtp_f3624,axiom,(
    ! [A_27a: del,A_27a: del,V0u: $i] :
      ( mem(V0u,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(arr(A_27a,bool),bool))
         => mem(f3624(A_27a,A_27a,V0u,V1s),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).
...
tff(lameq_f3624,axiom,(
    ! [A_27a: del,A_27a: del,V0u: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
              ( mem(V2t,arr(A_27a,bool))
             => ap(f3624(A_27a,A_27a,V0u,V1s),V2t) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EDIFF(A_27a),V0u),V2t)),ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2t),V1s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EDIFF__BIGINTER,lemma,(
    ! [A_27a: del,V0u: $i] :
      ( mem(V0u,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(arr(A_27a,bool),bool))
         => ap(ap(c_2Epred__set_2EDIFF(A_27a),V0u),ap(c_2Epred__set_2EBIGINTER(A_27a),V1s)) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f3624(A_27a,A_27a,V0u,V1s))) ) ) )).

tff(conj_thm_2Ereal__topology_2EBIGUNION__MONO__IMAGE,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2g: $i] :
             ...
             => ( ! [V3x: $i] :
               ...
               => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(c_2Epred__set_2EBIGUNION(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),V0s))),ap(c_2Epred__set_2EBIGUNION(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2g),V0s)))) ) ) ) ) )).
...
tff(lamtp_f3671,axiom,(
    ! [A_27b: del,A_27b: del,V4t: $i] :
...
tff(conj_thm_2Ereal__topology_2EINTER__BIGUNION,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0s: $i] :
          ( mem(V0s,arr(arr(A_27a,bool),bool))
         => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__CLOSED__INTER,lemma,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EBAIRE,lemma,(
    ! [V0g: $i] :
...
tff(conj_thm_2Ereal__topology_2EBAIRE__ALT,conjecture,(
    ! [V0g: $i] :
      ( mem(V0g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V1s))
              ...
              & p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V0g))
              & ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0g) = V1s )
           => ? [V2t: $i] :
                ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
                & ? [V3u: $i] :
                    ...
                    & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3u),ap(c_2Ereal__topology_2Eclosure,V2t))) ) ) ) ) ) )).
