...
tff(mem_c_2Eset__relation_2Eget__min,axiom,(
    ! [A_27a: del] : mem(c_2Eset__relation_2Eget__min(A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),ty_2Eoption_2Eoption(A_27a)))) )).

tff(conj_thm_2Eset__relation_2Enth__min__ind,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Enum_2Enum,bool))))
     => ( ( ! [V1r_27: $i] :
             ...
             => ! [V2s: $i] :
                 ...
                 => ! [V3r: $i] :
                     ...
                     => p(ap(ap(ap(V0P,V1r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V2s),V3r)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )
          & ! [V4r_27: $i] :
                 ...
                 => ! [V6r: $i] :
                     ...
                     => ! [V7n: tp__ty_2Enum_2Enum] :
                          ( ! [V8min: $i] :
                             ...
                             => ( ( V8min = ap(ap(c_2Eset__relation_2Eget__min(A_27a),V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V5s),V6r))
                                  & V8min != c_2Eoption_2ENONE(A_27a) )
                               => p(ap(ap(ap(V0P,V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EDELETE(A_27a),V5s),ap(c_2Eoption_2ETHE(A_27a),V8min))),V6r)),inj__ty_2Enum_2Enum(V7n))) ) )
                         => p(ap(ap(ap(V0P,V4r_27),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V5s),V6r)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V7n)))) ) ) ) ) )
       => ! [V9v: $i] :
           ...
           => ! [V10v1: $i] :
               ...
               => ! [V11v2: $i] :
                   ...
                   => ! [V12v3: tp__ty_2Enum_2Enum] : p(ap(ap(ap(V0P,V9v),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V10v1),V11v2)),inj__ty_2Enum_2Enum(V12v3))) ) ) ) ) ) )).
