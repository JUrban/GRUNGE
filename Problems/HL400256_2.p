...
tff(conj_thm_2Ecombin_2EGEN__literal__case__RATOR,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
     ...
     => ! [V1v: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27c)
             => ap(ap(ap(c_2Ebool_2Eliteral__case(A_27b,A_27b),V0f),V1v),V2x) = ap(ap(c_2Ebool_2Eliteral__case(A_27b,A_27b),ap(ap(c_2Ecombin_2EC(A_27b,A_27b,A_27b),V0f),V2x)),V1v) ) ) ) )).
