...
fof(conj_thm_2Ereal__topology_2EBIGUNION__MONO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION__CLOSED,lemma,(
    ! [V0g] :
...
fof(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION,conjecture,(
    ! [V0g] :
      ( mem(V0g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V0g))
          & ! [V1s] :
