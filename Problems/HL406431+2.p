...
fof(lameq_f2283,axiom,(
    ! [A_27b,A_27a,V1k] :
     ...
     => ! [V0cmp] :
         ...
         => ! [V3k_27] :
              ( mem(V3k_27,A_27a)
             => ap(f2283(A_27b,A_27a,V1k,V0cmp),V3k_27) = k(A_27b,ap(ap(c_2Emin_2E_3D(ty_2EternaryComparisons_2Eordering),ap(ap(V0cmp,V1k),V3k_27)),c_2EternaryComparisons_2ELESS)) ) ) ) )).

fof(lamtp_f2282,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a,V0cmp] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
...
fof(conj_thm_2Ecomparison_2Egood__cmp__trans,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
