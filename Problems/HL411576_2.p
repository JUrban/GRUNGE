...
tff(conj_thm_2Eiterate_2EINF,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
          & ? [V1b: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eiterate_2EREAL__LE__INF,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1b: tp__ty_2Erealax_2Ereal] :
          ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__SUP,lemma,(
    ! [V0f: $i] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V1s))
           ...
           => ? [V2x: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V3y: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Erealax_2Ereal(V3y))),ap(V0f,inj__ty_2Erealax_2Ereal(V2x)))) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__INF,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V1s))
           ...
           => ? [V2x: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V3y: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),V1s))
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),ap(V0f,inj__ty_2Erealax_2Ereal(V3y)))) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__INTERVAL,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))))) )).

tff(conj_thm_2Ereal__topology_2EEMPTY__AS__INTERVAL,lemma,(
    c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) )).

tff(ax_thm_2Ereal__topology_2Eis__interval,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
      <=> ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] :
           ...
           => ( ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3x)))
                ...
                | ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V3x)))
                  & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V1a))) ) )
             => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V0s)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EIS__INTERVAL__INTERVAL,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( p(ap(c_2Ereal__topology_2Eis__interval,ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b)))))
      & p(ap(c_2Ereal__topology_2Eis__interval,ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))))) ) )).

tff(conj_thm_2Ereal__topology_2EIS__INTERVAL__POINTWISE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EIS__INTERVAL__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
          & p(ap(c_2Ereal__topology_2Ecompact,V0s)) )
      <=> ? [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : V0s = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).
