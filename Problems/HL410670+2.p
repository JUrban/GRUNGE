...
fof(conj_thm_2Ereal__topology_2EIN__OPEN__SEGMENT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__DIST__IN__CLOSED__SEGMENT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__DIST__IN__OPEN__SEGMENT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
