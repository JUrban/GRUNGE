...
fof(conj_thm_2Efinite__map_2EFEVERY__SUBMAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1fm] :
                 ...
                 => ! [V2fm0] :
                     ...
                     => ( ( p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V0P),V1fm))
                          & p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V2fm0),V1fm)) )
                       => p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V0P),V2fm0)) ) ) ) ) ) ) )).
