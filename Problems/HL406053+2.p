...
fof(conj_thm_2Ewords_2ELSL__ONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2ESHIFT__1__SUB__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__extract__w2w__mask,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
