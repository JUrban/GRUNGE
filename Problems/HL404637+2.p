...
fof(conj_thm_2Efinite__map_2EFUPDATE__COMMUTES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2Efmap__SIMPLE__INDUCT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFCARD__FEMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFCARD__FUPDATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0fm] :
             ...
             => ! [V1a] :
                 ...
                 => ! [V2b] :
                      ( mem(V2b,A_27b)
                     => ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b))) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V1a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm))),ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0fm)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0fm))) ) ) ) ) ) )).

fof(conj_thm_2Efinite__map_2EFCARD__SUC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1n] :
                  ( mem(V1n,ty_2Enum_2Enum)
                 => ( ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0f) = ap(c_2Enum_2ESUC,V1n)
                  <=> ? [V2f_27] :
                        ( mem(V2f_27,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                        & ? [V3x] :
                            ( mem(V3x,A_27a)
                            & ? [V4y] :
                                ( mem(V4y,A_27b)
                                & ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2f_27)))
                                & ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V2f_27) = V1n
                                & V0f = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2f_27),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),V4y)) ) ) ) ) ) ) ) ) )).
