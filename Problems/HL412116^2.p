...
thf(conj_thm_2Eprobability_2EPROB__DISCRETE__EVENTS,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ( ( ( p @ ( ap @ ( c_2Eprobability_2Eprob__space @ A_27a ) @ V0p ) )
          & ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2Eprobability_2Ep__space @ A_27a ) @ V0p ) ) )
...
thf(conj_thm_2Eprobability_2Edistribution__partition,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1X: $i] :
                ...
                @ ( ap
                  @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ ty_2Eextreal_2Eextreal )
                    @ ( lam @ ty_2Eextreal_2Eextreal
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Eprobability_2Edistribution @ ty_2Eextreal_2Eextreal @ A_27a ) @ V0p ) @ V1X ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Eextreal_2Eextreal ) @ V3x ) @ ( c_2Epred__set_2EEMPTY @ ty_2Eextreal_2Eextreal ) ) ) ) )
