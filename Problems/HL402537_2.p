...
tff(mem_c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN(A_27a,A_27a),arr(arr(A_27a,A_27b),bool)) )).

tff(ax_thm_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN__def,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( p(ap(c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN(A_27a,A_27a),V0f))
      <=> ! [V1v: $i] :
            ( mem(V1v,A_27b)
           => ? [V2x: $i] :
                ( mem(V2x,A_27a)
...
tff(conj_thm_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN______FORALL__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1P: $i] :
