...
thf(f5922_0_2E0,type,(
    f5922_0_2E0: u )).

thf(f5922_0_2E4,type,(
    f5922_0_2E4: du > du > du > du > u )).

thf(f5922_0_2E5,type,(
    f5922_0_2E5: du > du > du > du > du > u )).

thf(f5922_1_2E0,type,(
    f5922_1_2E0: u )).

thf(f5922_1_2E3,type,(
    f5922_1_2E3: du > du > du > u )).
...
thf(def0_2Ethm_2EOmega__Automata_2ECO__BUECHI__SUNTIL__CLOSURE,axiom,(
    ! [A_27b: d,V13q_2E0: u,V0t0: mono_2Etyop_2Enum_2Enum,V3c_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5922_1_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V13q_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0t0 ) ) @ ( s @ A_27b @ V3c_2E0 ) ) ) )
    <=> ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V13q_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0t0 ) ) ) )
        = ( s @ A_27b @ V3c_2E0 ) ) ) )).

thf(def1_2Ethm_2EOmega__Automata_2ECO__BUECHI__SUNTIL__CLOSURE,axiom,(
...
thf(thm_2EOmega__Automata_2ECO__BUECHI__SUNTIL__CLOSURE,conjecture,(
    ! [A_27a: d,A_27b: d,V0t0: mono_2Etyop_2Enum_2Enum,V1phi: mono_2Etyop_2Enum_2Enum > $o,V2i_2E0: u,V3c_2E0: u,V4Psi_2E0: u,V5Phi__R_2E0: u,V6Phi__I_2E0: u] :
      ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ V1phi @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( f5922_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V6Phi__I_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V5Phi__R_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2i_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V4Psi_2E0 ) ) ) ) @ V0t0 )
    <=> ? [V12p: mono_2Etyop_2Enum_2Enum > $o,V13q_2E0: u] :
          ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( V12p @ V0t0 ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V6Phi__I_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V13q_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0t0 ) ) ) ) ) ) ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5922_1_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V13q_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0t0 ) ) @ ( s @ A_27b @ V3c_2E0 ) ) ) ) )
