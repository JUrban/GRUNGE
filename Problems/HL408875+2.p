...
fof(conj_thm_2Ewords_2EWORD__AND__ASSOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2EHolSmt_2Er254,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
         ...
         => ! [V1y] :
             ...
             => ! [V2z] :
                 ...
                 => ap(ap(c_2Ewords_2Eword__and(A_27a),ap(ap(c_2Ewords_2Eword__and(A_27a),V0x),V1y)),V2z) = ap(ap(c_2Ewords_2Eword__and(A_27a),V0x),ap(ap(c_2Ewords_2Eword__and(A_27a),V1y),V2z)) ) ) ) ) )).
