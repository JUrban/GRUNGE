...
fof(lameq_f896,axiom,(
    ! [V0a] :
     ...
     => ! [V1t] :
         ...
         => ap(f896(V0a),V1t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f883(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V1t)) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__UNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
