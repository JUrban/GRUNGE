...
thf(thm_2Ewhile_2ELESS__LEAST,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1m @ ( mono_2Ec_2Ewhile_2ELEAST @ V0P ) )
     => ( (~) @ ( V0P @ V1m ) ) ) )).

thf(thm_2Ewhile_2ELEAST__ELIM,conjecture,(
