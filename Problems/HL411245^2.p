...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPOSE__QUOTIENT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EFUNCTION__FACTORS__LEFT__GEN,lemma,(
...
thf(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1h: $i] :
