...
tff(c_2EreaderMonad_2EBIND_2E2,type,(
    c_2EreaderMonad_2EBIND_2E2: 
      !>[A_27a: $tType,A_27b: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27s,A_27a) * tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27s,A_27b)) ) > tyop_2Emin_2Efun(A_27s,A_27b) ) )).

tff(c_2EreaderMonad_2EBIND_2E3,type,(
    c_2EreaderMonad_2EBIND_2E3: 
      !>[A_27a: $tType,A_27b: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27s,A_27a) * tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27s,A_27b)) * A_27s ) > A_27b ) )).
...
tff(c_2EreaderMonad_2EMCOMPOSE_2E2,type,(
    c_2EreaderMonad_2EMCOMPOSE_2E2: 
      !>[A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27s,A_27b)) * tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27s,A_27c)) ) > tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27s,A_27c)) ) )).

tff(c_2EreaderMonad_2EMCOMPOSE_2E3,type,(
    c_2EreaderMonad_2EMCOMPOSE_2E3: 
      !>[A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27s,A_27b)) * tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27s,A_27c)) * A_27a ) > tyop_2Emin_2Efun(A_27s,A_27c) ) )).
...
tff(thm_2EreaderMonad_2EMCOMPOSE__LEFT__ID,conjecture,(
