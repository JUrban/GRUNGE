...
fof(conj_thm_2Eproduct_2ENPRODUCT__CLAUSES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eproduct_2EREAL__OF__NUM__NPRODUCT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Eproduct_2Enproduct(A_27a),V1s),V0f)) = ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3377(A_27a,V0f)) ) ) ) ) )).
