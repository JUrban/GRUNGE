...
thf(thm_2Egcd_2EGCD__SUCfree__ind,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ! [V1y: mono_2Etyop_2Enum_2Enum] :
            ( V0P @ mono_2Ec_2Enum_2E0 @ V1y )
        & ! [V2x: mono_2Etyop_2Enum_2Enum,V3y: mono_2Etyop_2Enum_2Enum] :
            ( ( V0P @ V2x @ V3y )
           => ( V0P @ V3y @ V2x ) )
        & ! [V4x: mono_2Etyop_2Enum_2Enum] :
            ( V0P @ V4x @ V4x )
        & ! [V5x: mono_2Etyop_2Enum_2Enum,V6y: mono_2Etyop_2Enum_2Enum] :
            ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V5x )
              & ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V6y )
              & ( V0P @ V5x @ V6y ) )
           => ( V0P @ V5x @ ( mono_2Ec_2Earithmetic_2E_2B @ V5x @ V6y ) ) ) )
     => ! [V7m: mono_2Etyop_2Enum_2Enum,V8n: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V7m @ V8n ) ) )).
