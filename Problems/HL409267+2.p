...
fof(conj_thm_2Ereal_2EREAL__LT__ANTISYM,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal_2EREAL__LT__ADD1,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__SUP,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Eintegral_2ESUP__INTERVAL,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
