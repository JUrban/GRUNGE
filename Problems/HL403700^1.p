...
thf(thm_2Elist_2EALL__DISTINCT__SET__TO__LIST,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESET__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Elist_2EMEM__GENLIST,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) ) ) ) )
    <=> ? [V3m: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3m @ V1n )
          & ( ( s @ A_27a @ V0x_2E0 )
            = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3m ) ) ) ) ) ) ) )).

thf(thm_2Elist_2EALL__DISTINCT__GENLIST,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) ) ) )
    <=> ! [V2m1: mono_2Etyop_2Enum_2Enum,V3m2: mono_2Etyop_2Enum_2Enum] :
          ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2m1 @ V0n )
            & ( mono_2Ec_2Eprim__rec_2E_3C @ V3m2 @ V0n )
            & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2m1 ) ) ) )
              = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3m2 ) ) ) ) ) )
         => ( V2m1 = V3m2 ) ) ) )).
...
thf(thm_2Esorting_2EPERM__SET__TO__LIST__count__COUNT__LIST,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Esorting_2EPERM_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Elist_2ESET__TO__LIST_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2Ecount @ V0n ) ) @ ( mono_2Ec_2Erich__list_2ECOUNT__LIST @ V0n ) ) )).
