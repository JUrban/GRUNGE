...
thf(thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__GF,conjecture,(
    ! [V0t0: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ...
      <=> ? [V17q: tyop_2Enum_2Enum > $o] :
            ...
            & ! [V18t: tyop_2Enum_2Enum] :
                ...
                = ( c_2Ebool_2ECOND @ $o @ ( V17q @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) @ ( c_2Ebool_2E_7E @ ( V1b @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) ) @ ( V2a @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) ) )
