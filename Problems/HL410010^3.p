...
thf(thm_2Eextreal_2EINV__IN__Q,conjecture,(
    ! [V0x: tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Ebool_2EIN @ tyop_2Eextreal_2Eextreal @ V0x @ c_2Eextreal_2EQ__set )
        & ( (~)
          @ ( V0x
            = ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( c_2Ebool_2EIN @ tyop_2Eextreal_2Eextreal @ ( c_2Eextreal_2Eextreal__div @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0x ) @ c_2Eextreal_2EQ__set ) ) )).
