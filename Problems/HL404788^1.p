...
thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFLOOKUP_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27c ) ) ) @ c_2Efinite__map_2EFLOOKUP_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFLOOKUP__MAP__KEYS__MAPPED,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0m_2E0: u,V1k_2E0: u,V2f_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27c ) @ ( c_2Efinite__map_2EMAP__KEYS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ V0m_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ V0m_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) ) ) )).
