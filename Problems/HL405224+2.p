...
fof(ax_thm_2EEncode_2Ewf__pred__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(lamtp_f2117,axiom,(
    ! [A_27a,V0p] :
      ( mem(V0p,arr(A_27a,bool))
     => mem(f2117(A_27a,V0p),arr(A_27a,bool)) ) )).

fof(lameq_f2117,axiom,(
    ! [A_27a,V0p] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V3x] :
          ( mem(V3x,A_27a)
         => ap(f2117(A_27a,V0p),V3x) = ap(V0p,V3x) ) ) )).

fof(lamtp_f2119,axiom,(
    ! [A_27a] : mem(f2119(A_27a),arr(A_27a,arr(ty_2Elist_2Elist(bool),A_27a))) )).

fof(lameq_f2119,axiom,(
    ! [A_27a,V5x] :
      ( mem(V5x,A_27a)
     => ap(f2119(A_27a),V5x) = k(ty_2Elist_2Elist(bool),V5x) ) )).

fof(lamtp_f2118,axiom,(
    ! [A_27a,A_27a] : mem(f2118(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27a)) )).

fof(lameq_f2118,axiom,(
    ! [A_27a,A_27a,V4v] :
      ( mem(V4v,ty_2Epair_2Eprod(A_27a,A_27a))
     => ap(f2118(A_27a,A_27a),V4v) = ap(ap(c_2Epair_2Epair__CASE(A_27a,A_27a,A_27a),V4v),f2119(A_27a)) ) )).

fof(ax_thm_2ECoder_2Edecode__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
         => ! [V1d] :
             ...
             => ! [V2l] :
                  ( mem(V2l,ty_2Elist_2Elist(bool))
                 => ap(ap(ap(c_2ECoder_2Edecode(A_27a),V0p),V1d),V2l) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(V1d,V2l)),ap(c_2Emin_2E_40(A_27a),f2117(A_27a,V0p))),f2118(A_27a,A_27a)) ) ) ) ) )).
...
fof(conj_thm_2ECoder_2Ewf__coder__closed,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
         ...
         => ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V0c))
           => ! [V1l] :
               ...
               => p(ap(ap(c_2ECoder_2Edomain(A_27a),V0c),ap(ap(c_2ECoder_2Edecoder(A_27a),V0c),V1l))) ) ) ) ) )).
