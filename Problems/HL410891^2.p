...
thf(conj_thm_2Earithmetic_2EMAX__LE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EFROM__INTER__NUMSEG__MAX,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
      = ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ ( ap @ c_2Earithmetic_2EMAX @ ( inj__ty_2Enum_2Enum @ V2p ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )).
