...
tff(conj_thm_2Earithmetic_2EMAX__LT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2ENOT__BIT__GT__LOG2,lemma,(
...
tff(conj_thm_2Ebit_2ENOT__BIT__GT__BITWISE,lemma,(
...
tff(lameq_f2163,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f2163(A_27a,V0w),inj__ty_2Enum_2Enum(V1i)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),inj__ty_2Enum_2Enum(V1i))) ) )).
...
tff(conj_thm_2Ewords_2Eword__and__n2w,lemma,(
...
tff(conj_thm_2Ewords_2Eword__or__n2w,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__DE__MORGAN__THM,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
...
tff(conj_thm_2Ewords_2EWORD__AND__COMM,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2Eword__bit__n2w,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__EQ,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
...
tff(lamtp_f2228,axiom,(
    ! [V4a: tp__o] : mem(f2228(V4a),arr(bool,bool)) )).

tff(lameq_f2228,axiom,(
    ! [V4a: tp__o,V5b: tp__o] : ap(f2228(V4a),inj__o(V5b)) = ap(ap(c_2Ebool_2E_2F_5C,inj__o(V4a)),ap(c_2Ebool_2E_7E,inj__o(V5b))) )).

tff(lmtp_f2227,type,(
    f2227: $i )).

tff(lamtp_f2227,axiom,(
    mem(f2227,arr(bool,arr(bool,bool))) )).

tff(lameq_f2227,axiom,(
    ! [V4a: tp__o] : ap(f2227,inj__o(V4a)) = f2228(V4a) )).

tff(lmtp_f2230,type,(
    f2230: tp__o > $i )).

tff(lamtp_f2230,axiom,(
    ! [V8a: tp__o] : mem(f2230(V8a),arr(bool,bool)) )).

tff(lameq_f2230,axiom,(
    ! [V8a: tp__o,V9b: tp__o] : ap(f2230(V8a),inj__o(V9b)) = ap(ap(c_2Ebool_2E_2F_5C,inj__o(V8a)),ap(c_2Ebool_2E_7E,inj__o(V9b))) )).

tff(lmtp_f2229,type,(
    f2229: $i )).

tff(lamtp_f2229,axiom,(
    mem(f2229,arr(bool,arr(bool,bool))) )).

tff(lameq_f2229,axiom,(
    ! [V8a: tp__o] : ap(f2229,inj__o(V8a)) = f2230(V8a) )).

tff(conj_thm_2Ewords_2EWORD__LITERAL__OR,conjecture,(
    ! [A_27a: del] :
      ...
      & ! [V2n: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__or(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V2n))),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V3m)))) = ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,inj__ty_2Enum_2Enum(V3m)))),f2227),inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V2n))))
      & ! [V6n: tp__ty_2Enum_2Enum,V7m: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__or(A_27a),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V7m)))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V6n))) = ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,inj__ty_2Enum_2Enum(V7m)))),f2229),inj__ty_2Enum_2Enum(V7m)),inj__ty_2Enum_2Enum(V6n))))
