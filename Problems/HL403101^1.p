...
thf(f3682_0_2E0,type,(
    f3682_0_2E0: u )).

thf(f3682_0_2E2,type,(
    f3682_0_2E2: du > du > u )).

thf(f3682_0_2E3,type,(
...
thf(mono_2Ef3682_0,type,(
    mono_2Ef3682_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(thm_2ETemporal__Logic_2ESWHEN__AS__BEFORE,conjecture,(
    ...
    <=> ( (~) @ ( mono_2Ec_2ETemporal__Logic_2EBEFORE @ V0b @ ( mono_2Ef3682_0 @ V1a @ V0b ) @ V2x ) ) ) )).
