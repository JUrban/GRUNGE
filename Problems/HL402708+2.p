...
fof(conj_thm_2Erich__list_2EAPPEND__BUTLASTN__DROP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1n] :
             ...
             => ! [V2l] :
                 ...
                 => ( ap(ap(c_2Earithmetic_2E_2B,V0m),V1n) = ap(c_2Elist_2ELENGTH(A_27a),V2l)
                   => ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0m),V2l)),ap(ap(c_2Elist_2EDROP(A_27a),V1n),V2l)) = V2l ) ) ) ) ) )).
