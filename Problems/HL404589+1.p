...
fof(thm_2Ecardinal_2ECOUNTABLE__EMPTY,axiom,(
...
fof(thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE,axiom,(
    ! [A_27a,V0s_2E0] :
     ...
     => ? [V1f_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EIMAGE_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V1f_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Epred__set_2EUNIV_2E0))) ) )).
...
fof(thm_2Ecardinal_2EFORALL__COUNTABLE__AS__IMAGE,conjecture,(
    ! [A_27a,V0P_2E0] :
      ( ! [V1d_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2Ecountable_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1d_2E0))))
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1d_2E0)))) )
