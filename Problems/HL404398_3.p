...
tff(thm_2Ecardinal_2Ecount__cardle,conjecture,(
    ! [A_27a: $tType,V0n_2E0: tyop_2Enum_2Enum,V1A_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] :
      ( p(c_2Ecardinal_2Ecardleq_2E2(tyop_2Enum_2Enum,A_27a,c_2Epred__set_2Ecount_2E1(V0n_2E0),V1A_2E0))
    <=> ( p(c_2Epred__set_2EFINITE_2E1(A_27a,V1A_2E0))
       => p(c_2Earithmetic_2E_3C_3D_2E2(V0n_2E0,c_2Epred__set_2ECARD_2E1(A_27a,V1A_2E0))) ) ) )).
