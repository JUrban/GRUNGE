...
tff(conj_thm_2Erich__list_2ELASTN,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0l: $i] :
...
tff(conj_thm_2Erich__list_2ELASTN__APPEND1,lemma,(
    ! [A_27a: del,V0l2: $i] :
...
tff(conj_thm_2Erich__list_2EDROP__APPEND1,lemma,(
...
tff(conj_thm_2Erich__list_2EDROP__LENGTH__NIL__rwt,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Erich__list_2EREVERSE__DROP,conjecture,(
    ! [A_27a: del,V0ls: $i] :
