...
fof(conj_thm_2Ewellorder_2Eseteq__wlog,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                      ...
                      & ! [V4x] :
                         ...
                         => ! [V5a] :
                             ...
                             => ! [V6b] :
                                  ( mem(V6b,A_27a)
                                 => ( ( p(ap(ap(V0P,V5a),V6b))
                                      & p(ap(ap(c_2Ebool_2EIN(A_27b),V4x),ap(V1f,V5a))) )
                                   => p(ap(ap(c_2Ebool_2EIN(A_27b),V4x),ap(V1f,V6b))) ) ) ) ) )
                   => ! [V7a] :
                        ( mem(V7a,A_27a)
                       => ! [V8b] :
                            ( mem(V8b,A_27a)
                           => ( p(ap(ap(V0P,V7a),V8b))
                             => ap(V1f,V7a) = ap(V1f,V8b) ) ) ) ) ) ) ) ) )).
