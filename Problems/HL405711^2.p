...
thf(conj_thm_2Eordinal_2EordEXP__le__MONO__L,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2EordEXP__MUL,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ! [V2z: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0x ) )
               => ( ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ V0x ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V1y ) @ V2z ) )
                  = ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ V0x ) @ V1y ) ) @ V2z ) ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2Eepsilon0__fixpoint,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ ( c_2Eordinal_2Eepsilon0 @ A_27a ) )
...
thf(conj_thm_2Eordinal_2EordMUL__under__epsilon0,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2EordEXP__under__epsilon0,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
