    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V3x] :
             ...
             => ap(f2912(V0f,V1g),V3x) = ap(V1g,ap(V0f,V3x)) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__COMPOSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
