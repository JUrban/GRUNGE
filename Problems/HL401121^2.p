    ...
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ...
        = ( surj__ty_2Enum_2Enum
          @ ( ap @ c_2Ewhile_2ELEAST
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1p: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Edivides_2Eprime @ V1p ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1p ) ) ) ) ) ) )).

thf(conj_thm_2Edivides_2EprimePRIMES,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ c_2Edivides_2Eprime @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).

thf(conj_thm_2Edivides_2EINFINITE__PRIMES,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ c_2Edivides_2EPRIMES @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).
...
thf(conj_thm_2Edivides_2EINDEX__LESS__PRIMES,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
