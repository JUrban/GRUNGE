...
fof(mem_c_2Epred__set_2ELINV__OPT,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),arr(arr(A_27a,A_27b),arr(arr(A_27a,bool),arr(A_27b,ty_2Eoption_2Eoption(A_27a))))) ) ) )).
...
fof(conj_thm_2Epred__set_2EIMAGE__SURJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(ax_thm_2Epred__set_2ELINV__OPT__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2EINJ__LINV__OPT__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                 ...
                 => p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),ap(ap(c_2Epred__set_2ELINV__OPT(A_27b,A_27b),V0f),V1s)),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V0f),V1s)),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),c_2Eoption_2ESOME(A_27b)),V1s))) ) ) ) ) )).

fof(conj_thm_2Epred__set_2ESURJ__INJ__INV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
