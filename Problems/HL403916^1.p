...
thf(thm_2Ellist_2Eevery__strong__coind,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1Q_2E0: u] :
      ( ( ! [V2h_2E0: u,V3t_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3t_2E0 ) ) ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V2h_2E0 ) ) ) ) )
        & ! [V4h_2E0: u,V5t_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V4h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V5t_2E0 ) ) ) ) ) )
           => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V5t_2E0 ) ) ) )
              | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eevery_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V5t_2E0 ) ) ) ) ) ) )
     => ! [V6ll_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V6ll_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eevery_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V6ll_2E0 ) ) ) ) ) ) )).
