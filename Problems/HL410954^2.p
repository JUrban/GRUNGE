...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__SET,conjecture,(
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Eeventually @ ty_2Erealax_2Ereal )
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V3s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V4t ) ) ) )
