...
thf(conj_thm_2Elist_2EALL__DISTINCT__MAP__INJ,lemma,(
...
thf(conj_thm_2Erich__list_2Eall__distinct__count__list,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( c_2Elist_2EALL__DISTINCT @ ty_2Enum_2Enum ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
