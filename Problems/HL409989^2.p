...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__0,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Epred__set_2EDISJOINT__DIFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eextreal_2Eext__suminf__sum,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
