...
thf(conj_thm_2Ebag_2EBAG__DECOMPOSE,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1b: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IN @ A_27a ) @ V0e ) @ V1b ) )
           => ? [V2b_27: $i] :
                ...
                & ( V1b
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0e ) @ V2b_27 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__DIFF__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ! [V2b2: $i] :
             ...
             => ( ~ ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IN @ A_27a ) @ V0x ) @ V1b1 ) )
               => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0x ) @ V2b2 ) ) @ V1b1 )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0x ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V2b2 ) @ V1b1 ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2ESUB__BAG__INSERT,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2ENOT__IN__SUB__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2ESUB__BAG__CARD,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EBAG__CARD__DIFF,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
       => ! [V1c: $i] :
           ...
           => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2ESUB__BAG @ A_27a ) @ V1c ) @ V0b ) )
             => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V0b ) @ V1c ) ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ V0b ) ) @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ V1c ) ) ) ) ) ) ) ) )).
