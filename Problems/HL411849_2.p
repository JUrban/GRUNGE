...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__GE__ON__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                & ! [V3x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),ap(V0f,inj__ty_2Erealax_2Ereal(V3x)))) ) )
             => ! [V4x: tp__ty_2Erealax_2Ereal] :
                  ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(c_2Ereal__topology_2Eclosure,V1s)))
                 => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),ap(V0f,inj__ty_2Erealax_2Ereal(V4x)))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ABS__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESETDIST__SYM,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1t),V0s))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESETDIST__CLOSURE,conjecture,
    ( ! [V0s: $i] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1t: $i] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
