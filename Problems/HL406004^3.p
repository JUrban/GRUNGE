...
thf(thm_2Earithmetic_2EMODEQ__0,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ( c_2Earithmetic_2EMODEQ @ V0n @ V0n @ c_2Enum_2E0 ) ) )).
...
thf(thm_2Ewords_2Eword__L__MULT,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__mul @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V0n ) @ ( c_2Ewords_2Eword__L @ A_27a ) )
      = ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Earithmetic_2EEVEN @ V0n ) @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) )).
