...
fof(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN__GEN,lemma,(
    ! [V0f] :
...
fof(lameq_f4063,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V5n] :
          ( mem(V5n,ty_2Enum_2Enum)
         => ap(f4063(V0s),V5n) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(V0s,V5n)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5n),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__NEST__GEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(c_2Ereal__topology_2EClosed,ap(V0s,V1n)))
                & p(ap(c_2Ereal__topology_2Econnected,ap(V0s,V1n))) ) )
          & ? [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
              & p(ap(c_2Ereal__topology_2Ecompact,ap(V0s,V2n))) )
          & ! [V3m] :
              ( mem(V3m,ty_2Enum_2Enum)
             => ! [V4n] :
                  ( mem(V4n,ty_2Enum_2Enum)
