...
tff(conj_thm_2Ereal_2EREAL__NEG__MUL2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) )).
...
tff(conj_thm_2Ereal_2EREAL__LT__SUB__LADD,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__LT__MUL2,lemma,(
    ! [V0x1: tp__ty_2Erealax_2Ereal,V1x2: tp__ty_2Erealax_2Ereal,V2y1: tp__ty_2Erealax_2Ereal,V3y2: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x1)))
        ...
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0x1)),inj__ty_2Erealax_2Ereal(V1x2)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V2y1)),inj__ty_2Erealax_2Ereal(V3y2))) )
     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x1)),inj__ty_2Erealax_2Ereal(V2y1))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1x2)),inj__ty_2Erealax_2Ereal(V3y2)))) ) )).
...
tff(tp_c_2Etransc_2Eroot,type,(
    c_2Etransc_2Eroot: $i )).

tff(mem_c_2Etransc_2Eroot,axiom,(
    mem(c_2Etransc_2Eroot,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(stp_fo_c_2Etransc_2Eroot,type,(
    fo__c_2Etransc_2Eroot: ( tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > tp__ty_2Erealax_2Ereal )).

tff(stp_eq_fo_c_2Etransc_2Eroot,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__ty_2Erealax_2Ereal] : inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Eroot(X0,X1)) = ap(ap(c_2Etransc_2Eroot,inj__ty_2Enum_2Enum(X0)),inj__ty_2Erealax_2Ereal(X1)) )).
...
tff(ax_thm_2Etransc_2Esqrt,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esqrt,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Eroot,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Erealax_2Ereal(V0x))) )).

tff(conj_thm_2Etransc_2EROOT__POS__LT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Etransc_2Eroot,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n))),inj__ty_2Erealax_2Ereal(V1x)))) ) )).

tff(conj_thm_2Etransc_2EACS__COS,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
     ...
     => surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,ap(c_2Etransc_2Eacs,inj__ty_2Erealax_2Ereal(V0y)))) = V0y ) )).

tff(conj_thm_2Etransc_2EACS__BOUNDS,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0y)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0y)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )
     => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Etransc_2Eacs,inj__ty_2Erealax_2Ereal(V0y))))
        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Etransc_2Eacs,inj__ty_2Erealax_2Ereal(V0y))),inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi))) ) ) )).
...
tff(conj_thm_2Etransc_2EDIFF__ACS__LEMMA,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0x)))
     ...
     => p(ap(ap(ap(c_2Elim_2Ediffl,c_2Etransc_2Eacs),ap(c_2Erealax_2Einv,ap(c_2Erealax_2Ereal__neg,ap(c_2Etransc_2Esin,ap(c_2Etransc_2Eacs,inj__ty_2Erealax_2Ereal(V0x)))))),inj__ty_2Erealax_2Ereal(V0x))) ) )).

tff(conj_thm_2Etransc_2EDIFF__ACS,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )
