...
fof(lamtp_f769,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27b))
         => mem(f769(A_27b,A_27a,V0f,V2l_27),arr(A_27a,ty_2Elist_2Elist(A_27b))) ) ) )).

fof(lameq_f769,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27b))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f769(A_27b,A_27a,V0f,V2l_27),V3x) = ap(ap(c_2Elist_2ESNOC(A_27b),ap(V0f,V3x)),V2l_27) ) ) ) )).

fof(lamtp_f768,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => mem(f768(A_27a,A_27b,V0f),arr(ty_2Elist_2Elist(A_27b),arr(A_27a,ty_2Elist_2Elist(A_27b)))) ) )).

fof(lameq_f768,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27b))
         => ap(f768(A_27a,A_27b,V0f),V2l_27) = f769(A_27b,A_27a,V0f,V2l_27) ) ) )).

fof(conj_thm_2Erich__list_2EMAP__FOLDL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1l] :
                  ( mem(V1l,ty_2Elist_2Elist(A_27a))
                 => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1l) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f768(A_27a,A_27b,V0f)),c_2Elist_2ENIL(A_27b)),V1l) ) ) ) ) )).
