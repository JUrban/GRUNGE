...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__FORALL,lemma,(
                      ...
                      @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ...
                              @ ( lam @ A_27b
                                @ ^ [V4a: $i] :
                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V4a ) @ V2s ) ) @ ( ap @ ( ap @ V1p @ V4a ) @ V3x ) ) ) ) ) )
                      @ V0net ) )
                <=> ! [V5a: $i] :
                      ( ( mem @ V5a @ A_27b )
...
thf(conj_thm_2Ereal__topology_2EFORALL__EVENTUALLY,conjecture,(
    ! [A_27a: del,A_27b: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1p: $i] :
          ( ( mem @ V1p @ ( arr @ A_27b @ ( arr @ A_27a @ bool ) ) )
                      ...
                      @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ...
                              @ ( lam @ A_27b
                                @ ^ [V5a: $i] :
                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V5a ) @ V2s ) ) @ ( ap @ ( ap @ V1p @ V5a ) @ V4x ) ) ) ) ) )
                      @ V0net ) ) ) ) ) ) ) )).
