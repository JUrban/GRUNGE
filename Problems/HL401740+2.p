...
fof(conj_thm_2Epred__set_2ESUM__SAME__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
           ...
           => ! [V1f] :
               ...
               => ! [V2p] :
                   ...
                   => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2p),V0P))
                     ...
                     => ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V1f),V0P) = ap(ap(c_2Earithmetic_2E_2A,ap(c_2Epred__set_2ECARD(A_27a),V0P)),ap(V1f,V2p)) ) ) ) ) ) ) )).
