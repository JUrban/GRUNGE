...
tff(conj_thm_2Elist_2EALL__DISTINCT__SNOC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l: $i] :
...
tff(conj_thm_2Elist_2EALL__DISTINCT__GENLIST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] :
