...
thf(c_2Ereal__topology_2Euniformly__continuous__on_2E0,type,(
    c_2Ereal__topology_2Euniformly__continuous__on_2E0: u )).

thf(c_2Ereal__topology_2Euniformly__continuous__on_2E2,type,(
    c_2Ereal__topology_2Euniformly__continuous__on_2E2: du > du > u )).
...
thf(mono_2Ec_2Ereal__topology_2Euniformly__continuous__on,type,(
    mono_2Ec_2Ereal__topology_2Euniformly__continuous__on: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Ereal__topology_2ELIM__WITHIN__SUBSET,axiom,(
    ! [V0t: mono_2Etyop_2Erealax_2Ereal > $o,V1f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3a: mono_2Etyop_2Erealax_2Ereal,V4s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Erealax_2Ereal @ V1f @ V2l @ ( mono_2Ec_2Ereal__topology_2Ewithin_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Eat @ V3a ) @ V4s ) )
        & ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V0t @ V4s ) )
     => ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Erealax_2Ereal @ V1f @ V2l @ ( mono_2Ec_2Ereal__topology_2Ewithin_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Eat @ V3a ) @ V0t ) ) ) )).

thf(thm_2Ereal__topology_2Euniformly__continuous__on,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V1s )
    <=> ! [V2e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V3d: mono_2Etyop_2Erealax_2Ereal] :
              ...
              & ! [V4x: mono_2Etyop_2Erealax_2Ereal,V5x_27: mono_2Etyop_2Erealax_2Ereal] :
                  ( ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V4x @ V1s )
                    & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V5x_27 @ V1s )
                    & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V5x_27 @ V4x ) ) @ V3d ) )
                 => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( V0f @ V5x_27 ) @ ( V0f @ V4x ) ) ) @ V2e ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SUBSET,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V2t ) ) )).
