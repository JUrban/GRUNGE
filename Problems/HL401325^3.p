...
thf(thm_2Ebit_2EBITWISE__def,axiom,
    ( ! [V0op: $o > $o > $o,V1x: tyop_2Enum_2Enum,V2y: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBITWISE @ c_2Enum_2E0 @ V0op @ V1x @ V2y )
        = c_2Enum_2E0 )
    & ! [V3n: tyop_2Enum_2Enum,V4op: $o > $o > $o,V5x: tyop_2Enum_2Enum,V6y: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ V3n ) @ V4op @ V5x @ V6y )
        = ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBITWISE @ V3n @ V4op @ V5x @ V6y ) @ ( c_2Ebit_2ESBIT @ ( V4op @ ( c_2Ebit_2EBIT @ V3n @ V5x ) @ ( c_2Ebit_2EBIT @ V3n @ V6y ) ) @ V3n ) ) ) )).
