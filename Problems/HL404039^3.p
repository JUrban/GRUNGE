...
thf(thm_2Equotient_2EW__PRS,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,V0R1: A_27a > A_27a > $o,V1abs1: A_27a > A_27c,V2rep1: A_27c > A_27a] :
     ...
     => ! [V3R2: A_27b > A_27b > $o,V4abs2: A_27b > A_27d,V5rep2: A_27d > A_27b] :
         ...
         => ! [V6f: A_27c > A_27c > A_27d,V7x: A_27c] :
              ( ( c_2Ecombin_2EW @ A_27c @ A_27d @ V6f @ V7x )
              = ( V4abs2 @ ( c_2Ecombin_2EW @ A_27a @ A_27b @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ ( A_27c > A_27d ) @ A_27c @ ( A_27a > A_27b ) @ V1abs1 @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ A_27d @ A_27c @ A_27b @ V1abs1 @ V5rep2 ) @ V6f ) @ ( V2rep1 @ V7x ) ) ) ) ) ) )).
