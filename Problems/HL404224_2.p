...
tff(conj_thm_2Earithmetic_2ESUC__ADD__SYM,lemma,(
...
tff(conj_thm_2Epath_2Edrop__eq__pcons,conjecture,(
     ...
     => ! [V2h: $i] :
         ...
         => ! [V3l: $i] :
             ...
             => ! [V4t: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                      & ap(ap(c_2Epath_2Edrop(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),V1p) = ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V2h),V3l),V4t) )
