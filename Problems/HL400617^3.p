    ...
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Erelation_2ETC @ tyop_2Enum_2Enum
        @ ^ [V2x: tyop_2Enum_2Enum,V3y: tyop_2Enum_2Enum] :
            ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V3y @ ( c_2Enum_2ESUC @ V2x ) )
        @ V0m
        @ ( c_2Enum_2ESUC @ V1n ) )
      = ( c_2Erelation_2ERTC @ tyop_2Enum_2Enum
        @ ^ [V4x: tyop_2Enum_2Enum,V5y: tyop_2Enum_2Enum] :
            ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V5y @ ( c_2Enum_2ESUC @ V4x ) )
        @ V0m
        @ V1n ) ) )).
...
thf(thm_2Eprim__rec_2ERTC__IM__TC,axiom,(
    ! [A_27a: $tType,V0f: A_27a > A_27a,V1m: A_27a,V2n: A_27a] :
      ( ( c_2Erelation_2ERTC @ A_27a
        @ ^ [V3x: A_27a,V4y: A_27a] :
            ( c_2Emin_2E_3D @ A_27a @ V4y @ ( V0f @ V3x ) )
        @ ( V0f @ V1m )
        @ V2n )
      = ( c_2Erelation_2ETC @ A_27a
        @ ^ [V5x: A_27a,V6y: A_27a] :
            ( c_2Emin_2E_3D @ A_27a @ V6y @ ( V0f @ V5x ) )
        @ V1m
        @ V2n ) ) )).
...
thf(thm_2Eprim__rec_2ELESS__ALT,conjecture,
    ( c_2Eprim__rec_2E_3C
    = ( c_2Erelation_2ETC @ tyop_2Enum_2Enum
      @ ^ [V0x: tyop_2Enum_2Enum,V1y: tyop_2Enum_2Enum] :
          ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V1y @ ( c_2Enum_2ESUC @ V0x ) ) ) )).
