...
fof(conj_thm_2Epred__set_2EPSUBSET__MEMBER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2ESUBSET__BIGUNION__I,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2Ecountable__decomposition,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
