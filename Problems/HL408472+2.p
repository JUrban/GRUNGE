...
fof(conj_thm_2Ebinary__ieee_2Efloat__compare2num__thm,lemma,
         ...
         => ! [V1v0] :
             ...
             => ! [V2v1] :
                 ...
                 => ! [V3v2] :
                     ...
                     => ! [V4v3] :
                          ( mem(V4v3,A_27a)
                         => ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(A_27a),V0x),V1v0),V2v1),V3v2),V4v3) = ap(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Ebinary__ieee_2Efloat__compare2num,V0x)) ) ) ) ) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Efloat__compare__case__def,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0v0] :
            ( mem(V0v0,A_27a)
