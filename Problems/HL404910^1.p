...
thf(f5475_0_2E0,type,(
    f5475_0_2E0: u )).

thf(f5475_0_2E1,type,(
    f5475_0_2E1: du > u )).

thf(f5475_0_2E2,type,(
    f5475_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef5475_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f5475_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f5475_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef5475_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5475_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2Elbtree_2Emmindex__EXISTS,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2e_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5475_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) )
    <=> ? [V3n: mono_2Etyop_2Enum_2Enum] :
          ( ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) ) ) )
          = ( mono_2Ec_2Eoption_2ESOME_2Emono_2Etyop_2Enum_2Enum @ V3n ) ) ) )).

thf(thm_2Elbtree_2Emmindex__EXISTS,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EEXISTS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f5475_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ V1f_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) )
     => ? [V4i: mono_2Etyop_2Enum_2Enum,V5m: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Eis__mmindex_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4i ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5m ) ) ) ) ) ) )).
