...
fof(conj_thm_2Epred__set_2ECOMPL__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(c_2Epred__set_2ECOMPL(A_27a),c_2Epred__set_2EEMPTY(A_27a)) = c_2Epred__set_2EUNIV(A_27a) ) )).
...
fof(conj_thm_2Efinite__map_2EFUPDATE__LIST__SAME__UPDATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
