...
tff(lmtp_f4022,type,(
    f4022: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f4022,axiom,(
    ! [V0k: tp__ty_2Enum_2Enum] : mem(f4022(V0k),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f4022,axiom,(
    ! [V0k: tp__ty_2Enum_2Enum,V5i: tp__ty_2Enum_2Enum] : ap(f4022(V0k),inj__ty_2Enum_2Enum(V5i)) = ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V5i)),inj__ty_2Enum_2Enum(V0k)) )).

tff(conj_thm_2Ereal__topology_2ESUMS__REINDEX__GEN,conjecture,(
    ! [V0k: tp__ty_2Enum_2Enum,V1a: $i] :
      ( mem(V1a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2l: tp__ty_2Erealax_2Ereal,V3s: $i] :
          ( mem(V3s,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,f4021(V0k,V1a)),inj__ty_2Erealax_2Ereal(V2l)),V3s))
          <=> p(ap(ap(ap(c_2Ereal__topology_2Esums,V1a),inj__ty_2Erealax_2Ereal(V2l)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f4022(V0k)),V3s))) ) ) ) )).
