...
thf(f3703_0_2E0,type,(
    f3703_0_2E0: u )).

thf(f3703_0_2E1,type,(
    f3703_0_2E1: du > u )).
...
thf(mono_2Ef3703_0,type,(
    mono_2Ef3703_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EEVENTUAL__AS__SBEFORE,axiom,(
    ! [V1t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3703_0 @ V1t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2ETemporal__Logic_2EEVENTUAL__AS__SBEFORE,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V0b )
      = ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V0b @ mono_2Ef3703_0 ) ) )).
