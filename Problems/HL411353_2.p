...
tff(conj_thm_2Ereal__topology_2EOPEN__NEGATIONS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EOpen,V0s))
       => p(ap(c_2Ereal__topology_2EOpen,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3701),V0s))) ) ) )).
