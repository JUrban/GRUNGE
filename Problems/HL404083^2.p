...
thf(conj_thm_2ETemporal__Logic_2EUNTIL__SIGNAL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EPast__Temporal__Logic_2ECONJUNCTIVE__NORMAL__FORM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ( ( ( ap @ c_2ETemporal__Logic_2ENEXT
                  ...
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V4t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V4t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V4t ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2EALWAYS
                  ...
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V6t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ V0a ) @ V6t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2EALWAYS @ V1b ) @ V6t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2ETemporal__Logic_2EWHEN
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V7t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V7t ) ) @ ( ap @ V1b @ V7t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V8t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V0a ) @ V2c ) @ V8t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V1b ) @ V2c ) @ V8t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2ETemporal__Logic_2ESWHEN
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V9t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V9t ) ) @ ( ap @ V1b @ V9t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V10t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V0a ) @ V2c ) @ V10t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V1b ) @ V2c ) @ V10t ) ) ) )
                & ( ( ap
                  ...
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V12t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EUNTIL @ V0a ) @ V2c ) @ V12t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EUNTIL @ V1b ) @ V2c ) @ V12t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V13t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V13t ) ) @ ( ap @ V1b @ V13t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V14t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V0a ) @ V2c ) @ V14t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V1b ) @ V2c ) @ V14t ) ) ) )
                & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V2c )
                  ...
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V16t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V2c ) @ V0a ) @ V16t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V2c ) @ V1b ) @ V16t ) ) ) )
                & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESBEFORE @ V2c )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V17t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V17t ) ) @ ( ap @ V1b @ V17t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V18t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESBEFORE @ V2c ) @ V0a ) @ V18t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESBEFORE @ V2c ) @ V1b ) @ V18t ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V19t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V19t ) ) @ ( ap @ V1b @ V19t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V20t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V20t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V20t ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V21t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V21t ) ) @ ( ap @ V1b @ V21t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V22t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0a ) @ V22t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V22t ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V23t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V23t ) ) @ ( ap @ V1b @ V23t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V24t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS @ V0a ) @ V24t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS @ V1b ) @ V24t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V25t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V25t ) ) @ ( ap @ V1b @ V25t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V26t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN @ V0a ) @ V2c ) @ V26t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN @ V1b ) @ V2c ) @ V26t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V27t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V27t ) ) @ ( ap @ V1b @ V27t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V28t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V0a ) @ V2c ) @ V28t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V1b ) @ V2c ) @ V28t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V29t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V29t ) ) @ ( ap @ V1b @ V29t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V30t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL @ V0a ) @ V2c ) @ V30t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL @ V1b ) @ V2c ) @ V30t ) ) ) )
                & ( ( ap
                    @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V31t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V31t ) ) @ ( ap @ V1b @ V31t ) ) ) )
                    @ V2c )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V32t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V2c ) @ V32t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V32t ) ) ) )
                & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V2c )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V33t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V33t ) ) @ ( ap @ V1b @ V33t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V34t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V2c ) @ V0a ) @ V34t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V2c ) @ V1b ) @ V34t ) ) ) )
                & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V2c )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V35t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V35t ) ) @ ( ap @ V1b @ V35t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V36t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V2c ) @ V0a ) @ V36t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V2c ) @ V1b ) @ V36t ) ) ) ) ) ) ) ) )).
