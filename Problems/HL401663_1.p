...
tff(thm_2Epred__set_2EINFINITE__UNIV,axiom,(
    ...
    <=> ? [V0f_2E0: u] :
          ( ! [V1x_2E0: u,V2y_2E0: u] :
              ( s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0f_2E0),s(A_27a,V1x_2E0))) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0f_2E0),s(A_27a,V2y_2E0)))
             => s(A_27a,V1x_2E0) = s(A_27a,V2y_2E0) )
          & ? [V3y_2E0: u] :
            ! [V4x_2E0: u] : s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0f_2E0),s(A_27a,V4x_2E0))) != s(A_27a,V3y_2E0) ) ) )).
...
tff(thm_2Epred__set_2EINFINITE__NUM__UNIV,conjecture,(
