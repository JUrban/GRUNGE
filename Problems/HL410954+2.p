    ...
    ! [V3s] :
     ...
     => ! [V4t] :
         ...
         => ! [V5x] :
             ...
             => ap(f3788(V3s,V4t),V5x) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V3s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V4t)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__SET,conjecture,(
    ! [V0l] :
     ...
     => ! [V1f] :
         ...
         => ! [V2a] :
             ...
             => ! [V3s] :
                 ...
                 => ! [V4t] :
                      ( mem(V4t,arr(ty_2Erealax_2Ereal,bool))
                     => ( p(ap(ap(c_2Ereal__topology_2Eeventually(ty_2Erealax_2Ereal),f3788(V3s,V4t)),ap(c_2Ereal__topology_2Eat,V2a)))
