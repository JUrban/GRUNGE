...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__ID,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),i(ty_2Erealax_2Ereal)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V0a)),V1s))) ) ) )).
