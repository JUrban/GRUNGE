...
thf(c_2ETemporal__Logic_2EWATCH_2E2,type,(
    c_2ETemporal__Logic_2EWATCH_2E2: du > du > u )).
...
thf(thm_2ETemporal__Logic_2EWATCH__REC,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1q: mono_2Etyop_2Enum_2Enum > $o,V2b: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EWATCH @ V1q @ V2b @ V0t0 )
    <=> ( ( (~) @ ( V1q @ V0t0 ) )
        & ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( V2b @ V0t0 ) @ ( mono_2Ec_2ETemporal__Logic_2ENEXT @ ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ V1q ) @ V0t0 ) @ ( mono_2Ec_2ETemporal__Logic_2ENEXT @ ( mono_2Ec_2ETemporal__Logic_2EWATCH @ V1q @ V2b ) @ V0t0 ) ) ) ) )).
