...
fof(conj_thm_2Ewords_2En2w__itself__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
         ...
         => ( ! [V1n] :
               ...
               => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1n),c_2Ebool_2Ethe__value(A_27a)))) )
           => ! [V2v] :
                ( mem(V2v,ty_2Enum_2Enum)
               => ! [V3v1] :
                    ( mem(V3v1,ty_2Ebool_2Eitself(A_27a))
                   => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2v),V3v1))) ) ) ) ) ) )).
