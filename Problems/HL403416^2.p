...
thf(conj_thm_2Ebag_2ESUB__BAG__DIFF,lemma,(
    ! [A_27a: del] :
      ( ! [V0b1: $i] :
          ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ! [V1b2: $i] :
...
thf(conj_thm_2Ebag_2ESUB__BAG__SET,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2ESET__OF__BAG__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2Emlt__dominates__thm1,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) )
       => ! [V1b1: $i] :
...
thf(conj_thm_2Ebag_2Ebdominates__BAG__DIFF,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
...
thf(conj_thm_2Ebag_2EBAG__INTER__FINITE,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2Emlt__dominates__thm2,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
          & ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) ) )
