...
fof(conj_thm_2Epred__set_2EDISJOINT__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Efinite__map_2EFUPDATE__FUPDATE__LIST__COMMUTES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0k] :
              ( mem(V0k,A_27a)
             => ! [V1kvl] :
                  ( mem(V1kvl,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                 => ! [V2fm] :
                      ( mem(V2fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                     => ! [V3v] :
                          ( mem(V3v,A_27b)
                         => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V0k),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1kvl))))
                           => ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0k),V3v))),V1kvl) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V2fm),V1kvl)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0k),V3v)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Efinite__map_2EFUPDATE__LIST__APPEND__COMMUTES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ! [V2fm] :
                      ( mem(V2fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                     => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l1))),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1l2))))
                       => ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V2fm),V0l1)),V1l2) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V2fm),V1l2)),V0l1) ) ) ) ) ) ) )).
