...
fof(thm_2Equotient__list_2EAPPEND__RSP,axiom,(
    ! [A_27a,A_27b,V0R_2E0,V1abs_2E0,V2rep_2E0] :
     ...
     => ! [V3l1_2E0,V4l2_2E0,V5m1_2E0,V6m2_2E0] :
          ( ( p(s(tyop_2Emin_2Ebool,c_2Elist_2ELIST__REL_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Elist_2Elist(A_27a),V3l1_2E0),s(tyop_2Elist_2Elist(A_27a),V4l2_2E0))))
            & p(s(tyop_2Emin_2Ebool,c_2Elist_2ELIST__REL_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Elist_2Elist(A_27a),V5m1_2E0),s(tyop_2Elist_2Elist(A_27a),V6m2_2E0)))) )
         => p(s(tyop_2Emin_2Ebool,c_2Elist_2ELIST__REL_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V3l1_2E0),s(tyop_2Elist_2Elist(A_27a),V5m1_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V4l2_2E0),s(tyop_2Elist_2Elist(A_27a),V6m2_2E0)))))) ) ) )).

fof(thm_2Equotient__list_2EREVERSE__RSP,conjecture,(
    ! [A_27a,A_27b,V0R_2E0,V1abs_2E0,V2rep_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Equotient_2EQUOTIENT_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Emin_2Efun(A_27a,A_27b),V1abs_2E0),s(tyop_2Emin_2Efun(A_27b,A_27a),V2rep_2E0))))
     => ! [V3l1_2E0,V4l2_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Elist_2ELIST__REL_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Elist_2Elist(A_27a),V3l1_2E0),s(tyop_2Elist_2Elist(A_27a),V4l2_2E0))))
         => p(s(tyop_2Emin_2Ebool,c_2Elist_2ELIST__REL_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EREVERSE_2E1(s(tyop_2Elist_2Elist(A_27a),V3l1_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EREVERSE_2E1(s(tyop_2Elist_2Elist(A_27a),V4l2_2E0)))))) ) ) )).
