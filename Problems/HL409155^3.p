...
thf(thm_2Eieee_2Eroundmode2num__thm,axiom,
    ( ( ( c_2Eieee_2Eroundmode2num @ c_2Eieee_2ETo__nearest )
      = c_2Enum_2E0 )
    & ( ( c_2Eieee_2Eroundmode2num @ c_2Eieee_2Efloat__To__zero )
      = ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) )
    & ( ( c_2Eieee_2Eroundmode2num @ c_2Eieee_2ETo__pinfinity )
      = ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) )
    & ( ( c_2Eieee_2Eroundmode2num @ c_2Eieee_2ETo__ninfinity )
      = ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )).

thf(thm_2Eieee_2Eroundmode__EQ__roundmode,axiom,(
    ! [V0a: tyop_2Eieee_2Eroundmode,V1a_27: tyop_2Eieee_2Eroundmode] :
      ( ( V0a = V1a_27 )
    <=> ( ( c_2Eieee_2Eroundmode2num @ V0a )
        = ( c_2Eieee_2Eroundmode2num @ V1a_27 ) ) ) )).
...
thf(thm_2Eieee_2Eroundmode__distinct,conjecture,
