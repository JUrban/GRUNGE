...
tff(conj_thm_2Eprim__rec_2ELESS__NOT__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Earithmetic_2ELESS__EQ__IMP__LESS__SUC,lemma,(
...
tff(conj_thm_2Elist_2ECARD__LIST__TO__SET,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
tff(conj_thm_2Elist_2ECARD__LIST__TO__SET__ALL__DISTINCT,conjecture,(
    ! [A_27a: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(A_27a))
