                    ...
                    @ ( lam @ A_27b
                      @ ^ [V2x: $i] :
                          ...
                          @ ( lam @ ( ty_2Elist_2Elist @ A_27b )
                            @ ^ [V3xs: $i] :
                                ( ap @ ( c_2Estate__transformer_2EUNIT @ A_27a @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V2x ) @ V3xs ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2Estate__transformer_2EmapM__cons,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
                ...
                = ( ap @ ( ap @ ( c_2Estate__transformer_2EBIND @ A_27a @ A_27b @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ V0f @ V1x ) )
                  @ ( lam @ A_27b
                    @ ^ [V3y: $i] :
                        ...
                        @ ( lam @ ( ty_2Elist_2Elist @ A_27b )
                          @ ^ [V4ys: $i] :
                              ( ap @ ( c_2Estate__transformer_2EUNIT @ A_27a @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V3y ) @ V4ys ) ) ) ) ) ) ) ) ) ) )).
