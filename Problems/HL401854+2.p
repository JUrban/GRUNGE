...
fof(conj_thm_2Epred__set_2ECARD__REST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
              & V0s != c_2Epred__set_2EEMPTY(A_27a) )
           => ap(c_2Epred__set_2ECARD(A_27a),ap(c_2Epred__set_2EREST(A_27a),V0s)) = ap(ap(c_2Earithmetic_2E_2D,ap(c_2Epred__set_2ECARD(A_27a),V0s)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) ) ) ) )).
