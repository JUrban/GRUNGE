...
thf(conj_thm_2Ellist_2ELFINITE__fromList,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V0l ) ) ) ) )).

thf(conj_thm_2Ellist_2ELLENGTH__fromList,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V0l ) ) )
        = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELNTH__fromList,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V1l ) )
