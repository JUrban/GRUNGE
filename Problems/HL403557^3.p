...
thf(thm_2Ewellorder_2Eseteq__wlog,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0P: A_27a > A_27a > $o,V1f: A_27a > A_27b > $o] :
      ( ( ! [V2a: A_27a,V3b: A_27a] :
            ( ( V0P @ V2a @ V3b )
           => ( V0P @ V3b @ V2a ) )
        & ! [V4x: A_27b,V5a: A_27a,V6b: A_27a] :
            ( ( ( V0P @ V5a @ V6b )
              & ( c_2Ebool_2EIN @ A_27b @ V4x @ ( V1f @ V5a ) ) )
           => ( c_2Ebool_2EIN @ A_27b @ V4x @ ( V1f @ V6b ) ) ) )
     => ! [V7a: A_27a,V8b: A_27a] :
          ( ( V0P @ V7a @ V8b )
         => ( ( V1f @ V7a )
            = ( V1f @ V8b ) ) ) ) )).
