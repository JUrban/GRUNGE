...
fof(conj_thm_2Earithmetic_2EMODEQ__0__CONG,lemma,(
    ! [V0m1] :
...
fof(conj_thm_2Earithmetic_2EMODEQ__NONZERO__MODEQUALITY,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m1] :
...
fof(conj_thm_2Earithmetic_2EMODEQ__THM,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m1] :
          ( mem(V1m1,ty_2Enum_2Enum)
