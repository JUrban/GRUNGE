...
fof(conj_thm_2EEncode_2Eencode__blist__def__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0e] :
            ...
            & ! [V2m] :
               ...
               => ! [V3e] :
                   ...
                   => ! [V4l] :
                        ( mem(V4l,ty_2Elist_2Elist(A_27b))
                       => ap(ap(ap(c_2EEncode_2Eencode__blist(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V2m))),V3e),V4l) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(V3e,ap(c_2Elist_2EHD(A_27b),V4l))),ap(ap(ap(c_2EEncode_2Eencode__blist(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V2m))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3e),ap(c_2Elist_2ETL(A_27b),V4l))) ) ) )
            & ! [V5m] :
               ...
               => ! [V6e] :
                   ...
                   => ! [V7l] :
                       ...
                       => ap(ap(ap(c_2EEncode_2Eencode__blist(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V5m))),V6e),V7l) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(V6e,ap(c_2Elist_2EHD(A_27b),V7l))),ap(ap(ap(c_2EEncode_2Eencode__blist(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V5m))),V6e),ap(c_2Elist_2ETL(A_27b),V7l))) ) ) ) ) ) ) )).
