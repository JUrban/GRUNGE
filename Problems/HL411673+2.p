...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ereal__topology_2EUNCOUNTABLE__INTERVAL,lemma,
    ( ! [V0a] :
    ...
    & ! [V2a] :
       ...
       => ! [V3b] :
           ...
           => ( ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
             => ~ p(ap(c_2Epred__set_2Ecountable(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOUNTABLE__OPEN__INTERVAL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Epred__set_2Ecountable(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b))))
          <=> ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) )).
