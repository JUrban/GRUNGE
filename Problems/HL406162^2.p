...
thf(conj_thm_2Ewords_2En2w__sub,lemma,(
...
thf(conj_thm_2Ewords_2Esaturate__add,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ewords_2Esaturate__add @ A_27a ) @ V0a ) @ V1b )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ ( c_2Ewords_2Eword__T @ A_27a ) ) @ V0a ) ) @ V1b ) ) @ ( c_2Ewords_2Eword__T @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0a ) @ V1b ) ) ) ) ) )).
