...
thf(conj_thm_2Elbtree_2Eoptmin__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ( p @ ( ap @ ( ap @ V0P @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) )
          & ! [V1x: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) )
          & ! [V2y: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2y ) ) ) )
          & ! [V3x: tp__ty_2Enum_2Enum,V4y: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V3x ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V4y ) ) ) ) )
       => ! [V5v: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum,V6v1: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V5v ) ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V6v1 ) ) ) ) ) )).
