...
tff(conj_thm_2Elist_2EMEM__GENLIST,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1f: $i] :
...
tff(conj_thm_2Esorting_2ESORTED__NIL,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => p(ap(ap(c_2Esorting_2ESORTED(A_27a),V0R),c_2Elist_2ENIL(A_27a))) ) )).

tff(conj_thm_2Esorting_2Eless__sorted__eq,lemma,(
...
tff(conj_thm_2Esorting_2ESORTED__GENLIST__PLUS,conjecture,(
