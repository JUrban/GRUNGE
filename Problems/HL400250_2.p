...
tff(conj_thm_2Ecombin_2EUPD11__SAME__KEY__AND__BASE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
         => ! [V2b: $i] :
             ...
             => ! [V3c: $i] :
                  ( mem(V3c,A_27b)
                 => ( ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V1a),V2b),V0f) = ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V1a),V3c),V0f)
                  <=> V2b = V3c ) ) ) ) ) )).
