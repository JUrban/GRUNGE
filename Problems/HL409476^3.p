...
thf(thm_2Efloat_2EFLOAT__DIV,conjecture,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( ( c_2Eieee_2EFinite @ V0a )
        ...
        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2E_2F @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) @ ( c_2Eieee_2Ethreshold @ c_2Eieee_2Efloat__format ) ) )
     => ( ( c_2Eieee_2EFinite @ ( c_2Eieee_2Efloat__div @ V0a @ V1b ) )
        & ( ( c_2Eieee_2EVal @ ( c_2Eieee_2Efloat__div @ V0a @ V1b ) )
          = ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2E_2F @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) @ ( c_2Efloat_2Eerror @ ( c_2Ereal_2E_2F @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) ) ) ) ) )).
