...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__COMPACT,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE__GEN,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
    ...
    ! [V2s: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V3k: $i] :
             ...
             => mem(f3883(V2s,V1f,V3k),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

tff(lameq_f3883,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3k: $i] :
              ( mem(V3k,arr(ty_2Erealax_2Ereal,bool))
             => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3883(V2s,V1f,V3k),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1f,inj__ty_2Erealax_2Ereal(V4x))),V3k))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EPROPER__MAP__FROM__COMPACT,conjecture,(
    ! [V0t: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3k: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1f),V2s))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1f),V2s)),V0t))
                      & p(ap(c_2Ereal__topology_2Ecompact,V2s))
                      & p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0t)),V3k)) )
                   => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3883(V2s,V1f,V3k)))) ) ) ) ) ) )).
