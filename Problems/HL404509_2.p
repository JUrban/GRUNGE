...
tff(conj_thm_2Ecardinal_2EINFINITE__IMAGE__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(conj_thm_2Ecardinal_2EINFINITE__NONEMPTY,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => V0s != c_2Epred__set_2EEMPTY(A_27a) ) ) )).
...
tff(conj_thm_2Ecardinal_2ELT__CASES,lemma,(
...
tff(conj_thm_2Ecardinal_2EINFINITE__CARD__LE,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
