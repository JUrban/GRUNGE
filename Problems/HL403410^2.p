...
thf(tp_c_2Ebag_2Edominates,type,(
    c_2Ebag_2Edominates: del > del > $i )).

thf(mem_c_2Ebag_2Edominates,axiom,(
    ! [A_27a: del,A_27b: del] :
...
thf(ax_thm_2Ebag_2EBAG__INN,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
...
thf(ax_thm_2Ebag_2ESUB__BAG,axiom,(
    ! [A_27a: del,V0b1: $i] :
...
thf(ax_thm_2Ebag_2EBAG__DIFF,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V0b1 ) @ V1b2 )
            = ( lam @ A_27a
              @ ^ [V2x: $i] :
                  ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ V0b1 @ V2x ) ) @ ( ap @ V1b2 @ V2x ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__IN__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1e1: $i] :
          ( ( mem @ V1e1 @ A_27a )
...
thf(conj_thm_2Ebag_2EBAG__UNION__RIGHT__CANCEL,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b1: $i] :
         ...
         => ! [V2b2: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1b1 ) @ V0b )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2b2 ) @ V0b ) )
              <=> ( V1b1 = V2b2 ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EBAG__UNION__DIFF__eliminate,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b ) @ V1c ) ) @ V1c )
              = V0b )
            & ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1c ) @ V0b ) ) @ V1c )
              = V0b ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__IN__DIFF__E,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2ESUB__BAG__BAG__IN,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EIN__SET__OF__BAG,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EFINITE__BAG__DIFF,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2EFINITE__SUB__BAG,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b1 ) )
       => ! [V1b2: $i] :
...
thf(conj_thm_2Ebag_2ESUB__BAG__DIFF__EQ,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2ESUB__BAG @ A_27a ) @ V0b1 ) @ V1b2 ) )
           => ( V1b2
              = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b2 ) @ V0b1 ) ) ) ) ) ) )).

thf(ax_thm_2Ebag_2EBAG__FILTER__DEF,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__FILTER @ A_27a ) @ V0P ) @ V1b )
            = ( lam @ A_27a
              @ ^ [V2e: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ V0P @ V2e ) ) @ ( ap @ V1b @ V2e ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__IN__BAG__FILTER,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1P: $i] :
...
thf(ax_thm_2Ebag_2Edominates__def,axiom,(
...
thf(conj_thm_2Erelation_2ETC__STRONG__INDUCT__LEFT1,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1P: $i] :
...
thf(conj_thm_2Ebag_2Emlt__dominates__thm1,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) )
       => ! [V1b1: $i] :
                ...
                <=> ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V1b1 ) )
                    ...
                    & ? [V3x: $i] :
                        ...
                        & ? [V4y: $i] :
                            ...
                            & ( V1b1
                              = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V2b2 ) @ V3x ) ) @ V4y ) )
