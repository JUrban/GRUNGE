...
tff(conj_thm_2Ebit_2EBITS__ZERO3,lemma,(
...
tff(conj_thm_2Ebit_2ESLICE__ZERO__THM,lemma,(
...
tff(conj_thm_2Ebit_2ESLICE__COMP__THM,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__SLICE__THM,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__BITS__THM,lemma,(
...
tff(conj_thm_2Esum__num_2EGSUM__FUN__EQUAL,lemma,(
...
tff(mem_c_2Ewords_2Esaturate__n2w,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Esaturate__n2w(A_27a),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool))) )).

tff(tp_c_2Ewords_2Esaturate__w2w,type,(
    c_2Ewords_2Esaturate__w2w: ( del * del ) > $i )).

tff(mem_c_2Ewords_2Esaturate__w2w,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ewords_2Esaturate__w2w(A_27a,A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(lamtp_f2162,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2162(A_27a,V0w),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f2162,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f2162(A_27a,V0w),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Ebit_2ESBIT,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),inj__ty_2Enum_2Enum(V1i))),inj__ty_2Enum_2Enum(V1i)) ) )).

tff(ax_thm_2Ewords_2Ew2n__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => surj__ty_2Enum_2Enum(ap(c_2Ewords_2Ew2n(A_27a),V0w)) = surj__ty_2Enum_2Enum(ap(ap(c_2Esum__num_2ESUM,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),f2162(A_27a,V0w))) ) )).
...
tff(ax_thm_2Ewords_2Esaturate__n2w__def,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(c_2Ewords_2Esaturate__n2w(A_27a),inj__ty_2Enum_2Enum(V0n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Enum_2Enum(V0n))),c_2Ewords_2Eword__T(A_27a)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))) )).

tff(ax_thm_2Ewords_2Esaturate__w2w__def,axiom,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ap(c_2Ewords_2Esaturate__w2w(A_27a,A_27a),V0w) = ap(c_2Ewords_2Esaturate__n2w(A_27b),ap(c_2Ewords_2Ew2n(A_27a),V0w)) ) )).

tff(conj_thm_2Ewords_2EEXISTS__HB,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Ewords_2Edimindex__dimword__lt__iso,lemma,(
    ! [A_27a: del,A_27b: del] :
...
tff(lamtp_f2257,axiom,(
    ! [A_27b: del,A_27a: del] : mem(f2257(A_27b,A_27a),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2257,axiom,(
    ! [A_27b: del,A_27a: del,V1m: tp__ty_2Enum_2Enum] : ap(f2257(A_27b,A_27a),inj__ty_2Enum_2Enum(V1m)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Ewords_2Edimword(A_27b),c_2Ebool_2Ethe__value(A_27b))),inj__ty_2Enum_2Enum(V1m)))),c_2Ewords_2Eword__T(A_27b)),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(V1m))) )).

tff(conj_thm_2Ewords_2Esaturate__w2w__n2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum] : ap(c_2Ewords_2Esaturate__w2w(A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2257(A_27b,A_27a)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V0n)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))) )).
