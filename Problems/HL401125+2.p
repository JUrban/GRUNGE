...
fof(conj_thm_2Edivides_2ENOT__PRIME__0,lemma,(
    ~ p(ap(c_2Edivides_2Eprime,c_2Enum_2E0)) )).

fof(conj_thm_2Edivides_2ENOT__PRIME__1,lemma,(
    ~ p(ap(c_2Edivides_2Eprime,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) )).

fof(lamtp_f207,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f207(V0n),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f207,axiom,(
    ! [V0n] :
     ...
     => ! [V1p] :
         ...
         => ap(f207(V0n),V1p) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Edivides_2Eprime,V1p)),ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Edivides_2EPRIMES,V0n)),V1p)) ) ) )).
...
fof(conj_thm_2Edivides_2ENEXT__LARGER__PRIME,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ? [V1i] :
...
fof(conj_thm_2Edivides_2EPRIMES__NO__GAP,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,ty_2Enum_2Enum)
...
fof(conj_thm_2Edivides_2EPRIMES__ONTO,conjecture,(
    ! [V0p] :
