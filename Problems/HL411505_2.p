...
tff(lamtp_f3962,axiom,(
    mem(f3962,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3962,axiom,(
    ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3962,inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V2x)) )).

tff(lmtp_f3963,type,(
    f3963: $i )).

tff(lamtp_f3963,axiom,(
    mem(f3963,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3963,axiom,(
    ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3963,inj__ty_2Erealax_2Ereal(V5x)) = ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V5x)) )).

tff(conj_thm_2Ereal__topology_2EREFLECT__INTERVAL,conjecture,
    ( ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3962),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))) = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V1b))),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0a)))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))
    & ! [V3a: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3963),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V4b)))) = ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V4b))),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V3a)))) )).
