...
thf(thm_2Ereal__topology_2EMONOTONE__SUBSEQUENCE,axiom,(
    ...
    ? [V1r: tyop_2Enum_2Enum > tyop_2Enum_2Enum] :
      ( ! [V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ V2m @ V3n )
         => ( c_2Eprim__rec_2E_3C @ ( V1r @ V2m ) @ ( V1r @ V3n ) ) )
      & ( ! [V4m: tyop_2Enum_2Enum,V5n: tyop_2Enum_2Enum] :
            ( ( c_2Earithmetic_2E_3C_3D @ V4m @ V5n )
           => ( c_2Ereal_2Ereal__lte @ ( V0s @ ( V1r @ V4m ) ) @ ( V0s @ ( V1r @ V5n ) ) ) )
        | ! [V6m: tyop_2Enum_2Enum,V7n: tyop_2Enum_2Enum] :
            ( ( c_2Earithmetic_2E_3C_3D @ V6m @ V7n )
           => ( c_2Ereal_2Ereal__lte @ ( V0s @ ( V1r @ V7n ) ) @ ( V0s @ ( V1r @ V6m ) ) ) ) ) ) )).
