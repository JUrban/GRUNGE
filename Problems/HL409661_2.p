...
tff(conj_thm_2Ecardinal_2EHAS__SIZE__SUC,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Eiterate_2ENUMSEG__CLAUSES,lemma,
...
tff(conj_thm_2Eiterate_2ETOPOLOGICAL__SORT,conjecture,(
       ...
       => ! [V6n: tp__ty_2Enum_2Enum,V7s: $i] :
           ...
           => ( p(ap(ap(c_2Ecardinal_2EHAS__SIZE(A_27a),V7s),inj__ty_2Enum_2Enum(V6n)))
             => ? [V8f: $i] :
                  ...
                  & V7s = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V8f),ap(ap(c_2Eiterate_2E_2E_2E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V6n)))
