...
fof(ax_thm_2Eoption_2EOPTION__IGNORE__BIND__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0m1] :
             ...
             => ! [V1m2] :
                 ...
                 => ap(ap(c_2Eoption_2EOPTION__IGNORE__BIND(A_27a,A_27a),V0m1),V1m2) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27a,A_27a),V0m1),ap(c_2Ecombin_2EK(ty_2Eoption_2Eoption(A_27a),ty_2Eoption_2Eoption(A_27a)),V1m2)) ) ) ) ) )).

fof(conj_thm_2Eoption_2EOPTION__IGNORE__BIND__thm,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
