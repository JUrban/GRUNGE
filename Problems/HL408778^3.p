...
thf(thm_2EHolSmt_2Er157,conjecture,(
    ...
    <=> ( ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V5u @ V2x ) @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V4v @ V1y ) @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ V3w ) @ V0z ) ) )
        = V6a ) ) )).
