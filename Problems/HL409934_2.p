...
tff(lamtp_f3448,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => mem(f3448(A_27a,V0f,V2e),arr(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3448,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ! [V3acc: tp__ty_2Eextreal_2Eextreal] : ap(f3448(A_27a,V0f,V2e),inj__ty_2Eextreal_2Eextreal(V3acc)) = ap(ap(c_2Eextreal_2Eextreal__add,ap(V0f,V2e)),inj__ty_2Eextreal_2Eextreal(V3acc)) ) ) )).

tff(lmtp_f3447,type,(
    f3447: ( del * $i ) > $i )).

tff(lamtp_f3447,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f3447(A_27a,V0f),arr(A_27a,arr(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal))) ) )).

tff(lameq_f3447,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ap(f3447(A_27a,V0f),V2e) = f3448(A_27a,V0f,V2e) ) ) )).
...
tff(ax_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__DEF,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),f3447(A_27a,V0f)),V1s),ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__THM,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
