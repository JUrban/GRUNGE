...
thf(conj_thm_2Erich__list_2EIS__PREFIX__APPEND1,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(conj_thm_2Erich__list_2EIS__PREFIX__APPEND2,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2EEncode_2Ewf__encode__prod,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( ( mem @ V0p1 @ ( arr @ A_27a @ bool ) )
     => ! [V1p2: $i] :
          ( ( mem @ V1p2 @ ( arr @ A_27b @ bool ) )
