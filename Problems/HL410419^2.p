...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__0,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__ADD,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__SUM,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
