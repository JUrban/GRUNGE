...
thf(c_2EASCIInumbers_2Enum__from__oct__string,type,(
    c_2EASCIInumbers_2Enum__from__oct__string: ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > tyop_2Enum_2Enum )).

thf(c_2EASCIInumbers_2Enum__to__oct__string,type,(
    c_2EASCIInumbers_2Enum__to__oct__string: tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) )).
...
thf(thm_2EASCIInumbers_2Enum__from__oct__string__def,axiom,
    ...
    = ( c_2EASCIInumbers_2Es2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ c_2EASCIInumbers_2EUNHEX ) )).

thf(thm_2EASCIInumbers_2Enum__to__oct__string__def,axiom,
    ( c_2EASCIInumbers_2Enum__to__oct__string
    = ( c_2EASCIInumbers_2En2s @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ c_2EASCIInumbers_2EHEX ) )).
...
thf(thm_2EASCIInumbers_2Enum__oct__string,conjecture,
    ( ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ c_2EASCIInumbers_2Enum__from__oct__string @ c_2EASCIInumbers_2Enum__to__oct__string )
