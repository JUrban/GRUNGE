...
fof(lamtp_f3797,axiom,(
    ! [V1f] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3797(V1f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3797,axiom,(
    ! [V1f] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V6x] :
          ( mem(V6x,ty_2Erealax_2Ereal)
         => ap(f3797(V1f),V6x) = ap(V1f,V6x) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__CONG__WITHIN,conjecture,(
    ! [V0a] :
             ...
             => ! [V3l] :
                 ...
                 => ! [V4s] :
                     ...
                     => ( ! [V5x] :
                       ...
                       => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3797(V1f)),V3l),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V0a)),V4s)))
