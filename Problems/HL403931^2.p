...
thf(conj_thm_2Ellist_2ELAPPEND__fromList,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V0l1 ) ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V1l2 ) )
            = ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ V1l2 ) ) ) ) ) )).
