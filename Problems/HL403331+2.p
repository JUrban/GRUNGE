...
fof(lameq_f970,axiom,(
    ! [A_27a,V1b] :
     ...
     => ! [V0P] :
         ...
         => ! [V2e] :
              ( mem(V2e,A_27a)
             => ap(f970(A_27a,V1b,V0P),V2e) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(V0P,V2e)),ap(V1b,V2e)),c_2Enum_2E0) ) ) ) )).
...
fof(conj_thm_2Ebag_2EBAG__INN__BAG__FILTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
