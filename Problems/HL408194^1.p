...
thf(thm_2Epoly_2EPOLY__MUL__ASSOC,axiom,(
    ! [V0p: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V1q: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V2r: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29] :
      ( ( mono_2Ec_2Epoly_2Epoly @ ( mono_2Ec_2Epoly_2Epoly__mul @ V0p @ ( mono_2Ec_2Epoly_2Epoly__mul @ V1q @ V2r ) ) )
      = ( mono_2Ec_2Epoly_2Epoly @ ( mono_2Ec_2Epoly_2Epoly__mul @ ( mono_2Ec_2Epoly_2Epoly__mul @ V0p @ V1q ) @ V2r ) ) ) )).
...
thf(thm_2Epoly_2EPOLY__LENGTH__MUL,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29] :
      ( ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Epoly_2Epoly__mul @ ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__neg @ V0a ) @ ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ mono_2Ec_2Elist_2ENIL_2Emono_2Etyop_2Erealax_2Ereal ) ) @ V1q ) )
      = ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Erealax_2Ereal @ V1q ) ) ) )).

thf(thm_2Epoly_2EPOLY__ENTIRE,axiom,(
...
thf(thm_2Eprim__rec_2Enum__Axiom,axiom,(
    ...
    ? [V2fn_2E0: u] :
      ( ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2fn_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) )
        = ( s @ A_27a @ V0e_2E0 ) )
      & ! [V3n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2fn_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V3n ) ) ) ) )
          = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2fn_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) ) ) ) ) ) )).
...
thf(thm_2Epoly_2EPOLY__ORDER__EXISTS,conjecture,(
