...
tff(conj_thm_2Eset__relation_2Erel__to__reln__swap,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1R: $i] :
          ( mem(V1R,arr(A_27a,arr(A_27b,bool)))
         => ( V0r = ap(c_2Eset__relation_2Erel__to__reln(A_27a,A_27a),V1R)
          <=> ap(c_2Eset__relation_2Ereln__to__rel(A_27a,A_27a),V0r) = V1R ) ) ) )).
