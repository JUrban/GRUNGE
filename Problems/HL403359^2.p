...
thf(conj_thm_2Ebag_2ECOMMUTING__ITBAG__RECURSES,lemma,(
         ...
         => ! [V2b: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( ! [V4x: $i] :
                   ...
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ A_27b ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1e ) @ V2b ) ) @ V3a )
                      = ( ap @ ( ap @ V0f @ V1e ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ A_27b ) @ V0f ) @ V2b ) @ V3a ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__GEN__SUM__REC,conjecture,(
    ! [V0b: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
            ...
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__SUM @ V0b ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) ) ) ) ) )).
