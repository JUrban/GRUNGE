...
thf(conj_thm_2Eiterate_2EITERATE__DELETE,lemma,(
           ...
           => ! [V2s: $i] :
               ...
               => ! [V3a: $i] :
                   ...
                   => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V2s ) )
                     ...
                     => ( ( ap @ ( ap @ V0op @ ( ap @ V1f @ V3a ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b ) @ V0op ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27a ) @ V2s ) @ V3a ) ) @ V1f ) )
...
thf(conj_thm_2Eproduct_2EPRODUCT__DELETE,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V2a ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27a ) @ V1s ) @ V2a ) ) @ V0f ) ) )
