...
tff(lmtp_f3434,type,(
    f3434: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3434,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] : mem(f3434(V0p,V1n),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3434,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: tp__ty_2Erealax_2Ereal] : ap(f3434(V0p,V1n),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Ereal_2Epow,ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Enum_2Enum(V1n)) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__POW,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(c_2Eiterate_2Epolynomial__function,V0p))
