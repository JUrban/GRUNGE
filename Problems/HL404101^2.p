...
thf(conj_thm_2Earithmetic_2EMULT__MONO__EQ,lemma,(
...
thf(conj_thm_2Ebag_2EBAG__GEN__PROD__EQ__1,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
       => ! [V1e: tp__ty_2Enum_2Enum] :
            ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__PROD @ V0b ) @ ( inj__ty_2Enum_2Enum @ V1e ) ) )
              = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
           => ( V1e
              = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EBAG__GEN__PROD__POSITIVE,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ ty_2Enum_2Enum ) @ V0b ) )
...
thf(conj_thm_2Edivides_2Eprime__divides__only__self,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Egcd_2EP__EUCLIDES,lemma,(
...
thf(conj_thm_2EprimeFactor_2EUNIQUE__PRIME__FACTORS,conjecture,(
