...
thf(conj_thm_2Ereal__topology_2ELINEAR__INVERTIBLE__BOUNDED__BELOW__POS,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              ...
              & ( ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V0f )
                = ( c_2Ecombin_2EI @ ty_2Erealax_2Ereal ) ) )
           => ? [V2B: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V3x: tp__ty_2Erealax_2Ereal] :
                    ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2B ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELINEAR__INVERTIBLE__BOUNDED__BELOW,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
