...
tff(conj_thm_2Efinite__map_2ESUBMAP__FUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2f3: $i] :
             ...
             => ( ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f1),V1f2))
                  | ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f2)))
                    & p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f1),V2f3)) ) )
               => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f1),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V1f2),V2f3))) ) ) ) ) )).
