...
fof(conj_thm_2Erich__list_2ELAST__LASTN__LAST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0n))
                 => ap(c_2Elist_2ELAST(A_27a),ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),V1l)) = ap(c_2Elist_2ELAST(A_27a),V1l) ) ) ) ) ) )).
