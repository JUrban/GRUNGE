...
fof(ax_thm_2Ebitstring_2Ereplicate__def,axiom,(
    ! [V0v] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(ap(c_2Ebitstring_2Ereplicate,V0v),V1n) = ap(c_2Elist_2EFLAT(bool),ap(ap(c_2Elist_2EGENLIST(ty_2Elist_2Elist(bool)),ap(c_2Ecombin_2EK(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),V0v)),V1n)) ) ) )).

fof(conj_thm_2Ebitstring_2Eshiftl__replicate__F,conjecture,(
    ! [V0v] :
      ( mem(V0v,ty_2Elist_2Elist(bool))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
