...
tff(conj_thm_2Efinite__map_2EFLOOKUP__FUN__FMAP,conjecture,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
               => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUN__FMAP(A_27a,A_27a),V1f),V0P)),V2k) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27b)),ap(ap(c_2Ebool_2EIN(A_27a),V2k),V0P)),ap(c_2Eoption_2ESOME(A_27b),ap(V1f,V2k))),c_2Eoption_2ENONE(A_27b)) ) ) ) ) )).
