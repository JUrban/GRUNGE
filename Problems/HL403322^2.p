...
thf(conj_thm_2Ebag_2EBAG__CARD__UNION,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b1 ) )
              & ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V1b2 ) ) )
           => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V1b2 ) ) )
              = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ V0b1 ) ) @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ V1b2 ) ) ) ) ) ) ) )).
