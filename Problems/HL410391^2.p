...
thf(conj_thm_2Ereal__topology_2ELINEAR__0,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__ADD,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ELINEAR__SUM,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
