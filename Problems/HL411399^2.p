...
thf(conj_thm_2Ereal__topology_2ECONNECTED__EQUIVALENCE__RELATION,lemma,(
    ! [V0R: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__IN,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQUIVALENCE__RELATION,conjecture,(
    ! [V0R: $i] :
      ( ( mem @ V0R @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
              ...
              & ! [V7a: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ? [V8t: $i] :
                      ...
                      & ! [V9x: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Erealax_2Ereal @ V7a ) ) @ ( inj__ty_2Erealax_2Ereal @ V9x ) ) ) ) ) ) )
           => ! [V10a: tp__ty_2Erealax_2Ereal,V11b: tp__ty_2Erealax_2Ereal] :
                ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V1s ) @ ( inj__ty_2Erealax_2Ereal @ V10a ) ) @ ( inj__ty_2Erealax_2Ereal @ V11b ) ) )
               => ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Erealax_2Ereal @ V10a ) ) @ ( inj__ty_2Erealax_2Ereal @ V11b ) ) ) ) ) ) ) )).
