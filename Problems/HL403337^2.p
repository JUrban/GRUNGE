...
thf(conj_thm_2Ebag_2EBAG__CARD__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )
      = fo__c_2Enum_2E0 ) )).

thf(conj_thm_2Ebag_2EBAG__FILTER__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__FILTER @ A_27a ) @ V0P ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
        = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__IMAGE__EMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
