...
thf(conj_thm_2Einftree_2Eis__tree__strongind,conjecture,(
     ...
     => ( ( ! [V1a: $i] :
             ...
             => ( p
                @ ( ap @ V0is__tree_27
                  @ ( lam @ ( ty_2Elist_2Elist @ A_27d )
                    @ ^ [V2p: $i] :
                        ( ap @ ( c_2Esum_2EINL @ A_27a @ A_27b ) @ V1a ) ) ) ) )
          & ! [V3f: $i] :
                 ...
                 => ( ! [V5d: $i] :
                   ...
                   => ( p
                      @ ( ap @ V0is__tree_27
                        @ ( lam @ ( ty_2Elist_2Elist @ A_27d )
                          @ ^ [V6p: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ A_27d ) ) @ V6p ) @ ( c_2Elist_2ENIL @ A_27d ) ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27a @ A_27b ) @ V4b ) ) @ ( ap @ ( ap @ V3f @ ( ap @ ( c_2Elist_2EHD @ A_27d ) @ V6p ) ) @ ( ap @ ( c_2Elist_2ETL @ A_27d ) @ V6p ) ) ) ) ) ) ) ) ) )
       => ! [V7a0: $i] :
