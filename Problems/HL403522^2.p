...
thf(conj_thm_2Ewellorder_2Ewellorder__fromNat__SUM,lemma,(
...
thf(ax_thm_2Ewellorder_2EfromNatWO__def,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Ewellorder_2EfromNatWO @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) )
      = ( ap @ ( c_2Ewellorder_2Ewellorder__ABS @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
          @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ bool ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1i: $i] :
...
thf(conj_thm_2Ewellorder_2EelsOf__fromNatWO,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Ewellorder_2EelsOf @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ ( c_2Ewellorder_2EfromNatWO @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
