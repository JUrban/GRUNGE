...
thf(f12162_0_2E0,type,(
    f12162_0_2E0: u )).

thf(f12162_0_2E1,type,(
    f12162_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef12162_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12162_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ f12162_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eproduct_2ENPRODUCT__ONE,axiom,(
    ! [A_27a: d,V1n_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12162_0_2E1 @ ( s @ A_27a @ V1n_2E0 ) ) ) )
      = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )).

thf(thm_2Eproduct_2ENPRODUCT__ONE,conjecture,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Eproduct_2Enproduct_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ f12162_0_2E0 ) ) ) )
      = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )).
