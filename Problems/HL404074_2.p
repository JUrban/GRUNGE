...
tff(conj_thm_2ETemporal__Logic_2EALWAYS__AS__BEFORE,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f904,axiom,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1t0: tp__ty_2Enum_2Enum] : ap(f904(V0b),inj__ty_2Enum_2Enum(V1t0)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0b),inj__ty_2Enum_2Enum(V1t0))) ) )).

tff(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__BEFORE,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1347,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1347(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,k(ty_2Enum_2Enum,c_2Ebool_2EF)),f882(V0a)),inj__ty_2Enum_2Enum(V2t)) ) )).

tff(lmtp_f1348,type,(
    f1348: $i > $i )).

tff(lamtp_f1348,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1348,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1348(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0a),inj__ty_2Enum_2Enum(V5t))) ) )).
...
tff(lameq_f1349,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1349(V0a,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1350(V0a)),V1b),inj__ty_2Enum_2Enum(V7t))) ) ) )).
...
tff(lameq_f1351,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V9t: tp__ty_2Enum_2Enum] : ap(f1351(V1b,V0a),inj__ty_2Enum_2Enum(V9t)) = ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),f1352(V0a,V1b)),inj__ty_2Enum_2Enum(V9t)) ) ) )).

tff(lmtp_f1353,type,(
    f1353: ( $i * $i ) > $i )).

tff(lamtp_f1353,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1353,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V11t: tp__ty_2Enum_2Enum] : ap(f1353(V0a,V1b),inj__ty_2Enum_2Enum(V11t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),f1315(V0a,V1b)),inj__ty_2Enum_2Enum(V11t))) ) ) )).
...
tff(lameq_f1354,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V13t: tp__ty_2Enum_2Enum] : ap(f1354(V1b,V0a),inj__ty_2Enum_2Enum(V13t)) = ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1355(V0a,V1b)),f1318(V0a,V1b)),inj__ty_2Enum_2Enum(V13t)) ) ) )).
...
tff(lameq_f1356,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V16t: tp__ty_2Enum_2Enum] : ap(f1356(V0a,V1b),inj__ty_2Enum_2Enum(V16t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),f1357(V0a,V1b)),inj__ty_2Enum_2Enum(V16t))) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EBEFORE__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
