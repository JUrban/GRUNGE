...
thf(f2345_0_2E0,type,(
    f2345_0_2E0: u )).

thf(f2345_0_2E1,type,(
    f2345_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2345_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2345_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ f2345_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2EFRONT__DEF,axiom,(
    ! [A_27a: d,V1t_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2345_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )).

thf(thm_2Elist_2EFRONT__DEF,axiom,(
    ! [A_27a: d,V0h_2E0: u,V1t_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFRONT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f2345_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFRONT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Elist_2EFRONT__CONS__EQ__NIL,axiom,(
    ! [A_27a: d] :
      ( ! [V0x_2E0: u,V1xs_2E0: u] :
          ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFRONT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1xs_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
        <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1xs_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
      & ! [V2x_2E0: u,V3xs_2E0: u] :
          ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFRONT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 ) ) ) ) ) )
        <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
      & ! [V4x_2E0: u,V5xs_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFRONT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5xs_2E0 ) ) ) ) ) ) ) )
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5xs_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Erich__list_2ETAKE__PRE__LENGTH,conjecture,(
    ! [A_27a: d,V0ls_2E0: u] :
      ( ( (~)
