...
tff(conj_thm_2Ereal_2EREAL__LTE__ANTSYM,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ~ ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1y)),inj__ty_2Erealax_2Ereal(V0x))) ) )).
...
tff(conj_thm_2Ereal_2ENUM__FLOOR__DIV__LOWERBOUND,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(lmtp_f2750,type,(
    f2750: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2750,axiom,(
    ! [V0r: tp__ty_2Erealax_2Ereal] : mem(f2750(V0r),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f2750,axiom,(
    ! [V0r: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2750(V0r),inj__ty_2Enum_2Enum(V1n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0r)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0r)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1n))))),inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).

tff(conj_thm_2Ereal_2ENUM__CEILING__NUM__FLOOR,conjecture,(
    ! [V0r: tp__ty_2Erealax_2Ereal] : surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__CEILING,inj__ty_2Erealax_2Ereal(V0r))) = surj__ty_2Enum_2Enum(ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2750(V0r)),ap(c_2Ereal_2ENUM__FLOOR,inj__ty_2Erealax_2Ereal(V0r)))) )).
