...
thf(thm_2Ebag_2EBAG__IN__DIVIDES,axiom,(
    ! [V0b: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1x: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EFINITE__BAG @ tyop_2Enum_2Enum @ V0b )
        & ( c_2Ebag_2EBAG__IN @ tyop_2Enum_2Enum @ V1x @ V0b ) )
     => ( c_2Edivides_2Edivides @ V1x @ ( c_2Ebag_2EBAG__GEN__PROD @ V0b @ V2a ) ) ) )).
...
thf(thm_2EprimeFactor_2EPRIME__FACTOR__DIVIDES,conjecture,(
