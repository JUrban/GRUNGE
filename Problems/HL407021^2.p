...
thf(conj_thm_2Eint__arith_2Eeq__context__rwt1,lemma,(
    ! [V0c: tp__ty_2Einteger_2Eint,V1x: tp__ty_2Einteger_2Eint,V2y: tp__ty_2Einteger_2Eint] :
      ( ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
        = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( inj__ty_2Einteger_2Eint @ V0c ) ) @ ( inj__ty_2Einteger_2Eint @ V1x ) ) ) )
     => ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( inj__ty_2Einteger_2Eint @ V0c ) ) @ ( inj__ty_2Einteger_2Eint @ V2y ) ) ) )
...
thf(conj_thm_2Einteger_2EINT__NEG__LE0,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__LE__ADD,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
      ( ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Einteger_2Eint @ V0x ) ) )
...
thf(conj_thm_2Einteger_2EINT__MOD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( ( V1m != fo__c_2Enum_2E0 )
...
thf(conj_thm_2Einteger_2EINT__LESS__MOD,lemma,(
...
thf(conj_thm_2Einteger__word_2Eword__msb__i2w,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger__word_2Ei2w__0,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Einteger__word_2Edifferent__sign__then__no__overflow,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Einteger__word_2Ew2i__i2w__pos,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Einteger_2Eint @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
        = ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).

thf(conj_thm_2Einteger__word_2Ew2i__i2w__neg,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Ewords_2EINT__MIN @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
     => ( ( surj__ty_2Einteger_2Eint @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ c_2Einteger_2Eint__neg @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )
...
thf(conj_thm_2Ewords_2En2w__dimword,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ewords_2Eword__msb__n2w__numeric,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ewords_2EWORD__EQ__NEG,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( ( mem @ V0v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Einteger__word_2Eoverflow,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
