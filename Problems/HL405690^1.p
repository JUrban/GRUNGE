...
thf(thm_2Eordinal_2Epredimage__sup__thm,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1a_2E0: u,V2b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2b_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2Esup_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eordinal_2Epreds_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) ) ) ) ) ) ) )
    <=> ? [V3d_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3d_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2b_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3d_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordEXP__lt__MONO__R,conjecture,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u,V2a_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2a_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1x_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0y_2E0 ) ) ) ) )
