...
tff(thm_2Erelation_2ETC__DEF,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1a_2E0: u,V2b_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2ETC_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(A_27a,V1a_2E0),s(A_27a,V2b_2E0)))))
    <=> ! [V3P_2E0: u] :
          ( ( ! [V4x_2E0: u,V5y_2E0: u] :
               ...
               => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3P_2E0),s(A_27a,V4x_2E0))),s(A_27a,V5y_2E0))))) )
            & ! [V6x_2E0: u,V7y_2E0: u,V8z_2E0: u] :
                ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3P_2E0),s(A_27a,V6x_2E0))),s(A_27a,V7y_2E0)))))
                  & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3P_2E0),s(A_27a,V7y_2E0))),s(A_27a,V8z_2E0))))) )
               => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3P_2E0),s(A_27a,V6x_2E0))),s(A_27a,V8z_2E0))))) ) )
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V3P_2E0),s(A_27a,V1a_2E0))),s(A_27a,V2b_2E0))))) ) ) )).
...
tff(thm_2Erelation_2ETC__INDUCT,conjecture,(
