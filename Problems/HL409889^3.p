...
thf(thm_2Eiterate_2EREAL__POLYFUN__EQ__CONST,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1c: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2k: tyop_2Erealax_2Ereal] :
    ...
    <=> ( ( ( V1c @ c_2Enum_2E0 )
        ...
        & ! [V5i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V5i @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V0n ) )
           => ( ( V1c @ V5i )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) )).
