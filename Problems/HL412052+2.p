...
fof(conj_thm_2Elebesgue_2Emax__fn__seq__mono,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g] :
          ( mem(V0g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
         => ! [V1n] :
             ...
             => ! [V2x] :
                  ( mem(V2x,A_27a)
                 => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(ap(c_2Elebesgue_2Emax__fn__seq(A_27a),V0g),V1n),V2x)),ap(ap(ap(c_2Elebesgue_2Emax__fn__seq(A_27a),V0g),ap(c_2Enum_2ESUC,V1n)),V2x))) ) ) ) ) )).
