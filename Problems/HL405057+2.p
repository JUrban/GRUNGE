         ...
         => ! [V3i] :
             ...
             => ! [V2Phi__R] :
                 ...
                 => ! [V9t] :
                     ...
                     => ap(f2034(A_27b,A_27a,V8q,V7t0,V3i,V2Phi__R),V9t) = ap(V2Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V9t),V7t0))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V9t),V7t0)))) ) ) ) ) ) )).

fof(lamtp_f2036,axiom,(
    ! [A_27b,A_27a,V8q] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0] :
          ( mem(V7t0,ty_2Enum_2Enum)
             ...
             => ! [V3i] :
                 ...
                 => ! [V4Psi] :
                     ...
                     => ! [V11t2] :
                         ...
                         => ap(f2036(A_27b,A_27a,V8q,V7t0,V10t1,V3i,V4Psi),V11t2) = ap(V4Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V10t1),ap(ap(c_2Earithmetic_2E_2B,V11t2),V7t0)))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V10t1),ap(ap(c_2Earithmetic_2E_2B,V11t2),V7t0))))) ) ) ) ) ) ) )).

fof(lamtp_f2035,axiom,(
    ! [A_27b,A_27a,V4Psi] :
      ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V3i] :
          ( mem(V3i,arr(ty_2Enum_2Enum,A_27a))
     ...
     => ! [V3i] :
         ...
         => ! [V7t0] :
             ...
             => ! [V8q] :
                 ...
                 => ! [V10t1] :
                      ( mem(V10t1,ty_2Enum_2Enum)
                     => ap(f2035(A_27b,A_27a,V4Psi,V3i,V7t0,V8q),V10t1) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2036(A_27b,A_27a,V8q,V7t0,V10t1,V3i,V4Psi)) ) ) ) ) ) )).

fof(lamtp_f2033,axiom,(
    ! [A_27a,A_27b,V4Psi] :
      ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V3i] :
          ( mem(V3i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V2Phi__R] :
             ...
             => ! [V1Phi__I] :
                 ...
                 => ! [V7t0] :
                      ( mem(V7t0,ty_2Enum_2Enum)
                     => mem(f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) ) )).
         ...
         => ! [V2Phi__R] :
             ...
             => ! [V1Phi__I] :
                 ...
                 => ! [V7t0] :
                     ...
                     => ! [V8q] :
                          ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
                         => ap(f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0),V8q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1Phi__I,ap(V8q,V7t0))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2034(A_27b,A_27a,V8q,V7t0,V3i,V2Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2035(A_27b,A_27a,V4Psi,V3i,V7t0,V8q)))) ) ) ) ) ) ) )).

fof(lamtp_f2032,axiom,(
     ...
     => ! [V2Phi__R] :
         ...
         => ! [V3i] :
             ...
             => ! [V4Psi] :
                 ...
                 => ! [V7t0] :
                      ( mem(V7t0,ty_2Enum_2Enum)
                     => ap(f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi),V7t0) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0)) ) ) ) ) ) )).

fof(conj_thm_2EOmega__Automata_2ECO__BUECHI__UNTIL__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3i] :
                         ...
                         => ! [V4Psi] :
                             ...
                             => ! [V5t0] :
                                 ...
                                 => ! [V6c] :
                                      ( mem(V6c,A_27b)
                                     => ( p(ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0phi),f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi)),V5t0))
                                      <=> ? [V12p] :
                                            ...
                                            & ? [V13q] :
                                                ...
                                                & ! [V14t] :
                                                   ...
                                                   => ( ( ~ p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,V14t),V5t0)))
                                                      ...
                                                      | ( p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,V14t),V5t0)))
                                                        & p(ap(V2Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V14t),V5t0))),ap(V13q,ap(ap(c_2Earithmetic_2E_2B,V14t),V5t0)))))
                                                        & p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,V14t),ap(ap(c_2Earithmetic_2E_2B,V5t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) ) ) )
                                                & ? [V15t1] :
                                                    ...
                                                    & ! [V16t2] :
                                                       ...
                                                       => ( ~ p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,V15t1),ap(ap(c_2Earithmetic_2E_2B,V16t2),V5t0))))
                                                          | p(ap(V4Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V15t1),ap(ap(c_2Earithmetic_2E_2B,V16t2),V5t0)))),ap(V13q,ap(ap(c_2Earithmetic_2E_2B,V15t1),ap(ap(c_2Earithmetic_2E_2B,V16t2),V5t0)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
