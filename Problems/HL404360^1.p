...
thf(thm_2Ewellorder_2Eallsets__wellorderable,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
    ? [V1wo_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2EelsOf_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1wo_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) )).

thf(thm_2Ecardinal_2Ecardleq__dichotomy,conjecture,(
