...
tff(conj_thm_2EHolSmt_2Er123,conjecture,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint,V3u: tp__ty_2Einteger_2Eint,V4v: tp__ty_2Einteger_2Eint] :
      ( p(ap(ap(c_2Einteger_2Eint__lt,inj__ty_2Einteger_2Eint(V0x)),ap(ap(c_2Einteger_2Eint__add,ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V1y))),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V2z)),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V3u)),inj__ty_2Einteger_2Eint(V4v))))))
    <=> ~ p(ap(ap(c_2Einteger_2Eint__le,ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V2z)),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V3u)),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V4v)),ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Einteger_2Eint(V0x)))))),inj__ty_2Einteger_2Eint(V1y))) ) )).
