...
tff(mem_c_2Epath_2Emem,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2Emem(A_27a,A_27a),arr(A_27a,arr(ty_2Epath_2Epath(A_27a,A_27a),bool))) )).
...
tff(ax_thm_2Epath_2Emem__def,axiom,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ( p(ap(ap(c_2Epath_2Emem(A_27a,A_27a),V0s),V1p))
          <=> ? [V2i: tp__ty_2Enum_2Enum] :
                ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                & V0s = ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V2i)),V1p) ) ) ) ) )).

tff(conj_thm_2Epath_2Emem__thm,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] :
      ( ! [V0x: $i] :
          ( mem(V0x,A_27a)
         => ! [V1s: $i] :
              ( mem(V1s,A_27a)
             => ( p(ap(ap(c_2Epath_2Emem(A_27a,A_27a),V1s),ap(c_2Epath_2Estopped__at(A_27a,A_27a),V0x)))
              <=> V1s = V0x ) ) )
      & ! [V2x: $i] :
          ( mem(V2x,A_27c)
         => ! [V3r: $i] :
              ( mem(V3r,A_27d)
             => ! [V4p: $i] :
                  ( mem(V4p,ty_2Epath_2Epath(A_27c,A_27c))
                 => ! [V5s: $i] :
                      ( mem(V5s,A_27c)
                     => ( p(ap(ap(c_2Epath_2Emem(A_27c,A_27c),V5s),ap(ap(ap(c_2Epath_2Epcons(A_27c,A_27c),V2x),V3r),V4p)))
                      <=> ( V5s = V2x
                          | p(ap(ap(c_2Epath_2Emem(A_27c,A_27c),V5s),V4p)) ) ) ) ) ) ) ) )).
