...
tff(conj_thm_2Ebit_2ELOG2__UNIQUE,lemma,(
...
tff(conj_thm_2Ebit_2EBITS__SUC,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__LOG2,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( V0n != fo__c_2Enum_2E0
...
tff(conj_thm_2Eblast_2EBCARRY__LEM,conjecture,(
    ! [V0i: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum,V3c: tp__o] :
     ...
     => ( p(ap(ap(ap(ap(c_2Eblast_2EBCARRY,inj__ty_2Enum_2Enum(V0i)),f2311(V1x)),f2312(V2y)),inj__o(V3c)))
