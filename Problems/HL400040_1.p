...
tff(f49_0_2E3,type,(
    f49_0_2E3: ( du * du * du ) > u )).

tff(f49_0_2E4,type,(
    f49_0_2E4: ( du * du * du * du ) > u )).
...
tff(arityeq3_2Ef49_0_2E3,axiom,(
    ! [A_27a: d,X0_2E0: mono_2Etyop_2Emin_2Ebool,X1_2E0: u,X2_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f49_0_2E3(s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(X0_2E0)),s(A_27a,X1_2E0),s(A_27a,X2_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)))),f49_0_2E0),s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(X0_2E0)))),s(A_27a,X1_2E0))),s(A_27a,X2_2E0))) )).

tff(arityeq4_2Ef49_0_2E4,axiom,(
    ! [A_27a: d,X0_2E0: mono_2Etyop_2Emin_2Ebool,X1_2E0: u,X2_2E0: u,X3_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f49_0_2E4(s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(X0_2E0)),s(A_27a,X1_2E0),s(A_27a,X2_2E0),s(A_27a,X3_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)))),f49_0_2E0),s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(X0_2E0)))),s(A_27a,X1_2E0))),s(A_27a,X2_2E0))),s(A_27a,X3_2E0)))) )).
...
tff(def0_2Ethm_2Ebool_2ECOND__DEF,axiom,(
    ! [A_27a: d,V0x_2E0: mono_2Etyop_2Emin_2Ebool,V1x_27_2E0: u,V2x_27_27_2E0: u,V3x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f49_0_2E4(s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(V0x_2E0)),s(A_27a,V1x_27_2E0),s(A_27a,V2x_27_27_2E0),s(A_27a,V3x_2E0)))))
...
tff(thm_2Ebool_2ECOND__DEF,axiom,(
    ! [A_27a: d,V0x_2E0: mono_2Etyop_2Emin_2Ebool,V1x_27_2E0: u,V2x_27_27_2E0: u] : s(A_27a,c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(V0x_2E0)),s(A_27a,V1x_27_2E0),s(A_27a,V2x_27_27_2E0))) = s(A_27a,c_2Emin_2E_40_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f49_0_2E3(s(tyop_2Emin_2Ebool,i_mono_2Etyop_2Emin_2Ebool(V0x_2E0)),s(A_27a,V1x_27_2E0),s(A_27a,V2x_27_27_2E0))))) )).
...
tff(thm_2Ebool_2ECOND__ID,conjecture,(
