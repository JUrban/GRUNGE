...
fof(conj_thm_2EindexedLists_2EMAP2i__ind,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2EindexedLists_2ELENGTH__MAP2i,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0f] :
                 ...
                 => ! [V1l1] :
                     ...
                     => ! [V2l2] :
                         ...
                         => ap(c_2Elist_2ELENGTH(A_27c),ap(ap(ap(c_2EindexedLists_2EMAP2i(A_27c,A_27c,A_27c),V0f),V1l1),V2l2)) = ap(ap(c_2Earithmetic_2EMIN,ap(c_2Elist_2ELENGTH(A_27a),V1l1)),ap(c_2Elist_2ELENGTH(A_27b),V2l2)) ) ) ) ) ) ) )).
