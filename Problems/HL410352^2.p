...
thf(conj_thm_2Ereal__topology_2EDEPENDENT__CHOICE__FIXED,lemma,(
    ! [A_27a: del,V0P: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V2a ) )
               ...
               => ? [V6f: $i] :
                    ...
                    & ! [V7n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V7n ) ) @ ( ap @ V6f @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) )
                    & ! [V8n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( ap @ V1R @ ( inj__ty_2Enum_2Enum @ V8n ) ) @ ( ap @ V6f @ ( inj__ty_2Enum_2Enum @ V8n ) ) ) @ ( ap @ V6f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V8n ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EDEPENDENT__CHOICE,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ bool ) ) )
     => ! [V1R: $i] :
          ( ( mem @ V1R @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) ) )
