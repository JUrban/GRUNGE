...
thf(f4111_0_2E0,type,(
    f4111_0_2E0: u )).

thf(f4111_0_2E1,type,(
    f4111_0_2E1: du > u )).

thf(f4121_0_2E0,type,(
    f4121_0_2E0: u )).

thf(f4121_0_2E1,type,(
    f4121_0_2E1: du > u )).

thf(f4128_0_2E0,type,(
    f4128_0_2E0: u )).

thf(f4128_0_2E1,type,(
    f4128_0_2E1: du > u )).

thf(f4128_0_2E2,type,(
    f4128_0_2E2: du > du > u )).

thf(f4128_1_2E0,type,(
    f4128_1_2E0: u )).

thf(f4128_1_2E1,type,(
    f4128_1_2E1: du > u )).

thf(f4128_1_2E2,type,(
    f4128_1_2E2: du > du > u )).

thf(f4182_0_2E0,type,(
    f4182_0_2E0: u )).

thf(f4182_0_2E1,type,(
    f4182_0_2E1: du > u )).

thf(f4318_0_2E0,type,(
    f4318_0_2E0: u )).

thf(f4318_0_2E1,type,(
    f4318_0_2E1: du > u )).

thf(f4318_0_2E2,type,(
    f4318_0_2E2: du > du > u )).

thf(f4322_0_2E0,type,(
    f4322_0_2E0: u )).

thf(f4322_0_2E1,type,(
    f4322_0_2E1: du > u )).

thf(f4322_0_2E2,type,(
    f4322_0_2E2: du > du > u )).
...
thf(c_2Ellist_2ELREPEAT_2E0,type,(
    c_2Ellist_2ELREPEAT_2E0: u )).

thf(c_2Ellist_2ELREPEAT_2E1,type,(
    c_2Ellist_2ELREPEAT_2E1: du > u )).
...
thf(mono_2Ef4111_0,type,(
    mono_2Ef4111_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq1_2Emono_2Ef4121_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4121_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f4121_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4128_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( f4128_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) ) @ f4128_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4128_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( f4128_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) ) @ f4128_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4128_1_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( f4128_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ f4128_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4128_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4128_1_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ f4128_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4182_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4182_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ f4182_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4318_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4318_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4318_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4318_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4318_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4318_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4322_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( f4322_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ f4322_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4322_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( f4322_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ f4322_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Ellist_2Ellist_28A_27a_29,axiom,(
    ! [A_27a: d,X0: $o,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) ) @ c_2Ebool_2ECOND_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X2_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ellist_2ELREPEAT_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ c_2Ellist_2ELREPEAT_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Eoption_2EOPTION__MAP_2E2_2Emono_2Etyop_2Ellist_2Ellist_28A_27a_29_20mono_2Etyop_2Ellist_2Ellist_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) ) @ c_2Eoption_2EOPTION__MAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Elist_2ENULL__DEF,axiom,(
    ! [A_27a: d] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2ET )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1t_2E0 ) ) ) ) ) )
          = mono_2Ec_2Ebool_2EF ) ) )).
...
thf(def0_2Ethm_2Ellist_2Elrep__ok__def,axiom,(
    ! [V6x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4111_0 @ V6x )
    <=> ( V6x = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Ellist_2Elrep__ok__def,axiom,(
    ! [A_27a: d,V0x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0x_2E0 ) ) ) )
    <=> ? [V1lrep__ok_27_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V1lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0x_2E0 ) ) ) )
          & ! [V2a0_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V1lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2a0_2E0 ) ) ) )
             => ( ! [V3x: mono_2Etyop_2Enum_2Enum] :
                    ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3x ) ) ) )
                    = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
                | ? [V4h_2E0: u,V5t_2E0: u] :
                    ( ! [V6x: mono_2Etyop_2Enum_2Enum] :
                        ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6x ) ) ) )
                        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4111_0 @ V6x ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V4h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V5t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V6x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V1lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V5t_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2ELNIL,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4121_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )).

thf(thm_2Ellist_2ELNIL,axiom,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2Ellist__abs_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f4121_0_2E0 ) ) ) ) )).

thf(thm_2Ellist_2ELHD,axiom,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2Ellist__rep_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )).

thf(def0_2Ethm_2Ellist_2ELTL,axiom,(
    ! [A_27a: d,V0ll_2E0: u,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4128_1_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2Ellist__rep_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V2n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ellist_2ELTL,axiom,(
    ! [A_27a: d,V0ll_2E0: u,V1v_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( f4128_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) @ ( s @ A_27a @ V1v_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2Ellist__abs_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( f4128_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELTL,axiom,(
    ! [A_27a: d,V0ll_2E0: u] :
      ...
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ ( f4128_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELHDTL__CONS__THM,axiom,(
    ! [A_27a: d,V0h_2E0: u,V1t_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0h_2E0 ) ) ) )
      & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2ELTL__LAPPEND,axiom,(
    ! [A_27a: d,V1l1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4182_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 )
        = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) ) )).

thf(thm_2Ellist_2ELTL__LAPPEND,axiom,(
    ! [A_27a: d,V0l2_2E0: u,V1l1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l2_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f4182_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l2_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2ELREPEAT__def,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4318_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) )
      = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2EMOD @ V1n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) )).

thf(thm_2Ellist_2ELREPEAT__def,axiom,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4318_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( i_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELREPEAT__thm,axiom,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2EfromList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2ELTL__LREPEAT,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1t_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( f4322_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELTL__LREPEAT,conjecture,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( f4322_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2EfromList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) ) ) )).
