...
fof(conj_thm_2Einteger_2EINT__NEG__LE0,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LE__ADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LE__DOUBLE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LE__ADDL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__SUB,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V0n))
           => ap(ap(c_2Einteger_2Eint__sub,ap(c_2Einteger_2Eint__of__num,V0n)),ap(c_2Einteger_2Eint__of__num,V1m)) = ap(c_2Einteger_2Eint__of__num,ap(ap(c_2Earithmetic_2E_2D,V0n),V1m)) ) ) ) )).
...
fof(conj_thm_2Einteger_2EINT__MOD,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger_2EINT__LESS__MOD,lemma,(
    ! [V0i] :
...
fof(conj_thm_2Ewords_2En2w__dimword,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2Eword__msb__n2w__numeric,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger__word_2Eword__msb__i2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger__word_2Eword__i2w__add,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Einteger__word_2Edifferent__sign__then__no__overflow,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Einteger__word_2Ew2i__i2w__pos,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger__word_2Ew2i__i2w__neg,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger__word_2Eoverflow,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
