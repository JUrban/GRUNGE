...
thf(conj_thm_2Erich__list_2EFILTER__IDEM,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f ) @ V1l ) )
            = ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f ) @ V1l ) ) ) ) )).
