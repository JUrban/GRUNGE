...
thf(conj_thm_2Etoto_2EStrong__toto__thm,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EStrongLinearOrder @ A_27a ) @ V0r ) )
       => ( ( ap @ ( c_2Etoto_2EStrongLinearOrder__of__TO @ A_27a ) @ ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ ( ap @ ( c_2Etoto_2Etoto__of__LinearOrder @ A_27a ) @ V0r ) ) )
          = V0r ) ) ) )).
