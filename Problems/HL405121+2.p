...
fof(conj_thm_2Equotient_2EQUOTIENT__SYM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Equotient_2EQUOTIENT__TRANS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Equotient__pred__set_2EIN__DELETER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Equotient__pred__set_2EDELETER__RSP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                               ...
                               => ! [V5x1] :
                                   ...
                                   => ! [V6x2] :
                                       ...
                                       => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),V3s1),V4s2))
                                         ...
                                         => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),ap(ap(ap(c_2Equotient__pred__set_2EDELETER(A_27a),V0R),V3s1),V5x1)),ap(ap(ap(c_2Equotient__pred__set_2EDELETER(A_27a),V0R),V4s2),V6x2))) ) ) ) ) ) ) ) ) ) ) ) )).
