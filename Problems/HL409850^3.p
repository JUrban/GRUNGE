...
thf(thm_2Eiterate_2ESUM__IMAGE__GEN,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1g: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1g )
        = ( c_2Eiterate_2ESum @ A_27b @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ V2s )
          @ ^ [V3y: A_27b] :
              ( c_2Eiterate_2ESum @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V4x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V4x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V2s ) @ ( c_2Emin_2E_3D @ A_27b @ ( V0f @ V4x ) @ V3y ) ) ) )
              @ V1g ) ) ) ) )).
...
thf(thm_2Epred__set_2EDIFF__DEF,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1t: A_27a > $o] :
      ...
      = ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
        @ ^ [V2x: A_27a] :
            ( c_2Epair_2E_2C @ A_27a @ $o @ V2x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V0s ) @ ( c_2Ebool_2E_7E @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1t ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__LE__INCLUDED,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1g: A_27b > tyop_2Erealax_2Ereal,V2s: A_27a > $o,V3t: A_27b > $o,V4i: A_27b > A_27a] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V3t )
        & ! [V5y: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V5y @ V3t )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V1g @ V5y ) ) )
        & ! [V6x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V6x @ V2s )
           => ? [V7y: A_27b] :
                ( ( c_2Ebool_2EIN @ A_27b @ V7y @ V3t )
                & ( ( V4i @ V7y )
                  = V6x )
                & ( c_2Ereal_2Ereal__lte @ ( V0f @ V6x ) @ ( V1g @ V7y ) ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V0f ) @ ( c_2Eiterate_2ESum @ A_27b @ V3t @ V1g ) ) ) )).
