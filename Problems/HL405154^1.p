...
thf(arityeq2_2Emono_2Ec_2Ebag_2EBAG__EVERY_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__EVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ X1_2E0 ) ) ) )
...
thf(thm_2Ebag_2EBAG__EVERY__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0P_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__EVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) ) ) )
      & ! [V1P_2E0: u,V2e_2E0: u,V3b_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__EVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__INSERT_2E2 @ ( s @ A_27b @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ V3b_2E0 ) ) ) ) ) )
        <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27b @ V2e_2E0 ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__EVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Enum_2Enum ) @ V3b_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Econtainer_2EEVERY__LIST__TO__BAG,conjecture,(
    ! [A_27a: d,V0ls_2E0: u,V1P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__EVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2ELIST__TO__BAG_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EEVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) ) )).
