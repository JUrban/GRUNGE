...
fof(mem_c_2Efmapal_2EAP__SND,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efmapal_2EAP__SND(A_27a,A_27a,A_27a),arr(arr(A_27b,A_27c),arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) ) )).
...
fof(conj_thm_2Efmapal_2Eo__f__fmap,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
