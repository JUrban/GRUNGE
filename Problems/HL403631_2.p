...
tff(conj_thm_2Efcp_2EREAD__TL,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0i: tp__ty_2Enum_2Enum,V1a: $i] :
      ( mem(V1a,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
       => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),V1a)),inj__ty_2Enum_2Enum(V0i)) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0i))) ) ) )).
