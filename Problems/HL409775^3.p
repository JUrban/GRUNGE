...
thf(thm_2Eiterate_2ENSUM__CLAUSES__LEFT,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ V0f )
        = ( c_2Earithmetic_2E_2B @ ( V0f @ V1m ) @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V1m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) @ V0f ) ) ) ) )).
