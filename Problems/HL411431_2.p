...
tff(lamtp_f3933,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3933(V0s),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

tff(lameq_f3933,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2y: tp__ty_2Erealax_2Ereal] : ap(f3933(V0s),inj__ty_2Erealax_2Ereal(V2y)) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2y))),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),V0s)) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),V0s),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x))) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EDELETE(arr(ty_2Erealax_2Ereal,bool)),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3933(V0s))),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)))) ) )).
...
tff(conj_thm_2Ereal__topology_2EIN__COMPONENTS__BIGUNION__COMPLEMENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
         ...
         => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1c),ap(c_2Ereal__topology_2Ecomponents,V0s)))
           => ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),V0s),V1c) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EDELETE(arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Ecomponents,V0s)),V1c)) ) ) ) )).
