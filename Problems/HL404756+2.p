...
fof(conj_thm_2Efinite__map_2EFMEQ__ENUMERATE__CASES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f1] :
             ...
             => ! [V1kvl] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f1),V2p) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1kvl)
                       => p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),V2p),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),V1kvl))) ) ) ) ) ) ) )).
