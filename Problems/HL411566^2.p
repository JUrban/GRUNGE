...
thf(conj_thm_2Ereal__topology_2ECBALL__INTERVAL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECBALL__INTERVAL__0,conjecture,(
    ! [V0e: tp__ty_2Erealax_2Ereal] :
      ( ( ap @ c_2Ereal__topology_2Ecball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0e ) ) )
