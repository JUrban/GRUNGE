...
thf(ax_thm_2EEncode_2Eencode__bnum__def,axiom,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ c_2EEncode_2Eencode__bnum @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
...
thf(conj_thm_2EEncode_2Eencode__bnum__def__compute,conjecture,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ c_2EEncode_2Eencode__bnum @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( c_2Elist_2ENIL @ bool ) ) )
    & ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
    ...
    & ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ c_2EEncode_2Eencode__bnum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ c_2Earithmetic_2EEVEN @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) @ ( ap @ ( ap @ c_2EEncode_2Eencode__bnum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( inj__ty_2Enum_2Enum @ V4n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
