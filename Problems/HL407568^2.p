...
thf(conj_thm_2Einteger_2EINT__EQ__LADD,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__NEG__GT0,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
thf(ax_thm_2Einteger_2ELEAST__INT__DEF,axiom,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Einteger_2Eint @ bool ) )
     => ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2ELEAST__INT @ V0P ) )
        = ( surj__ty_2Einteger_2Eint
          @ ( ap @ ( c_2Emin_2E_40 @ ty_2Einteger_2Eint )
            @ ( lam @ ty_2Einteger_2Eint
              @ ^ [V1i: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V1i ) )
                  @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Einteger_2Eint )
                    @ ( lam @ ty_2Einteger_2Eint
                      @ ^ [V2j: $i] :
                          ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ V2j ) @ V1i ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0P @ V2j ) ) ) ) ) ) ) ) ) ) ) )).
    ...
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ...
      = ( surj__ty_2Einteger_2Eint
        @ ( ap @ c_2Einteger_2ELEAST__INT
          @ ( lam @ ty_2Einteger_2Eint
            @ ^ [V1i: $i] :
                ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Eintreal_2Ereal__of__int @ V1i ) ) ) ) ) ) )).

thf(conj_thm_2Eintreal_2EINT__CEILING__BOUNDS,lemma,(
...
thf(conj_thm_2Eintreal_2EINT__CEILING,conjecture,(
