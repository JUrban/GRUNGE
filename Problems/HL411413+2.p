...
fof(conj_thm_2Etopology_2ECLOSED__IN__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE__EQ,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__COMPONENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c] :
         ...
         => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1c),ap(c_2Ereal__topology_2Ecomponents,V0s)))
           => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0s)),V1c)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPONENTS__FINITE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Ecomponents,V1s)))
              & ! [V2c] :
