...
thf(ax_thm_2Eordinal_2Eomax__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ V0s )
        = ( ap @ ( c_2Eoption_2Esome @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1a: $i] :
                ( ap
                @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
                  @ ( ap @ ( ap @ ( c_2Eset__relation_2Emaximal__elements @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0s )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ty_2Epair_2Eprod @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
                      @ ( ap @ ( c_2Epair_2EUNCURRY @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ bool ) )
                        @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
                          @ ^ [V2x: $i] :
                              ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
                              @ ^ [V3y: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V2x ) @ V3y ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V3y ) @ V2x ) ) ) ) ) ) ) ) )
                @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V1a ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Eomax__SOME,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ( ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ V0s )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V1a ) )
