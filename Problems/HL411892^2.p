...
thf(conj_thm_2Ereal__topology_2ESETDIST__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
                  & ! [V3x: tp__ty_2Erealax_2Ereal] :
                      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) )
                      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) ) )
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V2t ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1s ) @ V2t ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EHAUSDIST__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
                  & ! [V3x: tp__ty_2Erealax_2Ereal] :
                      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) )
                      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) ) )
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Ehausdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V2t ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Ehausdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1s ) @ V2t ) ) ) ) ) ) ) ) )).
