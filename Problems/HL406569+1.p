...
fof(arityeq2_2Ef8025_0_2E2_2EA_27b,axiom,(
    ! [A_27b,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f8025_0_2E2(s(tyop_2Enum_2Enum,X0_2E0),s(tyop_2Esptree_2Espt(A_27b),X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27b),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27b),tyop_2Emin_2Ebool)),f8025_0_2E0),s(tyop_2Enum_2Enum,X0_2E0))),s(tyop_2Esptree_2Espt(A_27b),X1_2E0))) )).
...
fof(def0_2Ethm_2Esptree_2Elookup__difference,axiom,(
    ! [A_27b,V2k_2E0,V1m2_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f8025_0_2E2(s(tyop_2Enum_2Enum,V2k_2E0),s(tyop_2Esptree_2Espt(A_27b),V1m2_2E0))))
    <=> s(tyop_2Eoption_2Eoption(A_27b),c_2Esptree_2Elookup_2E2(s(tyop_2Enum_2Enum,V2k_2E0),s(tyop_2Esptree_2Espt(A_27b),V1m2_2E0))) = s(tyop_2Eoption_2Eoption(A_27b),c_2Eoption_2ENONE_2E0) ) )).

fof(thm_2Esptree_2Elookup__difference,axiom,(
    ! [A_27a,A_27b,V0m1_2E0,V1m2_2E0,V2k_2E0] : s(tyop_2Eoption_2Eoption(A_27a),c_2Esptree_2Elookup_2E2(s(tyop_2Enum_2Enum,V2k_2E0),s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Edifference_2E2(s(tyop_2Esptree_2Espt(A_27a),V0m1_2E0),s(tyop_2Esptree_2Espt(A_27b),V1m2_2E0))))) = s(tyop_2Eoption_2Eoption(A_27a),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f8025_0_2E2(s(tyop_2Enum_2Enum,V2k_2E0),s(tyop_2Esptree_2Espt(A_27b),V1m2_2E0))),s(tyop_2Eoption_2Eoption(A_27a),c_2Esptree_2Elookup_2E2(s(tyop_2Enum_2Enum,V2k_2E0),s(tyop_2Esptree_2Espt(A_27a),V0m1_2E0))),s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ENONE_2E0))) )).
...
fof(thm_2Esptree_2Edomain__difference,conjecture,(
