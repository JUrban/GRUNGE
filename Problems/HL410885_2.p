...
tff(conj_thm_2Ereal__topology_2ELIM__COMPOSE__WITHIN,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(lmtp_f3739,type,(
    f3739: ( del * $i * $i * tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3739,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal] : mem(f3739(A_27a,V1f,V2g,V3y,V4z),arr(A_27a,bool)) ) ) )).

tff(lameq_f3739,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3y: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal,V5w: $i] :
              ( mem(V5w,A_27a)
             => ap(f3739(A_27a,V1f,V2g,V3y,V4z),V5w) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V5w)),inj__ty_2Erealax_2Ereal(V3y))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V2g,inj__ty_2Erealax_2Ereal(V3y))),inj__ty_2Erealax_2Ereal(V4z))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__COMPOSE__AT,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ! [V3y: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2g),V1f)),inj__ty_2Erealax_2Ereal(V4z)),V0net)) ) ) ) ) )).
