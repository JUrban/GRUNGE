...
thf(f4888_0_2E0,type,(
    f4888_0_2E0: u )).

thf(f4888_0_2E1,type,(
    f4888_0_2E1: du > u )).

thf(f4888_0_2E2,type,(
    f4888_0_2E2: du > du > u )).

thf(f4888_1_2E0,type,(
    f4888_1_2E0: u )).

thf(f4888_1_2E1,type,(
    f4888_1_2E1: du > u )).

thf(f4888_2_2E0,type,(
    f4888_2_2E0: u )).

thf(f4888_2_2E2,type,(
    f4888_2_2E2: du > du > u )).

thf(f4888_2_2E3,type,(
    f4888_2_2E3: du > du > du > u )).

thf(f4888_3_2E0,type,(
    f4888_3_2E0: u )).

thf(f4888_3_2E1,type,(
    f4888_3_2E1: du > u )).

thf(f4888_3_2E2,type,(
    f4888_3_2E2: du > du > u )).

thf(f4888_4_2E0,type,(
    f4888_4_2E0: u )).

thf(f4888_4_2E2,type,(
    f4888_4_2E2: du > du > u )).

thf(f4888_4_2E3,type,(
    f4888_4_2E3: du > du > du > u )).

thf(f4888_5_2E0,type,(
    f4888_5_2E0: u )).

thf(f4888_5_2E2,type,(
    f4888_5_2E2: du > du > u )).

thf(f4888_5_2E3,type,(
    f4888_5_2E3: du > du > du > u )).

thf(f4888_6_2E0,type,(
    f4888_6_2E0: u )).

thf(f4888_6_2E2,type,(
    f4888_6_2E2: du > du > u )).

thf(f4888_6_2E3,type,(
    f4888_6_2E3: du > du > du > u )).

thf(f4888_7_2E0,type,(
    f4888_7_2E0: u )).

thf(f4888_7_2E1,type,(
    f4888_7_2E1: du > u )).
...
thf(mono_2Ef4888_0,type,(
    mono_2Ef4888_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_1,type,(
    mono_2Ef4888_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_2,type,(
    mono_2Ef4888_2: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_3,type,(
    mono_2Ef4888_3: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_4,type,(
    mono_2Ef4888_4: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_5,type,(
    mono_2Ef4888_5: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_6,type,(
    mono_2Ef4888_6: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4888_7,type,(
    mono_2Ef4888_7: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_7 @ V4t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def1_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V6t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_1 @ V6t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def2_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V10t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_3 @ V1a @ V10t )
    <=> ( (~) @ ( V1a @ V10t ) ) ) )).

thf(def3_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_0 @ V1a @ V3t )
    <=> ( (~) @ ( V1a @ V3t ) ) ) )).

thf(def4_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V8t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_2 @ V1a @ V0b @ V8t )
    <=> ( ( (~) @ ( V1a @ V8t ) )
        & ( (~) @ ( V0b @ V8t ) ) ) ) )).

thf(def5_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V12t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_4 @ V1a @ V0b @ V12t )
    <=> ( ( (~) @ ( V1a @ V12t ) )
        & ( V0b @ V12t ) ) ) )).

thf(def6_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V16t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_6 @ V1a @ V0b @ V16t )
    <=> ( ( V1a @ V16t )
        & ( (~) @ ( V0b @ V16t ) ) ) ) )).

thf(def7_2Ethm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V14t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4888_5 @ V1a @ V0b @ V14t )
    <=> ( ( V1a @ V14t )
        & ( V0b @ V14t ) ) ) )).
...
thf(thm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
        ...
        <=> ( (~) @ ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ ( mono_2Ef4888_0 @ V1a ) @ mono_2Ef4888_7 @ V2x ) ) )
      & ! [V5x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPEVENTUAL @ V1a @ V5x )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V1a @ mono_2Ef4888_1 @ V5x ) )
      & ! [V7x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSUNTIL @ V1a @ V0b @ V7x )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V0b @ ( mono_2Ef4888_2 @ V1a @ V0b ) @ V7x ) )
      & ! [V9x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPUNTIL @ V1a @ V0b @ V9x )
        <=> ( (~) @ ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ ( mono_2Ef4888_3 @ V1a ) @ V0b @ V9x ) ) )
      & ! [V11x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSWHEN @ V1a @ V0b @ V11x )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V0b @ ( mono_2Ef4888_4 @ V1a @ V0b ) @ V11x ) )
      & ! [V13x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPWHEN @ V1a @ V0b @ V13x )
        <=> ( (~) @ ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V0b @ ( mono_2Ef4888_5 @ V1a @ V0b ) @ V13x ) ) )
      & ! [V15x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2EPast__Temporal__Logic_2EPBEFORE @ V1a @ V0b @ V15x )
        <=> ( (~) @ ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V0b @ ( mono_2Ef4888_6 @ V1a @ V0b ) @ V15x ) ) ) ) )).
