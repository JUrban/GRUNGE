...
fof(conj_thm_2Epath_2Efinite__take,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1i),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)))
                   => p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V1i),V0p))) ) ) ) ) ) )).

fof(conj_thm_2Epath_2Elength__take,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1i] :
                  ( mem(V1i,ty_2Enum_2Enum)
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1i),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)))
                   => ap(c_2Epath_2Elength(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V1i),V0p)) = ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) ) ) ) )).
