...
fof(conj_thm_2Ecardinal_2Ecardlt__TRANS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0s] :
                 ...
                 => ! [V1t] :
                     ...
                     => ! [V2u] :
                         ...
                         => ( ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V1t),V0s))
                              & ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V2u),V1t)) )
                           => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V2u),V0s)) ) ) ) ) ) ) ) )).
