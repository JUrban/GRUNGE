...
fof(conj_thm_2Ewords_2Ew2n__minus1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ereal_2EREAL__EQ__LADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__EQ__SUB__RADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ebinary__ieee_2Esign__not__zero,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ebinary__ieee_2Efloat__is__zero__to__real,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
              ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
             => ( p(ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27a,A_27a),V0x))
              <=> ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0x) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Efloat__to__real__eq,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
