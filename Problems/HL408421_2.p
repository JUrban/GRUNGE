...
tff(conj_thm_2Etransc_2ERPOW__1,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0a)))
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0a)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) = V0a ) )).
