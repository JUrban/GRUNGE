...
tff(conj_thm_2Equotient_2ECOND__RSP,conjecture,(
                   ...
                   => ! [V6b2: $i] :
                       ...
                       => ! [V7c1: $i] :
                           ...
                           => ! [V8c2: $i] :
                               ...
                               => ( ( ( p(inj__o(V3a1))
                                    <=> p(inj__o(V4a2)) )
                                    & p(ap(ap(V0R,V5b1),V6b2))
                                    & p(ap(ap(V0R,V7c1),V8c2)) )
                                 => p(ap(ap(V0R,ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V3a1)),V5b1),V7c1)),ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V4a2)),V6b2),V8c2))) ) ) ) ) ) ) ) ) ) )).
