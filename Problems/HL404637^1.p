...
thf(thm_2Efinite__map_2EFCARD__SUC,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
    ...
    <=> ? [V2f_27_2E0: u,V3x_2E0: u,V4y_2E0: u] :
          ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2f_27_2E0 ) ) ) ) ) ) )
          & ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efinite__map_2EFCARD_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2f_27_2E0 ) ) ) )
            = V1n )
          & ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 )
            = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2f_27_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27b @ V4y_2E0 ) ) ) ) ) ) ) ) )).
