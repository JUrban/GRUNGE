...
thf(thm_2Ereal__topology_2EBALL__SUBSET__CBALL,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1e: tyop_2Erealax_2Ereal] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0x @ V1e ) ) @ ( c_2Ereal__topology_2Ecball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0x @ V1e ) ) ) )).
...
thf(thm_2Ereal__topology_2ELOCALLY__MONO,axiom,(
    ! [V0P: ( tyop_2Erealax_2Ereal > $o ) > $o,V1Q: ( tyop_2Erealax_2Ereal > $o ) > $o,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ! [V3t: tyop_2Erealax_2Ereal > $o] :
            ( ( V0P @ V3t )
           => ( V1Q @ V3t ) )
        & ( c_2Ereal__topology_2Elocally @ V0P @ V2s ) )
     => ( c_2Ereal__topology_2Elocally @ V1Q @ V2s ) ) )).
...
thf(thm_2Ereal__topology_2ELOCALLY__CLOSED,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2EClosed @ V0s )
