    ...
    <=> ! [V1e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V2N: tyop_2Enum_2Enum] :
            ! [V3n: tyop_2Enum_2Enum] :
             ...
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0s @ V3n ) @ ( V0s @ V2N ) ) ) @ V1e ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2e: tyop_2Erealax_2Ereal,V3x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V2e )
        ...
        & ! [V4x: tyop_2Erealax_2Ereal] :
           ...
           => ( c_2Ereal_2Ereal__ge @ ( c_2Ereal_2Eabs @ ( V0f @ V4x ) ) @ ( c_2Erealax_2Ereal__mul @ V2e @ ( c_2Ereal_2Eabs @ V4x ) ) ) )
        & ! [V5n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V3x @ V5n ) @ V1s )
        & ( c_2Ereal__topology_2Ecauchy @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V3x ) ) )
     => ( c_2Ereal__topology_2Ecauchy @ V3x ) ) )).
