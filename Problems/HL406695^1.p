...
thf(thm_2Eint__arith_2Egcdthm2,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Einteger_2Eint,V3b: mono_2Etyop_2Einteger_2Eint,V4d: mono_2Etyop_2Enum_2Enum,V5p: mono_2Etyop_2Einteger_2Eint,V6q: mono_2Etyop_2Einteger_2Eint] :
      ( ( ( V4d
          = ( mono_2Ec_2Egcd_2Egcd @ V1a @ V0m ) )
        & ( ( mono_2Ec_2Einteger_2Eint__of__num @ V4d )
          = ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ V5p @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1a ) ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V6q @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) ) ) )
        & ( (~) @ ( V4d = mono_2Ec_2Enum_2E0 ) )
        & ( (~) @ ( V0m = mono_2Ec_2Enum_2E0 ) )
        & ( (~) @ ( V1a = mono_2Ec_2Enum_2E0 ) ) )
     => ( ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) @ ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1a ) @ V2x ) @ V3b ) )
      <=> ( ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V4d ) @ V3b )
          & ? [V7t: mono_2Etyop_2Einteger_2Eint] :
              ( V2x
              = ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__neg @ V5p ) @ ( mono_2Ec_2Einteger_2Eint__div @ V3b @ ( mono_2Ec_2Einteger_2Eint__of__num @ V4d ) ) ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V7t @ ( mono_2Ec_2Einteger_2Eint__div @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) @ ( mono_2Ec_2Einteger_2Eint__of__num @ V4d ) ) ) ) ) ) ) ) )).

thf(thm_2Eint__arith_2Egcd1thm,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2p: mono_2Etyop_2Einteger_2Eint,V3q: mono_2Etyop_2Einteger_2Eint] :
      ( ( ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ V2p @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V3q @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1n ) ) )
...
thf(thm_2Einteger_2EINT__DIV__1,axiom,(
    ! [V0p: mono_2Etyop_2Einteger_2Eint] :
      ( ( mono_2Ec_2Einteger_2Eint__div @ V0p @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
      = V0p ) )).
...
thf(thm_2Eint__arith_2Egcd21__thm,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Einteger_2Eint,V3b: mono_2Etyop_2Einteger_2Eint,V4p: mono_2Etyop_2Einteger_2Eint,V5q: mono_2Etyop_2Einteger_2Eint] :
      ( ( ( ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ V4p @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1a ) ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V5q @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) ) )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        & ( (~) @ ( V0m = mono_2Ec_2Enum_2E0 ) )
        & ( (~) @ ( V1a = mono_2Ec_2Enum_2E0 ) ) )
     => ( ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) @ ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1a ) @ V2x ) @ V3b ) )
      <=> ? [V6t: mono_2Etyop_2Einteger_2Eint] :
            ( V2x
            = ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__neg @ V4p ) @ V3b ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V6t @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) ) ) ) ) ) )).
