...
tff(conj_thm_2Eiterate_2EREAL__LE__INF__SUBSET,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EDIST__POS__LE,lemma,(
...
tff(conj_thm_2Ereal__topology_2ESETDIST__SUBSET__RIGHT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
