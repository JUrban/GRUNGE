...
fof(conj_thm_2Efmsp_2EFMSP__bitotal,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efmsp_2EFMSP__FORALL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0AN] :
                 ...
                 => ! [V1BC] :
                     ...
                     => ( ( p(ap(c_2Etransfer_2Ebitotal(A_27a,A_27a),V0AN))
                          & p(ap(c_2Etransfer_2Ebitotal(A_27b,A_27b),V1BC))
                          & p(ap(c_2Etransfer_2Ebi__unique(A_27a,A_27a),V0AN)) )
                       => p(ap(ap(ap(ap(c_2Etransfer_2EFUN__REL(arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool)),ap(ap(c_2Etransfer_2EFUN__REL(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)),ap(ap(c_2Efmsp_2EFMSP(A_27a,A_27a,A_27a),V0AN),V1BC)),c_2Emin_2E_3D(bool))),c_2Emin_2E_3D(bool)),c_2Ebool_2E_21(ty_2Efinite__map_2Efmap(A_27a,A_27a))),c_2Ebool_2E_21(ty_2Esptree_2Espt(A_27c)))) ) ) ) ) ) ) )).
