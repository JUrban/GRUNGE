...
thf(conj_thm_2Eextreal_2ECROSS__COUNTABLE__UNIV,lemma,(
...
thf(conj_thm_2Eextreal_2ECROSS__COUNTABLE__LEMMA2,lemma,(
    ! [A_27a: del,A_27b: del,V0t: $i] :
      ( ( mem @ V0t @ ( arr @ A_27b @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eextreal_2ECROSS__COUNTABLE,conjecture,(
    ! [A_27a: del,A_27b: del,V0t: $i] :
      ( ( mem @ V0t @ ( arr @ A_27b @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
