...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Ereal__topology_2Econnected__component,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),inj__ty_2Erealax_2Ereal(V0x)) = c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__UNIV,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)
