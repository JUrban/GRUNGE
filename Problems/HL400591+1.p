...
fof(thm_2Epair_2Epair__case__cong,conjecture,(
    ! [A_27a,A_27b,A_27c,V0f_27_2E0,V1M_2E0,V2M_27_2E0,V3f_2E0] :
      ( ( s(tyop_2Epair_2Eprod(A_27b,A_27c),V1M_2E0) = s(tyop_2Epair_2Eprod(A_27b,A_27c),V2M_27_2E0)
        & ! [V4x_2E0,V5y_2E0] :
            ( s(tyop_2Epair_2Eprod(A_27b,A_27c),V2M_27_2E0) = s(tyop_2Epair_2Eprod(A_27b,A_27c),c_2Epair_2E_2C_2E2(s(A_27b,V4x_2E0),s(A_27c,V5y_2E0)))
           => s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27c,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V3f_2E0),s(A_27b,V4x_2E0))),s(A_27c,V5y_2E0))) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27c,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V0f_27_2E0),s(A_27b,V4x_2E0))),s(A_27c,V5y_2E0))) ) )
     => s(A_27a,c_2Epair_2Epair__CASE_2E2(s(tyop_2Epair_2Eprod(A_27b,A_27c),V1M_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V3f_2E0))) = s(A_27a,c_2Epair_2Epair__CASE_2E2(s(tyop_2Epair_2Eprod(A_27b,A_27c),V2M_27_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V0f_27_2E0))) ) )).
