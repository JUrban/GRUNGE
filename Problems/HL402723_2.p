...
tff(conj_thm_2Erich__list_2EFOLDR__SNOC,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
     => ! [V1e: $i] :
          ( mem(V1e,A_27b)
         => ! [V2x: $i] :
             ...
             => ! [V3l: $i] :
                  ( mem(V3l,ty_2Elist_2Elist(A_27a))
                 => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e),ap(ap(c_2Elist_2ESNOC(A_27a),V2x),V3l)) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),ap(ap(V0f,V2x),V1e)),V3l) ) ) ) ) )).

tff(conj_thm_2Erich__list_2EFOLDR__MAP__REVERSE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
       ...
       => ! [V4e: $i] :
           ...
           => ! [V5g: $i] :
               ...
               => ! [V6l: $i] :
                   ...
                   => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V4e),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V5g),ap(c_2Elist_2EREVERSE(A_27b),V6l))) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V4e),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V5g),V6l)) ) ) ) ) ) )).
