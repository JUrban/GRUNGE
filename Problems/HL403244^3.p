...
thf(thm_2Ebag_2EBAG__UNION__LEFT__CANCEL,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__UNION @ A_27a @ V0b @ V1b1 )
        = ( c_2Ebag_2EBAG__UNION @ A_27a @ V0b @ V2b2 ) )
    <=> ( V1b1 = V2b2 ) ) )).
...
thf(thm_2Ebag_2EBAG__DELETE__TWICE,conjecture,(
    ! [A_27a: $tType,V0b0: A_27a > tyop_2Enum_2Enum,V1e1: A_27a,V2e2: A_27a,V3b1: A_27a > tyop_2Enum_2Enum,V4b2: A_27a > tyop_2Enum_2Enum] :
     ...
     => ? [V5b: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2EBAG__DELETE @ A_27a @ V3b1 @ V2e2 @ V5b )
          & ( c_2Ebag_2EBAG__DELETE @ A_27a @ V4b2 @ V1e1 @ V5b ) ) ) )).
