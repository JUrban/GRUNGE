...
tff(thm_2ETemporal__Logic_2EALWAYS__LINORD,conjecture,(
    ...
    <=> ! [V2t1_2E0: tyop_2Enum_2Enum] :
          ( p(c_2Earithmetic_2E_3C_3D_2E2(V0t0_2E0,V2t1_2E0))
         => p(app_2E2(tyop_2Enum_2Enum,tyop_2Emin_2Ebool,V1a_2E0,V2t1_2E0)) ) ) )).
