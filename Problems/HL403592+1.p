...
fof(arityeq1_2Ef4094_0_2E1_2EA_27d,axiom,(
    ! [A_27d,X0_2E0] : s(tyop_2Emin_2Ebool,f4094_0_2E1(s(tyop_2Elist_2Elist(A_27d),X0_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Emin_2Ebool),f4094_0_2E0),s(tyop_2Elist_2Elist(A_27d),X0_2E0))) )).
...
fof(def0_2Ethm_2Einftree_2Eis__tree__cases,axiom,(
    ! [A_27d,V5x_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f4094_0_2E1(s(tyop_2Elist_2Elist(A_27d),V5x_2E0))))
    <=> s(tyop_2Elist_2Elist(A_27d),V5x_2E0) = s(tyop_2Elist_2Elist(A_27d),c_2Elist_2ENIL_2E0) ) )).

fof(thm_2Einftree_2Eis__tree__cases,conjecture,(
    ! [A_27a,A_27b,A_27d,V0a0_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Einftree_2Eis__tree_2E1(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b)),V0a0_2E0))))
    <=> ( ? [V1a_2E0] :
          ! [V2x_2E0] : s(tyop_2Esum_2Esum(A_27a,A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b)),V0a0_2E0),s(tyop_2Elist_2Elist(A_27d),V2x_2E0))) = s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Esum_2EINL_2E1(s(A_27a,V1a_2E0)))
        | ? [V3f_2E0,V4b_2E0] :
            ( ! [V5x_2E0] : s(tyop_2Esum_2Esum(A_27a,A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b)),V0a0_2E0),s(tyop_2Elist_2Elist(A_27d),V5x_2E0))) = s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f4094_0_2E1(s(tyop_2Elist_2Elist(A_27d),V5x_2E0))),s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Esum_2EINR_2E1(s(A_27b,V4b_2E0))),s(tyop_2Esum_2Esum(A_27a,A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b)),app_2E2(s(tyop_2Emin_2Efun(A_27d,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b))),V3f_2E0),s(A_27d,c_2Elist_2EHD_2E1(s(tyop_2Elist_2Elist(A_27d),V5x_2E0))))),s(tyop_2Elist_2Elist(A_27d),c_2Elist_2ETL_2E1(s(tyop_2Elist_2Elist(A_27d),V5x_2E0)))))))
            & ! [V6d_2E0] : p(s(tyop_2Emin_2Ebool,c_2Einftree_2Eis__tree_2E1(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b)),app_2E2(s(tyop_2Emin_2Efun(A_27d,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Esum_2Esum(A_27a,A_27b))),V3f_2E0),s(A_27d,V6d_2E0)))))) ) ) ) )).
