...
thf(conj_thm_2Equotient_2EK__RSP,conjecture,(
                             ...
                             => ! [V6x1: $i] :
                                 ...
                                 => ! [V7x2: $i] :
                                     ...
                                     => ! [V8y1: $i] :
                                         ...
                                         => ! [V9y2: $i] :
                                              ( ( mem @ V9y2 @ A_27b )
                                             => ( ( ( p @ ( ap @ ( ap @ V0R1 @ V6x1 ) @ V7x2 ) )
                                                  & ( p @ ( ap @ ( ap @ V3R2 @ V8y1 ) @ V9y2 ) ) )
                                               => ( p @ ( ap @ ( ap @ V0R1 @ ( ap @ ( ap @ ( c_2Ecombin_2EK @ A_27a @ A_27b ) @ V6x1 ) @ V8y1 ) ) @ ( ap @ ( ap @ ( c_2Ecombin_2EK @ A_27a @ A_27b ) @ V7x2 ) @ V9y2 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
