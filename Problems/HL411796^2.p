...
thf(conj_thm_2Ereal__topology_2ESERIES__GOESTOZERO,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1x: $i] :
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Eeventually @ ty_2Enum_2Enum )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3n: $i] :
                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V3n ) @ V0s ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V1x @ V3n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) ) ) )
