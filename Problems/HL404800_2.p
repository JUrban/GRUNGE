...
tff(conj_thm_2Efinite__map_2Efmap__rel__OPTREL__FLOOKUP,lemma,(
     ...
     => ! [V1f1: $i] :
         ...
         => ! [V2f2: $i] :
             ...
             => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),V1f1),V2f2))
              <=> ! [V3k: $i] :
                    ( mem(V3k,A_27c)
                   => p(ap(ap(ap(c_2Eoption_2EOPTREL(A_27a,A_27a),V0R),ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V1f1),V3k)),ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V2f2),V3k))) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2Efmap__rel__FLOOKUP__imp,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1f1: $i] :
          ( mem(V1f1,ty_2Efinite__map_2Efmap(A_27c,A_27c))
         => ! [V2f2: $i] :
             ...
             => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),V1f1),V2f2))
               => ( ! [V3k: $i] :
                      ( mem(V3k,A_27c)
                     => ( ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V1f1),V3k) = c_2Eoption_2ENONE(A_27a)
                       => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V2f2),V3k) = c_2Eoption_2ENONE(A_27b) ) )
                  & ! [V4k: $i] :
                      ( mem(V4k,A_27c)
                     => ! [V5v1: $i] :
                          ( mem(V5v1,A_27a)
                         => ( ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V1f1),V4k) = ap(c_2Eoption_2ESOME(A_27a),V5v1)
                           => ? [V6v2: $i] :
                                ( mem(V6v2,A_27b)
                                & ap(ap(c_2Efinite__map_2EFLOOKUP(A_27c,A_27c),V2f2),V4k) = ap(c_2Eoption_2ESOME(A_27b),V6v2)
