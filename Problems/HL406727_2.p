...
tff(conj_thm_2EOmega_2Ecalc__nightmare__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1x: tp__ty_2Einteger_2Eint,V2c: tp__ty_2Enum_2Enum] : p(ap(ap(ap(V0P,inj__ty_2Einteger_2Eint(V1x)),inj__ty_2Enum_2Enum(V2c)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
