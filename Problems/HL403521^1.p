...
thf(thm_2Ewellorder_2EWEXTENSION,axiom,(
    ! [A_27a: d,V0w2_2E0: u,V1w1_2E0: u] :
      ( ( ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 )
        = ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w2_2E0 ) )
    <=> ! [V2a_2E0: u,V3b_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27a @ V3b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27a @ V3b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w2_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ewellorder_2EfromNatWO__11,conjecture,(
    ! [A_27a: d,V0j: mono_2Etyop_2Enum_2Enum,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( ( s @ ( tyop_2Ewellorder_2Ewellorder @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) @ ( c_2Ewellorder_2EfromNatWO_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) ) )
        = ( s @ ( tyop_2Ewellorder_2Ewellorder @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) ) @ ( c_2Ewellorder_2EfromNatWO_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0j ) ) ) ) )
    <=> ( V1i = V0j ) ) )).
