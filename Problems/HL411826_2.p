...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f4059(V0s)),V1t)) ) ) ) )).
