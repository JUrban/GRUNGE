...
tff(ax_thm_2Erelation_2ESTRORD,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(conj_thm_2Erelation_2ESTRORD__Strong,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
