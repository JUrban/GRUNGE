...
thf(thm_2Earithmetic_2EONE__LT__EXP,axiom,(
    ! [V0x: tyop_2Enum_2Enum,V1y: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2EEXP @ V0x @ V1y ) )
...
thf(thm_2Ebit_2EBIT__SHIFT__THM4,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1i: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V1i @ ( c_2Earithmetic_2EDIV @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) )
      = ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2B @ V1i @ V0n ) @ V2a ) ) )).

thf(thm_2Ebit_2EDIV__LT,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( ( c_2Eprim__rec_2E_3C @ V0n @ V1m )
        & ( c_2Eprim__rec_2E_3C @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2EDIV @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) ) ) )).

thf(thm_2Ebit_2EMOD__ZERO__GT,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum] :
      ( ( ( (~) @ ( V1a = c_2Enum_2E0 ) )
        & ( ( c_2Earithmetic_2EMOD @ V1a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) )
          = c_2Enum_2E0 ) )
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) @ V1a ) ) )).
...
thf(thm_2Ebit_2EBIT__SHIFT__THM5,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2i: tyop_2Enum_2Enum,V3a: tyop_2Enum_2Enum] :
      ( ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2E_2B @ V2i @ V0n ) @ V1m )
        & ( c_2Eprim__rec_2E_3C @ V3a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) ) )
     => ( ( c_2Ebit_2EBIT @ V2i @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) @ ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2EDIV @ V3a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2EMOD @ V3a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) @ c_2Enum_2E0 ) @ c_2Enum_2E0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) ) ) )
        = ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2B @ V2i @ V0n ) @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) @ ( c_2Earithmetic_2EMOD @ V3a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) ) ) ) ) ) )).
...
thf(thm_2Einteger_2EINT__DIV__CALCULATE,axiom,
    ( ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
        ( ( (~) @ ( V1m = c_2Enum_2E0 ) )
...
thf(thm_2Einteger__word_2Ei2w__DIV,conjecture,(
