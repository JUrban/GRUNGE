...
tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
       => ! [V1f_27: $i] :
            ( mem(V1f_27,arr(A_27a,A_27b))
           => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V1f_27),V0P),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0P)))
             => ! [V2f: $i] :
                  ( mem(V2f,arr(A_27b,ty_2Erealax_2Ereal))
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0P))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2f),V1f_27)),V0P)) ) ) ) ) ) )).

tff(lmtp_f3192,type,(
    f3192: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3192,axiom,(
    ! [A_27a: del,A_27b: del,V3x: $i] :
      ( mem(V3x,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Erealax_2Ereal))
         => mem(f3192(A_27a,A_27b,V3x,V0f),arr(A_27b,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3192,axiom,(
    ! [A_27a: del,A_27b: del,V3x: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V4y: $i] :
              ( mem(V4y,A_27b)
             => ap(f3192(A_27a,A_27b,V3x,V0f),V4y) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),V4y)) ) ) ) )).

tff(lmtp_f3191,type,(
    f3191: ( del * del * $i ) > $i )).

tff(lamtp_f3191,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Erealax_2Ereal))
     => mem(f3191(A_27b,A_27a,V0f),arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal))) ) )).
...
tff(lameq_f3191,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3191(A_27b,A_27a,V0f),V3x) = f3192(A_27a,A_27b,V3x,V0f) ) ) )).

tff(lmtp_f3194,type,(
    f3194: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3194,axiom,(
    ! [A_27b: del,A_27a: del,V5y: $i] :
      ( mem(V5y,A_27b)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Erealax_2Ereal))
         => mem(f3194(A_27b,A_27a,V5y,V0f),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3194,axiom,(
    ! [A_27b: del,A_27a: del,V5y: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V6x: $i] :
              ( mem(V6x,A_27a)
             => ap(f3194(A_27b,A_27a,V5y,V0f),V6x) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6x),V5y)) ) ) ) )).

tff(lmtp_f3193,type,(
    f3193: ( del * del * $i ) > $i )).

tff(lamtp_f3193,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Erealax_2Ereal))
     => mem(f3193(A_27a,A_27b,V0f),arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal))) ) )).
...
tff(lameq_f3193,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V5y: $i] :
          ( mem(V5y,A_27b)
         => ap(f3193(A_27a,A_27b,V0f),V5y) = f3194(A_27b,A_27a,V5y,V0f) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__CROSS__SYM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Erealax_2Ereal))
     => ! [V1s1: $i] :
         ...
         => ! [V2s2: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s1))
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f3191(A_27b,A_27a,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V1s1),V2s2))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Epair_2EUNCURRY(A_27b,A_27b,A_27b),f3193(A_27a,A_27b,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V2s2),V1s1))) ) ) ) ) )).
