...
tff(conj_thm_2Ebinary__ieee_2Erounding2num__thm,lemma,
    ...
    ! [A_27a: del,V0x: tp__ty_2Ebinary__ieee_2Erounding,V1v0: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V3v2: $i] :
             ...
             => ! [V4v3: $i] :
                  ( mem(V4v3,A_27a)
                 => ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Erounding__CASE(A_27a),inj__ty_2Ebinary__ieee_2Erounding(V0x)),V1v0),V2v1),V3v2),V4v3) = ap(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Ebinary__ieee_2Erounding2num,inj__ty_2Ebinary__ieee_2Erounding(V0x))) ) ) ) ) )).

tff(conj_thm_2Ebinary__ieee_2Erounding__case__def,conjecture,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( mem(V0v0,A_27a)
         => ! [V1v1: $i] :
