...
thf(conj_thm_2Ebag_2EBAG__IMAGE__EQ__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ A_27b ) )
         => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
           => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27b @ A_27a ) @ V1f ) @ V0b )
                = ( c_2Ebag_2EEMPTY__BAG @ A_27b ) )
            <=> ( V0b
                = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EBAG__EVERY__THM,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0P: $i] :
...
thf(conj_thm_2Ebag_2EBAG__IMAGE__FINITE__RESTRICTED__I,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V1b ) )
              & ( p
                @ ( ap
                  @ ( ap @ ( c_2Ebag_2EBAG__EVERY @ A_27a )
                    @ ( lam @ A_27a
                      @ ^ [V2e: $i] :
                          ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ V0f @ V2e ) ) @ V2e ) ) )
                  @ V1b ) ) )
           => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27a @ A_27a ) @ V0f ) @ V1b )
              = V1b ) ) ) ) )).
