...
thf(f3152_0_2E0,type,(
    f3152_0_2E0: u )).

thf(f3152_0_2E1,type,(
    f3152_0_2E1: du > u )).

thf(f3152_0_2E3,type,(
    f3152_0_2E3: du > du > du > u )).

thf(f3154_0_2E0,type,(
    f3154_0_2E0: u )).

thf(f3154_0_2E1,type,(
    f3154_0_2E1: du > u )).

thf(f3154_0_2E3,type,(
    f3154_0_2E3: du > du > du > u )).
...
thf(arityeq1_2Emono_2Ef3152_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( f3152_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) @ f3152_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3152_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27a @ ( f3152_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef3154_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( f3154_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) @ f3154_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3154_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27a @ ( f3154_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) @ f3154_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Elist_2EFOLDR_2E3_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
...
thf(def0_2Ethm_2Erich__list_2EFOLDL__FOLDR__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V3x_2E0: u,V4y_2E0: u] :
      ( ( s @ A_27a @ ( f3152_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) )
...
thf(thm_2Erich__list_2EFOLDL__FOLDR__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2l_2E0: u] :
      ...
      = ( s @ A_27a @ ( c_2Elist_2EFOLDR_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( f3152_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) ) ) @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) ) ) )).

thf(def0_2Ethm_2Erich__list_2EFOLDL__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V3x_2E0: u,V4y_2E0: u] :
      ( ( s @ A_27a @ ( f3154_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) ) @ ( s @ A_27b @ V3x_2E0 ) ) ) ) )).

thf(thm_2Erich__list_2EFOLDL__REVERSE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2l_2E0: u] :
      ...
      = ( s @ A_27a @ ( c_2Elist_2EFOLDR_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( f3154_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) ) ) @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) )).
