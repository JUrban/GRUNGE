...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTiesToEven__minus__infinity,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0y] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Erealax_2Ereal)
                 => ( p(ap(ap(c_2Ereal_2Ereal__lte,V1x),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))
                   => ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V1x) = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) )).
