...
thf(conj_thm_2Eprobability_2EPROB__POSITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eprobability_2EPROB__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eprobability_2Efinite__marginal__product__space__POW,conjecture,(
                                ...
                                @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a )
                                  @ ( ap
                                    @ ( ap @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) )
                                      @ ( lam @ A_27a
                                        @ ^ [V4x: $i] :
                                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ A_27c ) @ ( ap @ V1X @ V4x ) ) @ ( ap @ V2Y @ V4x ) ) ) )
                                    @ V3a ) )
