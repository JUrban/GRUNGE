...
fof(thm_2Ereal__topology_2EUNCOUNTABLE__OPEN,axiom,(
    ! [V0s_2E0] :
     ...
     => ~ p(s(tyop_2Emin_2Ebool,c_2Epred__set_2Ecountable_2E1(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool),V0s_2E0)))) ) )).
...
fof(thm_2Ereal__topology_2EFINITE__IMP__NOT__OPEN,conjecture,(
    ! [V0s_2E0] :
