...
fof(lameq_f3450,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f3450(A_27a,V1f,V0s),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V0s)),ap(V1f,V2x)),ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IN__IF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ! [V1f] :
                ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
               => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3450(A_27a,V1f,V0s)),V0s) ) ) ) ) )).
