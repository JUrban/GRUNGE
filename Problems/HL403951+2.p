...
fof(conj_thm_2Eoption_2EIS__SOME__EXISTS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0opt] :
          ( mem(V0opt,ty_2Eoption_2Eoption(A_27a))
...
fof(conj_thm_2Eoption_2EIS__NONE__EQ__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Erich__list_2ETAKE__APPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
               => ! [V2l2] :
                    ( mem(V2l2,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Elist_2ETAKE(A_27a),V0n),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V2l2)) = ap(ap(c_2Elist_2ETAKE(A_27a),V0n),V1l1) ) ) ) ) ) )).
...
fof(conj_thm_2Ellist_2ELAPPEND__NIL__2ND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
...
fof(conj_thm_2Ellist_2ELTAKE__LAPPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ellist_2ELTAKE__LNTH__EL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ellist_2ENOT__LFINITE__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll1] :
          ( mem(V0ll1,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELTAKE__fromList,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
    ...
    ! [A_27a,V1l1] :
     ...
     => ! [V0n] :
         ...
         => ! [V2l2] :
             ...
             => ! [V3m] :
                  ( mem(V3m,ty_2Enum_2Enum)
                 => ap(f1214(A_27a,V1l1,V0n,V2l2),V3m) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Eprim__rec_2E_3C,V0n),V3m)),ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),V1l1)),ap(ap(c_2Ellist_2ELNTH(A_27a),ap(ap(c_2Earithmetic_2E_2D,V0n),V3m)),V2l2)) ) ) ) ) )).

fof(conj_thm_2Ellist_2ELNTH__LAPPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ! [V2l2] :
                  ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
                 => ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),ap(ap(c_2Ellist_2ELAPPEND(A_27a),V1l1),V2l2)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Ellist_2ELLENGTH(A_27a),V1l1)),ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),V1l1)),f1214(A_27a,V1l1,V0n,V2l2)) ) ) ) ) )).
...
fof(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
...
fof(conj_thm_2Ellist_2ELTAKE__IMP__LDROP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ellist_2ELPREFIX__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Ellist_2Ellist(A_27a))
