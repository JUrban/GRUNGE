...
tff(conj_thm_2Ereal__topology_2ESPAN__CLAUSES,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ESPAN__ADD__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESPAN__EQ__SELF,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ap(c_2Ereal__topology_2Espan,V0s) = V0s
      <=> p(ap(c_2Ereal__topology_2Esubspace,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2ESURJECTIVE__IMAGE__EQ,lemma,(
...
tff(conj_thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2Esubspace,V0s))
            & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),V0s)) )
         => ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3657(V1a)),V0s) = V0s ) ) )).
