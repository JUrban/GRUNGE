...
fof(conj_thm_2EerrorStateMonad_2EIGNORE__BIND__ESGUARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0xM] :
             ...
             => ( ap(ap(c_2EerrorStateMonad_2EIGNORE__BIND(ty_2Eone_2Eone,ty_2Eone_2Eone,ty_2Eone_2Eone),ap(c_2EerrorStateMonad_2EES__GUARD(A_27a),c_2Ebool_2EF)),V0xM) = c_2EerrorStateMonad_2EES__FAIL(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b))
                & ap(ap(c_2EerrorStateMonad_2EIGNORE__BIND(ty_2Eone_2Eone,ty_2Eone_2Eone,ty_2Eone_2Eone),ap(c_2EerrorStateMonad_2EES__GUARD(A_27a),c_2Ebool_2ET)),V0xM) = V0xM ) ) ) ) )).
