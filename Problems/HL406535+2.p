...
fof(conj_thm_2Ebit_2EMOD__PLUS__RIGHT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(mem_c_2Ewords_2Eword__rol__bv,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__rol__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V2k] :
         ...
         => ! [V0w] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => mem(f2332(A_27a,V1m,V2k,V0w,V3a),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).

fof(lameq_f2332,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k] :
          ( mem(V2k,ty_2Enum_2Enum)
         => ! [V0w] :
             ...
             => ! [V3a] :
                 ...
                 => ! [V4j] :
                     ...
                     => ap(f2332(A_27a,V1m,V2k,V0w,V3a),V4j) = ap(ap(c_2Ebool_2E_5C_2F,V3a),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__mod(A_27a),V1m),ap(c_2Ewords_2En2w(A_27a),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))),ap(c_2Ewords_2En2w(A_27a),V4j))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,V2k),ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V4j)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))))) ) ) ) ) ) )).

fof(lamtp_f2331,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k] :
          ( mem(V2k,ty_2Enum_2Enum)
         => ! [V0w] :
              ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
             => mem(f2331(A_27a,V1m,V2k,V0w),arr(bool,arr(ty_2Enum_2Enum,bool))) ) ) ) )).

fof(lameq_f2331,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k] :
          ( mem(V2k,ty_2Enum_2Enum)
         => ! [V0w] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => ap(f2331(A_27a,V1m,V2k,V0w),V3a) = f2332(A_27a,V1m,V2k,V0w,V3a) ) ) ) ) )).

fof(lamtp_f2330,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2330(A_27a,V0w,V1m),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f2330,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1m] :
         ...
         => ! [V2k] :
              ( mem(V2k,ty_2Enum_2Enum)
             => ap(f2330(A_27a,V0w,V1m),V2k) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f2331(A_27a,V1m,V2k,V0w)),c_2Ebool_2EF),ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).

fof(conj_thm_2Eblast_2Eword__rol__bv__expand,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1m] :
              ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Eword__rol__bv(A_27a),V0w),V1m) = ap(c_2Efcp_2EFCP(bool,bool),f2330(A_27a,V0w,V1m)) ) ) ) )).
