...
tff(conj_thm_2Eoption_2EIS__NONE__EQ__NONE,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Erich__list_2ETAKE__APPEND1,lemma,(
...
tff(conj_thm_2Ellist_2ELTAKE__fromList,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Ellist_2ELNTH__LAPPEND,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( mem(V1l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l2: $i] :
          ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
...
tff(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Ellist_2ELTAKE__IMP__LDROP,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l1: $i] :
...
tff(conj_thm_2Ellist_2ELPREFIX__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Ellist_2Ellist(A_27a))
