...
thf(thm_2EquantHeuristics_2ELIST__LENGTH__1,axiom,(
...
thf(thm_2EquantHeuristics_2ELIST__LENGTH__COMPARE__SUC,conjecture,(
    ! [A_27a: d,V0x: mono_2Etyop_2Enum_2Enum,V1l_2E0: u] :
      ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Enum_2ESUC @ V0x ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) )
      <=> ? [V2l_27_2E0: u,V3e1_2E0: u] :
            ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0x @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_27_2E0 ) ) ) ) )
            & ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 )
              = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3e1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_27_2E0 ) ) ) ) ) )
      & ( ( mono_2Ec_2Earithmetic_2E_3E_3D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) @ ( mono_2Ec_2Enum_2ESUC @ V0x ) )
      <=> ? [V4l_27_2E0: u,V5e1_2E0: u] :
            ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0x @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_27_2E0 ) ) ) ) )
            & ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 )
              = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V5e1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_27_2E0 ) ) ) ) ) )
      & ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) )
          = ( mono_2Ec_2Enum_2ESUC @ V0x ) )
      <=> ? [V6l_27_2E0: u,V7e1_2E0: u] :
            ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V6l_27_2E0 ) ) ) )
              = V0x )
            & ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 )
              = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V7e1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V6l_27_2E0 ) ) ) ) ) )
      & ( ( ( mono_2Ec_2Enum_2ESUC @ V0x )
