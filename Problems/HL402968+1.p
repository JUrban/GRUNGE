...
fof(thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__def,axiom,(
    ! [A_27a,A_27b,V0v_2E0,V1rs_2E0,V2i_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT_2E3(s(A_27a,V0v_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V1rs_2E0),s(tyop_2Enum_2Enum,V2i_2E0))))
    <=> ( p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V2i_2E0),s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V1rs_2E0))))))
        & ( p(s(tyop_2Emin_2Ebool,c_2Eoption_2EIS__SOME_2E1(s(tyop_2Eoption_2Eoption(A_27b),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b)),c_2Elist_2EEL_2E2(s(tyop_2Enum_2Enum,V2i_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V1rs_2E0))),s(A_27a,V0v_2E0))))))
         => ? [V3j_2E0] :
              ( p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V3j_2E0),s(tyop_2Enum_2Enum,V2i_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2Eoption_2EIS__SOME_2E1(s(tyop_2Eoption_2Eoption(A_27b),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b)),c_2Elist_2EEL_2E2(s(tyop_2Enum_2Enum,V3j_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V1rs_2E0))),s(A_27a,V0v_2E0)))))) ) ) ) ) )).
...
fof(thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__SUC,conjecture,(
    ! [A_27a,A_27b,V0v_2E0,V1r_2E0,V2rs_2E0,V3i_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT_2E3(s(A_27a,V0v_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),c_2Elist_2ECONS_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b)),V1r_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V2rs_2E0))),s(tyop_2Enum_2Enum,c_2Enum_2ESUC_2E1(s(tyop_2Enum_2Enum,V3i_2E0))))))
    <=> ( ( s(tyop_2Eoption_2Eoption(A_27b),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b)),V1r_2E0),s(A_27a,V0v_2E0))) != s(tyop_2Eoption_2Eoption(A_27b),c_2Eoption_2ENONE_2E0)
          & p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V3i_2E0),s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V2rs_2E0)))))) )
        | p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT_2E3(s(A_27a,V0v_2E0),s(tyop_2Elist_2Elist(tyop_2Emin_2Efun(A_27a,tyop_2Eoption_2Eoption(A_27b))),V2rs_2E0),s(tyop_2Enum_2Enum,V3i_2E0)))) ) ) )).
