...
thf(thm_2Ebit_2ETWOEXP__NOT__ZERO,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( (~)
      @ ( ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n )
        = c_2Enum_2E0 ) ) )).
...
thf(thm_2Ebit_2EBIT__SLICE__THM3,conjecture,(
