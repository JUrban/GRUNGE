...
thf(thm_2Ecardinal_2ECARD__LE__IMAGE__GEN,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1s: A_27a > $o,V2t: A_27b > $o] :
     ...
     => ( c_2Ecardinal_2Ecardleq @ A_27b @ A_27a @ V2t @ V1s ) ) )).
...
thf(thm_2Ecardinal_2EUNION__LE__ADD__C,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1t: A_27a > $o] :
      ( c_2Ecardinal_2Ecardleq @ A_27a @ ( tyop_2Esum_2Esum @ A_27a @ A_27a ) @ ( c_2Epred__set_2EUNION @ A_27a @ V0s @ V1t ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27a @ V0s @ V1t ) ) )).
