...
fof(conj_thm_2Eextreal_2Eadd__infty,lemma,
    ( ! [V0x] :
        ( mem(V0x,ty_2Eextreal_2Eextreal)
       => ( ap(ap(c_2Eextreal_2Eextreal__add,V0x),c_2Eextreal_2EPosInf) = c_2Eextreal_2EPosInf
          & ap(ap(c_2Eextreal_2Eextreal__add,c_2Eextreal_2EPosInf),V0x) = c_2Eextreal_2EPosInf ) )
    & ! [V1x] :
        ( mem(V1x,ty_2Eextreal_2Eextreal)
       => ( V1x != c_2Eextreal_2EPosInf
         => ( ap(ap(c_2Eextreal_2Eextreal__add,V1x),c_2Eextreal_2ENegInf) = c_2Eextreal_2ENegInf
            & ap(ap(c_2Eextreal_2Eextreal__add,c_2Eextreal_2ENegInf),V1x) = c_2Eextreal_2ENegInf ) ) ) )).
...
fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__FN__PLUS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__split,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ! [V2s] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                      ...
                      & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V1f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel))) )
                   => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),V1f) = ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4188(A_27a,V1f,V2s))),ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4189(A_27a,V2s,V0m,V1f))) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__infty,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Elebesgue_2Eintegrable__infty,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                      ...
                      & ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                           => ap(V1f,V3x) = c_2Eextreal_2EPosInf ) ) )
                   => ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V2s) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) )).
