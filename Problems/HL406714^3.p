...
thf(thm_2EOmega_2Eevalupper__ind,conjecture,(
    ! [V0P: tyop_2Einteger_2Eint > ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Einteger_2Eint ) ) > $o] :
      ( ( ! [V1x: tyop_2Einteger_2Eint] :
            ( V0P @ V1x @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Einteger_2Eint ) ) )
     ...
     => ! [V6v: tyop_2Einteger_2Eint,V7v1: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Einteger_2Eint )] :
          ( V0P @ V6v @ V7v1 ) ) )).
