...
fof(conj_thm_2Erich__list_2ELASTN__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
                   => ! [V2f] :
                       ...
                       => ap(ap(c_2Erich__list_2ELASTN(A_27b),V0n),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V2f),V1l)) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V2f),ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),V1l)) ) ) ) ) ) ) )).
