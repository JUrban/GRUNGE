...
fof(conj_thm_2Earithmetic_2ESUB__LEFT__SUC,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITS__DIV__THM,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITS__LT__HIGH,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITS__COMP__THM2,conjecture,(
    ! [V0h1] :
      ( mem(V0h1,ty_2Enum_2Enum)
     => ! [V1l1] :
          ( mem(V1l1,ty_2Enum_2Enum)
