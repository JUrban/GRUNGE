...
tff(conj_thm_2Etransc_2EDIVISION__EQ,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => ( V1a = V2b
          <=> surj__ty_2Enum_2Enum(ap(c_2Etransc_2Edsize,V0D)) = fo__c_2Enum_2E0 ) ) ) )).

tff(conj_thm_2Etransc_2EINTEGRAL__NULL,conjecture,(
    ! [V0f: $i] :
