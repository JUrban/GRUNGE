    ...
    ! [A_27a: del,V0set: $i] :
     ...
     => ( ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0set )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
          @ ( lam @ ( arr @ A_27a @ bool )
            @ ^ [V1s: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V1s ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V1s ) @ V0set ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EFINITE__POWERSET,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ A_27a @ bool ) )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
              @ ( lam @ ( arr @ A_27a @ bool )
                @ ^ [V1t: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V1t ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V1t ) @ V0s ) ) ) ) ) ) ) ) )).
