...
thf(c_2Emachine__ieee_2Efp32__to__int,type,(
    c_2Emachine__ieee_2Efp32__to__int: tyop_2Ebinary__ieee_2Erounding > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) ) > ( tyop_2Eoption_2Eoption @ tyop_2Einteger_2Eint ) )).
...
thf(thm_2Emachine__ieee_2Efp32__to__int__def,axiom,(
    ! [V0mode: tyop_2Ebinary__ieee_2Erounding] :
      ( ( c_2Emachine__ieee_2Efp32__to__int @ V0mode )
...
thf(thm_2Emachine__ieee_2Efp32__to__int,conjecture,
    ( ! [V0mode: tyop_2Ebinary__ieee_2Erounding,V1a: tyop_2Ebinary__ieee_2Efloat @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) )] :
        ( ( c_2Emachine__ieee_2Efp32__to__int @ V0mode @ ( c_2Emachine__ieee_2Efloat__to__fp32 @ V1a ) )
        = ( c_2Ebinary__ieee_2Efloat__to__int @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ V0mode @ V1a ) )
    & ! [V2mode: tyop_2Ebinary__ieee_2Erounding,V3a: tyop_2Enum_2Enum] :
        ( ( c_2Emachine__ieee_2Efp32__to__int @ V2mode @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) @ V3a ) )
        = ( c_2Ebinary__ieee_2Efloat__to__int @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ V2mode @ ( c_2Emachine__ieee_2Efp32__to__float @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) @ V3a ) ) ) ) )).
