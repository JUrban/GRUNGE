...
fof(conj_thm_2Efinite__map_2EFRANGE__FEMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),c_2Efinite__map_2EFEMPTY(A_27b,A_27b)) = c_2Epred__set_2EEMPTY(A_27a) ) ) )).

fof(conj_thm_2Efinite__map_2EFRANGE__FUPDATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFINITE__FRANGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0fm] :
             ...
             => p(ap(c_2Epred__set_2EFINITE(A_27b),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V0fm))) ) ) ) )).
