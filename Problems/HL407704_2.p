...
tff(conj_thm_2Eordinal_2Eordle__EXISTS__ADD,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eordinal_2EordEXP__1R,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2EordNotationSemantics_2EaddL__disappears,lemma,(
    ! [A_27a: del,V0e: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),V1a),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0e)))
           => ap(ap(c_2Eordinal_2EordADD(A_27a),V1a),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0e)) = ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0e) ) ) ) )).

tff(conj_thm_2EordNotationSemantics_2Eadd__nat1__disappears,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ~ p(ap(ap(c_2Eordinal_2Eordlt(A_27a),V0a),c_2Eordinal_2Eomega(A_27a)))
         => ap(ap(c_2Eordinal_2EordADD(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(V1n))),V0a) = V0a ) ) )).
