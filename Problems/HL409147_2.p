...
tff(conj_thm_2Eieee_2Eroundmode2num__num2roundmode,conjecture,(
    ...
    <=> surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,ap(c_2Eieee_2Enum2roundmode,inj__ty_2Enum_2Enum(V0r)))) = V0r ) )).
