...
thf(thm_2Ewords_2EWORD__PRED__THM,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( (~)
        @ ( V0m
          = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Ewords_2Ew2n @ A_27a @ ( c_2Ewords_2Eword__sub @ A_27a @ V0m @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ ( c_2Ewords_2Ew2n @ A_27a @ V0m ) ) ) )).
