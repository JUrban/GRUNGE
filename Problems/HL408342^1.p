...
thf(f9741_0_2E0,type,(
    f9741_0_2E0: u )).

thf(f9741_0_2E1,type,(
    f9741_0_2E1: du > u )).

thf(f9741_0_2E2,type,(
    f9741_0_2E2: du > du > u )).
...
thf(mono_2Ef9741_0,type,(
    mono_2Ef9741_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(thm_2Elim_2Edifferentiable,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Elim_2Edifferentiable @ V0f @ V1x )
    <=> ? [V2l: mono_2Etyop_2Erealax_2Ereal] :
          ( mono_2Ec_2Elim_2Ediffl @ V0f @ V2l @ V1x ) ) )).
...
thf(thm_2Elim_2EIVT2,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V2b )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V2b ) @ V3y )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V3y @ ( V0f @ V1a ) )
        & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V4x )
              & ( mono_2Ec_2Ereal_2Ereal__lte @ V4x @ V2b ) )
           => ( mono_2Ec_2Elim_2Econtl @ V0f @ V4x ) ) )
...
thf(thm_2Elim_2EROLLE,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ? [V5z: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V5z )
          & ( mono_2Ec_2Erealax_2Ereal__lt @ V5z @ V2b )
          & ( mono_2Ec_2Elim_2Ediffl @ V0f @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V5z ) ) ) )).
...
thf(thm_2Etransc_2EPI__POS,axiom,(
    mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ mono_2Ec_2Etransc_2Epi )).

thf(thm_2Etransc_2ECOS__PI,axiom,
    ( ( mono_2Ec_2Etransc_2Ecos @ mono_2Ec_2Etransc_2Epi )
    = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )).

thf(thm_2Etransc_2ESIN__POS__PI,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x )
        & ( mono_2Ec_2Erealax_2Ereal__lt @ V0x @ mono_2Ec_2Etransc_2Epi ) )
     => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Etransc_2Esin @ V0x ) ) ) )).

thf(def0_2Ethm_2Etransc_2ECOS__TOTAL,axiom,(
    ! [V0y: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9741_0 @ V0y @ V1x )
    <=> ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V1x )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V1x @ mono_2Ec_2Etransc_2Epi )
        & ( ( mono_2Ec_2Etransc_2Ecos @ V1x )
          = V0y ) ) ) )).

thf(thm_2Etransc_2ECOS__TOTAL,conjecture,(
    ! [V0y: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Ebool_2E_3F_21_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9741_0 @ V0y ) ) ) )).
