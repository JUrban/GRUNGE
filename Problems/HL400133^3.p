...
thf(thm_2Ebool_2ERES__SELECT__DEF,axiom,(
    ! [A_27a: $tType] :
      ...
      = ( ^ [V0p: A_27a > $o,V1m: A_27a > $o] :
            ( c_2Emin_2E_40 @ A_27a
            @ ^ [V2x: A_27a] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V0p ) @ ( V1m @ V2x ) ) ) ) ) )).

thf(thm_2Ebool_2ERES__SELECT__THM,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1f: A_27a > $o] :
      ( ( c_2Ebool_2ERES__SELECT @ A_27a @ V0P @ V1f )
      = ( c_2Emin_2E_40 @ A_27a
        @ ^ [V2x: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V0P ) @ ( V1f @ V2x ) ) ) ) )).
