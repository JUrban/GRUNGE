...
fof(conj_thm_2Earithmetic_2EADD__DIV__RWT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Earithmetic_2EONE__LT__EXP,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ebit_2ETWOEXP__MONO2,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2ENOT__BIT__GT__TWOEXP,lemma,(
    ! [V0i] :
...
fof(conj_thm_2Ebit_2EBIT__COMPLEMENT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1i] :
...
fof(conj_thm_2Ebit_2EBIT__SHIFT__THM4,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EDIV__LT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EMOD__ZERO__GT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1a] :
          ( mem(V1a,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EDIV__GT0,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EDIV__SUB1,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__SHIFT__THM5,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger_2EINT__LE__TRANS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__EXP,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ap(ap(c_2Einteger_2Eint__exp,ap(c_2Einteger_2Eint__of__num,V0n)),V1m) = ap(c_2Einteger_2Eint__of__num,ap(ap(c_2Earithmetic_2EEXP,V0n),V1m)) ) ) )).
...
fof(conj_thm_2Einteger_2EINT__DIV__CALCULATE,lemma,
    ( ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
       => ! [V1m] :
            ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Eint__arith_2Ele__move__right__left,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger__word_2Ei2w__DIV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
