...
fof(conj_thm_2Ewords_2EEXTEND__EXTRACT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1l] :
                     ...
                     => ! [V2w] :
                         ...
                         => ( ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c)) = ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2B,V0h),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1l)
                           => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),V2w) = ap(c_2Ewords_2Ew2w(A_27c,A_27c),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),V2w)) ) ) ) ) ) ) ) )).
