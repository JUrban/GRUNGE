...
thf(conj_thm_2Ereal__topology_2ELIMPT__SING,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ~ ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__LIMIT__POINT,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__SING,conjecture,(
