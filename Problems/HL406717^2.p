...
thf(conj_thm_2EOmega_2Edark__shadow__cond__row__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1c: tp__ty_2Enum_2Enum,V2L: tp__ty_2Einteger_2Eint] :
              ( p @ ( ap @ ( ap @ V0P @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Einteger_2Eint ) @ ( inj__ty_2Enum_2Enum @ V1c ) ) @ ( inj__ty_2Einteger_2Eint @ V2L ) ) ) @ ( c_2Elist_2ENIL @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Einteger_2Eint ) ) ) )
