...
tff(conj_thm_2Elift__ieee_2Efloat__div__relative,lemma,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
              ...
              & ~ p(ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27t,A_27t),V1b))
              & p(ap(ap(c_2Elift__ieee_2Enormalizes(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),ap(ap(c_2Ereal_2E_2F,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)))) )
           => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),V0a),V1b))))
...
tff(tp_c_2Emachine__ieee_2Efp16__div,type,(
    c_2Emachine__ieee_2Efp16__div: $i )).

tff(mem_c_2Emachine__ieee_2Efp16__div,axiom,(
    mem(c_2Emachine__ieee_2Efp16__div,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))))) )).
...
tff(tp_c_2Emachine__ieee_2Efp16__isZero,type,(
    c_2Emachine__ieee_2Efp16__isZero: $i )).

tff(mem_c_2Emachine__ieee_2Efp16__isZero,axiom,(
    mem(c_2Emachine__ieee_2Efp16__isZero,arr(ty_2Efcp_2Ecart(bool,bool),bool)) )).

tff(stp_fo_c_2Emachine__ieee_2Efp16__isZero,type,(
    fo__c_2Emachine__ieee_2Efp16__isZero: tp__c_ty_2Efcp_2Ecart_o_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone > tp__o )).

tff(stp_eq_fo_c_2Emachine__ieee_2Efp16__isZero,axiom,(
    ! [X0: tp__c_ty_2Efcp_2Ecart_o_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone] : inj__o(fo__c_2Emachine__ieee_2Efp16__isZero(X0)) = ap(c_2Emachine__ieee_2Efp16__isZero,inj__c_ty_2Efcp_2Ecart_o_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(X0)) )).
...
tff(ax_thm_2Emachine__ieee_2Efp16__isZero__def,axiom,(
    c_2Emachine__ieee_2Efp16__isZero = ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ebinary__ieee_2Efloat__is__zero(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),c_2Emachine__ieee_2Efp16__to__float) )).
...
tff(conj_thm_2Elift__machine__ieee_2Efp16__float__div__relative,conjecture,(
