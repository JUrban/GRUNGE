...
tff(conj_thm_2Eextreal_2Esup__le__sup__imp,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1q: $i] :
...
tff(conj_thm_2Eextreal_2Ele__max2,lemma,(
...
tff(lameq_f4212,axiom,(
    ! [A_27a: del,V6g: $i] :
      ( mem(V6g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V2f: $i] :
          ( mem(V2f,arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))
         => ! [V8n: tp__ty_2Enum_2Enum] : ap(f4212(A_27a,V6g,V2f),inj__ty_2Enum_2Enum(V8n)) = ap(V2f,ap(V6g,inj__ty_2Enum_2Enum(V8n))) ) ) )).

tff(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__IMAGE,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1P_27: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))
             => ( ( ? [V3x: tp__ty_2Eextreal_2Eextreal] : p(ap(V0P,inj__ty_2Eextreal_2Eextreal(V3x)))
               ...
               => ? [V6g: $i] :
                    ( mem(V6g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
                    & ! [V7n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V6g,inj__ty_2Enum_2Enum(V7n))),V1P_27))
                    & surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f4212(A_27a,V6g,V2f)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,V0P)) ) ) ) ) ) )).
...
tff(lameq_f4214,axiom,(
    ! [A_27a: del,V12g: $i] :
      ( mem(V12g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V0f: $i] :
          ( mem(V0f,arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))
         => ! [V16n: tp__ty_2Enum_2Enum] : ap(f4214(A_27a,V12g,V0f),inj__ty_2Enum_2Enum(V16n)) = ap(V0f,ap(V12g,inj__ty_2Enum_2Enum(V16n))) ) ) )).

tff(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__MONO__IMAGE,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))
     => ! [V1P: $i] :
         ...
         => ! [V2P_27: $i] :
             ...
             => ( ( ? [V3x: tp__ty_2Eextreal_2Eextreal] : p(ap(V1P,inj__ty_2Eextreal_2Eextreal(V3x)))
                  & ? [V4z: tp__ty_2Eextreal_2Eextreal] :
                      ( V4z != fo__c_2Eextreal_2EPosInf
                      & ! [V5x: tp__ty_2Eextreal_2Eextreal] :
               ...
               => ? [V12g: $i] :
                    ( mem(V12g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
                    & ! [V13n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V12g,inj__ty_2Enum_2Enum(V13n))),V2P_27))
                    & ! [V14x: $i] :
                        ( mem(V14x,A_27a)
                       => ! [V15n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(V12g,inj__ty_2Enum_2Enum(V15n)),V14x)),ap(ap(V12g,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V15n))),V14x))) )
                    & surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f4214(A_27a,V12g,V0f)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,V1P)) ) ) ) ) ) )).
