...
thf(conj_thm_2Eiterate_2ENUMSEG__LT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V1x: $i] :
...
thf(conj_thm_2Eiterate_2ESUM__COMBINE__L,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__PARTIAL__SUMS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
