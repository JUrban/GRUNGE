...
tff(mem_c_2EfixedPoint_2Eempty,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EfixedPoint_2Eempty(A_27a,A_27a),arr(A_27a,arr(A_27b,bool))) )).

tff(tp_c_2EfixedPoint_2Efnsum,type,(
    c_2EfixedPoint_2Efnsum: ( del * del ) > $i )).

tff(mem_c_2EfixedPoint_2Efnsum,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EfixedPoint_2Efnsum(A_27a,A_27a),arr(arr(A_27b,arr(A_27a,bool)),arr(arr(A_27b,arr(A_27a,bool)),arr(A_27b,arr(A_27a,bool))))) )).
...
tff(ax_thm_2EfixedPoint_2Eempty__def,axiom,(
    ! [A_27a: del,A_27b: del] : c_2EfixedPoint_2Eempty(A_27a,A_27a) = k(A_27a,c_2Epred__set_2EEMPTY(A_27b)) )).

tff(conj_thm_2EfixedPoint_2Efnsum__empty,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,bool)))
     => ( ap(ap(c_2EfixedPoint_2Efnsum(A_27b,A_27b),V0f),c_2EfixedPoint_2Eempty(A_27a,A_27a)) = V0f
        & ap(ap(c_2EfixedPoint_2Efnsum(A_27b,A_27b),c_2EfixedPoint_2Eempty(A_27a,A_27a)),V0f) = V0f ) ) )).
