...
thf(c_2Emachine__ieee_2Efp16__to__value,type,(
    c_2Emachine__ieee_2Efp16__to__value: ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) > tyop_2Ebinary__ieee_2Efloat__value )).
...
thf(thm_2Emachine__ieee_2Efp16__to__value__def,axiom,
...
thf(thm_2Emachine__ieee_2Efp16__to__value,conjecture,
    ( ! [V0a: tyop_2Ebinary__ieee_2Efloat @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) )] :
        ( ( c_2Emachine__ieee_2Efp16__to__value @ ( c_2Emachine__ieee_2Efloat__to__fp16 @ V0a ) )
        = ( c_2Ebinary__ieee_2Efloat__value @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) @ V0a ) )
    & ! [V1a: tyop_2Enum_2Enum] :
        ( ( c_2Emachine__ieee_2Efp16__to__value @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ V1a ) )
        = ( c_2Ebinary__ieee_2Efloat__value @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) @ ( tyop_2Efcp_2Ebit1 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) @ ( c_2Emachine__ieee_2Efp16__to__float @ ( c_2Ewords_2En2w @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) @ V1a ) ) ) ) )).
