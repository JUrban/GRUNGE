...
tff(lmtp_f2728,type,(
    f2728: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2728,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2y: tp__ty_2Erealax_2Ereal] : mem(f2728(V0P,V2y),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f2728,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2y: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f2728(V0P,V2y),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,inj__ty_2Erealax_2Ereal(V3x))),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(lmtp_f2727,type,(
    f2727: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2727,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: tp__ty_2Erealax_2Ereal] : mem(f2727(V0P,V1s),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f2727,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : ap(f2727(V0P,V1s),inj__ty_2Erealax_2Ereal(V2y)) = ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ebool_2E_3F(ty_2Erealax_2Ereal),f2728(V0P,V2y))),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V1s))) ) )).

tff(lmtp_f2726,type,(
    f2726: $i > $i )).

tff(lamtp_f2726,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f2726,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: tp__ty_2Erealax_2Ereal] : ap(f2726(V0P),inj__ty_2Erealax_2Ereal(V1s)) = ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f2727(V0P,V1s)) ) )).

tff(ax_thm_2Ereal_2Esup,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Esup,V0P)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2726(V0P))) ) )).
...
tff(conj_thm_2Eiterate_2Esup__alt,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
