...
thf(conj_thm_2Einteger__word_2Eword__quot,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( V1b
             != ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
           => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__quot @ A_27a ) @ V0a ) @ V1b )
              = ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ ( ap @ c_2Einteger_2Eint__quot @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ V0a ) ) @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ V1b ) ) ) ) ) ) ) )).
