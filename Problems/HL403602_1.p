...
tff(thm_2Einftree_2Einftree__distinct,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1b_2E0: u,V2a_2E0: u] : s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiLf_2E1(s(A_27a,V2a_2E0))) != s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiNd_2E2(s(A_27b,V1b_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c)),V0f_2E0))) )).

tff(thm_2Einftree_2Einftree__ind,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0P_2E0: u] :
      ( ( ! [V1a_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiLf_2E1(s(A_27a,V1a_2E0)))))))
        & ! [V2b_2E0: u,V3f_2E0: u] :
            ( ! [V4d_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),app_2E2(s(tyop_2Emin_2Efun(A_27c,tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c)),V3f_2E0),s(A_27c,V4d_2E0)))))))
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiNd_2E2(s(A_27b,V2b_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c)),V3f_2E0))))))) ) )
     => ! [V5t_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),V5t_2E0))))) ) )).

tff(thm_2Einftree_2Einftree__nchotomy,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0t_2E0: u] :
      ( ? [V1a_2E0: u] : s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),V0t_2E0) = s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiLf_2E1(s(A_27a,V1a_2E0)))
      | ? [V2b_2E0: u,V3d_2E0: u] : s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),V0t_2E0) = s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiNd_2E2(s(A_27b,V2b_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c)),V3d_2E0))) ) )).
