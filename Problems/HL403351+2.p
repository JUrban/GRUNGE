...
fof(conj_thm_2Ebag_2EEMPTY__BAG__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ebag_2ESUB__BAG__DIFF__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2ESUB__BAG__UNION__MONO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0x] :
...
fof(conj_thm_2Ebag_2EPSUB__BAG__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
