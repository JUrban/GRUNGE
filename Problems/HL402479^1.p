...
thf(f2879_0_2E0,type,(
    f2879_0_2E0: u )).

thf(f2879_0_2E1,type,(
    f2879_0_2E1: du > u )).

thf(f2879_0_2E2,type,(
    f2879_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2879_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( f2879_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) ) @ f2879_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2879_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Eone_2Eone] :
      ( ( s @ A_27a @ ( f2879_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) ) @ f2879_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ X1 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EquantHeuristics_2EGUESS__FORALL__POINT_2E2_2Emono_2Etyop_2Eone_2Eone_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__TRIVIAL__FORALL__POINT,axiom,(
    ! [A_27a: d,V0i_2E0: u,V2xxx: mono_2Etyop_2Eone_2Eone] :
      ( ( s @ A_27a @ ( f2879_0_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ V2xxx ) ) ) )
      = ( s @ A_27a @ V0i_2E0 ) ) )).

thf(thm_2EquantHeuristics_2EGUESS__RULES__TRIVIAL__FORALL__POINT,conjecture,(
    ! [A_27a: d,V0i_2E0: u,V1P_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( f2879_0_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) ) ) )).
