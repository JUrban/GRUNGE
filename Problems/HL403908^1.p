...
thf(thm_2Ellist_2Eexists__def,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1x_27_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0x_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1x_27_2E0 ) ) ) )
    <=> ! [V2exists_27_2E0: u] :
          ( ! [V3a0_2E0: u] :
              ( ( ? [V4h_2E0: u,V5t_2E0: u] :
                    ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3a0_2E0 )
                      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V4h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V5t_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0x_2E0 ) @ ( s @ A_27a @ V4h_2E0 ) ) ) ) )
                | ? [V6h_2E0: u,V7t_2E0: u] :
                    ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3a0_2E0 )
                      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V6h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V7t_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V2exists_27_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V7t_2E0 ) ) ) ) ) )
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V2exists_27_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3a0_2E0 ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V2exists_27_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1x_27_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2Eexists__thm,axiom,(
    ! [A_27a: d,V0t_2E0: u,V1h_2E0: u,V2P_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2EF )
      & ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0t_2E0 ) ) ) ) ) )
      <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27a @ V1h_2E0 ) ) ) )
          | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2Eexists__LNTH,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1l_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) ) )
    <=> ? [V2n: mono_2Etyop_2Enum_2Enum,V3e_2E0: u] :
          ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3e_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V3e_2E0 ) ) ) ) ) ) )).
