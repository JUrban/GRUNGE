...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__NEG__INF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__POS__INF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                  & ! [V2x] :
                      ( mem(V2x,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                       => ap(V0f,V2x) != c_2Eextreal_2EPosInf ) ) )
               => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s) != c_2Eextreal_2EPosInf ) ) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__INFTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
