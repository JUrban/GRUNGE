...
thf(f3713_0_2E0,type,(
    f3713_0_2E0: u )).

thf(f3713_0_2E1,type,(
    f3713_0_2E1: du > u )).

thf(f3713_1_2E0,type,(
    f3713_1_2E0: u )).

thf(f3713_1_2E1,type,(
    f3713_1_2E1: du > u )).

thf(f3713_2_2E0,type,(
    f3713_2_2E0: u )).

thf(f3713_2_2E1,type,(
    f3713_2_2E1: du > u )).

thf(f3713_3_2E0,type,(
    f3713_3_2E0: u )).

thf(f3713_3_2E1,type,(
    f3713_3_2E1: du > u )).
...
thf(mono_2Ef3713_0,type,(
    mono_2Ef3713_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3713_1,type,(
    mono_2Ef3713_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3713_2,type,(
    mono_2Ef3713_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3713_3,type,(
    mono_2Ef3713_3: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESUNTIL__SIMP,axiom,(
    ! [V8t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3713_3 @ V8t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2ESUNTIL__SIMP,axiom,(
    ! [V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3713_1 @ V4t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2ESUNTIL__SIMP,axiom,(
    ! [V6t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3713_2 @ V6t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2ESUNTIL__SIMP,axiom,(
    ! [V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3713_0 @ V3t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2ETemporal__Logic_2ESUNTIL__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ mono_2Ef3713_0 @ V0b @ V2x )
          = ( V0b @ V2x ) )
      & ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ mono_2Ef3713_1 @ V0b )
        = ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V0b ) )
      & ! [V5x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ V1a @ mono_2Ef3713_2 @ V5x )
          = mono_2Ec_2Ebool_2EF )
      & ! [V7x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ V1a @ mono_2Ef3713_3 @ V7x )
          = mono_2Ec_2Ebool_2ET )
      & ! [V9x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESUNTIL @ V1a @ V1a @ V9x )
          = ( V1a @ V9x ) ) ) )).
