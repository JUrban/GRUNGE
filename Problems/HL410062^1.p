...
thf(f12127_0_2E0,type,(
    f12127_0_2E0: u )).

thf(f12127_0_2E2,type,(
    f12127_0_2E2: du > du > u )).

thf(f12127_0_2E3,type,(
...
thf(mono_2Ef12127_0,type,(
    mono_2Ef12127_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eproduct_2EPRODUCT__IMAGE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1g_2E0: u,V2s_2E0: u] :
      ( ! [V3x_2E0: u,V4y_2E0: u] :
         ...
         => ( ( s @ A_27a @ V3x_2E0 )
            = ( s @ A_27a @ V4y_2E0 ) ) )
     => ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eproduct_2Eproduct_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) ) ) )
        = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eproduct_2Eproduct_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2Eproduct_2EPRODUCT__OFFSET,axiom,(
    ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3p: mono_2Etyop_2Enum_2Enum,V4i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12127_0 @ V1f @ V3p @ V4i )
      = ( V1f @ ( mono_2Ec_2Earithmetic_2E_2B @ V4i @ V3p ) ) ) )).

thf(thm_2Eproduct_2EPRODUCT__OFFSET,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2m: mono_2Etyop_2Enum_2Enum,V3p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eproduct_2Eproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2E_2B @ V2m @ V3p ) @ ( mono_2Ec_2Earithmetic_2E_2B @ V0n @ V3p ) ) @ V1f )
      = ( mono_2Ec_2Eproduct_2Eproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V0n ) @ ( mono_2Ef12127_0 @ V1f @ V3p ) ) ) )).
