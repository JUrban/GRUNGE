...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__MONO,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2x))),ap(ap(c_2Ereal__topology_2Econnected__component,V1t),inj__ty_2Erealax_2Ereal(V2x)))) ) ) ) )).
