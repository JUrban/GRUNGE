...
fof(conj_thm_2Ewords_2ELSL__BITWISE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0n] :
...
fof(conj_thm_2Ewords_2EEXTRACT__JOIN__LSL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V5n] :
                                 ...
                                 => ! [V6w] :
                                     ...
                                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3l),V1m))
                                       ...
                                       => ap(ap(c_2Ewords_2Eword__or(A_27b),ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V2m_27),V6w)),V4s)),ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V1m),V3l),V6w)),V5n)) = ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),ap(ap(c_2Earithmetic_2EMIN,V0h),ap(ap(c_2Earithmetic_2EMIN,ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),V3l)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))),V3l),V6w)),V5n) ) ) ) ) ) ) ) ) ) ) )).
