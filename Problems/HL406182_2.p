...
tff(conj_thm_2Ewords_2Eword__join__index,lemma,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1a: $i] :
     ...
     => ! [V2b: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
              ...
              & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(ty_2Esum_2Esum(A_27a,A_27a)),c_2Ebool_2Ethe__value(ty_2Esum_2Esum(A_27a,A_27a))))) )
           => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__join(A_27a,A_27a),V1a),V2b)),inj__ty_2Enum_2Enum(V0i)))
            <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),inj__ty_2Enum_2Enum(V0i))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))))) ) ) ) ) )).

tff(conj_thm_2Ewords_2Eword__concat__assoc,conjecture,(
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
               ...
               => ap(ap(c_2Ewords_2Eword__concat(A_27d,A_27d,A_27d),ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),V0a),V1b)),V2c) = ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),V0a),ap(ap(c_2Ewords_2Eword__concat(A_27b,A_27b,A_27b),V1b),V2c)) ) ) ) ) )).
