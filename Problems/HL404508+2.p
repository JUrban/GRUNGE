...
fof(conj_thm_2Ecardinal_2ECARD__EQ__CONG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V2t] :
                             ...
                             => ! [V3t_27] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),V1s_27))
                                   ...
                                   => ( p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),V2t))
                                    <=> p(ap(ap(c_2Ecardinal_2Ecardeq(A_27b,A_27b),V1s_27),V3t_27)) ) ) ) ) ) ) ) ) ) ) )).
