...
fof(conj_thm_2Erich__list_2ESEG__0__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ! [V2x] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
                   => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0m),c_2Enum_2E0),ap(ap(c_2Elist_2ESNOC(A_27a),V2x),V1l)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0m),c_2Enum_2E0),V1l) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EBUTLASTN__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
