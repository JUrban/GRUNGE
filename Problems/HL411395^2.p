...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__DISJOINT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2EDISJOINT @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) )
        <=> ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
          ( ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) )
            = ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2y ) ) )
...
thf(conj_thm_2Ereal__topology_2EBIGUNION__CONNECTED__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
          = ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal )
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EDELETE @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2y: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ V2y ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2y ) @ V0s ) ) ) ) )
              @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) ) )).
