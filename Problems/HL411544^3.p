...
thf(thm_2Ereal__topology_2EUNIT__INTERVAL__NONEMPTY,axiom,
    ( ( (~)
      @ ( ( c_2Ereal__topology_2ECLOSED__interval @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) )
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
    & ( (~)
      @ ( ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).

thf(thm_2Ereal__topology_2EIMAGE__STRETCH__INTERVAL,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal,V2m: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V3x: tyop_2Erealax_2Ereal] :
            ...
            @ ^ [V4f: tyop_2Erealax_2Ereal] :
                ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V4f @ ( c_2Erealax_2Ereal__mul @ ( V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3x ) ) )
      ...
      = ( c_2Ebool_2ECOND @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2ECLOSED__interval @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal )
        @ ( c_2Ereal__topology_2ECLOSED__interval
          @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
            @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ( c_2Emin_2E_40 @ tyop_2Erealax_2Ereal
                @ ^ [V5f: tyop_2Erealax_2Ereal] :
                    ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V5f @ ( c_2Ereal_2Emin @ ( c_2Erealax_2Ereal__mul @ ( V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0a ) @ ( c_2Erealax_2Ereal__mul @ ( V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1b ) ) ) )
              @ ( c_2Emin_2E_40 @ tyop_2Erealax_2Ereal
                @ ^ [V6f: tyop_2Erealax_2Ereal] :
                    ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V6f @ ( c_2Ereal_2Emax @ ( c_2Erealax_2Ereal__mul @ ( V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0a ) @ ( c_2Erealax_2Ereal__mul @ ( V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1b ) ) ) ) )
            @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSED__INTERVAL__IMAGE__UNIT__INTERVAL,conjecture,(
        ...
        = ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          ...
          @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V3x: tyop_2Erealax_2Ereal] :
                ( c_2Emin_2E_40 @ tyop_2Erealax_2Ereal
                @ ^ [V4f: tyop_2Erealax_2Ereal] :
                    ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V4f @ ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ V1b @ V0a ) @ V3x ) ) )
            @ ( c_2Ereal__topology_2ECLOSED__interval @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) ) ) ) ) )).
