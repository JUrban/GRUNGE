...
thf(thm_2Earithmetic_2EONE__LT__MULT,conjecture,(
    ! [V0x: tyop_2Enum_2Enum,V1y: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2A @ V0x @ V1y ) )
    <=> ( ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0x )
          & ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V1y ) )
        | ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V1y )
          & ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V0x ) ) ) ) )).
