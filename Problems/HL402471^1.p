...
thf(f2871_0_2E0,type,(
    f2871_0_2E0: u )).

thf(f2871_0_2E1,type,(
    f2871_0_2E1: du > u )).

thf(f2871_0_2E2,type,(
    f2871_0_2E2: du > du > u )).

thf(f2871_1_2E0,type,(
    f2871_1_2E0: u )).

thf(f2871_1_2E1,type,(
    f2871_1_2E1: du > u )).

thf(f2871_1_2E2,type,(
    f2871_1_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2871_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( f2871_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ f2871_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2871_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( f2871_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ f2871_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef2871_1_2E1_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( f2871_1_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ f2871_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2871_1_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( f2871_1_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ f2871_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESSES__UEXISTS__THM4,axiom,(
    ! [A_27a: d,A_27c: d,V0i_2E0: u,V3x_2E0: u] :
      ( ( s @ A_27a @ ( f2871_1_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ A_27c @ V3x_2E0 ) ) )
      = ( s @ A_27a @ V0i_2E0 ) ) )).

thf(def1_2Ethm_2EquantHeuristics_2EGUESSES__UEXISTS__THM4,axiom,(
    ! [A_27a: d,A_27b: d,V0i_2E0: u,V2x_2E0: u] :
      ( ( s @ A_27a @ ( f2871_0_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ A_27b @ V2x_2E0 ) ) )
      = ( s @ A_27a @ V0i_2E0 ) ) )).

thf(thm_2EquantHeuristics_2EGUESSES__UEXISTS__THM4,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0i_2E0: u,V1P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( f2871_0_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) )
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( f2871_1_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) )
