...
fof(conj_thm_2Epred__set_2EFUNSET__EMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1f] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V1f),ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),V0s),c_2Epred__set_2EEMPTY(A_27b))))
