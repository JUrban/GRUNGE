...
tff(conj_thm_2Equotient__option_2EOPTION__REL__def,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Equotient__option_2EOPTION__MAP__RSP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs1: $i] :
          ( mem(V1abs1,arr(A_27a,A_27c))
                                     ...
                                     => ! [V8f1: $i] :
                                         ...
                                         => ! [V9f2: $i] :
                                             ...
                                             => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),V3R2),V8f1),V9f2))
                                               ...
                                               => p(ap(ap(ap(c_2Eoption_2EOPTREL(A_27b,A_27b),V3R2),ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V8f1),V6a1)),ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V9f2),V7a2))) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
