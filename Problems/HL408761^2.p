...
thf(conj_thm_2EHolSmt_2Er140,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1u: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3v: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal] :
      ( ( V0a
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V1u ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) @ ( inj__ty_2Erealax_2Ereal @ V4z ) ) ) ) )
    <=> ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1u ) ) @ ( inj__ty_2Erealax_2Ereal @ V2y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4z ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )).
