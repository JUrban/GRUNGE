    ...
    ! [A_27a: del,A_27b: del,V0v: $i] :
     ...
     => ! [V1rows: $i] :
         ...
         => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO @ A_27a @ A_27b ) @ V0v ) @ V1rows ) )
            = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( c_2Epair_2ESND @ bool @ ( ty_2Elist_2Elist @ bool ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX @ A_27a @ A_27b ) @ V0v ) @ V1rows ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( c_2Elist_2ENIL @ bool ) ) ) ) ) ) ) )).

thf(conj_thm_2EpatternMatches_2EEL2__STRONGEST__REDUNDANT__ROWS__INFO__AUX,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rows: $i] :
          ( ( mem @ V1rows @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
         => ! [V2p: $o,V3infos: tp__c_ty_2Elist_2Elist_o,V4i: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2EpatternMatches_2EEL__STRONGEST__REDUNDANT__ROWS__INFO,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rows: $i] :
          ( ( mem @ V1rows @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
              ...
              <=> ( ( p
                    @ ( ap
                      @ ( ap @ ( c_2Elist_2EEVERY @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) )
                        @ ( lam @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) )
                          @ ^ [V3r: $i] :
                              ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27b ) ) @ ( ap @ V3r @ V0v ) ) @ ( c_2Eoption_2ENONE @ A_27b ) ) ) )
