...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__IDEMP,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Ereal__topology_2Econnected__component,ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) ) )).
