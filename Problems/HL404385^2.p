...
thf(conj_thm_2Ecardinal_2ESING__set__exp__CARD,lemma,(
...
thf(conj_thm_2Ecardinal_2Eexp__INSERT__cardeq,lemma,(
...
thf(conj_thm_2Epred__set_2Ecount__EQN,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ...
      = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ ty_2Enum_2Enum @ bool ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Enum_2Enum ) )
        @ ( ap
          @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1p: $i] :
                  ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Enum_2Enum ) @ V1p ) @ ( ap @ c_2Epred__set_2Ecount @ V1p ) ) ) )
...
thf(conj_thm_2Ecardinal_2Eexp__count__cardeq,conjecture,(
    ! [A_27a: del,V0A: $i] :
