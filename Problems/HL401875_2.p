...
tff(conj_thm_2Epred__set_2EPREIMAGE__K,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ap(ap(c_2Epred__set_2EPREIMAGE(A_27b,A_27b),ap(c_2Ecombin_2EK(A_27a,A_27a),V0x)),V1s) = ap(ap(ap(c_2Ebool_2ECOND(arr(A_27b,bool)),ap(ap(c_2Ebool_2EIN(A_27a),V0x),V1s)),c_2Epred__set_2EUNIV(A_27b)),c_2Epred__set_2EEMPTY(A_27b)) ) ) )).
