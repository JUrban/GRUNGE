...
tff(lmtp_f3628,type,(
    f3628: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3628,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : mem(f3628(V1t,V0s,V2x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
tff(lameq_f3628,axiom,(
    ! [V1t: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] : ap(f3628(V1t,V0s,V2x),inj__ty_2Erealax_2Ereal(V3y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3y))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),V1t))) ) ) )).

tff(lmtp_f3627,type,(
    f3627: ( $i * $i ) > $i )).

tff(lamtp_f3627,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3627,axiom,(
    ! [V1t: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3627(V1t,V0s),inj__ty_2Erealax_2Ereal(V2x)) = f3628(V1t,V0s,V2x) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECLOSED__SEQUENTIAL__LIMITS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELIM__SUBSEQUENCE,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V2l: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0s),V1r)),inj__ty_2Erealax_2Ereal(V2l)),c_2Ereal__topology_2Esequentially)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__SUMS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
           ...
           => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3627(V1t,V0s))))) ) ) ) )).
