...
thf(thm_2ETemporal__Logic_2EALWAYS__SIGNAL,axiom,(
    ...
    <=> ! [V2t: tyop_2Enum_2Enum] :
          ( V1a @ ( c_2Earithmetic_2E_2B @ V2t @ V0t0 ) ) ) )).
...
thf(thm_2ETemporal__Logic_2EWHEN__AS__SWHEN,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ...
      = ( ^ [V2t: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ESWHEN @ V1a @ V0b @ V2t )
            @ ( c_2ETemporal__Logic_2EALWAYS
              @ ^ [V3t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_7E @ ( V0b @ V3t ) )
              @ V2t ) ) ) ) )).
...
thf(thm_2EOmega__Automata_2ECO__BUECHI__WHEN__CLOSURE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0t0: tyop_2Enum_2Enum,V1phi: tyop_2Enum_2Enum > $o,V2i: tyop_2Enum_2Enum > A_27a,V3c: A_27b,V4Psi: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V5Phi__R: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V6Phi__I: A_27b > $o] :
      ( ( c_2ETemporal__Logic_2EWHEN
        @ ^ [V7t0: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_3F @ ( tyop_2Enum_2Enum > A_27b )
            @ ^ [V8q: tyop_2Enum_2Enum > A_27b] :
                ( c_2Ebool_2E_2F_5C @ ( V6Phi__I @ ( V8q @ V7t0 ) )
                @ ( c_2Ebool_2E_2F_5C
                  @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                    @ ^ [V9t: tyop_2Enum_2Enum] :
                        ( V5Phi__R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V9t @ V7t0 ) ) @ ( V8q @ ( c_2Earithmetic_2E_2B @ V9t @ V7t0 ) ) ) ) )
                  @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                    @ ^ [V10t1: tyop_2Enum_2Enum] :
                        ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                        @ ^ [V11t2: tyop_2Enum_2Enum] :
                            ( V4Psi @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V10t1 @ ( c_2Earithmetic_2E_2B @ V11t2 @ V7t0 ) ) ) @ ( V8q @ ( c_2Earithmetic_2E_2B @ V10t1 @ ( c_2Earithmetic_2E_2B @ V11t2 @ V7t0 ) ) ) ) ) ) ) ) ) )
        @ V1phi
        @ V0t0 )
    <=> ? [V12p1: tyop_2Enum_2Enum > $o,V13p2: tyop_2Enum_2Enum > $o,V14q: tyop_2Enum_2Enum > A_27b] :
          ( ( ( ( (~) @ ( V12p1 @ V0t0 ) )
              & ( (~) @ ( V13p2 @ V0t0 ) )
              & ( ( V14q @ V0t0 )
                = V3c ) )
          ...
          & ! [V15t: tyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( (~) @ ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                  = V3c )
                & ( (~) @ ( V1phi @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( (~) @ ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
                & ( (~) @ ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
                & ( ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                  = V3c ) )
              | ( ( (~) @ ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( (~) @ ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                ...
                & ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                & ( (~) @ ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
                & ( V6Phi__I @ ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
              | ( ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                & ( (~) @ ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( V1phi @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                & ( V6Phi__I @ ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) )
                & ( V5Phi__R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) @ ( V14q @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) ) ) )
                & ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                & ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
              | ( ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                & ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ V0t0 ) )
                ...
                & ( V12p1 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                & ( V13p2 @ ( c_2Earithmetic_2E_2B @ V15t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
          & ? [V16t1: tyop_2Enum_2Enum] :
            ! [V17t2: tyop_2Enum_2Enum] :
              ( ( (~) @ ( V12p1 @ ( c_2Earithmetic_2E_2B @ V16t1 @ ( c_2Earithmetic_2E_2B @ V17t2 @ V0t0 ) ) ) )
              | ( V4Psi @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V16t1 @ ( c_2Earithmetic_2E_2B @ V17t2 @ V0t0 ) ) ) @ ( V14q @ ( c_2Earithmetic_2E_2B @ V16t1 @ ( c_2Earithmetic_2E_2B @ V17t2 @ V0t0 ) ) ) ) ) ) ) ) )).
