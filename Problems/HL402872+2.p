...
fof(conj_thm_2Erich__list_2EEL__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0n))
           => ! [V1x] :
               ...
               => ! [V2l] :
                   ...
                   => ap(ap(c_2Elist_2EEL(A_27a),V0n),ap(ap(c_2Elist_2ECONS(A_27a),V1x),V2l)) = ap(ap(c_2Elist_2EEL(A_27a),ap(c_2Eprim__rec_2EPRE,V0n)),V2l) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EDROP__EL__CONS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0ls)))
               => ap(ap(c_2Elist_2EDROP(A_27a),V1n),V0ls) = ap(ap(c_2Elist_2ECONS(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V1n),V0ls)),ap(ap(c_2Elist_2EDROP(A_27a),ap(ap(c_2Earithmetic_2E_2B,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0ls)) ) ) ) ) )).
