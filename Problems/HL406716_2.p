...
tff(conj_thm_2EOmega_2Ershadow__row__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1upperc: tp__ty_2Enum_2Enum,V2uppery: tp__ty_2Einteger_2Eint] : p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1upperc)),inj__ty_2Einteger_2Eint(V2uppery))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
          & ! [V3upperc: tp__ty_2Enum_2Enum,V4uppery: tp__ty_2Einteger_2Eint,V5lowerc: tp__ty_2Enum_2Enum,V6lowery: tp__ty_2Einteger_2Eint,V7rs: tp__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint] :
              ( p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3upperc)),inj__ty_2Einteger_2Eint(V4uppery))),inj__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint(V7rs)))
             => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3upperc)),inj__ty_2Einteger_2Eint(V4uppery))),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5lowerc)),inj__ty_2Einteger_2Eint(V6lowery))),inj__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint(V7rs)))) ) )
