...
thf(conj_thm_2Efinite__map_2EFEVERY__o__f,conjecture,(
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Efinite__map_2EFEVERY @ A_27a @ A_27b )
                      @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                        @ ^ [V3x: $i] :
                            ( ap @ V1P @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27c ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V3x ) ) @ ( ap @ V2f @ ( ap @ ( c_2Epair_2ESND @ A_27a @ A_27b ) @ V3x ) ) ) ) ) )
                    @ V0m ) ) ) ) ) ) )).
