...
fof(conj_thm_2Estring_2EisPREFIX__IND,conjecture,(
    ! [V0P] :
               ...
               => ( ! [V3c] :
                     ...
                     => ! [V4t1] :
                         ...
                         => ! [V5t2] :
                             ...
                             => ( ( ap(c_2Estring_2EDEST__STRING,V1s1) = ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(ty_2Estring_2Echar,ty_2Estring_2Echar)),ap(ap(c_2Epair_2E_2C(ty_2Estring_2Echar,ty_2Estring_2Echar),V3c),V4t1))
                                  & ap(c_2Estring_2EDEST__STRING,V2s2) = ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(ty_2Estring_2Echar,ty_2Estring_2Echar)),ap(ap(c_2Epair_2E_2C(ty_2Estring_2Echar,ty_2Estring_2Echar),V3c),V5t2)) )
