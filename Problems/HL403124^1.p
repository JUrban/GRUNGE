...
thf(f3705_0_2E0,type,(
    f3705_0_2E0: u )).

thf(f3705_0_2E1,type,(
    f3705_0_2E1: du > u )).

thf(f3705_0_2E2,type,(
    f3705_0_2E2: du > du > u )).
...
thf(mono_2Ef3705_0,type,(
    mono_2Ef3705_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EUNTIL__AS__SBEFORE,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3705_0 @ V1a @ V3t )
    <=> ( (~) @ ( V1a @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EUNTIL__AS__SBEFORE,conjecture,(
    ...
    <=> ( (~) @ ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ ( mono_2Ef3705_0 @ V1a ) @ V0b @ V2x ) ) ) )).
