...
fof(conj_thm_2Edivides_2EONE__LT__PRIME,lemma,(
    ! [V0p] :
...
fof(conj_thm_2EprimeFactor_2EPRIME__FACTORIZATION,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2EprimeFactor_2EFACTORS__prime,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ( p(ap(c_2Edivides_2Eprime,V0p))
