...
thf(f3509_0_2E0,type,(
    f3509_0_2E0: u )).

thf(f3509_0_2E2,type,(
    f3509_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3509_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3509_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f3509_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__APPEND__SEM,axiom,(
    ! [A_27a: d,A_27b: d,V1rows1_2E0: u,V0v_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3509_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V1rows1_2E0 ) @ ( s @ A_27a @ V0v_2E0 ) ) ) )
    <=> ? [V3r_2E0: u] :
