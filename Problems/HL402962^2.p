...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__SUBSUMED,lemma,(
                                  ...
                                  @ ( ap
                                    @ ( ap @ ( c_2Elist_2EEVERY @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) )
                                      @ ( lam @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) )
                                        @ ^ [V7row: $i] :
                                            ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27b ) ) @ ( ap @ V7row @ V5v ) ) @ ( c_2Eoption_2ENONE @ A_27b ) ) ) )
                                    @ V3rows2 ) ) ) )
...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__SUBSUMED__PMATCH__ROWS,conjecture,(
