...
thf(c_2Efcp_2Edest__cart,type,(
    c_2Efcp_2Edest__cart: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) > ( tyop_2Efcp_2Efinite__image @ A_27b ) > A_27a ) )).

thf(c_2Efcp_2Edest__finite__image,type,(
    c_2Efcp_2Edest__finite__image: 
      !>[A_27a: $tType] :
...
thf(c_2Efcp_2Efinite__index,type,(
    c_2Efcp_2Efinite__index: 
      !>[A_27a: $tType] :
...
thf(c_2Efcp_2Emk__cart,type,(
    c_2Efcp_2Emk__cart: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( ( tyop_2Efcp_2Efinite__image @ A_27b ) > A_27a ) > ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) ) )).

thf(c_2Efcp_2Emk__finite__image,type,(
    c_2Efcp_2Emk__finite__image: 
      !>[A_27a: $tType] :
...
thf(thm_2Efcp_2EHAS__SIZE__def,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Efcp_2EHAS__SIZE @ A_27a @ V0s @ V1n )
...
thf(thm_2Efcp_2Efinite__image__tybij,axiom,(
    ! [A_27a: $tType] :
      ( ! [V0a: tyop_2Efcp_2Efinite__image @ A_27a] :
          ( ( c_2Efcp_2Emk__finite__image @ A_27a @ ( c_2Efcp_2Edest__finite__image @ A_27a @ V0a ) )
          = V0a )
      & ! [V1r: A_27a] :
          ( ( ^ [V2x: A_27a] :
                ( c_2Ebool_2E_5C_2F @ ( c_2Emin_2E_3D @ A_27a @ V2x @ ( c_2Ebool_2EARB @ A_27a ) ) @ ( c_2Epred__set_2EFINITE @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) ) )
            @ V1r )
        <=> ( ( c_2Efcp_2Edest__finite__image @ A_27a @ ( c_2Efcp_2Emk__finite__image @ A_27a @ V1r ) )
            = V1r ) ) ) )).

thf(thm_2Efcp_2Edimindex__def,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) )
      = ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EFINITE @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) ) @ ( c_2Epred__set_2ECARD @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )).
        ...
        @ ^ [V0f: tyop_2Enum_2Enum > A_27a] :
            ...
            @ ^ [V1x: A_27a] :
                ...
                @ ^ [V2n: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( c_2Eprim__rec_2E_3C @ V2n @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( c_2Emin_2E_3D @ A_27a @ ( V0f @ V2n ) @ V1x ) ) ) ) ) ) )).

thf(thm_2Efcp_2Ecart__tybij,axiom,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ! [V0a: tyop_2Efcp_2Ecart @ A_27a @ A_27b] :
          ( ( c_2Efcp_2Emk__cart @ A_27a @ A_27b @ ( c_2Efcp_2Edest__cart @ A_27a @ A_27b @ V0a ) )
          = V0a )
      & ! [V1r: ( tyop_2Efcp_2Efinite__image @ A_27b ) > A_27a] :
          ( ( ^ [V2f: ( tyop_2Efcp_2Efinite__image @ A_27b ) > A_27a] : c_2Ebool_2ET
            @ V1r )
        <=> ( ( c_2Efcp_2Edest__cart @ A_27a @ A_27b @ ( c_2Efcp_2Emk__cart @ A_27a @ A_27b @ V1r ) )
            = V1r ) ) ) )).

thf(thm_2Efcp_2Efcp__index,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0x: tyop_2Efcp_2Ecart @ A_27a @ A_27b,V1i: tyop_2Enum_2Enum] :
      ( ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V0x @ V1i )
      = ( c_2Efcp_2Edest__cart @ A_27a @ A_27b @ V0x @ ( c_2Efcp_2Efinite__index @ ( tyop_2Efcp_2Efinite__image @ A_27b ) @ V1i ) ) ) )).

thf(thm_2Efcp_2EFCP,axiom,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ( c_2Efcp_2EFCP @ A_27a @ A_27b )
      = ( ^ [V0g: tyop_2Enum_2Enum > A_27a] :
            ( c_2Emin_2E_40 @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b )
            @ ^ [V1f: tyop_2Efcp_2Ecart @ A_27a @ A_27b] :
                ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                @ ^ [V2i: tyop_2Enum_2Enum] :
                    ( c_2Emin_2E_3D_3D_3E @ ( c_2Eprim__rec_2E_3C @ V2i @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) @ ( c_2Emin_2E_3D @ A_27a @ ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V1f @ V2i ) @ ( V0g @ V2i ) ) ) ) ) ) ) )).
...
thf(thm_2Efcp_2EFCP__BETA,conjecture,(
