...
thf(conj_thm_2Ellist_2ELHD__LGENLIST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ! [V1limopt: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
          ( ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V0f ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V1limopt ) ) )
          = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V1limopt ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( c_2Eoption_2ENONE @ A_27a ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
