...
thf(conj_thm_2Etransc_2EEXP__FDIFF,conjecture,
    ( ( ap @ c_2Epowser_2Ediffs
      @ ( lam @ ty_2Enum_2Enum
        @ ^ [V0n: $i] :
            ( ap @ c_2Erealax_2Einv @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V0n ) ) ) ) )
    = ( lam @ ty_2Enum_2Enum
      @ ^ [V1n: $i] :
          ( ap @ c_2Erealax_2Einv @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V1n ) ) ) ) )).
