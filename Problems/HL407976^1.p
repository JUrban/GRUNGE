...
thf(f9408_0_2E0,type,(
    f9408_0_2E0: u )).

thf(f9408_0_2E1,type,(
    f9408_0_2E1: du > u )).

thf(f9408_0_2E2,type,(
    f9408_0_2E2: du > du > u )).
...
thf(mono_2Ef9408_0,type,(
    mono_2Ef9408_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Eseq_2Elim,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9408_0 @ V0f @ V1l )
      = ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ V1l ) ) )).

thf(thm_2Eseq_2Elim,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Elim @ V0f )
      = ( mono_2Ec_2Emin_2E_40_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9408_0 @ V0f ) ) ) )).

thf(thm_2Eseq_2ESEQ__LIM,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Econvergent @ V0f )
