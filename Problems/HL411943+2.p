...
fof(conj_thm_2Ereal__topology_2EOPEN__UNIV,lemma,(
    p(ap(c_2Ereal__topology_2EOpen,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).

fof(conj_thm_2Ereal__topology_2EOPEN__IN__INTER__OPEN,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__COMPACT__SUBOPEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
      <=> ! [V1k] :
           ...
           => ! [V2t] :
               ...
               => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1k),V0s))
                    ...
                    & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1k),V2t)) )
                 => ? [V3u] :
                      ( mem(V3u,arr(ty_2Erealax_2Ereal,bool))
                      & ? [V4v] :
                          ( mem(V4v,arr(ty_2Erealax_2Ereal,bool))
                          & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1k),V3u))
                          & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3u),V4v))
                          & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3u),V2t))
                          & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V4v),V0s))
                          & p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0s)),V3u))
                          & p(ap(c_2Ereal__topology_2Ecompact,V4v)) ) ) ) ) ) ) ) )).
