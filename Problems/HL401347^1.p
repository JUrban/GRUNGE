...
thf(thm_2Elogroot_2ELOG__LE__MONO,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum,V2y: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1x @ V2y )
       => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Elogroot_2ELOG @ V0a @ V1x ) @ ( mono_2Ec_2Elogroot_2ELOG @ V0a @ V2y ) ) ) ) )).
