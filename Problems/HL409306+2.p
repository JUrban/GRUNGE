...
fof(mem_c_2Ebinary__ieee_2Eis__closest,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),arr(arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool),arr(ty_2Erealax_2Ereal,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool)))) ) ) )).
         ...
         => ! [V0s] :
             ...
             => ! [V1x] :
                 ...
                 => ! [V2a] :
                     ...
                     => ( p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V0s),V1x),V2a))
                      <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V2a),V0s))
                          & ! [V3b] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V3b),V0s))
                               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V2a)),V1x))),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V3b)),V1x)))) ) ) ) ) ) ) ) ) ) )).

fof(lamtp_f3041,axiom,(
    ! [A_27b,A_27a,A_27a,A_27b,V2x] :
         ...
         => ! [V0p] :
             ...
             => ! [V3a] :
                 ...
                 => ! [V4b] :
                     ...
                     => ap(f3041(A_27b,A_27a,A_27a,A_27b,V2x,V1s,V0p,V3a),V4b) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),V2x),V4b)),ap(V0p,V4b))),ap(V0p,V3a)) ) ) ) ) ) )).

fof(lamtp_f3040,axiom,(
    ! [A_27b,A_27a,A_27b,A_27a,V0p] :
     ...
     => ! [V1s] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => mem(f3040(A_27b,A_27a,A_27b,A_27a,V0p,V1s,V2x),arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool)) ) ) ) )).
    ...
    ! [A_27b,A_27a,A_27b,A_27a,V0p] :
     ...
     => ! [V1s] :
         ...
         => ! [V2x] :
             ...
             => ! [V3a] :
                  ( mem(V3a,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
                 => ap(f3040(A_27b,A_27a,A_27b,A_27a,V0p,V1s,V2x),V3a) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),V2x),V3a)),ap(c_2Ebool_2E_21(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3041(A_27b,A_27a,A_27a,A_27b,V2x,V1s,V0p,V3a))) ) ) ) ) )).
     ...
     => ! [A_27b] :
         ...
         => ! [V0p] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,ty_2Erealax_2Ereal)
                     => ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),V2x) = ap(c_2Emin_2E_40(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3040(A_27b,A_27a,A_27b,A_27a,V0p,V1s,V2x)) ) ) ) ) ) )).
...
fof(conj_thm_2Elift__ieee_2Efinite__float__within__threshold,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
              ( mem(V0f,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
             => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0f))
               => ( ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0f)),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Ethreshold(A_27a,A_27a),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27a,A_27a))))))
                  & ~ p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0f)),ap(c_2Ebinary__ieee_2Ethreshold(A_27a,A_27a),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27a,A_27a))))) ) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Eround__finite__normal__float__id,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
              ( mem(V0f,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
             => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0f))
                  & ~ p(ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27a,A_27a),V0f)) )
               => ap(ap(c_2Ebinary__ieee_2Eround(A_27a,A_27a),c_2Ebinary__ieee_2EroundTiesToEven),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0f)) = V0f ) ) ) ) )).
