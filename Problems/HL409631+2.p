...
fof(conj_thm_2Eiterate_2EREAL__LE__SUP__FINITE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Eiterate_2EREAL__SUP__LE__FINITE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eiterate_2ESUP__UNIQUE__FINITE,conjecture,(
    ! [V0a] :
