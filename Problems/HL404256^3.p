...
thf(thm_2EDecode_2Edecode__dec2enc,conjecture,(
    ! [A_27a: $tType,V0p: A_27a > $o,V1d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ),V2x: A_27a] :
      ( ( ( c_2EDecode_2Ewf__decoder @ A_27a @ V0p @ V1d )
        & ( V0p @ V2x ) )
     => ( ( V1d @ ( c_2EDecode_2Edec2enc @ A_27a @ V1d @ V2x ) )
        = ( c_2Eoption_2ESOME @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) @ ( c_2Epair_2E_2C @ A_27a @ ( tyop_2Elist_2Elist @ $o ) @ V2x @ ( c_2Elist_2ENIL @ $o ) ) ) ) ) )).
