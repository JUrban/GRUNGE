...
tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__CONST,lemma,(
...
tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lameq_f3435,axiom,(
    ! [V4p: $i] :
      ( mem(V4p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V5q: $i] :
          ( mem(V5q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3435(V4p,V5q),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Erealax_2Ereal__add,ap(V4p,inj__ty_2Erealax_2Ereal(V6x))),ap(V5q,inj__ty_2Erealax_2Ereal(V6x))) ) ) )).

tff(lmtp_f3436,type,(
    f3436: ( $i * $i ) > $i )).

tff(lamtp_f3436,axiom,(
    ! [V7p: $i] :
...
tff(lameq_f3436,axiom,(
    ! [V7p: $i] :
      ( mem(V7p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V8q: $i] :
          ( mem(V8q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V9x: tp__ty_2Erealax_2Ereal] : ap(f3436(V7p,V8q),inj__ty_2Erealax_2Ereal(V9x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V7p,inj__ty_2Erealax_2Ereal(V9x))),ap(V8q,inj__ty_2Erealax_2Ereal(V9x))) ) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__o,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
