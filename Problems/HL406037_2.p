...
tff(mem_c_2Ewords_2Eword__mod,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__mod(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(conj_thm_2Ewords_2EWORD__MOD__POW2,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Efcp_2Ecart(bool,bool))
