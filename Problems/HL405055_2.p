...
tff(lmtp_f2029,type,(
    f2029: ( del * del * $i * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2029,axiom,(
    ! [A_27b: del,A_27a: del,V7q: $i] :
     ...
     => ! [V6t0: tp__ty_2Enum_2Enum,V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
             ...
             => mem(f2029(A_27b,A_27a,V7q,V6t0,V2i,V1Phi__R),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2029,axiom,(
    ! [A_27b: del,A_27a: del,V7q: $i] :
     ...
     => ! [V6t0: tp__ty_2Enum_2Enum,V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
              ( mem(V1Phi__R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ! [V8t: tp__ty_2Enum_2Enum] : ap(f2029(A_27b,A_27a,V7q,V6t0,V2i,V1Phi__R),inj__ty_2Enum_2Enum(V8t)) = ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V8t)),inj__ty_2Enum_2Enum(V6t0)))),ap(V7q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V8t)),inj__ty_2Enum_2Enum(V6t0))))) ) ) ) )).

tff(lmtp_f2031,type,(
    f2031: ( del * del * $i * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2031,axiom,(
    ! [A_27b: del,A_27a: del,V7q: $i] :
      ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V6t0: tp__ty_2Enum_2Enum,V9t1: tp__ty_2Enum_2Enum,V2i: $i] :
         ...
         => ! [V3Psi: $i] :
             ...
             => mem(f2031(A_27b,A_27a,V7q,V6t0,V9t1,V2i,V3Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V3Psi: $i] :
     ...
     => ! [V2i: $i] :
         ...
         => ! [V6t0: tp__ty_2Enum_2Enum,V7q: $i] :
              ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
             => mem(f2030(A_27b,A_27a,V3Psi,V2i,V6t0,V7q),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2030,axiom,(
    ! [A_27b: del,A_27a: del,V3Psi: $i] :
     ...
     => ! [V2i: $i] :
         ...
         => ! [V6t0: tp__ty_2Enum_2Enum,V7q: $i] :
              ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
             => ! [V9t1: tp__ty_2Enum_2Enum] : ap(f2030(A_27b,A_27a,V3Psi,V2i,V6t0,V7q),inj__ty_2Enum_2Enum(V9t1)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2031(A_27b,A_27a,V7q,V6t0,V9t1,V2i,V3Psi)) ) ) ) )).

tff(lmtp_f2028,type,(
    f2028: ( del * del * $i * $i * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2028,axiom,(
     ...
     => ! [V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
             ...
             => ! [V0Phi__I: $i] :
                 ...
                 => ! [V6t0: tp__ty_2Enum_2Enum] : mem(f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) )).
     ...
     => ! [V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
             ...
             => ! [V0Phi__I: $i] :
                 ...
                 => ! [V6t0: tp__ty_2Enum_2Enum,V7q: $i] :
                      ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
                     => ap(f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0),V7q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0Phi__I,ap(V7q,inj__ty_2Enum_2Enum(V6t0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2029(A_27b,A_27a,V7q,V6t0,V2i,V1Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2030(A_27b,A_27a,V3Psi,V2i,V6t0,V7q)))) ) ) ) ) ) )).

tff(lmtp_f2027,type,(
    f2027: ( del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f2027,axiom,(
    ! [A_27b: del,A_27a: del,V0Phi__I: $i] :
     ...
     => ! [V1Phi__R: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3Psi: $i] :
                  ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => mem(f2027(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V0Phi__I: $i] :
     ...
     => ! [V1Phi__R: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3Psi: $i] :
                  ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => ! [V6t0: tp__ty_2Enum_2Enum] : ap(f2027(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),inj__ty_2Enum_2Enum(V6t0)) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0)) ) ) ) ) )).

tff(conj_thm_2EOmega__Automata_2ECO__BUECHI__NEXT__CLOSURE,conjecture,(
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3Psi: $i] :
                 ...
                 => ! [V4t0: tp__ty_2Enum_2Enum,V5c: $i] :
                      ( mem(V5c,A_27b)
                     => ( p(ap(ap(c_2ETemporal__Logic_2ENEXT,f2027(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),inj__ty_2Enum_2Enum(V4t0)))
                      <=> ? [V11p: $i] :
                            ...
                            & ? [V12q: $i] :
                                ...
                                & ! [V13t: tp__ty_2Enum_2Enum] :
                                    ...
                                    | ( p(ap(V11p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V13t)),inj__ty_2Enum_2Enum(V4t0))))
                                      & p(ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V13t)),inj__ty_2Enum_2Enum(V4t0)))),ap(V12q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V13t)),inj__ty_2Enum_2Enum(V4t0))))))
                                      & p(ap(V11p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V13t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) )
                                & ? [V14t1: tp__ty_2Enum_2Enum] :
                                  ! [V15t2: tp__ty_2Enum_2Enum] : p(ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t2)),inj__ty_2Enum_2Enum(V4t0))))),ap(V12q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t2)),inj__ty_2Enum_2Enum(V4t0))))))) ) ) ) ) ) ) ) ) )).
