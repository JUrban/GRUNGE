...
thf(conj_thm_2Ereal_2EREAL__SUB__LNEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
...
thf(conj_thm_2Ereal_2ESUM__NEG,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2d: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2d ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3n: $i] :
                    ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V0f @ V3n ) ) ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2d ) ) ) @ V0f ) ) ) ) ) )).
...
thf(conj_thm_2Eintegral_2EDINT__NEG,conjecture,(
    ! [V0f: $i] :
         ...
         => ( p
            @ ( ap
              @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V4x: $i] :
                      ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V0f @ V4x ) ) ) )
              @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V3i ) ) ) ) ) ) )).
