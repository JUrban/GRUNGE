...
thf(f1294_0_2E0,type,(
    f1294_0_2E0: u )).

thf(f1294_0_2E1,type,(
    f1294_0_2E1: du > u )).

thf(f1294_0_2E2,type,(
    f1294_0_2E2: du > du > u )).
...
thf(c_2Edivides_2EPRIMES_2E0,type,(
    c_2Edivides_2EPRIMES_2E0: u )).

thf(c_2Edivides_2EPRIMES_2E1,type,(
    c_2Edivides_2EPRIMES_2E1: du > u )).
...
thf(mono_2Ef1294_0,type,(
    mono_2Ef1294_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(mono_2Ec_2Edivides_2EPRIMES,type,(
    mono_2Ec_2Edivides_2EPRIMES: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(def0_2Ethm_2Edivides_2EPRIMES__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1294_0 @ V0n @ V1p )
    <=> ( ( mono_2Ec_2Edivides_2Eprime @ V1p )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Edivides_2EPRIMES @ V0n ) @ V1p ) ) ) )).

thf(thm_2Edivides_2EPRIMES__def,axiom,
    ( ( ( mono_2Ec_2Edivides_2EPRIMES @ mono_2Ec_2Enum_2E0 )
    ...
    & ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ...
        = ( mono_2Ec_2Ewhile_2ELEAST @ ( mono_2Ef1294_0 @ V0n ) ) ) )).

thf(thm_2Edivides_2ENEXT__LARGER__PRIME,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
    ? [V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0n @ ( mono_2Ec_2Edivides_2EPRIMES @ V1i ) )
      & ! [V2j: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2j @ V1i )
         => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Edivides_2EPRIMES @ V2j ) @ V0n ) ) ) )).

thf(thm_2Edivides_2EPRIMES__NO__GAP,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1p: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Edivides_2EPRIMES @ V0n ) @ V1p )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ V1p @ ( mono_2Ec_2Edivides_2EPRIMES @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) )
        & ( mono_2Ec_2Edivides_2Eprime @ V1p ) )
     => mono_2Ec_2Ebool_2EF ) )).
...
thf(thm_2Edivides_2EPRIMES__ONTO,conjecture,(
    ! [V0p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Edivides_2Eprime @ V0p )
     => ? [V1i: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Edivides_2EPRIMES @ V1i )
          = V0p ) ) )).
