...
fof(conj_thm_2Ecardinal_2EFINITE__IMAGE__INJ__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( ! [V2x] :
                       ...
                       => ! [V3y] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                             ...
                             => V2x = V3y ) ) )
                   => ( p(ap(c_2Epred__set_2EFINITE(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))
                    <=> p(ap(c_2Epred__set_2EFINITE(A_27a),V1s)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eiterate_2EITERATE__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
