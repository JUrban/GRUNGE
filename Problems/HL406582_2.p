...
tff(conj_thm_2Esptree_2EfromAList__ind,conjecture,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ( ( p(ap(V0P,c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
          & ! [V1x: tp__ty_2Enum_2Enum,V2y: $i] :
             ...
             => ! [V3xs: $i] :
                 ...
                 => ( p(ap(V0P,V3xs))
                   => p(ap(V0P,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),V2y)),V3xs))) ) ) ) )
       => ! [V4v: $i] :
