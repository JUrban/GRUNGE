...
thf(conj_thm_2Erealax_2ETREAL__ADD__LINV,lemma,(
...
thf(conj_thm_2Erealax_2ETREAL__NEG__WELLDEF,lemma,(
...
thf(ax_thm_2Erealax_2Ereal__neg,axiom,(
    ! [V0T1: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__ABS @ ( ap @ c_2Erealax_2Etreal__neg @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) ) ) ) ) )).
...
thf(conj_thm_2Erealax_2EREAL__ADD__LINV,conjecture,(
