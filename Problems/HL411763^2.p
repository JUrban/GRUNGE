...
thf(conj_thm_2Ereal__topology_2ESERIES__SUBSET,conjecture,(
    ! [V0x: $i] :
                      ...
                      @ ( ap
                        @ ( ap
                          @ ( ap @ c_2Ereal__topology_2Esums
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V4i: $i] :
                                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V4i ) @ V1s ) ) @ ( ap @ V0x @ V4i ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
