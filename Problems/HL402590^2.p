...
thf(conj_thm_2Erich__list_2EFILTER__FOLDL,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ V1l )
            = ( ap
              @ ( ap
                @ ( ap @ ( c_2Elist_2EFOLDL @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) )
                  @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                    @ ^ [V2l_27: $i] :
                        ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ V0P @ V3x ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V3x ) @ V2l_27 ) ) @ V2l_27 ) ) ) )
                @ ( c_2Elist_2ENIL @ A_27a ) )
              @ V1l ) ) ) ) )).
