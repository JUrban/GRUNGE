...
fof(lameq_f2212,axiom,(
    ! [A_27a,V1n] :
     ...
     => ! [V0w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2212(A_27a,V1n,V0w),V2i) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(ap(c_2Earithmetic_2E_2B,V2i),V1n))),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2B,V2i),V1n))) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__asr__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),V1n) = ap(c_2Efcp_2EFCP(bool,bool),f2212(A_27a,V1n,V0w)) ) ) ) )).
...
fof(conj_thm_2Ewords_2EASR__LIMIT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1n] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V1n))
               => ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),V1n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),c_2Ewords_2Eword__T(A_27a)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)) ) ) ) ) )).

fof(conj_thm_2Ewords_2ELSR__LIMIT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2ELSL__UINT__MAX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__asr__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
