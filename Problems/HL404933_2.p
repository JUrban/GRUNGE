...
tff(conj_thm_2Epred__set_2EDIFF__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Etopology_2EOPEN__IN__EMPTY,lemma,(
    ! [A_27a: del,V0top: $i] :
...
tff(conj_thm_2Etopology_2ECLOSED__IN__TOPSPACE,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
