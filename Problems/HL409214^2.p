...
thf(conj_thm_2Eintegral_2EDINT__SUB,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
             ...
             => ( p
                @ ( ap
                  @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V6x: $i] :
                          ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V6x ) ) @ ( ap @ V1g @ V6x ) ) ) )
                  @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V4i ) ) @ ( inj__ty_2Erealax_2Ereal @ V5j ) ) ) ) ) ) ) )).
