...
thf(thm_2EHolSmt_2ENOT__MEM__CONS,conjecture,(
    ! [A_27a: $tType,V0x: A_27a,V1h: A_27a,V2t: tyop_2Elist_2Elist @ A_27a] :
      ( ( (~) @ ( c_2Ebool_2EIN @ A_27a @ V0x @ ( c_2Elist_2ELIST__TO__SET @ A_27a @ ( c_2Elist_2ECONS @ A_27a @ V1h @ V2t ) ) ) )
    <=> ( ( (~) @ ( V0x = V1h ) )
        & ( (~) @ ( c_2Ebool_2EIN @ A_27a @ V0x @ ( c_2Elist_2ELIST__TO__SET @ A_27a @ V2t ) ) ) ) ) )).
