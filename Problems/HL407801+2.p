...
fof(conj_thm_2Einteger_2EINT__LT__ANTISYM,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__SUB__0,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Efrac_2EFRAC__SUB__CALCULATE,lemma,(
    ! [V0a1] :
...
fof(conj_thm_2Erat_2ERAT__SUB__CALCULATE,lemma,(
    ! [V0f1] :
      ( mem(V0f1,ty_2Efrac_2Efrac)
     => ! [V1f2] :
...
fof(conj_thm_2Erat_2ERAT__0LES__NMR,conjecture,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
