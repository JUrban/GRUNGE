...
fof(conj_thm_2Etopology_2EOPEN__IN__CLOSED__IN__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
...
fof(conj_thm_2Etopology_2EOPEN__IN__DIFF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
...
fof(conj_thm_2Ereal__topology_2EOPEN__IN__REFL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__REFL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     ...
     => ! [V0f] :
         ...
         => ! [V4u] :
             ...
             => ! [V5x] :
                 ...
                 => ap(f3925(V2s,V0f,V4u),V5x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V2s)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0f,V5x)),V4u))) ) ) ) ) )).

fof(lamtp_f3926,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V6u] :
     ...
     => ! [V6u] :
         ...
         => ! [V0f] :
             ...
             => ! [V7x] :
                 ...
                 => ap(f3926(V2s,V6u,V0f),V7x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V7x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(V0f,V7x)),V6u)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EUPPER__HEMICONTINUOUS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t] :
         ...
         => ! [V2s] :
             ...
             => ( ! [V3x] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V2s))
                     => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0f,V3x)),V1t)) ) )
               => ( ! [V4u] :
                      ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
