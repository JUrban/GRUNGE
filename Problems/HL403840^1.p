...
thf(thm_2Ellist_2ELTAKE__EQ__SOME__CONS,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1l_2E0: u,V2x_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2x_2E0 ) ) ) )
     => ! [V3h_2E0: u] :
        ? [V4y_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V3h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4y_2E0 ) ) ) ) ) )).
