...
tff(conj_thm_2EEncodeVar_2Eof__length__exists__zero,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ( p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),f2445(A_27a,V0phi)))
