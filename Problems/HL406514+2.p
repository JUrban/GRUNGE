...
fof(conj_thm_2Ebitstring_2Eword__concat__v2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0v1] :
                 ...
                 => ! [V1v2] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
                       ...
                       => ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),V0v1)),ap(c_2Ebitstring_2Ev2w(A_27b),V1v2)) = ap(c_2Ebitstring_2Ev2w(A_27c),ap(ap(c_2Ebitstring_2Efixwidth,ap(ap(c_2Earithmetic_2EMIN,ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))),ap(ap(c_2Elist_2EAPPEND(bool),V0v1),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),V1v2)))) ) ) ) ) ) ) )).

fof(conj_thm_2Ebitstring_2Eword__concat__v2w__rwt,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0bad_20domain] :
                 ...
                 => ! [V1v1] :
                     ...
                     => ! [V2v2] :
                         ...
                         => ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),V1v1)),ap(c_2Ebitstring_2Ev2w(A_27b),V2v2)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a))),ap(c_2Epred__set_2EFINITE(A_27b),c_2Epred__set_2EUNIV(A_27b)))),ap(c_2Ebitstring_2Ev2w(A_27c),ap(ap(c_2Ebitstring_2Efixwidth,ap(ap(c_2Earithmetic_2EMIN,ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))),ap(ap(c_2Elist_2EAPPEND(bool),V1v1),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),V2v2))))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))),c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a)),V0bad_20domain),ap(c_2Ebitstring_2Ev2w(A_27a),V1v1)),ap(c_2Ebitstring_2Ev2w(A_27b),V2v2))) ) ) ) ) ) ) )).
