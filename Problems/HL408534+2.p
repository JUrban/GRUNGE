...
fof(conj_thm_2Ebinary__ieee_2Einfinity__properties,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardNegative__minus__infinity,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0y] :
             ...
             => ! [V1x] :
                 ...
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,V1x),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))
                   => ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardNegative),V1x) = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardNegative__minus__infinity,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
             ...
             => ! [V1y] :
                 ...
                 => ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Erealax_2Ereal__lt,V2x),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))
                       => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardNegative),V0b),V2x) = ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) ) )).
