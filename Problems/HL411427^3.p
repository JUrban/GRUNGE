...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIQUE,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal > $o,V2x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V1c )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1c @ V0s )
        & ( c_2Ereal__topology_2Econnected @ V1c )
        & ! [V3c_27: tyop_2Erealax_2Ereal > $o] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V3c_27 )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3c_27 @ V0s )
              & ( c_2Ereal__topology_2Econnected @ V3c_27 ) )
           => ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3c_27 @ V1c ) ) )
     => ( ( c_2Ereal__topology_2Econnected__component @ V0s @ V2x )
        = V1c ) ) )).

thf(thm_2Ereal__topology_2EIN__COMPONENTS,axiom,(
    ! [V0u: tyop_2Erealax_2Ereal > $o,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ ( c_2Ereal__topology_2Ecomponents @ V0u ) )
    <=> ? [V2x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0u )
          & ( V1s
            = ( c_2Ereal__topology_2Econnected__component @ V0u @ V2x ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPONENTS__UNIQUE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1k: ( tyop_2Erealax_2Ereal > $o ) > $o] :
      ( ( ( ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V1k )
          = V0s )
        & ! [V2c: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2c @ V1k )
           => ( ( c_2Ereal__topology_2Econnected @ V2c )
              & ( (~)
                @ ( V2c
                  = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
              & ! [V3c_27: tyop_2Erealax_2Ereal > $o] :
                  ( ( ( c_2Ereal__topology_2Econnected @ V3c_27 )
                    & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2c @ V3c_27 )
                    & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3c_27 @ V0s ) )
                 => ( V3c_27 = V2c ) ) ) ) )
