...
tff(lamtp_f1553,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => mem(f1553(V1b,V2c,V0a),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1553,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1553(V1b,V2c,V0a),inj__ty_2Enum_2Enum(V5t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V1b),inj__ty_2Enum_2Enum(V5t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V2c),inj__ty_2Enum_2Enum(V5t))) ) ) ) )).

tff(lmtp_f1554,type,(
    f1554: ( $i * $i ) > $i )).

tff(lamtp_f1554,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1554(V1b,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1554,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V6t: tp__ty_2Enum_2Enum] : ap(f1554(V1b,V2c),inj__ty_2Enum_2Enum(V6t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V6t))),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),inj__ty_2Enum_2Enum(V6t))) ) ) )).

tff(lmtp_f1556,type,(
    f1556: ( $i * $i * $i ) > $i )).

tff(lamtp_f1556,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => mem(f1556(V1b,V2c,V0a),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1556,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => ! [V8t: tp__ty_2Enum_2Enum] : ap(f1556(V1b,V2c,V0a),inj__ty_2Enum_2Enum(V8t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V8t))),ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,inj__ty_2Enum_2Enum(V8t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),inj__ty_2Enum_2Enum(V8t)))) ) ) ) )).

tff(lmtp_f1555,type,(
    f1555: ( $i * $i * $i ) > $i )).

tff(lamtp_f1555,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => mem(f1555(V0a,V2c,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1555,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1555(V0a,V2c,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V7t))),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),inj__ty_2Enum_2Enum(V7t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1556(V1b,V2c,V0a)),inj__ty_2Enum_2Enum(V7t))) ) ) ) )).

tff(lmtp_f1557,type,(
    f1557: ( $i * $i ) > $i )).

tff(lamtp_f1557,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1557(V1b,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1557,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V9t: tp__ty_2Enum_2Enum] : ap(f1557(V1b,V2c),inj__ty_2Enum_2Enum(V9t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V9t))),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V2c),inj__ty_2Enum_2Enum(V9t))) ) ) )).

tff(lmtp_f1559,type,(
    f1559: ( $i * $i * $i ) > $i )).

tff(lamtp_f1559,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => mem(f1559(V1b,V2c,V0a),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1559,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => ! [V11t: tp__ty_2Enum_2Enum] : ap(f1559(V1b,V2c,V0a),inj__ty_2Enum_2Enum(V11t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V11t))),ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,inj__ty_2Enum_2Enum(V11t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),inj__ty_2Enum_2Enum(V11t)))) ) ) ) )).

tff(lmtp_f1558,type,(
    f1558: ( $i * $i * $i ) > $i )).

tff(lamtp_f1558,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => mem(f1558(V0a,V2c,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1558,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V10t: tp__ty_2Enum_2Enum] : ap(f1558(V0a,V2c,V1b),inj__ty_2Enum_2Enum(V10t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V10t))),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V2c),inj__ty_2Enum_2Enum(V10t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1559(V1b,V2c,V0a)),inj__ty_2Enum_2Enum(V10t))) ) ) ) )).

tff(lmtp_f1560,type,(
    f1560: ( $i * $i * $i ) > $i )).

tff(lamtp_f1560,axiom,(
    ! [V2c: $i] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => mem(f1560(V2c,V3d,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1560,axiom,(
    ! [V2c: $i] :
     ...
     => ! [V3d: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V12t: tp__ty_2Enum_2Enum] : ap(f1560(V2c,V3d,V1b),inj__ty_2Enum_2Enum(V12t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V12t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V2c),V3d),inj__ty_2Enum_2Enum(V12t))) ) ) ) )).

tff(lmtp_f1562,type,(
    f1562: ( $i * $i ) > $i )).

tff(lamtp_f1562,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1562(V0a,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1562,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V14t: tp__ty_2Enum_2Enum] : ap(f1562(V0a,V2c),inj__ty_2Enum_2Enum(V14t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V14t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),inj__ty_2Enum_2Enum(V14t))) ) ) )).

tff(lmtp_f1564,type,(
    f1564: ( $i * $i ) > $i )).

tff(lamtp_f1564,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1564(V0a,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1564,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V16t: tp__ty_2Enum_2Enum] : ap(f1564(V0a,V2c),inj__ty_2Enum_2Enum(V16t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V16t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),inj__ty_2Enum_2Enum(V16t))) ) ) )).

tff(lmtp_f1563,type,(
    f1563: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1563,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
             ...
             => ! [V3d: $i] :
                  ( mem(V3d,arr(ty_2Enum_2Enum,bool))
                 => mem(f1563(V0a,V2c,V1b,V3d),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V3d: $i] :
                  ( mem(V3d,arr(ty_2Enum_2Enum,bool))
                 => ! [V15t: tp__ty_2Enum_2Enum] : ap(f1563(V0a,V2c,V1b,V3d),inj__ty_2Enum_2Enum(V15t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V3d,inj__ty_2Enum_2Enum(V15t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1564(V0a,V2c)),V1b),inj__ty_2Enum_2Enum(V15t))) ) ) ) ) )).

tff(lmtp_f1561,type,(
    f1561: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1561,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
             ...
             => ! [V3d: $i] :
                  ( mem(V3d,arr(ty_2Enum_2Enum,bool))
                 => mem(f1561(V0a,V2c,V1b,V3d),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V3d: $i] :
                  ( mem(V3d,arr(ty_2Enum_2Enum,bool))
                 => ! [V13t: tp__ty_2Enum_2Enum] : ap(f1561(V0a,V2c,V1b,V3d),inj__ty_2Enum_2Enum(V13t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V2c),V3d),inj__ty_2Enum_2Enum(V13t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1562(V0a,V2c)),V1b),inj__ty_2Enum_2Enum(V13t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1563(V0a,V2c,V1b,V3d)),inj__ty_2Enum_2Enum(V13t))) ) ) ) ) )).

tff(lmtp_f1565,type,(
    f1565: ( $i * $i * $i ) > $i )).

tff(lamtp_f1565,axiom,(
    ! [V2c: $i] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => mem(f1565(V2c,V3d,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1565,axiom,(
    ! [V2c: $i] :
     ...
     => ! [V3d: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V17t: tp__ty_2Enum_2Enum] : ap(f1565(V2c,V3d,V1b),inj__ty_2Enum_2Enum(V17t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,inj__ty_2Enum_2Enum(V17t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V2c),V3d),inj__ty_2Enum_2Enum(V17t))) ) ) ) )).

tff(lmtp_f1567,type,(
    f1567: ( $i * $i ) > $i )).

tff(lamtp_f1567,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1567(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1567,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V19t: tp__ty_2Enum_2Enum] : ap(f1567(V0a,V3d),inj__ty_2Enum_2Enum(V19t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V19t))),ap(c_2Ebool_2E_7E,ap(ap(c_2ETemporal__Logic_2ENEXT,V3d),inj__ty_2Enum_2Enum(V19t)))) ) ) )).

tff(lmtp_f1569,type,(
    f1569: ( $i * $i ) > $i )).

tff(lamtp_f1569,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1569(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1569,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V21t: tp__ty_2Enum_2Enum] : ap(f1569(V0a,V3d),inj__ty_2Enum_2Enum(V21t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V21t))),ap(c_2Ebool_2E_7E,ap(ap(c_2ETemporal__Logic_2ENEXT,V3d),inj__ty_2Enum_2Enum(V21t)))) ) ) )).

tff(lmtp_f1568,type,(
    f1568: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1568,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => mem(f1568(V3d,V1b,V0a,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V3d: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V0a: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => ! [V20t: tp__ty_2Enum_2Enum] : ap(f1568(V3d,V1b,V0a,V2c),inj__ty_2Enum_2Enum(V20t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,inj__ty_2Enum_2Enum(V20t))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V3d,inj__ty_2Enum_2Enum(V20t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1569(V0a,V3d)),V1b),inj__ty_2Enum_2Enum(V20t)))) ) ) ) ) )).

tff(lmtp_f1566,type,(
    f1566: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1566,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => mem(f1566(V0a,V3d,V1b,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => ! [V18t: tp__ty_2Enum_2Enum] : ap(f1566(V0a,V3d,V1b,V2c),inj__ty_2Enum_2Enum(V18t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V2c),V3d),inj__ty_2Enum_2Enum(V18t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1567(V0a,V3d)),V1b),inj__ty_2Enum_2Enum(V18t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1568(V3d,V1b,V0a,V2c)),inj__ty_2Enum_2Enum(V18t))) ) ) ) ) )).

tff(lmtp_f1570,type,(
    f1570: ( $i * $i ) > $i )).

tff(lamtp_f1570,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1570(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1570,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V22t: tp__ty_2Enum_2Enum] : ap(f1570(V0a,V1b),inj__ty_2Enum_2Enum(V22t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,inj__ty_2Enum_2Enum(V22t))),ap(V1b,inj__ty_2Enum_2Enum(V22t))) ) ) )).

tff(lmtp_f1571,type,(
    f1571: ( $i * $i * $i ) > $i )).

tff(lamtp_f1571,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => mem(f1571(V0a,V2c,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1571,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V23t: tp__ty_2Enum_2Enum] : ap(f1571(V0a,V2c,V1b),inj__ty_2Enum_2Enum(V23t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V2c),inj__ty_2Enum_2Enum(V23t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V1b),V2c),inj__ty_2Enum_2Enum(V23t))) ) ) ) )).

tff(lmtp_f1572,type,(
    f1572: ( $i * $i ) > $i )).

tff(lamtp_f1572,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1572(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1572,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V24t: tp__ty_2Enum_2Enum] : ap(f1572(V0a,V1b),inj__ty_2Enum_2Enum(V24t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V24t))),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V1b),inj__ty_2Enum_2Enum(V24t))) ) ) )).

tff(lmtp_f1574,type,(
    f1574: ( $i * $i ) > $i )).

tff(lamtp_f1574,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1574(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1574,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V26t: tp__ty_2Enum_2Enum] : ap(f1574(V1b,V0a),inj__ty_2Enum_2Enum(V26t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,inj__ty_2Enum_2Enum(V26t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V0a),inj__ty_2Enum_2Enum(V26t))) ) ) )).

tff(lmtp_f1573,type,(
    f1573: ( $i * $i * $i ) > $i )).

tff(lamtp_f1573,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2c: $i] :
              ( mem(V2c,arr(ty_2Enum_2Enum,bool))
             => mem(f1573(V0a,V1b,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1573,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2c: $i] :
              ( mem(V2c,arr(ty_2Enum_2Enum,bool))
             => ! [V25t: tp__ty_2Enum_2Enum] : ap(f1573(V0a,V1b,V2c),inj__ty_2Enum_2Enum(V25t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,inj__ty_2Enum_2Enum(V25t))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V25t))),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V1b),inj__ty_2Enum_2Enum(V25t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1574(V1b,V0a)),ap(c_2ETemporal__Logic_2ENEXT,V2c)),inj__ty_2Enum_2Enum(V25t)))) ) ) ) )).

tff(lmtp_f1575,type,(
    f1575: ( $i * $i ) > $i )).

tff(lamtp_f1575,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1575(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1575,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V27t: tp__ty_2Enum_2Enum] : ap(f1575(V0a,V1b),inj__ty_2Enum_2Enum(V27t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V27t))),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),inj__ty_2Enum_2Enum(V27t))) ) ) )).

tff(lmtp_f1577,type,(
    f1577: ( $i * $i ) > $i )).

tff(lamtp_f1577,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1577(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1577,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V29t: tp__ty_2Enum_2Enum] : ap(f1577(V1b,V0a),inj__ty_2Enum_2Enum(V29t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,inj__ty_2Enum_2Enum(V29t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V0a),inj__ty_2Enum_2Enum(V29t))) ) ) )).

tff(lmtp_f1576,type,(
    f1576: ( $i * $i * $i ) > $i )).

tff(lamtp_f1576,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2c: $i] :
              ( mem(V2c,arr(ty_2Enum_2Enum,bool))
             => mem(f1576(V0a,V1b,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1576,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2c: $i] :
              ( mem(V2c,arr(ty_2Enum_2Enum,bool))
             => ! [V28t: tp__ty_2Enum_2Enum] : ap(f1576(V0a,V1b,V2c),inj__ty_2Enum_2Enum(V28t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,inj__ty_2Enum_2Enum(V28t))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V28t))),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),inj__ty_2Enum_2Enum(V28t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1577(V1b,V0a)),ap(c_2ETemporal__Logic_2ENEXT,V2c)),inj__ty_2Enum_2Enum(V28t)))) ) ) ) )).

tff(lmtp_f1578,type,(
    f1578: ( $i * $i * $i ) > $i )).

tff(lamtp_f1578,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => mem(f1578(V1b,V2c,V0a),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1578,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => ! [V30t: tp__ty_2Enum_2Enum] : ap(f1578(V1b,V2c,V0a),inj__ty_2Enum_2Enum(V30t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V30t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V1b),V2c),inj__ty_2Enum_2Enum(V30t))) ) ) ) )).

tff(lmtp_f1580,type,(
    f1580: ( $i * $i ) > $i )).

tff(lamtp_f1580,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1580(V3d,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1580,axiom,(
    ! [V3d: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V32t: tp__ty_2Enum_2Enum] : ap(f1580(V3d,V2c),inj__ty_2Enum_2Enum(V32t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,inj__ty_2Enum_2Enum(V32t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),inj__ty_2Enum_2Enum(V32t))) ) ) )).

tff(lmtp_f1581,type,(
    f1581: ( $i * $i ) > $i )).

tff(lamtp_f1581,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1581(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1581,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V33t: tp__ty_2Enum_2Enum] : ap(f1581(V0a,V3d),inj__ty_2Enum_2Enum(V33t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V33t)))),ap(c_2Ebool_2E_7E,ap(V3d,inj__ty_2Enum_2Enum(V33t)))) ) ) )).

tff(lmtp_f1583,type,(
    f1583: ( $i * $i ) > $i )).

tff(lamtp_f1583,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => mem(f1583(V3d,V2c),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1583,axiom,(
    ! [V3d: $i] :
     ...
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V35t: tp__ty_2Enum_2Enum] : ap(f1583(V3d,V2c),inj__ty_2Enum_2Enum(V35t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,inj__ty_2Enum_2Enum(V35t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),inj__ty_2Enum_2Enum(V35t))) ) ) )).

tff(lmtp_f1584,type,(
    f1584: ( $i * $i ) > $i )).

tff(lamtp_f1584,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1584(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1584,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V36t: tp__ty_2Enum_2Enum] : ap(f1584(V0a,V3d),inj__ty_2Enum_2Enum(V36t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V36t)))),ap(c_2Ebool_2E_7E,ap(V3d,inj__ty_2Enum_2Enum(V36t)))) ) ) )).

tff(lmtp_f1582,type,(
    f1582: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1582,axiom,(
    ! [V2c: $i] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
             ...
             => ! [V1b: $i] :
                  ( mem(V1b,arr(ty_2Enum_2Enum,bool))
                 => mem(f1582(V2c,V3d,V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V2c: $i] :
     ...
     => ! [V3d: $i] :
         ...
         => ! [V0a: $i] :
             ...
             => ! [V1b: $i] :
                  ( mem(V1b,arr(ty_2Enum_2Enum,bool))
                 => ! [V34t: tp__ty_2Enum_2Enum] : ap(f1582(V2c,V3d,V0a,V1b),inj__ty_2Enum_2Enum(V34t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,inj__ty_2Enum_2Enum(V34t))),ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,inj__ty_2Enum_2Enum(V34t))),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1583(V3d,V2c)),f1584(V0a,V3d)),inj__ty_2Enum_2Enum(V34t)))) ) ) ) ) )).

tff(lmtp_f1579,type,(
    f1579: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1579,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => mem(f1579(V3d,V1b,V0a,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V3d: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V0a: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => ! [V31t: tp__ty_2Enum_2Enum] : ap(f1579(V3d,V1b,V0a,V2c),inj__ty_2Enum_2Enum(V31t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V1b),V2c),inj__ty_2Enum_2Enum(V31t))),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1580(V3d,V2c)),f1581(V0a,V3d)),inj__ty_2Enum_2Enum(V31t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1582(V2c,V3d,V0a,V1b)),V3d),inj__ty_2Enum_2Enum(V31t))) ) ) ) ) )).

tff(lmtp_f1585,type,(
    f1585: ( $i * $i * $i ) > $i )).

tff(lamtp_f1585,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => mem(f1585(V1b,V2c,V0a),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f1585,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
              ( mem(V0a,arr(ty_2Enum_2Enum,bool))
             => ! [V37t: tp__ty_2Enum_2Enum] : ap(f1585(V1b,V2c,V0a),inj__ty_2Enum_2Enum(V37t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V37t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V1b),V2c),inj__ty_2Enum_2Enum(V37t))) ) ) ) )).

tff(lmtp_f1587,type,(
    f1587: ( $i * $i ) > $i )).

tff(lamtp_f1587,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1587(V3d,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1587,axiom,(
    ! [V3d: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V39t: tp__ty_2Enum_2Enum] : ap(f1587(V3d,V1b),inj__ty_2Enum_2Enum(V39t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,inj__ty_2Enum_2Enum(V39t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),inj__ty_2Enum_2Enum(V39t))) ) ) )).

tff(lmtp_f1588,type,(
    f1588: ( $i * $i ) > $i )).

tff(lamtp_f1588,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1588(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1588,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V40t: tp__ty_2Enum_2Enum] : ap(f1588(V0a,V3d),inj__ty_2Enum_2Enum(V40t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V40t)))),ap(c_2Ebool_2E_7E,ap(V3d,inj__ty_2Enum_2Enum(V40t)))) ) ) )).

tff(lmtp_f1590,type,(
    f1590: ( $i * $i ) > $i )).

tff(lamtp_f1590,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1590(V3d,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1590,axiom,(
    ! [V3d: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V42t: tp__ty_2Enum_2Enum] : ap(f1590(V3d,V1b),inj__ty_2Enum_2Enum(V42t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,inj__ty_2Enum_2Enum(V42t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),inj__ty_2Enum_2Enum(V42t))) ) ) )).

tff(lmtp_f1591,type,(
    f1591: ( $i * $i ) > $i )).

tff(lamtp_f1591,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => mem(f1591(V0a,V3d),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1591,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V3d: $i] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         => ! [V43t: tp__ty_2Enum_2Enum] : ap(f1591(V0a,V3d),inj__ty_2Enum_2Enum(V43t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V43t)))),ap(c_2Ebool_2E_7E,ap(V3d,inj__ty_2Enum_2Enum(V43t)))) ) ) )).

tff(lmtp_f1589,type,(
    f1589: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1589,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V3d: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => mem(f1589(V1b,V0a,V3d,V2c),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
         ...
         => ! [V3d: $i] :
             ...
             => ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Enum_2Enum,bool))
                 => ! [V41t: tp__ty_2Enum_2Enum] : ap(f1589(V1b,V0a,V3d,V2c),inj__ty_2Enum_2Enum(V41t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(V2c,inj__ty_2Enum_2Enum(V41t)))),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1590(V3d,V1b)),f1591(V0a,V3d)),inj__ty_2Enum_2Enum(V41t))) ) ) ) ) )).

tff(lmtp_f1586,type,(
    f1586: ( $i * $i * $i * $i ) > $i )).

tff(lamtp_f1586,axiom,(
    ! [V3d: $i] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c: $i] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         => ! [V0a: $i] :
             ...
             => ! [V1b: $i] :
                  ( mem(V1b,arr(ty_2Enum_2Enum,bool))
                 => mem(f1586(V3d,V2c,V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [V3d: $i] :
     ...
     => ! [V2c: $i] :
         ...
         => ! [V0a: $i] :
             ...
             => ! [V1b: $i] :
                  ( mem(V1b,arr(ty_2Enum_2Enum,bool))
                 => ! [V38t: tp__ty_2Enum_2Enum] : ap(f1586(V3d,V2c,V0a,V1b),inj__ty_2Enum_2Enum(V38t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V1b),V2c),inj__ty_2Enum_2Enum(V38t))),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1587(V3d,V1b)),f1588(V0a,V3d)),inj__ty_2Enum_2Enum(V38t)))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1589(V1b,V0a,V3d,V2c)),V3d),inj__ty_2Enum_2Enum(V38t))) ) ) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__SUNTIL__THM,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2c: $i] :
             ...
             => ! [V3d: $i] :
                  ( mem(V3d,arr(ty_2Enum_2Enum,bool))
                 => ( ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1552(V1b,V2c)) = f1553(V1b,V2c,V0a)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1554(V1b,V2c)) = f1555(V0a,V2c,V1b)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1557(V1b,V2c)) = f1558(V0a,V2c,V1b)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1560(V2c,V3d,V1b)) = f1561(V0a,V2c,V1b,V3d)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1565(V2c,V3d,V1b)) = f1566(V0a,V3d,V1b,V2c)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1570(V0a,V1b)),V2c) = f1571(V0a,V2c,V1b)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1572(V0a,V1b)),V2c) = f1573(V0a,V1b,V2c)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1575(V0a,V1b)),V2c) = f1576(V0a,V1b,V2c)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1578(V1b,V2c,V0a)),V3d) = f1579(V3d,V1b,V0a,V2c)
                    & ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1585(V1b,V2c,V0a)),V3d) = f1586(V3d,V2c,V0a,V1b) ) ) ) ) ) )).
