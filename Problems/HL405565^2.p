...
thf(conj_thm_2Eordinal_2EelsOf__allOrds,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Ewellorder_2EelsOf @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2EallOrds @ A_27a ) )
      = ( c_2Epred__set_2EUNIV @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) )).

thf(conj_thm_2Eordinal_2Ewellorder__ordinal__isomorphism,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Ewellorder_2EelsOf__cardeq__iso,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ A_27a ) )
     => ! [V1wo: $i] :
          ( ( mem @ V1wo @ ( ty_2Ewellorder_2Ewellorder @ A_27b ) )
         => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EINJ @ A_27b @ A_27a ) @ V0f ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27b ) @ V1wo ) ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) )
           => ? [V2wo_27: $i] :
                ( ( mem @ V2wo_27 @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
                & ( p @ ( ap @ ( ap @ ( c_2Ewellorder_2Eorderiso @ A_27b @ A_27a ) @ V1wo ) @ V2wo_27 ) ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2Euniv__ord__greater__cardinal,conjecture,(
    ! [A_27a: del] :
