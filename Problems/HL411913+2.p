...
fof(conj_thm_2Eiterate_2EREAL__INF__UNIQUE,lemma,(
    ! [V0s] :
...
fof(lamtp_f4080,axiom,(
    ! [V2e] :
     ...
     => ! [V1t] :
         ...
         => ! [V3x] :
              ( mem(V3x,ty_2Erealax_2Ereal)
             => mem(f4080(V2e,V1t,V3x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f4080,axiom,(
    ! [V2e] :
      ( mem(V2e,ty_2Erealax_2Ereal)
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V3x] :
             ...
             => ! [V4y] :
                  ( mem(V4y,ty_2Erealax_2Ereal)
                 => ap(f4080(V2e,V1t,V3x),V4y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V3x),V4y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V1t)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V4y)),V2e))) ) ) ) ) )).

fof(lamtp_f4079,axiom,(
    ! [V2e] :
      ( mem(V2e,ty_2Erealax_2Ereal)
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f4079,axiom,(
    ! [V2e] :
     ...
     => ! [V1t] :
         ...
         => ! [V3x] :
              ( mem(V3x,ty_2Erealax_2Ereal)
             => ap(f4079(V2e,V1t),V3x) = f4080(V2e,V1t,V3x) ) ) ) )).

fof(lamtp_f4082,axiom,(
    ! [V2e] :
      ( mem(V2e,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5x] :
             ...
             => mem(f4082(V2e,V0s,V5x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f4082,axiom,(
    ! [V2e] :
      ( mem(V2e,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5x] :
             ...
             => ! [V6y] :
                 ...
                 => ap(f4082(V2e,V0s,V5x),V6y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V5x),V6y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V0s)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V6y)),V2e))) ) ) ) ) )).

fof(lamtp_f4081,axiom,(
    ! [V2e] :
      ( mem(V2e,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f4081,axiom,(
    ! [V2e] :
     ...
     => ! [V0s] :
         ...
         => ! [V5x] :
              ( mem(V5x,ty_2Erealax_2Ereal)
             => ap(f4081(V2e,V0s),V5x) = f4082(V2e,V0s,V5x) ) ) ) )).

fof(lamtp_f4078,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
    ...
    ! [V0s] :
     ...
     => ! [V1t] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
              ...
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) = ap(c_2Eiterate_2Einf,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4078(V0s,V1t))) ) ) ) )).
