...
fof(conj_thm_2Ereal__topology_2EBOUNDED__UNION,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__INSERT,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0x),V1s)))
