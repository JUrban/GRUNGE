...
thf(thm_2Ereal__topology_2EFORALL__POS__MONO__1,conjecture,(
    ! [V0P: tyop_2Erealax_2Ereal > $o] :
      ( ( ! [V1d: tyop_2Erealax_2Ereal,V2e: tyop_2Erealax_2Ereal] :
           ...
           => ( V0P @ V2e ) )
        & ! [V3n: tyop_2Enum_2Enum] :
            ( V0P @ ( c_2Erealax_2Einv @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ V3n ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
     => ! [V4e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V4e )
         => ( V0P @ V4e ) ) ) )).
