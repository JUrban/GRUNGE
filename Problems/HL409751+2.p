...
fof(conj_thm_2Eiterate_2ENSUM__SUPPORT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1s] :
             ...
             => ap(ap(c_2Eiterate_2Ensum(A_27a),ap(ap(ap(c_2Eiterate_2Esupport(A_27a,A_27a),c_2Earithmetic_2E_2B),V0f),V1s)),V0f) = ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),V0f) ) ) ) )).
...
fof(conj_thm_2Eiterate_2ENSUM__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0u] :
...
fof(conj_thm_2Eiterate_2ENSUM__LE__GEN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
