...
tff(lamtp_f933,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f933(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f933,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t0: tp__ty_2Enum_2Enum] : ap(f933(V0a,V1b),inj__ty_2Enum_2Enum(V2t0)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,V0a),V1b),inj__ty_2Enum_2Enum(V2t0))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f893(V1b)),inj__ty_2Enum_2Enum(V2t0))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EBEFORE__AS__SBEFORE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2EBEFORE,V0a),V1b) = f933(V0a,V1b) ) ) )).
