...
thf(thm_2Ereal__topology_2ECLOSEST__POINT__LE,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2EClosed @ V0s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Ereal__topology_2Eclosest__point @ V0s @ V1a ) ) ) @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ V2x ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSEST__POINT__SELF,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Ereal__topology_2Eclosest__point @ V0s @ V1x )
        = V1x ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSEST__POINT__IN__INTERIOR,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eclosest__point @ V0s @ V1x ) @ ( c_2Ereal__topology_2Einterior @ V0s ) )
