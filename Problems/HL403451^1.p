...
thf(thm_2EEncode_2Eencode__blist__def__compute,conjecture,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0e_2E0: u,V1l_2E0: u] :
          ...
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V2m: mono_2Etyop_2Enum_2Enum,V3e_2E0: u,V4l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EEncode_2Eencode__blist_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2m ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V3e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V4l_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V3e_2E0 ) @ ( s @ A_27b @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V4l_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EEncode_2Eencode__blist_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2m ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V3e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V4l_2E0 ) ) ) ) ) ) ) )
      & ! [V5m: mono_2Etyop_2Enum_2Enum,V6e_2E0: u,V7l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EEncode_2Eencode__blist_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V5m ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V6e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V7l_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V6e_2E0 ) @ ( s @ A_27b @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V7l_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EEncode_2Eencode__blist_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V5m ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V6e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V7l_2E0 ) ) ) ) ) ) ) ) ) )).
