...
tff(mem_c_2Epath_2Eevery,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2Eevery(A_27a,A_27a),arr(arr(A_27a,bool),arr(ty_2Epath_2Epath(A_27a,A_27a),bool))) )).
...
tff(conj_thm_2Epath_2Enot__every,lemma,(
...
tff(conj_thm_2Epath_2Eevery__coinduction,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
                     ...
                     => ! [V5p: $i] :
                         ...
                         => ( p(ap(V0P,ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V3x),V4r),V5p)))
                           => ( p(ap(V1Q,V3x))
                              & p(ap(V0P,V5p)) ) ) ) ) ) )
           => ! [V6p: $i] :
                ( mem(V6p,ty_2Epath_2Epath(A_27a,A_27a))
               => ( p(ap(V0P,V6p))
                 => p(ap(ap(c_2Epath_2Eevery(A_27a,A_27a),V1Q),V6p)) ) ) ) ) ) )).

tff(conj_thm_2Epath_2Eexists__induction,conjecture,(
    ! [A_27a: del,A_27b: del,V0Q: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ( ( ! [V2x: $i] :
                  ( mem(V2x,A_27a)
                 => ( p(ap(V0Q,V2x))
                   => p(ap(V1P,ap(c_2Epath_2Estopped__at(A_27a,A_27a),V2x))) ) )
              & ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ! [V4r: $i] :
                      ( mem(V4r,A_27b)
                     => ! [V5p: $i] :
                          ( mem(V5p,ty_2Epath_2Epath(A_27a,A_27a))
                         => ( p(ap(V0Q,V3x))
                           => p(ap(V1P,ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V3x),V4r),V5p))) ) ) ) )
              & ! [V6x: $i] :
                  ( mem(V6x,A_27a)
                 => ! [V7r: $i] :
                      ( mem(V7r,A_27b)
                     => ! [V8p: $i] :
                          ( mem(V8p,ty_2Epath_2Epath(A_27a,A_27a))
                         => ( p(ap(V1P,V8p))
                           => p(ap(V1P,ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V6x),V7r),V8p))) ) ) ) ) )
           => ! [V9p: $i] :
                ( mem(V9p,ty_2Epath_2Epath(A_27a,A_27a))
               => ( p(ap(ap(c_2Epath_2Eexists(A_27a,A_27a),V0Q),V9p))
                 => p(ap(V1P,V9p)) ) ) ) ) ) )).
