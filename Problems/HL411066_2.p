...
tff(lmtp_f3817,type,(
    f3817: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3817,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3y: tp__ty_2Erealax_2Ereal] : mem(f3817(V0f,V3y),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3817,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3y: tp__ty_2Erealax_2Ereal,V4n: tp__ty_2Enum_2Enum] : ap(f3817(V0f,V3y),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),ap(V0f,inj__ty_2Enum_2Enum(V4n))) ) )).

tff(lmtp_f3816,type,(
    f3816: $i > $i )).

tff(lamtp_f3816,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3816(V0f),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3816,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3y: tp__ty_2Erealax_2Ereal] : ap(f3816(V0f),inj__ty_2Erealax_2Ereal(V3y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f3817(V0f,V3y))) ) )).

tff(conj_thm_2Ereal__topology_2ESEQUENCE__INFINITE__LEMMA,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( ( ! [V2n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V2n))) != V1l
         ...
         => ~ p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3816(V0f)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESEQUENCE__UNIQUE__LIMPT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2l_27: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0f),inj__ty_2Erealax_2Ereal(V1l)),c_2Ereal__topology_2Esequentially))
            & p(ap(ap(c_2Ereal__topology_2Elimit__point__of,inj__ty_2Erealax_2Ereal(V2l_27)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3816(V0f)))) )
         => V2l_27 = V1l ) ) )).

tff(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__CLOSED,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1t: $i] :
