...
tff(tp_c_2Ellist_2ELFILTER,type,(
    c_2Ellist_2ELFILTER: del > $i )).

tff(mem_c_2Ellist_2ELFILTER,axiom,(
    ! [A_27a: del] : mem(c_2Ellist_2ELFILTER(A_27a),arr(arr(A_27a,bool),arr(ty_2Ellist_2Ellist(A_27a),ty_2Ellist_2Ellist(A_27a)))) )).
...
tff(conj_thm_2Ellist_2ELFILTER__THM,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0P: $i] :
...
tff(conj_thm_2Ellist_2ELFILTER__APPEND,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ll1: $i] :
