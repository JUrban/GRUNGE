...
thf(thm_2Earithmetic_2ESUC__MOD,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ( ( ( c_2Earithmetic_2EMOD @ ( c_2Enum_2ESUC @ V1a ) @ V0n )
          = ( c_2Earithmetic_2EMOD @ ( c_2Enum_2ESUC @ V2b ) @ V0n ) )
      <=> ( ( c_2Earithmetic_2EMOD @ V1a @ V0n )
          = ( c_2Earithmetic_2EMOD @ V2b @ V0n ) ) ) ) )).
...
thf(thm_2Earithmetic_2EADD__MOD,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum,V3p: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ( ( ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2B @ V1a @ V3p ) @ V0n )
          = ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2B @ V2b @ V3p ) @ V0n ) )
      <=> ( ( c_2Earithmetic_2EMOD @ V1a @ V0n )
          = ( c_2Earithmetic_2EMOD @ V2b @ V0n ) ) ) ) )).
