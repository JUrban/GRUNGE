...
fof(conj_thm_2Ereal__topology_2ELIM__NULL__ABS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
         ...
         => ! [V1f] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net))
              <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3750(A_27a,V1f)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net)) ) ) ) ) )).
