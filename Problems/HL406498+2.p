    ...
    ! [V1v1] :
     ...
     => ! [V2v2] :
         ...
         => ! [V0f] :
             ...
             => ! [V3m] :
                  ( mem(V3m,ty_2Enum_2Enum)
                 => ap(f2299(V1v1,V2v2,V0f),V3m) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),V0f)),ap(c_2Elist_2EZIP(bool,bool),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Ebitstring_2Efixwidth,V3m),V1v1)),ap(ap(c_2Ebitstring_2Efixwidth,V3m),V2v2)))) ) ) ) ) )).
...
fof(ax_thm_2Ebitstring_2Ebitwise__def,axiom,(
    ! [V0f] :
     ...
     => ! [V1v1] :
         ...
         => ! [V2v2] :
              ( mem(V2v2,ty_2Elist_2Elist(bool))
             => ap(ap(ap(c_2Ebitstring_2Ebitwise,V0f),V1v1),V2v2) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2299(V1v1,V2v2,V0f)),ap(ap(c_2Earithmetic_2EMAX,ap(c_2Elist_2ELENGTH(bool),V1v1)),ap(c_2Elist_2ELENGTH(bool),V2v2))) ) ) ) )).

fof(lamtp_f2303,axiom,(
    ! [V0x] :
      ( mem(V0x,bool)
     => mem(f2303(V0x),arr(bool,bool)) ) )).
...
fof(lameq_f2303,axiom,(
    ! [V0x] :
     ...
     => ! [V1y] :
          ( mem(V1y,bool)
         => ap(f2303(V0x),V1y) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,V0x),V1y)) ) ) )).

fof(lamtp_f2302,axiom,(
    mem(f2302,arr(bool,arr(bool,bool))) )).

fof(lameq_f2302,axiom,(
    ! [V0x] :
      ( mem(V0x,bool)
     => ap(f2302,V0x) = f2303(V0x) ) )).

fof(ax_thm_2Ebitstring_2Ebnand__def,axiom,(
    c_2Ebitstring_2Ebnand = ap(c_2Ebitstring_2Ebitwise,f2302) )).
...
fof(conj_thm_2Ebitstring_2Efixwidth__fixwidth,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1v] :
          ( mem(V1v,ty_2Elist_2Elist(bool))
...
fof(conj_thm_2Ebitstring_2Eword__nand__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
