...
thf(conj_thm_2Etopology_2EHULL__UNIQUE,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__HULL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Eclosure @ V0s )
        = ( ap @ ( ap @ ( c_2Etopology_2Ehull @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2EClosed ) @ V0s ) ) ) )).
