...
tff(lmtp_f3274,type,(
    f3274: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3274,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : mem(f3274(V0s,V1a),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3274,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3274(V0s,V1a),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V1a))) ) )).

tff(lmtp_f3276,type,(
    f3276: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3276,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3276(V0s,V3b),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3276,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f3276(V0s,V3b),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V4x)),inj__ty_2Erealax_2Ereal(V3b))) ) )).

tff(lmtp_f3275,type,(
    f3275: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3275,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : mem(f3275(V0s,V1a),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3275,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] : ap(f3275(V0s,V1a),inj__ty_2Erealax_2Ereal(V3b)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3276(V0s,V3b))),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3b))) ) )).

tff(lmtp_f3273,type,(
    f3273: $i > $i )).

tff(lamtp_f3273,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3273,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : ap(f3273(V0s),inj__ty_2Erealax_2Ereal(V1a)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3274(V0s,V1a))),ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3275(V0s,V1a))) ) )).

tff(conj_thm_2Eiterate_2Esup__alt,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Esup,V0s)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f3273(V0s))) ) )).

tff(conj_thm_2Eiterate_2EREAL__SUP__UNIQUE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
