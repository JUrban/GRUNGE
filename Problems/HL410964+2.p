...
fof(lamtp_f3798,axiom,(
    ! [V1f] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3798(V1f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3798,axiom,(
    ! [V1f] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V5x] :
          ( mem(V5x,ty_2Erealax_2Ereal)
         => ap(f3798(V1f),V5x) = ap(V1f,V5x) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__CONG__AT,conjecture,(
    ! [V0a] :
         ...
         => ! [V2g] :
             ...
             => ! [V3l] :
                 ...
                 => ( ! [V4x] :
                   ...
                   => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3798(V1f)),V3l),ap(c_2Ereal__topology_2Eat,V0a)))
