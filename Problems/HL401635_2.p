...
tff(lmtp_f272,type,(
    f272: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f272,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V3y: $i] :
      ( mem(V3y,A_27b)
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => ! [V1s: $i] :
              ( mem(V1s,arr(A_27a,bool))
             => mem(f272(A_27a,A_27b,A_27a,V3y,V0f,V1s),arr(A_27a,bool)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,A_27a: del,V3y: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1s: $i] :
             ...
             => ! [V4x: $i] :
                  ( mem(V4x,A_27a)
                 => ap(f272(A_27a,A_27b,A_27a,V3y,V0f,V1s),V4x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V4x),V1s)),ap(ap(c_2Emin_2E_3D(A_27b),V3y),ap(V0f,V4x))) ) ) ) ) )).

tff(conj_thm_2Epred__set_2EBIJ__ALT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),V1s),V2t))
              <=> ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V0f),ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),V1s),V2t)))
                  & ! [V3y: $i] :
                      ( mem(V3y,A_27b)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V3y),V2t))
                       => p(ap(c_2Ebool_2E_3F_21(A_27a),f272(A_27a,A_27b,A_27a,V3y,V0f,V1s))) ) ) ) ) ) ) ) )).

tff(conj_thm_2Epred__set_2EBIJ__INSERT__IMP,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1e),V2s))
                      & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1e),V2s)),V3t)) )
                   => ? [V4u: $i] :
                        ( mem(V4u,arr(A_27b,bool))
                        & ap(ap(c_2Epred__set_2EINSERT(A_27b),ap(V0f,V1e)),V4u) = V3t
                        & ~ p(ap(ap(c_2Ebool_2EIN(A_27b),ap(V0f,V1e)),V4u))
                        & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),V2s),V4u)) ) ) ) ) ) ) )).
...
tff(conj_thm_2Epred__set_2EFINITE__BIJ,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
