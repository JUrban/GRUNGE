...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
