...
thf(conj_thm_2Erich__list_2EFILTER__FOLDR,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
                ...
                @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ...
                        @ ^ [V3l_27: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ V0P @ V2x ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V3l_27 ) ) @ V3l_27 ) ) ) )
                @ ( c_2Elist_2ENIL @ A_27a ) )
              @ V1l ) ) ) ) )).
