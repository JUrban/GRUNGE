    ...
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V1s )
        & ! [V2k: tyop_2Erealax_2Ereal > $o] :
            ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2k @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) )
              & ( c_2Ereal__topology_2Ecompact @ V2k ) )
           => ( c_2Ereal__topology_2Ecompact
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V3x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V3x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V1s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ V2k ) ) ) ) ) ) )
     => ( ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ V1s )
        = ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) ) ) )).
