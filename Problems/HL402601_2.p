...
tff(conj_thm_2Erich__list_2EFOLDL__APPEND,conjecture,(
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2l1: $i] :
             ...
             => ! [V3l2: $i] :
                 ...
                 => ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V1e),ap(ap(c_2Elist_2EAPPEND(A_27b),V2l1),V3l2)) = ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V1e),V2l1)),V3l2) ) ) ) ) )).
