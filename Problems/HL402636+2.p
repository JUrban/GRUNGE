...
fof(conj_thm_2Erich__list_2EFOLDR__SINGLE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1e] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27a)
                     => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e),ap(ap(c_2Elist_2ECONS(A_27a),V2x),c_2Elist_2ENIL(A_27a))) = ap(ap(V0f,V2x),V1e) ) ) ) ) ) )).
