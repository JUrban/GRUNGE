...
tff(lmtp_f1688,type,(
    f1688: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1688,axiom,(
    ! [V1i: tp__ty_2Enum_2Enum] : mem(f1688(V1i),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f1688,axiom,(
    ! [V1i: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : ap(f1688(V1i),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1i)) )).

tff(conj_thm_2Epath_2EPL__drop,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
     ...
     => ! [V1i: tp__ty_2Enum_2Enum] :
         ...
         => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),inj__ty_2Enum_2Enum(V1i)),V0p)) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f1688(V1i)),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)) ) ) )).

tff(conj_thm_2Epath_2EIN__PL__drop,conjecture,(
