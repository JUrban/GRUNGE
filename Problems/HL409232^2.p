...
thf(conj_thm_2Ereal_2ESUM__EQ,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
              ( ! [V4r: tp__ty_2Enum_2Enum] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4r ) ) )
                    = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4r ) ) ) ) )
             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V0f ) )
                = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V1g ) ) ) ) ) ) )).
...
thf(conj_thm_2Etransc_2EDIVISION__LBOUND,lemma,(
    ! [V0D: $i] :
      ( ( mem @ V0D @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Etransc_2Edivision @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V0D ) )
         => ! [V3r: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( ap @ V0D @ ( inj__ty_2Enum_2Enum @ V3r ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2EDIVISION__UBOUND,lemma,(
    ! [V0D: $i] :
      ( ( mem @ V0D @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Etransc_2Edivision @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V0D ) )
...
thf(conj_thm_2Eintegral_2EINTEGRAL__EQ,conjecture,(
    ! [V0f: $i] :
