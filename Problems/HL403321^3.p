...
thf(c_2Ebag_2EBAG__CARD__RELn,type,(
    c_2Ebag_2EBAG__CARD__RELn: 
      !>[A_27a: $tType] :
        ( ( A_27a > tyop_2Enum_2Enum ) > tyop_2Enum_2Enum > $o ) )).
...
thf(thm_2Ebag_2EBAG__CARD__RELn,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__CARD__RELn @ A_27a @ V0b @ V1n )
    <=> ! [V2P: ( A_27a > tyop_2Enum_2Enum ) > tyop_2Enum_2Enum > $o] :
          ( ( ( V2P @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) @ c_2Enum_2E0 )
            & ! [V3b: A_27a > tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
                ( ( V2P @ V3b @ V4n )
               => ! [V5e: A_27a] :
                    ( V2P @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V5e @ V3b ) @ ( c_2Enum_2ESUC @ V4n ) ) ) )
         => ( V2P @ V0b @ V1n ) ) ) )).

thf(thm_2Ebag_2EBAG__CARD,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V0b )
     => ( c_2Ebag_2EBAG__CARD__RELn @ A_27a @ V0b @ ( c_2Ebag_2EBAG__CARD @ A_27a @ V0b ) ) ) )).
...
thf(thm_2Ebag_2EBAG__CARD__THM,conjecture,(
    ! [A_27a: $tType] :
