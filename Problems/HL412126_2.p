...
tff(conj_thm_2Eprobability_2EPROB__ONE__INTER,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  ...
                  & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINTER(A_27a),V1s),V2t))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Eprob__x__eq__1__imp__prob__y__eq__0,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              ...
              & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1x),c_2Epred__set_2EEMPTY(A_27a)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )
           => ! [V2y: $i] :
                ( mem(V2y,A_27a)
               => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2y),c_2Epred__set_2EEMPTY(A_27a))),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                    & V2y != V1x )
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2y),c_2Epred__set_2EEMPTY(A_27a)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) ) )).
