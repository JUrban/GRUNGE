    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1g: A_27a > tyop_2Enum_2Enum,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ! [V3x: A_27a] :
           ...
           => ( c_2Earithmetic_2E_3C_3D @ ( V0f @ V3x ) @ ( V1g @ V3x ) ) )
        & ? [V4x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V4x @ V2s )
            & ( c_2Eprim__rec_2E_3C @ ( V0f @ V4x ) @ ( V1g @ V4x ) ) ) )
...
thf(thm_2Eiterate_2ENSUM__CONST,axiom,(
    ! [A_27a: $tType,V0c: tyop_2Enum_2Enum,V1s: A_27a > $o] :
     ...
     => ( ( c_2Eiterate_2Ensum @ A_27a @ V1s
          @ ^ [V2n: A_27a] : V0c )
        = ( c_2Earithmetic_2E_2A @ ( c_2Epred__set_2ECARD @ A_27a @ V1s ) @ V0c ) ) ) )).
    ...
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ! [V3x: A_27a] :
           ...
           => ( c_2Earithmetic_2E_3C_3D @ ( V1f @ V3x ) @ V2b ) )
        & ? [V4x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V4x @ V0s )
            & ( c_2Eprim__rec_2E_3C @ ( V1f @ V4x ) @ V2b ) ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Eiterate_2Ensum @ A_27a @ V0s @ V1f ) @ ( c_2Earithmetic_2E_2A @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) @ V2b ) ) ) )).
