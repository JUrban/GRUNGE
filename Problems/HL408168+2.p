...
fof(conj_thm_2Epoly_2EPOLY__LINEAR__DIVIDES,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Epoly_2EPOLY__LENGTH__MUL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1q] :
...
fof(conj_thm_2Epoly_2EPOLY__ROOTS__INDEX__LEMMA,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
