...
tff(conj_thm_2Ebinary__ieee_2Eround__roundTowardNegative__top,lemma,(
    ! [A_27t: del,A_27w: del,V0y: $i] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
         ...
         => ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTowardNegative)),inj__ty_2Erealax_2Ereal(V1x)) = ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) )).

tff(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardNegative__top,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: tp__o,V1y: $i] :
     ...
     => ! [V2x: tp__ty_2Erealax_2Ereal] :
         ...
         => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTowardNegative)),inj__o(V0b)),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Ebinary__ieee_2Efloat__top(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) )).
