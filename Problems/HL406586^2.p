...
thf(mem_c_2Esptree_2Ewf,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Esptree_2Ewf @ A_27a ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27a ) @ bool ) ) )).
...
thf(mem_c_2Esptree_2EfromAList,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Esptree_2EfromAList @ A_27a ) @ ( arr @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) @ ( ty_2Esptree_2Espt @ A_27a ) ) ) )).
...
thf(conj_thm_2Esptree_2Ewf__insert,lemma,(
                          ...
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V2x: $i] :
                                ...
                                @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) )
                                  @ ^ [V3xs: $i] :
                                      ( ap @ ( ap @ V0R @ V3xs ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ A_27a ) @ V2x ) @ V1y ) ) @ V3xs ) ) ) ) ) ) ) ) ) ) ) )
                        ...
                        @ ^ [V7xs: $i] :
                            ...
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V8x: $i] :
                                  ( lam @ A_27a
                                  @ ^ [V9y: $i] :
                                      ( ap @ ( c_2Ecombin_2EI @ ( ty_2Esptree_2Espt @ A_27a ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Esptree_2Einsert @ A_27a ) @ V8x ) @ V9y ) @ ( ap @ V4fromAList @ V7xs ) ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Esptree_2Ewf__fromAList,conjecture,(
    ! [A_27a: del,V0ls: $i] :
