...
tff(conj_thm_2Ewords_2Eword__L,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
     => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),c_2Ewords_2Eword__L(A_27a)),inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Ewords_2Eword__rrx__0,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ap(c_2Ewords_2Eword__rrx(A_27a),ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2EF)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) = ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2EF)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
      & ap(c_2Ewords_2Eword__rrx(A_27b),ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2ET)),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) = ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2EF)),c_2Ewords_2Eword__L(A_27b)) ) )).
