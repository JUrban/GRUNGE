...
fof(conj_thm_2Elist_2EFILTER__ALL__DISTINCT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Erich__list_2EFILTER__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P1] :
...
fof(conj_thm_2Eupdate_2ELIST__UPDATE__OVERRIDE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eupdate_2ELIST__UPDATE__ALL__DISTINCT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eupdate_2ELIST__UPDATE__SORT__OVERRIDE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
