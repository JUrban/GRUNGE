...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__EQ__NONE,lemma,(
...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__SNOC,lemma,(
...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__SNOC__PMATCH__ROW,conjecture,(
         ...
         => ! [V2c: tp__o,V3infos: tp__c_ty_2Elist_2Elist_o,V4p: $i] :
             ...
             => ! [V5g: $i] :
                 ...
                 => ! [V6r: $i] :
                     ...
                     => ! [V7c_27: tp__o] :
                          ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),inj__o(V2c)),inj__c_ty_2Elist_2Elist_o(V3infos)))
                         => ( ( ~ p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND__EX(A_27a,A_27a),V0v),V4p),V5g))
                             => ( p(inj__o(V2c))
                              <=> p(inj__o(V7c_27)) ) )
                           => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ESNOC(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27b,A_27b,A_27b),V4p),V5g),V6r)),V1rows)),inj__o(V7c_27)),ap(ap(c_2Elist_2ESNOC(bool),ap(ap(c_2Emin_2E_3D_3D_3E,inj__o(V2c)),ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND__EX(A_27a,A_27a),V0v),V4p),V5g)))),inj__c_ty_2Elist_2Elist_o(V3infos)))) ) ) ) ) ) ) ) )).
