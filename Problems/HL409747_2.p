...
tff(conj_thm_2Eiterate_2ENSUM__SING,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(lmtp_f3329,type,(
    f3329: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3329,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V1g: $i] :
              ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
             => mem(f3329(A_27a,A_27b,V0f,V2s,V1g),arr(A_27b,ty_2Enum_2Enum)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V1g: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ap(f3329(A_27a,A_27b,V0f,V2s,V1g),V3y) = ap(ap(c_2Eiterate_2Ensum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3330(A_27b,A_27a,V2s,V0f,V3y))),V1g) ) ) ) ) )).

tff(conj_thm_2Eiterate_2ENSUM__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2s: $i] :
              ( mem(V2s,arr(A_27a,bool))
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V1g)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),f3329(A_27a,A_27b,V0f,V2s,V1g))) ) ) ) ) )).
