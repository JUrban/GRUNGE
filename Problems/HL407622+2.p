...
fof(mem_c_2EordinalNotation_2Eosyntax__size,axiom,(
    mem(c_2EordinalNotation_2Eosyntax__size,arr(ty_2EordinalNotation_2Eosyntax,ty_2Enum_2Enum)) )).

fof(ax_thm_2EordinalNotation_2Eosyntax__size__def,axiom,
    ( ! [V0a] :
        ( mem(V0a,ty_2Enum_2Enum)
       => ap(c_2EordinalNotation_2Eosyntax__size,ap(c_2EordinalNotation_2EEnd,V0a)) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0a) )
    & ! [V1a0] :
        ( mem(V1a0,ty_2EordinalNotation_2Eosyntax)
       => ! [V2a1] :
            ( mem(V2a1,ty_2Enum_2Enum)
           => ! [V3a2] :
                ( mem(V3a2,ty_2EordinalNotation_2Eosyntax)
               => ap(c_2EordinalNotation_2Eosyntax__size,ap(ap(ap(c_2EordinalNotation_2EPlus,V1a0),V2a1),V3a2)) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Earithmetic_2E_2B,ap(c_2EordinalNotation_2Eosyntax__size,V1a0)),ap(ap(c_2Earithmetic_2E_2B,V2a1),ap(c_2EordinalNotation_2Eosyntax__size,V3a2)))) ) ) ) )).

fof(conj_thm_2EordinalNotation_2Eord__mult__ind,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2EordinalNotation_2Eosyntax,arr(ty_2EordinalNotation_2Eosyntax,bool)))
     => ( ! [V1x] :
            ( mem(V1x,ty_2EordinalNotation_2Eosyntax)
           => ! [V2y] :
                ( mem(V2y,ty_2EordinalNotation_2Eosyntax)
               => ( ( ! [V3v] :
                        ( mem(V3v,ty_2EordinalNotation_2Eosyntax)
                       => ! [V4v1] :
                            ( mem(V4v1,ty_2EordinalNotation_2Eosyntax)
                           => ! [V5m] :
                                ( mem(V5m,ty_2Enum_2Enum)
                               => ! [V6e] :
                                    ( mem(V6e,ty_2EordinalNotation_2Eosyntax)
                                   => ! [V7k] :
                                        ( mem(V7k,ty_2Enum_2Enum)
                                       => ! [V8t] :
                                            ( mem(V8t,ty_2EordinalNotation_2Eosyntax)
                                           => ( ( ~ ( V1x = ap(c_2EordinalNotation_2EEnd,c_2Enum_2E0)
                                                    | V2y = ap(c_2EordinalNotation_2EEnd,c_2Enum_2E0) )
                                                & ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),V1x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),V3v),V4v1)
                                                & V3v = ap(c_2EordinalNotation_2EEnd,V5m)
                                                & V4v1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V6e),V7k),V8t) )
                                             => p(ap(ap(V0P,ap(c_2EordinalNotation_2EEnd,V5m)),V8t)) ) ) ) ) ) ) )
                    & ! [V9v] :
                        ( mem(V9v,ty_2EordinalNotation_2Eosyntax)
                       => ! [V10v1] :
                            ( mem(V10v1,ty_2EordinalNotation_2Eosyntax)
                           => ! [V11e_27] :
                                ( mem(V11e_27,ty_2EordinalNotation_2Eosyntax)
                               => ! [V12k_27] :
                                    ( mem(V12k_27,ty_2Enum_2Enum)
                                   => ! [V13t_27] :
                                        ( mem(V13t_27,ty_2EordinalNotation_2Eosyntax)
                                       => ! [V14e2] :
                                           ...
                                           => ! [V15k2] :
                                               ...
                                               => ! [V16t2] :
                                                   ...
                                                   => ( ( ~ ( V1x = ap(c_2EordinalNotation_2EEnd,c_2Enum_2E0)
                                                            | V2y = ap(c_2EordinalNotation_2EEnd,c_2Enum_2E0) )
                                                        & ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),V1x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),V9v),V10v1)
                                                        & V9v = ap(ap(ap(c_2EordinalNotation_2EPlus,V11e_27),V12k_27),V13t_27)
                                                        & V10v1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V14e2),V15k2),V16t2) )
                                                     => p(ap(ap(V0P,ap(ap(ap(c_2EordinalNotation_2EPlus,V11e_27),V12k_27),V13t_27)),V16t2)) ) ) ) ) ) ) ) ) ) )
                 => p(ap(ap(V0P,V1x),V2y)) ) ) )
       => ! [V17v] :
