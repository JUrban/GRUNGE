...
tff(lamtp_f4027,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f4027(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4027,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f4027(V0f),inj__ty_2Enum_2Enum(V2i)) = ap(V0f,inj__ty_2Enum_2Enum(V2i)) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__COMPONENT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Esummable,V1s),V0f))
           => p(ap(ap(c_2Ereal__topology_2Esummable,V1s),f4027(V0f))) ) ) ) )).
