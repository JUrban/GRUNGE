...
tff(mem_c_2Epred__set_2EDFUNSET,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epred__set_2EDFUNSET(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,arr(A_27b,bool)),arr(arr(A_27a,A_27b),bool)))) )).
...
tff(conj_thm_2Epred__set_2EIN__DFUNSET,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EFUNSET__DFUNSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,arr(A_27a,bool))
     => ! [V1y: $i] :
          ( mem(V1y,arr(A_27b,bool))
         => ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),V0x),V1y) = ap(ap(c_2Epred__set_2EDFUNSET(A_27a,A_27a),V0x),ap(c_2Ecombin_2EK(arr(A_27b,bool),arr(A_27b,bool)),V1y)) ) ) )).
