...
tff(conj_thm_2Ecardinal_2ECARD__MUL__CONG,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1s_27: $i] :
          ( mem(V1s_27,arr(A_27b,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3t_27: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),V1s_27))
                   ...
                   => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V2t)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1s_27),V3t_27))) ) ) ) ) ) )).
