     ...
     => ( ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m @ V1f )
        = ( c_2Eextreal_2Eextreal__add
          @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
            @ ^ [V4x: A_27a] :
                ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V4x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V2s @ V4x ) ) )
          @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
            @ ^ [V5x: A_27a] :
                ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V5x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ V2s ) @ V5x ) ) ) ) ) ) )).
