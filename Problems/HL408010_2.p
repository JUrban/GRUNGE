...
tff(lmtp_f2886,type,(
    f2886: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2886,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2886(V1k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2886,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2886(V1k,V0f),inj__ty_2Enum_2Enum(V2n)) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1k))) ) )).

tff(conj_thm_2Eseq_2ESER__OFFSET,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Esummable,V0f))
       => ! [V1k: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Eseq_2Esums,f2886(V1k,V0f)),ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Eseq_2Esuminf,V0f)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1k))),V0f)))) ) ) )).
