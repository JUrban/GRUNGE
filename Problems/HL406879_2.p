...
tff(lmtp_f2584,type,(
    f2584: ( $i * tp__ty_2Ehrat_2Ehrat ) > $i )).

tff(lamtp_f2584,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V1w: tp__ty_2Ehrat_2Ehrat] : mem(f2584(V0P,V1w),arr(ty_2Ehreal_2Ehreal,bool)) ) )).

tff(lameq_f2584,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V1w: tp__ty_2Ehrat_2Ehrat,V2X: tp__ty_2Ehreal_2Ehreal] : ap(f2584(V0P,V1w),inj__ty_2Ehreal_2Ehreal(V2X)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,inj__ty_2Ehreal_2Ehreal(V2X))),ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V2X)),inj__ty_2Ehrat_2Ehrat(V1w))) ) )).

tff(lmtp_f2583,type,(
    f2583: $i > $i )).

tff(lamtp_f2583,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => mem(f2583(V0P),arr(ty_2Ehrat_2Ehrat,bool)) ) )).

tff(lameq_f2583,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V1w: tp__ty_2Ehrat_2Ehrat] : ap(f2583(V0P),inj__ty_2Ehrat_2Ehrat(V1w)) = ap(c_2Ebool_2E_3F(ty_2Ehreal_2Ehreal),f2584(V0P,V1w)) ) )).

tff(ax_thm_2Ehreal_2Ehreal__sup,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => surj__ty_2Ehreal_2Ehreal(ap(c_2Ehreal_2Ehreal__sup,V0P)) = surj__ty_2Ehreal_2Ehreal(ap(c_2Ehreal_2Ehreal,f2583(V0P))) ) )).
...
tff(conj_thm_2Ehreal_2EHREAL__SUP__ISACUT,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
...
tff(conj_thm_2Ehreal_2EHREAL__SUP,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ( ( ? [V1X: tp__ty_2Ehreal_2Ehreal] : p(ap(V0P,inj__ty_2Ehreal_2Ehreal(V1X)))
          & ? [V2Y: tp__ty_2Ehreal_2Ehreal] :
