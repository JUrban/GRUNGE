...
fof(conj_thm_2Ereal__topology_2ESETDIST__REFL,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V0s)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) )).
