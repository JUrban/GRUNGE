...
fof(conj_thm_2Earithmetic_2ENOT__SUC__LESS__EQ,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal_2EREAL__EQ__RADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__LE__ADD2,lemma,(
    ! [V0w] :
      ( mem(V0w,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2ESUM__EQ,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal_2ESUM__1,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(lamtp_f2739,axiom,(
    ! [V2k] :
      ( mem(V2k,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f2739(V2k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f2739,axiom,(
    ! [V2k] :
      ( mem(V2k,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V4r] :
              ( mem(V4r,ty_2Enum_2Enum)
             => ap(f2739(V2k,V0f),V4r) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,V4r),V2k)) ) ) ) )).

fof(conj_thm_2Ereal_2ESUM__REINDEX,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2k] :
             ...
             => ! [V3n] :
                  ( mem(V3n,ty_2Enum_2Enum)
                 => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V1m),V2k)),V3n)),V0f) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1m),V3n)),f2739(V2k,V0f)) ) ) ) ) )).
...
fof(conj_thm_2Ereal_2EREAL__ABS__TRIANGLE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__MIN__LE,lemma,(
    ! [V0z] :
...
fof(conj_thm_2Ereal_2EREAL__MIN__LE1,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__MIN__LE2,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2ESUM__SPLIT,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2n] :
             ...
             => ! [V3p] :
                 ...
                 => ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0m),V2n)),V1f)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V0m),V2n)),V3p)),V1f)) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0m),ap(ap(c_2Earithmetic_2E_2B,V2n),V3p))),V1f) ) ) ) ) )).

fof(conj_thm_2Eintegral_2ELE__0,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => p(ap(ap(c_2Earithmetic_2E_3C_3D,c_2Enum_2E0),V0n)) ) )).

fof(conj_thm_2Eintegral_2EREAL__LT__MIN,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EDIVISION__MONO__LE,lemma,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
               ...
               => ! [V3m] :
                   ...
                   => ! [V4n] :
                       ...
                       => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3m),V4n))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,V3m)),ap(V0d,V4n))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDIVISION__DSIZE__LE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2d] :
             ...
             => ! [V3n] :
                  ( mem(V3n,ty_2Enum_2Enum)
                 => ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),V2d))
                      & ap(V2d,ap(c_2Enum_2ESUC,V3n)) = ap(V2d,V3n) )
                   => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Etransc_2Edsize,V2d)),V3n)) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDIVISION__DSIZE__EQ,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2d] :
             ...
             => ! [V3n] :
                  ( mem(V3n,ty_2Enum_2Enum)
                 => ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),V2d))
                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(V2d,V3n)),ap(V2d,ap(c_2Enum_2ESUC,V3n))))
                      & ap(V2d,ap(c_2Enum_2ESUC,ap(c_2Enum_2ESUC,V3n))) = ap(V2d,ap(c_2Enum_2ESUC,V3n)) )
                   => ap(c_2Etransc_2Edsize,V2d) = ap(c_2Enum_2ESUC,V3n) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDIVISION__DSIZE__EQ__ALT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
             ...
             => ! [V3n] :
                 ...
                 => ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),V2d))
                      ...
                      & ! [V4i] :
                         ...
                         => ( p(ap(ap(c_2Eprim__rec_2E_3C,V4i),V3n))
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(V2d,V4i)),ap(V2d,ap(c_2Enum_2ESUC,V4i)))) ) ) )
                   => ap(c_2Etransc_2Edsize,V2d) = V3n ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDIVISION__INTERMEDIATE,lemma,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
             ...
             => ! [V3c] :
                 ...
                 => ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0d))
                   ...
                   => ? [V4n] :
                        ...
                        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,V4n)),V3c))
                        & p(ap(ap(c_2Ereal_2Ereal__lte,V3c),ap(V0d,ap(c_2Enum_2ESUC,V4n)))) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDINT__COMBINE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
