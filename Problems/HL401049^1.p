...
thf(f1254_0_2E0,type,(
    f1254_0_2E0: u )).

thf(f1254_0_2E1,type,(
    f1254_0_2E1: du > u )).

thf(f1254_1_2E0,type,(
    f1254_1_2E0: u )).

thf(f1254_1_2E1,type,(
    f1254_1_2E1: du > u )).

thf(f1254_1_2E2,type,(
    f1254_1_2E2: du > du > u )).
...
thf(mono_2Ef1254_0,type,(
    mono_2Ef1254_0: ( mono_2Etyop_2Enum_2Enum > $o ) > $o )).

thf(mono_2Ef1254_1,type,(
    mono_2Ef1254_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ewhile_2EOLEAST__def,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ef1254_0 @ V0P )
    <=> ? [V1n: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V1n ) ) )).

thf(def1_2Ethm_2Ewhile_2EOLEAST__def,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1254_1 @ V0P @ V2n )
      = ( V0P @ V2n ) ) )).

thf(thm_2Ewhile_2EOLEAST__def,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Ewhile_2EOLEAST @ V0P )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( mono_2Ef1254_0 @ V0P ) @ ( mono_2Ec_2Eoption_2ESOME_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ewhile_2ELEAST @ ( mono_2Ef1254_1 @ V0P ) ) ) @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) ) )).
