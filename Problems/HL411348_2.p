...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__AT,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__AVOID,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x))))
            & surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V1x))) != V2a )
         => ? [V3e: tp__ty_2Erealax_2Ereal] :
              ...
              & ! [V4y: tp__ty_2Erealax_2Ereal] :
                  ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V4y)))),inj__ty_2Erealax_2Ereal(V3e)))
                 => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V4y))) != V2a ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__OPEN__AVOID,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
