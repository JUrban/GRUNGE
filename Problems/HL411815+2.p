...
fof(conj_thm_2Ereal__topology_2ESERIES__ABSCONV__IMP__CONV,lemma,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k] :
...
fof(conj_thm_2Ereal__topology_2ESERIES__REARRANGE,lemma,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__REARRANGE,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
