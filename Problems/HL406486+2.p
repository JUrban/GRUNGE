...
fof(conj_thm_2Erich__list_2ELENGTH__NOT__NULL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
    ...
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ( p(ap(c_2Ewords_2Eword__lsb(A_27a),V0w))
          <=> p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),c_2Enum_2E0)) ) ) ) )).
...
fof(conj_thm_2Ebitstring_2Eword__lsb__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
