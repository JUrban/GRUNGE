...
thf(f9706_0_2E0,type,(
    f9706_0_2E0: u )).

thf(f9706_0_2E3,type,(
    f9706_0_2E3: du > du > du > u )).

thf(f9706_0_2E4,type,(
    f9706_0_2E4: du > du > du > du > u )).

thf(f9706_1_2E0,type,(
    f9706_1_2E0: u )).

thf(f9706_1_2E3,type,(
    f9706_1_2E3: du > du > du > u )).

thf(f9706_1_2E4,type,(
...
thf(mono_2Ef9706_0,type,(
    mono_2Ef9706_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9706_1,type,(
    mono_2Ef9706_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Epowser_2ETERMDIFF__LEMMA1,axiom,(
    ! [V1z: mono_2Etyop_2Erealax_2Ereal,V2h: mono_2Etyop_2Erealax_2Ereal,V0m: mono_2Etyop_2Enum_2Enum,V3p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9706_0 @ V1z @ V2h @ V0m @ V3p )
      = ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__add @ V1z @ V2h ) @ ( mono_2Ec_2Earithmetic_2E_2D @ V0m @ V3p ) ) @ ( mono_2Ec_2Ereal_2Epow @ V1z @ V3p ) ) @ ( mono_2Ec_2Ereal_2Epow @ V1z @ V0m ) ) ) )).

thf(def1_2Ethm_2Epowser_2ETERMDIFF__LEMMA1,axiom,(
    ! [V1z: mono_2Etyop_2Erealax_2Ereal,V2h: mono_2Etyop_2Erealax_2Ereal,V0m: mono_2Etyop_2Enum_2Enum,V4p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9706_1 @ V1z @ V2h @ V0m @ V4p )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Epow @ V1z @ V4p ) @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__add @ V1z @ V2h ) @ ( mono_2Ec_2Earithmetic_2E_2D @ V0m @ V4p ) ) @ ( mono_2Ec_2Ereal_2Epow @ V1z @ ( mono_2Ec_2Earithmetic_2E_2D @ V0m @ V4p ) ) ) ) ) )).

thf(thm_2Epowser_2ETERMDIFF__LEMMA1,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1z: mono_2Etyop_2Erealax_2Ereal,V2h: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ V0m ) @ ( mono_2Ef9706_0 @ V1z @ V2h @ V0m ) )
      = ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ V0m ) @ ( mono_2Ef9706_1 @ V1z @ V2h @ V0m ) ) ) )).
