...
tff(lmtp_f3278,type,(
    f3278: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3278,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : mem(f3278(V0s,V1a),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3278,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3278(V0s,V1a),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2x))) ) )).

tff(lmtp_f3280,type,(
    f3280: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3280,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3280(V0s,V3b),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3280,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f3280(V0s,V3b),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3b)),inj__ty_2Erealax_2Ereal(V4x))) ) )).

tff(lmtp_f3279,type,(
    f3279: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3279,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : mem(f3279(V0s,V1a),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3279,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] : ap(f3279(V0s,V1a),inj__ty_2Erealax_2Ereal(V3b)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3280(V0s,V3b))),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3b)),inj__ty_2Erealax_2Ereal(V1a))) ) )).

tff(lmtp_f3277,type,(
    f3277: $i > $i )).

tff(lamtp_f3277,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3277(V0s),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3277,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : ap(f3277(V0s),inj__ty_2Erealax_2Ereal(V1a)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3278(V0s,V1a))),ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3279(V0s,V1a))) ) )).

tff(ax_thm_2Eiterate_2Einf,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => surj__ty_2Erealax_2Ereal(ap(c_2Eiterate_2Einf,V0s)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f3277(V0s))) ) )).

tff(conj_thm_2Eiterate_2EREAL__INF__UNIQUE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
