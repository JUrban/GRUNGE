...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__NONOVERLAP,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
         ...
         => ! [V2c_27: $i] :
             ...
             => ( ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1c),ap(c_2Ereal__topology_2Ecomponents,V0s)))
               ...
               => ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V1c),V2c_27) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                <=> V1c != V2c_27 ) ) ) ) ) )).
