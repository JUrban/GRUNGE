...
fof(conj_thm_2Ewords_2Eword__L__MULT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ap(ap(c_2Ewords_2Eword__mul(A_27a),ap(c_2Ewords_2En2w(A_27a),V0n)),c_2Ewords_2Eword__L(A_27a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,V0n)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),c_2Ewords_2Eword__L(A_27a)) ) ) )).
...
fof(conj_thm_2Ewords_2Eword__L__MULT__NEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ap(ap(c_2Ewords_2Eword__mul(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),V0n))),c_2Ewords_2Eword__L(A_27a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,V0n)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),c_2Ewords_2Eword__L(A_27a)) ) ) )).
