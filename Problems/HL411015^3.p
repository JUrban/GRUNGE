...
thf(thm_2Ereal__topology_2EBOUNDED__LINEAR__IMAGE,axiom,(
...
thf(thm_2Ereal__topology_2EBOUNDED__SCALING,conjecture,(
    ! [V0c: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ V1s )
     => ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V2x: tyop_2Erealax_2Ereal] :
              ( c_2Erealax_2Ereal__mul @ V0c @ V2x )
          @ V1s ) ) ) )).
