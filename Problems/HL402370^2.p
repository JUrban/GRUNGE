...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__ELIM,lemma,(
    ! [A_27a: del,V0P: $i] :
         ...
         => ( ( p
          ...
          <=> ( p
              @ ( ap @ ( c_2Ebool_2E_3F_21 @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ V0P @ V3x ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__T,conjecture,(
             ...
             => ( ( p
              ...
              <=> ( p
                  @ ( ap @ ( c_2Ebool_2E_3F_21 @ A_27b )
                    @ ( lam @ A_27b
                      @ ^ [V4x: $i] :
                          ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V4x ) @ V1s ) ) ) ) ) ) ) ) )).
