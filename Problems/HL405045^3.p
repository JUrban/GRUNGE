    ...
    ! [V0t0: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( (~)
          @ ? [V3t1: tyop_2Enum_2Enum] :
            ! [V4t2: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V3t1 @ ( c_2Earithmetic_2E_2B @ V4t2 @ V0t0 ) ) ) )
      <=> ! [V5t1: tyop_2Enum_2Enum] :
          ? [V6t2: tyop_2Enum_2Enum] :
            ( (~) @ ( V2a @ ( c_2Earithmetic_2E_2B @ V5t1 @ ( c_2Earithmetic_2E_2B @ V6t2 @ V0t0 ) ) ) ) )
      & ( ( ? [V7t1: tyop_2Enum_2Enum] :
            ! [V8t2: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V7t1 @ ( c_2Earithmetic_2E_2B @ V8t2 @ V0t0 ) ) )
          & ? [V9t1: tyop_2Enum_2Enum] :
            ! [V10t2: tyop_2Enum_2Enum] :
              ( V1b @ ( c_2Earithmetic_2E_2B @ V9t1 @ ( c_2Earithmetic_2E_2B @ V10t2 @ V0t0 ) ) ) )
      <=> ? [V11t1: tyop_2Enum_2Enum] :
          ! [V12t2: tyop_2Enum_2Enum] :
            ( ( V2a @ ( c_2Earithmetic_2E_2B @ V11t1 @ ( c_2Earithmetic_2E_2B @ V12t2 @ V0t0 ) ) )
            & ( V1b @ ( c_2Earithmetic_2E_2B @ V11t1 @ ( c_2Earithmetic_2E_2B @ V12t2 @ V0t0 ) ) ) ) )
      & ( ( ? [V13t1: tyop_2Enum_2Enum] :
            ! [V14t2: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V13t1 @ ( c_2Earithmetic_2E_2B @ V14t2 @ V0t0 ) ) )
          | ? [V15t1: tyop_2Enum_2Enum] :
            ! [V16t2: tyop_2Enum_2Enum] :
              ( V1b @ ( c_2Earithmetic_2E_2B @ V15t1 @ ( c_2Earithmetic_2E_2B @ V16t2 @ V0t0 ) ) ) )
      <=> ? [V17q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V17q @ V0t0 ) )
            & ! [V18t: tyop_2Enum_2Enum] :
                ( ( V17q @ ( c_2Earithmetic_2E_2B @ V18t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                = ( c_2Ebool_2ECOND @ $o @ ( V17q @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) @ ( V1b @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) @ ( c_2Ebool_2E_7E @ ( V2a @ ( c_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) ) ) )
            & ? [V19t1: tyop_2Enum_2Enum] :
              ! [V20t2: tyop_2Enum_2Enum] :
                ( ( (~) @ ( V17q @ ( c_2Earithmetic_2E_2B @ V19t1 @ ( c_2Earithmetic_2E_2B @ V20t2 @ V0t0 ) ) ) )
                | ( V1b @ ( c_2Earithmetic_2E_2B @ V19t1 @ ( c_2Earithmetic_2E_2B @ V20t2 @ V0t0 ) ) ) ) ) ) ) )).
