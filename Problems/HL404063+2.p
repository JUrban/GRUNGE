...
fof(conj_thm_2Equotient_2EEXISTS__UNIQUE__REGULAR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1E] :
              ( mem(V1E,arr(A_27a,arr(A_27a,bool)))
             => ! [V2Q] :
                  ( mem(V2Q,arr(A_27a,bool))
                 => ( ( ! [V3x] :
                          ( mem(V3x,A_27a)
                         => ( p(ap(V0P,V3x))
                           => ( p(ap(ap(c_2Equotient_2Erespects(A_27a,A_27a),V1E),V3x))
                              & p(ap(V2Q,V3x)) ) ) )
                      & ! [V4x] :
                          ( mem(V4x,A_27a)
                         => ! [V5y] :
                              ( mem(V5y,A_27a)
                             => ( ( p(ap(ap(c_2Equotient_2Erespects(A_27a,A_27a),V1E),V4x))
                                  & p(ap(V2Q,V4x))
                                  & p(ap(ap(c_2Equotient_2Erespects(A_27a,A_27a),V1E),V5y))
                                  & p(ap(V2Q,V5y)) )
                               => p(ap(ap(V1E,V4x),V5y)) ) ) ) )
                   => ( p(ap(c_2Ebool_2E_3F_21(A_27a),V0P))
                     => p(ap(ap(c_2Equotient_2ERES__EXISTS__EQUIV(A_27a),V1E),V2Q)) ) ) ) ) ) ) )).
