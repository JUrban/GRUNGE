...
thf(tp_c_2Emergesort_2Esort3__tail,type,(
    c_2Emergesort_2Esort3__tail: del > $i )).

thf(mem_c_2Emergesort_2Esort3__tail,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Emergesort_2Esort3__tail__def,axiom,(
...
thf(conj_thm_2Emergesort_2Esort3__tail__correct,conjecture,(
    ! [A_27a: del,V0neg: $o,V1R: $i] :
      ( ( mem @ V1R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V2x: $i] :
          ( ( mem @ V2x @ A_27a )
         => ! [V3y: $i] :
             ...
             => ! [V4z: $i] :
                  ( ( mem @ V4z @ A_27a )
                 => ( ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort3__tail @ A_27a ) @ ( inj__o @ V0neg ) ) @ V1R ) @ V2x ) @ V3y ) @ V4z )
                    = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( inj__o @ V0neg ) ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort3 @ A_27a ) @ V1R ) @ V2x ) @ V3y ) @ V4z ) ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Esort3 @ A_27a ) @ V1R ) @ V2x ) @ V3y ) @ V4z ) ) ) ) ) ) ) )).
