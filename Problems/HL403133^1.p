...
thf(f3714_0_2E0,type,(
    f3714_0_2E0: u )).

thf(f3714_0_2E1,type,(
    f3714_0_2E1: du > u )).

thf(f3714_1_2E0,type,(
    f3714_1_2E0: u )).

thf(f3714_1_2E1,type,(
    f3714_1_2E1: du > u )).

thf(f3714_2_2E0,type,(
    f3714_2_2E0: u )).

thf(f3714_2_2E1,type,(
    f3714_2_2E1: du > u )).

thf(f3714_3_2E0,type,(
    f3714_3_2E0: u )).

thf(f3714_3_2E1,type,(
    f3714_3_2E1: du > u )).
...
thf(mono_2Ef3714_0,type,(
    mono_2Ef3714_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3714_1,type,(
    mono_2Ef3714_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3714_2,type,(
    mono_2Ef3714_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3714_3,type,(
    mono_2Ef3714_3: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESBEFORE__SIMP,axiom,(
    ! [V8t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3714_3 @ V8t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2ESBEFORE__SIMP,axiom,(
    ! [V5t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3714_1 @ V5t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2ESBEFORE__SIMP,axiom,(
    ! [V6t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3714_2 @ V6t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2ESBEFORE__SIMP,axiom,(
    ! [V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3714_0 @ V3t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2ETemporal__Logic_2ESBEFORE__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ mono_2Ef3714_0 @ V0b @ V2x )
          = mono_2Ec_2Ebool_2EF )
      & ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ mono_2Ef3714_1 @ V0b @ V4x )
        <=> ( (~) @ ( V0b @ V4x ) ) )
      & ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V1a @ mono_2Ef3714_2 )
        = ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V1a ) )
      & ! [V7x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V1a @ mono_2Ef3714_3 @ V7x )
          = mono_2Ec_2Ebool_2EF )
      & ! [V9x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V1a @ V1a @ V9x )
          = mono_2Ec_2Ebool_2EF ) ) )).
