...
tff(conj_thm_2Earithmetic_2ESUB__RIGHT__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ewords_2ECONCAT__EXTRACT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0h: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2l: tp__ty_2Enum_2Enum,V3w: $i] :
     ...
     => ( ( surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0h)),inj__ty_2Enum_2Enum(V1m))) = surj__ty_2Enum_2Enum(ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))
          ...
          & surj__ty_2Enum_2Enum(ap(c_2Efcp_2Edimindex(ty_2Esum_2Esum(A_27b,A_27b)),c_2Ebool_2Ethe__value(ty_2Esum_2Esum(A_27b,A_27b)))) != surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))) )
       => ap(ap(c_2Ewords_2Eword__concat(A_27b,A_27b,A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V0h)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V3w)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2l)),V3w)) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V0h)),inj__ty_2Enum_2Enum(V2l)),V3w) ) ) )).
