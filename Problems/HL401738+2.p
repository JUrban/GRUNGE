...
fof(conj_thm_2Epred__set_2ESUM__IMAGE__lower__bound,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
               ...
               => ! [V2n] :
                   ...
                   => ( ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                           => p(ap(ap(c_2Earithmetic_2E_3C_3D,V2n),ap(V0f,V3x))) ) )
                     => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2A,ap(c_2Epred__set_2ECARD(A_27a),V1s)),V2n)),ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V0f),V1s))) ) ) ) ) ) ) )).
