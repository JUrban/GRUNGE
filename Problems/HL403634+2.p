     ...
     => ! [V0x] :
         ...
         => ! [V4f] :
             ...
             => ! [V5c] :
                 ...
                 => ap(f1100(A_27a,V1y,V0x,V4f),V5c) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0x),V5c)),V1y),ap(V4f,V5c)) ) ) ) ) )).

fof(conj_thm_2Efcp_2Efcp__subst__comp,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V1y] :
                         ...
                         => ! [V2a] :
                             ...
                             => ! [V3b] :
                                 ...
                                 => ! [V4f] :
                                      ( mem(V4f,arr(ty_2Enum_2Enum,A_27a))
                                     => ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),V0x),V1y),ap(c_2Efcp_2EFCP(A_27a,A_27a),V4f)) = ap(c_2Efcp_2EFCP(A_27a,A_27a),f1100(A_27a,V1y,V0x,V4f)) ) ) ) ) ) ) ) ) ) )).
