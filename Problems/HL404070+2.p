...
fof(lameq_f921,axiom,(
    ! [V0a] :
     ...
     => ! [V1t] :
         ...
         => ap(f921(V0a),V1t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f889(V0a)),V1t)) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EALWAYS__AS__SUNTIL,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ap(c_2ETemporal__Logic_2EALWAYS,V0a) = f921(V0a) ) )).

fof(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__SUNTIL,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1293,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1293(V0a),V2t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f882(V0a)),V2t)) ) ) )).

fof(lamtp_f1294,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1294,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
         ...
         => ap(f1294(V0a),V5t) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a),V5t) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V7t] :
             ...
             => ap(f1295(V0a,V1b),V7t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1296(V1b)),f1297(V0a,V1b)),V7t)) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V10t] :
             ...
             => ap(f1298(V0a,V1b),V10t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1299(V0a,V1b)),f1300(V0a,V1b)),V10t)) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V13t] :
             ...
             => ap(f1301(V0a,V1b),V13t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1302(V0a)),V1b),V13t)) ) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V15t] :
             ...
             => ap(f1303(V1b,V0a),V15t) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1304(V1b)),f1305(V0a,V1b)),V15t) ) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V18t] :
             ...
             => ap(f1306(V1b,V0a),V18t) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1307(V1b)),f1308(V0a,V1b)),V18t) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ESUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
