...
tff(mem_c_2Ewellorder_2EfromNatWO,axiom,(
    ! [A_27a: del] : mem(c_2Ewellorder_2EfromNatWO(A_27a),arr(ty_2Enum_2Enum,ty_2Ewellorder_2Ewellorder(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).
...
tff(lmtp_f1027,type,(
    f1027: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1027,axiom,(
...
tff(lameq_f1027,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Enum_2Enum,V2j: tp__ty_2Enum_2Enum] : ap(f1027(A_27a,V0n,V1i),inj__ty_2Enum_2Enum(V2j)) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1i))),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2j)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1i)),inj__ty_2Enum_2Enum(V2j))),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2j)),inj__ty_2Enum_2Enum(V0n)))) )).

tff(lmtp_f1026,type,(
    f1026: ( del * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1026,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : mem(f1026(A_27a,V0n),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))))) )).

tff(lameq_f1026,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Enum_2Enum] : ap(f1026(A_27a,V0n),inj__ty_2Enum_2Enum(V1i)) = f1027(A_27a,V0n,V1i) )).

tff(conj_thm_2Ewellorder_2Ewellorder__fromNat__SUM,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : p(ap(c_2Ewellorder_2Ewellorder(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f1026(A_27a,V0n))))) )).

tff(ax_thm_2Ewellorder_2EfromNatWO__def,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(c_2Ewellorder_2EfromNatWO(A_27a),inj__ty_2Enum_2Enum(V0n)) = ap(c_2Ewellorder_2Ewellorder__ABS(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f1026(A_27a,V0n)))) )).

tff(conj_thm_2Ewellorder_2EelsOf__fromNatWO,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(c_2Ewellorder_2EelsOf(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Ewellorder_2EfromNatWO(A_27a),inj__ty_2Enum_2Enum(V0n))) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V0n))) )).
