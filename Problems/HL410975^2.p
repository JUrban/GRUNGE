...
thf(conj_thm_2Ereal__topology_2ESEQ__HARMONIC__OFFSET,lemma,(
      ...
      @ ( ap
        @ ( ap
          @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1n: $i] :
                  ( ap @ c_2Erealax_2Einv @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Ereal__of__num @ V1n ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) )
          @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
        @ c_2Ereal__topology_2Esequentially ) ) )).

thf(conj_thm_2Ereal__topology_2ESEQ__HARMONIC,conjecture,
    ( p
    @ ( ap
      @ ( ap
        @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V0n: $i] :
                ( ap @ c_2Erealax_2Einv @ ( ap @ c_2Ereal_2Ereal__of__num @ V0n ) ) ) )
        @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      @ c_2Ereal__topology_2Esequentially ) )).
