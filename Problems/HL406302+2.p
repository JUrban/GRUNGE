...
fof(mem_c_2Erelation_2ELinearOrder,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Erelation_2ELinearOrder(A_27a),arr(arr(A_27a,arr(A_27a,bool)),bool)) ) )).

fof(mem_c_2Erelation_2EOrder,axiom,(
    ! [A_27g] :
      ( ne(A_27g)
     => mem(c_2Erelation_2EOrder(A_27g),arr(arr(A_27g,arr(A_27g,bool)),bool)) ) )).
...
fof(conj_thm_2Erelation_2EStrongOrd__Ord,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(ax_thm_2Erelation_2ELinearOrder,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Etoto_2EStrongLinearOrderExists,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ? [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Etoto_2ETotOrd__TO__of__LO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Etoto_2ETO__exists,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ? [V0x] :
