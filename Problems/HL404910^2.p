...
thf(conj_thm_2Elbtree_2Emmindex__EXISTS,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
                ...
                @ ( ap @ ( c_2Elist_2EEXISTS @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2e: $i] :
                        ...
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V3n: $i] :
                              ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( ap @ V0f @ V2e ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ V3n ) ) ) ) ) )
                @ V1l ) )
           => ? [V4i: tp__ty_2Enum_2Enum,V5m: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Elbtree_2Eis__mmindex @ A_27a ) @ V0f ) @ V1l ) @ ( inj__ty_2Enum_2Enum @ V4i ) ) @ ( inj__ty_2Enum_2Enum @ V5m ) ) ) ) ) ) )).
