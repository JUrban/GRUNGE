...
tff(lamtp_f3003,axiom,(
    ! [V0g: $i] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3003(V0g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3003,axiom,(
    ! [V0g: $i] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3003(V0g),inj__ty_2Erealax_2Ereal(V3x)) = ap(c_2Etransc_2Eln,ap(V0g,inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(conj_thm_2Etransc_2EDIFF__LN__COMPOSITE,conjecture,(
    ! [V0g: $i] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1m: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
         ...
         => p(ap(ap(ap(c_2Elim_2Ediffl,f3003(V0g)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,ap(V0g,inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V1m))),inj__ty_2Erealax_2Ereal(V2x))) ) ) )).
