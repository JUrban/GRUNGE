...
tff(conj_thm_2Efinite__map_2EDRESTRICT__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(A_27a,bool))
     => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V0r) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) )).

tff(conj_thm_2Efinite__map_2EDRESTRICT__FUPDATE,lemma,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__DRESTRICT,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1P: $i] :
         ...
         => ! [V2Q: $i] :
             ...
             => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),V1P)),V2Q) = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINTER(A_27a),V1P),V2Q)) ) ) ) )).
