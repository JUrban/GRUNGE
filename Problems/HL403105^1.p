...
thf(f3686_0_2E0,type,(
    f3686_0_2E0: u )).

thf(f3686_0_2E1,type,(
    f3686_0_2E1: du > u )).

thf(f3686_1_2E0,type,(
    f3686_1_2E0: u )).

thf(f3686_1_2E1,type,(
    f3686_1_2E1: du > u )).

thf(f3686_1_2E2,type,(
    f3686_1_2E2: du > du > u )).
...
thf(mono_2Ef3686_0,type,(
    mono_2Ef3686_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3686_1,type,(
    mono_2Ef3686_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EALWAYS__AS__SWHEN,axiom,(
    ! [V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3686_0 @ V2t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EALWAYS__AS__SWHEN,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3686_1 @ V0a @ V3t )
    <=> ( (~) @ ( V0a @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EALWAYS__AS__SWHEN,conjecture,(
    ! [V0a: mono_2Etyop_2Enum_2Enum > $o,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ V0a @ V1x )
    <=> ( (~) @ ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ mono_2Ef3686_0 @ ( mono_2Ef3686_1 @ V0a ) @ V1x ) ) ) )).
