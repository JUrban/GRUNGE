...
thf(conj_thm_2Ealist_2EALOOKUP__SOME__FAPPLY__alist__to__fmap,lemma,(
    ! [A_27a: del,A_27b: del,V0al: $i] :
      ( ( mem @ V0al @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ A_27a )
...
thf(conj_thm_2Ealist_2EFUPDATE__LIST__EQ__APPEND__REVERSE,lemma,(
...
thf(conj_thm_2Ealist_2EFLOOKUP__FUPDATE__LIST__ALOOKUP__SOME,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
