...
thf(c_2Eoption_2EOPTREL_2E1,type,(
    c_2Eoption_2EOPTREL_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Eoption_2EOPTREL_2E1_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Eoption_2EOPTREL_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ c_2Eoption_2EOPTREL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Eoption_2EOPTREL_2E3_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
...
thf(arityeq3_2Emono_2Ec_2Eoption_2Eoption__CASE_2E3_2Emono_2EA_27a_20mono_2Etyop_2Eoption_2Eoption_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X2_2E0 ) ) )
...
thf(thm_2Eoption_2Eoption__CLAUSES,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2e_2E0: u] :
      ( ! [V3x_2E0: u,V4y_2E0: u] :
          ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3x_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V4y_2E0 ) ) ) )
        <=> ( ( s @ A_27a @ V3x_2E0 )
            = ( s @ A_27a @ V4y_2E0 ) ) )
      & ! [V5x_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V5x_2E0 ) ) ) ) )
          = ( s @ A_27a @ V5x_2E0 ) )
      & ! [V6x_2E0: u] :
          ( (~)
          @ ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V6x_2E0 ) ) ) ) )
      & ! [V7x_2E0: u] :
          ( (~)
          @ ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V7x_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )
      & ! [V8x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V8x_2E0 ) ) ) ) ) )
          = mono_2Ec_2Ebool_2ET )
      & ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2EF )
      & ! [V9x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__NONE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V9x_2E0 ) ) ) )
        <=> ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V9x_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )
      & ! [V10x_2E0: u] :
          ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V10x_2E0 ) ) ) ) )
        <=> ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V10x_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )
      & ! [V11x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V11x_2E0 ) ) ) )
         => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V11x_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V11x_2E0 ) ) )
      & ! [V12x_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V12x_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ c_2Eoption_2ESOME_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V12x_2E0 ) )
      & ! [V13x_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V13x_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V13x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ c_2Eoption_2ESOME_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V13x_2E0 ) )
      & ! [V14x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__NONE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V14x_2E0 ) ) ) )
         => ( ( s @ A_27b @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V14x_2E0 ) @ ( s @ A_27b @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) )
            = ( s @ A_27b @ V2e_2E0 ) ) )
      & ! [V15x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V15x_2E0 ) ) ) )
         => ( ( s @ A_27b @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V15x_2E0 ) @ ( s @ A_27b @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) )
            = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V15x_2E0 ) ) ) ) ) ) )
      & ! [V16x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EIS__SOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V16x_2E0 ) ) ) )
         => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V16x_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ c_2Eoption_2ESOME_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V16x_2E0 ) ) )
      & ! [V17v_2E0: u,V18f_2E0: u] :
          ( ( s @ A_27b @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ A_27b @ V17v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V18f_2E0 ) ) )
          = ( s @ A_27b @ V17v_2E0 ) )
      & ! [V19x_2E0: u,V20v_2E0: u,V21f_2E0: u] :
          ( ( s @ A_27b @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V19x_2E0 ) ) ) @ ( s @ A_27b @ V20v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V21f_2E0 ) ) )
          = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V21f_2E0 ) @ ( s @ A_27a @ V19x_2E0 ) ) ) )
      & ! [V22f_2E0: u,V23x_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V22f_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V23x_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V22f_2E0 ) @ ( s @ A_27a @ V23x_2E0 ) ) ) ) ) )
      & ! [V24f_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V24f_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )
      ...
      & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2EOPTION__JOIN_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V25x_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2EOPTION__JOIN_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V25x_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V25x_2E0 ) ) ) )).
...
thf(thm_2Equotient__option_2EOPTION__REL__EQ,conjecture,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Eoption_2EOPTREL_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ c_2Emin_2E_3D_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ c_2Emin_2E_3D_2E0 ) ) )).
