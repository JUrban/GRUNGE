...
tff(conj_thm_2Epatricia__casts_2El2n__11,lemma,(
...
tff(conj_thm_2Epatricia__casts_2EEVERY__MAP__ORD,lemma,(
...
tff(conj_thm_2Epatricia__casts_2EMAP__11,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Epatricia__casts_2EREVERSE__11,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Epatricia__casts_2Estring__to__num__11,conjecture,(
