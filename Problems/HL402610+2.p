...
fof(lamtp_f776,axiom,(
    ! [A_27a,A_27a] : mem(f776(A_27a,A_27a),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,ty_2Elist_2Elist(A_27a)))) )).

fof(lameq_f776,axiom,(
    ! [A_27a,A_27a,V1l_27] :
      ( mem(V1l_27,ty_2Elist_2Elist(A_27a))
     => ap(f776(A_27a,A_27a),V1l_27) = f777(A_27a,A_27a,V1l_27) ) )).

fof(conj_thm_2Erich__list_2EREVERSE__FOLDL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
