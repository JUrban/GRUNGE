...
tff(thm_2Ebool_2EABS__REP__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u] :
      ( ? [V1rep_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2ETYPE__DEFINITION_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27b,A_27a),V1rep_2E0)))))
     => ? [V2rep_2E0: u,V3abs_2E0: u] :
          ( ! [V4a_2E0: u] : s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V3abs_2E0),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V2rep_2E0),s(A_27b,V4a_2E0))))) = s(A_27b,V4a_2E0)
          & ! [V5r_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(A_27a,V5r_2E0)))))
