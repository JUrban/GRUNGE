...
thf(tp_c_2Eintegral_2Eintegrable,type,(
    c_2Eintegral_2Eintegrable: $i )).

thf(mem_c_2Eintegral_2Eintegrable,axiom,(
...
thf(tp_c_2Etransc_2EDint,type,(
    c_2Etransc_2EDint: $i )).

thf(mem_c_2Etransc_2EDint,axiom,(
...
thf(tp_c_2Etransc_2Egauge,type,(
    c_2Etransc_2Egauge: $i )).

thf(mem_c_2Etransc_2Egauge,axiom,(
...
thf(ax_thm_2Eintegral_2Eintegrable__def,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2f: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ V2f ) )
      <=> ? [V3i: tp__ty_2Erealax_2Ereal] :
            ( p @ ( ap @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ V2f ) @ ( inj__ty_2Erealax_2Ereal @ V3i ) ) ) ) ) )).

thf(conj_thm_2Eintegral_2EDINT__WRONG,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( ( mem @ V2f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V3i: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) )
         => ( p @ ( ap @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ V2f ) @ ( inj__ty_2Erealax_2Ereal @ V3i ) ) ) ) ) )).

thf(conj_thm_2Eintegral_2EREAL__ARCH__POW2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
    ? [V1n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).

thf(conj_thm_2Eintegral_2EGAUGE__MIN__FINITE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1gs: $i] :
          ( ( mem @ V1gs @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
         => ! [V2n: tp__ty_2Enum_2Enum] :
              ( ! [V3m: tp__ty_2Enum_2Enum] :
                  ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                 => ( p @ ( ap @ ( ap @ c_2Etransc_2Egauge @ V0s ) @ ( ap @ V1gs @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) )
             => ? [V4g: $i] :
                  ( ( mem @ V4g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                  & ( p @ ( ap @ ( ap @ c_2Etransc_2Egauge @ V0s ) @ V4g ) )
                  & ! [V5d: $i] :
                      ( ( mem @ V5d @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                     => ! [V6p: $i] :
                          ( ( mem @ V6p @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                         => ( ( p @ ( ap @ ( ap @ c_2Etransc_2Efine @ V4g ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V5d ) @ V6p ) ) )
                           => ! [V7m: tp__ty_2Enum_2Enum] :
                                ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V7m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                               => ( p @ ( ap @ ( ap @ c_2Etransc_2Efine @ ( ap @ V1gs @ ( inj__ty_2Enum_2Enum @ V7m ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V5d ) @ V6p ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__LINV__UNIQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
     ...
     => ( V0x
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__LT__DIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
     ...
     => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__ABS__TRIANGLE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).

thf(conj_thm_2Ereal_2EREAL__DIV__INNER__CANCEL2,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1z: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) ) ) )).
...
thf(conj_thm_2Eseq_2ESEQ__CAUCHY,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Eseq_2Ecauchy @ V0f ) )
      <=> ( p @ ( ap @ c_2Eseq_2Econvergent @ V0f ) ) ) ) )).

thf(ax_thm_2Etransc_2EDint,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( ( mem @ V2f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V3k: tp__ty_2Erealax_2Ereal] :
        ...
        <=> ! [V4e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V5g: $i] :
                  ...
                  & ( p
                    @ ( ap
                      @ ( ap @ c_2Etransc_2Egauge
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V6x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V6x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V6x ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) )
                      @ V5g ) )
                  & ! [V7D: $i] :
...
thf(conj_thm_2Etransc_2EDIVISION__EXISTS,lemma,(
          ...
          & ( p
            @ ( ap
              @ ( ap @ c_2Etransc_2Egauge
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V3x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V3x ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) )
              @ V2g ) ) )
       => ? [V4D: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,conjecture,(
    ! [V0f: $i] :
                  ...
                  & ( p
                    @ ( ap
                      @ ( ap @ c_2Etransc_2Egauge
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V5x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ V5x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V5x ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) ) )
                      @ V4g ) )
                  & ! [V6d1: $i] :
                      ( ( mem @ V6d1 @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                     => ! [V7p1: $i] :
                          ( ( mem @ V7p1 @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                         => ! [V8d2: $i] :
                              ( ( mem @ V8d2 @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                             => ! [V9p2: $i] :
                                  ( ( mem @ V9p2 @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                                 => ( ( ( p @ ( ap @ ( ap @ c_2Etransc_2Etdiv @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V6d1 ) @ V7p1 ) ) )
                                      & ( p @ ( ap @ ( ap @ c_2Etransc_2Efine @ V4g ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V6d1 ) @ V7p1 ) ) )
                                      & ( p @ ( ap @ ( ap @ c_2Etransc_2Etdiv @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V8d2 ) @ V9p2 ) ) )
                                      & ( p @ ( ap @ ( ap @ c_2Etransc_2Efine @ V4g ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V8d2 ) @ V9p2 ) ) ) )
                                   => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Etransc_2Ersum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V6d1 ) @ V7p1 ) ) @ V0f ) ) @ ( ap @ ( ap @ c_2Etransc_2Ersum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V8d2 ) @ V9p2 ) ) @ V0f ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) ) ) ) ) ) ) ) ) ) )).
