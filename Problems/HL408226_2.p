...
tff(lamtp_f2877,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2877(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2877,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2877(V0f),inj__ty_2Enum_2Enum(V2n)) = ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V2n))) ) )).
...
tff(conj_thm_2Eseq_2ESER__ABS,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Epowser_2ETERMDIFF__LEMMA4,lemma,(
    ! [V0f: $i] :
...
tff(lameq_f2952,axiom,(
    ! [V1g: $i] :
      ( mem(V1g,arr(ty_2Erealax_2Ereal,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5h: tp__ty_2Erealax_2Ereal] : ap(f2952(V1g),inj__ty_2Erealax_2Ereal(V5h)) = ap(c_2Eseq_2Esuminf,ap(V1g,inj__ty_2Erealax_2Ereal(V5h))) ) )).

tff(conj_thm_2Epowser_2ETERMDIFF__LEMMA5,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
         => ! [V2k: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Elim_2Etends__real__real,f2952(V1g)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) ) )).
