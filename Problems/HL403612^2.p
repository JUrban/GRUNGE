...
thf(conj_thm_2Esum_2EINL,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) )
     => ( ( p @ ( ap @ ( c_2Esum_2EISL @ A_27a @ A_27b ) @ V0x ) )
       => ( ( ap @ ( c_2Esum_2EINL @ A_27a @ A_27b ) @ ( ap @ ( c_2Esum_2EOUTL @ A_27a @ A_27b ) @ V0x ) )
          = V0x ) ) ) )).

thf(conj_thm_2Esum_2EINR,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) )
     => ( ( p @ ( ap @ ( c_2Esum_2EISR @ A_27a @ A_27b ) @ V0x ) )
       => ( ( ap @ ( c_2Esum_2EINR @ A_27a @ A_27b ) @ ( ap @ ( c_2Esum_2EOUTR @ A_27a @ A_27b ) @ V0x ) )
          = V0x ) ) ) )).

thf(conj_thm_2Esum_2ENOT__ISL__ISR,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) )
     => ( ~ ( p @ ( ap @ ( c_2Esum_2EISL @ A_27a @ A_27b ) @ V0x ) )
      <=> ( p @ ( ap @ ( c_2Esum_2EISR @ A_27a @ A_27b ) @ V0x ) ) ) ) )).

thf(conj_thm_2Esum_2ENOT__ISR__ISL,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) )
     => ( ~ ( p @ ( ap @ ( c_2Esum_2EISR @ A_27a @ A_27b ) @ V0x ) )
      <=> ( p @ ( ap @ ( c_2Esum_2EISL @ A_27a @ A_27b ) @ V0x ) ) ) ) )).

thf(conj_thm_2Efcp_2Eindex__sum,conjecture,(
    ! [A_27a: del,A_27b: del] :
