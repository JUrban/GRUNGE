...
fof(conj_thm_2Erich__list_2EFOLDL__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f1947,axiom,(
    ! [A_27b,A_27a,A_27a,A_27b,V3v] :
      ( mem(V3v,A_27b)
     => ! [V2k] :
          ( mem(V2k,A_27a)
...
fof(lamtp_f1946,axiom,(
    ! [A_27a,A_27a,A_27b,A_27b,V2k] :
      ( mem(V2k,A_27a)
...
fof(lamtp_f1945,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a] : mem(f1945(A_27b,A_27b,A_27a,A_27a),arr(A_27a,arr(A_27b,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a))))) )).

fof(lameq_f1945,axiom,(
    ! [A_27b,A_27b,A_27a,A_27a,V2k] :
      ( mem(V2k,A_27a)
     => ap(f1945(A_27b,A_27b,A_27a,A_27a),V2k) = f1946(A_27a,A_27a,A_27b,A_27b,V2k) ) )).

fof(conj_thm_2Efinite__map_2Efupdate__list__foldr,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
