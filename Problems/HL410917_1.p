...
tff(thm_2Ereal__topology_2ENET__DILEMMA,axiom,(
    ! [A_27a: d,V0Q_2E0: u,V1P_2E0: u,V2net_2E0: u] :
      ( ( ? [V3a_2E0: u] :
            ( ? [V4x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V4x_2E0),s(A_27a,V3a_2E0)))))
            & ! [V5x_2E0: u] :
                ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V5x_2E0),s(A_27a,V3a_2E0)))))
        ...
        & ? [V6b_2E0: u] :
            ( ? [V7x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V7x_2E0),s(A_27a,V6b_2E0)))))
            & ! [V8x_2E0: u] :
                ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V8x_2E0),s(A_27a,V6b_2E0)))))
               => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0Q_2E0),s(A_27a,V8x_2E0))))) ) ) )
     => ? [V9c_2E0: u] :
          ( ? [V10x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V10x_2E0),s(A_27a,V9c_2E0)))))
          & ! [V11x_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V2net_2E0),s(A_27a,V11x_2E0),s(A_27a,V9c_2E0)))))
             => ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V11x_2E0)))))
                & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0Q_2E0),s(A_27a,V11x_2E0))))) ) ) ) ) )).

tff(thm_2Ereal__topology_2ELIM,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1l_2E0: mono_2Etyop_2Erealax_2Ereal,V2f_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2E_2D_2D_3E_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V2f_2E0),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(V1l_2E0)),s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0)))))
    <=> ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Etrivial__limit_2E1(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0)))))
        | ! [V3e_2E0: mono_2Etyop_2Erealax_2Ereal] :
           ...
           => ? [V4y_2E0: u] :
                ( ? [V5x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(A_27a,V5x_2E0),s(A_27a,V4y_2E0)))))
                & ! [V6x_2E0: u] :
                    ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(A_27a,V6x_2E0),s(A_27a,V4y_2E0)))))
                   => p(mono_2Ec_2Erealax_2Ereal__lt_2E2(mono_2Ec_2Ereal__topology_2EDist_2E1(mono_2Ec_2Epair_2E_2C_2E2_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal(j_mono_2Etyop_2Erealax_2Ereal(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V2f_2E0),s(A_27a,V6x_2E0)))),V1l_2E0)),V3e_2E0)) ) ) ) ) ) )).
...
tff(thm_2Ereal__topology_2ELIM__ADD,conjecture,(
