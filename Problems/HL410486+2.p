...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__SUBSET,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__TRIPLES,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__BETWEEN__CASES,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__1,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(c_2Ereal__topology_2Ecollinear,V0s)) ) )).
