...
thf(conj_thm_2Ellist_2ELTL__HD__iff,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Ellist_2ELUNFOLD__LTL__HD,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL__HD @ A_27a ) ) @ V0ll )
        = V0ll ) ) )).

thf(conj_thm_2Ellist_2ELUNFOLD__BISIMULATION,lemma,(
...
thf(conj_thm_2Ellist_2ELLIST__BISIMULATION0,conjecture,(
    ! [A_27a: del,V0ll1: $i] :
