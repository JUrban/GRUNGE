...
tff(conj_thm_2Elist_2ELIST__REL__LENGTH,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2y: $i] :
             ...
             => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V1x),V2y))
...
tff(conj_thm_2Elist_2EEVERY2__THM,lemma,(
...
tff(conj_thm_2Erich__list_2EEVERY2__DROP,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
         => ! [V2l2: $i] :
             ...
             => ! [V3n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V1l1),V2l2))
                 => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EDROP(A_27a),inj__ty_2Enum_2Enum(V3n)),V1l1)),ap(ap(c_2Elist_2EDROP(A_27b),inj__ty_2Enum_2Enum(V3n)),V2l2))) ) ) ) ) )).
