...
tff(tp_c_2Eextreal_2Eext__mono__decreasing,type,(
    c_2Eextreal_2Eext__mono__decreasing: $i )).

tff(mem_c_2Eextreal_2Eext__mono__decreasing,axiom,(
...
tff(ax_thm_2Eextreal_2Eext__mono__decreasing__def,axiom,(
    ! [V0f: $i] :
...
tff(conj_thm_2Eextreal_2Eext__mono__decreasing__suc,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( p(ap(c_2Eextreal_2Eext__mono__decreasing,V0f))
