...
fof(conj_thm_2Epred__set_2EPOW__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Epred__set_2Epow__no__surj,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2Einfinite__pow__uncountable,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
