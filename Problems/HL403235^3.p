...
thf(thm_2Ebag_2EBAG__INN__BAG__DELETE,conjecture,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2e: A_27a] :
      ( ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e @ V1n @ V0b )
        & ( c_2Earithmetic_2E_3E @ V1n @ c_2Enum_2E0 ) )
     => ? [V3b_27: A_27a > tyop_2Enum_2Enum] :
          ( c_2Ebag_2EBAG__DELETE @ A_27a @ V0b @ V2e @ V3b_27 ) ) )).
