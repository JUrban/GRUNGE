...
fof(conj_thm_2Emeasure_2EALGEBRA__INTER__SPACE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Esubsets(A_27a),V0a))) )
               => ( ap(ap(c_2Epred__set_2EINTER(A_27a),ap(c_2Emeasure_2Espace(A_27a),V0a)),V1s) = V1s
                  & ap(ap(c_2Epred__set_2EINTER(A_27a),V1s),ap(c_2Emeasure_2Espace(A_27a),V0a)) = V1s ) ) ) ) ) )).

fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__STRONG__ADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
                 ...
                 => ! [V3l1] :
                     ...
                     => ! [V4l2] :
                         ...
                         => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0g0))
                           ...
                           => ap(V1lam,ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EUNION(A_27a),V3l1),V4l2)),V2g)) = ap(ap(c_2Erealax_2Ereal__add,ap(V1lam,ap(ap(c_2Epred__set_2EINTER(A_27a),V3l1),V2g))),ap(V1lam,ap(ap(c_2Epred__set_2EINTER(A_27a),V4l2),V2g))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ADDITIVE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1lam] :
                     ...
                     => ! [V2l1] :
                         ...
                         => ! [V3l2] :
                             ...
                             => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0g0))
                                  & p(ap(c_2Emeasure_2Epositive(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0g0)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27a),V0g0)),V1lam)))) )
                               => p(ap(c_2Emeasure_2Eadditive(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0g0)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(ap(c_2Emeasure_2Elambda__system(A_27a),V0g0),V1lam)),V1lam)))) ) ) ) ) ) ) ) ) )).
