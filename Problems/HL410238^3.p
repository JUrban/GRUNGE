...
thf(thm_2Emeasure_2EIN__SIGMA,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1a: ( A_27a > $o ) > $o,V2x: A_27a > $o] :
      ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2x @ V1a )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2x @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1a ) ) ) ) )).
...
thf(thm_2Emeasure_2ESIGMA__ALGEBRA__BOREL,axiom,(
    c_2Emeasure_2Esigma__algebra @ tyop_2Eextreal_2Eextreal @ c_2Emeasure_2EBorel )).
    ...
    <=> ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V1a )
        ...
        & ! [V2c: tyop_2Eextreal_2Eextreal] :
            ...
            @ ( c_2Epred__set_2EINTER @ A_27a
              @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ tyop_2Eextreal_2Eextreal @ V0f
                @ ( c_2Epred__set_2EGSPEC @ tyop_2Eextreal_2Eextreal @ tyop_2Eextreal_2Eextreal
                  @ ^ [V3x: tyop_2Eextreal_2Eextreal] :
                      ( c_2Epair_2E_2C @ tyop_2Eextreal_2Eextreal @ $o @ V3x @ ( c_2Eextreal_2Eextreal__lt @ V3x @ V2c ) ) ) )
