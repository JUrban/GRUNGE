...
fof(conj_thm_2Ereal__topology_2ESUBTOPOLOGY__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSED,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(lamtp_f3892,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => mem(f3892(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3892,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V2y] :
          ( mem(V2y,ty_2Erealax_2Ereal)
         => ap(f3892(V0a),V2y) = ap(ap(c_2Erealax_2Ereal__mul,V0a),V2y) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3892(V0a)),V1s)) ) ) )).

fof(lamtp_f3893,axiom,(
    ! [V0b] :
      ( mem(V0b,ty_2Erealax_2Ereal)
     => mem(f3893(V0b),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

fof(lameq_f3893,axiom,(
    ! [V0b] :
      ( mem(V0b,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3893(V0b),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Ereal_2Ereal__lte,V1x),V0b)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSED__INTERVAL__LEFT,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Erealax_2Ereal)
     => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3893(V0b)))) ) )).
...
fof(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__LE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3895(V1b,V0a)))) ) ) )).
