...
thf(thm_2Einteger_2EINT__LE__SQUARE,axiom,(
    ! [V0x: mono_2Etyop_2Einteger_2Eint] :
      ( mono_2Ec_2Einteger_2Eint__le @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V0x @ V0x ) ) )).
...
thf(thm_2Einteger_2EINT__POASQ,conjecture,(
    ! [V0x: mono_2Etyop_2Einteger_2Eint] :
      ( ( mono_2Ec_2Einteger_2Eint__lt @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Einteger_2Eint__mul @ V0x @ V0x ) )
    <=> ( (~)
        @ ( V0x
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) )).
