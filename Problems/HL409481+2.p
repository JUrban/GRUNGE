...
fof(conj_thm_2Efloat_2EFLOAT__SUB__RELATIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ! [V1b] :
          ( mem(V1b,ty_2Eieee_2Efloat)
         => ( ( p(ap(c_2Eieee_2EFinite,V0a))
              ...
              & p(ap(c_2Efloat_2Enormalizes,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b)))) )
           => ( p(ap(c_2Eieee_2EFinite,ap(ap(c_2Eieee_2Efloat__sub,V0a),V1b)))
              & ? [V2e] :
                  ...
                  & ap(c_2Eieee_2EVal,ap(ap(c_2Eieee_2Efloat__sub,V0a),V1b)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2e)) ) ) ) ) ) )).
