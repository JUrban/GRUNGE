...
thf(conj_thm_2Ellist_2Elrep__ok__MAP,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ( ( p
              @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27a )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ A_27b @ A_27a ) @ V0f ) @ ( ap @ V1g @ V2n ) ) ) ) )
          <=> ( p @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27b ) @ V1g ) ) ) ) ) )).

thf(conj_thm_2Ellist_2Elrep__ok__FUNPOW__BIND,lemma,(
    ! [A_27a: del,V0g: $i] :
...
thf(conj_thm_2Ellist_2ELUNFOLD,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
