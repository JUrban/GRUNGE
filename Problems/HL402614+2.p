...
fof(conj_thm_2Erich__list_2ESUM__FOLDL,conjecture,(
    ! [V0l] :
      ( mem(V0l,ty_2Elist_2Elist(ty_2Enum_2Enum))
     => ap(c_2Elist_2ESUM,V0l) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Earithmetic_2E_2B),c_2Enum_2E0),V0l) ) )).
