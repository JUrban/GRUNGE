...
tff(conj_thm_2Ecardinal_2ECARD__EQ__TRANS,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__ADD__CONG,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__MUL__SYM,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__LDISTRIB,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__RDISTRIB,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ! [V2u: $i] :
              ( mem(V2u,arr(A_27c,bool))
             => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Epair_2Eprod(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ty_2Epair_2Eprod(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a))),ap(ap(c_2Epred__set_2ECROSS(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t)),V2u)),ap(ap(c_2Ecardinal_2E_2B__c(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V2u)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1t),V2u)))) ) ) ) )).
