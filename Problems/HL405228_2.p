...
tff(conj_thm_2ECoder_2Ewf__coder__prod,conjecture,(
    ! [A_27a: del,A_27b: del,V0c1: $i] :
     ...
     => ! [V1c2: $i] :
         ...
         => ( ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V0c1))
           ...
           => p(ap(c_2ECoder_2Ewf__coder(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2ECoder_2Eprod__coder(A_27a,A_27a,A_27a,A_27a),V0c1),V1c2))) ) ) ) )).
