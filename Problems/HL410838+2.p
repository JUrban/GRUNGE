    ...
    ! [V1v] :
     ...
     => ! [V0a] :
         ...
         => ! [V2b] :
             ...
             => mem(f3727(V1v,V0a,V2b),arr(ty_2Erealax_2Ereal,bool)) ) ) ) )).

fof(lameq_f3727,axiom,(
    ! [V1v] :
      ( mem(V1v,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3c] :
                 ...
                 => ap(f3727(V1v,V0a,V2b),V3c) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V3c)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2Ereal__sub,V2b),V0a)),ap(ap(c_2Erealax_2Ereal__mul,V3c),V1v))) ) ) ) ) )).

fof(lamtp_f3726,axiom,(
    ! [V1v] :
      ( mem(V1v,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,ty_2Erealax_2Ereal)
         => mem(f3726(V1v,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

fof(lameq_f3726,axiom,(
    ! [V1v] :
      ( mem(V1v,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,ty_2Erealax_2Ereal)
         => ! [V2b] :
              ( mem(V2b,ty_2Erealax_2Ereal)
             => ap(f3726(V1v,V0a),V2b) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2b),ap(c_2Ebool_2E_3F(ty_2Erealax_2Ereal),f3727(V1v,V0a,V2b))) ) ) ) )).
...
fof(ax_thm_2Ereal__topology_2Ein__direction,axiom,(
    ! [V0a] :
     ...
     => ! [V1v] :
          ( mem(V1v,ty_2Erealax_2Ereal)
         => ap(ap(c_2Ereal__topology_2Ein__direction,V0a),V1v) = ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V0a)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3726(V1v,V0a))) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EIN__DIRECTION,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1v] :
          ( mem(V1v,ty_2Erealax_2Ereal)
