    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1g: A_27a > tyop_2Erealax_2Ereal,V2t: A_27a > $o] :
      ( ( ( c_2Ereal__topology_2Ebounded__def
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ A_27a
            @ ^ [V3x: A_27a] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( V0f @ V3x ) @ ( c_2Ebool_2EIN @ A_27a @ V3x @ V2t ) ) ) )
        & ( c_2Ereal__topology_2Ebounded__def
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ A_27a
            @ ^ [V4x: A_27a] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( V1g @ V4x ) @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V2t ) ) ) ) )
     => ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ A_27a
          @ ^ [V5x: A_27a] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__add @ ( V0f @ V5x ) @ ( V1g @ V5x ) ) @ ( c_2Ebool_2EIN @ A_27a @ V5x @ V2t ) ) ) ) ) )).
      ...
      ( ( ( c_2Epred__set_2EFINITE @ A_27b @ V2s )
        & ! [V3a: A_27b] :
           ...
           => ( c_2Ereal__topology_2Ebounded__def
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ A_27a
                @ ^ [V4x: A_27a] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( V0f @ V4x @ V3a ) @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V1t ) ) ) ) ) )
     => ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ A_27a
          @ ^ [V5x: A_27a] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Eiterate_2ESum @ A_27b @ V2s @ ( V0f @ V5x ) ) @ ( c_2Ebool_2EIN @ A_27a @ V5x @ V1t ) ) ) ) ) )).
