...
tff(conj_thm_2Ellist_2ELDROP__SUC,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ls: $i] :
      ( mem(V1ls,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELDROP(A_27a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n))),V1ls) = ap(ap(c_2Eoption_2EOPTION__BIND(ty_2Ellist_2Ellist(A_27a),ty_2Ellist_2Ellist(A_27a)),ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ls)),c_2Ellist_2ELTL(A_27a)) ) )).
