...
tff(conj_thm_2Ebool_2Eitself__induction,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Ebasis__emit_2Ei2w__itself__ind,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Einteger_2Eint,ty_2Einteger_2Eint),bool))
     => ( ! [V1i: tp__ty_2Einteger_2Eint] : p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Einteger_2Eint,ty_2Einteger_2Eint),inj__ty_2Einteger_2Eint(V1i)),c_2Ebool_2Ethe__value(A_27a))))
       => ! [V2v: tp__ty_2Einteger_2Eint,V3v1: $i] :
            ( mem(V3v1,ty_2Ebool_2Eitself(A_27a))
           => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Einteger_2Eint,ty_2Einteger_2Eint),inj__ty_2Einteger_2Eint(V2v)),V3v1))) ) ) ) )).
