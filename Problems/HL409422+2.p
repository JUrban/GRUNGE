...
fof(conj_thm_2Emachine__ieee_2Efp64__sqrt__with__flags,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1a] :
