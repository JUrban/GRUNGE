...
tff(conj_thm_2Ereal__topology_2ECLOSED__IMP__FIP,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__FIP,conjecture,(
    ! [V0f: $i] :
     ...
     => ( ( ! [V1t: $i] :
          ...
          & ? [V2t: $i] :
              ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
              & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2t),V0f))
              & p(ap(c_2Ereal__topology_2Ebounded__def,V2t)) )
          & ! [V3f_27: $i] :
              ( mem(V3f_27,arr(arr(ty_2Erealax_2Ereal,bool),bool))
             => ( ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),V3f_27))
                  & p(ap(ap(c_2Epred__set_2ESUBSET(arr(ty_2Erealax_2Ereal,bool)),V3f_27),V0f)) )
               => ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),V3f_27) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )
