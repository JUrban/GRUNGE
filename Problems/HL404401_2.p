...
tff(conj_thm_2Eoption_2EOPTION__BIND__EQUALS__OPTION,lemma,(
...
tff(conj_thm_2Epred__set_2EINJ__IFF,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ecardinal_2Eset__exp__product,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0A: $i] :
     ...
     => ! [V1B1: $i] :
         ...
         => ! [V2B2: $i] :
             ...
             => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,ty_2Eoption_2Eoption(arr(A_27b,ty_2Eoption_2Eoption(A_27c)))),arr(A_27a,ty_2Eoption_2Eoption(arr(A_27b,ty_2Eoption_2Eoption(A_27c))))),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),ap(ap(c_2Ecardinal_2Eset__exp(A_27b,A_27b),V0A),V1B1)),V2B2)),ap(ap(c_2Ecardinal_2Eset__exp(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),V0A),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1B1),V2B2)))) ) ) ) )).
