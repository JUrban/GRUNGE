...
fof(mem_c_2Efinite__map_2EFEVERY,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efinite__map_2EFEVERY(A_27a,A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool))) ) ) )).
...
fof(conj_thm_2Efinite__map_2EFDOM__DRESTRICT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFEVERY__DRESTRICT__COMPL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2k] :
                     ...
                     => ! [V3v] :
                         ...
                         => ! [V4s] :
                             ...
                             => ( p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V0P),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2k),V3v))),ap(c_2Epred__set_2ECOMPL(A_27a),V4s))))
                              <=> ( ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V2k),V4s))
                                   => p(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2k),V3v))) )
                                  & p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V0P),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V1f),ap(c_2Epred__set_2ECOMPL(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2k),V4s))))) ) ) ) ) ) ) ) ) ) )).
