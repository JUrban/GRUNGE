...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(ap(c_2Ereal__topology_2Econnected__component,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),V0x) = c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__UNIV,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) = c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)
