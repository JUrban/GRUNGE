...
thf(conj_thm_2Earithmetic_2ELESS__OR,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
     => ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2ELESS__EQ__LESS__EQ__MONO,lemma,(
...
thf(conj_thm_2EOmega__Automata_2EBUECHI__PERIODIC__REDUCTION__THM,conjecture,(
                      ...
                      & ? [V7q: $i] :
                          ...
                          & ! [V9t1: tp__ty_2Enum_2Enum] :
                            ? [V10t2: tp__ty_2Enum_2Enum] :
                              ( p @ ( ap @ V2Accept @ ( ap @ V7q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t1 ) ) @ ( inj__ty_2Enum_2Enum @ V10t2 ) ) ) ) ) ) )
