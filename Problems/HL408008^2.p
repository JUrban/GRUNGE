...
thf(conj_thm_2Ereal_2ESUM__GROUP,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1k: tp__ty_2Enum_2Enum,V2f: $i] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal
          @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V3m: $i] :
                  ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ V3m ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ V2f ) ) ) )
...
thf(conj_thm_2Eseq_2ESER__GROUP,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
