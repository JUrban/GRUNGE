...
tff(conj_thm_2Epred__set_2ESUBSET__INTER1,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(lamtp_f278,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => mem(f278(A_27a,V0P,V1x),arr(arr(A_27a,bool),bool)) ) ) )).
...
tff(lameq_f278,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,arr(A_27a,bool))
             => ap(f278(A_27a,V0P,V1x),V2s) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2s),V0P)),ap(ap(c_2Ebool_2EIN(A_27a),V1x),V2s)) ) ) ) )).

tff(lmtp_f277,type,(
    f277: ( del * del * $i ) > $i )).

tff(lamtp_f277,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => mem(f277(A_27a,A_27a,V0P),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f277,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(f277(A_27a,A_27a,V0P),V1x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),ap(c_2Ebool_2E_3F(arr(A_27a,bool)),f278(A_27a,V0P,V1x))) ) ) )).

tff(ax_thm_2Epred__set_2EBIGUNION,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ap(c_2Epred__set_2EBIGUNION(A_27a),V0P) = ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f277(A_27a,A_27a,V0P)) ) )).
...
tff(lamtp_f293,axiom,(
    ! [A_27a: del,A_27a: del,V0y: $i] :
      ( mem(V0y,arr(A_27a,bool))
     => mem(f293(A_27a,A_27a,V0y),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f293,axiom,(
    ! [A_27a: del,A_27a: del,V0y: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(f293(A_27a,A_27a,V0y),V1x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),ap(ap(c_2Ebool_2EIN(A_27a),V1x),V0y)) ) ) )).

tff(conj_thm_2Epred__set_2EGSPEC__ID,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,arr(A_27a,bool))
     => ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f293(A_27a,A_27a,V0y)) = V0y ) )).
...
tff(conj_thm_2Emeasure_2EMEASURE__SPACE__ADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
       => p(ap(c_2Emeasure_2Eadditive(A_27a),V0m)) ) ) )).
...
tff(lamtp_f3609,axiom,(
    ! [A_27a: del,V6a: $i] :
      ( mem(V6a,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ! [V2m: $i] :
              ( mem(V2m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             => mem(f3609(A_27a,V6a,V1b,V2m),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).
...
tff(lameq_f3609,axiom,(
    ! [A_27a: del,V6a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2m: $i] :
              ( mem(V2m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             => ! [V7i: tp__ty_2Enum_2Enum] : ap(f3609(A_27a,V6a,V1b,V2m),inj__ty_2Enum_2Enum(V7i)) = ap(ap(c_2Emeasure_2Emeasure(A_27a),V2m),ap(ap(c_2Epred__set_2EINTER(A_27a),V6a),ap(V1b,inj__ty_2Enum_2Enum(V7i)))) ) ) ) )).

tff(conj_thm_2Emeasure_2Emeasure__split,conjecture,(
    ! [A_27a: del,V0r: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2m: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V2m))
                  ...
                  & ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1b),V0r)) = ap(c_2Emeasure_2Em__space(A_27a),V2m)
                  & ! [V3i: tp__ty_2Enum_2Enum,V4j: tp__ty_2Enum_2Enum] :
                      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3i)),V0r))
                        ...
                        & V3i != V4j )
                     => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V1b,inj__ty_2Enum_2Enum(V3i))),ap(V1b,inj__ty_2Enum_2Enum(V4j)))) )
                  & ! [V5i: tp__ty_2Enum_2Enum] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5i)),V0r))
                     => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(V1b,inj__ty_2Enum_2Enum(V5i))),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V2m))) ) )
               => ! [V6a: $i] :
                    ( mem(V6a,arr(A_27a,bool))
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V6a),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V2m)))
                     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V2m),V6a)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Enum_2Enum),f3609(A_27a,V6a,V1b,V2m)),V0r)) ) ) ) ) ) ) )).
