...
thf(c_2EindexedLists_2EMAP2ia_2E0,type,(
    c_2EindexedLists_2EMAP2ia_2E0: u )).

thf(c_2EindexedLists_2EMAP2ia_2E4,type,(
...
thf(arityeq4_2Emono_2Ec_2EindexedLists_2EMAP2ia_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ X3_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ c_2EindexedLists_2EMAP2ia_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ X3_2E0 ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMAP2ia__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d] :
      ( ! [V0v0_2E0: u,V1i: mono_2Etyop_2Enum_2Enum,V2f_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ V0v0_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V3v8_2E0: u,V4v7_2E0: u,V5i: mono_2Etyop_2Enum_2Enum,V6f_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V6f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V4v7_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V3v8_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V7t2_2E0: u,V8t1_2E0: u,V9i: mono_2Etyop_2Enum_2Enum,V10h2_2E0: u,V11h1_2E0: u,V12f_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V12f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V11h1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V8t1_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27c @ V10h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ V7t2_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V12f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9i ) ) ) ) @ ( s @ A_27b @ V11h1_2E0 ) ) ) @ ( s @ A_27c @ V10h2_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V12f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V9i @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V8t1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ V7t2_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMAP2ia__NIL2,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0l1_2E0: u,V1i: mono_2Etyop_2Enum_2Enum,V2f_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAP2ia_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ c_2Elist_2ENIL_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )).
