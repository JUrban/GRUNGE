...
tff(conj_thm_2Ereal__topology_2EUNBOUNDED__INTER__COBOUNDED,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( ~ p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
              & p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),V1t))) )
