...
tff(conj_thm_2Efinite__map_2ESUBMAP__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V0f)) ) )).
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__SUBMAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27a,bool))
         => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),V1r)),V0f)) ) ) )).
