...
thf(thm_2Etransc_2EDIFF__ATN,conjecture,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( c_2Elim_2Ediffl @ c_2Etransc_2Eatn @ ( c_2Erealax_2Einv @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ereal_2Epow @ V0x @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ V0x ) )).
