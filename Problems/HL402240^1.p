...
thf(thm_2Elist_2EGENLIST__AUX,axiom,(
    ! [A_27a: d] :
      ...
      & ! [V2f_2E0: u,V3n: mono_2Etyop_2Enum_2Enum,V4l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST__AUX_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V3n ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST__AUX_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Elist_2EGENLIST__GENLIST__AUX,conjecture,(
    ! [A_27a: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST__AUX_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) ) )).
