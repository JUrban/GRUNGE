...
tff(conj_thm_2EindexedLists_2EFOLDRi__CONG_27,conjecture,(
                 ...
                 => ! [V4a1: $i] :
                     ...
                     => ! [V5a2: $i] :
                         ...
                         => ( ( V0l1 = V1l2
                              ...
                              & V4a1 = V5a2 )
                           => ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27b,A_27b),V2f1),V4a1),V0l1) = ap(ap(ap(c_2EindexedLists_2EFOLDRi(A_27b,A_27b),V3f2),V5a2),V1l2) ) ) ) ) ) ) ) )).
