...
tff(conj_thm_2Ereal__topology_2EBOUNDED__TRANSLATION,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V1s))
       => p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3805(V0a)),V1s))) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__TRANSLATION__EQ,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3805(V0a)),V1s)))
      <=> p(ap(c_2Ereal__topology_2Ebounded__def,V1s)) ) ) )).
