...
thf(c_2Earithmetic_2EMODEQ_2E0,type,(
    c_2Earithmetic_2EMODEQ_2E0: u )).

thf(c_2Earithmetic_2EMODEQ_2E3,type,(
...
thf(mono_2Ec_2Earithmetic_2EMODEQ,type,(
    mono_2Ec_2Earithmetic_2EMODEQ: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(thm_2Earithmetic_2EMODEQ__INTRO__CONG,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1e1: mono_2Etyop_2Enum_2Enum,V2e0: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0n )
     => ( ( mono_2Ec_2Earithmetic_2EMODEQ @ V0n @ V2e0 @ V1e1 )
       => ( ( mono_2Ec_2Earithmetic_2EMOD @ V2e0 @ V0n )
          = ( mono_2Ec_2Earithmetic_2EMOD @ V1e1 @ V0n ) ) ) ) )).

thf(thm_2Earithmetic_2EMODEQ__PLUS__CONG,axiom,(
    ! [V0y1: mono_2Etyop_2Enum_2Enum,V1y0: mono_2Etyop_2Enum_2Enum,V2x1: mono_2Etyop_2Enum_2Enum,V3x0: mono_2Etyop_2Enum_2Enum,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2EMODEQ @ V4n @ V3x0 @ V2x1 )
     => ( ( mono_2Ec_2Earithmetic_2EMODEQ @ V4n @ V1y0 @ V0y1 )
       => ( mono_2Ec_2Earithmetic_2EMODEQ @ V4n @ ( mono_2Ec_2Earithmetic_2E_2B @ V3x0 @ V1y0 ) @ ( mono_2Ec_2Earithmetic_2E_2B @ V2x1 @ V0y1 ) ) ) ) )).

thf(thm_2Earithmetic_2EMODEQ__REFL,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Earithmetic_2EMODEQ @ V0n @ V1x @ V1x ) )).

thf(thm_2Earithmetic_2EMODEQ__0,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0n )
     => ( mono_2Ec_2Earithmetic_2EMODEQ @ V0n @ V0n @ mono_2Ec_2Enum_2E0 ) ) )).
...
thf(thm_2Elist_2ELIST__EQ__REWRITE,axiom,(
    ...
    <=> ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) )
          = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) ) ) ) )
        & ! [V2x: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2x @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) ) )
           => ( ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) )
              = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Elist_2ELENGTH__GENLIST,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) ) )
      = V1n ) )).

thf(thm_2Elist_2EEL__GENLIST,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2x @ V1n )
     => ( ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) )
        = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELGENLIST__CHUNK__GENLIST,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1f_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( i_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2EfromList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Enum_2Enum_29 @ ( mono_2Ec_2Earithmetic_2E_2B @ V0n ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( i_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELREPEAT__thm,conjecture,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELREPEAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
