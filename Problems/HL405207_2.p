...
tff(lamtp_f2109,axiom,(
    ! [A_27b: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f2109(A_27b,A_27a,V0P),arr(A_27a,arr(A_27b,bool))) ) )).
...
tff(lameq_f2109,axiom,(
    ! [A_27b: del,A_27a: del,V0P: $i] :
     ...
     => ! [V3k: $i] :
          ( mem(V3k,A_27a)
         => ap(f2109(A_27b,A_27a,V0P),V3k) = k(A_27b,ap(V0P,V3k)) ) ) )).

tff(conj_thm_2Ealist_2EALOOKUP__FILTER,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1ls: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(ap(c_2Elist_2EFILTER(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f2109(A_27b,A_27a,V0P))),V1ls)),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27b)),ap(V0P,V2x)),ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V1ls),V2x)),c_2Eoption_2ENONE(A_27b)) ) ) ) )).
