...
thf(f13793_0_2E0,type,(
    f13793_0_2E0: u )).

thf(f13793_0_2E1,type,(
    f13793_0_2E1: du > u )).

thf(f13793_1_2E0,type,(
    f13793_1_2E0: u )).

thf(f13793_1_2E1,type,(
    f13793_1_2E1: du > u )).

thf(f13795_0_2E0,type,(
    f13795_0_2E0: u )).

thf(f13795_0_2E1,type,(
    f13795_0_2E1: du > u )).

thf(f13795_1_2E0,type,(
    f13795_1_2E0: u )).

thf(f13795_1_2E1,type,(
    f13795_1_2E1: du > u )).

thf(f13796_0_2E0,type,(
    f13796_0_2E0: u )).

thf(f13796_0_2E1,type,(
    f13796_0_2E1: du > u )).

thf(f13796_1_2E0,type,(
    f13796_1_2E0: u )).

thf(f13796_1_2E1,type,(
    f13796_1_2E1: du > u )).
...
thf(mono_2Ef13793_0,type,(
    mono_2Ef13793_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13793_1,type,(
    mono_2Ef13793_1: mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef13795_0,type,(
    mono_2Ef13795_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13795_1,type,(
    mono_2Ef13795_1: mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef13796_0,type,(
    mono_2Ef13796_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13796_1,type,(
    mono_2Ef13796_1: mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2EINDEPENDENT__STDBASIS,axiom,(
...
thf(def1_2Ethm_2Ereal__topology_2EINDEPENDENT__STDBASIS,axiom,(
    ! [V0i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13793_0 @ V0i )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V0i @ ( mono_2Ef13793_1 @ V0i ) ) ) )).

thf(thm_2Ereal__topology_2EINDEPENDENT__STDBASIS,axiom,(
    mono_2Ec_2Ereal__topology_2Eindependent @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef13793_0 ) )).

thf(thm_2Ereal__topology_2EDIM__UNIQUE,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1v: mono_2Etyop_2Erealax_2Ereal > $o,V2b: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V2b @ V1v )
        ...
        & ( mono_2Ec_2Ecardinal_2EHAS__SIZE_2Emono_2Etyop_2Erealax_2Ereal @ V2b @ V0n ) )
     => ( ( mono_2Ec_2Ereal__topology_2Edim @ V1v )
        = V0n ) ) )).

thf(def0_2Ethm_2Ereal__topology_2ESPAN__STDBASIS,axiom,(
    ! [V0i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13795_1 @ V0i )
    <=> ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0i )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V0i @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESPAN__STDBASIS,axiom,(
    ! [V0i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13795_0 @ V0i )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V0i @ ( mono_2Ef13795_1 @ V0i ) ) ) )).

thf(thm_2Ereal__topology_2ESPAN__STDBASIS,axiom,
    ( ( mono_2Ec_2Ereal__topology_2Espan @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef13795_0 ) )
    = mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Erealax_2Ereal )).

thf(def0_2Ethm_2Ereal__topology_2EHAS__SIZE__STDBASIS,axiom,(
    ! [V0i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13796_1 @ V0i )
    <=> ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0i )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V0i @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EHAS__SIZE__STDBASIS,axiom,(
    ! [V0i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13796_0 @ V0i )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V0i @ ( mono_2Ef13796_1 @ V0i ) ) ) )).

thf(thm_2Ereal__topology_2EHAS__SIZE__STDBASIS,axiom,(
    mono_2Ec_2Ecardinal_2EHAS__SIZE_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef13796_0 ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) )).

thf(thm_2Ereal__topology_2EDIM__UNIV,conjecture,
    ( ( mono_2Ec_2Ereal__topology_2Edim @ mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Erealax_2Ereal )
