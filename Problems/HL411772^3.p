...
thf(thm_2Ereal__topology_2ELIM__DROP__LE,axiom,(
...
thf(thm_2Ereal__topology_2ESERIES__DROP__LE,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2s: tyop_2Enum_2Enum > $o,V3a: tyop_2Erealax_2Ereal,V4b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Esums @ V0f @ V3a @ V2s )
        ...
        & ! [V5x: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V5x @ V2s )
           => ( c_2Ereal_2Ereal__lte @ ( V0f @ V5x ) @ ( V1g @ V5x ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ V3a @ V4b ) ) )).
