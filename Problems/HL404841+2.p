...
fof(conj_thm_2Efinite__map_2EDRESTRICT__SUBMAP__gen,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2P] :
                     ...
                     => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V1g))
                       => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),V2P)),V1g)) ) ) ) ) ) ) )).
