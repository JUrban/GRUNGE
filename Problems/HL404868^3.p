...
thf(thm_2EternaryComparisons_2Eordering__CASE,axiom,(
    ! [A_27a: $tType,V0x: tyop_2EternaryComparisons_2Eordering,V1v0: A_27a,V2v1: A_27a,V3v2: A_27a] :
      ...
      = ( ^ [V4m: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ A_27a @ ( c_2Eprim__rec_2E_3C @ V4m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1v0 @ ( c_2Ebool_2ECOND @ A_27a @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V4m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2v1 @ V3v2 ) )
