...
thf(thm_2Earithmetic_2EMODEQ__NONZERO__MODEQUALITY,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m2: tyop_2Enum_2Enum,V2m1: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
     => ( ( c_2Earithmetic_2EMODEQ @ V0n @ V2m1 @ V1m2 )
      <=> ( ( c_2Earithmetic_2EMOD @ V2m1 @ V0n )
          = ( c_2Earithmetic_2EMOD @ V1m2 @ V0n ) ) ) ) )).
