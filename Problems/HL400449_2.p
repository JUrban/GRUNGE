...
tff(tp_c_2Erelation_2ERINTER,type,(
    c_2Erelation_2ERINTER: ( del * del ) > $i )).

tff(mem_c_2Erelation_2ERINTER,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erelation_2ERINTER(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,bool)),arr(arr(A_27a,arr(A_27b,bool)),arr(A_27a,arr(A_27b,bool))))) )).
...
tff(ax_thm_2Erelation_2ERINTER,axiom,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
     ...
     => ! [V1R2: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ( p(ap(ap(ap(ap(c_2Erelation_2ERINTER(A_27a,A_27a),V0R1),V1R2),V2x),V3y))
                  <=> ( p(ap(ap(V0R1,V2x),V3y))
                      & p(ap(ap(V1R2,V2x),V3y)) ) ) ) ) ) ) )).

tff(conj_thm_2Erelation_2Etransitive__RINTER,conjecture,(
    ! [A_27a: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1R2: $i] :
          ( mem(V1R2,arr(A_27a,arr(A_27a,bool)))
         => ( ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R1))
              & p(ap(c_2Erelation_2Etransitive(A_27a),V1R2)) )
           => p(ap(c_2Erelation_2Etransitive(A_27a),ap(ap(c_2Erelation_2ERINTER(A_27a,A_27a),V0R1),V1R2))) ) ) ) )).
