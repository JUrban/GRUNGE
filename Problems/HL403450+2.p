...
fof(ax_thm_2EEncode_2Eencode__list__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0xb] :
            ( mem(V0xb,arr(A_27a,ty_2Elist_2Elist(bool)))
           => ap(ap(c_2EEncode_2Eencode__list(A_27a),V0xb),c_2Elist_2ENIL(A_27a)) = ap(ap(c_2Elist_2ECONS(bool),c_2Ebool_2EF),c_2Elist_2ENIL(bool)) )
        & ! [V1xb] :
           ...
           => ! [V2x] :
               ...
               => ! [V3xs] :
                   ...
                   => ap(ap(c_2EEncode_2Eencode__list(A_27a),V1xb),ap(ap(c_2Elist_2ECONS(A_27a),V2x),V3xs)) = ap(ap(c_2Elist_2ECONS(bool),c_2Ebool_2ET),ap(ap(c_2Elist_2EAPPEND(bool),ap(V1xb,V2x)),ap(ap(c_2EEncode_2Eencode__list(A_27a),V1xb),V3xs))) ) ) ) ) ) )).

fof(conj_thm_2EEncode_2Eencode__list__cong,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
             ...
             => ! [V2f1] :
                 ...
                 => ! [V3f2] :
                     ...
                     => ( ( V0l1 = V1l2
                       ...
                       => ap(ap(c_2EEncode_2Eencode__list(A_27a),V2f1),V0l1) = ap(ap(c_2EEncode_2Eencode__list(A_27a),V3f2),V1l2) ) ) ) ) ) ) )).
