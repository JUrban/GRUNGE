...
tff(lameq_f2309,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => ! [V2l: tp__c_ty_2Elist_2Elist_o] : ap(f2309(V0f),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(c_2Ebitstring_2Ev2w(ty_2Eone_2Eone),ap(ap(c_2Elist_2ECONS(bool),ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),V0f),ap(c_2Elist_2EHD(bool),inj__c_ty_2Elist_2Elist_o(V2l))),ap(c_2Elist_2ETL(bool),inj__c_ty_2Elist_2Elist_o(V2l)))),c_2Elist_2ENIL(bool))) ) )).

tff(conj_thm_2Ebitstring_2Eword__reduce__v2w,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => ! [V1v: tp__c_ty_2Elist_2Elist_o] : surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(c_2Ewords_2Eword__reduce(A_27a),V0f),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V1v)))) = surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2309(V0f)),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__c_ty_2Elist_2Elist_o(V1v)))) ) )).
