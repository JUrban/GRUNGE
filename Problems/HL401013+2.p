...
fof(conj_thm_2Eprim__rec_2Emeasure__thm,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(lamtp_f173,axiom,(
    ! [V1m] :
      ( mem(V1m,ty_2Enum_2Enum)
     => mem(f173(V1m),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
fof(lameq_f173,axiom,(
    ! [V1m] :
     ...
     => ! [V2n] :
         ...
         => ap(f173(V1m),V2n) = ap(ap(c_2Earithmetic_2E_2D,V1m),V2n) ) ) )).

fof(lamtp_f172,axiom,(
    mem(f172,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

fof(lameq_f172,axiom,(
    ! [V1m] :
      ( mem(V1m,ty_2Enum_2Enum)
     => ap(f172,V1m) = f173(V1m) ) )).

fof(lamtp_f178,axiom,(
    ! [V3f] :
      ( mem(V3f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))
     => ! [V5m] :
          ( mem(V5m,ty_2Enum_2Enum)
         => ! [V4a] :
              ( mem(V4a,ty_2Enum_2Enum)
             => mem(f178(V3f,V5m,V4a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) ) )).
    ...
    ! [V3f] :
     ...
     => ! [V5m] :
         ...
         => ! [V4a] :
              ( mem(V4a,ty_2Enum_2Enum)
             => ! [V7d] :
                  ( mem(V7d,ty_2Enum_2Enum)
                 => ap(f178(V3f,V5m,V4a),V7d) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V5m),V7d)),V4a),ap(V3f,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),V4a)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V5m),V7d)))) ) ) ) ) )).

fof(lamtp_f177,axiom,(
    ! [V5m] :
      ( mem(V5m,ty_2Enum_2Enum)
     => ! [V3f] :
          ( mem(V3f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))
         => ! [V4a] :
              ( mem(V4a,ty_2Enum_2Enum)
             => mem(f177(V5m,V3f,V4a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) ) )).
     ...
     => ! [V3f] :
         ...
         => ! [V4a] :
             ...
             => ! [V6n] :
                 ...
                 => ap(f177(V5m,V3f,V4a),V6n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V6n),c_2Enum_2E0)),V4a),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f178(V3f,V5m,V4a)),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))),V6n))) ) ) ) ) )).

fof(lamtp_f176,axiom,(
    ! [V3f] :
      ( mem(V3f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))
     => ! [V4a] :
          ( mem(V4a,ty_2Enum_2Enum)
         => mem(f176(V3f,V4a),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) ) )).
...
fof(lameq_f176,axiom,(
    ! [V3f] :
     ...
     => ! [V4a] :
         ...
         => ! [V5m] :
              ( mem(V5m,ty_2Enum_2Enum)
             => ap(f176(V3f,V4a),V5m) = f177(V5m,V3f,V4a) ) ) ) )).

fof(lamtp_f175,axiom,(
    ! [V3f] :
      ( mem(V3f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))
     => mem(f175(V3f),arr(ty_2Enum_2Enum,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))) ) )).
...
fof(lameq_f175,axiom,(
    ! [V3f] :
     ...
     => ! [V4a] :
          ( mem(V4a,ty_2Enum_2Enum)
         => ap(f175(V3f),V4a) = ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f176(V3f,V4a)) ) ) )).

fof(lamtp_f174,axiom,(
    mem(f174,arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))) )).

fof(lameq_f174,axiom,(
    ! [V3f] :
      ( mem(V3f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Enum_2Enum))
     => ap(f174,V3f) = ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f175(V3f)) ) )).

fof(ax_thm_2Earithmetic_2Efindq__def,axiom,(
    c_2Earithmetic_2Efindq = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Eprim__rec_2Emeasure(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),k(ty_2Enum_2Enum,ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f172))))),f174) )).
...
fof(conj_thm_2Earithmetic_2Efindq__thm,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
