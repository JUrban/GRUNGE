...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EQUIVALENCE__RELATION,lemma,(
    ! [V0R: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQUIVALENCE__RELATION,conjecture,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
