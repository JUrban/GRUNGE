...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
