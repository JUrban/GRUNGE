...
tff(conj_thm_2Erich__list_2EUNZIP__SNOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Epair_2Eprod(A_27a,A_27a))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
         => ap(c_2Elist_2EUNZIP(A_27a,A_27a),ap(ap(c_2Elist_2ESNOC(ty_2Epair_2Eprod(A_27a,A_27a)),V0x),V1l)) = ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2ESNOC(A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V0x)),ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EUNZIP(A_27a,A_27a),V1l)))),ap(ap(c_2Elist_2ESNOC(A_27b),ap(c_2Epair_2ESND(A_27a,A_27a),V0x)),ap(c_2Epair_2ESND(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EUNZIP(A_27a,A_27a),V1l)))) ) ) )).
