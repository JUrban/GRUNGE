...
thf(thm_2Ereal__topology_2ELINEAR__IMAGE__SUBSET__INTERIOR,axiom,(
...
thf(thm_2Ereal__topology_2EIN__INTERIOR__LINEAR__IMAGE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Elinear @ V0f )
        & ( c_2Ereal__topology_2Elinear @ V1g )
        & ( ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1g )
          = ( c_2Ecombin_2EI @ tyop_2Erealax_2Ereal ) )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ ( c_2Ereal__topology_2Einterior @ V2s ) ) )
     => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ ( c_2Ereal__topology_2Einterior @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) ) ) ) )).
