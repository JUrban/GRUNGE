...
tff(lameq_f2520,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Eordinal_2Eordinal(A_27a)))
     => ! [V7n: tp__ty_2Enum_2Enum] : ap(f2520(A_27a,V1f),inj__ty_2Enum_2Enum(V7n)) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(V1f,inj__ty_2Enum_2Enum(V7n))),inj__o(fo__c_2Ebool_2ET)) ) )).

tff(lmtp_f2521,type,(
    f2521: ( del * $i ) > $i )).

tff(lamtp_f2521,axiom,(
    ! [A_27a: del,V0A: $i] :
...
tff(lameq_f2521,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(ty_2Enum_2Enum,arr(ty_2Eordinal_2Eordinal(A_27a),bool)))
     => ! [V8n: tp__ty_2Enum_2Enum] : ap(f2521(A_27a,V0A),inj__ty_2Enum_2Enum(V8n)) = ap(ap(c_2Epair_2E_2C(arr(ty_2Eordinal_2Eordinal(A_27a),bool),arr(ty_2Eordinal_2Eordinal(A_27a),bool)),ap(V0A,inj__ty_2Enum_2Enum(V8n))),inj__o(fo__c_2Ebool_2ET)) ) )).

tff(conj_thm_2Eveblen_2Esup__mem__INTER,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(ty_2Enum_2Enum,arr(ty_2Eordinal_2Eordinal(A_27a),bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Eordinal_2Eordinal(A_27a)))
