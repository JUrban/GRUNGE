...
fof(conj_thm_2Ecardinal_2ECARD__LE__LT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EFINITE__CARD__LT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__ALT__cardleq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__CASES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0s))
          <=> ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
              | p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) ) ) )).
