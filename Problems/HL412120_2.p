...
tff(mem_c_2Elebesgue_2Efinite__space__integral,axiom,(
    ! [A_27a: del] : mem(c_2Elebesgue_2Efinite__space__integral(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))) )).
...
tff(lamtp_f4104,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f4104(A_27a,V1f,V0m),arr(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f4104,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0m: $i] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2r: tp__ty_2Eextreal_2Eextreal] : ap(f4104(A_27a,V1f,V0m),inj__ty_2Eextreal_2Eextreal(V2r)) = ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V2r)),ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V1f),ap(ap(c_2Epred__set_2EINSERT(ty_2Eextreal_2Eextreal),inj__ty_2Eextreal_2Eextreal(V2r)),c_2Epred__set_2EEMPTY(ty_2Eextreal_2Eextreal)))),ap(c_2Emeasure_2Em__space(A_27a),V0m))))) ) ) )).
...
tff(ax_thm_2Elebesgue_2Efinite__space__integral__def,axiom,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Efinite__space__integral(A_27a),V0m),V1f)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Eextreal_2Eextreal),f4104(A_27a,V1f,V0m)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),ap(c_2Emeasure_2Em__space(A_27a),V0m)))) ) ) )).

tff(conj_thm_2Elebesgue_2Efinite__support__integral__reduce,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
              ...
              & p(ap(c_2Epred__set_2EFINITE(ty_2Eextreal_2Eextreal),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),ap(c_2Emeasure_2Em__space(A_27a),V0m)))) )
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Efinite__space__integral(A_27a),V0m),V1f)) ) ) ) )).
...
tff(tp_c_2Eprobability_2Eexpectation,type,(
    c_2Eprobability_2Eexpectation: del > $i )).

tff(mem_c_2Eprobability_2Eexpectation,axiom,(
    ! [A_27a: del] : mem(c_2Eprobability_2Eexpectation(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))) )).
...
tff(tp_c_2Eprobability_2Eprob,type,(
    c_2Eprobability_2Eprob: del > $i )).

tff(mem_c_2Eprobability_2Eprob,axiom,(
    ! [A_27a: del] : mem(c_2Eprobability_2Eprob(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),ty_2Erealax_2Ereal))) )).
...
tff(tp_c_2Eprobability_2Ereal__random__variable,type,(
    c_2Eprobability_2Ereal__random__variable: del > $i )).

tff(mem_c_2Eprobability_2Ereal__random__variable,axiom,(
    ! [A_27a: del] : mem(c_2Eprobability_2Ereal__random__variable(A_27a),arr(arr(A_27a,ty_2Eextreal_2Eextreal),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool))) )).

tff(ax_thm_2Eprobability_2Ep__space__def,axiom,(
    ! [A_27a: del] : c_2Eprobability_2Ep__space(A_27a) = c_2Emeasure_2Em__space(A_27a) )).

tff(ax_thm_2Eprobability_2Eevents__def,axiom,(
    ! [A_27a: del] : c_2Eprobability_2Eevents(A_27a) = c_2Emeasure_2Emeasurable__sets(A_27a) )).

tff(ax_thm_2Eprobability_2Eprob__def,axiom,(
    ! [A_27a: del] : c_2Eprobability_2Eprob(A_27a) = c_2Emeasure_2Emeasure(A_27a) )).

tff(ax_thm_2Eprobability_2Eprob__space__def,axiom,(
    ! [A_27a: del,V0p: $i] :
     ...
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
      <=> ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0p))
          & surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V0p),ap(c_2Eprobability_2Ep__space(A_27a),V0p))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) ) )).

tff(ax_thm_2Eprobability_2Ereal__random__variable__def,axiom,(
    ! [A_27a: del,V0X: $i] :
          ...
          <=> ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V1p))
              & ! [V2x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Eprobability_2Ep__space(A_27a),V1p)))
                   => ( surj__ty_2Eextreal_2Eextreal(ap(V0X,V2x)) != fo__c_2Eextreal_2ENegInf
                      & surj__ty_2Eextreal_2Eextreal(ap(V0X,V2x)) != fo__c_2Eextreal_2EPosInf ) ) )
              & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V0X),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Eprobability_2Ep__space(A_27a),V1p)),ap(c_2Eprobability_2Eevents(A_27a),V1p))),c_2Emeasure_2EBorel))) ) ) ) ) )).

tff(ax_thm_2Eprobability_2Eexpectation__def,axiom,(
    ! [A_27a: del] : c_2Eprobability_2Eexpectation(A_27a) = c_2Elebesgue_2Eintegral(A_27a) )).

tff(lmtp_f4240,type,(
    f4240: ( del * $i * $i ) > $i )).

tff(lamtp_f4240,axiom,(
    ! [A_27a: del,V1X: $i] :
...
tff(lameq_f4240,axiom,(
    ! [A_27a: del,V1X: $i] :
      ( mem(V1X,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0p: $i] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2r: tp__ty_2Eextreal_2Eextreal] : ap(f4240(A_27a,V1X,V0p),inj__ty_2Eextreal_2Eextreal(V2r)) = ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V2r)),ap(c_2Eextreal_2ENormal,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V1X),ap(ap(c_2Epred__set_2EINSERT(ty_2Eextreal_2Eextreal),inj__ty_2Eextreal_2Eextreal(V2r)),c_2Epred__set_2EEMPTY(ty_2Eextreal_2Eextreal)))),ap(c_2Eprobability_2Ep__space(A_27a),V0p))))) ) ) )).

tff(conj_thm_2Eprobability_2Efinite__expectation2,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Eextreal_2Eextreal),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))))
           ...
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eprobability_2Eexpectation(A_27a),V0p),V1X)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Eextreal_2Eextreal),f4240(A_27a,V1X,V0p)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))) ) ) ) )).
