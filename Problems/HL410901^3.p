...
thf(thm_2Ereal__topology_2EINFINITE__FROM,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( (~) @ ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ ( c_2Ereal__topology_2Efrom @ V0n ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIMPT__SEQUENTIAL__INJ,axiom,(
    ...
    <=> ? [V2f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
          ( ! [V3n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V2f @ V3n ) @ ( c_2Epred__set_2EDELETE @ tyop_2Erealax_2Ereal @ V1s @ V0x ) )
