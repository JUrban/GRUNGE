...
thf(arityeq2_2Emono_2Ec_2Esptree_2Einter_2E2_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27b ) ) ) @ c_2Esptree_2Einter_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Esptree_2Elookup__inter__assoc,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0x: mono_2Etyop_2Enum_2Enum,V1t3_2E0: u,V2t2_2E0: u,V3t1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V3t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V2t2_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V1t3_2E0 ) ) ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V3t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V2t2_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V1t3_2E0 ) ) ) ) ) ) )).
