...
tff(lamtp_f390,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => mem(f390(A_27a,V0P,V1Q),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f390,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1Q: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f390(A_27a,V0P,V1Q),V3x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,V3x)),ap(V1Q,V3x)) ) ) ) )).

tff(conj_thm_2Elist_2EMEM__FILTER,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1L: $i] :
...
tff(conj_thm_2Elist_2EALL__DISTINCT__FILTER,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(conj_thm_2Erich__list_2EFILTER__FILTER,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
...
tff(conj_thm_2Epatricia_2EREMOVE__IS__PTREE,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Epatricia_2EPEEK__REMOVE,lemma,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
...
tff(conj_thm_2Epatricia_2EMEM__TRAVERSE__PEEK,lemma,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
...
tff(conj_thm_2Epatricia_2EPERM__DELETE__PTREE,conjecture,(
