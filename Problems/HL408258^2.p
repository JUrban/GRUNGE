...
thf(ax_thm_2Etransc_2Eln,axiom,(
      ...
      = ( surj__ty_2Erealax_2Ereal
        @ ( ap @ ( c_2Emin_2E_40 @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1u: $i] :
                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Etransc_2Eexp @ V1u ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2ELN__EXP,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
