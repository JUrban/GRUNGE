...
tff(conj_thm_2Epred__set_2EBIGUNION__IMAGE__UNIV,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1N: tp__ty_2Enum_2Enum] :
         ...
         => ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1N)))) ) ) )).
...
tff(conj_thm_2Emeasure_2ECLOSED__CDI__DUNION,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
