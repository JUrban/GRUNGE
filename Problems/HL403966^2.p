...
thf(conj_thm_2Ellist_2ELLENGTH__LGENLIST,conjecture,(
    ! [A_27a: del,V0limopt: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V1f ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V0limopt ) ) ) )
        = V0limopt ) ) )).
