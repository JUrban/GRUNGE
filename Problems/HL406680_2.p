...
tff(lamtp_f2513,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => mem(f2513(V0P),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2513,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f2513(V0P),inj__ty_2Enum_2Enum(V1n)) = ap(V0P,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V1n))) ) )).

tff(lmtp_f2514,type,(
    f2514: $i > $i )).

tff(lamtp_f2514,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => mem(f2514(V0P),arr(ty_2Einteger_2Eint,bool)) ) )).

tff(lameq_f2514,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => ! [V2x: tp__ty_2Einteger_2Eint] : ap(f2514(V0P),inj__ty_2Einteger_2Eint(V2x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Einteger_2Eint(V2x))),ap(V0P,inj__ty_2Einteger_2Eint(V2x))) ) )).

tff(conj_thm_2Eint__arith_2EINT__NUM__UEXISTS,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => ( p(ap(c_2Ebool_2E_3F_21(ty_2Enum_2Enum),f2513(V0P)))
      <=> p(ap(c_2Ebool_2E_3F_21(ty_2Einteger_2Eint),f2514(V0P))) ) ) )).
