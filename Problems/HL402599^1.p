...
thf(f3108_0_2E0,type,(
    f3108_0_2E0: u )).

thf(f3108_0_2E2,type,(
    f3108_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3108_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f3108_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ f3108_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Erich__list_2EAPPEND__FOLDL,axiom,(
    ! [A_27a: d,V2l_27_2E0: u,V3x_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f3108_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_27_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
...
thf(thm_2Erich__list_2EAPPEND__FOLDL,conjecture,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u] :
      ...
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFOLDL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ f3108_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) ) ) ) )).
