...
thf(conj_thm_2Epred__set_2EUNIQUE__MEMBER__SING,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1s: $i] :
...
thf(conj_thm_2Eset__relation_2Epartial__order__linear__order,lemma,(
    ! [A_27a: del,V0r: $i] :
...
thf(conj_thm_2Eset__relation_2Efinite__prefix__po__has__minimal__path,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eset__relation_2Eminimal__linear__order__unique,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eset__relation_2Efinite__prefix__linear__order__has__unique__minimal,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1r: $i] :
