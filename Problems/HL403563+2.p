...
fof(lamtp_f1040,axiom,(
    ! [A_27a,A_27a,V0e] :
     ...
     => ! [V1w] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => mem(f1040(A_27a,A_27a,V0e,V1w,V2x),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) ) )).

fof(lameq_f1040,axiom,(
    ! [A_27a,A_27a,V0e] :
      ( mem(V0e,A_27a)
     => ! [V1w] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2x] :
             ...
             => ! [V3y] :
                  ( mem(V3y,A_27a)
                 => ap(f1040(A_27a,A_27a,V0e,V1w,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(A_27a),V2x),V0e))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(A_27a),V3y),V0e))),ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)),ap(c_2Ewellorder_2Ewellorder__REP(A_27a),V1w))))) ) ) ) ) )).

fof(lamtp_f1039,axiom,(
    ! [A_27a,A_27a,A_27a,V0e] :
      ( mem(V0e,A_27a)
     => ! [V1w] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => mem(f1039(A_27a,A_27a,A_27a,V0e,V1w),arr(A_27a,arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a))))) ) ) )).

fof(lameq_f1039,axiom,(
    ! [A_27a,A_27a,A_27a,V0e] :
      ( mem(V0e,A_27a)
     => ! [V1w] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f1039(A_27a,A_27a,A_27a,V0e,V1w),V2x) = f1040(A_27a,A_27a,V0e,V1w,V2x) ) ) ) )).

fof(ax_thm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
         => ! [V1w] :
              ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
             => ap(ap(c_2Ewellorder_2Eremove(A_27a),V0e),V1w) = ap(c_2Ewellorder_2Ewellorder__ABS(A_27a),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1039(A_27a,A_27a,A_27a,V0e,V1w)))) ) ) ) )).

fof(conj_thm_2Ewellorder_2Ewellorder__remove,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
         => ! [V1w] :
              ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
             => p(ap(c_2Ewellorder_2Ewellorder(A_27a),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1039(A_27a,A_27a,A_27a,V0e,V1w))))) ) ) ) )).

fof(conj_thm_2Ewellorder_2EelsOf__remove,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
         => ! [V1w] :
              ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
             => ap(c_2Ewellorder_2EelsOf(A_27a),ap(ap(c_2Ewellorder_2Eremove(A_27a),V0e),V1w)) = ap(ap(c_2Epred__set_2EDELETE(A_27a),ap(c_2Ewellorder_2EelsOf(A_27a),V1w)),V0e) ) ) ) )).
