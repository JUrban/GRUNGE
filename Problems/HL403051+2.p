...
fof(conj_thm_2EindexedLists_2EMAP2i__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0f] :
                 ...
                 => ! [V1l1] :
                     ...
                     => ! [V2l2] :
                         ...
                         => ap(ap(ap(c_2EindexedLists_2EMAP2i(A_27c,A_27c,A_27c),V0f),V1l1),V2l2) = ap(ap(ap(ap(c_2EindexedLists_2EMAP2ia(A_27c,A_27c,A_27c),V0f),c_2Enum_2E0),V1l1),V2l2) ) ) ) ) ) ) )).
