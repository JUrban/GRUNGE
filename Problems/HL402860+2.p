...
fof(conj_thm_2Erich__list_2ELIST__ELEM__COUNT__MEM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Earithmetic_2E_3E,ap(ap(c_2Erich__list_2ELIST__ELEM__COUNT(A_27a),V0e),V1l)),c_2Enum_2E0))
