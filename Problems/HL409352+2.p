...
fof(conj_thm_2Earithmetic_2EMIN__LT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
...
fof(conj_thm_2Ewords_2EWORD__OR__ASSOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__BITWISE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__LSL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2n] :
                     ...
                     => ! [V3w] :
                         ...
                         => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0h),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                           => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),ap(ap(c_2Ewords_2Eword__lsl(A_27a),V3w),V2n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Earithmetic_2E_3C_3D,V2n),V0h)),ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,V0h),V2n)),ap(ap(c_2Earithmetic_2E_2D,V1l),V2n)),V3w)),ap(ap(c_2Earithmetic_2E_2D,V2n),V1l))),ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0)) ) ) ) ) ) ) ) )).
...
fof(ax_thm_2Emachine__ieee_2Efloat__to__fp32__def,axiom,(
    ! [V0x] :
     ...
     => ap(c_2Emachine__ieee_2Efloat__to__fp32,V0x) = ap(ap(c_2Ewords_2Eword__concat(ty_2Eone_2Eone,ty_2Eone_2Eone,ty_2Eone_2Eone),ap(c_2Ebinary__ieee_2Efloat__Sign(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0x)),ap(ap(c_2Ewords_2Eword__concat(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ap(c_2Ebinary__ieee_2Efloat__Exponent(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0x)),ap(c_2Ebinary__ieee_2Efloat__Significand(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0x))) ) )).

fof(conj_thm_2Emachine__ieee_2Efp32__to__float__float__to__fp32,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))))
