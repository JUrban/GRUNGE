...
fof(conj_thm_2Ecardinal_2EFINITE__IMP__COUNTABLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EUNCOUNTABLE__OPEN,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EFINITE__IMP__NOT__OPEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
