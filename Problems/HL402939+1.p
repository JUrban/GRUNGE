...
fof(thm_2EpatternMatches_2EPMATCH__ROW__COND__DEF__GSYM,conjecture,(
    ! [A_27a,A_27b,V0v_2E0,V1pat_2E0,V2inp_2E0,V3guard_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__COND_2E4(s(tyop_2Emin_2Efun(A_27a,A_27b),V1pat_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V3guard_2E0),s(A_27b,V2inp_2E0),s(A_27a,V0v_2E0))))
    <=> ( s(A_27b,V2inp_2E0) = s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1pat_2E0),s(A_27a,V0v_2E0)))
        & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V3guard_2E0),s(A_27a,V0v_2E0)))) ) ) )).
