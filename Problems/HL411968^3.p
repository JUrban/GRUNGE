...
thf(thm_2Eiterate_2ENEUTRAL__REAL__ADD,axiom,
    ( ( c_2Eiterate_2Eneutral @ tyop_2Erealax_2Ereal @ c_2Erealax_2Ereal__add )
    = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )).

thf(thm_2Eiterate_2ESUM__SUPPORT,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
      ( ( c_2Eiterate_2ESum @ A_27a @ ( c_2Eiterate_2Esupport @ A_27a @ tyop_2Erealax_2Ereal @ c_2Erealax_2Ereal__add @ V0f @ V1s ) @ V0f )
      = ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) ) )).
...
thf(thm_2Eiterate_2ESUM__RMUL,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1c: tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( c_2Eiterate_2ESum @ A_27a @ V2s
        @ ^ [V3x: A_27a] :
            ( c_2Erealax_2Ereal__mul @ ( V0f @ V3x ) @ V1c ) )
      = ( c_2Erealax_2Ereal__mul @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V0f ) @ V1c ) ) )).

thf(thm_2Eiterate_2ESUM__POS__LT,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
     ...
     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__POS__LE,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
      ( ! [V2x: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V2x @ V1s )
         => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V2x ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) ) ) )).

thf(thm_2Eiterate_2ESUM__DELTA,axiom,(
    ! [A_27a: $tType,V0b: tyop_2Erealax_2Ereal,V1s: A_27a > $o,V2a: A_27a] :
      ( ( c_2Eiterate_2ESum @ A_27a @ V1s
        @ ^ [V3x: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ A_27a @ V3x @ V2a ) @ V0b @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
      = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ A_27a @ V2a @ V1s ) @ V0b @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).

thf(thm_2Eiterate_2ESUM__EQ__SUPERSET,axiom,(
    ! [A_27a: $tType,V0g: A_27a > tyop_2Erealax_2Ereal,V1f: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o,V3t: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V3t )
        ...
        & ! [V5x: A_27a] :
           ...
           => ( ( V1f @ V5x )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1f )
        = ( c_2Eiterate_2ESum @ A_27a @ V3t @ V0g ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__WITHIN,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1x: tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eat @ V1x ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V1x ) @ V2s ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN__IN,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o,V4a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3t ) @ V2s )
        ...
        & ! [V5x: tyop_2Erealax_2Ereal] :
           ...
           => ( ( V0f @ V5x )
              = ( V1g @ V5x ) ) )
        & ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V4a ) @ V3t ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V1g @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V4a ) @ V3t ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__SUM,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27b > A_27a > tyop_2Erealax_2Ereal,V2s: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27b @ V2s )
        & ! [V3a: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V3a @ V2s )
           => ( c_2Ereal__topology_2Econtinuous @ A_27a @ ( V1f @ V3a ) @ V0net ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ A_27a
        @ ^ [V4x: A_27a] :
            ( c_2Eiterate_2ESum @ A_27b @ V2s
            @ ^ [V5a: A_27b] :
                ( V1f @ V5a @ V4x ) )
        @ V0net ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__MUL,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V1c @ V0s )
        & ( c_2Ereal__topology_2Econtinuous__on @ V2f @ V0s ) )
     => ( c_2Ereal__topology_2Econtinuous__on
        @ ^ [V3x: tyop_2Erealax_2Ereal] :
            ( c_2Erealax_2Ereal__mul @ ( V1c @ V3x ) @ ( V2f @ V3x ) )
        @ V0s ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__INV,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V1s )
        & ! [V2x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V1s )
           => ( (~)
              @ ( ( V0f @ V2x )
                = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )
     => ( c_2Ereal__topology_2Econtinuous__on @ ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ c_2Erealax_2Einv @ V0f ) @ V1s ) ) )).

thf(thm_2Ereal__topology_2ESETDIST__POS__LE,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__SETDIST,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
      ...
      @ ^ [V2y: tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V2y @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0s ) )
      @ ( c_2Ereal__topology_2Eat @ V1x ) ) )).
...
thf(thm_2Ereal__topology_2ESETDIST__EQ__0__CLOSED__IN,axiom,(
    ! [V0u: tyop_2Erealax_2Ereal > $o,V1s: tyop_2Erealax_2Ereal > $o,V2x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V0u ) @ V1s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0u ) )
     => ( ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V1s ) )
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
      <=> ( ( V1s
...
thf(thm_2Ereal__topology_2ESUBORDINATE__PARTITION__OF__UNITY,conjecture,(
    ! [V0c: ( tyop_2Erealax_2Ereal > $o ) > $o,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1s @ ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V0c ) )
        & ! [V2u: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2u @ V0c )
           => ( c_2Ereal__topology_2EOpen @ V2u ) )
        & ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V1s )
           => ? [V4v: tyop_2Erealax_2Ereal > $o] :
                ( ( c_2Ereal__topology_2EOpen @ V4v )
                & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V4v )
                & ( c_2Epred__set_2EFINITE @ ( tyop_2Erealax_2Ereal > $o )
                  @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o )
                    @ ^ [V5u: tyop_2Erealax_2Ereal > $o] :
                        ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ $o @ V5u @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V5u @ V0c ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V5u @ V4v ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) ) ) ) ) ) )
     => ? [V6f: ( tyop_2Erealax_2Ereal > $o ) > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ! [V7u: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V7u @ V0c )
             => ( ( c_2Ereal__topology_2Econtinuous__on @ ( V6f @ V7u ) @ V1s )
                & ! [V8x: tyop_2Erealax_2Ereal] :
                    ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ V1s )
                   => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V6f @ V7u @ V8x ) ) ) ) )
          & ! [V9x: tyop_2Erealax_2Ereal,V10u: tyop_2Erealax_2Ereal > $o] :
              ( ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V10u @ V0c )
                & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V9x @ V1s )
                & ( (~) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V9x @ V10u ) ) )
             => ( ( V6f @ V10u @ V9x )
                = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
          & ! [V11x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V11x @ V1s )
             => ( ( c_2Eiterate_2ESum @ ( tyop_2Erealax_2Ereal > $o ) @ V0c
                  @ ^ [V12u: tyop_2Erealax_2Ereal > $o] :
                      ( V6f @ V12u @ V11x ) )
                = ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
          & ! [V13x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V13x @ V1s )
             => ? [V14n: tyop_2Erealax_2Ereal > $o] :
                  ( ( c_2Ereal__topology_2EOpen @ V14n )
                  & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V13x @ V14n )
                  & ( c_2Epred__set_2EFINITE @ ( tyop_2Erealax_2Ereal > $o )
                    @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o )
                      @ ^ [V15u: tyop_2Erealax_2Ereal > $o] :
                          ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ $o @ V15u
                          @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V15u @ V0c )
                            @ ( c_2Ebool_2E_7E
                              @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
                                @ ^ [V16x: tyop_2Erealax_2Ereal] :
                                    ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V16x @ V14n ) @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V6f @ V15u @ V16x ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) ) ) ) ) ) ) ) ) )).
