...
tff(conj_thm_2Ereal__topology_2ELIM__DROP__LE,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2ESERIES__DROP__LE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
             ...
             => ! [V3a: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V3a)),V2s))
                    ...
                    & ! [V5x: tp__ty_2Enum_2Enum] :
                        ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5x)),V2s))
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Enum_2Enum(V5x))),ap(V1g,inj__ty_2Enum_2Enum(V5x)))) ) )
                 => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V4b))) ) ) ) ) )).
