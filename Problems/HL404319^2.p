...
thf(conj_thm_2Ering_2Ering__accfupds,lemma,(
    ! [A_27a: del] :
      ( ! [V0r: $i] :
          ( ( mem @ V0r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V1f: $i] :
              ( ( mem @ V1f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R1__fupd @ A_27a ) @ V1f ) @ V0r ) )
      ...
      & ! [V2r: $i] :
         ...
         => ! [V3f: $i] :
             ...
             => ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP__fupd @ A_27a ) @ V3f ) @ V2r ) )
                = ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V2r ) ) ) )
      & ! [V4r: $i] :
          ( ( mem @ V4r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V5f: $i] :
              ( ( mem @ V5f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM__fupd @ A_27a ) @ V5f ) @ V4r ) )
                = ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V4r ) ) ) )
      & ! [V6r: $i] :
          ( ( mem @ V6r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V7f: $i] :
              ( ( mem @ V7f @ ( arr @ ( arr @ A_27a @ A_27a ) @ ( arr @ A_27a @ A_27a ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN__fupd @ A_27a ) @ V7f ) @ V6r ) )
                = ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V6r ) ) ) )
      & ! [V8r: $i] :
          ( ( mem @ V8r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V9f: $i] :
              ( ( mem @ V9f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R0__fupd @ A_27a ) @ V9f ) @ V8r ) )
                = ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V8r ) ) ) )
      & ! [V10r: $i] :
          ( ( mem @ V10r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V11f: $i] :
              ( ( mem @ V11f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP__fupd @ A_27a ) @ V11f ) @ V10r ) )
                = ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V10r ) ) ) )
      & ! [V12r: $i] :
          ( ( mem @ V12r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V13f: $i] :
              ( ( mem @ V13f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM__fupd @ A_27a ) @ V13f ) @ V12r ) )
                = ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V12r ) ) ) )
      & ! [V14r: $i] :
          ( ( mem @ V14r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V15f: $i] :
              ( ( mem @ V15f @ ( arr @ ( arr @ A_27a @ A_27a ) @ ( arr @ A_27a @ A_27a ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN__fupd @ A_27a ) @ V15f ) @ V14r ) )
                = ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V14r ) ) ) )
      & ! [V16r: $i] :
          ( ( mem @ V16r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V17f: $i] :
              ( ( mem @ V17f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R0__fupd @ A_27a ) @ V17f ) @ V16r ) )
                = ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V16r ) ) ) )
      & ! [V18r: $i] :
          ( ( mem @ V18r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V19f: $i] :
              ( ( mem @ V19f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R1__fupd @ A_27a ) @ V19f ) @ V18r ) )
                = ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V18r ) ) ) )
      & ! [V20r: $i] :
          ( ( mem @ V20r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V21f: $i] :
              ( ( mem @ V21f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM__fupd @ A_27a ) @ V21f ) @ V20r ) )
                = ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V20r ) ) ) )
      & ! [V22r: $i] :
          ( ( mem @ V22r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V23f: $i] :
              ( ( mem @ V23f @ ( arr @ ( arr @ A_27a @ A_27a ) @ ( arr @ A_27a @ A_27a ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN__fupd @ A_27a ) @ V23f ) @ V22r ) )
                = ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V22r ) ) ) )
      & ! [V24r: $i] :
          ( ( mem @ V24r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V25f: $i] :
              ( ( mem @ V25f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R0__fupd @ A_27a ) @ V25f ) @ V24r ) )
                = ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V24r ) ) ) )
      & ! [V26r: $i] :
          ( ( mem @ V26r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V27f: $i] :
              ( ( mem @ V27f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R1__fupd @ A_27a ) @ V27f ) @ V26r ) )
                = ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V26r ) ) ) )
      & ! [V28r: $i] :
          ( ( mem @ V28r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V29f: $i] :
              ( ( mem @ V29f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP__fupd @ A_27a ) @ V29f ) @ V28r ) )
                = ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V28r ) ) ) )
      & ! [V30r: $i] :
          ( ( mem @ V30r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V31f: $i] :
              ( ( mem @ V31f @ ( arr @ ( arr @ A_27a @ A_27a ) @ ( arr @ A_27a @ A_27a ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN__fupd @ A_27a ) @ V31f ) @ V30r ) )
                = ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V30r ) ) ) )
      & ! [V32r: $i] :
          ( ( mem @ V32r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V33f: $i] :
              ( ( mem @ V33f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R0__fupd @ A_27a ) @ V33f ) @ V32r ) )
                = ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V32r ) ) ) )
      & ! [V34r: $i] :
          ( ( mem @ V34r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V35f: $i] :
              ( ( mem @ V35f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R1__fupd @ A_27a ) @ V35f ) @ V34r ) )
                = ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V34r ) ) ) )
      & ! [V36r: $i] :
          ( ( mem @ V36r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V37f: $i] :
              ( ( mem @ V37f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP__fupd @ A_27a ) @ V37f ) @ V36r ) )
                = ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V36r ) ) ) )
      & ! [V38r: $i] :
          ( ( mem @ V38r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V39f: $i] :
              ( ( mem @ V39f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM__fupd @ A_27a ) @ V39f ) @ V38r ) )
                = ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V38r ) ) ) )
      & ! [V40r: $i] :
          ( ( mem @ V40r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V41f: $i] :
              ( ( mem @ V41f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R0__fupd @ A_27a ) @ V41f ) @ V40r ) )
                = ( ap @ V41f @ ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V40r ) ) ) ) )
      & ! [V42r: $i] :
          ( ( mem @ V42r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V43f: $i] :
              ( ( mem @ V43f @ ( arr @ A_27a @ A_27a ) )
             => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__R1__fupd @ A_27a ) @ V43f ) @ V42r ) )
                = ( ap @ V43f @ ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V42r ) ) ) ) )
      & ! [V44r: $i] :
          ( ( mem @ V44r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V45f: $i] :
              ( ( mem @ V45f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP__fupd @ A_27a ) @ V45f ) @ V44r ) )
                = ( ap @ V45f @ ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V44r ) ) ) ) )
      & ! [V46r: $i] :
          ( ( mem @ V46r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V47f: $i] :
              ( ( mem @ V47f @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM__fupd @ A_27a ) @ V47f ) @ V46r ) )
                = ( ap @ V47f @ ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V46r ) ) ) ) )
      & ! [V48r: $i] :
          ( ( mem @ V48r @ ( ty_2Ering_2Ering @ A_27a ) )
         => ! [V49f: $i] :
              ( ( mem @ V49f @ ( arr @ ( arr @ A_27a @ A_27a ) @ ( arr @ A_27a @ A_27a ) ) )
             => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN__fupd @ A_27a ) @ V49f ) @ V48r ) )
                = ( ap @ V49f @ ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V48r ) ) ) ) ) ) )).

thf(conj_thm_2Ering_2Ering__component__equality,lemma,(
    ! [A_27a: del,V0r1: $i] :
      ( ( mem @ V0r1 @ ( ty_2Ering_2Ering @ A_27a ) )
     => ! [V1r2: $i] :
          ( ( mem @ V1r2 @ ( ty_2Ering_2Ering @ A_27a ) )
         => ( ( V0r1 = V1r2 )
          <=> ( ( ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V0r1 )
                = ( ap @ ( c_2Ering_2Ering__R0 @ A_27a ) @ V1r2 ) )
              & ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V0r1 )
                = ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ V1r2 ) )
              & ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V0r1 )
                = ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V1r2 ) )
              & ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V0r1 )
                = ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V1r2 ) )
              & ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V0r1 )
                = ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V1r2 ) ) ) ) ) ) )).

thf(conj_thm_2Ering_2Ering__literal__11,conjecture,(
    ! [A_27a: del,V0a01: $i] :
      ( ( mem @ V0a01 @ A_27a )
     => ! [V1a1: $i] :
          ( ( mem @ V1a1 @ A_27a )
