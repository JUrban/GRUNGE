...
tff(mem_c_2Epath_2Epmap,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] : mem(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),arr(arr(A_27a,A_27c),arr(arr(A_27b,A_27d),arr(ty_2Epath_2Epath(A_27a,A_27a),ty_2Epath_2Epath(A_27c,A_27c))))) )).
...
tff(conj_thm_2Epath_2Epmap__thm,lemma,(
...
tff(conj_thm_2Epath_2Enth__label__pmap,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2i: tp__ty_2Enum_2Enum,V3p: $i] :
             ...
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2i))),ap(c_2Epath_2EPL(A_27a,A_27a),V3p)))
               => ap(ap(c_2Epath_2Enth__label(A_27c,A_27c),inj__ty_2Enum_2Enum(V2i)),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V3p)) = ap(V1g,ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V2i)),V3p)) ) ) ) ) )).
