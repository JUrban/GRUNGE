...
tff(lmtp_f1874,type,(
    f1874: ( del * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1874,axiom,(
    ! [A_27a: del,V4x: $i] :
      ( mem(V4x,A_27a)
     => ! [V2f: $i] :
          ( mem(V2f,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1n: tp__ty_2Enum_2Enum] : mem(f1874(A_27a,V4x,V2f,V1n),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1874,axiom,(
    ! [A_27a: del,V4x: $i] :
     ...
     => ! [V2f: $i] :
          ( mem(V2f,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1n: tp__ty_2Enum_2Enum,V5m: tp__ty_2Enum_2Enum] : ap(f1874(A_27a,V4x,V2f,V1n),inj__ty_2Enum_2Enum(V5m)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V1n))),ap(ap(c_2Emin_2E_3D(A_27a),ap(V2f,inj__ty_2Enum_2Enum(V5m))),V4x)) ) ) )).

tff(conj_thm_2Ecardinal_2EHAS__SIZE__INDEX,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ecardinal_2EHAS__SIZE(A_27a),V0s),inj__ty_2Enum_2Enum(V1n)))
         => ? [V2f: $i] :
              ...
              & ! [V4x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),V0s))
                   => p(ap(c_2Ebool_2E_3F_21(ty_2Enum_2Enum),f1874(A_27a,V4x,V2f,V1n))) ) ) ) ) ) )).
...
tff(conj_thm_2Eiterate_2EFINITE__INDEX__NUMSEG,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
      <=> ? [V1f: $i] :
            ...
            & ! [V2i: tp__ty_2Enum_2Enum,V3j: tp__ty_2Enum_2Enum] :
               ...
               => V2i = V3j )
            & V0s = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),ap(ap(c_2Eiterate_2E_2E_2E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(c_2Epred__set_2ECARD(A_27a),V0s))) ) ) ) )).
