...
fof(conj_thm_2Epred__set_2EBIJ__IMP__11,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
              ( mem(V0f,arr(A_27a,A_27b))
             => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(A_27b)))
               => ! [V1x] :
                    ( mem(V1x,A_27a)
                   => ! [V2y] :
                        ( mem(V2y,A_27a)
