...
thf(thm_2Equotient_2ERES__EXISTS__UNIQUE__REGULAR,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1R: A_27a > A_27a > $o,V2Q: A_27a > $o] :
      ( ( ! [V3x: A_27a] :
            ( ( V0P @ V3x )
           => ( V2Q @ V3x ) )
        & ! [V4x: A_27a,V5y: A_27a] :
            ( ( ( c_2Equotient_2Erespects @ A_27a @ $o @ V1R @ V4x )
              & ( V2Q @ V4x )
              & ( c_2Equotient_2Erespects @ A_27a @ $o @ V1R @ V5y )
              & ( V2Q @ V5y ) )
           => ( V1R @ V4x @ V5y ) ) )
     => ( ( c_2Ebool_2ERES__EXISTS__UNIQUE @ A_27a @ ( c_2Equotient_2Erespects @ A_27a @ $o @ V1R ) @ V0P )
       => ( c_2Equotient_2ERES__EXISTS__EQUIV @ A_27a @ V1R @ V2Q ) ) ) )).
