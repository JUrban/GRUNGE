...
thf(f1252_0_2E0,type,(
    f1252_0_2E0: u )).

thf(f1252_0_2E1,type,(
    f1252_0_2E1: du > u )).
...
thf(mono_2Ef1252_0,type,(
    mono_2Ef1252_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ewhile_2ELEAST__T,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1252_0 @ V0x )
      = mono_2Ec_2Ebool_2ET ) )).

thf(thm_2Ewhile_2ELEAST__T,conjecture,
    ( ( mono_2Ec_2Ewhile_2ELEAST @ mono_2Ef1252_0 )
    = mono_2Ec_2Enum_2E0 )).
