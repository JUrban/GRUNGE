...
thf(conj_thm_2Efrac_2EFRAC__DNM__SAVE,conjecture,(
    ! [V0a1: tp__ty_2Einteger_2Eint,V1b1: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Efrac_2Efrac__dnm @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ V0a1 ) ) @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) )
      = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).
