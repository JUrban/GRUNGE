...
tff(lamtp_f3824,axiom,(
    ! [A_27a: del,V2g: $i] :
      ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3824(A_27a,V2g,V0f),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3824,axiom,(
    ! [A_27a: del,V2g: $i] :
      ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3824(A_27a,V2g,V0f),V4x) = ap(V0f,ap(V2g,V4x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__CONTINUOUS__FUNCTION,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1net: $i] :
          ( mem(V1net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V2g: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V3l))))
                    & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V2g),inj__ty_2Erealax_2Ereal(V3l)),V1net)) )
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3824(A_27a,V2g,V0f)),ap(V0f,inj__ty_2Erealax_2Ereal(V3l))),V1net)) ) ) ) ) )).
