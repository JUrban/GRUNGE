...
tff(lamtp_f1952,axiom,(
    mem(f1952,arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f1952,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum] : ap(f1952,inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).

tff(ax_thm_2EternaryComparisons_2Eordering__BIJ,axiom,
    ( ! [V0a: tp__ty_2EternaryComparisons_2Eordering] : surj__ty_2EternaryComparisons_2Eordering(ap(c_2EternaryComparisons_2Enum2ordering,ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(V0a)))) = V0a
    & ! [V1r: tp__ty_2Enum_2Enum] :
        ( p(ap(f1952,inj__ty_2Enum_2Enum(V1r)))
      <=> surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,ap(c_2EternaryComparisons_2Enum2ordering,inj__ty_2Enum_2Enum(V1r)))) = V1r ) )).

tff(conj_thm_2EternaryComparisons_2Eordering2num__ONTO,conjecture,(
    ...
    <=> ? [V1a: tp__ty_2EternaryComparisons_2Eordering] : V0r = surj__ty_2Enum_2Enum(ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(V1a))) ) )).
