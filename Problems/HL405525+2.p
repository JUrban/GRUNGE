...
fof(conj_thm_2Einteger_2EINT__QUOT__CALCULATE,conjecture,
    ( ! [V0p] :
        ( mem(V0p,ty_2Enum_2Enum)
       => ! [V1q] :
            ( mem(V1q,ty_2Enum_2Enum)
    ...
    & ! [V2p] :
       ...
       => ! [V3q] :
           ...
           => ( V3q != ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
             => ( ap(ap(c_2Einteger_2Eint__quot,ap(c_2Einteger_2Eint__neg,V2p)),V3q) = ap(c_2Einteger_2Eint__neg,ap(ap(c_2Einteger_2Eint__quot,V2p),V3q))
                & ap(ap(c_2Einteger_2Eint__quot,V2p),ap(c_2Einteger_2Eint__neg,V3q)) = ap(c_2Einteger_2Eint__neg,ap(ap(c_2Einteger_2Eint__quot,V2p),V3q)) ) ) ) )
    & ! [V4m] :
