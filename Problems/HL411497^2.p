...
thf(conj_thm_2Ereal__topology_2ETRANSLATION__DIFF,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
     ...
     => ! [V2t: $i] :
         ...
         => ( ( ap
              ...
              @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ V1s ) @ V2t ) )
            = ( ap
              @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal )
                @ ( ap
                  @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V4x: $i] :
              ...
              @ ( ap
                @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V5x: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V5x ) ) )
                @ V2t ) ) ) ) ) )).
