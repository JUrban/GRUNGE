...
tff(conj_thm_2Ebitstring_2Ev2w__n2v,lemma,(
...
tff(conj_thm_2Ebitstring_2Eops__to__v2w,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,A_27g: del,A_27h: del,A_27i: del,A_27j: del,A_27k: del,A_27l: del,A_27m: del,A_27n: del,A_27o: del,A_27p: del,A_27q: del,A_27r: del,A_27s: del,A_27t: del] :
      ...
      & ! [V24v: tp__c_ty_2Elist_2Elist_o,V25n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V24v))),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(V25n))) = ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V24v))),ap(c_2Ebitstring_2Ev2w(A_27b),ap(c_2Ebitstring_2En2v,inj__ty_2Enum_2Enum(V25n))))
      & ! [V26v: tp__c_ty_2Elist_2Elist_o,V27n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V27n))),ap(c_2Ebitstring_2Ev2w(A_27b),inj__c_ty_2Elist_2Elist_o(V26v))) = ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),ap(c_2Ebitstring_2En2v,inj__ty_2Enum_2Enum(V27n)))),ap(c_2Ebitstring_2Ev2w(A_27b),inj__c_ty_2Elist_2Elist_o(V26v)))
      & ! [V28v: tp__c_ty_2Elist_2Elist_o,V29n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__join(A_27q,A_27q),ap(c_2Ebitstring_2Ev2w(A_27q),inj__c_ty_2Elist_2Elist_o(V28v))),ap(c_2Ewords_2En2w(A_27r),inj__ty_2Enum_2Enum(V29n))) = ap(ap(c_2Ewords_2Eword__join(A_27q,A_27q),ap(c_2Ebitstring_2Ev2w(A_27q),inj__c_ty_2Elist_2Elist_o(V28v))),ap(c_2Ebitstring_2Ev2w(A_27r),ap(c_2Ebitstring_2En2v,inj__ty_2Enum_2Enum(V29n))))
      & ! [V30v: tp__c_ty_2Elist_2Elist_o,V31n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__join(A_27s,A_27s),ap(c_2Ewords_2En2w(A_27s),inj__ty_2Enum_2Enum(V31n))),ap(c_2Ebitstring_2Ev2w(A_27t),inj__c_ty_2Elist_2Elist_o(V30v))) = ap(ap(c_2Ewords_2Eword__join(A_27s,A_27s),ap(c_2Ebitstring_2Ev2w(A_27s),ap(c_2Ebitstring_2En2v,inj__ty_2Enum_2Enum(V31n)))),ap(c_2Ebitstring_2Ev2w(A_27t),inj__c_ty_2Elist_2Elist_o(V30v))) ) )).
