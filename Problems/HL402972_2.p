...
tff(conj_thm_2Elist_2EEVERY__APPEND,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l1: $i] :
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__0,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V2rs: $i] :
             ...
             => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1r),V2rs)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
              <=> ap(V1r,V0v) = c_2Eoption_2ENONE(A_27b) ) ) ) ) )).

tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__LT,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rs1: $i] :
         ...
         => ! [V2rs2: $i] :
             ...
             => ! [V3i: tp__ty_2Enum_2Enum] :
                 ...
                 => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2EAPPEND(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1),V2rs2)),inj__ty_2Enum_2Enum(V3i)))
                  <=> p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V1rs1),inj__ty_2Enum_2Enum(V3i))) ) ) ) ) ) )).
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__GE,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rs1: $i] :
          ( mem(V1rs1,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
             ...
             => ! [V3i: tp__ty_2Enum_2Enum] :
                 ...
                 => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2EAPPEND(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1),V2rs2)),inj__ty_2Enum_2Enum(V3i)))
                  <=> ( ( ~ p(ap(ap(c_2Elist_2EEVERY(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),f839(A_27b,A_27a,A_27a,A_27b,V0v)),V1rs1))
                      ...
                      | p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V2rs2),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3i)),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rs1)))) ) ) ) ) ) ) )).
...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__SNOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rows: $i] :
          ( mem(V1rows,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
             ...
             => ! [V5i: tp__o,V6c_27: tp__o] :
                 ...
                 => ( ( ap(V4r,V0v) = c_2Eoption_2ENONE(A_27b)
                   ...
                   => ( ( p(inj__o(V2c))
                       => ( p(inj__o(V5i))
                         => ap(V4r,V0v) = c_2Eoption_2ENONE(A_27b) ) )
                     => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ESNOC(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V4r),V1rows)),inj__o(V6c_27)),ap(ap(c_2Elist_2ESNOC(bool),inj__o(V5i)),inj__c_ty_2Elist_2Elist_o(V3infos)))) ) ) ) ) ) ) )).
