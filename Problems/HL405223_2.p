...
tff(tp_c_2ECoder_2Edecode,type,(
    c_2ECoder_2Edecode: del > $i )).

tff(mem_c_2ECoder_2Edecode,axiom,(
    ! [A_27a: del] : mem(c_2ECoder_2Edecode(A_27a),arr(arr(A_27a,bool),arr(arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))),arr(ty_2Elist_2Elist(bool),A_27a)))) )).

tff(tp_c_2ECoder_2Edecoder,type,(
    c_2ECoder_2Edecoder: del > $i )).

tff(mem_c_2ECoder_2Edecoder,axiom,(
    ! [A_27a: del] : mem(c_2ECoder_2Edecoder(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Elist_2Elist(bool),A_27a))) )).
...
tff(ax_thm_2ECoder_2Edecoder__def,axiom,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
...
tff(conj_thm_2ECoder_2Edecode__encode,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
...
tff(conj_thm_2ECoder_2Ewf__coder,conjecture,(
    ! [A_27a: del,V0c: $i] :
