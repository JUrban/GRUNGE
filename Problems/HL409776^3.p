...
thf(thm_2Eiterate_2ENSUM__CLAUSES__NUMSEG,axiom,(
...
thf(thm_2Eiterate_2ENSUM__CLAUSES__RIGHT,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ V0f )
        = ( c_2Earithmetic_2E_2B @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ ( c_2Earithmetic_2E_2D @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0f ) @ ( V0f @ V2n ) ) ) ) )).
