...
fof(conj_thm_2Epred__set_2EUNIV__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2EMAXIMAL__INDEPENDENT__SUBSET__EXTEND,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1v] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND__LEMMA,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Erealax_2Ereal,bool))
