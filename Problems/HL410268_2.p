...
tff(conj_thm_2Eextreal_2Eabs__pos,lemma,(
...
tff(conj_thm_2Eextreal_2Eabs__bounds__lt,lemma,(
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__ABS,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                  ...
                  & ! [V3x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Espace(A_27a),V0a)))
                       => surj__ty_2Eextreal_2Eextreal(ap(V2g,V3x)) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__abs,ap(V1f,V3x))) ) ) )
