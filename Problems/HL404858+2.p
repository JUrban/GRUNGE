...
fof(conj_thm_2Efinite__map_2EDRESTRICT__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f1933,axiom,(
    ! [A_27a,A_27b,A_27a,V2k] :
      ( mem(V2k,A_27a)
...
fof(lamtp_f1932,axiom,(
    ! [A_27b,A_27a,A_27a] : mem(f1932(A_27b,A_27a,A_27a),arr(A_27a,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).

fof(lameq_f1932,axiom,(
    ! [A_27b,A_27a,A_27a,V2k] :
      ( mem(V2k,A_27a)
     => ap(f1932(A_27b,A_27a,A_27a),V2k) = f1933(A_27a,A_27b,A_27a,V2k) ) )).

fof(conj_thm_2Efinite__map_2EDRESTRICT__DOMSUB,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2Edrestrict__iter__list,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
