...
tff(lmtp_f1260,type,(
    f1260: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1260,axiom,(
    ! [A_27b: del,A_27c: del,A_27d: del,A_27a: del,V6f: $i] :
      ( mem(V6f,arr(A_27c,A_27d))
     => ! [V1abs1: $i] :
...
tff(conj_thm_2Equotient_2ELAMBDA__PRS1,conjecture,(
