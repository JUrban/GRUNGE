...
tff(conj_thm_2Eprobability_2EPROB__EQ__BIGUNION__IMAGE,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2p: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V2p))
                  ...
                  & ! [V7n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V2p),ap(V0f,inj__ty_2Enum_2Enum(V7n)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V2p),ap(V1g,inj__ty_2Enum_2Enum(V7n)))) )
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V2p),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V2p),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1g),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) ) ) ) ) )).
