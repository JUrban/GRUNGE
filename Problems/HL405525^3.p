...
thf(thm_2Einteger_2EINT__QUOT__CALCULATE,conjecture,
    ( ! [V0p: tyop_2Enum_2Enum,V1q: tyop_2Enum_2Enum] :
        ( ( (~) @ ( V1q = c_2Enum_2E0 ) )
       => ( ( c_2Einteger_2Eint__quot @ ( c_2Einteger_2Eint__of__num @ V0p ) @ ( c_2Einteger_2Eint__of__num @ V1q ) )
          = ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2EDIV @ V0p @ V1q ) ) ) )
    & ! [V2p: tyop_2Einteger_2Eint,V3q: tyop_2Einteger_2Eint] :
        ( ( (~)
          @ ( V3q
            = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) )
       => ( ( ( c_2Einteger_2Eint__quot @ ( c_2Einteger_2Eint__neg @ V2p ) @ V3q )
            = ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__quot @ V2p @ V3q ) ) )
          & ( ( c_2Einteger_2Eint__quot @ V2p @ ( c_2Einteger_2Eint__neg @ V3q ) )
            = ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__quot @ V2p @ V3q ) ) ) ) )
