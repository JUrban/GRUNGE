...
thf(thm_2Ebag_2EBAG__DELETE__BAG__IN__down,conjecture,(
    ! [A_27a: $tType,V0b0: A_27a > tyop_2Enum_2Enum,V1b: A_27a > tyop_2Enum_2Enum,V2e1: A_27a,V3e2: A_27a] :
      ( ( ( c_2Ebag_2EBAG__DELETE @ A_27a @ V0b0 @ V2e1 @ V1b )
        & ( (~) @ ( V2e1 = V3e2 ) )
        & ( c_2Ebag_2EBAG__IN @ A_27a @ V3e2 @ V0b0 ) )
     => ( c_2Ebag_2EBAG__IN @ A_27a @ V3e2 @ V1b ) ) )).
