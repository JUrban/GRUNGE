...
thf(tp_c_2Equotient__pred__set_2EDELETER,type,(
    c_2Equotient__pred__set_2EDELETER: del > $i )).

thf(mem_c_2Equotient__pred__set_2EDELETER,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Equotient__pred__set_2EIN__DELETER,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Equotient__pred__set_2EDELETE__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1abs: $i] :
          ( ( mem @ V1abs @ ( arr @ A_27a @ A_27b ) )
         => ! [V2rep: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27a @ A_27b ) @ V0R ) @ V1abs ) @ V2rep ) )
               => ! [V3s: $i] :
                   ...
                   => ! [V4x: $i] :
                        ( ( mem @ V4x @ A_27b )
                       => ( ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27b ) @ V3s ) @ V4x )
                          = ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27b @ bool @ A_27a @ bool ) @ V2rep ) @ ( c_2Ecombin_2EI @ bool ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient__pred__set_2EDELETER @ A_27a ) @ V0R ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ bool @ A_27b @ bool ) @ V1abs ) @ ( c_2Ecombin_2EI @ bool ) ) @ V3s ) ) @ ( ap @ V2rep @ V4x ) ) ) ) ) ) ) ) ) ) )).
