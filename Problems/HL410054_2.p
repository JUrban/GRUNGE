...
tff(conj_thm_2Eproduct_2EPRODUCT__SUPPORT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eproduct_2Eproduct(A_27a),ap(ap(ap(c_2Eiterate_2Esupport(A_27a,A_27a),c_2Erealax_2Ereal__mul),V0f),V1s)),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),V0f)) ) ) )).
