...
tff(conj_thm_2Epred__set_2ECOUNTABLE__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE__INJ__GENERAL,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1A: $i] :
          ( mem(V1A,arr(A_27b,bool))
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: $i] :
               ...
               => p(ap(c_2Epred__set_2Ecountable(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f1866(A_27b,A_27a,V2s,V0f,V1A)))) ) ) ) ) )).
