...
thf(tp_c_2Etoto_2Elistorder,type,(
    c_2Etoto_2Elistorder: del > $i )).

thf(mem_c_2Etoto_2Elistorder,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Etoto_2ESLO__listorder,lemma,(
    ! [A_27a: del,V0V: $i] :
...
thf(ax_thm_2Etoto_2EListOrd,axiom,(
    ! [A_27a: del,V0c: $i] :
      ( ( mem @ V0c @ ( ty_2Etoto_2Etoto @ A_27a ) )
     => ( ( ap @ ( c_2Etoto_2EListOrd @ A_27a ) @ V0c )
        = ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( c_2Etoto_2Elistorder @ A_27a ) @ ( ap @ ( c_2Etoto_2EStrongLinearOrder__of__TO @ A_27a ) @ ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ V0c ) ) ) ) ) ) )).

thf(conj_thm_2Etoto_2ETO__ListOrd,conjecture,(
    ! [A_27a: del,V0c: $i] :
      ( ( mem @ V0c @ ( ty_2Etoto_2Etoto @ A_27a ) )
