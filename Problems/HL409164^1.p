...
thf(f10727_0_2E0,type,(
    f10727_0_2E0: u )).

thf(f10727_0_2E1,type,(
    f10727_0_2E1: du > u )).
...
thf(c_2Eieee_2Eccode__CASE_2E0,type,(
    c_2Eieee_2Eccode__CASE_2E0: u )).

thf(c_2Eieee_2Eccode__CASE_2E5,type,(
...
thf(mono_2Ef10727_0,type,(
    mono_2Ef10727_0: mono_2Etyop_2Eieee_2Eccode > $o )).
...
thf(arityeq5_2Emono_2Ec_2Eieee_2Eccode__CASE_2E5_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Eieee_2Eccode,X1_2E0: u,X2_2E0: u,X3_2E0: u,X4_2E0: u] :
      ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) @ ( s @ A_27a @ X4_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eieee_2Eccode @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) ) ) ) @ c_2Eieee_2Eccode__CASE_2E0 ) @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) @ ( s @ A_27a @ X3_2E0 ) ) ) @ ( s @ A_27a @ X4_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Eieee_2Eccode__CASE,axiom,(
    ! [V0x: mono_2Etyop_2Eieee_2Eccode] :
      ( ( mono_2Ef10727_0 @ V0x )
    <=> ( ( mono_2Ec_2Eieee_2Eccode2num @ V0x )
        = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )).

thf(thm_2Eieee_2Eccode__CASE,axiom,(
    ! [A_27a: d,V0x: mono_2Etyop_2Eieee_2Eccode,V1v0_2E0: u,V2v1_2E0: u,V3v2_2E0: u,V4v3_2E0: u] :
      ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ V0x ) ) @ ( s @ A_27a @ V1v0_2E0 ) @ ( s @ A_27a @ V2v1_2E0 ) @ ( s @ A_27a @ V3v2_2E0 ) @ ( s @ A_27a @ V4v3_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Eieee_2Eccode2num @ V0x ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ A_27a @ V1v0_2E0 ) @ ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Eieee_2Eccode2num @ V0x ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ A_27a @ V2v1_2E0 ) @ ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef10727_0 @ V0x ) ) ) @ ( s @ A_27a @ V3v2_2E0 ) @ ( s @ A_27a @ V4v3_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Eieee_2Eccode__case__def,conjecture,(
    ! [A_27a: d] :
      ( ! [V0v0_2E0: u,V1v1_2E0: u,V2v2_2E0: u,V3v3_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ mono_2Ec_2Eieee_2EGt ) ) @ ( s @ A_27a @ V0v0_2E0 ) @ ( s @ A_27a @ V1v1_2E0 ) @ ( s @ A_27a @ V2v2_2E0 ) @ ( s @ A_27a @ V3v3_2E0 ) ) )
          = ( s @ A_27a @ V0v0_2E0 ) )
      & ! [V4v0_2E0: u,V5v1_2E0: u,V6v2_2E0: u,V7v3_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ mono_2Ec_2Eieee_2ELt ) ) @ ( s @ A_27a @ V4v0_2E0 ) @ ( s @ A_27a @ V5v1_2E0 ) @ ( s @ A_27a @ V6v2_2E0 ) @ ( s @ A_27a @ V7v3_2E0 ) ) )
          = ( s @ A_27a @ V5v1_2E0 ) )
      & ! [V8v0_2E0: u,V9v1_2E0: u,V10v2_2E0: u,V11v3_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ mono_2Ec_2Eieee_2EEq ) ) @ ( s @ A_27a @ V8v0_2E0 ) @ ( s @ A_27a @ V9v1_2E0 ) @ ( s @ A_27a @ V10v2_2E0 ) @ ( s @ A_27a @ V11v3_2E0 ) ) )
          = ( s @ A_27a @ V10v2_2E0 ) )
      & ! [V12v0_2E0: u,V13v1_2E0: u,V14v2_2E0: u,V15v3_2E0: u] :
          ( ( s @ A_27a @ ( c_2Eieee_2Eccode__CASE_2E5 @ ( s @ tyop_2Eieee_2Eccode @ ( i_mono_2Etyop_2Eieee_2Eccode @ mono_2Ec_2Eieee_2EUn ) ) @ ( s @ A_27a @ V12v0_2E0 ) @ ( s @ A_27a @ V13v1_2E0 ) @ ( s @ A_27a @ V14v2_2E0 ) @ ( s @ A_27a @ V15v3_2E0 ) ) )
          = ( s @ A_27a @ V15v3_2E0 ) ) ) )).
