...
thf(thm_2Esum_2EINL,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISL_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0x_2E0 ) ) ) )
     => ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ ( c_2Esum_2EOUTL_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0x_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0x_2E0 ) ) ) )).
