...
tff(conj_thm_2Ecardinal_2ESURJECTIVE__ON__RIGHT__INVERSE,lemma,(
...
tff(conj_thm_2Ecardinal_2EBIJECTIVE__INJECTIVE__SURJECTIVE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2EBIJECTIVE__INVERSES,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
