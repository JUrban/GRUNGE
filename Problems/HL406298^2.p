...
thf(ax_thm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a: del] :
              ...
              @ ^ [V2a: $i] :
                  ...
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3v: $i] :
                        ...
                        @ ^ [V4v1: $i] :
                            ( ap @ ( c_2Ecombin_2EI @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ V3v ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2En2w__itself__def,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Ewords_2En2w__itself @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
