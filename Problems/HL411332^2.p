...
thf(conj_thm_2Ereal__topology_2EDIST__TRIANGLE__LT,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__APPROACHABLE,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
