...
fof(conj_thm_2EHolSmt_2Er070,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ! [V2z] :
             ...
             => ( V0x = ap(ap(c_2Einteger_2Eint__add,V1y),V2z)
              <=> ap(ap(c_2Einteger_2Eint__add,V1y),ap(ap(c_2Einteger_2Eint__add,V2z),ap(ap(c_2Einteger_2Eint__mul,ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0x))) = ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0) ) ) ) ) )).
