...
thf(conj_thm_2Epred__set_2EINTER__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ! [V0s: $i] :
          ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__NONOVERLAP,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
            = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
        <=> ( ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ V0s ) )
            ...
            | ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) )
             != ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) ) ) ) )).
