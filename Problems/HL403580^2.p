...
thf(ax_thm_2Ewellorder_2Eposet,axiom,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
...
thf(ax_thm_2Ewellorder_2Echain,axiom,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ewellorder_2EZL,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ( ( ( p @ ( ap @ ( c_2Ewellorder_2Eposet @ A_27a ) @ V0l ) )
          & ? [V1x: $i] :
              ...
              & ( p
                @ ( ap
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ ( c_2Ewellorder_2Efl @ A_27a ) @ V0l ) @ V2x ) )
                  @ V1x ) ) )
          & ! [V3P: $i] :
