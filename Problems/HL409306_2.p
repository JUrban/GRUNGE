...
tff(conj_thm_2Elift__ieee_2Efinite__float__within__threshold,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(conj_thm_2Elift__ieee_2Eround__finite__normal__float__id,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
     => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0f))
          & ~ p(ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27a,A_27a),V0f)) )
       => ap(ap(c_2Ebinary__ieee_2Eround(A_27a,A_27a),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27a,A_27a),V0f)) = V0f ) ) )).
