...
thf(thm_2EHolSmt_2Er119,conjecture,(
    ...
    <=> ( (~) @ ( c_2Einteger_2Eint__ge @ ( c_2Einteger_2Eint__add @ ( c_2Einteger_2Eint__add @ V2x @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V1y ) ) @ V0z ) @ ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) ) )).
