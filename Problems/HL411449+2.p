...
fof(conj_thm_2Ereal__topology_2EBOUNDED__HAS__INF,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECLOSED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
      <=> ! [V1x] :
           ...
           => ( ! [V2e] :
                 ...
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2e))
                   => ? [V3x_27] :
                        ...
                        & V3x_27 != V1x
                        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V3x_27),V1x))),V2e)) ) ) )
             => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOMPACT__ATTAINS__INF,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
          & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
