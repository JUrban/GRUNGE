...
fof(conj_thm_2Ewords_2Ew2w__LSL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V2n] :
                 ...
                 => ! [V3w] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0h),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                       => ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),V0h),V1l),ap(ap(c_2Ewords_2Eword__lsl(A_27a),V3w),V2n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Earithmetic_2E_3C_3D,V2n),V0h)),ap(ap(c_2Ewords_2Eword__lsl(A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,V0h),V2n)),ap(ap(c_2Earithmetic_2E_2D,V1l),V2n)),V3w)),ap(ap(c_2Earithmetic_2E_2D,V2n),V1l))),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)) ) ) ) ) ) ) )).

fof(conj_thm_2Ewords_2EWORD__EXTRACT__LSL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
