...
fof(conj_thm_2Eproduct_2EPRODUCT__ABS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3362(A_27a,V0f)) = ap(c_2Ereal_2Eabs,ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),V0f)) ) ) ) ) )).
