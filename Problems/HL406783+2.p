...
fof(conj_thm_2Erich__list_2EFILTER__FILTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Epatricia_2EPERM__DELETE__PTREE,conjecture,(
    ! [V0t] :
     ...
     => ! [V1k] :
         ...
         => ( ( p(ap(c_2Epatricia_2EIS__PTREE(ty_2Eone_2Eone),V0t))
           ...
           => p(ap(ap(c_2Esorting_2EPERM(ty_2Enum_2Enum),ap(c_2Epatricia_2ETRAVERSE(ty_2Eone_2Eone),ap(ap(c_2Epatricia_2EREMOVE(ty_2Eone_2Eone),V0t),V1k))),ap(ap(c_2Elist_2EFILTER(ty_2Enum_2Enum),f2572(V1k)),ap(c_2Epatricia_2ETRAVERSE(ty_2Eone_2Eone),V0t)))) ) ) ) )).
