...
fof(mem_c_2EerrorStateMonad_2EES__CHOICE,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EerrorStateMonad_2EES__CHOICE(A_27a,A_27a),arr(arr(A_27b,ty_2Eoption_2Eoption(A_27a)),arr(arr(A_27b,ty_2Eoption_2Eoption(A_27a)),arr(A_27b,ty_2Eoption_2Eoption(A_27a))))) ) ) )).
...
fof(lamtp_f578,axiom,(
    ! [A_27a] : mem(f578(A_27a),arr(A_27a,ty_2Eoption_2Eoption(A_27a))) )).
...
fof(conj_thm_2EerrorStateMonad_2EES__CHOICE__FAIL__RID,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0xM] :
             ...
             => ap(ap(c_2EerrorStateMonad_2EES__CHOICE(A_27b,A_27b),V0xM),c_2EerrorStateMonad_2EES__FAIL(A_27b,A_27b)) = V0xM ) ) ) )).
