...
thf(conj_thm_2Erich__list_2EFOLDR__FOLDL__REVERSE,lemma,(
...
thf(conj_thm_2Erich__list_2EFOLDR__REVERSE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27b )
         => ! [V2l: $i] :
              ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27b ) @ V0f ) @ V1e ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ V2l ) )
                = ( ap
                  @ ( ap
                    @ ( ap @ ( c_2Elist_2EFOLDL @ A_27a @ A_27b )
                      @ ( lam @ A_27b
