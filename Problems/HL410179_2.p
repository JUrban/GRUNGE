...
tff(conj_thm_2Epred__set_2EDISJOINT__DIFFS,lemma,(
    ! [A_27a: del,V0g: $i] :
...
tff(conj_thm_2Emeasure_2ECOUNTABLY__ADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Emeasure_2EMEASURE__COUNTABLE__INCREASING,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
