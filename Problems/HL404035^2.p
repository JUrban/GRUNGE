...
thf(conj_thm_2Equotient_2Eo__PRS,conjecture,(
                                         ...
                                         => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27c @ A_27f ) @ V6R3 ) @ V7abs3 ) @ V8rep3 ) )
                                           => ! [V9f: $i] :
                                               ...
                                               => ! [V10g: $i] :
                                                   ...
                                                   => ( ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27d @ A_27f @ A_27e ) @ V9f ) @ V10g )
                                                      = ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27d @ A_27c @ A_27a @ A_27f ) @ V2rep1 ) @ V7abs3 ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ A_27c @ A_27b ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27b @ A_27f @ A_27e @ A_27c ) @ V4abs2 ) @ V8rep3 ) @ V9f ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ A_27e @ A_27d @ A_27b ) @ V1abs1 ) @ V5rep2 ) @ V10g ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
