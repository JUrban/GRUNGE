...
tff(conj_thm_2Ereal__topology_2EGDELTA__COMPLEMENT,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EFSIGMA__COMPLEMENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Efsigma,ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),V0s)))
