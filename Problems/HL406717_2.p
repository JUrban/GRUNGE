...
tff(conj_thm_2EOmega_2Edark__shadow__cond__row__ind,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
     => ( ( ! [V1c: tp__ty_2Enum_2Enum,V2L: tp__ty_2Einteger_2Eint] : p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1c)),inj__ty_2Einteger_2Eint(V2L))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
          & ! [V3c: tp__ty_2Enum_2Enum,V4L: tp__ty_2Einteger_2Eint,V5d: tp__ty_2Enum_2Enum,V6R: tp__ty_2Einteger_2Eint,V7t: tp__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint] :
              ( p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3c)),inj__ty_2Einteger_2Eint(V4L))),inj__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint(V7t)))
             => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3c)),inj__ty_2Einteger_2Eint(V4L))),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5d)),inj__ty_2Einteger_2Eint(V6R))),inj__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint(V7t)))) ) )
       => ! [V8v: tp__ty_2Enum_2Enum,V9v1: tp__ty_2Einteger_2Eint,V10v2: tp__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint] : p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V8v)),inj__ty_2Einteger_2Eint(V9v1))),inj__c_ty_2Elist_2Elist_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Einteger_2Eint(V10v2))) ) ) )).
