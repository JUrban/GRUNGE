...
thf(conj_thm_2Ereal_2EABS__TRIANGLE__SUB,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EGREATER__EQ__REFL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3E_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) )).

thf(conj_thm_2Ereal__topology_2EUPPER__BOUND__FINITE__SET__REAL,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ecauchy @ V0s ) )
       => ( p
              ...
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V1y: $i] :
                    ...
                    @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V2n: $i] :
                            ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V1y ) @ ( ap @ V0s @ V2n ) ) ) ) ) ) ) ) ) ) ) )).
