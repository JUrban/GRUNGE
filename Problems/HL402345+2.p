...
fof(lamtp_f483,axiom,(
    ! [A_27a,V2t] :
      ( mem(V2t,arr(A_27a,bool))
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => mem(f483(A_27a,V2t,V0P),arr(A_27a,bool)) ) ) )).
...
fof(lameq_f483,axiom,(
    ! [A_27a,V2t] :
     ...
     => ! [V0P] :
         ...
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f483(A_27a,V2t,V0P),V5x) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2EIN(A_27a),V5x),V2t))),ap(V0P,V5x)) ) ) ) )).

fof(conj_thm_2Eres__quan_2ERES__FORALL__DIFF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
