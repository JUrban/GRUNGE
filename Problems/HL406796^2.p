...
thf(conj_thm_2Erelation_2EIN__RDOM,lemma,(
...
thf(conj_thm_2Etc_2EDRESTR__IN,lemma,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2a: $i] :
              ( ( mem @ V2a @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Etc_2E_5E_7C @ A_27a ) @ V0R ) @ V1s ) @ V2a )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2a ) @ V1s ) ) @ ( ap @ V0R @ V2a ) ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) ) )).

thf(conj_thm_2Etc_2EDRESTR__RDOM,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( ap @ ( ap @ ( c_2Etc_2E_5E_7C @ A_27a ) @ V0R ) @ ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) )
        = V0R ) ) )).
