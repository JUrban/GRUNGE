...
fof(lamtp_f3705,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3705(V0c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3705,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => ! [V3x] :
          ( mem(V3x,ty_2Erealax_2Ereal)
         => ap(f3705(V0c),V3x) = ap(ap(c_2Erealax_2Ereal__add,V0c),V3x) ) ) )).

fof(lamtp_f3706,axiom,(
    ! [V4c] :
      ( mem(V4c,ty_2Erealax_2Ereal)
     => mem(f3706(V4c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3706,axiom,(
    ! [V4c] :
      ( mem(V4c,ty_2Erealax_2Ereal)
     => ! [V7x] :
          ( mem(V7x,ty_2Erealax_2Ereal)
         => ap(f3706(V4c),V7x) = ap(ap(c_2Erealax_2Ereal__add,V4c),V7x) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EINTERVAL__TRANSLATION,conjecture,
    ( ! [V0c] :
        ( mem(V0c,ty_2Erealax_2Ereal)
       => ! [V1a] :
    ...
    & ! [V4c] :
       ...
       => ! [V5a] :
           ...
           => ! [V6b] :
               ...
               => ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V4c),V5a)),ap(ap(c_2Erealax_2Ereal__add,V4c),V6b))) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3706(V4c)),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5a),V6b))) ) ) ) )).
