...
fof(conj_thm_2Epath_2Efinite__okpath__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                      ...
                      & ! [V3x] :
                         ...
                         => ! [V4r] :
                             ...
                             => ! [V5p] :
                                 ...
                                 => ( ( p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V1R),V5p))
                                      & p(ap(c_2Epath_2Efinite(A_27a,A_27a),V5p))
                                      & p(ap(ap(ap(V1R,V3x),V4r),ap(c_2Epath_2Efirst(A_27a,A_27a),V5p)))
                                      & p(ap(V0P,V5p)) )
                                   => p(ap(V0P,ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V3x),V4r),V5p))) ) ) ) ) )
                   => ! [V6sigma] :
                        ( mem(V6sigma,ty_2Epath_2Epath(A_27a,A_27a))
                       => ( ( p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V1R),V6sigma))
                            & p(ap(c_2Epath_2Efinite(A_27a,A_27a),V6sigma)) )
                         => p(ap(V0P,V6sigma)) ) ) ) ) ) ) ) )).
