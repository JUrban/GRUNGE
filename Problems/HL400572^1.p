...
thf(thm_2Epair_2EPROD__ALL__CONG,conjecture,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1p_27_2E0: u,V2P_2E0: u,V3P_27_2E0: u,V4Q_2E0: u,V5Q_27_2E0: u] :
      ( ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0p_2E0 )
          = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_27_2E0 ) )
        & ! [V6x_2E0: u,V7y_2E0: u] :
            ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_27_2E0 )
              = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V6x_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) ) )
           => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) )
              = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_27_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) ) ) )
        & ! [V8x_2E0: u,V9y_2E0: u] :
            ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_27_2E0 )
              = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V8x_2E0 ) @ ( s @ A_27b @ V9y_2E0 ) ) ) )
           => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V4Q_2E0 ) @ ( s @ A_27b @ V9y_2E0 ) ) ) )
              = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V5Q_27_2E0 ) @ ( s @ A_27b @ V9y_2E0 ) ) ) ) ) ) )
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epair_2EPROD__ALL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V4Q_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) )
        = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epair_2EPROD__ALL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V5Q_27_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_27_2E0 ) ) ) ) ) ) )).
