...
tff(conj_thm_2Ebitstring_2Eword__join__v2w__rwt,conjecture,(
    ! [A_27a: del,A_27b: del,V0bad_20domain: tp__o,V1v1: tp__c_ty_2Elist_2Elist_o,V2v2: tp__c_ty_2Elist_2Elist_o] : ap(ap(c_2Ewords_2Eword__join(A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V1v1))),ap(c_2Ebitstring_2Ev2w(A_27b),inj__c_ty_2Elist_2Elist_o(V2v2))) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a))),ap(c_2Epred__set_2EFINITE(A_27b),c_2Epred__set_2EUNIV(A_27b)))),ap(c_2Ebitstring_2Ev2w(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Elist_2EAPPEND(bool),inj__c_ty_2Elist_2Elist_o(V1v1)),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),inj__c_ty_2Elist_2Elist_o(V2v2))))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))),c_2Ewords_2Eword__join(A_27a,A_27a)),inj__o(V0bad_20domain)),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V1v1))),ap(c_2Ebitstring_2Ev2w(A_27b),inj__c_ty_2Elist_2Elist_o(V2v2)))) )).
