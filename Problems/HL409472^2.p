...
thf(conj_thm_2Efloat_2EIS__FINITE__CLOSEST,lemma,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum,V1v: $i] :
     ...
     => ! [V2p: $i] :
         ...
         => ! [V3x: tp__ty_2Erealax_2Ereal] :
              ( p
              @ ( ap @ ( ap @ c_2Eieee_2Eis__finite @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0X ) )
                @ ( ap
...
thf(conj_thm_2Efloat_2EDEFLOAT__FLOAT__ZEROSIGN__ROUND__FINITE,conjecture,(
