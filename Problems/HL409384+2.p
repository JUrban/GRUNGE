...
fof(mem_c_2Emachine__ieee_2Efp32__mul__with__flags,axiom,(
    mem(c_2Emachine__ieee_2Efp32__mul__with__flags,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags))))) )).
...
fof(conj_thm_2Emachine__ieee_2Efp32__mul__with__flags,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1b] :
