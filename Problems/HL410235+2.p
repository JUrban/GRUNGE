...
fof(lamtp_f3542,axiom,(
    ! [A_27a,V0m] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3542(A_27a,V0m,V1c),arr(arr(A_27a,bool),ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [A_27a,V0m] :
     ...
     => ! [V1c] :
         ...
         => ! [V2a] :
             ...
             => ap(f3542(A_27a,V0m,V1c),V2a) = ap(ap(c_2Erealax_2Ereal__mul,V1c),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V2a)) ) ) ) )).

fof(conj_thm_2Emeasure_2EMEASURE__SPACE__CMUL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
