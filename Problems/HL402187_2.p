...
tff(conj_thm_2Elist_2EALL__DISTINCT__ZIP__SWAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27b))
         => ( ( p(ap(c_2Elist_2EALL__DISTINCT(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2))))
              & surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V0l1)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),V1l2)) )
           => p(ap(c_2Elist_2EALL__DISTINCT(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Elist_2EZIP(A_27b,A_27b),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),V1l2),V0l1)))) ) ) ) )).
