...
thf(thm_2Estring_2EIMPLODE__EXPLODE__I,axiom,(
    ! [V0s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
      ( ( ( c_2Estring_2EEXPLODE @ V0s )
        = V0s )
      & ( ( c_2Estring_2EIMPLODE @ V0s )
        = V0s ) ) )).

thf(thm_2EASCIInumbers_2En2s__compute,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1f: tyop_2Enum_2Enum > tyop_2Estring_2Echar,V2b: tyop_2Enum_2Enum] :
      ( ( c_2EASCIInumbers_2En2s @ V2b @ V1f @ V0n )
      = ( c_2Estring_2EIMPLODE @ ( c_2Elist_2EREVERSE @ tyop_2Estring_2Echar @ ( c_2Elist_2EMAP @ tyop_2Enum_2Enum @ tyop_2Estring_2Echar @ V1f @ ( c_2Enumposrep_2En2l @ V2b @ V0n ) ) ) ) ) )).
