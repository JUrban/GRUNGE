...
fof(conj_thm_2Ereal_2EREAL__SUB__TRIANGLE,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Eseq_2ESEQ__MONOSUB,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ? [V1f] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
...
fof(conj_thm_2Eseq_2ESEQ__SBOUNDED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
...
fof(conj_thm_2Eseq_2ESEQ__DIRECT,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Eseq_2ESEQ__CAUCHY,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Ecauchy,V0f))
      <=> p(ap(c_2Eseq_2Econvergent,V0f)) ) ) )).
