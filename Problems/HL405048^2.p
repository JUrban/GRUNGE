...
thf(conj_thm_2EOmega__Automata_2EBOREL__HIERARCHY__F,conjecture,(
    ! [V0a: $i] :
          ...
          <=> ? [V3q: $i] :
                ...
                & ? [V5t1: tp__ty_2Enum_2Enum] :
                  ! [V6t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V3q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V5t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V6t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) ) )
          ...
          <=> ? [V8q: $i] :
                ...
                & ! [V10t1: tp__ty_2Enum_2Enum] :
                  ? [V11t2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V10t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V11t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) ) ) ) ) )).
