...
fof(conj_thm_2Egcd_2EGCD__0R,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ap(ap(c_2Egcd_2Egcd,V0a),c_2Enum_2E0) = V0a ) )).

fof(conj_thm_2Egcd_2EGCD__0L,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ap(ap(c_2Egcd_2Egcd,c_2Enum_2E0),V0a) = V0a ) )).

fof(conj_thm_2Egcd_2EL__EUCLIDES,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Egcd_2ELCM__IS__LEAST__COMMON__MULTIPLE,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
