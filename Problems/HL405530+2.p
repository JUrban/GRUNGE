...
fof(conj_thm_2Einteger_2EINT__REM__CALCULATE,lemma,
    ( ! [V0p] :
...
fof(conj_thm_2Einteger_2EINT__REM__REDUCE,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ( ap(ap(c_2Einteger_2Eint__rem,ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n)))) = ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
            & ap(ap(c_2Einteger_2Eint__rem,ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V1n)))) = ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
            & ap(ap(c_2Einteger_2Eint__rem,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,V0m))),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n)))) = ap(c_2Einteger_2Eint__of__num,ap(ap(c_2Earithmetic_2EMOD,ap(c_2Earithmetic_2ENUMERAL,V0m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))))
