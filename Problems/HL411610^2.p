...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INV,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EMAPPING__CONNECTED__ONTO__SEGMENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
            & ~ ? [V3a: tp__ty_2Erealax_2Ereal] :
                  ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )
         => ? [V4f: $i] :
              ( ( mem @ V4f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
              & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V4f ) @ V0s ) )
              & ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V4f ) @ V0s )
