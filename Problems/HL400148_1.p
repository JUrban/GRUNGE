...
tff(thm_2Ebool_2Eitself__Axiom,conjecture,(
    ...
    ? [V1f_2E0: u] : s(A_27b,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ebool_2Eitself(A_27a),A_27b),V1f_2E0),s(tyop_2Ebool_2Eitself(A_27a),c_2Ebool_2Ethe__value_2E0))) = s(A_27b,V0e_2E0) )).
