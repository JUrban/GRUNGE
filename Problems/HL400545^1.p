...
thf(c_2Eoption_2EOPTION__ALL_2E0,type,(
    c_2Eoption_2EOPTION__ALL_2E0: u )).

thf(c_2Eoption_2EOPTION__ALL_2E2,type,(
...
thf(arityeq2_2Emono_2Ec_2Eoption_2EOPTION__ALL_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTION__ALL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X1_2E0 ) ) ) )
...
thf(thm_2Eoption_2EOPTION__ALL__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0P_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTION__ALL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) )
          = mono_2Ec_2Ebool_2ET )
      & ! [V1P_2E0: u,V2x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTION__ALL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) ) ) )
      ...
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V0opt_2E0 )
        ...
        & ! [V4x_2E0: u] :
           ...
           => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
              = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_27_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) ) )
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTION__ALL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V0opt_2E0 ) ) ) )
        = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTION__ALL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_27_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1opt_27_2E0 ) ) ) ) ) ) )).
