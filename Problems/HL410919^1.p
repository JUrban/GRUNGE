...
thf(f12709_0_2E0,type,(
    f12709_0_2E0: u )).

thf(f12709_0_2E1,type,(
    f12709_0_2E1: du > u )).

thf(f12709_0_2E2,type,(
    f12709_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef12709_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f12709_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ f12709_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef12709_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f12709_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ f12709_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ELIM__NEG,axiom,(
    ! [A_27a: d,V1f_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f12709_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__NEG,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1f_2E0: u,V2l: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f12709_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__neg @ V2l ) ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__SUB,conjecture,(
    ! [A_27a: d,V0net_2E0: u,V1f_2E0: u,V2g_2E0: u,V3l: mono_2Etyop_2Erealax_2Ereal,V4m: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V3l ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2g_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V4m ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) )
