...
tff(conj_thm_2Elist_2EEVERY__GENLIST,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
...
tff(conj_thm_2Erich__list_2ECOUNT__LIST__GENLIST,lemma,(
...
tff(conj_thm_2Erich__list_2ECOUNT__LIST__compute,lemma,(
...
tff(mem_c_2Ewords_2Esw2sw,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ewords_2Esw2sw(A_27a,A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(conj_thm_2Ewords_2EBIT__SET__def,lemma,(
...
tff(conj_thm_2Ewords_2En2w__mod,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__RIGHT__ADD__DISTRIB,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__LITERAL__MULT,lemma,(
    ! [A_27a: del,A_27b: del] :
...
tff(conj_thm_2Ewords_2Edimword__32,lemma,(
