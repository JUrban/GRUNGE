...
tff(conj_thm_2Eextreal_2Einf__const__over__set,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1k: tp__ty_2Eextreal_2Eextreal] :
          ( V0s != c_2Epred__set_2EEMPTY(A_27a)
         => surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__inf,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),k(A_27a,inj__ty_2Eextreal_2Eextreal(V1k))),V0s))) = V1k ) ) )).
