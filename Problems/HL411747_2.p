...
tff(lamtp_f4018,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f4018(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4018,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3i: tp__ty_2Enum_2Enum] : ap(f4018(V0f),inj__ty_2Enum_2Enum(V3i)) = ap(V0f,inj__ty_2Enum_2Enum(V3i)) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__COMPONENT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2l: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4018(V0f)),inj__ty_2Erealax_2Ereal(V2l)),V1s)) ) ) ) )).
