...
thf(thm_2Ereal__topology_2ELOCALLY__INTER,axiom,(
    ! [V0P: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o] :
      ( ! [V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( ( V0P @ V1s )
            & ( V0P @ V2t ) )
         => ( V0P @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Erealax_2Ereal @ V1s @ V2t ) ) )
     => ! [V3s: mono_2Etyop_2Erealax_2Ereal > $o,V4t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ V3s )
            & ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ V4t ) )
         => ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Erealax_2Ereal @ V3s @ V4t ) ) ) ) )).

thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
