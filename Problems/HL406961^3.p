...
thf(thm_2Ewords_2EMOD__COMPLEMENT,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1q: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V0n )
        & ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V1q )
        & ( c_2Eprim__rec_2E_3C @ V2a @ ( c_2Earithmetic_2E_2A @ V1q @ V0n ) ) )
     => ( ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2A @ V1q @ V0n ) @ V2a ) @ V0n )
        = ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2D @ V0n @ ( c_2Earithmetic_2EMOD @ V2a @ V0n ) ) @ V0n ) ) ) )).

thf(thm_2Einteger__word_2Ew2w__i2w,conjecture,(
