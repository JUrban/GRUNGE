...
tff(conj_thm_2Ecardinal_2ECARD__EQ__SYM,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__EQ__IMP__LE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__LE__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ecardinal_2ECARD__LE__UNIV,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__INTERVAL,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECARD__EQ__OPEN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2EOpen,V0s))
