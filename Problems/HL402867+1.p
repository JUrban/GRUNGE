...
fof(thm_2Erich__list_2EEL__TAKE,axiom,(
    ! [A_27a,V0n_2E0,V1x_2E0,V2l_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Enum_2Enum,V0n_2E0))))
     => s(A_27a,c_2Elist_2EEL_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ETAKE_2E2(s(tyop_2Enum_2Enum,V0n_2E0),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))))) = s(A_27a,c_2Elist_2EEL_2E2(s(tyop_2Enum_2Enum,V1x_2E0),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))) ) )).
...
fof(thm_2Erich__list_2EMEM__SING__APPEND,conjecture,(
    ! [A_27a,V0d_2E0,V1b_2E0] :
      ( ! [V2a_2E0,V3c_2E0] : s(tyop_2Elist_2Elist(A_27a),V0d_2E0) != s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V2a_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V1b_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))))),s(tyop_2Elist_2Elist(A_27a),V3c_2E0)))
    <=> ~ p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V1b_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(A_27a),V0d_2E0)))))) ) )).
