...
thf(conj_thm_2Ereal__topology_2ESETDIST__POS__LE,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EREAL__LE__SETDIST__EQ,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESETDIST__SING__LE__HAUSDIST,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESETDIST__HAUSDIST__TRIANGLE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
