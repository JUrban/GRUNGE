...
fof(lameq_f2672,axiom,(
    ! [V3v2] :
     ...
     => ! [V4t] :
          ( mem(V4t,ty_2Elist_2Elist(ty_2Estring_2Echar))
         => ap(f2672(V3v2),V4t) = ap(ap(c_2Ebool_2Eliteral__case(ty_2Estring_2Echar,ty_2Estring_2Echar),f2673(V4t)),V3v2) ) ) )).

fof(lamtp_f2671,axiom,(
    mem(f2671,arr(ty_2Estring_2Echar,arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Einteger_2Eint))) )).

fof(lameq_f2671,axiom,(
    ! [V3v2] :
      ( mem(V3v2,ty_2Estring_2Echar)
     => ap(f2671,V3v2) = f2672(V3v2) ) )).

fof(lamtp_f2670,axiom,(
    mem(f2670,arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Einteger_2Eint)) )).

fof(lameq_f2670,axiom,(
    ! [V2a] :
      ( mem(V2a,ty_2Elist_2Elist(ty_2Estring_2Echar))
     => ap(f2670,V2a) = ap(ap(ap(c_2Elist_2Elist__CASE(ty_2Estring_2Echar,ty_2Estring_2Echar),V2a),ap(c_2Ecombin_2EI(ty_2Einteger_2Eint),ap(c_2Einteger_2Eint__of__num,ap(c_2EASCIInumbers_2Enum__from__dec__string,c_2Elist_2ENIL(ty_2Estring_2Echar))))),f2671) ) )).

fof(ax_thm_2Einteger__word_2EfromString__primitive__def,axiom,(
    c_2Einteger__word_2EfromString = ap(ap(c_2Erelation_2EWFREC(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(c_2Emin_2E_40(arr(ty_2Elist_2Elist(ty_2Estring_2Echar),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),bool))),f1127)),k(arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Einteger_2Eint),f2670)) )).

fof(conj_thm_2Einteger__word_2EfromString__def,conjecture,(
    ! [V0t] :
