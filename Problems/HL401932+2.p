...
fof(conj_thm_2Egcd_2ELCM__IS__LEAST__COMMON__MULTIPLE,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Egcd_2ELCM__LE,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Epred__set_2EMAX__SET__ELIM,lemma,(
    ! [V0P] :
     ...
     => ! [V1Q] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0P))
              & ( V0P = c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)
               => p(ap(V1Q,c_2Enum_2E0)) )
              & ! [V2x] :
                  ( mem(V2x,ty_2Enum_2Enum)
                 => ( ( ! [V3y] :
                          ( mem(V3y,ty_2Enum_2Enum)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3y),V0P))
                           => p(ap(ap(c_2Earithmetic_2E_3C_3D,V3y),V2x)) ) )
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2x),V0P)) )
                   => p(ap(V1Q,V2x)) ) ) )
           => p(ap(V1Q,ap(c_2Epred__set_2EMAX__SET,V0P))) ) ) ) )).

fof(conj_thm_2Epred__set_2EMIN__SET__ELIM,lemma,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ! [V1Q] :
          ( mem(V1Q,arr(ty_2Enum_2Enum,bool))
         => ( ( V0P != c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)
              & ! [V2x] :
                 ...
                 => ( ( ! [V3y] :
                          ( mem(V3y,ty_2Enum_2Enum)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3y),V0P))
                           => p(ap(ap(c_2Earithmetic_2E_3C_3D,V2x),V3y)) ) )
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2x),V0P)) )
                   => p(ap(V1Q,V2x)) ) ) )
...
fof(conj_thm_2Egcdset_2Egcdset__greatest,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1g] :
