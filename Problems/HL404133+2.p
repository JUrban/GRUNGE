    ...
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0p] :
             ...
             => ap(c_2Epath_2Elength(A_27a,A_27a),V0p) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(ty_2Enum_2Enum)),ap(c_2Epath_2Efinite(A_27a,A_27a),V0p)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Eoption_2ETHE(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b))),ap(c_2Ellist_2EtoList(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Epair_2ESND(A_27a,A_27a),ap(c_2Epath_2EfromPath(A_27a,A_27a),V0p)))))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),c_2Eoption_2ENONE(ty_2Enum_2Enum)) ) ) ) )).

fof(conj_thm_2Epath_2Elength__thm,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
