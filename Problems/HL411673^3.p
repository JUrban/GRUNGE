...
thf(thm_2Ecardinal_2ECOUNTABLE__EMPTY,axiom,(
    ! [A_27a: $tType] :
      ( c_2Epred__set_2Ecountable @ A_27a @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )).
...
thf(thm_2Ereal__topology_2ECOUNTABLE__OPEN__INTERVAL,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2Ecountable @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) ) )
    <=> ( ( c_2Ereal__topology_2EOPEN__interval @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) )
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).
