...
tff(conj_thm_2Elift__ieee_2Eclosest__is__everything,lemma,(
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
               => ( p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),inj__ty_2Erealax_2Ereal(V2x))))
                  & ( ? [V3b: $i] :
                        ( mem(V3b,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
                        & p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),inj__ty_2Erealax_2Ereal(V2x)),V3b))
                        & p(ap(V0p,V3b)) )
                   => p(ap(V0p,ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),inj__ty_2Erealax_2Ereal(V2x)))) ) ) ) ) ) ) )).

tff(conj_thm_2Elift__ieee_2Eclosest__in__set,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool))
