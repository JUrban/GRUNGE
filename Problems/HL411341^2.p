...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__IMP__CONTINUOUS,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__EXTENDS__TO__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__UNIFORMLY__CONTINUOUS__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
