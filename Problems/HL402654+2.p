...
fof(lamtp_f801,axiom,(
    ! [A_27a,A_27b,V2P] :
     ...
     => ! [V0f] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => mem(f801(A_27a,A_27b,V2P,V0f,V4x),arr(A_27b,A_27a)) ) ) ) )).

fof(lameq_f801,axiom,(
    ! [A_27a,A_27b,V2P] :
      ( mem(V2P,arr(A_27b,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27a)))
         => ! [V4x] :
             ...
             => ! [V5y] :
                  ( mem(V5y,A_27b)
                 => ap(f801(A_27a,A_27b,V2P,V0f,V4x),V5y) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(V2P,V5y)),ap(ap(V0f,V4x),V5y)),V4x) ) ) ) ) )).

fof(lamtp_f800,axiom,(
    ! [A_27b,A_27a,V2P] :
      ( mem(V2P,arr(A_27b,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27a)))
         => mem(f800(A_27b,A_27a,V2P,V0f),arr(A_27a,arr(A_27b,A_27a))) ) ) )).

fof(lameq_f800,axiom,(
    ! [A_27b,A_27a,V2P] :
      ( mem(V2P,arr(A_27b,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27a)))
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f800(A_27b,A_27a,V2P,V0f),V4x) = f801(A_27a,A_27b,V2P,V0f,V4x) ) ) ) )).

fof(conj_thm_2Erich__list_2EFOLDL__FILTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1e] :
                 ...
                 => ! [V2P] :
                     ...
                     => ! [V3l] :
                         ...
                         => ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V1e),ap(ap(c_2Elist_2EFILTER(A_27b),V2P),V3l)) = ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),f800(A_27b,A_27a,V2P,V0f)),V1e),V3l) ) ) ) ) ) ) )).
