...
thf(thm_2ETemporal__Logic_2EWATCH__SIGNAL,conjecture,(
    ...
    <=> ( ( ! [V3t: mono_2Etyop_2Enum_2Enum] :
              ( (~) @ ( V2b @ ( mono_2Ec_2Earithmetic_2E_2B @ V3t @ V0t0 ) ) )
         => ! [V4t: mono_2Etyop_2Enum_2Enum] :
              ( (~) @ ( V1q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
        & ! [V5d: mono_2Etyop_2Enum_2Enum] :
            ( ( ( V2b @ ( mono_2Ec_2Earithmetic_2E_2B @ V5d @ V0t0 ) )
              & ! [V6t: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Eprim__rec_2E_3C @ V6t @ V5d )
                 => ( (~) @ ( V2b @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) ) ) )
           => ( ! [V7t: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V7t @ V5d )
                 => ( (~) @ ( V1q @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) )
              & ! [V8t: mono_2Etyop_2Enum_2Enum] :
                  ( V1q @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t @ ( mono_2Ec_2Earithmetic_2E_2B @ V5d @ V0t0 ) ) ) ) ) ) ) ) )).
