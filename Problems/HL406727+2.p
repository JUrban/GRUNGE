...
fof(conj_thm_2EOmega_2Ecalc__nightmare__ind,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool))))
     => ( ( ! [V1x] :
              ( mem(V1x,ty_2Einteger_2Eint)
             => ! [V2c] :
                  ( mem(V2c,ty_2Enum_2Enum)
                 => p(ap(ap(ap(V0P,V1x),V2c),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )
          & ! [V3x] :
                     ...
                     => ! [V6R] :
                         ...
                         => ! [V7rs] :
                             ...
                             => ( p(ap(ap(ap(V0P,V3x),V4c),V7rs))
                               => p(ap(ap(ap(V0P,V3x),V4c),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V5d),V6R)),V7rs))) ) ) ) ) ) ) )
       => ! [V8v] :
