...
tff(conj_thm_2Ereal_2EABS__CIRCLE,lemma,(
...
tff(conj_thm_2Eseq_2ESER__SUB,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lmtp_f2888,type,(
    f2888: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2888,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f2888(V0x,V2c),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2888,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum] : ap(f2888(V0x,V2c),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Ereal_2E_2F,ap(V0x,inj__ty_2Enum_2Enum(V3n))),inj__ty_2Erealax_2Ereal(V2c)) ) )).

tff(conj_thm_2Eseq_2ESER__CDIV,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Eseq_2Esums,V0x),inj__ty_2Erealax_2Ereal(V1x0)))
         => p(ap(ap(c_2Eseq_2Esums,f2888(V0x,V2c)),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1x0)),inj__ty_2Erealax_2Ereal(V2c)))) ) ) )).
...
tff(conj_thm_2Elim_2ELIM__NULL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Epowser_2EPOWSER__INSIDE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Eseq_2Esummable,f2935(V0f,V1x)))
...
tff(conj_thm_2Epowser_2EDIFFS__EQUIV,lemma,(
    ! [V0c: $i] :
      ( mem(V0c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Epowser_2ETERMDIFF__LEMMA3,lemma,(
...
tff(conj_thm_2Epowser_2ETERMDIFF__LEMMA5,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
...
tff(conj_thm_2Epowser_2ETERMDIFF,conjecture,(
    ! [V0c: $i] :
      ( mem(V0c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
