...
tff(conj_thm_2Ereal__topology_2ECLOSURE__COMPLEMENT,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__CLOSURE__IDEMP,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__INTERIOR__IDEMP,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
