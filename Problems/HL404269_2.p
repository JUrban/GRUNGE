...
tff(conj_thm_2EDecode_2Ewf__decode__prod,lemma,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,arr(A_27a,bool))
     => ! [V1p2: $i] :
          ( mem(V1p2,arr(A_27b,bool))
...
tff(lameq_f1734,axiom,(
    ! [A_27a: del,A_27b: del,V9y: $i] :
     ...
     => ! [V6x: $i] :
          ( mem(V6x,A_27a)
         => ! [V10t_27: tp__c_ty_2Elist_2Elist_o] : ap(f1734(A_27a,A_27b,V9y,V6x),inj__c_ty_2Elist_2Elist_o(V10t_27)) = ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6x),V9y)),inj__c_ty_2Elist_2Elist_o(V10t_27))) ) ) )).

tff(lmtp_f1733,type,(
    f1733: ( del * del * $i ) > $i )).

tff(lamtp_f1733,axiom,(
...
tff(lmtp_f1732,type,(
    f1732: ( del * del * del * $i ) > $i )).

tff(lamtp_f1732,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V6x: $i] :
      ( mem(V6x,A_27a)
...
tff(lamtp_f1731,axiom,(
    ! [A_27a: del,A_27b: del,V3d2: $i] :
      ( mem(V3d2,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))
     => ! [V6x: $i] :
          ( mem(V6x,A_27a)
...
tff(lameq_f1731,axiom,(
    ! [A_27a: del,A_27b: del,V3d2: $i] :
     ...
     => ! [V6x: $i] :
          ( mem(V6x,A_27a)
         => ! [V7t: tp__c_ty_2Elist_2Elist_o] : ap(f1731(A_27a,A_27b,V3d2,V6x),inj__c_ty_2Elist_2Elist_o(V7t)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),ap(V3d2,inj__c_ty_2Elist_2Elist_o(V7t))),c_2Eoption_2ENONE(ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))),f1732(A_27b,A_27a,A_27b,V6x)) ) ) )).

tff(lmtp_f1730,type,(
    f1730: ( del * del * del * $i ) > $i )).

tff(lamtp_f1730,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,V3d2: $i] :
      ( mem(V3d2,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))
...
tff(conj_thm_2EDecode_2Edecode__prod,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,arr(A_27a,bool))
     => ! [V1d1: $i] :
          ( mem(V1d1,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
         => ! [V2p2: $i] :
             ...
             => ! [V3d2: $i] :
                 ...
                 => ! [V4l: tp__c_ty_2Elist_2Elist_o] :
                     ...
                     => ap(ap(ap(ap(c_2EDecode_2Edecode__prod(A_27a,A_27a),ap(ap(c_2EEncode_2Elift__prod(A_27a,A_27a),V0p1),V2p2)),V1d1),V3d2),inj__c_ty_2Elist_2Elist_o(V4l)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(V1d1,inj__c_ty_2Elist_2Elist_o(V4l))),c_2Eoption_2ENONE(ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))),f1729(A_27b,A_27a,V3d2)) ) ) ) ) ) )).
