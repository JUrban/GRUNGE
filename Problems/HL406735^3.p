...
thf(thm_2Eveblen_2Emono__natI,axiom,(
    ! [A_27a: $tType,V0f: tyop_2Enum_2Enum > ( tyop_2Eordinal_2Eordinal @ A_27a )] :
      ( ! [V1n: tyop_2Enum_2Enum] :
          ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ ( V0f @ ( c_2Enum_2ESUC @ V1n ) ) @ ( V0f @ V1n ) ) )
...
thf(thm_2Eveblen_2Esup__mem__INTER,axiom,(
    ! [A_27a: $tType,V0f: tyop_2Enum_2Enum > ( tyop_2Eordinal_2Eordinal @ A_27a ),V1A: tyop_2Enum_2Enum > ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Eveblen_2Eclub @ A_27a @ ( V1A @ V2n ) )
        & ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Epred__set_2ESUBSET @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( V1A @ ( c_2Enum_2ESUC @ V3n ) ) @ ( V1A @ V3n ) )
        & ! [V4n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( V0f @ V4n ) @ ( V1A @ V4n ) )
        ...
        @ ( c_2Eordinal_2Esup @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Enum_2Enum
            @ ^ [V7n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ $o @ ( V0f @ V7n ) @ c_2Ebool_2ET ) ) )
        @ ( c_2Epred__set_2EBIGINTER @ ( tyop_2Eordinal_2Eordinal @ A_27a )
          @ ( c_2Epred__set_2EGSPEC @ ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o ) @ tyop_2Enum_2Enum
            @ ^ [V8n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o ) @ $o @ ( V1A @ V8n ) @ c_2Ebool_2ET ) ) ) ) ) )).
...
thf(thm_2Eveblen_2Eclub__INTER,conjecture,(
    ! [A_27a: $tType,V0A: tyop_2Enum_2Enum > ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( ! [V1n: tyop_2Enum_2Enum] :
            ( c_2Eveblen_2Eclub @ A_27a @ ( V0A @ V1n ) )
        & ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Epred__set_2ESUBSET @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( V0A @ ( c_2Enum_2ESUC @ V2n ) ) @ ( V0A @ V2n ) ) )
     => ( c_2Eveblen_2Eclub @ A_27a
        @ ( c_2Epred__set_2EBIGINTER @ ( tyop_2Eordinal_2Eordinal @ A_27a )
          @ ( c_2Epred__set_2EGSPEC @ ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o ) @ tyop_2Enum_2Enum
            @ ^ [V3n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o ) @ $o @ ( V0A @ V3n ) @ c_2Ebool_2ET ) ) ) ) ) )).
