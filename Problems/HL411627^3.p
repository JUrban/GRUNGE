      ...
      ( ( ( c_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V3x )
              = ( V0f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) @ V2t )
      ...
      ( ( ( c_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V3x )
              = ( V0f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( c_2Ereal__topology_2Ehomeomorphic @ V1s @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2t ) )
        = ( c_2Ereal__topology_2Ehomeomorphic @ V1s @ V2t ) ) ) )).
