...
thf(conj_thm_2Ecardinal_2ECARD__EQ__BIJECTIONS,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__EQ__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__IMP__CARD__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__FINITE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
