...
thf(conj_thm_2Erich__list_2ETAKE__APPEND,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
     ...
     => ! [V2l2: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V1l1 ) @ V2l2 ) )
            = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l1 ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l1 ) ) ) @ V2l2 ) ) ) ) ) )).
