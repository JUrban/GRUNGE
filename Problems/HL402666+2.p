...
fof(conj_thm_2Erich__list_2ESEG__SUC__CONS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
         ...
         => ! [V1n] :
             ...
             => ! [V2l] :
                 ...
                 => ! [V3x] :
                      ( mem(V3x,A_27a)
                     => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0m),ap(c_2Enum_2ESUC,V1n)),ap(ap(c_2Elist_2ECONS(A_27a),V3x),V2l)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0m),V1n),V2l) ) ) ) ) ) )).
