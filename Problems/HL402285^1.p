...
thf(thm_2Elist_2ETAKE__LENGTH__ID__rwt,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1m: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1m ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) )).
