...
fof(conj_thm_2EerrorStateMonad_2Esequence__nil,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(c_2EerrorStateMonad_2Esequence(A_27a,A_27a),c_2Elist_2ENIL(arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))) = ap(c_2EerrorStateMonad_2EUNIT(A_27a,A_27a),c_2Elist_2ENIL(A_27b)) ) ) )).
