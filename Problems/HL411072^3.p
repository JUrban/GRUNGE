...
thf(thm_2Ereal__topology_2ECONVERGENT__IMP__BOUNDED,axiom,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )).

thf(thm_2Ereal__topology_2ESEQUENCE__UNIQUE__LIMPT,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal,V2l_27: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ V0f @ V1l @ c_2Ereal__topology_2Esequentially )
        & ( c_2Ereal__topology_2Elimit__point__of @ V2l_27
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V3y: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V3y
                @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                  @ ^ [V4n: tyop_2Enum_2Enum] :
                      ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V3y @ ( V0f @ V4n ) ) ) ) ) ) )
     => ( V2l_27 = V1l ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPACT__SEQUENCE__WITH__LIMIT,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ V0f @ V1l @ c_2Ereal__topology_2Esequentially )
     => ( c_2Ereal__topology_2Ecompact @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1l @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) ) )).
