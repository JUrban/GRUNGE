...
thf(conj_thm_2Etransc_2ESIN__PERIODIC__PI,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Esin @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Etransc_2Epi ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ c_2Etransc_2Esin @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) )).

thf(conj_thm_2Etransc_2ESIN__PERIODIC,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
