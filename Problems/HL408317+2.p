...
fof(conj_thm_2Enumeral_2Enumeral__fact,lemma,
    ( ap(c_2Earithmetic_2EFACT,c_2Enum_2E0) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))
    & ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eseq_2ESER__POS__LT__PAIR,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Etransc_2ECOS__PAIRED,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => p(ap(ap(c_2Eseq_2Esums,f2985(V0x)),ap(c_2Etransc_2Ecos,V0x))) ) )).

fof(conj_thm_2Etransc_2ECOS__2,conjecture,(
