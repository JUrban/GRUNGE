...
fof(mem_c_2Efmapal_2Emerge,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efmapal_2Emerge(A_27a,A_27a),arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))) ) ) )).

fof(conj_thm_2Efmapal_2Eincr__merge__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
              ( mem(V0P,arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),bool))))
             => ( ( ! [V1cmp] :
                      ( mem(V1cmp,ty_2Etoto_2Etoto(A_27a))
                     => ! [V2l] :
                          ( mem(V2l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                         => p(ap(ap(ap(V0P,V1cmp),V2l),c_2Elist_2ENIL(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))) ) )
                  & ! [V3cmp] :
                      ( mem(V3cmp,ty_2Etoto_2Etoto(A_27a))
                     => ! [V4l] :
                          ( mem(V4l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                         => ! [V5lol] :
                              ( mem(V5lol,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
                             => p(ap(ap(ap(V0P,V3cmp),V4l),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),c_2Eoption_2ENONE(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),V5lol))) ) ) )
                  & ! [V6cmp] :
                      ( mem(V6cmp,ty_2Etoto_2Etoto(A_27a))
                     => ! [V7l] :
                          ( mem(V7l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                         => ! [V8m] :
                              ( mem(V8m,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                             => ! [V9lol] :
                                  ( mem(V9lol,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
                                 => ( p(ap(ap(ap(V0P,V6cmp),ap(ap(ap(c_2Efmapal_2Emerge(A_27a,A_27a),V6cmp),V7l),V8m)),V9lol))
                                   => p(ap(ap(ap(V0P,V6cmp),V7l),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))),V8m)),V9lol))) ) ) ) ) ) )
               => ! [V10v] :
                    ( mem(V10v,ty_2Etoto_2Etoto(A_27a))
                   => ! [V11v1] :
                        ( mem(V11v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                       => ! [V12v2] :
                            ( mem(V12v2,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
