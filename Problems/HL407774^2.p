...
thf(conj_thm_2Efrac_2EFRAC__ADD__COMM,lemma,(
    ! [V0a: tp__ty_2Efrac_2Efrac,V1b: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) @ ( inj__ty_2Efrac_2Efrac @ V1b ) ) )
      = ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V1b ) ) @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) ) ) )).

thf(conj_thm_2Erat_2ERAT__ADD__CONG1,lemma,(
...
thf(conj_thm_2Erat_2ERAT__ADD__CONG2,conjecture,(
    ! [V0x: tp__ty_2Efrac_2Efrac,V1y: tp__ty_2Efrac_2Efrac] :
