...
thf(conj_thm_2EdefCNF_2EOK__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum,V2conn: $i] :
             ...
             => ! [V3i: tp__ty_2Enum_2Enum,V4j: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ bool @ ( arr @ bool @ bool ) ) @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) ) @ V2conn ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ bool ) @ ( inj__ty_2Enum_2Enum @ V3i ) ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ bool ) @ ( inj__ty_2Enum_2Enum @ V4j ) ) ) ) ) ) )
          & ! [V5n: tp__ty_2Enum_2Enum,V6conn: $i] :
              ( ( mem @ V6conn @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
             => ! [V7i: tp__ty_2Enum_2Enum,V8b: $o] :
          ...
          & ! [V9n: tp__ty_2Enum_2Enum,V10conn: $i] :
             ...
             => ! [V11a: $o,V12j: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V9n ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ bool @ ( arr @ bool @ bool ) ) @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) ) @ V10conn ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) @ ( ap @ ( c_2Esum_2EINR @ ty_2Enum_2Enum @ bool ) @ ( inj__o @ V11a ) ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ bool ) @ ( inj__ty_2Enum_2Enum @ V12j ) ) ) ) ) ) )
       ...
       => ! [V17v: tp__ty_2Enum_2Enum,V18v1: $i] :
           ...
           => ! [V19v2: tp__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o,V20v3: tp__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o] :
                ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V17v ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ bool @ ( arr @ bool @ bool ) ) @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) ) @ V18v1 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) @ ( inj__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o @ V19v2 ) ) @ ( inj__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o @ V20v3 ) ) ) ) ) ) ) ) )).
