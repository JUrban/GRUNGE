...
tff(conj_thm_2Ellist_2ELFINITE__DROP,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
     ...
     => ( ( p(ap(c_2Ellist_2ELFINITE(A_27a),V1ll))
       ...
       => ? [V2y: $i] :
            ...
            & ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Ellist_2Ellist(A_27a)),V2y) ) ) ) )).
