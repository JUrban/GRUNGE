...
fof(lamtp_f3755,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3755(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3755,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4a] :
          ( mem(V4a,A_27a)
         => ap(f3755(A_27a,V1f),V4a) = ap(V1f,V4a) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__COMPONENT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2i] :
                     ...
                     => ! [V3l] :
                         ...
                         => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),V3l),V0net))
                           => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3755(A_27a,V1f)),V3l),V0net)) ) ) ) ) ) ) ) )).
