    ...
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1g: A_27b > tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ! [V3x: A_27a] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V1g @ ( V0f @ V3x ) ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ A_27b @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ V2s ) @ V1g ) @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ ( c_2Ecombin_2Eo @ A_27a @ tyop_2Erealax_2Ereal @ A_27b @ V1g @ V0f ) ) ) ) )).
