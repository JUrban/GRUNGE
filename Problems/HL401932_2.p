...
tff(conj_thm_2Edivides_2EDIVIDES__LE,lemma,(
...
tff(conj_thm_2Egcd_2ELCM__IS__LEAST__COMMON__MULTIPLE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Egcd_2ELCM__LE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Epred__set_2EMAX__SET__ELIM,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Epred__set_2EMIN__SET__ELIM,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f314,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f314(V0s),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1n)),ap(c_2Epred__set_2EMIN__SET,ap(ap(c_2Epred__set_2EDELETE(ty_2Enum_2Enum),V0s),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) ) )).

tff(lmtp_f316,type,(
    f316: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f316,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V2d: tp__ty_2Enum_2Enum] : mem(f316(V0s,V2d),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f316,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V2d: tp__ty_2Enum_2Enum,V3e: tp__ty_2Enum_2Enum] : ap(f316(V0s,V2d),inj__ty_2Enum_2Enum(V3e)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3e)),V0s)),ap(ap(c_2Edivides_2Edivides,inj__ty_2Enum_2Enum(V2d)),inj__ty_2Enum_2Enum(V3e))) ) )).

tff(lmtp_f315,type,(
    f315: $i > $i )).

tff(lamtp_f315,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f315,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V2d: tp__ty_2Enum_2Enum] : ap(f315(V0s),inj__ty_2Enum_2Enum(V2d)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2d)),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f316(V0s,V2d))) ) )).

tff(ax_thm_2Egcdset_2Egcdset__def,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => surj__ty_2Enum_2Enum(ap(c_2Egcdset_2Egcdset,V0s)) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(arr(ty_2Enum_2Enum,bool)),V0s),c_2Epred__set_2EEMPTY(ty_2Enum_2Enum))),ap(ap(c_2Emin_2E_3D(arr(ty_2Enum_2Enum,bool)),V0s),ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),c_2Epred__set_2EEMPTY(ty_2Enum_2Enum))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Epred__set_2EMAX__SET,ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f314(V0s))),ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f315(V0s)))))) ) )).

tff(conj_thm_2Egcdset_2Egcdset__greatest,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
