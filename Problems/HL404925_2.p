...
tff(conj_thm_2Etopology_2EOPEN__OWN__NEIGH,conjecture,(
    ! [A_27a: del,V0S_27: $i] :
     ...
     => ! [V1top: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ( ( p(ap(ap(c_2Etopology_2Eopen__in(A_27a),V1top),V0S_27))
                  & p(ap(V0S_27,V2x)) )
               => p(ap(ap(c_2Etopology_2Eneigh(A_27a),V1top),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0S_27),V2x))) ) ) ) ) )).
