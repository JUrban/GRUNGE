...
thf(c_2Eutil__prob_2Eminimal_2E0,type,(
    c_2Eutil__prob_2Eminimal_2E0: u )).

thf(c_2Eutil__prob_2Eminimal_2E1,type,(
...
thf(mono_2Ec_2Eutil__prob_2Eminimal,type,(
    mono_2Ec_2Eutil__prob_2Eminimal: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Eutil__prob_2EMINIMAL__EXISTS,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ? [V1n: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V1n )
    <=> ( ( V0P @ ( mono_2Ec_2Eutil__prob_2Eminimal @ V0P ) )
        & ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2n @ ( mono_2Ec_2Eutil__prob_2Eminimal @ V0P ) )
           => ( (~) @ ( V0P @ V2n ) ) ) ) ) )).
...
thf(thm_2Eutil__prob_2EMINIMAL__EQ__IMP,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1p: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( V1p @ V0m )
        & ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2n @ V0m )
           => ( (~) @ ( V1p @ V2n ) ) ) )
     => ( V0m
        = ( mono_2Ec_2Eutil__prob_2Eminimal @ V1p ) ) ) )).

thf(thm_2Eutil__prob_2EMINIMAL__SUC,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1p: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( ( mono_2Ec_2Enum_2ESUC @ V0n )
          = ( mono_2Ec_2Eutil__prob_2Eminimal @ V1p ) )
        & ( V1p @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) )
    <=> ( ( (~) @ ( V1p @ mono_2Ec_2Enum_2E0 ) )
        & ( V0n
          = ( mono_2Ec_2Eutil__prob_2Eminimal @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Emin_2Ebool_20mono_2Etyop_2Enum_2Enum @ V1p @ mono_2Ec_2Enum_2ESUC ) ) )
        & ( V1p @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) ) ) )).
