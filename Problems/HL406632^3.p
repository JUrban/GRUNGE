...
thf(c_2Eenumeral_2ELESS__ALL,type,(
    c_2Eenumeral_2ELESS__ALL: 
      !>[A_27a: $tType] :
        ( ( tyop_2Etoto_2Etoto @ A_27a ) > A_27a > ( A_27a > $o ) > $o ) )).
...
thf(thm_2Eenumeral_2ELESS__ALL,axiom,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1x: A_27a,V2s: A_27a > $o] :
      ( ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1x @ V2s )
    <=> ! [V3y: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V3y @ V2s )
         => ( ( c_2Etoto_2Eapto @ A_27a @ V0cmp @ V1x @ V3y )
            = c_2EternaryComparisons_2ELESS ) ) ) )).

thf(thm_2Eenumeral_2ELESS__ALL__UO__LEM,axiom,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1a: A_27a,V2s: A_27a > $o] :
      ( ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1a @ V2s )
     => ( ( c_2Eenumeral_2EUO @ A_27a @ V0cmp @ ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V2s )
        = ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ V2s ) ) ) )).
...
thf(thm_2Eenumeral_2ELESS__ALL__OU__UO__LEM,conjecture,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1a: A_27a,V2s: A_27a > $o,V3t: A_27a > $o] :
      ( ( ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1a @ V2s )
        & ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1a @ V3t ) )
     => ( ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ ( c_2Eenumeral_2EUO @ A_27a @ V0cmp @ ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V2s ) @ V3t )
        = ( c_2Epred__set_2EINSERT @ A_27a @ V1a @ ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V2s @ V3t ) ) ) ) )).
