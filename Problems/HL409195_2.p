...
tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__POW,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Epow,ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V0a),V1s)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f3187(A_27a,A_27a,V0a))),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V1s),V1s))) ) ) ) )).
