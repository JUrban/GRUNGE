...
tff(mem_c_2Esptree_2Edifference,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Esptree_2Edifference(A_27a,A_27a),arr(ty_2Esptree_2Espt(A_27a),arr(ty_2Esptree_2Espt(A_27b),ty_2Esptree_2Espt(A_27a)))) )).
...
tff(conj_thm_2Esptree_2Elookup__difference,lemma,(
    ! [A_27a: del,A_27b: del,V0m1: $i] :
      ( mem(V0m1,ty_2Esptree_2Espt(A_27a))
     => ! [V1m2: $i] :
          ( mem(V1m2,ty_2Esptree_2Espt(A_27b))
         => ! [V2k: tp__ty_2Enum_2Enum] : ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V2k)),ap(ap(c_2Esptree_2Edifference(A_27a,A_27a),V0m1),V1m2)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(A_27b)),ap(ap(c_2Esptree_2Elookup(A_27b),inj__ty_2Enum_2Enum(V2k)),V1m2)),c_2Eoption_2ENONE(A_27b))),ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V2k)),V0m1)),c_2Eoption_2ENONE(A_27a)) ) ) )).
...
tff(conj_thm_2Esptree_2Edomain__difference,conjecture,(
