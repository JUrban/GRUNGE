...
thf(conj_thm_2Esemi__ring_2Eplus__permute,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( ty_2Esemi__ring_2Esemi__ring @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Esemi__ring_2Eis__semi__ring @ A_27a ) @ V0r ) )
       => ! [V1m: $i] :
           ...
           => ! [V2n: $i] :
               ...
               => ! [V3p: $i] :
                   ...
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( ap @ ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a ) @ V0r ) @ V1m ) @ V2n ) ) @ V3p )
                      = ( ap @ ( ap @ ( ap @ ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( ap @ ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a ) @ V0r ) @ V1m ) @ V3p ) ) @ V2n ) ) ) ) ) ) ) )).

thf(conj_thm_2Ering_2Eneg__mult,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( ty_2Ering_2Ering @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Ering_2Eis__ring @ A_27a ) @ V0r ) )
       => ! [V1a: $i] :
           ...
           => ! [V2b: $i] :
                ( ( mem @ V2b @ A_27a )
               => ( ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V0r ) @ V1a ) ) @ V2b )
                  = ( ap @ ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ V0r ) @ V1a ) @ V2b ) ) ) ) ) ) ) )).
