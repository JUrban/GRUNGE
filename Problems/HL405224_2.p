...
tff(lamtp_f2117,axiom,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => mem(f2117(A_27a,V0p),arr(A_27a,bool)) ) )).

tff(lameq_f2117,axiom,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
...
tff(lamtp_f2119,axiom,(
    ! [A_27a: del] : mem(f2119(A_27a),arr(A_27a,arr(ty_2Elist_2Elist(bool),A_27a))) )).
...
tff(lamtp_f2118,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2118(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27a)) )).

tff(lameq_f2118,axiom,(
    ! [A_27a: del,A_27a: del,V4v: $i] :
...
tff(ax_thm_2ECoder_2Edecode__def,axiom,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1d: $i] :
          ( mem(V1d,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
         => ! [V2l: tp__c_ty_2Elist_2Elist_o] : ap(ap(ap(c_2ECoder_2Edecode(A_27a),V0p),V1d),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(V1d,inj__c_ty_2Elist_2Elist_o(V2l))),ap(c_2Emin_2E_40(A_27a),f2117(A_27a,V0p))),f2118(A_27a,A_27a)) ) ) )).
...
tff(conj_thm_2ECoder_2Ewf__coder__closed,conjecture,(
    ! [A_27a: del,V0c: $i] :
      ( mem(V0c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V0c))
       => ! [V1l: tp__c_ty_2Elist_2Elist_o] : p(ap(ap(c_2ECoder_2Edomain(A_27a),V0c),ap(ap(c_2ECoder_2Edecoder(A_27a),V0c),inj__c_ty_2Elist_2Elist_o(V1l)))) ) ) )).
