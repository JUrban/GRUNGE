...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__INF,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V1s))
           ...
           => ? [V2x] :
                ...
                & ! [V3y] :
                    ( mem(V3y,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V1s))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V2x)),ap(V0f,V3y))) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__INTERVAL,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__INTERVAL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Ereal__topology_2Eis__interval,ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b))))
            & p(ap(c_2Ereal__topology_2Eis__interval,ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__POINTWISE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__COMPACT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
          & p(ap(c_2Ereal__topology_2Ecompact,V0s)) )
      <=> ? [V1a] :
            ...
            & ? [V2b] :
                ( mem(V2b,ty_2Erealax_2Ereal)
                & V0s = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) ) ) )).
