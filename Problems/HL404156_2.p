...
tff(mem_c_2Epath_2Eexists,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2Eexists(A_27a,A_27a),arr(arr(A_27a,bool),arr(ty_2Epath_2Epath(A_27a,A_27a),bool))) )).

tff(tp_c_2Epath_2EfirstP__at,type,(
    c_2Epath_2EfirstP__at: ( del * del ) > $i )).

tff(mem_c_2Epath_2EfirstP__at,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2EfirstP__at(A_27a,A_27a),arr(arr(A_27a,bool),arr(ty_2Epath_2Epath(A_27a,A_27a),arr(ty_2Enum_2Enum,bool)))) )).
...
tff(conj_thm_2Epath_2EfirstP__at__thm,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0P: $i] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1x: $i] :
             ...
             => ! [V2n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),ap(c_2Epath_2Estopped__at(A_27a,A_27a),V1x)),inj__ty_2Enum_2Enum(V2n)))
                <=> ( V2n = fo__c_2Enum_2E0
                    & p(ap(V0P,V1x)) ) ) ) )
      & ! [V3P: $i] :
         ...
         => ! [V4n: tp__ty_2Enum_2Enum,V5x: $i] :
             ...
             => ! [V6r: $i] :
                  ( mem(V6r,A_27b)
                 => ! [V7p: $i] :
                      ( mem(V7p,ty_2Epath_2Epath(A_27a,A_27a))
                     => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V3P),ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V5x),V6r),V7p)),inj__ty_2Enum_2Enum(V4n)))
                      <=> ( ( V4n = fo__c_2Enum_2E0
                            & p(ap(V3P,V5x)) )
                          | ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V4n)))
                            & ~ p(ap(V3P,V5x))
                            & p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V3P),V7p),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V4n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) ) ) ) ) ) ) )).
...
tff(ax_thm_2Epath_2Eexists__def,axiom,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ( p(ap(ap(c_2Epath_2Eexists(A_27a,A_27a),V0P),V1p))
          <=> ? [V2i: tp__ty_2Enum_2Enum] : p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),inj__ty_2Enum_2Enum(V2i))) ) ) ) )).

tff(conj_thm_2Epath_2Eexists__thm,conjecture,(
