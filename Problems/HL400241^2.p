...
thf(conj_thm_2Ecombin_2EUPDATE__APPLY,conjecture,(
      ...
      ( ! [V0a: $i] :
         ...
         => ! [V1x: $i] :
             ...
             => ! [V2f: $i] :
                 ...
                 => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ecombin_2EUPDATE @ A_27a @ A_27b ) @ V0a ) @ V1x ) @ V2f ) @ V0a )
                    = V1x ) ) ) )
      & ! [V3a: $i] :
          ( ( mem @ V3a @ A_27c )
         => ! [V4b: $i] :
             ...
             => ! [V5x: $i] :
                 ...
                 => ! [V6f: $i] :
                     ...
                     => ( ( V3a != V4b )
                       => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ecombin_2EUPDATE @ A_27c @ A_27d ) @ V3a ) @ V5x ) @ V6f ) @ V4b )
                          = ( ap @ V6f @ V4b ) ) ) ) ) ) ) ) )).
