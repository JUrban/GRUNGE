...
tff(conj_thm_2Ereal__topology_2ESETDIST__SUBSET__LEFT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2u: $i] :
             ...
             => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1t),V2u))),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V2u)))) ) ) ) ) )).
