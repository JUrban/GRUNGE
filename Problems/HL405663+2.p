...
fof(conj_thm_2Eordinal_2EordMULT__0L,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Eordinal_2EordMULT__lt__MONO__R,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(conj_thm_2Eordinal_2EordMULT__le__MONO__R,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(conj_thm_2Eordinal_2EordMULT__lt__MONO__R__EQN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
