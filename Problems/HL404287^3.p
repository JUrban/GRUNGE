...
thf(c_2EDecode_2Edecode__tree,type,(
    c_2EDecode_2Edecode__tree: 
      !>[A_27a: $tType] :
        ( ( ( tyop_2EEncode_2Etree @ A_27a ) > $o ) > ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ) ) > ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2EEncode_2Etree @ A_27a ) @ ( tyop_2Elist_2Elist @ $o ) ) ) ) )).
...
thf(c_2EEncode_2Eencode__tree,type,(
    c_2EEncode_2Eencode__tree: 
      !>[A_27a: $tType] :
        ( ( A_27a > ( tyop_2Elist_2Elist @ $o ) ) > ( tyop_2EEncode_2Etree @ A_27a ) > ( tyop_2Elist_2Elist @ $o ) ) )).

thf(c_2EEncode_2Elift__tree,type,(
    c_2EEncode_2Elift__tree: 
      !>[A_27a: $tType] :
        ( ( A_27a > $o ) > ( tyop_2EEncode_2Etree @ A_27a ) > $o ) )).
...
thf(thm_2EDecode_2Edecode__tree__def,axiom,(
    ! [A_27a: $tType,V0p: ( tyop_2EEncode_2Etree @ A_27a ) > $o,V1d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) )] :
      ( ( c_2EDecode_2Edecode__tree @ A_27a @ V0p @ V1d )
      = ( c_2EDecode_2Eenc2dec @ ( tyop_2EEncode_2Etree @ A_27a ) @ V0p @ ( c_2EEncode_2Eencode__tree @ A_27a @ ( c_2EDecode_2Edec2enc @ A_27a @ V1d ) ) ) ) )).
...
thf(thm_2EDecode_2Ewf__decode__tree,conjecture,(
    ! [A_27a: $tType,V0p: A_27a > $o,V1d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) )] :
      ( ( c_2EDecode_2Ewf__decoder @ A_27a @ V0p @ V1d )
     => ( c_2EDecode_2Ewf__decoder @ ( tyop_2EEncode_2Etree @ A_27a ) @ ( c_2EEncode_2Elift__tree @ A_27a @ V0p ) @ ( c_2EDecode_2Edecode__tree @ A_27a @ ( c_2EEncode_2Elift__tree @ A_27a @ V0p ) @ V1d ) ) ) )).
