...
tff(conj_thm_2EOmega__Automata_2EOMEGA__DISJ__CLOSURE,conjecture,(
                                        ...
                                        & ? [V14q2: $i] :
                                            ...
                                            & ! [V15t: tp__ty_2Enum_2Enum] :
                                                ( ( ~ p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0))))
                                                  & p(ap(V2Phi__R1,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0)))),ap(V13q1,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0))))))
                                                ...
                                                | ( p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0))))
                                                  & p(ap(V6Phi__R2,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0)))),ap(V14q2,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V1t0))))))
                                                  & p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) )
                                            & ( ( ~ p(ap(V12p,inj__ty_2Enum_2Enum(V1t0)))
