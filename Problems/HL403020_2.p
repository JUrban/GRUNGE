...
tff(conj_thm_2EindexedLists_2EEL__MAPi,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2l: $i] :
         ...
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1n)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
           => ap(ap(c_2Elist_2EEL(A_27b),inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V0f),V2l)) = ap(ap(V0f,inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V1n)),V2l)) ) ) ) )).
