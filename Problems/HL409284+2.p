...
fof(mem_c_2Ebinary__ieee_2Efloat__compare,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => mem(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),ty_2Ebinary__ieee_2Efloat__compare))) ) ) )).
...
fof(mem_c_2Ebinary__ieee_2Efloat__greater__equal,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => mem(c_2Ebinary__ieee_2Efloat__greater__equal(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),bool))) ) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Efloat__compare__case__def,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0v0] :
            ( mem(V0v0,A_27a)
...
fof(lamtp_f3148,axiom,(
    ! [V4r1] :
      ( mem(V4r1,ty_2Erealax_2Ereal)
     => mem(f3148(V4r1),arr(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat__compare)) ) )).

fof(lameq_f3148,axiom,(
    ! [V4r1] :
      ( mem(V4r1,ty_2Erealax_2Ereal)
     => ! [V5r2] :
          ( mem(V5r2,ty_2Erealax_2Ereal)
         => ap(f3148(V4r1),V5r2) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Erealax_2Ereal__lt,V4r1),V5r2)),c_2Ebinary__ieee_2ELT),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V4r1),V5r2)),c_2Ebinary__ieee_2EEQ),c_2Ebinary__ieee_2EGT)) ) ) )).

fof(lamtp_f3147,axiom,(
    ! [A_27t,A_27w,V1y] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V3v1] :
          ( mem(V3v1,ty_2Ebinary__ieee_2Efloat__value)
         => mem(f3147(A_27t,A_27w,V1y,V3v1),arr(ty_2Erealax_2Ereal,ty_2Ebinary__ieee_2Efloat__compare)) ) ) )).
...
fof(lameq_f3147,axiom,(
    ! [A_27t,A_27w,V1y] :
     ...
     => ! [V3v1] :
         ...
         => ! [V4r1] :
              ( mem(V4r1,ty_2Erealax_2Ereal)
             => ap(f3147(A_27t,A_27w,V1y,V3v1),V4r1) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),V3v1),f3148(V4r1)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1y)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),c_2Ebinary__ieee_2EGT),c_2Ebinary__ieee_2ELT)),c_2Ebinary__ieee_2EUN) ) ) ) )).

fof(lamtp_f3146,axiom,(
    ! [A_27t,A_27w,V1y] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V2v] :
             ...
             => mem(f3146(A_27t,A_27w,V1y,V0x,V2v),arr(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__compare)) ) ) ) )).
    ...
    ! [A_27t,A_27w,V1y] :
     ...
     => ! [V0x] :
         ...
         => ! [V2v] :
             ...
             => ! [V3v1] :
                  ( mem(V3v1,ty_2Ebinary__ieee_2Efloat__value)
                 => ap(f3146(A_27t,A_27w,V1y,V0x,V2v),V3v1) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),V2v),f3147(A_27t,A_27w,V1y,V3v1)),ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Ebinary__ieee_2Efloat__compare),V3v1),k(ty_2Erealax_2Ereal,ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),c_2Ebinary__ieee_2ELT),c_2Ebinary__ieee_2EGT))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1y))),c_2Ebinary__ieee_2EEQ),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat__compare),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V0x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),c_2Ebinary__ieee_2ELT),c_2Ebinary__ieee_2EGT))),c_2Ebinary__ieee_2EUN)),c_2Ebinary__ieee_2EUN) ) ) ) ) )).

fof(lamtp_f3145,axiom,(
    ! [A_27w,A_27t,V1y] :
      ( mem(V1y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0x] :
          ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
...
fof(lameq_f3145,axiom,(
    ! [A_27w,A_27t,V1y] :
     ...
     => ! [V0x] :
         ...
         => ! [V2v] :
              ( mem(V2v,ty_2Ebinary__ieee_2Efloat__value)
             => ap(f3145(A_27w,A_27t,V1y,V0x),V2v) = f3146(A_27t,A_27w,V1y,V0x,V2v) ) ) ) )).
         ...
         => ! [V0x] :
             ...
             => ! [V1y] :
                 ...
                 => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__greater__equal(A_27t,A_27t),V0x),V1y))
                  <=> p(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(bool),ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),V0x),V1y)),c_2Ebool_2EF),c_2Ebool_2ET),c_2Ebool_2ET),c_2Ebool_2EF)) ) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Efloat__ge,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
