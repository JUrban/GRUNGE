...
thf(thm_2Ewords_2Ew2w__eq__n2w,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1y: tyop_2Enum_2Enum] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) )
        & ( c_2Eprim__rec_2E_3C @ V1y @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
     => ( ( ( c_2Ewords_2Ew2w @ A_27a @ A_27b @ V0x )
          = ( c_2Ewords_2En2w @ A_27b @ V1y ) )
      <=> ( V0x
          = ( c_2Ewords_2En2w @ A_27a @ V1y ) ) ) ) )).

thf(thm_2Ewords_2Eword__extract__eq__n2w,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1h: tyop_2Enum_2Enum,V2y: tyop_2Enum_2Enum] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) )
        ...
        & ( c_2Eprim__rec_2E_3C @ V2y @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
     => ( ( ( c_2Ewords_2Eword__extract @ A_27a @ A_27b @ V1h @ c_2Enum_2E0 @ V0x )
          = ( c_2Ewords_2En2w @ A_27b @ V2y ) )
      <=> ( V0x
          = ( c_2Ewords_2En2w @ A_27a @ V2y ) ) ) ) )).
