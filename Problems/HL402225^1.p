...
thf(f2276_0_2E0,type,(
    f2276_0_2E0: u )).

thf(f2276_0_2E2,type,(
    f2276_0_2E2: du > du > u )).

thf(f2276_0_2E3,type,(
    f2276_0_2E3: du > du > du > u )).
...
thf(arityeq2_2Emono_2Ef2276_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( f2276_0_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) ) ) @ f2276_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef2276_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2276_0_2E3 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) ) ) @ f2276_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ X2_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ebool_2E_3F_21_2E1_2Emono_2Etyop_2Emin_2Efun_28tyop_2Elist_2Elist_28A_27a_29_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ c_2Ebool_2E_3F_21_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2Elist__Axiom__old,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1f_2E0: u,V2fn1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2276_0_2E3 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn1_2E0 ) ) ) )
    <=> ( ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ A_27b @ V0x_2E0 ) )
        & ! [V3h_2E0: u,V4t_2E0: u] :
            ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4t_2E0 ) ) ) ) )
            = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ V1f_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4t_2E0 ) ) ) ) ) @ ( s @ A_27a @ V3h_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4t_2E0 ) ) ) ) ) ) )).

thf(thm_2Elist_2Elist__Axiom__old,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1f_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( f2276_0_2E2 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) ) ) @ V1f_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Elist_2ESNOC__INDUCT,conjecture,(
    ! [A_27a: d,V0P_2E0: u] :
