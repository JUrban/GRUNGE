...
thf(f11477_0_2E0,type,(
    f11477_0_2E0: u )).

thf(f11477_0_2E2,type,(
    f11477_0_2E2: du > du > u )).

thf(f11477_0_2E3,type,(
    f11477_0_2E3: du > du > du > u )).
...
thf(f12687_0_2E0,type,(
    f12687_0_2E0: u )).

thf(f12687_0_2E2,type,(
    f12687_0_2E2: du > du > u )).

thf(f12687_0_2E3,type,(
    f12687_0_2E3: du > du > du > u )).
...
thf(mono_2Ef11477_0,type,(
    mono_2Ef11477_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ef12687_0,type,(
    mono_2Ef12687_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2ESUM__OFFSET,axiom,(
    ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V0p: mono_2Etyop_2Enum_2Enum,V4i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11477_0 @ V1f @ V0p @ V4i )
      = ( V1f @ ( mono_2Ec_2Earithmetic_2E_2B @ V4i @ V0p ) ) ) )).

thf(thm_2Eiterate_2ESUM__OFFSET,axiom,(
    ! [V0p: mono_2Etyop_2Enum_2Enum,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2E_2B @ V2m @ V0p ) @ ( mono_2Ec_2Earithmetic_2E_2B @ V3n @ V0p ) ) @ V1f )
      = ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ ( mono_2Ef11477_0 @ V1f @ V0p ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUMS__REINDEX,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V0k: mono_2Etyop_2Enum_2Enum,V4x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12687_0 @ V1a @ V0k @ V4x )
      = ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4x @ V0k ) ) ) )).

thf(thm_2Ereal__topology_2ESUMS__REINDEX,conjecture,(
    ! [V0k: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ereal__topology_2Esums @ ( mono_2Ef12687_0 @ V1a @ V0k ) @ V2l @ ( mono_2Ec_2Ereal__topology_2Efrom @ V3n ) )
      = ( mono_2Ec_2Ereal__topology_2Esums @ V1a @ V2l @ ( mono_2Ec_2Ereal__topology_2Efrom @ ( mono_2Ec_2Earithmetic_2E_2B @ V3n @ V0k ) ) ) ) )).
