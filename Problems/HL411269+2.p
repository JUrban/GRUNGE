    ...
    ! [V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V5w] :
             ...
             => ! [V6x] :
                  ( mem(V6x,ty_2Erealax_2Ereal)
                 => ap(f3869(V1s,V0f,V5w),V6x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V6x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6x),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V6x)),V5w))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSED__MAP__OPEN__SUPERSET__PREIMAGE__EQ,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__MAP__OPEN__SUPERSET__PREIMAGE__POINT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                ...
                <=> ! [V4u] :
                     ...
                     => ! [V5y] :
                         ...
                         => ( ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V4u))
                              ...
                              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3861(V1s,V0f,V5y))),V4u)) )
                           => ? [V7v] :
                                ( mem(V7v,arr(ty_2Erealax_2Ereal,bool))
                                & p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2t)),V7v))
                                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V7v))
                                & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3868(V1s,V0f,V7v))),V4u)) ) ) ) ) ) ) ) ) ) )).
