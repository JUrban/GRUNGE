...
tff(conj_thm_2Ebit_2EADD__BIT__SUC,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__ADD__BIT,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
     ...
     => ! [V2b: $i] :
         ...
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
           => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),V1a),V2b)),inj__ty_2Enum_2Enum(V0n)))
            <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))),ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V1a)),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V2b))),inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),inj__ty_2Enum_2Enum(V0n)))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),inj__ty_2Enum_2Enum(V0n))))))) ) ) ) ) )).
