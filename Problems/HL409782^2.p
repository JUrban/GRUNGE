...
thf(ax_thm_2Eiterate_2Eneutral,axiom,(
    ! [A_27a: del,V0op: $i] :
        ...
        = ( ap @ ( c_2Emin_2E_40 @ A_27a )
          @ ( lam @ A_27a
            @ ^ [V1x: $i] :
                ...
                @ ( lam @ A_27a
                  @ ^ [V2y: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( ap @ V0op @ V1x ) @ V2y ) ) @ V2y ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( ap @ V0op @ V2y ) @ V1x ) ) @ V2y ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ENEUTRAL__REAL__MUL,conjecture,
