...
thf(conj_thm_2Ebinary__ieee_2Efloat__is__finite,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
...
thf(conj_thm_2Ebinary__ieee_2Efloat__distinct__finite,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
...
thf(conj_thm_2Ebinary__ieee_2Efloat__is__distinct,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
     => ( ~ ( ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__nan @ A_27a @ A_27b ) @ V0x ) )
            & ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__infinite @ A_27a @ A_27b ) @ V0x ) ) )
