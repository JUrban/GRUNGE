...
fof(conj_thm_2Earithmetic_2EEXP2__LT,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2EDecode_2Edec__bnum__lt,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1l] :
         ...
         => ! [V2n] :
             ...
             => ! [V3t] :
                 ...
                 => ( ap(ap(c_2EDecode_2Edec__bnum,V0m),V1l) = ap(c_2Eoption_2ESOME(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2n),V3t))
