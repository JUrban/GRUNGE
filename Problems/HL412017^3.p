...
thf(thm_2Elebesgue_2Epos__fn__integral__disjoint__sets,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2s: A_27a > $o,V3t: A_27a > $o] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Epred__set_2EDISJOINT @ A_27a @ V2s @ V3t )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2s @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V3t @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) )
        ...
        & ! [V4x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( V1f @ V4x ) ) )
     => ( ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
          @ ^ [V5x: A_27a] :
              ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V5x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EUNION @ A_27a @ V2s @ V3t ) @ V5x ) ) )
        = ( c_2Eextreal_2Eextreal__add
          @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
            @ ^ [V6x: A_27a] :
                ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V6x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V2s @ V6x ) ) )
          @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
            @ ^ [V7x: A_27a] :
                ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V7x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V3t @ V7x ) ) ) ) ) ) )).
...
thf(thm_2Elebesgue_2Epos__fn__integral__disjoint__sets__sum,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2s: A_27b > $o,V3a: A_27b > A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27b @ V2s )
        & ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ! [V4i: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V4i @ V2s )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( V3a @ V4i ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        & ! [V5x: A_27a] :
            ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( V1f @ V5x ) )
        & ! [V6i: A_27b,V7j: A_27b] :
            ( ( ( c_2Ebool_2EIN @ A_27b @ V6i @ V2s )
              & ( c_2Ebool_2EIN @ A_27b @ V7j @ V2s )
              & ( (~) @ ( V6i = V7j ) ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V3a @ V6i ) @ ( V3a @ V7j ) ) )
        & ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V1f @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) @ c_2Emeasure_2EBorel ) ) )
     => ( ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
          @ ^ [V8x: A_27a] :
              ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V8x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ A_27b @ ( A_27a > $o ) @ V3a @ V2s ) ) @ V8x ) ) )
        = ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27b
          @ ^ [V9i: A_27b] :
              ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
              @ ^ [V10x: A_27a] :
                  ( c_2Eextreal_2Eextreal__mul @ ( V1f @ V10x ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( V3a @ V9i ) @ V10x ) ) )
          @ V2s ) ) ) )).
