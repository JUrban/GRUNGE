...
thf(thm_2EindexedLists_2ELENGTH__MAP2i,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1l1_2E0: u,V2l2_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ ( c_2EindexedLists_2EMAP2i_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l2_2E0 ) ) ) ) ) )
      = ( mono_2Ec_2Earithmetic_2EMIN @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l2_2E0 ) ) ) ) ) ) )).
