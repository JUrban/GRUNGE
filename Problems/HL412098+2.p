...
fof(conj_thm_2Eprobability_2EPROB__FINITELY__ADDITIVE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ! [V2f] :
                 ...
                 => ! [V3n] :
                      ( mem(V3n,ty_2Enum_2Enum)
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V2f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epred__set_2Ecount,V3n)),ap(c_2Eprobability_2Eevents(A_27a),V0p))))
                          & ! [V4a] :
                              ( mem(V4a,ty_2Enum_2Enum)
                             => ! [V5b] :
                                  ( mem(V5b,ty_2Enum_2Enum)
                                 => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V4a),V3n))
                                      & p(ap(ap(c_2Eprim__rec_2E_3C,V5b),V3n))
                                      & V4a != V5b )
                                   => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V2f,V4a)),ap(V2f,V5b))) ) ) )
                          & V1s = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),ap(c_2Epred__set_2Ecount,V3n))) )
                       => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V3n)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V2f)) = ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s) ) ) ) ) ) ) )).
