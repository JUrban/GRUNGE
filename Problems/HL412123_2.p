...
tff(lmtp_f4242,type,(
    f4242: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4242,axiom,(
    ! [A_27a: del,A_27c: del,A_27b: del,V2Y: $i] :
      ( mem(V2Y,arr(A_27a,A_27c))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V0p: $i] :
...
tff(conj_thm_2Eprobability_2Efinite__marginal__product__space__POW,conjecture,(
