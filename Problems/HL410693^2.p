...
thf(conj_thm_2Ereal__topology_2EEMPTY__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(ax_thm_2Ereal__topology_2Econnected,axiom,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__DISJOINT__BIGUNION__OPEN__UNIQUE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ! [V1f_27: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Epairwise @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( c_2Epred__set_2EDISJOINT @ ty_2Erealax_2Ereal ) ) @ V0f ) )
              ...
              & ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V0f )
                = ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V1f_27 ) ) )
           => ( V0f = V1f_27 ) ) ) ) )).
