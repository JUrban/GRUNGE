...
tff(conj_thm_2Erich__list_2EFOLDL__APPEND,lemma,(
...
tff(lmtp_f1947,type,(
    f1947: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f1947,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,A_27b: del,V3v: $i] :
      ( mem(V3v,A_27b)
     => ! [V2k: $i] :
          ( mem(V2k,A_27a)
         => mem(f1947(A_27b,A_27a,A_27a,A_27b,V3v,V2k),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a))) ) ) )).

tff(lameq_f1947,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,A_27b: del,V3v: $i] :
      ( mem(V3v,A_27b)
     => ! [V2k: $i] :
          ( mem(V2k,A_27a)
         => ! [V4env: $i] :
              ( mem(V4env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ap(f1947(A_27b,A_27a,A_27a,A_27b,V3v,V2k),V4env) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V4env),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2k),V3v)) ) ) ) )).

tff(lmtp_f1946,type,(
    f1946: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f1946,axiom,(
    ! [A_27a: del,A_27a: del,A_27b: del,A_27b: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => mem(f1946(A_27a,A_27a,A_27b,A_27b,V2k),arr(A_27b,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) ) )).

tff(lameq_f1946,axiom,(
    ! [A_27a: del,A_27a: del,A_27b: del,A_27b: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => ! [V3v: $i] :
          ( mem(V3v,A_27b)
         => ap(f1946(A_27a,A_27a,A_27b,A_27b,V2k),V3v) = f1947(A_27b,A_27a,A_27a,A_27b,V3v,V2k) ) ) )).

tff(lmtp_f1945,type,(
    f1945: ( del * del * del * del ) > $i )).

tff(lamtp_f1945,axiom,(
    ! [A_27b: del,A_27b: del,A_27a: del,A_27a: del] : mem(f1945(A_27b,A_27b,A_27a,A_27a),arr(A_27a,arr(A_27b,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a))))) )).

tff(lameq_f1945,axiom,(
    ! [A_27b: del,A_27b: del,A_27a: del,A_27a: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => ap(f1945(A_27b,A_27b,A_27a,A_27a),V2k) = f1946(A_27a,A_27a,A_27b,A_27b,V2k) ) )).

tff(conj_thm_2Efinite__map_2Efupdate__list__foldr,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
         => ap(ap(ap(c_2Elist_2EFOLDR(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1945(A_27b,A_27b,A_27a,A_27a))),V0m),V1l) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V0m),ap(c_2Elist_2EREVERSE(ty_2Epair_2Eprod(A_27a,A_27a)),V1l)) ) ) )).
