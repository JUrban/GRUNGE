...
fof(conj_thm_2Ereal__topology_2ELE__ADD,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2EADD__SUB2,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2EREAL__POW__LE__1,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EREAL__INV__1__LE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
...
fof(conj_thm_2Ereal__topology_2ESUM__GP,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESERIES__RATIO,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => ! [V1a] :
         ...
         => ! [V2s] :
             ...
             => ! [V3N] :
                  ( mem(V3N,ty_2Enum_2Enum)
                 => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,V0c),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))
                      & ! [V4n] :
                          ( mem(V4n,ty_2Enum_2Enum)
                         => ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V4n),V3N))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1a,ap(c_2Enum_2ESUC,V4n)))),ap(ap(c_2Erealax_2Ereal__mul,V0c),ap(c_2Ereal_2Eabs,ap(V1a,V4n))))) ) ) )
                   => ? [V5l] :
                        ( mem(V5l,ty_2Erealax_2Ereal)
                        & p(ap(ap(ap(c_2Ereal__topology_2Esums,V1a),V5l),V2s)) ) ) ) ) ) ) )).
