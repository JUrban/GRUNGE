...
tff(conj_thm_2Ereal_2EREAL__LE__ADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__LE__SUB__RADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal__topology_2ESETDIST__EMPTY,lemma,
    ( ! [V0t: $i] :
        ( mem(V0t,arr(ty_2Erealax_2Ereal,bool))
       => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)),V0t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
    & ! [V1s: $i] :
        ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
       => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1s),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
...
tff(conj_thm_2Ereal__topology_2EREAL__LE__SETDIST__EQ,lemma,(
    ! [V0d: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0d)),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1s),V2t))))
          <=> ( ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0d)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V4y))))) )
              & ( ( V1s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                  | V2t = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0d)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESETDIST__SING__TRIANGLE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V0s))),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V0s))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y))))) ) )).

tff(conj_thm_2Ereal__topology_2ESETDIST__LE__SING,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESETDIST__SING__LE__HAUSDIST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
                ...
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s)) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V1t))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESETDIST__HAUSDIST__TRIANGLE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2u: $i] :
             ...
             => ( ( V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                  & p(ap(c_2Ereal__topology_2Ebounded__def,V1t))
                  & p(ap(c_2Ereal__topology_2Ebounded__def,V2u)) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V2u))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1t),V2u))))) ) ) ) ) )).
