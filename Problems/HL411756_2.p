...
tff(lamtp_f4024,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4024(V0x,V1y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f4024,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3n: tp__ty_2Enum_2Enum] : ap(f4024(V0x,V1y),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0x,inj__ty_2Enum_2Enum(V3n))),ap(V1y,inj__ty_2Enum_2Enum(V3n))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__ADD,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y: $i] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2s),V0x))
               ...
               => p(ap(ap(c_2Ereal__topology_2Esummable,V2s),f4024(V0x,V1y))) ) ) ) ) )).
