...
fof(mem_c_2Emachine__ieee_2Efp32__sub__with__flags,axiom,(
    mem(c_2Emachine__ieee_2Efp32__sub__with__flags,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags))))) )).
    ...
    ! [V0mode] :
     ...
     => ! [V1a] :
         ...
         => ! [V2b] :
             ...
             => ap(ap(ap(c_2Emachine__ieee_2Efp32__sub__with__flags,V0mode),V1a),V2b) = ap(ap(ap(c_2Epair_2E_23_23(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),c_2Ecombin_2EI(ty_2Ebinary__ieee_2Eflags)),c_2Emachine__ieee_2Efloat__to__fp32),ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0mode),ap(c_2Emachine__ieee_2Efp32__to__float,V1a)),ap(c_2Emachine__ieee_2Efp32__to__float,V2b))) ) ) ) )).
...
fof(conj_thm_2Emachine__ieee_2Efp32__sub__with__flags,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1b] :
