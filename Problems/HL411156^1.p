...
thf(thm_2Ereal__topology_2EFORALL__POS__MONO,axiom,(
    ! [V0P: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ! [V1d: mono_2Etyop_2Erealax_2Ereal,V2e: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1d @ V2e )
              & ( V0P @ V1d ) )
           => ( V0P @ V2e ) )
        & ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( ( (~) @ ( V3n = mono_2Ec_2Enum_2E0 ) )
           => ( V0P @ ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Ereal_2Ereal__of__num @ V3n ) ) ) ) )
...
thf(thm_2Ereal__topology_2EFORALL__POS__MONO__1,conjecture,(
    ! [V0P: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ! [V1d: mono_2Etyop_2Erealax_2Ereal,V2e: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1d @ V2e )
              & ( V0P @ V1d ) )
           => ( V0P @ V2e ) )
        & ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( V0P @ ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Ereal_2Ereal__of__num @ V3n ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )
     => ! [V4e: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V4e )
         => ( V0P @ V4e ) ) ) )).
