...
tff(conj_thm_2Epred__set_2EDISJOINT__EMPTY,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EPROB__COUNTABLY__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EEVENTS__EMPTY,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),c_2Epred__set_2EEMPTY(A_27a)),ap(c_2Eprobability_2Eevents(A_27a),V0p))) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__FINITELY__ADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2f: $i] :
             ...
             => ! [V3n: tp__ty_2Enum_2Enum] :
                  ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                    & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V2f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V3n))),ap(c_2Eprobability_2Eevents(A_27a),V0p))))
                    ...
                    & V1s = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V3n)))) )
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V2f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) ) ) ) ) )).
