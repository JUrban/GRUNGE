...
thf(thm_2Ealignment_2Ealign__w2n,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ...
      = ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2EDIV @ ( c_2Ewords_2Ew2n @ A_27a @ V1w ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0p ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0p ) ) ) ) )).

thf(thm_2Ealignment_2Ealign__sub,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ealignment_2Ealign @ A_27a @ V0p @ V1w )
      = ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V0p @ c_2Enum_2E0 ) @ V1w @ ( c_2Ewords_2Eword__sub @ A_27a @ V1w @ ( c_2Ewords_2Eword__extract @ A_27a @ A_27a @ ( c_2Earithmetic_2E_2D @ V0p @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ c_2Enum_2E0 @ V1w ) ) ) ) )).
...
thf(thm_2Ealignment_2Ealign__add__aligned,conjecture,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1a: tyop_2Efcp_2Ecart @ $o @ A_27a,V2b: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ V1a )
        & ( c_2Eprim__rec_2E_3C @ ( c_2Ewords_2Ew2n @ A_27a @ V2b ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0p ) ) )
     => ( ( c_2Ealignment_2Ealign @ A_27a @ V0p @ ( c_2Ewords_2Eword__add @ A_27a @ V1a @ V2b ) )
        = V1a ) ) )).
