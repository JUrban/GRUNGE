...
fof(conj_thm_2Earithmetic_2EMIN__0,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2ENOT__MOD2__LEM2,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EODD__MOD2__LEM,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__SLICE__THM2,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__SLICE__THM3,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT0__ODD,lemma,(
...
fof(conj_thm_2Elist_2EFOLDL__CONG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(ax_thm_2Erich__list_2ECOUNT__LIST__def,axiom,
    ( ap(c_2Erich__list_2ECOUNT__LIST,c_2Enum_2E0) = c_2Elist_2ENIL(ty_2Enum_2Enum)
    & ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
       => ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Enum_2ESUC,V0n)) = ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),c_2Enum_2E0),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2ESUC),ap(c_2Erich__list_2ECOUNT__LIST,V0n))) ) )).

fof(conj_thm_2Erich__list_2EMEM__COUNT__LIST,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(lameq_f2165,axiom,(
    ! [A_27a,V0v] :
     ...
     => ! [V1w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2165(A_27a,V0v,V1w),V2i) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),V2i)) ) ) ) )).
...
fof(lamtp_f2179,axiom,(
    ! [A_27a,V2w] :
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
              ( mem(V1l,ty_2Enum_2Enum)
             => mem(f2179(A_27a,V2w,V0h,V1l),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
             ...
             => ! [V3i] :
                 ...
                 => ap(f2179(A_27a,V2w,V0h,V1l),V3i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V1l),V3i)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V3i),ap(ap(c_2Earithmetic_2EMIN,V0h),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2w),V3i))) ) ) ) ) )).

fof(lamtp_f2178,axiom,(
    ! [A_27a,V1l] :
      ( mem(V1l,ty_2Enum_2Enum)
     => ! [V0h] :
          ( mem(V0h,ty_2Enum_2Enum)
         => mem(f2178(A_27a,V1l,V0h),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) ) )).
...
fof(lameq_f2178,axiom,(
    ! [A_27a,V1l] :
     ...
     => ! [V0h] :
         ...
         => ! [V2w] :
              ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
             => ap(f2178(A_27a,V1l,V0h),V2w) = ap(c_2Efcp_2EFCP(bool,bool),f2179(A_27a,V2w,V0h,V1l)) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__slice__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
              ( mem(V1l,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__slice(A_27a),V0h),V1l) = f2178(A_27a,V1l,V0h) ) ) ) )).
...
fof(lameq_f2210,axiom,(
    ! [A_27a,V1n] :
     ...
     => ! [V0w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2210(A_27a,V1n,V0w),V2i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,V2i),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V1n),V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2D,V2i),V1n)))) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__lsl__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__lsl(A_27a),V0w),V1n) = ap(c_2Efcp_2EFCP(bool,bool),f2210(A_27a,V1n,V0w)) ) ) ) )).
...
fof(conj_thm_2Ewords_2Eword__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0i),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
           => ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),V0i)) ) ) ) )).
...
fof(conj_thm_2Ewords_2EWORD__ADD__OR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2Ew2w__id,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__RIGHT__ADD__DISTRIB,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__EQ__SUB__ZERO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2ESHIFT__ZERO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ewords_2Eword__lsl__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(lamtp_f2317,axiom,(
    ! [A_27a,V1m] :
     ...
     => ! [V3j] :
         ...
         => ! [V0w] :
              ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
             => mem(f2317(A_27a,V1m,V3j,V0w),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
     ...
     => ! [V3j] :
         ...
         => ! [V0w] :
             ...
             => ! [V4i] :
                 ...
                 => ap(f2317(A_27a,V1m,V3j,V0w),V4i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),V3j)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V3j),V4i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1m),ap(ap(c_2Earithmetic_2E_2D,V4i),V3j)))) ) ) ) ) )).

fof(lamtp_f2316,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2a] :
              ( mem(V2a,ty_2Efcp_2Ecart(bool,bool))
             => mem(f2316(A_27a,V1m,V0w,V2a),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool))) ) ) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2a] :
             ...
             => ! [V3j] :
                  ( mem(V3j,ty_2Enum_2Enum)
                 => ap(f2316(A_27a,V1m,V0w,V2a),V3j) = ap(ap(c_2Ewords_2Eword__add(A_27a),V2a),ap(c_2Efcp_2EFCP(bool,bool),f2317(A_27a,V1m,V3j,V0w))) ) ) ) ) )).

fof(lamtp_f2315,axiom,(
    ! [A_27a,A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2315(A_27a,A_27a,V1m,V0w),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool)))) ) ) )).
...
fof(lameq_f2315,axiom,(
    ! [A_27a,A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2a] :
              ( mem(V2a,ty_2Efcp_2Ecart(bool,bool))
             => ap(f2315(A_27a,A_27a,V1m,V0w),V2a) = f2316(A_27a,V1m,V0w,V2a) ) ) ) )).

fof(conj_thm_2Eblast_2EBITWISE__MUL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1m] :
              ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Eword__mul(A_27a),V0w),V1m) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f2315(A_27a,A_27a,V1m,V0w)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).
