...
fof(conj_thm_2Eextreal_2EOPP__IN__Q,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),V0x),c_2Eextreal_2EQ__set))
       => p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),ap(c_2Eextreal_2Eextreal__ainv,V0x)),c_2Eextreal_2EQ__set)) ) ) )).
