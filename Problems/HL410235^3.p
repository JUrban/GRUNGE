...
thf(thm_2Emeasure_2EMEASURE__SPACE__CMUL,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1c: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Emeasure_2Emeasure__space @ A_27a
        @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m )
          @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m )
            @ ^ [V2a: A_27a > $o] :
                ( c_2Erealax_2Ereal__mul @ V1c @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2a ) ) ) ) ) ) )).
