...
tff(conj_thm_2Epred__set_2EDIFF__INTER2,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EPREIMAGE__COMPL__INTER,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1t: $i] :
         ...
         => ! [V2sp: $i] :
             ...
             => ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2ECOMPL(A_27b),V1t))),V2sp) = ap(ap(c_2Epred__set_2EDIFF(A_27a),V2sp),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1t)) ) ) ) )).
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__ALT3,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
