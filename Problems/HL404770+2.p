...
fof(conj_thm_2Efinite__map_2EFEMPTY__SUBMAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0h] :
             ...
             => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0h),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)))
              <=> V0h = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) ) ) ) )).
