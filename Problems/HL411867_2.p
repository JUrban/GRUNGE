...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__INTER__CLOSURE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ESETDIST__EQ__0__CLOSED__IN,conjecture,(
    ! [V0u: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => ( surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V1s))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
