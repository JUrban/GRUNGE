...
fof(conj_thm_2Ecombin_2Eo__ABS__L,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ellist_2ELTL__HD__LTL__LHD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELGENLIST__SOME,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => ( ap(ap(c_2Ellist_2ELGENLIST(A_27a),V0f),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),c_2Enum_2E0)) = c_2Ellist_2ELNIL(A_27a)
            & ! [V1n] :
                ( mem(V1n,ty_2Enum_2Enum)
               => ap(ap(c_2Ellist_2ELGENLIST(A_27a),V0f),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(c_2Enum_2ESUC,V1n))) = ap(ap(c_2Ellist_2ELCONS(A_27a),ap(V0f,c_2Enum_2E0)),ap(ap(c_2Ellist_2ELGENLIST(A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Enum_2ESUC)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),V1n))) ) ) ) ) )).
