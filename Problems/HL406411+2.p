...
fof(conj_thm_2Epred__set_2Enum__countable,lemma,(
...
fof(conj_thm_2Ecardinal_2Ecountable__cardeq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2Ecardlt__lenoteq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eucord_2Eucinf__uncountable,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Eucord_2EUnum__cardlt__ucinf,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).
