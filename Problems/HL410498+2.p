...
fof(conj_thm_2Ereal__topology_2EINDEPENDENT__MONO,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EIN__SPAN__INSERT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EINDEPENDENT__INSERT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
