...
tff(conj_thm_2Eordinal_2Ewellorder__ordinal__isomorphism,lemma,(
    ! [A_27a: del,V0w: $i] :
...
tff(conj_thm_2Eordinal_2Epreds__wobound,lemma,(
    ! [A_27a: del,V0ord: $i] :
...
tff(conj_thm_2Eordinal_2Epreds__inj__univ,conjecture,(
    ! [A_27a: del,V0ord: $i] :
      ( mem(V0ord,ty_2Eordinal_2Eordinal(A_27a))
