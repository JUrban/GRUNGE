...
thf(tp_c_2Ebit_2ELOWEST__SET__BIT,type,(
    c_2Ebit_2ELOWEST__SET__BIT: $i )).

thf(mem_c_2Ebit_2ELOWEST__SET__BIT,axiom,(
    mem @ c_2Ebit_2ELOWEST__SET__BIT @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2Ebit_2ELOWEST__SET__BIT,type,(
    fo__c_2Ebit_2ELOWEST__SET__BIT: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Ebit_2ELOWEST__SET__BIT,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Ebit_2ELOWEST__SET__BIT @ X0 ) )
      = ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( inj__ty_2Enum_2Enum @ X0 ) ) ) )).
...
thf(conj_thm_2Enumeral__bit_2ELOWEST__SET__BIT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( V0n != fo__c_2Enum_2E0 )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( ap @ c_2Earithmetic_2EDIV2 @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Enumeral__bit_2ELOWEST__SET__BIT__compute,conjecture,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )
    & ! [V1n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ebit_2ELOWEST__SET__BIT @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )
        = fo__c_2Enum_2E0 ) )).
