...
thf(thm_2Eiterate_2ESUM__POS__BOUND,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        ...
        & ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V0f ) @ V1b ) )
     => ! [V4x: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V4x @ V2s )
         => ( c_2Ereal_2Ereal__lte @ ( V0f @ V4x ) @ V1b ) ) ) )).
