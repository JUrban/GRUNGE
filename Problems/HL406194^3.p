    ...
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ...
      = ( c_2Esum__num_2ESUM @ V0n
        @ ^ [V2i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V1w @ V2i ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ c_2Enum_2E0 ) ) ) )).

thf(thm_2Ewords_2Ebit__count__upto__SUC,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Ebit__count__upto @ A_27a @ ( c_2Enum_2ESUC @ V1n ) @ V0w )
      = ( c_2Earithmetic_2E_2B @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V0w @ V1n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ c_2Enum_2E0 ) @ ( c_2Ewords_2Ebit__count__upto @ A_27a @ V1n @ V0w ) ) ) )).
