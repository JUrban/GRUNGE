...
thf(f7052_0_2E0,type,(
    f7052_0_2E0: u )).

thf(f7052_0_2E2,type,(
    f7052_0_2E2: du > du > u )).

thf(f7052_1_2E0,type,(
    f7052_1_2E0: u )).

thf(f7052_1_2E2,type,(
    f7052_1_2E2: du > du > u )).
...
thf(mono_2Ef7052_0,type,(
    mono_2Ef7052_0: $o > $o > $o )).

thf(mono_2Ef7052_1,type,(
    mono_2Ef7052_1: $o > $o > $o )).
...
thf(def0_2Ethm_2Ewords_2EWORD__LITERAL__AND,axiom,(
    ! [V8a: $o,V9b: $o] :
      ( ( mono_2Ef7052_1 @ V8a @ V9b )
    <=> ( V8a
        & ( (~) @ V9b ) ) ) )).

thf(def1_2Ethm_2Ewords_2EWORD__LITERAL__AND,axiom,(
    ! [V4a: $o,V5b: $o] :
      ( ( mono_2Ef7052_0 @ V4a @ V5b )
    <=> ( V4a
        & ( (~) @ V5b ) ) ) )).

thf(thm_2Ewords_2EWORD__LITERAL__AND,conjecture,(
    ! [A_27a: d] :
      ( ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__and_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1m ) ) ) ) ) )
          = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2EMIN @ ( mono_2Ec_2Ebit_2ELOG2 @ V0n ) @ ( mono_2Ec_2Ebit_2ELOG2 @ V1m ) ) ) @ mono_2Ec_2Ebool_2E_2F_5C @ V0n @ V1m ) ) ) ) ) )
      & ! [V2n: mono_2Etyop_2Enum_2Enum,V3m: mono_2Etyop_2Enum_2Enum] :
          ...
          = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Ebit_2ELOG2 @ V2n ) ) @ mono_2Ef7052_0 @ V2n @ V3m ) ) ) ) ) )
      & ! [V6n: mono_2Etyop_2Enum_2Enum,V7m: mono_2Etyop_2Enum_2Enum] :
          ...
          = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Ebit_2ELOG2 @ V6n ) ) @ mono_2Ef7052_1 @ V6n @ V7m ) ) ) ) ) )
      & ! [V10n: mono_2Etyop_2Enum_2Enum,V11m: mono_2Etyop_2Enum_2Enum] :
          ...
          = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__1comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2EMAX @ ( mono_2Ec_2Ebit_2ELOG2 @ V10n ) @ ( mono_2Ec_2Ebit_2ELOG2 @ V11m ) ) ) @ mono_2Ec_2Ebool_2E_5C_2F @ V10n @ V11m ) ) ) ) ) ) ) ) ) )).
