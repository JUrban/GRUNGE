...
tff(mem_c_2Epath_2Eplink,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2Eplink(A_27a,A_27a),arr(ty_2Epath_2Epath(A_27a,A_27a),arr(ty_2Epath_2Epath(A_27a,A_27a),ty_2Epath_2Epath(A_27a,A_27a)))) )).
...
tff(conj_thm_2Epath_2Efinite__path__ind,lemma,(
...
tff(conj_thm_2Epath_2Efinite__path__end__cases,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
     ...
     => ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),V0p))
       => ( ? [V1x: $i] :
          ...
          | ? [V2p_27: $i] :
              ( mem(V2p_27,ty_2Epath_2Epath(A_27a,A_27a))
              & ? [V3l: $i] :
                  ( mem(V3l,A_27b)
                  & ? [V4s: $i] :
                      ( mem(V4s,A_27a)
                      & V0p = ap(ap(c_2Epath_2Eplink(A_27a,A_27a),V2p_27),ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),ap(c_2Epath_2Elast(A_27a,A_27a),V2p_27)),V3l),ap(c_2Epath_2Estopped__at(A_27a,A_27a),V4s))) ) ) ) ) ) ) )).
