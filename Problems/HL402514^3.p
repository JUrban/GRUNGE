...
thf(thm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__ALT__DEF,conjecture,(
    ! [A_27a: $tType,V0i: A_27a,V1P: A_27a > $o] :
      ( ! [V2v: A_27a] :
          ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL @ A_27a @ V2v @ V0i @ ( V1P @ V2v ) )
    <=> ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ tyop_2Eone_2Eone @ A_27a @ ( c_2Ecombin_2EK @ A_27a @ tyop_2Eone_2Eone @ V0i )
        @ ^ [V3v: A_27a] :
            ( V1P @ V3v ) ) ) )).
