...
thf(stp_fo_c_2Ehrat_2Ehrat__REP__CLASS,type,(
    fo__c_2Ehrat_2Ehrat__REP__CLASS: tp__ty_2Ehrat_2Ehrat > tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum > $o )).

thf(stp_eq_fo_c_2Ehrat_2Ehrat__REP__CLASS,axiom,(
    ! [X0: tp__ty_2Ehrat_2Ehrat,X1: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
      ( ( inj__o @ ( fo__c_2Ehrat_2Ehrat__REP__CLASS @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Ehrat_2Ehrat__REP__CLASS @ ( inj__ty_2Ehrat_2Ehrat @ X0 ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ X1 ) ) ) )).
              ...
              @ ( lam @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool )
                @ ^ [V2c: $i] :
                    ...
                    @ ( lam @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                      @ ^ [V3r: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ehrat_2Etrat__eq @ V3r ) @ V3r ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool ) ) @ V2c ) @ ( ap @ c_2Ehrat_2Etrat__eq @ V3r ) ) ) ) ) )
              @ V1r ) )
        <=> ( ( ap @ c_2Ehrat_2Ehrat__REP__CLASS @ ( ap @ c_2Ehrat_2Ehrat__ABS__CLASS @ V1r ) )
            = V1r ) ) ) )).

thf(conj_thm_2Ehrat_2Ehrat__ABS__REP__CLASS,conjecture,
    ( ! [V0a: tp__ty_2Ehrat_2Ehrat] :
        ( ( surj__ty_2Ehrat_2Ehrat @ ( ap @ c_2Ehrat_2Ehrat__ABS__CLASS @ ( ap @ c_2Ehrat_2Ehrat__REP__CLASS @ ( inj__ty_2Ehrat_2Ehrat @ V0a ) ) ) )
        = V0a )
    & ! [V1c: $i] :
