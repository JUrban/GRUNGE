...
fof(conj_thm_2Epath_2EPL__downward__closed,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0i),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                   => ! [V2j] :
                       ...
                       => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2j),V0i))
                         => p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2j),ap(c_2Epath_2EPL(A_27a,A_27a),V1p))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Epath_2EIN__PL__drop,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0i),ap(c_2Epath_2EPL(A_27a,A_27a),V2p)))
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1j),ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),V0i),V2p))))
                        <=> p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V0i),V1j)),ap(c_2Epath_2EPL(A_27a,A_27a),V2p))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Epath_2Eel__drop,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                      ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V0i),V1j)),ap(c_2Epath_2EPL(A_27a,A_27a),V2p)))
                       => ap(ap(c_2Epath_2Eel(A_27a,A_27a),V0i),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),V1j),V2p)) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2B,V0i),V1j)),V2p) ) ) ) ) ) ) )).

fof(conj_thm_2Epath_2Elast__take,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ! [V1p] :
                  ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0i),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                   => ap(c_2Epath_2Elast(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V0i),V1p)) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),V0i),V1p) ) ) ) ) ) )).
...
fof(conj_thm_2Epath_2Elast__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0i),V1j))
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1j),ap(c_2Epath_2EPL(A_27a,A_27a),V2p))) )
                       => ap(c_2Epath_2Elast(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V0i),V1j),V2p)) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),V1j),V2p) ) ) ) ) ) ) )).
