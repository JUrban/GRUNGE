...
thf(conj_thm_2Elim_2EIVT2,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Etransc_2ECOS__POS__PI2,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
