...
fof(lamtp_f1861,axiom,(
    ! [A_27a,V0A] :
      ( mem(V0A,arr(A_27a,bool))
     => mem(f1861(A_27a,V0A),arr(ty_2Enum_2Enum,arr(arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)),bool))) ) )).
...
fof(lameq_f1861,axiom,(
    ! [A_27a,V0A] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f1861(A_27a,V0A),V1n) = ap(ap(c_2Ecardinal_2Eset__exp(ty_2Enum_2Enum,ty_2Enum_2Enum),V0A),ap(c_2Epred__set_2Ecount,V1n)) ) ) )).

fof(conj_thm_2Ecardinal_2Elist__BIGUNION__EXP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
         => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Ecardinal_2Elist(A_27a),V0A)),ap(c_2Epred__set_2EBIGUNION(arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f1861(A_27a,V0A)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) ) ) )).
