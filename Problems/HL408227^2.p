...
thf(conj_thm_2Elim_2ELIM__NULL,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Epowser_2EPOWSER__INSIDEA,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Epowser_2EPOWSER__INSIDE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
          ( ( ( p
         ...
         => ( p
            @ ( ap @ c_2Eseq_2Esummable
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4n: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V4n ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) @ V4n ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epowser_2EDIFFS__EQUIV,lemma,(
    ! [V0c: $i] :
      ( ( mem @ V0c @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Epowser_2ETERMDIFF__LEMMA3,lemma,(
...
thf(conj_thm_2Epowser_2ETERMDIFF__LEMMA5,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
              ...
              ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2k ) ) )
                ...
                & ! [V3h: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ! [V4n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V3h ) ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3h ) ) ) ) ) ) )
             => ( p
                @ ( ap
                  @ ( ap
                    @ ( ap @ c_2Elim_2Etends__real__real
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5h: $i] :
                            ( ap @ c_2Eseq_2Esuminf @ ( ap @ V1g @ V5h ) ) ) )
                    @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                  @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EABS__CIRCLE,lemma,(
...
thf(conj_thm_2Eseq_2ESER__SUB,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Eseq_2ESER__CDIV,lemma,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Epowser_2ETERMDIFF,conjecture,(
    ! [V0c: $i] :
      ( ( mem @ V0c @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
