...
fof(thm_2Eordinal_2EordADD__CANCEL1,axiom,(
    ! [A_27a] :
      ( ! [V0c_2E0,V1a_2E0] :
        ...
        <=> s(tyop_2Eordinal_2Eordinal(A_27a),V0c_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0))) )
      & ! [V2c_2E0,V3a_2E0] :
...
fof(thm_2Eordinal_2Eordle__CANCEL__ADDR,conjecture,(
