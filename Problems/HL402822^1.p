...
thf(thm_2Erich__list_2EIS__PREFIX__APPEND3,conjecture,(
    ! [A_27a: d,V0c_2E0: u,V1a_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EisPREFIX_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0c_2E0 ) ) ) ) ) ) )).
