...
tff(lameq_f2839,axiom,(
    ! [V0n: tp__ty_2EordinalNotation_2Eosyntax] : ap(f2839,inj__ty_2EordinalNotation_2Eosyntax(V0n)) = ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),inj__ty_2EordinalNotation_2Eosyntax(V0n)),ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V0n))) )).

tff(lmtp_f2840,type,(
    f2840: ( del * del ) > $i )).

tff(lamtp_f2840,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2840(A_27a,A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) )).
