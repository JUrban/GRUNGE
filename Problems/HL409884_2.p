...
tff(conj_thm_2Eiterate_2ESUM__RMUL,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
...
tff(conj_thm_2Eiterate_2ESUM__SUM__PRODUCT,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,arr(A_27b,bool)))
...
tff(conj_thm_2Eiterate_2ESUM__EQ__GENERAL__INVERSES,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
...
tff(lamtp_f3385,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f3385(V0f,V1g),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3385,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V4i: tp__ty_2Enum_2Enum] : ap(f3385(V0f,V1g),inj__ty_2Enum_2Enum(V4i)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Enum_2Enum(V4i))),ap(V1g,inj__ty_2Enum_2Enum(V4i))) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__SUB__NUMSEG,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f3385(V0f,V1g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V0f)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V1g))) ) ) )).
...
tff(lmtp_f3405,type,(
    f3405: ( tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3405,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal,V2n: tp__ty_2Enum_2Enum,V0x: tp__ty_2Erealax_2Ereal] : mem(f3405(V1y,V2n,V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f3405,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal,V2n: tp__ty_2Enum_2Enum,V0x: tp__ty_2Erealax_2Ereal,V3i: tp__ty_2Enum_2Enum] : ap(f3405(V1y,V2n,V0x),inj__ty_2Enum_2Enum(V3i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Enum_2Enum(V3i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1y)),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V3i)))) )).

tff(conj_thm_2Eiterate_2EREAL__SUB__POW,lemma,(
...
tff(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
