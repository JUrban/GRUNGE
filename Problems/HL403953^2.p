...
thf(conj_thm_2Ellist_2ENOT__LFINITE__DROP__LFINITE,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V2t: $i] :
          ( ( mem @ V2t @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ~ ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V1l ) )
              & ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
                = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V2t ) ) )
...
thf(conj_thm_2Ellist_2ELDROP__APPEND1,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ! [V3l2: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l1 )
                  = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V2l ) )
               => ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1l1 ) @ V3l2 ) )
                  = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V2l ) @ V3l2 ) ) ) ) ) ) ) )).
