...
tff(thm_2Epred__set_2EFUNSET,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1Q_2E0: u,V2x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFUNSET_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1Q_2E0),s(tyop_2Emin_2Efun(A_27a,A_27b),V2x_2E0)))))
    <=> ! [V3x_2E0: u] :
         ...
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V2x_2E0),s(A_27a,V3x_2E0))),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1Q_2E0))))) ) ) )).

tff(thm_2Epred__set_2EIN__FUNSET,conjecture,(
