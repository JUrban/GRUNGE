...
fof(conj_thm_2Einteger_2EINT__EQ__LADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
    ...
    ! [V1i] :
     ...
     => ! [V0P] :
         ...
         => ! [V2j] :
             ...
             => ap(f2142(V1i,V0P),V2j) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Einteger_2Eint__lt,V2j),V1i)),ap(c_2Ebool_2E_7E,ap(V0P,V2j))) ) ) ) )).

fof(lamtp_f2141,axiom,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
...
fof(lameq_f2141,axiom,(
    ! [V0P] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Einteger_2Eint)
         => ap(f2141(V0P),V1i) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,V1i)),ap(c_2Ebool_2E_21(ty_2Einteger_2Eint),f2142(V1i,V0P))) ) ) )).

fof(ax_thm_2Einteger_2ELEAST__INT__DEF,axiom,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Einteger_2Eint,bool))
     => ap(c_2Einteger_2ELEAST__INT,V0P) = ap(c_2Emin_2E_40(ty_2Einteger_2Eint),f2141(V0P)) ) )).
...
fof(lamtp_f2752,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2752(V0x),arr(ty_2Einteger_2Eint,bool)) ) )).
...
fof(lameq_f2752,axiom,(
    ! [V0x] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Einteger_2Eint)
         => ap(f2752(V0x),V1i) = ap(ap(c_2Ereal_2Ereal__lte,V0x),ap(c_2Eintreal_2Ereal__of__int,V1i)) ) ) )).

fof(ax_thm_2Eintreal_2EINT__CEILING__def,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Eintreal_2EINT__CEILING,V0x) = ap(c_2Einteger_2ELEAST__INT,f2752(V0x)) ) )).

fof(conj_thm_2Eintreal_2Ereal__of__int__monotonic,lemma,(
    ! [V0i] :
      ( mem(V0i,ty_2Einteger_2Eint)
     => ! [V1j] :
...
fof(conj_thm_2Eintreal_2EINT__FLOOR__BOUNDS,lemma,(
    ! [V0r] :
...
fof(lamtp_f2753,axiom,(
    ! [V0r] :
      ( mem(V0r,ty_2Erealax_2Ereal)
     => mem(f2753(V0r),arr(ty_2Einteger_2Eint,ty_2Einteger_2Eint)) ) )).
...
fof(lameq_f2753,axiom,(
    ! [V0r] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Einteger_2Eint)
         => ap(f2753(V0r),V1i) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Einteger_2Eint),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Eintreal_2Ereal__of__int,V1i)),V0r)),V1i),ap(ap(c_2Einteger_2Eint__add,V1i),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) )).

fof(conj_thm_2Eintreal_2EINT__CEILING__INT__FLOOR,conjecture,(
    ! [V0r] :
      ( mem(V0r,ty_2Erealax_2Ereal)
     => ap(c_2Eintreal_2EINT__CEILING,V0r) = ap(ap(c_2Ebool_2ELET(ty_2Einteger_2Eint,ty_2Einteger_2Eint),f2753(V0r)),ap(c_2Eintreal_2EINT__FLOOR,V0r)) ) )).
