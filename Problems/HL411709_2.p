...
tff(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__IMP__SURJECTIVE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__BIJECTIVE__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
              ...
              & ! [V4y: tp__ty_2Erealax_2Ereal] :
                ? [V5x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V5x))) = V4y )
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
