...
fof(conj_thm_2Eprobability_2Emarginal__joint__zero,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2Ejoint__distribution__le2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2Econditional__distribution__le__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V2Y] :
                         ...
                         => ! [V3a] :
                             ...
                             => ! [V4b] :
                                 ...
                                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                      & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V1X),V2Y),V3a),V4b)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) ) ) ) ) ) ) )).
