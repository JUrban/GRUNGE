...
fof(conj_thm_2Esorting_2EPERM__LENGTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
...
fof(conj_thm_2Epatricia_2EPERM__NOT__REMOVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
...
fof(lamtp_f2572,axiom,(
    ! [V1k] :
      ( mem(V1k,ty_2Enum_2Enum)
     => mem(f2572(V1k),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2572,axiom,(
    ! [V1k] :
     ...
     => ! [V2x] :
         ...
         => ap(f2572(V1k),V2x) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2x),V1k)) ) ) )).

fof(conj_thm_2Epatricia_2EFILTER__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Epatricia_2EPERM__REMOVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
         => ! [V1k] :
             ...
             => ( ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
                  & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1k),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),ap(c_2Epatricia_2ETRAVERSE(A_27a),V0t)))) )
               => p(ap(ap(c_2Esorting_2EPERM(ty_2Enum_2Enum),ap(c_2Epatricia_2ETRAVERSE(A_27a),ap(ap(c_2Epatricia_2EREMOVE(A_27a),V0t),V1k))),ap(ap(c_2Elist_2EFILTER(ty_2Enum_2Enum),f2572(V1k)),ap(c_2Epatricia_2ETRAVERSE(A_27a),V0t)))) ) ) ) ) )).

fof(conj_thm_2Epatricia_2ESIZE__REMOVE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
