...
fof(conj_thm_2Epred__set_2EDISJOINT__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( ! [V3x] :
                           ...
                           => ! [V4y] :
                               ...
                               => ( ap(V0f,V3x) = ap(V0f,V4y)
                                <=> V3x = V4y ) ) )
                       => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s1)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s2)))
