...
thf(conj_thm_2EHolSmt_2Et027,conjecture,(
    ! [V0x: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone,V1p: $o] :
      ( ( ( V0x
      ...
      <=> ( p @ ( inj__o @ V1p ) ) )
    <=> ( V0x
        = ( surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( inj__o @ V1p ) ) @ ( ap @ ( c_2Ewords_2En2w @ ty_2Eone_2Eone ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( c_2Ewords_2En2w @ ty_2Eone_2Eone ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
