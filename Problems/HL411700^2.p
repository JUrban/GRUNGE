...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__UNIV,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
