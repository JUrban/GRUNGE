...
tff(f2288_0_2E0,type,(
    f2288_0_2E0: u )).

tff(f2288_0_2E1,type,(
    f2288_0_2E1: du > u )).

tff(f5946_0_2E0,type,(
    f5946_0_2E0: u )).

tff(f5946_0_2E1,type,(
    f5946_0_2E1: du > u )).

tff(f5946_0_2E2,type,(
    f5946_0_2E2: ( du * du ) > u )).
...
tff(arityeq1_2Ef2288_0_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2288_0_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X0_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),f2288_0_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X0_2E0)))) )).

tff(arityeq1_2Ef5946_0_2E1,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Epair_2Eprod(A_27a,A_27b)),f5946_0_2E1(s(tyop_2Efinite__map_2Efmap(A_27a,A_27b),X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Epair_2Eprod(A_27a,A_27b)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Efinite__map_2Efmap(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Epair_2Eprod(A_27a,A_27b))),f5946_0_2E0),s(tyop_2Efinite__map_2Efmap(A_27a,A_27b),X0_2E0))) )).

tff(arityeq2_2Ef5946_0_2E2,axiom,(
...
tff(arityeq1_2Ec_2Efinite__map_2EFDOM_2E1_003,axiom,(
...
tff(arityeq2_2Ec_2Elist_2EMAP_2E2_008,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EMAP_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27c),A_27a),X0_2E0),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(A_27a,A_27c)),X1_2E0))) = s(tyop_2Elist_2Elist(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(A_27a,A_27c)),tyop_2Elist_2Elist(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27c),A_27a),tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(A_27a,A_27c)),tyop_2Elist_2Elist(A_27a))),c_2Elist_2EMAP_2E0),s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27c),A_27a),X0_2E0))),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(A_27a,A_27c)),X1_2E0))) )).
...
tff(thm_2Efinite__map_2EFDOM__FINITE,axiom,(
    ! [A_27a: d,A_27b: d,V0fm_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Efinite__map_2EFDOM_2E1(s(tyop_2Efinite__map_2Efmap(A_27a,A_27b),V0fm_2E0))))))) )).
...
tff(def0_2Ethm_2Elist_2ESET__TO__LIST__THM,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f2288_0_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0)))))
    <=> s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0) ) )).

tff(thm_2Elist_2ESET__TO__LIST__THM,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
...
tff(thm_2Elist_2ESET__TO__LIST__IND,axiom,(
    ! [A_27a: d,V0P_2E0: u] :
      ( ! [V1s_2E0: u] :
          ( ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2EFINITE_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0)))))
           ...
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EREST_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0))))))) )
     ...
     => ! [V2v_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2v_2E0))))) ) )).

tff(thm_2Elist_2ESET__TO__LIST__EMPTY,axiom,(
    ! [A_27a: d] : s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESET__TO__LIST_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0) )).
...
tff(thm_2Ealist_2Efmap__to__alist__preserves__FDOM,conjecture,(
