         ...
         => ! [V0f] :
             ...
             => ! [V3g_27] :
                 ...
                 => ! [V8x] :
                     ...
                     => ap(f3209(V2f_27,V1g,V0f,V3g_27),V8x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(V2f_27,V8x)),ap(V1g,V8x))),ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V8x)),ap(V3g_27,V8x))) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRATION__BY__PARTS,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             ...
             => ! [V3g_27] :
                 ...
                 => ! [V4a] :
                     ...
                     => ! [V5b] :
                         ...
                         => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V4a),V5b))
                              & ! [V6x] :
                                  ( mem(V6x,ty_2Erealax_2Ereal)
                                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V4a),V6x))
                                      & p(ap(ap(c_2Ereal_2Ereal__lte,V6x),V5b)) )
                                   => p(ap(ap(ap(c_2Elim_2Ediffl,V0f),ap(V2f_27,V6x)),V6x)) ) )
                              & ! [V7x] :
                                  ( mem(V7x,ty_2Erealax_2Ereal)
                                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V4a),V7x))
                                      & p(ap(ap(c_2Ereal_2Ereal__lte,V7x),V5b)) )
                                   => p(ap(ap(ap(c_2Elim_2Ediffl,V1g),ap(V3g_27,V7x)),V7x)) ) ) )
                           => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)),f3209(V2f_27,V1g,V0f,V3g_27)),ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V5b)),ap(V1g,V5b))),ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V4a)),ap(V1g,V4a))))) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eintegral_2EINTEGRAL__ADD,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(lameq_f3218,axiom,(
    ! [V2f_27] :
     ...
     => ! [V1g] :
         ...
         => ! [V8x] :
              ( mem(V8x,ty_2Erealax_2Ereal)
             => ap(f3218(V2f_27,V1g),V8x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2f_27,V8x)),ap(V1g,V8x)) ) ) ) )).

fof(lamtp_f3219,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3g_27] :
          ( mem(V3g_27,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
    ...
    ! [V0f] :
     ...
     => ! [V3g_27] :
         ...
         => ! [V9x] :
             ...
             => ap(f3219(V0f,V3g_27),V9x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V9x)),ap(V3g_27,V9x)) ) ) ) )).

fof(lamtp_f3220,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3g_27] :
          ( mem(V3g_27,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
    ...
    ! [V0f] :
     ...
     => ! [V3g_27] :
         ...
         => ! [V10x] :
             ...
             => ap(f3220(V0f,V3g_27),V10x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V10x)),ap(V3g_27,V10x)) ) ) ) )).

fof(lamtp_f3221,axiom,(
    ! [V2f_27] :
      ( mem(V2f_27,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
    ...
    ! [V2f_27] :
     ...
     => ! [V1g] :
         ...
         => ! [V11x] :
             ...
             => ap(f3221(V2f_27,V1g),V11x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2f_27,V11x)),ap(V1g,V11x)) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRAL__BY__PARTS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                         ...
                         => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V4a),V5b))
                              ...
                              & ! [V7x] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V4a),V7x))
                                      & p(ap(ap(c_2Ereal_2Ereal__lte,V7x),V5b)) )
                                   => p(ap(ap(ap(c_2Elim_2Ediffl,V1g),ap(V3g_27,V7x)),V7x)) ) )
                              & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)),f3218(V2f_27,V1g)))
                              & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)),f3219(V0f,V3g_27))) )
                           => ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)),f3220(V0f,V3g_27)) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V5b)),ap(V1g,V5b))),ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V4a)),ap(V1g,V4a)))),ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)),f3221(V2f_27,V1g))) ) ) ) ) ) ) ) )).
