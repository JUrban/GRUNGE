...
fof(conj_thm_2Ereal__topology_2EINTERIOR__INTERVAL,conjecture,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
    ...
    & ! [V2a] :
       ...
       => ! [V3b] :
           ...
           => ap(c_2Ereal__topology_2Einterior,ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b))) = ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)) ) ) )).
