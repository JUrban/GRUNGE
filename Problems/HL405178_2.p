...
tff(conj_thm_2Ealist_2EMEM__fmap__to__alist,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27b)
         => ! [V2fm: $i] :
             ...
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0x),V1y)),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V2fm))))
              <=> ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2fm)))
                  & ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2fm),V0x) = V1y ) ) ) ) ) )).

tff(conj_thm_2Ealist_2EMEM__fmap__to__alist__FLOOKUP,conjecture,(
