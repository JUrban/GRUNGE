...
fof(mem_c_2Elebesgue_2Efinite__space__integral,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Elebesgue_2Efinite__space__integral(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,ty_2Eextreal_2Eextreal),ty_2Eextreal_2Eextreal))) ) )).
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0m] :
         ...
         => ! [V2r] :
             ...
             => ap(f4104(A_27a,V1f,V0m),V2r) = ap(ap(c_2Eextreal_2Eextreal__mul,V2r),ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V1f),ap(ap(c_2Epred__set_2EINSERT(ty_2Eextreal_2Eextreal),V2r),c_2Epred__set_2EEMPTY(ty_2Eextreal_2Eextreal)))),ap(c_2Emeasure_2Em__space(A_27a),V0m))))) ) ) ) )).
...
fof(ax_thm_2Elebesgue_2Efinite__space__integral__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0m] :
         ...
         => ! [V1f] :
              ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
             => ap(ap(c_2Elebesgue_2Efinite__space__integral(A_27a),V0m),V1f) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Eextreal_2Eextreal),f4104(A_27a,V1f,V0m)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),ap(c_2Emeasure_2Em__space(A_27a),V0m))) ) ) ) )).

fof(conj_thm_2Elebesgue_2Efinite__space__integral__reduce,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f) = ap(ap(c_2Elebesgue_2Efinite__space__integral(A_27a),V0m),V1f) ) ) ) ) )).
...
fof(ax_thm_2Eprobability_2Eprob__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Eprobability_2Eprob(A_27a) = c_2Emeasure_2Emeasure(A_27a) ) )).

fof(ax_thm_2Eprobability_2Eprob__space__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
         ...
         => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
          <=> ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0p))
              & ap(ap(c_2Emeasure_2Emeasure(A_27a),V0p),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) = ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) ) ) ) ) )).

fof(ax_thm_2Eprobability_2Ereal__random__variable__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0X] :
              ...
              <=> ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V1p))
                  & ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Eprobability_2Ep__space(A_27a),V1p)))
                       => ( ap(V0X,V2x) != c_2Eextreal_2ENegInf
                          & ap(V0X,V2x) != c_2Eextreal_2EPosInf ) ) )
...
fof(ax_thm_2Eprobability_2Eexpectation__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Eprobability_2Eexpectation(A_27a) = c_2Elebesgue_2Eintegral(A_27a) ) )).
...
fof(conj_thm_2Eprobability_2Efinite__expectation1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
