...
thf(conj_thm_2Edivides_2EALL__DIVIDES__0,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Edivides_2Edivides @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )).

thf(conj_thm_2Edivides_2EDIVIDES__TRANS,lemma,(
...
thf(conj_thm_2Edivides_2EDIVIDES__MULT,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2c: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Edivides_2Edivides @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V1b ) ) )
...
thf(conj_thm_2Eint__arith_2Egcd1thm,conjecture,(
