...
fof(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__OPEN,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s] :
             ...
             => ! [V3a] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2EOpen,V2s))
                      ...
                      & p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V3a))) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V1g),ap(c_2Ereal__topology_2Eat,V3a))) ) ) ) ) ) )).
