...
thf(thm_2EternaryComparisons_2Eordering__Axiom,conjecture,(
    ! [A_27a: d,V0x0_2E0: u,V1x1_2E0: u,V2x2_2E0: u] :
    ? [V3f_2E0: u] :
      ( ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2EternaryComparisons_2Eordering @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( i_mono_2Etyop_2EternaryComparisons_2Eordering @ mono_2Ec_2EternaryComparisons_2ELESS ) ) ) )
        = ( s @ A_27a @ V0x0_2E0 ) )
      & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2EternaryComparisons_2Eordering @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( i_mono_2Etyop_2EternaryComparisons_2Eordering @ mono_2Ec_2EternaryComparisons_2EEQUAL ) ) ) )
        = ( s @ A_27a @ V1x1_2E0 ) )
      & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2EternaryComparisons_2Eordering @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( i_mono_2Etyop_2EternaryComparisons_2Eordering @ mono_2Ec_2EternaryComparisons_2EGREATER ) ) ) )
        = ( s @ A_27a @ V2x2_2E0 ) ) ) )).
