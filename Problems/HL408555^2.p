...
thf(conj_thm_2Ebinary__ieee_2Efloat__sub__finite,conjecture,(
    ! [A_27a: del,A_27b: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
     ...
     => ! [V2y: $i] :
         ...
         => ! [V3r1: tp__ty_2Erealax_2Ereal,V4r2: tp__ty_2Erealax_2Ereal] :
             ...
             => ( ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__sub @ A_27a @ A_27b ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ V1x ) @ V2y )
