...
thf(conj_thm_2EHolSmt_2Er164,conjecture,(
    ! [V0u: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2a: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0u ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0u ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) ) ) )).
