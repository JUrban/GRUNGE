    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V2x] :
             ...
             => ap(f3639(V0f,V1g),V2x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V2x)),ap(V1g,V2x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUB,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ELINEAR__EQ__0,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__EQ,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
