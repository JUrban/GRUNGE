...
thf(thm_2EHolSmt_2Et002,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0z: A_27b,V1y: A_27a,V2x: A_27a,V3f: A_27a > A_27b] :
      ( ( V2x = V1y )
      | ( ( V3f @ V1y )
        = ( c_2Ecombin_2EUPDATE @ A_27a @ A_27b @ V2x @ V0z @ V3f @ V1y ) ) ) )).
