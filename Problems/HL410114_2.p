...
tff(tp_c_2Emeasure_2Ecountably__subadditive,type,(
    c_2Emeasure_2Ecountably__subadditive: del > $i )).

tff(mem_c_2Emeasure_2Ecountably__subadditive,axiom,(
    ! [A_27a: del] : mem(c_2Emeasure_2Ecountably__subadditive(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) )).
...
tff(tp_c_2Emeasure_2Esubadditive,type,(
    c_2Emeasure_2Esubadditive: del > $i )).

tff(mem_c_2Emeasure_2Esubadditive,axiom,(
    ! [A_27a: del] : mem(c_2Emeasure_2Esubadditive(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) )).
...
tff(ax_thm_2Emeasure_2Esubadditive__def,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
      ...
      <=> ! [V1s: $i] :
           ...
           => ! [V2t: $i] :
               ...
               => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),V2t))),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V2t)))) ) ) ) ) ) )).

tff(ax_thm_2Emeasure_2Ecountably__subadditive__def,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE__SUBADDITIVE,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
