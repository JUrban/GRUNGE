...
thf(conj_thm_2Etransc_2ELN__INV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eln @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) ) )).
...
thf(conj_thm_2Eutil__prob_2Eneg__logr,conjecture,(
