...
thf(conj_thm_2Etransc_2ETAN__ADD,lemma,(
...
thf(conj_thm_2Etransc_2ETAN__DOUBLE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Ecos @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
         != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
        & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Ecos @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
         != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Etan @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
