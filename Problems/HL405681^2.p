...
thf(conj_thm_2Eoption_2Eoption__CASES,lemma,(
    ! [A_27a: del,V0opt: $i] :
...
thf(conj_thm_2Eordinal_2Eordle__ANTISYM,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2Eordlt__DISCRETE1,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(ax_thm_2Eordinal_2Esup__def,axiom,(
    ! [A_27a: del,V0ordset: $i] :
      ( ( mem @ V0ordset @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ V0ordset )
        = ( ap @ ( c_2Eordinal_2Eoleast @ A_27a )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1a: $i] :
                ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V1a ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) ) @ ( c_2Eordinal_2Epreds @ A_27a ) ) @ V0ordset ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EordEXP__fromNat,lemma,(
...
thf(conj_thm_2Eordinal_2Eislimit__SUC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2Eislimit__fromNat,lemma,(
    ! [A_27a: del,V0x: tp__ty_2Enum_2Enum] :
      ( ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) ) )
        = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
    <=> ( V0x = fo__c_2Enum_2E0 ) ) )).
...
thf(conj_thm_2Eordinal_2EordEXP__ZERO__limit,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0x ) )
          = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
       => ( ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0x )
          = ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).
