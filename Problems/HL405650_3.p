...
tff(thm_2Eordinal_2Eordinal__IVT,conjecture,(
    ! [A_27a: $tType,V0f_2E0: tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a)),V1c_2E0: tyop_2Eordinal_2Eordinal(A_27a),V2a2_2E0: tyop_2Eordinal_2Eordinal(A_27a),V3a1_2E0: tyop_2Eordinal_2Eordinal(A_27a)] :
      ( ( ! [V4a_2E0: tyop_2Eordinal_2Eordinal(A_27a)] :
            ( ( p(c_2Eordinal_2Eordlt_2E2(A_27a,c_2Eordinal_2EfromNat_2E1(A_27a,c_2Enum_2E0_2E0),V4a_2E0))
              & c_2Eordinal_2Eomax_2E1(A_27a,c_2Eordinal_2Epreds_2E1(A_27a,V4a_2E0)) = c_2Eoption_2ENONE_2E0(tyop_2Eordinal_2Eordinal(A_27a)) )
           => app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V4a_2E0) = c_2Eordinal_2Esup_2E1(A_27a,c_2Epred__set_2EIMAGE_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,c_2Eordinal_2Epreds_2E1(A_27a,V4a_2E0))) )
        & ! [V5x_2E0: tyop_2Eordinal_2Eordinal(A_27a),V6y_2E0: tyop_2Eordinal_2Eordinal(A_27a)] :
            ( ~ p(c_2Eordinal_2Eordlt_2E2(A_27a,V6y_2E0,V5x_2E0))
           => ~ p(c_2Eordinal_2Eordlt_2E2(A_27a,app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V6y_2E0),app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V5x_2E0))) )
        & p(c_2Eordinal_2Eordlt_2E2(A_27a,V3a1_2E0,V2a2_2E0))
        & ~ p(c_2Eordinal_2Eordlt_2E2(A_27a,V1c_2E0,app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V3a1_2E0)))
        & p(c_2Eordinal_2Eordlt_2E2(A_27a,V1c_2E0,app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V2a2_2E0))) )
     => ? [V7b_2E0: tyop_2Eordinal_2Eordinal(A_27a)] :
          ( ~ p(c_2Eordinal_2Eordlt_2E2(A_27a,V7b_2E0,V3a1_2E0))
          & p(c_2Eordinal_2Eordlt_2E2(A_27a,V7b_2E0,V2a2_2E0))
          & ~ p(c_2Eordinal_2Eordlt_2E2(A_27a,V1c_2E0,app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,V7b_2E0)))
          & p(c_2Eordinal_2Eordlt_2E2(A_27a,V1c_2E0,app_2E2(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a),V0f_2E0,c_2Eordinal_2EordSUC_2E1(A_27a,V7b_2E0)))) ) ) )).
