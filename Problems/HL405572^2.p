...
thf(ax_thm_2Eordinal_2Eoleast__def,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eordinal_2Eoleast @ A_27a ) @ V0P )
        = ( ap @ ( c_2Emin_2E_40 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V1x ) )
                @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
                  @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
                    @ ^ [V2y: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V2y ) @ V1x ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0P @ V2y ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Equotient_2ERIGHT__RES__FORALL__REGULAR,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1R: $i] :
...
thf(conj_thm_2Eordinal_2Eoleast__intro,conjecture,(
    ! [A_27a: del,V0Q: $i] :
