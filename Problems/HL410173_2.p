...
tff(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__DISJOINT,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA2,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
       => ! [V1s: $i] :
...
tff(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA,conjecture,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1a: $i] :
