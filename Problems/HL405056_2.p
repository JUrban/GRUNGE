...
tff(conj_thm_2EOmega__Automata_2ECO__BUECHI__SUNTIL__CLOSURE,conjecture,(
             ...
             => ! [V3i: $i] :
                 ...
                 => ! [V4Psi: $i] :
                     ...
                     => ! [V5t0: tp__ty_2Enum_2Enum,V6c: $i] :
                          ( mem(V6c,A_27b)
                         => ( p(ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0phi),f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi)),inj__ty_2Enum_2Enum(V5t0)))
                          <=> ? [V12p: $i] :
