...
thf(thm_2Erelation_2ERTC__lifts__invariants,conjecture,(
    ! [A_27a: d,V0R_2E0: u,V1P_2E0: u] :
      ( ! [V2x_2E0: u,V3y_2E0: u] :
     ...
     => ! [V4x_2E0: u,V5y_2E0: u] :
          ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2ERTC_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V5y_2E0 ) ) ) ) )
