...
fof(conj_thm_2Erich__list_2ELASTN__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ! [V2x] :
                    ( mem(V2x,A_27a)
                   => ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),ap(ap(c_2Elist_2ECONS(A_27a),V2x),V1l)) = ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),V1l) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2ELASTN__LENGTH__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Erich__list_2Elist__rel__lastn,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2l2] :
                     ...
                     => ! [V3n] :
                         ...
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3n),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
                           ...
                           => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0f),ap(ap(c_2Erich__list_2ELASTN(A_27a),V3n),V1l1)),ap(ap(c_2Erich__list_2ELASTN(A_27b),V3n),V2l2))) ) ) ) ) ) ) ) )).
