...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__ONE__CASE______FORALL__GAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1Q] :
                 ...
                 => ( ! [V2x] :
                       ...
                       => ? [V3fv] :
                            ( mem(V3fv,A_27b)
                            & V2x = ap(V1Q,V3fv) ) )
                   => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27b,A_27b),V1Q),V0P)) ) ) ) ) ) )).
