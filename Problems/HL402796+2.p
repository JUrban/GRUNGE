...
fof(conj_thm_2Erich__list_2ETAKE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0l] :
            ( mem(V0l,ty_2Elist_2Elist(A_27a))
        ...
        & ! [V1n] :
           ...
           => ! [V2x] :
               ...
               => ! [V3l] :
                    ( mem(V3l,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Elist_2ETAKE(A_27a),ap(c_2Enum_2ESUC,V1n)),ap(ap(c_2Elist_2ECONS(A_27a),V2x),V3l)) = ap(ap(c_2Elist_2ECONS(A_27a),V2x),ap(ap(c_2Elist_2ETAKE(A_27a),V1n),V3l)) ) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2ETAKE__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ! [V2x] :
                    ( mem(V2x,A_27a)
                   => ap(ap(c_2Elist_2ETAKE(A_27a),V0n),ap(ap(c_2Elist_2ESNOC(A_27a),V2x),V1l)) = ap(ap(c_2Elist_2ETAKE(A_27a),V0n),V1l) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EBUTLASTN__TAKE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),V1l) = ap(ap(c_2Elist_2ETAKE(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n)),V1l) ) ) ) ) )).
