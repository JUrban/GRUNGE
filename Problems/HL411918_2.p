...
tff(conj_thm_2Eprim__rec_2Enum__Axiom,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUBSET__ANTISYM__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
       => ap(c_2Ereal__topology_2Eclosure,V0s) = V0s ) ) )).

tff(conj_thm_2Ereal__topology_2ELT__EXISTS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(ax_thm_2Ereal__topology_2Ecompact,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
      ...
      <=> ! [V1f: $i] :
           ...
           => ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1f,inj__ty_2Enum_2Enum(V2n))),V0s))
             => ? [V3l: tp__ty_2Erealax_2Ereal,V4r: $i] :
                  ...
                  & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),V4r)),inj__ty_2Erealax_2Ereal(V3l)),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) )).

tff(ax_thm_2Ereal__topology_2Ecauchy,axiom,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__CAUCHY,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__IMP__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => p(ap(c_2Ereal__topology_2EClosed,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EISOMETRY__ON__IMP__CONTINUOUS__ON,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
         ...
         => ( ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
               ...
               => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V1f,inj__ty_2Erealax_2Ereal(V2x))),ap(V1f,inj__ty_2Erealax_2Ereal(V3y))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3y)))) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1f),V0s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__CONTINUOUS__IMAGE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESETDIST__LE__DIST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESETDIST__EQ__0__SING,lemma,
    ...
    & ! [V2s: $i] :
       ...
       => ! [V3x: tp__ty_2Erealax_2Ereal] :
            ( surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
          <=> ( V2s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              | p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),ap(c_2Ereal__topology_2Eclosure,V2s))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EISOMETRY__IMP__EMBEDDING,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
             ...
             => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s) = V2t
                  & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V1s))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4y)),V1s)) )
                     => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(V0f,inj__ty_2Erealax_2Ereal(V4y))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V4y)))) ) )
               => ? [V5g: $i] :
...
tff(conj_thm_2Ereal__topology_2EISOMETRY__IMP__HOMEOMORPHISM__COMPACT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V1s))
              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)),V1s))
              & ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
                 ...
                 => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),ap(V0f,inj__ty_2Erealax_2Ereal(V3y))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3y)))) ) )
           => ? [V4g: $i] :
                ( mem(V4g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                & p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1s),V1s)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V0f),V4g))) ) ) ) ) )).
