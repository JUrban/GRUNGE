...
tff(conj_thm_2Ereal__topology_2ECARD__STDBASIS,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__SPAN__BOUND,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__BOUND,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Eindependent,V0s))
       => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
