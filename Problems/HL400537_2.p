...
tff(conj_thm_2Eoption_2EOPTREL__MONO,conjecture,(
             ...
             => ! [V3y: $i] :
                 ...
                 => ( ! [V4x: $i] :
                       ...
                       => ! [V5y: $i] :
                           ...
                           => ( p(ap(ap(V0P,V4x),V5y))
                             => p(ap(ap(V1Q,V4x),V5y)) ) ) )
                   => ( p(ap(ap(ap(c_2Eoption_2EOPTREL(A_27a,A_27a),V0P),V2x),V3y))
                     => p(ap(ap(ap(c_2Eoption_2EOPTREL(A_27a,A_27a),V1Q),V2x),V3y)) ) ) ) ) ) ) )).
