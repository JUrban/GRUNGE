...
thf(conj_thm_2Earithmetic_2EONE__ONE__UNBOUNDED,lemma,(
    ! [V0f: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Ebool_2EONE__ONE @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ V0f ) )
       => ! [V1b: tp__ty_2Enum_2Enum] :
          ? [V2n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V1b ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2ENOT__STRICTLY__DECREASING,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ~ ! [V1n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ V0f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
