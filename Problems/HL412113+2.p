...
fof(conj_thm_2Eprobability_2Emarginal__joint__zero3,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                     ...
                                     => ! [V5t] :
                                         ...
                                         => ! [V6u] :
                                             ...
                                             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                                  ...
                                                  & ( ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V4s) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                                                    | ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V5t) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                                                    | ap(ap(ap(c_2Eprobability_2Edistribution(A_27d,A_27d),V0p),V3Z),V6u) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) )
                                               => ap(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution3(A_27b,A_27b,A_27b,A_27b),V0p),V1X),V2Y),V3Z),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V4s),ap(ap(c_2Epred__set_2ECROSS(A_27c,A_27c),V5t),V6u))) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) ) ) ) ) ) ) ) )).
