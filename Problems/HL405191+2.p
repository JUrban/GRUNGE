...
fof(conj_thm_2Efinite__map_2EFUNION__FEMPTY__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0g] :
              ( mem(V0g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V0g) = V0g ) ) ) )).

fof(conj_thm_2Efinite__map_2EFUNION__FEMPTY__2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)) = V0f ) ) ) )).

fof(conj_thm_2Efinite__map_2EFUNION__FUPDATE__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2x] :
                     ...
                     => ! [V3y] :
                          ( mem(V3y,A_27b)
                         => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))),V1g) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)) ) ) ) ) ) ) )).

fof(conj_thm_2Efinite__map_2EFUNION__FUPDATE__2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2x] :
                     ...
                     => ! [V3y] :
                          ( mem(V3y,A_27b)
                         => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1g),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efinite__map_2Efmap(A_27a,A_27a)),ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f))),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g)),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ealist_2Efmap__to__alist__to__fmap,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2Ealist__to__fmap__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),V0l1),V1l2)) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0l1)),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V1l2)) ) ) ) ) )).

fof(conj_thm_2Ealist_2EFUPDATE__LIST__EQ__APPEND__REVERSE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ls] :
              ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
             => ! [V1fm] :
                  ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                 => ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V1fm),V0ls) = ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EREVERSE(ty_2Epair_2Eprod(A_27a,A_27a)),V0ls)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V1fm))) ) ) ) ) )).
