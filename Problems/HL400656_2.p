...
tff(mem_c_2Eposet_2Ecarrier,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Ecarrier(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(A_27a,bool))) )).

tff(tp_c_2Eposet_2Ecomplete,type,(
    c_2Eposet_2Ecomplete: del > $i )).

tff(mem_c_2Eposet_2Ecomplete,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Ecomplete(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) )).

tff(tp_c_2Eposet_2Efunction,type,(
    c_2Eposet_2Efunction: ( del * del ) > $i )).

tff(mem_c_2Eposet_2Efunction,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Eposet_2Efunction(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27b,bool),arr(arr(A_27a,A_27b),bool)))) )).

tff(tp_c_2Eposet_2Eglb,type,(
    c_2Eposet_2Eglb: del > $i )).

tff(mem_c_2Eposet_2Eglb,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Eglb(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),arr(A_27a,bool)))) )).

tff(tp_c_2Eposet_2Elfp,type,(
    c_2Eposet_2Elfp: del > $i )).

tff(mem_c_2Eposet_2Elfp,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Elfp(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,A_27a),arr(A_27a,bool)))) )).

tff(tp_c_2Eposet_2Elub,type,(
    c_2Eposet_2Elub: del > $i )).

tff(mem_c_2Eposet_2Elub,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Elub(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),arr(A_27a,bool)))) )).

tff(tp_c_2Eposet_2Emonotonic,type,(
    c_2Eposet_2Emonotonic: del > $i )).

tff(mem_c_2Eposet_2Emonotonic,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Emonotonic(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,A_27a),bool))) )).

tff(tp_c_2Eposet_2Eposet,type,(
    c_2Eposet_2Eposet: del > $i )).

tff(mem_c_2Eposet_2Eposet,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Eposet(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) )).

tff(tp_c_2Eposet_2Etop,type,(
    c_2Eposet_2Etop: del > $i )).

tff(mem_c_2Eposet_2Etop,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Etop(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(A_27a,bool))) )).
...
tff(ax_thm_2Eposet_2Ecarrier__def,axiom,(
    ! [A_27a: del,V0s: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ap(c_2Eposet_2Ecarrier(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s),V1r)) = V0s ) ) )).
...
tff(conj_thm_2Eposet_2Eposet__antisym,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Eposet_2Eposet__trans,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
          ( mem(V1r,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Eposet_2Ecomplete__top,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
    ...
    ! [A_27a: del,V0s: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( p(ap(ap(c_2Eposet_2Emonotonic(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s),V1r)),V2f))
              <=> ! [V3x: $i] :
                    ( mem(V3x,A_27a)
                   => ! [V4y: $i] :
                        ( mem(V4y,A_27a)
    ...
    ! [A_27a: del,V0s: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ( p(ap(ap(ap(c_2Eposet_2Elfp(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0s),V1r)),V2f),V3x))
                  <=> ( p(ap(V0s,V3x))
                      & ap(V2f,V3x) = V3x
                      & ! [V4y: $i] :
                          ( mem(V4y,A_27a)
...
tff(conj_thm_2Eposet_2Eknaster__tarski__lfp,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
