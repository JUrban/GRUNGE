...
thf(conj_thm_2Eproduct_2ENPRODUCT__DELTA,conjecture,(
    ! [A_27a: del,V0b: tp__ty_2Enum_2Enum,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
     => ! [V2a: $i] :
          ( ( mem @ V2a @ A_27a )
         => ( ( surj__ty_2Enum_2Enum
              @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V1s )
                @ ( lam @ A_27a
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V3x ) @ V2a ) ) @ ( inj__ty_2Enum_2Enum @ V0b ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2a ) @ V1s ) ) @ ( inj__ty_2Enum_2Enum @ V0b ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
