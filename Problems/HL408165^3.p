...
thf(thm_2Epoly_2EPOLY__ADD__CLAUSES,axiom,(
    ! [V0t2: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V1t1: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V2p2: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V3p1: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V4h2: tyop_2Erealax_2Ereal,V5h1: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epoly_2Epoly__add @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) @ V2p2 )
        = V2p2 )
      & ( ( c_2Epoly_2Epoly__add @ V3p1 @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) )
        = V3p1 )
      & ( ( c_2Epoly_2Epoly__add @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V5h1 @ V1t1 ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V4h2 @ V0t2 ) )
        = ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__add @ V5h1 @ V4h2 ) @ ( c_2Epoly_2Epoly__add @ V1t1 @ V0t2 ) ) ) ) )).

thf(thm_2Epoly_2EPOLY__MUL__CLAUSES,axiom,(
    ! [V0t1: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V1p2: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V2k1: tyop_2Erealax_2Ereal,V3h1: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) @ V1p2 )
        = ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) )
      & ( ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V3h1 @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) @ V1p2 )
        = ( c_2Epoly_2E_23_23 @ V3h1 @ V1p2 ) )
      & ( ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V3h1 @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V2k1 @ V0t1 ) ) @ V1p2 )
        = ( c_2Epoly_2Epoly__add @ ( c_2Epoly_2E_23_23 @ V3h1 @ V1p2 ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V2k1 @ V0t1 ) @ V1p2 ) ) ) ) ) )).
...
thf(thm_2Epoly_2EPOLY__LINEAR__REM,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1t: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V2h: tyop_2Erealax_2Ereal] :
    ? [V3q: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V4r: tyop_2Erealax_2Ereal] :
      ( ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V2h @ V1t )
      = ( c_2Epoly_2Epoly__add @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V4r @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) @ ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V0a ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) @ V3q ) ) ) )).
