...
tff(ax_thm_2Ewellorder_2Efinite__def,axiom,(
    ! [A_27a: del,V0w: $i] :
...
tff(conj_thm_2Ewellorder_2Efinite__wZERO,conjecture,(
    ! [A_27a: del] : p(ap(c_2Ewellorder_2Efinite(A_27a),c_2Ewellorder_2EwZERO(A_27a))) )).
