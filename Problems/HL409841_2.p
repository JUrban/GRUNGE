...
tff(conj_thm_2Eiterate_2EITERATE__BIJECTION,lemma,(
...
tff(lmtp_f3333,type,(
    f3333: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3333,axiom,(
    ! [A_27a: del,A_27a: del,V4y: $i] :
      ( mem(V4y,A_27a)
     => ! [V1p: $i] :
...
tff(conj_thm_2Eiterate_2ESUM__BIJECTION,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: $i] :
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V0f),V1p))) ) ) ) ) )).
