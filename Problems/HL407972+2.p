...
fof(lameq_f2869,axiom,(
    ! [V0x] :
     ...
     => ! [V2n] :
         ...
         => ap(f2869(V0x),V2n) = ap(c_2Erealax_2Einv,ap(V0x,V2n)) ) ) )).

fof(conj_thm_2Eseq_2ESEQ__INV,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0] :
          ( mem(V1x0,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0x),V1x0))
           ...
           => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2869(V0x)),ap(c_2Erealax_2Einv,V1x0))) ) ) ) )).
