...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__LEFT__EQ,axiom,(
      ...
      ( ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal,V4y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V3x )
              = ( V0f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V1s ) @ V2t )
        = ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ V2t ) ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__RIGHT__EQ,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal,V4y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V3x )
              = ( V0f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V2t ) )
        = ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ V2t ) ) ) )).
