...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__DELETE,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ebag_2EBIG__BAG__UNION__DELETE,conjecture,(
    ! [A_27a: del,V0sob: $i] :
      ( ( mem @ V0sob @ ( arr @ ( arr @ A_27a @ ty_2Enum_2Enum ) @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0sob ) )
           => ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0sob ) @ V1b ) )
              = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V1b ) @ V0sob ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V0sob ) ) @ V1b ) ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V0sob ) ) ) ) ) ) )).
