...
fof(conj_thm_2Epred__set_2EDISJOINT__DIFFS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g] :
...
fof(conj_thm_2Emeasure_2ECOUNTABLY__ADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EMEASURE__COUNTABLE__INCREASING,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
