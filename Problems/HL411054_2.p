...
tff(lmtp_f3611,type,(
    f3611: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3611,axiom,(
...
tff(conj_thm_2Ereal__topology_2EBIGUNION__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lmtp_f3815,type,(
    f3815: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3815,axiom,(
    ! [V1e: tp__ty_2Erealax_2Ereal] : mem(f3815(V1e),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

tff(lameq_f3815,axiom,(
    ! [V1e: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3815(V1e),inj__ty_2Erealax_2Ereal(V3x)) = ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V1e))) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__IMP__TOTALLY__BOUNDED,lemma,(
    ! [V0s: $i] :
     ...
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => ! [V1e: tp__ty_2Erealax_2Ereal] :
           ...
           => ? [V2k: $i] :
                ...
                & p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V2k))
                & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2k),V0s))
                & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3815(V1e)),V2k)))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EHEINE__BOREL__LEMMA,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => ! [V1t: $i] :
            ( mem(V1t,arr(arr(ty_2Erealax_2Ereal,bool),bool))
           => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V1t)))
                & ! [V2b: $i] :
                    ( mem(V2b,arr(ty_2Erealax_2Ereal,bool))
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2b),V1t))
                     => p(ap(c_2Ereal__topology_2EOpen,V2b)) ) ) )
             => ? [V3e: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ! [V4x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ? [V5b: $i] :
                          ( mem(V5b,arr(ty_2Erealax_2Ereal,bool))
                          & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V5b),V1t))
                          & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),inj__ty_2Erealax_2Ereal(V3e)))),V5b)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__IMP__HEINE__BOREL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => ! [V1f: $i] :
