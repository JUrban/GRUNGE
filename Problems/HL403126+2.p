...
fof(lameq_f932,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f932(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,f889(V0a)),V1b),V2t0))),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESUNTIL__AS__SBEFORE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
