...
thf(f13511_0_2E0,type,(
    f13511_0_2E0: u )).

thf(f13511_0_2E2,type,(
    f13511_0_2E2: du > du > u )).

thf(f13511_0_2E3,type,(
    f13511_0_2E3: du > du > du > u )).

thf(f13527_0_2E0,type,(
    f13527_0_2E0: u )).

thf(f13527_0_2E1,type,(
    f13527_0_2E1: du > u )).

thf(f13527_0_2E2,type,(
    f13527_0_2E2: du > du > u )).
...
thf(mono_2Ef13511_0,type,(
    mono_2Ef13511_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13527_0,type,(
    mono_2Ef13527_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ereal__topology_2ESUBTOPOLOGY__UNIV,axiom,(
    ! [A_27a: d,V0top_2E0: u] :
      ( ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( c_2Ereal__topology_2Esubtopology_2E2 @ ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ V0top_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EUNIV_2E0 ) ) )
      = ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ V0top_2E0 ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__IN,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
      = ( mono_2Ec_2Etopology_2Eclosed__in_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eeuclidean @ V0s ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13527_0 @ V0a @ V2y )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V0a @ V2y ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ ( mono_2Ef13527_0 @ V0a ) @ V1s ) )).

thf(def0_2Ethm_2Ereal__topology_2ECLOSED__INTERVAL__LEFT,axiom,(
...
thf(thm_2Ereal__topology_2ECLOSED__INTERVAL__LEFT,axiom,(
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__HALFSPACE__LE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13511_0 @ V0a @ V1b @ V2x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V2x @ ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__HALFSPACE__LE,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13511_0 @ V0a @ V1b ) ) ) )).
