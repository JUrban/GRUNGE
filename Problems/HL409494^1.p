...
thf(thm_2Etransc_2ELN__INV,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Etransc_2Eln @ ( mono_2Ec_2Erealax_2Einv @ V0x ) )
        = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Etransc_2Eln @ V0x ) ) ) ) )).
...
thf(thm_2Eutil__prob_2Elg__inv,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x )
     => ( ( mono_2Ec_2Eutil__prob_2Elg @ ( mono_2Ec_2Erealax_2Einv @ V0x ) )
        = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Eutil__prob_2Elg @ V0x ) ) ) ) )).
