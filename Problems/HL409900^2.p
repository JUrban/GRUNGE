...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,conjecture,(
    ! [V0P: $i] :
                 ...
                 => ( ( ( p @ ( ap @ V0P @ V4p ) )
                   ...
                   => ( p
                      @ ( ap @ V0P
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V6x: $i] :
                              ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V4p @ V6x ) ) @ ( ap @ V5q @ V6x ) ) ) ) ) ) ) )
          & ! [V7p: $i] :
                 ...
                 => ( ( ( p @ ( ap @ V0P @ V7p ) )
                   ...
                   => ( p
                      @ ( ap @ V0P
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V9x: $i] :
                              ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V7p @ V9x ) ) @ ( ap @ V8q @ V9x ) ) ) ) ) ) ) ) )
       => ! [V10p: $i] :
