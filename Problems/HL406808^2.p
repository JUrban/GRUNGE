...
thf(tp_c_2Etc_2ERELN__TO__FMAP,type,(
    c_2Etc_2ERELN__TO__FMAP: del > $i )).

thf(mem_c_2Etc_2ERELN__TO__FMAP,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Etc_2EFMAP__TO__RELN,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ( ( ap @ ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ V0f ) @ V1x )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V1x ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ ( arr @ A_27a @ bool ) ) @ V0f ) ) ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ ( arr @ A_27a @ bool ) ) @ V0f ) @ V1x ) ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) )).

thf(ax_thm_2Etc_2ERELN__TO__FMAP,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( ap @ ( c_2Etc_2ERELN__TO__FMAP @ A_27a ) @ V0R )
        = ( ap @ ( ap @ ( c_2Efinite__map_2EFUN__FMAP @ A_27a @ ( arr @ A_27a @ bool ) ) @ V0R ) @ ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) ) ) ) )).

thf(conj_thm_2Etc_2EFDOM__RDOM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) ) )
       => ( ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( c_2Etc_2ERELN__TO__FMAP @ A_27a ) @ V0R ) )
          = ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) ) ) ) )).

thf(conj_thm_2Etc_2ERELN__TO__FMAP__TO__RELN__ID,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) ) )
       => ( ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ ( ap @ ( c_2Etc_2ERELN__TO__FMAP @ A_27a ) @ V0R ) )
          = V0R ) ) ) )).
