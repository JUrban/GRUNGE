...
fof(conj_thm_2Epred__set_2ECOUNTABLE__ALT__BIJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Eextreal_2ECROSS__COUNTABLE__UNIV,lemma,(
...
fof(conj_thm_2Eextreal_2ECROSS__COUNTABLE__LEMMA1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eextreal_2ECROSS__COUNTABLE__LEMMA2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0t] :
             ...
             => ! [V1s] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2Ecountable(A_27a),V1s))
                      & p(ap(c_2Epred__set_2Ecountable(A_27b),V0t))
                      & p(ap(c_2Epred__set_2EFINITE(A_27b),V0t)) )
                   => p(ap(c_2Epred__set_2Ecountable(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V1s),V0t))) ) ) ) ) ) )).

fof(conj_thm_2Eextreal_2ECROSS__COUNTABLE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
