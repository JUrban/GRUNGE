...
thf(thm_2EDecode_2Edec2enc__decode__unit,conjecture,(
    ! [V0p: tyop_2Eone_2Eone > $o,V1x: tyop_2Eone_2Eone] :
      ( ( V0p @ V1x )
     => ( ( c_2EDecode_2Edec2enc @ tyop_2Eone_2Eone @ ( c_2EDecode_2Edecode__unit @ V0p ) @ V1x )
        = ( c_2EEncode_2Eencode__unit @ V1x ) ) ) )).
