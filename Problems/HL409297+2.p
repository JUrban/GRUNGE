...
fof(lamtp_f3223,axiom,(
    ! [A_27a,A_27b] : mem(f3223(A_27a,A_27b),arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)))) )).
...
fof(conj_thm_2Elift__ieee_2Eis__finite__closest,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Erealax_2Ereal)
                 => p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),ap(c_2Epred__set_2EGSPEC(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3223(A_27a,A_27b))),V1x))) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Efloat__round__finite,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0b] :
             ...
             => ! [V1x] :
                 ...
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,V1x)),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
                   => p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0b),V1x))) ) ) ) ) ) )).
