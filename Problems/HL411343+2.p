...
fof(lamtp_f3354,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3354(A_27a,V0f,V1g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3354,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3354(A_27a,V0f,V1g),V3x) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

fof(lamtp_f3361,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__CONST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ADD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V1g] :
             ...
             => ! [V2net] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V0f),V2net))
                   ...
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3354(A_27a,V0f,V1g)),V2net)) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__SUB,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__ID,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),i(ty_2Erealax_2Ereal)),ap(c_2Ereal__topology_2Eat,V0a))) ) )).
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE__EQ,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(lamtp_f3921,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V2f] :
          ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3921(V0a,V2f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3921,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V2f] :
          ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x] :
             ...
             => ap(f3921(V0a,V2f),V3x) = ap(V2f,ap(ap(c_2Erealax_2Ereal__add,V0a),V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__TRANSLATION,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1z] :
         ...
         => ! [V2f] :
              ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V2f),ap(c_2Ereal__topology_2Eat,ap(ap(c_2Erealax_2Ereal__add,V0a),V1z))))
              <=> p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3921(V0a,V2f)),ap(c_2Ereal__topology_2Eat,V1z))) ) ) ) ) )).
