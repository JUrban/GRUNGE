...
tff(conj_thm_2Eordinal_2Eordlt__CANCEL__ADDR,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EleqLEFT__CANCEL,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eordinal_2Eordlt__EXISTS__ADD,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Eordinal_2Eordinal(A_27a))
