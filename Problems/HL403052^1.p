...
thf(thm_2ETemporal__Logic_2EWATCH__EXISTS,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1t0: mono_2Etyop_2Enum_2Enum] :
    ? [V2q: mono_2Etyop_2Enum_2Enum > $o] :
      ( mono_2Ec_2ETemporal__Logic_2EWATCH @ V2q @ V0b @ V1t0 ) )).
