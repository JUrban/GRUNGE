...
thf(thm_2Epred__set_2ESUM__IMAGE__lower__bound,conjecture,(
    ! [A_27a: d,V0f_2E0: u,V1s_2E0: u] :
     ...
     => ! [V2n: mono_2Etyop_2Enum_2Enum] :
          ( ! [V3x_2E0: u] :
             ...
             => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) )
         => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2E_2A @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ECARD_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) @ V2n ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) ) ) )).
