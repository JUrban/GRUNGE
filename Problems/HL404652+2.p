...
fof(conj_thm_2Efinite__map_2ESTRONG__DRESTRICT__FUPDATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2x] :
                     ...
                     => ! [V3y] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1r))
                           => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))),V1r) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V1r),V2x))),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)) ) ) ) ) ) ) ) )).
