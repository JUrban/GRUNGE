      ...
      @ ( c_2Emin_2E_40 @ ( tyop_2Enum_2Enum > tyop_2Enum_2Enum > $o )
        @ ^ [V0R: tyop_2Enum_2Enum > tyop_2Enum_2Enum > $o] :
            ...
            @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
              @ ^ [V1n: tyop_2Enum_2Enum] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V1n @ c_2Enum_2E0 ) ) @ ( V0R @ ( c_2Earithmetic_2EDIV @ ( c_2Earithmetic_2E_2D @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V1n ) ) ) ) )
      @ ^ [V2lrnext: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V3a: tyop_2Enum_2Enum] :
          ( c_2Ecombin_2EI @ tyop_2Enum_2Enum @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V3a @ c_2Enum_2E0 ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( V2lrnext @ ( c_2Earithmetic_2EDIV @ ( c_2Earithmetic_2E_2D @ V3a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).

thf(thm_2Esptree_2Elrnext__def,conjecture,(
    ! [V0n: tyop_2Enum_2Enum] :
