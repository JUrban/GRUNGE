...
fof(conj_thm_2Ereal_2ENUM__FLOOR__LE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2ENUM__FLOOR__DIV__LOWERBOUND,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eutil__prob_2EREAL__LT__LE__MUL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Elebesgue_2Elemma__fn__3,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
