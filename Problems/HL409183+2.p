...
fof(conj_thm_2Epred__set_2EINSERT__INTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(lamtp_f3178,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3178(A_27a,V1f),arr(A_27a,bool)) ) )).
...
fof(lameq_f3178,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V2p] :
          ( mem(V2p,A_27a)
         => ap(f3178(A_27a,V1f),V2p) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V2p)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) )).

fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__INTER__NONZERO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
         ...
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
           => ! [V1f] :
                ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
               => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),ap(ap(c_2Epred__set_2EINTER(A_27a),V0P),f3178(A_27a,V1f))) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0P) ) ) ) ) )).
