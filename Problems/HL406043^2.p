...
thf(conj_thm_2Ewords_2EWORD__NEG__RMUL,lemma,(
    ! [A_27a: del,V0v: $i] :
...
thf(conj_thm_2Ewords_2EWORD__2COMP__LSL,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V1a ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) )
        = ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V1a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).
