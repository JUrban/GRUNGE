...
thf(thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT__EQ,axiom,(
    ...
    <=> ! [V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ( ( c_2Ereal__topology_2Econtinuous__on @ V1f @ V0s )
            & ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1f @ V0s ) ) )
...
thf(thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econnected @ V1s )
        ...
        & ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) )
     => ? [V2a: tyop_2Erealax_2Ereal] :
        ! [V3x: tyop_2Erealax_2Ereal] :
