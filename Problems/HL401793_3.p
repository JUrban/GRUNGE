...
tff(arityeq2_2Ec_2Epred__set_2Epairwise_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: $tType,X0_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),X1_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] : c_2Epred__set_2Epairwise_2E2(A_27a,X0_2E0,X1_2E0) = app_2E2(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool,app_2E2(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),c_2Epred__set_2Epairwise_2E0(A_27a),X0_2E0),X1_2E0) )).
...
tff(thm_2Epred__set_2Epairwise__def,axiom,(
    ! [A_27a: $tType,V0P_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V1s_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] :
      ( p(c_2Epred__set_2Epairwise_2E2(A_27a,V0P_2E0,V1s_2E0))
    <=> ! [V2e1_2E0: A_27a,V3e2_2E0: A_27a] :
          ( ( p(c_2Ebool_2EIN_2E2(A_27a,V2e1_2E0,V1s_2E0))
            & p(c_2Ebool_2EIN_2E2(A_27a,V3e2_2E0,V1s_2E0)) )
         => p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0,V2e1_2E0),V3e2_2E0)) ) ) )).
...
tff(thm_2Epred__set_2Epairwise__UNION,conjecture,(
    ! [A_27a: $tType,V0s2_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s1_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2R_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))] :
      ( p(c_2Epred__set_2Epairwise_2E2(A_27a,V2R_2E0,c_2Epred__set_2EUNION_2E2(A_27a,V1s1_2E0,V0s2_2E0)))
    <=> ( p(c_2Epred__set_2Epairwise_2E2(A_27a,V2R_2E0,V1s1_2E0))
        & p(c_2Epred__set_2Epairwise_2E2(A_27a,V2R_2E0,V0s2_2E0))
        & ! [V3x_2E0: A_27a,V4y_2E0: A_27a] :
            ( ( p(c_2Ebool_2EIN_2E2(A_27a,V3x_2E0,V1s1_2E0))
              & p(c_2Ebool_2EIN_2E2(A_27a,V4y_2E0,V0s2_2E0)) )
           => ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2R_2E0,V3x_2E0),V4y_2E0))
              & p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2R_2E0,V4y_2E0),V3x_2E0)) ) ) ) ) )).
