...
tff(conj_thm_2Efinite__map_2EFUNION__FEMPTY__2,lemma,(
...
tff(conj_thm_2Efinite__map_2EFUNION__FUPDATE__2,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__APPEND,lemma,(
...
tff(conj_thm_2Ealist_2EFUPDATE__LIST__EQ__APPEND__REVERSE,conjecture,(
