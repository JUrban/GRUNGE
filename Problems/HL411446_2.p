...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__RANGE,lemma,(
    ! [V0f: $i] :
        ...
        <=> ! [V2e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V3d: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ! [V4x_27: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V4x_27)),inj__ty_2Erealax_2Ereal(V1x)))),inj__ty_2Erealax_2Ereal(V3d)))
                     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V4x_27))),ap(V0f,inj__ty_2Erealax_2Ereal(V1x))))),inj__ty_2Erealax_2Ereal(V2e))) ) ) ) ) ) )).

tff(lmtp_f3939,type,(
    f3939: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3939,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3939(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3939,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3939(V0a),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V2x))) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3939(V0a)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x)))) )).
