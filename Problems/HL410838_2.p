...
tff(lmtp_f3727,type,(
    f3727: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3727,axiom,(
    ! [V1v: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : mem(f3727(V1v,V0a,V2b),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3727,axiom,(
    ! [V1v: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] : ap(f3727(V1v,V0a,V2b),inj__ty_2Erealax_2Ereal(V3c)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V3c))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V0a))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3c)),inj__ty_2Erealax_2Ereal(V1v)))) )).

tff(lmtp_f3726,type,(
    f3726: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3726,axiom,(
    ! [V1v: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal] : mem(f3726(V1v,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3726,axiom,(
    ! [V1v: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : ap(f3726(V1v,V0a),inj__ty_2Erealax_2Ereal(V2b)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2b)),ap(c_2Ebool_2E_3F(ty_2Erealax_2Ereal),f3727(V1v,V0a,V2b))) )).

tff(ax_thm_2Ereal__topology_2Ein__direction,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1v: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Ein__direction,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1v))) = surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0a))),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3726(V1v,V0a)))) )).
...
tff(conj_thm_2Ereal__topology_2EIN__DIRECTION,conjecture,(
