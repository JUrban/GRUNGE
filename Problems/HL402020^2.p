...
thf(ax_thm_2Erelation_2EWeakOrder,axiom,(
    ! [A_27g: del,V0Z: $i] :
     ...
     => ( ( ap @ ( c_2Eset__relation_2ERRUNIV @ A_27a ) @ V0s )
        = ( lam @ A_27a
          @ ^ [V1x: $i] :
              ( lam @ A_27a
              @ ^ [V2y: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V1x ) @ V0s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2y ) @ V0s ) ) ) ) ) ) )).
            ...
            = ( ap @ ( ap @ ( c_2Erelation_2ERUNION @ A_27a @ A_27a ) @ V0R )
              @ ( lam @ A_27a
                @ ^ [V2x: $i] :
                    ( lam @ A_27a
                    @ ^ [V3y: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V2x ) @ V3y ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ V1s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Epartial__order__reln__to__rel__conv,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
