...
fof(mem_c_2Epair_2ESWAP,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Epair_2ESWAP(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
fof(ax_thm_2Epair_2ESWAP__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0a] :
              ( mem(V0a,ty_2Epair_2Eprod(A_27b,A_27b))
             => ap(c_2Epair_2ESWAP(A_27a,A_27a),V0a) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(c_2Epair_2ESND(A_27b,A_27b),V0a)),ap(c_2Epair_2EFST(A_27b,A_27b),V0a)) ) ) ) )).
...
fof(conj_thm_2Eset__relation_2Etc__SWAP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
...
fof(conj_thm_2Eset__relation_2Eacyclic__SWAP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
fof(conj_thm_2Eset__relation_2Eminimal__elements__SWAP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0xs] :
...
fof(conj_thm_2Eset__relation_2Efinite__acyclic__has__minimal__path,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Eset__relation_2Efinite__acyclic__has__maximal__path,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
