...
tff(conj_thm_2Erich__list_2EALL__DISTINCT__MEM__ZIP__MAP,conjecture,(
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2ls: $i] :
             ...
             => ( p(ap(c_2Elist_2EALL__DISTINCT(A_27a),V2ls))
               => ( p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),V1x),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V2ls),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2ls))))))
                <=> ( p(ap(ap(c_2Ebool_2EIN(A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V1x)),ap(c_2Elist_2ELIST__TO__SET(A_27a),V2ls)))
                    & ap(c_2Epair_2ESND(A_27a,A_27a),V1x) = ap(V0f,ap(c_2Epair_2EFST(A_27a,A_27a),V1x)) ) ) ) ) ) ) )).
