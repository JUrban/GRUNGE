...
tff(ax_thm_2EDeepSyntax_2EAset__def,axiom,
    ( ! [V0pos: tp__o,V1f1: tp__ty_2EDeepSyntax_2Edeep__form,V2f2: tp__ty_2EDeepSyntax_2Edeep__form] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V0pos)),ap(ap(c_2EDeepSyntax_2EConjn,inj__ty_2EDeepSyntax_2Edeep__form(V1f1)),inj__ty_2EDeepSyntax_2Edeep__form(V2f2))) = ap(ap(c_2Epred__set_2EUNION(ty_2Einteger_2Eint),ap(ap(c_2EDeepSyntax_2EAset,inj__o(V0pos)),inj__ty_2EDeepSyntax_2Edeep__form(V1f1))),ap(ap(c_2EDeepSyntax_2EAset,inj__o(V0pos)),inj__ty_2EDeepSyntax_2Edeep__form(V2f2)))
    & ! [V3pos: tp__o,V4f1: tp__ty_2EDeepSyntax_2Edeep__form,V5f2: tp__ty_2EDeepSyntax_2Edeep__form] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V3pos)),ap(ap(c_2EDeepSyntax_2EDisjn,inj__ty_2EDeepSyntax_2Edeep__form(V4f1)),inj__ty_2EDeepSyntax_2Edeep__form(V5f2))) = ap(ap(c_2Epred__set_2EUNION(ty_2Einteger_2Eint),ap(ap(c_2EDeepSyntax_2EAset,inj__o(V3pos)),inj__ty_2EDeepSyntax_2Edeep__form(V4f1))),ap(ap(c_2EDeepSyntax_2EAset,inj__o(V3pos)),inj__ty_2EDeepSyntax_2Edeep__form(V5f2)))
    & ! [V6pos: tp__o,V7f: tp__ty_2EDeepSyntax_2Edeep__form] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V6pos)),ap(c_2EDeepSyntax_2ENegn,inj__ty_2EDeepSyntax_2Edeep__form(V7f))) = ap(ap(c_2EDeepSyntax_2EAset,ap(c_2Ebool_2E_7E,inj__o(V6pos))),inj__ty_2EDeepSyntax_2Edeep__form(V7f))
    & ! [V8pos: tp__o,V9b: tp__o] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V8pos)),ap(c_2EDeepSyntax_2EUnrelatedBool,inj__o(V9b))) = c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint)
    & ! [V10pos: tp__o,V11i: tp__ty_2Einteger_2Eint] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V10pos)),ap(c_2EDeepSyntax_2ExLT,inj__ty_2Einteger_2Eint(V11i))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Einteger_2Eint,bool)),inj__o(V10pos)),ap(ap(c_2Epred__set_2EINSERT(ty_2Einteger_2Eint),inj__ty_2Einteger_2Eint(V11i)),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint))),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint))
    & ! [V12pos: tp__o,V13i: tp__ty_2Einteger_2Eint] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V12pos)),ap(c_2EDeepSyntax_2ELTx,inj__ty_2Einteger_2Eint(V13i))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Einteger_2Eint,bool)),inj__o(V12pos)),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint)),ap(ap(c_2Epred__set_2EINSERT(ty_2Einteger_2Eint),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V13i)),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint)))
    & ! [V14pos: tp__o,V15i: tp__ty_2Einteger_2Eint] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V14pos)),ap(c_2EDeepSyntax_2ExEQ,inj__ty_2Einteger_2Eint(V15i))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Einteger_2Eint,bool)),inj__o(V14pos)),ap(ap(c_2Epred__set_2EINSERT(ty_2Einteger_2Eint),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V15i)),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint))),ap(ap(c_2Epred__set_2EINSERT(ty_2Einteger_2Eint),inj__ty_2Einteger_2Eint(V15i)),c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint)))
    & ! [V16pos: tp__o,V17i1: tp__ty_2Einteger_2Eint,V18i2: tp__ty_2Einteger_2Eint] : ap(ap(c_2EDeepSyntax_2EAset,inj__o(V16pos)),ap(ap(c_2EDeepSyntax_2ExDivided,inj__ty_2Einteger_2Eint(V17i1)),inj__ty_2Einteger_2Eint(V18i2))) = c_2Epred__set_2EEMPTY(ty_2Einteger_2Eint) )).

tff(conj_thm_2EDeepSyntax_2Ein__aset,conjecture,(
    ! [V0pos: tp__o,V1f1: tp__ty_2EDeepSyntax_2Edeep__form,V2f2: tp__ty_2EDeepSyntax_2Edeep__form,V3P: $i] :
     ...
     => ! [V4f: tp__ty_2EDeepSyntax_2Edeep__form,V5a0: tp__o,V6i: tp__ty_2Einteger_2Eint,V7i1: tp__ty_2Einteger_2Eint,V8i2: tp__ty_2Einteger_2Eint] :
