...
tff(mem_c_2Ecombin_2ECOMM,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ecombin_2ECOMM(A_27a,A_27a),arr(arr(A_27a,arr(A_27a,A_27b)),bool)) )).
...
tff(conj_thm_2Erich__list_2ECOMM__ASSOC__FOLDR__REVERSE,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27a,A_27a)))
     => ( p(ap(c_2Ecombin_2ECOMM(A_27a,A_27a),V0f))
       => ( p(ap(c_2Ecombin_2EASSOC(A_27a),V0f))
