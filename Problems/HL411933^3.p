...
thf(thm_2Ereal__topology_2ELOCALLY__OPEN__MAP__IMAGE,conjecture,(
    ! [V0P: ( tyop_2Erealax_2Ereal > $o ) > $o,V1Q: ( tyop_2Erealax_2Ereal > $o ) > $o,V2f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V2f @ V3s )
        & ! [V4t: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3s ) @ V4t )
           => ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2f @ V3s ) ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2f @ V4t ) ) )
        & ! [V5t: tyop_2Erealax_2Ereal > $o] :
            ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V5t @ V3s )
              & ( V0P @ V5t ) )
           => ( V1Q @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2f @ V5t ) ) )
        & ( c_2Ereal__topology_2Elocally @ V0P @ V3s ) )
     => ( c_2Ereal__topology_2Elocally @ V1Q @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2f @ V3s ) ) ) )).
