...
thf(conj_thm_2Ereal__topology_2ELIM__NEG__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__INCREASING__CONVERGENT,lemma,(
    ! [V0s: $i] :
     ...
     => ( ( ( p
            @ ( ap @ c_2Ereal__topology_2Ebounded__def
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V1n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ V0s @ V1n ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V1n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )
          & ! [V2n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( ap @ V0s @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) )
       => ? [V3l: tp__ty_2Erealax_2Ereal] :
            ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ c_2Ereal__topology_2Esequentially ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__DECREASING__CONVERGENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( ( p
            @ ( ap @ c_2Ereal__topology_2Ebounded__def
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V1n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ V0s @ V1n ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V1n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )
          & ! [V2n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0s @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) )
       => ? [V3l: tp__ty_2Erealax_2Ereal] :
            ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ c_2Ereal__topology_2Esequentially ) ) ) ) )).
