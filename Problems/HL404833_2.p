...
tff(conj_thm_2Efinite__map_2EFRANGE__FUPDATE__LIST__SUBSET,lemma,(
...
tff(conj_thm_2Efinite__map_2EIN__FRANGE__FUPDATE__LIST__suff,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ! [V2ls: $i] :
              ( mem(V2ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b)))
             => ( ( ! [V3v: $i] :
                      ( mem(V3v,A_27a)
                  ...
                  & ! [V4v: $i] :
                      ( mem(V4v,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4v),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),c_2Epair_2ESND(A_27b,A_27b)),V2ls))))
                       => p(ap(V1P,V4v)) ) ) )
               => ! [V5v: $i] :
                    ( mem(V5v,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V5v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27b,A_27b),V0fm),V2ls))))
                     => p(ap(V1P,V5v)) ) ) ) ) ) ) )).
