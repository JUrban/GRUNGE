...
fof(conj_thm_2Ereal__topology_2ELIM__NULL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ELIM__AT__ZERO,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__LIM__0,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(c_2Ereal__topology_2Eat,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__AT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
