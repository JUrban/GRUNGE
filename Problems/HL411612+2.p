...
fof(conj_thm_2Ereal__topology_2ELIM__NEG__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
         ...
         => ! [V1f] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3743(A_27a,V1f)),ap(c_2Erealax_2Ereal__neg,V2l)),V0net))
...
fof(lameq_f3997,axiom,(
    ! [V0s] :
     ...
     => ! [V1n] :
         ...
         => ap(f3997(V0s),V1n) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0s,V1n)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1n),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOUNDED__INCREASING__CONVERGENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3997(V0s))))
          & ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,V2n)),ap(V0s,ap(c_2Enum_2ESUC,V2n)))) ) )
       => ? [V3l] :
            ( mem(V3l,ty_2Erealax_2Ereal)
            & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0s),V3l),c_2Ereal__topology_2Esequentially)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOUNDED__DECREASING__CONVERGENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3997(V0s))))
          & ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,ap(c_2Enum_2ESUC,V2n))),ap(V0s,V2n))) ) )
       => ? [V3l] :
            ( mem(V3l,ty_2Erealax_2Ereal)
            & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0s),V3l),c_2Ereal__topology_2Esequentially)) ) ) ) )).
