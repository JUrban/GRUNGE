...
thf(c_2Efmaptree_2Eitem_2E0,type,(
    c_2Efmaptree_2Eitem_2E0: u )).

thf(c_2Efmaptree_2Eitem_2E1,type,(
...
thf(arityeq1_2Emono_2Ec_2Efmaptree_2Eitem_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( c_2Efmaptree_2Eitem_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ A_27b ) @ c_2Efmaptree_2Eitem_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Efmaptree_2Emap_2E1_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) @ ( c_2Efmaptree_2Emap_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) ) @ c_2Efmaptree_2Emap_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Efmaptree_2EFTNode__11,axiom,(
    ! [A_27a: d,A_27b: d,V0i2_2E0: u,V1i1_2E0: u,V2f2_2E0: u,V3f1_2E0: u] :
      ( ( ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ ( c_2Efmaptree_2EFTNode_2E2 @ ( s @ A_27b @ V1i1_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ V3f1_2E0 ) ) )
        = ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ ( c_2Efmaptree_2EFTNode_2E2 @ ( s @ A_27b @ V0i2_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ V2f2_2E0 ) ) ) )
    <=> ( ( ( s @ A_27b @ V1i1_2E0 )
          = ( s @ A_27b @ V0i2_2E0 ) )
        & ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ V3f1_2E0 )
          = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ V2f2_2E0 ) ) ) ) )).

thf(thm_2Efmaptree_2Eitem__map__def,axiom,(
    ! [A_27a: d,A_27b: d,V0ft_2E0: u] :
      ( ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 )
      = ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ ( c_2Efmaptree_2EFTNode_2E2 @ ( s @ A_27b @ ( c_2Efmaptree_2Eitem_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) ) ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ ( c_2Efmaptree_2Emap_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) ) ) ) ) ) )).

thf(thm_2Efmaptree_2Emap__thm,conjecture,(
    ! [A_27a: d,A_27b: d,V0i_2E0: u,V1fm_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) @ ( c_2Efmaptree_2Emap_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) @ ( c_2Efmaptree_2EFTNode_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) @ V1fm_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ ( tyop_2Efmaptree_2Efmaptree @ A_27b @ A_27a ) ) @ V1fm_2E0 ) ) )).
