...
tff(conj_thm_2Estate__transformer_2EMCOMP__ID,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27b,ty_2Epair_2Eprod(A_27c,A_27c))))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27d,arr(A_27e,ty_2Epair_2Eprod(A_27f,A_27f))))
         => ( ap(ap(c_2Estate__transformer_2EMCOMP(A_27a,A_27a,A_27a,A_27a),V0g),c_2Estate__transformer_2EUNIT(A_27b,A_27b)) = V0g
            & ap(ap(c_2Estate__transformer_2EMCOMP(A_27d,A_27d,A_27d,A_27d),c_2Estate__transformer_2EUNIT(A_27e,A_27e)),V1f) = V1f ) ) ) )).

tff(conj_thm_2Estate__transformer_2EEXT__o__UNIT,conjecture,(
