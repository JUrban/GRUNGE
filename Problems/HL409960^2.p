...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IN__IF__ALT,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                ...
                = ( surj__ty_2Eextreal_2Eextreal
                  @ ( ap
                    @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V0s ) ) @ ( ap @ V1f @ V3x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V2z ) ) ) )
                    @ V0s ) ) ) ) ) ) )).
