...
thf(f3500_0_2E0,type,(
    f3500_0_2E0: u )).

thf(f3500_0_2E2,type,(
    f3500_0_2E2: du > du > u )).

thf(f3500_0_2E3,type,(
    f3500_0_2E3: du > du > du > u )).

thf(f3500_1_2E0,type,(
    f3500_1_2E0: u )).

thf(f3500_1_2E1,type,(
    f3500_1_2E1: du > u )).

thf(f3500_1_2E2,type,(
    f3500_1_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3500_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f3500_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef3500_0_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( f3500_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef3500_1_2E1_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( f3500_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ f3500_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef3500_1_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27a @ ( f3500_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ f3500_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).
...
thf(arityeq4_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E4_2Emono_2EA_27d_20mono_2EA_27c_20mono_2EA_27a,axiom,(
...
thf(arityeq4_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E4_2Emono_2EA_27d_20mono_2EA_27c_20mono_2EA_27b,axiom,(
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__ROW__REMOVE__FUN,axiom,(
    ! [A_27a: d,A_27c: d,V2p_2E0: u,V8x_2E0: u] :
      ( ( s @ A_27a @ ( f3500_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2p_2E0 ) @ ( s @ A_27c @ V8x_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2p_2E0 ) @ ( s @ A_27c @ V8x_2E0 ) ) ) ) )).

thf(def1_2Ethm_2EpatternMatches_2EPMATCH__ROW__REMOVE__FUN,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0ff_2E0: u,V2p_2E0: u,V7x_2E0: u] :
      ( ( s @ A_27b @ ( f3500_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0ff_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2p_2E0 ) @ ( s @ A_27c @ V7x_2E0 ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__ROW__REMOVE__FUN,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0ff_2E0: u,V1v_2E0: u,V2p_2E0: u,V3g_2E0: u,V4r_2E0: u] :
      ( ! [V5x_2E0: u,V6y_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27d ) @ ( c_2EpatternMatches_2EPMATCH__ROW_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f3500_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0ff_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2p_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V3g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ V4r_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0ff_2E0 ) @ ( s @ A_27a @ V1v_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27d ) @ ( c_2EpatternMatches_2EPMATCH__ROW_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( f3500_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2p_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V3g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ V4r_2E0 ) @ ( s @ A_27a @ V1v_2E0 ) ) ) ) ) )).
