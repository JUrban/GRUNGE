...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
              ...
              @ ( ap @ c_2Ereal__topology_2Esubspace
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V2x ) ) @ V1s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESPAN__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
           => ( ( ap @ c_2Ereal__topology_2Espan @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) )
              = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ c_2Ereal__topology_2Espan @ V1s ) ) ) ) ) ) )).
