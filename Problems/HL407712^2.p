...
thf(conj_thm_2Eordinal_2EordMULT__le__MONO__L,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
...
thf(conj_thm_2EordNotationSemantics_2Enat__times__omega,conjecture,(
    ! [A_27a: del,V0e: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum] :
          ( ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) )
            & ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0e ) ) )
         => ( ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0e ) )
