...
tff(mem_c_2Ecardinal_2Ecardgt,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ecardinal_2Ecardgt(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27b,bool),bool))) )).
...
tff(ax_thm_2Ecardinal_2Ecardgt__def,axiom,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ( p(ap(ap(c_2Ecardinal_2Ecardgt(A_27a,A_27a),V0s),V1t))
          <=> ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s),V1t)) ) ) ) )).

tff(conj_thm_2Ecardinal_2Egt__c,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
