...
fof(conj_thm_2Ereal__topology_2EINTERIOR__HYPERPLANE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ap(c_2Ereal__topology_2Einterior,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3899(V0a))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) )).
