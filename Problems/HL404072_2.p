...
tff(conj_thm_2ETemporal__Logic_2EALWAYS__AS__WHEN,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f884,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1t: tp__ty_2Enum_2Enum] : ap(f884(V0a),inj__ty_2Enum_2Enum(V1t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0a),inj__ty_2Enum_2Enum(V1t))) ) )).

tff(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__WHEN,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2ETemporal__Logic_2ESWHEN__AS__NOT__WHEN,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1324,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1324(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(ap(ap(c_2ETemporal__Logic_2EWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),f882(V0a)),inj__ty_2Enum_2Enum(V2t)) ) )).

tff(lmtp_f1325,type,(
    f1325: $i > $i )).

tff(lamtp_f1325,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1325,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1325(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0a),inj__ty_2Enum_2Enum(V5t))) ) )).
...
tff(lameq_f1326,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1326(V0a,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f1296(V1b)),f1327(V0a,V1b)),inj__ty_2Enum_2Enum(V7t))) ) ) )).
...
tff(lameq_f1328,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V10t: tp__ty_2Enum_2Enum] : ap(f1328(V1b,V0a),inj__ty_2Enum_2Enum(V10t)) = ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1b),f1329(V0a,V1b)),inj__ty_2Enum_2Enum(V10t)) ) ) )).
...
tff(lameq_f1330,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V12t: tp__ty_2Enum_2Enum] : ap(f1330(V0a,V1b),inj__ty_2Enum_2Enum(V12t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f1331(V0a)),V1b),inj__ty_2Enum_2Enum(V12t))) ) ) )).
...
tff(lameq_f1332,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V14t: tp__ty_2Enum_2Enum] : ap(f1332(V1b,V0a),inj__ty_2Enum_2Enum(V14t)) = ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f1333(V1b)),f1334(V0a,V1b)),inj__ty_2Enum_2Enum(V14t)) ) ) )).
...
tff(lameq_f1335,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V17t: tp__ty_2Enum_2Enum] : ap(f1335(V0a,V1b),inj__ty_2Enum_2Enum(V17t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1b),f1336(V0a,V1b)),inj__ty_2Enum_2Enum(V17t))) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EWHEN__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
