...
tff(mem_c_2Ebft_2EBFT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ebft_2EBFT(A_27a,A_27a),arr(arr(A_27b,ty_2Elist_2Elist(A_27b)),arr(arr(A_27b,arr(A_27a,A_27a)),arr(ty_2Elist_2Elist(A_27b),arr(ty_2Elist_2Elist(A_27b),arr(A_27a,A_27a)))))) )).

tff(conj_thm_2Ebft_2EBFT__def,lemma,(
...
tff(conj_thm_2Ebft_2EBFT__ind,lemma,(
...
tff(conj_thm_2Ebft_2EBFT__CONS,conjecture,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1f: $i] :
                     ...
                     => ! [V5a: $i] :
                         ...
                         => ! [V6b: $i] :
                             ...
                             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2EdirGraph_2EParents(A_27a,A_27a),V0G)))
                               ...
                               => ap(ap(ap(ap(ap(c_2Ebft_2EBFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),V1f),V2seen),V3fringe),V4acc) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(ap(ap(ap(c_2Ebft_2EBFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),V1f),V2seen),V3fringe),V5a)),V6b) ) ) ) ) ) ) ) ) )).
