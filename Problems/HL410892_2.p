...
tff(lmtp_f3740,type,(
    f3740: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f3740,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f3740(V0n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f3740,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : ap(f3740(V0n),inj__ty_2Enum_2Enum(V1m)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m))) )).

tff(ax_thm_2Ereal__topology_2Efrom,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V0n)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3740(V0n)) )).

tff(conj_thm_2Ereal__topology_2EFROM__INTER__NUMSEG,conjecture,(
