...
thf(conj_thm_2Erich__list_2EMONOID__APPEND__NIL,conjecture,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ ( c_2Ecombin_2EMONOID @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2EAPPEND @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) )).
