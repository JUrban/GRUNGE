...
thf(thm_2Eextreal_2Ele__max2,axiom,(
    ! [V0x: tyop_2Eextreal_2Eextreal,V1y: tyop_2Eextreal_2Eextreal] :
      ( c_2Eextreal_2Eextreal__le @ V1y @ ( c_2Eextreal_2Eextreal__max @ V0x @ V1y ) ) )).

thf(thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__IMAGE,axiom,(
    ! [A_27a: $tType,V0P: tyop_2Eextreal_2Eextreal > $o,V1P_27: ( A_27a > tyop_2Eextreal_2Eextreal ) > $o,V2f: ( A_27a > tyop_2Eextreal_2Eextreal ) > tyop_2Eextreal_2Eextreal] :
      ( ( ? [V3x: tyop_2Eextreal_2Eextreal] :
        ...
        & ? [V4z: tyop_2Eextreal_2Eextreal] :
            ...
            & ! [V5x: tyop_2Eextreal_2Eextreal] :
                ( ( V0P @ V5x )
               => ( c_2Eextreal_2Eextreal__le @ V5x @ V4z ) ) )
        & ( V0P
          = ( c_2Epred__set_2EIMAGE @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ tyop_2Eextreal_2Eextreal @ V2f @ V1P_27 ) ) )
     => ? [V6g: tyop_2Enum_2Enum > A_27a > tyop_2Eextreal_2Eextreal] :
          ( ! [V7n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ ( V6g @ V7n ) @ V1P_27 )
...
thf(thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__MONO__IMAGE,conjecture,(
    ! [A_27a: $tType,V0f: ( A_27a > tyop_2Eextreal_2Eextreal ) > tyop_2Eextreal_2Eextreal,V1P: tyop_2Eextreal_2Eextreal > $o,V2P_27: ( A_27a > tyop_2Eextreal_2Eextreal ) > $o] :
      ( ( ? [V3x: tyop_2Eextreal_2Eextreal] :
            ( V1P @ V3x )
        & ? [V4z: tyop_2Eextreal_2Eextreal] :
            ( ( (~) @ ( V4z = c_2Eextreal_2EPosInf ) )
            & ! [V5x: tyop_2Eextreal_2Eextreal] :
               ...
               => ( c_2Eextreal_2Eextreal__le @ V5x @ V4z ) ) )
        & ( V1P
          = ( c_2Epred__set_2EIMAGE @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ tyop_2Eextreal_2Eextreal @ V0f @ V2P_27 ) )
        & ! [V6g1: A_27a > tyop_2Eextreal_2Eextreal,V7g2: A_27a > tyop_2Eextreal_2Eextreal] :
            ( ( ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V6g1 @ V2P_27 )
              & ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V7g2 @ V2P_27 )
              & ! [V8x: A_27a] :
                  ( c_2Eextreal_2Eextreal__le @ ( V6g1 @ V8x ) @ ( V7g2 @ V8x ) ) )
           => ( c_2Eextreal_2Eextreal__le @ ( V0f @ V6g1 ) @ ( V0f @ V7g2 ) ) )
        & ! [V9g1: A_27a > tyop_2Eextreal_2Eextreal,V10g2: A_27a > tyop_2Eextreal_2Eextreal] :
            ( ( ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V9g1 @ V2P_27 )
              & ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V10g2 @ V2P_27 ) )
           => ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal )
              @ ^ [V11x: A_27a] :
                  ( c_2Eextreal_2Eextreal__max @ ( V9g1 @ V11x ) @ ( V10g2 @ V11x ) )
              @ V2P_27 ) ) )
     => ? [V12g: tyop_2Enum_2Enum > A_27a > tyop_2Eextreal_2Eextreal] :
          ( ! [V13n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ ( V12g @ V13n ) @ V2P_27 )
          & ! [V14x: A_27a,V15n: tyop_2Enum_2Enum] :
              ( c_2Eextreal_2Eextreal__le @ ( V12g @ V15n @ V14x ) @ ( V12g @ ( c_2Enum_2ESUC @ V15n ) @ V14x ) )
          & ( ( c_2Eextreal_2Eextreal__sup
              @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Eextreal_2Eextreal
                @ ^ [V16n: tyop_2Enum_2Enum] :
                    ( V0f @ ( V12g @ V16n ) )
                @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) )
            = ( c_2Eextreal_2Eextreal__sup @ V1P ) ) ) ) )).
