...
thf(conj_thm_2Epred__set_2EBIGUNION__SING,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__EQ__CONNECTED__COMPONENTS__EQ,lemma,(
    ! [V0s: $i] :
      ...
      <=> ! [V1c: $i] :
           ...
           => ! [V2c_27: $i] :
               ...
               => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1c ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) )
                    & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2c_27 ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) ) )
                 => ( V1c = V2c_27 ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPONENTS__INTERMEDIATE__SUBSET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
         ...
         => ! [V2u: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V2u ) ) )
                  & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) )
                  & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V1t ) @ V2u ) ) )
               => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V1t ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOPEN__BIGUNION__COMPONENTS,lemma,(
    ! [V0u: $i] :
      ( ( mem @ V0u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1s: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V0u ) ) @ V1s ) )
           ...
           => ? [V2k: $i] :
                ( ( mem @ V2k @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
                & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2k ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0u ) ) )
                & ( V1s
                  = ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V2k ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOPEN__IN__COMPONENTS,conjecture,(
    ! [V0u: $i] :
      ( ( mem @ V0u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
