...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE__EQ,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__TRANSLATION,conjecture,(
      ...
      <=> ( p
          @ ( ap
            @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V3x: $i] :
                    ( ap @ V2f @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V3x ) ) ) )
            @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) ) ) ) ) )).
