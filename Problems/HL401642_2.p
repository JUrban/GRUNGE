...
tff(conj_thm_2Epred__set_2ESURJ__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EFINITE__SURJ__BIJ,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2t: $i] :
              ( mem(V2t,arr(A_27b,bool))
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                  & p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V1f),V0s),V2t))
                  & surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27b),V2t)) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),V0s)) )
               => p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V1f),V0s),V2t)) ) ) ) ) )).
