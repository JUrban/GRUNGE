...
thf(conj_thm_2Ereal_2EREAL__LT__IADD,lemma,(
...
thf(conj_thm_2Ereal_2EREAL__SUP__UBOUND__LE,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ? [V1x: tp__ty_2Erealax_2Ereal] :
       ...
       => ! [V4y: tp__ty_2Erealax_2Ereal] :
           ...
           => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) @ ( ap @ c_2Ereal_2Esup @ V0P ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2ESUP__EPSILON,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Eseq_2ESEQ__UNIQ,lemma,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Eextreal_2Emono__increasing__converges__to__sup,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
