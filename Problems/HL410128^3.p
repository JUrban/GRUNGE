...
thf(c_2Emeasure_2Ecountably__subadditive,type,(
    c_2Emeasure_2Ecountably__subadditive: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) ) > $o ) )).
...
thf(c_2Emeasure_2Eouter__measure__space,type,(
    c_2Emeasure_2Eouter__measure__space: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) ) > $o ) )).
...
thf(c_2Emeasure_2Esubadditive,type,(
    c_2Emeasure_2Esubadditive: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) ) > $o ) )).
...
thf(thm_2Emeasure_2Eincreasing__def,axiom,(
    ...
    <=> ! [V1s: A_27a > $o,V2t: A_27a > $o] :
         ...
         => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2t ) ) ) ) )).
...
thf(thm_2Emeasure_2Eouter__measure__space__def,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( c_2Emeasure_2Eouter__measure__space @ A_27a @ V0m )
    <=> ( ( c_2Emeasure_2Epositive @ A_27a @ V0m )
        & ( c_2Emeasure_2Eincreasing @ A_27a @ V0m )
        & ( c_2Emeasure_2Ecountably__subadditive @ A_27a @ V0m ) ) ) )).
...
thf(thm_2Emeasure_2EALGEBRA__COMPL,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ V0a )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ V1s ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) ) )).
...
thf(thm_2Emeasure_2ELAMBDA__SYSTEM__ADDITIVE,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0g0: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1lam: ( A_27a > $o ) > tyop_2Erealax_2Ereal,V2l1: A_27b,V3l2: A_27c] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ V0g0 )
        & ( c_2Emeasure_2Epositive @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0g0 ) @ V1lam ) ) ) )
     => ( c_2Emeasure_2Eadditive @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0g0 @ V1lam ) @ V1lam ) ) ) ) )).
...
thf(thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE__SUBADDITIVE,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        & ( c_2Emeasure_2Epositive @ A_27a @ V0m )
        & ( c_2Emeasure_2Ecountably__subadditive @ A_27a @ V0m ) )
     => ( c_2Emeasure_2Esubadditive @ A_27a @ V0m ) ) )).
...
thf(thm_2Emeasure_2ESUBADDITIVE,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o,V2t: A_27a > $o,V3u: A_27a > $o] :
     ...
     => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V3u ) @ ( c_2Erealax_2Ereal__add @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2t ) ) ) ) )).

thf(thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: tyop_2Enum_2Enum > A_27a > $o,V2s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Ecountably__subadditive @ A_27a @ V0m )
        ...
        & ( c_2Eseq_2Esummable @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m ) @ V1f ) )
        & ( V2s
          = ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2s @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V2s ) @ ( c_2Eseq_2Esuminf @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m ) @ V1f ) ) ) ) )).
...
thf(thm_2Emeasure_2ELAMBDA__SYSTEM__POSITIVE,axiom,(
    ! [A_27a: $tType,V0g0: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1lam: ( A_27a > $o ) > tyop_2Erealax_2Ereal] :
      ( ( c_2Emeasure_2Epositive @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0g0 ) @ V1lam ) ) )
     => ( c_2Emeasure_2Epositive @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0g0 @ V1lam ) @ V1lam ) ) ) ) )).

thf(thm_2Emeasure_2ELAMBDA__SYSTEM__INCREASING,axiom,(
    ! [A_27a: $tType,V0g0: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1lam: ( A_27a > $o ) > tyop_2Erealax_2Ereal] :
      ( ( c_2Emeasure_2Eincreasing @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0g0 ) @ V1lam ) ) )
     => ( c_2Emeasure_2Eincreasing @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0g0 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0g0 @ V1lam ) @ V1lam ) ) ) ) )).
...
thf(thm_2Eseq_2ESUMMABLE__LE,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Eseq_2Esummable @ V0f )
        & ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Esum @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ V2n ) @ V0f ) @ V1x ) )
...
thf(thm_2Emeasure_2ELAMBDA__SYSTEM__CARATHEODORY,conjecture,(
    ! [A_27a: $tType,V0gsig: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1lam: ( A_27a > $o ) > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0gsig )
        & ( c_2Emeasure_2Eouter__measure__space @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0gsig ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0gsig ) @ V1lam ) ) ) )
     => ! [V2f: tyop_2Enum_2Enum > A_27a > $o] :
          ( ( ( c_2Ebool_2EIN @ ( tyop_2Enum_2Enum > A_27a > $o ) @ V2f @ ( c_2Epred__set_2EFUNSET @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0gsig @ V1lam ) ) )
            & ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
                ( ( (~) @ ( V3m = V4n ) )
               => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V2f @ V3m ) @ ( V2f @ V4n ) ) ) )
         => ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V2f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0gsig @ V1lam ) )
            & ( c_2Eseq_2Esums @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ V1lam @ V2f ) @ ( V1lam @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V2f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) ) ) ) ) )).
