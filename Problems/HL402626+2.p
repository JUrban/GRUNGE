...
fof(mem_c_2Erich__list_2ESPLITP,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(ax_thm_2Erich__list_2ESPLITP,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0P] :
...
fof(ax_thm_2Erich__list_2EPREFIX__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1l] :
             ...
             => ap(ap(c_2Erich__list_2EPREFIX(A_27a),V0P),V1l) = ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Erich__list_2ESPLITP(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Ebool_2E_7E),V0P)),V1l)) ) ) ) )).
...
fof(conj_thm_2Erich__list_2EPREFIX__FOLDR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
