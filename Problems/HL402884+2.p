...
fof(conj_thm_2Erich__list_2EZIP__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2c] :
                     ...
                     => ! [V3d] :
                         ...
                         => ( ( ap(c_2Elist_2ELENGTH(A_27a),V0a) = ap(c_2Elist_2ELENGTH(A_27b),V1b)
                              & ap(c_2Elist_2ELENGTH(A_27a),V2c) = ap(c_2Elist_2ELENGTH(A_27b),V3d) )
                           => ap(ap(c_2Elist_2EAPPEND(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0a),V1b))),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V2c),V3d))) = ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2EAPPEND(A_27a),V0a),V2c)),ap(ap(c_2Elist_2EAPPEND(A_27b),V1b),V3d))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EREVERSE__ZIP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ( ap(c_2Elist_2ELENGTH(A_27a),V0l1) = ap(c_2Elist_2ELENGTH(A_27b),V1l2)
                   => ap(c_2Elist_2EREVERSE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2))) = ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EREVERSE(A_27a),V0l1)),ap(c_2Elist_2EREVERSE(A_27b),V1l2))) ) ) ) ) ) )).
