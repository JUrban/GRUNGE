...
tff(lamtp_f496,axiom,(
    ! [A_27a: del,A_27a: del,V1m: $i] :
      ( mem(V1m,arr(A_27a,bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => mem(f496(A_27a,A_27a,V1m,V2x),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f496,axiom,(
    ! [A_27a: del,A_27a: del,V1m: $i] :
     ...
     => ! [V2x: $i] :
         ...
         => ! [V3y: $i] :
              ( mem(V3y,A_27a)
             => ap(f496(A_27a,A_27a,V1m,V2x),V3y) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1m,V3y)),ap(ap(c_2Emin_2E_3D(A_27a),V3y),V2x)) ) ) ) )).

tff(lmtp_f495,type,(
    f495: ( del * del * $i * $i ) > $i )).

tff(lamtp_f495,axiom,(
    ! [A_27a: del,A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m: $i] :
          ( mem(V1m,arr(A_27a,bool))
         => mem(f495(A_27a,A_27a,V0p,V1m),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f495,axiom,(
    ! [A_27a: del,A_27a: del,V0p: $i] :
     ...
     => ! [V1m: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f495(A_27a,A_27a,V0p,V1m),V2x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1m,V2x)),ap(ap(c_2Ebool_2ERES__FORALL(A_27a),V0p),f496(A_27a,A_27a,V1m,V2x))) ) ) ) )).

tff(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__ALT,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m: $i] :
          ( mem(V1m,arr(A_27a,bool))
         => ( p(ap(ap(c_2Ebool_2ERES__EXISTS__UNIQUE(A_27a),V0p),V1m))
          <=> p(ap(ap(c_2Ebool_2ERES__EXISTS(A_27a),V0p),f495(A_27a,A_27a,V0p,V1m))) ) ) ) )).
