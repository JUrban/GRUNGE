...
tff(thm_2Elist_2ESNOC__CASES,conjecture,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( s(tyop_2Elist_2Elist(A_27a),V0ll_2E0) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)
      | ? [V1x_2E0: u,V2l_2E0: u] : s(tyop_2Elist_2Elist(A_27a),V0ll_2E0) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V1x_2E0),s(tyop_2Elist_2Elist(A_27a),V2l_2E0))) ) )).
