...
tff(conj_thm_2Eiterate_2EREAL__SUP__LE__EQ,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__DIFFS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__NONTRIVIAL__ALT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
           ...
           => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Emax,ap(c_2Ereal_2Esup,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4064(V1t,V0s)))),ap(c_2Ereal_2Esup,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4065(V0s,V1t))))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE__EQ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
