...
thf(conj_thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
         ...
         => ! [V2e: tp__ty_2Erealax_2Ereal,V3x: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) )
                  ...
                  & ! [V5n: tp__ty_2Enum_2Enum] :
                      ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V3x @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) @ V1s ) )
                  & ( p @ ( ap @ c_2Ereal__topology_2Ecauchy @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V3x ) ) ) )
