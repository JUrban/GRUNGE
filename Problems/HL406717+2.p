...
fof(conj_thm_2EOmega_2Edark__shadow__cond__row__ind,conjecture,(
    ! [V0P] :
     ...
     => ( ( ! [V1c] :
             ...
             => ! [V2L] :
                 ...
                 => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1c),V2L)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )
          & ! [V3c] :
             ...
             => ! [V4L] :
                 ...
                 => ! [V5d] :
                     ...
                     => ! [V6R] :
                         ...
                         => ! [V7t] :
                              ( mem(V7t,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                             => ( p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3c),V4L)),V7t))
                               => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3c),V4L)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V5d),V6R)),V7t))) ) ) ) ) ) ) )
       => ! [V8v] :
