...
tff(conj_thm_2Eiterate_2EFINREC__def__compute,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
         => ! [V1b: $i] :
             ...
             => ! [V13s: $i] :
                 ...
                 => ! [V14a: $i] :
                     ...
                     => ! [V15n: tp__ty_2Enum_2Enum] :
                          ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V11f),V12b),V13s),V14a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(V15n)))))
                        <=> ? [V16x: $i] :
                              ( mem(V16x,A_27a)
                              & ? [V17c: $i] :
                                  ( mem(V17c,A_27b)
                                  & p(ap(ap(c_2Ebool_2EIN(A_27a),V16x),V13s))
                                  & p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V11f),V12b),ap(ap(c_2Epred__set_2EDELETE(A_27a),V13s),V16x)),V17c),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V15n)))))
