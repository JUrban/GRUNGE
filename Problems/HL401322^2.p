...
thf(conj_thm_2Ebit_2EBITWISE__BITS,conjecture,(
    ! [V0wl: tp__ty_2Enum_2Enum,V1op: $i] :
      ( ( mem @ V1op @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
     => ! [V2a: tp__ty_2Enum_2Enum,V3b: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0wl ) ) ) @ V1op ) @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0wl ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) ) @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0wl ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V3b ) ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0wl ) ) ) @ V1op ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) @ ( inj__ty_2Enum_2Enum @ V3b ) ) ) ) ) )).
