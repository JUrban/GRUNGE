...
tff(tp_c_2Eprobability_2Euniform__distribution,type,(
    c_2Eprobability_2Euniform__distribution: ( del * del * del * del ) > $i )).

tff(mem_c_2Eprobability_2Euniform__distribution,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] : mem(c_2Eprobability_2Euniform__distribution(A_27a,A_27a,A_27a,A_27a),arr(A_27b,arr(A_27c,arr(ty_2Epair_2Eprod(arr(A_27d,bool),arr(A_27d,bool)),arr(arr(A_27a,bool),ty_2Erealax_2Ereal))))) )).
...
tff(lamtp_f4235,axiom,(
    ! [A_27d: del,A_27a: del,V2s: $i] :
      ( mem(V2s,ty_2Epair_2Eprod(arr(A_27d,bool),arr(A_27d,bool)))
     => mem(f4235(A_27d,A_27a,V2s),arr(arr(A_27a,bool),ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4235,axiom,(
    ! [A_27d: del,A_27a: del,V2s: $i] :
      ( mem(V2s,ty_2Epair_2Eprod(arr(A_27d,bool),arr(A_27d,bool)))
     => ! [V3a: $i] :
          ( mem(V3a,arr(A_27a,bool))
         => ap(f4235(A_27d,A_27a,V2s),V3a) = ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,ap(c_2Epred__set_2ECARD(A_27a),V3a))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Epred__set_2ECARD(A_27d),ap(c_2Emeasure_2Espace(A_27d),V2s)))) ) ) )).

tff(ax_thm_2Eprobability_2Euniform__distribution__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0p: $i] :
     ...
     => ! [V1X: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,ty_2Epair_2Eprod(arr(A_27d,bool),arr(A_27d,bool)))
             => ap(ap(ap(c_2Eprobability_2Euniform__distribution(A_27a,A_27a,A_27a,A_27a),V0p),V1X),V2s) = f4235(A_27d,A_27a,V2s) ) ) ) )).

tff(conj_thm_2Eprobability_2EPSPACE,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eprobability_2Euniform__distribution__prob__space,conjecture,(
    ! [A_27a: del,A_27b: del,V0X: $i] :
      ( mem(V0X,arr(A_27a,A_27b))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V1p)))
                  ...
                  & p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),V2s)) )
               => p(ap(c_2Eprobability_2Eprob__space(A_27b),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Espace(A_27b),V2s)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27b),V2s)),ap(ap(ap(c_2Eprobability_2Euniform__distribution(A_27b,A_27b,A_27b,A_27b),V1p),V0X),V2s))))) ) ) ) ) )).
