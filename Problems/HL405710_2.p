...
tff(conj_thm_2Eordinal_2EordMULT__le__MONO__L,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eordinal_2EordADD__under__epsilon0,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMUL__under__epsilon0,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
