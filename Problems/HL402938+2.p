    ...
    ! [A_27b,A_27a,V2i] :
     ...
     => ! [V0p] :
         ...
         => ! [V1g] :
             ...
             => mem(f825(A_27b,A_27a,V2i,V0p,V1g),arr(A_27a,bool)) ) ) ) )).
    ...
    ! [A_27b,A_27a,V2i] :
     ...
     => ! [V0p] :
         ...
         => ! [V1g] :
             ...
             => ! [V6y] :
                  ( mem(V6y,A_27a)
                 => ap(f825(A_27b,A_27a,V2i,V0p,V1g),V6y) = ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND(A_27a,A_27a),V0p),V1g),V2i),V6y) ) ) ) ) )).

fof(conj_thm_2EpatternMatches_2EPMATCH__COND__SELECT__UNIQUE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1g] :
                 ...
                 => ! [V2i] :
                     ...
                     => ( ! [V3x1] :
                       ...
                       => ! [V5x] :
                            ( mem(V5x,A_27a)
                           => ( p(ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND(A_27a,A_27a),V0p),V1g),V2i),V5x))
                             => ap(c_2Emin_2E_40(A_27a),f825(A_27b,A_27a,V2i,V0p,V1g)) = V5x ) ) ) ) ) ) ) ) )).
