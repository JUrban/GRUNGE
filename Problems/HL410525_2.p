...
tff(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ESPAN__INDUCT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1h: $i] :
...
tff(conj_thm_2Ereal__topology_2ESPAN__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
