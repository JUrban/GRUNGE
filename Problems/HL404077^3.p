...
thf(thm_2EPast__Temporal__Logic_2EPUNTIL__EXPRESSIVE,conjecture,(
        ...
        = ( ^ [V13t: tyop_2Enum_2Enum] :
              ...
              @ ( c_2EPast__Temporal__Logic_2EPUNTIL
                @ ^ [V14t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_7E @ ( V1a @ V14t ) ) @ ( c_2Ebool_2E_7E @ ( V0b @ V14t ) ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1a @ V0b )
        = ( ^ [V16t: tyop_2Enum_2Enum] :
              ...
              @ ^ [V17t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_7E @ ( V0b @ V17t ) )
              @ ^ [V18t: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_2F_5C @ ( V1a @ V18t ) @ ( c_2Ebool_2E_7E @ ( V0b @ V18t ) ) )
              @ V16t ) ) )
