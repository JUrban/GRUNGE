...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IF__ELIM,conjecture,(
    ! [A_27a: del,V0s: $i] :
               ...
               => ( ( surj__ty_2Eextreal_2Eextreal
                    @ ( ap
                      @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Eextreal_2Eextreal ) @ ( ap @ V1P @ V4x ) ) @ ( ap @ V2f @ V4x ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
                      @ V0s ) )
