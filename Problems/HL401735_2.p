...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__SING,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__SUBSET__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__IN__LE,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
