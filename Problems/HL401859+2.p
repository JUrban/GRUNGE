...
fof(conj_thm_2Epred__set_2EIMAGE__EQ__SING,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2z] :
                      ( mem(V2z,A_27a)
                     => ( ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V0f),V1s) = ap(ap(c_2Epred__set_2EINSERT(A_27a),V2z),c_2Epred__set_2EEMPTY(A_27a))
