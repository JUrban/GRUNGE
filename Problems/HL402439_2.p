...
tff(conj_thm_2EerrorStateMonad_2EBIND__RIGHT__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del,V0k: $i] :
      ( mem(V0k,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))
     => ap(ap(c_2EerrorStateMonad_2EBIND(A_27a,A_27a,A_27a),V0k),c_2EerrorStateMonad_2EUNIT(A_27a,A_27a)) = V0k ) )).
