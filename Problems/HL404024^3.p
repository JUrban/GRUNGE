...
thf(thm_2Equotient_2ECOND__RSP,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0R: A_27a > A_27a > $o,V1abs: A_27a > A_27b,V2rep: A_27b > A_27a] :
     ...
     => ! [V3a1: $o,V4a2: $o,V5b1: A_27a,V6b2: A_27a,V7c1: A_27a,V8c2: A_27a] :
          ( ( ( V3a1 = V4a2 )
            & ( V0R @ V5b1 @ V6b2 )
            & ( V0R @ V7c1 @ V8c2 ) )
         => ( V0R @ ( c_2Ebool_2ECOND @ A_27a @ V3a1 @ V5b1 @ V7c1 ) @ ( c_2Ebool_2ECOND @ A_27a @ V4a2 @ V6b2 @ V8c2 ) ) ) ) )).
