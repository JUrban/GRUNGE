...
tff(lmtp_f1903,type,(
    f1903: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1903,axiom,(
    ! [A_27b: del,A_27a: del,V3b: $i] :
      ( mem(V3b,A_27b)
     => ! [V2a: $i] :
          ( mem(V2a,A_27a)
         => ! [V1f: $i] :
              ( mem(V1f,arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))
             => mem(f1903(A_27b,A_27a,V3b,V2a,V1f),arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b))) ) ) ) )).

tff(lameq_f1903,axiom,(
    ! [A_27b: del,A_27a: del,V3b: $i] :
      ( mem(V3b,A_27b)
     => ! [V2a: $i] :
          ( mem(V2a,A_27a)
         => ! [V1f: $i] :
             ...
             => ! [V4x: $i] :
                  ( mem(V4x,A_27a)
                 => ap(f1903(A_27b,A_27a,V3b,V2a,V1f),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27b,A_27b)),ap(ap(c_2Emin_2E_3D(A_27a),V4x),V2a)),ap(c_2Esum_2EINL(A_27b,A_27b),V3b)),ap(V1f,V4x)) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2Eis__fmap__rules,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),k(A_27a,ap(c_2Esum_2EINR(A_27b,A_27b),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone)))))
      & ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))
         => ! [V2a: $i] :
              ( mem(V2a,A_27a)
             => ! [V3b: $i] :
                  ( mem(V3b,A_27b)
                 => ( p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),V1f))
                   => p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),f1903(A_27b,A_27a,V3b,V2a,V1f))) ) ) ) ) ) )).
