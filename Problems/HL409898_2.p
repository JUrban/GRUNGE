...
tff(lamtp_f3432,axiom,(
    ! [A_27a: del,V1p: $i] :
      ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V2i: $i] :
          ( mem(V2i,A_27a)
         => mem(f3432(A_27a,V1p,V2i),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3432,axiom,(
    ! [A_27a: del,V1p: $i] :
      ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V2i: $i] :
          ( mem(V2i,A_27a)
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3432(A_27a,V1p,V2i),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(V1p,inj__ty_2Erealax_2Ereal(V3x)),V2i) ) ) )).

tff(lmtp_f3433,type,(
    f3433: ( del * $i * $i ) > $i )).

tff(lamtp_f3433,axiom,(
    ! [A_27a: del,V1p: $i] :
      ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => mem(f3433(A_27a,V1p,V0s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3433,axiom,(
    ! [A_27a: del,V1p: $i] :
      ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3433(A_27a,V1p,V0s),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Eiterate_2ESum(A_27a),V0s),ap(V1p,inj__ty_2Erealax_2Ereal(V4x))) ) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUM,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1p: $i] :
          ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
              & ! [V2i: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2i),V0s))
                   => p(ap(c_2Eiterate_2Epolynomial__function,f3432(A_27a,V1p,V2i))) ) ) )
           => p(ap(c_2Eiterate_2Epolynomial__function,f3433(A_27a,V1p,V0s))) ) ) ) )).
