...
tff(ax_thm_2EordinalNotation_2Efinp__def,axiom,
...
tff(ax_thm_2EordinalNotation_2Etail__def,axiom,(
    ! [V0e: tp__ty_2EordinalNotation_2Eosyntax,V1k: tp__ty_2Enum_2Enum,V2t: tp__ty_2EordinalNotation_2Eosyntax] : surj__ty_2EordinalNotation_2Eosyntax(ap(c_2EordinalNotation_2Etail,ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V0e)),inj__ty_2Enum_2Enum(V1k)),inj__ty_2EordinalNotation_2Eosyntax(V2t)))) = V2t )).
...
tff(conj_thm_2EordNotationSemantics_2Etail__dominated,conjecture,(
