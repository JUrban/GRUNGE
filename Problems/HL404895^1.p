...
thf(c_2Elbtree_2Efinite_2E0,type,(
    c_2Elbtree_2Efinite_2E0: u )).

thf(c_2Elbtree_2Efinite_2E1,type,(
    c_2Elbtree_2Efinite_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Elbtree_2Efinite_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ tyop_2Emin_2Ebool ) @ c_2Elbtree_2Efinite_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Elbtree_2Efinite_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ tyop_2Emin_2Ebool ) @ c_2Elbtree_2Efinite_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Elbtree_2Efinite__def,axiom,(
    ! [A_27a: d,V0x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V0x_2E0 ) ) ) )
    <=> ! [V1finite_27_2E0: u] :
          ( ! [V2a0_2E0: u] :
              ( ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2a0_2E0 )
                  = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ c_2Elbtree_2ELf_2E0 ) )
                | ? [V3a_2E0: u,V4t1_2E0: u,V5t2_2E0: u] :
                    ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2a0_2E0 )
                      = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V3a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V4t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V5t2_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1finite_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V4t1_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1finite_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V5t2_2E0 ) ) ) ) ) )
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1finite_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2a0_2E0 ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ tyop_2Emin_2Ebool ) @ V1finite_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V0x_2E0 ) ) ) ) ) ) )).

thf(thm_2Elbtree_2Efinite__thm,conjecture,(
    ! [A_27a: d,A_27b: d,V0t2_2E0: u,V1t1_2E0: u,V2a_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ c_2Elbtree_2ELf_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2ET )
      & ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27b @ V2a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V1t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V0t2_2E0 ) ) ) ) ) )
      <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V1t1_2E0 ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Efinite_2E1 @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V0t2_2E0 ) ) ) ) ) ) ) )).
