...
thf(conj_thm_2Eextreal_2Elt__trans,lemma,(
...
thf(conj_thm_2Eextreal_2Erat__not__infty,lemma,(
    ! [V0r: tp__ty_2Eextreal_2Eextreal] :
      ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( inj__ty_2Eextreal_2Eextreal @ V0r ) ) @ c_2Eextreal_2EQ__set ) )
     => ( ( V0r != fo__c_2Eextreal_2ENegInf )
        & ( V0r != fo__c_2Eextreal_2EPosInf ) ) ) )).

thf(conj_thm_2Eextreal_2EQ__DENSE__IN__R,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
      ( ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) )
     => ? [V2r: tp__ty_2Eextreal_2Eextreal] :
          ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( inj__ty_2Eextreal_2Eextreal @ V2r ) ) @ c_2Eextreal_2EQ__set ) )
          & ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V2r ) ) )
          & ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( inj__ty_2Eextreal_2Eextreal @ V2r ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EBIGUNION__IMAGE__Q,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ ty_2Eextreal_2Eextreal @ ( arr @ A_27a @ bool ) ) )
         => ( ( ( p @ ( ap @ ( c_2Emeasure_2Esigma__algebra @ A_27a ) @ V0a ) )
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Eextreal_2Eextreal @ ( arr @ A_27a @ bool ) ) ) @ V1f ) @ ( ap @ ( ap @ ( c_2Epred__set_2EFUNSET @ ty_2Eextreal_2Eextreal @ ( arr @ A_27a @ bool ) ) @ c_2Eextreal_2EQ__set ) @ ( ap @ ( c_2Emeasure_2Esubsets @ A_27a ) @ V0a ) ) ) ) )
           => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Eextreal_2Eextreal @ ( arr @ A_27a @ bool ) ) @ V1f ) @ c_2Eextreal_2EQ__set ) ) ) @ ( ap @ ( c_2Emeasure_2Esubsets @ A_27a ) @ V0a ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1g: $i] :
