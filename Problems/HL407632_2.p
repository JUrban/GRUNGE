...
tff(conj_thm_2Epred__set_2EINTER__applied,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EBIGUNION__applied,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1sos: $i] :
...
tff(ax_thm_2Etopology_2Eistopology,axiom,(
    ! [A_27a: del,V0L: $i] :
...
tff(conj_thm_2Emetric_2Emtop__istopology,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Emetric_2Emetric(A_27a))
