...
tff(lamtp_f3593,axiom,(
    ! [A_27a: del,V0fn: $i] :
      ( mem(V0fn,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V6x: $i] :
          ( mem(V6x,A_27a)
         => mem(f3593(A_27a,V0fn,V6x),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) ) )).
...
tff(lameq_f3593,axiom,(
    ! [A_27a: del,V0fn: $i] :
     ...
     => ! [V6x: $i] :
          ( mem(V6x,A_27a)
         => ! [V7n: tp__ty_2Enum_2Enum] : ap(f3593(A_27a,V0fn,V6x),inj__ty_2Enum_2Enum(V7n)) = ap(ap(V0fn,inj__ty_2Enum_2Enum(V7n)),V6x) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MONO__SUP,conjecture,(
    ! [A_27a: del,V0fn: $i] :
      ( mem(V0fn,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V1f: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V2a))
                  & ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V0fn,inj__ty_2Enum_2Enum(V3n))),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V2a),c_2Emeasure_2EBorel)))
                  ...
                  & ! [V6x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V6x),ap(c_2Emeasure_2Espace(A_27a),V2a)))
                       => surj__ty_2Eextreal_2Eextreal(ap(V1f,V6x)) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3593(A_27a,V0fn,V6x)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) )
               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V1f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V2a),c_2Emeasure_2EBorel))) ) ) ) ) )).
