...
fof(conj_thm_2Ecombin_2ES__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecombin_2ES__ABS__L,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                 ...
                 => ! [V1g] :
                      ( mem(V1g,arr(A_27a,A_27c))
                     => ap(ap(c_2Ecombin_2ES(A_27a,A_27a,A_27a),f84(A_27b,A_27c,A_27a,V0f)),V1g) = f85(A_27c,A_27b,A_27a,V0f,V1g) ) ) ) ) ) )).
