...
thf(conj_thm_2Earithmetic_2EMULT__EQ__1,lemma,(
    ! [V0x: tp__ty_2Enum_2Enum,V1y: tp__ty_2Enum_2Enum] :
      ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) )
...
thf(conj_thm_2Edivides_2EDIVIDES__REFL,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Edivides_2Edivides @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) ) )).
...
thf(conj_thm_2Edivides_2EDIVIDES__MULT__LEFT,conjecture,(
