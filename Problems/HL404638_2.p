...
tff(conj_thm_2Efinite__map_2EFCARD__SUC,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0f)) = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))
        <=> ? [V2f_27: $i] :
              ...
              & ? [V3x: $i] :
                  ...
                  & ? [V4y: $i] :
                      ...
                      & surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V2f_27)) = V1n
                      & V0f = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2f_27),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),V4y)) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2Efmap__INDUCT,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
