     ...
     => ! [V2x] :
         ...
         => ! [V0R] :
             ...
             => ! [V3xs] :
                 ...
                 => ap(f2421(A_27a,V1y,V2x,V0R),V3xs) = ap(ap(V0R,V3xs),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2x),V1y)),V3xs)) ) ) ) ) )).

fof(lamtp_f2420,axiom,(
    ! [A_27a,V0R] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
     => ! [V1y] :
          ( mem(V1y,A_27a)
...
fof(lameq_f2420,axiom,(
    ! [A_27a,V0R] :
     ...
     => ! [V1y] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Enum_2Enum)
             => ap(f2420(A_27a,V0R,V1y),V2x) = ap(c_2Ebool_2E_21(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))),f2421(A_27a,V1y,V2x,V0R)) ) ) ) )).

fof(lamtp_f2419,axiom,(
    ! [A_27a,A_27a,V0R] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
     => mem(f2419(A_27a,A_27a,V0R),arr(A_27a,bool)) ) )).

fof(lameq_f2419,axiom,(
    ! [A_27a,A_27a,V0R] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
     => ! [V1y] :
          ( mem(V1y,A_27a)
...
fof(lamtp_f2418,axiom,(
    ! [A_27a,A_27a] : mem(f2418(A_27a,A_27a),arr(arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)),bool)) )).

fof(lameq_f2418,axiom,(
    ! [A_27a,A_27a,V0R] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
    ...
    ! [A_27a,A_27a,V7xs] :
     ...
     => ! [V4fromAList] :
         ...
         => ! [V8x] :
             ...
             => mem(f2427(A_27a,A_27a,V7xs,V4fromAList,V8x),arr(A_27a,ty_2Esptree_2Espt(A_27a))) ) ) ) )).

fof(lameq_f2427,axiom,(
    ! [A_27a,A_27a,V7xs] :
      ( mem(V7xs,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V4fromAList] :
          ( mem(V4fromAList,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)))
         => ! [V8x] :
             ...
             => ! [V9y] :
                  ( mem(V9y,A_27a)
                 => ap(f2427(A_27a,A_27a,V7xs,V4fromAList,V8x),V9y) = ap(c_2Ecombin_2EI(ty_2Esptree_2Espt(A_27a)),ap(ap(ap(c_2Esptree_2Einsert(A_27a),V8x),V9y),ap(V4fromAList,V7xs))) ) ) ) ) )).

fof(lamtp_f2426,axiom,(
    ! [A_27a,A_27a,V7xs] :
      ( mem(V7xs,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V4fromAList] :
          ( mem(V4fromAList,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)))
...
fof(lameq_f2426,axiom,(
    ! [A_27a,A_27a,V7xs] :
     ...
     => ! [V4fromAList] :
         ...
         => ! [V8x] :
              ( mem(V8x,ty_2Enum_2Enum)
             => ap(f2426(A_27a,A_27a,V7xs,V4fromAList),V8x) = f2427(A_27a,A_27a,V7xs,V4fromAList,V8x) ) ) ) )).

fof(lamtp_f2425,axiom,(
    ! [A_27a,A_27a,V4fromAList] :
      ( mem(V4fromAList,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)))
     => ! [V6v] :
...
fof(lamtp_f2422,axiom,(
    ! [A_27a,A_27a,A_27a] : mem(f2422(A_27a,A_27a,A_27a),arr(arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)))) )).

fof(lameq_f2422,axiom,(
    ! [A_27a,A_27a,A_27a,V4fromAList] :
      ( mem(V4fromAList,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Esptree_2Espt(A_27a)))
     => ap(f2422(A_27a,A_27a,A_27a),V4fromAList) = f2423(A_27a,A_27a,V4fromAList) ) )).

fof(ax_thm_2Esptree_2EfromAList__primitive__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Esptree_2EfromAList(A_27a) = ap(ap(c_2Erelation_2EWFREC(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))),ap(c_2Emin_2E_40(arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool))),f2418(A_27a,A_27a))),f2422(A_27a,A_27a,A_27a)) ) )).

fof(conj_thm_2Esptree_2EfromAList__def,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ap(c_2Esptree_2EfromAList(A_27a),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) = c_2Esptree_2ELN(A_27a)
        & ! [V0y] :
           ...
           => ! [V1xs] :
               ...
               => ! [V2x] :
                    ( mem(V2x,ty_2Enum_2Enum)
                   => ap(c_2Esptree_2EfromAList(A_27a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2x),V0y)),V1xs)) = ap(ap(ap(c_2Esptree_2Einsert(A_27a),V2x),V0y),ap(c_2Esptree_2EfromAList(A_27a),V1xs)) ) ) ) ) ) )).
