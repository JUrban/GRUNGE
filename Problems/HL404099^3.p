...
thf(thm_2EPast__Temporal__Logic_2ESEPARATE__PSUNTIL__THM,conjecture,(
    ! [V0d: tyop_2Enum_2Enum > $o,V1c: tyop_2Enum_2Enum > $o,V2b: tyop_2Enum_2Enum > $o,V3a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
        ...
        = ( ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a @ V2b @ V5t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a @ V1c @ V5t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
          @ ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V6t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V6t ) ) )
        = ( ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( V2b @ V7t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V7t ) )
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
                @ ^ [V8t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V3a @ V8t ) @ ( c_2Ebool_2E_2F_5C @ ( V1c @ V8t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V2b @ V8t ) ) )
                @ V7t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
          @ ^ [V9t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V9t ) @ ( c_2ETemporal__Logic_2ESUNTIL @ V1c @ V0d @ V9t ) ) )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2ESUNTIL @ V1c @ V0d @ V10t )
                @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                  @ ^ [V11t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V3a @ V11t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1c @ V11t ) )
                  @ V2b
                  @ V10t ) )
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
                @ ^ [V12t: tyop_2Enum_2Enum] :
                    ...
                    @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                      @ ^ [V13t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_2F_5C @ ( V3a @ V13t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1c @ V13t ) )
                      @ V2b
                      @ V12t ) )
                @ V10t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
          @ ^ [V14t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V14t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V1c @ V0d @ V14t ) ) )
        = ( ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2EBEFORE @ V1c @ V0d @ V15t )
                @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                  @ ^ [V16t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V3a @ V16t ) @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0d @ V16t ) ) )
                  @ V2b
                  @ V15t ) )
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a
                    ...
                    @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V17t ) )
                      @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                        @ ^ [V18t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( V3a @ V18t ) @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0d @ V18t ) ) )
                        @ V2b
                        @ V17t ) ) )
                @ V15t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL
          @ ^ [V19t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V3a @ V19t ) @ ( V2b @ V19t ) )
          @ V1c )
        = ( ^ [V20t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V3a @ V1c @ V20t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2b @ V1c @ V20t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL
          @ ^ [V21t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V3a @ V21t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V21t ) )
          @ V1c )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_5C_2F @ ( V3a @ V22t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V22t ) )
                @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                  @ ^ [V23t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_5C_2F @ ( V2b @ V23t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V3a @ V23t ) )
                  @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V1c )
                  @ V22t ) ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL
          @ ^ [V24t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V3a @ V24t ) @ ( c_2ETemporal__Logic_2ESUNTIL @ V2b @ V1c @ V24t ) )
          @ V0d )
              ...
              @ ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ESUNTIL @ V2b @ V1c @ V25t )
                @ ( c_2EPast__Temporal__Logic_2EPBEFORE
                  @ ^ [V26t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_5C_2F @ ( V0d @ V26t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1c @ V26t ) )
                  @ ^ [V27t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V27t ) ) @ ( c_2Ebool_2E_7E @ ( V0d @ V27t ) ) )
                  @ V25t ) )
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                    ...
                    @ ( c_2Ebool_2E_5C_2F @ ( V1c @ V28t )
                      @ ( c_2EPast__Temporal__Logic_2EPBEFORE
                        @ ^ [V29t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_5C_2F @ ( V0d @ V29t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1c @ V29t ) )
                        @ ^ [V30t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V30t ) ) @ ( c_2Ebool_2E_7E @ ( V0d @ V30t ) ) )
                        @ V28t ) ) )
                @ V0d
                @ V25t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL
          @ ^ [V31t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V3a @ V31t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V2b @ V1c @ V31t ) )
          @ V0d )
              ...
              @ ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EBEFORE @ V2b @ V1c @ V32t )
                @ ( c_2EPast__Temporal__Logic_2EPBEFORE
                  @ ^ [V33t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_5C_2F @ ( V0d @ V33t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V2b @ V33t ) )
                  @ ^ [V34t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V34t ) ) @ ( c_2Ebool_2E_7E @ ( V0d @ V34t ) ) )
                  @ V32t ) )
              @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                @ ^ [V35t: tyop_2Enum_2Enum] :
                    ...
                    @ ( c_2EPast__Temporal__Logic_2EPBEFORE
                      @ ^ [V36t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_5C_2F @ ( V0d @ V36t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V2b @ V36t ) )
                      @ ^ [V37t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V37t ) ) @ ( c_2Ebool_2E_7E @ ( V0d @ V37t ) ) )
                      @ V35t ) )
                @ V0d
                @ V32t ) ) ) ) ) )).
