...
tff(conj_thm_2Estring_2ECHR__ONTO,lemma,(
    ! [V0a: tp__ty_2Estring_2Echar] :
    ? [V1r: tp__ty_2Enum_2Enum] :
      ( V0a = surj__ty_2Estring_2Echar(ap(c_2Estring_2ECHR,inj__ty_2Enum_2Enum(V1r)))
...
tff(conj_thm_2Estring_2ECHAR__INDUCT__THM,conjecture,(
    ! [V0P: $i] :
