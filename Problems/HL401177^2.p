...
thf(conj_thm_2Earithmetic_2ELE__ADD__LCANCEL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) ) )).
...
thf(conj_thm_2Elogroot_2EEXP__LE__ISO,lemma,(
...
thf(conj_thm_2Elogroot_2EROOT__UNIQUE,lemma,(
    ! [V0r: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V0r ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        = V2p ) ) )).

thf(conj_thm_2Elogroot_2EROOT__DIV,lemma,(
    ! [V0r: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V0r ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) @ ( inj__ty_2Enum_2Enum @ V2y ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V0r ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( inj__ty_2Enum_2Enum @ V2y ) ) @ ( inj__ty_2Enum_2Enum @ V0r ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elogroot_2EROOT__COMPUTE,conjecture,(
    ! [V0r: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0r ) ) )
     => ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V0r ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          = fo__c_2Enum_2E0 )
        & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V0r ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
          = ( surj__ty_2Enum_2Enum
            @ ( ap
              @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Enum_2ESUC @ V2x ) ) @ ( inj__ty_2Enum_2Enum @ V0r ) ) ) ) @ V2x ) @ ( ap @ c_2Enum_2ESUC @ V2x ) ) ) )
