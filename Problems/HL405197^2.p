...
thf(conj_thm_2Ealist_2EALOOKUP__def,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0q: $i] :
          ( ( mem @ V0q @ A_27b )
...
thf(conj_thm_2Ealist_2Ealist__to__fmap__to__alist,lemma,(
     ...
     => ( ( ap @ ( c_2Ealist_2Efmap__to__alist @ A_27a @ A_27b ) @ ( ap @ ( c_2Ealist_2Ealist__to__fmap @ A_27a @ A_27b ) @ V0al ) )
        = ( ap
          @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
            @ ( lam @ A_27a
              @ ^ [V1k: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V1k ) @ ( ap @ ( c_2Eoption_2ETHE @ A_27b ) @ ( ap @ ( ap @ ( c_2Ealist_2EALOOKUP @ A_27b @ A_27a ) @ V0al ) @ V1k ) ) ) ) )
...
thf(conj_thm_2Elist_2EMAP__EQ__f,lemma,(
...
thf(conj_thm_2Esorting_2EALL__DISTINCT__PERM__LIST__TO__SET__TO__LIST,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
thf(conj_thm_2Ealist_2Ealist__to__fmap__to__alist__PERM,conjecture,(
    ! [A_27a: del,A_27b: del,V0al: $i] :
      ( ( mem @ V0al @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
