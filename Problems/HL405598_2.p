...
tff(lamtp_f2156,axiom,(
    ! [A_27a: del,A_27a: del,V2x: $i] :
      ( mem(V2x,ty_2Eordinal_2Eordinal(A_27a))
     => mem(f2156(A_27a,A_27a,V2x),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))))) ) )).
...
tff(lameq_f2156,axiom,(
    ! [A_27a: del,A_27a: del,V2x: $i] :
     ...
     => ! [V3y: $i] :
         ...
         => ap(f2156(A_27a,A_27a,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V2x),V3y)),ap(c_2Ebool_2E_7E,ap(ap(c_2Eordinal_2Eordlt(A_27a),V3y),V2x))) ) ) )).

tff(lmtp_f2155,type,(
    f2155: ( del * del ) > $i )).

tff(lamtp_f2155,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2155(A_27a,A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))))) )).

tff(lameq_f2155,axiom,(
    ! [A_27a: del,A_27a: del,V2x: $i] :
      ( mem(V2x,ty_2Eordinal_2Eordinal(A_27a))
     => ap(f2155(A_27a,A_27a),V2x) = f2156(A_27a,A_27a,V2x) ) )).

tff(lmtp_f2154,type,(
    f2154: ( del * del * $i ) > $i )).

tff(lamtp_f2154,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => mem(f2154(A_27a,A_27a,V0s),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) ) )).
...
tff(lameq_f2154,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
     ...
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
         => ap(f2154(A_27a,A_27a,V0s),V1a) = ap(ap(c_2Emin_2E_3D(arr(ty_2Eordinal_2Eordinal(A_27a),bool)),ap(ap(c_2Eset__relation_2Emaximal__elements(ty_2Eordinal_2Eordinal(A_27a)),V0s),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(c_2Epair_2EUNCURRY(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2155(A_27a,A_27a))))),ap(ap(c_2Epred__set_2EINSERT(ty_2Eordinal_2Eordinal(A_27a)),V1a),c_2Epred__set_2EEMPTY(ty_2Eordinal_2Eordinal(A_27a)))) ) ) )).

tff(ax_thm_2Eordinal_2Eomax__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ap(c_2Eordinal_2Eomax(A_27a),V0s) = ap(c_2Eoption_2Esome(ty_2Eordinal_2Eordinal(A_27a)),f2154(A_27a,A_27a,V0s)) ) )).

tff(conj_thm_2Eordinal_2Eomax__SOME,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
