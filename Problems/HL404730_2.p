...
tff(conj_thm_2Epred__set_2EDELETE__DELETE,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
...
tff(conj_thm_2Efinite__map_2EDOMSUB__IDEM,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1k: $i] :
          ( mem(V1k,A_27a)
         => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V1k)),V1k) = ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V1k) ) ) )).
