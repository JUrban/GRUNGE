...
fof(conj_thm_2Efrac_2EFRAC__SGN__MUL2,lemma,(
    ! [V0f1] :
      ( mem(V0f1,ty_2Efrac_2Efrac)
     => ! [V1f2] :
...
fof(conj_thm_2Erat_2ERAT__AINV__RMUL,lemma,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
     => ! [V1r2] :
          ( mem(V1r2,ty_2Erat_2Erat)
...
fof(conj_thm_2Erat_2ERAT__AINV__MINV,lemma,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
...
fof(conj_thm_2Erat_2ERAT__SGN__MINV,lemma,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
     => ( V0r1 != ap(c_2Erat_2Erat__of__num,c_2Enum_2E0)
...
fof(conj_thm_2Erat_2ERAT__DIV__MINV,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Erat_2ERAT__DIV__EQ0,lemma,(
    ! [V0d] :
...
fof(conj_thm_2Erat_2ERATN__DIV__RATD,lemma,(
    ! [V0r] :
      ( mem(V0r,ty_2Erat_2Erat)
...
fof(conj_thm_2Erat_2ERAT__SGN__NUM__COND,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Erat_2ERAT__MINV__RATND,conjecture,(
    ! [V0r] :
      ( mem(V0r,ty_2Erat_2Erat)
