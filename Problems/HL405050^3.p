...
thf(thm_2EOmega__Automata_2ETEMP__OPS__DEFS__TO__OMEGA,conjecture,(
    ! [V0l: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( V0l
          = ( c_2ETemporal__Logic_2ENEXT @ V2a ) )
      <=> ( c_2Ebool_2ET
          & ! [V3t: tyop_2Enum_2Enum] :
              ( ( V0l @ V3t )
              = ( V2a @ ( c_2Enum_2ESUC @ V3t ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
      ...
      <=> ( c_2Ebool_2ET
          & ! [V4t: tyop_2Enum_2Enum] :
              ( ( V0l @ V4t )
            <=> ( ( V2a @ V4t )
                & ( V0l @ ( c_2Enum_2ESUC @ V4t ) ) ) )
          & ! [V5t1: tyop_2Enum_2Enum] :
            ? [V6t2: tyop_2Enum_2Enum] :
              ( ( V2a @ ( c_2Earithmetic_2E_2B @ V5t1 @ V6t2 ) )
             => ( V0l @ ( c_2Earithmetic_2E_2B @ V5t1 @ V6t2 ) ) ) ) )
      & ( ( V0l
      ...
      <=> ( c_2Ebool_2ET
          & ! [V7t: tyop_2Enum_2Enum] :
              ( ( V0l @ V7t )
            <=> ( ( V2a @ V7t )
                | ( V0l @ ( c_2Enum_2ESUC @ V7t ) ) ) )
          & ! [V8t1: tyop_2Enum_2Enum] :
            ? [V9t2: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Earithmetic_2E_2B @ V8t1 @ V9t2 ) )
             => ( V2a @ ( c_2Earithmetic_2E_2B @ V8t1 @ V9t2 ) ) ) ) )
      & ( ( V0l
      ...
      <=> ( c_2Ebool_2ET
          & ! [V10t: tyop_2Enum_2Enum] :
            ...
            <=> ( ( (~) @ ( V1b @ V10t ) )
               => ( ( V2a @ V10t )
                  & ( V0l @ ( c_2Enum_2ESUC @ V10t ) ) ) ) )
          & ! [V11t1: tyop_2Enum_2Enum] :
            ? [V12t2: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Earithmetic_2E_2B @ V11t1 @ V12t2 ) )
             => ( ( (~) @ ( V2a @ ( c_2Earithmetic_2E_2B @ V11t1 @ V12t2 ) ) )
                | ( V1b @ ( c_2Earithmetic_2E_2B @ V11t1 @ V12t2 ) ) ) ) ) )
      & ( ( V0l
          = ( c_2ETemporal__Logic_2ESWHEN @ V2a @ V1b ) )
      <=> ( c_2Ebool_2ET
          & ! [V13t: tyop_2Enum_2Enum] :
              ( ( V0l @ V13t )
              = ( c_2Ebool_2ECOND @ $o @ ( V1b @ V13t ) @ ( V2a @ V13t ) @ ( V0l @ ( c_2Enum_2ESUC @ V13t ) ) ) )
          & ! [V14t1: tyop_2Enum_2Enum] :
            ? [V15t2: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Earithmetic_2E_2B @ V14t1 @ V15t2 ) )
             => ( V1b @ ( c_2Earithmetic_2E_2B @ V14t1 @ V15t2 ) ) ) ) )
      & ( ( V0l
      ...
      <=> ( c_2Ebool_2ET
          & ! [V16t: tyop_2Enum_2Enum] :
            ...
            <=> ( ( (~) @ ( V1b @ V16t ) )
                & ( ( V2a @ V16t )
                  | ( V0l @ ( c_2Enum_2ESUC @ V16t ) ) ) ) )
          & ! [V17t1: tyop_2Enum_2Enum] :
            ? [V18t2: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Earithmetic_2E_2B @ V17t1 @ V18t2 ) )
      ...
      <=> ( c_2Ebool_2ET
          & ! [V19t: tyop_2Enum_2Enum] :
            ...
            <=> ( ( (~) @ ( V1b @ V19t ) )
               => ( ( V2a @ V19t )
                  & ( V0l @ ( c_2Enum_2ESUC @ V19t ) ) ) ) )
          & ! [V20t1: tyop_2Enum_2Enum] :
            ? [V21t2: tyop_2Enum_2Enum] :
              ( ( (~) @ ( V0l @ ( c_2Earithmetic_2E_2B @ V20t1 @ V21t2 ) ) )
             => ( ( (~) @ ( V2a @ ( c_2Earithmetic_2E_2B @ V20t1 @ V21t2 ) ) )
                | ( V1b @ ( c_2Earithmetic_2E_2B @ V20t1 @ V21t2 ) ) ) ) ) )
      & ( ( V0l
          = ( c_2ETemporal__Logic_2EWHEN @ V2a @ V1b ) )
      <=> ( c_2Ebool_2ET
          & ! [V22t: tyop_2Enum_2Enum] :
              ( ( V0l @ V22t )
              = ( c_2Ebool_2ECOND @ $o @ ( V1b @ V22t ) @ ( V2a @ V22t ) @ ( V0l @ ( c_2Enum_2ESUC @ V22t ) ) ) )
          & ! [V23t1: tyop_2Enum_2Enum] :
            ? [V24t2: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Earithmetic_2E_2B @ V23t1 @ V24t2 ) )
              | ( V1b @ ( c_2Earithmetic_2E_2B @ V23t1 @ V24t2 ) ) ) ) )
      & ( ( V0l
      ...
      <=> ( c_2Ebool_2ET
          & ! [V25t: tyop_2Enum_2Enum] :
            ...
            <=> ( ( (~) @ ( V1b @ V25t ) )
                & ( ( V2a @ V25t )
                  | ( V0l @ ( c_2Enum_2ESUC @ V25t ) ) ) ) )
          & ! [V26t1: tyop_2Enum_2Enum] :
            ? [V27t2: tyop_2Enum_2Enum] :
              ( ( (~) @ ( V0l @ ( c_2Earithmetic_2E_2B @ V26t1 @ V27t2 ) ) )
             => ( ( V2a @ ( c_2Earithmetic_2E_2B @ V26t1 @ V27t2 ) )
                | ( V1b @ ( c_2Earithmetic_2E_2B @ V26t1 @ V27t2 ) ) ) ) ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2ET )
          & ! [V28t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V28t ) )
              = ( V2a @ V28t ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPSNEXT @ V2a ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2EF )
          & ! [V29t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V29t ) )
              = ( V2a @ V29t ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPALWAYS @ V2a ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2ET )
          & ! [V30t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V30t ) )
            <=> ( ( V2a @ V30t )
                & ( V0l @ V30t ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V2a ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2EF )
          & ! [V31t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V31t ) )
            <=> ( ( V2a @ V31t )
                | ( V0l @ V31t ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2EF )
          & ! [V32t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V32t ) )
            <=> ( ( V1b @ V32t )
                | ( ( V2a @ V32t )
                  & ( V0l @ V32t ) ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2EF )
          & ! [V33t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V33t ) )
            <=> ( ( ( V2a @ V33t )
                  & ( V1b @ V33t ) )
                | ( ( (~) @ ( V1b @ V33t ) )
                  & ( V0l @ V33t ) ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2EF )
          & ! [V34t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V34t ) )
            <=> ( ( (~) @ ( V1b @ V34t ) )
                & ( ( V2a @ V34t )
                  | ( V0l @ V34t ) ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2ET )
          & ! [V35t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V35t ) )
            <=> ( ( V1b @ V35t )
                | ( ( V2a @ V35t )
                  & ( V0l @ V35t ) ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2ET )
          & ! [V36t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V36t ) )
            <=> ( ( ( V2a @ V36t )
                  & ( V1b @ V36t ) )
                | ( ( (~) @ ( V1b @ V36t ) )
                  & ( V0l @ V36t ) ) ) )
          & c_2Ebool_2ET ) )
      & ( ( V0l
          = ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V2a @ V1b ) ) )
      <=> ( ( ( V0l @ c_2Enum_2E0 )
            = c_2Ebool_2ET )
          & ! [V37t: tyop_2Enum_2Enum] :
              ( ( V0l @ ( c_2Enum_2ESUC @ V37t ) )
            <=> ( ( (~) @ ( V1b @ V37t ) )
                & ( ( V2a @ V37t )
                  | ( V0l @ V37t ) ) ) )
          & c_2Ebool_2ET ) ) ) )).
