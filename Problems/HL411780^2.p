...
thf(conj_thm_2Ereal__topology_2ESERIES__NEG,lemma,(
    ! [V0x: $i] :
              ...
              @ ( ap
                @ ( ap
                  @ ( ap @ c_2Ereal__topology_2Esums
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3n: $i] :
                          ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V0x @ V3n ) ) ) )
                  @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V1x0 ) ) )
                @ V2s ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINFSUM__NEG,conjecture,(
    ! [V0s: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V0s ) @ V1x ) )
           => ( ( surj__ty_2Erealax_2Ereal
                @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V0s )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2n: $i] :
                        ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V1x @ V2n ) ) ) ) )
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V0s ) @ V1x ) ) ) ) ) ) ) )).
