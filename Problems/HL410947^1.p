...
thf(f13223_0_2E0,type,(
    f13223_0_2E0: u )).

thf(f13223_0_2E1,type,(
    f13223_0_2E1: du > u )).

thf(f13223_0_2E2,type,(
...
thf(arityeq1_2Emono_2Ef13223_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f13223_0_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f13223_0_2E0 ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef13223_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13223_0_2E2 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f13223_0_2E0 ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2Enetlimit,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13223_0_2E2 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) )
    <=> ! [V2x_2E0: u] :
          ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2Enetlimit,axiom,(
    ! [A_27a: d,V0net_2E0: u] :
      ( ( s @ A_27a @ ( c_2Ereal__topology_2Enetlimit_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f13223_0_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) ) ) )).
