...
fof(lamtp_f2892,axiom,(
    ! [V2x] :
      ( mem(V2x,ty_2Erealax_2Ereal)
     => ! [V1k] :
          ( mem(V1k,ty_2Enum_2Enum)
         => mem(f2892(V2x,V1k),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f2892,axiom,(
    ! [V2x] :
     ...
     => ! [V1k] :
         ...
         => ! [V3m] :
              ( mem(V3m,ty_2Enum_2Enum)
             => ap(f2892(V2x,V1k),V3m) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V3m),V1k)),V2x),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Eseq_2ESUM__PICK,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1k] :
          ( mem(V1k,ty_2Enum_2Enum)
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V0n)),f2892(V2x,V1k)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Eprim__rec_2E_3C,V1k),V0n)),V2x),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) )).
