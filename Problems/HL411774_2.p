...
tff(conj_thm_2Eiterate_2ESUM__ABS__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ETRIVIAL__LIMIT__SEQUENTIALLY,lemma,(
...
tff(conj_thm_2Ereal__topology_2EFROM__0,lemma,(
    ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) = c_2Epred__set_2EUNIV(ty_2Enum_2Enum) )).

tff(lmtp_f3764,type,(
    f3764: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3764,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3764(A_27a,V1f,V3b),arr(A_27a,bool)) ) )).

tff(lameq_f3764,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3764(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1f,V4x))),inj__ty_2Erealax_2Ereal(V3b)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__ABS__UBOUND,lemma,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                ...
                & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3764(A_27a,V1f,V3b)),V0net)) )
...
tff(conj_thm_2Ereal__topology_2ESERIES__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: $i] :
          ( mem(V1k,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Ereal__topology_2ESUMS__OFFSET,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1l)),ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V2m))))
         ...
         => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1l)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),V0f))),ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V3n)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__DROP__POS,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V2a)),V1s))
                & ! [V3x: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3x)),V1s))
             ...
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2a))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__BOUND,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
