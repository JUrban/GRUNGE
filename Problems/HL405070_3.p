...
tff(arityeq2_2Ec_2Epair_2E_2C_2E2_2Emono_2EA_27a_20mono_2Etyop_2Epair_2Eprod_28A_27state_2CA_27state_29,axiom,(
    ! [A_27a: $tType,A_27state: $tType,X0_2E0: A_27a,X1_2E0: tyop_2Epair_2Eprod(A_27state,A_27state)] : c_2Epair_2E_2C_2E2(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state),X0_2E0,X1_2E0) = app_2E2(tyop_2Epair_2Eprod(A_27state,A_27state),tyop_2Epair_2Eprod(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state)),app_2E2(A_27a,tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27state,A_27state),tyop_2Epair_2Eprod(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state))),c_2Epair_2E_2C_2E0(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state)),X0_2E0),X1_2E0) )).

tff(arityeq2_2Ec_2Epair_2E_2C_2E2_2Emono_2EA_27state_20mono_2EA_27state,axiom,(
    ! [A_27state: $tType,X0_2E0: A_27state,X1_2E0: A_27state] : c_2Epair_2E_2C_2E2(A_27state,A_27state,X0_2E0,X1_2E0) = app_2E2(A_27state,tyop_2Epair_2Eprod(A_27state,A_27state),app_2E2(A_27state,tyop_2Emin_2Efun(A_27state,tyop_2Epair_2Eprod(A_27state,A_27state)),c_2Epair_2E_2C_2E0(A_27state,A_27state),X0_2E0),X1_2E0) )).
...
tff(thm_2EOmega__Automata_2EBUECHI__PERIODIC__REDUCTION__THM,conjecture,(
    ! [A_27a: $tType,A_27state: $tType,V0TransRel_2E0: tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state)),tyop_2Emin_2Ebool),V1InitState_2E0: tyop_2Emin_2Efun(A_27state,tyop_2Emin_2Ebool),V2Accept_2E0: tyop_2Emin_2Efun(A_27state,tyop_2Emin_2Ebool)] :
      ( ! [V3s_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27state)] :
        ? [V4x0_2E0: tyop_2Enum_2Enum,V5l_2E0: tyop_2Enum_2Enum] :
          ( p(c_2Eprim__rec_2E_3C_2E2(c_2Enum_2E0_2E0,V5l_2E0))
          & app_2E2(tyop_2Enum_2Enum,A_27state,V3s_2E0,V4x0_2E0) = app_2E2(tyop_2Enum_2Enum,A_27state,V3s_2E0,c_2Earithmetic_2E_2B_2E2(V4x0_2E0,V5l_2E0)) )
     => ( ? [V6i_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V7q_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27state)] :
            ( p(app_2E2(A_27state,tyop_2Emin_2Ebool,V1InitState_2E0,app_2E2(tyop_2Enum_2Enum,A_27state,V7q_2E0,c_2Enum_2E0_2E0)))
            & ! [V8t_2E0: tyop_2Enum_2Enum] : p(app_2E2(tyop_2Epair_2Eprod(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state)),tyop_2Emin_2Ebool,V0TransRel_2E0,c_2Epair_2E_2C_2E2(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state),app_2E2(tyop_2Enum_2Enum,A_27a,V6i_2E0,V8t_2E0),c_2Epair_2E_2C_2E2(A_27state,A_27state,app_2E2(tyop_2Enum_2Enum,A_27state,V7q_2E0,V8t_2E0),app_2E2(tyop_2Enum_2Enum,A_27state,V7q_2E0,c_2Earithmetic_2E_2B_2E2(V8t_2E0,c_2Earithmetic_2ENUMERAL_2E1(c_2Earithmetic_2EBIT1_2E1(c_2Earithmetic_2EZERO_2E0))))))))
            & ! [V9t1_2E0: tyop_2Enum_2Enum] :
              ? [V10t2_2E0: tyop_2Enum_2Enum] : p(app_2E2(A_27state,tyop_2Emin_2Ebool,V2Accept_2E0,app_2E2(tyop_2Enum_2Enum,A_27state,V7q_2E0,c_2Earithmetic_2E_2B_2E2(V9t1_2E0,V10t2_2E0)))) )
      <=> ? [V11x0_2E0: tyop_2Enum_2Enum,V12l_2E0: tyop_2Enum_2Enum,V13j_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V14p_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27state)] :
            ( p(c_2Eprim__rec_2E_3C_2E2(c_2Enum_2E0_2E0,V12l_2E0))
            & ! [V15t2_2E0: tyop_2Enum_2Enum] : app_2E2(tyop_2Enum_2Enum,A_27a,V13j_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,V15t2_2E0)) = app_2E2(tyop_2Enum_2Enum,A_27a,V13j_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,c_2Earithmetic_2EMOD_2E2(V15t2_2E0,V12l_2E0)))
            & ! [V16t2_2E0: tyop_2Enum_2Enum] : app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,V16t2_2E0)) = app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,c_2Earithmetic_2EMOD_2E2(V16t2_2E0,V12l_2E0)))
            & p(app_2E2(A_27state,tyop_2Emin_2Ebool,V1InitState_2E0,app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,c_2Enum_2E0_2E0)))
            & ! [V17t_2E0: tyop_2Enum_2Enum] :
                ( p(c_2Eprim__rec_2E_3C_2E2(V17t_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,V12l_2E0)))
               => p(app_2E2(tyop_2Epair_2Eprod(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state)),tyop_2Emin_2Ebool,V0TransRel_2E0,c_2Epair_2E_2C_2E2(A_27a,tyop_2Epair_2Eprod(A_27state,A_27state),app_2E2(tyop_2Enum_2Enum,A_27a,V13j_2E0,V17t_2E0),c_2Epair_2E_2C_2E2(A_27state,A_27state,app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,V17t_2E0),app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,c_2Earithmetic_2E_2B_2E2(V17t_2E0,c_2Earithmetic_2ENUMERAL_2E1(c_2Earithmetic_2EBIT1_2E1(c_2Earithmetic_2EZERO_2E0)))))))) )
            & ? [V18t_2E0: tyop_2Enum_2Enum] :
                ( p(c_2Eprim__rec_2E_3C_2E2(V18t_2E0,V12l_2E0))
                & p(app_2E2(A_27state,tyop_2Emin_2Ebool,V2Accept_2E0,app_2E2(tyop_2Enum_2Enum,A_27state,V14p_2E0,c_2Earithmetic_2E_2B_2E2(V11x0_2E0,V18t_2E0)))) ) ) ) ) )).
