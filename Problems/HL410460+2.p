...
fof(conj_thm_2Ereal__topology_2EREAL__EQ__LINV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( ap(c_2Erealax_2Ereal__neg,V0x) = V0x
      <=> V0x = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__EQ__RINV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( V0x = ap(c_2Erealax_2Ereal__neg,V0x)
      <=> V0x = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) )).

fof(conj_thm_2Ereal__topology_2EABS__TRIANGLE__EQ,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
