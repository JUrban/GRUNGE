...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__TRANS,conjecture,(
    ! [V0z: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V1s),inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3y)))
            & p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V1s),inj__ty_2Erealax_2Ereal(V3y)),inj__ty_2Erealax_2Ereal(V0z))) )
         => p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V1s),inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V0z))) ) ) )).
