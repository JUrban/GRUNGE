...
thf(f12615_0_2E0,type,(
    f12615_0_2E0: u )).

thf(f12615_0_2E2,type,(
    f12615_0_2E2: du > du > u )).

thf(f12615_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef12615_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f12615_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef12615_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f12615_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(thm_2Ereal_2EABS__TRIANGLE__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ V1y ) ) @ ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Ereal_2Eabs @ V0x ) @ ( mono_2Ec_2Ereal_2Eabs @ V1y ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ELIM__SUB,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2g_2E0: u,V5x_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f12615_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2g_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) )
      = ( mono_2Ec_2Ereal_2Ereal__sub @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2g_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__SUB,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1f_2E0: u,V2g_2E0: u,V3l: mono_2Etyop_2Erealax_2Ereal,V4m: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f12615_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2g_2E0 ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2Ereal__sub @ V3l @ V4m ) ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ELIM__UNIQUE,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1f_2E0: u,V2l: mono_2Etyop_2Erealax_2Ereal,V3l_27: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Etrivial__limit_2E1 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) )
        ...
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V3l_27 ) ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) ) )
     => ( V2l = V3l_27 ) ) )).

thf(thm_2Ereal__topology_2Ecauchy,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Ecauchy @ V0s )
    <=> ! [V1e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V2N: mono_2Etyop_2Enum_2Enum] :
            ! [V3m: mono_2Etyop_2Enum_2Enum,V4n: mono_2Etyop_2Enum_2Enum] :
             ...
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( V0s @ V3m ) @ ( V0s @ V4n ) ) ) @ V1e ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONVERGENT__IMP__CAUCHY,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ V0s @ V1l @ mono_2Ec_2Ereal__topology_2Esequentially )
     => ( mono_2Ec_2Ereal__topology_2Ecauchy @ V0s ) ) )).

thf(thm_2Ereal__topology_2ECONVERGENT__EQ__CAUCHY,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
...
thf(thm_2Ereal__topology_2ECAUCHY__CONTINUOUS__UNIQUENESS__LEMMA,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
          ( ( ( mono_2Ec_2Ereal__topology_2Ecauchy @ V2x )
            & ! [V3n: mono_2Etyop_2Enum_2Enum] :
                ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V2x @ V3n ) @ V1s ) )
         => ( mono_2Ec_2Ereal__topology_2Ecauchy @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V2x ) ) )
     => ! [V4a: mono_2Etyop_2Erealax_2Ereal,V5x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
          ( ( ! [V6n: mono_2Etyop_2Enum_2Enum] :
                ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V5x @ V6n ) @ V1s )
            & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ V5x @ V4a @ mono_2Ec_2Ereal__topology_2Esequentially ) )
         => ? [V7l: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V5x ) @ V7l @ mono_2Ec_2Ereal__topology_2Esequentially )
              & ! [V8y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
                  ( ( ! [V9n: mono_2Etyop_2Enum_2Enum] :
                        ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V8y @ V9n ) @ V1s )
                    & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ V8y @ V4a @ mono_2Ec_2Ereal__topology_2Esequentially ) )
                 => ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V8y ) @ V7l @ mono_2Ec_2Ereal__topology_2Esequentially ) ) ) ) ) )).
