...
thf(thm_2Ecardinal_2ECARD__EQ__CARD,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1t ) )
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,axiom,(
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__FINITE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
