...
fof(thm_2Erich__list_2ELIST__TO__SET__EQ__SING,conjecture,(
    ! [A_27a,V0x_2E0,V1ls_2E0] :
      ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(A_27a),V1ls_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EINSERT_2E2(s(A_27a,V0x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)))
    <=> ( s(tyop_2Elist_2Elist(A_27a),V1ls_2E0) != s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)
        & p(s(tyop_2Emin_2Ebool,c_2Elist_2EEVERY_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Emin_2E_3D_2E1(s(A_27a,V0x_2E0))),s(tyop_2Elist_2Elist(A_27a),V1ls_2E0)))) ) ) )).
