...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__DELETE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
...
tff(conj_thm_2Elist_2ESUM__IMAGE__LIST__TO__SET__upper__bound,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
         => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V0f),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1ls))),ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1ls)))) ) ) )).
