...
fof(conj_thm_2Ereal__topology_2ELIM__MAX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
                 ...
                 => ! [V3l] :
                     ...
                     => ! [V4m] :
                         ...
                         => ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),V3l),V0net))
                           ...
                           => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3747(A_27a,V1f,V2g)),ap(ap(c_2Ereal_2Emax,V3l),V4m)),V0net)) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__MAX,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
