...
tff(conj_thm_2Equotient__list_2ECONS__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
         => ! [V2rep: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => ! [V3t: $i] :
                   ...
                   => ! [V4h: $i] :
                        ( mem(V4h,A_27b)
                       => ap(ap(c_2Elist_2ECONS(A_27b),V4h),V3t) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1abs),ap(ap(c_2Elist_2ECONS(A_27a),ap(V2rep,V4h)),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V3t))) ) ) ) ) ) ) )).
