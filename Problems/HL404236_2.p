...
tff(conj_thm_2Elist_2EFILTER__ALL__DISTINCT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Erich__list_2EFILTER__MAP,lemma,(
...
tff(conj_thm_2Eupdate_2ELIST__UPDATE__OVERRIDE,lemma,(
...
tff(conj_thm_2Eupdate_2ELIST__UPDATE__ALL__DISTINCT,lemma,(
    ! [A_27a: del,A_27b: del,V0l1: $i] :
     ...
     => ! [V1l2: $i] :
         ...
         => ( ( p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1l2)))
              & p(ap(ap(c_2Esorting_2EPERM(ty_2Epair_2Eprod(A_27a,A_27a)),V0l1),V1l2)) )
           => ap(c_2Eupdate_2ELIST__UPDATE(A_27a,A_27a),V0l1) = ap(c_2Eupdate_2ELIST__UPDATE(A_27a,A_27a),V1l2) ) ) ) )).

tff(conj_thm_2Eupdate_2ELIST__UPDATE__SORT__OVERRIDE,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Epair_2Eprod(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
         => ap(c_2Eupdate_2ELIST__UPDATE(A_27a,A_27a),V1l) = ap(c_2Eupdate_2ELIST__UPDATE(A_27a,A_27a),ap(ap(c_2Esorting_2EQSORT(ty_2Epair_2Eprod(A_27a,A_27a)),V0R),ap(c_2Eupdate_2EOVERRIDE(A_27a,A_27a),V1l))) ) ) )).
