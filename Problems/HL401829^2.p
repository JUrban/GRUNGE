...
thf(conj_thm_2Epred__set_2ESURJ__COMPOSE,lemma,(
...
thf(conj_thm_2Epred__set_2EPOW__EMPTY,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0s )
       != ( c_2Epred__set_2EEMPTY @ ( arr @ A_27a @ bool ) ) ) ) )).

thf(conj_thm_2Epred__set_2Einj__surj,lemma,(
...
thf(conj_thm_2Epred__set_2Epow__no__surj,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ~ ? [V1f: $i] :
...
thf(conj_thm_2Epred__set_2Einfinite__pow__uncountable,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
