...
thf(conj_thm_2Ellist_2ELTL__LAPPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0l1 ) @ V1l2 ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V0l1 ) @ ( c_2Ellist_2ELNIL @ A_27a ) ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V1l2 ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V0l1 ) ) ) @ V1l2 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELTL__LREPEAT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l ) )
        = ( ap
          @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ( ty_2Ellist_2Ellist @ A_27a ) @ ( ty_2Ellist_2Ellist @ A_27a ) )
            @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
              @ ^ [V1t: $i] :
                  ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1t ) @ ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l ) ) ) )
