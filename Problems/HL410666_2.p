...
tff(conj_thm_2Ereal__topology_2EOPEN__SEGMENT__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
