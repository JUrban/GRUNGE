...
tff(conj_thm_2Ecardinal_2EFINITE__IMP__COUNTABLE,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNCOUNTABLE__OPEN,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EFINITE__IMP__NOT__OPEN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
