...
fof(conj_thm_2Erich__list_2ETAKE__APPEND2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
         ...
         => ! [V1n] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l1)),V1n))
               => ! [V2l2] :
                    ( mem(V2l2,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Elist_2ETAKE(A_27a),V1n),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V2l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),ap(ap(c_2Elist_2ETAKE(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l1))),V2l2)) ) ) ) ) ) )).
