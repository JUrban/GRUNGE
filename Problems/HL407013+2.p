...
fof(ax_thm_2Einteger__word_2Esaturate__i2w__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0i] :
         ...
         => ap(c_2Einteger__word_2Esaturate__i2w(A_27a),V0i) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger__word_2EUINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))),V0i)),c_2Ewords_2Eword__T(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__lt,V0i),ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0))),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),ap(c_2Ewords_2En2w(A_27a),ap(c_2Einteger_2ENum,V0i)))) ) ) )).
...
fof(conj_thm_2Einteger__word_2Esaturate__i2sw,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Einteger_2Eint)
