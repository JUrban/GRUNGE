...
tff(conj_thm_2Eextreal_2Esup__mono,conjecture,(
    ! [V0p: $i] :
     ...
     => ! [V1q: $i] :
         ...
         => ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0p,inj__ty_2Enum_2Enum(V2n))),ap(V1q,inj__ty_2Enum_2Enum(V2n))))
           => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0p),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1q),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) ) ) ) )).
