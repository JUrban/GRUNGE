...
tff(lmtp_f1869,type,(
    f1869: ( del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f1869,axiom,(
...
tff(lmtp_f1868,type,(
    f1868: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1868,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(A_27a,arr(A_27b,bool)))
         => ! [V0f: $i] :
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__PRODUCT__DEPENDENT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27c)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2Ecountable(A_27a),V1s))
               ...
               => p(ap(c_2Epred__set_2Ecountable(A_27c),ap(c_2Epred__set_2EGSPEC(A_27c,A_27c),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1868(A_27b,A_27c,A_27a,A_27a,V1s,V2t,V0f))))) ) ) ) ) )).
