...
thf(thm_2Ebag_2EBAG__DELETE__commutes,conjecture,(
    ! [A_27a: $tType,V0b0: A_27a > tyop_2Enum_2Enum,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum,V3e1: A_27a,V4e2: A_27a] :
      ( ( ( c_2Ebag_2EBAG__DELETE @ A_27a @ V0b0 @ V3e1 @ V1b1 )
        & ( c_2Ebag_2EBAG__DELETE @ A_27a @ V1b1 @ V4e2 @ V2b2 ) )
     => ? [V5b_27: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2EBAG__DELETE @ A_27a @ V0b0 @ V4e2 @ V5b_27 )
          & ( c_2Ebag_2EBAG__DELETE @ A_27a @ V5b_27 @ V3e1 @ V2b2 ) ) ) )).
