    ...
    & ! [V1r: tp__ty_2Enum_2Enum] :
        ( ( p
          @ ( ap
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V2n: $i] :
                  ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
...
thf(conj_thm_2EternaryComparisons_2Enum2ordering__ordering2num,conjecture,(
    ! [V0a: tp__ty_2EternaryComparisons_2Eordering] :
      ( ( surj__ty_2EternaryComparisons_2Eordering @ ( ap @ c_2EternaryComparisons_2Enum2ordering @ ( ap @ c_2EternaryComparisons_2Eordering2num @ ( inj__ty_2EternaryComparisons_2Eordering @ V0a ) ) ) )
      = V0a ) )).
