...
tff(conj_thm_2Erelation_2EALT__equivalence,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Esorting_2EPERM__EQUIVALENCE,lemma,(
    ! [A_27a: del] : p(ap(c_2Erelation_2Eequivalence(ty_2Elist_2Elist(A_27a)),c_2Esorting_2EPERM(A_27a))) )).

tff(conj_thm_2Esorting_2EPERM__EQUIVALENCE__ALT__DEF,conjecture,(
    ! [A_27a: del,V0x: $i] :
