...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELMAP_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27b_2CA_27a_29_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ c_2Ellist_2ELMAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Ellist_2ELUNFOLD_2E2_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27c ) ) ) @ c_2Ellist_2ELUNFOLD_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Epath_2Elabels_2E1_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27b @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27b @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ c_2Epath_2Elabels_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27b @ A_27c ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Epath_2Elabels__LMAP,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27b ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( c_2Epair_2ESND_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) ) @ ( c_2Epath_2EfromPath_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Epath_2Elabels__unfold,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0proj_2E0: u,V1f_2E0: u,V2s_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27b @ A_27c ) @ ( c_2Epath_2Eunfold_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0proj_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V2s_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V2s_2E0 ) ) ) ) )).
