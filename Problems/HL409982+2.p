...
fof(mem_c_2Eextreal_2Eextreal__inf,axiom,(
...
fof(lamtp_f3472,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => mem(f3472(V0f),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f3472,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V3n] :
          ( mem(V3n,ty_2Enum_2Enum)
         => ap(f3472(V0f),V3n) = ap(V0f,ap(c_2Enum_2ESUC,V3n)) ) ) )).

fof(conj_thm_2Eextreal_2Ele__inf,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Eextreal_2Eextreal)
         => ( p(ap(ap(c_2Eextreal_2Eextreal__le,V1x),ap(c_2Eextreal_2Eextreal__inf,V0p)))
          <=> ! [V2y] :
                ( mem(V2y,ty_2Eextreal_2Eextreal)
               => ( p(ap(V0p,V2y))
                 => p(ap(ap(c_2Eextreal_2Eextreal__le,V1x),V2y)) ) ) ) ) ) )).

fof(conj_thm_2Eextreal_2Einf__le,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Eextreal_2Eextreal)
         => ( p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__inf,V0p)),V1x))
          <=> ! [V2y] :
                ( mem(V2y,ty_2Eextreal_2Eextreal)
               => ( ! [V3z] :
...
fof(conj_thm_2Eextreal_2Einf__eq,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Eextreal_2Eextreal)
         => ( ap(c_2Eextreal_2Eextreal__inf,V0p) = V1x
          <=> ( ! [V2y] :
                  ( mem(V2y,ty_2Eextreal_2Eextreal)
                 => ( p(ap(V0p,V2y))
                   => p(ap(ap(c_2Eextreal_2Eextreal__le,V1x),V2y)) ) )
              & ! [V3y] :
                 ...
                 => ( ! [V4z] :
                       ...
                       => ( p(ap(V0p,V4z))
                         => p(ap(ap(c_2Eextreal_2Eextreal__le,V3y),V4z)) ) )
                   => p(ap(ap(c_2Eextreal_2Eextreal__le,V3y),V1x)) ) ) ) ) ) ) )).

fof(conj_thm_2Eextreal_2Einf__suc,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( ! [V1m] :
            ( mem(V1m,ty_2Enum_2Enum)
           => ! [V2n] :
               ...
               => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V2n))
                 => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0f,V2n)),ap(V0f,V1m))) ) ) )
       => ap(c_2Eextreal_2Eextreal__inf,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3472(V0f)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) = ap(c_2Eextreal_2Eextreal__inf,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) )).
