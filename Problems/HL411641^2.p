...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE__CLOSED__MAP,lemma,(
    ! [V0f: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ V2s ) )
                      ...
                      & ! [V4x: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) )
                            = V4x ) )
                      & ! [V5u: $i] :
                          ( ( mem @ V5u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                         => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) ) @ V5u ) )
                           => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V3t ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V5u ) ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__CLOSED__MAP,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
