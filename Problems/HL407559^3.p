...
thf(c_2Ereal_2ENUM__CEILING,type,(
    c_2Ereal_2ENUM__CEILING: tyop_2Erealax_2Ereal > tyop_2Enum_2Enum )).

thf(c_2Ereal_2ENUM__FLOOR,type,(
    c_2Ereal_2ENUM__FLOOR: tyop_2Erealax_2Ereal > tyop_2Enum_2Enum )).
...
thf(thm_2Ereal_2ENUM__FLOOR__def,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal_2ENUM__FLOOR @ V0x )
      = ( c_2Ewhile_2ELEAST
        @ ^ [V1n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__gt @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2E_2B @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0x ) ) ) )).

thf(thm_2Ereal_2ENUM__CEILING__def,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal_2ENUM__CEILING @ V0x )
      = ( c_2Ewhile_2ELEAST
        @ ^ [V1n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ V0x @ ( c_2Ereal_2Ereal__of__num @ V1n ) ) ) ) )).

thf(thm_2Ereal_2ENUM__FLOOR__LET,axiom,(
    ! [V0y: tyop_2Enum_2Enum,V1x: tyop_2Erealax_2Ereal] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Ereal_2ENUM__FLOOR @ V1x ) @ V0y )
      = ( c_2Erealax_2Ereal__lt @ V1x @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ V0y ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )).
...
thf(thm_2Ereal_2ENUM__FLOOR__DIV__LOWERBOUND,axiom,(
    ! [V0y: tyop_2Erealax_2Ereal,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Erealax_2Ereal__lt @ V1x @ ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2E_2B @ ( c_2Ereal_2ENUM__FLOOR @ ( c_2Ereal_2E_2F @ V1x @ V0y ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0y ) ) ) )).

thf(thm_2Ereal_2ENUM__FLOOR__BASE,axiom,(
    ! [V0r: tyop_2Erealax_2Ereal] :
      ( ( c_2Erealax_2Ereal__lt @ V0r @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
     => ( ( c_2Ereal_2ENUM__FLOOR @ V0r )
        = c_2Enum_2E0 ) ) )).
...
thf(thm_2Ereal_2ENUM__CEILING__NUM__FLOOR,conjecture,(
    ! [V0r: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal_2ENUM__CEILING @ V0r )
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
        @ ^ [V1n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebool_2E_5C_2F @ ( c_2Ereal_2Ereal__lte @ V0r @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V0r @ ( c_2Ereal_2Ereal__of__num @ V1n ) ) ) @ V1n @ ( c_2Earithmetic_2E_2B @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
        @ ( c_2Ereal_2ENUM__FLOOR @ V0r ) ) ) )).
