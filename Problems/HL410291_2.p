...
tff(conj_thm_2Epred__set_2EFINITE__DIFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(lamtp_f3450,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => mem(f3450(A_27a,V1f,V0s),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f3450,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3450(A_27a,V1f,V0s),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V0s)),ap(V1f,V2x)),ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IN__IF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1f: $i] :
            ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3450(A_27a,V1f,V0s)),V0s)) ) ) ) )).
...
tff(lamtp_f3607,axiom,(
    ! [A_27a: del,V2b: $i] :
     ...
     => ! [V5a: $i] :
         ...
         => ! [V6x: $i] :
              ( mem(V6x,A_27a)
             => mem(f3607(A_27a,V2b,V5a,V6x),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) ) ) )).
...
tff(lameq_f3607,axiom,(
    ! [A_27a: del,V2b: $i] :
     ...
     => ! [V5a: $i] :
         ...
         => ! [V6x: $i] :
              ( mem(V6x,A_27a)
             => ! [V7i: tp__ty_2Enum_2Enum] : ap(f3607(A_27a,V2b,V5a,V6x),inj__ty_2Enum_2Enum(V7i)) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),V5a),ap(V2b,inj__ty_2Enum_2Enum(V7i)))),V6x) ) ) ) )).

tff(lmtp_f3606,type,(
    f3606: ( del * $i * $i * $i ) > $i )).

tff(lamtp_f3606,axiom,(
    ! [A_27a: del,V2b: $i] :
      ( mem(V2b,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5a: $i] :
          ( mem(V5a,arr(A_27a,bool))
         => ! [V0r: $i] :
             ...
             => mem(f3606(A_27a,V2b,V5a,V0r),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) ) )).
    ...
    ! [A_27a: del,V2b: $i] :
     ...
     => ! [V5a: $i] :
         ...
         => ! [V0r: $i] :
             ...
             => ! [V6x: $i] :
                  ( mem(V6x,A_27a)
                 => ap(f3606(A_27a,V2b,V5a,V0r),V6x) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Enum_2Enum),f3607(A_27a,V2b,V5a,V6x)),V0r) ) ) ) ) )).

tff(conj_thm_2Emeasure_2Eindicator__fn__split,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Enum_2Enum,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2b: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0r))
                  & ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2b),V0r)) = V1s
               ...
               => ! [V5a: $i] :
                   ...
                   => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V5a),V1s))
                     => ap(c_2Emeasure_2Eindicator__fn(A_27a),V5a) = f3606(A_27a,V2b,V5a,V0r) ) ) ) ) ) ) )).
