...
fof(lamtp_f289,axiom,(
    ! [A_27a,A_27a,V0set] :
      ( mem(V0set,arr(A_27a,bool))
     => mem(f289(A_27a,A_27a,V0set),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).

fof(lameq_f289,axiom,(
    ! [A_27a,A_27a,V0set] :
      ( mem(V0set,arr(A_27a,bool))
     => ! [V1s] :
          ( mem(V1s,arr(A_27a,bool))
         => ap(f289(A_27a,A_27a,V0set),V1s) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1s),ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1s),V0set)) ) ) )).

fof(ax_thm_2Epred__set_2EPOW__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0set] :
          ( mem(V0set,arr(A_27a,bool))
         => ap(c_2Epred__set_2EPOW(A_27a),V0set) = ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f289(A_27a,A_27a,V0set)) ) ) )).

fof(conj_thm_2Epred__set_2EPOW__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Epred__set_2EPOW__EQNS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
