...
fof(conj_thm_2Ereal__topology_2ECOMPACT__LEMMA,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
         ...
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V1s))
                  & ! [V2n] :
                      ( mem(V2n,ty_2Enum_2Enum)
                     => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0x,V2n)),V1s)) ) )
               => ? [V3l] :
                    ( mem(V3l,ty_2Erealax_2Ereal)
                    & ? [V4r] :
                        ( mem(V4r,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
                           ...
                           => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V7e))
                             => ? [V8N] :
                                  ...
                                  & ! [V9n] :
                                     ...
                                     => ! [V10i] :
                                          ( mem(V10i,A_27a)
                                         => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V8N),V9n))
                                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,ap(V4r,V9n))),V3l))),V7e)) ) ) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOUNDED__CLOSED__IMP__COMPACT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
