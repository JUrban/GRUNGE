...
thf(conj_thm_2Ecardinal_2ECARDLEQ__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( ( mem @ V0s1 @ ( arr @ A_27a @ bool ) )
     => ! [V1s2: $i] :
          ( ( mem @ V1s2 @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2EPOW__TWO__set__exp,lemma,(
    ! [A_27a: del,V0A: $i] :
...
thf(conj_thm_2Ecardinal_2Eset__exp__card__cong,lemma,(
...
thf(conj_thm_2Ecardinal_2Eset__exp__cardle__cong,lemma,(
...
thf(conj_thm_2Ecardinal_2Ecardlt__cardle,lemma,(
...
thf(conj_thm_2Ecardinal_2Eset__exp__product,lemma,(
...
thf(conj_thm_2Epred__set_2EFINITE__DIFF__down,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1Q: $i] :
          ( ( mem @ V1Q @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ecardinal_2EPOW__EQ__X__EXP__X,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ A_27a @ bool ) )
