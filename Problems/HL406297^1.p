...
thf(thm_2Ewords_2En2w__itself__ind,conjecture,(
    ! [A_27a: d,V0P_2E0: u] :
      ( ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) ) )
     => ! [V2v: mono_2Etyop_2Enum_2Enum,V3v1_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2v ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ V3v1_2E0 ) ) ) ) ) ) ) )).
