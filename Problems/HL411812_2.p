...
tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(lameq_f4052,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0x: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
             => ! [V6n: tp__ty_2Enum_2Enum] : ap(f4052(V1s,V0x,V2f),inj__ty_2Enum_2Enum(V6n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s)),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V6n)))),V0x)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V6n)))),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0x),V2f))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE__STRONG,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s)),f4039(V0x)))
                  & ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
                      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4m)),V1s))
                        ...
                        & surj__ty_2Enum_2Enum(ap(V2f,inj__ty_2Enum_2Enum(V4m))) = surj__ty_2Enum_2Enum(ap(V2f,inj__ty_2Enum_2Enum(V5n))) )
                     => V4m = V5n ) )
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4052(V1s,V0x,V2f)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
