...
tff(thm_2Epred__set_2ESING__applied,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2EINSERT_2E3(s(A_27a,V1y_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0),s(A_27a,V0x_2E0)))))
    <=> s(A_27a,V0x_2E0) = s(A_27a,V1y_2E0) ) )).
