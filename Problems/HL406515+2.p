...
fof(lamtp_f2309,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => mem(f2309(V0f),arr(ty_2Elist_2Elist(bool),ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(lameq_f2309,axiom,(
    ! [V0f] :
     ...
     => ! [V2l] :
          ( mem(V2l,ty_2Elist_2Elist(bool))
         => ap(f2309(V0f),V2l) = ap(c_2Ebitstring_2Ev2w(ty_2Eone_2Eone),ap(ap(c_2Elist_2ECONS(bool),ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),V0f),ap(c_2Elist_2EHD(bool),V2l)),ap(c_2Elist_2ETL(bool),V2l))),c_2Elist_2ENIL(bool))) ) ) )).

fof(conj_thm_2Ebitstring_2Eword__reduce__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(bool,arr(bool,bool)))
         => ! [V1v] :
              ( mem(V1v,ty_2Elist_2Elist(bool))
             => ap(ap(c_2Ewords_2Eword__reduce(A_27a),V0f),ap(c_2Ebitstring_2Ev2w(A_27a),V1v)) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2309(V0f)),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V1v)) ) ) ) )).
