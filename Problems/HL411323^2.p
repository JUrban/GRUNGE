...
thf(conj_thm_2Ereal__topology_2EBOUNDED__CLOSURE__EQ,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__GT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ~ ( p
...
thf(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ~ ( p
        @ ( ap @ c_2Ereal__topology_2Ebounded__def
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
