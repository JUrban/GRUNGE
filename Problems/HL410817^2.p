...
thf(conj_thm_2Ereal__topology_2EINTERIOR__FRONTIER,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) )
        = ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__FRONTIER__EMPTY,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
          | ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) ) )
