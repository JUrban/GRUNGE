...
fof(conj_thm_2Ebit_2EBITS__SUM3,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1a] :
          ( mem(V1a,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1b] :
                 ...
                 => ! [V2h] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2h))
                       ...
                       => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b)) = ap(ap(c_2Ewords_2Eword__add(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V0a)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V1b)) ) ) ) ) ) ) )).
