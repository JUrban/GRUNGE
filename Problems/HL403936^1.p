...
thf(f4208_0_2E0,type,(
    f4208_0_2E0: u )).

thf(f4208_0_2E2,type,(
    f4208_0_2E2: du > du > u )).
...
thf(c_2Elist_2EAPPEND_2E1,type,(
...
thf(arityeq2_2Emono_2Ef4208_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4208_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f4208_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Elist_2EAPPEND_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2EAPPEND_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2Elist_2EAPPEND_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2ELLENGTH__APPEND,axiom,(
    ! [A_27a: d,V0ll1_2E0: u,V1ll2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4208_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELLENGTH__APPEND,axiom,(
    ! [A_27a: d,V0ll1_2E0: u,V1ll2_2E0: u] :
      ( ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) ) ) )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4208_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) ) @ ( mono_2Ec_2Eoption_2ESOME_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Eoption_2ETHE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) ) ) ) ) @ ( mono_2Ec_2Eoption_2ETHE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) ) ) ) ) @ mono_2Ec_2Eoption_2ENONE_2Emono_2Etyop_2Enum_2Enum ) ) )).
...
thf(thm_2Ellist_2ELTAKE__LAPPEND2,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1l1_2E0: u,V2l2_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l2_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2EAPPEND_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V0n @ ( mono_2Ec_2Eoption_2ETHE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l1_2E0 ) ) ) ) ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l2_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2EtoList__LAPPEND__APPEND,conjecture,(
