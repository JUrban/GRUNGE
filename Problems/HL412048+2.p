...
fof(mem_c_2Elebesgue_2Eprod__measure__space3,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Elebesgue_2Eprod__measure__space3(A_27a,A_27a,A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)),arr(ty_2Epair_2Eprod(arr(A_27c,bool),arr(A_27c,bool)),ty_2Epair_2Eprod(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)))))) ) ) ) )).
...
fof(mem_c_2Elebesgue_2Eprod__sets3,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Elebesgue_2Eprod__sets3(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,bool),bool),arr(arr(arr(A_27b,bool),bool),arr(arr(arr(A_27c,bool),bool),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),bool))))) ) ) ) )).

fof(lamtp_f4110,axiom,(
    ! [A_27a,A_27b,A_27c,A_27c,V0a] :
...
fof(lamtp_f4109,axiom,(
    ! [A_27c,A_27c,A_27b,A_27a,A_27b,V0a] :
      ( mem(V0a,arr(arr(A_27a,bool),bool))
     => ! [V1b] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V2c] :
...
fof(lamtp_f4108,axiom,(
    ! [A_27b,A_27a,A_27c,A_27a,V2c] :
      ( mem(V2c,arr(arr(A_27c,bool),bool))
     => ! [V1b] :
          ( mem(V1b,arr(arr(A_27b,bool),bool))
         => ! [V0a] :
...
fof(conj_thm_2Elebesgue_2Efinite__prod__measure__space__POW3,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
