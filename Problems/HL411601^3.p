...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON,axiom,(
    ...
    <=> ! [V2x: tyop_2Erealax_2Ereal] :
         ...
         => ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Erealax_2Ereal @ V0f @ ( V0f @ V2x ) @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V2x ) @ V1s ) ) ) ) )).

thf(thm_2Ereal__topology_2ELIM__WITHIN__UNION,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1t: tyop_2Erealax_2Ereal > $o,V2s: tyop_2Erealax_2Ereal > $o,V3l: tyop_2Erealax_2Ereal,V4f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Erealax_2Ereal @ V4f @ V3l @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V0x ) @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V2s @ V1t ) ) )
    <=> ( ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Erealax_2Ereal @ V4f @ V3l @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V0x ) @ V2s ) )
        & ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Erealax_2Ereal @ V4f @ V3l @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V0x ) @ V1t ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__UNION,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( c_2Ereal__topology_2Econtinuous__on @ V0f @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V1s @ V2t ) ) ) )).
