...
thf(tp_c_2Erich__list_2ESPLITP,type,(
    c_2Erich__list_2ESPLITP: del > $i )).

thf(mem_c_2Erich__list_2ESPLITP,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ ( arr @ ( arr @ A_27a @ bool ) @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Epair_2Eprod @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) )).
...
thf(ax_thm_2Erich__list_2ESPLITP,axiom,(
    ! [A_27a: del] :
      ( ! [V0P: $i] :
          ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ V0P ) @ ( c_2Elist_2ENIL @ A_27a ) )
            = ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) )
      & ! [V1P: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3l: $i] :
                  ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27a ) )
                 => ( ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ V1P ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V3l ) )
                    = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Epair_2Eprod @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ V1P @ V2x ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V3l ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( ap @ ( c_2Epair_2EFST @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ V1P ) @ V3l ) ) ) ) @ ( ap @ ( c_2Epair_2ESND @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ V1P ) @ V3l ) ) ) ) ) ) ) ) ) )).

thf(ax_thm_2Erich__list_2EPREFIX__DEF,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2EPREFIX @ A_27a ) @ V0P ) @ V1l )
            = ( ap @ ( c_2Epair_2EFST @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ bool @ bool ) @ c_2Ebool_2E_7E ) @ V0P ) ) @ V1l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EPREFIX__FOLDR,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
