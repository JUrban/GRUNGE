...
tff(conj_thm_2Ereal__topology_2ECLOSEST__POINT__EXISTS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
            & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V1a))),V0s))
            & ! [V2y: tp__ty_2Erealax_2Ereal] :
                ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),V0s))
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V1a))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2y))))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESETDIST__UNIQUE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ESETDIST__CLOSEST__POINT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
     ...
     => ( ( p(ap(c_2Ereal__topology_2EClosed,V1s))
       ...
       => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V1s))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),ap(ap(c_2Ereal__topology_2Eclosest__point,V1s),inj__ty_2Erealax_2Ereal(V0a))))) ) ) )).
