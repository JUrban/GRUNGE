    ...
    ! [A_27a: $tType,V0h: A_27a,V1t: tyop_2Ellist_2Ellist @ A_27a] :
      ...
      = ( c_2Ellist_2Ellist__abs @ A_27a
        @ ^ [V2n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V2n @ c_2Enum_2E0 ) @ ( c_2Eoption_2ESOME @ A_27a @ V0h ) @ ( c_2Ellist_2Ellist__rep @ A_27a @ V1t @ ( c_2Earithmetic_2E_2D @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).

thf(thm_2Ellist_2Ellist__rep__LCONS,conjecture,(
