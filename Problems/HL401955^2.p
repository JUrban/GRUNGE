...
thf(conj_thm_2Eset__relation_2Efinite__prefixes__inj__image,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
                        ...
                        @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) @ bool ) )
                          @ ( lam @ A_27a
                            @ ^ [V5x: $i] :
                                ( lam @ A_27a
                                @ ^ [V6y: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ A_27b ) @ ( ap @ V0f @ V5x ) ) @ ( ap @ V0f @ V6y ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V5x ) @ V6y ) ) @ V1r ) ) ) ) ) ) )
