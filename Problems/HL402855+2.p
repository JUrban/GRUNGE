...
fof(conj_thm_2Elist_2EFRONT__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0x] :
            ( mem(V0x,A_27a)
...
fof(conj_thm_2Elist_2ELENGTH__FRONT__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Erich__list_2EEL__FRONT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V1n),ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2EFRONT(A_27a),V0l))))
                  & ~ p(ap(c_2Elist_2ENULL(A_27a),V0l)) )
               => ap(ap(c_2Elist_2EEL(A_27a),V1n),ap(c_2Elist_2EFRONT(A_27a),V0l)) = ap(ap(c_2Elist_2EEL(A_27a),V1n),V0l) ) ) ) ) )).
