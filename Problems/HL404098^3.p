    ...
    ! [V0c: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V3t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1b @ V3t ) ) )
        = ( ^ [V4t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V4t ) @ ( c_2Ebool_2E_2F_5C @ ( V1b @ V4t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a @ V4t ) ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V5t ) @ ( c_2ETemporal__Logic_2ESUNTIL @ V1b @ V0c @ V5t ) ) )
        = ( ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2EPast__Temporal__Logic_2EPNEXT
                @ ^ [V7t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V2a @ V7t ) @ ( V0c @ V7t ) )
                @ V6t )
              @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2ESUNTIL @ V1b @ V0c @ V6t )
                @ ( c_2EPast__Temporal__Logic_2EPNEXT
                  @ ^ [V8t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2a @ V8t ) @ ( V1b @ V8t ) )
                  @ V6t ) ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V9t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V9t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V1b @ V0c @ V9t ) ) )
        = ( ^ [V10t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2EPast__Temporal__Logic_2EPNEXT
                @ ^ [V11t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V2a @ V11t ) @ ( c_2Ebool_2E_2F_5C @ ( V1b @ V11t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V11t ) ) ) )
                @ V10t )
              @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2EBEFORE @ V1b @ V0c @ V10t )
                @ ( c_2EPast__Temporal__Logic_2EPNEXT
                  @ ^ [V12t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2a @ V12t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V12t ) ) )
                  @ V10t ) ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V13t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V13t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1b @ V13t ) ) )
        = ( ^ [V14t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V14t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a @ V14t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V15t ) @ ( c_2ETemporal__Logic_2ESUNTIL @ V1b @ V0c @ V15t ) ) )
        = ( ^ [V16t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2EPast__Temporal__Logic_2EPNEXT
                @ ^ [V17t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( V2a @ V17t ) @ ( V0c @ V17t ) )
                @ V16t )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V18t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V18t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V1b @ V0c @ V18t ) ) )
        = ( ^ [V19t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C
              @ ( c_2EPast__Temporal__Logic_2EPNEXT
                @ ^ [V20t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( V2a @ V20t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V20t ) ) )
                @ V19t )
