...
fof(conj_thm_2Estate__transformer_2EEXT__UNIT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Estate__transformer_2EMMAP__ID,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),c_2Ecombin_2EI(A_27b)) = c_2Ecombin_2EI(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))) ) ) )).
