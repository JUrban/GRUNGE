...
thf(thm_2Einteger_2EINT__MUL__CALCULATE,axiom,
    ...
    & ! [V2x: mono_2Etyop_2Einteger_2Eint,V3y: mono_2Etyop_2Einteger_2Eint] :
        ( ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__neg @ V2x ) @ V3y )
        = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__mul @ V2x @ V3y ) ) )
    & ! [V4x: mono_2Etyop_2Einteger_2Eint,V5y: mono_2Etyop_2Einteger_2Eint] :
        ( ( mono_2Ec_2Einteger_2Eint__mul @ V4x @ ( mono_2Ec_2Einteger_2Eint__neg @ V5y ) )
        = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__mul @ V4x @ V5y ) ) )
    & ! [V6x: mono_2Etyop_2Einteger_2Eint] :
        ( ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__neg @ V6x ) )
        = V6x ) )).
...
thf(thm_2Einteger__word_2Eword__i2w__mul,conjecture,(
    ! [A_27a: d,V0a: mono_2Etyop_2Einteger_2Eint,V1b: mono_2Etyop_2Einteger_2Eint] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__mul_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Ei2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ V0a ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Ei2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ V1b ) ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Ei2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ ( mono_2Ec_2Einteger_2Eint__mul @ V0a @ V1b ) ) ) ) ) ) )).
