...
fof(lamtp_f3283,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f3283(V0n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).
...
fof(lameq_f3283,axiom,(
    ! [V0n] :
     ...
     => ! [V1x] :
         ...
         => ap(f3283(V0n),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1x),ap(ap(c_2Earithmetic_2E_3C_3D,V1x),V0n)) ) ) )).

fof(conj_thm_2Eiterate_2ENUMSEG__LE,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3283(V0n)) = ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V0n) ) )).
