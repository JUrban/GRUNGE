...
tff(conj_thm_2Ereal__topology_2EEXISTS__FINITE__SUBSET__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUBSET__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),V1s),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2t)))
              <=> ? [V3u: $i] :
                    ( mem(V3u,arr(A_27a,bool))
                    & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V3u),V2t))
                    & V1s = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V3u) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL__SUBTOPOLOGY,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
      <=> ! [V1f: $i] :
