      ...
      @ ( lam @ ty_2Enum_2Enum
        @ ^ [V0n: $i] :
            ...
            @ ^ [V1t: $i] :
                ( lam @ ty_2Enum_2Enum
                @ ^ [V2r: $i] :
                    ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2r ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Enumpair_2Enlen__thm,conjecture,(
