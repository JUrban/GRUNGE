...
fof(lamtp_f429,axiom,(
    ! [A_27a,V1n] :
      ( mem(V1n,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => mem(f429(A_27a,V1n,V0f),arr(ty_2Enum_2Enum,A_27a)) ) ) )).
    ...
    ! [A_27a,V1n] :
     ...
     => ! [V0f] :
         ...
         => ! [V2m] :
             ...
             => ap(f429(A_27a,V1n,V0f),V2m) = ap(V0f,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Eprim__rec_2EPRE,V1n)),V2m)) ) ) ) )).

fof(conj_thm_2Elist_2EREVERSE__GENLIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
