...
thf(conj_thm_2Elist_2EALL__DISTINCT__GENLIST,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Esorting_2EPERM__ALL__DISTINCT,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
thf(conj_thm_2Esorting_2EPERM__SET__TO__LIST__count__COUNT__LIST,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
