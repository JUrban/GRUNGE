...
tff(conj_thm_2Eiterate_2ENSUM__IMAGE__NONZERO,conjecture,(
     ...
     => ! [V1i: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               ...
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1i),V2s)),V0d)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V0d),V1i))) ) ) ) ) )).
