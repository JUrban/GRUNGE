...
thf(thm_2EHolSmt_2Er229,conjecture,(
    ! [V0z: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2x: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Erealax_2Ereal__add @ V2x @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0z ) @ V1y ) ) ) )).
