...
thf(thm_2Ereal__topology_2EBANACH__FIX,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2c: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Ecomplete @ V1s )
        ...
        & ( c_2Erealax_2Ereal__lt @ V2c @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
        ...
        & ! [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ ( V0f @ V4y ) ) ) @ ( c_2Erealax_2Ereal__mul @ V2c @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V3x @ V4y ) ) ) ) ) )
     => ( c_2Ebool_2E_3F_21 @ tyop_2Erealax_2Ereal
        @ ^ [V5x: tyop_2Erealax_2Ereal] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x @ V1s ) @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V0f @ V5x ) @ V5x ) ) ) ) )).
