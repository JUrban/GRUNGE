...
thf(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__CMUL,lemma,(
    ! [V0f: $i] :
         ...
         => ( p
            @ ( ap @ c_2Ereal__topology_2Elinear
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V2x: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) @ ( ap @ V0f @ V2x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SCALING,conjecture,(
