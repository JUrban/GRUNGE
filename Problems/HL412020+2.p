...
fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__SUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27b),V3s))
                              ...
                              & ! [V5x] :
                                 ...
                                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V5x),ap(c_2Emeasure_2Espace(A_27a),V0a)))
                                   => ap(V2g,V5x) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f3587(A_27a,A_27b,V1f,V5x)),V3s) ) ) )
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__sum,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27b),V2s))
                          ...
                          & ! [V3i] :
                             ...
                             => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V3i),V2s))
                               => ! [V4x] :
                                    ( mem(V4x,A_27a)
                                   => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(ap(V1f,V3i),V4x))) ) ) )
                          & ! [V5i] :
                              ( mem(V5i,A_27b)
                       ...
                       => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4179(A_27b,A_27a,V1f,V2s)) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f4181(A_27a,A_27b,V1f,V0m)),V2s) ) ) ) ) ) ) )).

fof(lamtp_f4192,axiom,(
    ! [A_27a,V1f] :
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V5x] :
         ...
         => ! [V6i] :
             ...
             => ap(f4192(A_27a,V1f,V5x),V6i) = ap(ap(V1f,V6i),V5x) ) ) ) )).

fof(lamtp_f4191,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => mem(f4191(A_27a,V1f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f4191,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V5x] :
          ( mem(V5x,A_27a)
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0m] :
         ...
         => ! [V7i] :
             ...
             => ap(f4193(A_27a,V1f,V0m),V7i) = ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),ap(V1f,V7i)) ) ) ) )).

fof(conj_thm_2Elebesgue_2Epos__fn__integral__suminf,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  & ! [V2i] :
                     ...
                     => ! [V3x] :
                          ( mem(V3x,A_27a)
                         => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(ap(V1f,V2i),V3x))) ) )
                  & ! [V4i] :
                      ( mem(V4i,ty_2Enum_2Enum)
                     => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V1f,V4i)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel))) ) )
               => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4191(A_27a,V1f)) = ap(c_2Eextreal_2Eext__suminf,f4193(A_27a,V1f,V0m)) ) ) ) ) )).
