...
fof(conj_thm_2Ewords_2Ebit__count__upto__is__zero,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
             ...
             => ( ap(ap(c_2Ewords_2Ebit__count__upto(A_27a),V0n),V1w) = c_2Enum_2E0
              <=> ! [V2i] :
                   ...
                   => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2i),V0n))
                     => ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),V2i)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ealignment_2Ealigned__bit__count__upto,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
