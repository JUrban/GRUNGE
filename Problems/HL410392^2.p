...
thf(conj_thm_2Ereal__topology_2ELINEAR__SUM__MUL,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal
                        @ ( ap @ V0f
                          @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                            @ ( lam @ A_27a
                              @ ^ [V4i: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2c @ V4i ) ) @ ( ap @ V3v @ V4i ) ) ) ) ) )
                      = ( surj__ty_2Erealax_2Ereal
                        @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                          @ ( lam @ A_27a
                            @ ^ [V5i: $i] :
                                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2c @ V5i ) ) @ ( ap @ V0f @ ( ap @ V3v @ V5i ) ) ) ) ) ) ) ) ) ) ) ) )).
