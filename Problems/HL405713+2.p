...
fof(conj_thm_2Eordinal_2Eis__polyform__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                  ...
                  & ! [V2a] :
                     ...
                     => ! [V3c] :
                         ...
                         => ! [V4e] :
                             ...
                             => p(ap(ap(V0P,V2a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V3c),V4e)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))))) ) ) )
                  & ! [V5a] :
                         ...
                         => ! [V7e1] :
                             ...
                             => ! [V8c2] :
                                 ...
                                 => ! [V9e2] :
                                     ...
                                     => ! [V10t] :
                                          ( mem(V10t,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))))
                                         => ( p(ap(ap(V0P,V5a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V8c2),V9e2)),V10t)))
                                           => p(ap(ap(V0P,V5a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V6c1),V7e1)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V8c2),V9e2)),V10t)))) ) ) ) ) ) ) ) )
               => ! [V11v] :
                    ( mem(V11v,ty_2Eordinal_2Eordinal(A_27a))
                   => ! [V12v1] :
                        ( mem(V12v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))))
