...
tff(lamtp_f1403,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1403(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1403,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1403(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,f889(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),inj__ty_2Enum_2Enum(V2t))) ) )).

tff(lmtp_f1404,type,(
    f1404: $i > $i )).

tff(lamtp_f1404,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1404(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1404,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1404(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),k(ty_2Enum_2Enum,c_2Ebool_2EF)),inj__ty_2Enum_2Enum(V5t)) ) )).

tff(lmtp_f1405,type,(
    f1405: ( $i * $i ) > $i )).

tff(lamtp_f1405,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1405(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1405,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1405(V1b,V0a),inj__ty_2Enum_2Enum(V7t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1361(V0a,V1b)),inj__ty_2Enum_2Enum(V7t)) ) ) )).

tff(lmtp_f1406,type,(
    f1406: ( $i * $i ) > $i )).

tff(lamtp_f1406,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1406(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1406,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V9t: tp__ty_2Enum_2Enum] : ap(f1406(V0a,V1b),inj__ty_2Enum_2Enum(V9t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,f1363(V0a)),V1b),inj__ty_2Enum_2Enum(V9t))) ) ) )).

tff(lmtp_f1407,type,(
    f1407: ( $i * $i ) > $i )).

tff(lamtp_f1407,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1407(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1407,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V11t: tp__ty_2Enum_2Enum] : ap(f1407(V1b,V0a),inj__ty_2Enum_2Enum(V11t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1300(V0a,V1b)),inj__ty_2Enum_2Enum(V11t)) ) ) )).

tff(lmtp_f1408,type,(
    f1408: ( $i * $i ) > $i )).

tff(lamtp_f1408,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1408(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1408,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V13t: tp__ty_2Enum_2Enum] : ap(f1408(V0a,V1b),inj__ty_2Enum_2Enum(V13t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1355(V0a,V1b)),inj__ty_2Enum_2Enum(V13t))) ) ) )).

tff(lmtp_f1409,type,(
    f1409: ( $i * $i ) > $i )).

tff(lamtp_f1409,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1409(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1409,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V15t: tp__ty_2Enum_2Enum] : ap(f1409(V0a,V1b),inj__ty_2Enum_2Enum(V15t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1367(V0a,V1b)),inj__ty_2Enum_2Enum(V15t))) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ( ap(c_2EPast__Temporal__Logic_2EPALWAYS,V0a) = f1403(V0a)
            & ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,V0a) = f1404(V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V1b) = f1405(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),V1b) = f1406(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V0a),V1b) = f1407(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V0a),V1b) = f1408(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V0a),V1b) = f1409(V0a,V1b) ) ) ) )).
