...
tff(conj_thm_2Erelation_2ETC__STRONG__INDUCT__LEFT1,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
              ...
              & ! [V4x: $i] :
                 ...
                 => ! [V5y: $i] :
                     ...
                     => ! [V6z: $i] :
                         ...
                         => ( ( p(ap(ap(V0R,V4x),V5y))
                              & p(ap(ap(V1P,V5y),V6z))
                              & p(ap(ap(ap(c_2Erelation_2ETC(A_27a),V0R),V5y),V6z)) )
                           => p(ap(ap(V1P,V4x),V6z)) ) ) ) ) )
           => ! [V7u: $i] :
                ( mem(V7u,A_27a)
               => ! [V8v: $i] :
...
tff(tp_c_2Ebag_2EBAG__FILTER,type,(
    c_2Ebag_2EBAG__FILTER: del > $i )).

tff(mem_c_2Ebag_2EBAG__FILTER,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__FILTER(A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)))) )).
...
tff(tp_c_2Ebag_2Edominates,type,(
    c_2Ebag_2Edominates: ( del * del ) > $i )).

tff(mem_c_2Ebag_2Edominates,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ebag_2Edominates(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,bool)),arr(arr(A_27a,bool),arr(arr(A_27b,bool),bool)))) )).
...
tff(ax_thm_2Ebag_2EBAG__INN,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1n: tp__ty_2Enum_2Enum,V2b: $i] :
          ( mem(V2b,arr(A_27a,ty_2Enum_2Enum))
         => ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V0e),inj__ty_2Enum_2Enum(V1n)),V2b))
          <=> p(ap(ap(c_2Earithmetic_2E_3E_3D,ap(V2b,V0e)),inj__ty_2Enum_2Enum(V1n))) ) ) ) )).
...
tff(ax_thm_2Ebag_2EBAG__IN,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1b: $i] :
...
tff(lameq_f964,axiom,(
    ! [A_27a: del,V0e: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f964(A_27a,V0e,V1b),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V2x),V0e)),ap(ap(c_2Earithmetic_2E_2B,ap(V1b,V0e)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(V1b,V2x)) ) ) ) )).

tff(ax_thm_2Ebag_2EBAG__INSERT,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__IN__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e1: $i] :
          ( mem(V1e1,A_27a)
...
tff(conj_thm_2Ebag_2EBAG__INSERT__NOT__EMPTY,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__UNION__RIGHT__CANCEL,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b1: $i] :
...
tff(conj_thm_2Ebag_2EBAG__UNION__DIFF__eliminate,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1c: $i] :
          ( mem(V1c,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ENOT__IN__EMPTY__BAG,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
...
tff(conj_thm_2Ebag_2EBAG__IN__DIFF__E,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1b1: $i] :
          ( mem(V1b1,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ESUB__BAG__BAG__IN,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1b1: $i] :
          ( mem(V1b1,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EIN__SET__OF__BAG,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EFINITE__BAG__DIFF,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EFINITE__SUB__BAG,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b1))
       => ! [V1b2: $i] :
...
tff(conj_thm_2Ebag_2ESUB__BAG__DIFF__EQ,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(lamtp_f970,axiom,(
    ! [A_27a: del,V1b: $i] :
      ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V0P: $i] :
          ( mem(V0P,arr(A_27a,bool))
         => mem(f970(A_27a,V1b,V0P),arr(A_27a,ty_2Enum_2Enum)) ) ) )).

tff(lameq_f970,axiom,(
    ! [A_27a: del,V1b: $i] :
      ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V0P: $i] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V2e: $i] :
              ( mem(V2e,A_27a)
             => ap(f970(A_27a,V1b,V0P),V2e) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(V0P,V2e)),ap(V1b,V2e)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) ) ) )).

tff(ax_thm_2Ebag_2EBAG__FILTER__DEF,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
         => ap(ap(c_2Ebag_2EBAG__FILTER(A_27a),V0P),V1b) = f970(A_27a,V1b,V0P) ) ) )).

tff(conj_thm_2Ebag_2EFINITE__BAG__FILTER,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__IN__BAG__FILTER,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
...
tff(ax_thm_2Ebag_2Edominates__def,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
     ...
     => ! [V1s1: $i] :
         ...
         => ! [V2s2: $i] :
             ...
             => ( p(ap(ap(ap(c_2Ebag_2Edominates(A_27a,A_27a),V0R),V1s1),V2s2))
              <=> ! [V3x: $i] :
                    ( mem(V3x,A_27a)
...
tff(conj_thm_2Ebag_2Emlt__dominates__thm1,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R))
       => ! [V1b1: $i] :
