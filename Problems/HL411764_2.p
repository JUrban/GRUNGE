...
tff(lamtp_f4028,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => mem(f4028(V0x,V1s),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f4028,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V4i: tp__ty_2Enum_2Enum] : ap(f4028(V0x,V1s),inj__ty_2Enum_2Enum(V4i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4i)),V1s)),ap(V0x,inj__ty_2Enum_2Enum(V4i))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__SUBSET,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),V1s),V2t))
                    & p(ap(ap(ap(c_2Ereal__topology_2Esums,f4028(V0x,V1s)),inj__ty_2Erealax_2Ereal(V3l)),V2t)) )
                 => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V3l)),V1s)) ) ) ) ) )).

tff(lmtp_f4029,type,(
    f4029: ( $i * $i ) > $i )).

tff(lamtp_f4029,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => mem(f4029(V0x,V1s),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f4029,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V3i: tp__ty_2Enum_2Enum] : ap(f4029(V0x,V1s),inj__ty_2Enum_2Enum(V3i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3i)),V1s)),ap(V0x,inj__ty_2Enum_2Enum(V3i))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: $i] :
              ( mem(V2t,arr(ty_2Enum_2Enum,bool))
             => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),V1s),V2t))
                  & p(ap(ap(c_2Ereal__topology_2Esummable,V2t),f4029(V0x,V1s))) )
               => p(ap(ap(c_2Ereal__topology_2Esummable,V1s),V0x)) ) ) ) ) )).
