...
fof(conj_thm_2Elist_2EEVERY2__LENGTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1l1] :
                 ...
                 => ! [V2l2] :
                     ...
                     => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),V1l1),V2l2))
                       => ap(c_2Elist_2ELENGTH(A_27a),V1l1) = ap(c_2Elist_2ELENGTH(A_27b),V2l2) ) ) ) ) ) ) )).

fof(conj_thm_2Elist_2EEVERY2__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [A_27h] :
                                 ...
                                 => ( ! [V0P] :
                                       ...
                                       => ! [V1ys] :
                                           ...
                                           => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),c_2Elist_2ENIL(A_27a)),V1ys))
                                       ...
                                       => ! [V3yys] :
                                           ...
                                           => ! [V4x] :
                                               ...
                                               => ! [V5xs] :
                                                   ...
                                                   => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27c,A_27c),V2P),ap(ap(c_2Elist_2ECONS(A_27c),V4x),V5xs)),V3yys))
                                                    <=> ? [V6y] :
                                                          ( mem(V6y,A_27d)
                                                          & ? [V7ys] :
                                                              ...
                                                              & p(ap(ap(V2P,V4x),V6y))
                                                              & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27c,A_27c),V2P),V5xs),V7ys)) ) ) ) ) ) ) )
                                    & ! [V8P] :
                                        ( mem(V8P,arr(A_27e,arr(A_27f,bool)))
                                       => ! [V9xs] :
                                            ( mem(V9xs,ty_2Elist_2Elist(A_27e))
                                           => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27e,A_27e),V8P),V9xs),c_2Elist_2ENIL(A_27f)))
                                       ...
                                       => ! [V11xxs] :
                                           ...
                                           => ! [V12y] :
                                               ...
                                               => ! [V13ys] :
                                                   ...
                                                   => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27g,A_27g),V10P),V11xxs),ap(ap(c_2Elist_2ECONS(A_27h),V12y),V13ys)))
                                                    <=> ? [V14x] :
                                                          ( mem(V14x,A_27g)
                                                          & ? [V15xs] :
                                                              ...
                                                              & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27g,A_27g),V10P),V15xs),V13ys)) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2EBUTLASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0l] :
               ...
               => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),c_2Enum_2E0),V0l) = V0l )
            & ! [V1n] :
                ( mem(V1n,ty_2Enum_2Enum)
               => ! [V2x] :
                    ( mem(V2x,A_27b)
                   => ! [V3l] :
                       ...
                       => ap(ap(c_2Erich__list_2EBUTLASTN(A_27b),ap(c_2Enum_2ESUC,V1n)),ap(ap(c_2Elist_2ESNOC(A_27b),V2x),V3l)) = ap(ap(c_2Erich__list_2EBUTLASTN(A_27b),V1n),V3l) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EBUTLASTN__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ! [V2x] :
                    ( mem(V2x,A_27a)
                   => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),ap(ap(c_2Elist_2ECONS(A_27a),V2x),V1l)) = ap(ap(c_2Elist_2ECONS(A_27a),V2x),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),V1l)) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EBUTLASTN__LENGTH__NIL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Erich__list_2Elist__rel__butlastn,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2l2] :
                     ...
                     => ! [V3n] :
                         ...
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3n),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
                              & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0f),V1l1),V2l2)) )
                           => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0f),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V3n),V1l1)),ap(ap(c_2Erich__list_2EBUTLASTN(A_27b),V3n),V2l2))) ) ) ) ) ) ) ) )).
