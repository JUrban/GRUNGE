...
fof(conj_thm_2Efmapal_2Efmap__FDOM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l] :
             ...
             => ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(c_2Efmapal_2Efmap(A_27a,A_27a),V0l)) = ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l)) ) ) ) )).

fof(conj_thm_2Efmapal_2Efmap__FDOM__rec,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0x] :
                ( mem(V0x,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(c_2Efmapal_2Efmap(A_27a,A_27a),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))))))
                <=> $false ) )
            & ! [V1x] :
                ( mem(V1x,A_27a)
               => ! [V2w] :
                   ...
                   => ! [V3z] :
                       ...
                       => ! [V4l] :
                           ...
                           => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(c_2Efmapal_2Efmap(A_27a,A_27a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2w),V3z)),V4l)))))
                            <=> ( V1x = V2w
                                | p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(c_2Efmapal_2Efmap(A_27a,A_27a),V4l)))) ) ) ) ) ) ) ) ) ) )).
