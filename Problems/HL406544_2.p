...
tff(mem_c_2Ealignment_2Ealigned,axiom,(
    ! [A_27a: del] : mem(c_2Ealignment_2Ealigned(A_27a),arr(ty_2Enum_2Enum,arr(ty_2Efcp_2Ecart(bool,bool),bool))) )).
...
tff(conj_thm_2Ealignment_2Ealigned__extract,conjecture,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ( p(ap(ap(c_2Ealignment_2Ealigned(A_27a),inj__ty_2Enum_2Enum(V0p)),V1w))
      <=> ( V0p = fo__c_2Enum_2E0
