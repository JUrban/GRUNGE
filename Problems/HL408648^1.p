...
thf(f10022_0_2E0,type,(
    f10022_0_2E0: u )).

thf(f10022_0_2E2,type,(
    f10022_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef10022_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10022_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f10022_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EHolSmt_2Er027,axiom,(
    ! [A_27a: d,V2x_2E0: u,V1y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10022_0_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V2x_2E0 )
        = ( s @ A_27a @ V1y_2E0 ) ) ) )).

thf(thm_2EHolSmt_2Er027,conjecture,(
    ! [A_27a: d,V0z_2E0: u,V1y_2E0: u,V2x_2E0: u,V3p: $o] :
      ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V3p @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10022_0_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10022_0_2E2 @ ( s @ A_27a @ V1y_2E0 ) @ ( s @ A_27a @ V0z_2E0 ) ) ) ) )
    <=> ( ( s @ A_27a @ V1y_2E0 )
