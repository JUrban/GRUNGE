...
thf(conj_thm_2Ebinary__ieee_2Efloat__mul__finite,conjecture,(
    ! [A_27a: del,A_27b: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
     ...
     => ! [V2y: $i] :
         ...
         => ! [V3r1: tp__ty_2Erealax_2Ereal,V4r2: tp__ty_2Erealax_2Ereal] :
             ...
             => ( ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__mul @ A_27a @ A_27b ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ V1x ) @ V2y )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__round__with__flags @ A_27a @ A_27b ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27a @ A_27b ) @ V1x ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27a @ A_27b ) @ V2y ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3r1 ) ) @ ( inj__ty_2Erealax_2Ereal @ V4r2 ) ) ) ) ) ) ) )).
