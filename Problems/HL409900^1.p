...
thf(f11788_0_2E0,type,(
    f11788_0_2E0: u )).

thf(f11788_0_2E1,type,(
    f11788_0_2E1: du > u )).

thf(f11788_1_2E0,type,(
    f11788_1_2E0: u )).

thf(f11788_1_2E1,type,(
    f11788_1_2E1: du > u )).

thf(f11788_1_2E2,type,(
    f11788_1_2E2: du > du > u )).

thf(f11788_2_2E0,type,(
    f11788_2_2E0: u )).

thf(f11788_2_2E2,type,(
    f11788_2_2E2: du > du > u )).

thf(f11788_2_2E3,type,(
    f11788_2_2E3: du > du > du > u )).

thf(f11788_3_2E0,type,(
    f11788_3_2E0: u )).

thf(f11788_3_2E2,type,(
    f11788_3_2E2: du > du > u )).

thf(f11788_3_2E3,type,(
...
thf(mono_2Ef11788_0,type,(
    mono_2Ef11788_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11788_1,type,(
    mono_2Ef11788_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11788_2,type,(
    mono_2Ef11788_2: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11788_3,type,(
    mono_2Ef11788_3: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11788_0 @ V1x )
      = V1x ) )).

thf(def1_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,axiom,(
    ! [V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11788_1 @ V2c @ V3x )
      = V2c ) )).

thf(def2_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,axiom,(
    ! [V7p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V8q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V9x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11788_3 @ V7p @ V8q @ V9x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V7p @ V9x ) @ ( V8q @ V9x ) ) ) )).

thf(def3_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,axiom,(
    ! [V4p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V5q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V6x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11788_2 @ V4p @ V5q @ V6x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V4p @ V6x ) @ ( V5q @ V6x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__INDUCT,conjecture,(
    ! [V0P: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > $o] :
      ( ( ( V0P @ mono_2Ef11788_0 )
        & ! [V2c: mono_2Etyop_2Erealax_2Ereal] :
            ( V0P @ ( mono_2Ef11788_1 @ V2c ) )
        & ! [V4p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V5q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0P @ V4p )
              & ( V0P @ V5q ) )
           => ( V0P @ ( mono_2Ef11788_2 @ V4p @ V5q ) ) )
        & ! [V7p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V8q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0P @ V7p )
              & ( V0P @ V8q ) )
           => ( V0P @ ( mono_2Ef11788_3 @ V7p @ V8q ) ) ) )
     => ! [V10p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V10p )
         => ( V0P @ V10p ) ) ) )).
