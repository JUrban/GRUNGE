...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__CONST,lemma,(
...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,lemma,(
    ! [V0p: $i] :
...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__POW,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ c_2Eiterate_2Epolynomial__function @ V0p ) )
         => ( p
            @ ( ap @ c_2Eiterate_2Epolynomial__function
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V2x: $i] :
                    ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ V0p @ V2x ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) )).
