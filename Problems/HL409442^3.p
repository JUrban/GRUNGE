...
thf(c_2Eieee_2EMinus__infinity,type,(
    c_2Eieee_2EMinus__infinity: tyop_2Eieee_2Efloat )).
...
thf(c_2Eieee_2EPlus__infinity,type,(
    c_2Eieee_2EPlus__infinity: tyop_2Eieee_2Efloat )).
...
thf(thm_2Eieee_2Eis__valid,axiom,(
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum,V1s: tyop_2Enum_2Enum,V2e: tyop_2Enum_2Enum,V3f: tyop_2Enum_2Enum] :
      ( ( c_2Eieee_2Eis__valid @ V0X @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ V1s @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ V2e @ V3f ) ) )
    <=> ( ( c_2Eprim__rec_2E_3C @ V1s @ ( c_2Enum_2ESUC @ ( c_2Enum_2ESUC @ c_2Enum_2E0 ) ) )
        & ( c_2Eprim__rec_2E_3C @ V2e @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Eieee_2Eexpwidth @ V0X ) ) )
        & ( c_2Eprim__rec_2E_3C @ V3f @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Eieee_2Efracwidth @ V0X ) ) ) ) ) )).

thf(thm_2Eieee_2Eplus__infinity,axiom,(
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum] :
      ( ( c_2Eieee_2Eplus__infinity @ V0X )
      = ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ c_2Enum_2E0 @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( c_2Eieee_2Eemax @ V0X ) @ c_2Enum_2E0 ) ) ) )).

thf(thm_2Eieee_2Eminus__infinity,axiom,(
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum] :
      ( ( c_2Eieee_2Eminus__infinity @ V0X )
      = ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( c_2Eieee_2Eemax @ V0X ) @ c_2Enum_2E0 ) ) ) )).
...
thf(thm_2Eieee_2EMinus__infinity,axiom,
    ...
    = ( c_2Eieee_2Efloat @ ( c_2Eieee_2Eminus__infinity @ c_2Eieee_2Efloat__format ) ) )).

thf(thm_2Eieee_2EPlus__infinity,axiom,
    ( c_2Eieee_2EPlus__infinity
    = ( c_2Eieee_2Efloat @ ( c_2Eieee_2Eplus__infinity @ c_2Eieee_2Efloat__format ) ) )).
...
thf(thm_2Efloat_2EFLOAT__INFINITIES__SIGNED,conjecture,
    ( ( ( c_2Eieee_2Esign @ ( c_2Eieee_2Edefloat @ c_2Eieee_2EPlus__infinity ) )
      = c_2Enum_2E0 )
    & ( ( c_2Eieee_2Esign @ ( c_2Eieee_2Edefloat @ c_2Eieee_2EMinus__infinity ) )
      = ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )).
