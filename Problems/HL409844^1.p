...
thf(thm_2Eiterate_2EITERATE__EQ__GENERAL__INVERSES,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0op_2E0: u] :
     ...
     => ! [V1s_2E0: u,V2t_2E0: u,V3f_2E0: u,V4g_2E0: u,V5h_2E0: u,V6k_2E0: u] :
          ( ( ! [V7y_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V7y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) )
               => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V6k_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
                  & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V6k_2E0 ) @ ( s @ A_27b @ V7y_2E0 ) ) ) ) )
                    = ( s @ A_27b @ V7y_2E0 ) ) ) )
            & ! [V8x_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V8x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
               => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) )
                  & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V6k_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) )
                    = ( s @ A_27a @ V8x_2E0 ) )
                  & ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4g_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) )
                    = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V3f_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) ) ) )
         => ( ( s @ A_27c @ ( c_2Eiterate_2Eiterate_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27c @ A_27c ) ) @ V0op_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V3f_2E0 ) ) )
            = ( s @ A_27c @ ( c_2Eiterate_2Eiterate_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27c @ A_27c ) ) @ V0op_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V4g_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__EQ__GENERAL__INVERSES,conjecture,(
