...
tff(conj_thm_2Ebag_2EBAG__IMAGE__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__IMAGE__COMPOSE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27c,A_27a))
         => ! [V2b: $i] :
             ...
             => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27c),V2b))
               => ap(ap(c_2Ebag_2EBAG__IMAGE(A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0f),V1g)),V2b) = ap(ap(c_2Ebag_2EBAG__IMAGE(A_27b,A_27b),V0f),ap(ap(c_2Ebag_2EBAG__IMAGE(A_27a,A_27a),V1g),V2b)) ) ) ) ) )).
