      ...
      = ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b
        @ ^ [V2y: A_27b] :
            ...
            @ ( c_2Ebool_2E_21 @ A_27a
              @ ^ [V3x: A_27a] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ A_27a @ V3x @ V1s ) @ ( c_2Ebool_2EIN @ A_27b @ V2y @ ( V0f @ V3x ) ) ) ) ) ) ) )).
    ...
    ! [A_27a: $tType,V0u: A_27a > $o,V1s: ( A_27a > $o ) > $o] :
      ...
      = ( c_2Epred__set_2EBIGUNION @ A_27a
        @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
          @ ^ [V2t: A_27a > $o] :
              ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ ( c_2Epred__set_2EDIFF @ A_27a @ V0u @ V2t ) @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ V1s ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EBAIRE,axiom,(
    ! [V0g: ( tyop_2Erealax_2Ereal > $o ) > $o,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ V1s )
        & ( c_2Epred__set_2Ecountable @ ( tyop_2Erealax_2Ereal > $o ) @ V0g )
        & ! [V2t: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2t @ V0g )
           => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V1s ) @ V2t )
              & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1s @ ( c_2Ereal__topology_2Eclosure @ V2t ) ) ) ) )
     => ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1s @ ( c_2Ereal__topology_2Eclosure @ ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ V0g ) ) ) ) )).
      ...
      ( ( ( c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ V1s )
        & ( (~)
          @ ( V1s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
        & ( c_2Epred__set_2Ecountable @ ( tyop_2Erealax_2Ereal > $o ) @ V0g )
        & ( ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V0g )
          = V1s ) )
     => ? [V2t: tyop_2Erealax_2Ereal > $o,V3u: tyop_2Erealax_2Ereal > $o] :
          ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2t @ V0g )
          ...
          & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3u @ ( c_2Ereal__topology_2Eclosure @ V2t ) ) ) ) )).
