...
tff(conj_thm_2Ecardinal_2EFINITE__IMAGE__INJ__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal_2EREAL__INV__INJ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eiterate_2EFINITE__REAL__INTERVAL,conjecture,
