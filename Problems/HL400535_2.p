...
tff(lmtp_f107,type,(
    f107: ( del * del * del * $i ) > $i )).

tff(lamtp_f107,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V1x: $i] :
      ( mem(V1x,A_27a)
     => mem(f107(A_27a,A_27b,A_27a,V1x),arr(arr(A_27a,A_27b),A_27b)) ) )).
...
tff(lameq_f107,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V1x: $i] :
     ...
     => ! [V2f: $i] :
          ( mem(V2f,arr(A_27a,A_27b))
         => ap(f107(A_27a,A_27b,A_27a,V1x),V2f) = ap(V2f,V1x) ) ) )).

tff(conj_thm_2Eoption_2ESOME__APPLY__PERMUTE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Eoption_2Eoption(arr(A_27a,A_27b)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(ap(c_2Eoption_2EOPTION__APPLY(A_27b,A_27b),V0f),ap(c_2Eoption_2ESOME(A_27a),V1x)) = ap(ap(c_2Eoption_2EOPTION__APPLY(A_27b,A_27b),ap(c_2Eoption_2ESOME(arr(arr(A_27a,A_27b),A_27b)),f107(A_27a,A_27b,A_27a,V1x))),V0f) ) ) )).
