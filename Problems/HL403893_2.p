...
tff(conj_thm_2Ellist_2ENOT__LFINITE__DROP,conjecture,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ( ~ p(ap(c_2Ellist_2ELFINITE(A_27a),V0ll))
       => ! [V1n: tp__ty_2Enum_2Enum] :
          ? [V2y: $i] :
            ...
            & ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V1n)),V0ll) = ap(c_2Eoption_2ESOME(ty_2Ellist_2Ellist(A_27a)),V2y) ) ) ) )).
