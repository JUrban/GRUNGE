...
fof(conj_thm_2Elist_2EEVERY__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Erich__list_2EEVERY__BUTLASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
             ...
             => ( p(ap(ap(c_2Elist_2EEVERY(A_27a),V0P),V1l))
               => ! [V2m] :
                   ...
                   => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2m),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
                     => p(ap(ap(c_2Elist_2EEVERY(A_27a),V0P),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V2m),V1l))) ) ) ) ) ) ) )).
