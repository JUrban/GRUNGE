...
tff(conj_thm_2Ereal_2EREAL__NEG__EQ0,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
...
tff(lmtp_f3904,type,(
    f3904: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3904,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal] : mem(f3904(V1b,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3904,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3904(V1b,V0a),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(c_2Ereal_2Ereal__gt,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V1b))) )).

tff(lmtp_f3914,type,(
    f3914: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3914,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal] : mem(f3914(V1b,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3914,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3914(V1b,V0a),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V3x))),inj__ty_2Erealax_2Ereal(V1b))) )).

tff(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__LT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
     ...
     => ap(c_2Ereal__topology_2Eclosure,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3902(V1b,V0a))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3914(V1b,V0a)) ) )).

tff(lmtp_f3915,type,(
    f3915: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3915,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal] : mem(f3915(V1b,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3915,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3915(V1b,V0a),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),ap(ap(c_2Ereal_2Ereal__ge,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V3x))),inj__ty_2Erealax_2Ereal(V1b))) )).

tff(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__GT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( V0a != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
     => ap(c_2Ereal__topology_2Eclosure,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3904(V1b,V0a))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3915(V1b,V0a)) ) )).
