...
thf(c_2Enumpair_2Enfst_2E0,type,(
    c_2Enumpair_2Enfst_2E0: u )).

thf(c_2Enumpair_2Enfst_2E1,type,(
    c_2Enumpair_2Enfst_2E1: du > u )).

thf(c_2Enumpair_2Enpair_2E0,type,(
    c_2Enumpair_2Enpair_2E0: u )).

thf(c_2Enumpair_2Enpair_2E2,type,(
    c_2Enumpair_2Enpair_2E2: du > du > u )).
...
thf(mono_2Ec_2Enumpair_2Enfst,type,(
    mono_2Ec_2Enumpair_2Enfst: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Enumpair_2Enpair,type,(
    mono_2Ec_2Enumpair_2Enpair: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Enumpair_2Einvtri__linverse__r,axiom,(
    ! [V0y: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0y @ V1x )
     => ( ( mono_2Ec_2Enumpair_2Einvtri @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Enumpair_2Etri @ V1x ) @ V0y ) )
        = V1x ) ) )).

thf(thm_2Enumpair_2Enpair__def,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Enpair @ V0m @ V1n )
      = ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Enumpair_2Etri @ ( mono_2Ec_2Earithmetic_2E_2B @ V0m @ V1n ) ) @ V1n ) ) )).

thf(thm_2Enumpair_2Enfst__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Enfst @ V0n )
      = ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Enumpair_2Etri @ ( mono_2Ec_2Enumpair_2Einvtri @ V0n ) ) @ ( mono_2Ec_2Enumpair_2Einvtri @ V0n ) ) @ V0n ) ) )).
...
thf(thm_2Enumpair_2Enfst__npair,conjecture,(
    ! [V0y: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Enfst @ ( mono_2Ec_2Enumpair_2Enpair @ V1x @ V0y ) )
      = V1x ) )).
