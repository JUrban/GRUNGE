...
tff(conj_thm_2Ereal__topology_2ELIM__WITHIN__SUBSET,lemma,(
    ! [V0t: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SUBSET,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V1s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V2t)) ) ) ) ) )).
