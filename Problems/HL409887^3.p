...
thf(thm_2Eiterate_2EREAL__POLYFUN__ROOTBOUND,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1c: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ! [V2i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V2i @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V0n ) )
           => ( ( V1c @ V2i )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
          ...
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V3x: tyop_2Erealax_2Ereal] :
                ...
                @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal
                  @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V0n )
                    @ ^ [V4i: tyop_2Enum_2Enum] :
                        ( c_2Erealax_2Ereal__mul @ ( V1c @ V4i ) @ ( c_2Ereal_2Epow @ V3x @ V4i ) ) )
                  @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )
        & ( c_2Earithmetic_2E_3C_3D
          @ ( c_2Epred__set_2ECARD @ tyop_2Erealax_2Ereal
            @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V5x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V5x
                  @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal
                    @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V0n )
                      @ ^ [V6i: tyop_2Enum_2Enum] :
                          ( c_2Erealax_2Ereal__mul @ ( V1c @ V6i ) @ ( c_2Ereal_2Epow @ V5x @ V6i ) ) )
                    @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )
          @ V0n ) ) ) )).
      ...
      ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V2x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x
              @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal
                @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V0n )
                  @ ^ [V3i: tyop_2Enum_2Enum] :
                      ( c_2Erealax_2Ereal__mul @ ( V1c @ V3i ) @ ( c_2Ereal_2Epow @ V2x @ V3i ) ) )
                @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )
    <=> ? [V4i: tyop_2Enum_2Enum] :
          ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4i @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V0n ) )
          & ( (~)
            @ ( ( V1c @ V4i )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) ) )).
