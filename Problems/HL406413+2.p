...
fof(conj_thm_2Ecardinal_2ECARDEQ__INSERT__RWT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Eucord_2EUnum__cardle__ucinf,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Eucord_2Eucord__sup__exists__lemma,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
