...
thf(conj_thm_2Epred__set_2EDIFF__DIFF__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Epred__set_2EBIGINTER__SUBSET,lemma,(
    ! [A_27a: del,V0sp: $i] :
...
thf(conj_thm_2Epred__set_2EDIFF__BIGINTER1,lemma,(
    ! [A_27a: del,V0sp: $i] :
      ( ( mem @ V0sp @ ( arr @ A_27a @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
...
thf(conj_thm_2Epred__set_2EDIFF__BIGINTER,conjecture,(
    ! [A_27a: del,V0sp: $i] :
      ( ( mem @ V0sp @ ( arr @ A_27a @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
                ...
                @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
                  @ ( ap
                    @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V3u: $i] :
                            ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V0sp ) @ V3u ) ) )
                    @ V1s ) ) ) ) ) ) ) )).
