...
thf(conj_thm_2Equotient_2EC__PRS,conjecture,(
                                         ...
                                         => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2EQUOTIENT @ A_27c @ A_27f ) @ V6R3 ) @ V7abs3 ) @ V8rep3 ) )
                                           => ! [V9f: $i] :
                                               ...
                                               => ! [V10x: $i] :
                                                   ...
                                                   => ! [V11y: $i] :
                                                        ( ( mem @ V11y @ A_27d )
                                                       => ( ( ap @ ( ap @ ( ap @ ( c_2Ecombin_2EC @ A_27d @ A_27e @ A_27f ) @ V9f ) @ V10x ) @ V11y )
                                                          = ( ap @ V7abs3 @ ( ap @ ( ap @ ( ap @ ( c_2Ecombin_2EC @ A_27a @ A_27b @ A_27c ) @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ ( arr @ A_27e @ A_27f ) @ A_27d @ ( arr @ A_27b @ A_27c ) ) @ V1abs1 ) @ ( ap @ ( ap @ ( c_2Equotient_2E_2D_2D_3E @ A_27b @ A_27f @ A_27e @ A_27c ) @ V4abs2 ) @ V8rep3 ) ) @ V9f ) ) @ ( ap @ V5rep2 @ V10x ) ) @ ( ap @ V2rep1 @ V11y ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
