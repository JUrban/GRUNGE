...
thf(conj_thm_2Ereal__topology_2ESERIES__LINEAR,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__LINEAR,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1h: $i] :
          ( ( mem @ V1h @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ! [V2s: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2s ) @ V0f ) )
                  & ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V1h ) ) )
               => ( p
                  @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2s )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3n: $i] :
                          ( ap @ V1h @ ( ap @ V0f @ V3n ) ) ) ) ) ) ) ) ) )).
