...
tff(conj_thm_2Earithmetic_2EMOD__MULT__MOD,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Einteger__word_2Ew2w__i2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Einteger_2Eint] :
     ...
     => ap(c_2Ewords_2Ew2w(A_27b,A_27b),ap(c_2Einteger__word_2Ei2w(A_27b),inj__ty_2Einteger_2Eint(V0i))) = ap(c_2Einteger__word_2Ei2w(A_27a),inj__ty_2Einteger_2Eint(V0i)) ) )).
