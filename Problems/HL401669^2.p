...
thf(conj_thm_2Epred__set_2EIN__GSPEC,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
                   ...
                   => ( p
                      @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V2x )
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ ( ap @ V0f @ V4x ) ) @ ( ap @ V3P @ V4x ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EFINITE__BIJ__CARD__EQ,lemma,(
     ...
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ? [V1f: $i] :
            ...
            & ? [V2b: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EBIJ @ ty_2Enum_2Enum @ A_27a ) @ V1f ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V2b ) ) ) @ V0s ) ) ) ) ) )).

thf(conj_thm_2Epred__set_2EFINITE__ISO__NUM,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ? [V1f: $i] :
            ...
            & ( V0s
              = ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ ( ap @ V1f @ V4n ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V4n ) @ ( ap @ ( c_2Epred__set_2ECARD @ A_27a ) @ V0s ) ) ) ) ) ) ) ) ) )).
