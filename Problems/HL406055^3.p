...
thf(thm_2Ewords_2Elsl__lsr,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2E_2A @ ( c_2Ewords_2Ew2n @ A_27a @ V0w ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) ) @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ( ( c_2Ewords_2Eword__lsr @ A_27a @ ( c_2Ewords_2Eword__lsl @ A_27a @ V0w @ V1n ) @ V1n )
        = V0w ) ) )).
