...
fof(lamtp_f1689,axiom,(
    ! [V1i] :
      ( mem(V1i,ty_2Enum_2Enum)
     => mem(f1689(V1i),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).
...
fof(lameq_f1689,axiom,(
    ! [V1i] :
     ...
     => ! [V2n] :
          ( mem(V2n,ty_2Enum_2Enum)
         => ap(f1689(V1i),V2n) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2n),ap(ap(c_2Earithmetic_2E_3C_3D,V2n),V1i)) ) ) )).

fof(conj_thm_2Epath_2EPL__take,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1i),ap(c_2Epath_2EPL(A_27a,A_27a),V0p)))
                   => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V1i),V0p)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1689(V1i)) ) ) ) ) ) )).
...
fof(lamtp_f1690,axiom,(
    ! [V1j] :
      ( mem(V1j,ty_2Enum_2Enum)
     => ! [V0i] :
          ( mem(V0i,ty_2Enum_2Enum)
         => mem(f1690(V1j,V0i),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) ) )).
    ...
    ! [V1j] :
     ...
     => ! [V0i] :
         ...
         => ! [V3n] :
             ...
             => ap(f1690(V1j,V0i),V3n) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3n),ap(ap(c_2Earithmetic_2E_3C_3D,V3n),ap(ap(c_2Earithmetic_2E_2D,V1j),V0i))) ) ) ) )).

fof(conj_thm_2Epath_2EPL__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0i),V1j))
                       ...
                       => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V0i),V1j),V2p)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1690(V1j,V0i)) ) ) ) ) ) ) )).
