...
tff(conj_thm_2Ereal__topology_2ENETLIMIT__WITHIN,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__INV,lemma,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1f),V0net))
              & surj__ty_2Erealax_2Ereal(ap(V1f,ap(c_2Ereal__topology_2Enetlimit(A_27a),V0net))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Erealax_2Einv),V1f)),V0net)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__WITHIN__INV,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V2a))),V1s)))
                & surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V2a))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
             => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),c_2Erealax_2Einv),V0f)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V2a))),V1s))) ) ) ) )).
