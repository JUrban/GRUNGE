...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__UNIQUE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1k: $i] :
          ( mem(V1k,arr(arr(ty_2Erealax_2Ereal,bool),bool))
         => ( ( ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V1k) = V0s
              & ! [V2c: $i] :
                  ( mem(V2c,arr(ty_2Erealax_2Ereal,bool))
                 => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2c),V1k))
                   => ( p(ap(c_2Ereal__topology_2Econnected,V2c))
                      & V2c != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                      & ! [V3c_27: $i] :
                          ( mem(V3c_27,arr(ty_2Erealax_2Ereal,bool))
                         => ( ( p(ap(c_2Ereal__topology_2Econnected,V3c_27))
                              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2c),V3c_27))
                              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3c_27),V0s)) )
                           => V3c_27 = V2c ) ) ) ) ) )
           => ap(c_2Ereal__topology_2Ecomponents,V0s) = V1k ) ) ) )).
