...
thf(conj_thm_2Eordinal_2Egeneric__continuity,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ( ( ! [V1a: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V1a ) )
                  & ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1a ) )
                    = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) )
               => ( ( ap @ V0f @ V1a )
                  = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0f ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1a ) ) ) ) ) )
          & ! [V2x: $i] :
       ...
       => ! [V4s: $i] :
           ...
           => ( ( ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardleq @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ V4s ) @ ( c_2Epred__set_2EUNIV @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) ) )
             ...
             => ( ( ap @ V0f @ ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ V4s ) )
                = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0f ) @ V4s ) ) ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2EordADD__continuous,conjecture,(
    ! [A_27a: del,V0a: $i] :
