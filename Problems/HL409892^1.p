...
thf(f11508_0_2E0,type,(
    f11508_0_2E0: u )).

thf(f11508_0_2E2,type,(
    f11508_0_2E2: du > du > u )).

thf(f11508_0_2E3,type,(
...
thf(f11778_0_2E0,type,(
    f11778_0_2E0: u )).

thf(f11778_0_2E2,type,(
    f11778_0_2E2: du > du > u )).

thf(f11778_0_2E3,type,(
    f11778_0_2E3: du > du > du > u )).

thf(f11780_0_2E0,type,(
    f11780_0_2E0: u )).

thf(f11780_0_2E2,type,(
    f11780_0_2E2: du > du > u )).

thf(f11780_0_2E3,type,(
...
thf(c_2Eiterate_2Epolynomial__function_2E0,type,(
    c_2Eiterate_2Epolynomial__function_2E0: u )).

thf(c_2Eiterate_2Epolynomial__function_2E1,type,(
...
thf(mono_2Ef11508_0,type,(
    mono_2Ef11508_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11778_0,type,(
    mono_2Ef11778_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11780_0,type,(
    mono_2Ef11780_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Eiterate_2Epolynomial__function,type,(
    mono_2Ec_2Eiterate_2Epolynomial__function: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > $o )).
...
thf(def0_2Ethm_2Eiterate_2ESUM__ADD__NUMSEG,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V4i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11508_0 @ V0f @ V1g @ V4i )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V0f @ V4i ) @ ( V1g @ V4i ) ) ) )).

thf(thm_2Eiterate_2ESUM__ADD__NUMSEG,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ ( mono_2Ef11508_0 @ V0f @ V1g ) )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V0f ) @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V1g ) ) ) )).

thf(def0_2Ethm_2Eiterate_2Epolynomial__function,axiom,(
    ! [V2c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal,V4i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11778_0 @ V2c @ V3x @ V4i )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V2c @ V4i ) @ ( mono_2Ec_2Ereal_2Epow @ V3x @ V4i ) ) ) )).

thf(thm_2Eiterate_2Epolynomial__function,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
    <=> ? [V1m: mono_2Etyop_2Enum_2Enum,V2c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
        ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( V0p @ V3x )
          = ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V1m ) @ ( mono_2Ef11778_0 @ V2c @ V3x ) ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ADD,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11780_0 @ V0p @ V1q @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V0p @ V2x ) @ ( V1q @ V2x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ADD,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
        & ( mono_2Ec_2Eiterate_2Epolynomial__function @ V1q ) )
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11780_0 @ V0p @ V1q ) ) ) )).
