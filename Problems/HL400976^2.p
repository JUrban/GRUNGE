...
thf(conj_thm_2Earithmetic_2EABS__DIFF__SUC__LE,lemma,(
    ! [V0x: tp__ty_2Enum_2Enum,V1z: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1z ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1z ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2EABS__DIFF__PLUS__LE,conjecture,(
    ! [V0x: tp__ty_2Enum_2Enum,V1z: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2y ) ) @ ( inj__ty_2Enum_2Enum @ V1z ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2y ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1z ) ) ) ) ) )).
