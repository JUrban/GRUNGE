...
tff(conj_thm_2Equotient__list_2ESOME__EL__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
               ...
               => ! [V3l: $i] :
                   ...
                   => ! [V4P: $i] :
                       ...
                       => ( p(ap(ap(c_2Elist_2EEXISTS(A_27b),V4P),V3l))
                        <=> p(ap(ap(c_2Elist_2EEXISTS(A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V4P)),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V3l))) ) ) ) ) ) ) ) )).
