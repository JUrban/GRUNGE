...
tff(conj_thm_2Earithmetic_2ELESS__EQ__ADD__EXISTS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Earithmetic_2EMULT__SUC,lemma,(
...
tff(conj_thm_2Earithmetic_2EADD__MODULUS__RIGHT,lemma,(
...
tff(mem_c_2Ewords_2Econcat__word__list,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ewords_2Econcat__word__list(A_27a,A_27a),arr(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(mem_c_2Ewords_2Eword__replicate,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ewords_2Eword__replicate(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(lmtp_f2217,type,(
    f2217: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2217,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2217(A_27a,V0n,V1w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2217,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2217(A_27a,V0n,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V0n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))) ) )).

tff(ax_thm_2Ewords_2Eword__replicate__def,axiom,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ap(ap(c_2Ewords_2Eword__replicate(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),V1w) = ap(c_2Efcp_2EFCP(bool,bool),f2217(A_27a,V0n,V1w)) ) )).

tff(ax_thm_2Ewords_2Econcat__word__list__def,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),c_2Elist_2ENIL(ty_2Efcp_2Ecart(bool,bool))) = ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))
      & ! [V0h: $i] :
          ( mem(V0h,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1t: $i] :
              ( mem(V1t,ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)))
             => ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),ap(ap(c_2Elist_2ECONS(ty_2Efcp_2Ecart(bool,bool)),V0h),V1t)) = ap(ap(c_2Ewords_2Eword__or(A_27b),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0h)),ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),V1t)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).
...
tff(conj_thm_2Ewords_2Eword__replicate__concat__word__list,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ap(ap(c_2Ewords_2Eword__replicate(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),V1w) = ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V1w)),inj__ty_2Enum_2Enum(V0n))) ) )).
