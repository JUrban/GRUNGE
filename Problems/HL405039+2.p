    ...
    ! [A_27state,V0t0] :
     ...
     => ! [V5q] :
         ...
         => ! [V7t] :
             ...
             => ap(f2025(A_27state,V0t0,V5q),V7t) = ap(V5q,ap(ap(c_2Earithmetic_2E_2B,V7t),V0t0)) ) ) ) )).

fof(lamtp_f2026,axiom,(
    ! [A_27state,V0t0] :
      ( mem(V0t0,ty_2Enum_2Enum)
     => ! [V8q] :
    ...
    ! [A_27state,V0t0] :
     ...
     => ! [V8q] :
         ...
         => ! [V10t] :
             ...
             => ap(f2026(A_27state,V0t0,V8q),V10t) = ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V10t),V0t0)) ) ) ) )).

fof(conj_thm_2EOmega__Automata_2EDET__OMEGA__EXISTS__FORALL__THEOREM,conjecture,(
    ! [A_27input] :
      ( ne(A_27input)
     => ! [A_27state] :
          ( ne(A_27state)
                         ...
                         => ! [V4Accept] :
                             ...
                             => ( ? [V5q] :
                                    ...
                                    & ! [V6t] :
                                       ...
                                       => ap(V5q,ap(ap(c_2Earithmetic_2E_2B,V6t),ap(ap(c_2Earithmetic_2E_2B,V0t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) = ap(V2TransRel,ap(ap(c_2Epair_2E_2C(A_27input,A_27input),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V6t),V0t0))),ap(V5q,ap(ap(c_2Earithmetic_2E_2B,V6t),V0t0)))) )
                              ...
                              <=> ! [V8q] :
                                   ...
                                   => ( ( ap(V8q,V0t0) = V1InitVal
                                        & ! [V9t] :
                                           ...
                                           => ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V9t),ap(ap(c_2Earithmetic_2E_2B,V0t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) = ap(V2TransRel,ap(ap(c_2Epair_2E_2C(A_27input,A_27input),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,V9t),V0t0))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V9t),V0t0)))) ) )
