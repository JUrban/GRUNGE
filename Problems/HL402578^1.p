...
thf(thm_2Elist_2ESNOC__Axiom,axiom,(
    ...
    ? [V2fn_2E0: u] :
      ( ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
        = ( s @ A_27b @ V0e_2E0 ) )
      & ! [V3x_2E0: u,V4l_2E0: u] :
          ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) ) )
          = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ A_27b ) @ V2fn_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Erich__list_2ENOT__NIL__SNOC,conjecture,(
