...
tff(tp_c_2Erelation_2EINDUCTIVE__INVARIANT,type,(
    c_2Erelation_2EINDUCTIVE__INVARIANT: ( del * del ) > $i )).

tff(mem_c_2Erelation_2EINDUCTIVE__INVARIANT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erelation_2EINDUCTIVE__INVARIANT(A_27a,A_27a),arr(arr(A_27a,arr(A_27a,bool)),arr(arr(A_27a,arr(A_27b,bool)),arr(arr(arr(A_27a,A_27b),arr(A_27a,A_27b)),bool)))) )).
...
tff(ax_thm_2Erelation_2EINDUCTIVE__INVARIANT__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
...
tff(conj_thm_2Erelation_2EINDUCTIVE__INVARIANT__WFREC,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,arr(A_27b,bool)))
