...
fof(conj_thm_2Ereal__topology_2EBOUNDED__CLOSED__NEST,conjecture,(
    ! [V0s] :
     ...
     => ( ( ! [V1n] :
          ...
          & p(ap(c_2Ereal__topology_2Ebounded__def,ap(V0s,c_2Enum_2E0))) )
       => ? [V5a] :
            ( mem(V5a,ty_2Erealax_2Ereal)
            & ! [V6n] :
                ( mem(V6n,ty_2Enum_2Enum)
               => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5a),ap(V0s,V6n))) ) ) ) ) )).
