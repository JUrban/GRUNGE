...
fof(conj_thm_2Efinite__map_2EDRESTRICT__FUNION__DRESTRICT__COMPL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                  ( mem(V1s,arr(A_27a,bool))
                 => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),V1s)),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),ap(c_2Epred__set_2ECOMPL(A_27a),V1s))) = V0f ) ) ) ) )).
