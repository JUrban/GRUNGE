...
fof(conj_thm_2Ereal__topology_2ESEPARATE__POINT__CLOSED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
           ...
           => ? [V2d] :
                ...
                & ! [V3x] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V0s))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,V2d),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V3x)))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEPARATE__COMPACT__CLOSED,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
