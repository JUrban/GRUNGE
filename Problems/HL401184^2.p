...
thf(conj_thm_2Edivides_2EONE__DIVIDES__ALL,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Edivides_2Edivides @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) ) )).
...
thf(conj_thm_2Egcd_2EPRIME__IS__GCD,conjecture,(
