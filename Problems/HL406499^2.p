    ...
    = ( ap @ c_2Ebitstring_2Ebitwise
      @ ( lam @ bool
        @ ^ [V0x: $i] :
            ( lam @ bool
            @ ^ [V1y: $i] :
                ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ V0x ) @ V1y ) ) ) ) ) )).
     ...
     => ! [V1w: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__nor @ A_27a ) @ V0v ) @ V1w )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0v ) @ V2i ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ V2i ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Eword__nor__v2w,conjecture,(
