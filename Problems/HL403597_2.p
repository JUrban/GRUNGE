...
tff(conj_thm_2Einftree_2Erelrec__rules,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] :
      ( ! [V0lf: $i] :
         ...
         => ! [V1nd: $i] :
             ...
             => ! [V2a: $i] :
                  ( mem(V2a,A_27a)
                 => p(ap(ap(ap(ap(c_2Einftree_2Erelrec(A_27a,A_27a,A_27a,A_27a),V0lf),V1nd),ap(c_2Einftree_2EiLf(A_27a,A_27a,A_27a),V2a)),ap(V0lf,V2a))) ) ) )
      & ! [V3lf: $i] :
             ...
             => ! [V5b: $i] :
                 ...
                 => ! [V6df: $i] :
                     ...
                     => ! [V7g: $i] :
                         ...
                         => ( ! [V8d: $i] :
                                ( mem(V8d,A_27d)
                               => p(ap(ap(ap(ap(c_2Einftree_2Erelrec(A_27a,A_27a,A_27a,A_27a),V3lf),V4nd),ap(V6df,V8d)),ap(V7g,V8d))) )
                           => p(ap(ap(ap(ap(c_2Einftree_2Erelrec(A_27a,A_27a,A_27a,A_27a),V3lf),V4nd),ap(ap(c_2Einftree_2EiNd(A_27a,A_27a,A_27a),V5b),V6df)),ap(ap(V4nd,V5b),V7g))) ) ) ) ) ) ) ) )).
