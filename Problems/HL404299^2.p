...
thf(tp_c_2Emergesort_2Estable,type,(
    c_2Emergesort_2Estable: del > $i )).

thf(mem_c_2Emergesort_2Estable,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Emergesort_2Emergesort__def,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Emergesort_2Emergesort @ A_27a ) @ V0R ) @ V1l )
            = ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2EmergesortN @ A_27a ) @ V0R ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) @ V1l ) ) ) ) )).

thf(conj_thm_2Emergesort_2EmergesortN__stable,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Emergesort_2Emergesort__stable,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
