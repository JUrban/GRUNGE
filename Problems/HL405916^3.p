...
thf(thm_2Ebit_2ENOT__BIT__GT__BITWISE,axiom,(
    ! [V0i: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2op: $o > $o > $o,V3a: tyop_2Enum_2Enum,V4b: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V1n @ V0i )
     => ( (~) @ ( c_2Ebit_2EBIT @ V0i @ ( c_2Ebit_2EBITWISE @ V1n @ V2op @ V3a @ V4b ) ) ) ) )).
...
thf(thm_2Ewords_2EWORD__LITERAL__OR,conjecture,(
    ! [A_27a: $tType] :
      ( ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
          ( ( c_2Ewords_2Eword__or @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V0n ) @ ( c_2Ewords_2En2w @ A_27a @ V1m ) )
          ...
          = ( c_2Ewords_2Eword__1comp @ A_27a
            @ ( c_2Ewords_2En2w @ A_27a
              @ ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ ( c_2Ebit_2ELOG2 @ V3m ) )
                @ ^ [V4a: $o,V5b: $o] :
                    ( c_2Ebool_2E_2F_5C @ V4a @ ( c_2Ebool_2E_7E @ V5b ) )
                @ V3m
                @ V2n ) ) ) )
      & ! [V6n: tyop_2Enum_2Enum,V7m: tyop_2Enum_2Enum] :
          ...
          = ( c_2Ewords_2Eword__1comp @ A_27a
            @ ( c_2Ewords_2En2w @ A_27a
              @ ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ ( c_2Ebit_2ELOG2 @ V7m ) )
                @ ^ [V8a: $o,V9b: $o] :
                    ( c_2Ebool_2E_2F_5C @ V8a @ ( c_2Ebool_2E_7E @ V9b ) )
                @ V7m
                @ V6n ) ) ) )
      & ! [V10n: tyop_2Enum_2Enum,V11m: tyop_2Enum_2Enum] :
