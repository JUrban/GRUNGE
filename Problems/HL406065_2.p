...
tff(lamtp_f2198,axiom,(
    ! [V2n: tp__o,V3z: tp__o] : mem(f2198(V2n,V3z),arr(bool,bool)) )).

tff(lameq_f2198,axiom,(
    ! [V2n: tp__o,V3z: tp__o,V5v: tp__o] : ap(f2198(V2n,V3z),inj__o(V5v)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,inj__o(V3z))),ap(ap(c_2Emin_2E_3D(bool),inj__o(V2n)),inj__o(V5v))) )).

tff(lmtp_f2197,type,(
    f2197: tp__o > $i )).

tff(lamtp_f2197,axiom,(
    ! [V2n: tp__o] : mem(f2197(V2n),arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

tff(lameq_f2197,axiom,(
    ! [V2n: tp__o,V3z: tp__o] : ap(f2197(V2n),inj__o(V3z)) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2198(V2n,V3z))) )).

tff(lmtp_f2196,type,(
    f2196: $i )).

tff(lamtp_f2196,axiom,(
    mem(f2196,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

tff(lameq_f2196,axiom,(
    ! [V2n: tp__o] : ap(f2196,inj__o(V2n)) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2197(V2n)) )).
    ...
    ! [A_27a: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( p(ap(ap(c_2Ewords_2Eword__gt(A_27a),V0a),V1b))
          <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2196)),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) )).
...
tff(conj_thm_2Ewords_2EWORD__GREATER,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
