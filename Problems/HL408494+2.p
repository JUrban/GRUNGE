...
fof(conj_thm_2Ebinary__ieee_2Efloat__is__finite,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V0x))
              <=> ( p(ap(c_2Ebinary__ieee_2Efloat__is__normal(A_27a,A_27a),V0x))
                  | p(ap(c_2Ebinary__ieee_2Efloat__is__subnormal(A_27a,A_27a),V0x))
                  | p(ap(c_2Ebinary__ieee_2Efloat__is__zero(A_27a,A_27a),V0x)) ) ) ) ) ) )).
