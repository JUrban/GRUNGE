...
tff(conj_thm_2Ebag_2EEMPTY__BAG__alt,lemma,(
    ! [A_27a: del] : c_2Ebag_2EEMPTY__BAG(A_27a) = k(A_27a,c_2Enum_2E0) )).
...
tff(conj_thm_2Ebag_2EBAG__FILTER__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Ebag_2EBAG__IMAGE__EMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
