...
thf(thm_2Econtainer_2EBAG__OF__FMAP__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0f: A_27b > A_27c > A_27a,V1b: tyop_2Efinite__map_2Efmap @ A_27b @ A_27c] :
      ...
      = ( ^ [V2x: A_27a] :
            ...
            @ ^ [V3k: A_27b] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27b @ V3k @ ( c_2Efinite__map_2EFDOM @ A_27b @ A_27c @ V1b ) ) @ ( c_2Emin_2E_3D @ A_27a @ V2x @ ( V0f @ V3k @ ( c_2Efinite__map_2EFAPPLY @ A_27b @ A_27c @ V1b @ V3k ) ) ) ) ) ) ) )).
