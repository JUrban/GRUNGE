...
fof(mem_c_2Eprobability_2Econditional__distribution,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,A_27b),arr(arr(A_27a,A_27c),arr(arr(A_27b,bool),arr(arr(A_27c,bool),ty_2Erealax_2Ereal)))))) ) ) ) )).
...
fof(ax_thm_2Eprobability_2Econditional__distribution__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V2Y] :
                         ...
                         => ! [V3a] :
                             ...
                             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                               ...
                               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),V3a))) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eprobability_2Edistribution__pos,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1X] :
                 ...
                 => ! [V2a] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V2a))) ) ) ) ) ) ) )).

fof(conj_thm_2Eprobability_2Econditional__distribution__pos,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V2Y] :
                         ...
                         => ! [V3a] :
                             ...
                             => ! [V4b] :
                                 ...
                                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                      & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V1X),V2Y),V3a),V4b))) ) ) ) ) ) ) ) ) ) )).
