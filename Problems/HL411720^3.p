...
thf(thm_2Ereal__topology_2EAFFINITY__INVERSES,conjecture,(
    ! [V0m: tyop_2Erealax_2Ereal,V1c: tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0m
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( ( ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V0m @ V2x ) @ V1c )
            @ ^ [V3x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Einv @ V0m ) @ V3x ) @ ( c_2Erealax_2Ereal__neg @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Einv @ V0m ) @ V1c ) ) ) )
          = ( ^ [V4x: tyop_2Erealax_2Ereal] : V4x ) )
        & ( ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V5x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Einv @ V0m ) @ V5x ) @ ( c_2Erealax_2Ereal__neg @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Einv @ V0m ) @ V1c ) ) )
            @ ^ [V6x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V0m @ V6x ) @ V1c ) )
          = ( ^ [V7x: tyop_2Erealax_2Ereal] : V7x ) ) ) ) )).
