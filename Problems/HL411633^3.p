...
thf(thm_2Ereal__topology_2ELINEAR__SCALING,axiom,(
    ! [V0c: tyop_2Erealax_2Ereal] :
      ...
      @ ^ [V1x: tyop_2Erealax_2Ereal] :
          ( c_2Erealax_2Ereal__mul @ V0c @ V1x ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__RIGHT__EQ,axiom,(
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__SCALING__RIGHT,conjecture,(
    ! [V0c: tyop_2Erealax_2Ereal] :
      ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V0c )
     => ! [V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
