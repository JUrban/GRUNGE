...
fof(conj_thm_2Ewords_2Eword__xor__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__LITERAL__XOR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
              ( mem(V1m,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__xor(A_27a),ap(c_2Ewords_2En2w(A_27a),V0n)),ap(c_2Ewords_2En2w(A_27a),V1m)) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(ap(c_2Earithmetic_2EMAX,ap(c_2Ebit_2ELOG2,V0n)),ap(c_2Ebit_2ELOG2,V1m)))),f2218),V0n),V1m)) ) ) ) )).
