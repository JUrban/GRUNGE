...
thf(conj_thm_2Ereal__topology_2ELINEAR__SCALING,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap @ c_2Ereal__topology_2Elinear
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V1x: $i] :
              ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ V1x ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__LEFT__EQ,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SCALING__LEFT,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
