...
fof(conj_thm_2Erelation_2ERTC__IDEM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(conj_thm_2Erelation_2EIDEM__RTC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => p(ap(c_2Erelation_2EIDEM(arr(A_27a,arr(A_27a,bool))),c_2Erelation_2ERTC(A_27a))) ) )).
