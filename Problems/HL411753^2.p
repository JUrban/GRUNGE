...
thf(conj_thm_2Ereal__topology_2EFROM__0,lemma,
...
thf(conj_thm_2Ereal__topology_2ESUMS__REINDEX__GEN,conjecture,(
    ! [V0k: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V2l: tp__ty_2Erealax_2Ereal,V3s: $i] :
         ...
         => ( ( p
              @ ( ap
                ...
                @ V3s ) )
          <=> ( p
              @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V1a ) @ ( inj__ty_2Erealax_2Ereal @ V2l ) )
                @ ( ap
                  @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V5i: $i] :
                          ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V5i ) @ ( inj__ty_2Enum_2Enum @ V0k ) ) ) )
                  @ V3s ) ) ) ) ) ) )).
