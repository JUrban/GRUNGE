...
tff(conj_thm_2EHolSmt_2Er212,conjecture,(
    ! [V0u: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2v: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal,V5a: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0u))),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2v)),inj__ty_2Erealax_2Ereal(V3y))),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V4z))))),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V5a))))
    <=> ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0u)),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V2v))),inj__ty_2Erealax_2Ereal(V3y))),inj__ty_2Erealax_2Ereal(V4z)))),inj__ty_2Erealax_2Ereal(V5a))) ) )).
