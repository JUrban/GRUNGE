...
tff(conj_thm_2Earithmetic_2ELESS__EQ__EXISTS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Earithmetic_2EZERO__LT__EXP,lemma,(
...
tff(conj_thm_2Earithmetic_2EEXISTS__GREATEST,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Ereal_2EREAL__INV__0,lemma,(
    surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
...
tff(conj_thm_2Ereal_2EREAL__LE__01,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__EQ__RMUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__LT__INV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) )
...
tff(conj_thm_2Ereal_2EREAL__LE__RDIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
...
tff(conj_thm_2Ereal_2EREAL__LE__RMUL__IMP,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1y)),inj__ty_2Erealax_2Ereal(V2z))) )
...
tff(conj_thm_2Ereal_2EPOW__ONE,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V0n))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).
...
tff(conj_thm_2Ereal_2EREAL__ABS__0,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__ABS__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1y)))) )).

tff(conj_thm_2Ereal_2EREAL__DIV__RMUL__CANCEL,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
      ( V0c != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V0c))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V0c)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))) ) )).
...
tff(tp_c_2Eieee_2Eis__closest,type,(
    c_2Eieee_2Eis__closest: del > $i )).

tff(mem_c_2Eieee_2Eis__closest,axiom,(
...
tff(ax_thm_2Eieee_2Eis__valid,axiom,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum,V1s: tp__ty_2Enum_2Enum,V2e: tp__ty_2Enum_2Enum,V3f: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eieee_2Eis__valid,inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V0X)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1s)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2e)),inj__ty_2Enum_2Enum(V3f)))))
...
tff(ax_thm_2Eieee_2Ethreshold,axiom,(
...
tff(ax_thm_2Eieee_2Eis__closest,axiom,(
    ! [A_27a: del,V0v: $i] :
...
tff(conj_thm_2Efloat_2EIS__FINITE__EXPLICIT,lemma,(
...
tff(conj_thm_2Efloat_2ECLOSEST__IS__CLOSEST,lemma,(
    ! [V0v: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3s: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V3s))
               => ( V3s != c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
                 => p(ap(ap(ap(ap(c_2Eieee_2Eis__closest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V3s),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(ap(ap(c_2Eieee_2Eclosest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V1p),V3s),inj__ty_2Erealax_2Ereal(V2x)))) ) ) ) ) ) )).

tff(lmtp_f3240,type,(
    f3240: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum > $i )).

tff(lamtp_f3240,axiom,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] : mem(f3240(V0X),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).

tff(lameq_f3240,axiom,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum,V1a: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] : ap(f3240(V0X),inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V1a)) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V1a)),ap(ap(c_2Eieee_2Eis__finite,inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V0X)),inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V1a))) )).

tff(conj_thm_2Efloat_2EIS__FINITE__FINITE,lemma,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] : p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),f3240(V0X)))) )).

tff(conj_thm_2Efloat_2EIS__FINITE__NONEMPTY,lemma,(
    ! [V0X: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] : ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),f3240(V0X)) != c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).
...
tff(conj_thm_2Efloat_2EERROR__BOUND__NORM__STRONG,conjecture,(
