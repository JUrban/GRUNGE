...
thf(conj_thm_2Ereal_2ENUM__FLOOR__LE2,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) )
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) ) )
      <=> ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) ) ) ) )).
