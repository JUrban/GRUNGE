...
thf(thm_2Ebag_2Edominates__SUBSET,conjecture,(
    ! [A_27a: $tType,V0Y: A_27a > $o,V1X: A_27a > $o,V2R: A_27a > A_27a > $o] :
      ( ( ( c_2Erelation_2Etransitive @ A_27a @ V2R )
        & ( c_2Epred__set_2EFINITE @ A_27a @ V0Y )
        & ( c_2Ebag_2Edominates @ A_27a @ A_27a @ V2R @ V0Y @ V1X )
        & ( c_2Epred__set_2ESUBSET @ A_27a @ V1X @ V0Y )
        & ( (~)
          @ ( V1X
            = ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) )
     => ? [V3x: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V1X )
          & ( V2R @ V3x @ V3x ) ) ) )).
