...
thf(f2189_0_2E0,type,(
    f2189_0_2E0: u )).

thf(f2189_0_2E1,type,(
    f2189_0_2E1: du > u )).

thf(f2189_1_2E0,type,(
    f2189_1_2E0: u )).

thf(f2189_1_2E1,type,(
    f2189_1_2E1: du > u )).

thf(f2189_1_2E2,type,(
    f2189_1_2E2: du > du > u )).

thf(f2189_2_2E0,type,(
    f2189_2_2E0: u )).

thf(f2189_2_2E1,type,(
    f2189_2_2E1: du > u )).

thf(f2189_2_2E2,type,(
    f2189_2_2E2: du > du > u )).

thf(f2189_3_2E0,type,(
    f2189_3_2E0: u )).

thf(f2189_3_2E2,type,(
    f2189_3_2E2: du > du > u )).
...
thf(c_2Epred__set_2EMAX__SET_2E0,type,(
    c_2Epred__set_2EMAX__SET_2E0: u )).

thf(c_2Epred__set_2EMAX__SET_2E1,type,(
    c_2Epred__set_2EMAX__SET_2E1: du > u )).

thf(c_2Epred__set_2EMIN__SET_2E0,type,(
    c_2Epred__set_2EMIN__SET_2E0: u )).

thf(c_2Epred__set_2EMIN__SET_2E1,type,(
...
thf(c_2Edivides_2Edivides_2E0,type,(
    c_2Edivides_2Edivides_2E0: u )).

thf(c_2Edivides_2Edivides_2E2,type,(
    c_2Edivides_2Edivides_2E2: du > du > u )).

thf(c_2Egcdset_2Egcdset_2E0,type,(
    c_2Egcdset_2Egcdset_2E0: u )).

thf(c_2Egcdset_2Egcdset_2E1,type,(
...
thf(c_2Egcd_2Elcm_2E0,type,(
    c_2Egcd_2Elcm_2E0: u )).

thf(c_2Egcd_2Elcm_2E2,type,(
...
thf(mono_2Ef2189_0,type,(
    mono_2Ef2189_0: ( mono_2Etyop_2Enum_2Enum > $o ) > $o )).

thf(mono_2Ef2189_1,type,(
    mono_2Ef2189_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef2189_2,type,(
    mono_2Ef2189_2: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef2189_3,type,(
    mono_2Ef2189_3: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(mono_2Ec_2Epred__set_2EMAX__SET,type,(
    mono_2Ec_2Epred__set_2EMAX__SET: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Epred__set_2EMIN__SET,type,(
    mono_2Ec_2Epred__set_2EMIN__SET: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum )).
...
thf(mono_2Ec_2Edivides_2Edivides,type,(
    mono_2Ec_2Edivides_2Edivides: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ec_2Egcdset_2Egcdset,type,(
    mono_2Ec_2Egcdset_2Egcdset: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Enumeral_2EiZ,type,(
    mono_2Ec_2Enumeral_2EiZ: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Egcd_2Elcm,type,(
    mono_2Ec_2Egcd_2Elcm: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Edivides_2EALL__DIVIDES__0,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Edivides_2Edivides @ V0a @ mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Edivides_2EZERO__DIVIDES,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Edivides_2Edivides @ mono_2Ec_2Enum_2E0 @ V0m )
    <=> ( V0m = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Edivides_2EONE__DIVIDES__ALL,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Edivides_2Edivides @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0a ) )).

thf(thm_2Edivides_2EDIVIDES__LE,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V1b )
        & ( mono_2Ec_2Edivides_2Edivides @ V0a @ V1b ) )
     => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0a @ V1b ) ) )).

thf(thm_2Egcd_2ELCM__IS__LEAST__COMMON__MULTIPLE,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Edivides_2Edivides @ V1m @ ( mono_2Ec_2Egcd_2Elcm @ V1m @ V0n ) )
      & ( mono_2Ec_2Edivides_2Edivides @ V0n @ ( mono_2Ec_2Egcd_2Elcm @ V1m @ V0n ) )
      & ! [V2p: mono_2Etyop_2Enum_2Enum] :
          ( ( ( mono_2Ec_2Edivides_2Edivides @ V1m @ V2p )
            & ( mono_2Ec_2Edivides_2Edivides @ V0n @ V2p ) )
         => ( mono_2Ec_2Edivides_2Edivides @ ( mono_2Ec_2Egcd_2Elcm @ V1m @ V0n ) @ V2p ) ) ) )).
...
thf(thm_2Egcd_2ELCM__LE,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1m @ ( mono_2Ec_2Egcd_2Elcm @ V1m @ V0n ) )
        & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1m @ ( mono_2Ec_2Egcd_2Elcm @ V0n @ V1m ) ) ) ) )).

thf(def0_2Ethm_2Egcdset_2Egcdset__def,axiom,(
...
thf(def1_2Ethm_2Egcdset_2Egcdset__def,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2189_1 @ V0s @ V1n )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Emin_2Ebool @ V1n @ ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1n @ ( mono_2Ec_2Epred__set_2EMIN__SET @ ( mono_2Ec_2Epred__set_2EDELETE_2Emono_2Etyop_2Enum_2Enum @ V0s @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )).

thf(def2_2Ethm_2Egcdset_2Egcdset__def,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V2d: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2189_3 @ V0s @ V2d )
    <=> ! [V3e: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3e @ V0s )
         => ( mono_2Ec_2Edivides_2Edivides @ V2d @ V3e ) ) ) )).

thf(def3_2Ethm_2Egcdset_2Egcdset__def,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V2d: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2189_2 @ V0s @ V2d )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Emin_2Ebool @ V2d @ ( mono_2Ef2189_3 @ V0s @ V2d ) ) ) )).

thf(thm_2Egcdset_2Egcdset__def,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Egcdset_2Egcdset @ V0s )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef2189_0 @ V0s ) @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Epred__set_2EMAX__SET @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef2189_1 @ V0s ) ) @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef2189_2 @ V0s ) ) ) ) ) ) )).
...
thf(thm_2Epred__set_2EINTER__FINITE,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
     ...
     => ! [V1t_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Epred__set_2EMAX__SET__ELIM,axiom,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o,V1Q: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Enum_2Enum @ V0P )
        & ( ( V0P = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Enum_2Enum )
         => ( V1Q @ mono_2Ec_2Enum_2E0 ) )
        & ! [V2x: mono_2Etyop_2Enum_2Enum] :
            ( ( ! [V3y: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3y @ V0P )
                 => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V3y @ V2x ) )
              & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2x @ V0P ) )
           => ( V1Q @ V2x ) ) )
     => ( V1Q @ ( mono_2Ec_2Epred__set_2EMAX__SET @ V0P ) ) ) )).
    ...
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o,V1Q: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( (~) @ ( V0P = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Enum_2Enum ) )
        & ! [V2x: mono_2Etyop_2Enum_2Enum] :
            ( ( ! [V3y: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3y @ V0P )
                 => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2x @ V3y ) )
              & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2x @ V0P ) )
           => ( V1Q @ V2x ) ) )
     => ( V1Q @ ( mono_2Ec_2Epred__set_2EMIN__SET @ V0P ) ) ) )).
...
thf(thm_2Egcdset_2Egcdset__greatest,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V1g: mono_2Etyop_2Enum_2Enum] :
      ( ! [V2e: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2e @ V0s )
         => ( mono_2Ec_2Edivides_2Edivides @ V1g @ V2e ) )
     => ( mono_2Ec_2Edivides_2Edivides @ V1g @ ( mono_2Ec_2Egcdset_2Egcdset @ V0s ) ) ) )).
