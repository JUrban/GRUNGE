...
fof(conj_thm_2Ecardinal_2ECARD__EQ__SYM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__EQ__COUNTABLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2EUNCOUNTABLE__REAL,lemma,(
    ~ p(ap(c_2Epred__set_2Ecountable(ty_2Erealax_2Ereal),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).

fof(conj_thm_2Ereal__topology_2ECARD__EQ__REAL__IMP__UNCOUNTABLE,conjecture,(
    ! [V0s] :
