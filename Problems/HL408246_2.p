...
tff(conj_thm_2Etransc_2EEXP__ADD__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Eexp,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))),ap(c_2Etransc_2Eexp,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))))) = surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V1y))) )).

tff(conj_thm_2Etransc_2EEXP__NEG__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eexp,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).

tff(conj_thm_2Etransc_2EEXP__ADD,conjecture,(
