...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__OF__SUBSET,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1s: $i] :
     ...
     => ! [V2t: $i] :
         ...
         => ! [V3x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1s),V2t))
                & p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V1s),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V0y))) )
             => p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V2t),inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V0y))) ) ) ) )).
