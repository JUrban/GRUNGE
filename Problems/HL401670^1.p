...
thf(f1905_0_2E0,type,(
    f1905_0_2E0: u )).

thf(f1905_0_2E1,type,(
    f1905_0_2E1: du > u )).

thf(f1905_0_2E2,type,(
    f1905_0_2E2: du > du > u )).
...
thf(mono_2Ef1905_0,type,(
    mono_2Ef1905_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 )).
...
thf(def0_2Ethm_2Epred__set_2Ecount__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1905_0 @ V0n @ V1m )
...
thf(thm_2Epred__set_2Ecount__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ...
      = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef1905_0 @ V0n ) ) ) )).
...
thf(thm_2Epred__set_2EFINITE__BIJ__COUNT,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
     => ? [V1f_2E0: u,V2b: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EBIJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ec_2Epred__set_2Ecount @ V2b ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) ) ) )).

thf(thm_2Epred__set_2EFINITE__WEAK__ENUMERATE,conjecture,(
    ! [A_27a: d,V0s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
    <=> ? [V1f_2E0: u,V2b: mono_2Etyop_2Enum_2Enum] :
        ! [V3e_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) )
        <=> ? [V4n: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Eprim__rec_2E_3C @ V4n @ V2b )
              & ( ( s @ A_27a @ V3e_2E0 )
                = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) ) ) ) ) )).
