...
thf(f10011_0_2E0,type,(
    f10011_0_2E0: u )).

thf(f10011_0_2E1,type,(
    f10011_0_2E1: du > u )).
...
thf(def0_2Ethm_2EHolSmt_2Er016,axiom,(
    ! [V0q: $o] :
      ( ( mono_2Ef10011_0 @ V0q )
    <=> ( (~) @ V0q ) ) )).

thf(thm_2EHolSmt_2Er016,conjecture,(
    ! [V0q: $o,V1p: $o] :
      ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V1p @ ( mono_2Ef10011_0 @ V0q ) @ V0q )
    <=> ( V1p
      <=> ( (~) @ V0q ) ) ) )).
