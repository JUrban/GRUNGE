...
tff(tp_c_2Emeasure_2Eouter__measure__space,type,(
    c_2Emeasure_2Eouter__measure__space: del > $i )).

tff(mem_c_2Emeasure_2Eouter__measure__space,axiom,(
    ! [A_27a: del] : mem(c_2Emeasure_2Eouter__measure__space(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) )).
...
tff(ax_thm_2Emeasure_2Eouter__measure__space__def,axiom,(
    ! [A_27a: del,V0m: $i] :
...
tff(conj_thm_2Emeasure_2EOUTER__MEASURE__SPACE__POSITIVE,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Eouter__measure__space(A_27a),V0m))
       => p(ap(c_2Emeasure_2Epositive(A_27a),V0m)) ) ) )).
