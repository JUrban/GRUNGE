...
tff(conj_thm_2Elift__ieee_2Efloat__sub__relative,lemma,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
           ...
           => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),V0a),V1b))))
...
tff(tp_c_2Emachine__ieee_2Efp16__sub,type,(
    c_2Emachine__ieee_2Efp16__sub: $i )).

tff(mem_c_2Emachine__ieee_2Efp16__sub,axiom,(
    mem(c_2Emachine__ieee_2Efp16__sub,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))))) )).
...
tff(conj_thm_2Elift__machine__ieee_2Efp16__float__sub__relative,conjecture,(
