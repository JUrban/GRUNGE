...
fof(lamtp_f4022,axiom,(
    ! [V0k] :
      ( mem(V0k,ty_2Enum_2Enum)
     => mem(f4022(V0k),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
fof(lameq_f4022,axiom,(
    ! [V0k] :
     ...
     => ! [V5i] :
         ...
         => ap(f4022(V0k),V5i) = ap(ap(c_2Earithmetic_2E_2B,V5i),V0k) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUMS__REINDEX__GEN,conjecture,(
    ! [V0k] :
      ( mem(V0k,ty_2Enum_2Enum)
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2l] :
             ...
             => ! [V3s] :
                 ...
                 => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,f4021(V0k,V1a)),V2l),V3s))
                  <=> p(ap(ap(ap(c_2Ereal__topology_2Esums,V1a),V2l),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f4022(V0k)),V3s))) ) ) ) ) ) )).
