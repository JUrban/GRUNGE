...
thf(conj_thm_2Ebinary__ieee_2Edatatype__flags,conjecture,(
    ! [V0record: $i] :
      ( ( mem @ V0record @ ( arr @ ty_2Ebinary__ieee_2Eflags @ ( arr @ bool @ ( arr @ bool @ ( arr @ bool @ ( arr @ bool @ ( arr @ bool @ ( arr @ bool @ bool ) ) ) ) ) ) ) )
     => ! [V1flags: tp__ty_2Ebinary__ieee_2Eflags,V2DivideByZero: $o,V3InvalidOp: $o,V4Overflow: $o,V5Precision: $o,V6Underflow__BeforeRounding: $o,V7Underflow__AfterRounding: $o] :
          ( p @ ( ap @ ( c_2Ebool_2EDATATYPE @ bool ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ V0record @ ( inj__ty_2Ebinary__ieee_2Eflags @ V1flags ) ) @ ( inj__o @ V2DivideByZero ) ) @ ( inj__o @ V3InvalidOp ) ) @ ( inj__o @ V4Overflow ) ) @ ( inj__o @ V5Precision ) ) @ ( inj__o @ V6Underflow__BeforeRounding ) ) @ ( inj__o @ V7Underflow__AfterRounding ) ) ) ) ) )).
