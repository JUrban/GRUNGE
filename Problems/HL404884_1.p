...
tff(thm_2Elbtree_2Emem__rules,conjecture,(
    ! [A_27a: d] :
      ( ! [V0a_2E0: u,V1t1_2E0: u,V2t2_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V0a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V0a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V1t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V2t2_2E0)))))))
      & ! [V3a_2E0: u,V4b_2E0: u,V5t1_2E0: u,V6t2_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V3a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V5t1_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V3a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V4b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V5t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V6t2_2E0))))))) )
      & ! [V7a_2E0: u,V8b_2E0: u,V9t1_2E0: u,V10t2_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V7a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V10t2_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V7a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V8b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V9t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V10t2_2E0))))))) ) ) )).
