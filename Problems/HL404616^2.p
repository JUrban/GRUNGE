...
thf(conj_thm_2Efinite__map_2Eis__fmap__rules,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ( p
                 ...
                 => ( ( p @ ( ap @ ( c_2Efinite__map_2Eis__fmap @ A_27a @ A_27b ) @ V1f ) )
                   => ( p
                      @ ( ap @ ( c_2Efinite__map_2Eis__fmap @ A_27a @ A_27b )
                        @ ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27b @ ty_2Eone_2Eone ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V4x ) @ V2a ) ) @ ( ap @ ( c_2Esum_2EINL @ A_27b @ ty_2Eone_2Eone ) @ V3b ) ) @ ( ap @ V1f @ V4x ) ) ) ) ) ) ) ) ) ) )).
