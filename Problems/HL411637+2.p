...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__OPEN__GEN,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1h] :
                     ...
                     => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s) = V3t
                          ...
                          & ! [V7x] :
                             ...
                             => ! [V8y] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),V2s))
                                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V8y),V2s))
                                      & ap(V0f,V7x) = ap(V0f,V8y) )
                                   => ap(V1h,V7x) = ap(V1h,V8y) ) ) ) )
                       => ? [V9g] :
                            ...
                            & ! [V10x] :
                               ...
                               => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V10x),V2s))
                                 => ap(V1h,V10x) = ap(V9g,ap(V0f,V10x)) ) ) ) ) ) ) ) ) ) )).
     ...
     => ! [V1g] :
         ...
         => ! [V7v] :
             ...
             => ! [V8x] :
                 ...
                 => ap(f3998(V2s,V1g,V7v),V8x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V8x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V8x),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1g,V8x)),V7v))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE__UNIQUE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                     ...
                     => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s) = V3t
                          ...
                          & ! [V9x] :
                             ...
                             => ! [V10y] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V9x),V2s))
                                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V10y),V2s)) )
                                   => ( ap(V0f,V9x) = ap(V0f,V10y)
                                    <=> ap(V1g,V9x) = ap(V1g,V10y) ) ) ) ) )
