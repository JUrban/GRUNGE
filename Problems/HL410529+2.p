...
fof(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__LEFT__INVERSE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INVERTIBLE__BOUNDED__BELOW__POS,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__BOUNDED__BELOW__POS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1x] :
