...
fof(lamtp_f3900,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => mem(f3900(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

fof(lameq_f3900,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3900(V0a),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Ereal_2Ereal__lte,V1x),V0a)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__LE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3900(V0a)))) ) )).

fof(conj_thm_2Ereal__topology_2EIMAGE__CLOSURE__SUBSET,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__COMPONENT__LE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                      & ! [V4y] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1s))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V4y)),V3b)) ) )
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),ap(c_2Ereal__topology_2Eclosure,V1s))) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V2x)),V3b)) ) ) ) ) ) )).
