...
tff(conj_thm_2Estate__transformer_2EEXT__o__JOIN,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,arr(A_27a,ty_2Epair_2Eprod(A_27c,A_27c))))
...
tff(conj_thm_2Estate__transformer_2EMMAP__JOIN,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27c))
     => ap(ap(c_2Ecombin_2Eo(arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))),arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))),arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))))),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V0f)),c_2Estate__transformer_2EJOIN(A_27a,A_27a)) = ap(ap(c_2Ecombin_2Eo(arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))),arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))),arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))))),c_2Estate__transformer_2EJOIN(A_27a,A_27a)),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V0f))) ) )).
