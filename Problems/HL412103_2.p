...
tff(conj_thm_2Epred__set_2ECOUNTABLE__ENUM,lemma,(
    ! [A_27a: del,V0c: $i] :
     ...
     => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0c))
      <=> ( V0c = c_2Epred__set_2EEMPTY(A_27a)
          | ? [V1f: $i] :
              ...
              & V0c = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)) ) ) ) ) )).
...
tff(conj_thm_2Eseq_2ESER__0,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ! [V2m: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2m)))
             => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V2m))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
...
tff(conj_thm_2Eprobability_2EPROB__POSITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eprobability_2EEVENTS__COUNTABLE__UNION,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: $i] :
...
tff(conj_thm_2Eprobability_2EPROB__COUNTABLY__SUBADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              & p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
              & p(ap(c_2Eseq_2Esummable,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V1f))) )
           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))),ap(c_2Eseq_2Esuminf,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V1f)))) ) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__COUNTABLY__ZERO,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: $i] :
          ( mem(V1c,arr(arr(A_27a,bool),bool))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              ...
              & ! [V2x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2x),V1c))
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2x)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(c_2Epred__set_2EBIGUNION(A_27a),V1c))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).
