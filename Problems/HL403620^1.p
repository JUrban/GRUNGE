...
thf(f4066_0_2E0,type,(
    f4066_0_2E0: u )).

thf(f4066_0_2E2,type,(
    f4066_0_2E2: du > du > u )).
...
thf(mono_2Ef4066_0,type,(
    mono_2Ef4066_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Efcp_2EFCP__APPLY__UPDATE__THM,axiom,(
    ! [V2a: mono_2Etyop_2Enum_2Enum,V4b: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4066_0 @ V2a @ V4b )
    <=> ( V2a = V4b ) ) )).

thf(thm_2Efcp_2EFCP__APPLY__UPDATE__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0index_20out_20of_20range: $o,V1m_2E0: u,V2a: mono_2Etyop_2Enum_2Enum,V3w_2E0: u,V4b: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2E_3A_2B_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2a ) ) @ ( s @ A_27a @ V3w_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V1m_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4b ) ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eprim__rec_2E_3C @ V4b @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27b ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) ) ) ) @ ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4066_0 @ V2a @ V4b ) ) ) @ ( s @ A_27a @ V3w_2E0 ) @ ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V1m_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4b ) ) ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ ( c_2Ecombin_2EFAIL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ c_2Efcp_2Efcp__index_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V0index_20out_20of_20range ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2E_3A_2B_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2a ) ) @ ( s @ A_27a @ V3w_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V1m_2E0 ) ) ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4b ) ) ) ) ) ) ) )).
