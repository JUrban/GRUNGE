...
fof(conj_thm_2Ereal__topology_2EOPEN__HALFSPACE__LT,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3902(V1b,V0a)))) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__HALFSPACE__LT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( ~ ( V0a = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
           ...
           => ap(c_2Ereal__topology_2Efrontier,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3902(V1b,V0a))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3898(V1b,V0a)) ) ) ) )).
