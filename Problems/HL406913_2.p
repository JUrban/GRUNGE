...
tff(conj_thm_2Efmapal_2EORL__sublists__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),bool)))
     => ( ( ! [V1cmp: $i] :
              ( mem(V1cmp,ty_2Etoto_2Etoto(A_27a))
             => p(ap(ap(V0P,V1cmp),c_2Elist_2ENIL(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))) )
          & ! [V2cmp: $i] :
              ( mem(V2cmp,ty_2Etoto_2Etoto(A_27a))
             => ! [V3lol: $i] :
                  ( mem(V3lol,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
                 => ( p(ap(ap(V0P,V2cmp),V3lol))
                   => p(ap(ap(V0P,V2cmp),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),c_2Eoption_2ENONE(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),V3lol))) ) ) )
          & ! [V4cmp: $i] :
              ( mem(V4cmp,ty_2Etoto_2Etoto(A_27a))
             => ! [V5m: $i] :
                  ( mem(V5m,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                 => ! [V6lol: $i] :
                      ( mem(V6lol,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
                     => ( p(ap(ap(V0P,V4cmp),V6lol))
                       => p(ap(ap(V0P,V4cmp),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))),ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))),V5m)),V6lol))) ) ) ) ) )
       => ! [V7v: $i] :
            ( mem(V7v,ty_2Etoto_2Etoto(A_27a))
           => ! [V8v1: $i] :
                ( mem(V8v1,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))))
