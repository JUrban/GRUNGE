...
thf(conj_thm_2Elist_2EALL__DISTINCT__CARD__LIST__TO__SET,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
thf(conj_thm_2Elist_2Eall__distinct__nub,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( p @ ( ap @ ( c_2Elist_2EALL__DISTINCT @ A_27a ) @ ( ap @ ( c_2Elist_2Enub @ A_27a ) @ V0l ) ) ) ) )).

thf(conj_thm_2Elist_2Elist__to__set__diff,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
            ...
            = ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a )
              @ ( ap
                @ ( ap @ ( c_2Elist_2EFILTER @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V0l1 ) ) ) ) )
                @ V1l2 ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2ECARD__UNION__EQN,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Elist_2Elength__nub__append,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
