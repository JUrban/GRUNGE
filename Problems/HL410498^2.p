...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__MONO,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2EIN__SPAN__INSERT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__INSERT,conjecture,(
