...
thf(thm_2Ereal__topology_2ECOMPONENTS__NONOVERLAP,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal > $o,V2c_27: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V1c @ ( c_2Ereal__topology_2Ecomponents @ V0s ) )
        & ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2c_27 @ ( c_2Ereal__topology_2Ecomponents @ V0s ) ) )
     => ( ( ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V1c @ V2c_27 )
          = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
      <=> ( (~) @ ( V1c = V2c_27 ) ) ) ) )).
