...
fof(conj_thm_2Esorting_2ESORTED__PERM__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Esorting_2Esorted__perm__count__list,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2l] :
                     ...
                     => ! [V3n] :
                         ...
                         => ( ( p(ap(ap(c_2Esorting_2ESORTED(A_27b),ap(ap(c_2Erelation_2Einv__image(A_27b,A_27b),c_2Earithmetic_2E_3C_3D),V1f)),V2l))
                              & p(ap(ap(c_2Esorting_2EPERM(ty_2Enum_2Enum),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l)),ap(c_2Erich__list_2ECOUNT__LIST,V3n))) )
                           => ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l) = ap(c_2Erich__list_2ECOUNT__LIST,V3n) ) ) ) ) ) ) ) )).
