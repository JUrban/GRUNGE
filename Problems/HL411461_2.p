...
tff(lamtp_f3946,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3946(V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3946,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3946(V0f),inj__ty_2Erealax_2Ereal(V3x)) = ap(V0f,inj__ty_2Erealax_2Ereal(V3x)) ) )).

tff(lmtp_f3947,type,(
    f3947: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3947,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : mem(f3947(V0f,V2n),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3947,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum,V4x: tp__ty_2Erealax_2Ereal] : ap(f3947(V0f,V2n),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Ereal_2Epow,ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),inj__ty_2Enum_2Enum(V2n)) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__POW,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2n: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3946(V0f)),V1s))
             => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3947(V0f,V2n)),V1s)) ) ) ) )).
