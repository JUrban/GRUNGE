...
fof(lamtp_f3649,axiom,(
    ! [V0op] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => mem(f3649(V0op,V1x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3649,axiom,(
    ! [V0op] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
              ( mem(V2y,ty_2Erealax_2Ereal)
             => ap(f3649(V0op,V1x),V2y) = ap(ap(V0op,V2y),V1x) ) ) ) )).

fof(lamtp_f3648,axiom,(
    ! [V0op] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
...
fof(lameq_f3648,axiom,(
    ! [V0op] :
     ...
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3648(V0op),V1x) = f3649(V0op,V1x) ) ) )).

fof(conj_thm_2Ereal__topology_2EBILINEAR__SWAP,conjecture,(
    ! [V0op] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
