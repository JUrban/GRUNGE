...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SUBSET__BALL,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS__EXPLICIT,lemma,(
    ! [V0f: $i] :
             ...
             => ( ( ! [V3x: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ( p
                          @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V7x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V7x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V7x ) ) @ V6u ) ) ) ) ) ) ) ) ) )
               => ! [V8x: tp__ty_2Erealax_2Ereal,V9e: tp__ty_2Erealax_2Ereal] :
                    ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V8x ) ) @ V2s ) )
                      ...
                      & ( ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V8x ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
