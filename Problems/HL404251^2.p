                      ...
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ bool )
                              @ ^ [V4t: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0p @ V3x ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ bool ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V2l ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ bool ) @ ( ap @ V1e @ V3x ) ) @ V4t ) ) ) ) ) ) ) )
                      ...
                      @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ ( ty_2Elist_2Elist @ bool ) @ bool )
                        @ ( lam @ A_27a
                          @ ^ [V5x: $i] :
                              ( lam @ ( ty_2Elist_2Elist @ bool )
                              @ ^ [V6t: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0p @ V5x ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ bool ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V2l ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ bool ) @ ( ap @ V1e @ V5x ) ) @ V6t ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2EDecode_2Eenc2dec__none,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
