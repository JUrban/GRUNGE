...
tff(tp_c_2Efinite__map_2EFEVERY,type,(
    c_2Efinite__map_2EFEVERY: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2EFEVERY,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2EFEVERY(A_27a,A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),bool))) )).
...
tff(ax_thm_2Efinite__map_2EFEVERY__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1f: $i] :
          ( mem(V1f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V0P),V1f))
          <=> ! [V2x: $i] :
                ( mem(V2x,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f)))
                 => p(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1f),V2x)))) ) ) ) ) ) )).
...
tff(lmtp_f1909,type,(
    f1909: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f1909,axiom,(
    ! [A_27a: del,A_27c: del,A_27a: del,A_27b: del,V2f: $i] :
      ( mem(V2f,arr(A_27b,A_27c))
     => ! [V1P: $i] :
          ( mem(V1P,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
         => mem(f1909(A_27a,A_27c,A_27a,A_27b,V2f,V1P),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)) ) ) )).

tff(lameq_f1909,axiom,(
    ! [A_27a: del,A_27c: del,A_27a: del,A_27b: del,V2f: $i] :
      ( mem(V2f,arr(A_27b,A_27c))
     => ! [V1P: $i] :
          ( mem(V1P,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
         => ! [V3x: $i] :
             ...
             => ap(f1909(A_27a,A_27c,A_27a,A_27b,V2f,V1P),V3x) = ap(V1P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V3x)),ap(V2f,ap(c_2Epair_2ESND(A_27a,A_27a),V3x)))) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFEVERY__o__f,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0m: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(A_27b,A_27c))
             => ( p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),V1P),ap(ap(c_2Efinite__map_2Eo__f(A_27a,A_27a,A_27a),V2f),V0m)))
              <=> p(ap(ap(c_2Efinite__map_2EFEVERY(A_27a,A_27a),f1909(A_27a,A_27c,A_27a,A_27b,V2f,V1P)),V0m)) ) ) ) ) )).
