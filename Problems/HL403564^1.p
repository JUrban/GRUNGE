...
thf(f4738_0_2E0,type,(
    f4738_0_2E0: u )).

thf(f4738_0_2E2,type,(
    f4738_0_2E2: du > du > u )).

thf(f4738_0_2E4,type,(
    f4738_0_2E4: du > du > du > du > u )).

thf(f4738_1_2E0,type,(
    f4738_1_2E0: u )).

thf(f4738_1_2E4,type,(
    f4738_1_2E4: du > du > du > du > u )).

thf(f4740_0_2E0,type,(
    f4740_0_2E0: u )).

thf(f4740_0_2E2,type,(
    f4740_0_2E2: du > du > u )).

thf(f4740_0_2E4,type,(
    f4740_0_2E4: du > du > du > du > u )).

thf(f4740_1_2E0,type,(
    f4740_1_2E0: u )).

thf(f4740_1_2E4,type,(
...
thf(c_2Ewellorder_2Eremove_2E0,type,(
    c_2Ewellorder_2Eremove_2E0: u )).

thf(c_2Ewellorder_2Eremove_2E2,type,(
...
thf(arityeq2_2Emono_2Ef4738_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4738_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) ) @ f4738_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef4738_0_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4738_0_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef4738_1_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4738_1_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X3_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ef4740_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4740_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef4740_0_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4740_0_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef4740_1_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4740_1_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X3_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Ewellorder_2Eremove_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( c_2Ewellorder_2Eremove_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) )
...
thf(def0_2Ethm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a: d,V2x_2E0: u,V0e_2E0: u,V3y_2E0: u,V1w_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4740_1_2E4 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) ) )
    <=> ( ( (~)
          @ ( ( s @ A_27a @ V2x_2E0 )
            = ( s @ A_27a @ V0e_2E0 ) ) )
        & ( (~)
          @ ( ( s @ A_27a @ V3y_2E0 )
            = ( s @ A_27a @ V0e_2E0 ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a: d,V0e_2E0: u,V1w_2E0: u,V2x_2E0: u,V3y_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4740_0_2E4 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( f4740_1_2E4 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a: d,V0e_2E0: u,V1w_2E0: u] :
      ( ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( c_2Ewellorder_2Eremove_2E2 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) )
      = ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( c_2Ewellorder_2Ewellorder__ABS_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4740_0_2E2 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) ) ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2Ewellorder_2Ewellorder__remove,axiom,(
    ! [A_27a: d,V2x_2E0: u,V1e_2E0: u,V3y_2E0: u,V0w_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4738_1_2E4 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) )
    <=> ( ( (~)
          @ ( ( s @ A_27a @ V2x_2E0 )
            = ( s @ A_27a @ V1e_2E0 ) ) )
        & ( (~)
          @ ( ( s @ A_27a @ V3y_2E0 )
            = ( s @ A_27a @ V1e_2E0 ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ewellorder_2Ewellorder__remove,axiom,(
    ! [A_27a: d,V1e_2E0: u,V0w_2E0: u,V2x_2E0: u,V3y_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4738_0_2E4 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( f4738_1_2E4 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Ewellorder__remove,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1e_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Ewellorder_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4738_0_2E2 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2EWIN__remove,conjecture,(
