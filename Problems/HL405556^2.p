...
thf(ax_thm_2Eordinal_2Epreds__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0w )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1w0: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ V1w0 ) @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V1w0 ) @ V0w ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EIN__preds,conjecture,(
    ! [A_27a: del,V0x: $i] :
