...
thf(conj_thm_2Ealist_2Ealist__to__fmap__FAPPLY__MEM,lemma,(
          ...
          @ ( lam @ A_27b
            @ ^ [V1y: $i] :
                ...
                @ ( ap @ ( c_2Ebool_2E_3F @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ A_27b ) @ V0f ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ A_27b ) @ V0f ) @ V2x ) ) @ V1y ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ealist_2EFRANGE__alist__to__fmap__SUBSET,conjecture,(
