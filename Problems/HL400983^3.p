...
thf(thm_2Earithmetic_2ESUB__LESS__SUC,axiom,(
    ! [V0p: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2E_2D @ V0p @ V1m ) @ ( c_2Enum_2ESUC @ V0p ) ) )).
...
thf(thm_2Earithmetic_2ELE__SUB__LCANCEL,conjecture,(
