...
thf(conj_thm_2Eprobability_2Emarginal__distribution2,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1X: $i] :
                      ...
                      = ( surj__ty_2Erealax_2Ereal
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27b )
                            @ ( lam @ A_27b
                              @ ^ [V4x: $i] :
                                  ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Eprobability_2Ejoint__distribution @ A_27b @ A_27c @ A_27a ) @ V0p ) @ V1X ) @ V2Y ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27b ) @ V4x ) @ ( c_2Epred__set_2EEMPTY @ A_27b ) ) ) @ V3b ) ) ) )
