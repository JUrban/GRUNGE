...
fof(conj_thm_2Epred__set_2EMIN__SET__THM,lemma,
    ( ! [V0e] :
...
fof(conj_thm_2Epred__set_2EMIN__SET__UNION,conjecture,(
    ! [V0A] :
     ...
     => ! [V1B] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0A))
           ...
           => ap(c_2Epred__set_2EMIN__SET,ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),V0A),V1B)) = ap(ap(c_2Earithmetic_2EMIN,ap(c_2Epred__set_2EMIN__SET,V0A)),ap(c_2Epred__set_2EMIN__SET,V1B)) ) ) ) )).
