...
thf(conj_thm_2Elist_2EGENLIST__APPEND,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
          ...
          = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EGENLIST @ A_27a ) @ V0f ) @ ( inj__ty_2Enum_2Enum @ V2b ) ) )
            @ ( ap
              @ ( ap @ ( c_2Elist_2EGENLIST @ A_27a )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3t: $i] :
                      ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3t ) @ ( inj__ty_2Enum_2Enum @ V2b ) ) ) ) )
              @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) ) )).

thf(conj_thm_2Elist_2ESUM__SNOC,lemma,(
...
thf(conj_thm_2Elist_2ESUM__APPEND,lemma,(
...
thf(conj_thm_2Eprim__rec_2ELESS__SUC,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Esorting_2ESUM__IMAGE__count__SUM__GENLIST,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Esorting_2ESUM__IMAGE__count__MULT,conjecture,(
