...
thf(conj_thm_2Etransc_2EEXP__MONO__LT,lemma,(
...
thf(conj_thm_2Etransc_2ELN__EXP,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eln @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
      = V0x ) )).

thf(conj_thm_2Etransc_2EEXP__LN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eexp @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
        = V0x )
    <=> ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).

thf(conj_thm_2Etransc_2ELN__INJ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
     ...
     => ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) )
      <=> ( V0x = V1y ) ) ) )).
...
thf(conj_thm_2Etransc_2ERPOW__UNIQ__EXP,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) )
        ...
        & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Etransc_2Erpow @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Etransc_2Erpow @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) ) ) )
     => ( V1b = V2c ) ) )).
