...
thf(thm_2EindexedLists_2EFOLDRi__CONG,conjecture,(
    ! [A_27a: d,A_27b: d,V0l2_2E0: u,V1l1_2E0: u,V2f2_2E0: u,V3f1_2E0: u,V4a2_2E0: u,V5a1_2E0: u] :
     ...
     => ( ! [V6n: mono_2Etyop_2Enum_2Enum,V7e_2E0: u,V8a_2E0: u] :
           ...
           => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V7e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) ) )
             => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V3f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) ) ) @ ( s @ A_27a @ V7e_2E0 ) ) ) @ ( s @ A_27b @ V8a_2E0 ) ) )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ V2f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) ) ) @ ( s @ A_27a @ V7e_2E0 ) ) ) @ ( s @ A_27b @ V8a_2E0 ) ) ) ) ) )
       => ( ( ( s @ A_27b @ V5a1_2E0 )
            = ( s @ A_27b @ V4a2_2E0 ) )
