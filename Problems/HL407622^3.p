...
thf(c_2EordinalNotation_2Eosyntax__size,type,(
    c_2EordinalNotation_2Eosyntax__size: tyop_2EordinalNotation_2Eosyntax > tyop_2Enum_2Enum )).
...
thf(thm_2EordinalNotation_2Eosyntax__size__def,axiom,
    ( ! [V0a: tyop_2Enum_2Enum] :
        ( ( c_2EordinalNotation_2Eosyntax__size @ ( c_2EordinalNotation_2EEnd @ V0a ) )
        = ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V0a ) )
    & ! [V1a0: tyop_2EordinalNotation_2Eosyntax,V2a1: tyop_2Enum_2Enum,V3a2: tyop_2EordinalNotation_2Eosyntax] :
        ( ( c_2EordinalNotation_2Eosyntax__size @ ( c_2EordinalNotation_2EPlus @ V1a0 @ V2a1 @ V3a2 ) )
        = ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2B @ ( c_2EordinalNotation_2Eosyntax__size @ V1a0 ) @ ( c_2Earithmetic_2E_2B @ V2a1 @ ( c_2EordinalNotation_2Eosyntax__size @ V3a2 ) ) ) ) ) )).
...
thf(thm_2EordinalNotation_2Eord__mult__ind,conjecture,(
    ! [V0P: tyop_2EordinalNotation_2Eosyntax > tyop_2EordinalNotation_2Eosyntax > $o] :
      ( ! [V1x: tyop_2EordinalNotation_2Eosyntax,V2y: tyop_2EordinalNotation_2Eosyntax] :
          ( ( ! [V3v: tyop_2EordinalNotation_2Eosyntax,V4v1: tyop_2EordinalNotation_2Eosyntax,V5m: tyop_2Enum_2Enum,V6e: tyop_2EordinalNotation_2Eosyntax,V7k: tyop_2Enum_2Enum,V8t: tyop_2EordinalNotation_2Eosyntax] :
                ( ( ( (~)
                    @ ( ( V1x
                        = ( c_2EordinalNotation_2EEnd @ c_2Enum_2E0 ) )
                      | ( V2y
                        = ( c_2EordinalNotation_2EEnd @ c_2Enum_2E0 ) ) ) )
                  & ( ( c_2Epair_2E_2C @ tyop_2EordinalNotation_2Eosyntax @ tyop_2EordinalNotation_2Eosyntax @ V1x @ V2y )
                    = ( c_2Epair_2E_2C @ tyop_2EordinalNotation_2Eosyntax @ tyop_2EordinalNotation_2Eosyntax @ V3v @ V4v1 ) )
                  & ( V3v
                    = ( c_2EordinalNotation_2EEnd @ V5m ) )
                  & ( V4v1
                    = ( c_2EordinalNotation_2EPlus @ V6e @ V7k @ V8t ) ) )
               => ( V0P @ ( c_2EordinalNotation_2EEnd @ V5m ) @ V8t ) )
            & ! [V9v: tyop_2EordinalNotation_2Eosyntax,V10v1: tyop_2EordinalNotation_2Eosyntax,V11e_27: tyop_2EordinalNotation_2Eosyntax,V12k_27: tyop_2Enum_2Enum,V13t_27: tyop_2EordinalNotation_2Eosyntax,V14e2: tyop_2EordinalNotation_2Eosyntax,V15k2: tyop_2Enum_2Enum,V16t2: tyop_2EordinalNotation_2Eosyntax] :
                ( ( ( (~)
                    @ ( ( V1x
                        = ( c_2EordinalNotation_2EEnd @ c_2Enum_2E0 ) )
                      | ( V2y
                        = ( c_2EordinalNotation_2EEnd @ c_2Enum_2E0 ) ) ) )
                  & ( ( c_2Epair_2E_2C @ tyop_2EordinalNotation_2Eosyntax @ tyop_2EordinalNotation_2Eosyntax @ V1x @ V2y )
                    = ( c_2Epair_2E_2C @ tyop_2EordinalNotation_2Eosyntax @ tyop_2EordinalNotation_2Eosyntax @ V9v @ V10v1 ) )
                  & ( V9v
                    = ( c_2EordinalNotation_2EPlus @ V11e_27 @ V12k_27 @ V13t_27 ) )
                  & ( V10v1
                    = ( c_2EordinalNotation_2EPlus @ V14e2 @ V15k2 @ V16t2 ) ) )
               => ( V0P @ ( c_2EordinalNotation_2EPlus @ V11e_27 @ V12k_27 @ V13t_27 ) @ V16t2 ) ) )
         => ( V0P @ V1x @ V2y ) )
