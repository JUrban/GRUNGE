...
thf(conj_thm_2ETemporal__Logic_2EALWAYS__AS__UNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__UNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESBEFORE__AS__UNTIL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EPast__Temporal__Logic_2EUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V14t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V14t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V14t ) ) ) ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V15t: $i] :
                ...
                @ ^ [V16t: $i] :
                    ...
                    @ ( ap
                      @ ( ap @ c_2ETemporal__Logic_2EUNTIL
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V17t: $i] :
                              ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V17t ) ) ) )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V18t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V18t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V18t ) ) ) ) )
                    @ V16t ) ) )
            & ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESBEFORE @ V0a ) @ V1b )
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V19t: $i] :
