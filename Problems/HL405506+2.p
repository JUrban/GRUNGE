...
fof(conj_thm_2Einteger_2ETINT__MUL__ASSOC,lemma,(
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ! [V2z] :
             ...
             => ap(ap(c_2Einteger_2Etint__mul,V0x),ap(ap(c_2Einteger_2Etint__mul,V1y),V2z)) = ap(ap(c_2Einteger_2Etint__mul,ap(ap(c_2Einteger_2Etint__mul,V0x),V1y)),V2z) ) ) ) )).

fof(conj_thm_2Einteger_2ETINT__MUL__WELLDEF,lemma,(
    ! [V0x1] :
...
fof(ax_thm_2Einteger_2Eint__mul,axiom,(
    ! [V0T1] :
     ...
     => ! [V1T2] :
         ...
         => ap(ap(c_2Einteger_2Eint__mul,V0T1),V1T2) = ap(c_2Einteger_2Eint__ABS,ap(ap(c_2Einteger_2Etint__mul,ap(c_2Einteger_2Eint__REP,V0T1)),ap(c_2Einteger_2Eint__REP,V1T2))) ) ) )).
...
fof(conj_thm_2Einteger_2EINT__EXP__ADD__EXPONENTS,conjecture,(
    ! [V0n] :
     ...
     => ! [V1m] :
         ...
         => ! [V2p] :
             ...
             => ap(ap(c_2Einteger_2Eint__mul,ap(ap(c_2Einteger_2Eint__exp,V2p),V0n)),ap(ap(c_2Einteger_2Eint__exp,V2p),V1m)) = ap(ap(c_2Einteger_2Eint__exp,V2p),ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)) ) ) ) )).
