...
fof(conj_thm_2Epred__set_2EPROD__SET__IMAGE__REDUCTION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1s] :
             ...
             => ! [V2x] :
                  ( mem(V2x,A_27a)
                 => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))
                      & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(V0f,V2x)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s))) )
                   => ap(c_2Epred__set_2EPROD__SET,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),V1s))) = ap(ap(c_2Earithmetic_2E_2A,ap(V0f,V2x)),ap(c_2Epred__set_2EPROD__SET,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s))) ) ) ) ) ) )).
