...
tff(conj_thm_2Epred__set_2EIMAGE__BIGUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1M: $i] :
          ( mem(V1M,arr(arr(A_27a,bool),bool))
         => ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2EBIGUNION(A_27a),V1M)) = ap(c_2Epred__set_2EBIGUNION(A_27b),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f)),V1M)) ) ) )).
