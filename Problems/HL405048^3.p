...
thf(thm_2EOmega__Automata_2EBOREL__HIERARCHY__F,conjecture,(
    ! [V0t0: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum > $o] :
      ...
      <=> ? [V3q: tyop_2Enum_2Enum > $o] :
            ...
            & ! [V4t: tyop_2Enum_2Enum] :
                ( ( V3q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
              <=> ( ( V3q @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) )
                  | ( V1a @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
            & ? [V5t1: tyop_2Enum_2Enum] :
              ! [V6t2: tyop_2Enum_2Enum] :
                ( V3q @ ( c_2Earithmetic_2E_2B @ V5t1 @ ( c_2Earithmetic_2E_2B @ V6t2 @ V0t0 ) ) ) ) )
      & ( ? [V7t: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V7t @ V0t0 ) )
      <=> ? [V8q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V8q @ V0t0 ) )
            & ! [V9t: tyop_2Enum_2Enum] :
                ( ( V8q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) )
              <=> ( ( V8q @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) )
                  | ( V1a @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) ) )
            & ! [V10t1: tyop_2Enum_2Enum] :
              ? [V11t2: tyop_2Enum_2Enum] :
                ( V8q @ ( c_2Earithmetic_2E_2B @ V10t1 @ ( c_2Earithmetic_2E_2B @ V11t2 @ V0t0 ) ) ) ) ) ) )).
