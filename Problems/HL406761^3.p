...
thf(thm_2Epatricia_2EPTREE__OF__NUMSET__IS__PTREE__EMPTY,axiom,(
    ! [V0s: tyop_2Enum_2Enum > $o] :
      ( c_2Epatricia_2EIS__PTREE @ tyop_2Eone_2Eone @ ( c_2Epatricia_2EPTREE__OF__NUMSET @ ( c_2Epatricia_2EEmpty @ tyop_2Eone_2Eone ) @ V0s ) ) )).
...
thf(thm_2Epatricia_2EIN__PTREE__EMPTY,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( (~) @ ( c_2Epatricia_2EIN__PTREE @ V0n @ ( c_2Epatricia_2EEmpty @ tyop_2Eone_2Eone ) ) ) )).
