...
fof(conj_thm_2Ewords_2Eword__extract__w2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1h] :
                     ...
                     => ! [V2l] :
                         ...
                         => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
                           => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),V1h),V2l),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V1h),V2l),V0w) ) ) ) ) ) ) ) )).
