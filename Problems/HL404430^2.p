...
thf(conj_thm_2Ecardinal_2ECARD__LE__INJ,lemma,(
...
thf(conj_thm_2Ecardinal_2ESURJECTIVE__IFF__INJECTIVE__GEN,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__EQ__BIJECTION,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
