...
thf(conj_thm_2Ewords_2Eword__join__index,lemma,(
...
thf(conj_thm_2Ewords_2Eword__concat__assoc,conjecture,(
         ...
         => ! [V2c: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) )
                  ...
                  & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Efcp_2Edimindex @ A_27d ) @ ( c_2Ebool_2Ethe__value @ A_27d ) ) )
                    = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27b ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) ) )
                  & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Efcp_2Edimindex @ A_27e ) @ ( c_2Ebool_2Ethe__value @ A_27e ) ) )
                    = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Efcp_2Edimindex @ A_27b ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27c ) @ ( c_2Ebool_2Ethe__value @ A_27c ) ) ) ) )
                  & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Efcp_2Edimindex @ A_27f ) @ ( c_2Ebool_2Ethe__value @ A_27f ) ) )
                    = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Efcp_2Edimindex @ A_27d ) @ ( c_2Ebool_2Ethe__value @ A_27d ) ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27c ) @ ( c_2Ebool_2Ethe__value @ A_27c ) ) ) ) ) )
               => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27d @ A_27c @ A_27f ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27a @ A_27b @ A_27d ) @ V0a ) @ V1b ) ) @ V2c )
                  = ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27a @ A_27e @ A_27f ) @ V0a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27b @ A_27c @ A_27e ) @ V1b ) @ V2c ) ) ) ) ) ) ) )).
