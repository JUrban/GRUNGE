...
thf(thm_2Ereal__topology_2ECONTINUOUS__PRODUCT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > A_27b > tyop_2Erealax_2Ereal,V2t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27b @ V2t )
        & ! [V3i: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V3i @ V2t )
     ...
     => ( c_2Ereal__topology_2Econtinuous @ A_27a
        @ ^ [V5x: A_27a] :
            ( c_2Eproduct_2Eproduct @ A_27b @ V2t @ ( V1f @ V5x ) )
        @ V0net ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__PRODUCT,conjecture,(
    ! [A_27a: $tType,V0f: tyop_2Erealax_2Ereal > A_27a > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2t )
        & ! [V3i: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3i @ V2t )
     ...
     => ( c_2Ereal__topology_2Econtinuous__on
        @ ^ [V5x: tyop_2Erealax_2Ereal] :
            ( c_2Eproduct_2Eproduct @ A_27a @ V2t @ ( V0f @ V5x ) )
        @ V1s ) ) )).
