...
tff(conj_thm_2Epath_2Epconcat__thm,lemma,(
...
tff(conj_thm_2Epath_2Epconcat__eq__stopped,lemma,(
...
tff(conj_thm_2Epath_2Epconcat__eq__pcons,lemma,(
...
tff(conj_thm_2Epath_2Efinite__pconcat,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1lab: $i] :
          ( mem(V1lab,A_27b)
         => ! [V2p2: $i] :
              ( mem(V2p2,ty_2Epath_2Epath(A_27a,A_27a))
             => ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(ap(c_2Epath_2Epconcat(A_27a,A_27a),V0p1),V1lab),V2p2)))
              <=> ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),V0p1))
                  & p(ap(c_2Epath_2Efinite(A_27a,A_27a),V2p2)) ) ) ) ) ) )).
