...
fof(lameq_f906,axiom,(
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f906(V1b,V0a),V2t0) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f889(V0a)),V1b),V2t0))),ap(ap(c_2ETemporal__Logic_2EALWAYS,V0a),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EUNTIL__AS__BEFORE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
