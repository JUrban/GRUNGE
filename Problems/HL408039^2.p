...
thf(conj_thm_2Eseq_2ETRANSFORM__2D__NUM,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ...
          & ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) )
