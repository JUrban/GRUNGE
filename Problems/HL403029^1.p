...
thf(f3415_0_2E0,type,(
    f3415_0_2E0: u )).

thf(f3415_0_2E2,type,(
    f3415_0_2E2: du > du > u )).
...
thf(c_2EindexedLists_2Efindi_2E0,type,(
    c_2EindexedLists_2Efindi_2E0: u )).

thf(c_2EindexedLists_2Efindi_2E2,type,(
    c_2EindexedLists_2Efindi_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3415_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3415_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f3415_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EindexedLists_2Efindi_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2EindexedLists_2Efindi_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Enum_2Enum ) ) @ c_2EindexedLists_2Efindi_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2EindexedLists_2Efindi__def,axiom,(
    ! [A_27a: d,V1x_2E0: u,V2h_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3415_0_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2h_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V1x_2E0 )
        = ( s @ A_27a @ V2h_2E0 ) ) ) )).
...
thf(thm_2EindexedLists_2Efindi__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0x_2E0: u] :
          ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2EindexedLists_2Efindi_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )
          = mono_2Ec_2Enum_2E0 )
      & ! [V1x_2E0: u,V2h_2E0: u,V3t_2E0: u] :
          ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2EindexedLists_2Efindi_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3t_2E0 ) ) ) ) ) )
          = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3415_0_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2h_2E0 ) ) ) ) @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2EindexedLists_2Efindi_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3t_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2EindexedLists_2Efindi__EL,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) )
     => ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2EindexedLists_2Efindi_2E2 @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) )
        = V1n ) ) )).
