...
tff(ax_thm_2Eextreal_2Eextreal__max__def,axiom,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] : surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__max,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(V1y))) = surj__ty_2Eextreal_2Eextreal(ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Eextreal_2Eextreal__le,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(V1y))),inj__ty_2Eextreal_2Eextreal(V1y)),inj__ty_2Eextreal_2Eextreal(V0x))) )).

tff(conj_thm_2Eextreal_2Ele__max,lemma,(
...
tff(conj_thm_2Emeasure_2EADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LT,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MAX,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(mem_c_2Elebesgue_2ERADON__F,axiom,(
    ! [A_27a: del] : mem(c_2Elebesgue_2ERADON__F(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,ty_2Eextreal_2Eextreal),bool)))) )).
...
tff(lamtp_f4216,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f4216(A_27a,V2f),arr(A_27a,bool)) ) )).

tff(lameq_f4216,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f4216(A_27a,V2f),V3x) = ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V2f,V3x)) ) ) )).
...
tff(ax_thm_2Elebesgue_2ERADON__F__def,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1v: $i] :
          ( mem(V1v,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Elebesgue_2Elemma__radon__max__in__F,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Eextreal_2Eextreal))
