...
tff(mem_c_2Ecomparison_2Eresp__equiv,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Ecomparison_2Eresp__equiv(A_27a,A_27a,A_27a),arr(arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)),arr(arr(A_27a,arr(A_27b,A_27c)),bool))) )).
...
tff(mem_c_2Ecomparison_2Eresp__equiv2,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ecomparison_2Eresp__equiv2(A_27a,A_27a),arr(arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)),arr(arr(A_27b,arr(A_27b,ty_2EternaryComparisons_2Eordering)),arr(arr(A_27a,A_27b),bool)))) )).
...
tff(conj_thm_2Ecomparison_2Eantisym__resp__equiv,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0cmp: $i] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(A_27b,A_27c)))
