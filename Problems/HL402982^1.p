...
thf(f3544_0_2E0,type,(
    f3544_0_2E0: u )).

thf(f3544_0_2E2,type,(
    f3544_0_2E2: du > du > u )).

thf(f3545_0_2E0,type,(
    f3545_0_2E0: u )).

thf(f3545_0_2E2,type,(
    f3545_0_2E2: du > du > u )).
...
thf(mono_2Ef3544_0,type,(
    mono_2Ef3544_0: $o > $o > $o )).

thf(mono_2Ef3545_0,type,(
    mono_2Ef3545_0: $o > $o > $o )).
...
thf(def0_2Ethm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__def,axiom,(
    ! [V2i1: $o,V3i2: $o] :
      ( ( mono_2Ef3545_0 @ V2i1 @ V3i2 )
    <=> ( V2i1
        | V3i2 ) ) )).
...
thf(thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__def,axiom,(
    ! [V0ip1: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V1ip2: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
      ...
      = ( mono_2Ec_2Elist_2EMAP2_2Emono_2Etyop_2Emin_2Ebool_20mono_2Etyop_2Emin_2Ebool_20mono_2Etyop_2Emin_2Ebool @ mono_2Ef3545_0 @ V0ip1 @ V1ip2 ) ) )).
...
thf(def0_2Ethm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__THM,axiom,(
    ! [V2c: $o,V4c_27: $o] :
      ( ( mono_2Ef3544_0 @ V2c @ V4c_27 )
    <=> ( V2c
        & V4c_27 ) ) )).
...
thf(thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1rows_2E0: u,V2c: $o,V3infos: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V4c_27: $o,V5infos_27: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
     ...
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO_2E4 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V1rows_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V4c_27 ) ) @ ( s @ ( tyop_2Elist_2Elist @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 @ V5infos_27 ) ) ) ) )
       => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO_2E4 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V1rows_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3544_0 @ V2c @ V4c_27 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 @ ( mono_2Ec_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ @ V3infos @ V5infos_27 ) ) ) ) ) ) ) ) )).
