...
tff(conj_thm_2Earithmetic_2ESUB__LESS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ereal__topology_2ESUMS__FINITE__DIFF,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUMS__OFFSET,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
