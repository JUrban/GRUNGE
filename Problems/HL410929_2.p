...
tff(conj_thm_2Ereal__topology_2ELIM__COMPONENT,conjecture,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3755(A_27a,V1f)),inj__ty_2Erealax_2Ereal(V3l)),V0net)) ) ) ) ) )).
