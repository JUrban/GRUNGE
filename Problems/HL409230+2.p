...
fof(lameq_f3208,axiom,(
    ! [V0f] :
     ...
     => ! [V5x] :
         ...
         => ap(f3208(V0f),V5x) = ap(c_2Ereal_2Eabs,ap(V0f,V5x)) ) ) )).

fof(conj_thm_2Eintegral_2EDINT__TRIANGLE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3i] :
                  ( mem(V3i,ty_2Erealax_2Ereal)
                 => ! [V4j] :
                      ( mem(V4j,ty_2Erealax_2Ereal)
                     => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V2b))
                          & p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f),V3i))
                          & p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),f3208(V0f)),V4j)) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V3i)),V4j)) ) ) ) ) ) ) )).
