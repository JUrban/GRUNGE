...
tff(conj_thm_2Epair_2ELEX__DEF__THM,lemma,(
...
tff(conj_thm_2Epair_2ELEX__MONO,conjecture,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1R2: $i] :
         ...
         => ! [V2R3: $i] :
             ...
             => ! [V3R4: $i] :
                 ...
                 => ! [V4x: $i] :
                     ...
                     => ! [V5y: $i] :
                          ( mem(V5y,ty_2Epair_2Eprod(A_27a,A_27a))
                         => ( ( ! [V6x: $i] :
                                  ( mem(V6x,A_27a)
                                 => ! [V7y: $i] :
                                      ( mem(V7y,A_27a)
                           ...
                           => ( p(ap(ap(ap(ap(c_2Epair_2ELEX(A_27a,A_27a),V0R1),V2R3),V4x),V5y))
                             => p(ap(ap(ap(ap(c_2Epair_2ELEX(A_27a,A_27a),V1R2),V3R4),V4x),V5y)) ) ) ) ) ) ) ) ) )).
