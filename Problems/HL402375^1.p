...
thf(f2576_0_2E0,type,(
    f2576_0_2E0: u )).

thf(f2576_0_2E1,type,(
    f2576_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2576_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2576_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ f2576_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eres__quan_2ERES__EXISTS__UNIQUE__SING,axiom,(
    ! [A_27b: d,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2576_0_2E1 @ ( s @ A_27b @ V3x_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).

thf(thm_2Eres__quan_2ERES__EXISTS__UNIQUE__SING,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0P_2E0: u,V1s_2E0: u,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2ERES__EXISTS__UNIQUE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ f2576_0_2E0 ) ) ) )
    <=> ? [V4y_2E0: u] :
          ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1s_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27b @ V4y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) ) ) ) ) )).
