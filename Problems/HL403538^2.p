...
thf(conj_thm_2Ewellorder_2Ewo2wo__EQ__NONE,lemma,(
             ...
             => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V0w1 ) @ V1w2 ) @ V2x )
               ...
               => ! [V3y: $i] :
                   ...
                   => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V2x ) @ V3y ) ) @ ( ap @ ( c_2Eset__relation_2Estrict @ A_27a ) @ ( ap @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a ) @ V0w1 ) ) ) )
                     => ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V0w1 ) @ V1w2 ) @ V3y )
                        = ( c_2Eoption_2ENONE @ A_27b ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Ewo2wo__EQ__SOME__downwards,conjecture,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( ( mem @ V0w1 @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
     => ! [V1w2: $i] :
          ( ( mem @ V1w2 @ ( ty_2Ewellorder_2Ewellorder @ A_27b ) )
                 ...
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V0w1 ) @ V1w2 ) @ V2x )
                   ...
                   => ! [V4x0: $i] :
                       ...
                       => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V4x0 ) @ V2x ) ) @ ( ap @ ( c_2Eset__relation_2Estrict @ A_27a ) @ ( ap @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a ) @ V0w1 ) ) ) )
                         => ? [V5y0: $i] :
                              ( ( mem @ V5y0 @ A_27b )
                              & ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V0w1 ) @ V1w2 ) @ V4x0 )
                                = ( ap @ ( c_2Eoption_2ESOME @ A_27b ) @ V5y0 ) ) ) ) ) ) ) ) ) ) )).
