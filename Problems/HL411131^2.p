...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__OPEN,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ! [V2s: $i] :
             ...
             => ! [V3a: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V2s ) )
                    ...
                    & ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) ) )
                 => ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V1g ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) ) ) ) ) ) )).
