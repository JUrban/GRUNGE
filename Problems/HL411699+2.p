...
fof(conj_thm_2Ereal__topology_2ESUBSPACE__UNIV,lemma,(
...
fof(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__IMAGE__SUBSPACE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1x] :
