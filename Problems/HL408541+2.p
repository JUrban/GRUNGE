...
fof(conj_thm_2Ebinary__ieee_2Efloat__round__bottom,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0mode] :
             ...
             => ! [V1toneg] :
                 ...
                 => ! [V2r] :
                      ( mem(V2r,ty_2Erealax_2Ereal)
                     => ( ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),V0mode),V2r) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))
                       => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),V0mode),V1toneg),V2r) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) ) )).
