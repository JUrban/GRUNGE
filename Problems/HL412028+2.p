...
fof(conj_thm_2Eextreal_2Elt__antisym,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
...
fof(conj_thm_2Elebesgue_2Eintegrable__const,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1c] :
             ...
             => ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),k(A_27a,ap(c_2Eextreal_2ENormal,V1c)))) ) ) ) ) )).
