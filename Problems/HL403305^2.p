...
thf(tp_c_2Ebag_2EBAG__DISJOINT,type,(
    c_2Ebag_2EBAG__DISJOINT: del > $i )).

thf(mem_c_2Ebag_2EBAG__DISJOINT,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ebag_2EBAG__OF__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
      = ( c_2Epred__set_2EEMPTY @ A_27a ) ) )).

thf(ax_thm_2Ebag_2EBAG__DISJOINT,axiom,(
    ! [A_27a: del,V0b1: $i] :
...
thf(conj_thm_2Ebag_2EBAG__DISJOINT__EMPTY,conjecture,(
    ! [A_27a: del,V0b: $i] :
