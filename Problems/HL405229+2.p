...
fof(mem_c_2ECoder_2Eblist__coder,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2ECoder_2Eblist__coder(A_27a,A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),ty_2Epair_2Eprod(arr(ty_2Elist_2Elist(A_27a),bool),arr(ty_2Elist_2Elist(A_27a),bool))))) ) ) ) )).
...
fof(conj_thm_2ECoder_2Ewf__coder__op,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(ax_thm_2ECoder_2Eblist__coder__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1p] :
                     ...
                     => ! [V2e] :
                         ...
                         => ! [V3d] :
                             ...
                             => ap(ap(c_2ECoder_2Eblist__coder(A_27a,A_27a,A_27a),V0m),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1p),ap(ap(c_2Epair_2E_2C(arr(A_27b,ty_2Elist_2Elist(A_27c)),arr(A_27b,ty_2Elist_2Elist(A_27c))),V2e),V3d))) = ap(ap(c_2Epair_2E_2C(arr(ty_2Elist_2Elist(A_27a),bool),arr(ty_2Elist_2Elist(A_27a),bool)),ap(ap(c_2EEncode_2Elift__blist(A_27a),V0m),V1p)),ap(ap(c_2Epair_2E_2C(arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27c)),arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27c))),ap(ap(c_2EEncode_2Eencode__blist(A_27c,A_27c),V0m),V2e)),ap(ap(ap(c_2EDecode_2Edecode__blist(A_27a),ap(ap(c_2EEncode_2Elift__blist(A_27a),V0m),V1p)),V0m),V3d))) ) ) ) ) ) ) ) )).

fof(conj_thm_2ECoder_2Ewf__coder__blist,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1c] :
             ...
             => ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V1c))
               => p(ap(c_2ECoder_2Ewf__coder(ty_2Elist_2Elist(A_27a)),ap(ap(c_2ECoder_2Eblist__coder(A_27a,A_27a,A_27a),V0m),V1c))) ) ) ) ) )).
