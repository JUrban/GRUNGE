...
fof(conj_thm_2Etransc_2EMCLAURIN__ALL__LT,lemma,(
    ! [V0f] :
...
fof(lamtp_f3001,axiom,(
    ! [V0diff] :
      ( mem(V0diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => mem(f3001(V0diff,V2x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3001,axiom,(
    ! [V0diff] :
     ...
     => ! [V2x] :
         ...
         => ! [V3m] :
              ( mem(V3m,ty_2Enum_2Enum)
             => ap(f3001(V0diff,V2x),V3m) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V0diff,V3m),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V3m)))),ap(ap(c_2Ereal_2Epow,V2x),V3m)) ) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN__ZERO,lemma,(
    ! [V0diff] :
      ( mem(V0diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ! [V2x] :
             ...
             => ( ( V2x = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
               ...
               => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V1n)),f3001(V0diff,V2x)) = ap(ap(V0diff,c_2Enum_2E0),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN__ALL__LE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1diff] :
          ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
