...
tff(lamtp_f771,axiom,(
    ! [A_27a: del,V2x: $i] :
      ( mem(V2x,A_27a)
     => ! [V0P: $i] :
          ( mem(V0P,arr(A_27a,bool))
         => mem(f771(A_27a,V2x,V0P),arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))) ) ) )).
    ...
    ! [A_27a: del,V2x: $i] :
     ...
     => ! [V0P: $i] :
         ...
         => ! [V3l_27: $i] :
             ...
             => ap(f771(A_27a,V2x,V0P),V3l_27) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(V0P,V2x)),ap(ap(c_2Elist_2ECONS(A_27a),V2x),V3l_27)),V3l_27) ) ) ) )).

tff(lmtp_f770,type,(
    f770: ( del * del * $i ) > $i )).

tff(lamtp_f770,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f770(A_27a,A_27a,V0P),arr(A_27a,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))) ) )).
...
tff(lameq_f770,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
     ...
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f770(A_27a,A_27a,V0P),V2x) = f771(A_27a,V2x,V0P) ) ) )).

tff(conj_thm_2Erich__list_2EFILTER__FOLDR,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ap(ap(c_2Elist_2EFILTER(A_27a),V0P),V1l) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),f770(A_27a,A_27a,V0P)),c_2Elist_2ENIL(A_27a)),V1l) ) ) )).
