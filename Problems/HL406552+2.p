...
fof(conj_thm_2Ebit_2EBITS__SUM2,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__ZERO2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0h] :
             ...
             => ! [V1l] :
                  ( mem(V1l,ty_2Enum_2Enum)
                 => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),V0h),V1l),ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0)) = ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0) ) ) ) ) )).

fof(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__MUL2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1b] :
                 ...
                 => ! [V2h] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2h),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                       => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),V2h),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__mul(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V0a)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V1b))) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__mul(A_27a),V0a),V1b)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ewords_2ELSL__LIMIT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
...
fof(conj_thm_2Ealignment_2Ealigned__extract,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
...
fof(conj_thm_2Ealignment_2Ealigned__ge__dim,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
...
fof(conj_thm_2Ealignment_2Ealigned__mul__shift__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
