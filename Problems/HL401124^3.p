    ...
    & ! [V0n: tyop_2Enum_2Enum] :
        ...
        = ( c_2Ewhile_2ELEAST
          @ ^ [V1p: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2Edivides_2Eprime @ V1p ) @ ( c_2Eprim__rec_2E_3C @ ( c_2Edivides_2EPRIMES @ V0n ) @ V1p ) ) ) ) )).

thf(thm_2Edivides_2EprimePRIMES,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( c_2Edivides_2Eprime @ ( c_2Edivides_2EPRIMES @ V0n ) ) )).

thf(thm_2Edivides_2EINFINITE__PRIMES,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ ( c_2Edivides_2EPRIMES @ V0n ) @ ( c_2Edivides_2EPRIMES @ ( c_2Enum_2ESUC @ V0n ) ) ) )).
...
thf(thm_2Edivides_2EPRIMES__NO__GAP,conjecture,(
