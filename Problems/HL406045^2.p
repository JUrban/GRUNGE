...
thf(conj_thm_2Earithmetic_2EDIV__MOD__MOD__DIV,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2ELSR__LIMIT,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Ewords_2EWORD__DIV__LSR,lemma,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V0m ) @ ( inj__ty_2Enum_2Enum @ V1n ) )
            = ( ap @ ( ap @ ( c_2Ewords_2Eword__div @ A_27a ) @ V0m ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2En2w__DIV,conjecture,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
     ...
     => ( ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
        = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
