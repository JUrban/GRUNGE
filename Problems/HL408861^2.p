...
thf(conj_thm_2EHolSmt_2Er240,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: tp__ty_2Enum_2Enum] :
     ...
     => ( ( ap @ ( c_2Ewords_2Ew2w @ A_27a @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) )
        = ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) ) ) )).
