...
tff(lmtp_f3290,type,(
    f3290: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3290,axiom,(
...
tff(conj_thm_2Eiterate_2ESUPPORT__DELTA,lemma,(
...
tff(conj_thm_2Eiterate_2EITERATE__SING,lemma,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27b,arr(A_27b,A_27b)))
...
tff(conj_thm_2Eiterate_2EITERATE__DELTA,conjecture,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ( p(ap(c_2Eiterate_2Emonoidal(A_27a),V0op))
       => ! [V1f: $i] :
