...
thf(conj_thm_2Emeasure_2EALGEBRA__FINITE__UNION,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(conj_thm_2Epred__set_2EDISJOINT__COUNT,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
       ...
       => ! [V3n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ ( c_2Epred__set_2EDISJOINT @ A_27a ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ( arr @ A_27a @ bool ) ) @ V0f ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EADDITIVE__SUM,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
