...
tff(mem_c_2Ewords_2Eword__rrx,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__rrx(A_27a),arr(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool))) )).

tff(lmtp_f2214,type,(
    f2214: ( del * tp__o * $i ) > $i )).

tff(lamtp_f2214,axiom,(
    ! [A_27a: del,V0c: tp__o,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2214(A_27a,V0c,V1w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2214,axiom,(
    ! [A_27a: del,V0c: tp__o,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2214(A_27a,V0c,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__o(V0c)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V1w),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V2i))) ) )).

tff(ax_thm_2Ewords_2Eword__rrx__def,axiom,(
    ! [A_27a: del,V0c: tp__o,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ap(c_2Ewords_2Eword__rrx(A_27a),ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(V0c)),V1w)) = ap(ap(c_2Epair_2E_2C(bool,bool),ap(c_2Ewords_2Eword__lsb(A_27a),V1w)),ap(c_2Efcp_2EFCP(bool,bool),f2214(A_27a,V0c,V1w))) ) )).
...
tff(conj_thm_2Ewords_2Eword__H,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
     ...
     => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),c_2Ewords_2Eword__H(A_27a)),inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Ewords_2Eword__lsb__word__T,lemma,(
...
tff(conj_thm_2Ewords_2Elsr__1__word__T,lemma,(
...
tff(conj_thm_2Ewords_2Eword__rrx__word__T,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ap(c_2Ewords_2Eword__rrx(A_27a),ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2EF)),ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) = ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2ET)),c_2Ewords_2Eword__H(A_27a))
      & ap(c_2Ewords_2Eword__rrx(A_27b),ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2ET)),ap(c_2Ewords_2Eword__2comp(A_27b),ap(c_2Ewords_2En2w(A_27b),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) = ap(ap(c_2Epair_2E_2C(bool,bool),inj__o(fo__c_2Ebool_2ET)),ap(c_2Ewords_2Eword__2comp(A_27b),ap(c_2Ewords_2En2w(A_27b),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) )).
