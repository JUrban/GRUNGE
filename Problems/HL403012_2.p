...
tff(mem_c_2EindexedLists_2EMAPi__ACC,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,arr(A_27b,A_27a)),arr(ty_2Enum_2Enum,arr(ty_2Elist_2Elist(A_27a),arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27a)))))) )).
    ...
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
         ...
         => ! [V1i: tp__ty_2Enum_2Enum,V2a: $i] :
             ...
             => ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),inj__ty_2Enum_2Enum(V1i)),V2a),c_2Elist_2ENIL(A_27b)) = ap(c_2Elist_2EREVERSE(A_27a),V2a) ) )
      & ! [V3f: $i] :
    ...
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2a: $i] :
         ...
         => ! [V3l: $i] :
             ...
             => ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),inj__ty_2Enum_2Enum(V1n)),V2a),V3l) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(c_2Elist_2EREVERSE(A_27a),V2a)),ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)))),V3l)) ) ) ) )).
