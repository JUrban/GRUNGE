      ...
      = ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum
        @ ( ap
          @ ( ap @ ( c_2Elist_2EGENLIST @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1i: $i] :
                  ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V1i ) ) )
...
thf(conj_thm_2Ebitstring_2Elength__rev__count__list,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
