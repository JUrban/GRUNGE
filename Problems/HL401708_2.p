...
tff(conj_thm_2Epred__set_2ECROSS__EMPTY__EQN,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ( ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1t) = c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(A_27a,A_27a))
