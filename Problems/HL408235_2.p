...
tff(lamtp_f2965,axiom,(
    mem(f2965,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2965,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : ap(f2965,inj__ty_2Enum_2Enum(V0n)) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,inj__ty_2Enum_2Enum(V0n)))) )).

tff(lmtp_f2966,type,(
    f2966: $i )).

tff(lamtp_f2966,axiom,(
    mem(f2966,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2966,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum] : ap(f2966,inj__ty_2Enum_2Enum(V1n)) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,inj__ty_2Enum_2Enum(V1n)))) )).

tff(conj_thm_2Etransc_2EEXP__FDIFF,lemma,(
    ap(c_2Epowser_2Ediffs,f2965) = f2966 )).

tff(conj_thm_2Etransc_2EDIFF__EXP,conjecture,(
