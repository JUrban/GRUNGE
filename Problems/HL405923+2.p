...
fof(mem_c_2Ewords_2Ereduce__xor,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Ereduce__xor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(ax_thm_2Ewords_2Ereduce__xor__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ewords_2Ereduce__xor(A_27a) = ap(c_2Ewords_2Eword__reduce(A_27a),f2172) ) )).
...
fof(lameq_f2236,axiom,(
    ! [V1l] :
     ...
     => ap(f2236,V1l) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__xor(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),V1l)),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),V1l)) ) )).

fof(conj_thm_2Ewords_2Efoldl__reduce__xor,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ereduce__xor(A_27a),V0w) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2236),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).
