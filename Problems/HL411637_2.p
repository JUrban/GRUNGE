    ...
    ! [V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V5v: $i] :
             ...
             => mem(f3851(V2s,V0f,V5v),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

tff(lameq_f3851,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V5v: $i] :
              ( mem(V5v,arr(ty_2Erealax_2Ereal,bool))
             => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3851(V2s,V0f,V5v),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),V5v))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1h: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4u: $i] :
                     ...
                     => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s) = V3t
                          & ! [V5v: $i] :
                              ( mem(V5v,arr(ty_2Erealax_2Ereal,bool))
                             => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V5v),V3t))
                               => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3851(V2s,V0f,V5v))))
                                <=> p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V3t)),V5v)) ) ) )
                          & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1h),V2s))
                          & ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1h),V2s) = V4u
                          & ! [V7x: tp__ty_2Erealax_2Ereal,V8y: tp__ty_2Erealax_2Ereal] :
                              ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V2s))
                                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8y)),V2s))
                                & surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V7x))) = surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V8y))) )
                             => surj__ty_2Erealax_2Ereal(ap(V1h,inj__ty_2Erealax_2Ereal(V7x))) = surj__ty_2Erealax_2Ereal(ap(V1h,inj__ty_2Erealax_2Ereal(V8y))) ) )
                       => ? [V9g: $i] :
                            ( mem(V9g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                            & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V9g),V3t))
                            & ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V9g),V3t) = V4u
                            & ! [V10x: tp__ty_2Erealax_2Ereal] :
                                ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V10x)),V2s))
                               => surj__ty_2Erealax_2Ereal(ap(V1h,inj__ty_2Erealax_2Ereal(V10x))) = surj__ty_2Erealax_2Ereal(ap(V9g,ap(V0f,inj__ty_2Erealax_2Ereal(V10x)))) ) ) ) ) ) ) ) ) )).

tff(ax_thm_2Ereal__topology_2Ehomeomorphism,axiom,(
    ! [V0s: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V2f),V3g)))
                  <=> ( ! [V4x: tp__ty_2Erealax_2Ereal] :
                         ...
                         => surj__ty_2Erealax_2Ereal(ap(V3g,ap(V2f,inj__ty_2Erealax_2Ereal(V4x)))) = V4x )
                      ...
                      & ! [V5y: tp__ty_2Erealax_2Ereal] :
                         ...
                         => surj__ty_2Erealax_2Ereal(ap(V2f,ap(V3g,inj__ty_2Erealax_2Ereal(V5y)))) = V5y )
...
tff(ax_thm_2Ereal__topology_2Ehomeomorphic,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
    ...
    ! [V2s: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V7v: $i] :
             ...
             => mem(f3998(V2s,V1g,V7v),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).
...
tff(lameq_f3998,axiom,(
    ! [V2s: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V7v: $i] :
              ( mem(V7v,arr(ty_2Erealax_2Ereal,bool))
             => ! [V8x: tp__ty_2Erealax_2Ereal] : ap(f3998(V2s,V1g,V7v),inj__ty_2Erealax_2Ereal(V8x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1g,inj__ty_2Erealax_2Ereal(V8x))),V7v))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE__UNIQUE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4u: $i] :
                      ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
                     => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s) = V3t
                          & ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1g),V2s) = V4u
                          & ! [V5v: $i] :
                              ( mem(V5v,arr(ty_2Erealax_2Ereal,bool))
                             => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V5v),V3t))
                               => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3851(V2s,V0f,V5v))))
                          ...
                          & ! [V7v: $i] :
                             ...
                             => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V7v),V4u))
                               => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3998(V2s,V1g,V7v))))
                          ...
                          & ! [V9x: tp__ty_2Erealax_2Ereal,V10y: tp__ty_2Erealax_2Ereal] :
                              ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9x)),V2s))
                                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V10y)),V2s)) )
                             => ( surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V9x))) = surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V10y)))
                              <=> surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V9x))) = surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V10y))) ) ) )
                       => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V3t),V4u)) ) ) ) ) ) ) )).
