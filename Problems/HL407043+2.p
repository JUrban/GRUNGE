...
fof(lamtp_f2697,axiom,(
    ! [V2bs] :
      ( mem(V2bs,ty_2Elist_2Elist(bool))
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => mem(f2697(V2bs,V0n),arr(bool,ty_2Einteger_2Eint)) ) ) )).
...
fof(lameq_f2697,axiom,(
    ! [V2bs] :
     ...
     => ! [V0n] :
         ...
         => ! [V3r] :
              ( mem(V3r,bool)
             => ap(f2697(V2bs,V0n),V3r) = ap(c_2Eint__bitwise_2Eint__of__bits,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Elist_2EDROP(bool),V0n),V2bs)),V3r)) ) ) ) )).

fof(lamtp_f2696,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f2696(V0n),arr(ty_2Elist_2Elist(bool),arr(bool,ty_2Einteger_2Eint))) ) )).
...
fof(lameq_f2696,axiom,(
    ! [V0n] :
     ...
     => ! [V2bs] :
          ( mem(V2bs,ty_2Elist_2Elist(bool))
         => ap(f2696(V0n),V2bs) = f2697(V2bs,V0n) ) ) )).
...
fof(ax_thm_2Eint__bitwise_2Eint__shift__right__def,axiom,(
    ! [V0n] :
     ...
     => ! [V1i] :
         ...
         => ap(ap(c_2Eint__bitwise_2Eint__shift__right,V0n),V1i) = ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool))),ap(c_2Epair_2EUNCURRY(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2696(V0n))),ap(c_2Eint__bitwise_2Ebits__of__int,V1i)) ) ) )).
...
fof(conj_thm_2Eint__bitwise_2Eint__bit__shift__right,conjecture,(
    ! [V0b] :
