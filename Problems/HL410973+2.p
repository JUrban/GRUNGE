    ...
    ! [V2k] :
     ...
     => ! [V0f] :
         ...
         => ! [V3i] :
             ...
             => ap(f3801(V2k,V0f),V3i) = ap(V0f,ap(ap(c_2Earithmetic_2E_2D,V3i),V2k)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEQ__OFFSET__NEG,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2k] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0f),V1l),c_2Ereal__topology_2Esequentially))
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f3801(V2k,V0f)),V1l),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).
