...
fof(conj_thm_2Ebag_2EBAG__INN__BAG__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebag_2EBAG__EXTENSION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__IN__BAG__FILTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
