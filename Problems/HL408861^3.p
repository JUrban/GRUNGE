...
thf(thm_2EHolSmt_2Er240,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0x: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0x @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ( ( c_2Ewords_2Ew2w @ A_27a @ A_27b @ ( c_2Ewords_2En2w @ A_27a @ V0x ) )
        = ( c_2Ewords_2En2w @ A_27b @ V0x ) ) ) )).
