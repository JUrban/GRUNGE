...
tff(conj_thm_2Elist_2ELIST__BIND__THM,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1h: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ap(ap(c_2Elist_2ELIST__BIND(A_27a,A_27a),c_2Elist_2ENIL(A_27b)),V0f) = c_2Elist_2ENIL(A_27a)
                & ap(ap(c_2Elist_2ELIST__BIND(A_27a,A_27a),ap(ap(c_2Elist_2ECONS(A_27b),V1h),V2t)),V0f) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(V0f,V1h)),ap(ap(c_2Elist_2ELIST__BIND(A_27a,A_27a),V2t),V0f)) ) ) ) ) )).

tff(conj_thm_2Elist_2ESINGL__LIST__APPLY__L,conjecture,(
