...
tff(lamtp_f1910,axiom,(
    ! [A_27a: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,A_27a))
     => mem(f1910(A_27a,A_27c,V0f),arr(A_27c,ty_2Eoption_2Eoption(A_27a))) ) )).

tff(lameq_f1910,axiom,(
    ! [A_27a: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,A_27a))
     => ! [V3v: $i] :
          ( mem(V3v,A_27c)
         => ap(f1910(A_27a,A_27c,V0f),V3v) = ap(c_2Eoption_2ESOME(A_27a),ap(V0f,V3v)) ) ) )).

tff(conj_thm_2Efinite__map_2EFLOOKUP__o__f,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,A_27a))
     => ! [V1fm: $i] :
         ...
         => ! [V2k: $i] :
              ( mem(V2k,A_27b)
             => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),ap(ap(c_2Efinite__map_2Eo__f(A_27b,A_27b,A_27b),V0f),V1fm)),V2k) = ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27c,A_27c),ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),V1fm),V2k)),c_2Eoption_2ENONE(A_27a)),f1910(A_27a,A_27c,V0f)) ) ) ) )).
