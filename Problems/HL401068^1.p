...
thf(thm_2Earithmetic_2ELESS__ADD__SUC,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Eprim__rec_2E_3C @ V0m @ ( mono_2Ec_2Earithmetic_2E_2B @ V0m @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) )).
...
thf(thm_2Enumeral_2Ebit__initiality,axiom,(
    ...
    ? [V3f_2E0: u] :
      ( ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        = ( s @ A_27a @ V0zf_2E0 ) )
      & ! [V4n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V4n ) ) ) ) )
          = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V1b1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) ) ) )
      & ! [V5n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V5n ) ) ) ) )
          = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V2b2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) ) ) ) ) ) ) )).
...
thf(thm_2Enumeral_2Ebit__induction,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( V0P @ mono_2Ec_2Earithmetic_2EZERO )
        & ! [V1n: mono_2Etyop_2Enum_2Enum] :
            ( ( V0P @ V1n )
           => ( V0P @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) )
        & ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( ( V0P @ V2n )
           => ( V0P @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V2n ) ) ) )
