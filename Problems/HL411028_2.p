...
tff(conj_thm_2Ereal__topology_2EBOUNDED__COMPONENTWISE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
      <=> p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),i(ty_2Erealax_2Ereal)),V0s))) ) ) )).
