...
thf(conj_thm_2Eproduct_2EPRODUCT__CLAUSES__NUMSEG,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eproduct_2EPRODUCT__CLAUSES__RIGHT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
