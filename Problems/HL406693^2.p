...
thf(conj_thm_2Egcd_2EGCD__SYM,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V1b ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V1b ) ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) ) ) )).

thf(conj_thm_2Egcd_2EFACTOR__OUT__GCD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( ( ( V0n != fo__c_2Enum_2E0 )
        & ( V1m != fo__c_2Enum_2E0 ) )
     => ? [V2p: tp__ty_2Enum_2Enum,V3q: tp__ty_2Enum_2Enum] :
          ( ( V0n
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V2p ) ) @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) ) )
          & ( V1m
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V3q ) ) @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) ) )
          & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V2p ) ) @ ( inj__ty_2Enum_2Enum @ V3q ) ) )
...
thf(conj_thm_2Eint__arith_2EINT__NUM__DIVIDES,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Eint__arith_2EINT__DIVIDES__LRMUL,lemma,(
...
thf(conj_thm_2Eint__arith_2EINT__DIVIDES__RELPRIME__MUL,lemma,(
    ! [V0p: tp__ty_2Enum_2Enum,V1q: tp__ty_2Enum_2Enum,V2r: tp__ty_2Einteger_2Eint] :
      ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V0p ) ) @ ( inj__ty_2Enum_2Enum @ V1q ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
...
thf(conj_thm_2Einteger_2EINT__EQ__RMUL,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__DIV__1,lemma,(
...
thf(conj_thm_2Einteger_2EINT__DIV__ID,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
      ( ( V0p
       != ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
...
thf(conj_thm_2Einteger_2EINT__MOD__ID,lemma,(
...
thf(conj_thm_2Einteger_2EINT__MUL__DIV,lemma,(
...
thf(conj_thm_2Einteger_2EINT__DIVIDES__TRANS,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__DIVIDES__RMUL,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint,V1q: tp__ty_2Einteger_2Eint,V2r: tp__ty_2Einteger_2Eint] :
      ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__divides @ ( inj__ty_2Einteger_2Eint @ V0p ) ) @ ( inj__ty_2Einteger_2Eint @ V1q ) ) )
...
thf(conj_thm_2Eint__arith_2Egcdthm2,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V2x: tp__ty_2Einteger_2Eint,V3b: tp__ty_2Einteger_2Eint,V4d: tp__ty_2Enum_2Enum,V5p: tp__ty_2Einteger_2Eint,V6q: tp__ty_2Einteger_2Eint] :
      ( ( ( V4d
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Egcd_2Egcd @ ( inj__ty_2Enum_2Enum @ V1a ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) )
        & ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V4d ) ) )
          = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V5p ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V6q ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) ) ) )
        & ( V4d != fo__c_2Enum_2E0 )
        & ( V0m != fo__c_2Enum_2E0 )
        & ( V1a != fo__c_2Enum_2E0 ) )
