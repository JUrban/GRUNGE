...
fof(conj_thm_2Ereal_2EREAL__LET__ANTISYM,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__LTE__ANTSYM,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lamtp_f2750,axiom,(
    ! [V0r] :
      ( mem(V0r,ty_2Erealax_2Ereal)
     => mem(f2750(V0r),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
fof(lameq_f2750,axiom,(
    ! [V0r] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f2750(V0r),V1n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ereal_2Ereal__lte,V0r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V0r),ap(c_2Ereal_2Ereal__of__num,V1n)))),V1n),ap(ap(c_2Earithmetic_2E_2B,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) )).

fof(conj_thm_2Ereal_2ENUM__CEILING__NUM__FLOOR,conjecture,(
    ! [V0r] :
      ( mem(V0r,ty_2Erealax_2Ereal)
     => ap(c_2Ereal_2ENUM__CEILING,V0r) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2750(V0r)),ap(c_2Ereal_2ENUM__FLOOR,V0r)) ) )).
