...
thf(thm_2Etoto_2Etoto__glneq,axiom,(
    ! [A_27a: d] :
      ( ! [V0c_2E0: u,V1x_2E0: u,V2y_2E0: u] :
          ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2ELESS )
         => ( (~)
            @ ( ( s @ A_27a @ V1x_2E0 )
              = ( s @ A_27a @ V2y_2E0 ) ) ) )
      & ! [V3c_2E0: u,V4x_2E0: u,V5y_2E0: u] :
          ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V3c_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V5y_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2EGREATER )
         => ( (~)
            @ ( ( s @ A_27a @ V4x_2E0 )
              = ( s @ A_27a @ V5y_2E0 ) ) ) ) ) )).

thf(thm_2Etoto_2Etoto__cpn__eqn,conjecture,(
    ! [A_27a: d] :
      ( ! [V0c_2E0: u,V1x_2E0: u,V2y_2E0: u] :
          ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2EEQUAL )
      ...
      & ! [V3c_2E0: u,V4x_2E0: u,V5y_2E0: u] :
         ...
         => ( (~)
            @ ( ( s @ A_27a @ V4x_2E0 )
              = ( s @ A_27a @ V5y_2E0 ) ) ) )
      & ! [V6c_2E0: u,V7x_2E0: u,V8y_2E0: u] :
          ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V6c_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ A_27a @ V8y_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2EGREATER )
         => ( (~)
            @ ( ( s @ A_27a @ V7x_2E0 )
              = ( s @ A_27a @ V8y_2E0 ) ) ) ) ) )).
