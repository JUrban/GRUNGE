...
tff(tp_c_2Efinite__map_2EFMAP__MAP2,type,(
    c_2Efinite__map_2EFMAP__MAP2: ( del * del * del ) > $i )).

tff(mem_c_2Efinite__map_2EFMAP__MAP2,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).
...
tff(conj_thm_2Efinite__map_2EFMAP__MAP2__THM,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),V1m)) = ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1m)
            & ! [V2x: $i] :
                ( mem(V2x,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1m)))
                 => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),V1m)),V2x) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1m),V2x))) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFMAP__MAP2__FUPDATE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2x: $i] :
             ...
             => ! [V3v: $i] :
                  ( mem(V3v,A_27c)
                 => ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1m),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3v))) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),V1m)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3v)))) ) ) ) ) )).
