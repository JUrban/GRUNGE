...
fof(mem_c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO(A_27a,A_27a),arr(A_27a,arr(ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ty_2Elist_2Elist(bool)))) ) ) )).
     ...
     => ! [A_27b] :
         ...
         => ! [V0v] :
             ...
             => ! [V1rows] :
                 ...
                 => ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows) = ap(c_2Epair_2ESND(bool,bool),ap(ap(ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX(A_27a,A_27a),V0v),V1rows),c_2Ebool_2ET),c_2Elist_2ENIL(bool))) ) ) ) ) )).

fof(conj_thm_2EpatternMatches_2EEL2__STRONGEST__REDUNDANT__ROWS__INFO__AUX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3infos] :
                         ...
                         => ! [V4i] :
                             ...
                             => ( ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V4i),ap(c_2Elist_2ELENGTH(bool),V3infos)))
                               ...
                               => ( p(ap(ap(c_2Elist_2EEL(bool),V4i),ap(c_2Epair_2ESND(bool,bool),ap(ap(ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX(A_27a,A_27a),V0v),V1rows),V2p),V3infos))))
                                <=> ( ( p(V2p)
                                      & p(ap(ap(c_2Elist_2EEVERY(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),f840(A_27b,A_27a,A_27a,A_27b,V0v)),ap(ap(c_2Elist_2ETAKE(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Earithmetic_2E_2D,V4i),ap(c_2Elist_2ELENGTH(bool),V3infos))),V1rows))) )
...
fof(conj_thm_2EpatternMatches_2EEL__STRONGEST__REDUNDANT__ROWS__INFO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1rows] :
                 ...
                 => ! [V2i] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2i),ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rows)))
                       => ( p(ap(ap(c_2Elist_2EEL(bool),V2i),ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows)))
                        <=> ( p(ap(ap(c_2Elist_2EEVERY(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),f847(A_27b,A_27a,A_27a,A_27b,V0v)),ap(ap(c_2Elist_2ETAKE(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V2i),V1rows)))
