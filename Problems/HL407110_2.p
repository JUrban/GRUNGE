...
tff(tp_c_2Ehreal_2Ehreal__sup,type,(
    c_2Ehreal_2Ehreal__sup: $i )).

tff(mem_c_2Ehreal_2Ehreal__sup,axiom,(
    mem(c_2Ehreal_2Ehreal__sup,arr(arr(ty_2Ehreal_2Ehreal,bool),ty_2Ehreal_2Ehreal)) )).

tff(conj_thm_2Ehreal_2EHREAL__SUP,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ( ( ? [V1X: tp__ty_2Ehreal_2Ehreal] : p(ap(V0P,inj__ty_2Ehreal_2Ehreal(V1X)))
...
tff(conj_thm_2Erealax_2ETREAL__BIJ,lemma,
...
tff(conj_thm_2Erealax_2ETREAL__BIJ__WELLDEF,lemma,(
...
tff(conj_thm_2Erealax_2EREAL__ISO__EQ,lemma,(
...
tff(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA1,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA2,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
...
tff(lamtp_f2713,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => mem(f2713(V0P),arr(ty_2Ehreal_2Ehreal,bool)) ) )).

tff(lameq_f2713,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V6h: tp__ty_2Ehreal_2Ehreal] : ap(f2713(V0P),inj__ty_2Ehreal_2Ehreal(V6h)) = ap(V0P,ap(c_2Erealax_2Ereal__of__hreal,inj__ty_2Ehreal_2Ehreal(V6h))) ) )).

tff(lmtp_f2714,type,(
    f2714: $i > $i )).

tff(lamtp_f2714,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => mem(f2714(V0P),arr(ty_2Ehreal_2Ehreal,bool)) ) )).

tff(lameq_f2714,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V9h: tp__ty_2Ehreal_2Ehreal] : ap(f2714(V0P),inj__ty_2Ehreal_2Ehreal(V9h)) = ap(V0P,ap(c_2Erealax_2Ereal__of__hreal,inj__ty_2Ehreal_2Ehreal(V9h))) ) )).

tff(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA3,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ( ( ! [V1x: tp__ty_2Erealax_2Ereal] :
       ...
       => ( ? [V5X: tp__ty_2Ehreal_2Ehreal] : p(ap(f2713(V0P),inj__ty_2Ehreal_2Ehreal(V5X)))
          & ? [V7Y: tp__ty_2Ehreal_2Ehreal] :
            ! [V8X: tp__ty_2Ehreal_2Ehreal] :
              ( p(ap(f2714(V0P),inj__ty_2Ehreal_2Ehreal(V8X)))
             => p(ap(ap(c_2Ehreal_2Ehreal__lt,inj__ty_2Ehreal_2Ehreal(V8X)),inj__ty_2Ehreal_2Ehreal(V7Y))) ) ) ) ) )).

tff(conj_thm_2Erealax_2ESUP__ALLPOS__LEMMA4,lemma,(
...
tff(conj_thm_2Erealax_2EREAL__SUP__ALLPOS,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ( ( ! [V1x: tp__ty_2Erealax_2Ereal] :
              ( p(ap(V0P,inj__ty_2Erealax_2Ereal(V1x)))
