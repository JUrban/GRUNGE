...
tff(conj_thm_2Ewellorder_2Estrict__UNION,conjecture,(
    ! [A_27a: del,V0r1: $i] :
      ( mem(V0r1,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1r2: $i] :
          ( mem(V1r2,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
         => ap(c_2Eset__relation_2Estrict(A_27a),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),V0r1),V1r2)) = ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Eset__relation_2Estrict(A_27a),V0r1)),ap(c_2Eset__relation_2Estrict(A_27a),V1r2)) ) ) )).
