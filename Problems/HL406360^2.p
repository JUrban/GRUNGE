...
thf(tp_c_2Etoto_2Eqk__numOrd,type,(
    c_2Etoto_2Eqk__numOrd: $i )).

thf(mem_c_2Etoto_2Eqk__numOrd,axiom,(
    mem @ c_2Etoto_2Eqk__numOrd @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ ty_2EternaryComparisons_2Eordering ) ) )).

thf(stp_fo_c_2Etoto_2Eqk__numOrd,type,(
    fo__c_2Etoto_2Eqk__numOrd: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum > tp__ty_2EternaryComparisons_2Eordering )).

thf(stp_eq_fo_c_2Etoto_2Eqk__numOrd,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2EternaryComparisons_2Eordering @ ( fo__c_2Etoto_2Eqk__numOrd @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Etoto_2Eqk__numOrd @ ( inj__ty_2Enum_2Enum @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) ) )).
...
thf(tp_c_2Etoto_2Eqk__numto,type,(
    c_2Etoto_2Eqk__numto: $i )).

thf(mem_c_2Etoto_2Eqk__numto,axiom,(
...
thf(conj_thm_2Etoto_2ETO__qk__numOrd,lemma,(
    p @ ( ap @ ( c_2Etoto_2ETotOrd @ ty_2Enum_2Enum ) @ c_2Etoto_2Eqk__numOrd ) )).

thf(ax_thm_2Etoto_2Eqk__numto,axiom,
    ( ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ c_2Etoto_2Eqk__numto )
    = ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ ( ap @ ( c_2Etoto_2ETO @ ty_2Enum_2Enum ) @ c_2Etoto_2Eqk__numOrd ) ) )).

thf(conj_thm_2Etoto_2Eap__qk__numto__thm,conjecture,
    ( ( ap @ ( c_2Etoto_2Eapto @ ty_2Enum_2Enum ) @ c_2Etoto_2Eqk__numto )
