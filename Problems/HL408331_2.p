...
tff(conj_thm_2Etransc_2ECOS__PERIODIC__PI,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x)))) )).

tff(conj_thm_2Etransc_2ECOS__PERIODIC,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi))))) = surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x))) )).
