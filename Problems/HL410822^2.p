...
thf(conj_thm_2Ereal__topology_2EOPEN__UNIV,lemma,(
    p @ ( ap @ c_2Ereal__topology_2EOpen @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) )).

thf(conj_thm_2Ereal__topology_2EOPEN__DIFF,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__FRONTIER__EMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
          | ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) ) )
       => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) )
          = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__CLOSED__EQ__EMPTY__AS__FRONTIER,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
      ...
      <=> ? [V1t: $i] :
            ...
            & ( V0s
              = ( ap @ c_2Ereal__topology_2Efrontier @ V1t ) ) ) ) ) )).
