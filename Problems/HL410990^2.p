...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__AT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN__INTERIOR,conjecture,(
    ! [V0p: $i] :
