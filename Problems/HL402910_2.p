...
tff(ax_thm_2EdefCNF_2EOKDEF__def,axiom,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( p(ap(ap(c_2EdefCNF_2EOKDEF,inj__ty_2Enum_2Enum(V0n)),c_2Elist_2ENIL(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))))))
      <=> $true )
    & ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
       ...
       => ! [V3xs: $i] :
           ...
           => ( p(ap(ap(c_2EdefCNF_2EOKDEF,inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool)))),V2x),V3xs)))
...
tff(conj_thm_2EdefCNF_2EOKDEF__SNOC,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ( p(ap(ap(c_2EdefCNF_2EOKDEF,inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Elist_2ESNOC(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool)))),V1x),V2l)))
          <=> ( p(ap(ap(c_2EdefCNF_2EOKDEF,inj__ty_2Enum_2Enum(V0n)),V2l))
              & p(ap(ap(c_2EdefCNF_2EOK,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0n)),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool)))),V2l))),V1x)) ) ) ) ) )).
