                      ...
                      @ ^ [V3y: $i] :
                          ...
                          @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3y ) @ V2t ) )
                            @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                              @ ( lam @ A_27a
                                @ ^ [V4z: $i] :
                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4z ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2EternaryComparisons_2Eordering ) @ ( ap @ ( ap @ ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ V0cmp ) @ V4z ) @ V3y ) ) @ ( inj__ty_2EternaryComparisons_2Eordering @ fo__c_2EternaryComparisons_2ELESS ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Etoto_2Etoto__trans__less,lemma,(
    ! [A_27a: del] :
      ( ! [V0c: $i] :
...
thf(conj_thm_2Eenumeral_2ELESS__UO__LEM,conjecture,(
    ! [A_27a: del,V0cmp: $i] :
      ( ( mem @ V0cmp @ ( ty_2Etoto_2Etoto @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
