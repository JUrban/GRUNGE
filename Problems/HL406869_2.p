...
tff(conj_thm_2Ehreal_2EISACUT__HRAT,lemma,(
    ! [V0h: tp__ty_2Ehrat_2Ehrat] : p(ap(c_2Ehreal_2Eisacut,ap(c_2Ehreal_2Ecut__of__hrat,inj__ty_2Ehrat_2Ehrat(V0h)))) )).
...
tff(conj_thm_2Ehreal_2EHREAL__MUL__LID,conjecture,(
