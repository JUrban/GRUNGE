...
tff(conj_thm_2Epath_2Efirst__pmap,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
...
tff(conj_thm_2Epath_2Eel__pmap,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27c))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27b,A_27d))
         => ! [V2i: tp__ty_2Enum_2Enum,V3p: $i] :
              ( mem(V3p,ty_2Epath_2Epath(A_27a,A_27a))
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),ap(c_2Epath_2EPL(A_27a,A_27a),V3p)))
               => ap(ap(c_2Epath_2Eel(A_27c,A_27c),inj__ty_2Enum_2Enum(V2i)),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V3p)) = ap(V0f,ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V2i)),V3p)) ) ) ) ) )).
