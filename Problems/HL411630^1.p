...
thf(f12913_0_2E0,type,(
    f12913_0_2E0: u )).

thf(f12913_0_2E1,type,(
    f12913_0_2E1: du > u )).

thf(f12913_0_2E2,type,(
    f12913_0_2E2: du > du > u )).

thf(f12914_0_2E0,type,(
    f12914_0_2E0: u )).

thf(f12914_0_2E1,type,(
    f12914_0_2E1: du > u )).

thf(f12914_0_2E2,type,(
...
thf(mono_2Ef12913_0,type,(
    mono_2Ef12913_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12914_0,type,(
    mono_2Ef12914_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__LEFT__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12914_0 @ V0a @ V3x )
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__LEFT__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12914_0 @ V0a ) @ V1s ) @ V2t )
      = ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ V2t ) ) )).

thf(def0_2Ethm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__RIGHT__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12913_0 @ V0a @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V3x ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION__RIGHT__EQ,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12913_0 @ V0a ) @ V2t ) )
      = ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V1s @ V2t ) ) )).
