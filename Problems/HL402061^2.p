...
thf(conj_thm_2Eset__relation_2Enat__order__iso__thm,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ( ty_2Eoption_2Eoption @ A_27a ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ( ( ! [V2n: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum] :
                  ( ( ( ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3m ) )
              ...
              & ! [V4x: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ V1s ) )
                   => ? [V5m: tp__ty_2Enum_2Enum] :
                        ( ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V5m ) )
                        = ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V4x ) ) ) )
              & ! [V6m: tp__ty_2Enum_2Enum,V7x: $i] :
                  ( ( mem @ V7x @ A_27a )
                 => ( ( ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V6m ) )
                      ...
                      @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
                        @ ( lam @ A_27a
                          @ ^ [V8x: $i] :
                              ( lam @ A_27a
                              @ ^ [V9y: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V8x ) @ V9y ) )
                                  @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V10m: $i] :
                                          ...
                                          @ ( lam @ ty_2Enum_2Enum
                                            @ ^ [V11n: $i] :
                                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V10m ) @ V11n ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V10m ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V8x ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V11n ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V9y ) ) ) ) ) ) ) ) ) ) ) ) ) )
                  @ V1s ) )
              & ( p
                @ ( ap
                  @ ( ap @ ( c_2Eset__relation_2Efinite__prefixes @ A_27a @ A_27a )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) )
                      @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
                        @ ( lam @ A_27a
                          @ ^ [V12x: $i] :
                              ( lam @ A_27a
                              @ ^ [V13y: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V12x ) @ V13y ) )
                                  @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V14m: $i] :
                                          ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                          @ ( lam @ ty_2Enum_2Enum
                                            @ ^ [V15n: $i] :
                                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V14m ) @ V15n ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V14m ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V12x ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ V0f @ V15n ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V13y ) ) ) ) ) ) ) ) ) ) ) ) ) )
                  @ V1s ) ) ) ) ) ) )).
