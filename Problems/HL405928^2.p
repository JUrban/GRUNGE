...
thf(conj_thm_2Ebit_2EBITS__ZERO5,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ebit_2EBIT__IMP__GE__TWOEXP,lemma,(
...
thf(conj_thm_2Ebit_2EEXISTS__BIT__IN__RANGE,lemma,(
...
thf(conj_thm_2Ewords_2ELOG2__w2n,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( V0w
