...
fof(conj_thm_2Eutil__prob_2ELE__INF,lemma,(
    ! [V0p] :
...
fof(conj_thm_2Eutil__prob_2EINF__LE,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
...
fof(lamtp_f3526,axiom,(
    ! [A_27a,V3f] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V4m] :
          ( mem(V4m,ty_2Enum_2Enum)
         => mem(f3526(A_27a,V3f,V4m),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [A_27a,V3f] :
     ...
     => ! [V4m] :
         ...
         => ! [V5n] :
             ...
             => ap(f3526(A_27a,V3f,V4m),V5n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V4m),V5n))),ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V3f,V4m)),ap(V3f,V5n))) ) ) ) )).

fof(lamtp_f3525,axiom,(
    ! [A_27a,V3f] :
      ( mem(V3f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
...
fof(lameq_f3525,axiom,(
    ! [A_27a,V3f] :
     ...
     => ! [V4m] :
          ( mem(V4m,ty_2Enum_2Enum)
         => ap(f3525(A_27a,V3f),V4m) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3526(A_27a,V3f,V4m)) ) ) )).

fof(lamtp_f3524,axiom,(
    ! [A_27a,V2r] :
...
fof(lameq_f3523,axiom,(
    ! [A_27a,V1s] :
     ...
     => ! [V0m] :
         ...
         => ! [V2r] :
              ( mem(V2r,ty_2Erealax_2Ereal)
             => ap(f3523(A_27a,V1s,V0m),V2r) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2r),ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,arr(A_27a,bool))),f3524(A_27a,V2r,V1s,V0m))) ) ) ) )).

fof(ax_thm_2Emeasure_2Einf__measure__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ap(ap(c_2Emeasure_2Einf__measure(A_27a),V0m),V1s) = ap(c_2Ereal_2Einf,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3523(A_27a,V1s,V0m))) ) ) ) )).
...
fof(lamtp_f3537,axiom,(
    ! [A_27a,V4f] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5m] :
          ( mem(V5m,ty_2Enum_2Enum)
         => mem(f3537(A_27a,V4f,V5m),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [A_27a,V4f] :
     ...
     => ! [V5m] :
         ...
         => ! [V6n] :
             ...
             => ap(f3537(A_27a,V4f,V5m),V6n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V5m),V6n))),ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V4f,V5m)),ap(V4f,V6n))) ) ) ) )).

fof(lamtp_f3536,axiom,(
    ! [A_27a,V4f] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
...
fof(lameq_f3536,axiom,(
    ! [A_27a,V4f] :
     ...
     => ! [V5m] :
          ( mem(V5m,ty_2Enum_2Enum)
         => ap(f3536(A_27a,V4f),V5m) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3537(A_27a,V4f,V5m)) ) ) )).

fof(lamtp_f3535,axiom,(
    ! [A_27a,V3r] :
...
fof(lameq_f3534,axiom,(
    ! [A_27a,V1g] :
     ...
     => ! [V0m] :
         ...
         => ! [V3r] :
              ( mem(V3r,ty_2Erealax_2Ereal)
             => ap(f3534(A_27a,V1g,V0m),V3r) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3r),ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,arr(A_27a,bool))),f3535(A_27a,V3r,V1g,V0m))) ) ) ) )).

fof(conj_thm_2Emeasure_2EINF__MEASURE__NONEMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EINF__MEASURE__POS0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1g] :
             ...
             => ! [V2x] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
                      & p(ap(c_2Emeasure_2Epositive(A_27a),V0m))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3534(A_27a,V1g,V0m)))) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2x)) ) ) ) ) ) )).

fof(conj_thm_2Emeasure_2EINCREASING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EADDITIVE__INCREASING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EINF__MEASURE__AGREES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
                  ...
                  & p(ap(c_2Emeasure_2Ecountably__additive(A_27a),V0m))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
               => ap(ap(c_2Emeasure_2Einf__measure(A_27a),V0m),V1s) = ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s) ) ) ) ) )).
