...
fof(ax_thm_2Ereal__topology_2Eis__interval,axiom,(
    ! [V0s] :
                   ...
                   => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1a),V0s))
                     ...
                     => ( ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V3x))
                          ...
                          | ( p(ap(ap(c_2Ereal_2Ereal__lte,V2b),V3x))
                            & p(ap(ap(c_2Ereal_2Ereal__lte,V3x),V1a)) ) )
                       => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V0s)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__EMPTY,lemma,(
    p(ap(c_2Ereal__topology_2Eis__interval,c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) )).

fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__SING,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => p(ap(c_2Ereal__topology_2Eis__interval,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) ) )).

fof(conj_thm_2Ereal__topology_2EIS__INTERVAL__SCALING,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
