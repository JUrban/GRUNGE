...
thf(conj_thm_2Ecardinal_2ECARD__EQ__SYM,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__EQ__COUNTABLE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNCOUNTABLE__REAL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECARD__EQ__REAL__IMP__UNCOUNTABLE,conjecture,(
    ! [V0s: $i] :
