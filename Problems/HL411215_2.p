...
tff(lmtp_f3749,type,(
    f3749: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3749,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l: tp__ty_2Erealax_2Ereal] : mem(f3749(A_27a,V1f,V2l),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3749,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l: tp__ty_2Erealax_2Ereal,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3749(A_27a,V1f,V2l),V3x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V1f,V3x)),inj__ty_2Erealax_2Ereal(V2l)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__NULL,lemma,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: tp__ty_2Erealax_2Ereal] :
            ...
            <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3749(A_27a,V1f,V2l)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net)) ) ) ) )).

tff(lmtp_f3783,type,(
    f3783: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3783,axiom,(
    ! [V2a: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3783(V2a,V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3783,axiom,(
    ! [V2a: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3783(V2a,V0f),inj__ty_2Erealax_2Ereal(V3x)) = ap(V0f,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__AT__ZERO,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2a: tp__ty_2Erealax_2Ereal] :
        ...
        <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3783(V2a,V0f)),inj__ty_2Erealax_2Ereal(V1l)),ap(c_2Ereal__topology_2Eat,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ELINEAR__LIM__0,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ereal__topology_2Eat,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__AT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
