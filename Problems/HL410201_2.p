...
tff(conj_thm_2Emeasure_2EMEASURABLE__UP__LIFT,lemma,(
    ! [A_27a: del,A_27b: del,V0sp: $i] :
...
tff(conj_thm_2Emeasure_2EMEASURABLE__UP__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(arr(A_27a,bool),bool))
         => ! [V2b: $i] :
             ...
             => ! [V3c: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,bool)),V1a),V2b))
                      & p(ap(c_2Emeasure_2Esigma__algebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0sp),V2b))) )
                   => p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,A_27b)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0sp),V1a)),V3c)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V0sp),V2b)),V3c))) ) ) ) ) ) )).
