...
thf(thm_2Enumeral__bit_2EFDUB__def,axiom,
    ( ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral__bit_2EFDUB @ V0f @ mono_2Ec_2Enum_2E0 )
        = mono_2Ec_2Enum_2E0 )
    & ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral__bit_2EFDUB @ V1f @ ( mono_2Ec_2Enum_2ESUC @ V2n ) )
        = ( V1f @ ( V1f @ ( mono_2Ec_2Enum_2ESUC @ V2n ) ) ) ) )).

thf(thm_2Enumeral__bit_2EFDUB__FDUB,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
