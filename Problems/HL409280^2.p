...
thf(conj_thm_2Eintegral_2EINTEGRATION__BY__PARTS,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRAL__ADD,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Eintegral_2EINTEGRAL__BY__PARTS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                 ...
                 => ! [V4a: tp__ty_2Erealax_2Ereal,V5b: tp__ty_2Erealax_2Ereal] :
                      ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                        ...
                        & ! [V7x: tp__ty_2Erealax_2Ereal] :
                           ...
                           => ( p @ ( ap @ ( ap @ ( ap @ c_2Elim_2Ediffl @ V1g ) @ ( ap @ V3g_27 @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) ) )
                        & ( p
                          @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V8x: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2f_27 @ V8x ) ) @ ( ap @ V1g @ V8x ) ) ) ) )
                        & ( p
                          @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V9x: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V9x ) ) @ ( ap @ V3g_27 @ V9x ) ) ) ) ) )
                     => ( ( surj__ty_2Erealax_2Ereal
                          @ ( ap @ ( ap @ c_2Eintegral_2Eintegral @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V10x: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V10x ) ) @ ( ap @ V3g_27 @ V10x ) ) ) ) )
                        = ( surj__ty_2Erealax_2Ereal
                          @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) ) )
                            @ ( ap @ ( ap @ c_2Eintegral_2Eintegral @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V11x: $i] :
                                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2f_27 @ V11x ) ) @ ( ap @ V1g @ V11x ) ) ) ) ) ) ) ) ) ) ) ) )).
