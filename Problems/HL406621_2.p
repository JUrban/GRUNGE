...
tff(lamtp_f2467,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => mem(f2467(A_27a,V0R),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)) ) )).
...
tff(lameq_f2467,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1lol: $i] :
         ...
         => ap(f2467(A_27a,V0R),V1lol) = ap(ap(V0R,V1lol),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))),V1lol)) ) ) )).

tff(lmtp_f2469,type,(
    f2469: ( del * $i * $i ) > $i )).

tff(lamtp_f2469,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)))
     => ! [V2m: $i] :
          ( mem(V2m,ty_2Elist_2Elist(A_27a))
         => mem(f2469(A_27a,V0R,V2m),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)) ) ) )).
    ...
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V2m: $i] :
         ...
         => ! [V3lol: $i] :
             ...
             => ap(f2469(A_27a,V0R,V2m),V3lol) = ap(ap(V0R,V3lol),ap(ap(c_2Elist_2ECONS(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),V2m)),V3lol)) ) ) ) )).

tff(lmtp_f2468,type,(
    f2468: ( del * del * $i ) > $i )).

tff(lamtp_f2468,axiom,(
    ! [A_27a: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)))
     => mem(f2468(A_27a,A_27a,V0R),arr(ty_2Elist_2Elist(A_27a),bool)) ) )).
...
tff(lameq_f2468,axiom,(
    ! [A_27a: del,A_27a: del,V0R: $i] :
     ...
     => ! [V2m: $i] :
          ( mem(V2m,ty_2Elist_2Elist(A_27a))
         => ap(f2468(A_27a,A_27a,V0R),V2m) = ap(c_2Ebool_2E_21(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))),f2469(A_27a,V0R,V2m)) ) ) )).

tff(lmtp_f2466,type,(
    f2466: ( del * del ) > $i )).

tff(lamtp_f2466,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2466(A_27a,A_27a),arr(arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)),bool)) )).

tff(lameq_f2466,axiom,(
    ! [A_27a: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool)))
     => ap(f2466(A_27a,A_27a),V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))),V0R)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))),f2467(A_27a,V0R))),ap(c_2Ebool_2E_21(ty_2Elist_2Elist(A_27a)),f2468(A_27a,A_27a,V0R)))) ) )).

tff(lmtp_f2474,type,(
    f2474: ( del * del * $i * $i ) > $i )).

tff(lamtp_f2474,axiom,(
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
     ...
     => ! [V7lol: $i] :
         ...
         => mem(f2474(A_27a,A_27a,V4lol__set,V7lol),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,bool))) ) ) )).
    ...
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
     ...
     => ! [V7lol: $i] :
         ...
         => ! [V8m: $i] :
             ...
             => ap(f2474(A_27a,A_27a,V4lol__set,V7lol),V8m) = ap(c_2Ecombin_2EI(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EUNION(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),V8m)),ap(V4lol__set,V7lol))) ) ) ) )).

tff(lmtp_f2473,type,(
    f2473: ( del * $i * $i ) > $i )).

tff(lamtp_f2473,axiom,(
    ! [A_27a: del,V6v: $i] :
      ( mem(V6v,ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))
     => ! [V4lol__set: $i] :
          ( mem(V4lol__set,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))
         => mem(f2473(A_27a,V6v,V4lol__set),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool))) ) ) )).
...
tff(lameq_f2473,axiom,(
    ! [A_27a: del,V6v: $i] :
     ...
     => ! [V4lol__set: $i] :
         ...
         => ! [V7lol: $i] :
              ( mem(V7lol,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))))
             => ap(f2473(A_27a,V6v,V4lol__set),V7lol) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V6v),ap(c_2Ecombin_2EI(arr(A_27a,bool)),ap(V4lol__set,V7lol))),f2474(A_27a,A_27a,V4lol__set,V7lol)) ) ) ) )).

tff(lmtp_f2472,type,(
    f2472: ( del * del * $i ) > $i )).

tff(lamtp_f2472,axiom,(
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
      ( mem(V4lol__set,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))
     => mem(f2472(A_27a,A_27a,V4lol__set),arr(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))) ) )).
...
tff(lameq_f2472,axiom,(
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
     ...
     => ! [V6v: $i] :
          ( mem(V6v,ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))
         => ap(f2472(A_27a,A_27a,V4lol__set),V6v) = f2473(A_27a,V6v,V4lol__set) ) ) )).

tff(lmtp_f2471,type,(
    f2471: ( del * del * $i ) > $i )).

tff(lamtp_f2471,axiom,(
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
      ( mem(V4lol__set,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))
     => mem(f2471(A_27a,A_27a,V4lol__set),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool))) ) )).

tff(lameq_f2471,axiom,(
    ! [A_27a: del,A_27a: del,V4lol__set: $i] :
      ( mem(V4lol__set,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))
     => ! [V5a: $i] :
          ( mem(V5a,ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))))
         => ap(f2471(A_27a,A_27a,V4lol__set),V5a) = ap(ap(ap(c_2Elist_2Elist__CASE(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)),ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),V5a),ap(c_2Ecombin_2EI(arr(A_27a,bool)),c_2Epred__set_2EEMPTY(A_27a))),f2472(A_27a,A_27a,V4lol__set)) ) ) )).

tff(lmtp_f2470,type,(
    f2470: ( del * del * del ) > $i )).

tff(lamtp_f2470,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del] : mem(f2470(A_27a,A_27a,A_27a),arr(arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))) )).

tff(lameq_f2470,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V4lol__set: $i] :
      ( mem(V4lol__set,arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(A_27a,bool)))
     => ap(f2470(A_27a,A_27a,A_27a),V4lol__set) = f2471(A_27a,A_27a,V4lol__set) ) )).

tff(ax_thm_2Eenumeral_2Elol__set__primitive,axiom,(
    ! [A_27a: del] : c_2Eenumeral_2Elol__set(A_27a) = ap(ap(c_2Erelation_2EWFREC(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a)))),ap(c_2Emin_2E_40(arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),arr(ty_2Elist_2Elist(ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))),bool))),f2466(A_27a,A_27a))),f2470(A_27a,A_27a,A_27a)) )).

tff(conj_thm_2Eenumeral_2Elol__set,conjecture,(
    ! [A_27a: del] :
