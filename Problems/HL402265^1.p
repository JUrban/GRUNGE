...
thf(f2445_0_2E0,type,(
    f2445_0_2E0: u )).

thf(f2445_0_2E2,type,(
    f2445_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef2445_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2445_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f2445_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2ELUPDATE__SNOC,axiom,(
    ! [A_27a: d,V1k: mono_2Etyop_2Enum_2Enum,V0ys_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2445_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) )
    <=> ( V1k
        = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) ) ) ) )).

thf(thm_2Elist_2ELUPDATE__SNOC,conjecture,(
    ! [A_27a: d,V0ys_2E0: u,V1k: mono_2Etyop_2Enum_2Enum,V2x_2E0: u,V3y_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f2445_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ys_2E0 ) ) ) ) ) ) ) ) )).
