...
tff(conj_thm_2Ebag_2EBAG__IMAGE__EQ__EMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
         => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
           => ( ap(ap(c_2Ebag_2EBAG__IMAGE(A_27b,A_27b),V1f),V0b) = c_2Ebag_2EEMPTY__BAG(A_27b)
