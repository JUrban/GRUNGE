    ...
    ! [A_27b,A_27a,V0l] :
     ...
     => ! [V1f] :
         ...
         => ! [V3x] :
             ...
             => ap(f426(A_27b,A_27a,V0l,V1f),V3x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(ap(c_2Elist_2EEL(A_27a),V3x),V0l)),ap(V1f,V3x)) ) ) ) )).

fof(conj_thm_2Elist_2EZIP__GENLIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1f] :
                 ...
                 => ! [V2n] :
                     ...
                     => ( ap(c_2Elist_2ELENGTH(A_27a),V0l) = V2n
                       => ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l),ap(ap(c_2Elist_2EGENLIST(A_27b),V1f),V2n))) = ap(ap(c_2Elist_2EGENLIST(ty_2Epair_2Eprod(A_27a,A_27a)),f426(A_27b,A_27a,V0l,V1f)),V2n) ) ) ) ) ) ) )).
