...
thf(thm_2Ebag_2EBAG__INSERT__EQ__UNION,conjecture,(
    ! [A_27a: $tType,V0e: A_27a,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum,V3b: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V3b )
        = ( c_2Ebag_2EBAG__UNION @ A_27a @ V1b1 @ V2b2 ) )
     => ( ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ V1b1 )
        | ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ V2b2 ) ) ) )).
