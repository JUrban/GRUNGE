...
thf(thm_2Emeasure_2EALGEBRA__DIFF,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1s: A_27a > $o,V2t: A_27a > $o] :
     ...
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EDIFF @ A_27a @ V1s @ V2t ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) ) )).
...
thf(thm_2Emeasure_2EMEASURE__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        ...
        & ! [V2x: A_27a] :
           ...
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EINSERT @ A_27a @ V2x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        & ( c_2Epred__set_2EFINITE @ A_27a @ V1s ) )
     => ( ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s )
        = ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27a
          @ ^ [V3x: A_27a] :
              ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ ( c_2Epred__set_2EINSERT @ A_27a @ V3x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
          @ V1s ) ) ) )).
