...
thf(f11777_0_2E0,type,(
    f11777_0_2E0: u )).

thf(f11777_0_2E1,type,(
    f11777_0_2E1: du > u )).

thf(f11777_0_2E2,type,(
    f11777_0_2E2: du > du > u )).

thf(f11785_0_2E0,type,(
    f11785_0_2E0: u )).

thf(f11785_0_2E2,type,(
    f11785_0_2E2: du > du > u )).

thf(f11785_0_2E3,type,(
    f11785_0_2E3: du > du > du > u )).

thf(f11787_0_2E0,type,(
    f11787_0_2E0: u )).

thf(f11787_0_2E2,type,(
    f11787_0_2E2: du > du > u )).

thf(f11787_0_2E3,type,(
    f11787_0_2E3: du > du > du > u )).
...
thf(mono_2Ef11777_0,type,(
    mono_2Ef11777_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11785_0,type,(
    mono_2Ef11785_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11787_0,type,(
    mono_2Ef11787_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__CONST,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11777_0 @ V0c @ V1x )
      = V0c ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__CONST,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11777_0 @ V0c ) ) )).

thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11785_0 @ V0p @ V1q @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0p @ V2x ) @ ( V1q @ V2x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11785_0 @ V0p @ V1q ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__POW,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11787_0 @ V0p @ V1n @ V2x )
      = ( mono_2Ec_2Ereal_2Epow @ ( V0p @ V2x ) @ V1n ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__POW,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11787_0 @ V0p @ V1n ) ) ) )).
