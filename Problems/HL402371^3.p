...
thf(thm_2Eres__quan_2ERES__EXISTS__EMPTY,axiom,(
    ! [A_27a: $tType,V0p: A_27a > $o] :
      ( (~) @ ( c_2Ebool_2ERES__EXISTS @ A_27a @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V0p ) ) )).

thf(thm_2Eres__quan_2ERES__EXISTS__UNIQUE__EMPTY,conjecture,(
    ! [A_27a: $tType,V0p: A_27a > $o] :
      ( (~) @ ( c_2Ebool_2ERES__EXISTS__UNIQUE @ A_27a @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V0p ) ) )).
