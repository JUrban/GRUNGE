...
thf(conj_thm_2Eproduct_2Eth,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
          ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
         => ! [V1g: $i] :
      ...
      & ! [V5f: $i] :
         ...
         => ! [V6g: $i] :
             ...
             => ! [V7a: tp__ty_2Enum_2Enum,V8b: tp__ty_2Enum_2Enum] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal
                      @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V7a ) ) @ ( inj__ty_2Enum_2Enum @ V8b ) ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V10i: $i] :
                              ( ap @ V5f @ V10i ) ) ) )
                    = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V7a ) ) @ ( inj__ty_2Enum_2Enum @ V8b ) ) ) @ V6g ) ) ) ) ) )
      & ! [V11f: $i] :
         ...
         => ! [V12g: $i] :
             ...
             => ! [V13p: $i] :
                 ...
                 => ( ! [V14x: $i] :
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal
                        @ ( ap
                          @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27b )
