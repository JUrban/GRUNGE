...
tff(lamtp_f1053,axiom,(
    ! [A_27b: del,A_27a: del,A_27d: del,V3b: $i] :
      ( mem(V3b,A_27b)
     => ! [V2f: $i] :
          ( mem(V2f,arr(A_27d,arr(ty_2Elist_2Elist(A_27d),ty_2Esum_2Esum(A_27a,A_27a))))
         => mem(f1053(A_27b,A_27a,A_27d,V3b,V2f),arr(ty_2Elist_2Elist(A_27d),ty_2Esum_2Esum(A_27a,A_27a))) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,A_27d: del,V3b: $i] :
     ...
     => ! [V2f: $i] :
         ...
         => ! [V5p: $i] :
             ...
             => ap(f1053(A_27b,A_27a,A_27d,V3b,V2f),V5p) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Elist_2Elist(A_27d)),V5p),c_2Elist_2ENIL(A_27d))),ap(c_2Esum_2EINR(A_27a,A_27a),V3b)),ap(ap(V2f,ap(c_2Elist_2EHD(A_27d),V5p)),ap(c_2Elist_2ETL(A_27d),V5p))) ) ) ) )).

tff(conj_thm_2Einftree_2Eis__tree__rules,conjecture,(
    ! [A_27a: del,A_27b: del,A_27d: del] :
      ( ! [V0a: $i] :
          ( mem(V0a,A_27a)
         => p(ap(c_2Einftree_2Eis__tree(A_27a,A_27a,A_27a),k(ty_2Elist_2Elist(A_27d),ap(c_2Esum_2EINL(A_27a,A_27a),V0a)))) )
      & ! [V2f: $i] :
          ( mem(V2f,arr(A_27d,arr(ty_2Elist_2Elist(A_27d),ty_2Esum_2Esum(A_27a,A_27a))))
         => ! [V3b: $i] :
              ( mem(V3b,A_27b)
             => ( ! [V4d: $i] :
                    ( mem(V4d,A_27d)
                   => p(ap(c_2Einftree_2Eis__tree(A_27a,A_27a,A_27a),ap(V2f,V4d))) )
               => p(ap(c_2Einftree_2Eis__tree(A_27a,A_27a,A_27a),f1053(A_27b,A_27a,A_27d,V3b,V2f))) ) ) ) ) )).
