...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE__OPEN__MAP,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__OPEN__MAP,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
