...
tff(conj_thm_2Ereal_2EREAL__LT__MIN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal__topology_2EREAL__HALF,lemma,
...
tff(conj_thm_2Ereal__topology_2EREAL__LE__LMUL1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal__topology_2EBILINEAR__LSUB,lemma,(
    ! [V0h: $i] :
    ...
    ! [V2h: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1g: $i] :
             ...
             => mem(f3835(V2h,V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) ) )).

tff(lameq_f3835,axiom,(
    ! [V2h: $i] :
      ( mem(V2h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1g: $i] :
              ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3835(V2h,V0f,V1g),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(V2h,ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),ap(V1g,inj__ty_2Erealax_2Ereal(V4x))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBILINEAR__UNIFORMLY__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2h: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V3s))
                   ...
                   => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f3835(V2h,V0f,V1g)),V3s)) ) ) ) ) ) )).
