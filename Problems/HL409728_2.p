...
tff(lmtp_f3312,type,(
    f3312: ( del * del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3312,axiom,(
    ! [A_27a: del,A_27a: del,V0b: tp__ty_2Enum_2Enum,V2a: $i] :
      ( mem(V2a,A_27a)
     => mem(f3312(A_27a,A_27a,V0b,V2a),arr(A_27a,ty_2Enum_2Enum)) ) )).
...
tff(lameq_f3312,axiom,(
    ! [A_27a: del,A_27a: del,V0b: tp__ty_2Enum_2Enum,V2a: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3312(A_27a,A_27a,V0b,V2a),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2a)),inj__ty_2Enum_2Enum(V0b)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) ) )).

tff(conj_thm_2Eiterate_2ENSUM__DELTA,conjecture,(
    ! [A_27a: del,V0b: tp__ty_2Enum_2Enum,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2a: $i] :
          ( mem(V2a,A_27a)
         => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3312(A_27a,A_27a,V0b,V2a))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V2a),V1s)),inj__ty_2Enum_2Enum(V0b)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).
