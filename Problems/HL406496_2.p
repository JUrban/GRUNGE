...
tff(conj_thm_2Elist_2EEL__ZIP,lemma,(
    ! [A_27a: del,A_27b: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27b))
         => ! [V2n: tp__ty_2Enum_2Enum] :
             ...
             => ap(ap(c_2Elist_2EEL(ty_2Epair_2Eprod(A_27a,A_27a)),inj__ty_2Enum_2Enum(V2n)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2))) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V2n)),V0l1)),ap(ap(c_2Elist_2EEL(A_27b),inj__ty_2Enum_2Enum(V2n)),V1l2)) ) ) ) )).
...
tff(lmtp_f2295,type,(
    f2295: tp__c_ty_2Elist_2Elist_o > $i )).

tff(lamtp_f2295,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o] : mem(f2295(V0v),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2295,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1i: tp__ty_2Enum_2Enum] : ap(f2295(V0v),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Ebitstring_2Etestbit,inj__ty_2Enum_2Enum(V1i)),inj__c_ty_2Elist_2Elist_o(V0v)) )).

tff(ax_thm_2Ebitstring_2Ev2w__def,axiom,(
    ! [A_27a: del,V0v: tp__c_ty_2Elist_2Elist_o] : ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V0v)) = ap(c_2Efcp_2EFCP(bool,bool),f2295(V0v)) )).

tff(lmtp_f2299,type,(
    f2299: ( tp__c_ty_2Elist_2Elist_o * tp__c_ty_2Elist_2Elist_o * $i ) > $i )).

tff(lamtp_f2299,axiom,(
    ! [V1v1: tp__c_ty_2Elist_2Elist_o,V2v2: tp__c_ty_2Elist_2Elist_o,V0f: $i] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => mem(f2299(V1v1,V2v2,V0f),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))) ) )).

tff(lameq_f2299,axiom,(
    ! [V1v1: tp__c_ty_2Elist_2Elist_o,V2v2: tp__c_ty_2Elist_2Elist_o,V0f: $i] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => ! [V3m: tp__ty_2Enum_2Enum] : ap(f2299(V1v1,V2v2,V0f),inj__ty_2Enum_2Enum(V3m)) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),V0f)),ap(c_2Elist_2EZIP(bool,bool),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Ebitstring_2Efixwidth,inj__ty_2Enum_2Enum(V3m)),inj__c_ty_2Elist_2Elist_o(V1v1))),ap(ap(c_2Ebitstring_2Efixwidth,inj__ty_2Enum_2Enum(V3m)),inj__c_ty_2Elist_2Elist_o(V2v2))))) ) )).

tff(ax_thm_2Ebitstring_2Ebitwise__def,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(bool,arr(bool,bool)))
     => ! [V1v1: tp__c_ty_2Elist_2Elist_o,V2v2: tp__c_ty_2Elist_2Elist_o] : surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2Ebitstring_2Ebitwise,V0f),inj__c_ty_2Elist_2Elist_o(V1v1)),inj__c_ty_2Elist_2Elist_o(V2v2))) = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2299(V1v1,V2v2,V0f)),ap(ap(c_2Earithmetic_2EMAX,ap(c_2Elist_2ELENGTH(bool),inj__c_ty_2Elist_2Elist_o(V1v1))),ap(c_2Elist_2ELENGTH(bool),inj__c_ty_2Elist_2Elist_o(V2v2))))) ) )).

tff(ax_thm_2Ebitstring_2Ebor__def,axiom,(
    c_2Ebitstring_2Ebor = ap(c_2Ebitstring_2Ebitwise,c_2Ebool_2E_5C_2F) )).

tff(conj_thm_2Ebitstring_2Efixwidth__id,lemma,(
...
tff(conj_thm_2Ebitstring_2Eword__or__v2w,conjecture,(
