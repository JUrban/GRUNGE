...
fof(conj_thm_2Eprim__rec_2EWF__IFF__WELLFOUNDED,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(lamtp_f303,axiom,(
    ! [A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => mem(f303(A_27a,V0R,V1x),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).

fof(lameq_f303,axiom,(
    ! [A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => ! [V2y] :
              ( mem(V2y,A_27a)
             => ap(f303(A_27a,V0R,V1x),V2y) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2y),ap(ap(V0R,V1x),V2y)) ) ) ) )).

fof(lamtp_f304,axiom,(
    ! [A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V3x] :
          ( mem(V3x,A_27a)
         => mem(f304(A_27a,V0R,V3x),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).

fof(lameq_f304,axiom,(
    ! [A_27a,V0R] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V3x] :
          ( mem(V3x,A_27a)
         => ! [V4y] :
              ( mem(V4y,A_27a)
             => ap(f304(A_27a,V0R,V3x),V4y) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4y),ap(ap(ap(c_2Erelation_2ERTC(A_27a),V0R),V3x),V4y)) ) ) ) )).

fof(conj_thm_2Epred__set_2EKoenigsLemma,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
           ...
           => ! [V3x] :
               ...
               => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f304(A_27a,V0R,V3x))))
                 => ? [V5f] :
                      ...
                      & ap(V5f,c_2Enum_2E0) = V3x
                      & ! [V6n] :
                          ( mem(V6n,ty_2Enum_2Enum)
                         => p(ap(ap(V0R,ap(V5f,V6n)),ap(V5f,ap(c_2Enum_2ESUC,V6n)))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EKoenigsLemma__WF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
