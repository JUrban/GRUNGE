...
fof(conj_thm_2EternaryComparisons_2Enum2ordering__thm,lemma,
...
fof(conj_thm_2EternaryComparisons_2Eordering__EQ__ordering,lemma,(
    ! [V0a] :
...
fof(conj_thm_2EternaryComparisons_2Eordering__eq__dec,conjecture,
    ( ! [V0x] :
