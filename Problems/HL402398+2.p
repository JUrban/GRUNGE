...
fof(ax_thm_2Estate__transformer_2EJOIN__DEF,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0z] :
              ( mem(V0z,arr(A_27a,ty_2Epair_2Eprod(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))))
             => ap(c_2Estate__transformer_2EJOIN(A_27a,A_27a),V0z) = ap(ap(c_2Estate__transformer_2EBIND(A_27a,A_27a,A_27a),V0z),c_2Ecombin_2EI(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))) ) ) ) )).
...
fof(conj_thm_2Estate__transformer_2EJOIN__EXT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
