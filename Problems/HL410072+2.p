...
fof(conj_thm_2Eiterate_2EITERATE__EQ__NEUTRAL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V1f] :
                   ...
                   => ! [V2s] :
                       ...
                       => ( ! [V3x] :
                         ...
                         => ap(ap(ap(c_2Eiterate_2Eiterate(A_27a,A_27a),V0op),V2s),V1f) = ap(c_2Eiterate_2Eneutral(A_27b),V0op) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eproduct_2EPRODUCT__EQ__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
