...
thf(conj_thm_2Ereal__topology_2EDIAMETER__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              & ! [V2x: tp__ty_2Erealax_2Ereal] :
                  ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) )
           => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Ediameter @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) ) )
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal__topology_2Ediameter @ V1s ) ) ) ) ) ) )).
