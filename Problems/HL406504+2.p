...
fof(ax_thm_2Ebitstring_2Emodify__def,axiom,(
    ! [V0f] :
     ...
     => ! [V1v] :
         ...
         => ap(ap(c_2Ebitstring_2Emodify,V0f),V1v) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f)),ap(c_2Elist_2EZIP(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Enum_2Enum),ty_2Elist_2Elist(ty_2Enum_2Enum)),ap(c_2Ebitstring_2Erev__count__list,ap(c_2Elist_2ELENGTH(bool),V1v))),V1v))) ) ) )).
...
fof(conj_thm_2Ebitstring_2Elength__rev__count__list,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Elist_2ELENGTH(ty_2Enum_2Enum),ap(c_2Ebitstring_2Erev__count__list,V0n)) = V0n ) )).

fof(conj_thm_2Ebitstring_2Eel__rev__count__list,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebitstring_2Eword__modify__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,arr(bool,bool)))
