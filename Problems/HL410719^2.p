...
thf(conj_thm_2Ereal_2EREAL__MIN__LE1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Ereal_2Emin @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELIMPT__OF__OPEN__IN,conjecture,(
    ! [V0s: $i] :
