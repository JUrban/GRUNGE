...
tff(conj_thm_2Erich__list_2EAPPEND__SNOC1,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(lameq_f2241,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(bool,arr(bool,bool)))
     => ! [V2l: tp__c_ty_2Elist_2Elist_o] : ap(f2241(V1f),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),V1f),ap(c_2Elist_2EHD(bool),inj__c_ty_2Elist_2Elist_o(V2l))),ap(c_2Elist_2ETL(bool),inj__c_ty_2Elist_2Elist_o(V2l))) ) )).

tff(conj_thm_2Ewords_2Eword__reduce__n2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(bool,arr(bool,bool)))
