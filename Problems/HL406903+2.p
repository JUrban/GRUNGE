...
fof(conj_thm_2EDeepSyntax_2Eposinf__ok,lemma,(
    ! [V0f] :
...
fof(conj_thm_2EDeepSyntax_2Eadd__d__posinf,lemma,(
    ! [V0f] :
      ( mem(V0f,ty_2EDeepSyntax_2Edeep__form)
     => ! [V1x] :
...
fof(conj_thm_2EDeepSyntax_2Eposinf__disj1__implies__exoriginal,conjecture,(
    ! [V0f] :
      ( mem(V0f,ty_2EDeepSyntax_2Edeep__form)
     => ! [V1d] :
