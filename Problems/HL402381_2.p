...
tff(conj_thm_2Eres__quan_2ERES__ABSTRACT__EQUAL,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m1: $i] :
...
tff(conj_thm_2Eres__quan_2ERES__ABSTRACT__IDEMPOT,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m: $i] :
          ( mem(V1m,arr(A_27a,A_27b))
         => ap(ap(c_2Ebool_2ERES__ABSTRACT(A_27a,A_27a),V0p),ap(ap(c_2Ebool_2ERES__ABSTRACT(A_27a,A_27a),V0p),V1m)) = ap(ap(c_2Ebool_2ERES__ABSTRACT(A_27a,A_27a),V0p),V1m) ) ) )).
