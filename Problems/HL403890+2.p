...
fof(conj_thm_2Ellist_2ELNTH__HD__LDROP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1ll] :
              ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
             => ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),V1ll) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27a,A_27a),ap(ap(c_2Ellist_2ELDROP(A_27a),V0n),V1ll)),c_2Ellist_2ELHD(A_27a)) ) ) ) )).
