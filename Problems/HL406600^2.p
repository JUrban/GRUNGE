...
thf(conj_thm_2Earithmetic_2EEVEN__ODD__EXISTS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( ( p @ ( ap @ c_2Earithmetic_2EEVEN @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      ...
      & ( ( p @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
       => ? [V2m: tp__ty_2Enum_2Enum] :
            ( V0n
            = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Esptree_2EIN__domain,conjecture,(
