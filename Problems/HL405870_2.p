...
tff(conj_thm_2Ewords_2Eword__extract__w2w,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0w: $i] :
     ...
     => ! [V1h: tp__ty_2Enum_2Enum,V2l: tp__ty_2Enum_2Enum] :
         ...
         => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),inj__ty_2Enum_2Enum(V1h)),inj__ty_2Enum_2Enum(V2l)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V1h)),inj__ty_2Enum_2Enum(V2l)),V0w) ) ) )).
