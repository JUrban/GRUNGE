...
thf(conj_thm_2Erich__list_2EBUTLASTN__LASTN,conjecture,(
    ! [A_27a: del,V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2l: $i] :
     ...
     => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
       ...
       => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2l ) )
          = ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V2l ) ) ) ) ) )).
