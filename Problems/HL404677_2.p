...
tff(conj_thm_2Efinite__map_2EFMERGE__EQ__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,arr(A_27b,arr(A_27b,A_27b)))
     => ! [V1f: $i] :
          ( mem(V1f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2g: $i] :
              ( mem(V2g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ( ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m),V1f),V2g) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a)
              <=> ( V1f = c_2Efinite__map_2EFEMPTY(A_27a,A_27a)
                  & V2g = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) ) ) ) ) )).
