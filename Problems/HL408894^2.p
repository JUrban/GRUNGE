...
thf(conj_thm_2EHolSmt_2Et018,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
         ...
         => ! [V2i: tp__ty_2Enum_2Enum] :
              ( ( V0x = V1y )
             => ( ( p @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0x ) @ ( inj__ty_2Enum_2Enum @ V2i ) ) )
               => ( p @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1y ) @ ( inj__ty_2Enum_2Enum @ V2i ) ) ) ) ) ) ) )).
