...
fof(conj_thm_2Estate__transformer_2EEXT__MCOMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Estate__transformer_2EUNIT__o__MCOMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Estate__transformer_2EMMAP__EXT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                 ...
                 => ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V0f) = ap(c_2Estate__transformer_2EEXT(A_27b,A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Estate__transformer_2EUNIT(A_27a,A_27a)),V0f)) ) ) ) ) )).

fof(conj_thm_2Estate__transformer_2EMMAP__COMP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [A_27d] :
                 ...
                 => ! [V0f] :
                     ...
                     => ! [V1g] :
                         ...
                         => ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V0f),V1g)) = ap(ap(c_2Ecombin_2Eo(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V0f)),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V1g)) ) ) ) ) ) ) )).
