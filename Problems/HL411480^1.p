...
thf(f13333_0_2E0,type,(
    f13333_0_2E0: u )).

thf(f13333_0_2E1,type,(
    f13333_0_2E1: du > u )).

thf(f13333_1_2E0,type,(
    f13333_1_2E0: u )).

thf(f13333_1_2E1,type,(
    f13333_1_2E1: du > u )).

thf(f13333_1_2E3,type,(
    f13333_1_2E3: du > du > du > u )).

thf(f13333_2_2E0,type,(
    f13333_2_2E0: u )).

thf(f13333_2_2E3,type,(
    f13333_2_2E3: du > du > du > u )).
...
thf(mono_2Ef13333_0,type,(
    mono_2Ef13333_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).

thf(mono_2Ef13333_1,type,(
    mono_2Ef13333_1: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13333_2,type,(
    mono_2Ef13333_2: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(thm_2Eiterate_2EREAL__SUP__LE__SUBSET,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Esup @ V0s ) @ ( mono_2Ec_2Ereal_2Esup @ V1t ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2Ediameter,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef13333_0 @ V0s )
    <=> ( V0s = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )).

thf(def1_2Ethm_2Ereal__topology_2Ediameter,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal,V0s: mono_2Etyop_2Erealax_2Ereal > $o,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13333_2 @ V1x @ V0s @ V2y )
    <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1x @ V0s )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V2y @ V0s ) ) ) )).

thf(def2_2Ethm_2Ereal__topology_2Ediameter,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13333_1 @ V0s @ V1x @ V2y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V1x @ V2y ) ) @ ( mono_2Ef13333_2 @ V1x @ V0s @ V2y ) ) ) )).

thf(thm_2Ereal__topology_2Ediameter,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ediameter @ V0s )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13333_0 @ V0s ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 @ ( mono_2Ec_2Epair_2EUNCURRY_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ef13333_1 @ V0s ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EDIAMETER__POS__LE,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ebounded__def @ V0s )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Ereal__topology_2Ediameter @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EDIAMETER__SUBSET,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V0s @ V1t )
