...
thf(ax_thm_2Ereal_2Ereal__of__num,axiom,
    ...
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ...
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Erealax_2Ereal__1 ) ) ) ) )).

thf(conj_thm_2Ereal_2EREAL__1,lemma,
...
thf(conj_thm_2Ereal_2EREAL,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
