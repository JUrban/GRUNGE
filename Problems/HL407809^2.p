...
thf(conj_thm_2Efrac_2EFRAC__ADD__RID,lemma,(
    ! [V0a: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) @ ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__0 ) ) )
      = V0a ) )).
...
thf(conj_thm_2Erat_2ERAT__ADD__RID,conjecture,(
