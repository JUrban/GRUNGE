...
fof(conj_thm_2Ebit_2EDIV__MULT__THM2,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITWISE__COR,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2ESBIT__MULT,lemma,(
    ! [V0b] :
      ( mem(V0b,bool)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITWISE__EVAL,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1op] :
