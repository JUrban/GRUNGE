...
fof(conj_thm_2Ecardinal_2EINFINITE__IMAGE__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EINFINITE__NONEMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2Enum__INFINITE,lemma,(
...
fof(conj_thm_2Ecardinal_2EINFINITE__DIFF__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ELT__CASES,lemma,(
    ! [V0m] :
...
fof(conj_thm_2Ecardinal_2EINFINITE__CARD__LE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
