...
tff(thm_2Erelation_2ETC__CASES2__E,conjecture,(
    ! [A_27a: $tType,V0R_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V1x_2E0: A_27a,V2z_2E0: A_27a] :
      ( p(c_2Erelation_2ETC_2E3(A_27a,V0R_2E0,V1x_2E0,V2z_2E0))
     => ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0R_2E0,V1x_2E0),V2z_2E0))
        | ? [V3y_2E0: A_27a] :
            ( p(c_2Erelation_2ETC_2E3(A_27a,V0R_2E0,V1x_2E0,V3y_2E0))
            & p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0R_2E0,V3y_2E0),V2z_2E0)) ) ) ) )).
