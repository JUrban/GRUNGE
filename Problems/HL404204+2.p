...
fof(conj_thm_2Epath_2Efinite__plink,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p1] :
             ...
             => ! [V1p2] :
                 ...
                 => ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(c_2Epath_2Eplink(A_27a,A_27a),V0p1),V1p2)))
                  <=> ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),V0p1))
                      & p(ap(c_2Epath_2Efinite(A_27a,A_27a),V1p2)) ) ) ) ) ) ) )).
