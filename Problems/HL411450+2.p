...
fof(conj_thm_2Ereal__topology_2ECOMPACT__ATTAINS__SUP,lemma,(
    ! [V0s] :
       ...
       => ? [V1x] :
            ...
            & ! [V2y] :
               ...
               => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V0s))
                 => p(ap(ap(c_2Ereal_2Ereal__lte,V2y),V1x)) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__SUP,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
