...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__SUM,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUM,conjecture,(
    ! [A_27a: del,V0t: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                  & ! [V3a: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3a),V2s))
                       => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,ap(V1f,V3a)),V0t)) ) ) )
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3833(A_27a,V1f,V2s)),V0t)) ) ) ) ) )).
