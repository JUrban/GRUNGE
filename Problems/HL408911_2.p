...
tff(conj_thm_2Ebit_2EBITS__ZERO2,lemma,(
...
tff(conj_thm_2Ebit_2EODD__MOD2__LEM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ewords_2Eword__index__n2w,lemma,(
    ! [A_27a: del,V0index_20too_20large: tp__o,V1n: tp__ty_2Enum_2Enum,V2i: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V1n))),inj__ty_2Enum_2Enum(V2i)))
    <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Ebit_2EBIT,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V1n))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Enum_2Enum,bool)),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Enum_2Enum,bool))),c_2Efcp_2Efcp__index(bool,bool)),inj__o(V0index_20too_20large)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V1n))),inj__ty_2Enum_2Enum(V2i)))) ) )).
...
tff(conj_thm_2EHolSmt_2Et035,conjecture,(
    ! [V0x: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] :
      ( surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = V0x
      | surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(ap(c_2Ewords_2Eword__extract(ty_2Eone_2Eone,ty_2Eone_2Eone),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V0x))) != surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) )).
