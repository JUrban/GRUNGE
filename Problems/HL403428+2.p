...
fof(conj_thm_2Ebag_2ECOMMUTING__ITBAG__RECURSES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
    ...
    ! [A_27a,V2e] :
     ...
     => ! [V0eltsize] :
         ...
         => ! [V3acc] :
             ...
             => ap(f979(A_27a,V2e,V0eltsize),V3acc) = ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(V0eltsize,V2e))),V3acc) ) ) ) )).

fof(lamtp_f978,axiom,(
    ! [A_27a,V0eltsize] :
      ( mem(V0eltsize,arr(A_27a,ty_2Enum_2Enum))
    ...
    ! [A_27a] :
     ...
     => ! [V0eltsize] :
         ...
         => ! [V1b] :
             ...
             => ap(ap(c_2Ebag_2Ebag__size(A_27a),V0eltsize),V1b) = ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),f978(A_27a,V0eltsize)),V1b),c_2Enum_2E0) ) ) ) )).

fof(conj_thm_2Ebag_2EBAG__SIZE__INSERT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
