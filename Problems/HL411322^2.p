...
thf(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__LT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ...
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V2x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V2x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ~ ( p
...
thf(conj_thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__LT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ~ ( p
        @ ( ap @ c_2Ereal__topology_2Ebounded__def
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
