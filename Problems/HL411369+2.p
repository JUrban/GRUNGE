...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__OF__SUBSET,conjecture,(
    ! [V0y] :
         ...
         => ! [V2t] :
             ...
             => ! [V3x] :
                 ...
                 => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1s),V2t))
                      & p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V1s),V3x),V0y)) )
                   => p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V2t),V3x),V0y)) ) ) ) ) ) )).
