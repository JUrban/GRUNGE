...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__EMPTY,conjecture,
    ( ! [V0s: tyop_2Erealax_2Ereal > $o] :
        ( ( c_2Ereal__topology_2Ehomeomorphic @ V0s @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
      <=> ( V0s
          = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
    & ! [V1s: tyop_2Erealax_2Ereal > $o] :
        ( ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) @ V1s )
      <=> ( V1s
          = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).
