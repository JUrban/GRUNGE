...
thf(thm_2Ebit_2ETWOEXP__LE__IMP__LE__LOG2,axiom,
    ( ! [V0x: tyop_2Enum_2Enum,V1y: tyop_2Enum_2Enum] :
        ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0x ) @ V1y )
       => ( c_2Earithmetic_2E_3C_3D @ V0x @ ( c_2Ebit_2ELOG2 @ V1y ) ) )
    & ! [V2y: tyop_2Enum_2Enum,V3x: tyop_2Enum_2Enum] :
        ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V3x )
       => ( ( c_2Earithmetic_2E_3C_3D @ V3x @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V2y ) )
         => ( c_2Earithmetic_2E_3C_3D @ ( c_2Ebit_2ELOG2 @ V3x ) @ V2y ) ) ) )).
...
thf(thm_2Ebit_2EBIT__LOG2,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( (~) @ ( V0n = c_2Enum_2E0 ) )
     => ( c_2Ebit_2EBIT @ ( c_2Ebit_2ELOG2 @ V0n ) @ V0n ) ) )).
