...
fof(conj_thm_2Earithmetic_2ELESS__LESS__SUC,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eintegral_2Enum__MAX,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ( ( ? [V1x] :
          ...
          & ? [V2M] :
              ...
              & ! [V3x] :
                 ...
                 => ( p(ap(V0P,V3x))
                   => p(ap(ap(c_2Earithmetic_2E_3C_3D,V3x),V2M)) ) ) ) )
      <=> ? [V4m] :
            ...
            & ! [V5x] :
               ...
               => ( p(ap(V0P,V5x))
                 => p(ap(ap(c_2Earithmetic_2E_3C_3D,V5x),V4m)) ) ) ) ) ) )).
