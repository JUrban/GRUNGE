...
fof(conj_thm_2Eiterate_2ESUM__CLAUSES__RIGHT,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESERIES__TERMS__TOZERO,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),ap(c_2Ereal__topology_2Efrom,V2n)))
