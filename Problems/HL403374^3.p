...
thf(c_2Ebag_2EBAG__DISJOINT,type,(
    c_2Ebag_2EBAG__DISJOINT: 
      !>[A_27a: $tType] :
...
thf(thm_2Ebag_2EBAG__DISJOINT,axiom,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__DISJOINT @ A_27a @ V0b1 @ V1b2 )
      = ( c_2Epred__set_2EDISJOINT @ A_27a @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V0b1 ) @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V1b2 ) ) ) )).

thf(thm_2Ebag_2EBAG__ALL__DISTINCT,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27a @ V0b )
    <=> ! [V1e: A_27a] :
          ( c_2Earithmetic_2E_3C_3D @ ( V0b @ V1e ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__ALL__DISTINCT__BAG__UNION,conjecture,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27a @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V0b1 @ V1b2 ) )
    <=> ( ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27a @ V0b1 )
        & ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27a @ V1b2 )
        & ( c_2Ebag_2EBAG__DISJOINT @ A_27a @ V0b1 @ V1b2 ) ) ) )).
