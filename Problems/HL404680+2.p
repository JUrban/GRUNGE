...
fof(conj_thm_2Efinite__map_2EFLOOKUP__SUBMAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1g] :
                 ...
                 => ! [V2k] :
                     ...
                     => ! [V3v] :
                          ( mem(V3v,A_27b)
                         => ( ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V1g))
                              & ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V0f),V2k) = ap(c_2Eoption_2ESOME(A_27b),V3v) )
                           => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V1g),V2k) = ap(c_2Eoption_2ESOME(A_27b),V3v) ) ) ) ) ) ) ) )).
