...
tff(ax_thm_2Elist_2EPAD__LEFT,axiom,(
    ! [A_27a: del,V0c: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2s: $i] :
         ...
         => ap(ap(ap(c_2Elist_2EPAD__LEFT(A_27a),V0c),inj__ty_2Enum_2Enum(V1n)),V2s) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V0c)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1n)),ap(c_2Elist_2ELENGTH(A_27a),V2s)))),V2s) ) ) )).
...
tff(lmtp_f2179,type,(
    f2179: ( del * $i * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2179,axiom,(
    ! [A_27a: del,V2w: $i] :
      ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] : mem(f2179(A_27a,V2w,V0h,V1l),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2179,axiom,(
    ! [A_27a: del,V2w: $i] :
      ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum,V3i: tp__ty_2Enum_2Enum] : ap(f2179(A_27a,V2w,V0h,V1l),inj__ty_2Enum_2Enum(V3i)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1l)),inj__ty_2Enum_2Enum(V3i))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3i)),ap(ap(c_2Earithmetic_2EMIN,inj__ty_2Enum_2Enum(V0h)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2w),inj__ty_2Enum_2Enum(V3i)))) ) )).

tff(lmtp_f2178,type,(
    f2178: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2178,axiom,(
    ! [A_27a: del,V1l: tp__ty_2Enum_2Enum,V0h: tp__ty_2Enum_2Enum] : mem(f2178(A_27a,V1l,V0h),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(ax_thm_2Ewords_2Eword__slice__def,axiom,(
    ! [A_27a: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__slice(A_27a),inj__ty_2Enum_2Enum(V0h)),inj__ty_2Enum_2Enum(V1l)) = f2178(A_27a,V1l,V0h) )).
...
tff(conj_thm_2Ewords_2EWORD__NEG__1__T,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum] :
     ...
     => p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Enum_2Enum(V0i))) ) )).
...
tff(conj_thm_2Ewords_2EASR__LIMIT,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Enum_2Enum(V1n)))
         => ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),c_2Ewords_2Eword__T(A_27a)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ewords_2Eword__asr,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),ap(ap(c_2Ewords_2Eword__or(A_27a),ap(ap(ap(c_2Ewords_2Eword__slice(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Enum_2Enum(V1n))),c_2Ewords_2Eword__T(A_27a))),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)))),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V0w),inj__ty_2Enum_2Enum(V1n))) ) )).

tff(conj_thm_2Ewords_2Eword__bit__0,lemma,(
...
tff(conj_thm_2Ebitstring_2Elength__shiftr,lemma,(
...
tff(conj_thm_2Ebitstring_2Eel__fixwidth,lemma,(
...
tff(conj_thm_2Ebitstring_2Eel__shiftr,lemma,(
...
tff(conj_thm_2Ebitstring_2Eword__msb__v2w,lemma,(
...
tff(conj_thm_2Ebitstring_2Eword__lsr__v2w,lemma,(
...
tff(lmtp_f2308,type,(
    f2308: ( del * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2308,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : mem(f2308(A_27a,V0n),arr(ty_2Elist_2Elist(bool),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2308,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V2l: tp__c_ty_2Elist_2Elist_o] : ap(f2308(A_27a,V0n),inj__c_ty_2Elist_2Elist_o(V2l)) = ap(c_2Ebitstring_2Ev2w(A_27a),ap(ap(c_2Ebitstring_2Esign__extend(bool),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(bool)),ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Elist_2ECONS(bool),ap(c_2Elist_2EHD(bool),inj__c_ty_2Elist_2Elist_o(V2l))),c_2Elist_2ENIL(bool))),ap(ap(c_2Ebitstring_2Eshiftr,inj__c_ty_2Elist_2Elist_o(V2l)),inj__ty_2Enum_2Enum(V0n))))) )).

tff(conj_thm_2Ebitstring_2Eword__asr__v2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] : ap(ap(c_2Ewords_2Eword__asr(A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),inj__c_ty_2Elist_2Elist_o(V1v))),inj__ty_2Enum_2Enum(V0n)) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2308(A_27a,V0n)),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__c_ty_2Elist_2Elist_o(V1v))) )).
