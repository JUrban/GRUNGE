...
tff(lamtp_f2861,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => mem(f2861(V0R),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2861,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f2861(V0R),inj__ty_2Enum_2Enum(V1n)) = ap(ap(V0R,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))),ap(c_2Enum_2ESUC,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))) ) )).

tff(lmtp_f2860,type,(
    f2860: $i )).

tff(lamtp_f2860,axiom,(
    mem(f2860,arr(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)),bool)) )).

tff(lameq_f2860,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ap(f2860,V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(ty_2Enum_2Enum),V0R)),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2861(V0R))) ) )).

tff(lmtp_f2865,type,(
    f2865: $i > $i )).

tff(lamtp_f2865,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => mem(f2865(V2rat__of__num),arr(ty_2Enum_2Enum,ty_2Erat_2Erat)) ) )).

tff(lameq_f2865,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => ! [V5n: tp__ty_2Enum_2Enum] : ap(f2865(V2rat__of__num),inj__ty_2Enum_2Enum(V5n)) = ap(c_2Ecombin_2EI(ty_2Erat_2Erat),ap(ap(c_2Erat_2Erat__add,ap(V2rat__of__num,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V5n)))),inj__ty_2Erat_2Erat(fo__c_2Erat_2Erat__1))) ) )).

tff(lmtp_f2864,type,(
    f2864: $i > $i )).

tff(lamtp_f2864,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => mem(f2864(V2rat__of__num),arr(ty_2Enum_2Enum,ty_2Erat_2Erat)) ) )).

tff(lameq_f2864,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => ! [V4v: tp__ty_2Enum_2Enum] : ap(f2864(V2rat__of__num),inj__ty_2Enum_2Enum(V4v)) = ap(ap(ap(c_2Earithmetic_2Enum__CASE(ty_2Erat_2Erat),inj__ty_2Enum_2Enum(V4v)),ap(c_2Ecombin_2EI(ty_2Erat_2Erat),inj__ty_2Erat_2Erat(fo__c_2Erat_2Erat__1))),f2865(V2rat__of__num)) ) )).

tff(lmtp_f2863,type,(
    f2863: $i > $i )).

tff(lamtp_f2863,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => mem(f2863(V2rat__of__num),arr(ty_2Enum_2Enum,ty_2Erat_2Erat)) ) )).

tff(lameq_f2863,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => ! [V3a: tp__ty_2Enum_2Enum] : ap(f2863(V2rat__of__num),inj__ty_2Enum_2Enum(V3a)) = ap(ap(ap(c_2Earithmetic_2Enum__CASE(ty_2Erat_2Erat),inj__ty_2Enum_2Enum(V3a)),ap(c_2Ecombin_2EI(ty_2Erat_2Erat),inj__ty_2Erat_2Erat(fo__c_2Erat_2Erat__0))),f2864(V2rat__of__num)) ) )).

tff(lmtp_f2862,type,(
    f2862: $i )).

tff(lamtp_f2862,axiom,(
    mem(f2862,arr(arr(ty_2Enum_2Enum,ty_2Erat_2Erat),arr(ty_2Enum_2Enum,ty_2Erat_2Erat))) )).

tff(lameq_f2862,axiom,(
    ! [V2rat__of__num: $i] :
      ( mem(V2rat__of__num,arr(ty_2Enum_2Enum,ty_2Erat_2Erat))
     => ap(f2862,V2rat__of__num) = f2863(V2rat__of__num) ) )).

tff(ax_thm_2Erat_2Erat__of__num__primitive__def,axiom,(
    c_2Erat_2Erat__of__num = ap(ap(c_2Erelation_2EWFREC(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emin_2E_40(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool))),f2860)),f2862) )).

tff(conj_thm_2Erat_2Erat__of__num__ind,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Erat_2ERAT__ADD__CALCULATE,lemma,(
...
tff(conj_thm_2Erat_2ERAT__OF__NUM__CALCULATE,conjecture,(
