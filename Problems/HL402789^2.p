...
thf(conj_thm_2Elist_2ENULL,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Erich__list_2ETL__SNOC,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( c_2Elist_2ETL @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V0x ) @ V1l ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V1l ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V0x ) @ ( ap @ ( c_2Elist_2ETL @ A_27a ) @ V1l ) ) ) ) ) ) )).
