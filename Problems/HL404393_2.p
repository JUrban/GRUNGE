...
tff(conj_thm_2Ecardinal_2EEMPTY__CARDLEQ,lemma,(
    ! [A_27a: del,A_27b: del,V0t: $i] :
...
tff(conj_thm_2Ecardinal_2EEMPTY__set__exp,lemma,(
...
tff(conj_thm_2Ecardinal_2Eexp__count__cardeq,lemma,(
    ! [A_27a: del,V0A: $i] :
...
tff(conj_thm_2Ecardinal_2EINFINITE__Unum,lemma,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0A))
      <=> p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),V0A)) ) ) )).

tff(conj_thm_2Ecardinal_2EINFINITE__cardleq__INSERT,lemma,(
    ! [A_27a: del,A_27b: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27b)
         => ! [V2s: $i] :
             ...
             => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0A))
               => ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),ap(ap(c_2Epred__set_2EINSERT(A_27b),V1x),V2s)),V0A))
                <=> p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V2s),V0A)) ) ) ) ) ) )).

tff(lmtp_f1861,type,(
    f1861: ( del * $i ) > $i )).

tff(lamtp_f1861,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
...
tff(lameq_f1861,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f1861(A_27a,V0A),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ecardinal_2Eset__exp(ty_2Enum_2Enum,ty_2Enum_2Enum),V0A),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1n))) ) )).

tff(conj_thm_2Ecardinal_2Elist__BIGUNION__EXP,lemma,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2EINFINITE__A__list__BIJ__A,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0A))
