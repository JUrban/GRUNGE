...
tff(conj_thm_2Earithmetic_2ENOT__GREATER__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Epred__set_2ECARD__EQ__0,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(mem_c_2Econtainer_2EBAG__OF__FMAP,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Econtainer_2EBAG__OF__FMAP(A_27a,A_27a,A_27a),arr(arr(A_27b,arr(A_27c,A_27a)),arr(ty_2Efinite__map_2Efmap(A_27b,A_27b),arr(A_27a,ty_2Enum_2Enum)))) )).

tff(lmtp_f2096,type,(
    f2096: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2096,axiom,(
    ! [A_27c: del,A_27a: del,A_27b: del,V2x: $i] :
      ( mem(V2x,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27b,arr(A_27c,A_27a)))
         => ! [V1b: $i] :
              ( mem(V1b,ty_2Efinite__map_2Efmap(A_27b,A_27b))
             => mem(f2096(A_27c,A_27a,A_27b,V2x,V0f,V1b),arr(A_27b,bool)) ) ) ) )).
    ...
    ! [A_27c: del,A_27a: del,A_27b: del,V2x: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V3k: $i] :
                  ( mem(V3k,A_27b)
                 => ap(f2096(A_27c,A_27a,A_27b,V2x,V0f,V1b),V3k) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27b),V3k),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V1b))),ap(ap(c_2Emin_2E_3D(A_27a),V2x),ap(ap(V0f,V3k),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V1b),V3k)))) ) ) ) ) )).

tff(lmtp_f2095,type,(
    f2095: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f2095,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V1b: $i] :
      ( mem(V1b,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27b,arr(A_27c,A_27a)))
         => mem(f2095(A_27b,A_27c,A_27a,V1b,V0f),arr(A_27a,ty_2Enum_2Enum)) ) ) )).
...
tff(lameq_f2095,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V1b: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f2095(A_27b,A_27c,A_27a,V1b,V0f),V2x) = ap(c_2Epred__set_2ECARD(A_27b),f2096(A_27c,A_27a,A_27b,V2x,V0f,V1b)) ) ) ) )).
...
tff(ax_thm_2Econtainer_2EBAG__OF__FMAP__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efinite__map_2Efmap(A_27b,A_27b))
         => ap(ap(c_2Econtainer_2EBAG__OF__FMAP(A_27a,A_27a,A_27a),V0f),V1b) = f2095(A_27b,A_27c,A_27a,V1b,V0f) ) ) )).

tff(conj_thm_2Econtainer_2EBAG__IN__BAG__OF__FMAP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,arr(A_27c,A_27a)))
         => ! [V2b: $i] :
              ( mem(V2b,ty_2Efinite__map_2Efmap(A_27b,A_27b))
             => ( p(ap(ap(c_2Ebag_2EBAG__IN(A_27a),V0x),ap(ap(c_2Econtainer_2EBAG__OF__FMAP(A_27a,A_27a,A_27a),V1f),V2b)))
              <=> ? [V3k: $i] :
                    ( mem(V3k,A_27b)
                    & p(ap(ap(c_2Ebool_2EIN(A_27b),V3k),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V2b)))
                    & V0x = ap(ap(V1f,V3k),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V2b),V3k)) ) ) ) ) ) )).
