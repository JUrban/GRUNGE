...
thf(ax_thm_2Eordinal_2EordSUC__def,axiom,(
    ! [A_27a: del,V0a: $i] :
     ...
     => ( ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ V0a )
        = ( ap @ ( c_2Eordinal_2Eoleast @ A_27a )
          @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
            @ ^ [V1b: $i] :
                ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V0a ) @ V1b ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2Eno__maximal__ordinal,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ? [V1b: $i] :
...
thf(conj_thm_2Eordinal_2Eordlt__SUC,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
