...
tff(thm_2Etoto_2EStrongLinearOrderExists,axiom,(
    ! [A_27a: d] :
...
tff(thm_2Etoto_2ETO__exists,conjecture,(
    ! [A_27a: d] :
    ? [V0x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Etoto_2ETotOrd_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2EternaryComparisons_2Eordering)),V0x_2E0))))) )).
