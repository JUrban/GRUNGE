...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__SELF,axiom,(
      ...
      ( ( ( c_2Ereal__topology_2Elinear @ V0f )
        & ! [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V2x )
              = ( V0f @ V3y ) )
           => ( V2x = V3y ) ) )
     => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) @ V1s ) ) )).
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__LEFT__EQ,conjecture,(
