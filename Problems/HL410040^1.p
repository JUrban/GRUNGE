...
thf(f12157_0_2E0,type,(
    f12157_0_2E0: u )).

thf(f12157_0_2E2,type,(
    f12157_0_2E2: du > du > u )).

thf(f12157_0_2E3,type,(
    f12157_0_2E3: du > du > du > u )).

thf(f12158_0_2E0,type,(
    f12158_0_2E0: u )).

thf(f12158_0_2E2,type,(
    f12158_0_2E2: du > du > u )).

thf(f12158_0_2E3,type,(
...
thf(mono_2Ef12158_0,type,(
    mono_2Ef12158_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq2_2Emono_2Ef12157_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f12157_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef12157_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12157_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(def0_2Ethm_2Eproduct_2ENPRODUCT__MUL,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1g_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12157_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
      = ( mono_2Ec_2Earithmetic_2E_2A @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eproduct_2ENPRODUCT__MUL,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1g_2E0: u,V2s_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Eproduct_2Enproduct_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f12157_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1g_2E0 ) ) ) ) ) )
...
thf(def0_2Ethm_2Eproduct_2ENPRODUCT__MUL__NUMSEG,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V4x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12158_0 @ V0f @ V1g @ V4x )
      = ( mono_2Ec_2Earithmetic_2E_2A @ ( V0f @ V4x ) @ ( V1g @ V4x ) ) ) )).

thf(thm_2Eproduct_2ENPRODUCT__MUL__NUMSEG,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eproduct_2Enproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ ( mono_2Ef12158_0 @ V0f @ V1g ) )
      = ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Eproduct_2Enproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V0f ) @ ( mono_2Ec_2Eproduct_2Enproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V1g ) ) ) )).
