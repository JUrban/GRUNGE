...
fof(conj_thm_2Ellist_2ELDROP__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ellist_2ELNTH__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ! [V2ll] :
                 ...
                 => ap(ap(c_2Ellist_2ELNTH(A_27a),ap(ap(c_2Earithmetic_2E_2B,V0a),V1b)),V2ll) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27a,A_27a),ap(ap(c_2Ellist_2ELDROP(A_27a),V0a),V2ll)),ap(c_2Ellist_2ELNTH(A_27a),V1b)) ) ) ) ) )).
