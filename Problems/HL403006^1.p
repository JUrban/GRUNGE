...
thf(f3563_0_2E0,type,(
    f3563_0_2E0: u )).

thf(f3563_0_2E1,type,(
    f3563_0_2E1: du > u )).

thf(f3563_0_2E2,type,(
    f3563_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef3563_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( f3563_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) ) @ f3563_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef3563_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3563_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X1_2E0 ) ) ) )
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW__COND__NOT__EX__OR__EQ_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW__COND__NOT__EX__OR__EQ_2E3_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__ROW__COND__NOT__EX__OR__EQ__def,axiom,(
    ! [A_27a: d,A_27b: d,V0i_2E0: u,V3row_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3563_0_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ V3row_2E0 ) ) ) )
    <=> ( (~)
    ...
    <=> ( ( (~)
          @ ( (~)
            @ ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ V1r_2E0 ) @ ( s @ A_27a @ V0i_2E0 ) ) )
              = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ c_2Eoption_2ENONE_2E0 ) ) ) )
        | ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EEXISTS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( f3563_0_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V2rows_2E0 ) ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__PRED__UNROLL__CONS,conjecture,(
