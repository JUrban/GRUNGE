...
thf(thm_2Ebag_2EBAG__INN__0,axiom,(
    ! [A_27a: d,V0b_2E0: u,V1e_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INN__BAG__UNION,axiom,(
    ...
    <=> ? [V4m1: mono_2Etyop_2Enum_2Enum,V5m2: mono_2Etyop_2Enum_2Enum] :
          ( ( V0n
            = ( mono_2Ec_2Earithmetic_2E_2B @ V4m1 @ V5m2 ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4m1 ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2b1_2E0 ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5m2 ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3b2_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,conjecture,(
    ! [A_27a: d,V0b_2E0: u,V1e_2E0: u,V2s_2E0: u] :
      ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) )
    ...
    <=> ? [V3b0_2E0: u,V4eb_2E0: u] :
          ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 )
            = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__UNION_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V4eb_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3b0_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 )
            = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ebag_2ESET__OF__BAG_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3b0_2E0 ) ) ) )
          & ! [V5e_27_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__IN_2E2 @ ( s @ A_27a @ V5e_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V4eb_2E0 ) ) ) )
             => ( ( s @ A_27a @ V5e_27_2E0 )
                = ( s @ A_27a @ V1e_2E0 ) ) )
          & ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__IN_2E2 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V4eb_2E0 ) ) ) ) ) ) ) )).
