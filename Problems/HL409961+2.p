...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__CROSS__SYM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1s1] :
                 ...
                 => ! [V2s2] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s1))
                       ...
                       => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f3461(A_27b,A_27a,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V1s1),V2s2)) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Epair_2EUNCURRY(A_27b,A_27b,A_27b),f3463(A_27a,A_27b,V0f))),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V2s2),V1s1)) ) ) ) ) ) ) )).
