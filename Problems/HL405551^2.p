...
thf(ax_thm_2Eordinal_2EallOrds__def,axiom,(
    ! [A_27a: del] :
      ( ( c_2Eordinal_2EallOrds @ A_27a )
      = ( ap @ ( c_2Ewellorder_2Ewellorder__ABS @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2Ewellorder__allOrds,lemma,(
    ! [A_27a: del] :
      ( p
...
thf(conj_thm_2Eordinal_2EelsOf__allOrds,conjecture,(
    ! [A_27a: del] :
