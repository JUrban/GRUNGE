...
thf(c_2Erelation_2EINVOL_2E0,type,(
    c_2Erelation_2EINVOL_2E0: u )).

thf(c_2Erelation_2EINVOL_2E1,type,(
    c_2Erelation_2EINVOL_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Erelation_2EINVOL_2E1_2Emono_2EA_27z,axiom,(
    ! [A_27z: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EINVOL_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ tyop_2Emin_2Ebool ) @ c_2Erelation_2EINVOL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X0_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ecombin_2Eo_2E2_2Emono_2EA_27z_20mono_2EA_27z_20mono_2EA_27z,axiom,(
    ! [A_27z: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) ) ) @ c_2Ecombin_2Eo_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Erelation_2EINVOL__DEF,axiom,(
    ! [A_27z: d,V0f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EINVOL_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ V0f_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ V0f_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ c_2Ecombin_2EI_2E0 ) ) ) )).

thf(thm_2Erelation_2EINVOL,conjecture,(
    ! [A_27z: d,V0f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EINVOL_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27z @ A_27z ) @ V0f_2E0 ) ) ) )
    <=> ! [V1x_2E0: u] :
