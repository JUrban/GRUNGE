...
thf(f2925_0_2E0,type,(
    f2925_0_2E0: u )).

thf(f2925_0_2E1,type,(
    f2925_0_2E1: du > u )).
...
thf(def0_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__NEG,axiom,(
    ! [V2P: $o] :
      ( ( mono_2Ef2925_0 @ V2P )
    <=> ( (~) @ V2P ) ) )).

thf(thm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__NEG,conjecture,(
    ! [A_27a: d,V0v_2E0: u,V1i_2E0: u,V2P: $o] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__EXISTS_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V2P ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2925_0 @ V2P ) ) ) ) ) ) ) )).
