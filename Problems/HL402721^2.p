...
thf(conj_thm_2Erich__list_2EFCOMM__FOLDR__FLAT,conjecture,(
    ! [A_27a: del,A_27b: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27b @ ( arr @ A_27a @ A_27a ) ) )
           ...
           => ! [V2e: $i] :
               ...
               => ( ( p @ ( ap @ ( ap @ ( c_2Ecombin_2ELEFT__ID @ A_27a @ A_27a ) @ V0g ) @ V2e ) )
                 => ! [V3l: $i] :
                     ...
                     => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27b @ A_27a ) @ V1f ) @ V2e ) @ ( ap @ ( c_2Elist_2EFLAT @ A_27b ) @ V3l ) )
                        = ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27a ) @ V0g ) @ V2e ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Elist_2Elist @ A_27b ) @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27b @ A_27a ) @ V1f ) @ V2e ) ) @ V3l ) ) ) ) ) ) ) ) ) )).
