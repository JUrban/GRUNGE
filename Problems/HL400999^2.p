...
thf(tp_c_2Earithmetic_2ENRC,type,(
    c_2Earithmetic_2ENRC: del > $i )).

thf(mem_c_2Earithmetic_2ENRC,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Earithmetic_2ENRC,axiom,(
    ! [A_27a: del] :
      ( ! [V0R: $i] :
...
thf(conj_thm_2Earithmetic_2ERTC__eq__NRC,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2y: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ERTC @ A_27a ) @ V0R ) @ V1x ) @ V2y ) )
              <=> ? [V3n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2ENRC @ A_27a ) @ V0R ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ V1x ) @ V2y ) ) ) ) ) ) )).
...
thf(conj_thm_2Erelation_2EEXTEND__RTC__TC__EQN,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Earithmetic_2ETC__eq__NRC,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2y: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ETC @ A_27a ) @ V0R ) @ V1x ) @ V2y ) )
              <=> ? [V3n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2ENRC @ A_27a ) @ V0R ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V1x ) @ V2y ) ) ) ) ) ) )).
