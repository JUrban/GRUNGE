...
thf(conj_thm_2Ewellorder_2EfromNatWO__11,conjecture,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum,V1j: tp__ty_2Enum_2Enum] :
      ( ( ( ap @ ( c_2Ewellorder_2EfromNatWO @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0i ) )
        = ( ap @ ( c_2Ewellorder_2EfromNatWO @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1j ) ) )
    <=> ( V0i = V1j ) ) )).
