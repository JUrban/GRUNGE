...
thf(f8852_0_2E0,type,(
    f8852_0_2E0: u )).

thf(f8852_0_2E1,type,(
    f8852_0_2E1: du > u )).

thf(f8852_0_2E2,type,(
    f8852_0_2E2: du > du > u )).
...
thf(mono_2Ef8852_0,type,(
    mono_2Ef8852_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal_2EREAL__SUP__EXISTS__UNIQUE,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o,V4s: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8852_0 @ V0p @ V4s )
...
thf(thm_2Ereal_2EREAL__SUP__EXISTS__UNIQUE,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ? [V1x: mono_2Etyop_2Erealax_2Ereal] :
            ( V0p @ V1x )
        & ? [V2z: mono_2Etyop_2Erealax_2Ereal] :
          ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( V0p @ V3x )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V2z ) ) )
     => ( mono_2Ec_2Ebool_2E_3F_21_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef8852_0 @ V0p ) ) ) )).
