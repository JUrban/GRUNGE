...
tff(conj_thm_2Ereal_2EREAL__POW__INV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Epow,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x))),inj__ty_2Enum_2Enum(V1n))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Enum_2Enum(V1n)))) )).
...
tff(conj_thm_2Eiterate_2ESUM__POS__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
...
tff(conj_thm_2Eiterate_2ESUM__SUBSET,lemma,(
    ! [A_27a: del,V0u: $i] :
...
tff(conj_thm_2Eiterate_2ESUM__TRIV__NUMSEG,lemma,(
    ! [V0f: $i] :
...
tff(lmtp_f3390,type,(
    f3390: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3390,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3390(V0p,V1f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3390,axiom,(
    ! [V0p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V4i: tp__ty_2Enum_2Enum] : ap(f3390(V0p,V1f),inj__ty_2Enum_2Enum(V4i)) = ap(V1f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4i)),inj__ty_2Enum_2Enum(V0p))) ) )).

tff(conj_thm_2Eiterate_2ESUM__OFFSET,lemma,(
    ! [V0p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V0p))),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V0p)))),V1f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f3390(V0p,V1f))) ) )).
...
tff(conj_thm_2Ereal__topology_2ELE__ADD,lemma,(
...
tff(conj_thm_2Ereal__topology_2EADD__SUB2,lemma,(
...
tff(conj_thm_2Ereal__topology_2EREAL__POW__1__LE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EREAL__POW__LE__1,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal__topology_2EREAL__INV__1__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
...
tff(conj_thm_2Ereal__topology_2EFINITE__INTER__NUMSEG,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V0s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))))) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__0,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => p(ap(ap(ap(c_2Ereal__topology_2Esums,k(ty_2Enum_2Enum,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0s)) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__CAUCHY,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( ? [V2l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V2l)),V1s))
          <=> ! [V3e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V4N: tp__ty_2Enum_2Enum] :
                  ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V4N)))
                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V6n)))),V0f))),inj__ty_2Erealax_2Ereal(V3e))) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__COMPARISON,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ? [V3l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),inj__ty_2Erealax_2Ereal(V3l)),V2s))
                  & ? [V4N: tp__ty_2Enum_2Enum] :
                    ! [V5n: tp__ty_2Enum_2Enum] :
                      ( ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V5n)),inj__ty_2Enum_2Enum(V4N)))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5n)),V2s)) )
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V5n)))),ap(V1g,inj__ty_2Enum_2Enum(V5n)))) ) )
               => ? [V6l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V6l)),V2s)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__RATIO,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1a: $i] :
      ( mem(V1a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(ty_2Enum_2Enum,bool))
         => ! [V3N: tp__ty_2Enum_2Enum] :
              ( ( p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0c)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
                & ! [V4n: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V4n)),inj__ty_2Enum_2Enum(V3N)))
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1a,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V4n))))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0c)),ap(c_2Ereal_2Eabs,ap(V1a,inj__ty_2Enum_2Enum(V4n)))))) ) )
             => ? [V5l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2Esums,V1a),inj__ty_2Erealax_2Ereal(V5l)),V2s)) ) ) ) )).
