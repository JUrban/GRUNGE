    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1g: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ! [V3x: A_27a] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0f @ V3x ) ) @ ( V1g @ V3x ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V0f ) ) @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1g ) ) ) )).

thf(thm_2Eiterate_2ESUM__SING__NUMSEG,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1n @ V1n ) @ V0f )
      = ( V0f @ V1n ) ) )).
...
thf(thm_2Ereal__topology_2EBILINEAR__BOUNDED,conjecture,(
