...
thf(thm_2Einteger_2EINT__EXP__EQ0,axiom,(
    ! [V0p: tyop_2Einteger_2Eint,V1n: tyop_2Enum_2Enum] :
      ( ( ( c_2Einteger_2Eint__exp @ V0p @ V1n )
        = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) )
    <=> ( ( V0p
          = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) )
        & ( (~) @ ( V1n = c_2Enum_2E0 ) ) ) ) )).
    ...
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Einteger_2Eint] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ V1n @ V0m )
        & ( (~)
          @ ( V2p
            = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) )
     => ( ( c_2Einteger_2Eint__mod @ ( c_2Einteger_2Eint__exp @ V2p @ V0m ) @ ( c_2Einteger_2Eint__exp @ V2p @ V1n ) )
        = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) )).
    ...
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Einteger_2Eint] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ V1n @ V0m )
        & ( (~)
          @ ( V2p
            = ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) )
     => ( ( c_2Einteger_2Eint__div @ ( c_2Einteger_2Eint__exp @ V2p @ V0m ) @ ( c_2Einteger_2Eint__exp @ V2p @ V1n ) )
        = ( c_2Einteger_2Eint__exp @ V2p @ ( c_2Earithmetic_2E_2D @ V0m @ V1n ) ) ) ) )).
