...
tff(conj_thm_2Efcp_2EFCP__UNIQUE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,A_27a))
         => ( ! [V2i: tp__ty_2Enum_2Enum] :
                ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
               => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0f),inj__ty_2Enum_2Enum(V2i)) = ap(V1g,inj__ty_2Enum_2Enum(V2i)) )
          <=> ap(c_2Efcp_2EFCP(A_27a,A_27a),V1g) = V0f ) ) ) )).
