...
tff(conj_thm_2Emeasure_2EUNIV__SIGMA__ALGEBRA,conjecture,(
    ! [A_27a: del] : p(ap(c_2Emeasure_2Esigma__algebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(arr(A_27a,bool))))) )).
