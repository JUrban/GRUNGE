...
thf(f2876_0_2E0,type,(
    f2876_0_2E0: u )).

thf(f2876_0_2E2,type,(
    f2876_0_2E2: du > du > u )).

thf(f2876_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef2876_0_2E2_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f2876_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef2876_0_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2876_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) ) )
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__EQUATION__FORALL__POINT,axiom,(
    ! [A_27b: d,A_27c: d,V1P_2E0: u,V2Q_2E0: u,V4x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2876_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V1P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V2Q_2E0 ) @ ( s @ A_27b @ V4x_2E0 ) ) ) )
    <=> ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V1P_2E0 ) @ ( s @ A_27b @ V4x_2E0 ) ) )
        = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V2Q_2E0 ) @ ( s @ A_27b @ V4x_2E0 ) ) ) ) ) )).
...
thf(thm_2EquantHeuristics_2EGUESS__RULES__EQUATION__FORALL__POINT,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0i_2E0: u,V1P_2E0: u,V2Q_2E0: u] :
      ( ! [V3fv_2E0: u] :
          ( (~)
          @ ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V1P_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0i_2E0 ) @ ( s @ A_27a @ V3fv_2E0 ) ) ) ) )
            = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V2Q_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0i_2E0 ) @ ( s @ A_27a @ V3fv_2E0 ) ) ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0i_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( f2876_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V1P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ V2Q_2E0 ) ) ) ) ) ) ) )).
