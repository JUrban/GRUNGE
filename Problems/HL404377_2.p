...
tff(conj_thm_2Ecardinal_2EEMPTY__set__exp__CARD,conjecture,(
    ! [A_27a: del,A_27b: del,V0A: $i] :
      ( mem(V0A,arr(A_27b,bool))
     => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,ty_2Eoption_2Eoption(A_27b)),arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),V0A),c_2Epred__set_2EEMPTY(A_27a))),ap(c_2Epred__set_2Ecount,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) )).
