    ...
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
             ...
             => mem(f3628(V1t,V0s,V2x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
             ...
             => ! [V3y] :
                 ...
                 => ap(f3628(V1t,V0s,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V2x),V3y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V1t))) ) ) ) ) )).

fof(lamtp_f3627,axiom,(
    ! [V1t] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3627(V1t,V0s),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).
...
fof(lameq_f3627,axiom,(
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => ap(f3627(V1t,V0s),V2x) = f3628(V1t,V0s,V2x) ) ) ) )).

fof(lamtp_f3630,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4y] :
             ...
             => mem(f3630(V0s,V1t,V4y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).
     ...
     => ! [V1t] :
         ...
         => ! [V4y] :
             ...
             => ! [V5x] :
                 ...
                 => ap(f3630(V0s,V1t,V4y),V5x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V4y),V5x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V0s))) ) ) ) ) )).

fof(lamtp_f3629,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3629(V0s,V1t),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).
...
fof(lameq_f3629,axiom,(
    ! [V0s] :
     ...
     => ! [V1t] :
         ...
         => ! [V4y] :
              ( mem(V4y,ty_2Erealax_2Ereal)
             => ap(f3629(V0s,V1t),V4y) = f3630(V0s,V1t,V4y) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUMS__SYM,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3627(V1t,V0s))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3629(V0s,V1t))) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ELIM__ADD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
                 ...
                 => ! [V3l] :
                     ...
                     => ! [V4m] :
                         ...
                         => ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),V3l),V0net))
                           ...
                           => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3744(A_27a,V1f,V2g)),ap(ap(c_2Erealax_2Ereal__add,V3l),V4m)),V0net)) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECLOSURE__SEQUENTIAL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1l] :
    ...
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V4x] :
             ...
             => mem(f3955(V1t,V0s,V4x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f3955,axiom,(
    ! [V1t] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x] :
             ...
             => ! [V5y] :
                 ...
                 => ap(f3955(V1t,V0s,V4x),V5y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V4x),V5y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),ap(c_2Ereal__topology_2Eclosure,V0s))),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),ap(c_2Ereal__topology_2Eclosure,V1t)))) ) ) ) ) )).

fof(lamtp_f3954,axiom,(
    ! [V1t] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3954(V1t,V0s),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).

fof(lameq_f3954,axiom,(
    ! [V1t] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x] :
              ( mem(V4x,ty_2Erealax_2Ereal)
             => ap(f3954(V1t,V0s),V4x) = f3955(V1t,V0s,V4x) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSURE__SUMS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
           ...
           => ap(c_2Ereal__topology_2Eclosure,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3627(V1t,V0s)))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3954(V1t,V0s))) ) ) ) )).
