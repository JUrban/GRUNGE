...
fof(conj_thm_2Ereal__topology_2ELINEAR__OPEN__MAPPING,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
              ...
              & ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1g) = c_2Ecombin_2EI(ty_2Erealax_2Ereal) )
           => ! [V2s] :
                ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
               => ( p(ap(c_2Ereal__topology_2EOpen,V2s))
                 => p(ap(c_2Ereal__topology_2EOpen,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s))) ) ) ) ) ) )).
