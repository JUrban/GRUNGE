    ...
    ! [V0p] :
     ...
     => ! [V1f] :
         ...
         => ! [V4i] :
             ...
             => ap(f3390(V0p,V1f),V4i) = ap(V1f,ap(ap(c_2Earithmetic_2E_2B,V4i),V0p)) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__OFFSET,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Enum_2Enum)
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,V2m),V0p)),ap(ap(c_2Earithmetic_2E_2B,V3n),V0p))),V1f) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),f3390(V0p,V1f)) ) ) ) ) )).
...
fof(conj_thm_2Eiterate_2ESUM__OFFSET__0,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
