...
tff(conj_thm_2Esptree_2Elookup__inter__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: tp__ty_2Enum_2Enum,V1t1: $i] :
     ...
     => ! [V2t2: $i] :
         ...
         => ! [V3y: $i] :
              ( mem(V3y,A_27a)
             => ( ( ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V0x)),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V1t1),V2t2)) = ap(c_2Eoption_2ESOME(A_27a),V3y)
                ...
                & ( ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V0x)),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V1t1),V2t2)) = c_2Eoption_2ENONE(A_27a)
