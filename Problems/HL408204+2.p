...
fof(conj_thm_2Ereal_2EREAL__EQ__MUL__LCANCEL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Epoly_2EPOLY__CMUL,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1c] :
...
fof(conj_thm_2Epoly_2EPOLY__NEG,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Epoly_2EPOLY__DIFF__MUL,lemma,(
    ! [V0p1] :
      ( mem(V0p1,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1p2] :
          ( mem(V1p2,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
...
fof(conj_thm_2Epoly_2EPOLY__DIFF__EXP__PRIME,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1a] :
...
fof(conj_thm_2Epoly_2EPOLY__MUL__LCANCEL,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1q] :
...
fof(conj_thm_2Epoly_2EPOLY__EXP__PRIME__EQ__0,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Epoly_2EORDER__UNIQUE,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Epoly_2EORDER__DECOMP,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Epoly_2EORDER__DIFF,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
