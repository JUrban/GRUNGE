...
thf(thm_2Elist_2Elist__size__cong,conjecture,(
    ! [A_27a: d,V0M_2E0: u,V1N_2E0: u,V2f_2E0: u,V3f_27_2E0: u] :
      ( ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0M_2E0 )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1N_2E0 ) )
        & ! [V4x_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1N_2E0 ) ) ) ) ) )
           => ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
              = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3f_27_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) ) )
     => ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2Elist__size_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0M_2E0 ) ) ) )
        = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2Elist__size_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3f_27_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1N_2E0 ) ) ) ) ) ) )).
