...
tff(conj_thm_2Ereal_2EREAL__NEG__RMUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V1y)))) )).
...
tff(conj_thm_2Ereal_2EREAL__LE__LADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__LE__RADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__LE__ADD2,lemma,(
    ! [V0w: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0w)),inj__ty_2Erealax_2Ereal(V1x)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V3z))) )
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0w)),inj__ty_2Erealax_2Ereal(V2y))),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V3z)))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__SUB__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__SUB__RDISTRIB,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))),inj__ty_2Erealax_2Ereal(V2z))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V2z))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1y)),inj__ty_2Erealax_2Ereal(V2z)))) )).
...
tff(conj_thm_2Ereal_2EREAL__INV__POS,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__LT__RMUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__LT__HALF2,lemma,(
    ! [V0d: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V0d)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0d)))
    <=> p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0d))) ) )).
...
tff(lameq_f2735,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f2735(V0f,V1g),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Enum_2Enum(V4n))),ap(V1g,inj__ty_2Enum_2Enum(V4n))) ) ) )).

tff(conj_thm_2Ereal_2ESUM__SUB,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f2735(V0f,V1g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V0f)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),V1g))) ) ) )).

tff(lmtp_f2742,type,(
    f2742: $i > $i )).

tff(lamtp_f2742,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2742(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2742,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f2742(V0f),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))),ap(V0f,inj__ty_2Enum_2Enum(V3n))) ) )).

tff(conj_thm_2Ereal_2ESUM__CANCEL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum,V2d: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2d))),f2742(V0f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2d)))),ap(V0f,inj__ty_2Enum_2Enum(V1n)))) ) )).
...
tff(conj_thm_2Elim_2ELIM,lemma,(
    ! [V0f: $i] :
...
tff(lmtp_f2904,type,(
    f2904: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2904,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : mem(f2904(V0f,V2x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2904,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x: tp__ty_2Erealax_2Ereal,V3h: tp__ty_2Erealax_2Ereal] : ap(f2904(V0f,V2x),inj__ty_2Erealax_2Ereal(V3h)) = ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3h)))),ap(V0f,inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V3h)) ) )).
...
tff(ax_thm_2Elim_2Ediffl,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
        ...
        <=> p(ap(ap(ap(c_2Elim_2Etends__real__real,f2904(V0f,V2x)),inj__ty_2Erealax_2Ereal(V1l)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).
...
tff(lameq_f2993,axiom,(
    ! [V1p: $i] :
     ...
     => ! [V2f: $i] :
         ...
         => ! [V0D: $i] :
              ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
             => ! [V3n: tp__ty_2Enum_2Enum] : ap(f2993(V1p,V2f,V0D),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2f,ap(V1p,inj__ty_2Enum_2Enum(V3n)))),ap(ap(c_2Ereal_2Ereal__sub,ap(V0D,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))),ap(V0D,inj__ty_2Enum_2Enum(V3n)))) ) ) ) )).

tff(ax_thm_2Etransc_2Ersum,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
          ( mem(V1p,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2f: $i] :
              ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V0D),V1p)),V2f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Etransc_2Edsize,V0D))),f2993(V1p,V2f,V0D))) ) ) ) )).

tff(lmtp_f2994,type,(
    f2994: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2994,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : mem(f2994(V0a,V1b),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2994,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V6x: tp__ty_2Erealax_2Ereal] : ap(f2994(V0a,V1b),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V6x))),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V6x)),inj__ty_2Erealax_2Ereal(V1b))) )).

tff(ax_thm_2Etransc_2EDint,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3k: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2f),inj__ty_2Erealax_2Ereal(V3k)))
             ...
             => ? [V5g: $i] :
                  ...
                  & ! [V7D: $i] :
                     ...
                     => ! [V8p: $i] :
                         ...
                         => ( ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V7D),V8p)))
                           ...
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V7D),V8p)),V2f)),inj__ty_2Erealax_2Ereal(V3k)))),inj__ty_2Erealax_2Ereal(V4e))) ) ) ) ) ) ) ) )).

tff(conj_thm_2Etransc_2EDIVISION__LHS,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => surj__ty_2Erealax_2Ereal(ap(V0D,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = V1a ) ) )).

tff(conj_thm_2Etransc_2EDIVISION__RHS,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0D))
         => surj__ty_2Erealax_2Ereal(ap(V0D,ap(c_2Etransc_2Edsize,V0D))) = V2b ) ) )).

tff(conj_thm_2Etransc_2EDIVISION__LBOUND,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0D))
         => ! [V3r: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),ap(V0D,inj__ty_2Enum_2Enum(V3r)))) ) ) )).

tff(conj_thm_2Etransc_2EDIVISION__UBOUND,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0D))
         => ! [V3r: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0D,inj__ty_2Enum_2Enum(V3r))),inj__ty_2Erealax_2Ereal(V2b))) ) ) )).

tff(conj_thm_2Etransc_2EINTEGRAL__NULL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V1a))),V0f),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) )).

tff(conj_thm_2Etransc_2EFTC1,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1f_27: $i] :
          ( mem(V1f_27,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b)))
                & ! [V4x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(ap(c_2Elim_2Ediffl,V0f),ap(V1f_27,inj__ty_2Erealax_2Ereal(V4x))),inj__ty_2Erealax_2Ereal(V4x))) ) )
             => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V1f_27),ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V3b))),ap(V0f,inj__ty_2Erealax_2Ereal(V2a))))) ) ) ) )).
