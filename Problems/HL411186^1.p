...
thf(f13911_0_2E0,type,(
    f13911_0_2E0: u )).

thf(f13911_0_2E2,type,(
    f13911_0_2E2: du > du > u )).

thf(f13911_0_2E3,type,(
    f13911_0_2E3: du > du > du > u )).

thf(f13914_0_2E0,type,(
    f13914_0_2E0: u )).

thf(f13914_0_2E2,type,(
    f13914_0_2E2: du > du > u )).

thf(f13914_0_2E3,type,(
    f13914_0_2E3: du > du > du > u )).

thf(f13914_1_2E0,type,(
    f13914_1_2E0: u )).

thf(f13914_1_2E3,type,(
    f13914_1_2E3: du > du > du > u )).

thf(f13914_1_2E4,type,(
    f13914_1_2E4: du > du > du > du > u )).
...
thf(mono_2Ef13911_0,type,(
    mono_2Ef13911_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13914_0,type,(
    mono_2Ef13914_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13914_1,type,(
    mono_2Ef13914_1: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SEQUENTIALLY,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V7n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef13914_1 @ V0f @ V2x @ V3y @ V7n )
      = ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ ( V2x @ V7n ) ) @ ( V0f @ ( V3y @ V7n ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SEQUENTIALLY,axiom,(
    ! [V2x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V6n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef13914_0 @ V2x @ V3y @ V6n )
      = ( mono_2Ec_2Ereal_2Ereal__sub @ ( V2x @ V6n ) @ ( V3y @ V6n ) ) ) )).

thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SEQUENTIALLY,axiom,(
    ...
    <=> ! [V2x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
          ( ( ! [V4n: mono_2Etyop_2Enum_2Enum] :
                ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V2x @ V4n ) @ V1s )
            & ! [V5n: mono_2Etyop_2Enum_2Enum] :
                ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V3y @ V5n ) @ V1s )
            & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef13914_0 @ V2x @ V3y ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ mono_2Ec_2Ereal__topology_2Esequentially ) )
         => ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef13914_1 @ V0f @ V2x @ V3y ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ mono_2Ec_2Ereal__topology_2Esequentially ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ADD,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13911_0 @ V0f @ V1g @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V0f @ V3x ) @ ( V1g @ V3x ) ) ) )).

thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ADD,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V2s )
        & ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ V1g @ V2s ) )
     => ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ ( mono_2Ef13911_0 @ V0f @ V1g ) @ V2s ) ) )).
