...
tff(ax_thm_2Epath_2Epath__absrep__bijections,axiom,(
    ! [A_27a: del,A_27b: del] :
      ...
      & ! [V1r: $i] :
         ...
         => ( p(ap(k(ty_2Epair_2Eprod(A_27a,A_27a),c_2Ebool_2ET),V1r))
          <=> ap(c_2Epath_2EfromPath(A_27a,A_27a),ap(c_2Epath_2EtoPath(A_27a,A_27a),V1r)) = V1r ) ) ) )).

tff(conj_thm_2Epath_2EfromPath__onto,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,ty_2Epair_2Eprod(A_27a,A_27a))
     => ? [V1a: $i] :
          ( mem(V1a,ty_2Epath_2Epath(A_27a,A_27a))
          & V0r = ap(c_2Epath_2EfromPath(A_27a,A_27a),V1a) ) ) )).
