...
fof(conj_thm_2Ereal__topology_2ELOCALLY__MONO,lemma,(
    ! [V0P] :
      ( mem(V0P,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1Q] :
         ...
         => ! [V2s] :
             ...
             => ( ( ! [V3t] :
                     ...
                     => ( p(ap(V0P,V3t))
                       => p(ap(V1Q,V3t)) ) )
                  & p(ap(ap(c_2Ereal__topology_2Elocally,V0P),V2s)) )
               => p(ap(ap(c_2Ereal__topology_2Elocally,V1Q),V2s)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELOCALLY__CLOSED,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2EClosed),V0s))
