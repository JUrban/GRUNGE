...
thf(f3728_0_2E0,type,(
    f3728_0_2E0: u )).

thf(f3728_0_2E2,type,(
    f3728_0_2E2: du > du > u )).

thf(f3728_0_2E3,type,(
...
thf(mono_2Ef3728_0,type,(
    mono_2Ef3728_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EIMP__NEXT,axiom,(
    ! [V1P: mono_2Etyop_2Enum_2Enum > $o,V0Q: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3728_0 @ V1P @ V0Q @ V3t )
    <=> ( ( V1P @ V3t )
       => ( V0Q @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EIMP__NEXT,conjecture,(
    ! [V0Q: mono_2Etyop_2Enum_2Enum > $o,V1P: mono_2Etyop_2Enum_2Enum > $o,V2x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2ETemporal__Logic_2ENEXT @ ( mono_2Ef3728_0 @ V1P @ V0Q ) @ V2x )
