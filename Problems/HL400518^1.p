...
thf(arityeq3_2Emono_2Ec_2Eoption_2EOPTION__MAP2_2E3_2Emono_2EA_27c_20mono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2EOPTION__MAP2_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X2_2E0 ) ) )
...
thf(thm_2Eoption_2EOPTION__MAP2__SOME,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u,V1o2_2E0: u,V2o1_2E0: u,V3f_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2EOPTION__MAP2_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V2o1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V1o2_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27c @ V0v_2E0 ) ) ) )
    <=> ? [V4x1_2E0: u,V5x2_2E0: u] :
          ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V2o1_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V4x1_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V1o2_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V5x2_2E0 ) ) ) )
          & ( ( s @ A_27c @ V0v_2E0 )
            = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V3f_2E0 ) @ ( s @ A_27a @ V4x1_2E0 ) ) ) @ ( s @ A_27b @ V5x2_2E0 ) ) ) ) ) ) )).
