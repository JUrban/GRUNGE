...
fof(lameq_f915,axiom,(
    ! [V0a] :
     ...
     => ! [V1t] :
         ...
         => ap(f915(V0a),V1t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f889(V0a)),V1t)) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EALWAYS__AS__SWHEN,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ap(c_2ETemporal__Logic_2EALWAYS,V0a) = f915(V0a) ) )).

fof(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__SWHEN,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ap(c_2ETemporal__Logic_2EEVENTUAL,V0a) = ap(ap(c_2ETemporal__Logic_2ESWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a) ) )).

fof(conj_thm_2ETemporal__Logic_2EWHEN__AS__NOT__SWHEN,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1337,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1337(V0a),V2t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f882(V0a)),V2t)) ) ) )).

fof(lamtp_f1338,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1338,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
         ...
         => ap(f1338(V0a),V5t) = ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a),V5t) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V7t] :
             ...
             => ap(f1339(V1b,V0a),V7t) = ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1b),f1340(V0a,V1b)),V7t) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V9t] :
             ...
             => ap(f1341(V0a,V1b),V9t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f1342(V1b)),f1329(V0a,V1b)),V9t)) ) ) ) )).

fof(lamtp_f1343,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V12t] :
             ...
             => ap(f1343(V0a,V1b),V12t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f1331(V0a)),V1b),V12t)) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V14t] :
             ...
             => ap(f1344(V0a,V1b),V14t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1b),f1345(V0a,V1b)),V14t)) ) ) ) )).

fof(lamtp_f1346,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V16t] :
             ...
             => ap(f1346(V1b,V0a),V16t) = ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f1320(V1b)),f1336(V0a,V1b)),V16t) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ESWHEN__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
