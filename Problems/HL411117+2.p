...
fof(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST,lemma,(
    ! [V0s] :
    ...
    ! [V0s] :
     ...
     => ! [V10t] :
         ...
         => ! [V11n] :
             ...
             => ap(f3819(V0s,V10t),V11n) = ap(ap(c_2Emin_2E_3D(arr(ty_2Erealax_2Ereal,bool)),V10t),ap(V0s,V11n)) ) ) ) )).

fof(lamtp_f3818,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => mem(f3818(V0s),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

fof(lameq_f3818,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V10t] :
          ( mem(V10t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST__SING,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
       ...
       => ? [V9a] :
            ( mem(V9a,ty_2Erealax_2Ereal)
            & ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3818(V0s))) = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V9a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) ) )).
