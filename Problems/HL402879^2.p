...
thf(conj_thm_2Elist_2ELIST__REL__LENGTH,lemma,(
...
thf(conj_thm_2Elist_2EDROP__LENGTH__TOO__LONG,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Elist_2EEVERY2__THM,lemma,(
...
thf(conj_thm_2Erich__list_2EEVERY2__APPEND,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27b @ bool ) ) )
     => ! [V1l1: $i] :
                 ...
                 => ! [V4l4: $i] :
                     ...
                     => ( ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2ELIST__REL @ A_27a @ A_27b ) @ V0R ) @ V1l1 ) @ V2l2 ) )
                      ...
                      <=> ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2ELIST__REL @ A_27a @ A_27b ) @ V0R ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V1l1 ) @ V3l3 ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27b ) @ V2l2 ) @ V4l4 ) ) )
                          ...
                          & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V3l3 ) )
                            = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27b ) @ V4l4 ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2EEVERY2__DROP,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27b @ bool ) ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
