...
tff(conj_thm_2Ebinary__ieee_2Efloat__round__bottom,conjecture,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1toneg: tp__o,V2r: tp__ty_2Erealax_2Ereal] :
      ( ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),inj__ty_2Erealax_2Ereal(V2r)) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))
     => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),inj__o(V1toneg)),inj__ty_2Erealax_2Ereal(V2r)) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) )).
