      ...
      ( ( ( c_2Ereal__topology_2Ebounded__def
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum
            @ ^ [V1n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( V0s @ V1n ) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V1n @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )
        & ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( V0s @ V2n ) @ ( V0s @ ( c_2Enum_2ESUC @ V2n ) ) ) )
     => ? [V3l: tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ V0s @ V3l @ c_2Ereal__topology_2Esequentially ) ) )).
      ...
      ( ( ( c_2Ereal__topology_2Ebounded__def
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum
            @ ^ [V1n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( V0s @ V1n ) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V1n @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )
        & ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( V0s @ ( c_2Enum_2ESUC @ V2n ) ) @ ( V0s @ V2n ) ) )
     => ? [V3l: tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ V0s @ V3l @ c_2Ereal__topology_2Esequentially ) ) )).
