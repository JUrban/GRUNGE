...
thf(conj_thm_2Erich__list_2EMAP__FILTER,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( ! [V3x: $i] :
                   ...
                   => ( ( p @ ( ap @ V1P @ ( ap @ V0f @ V3x ) ) )
                    <=> ( p @ ( ap @ V1P @ V3x ) ) ) )
               => ( ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27a ) @ V0f ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V1P ) @ V2l ) )
                  = ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V1P ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27a ) @ V0f ) @ V2l ) ) ) ) ) ) ) )).
