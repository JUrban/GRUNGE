...
fof(conj_thm_2Elist_2EMEM__ZIP__MEM__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ps] :
              ( mem(V0ps,ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))
             => ! [V1p] :
                  ( mem(V1p,ty_2Epair_2Eprod(A_27a,A_27a))
                 => ( ( ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps)) = ap(c_2Elist_2ELENGTH(A_27b),ap(c_2Epair_2ESND(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),V1p),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Elist_2EZIP(A_27a,A_27a),V0ps)))) )
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V1p)),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps))))
                      & p(ap(ap(c_2Ebool_2EIN(A_27b),ap(c_2Epair_2ESND(A_27a,A_27a),V1p)),ap(c_2Elist_2ELIST__TO__SET(A_27b),ap(c_2Epair_2ESND(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps)))) ) ) ) ) ) ) )).
