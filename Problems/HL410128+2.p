...
fof(conj_thm_2Eseq_2ESUMMABLE__LE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(mem_c_2Emeasure_2Esubadditive,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Emeasure_2Esubadditive(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) ) )).
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE__SUBADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ESUBADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EINCREASING__ADDITIVE__SUMMABLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__INCREASING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__STRONG__SUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EOUTER__MEASURE__SPACE__POSITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__CARATHEODORY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0gsig] :
