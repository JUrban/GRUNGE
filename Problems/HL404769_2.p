...
tff(conj_thm_2Efinite__map_2ESUBMAP__FUNION,lemma,(
...
tff(conj_thm_2Efinite__map_2ESUBMAP__FUNION__ID,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] :
      ( ! [V0f1: $i] :
          ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V1f2: $i] :
              ( mem(V1f2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f1),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f1),V1f2))) ) )
      & ! [V2f1: $i] :
          ( mem(V2f1,ty_2Efinite__map_2Efmap(A_27c,A_27c))
         => ! [V3f2: $i] :
              ( mem(V3f2,ty_2Efinite__map_2Efmap(A_27c,A_27c))
             => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27c),ap(c_2Efinite__map_2EFDOM(A_27c,A_27c),V2f1)),ap(c_2Efinite__map_2EFDOM(A_27c,A_27c),V3f2)))
               => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27c,A_27c),V3f2),ap(ap(c_2Efinite__map_2EFUNION(A_27c,A_27c),V2f1),V3f2))) ) ) ) ) )).
