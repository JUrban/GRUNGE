...
thf(conj_thm_2Ealignment_2Ealigned__extract,lemma,(
...
thf(conj_thm_2Ealignment_2Ealigned__ge__dim,lemma,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EWORD__EXTRACT__ZERO2,lemma,(
...
thf(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__MUL2,lemma,(
...
thf(conj_thm_2Ewords_2ELSL__LIMIT,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Ewords_2EWORD__MUL__LSL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V0a ) @ ( inj__ty_2Enum_2Enum @ V1n ) )
          = ( ap @ ( ap @ ( c_2Ewords_2Eword__mul @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ V0a ) ) ) )).

thf(conj_thm_2Ealignment_2Ealigned__mul__shift__1,conjecture,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
