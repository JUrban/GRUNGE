...
thf(conj_thm_2Ealist_2EALOOKUP__LEAST__EL,conjecture,(
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Elist_2EEL @ A_27b )
                      @ ( ap @ c_2Ewhile_2ELEAST
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V2n: $i] :
                              ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ V2n ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ ( c_2Epair_2EFST @ A_27a @ A_27b ) ) @ V0ls ) ) ) @ V1k ) ) ) )
