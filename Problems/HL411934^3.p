...
thf(c_2Ereal__topology_2Efsigma,type,(
    c_2Ereal__topology_2Efsigma: ( tyop_2Erealax_2Ereal > $o ) > $o )).

thf(c_2Ereal__topology_2Egdelta,type,(
    c_2Ereal__topology_2Egdelta: ( tyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Ereal__topology_2Egdelta,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Egdelta @ V0s )
    <=> ? [V1g: ( tyop_2Erealax_2Ereal > $o ) > $o] :
          ( ( c_2Epred__set_2Ecountable @ ( tyop_2Erealax_2Ereal > $o ) @ V1g )
          & ! [V2u: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2u @ V1g )
             => ( c_2Ereal__topology_2EOpen @ V2u ) )
          & ( ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ V1g )
            = V0s ) ) ) )).

thf(thm_2Ereal__topology_2Efsigma,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Efsigma @ V0s )
    <=> ? [V1g: ( tyop_2Erealax_2Ereal > $o ) > $o] :
          ( ( c_2Epred__set_2Ecountable @ ( tyop_2Erealax_2Ereal > $o ) @ V1g )
          & ! [V2c: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V2c @ V1g )
             => ( c_2Ereal__topology_2EClosed @ V2c ) )
          & ( ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V1g )
            = V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EGDELTA__COMPLEMENT,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Egdelta @ ( c_2Epred__set_2EDIFF @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) @ V0s ) )
      = ( c_2Ereal__topology_2Efsigma @ V0s ) ) )).
