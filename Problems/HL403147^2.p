...
thf(conj_thm_2ETemporal__Logic_2EIMP__NEXT,conjecture,(
    ! [V0Q: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ( ( ap @ c_2ETemporal__Logic_2ENEXT
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2t: $i] :
                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V2t ) ) @ ( ap @ V0Q @ V2t ) ) ) )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V3t: $i] :
                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1P ) @ V3t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0Q ) @ V3t ) ) ) ) ) ) )).
