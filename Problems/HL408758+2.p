...
fof(conj_thm_2EHolSmt_2Er137,conjecture,(
    ! [V0a] :
     ...
     => ! [V1u] :
         ...
         => ! [V2x] :
             ...
             => ( V0a = ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1u)),V2x)
              <=> ap(ap(c_2Erealax_2Ereal__mul,V1u),V2x) = ap(c_2Erealax_2Ereal__neg,V0a) ) ) ) ) )).
