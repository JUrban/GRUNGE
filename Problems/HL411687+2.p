...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__RANGE__CONSTANT,conjecture,(
    ! [V0t] :
     ...
     => ! [V1f] :
         ...
         => ! [V2s] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Econnected,V2s))
                  ...
                  & ! [V3y] :
                      ( mem(V3y,ty_2Erealax_2Ereal)
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V0t))
                       => ap(ap(c_2Ereal__topology_2Econnected__component,V0t),V3y) = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V3y),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) )
               => ? [V4a] :
                    ( mem(V4a,ty_2Erealax_2Ereal)
                    & ! [V5x] :
                        ( mem(V5x,ty_2Erealax_2Ereal)
