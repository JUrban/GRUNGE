...
thf(conj_thm_2Ereal__topology_2EDIAMETER__LE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1d: tp__ty_2Erealax_2Ereal] :
          ( ( ( ( V0s
            ...
            & ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
               ...
               => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1d ) ) ) ) )
         => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal__topology_2Ediameter @ V0s ) ) @ ( inj__ty_2Erealax_2Ereal @ V1d ) ) ) ) ) )).
