...
thf(conj_thm_2Ellist_2ELHD__LUNFOLD,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2Ellist_2ELTL__LUNFOLD,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
...
thf(conj_thm_2Eoption_2EOPTION__MAP__CASE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1x: $i] :
...
thf(conj_thm_2Ellist_2ELTAKE__LUNFOLD,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
