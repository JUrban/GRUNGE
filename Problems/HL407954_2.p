...
tff(conj_thm_2Earithmetic_2EEQ__MULT__LCANCEL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Einteger_2EINT__LT__01,lemma,(
...
tff(conj_thm_2Einteger_2EINT__NEG__EQ0,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
tff(conj_thm_2Einteger_2EINT__NEG__SAME__EQ,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
      ( V0p = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V0p)))
    <=> V0p = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).

tff(conj_thm_2Einteger_2EINT__ABS__NEG,lemma,(
...
tff(conj_thm_2Einteger_2EINT__ABS__EQ__ABS,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
tff(conj_thm_2Efrac_2EFRAC__MINV__1,lemma,(
...
tff(conj_thm_2Erat_2Erat__0,lemma,(
...
tff(conj_thm_2Erat_2ERAT__AINV__CONG,lemma,(
...
tff(conj_thm_2Erat_2ERAT__MINV__CALCULATE,lemma,(
...
tff(conj_thm_2Erat_2ERAT__LEQ__CALCULATE,lemma,(
    ! [V0f1: tp__ty_2Efrac_2Efrac,V1f2: tp__ty_2Efrac_2Efrac] :
...
tff(conj_thm_2Erat_2ERAT__OF__NUM__LES,lemma,(
...
tff(conj_thm_2Erat_2ERAT__AINV__0,lemma,(
...
tff(conj_thm_2Erat_2ERAT__AINV__EQ,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__EQ__AINV,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__LES__TOTAL,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( p(ap(ap(c_2Erat_2Erat__les,inj__ty_2Erat_2Erat(V0r1)),inj__ty_2Erat_2Erat(V1r2)))
      | V0r1 = V1r2
      | p(ap(ap(c_2Erat_2Erat__les,inj__ty_2Erat_2Erat(V1r2)),inj__ty_2Erat_2Erat(V0r1))) ) )).

tff(conj_thm_2Erat_2ERAT__LEQ__REF,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat] : p(ap(ap(c_2Erat_2Erat__leq,inj__ty_2Erat_2Erat(V0r1)),inj__ty_2Erat_2Erat(V0r1))) )).

tff(conj_thm_2Erat_2ERAT__LES__01,lemma,(
...
tff(conj_thm_2Erat_2ERAT__LES__LEQ__TRANS,lemma,(
...
tff(conj_thm_2Erat_2ERAT__LEQ__LES__TRANS,lemma,(
    ! [V0a: tp__ty_2Erat_2Erat,V1b: tp__ty_2Erat_2Erat,V2c: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__0LES__0LEQ__ADD,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__RDIV__EQ,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat,V2r3: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__EQ__RADD,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat,V2r3: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__EQ__LMUL,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat,V2r3: tp__ty_2Erat_2Erat] :
      ( V2r3 != surj__ty_2Erat_2Erat(ap(c_2Erat_2Erat__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
...
tff(conj_thm_2Erat_2ERAT__LES__AINV,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__AINV__LES,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
tff(conj_thm_2Erat_2ERAT__MUL__SIGN__CASES,lemma,(
...
tff(conj_thm_2Erat_2ERAT__OF__NUM,lemma,(
    ! [A_27a: del,V0n: $i] :
      ( mem(V0n,A_27a)
...
tff(conj_thm_2Erat_2Erat__of__int__11,lemma,(
...
tff(conj_thm_2Erat_2Erat__of__int__of__num,lemma,(
...
tff(conj_thm_2Erat_2Erat__of__int__MUL,lemma,(
...
tff(conj_thm_2Erat_2Erat__of__int__ainv,lemma,(
...
tff(conj_thm_2Erat_2ERATN__LEAST,lemma,(
    ! [V0r: tp__ty_2Erat_2Erat,V1n_27: tp__ty_2Einteger_2Eint,V2d_27: tp__ty_2Enum_2Enum] :
      ( ( V0r = surj__ty_2Erat_2Erat(ap(ap(c_2Erat_2Erat__div,ap(c_2Erat_2Erat__of__int,inj__ty_2Einteger_2Eint(V1n_27))),ap(c_2Erat_2Erat__of__num,inj__ty_2Enum_2Enum(V2d_27))))
        & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2d_27))) )
     => p(ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger_2EABS,ap(c_2Erat_2ERATN,inj__ty_2Erat_2Erat(V0r)))),ap(c_2Einteger_2EABS,inj__ty_2Einteger_2Eint(V1n_27)))) ) )).

tff(conj_thm_2Erat_2ERATN__RATD__MULT,lemma,(
...
tff(conj_thm_2Erat_2ERATD__NEG,conjecture,(
