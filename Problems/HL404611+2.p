...
fof(ax_thm_2Estring_2ESUB__def,axiom,(
    ! [V0s] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(c_2Estring_2ESUB,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),V0s),V1n)) = ap(ap(c_2Elist_2EEL(ty_2Estring_2Echar),V1n),V0s) ) ) )).
...
fof(conj_thm_2EASCIInumbers_2ESUB__num__to__bin__string,conjecture,(
    ! [V0x] :
