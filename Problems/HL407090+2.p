...
fof(lamtp_f2707,axiom,(
    ! [V1y] :
      ( mem(V1y,ty_2Ehreal_2Ehreal)
     => ! [V0x] :
          ( mem(V0x,ty_2Ehreal_2Ehreal)
         => mem(f2707(V1y,V0x),arr(ty_2Ehreal_2Ehreal,bool)) ) ) )).
    ...
    ! [V1y] :
     ...
     => ! [V0x] :
         ...
         => ! [V2d] :
             ...
             => ap(f2707(V1y,V0x),V2d) = ap(ap(c_2Emin_2E_3D(ty_2Ehreal_2Ehreal),V0x),ap(ap(c_2Ehreal_2Ehreal__add,V1y),V2d)) ) ) ) )).
...
fof(ax_thm_2Erealax_2Ehreal__of__treal,axiom,(
    ! [V0x] :
     ...
     => ! [V1y] :
          ( mem(V1y,ty_2Ehreal_2Ehreal)
         => ap(c_2Erealax_2Ehreal__of__treal,ap(ap(c_2Epair_2E_2C(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal),V0x),V1y)) = ap(c_2Emin_2E_40(ty_2Ehreal_2Ehreal),f2707(V1y,V0x)) ) ) )).

fof(conj_thm_2Erealax_2ETREAL__BIJ,conjecture,
    ( ! [V0h] :
