...
thf(thm_2Equotient__sum_2EINR__PRS,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6b_2E0: u] :
              ( ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27d @ V6b_2E0 ) ) )
              = ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( c_2Esum_2E_2B_2B_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1abs1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V4abs2_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V5rep2_2E0 ) @ ( s @ A_27d @ V6b_2E0 ) ) ) ) ) ) ) ) ) ) )).
