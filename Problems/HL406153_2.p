...
tff(conj_thm_2Ewords_2EWORD__GE,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(lmtp_f2256,type,(
    f2256: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * tp__o ) > $i )).

tff(lamtp_f2256,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o] : mem(f2256(A_27a,V0a,V1b,V2sa),arr(bool,bool)) )).

tff(lameq_f2256,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o,V3sb: tp__o] : ap(f2256(A_27a,V0a,V1b,V2sa),inj__o(V3sb)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(bool),inj__o(V2sa)),inj__o(V3sb))),ap(ap(c_2Earithmetic_2E_3E_3D,ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V0a)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1b)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,inj__o(V2sa))),inj__o(V3sb))) )).

tff(lmtp_f2255,type,(
    f2255: ( del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2255,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] : mem(f2255(A_27a,V0a,V1b),arr(bool,arr(bool,bool))) )).

tff(lameq_f2255,axiom,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2sa: tp__o] : ap(f2255(A_27a,V0a,V1b),inj__o(V2sa)) = f2256(A_27a,V0a,V1b,V2sa) )).

tff(conj_thm_2Ewords_2Eword__ge__n2w,conjecture,(
