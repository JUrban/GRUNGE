...
tff(conj_thm_2Erich__list_2EZIP__SNOC,conjecture,(
     ...
     => ! [V1l2: $i] :
         ...
         => ( surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V0l1)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),V1l2))
           => ! [V2x1: $i] :
               ...
               => ! [V3x2: $i] :
                    ( mem(V3x2,A_27b)
                   => ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2ESNOC(A_27a),V2x1),V0l1)),ap(ap(c_2Elist_2ESNOC(A_27b),V3x2),V1l2))) = ap(ap(c_2Elist_2ESNOC(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x1),V3x2)),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2))) ) ) ) ) ) )).
