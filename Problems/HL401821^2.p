...
thf(conj_thm_2Epred__set_2Ecountable__surj,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2Epair__to__num__inv,lemma,
...
thf(conj_thm_2Epred__set_2Ecross__countable,conjecture,(
