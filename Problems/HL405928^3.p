...
thf(thm_2Ebit_2ELOG2__UNIQUE,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1p: tyop_2Enum_2Enum] :
      ( ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1p ) @ V0n )
        & ( c_2Eprim__rec_2E_3C @ V0n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V1p ) ) ) )
     => ( ( c_2Ebit_2ELOG2 @ V0n )
        = V1p ) ) )).
...
thf(thm_2Ebit_2EBIT__SLICE__THM,axiom,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2ESBIT @ ( c_2Ebit_2EBIT @ V0x @ V1n ) @ V0x )
      = ( c_2Ebit_2ESLICE @ V0x @ V0x @ V1n ) ) )).
...
thf(thm_2Ebit_2EBIT__BITS__THM,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum,V3b: tyop_2Enum_2Enum] :
      ( ! [V4x: tyop_2Enum_2Enum] :
          ( ( ( c_2Earithmetic_2E_3C_3D @ V1l @ V4x )
            & ( c_2Earithmetic_2E_3C_3D @ V4x @ V0h ) )
         => ( ( c_2Ebit_2EBIT @ V4x @ V2a )
            = ( c_2Ebit_2EBIT @ V4x @ V3b ) ) )
    <=> ( ( c_2Ebit_2EBITS @ V0h @ V1l @ V2a )
        = ( c_2Ebit_2EBITS @ V0h @ V1l @ V3b ) ) ) )).

thf(thm_2Ebit_2EBITS__ZERO5,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
      ( ! [V2i: tyop_2Enum_2Enum] :
          ( ( c_2Earithmetic_2E_3C_3D @ V2i @ V0n )
         => ( (~) @ ( c_2Ebit_2EBIT @ V2i @ V1m ) ) )
     => ( ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V1m )
        = c_2Enum_2E0 ) ) )).

thf(thm_2Ebit_2EBIT__IMP__GE__TWOEXP,axiom,(
    ! [V0i: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V0i @ V1n )
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0i ) @ V1n ) ) )).

thf(thm_2Ebit_2EEXISTS__BIT__IN__RANGE,axiom,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( ( (~) @ ( V2n = c_2Enum_2E0 ) )
        & ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0a ) @ V2n )
        & ( c_2Eprim__rec_2E_3C @ V2n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1b ) ) )
     => ? [V3i: tyop_2Enum_2Enum] :
          ( ( c_2Earithmetic_2E_3C_3D @ V0a @ V3i )
          & ( c_2Eprim__rec_2E_3C @ V3i @ V1b )
          & ( c_2Ebit_2EBIT @ V3i @ V2n ) ) ) )).
...
thf(thm_2Ewords_2ELOG2__w2n,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( (~)
        @ ( V0w
     ...
     => ( ( c_2Ebit_2ELOG2 @ ( c_2Ewords_2Ew2n @ A_27a @ V0w ) )
        = ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) )
          @ ( c_2Ewhile_2ELEAST
            @ ^ [V1i: tyop_2Enum_2Enum] :
                ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V0w @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1i ) ) ) ) ) ) )).
