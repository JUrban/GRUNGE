...
tff(conj_thm_2Ewords_2EWORD__MODIFY__BIT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(bool,bool)))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] :
             ...
             => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__modify(A_27a),V0f),V1w)),inj__ty_2Enum_2Enum(V2i)))
              <=> p(ap(ap(V0f,inj__ty_2Enum_2Enum(V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i)))) ) ) ) ) )).
