...
thf(f4036_0_2E0,type,(
    f4036_0_2E0: u )).

thf(f4036_0_2E2,type,(
    f4036_0_2E2: du > du > u )).

thf(f4036_0_2E4,type,(
    f4036_0_2E4: du > du > du > du > u )).

thf(f4037_0_2E0,type,(
    f4037_0_2E0: u )).

thf(f4037_0_2E1,type,(
    f4037_0_2E1: du > u )).

thf(f4037_0_2E3,type,(
...
thf(c_2Ebft_2EBFT_2E0,type,(
    c_2Ebft_2EBFT_2E0: u )).

thf(c_2Ebft_2EBFT_2E5,type,(
    c_2Ebft_2EBFT_2E5: du > du > du > du > du > u )).
...
thf(c_2EdirGraph_2EEXCLUDE_2E0,type,(
    c_2EdirGraph_2EEXCLUDE_2E0: u )).

thf(c_2EdirGraph_2EEXCLUDE_2E2,type,(
    c_2EdirGraph_2EEXCLUDE_2E2: du > du > u )).
...
thf(c_2Elist_2ELIST__TO__SET_2E2,type,(
    c_2Elist_2ELIST__TO__SET_2E2: du > du > u )).

thf(c_2Elist_2ENIL_2E0,type,(
    c_2Elist_2ENIL_2E0: u )).

thf(c_2EdirGraph_2EParents_2E0,type,(
    c_2EdirGraph_2EParents_2E0: u )).

thf(c_2EdirGraph_2EParents_2E1,type,(
    c_2EdirGraph_2EParents_2E1: du > u )).

thf(c_2EdirGraph_2EREACH_2E0,type,(
    c_2EdirGraph_2EREACH_2E0: u )).

thf(c_2EdirGraph_2EREACH_2E1,type,(
    c_2EdirGraph_2EREACH_2E1: du > u )).

thf(c_2EdirGraph_2EREACH_2E2,type,(
    c_2EdirGraph_2EREACH_2E2: du > du > u )).

thf(c_2EdirGraph_2EREACH__LIST_2E0,type,(
    c_2EdirGraph_2EREACH__LIST_2E0: u )).

thf(c_2EdirGraph_2EREACH__LIST_2E2,type,(
    c_2EdirGraph_2EREACH__LIST_2E2: du > du > u )).

thf(c_2EdirGraph_2EREACH__LIST_2E3,type,(
...
thf(arityeq2_2Emono_2Ef4036_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4036_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) ) @ f4036_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef4036_0_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4036_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) ) @ f4036_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) @ ( s @ A_27a @ X3_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4037_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4037_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4037_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4037_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4037_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(arityeq5_2Emono_2Ec_2Ebft_2EBFT_2E5_2Emono_2Etyop_2Elist_2Elist_28A_27a_29_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u,X4_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebft_2EBFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X3_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X4_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) ) @ c_2Ebft_2EBFT_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X3_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X4_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EdirGraph_2EEXCLUDE_2E2_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2EdirGraph_2EEXCLUDE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ c_2EdirGraph_2EEXCLUDE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2ELIST__TO__SET_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ELIST__TO__SET_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ c_2Elist_2ELIST__TO__SET_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2EdirGraph_2EParents_2E1_2Emono_2EA_27a_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EParents_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ c_2EdirGraph_2EParents_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2EdirGraph_2EREACH_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2EdirGraph_2EREACH_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ c_2EdirGraph_2EREACH_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2EdirGraph_2EREACH_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ec_2EdirGraph_2EREACH__LIST_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH__LIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ c_2EdirGraph_2EREACH__LIST_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2EdirGraph_2EREACH__LIST_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EdirGraph_2EREACH__LIST_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ c_2EdirGraph_2EREACH__LIST_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Erelation_2ERTC_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2Erelation_2ERTC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) )
...
thf(thm_2Ebft_2EBFT__REACH__1,axiom,(
    ! [A_27a: d,V0G_2E0: u,V1f_2E0: u,V2seen_2E0: u,V3fringe_2E0: u,V4acc_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EParents_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) ) ) ) )
        & ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2Elist_2ECONS_2E0 ) ) )
     => ! [V5x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebft_2EBFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3fringe_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4acc_2E0 ) ) ) ) ) ) ) )
         => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH__LIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3fringe_2E0 ) ) ) ) ) )
            | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4acc_2E0 ) ) ) ) ) ) ) ) ) )).

thf(thm_2Ebft_2EBFT__REACH__2,axiom,(
    ! [A_27a: d,V0G_2E0: u,V1f_2E0: u,V2seen_2E0: u,V3fringe_2E0: u,V4acc_2E0: u,V5x_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EParents_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) ) ) ) )
        & ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2Elist_2ECONS_2E0 ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH__LIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2EdirGraph_2EEXCLUDE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3fringe_2E0 ) ) ) ) ) )
        & ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) ) ) ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebft_2EBFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3fringe_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4acc_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2EdirGraph_2EREACH__def,axiom,(
    ! [A_27a: d,V0G_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4037_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) ) ) ) ) ) )).

thf(thm_2EdirGraph_2EREACH__def,axiom,(
    ! [A_27a: d,V0G_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2EdirGraph_2EREACH_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2Erelation_2ERTC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4037_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) ) ) ) ) )).

thf(thm_2EdirGraph_2EREACH__LIST__def,axiom,(
    ! [A_27a: d,V0G_2E0: u,V1nodes_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EdirGraph_2EREACH__LIST_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1nodes_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
    <=> ? [V3x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1nodes_2E0 ) ) ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2EdirGraph_2EREACH__EXCLUDE,axiom,(
    ! [A_27a: d,V1x_2E0: u,V0G_2E0: u,V2x_27_2E0: u,V3y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4036_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ A_27a @ V2x_27_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) )
    <=> ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1x_2E0 ) ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ A_27a @ V2x_27_2E0 ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2EdirGraph_2EREACH__EXCLUDE,axiom,(
    ! [A_27a: d,V0G_2E0: u,V1x_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2EdirGraph_2EREACH_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2EdirGraph_2EEXCLUDE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1x_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2Erelation_2ERTC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4036_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) ) ) ) ) )).

thf(thm_2Elist_2ELIST__TO__SET__DEF,axiom,(
    ! [A_27a: d] :
      ( ! [V0x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ELIST__TO__SET_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ A_27a @ V0x_2E0 ) ) ) )
          = mono_2Ec_2Ebool_2EF )
      & ! [V1h_2E0: u,V2t_2E0: u,V3x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ELIST__TO__SET_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2t_2E0 ) ) ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
        <=> ( ( ( s @ A_27a @ V3x_2E0 )
              = ( s @ A_27a @ V1h_2E0 ) )
            | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ELIST__TO__SET_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2t_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ebft_2EBFT__REACH__THM,conjecture,(
    ! [A_27a: d,V0G_2E0: u,V1fringe_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EParents_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) ) ) ) ) )
     => ! [V2x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH__LIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1fringe_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebft_2EBFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2Elist_2ECONS_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1fringe_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) ) ) ) ) ) ) ) )).
