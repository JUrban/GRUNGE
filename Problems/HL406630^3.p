...
thf(thm_2Eenumeral_2ELESS__ALL__OU,axiom,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1x: A_27a,V2u: A_27a > $o,V3v: A_27a > $o] :
      ( ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1x @ ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V2u @ V3v ) )
    <=> ( ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1x @ V2u )
        & ( c_2Eenumeral_2ELESS__ALL @ A_27a @ V0cmp @ V1x @ V3v ) ) ) )).
...
thf(thm_2Eenumeral_2EOU__ASSOC,conjecture,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1a: A_27a > $o,V2b: A_27a > $o,V3c: A_27a > $o] :
      ( ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V1a @ ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V2b @ V3c ) )
      = ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V1a @ V2b ) @ V3c ) ) )).
