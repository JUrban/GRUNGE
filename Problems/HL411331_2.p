...
tff(lmtp_f3919,type,(
    f3919: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3919,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3919(V2s,V1f,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f3919,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0a: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3919(V2s,V1f,V0a),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V2s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,inj__ty_2Erealax_2Ereal(V3x))),inj__ty_2Erealax_2Ereal(V0a)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__CONSTANT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1f: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1f),V2s))
           ...
           => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3919(V2s,V1f,V0a)))) ) ) ) )).
