...
thf(conj_thm_2ETemporal__Logic_2EUNTIL__FIX,conjecture,(
    ! [V0y: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( V0y
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V3t: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V3t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2a @ V3t ) ) @ ( ap @ V0y @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3t ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )
              <=> ( ( V0y
