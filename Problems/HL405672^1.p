...
thf(arityeq2_2Emono_2Ec_2Ewellorder_2Eorderlt_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderlt_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) ) )
...
thf(thm_2Eordinal_2Eordle__TRANS,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u,V2z_2E0: u] :
     ...
     => ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2z_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EORD__ONE,axiom,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )
...
thf(thm_2Eordinal_2Eordlt__EXISTS__ADD,axiom,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) ) ) )
    <=> ? [V2c_2E0: u] :
          ( ( (~)
            @ ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2c_2E0 )
          ...
          & ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 )
            = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordADD_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2c_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ewellorder_2Eorderlt__trichotomy,axiom,(
    ! [A_27a: d,A_27b: d,V0w2_2E0: u,V1w1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderlt_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27b ) @ V0w2_2E0 ) ) ) )
      | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderiso_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27b ) @ V0w2_2E0 ) ) ) )
      | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Eorderlt_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27b ) @ V0w2_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordDIV__UNIQUE,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u,V2q_2E0: u,V3r_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) ) ) )
        & ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 )
          = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordADD_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordMULT_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2q_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3r_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3r_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordDIV_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) ) )
        = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2q_2E0 ) ) ) )).
