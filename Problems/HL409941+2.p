...
fof(lameq_f3449,axiom,(
    ! [A_27a,V2f] :
     ...
     => ! [V1P] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3449(A_27a,V2f,V1P),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(V1P,V4x)),ap(V2f,V4x)),ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IF__ELIM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                      & ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s))
                           => p(ap(V1P,V3x)) ) ) )
                   => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3449(A_27a,V2f,V1P)),V0s) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f),V0s) ) ) ) ) ) )).
