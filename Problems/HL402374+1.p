...
fof(arityeq1_2Ef2577_0_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2577_0_2E1(s(tyop_2Emin_2Ebool,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2577_0_2E0),s(tyop_2Emin_2Ebool,X0_2E0))) )).

fof(arityeq2_2Ef2577_0_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f2577_0_2E2(s(tyop_2Emin_2Ebool,X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2577_0_2E0),s(tyop_2Emin_2Ebool,X0_2E0))),s(A_27a,X1_2E0))) )).

fof(arityeq1_2Ef2578_0_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2578_0_2E1(s(tyop_2Emin_2Ebool,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2578_0_2E0),s(tyop_2Emin_2Ebool,X0_2E0))) )).

fof(arityeq2_2Ef2578_0_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f2578_0_2E2(s(tyop_2Emin_2Ebool,X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2578_0_2E0),s(tyop_2Emin_2Ebool,X0_2E0))),s(A_27a,X1_2E0))) )).
...
fof(def0_2Ethm_2Eres__quan_2ERES__EXISTS__NULL,axiom,(
    ! [A_27a,V1m_2E0,V2x_2E0] : s(tyop_2Emin_2Ebool,f2578_0_2E2(s(tyop_2Emin_2Ebool,V1m_2E0),s(A_27a,V2x_2E0))) = s(tyop_2Emin_2Ebool,V1m_2E0) )).

fof(thm_2Eres__quan_2ERES__EXISTS__NULL,axiom,(
    ! [A_27a,V0p_2E0,V1m_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2ERES__EXISTS_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0p_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2578_0_2E1(s(tyop_2Emin_2Ebool,V1m_2E0))))))
    <=> ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0p_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
        & p(s(tyop_2Emin_2Ebool,V1m_2E0)) ) ) )).
...
fof(def0_2Ethm_2Eres__quan_2ERES__EXISTS__UNIQUE__NULL,axiom,(
    ! [A_27a,V1m_2E0,V2x_2E0] : s(tyop_2Emin_2Ebool,f2577_0_2E2(s(tyop_2Emin_2Ebool,V1m_2E0),s(A_27a,V2x_2E0))) = s(tyop_2Emin_2Ebool,V1m_2E0) )).

fof(thm_2Eres__quan_2ERES__EXISTS__UNIQUE__NULL,conjecture,(
    ! [A_27a,V0p_2E0,V1m_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2ERES__EXISTS__UNIQUE_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0p_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2577_0_2E1(s(tyop_2Emin_2Ebool,V1m_2E0))))))
    <=> ( ? [V3x_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0p_2E0) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EINSERT_2E2(s(A_27a,V3x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)))
        & p(s(tyop_2Emin_2Ebool,V1m_2E0)) ) ) )).
