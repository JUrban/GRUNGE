...
thf(conj_thm_2Erelation_2ETC__lifts__invariants,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1R: $i] :
         ...
         => ( ! [V2x: $i] :
           ...
           => ! [V4x: $i] :
               ...
               => ! [V5y: $i] :
                    ( ( mem @ V5y @ A_27a )
                   => ( ( ( p @ ( ap @ V0P @ V4x ) )
                        & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ETC @ A_27a ) @ V1R ) @ V4x ) @ V5y ) ) )
                     => ( p @ ( ap @ V0P @ V5y ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Esorting_2EPERM__lifts__invariants,conjecture,(
    ! [A_27a: del,V0P: $i] :
