...
fof(conj_thm_2Ecardinal_2EINJECTIVE__LEFT__INVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2ELINEAR__SUB,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__BOUNDED__BELOW__POS,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1x] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__ON,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__MINIMAL,lemma,(
    ! [V0s] :
                ...
                & ? [V3g] :
                    ...
                    & ! [V4x] :
                       ...
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V0s))
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V2f,V4x)),V1t))
                            & ap(V3g,ap(V2f,V4x)) = V4x ) ) )
                    & ! [V5y] :
                        ( mem(V5y,ty_2Erealax_2Ereal)
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V1t))
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V3g,V5y)),V0s))
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__SELF,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
