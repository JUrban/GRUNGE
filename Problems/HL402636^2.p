...
thf(conj_thm_2Erich__list_2EFOLDR__SINGLE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2x: $i] :
              ( ( mem @ V2x @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27b ) @ V0f ) @ V1e ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( c_2Elist_2ENIL @ A_27a ) ) )
                = ( ap @ ( ap @ V0f @ V2x ) @ V1e ) ) ) ) ) )).
