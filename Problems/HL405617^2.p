...
thf(conj_thm_2Eordinal_2Epreds__sup__thm,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) )
     => ( ( ( p @ ( ap @ ( c_2Eordinal_2Edownward__closed @ A_27a ) @ V0s ) )
          & ( V0s
...
thf(conj_thm_2Eordinal_2Eordlt__fromNat,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V1x ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
      <=> ? [V2m: tp__ty_2Enum_2Enum] :
            ( ( V1x
              = ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) )
            & ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )).

thf(ax_thm_2Eordinal_2Eomega__def,axiom,(
    ! [A_27a: del] :
      ...
      = ( ap @ ( c_2Eordinal_2Esup @ A_27a )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ty_2Enum_2Enum )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V0i: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ V0i ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Elt__omega,conjecture,(
    ! [A_27a: del,V0a: $i] :
