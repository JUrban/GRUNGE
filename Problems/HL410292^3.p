...
thf(thm_2Emeasure_2Eindicator__fn__suminf,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Enum_2Enum > A_27a > $o,V1x: A_27a] :
      ( ! [V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
          ( ( (~) @ ( V2m = V3n ) )
         => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V0a @ V2m ) @ ( V0a @ V3n ) ) )
     => ( ( c_2Eextreal_2Eext__suminf
          @ ^ [V4i: tyop_2Enum_2Enum] :
              ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( V0a @ V4i ) @ V1x ) )
        = ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V0a @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ V1x ) ) ) )).
