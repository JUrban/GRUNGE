...
tff(mem_c_2Epath_2Efilter,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epath_2Efilter(A_27a,A_27a),arr(arr(A_27a,bool),arr(ty_2Epath_2Epath(A_27a,A_27a),ty_2Epath_2Epath(A_27a,A_27a)))) )).
...
tff(conj_thm_2Epath_2Eexists__induction,lemma,(
...
tff(conj_thm_2Epath_2Efilter__every,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1p: $i] :
