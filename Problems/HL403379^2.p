...
thf(conj_thm_2Earithmetic_2ENOT__GREATER__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(ax_thm_2Ebag_2EBAG__ALL__DISTINCT,axiom,(
    ! [A_27a: del,V0b: $i] :
...
thf(conj_thm_2Ebag_2EBAG__IN__BAG__DIFF__ALL__DISTINCT,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
