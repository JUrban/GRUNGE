...
tff(conj_thm_2Ereal__topology_2EOPEN__INTER__CLOSURE__SUBSET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__INTER__CLOSURE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
       => ? [V1t: $i] :
            ...
            & V0s = ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V1t),ap(c_2Ereal__topology_2Eclosure,V0s)) ) ) ) )).
