...
tff(conj_thm_2Efinite__map_2EDRESTRICT__SUBSET__SUBMAP__gen,conjecture,(
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f1),V2s)),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V1f2),V2s)))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V3t),V2s)) )
                   => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f1),V3t)),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V1f2),V3t))) ) ) ) ) ) )).
