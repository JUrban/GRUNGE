...
thf(conj_thm_2Eupdate_2EOVERRIDE__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
                      ...
                      @ ( ap @ V0P
                        @ ( ap
                          @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                            @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                              @ ^ [V3y: $i] :
                                  ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V1x ) ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V3y ) ) ) ) )
                          @ V2t ) ) )
