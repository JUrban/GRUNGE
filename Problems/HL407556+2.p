...
fof(conj_thm_2Ereal_2ENUM__FLOOR__BASE,lemma,(
    ! [V0r] :
      ( mem(V0r,ty_2Erealax_2Ereal)
     => ( p(ap(ap(c_2Erealax_2Ereal__lt,V0r),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))
       => ap(c_2Ereal_2ENUM__FLOOR,V0r) = c_2Enum_2E0 ) ) )).

fof(conj_thm_2Ereal_2ENUM__FLOOR__EQNS,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ( ap(c_2Ereal_2ENUM__FLOOR,ap(c_2Ereal_2Ereal__of__num,V0n)) = V0n
            & ap(c_2Ereal_2ENUM__FLOOR,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,V0n))) = c_2Enum_2E0
            & ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V1m))
             => ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,V0n)),ap(c_2Ereal_2Ereal__of__num,V1m))) = ap(ap(c_2Earithmetic_2EDIV,V0n),V1m) )
            & ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V1m))
             => ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,V0n))),ap(c_2Ereal_2Ereal__of__num,V1m))) = c_2Enum_2E0 ) ) ) ) )).
