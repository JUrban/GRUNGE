...
thf(thm_2Ereal__topology_2ESPAN__BREAKDOWN__EQ,conjecture,(
    ...
    <=> ? [V3k: tyop_2Erealax_2Ereal] :
          ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__sub @ V0x @ ( c_2Erealax_2Ereal__mul @ V3k @ V1a ) ) @ ( c_2Ereal__topology_2Espan @ V2s ) ) ) )).
