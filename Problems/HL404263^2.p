...
thf(ax_thm_2EEncode_2Eencode__unit__def,axiom,(
    ! [V0v0: tp__ty_2Eone_2Eone] :
      ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ c_2EEncode_2Eencode__unit @ ( inj__ty_2Eone_2Eone @ V0v0 ) ) )
...
thf(conj_thm_2EDecode_2Edecode__unit,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Eone_2Eone @ bool ) )
