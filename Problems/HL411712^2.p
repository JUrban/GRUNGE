...
thf(conj_thm_2Ereal__topology_2ELINEAR__BOUNDED__POS,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
       => ? [V1B: tp__ty_2Erealax_2Ereal] :
            ...
            & ! [V2x: tp__ty_2Erealax_2Ereal] :
                ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1B ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) ) ) ) )).
     ...
     => ! [V2s: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V1f ) )
              & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( V3x = V4y ) ) )
           => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1f ) @ V2s ) ) )
            <=> ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V2s ) ) ) ) ) ) )).
