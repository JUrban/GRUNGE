...
thf(thm_2Ecardinal_2Ecardleq__SURJ,axiom,(
    ...
    <=> ( ? [V2f: A_27b > A_27a] :
            ( c_2Epred__set_2ESURJ @ A_27b @ A_27a @ V2f @ V0B @ V1A )
        | ( V1A
      ...
      = ( c_2Epred__set_2EGSPEC @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a )
        @ ^ [V1l: tyop_2Elist_2Elist @ A_27a] :
            ...
            @ ( c_2Ebool_2E_21 @ A_27a
              @ ^ [V2e: A_27a] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ A_27a @ V2e @ ( c_2Elist_2ELIST__TO__SET @ A_27a @ V1l ) ) @ ( c_2Ebool_2EIN @ A_27a @ V2e @ V0A ) ) ) ) ) ) )).
...
thf(thm_2Ecardinal_2Efinite__subsets__bijection,conjecture,(
    ! [A_27a: $tType,V0A: A_27a > $o] :
      ( ( (~) @ ( c_2Epred__set_2EFINITE @ A_27a @ V0A ) )
     => ( c_2Ecardinal_2Ecardeq @ A_27a @ ( A_27a > $o ) @ V0A
        @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
          @ ^ [V1s: A_27a > $o] :
              ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ V1s @ ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2EFINITE @ A_27a @ V1s ) @ ( c_2Epred__set_2ESUBSET @ A_27a @ V1s @ V0A ) ) ) ) ) ) )).
