...
thf(conj_thm_2Eproduct_2EREAL__OF__NUM__NPRODUCT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
           => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V1s ) @ V0f ) ) )
              = ( surj__ty_2Erealax_2Ereal
                @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ V0f @ V2x ) ) ) ) ) ) ) ) ) )).
