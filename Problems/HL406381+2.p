...
fof(conj_thm_2Ehrat_2ETRAT__ADD__SYM__EQ,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ehrat_2ETRAT__ADD__WELLDEFINED,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1q] :
          ( mem(V1q,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
...
fof(conj_thm_2Ehrat_2ETRAT__ADD__WELLDEFINED2,conjecture,(
    ! [V0p1] :
