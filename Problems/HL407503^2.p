...
thf(ax_thm_2Ereal_2Einf__def,axiom,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Einf @ V0p ) )
        = ( surj__ty_2Erealax_2Ereal
          @ ( ap @ c_2Erealax_2Ereal__neg
            @ ( ap @ c_2Ereal_2Esup
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V1r: $i] :
                    ( ap @ V0p @ ( ap @ c_2Erealax_2Ereal__neg @ V1r ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2EREAL__LE__SUP,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ? [V2y: tp__ty_2Erealax_2Ereal] :
                ( p @ ( ap @ V0p @ ( inj__ty_2Erealax_2Ereal @ V2y ) ) )
...
thf(conj_thm_2Ereal_2EREAL__INF__LE,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ? [V2y: tp__ty_2Erealax_2Ereal] :
            ...
            & ? [V3y: tp__ty_2Erealax_2Ereal] :
              ! [V4z: tp__ty_2Erealax_2Ereal] :
                ( ( p @ ( ap @ V0p @ ( inj__ty_2Erealax_2Ereal @ V4z ) ) )
               => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) @ ( inj__ty_2Erealax_2Ereal @ V4z ) ) ) ) )
         => ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Einf @ V0p ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
          <=> ! [V5y: tp__ty_2Erealax_2Ereal] :
                ( ! [V6z: tp__ty_2Erealax_2Ereal] :
                    ( ( p @ ( ap @ V0p @ ( inj__ty_2Erealax_2Ereal @ V6z ) ) )
                   => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) @ ( inj__ty_2Erealax_2Ereal @ V6z ) ) ) )
               => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) ) ) )).
