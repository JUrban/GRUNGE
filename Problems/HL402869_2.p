...
tff(lamtp_f816,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del] : mem(f816(A_27b,A_27c,A_27a),arr(A_27a,arr(ty_2Epair_2Eprod(A_27b,A_27b),A_27a))) )).

tff(lameq_f816,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V1x: $i] :
      ( mem(V1x,A_27a)
     => ap(f816(A_27b,A_27c,A_27a),V1x) = ap(c_2Epair_2EUNCURRY(A_27b,A_27b,A_27b),k(A_27b,k(A_27c,V1x))) ) )).

tff(conj_thm_2Erich__list_2EMAP__FST__funs,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0funs: $i] :
      ( mem(V0funs,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f816(A_27b,A_27c,A_27a))),V0funs) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0funs) ) )).
