...
tff(conj_thm_2Efinite__map_2EDOMSUB__FAPPLY__NEQ,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1k1: $i] :
          ( mem(V1k1,A_27a)
         => ! [V2k2: $i] :
              ( mem(V2k2,A_27a)
             => ( V1k1 != V2k2
               => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V1k1)),V2k2) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0fm),V2k2) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EDOMSUB__FUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2k: $i] :
              ( mem(V2k,A_27a)
             => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g)),V2k) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0f),V2k)),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V1g),V2k)) ) ) ) )).
