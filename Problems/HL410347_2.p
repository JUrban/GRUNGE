...
tff(lmtp_f3633,type,(
    f3633: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3633,axiom,(
    ! [A_27a: del,A_27b: del,V1r: $i] :
     ...
     => ! [V3x: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => mem(f3633(A_27a,A_27b,V1r,V3x,V2f),arr(A_27b,bool)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,V1r: $i] :
     ...
     => ! [V3x: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V4y: $i] :
                  ( mem(V4y,A_27b)
                 => ap(f3633(A_27a,A_27b,V1r,V3x,V2f),V4y) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(A_27a),ap(V2f,V3x)),ap(V2f,V4y)))),ap(ap(V1r,ap(V2f,V3x)),ap(V2f,V4y))) ) ) ) ) )).

tff(lmtp_f3632,type,(
    f3632: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f3632,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V1r: $i] :
      ( mem(V1r,arr(A_27a,arr(A_27a,bool)))
     => ! [V2f: $i] :
          ( mem(V2f,arr(A_27b,A_27a))
         => mem(f3632(A_27b,A_27a,A_27b,V1r,V2f),arr(A_27b,arr(A_27b,bool))) ) ) )).
...
tff(lameq_f3632,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V1r: $i] :
     ...
     => ! [V2f: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27b)
             => ap(f3632(A_27b,A_27a,A_27b,V1r,V2f),V3x) = f3633(A_27a,A_27b,V1r,V3x,V2f) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EPAIRWISE__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(A_27b,A_27a))
             => ( p(ap(ap(c_2Ereal__topology_2Epairwise(A_27a),V1r),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V2f),V0s)))
              <=> p(ap(ap(c_2Ereal__topology_2Epairwise(A_27b),f3632(A_27b,A_27a,A_27b,V1r,V2f)),V0s)) ) ) ) ) )).
