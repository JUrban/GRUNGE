...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardPositive__bottom,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0y] :
             ...
             => ! [V1x] :
                 ...
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,V1x),ap(c_2Erealax_2Ereal__neg,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))
                   => ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardPositive),V1x) = ap(c_2Ebinary__ieee_2Efloat__bottom(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) )).
