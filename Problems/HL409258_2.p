...
tff(lameq_f3214,axiom,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3i: tp__ty_2Enum_2Enum] : ap(f3214(V0d),inj__ty_2Enum_2Enum(V3i)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3i)))),ap(V0d,inj__ty_2Enum_2Enum(V3i))) ) )).

tff(conj_thm_2Eintegral_2ESUM__DIFFS,conjecture,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))),f3214(V0d))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(V0d,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n)))),ap(V0d,inj__ty_2Enum_2Enum(V1m)))) ) )).
