...
thf(f4669_0_2E0,type,(
    f4669_0_2E0: u )).

thf(f4669_0_2E1,type,(
    f4669_0_2E1: du > u )).

thf(f4669_0_2E3,type,(
    f4669_0_2E3: du > du > du > u )).

thf(f4708_0_2E0,type,(
    f4708_0_2E0: u )).

thf(f4708_0_2E2,type,(
    f4708_0_2E2: du > du > u )).

thf(f4708_0_2E3,type,(
    f4708_0_2E3: du > du > du > u )).
...
thf(arityeq1_2Emono_2Ef4669_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4669_0_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4669_0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4669_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4669_0_2E3 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ef4708_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4708_0_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4708_0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4708_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4708_0_2E3 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4708_0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ewellorder_2EWIN__WF2,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4669_0_2E3 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eset__relation_2Estrict_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2EWIN__WF2,axiom,(
    ! [A_27a: d,V0w_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EWF_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4669_0_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) )).

thf(def0_2Ethm_2Ewellorder_2Ewleast__def,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1s_2E0: u,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4708_0_2E3 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2EelsOf_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) )
        ...
        & ! [V3y_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2EelsOf_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) )
...
thf(thm_2Ewellorder_2Ewleast__def,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1s_2E0: u] :
      ...
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Esome_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4708_0_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Ewleast__EQ__NONE,conjecture,(
    ! [A_27a: d,V0w_2E0: u,V1s_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ewellorder_2Ewleast_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
