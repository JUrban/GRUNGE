...
tff(ax_thm_2Ewellorder_2Echain,axiom,(
    ! [A_27a: del,V0l: $i] :
...
tff(lamtp_f1042,axiom,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => mem(f1042(A_27a,V0l),arr(A_27a,bool)) ) )).

tff(lameq_f1042,axiom,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
...
tff(conj_thm_2Ewellorder_2EZL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
tff(conj_thm_2Ewellorder_2EPOSET__RESTRICTED__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Ewellorder_2EFL__RESTRICTED__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Ewellorder_2EZL__SUBSETS,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ( ! [V1c: $i] :
