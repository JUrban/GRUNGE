...
tff(lameq_f594,axiom,(
    ! [A_27c: del,A_27b: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V4x: $i] :
              ( mem(V4x,A_27b)
             => ap(f594(A_27c,A_27b,V1P,V2Q),V4x) = ap(ap(c_2Emin_2E_3D(A_27c),ap(V1P,V4x)),ap(V2Q,V4x)) ) ) ) )).

tff(conj_thm_2EquantHeuristics_2EGUESS__RULES__EQUATION__FORALL__POINT,conjecture,(
     ...
     => ! [V1P: $i] :
         ...
         => ! [V2Q: $i] :
             ...
             => ( ! [V3fv: $i] :
               ...
               => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27a,A_27a),V0i),f594(A_27c,A_27b,V1P,V2Q))) ) ) ) ) )).
