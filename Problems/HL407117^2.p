...
thf(conj_thm_2Erealax_2ETREAL__ADD__LID,lemma,(
    ! [V0x: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Etreal__eq @ ( ap @ ( ap @ c_2Erealax_2Etreal__add @ c_2Erealax_2Etreal__0 ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) ) )).
...
thf(conj_thm_2Erealax_2EREAL__ADD__LID,conjecture,(
