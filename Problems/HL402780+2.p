...
fof(conj_thm_2Erich__list_2ELUPDATE__APPEND1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
             ...
             => ! [V2n] :
                 ...
                 => ! [V3x] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2n),ap(c_2Elist_2ELENGTH(A_27a),V0l1)))
                       => ap(ap(ap(c_2Elist_2ELUPDATE(A_27a),V3x),V2n),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(ap(c_2Elist_2ELUPDATE(A_27a),V3x),V2n),V0l1)),V1l2) ) ) ) ) ) ) )).
