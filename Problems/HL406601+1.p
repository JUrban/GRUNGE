...
fof(arityeq2_2Ec_2Esptree_2Edifference_2E2_2EA_27a_20A_27c,axiom,(
    ! [A_27a,A_27c,X0_2E0,X1_2E0] : s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Edifference_2E2(s(tyop_2Esptree_2Espt(A_27a),X0_2E0),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) = s(tyop_2Esptree_2Espt(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27a),tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27a))),c_2Esptree_2Edifference_2E0),s(tyop_2Esptree_2Espt(A_27a),X0_2E0))),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) )).
...
fof(arityeq1_2Ec_2Esptree_2Esize_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Enum_2Enum,c_2Esptree_2Esize_2E1(s(tyop_2Esptree_2Espt(A_27a),X0_2E0))) = s(tyop_2Enum_2Enum,app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27a),tyop_2Enum_2Enum),c_2Esptree_2Esize_2E0),s(tyop_2Esptree_2Espt(A_27a),X0_2E0))) )).
...
fof(thm_2Esptree_2EIMP__size__LESS__size,axiom,(
    ! [A_27a,V0x_2E0,V1y_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Esptree_2Esubspt_2E2(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0),s(tyop_2Esptree_2Espt(A_27a),V1y_2E0))))
        & s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0))) != s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27a),V1y_2E0))) )
     => p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,c_2Esptree_2Esize_2E1(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0))),s(tyop_2Enum_2Enum,c_2Esptree_2Esize_2E1(s(tyop_2Esptree_2Espt(A_27a),V1y_2E0)))))) ) )).

fof(thm_2Esptree_2Esize__diff__less,conjecture,(
    ! [A_27a,A_27b,A_27c,V0x_2E0,V1y_2E0,V2z_2E0,V3t_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27c),V2z_2E0))),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27b),V1y_2E0))))))
        & p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V3t_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27b),V1y_2E0))))))
        & ~ p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V3t_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27c),V2z_2E0))))))
        & p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Enum_2Enum,V3t_2E0),s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),c_2Esptree_2Edomain_2E1(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0)))))) )
     => p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,c_2Esptree_2Esize_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Edifference_2E2(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0),s(tyop_2Esptree_2Espt(A_27b),V1y_2E0))))),s(tyop_2Enum_2Enum,c_2Esptree_2Esize_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Edifference_2E2(s(tyop_2Esptree_2Espt(A_27a),V0x_2E0),s(tyop_2Esptree_2Espt(A_27c),V2z_2E0)))))))) ) )).
