...
thf(c_2Emetric_2Emetric_2E0,type,(
    c_2Emetric_2Emetric_2E0: u )).

thf(c_2Emetric_2Emetric_2E1,type,(
...
thf(arityeq1_2Emono_2Ec_2Emetric_2Emetric_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ ( c_2Emetric_2Emetric_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emetric_2Emetric @ A_27a ) ) @ c_2Emetric_2Emetric_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Emetric_2Emetric__tybij,axiom,(
    ! [A_27a: d] :
      ( ! [V0a_2E0: u] :
          ( ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ ( c_2Emetric_2Emetric_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ ( c_2Emetric_2Edist_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0a_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0a_2E0 ) )
      & ! [V1r_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Emetric_2Eismet_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ V1r_2E0 ) ) ) )
        <=> ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ ( c_2Emetric_2Edist_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ ( c_2Emetric_2Emetric_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ V1r_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Erealax_2Ereal ) @ V1r_2E0 ) ) ) ) )).

thf(thm_2Emetric_2EMETRIC__ISMET,conjecture,(
    ! [A_27a: d,V0m_2E0: u] :
