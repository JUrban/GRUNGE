...
fof(conj_thm_2Ecardinal_2EHAS__SIZE__NUMSEG__LE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => p(ap(ap(c_2Ecardinal_2EHAS__SIZE(ty_2Enum_2Enum),ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1876(V0n))),ap(ap(c_2Earithmetic_2E_2B,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) )).

fof(conj_thm_2Ecardinal_2EFINITE__NUMSEG__LE,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
