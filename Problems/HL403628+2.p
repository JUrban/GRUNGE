...
fof(mem_c_2Efcp_2EFCP__CONS,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efcp_2EFCP__CONS(A_27a,A_27a,A_27a),arr(A_27a,arr(ty_2Efcp_2Ecart(A_27a,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a)))) ) ) ) )).
...
fof(lameq_f1095,axiom,(
    ! [A_27a,A_27b,V1v] :
     ...
     => ! [V2i] :
          ( mem(V2i,ty_2Enum_2Enum)
         => ap(f1095(A_27a,A_27b,V1v),V2i) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1v),ap(c_2Eprim__rec_2EPRE,V2i)) ) ) )).
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
             ...
             => ! [V0h] :
                 ...
                 => ! [V1v] :
                      ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
                     => ap(ap(c_2Efcp_2EFCP__CONS(A_27a,A_27a,A_27a),V0h),V1v) = ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),c_2Enum_2E0),V0h),ap(c_2Efcp_2EFCP(A_27a,A_27a),f1095(A_27a,A_27b,V1v))) ) ) ) ) ) )).
...
fof(conj_thm_2Efcp_2EFCP__CONS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
