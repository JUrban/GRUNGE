...
thf(f12645_0_2E0,type,(
    f12645_0_2E0: u )).

thf(f12645_0_2E1,type,(
    f12645_0_2E1: du > u )).

thf(f12645_0_2E2,type,(
    f12645_0_2E2: du > du > u )).

thf(f12645_1_2E0,type,(
    f12645_1_2E0: u )).

thf(f12645_1_2E1,type,(
    f12645_1_2E1: du > u )).

thf(f12645_1_2E2,type,(
    f12645_1_2E2: du > du > u )).

thf(f12646_0_2E0,type,(
    f12646_0_2E0: u )).

thf(f12646_0_2E2,type,(
    f12646_0_2E2: du > du > u )).

thf(f12646_0_2E3,type,(
    f12646_0_2E3: du > du > du > u )).
...
thf(mono_2Ef12645_0,type,(
    mono_2Ef12645_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12645_1,type,(
    mono_2Ef12645_1: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12646_0,type,(
    mono_2Ef12646_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUMMABLE__SUBSET,axiom,(
    ! [V1s: mono_2Etyop_2Enum_2Enum > $o,V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12646_0 @ V1s @ V0x @ V3i )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3i @ V1s ) @ ( V0x @ V3i ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__SUBSET,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Enum_2Enum @ V1s @ V2t )
        & ( mono_2Ec_2Ereal__topology_2Esummable @ V2t @ ( mono_2Ef12646_0 @ V1s @ V0x ) ) )
...
thf(def0_2Ethm_2Ereal__topology_2ESUMMABLE__SUBSET__ABSCONV,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12645_1 @ V0x @ V4n )
      = ( mono_2Ec_2Ereal_2Eabs @ ( V0x @ V4n ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESUMMABLE__SUBSET__ABSCONV,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12645_0 @ V0x @ V3n )
      = ( mono_2Ec_2Ereal_2Eabs @ ( V0x @ V3n ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__SUBSET__ABSCONV,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esummable @ V1s @ ( mono_2Ef12645_0 @ V0x ) )
        & ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Enum_2Enum @ V2t @ V1s ) )
     => ( mono_2Ec_2Ereal__topology_2Esummable @ V2t @ ( mono_2Ef12645_1 @ V0x ) ) ) )).
