...
fof(ax_thm_2Ecombin_2EI__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ecombin_2EI(A_27a) = ap(ap(c_2Ecombin_2ES(A_27a,A_27a,A_27a),c_2Ecombin_2EK(A_27a,A_27a)),c_2Ecombin_2EK(A_27a,A_27a)) ) )).
...
fof(conj_thm_2Ecombin_2EI__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
