...
fof(lameq_f902,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f902(V0a,V1b),V2t0) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f889(V0a)),V1b),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESBEFORE__AS__UNTIL,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2EOmega__Automata_2EBUECHI__TRANSLATION,conjecture,(
    ! [V0Phi] :
