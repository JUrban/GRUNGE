...
fof(lamtp_f901,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f901(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f901,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f901(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0a),V1b),V2t0)),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESUNTIL__AS__UNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V1b) = f901(V0a,V1b) ) ) )).
