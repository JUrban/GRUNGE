...
fof(conj_thm_2Ereal__topology_2EDIAMETER__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
              & ! [V2x] :
                 ...
                 => ap(c_2Ereal_2Eabs,ap(V0f,V2x)) = ap(c_2Ereal_2Eabs,V2x) ) )
           => ap(c_2Ereal__topology_2Ediameter,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)) = ap(c_2Ereal__topology_2Ediameter,V1s) ) ) ) )).
