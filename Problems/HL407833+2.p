...
fof(ax_thm_2Einteger_2EINT__ABS,axiom,(
    ! [V0n] :
     ...
     => ap(c_2Einteger_2EABS,V0n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Einteger_2Eint),ap(ap(c_2Einteger_2Eint__lt,V0n),ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0))),ap(c_2Einteger_2Eint__neg,V0n)),V0n) ) )).
...
fof(conj_thm_2EintExtension_2EINT__ABS__NOT0POS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ( V0x != ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
...
fof(conj_thm_2Efrac_2EFRAC__AINV__CALCULATE,lemma,(
    ! [V0a1] :
...
fof(conj_thm_2Efrac_2EFRAC__MINV__CALCULATE,lemma,(
    ! [V0a1] :
      ( mem(V0a1,ty_2Einteger_2Eint)
     => ! [V1b1] :
          ( mem(V1b1,ty_2Einteger_2Eint)
...
fof(conj_thm_2Erat_2ERAT__MINV__CONG,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Efrac_2Efrac)
...
fof(conj_thm_2Erat_2ERAT__EQ0__NMR,lemma,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
...
fof(conj_thm_2Erat_2ERAT__AINV__MINV,conjecture,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
     => ( V0r1 != ap(c_2Erat_2Erat__of__num,c_2Enum_2E0)
