...
thf(tp_c_2Erelation_2EWFP,type,(
    c_2Erelation_2EWFP: del > $i )).

thf(mem_c_2Erelation_2EWFP,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Erelation_2EWFP @ A_27a ) @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) @ ( arr @ A_27a @ bool ) ) ) )).
...
thf(conj_thm_2Erelation_2EINDUCTION__WF__THM,lemma,(
    ! [A_27a: del,V0R: $i] :
...
thf(conj_thm_2Erelation_2EWF__EQ__INDUCTION__THM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
      <=> ! [V1P: $i] :
...
thf(conj_thm_2Erelation_2EWFP__RULES,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Erelation_2EWFP__STRONG__INDUCT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1R: $i] :
...
thf(conj_thm_2Erelation_2EWF__EQ__WFP,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
      <=> ! [V1x: $i] :
