...
thf(ax_thm_2Equotient__pred__set_2EDELETER__def,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
              ( ( mem @ V2x @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Equotient__pred__set_2EDELETER @ A_27a ) @ V0R ) @ V1s ) @ V2x )
                = ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V3y: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V3y ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3y ) @ V1s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ V0R @ V2x ) @ V3y ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Equotient__pred__set_2EIN__DELETER,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
