...
fof(lamtp_f3834,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => mem(f3834(A_27a,V1f,V4x),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3834,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => ! [V5a] :
              ( mem(V5a,A_27a)
             => ap(f3834(A_27a,V1f,V4x),V5a) = ap(ap(V1f,V5a),V4x) ) ) ) )).

fof(lamtp_f3833,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2s] :
...
fof(lameq_f3833,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V2s] :
         ...
         => ! [V4x] :
              ( mem(V4x,ty_2Erealax_2Ereal)
             => ap(f3833(A_27a,V1f,V2s),V4x) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3834(A_27a,V1f,V4x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
