...
thf(conj_thm_2Ereal_2EREAL__BIGNUM,lemma,(
    ! [V0r: tp__ty_2Erealax_2Ereal] :
    ? [V1n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EREAL__ARCH__INV,conjecture,(
