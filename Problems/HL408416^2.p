...
thf(conj_thm_2Etransc_2EMCLAURIN__ALL__LE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Etransc_2EMCLAURIN__EXP__LE,conjecture,(
    ...
    ? [V2t: tp__ty_2Erealax_2Ereal] :
      ...
      & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
        = ( surj__ty_2Erealax_2Ereal
          @ ( ap
            @ ( ap @ c_2Erealax_2Ereal__add
              @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3m: $i] :
                      ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V3m ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V3m ) ) ) ) ) )
            @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V2t ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) )).
