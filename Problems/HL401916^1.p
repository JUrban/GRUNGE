...
thf(thm_2Earithmetic_2EEVEN__DOUBLE,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Earithmetic_2EEVEN @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0n ) ) )).
...
thf(thm_2Earithmetic_2EEVEN__MOD2,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2EEVEN @ V0x )
    <=> ( ( mono_2Ec_2Earithmetic_2EMOD @ V0x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
        = mono_2Ec_2Enum_2E0 ) ) )).
...
thf(thm_2Enumeral__bit_2EiSUC,axiom,(
    mono_2Ec_2Enumeral__bit_2EiSUC = mono_2Ec_2Enum_2ESUC )).

thf(thm_2Enumeral__bit_2EiDIV2,axiom,(
    mono_2Ec_2Enumeral__bit_2EiDIV2 = mono_2Ec_2Earithmetic_2EDIV2 )).

thf(thm_2Enumeral__bit_2ENUMERAL__iDIV2,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ mono_2Ec_2Earithmetic_2EZERO )
        = mono_2Ec_2Earithmetic_2EZERO )
      & ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ ( mono_2Ec_2Enumeral__bit_2EiSUC @ mono_2Ec_2Earithmetic_2EZERO ) )
        = mono_2Ec_2Earithmetic_2EZERO )
      & ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) )
        = V0n )
      & ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ ( mono_2Ec_2Enumeral__bit_2EiSUC @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) ) )
        = ( mono_2Ec_2Enumeral__bit_2EiSUC @ V0n ) )
      & ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V0n ) )
        = ( mono_2Ec_2Enumeral__bit_2EiSUC @ V0n ) )
      & ( ( mono_2Ec_2Enumeral__bit_2EiDIV2 @ ( mono_2Ec_2Enumeral__bit_2EiSUC @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V0n ) ) )
        = ( mono_2Ec_2Enumeral__bit_2EiSUC @ V0n ) )
      & ( ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enumeral__bit_2EiSUC @ V0n ) )
        = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) ) ) )).
