...
tff(mem_c_2Epair_2ESWAP,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epair_2ESWAP(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27a,A_27a))) )).
...
tff(conj_thm_2Eset__relation_2Etc__SWAP,lemma,(
    ! [A_27a: del,V0r: $i] :
...
tff(conj_thm_2Eset__relation_2Eacyclic__SWAP,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
tff(conj_thm_2Eset__relation_2Eminimal__elements__SWAP,lemma,(
    ! [A_27a: del,V0xs: $i] :
...
tff(conj_thm_2Eset__relation_2Efinite__acyclic__has__maximal__path,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1r: $i] :
          ( mem(V1r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
