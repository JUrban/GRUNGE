...
tff(mem_c_2Ewords_2Eword__modify,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__modify(A_27a),arr(arr(ty_2Enum_2Enum,arr(bool,bool)),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).

tff(lmtp_f2185,type,(
    f2185: ( del * $i * $i ) > $i )).

tff(lamtp_f2185,axiom,(
    ! [A_27a: del,V0f: $i] :
...
tff(lameq_f2185,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2185(A_27a,V0f,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(V0f,inj__ty_2Enum_2Enum(V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i))) ) ) )).
...
tff(lmtp_f2226,type,(
    f2226: ( tp__o * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2226,axiom,(
    ! [V1x: tp__o,V0n: tp__ty_2Enum_2Enum,V2i: tp__ty_2Enum_2Enum] : mem(f2226(V1x,V0n,V2i),arr(bool,bool)) )).

tff(lameq_f2226,axiom,(
    ! [V1x: tp__o,V0n: tp__ty_2Enum_2Enum,V2i: tp__ty_2Enum_2Enum,V3b: tp__o] : ap(f2226(V1x,V0n,V2i),inj__o(V3b)) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V0n))),inj__o(V1x)),inj__o(V3b)) )).

tff(lmtp_f2225,type,(
    f2225: ( tp__o * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2225,axiom,(
    ! [V1x: tp__o,V0n: tp__ty_2Enum_2Enum] : mem(f2225(V1x,V0n),arr(ty_2Enum_2Enum,arr(bool,bool))) )).

tff(lameq_f2225,axiom,(
    ! [V1x: tp__o,V0n: tp__ty_2Enum_2Enum,V2i: tp__ty_2Enum_2Enum] : ap(f2225(V1x,V0n),inj__ty_2Enum_2Enum(V2i)) = f2226(V1x,V0n,V2i) )).

tff(conj_thm_2Ewords_2EBIT__UPDATE,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: tp__o] : ap(ap(c_2Efcp_2E_3A_2B(bool,bool),inj__ty_2Enum_2Enum(V0n)),inj__o(V1x)) = ap(c_2Ewords_2Eword__modify(A_27a),f2225(V1x,V0n)) )).
