...
thf(thm_2Ereal__topology_2ESETDIST__TRIANGLE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2t: tyop_2Erealax_2Ereal > $o] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V2t ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V2t ) ) ) ) )).
