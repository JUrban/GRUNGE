...
thf(f12336_0_2E0,type,(
    f12336_0_2E0: u )).

thf(f12336_0_2E1,type,(
    f12336_0_2E1: du > u )).

thf(f12336_0_2E2,type,(
    f12336_0_2E2: du > du > u )).

thf(f12336_1_2E0,type,(
    f12336_1_2E0: u )).

thf(f12336_1_2E1,type,(
    f12336_1_2E1: du > u )).

thf(f12336_1_2E2,type,(
    f12336_1_2E2: du > du > u )).

thf(f13890_0_2E0,type,(
    f13890_0_2E0: u )).

thf(f13890_0_2E1,type,(
    f13890_0_2E1: du > u )).

thf(f13890_0_2E2,type,(
    f13890_0_2E2: du > du > u )).

thf(f14020_0_2E0,type,(
    f14020_0_2E0: u )).

thf(f14020_0_2E1,type,(
    f14020_0_2E1: du > u )).

thf(f14020_0_2E2,type,(
...
thf(mono_2Ef12336_0,type,(
    mono_2Ef12336_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12336_1,type,(
    mono_2Ef12336_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13890_0,type,(
    mono_2Ef13890_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef14020_0,type,(
    mono_2Ef14020_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECOMPACT__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13890_0 @ V0a @ V2x )
...
thf(thm_2Ereal__topology_2ECOMPACT__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13890_0 @ V0a ) @ V1s ) )
      = ( mono_2Ec_2Ereal__topology_2Ecompact @ V1s ) ) )).

thf(def0_2Ethm_2Ereal__topology_2ELOCALLY__TRANSLATION,axiom,(
    ! [V4a: mono_2Etyop_2Erealax_2Ereal,V6x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12336_1 @ V4a @ V6x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V4a @ V6x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ELOCALLY__TRANSLATION,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12336_0 @ V1a @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ V3x ) ) )).
...
thf(thm_2Ereal__topology_2ELOCALLY__TRANSLATION,axiom,(
    ! [V0P: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o] :
      ( ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( V0P @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12336_0 @ V1a ) @ V2s ) )
          = ( V0P @ V2s ) )
     => ! [V4a: mono_2Etyop_2Erealax_2Ereal,V5s: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12336_1 @ V4a ) @ V5s ) )
          = ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ V5s ) ) ) )).

thf(def0_2Ethm_2Ereal__topology_2ELOCALLY__COMPACT__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef14020_0 @ V0a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V2x ) ) )).

thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__TRANSLATION__EQ,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Elocally @ mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef14020_0 @ V0a ) @ V1s ) )
