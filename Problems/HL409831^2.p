...
thf(conj_thm_2Eiterate_2ESUM__SWAP,lemma,(
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal
                    @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                      @ ( lam @ A_27a
                        @ ^ [V3i: $i] :
                            ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27b ) @ V2t ) @ ( ap @ V0f @ V3i ) ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal
                    @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27b ) @ V2t )
                      @ ( lam @ A_27b
                        @ ^ [V4j: $i] :
                            ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                            @ ( lam @ A_27a
...
thf(conj_thm_2Eiterate_2ESUM__RESTRICT__SET,lemma,(
    ! [A_27a: del,V0P: $i] :
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Eiterate_2ESum @ A_27a )
                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ V0P @ V3x ) ) ) ) ) )
                    @ V2f ) )
                = ( surj__ty_2Erealax_2Ereal
                  @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                    @ ( lam @ A_27a
                      @ ^ [V4x: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ V0P @ V4x ) ) @ ( ap @ V2f @ V4x ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ESUM__SUM__RESTRICT,conjecture,(
