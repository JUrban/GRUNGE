...
thf(conj_thm_2Ebag_2EBAG__GEN__SUM__EMPTY,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebag_2EBAG__GEN__SUM @ ( c_2Ebag_2EEMPTY__BAG @ ty_2Enum_2Enum ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      = V0n ) )).
