...
fof(conj_thm_2Eprobability_2EINCREASING__PROB,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
...
fof(conj_thm_2Eprobability_2EPROB__SPACE__INCREASING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Eprobability_2EPROB__INCREASING,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
