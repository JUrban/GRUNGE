...
tff(lmtp_f1030,type,(
    f1030: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1030,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
     ...
     => ! [V2x: $i] :
         ...
         => ! [V0w: $i] :
             ...
             => mem(f1030(A_27a,A_27a,V1s,V2x,V0w),arr(A_27a,bool)) ) ) ) )).

tff(lameq_f1030,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ! [V0w: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27a)
                 => ap(f1030(A_27a,A_27a,V1s,V2x,V0w),V3y) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3y),ap(c_2Ewellorder_2EelsOf(A_27a),V0w))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2EIN(A_27a),V3y),V1s))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(A_27a),V2x),V3y))))),ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)),ap(c_2Eset__relation_2Estrict(A_27a),ap(c_2Ewellorder_2Ewellorder__REP(A_27a),V0w)))) ) ) ) ) )).

tff(lmtp_f1029,type,(
    f1029: ( del * del * $i * $i ) > $i )).

tff(lamtp_f1029,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Ewellorder_2Ewellorder(A_27a))
         => mem(f1029(A_27a,A_27a,V1s,V0w),arr(A_27a,bool)) ) ) )).

tff(lameq_f1029,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f1029(A_27a,A_27a,V1s,V0w),V2x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Ewellorder_2EelsOf(A_27a),V0w))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))),ap(c_2Ebool_2E_21(A_27a),f1030(A_27a,A_27a,V1s,V2x,V0w)))) ) ) ) )).

tff(ax_thm_2Ewellorder_2Ewleast__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Ewellorder_2Ewellorder(A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ap(ap(c_2Ewellorder_2Ewleast(A_27a),V0w),V1s) = ap(c_2Eoption_2Esome(A_27a),f1029(A_27a,A_27a,V1s,V0w)) ) ) )).

tff(conj_thm_2Ewellorder_2Ewleast__SUBSET,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Ewellorder_2Ewellorder(A_27a))
     => ! [V1s1: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3s2: $i] :
                 ...
                 => ! [V4y: $i] :
                      ( mem(V4y,A_27a)
                     => ( ( ap(ap(c_2Ewellorder_2Ewleast(A_27a),V0w),V1s1) = ap(c_2Eoption_2ESOME(A_27a),V2x)
                          & ap(ap(c_2Ewellorder_2Ewleast(A_27a),V0w),V3s2) = ap(c_2Eoption_2ESOME(A_27a),V4y)
