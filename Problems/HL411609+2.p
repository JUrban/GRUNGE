...
fof(conj_thm_2Ereal__topology_2ECONNECTED__IVT__HYPERPLANE,lemma,(
    ! [V0s] :
             ...
             => ! [V3a] :
                 ...
                 => ! [V4b] :
                     ...
                     => ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
                          ...
                          & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,V3a),V1x)),V4b))
                          & p(ap(ap(c_2Ereal_2Ereal__lte,V4b),ap(ap(c_2Erealax_2Ereal__mul,V3a),V2y))) )
                       => ? [V5z] :
                            ( mem(V5z,ty_2Erealax_2Ereal)
                            & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5z),V0s))
                            & ap(ap(c_2Erealax_2Ereal__mul,V3a),V5z) = V4b ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ! [V3a] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V0s))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,V1x),V3a))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,V3a),V2y)) )
                   => ? [V4z] :
                        ( mem(V4z,ty_2Erealax_2Ereal)
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4z),V0s))
                        & V4z = V3a ) ) ) ) ) ) )).
