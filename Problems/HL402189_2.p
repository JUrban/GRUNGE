...
tff(conj_thm_2Elist_2EMEM__FLAT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1L: $i] :
...
tff(conj_thm_2Elist_2EFLAT__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Elist_2EALL__DISTINCT__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Elist_2EALL__DISTINCT__FLAT__REVERSE,conjecture,(
    ! [A_27a: del,V0xs: $i] :
