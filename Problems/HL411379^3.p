...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__MONO,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2x: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V2x ) @ ( c_2Ereal__topology_2Econnected__component @ V1t @ V2x ) ) ) )).
