...
tff(lameq_f3849,axiom,(
    ! [V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V5u: $i] :
              ( mem(V5u,arr(ty_2Erealax_2Ereal,bool))
             => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3849(V2s,V0f,V5u),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),V5u))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__RIGHT__INVERSE__IMP__QUOTIENT__MAP,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
                      ...
                      & ! [V4y: tp__ty_2Erealax_2Ereal] :
                          ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4y)),V3t))
                         => surj__ty_2Erealax_2Ereal(ap(V0f,ap(V1g,inj__ty_2Erealax_2Ereal(V4y)))) = V4y ) )
                   => ! [V5u: $i] :
                        ( mem(V5u,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3850,axiom,(
    ! [V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V4u: $i] :
              ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
             => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3850(V2s,V0f,V4u),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V5x))),V4u))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__LEFT__INVERSE__IMP__QUOTIENT__MAP,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
                  ...
                  & ! [V3x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => surj__ty_2Erealax_2Ereal(ap(V1g,ap(V0f,inj__ty_2Erealax_2Ereal(V3x)))) = V3x ) )
               => ! [V4u: $i] :
                    ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
                   => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V4u),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s)))
                     => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3850(V2s,V0f,V4u))))
                      <=> p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s))),V4u)) ) ) ) ) ) ) ) )).
