...
tff(lmtp_f2106,type,(
    f2106: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2106,axiom,(
...
tff(lmtp_f2105,type,(
    f2105: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f2105,axiom,(
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__MAP,lemma,(
...
tff(lmtp_f2111,type,(
    f2111: ( del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2111,axiom,(
    ! [A_27d: del,A_27b: del,A_27a: del,A_27c: del,V0f1: $i] :
      ( mem(V0f1,arr(A_27a,A_27b))
     => ! [V5x: $i] :
          ( mem(V5x,A_27a)
...
tff(lmtp_f2110,type,(
    f2110: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f2110,axiom,(
    ! [A_27c: del,A_27b: del,A_27d: del,A_27a: del,V0f1: $i] :
      ( mem(V0f1,arr(A_27a,A_27b))
     => ! [V1f2: $i] :
          ( mem(V1f2,arr(A_27c,A_27d))
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__MAP__matchable,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f1: $i] :
      ( mem(V0f1,arr(A_27a,A_27b))
     => ! [V1f2: $i] :
          ( mem(V1f2,arr(A_27c,A_27d))
