...
thf(conj_thm_2Earithmetic_2ELESS__EQ__IFF__LESS__SUC,lemma,(
...
thf(conj_thm_2Earithmetic_2ESUC__MOD,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
     => ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2b ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
