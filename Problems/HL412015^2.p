...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__SUM,lemma,(
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27b ) @ V3s ) )
                      ...
                      & ! [V4i: $i] :
                         ...
                         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V4i ) @ V3s ) )
                           => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ V1f @ V4i ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) ) ) )
                      & ! [V5x: $i] :
                          ( ( mem @ V5x @ A_27a )
                         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ ( ap @ ( c_2Emeasure_2Espace @ A_27a ) @ V0a ) ) )
                           => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ V2g @ V5x ) )
                              = ( surj__ty_2Eextreal_2Eextreal
                                @ ( ap
...
thf(conj_thm_2Elebesgue_2Epos__fn__integral__sum,conjecture,(
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27b ) @ V2s ) )
                  ...
                  & ! [V5i: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V5i ) @ V2s ) )
                       => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ V1f @ V5i ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) @ ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V0m ) ) ) @ c_2Emeasure_2EBorel ) ) ) ) ) )
               => ( ( surj__ty_2Eextreal_2Eextreal
                    @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m )
                      @ ( lam @ A_27a
                        @ ^ [V6x: $i] :
                  ...
                  = ( surj__ty_2Eextreal_2Eextreal
                    @ ( ap
                      @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27b )
                        @ ( lam @ A_27b
                          @ ^ [V8i: $i] :
                              ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m ) @ ( ap @ V1f @ V8i ) ) ) )
                      @ V2s ) ) ) ) ) ) ) )).
