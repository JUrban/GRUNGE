...
tff(conj_thm_2Ereal__topology_2ECLOSED__APPROACHABLE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__CLOSED__NEST,conjecture,(
    ! [V0s: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] : p(ap(c_2Ereal__topology_2EClosed,ap(V0s,inj__ty_2Enum_2Enum(V1n))))
          ...
          & p(ap(c_2Ereal__topology_2Ebounded__def,ap(V0s,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) )
       => ? [V5a: tp__ty_2Erealax_2Ereal] :
          ! [V6n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5a)),ap(V0s,inj__ty_2Enum_2Enum(V6n)))) ) ) )).
