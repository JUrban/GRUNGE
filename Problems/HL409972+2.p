...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__POS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               ...
               => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s))) ) ) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__MONO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Eextreal_2Esup__const__over__set,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(lamtp_f3476,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V6n] :
          ( mem(V6n,ty_2Enum_2Enum)
         => mem(f3476(V0f,V6n),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f3476,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V6n] :
          ( mem(V6n,ty_2Enum_2Enum)
         => ! [V7i] :
             ...
             => ap(f3476(V0f,V6n),V7i) = ap(ap(V0f,V7i),V6n) ) ) ) )).

fof(lamtp_f3475,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => mem(f3475(V0f,V1s),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f3475,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V6n] :
              ( mem(V6n,ty_2Enum_2Enum)
             => ap(f3475(V0f,V1s),V6n) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Enum_2Enum),f3476(V0f,V6n)),V1s) ) ) ) )).

fof(lamtp_f3477,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => mem(f3477(V0f),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f3477,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V8i] :
          ( mem(V8i,ty_2Enum_2Enum)
         => ap(f3477(V0f),V8i) = ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(V0f,V8i)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) )).

fof(conj_thm_2Eextreal_2Esup__sum__mono,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V1s))
              & ! [V2i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2i),V1s))
                   => ! [V3n] :
                        ( mem(V3n,ty_2Enum_2Enum)
                       => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(ap(V0f,V2i),V3n))) ) ) )
              & ! [V4i] :
                  ( mem(V4i,ty_2Enum_2Enum)
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4i),V1s))
                   => ! [V5n] :
                        ( mem(V5n,ty_2Enum_2Enum)
                       => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(V0f,V4i),V5n)),ap(ap(V0f,V4i),ap(c_2Enum_2ESUC,V5n)))) ) ) ) )
           => ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3475(V0f,V1s)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(ty_2Enum_2Enum),f3477(V0f)),V1s) ) ) ) )).
