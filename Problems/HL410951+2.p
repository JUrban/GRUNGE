...
fof(conj_thm_2Ereal__topology_2ELIM__WITHIN,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ELIM__TRANSFORM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
         ...
         => ! [V1f] :
             ...
             => ! [V2g] :
                 ...
                 => ! [V3l] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3786(A_27a,V1f,V2g)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net))
...
fof(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN,conjecture,(
    ! [V0l] :
