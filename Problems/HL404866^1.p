...
thf(thm_2EternaryComparisons_2Eordering2num__ONTO,conjecture,(
    ...
    <=> ? [V1a: mono_2Etyop_2EternaryComparisons_2Eordering] :
          ( V0r
          = ( mono_2Ec_2EternaryComparisons_2Eordering2num @ V1a ) ) ) )).
