...
fof(conj_thm_2Epred__set_2EPREIMAGE__COMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Emeasure_2EMEASURABLE__COMP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V3b] :
                             ...
                             => ! [V4c] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V0f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V2a),V3b)))
                                      & p(ap(ap(c_2Ebool_2EIN(arr(A_27b,A_27c)),V1g),ap(ap(c_2Emeasure_2Emeasurable(A_27b,A_27b),V3b),V4c))) )
