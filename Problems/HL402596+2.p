...
fof(conj_thm_2Earithmetic_2EADD__SUC,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Erich__list_2ELENGTH__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1k] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V0n),V1k)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(c_2Elist_2ELENGTH(A_27a),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1k),V2l)) = V0n ) ) ) ) ) )).
