...
fof(lameq_f1320,axiom,(
    ! [V1b] :
     ...
     => ! [V17t] :
         ...
         => ap(f1320(V1b),V17t) = ap(c_2Ebool_2E_7E,ap(V1b,V17t)) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V8t] :
             ...
             => ap(f1340(V0a,V1b),V8t) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V0a,V8t)),ap(V1b,V8t)) ) ) ) )).

fof(lamtp_f1342,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1342,axiom,(
    ! [V1b] :
     ...
     => ! [V10t] :
         ...
         => ap(f1342(V1b),V10t) = ap(c_2Ebool_2E_7E,ap(V1b,V10t)) ) ) )).
...
fof(lamtp_f1389,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1389(V0a),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f1389,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1389(V0a),V2t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f882(V0a)),V2t)) ) ) )).

fof(lamtp_f1390,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1390(V0a),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f1390,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f1390(V0a),V5t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a),V5t) ) ) )).

fof(lamtp_f1391,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1391(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V7t] :
             ...
             => ap(f1391(V1b,V0a),V7t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V1b),f1340(V0a,V1b)),V7t) ) ) ) )).

fof(lamtp_f1392,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1392(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V9t] :
             ...
             => ap(f1392(V0a,V1b),V9t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1342(V1b)),f1329(V0a,V1b)),V9t)) ) ) ) )).

fof(lamtp_f1393,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1393(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V12t] :
             ...
             => ap(f1393(V0a,V1b),V12t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1331(V0a)),V1b),V12t)) ) ) ) )).

fof(lamtp_f1394,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1394(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V14t] :
             ...
             => ap(f1394(V0a,V1b),V14t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V1b),f1345(V0a,V1b)),V14t)) ) ) ) )).

fof(lamtp_f1395,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1395(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V16t] :
             ...
             => ap(f1395(V1b,V0a),V16t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1320(V1b)),f1336(V0a,V1b)),V16t) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EPSWHEN__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ( ap(c_2EPast__Temporal__Logic_2EPALWAYS,V0a) = f1389(V0a)
            & ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,V0a) = f1390(V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V1b) = f1391(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),V1b) = f1392(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V0a),V1b) = f1393(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V0a),V1b) = f1394(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),V1b) = f1395(V1b,V0a) ) ) ) )).
