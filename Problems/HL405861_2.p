...
tff(lamtp_f2224,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,bool))
     => mem(f2224(V0f),arr(ty_2Enum_2Enum,arr(bool,bool))) ) )).

tff(lameq_f2224,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,bool))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f2224(V0f),inj__ty_2Enum_2Enum(V1i)) = k(bool,ap(V0f,inj__ty_2Enum_2Enum(V1i))) ) )).

tff(conj_thm_2Ewords_2Efcp__n2w,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,bool))
     => ap(c_2Efcp_2EFCP(bool,bool),V0f) = ap(ap(c_2Ewords_2Eword__modify(A_27a),f2224(V0f)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
