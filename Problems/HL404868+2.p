     ...
     => ! [V2v1] :
         ...
         => ! [V1v0] :
             ...
             => ! [V4m] :
                 ...
                 => ap(f1953(A_27a,V3v2,V2v1,V1v0),V4m) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,V4m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1v0),ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V4m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2v1),V3v2)) ) ) ) ) )).
     ...
     => ! [V0x] :
         ...
         => ! [V1v0] :
             ...
             => ! [V2v1] :
                 ...
                 => ! [V3v2] :
                      ( mem(V3v2,A_27a)
                     => ap(ap(ap(ap(c_2EternaryComparisons_2Eordering__CASE(A_27a),V0x),V1v0),V2v1),V3v2) = ap(f1953(A_27a,V3v2,V2v1,V1v0),ap(c_2EternaryComparisons_2Eordering2num,V0x)) ) ) ) ) ) )).

fof(conj_thm_2EternaryComparisons_2Eordering__case__def,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0v0] :
            ( mem(V0v0,A_27a)
