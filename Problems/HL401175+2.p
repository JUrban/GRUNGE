...
fof(conj_thm_2Elogroot_2ELE__EXP__ISO,lemma,(
    ! [V0e] :
...
fof(conj_thm_2Elogroot_2EEXP__LT__ISO,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Elogroot_2ELOG__UNIQUE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elogroot_2EEXP__MUL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
...
fof(conj_thm_2Elogroot_2ELOG__ROOT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1x] :
