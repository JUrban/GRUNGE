...
fof(arityeq2_2Ec_2Esptree_2Einter_2E2_2EA_27a_20A_27c,axiom,(
    ! [A_27a,A_27c,X0_2E0,X1_2E0] : s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Einter_2E2(s(tyop_2Esptree_2Espt(A_27a),X0_2E0),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) = s(tyop_2Esptree_2Espt(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27a),tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27a))),c_2Esptree_2Einter_2E0),s(tyop_2Esptree_2Espt(A_27a),X0_2E0))),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) )).

fof(arityeq2_2Ec_2Esptree_2Einter_2E2_2EA_27b_20A_27c,axiom,(
    ! [A_27b,A_27c,X0_2E0,X1_2E0] : s(tyop_2Esptree_2Espt(A_27b),c_2Esptree_2Einter_2E2(s(tyop_2Esptree_2Espt(A_27b),X0_2E0),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) = s(tyop_2Esptree_2Espt(A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27b)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27b),tyop_2Emin_2Efun(tyop_2Esptree_2Espt(A_27c),tyop_2Esptree_2Espt(A_27b))),c_2Esptree_2Einter_2E0),s(tyop_2Esptree_2Espt(A_27b),X0_2E0))),s(tyop_2Esptree_2Espt(A_27c),X1_2E0))) )).
...
fof(thm_2Esptree_2Ewf__inter,axiom,(
    ! [A_27a,A_27b,V0m1_2E0,V1m2_2E0] : p(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Einter_2E2(s(tyop_2Esptree_2Espt(A_27a),V0m1_2E0),s(tyop_2Esptree_2Espt(A_27b),V1m2_2E0)))))) )).
