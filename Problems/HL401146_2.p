...
tff(conj_thm_2Eind__type_2EINJA__INJ,lemma,(
    ! [A_27a: del,V0a1: $i] :
      ( mem(V0a1,A_27a)
     => ! [V1a2: $i] :
          ( mem(V1a2,A_27a)
...
tff(conj_thm_2Eind__type_2EINJF__INJ,lemma,(
    ! [A_27a: del,V0f1: $i] :
...
tff(conj_thm_2Eind__type_2EMK__REC__INJ,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eind__type_2EDEST__REC__INJ,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eind__type_2ECONSTR__INJ,conjecture,(
