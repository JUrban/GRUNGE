...
thf(conj_thm_2Ereal__topology_2EOPEN__SUBSET__INTERIOR,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__CLOSURE__IDEMP,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) ) )
