...
thf(thm_2EEncode_2Ecollision__free__def,axiom,(
    ...
    <=> ! [V2x: mono_2Etyop_2Enum_2Enum,V3y: mono_2Etyop_2Enum_2Enum] :
          ( ( ( V1p @ V2x )
            & ( V1p @ V3y )
            & ( ( mono_2Ec_2Earithmetic_2EMOD @ V2x @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0m ) )
              = ( mono_2Ec_2Earithmetic_2EMOD @ V3y @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0m ) ) ) )
         => ( V2x = V3y ) ) ) )).
...
thf(thm_2EEncode_2Ewf__pred__bnum,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1p: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2EEncode_2Ewf__pred__bnum @ V0m @ V1p )
     => ( mono_2Ec_2EEncode_2Ecollision__free @ V0m @ V1p ) ) )).
