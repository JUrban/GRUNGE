...
fof(conj_thm_2Ereal_2EREAL__ADD__RID__UNIQ,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__RE__IM__EQ,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1w] :
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__ADD__RID__UNIQ,conjecture,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1w] :
          ( mem(V1w,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
