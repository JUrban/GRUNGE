...
thf(thm_2Ebag_2EBIG__BAG__UNION__def,axiom,(
    ! [A_27a: $tType,V0sob: ( A_27a > tyop_2Enum_2Enum ) > $o] :
      ( ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V0sob )
      = ( ^ [V1x: A_27a] :
            ( c_2Epred__set_2ESUM__IMAGE @ ( A_27a > tyop_2Enum_2Enum )
...
thf(thm_2Ebag_2EBIG__BAG__UNION__UNION,conjecture,(
    ! [A_27a: $tType,V0s2: ( A_27a > tyop_2Enum_2Enum ) > $o,V1s1: ( A_27a > tyop_2Enum_2Enum ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ ( A_27a > tyop_2Enum_2Enum ) @ V1s1 )
        & ( c_2Epred__set_2EFINITE @ ( A_27a > tyop_2Enum_2Enum ) @ V0s2 ) )
     => ( ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ ( c_2Epred__set_2EUNION @ ( A_27a > tyop_2Enum_2Enum ) @ V1s1 @ V0s2 ) )
        = ( c_2Ebag_2EBAG__DIFF @ A_27a @ ( c_2Ebag_2EBAG__UNION @ A_27a @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V1s1 ) @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V0s2 ) ) @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ ( c_2Epred__set_2EINTER @ ( A_27a > tyop_2Enum_2Enum ) @ V1s1 @ V0s2 ) ) ) ) ) )).
