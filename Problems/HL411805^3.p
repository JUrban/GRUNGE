...
thf(thm_2Ereal__topology_2ESERIES__COMPARISON__UNIFORM,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2P: A_27a > $o,V3s: tyop_2Enum_2Enum > $o] :
      ( ( ? [V4l: tyop_2Erealax_2Ereal] :
            ( c_2Ereal__topology_2Esums @ V1g @ V4l @ V3s )
        & ? [V5N: tyop_2Enum_2Enum] :
          ! [V6n: tyop_2Enum_2Enum,V7x: A_27a] :
            ( ( ( c_2Earithmetic_2E_3C_3D @ V5N @ V6n )
              & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V6n @ V3s )
              & ( V2P @ V7x ) )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0f @ V7x @ V6n ) ) @ ( V1g @ V6n ) ) ) )
     => ? [V8l: A_27a > tyop_2Erealax_2Ereal] :
        ! [V9e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V9e )
         => ? [V10N: tyop_2Enum_2Enum] :
            ! [V11n: tyop_2Enum_2Enum,V12x: A_27a] :
              ( ( ( c_2Earithmetic_2E_3C_3D @ V10N @ V11n )
                & ( V2P @ V12x ) )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V3s @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V11n ) ) @ ( V0f @ V12x ) ) @ ( V8l @ V12x ) ) ) @ V9e ) ) ) ) )).
