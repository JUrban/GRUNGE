...
tff(conj_thm_2Ereal__topology_2ECOMPACT__UNION,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__INSERT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V1s))
       => p(ap(c_2Ereal__topology_2Ecompact,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),V1s))) ) ) )).
