...
thf(conj_thm_2EdefCNF_2EUNIQUE__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1v: $i] :
          ...
          & ! [V11v: $i] :
             ...
             => ! [V12n: tp__ty_2Enum_2Enum,V13conn: $i] :
                 ...
                 => ! [V14a: $o,V15j: tp__ty_2Enum_2Enum] :
                      ( p @ ( ap @ ( ap @ ( ap @ V0P @ V11v ) @ ( inj__ty_2Enum_2Enum @ V12n ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ bool @ ( arr @ bool @ bool ) ) @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) ) @ V13conn ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ bool ) ) @ ( ap @ ( c_2Esum_2EINR @ ty_2Enum_2Enum @ bool ) @ ( inj__o @ V14a ) ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ bool ) @ ( inj__ty_2Enum_2Enum @ V15j ) ) ) ) ) ) ) )
          & ! [V16v: $i] :
