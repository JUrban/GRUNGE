...
tff(conj_thm_2EternaryComparisons_2Enum2ordering__ONTO,conjecture,(
    ! [V0a: tp__ty_2EternaryComparisons_2Eordering] :
    ? [V1r: tp__ty_2Enum_2Enum] :
      ( V0a = surj__ty_2EternaryComparisons_2Eordering(ap(c_2EternaryComparisons_2Enum2ordering,inj__ty_2Enum_2Enum(V1r)))
