...
fof(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ( p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4200(A_27a,V1f)))
                  & ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f) = ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4201(A_27a,V1f)) ) ) ) ) ) )).

fof(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
