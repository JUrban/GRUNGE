...
fof(conj_thm_2Epred__set_2ESUM__IMAGE__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1e] :
              ( mem(V1e,A_27a)
             => ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1e),c_2Epred__set_2EEMPTY(A_27a))) = ap(V0f,V1e) ) ) ) )).
...
fof(conj_thm_2Epred__set_2ESUM__IMAGE__IN__LE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
