...
tff(lameq_f899,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: tp__ty_2Enum_2Enum] : ap(f899(V0a,V1b),inj__ty_2Enum_2Enum(V2t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f893(V1b)),f900(V0a,V1b)),inj__ty_2Enum_2Enum(V2t))),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),inj__ty_2Enum_2Enum(V2t))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2ESWHEN__AS__UNTIL,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
