...
fof(conj_thm_2Ereal_2Ediv__rat,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eextreal_2EINV__IN__Q,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),V0x),c_2Eextreal_2EQ__set))
          & V0x != ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0) )
       => p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),ap(ap(c_2Eextreal_2Eextreal__div,ap(c_2Eextreal_2Eextreal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0x)),c_2Eextreal_2EQ__set)) ) ) )).
