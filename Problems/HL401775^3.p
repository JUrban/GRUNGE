...
thf(thm_2Epred__set_2EPOW__EQNS,conjecture,(
    ! [A_27a: $tType] :
      ...
      & ! [V0e: A_27a,V1s: A_27a > $o] :
          ...
          = ( c_2Ebool_2ELET @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > $o )
            @ ^ [V2ps: ( A_27a > $o ) > $o] :
                ( c_2Epred__set_2EUNION @ ( A_27a > $o ) @ ( c_2Epred__set_2EIMAGE @ ( A_27a > $o ) @ ( A_27a > $o ) @ ( c_2Epred__set_2EINSERT @ A_27a @ V0e ) @ V2ps ) @ V2ps )
