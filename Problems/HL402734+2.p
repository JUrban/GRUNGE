...
fof(conj_thm_2Erich__list_2EELL__APPEND2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l2] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l2)))
               => ! [V2l1] :
                    ( mem(V2l1,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Erich__list_2EELL(A_27a),V0n),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l1),V1l2)) = ap(ap(c_2Erich__list_2EELL(A_27a),V0n),V1l2) ) ) ) ) ) )).
