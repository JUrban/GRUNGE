...
thf(thm_2Ebit_2ELT__TWOEXP,axiom,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0x @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) )
    <=> ( ( V0x = c_2Enum_2E0 )
        | ( c_2Eprim__rec_2E_3C @ ( c_2Ebit_2ELOG2 @ V0x ) @ V1n ) ) ) )).
...
thf(thm_2Ewords_2ELOG2__w2n__lt,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( (~)
        @ ( V0w
          = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) )
