...
tff(conj_thm_2Eordinal_2Eomax__EMPTY,lemma,(
...
tff(conj_thm_2Eordinal_2EordMULT__0L,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eordinal_2EordMULT__continuous,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1s: $i] :
...
tff(conj_thm_2Eordinal_2Eislimit__mul__R,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
