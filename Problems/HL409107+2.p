...
fof(conj_thm_2Ereal_2EREAL__NEG__GT0,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__POW2__ABS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Etransc_2EPOW__2__SQRT,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
...
fof(conj_thm_2Etransc_2ESIN__COS__SQ,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
...
fof(conj_thm_2Ecomplex_2EMODU__POW2,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ecomplex_2EMODU__POS,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(c_2Ecomplex_2Emodu,V0z))) ) )).

fof(conj_thm_2Ecomplex_2ERE__DIV__MODU__ACS__BOUNDS,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( V0z != ap(c_2Ecomplex_2Ecomplex__of__num,c_2Enum_2E0)
...
fof(conj_thm_2Ecomplex_2ERE__DIV__MODU__ACS__COS,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( V0z != ap(c_2Ecomplex_2Ecomplex__of__num,c_2Enum_2E0)
...
fof(conj_thm_2Ecomplex_2EARG__SIN,conjecture,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( V0z != ap(c_2Ecomplex_2Ecomplex__of__num,c_2Enum_2E0)
