...
thf(conj_thm_2Eordinal_2Eord__CASES,lemma,(
    ! [A_27a: del,V0a: $i] :
     ...
     => ( ( V0a
        ...
        | ? [V1a0: $i] :
            ...
            & ( V0a
              = ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ V1a0 ) ) )
...
thf(conj_thm_2Eordinal_2Eislimit__mul__R,lemma,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ( ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1a ) )
              = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
           => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V0b ) @ V1a ) ) )
              = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Eomega__exp__islimit,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0a ) )
       => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0a ) ) )
          = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) )).
