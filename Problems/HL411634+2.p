...
fof(conj_thm_2Ecardinal_2ECARD__EQ__BIJECTIONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__EQ__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__FINITE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
           ...
           => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V0s),V1t))
            <=> ap(c_2Epred__set_2ECARD(ty_2Erealax_2Ereal),V0s) = ap(c_2Epred__set_2ECARD(ty_2Erealax_2Ereal),V1t) ) ) ) ) )).
