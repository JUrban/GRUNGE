...
thf(thm_2Equotient_2ERES__EXISTS__UNIQUE__RESPECTS__REGULAR,conjecture,(
    ! [A_27a: d,V0R_2E0: u,V1P_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Equotient_2ERES__EXISTS__EQUIV_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) ) ) )).
