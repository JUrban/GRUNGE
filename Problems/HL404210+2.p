...
fof(conj_thm_2Epath_2Eokpath__take,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epath_2Eokpath__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2i] :
                     ...
                     => ! [V3j] :
                         ...
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2i),V3j))
                              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3j),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                              & p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V0R),V1p)) )
                           => p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V0R),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V2i),V3j),V1p))) ) ) ) ) ) ) ) )).
