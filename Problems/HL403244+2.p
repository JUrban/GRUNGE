...
fof(conj_thm_2Ebag_2EBAG__UNION__LEFT__CANCEL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__UNION__RIGHT__CANCEL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__UNION__DIFF__eliminate,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__DELETE__TWICE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b0] :
          ( mem(V0b0,arr(A_27a,ty_2Enum_2Enum))
