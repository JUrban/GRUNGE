...
fof(lamtp_f3988,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4b] :
          ( mem(V4b,ty_2Erealax_2Ereal)
         => mem(f3988(A_27a,V1f,V4b),arr(A_27a,bool)) ) ) )).

fof(lameq_f3988,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4b] :
          ( mem(V4b,ty_2Erealax_2Ereal)
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f3988(A_27a,V1f,V4b),V5x) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V5x)),V4b) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__COMPONENT__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
