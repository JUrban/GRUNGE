...
thf(thm_2Ebag_2EBAG__IN__BIG__BAG__UNION,conjecture,(
    ! [A_27a: $tType,V0e: A_27a,V1P: ( A_27a > tyop_2Enum_2Enum ) > $o] :
      ( ( c_2Epred__set_2EFINITE @ ( A_27a > tyop_2Enum_2Enum ) @ V1P )
     => ( ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V1P ) )
      <=> ? [V2b: A_27a > tyop_2Enum_2Enum] :
            ( ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ V2b )
            & ( c_2Ebool_2EIN @ ( A_27a > tyop_2Enum_2Enum ) @ V2b @ V1P ) ) ) ) )).
