...
thf(thm_2Ebag_2EBAG__cases,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ...
      | ? [V1b0: A_27a > tyop_2Enum_2Enum,V2e: A_27a] :
          ( V0b
          = ( c_2Ebag_2EBAG__INSERT @ A_27a @ V2e @ V1b0 ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INSERT__EQUAL,axiom,(
    ! [A_27a: $tType,V0b: A_27a,V1a: A_27a,V2N: A_27a > tyop_2Enum_2Enum,V3M: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__INSERT @ A_27a @ V1a @ V3M )
        = ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0b @ V2N ) )
    <=> ( ( ( V3M = V2N )
          & ( V1a = V0b ) )
        | ? [V4k: A_27a > tyop_2Enum_2Enum] :
            ( ( V3M
              = ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0b @ V4k ) )
            & ( V2N
              = ( c_2Ebag_2EBAG__INSERT @ A_27a @ V1a @ V4k ) ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1P: A_27a > $o] :
      ( ( ( c_2Ebag_2EBAG__FILTER @ A_27a @ V1P @ V0b )
        = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
    <=> ( c_2Ebag_2EBAG__EVERY @ A_27a @ ( c_2Ecombin_2Eo @ A_27a @ $o @ $o @ c_2Ebool_2E_7E @ V1P ) @ V0b ) ) )).
...
thf(thm_2Ebag_2ESET__OF__BAG__IMAGE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27b > A_27a,V1b: A_27b > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESET__OF__BAG @ A_27a @ ( c_2Ebag_2EBAG__IMAGE @ A_27a @ A_27b @ V0f @ V1b ) )
      = ( c_2Epred__set_2EIMAGE @ A_27b @ A_27a @ V0f @ ( c_2Ebag_2ESET__OF__BAG @ A_27b @ V1b ) ) ) )).
