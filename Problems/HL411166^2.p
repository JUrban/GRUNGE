...
thf(conj_thm_2Ereal__topology_2ELIM__MAX,lemma,(
    ! [A_27a: del,V0net: $i] :
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5x: $i] :
                                ( ap @ ( ap @ c_2Ereal_2Emax @ ( ap @ V1f @ V5x ) ) @ ( ap @ V2g @ V5x ) ) ) )
                        @ ( ap @ ( ap @ c_2Ereal_2Emax @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ ( inj__ty_2Erealax_2Ereal @ V4m ) ) )
                      @ V0net ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__MAX,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2Emax @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) )
                    @ V2net ) ) ) ) ) ) )).
