...
fof(conj_thm_2Epred__set_2ESUM__IMAGE__INJ__o,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V1g] :
                   ...
                   => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27b,A_27b),V1g),V0s),c_2Epred__set_2EUNIV(A_27a)))
                     => ! [V2f] :
                         ...
                         => ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V1g),V0s)) = ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V2f),V1g)),V0s) ) ) ) ) ) ) ) )).
