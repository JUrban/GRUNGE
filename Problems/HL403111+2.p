...
fof(lamtp_f920,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f920(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f920,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f920(V0a,V1b),V2t0) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1b),f887(V0a,V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__AS__NOT__SWHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2EBEFORE,V0a),V1b) = f920(V0a,V1b) ) ) )).
