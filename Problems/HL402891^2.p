...
thf(conj_thm_2Erich__list_2Emap__replicate,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
          ( ( mem @ V2x @ A_27a )
         => ( ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27b ) @ V0f ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2x ) )
            = ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ V0f @ V2x ) ) ) ) ) )).
