...
thf(conj_thm_2Erich__list_2ELASTN__APPEND1,lemma,(
    ! [A_27a: del,V0l2: $i] :
...
thf(conj_thm_2Erich__list_2EDROP__APPEND1,lemma,(
...
thf(conj_thm_2Erich__list_2EDROP__LENGTH__NIL__rwt,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Erich__list_2EREVERSE__DROP,conjecture,(
    ! [A_27a: del,V0ls: $i] :
      ( ( mem @ V0ls @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0ls ) ) )
         => ( ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0ls ) )
            = ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0ls ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V0ls ) ) ) ) ) )).
