...
tff(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__NIL,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),c_2Elist_2ENIL(arr(A_27a,ty_2Eoption_2Eoption(A_27b)))),inj__o(fo__c_2Ebool_2ET)),c_2Elist_2ENIL(bool))) ) )).
