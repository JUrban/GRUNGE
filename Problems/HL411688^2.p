...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT,conjecture,(
    ! [V0f: $i] :
              ...
              & ! [V2x: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ? [V3e: tp__ty_2Erealax_2Ereal] :
                      ...
                      & ! [V4y: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) ) ) ) ) )
           => ? [V5a: tp__ty_2Erealax_2Ereal] :
              ! [V6x: tp__ty_2Erealax_2Ereal] :
                ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) @ V1s ) )
