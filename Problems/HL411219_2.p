...
tff(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__COMPOSE,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f2912(V0f,V1g)),V2s)) ) ) ) ) )).
