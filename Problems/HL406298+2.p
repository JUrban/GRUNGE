...
fof(mem_c_2Ewords_2En2w__itself,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2En2w__itself(A_27a),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) ) )).

fof(lamtp_f2258,axiom,(
    ! [A_27a] : mem(f2258(A_27a),arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool)),bool)) )).
...
fof(lamtp_f2260,axiom,(
    ! [A_27a,A_27a] : mem(f2260(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Ebool_2Eitself(A_27a),ty_2Efcp_2Ecart(bool,bool)))) )).

fof(lameq_f2260,axiom,(
    ! [A_27a,A_27a,V3v] :
      ( mem(V3v,ty_2Enum_2Enum)
     => ap(f2260(A_27a,A_27a),V3v) = k(ty_2Ebool_2Eitself(A_27a),ap(c_2Ecombin_2EI(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w(A_27a),V3v))) ) )).

fof(lamtp_f2259,axiom,(
    ! [A_27a] : mem(f2259(A_27a),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) )).

fof(lameq_f2259,axiom,(
    ! [A_27a,V2a] :
      ( mem(V2a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(f2259(A_27a),V2a) = ap(ap(c_2Epair_2Epair__CASE(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V2a),f2260(A_27a,A_27a)) ) )).

fof(ax_thm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ewords_2En2w__itself(A_27a) = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Emin_2E_40(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))),f2258(A_27a))),k(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool)),f2259(A_27a))) ) )).

fof(conj_thm_2Ewords_2En2w__itself__def,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ap(c_2Ewords_2En2w__itself(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0n),c_2Ebool_2Ethe__value(A_27a))) = ap(c_2Ewords_2En2w(A_27a),V0n) ) ) )).
