...
thf(thm_2Ebag_2EBAG__ALL__DISTINCT__THM,conjecture,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27a @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
      & ! [V0e: A_27b,V1b: A_27b > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27b @ ( c_2Ebag_2EBAG__INSERT @ A_27b @ V0e @ V1b ) )
        <=> ( ( (~) @ ( c_2Ebag_2EBAG__IN @ A_27b @ V0e @ V1b ) )
            & ( c_2Ebag_2EBAG__ALL__DISTINCT @ A_27b @ V1b ) ) ) ) )).
