...
thf(thm_2Ereal__topology_2EDINI,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ecompact @ V2s )
        & ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Ereal__topology_2Econtinuous__on @ ( V0f @ V3n ) @ V2s )
        & ( c_2Ereal__topology_2Econtinuous__on @ V1g @ V2s )
        ...
        & ! [V6n: tyop_2Enum_2Enum,V7x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V2s )
           => ( c_2Ereal_2Ereal__lte @ ( V0f @ V6n @ V7x ) @ ( V0f @ ( c_2Earithmetic_2E_2B @ V6n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V7x ) ) ) )
         ...
         => ( c_2Ereal__topology_2Eeventually @ tyop_2Enum_2Enum
            @ ^ [V9n: tyop_2Enum_2Enum] :
                ...
                @ ^ [V10x: tyop_2Erealax_2Ereal] :
                    ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V10x @ V2s ) @ ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V0f @ V9n @ V10x ) @ ( V1g @ V10x ) ) ) @ V8e ) ) )
            @ c_2Ereal__topology_2Esequentially ) ) ) )).
