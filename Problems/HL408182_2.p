...
tff(lamtp_f2926,axiom,(
    mem(f2926,arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2926,axiom,(
    ! [V2c: tp__ty_2Erealax_2Ereal] : ap(f2926,inj__ty_2Erealax_2Ereal(V2c)) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(lmtp_f2927,type,(
    f2927: $i )).

tff(lamtp_f2927,axiom,(
    mem(f2927,arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2927,axiom,(
    ! [V3c: tp__ty_2Erealax_2Ereal] : ap(f2927,inj__ty_2Erealax_2Ereal(V3c)) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Epoly_2EPOLY__DIFF__AUX__ISZERO,lemma,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Elist_2EEVERY(ty_2Erealax_2Ereal),f2926),ap(ap(c_2Epoly_2Epoly__diff__aux,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))),inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0p))))
    <=> p(ap(ap(c_2Elist_2EEVERY(ty_2Erealax_2Ereal),f2927),inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0p))) ) )).

tff(conj_thm_2Epoly_2EPOLY__DIFF__ISZERO,conjecture,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal] :
