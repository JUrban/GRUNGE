...
thf(conj_thm_2Eblast_2EBITWISE__ADD,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1y: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0x ) @ V1y )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ ( ap @ ( ap @ ( ap @ c_2Eblast_2EBSUM @ V2i ) @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0x ) ) @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1y ) ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) ) ) ) ) )).
