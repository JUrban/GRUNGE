...
thf(thm_2EHolSmt_2Et029,conjecture,(
    ! [V0x: tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone,V1p: $o] :
      ( ( V1p
      <=> ( V0x
          = ( c_2Ewords_2En2w @ tyop_2Eone_2Eone @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
    <=> ( V0x
        = ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ V1p @ ( c_2Ewords_2En2w @ tyop_2Eone_2Eone @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ewords_2En2w @ tyop_2Eone_2Eone @ c_2Enum_2E0 ) ) ) ) )).
