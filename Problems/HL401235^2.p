...
thf(conj_thm_2Enumpair_2Enlistrec__ind,lemma,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ( ! [V1n: $i] :
       ...
       => ! [V4v: $i] :
           ...
           => ! [V5v1: $i] :
               ...
               => ! [V6v2: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ ( ap @ V0P @ V4v ) @ V5v1 ) @ ( inj__ty_2Enum_2Enum @ V6v2 ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Enumpair_2Enlist__ind,conjecture,(
    ! [V0P: $i] :
