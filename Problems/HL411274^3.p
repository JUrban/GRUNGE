...
thf(thm_2Ereal__topology_2EPROPER__MAP__FROM__COMPACT,conjecture,(
    ! [V0t: tyop_2Erealax_2Ereal > $o,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3k: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V1f @ V2s )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1f @ V2s ) @ V0t )
        & ( c_2Ereal__topology_2Ecompact @ V2s )
        & ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V0t ) @ V3k ) )
     => ( c_2Ereal__topology_2Ecompact
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V4x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V4x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V2s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V1f @ V4x ) @ V3k ) ) ) ) ) ) )).
