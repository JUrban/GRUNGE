...
thf(conj_thm_2Ereal__topology_2ELIM__VMUL,lemma,(
    ! [A_27a: del,V0net: $i] :
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V4x: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1c @ V4x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) ) )
                    @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2d ) ) @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) )
                  @ V0net ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__VMUL,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
