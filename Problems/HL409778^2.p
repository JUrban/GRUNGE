...
thf(conj_thm_2Earithmetic_2EADD__MOD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
     => ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1a ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2b ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
      <=> ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1a ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V2b ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ENSUM__CLAUSES,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
          ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V0f ) )
            = fo__c_2Enum_2E0 ) )
      & ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
         => ! [V2f: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27b ) @ V3s ) )
                   => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27b ) @ V1x ) @ V3s ) ) @ V2f ) )
                      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V1x ) @ V3s ) ) @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b ) @ V3s ) @ V2f ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ V2f @ V1x ) ) @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b ) @ V3s ) @ V2f ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2EMOD__NSUM__MOD,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2s: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V2s ) )
              & ( V1n != fo__c_2Enum_2E0 ) )
           => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s ) @ V0f ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
              = ( surj__ty_2Enum_2Enum
                @ ( ap
                  @ ( ap @ c_2Earithmetic_2EMOD
                    @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s )
                      @ ( lam @ A_27a
                        @ ^ [V3i: $i] :
                            ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ V0f @ V3i ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )
