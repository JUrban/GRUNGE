...
fof(conj_thm_2Ereal__topology_2ESERIES__TRIVIAL,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),c_2Epred__set_2EEMPTY(ty_2Enum_2Enum))) ) )).
