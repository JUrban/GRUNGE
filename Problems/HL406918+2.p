...
fof(conj_thm_2Efmapal_2Einter__merge__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
              ( mem(V0P,arr(ty_2Etoto_2Etoto(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(ty_2Elist_2Elist(A_27a),bool))))
             => ( ( ! [V1cmp] :
                      ( mem(V1cmp,ty_2Etoto_2Etoto(A_27a))
                     => p(ap(ap(ap(V0P,V1cmp),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))),c_2Elist_2ENIL(A_27a))) )
                  & ! [V2cmp] :
                     ...
                     => ! [V3a] :
                         ...
                         => ! [V4b] :
                              ( mem(V4b,A_27b)
                             => ! [V5l] :
                                  ( mem(V5l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                                 => p(ap(ap(ap(V0P,V2cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3a),V4b)),V5l)),c_2Elist_2ENIL(A_27a))) ) ) ) )
                  & ! [V6cmp] :
                     ...
                     => ! [V7y] :
                         ...
                         => ! [V8m] :
                             ...
                             => p(ap(ap(ap(V0P,V6cmp),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))),ap(ap(c_2Elist_2ECONS(A_27a),V7y),V8m))) ) ) )
                  & ! [V9cmp] :
                     ...
                     => ! [V10a] :
                         ...
                         => ! [V11b] :
                              ( mem(V11b,A_27b)
                             => ! [V12l] :
                                  ( mem(V12l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                                 => ! [V13y] :
                                      ( mem(V13y,A_27a)
                                     => ! [V14m] :
                                         ...
                                         => ( ( ( ap(ap(ap(c_2Etoto_2Eapto(A_27a),V9cmp),V10a),V13y) = c_2EternaryComparisons_2EEQUAL
                                              ...
                                              & ( ap(ap(ap(c_2Etoto_2Eapto(A_27a),V9cmp),V10a),V13y) = c_2EternaryComparisons_2EGREATER
                                               => p(ap(ap(ap(V0P,V9cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V10a),V11b)),V12l)),V14m)) )
                                           ...
                                           => p(ap(ap(ap(V0P,V9cmp),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V10a),V11b)),V12l)),ap(ap(c_2Elist_2ECONS(A_27a),V13y),V14m))) ) ) ) ) ) ) ) )
               => ! [V15v] :
                    ( mem(V15v,ty_2Etoto_2Etoto(A_27a))
                   => ! [V16v1] :
                        ( mem(V16v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                       => ! [V17v2] :
