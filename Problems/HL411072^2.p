...
thf(conj_thm_2Ereal__topology_2ELIMPT__INSERT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESEQUENCE__UNIQUE__LIMPT,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__SEQUENCE__WITH__LIMIT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ c_2Ereal__topology_2Esequentially ) )
