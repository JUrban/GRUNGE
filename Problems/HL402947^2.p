...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROW__EXTEND__INPUT,conjecture,(
                                      ...
                                      = ( ap
                                        @ ( ap
                                          @ ( ap @ ( ap @ ( c_2EpatternMatches_2EPMATCH__ROW @ A_27f @ A_27d @ A_27b ) @ V7p_27 )
                                            @ ( lam @ A_27d
                                              @ ^ [V13x: $i] :
                                                  ( ap @ ( ap @ V5g @ ( ap @ V2f_27 @ ( ap @ V7p_27 @ V13x ) ) ) @ ( ap @ V3f @ V13x ) ) ) )
                                          @ ( lam @ A_27d
                                            @ ^ [V14x: $i] :
                                                ( ap @ ( ap @ V6r @ ( ap @ V2f_27 @ ( ap @ V7p_27 @ V14x ) ) ) @ ( ap @ V3f @ V14x ) ) ) )
                                        @ V1v_27 ) ) ) ) ) ) ) ) ) ) ) )).
