...
thf(conj_thm_2Erich__list_2EMEM__FOLDL,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( ( mem @ V0y @ A_27a )
     => ! [V1l: $i] :
                  ...
                  @ ( ap @ ( c_2Elist_2EFOLDL @ A_27a @ bool )
                    @ ( lam @ bool
                      @ ^ [V2l_27: $i] :
                          ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ V2l_27 ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V0y ) @ V3x ) ) ) ) )
                  @ ( inj__o @ fo__c_2Ebool_2EF ) )
                @ V1l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EMEM__FOLDL__MAP,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
