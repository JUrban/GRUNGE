...
thf(conj_thm_2Erich__list_2EDROP__LENGTH__NIL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) @ V0l )
        = ( c_2Elist_2ENIL @ A_27a ) ) ) )).

thf(conj_thm_2Erich__list_2EDROP__LENGTH__NIL__rwt,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1m: tp__ty_2Enum_2Enum] :
          ( ( V1m
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V0l )
            = ( c_2Elist_2ENIL @ A_27a ) ) ) ) )).
