...
tff(lmtp_f2475,type,(
    f2475: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f2475,axiom,(
    ...
    ! [A_27a: del,V1cmp: $i] :
     ...
     => ! [V3x: $i] :
         ...
         => ! [V4r: $i] :
             ...
             => ! [V6z: $i] :
                  ( mem(V6z,A_27a)
                 => ap(f2476(A_27a,V1cmp,V3x,V4r),V6z) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6z),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V6z),ap(ap(c_2Eenumeral_2EENUMERAL(A_27a),V1cmp),V4r))),ap(ap(c_2Emin_2E_3D(ty_2EternaryComparisons_2Eordering),ap(ap(ap(c_2Etoto_2Eapto(A_27a),V1cmp),V3x),V6z)),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS)))) ) ) ) ) )).
...
tff(conj_thm_2Eenumeral_2EIN__bt__to__set,conjecture,(
    ! [A_27a: del] :
      ( ! [V0cmp: $i] :
          ( mem(V0cmp,ty_2Etoto_2Etoto(A_27a))
         => ! [V1y: $i] :
