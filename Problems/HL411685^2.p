...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__DISCRETE__FINITE__RANGE__CONSTANT__EQ,lemma,
    ( ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
      <=> ! [V1f: $i] :
           ...
           => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V1f ) @ V0s ) )
                        ...
                        & ! [V4y: tp__ty_2Erealax_2Ereal] :
                            ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) @ V0s ) )
                              & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) )
                               != ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) )
                           => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) ) ) ) ) )
             => ? [V5a: tp__ty_2Erealax_2Ereal] :
                ! [V6x: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) )
                    = V5a ) ) ) ) ) ) )).
