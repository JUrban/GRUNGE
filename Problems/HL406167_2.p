...
tff(mem_c_2Ewords_2Eword__reverse,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__reverse(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(conj_thm_2Ewords_2Eword__reverse__word__T,conjecture,(
