...
thf(conj_thm_2Eintegral_2ESUP__INTERVAL,lemma,(
    ! [V0P: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => ? [V4s: tp__ty_2Erealax_2Ereal] :
              ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V4s ) ) )
              & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V4s ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
              & ! [V5y: tp__ty_2Erealax_2Ereal] :
                  ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) @ ( inj__ty_2Erealax_2Ereal @ V4s ) ) )
                <=> ? [V6x: tp__ty_2Erealax_2Ereal] :
                      ...
                      & ( p @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) )
                      & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__DIV__LMUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( V1y
       != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) )
        = V0x ) ) )).
...
thf(conj_thm_2Eintegral_2ECONT__UNIFORM,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
