...
tff(lmtp_f3990,type,(
    f3990: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3990,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3990(A_27a,V1f,V3b),arr(A_27a,bool)) ) )).

tff(lameq_f3990,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3990(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,ap(V1f,V4x)),inj__ty_2Erealax_2Ereal(V3b)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__DROP__UBOUND,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net))
                & ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3990(A_27a,V1f,V3b)),V0net)) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2l)),inj__ty_2Erealax_2Ereal(V3b))) ) ) ) )).
