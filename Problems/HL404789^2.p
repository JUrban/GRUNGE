...
thf(conj_thm_2Efinite__map_2EFLOOKUP__DRESTRICT,lemma,(
...
thf(conj_thm_2Efinite__map_2EFLOOKUP__MAP__KEYS,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1m: $i] :
...
thf(conj_thm_2Efinite__map_2EDRESTRICT__MAP__KEYS__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1fm: $i] :
