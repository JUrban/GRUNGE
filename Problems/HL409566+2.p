...
fof(conj_thm_2Elift__ieee_2Efloat__div__relative,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
                   ...
                   => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b))))
                      & ? [V2e] :
...
fof(mem_c_2Emachine__ieee_2Efp32__isZero,axiom,(
    mem(c_2Emachine__ieee_2Efp32__isZero,arr(ty_2Efcp_2Ecart(bool,bool),bool)) )).
...
fof(ax_thm_2Emachine__ieee_2Efp32__isZero__def,axiom,(
    c_2Emachine__ieee_2Efp32__isZero = ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ebinary__ieee_2Efloat__is__zero(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))),c_2Emachine__ieee_2Efp32__to__float) )).
...
fof(conj_thm_2Elift__machine__ieee_2Efp32__float__div__relative,conjecture,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ( ( p(ap(c_2Emachine__ieee_2Efp32__isFinite,V0a))
              ...
              & ~ p(ap(c_2Emachine__ieee_2Efp32__isZero,V1b))
           ...
           => ( p(ap(c_2Emachine__ieee_2Efp32__isFinite,ap(ap(ap(c_2Emachine__ieee_2Efp32__div,c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b)))
              & ? [V2e] :
                  ( mem(V2e,ty_2Erealax_2Ereal)
                  & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V2e)),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))))))))
                  & ap(c_2Emachine__ieee_2Efp32__to__real,ap(ap(ap(c_2Emachine__ieee_2Efp32__div,c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(c_2Emachine__ieee_2Efp32__to__real,V0a)),ap(c_2Emachine__ieee_2Efp32__to__real,V1b))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2e)) ) ) ) ) ) )).
