...
thf(conj_thm_2Ehreal_2EHRAT__DOWN2,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
...
thf(conj_thm_2Ehreal_2EEQUAL__CUTS,lemma,(
...
thf(ax_thm_2Ehreal_2Ehreal__sub,axiom,(
    ! [V0Y: tp__ty_2Ehreal_2Ehreal,V1X: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__sub @ ( inj__ty_2Ehreal_2Ehreal @ V0Y ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1X ) ) )
      = ( surj__ty_2Ehreal_2Ehreal
        @ ( ap @ c_2Ehreal_2Ehreal
          @ ( lam @ ty_2Ehrat_2Ehrat
            @ ^ [V2w: $i] :
                ...
                @ ( lam @ ty_2Ehrat_2Ehrat
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V1X ) ) @ V3x ) ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V0Y ) ) @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__add @ V3x ) @ V2w ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ehreal_2EHREAL__SUB__ISACUT,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) )
     => ( p
        @ ( ap @ c_2Ehreal_2Eisacut
...
thf(conj_thm_2Ehreal_2EHREAL__SUB__ADD,conjecture,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) )
