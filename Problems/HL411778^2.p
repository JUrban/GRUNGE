...
thf(conj_thm_2Ereal__topology_2EINFSUM__SUB,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1y: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2s ) @ V0x ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal
                    @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3i: $i] :
                            ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0x @ V3i ) ) @ ( ap @ V1y @ V3i ) ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s ) @ V0x ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2s ) @ V1y ) ) ) ) ) ) ) ) )).
