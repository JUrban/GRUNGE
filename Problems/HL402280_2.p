...
tff(conj_thm_2Epred__set_2ECARD__INTER__LESS__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ECARD__DIFF,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Elist_2EALL__DISTINCT__CARD__LIST__TO__SET,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
tff(conj_thm_2Elist_2Eall__distinct__nub,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2Elist__to__set__diff,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2Elength__nub__append,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
         => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),V0l1))),ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),ap(ap(c_2Elist_2EFILTER(A_27a),f450(A_27a,A_27a,V0l1)),V1l2))))) ) ) )).
