...
thf(conj_thm_2Ereal__topology_2EFINITE__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V0s ) )
       => ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBOUNDED__SUMS__IMAGE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p
                    @ ( ap @ c_2Ereal__topology_2Ebounded__def
                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ V0f @ V3x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2t ) ) ) ) ) )
                  & ( p
                    @ ( ap @ c_2Ereal__topology_2Ebounded__def
                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ V1g @ V4x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ V2t ) ) ) ) ) ) )
               => ( p
                  @ ( ap @ c_2Ereal__topology_2Ebounded__def
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V0f @ V5x ) ) @ ( ap @ V1g @ V5x ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ V2t ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SUMS__IMAGES,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
                       ...
                       => ( p
                          @ ( ap @ c_2Ereal__topology_2Ebounded__def
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ A_27a )
                              @ ( lam @ A_27a
                                @ ^ [V4x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ V0f @ V4x ) @ V3a ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ V1t ) ) ) ) ) ) ) ) )
               => ( p
                  @ ( ap @ c_2Ereal__topology_2Ebounded__def
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27b ) @ V2s ) @ ( ap @ V0f @ V5x ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ V1t ) ) ) ) ) ) ) ) ) ) )).
