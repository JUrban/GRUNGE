...
thf(conj_thm_2Etc_2EsubTC__INSERT,lemma,(
    ! [A_27a: del,V0R: $i] :
...
thf(conj_thm_2Etc_2EsubTC__INSERT__COR,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ! [V2x: $i] :
             ...
             => ! [V3a: $i] :
                  ( ( mem @ V3a @ A_27a )
                 => ( ( ap @ ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V2x ) @ V1s ) ) @ V3a )
                    = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ ( ap @ ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V1s ) @ V3a ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V1s ) @ V3a ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V1s ) @ V2x ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ V1s ) @ V3a ) ) ) ) ) ) ) )).
