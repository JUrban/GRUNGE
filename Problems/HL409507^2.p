...
thf(conj_thm_2Epred__set_2EBIJ__SYM,lemma,(
...
thf(conj_thm_2Eutil__prob_2ENUM__2D__BIJ__NZ__ALT2,lemma,(
    ? [V0f: $i] :
...
thf(conj_thm_2Eutil__prob_2ENUM__2D__BIJ__NZ__ALT2__INV,conjecture,(
    ? [V0f: $i] :
