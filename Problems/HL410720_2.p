...
tff(conj_thm_2Ereal__topology_2ELIMPT__OF__UNIV,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELIMPT__OF__OPEN__IN,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIMPT__OF__OPEN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
