...
thf(thm_2Ereal__topology_2ELIMPT__SING,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal] :
      ( (~) @ ( c_2Ereal__topology_2Elimit__point__of @ V0x @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1y @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EINTERIOR__SING,conjecture,(
