...
thf(conj_thm_2Erich__list_2ELASTN__LENGTH__APPEND,conjecture,(
    ! [A_27a: del,V0l2: $i] :
      ( ( mem @ V0l2 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l2 ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V1l1 ) @ V0l2 ) )
            = V0l2 ) ) ) )).
