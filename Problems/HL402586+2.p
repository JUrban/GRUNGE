...
fof(lamtp_f767,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => mem(f767(A_27a,A_27b,V0f,V2x),arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b))) ) ) )).

fof(lameq_f767,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ! [V3l_27] :
              ( mem(V3l_27,ty_2Elist_2Elist(A_27b))
             => ap(f767(A_27a,A_27b,V0f,V2x),V3l_27) = ap(ap(c_2Elist_2ECONS(A_27b),ap(V0f,V2x)),V3l_27) ) ) ) )).

fof(lamtp_f766,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => mem(f766(A_27b,A_27a,V0f),arr(A_27a,arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)))) ) )).

fof(lameq_f766,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ap(f766(A_27b,A_27a,V0f),V2x) = f767(A_27a,A_27b,V0f,V2x) ) ) )).

fof(conj_thm_2Erich__list_2EMAP__FOLDR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1l] :
                 ...
                 => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1l) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),f766(A_27b,A_27a,V0f)),c_2Elist_2ENIL(A_27b)),V1l) ) ) ) ) )).
