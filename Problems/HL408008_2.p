...
tff(lmtp_f2737,type,(
    f2737: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2737,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V2f: $i] :
      ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2737(V1k,V2f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2737,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V2f: $i] :
      ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3m: tp__ty_2Enum_2Enum] : ap(f2737(V1k,V2f),inj__ty_2Enum_2Enum(V3m)) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V1k))),inj__ty_2Enum_2Enum(V1k))),V2f) ) )).

tff(conj_thm_2Ereal_2ESUM__GROUP,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1k: tp__ty_2Enum_2Enum,V2f: $i] :
      ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n))),f2737(V1k,V2f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1k)))),V2f)) ) )).
...
tff(lmtp_f2884,type,(
    f2884: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2884,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2884(V1k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2884,axiom,(
    ! [V1k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2884(V1k,V0f),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1k))),inj__ty_2Enum_2Enum(V1k))),V0f) ) )).

tff(conj_thm_2Eseq_2ESER__GROUP,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( ( p(ap(c_2Eseq_2Esummable,V0f))
            & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1k))) )
         => p(ap(ap(c_2Eseq_2Esums,f2884(V1k,V0f)),ap(c_2Eseq_2Esuminf,V0f))) ) ) )).
