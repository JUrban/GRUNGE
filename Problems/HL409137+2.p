...
fof(conj_thm_2Etransc_2EEXP__NEG,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__INV__SCALAR__LMUL,lemma,(
    ! [V0k] :
...
fof(conj_thm_2Ecomplex_2EMODU__UNIT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__INV__ARG,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ecomplex_2ECOMPLEX__EXP__NEG,conjecture,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
