...
fof(conj_thm_2Eproduct_2ENPRODUCT__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( ! [V3x] :
                           ...
                           => ! [V4y] :
                               ...
                               => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                                 ...
                                 => V3x = V4y ) ) )
                       => ap(ap(c_2Eproduct_2Enproduct(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),V1g) = ap(ap(c_2Eproduct_2Enproduct(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V1g),V0f)) ) ) ) ) ) ) )).
