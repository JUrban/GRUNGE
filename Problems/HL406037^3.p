...
thf(thm_2Ewords_2EWORD__MOD__POW2,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Efcp_2Ecart @ $o @ A_27a,V1v: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V1v @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
     => ( ( c_2Ewords_2Eword__mod @ A_27a @ V0m @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V1v ) ) ) )
        = ( c_2Ewords_2Eword__bits @ A_27a @ V1v @ c_2Enum_2E0 @ V0m ) ) ) )).
