...
thf(conj_thm_2Ereal__topology_2EDIST__NZ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( V0x != V1y )
...
thf(conj_thm_2Ereal__topology_2ECLOSED__SUBSET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__DIFF,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
          ...
          <=> ! [V3e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V4d: tp__ty_2Erealax_2Ereal] :
                    ...
                    & ! [V5x_27: tp__ty_2Erealax_2Ereal] :
                        ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ V2s ) )
                          & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) ) )
                       => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__WITHIN,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__CONTINUOUS__IMAGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__LT__MIN,lemma,(
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__COMPACT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
                  ...
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1f ) @ V0s )
                    = V2t )
                  & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                      ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) @ V0s ) )
                        & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) @ V0s ) )
                        & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) )
                          = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) )
                     => ( V3x = V4y ) ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__ONE__POINT__COMPACTIFICATIONS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
                ...
                & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ V0s ) )
                & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) @ V1t ) )
                & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ty_2Erealax_2Ereal ) @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ty_2Erealax_2Ereal ) @ V1t ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) ) ) )
             => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V0s ) @ V1t ) ) ) ) ) )).
