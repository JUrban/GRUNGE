...
thf(thm_2Ereal__topology_2EBOUNDS__LINEAR,axiom,(
    ! [V0A: mono_2Etyop_2Enum_2Enum,V1B: mono_2Etyop_2Enum_2Enum,V2C: mono_2Etyop_2Enum_2Enum] :
      ( ! [V3n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2E_2A @ V0A @ V3n ) @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2A @ V1B @ V3n ) @ V2C ) )
    <=> ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0A @ V1B ) ) )).

thf(thm_2Ereal__topology_2EBOUNDS__LINEAR__0,conjecture,(
    ! [V0A: mono_2Etyop_2Enum_2Enum,V1B: mono_2Etyop_2Enum_2Enum] :
      ( ! [V2n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2E_2A @ V0A @ V2n ) @ V1B )
