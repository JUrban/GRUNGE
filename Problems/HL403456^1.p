...
thf(f3609_0_2E0,type,(
    f3609_0_2E0: u )).

thf(f3609_0_2E1,type,(
    f3609_0_2E1: du > u )).

thf(f3609_1_2E0,type,(
    f3609_1_2E0: u )).

thf(f3609_1_2E1,type,(
    f3609_1_2E1: du > u )).

thf(f3610_0_2E0,type,(
    f3610_0_2E0: u )).

thf(f3610_0_2E1,type,(
    f3610_0_2E1: du > u )).
...
thf(mono_2Ef3609_0,type,(
    mono_2Ef3609_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3609_1,type,(
    mono_2Ef3609_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3610_0,type,(
    mono_2Ef3610_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2EEncode_2Eencode__bnum__def,axiom,(
...
thf(thm_2EEncode_2Eencode__bnum__def,axiom,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EEncode_2Eencode__bnum @ mono_2Ec_2Enum_2E0 @ V0n )
        = mono_2Ec_2Elist_2ENIL_2Emono_2Etyop_2Emin_2Ebool )
    & ! [V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EEncode_2Eencode__bnum @ ( mono_2Ec_2Enum_2ESUC @ V1m ) @ V2n )
        = ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3610_0 @ V2n ) @ ( mono_2Ec_2EEncode_2Eencode__bnum @ V1m @ ( mono_2Ec_2Earithmetic_2EDIV @ V2n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2EEncode_2Eencode__bnum__def__compute,axiom,(
    ! [V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3609_1 @ V4n )
    <=> ( (~) @ ( mono_2Ec_2Earithmetic_2EEVEN @ V4n ) ) ) )).

thf(def1_2Ethm_2EEncode_2Eencode__bnum__def__compute,axiom,(
    ! [V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3609_0 @ V2n )
    <=> ( (~) @ ( mono_2Ec_2Earithmetic_2EEVEN @ V2n ) ) ) )).
...
thf(thm_2EEncode_2Eencode__bnum__def__compute,conjecture,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ...
        = mono_2Ec_2Elist_2ENIL_2Emono_2Etyop_2Emin_2Ebool )
    & ! [V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EEncode_2Eencode__bnum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1m ) ) @ V2n )
        = ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3609_0 @ V2n ) @ ( mono_2Ec_2EEncode_2Eencode__bnum @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1m ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Earithmetic_2EDIV @ V2n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )
    & ! [V3m: mono_2Etyop_2Enum_2Enum,V4n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2EEncode_2Eencode__bnum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V3m ) ) @ V4n )
        = ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3609_1 @ V4n ) @ ( mono_2Ec_2EEncode_2Eencode__bnum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V3m ) ) @ ( mono_2Ec_2Earithmetic_2EDIV @ V4n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).
