...
tff(conj_thm_2Elist_2EGENLIST__APPEND,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
...
tff(conj_thm_2Esorting_2ESUM__IMAGE__count__SUM__GENLIST,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Esorting_2ESUM__IMAGE__count__MULT,conjecture,(
