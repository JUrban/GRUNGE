...
tff(f13738_0_2E0,type,(
    f13738_0_2E0: u )).

tff(f13738_0_2E2,type,(
    f13738_0_2E2: ( du * du ) > u )).

tff(f13738_0_2E4,type,(
    f13738_0_2E4: ( du * du * du * du ) > u )).
...
tff(arityeq2_2Ef13738_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f13738_0_2E2(s(tyop_2Ereal__topology_2Enet(A_27a),X0_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X1_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Ereal__topology_2Enet(A_27a),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)))),f13738_0_2E0),s(tyop_2Ereal__topology_2Enet(A_27a),X0_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X1_2E0))) )).

tff(arityeq4_2Ef13738_0_2E4,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13738_0_2E4(s(tyop_2Ereal__topology_2Enet(A_27a),X0_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X1_2E0),s(A_27a,X2_2E0),s(A_27a,X3_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Ereal__topology_2Enet(A_27a),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)))),f13738_0_2E0),s(tyop_2Ereal__topology_2Enet(A_27a),X0_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),X1_2E0))),s(A_27a,X2_2E0))),s(A_27a,X3_2E0)))) )).
...
tff(arityeq1_2Ec_2Ereal__topology_2Enetord_2E1_002,axiom,(
...
tff(thm_2Ereal__topology_2ENET,axiom,(
    ! [A_27a: d,V0n_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ! [V3z_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V3z_2E0),s(A_27a,V1x_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V3z_2E0),s(A_27a,V2y_2E0))))) )
      | ! [V4z_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V4z_2E0),s(A_27a,V2y_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V4z_2E0),s(A_27a,V1x_2E0))))) ) ) )).

tff(def0_2Ethm_2Ereal__topology_2Ewithin,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1s_2E0: u,V2x_2E0: u,V3y_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13738_0_2E4(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0),s(A_27a,V2x_2E0),s(A_27a,V3y_2E0)))))
    <=> ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(A_27a,V2x_2E0),s(A_27a,V3y_2E0)))))
...
tff(thm_2Ereal__topology_2Ewithin,axiom,(
    ! [A_27a: d,V0net_2E0: u,V1s_2E0: u] : s(tyop_2Ereal__topology_2Enet(A_27a),c_2Ereal__topology_2Ewithin_2E2(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0))) = s(tyop_2Ereal__topology_2Enet(A_27a),c_2Ereal__topology_2Emk__net_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f13738_0_2E2(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0))))) )).
...
tff(thm_2Ereal__topology_2EWITHIN,conjecture,(
