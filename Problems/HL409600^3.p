...
thf(thm_2Eiterate_2EREAL__COMPLETE,axiom,(
    ! [V0P: tyop_2Erealax_2Ereal > $o] :
      ( ( ? [V1x: tyop_2Erealax_2Ereal] :
            ( V0P @ V1x )
        & ? [V2M: tyop_2Erealax_2Ereal] :
          ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( V0P @ V3x )
           => ( c_2Ereal_2Ereal__lte @ V3x @ V2M ) ) )
     => ? [V4M: tyop_2Erealax_2Ereal] :
          ( ! [V5x: tyop_2Erealax_2Ereal] :
              ( ( V0P @ V5x )
             => ( c_2Ereal_2Ereal__lte @ V5x @ V4M ) )
          & ! [V6M_27: tyop_2Erealax_2Ereal] :
              ( ! [V7x: tyop_2Erealax_2Ereal] :
                  ( ( V0P @ V7x )
                 => ( c_2Ereal_2Ereal__lte @ V7x @ V6M_27 ) )
             => ( c_2Ereal_2Ereal__lte @ V4M @ V6M_27 ) ) ) ) )).
        ...
        @ ^ [V1a: tyop_2Erealax_2Ereal] :
            ...
            @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
              @ ^ [V2x: tyop_2Erealax_2Ereal] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s ) @ ( c_2Ereal_2Ereal__lte @ V2x @ V1a ) ) )
            @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
              @ ^ [V3b: tyop_2Erealax_2Ereal] :
                  ( c_2Emin_2E_3D_3D_3E
                  @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
                    @ ^ [V4x: tyop_2Erealax_2Ereal] :
                        ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s ) @ ( c_2Ereal_2Ereal__lte @ V4x @ V3b ) ) )
                  @ ( c_2Ereal_2Ereal__lte @ V1a @ V3b ) ) ) ) ) ) )).
