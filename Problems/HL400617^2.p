...
thf(conj_thm_2Eprim__rec_2ETC__IM__RTC__SUC,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( p
        @ ( ap
          @ ( ap
            @ ( ap @ ( c_2Erelation_2ETC @ ty_2Enum_2Enum )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2x: $i] :
                    ( lam @ ty_2Enum_2Enum
                    @ ^ [V3y: $i] :
                        ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V3y ) @ ( ap @ c_2Enum_2ESUC @ V2x ) ) ) ) )
            ...
            @ ( ap @ ( c_2Erelation_2ERTC @ ty_2Enum_2Enum )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4x: $i] :
                    ( lam @ ty_2Enum_2Enum
                    @ ^ [V5y: $i] :
                        ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V5y ) @ ( ap @ c_2Enum_2ESUC @ V4x ) ) ) ) )
            @ ( inj__ty_2Enum_2Enum @ V0m ) )
          @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).

thf(conj_thm_2Eprim__rec_2ERTC__IM__TC,lemma,(
    ! [A_27a: del,V0f: $i] :
                      ...
                      @ ( ap @ ( c_2Erelation_2ERTC @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( lam @ A_27a
                              @ ^ [V4y: $i] :
                                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V4y ) @ ( ap @ V0f @ V3x ) ) ) ) )
                      @ ( ap @ V0f @ V1m ) )
                    @ V2n ) )
              <=> ( p
                  @ ( ap
                      ...
                      @ ( ap @ ( c_2Erelation_2ETC @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V5x: $i] :
                              ( lam @ A_27a
                              @ ^ [V6y: $i] :
                                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V6y ) @ ( ap @ V0f @ V5x ) ) ) ) )
                      @ V1m )
                    @ V2n ) ) ) ) ) ) )).
...
thf(conj_thm_2Erelation_2ETC__CASES2,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Eprim__rec_2ELESS__ALT,conjecture,
    ( c_2Eprim__rec_2E_3C
    = ( ap @ ( c_2Erelation_2ETC @ ty_2Enum_2Enum )
      @ ( lam @ ty_2Enum_2Enum
        @ ^ [V0x: $i] :
            ( lam @ ty_2Enum_2Enum
            @ ^ [V1y: $i] :
                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V1y ) @ ( ap @ c_2Enum_2ESUC @ V0x ) ) ) ) ) )).
