...
fof(lamtp_f37,axiom,(
    ! [A_27a,A_27a,A_27a] : mem(f37(A_27a,A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool))) )).
...
fof(ax_thm_2Ebool_2ERES__EXISTS__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ebool_2ERES__EXISTS(A_27a) = f37(A_27a,A_27a,A_27a) ) )).

fof(conj_thm_2Ebool_2ERES__EXISTS__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
