...
thf(conj_thm_2Ereal_2EREAL__LT__MIN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) @ ( ap @ ( ap @ c_2Ereal_2Emin @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__LE__LMUL1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__LSUB,lemma,(
    ! [V0h: $i] :
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__RSUB,lemma,(
    ! [V0h: $i] :
      ( ( mem @ V0h @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3z: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ c_2Ereal__topology_2Ebilinear @ V0h ) )
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__BOUNDED__POS,lemma,(
    ! [V0h: $i] :
      ( ( mem @ V0h @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebilinear @ V0h ) )
       => ? [V1B: tp__ty_2Erealax_2Ereal] :
            ...
            & ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
                ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ V0h @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1B ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBOUNDED__POS,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__UNIFORMLY__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on @ V0f ) @ V3s ) )
                      & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on @ V1g ) @ V3s ) )
                      & ( p @ ( ap @ c_2Ereal__topology_2Ebilinear @ V2h ) )
                      & ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V3s ) ) )
                      & ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V3s ) ) ) )
                   => ( p
                      @ ( ap
                        @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on
                          @ ( lam @ ty_2Erealax_2Ereal
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ V2h @ ( ap @ V0f @ V4x ) ) @ ( ap @ V1g @ V4x ) ) ) )
                        @ V3s ) ) ) ) ) ) ) )).
