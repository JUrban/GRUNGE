...
thf(conj_thm_2Erelation_2ERTC__SINGLE,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Erelation_2ERTC__STRONG__INDUCT__RIGHT1,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
              ...
              & ! [V3x: $i] :
                 ...
                 => ! [V4y: $i] :
                     ...
                     => ! [V5z: $i] :
                          ( ( mem @ V5z @ A_27a )
                         => ( ( ( p @ ( ap @ ( ap @ V1P @ V3x ) @ V4y ) )
                              & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ERTC @ A_27a ) @ V0R ) @ V3x ) @ V4y ) )
                              & ( p @ ( ap @ ( ap @ V0R @ V4y ) @ V5z ) ) )
                           => ( p @ ( ap @ ( ap @ V1P @ V3x ) @ V5z ) ) ) ) ) ) )
           => ! [V6x: $i] :
                ( ( mem @ V6x @ A_27a )
...
thf(conj_thm_2Etc_2ERTC__INSERT,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
