...
thf(conj_thm_2Eordinal_2EordSUC__NUMERAL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
      = ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EordMULT__2R,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V0a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )
        = ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ V0a ) ) ) )).
