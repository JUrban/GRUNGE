...
fof(conj_thm_2Erich__list_2EELL__EL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2EELL(A_27a),V0n),V1l) = ap(ap(c_2Elist_2EEL(A_27a),ap(c_2Eprim__rec_2EPRE,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n))),V1l) ) ) ) ) )).
