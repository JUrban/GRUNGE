...
tff(conj_thm_2Ereal__topology_2ELIMIT__POINT__FINITE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__NO__LIMPT,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
