    ...
    ! [A_27a: $tType] :
      ( ( ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 )
        = ( c_2Eordinal_2Eoleast @ A_27a
          @ ^ [V0a: tyop_2Eordinal_2Eordinal @ A_27a] : c_2Ebool_2ET ) )
      & ! [V1n: tyop_2Enum_2Enum] :
          ( ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ V1n ) ) )
          = ( c_2Eordinal_2EordSUC @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ V1n ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
      & ! [V2n: tyop_2Enum_2Enum] :
          ( ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ V2n ) ) )
          = ( c_2Eordinal_2EordSUC @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ V2n ) ) ) ) ) ) )).
