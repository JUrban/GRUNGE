...
fof(conj_thm_2Ereal__topology_2EMAXIMAL__INDEPENDENT__SUBSET,lemma,(
    ! [V0v] :
...
fof(lameq_f3662,axiom,(
    ! [V0v] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f3662(V0v),V1n) = ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3663(V1n,V0v)) ) ) )).

fof(ax_thm_2Ereal__topology_2Edim,axiom,(
    ! [V0v] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Ereal__topology_2Edim,V0v) = ap(c_2Emin_2E_40(ty_2Enum_2Enum),f3662(V0v)) ) )).

fof(conj_thm_2Ereal__topology_2EBASIS__EXISTS,conjecture,(
    ! [V0v] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ? [V1b] :
          ( mem(V1b,arr(ty_2Erealax_2Ereal,bool))
