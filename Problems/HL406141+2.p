...
fof(conj_thm_2Ewords_2EWORD__ADD__RIGHT__LS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
          ( mem(V0c,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__LESS__NEG__RIGHT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__ADD__RIGHT__LS2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
          ( mem(V0c,ty_2Efcp_2Ecart(bool,bool))
