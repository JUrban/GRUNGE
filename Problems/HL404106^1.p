...
thf(thm_2Ebag_2EBAG__GEN__PROD__UNION,axiom,(
    ! [V0b1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V1b2: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Ebag_2EFINITE__BAG_2Emono_2Etyop_2Enum_2Enum @ V0b1 )
        & ( mono_2Ec_2Ebag_2EFINITE__BAG_2Emono_2Etyop_2Enum_2Enum @ V1b2 ) )
     => ( ( mono_2Ec_2Ebag_2EBAG__GEN__PROD @ ( mono_2Ec_2Ebag_2EBAG__UNION_2Emono_2Etyop_2Enum_2Enum @ V0b1 @ V1b2 ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
        = ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Ebag_2EBAG__GEN__PROD @ V0b1 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ebag_2EBAG__GEN__PROD @ V1b2 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).
...
thf(thm_2EprimeFactor_2EPRIME__FACTORS__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Ebag_2EFINITE__BAG_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ V0n ) )
        & ! [V1m: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Ebag_2EBAG__IN_2Emono_2Etyop_2Enum_2Enum @ V1m @ ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ V0n ) )
           => ( mono_2Ec_2Edivides_2Eprime @ V1m ) )
        & ( V0n
          = ( mono_2Ec_2Ebag_2EBAG__GEN__PROD @ ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ V0n ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).
...
thf(thm_2EprimeFactor_2EPRIME__FACTORS__MULT,conjecture,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0a )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V1b ) )
     => ( ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ ( mono_2Ec_2Earithmetic_2E_2A @ V0a @ V1b ) )
        = ( mono_2Ec_2Ebag_2EBAG__UNION_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ V0a ) @ ( mono_2Ec_2EprimeFactor_2EPRIME__FACTORS @ V1b ) ) ) ) )).
