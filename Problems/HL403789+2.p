...
fof(lamtp_f1162,axiom,(
    ! [A_27a,V2h] :
      ( mem(V2h,A_27a)
     => ! [V3t] :
          ( mem(V3t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => mem(f1162(A_27a,V2h,V3t),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))) ) ) )).
    ...
    ! [A_27a,V2h] :
     ...
     => ! [V3t] :
         ...
         => ! [V4n] :
             ...
             => ap(f1162(A_27a,V2h,V3t),V4n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V4n),c_2Enum_2E0)),ap(c_2Eoption_2ESOME(A_27a),V2h)),ap(V3t,ap(ap(c_2Earithmetic_2E_2D,V4n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) )).

fof(conj_thm_2Ellist_2Elrep__ok__cases,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a0] :
          ( mem(V0a0,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
