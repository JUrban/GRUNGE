...
tff(conj_thm_2Ellist_2ELNTH__ADD,conjecture,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2ll: $i] :
      ( mem(V2ll,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELNTH(A_27a),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0a)),inj__ty_2Enum_2Enum(V1b))),V2ll) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27a,A_27a),ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0a)),V2ll)),ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V1b))) ) )).
