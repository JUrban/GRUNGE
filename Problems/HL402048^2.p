...
thf(conj_thm_2Epred__set_2EPAIR__IN__GSPEC__1,lemma,(
                 ...
                 => ( ( p
                      @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V0a ) @ V1b ) )
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4y: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V4y ) @ V2x ) ) @ ( ap @ V3P @ V4y ) ) ) ) ) )
                  <=> ( ( p @ ( ap @ V3P @ V0a ) )
                      & ( V1b = V2x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Eextend__linear__order,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
                    ...
                    @ ( ap @ ( c_2Eset__relation_2Elinear__order @ A_27a )
                      @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ V0r )
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V3y: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V3y ) @ V2x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3y ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V2x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) ) ) ) )
                    @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V2x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) ) ) ) ) )).
