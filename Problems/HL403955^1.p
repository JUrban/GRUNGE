...
thf(thm_2Ellist_2ELDROP__SUC,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1ls_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ls_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2EOPTION__BIND_2E2 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ls_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ c_2Ellist_2ELTL_2E0 ) ) ) ) )).
