...
fof(conj_thm_2EOmega__Automata_2ECO__BUECHI__SUNTIL__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3i] :
                         ...
                         => ! [V4Psi] :
                             ...
                             => ! [V5t0] :
                                 ...
                                 => ! [V6c] :
                                      ( mem(V6c,A_27b)
                                     => ( p(ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0phi),f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi)),V5t0))
                                      <=> ? [V12p] :
