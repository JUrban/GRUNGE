...
thf(conj_thm_2Eiterate_2ENSUM__EQ,lemma,(
    ! [A_27a: del,V0f: $i] :
             ...
             => ( ! [V3x: $i] :
                   ...
                   => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2s ) )
                     => ( ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ V3x ) )
                        = ( surj__ty_2Enum_2Enum @ ( ap @ V1g @ V3x ) ) ) ) )
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s ) @ V0f ) )
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s ) @ V1g ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ENSUM__SING,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) @ V0f ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ V1x ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ENSUM__NSUM__RESTRICT,lemma,(
                   ...
                   => ( ( surj__ty_2Enum_2Enum
                        @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap
                                @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b )
                                    @ ( lam @ A_27b
                                      @ ^ [V5y: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ V5y ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V5y ) @ V3t ) ) @ ( ap @ ( ap @ V0R @ V4x ) @ V5y ) ) ) ) ) )
                                @ ( lam @ A_27b
                                  @ ^ [V6y: $i] :
                                      ( ap @ ( ap @ V1f @ V4x ) @ V6y ) ) ) ) ) )
                      = ( surj__ty_2Enum_2Enum
                        @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b ) @ V3t )
                          @ ( lam @ A_27b
                            @ ^ [V7y: $i] :
                                ( ap
                                @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                    @ ( lam @ A_27a
                                      @ ^ [V8x: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V8x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V8x ) @ V2s ) ) @ ( ap @ ( ap @ V0R @ V8x ) @ V7y ) ) ) ) ) )
                                @ ( lam @ A_27a
                                  @ ^ [V9x: $i] :
                                      ( ap @ ( ap @ V1f @ V9x ) @ V7y ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ENSUM__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V2s ) )
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V2s ) @ V1g ) )
                  = ( surj__ty_2Enum_2Enum
                    @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V2s ) )
                      @ ( lam @ A_27b
                        @ ^ [V3y: $i] :
                            ( ap
                            @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a )
                              @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                @ ( lam @ A_27a
                                  @ ^ [V4x: $i] :
                                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V4x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ ( ap @ V0f @ V4x ) ) @ V3y ) ) ) ) ) )
                            @ V1g ) ) ) ) ) ) ) ) ) )).
