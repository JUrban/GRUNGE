...
thf(f4283_0_2E0,type,(
    f4283_0_2E0: u )).

thf(f4283_0_2E1,type,(
    f4283_0_2E1: du > u )).

thf(f4283_0_2E2,type,(
    f4283_0_2E2: du > du > u )).

thf(f4283_1_2E0,type,(
    f4283_1_2E0: u )).

thf(f4283_1_2E1,type,(
    f4283_1_2E1: du > u )).

thf(f4283_1_2E3,type,(
    f4283_1_2E3: du > du > du > u )).

thf(f4283_2_2E0,type,(
    f4283_2_2E0: u )).

thf(f4283_2_2E3,type,(
    f4283_2_2E3: du > du > du > u )).

thf(f4283_3_2E0,type,(
    f4283_3_2E0: u )).

thf(f4283_3_2E2,type,(
    f4283_3_2E2: du > du > u )).

thf(f4285_0_2E0,type,(
    f4285_0_2E0: u )).

thf(f4285_0_2E1,type,(
    f4285_0_2E1: du > u )).

thf(f4285_0_2E2,type,(
    f4285_0_2E2: du > du > u )).

thf(f4285_1_2E0,type,(
    f4285_1_2E0: u )).

thf(f4285_1_2E1,type,(
    f4285_1_2E1: du > u )).

thf(f4285_1_2E3,type,(
    f4285_1_2E3: du > du > du > u )).

thf(f4285_2_2E0,type,(
    f4285_2_2E0: u )).

thf(f4285_2_2E3,type,(
    f4285_2_2E3: du > du > du > u )).

thf(f4285_3_2E0,type,(
    f4285_3_2E0: u )).

thf(f4285_3_2E2,type,(
    f4285_3_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4283_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4283_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4283_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4283_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4283_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4283_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4283_1_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4283_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) @ f4283_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4283_1_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4283_1_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) @ f4283_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4283_2_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4283_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4283_2_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4283_3_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4283_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f4283_3_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4285_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4285_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4285_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4285_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4285_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4285_0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4285_1_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4285_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) @ f4285_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4285_1_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4285_1_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) ) @ f4285_1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4285_2_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4285_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ f4285_2_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4285_3_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4285_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f4285_3_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Epred__set_2ESUBSET_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2CA_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(arityeq2_2Emono_2Ec_2Eset__relation_2Elinear__order_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Ellist_2Elinear__order__to__llist__eq,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4283_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
    <=> ? [V4i: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) )).

thf(def1_2Ethm_2Ellist_2Elinear__order__to__llist__eq,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V3x_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4283_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f4283_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).

thf(def2_2Ethm_2Ellist_2Elinear__order__to__llist__eq,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V5x_2E0: u,V6y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4283_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) )
    <=> ? [V7i: mono_2Etyop_2Enum_2Enum,V8j: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V7i @ V8j )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V7i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V5x_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V8j ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V6y_2E0 ) ) ) ) ) ) )).

thf(def3_2Ethm_2Ellist_2Elinear__order__to__llist__eq,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V5x_2E0: u,V6y_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4283_1_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( f4283_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2Elinear__order__to__llist__eq,axiom,(
    ! [A_27a: d,V0lo_2E0: u,V1X_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eset__relation_2Elinear__order_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0lo_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1X_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eset__relation_2Efinite__prefixes_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0lo_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1X_2E0 ) ) ) ) )
     => ? [V2ll_2E0: u] :
          ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1X_2E0 )
            = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4283_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) )
          & ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0lo_2E0 )
            = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4283_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) ) ) )
          & ! [V9i: mono_2Etyop_2Enum_2Enum,V10j: mono_2Etyop_2Enum_2Enum,V11x_2E0: u] :
              ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
                  = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V11x_2E0 ) ) ) )
                & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V10j ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
                  = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V11x_2E0 ) ) ) ) )
             => ( V9i = V10j ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2Elinear__order__to__llist,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4285_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
    <=> ? [V4i: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) )).

thf(def1_2Ethm_2Ellist_2Elinear__order__to__llist,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V3x_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4285_0_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f4285_3_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).

thf(def2_2Ethm_2Ellist_2Elinear__order__to__llist,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V5x_2E0: u,V6y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4285_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) )
    <=> ? [V7i: mono_2Etyop_2Enum_2Enum,V8j: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V7i @ V8j )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V7i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V5x_2E0 ) ) ) )
...
thf(def3_2Ethm_2Ellist_2Elinear__order__to__llist,axiom,(
    ! [A_27a: d,V2ll_2E0: u,V5x_2E0: u,V6y_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f4285_1_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( f4285_2_2E3 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2Elinear__order__to__llist,conjecture,(
    ! [A_27a: d,V0lo_2E0: u,V1X_2E0: u] :
     ...
     => ? [V2ll_2E0: u] :
          ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1X_2E0 )
            = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4285_0_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2ESUBSET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0lo_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ ( f4285_1_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) ) ) ) ) )
          & ! [V9i: mono_2Etyop_2Enum_2Enum,V10j: mono_2Etyop_2Enum_2Enum,V11x_2E0: u] :
              ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
                  = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V11x_2E0 ) ) ) )
                & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V10j ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
