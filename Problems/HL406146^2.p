...
thf(conj_thm_2Ewords_2Eword__abs__neg,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( c_2Ewords_2Eword__abs @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V0w ) )
        = ( ap @ ( c_2Ewords_2Eword__abs @ A_27a ) @ V0w ) ) ) )).

thf(conj_thm_2Ewords_2Eword__abs__diff,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( c_2Ewords_2Eword__abs @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ V0a ) @ V1b ) )
            = ( ap @ ( c_2Ewords_2Eword__abs @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ V1b ) @ V0a ) ) ) ) ) )).
