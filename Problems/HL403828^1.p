...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELUNFOLD_2E2_2Emono_2EA_27a_20mono_2Etyop_2Ellist_2Ellist_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ c_2Ellist_2ELUNFOLD_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Eoption_2ESOME_2E1_2Emono_2Etyop_2Epair_2Eprod_28A_27c_2CA_27b_29,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ c_2Eoption_2ESOME_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Ellist_2ELTL__HD__iff,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1t_2E0: u,V2h_2E0: u] :
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( c_2Ellist_2ELTL__HD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0x_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) @ ( s @ A_27a @ V2h_2E0 ) ) ) ) ) )
      <=> ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0x_2E0 )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) ) )
      & ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( c_2Ellist_2ELTL__HD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0x_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) )
      <=> ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0x_2E0 )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) ) ) )).

thf(thm_2Ellist_2ELUNFOLD__LTL__HD,axiom,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( tyop_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) ) @ c_2Ellist_2ELTL__HD_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )).

thf(thm_2Ellist_2ELUNFOLD__BISIMULATION,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f1_2E0: u,V1f2_2E0: u,V2x1_2E0: u,V3x2_2E0: u] :
      ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ V0f1_2E0 ) @ ( s @ A_27a @ V2x1_2E0 ) ) )
        = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELUNFOLD_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ V1f2_2E0 ) @ ( s @ A_27c @ V3x2_2E0 ) ) ) )
    <=> ? [V4R_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V4R_2E0 ) @ ( s @ A_27a @ V2x1_2E0 ) ) ) @ ( s @ A_27c @ V3x2_2E0 ) ) ) )
          & ! [V5y1_2E0: u,V6y2_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V4R_2E0 ) @ ( s @ A_27a @ V5y1_2E0 ) ) ) @ ( s @ A_27c @ V6y2_2E0 ) ) ) )
             => ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ V0f1_2E0 ) @ ( s @ A_27a @ V5y1_2E0 ) ) )
                    = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ c_2Eoption_2ENONE_2E0 ) )
                  & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ V1f2_2E0 ) @ ( s @ A_27c @ V6y2_2E0 ) ) )
                    = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ c_2Eoption_2ENONE_2E0 ) ) )
                | ? [V7h_2E0: u,V8t1_2E0: u,V9t2_2E0: u] :
                    ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ V0f1_2E0 ) @ ( s @ A_27a @ V5y1_2E0 ) ) )
                      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V8t1_2E0 ) @ ( s @ A_27b @ V7h_2E0 ) ) ) ) ) )
                    & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ V1f2_2E0 ) @ ( s @ A_27c @ V6y2_2E0 ) ) )
                      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27c @ V9t2_2E0 ) @ ( s @ A_27b @ V7h_2E0 ) ) ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V4R_2E0 ) @ ( s @ A_27a @ V8t1_2E0 ) ) ) @ ( s @ A_27c @ V9t2_2E0 ) ) ) ) ) ) ) ) ) )).
          ...
          & ! [V3ll3_2E0: u,V4ll4_2E0: u] :
             ...
             => ( ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll3_2E0 )
                ...
                | ? [V5h_2E0: u,V6t1_2E0: u,V7t2_2E0: u] :
                    ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll3_2E0 )
                      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V5h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V6t1_2E0 ) ) ) )
                    & ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V4ll4_2E0 )
                      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V5h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V7t2_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ V2R_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V6t1_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V7t2_2E0 ) ) ) ) ) ) ) ) ) )).
