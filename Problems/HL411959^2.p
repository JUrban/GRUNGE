...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__PROPER__IMAGE__EQ,lemma,(
    ! [V0f: $i] :
                      ...
                      @ ( ap @ c_2Ereal__topology_2Ecompact
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                          @ ( lam @ ty_2Erealax_2Ereal
                            @ ^ [V3x: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V3x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V3x ) ) @ V2k ) ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__PROPER__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
