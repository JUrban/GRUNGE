...
fof(conj_thm_2Ereal__topology_2ECLOSED__LIMPT,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ELIM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON,lemma,(
    ! [V0f] :
         ...
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
          <=> ! [V2x] :
               ...
               => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V1s))
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),ap(V0f,V2x)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),V1s))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__WITHIN__UNION,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2x] :
             ...
             => ! [V3s] :
                 ...
                 => ! [V4t] :
                     ...
                     => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),V1l),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V3s),V4t))))
                      <=> ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),V1l),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),V3s)))
                          & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),V1l),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),V4t))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__UNION,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2EClosed,V1s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V1s),V2t))) ) ) ) ) )).
