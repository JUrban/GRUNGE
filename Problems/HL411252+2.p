...
fof(conj_thm_2Ereal__topology_2ECLOSURE__SUBSET__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eclosure,V0s)),V0s))
      <=> p(ap(c_2Ereal__topology_2EClosed,V0s)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSED__MAP__CLOSURES,conjecture,(
    ! [V0f] :
     ...
     => ( ! [V1s] :
      ...
      <=> ! [V2s] :
           ...
           => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eclosure,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eclosure,V2s)))) ) ) ) )).
