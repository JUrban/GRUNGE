...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__integral__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                         ...
                         => ( ( p
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ ( ap @ ( c_2Emeasure_2Epos__simple__fn @ A_27a ) @ V0m )
                                      @ ( lam @ A_27a
                                        @ ^ [V6x: $i] :
                                            ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) @ ( ap @ V1f @ V6x ) ) ) )
                                    @ V2s )
                                  @ V3a )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V7i: $i] :
                            ...
                            & ( ( surj__ty_2Eextreal_2Eextreal
                                @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__simple__fn__integral @ A_27a ) @ V0m ) @ V2s ) @ V3a )
                                  @ ( lam @ ty_2Enum_2Enum
                                    @ ^ [V8i: $i] :
                                        ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) @ ( ap @ V4x @ V8i ) ) ) ) )
...
thf(conj_thm_2Elebesgue_2Epsfis__cmul,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
