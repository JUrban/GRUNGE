...
thf(conj_thm_2Ebag_2EBAG__DIFF__2R,conjecture,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1B: $i] :
         ...
         => ! [V2C: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2ESUB__BAG @ A_27a ) @ V2C ) @ V1B ) )
               => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V0A ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1B ) @ V2C ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0A ) @ V2C ) ) @ V1B ) ) ) ) ) ) )).
