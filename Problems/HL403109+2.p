...
fof(lameq_f917,axiom,(
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V2t] :
              ( mem(V2t,ty_2Enum_2Enum)
             => ap(f917(V1b,V0a),V2t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V1b),f891(V0a,V1b)),V2t)),ap(ap(c_2ETemporal__Logic_2EALWAYS,V0a),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EUNTIL__AS__SWHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
