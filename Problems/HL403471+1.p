...
fof(thm_2Esemi__ring_2Eplus__zero__left,conjecture,(
    ! [A_27a,V0r_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Esemi__ring_2Eis__semi__ring_2E1(s(tyop_2Esemi__ring_2Esemi__ring(A_27a),V0r_2E0))))
     => ! [V1n_2E0] : s(A_27a,c_2Esemi__ring_2Esemi__ring__SRP_2E3(s(tyop_2Esemi__ring_2Esemi__ring(A_27a),V0r_2E0),s(A_27a,c_2Esemi__ring_2Esemi__ring__SR0_2E1(s(tyop_2Esemi__ring_2Esemi__ring(A_27a),V0r_2E0))),s(A_27a,V1n_2E0))) = s(A_27a,V1n_2E0) ) )).
