...
tff(conj_thm_2Earithmetic_2ESUB__LEFT__GREATER__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Etransc_2EDIVISION__UBOUND__LT,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2EDIVISION__APPEND__EXPLICIT,conjecture,(
