...
tff(conj_thm_2Eset__relation_2Efinite__prefixes__range,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27a,A_27a),V0r),V1s))
                  & p(ap(ap(c_2Epred__set_2EDISJOINT(A_27b),V2t),ap(c_2Eset__relation_2Erange(A_27b,A_27b),V0r))) )
               => p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27a,A_27a),V0r),ap(ap(c_2Epred__set_2EUNION(A_27b),V1s),V2t))) ) ) ) ) )).
