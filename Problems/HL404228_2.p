...
tff(conj_thm_2Elist_2EEL__LENGTH__SNOC,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(conj_thm_2Ellist_2ELTAKE__SNOC__LNTH,lemma,(
...
tff(conj_thm_2Ellist_2ELTAKE__LENGTH,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l: $i] :
          ( mem(V2l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Epath_2Enth__label__LNTH,lemma,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V2x: $i] :
          ( mem(V2x,A_27b)
         => ( ap(ap(c_2Ellist_2ELNTH(A_27b),inj__ty_2Enum_2Enum(V0n)),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p)) = ap(c_2Eoption_2ESOME(A_27b),V2x)
          <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
              & ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V0n)),V1p) = V2x ) ) ) ) )).

tff(conj_thm_2Epath_2Enth__label__LTAKE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0n: tp__ty_2Enum_2Enum,V1p: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ! [V3i: tp__ty_2Enum_2Enum,V4v: $i] :
              ( mem(V4v,A_27c)
             => ( ( ap(ap(c_2Ellist_2ELTAKE(A_27b),inj__ty_2Enum_2Enum(V0n)),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p)) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27b)),V2l)
                  & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3i)),ap(c_2Elist_2ELENGTH(A_27b),V2l))) )
               => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V3i)),V1p) = ap(ap(c_2Elist_2EEL(A_27b),inj__ty_2Enum_2Enum(V3i)),V2l) ) ) ) ) )).
