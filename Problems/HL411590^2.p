...
thf(conj_thm_2Ereal__topology_2ELIM__COMPONENT__LE,lemma,(
    ! [A_27a: del,V0net: $i] :
                    ...
                    & ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5x: $i] :
                                ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V1f @ V5x ) ) @ ( ap @ V2g @ V5x ) ) ) )
                        @ V0net ) ) )
                 => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ ( inj__ty_2Erealax_2Ereal @ V4m ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELIM__DROP__LE,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
