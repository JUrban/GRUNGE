...
thf(conj_thm_2EHolSmt_2Er182,conjecture,(
    ! [V0u: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2v: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal,V4w: tp__ty_2Erealax_2Ereal,V5z: tp__ty_2Erealax_2Ereal,V6a: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0u ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V2v ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V4w ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) ) ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V6a ) ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0u ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2v ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V4w ) ) @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V6a ) ) ) ) )).
