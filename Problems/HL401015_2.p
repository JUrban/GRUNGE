...
tff(lmtp_f179,type,(
    f179: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f179,axiom,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : mem(f179(V0a,V1m),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f179,axiom,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V3d: tp__ty_2Enum_2Enum] : ap(f179(V0a,V1m),inj__ty_2Enum_2Enum(V3d)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V3d))),inj__ty_2Enum_2Enum(V0a)),ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0a))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V3d))))) )).

tff(conj_thm_2Earithmetic_2Efindq__thm,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0a)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Enum_2Enum(V0a)),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f179(V0a,V1m)),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V2n))))) )).

tff(conj_thm_2Earithmetic_2Efindq__divisor,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m)))
     => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2a)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V0n))))),inj__ty_2Enum_2Enum(V0n))),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V2a)),inj__ty_2Enum_2Enum(V1m)))) ) )).
