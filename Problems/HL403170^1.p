...
thf(thm_2ETemporal__Logic_2EBEFORE__FIX,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o,V2y: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V3x: mono_2Etyop_2Enum_2Enum] :
          ( ( V2y @ V3x )
        <=> ( ( (~) @ ( V0b @ V3x ) )
            & ( ( V1a @ V3x )
              | ( V2y @ ( mono_2Ec_2Earithmetic_2E_2B @ V3x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )
    <=> ( ( V2y
