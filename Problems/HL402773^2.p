...
thf(tp_c_2Erich__list_2EUNZIP__FST,type,(
    c_2Erich__list_2EUNZIP__FST: del > del > $i )).

thf(mem_c_2Erich__list_2EUNZIP__FST,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( mem @ ( c_2Erich__list_2EUNZIP__FST @ A_27a @ A_27b ) @ ( arr @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) )).
...
thf(ax_thm_2Erich__list_2EUNZIP__FST__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
     => ( ( ap @ ( c_2Erich__list_2EUNZIP__FST @ A_27a @ A_27b ) @ V0l )
        = ( ap @ ( c_2Epair_2EFST @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( c_2Elist_2EUNZIP @ A_27a @ A_27b ) @ V0l ) ) ) ) )).

thf(conj_thm_2Erich__list_2ELENGTH__UNZIP__FST,conjecture,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ ( ap @ ( c_2Erich__list_2EUNZIP__FST @ A_27a @ A_27b ) @ V0l ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l ) ) ) ) )).
