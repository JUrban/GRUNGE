...
thf(thm_2EternaryComparisons_2Eordering2num__num2ordering,conjecture,(
    ...
    <=> ( ( mono_2Ec_2EternaryComparisons_2Eordering2num @ ( mono_2Ec_2EternaryComparisons_2Enum2ordering @ V0r ) )
        = V0r ) ) )).
