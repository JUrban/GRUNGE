...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__REDUNDANT__ROWS__INFO__EQUIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2EpatternMatches_2EREDUNDANT__ROWS__INFO__TO__PMATCH__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1c] :
                 ...
                 => ! [V2rows] :
                     ...
                     => ! [V3infos] :
                          ( mem(V3infos,ty_2Elist_2Elist(bool))
                         => ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V2rows),V1c),V3infos))
                           => ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),V2rows) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27b,A_27b),V0v),ap(ap(c_2EpatternMatches_2EAPPLY__REDUNDANT__ROWS__INFO(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V3infos),V2rows)) ) ) ) ) ) ) ) )).
