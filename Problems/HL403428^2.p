...
thf(tp_c_2Ebag_2Ebag__size,type,(
    c_2Ebag_2Ebag__size: del > $i )).

thf(mem_c_2Ebag_2Ebag__size,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Ebag_2Ebag__size__def,axiom,(
    ! [A_27a: del,V0eltsize: $i] :
      ( ( mem @ V0eltsize @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Ebag_2Ebag__size @ A_27a ) @ V0eltsize ) @ V1b ) )
            = ( surj__ty_2Enum_2Enum
              @ ( ap
                @ ( ap
                  @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ ty_2Enum_2Enum )
                    @ ( lam @ A_27a
                      @ ^ [V2e: $i] :
                          ( lam @ ty_2Enum_2Enum
                          @ ^ [V3acc: $i] :
                              ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ V0eltsize @ V2e ) ) ) @ V3acc ) ) ) )
                  @ V1b )
                @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__SIZE__INSERT,conjecture,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ! [V1eltsize: $i] :
         ...
         => ! [V2e: $i] :
             ...
             => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Ebag_2Ebag__size @ A_27a ) @ V1eltsize ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e ) @ V0b ) ) )
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ V1eltsize @ V2e ) ) ) @ ( ap @ ( ap @ ( c_2Ebag_2Ebag__size @ A_27a ) @ V1eltsize ) @ V0b ) ) ) ) ) ) ) ) )).
