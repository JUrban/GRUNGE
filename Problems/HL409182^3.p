...
thf(thm_2Ereal__sigma_2EREAL__SUM__IMAGE__EQ__CARD,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o] :
     ...
     => ( ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27a
          @ ^ [V1x: A_27a] :
              ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ A_27a @ V1x @ V0P ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
          @ V0P )
...
thf(thm_2Ereal__sigma_2EREAL__SUM__IMAGE__INV__CARD__EQ__1,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o] :
     ...
     => ( ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27a
          @ ^ [V1s: A_27a] :
              ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ A_27a @ V1s @ V0P ) @ ( c_2Erealax_2Einv @ ( c_2Ereal_2Ereal__of__num @ ( c_2Epred__set_2ECARD @ A_27a @ V0P ) ) ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
          @ V0P )
        = ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
