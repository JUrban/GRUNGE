...
tff(conj_thm_2Ereal__topology_2EPERMUTES__IMAGE,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Ereal__topology_2EPERMUTES__INJECTIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(c_2Ereal__topology_2Esummable,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s)),f4040(V0x)))
                    & ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                        ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5m)),V1s))
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V6n)),V1s))
                          & surj__ty_2Enum_2Enum(ap(V2f,inj__ty_2Enum_2Enum(V5m))) = surj__ty_2Enum_2Enum(ap(V2f,inj__ty_2Enum_2Enum(V6n))) )
                       => V5m = V6n ) )
                 => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0x),V2f)),inj__ty_2Erealax_2Ereal(V3l)),V1s))
                  <=> p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V3l)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s))) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__REARRANGE__EQ,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
