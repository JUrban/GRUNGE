...
thf(thm_2Ebit_2EBIT__SHIFT__THM2,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2s: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V2s @ V0n )
     => ( ( c_2Ebit_2EBIT @ V0n @ ( c_2Earithmetic_2E_2A @ V1a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V2s ) ) )
        = ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2D @ V0n @ V2s ) @ V1a ) ) ) )).

thf(thm_2Ebit_2EBIT__SHIFT__THM3,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2s: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0n @ V2s )
     => ( (~) @ ( c_2Ebit_2EBIT @ V0n @ ( c_2Earithmetic_2E_2A @ V1a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V2s ) ) ) ) ) )).
...
thf(thm_2Ewords_2ELSL__ONE,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
