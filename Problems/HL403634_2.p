...
tff(lmtp_f1100,type,(
    f1100: ( del * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f1100,axiom,(
    ! [A_27a: del,V1y: $i] :
      ( mem(V1y,A_27a)
     => ! [V0x: tp__ty_2Enum_2Enum,V4f: $i] :
          ( mem(V4f,arr(ty_2Enum_2Enum,A_27a))
         => mem(f1100(A_27a,V1y,V0x,V4f),arr(ty_2Enum_2Enum,A_27a)) ) ) )).
...
tff(lameq_f1100,axiom,(
    ! [A_27a: del,V1y: $i] :
     ...
     => ! [V0x: tp__ty_2Enum_2Enum,V4f: $i] :
          ( mem(V4f,arr(ty_2Enum_2Enum,A_27a))
         => ! [V5c: tp__ty_2Enum_2Enum] : ap(f1100(A_27a,V1y,V0x,V4f),inj__ty_2Enum_2Enum(V5c)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0x)),inj__ty_2Enum_2Enum(V5c))),V1y),ap(V4f,inj__ty_2Enum_2Enum(V5c))) ) ) )).

tff(conj_thm_2Efcp_2Efcp__subst__comp,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0x: tp__ty_2Enum_2Enum,V1y: $i] :
     ...
     => ! [V2a: $i] :
         ...
         => ! [V3b: $i] :
             ...
             => ! [V4f: $i] :
                  ( mem(V4f,arr(ty_2Enum_2Enum,A_27a))
                 => ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V0x)),V1y),ap(c_2Efcp_2EFCP(A_27a,A_27a),V4f)) = ap(c_2Efcp_2EFCP(A_27a,A_27a),f1100(A_27a,V1y,V0x,V4f)) ) ) ) ) )).
