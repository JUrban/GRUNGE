...
fof(conj_thm_2Eiterate_2EREAL__OF__NUM__SUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
...
fof(lamtp_f3393,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f3393(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3393,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V3i] :
          ( mem(V3i,ty_2Enum_2Enum)
         => ap(f3393(V0f),V3i) = ap(c_2Ereal_2Ereal__of__num,ap(V0f,V3i)) ) ) )).

fof(conj_thm_2Eiterate_2EREAL__OF__NUM__SUM__NUMSEG,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1m] :
         ...
         => ! [V2n] :
             ...
             => ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Eiterate_2Ensum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)),V0f)) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)),f3393(V0f)) ) ) ) )).
