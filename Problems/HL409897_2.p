...
tff(lameq_f3426,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3426(V0p,V1q),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),ap(V1q,inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ADD,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lmtp_f3428,type,(
    f3428: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3428,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal] : mem(f3428(V0p,V1c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3428,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3428(V0p,V1c),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V1c)) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__RMUL,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lameq_f3431,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3431(V0p,V1q),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),ap(V1q,inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
