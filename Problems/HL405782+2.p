...
fof(lameq_f2167,axiom,(
    ! [A_27a,V1w] :
     ...
     => ! [V0v] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2167(A_27a,V1w,V0v),V2i) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),V2i))) ) ) ) )).
...
fof(lamtp_f2221,axiom,(
    ! [V2x] :
      ( mem(V2x,bool)
     => mem(f2221(V2x),arr(bool,bool)) ) )).
...
fof(lameq_f2221,axiom,(
    ! [V2x] :
     ...
     => ! [V3y] :
          ( mem(V3y,bool)
         => ap(f2221(V2x),V3y) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,V2x),V3y)) ) ) )).

fof(lamtp_f2220,axiom,(
    mem(f2220,arr(bool,arr(bool,bool))) )).

fof(lameq_f2220,axiom,(
    ! [V2x] :
      ( mem(V2x,bool)
     => ap(f2220,V2x) = f2221(V2x) ) )).

fof(conj_thm_2Ewords_2Eword__nand__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ap(ap(c_2Ewords_2Eword__nand(A_27a),ap(c_2Ewords_2En2w(A_27a),V0n)),ap(c_2Ewords_2En2w(A_27a),V1m)) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),f2220),V0n),V1m)) ) ) ) )).
