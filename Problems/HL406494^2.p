...
thf(conj_thm_2Ebitstring_2Elength__bitify__null,lemma,(
...
thf(conj_thm_2Enumposrep_2El2n__lt,lemma,(
...
thf(conj_thm_2Ebitstring_2Ev2n__lt,conjecture,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Ebitstring_2Ev2n @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ bool ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) ) ) )).
