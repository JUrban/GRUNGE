...
thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__IMP__CONTINUOUS,axiom,(
...
thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__EXTENDS__TO__CLOSURE,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V1s )
...
thf(thm_2Ereal__topology_2EBOUNDED__UNIFORMLY__CONTINUOUS__IMAGE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V1s )
        & ( c_2Ereal__topology_2Ebounded__def @ V1s ) )
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) ) )).
