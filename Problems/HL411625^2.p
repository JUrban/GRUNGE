...
thf(conj_thm_2Ecardinal_2EINJECTIVE__LEFT__INVERSE,lemma,(
...
thf(conj_thm_2Ereal__topology_2ELINEAR__SUB,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__BOUNDED__BELOW__POS,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
          & ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
       ...
       => ? [V3B: tp__ty_2Erealax_2Ereal] :
            ...
            & ! [V4x: tp__ty_2Erealax_2Ereal] :
                ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3B ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__SELF,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              & ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( V2x = V3y ) ) )
           => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) ) @ V1s ) ) ) ) ) )).
