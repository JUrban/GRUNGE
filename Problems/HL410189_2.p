...
tff(lmtp_f3529,type,(
    f3529: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3529,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V2f: $i] :
          ( mem(V2f,arr(A_27a,A_27b))
         => ! [V1b: $i] :
              ( mem(V1b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
             => mem(f3529(A_27b,A_27a,A_27b,V0a,V2f,V1b),arr(arr(A_27b,bool),bool)) ) ) ) )).
     ...
     => ! [V2f: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ap(f3529(A_27b,A_27a,A_27b,V0a,V2f,V1b),V3s) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V3s),ap(c_2Emeasure_2Esubsets(A_27b),V1b))),ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f),V3s)),ap(c_2Emeasure_2Espace(A_27a),V0a))),ap(c_2Emeasure_2Esubsets(A_27a),V0a))) ) ) ) ) )).

tff(lmtp_f3528,type,(
    f3528: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f3528,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
         => mem(f3528(A_27b,A_27a,A_27b,A_27a,V0a,V1b),arr(arr(A_27a,A_27b),ty_2Epair_2Eprod(arr(A_27a,A_27b),arr(A_27a,A_27b)))) ) ) )).
...
tff(lameq_f3528,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,A_27a: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(A_27a,A_27b))
             => ap(f3528(A_27b,A_27a,A_27b,A_27a,V0a,V1b),V2f) = ap(ap(c_2Epair_2E_2C(arr(A_27a,A_27b),arr(A_27a,A_27b)),V2f),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Emeasure_2Esigma__algebra(A_27b),V1b)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),V2f),ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),ap(c_2Emeasure_2Espace(A_27a),V0a)),ap(c_2Emeasure_2Espace(A_27b),V1b)))),ap(c_2Ebool_2E_21(arr(A_27b,bool)),f3529(A_27b,A_27a,A_27b,V0a,V2f,V1b)))))) ) ) ) )).

tff(ax_thm_2Emeasure_2Emeasurable__def,axiom,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
         => ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),V1b) = ap(c_2Epred__set_2EGSPEC(arr(A_27a,A_27b),arr(A_27a,A_27b)),f3528(A_27b,A_27a,A_27b,A_27a,V0a,V1b)) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURABLE,conjecture,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
