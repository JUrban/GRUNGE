...
thf(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__PSUNTIL__THM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ! [V3d: $i] :
                 ...
                 => ( ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                      ...
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V5t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V1b ) @ V5t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V2c ) @ V5t ) ) ) )
                    & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V6t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V6t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V6t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V7t: $i] :
                            ...
                            @ ( ap
                              @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V8t: $i] :
                                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V8t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2c @ V8t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V8t ) ) ) ) )
                              @ V7t ) ) ) )
                    & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V9t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V9t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V2c ) @ V3d ) @ V9t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V10t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V11t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V11t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V11t ) ) ) )
                                    @ V1b )
                                  @ V10t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                                      ...
                                      @ ( ap
                                        @ ( ap
                                          @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V13t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V13t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V13t ) ) ) )
                                          @ V1b )
                                        @ V12t ) ) ) )
                              @ V10t ) ) ) )
                    & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V14t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V14t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V2c ) @ V3d ) @ V14t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V15t: $i] :
                            ( ap
                            @ ( ap @ c_2Ebool_2E_5C_2F
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V16t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V16t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V3d ) @ V16t ) ) ) ) )
                                    @ V1b )
                                  @ V15t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a )
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V18t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V18t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V3d ) @ V18t ) ) ) ) )
                                            @ V1b )
                                          @ V17t ) ) ) ) )
                              @ V15t ) ) ) )
                    & ( ( ap
                      ...
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V20t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V2c ) @ V20t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V20t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V21t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V21t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V21t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V22t: $i] :
                              ...
                              @ ( ap
                                @ ( ap
                                  @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V23t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V23t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V23t ) ) ) )
                    ...
                    & ( ( ap
                        @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V24t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V24t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V1b ) @ V2c ) @ V24t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V25t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V26t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V26t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V26t ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V27t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V27t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V27t ) ) ) ) )
                                  @ V25t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                          ...
                                          @ ( ap
                                            @ ( ap
                                              @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                                                @ ( lam @ ty_2Enum_2Enum
                                                  @ ^ [V29t: $i] :
                                                      ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V29t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V29t ) ) ) )
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V30t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V30t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V30t ) ) ) ) )
                                            @ V28t ) ) ) ) )
                                @ V3d )
                              @ V25t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V31t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V31t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V1b ) @ V2c ) @ V31t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V32t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V33t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V33t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V33t ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V34t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V34t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V34t ) ) ) ) )
                                  @ V32t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V36t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V3d @ V36t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V36t ) ) ) )
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V37t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V37t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V37t ) ) ) ) )
                                          @ V35t ) ) ) )
                                @ V3d )
                              @ V32t ) ) ) ) ) ) ) ) ) )).
