...
thf(conj_thm_2Eordinal_2Efixpoints__exist,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ( ( ! [V1s: $i] :
             ...
             => ( ( ( V1s
                   != ( c_2Epred__set_2EEMPTY @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
                  & ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardleq @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ V1s ) @ ( c_2Epred__set_2EUNIV @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) ) ) )
               => ( ( ap @ V0f @ ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ V1s ) )
                  = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0f ) @ V1s ) ) ) ) )
          & ! [V2x: $i] :
...
thf(ax_thm_2Eordinal_2Eepsilon0__def,axiom,(
    ! [A_27a: del] :
      ( ( c_2Eordinal_2Eepsilon0 @ A_27a )
      = ( ap @ ( c_2Eordinal_2Eoleast @ A_27a )
        @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
          @ ^ [V0x: $i] :
              ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0x ) ) @ V0x ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Eepsilon0__fixpoint,conjecture,(
    ! [A_27a: del] :
