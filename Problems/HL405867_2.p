...
tff(conj_thm_2Ewords_2EBITS__ZEROL__DIMINDEX,lemma,(
...
tff(conj_thm_2Ewords_2Edimindex__dimword__le__iso,lemma,(
    ! [A_27a: del,A_27b: del] :
...
tff(conj_thm_2Ewords_2Ew2n__11__lift,conjecture,(
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c))))
           ...
           => ( surj__ty_2Enum_2Enum(ap(c_2Ewords_2Ew2n(A_27a),V0a)) = surj__ty_2Enum_2Enum(ap(c_2Ewords_2Ew2n(A_27b),V1b))
            <=> ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0a) = ap(c_2Ewords_2Ew2w(A_27b,A_27b),V1b) ) ) ) ) )).
