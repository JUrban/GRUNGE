...
thf(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__SET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__INTERIOR,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
            & ( V0s
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal__topology_2Eclosest__point @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) )
          <=> ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__FRONTIER,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
            & ( V0s
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
            & ~ ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) )
         => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal__topology_2Eclosest__point @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) ) ) ) )).
