...
thf(f13855_0_2E0,type,(
    f13855_0_2E0: u )).

thf(f13855_0_2E2,type,(
    f13855_0_2E2: du > du > u )).

thf(f13855_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef13855_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f13855_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef13855_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13855_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Ereal__topology_2Epermutes_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Ereal__topology_2Epermutes,axiom,(
    ! [A_27a: d,V0p_2E0: u,V3y_2E0: u,V4x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13855_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0p_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
...
thf(thm_2Ereal__topology_2Epermutes,axiom,(
    ...
    <=> ( ! [V2x_2E0: u] :
           ...
           => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0p_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
              = ( s @ A_27a @ V2x_2E0 ) ) )
        & ! [V3y_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f13855_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0p_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EPERMUTES__INJECTIVE,conjecture,(
    ! [A_27a: d,V0p_2E0: u,V1s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Epermutes_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
     => ! [V2x_2E0: u,V3y_2E0: u] :
          ( ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0p_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
