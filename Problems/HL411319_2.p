...
tff(lmtp_f3899,type,(
    f3899: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3899,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3899(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3899,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3899(V0a),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V0a))) )).

tff(conj_thm_2Ereal__topology_2EINTERIOR__HYPERPLANE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__STANDARD__HYPERPLANE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : ap(c_2Ereal__topology_2Einterior,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3899(V0a))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )).
