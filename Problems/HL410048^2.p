...
thf(conj_thm_2Eproduct_2ENPRODUCT__SUPERSET,conjecture,(
    ! [A_27a: del,V0f: $i] :
                  ...
                  & ! [V3x: $i] :
                     ...
                     => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2v ) )
                       ...
                       => ( ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ V3x ) )
                          = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V2v ) @ V0f ) )
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V1u ) @ V0f ) ) ) ) ) ) ) )).
