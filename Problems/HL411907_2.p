...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__UNION__LE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__INSERT__LE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
                ...
                & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),V0s)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),V1t)))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)))) ) ) ) )).
