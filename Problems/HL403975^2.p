...
thf(conj_thm_2Ellist_2ELFINITE__LGENLIST,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
...
thf(conj_thm_2Ellist_2ELLENGTH__LREPEAT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l ) ) )
        = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) ) ) ) )).
