...
thf(thm_2Ereal__topology_2EBOUNDED__SUBSET__BALL,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ? [V2r: tyop_2Erealax_2Ereal] :
          ...
          & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1x @ V2r ) ) ) ) ) )).
    ...
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ! [V3x: tyop_2Erealax_2Ereal] :
        ...
        & ! [V4u: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V1t ) @ V4u )
        ...
        & ! [V6u: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V1t ) @ V6u )
           => ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2s )
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V7x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V7x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V2s ) @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( V0f @ V7x ) @ V6u ) ) ) ) ) ) )
     => ! [V8x: tyop_2Erealax_2Ereal,V9e: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ V2s )
            & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V9e )
            & ( c_2Ereal__topology_2Ebounded__def @ ( V0f @ V8x ) )
            & ( (~)
              @ ( ( V0f @ V8x )
                = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )
         => ? [V10d: tyop_2Erealax_2Ereal] :
              ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V10d )
              & ! [V11x_27: tyop_2Erealax_2Ereal] :
                  ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V11x_27 @ V2s )
                    & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V8x @ V11x_27 ) ) @ V10d ) )
                 => ( ! [V12y: tyop_2Erealax_2Ereal] :
                        ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V12y @ ( V0f @ V8x ) )
                       => ? [V13y_27: tyop_2Erealax_2Ereal] :
                            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V13y_27 @ ( V0f @ V11x_27 ) )
                            & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V12y @ V13y_27 ) ) @ V9e ) ) )
                    & ! [V14y_27: tyop_2Erealax_2Ereal] :
                        ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V14y_27 @ ( V0f @ V11x_27 ) )
                       => ? [V15y: tyop_2Erealax_2Ereal] :
                            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V15y @ ( V0f @ V8x ) )
                            & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V14y_27 @ V15y ) ) @ V9e ) ) ) ) ) ) ) ) )).
     ...
     => ! [V8x: tyop_2Erealax_2Ereal,V9e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V10d: tyop_2Erealax_2Ereal] :
              ...
              & ! [V11x_27: tyop_2Erealax_2Ereal] :
                  ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V11x_27 @ V2s )
                    & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V8x @ V11x_27 ) ) @ V10d ) )
                 => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( V0f @ V8x ) @ ( V0f @ V11x_27 ) ) ) @ V9e ) ) ) ) ) )).
