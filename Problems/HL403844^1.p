...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELMAP_2E2_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) ) @ c_2Ellist_2ELMAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Ellist_2ELMAP_2E2_2Emono_2EA_27c_20mono_2EA_27b,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ c_2Ellist_2ELMAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Ellist_2ELMAP__MAP,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1g_2E0: u,V2ll_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V1g_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V2ll_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V1g_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V2ll_2E0 ) ) ) ) )).
