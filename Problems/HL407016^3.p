...
thf(thm_2Einteger_2EINT__LE__MONO,axiom,(
    ! [V0x: tyop_2Einteger_2Eint,V1y: tyop_2Einteger_2Eint,V2z: tyop_2Einteger_2Eint] :
     ...
     => ( ( c_2Einteger_2Eint__le @ ( c_2Einteger_2Eint__mul @ V0x @ V1y ) @ ( c_2Einteger_2Eint__mul @ V0x @ V2z ) )
        = ( c_2Einteger_2Eint__le @ V1y @ V2z ) ) ) )).
...
thf(thm_2Einteger__word_2Ei2w__minus__1,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Einteger__word_2Ei2w @ A_27a @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
...
thf(thm_2Einteger__word_2Esaturate__i2sw__0,axiom,(
    ! [A_27a: $tType] :
...
thf(thm_2Enumeral__bit_2EiBITWISE,axiom,
    ...
    & ! [V3x: tyop_2Enum_2Enum,V4opr: $o > $o > $o,V5a: tyop_2Enum_2Enum,V6b: tyop_2Enum_2Enum] :
        ...
        = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
          @ ^ [V7w: tyop_2Enum_2Enum] :
              ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( V4opr @ ( c_2Earithmetic_2EODD @ V5a ) @ ( c_2Earithmetic_2EODD @ V6b ) ) @ ( c_2Earithmetic_2EBIT1 @ V7w ) @ ( c_2Enumeral_2EiDUB @ V7w ) )
    ...
    & ! [V8x: tyop_2Enum_2Enum,V9opr: $o > $o > $o,V10a: tyop_2Enum_2Enum,V11b: tyop_2Enum_2Enum] :
        ...
        = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
          @ ^ [V12w: tyop_2Enum_2Enum] :
              ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( V9opr @ ( c_2Earithmetic_2EODD @ V10a ) @ ( c_2Earithmetic_2EODD @ V11b ) ) @ ( c_2Earithmetic_2EBIT1 @ V12w ) @ ( c_2Enumeral_2EiDUB @ V12w ) )
...
thf(thm_2Einteger__word_2Esigned__saturate__sub,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1b: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Einteger__word_2Esigned__saturate__sub @ A_27a @ V0a @ V1b )
      = ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Emin_2E_3D @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ V1b @ ( c_2Ewords_2Eword__L @ A_27a ) ) @ ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Ewords_2Eword__le @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V0a ) @ ( c_2Ewords_2Eword__H @ A_27a ) @ ( c_2Ewords_2Eword__add @ A_27a @ V0a @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) @ ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ewords_2Eword__and @ A_27a @ V0a @ ( c_2Ewords_2Eword__1comp @ A_27a @ V1b ) ) @ ( c_2Einteger__word_2Esigned__saturate__add @ A_27a @ V0a @ ( c_2Ewords_2Eword__2comp @ A_27a @ V1b ) ) ) ) ) )).
