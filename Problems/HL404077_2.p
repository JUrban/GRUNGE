...
tff(lamtp_f1375,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1375(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1375,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1375(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),k(ty_2Enum_2Enum,c_2Ebool_2EF)),inj__ty_2Enum_2Enum(V2t)) ) )).

tff(lmtp_f1376,type,(
    f1376: $i > $i )).

tff(lamtp_f1376,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1376(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1376,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V4t: tp__ty_2Enum_2Enum] : ap(f1376(V0a),inj__ty_2Enum_2Enum(V4t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1311(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),inj__ty_2Enum_2Enum(V4t))) ) )).

tff(lmtp_f1377,type,(
    f1377: ( $i * $i ) > $i )).

tff(lamtp_f1377,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1377(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1377,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1377(V0a,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1296(V1b)),f1297(V0a,V1b)),inj__ty_2Enum_2Enum(V7t))) ) ) )).

tff(lmtp_f1378,type,(
    f1378: ( $i * $i ) > $i )).

tff(lamtp_f1378,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1378(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1378,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V10t: tp__ty_2Enum_2Enum] : ap(f1378(V1b,V0a),inj__ty_2Enum_2Enum(V10t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1314(V1b)),f1315(V0a,V1b)),inj__ty_2Enum_2Enum(V10t)) ) ) )).

tff(lmtp_f1379,type,(
    f1379: ( $i * $i ) > $i )).

tff(lamtp_f1379,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1379(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1379,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V13t: tp__ty_2Enum_2Enum] : ap(f1379(V0a,V1b),inj__ty_2Enum_2Enum(V13t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1317(V0a,V1b)),f1318(V0a,V1b)),inj__ty_2Enum_2Enum(V13t))) ) ) )).

tff(lmtp_f1380,type,(
    f1380: ( $i * $i ) > $i )).

tff(lamtp_f1380,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1380(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1380,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V16t: tp__ty_2Enum_2Enum] : ap(f1380(V1b,V0a),inj__ty_2Enum_2Enum(V16t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1320(V1b)),f1321(V0a,V1b)),inj__ty_2Enum_2Enum(V16t)) ) ) )).

tff(lmtp_f1381,type,(
    f1381: ( $i * $i ) > $i )).

tff(lamtp_f1381,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1381(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1381,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V19t: tp__ty_2Enum_2Enum] : ap(f1381(V0a,V1b),inj__ty_2Enum_2Enum(V19t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1323(V0a)),V1b),inj__ty_2Enum_2Enum(V19t))) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EPUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ( ap(c_2EPast__Temporal__Logic_2EPALWAYS,V0a) = f1375(V0a)
            & ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,V0a) = f1376(V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V1b) = f1377(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V0a),V1b) = f1378(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V0a),V1b) = f1379(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V0a),V1b) = f1380(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),V1b) = f1381(V0a,V1b) ) ) ) )).
