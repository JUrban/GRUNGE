...
tff(conj_thm_2Eseq_2ETRANSFORM__2D__NUM,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ...
          & ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V3m)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V4n)))) )
...
tff(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__MONO,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
      <=> ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
...
tff(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__DISJOINT,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
      <=> ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
