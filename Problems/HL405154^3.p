...
thf(thm_2Ebag_2EBAG__EVERY__THM,axiom,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ! [V0P: A_27a > $o] :
          ( c_2Ebag_2EBAG__EVERY @ A_27a @ V0P @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
      & ! [V1P: A_27b > $o,V2e: A_27b,V3b: A_27b > tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2EBAG__EVERY @ A_27b @ V1P @ ( c_2Ebag_2EBAG__INSERT @ A_27b @ V2e @ V3b ) )
        <=> ( ( V1P @ V2e )
            & ( c_2Ebag_2EBAG__EVERY @ A_27b @ V1P @ V3b ) ) ) ) )).
