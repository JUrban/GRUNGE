...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__EMPTY,lemma,(
    p(ap(c_2Ereal__topology_2Ecollinear,c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) )).

fof(conj_thm_2Ereal__topology_2ECOLLINEAR__SING,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__2,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__SMALL,conjecture,(
    ! [V0s] :
