...
thf(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__CAUCHY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__IMP__TOTALLY__BOUNDED,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
       => ! [V1e: tp__ty_2Erealax_2Ereal] :
                ...
                & ( p
                  @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0s )
                    @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal )
                      @ ( ap
                        @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                          @ ( lam @ ty_2Erealax_2Ereal
                            @ ^ [V3x: $i] :
                                ( ap @ c_2Ereal__topology_2Eball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V3x ) @ ( inj__ty_2Erealax_2Ereal @ V1e ) ) ) ) )
                        @ V2k ) ) ) ) ) ) ) ) )).
