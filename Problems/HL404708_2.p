...
tff(conj_thm_2Efinite__map_2EFRANGE__FMAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
           => ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUN__FMAP(A_27a,A_27a),V1f),V0P)) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f),V0P) ) ) ) )).
