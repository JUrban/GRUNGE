...
fof(conj_thm_2Erich__list_2ESEG__CONS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0j] :
         ...
         => ! [V1n] :
             ...
             => ! [V2h] :
                 ...
                 => ! [V3t] :
                     ...
                     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0j))
                          & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V1n),V0j)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),V3t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) )
                       => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V1n),V0j),ap(ap(c_2Elist_2ECONS(A_27a),V2h),V3t)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V1n),ap(ap(c_2Earithmetic_2E_2D,V0j),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3t) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2ESEG__SUC__EL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1i] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2E_2B,V1i),V0n)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Enum_2ESUC,V0n)),V1i),V2l) = ap(ap(c_2Elist_2ECONS(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V1i),V2l)),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2l)) ) ) ) ) ) )).
