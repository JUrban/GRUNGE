...
fof(conj_thm_2Erich__list_2ESEG__APPEND2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
         ...
         => ! [V1m] :
             ...
             => ! [V2n] :
                 ...
                 => ! [V3l2] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l1)),V1m))
                          & p(ap(ap(c_2Earithmetic_2E_3C_3D,V2n),ap(c_2Elist_2ELENGTH(A_27a),V3l2))) )
                       => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V2n),V1m),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V3l2)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V2n),ap(ap(c_2Earithmetic_2E_2D,V1m),ap(c_2Elist_2ELENGTH(A_27a),V0l1))),V3l2) ) ) ) ) ) ) )).
