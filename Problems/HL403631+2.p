...
fof(mem_c_2Efcp_2EFCP__TL,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) ) ) ) )).
...
fof(lameq_f1094,axiom,(
    ! [A_27a,A_27c,V0v] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f1094(A_27a,A_27c,V0v),V1i) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0v),ap(c_2Enum_2ESUC,V1i)) ) ) )).
...
fof(conj_thm_2Efcp_2EREAD__TL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0i] :
                 ...
                 => ! [V1a] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0i),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
                       => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),V1a)),V0i) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1a),ap(c_2Enum_2ESUC,V0i)) ) ) ) ) ) ) )).
