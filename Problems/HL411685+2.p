...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ! [V1f] :
                     ...
                     => ? [V3e] :
                          ...
                          & ! [V4y] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V0s))
                                  & ap(V1f,V4y) != ap(V1f,V2x) )
                               => p(ap(ap(c_2Ereal_2Ereal__lte,V3e),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V1f,V4y)),ap(V1f,V2x))))) ) ) ) ) ) )
             => ? [V5a] :
