...
tff(conj_thm_2Ereal__topology_2EBOUNDED__SUMS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EDIAMETER__SUMS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f4077,type,(
    f4077: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4077,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2y: tp__ty_2Erealax_2Ereal] : mem(f4077(V1t,V0s,V2y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f4077,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2y: tp__ty_2Erealax_2Ereal,V3z: tp__ty_2Erealax_2Ereal] : ap(f4077(V1t,V0s,V2y),inj__ty_2Erealax_2Ereal(V3z)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V3z))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),V1t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3z)),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))))))) ) ) )).

tff(lmtp_f4076,type,(
    f4076: ( $i * $i ) > $i )).

tff(lamtp_f4076,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f4076,axiom,(
    ! [V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s: $i] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2y: tp__ty_2Erealax_2Ereal] : ap(f4076(V1t,V0s),inj__ty_2Erealax_2Ereal(V2y)) = f4077(V1t,V0s,V2y) ) ) )).

tff(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__SUMS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__DIAMETER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         ...
         => ? [V2d: tp__ty_2Erealax_2Ereal] :
              ...
              & ! [V3t: $i] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V3t))
                      & V3t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
