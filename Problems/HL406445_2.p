...
tff(lamtp_f2305,axiom,(
    mem(f2305,arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2305,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum] : ap(f2305,inj__ty_2Enum_2Enum(V2n)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Ebitstring_2Eboolify__reverse__map,conjecture,(
    ! [V0v: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum,V1a: tp__c_ty_2Elist_2Elist_o] : surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Ebitstring_2Eboolify,inj__c_ty_2Elist_2Elist_o(V1a)),inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(V0v))) = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Elist_2EAPPEND(bool),ap(c_2Elist_2EREVERSE(bool),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),f2305),inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(V0v)))),inj__c_ty_2Elist_2Elist_o(V1a))) )).
