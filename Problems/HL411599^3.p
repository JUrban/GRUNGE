...
thf(thm_2Ereal__topology_2ECLOSURE__IMAGE__CLOSURE,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
     => ( ( c_2Ereal__topology_2Eclosure @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) ) )
        = ( c_2Ereal__topology_2Eclosure @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__MAP__CLOSURES,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) )
    <=> ! [V1s: tyop_2Erealax_2Ereal > $o] :
          ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) ) @ ( c_2Ereal__topology_2Eclosure @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) ) ) )).
