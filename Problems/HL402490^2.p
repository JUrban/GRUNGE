...
thf(conj_thm_2EquantHeuristics_2EGUESS__RULES__EQUIV,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: $i] :
      ( ( mem @ V0i @ ( arr @ A_27a @ A_27b ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27b @ bool ) )
                     ...
                     => ( ( ( ( p
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V7x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V1P @ V7x ) ) @ ( ap @ V2Q @ V7x ) ) ) ) ) )
                        & ( ( ( p
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V10x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V1P @ V10x ) ) @ ( ap @ V2Q @ V10x ) ) ) ) ) )
                        & ( ( ( p
                              @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__POINT @ A_27a @ A_27b ) @ V0i )
                                @ ( lam @ A_27b
                                  @ ^ [V11x: $i] :
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V13x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V1P @ V13x ) ) @ ( ap @ V2Q @ V13x ) ) ) ) ) )
                        & ( ( ( p
                              @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b ) @ V0i )
                                @ ( lam @ A_27b
                                  @ ^ [V14x: $i] :
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__POINT @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V16x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V1P @ V16x ) ) @ ( ap @ V2Q @ V16x ) ) ) ) ) )
                        & ( ( ( p
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V19x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V3P1 @ V19x ) ) @ ( ap @ V4P2 @ V19x ) ) ) ) ) )
                        & ( ( ( p
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V22x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V3P1 @ V22x ) ) @ ( ap @ V4P2 @ V22x ) ) ) ) ) )
                        & ( ( ( p
                              @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b ) @ V0i )
                                @ ( lam @ A_27b
                                  @ ^ [V23x: $i] :
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V25x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V3P1 @ V25x ) ) @ ( ap @ V4P2 @ V25x ) ) ) ) ) )
                        & ( ( ( p
                              @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__FORALL__GAP @ A_27a @ A_27b ) @ V0i )
                                @ ( lam @ A_27b
                                  @ ^ [V26x: $i] :
                         ...
                         => ( p
                            @ ( ap @ ( ap @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP @ A_27a @ A_27b ) @ V0i )
                              @ ( lam @ A_27b
                                @ ^ [V28x: $i] :
                                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ V3P1 @ V28x ) ) @ ( ap @ V4P2 @ V28x ) ) ) ) ) ) ) ) ) ) ) ) )).
