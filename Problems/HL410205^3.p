...
thf(thm_2Emeasure_2ESIGMA__ALGEBRA__SIGMA,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1sts: ( A_27a > $o ) > $o] :
     ...
     => ( c_2Emeasure_2Esigma__algebra @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1sts ) ) ) )).

thf(thm_2Emeasure_2ESIGMA__SUBSET__SUBSETS,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1a: ( A_27a > $o ) > $o] :
      ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ V1a @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1a ) ) ) )).
...
thf(thm_2Emeasure_2ESIGMA__REDUCE,axiom,(
    ! [A_27a: $tType,V0sp: A_27a > $o,V1a: ( A_27a > $o ) > $o] :
      ( ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ V0sp @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1a ) ) )
      = ( c_2Emeasure_2Esigma @ A_27a @ V0sp @ V1a ) ) )).
...
thf(thm_2Emeasure_2EMEASURE__PRESERVING__UP__SIGMA,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0m1: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1m2: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27b > $o ) > $o ) @ ( ( A_27b > $o ) > tyop_2Erealax_2Ereal ) ),V2a: ( A_27a > $o ) > $o] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m1 )
        & ( ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m1 )
          = ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m1 ) @ V2a ) ) ) )
     => ( c_2Epred__set_2ESUBSET @ ( A_27a > A_27b ) @ ( c_2Emeasure_2Emeasure__preserving @ A_27a @ A_27b @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m1 ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ V2a @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m1 ) ) ) @ V1m2 ) @ ( c_2Emeasure_2Emeasure__preserving @ A_27a @ A_27b @ V0m1 @ V1m2 ) ) ) )).
