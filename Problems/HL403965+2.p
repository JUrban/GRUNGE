...
fof(conj_thm_2Ellist_2ELNTH__LMAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0n] :
             ...
             => ! [V1f] :
                 ...
                 => ! [V2l] :
                     ...
                     => ap(ap(c_2Ellist_2ELNTH(A_27b),V0n),ap(ap(c_2Ellist_2ELMAP(A_27a,A_27a),V1f),V2l)) = ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V1f),ap(ap(c_2Ellist_2ELNTH(A_27a),V0n),V2l)) ) ) ) ) ) )).
