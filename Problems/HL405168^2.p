         ...
         => ( ( ap @ ( ap @ ( c_2Econtainer_2EBAG__OF__FMAP @ A_27a @ A_27b @ A_27c ) @ V0f ) @ V1b )
            = ( lam @ A_27a
              @ ^ [V2x: $i] :
                  ...
                  @ ( lam @ A_27b
                    @ ^ [V3k: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3k ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27b @ A_27c ) @ V1b ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V2x ) @ ( ap @ ( ap @ V0f @ V3k ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27b @ A_27c ) @ V1b ) @ V3k ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Econtainer_2EBAG__OF__FMAP__THM,conjecture,(
