...
fof(conj_thm_2Erelation_2ERSUBSET__ANTISYM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Erelation_2ERSUBSET__antisymmetric,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => p(ap(c_2Erelation_2Eantisymmetric(arr(A_27a,arr(A_27b,bool))),c_2Erelation_2ERSUBSET(A_27a,A_27a))) ) ) )).
