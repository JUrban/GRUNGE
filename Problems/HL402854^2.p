...
thf(conj_thm_2Erich__list_2EFRONT__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ! [V2e: $i] :
              ( ( mem @ V2e @ A_27a )
             => ( ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2e ) @ V1l2 ) ) )
                = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2e ) @ V1l2 ) ) ) ) ) ) ) )).
