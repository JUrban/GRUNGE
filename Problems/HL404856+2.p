...
fof(conj_thm_2Efinite__map_2Efmap__to__list,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0m] :
             ...
             => ? [V1l] :
                  ...
                  & p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1l)))
                  & V0m = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1l) ) ) ) ) )).
