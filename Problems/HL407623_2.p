...
tff(tp_c_2EordinalNotation_2Erestn,type,(
    c_2EordinalNotation_2Erestn: $i )).

tff(mem_c_2EordinalNotation_2Erestn,axiom,(
    mem(c_2EordinalNotation_2Erestn,arr(ty_2EordinalNotation_2Eosyntax,arr(ty_2Enum_2Enum,ty_2EordinalNotation_2Eosyntax))) )).

tff(stp_fo_c_2EordinalNotation_2Erestn,type,(
    fo__c_2EordinalNotation_2Erestn: ( tp__ty_2EordinalNotation_2Eosyntax * tp__ty_2Enum_2Enum ) > tp__ty_2EordinalNotation_2Eosyntax )).

tff(stp_eq_fo_c_2EordinalNotation_2Erestn,axiom,(
    ! [X0: tp__ty_2EordinalNotation_2Eosyntax,X1: tp__ty_2Enum_2Enum] : inj__ty_2EordinalNotation_2Eosyntax(fo__c_2EordinalNotation_2Erestn(X0,X1)) = ap(ap(c_2EordinalNotation_2Erestn,inj__ty_2EordinalNotation_2Eosyntax(X0)),inj__ty_2Enum_2Enum(X1)) )).
...
tff(ax_thm_2EordinalNotation_2Erestn__def,axiom,
    ( ! [V0a: tp__ty_2EordinalNotation_2Eosyntax] : surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,inj__ty_2EordinalNotation_2Eosyntax(V0a)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = V0a
    & ! [V1a: tp__ty_2EordinalNotation_2Eosyntax,V2n: tp__ty_2Enum_2Enum] : surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,inj__ty_2EordinalNotation_2Eosyntax(V1a)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n)))) = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,ap(c_2EordinalNotation_2Etail,inj__ty_2EordinalNotation_2Eosyntax(V1a))),inj__ty_2Enum_2Enum(V2n))) )).

tff(conj_thm_2EordinalNotation_2Erestn__def__compute,conjecture,
    ( ! [V0a: tp__ty_2EordinalNotation_2Eosyntax] : surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,inj__ty_2EordinalNotation_2Eosyntax(V0a)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = V0a
    ...
    & ! [V3a: tp__ty_2EordinalNotation_2Eosyntax,V4n: tp__ty_2Enum_2Enum] : surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,inj__ty_2EordinalNotation_2Eosyntax(V3a)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(V4n))))) = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(c_2EordinalNotation_2Erestn,ap(c_2EordinalNotation_2Etail,inj__ty_2EordinalNotation_2Eosyntax(V3a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V4n))))) )).
