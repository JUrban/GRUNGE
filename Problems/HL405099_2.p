...
tff(conj_thm_2Equotient__pred__set_2EIN__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
               ...
               => ! [V3x: $i] :
                   ...
                   => ! [V4s: $i] :
                       ...
                       => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V3x),V4s))
                        <=> p(ap(ap(c_2Ebool_2EIN(A_27a),ap(V2rep,V3x)),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V4s))) ) ) ) ) ) ) ) )).
