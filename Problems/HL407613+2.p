...
fof(conj_thm_2EordinalNotation_2Eis__ord__cases,conjecture,(
    ! [V0a0] :
      ( mem(V0a0,ty_2EordinalNotation_2Eosyntax)
     => ( p(ap(c_2EordinalNotation_2Eis__ord,V0a0))
      <=> ( ? [V1k] :
              ( mem(V1k,ty_2Enum_2Enum)
              & V0a0 = ap(c_2EordinalNotation_2EEnd,V1k) )
          | ? [V2e] :
              ...
              & ? [V3k] :
                  ...
                  & ? [V4t] :
                      ...
                      & V0a0 = ap(ap(ap(c_2EordinalNotation_2EPlus,V2e),V3k),V4t)
