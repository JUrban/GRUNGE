...
tff(conj_thm_2Ereal_2EABS__BETWEEN,lemma,(
...
tff(conj_thm_2Eutil__prob_2EPOW__HALF__MONO,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Eextreal_2Epow__le__mono,lemma,(
...
tff(conj_thm_2Eextreal_2EEXTREAL__ARCH__POW,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
      ( V0x != fo__c_2Eextreal_2EPosInf
...
tff(lamtp_f3473,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3473(V0f),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3473,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f3473(V0f),inj__ty_2Enum_2Enum(V2n)) = ap(c_2Eextreal_2ENormal,ap(V0f,inj__ty_2Enum_2Enum(V2n))) ) )).

tff(conj_thm_2Eextreal_2Esup__seq,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Eextreal_2Emono__increasing,V0f))
         => ( p(ap(ap(c_2Eseq_2E_2D_2D_3E,V0f),inj__ty_2Erealax_2Ereal(V1l)))
          <=> surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3473(V0f)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V1l))) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Elemma__fn__sup,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
