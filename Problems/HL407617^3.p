...
thf(thm_2EordinalNotation_2Erank__def,axiom,
    ( ! [V0v0: tyop_2Enum_2Enum] :
        ( ( c_2EordinalNotation_2Erank @ ( c_2EordinalNotation_2EEnd @ V0v0 ) )
        = c_2Enum_2E0 )
    & ! [V1e: tyop_2EordinalNotation_2Eosyntax,V2k: tyop_2Enum_2Enum,V3t: tyop_2EordinalNotation_2Eosyntax] :
        ( ( c_2EordinalNotation_2Erank @ ( c_2EordinalNotation_2EPlus @ V1e @ V2k @ V3t ) )
        = ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2EordinalNotation_2Erank @ V1e ) ) ) )).

thf(thm_2EordinalNotation_2Eis__ord__downclosed,axiom,(
    ! [V0w: tyop_2EordinalNotation_2Eosyntax,V1t: tyop_2EordinalNotation_2Eosyntax,V2k: tyop_2Enum_2Enum] :
      ( ( c_2EordinalNotation_2Eis__ord @ ( c_2EordinalNotation_2EPlus @ V0w @ V2k @ V1t ) )
     => ( ( c_2EordinalNotation_2Eis__ord @ V0w )
        & ( c_2EordinalNotation_2Eis__ord @ V1t ) ) ) )).
...
thf(thm_2EordinalNotation_2Eoless__expt,conjecture,(
    ! [V0e: tyop_2EordinalNotation_2Eosyntax,V1k: tyop_2Enum_2Enum,V2t: tyop_2EordinalNotation_2Eosyntax] :
      ( ( c_2EordinalNotation_2Eis__ord @ ( c_2EordinalNotation_2EPlus @ V0e @ V1k @ V2t ) )
     => ( c_2EordinalNotation_2Eoless @ V0e @ ( c_2EordinalNotation_2EPlus @ V0e @ V1k @ V2t ) ) ) )).
