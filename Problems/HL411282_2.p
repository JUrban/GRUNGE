...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__UNION__LOCAL__OPEN,lemma,(
    ! [V0t: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
             => ( ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V2s),V0t))),V2s))
                  & p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V2s),V0t))),V0t))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LOCAL__OPEN,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
