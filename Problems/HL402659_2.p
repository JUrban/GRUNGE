...
tff(lamtp_f802,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => mem(f802(A_27a,V0P,V1Q),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f802,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1Q: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f802(A_27a,V0P,V1Q),V3x) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0P,V3x)),ap(V1Q,V3x)) ) ) ) )).

tff(conj_thm_2Erich__list_2EEXISTS__DISJ,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => ! [V2l: $i] :
             ...
             => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),f802(A_27a,V0P,V1Q)),V2l))
