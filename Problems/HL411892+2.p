...
fof(conj_thm_2Ereal__topology_2ESETDIST__LINEAR__IMAGE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
                  & ! [V3x] :
                      ( mem(V3x,ty_2Erealax_2Ereal)
                     => ap(c_2Ereal_2Eabs,ap(V0f,V3x)) = ap(c_2Ereal_2Eabs,V3x) ) )
               => ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2t))) = ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1s),V2t)) ) ) ) ) )).
