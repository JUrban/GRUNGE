...
tff(thm_2Erelation_2EIN__RRANGE,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0y_2E0: A_27a,V1R_2E0: tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))] :
      ( p(c_2Ebool_2EIN_2E2(A_27a,V0y_2E0,c_2Erelation_2ERRANGE_2E1(A_27b,A_27a,V1R_2E0)))
    <=> ? [V2x_2E0: A_27b] : p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1R_2E0,V2x_2E0),V0y_2E0)) ) )).
...
tff(thm_2Eset__relation_2Erange__to__rel__conv,conjecture,(
