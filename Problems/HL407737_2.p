...
tff(conj_thm_2Ereal_2EABS__LT__MUL2,lemma,(
    ! [V0w: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0w))),inj__ty_2Erealax_2Ereal(V2y)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V3z))) )
     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0w)),inj__ty_2Erealax_2Ereal(V1x)))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V3z)))) ) )).
...
tff(conj_thm_2Enets_2EDORDER__LEMMA,lemma,(
    ! [A_27a: del,V0g: $i] :
...
tff(conj_thm_2Enets_2EMR1__BOUNDED,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,bool)))
     => ! [V1f: $i] :
...
tff(conj_thm_2Enets_2ENET__CONV__NZ,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2x0: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V3N: $i] :
                  ...
                  & ! [V4n: $i] :
                      ( mem(V4n,A_27a)
                     => ( p(ap(ap(V0g,V4n),V3N))
                       => surj__ty_2Erealax_2Ereal(ap(V1x,V4n)) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) ) ) )).
...
tff(conj_thm_2Enets_2ENET__CONV__IBOUNDED,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Enets_2ENET__INV,conjecture,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Enets_2Edorder(A_27a),V0g))
       => ! [V1x: $i] :
