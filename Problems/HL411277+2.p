...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__CLOSED__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     ...
     => ! [V0f] :
         ...
         => ! [V1g] :
             ...
             => ! [V5k] :
                 ...
                 => mem(f3887(V2s,V0f,V1g,V5k),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) ) )).

fof(lameq_f3887,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1g] :
             ...
             => ! [V5k] :
                 ...
                 => ! [V6x] :
                     ...
                     => ap(f3887(V2s,V0f,V1g,V5k),V6x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V6x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6x),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1g),V0f),V6x)),V5k))) ) ) ) ) ) )).

fof(lamtp_f3888,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V7k] :
             ...
             => mem(f3888(V2s,V0f,V7k),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f3888,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V7k] :
             ...
             => ! [V8x] :
                 ...
                 => ap(f3888(V2s,V0f,V7k),V8x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V8x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V8x),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V8x)),V7k))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EPROPER__MAP__FROM__COMPOSITION__RIGHT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             ...
             => ! [V3t] :
                 ...
                 => ! [V4u] :
                     ...
                     => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
                          ...
                          & ! [V5k] :
                              ( mem(V5k,arr(ty_2Erealax_2Ereal,bool))
                             => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V5k),V4u))
                                  & p(ap(c_2Ereal__topology_2Ecompact,V5k)) )
                               => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3887(V2s,V0f,V1g,V5k)))) ) ) )
                       => ! [V7k] :
                            ( mem(V7k,arr(ty_2Erealax_2Ereal,bool))
                           => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V7k),V3t))
                                & p(ap(c_2Ereal__topology_2Ecompact,V7k)) )
                             => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3888(V2s,V0f,V7k)))) ) ) ) ) ) ) ) ) )).
