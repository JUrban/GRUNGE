...
thf(conj_thm_2Ewords_2EWORD__NEG__EQ,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1v: $i] :
...
thf(conj_thm_2Ewords_2EWORD__ADD__LEFT__LO,lemma,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ! [V1c: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lo @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V2a ) @ V0b ) ) @ V1c ) )
              <=> ( p
                  @ ( ap
                    @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ V0b ) @ V1c ) )
                      @ ( ap
                        @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) @ bool )
                          @ ( lam @ ( ty_2Efcp_2Ecart @ bool @ A_27a )
                            @ ^ [V3x: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lo @ A_27a ) @ V2a ) @ V3x ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ V0b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V1c ) ) @ V3x ) ) @ V2a ) ) ) ) )
                        @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Ewords_2Ew2n @ A_27a ) @ V1c ) ) @ ( ap @ ( c_2Ewords_2Ew2n @ A_27a ) @ V0b ) ) ) ) )
                    @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V0b ) ) @ V2a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lo @ A_27a ) @ V2a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V0b ) ) @ V1c ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__LESS__NEG__LEFT,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EWORD__ADD__LEFT__LO2,conjecture,(
    ! [A_27a: del,V0c: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lo @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0c ) @ V1a ) ) @ V1a ) )
          <=> ( ( V1a
              ...
              & ( ( ( V0c
                ...
                | ( V1a
                  = ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V0c ) ) ) ) ) ) ) )).
