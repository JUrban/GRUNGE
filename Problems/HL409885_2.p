...
tff(lmtp_f3418,type,(
    f3418: ( tp__ty_2Enum_2Enum * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3418,axiom,(
    ! [V6j: tp__ty_2Enum_2Enum,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal] : mem(f3418(V6j,V0a,V2y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3418,axiom,(
    ! [V6j: tp__ty_2Enum_2Enum,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal,V7k: tp__ty_2Enum_2Enum] : ap(f3418(V6j,V0a,V2y),inj__ty_2Enum_2Enum(V7k)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6j)),inj__ty_2Enum_2Enum(V7k))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Enum_2Enum(V7k))) ) )).

tff(lmtp_f3417,type,(
    f3417: ( tp__ty_2Erealax_2Ereal * $i * tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3417,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] : mem(f3417(V2y,V0a,V3n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3417,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal,V6j: tp__ty_2Enum_2Enum] : ap(f3417(V2y,V0a,V3n,V1x),inj__ty_2Enum_2Enum(V6j)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V6j))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),f3418(V6j,V0a,V2y))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Enum_2Enum(V6j))) ) )).

tff(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN__ALT,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V3n)))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),f3413(V0a,V1x))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),f3414(V0a,V2y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),f3417(V2y,V0a,V3n,V1x)))) ) ) )).
