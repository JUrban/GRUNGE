...
tff(lamtp_f420,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool)))
     => mem(f420(A_27a,V0R),arr(arr(A_27a,bool),bool)) ) )).
...
tff(lameq_f420,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ap(f420(A_27a,V0R),V1s) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(A_27a),V1s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V1s),c_2Epred__set_2EEMPTY(A_27a))))),ap(ap(V0R,ap(c_2Epred__set_2EREST(A_27a),V1s)),V1s)) ) ) )).

tff(lmtp_f419,type,(
    f419: ( del * del ) > $i )).

tff(lamtp_f419,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f419(A_27a,A_27a),arr(arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool)),bool)) )).

tff(lameq_f419,axiom,(
    ! [A_27a: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool)))
     => ap(f419(A_27a,A_27a),V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(arr(A_27a,bool)),V0R)),ap(c_2Ebool_2E_21(arr(A_27a,bool)),f420(A_27a,V0R))) ) )).

tff(lmtp_f422,type,(
    f422: ( del * del * $i ) > $i )).

tff(lamtp_f422,axiom,(
    ! [A_27a: del,A_27a: del,V2SET__TO__LIST: $i] :
      ( mem(V2SET__TO__LIST,arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)))
     => mem(f422(A_27a,A_27a,V2SET__TO__LIST),arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a))) ) )).
...
tff(lameq_f422,axiom,(
    ! [A_27a: del,A_27a: del,V2SET__TO__LIST: $i] :
     ...
     => ! [V3a: $i] :
         ...
         => ap(f422(A_27a,A_27a,V2SET__TO__LIST),V3a) = ap(c_2Ecombin_2EI(ty_2Elist_2Elist(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(c_2Epred__set_2EFINITE(A_27a),V3a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V3a),c_2Epred__set_2EEMPTY(A_27a))),c_2Elist_2ENIL(A_27a)),ap(ap(c_2Elist_2ECONS(A_27a),ap(c_2Epred__set_2ECHOICE(A_27a),V3a)),ap(V2SET__TO__LIST,ap(c_2Epred__set_2EREST(A_27a),V3a))))),c_2Ebool_2EARB(ty_2Elist_2Elist(A_27a)))) ) ) )).

tff(lmtp_f421,type,(
    f421: ( del * del * del ) > $i )).

tff(lamtp_f421,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del] : mem(f421(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)),arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)))) )).

tff(lameq_f421,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V2SET__TO__LIST: $i] :
      ( mem(V2SET__TO__LIST,arr(arr(A_27a,bool),ty_2Elist_2Elist(A_27a)))
     => ap(f421(A_27a,A_27a,A_27a),V2SET__TO__LIST) = f422(A_27a,A_27a,V2SET__TO__LIST) ) )).

tff(ax_thm_2Elist_2ESET__TO__LIST__primitive__def,axiom,(
    ! [A_27a: del] : c_2Elist_2ESET__TO__LIST(A_27a) = ap(ap(c_2Erelation_2EWFREC(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emin_2E_40(arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool))),f419(A_27a,A_27a))),f421(A_27a,A_27a,A_27a)) )).

tff(conj_thm_2Elist_2ESET__TO__LIST__IND,conjecture,(
    ! [A_27a: del,V0P: $i] :
