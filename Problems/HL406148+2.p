...
fof(conj_thm_2Ewords_2EADD__WITH__CARRY__SUB,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1y] :
              ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
             => ap(c_2Ewords_2Eadd__with__carry(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V0x),ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__1comp(A_27a),V1y)),c_2Ebool_2ET))) = ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__sub(A_27a),V0x),V1y)),ap(ap(c_2Epair_2E_2C(bool,bool),ap(ap(c_2Ewords_2Eword__ls(A_27a),V1y),V0x)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ewords_2Eword__msb(A_27a),V0x)),ap(c_2Ewords_2Eword__msb(A_27a),V1y)))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ewords_2Eword__msb(A_27a),ap(ap(c_2Ewords_2Eword__sub(A_27a),V0x),V1y))),ap(c_2Ewords_2Eword__msb(A_27a),V0x)))))) ) ) ) )).
