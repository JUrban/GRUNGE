...
thf(thm_2Ereal__topology_2EINTERIOR__BIGINTER__SUBSET,conjecture,(
    ! [V0f: ( tyop_2Erealax_2Ereal > $o ) > $o] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Einterior @ ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ V0f ) ) @ ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ c_2Ereal__topology_2Einterior @ V0f ) ) ) )).
