...
thf(conj_thm_2Eiterate_2EITERATE__DELTA,lemma,(
       ...
       => ! [V1f: $i] :
           ...
           => ! [V2a: $i] :
               ...
               => ! [V3s: $i] :
                   ...
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a ) @ V0op ) @ V3s )
                        @ ( lam @ A_27b
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ V4x ) @ V2a ) ) @ ( ap @ V1f @ V4x ) ) @ ( ap @ ( c_2Eiterate_2Eneutral @ A_27a ) @ V0op ) ) ) )
                      = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V2a ) @ V3s ) ) @ ( ap @ V1f @ V2a ) ) @ ( ap @ ( c_2Eiterate_2Eneutral @ A_27a ) @ V0op ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ENEUTRAL__REAL__MUL,lemma,
    ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( c_2Eiterate_2Eneutral @ ty_2Erealax_2Ereal ) @ c_2Erealax_2Ereal__mul ) )
...
thf(conj_thm_2Eproduct_2EPRODUCT__DELTA,conjecture,(
     ...
     => ! [V2a: $i] :
         ...
         => ( ( surj__ty_2Erealax_2Ereal
              @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s )
                @ ( lam @ A_27a
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V3x ) @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V0b ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2a ) @ V1s ) ) @ ( inj__ty_2Erealax_2Ereal @ V0b ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )).
