...
thf(conj_thm_2Ellist_2ELTL__HD__iff,conjecture,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ! [V2h: $i] :
              ( ( mem @ V2h @ A_27a )
             => ( ( ( ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V0x )
                    = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ V1t ) @ V2h ) ) )
                <=> ( V0x
                    = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V2h ) @ V1t ) ) )
                & ( ( ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V0x )
                    = ( c_2Eoption_2ENONE @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) )
                <=> ( V0x
                    = ( c_2Ellist_2ELNIL @ A_27a ) ) ) ) ) ) ) )).
