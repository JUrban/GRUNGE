...
thf(thm_2Ereal_2ESUM__POS__GEN,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1m: tyop_2Enum_2Enum] :
     ...
     => ! [V3n: tyop_2Enum_2Enum] :
          ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Esum @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ V1m @ V3n ) @ V0f ) ) ) )).
...
thf(thm_2Eseq_2ESER__POS__LE,conjecture,(
