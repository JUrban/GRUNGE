...
thf(conj_thm_2Emetric_2EMR1__DEF,lemma,(
...
thf(conj_thm_2Enets_2EDORDER__LEMMA,lemma,(
    ! [A_27a: del,V0g: $i] :
...
thf(conj_thm_2Enets_2EMTOP__TENDS,lemma,(
...
thf(conj_thm_2Enets_2EMR1__BOUNDED,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Enets_2ENET__CONV__NZ,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Enets_2ENET__CONV__IBOUNDED,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
         => ! [V2x0: tp__ty_2Erealax_2Ereal] :
             ...
             => ( p
                @ ( ap @ ( ap @ ( c_2Enets_2Ebounded @ ty_2Erealax_2Ereal @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Emetric_2Emetric @ ty_2Erealax_2Ereal ) @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) ) @ c_2Emetric_2Emr1 ) @ V0g ) )
                  @ ( lam @ A_27a
                    @ ^ [V3n: $i] :
                        ( ap @ c_2Erealax_2Einv @ ( ap @ V1x @ V3n ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EABS__LT__MUL2,lemma,(
...
thf(conj_thm_2Enets_2ENET__INV,conjecture,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Enets_2Edorder @ A_27a ) @ V0g ) )
       => ! [V1x: $i] :
