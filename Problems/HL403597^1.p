...
thf(c_2Einftree_2Erelrec_2E0,type,(
    c_2Einftree_2Erelrec_2E0: u )).

thf(c_2Einftree_2Erelrec_2E4,type,(
    c_2Einftree_2Erelrec_2E4: du > du > du > du > u )).
...
thf(arityeq1_2Emono_2Ec_2Einftree_2EiLf_2E1_2Emono_2EA_27a_20mono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27c: d,A_27d: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiLf_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ c_2Einftree_2EiLf_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Einftree_2EiNd_2E2_2Emono_2EA_27a_20mono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiNd_2E2 @ ( s @ A_27c @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) ) @ c_2Einftree_2EiNd_2E0 ) @ ( s @ A_27c @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ec_2Einftree_2Erelrec_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ X2_2E0 ) @ ( s @ A_27b @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Einftree_2Erelrec_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ X2_2E0 ) ) ) @ ( s @ A_27b @ X3_2E0 ) ) ) ) ) )).
...
thf(thm_2Einftree_2Erelrec__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0x_2E0: u,V1x_27_2E0: u,V2x_27_27_2E0: u,V3x_27_27_27_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V1x_27_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V2x_27_27_2E0 ) @ ( s @ A_27b @ V3x_27_27_27_2E0 ) ) ) )
    <=> ! [V4relrec_27_2E0: u] :
          ( ! [V5a0_2E0: u,V6a1_2E0: u,V7a2_2E0: u,V8a3_2E0: u] :
              ( ( ? [V9a_2E0: u] :
                    ( ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V7a2_2E0 )
                      = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiLf_2E1 @ ( s @ A_27a @ V9a_2E0 ) ) ) )
                    & ( ( s @ A_27b @ V8a3_2E0 )
                      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5a0_2E0 ) @ ( s @ A_27a @ V9a_2E0 ) ) ) ) )
                | ? [V10b_2E0: u,V11df_2E0: u,V12g_2E0: u] :
                    ( ( ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ V7a2_2E0 )
                      = ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiNd_2E2 @ ( s @ A_27c @ V10b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ V11df_2E0 ) ) ) )
                    & ( ( s @ A_27b @ V8a3_2E0 )
                      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V6a1_2E0 ) @ ( s @ A_27c @ V10b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V12g_2E0 ) ) ) )
                    & ! [V13d_2E0: u] :
...
thf(thm_2Einftree_2Erelrec__rules,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d] :
      ( ! [V0lf_2E0: u,V1nd_2E0: u,V2a_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0lf_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V1nd_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiLf_2E1 @ ( s @ A_27a @ V2a_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0lf_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) ) ) ) ) )
      & ! [V3lf_2E0: u,V4nd_2E0: u,V5b_2E0: u,V6df_2E0: u,V7g_2E0: u] :
          ( ! [V8d_2E0: u] :
              ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3lf_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V4nd_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ V6df_2E0 ) @ ( s @ A_27d @ V8d_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V7g_2E0 ) @ ( s @ A_27d @ V8d_2E0 ) ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Erelrec_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3lf_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V4nd_2E0 ) @ ( s @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) @ ( c_2Einftree_2EiNd_2E2 @ ( s @ A_27c @ V5b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Einftree_2Einftree @ A_27a @ A_27c @ A_27d ) ) @ V6df_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ A_27b ) ) @ V4nd_2E0 ) @ ( s @ A_27c @ V5b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V7g_2E0 ) ) ) ) ) ) ) ) )).
