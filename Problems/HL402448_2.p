...
tff(conj_thm_2EerrorStateMonad_2EJOIN__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0k: $i] :
      ( mem(V0k,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))
     => ! [V1m: $i] :
          ( mem(V1m,arr(A_27b,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27c,A_27c)))))
         => ap(ap(c_2EerrorStateMonad_2EBIND(A_27a,A_27a,A_27a),V0k),V1m) = ap(c_2EerrorStateMonad_2EJOIN(A_27a,A_27a),ap(ap(c_2EerrorStateMonad_2EMMAP(A_27a,A_27a,A_27a),V1m),V0k)) ) ) )).
