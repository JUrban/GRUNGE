...
thf(conj_thm_2Ehreal_2EHRAT__GT__L1,lemma,(
...
thf(conj_thm_2Ehreal_2ECUT__NEARTOP__MUL,lemma,(
...
thf(ax_thm_2Ehreal_2Ehreal__1,axiom,
    ( fo__c_2Ehreal_2Ehreal__1
    = ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Ehreal_2Ehreal @ ( ap @ c_2Ehreal_2Ecut__of__hrat @ ( inj__ty_2Ehrat_2Ehrat @ fo__c_2Ehrat_2Ehrat__1 ) ) ) ) )).
...
thf(ax_thm_2Ehreal_2Ehreal__inv,axiom,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Ehreal_2Ehreal__inv @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) )
      = ( surj__ty_2Ehreal_2Ehreal
        @ ( ap @ c_2Ehreal_2Ehreal
          @ ( lam @ ty_2Ehrat_2Ehrat
            @ ^ [V1w: $i] :
                ...
                @ ( lam @ ty_2Ehrat_2Ehrat
                  @ ^ [V2d: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ehreal_2Ehrat__lt @ V2d ) @ ( inj__ty_2Ehrat_2Ehrat @ fo__c_2Ehrat_2Ehrat__1 ) ) )
                      @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Ehrat_2Ehrat )
                        @ ( lam @ ty_2Ehrat_2Ehrat
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ V3x ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ehrat__lt @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ V1w ) @ V3x ) ) @ V2d ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ehreal_2EHREAL__INV__ISACUT,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal] :
      ( p
...
thf(conj_thm_2Ehreal_2EHREAL__MUL__LINV,conjecture,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__mul @ ( ap @ c_2Ehreal_2Ehreal__inv @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) )
      = fo__c_2Ehreal_2Ehreal__1 ) )).
