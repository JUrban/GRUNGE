...
fof(conj_thm_2EEncode_2Ewf__encode__bnum,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2EEncode_2Ewf__pred__bnum,V0m),V1p))
           => p(ap(ap(c_2EEncode_2Ewf__encoder(ty_2Enum_2Enum),V1p),ap(c_2EEncode_2Eencode__bnum,V0m))) ) ) ) )).
...
fof(conj_thm_2ECoder_2Ewf__coder__bnum,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2EEncode_2Ewf__pred__bnum,V0m),V1p))
           => p(ap(c_2ECoder_2Ewf__coder(ty_2Enum_2Enum),ap(ap(c_2ECoder_2Ebnum__coder,V0m),V1p))) ) ) ) )).
