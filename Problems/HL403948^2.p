...
thf(conj_thm_2Ellist_2ELTAKE__TAKE__LESS,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ! [V3m: tp__ty_2Enum_2Enum] :
             ...
             => ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ V1ll )
                = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ V2l ) ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2Eprefixes__is__prefix__total,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Ellist_2Eprefixes__lprefix__total,conjecture,(
    ! [A_27a: del,V0ll: $i] :
