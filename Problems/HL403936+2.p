...
fof(conj_thm_2Ellist_2ELFINITE__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll1] :
...
fof(conj_thm_2Ellist_2ELLENGTH__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll1] :
          ( mem(V0ll1,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELTAKE__LAPPEND2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
