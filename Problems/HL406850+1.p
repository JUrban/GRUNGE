...
fof(thm_2Ehreal_2EHRAT__LT__ANTISYM,axiom,(
    ! [V0x_2E0,V1y_2E0] :
      ~ ( p(s(tyop_2Emin_2Ebool,c_2Ehreal_2Ehrat__lt_2E2(s(tyop_2Ehrat_2Ehrat,V0x_2E0),s(tyop_2Ehrat_2Ehrat,V1y_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Ehreal_2Ehrat__lt_2E2(s(tyop_2Ehrat_2Ehrat,V1y_2E0),s(tyop_2Ehrat_2Ehrat,V0x_2E0)))) ) )).

fof(thm_2Ehreal_2EHRAT__UP,axiom,(
    ! [V0x_2E0] :
    ? [V1y_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ehreal_2Ehrat__lt_2E2(s(tyop_2Ehrat_2Ehrat,V0x_2E0),s(tyop_2Ehrat_2Ehrat,V1y_2E0)))) )).

fof(thm_2Ehreal_2EHRAT__DOWN,axiom,(
    ! [V0x_2E0] :
    ? [V1y_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ehreal_2Ehrat__lt_2E2(s(tyop_2Ehrat_2Ehrat,V1y_2E0),s(tyop_2Ehrat_2Ehrat,V0x_2E0)))) )).
...
fof(thm_2Ehreal_2EISACUT__HRAT,conjecture,(
