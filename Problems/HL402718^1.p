...
thf(f3155_0_2E0,type,(
    f3155_0_2E0: u )).

thf(f3155_0_2E2,type,(
    f3155_0_2E2: du > du > u )).

thf(f3155_0_2E4,type,(
    f3155_0_2E4: du > du > du > du > u )).

thf(f3167_0_2E0,type,(
    f3167_0_2E0: u )).

thf(f3167_0_2E1,type,(
    f3167_0_2E1: du > u )).

thf(f3167_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef3155_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( f3155_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) ) ) @ f3155_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef3155_0_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ A_27b @ ( f3155_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) @ ( s @ A_27b @ X3_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef3167_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) @ ( f3167_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) ) @ f3167_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3167_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2: $o] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3167_0_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X2 ) ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Emin_2Ebool_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) ) @ f3167_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ X2 ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Elist_2EFOLDR_2E3_2Emono_2EA_27a_20mono_2Etyop_2Emin_2Ebool,axiom,(
...
thf(arityeq3_2Emono_2Ec_2Elist_2EFOLDR_2E3_2Emono_2EA_27c_20mono_2EA_27b,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Elist_2EMAP_2E2_2Emono_2EA_27a_20mono_2Etyop_2Emin_2Ebool,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Erich__list_2EFOLDR__MAP,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V2g_2E0: u,V4x_2E0: u,V5y_2E0: u] :
      ( ( s @ A_27b @ ( f3155_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2g_2E0 ) @ ( s @ A_27c @ V4x_2E0 ) @ ( s @ A_27b @ V5y_2E0 ) ) )
...
thf(thm_2Erich__list_2EFOLDR__MAP,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1e_2E0: u,V2g_2E0: u,V3l_2E0: u] :
      ...
      = ( s @ A_27b @ ( c_2Elist_2EFOLDR_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( f3155_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2g_2E0 ) ) ) @ ( s @ A_27b @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27c ) @ V3l_2E0 ) ) ) ) )).

thf(def0_2Ethm_2Erich__list_2EMEM__FOLDR,axiom,(
    ! [A_27a: d,V0y_2E0: u,V2x_2E0: u,V3l_27: $o] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3167_0_2E3 @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V3l_27 ) ) ) ) )
    <=> ( ( ( s @ A_27a @ V0y_2E0 )
          = ( s @ A_27a @ V2x_2E0 ) )
        | V3l_27 ) ) )).

thf(thm_2Erich__list_2EMEM__FOLDR,axiom,(
    ! [A_27a: d,V0y_2E0: u,V1l_2E0: u] :
      ...
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EFOLDR_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) ) @ ( f3167_0_2E1 @ ( s @ A_27a @ V0y_2E0 ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ mono_2Ec_2Ebool_2EF ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) ) )).

thf(thm_2Erich__list_2EMEM__FOLDR__MAP,conjecture,(
