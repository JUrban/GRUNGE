...
tff(conj_thm_2Epath_2Enth__label__drop,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1j: tp__ty_2Enum_2Enum,V2p: $i] :
      ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Enum_2ESUC,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j)))),ap(c_2Epath_2EPL(A_27a,A_27a),V2p)))
       => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V0i)),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),inj__ty_2Enum_2Enum(V1j)),V2p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j))),V2p) ) ) )).
