         ...
         => ! [V2i] :
             ...
             => ! [V1Phi__R] :
                 ...
                 => ! [V8t] :
                     ...
                     => ap(f2029(A_27b,A_27a,V7q,V6t0,V2i,V1Phi__R),V8t) = ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V8t),V6t0))),ap(V7q,ap(ap(c_2Earithmetic_2E_2B,V8t),V6t0)))) ) ) ) ) ) )).

fof(lamtp_f2031,axiom,(
    ! [A_27b,A_27a,V7q] :
      ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V6t0] :
          ( mem(V6t0,ty_2Enum_2Enum)
             ...
             => ! [V2i] :
                 ...
                 => ! [V3Psi] :
                     ...
                     => ! [V10t2] :
                         ...
                         => ap(f2031(A_27b,A_27a,V7q,V6t0,V9t1,V2i,V3Psi),V10t2) = ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V9t1),ap(ap(c_2Earithmetic_2E_2B,V10t2),V6t0)))),ap(V7q,ap(ap(c_2Earithmetic_2E_2B,V9t1),ap(ap(c_2Earithmetic_2E_2B,V10t2),V6t0))))) ) ) ) ) ) ) )).

fof(lamtp_f2030,axiom,(
    ! [A_27b,A_27a,V3Psi] :
      ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V2i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
     ...
     => ! [V2i] :
         ...
         => ! [V6t0] :
             ...
             => ! [V7q] :
                 ...
                 => ! [V9t1] :
                      ( mem(V9t1,ty_2Enum_2Enum)
                     => ap(f2030(A_27b,A_27a,V3Psi,V2i,V6t0,V7q),V9t1) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2031(A_27b,A_27a,V7q,V6t0,V9t1,V2i,V3Psi)) ) ) ) ) ) )).

fof(lamtp_f2028,axiom,(
    ! [A_27a,A_27b,V3Psi] :
      ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V2i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1Phi__R] :
             ...
             => ! [V0Phi__I] :
                 ...
                 => ! [V6t0] :
                      ( mem(V6t0,ty_2Enum_2Enum)
                     => mem(f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) ) )).
         ...
         => ! [V1Phi__R] :
             ...
             => ! [V0Phi__I] :
                 ...
                 => ! [V6t0] :
                     ...
                     => ! [V7q] :
                          ( mem(V7q,arr(ty_2Enum_2Enum,A_27b))
                         => ap(f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0),V7q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0Phi__I,ap(V7q,V6t0))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2029(A_27b,A_27a,V7q,V6t0,V2i,V1Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2030(A_27b,A_27a,V3Psi,V2i,V6t0,V7q)))) ) ) ) ) ) ) )).

fof(lamtp_f2027,axiom,(
     ...
     => ! [V1Phi__R] :
         ...
         => ! [V2i] :
             ...
             => ! [V3Psi] :
                 ...
                 => ! [V6t0] :
                      ( mem(V6t0,ty_2Enum_2Enum)
                     => ap(f2027(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),V6t0) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2028(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V6t0)) ) ) ) ) ) )).

fof(conj_thm_2EOmega__Automata_2ECO__BUECHI__NEXT__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2i] :
                     ...
                     => ! [V3Psi] :
                         ...
                         => ! [V4t0] :
                             ...
                             => ! [V5c] :
                                  ( mem(V5c,A_27b)
                                 => ( p(ap(ap(c_2ETemporal__Logic_2ENEXT,f2027(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),V4t0))
                                  <=> ? [V11p] :
                                        ...
                                        & ? [V12q] :
                                            ...
                                            & ! [V13t] :
                                               ...
                                               => ( ( ~ p(ap(V11p,ap(ap(c_2Earithmetic_2E_2B,V13t),V4t0)))
                                                  ...
                                                  | ( p(ap(V11p,ap(ap(c_2Earithmetic_2E_2B,V13t),V4t0)))
                                                    & p(ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V13t),V4t0))),ap(V12q,ap(ap(c_2Earithmetic_2E_2B,V13t),V4t0)))))
                                                    & p(ap(V11p,ap(ap(c_2Earithmetic_2E_2B,V13t),ap(ap(c_2Earithmetic_2E_2B,V4t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) ) ) )
                                            & ? [V14t1] :
                                                ( mem(V14t1,ty_2Enum_2Enum)
                                                & ! [V15t2] :
                                                    ( mem(V15t2,ty_2Enum_2Enum)
                                                   => p(ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V14t1),ap(ap(c_2Earithmetic_2E_2B,V15t2),V4t0)))),ap(V12q,ap(ap(c_2Earithmetic_2E_2B,V14t1),ap(ap(c_2Earithmetic_2E_2B,V15t2),V4t0)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
