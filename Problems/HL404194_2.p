...
tff(conj_thm_2Epath_2Eel__pgenerate,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Enum_2Enum,A_27b))
         => ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Epath_2Epgenerate(A_27a,A_27a),V1f),V2g)) = ap(V1f,inj__ty_2Enum_2Enum(V0n)) ) ) )).
