...
thf(f11764_0_2E0,type,(
    f11764_0_2E0: u )).

thf(f11764_0_2E2,type,(
    f11764_0_2E2: du > du > u )).

thf(f11764_0_2E3,type,(
    f11764_0_2E3: du > du > du > u )).

thf(f11765_0_2E0,type,(
    f11765_0_2E0: u )).

thf(f11765_0_2E2,type,(
    f11765_0_2E2: du > du > u )).

thf(f11765_0_2E3,type,(
...
thf(mono_2Ef11765_0,type,(
    mono_2Ef11765_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq2_2Emono_2Ef11764_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f11764_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
...
thf(arityeq3_2Emono_2Ef11764_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f11764_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) ) @ f11764_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EMOD__NSUM__MOD,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V3i_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f11764_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ A_27a @ V3i_2E0 ) ) ) )
      = ( mono_2Ec_2Earithmetic_2EMOD @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ A_27a @ V3i_2E0 ) ) ) ) @ V1n ) ) )).

thf(thm_2Eiterate_2EMOD__NSUM__MOD,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2s_2E0: u] :
     ...
     => ( ( mono_2Ec_2Earithmetic_2EMOD @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Eiterate_2Ensum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) ) ) ) @ V1n )
        = ( mono_2Ec_2Earithmetic_2EMOD @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Eiterate_2Ensum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f11764_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) ) ) @ V1n ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EMOD__NSUM__MOD__NUMSEG,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum,V4i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11765_0 @ V0f @ V3n @ V4i )
      = ( mono_2Ec_2Earithmetic_2EMOD @ ( V0f @ V4i ) @ V3n ) ) )).

thf(thm_2Eiterate_2EMOD__NSUM__MOD__NUMSEG,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum,V2b: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( (~) @ ( V3n = mono_2Ec_2Enum_2E0 ) )
     => ( ( mono_2Ec_2Earithmetic_2EMOD @ ( mono_2Ec_2Eiterate_2Ensum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V1a @ V2b ) @ V0f ) @ V3n )
        = ( mono_2Ec_2Earithmetic_2EMOD @ ( mono_2Ec_2Eiterate_2Ensum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V1a @ V2b ) @ ( mono_2Ef11765_0 @ V0f @ V3n ) ) @ V3n ) ) ) )).
