    ...
    ! [V0x] :
     ...
     => ! [V1s] :
         ...
         => ! [V4i] :
             ...
             => ap(f4028(V0x,V1s),V4i) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4i),V1s)),ap(V0x,V4i)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__SUBSET,lemma,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2t] :
             ...
             => ! [V3l] :
                 ...
                 => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),V1s),V2t))
                      & p(ap(ap(ap(c_2Ereal__topology_2Esums,f4028(V0x,V1s)),V3l),V2t)) )
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),V3l),V1s)) ) ) ) ) ) )).

fof(lamtp_f4029,axiom,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0x] :
     ...
     => ! [V1s] :
         ...
         => ! [V3i] :
             ...
             => ap(f4029(V0x,V1s),V3i) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3i),V1s)),ap(V0x,V3i)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
