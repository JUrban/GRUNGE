...
tff(lmtp_f3152,type,(
    f3152: ( del * tp__ty_2Erealax_2Ereal * $i * $i * $i ) > $i )).

tff(lamtp_f3152,axiom,(
    ! [A_27a: del,V3x: tp__ty_2Erealax_2Ereal,V0v: $i] :
      ( mem(V0v,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V1p: $i] :
              ( mem(V1p,arr(A_27a,bool))
             => mem(f3152(A_27a,V3x,V0v,V2s,V1p),arr(A_27a,bool)) ) ) ) )).
    ...
    ! [A_27a: del,V3x: tp__ty_2Erealax_2Ereal,V0v: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V1p: $i] :
             ...
             => ! [V5b: $i] :
                  ( mem(V5b,A_27a)
                 => ap(f3152(A_27a,V3x,V0v,V2s,V1p),V5b) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(ap(c_2Eieee_2Eis__closest(A_27a),V0v),V2s),inj__ty_2Erealax_2Ereal(V3x)),V5b)),ap(V1p,V5b)) ) ) ) ) )).

tff(lmtp_f3151,type,(
    f3151: ( del * $i * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3151,axiom,(
    ! [A_27a: del,V1p: $i] :
      ( mem(V1p,arr(A_27a,bool))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V0v: $i] :
              ( mem(V0v,arr(A_27a,ty_2Erealax_2Ereal))
             => ! [V3x: tp__ty_2Erealax_2Ereal] : mem(f3151(A_27a,V1p,V2s,V0v,V3x),arr(A_27a,bool)) ) ) ) )).
     ...
     => ! [V2s: $i] :
         ...
         => ! [V0v: $i] :
             ...
             => ! [V3x: tp__ty_2Erealax_2Ereal,V4a: $i] :
                  ( mem(V4a,A_27a)
                 => ap(f3151(A_27a,V1p,V2s,V0v,V3x),V4a) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(ap(c_2Eieee_2Eis__closest(A_27a),V0v),V2s),inj__ty_2Erealax_2Ereal(V3x)),V4a)),ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_3F(A_27a),f3152(A_27a,V3x,V0v,V2s,V1p))),ap(V1p,V4a))) ) ) ) ) )).

tff(ax_thm_2Eieee_2Eclosest,axiom,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
          ( mem(V1p,arr(A_27a,bool))
         => ! [V2s: $i] :
              ( mem(V2s,arr(A_27a,bool))
             => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(ap(ap(ap(c_2Eieee_2Eclosest(A_27a),V0v),V1p),V2s),inj__ty_2Erealax_2Ereal(V3x)) = ap(c_2Emin_2E_40(A_27a),f3151(A_27a,V1p,V2s,V0v,V3x)) ) ) ) )).

tff(conj_thm_2Efloat_2EIS__CLOSEST__EXISTS,lemma,(
    ! [V0v: $i] :
...
tff(conj_thm_2Efloat_2ECLOSEST__IS__EVERYTHING,conjecture,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
