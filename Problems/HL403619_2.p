...
tff(conj_thm_2Efcp_2EAPPLY__FCP__UPDATE__ID,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ! [V1a: tp__ty_2Enum_2Enum] : ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0m),inj__ty_2Enum_2Enum(V1a))),V0m) = V0m ) )).
