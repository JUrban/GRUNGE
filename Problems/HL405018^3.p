...
thf(thm_2Equotient__pair_2EPAIR__REL__REFL,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0R1: A_27a > A_27a > $o,V1R2: A_27b > A_27b > $o] :
      ( ( ! [V2x: A_27a,V3y: A_27a] :
        ...
        & ! [V4x: A_27b,V5y: A_27b] :
          ...
          <=> ( ( V1R2 @ V4x )
              = ( V1R2 @ V5y ) ) ) )
     => ! [V6x: tyop_2Epair_2Eprod @ A_27a @ A_27b] :
          ( c_2Equotient__pair_2E_23_23_23 @ A_27a @ A_27b @ A_27a @ A_27b @ V0R1 @ V1R2 @ V6x @ V6x ) ) )).
