...
thf(thm_2Ecardinal_2Eadd__c,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t )
      = ( c_2Epred__set_2EUNION @ ( tyop_2Esum_2Esum @ A_27a @ A_27b )
        @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ A_27a
          @ ^ [V2x: A_27a] :
              ( c_2Epair_2E_2C @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ $o @ ( c_2Esum_2EINL @ A_27a @ A_27b @ V2x ) @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V0s ) ) )
        @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ A_27b
          @ ^ [V3y: A_27b] :
              ( c_2Epair_2E_2C @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ $o @ ( c_2Esum_2EINR @ A_27a @ A_27b @ V3y ) @ ( c_2Ebool_2EIN @ A_27b @ V3y @ V1t ) ) ) ) ) )).
...
thf(thm_2Ecardinal_2ECARD__ADD__FINITE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
