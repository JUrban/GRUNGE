...
fof(conj_thm_2Eiterate_2EFINITE__INDEX__NUMSEG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
                ...
                & ! [V2i] :
                   ...
                   => ! [V3j] :
                       ...
                       => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2i),ap(ap(c_2Eiterate_2E_2E_2E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2Epred__set_2ECARD(A_27a),V0s))))
                         ...
                         => V2i = V3j ) ) )
                & V0s = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),ap(ap(c_2Eiterate_2E_2E_2E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2Epred__set_2ECARD(A_27a),V0s))) ) ) ) ) )).

fof(conj_thm_2Eiterate_2EFINITE__INDEX__NUMBERS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
