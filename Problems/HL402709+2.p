...
fof(conj_thm_2Erich__list_2ESEG__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n1] :
         ...
         => ! [V1m1] :
             ...
             => ! [V2n2] :
                 ...
                 => ! [V3m2] :
                     ...
                     => ! [V4l] :
                          ( mem(V4l,ty_2Elist_2Elist(A_27a))
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V0n1),V1m1)),ap(c_2Elist_2ELENGTH(A_27a),V4l)))
                              & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V2n2),V3m2)),V0n1)) )
                           => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V2n2),V3m2),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n1),V1m1),V4l)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V2n2),ap(ap(c_2Earithmetic_2E_2B,V1m1),V3m2)),V4l) ) ) ) ) ) ) ) )).
