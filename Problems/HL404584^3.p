...
thf(thm_2Ecardinal_2ECOUNTABLE__DELETE,axiom,(
    ! [A_27a: $tType,V0x: A_27a,V1s: A_27a > $o] :
      ( ( c_2Epred__set_2Ecountable @ A_27a @ ( c_2Epred__set_2EDELETE @ A_27a @ V1s @ V0x ) )
...
thf(thm_2Ecardinal_2ECOUNTABLE__DIFF__FINITE,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1t: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
     => ( ( c_2Epred__set_2Ecountable @ A_27a @ ( c_2Epred__set_2EDIFF @ A_27a @ V1t @ V0s ) )
