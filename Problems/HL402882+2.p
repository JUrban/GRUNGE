...
fof(conj_thm_2Erich__list_2ELIST__REL__APPEND__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Erich__list_2ELIST__REL__GENLIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1f] :
                 ...
                 => ! [V2l] :
                     ...
                     => ! [V3g] :
                         ...
                         => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Elist_2EGENLIST(A_27a),V1f),V2l)),ap(ap(c_2Elist_2EGENLIST(A_27b),V3g),V2l)))
                          <=> ! [V4i] :
                                ( mem(V4i,ty_2Enum_2Enum)
                               => ( p(ap(ap(c_2Eprim__rec_2E_3C,V4i),V2l))
                                 => p(ap(ap(V0P,ap(V1f,V4i)),ap(V3g,V4i))) ) ) ) ) ) ) ) ) ) )).
