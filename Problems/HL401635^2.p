...
thf(conj_thm_2Epred__set_2EBIJ__ALT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3y ) @ V2t ) )
                       => ( p
                          @ ( ap @ ( c_2Ebool_2E_3F_21 @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V4x: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ V3y ) @ ( ap @ V0f @ V4x ) ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Epred__set_2EBIJ__INSERT__IMP,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27a )
...
thf(conj_thm_2Epred__set_2EFINITE__BIJ,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
