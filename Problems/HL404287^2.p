...
thf(tp_ty_2EEncode_2Etree,type,(
...
thf(tp_c_2EEncode_2Eencode__tree,type,(
    c_2EEncode_2Eencode__tree: del > $i )).

thf(mem_c_2EEncode_2Eencode__tree,axiom,(
    ! [A_27a: del] :
...
thf(tp_c_2EEncode_2Elift__tree,type,(
    c_2EEncode_2Elift__tree: del > $i )).

thf(mem_c_2EEncode_2Elift__tree,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2EEncode_2Ewf__encode__tree,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
...
thf(conj_thm_2EDecode_2Ewf__decode__tree,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1d: $i] :
          ( ( mem @ V1d @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) )
