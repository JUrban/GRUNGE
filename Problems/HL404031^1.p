...
thf(arityeq1_2Emono_2Ec_2Ecombin_2EI_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ecombin_2EI_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ c_2Ecombin_2EI_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Equotient_2EI__PRS,conjecture,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1abs_2E0: u,V2rep_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Equotient_2EQUOTIENT_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1abs_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2rep_2E0 ) ) ) )
     => ! [V3e_2E0: u] :
          ( ( s @ A_27b @ ( c_2Ecombin_2EI_2E1 @ ( s @ A_27b @ V3e_2E0 ) ) )
          = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1abs_2E0 ) @ ( s @ A_27a @ ( c_2Ecombin_2EI_2E1 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2rep_2E0 ) @ ( s @ A_27b @ V3e_2E0 ) ) ) ) ) ) ) ) ) )).
