...
thf(thm_2Ereal__topology_2ESERIES__FINITE__SUPPORT,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2k: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1s @ V2k ) )
        & ! [V3x: tyop_2Enum_2Enum] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3x @ V2k )
              & ( (~) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3x @ V1s ) ) )
           => ( ( V0f @ V3x )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1s @ V2k ) @ V0f ) @ V2k ) ) )).
...
thf(thm_2Ereal__topology_2ESERIES__SUM,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal,V2k: tyop_2Enum_2Enum > $o,V3s: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V3s )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Enum_2Enum @ V3s @ V2k )
        & ! [V4x: tyop_2Enum_2Enum] :
            ( ( (~) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4x @ V3s ) )
           => ( ( V0f @ V4x )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
        & ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ V3s @ V0f )
          = V1l ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ V1l @ V2k ) ) )).
