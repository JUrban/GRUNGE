...
fof(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2EBIGINTER__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(arr(A_27a,bool),bool))
...
fof(conj_thm_2Ereal__topology_2EBIGUNION__BIGINTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(arr(A_27a,bool),bool))
...
fof(ax_thm_2Ereal__topology_2Egdelta,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(ax_thm_2Ereal__topology_2Efsigma,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EGDELTA__COMPLEMENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
