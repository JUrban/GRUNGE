...
thf(f12504_0_2E0,type,(
    f12504_0_2E0: u )).

thf(f12504_0_2E1,type,(
    f12504_0_2E1: du > u )).

thf(f12504_0_2E2,type,(
    f12504_0_2E2: du > du > u )).

thf(f13520_0_2E0,type,(
    f13520_0_2E0: u )).

thf(f13520_0_2E1,type,(
    f13520_0_2E1: du > u )).

thf(f13520_0_2E2,type,(
    f13520_0_2E2: du > du > u )).
...
thf(mono_2Ef12504_0,type,(
    mono_2Ef12504_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13520_0,type,(
    mono_2Ef13520_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).
...
thf(def0_2Ethm_2Ereal__topology_2EOPEN__HALFSPACE__COMPONENT__GT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12504_0 @ V0a @ V1x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1x @ ( mono_2Ec_2Ereal_2Ereal__gt @ V1x @ V0a ) ) ) )).

thf(thm_2Ereal__topology_2EOPEN__HALFSPACE__COMPONENT__GT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2EOpen @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12504_0 @ V0a ) ) ) )).

thf(def0_2Ethm_2Ereal__topology_2EOPEN__INTERVAL__RIGHT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13520_0 @ V0a @ V1x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1x @ ( mono_2Ec_2Erealax_2Ereal__lt @ V0a @ V1x ) ) ) )).

thf(thm_2Ereal__topology_2EOPEN__INTERVAL__RIGHT,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2EOpen @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13520_0 @ V0a ) ) ) )).
