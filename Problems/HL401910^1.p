...
thf(c_2Enumeral__bit_2EiBITWISE_2E0,type,(
    c_2Enumeral__bit_2EiBITWISE_2E0: u )).

thf(c_2Enumeral__bit_2EiBITWISE_2E4,type,(
...
thf(mono_2Ec_2Enumeral__bit_2EiBITWISE,type,(
    mono_2Ec_2Enumeral__bit_2EiBITWISE: mono_2Etyop_2Enum_2Enum > ( $o > $o > $o ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Enumeral__bit_2EiBITWISE__def,axiom,(
    mono_2Ec_2Enumeral__bit_2EiBITWISE = mono_2Ec_2Ebit_2EBITWISE )).

thf(thm_2Enumeral__bit_2ENUMERAL__BITWISE,conjecture,(
    ! [A_27a: d] :
      ( ! [V0x: mono_2Etyop_2Enum_2Enum,V1f: $o > $o > $o,V2a_2E0: u] :
          ( ( mono_2Ec_2Ebit_2EBITWISE @ V0x @ V1f @ mono_2Ec_2Enum_2E0 @ mono_2Ec_2Enum_2E0 )
          = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enumeral__bit_2EiBITWISE @ V0x @ V1f @ mono_2Ec_2Enum_2E0 @ mono_2Ec_2Enum_2E0 ) ) )
      & ! [V3x: mono_2Etyop_2Enum_2Enum,V4f: $o > $o > $o,V5a: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebit_2EBITWISE @ V3x @ V4f @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V5a ) @ mono_2Ec_2Enum_2E0 )
          = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enumeral__bit_2EiBITWISE @ V3x @ V4f @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V5a ) @ mono_2Ec_2Enum_2E0 ) ) )
      & ! [V6x: mono_2Etyop_2Enum_2Enum,V7f: $o > $o > $o,V8b: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebit_2EBITWISE @ V6x @ V7f @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V8b ) )
          = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enumeral__bit_2EiBITWISE @ V6x @ V7f @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V8b ) ) ) )
      & ! [V9x: mono_2Etyop_2Enum_2Enum,V10f: $o > $o > $o,V11a: mono_2Etyop_2Enum_2Enum,V12b: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ebit_2EBITWISE @ V9x @ V10f @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V11a ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V12b ) )
          = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Enumeral__bit_2EiBITWISE @ V9x @ V10f @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V11a ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V12b ) ) ) ) ) )).
