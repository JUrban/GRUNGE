...
fof(conj_thm_2Emeasure_2EMEASURE__COMPL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
               => ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m)),V1s)) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(c_2Emeasure_2Em__space(A_27a),V0m))),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)) ) ) ) ) )).
