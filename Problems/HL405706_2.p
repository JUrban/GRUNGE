...
tff(conj_thm_2Eordinal_2EordZERO__ltSUC,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eordinal_2Eord__CASES,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eordinal_2Estrict__continuity__preserves__islimit,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Eordinal_2Eislimit__mul__R,lemma,(
    ! [A_27a: del,V0b: $i] :
...
tff(conj_thm_2Eordinal_2Eomega__exp__islimit,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0a))
