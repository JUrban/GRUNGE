...
tff(conj_thm_2Ereal__sigma_2ENESTED__REAL__SUM__IMAGE__REVERSE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2s_27: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3184(A_27b,A_27a,V0f,V2s_27)),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f3185(A_27a,A_27b,V0f,V1s)),V2s_27)) ) ) ) ) )).
