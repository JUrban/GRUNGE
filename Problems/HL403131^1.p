...
thf(f3712_0_2E0,type,(
    f3712_0_2E0: u )).

thf(f3712_0_2E1,type,(
    f3712_0_2E1: du > u )).

thf(f3712_1_2E0,type,(
    f3712_1_2E0: u )).

thf(f3712_1_2E1,type,(
    f3712_1_2E1: du > u )).

thf(f3712_2_2E0,type,(
    f3712_2_2E0: u )).

thf(f3712_2_2E1,type,(
    f3712_2_2E1: du > u )).

thf(f3712_3_2E0,type,(
    f3712_3_2E0: u )).

thf(f3712_3_2E1,type,(
    f3712_3_2E1: du > u )).
...
thf(mono_2Ef3712_0,type,(
    mono_2Ef3712_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3712_1,type,(
    mono_2Ef3712_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3712_2,type,(
    mono_2Ef3712_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3712_3,type,(
    mono_2Ef3712_3: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESWHEN__SIMP,axiom,(
    ! [V8t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3712_3 @ V8t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2ESWHEN__SIMP,axiom,(
    ! [V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3712_1 @ V4t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2ESWHEN__SIMP,axiom,(
    ! [V6t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3712_2 @ V6t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2ESWHEN__SIMP,axiom,(
    ! [V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3712_0 @ V3t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2ETemporal__Logic_2ESWHEN__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ mono_2Ef3712_0 @ V0b @ V2x )
          = mono_2Ec_2Ebool_2EF )
      & ( ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ mono_2Ef3712_1 @ V0b )
        = ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V0b ) )
      & ! [V5x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ V1a @ mono_2Ef3712_2 @ V5x )
          = mono_2Ec_2Ebool_2EF )
      & ! [V7x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ V1a @ mono_2Ef3712_3 @ V7x )
          = ( V1a @ V7x ) )
      & ( ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ V1a @ V1a )
