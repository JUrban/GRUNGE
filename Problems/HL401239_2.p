...
tff(lmtp_f248,type,(
    f248: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f248,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum] : mem(f248(V2n),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f248,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum,V4r: tp__ty_2Enum_2Enum] : ap(f248(V2n),inj__ty_2Enum_2Enum(V4r)) = ap(ap(c_2Enumpair_2Encons,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V4r)) )).

tff(lmtp_f247,type,(
    f247: $i )).

tff(lamtp_f247,axiom,(
    mem(f247,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).

tff(lameq_f247,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum] : ap(f247,inj__ty_2Enum_2Enum(V2n)) = k(ty_2Enum_2Enum,f248(V2n)) )).

tff(ax_thm_2Enumpair_2Enapp__def,axiom,(
    ! [V0l1: tp__ty_2Enum_2Enum,V1l2: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Enumpair_2Enapp,inj__ty_2Enum_2Enum(V0l1)),inj__ty_2Enum_2Enum(V1l2))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Enumpair_2Enlistrec(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1l2)),f247),inj__ty_2Enum_2Enum(V0l1))) )).

tff(conj_thm_2Enumpair_2Enapp__thm,conjecture,(
