...
tff(conj_thm_2Esptree_2Ewf__inter,lemma,(
    ! [A_27a: del,A_27b: del,V0m1: $i] :
      ( mem(V0m1,ty_2Esptree_2Espt(A_27a))
     => ! [V1m2: $i] :
          ( mem(V1m2,ty_2Esptree_2Espt(A_27b))
         => p(ap(c_2Esptree_2Ewf(A_27a),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0m1),V1m2))) ) ) )).
...
tff(conj_thm_2Esptree_2Espt__eq__thm,lemma,(
    ! [A_27a: del,V0t1: $i] :
...
tff(conj_thm_2Esptree_2Einter__assoc,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0t1: $i] :
     ...
     => ! [V1t2: $i] :
         ...
         => ! [V2t3: $i] :
             ...
             => ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0t1),ap(ap(c_2Esptree_2Einter(A_27b,A_27b),V1t2),V2t3)) = ap(ap(c_2Esptree_2Einter(A_27a,A_27a),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V0t1),V1t2)),V2t3) ) ) ) )).
