...
fof(conj_thm_2Ereal__topology_2ECLOSED__UNION,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__UNION,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
           ...
           => p(ap(c_2Ereal__topology_2Ecompact,ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V0s),V1t))) ) ) ) )).
