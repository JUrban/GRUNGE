...
tff(lameq_f2285,axiom,(
    ! [A_27a: del,V1k: $i] :
     ...
     => ! [V0cmp: $i] :
         ...
         => ! [V2k_27: $i] :
              ( mem(V2k_27,A_27a)
             => ap(f2285(A_27a,V1k,V0cmp),V2k_27) = ap(ap(c_2Emin_2E_3D(ty_2EternaryComparisons_2Eordering),ap(ap(V0cmp,V1k),V2k_27)),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS)) ) ) ) )).

tff(lmtp_f2284,type,(
    f2284: ( del * del * $i ) > $i )).

tff(lamtp_f2284,axiom,(
    ! [A_27a: del,A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
...
tff(conj_thm_2Ecomparison_2Egood__cmp__Less__trans,lemma,(
    ! [A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
...
tff(lameq_f2287,axiom,(
    ! [A_27a: del,V3k: $i] :
     ...
     => ! [V0cmp: $i] :
         ...
         => ! [V4k_27: $i] :
              ( mem(V4k_27,A_27a)
             => ap(f2287(A_27a,V3k,V0cmp),V4k_27) = ap(ap(c_2Emin_2E_3D(ty_2EternaryComparisons_2Eordering),ap(ap(V0cmp,V3k),V4k_27)),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS)) ) ) ) )).

tff(lmtp_f2286,type,(
    f2286: ( del * del * $i ) > $i )).

tff(lamtp_f2286,axiom,(
    ! [A_27a: del,A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
...
tff(conj_thm_2Ecomparison_2Egood__cmp__Less__irrefl__trans,conjecture,(
    ! [A_27a: del,V0cmp: $i] :
      ( mem(V0cmp,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
     => ( p(ap(c_2Ecomparison_2Egood__cmp(A_27a),V0cmp))
