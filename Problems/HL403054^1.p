...
thf(thm_2ETemporal__Logic_2EWELL__ORDER__UNIQUE,conjecture,(
    ! [V0m2: mono_2Etyop_2Enum_2Enum,V1m1: mono_2Etyop_2Enum_2Enum,V2P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( V2P @ V1m1 )
        & ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3n @ V1m1 )
           => ( (~) @ ( V2P @ V3n ) ) )
        & ( V2P @ V0m2 )
        & ! [V4n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ V4n @ V0m2 )
           => ( (~) @ ( V2P @ V4n ) ) ) )
     => ( V1m1 = V0m2 ) ) )).
