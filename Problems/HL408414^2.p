...
thf(conj_thm_2Ereal_2EREAL__OF__NUM__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Etransc_2EMCLAURIN__ALL__LT,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1diff: $i] :
         ...
         => ( ( ( ( ap @ V1diff @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) )
                = V0f )
              & ! [V2m: tp__ty_2Enum_2Enum,V3x: tp__ty_2Erealax_2Ereal] :
                  ( p @ ( ap @ ( ap @ ( ap @ c_2Elim_2Ediffl @ ( ap @ V1diff @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) @ ( ap @ ( ap @ V1diff @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) )
           => ! [V4x: tp__ty_2Erealax_2Ereal,V5n: tp__ty_2Enum_2Enum] :
                ( ( ( V4x
                   != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
                  & ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) )
               => ? [V6t: tp__ty_2Erealax_2Ereal] :
                    ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V6t ) ) ) )
                    & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V6t ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) )
                    & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) )
                      = ( surj__ty_2Erealax_2Ereal
                        @ ( ap
                          @ ( ap @ c_2Erealax_2Ereal__add
                            @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V7m: $i] :
                                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ V1diff @ V7m ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V7m ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) @ V7m ) ) ) ) )
                          @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ V1diff @ ( inj__ty_2Enum_2Enum @ V5n ) ) @ ( inj__ty_2Erealax_2Ereal @ V6t ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2EMCLAURIN__ZERO,lemma,(
    ! [V0diff: $i] :
      ( ( mem @ V0diff @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: tp__ty_2Erealax_2Ereal] :
          ( ( ( V2x
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
         ...
         => ( ( surj__ty_2Erealax_2Ereal
              @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3m: $i] :
                      ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ V0diff @ V3m ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2EFACT @ V3m ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ V3m ) ) ) ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ V0diff @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2EMCLAURIN__ALL__LE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1diff: $i] :
          ( ( mem @ V1diff @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) )
