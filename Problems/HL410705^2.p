...
thf(conj_thm_2Ereal__topology_2EREAL__CHOOSE__SIZE,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
     ...
     => ? [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
          = V0c ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELIMPT__UNIV,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) ) )).
