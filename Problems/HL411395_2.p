...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__DISJOINT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
