...
tff(conj_thm_2Elist_2ETL__GENLIST,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(c_2Elist_2ETL(A_27a),ap(ap(c_2Elist_2EGENLIST(A_27a),V0f),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))) = ap(ap(c_2Elist_2EGENLIST(A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Enum_2ESUC)),inj__ty_2Enum_2Enum(V1n)) ) )).
...
tff(mem_c_2Efcp_2EFCP__TL,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) )).
...
tff(lamtp_f1094,axiom,(
    ! [A_27a: del,A_27c: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => mem(f1094(A_27a,A_27c,V0v),arr(ty_2Enum_2Enum,A_27a)) ) )).

tff(lameq_f1094,axiom,(
    ! [A_27a: del,A_27c: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f1094(A_27a,A_27c,V0v),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0v),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1i))) ) )).

tff(ax_thm_2Efcp_2EFCP__TL__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ap(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),V0v) = ap(c_2Efcp_2EFCP(A_27a,A_27a),f1094(A_27a,A_27c,V0v)) ) )).
...
tff(conj_thm_2Efcp_2EFCP__TL,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
       ...
       => ap(c_2Efcp_2EFCP__TL(A_27a,A_27a,A_27a),V0v) = ap(c_2Efcp_2EL2V(A_27a,A_27a),ap(c_2Elist_2ETL(A_27a),ap(c_2Efcp_2EV2L(A_27a,A_27a),V0v))) ) ) )).
