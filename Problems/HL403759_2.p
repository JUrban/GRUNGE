...
tff(conj_thm_2Estring_2EEXTRACT__ind,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),bool))
     => ( ( ! [V1s: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar,V2i: tp__ty_2Enum_2Enum] : p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V1s)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),c_2Eoption_2ENONE(ty_2Enum_2Enum)))))
          & ! [V3s: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar,V4i: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] : p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4i)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5n)))))) )
       => ! [V6v: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar,V7v1: tp__ty_2Enum_2Enum,V8v2: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] : p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V6v)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V7v1)),inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(V8v2))))) ) ) )).
