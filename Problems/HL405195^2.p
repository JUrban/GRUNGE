...
thf(conj_thm_2Efinite__map_2Eo__f__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27c @ A_27b ) )
     => ( ( ap @ ( ap @ ( c_2Efinite__map_2Eo__f @ A_27a @ A_27c @ A_27b ) @ V0f ) @ ( c_2Efinite__map_2EFEMPTY @ A_27a @ A_27c ) )
        = ( c_2Efinite__map_2EFEMPTY @ A_27a @ A_27b ) ) ) )).

thf(conj_thm_2Efinite__map_2Eo__f__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27c @ A_27b ) )
     => ! [V1fm: $i] :
...
thf(conj_thm_2Efinite__map_2EMAP__KEYS__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
...
thf(conj_thm_2Efinite__map_2EMAP__KEYS__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1fm: $i] :
          ( ( mem @ V1fm @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27c ) )
...
thf(conj_thm_2Epred__set_2EINJ__EMPTY,lemma,(
...
thf(conj_thm_2Epred__set_2EINJ__INSERT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Ealist_2Ealist__to__fmap__MAP,conjecture,(
                        ...
                        @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27c @ ( ty_2Epair_2Eprod @ A_27b @ A_27d ) )
                          @ ( lam @ A_27a
                            @ ^ [V3x: $i] :
                                ( lam @ A_27c
                                @ ^ [V4y: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ A_27d ) @ ( ap @ V0f1 @ V3x ) ) @ ( ap @ V1f2 @ V4y ) ) ) ) ) )
                      @ V2al ) )
