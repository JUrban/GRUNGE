...
thf(conj_thm_2Efinite__map_2EFCARD__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Efinite__map_2EFCARD @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFEMPTY @ A_27a @ A_27b ) ) )
      = fo__c_2Enum_2E0 ) )).

thf(conj_thm_2Efinite__map_2EFCARD__FUPDATE,lemma,(
...
thf(conj_thm_2Efinite__map_2EFCARD__0__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
