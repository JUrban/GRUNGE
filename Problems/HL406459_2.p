...
tff(lmtp_f2296,type,(
    f2296: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f2296,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f2296(V0n),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

tff(lameq_f2296,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Enum_2Enum] : ap(f2296(V0n),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1i)) )).

tff(ax_thm_2Ebitstring_2Erev__count__list__def,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(c_2Ebitstring_2Erev__count__list,inj__ty_2Enum_2Enum(V0n))) = surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(ap(c_2Elist_2EGENLIST(ty_2Enum_2Enum),f2296(V0n)),inj__ty_2Enum_2Enum(V0n))) )).

tff(conj_thm_2Ebitstring_2Eel__rev__count__list,conjecture,(
