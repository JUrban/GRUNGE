...
thf(conj_thm_2Etopology_2EHULL__UNION__RIGHT,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ! [V2t: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ V2t ) )
                = ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V2t ) ) ) ) ) ) ) )).
