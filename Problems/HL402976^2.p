...
thf(conj_thm_2Elist_2ELENGTH__NIL__SYM,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( fo__c_2Enum_2E0
...
thf(conj_thm_2EpatternMatches_2EPMATCH__EQUIV__ROWS__EQUIV__EXPAND,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rows1: $i] :
          ( ( mem @ V1rows1 @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
...
thf(conj_thm_2EpatternMatches_2EPMATCH__EQUIV__ROWS__CONS__NONE,lemma,(
...
thf(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__CONS,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1row: $i] :
         ...
         => ! [V2rows: $i] :
             ...
             => ! [V3c: $o,V4i: $o,V5infos_27: tp__c_ty_2Elist_2Elist_o] :
          ...
          @ ( ap
            @ ( ap @ ( c_2Elist_2EFILTER @ ( ty_2Epair_2Eprod @ bool @ A_27a ) )
              @ ( lam @ ( ty_2Epair_2Eprod @ bool @ A_27a )
                @ ^ [V2x: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ ( c_2Epair_2EFST @ bool @ A_27a ) @ V2x ) ) ) )
...
thf(conj_thm_2EpatternMatches_2EAPPLY__REDUNDANT__ROWS__INFO__THMS,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del] :
      ...
      & ! [V0is: tp__c_ty_2Elist_2Elist_o,V1x: $i] :
         ...
         => ! [V2xs: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2EpatternMatches_2EAPPLY__REDUNDANT__ROWS__INFO @ A_27b ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V0is ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V1x ) @ V2xs ) )
      ...
      & ! [V3is: tp__c_ty_2Elist_2Elist_o,V4x: $i] :
         ...
         => ! [V5xs: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2EpatternMatches_2EAPPLY__REDUNDANT__ROWS__INFO @ A_27c ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V3is ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27c ) @ V4x ) @ V5xs ) )
...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__REDUNDANT__ROWS__INFO__EQUIV,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1c: $o,V2rows: $i] :
          ( ( mem @ V2rows @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
