...
fof(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(lamtp_f3418,axiom,(
    ! [V6j] :
     ...
     => ! [V0a] :
         ...
         => ! [V2y] :
              ( mem(V2y,ty_2Erealax_2Ereal)
             => mem(f3418(V6j,V0a,V2y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).

fof(lameq_f3418,axiom,(
    ! [V6j] :
      ( mem(V6j,ty_2Enum_2Enum)
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2y] :
             ...
             => ! [V7k] :
                 ...
                 => ap(f3418(V6j,V0a,V2y),V7k) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2B,V6j),V7k)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(ap(c_2Ereal_2Epow,V2y),V7k)) ) ) ) ) )).

fof(lamtp_f3417,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3n] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Erealax_2Ereal)
                 => mem(f3417(V2y,V0a,V3n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) ) )).

fof(lameq_f3417,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Erealax_2Ereal)
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V3n] :
             ...
             => ! [V1x] :
                 ...
                 => ! [V6j] :
                      ( mem(V6j,ty_2Enum_2Enum)
                     => ap(f3417(V2y,V0a,V3n,V1x),V6j) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,V3n),V6j)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),f3418(V6j,V0a,V2y))),ap(ap(c_2Ereal_2Epow,V1x),V6j)) ) ) ) ) ) )).

fof(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN__ALT,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ! [V3n] :
                  ( mem(V3n,ty_2Enum_2Enum)
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V3n))
                   => ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V3n)),f3413(V0a,V1x))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V3n)),f3414(V0a,V2y))) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,V1x),V2y)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,V3n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),f3417(V2y,V0a,V3n,V1x))) ) ) ) ) ) )).
