...
tff(conj_thm_2Efinite__map_2ESUBMAP__TRANS,lemma,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__SUBSET__SUBMAP,lemma,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1f2: $i] :
          ( mem(V1f2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
