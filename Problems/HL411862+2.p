...
fof(conj_thm_2Ereal__topology_2ECONNECTED__SEGMENT,lemma,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__INTER__FRONTIER,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__INTERIOR__SUBSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ESETDIST__SUBSETS__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
                         ...
                         => ! [V5y] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V0s))
                               ...
                               => ? [V6x_27] :
                                    ...
                                    & ? [V7y_27] :
                                        ( mem(V7y_27,ty_2Erealax_2Ereal)
                                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6x_27),V2s_27))
                                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7y_27),V3t_27))
                                        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V6x_27),V7y_27))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x),V5y)))) ) ) ) ) ) )
                   => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s_27),V3t_27)) = ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESETDIST__FRONTIER,lemma,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1t] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
           => ( p(ap(ap(c_2Epred__set_2EDISJOINT(ty_2Erealax_2Ereal),V0s),V1t))
             => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Efrontier,V0s)),V1t)) = ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) ) ) )
    & ! [V2s] :
        ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V3t] :
            ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
           => ( p(ap(ap(c_2Epred__set_2EDISJOINT(ty_2Erealax_2Ereal),V2s),V3t))
             => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),ap(c_2Ereal__topology_2Efrontier,V3t))) = ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),V3t)) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESETDIST__FRONTIERS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EDISJOINT(ty_2Erealax_2Ereal),V0s),V1t)),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Efrontier,V0s)),ap(c_2Ereal__topology_2Efrontier,V1t)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) )).
