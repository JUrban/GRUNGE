...
tff(conj_thm_2Ereal__topology_2EFINITE__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EFINITE__IMP__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
       => p(ap(c_2Ereal__topology_2EClosed,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EFINITE__IMP__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
       => p(ap(c_2Ereal__topology_2Ecompact,V0s)) ) ) )).
