...
thf(conj_thm_2Elift__ieee_2Eclosest__is__closest,lemma,(
...
thf(conj_thm_2Elift__ieee_2Eis__finite__finite,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( p
      @ ( ap @ ( c_2Epred__set_2EFINITE @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
...
thf(conj_thm_2Elift__ieee_2Eis__finite__nonempty,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
        @ ( lam @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b )
          @ ^ [V0a: $i] :
...
thf(conj_thm_2Epred__set_2EGSPEC__ETA,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ( ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
          @ ( lam @ A_27a
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V1x ) @ ( ap @ V0P @ V1x ) ) ) )
        = V0P ) ) )).
...
thf(conj_thm_2Elift__ieee_2Eerror__at__worst__lemma,conjecture,(
