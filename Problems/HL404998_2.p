...
tff(conj_thm_2Equotient__list_2EFOLDR__PRS,conjecture,(
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6l: $i] :
                                 ...
                                 => ! [V7f: $i] :
                                     ...
                                     => ! [V8e: $i] :
                                          ( mem(V8e,A_27d)
                                         => ap(ap(ap(c_2Elist_2EFOLDR(A_27c,A_27c),V7f),V8e),V6l) = ap(V4abs2,ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),ap(ap(c_2Equotient_2E_2D_2D_3E(A_27b,A_27b,A_27b,A_27b),V4abs2),V5rep2)),V7f)),ap(V5rep2,V8e)),ap(ap(c_2Elist_2EMAP(A_27c,A_27c),V2rep1),V6l))) ) ) ) ) ) ) ) ) ) ) ) )).
