...
fof(conj_thm_2Ereal_2EABS__BOUNDS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1k] :
...
fof(conj_thm_2Ecomplex_2ERE__IM__LE__MODU,lemma,(
    ! [V0z] :
...
fof(conj_thm_2Ecomplex_2EMODU__NZ,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ecomplex_2EIM__DIV__MODU__BOUNDS,conjecture,(
    ! [V0z] :
      ( mem(V0z,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( V0z != ap(c_2Ecomplex_2Ecomplex__of__num,c_2Enum_2E0)
