...
thf(thm_2Emeasure_2EMEASURABLE__SUBSET,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1b: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o )] :
      ( c_2Epred__set_2ESUBSET @ ( A_27a > A_27b ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V0a @ V1b ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V0a @ ( c_2Emeasure_2Esigma @ A_27b @ ( c_2Emeasure_2Espace @ A_27b @ V1b ) @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) ) ) ) )).
