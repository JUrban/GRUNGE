...
tff(conj_thm_2EternaryComparisons_2Elist__compare__ind,conjecture,(
                 ...
                 => ! [V10l1: $i] :
                     ...
                     => ! [V11y: $i] :
                         ...
                         => ! [V12l2: $i] :
                             ...
                             => ( ( surj__ty_2EternaryComparisons_2Eordering(ap(ap(V8cmp,V9x),V11y)) = fo__c_2EternaryComparisons_2EEQUAL
