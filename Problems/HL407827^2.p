...
thf(conj_thm_2Efrac_2EFRAC__AINV__ADD,lemma,(
    ! [V0f1: tp__ty_2Efrac_2Efrac,V1f2: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__ainv @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V0f1 ) ) @ ( inj__ty_2Efrac_2Efrac @ V1f2 ) ) ) )
      = ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( ap @ c_2Efrac_2Efrac__ainv @ ( inj__ty_2Efrac_2Efrac @ V0f1 ) ) ) @ ( ap @ c_2Efrac_2Efrac__ainv @ ( inj__ty_2Efrac_2Efrac @ V1f2 ) ) ) ) ) )).
...
thf(conj_thm_2Erat_2ERAT__AINV__ADD,conjecture,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
