         ...
         => ( ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ A_27b ) @ V0P ) @ V1Q )
            = ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
              @ ( lam @ ( ty_2Epair_2Eprod @ A_27a @ A_27b )
                @ ^ [V2p: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ V2p ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ ( ap @ ( c_2Epair_2EFST @ A_27a @ A_27b ) @ V2p ) ) @ V0P ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ ( ap @ ( c_2Epair_2ESND @ A_27a @ A_27b ) @ V2p ) ) @ V1Q ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Epred__set_2ECOUNTABLE__ALT,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eextreal_2ECROSS__COUNTABLE__UNIV,conjecture,(
    p @ ( ap @ ( c_2Epred__set_2Ecountable @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) )).
