...
fof(conj_thm_2Etransfer_2EFUN__REL__EQ2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(ap(c_2Etransfer_2EFUN__REL(A_27a,A_27a,A_27a,A_27a),c_2Emin_2E_3D(A_27a)),c_2Emin_2E_3D(A_27b)) = c_2Emin_2E_3D(arr(A_27a,A_27b)) ) ) )).
