...
thf(thm_2Emeasure_2Emeasurable__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1b: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o )] :
      ( ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V0a @ V1b )
      = ( c_2Epred__set_2EGSPEC @ ( A_27a > A_27b ) @ ( A_27a > A_27b )
        @ ^ [V2f: A_27a > A_27b] :
            ( c_2Epair_2E_2C @ ( A_27a > A_27b ) @ $o @ V2f
            @ ( c_2Ebool_2E_2F_5C @ ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
              @ ( c_2Ebool_2E_2F_5C @ ( c_2Emeasure_2Esigma__algebra @ A_27b @ V1b )
                @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ ( A_27a > A_27b ) @ V2f @ ( c_2Epred__set_2EFUNSET @ A_27a @ A_27b @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ ( c_2Emeasure_2Espace @ A_27b @ V1b ) ) )
                  @ ( c_2Ebool_2E_21 @ ( A_27b > $o )
                    @ ^ [V3s: A_27b > $o] :
                        ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ ( A_27b > $o ) @ V3s @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) ) @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EINTER @ A_27a @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V2f @ V3s ) @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) ) ) ) ) ) ) ) ) )).
