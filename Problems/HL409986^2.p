...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__CMUL,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eextreal_2Esup__cmul,lemma,(
    ! [A_27a: del,V0f: $i] :
              ...
              @ ( ap @ c_2Eextreal_2Eextreal__sup
                @ ( ap
                  @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ ty_2Eextreal_2Eextreal )
                    @ ( lam @ A_27a
                      @ ^ [V2n: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ V0f @ V2n ) ) ) )
...
thf(conj_thm_2Eextreal_2Eext__suminf__cmul__alt,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal ) )
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) )
         ...
         => ( ( surj__ty_2Eextreal_2Eextreal
              @ ( ap @ c_2Eextreal_2Eext__suminf
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4n: $i] :
                      ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ V0f @ V4n ) ) ) ) )
