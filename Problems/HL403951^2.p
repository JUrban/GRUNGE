...
thf(conj_thm_2Ellist_2ELTAKE__LAPPEND1,lemma,(
...
thf(conj_thm_2Ellist_2ENOT__LFINITE__APPEND,lemma,(
    ! [A_27a: del,V0ll1: $i] :
      ( ( mem @ V0ll1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1ll2: $i] :
          ( ( mem @ V1ll2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
...
thf(conj_thm_2Ellist_2ELTAKE__fromList,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Ellist_2Eto__fromList,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll ) )
...
thf(conj_thm_2Ellist_2ELNTH__LAPPEND,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( ( mem @ V1l1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V2l2: $i] :
          ( ( mem @ V2l2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1l1 ) @ V2l2 ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ty_2Enum_2Enum @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V1l1 ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l1 ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3m: $i] :
                    ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V3m ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l1 ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V3m ) ) @ V2l2 ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
thf(conj_thm_2Ellist_2ELTAKE__IMP__LDROP,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V2l1: $i] :
          ( ( mem @ V2l1 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2l1 ) )
           => ? [V3l2: $i] :
                ( ( mem @ V3l2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
                & ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll )
                  = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V3l2 ) )
                & ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V2l1 ) ) @ V3l2 )
                  = V1ll ) ) ) ) ) )).
...
thf(conj_thm_2Eoption_2EIS__NONE__EQ__NONE,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Erich__list_2ETAKE__APPEND1,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l1 ) ) )
       => ! [V2l2: $i] :
            ( ( mem @ V2l2 @ ( ty_2Elist_2Elist @ A_27a ) )
           => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V1l1 ) @ V2l2 ) )
              = ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l1 ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELPREFIX__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2ELPREFIX @ A_27a ) @ V0l1 ) @ V1l2 ) )
          <=> ? [V2ll: $i] :
                ...
                & ( V1l2
                  = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0l1 ) @ V2ll ) ) ) ) ) ) )).
