...
thf(conj_thm_2Ebool_2ESELECT__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Epred__set_2EINJ__COMPOSE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1g: $i] :
                  ...
                  @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V2y ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V1s ) ) )
                    @ ( ap @ ( c_2Eoption_2ESOME @ A_27a )
                      @ ( ap @ ( c_2Emin_2E_40 @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ ( ap @ V0f @ V3x ) ) @ V2y ) ) ) ) ) )
                  @ ( c_2Eoption_2ENONE @ A_27a ) ) ) ) ) ) )).

thf(conj_thm_2Epred__set_2EINJ__LINV__OPT__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2Epred__set_2ESURJ__INJ__INV,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
