...
fof(lamtp_f2926,axiom,(
    mem(f2926,arr(ty_2Erealax_2Ereal,bool)) )).

fof(lameq_f2926,axiom,(
    ! [V2c] :
      ( mem(V2c,ty_2Erealax_2Ereal)
     => ap(f2926,V2c) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V2c),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) )).

fof(lamtp_f2927,axiom,(
    mem(f2927,arr(ty_2Erealax_2Ereal,bool)) )).

fof(lameq_f2927,axiom,(
    ! [V3c] :
      ( mem(V3c,ty_2Erealax_2Ereal)
     => ap(f2927,V3c) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V3c),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) )).

fof(conj_thm_2Epoly_2EPOLY__DIFF__AUX__ISZERO,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Elist_2EEVERY(ty_2Erealax_2Ereal),f2926),ap(ap(c_2Epoly_2Epoly__diff__aux,ap(c_2Enum_2ESUC,V1n)),V0p)))
          <=> p(ap(ap(c_2Elist_2EEVERY(ty_2Erealax_2Ereal),f2927),V0p)) ) ) ) )).

fof(conj_thm_2Epoly_2EPOLY__DIFF__ISZERO,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
