...
tff(conj_thm_2Ereal__topology_2ELIM__MIN,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(ax_thm_2Ereal__topology_2Econtinuous,axiom,(
    ! [A_27a: del,V0f: $i] :
...
tff(lamtp_f3826,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3826(A_27a,V0f,V1g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3826,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3826(A_27a,V0f,V1g),V3x) = ap(ap(c_2Ereal_2Emin,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MIN,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2net: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V0f),V2net))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3826(A_27a,V0f,V1g)),V2net)) ) ) ) ) )).
