...
fof(conj_thm_2Ewords_2Eword__L__MULT__NEG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__L2__MULT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [A_27d] :
                 ...
                 => ( ap(ap(c_2Ewords_2Eword__mul(A_27a),c_2Ewords_2Eword__L2(A_27a)),c_2Ewords_2Eword__L2(A_27a)) = c_2Ewords_2Eword__L2(A_27a)
                    ...
                    & ! [V0n] :
                        ( mem(V0n,ty_2Enum_2Enum)
                       => ap(ap(c_2Ewords_2Eword__mul(A_27c),ap(c_2Ewords_2En2w(A_27c),V0n)),c_2Ewords_2Eword__L2(A_27c)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,V0n)),ap(c_2Ewords_2En2w(A_27c),c_2Enum_2E0)),c_2Ewords_2Eword__L2(A_27c)) )
                    & ! [V1n] :
                        ( mem(V1n,ty_2Enum_2Enum)
                       => ap(ap(c_2Ewords_2Eword__mul(A_27d),ap(c_2Ewords_2Eword__2comp(A_27d),ap(c_2Ewords_2En2w(A_27d),V1n))),c_2Ewords_2Eword__L2(A_27d)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,V1n)),ap(c_2Ewords_2En2w(A_27d),c_2Enum_2E0)),c_2Ewords_2Eword__L2(A_27d)) ) ) ) ) ) ) )).
