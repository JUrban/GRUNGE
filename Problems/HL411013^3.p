...
thf(thm_2Ereal__topology_2ENOT__BOUNDED__UNIV,axiom,(
    (~) @ ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) ) )).
...
thf(thm_2Ereal__topology_2ECOBOUNDED__IMP__UNBOUNDED,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EDIFF @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) @ V0s ) )
     => ( (~) @ ( c_2Ereal__topology_2Ebounded__def @ V0s ) ) ) )).
