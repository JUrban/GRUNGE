...
thf(thm_2Ereal__topology_2ECOMPONENTS__EQ__EMPTY,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ecomponents @ V0s )
        = ( c_2Epred__set_2EEMPTY @ ( tyop_2Erealax_2Ereal > $o ) ) )
    <=> ( V0s
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).

thf(thm_2Ereal__topology_2ECOMPONENTS__EMPTY,axiom,
    ( ( c_2Ereal__topology_2Ecomponents @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
    = ( c_2Epred__set_2EEMPTY @ ( tyop_2Erealax_2Ereal > $o ) ) )).

thf(thm_2Ereal__topology_2ECOMPONENTS__EQ__SING__EXISTS,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ? [V1a: tyop_2Erealax_2Ereal > $o] :
          ( ( c_2Ereal__topology_2Ecomponents @ V0s )
          = ( c_2Epred__set_2EINSERT @ ( tyop_2Erealax_2Ereal > $o ) @ V1a @ ( c_2Epred__set_2EEMPTY @ ( tyop_2Erealax_2Ereal > $o ) ) ) )
...
thf(thm_2Ereal__topology_2ECONNECTED__EQ__COMPONENTS__SUBSET__SING__EXISTS,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Econnected @ V0s )
    <=> ? [V1a: tyop_2Erealax_2Ereal > $o] :
          ( c_2Epred__set_2ESUBSET @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2Ecomponents @ V0s ) @ ( c_2Epred__set_2EINSERT @ ( tyop_2Erealax_2Ereal > $o ) @ V1a @ ( c_2Epred__set_2EEMPTY @ ( tyop_2Erealax_2Ereal > $o ) ) ) ) ) )).
