...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__LEFT__EQ,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SCALING__LEFT,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
              ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
             => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3700(V0c)),V1s)),V2t))
              <=> p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V1s),V2t)) ) ) ) ) )).
