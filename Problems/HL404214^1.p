...
thf(thm_2Ellist_2ELLIST__EQ,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1g_2E0: u] :
      ( ! [V2x_2E0: u] :
          ( ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
              = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) )
            & ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
              = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) ) )
          | ? [V3h_2E0: u,V4y_2E0: u] :
              ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
                = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V3h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) ) ) ) )
              & ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
                = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V3h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) ) ) ) ) ) )
     => ! [V5x_2E0: u] :
          ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ V1g_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) ) )).
...
thf(thm_2Epath_2Elabels__LMAP,conjecture,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u] :
