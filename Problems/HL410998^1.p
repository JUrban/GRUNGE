        ...
        | ? [V3a_2E0: u,V4b_2E0: u] :
            ( ( (~)
              @ ( ( s @ A_27a @ V3a_2E0 )
                = ( s @ A_27a @ V4b_2E0 ) ) )
            & ! [V5x_2E0: u] :
                ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V3a_2E0 ) ) ) ) )
                & ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V4b_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSURE__SEQUENTIAL,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1l: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1l @ ( mono_2Ec_2Ereal__topology_2Eclosure @ V0s ) )
    <=> ? [V2x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
          ( ! [V3n: mono_2Etyop_2Enum_2Enum] :
              ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V2x @ V3n ) @ V0s )
          & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ V2x @ V1l @ mono_2Ec_2Ereal__topology_2Esequentially ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__CLOSURE,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ebounded__def @ V0s )
