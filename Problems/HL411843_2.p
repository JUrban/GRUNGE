...
tff(conj_thm_2Ereal__topology_2Econtinuous__at,lemma,(
    ! [V0f: $i] :
        ...
        <=> ! [V2e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V3d: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ! [V4x_27: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x_27)),inj__ty_2Erealax_2Ereal(V1x)))),inj__ty_2Erealax_2Ereal(V3d)))
                     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V4x_27))),ap(V0f,inj__ty_2Erealax_2Ereal(V1x))))),inj__ty_2Erealax_2Ereal(V2e))) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__SETDIST,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f4062(V0s)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x)))) ) )).
