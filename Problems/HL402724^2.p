...
thf(conj_thm_2Erich__list_2EFILTER__SNOC,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2l: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V1x ) @ V2l ) )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ V0P @ V1x ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V1x ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ V2l ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ V2l ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EFOLDR__FILTER__REVERSE,conjecture,(
    ! [A_27a: del,V0f: $i] :
       ...
       => ! [V4e: $i] :
           ...
           => ! [V5P: $i] :
               ...
               => ! [V6l: $i] :
                   ...
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27a ) @ V0f ) @ V4e ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V5P ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ V6l ) ) )
                      = ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27a ) @ V0f ) @ V4e ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V5P ) @ V6l ) ) ) ) ) ) ) ) )).
