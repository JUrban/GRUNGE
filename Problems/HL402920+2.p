...
fof(conj_thm_2Elogroot_2ELOG__EQ__0,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Elogroot_2ELOG__add__digit,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Erich__list_2EMEM__LAST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Enumposrep_2El2n__eq__0,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
...
fof(conj_thm_2Enumposrep_2ELOG__l2n,conjecture,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0b))
       => ! [V1l] :
