...
fof(conj_thm_2Epath_2Efirst__label__drop,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ! [V1p] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0i),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                   => ap(c_2Epath_2Efirst__label(A_27a,A_27a),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),V0i),V1p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V0i),V1p) ) ) ) ) ) )).
