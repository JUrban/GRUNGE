...
fof(conj_thm_2Elist_2EMAP__EQ__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1l] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27b)
                     => ( ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1l) = ap(ap(c_2Elist_2ECONS(A_27b),V2x),c_2Elist_2ENIL(A_27b))
                      <=> ? [V3x0] :
                            ( mem(V3x0,A_27a)
...
fof(conj_thm_2Elist_2EEVERY__MAP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Elist_2EREVERSE__EQ__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Elist_2EMAP__TAKE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1n] :
                 ...
                 => ! [V2l] :
                      ( mem(V2l,ty_2Elist_2Elist(A_27a))
                     => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),ap(ap(c_2Elist_2ETAKE(A_27a),V1n),V2l)) = ap(ap(c_2Elist_2ETAKE(A_27b),V1n),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2l)) ) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2ETAKE__REVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Elist_2ETAKE(A_27a),V0n),ap(c_2Elist_2EREVERSE(A_27a),V1l)) = ap(c_2Elist_2EREVERSE(A_27a),ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),V1l)) ) ) ) ) )).
...
fof(conj_thm_2Enumposrep_2ELENGTH__l2n,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1l] :
...
fof(conj_thm_2Enumposrep_2En2l__l2n,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Enum_2Enum))
...
fof(conj_thm_2EASCIInumbers_2En2s__s2n,conjecture,(
    ! [V0c2n] :
         ...
         => ! [V2b] :
             ...
             => ! [V3s] :
                 ...
                 => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V2b))
                      & p(ap(ap(c_2Elist_2EEVERY(ty_2Estring_2Echar),ap(ap(c_2Ecombin_2Eo(ty_2Estring_2Echar,ty_2Estring_2Echar,ty_2Estring_2Echar),ap(c_2Earithmetic_2E_3E,V2b)),V0c2n)),V3s)) )
                   => ap(ap(ap(c_2EASCIInumbers_2En2s,V2b),V1n2c),ap(ap(ap(c_2EASCIInumbers_2Es2n,V2b),V0c2n),V3s)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(ap(ap(c_2EASCIInumbers_2Es2n,V2b),V0c2n),V3s)),c_2Enum_2E0)),ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(V1n2c,c_2Enum_2E0)),c_2Elist_2ENIL(ty_2Estring_2Echar))),ap(ap(c_2Elist_2EMAP(ty_2Estring_2Echar,ty_2Estring_2Echar),ap(ap(c_2Ecombin_2Eo(ty_2Estring_2Echar,ty_2Estring_2Echar,ty_2Estring_2Echar),V1n2c),V0c2n)),ap(ap(c_2Erich__list_2ELASTN(ty_2Estring_2Echar),ap(c_2Enum_2ESUC,ap(ap(c_2Elogroot_2ELOG,V2b),ap(ap(ap(c_2EASCIInumbers_2Es2n,V2b),V0c2n),V3s)))),V3s))) ) ) ) ) ) )).
