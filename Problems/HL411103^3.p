...
thf(thm_2Ereal__topology_2ECLOSED__BIGINTER__COMPACT,conjecture,(
    ...
    <=> ! [V1e: tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2Ecompact @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Ecball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V1e ) ) @ V0s ) ) ) )).
