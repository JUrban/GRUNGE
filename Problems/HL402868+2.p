...
fof(conj_thm_2Erich__list_2EEL__LENGTH__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l2] :
...
fof(conj_thm_2Erich__list_2EEL__LENGTH__APPEND__rwt,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l2] :
          ( mem(V0l2,ty_2Elist_2Elist(A_27a))
         => ! [V1n] :
             ...
             => ! [V2l1] :
                 ...
                 => ( ( ~ p(ap(c_2Elist_2ENULL(A_27a),V0l2))
                      & V1n = ap(c_2Elist_2ELENGTH(A_27a),V2l1) )
                   => ap(ap(c_2Elist_2EEL(A_27a),V1n),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l1),V0l2)) = ap(c_2Elist_2EHD(A_27a),V0l2) ) ) ) ) ) )).
