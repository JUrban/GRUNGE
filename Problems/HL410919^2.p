...
thf(conj_thm_2Ereal__topology_2ELIM__NEG,lemma,(
    ! [A_27a: del,V0net: $i] :
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V1f @ V3x ) ) ) )
                    @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) )
                  @ V0net ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELIM__SUB,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
