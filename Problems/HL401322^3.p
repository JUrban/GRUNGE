...
thf(thm_2Ebit_2EBITWISE__BITS,conjecture,(
    ! [V0wl: tyop_2Enum_2Enum,V1op: $o > $o > $o,V2a: tyop_2Enum_2Enum,V3b: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ V0wl ) @ V1op @ ( c_2Ebit_2EBITS @ V0wl @ c_2Enum_2E0 @ V2a ) @ ( c_2Ebit_2EBITS @ V0wl @ c_2Enum_2E0 @ V3b ) )
      = ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ V0wl ) @ V1op @ V2a @ V3b ) ) )).
