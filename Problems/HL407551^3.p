...
thf(thm_2Ereal_2ENUM__FLOOR__LE2,conjecture,(
    ! [V0y: tyop_2Erealax_2Ereal,V1x: tyop_2Enum_2Enum] :
      ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V0y )
     => ( ( c_2Earithmetic_2E_3C_3D @ V1x @ ( c_2Ereal_2ENUM__FLOOR @ V0y ) )
        = ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ V1x ) @ V0y ) ) ) )).
