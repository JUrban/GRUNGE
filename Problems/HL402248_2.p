...
tff(conj_thm_2Elist_2ESUM__SNOC,lemma,(
...
tff(lmtp_f428,type,(
    f428: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f428,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V2a: tp__ty_2Enum_2Enum] : mem(f428(A_27a,V0f,V2a),arr(A_27a,ty_2Enum_2Enum)) ) )).

tff(lameq_f428,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V2a: tp__ty_2Enum_2Enum,V3e: $i] :
          ( mem(V3e,A_27a)
         => ap(f428(A_27a,V0f,V2a),V3e) = ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2a)),ap(V0f,V3e)) ) ) )).

tff(lmtp_f427,type,(
    f427: ( del * $i ) > $i )).

tff(lamtp_f427,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
...
tff(lameq_f427,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V2a: tp__ty_2Enum_2Enum] : ap(f427(A_27a,V0f),inj__ty_2Enum_2Enum(V2a)) = f428(A_27a,V0f,V2a) ) )).

tff(conj_thm_2Elist_2ESUM__MAP__FOLDL,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
         => surj__ty_2Enum_2Enum(ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1ls))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f427(A_27a,V0f)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V1ls)) ) ) )).
