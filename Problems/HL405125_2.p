...
tff(lamtp_f2070,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(A_27a,bool))
         => mem(f2070(A_27a,A_27a,V1s,V2t),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f2070,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
     ...
     => ! [V2t: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f2070(A_27a,A_27a,V1s,V2t),V3x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s)),ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2t)) ) ) ) )).
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient__pred__set_2EDISJOINTR(A_27a),V0R),V1s),V2t))
              <=> ~ p(ap(ap(c_2Ebool_2ERES__EXISTS(A_27a),ap(c_2Equotient_2Erespects(A_27a,A_27a),V0R)),f2070(A_27a,A_27a,V1s,V2t))) ) ) ) ) )).

tff(conj_thm_2Equotient__pred__set_2EDISJOINTR__RSP,conjecture,(
