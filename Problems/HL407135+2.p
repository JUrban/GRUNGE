...
fof(conj_thm_2Ebool_2Eitself__induction,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
...
fof(conj_thm_2Ebasis__emit_2EFCPi__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
              ( mem(V0P,arr(ty_2Epair_2Eprod(arr(ty_2Enum_2Enum,A_27a),arr(ty_2Enum_2Enum,A_27a)),bool))
             => ( ! [V1f] :
                    ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
                   => p(ap(V0P,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,A_27a),arr(ty_2Enum_2Enum,A_27a)),V1f),c_2Ebool_2Ethe__value(A_27b)))) )
               => ! [V2v] :
                    ( mem(V2v,arr(ty_2Enum_2Enum,A_27a))
                   => ! [V3v1] :
                        ( mem(V3v1,ty_2Ebool_2Eitself(A_27b))
                       => p(ap(V0P,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,A_27a),arr(ty_2Enum_2Enum,A_27a)),V2v),V3v1))) ) ) ) ) ) ) )).
