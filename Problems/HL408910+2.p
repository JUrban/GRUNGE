...
fof(conj_thm_2Ewords_2EWORD__ADD__BIT0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b)),c_2Enum_2E0))
              <=> ~ ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0a),c_2Enum_2E0))
                  <=> p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1b),c_2Enum_2E0)) ) ) ) ) ) )).

fof(conj_thm_2EHolSmt_2Et034,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
         ...
         => ! [V1y] :
             ...
             => ( ap(ap(c_2Ewords_2Eword__add(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0x) = V1y
               => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0x),c_2Enum_2E0))
                 => ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1y),c_2Enum_2E0)) ) ) ) ) ) )).
