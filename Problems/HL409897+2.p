...
fof(conj_thm_2Eiterate_2ESUM__SING__NUMSEG,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Eiterate_2ESUM__CLAUSES__LEFT,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__RMUL,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__MUL,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
