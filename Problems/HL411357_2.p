...
tff(conj_thm_2Ecardinal_2ESURJECTIVE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2EOPEN__TRANSLATION__EQ,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__TRANSLATION,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Ereal__topology_2Einterior,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3805(V0a)),V1s)) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3924(V0a)),ap(c_2Ereal__topology_2Einterior,V1s)) ) )).
