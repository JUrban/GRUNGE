...
thf(conj_thm_2Ealignment_2Ealign__w2n,lemma,(
...
thf(conj_thm_2Ealignment_2Ealign__sub,lemma,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ealignment_2Ealign @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0p ) ) @ V1w )
...
thf(conj_thm_2Ewords_2EWORD__EXTRACT__ID,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ealignment_2Ealign__add__aligned,conjecture,(
