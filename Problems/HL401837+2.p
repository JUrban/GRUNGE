...
fof(conj_thm_2Epred__set_2ECHOICE__NOT__IN__REST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EFINITE__REST__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__MONO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(ap(ap(c_2Earithmetic_2EFUNPOW(arr(A_27a,bool)),c_2Epred__set_2EREST(A_27a)),V0n),V1s)),V1s)) ) ) ) )).

fof(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__NOT__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1s] :
             ...
             => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => ap(ap(ap(c_2Earithmetic_2EFUNPOW(arr(A_27a,bool)),c_2Epred__set_2EREST(A_27a)),V0n),V1s) != c_2Epred__set_2EEMPTY(A_27a) ) ) ) ) )).

fof(lamtp_f307,axiom,(
    ! [A_27a,V0s] :
      ( mem(V0s,arr(A_27a,bool))
     => mem(f307(A_27a,V0s),arr(ty_2Enum_2Enum,A_27a)) ) )).

fof(lameq_f307,axiom,(
    ! [A_27a,V0s] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f307(A_27a,V0s),V1n) = ap(c_2Epred__set_2ECHOICE(A_27a),ap(ap(ap(c_2Earithmetic_2EFUNPOW(arr(A_27a,bool)),c_2Epred__set_2EREST(A_27a)),V1n),V0s)) ) ) )).

fof(conj_thm_2Epred__set_2EINFINITE__EXPLICIT__ENUMERATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => p(ap(ap(ap(c_2Epred__set_2EINJ(ty_2Enum_2Enum,ty_2Enum_2Enum),f307(A_27a,V0s)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),V0s)) ) ) ) )).
