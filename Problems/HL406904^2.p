...
thf(stp_fo_c_2EDeepSyntax_2Eeval__form,type,(
    fo__c_2EDeepSyntax_2Eeval__form: tp__ty_2EDeepSyntax_2Edeep__form > tp__ty_2Einteger_2Eint > $o )).

thf(stp_eq_fo_c_2EDeepSyntax_2Eeval__form,axiom,(
    ! [X0: tp__ty_2EDeepSyntax_2Edeep__form,X1: tp__ty_2Einteger_2Eint] :
      ( ( inj__o @ ( fo__c_2EDeepSyntax_2Eeval__form @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2EDeepSyntax_2Eeval__form @ ( inj__ty_2EDeepSyntax_2Edeep__form @ X0 ) ) @ ( inj__ty_2Einteger_2Eint @ X1 ) ) ) )).
...
thf(stp_fo_c_2EDeepSyntax_2Ealldivide,type,(
    fo__c_2EDeepSyntax_2Ealldivide: tp__ty_2EDeepSyntax_2Edeep__form > tp__ty_2Einteger_2Eint > $o )).

thf(stp_eq_fo_c_2EDeepSyntax_2Ealldivide,axiom,(
    ! [X0: tp__ty_2EDeepSyntax_2Edeep__form,X1: tp__ty_2Einteger_2Eint] :
      ( ( inj__o @ ( fo__c_2EDeepSyntax_2Ealldivide @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2EDeepSyntax_2Ealldivide @ ( inj__ty_2EDeepSyntax_2Edeep__form @ X0 ) ) @ ( inj__ty_2Einteger_2Eint @ X1 ) ) ) )).
...
thf(conj_thm_2EDeepSyntax_2Eneginf__disj1__implies__exoriginal,lemma,(
    ! [V0f: tp__ty_2EDeepSyntax_2Edeep__form,V1d: tp__ty_2Einteger_2Eint,V2i: tp__ty_2Einteger_2Eint] :
     ...
     => ( ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Einteger_2Eint @ V2i ) ) )
       ...
       => ? [V3x: tp__ty_2Einteger_2Eint] :
            ( p @ ( ap @ ( ap @ c_2EDeepSyntax_2Eeval__form @ ( inj__ty_2EDeepSyntax_2Edeep__form @ V0f ) ) @ ( inj__ty_2Einteger_2Eint @ V3x ) ) ) ) ) )).

thf(conj_thm_2EDeepSyntax_2Eneginf__exoriginal__implies__rhs,lemma,(
     ...
     => ( ( p @ ( ap @ ( ap @ c_2EDeepSyntax_2Eeval__form @ ( inj__ty_2EDeepSyntax_2Edeep__form @ V0f ) ) @ ( inj__ty_2Einteger_2Eint @ V2x ) ) )
       => ( ? [V3i: tp__ty_2Einteger_2Eint] :
          ...
          | ? [V4j: tp__ty_2Einteger_2Eint,V5b: tp__ty_2Einteger_2Eint] :
              ...
              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Einteger_2Eint ) @ ( inj__ty_2Einteger_2Eint @ V5b ) ) @ ( ap @ ( ap @ c_2EDeepSyntax_2EBset @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( inj__ty_2EDeepSyntax_2Edeep__form @ V0f ) ) ) )
...
thf(conj_thm_2EDeepSyntax_2Eneginf__exoriginal__eq__rhs,conjecture,(
     ...
     => ( ? [V2x: tp__ty_2Einteger_2Eint] :
      ...
      <=> ( ? [V3i: tp__ty_2Einteger_2Eint] :
          ...
          | ? [V4b: tp__ty_2Einteger_2Eint,V5j: tp__ty_2Einteger_2Eint] :
              ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Einteger_2Eint ) @ ( inj__ty_2Einteger_2Eint @ V4b ) ) @ ( ap @ ( ap @ c_2EDeepSyntax_2EBset @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( inj__ty_2EDeepSyntax_2Edeep__form @ V0f ) ) ) )
