    ...
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2i: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),inj__ty_2Enum_2Enum(V2i)))
            <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2i)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                & p(ap(V0P,ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V2i)),V1p)))
                & ! [V3j: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3j)),inj__ty_2Enum_2Enum(V2i)))
                   => ~ p(ap(V0P,ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V3j)),V1p))) ) ) ) ) ) )).
...
tff(conj_thm_2Epath_2Eexists__el,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
