    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1u: A_27a > $o,V2v: A_27a > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ A_27a @ V1u @ V2v )
        & ! [V3x: A_27a] :
           ...
           => ( ( V0f @ V3x )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2v @ V0f )
        = ( c_2Eiterate_2ESum @ A_27a @ V1u @ V0f ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__GROUP,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1g: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o,V3t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ( c_2Epred__set_2ESUBSET @ A_27b @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ V2s ) @ V3t ) )
     => ( ( c_2Eiterate_2ESum @ A_27b @ V3t
          @ ^ [V4y: A_27b] :
              ( c_2Eiterate_2ESum @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V5x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V5x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V5x @ V2s ) @ ( c_2Emin_2E_3D @ A_27b @ ( V0f @ V5x ) @ V4y ) ) ) )
              @ V1g ) )
        = ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1g ) ) ) )).
