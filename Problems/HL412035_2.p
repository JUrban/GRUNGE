...
tff(conj_thm_2Elebesgue_2Eintegrable__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(lamtp_f4199,axiom,(
    ! [A_27a: del,V1f1: $i] :
      ( mem(V1f1,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2f2: $i] :
          ( mem(V2f2,arr(A_27a,ty_2Eextreal_2Eextreal))
         => mem(f4199(A_27a,V1f1,V2f2),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f4199,axiom,(
    ! [A_27a: del,V1f1: $i] :
      ( mem(V1f1,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2f2: $i] :
          ( mem(V2f2,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f4199(A_27a,V1f1,V2f2),V3x) = ap(ap(c_2Eextreal_2Eextreal__sub,ap(V1f1,V3x)),ap(V2f2,V3x)) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__sub,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f1: $i] :
          ( mem(V1f1,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2f2: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  & p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),V1f1))
                  & p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),V2f2)) )
               => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4199(A_27a,V1f1,V2f2))) ) ) ) ) )).
