...
tff(conj_thm_2Ereal__topology_2EINTERIOR__EMPTY,lemma,(
...
tff(conj_thm_2Ereal__topology_2EREGULAR__CLOSED__UNION,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EREGULAR__CLOSED__BIGUNION,conjecture,(
    ! [V0f: $i] :
