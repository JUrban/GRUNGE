...
fof(conj_thm_2Emeasure_2ESPACE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
    ...
    ! [A_27a,V0fn] :
     ...
     => ! [V6x] :
         ...
         => ! [V7n] :
             ...
             => ap(f3593(A_27a,V0fn,V6x),V7n) = ap(ap(V0fn,V7n),V6x) ) ) ) )).

fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MONO__SUP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0fn] :
          ( mem(V0fn,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
             ...
             => ! [V2a] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V2a))
                      & ! [V3n] :
                         ...
                         => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V0fn,V3n)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V2a),c_2Emeasure_2EBorel))) )
                      & ! [V4n] :
                          ( mem(V4n,ty_2Enum_2Enum)
                         => ! [V5x] :
                              ( mem(V5x,A_27a)
                             => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V5x),ap(c_2Emeasure_2Espace(A_27a),V2a)))
                               => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(V0fn,V4n),V5x)),ap(ap(V0fn,ap(c_2Enum_2ESUC,V4n)),V5x))) ) ) )
                      & ! [V6x] :
                          ( mem(V6x,A_27a)
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V6x),ap(c_2Emeasure_2Espace(A_27a),V2a)))
                           => ap(V1f,V6x) = ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3593(A_27a,V0fn,V6x)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) )
