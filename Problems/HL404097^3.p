...
thf(thm_2EPast__Temporal__Logic_2ESEPARATE__BEFORE__THM,conjecture,(
    ! [V0d: tyop_2Enum_2Enum > $o,V1c: tyop_2Enum_2Enum > $o,V2b: tyop_2Enum_2Enum > $o,V3a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2ETemporal__Logic_2EBEFORE @ V3a
        ...
        = ( ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2EBEFORE @ V3a @ V2b @ V5t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V3a @ V1c @ V5t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V3a @ V6t ) @ ( V2b @ V6t ) )
          @ V1c )
        = ( ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EBEFORE @ V3a @ V1c @ V7t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V2b @ V1c @ V7t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V3a
          @ ^ [V8t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V8t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1c @ V8t ) ) )
              ...
              @ ( c_2Ebool_2E_5C_2F @ ( V3a @ V9t )
                @ ( c_2ETemporal__Logic_2EBEFORE @ ( c_2ETemporal__Logic_2ENEXT @ V3a )
                  @ ^ [V10t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V1c @ V10t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V10t ) )
                  @ V9t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V3a
          @ ^ [V11t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V11t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V1c @ V11t ) ) )
              ...
              @ ( c_2Ebool_2E_5C_2F @ ( V3a @ V12t )
                @ ( c_2ETemporal__Logic_2EBEFORE @ ( c_2ETemporal__Logic_2ENEXT @ V3a )
                  @ ^ [V13t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V1c @ V13t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V13t ) )
                  @ V12t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V3a
          @ ^ [V14t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V14t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1c @ V0d @ V14t ) ) )
        = ( ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C
              @ ( c_2Ebool_2E_5C_2F
                @ ( c_2EPast__Temporal__Logic_2EPBEFORE
                  @ ^ [V16t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_7E @ ( V1c @ V16t ) )
                  @ V0d
                  @ V15t )
                @ ( c_2ETemporal__Logic_2EBEFORE
                  @ ^ [V17t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_5C_2F @ ( V3a @ V17t ) @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V17t ) ) )
                  @ V2b
                  @ V15t ) )
              @ ( c_2ETemporal__Logic_2EBEFORE @ V3a
                @ ^ [V18t: tyop_2Enum_2Enum] :
                    ...
                    @ ( c_2ETemporal__Logic_2ESUNTIL
                      @ ^ [V19t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V19t ) ) @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V19t ) )
                      @ V2b
                      @ V18t ) )
                @ V15t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE @ V3a
          @ ^ [V20t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2b @ V20t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1c @ V0d @ V20t ) ) )
        = ( ^ [V21t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C
              @ ( c_2Ebool_2E_5C_2F
                @ ( c_2EPast__Temporal__Logic_2EPSUNTIL
                  @ ^ [V22t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_7E @ ( V1c @ V22t ) )
                  @ V0d
                  @ V21t )
                @ ( c_2ETemporal__Logic_2EBEFORE
                  @ ^ [V23t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_5C_2F @ ( V3a @ V23t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0d @ V23t ) )
                  @ V2b
                  @ V21t ) )
              @ ( c_2ETemporal__Logic_2EBEFORE @ V3a
                    ...
                    @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V24t ) )
                      @ ( c_2ETemporal__Logic_2ESUNTIL
                        @ ^ [V25t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V3a @ V25t ) ) @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V0d @ V25t ) ) )
                        @ V2b
                        @ V24t ) ) )
                @ V21t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V26t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V3a @ V26t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2b @ V26t ) )
          @ V1c )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1c @ V27t ) )
                @ ( c_2ETemporal__Logic_2EBEFORE
                  @ ^ [V28t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2b @ V28t ) @ ( c_2ETemporal__Logic_2ENEXT @ V3a @ V28t ) )
                  @ ( c_2ETemporal__Logic_2ENEXT @ V1c )
                  @ V27t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V29t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V3a @ V29t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V2b @ V29t ) )
          @ V1c )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1c @ V30t ) )
                @ ( c_2ETemporal__Logic_2EBEFORE
                  @ ^ [V31t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2b @ V31t ) @ ( c_2ETemporal__Logic_2ENEXT @ V3a @ V31t ) )
                  @ ( c_2ETemporal__Logic_2ENEXT @ V1c )
                  @ V30t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V32t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V3a @ V32t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V2b @ V1c @ V32t ) )
          @ V0d )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V2b @ V1c @ V33t )
                @ ( c_2ETemporal__Logic_2ESUNTIL
                  @ ^ [V34t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V34t ) ) @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V34t ) ) )
                  @ ^ [V35t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V3a @ V35t ) @ ( c_2Ebool_2E_7E @ ( V0d @ V35t ) ) )
                  @ V33t ) )
              @ ( c_2ETemporal__Logic_2EBEFORE
                    ...
                    @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1c @ V36t ) )
                      @ ( c_2ETemporal__Logic_2ESUNTIL
                        @ ^ [V37t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V37t ) ) @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V1c @ V37t ) ) )
                        @ ^ [V38t: tyop_2Enum_2Enum] :
                            ( c_2Ebool_2E_2F_5C @ ( V3a @ V38t ) @ ( c_2Ebool_2E_7E @ ( V0d @ V38t ) ) )
                        @ V36t ) ) )
                @ V0d
                @ V33t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V39t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V3a @ V39t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2b @ V1c @ V39t ) )
          @ V0d )
              ...
              @ ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2b @ V1c @ V40t )
                @ ( c_2ETemporal__Logic_2ESUNTIL
                  @ ^ [V41t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V41t ) ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V41t ) )
                  @ ^ [V42t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V3a @ V42t ) @ ( c_2Ebool_2E_7E @ ( V0d @ V42t ) ) )
                  @ V40t ) )
              @ ( c_2ETemporal__Logic_2EBEFORE
                @ ^ [V43t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V1c @ V43t )
                    @ ( c_2ETemporal__Logic_2ESUNTIL
                      @ ^ [V44t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0d @ V44t ) ) @ ( c_2ETemporal__Logic_2ENEXT @ V2b @ V44t ) )
                      @ ^ [V45t: tyop_2Enum_2Enum] :
                          ( c_2Ebool_2E_2F_5C @ ( V3a @ V45t ) @ ( c_2Ebool_2E_7E @ ( V0d @ V45t ) ) )
                      @ V43t ) )
                @ V0d
                @ V40t ) ) ) ) ) )).
