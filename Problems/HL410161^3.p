...
thf(thm_2Emeasure_2ESIGMA__SUBSET__MEASURABLE__SETS,conjecture,(
    ! [A_27a: $tType,V0a: ( A_27a > $o ) > $o,V1m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V1m )
        & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ V0a @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) ) )
     => ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) @ V0a ) ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) ) ) )).
