...
tff(conj_thm_2EHolSmt_2Er020,conjecture,(
    ! [A_27a: del,V0p: tp__o,V1q: tp__o,V2x: $i] :
      ( mem(V2x,A_27a)
     => ! [V3y: $i] :
          ( mem(V3y,A_27a)
         => ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V0p)),ap(ap(ap(c_2Ebool_2ECOND(A_27a),inj__o(V1q)),V2x),V3y)),V2x) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,inj__o(V1q))),inj__o(V0p))),V3y),V2x) ) ) )).
