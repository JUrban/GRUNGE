...
fof(conj_thm_2Earithmetic_2ELESS__MULT2,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elogroot_2ELOG__DIV,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Elogroot_2ELOG__RWT,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Enumposrep_2ELENGTH__l2n,conjecture,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1l] :
