    ...
    ! [V0n: tp__ty_2Enum_2Enum,V1v: $i] :
     ...
     => ! [V2b: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V2b ) @ V1v ) )
           ...
           => ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal__topology_2Edim @ V1v ) )
              = V0n ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESPAN__STDBASIS,lemma,
    ( ( ap @ c_2Ereal__topology_2Espan
      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V0i: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V0i ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V0i ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V0i ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EHAS__SIZE__STDBASIS,lemma,
    ( p
    @ ( ap
      @ ( ap @ ( c_2Ecardinal_2EHAS__SIZE @ ty_2Erealax_2Ereal )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V0i: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V0i ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V0i ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V0i ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EDIM__UNIV,conjecture,
    ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal__topology_2Edim @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) )
