...
tff(mem_c_2Einteger__word_2Esaturate__w2sw,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Einteger__word_2Esaturate__w2sw(A_27a,A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(conj_thm_2Einteger__word_2Esaturate__w2sw,conjecture,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
