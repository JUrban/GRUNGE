...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__IMP__OPEN__IN,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__SYM,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__LOCALLY,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ! [V1Q: $i] :
