...
fof(conj_thm_2Epred__set_2ECARD__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
         => ap(c_2Epred__set_2ECARD(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V0x),c_2Epred__set_2EEMPTY(A_27a))) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) ) ) )).
...
fof(mem_c_2Efcp_2Edest__cart,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efcp_2Edest__cart(A_27a,A_27a),arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Efcp_2Efinite__image(A_27b),A_27a))) ) ) )).
...
fof(mem_c_2Efcp_2Emk__cart,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efcp_2Emk__cart(A_27a,A_27a),arr(arr(ty_2Efcp_2Efinite__image(A_27b),A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) ) ) )).
...
fof(lamtp_f1074,axiom,(
    ! [A_27a,A_27a] : mem(f1074(A_27a,A_27a),arr(A_27a,bool)) )).

fof(lameq_f1074,axiom,(
    ! [A_27a,A_27a,V2x] :
      ( mem(V2x,A_27a)
     => ap(f1074(A_27a,A_27a),V2x) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(A_27a),V2x),c_2Ebool_2EARB(A_27a))),ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a))) ) )).
...
fof(lamtp_f1077,axiom,(
    ! [A_27a,V1x] :
      ( mem(V1x,A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
         => mem(f1077(A_27a,V1x,V0f),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f1077,axiom,(
    ! [A_27a,V1x] :
     ...
     => ! [V0f] :
         ...
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(f1077(A_27a,V1x,V0f),V2n) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,V2n),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Emin_2E_3D(A_27a),ap(V0f,V2n)),V1x)) ) ) ) )).

fof(lamtp_f1076,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => mem(f1076(A_27a,V0f),arr(A_27a,bool)) ) )).
...
fof(lameq_f1076,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => ap(f1076(A_27a,V0f),V1x) = ap(c_2Ebool_2E_3F_21(ty_2Enum_2Enum),f1077(A_27a,V1x,V0f)) ) ) )).

fof(lamtp_f1075,axiom,(
    ! [A_27a,A_27a] : mem(f1075(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,A_27a),bool)) )).

fof(lameq_f1075,axiom,(
    ! [A_27a,A_27a,V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ap(f1075(A_27a,A_27a),V0f) = ap(c_2Ebool_2E_21(A_27a),f1076(A_27a,V0f)) ) )).

fof(ax_thm_2Efcp_2Efinite__index__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Efcp_2Efinite__index(A_27a) = ap(c_2Emin_2E_40(arr(ty_2Enum_2Enum,A_27a)),f1075(A_27a,A_27a)) ) )).
...
fof(ax_thm_2Efcp_2Ecart__tybij,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0a] :
                ( mem(V0a,ty_2Efcp_2Ecart(A_27a,A_27a))
               => ap(c_2Efcp_2Emk__cart(A_27a,A_27a),ap(c_2Efcp_2Edest__cart(A_27a,A_27a),V0a)) = V0a )
            & ! [V1r] :
                ( mem(V1r,arr(ty_2Efcp_2Efinite__image(A_27b),A_27a))
               => ( p(ap(k(arr(ty_2Efcp_2Efinite__image(A_27b),A_27a),c_2Ebool_2ET),V1r))
                <=> ap(c_2Efcp_2Edest__cart(A_27a,A_27a),ap(c_2Efcp_2Emk__cart(A_27a,A_27a),V1r)) = V1r ) ) ) ) ) )).
     ...
     => ! [A_27b] :
         ...
         => ! [V0x] :
             ...
             => ! [V1i] :
                 ...
                 => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V0x),V1i) = ap(ap(c_2Efcp_2Edest__cart(A_27a,A_27a),V0x),ap(c_2Efcp_2Efinite__index(ty_2Efcp_2Efinite__image(A_27b)),V1i)) ) ) ) ) )).

fof(lamtp_f1080,axiom,(
    ! [A_27b,A_27a,V0g] :
      ( mem(V0g,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1f] :
          ( mem(V1f,ty_2Efcp_2Ecart(A_27a,A_27a))
         => mem(f1080(A_27b,A_27a,V0g,V1f),arr(ty_2Enum_2Enum,bool)) ) ) )).
    ...
    ! [A_27b,A_27a,V0g] :
     ...
     => ! [V1f] :
         ...
         => ! [V2i] :
             ...
             => ap(f1080(A_27b,A_27a,V0g,V1f),V2i) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Eprim__rec_2E_3C,V2i),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1f),V2i)),ap(V0g,V2i))) ) ) ) )).

fof(lamtp_f1079,axiom,(
    ! [A_27b,A_27a,A_27a,A_27b,V0g] :
      ( mem(V0g,arr(ty_2Enum_2Enum,A_27a))
     => mem(f1079(A_27b,A_27a,A_27a,A_27b,V0g),arr(ty_2Efcp_2Ecart(A_27a,A_27a),bool)) ) )).
...
fof(lameq_f1079,axiom,(
    ! [A_27b,A_27a,A_27a,A_27b,V0g] :
     ...
     => ! [V1f] :
          ( mem(V1f,ty_2Efcp_2Ecart(A_27a,A_27a))
         => ap(f1079(A_27b,A_27a,A_27a,A_27b,V0g),V1f) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1080(A_27b,A_27a,V0g,V1f)) ) ) )).

fof(lamtp_f1078,axiom,(
    ! [A_27a,A_27b,A_27a] : mem(f1078(A_27a,A_27b,A_27a),arr(arr(ty_2Enum_2Enum,A_27a),ty_2Efcp_2Ecart(A_27a,A_27a))) )).

fof(lameq_f1078,axiom,(
    ! [A_27a,A_27b,A_27a,V0g] :
      ( mem(V0g,arr(ty_2Enum_2Enum,A_27a))
     => ap(f1078(A_27a,A_27b,A_27a),V0g) = ap(c_2Emin_2E_40(ty_2Efcp_2Ecart(A_27a,A_27a)),f1079(A_27b,A_27a,A_27a,A_27b,V0g)) ) )).
...
fof(ax_thm_2Efcp_2EFCP,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Efcp_2EFCP(A_27a,A_27a) = f1078(A_27a,A_27b,A_27a) ) ) )).

fof(conj_thm_2Efcp_2EFCP__BETA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
