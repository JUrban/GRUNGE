...
fof(conj_thm_2Ebit_2EBITS__ZERO3,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ebit_2EBIT__B,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBITS__SUM,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
...
fof(mem_c_2Ewords_2Enzcv,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Enzcv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Epair_2Eprod(bool,bool)))) ) )).
...
fof(ax_thm_2Ewords_2Eword__1comp__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Eword__1comp(A_27a),V0w) = ap(c_2Efcp_2EFCP(bool,bool),f2163(A_27a,V0w)) ) ) )).

fof(lamtp_f2193,axiom,(
    ! [A_27a,A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2q] :
             ...
             => mem(f2193(A_27a,A_27a,V0a,V1b,V2q),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Epair_2Eprod(bool,bool))) ) ) ) )).
     ...
     => ! [V1b] :
         ...
         => ! [V2q] :
             ...
             => ! [V3r] :
                 ...
                 => ap(f2193(A_27a,A_27a,V0a,V1b,V2q),V3r) = ap(ap(c_2Epair_2E_2C(bool,bool),ap(c_2Ewords_2Eword__msb(A_27a),V3r)),ap(ap(c_2Epair_2E_2C(bool,bool),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V3r),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0))),ap(ap(c_2Epair_2E_2C(bool,bool),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebit_2EBIT,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V2q)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V1b),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ewords_2Eword__msb(A_27a),V0a)),ap(c_2Ewords_2Eword__msb(A_27a),V1b)))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ewords_2Eword__msb(A_27a),V3r)),ap(c_2Ewords_2Eword__msb(A_27a),V0a))))))) ) ) ) ) )).

fof(lamtp_f2192,axiom,(
    ! [A_27a,V0a] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
...
fof(lameq_f2192,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2q] :
              ( mem(V2q,ty_2Enum_2Enum)
             => ap(f2192(A_27a,V0a,V1b),V2q) = ap(ap(c_2Ebool_2ELET(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),f2193(A_27a,A_27a,V0a,V1b,V2q)),ap(c_2Ewords_2En2w(A_27a),V2q)) ) ) ) )).
...
fof(ax_thm_2Ewords_2Enzcv__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0a] :
         ...
         => ! [V1b] :
              ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2192(A_27a,V0a,V1b)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ewords_2Ew2n(A_27a),V0a)),ap(c_2Ewords_2Ew2n(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V1b)))) ) ) ) )).

fof(lamtp_f2208,axiom,(
    mem(f2208,arr(bool,arr(bool,bool))) )).

fof(lameq_f2208,axiom,(
    ! [V4c] :
      ( mem(V4c,bool)
     => ap(f2208,V4c) = k(bool,ap(c_2Ebool_2E_7E,V4c)) ) )).
     ...
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ( p(ap(ap(c_2Ewords_2Eword__lo(A_27a),V0a),V1b))
              <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2208)))))),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) ) )).
...
fof(lamtp_f2311,axiom,(
    ! [V1x] :
      ( mem(V1x,ty_2Enum_2Enum)
     => mem(f2311(V1x),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2311,axiom,(
    ! [V1x] :
     ...
     => ! [V4i] :
         ...
         => ap(f2311(V1x),V4i) = ap(ap(c_2Ebit_2EBIT,V4i),V1x) ) ) )).

fof(lamtp_f2312,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Enum_2Enum)
     => mem(f2312(V2y),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2312,axiom,(
    ! [V2y] :
     ...
     => ! [V5i] :
         ...
         => ap(f2312(V2y),V5i) = ap(ap(c_2Ebit_2EBIT,V5i),V2y) ) ) )).

fof(conj_thm_2Eblast_2EBCARRY__LEM,lemma,(
    ! [V0i] :
         ...
         => ! [V2y] :
             ...
             => ! [V3c] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0i))
                   => ( p(ap(ap(ap(ap(c_2Eblast_2EBCARRY,V0i),f2311(V1x)),f2312(V2y)),V3c))
...
fof(conj_thm_2Eblast_2EBCARRY__EQ,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1c] :
          ( mem(V1c,bool)
...
fof(conj_thm_2Eblast_2EBITWISE__LO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
         ...
         => ! [V1y] :
             ...
             => ( p(ap(ap(c_2Ewords_2Eword__lo(A_27a),V0x),V1y))
              <=> ~ p(ap(ap(ap(ap(c_2Eblast_2EBCARRY,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),ap(c_2Efcp_2Efcp__index(bool,bool),V1y))),c_2Ebool_2ET)) ) ) ) ) )).
