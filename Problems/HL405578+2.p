...
fof(lamtp_f2152,axiom,(
    ! [A_27a,V0a] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => mem(f2152(A_27a,V0a),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) ) )).
...
fof(lameq_f2152,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ap(f2152(A_27a,V0a),V1b) = ap(ap(c_2Eordinal_2Eordlt(A_27a),V0a),V1b) ) ) )).
...
fof(ax_thm_2Eordinal_2EordSUC__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
         => ap(c_2Eordinal_2EordSUC(A_27a),V0a) = ap(c_2Eordinal_2Eoleast(A_27a),f2152(A_27a,V0a)) ) ) )).

fof(conj_thm_2Eordinal_2Eno__maximal__ordinal,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(conj_thm_2Eordinal_2Eordlt__SUC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
