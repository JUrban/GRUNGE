...
tff(conj_thm_2Ereal__topology_2ECLOSED__EMPTY,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECLOSED__CONNECTED__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Ereal__topology_2EClosed,V0s))
         => p(ap(c_2Ereal__topology_2EClosed,ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)))) ) ) )).
