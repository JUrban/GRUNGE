...
fof(conj_thm_2Erich__list_2ELENGTH__REPLICATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1x] :
              ( mem(V1x,A_27a)
             => ap(c_2Elist_2ELENGTH(A_27a),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V0n),V1x)) = V0n ) ) ) )).
...
fof(conj_thm_2Erich__list_2EEL__REPLICATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n1] :
         ...
         => ! [V1n2] :
             ...
             => ! [V2x] :
                  ( mem(V2x,A_27a)
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n1),V1n2))
                   => ap(ap(c_2Elist_2EEL(A_27a),V0n1),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V1n2),V2x)) = V2x ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EDROP__REPLICATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ! [V2a] :
                  ( mem(V2a,A_27a)
                 => ap(ap(c_2Elist_2EDROP(A_27a),V0n),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V1m),V2a)) = ap(ap(c_2Erich__list_2EREPLICATE(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1m),V0n)),V2a) ) ) ) ) )).
