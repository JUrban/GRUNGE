...
tff(conj_thm_2Ereal__topology_2ECONNECTED__UNIV,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__UNIV,conjecture,(
    ap(c_2Ereal__topology_2Ecomponents,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)) = ap(ap(c_2Epred__set_2EINSERT(arr(ty_2Erealax_2Ereal,bool)),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)),c_2Epred__set_2EEMPTY(arr(ty_2Erealax_2Ereal,bool))) )).
