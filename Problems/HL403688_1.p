...
tff(thm_2Esorting_2EPERM__APPEND,axiom,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V0l1_2E0),s(tyop_2Elist_2Elist(A_27a),V1l2_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V1l2_2E0),s(tyop_2Elist_2Elist(A_27a),V0l1_2E0))))))) )).

tff(thm_2Esorting_2EPERM__APPEND__IFF,axiom,(
    ! [A_27a: d] :
      ( ! [V0l_2E0: u,V1l1_2E0: u,V2l2_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Elist_2Elist(A_27a),V1l1_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V0l_2E0),s(tyop_2Elist_2Elist(A_27a),V2l2_2E0)))))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),V1l1_2E0),s(tyop_2Elist_2Elist(A_27a),V2l2_2E0))))
      & ! [V3l_2E0: u,V4l1_2E0: u,V5l2_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V4l1_2E0),s(tyop_2Elist_2Elist(A_27a),V3l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V5l2_2E0),s(tyop_2Elist_2Elist(A_27a),V3l_2E0)))))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),V4l1_2E0),s(tyop_2Elist_2Elist(A_27a),V5l2_2E0)))) ) )).

tff(thm_2Esorting_2EPERM__lifts__transitive__relations,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1Q_2E0: u] :
      ( ( ! [V2x1_2E0: u,V3x2_2E0: u,V4x3_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),V1Q_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27b),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V2x1_2E0),s(tyop_2Elist_2Elist(A_27a),V3x2_2E0))),s(tyop_2Elist_2Elist(A_27a),V4x3_2E0))))))),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27b),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V2x1_2E0),s(tyop_2Elist_2Elist(A_27a),V4x3_2E0))),s(tyop_2Elist_2Elist(A_27a),V3x2_2E0)))))))))
        & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2Etransitive_2E1(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),V1Q_2E0))))) )
     => ! [V5x_2E0: u,V6y_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),V5x_2E0),s(tyop_2Elist_2Elist(A_27a),V6y_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),V1Q_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27b),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),V5x_2E0))))),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),A_27b),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),V6y_2E0))))))) ) ) )).

tff(thm_2Esorting_2EPERM__lifts__monotonicities,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
     ...
     => ! [V7x_2E0: u,V8y_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27a),V7x_2E0),s(tyop_2Elist_2Elist(A_27a),V8y_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esorting_2EPERM_2E2(s(tyop_2Elist_2Elist(A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27b)),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),V7x_2E0))),s(tyop_2Elist_2Elist(A_27b),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27b)),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),V8y_2E0))))))) ) ) )).
