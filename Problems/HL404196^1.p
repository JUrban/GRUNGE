...
thf(thm_2Epath_2Eel__pgenerate,axiom,(
    ! [A_27a: d,A_27b: d,V0n: mono_2Etyop_2Enum_2Enum,V1f_2E0: u,V2g_2E0: u] :
      ( ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epgenerate_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V2g_2E0 ) ) ) ) )
...
thf(thm_2Epath_2Enth__label__pgenerate,axiom,(
    ! [A_27a: d,A_27b: d,V0n: mono_2Etyop_2Enum_2Enum,V1f_2E0: u,V2g_2E0: u] :
      ( ( s @ A_27b @ ( c_2Epath_2Enth__label_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epgenerate_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V2g_2E0 ) ) ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V2g_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) ) )).
...
thf(thm_2Epath_2Epgenerate__11,conjecture,(
    ! [A_27a: d,A_27b: d,V0f1_2E0: u,V1g1_2E0: u,V2f2_2E0: u,V3g2_2E0: u] :
      ( ( ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epgenerate_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V1g1_2E0 ) ) )
        = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epgenerate_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V3g2_2E0 ) ) ) )
    <=> ( ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0f1_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f2_2E0 ) )
        & ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V1g1_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27b ) @ V3g2_2E0 ) ) ) ) )).
