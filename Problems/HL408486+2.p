...
fof(mem_c_2Enumeral_2EiSQR,axiom,(
...
fof(ax_thm_2Enumeral_2EiSQR,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ap(c_2Enumeral_2EiSQR,V0x) = ap(ap(c_2Earithmetic_2E_2A,V0x),V0x) ) )).

fof(conj_thm_2Enumeral_2Enumeral__exp,lemma,
    ( ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
       => ap(ap(c_2Earithmetic_2EEXP,V0n),c_2Earithmetic_2EZERO) = ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO) )
    & ! [V1n] :
        ( mem(V1n,ty_2Enum_2Enum)
       => ! [V2m] :
            ( mem(V2m,ty_2Enum_2Enum)
           => ap(ap(c_2Earithmetic_2EEXP,V1n),ap(c_2Earithmetic_2EBIT1,V2m)) = ap(ap(c_2Earithmetic_2E_2A,V1n),ap(c_2Enumeral_2EiSQR,ap(ap(c_2Earithmetic_2EEXP,V1n),V2m))) ) )
    & ! [V3n] :
        ( mem(V3n,ty_2Enum_2Enum)
       => ! [V4m] :
            ( mem(V4m,ty_2Enum_2Enum)
           => ap(ap(c_2Earithmetic_2EEXP,V3n),ap(c_2Earithmetic_2EBIT2,V4m)) = ap(ap(c_2Earithmetic_2E_2A,ap(c_2Enumeral_2EiSQR,V3n)),ap(c_2Enumeral_2EiSQR,ap(ap(c_2Earithmetic_2EEXP,V3n),V4m))) ) ) )).
...
fof(conj_thm_2Ebinary__ieee_2Esign__not__zero,conjecture,(
    ! [V0s] :
