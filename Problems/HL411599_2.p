...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__SUBSET__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE__EQ,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__IMAGE__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
           => ap(c_2Ereal__topology_2Eclosure,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eclosure,V1s))) = ap(c_2Ereal__topology_2Eclosure,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MAP__CLOSURES,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal)))
      <=> ! [V1s: $i] :
            ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
