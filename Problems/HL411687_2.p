...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__RANGE__CONSTANT,conjecture,(
    ! [V0t: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Econnected,V2s))
                  ...
                  & ! [V3y: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ap(ap(c_2Ereal__topology_2Econnected__component,V0t),inj__ty_2Erealax_2Ereal(V3y)) = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) )
               => ? [V4a: tp__ty_2Erealax_2Ereal] :
                  ! [V5x: tp__ty_2Erealax_2Ereal] :
