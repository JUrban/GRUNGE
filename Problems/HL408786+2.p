...
fof(conj_thm_2EHolSmt_2Er165,conjecture,(
    ! [V0u] :
     ...
     => ! [V1x] :
         ...
         => ! [V2a] :
             ...
             => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)),ap(c_2Erealax_2Ereal__neg,V2a)))
              <=> p(ap(ap(c_2Ereal_2Ereal__ge,ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x)),V2a)) ) ) ) ) )).
