...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__HAPPENS,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__AND,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1p: $i] :
          ( mem(V1p,arr(A_27a,bool))
...
tff(ax_thm_2Ereal__topology_2Econtinuous__on,axiom,(
    ! [V0f: $i] :
               ...
               => ! [V3e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ? [V4d: tp__ty_2Erealax_2Ereal] :
                        ...
                        & ! [V5x_27: tp__ty_2Erealax_2Ereal] :
                            ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x_27)),V1s))
                              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x_27)),inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V4d))) )
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V5x_27))),ap(V0f,inj__ty_2Erealax_2Ereal(V2x))))),inj__ty_2Erealax_2Ereal(V3e))) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EABS__TRIANGLE__LE,lemma,(
    ! [V0e: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1x))),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V2y)))),inj__ty_2Erealax_2Ereal(V0e)))
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y)))),inj__ty_2Erealax_2Ereal(V0e))) ) )).

tff(lmtp_f3936,type,(
    f3936: ( del * $i * $i ) > $i )).

tff(lamtp_f3936,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V3s: $i] :
          ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3936(A_27a,V1f,V3s),arr(A_27a,bool)) ) ) )).

tff(lameq_f3936,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V3s: $i] :
          ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4n: $i] :
              ( mem(V4n,A_27a)
             => ap(f3936(A_27a,V1f,V3s),V4n) = ap(ap(c_2Ereal__topology_2Econtinuous__on,ap(V1f,V4n)),V3s) ) ) ) )).

tff(lmtp_f3938,type,(
    f3938: ( del * tp__ty_2Erealax_2Ereal * $i * $i * $i * $i ) > $i )).

tff(lamtp_f3938,axiom,(
    ! [A_27a: del,V5e: tp__ty_2Erealax_2Ereal,V6n: $i] :
      ( mem(V6n,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                  ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
                 => mem(f3938(A_27a,V5e,V6n,V1f,V2g,V3s),arr(ty_2Erealax_2Ereal,bool)) ) ) ) ) )).

tff(lameq_f3938,axiom,(
    ! [A_27a: del,V5e: tp__ty_2Erealax_2Ereal,V6n: $i] :
      ( mem(V6n,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                  ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
                 => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f3938(A_27a,V5e,V6n,V1f,V2g,V3s),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V3s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V1f,V6n),inj__ty_2Erealax_2Ereal(V7x))),ap(V2g,inj__ty_2Erealax_2Ereal(V7x))))),inj__ty_2Erealax_2Ereal(V5e))) ) ) ) ) )).

tff(lmtp_f3937,type,(
    f3937: ( del * $i * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3937,axiom,(
    ! [A_27a: del,V3s: $i] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1f: $i] :
              ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
             => ! [V5e: tp__ty_2Erealax_2Ereal] : mem(f3937(A_27a,V3s,V2g,V1f,V5e),arr(A_27a,bool)) ) ) ) )).

tff(lameq_f3937,axiom,(
    ! [A_27a: del,V3s: $i] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1f: $i] :
              ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
             => ! [V5e: tp__ty_2Erealax_2Ereal,V6n: $i] :
                  ( mem(V6n,A_27a)
                 => ap(f3937(A_27a,V3s,V2g,V1f,V5e),V6n) = ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f3938(A_27a,V5e,V6n,V1f,V2g,V3s)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__UNIFORM__LIMIT,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                  ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
                 => ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                      & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3936(A_27a,V1f,V3s)),V0net))
                      & ! [V5e: tp__ty_2Erealax_2Ereal] :
                         ...
                         => p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3937(A_27a,V3s,V2g,V1f,V5e)),V0net)) ) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V2g),V3s)) ) ) ) ) ) )).
