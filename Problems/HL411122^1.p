    ...
    ! [V0P: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ! [V1m: mono_2Etyop_2Enum_2Enum] :
        ...
        & ! [V4m: mono_2Etyop_2Enum_2Enum,V5n: mono_2Etyop_2Enum_2Enum] :
           ...
           => ( V0P @ V4m @ V5n ) ) )
     => ! [V6m: mono_2Etyop_2Enum_2Enum,V7y: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V6m @ V7y ) ) )).
...
thf(thm_2Ereal__topology_2EUNIFORMLY__CONVERGENT__EQ__CAUCHY__ALT,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1s_2E0: u] :
      ( ? [V2l_2E0: u] :
        ! [V3e: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V3e )
    ...
    <=> ! [V7e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V8N: mono_2Etyop_2Enum_2Enum] :
            ! [V9m: mono_2Etyop_2Enum_2Enum,V10n: mono_2Etyop_2Enum_2Enum,V11x_2E0: u] :
              ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V8N @ V9m )
                & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V8N @ V10n )
                & ( mono_2Ec_2Eprim__rec_2E_3C @ V9m @ V10n )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V11x_2E0 ) ) ) ) )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9m ) ) ) ) @ ( s @ A_27a @ V11x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V10n ) ) ) ) @ ( s @ A_27a @ V11x_2E0 ) ) ) ) ) ) @ V7e ) ) ) ) )).
