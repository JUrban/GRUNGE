...
tff(conj_thm_2Ebool_2ERES__FORALL__CONG,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
...
tff(conj_thm_2Eres__quan_2ERES__EXISTS__NULL,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m: tp__o] :
...
tff(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__NULL,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1m: tp__o] :
