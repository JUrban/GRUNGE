     ...
     => ! [V1w: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__xnor @ A_27a ) @ V0v ) @ V1w )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0v ) @ V2i ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ V2i ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Eword__xnor__n2w,conjecture,(
