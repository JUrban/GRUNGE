    ...
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o,V3c: tyop_2Erealax_2Ereal > $o] :
      ( ( ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s )
        ...
        & ! [V6y: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6y @ V2t )
           => ( c_2Ereal__topology_2Econnected
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V7x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V7x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V1s ) @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V0f @ V7x ) @ V6y ) ) ) ) ) )
        & ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2t ) @ V3c )
          | ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2t ) @ V3c ) )
        & ( c_2Ereal__topology_2Econnected @ V3c ) )
     => ( c_2Ereal__topology_2Econnected
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V8x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V8x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ V1s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V8x ) @ V3c ) ) ) ) ) ) )).
