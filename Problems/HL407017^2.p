...
thf(conj_thm_2Earithmetic_2ELT__MULT__LCANCEL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Einteger__word_2Ei2w__INT__MAX,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ ( c_2Einteger__word_2EINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
...
thf(conj_thm_2Ewords_2EWORD__NOT__LOWER__EQUAL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EZERO__LO__INT__MIN,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lo @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__MSB__INT__MIN__LS,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0a ) )
      <=> ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) @ V0a ) ) ) ) )).

thf(conj_thm_2Ewords_2Eword__msb__neg,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2Eword__ls__n2w,lemma,(
...
thf(conj_thm_2Einteger__word_2Esigned__saturate__add,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Einteger__word_2Esigned__saturate__add @ A_27a ) @ V0a ) @ V1b )
            = ( ap
              @ ( ap @ ( c_2Ebool_2ELET @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
                @ ( ap
                  @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) @ ( arr @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) )
                    @ ( lam @ ( ty_2Efcp_2Ecart @ bool @ A_27a )
                      @ ^ [V2sum: $i] :
                          ( lam @ bool
                          @ ^ [V3msba: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ V3msba ) @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V1b ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ V3msba ) @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V2sum ) ) ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ V3msba ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) @ ( c_2Ewords_2Eword__H @ A_27a ) ) ) @ V2sum ) ) ) )
                  @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0a ) @ V1b ) ) )
              @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0a ) ) ) ) ) )).
