...
thf(conj_thm_2Earithmetic_2ESUB__LEFT__SUB,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(ax_thm_2Ebitstring_2Etestbit__def,axiom,(
    ...
    <=> ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Efield @ ( inj__ty_2Enum_2Enum @ V0b ) ) @ ( inj__ty_2Enum_2Enum @ V0b ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V1v ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( c_2Elist_2ENIL @ bool ) ) ) ) ) )).
...
thf(conj_thm_2Elist_2ENULL__EQ,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Elist_2ENULL__LENGTH,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l ) )
      <=> ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) )
...
thf(conj_thm_2Elist_2EGENLIST__AUX__compute,lemma,(
    ! [A_27a: del] :
      ( ! [V0f: $i] :
...
thf(conj_thm_2Erich__list_2ELASTN__1,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( V0l
         != ( c_2Elist_2ENIL @ A_27a ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ V0l )
          = ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ ( ap @ ( c_2Elist_2ELAST @ A_27a ) @ V0l ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Eword__bit__last__shiftr,conjecture,(
          ...
          @ ( ap
            @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ bool ) @ bool )
              @ ( lam @ ( ty_2Elist_2Elist @ bool )
                @ ^ [V2l: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( c_2Elist_2ENULL @ bool ) @ V2l ) ) ) @ ( ap @ ( c_2Elist_2ELAST @ bool ) @ V2l ) ) ) )
