...
thf(arityeq3_2Emono_2Ec_2Epair_2E_23_23_2E3_2Emono_2EA_27c_20mono_2EA_27d_20mono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_23_23_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ X1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) ) @ c_2Epair_2E_23_23_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ X2_2E0 ) ) ) ) )).
...
thf(thm_2Equotient__pair_2EFST__PRS,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6p_2E0: u] :
              ( ( s @ A_27c @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ V6p_2E0 ) ) )
              = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1abs1_2E0 ) @ ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_23_23_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2rep1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V5rep2_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27d ) @ V6p_2E0 ) ) ) ) ) ) ) ) ) ) )).
