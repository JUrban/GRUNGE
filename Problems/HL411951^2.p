...
thf(conj_thm_2Ereal__topology_2EOPEN__IN__DELETE,lemma,(
    ! [V0u: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__IN,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__DELETE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
