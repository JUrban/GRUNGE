...
thf(conj_thm_2Elist_2EMEM__REVERSE,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Elist_2ELAST__REVERSE,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
thf(conj_thm_2Elist_2EdropWhile__eq__nil,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ls: $i] :
...
thf(conj_thm_2Elist_2EMEM__dropWhile__IMP,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ls: $i] :
          ( ( mem @ V1ls @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Elist_2EHD__dropWhile,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ls: $i] :
          ( ( mem @ V1ls @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Enumposrep_2ELOG__l2n,lemma,(
...
thf(conj_thm_2Enumposrep_2El2n__dropWhile__0,lemma,(
...
thf(conj_thm_2Enumposrep_2ELOG__l2n__dropWhile,conjecture,(
        ...
        & ( p
          @ ( ap
            @ ( ap @ ( c_2Elist_2EEXISTS @ ty_2Enum_2Enum )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2y: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V2y ) ) ) )
