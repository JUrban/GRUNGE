...
fof(conj_thm_2EreaderMonad_2EFMAP__ID,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0M] :
             ...
             => ( ap(ap(c_2EreaderMonad_2EFMAP(A_27b,A_27b,A_27b),i(A_27b)),V0M) = V0M
                & ap(ap(c_2EreaderMonad_2EFMAP(A_27b,A_27b,A_27b),c_2Ecombin_2EI(A_27b)),V0M) = V0M ) ) ) ) )).
