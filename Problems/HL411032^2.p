...
thf(conj_thm_2Ereal_2EREAL__MIN__LT,lemma,(
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__HAS__INF,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EINF__INSERT,conjecture,(
