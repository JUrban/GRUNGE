...
thf(conj_thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EINJECTIVE__IMP__ISOMETRIC,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__IMAGE__SUBSPACE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
