...
fof(conj_thm_2Epred__set_2EINJ__LINV__OPT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(ax_thm_2Epred__set_2ELINV__LO,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2y] :
                      ( mem(V2y,A_27b)
                     => ap(ap(ap(c_2Epred__set_2ELINV(A_27a,A_27a),V0f),V1s),V2y) = ap(c_2Eoption_2ETHE(A_27a),ap(ap(ap(c_2Epred__set_2ELINV__OPT(A_27a,A_27a),V0f),V1s),V2y)) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2ELINV__DEF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
