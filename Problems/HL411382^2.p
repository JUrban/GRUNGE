...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EMPTY,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) )
      = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )).
