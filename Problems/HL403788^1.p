...
thf(f4112_0_2E0,type,(
    f4112_0_2E0: u )).

thf(f4112_0_2E1,type,(
    f4112_0_2E1: du > u )).
...
thf(mono_2Ef4112_0,type,(
    mono_2Ef4112_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ellist_2Elrep__ok__coind,axiom,(
    ! [V5x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4112_0 @ V5x )
    <=> ( V5x = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Ellist_2Elrep__ok__coind,conjecture,(
    ! [A_27a: d,V0lrep__ok_27_2E0: u] :
      ( ! [V1a0_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V0lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V1a0_2E0 ) ) ) )
         => ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
                ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V1a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) ) )
                = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
            | ? [V3h_2E0: u,V4t_2E0: u] :
                ( ! [V5x: mono_2Etyop_2Enum_2Enum] :
                    ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V1a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5x ) ) ) )
                    = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4112_0 @ V5x ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V4t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V5x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V0lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V4t_2E0 ) ) ) ) ) ) )
     => ! [V6a0_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ tyop_2Emin_2Ebool ) @ V0lrep__ok_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V6a0_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V6a0_2E0 ) ) ) ) ) ) )).
