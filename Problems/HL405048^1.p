    ...
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ...
      <=> ? [V3q: mono_2Etyop_2Enum_2Enum > $o] :
            ...
            & ! [V4t: mono_2Etyop_2Enum_2Enum] :
                ( ( V3q @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
              <=> ( ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) )
                  | ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
      ...
      & ( ? [V7t: mono_2Etyop_2Enum_2Enum] :
            ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) )
      <=> ? [V8q: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V8q @ V0t0 ) )
            & ! [V9t: mono_2Etyop_2Enum_2Enum] :
                ( ( V8q @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) )
              <=> ( ( V8q @ ( mono_2Ec_2Earithmetic_2E_2B @ V9t @ V0t0 ) )
                  | ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) ) )
            & ! [V10t1: mono_2Etyop_2Enum_2Enum] :
              ? [V11t2: mono_2Etyop_2Enum_2Enum] :
                ( V8q @ ( mono_2Ec_2Earithmetic_2E_2B @ V10t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t2 @ V0t0 ) ) ) ) ) ) )).
