...
thf(thm_2Ereal__topology_2ECOMPACT__ATTAINS__INF,axiom,(
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__INF,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Ecompact @ V1s )
     ...
     => ? [V2x: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V3y: mono_2Etyop_2Erealax_2Ereal] :
             ...
             => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V2x ) @ ( V0f @ V3y ) ) ) ) ) )).
