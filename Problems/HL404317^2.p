...
thf(ax_thm_2Ering_2Ering__R0,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1a0: $i] :
          ( ( mem @ V1a0 @ A_27a )
...
thf(ax_thm_2Ering_2Ering__R1,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1a0: $i] :
          ( ( mem @ V1a0 @ A_27a )
         => ! [V2f: $i] :
             ...
             => ! [V3f0: $i] :
                 ...
                 => ! [V4f1: $i] :
                      ( ( mem @ V4f1 @ ( arr @ A_27a @ A_27a ) )
                     => ( ( ap @ ( c_2Ering_2Ering__R1 @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Erecordtype_2Ering @ A_27a ) @ V0a ) @ V1a0 ) @ V2f ) @ V3f0 ) @ V4f1 ) )
                        = V1a0 ) ) ) ) ) ) )).

thf(ax_thm_2Ering_2Ering__RP,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1a0: $i] :
          ( ( mem @ V1a0 @ A_27a )
         => ! [V2f: $i] :
             ...
             => ! [V3f0: $i] :
                 ...
                 => ! [V4f1: $i] :
                      ( ( mem @ V4f1 @ ( arr @ A_27a @ A_27a ) )
                     => ( ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Erecordtype_2Ering @ A_27a ) @ V0a ) @ V1a0 ) @ V2f ) @ V3f0 ) @ V4f1 ) )
                        = V2f ) ) ) ) ) ) )).

thf(ax_thm_2Ering_2Ering__RM,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1a0: $i] :
          ( ( mem @ V1a0 @ A_27a )
         => ! [V2f: $i] :
             ...
             => ! [V3f0: $i] :
                 ...
                 => ! [V4f1: $i] :
                      ( ( mem @ V4f1 @ ( arr @ A_27a @ A_27a ) )
                     => ( ( ap @ ( c_2Ering_2Ering__RM @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Erecordtype_2Ering @ A_27a ) @ V0a ) @ V1a0 ) @ V2f ) @ V3f0 ) @ V4f1 ) )
                        = V3f0 ) ) ) ) ) ) )).

thf(ax_thm_2Ering_2Ering__RN,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1a0: $i] :
          ( ( mem @ V1a0 @ A_27a )
         => ! [V2f: $i] :
             ...
             => ! [V3f0: $i] :
                 ...
                 => ! [V4f1: $i] :
                      ( ( mem @ V4f1 @ ( arr @ A_27a @ A_27a ) )
                     => ( ( ap @ ( c_2Ering_2Ering__RN @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Erecordtype_2Ering @ A_27a ) @ V0a ) @ V1a0 ) @ V2f ) @ V3f0 ) @ V4f1 ) )
                        = V4f1 ) ) ) ) ) ) )).

thf(conj_thm_2Ering_2Ering__accessors,conjecture,(
    ! [A_27a: del] :
      ( ! [V0a: $i] :
          ( ( mem @ V0a @ A_27a )
         => ! [V1a0: $i] :
