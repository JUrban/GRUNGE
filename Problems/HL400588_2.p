...
tff(lamtp_f138,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),bool))
     => mem(f138(A_27c,A_27b,A_27a,V0P),arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),bool)) ) )).

tff(lameq_f138,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))
         => ap(f138(A_27c,A_27b,A_27a,V0P),V1f) = ap(V0P,V1f) ) ) )).

tff(lmtp_f140,type,(
    f140: ( del * del * del * $i ) > $i )).

tff(lamtp_f140,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V2p: $i] :
      ( mem(V2p,ty_2Epair_2Eprod(arr(A_27a,A_27b),arr(A_27a,A_27b)))
     => mem(f140(A_27b,A_27c,A_27a,V2p),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))) ) )).
...
tff(lameq_f140,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V2p: $i] :
     ...
     => ! [V3a: $i] :
          ( mem(V3a,A_27a)
         => ap(f140(A_27b,A_27c,A_27a,V2p),V3a) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),ap(ap(c_2Epair_2EFST(arr(A_27a,A_27b),arr(A_27a,A_27b)),V2p),V3a)),ap(ap(c_2Epair_2ESND(arr(A_27a,A_27b),arr(A_27a,A_27b)),V2p),V3a)) ) ) )).

tff(lmtp_f139,type,(
    f139: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f139,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),bool))
     => mem(f139(A_27a,A_27b,A_27c,A_27a,V0P),arr(ty_2Epair_2Eprod(arr(A_27a,A_27b),arr(A_27a,A_27b)),bool)) ) )).
...
tff(lameq_f139,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27a: del,V0P: $i] :
     ...
     => ! [V2p: $i] :
          ( mem(V2p,ty_2Epair_2Eprod(arr(A_27a,A_27b),arr(A_27a,A_27b)))
         => ap(f139(A_27a,A_27b,A_27c,A_27a,V0P),V2p) = ap(V0P,f140(A_27b,A_27c,A_27a,V2p)) ) ) )).

tff(conj_thm_2Epair_2EPAIR__FUN__THM,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),bool))
     => ( p(ap(c_2Ebool_2E_3F_21(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))),f138(A_27c,A_27b,A_27a,V0P)))
      <=> p(ap(c_2Ebool_2E_3F_21(ty_2Epair_2Eprod(arr(A_27a,A_27b),arr(A_27a,A_27b))),f139(A_27a,A_27b,A_27c,A_27a,V0P))) ) ) )).
