...
thf(conj_thm_2Eiterate_2ESUM__DIFFS,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3k: $i] :
                    ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V3k ) ) @ ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3k ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )
...
thf(conj_thm_2Eiterate_2ESUM__DIFFS__ALT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal
