...
thf(conj_thm_2Epred__set_2EKoenigsLemma,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ! [V1x: $i] :
            ( ( mem @ V1x @ A_27a )
           => ( p
              @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2y: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V2y ) @ ( ap @ ( ap @ V0R @ V1x ) @ V2y ) ) ) ) ) ) )
       => ! [V3x: $i] :
            ( ( mem @ V3x @ A_27a )
           => ( ~ ( p
                  @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V4y: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V4y ) @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ERTC @ A_27a ) @ V0R ) @ V3x ) @ V4y ) ) ) ) ) )
             => ? [V5f: $i] :
                  ( ( mem @ V5f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
                  & ( ( ap @ V5f @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) )
                    = V3x )
                  & ! [V6n: tp__ty_2Enum_2Enum] :
                      ( p @ ( ap @ ( ap @ V0R @ ( ap @ V5f @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) @ ( ap @ V5f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) ) ) ) ) ) ) )).
