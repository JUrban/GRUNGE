          ...
          @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
            @ ( lam @ A_27a
              @ ^ [V1x1: $i] :
                  ( lam @ A_27a
                  @ ^ [V2x2: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V1x1 ) @ V2x2 ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V1x1 ) @ V0xs ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x2 ) @ V0xs ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Euniv__reln__to__rel__conv,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
