...
thf(arityeq3_2Emono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Esum_2Esum_28A_27c_2CA_27d_29,axiom,(
    ! [A_27c: d,A_27d: d,X0: $o,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ X1_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) ) ) ) @ c_2Ebool_2ECOND_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ X2_2E0 ) ) ) ) )).
...
thf(thm_2Esum_2ESUM__MAP,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0f_2E0: u,V1g_2E0: u,V2z_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27c @ A_27d ) @ ( c_2Esum_2E_2B_2B_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V1g_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2z_2E0 ) ) )
