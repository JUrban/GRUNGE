...
fof(conj_thm_2Eiterate_2ENSUM__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Eiterate_2ENSUM__IMAGE__GEN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2s] :
                      ( mem(V2s,arr(A_27a,bool))
                     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                       => ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V1g) = ap(ap(c_2Eiterate_2Ensum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),f3329(A_27a,A_27b,V0f,V2s,V1g)) ) ) ) ) ) ) )).
