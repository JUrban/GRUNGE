...
thf(conj_thm_2Ereal_2EREAL__SUP__LE,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Ereal_2EREAL__SUP__EXISTS__UNIQUE,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ? [V1x: tp__ty_2Erealax_2Ereal] :
              ( p @ ( ap @ V0p @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
                    ...
                    @ ^ [V5y: $i] :
                        ...
                        @ ( ap @ ( c_2Emin_2E_3D @ bool )
                          @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Erealax_2Ereal )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V6x: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0p @ V6x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V5y ) @ V6x ) ) ) ) )
                        @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V5y ) @ V4s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__SUP__MAX,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
