    ...
    ! [V0t0: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum > $o] :
      ( ( ? [V2t1: tyop_2Enum_2Enum] :
          ! [V3t2: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V2t1 @ ( c_2Earithmetic_2E_2B @ V3t2 @ V0t0 ) ) )
      <=> ? [V4q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V4q @ V0t0 ) )
            & ! [V5t: tyop_2Enum_2Enum] :
                ( ( V4q @ ( c_2Earithmetic_2E_2B @ V5t @ V0t0 ) )
               => ( ( V1a @ ( c_2Earithmetic_2E_2B @ V5t @ V0t0 ) )
                  & ( V4q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V5t @ V0t0 ) ) ) ) )
            & ? [V6t: tyop_2Enum_2Enum] :
                ( V4q @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) ) )
      & ( ? [V7t1: tyop_2Enum_2Enum] :
          ! [V8t2: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V7t1 @ ( c_2Earithmetic_2E_2B @ V8t2 @ V0t0 ) ) )
      <=> ? [V9p: tyop_2Enum_2Enum > $o,V10q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V9p @ V0t0 ) )
            & ( (~) @ ( V10q @ V0t0 ) )
            & ! [V11t: tyop_2Enum_2Enum] :
                ( ( ( V9p @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                 => ( V9p @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) )
                & ( ( V9p @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                 => ( ( V9p @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                    | ( (~) @ ( V10q @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) ) )
                & ( ( V10q @ ( c_2Enum_2ESUC @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                <=> ( ( ( V9p @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                      & ( (~) @ ( V10q @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) )
                      & ( (~) @ ( V1a @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) )
                    | ( ( V9p @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) )
                      & ( V10q @ ( c_2Earithmetic_2E_2B @ V11t @ V0t0 ) ) ) ) ) )
            & ! [V12t1: tyop_2Enum_2Enum] :
              ? [V13t2: tyop_2Enum_2Enum] :
                ( ( V9p @ ( c_2Earithmetic_2E_2B @ V12t1 @ ( c_2Earithmetic_2E_2B @ V13t2 @ V0t0 ) ) )
                & ( (~) @ ( V10q @ ( c_2Earithmetic_2E_2B @ V12t1 @ ( c_2Earithmetic_2E_2B @ V13t2 @ V0t0 ) ) ) ) ) ) ) ) )).
