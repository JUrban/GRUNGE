...
tff(c_2Elbtree_2Emem_2E1,type,(
    c_2Elbtree_2Emem_2E1: 
      !>[A_27a: $tType] :
        ( A_27a > tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool) ) )).

tff(c_2Elbtree_2Emem_2E2,type,(
    c_2Elbtree_2Emem_2E2: 
      !>[A_27a: $tType] :
        ( ( A_27a * tyop_2Elbtree_2Elbtree(A_27a) ) > tyop_2Emin_2Ebool ) )).
...
tff(thm_2Elist_2EEXISTS__APPEND,axiom,(
    ! [A_27a: $tType,V0P_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1l1_2E0: tyop_2Elist_2Elist(A_27a),V2l2_2E0: tyop_2Elist_2Elist(A_27a)] :
      ( p(c_2Elist_2EEXISTS_2E2(A_27a,V0P_2E0,c_2Elist_2EAPPEND_2E2(A_27a,V1l1_2E0,V2l2_2E0)))
    <=> ( p(c_2Elist_2EEXISTS_2E2(A_27a,V0P_2E0,V1l1_2E0))
        | p(c_2Elist_2EEXISTS_2E2(A_27a,V0P_2E0,V2l2_2E0)) ) ) )).
...
tff(thm_2Ellist_2Eexists__ind,axiom,(
    ! [A_27a: $tType,V0P_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1exists_27_2E0: tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool)] :
      ( ( ! [V2h_2E0: A_27a,V3t_2E0: tyop_2Ellist_2Ellist(A_27a)] :
            ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,V0P_2E0,V2h_2E0))
           => p(app_2E2(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool,V1exists_27_2E0,c_2Ellist_2ELCONS_2E2(A_27a,V2h_2E0,V3t_2E0))) )
        & ! [V4h_2E0: A_27a,V5t_2E0: tyop_2Ellist_2Ellist(A_27a)] :
            ( p(app_2E2(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool,V1exists_27_2E0,V5t_2E0))
           => p(app_2E2(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool,V1exists_27_2E0,c_2Ellist_2ELCONS_2E2(A_27a,V4h_2E0,V5t_2E0))) ) )
     => ! [V6a0_2E0: tyop_2Ellist_2Ellist(A_27a)] :
          ( p(c_2Ellist_2Eexists_2E2(A_27a,V0P_2E0,V6a0_2E0))
         => p(app_2E2(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool,V1exists_27_2E0,V6a0_2E0)) ) ) )).
