...
fof(lamtp_f3497,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Eextreal_2Eextreal)
     => mem(f3497(V0a),arr(ty_2Eextreal_2Eextreal,ty_2Epair_2Eprod(arr(ty_2Eextreal_2Eextreal,bool),arr(ty_2Eextreal_2Eextreal,bool)))) ) )).

fof(lameq_f3497,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Eextreal_2Eextreal)
     => ! [V1b] :
          ( mem(V1b,ty_2Eextreal_2Eextreal)
         => ap(f3497(V0a),V1b) = ap(ap(c_2Epair_2E_2C(arr(ty_2Eextreal_2Eextreal,bool),arr(ty_2Eextreal_2Eextreal,bool)),ap(ap(c_2Eextreal_2Eopen__interval,V0a),V1b)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),V0a),c_2Eextreal_2EQ__set)),ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),V1b),c_2Eextreal_2EQ__set))) ) ) )).

fof(lamtp_f3496,axiom,(
    mem(f3496,arr(ty_2Eextreal_2Eextreal,arr(ty_2Eextreal_2Eextreal,ty_2Epair_2Eprod(arr(ty_2Eextreal_2Eextreal,bool),arr(ty_2Eextreal_2Eextreal,bool))))) )).

fof(lameq_f3496,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Eextreal_2Eextreal)
     => ap(f3496,V0a) = f3497(V0a) ) )).

fof(ax_thm_2Eextreal_2Erational__intervals__def,axiom,(
    c_2Eextreal_2Erational__intervals = ap(c_2Epred__set_2EGSPEC(arr(ty_2Eextreal_2Eextreal,bool),arr(ty_2Eextreal_2Eextreal,bool)),ap(c_2Epair_2EUNCURRY(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal),f3496)) )).

fof(conj_thm_2Eextreal_2ECOUNTABLE__RATIONAL__INTERVALS,conjecture,(
    p(ap(c_2Epred__set_2Ecountable(arr(ty_2Eextreal_2Eextreal,bool)),c_2Eextreal_2Erational__intervals)) )).
