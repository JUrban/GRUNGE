...
thf(thm_2EHolSmt_2Er028,conjecture,(
    ! [A_27a: $tType,V0z: A_27a,V1y: A_27a,V2x: A_27a,V3p: $o] :
      ( ( c_2Ebool_2ECOND @ $o @ V3p @ ( c_2Emin_2E_3D @ A_27a @ V2x @ V1y ) @ ( c_2Emin_2E_3D @ A_27a @ V0z @ V1y ) )
    <=> ( V1y
        = ( c_2Ebool_2ECOND @ A_27a @ V3p @ V2x @ V0z ) ) ) )).
