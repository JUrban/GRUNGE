...
fof(conj_thm_2Ereal__topology_2EOPEN__INTERVAL__LEMMA,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
             ...
             => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,V0a),V2x))
               ...
               => ? [V3d] :
                    ...
                    & ! [V4x_27] :
                       ...
                       => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V4x_27),V2x))),V3d))
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,V0a),V4x_27))
                            & p(ap(ap(c_2Erealax_2Ereal__lt,V4x_27),V1b)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EOPEN__INTERVAL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
