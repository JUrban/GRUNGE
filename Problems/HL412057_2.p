...
tff(conj_thm_2Eextreal_2Eabs__refl,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
      ( surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__abs,inj__ty_2Eextreal_2Eextreal(V0x))) = V0x
...
tff(mem_c_2Elebesgue_2Emeasure__absolutely__continuous,axiom,(
    ! [A_27a: del] : mem(c_2Elebesgue_2Emeasure__absolutely__continuous(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool))) )).
...
tff(conj_thm_2Elebesgue_2Eintegrable__pos,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => ( p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),V1f))
            <=> ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V1f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel)))
                & surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),V1f)) != fo__c_2Eextreal_2EPosInf ) ) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__bounded,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(lamtp_f4200,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f4200(A_27a,V1f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4200,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f4200(A_27a,V1f),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V3x)),inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf))),ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V1f,V3x)) ) ) )).

tff(lmtp_f4201,type,(
    f4201: ( del * $i ) > $i )).

tff(lamtp_f4201,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f4201(A_27a,V1f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4201,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f4201(A_27a,V1f),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V4x)),inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf))),ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V1f,V4x)) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt2,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
              ...
              & ! [V2x: $i] :
                  ( mem(V2x,A_27a)
                 => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V1f,V2x))) ) )
           => ( p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4200(A_27a,V1f)))
              & surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),V1f)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4201(A_27a,V1f))) ) ) ) ) )).

tff(lmtp_f4218,type,(
    f4218: ( del * $i * $i ) > $i )).

tff(lamtp_f4218,axiom,(
    ! [A_27a: del,V2f: $i] :
...
tff(conj_thm_2Elebesgue_2ERadon__Nikodym,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1v: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => ? [V2f: $i] :
                ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
                & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V2f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel)))
                & ! [V3x: $i] :
                    ( mem(V3x,A_27a)
                ...
                & ! [V4A: $i] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V4A),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                     => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4218(A_27a,V2f,V4A))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V1v),V4A))) ) ) ) ) ) ) )).

tff(lmtp_f4223,type,(
    f4223: ( del * $i * $i ) > $i )).

tff(lamtp_f4223,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5A: $i] :
          ( mem(V5A,arr(A_27a,bool))
         => mem(f4223(A_27a,V2f,V5A),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

tff(lameq_f4223,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5A: $i] :
          ( mem(V5A,arr(A_27a,bool))
         => ! [V6x: $i] :
              ( mem(V6x,A_27a)
             => ap(f4223(A_27a,V2f,V5A),V6x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(V2f,V6x)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V5A),V6x)) ) ) ) )).

tff(conj_thm_2Elebesgue_2ERadon__Nikodym2,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1v: $i] :
          ( mem(V1v,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => ? [V2f: $i] :
                ...
                & ! [V4x: $i] :
                    ( mem(V4x,A_27a)
                   => surj__ty_2Eextreal_2Eextreal(ap(V2f,V4x)) != fo__c_2Eextreal_2EPosInf )
                & ! [V5A: $i] :
                    ( mem(V5A,arr(A_27a,bool))
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V5A),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                     => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4223(A_27a,V2f,V5A))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V1v),V5A))) ) ) ) ) ) ) )).
