...
fof(conj_thm_2Epred__set_2EFINITE__DIFF__down,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EINFINITE__INHAB,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2ECARDLEQ__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EPOW__TWO__set__exp,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
         => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Epred__set_2EPOW(A_27a),V0A)),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),ap(c_2Epred__set_2Ecount,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),V0A))) ) ) )).

fof(conj_thm_2Ecardinal_2Eset__exp__card__cong,lemma,(
    ! [A_27a1] :
      ( ne(A_27a1)
     => ! [A_27a2] :
          ( ne(A_27a2)
...
fof(conj_thm_2Ecardinal_2Eset__exp__cardle__cong,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V2a] :
                             ...
                             => ! [V3c] :
                                 ...
                                 => ( ( V0b = c_2Epred__set_2EEMPTY(A_27a)
                                   ...
                                   => ( ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2a),V0b))
                                        & p(ap(ap(c_2Ecardinal_2Ecardleq(A_27d,A_27d),V3c),V1d)) )
                                     => p(ap(ap(c_2Ecardinal_2Ecardleq(arr(A_27d,ty_2Eoption_2Eoption(A_27c)),arr(A_27d,ty_2Eoption_2Eoption(A_27c))),ap(ap(c_2Ecardinal_2Eset__exp(A_27d,A_27d),V2a),V3c)),ap(ap(c_2Ecardinal_2Eset__exp(A_27b,A_27b),V0b),V1d))) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2Ecardlt__cardle,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2Eset__exp__product,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EPOW__EQ__X__EXP__X,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
