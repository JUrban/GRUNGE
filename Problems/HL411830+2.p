...
fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__SET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
...
fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__INTERIOR,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1x)),ap(c_2Ereal__topology_2Einterior,V0s)))
            <=> p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),ap(c_2Ereal__topology_2Einterior,V0s))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__FRONTIER,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),ap(c_2Ereal__topology_2Einterior,V0s))) )
           => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1x)),ap(c_2Ereal__topology_2Efrontier,V0s))) ) ) ) )).
