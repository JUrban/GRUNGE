...
fof(conj_thm_2Erich__list_2ESNOC__FOLDR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
         => ! [V1l] :
             ...
             => ap(ap(c_2Elist_2ESNOC(A_27a),V0x),V1l) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),c_2Elist_2ECONS(A_27a)),ap(ap(c_2Elist_2ECONS(A_27a),V0x),c_2Elist_2ENIL(A_27a))),V1l) ) ) ) )).
