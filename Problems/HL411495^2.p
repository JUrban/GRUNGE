...
thf(conj_thm_2Ereal__topology_2ECLOSED__NEGATIONS,lemma,(
    ! [V0s: $i] :
            ...
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V1x: $i] :
                      ( ap @ c_2Erealax_2Ereal__neg @ V1x ) ) )
              @ V0s ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__SUMS,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__DIFFERENCES,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
