...
thf(thm_2Ereal__topology_2ESEGMENT__TO__CLOSEST__POINT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2EClosed @ V0s )
        & ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )
     => ( ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eopen__segment @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Ereal__topology_2Eclosest__point @ V0s @ V1a ) ) ) @ V0s )
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).
...
thf(thm_2Ereal__topology_2ESEGMENT__TO__POINT__EXISTS,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2EClosed @ V0s )
        & ( (~)
          @ ( V0s
     ...
     => ? [V2b: tyop_2Erealax_2Ereal] :
          ...
          & ( ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eopen__segment @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ V2b ) ) @ V0s )
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) )).
