...
thf(thm_2Ereal__topology_2EHAUSDIST__SETDIST__TRIANGLE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2u: tyop_2Erealax_2Ereal > $o] :
      ( ( ( (~)
        ...
        & ( c_2Ereal__topology_2Ebounded__def @ V1t ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V2u ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V1t @ V2u ) ) ) ) ) )).
