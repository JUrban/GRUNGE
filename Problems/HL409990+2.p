...
fof(mem_c_2Eextreal_2Eextreal__min,axiom,(
...
fof(conj_thm_2Eextreal_2Ele__total,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
...
fof(ax_thm_2Eextreal_2Eextreal__min__def,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ap(ap(c_2Eextreal_2Eextreal__min,V0x),V1y) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Eextreal_2Eextreal__le,V0x),V1y)),V0x),V1y) ) ) )).

fof(conj_thm_2Eextreal_2Emin__le,conjecture,(
    ! [V0z] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ( p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(c_2Eextreal_2Eextreal__min,V1x),V2y)),V0z))
