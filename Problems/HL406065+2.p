...
fof(lamtp_f2198,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ! [V3z] :
          ( mem(V3z,bool)
         => mem(f2198(V2n,V3z),arr(bool,bool)) ) ) )).
...
fof(lameq_f2198,axiom,(
    ! [V2n] :
     ...
     => ! [V3z] :
         ...
         => ! [V5v] :
              ( mem(V5v,bool)
             => ap(f2198(V2n,V3z),V5v) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,V3z)),ap(ap(c_2Emin_2E_3D(bool),V2n),V5v)) ) ) ) )).

fof(lamtp_f2197,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => mem(f2197(V2n),arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) ) )).
...
fof(lameq_f2197,axiom,(
    ! [V2n] :
     ...
     => ! [V3z] :
          ( mem(V3z,bool)
         => ap(f2197(V2n),V3z) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2198(V2n,V3z))) ) ) )).

fof(lamtp_f2196,axiom,(
    mem(f2196,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2196,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ap(f2196,V2n) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2197(V2n)) ) )).
...
fof(conj_thm_2Ewords_2EWORD__GREATER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
