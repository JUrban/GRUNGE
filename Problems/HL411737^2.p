...
thf(conj_thm_2Ereal__topology_2ELINEAR__SUM,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ELIM__LINEAR,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__LINEAR,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1h: $i] :
          ( ( mem @ V1h @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                    ...
                    @ ( ap
                      @ ( ap @ c_2Ereal__topology_2Esums
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V4n: $i] :
                              ( ap @ V1h @ ( ap @ V0f @ V4n ) ) ) )
                      @ ( ap @ V1h @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) )
                    @ V3s ) ) ) ) ) ) )).
