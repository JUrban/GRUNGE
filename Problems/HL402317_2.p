...
tff(conj_thm_2Elist_2EAPPEND__EQ__SING,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EMEM__SPLIT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l: $i] :
...
tff(conj_thm_2Elist_2EFILTER__NEQ__NIL,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2ENULL__FILTER,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
...
tff(conj_thm_2Elist_2EUNIQUE__FILTER,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1L: $i] :
          ( mem(V1L,ty_2Elist_2Elist(A_27a))
