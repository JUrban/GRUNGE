...
tff(conj_thm_2Ecardinal_2EHAS__SIZE__CLAUSES,lemma,(
...
tff(conj_thm_2Eiterate_2ECHOOSE__SUBSET__STRONG,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2EFRONTIER__CLOSURES,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EIS__INTERVAL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECARD__FRONTIER__INTERVAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
