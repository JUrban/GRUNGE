...
fof(lameq_f2213,axiom,(
    ! [A_27a,V1n] :
     ...
     => ! [V0w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2213(A_27a,V1n,V0w),V2i) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,V2i),V1n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__ror__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__ror(A_27a),V0w),V1n) = ap(c_2Efcp_2EFCP(bool,bool),f2213(A_27a,V1n,V0w)) ) ) ) )).
...
fof(conj_thm_2Ewords_2EROR__CYCLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2ESHIFT__ZERO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
