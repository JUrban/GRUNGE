...
fof(conj_thm_2Eiterate_2EREAL__COMPLETE,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,conjecture,(
    ! [V0s] :
         ...
         => ( ( ! [V2m] :
                 ...
                 => ! [V3n] :
                     ...
                     => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2m),V3n))
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,V2m)),ap(V0s,V3n))) ) ) )
              & ! [V4n] :
                  ( mem(V4n,ty_2Enum_2Enum)
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0s,V4n))),V1b)) ) )
           => ? [V5l] :
                ...
                & ! [V6e] :
                   ...
                   => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V6e))
                     => ? [V7N] :
                          ...
                          & ! [V8n] :
                              ( mem(V8n,ty_2Enum_2Enum)
                             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V7N),V8n))
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0s,V8n)),V5l))),V6e)) ) ) ) ) ) ) ) ) ) )).
