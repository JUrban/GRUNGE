...
thf(thm_2Ereal__topology_2ELIMPT__INJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0x: tyop_2Erealax_2Ereal,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Elinear @ V1f )
        & ! [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
            ( ( ( V1f @ V3x )
              = ( V1f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( c_2Ereal__topology_2Elimit__point__of @ ( V1f @ V0x ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1f @ V2s ) )
        = ( c_2Ereal__topology_2Elimit__point__of @ V0x @ V2s ) ) ) )).
