...
thf(conj_thm_2Ereal__topology_2EDIST__TRIANGLE__HALF__R,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECAUCHY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EBANACH__FIX,conjecture,(
    ! [V0f: $i] :
             ...
             => ( p
                @ ( ap @ ( c_2Ebool_2E_3F_21 @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V5x: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V5x ) ) @ V5x ) ) ) ) ) ) ) ) )).
