...
thf(f2527_0_2E0,type,(
    f2527_0_2E0: u )).

thf(f2527_0_2E1,type,(
    f2527_0_2E1: du > u )).

thf(f2529_0_2E0,type,(
    f2529_0_2E0: u )).

thf(f2529_0_2E2,type,(
    f2529_0_2E2: du > du > u )).
...
thf(c_2Elist_2EoEL_2E0,type,(
    c_2Elist_2EoEL_2E0: u )).

thf(c_2Elist_2EoEL_2E2,type,(
    c_2Elist_2EoEL_2E2: du > du > u )).
...
thf(mono_2Ef2527_0,type,(
    mono_2Ef2527_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef2529_0,type,(
    mono_2Ef2529_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq3_2Emono_2Ec_2Elist_2ELUPDATE_2E3_2Emono_2EA_27a,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Elist_2EoEL_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ c_2Elist_2EoEL_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Elist_2ELUPDATE__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0e_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V2e_2E0: u,V3x_2E0: u,V4l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4l_2E0 ) ) ) )
      & ! [V5e_2E0: u,V6n: mono_2Etyop_2Enum_2Enum,V7x_2E0: u,V8l_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V5e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V6n ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V8l_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V5e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V8l_2E0 ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2Elist_2EoEL__def,axiom,(
    ! [V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2527_0 @ V1n )
...
thf(thm_2Elist_2EoEL__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2x_2E0: u,V3xs_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2527_0 @ V1n ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2EoEL__LUPDATE,axiom,(
    ! [V1i: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2529_0 @ V1i @ V2n )
    <=> ( (~) @ ( V1i = V2n ) ) ) )).

thf(thm_2Elist_2EoEL__LUPDATE,conjecture,(
    ! [A_27a: d,V0xs_2E0: u,V1i: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum,V3x_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ELUPDATE_2E3 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0xs_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2529_0 @ V1i @ V2n ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Elist_2EoEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0xs_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eprim__rec_2E_3C @ V1i @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0xs_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3x_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) ) ) )).
