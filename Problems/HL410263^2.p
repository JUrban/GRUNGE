...
thf(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__BOREL,lemma,(
    p @ ( ap @ ( c_2Emeasure_2Esigma__algebra @ ty_2Eextreal_2Eextreal ) @ c_2Emeasure_2EBorel ) )).

thf(conj_thm_2Emeasure_2ESPACE__BOREL,lemma,
...
thf(conj_thm_2Emeasure_2EBOREL__MEASURABLE__SETS10,conjecture,(
    ! [V0c: tp__ty_2Eextreal_2Eextreal] :
      ( p
      @ ( ap
