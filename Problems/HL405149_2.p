...
tff(tp_c_2Ebag_2EPSUB__BAG,type,(
    c_2Ebag_2EPSUB__BAG: del > $i )).

tff(mem_c_2Ebag_2EPSUB__BAG,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EPSUB__BAG(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool))) )).

tff(conj_thm_2Ebag_2EPSUB__BAG__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
...
tff(conj_thm_2Ebag_2EPSUB__BAG__CARD,lemma,(
    ! [A_27a: del,V0b1: $i] :
...
tff(lamtp_f2086,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool)))
     => mem(f2086(A_27a,V0R),arr(arr(A_27a,ty_2Enum_2Enum),bool)) ) )).
...
tff(lameq_f2086,axiom,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1bag: $i] :
         ...
         => ap(f2086(A_27a,V0R),V1bag) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebag_2EFINITE__BAG(A_27a),V1bag)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(arr(A_27a,ty_2Enum_2Enum)),V1bag),c_2Ebag_2EEMPTY__BAG(A_27a))))),ap(ap(V0R,ap(c_2Ebag_2EBAG__REST(A_27a),V1bag)),V1bag)) ) ) )).

tff(lmtp_f2085,type,(
    f2085: ( del * del ) > $i )).

tff(lamtp_f2085,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f2085(A_27a,A_27a),arr(arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool)),bool)) )).

tff(lameq_f2085,axiom,(
    ! [A_27a: del,A_27a: del,V0R: $i] :
      ( mem(V0R,arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool)))
     => ap(f2085(A_27a,A_27a),V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(arr(A_27a,ty_2Enum_2Enum)),V0R)),ap(c_2Ebool_2E_21(arr(A_27a,ty_2Enum_2Enum)),f2086(A_27a,V0R))) ) )).

tff(lmtp_f2088,type,(
    f2088: ( del * del * $i ) > $i )).

tff(lamtp_f2088,axiom,(
    ! [A_27a: del,A_27a: del,V2BAG__TO__LIST: $i] :
      ( mem(V2BAG__TO__LIST,arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))
     => mem(f2088(A_27a,A_27a,V2BAG__TO__LIST),arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a))) ) )).

tff(lameq_f2088,axiom,(
    ! [A_27a: del,A_27a: del,V2BAG__TO__LIST: $i] :
      ( mem(V2BAG__TO__LIST,arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))
     => ! [V3a: $i] :
          ( mem(V3a,arr(A_27a,ty_2Enum_2Enum))
         => ap(f2088(A_27a,A_27a,V2BAG__TO__LIST),V3a) = ap(c_2Ecombin_2EI(ty_2Elist_2Elist(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(c_2Ebag_2EFINITE__BAG(A_27a),V3a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Emin_2E_3D(arr(A_27a,ty_2Enum_2Enum)),V3a),c_2Ebag_2EEMPTY__BAG(A_27a))),c_2Elist_2ENIL(A_27a)),ap(ap(c_2Elist_2ECONS(A_27a),ap(c_2Ebag_2EBAG__CHOICE(A_27a),V3a)),ap(V2BAG__TO__LIST,ap(c_2Ebag_2EBAG__REST(A_27a),V3a))))),c_2Ebool_2EARB(ty_2Elist_2Elist(A_27a)))) ) ) )).

tff(lmtp_f2087,type,(
    f2087: ( del * del * del ) > $i )).

tff(lamtp_f2087,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del] : mem(f2087(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)),arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))) )).

tff(lameq_f2087,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V2BAG__TO__LIST: $i] :
      ( mem(V2BAG__TO__LIST,arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))
     => ap(f2087(A_27a,A_27a,A_27a),V2BAG__TO__LIST) = f2088(A_27a,A_27a,V2BAG__TO__LIST) ) )).

tff(ax_thm_2Econtainer_2EBAG__TO__LIST__primitive__def,axiom,(
    ! [A_27a: del] : c_2Econtainer_2EBAG__TO__LIST(A_27a) = ap(ap(c_2Erelation_2EWFREC(arr(A_27a,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)),ap(c_2Emin_2E_40(arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool))),f2085(A_27a,A_27a))),f2087(A_27a,A_27a,A_27a)) )).

tff(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,conjecture,(
    ! [A_27a: del,V0P: $i] :
