...
thf(thm_2Ebag_2EBAG__IN__BAG__OF__SET,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1p: A_27a] :
      ( ( c_2Ebag_2EBAG__IN @ A_27a @ V1p @ ( c_2Ebag_2EBAG__OF__SET @ A_27a @ V0P ) )
      = ( c_2Ebool_2EIN @ A_27a @ V1p @ V0P ) ) )).
