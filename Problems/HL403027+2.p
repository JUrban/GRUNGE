...
fof(conj_thm_2EindexedLists_2EFOLDRi__CONG_27,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V5a2] :
                                 ...
                                 => ( ( V0l1 = V1l2
                                      & ! [V6n] :
                                         ...
                                         => ! [V7a] :
                                              ( mem(V7a,A_27b)
                                             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V6n),ap(c_2Elist_2ELENGTH(A_27a),V1l2)))
                                               => ap(ap(ap(V2f1,V6n),ap(ap(c_2Elist_2EEL(A_27a),V6n),V1l2)),V7a) = ap(ap(ap(V3f2,V6n),ap(ap(c_2Elist_2EEL(A_27a),V6n),V1l2)),V7a) ) ) )
                                      & V4a1 = V5a2 )
