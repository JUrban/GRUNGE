...
fof(lamtp_f3643,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1v] :
          ( mem(V1v,ty_2Erealax_2Ereal)
         => mem(f3643(V0f,V1v),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V1v] :
         ...
         => ! [V2x] :
             ...
             => ap(f3643(V0f,V1v),V2x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V2x)),V1v) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__MUL__COMPONENT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1v] :
          ( mem(V1v,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
           => p(ap(c_2Ereal__topology_2Elinear,f3643(V0f,V1v))) ) ) ) )).
