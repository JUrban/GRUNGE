...
thf(thm_2Efloat_2ESIGN,axiom,(
    ! [V0a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( c_2Eieee_2Esign @ V0a )
      = ( c_2Epair_2EFST @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ V0a ) ) )).

thf(thm_2Efloat_2EEXPONENT,axiom,(
    ! [V0a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( c_2Eieee_2Eexponent @ V0a )
      = ( c_2Epair_2EFST @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( c_2Epair_2ESND @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ V0a ) ) ) )).

thf(thm_2Efloat_2EFRACTION,axiom,(
    ! [V0a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( c_2Eieee_2Efraction @ V0a )
      = ( c_2Epair_2ESND @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( c_2Epair_2ESND @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ V0a ) ) ) )).
...
thf(thm_2Efloat_2EIS__VALID,axiom,(
    ...
    <=> ( ( c_2Eprim__rec_2E_3C @ ( c_2Eieee_2Esign @ V1a ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) )
        & ( c_2Eprim__rec_2E_3C @ ( c_2Eieee_2Eexponent @ V1a ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Eieee_2Eexpwidth @ V0X ) ) )
        & ( c_2Eprim__rec_2E_3C @ ( c_2Eieee_2Efraction @ V1a ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Eieee_2Efracwidth @ V0X ) ) ) ) ) )).
    ...
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) )
        @ ^ [V1a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
            ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ $o @ V1a @ ( c_2Eieee_2Eis__valid @ V0X @ V1a ) ) ) ) )).
