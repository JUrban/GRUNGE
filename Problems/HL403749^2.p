...
thf(conj_thm_2Estring_2ETOCHAR__ind,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( ty_2Elist_2Elist @ ty_2Estring_2Echar ) @ bool ) )
     => ( ( ! [V1c: tp__ty_2Estring_2Echar] :
              ( p @ ( ap @ V0P @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ty_2Estring_2Echar ) @ ( inj__ty_2Estring_2Echar @ V1c ) ) @ ( c_2Elist_2ENIL @ ty_2Estring_2Echar ) ) ) )
          & ( p @ ( ap @ V0P @ ( c_2Elist_2ENIL @ ty_2Estring_2Echar ) ) )
          & ! [V2v6: tp__ty_2Estring_2Echar,V3v4: tp__ty_2Estring_2Echar,V4v5: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] :
       ...
       => ! [V5v: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] :
            ( p @ ( ap @ V0P @ ( inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar @ V5v ) ) ) ) ) )).
