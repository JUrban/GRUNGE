...
thf(conj_thm_2Ellist_2ELHD__fromList,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V0l ) )
        = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l ) ) @ ( c_2Eoption_2ENONE @ A_27a ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ ( ap @ ( c_2Elist_2EHD @ A_27a ) @ V0l ) ) ) ) ) )).
