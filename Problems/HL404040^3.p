...
thf(thm_2Equotient_2EW__RSP,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,V0R1: A_27a > A_27a > $o,V1abs1: A_27a > A_27c,V2rep1: A_27c > A_27a] :
     ...
     => ! [V3R2: A_27b > A_27b > $o,V4abs2: A_27b > A_27d,V5rep2: A_27d > A_27b] :
         ...
         => ! [V6f1: A_27a > A_27a > A_27b,V7f2: A_27a > A_27a > A_27b,V8x1: A_27a,V9x2: A_27a] :
              ( ( ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ ( A_27a > A_27b ) @ V0R1 @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ A_27b @ V0R1 @ V3R2 ) @ V6f1 @ V7f2 )
                & ( V0R1 @ V8x1 @ V9x2 ) )
             => ( V3R2 @ ( c_2Ecombin_2EW @ A_27a @ A_27b @ V6f1 @ V8x1 ) @ ( c_2Ecombin_2EW @ A_27a @ A_27b @ V7f2 @ V9x2 ) ) ) ) ) )).
