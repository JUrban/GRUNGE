...
thf(thm_2Erich__list_2ENOT__NULL__SNOC,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1l_2E0: u] :
      ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2ENULL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) ) ) ) )).
