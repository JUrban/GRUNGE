...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__IMP__CONTINUOUS__ON,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__NEGATIONS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
       => p(ap(c_2Ereal__topology_2Econnected,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3701),V0s))) ) ) )).
