...
fof(lamtp_f3750,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3750(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3750,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ap(f3750(A_27a,V1f),V2x) = ap(c_2Ereal_2Eabs,ap(V1f,V2x)) ) ) )).
...
fof(lamtp_f3830,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3830(V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f3830,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => ap(f3830(V0f),V2x) = ap(c_2Ereal_2Eabs,ap(V0f,V2x)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ABS__COMPOSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
         ...
         => ! [V1f] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1f),V0net))
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3750(A_27a,V1f)),V0net)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ABS__COMPOSE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
