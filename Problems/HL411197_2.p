...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__OPEN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x))))
        <=> ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2EOpen,V2t))
                  & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V1x))),V2t)) )
               => ? [V3s: $i] :
                    ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
                    & p(ap(c_2Ereal__topology_2EOpen,V3s))
                    & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V3s))
                    & ! [V4x_27: tp__ty_2Erealax_2Ereal] :
                        ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x_27)),V3s))
                       => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V4x_27))),V2t)) ) ) ) ) ) ) )).
