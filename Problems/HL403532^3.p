...
thf(thm_2Ewellorder_2Ewo2wo__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0w1: tyop_2Ewellorder_2Ewellorder @ A_27a,V1w2: tyop_2Ewellorder_2Ewellorder @ A_27b] :
      ( ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b @ V0w1 @ V1w2 )
      = ( c_2Erelation_2EWFREC @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b )
        @ ^ [V2x: A_27a,V3y: A_27a] :
            ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V2x @ V3y ) @ ( c_2Eset__relation_2Estrict @ A_27a @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a @ V0w1 ) ) )
        @ ^ [V4f: A_27a > ( tyop_2Eoption_2Eoption @ A_27b ),V5x: A_27a] :
            ( c_2Ebool_2ELET @ ( ( tyop_2Eoption_2Eoption @ A_27b ) > $o ) @ ( tyop_2Eoption_2Eoption @ A_27b )
            @ ^ [V6s0: ( tyop_2Eoption_2Eoption @ A_27b ) > $o] :
                ( c_2Ebool_2ELET @ ( A_27b > $o ) @ ( tyop_2Eoption_2Eoption @ A_27b )
                @ ^ [V7s1: A_27b > $o] :
                    ( c_2Ebool_2ECOND @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Emin_2E_3D @ ( A_27b > $o ) @ V7s1 @ ( c_2Ewellorder_2EelsOf @ A_27b @ V1w2 ) ) @ ( c_2Eoption_2ENONE @ A_27b ) @ ( c_2Ewellorder_2Ewleast @ A_27b @ V1w2 @ V7s1 ) )
                @ ( c_2Epred__set_2EIMAGE @ ( tyop_2Eoption_2Eoption @ A_27b ) @ A_27b @ ( c_2Eoption_2ETHE @ A_27b ) @ ( c_2Epred__set_2EDELETE @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V6s0 @ ( c_2Eoption_2ENONE @ A_27b ) ) ) )
            @ ( c_2Epred__set_2EIMAGE @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V4f @ ( c_2Ewellorder_2Eiseg @ A_27a @ V0w1 @ V5x ) ) ) ) ) )).
