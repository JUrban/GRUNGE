...
tff(conj_thm_2Ebool_2EPULL__FORALL,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Epred__set_2EIN__GSPEC,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ? [V1f: $i] :
            ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
            & ? [V2b: tp__ty_2Enum_2Enum] : p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V2b))),V0s)) ) ) ) )).

tff(lmtp_f276,type,(
    f276: ( del * $i * $i ) > $i )).

tff(lamtp_f276,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => mem(f276(A_27a,V1f,V0s),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f276,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f276(A_27a,V1f,V0s),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V1f,inj__ty_2Enum_2Enum(V4n))),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4n)),ap(c_2Epred__set_2ECARD(A_27a),V0s))) ) ) )).

tff(conj_thm_2Epred__set_2EFINITE__ISO__NUM,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ? [V1f: $i] :
            ...
            & ! [V2n: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum] :
               ...
               => ( ap(V1f,inj__ty_2Enum_2Enum(V2n)) = ap(V1f,inj__ty_2Enum_2Enum(V3m))
                 => V2n = V3m ) )
            & V0s = ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f276(A_27a,V1f,V0s)) ) ) ) )).
