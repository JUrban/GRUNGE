...
thf(stp_fo_c_2Estring_2EisDigit,type,(
    fo__c_2Estring_2EisDigit: tp__ty_2Estring_2Echar > $o )).

thf(stp_eq_fo_c_2Estring_2EisDigit,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] :
      ( ( inj__o @ ( fo__c_2Estring_2EisDigit @ X0 ) )
      = ( ap @ c_2Estring_2EisDigit @ ( inj__ty_2Estring_2Echar @ X0 ) ) ) )).
...
thf(conj_thm_2EASCIInumbers_2EHEX__def,lemma,
...
thf(conj_thm_2EASCIInumbers_2EUNHEX__def,lemma,
...
thf(conj_thm_2EASCIInumbers_2EDEC__UNDEC,conjecture,(
    ! [V0c: tp__ty_2Estring_2Echar] :
      ( ( p @ ( ap @ c_2Estring_2EisDigit @ ( inj__ty_2Estring_2Echar @ V0c ) ) )
