...
thf(conj_thm_2EPast__Temporal__Logic_2EPSWHEN__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V7t: $i] :
                    ...
                    @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V1b )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V8t: $i] :
                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V0a @ V8t ) ) @ ( ap @ V1b @ V8t ) ) ) )
                    @ V7t ) ) )
                ...
                @ ^ [V14t: $i] :
                    ...
                    @ ( ap
                      @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V1b )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V15t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V15t ) ) @ ( ap @ V1b @ V15t ) ) ) )
                      @ V14t ) ) ) )
