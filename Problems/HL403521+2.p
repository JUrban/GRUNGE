...
fof(mem_c_2Ewellorder_2EfromNatWO,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewellorder_2EfromNatWO(A_27a),arr(ty_2Enum_2Enum,ty_2Ewellorder_2Ewellorder(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).
...
fof(conj_thm_2Ewellorder_2Ewellorder__fromNat__SUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(ax_thm_2Ewellorder_2EfromNatWO__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ap(c_2Ewellorder_2EfromNatWO(A_27a),V0n) = ap(c_2Ewellorder_2Ewellorder__ABS(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epair_2Eprod(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f1026(A_27a,V0n)))) ) ) )).

fof(conj_thm_2Ewellorder_2EfromNatWO__11,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
         ...
         => ! [V1j] :
             ...
             => ( ap(c_2Ewellorder_2EfromNatWO(A_27a),V0i) = ap(c_2Ewellorder_2EfromNatWO(A_27a),V1j)
              <=> V0i = V1j ) ) ) ) )).
