...
thf(thm_2Elift__ieee_2Efloat__to__real__threshold,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0x: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w] :
     ...
     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0x ) ) @ ( c_2Ebinary__ieee_2Ethreshold @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) ) ) ) )).
...
thf(thm_2Elift__ieee_2Efinite__float__within__threshold,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b] :
      ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27a @ A_27b @ V0f )
     => ( ( (~) @ ( c_2Ereal_2Ereal__lte @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27a @ A_27b @ V0f ) @ ( c_2Erealax_2Ereal__neg @ ( c_2Ebinary__ieee_2Ethreshold @ A_27a @ A_27b @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) ) ) )
        & ( (~) @ ( c_2Ereal_2Ereal__ge @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27a @ A_27b @ V0f ) @ ( c_2Ebinary__ieee_2Ethreshold @ A_27a @ A_27b @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) ) ) ) ) )).
