...
thf(conj_thm_2Etopology_2EHULL__IMAGE__GALOIS,lemma,(
    ! [A_27a: del,V0P: $i] :
         ...
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ! [V4s: $i] :
                   ...
                   => ( ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27a ) @ V1f ) @ V3s ) )
                      = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27a ) @ V1f ) @ ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V3s ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Etopology_2EHULL__IMAGE,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ A_27a ) )
             ...
             => ( ( ! [V3s: $i] :
                  ...
                  & ! [V7y: $i] :
                     ...
                     => ? [V8x: $i] :
                          ...
                          & ( ( ap @ V1f @ V8x )
                            = V7y ) ) ) )
               => ( ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27a ) @ V1f ) @ V2s ) )
                  = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27a ) @ V1f ) @ ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V2s ) ) ) ) ) ) ) )).
