...
fof(conj_thm_2Epoly_2EPOLY__ZERO__LEMMA,lemma,(
    ! [V0h] :
...
fof(lamtp_f2925,axiom,(
    mem(f2925,arr(ty_2Erealax_2Ereal,bool)) )).

fof(lameq_f2925,axiom,(
    ! [V1c] :
      ( mem(V1c,ty_2Erealax_2Ereal)
     => ap(f2925,V1c) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V1c),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) )).

fof(conj_thm_2Epoly_2EPOLY__ZERO,conjecture,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ( ap(c_2Epoly_2Epoly,V0p) = ap(c_2Epoly_2Epoly,c_2Elist_2ENIL(ty_2Erealax_2Ereal))
      <=> p(ap(ap(c_2Elist_2EEVERY(ty_2Erealax_2Ereal),f2925),V0p)) ) ) )).
