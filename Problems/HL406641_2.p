...
tff(conj_thm_2Esemi__ring_2Emult__assoc,lemma,(
    ! [A_27a: del,V0r: $i] :
...
tff(conj_thm_2Esemi__ring_2Emult__one__left,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,ty_2Esemi__ring_2Esemi__ring(A_27a))
     => ( p(ap(c_2Esemi__ring_2Eis__semi__ring(A_27a),V0r))
       => ! [V1n: $i] :
...
tff(conj_thm_2Esemi__ring_2Emult__rotate,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,ty_2Esemi__ring_2Esemi__ring(A_27a))
     => ( p(ap(c_2Esemi__ring_2Eis__semi__ring(A_27a),V0r))
       => ! [V1m: $i] :
...
tff(conj_thm_2Ecanonical_2Evarlist__merge__ok,conjecture,(
    ! [A_27a: del,V0sr: $i] :
      ( mem(V0sr,ty_2Esemi__ring_2Esemi__ring(A_27a))
