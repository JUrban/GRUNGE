...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Erealax_2Ereal__add @ V1a @ V2x )
        @ V0s ) ) )).

thf(thm_2Ereal__topology_2EHOMEOMORPHIC__AFFINITY,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2c: tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V2c
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( c_2Ereal__topology_2Ehomeomorphic @ V0s
        @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V3x: tyop_2Erealax_2Ereal] :
              ( c_2Erealax_2Ereal__add @ V1a @ ( c_2Erealax_2Ereal__mul @ V2c @ V3x ) )
          @ V0s ) ) ) )).
