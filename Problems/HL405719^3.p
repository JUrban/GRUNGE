...
thf(thm_2Eordinal_2Eordlt__DISCRETE1,axiom,(
    ! [A_27a: $tType,V0b: tyop_2Eordinal_2Eordinal @ A_27a,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( (~)
      @ ( ( c_2Eordinal_2Eordlt @ A_27a @ V1a @ V0b )
        & ( c_2Eordinal_2Eordlt @ A_27a @ V0b @ ( c_2Eordinal_2EordSUC @ A_27a @ V1a ) ) ) ) )).
...
thf(thm_2Eordinal_2EordMULT__le__MONO__R,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a,V1b: tyop_2Eordinal_2Eordinal @ A_27a,V2c: tyop_2Eordinal_2Eordinal @ A_27a] :
     ...
     => ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EordMULT @ A_27a @ V2c @ V1b ) @ ( c_2Eordinal_2EordMULT @ A_27a @ V2c @ V0a ) ) ) ) )).

thf(thm_2Eordinal_2EordMULT__lt__MONO__R__EQN,axiom,(
    ! [A_27a: $tType,V0c: tyop_2Eordinal_2Eordinal @ A_27a,V1b: tyop_2Eordinal_2Eordinal @ A_27a,V2a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EordMULT @ A_27a @ V0c @ V2a ) @ ( c_2Eordinal_2EordMULT @ A_27a @ V0c @ V1b ) )
    <=> ( ( c_2Eordinal_2Eordlt @ A_27a @ V2a @ V1b )
        & ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ V0c ) ) ) )).
...
thf(thm_2Eordinal_2EordADD__EQ__0,axiom,(
    ! [A_27a: $tType,V0y: tyop_2Eordinal_2Eordinal @ A_27a,V1x: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( ( c_2Eordinal_2EordADD @ A_27a @ V1x @ V0y )
        = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) )
    <=> ( ( V1x
          = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) )
        & ( V0y
...
thf(thm_2Eordinal_2EordMULT__EQ__0,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Eordinal_2Eordinal @ A_27a,V1y: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( ( c_2Eordinal_2EordMULT @ A_27a @ V0x @ V1y )
        = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) )
    <=> ( ( V0x
          = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) )
        | ( V1y
...
thf(thm_2Eordinal_2EZERO__lt__ordEXP,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Eordinal_2Eordinal @ A_27a,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ ( c_2Eordinal_2EordEXP @ A_27a @ V1a @ V0x ) )
    <=> ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ V1a )
        | ( ( c_2Eordinal_2Eomax @ A_27a @ ( c_2Eordinal_2Epreds @ A_27a @ V0x ) )
          = ( c_2Eoption_2ENONE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordEXP__le__MONO__R,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Eordinal_2Eordinal @ A_27a,V1y: tyop_2Eordinal_2Eordinal @ A_27a,V2a: tyop_2Eordinal_2Eordinal @ A_27a] :
     ...
     => ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EordEXP @ A_27a @ V2a @ V1y ) @ ( c_2Eordinal_2EordEXP @ A_27a @ V2a @ V0x ) ) ) ) )).
...
thf(thm_2Eordinal_2Eis__polyform__ELthm,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0ces: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ),V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eis__polyform @ A_27a @ A_27b @ V1a @ V0ces )
    <=> ( ! [V2i: tyop_2Enum_2Enum,V3j: tyop_2Enum_2Enum] :
            ( ( ( c_2Eprim__rec_2E_3C @ V2i @ V3j )
              & ( c_2Eprim__rec_2E_3C @ V3j @ ( c_2Elist_2ELENGTH @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ) @ V0ces ) ) )
           => ( c_2Eordinal_2Eordlt @ A_27b @ ( c_2Epair_2ESND @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) @ ( c_2Elist_2EEL @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ) @ V3j @ V0ces ) ) @ ( c_2Epair_2ESND @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) @ ( c_2Elist_2EEL @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ) @ V2i @ V0ces ) ) ) )
        & ! [V4c: tyop_2Eordinal_2Eordinal @ A_27a,V5e: tyop_2Eordinal_2Eordinal @ A_27b] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ) @ ( c_2Epair_2E_2C @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) @ V4c @ V5e ) @ ( c_2Elist_2ELIST__TO__SET @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27b ) ) @ V0ces ) )
           => ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ V4c )
              & ( c_2Eordinal_2Eordlt @ A_27a @ V4c @ V1a ) ) ) ) ) )).
...
thf(thm_2Eordinal_2Epolyform__UNIQUE,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a,V1b: tyop_2Eordinal_2Eordinal @ A_27a,V2ces: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) )] :
      ( ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0a )
        & ( c_2Eordinal_2Eis__polyform @ A_27a @ A_27a @ V0a @ V2ces )
        & ( V1b
          = ( c_2Eordinal_2Eeval__poly @ A_27a @ V0a @ V2ces ) ) )
     => ( ( c_2Eordinal_2Epolyform @ A_27a @ V0a @ V1b )
        = V2ces ) ) )).
