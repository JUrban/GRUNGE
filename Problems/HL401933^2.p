              ...
              @ ( ap
                @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum )
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V1n: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ bool ) @ V1n ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V1n ) @ ( ap @ c_2Epred__set_2EMIN__SET @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ty_2Enum_2Enum ) @ V0s ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2d: $i] :
                        ...
                        @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V3e: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V3e ) @ V0s ) ) @ ( ap @ ( ap @ c_2Edivides_2Edivides @ V2d ) @ V3e ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Egcdset_2Egcdset__EMPTY,conjecture,
