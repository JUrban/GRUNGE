...
thf(thm_2Ebit_2EBIT__COMP__THM3,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2l: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ ( c_2Ebit_2EBITS @ V0h @ ( c_2Enum_2ESUC @ V1m ) @ V3n ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2D @ ( c_2Enum_2ESUC @ V1m ) @ V2l ) ) ) @ ( c_2Ebit_2EBITS @ V1m @ V2l @ V3n ) )
        = ( c_2Ebit_2EBITS @ V0h @ V2l @ V3n ) ) ) )).
...
thf(thm_2Ebit_2ESBIT__DIV,axiom,(
...
thf(thm_2Ebit_2EBITS__SUC,conjecture,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V1l @ ( c_2Enum_2ESUC @ V0h ) )
     => ( ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2ESBIT @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0h ) @ V2n ) @ ( c_2Earithmetic_2E_2D @ ( c_2Enum_2ESUC @ V0h ) @ V1l ) ) @ ( c_2Ebit_2EBITS @ V0h @ V1l @ V2n ) )
        = ( c_2Ebit_2EBITS @ ( c_2Enum_2ESUC @ V0h ) @ V1l @ V2n ) ) ) )).
