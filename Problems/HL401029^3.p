...
thf(thm_2Earithmetic_2EMODEQ__EXP__CONG,conjecture,(
    ! [V0y: tyop_2Enum_2Enum,V1x: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum,V3e: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2EMODEQ @ V2n @ V1x @ V0y )
     => ( c_2Earithmetic_2EMODEQ @ V2n @ ( c_2Earithmetic_2EEXP @ V1x @ V3e ) @ ( c_2Earithmetic_2EEXP @ V0y @ V3e ) ) ) )).
