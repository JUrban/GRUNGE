...
tff(conj_thm_2Ellist_2ELTAKE__IMP__LDROP,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l1: $i] :
          ( mem(V2l1,ty_2Elist_2Elist(A_27a))
         => ( ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),V2l1)
           => ? [V3l2: $i] :
                ( mem(V3l2,ty_2Ellist_2Ellist(A_27a))
                & ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Ellist_2Ellist(A_27a)),V3l2)
