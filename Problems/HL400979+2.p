...
fof(conj_thm_2Earithmetic_2EABS__DIFF__COMM,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Earithmetic_2EABS__DIFF__LE__SUM,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Earithmetic_2EABS__DIFF__TRIANGLE__lem,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1y] :
...
fof(conj_thm_2Earithmetic_2EABS__DIFF__TRIANGLE,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1y] :
          ( mem(V1y,ty_2Enum_2Enum)
