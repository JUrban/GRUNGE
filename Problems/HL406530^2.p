...
thf(conj_thm_2Ebit_2ESLICE__ZERO2,lemma,(
    ! [V0l: tp__ty_2Enum_2Enum,V1h: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2ESLICE @ ( inj__ty_2Enum_2Enum @ V1h ) ) @ ( inj__ty_2Enum_2Enum @ V0l ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      = fo__c_2Enum_2E0 ) )).
...
thf(conj_thm_2Ewords_2EWORD__ADD__OR,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Eblast_2EBITWISE__MUL,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1m: $i] :
                    ...
                    @ ^ [V2a: $i] :
                        ...
                        @ ^ [V3j: $i] :
                            ...
                            @ ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V4i: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ V3j ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V3j ) @ V4i ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1m ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V4i ) @ V3j ) ) ) ) ) ) ) ) ) )
                @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
