...
thf(f2877_0_2E0,type,(
    f2877_0_2E0: u )).

thf(f2877_0_2E1,type,(
    f2877_0_2E1: du > u )).

thf(f2877_0_2E2,type,(
    f2877_0_2E2: du > du > u )).

thf(f2877_1_2E0,type,(
    f2877_1_2E0: u )).

thf(f2877_1_2E1,type,(
    f2877_1_2E1: du > u )).

thf(f2877_1_2E2,type,(
    f2877_1_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2877_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( f2877_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) ) @ f2877_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2877_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Eone_2Eone] :
      ( ( s @ A_27a @ ( f2877_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) ) @ f2877_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ X1 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef2877_1_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2877_1_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2877_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2877_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2877_1_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2877_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2_2Emono_2Etyop_2Eone_2Eone_20mono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__GAP,axiom,(
    ! [A_27a: d,V0i_2E0: u,V1xxx: mono_2Etyop_2Eone_2Eone] :
      ( ( s @ A_27a @ ( f2877_0_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ V1xxx ) ) ) )
      = ( s @ A_27a @ V0i_2E0 ) ) )).

thf(def1_2Ethm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__GAP,axiom,(
    ! [A_27a: d,V0i_2E0: u,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2877_1_2E2 @ ( s @ A_27a @ V0i_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V2x_2E0 )
        = ( s @ A_27a @ V0i_2E0 ) ) ) )).

thf(thm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__GAP,conjecture,(
    ! [A_27a: d,V0i_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eone_2Eone @ A_27a ) @ ( f2877_0_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2877_1_2E1 @ ( s @ A_27a @ V0i_2E0 ) ) ) ) ) ) )).
