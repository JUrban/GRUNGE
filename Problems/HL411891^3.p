...
thf(thm_2Ereal__topology_2ESETDIST__TRANSLATION,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Esetdist
        @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o )
          ...
          @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V4x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ V0a @ V4x )
            @ V2t ) ) )
...
thf(thm_2Ereal__topology_2EHAUSDIST__TRANSLATION,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ehausdist
        @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o )
          @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V3x: tyop_2Erealax_2Ereal] :
                ( c_2Erealax_2Ereal__add @ V0a @ V3x )
