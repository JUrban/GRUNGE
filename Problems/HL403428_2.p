...
tff(tp_c_2Ebag_2EITBAG,type,(
    c_2Ebag_2EITBAG: ( del * del ) > $i )).

tff(mem_c_2Ebag_2EITBAG,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ebag_2EITBAG(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,A_27b)),arr(arr(A_27a,ty_2Enum_2Enum),arr(A_27b,A_27b)))) )).

tff(tp_c_2Ebag_2Ebag__size,type,(
    c_2Ebag_2Ebag__size: del > $i )).

tff(mem_c_2Ebag_2Ebag__size,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2Ebag__size(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),ty_2Enum_2Enum))) )).

tff(conj_thm_2Ebag_2ECOMMUTING__ITBAG__RECURSES,lemma,(
         ...
         => ! [V2b: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( ! [V4x: $i] :
                   ...
                   => ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),V0f),ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V1e),V2b)),V3a) = ap(ap(V0f,V1e),ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),V0f),V2b),V3a)) ) ) ) ) ) )).

tff(lmtp_f979,type,(
    f979: ( del * $i * $i ) > $i )).

tff(lamtp_f979,axiom,(
    ! [A_27a: del,V2e: $i] :
      ( mem(V2e,A_27a)
     => ! [V0eltsize: $i] :
          ( mem(V0eltsize,arr(A_27a,ty_2Enum_2Enum))
         => mem(f979(A_27a,V2e,V0eltsize),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) )).
...
tff(lameq_f979,axiom,(
    ! [A_27a: del,V2e: $i] :
     ...
     => ! [V0eltsize: $i] :
          ( mem(V0eltsize,arr(A_27a,ty_2Enum_2Enum))
         => ! [V3acc: tp__ty_2Enum_2Enum] : ap(f979(A_27a,V2e,V0eltsize),inj__ty_2Enum_2Enum(V3acc)) = ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(V0eltsize,V2e))),inj__ty_2Enum_2Enum(V3acc)) ) ) )).

tff(lmtp_f978,type,(
    f978: ( del * $i ) > $i )).

tff(lamtp_f978,axiom,(
    ! [A_27a: del,V0eltsize: $i] :
      ( mem(V0eltsize,arr(A_27a,ty_2Enum_2Enum))
     => mem(f978(A_27a,V0eltsize),arr(A_27a,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).
...
tff(lameq_f978,axiom,(
    ! [A_27a: del,V0eltsize: $i] :
     ...
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ap(f978(A_27a,V0eltsize),V2e) = f979(A_27a,V2e,V0eltsize) ) ) )).

tff(ax_thm_2Ebag_2Ebag__size__def,axiom,(
    ! [A_27a: del,V0eltsize: $i] :
      ( mem(V0eltsize,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
         => surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2Ebag__size(A_27a),V0eltsize),V1b)) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebag_2EITBAG(A_27a,A_27a),f978(A_27a,V0eltsize)),V1b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ebag_2EBAG__SIZE__INSERT,conjecture,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ! [V1eltsize: $i] :
         ...
         => ! [V2e: $i] :
             ...
             => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
               => surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2Ebag__size(A_27a),V1eltsize),ap(ap(c_2Ebag_2EBAG__INSERT(A_27a),V2e),V0b))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(V1eltsize,V2e))),ap(ap(c_2Ebag_2Ebag__size(A_27a),V1eltsize),V0b))) ) ) ) ) )).
