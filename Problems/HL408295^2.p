...
thf(conj_thm_2Etransc_2EROOT__MONO__LE,lemma,(
...
thf(conj_thm_2Etransc_2ESQRT__MONO__LE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
     ...
     => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Etransc_2Esqrt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( ap @ c_2Etransc_2Esqrt @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).
