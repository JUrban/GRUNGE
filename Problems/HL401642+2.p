...
fof(conj_thm_2Epred__set_2ESURJ__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2EFINITE__SURJ__BIJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1f] :
                 ...
                 => ! [V2t] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                          ...
                          & ap(c_2Epred__set_2ECARD(A_27b),V2t) = ap(c_2Epred__set_2ECARD(A_27a),V0s) )
