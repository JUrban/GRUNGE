...
thf(conj_thm_2Ecardinal_2ECARD__LE__REFL,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardleq @ A_27a @ A_27a ) @ V0s ) @ V0s ) ) ) )).

thf(conj_thm_2Ecardinal_2ECARD__LET__TRANS,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__LE__TOTAL,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__LE__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__LT__FINITE__INFINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__ADD__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__ADD2__ABSORB__LE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__ADD2__ABSORB__LT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
