...
thf(thm_2Efcp_2EFCP__TL__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0v: tyop_2Efcp_2Ecart @ A_27a @ A_27c] :
      ( ( c_2Efcp_2EFCP__TL @ A_27a @ A_27b @ A_27c @ V0v )
      = ( c_2Efcp_2EFCP @ A_27a @ A_27b
        @ ^ [V1i: tyop_2Enum_2Enum] :
            ( c_2Efcp_2Efcp__index @ A_27a @ A_27c @ V0v @ ( c_2Enum_2ESUC @ V1i ) ) ) ) )).
...
thf(thm_2Efcp_2EFCP__TL,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0v: tyop_2Efcp_2Ecart @ A_27a @ A_27b] :
      ( ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) )
        & ( ( c_2Efcp_2Edimindex @ A_27c @ ( c_2Ebool_2Ethe__value @ A_27c ) )
          = ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
     => ( ( c_2Efcp_2EFCP__TL @ A_27a @ A_27c @ A_27b @ V0v )
        = ( c_2Efcp_2EL2V @ A_27a @ A_27c @ ( c_2Elist_2ETL @ A_27a @ ( c_2Efcp_2EV2L @ A_27a @ A_27b @ V0v ) ) ) ) ) )).
