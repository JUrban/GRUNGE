...
fof(conj_thm_2Epred__set_2EDIFF__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EINJ__DELETE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V2f),V0s),V1t))
                       => ! [V3e] :
                           ...
                           => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3e),V0s))
                             => p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V2f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V0s),V3e)),ap(ap(c_2Epred__set_2EDELETE(A_27b),V1t),ap(V2f,V3e)))) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Epred__set_2EBIJ__DELETE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
