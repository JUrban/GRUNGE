...
thf(conj_thm_2Earithmetic_2Enum__case__eq,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1zc: $i] :
     ...
     => ! [V2sc: $i] :
         ...
         => ! [V3v: $i] :
              ( ( mem @ V3v @ A_27a )
             => ( ( ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2Enum__CASE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1zc ) @ V2sc )
                  = V3v )
              <=> ( ( ( V0n = fo__c_2Enum_2E0 )
                    & ( V1zc = V3v ) )
                  | ? [V4x: tp__ty_2Enum_2Enum] :
                      ( ( V0n
                        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) )
                      & ( ( ap @ V2sc @ ( inj__ty_2Enum_2Enum @ V4x ) )
                        = V3v ) ) ) ) ) ) ) )).
