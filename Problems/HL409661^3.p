...
thf(thm_2Eiterate_2ENUMSEG__CLAUSES,axiom,
    ( ! [V0m: tyop_2Enum_2Enum] :
        ( ( c_2Eiterate_2E_2E_2E @ V0m @ c_2Enum_2E0 )
        = ( c_2Ebool_2ECOND @ ( tyop_2Enum_2Enum > $o ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V0m @ c_2Enum_2E0 ) @ ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ ( c_2Epred__set_2EEMPTY @ tyop_2Enum_2Enum ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Enum_2Enum ) ) )
    & ! [V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
        ( ( c_2Eiterate_2E_2E_2E @ V1m @ ( c_2Enum_2ESUC @ V2n ) )
        = ( c_2Ebool_2ECOND @ ( tyop_2Enum_2Enum > $o ) @ ( c_2Earithmetic_2E_3C_3D @ V1m @ ( c_2Enum_2ESUC @ V2n ) ) @ ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ ( c_2Enum_2ESUC @ V2n ) @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) ) @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) ) ) )).
...
thf(thm_2Eiterate_2ETOPOLOGICAL__SORT,conjecture,(
    ! [A_27a: $tType,V0_3C_3C: A_27a > A_27a > $o] :
      ( ( ! [V1x: A_27a,V2y: A_27a] :
            ( ( ( V0_3C_3C @ V1x @ V2y )
              & ( V0_3C_3C @ V2y @ V1x ) )
           => ( V1x = V2y ) )
        & ! [V3x: A_27a,V4y: A_27a,V5z: A_27a] :
            ( ( ( V0_3C_3C @ V3x @ V4y )
              & ( V0_3C_3C @ V4y @ V5z ) )
           => ( V0_3C_3C @ V3x @ V5z ) ) )
     => ! [V6n: tyop_2Enum_2Enum,V7s: A_27a > $o] :
          ( ( c_2Ecardinal_2EHAS__SIZE @ A_27a @ V7s @ V6n )
         => ? [V8f: tyop_2Enum_2Enum > A_27a] :
              ( ( V7s
                = ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ A_27a @ V8f @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V6n ) ) )
              & ! [V9j: tyop_2Enum_2Enum,V10k: tyop_2Enum_2Enum] :
                  ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V9j @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V6n ) )
                    & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V10k @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V6n ) )
                    & ( c_2Eprim__rec_2E_3C @ V9j @ V10k ) )
                 => ( (~) @ ( V0_3C_3C @ ( V8f @ V10k ) @ ( V8f @ V9j ) ) ) ) ) ) ) )).
