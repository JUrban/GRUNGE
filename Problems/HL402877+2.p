...
fof(conj_thm_2Erich__list_2ELIST__REL__APPEND__IMP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2ys] :
                     ...
                     => ! [V3xs1] :
                         ...
                         => ! [V4ys1] :
                             ...
                             => ( ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Elist_2EAPPEND(A_27a),V1xs),V3xs1)),ap(ap(c_2Elist_2EAPPEND(A_27b),V2ys),V4ys1)))
                                  & ap(c_2Elist_2ELENGTH(A_27a),V1xs) = ap(c_2Elist_2ELENGTH(A_27b),V2ys) )
                               => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),V1xs),V2ys))
                                  & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),V3xs1),V4ys1)) ) ) ) ) ) ) ) ) ) )).
