...
thf(conj_thm_2EHolSmt_2Er253,conjecture,(
    ! [V0x: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] :
      ( ( surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone @ ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__extract @ ty_2Eone_2Eone @ ty_2Eone_2Eone ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone @ V0x ) ) )
      = V0x ) )).
