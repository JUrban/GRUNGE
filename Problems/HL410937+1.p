...
fof(thm_2Ereal__topology_2Etrivial__limit,axiom,(
    ! [A_27a,V0net_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Etrivial__limit_2E1(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0))))
    <=> ( ! [V1a_2E0,V2b_2E0] : s(A_27a,V1a_2E0) = s(A_27a,V2b_2E0)
        | ? [V3a_2E0,V4b_2E0] :
            ( s(A_27a,V3a_2E0) != s(A_27a,V4b_2E0)
            & ! [V5x_2E0] :
                ( ~ p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(A_27a,V5x_2E0),s(A_27a,V3a_2E0))))
                & ~ p(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0),s(A_27a,V5x_2E0),s(A_27a,V4b_2E0)))) ) ) ) ) )).
...
fof(thm_2Ereal__topology_2ELIM__UNIQUE,conjecture,(
