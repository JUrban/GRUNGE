...
thf(conj_thm_2Ecardinal_2ECARD__HAS__SIZE__CONG,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
         => ! [V2n: tp__ty_2Enum_2Enum] :
              ( ( ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2EHAS__SIZE @ A_27a ) @ V0s ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                & ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardeq @ A_27a @ A_27b ) @ V0s ) @ V1t ) ) )
             => ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2EHAS__SIZE @ A_27b ) @ V1t ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) )).
