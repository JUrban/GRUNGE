...
fof(lamtp_f593,axiom,(
    ! [A_27b,A_27a,V1P] :
      ( mem(V1P,arr(A_27a,A_27b))
     => ! [V2Q] :
          ( mem(V2Q,arr(A_27a,A_27b))
         => mem(f593(A_27b,A_27a,V1P,V2Q),arr(A_27a,bool)) ) ) )).
...
fof(lameq_f593,axiom,(
    ! [A_27b,A_27a,V1P] :
     ...
     => ! [V2Q] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f593(A_27b,A_27a,V1P,V2Q),V4x) = ap(ap(c_2Emin_2E_3D(A_27b),ap(V1P,V4x)),ap(V2Q,V4x)) ) ) ) )).

fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__POINT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1P] :
                 ...
                 => ! [V2Q] :
                     ...
                     => ( ap(V1P,V0i) = ap(V2Q,V0i)
                       => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__POINT(ty_2Eone_2Eone,ty_2Eone_2Eone),k(ty_2Eone_2Eone,V0i)),f593(A_27b,A_27a,V1P,V2Q))) ) ) ) ) ) ) )).
