...
thf(f13141_0_2E0,type,(
    f13141_0_2E0: u )).

thf(f13141_0_2E1,type,(
    f13141_0_2E1: du > u )).

thf(f13141_0_2E2,type,(
    f13141_0_2E2: du > du > u )).

thf(f13142_0_2E0,type,(
    f13142_0_2E0: u )).

thf(f13142_0_2E1,type,(
    f13142_0_2E1: du > u )).

thf(f13142_0_2E2,type,(
...
thf(mono_2Ef13141_0,type,(
    mono_2Ef13141_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13142_0,type,(
    mono_2Ef13142_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13142_0 @ V1a @ V2x )
...
thf(thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13142_0 @ V1a ) @ V0s )
        = V0s ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF__EQ,axiom,(
    ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13141_0 @ V1a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V1a @ V2x ) ) )).

thf(thm_2Ereal__topology_2ESUBSPACE__TRANSLATION__SELF__EQ,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Esubspace @ V0s )
     => ( ( ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13141_0 @ V1a ) @ V0s )
          = V0s )
      <=> ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1a @ V0s ) ) ) )).
