...
thf(thm_2Elim_2ELIM__EQUAL,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3x0: mono_2Etyop_2Erealax_2Ereal] :
      ( ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( (~) @ ( V4x = V3x0 ) )
         => ( ( V0f @ V4x )
            = ( V1g @ V4x ) ) )
     => ( ( mono_2Ec_2Elim_2Etends__real__real @ V0f @ V2l @ V3x0 )
        = ( mono_2Ec_2Elim_2Etends__real__real @ V1g @ V2l @ V3x0 ) ) ) )).
