...
fof(lamtp_f3511,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f3511(V0f,V1g),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V4x] :
             ...
             => ap(f3511(V0f,V1g),V4x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,V4x)),ap(V1g,V4x)) ) ) ) )).

fof(conj_thm_2Eproduct_2EPRODUCT__MUL__NUMSEG,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ap(ap(c_2Eproduct_2Eproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),f3511(V0f,V1g)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eproduct_2Eproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),V0f)),ap(ap(c_2Eproduct_2Eproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),V1g)) ) ) ) ) )).
