...
tff(conj_thm_2Enets_2ENET__DIV,lemma,(
    ! [A_27a: del,V0g: $i] :
...
tff(lamtp_f2871,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f2871(V0x,V2y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f2871,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f2871(V0x,V2y),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Ereal_2E_2F,ap(V0x,inj__ty_2Enum_2Enum(V4n))),ap(V2y,inj__ty_2Enum_2Enum(V4n))) ) ) )).

tff(conj_thm_2Eseq_2ESEQ__DIV,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2y: $i] :
         ...
         => ! [V3y0: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2871(V0x,V2y)),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1x0)),inj__ty_2Erealax_2Ereal(V3y0)))) ) ) ) )).
