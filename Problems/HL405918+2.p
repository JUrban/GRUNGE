...
fof(conj_thm_2Earithmetic_2EADD__MODULUS__RIGHT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
...
fof(mem_c_2Ewords_2Econcat__word__list,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Ewords_2Econcat__word__list(A_27a,A_27a),arr(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Efcp_2Ecart(bool,bool))) ) ) )).
...
fof(mem_c_2Ewords_2Eword__replicate,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Ewords_2Eword__replicate(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) ) )).
...
fof(lameq_f2217,axiom,(
    ! [A_27a,V0n] :
     ...
     => ! [V1w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2217(A_27a,V0n,V1w),V2i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,V2i),ap(ap(c_2Earithmetic_2E_2A,V0n),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),ap(ap(c_2Earithmetic_2EMOD,V2i),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))) ) ) ) )).
    ...
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [V0n] :
             ...
             => ! [V1w] :
                  ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
                 => ap(ap(c_2Ewords_2Eword__replicate(A_27a,A_27a),V0n),V1w) = ap(c_2Efcp_2EFCP(bool,bool),f2217(A_27a,V0n,V1w)) ) ) ) ) )).
...
fof(ax_thm_2Ewords_2Econcat__word__list__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),c_2Elist_2ENIL(ty_2Efcp_2Ecart(bool,bool))) = ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0)
            & ! [V0h] :
...
fof(conj_thm_2Ewords_2Eword__replicate__concat__word__list,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0n] :
             ...
             => ! [V1w] :
                  ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
                 => ap(ap(c_2Ewords_2Eword__replicate(A_27a,A_27a),V0n),V1w) = ap(c_2Ewords_2Econcat__word__list(A_27a,A_27a),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V1w)),V0n)) ) ) ) ) )).
