...
fof(conj_thm_2Emachine__ieee_2Efp64__sqrt,conjecture,
    ( ! [V0mode] :
        ( mem(V0mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V1a] :
           ...
           => ap(ap(c_2Emachine__ieee_2Efp64__sqrt,V0mode),ap(c_2Emachine__ieee_2Efloat__to__fp64,V1a)) = ap(c_2Emachine__ieee_2Efloat__to__fp64,ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(c_2Ebinary__ieee_2Efloat__sqrt(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Eone_2Eone))))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Eone_2Eone)))))),V0mode),V1a))) ) )
    & ! [V2mode] :
        ( mem(V2mode,ty_2Ebinary__ieee_2Erounding)
       => ! [V3a] :
            ( mem(V3a,ty_2Enum_2Enum)
           => ap(ap(c_2Emachine__ieee_2Efp64__sqrt,V2mode),ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))))),V3a)) = ap(c_2Emachine__ieee_2Efloat__to__fp64,ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(c_2Ebinary__ieee_2Efloat__sqrt(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Eone_2Eone))))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Eone_2Eone)))))),V2mode),ap(c_2Emachine__ieee_2Efp64__to__float,ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))))),V3a))))) ) ) )).
