...
tff(mem_c_2Ewords_2Ebit__count__upto,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Ebit__count__upto(A_27a),arr(ty_2Enum_2Enum,arr(ty_2Efcp_2Ecart(bool,bool),ty_2Enum_2Enum))) )).

tff(lmtp_f2187,type,(
    f2187: ( del * $i ) > $i )).

tff(lamtp_f2187,axiom,(
    ! [A_27a: del,V1w: $i] :
...
tff(lameq_f2187,axiom,(
    ! [A_27a: del,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2187(A_27a,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) )).

tff(ax_thm_2Ewords_2Ebit__count__upto__def,axiom,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => surj__ty_2Enum_2Enum(ap(ap(c_2Ewords_2Ebit__count__upto(A_27a),inj__ty_2Enum_2Enum(V0n)),V1w)) = surj__ty_2Enum_2Enum(ap(ap(c_2Esum__num_2ESUM,inj__ty_2Enum_2Enum(V0n)),f2187(A_27a,V1w))) ) )).

tff(conj_thm_2Ewords_2Ebit__count__upto__SUC,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ewords_2Ebit__count__upto(A_27a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))),V0w)) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),inj__ty_2Enum_2Enum(V1n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Ewords_2Ebit__count__upto(A_27a),inj__ty_2Enum_2Enum(V1n)),V0w))) ) )).
