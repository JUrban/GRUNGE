...
tff(conj_thm_2Ereal__topology_2EOPEN__UNION,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EOPEN__OPEN__IN__TRANS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__UNION__OPEN,conjecture,(
    ! [V0f: $i] :
