...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__WITHIN__INV,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) @ V1s ) ) )
                & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) )
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INV,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
