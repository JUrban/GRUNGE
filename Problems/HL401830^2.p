...
thf(conj_thm_2Epred__set_2ESUM__UNIV,lemma,(
    ! [A_27a: del,A_27b: del] :
...
thf(conj_thm_2Epred__set_2EINJ__INL,lemma,(
...
thf(conj_thm_2Epred__set_2EINJ__INR,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Epred__set_2Eunion__countable__IFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Epred__set_2Einj__image__countable__IFF,lemma,(
...
thf(conj_thm_2Epred__set_2Ecountable__Usum,conjecture,(
    ! [A_27a: del,A_27b: del] :
