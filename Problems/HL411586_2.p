...
tff(lamtp_f3763,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3763(A_27a,V1f,V2s),arr(A_27a,bool)) ) ) )).

tff(lameq_f3763,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3763(A_27a,V1f,V2s),V4x) = ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1f,V4x)),V2s) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__IN__CLOSED__SET,lemma,(
    ! [A_27a: del,V0net: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(c_2Ereal__topology_2EClosed,V2s))
                    & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3763(A_27a,V1f,V2s)),V0net))
...
tff(conj_thm_2Ereal__topology_2ELIM__COMPONENT__UBOUND,conjecture,(
