...
fof(lamtp_f3471,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => mem(f3471(V0x),arr(ty_2Enum_2Enum,bool)) ) )).

fof(lameq_f3471,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f3471(V0x),V1n) = ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),V0x),ap(c_2Eextreal_2Eextreal__of__num,V1n)) ) ) )).

fof(lamtp_f3470,axiom,(
    mem(f3470,arr(ty_2Eextreal_2Eextreal,bool)) )).

fof(lameq_f3470,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ap(f3470,V0x) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f3471(V0x)) ) )).

fof(conj_thm_2Eextreal_2Esup__num,lemma,(
    ap(c_2Eextreal_2Eextreal__sup,f3470) = c_2Eextreal_2EPosInf )).

fof(lamtp_f3478,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3478(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f3478,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ! [V2n] :
              ( mem(V2n,A_27a)
             => ap(f3478(A_27a,V0f,V1c),V2n) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(V0f,V2n)) ) ) ) )).

fof(conj_thm_2Eextreal_2Esup__cmul,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V1c] :
             ...
             => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V1c))
               => ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),f3478(A_27a,V0f,V1c)),c_2Epred__set_2EUNIV(A_27a))) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),c_2Epred__set_2EUNIV(A_27a)))) ) ) ) ) )).
...
fof(lamtp_f4149,axiom,(
    ! [A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2c] :
          ( mem(V2c,ty_2Erealax_2Ereal)
         => mem(f4149(A_27a,V1s,V2c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f4149,axiom,(
    ! [A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2c] :
          ( mem(V2c,ty_2Erealax_2Ereal)
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f4149(A_27a,V1s,V2c),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V2c)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s),V3x)) ) ) ) )).

fof(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__indicator,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ! [V2c] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                   ...
                   => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4149(A_27a,V1s,V2c)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Erealax_2Ereal__mul,V2c),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) ) ) )).
    ...
    ! [A_27a,V2fi] :
     ...
     => ! [V10x] :
         ...
         => ! [V11i] :
             ...
             => ap(f4159(A_27a,V2fi,V10x),V11i) = ap(ap(V2fi,V11i),V10x) ) ) ) )).

fof(lamtp_f4160,axiom,(
    ! [A_27a,V1f] :
    ...
    ! [A_27a,V13i] :
     ...
     => ! [V2fi] :
         ...
         => ! [V3A] :
             ...
             => ! [V14x] :
                  ( mem(V14x,A_27a)
                 => ap(f4162(A_27a,V13i,V2fi,V3A),V14x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(ap(V2fi,V13i),V14x)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V3A),V14x)) ) ) ) ) )).

fof(lamtp_f4161,axiom,(
    ! [A_27a,V3A] :
      ( mem(V3A,arr(A_27a,bool))
     => ! [V2fi] :
          ( mem(V2fi,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
    ...
    ! [A_27a,V3A] :
     ...
     => ! [V2fi] :
         ...
         => ! [V0m] :
             ...
             => ! [V13i] :
                  ( mem(V13i,ty_2Enum_2Enum)
                 => ap(f4161(A_27a,V3A,V2fi,V0m),V13i) = ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4162(A_27a,V13i,V2fi,V3A)) ) ) ) ) )).

fof(conj_thm_2Elebesgue_2Elebesgue__monotone__convergence__subset,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
                 ...
                 => ! [V3A] :
                     ...
                     => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                          & ! [V4i] :
                             ...
                             => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),ap(V2fi,V4i)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel))) )
                          & ! [V5i] :
                              ( mem(V5i,ty_2Enum_2Enum)
                             => ! [V6x] :
                                  ( mem(V6x,A_27a)
                                 => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(ap(V2fi,V5i),V6x))) ) )
                          & ! [V7x] :
                              ( mem(V7x,A_27a)
                             => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V1f,V7x))) )
                          & ! [V8x] :
                              ( mem(V8x,A_27a)
                       ...
                       => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4160(A_27a,V1f,V3A)) = ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f4161(A_27a,V3A,V2fi,V0m)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) ) ) ) ) )).

fof(lamtp_f4190,axiom,(
    ! [A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => mem(f4190(A_27a,V1s),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f4190,axiom,(
    ! [A_27a,V1s] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ap(f4190(A_27a,V1s),V2x) = ap(ap(c_2Eextreal_2Eextreal__mul,c_2Eextreal_2EPosInf),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s),V2x)) ) ) )).

fof(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__infty,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
               => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4190(A_27a,V1s)) = ap(ap(c_2Eextreal_2Eextreal__mul,c_2Eextreal_2EPosInf),ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s))) ) ) ) ) )).
