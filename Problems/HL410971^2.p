...
thf(conj_thm_2Ereal__topology_2EDENSE__IMP__PERFECT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( ap @ c_2Ereal__topology_2Eclosure @ V0s )
...
thf(conj_thm_2Ereal__topology_2EDENSE__LIMIT__POINTS,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ( ( ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ V2x ) @ V0s ) ) ) )
              = ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) )
          <=> ( ( ap @ c_2Ereal__topology_2Eclosure @ V0s )
              = ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) ) ) ) )).
