...
tff(conj_thm_2Eseq_2ESER__POS__LE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(c_2Eseq_2Esummable,V0f))
            & ! [V2m: tp__ty_2Enum_2Enum] :
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V0f,inj__ty_2Enum_2Enum(V2m)))) ) )
         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1n))),V0f)),ap(c_2Eseq_2Esuminf,V0f))) ) ) )).
...
tff(lamtp_f2960,axiom,(
    mem(f2960,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2960,axiom,(
    ! [V2n: tp__ty_2Enum_2Enum] : ap(f2960,inj__ty_2Enum_2Enum(V2n)) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,inj__ty_2Enum_2Enum(V2n)))) )).

tff(lmtp_f2959,type,(
    f2959: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2959,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2959(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2959,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2959(V0x),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Erealax_2Ereal__mul,ap(f2960,inj__ty_2Enum_2Enum(V1n))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Enum_2Enum(V1n))) )).

tff(ax_thm_2Etransc_2Eexp,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(c_2Eseq_2Esuminf,f2959(V0x))) )).

tff(conj_thm_2Etransc_2EEXP__CONVERGES,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Eseq_2Esums,f2959(V0x)),ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x)))) )).
...
tff(conj_thm_2Etransc_2EEXP__LE__X,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x)))) ) )).
