...
tff(lamtp_f1713,axiom,(
    ! [A_27b: del,A_27a: del,V1x: $i] :
      ( mem(V1x,ty_2Epair_2Eprod(A_27a,A_27a))
     => mem(f1713(A_27b,A_27a,V1x),arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)) ) )).
...
tff(lameq_f1713,axiom,(
    ! [A_27b: del,A_27a: del,V1x: $i] :
     ...
     => ! [V3y: $i] :
          ( mem(V3y,ty_2Epair_2Eprod(A_27a,A_27a))
         => ap(f1713(A_27b,A_27a,V1x),V3y) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V1x)),ap(c_2Epair_2EFST(A_27a,A_27a),V3y))) ) ) )).

tff(conj_thm_2Eupdate_2EOVERRIDE__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),bool))
     => ( ( p(ap(V0P,c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))))
          & ! [V1x: $i] :
              ( mem(V1x,ty_2Epair_2Eprod(A_27a,A_27a))
             => ! [V2t: $i] :
                  ( mem(V2t,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                 => ( p(ap(V0P,ap(ap(c_2Elist_2EFILTER(ty_2Epair_2Eprod(A_27a,A_27a)),f1713(A_27b,A_27a,V1x)),V2t)))
                   => p(ap(V0P,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),V1x),V2t))) ) ) ) )
       => ! [V4v: $i] :
            ( mem(V4v,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
           => p(ap(V0P,V4v)) ) ) ) )).
