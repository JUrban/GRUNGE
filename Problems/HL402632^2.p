...
thf(conj_thm_2Erich__list_2ECOMM__MONOID__FOLDR,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27a @ A_27a ) ) )
       ...
       => ! [V1e_27: $i] :
           ...
           => ( ( p @ ( ap @ ( ap @ ( c_2Ecombin_2EMONOID @ A_27a ) @ V0f ) @ V1e_27 ) )
             => ! [V2e: $i] :
                 ...
                 => ! [V3l: $i] :
                      ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27a ) )
                     => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27a ) @ V0f ) @ V2e ) @ V3l )
                        = ( ap @ ( ap @ V0f @ V2e ) @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27a ) @ V0f ) @ V1e_27 ) @ V3l ) ) ) ) ) ) ) ) ) )).
