...
fof(conj_thm_2Eset__relation_2Erange__mono,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0r] :
             ...
             => ! [V1r_27] :
                 ...
                 => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Epair_2Eprod(A_27a,A_27a)),V0r),V1r_27))
                   => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(c_2Eset__relation_2Erange(A_27b,A_27b),V0r)),ap(c_2Eset__relation_2Erange(A_27b,A_27b),V1r_27))) ) ) ) ) ) )).
