...
thf(f12731_0_2E0,type,(
    f12731_0_2E0: u )).

thf(f12731_0_2E2,type,(
    f12731_0_2E2: du > du > u )).

thf(f12731_0_2E3,type,(
    f12731_0_2E3: du > du > du > u )).

thf(f12731_1_2E0,type,(
    f12731_1_2E0: u )).

thf(f12731_1_2E2,type,(
    f12731_1_2E2: du > du > u )).

thf(f12731_1_2E3,type,(
    f12731_1_2E3: du > du > du > u )).

thf(f12731_2_2E0,type,(
    f12731_2_2E0: u )).

thf(f12731_2_2E2,type,(
    f12731_2_2E2: du > du > u )).

thf(f12731_2_2E3,type,(
...
thf(mono_2Ef12731_0,type,(
    mono_2Ef12731_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12731_1,type,(
    mono_2Ef12731_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12731_2,type,(
    mono_2Ef12731_2: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EAFFINITY__INVERSES,axiom,(
    ! [V0m: mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal,V6x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12731_1 @ V0m @ V1c @ V6x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Erealax_2Einv @ V0m ) @ V6x ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Erealax_2Einv @ V0m ) @ V1c ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EAFFINITY__INVERSES,axiom,(
    ! [V0m: mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal,V7x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12731_2 @ V0m @ V1c @ V7x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0m @ V7x ) @ V1c ) ) )).

thf(def2_2Ethm_2Ereal__topology_2EAFFINITY__INVERSES,axiom,(
    ! [V0m: mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12731_0 @ V0m @ V1c @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0m @ V3x ) @ V1c ) ) )).

thf(thm_2Ereal__topology_2EAFFINITY__INVERSES,conjecture,(
    ! [V0m: mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0m
          = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ( ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12731_0 @ V0m @ V1c ) @ ( mono_2Ef12731_0 @ ( mono_2Ec_2Erealax_2Einv @ V0m ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Erealax_2Einv @ V0m ) @ V1c ) ) ) @ V2x )
            = V2x )
        & ! [V5x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12731_1 @ V0m @ V1c ) @ ( mono_2Ef12731_2 @ V0m @ V1c ) @ V5x )
            = V5x ) ) ) )).
