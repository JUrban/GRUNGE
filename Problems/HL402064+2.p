...
fof(lamtp_f371,axiom,(
    ! [A_27a,A_27a,V2e] :
      ( mem(V2e,A_27a)
     => mem(f371(A_27a,A_27a,V2e),arr(arr(A_27a,bool),arr(A_27a,bool))) ) )).

fof(lameq_f371,axiom,(
    ! [A_27a,A_27a,V2e] :
      ( mem(V2e,A_27a)
     => ! [V4es] :
          ( mem(V4es,arr(A_27a,bool))
         => ap(f371(A_27a,A_27a,V2e),V4es) = ap(ap(c_2Epred__set_2EDELETE(A_27a),V4es),V2e) ) ) )).

fof(lamtp_f370,axiom,(
    ! [A_27a,A_27a,V2e] :
      ( mem(V2e,A_27a)
     => ! [V1xss] :
          ( mem(V1xss,arr(arr(A_27a,bool),bool))
         => mem(f370(A_27a,A_27a,V2e,V1xss),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).
...
fof(lameq_f370,axiom,(
    ! [A_27a,A_27a,V2e] :
     ...
     => ! [V1xss] :
          ( mem(V1xss,arr(arr(A_27a,bool),bool))
         => ! [V3es] :
              ( mem(V3es,arr(A_27a,bool))
             => ap(f370(A_27a,A_27a,V2e,V1xss),V3es) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V3es),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V3es),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27a,bool),arr(A_27a,bool)),f371(A_27a,A_27a,V2e)),V1xss))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V3es),c_2Epred__set_2EEMPTY(A_27a))))) ) ) ) )).

fof(conj_thm_2Eset__relation_2Eper__delete,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0xs] :
          ( mem(V0xs,arr(A_27a,bool))
         => ! [V1xss] :
             ...
             => ! [V2e] :
                  ( mem(V2e,A_27a)
                 => ( p(ap(ap(c_2Eset__relation_2Eper(A_27a),V0xs),V1xss))
                   => p(ap(ap(c_2Eset__relation_2Eper(A_27a),ap(ap(c_2Epred__set_2EDELETE(A_27a),V0xs),V2e)),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f370(A_27a,A_27a,V2e,V1xss)))) ) ) ) ) ) )).
