...
thf(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__NEXT__THM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ( ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V3t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V3t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V4t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V4t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V4t ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V5t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V5t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V5t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V6t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V6t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V6t ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V7t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V7t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V7t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V8t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V9t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V9t ) ) @ ( ap @ V2c @ V9t ) ) ) )
                            @ V8t ) )
                        @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V8t ) )
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V10t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V10t ) ) @ ( ap @ V1b @ V10t ) ) ) )
                            @ V8t ) ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V11t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V11t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1b ) @ V2c ) @ V11t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V12t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V13t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V13t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V13t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V13t ) ) ) ) ) )
                            @ V12t ) )
                        @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1b ) @ V2c ) @ V12t ) )
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V14t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V14t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V14t ) ) ) ) )
                            @ V12t ) ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V15t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V15t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V15t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V16t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V16t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V16t ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V17t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V17t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V17t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V18t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V18t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V18t ) ) ) )
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V19t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V19t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V19t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V20t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V21t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V21t ) ) @ ( ap @ V2c @ V21t ) ) ) )
                            @ V20t ) )
                ...
                & ( ( ap @ c_2ETemporal__Logic_2ENEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V22t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V22t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1b ) @ V2c ) @ V22t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V23t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_2F_5C
                          @ ( ap
                            @ ( ap @ c_2ETemporal__Logic_2ENEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V24t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V24t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V24t ) ) ) ) )
                            @ V23t ) )
