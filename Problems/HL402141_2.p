...
tff(lamtp_f400,axiom,(
    ! [A_27a: del,A_27a: del,V0L1: $i] :
...
tff(lamtp_f398,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del] : mem(f398(A_27a,A_27a,A_27a),arr(ty_2Elist_2Elist(A_27a),arr(ty_2Elist_2Elist(A_27a),bool))) )).

tff(lameq_f398,axiom,(
    ! [A_27a: del,A_27a: del,A_27a: del,V0L1: $i] :
      ( mem(V0L1,ty_2Elist_2Elist(A_27a))
     => ap(f398(A_27a,A_27a,A_27a),V0L1) = f399(A_27a,A_27a,V0L1) ) )).

tff(conj_thm_2Elist_2EWF__LIST__PRED,conjecture,(
    ! [A_27a: del] : p(ap(c_2Erelation_2EWF(ty_2Elist_2Elist(A_27a)),f398(A_27a,A_27a,A_27a))) )).
