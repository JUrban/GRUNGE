...
fof(conj_thm_2Ewords_2EWORD__w2w__OVER__MUL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(c_2Ewords_2Eword__mul(A_27a),V0a),V1b)) = ap(ap(ap(c_2Ewords_2Eword__bits(A_27b),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__mul(A_27b),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0a)),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V1b))) ) ) ) ) )).
