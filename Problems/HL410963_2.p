...
tff(lamtp_f3797,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3797(V1f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3797,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3797(V1f),inj__ty_2Erealax_2Ereal(V6x)) = ap(V1f,inj__ty_2Erealax_2Ereal(V6x)) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__CONG__WITHIN,conjecture,(
     ...
     => ! [V2g: $i] :
         ...
         => ! [V3l: tp__ty_2Erealax_2Ereal,V4s: $i] :
             ...
             => ( ! [V5x: tp__ty_2Erealax_2Ereal] :
               ...
               => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3797(V1f)),inj__ty_2Erealax_2Ereal(V3l)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0a))),V4s)))
