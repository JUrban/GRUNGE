...
fof(conj_thm_2Epred__set_2EFINITE__INTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s1] :
...
fof(conj_thm_2Ecardinal_2EGE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ecardinal_2EINJECTIVE__ON__LEFT__INVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eiterate_2ESUM__DIFF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Eiterate_2ESUM__ABS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V1s] :
              ( mem(V1s,arr(A_27a,bool))
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(A_27a),V1s),V0f))),ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3362(A_27a,V0f)))) ) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( ! [V3x] :
                           ...
                           => ! [V4y] :
                               ...
                               => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                                 ...
                                 => V3x = V4y ) ) )
                       => ap(ap(c_2Eiterate_2ESum(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),V1g) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V1g),V0f)) ) ) ) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__SUBSET__SIMPLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0u] :
...
fof(conj_thm_2Ereal__topology_2EREAL__HALF,lemma,
    ( ! [V0e] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__CAUCHY,lemma,(
    ! [V0f] :
               ...
               => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2e))
                 => ? [V3N] :
                      ...
                      & ! [V4m] :
                         ...
                         => ! [V5n] :
                              ( mem(V5n,ty_2Enum_2Enum)
                             => ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V4m),V3N))
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,V4m),V5n))),V0f))),V2e)) ) ) ) ) ) ) ) ) ) )).

fof(lamtp_f4039,axiom,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f4039(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f4039,axiom,(
    ! [V0x] :
     ...
     => ! [V3n] :
          ( mem(V3n,ty_2Enum_2Enum)
         => ap(f4039(V0x),V3n) = ap(c_2Ereal_2Eabs,ap(V0x,V3n)) ) ) )).

fof(lamtp_f4052,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Enum_2Enum,bool))
     => ! [V0x] :
          ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2f] :
             ...
             => mem(f4052(V1s,V0x,V2f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).

fof(lameq_f4052,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Enum_2Enum,bool))
     => ! [V0x] :
          ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2f] :
             ...
             => ! [V6n] :
                  ( mem(V6n,ty_2Enum_2Enum)
                 => ap(f4052(V1s,V0x,V2f),V6n) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s)),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V6n))),V0x)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V6n))),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0x),V2f))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE__STRONG,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2f] :
              ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1s)),f4039(V0x)))
                  & ! [V4m] :
                      ( mem(V4m,ty_2Enum_2Enum)
                     => ! [V5n] :
                          ( mem(V5n,ty_2Enum_2Enum)
                         => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4m),V1s))
                              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5n),V1s))
                              & ap(V2f,V4m) = ap(V2f,V5n) )
                           => V4m = V5n ) ) ) )
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4052(V1s,V0x,V2f)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).
