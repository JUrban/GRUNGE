...
tff(thm_2Ereal_2EREAL__LE__SUP,axiom,(
    ! [V0p_2E0: tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool),V1x_2E0: tyop_2Erealax_2Ereal] :
      ( ( ? [V2y_2E0: tyop_2Erealax_2Ereal] : p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V2y_2E0))
        & ? [V3y_2E0: tyop_2Erealax_2Ereal] :
          ! [V4z_2E0: tyop_2Erealax_2Ereal] :
            ( p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V4z_2E0))
           => p(c_2Ereal_2Ereal__lte_2E2(V4z_2E0,V3y_2E0)) ) )
     => ( p(c_2Ereal_2Ereal__lte_2E2(V1x_2E0,c_2Ereal_2Esup_2E1(V0p_2E0)))
      <=> ! [V5y_2E0: tyop_2Erealax_2Ereal] :
            ( ! [V6z_2E0: tyop_2Erealax_2Ereal] :
                ( p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V6z_2E0))
               => p(c_2Ereal_2Ereal__lte_2E2(V6z_2E0,V5y_2E0)) )
           => p(c_2Ereal_2Ereal__lte_2E2(V1x_2E0,V5y_2E0)) ) ) ) )).
    ...
    ! [V0p_2E0: tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool),V1x_2E0: tyop_2Erealax_2Ereal] :
      ( ( ? [V2y_2E0: tyop_2Erealax_2Ereal] : p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V2y_2E0))
        & ? [V3y_2E0: tyop_2Erealax_2Ereal] :
          ! [V4z_2E0: tyop_2Erealax_2Ereal] :
            ( p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V4z_2E0))
           => p(c_2Ereal_2Ereal__lte_2E2(V3y_2E0,V4z_2E0)) ) )
     => ( p(c_2Ereal_2Ereal__lte_2E2(c_2Ereal_2Einf_2E1(V0p_2E0),V1x_2E0))
      <=> ! [V5y_2E0: tyop_2Erealax_2Ereal] :
            ( ! [V6z_2E0: tyop_2Erealax_2Ereal] :
                ( p(app_2E2(tyop_2Erealax_2Ereal,tyop_2Emin_2Ebool,V0p_2E0,V6z_2E0))
               => p(c_2Ereal_2Ereal__lte_2E2(V5y_2E0,V6z_2E0)) )
           => p(c_2Ereal_2Ereal__lte_2E2(V5y_2E0,V1x_2E0)) ) ) ) )).
