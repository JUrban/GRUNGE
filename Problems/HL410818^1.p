...
thf(thm_2Ereal__topology_2EFRONTIER__CLOSED,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Ereal__topology_2Efrontier @ V0s ) ) )).

thf(thm_2Ereal__topology_2EINTERIOR__FRONTIER__EMPTY,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2EOpen @ V0s )
        | ( mono_2Ec_2Ereal__topology_2EClosed @ V0s ) )
     => ( ( mono_2Ec_2Ereal__topology_2Einterior @ ( mono_2Ec_2Ereal__topology_2Efrontier @ V0s ) )
        = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )).

thf(thm_2Ereal__topology_2EFRONTIER__FRONTIER,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2EOpen @ V0s )
        | ( mono_2Ec_2Ereal__topology_2EClosed @ V0s ) )
     => ( ( mono_2Ec_2Ereal__topology_2Efrontier @ ( mono_2Ec_2Ereal__topology_2Efrontier @ V0s ) )
        = ( mono_2Ec_2Ereal__topology_2Efrontier @ V0s ) ) ) )).
