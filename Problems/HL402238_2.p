...
tff(lamtp_f426,axiom,(
    ! [A_27b: del,A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,A_27b))
         => mem(f426(A_27b,A_27a,V0l,V1f),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f426,axiom,(
    ! [A_27b: del,A_27a: del,V0l: $i] :
     ...
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,A_27b))
         => ! [V3x: tp__ty_2Enum_2Enum] : ap(f426(A_27b,A_27a,V0l,V1f),inj__ty_2Enum_2Enum(V3x)) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V3x)),V0l)),ap(V1f,inj__ty_2Enum_2Enum(V3x))) ) ) )).

tff(conj_thm_2Elist_2EZIP__GENLIST,conjecture,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2n: tp__ty_2Enum_2Enum] :
             ...
             => ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l),ap(ap(c_2Elist_2EGENLIST(A_27b),V1f),inj__ty_2Enum_2Enum(V2n)))) = ap(ap(c_2Elist_2EGENLIST(ty_2Epair_2Eprod(A_27a,A_27a)),f426(A_27b,A_27a,V0l,V1f)),inj__ty_2Enum_2Enum(V2n)) ) ) ) )).
