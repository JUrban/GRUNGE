...
tff(conj_thm_2Ehreal_2EHRAT__LT__REFL,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat] : ~ p(ap(ap(c_2Ehreal_2Ehrat__lt,inj__ty_2Ehrat_2Ehrat(V0x)),inj__ty_2Ehrat_2Ehrat(V0x))) )).

tff(conj_thm_2Ehreal_2EHRAT__LT__NE,conjecture,(
