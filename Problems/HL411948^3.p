...
thf(thm_2Ereal__topology_2ELOCALLY__INTER,axiom,(
    ! [V0P: ( tyop_2Erealax_2Ereal > $o ) > $o] :
      ( ! [V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
          ( ( ( V0P @ V1s )
            & ( V0P @ V2t ) )
         => ( V0P @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V1s @ V2t ) ) )
     => ! [V3s: tyop_2Erealax_2Ereal > $o,V4t: tyop_2Erealax_2Ereal > $o] :
          ( ( ( c_2Ereal__topology_2Elocally @ V0P @ V3s )
            & ( c_2Ereal__topology_2Elocally @ V0P @ V4t ) )
         => ( c_2Ereal__topology_2Elocally @ V0P @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V3s @ V4t ) ) ) ) )).
