...
tff(mem_c_2Ewords_2Ereduce__xnor,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Ereduce__xnor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(mem_c_2Ewords_2Eword__xnor,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__xnor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).

tff(lmtp_f2169,type,(
    f2169: ( del * $i * $i ) > $i )).

tff(lamtp_f2169,axiom,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2169(A_27a,V0v,V1w),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2169,axiom,(
    ! [A_27a: del,V0v: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2169(A_27a,V0v,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),inj__ty_2Enum_2Enum(V2i))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i))) ) ) )).
...
tff(ax_thm_2Ewords_2Eword__xnor__def,axiom,(
    ! [A_27a: del,V0v: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Ewords_2Eword__xnor(A_27a),V0v),V1w) = ap(c_2Efcp_2EFCP(bool,bool),f2169(A_27a,V0v,V1w)) ) ) )).
...
tff(lamtp_f2239,axiom,(
    mem(f2239,arr(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2239,axiom,(
    ! [V1l: tp__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] : ap(f2239,inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l)) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__xnor(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l))),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l))) )).

tff(conj_thm_2Ewords_2Efoldl__reduce__xnor,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(c_2Ewords_2Ereduce__xnor(A_27a),V0w)) = surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2239),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))) ) )).
