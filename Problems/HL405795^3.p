...
thf(c_2Ewords_2Es2w,type,(
    c_2Ewords_2Es2w: 
      !>[A_27a: $tType] :
        ( tyop_2Enum_2Enum > ( tyop_2Estring_2Echar > tyop_2Enum_2Enum ) > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) ) )).

thf(c_2Ewords_2Ew2s,type,(
    c_2Ewords_2Ew2s: 
      !>[A_27a: $tType] :
        ( tyop_2Enum_2Enum > ( tyop_2Enum_2Enum > tyop_2Estring_2Echar ) > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) ) )).

thf(c_2Ewords_2Eword__from__oct__string,type,(
    c_2Ewords_2Eword__from__oct__string: 
      !>[A_27a: $tType] :
        ( ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) ) )).

thf(c_2Ewords_2Eword__to__oct__string,type,(
    c_2Ewords_2Eword__to__oct__string: 
      !>[A_27a: $tType] :
        ( ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) ) )).
...
thf(thm_2Ewords_2Eword__oct__string,conjecture,(
    ! [A_27a: $tType] :
