...
thf(thm_2EHolSmt_2ENOT__MEM__CONS,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1h_2E0: u,V2t_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2t_2E0 ) ) ) ) ) ) ) ) )
    <=> ( ( (~)
          @ ( ( s @ A_27a @ V0x_2E0 )
            = ( s @ A_27a @ V1h_2E0 ) ) )
        & ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2t_2E0 ) ) ) ) ) ) ) ) ) )).
