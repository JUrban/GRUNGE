...
fof(conj_thm_2Einteger_2ETINT__LT__TOTAL,lemma,(
    ! [V0x] :
...
fof(ax_thm_2Einteger_2EINT__MIN,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ap(ap(c_2Einteger_2Eint__min,V0x),V1y) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Einteger_2Eint),ap(ap(c_2Einteger_2Eint__lt,V0x),V1y)),V0x),V1y) ) ) )).

fof(conj_thm_2Einteger_2EINT__MIN__LT,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
