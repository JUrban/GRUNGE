...
thf(f2386_0_2E0,type,(
    f2386_0_2E0: u )).

thf(f2386_0_2E1,type,(
    f2386_0_2E1: du > u )).
...
thf(mono_2Ef2386_0,type,(
    mono_2Ef2386_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Elist_2EEL__compute,axiom,(
    ! [V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2386_0 @ V1n )
    <=> ( V1n = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Elist_2EEL__compute,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ...
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2386_0 @ V1n ) ) ) @ ( s @ A_27a @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2EPRE @ V1n ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) ) ) )).
