...
fof(conj_thm_2Ewellorder_2EZL__SUBSETS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
...
fof(conj_thm_2Ewellorder_2EZL__SUBSETS__BIGUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
                    ...
                    & ! [V3x] :
                       ...
                       => ! [V4y] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V3x),V1c))
                             ...
                             => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V3x),V4y))
                                | p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V4y),V3x)) ) ) ) ) )
                 => p(ap(V0P,ap(c_2Epred__set_2EBIGUNION(A_27a),V1c))) ) )
           => ? [V5a] :
                ...
                & ! [V6x] :
                    ( mem(V6x,arr(A_27a,bool))
                   => ( ( p(ap(V0P,V6x))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V5a),V6x)) )
                     => V5a = V6x ) ) ) ) ) ) )).
