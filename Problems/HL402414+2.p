...
fof(conj_thm_2Estate__transformer_2ESND__o__UNIT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
              ( mem(V0x,A_27a)
             => ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Epair_2ESND(A_27a,A_27a)),ap(c_2Estate__transformer_2EUNIT(A_27b,A_27b),V0x)) = c_2Ecombin_2EI(A_27b) ) ) ) )).
