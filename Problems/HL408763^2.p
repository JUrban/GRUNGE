...
thf(conj_thm_2EHolSmt_2Er142,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1u: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V3v: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V1u ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) )
    <=> ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1u ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V3v ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) )
        = V0a ) ) )).
