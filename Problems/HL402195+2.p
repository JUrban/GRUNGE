...
fof(conj_thm_2Elist_2ESUM__MAP__MEM__bound,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1x] :
             ...
             => ! [V2ls] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Elist_2ELIST__TO__SET(A_27a),V2ls)))
                   => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(V0f,V1x)),ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2ls)))) ) ) ) ) ) )).
