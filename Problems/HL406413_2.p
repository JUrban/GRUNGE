...
tff(conj_thm_2Ecardinal_2ECARDEQ__INSERT__RWT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eucord_2EUnum__cardle__ucinf,lemma,(
...
tff(conj_thm_2Eucord_2Eucord__sup__exists__lemma,conjecture,(
