...
fof(conj_thm_2Epred__set_2EITSET__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2ECOMMUTING__ITSET__RECURSES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lameq_f3171,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V2e] :
          ( mem(V2e,A_27a)
         => ! [V3acc] :
              ( mem(V3acc,ty_2Erealax_2Ereal)
             => ap(f3171(A_27a,V0f,V2e),V3acc) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V2e)),V3acc) ) ) ) )).

fof(lamtp_f3170,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
    ...
    ! [A_27a] :
     ...
     => ! [V0f] :
         ...
         => ! [V1s] :
             ...
             => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V0f),V1s) = ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),f3170(A_27a,V0f)),V1s),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) ) )).

fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
