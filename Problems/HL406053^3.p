...
thf(thm_2Ewords_2Eword__lsr__def,axiom,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ...
      = ( c_2Efcp_2EFCP @ $o @ A_27a
        @ ^ [V2i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_2F_5C @ ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2E_2B @ V2i @ V1n ) @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V0w @ ( c_2Earithmetic_2E_2B @ V2i @ V1n ) ) ) ) ) )).
...
thf(thm_2Ewords_2ELSL__ONE,axiom,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ewords_2Eword__lsl @ A_27a @ V0w @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) )
      = ( c_2Ewords_2Eword__add @ A_27a @ V0w @ V0w ) ) )).

thf(thm_2Ewords_2ESHIFT__1__SUB__1,axiom,(
    ! [A_27a: $tType,V0i: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0i @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ( ( c_2Efcp_2Efcp__index @ $o @ A_27a @ ( c_2Ewords_2Eword__sub @ A_27a @ ( c_2Ewords_2Eword__lsl @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1n ) @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0i )
        = ( c_2Eprim__rec_2E_3C @ V0i @ V1n ) ) ) )).

thf(thm_2Ewords_2Eword__extract__w2w__mask,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2a: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ewords_2Eword__extract @ A_27a @ A_27b @ V0h @ V1l @ V2a )
      = ( c_2Ewords_2Ew2w @ A_27a @ A_27b @ ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Earithmetic_2E_3C_3D @ V1l @ V0h ) @ ( c_2Ewords_2Eword__and @ A_27a @ ( c_2Ewords_2Eword__lsr @ A_27a @ V2a @ V1l ) @ ( c_2Ewords_2Eword__sub @ A_27a @ ( c_2Ewords_2Eword__lsl @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2E_2D @ V0h @ V1l ) ) @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) ) ) )).
