...
tff(ax_thm_2Epatricia_2EADD__LIST__def,axiom,(
    ! [A_27a: del] : c_2Epatricia_2EADD__LIST(A_27a) = ap(c_2Elist_2EFOLDL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epatricia_2EADD(A_27a)) )).
...
tff(conj_thm_2Epatricia_2EADD__LIST__IS__PTREE,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
     => ! [V1l: $i] :
