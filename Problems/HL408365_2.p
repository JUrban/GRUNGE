...
tff(lmtp_f2987,type,(
    f2987: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2987,axiom,(
    ! [V0y: tp__ty_2Erealax_2Ereal] : mem(f2987(V0y),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2987,axiom,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f2987(V0y),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V0y)))) )).

tff(conj_thm_2Etransc_2ECOS__TOTAL,lemma,(
...
tff(ax_thm_2Etransc_2Eacs,axiom,(
    ! [V0y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eacs,inj__ty_2Erealax_2Ereal(V0y))) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2987(V0y))) )).

tff(conj_thm_2Etransc_2EACS,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Erealax_2Ereal(V0y)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0y)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )
