...
fof(conj_thm_2Ereal__topology_2EOPEN__IN__SUBTOPOLOGY__INTER__SUBSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1u] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__BIGUNION,lemma,(
    ! [V0s] :
     ...
     => ( ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),V0s))
       ...
       => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0s))) ) ) )).

fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__COMPACT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
      <=> ! [V1k] :
