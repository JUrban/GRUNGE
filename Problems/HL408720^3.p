...
thf(thm_2EHolSmt_2Er099,conjecture,(
    ! [V0y: tyop_2Einteger_2Eint,V1x: tyop_2Einteger_2Eint] :
      ( ( c_2Einteger_2Eint__gt @ V1x @ V0y )
    <=> ( (~) @ ( c_2Einteger_2Eint__ge @ ( c_2Einteger_2Eint__add @ V0y @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V1x ) ) @ ( c_2Einteger_2Eint__of__num @ c_2Enum_2E0 ) ) ) ) )).
