...
tff(conj_thm_2Ecardinal_2ECARD__LE__ADDL,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__ADD__ABSORB,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ( ( ~ p(ap(c_2Epred__set_2EFINITE(A_27b),V1t))
              & p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s),V1t)) )
           => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t)),V1t)) ) ) ) )).
