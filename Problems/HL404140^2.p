...
thf(conj_thm_2Ellist_2ELHDTL__EQ__SOME,lemma,(
    ! [A_27a: del,V0h: $i] :
      ( ( mem @ V0h @ A_27a )
     => ! [V1t: $i] :
         ...
         => ! [V2ll: $i] :
             ...
             => ( ( V2ll
              ...
              <=> ( ( ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ V2ll )
                    = ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V0h ) )
                  & ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V2ll )
                    = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V1t ) ) ) ) ) ) ) )).

thf(conj_thm_2Ellist_2Ellist__Axiom,lemma,(
...
thf(conj_thm_2Epath_2Epath__Axiom,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
                              ...
                              @ ^ [V5v3: $i] :
                                  ...
                                  @ ( lam @ A_27c
                                    @ ^ [V6l: $i] :
                                        ( lam @ A_27a
                                        @ ^ [V7v: $i] :
                                            ( ap @ ( ap @ ( ap @ ( c_2Epath_2Epcons @ A_27b @ A_27c ) @ V3y ) @ V6l ) @ ( ap @ V1g @ V7v ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
