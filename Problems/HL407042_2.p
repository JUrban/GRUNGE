...
tff(lmtp_f2695,type,(
    f2695: ( tp__c_ty_2Elist_2Elist_o * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2695,axiom,(
    ! [V2bs: tp__c_ty_2Elist_2Elist_o,V0n: tp__ty_2Enum_2Enum] : mem(f2695(V2bs,V0n),arr(bool,ty_2Einteger_2Eint)) )).

tff(lameq_f2695,axiom,(
    ! [V2bs: tp__c_ty_2Elist_2Elist_o,V0n: tp__ty_2Enum_2Enum,V3r: tp__o] : ap(f2695(V2bs,V0n),inj__o(V3r)) = ap(c_2Eint__bitwise_2Eint__of__bits,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Elist_2EAPPEND(bool),ap(ap(c_2Elist_2EGENLIST(bool),ap(c_2Ecombin_2EK(bool,bool),inj__o(fo__c_2Ebool_2EF))),inj__ty_2Enum_2Enum(V0n))),inj__c_ty_2Elist_2Elist_o(V2bs))),inj__o(V3r))) )).

tff(lmtp_f2694,type,(
    f2694: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f2694,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f2694(V0n),arr(ty_2Elist_2Elist(bool),arr(bool,ty_2Einteger_2Eint))) )).

tff(lameq_f2694,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V2bs: tp__c_ty_2Elist_2Elist_o] : ap(f2694(V0n),inj__c_ty_2Elist_2Elist_o(V2bs)) = f2695(V2bs,V0n) )).

tff(ax_thm_2Eint__bitwise_2Eint__shift__left__def,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Einteger_2Eint] : surj__ty_2Einteger_2Eint(ap(ap(c_2Eint__bitwise_2Eint__shift__left,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Einteger_2Eint(V1i))) = surj__ty_2Einteger_2Eint(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool))),ap(c_2Epair_2EUNCURRY(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2694(V0n))),ap(c_2Eint__bitwise_2Ebits__of__int,inj__ty_2Einteger_2Eint(V1i)))) )).
...
tff(conj_thm_2Eint__bitwise_2Eint__bit__shift__left,conjecture,(
