...
tff(lamtp_f1,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f1(A_27a,A_27a),arr(arr(A_27a,bool),bool)) )).

tff(lameq_f1,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ap(f1(A_27a,A_27a),V0P) = ap(ap(c_2Emin_2E_3D(arr(A_27a,bool)),V0P),k(A_27a,c_2Ebool_2ET)) ) )).

tff(ax_thm_2Ebool_2EFORALL__DEF,axiom,(
    ! [A_27a: del] : c_2Ebool_2E_21(A_27a) = f1(A_27a,A_27a) )).
...
tff(conj_thm_2Equotient_2EFORALL__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
