...
fof(conj_thm_2Earithmetic_2EMODEQ__MULT__CONG,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x0] :
          ( mem(V1x0,ty_2Enum_2Enum)
...
fof(conj_thm_2Earithmetic_2EMODEQ__NUMERAL,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
...
fof(conj_thm_2Eint__bitwise_2Eint__not__not,lemma,(
    ! [V0i] :
      ( mem(V0i,ty_2Einteger_2Eint)
...
fof(conj_thm_2Eint__bitwise_2Eint__bit__int__of__bits,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1b] :
