...
fof(conj_thm_2Ereal_2EABS__SIGN,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lameq_f2997,axiom,(
    ! [V1g1] :
     ...
     => ! [V2g2] :
         ...
         => ! [V3x] :
              ( mem(V3x,ty_2Erealax_2Ereal)
             => ap(f2997(V1g1,V2g2),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__lt,ap(V1g1,V3x)),ap(V2g2,V3x))),ap(V1g1,V3x)),ap(V2g2,V3x)) ) ) ) )).

fof(conj_thm_2Etransc_2EGAUGE__MIN,lemma,(
    ! [V0E] :
...
fof(conj_thm_2Etransc_2EFINE__MIN,lemma,(
    ! [V0g1] :
      ( mem(V0g1,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g2] :
          ( mem(V1g2,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__DINT,lemma,(
    ! [V0f] :
     ...
     => ! [V1a] :
         ...
         => ! [V2b] :
             ...
             => ( p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f))
               => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f),ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f))) ) ) ) ) )).

fof(conj_thm_2Eintegral_2ETDIV__BOUNDS,lemma,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1p] :
          ( mem(V1p,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2a] :
             ...
             => ! [V3b] :
                 ...
                 => ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V0d),V1p)))
                   => ! [V4n] :
                        ( mem(V4n,ty_2Enum_2Enum)
                       => ( p(ap(ap(c_2Ereal_2Ereal__lte,V2a),ap(V0d,V4n)))
                          & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,V4n)),V3b))
                          & p(ap(ap(c_2Ereal_2Ereal__lte,V2a),ap(V1p,V4n)))
                          & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V1p,V4n)),V3b)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EREAL__LE__RMUL1,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ! [V2z] :
              ( mem(V2z,ty_2Erealax_2Ereal)
             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V0x),V1y))
                  & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2z)) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,V0x),V2z)),ap(ap(c_2Erealax_2Ereal__mul,V1y),V2z))) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRAL__LE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
