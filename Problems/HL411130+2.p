...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__AT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
             ...
             => ! [V3d] :
                 ...
                 => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V3d))
                      & ! [V4x_27] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x_27),V2x))),V3d))
                           => ap(V0f,V4x_27) = ap(V1g,V4x_27) ) )
                      & p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V2x))) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V1g),ap(c_2Ereal__topology_2Eat,V2x))) ) ) ) ) ) )).
