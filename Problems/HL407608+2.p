...
fof(conj_thm_2EordinalNotation_2Eoless__cases,conjecture,(
    ! [V0a0] :
      ( mem(V0a0,ty_2EordinalNotation_2Eosyntax)
     => ! [V1a1] :
          ( mem(V1a1,ty_2EordinalNotation_2Eosyntax)
         => ( p(ap(ap(c_2EordinalNotation_2Eoless,V0a0),V1a1))
          <=> ( ? [V2k1] :
                  ( mem(V2k1,ty_2Enum_2Enum)
                  & ? [V3k2] :
                      ( mem(V3k2,ty_2Enum_2Enum)
                      & V0a0 = ap(c_2EordinalNotation_2EEnd,V2k1)
                      & V1a1 = ap(c_2EordinalNotation_2EEnd,V3k2)
                      & p(ap(ap(c_2Eprim__rec_2E_3C,V2k1),V3k2)) ) )
              | ? [V4k1] :
                  ( mem(V4k1,ty_2Enum_2Enum)
                  & ? [V5e2] :
                      ( mem(V5e2,ty_2EordinalNotation_2Eosyntax)
                      & ? [V6k2] :
                          ( mem(V6k2,ty_2Enum_2Enum)
                          & ? [V7t2] :
                              ( mem(V7t2,ty_2EordinalNotation_2Eosyntax)
                              & V0a0 = ap(c_2EordinalNotation_2EEnd,V4k1)
                              & V1a1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V5e2),V6k2),V7t2) ) ) ) )
              | ? [V8e1] :
                  ( mem(V8e1,ty_2EordinalNotation_2Eosyntax)
                  & ? [V9k1] :
                      ( mem(V9k1,ty_2Enum_2Enum)
                      & ? [V10t1] :
                          ( mem(V10t1,ty_2EordinalNotation_2Eosyntax)
                          & ? [V11e2] :
                              ( mem(V11e2,ty_2EordinalNotation_2Eosyntax)
                              & ? [V12k2] :
                                  ( mem(V12k2,ty_2Enum_2Enum)
                                  & ? [V13t2] :
                                      ( mem(V13t2,ty_2EordinalNotation_2Eosyntax)
                                      & V0a0 = ap(ap(ap(c_2EordinalNotation_2EPlus,V8e1),V9k1),V10t1)
                                      & V1a1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V11e2),V12k2),V13t2)
                                      & p(ap(ap(c_2EordinalNotation_2Eoless,V8e1),V11e2)) ) ) ) ) ) )
              | ? [V14e1] :
                  ( mem(V14e1,ty_2EordinalNotation_2Eosyntax)
                  & ? [V15k1] :
                      ( mem(V15k1,ty_2Enum_2Enum)
                      & ? [V16t1] :
                          ( mem(V16t1,ty_2EordinalNotation_2Eosyntax)
                          & ? [V17e2] :
                              ( mem(V17e2,ty_2EordinalNotation_2Eosyntax)
                              & ? [V18k2] :
                                  ( mem(V18k2,ty_2Enum_2Enum)
                                  & ? [V19t2] :
                                      ( mem(V19t2,ty_2EordinalNotation_2Eosyntax)
                                      & V0a0 = ap(ap(ap(c_2EordinalNotation_2EPlus,V14e1),V15k1),V16t1)
                                      & V1a1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V17e2),V18k2),V19t2)
                                      & V14e1 = V17e2
                                      & p(ap(ap(c_2Eprim__rec_2E_3C,V15k1),V18k2)) ) ) ) ) ) )
              | ? [V20e1] :
                  ( mem(V20e1,ty_2EordinalNotation_2Eosyntax)
                  & ? [V21k1] :
                      ( mem(V21k1,ty_2Enum_2Enum)
                      & ? [V22t1] :
                          ( mem(V22t1,ty_2EordinalNotation_2Eosyntax)
                          & ? [V23e2] :
                              ( mem(V23e2,ty_2EordinalNotation_2Eosyntax)
                              & ? [V24k2] :
                                  ( mem(V24k2,ty_2Enum_2Enum)
                                  & ? [V25t2] :
                                      ( mem(V25t2,ty_2EordinalNotation_2Eosyntax)
                                      & V0a0 = ap(ap(ap(c_2EordinalNotation_2EPlus,V20e1),V21k1),V22t1)
                                      & V1a1 = ap(ap(ap(c_2EordinalNotation_2EPlus,V23e2),V24k2),V25t2)
                                      & V20e1 = V23e2
                                      & V21k1 = V24k2
                                      & p(ap(ap(c_2EordinalNotation_2Eoless,V22t1),V25t2)) ) ) ) ) ) ) ) ) ) ) )).
