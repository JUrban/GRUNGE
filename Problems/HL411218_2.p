...
tff(conj_thm_2Ereal__topology_2ELIM__LINEAR,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(lamtp_f3840,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3840(A_27a,V1f,V2g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3840,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3840(A_27a,V1f,V2g),V3x) = ap(V2g,ap(V1f,V3x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__COMPOSE,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1f),V0net))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3840(A_27a,V1f,V2g)),V0net)) ) ) ) ) )).
