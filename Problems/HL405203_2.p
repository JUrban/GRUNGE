...
tff(conj_thm_2Elist_2EEL__ALL__DISTINCT__EL__EQ,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EINJ__MAP__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l1: $i] :
         ...
         => ! [V2l2: $i] :
             ...
             => ( ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EUNION(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l1)),ap(c_2Elist_2ELIST__TO__SET(A_27a),V2l2))),c_2Epred__set_2EUNIV(A_27b)))
                  & ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V1l1) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2l2) )
               => V1l1 = V2l2 ) ) ) ) )).
...
tff(conj_thm_2Esorting_2EPERM__REFL,lemma,(
    ! [A_27a: del,V0L: $i] :
      ( mem(V0L,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EPERM__LIST__TO__SET,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EPERM__MAP,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EMEM__PERM,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Ealist_2EMEM__fmap__to__alist__FLOOKUP,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(A_27a,A_27a))
     => ! [V1fm: $i] :
          ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),V0p),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V1fm))))
          <=> ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V1fm),ap(c_2Epair_2EFST(A_27a,A_27a),V0p)) = ap(c_2Eoption_2ESOME(A_27b),ap(c_2Epair_2ESND(A_27a,A_27a),V0p)) ) ) ) )).

tff(conj_thm_2Ealist_2Efmap__to__alist__to__fmap,lemma,(
...
tff(conj_thm_2Ealist_2EFDOM__alist__to__fmap,lemma,(
    ! [A_27a: del,A_27b: del,V0al: $i] :
      ( mem(V0al,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
...
tff(conj_thm_2Ealist_2EALL__DISTINCT__fmap__to__alist__keys,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
...
tff(conj_thm_2Ealist_2Efmap__to__alist__inj,lemma,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1f2: $i] :
          ( mem(V1f2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V0f1) = ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V1f2)
           => V0f1 = V1f2 ) ) ) )).

tff(conj_thm_2Ealist_2Efmap__to__alist__preserves__FDOM,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0fm1: $i] :
      ( mem(V0fm1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1fm2: $i] :
          ( mem(V1fm2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm1) = ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm2)
           => ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V0fm1)) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V1fm2)) ) ) ) )).

tff(conj_thm_2Ealist_2EPERM__fmap__to__alist,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm1: $i] :
      ( mem(V0fm1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1fm2: $i] :
          ( mem(V1fm2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Esorting_2EPERM(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V0fm1)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V1fm2)))
          <=> V0fm1 = V1fm2 ) ) ) )).
