...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__SYM,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Econnected__component @ V0s @ V2y @ V1x ) ) )).

thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__TRANS,axiom,(
    ! [V0z: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econnected__component @ V1s @ V2x @ V3y )
        & ( mono_2Ec_2Ereal__topology_2Econnected__component @ V1s @ V3y @ V0z ) )
     => ( mono_2Ec_2Ereal__topology_2Econnected__component @ V1s @ V2x @ V0z ) ) )).
...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__DISJOINT,conjecture,(
