...
fof(conj_thm_2Ereal__topology_2ELINEAR__0,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
    ...
    ! [V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2x] :
             ...
             => ap(f3656(V1s,V0f),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V2x)),V1s)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__PREIMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
