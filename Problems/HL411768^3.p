...
thf(thm_2Ereal__topology_2ESERIES__FINITE,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o] :
      ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V1s )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ V1s @ V0f ) @ V1s ) ) )).
...
thf(thm_2Ereal__topology_2ESERIES__ADD,axiom,(
    ! [V0x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1x0: tyop_2Erealax_2Ereal,V2y: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V3y0: tyop_2Erealax_2Ereal,V4s: tyop_2Enum_2Enum > $o] :
     ...
     => ( c_2Ereal__topology_2Esums
        @ ^ [V5n: tyop_2Enum_2Enum] :
            ( c_2Erealax_2Ereal__add @ ( V0x @ V5n ) @ ( V2y @ V5n ) )
...
thf(thm_2Ereal__topology_2ESUMS__FINITE__UNION,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2t: tyop_2Enum_2Enum > $o,V3l: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V2t )
        & ( c_2Ereal__topology_2Esums @ V0f @ V3l @ V1s ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Erealax_2Ereal__add @ V3l @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EDIFF @ tyop_2Enum_2Enum @ V2t @ V1s ) @ V0f ) ) @ ( c_2Epred__set_2EUNION @ tyop_2Enum_2Enum @ V1s @ V2t ) ) ) )).
