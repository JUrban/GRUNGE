...
thf(conj_thm_2Eiterate_2ECARD__NUMSEG__1,lemma,(
...
thf(conj_thm_2Eproduct_2ENPRODUCT__CONST,lemma,(
    ! [A_27a: del,V0c: tp__ty_2Enum_2Enum,V1s: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
       => ( ( surj__ty_2Enum_2Enum
          ...
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( inj__ty_2Enum_2Enum @ V0c ) ) @ ( ap @ ( c_2Epred__set_2ECARD @ A_27a ) @ V1s ) ) ) ) ) ) )).

thf(conj_thm_2Eproduct_2ENPRODUCT__CONST__NUMSEG__1,conjecture,(
    ! [V0c: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum
        @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V2x: $i] :
                ( inj__ty_2Enum_2Enum @ V0c ) ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( inj__ty_2Enum_2Enum @ V0c ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
