...
fof(conj_thm_2Einteger__word_2EINT__BOUND__ORDER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ew2i__INT__MINw,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ei2w__INT__MIN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
