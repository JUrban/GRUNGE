...
thf(f9994_0_2E0,type,(
    f9994_0_2E0: u )).

thf(f9994_0_2E1,type,(
    f9994_0_2E1: du > u )).
...
thf(def0_2Ethm_2EHolSmt_2Ed026,axiom,(
    ! [V0r: $o] :
      ( ( mono_2Ef9994_0 @ V0r )
    <=> ( (~) @ V0r ) ) )).

thf(thm_2EHolSmt_2Ed026,conjecture,(
    ! [V0r: $o,V1q: $o,V2p: $o] :
      ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V2p @ V1q @ ( mono_2Ef9994_0 @ V0r ) )
      | V2p
      | V0r ) )).
