...
tff(f13786_0_2E0,type,(
    f13786_0_2E0: u )).

tff(f13786_0_2E2,type,(
    f13786_0_2E2: ( du * du ) > u )).

tff(f13786_0_2E3,type,(
    f13786_0_2E3: ( du * du * du ) > u )).

tff(f13787_0_2E0,type,(
    f13787_0_2E0: u )).

tff(f13787_0_2E2,type,(
    f13787_0_2E2: ( du * du ) > u )).

tff(f13787_0_2E3,type,(
...
tff(arityeq3_2Ef13787_0_2E3,axiom,(
...
tff(thm_2Ereal__topology_2EISTOPLOGY__SUBTOPOLOGY,axiom,(
    ! [A_27a: d,V0top_2E0: u,V1u_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Etopology_2Eistopology_2E1(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),c_2Epred__set_2EGSPEC_2E1(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Epair_2Eprod(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool)),f13787_0_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1u_2E0),s(tyop_2Etopology_2Etopology(A_27a),V0top_2E0))))))))) )).
...
tff(thm_2Ereal__topology_2EOPEN__IN__SUBTOPOLOGY,conjecture,(
