...
fof(thm_2Ebinary__ieee_2Erounding__EQ__rounding,axiom,(
    ! [V0a_2E0,V1a_27_2E0] :
      ( s(tyop_2Ebinary__ieee_2Erounding,V0a_2E0) = s(tyop_2Ebinary__ieee_2Erounding,V1a_27_2E0)
    <=> s(tyop_2Enum_2Enum,c_2Ebinary__ieee_2Erounding2num_2E1(s(tyop_2Ebinary__ieee_2Erounding,V0a_2E0))) = s(tyop_2Enum_2Enum,c_2Ebinary__ieee_2Erounding2num_2E1(s(tyop_2Ebinary__ieee_2Erounding,V1a_27_2E0))) ) )).
...
fof(thm_2Ebinary__ieee_2Erounding__distinct,conjecture,
    ( s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTiesToEven_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardPositive_2E0)
    & s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTiesToEven_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardNegative_2E0)
    & s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTiesToEven_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardZero_2E0)
    & s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardPositive_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardNegative_2E0)
    & s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardPositive_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardZero_2E0)
    & s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardNegative_2E0) != s(tyop_2Ebinary__ieee_2Erounding,c_2Ebinary__ieee_2EroundTowardZero_2E0) )).
