...
thf(f5034_0_2E0,type,(
    f5034_0_2E0: u )).

thf(f5034_0_2E2,type,(
    f5034_0_2E2: du > du > u )).

thf(f5034_0_2E3,type,(
    f5034_0_2E3: du > du > du > u )).

thf(f5034_1_2E0,type,(
    f5034_1_2E0: u )).

thf(f5034_1_2E2,type,(
    f5034_1_2E2: du > du > u )).

thf(f5034_1_2E3,type,(
    f5034_1_2E3: du > du > du > u )).

thf(f5034_2_2E0,type,(
    f5034_2_2E0: u )).

thf(f5034_2_2E2,type,(
    f5034_2_2E2: du > du > u )).

thf(f5034_2_2E3,type,(
    f5034_2_2E3: du > du > du > u )).

thf(f5034_3_2E0,type,(
    f5034_3_2E0: u )).

thf(f5034_3_2E2,type,(
    f5034_3_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef5034_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( f5034_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) ) @ f5034_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef5034_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5034_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5034_1_2E2_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( f5034_1_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef5034_1_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ ( f5034_1_2E3 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5034_2_2E2_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ ( f5034_2_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) ) ) @ f5034_2_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef5034_2_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( f5034_2_2E3 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5034_3_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5034_3_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ f5034_3_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Epair_2E_2C_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27b_2Ctyop_2Eoption_2Eoption_28A_27c_29_29_20mono_2Etyop_2Emin_2Ebool,axiom,(
...
thf(arityeq3_2Emono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Eoption_2Eoption_28A_27c_29,axiom,(
...
thf(arityeq1_2Emono_2Ec_2Epred__set_2EGSPEC_2E1_2Emono_2Etyop_2Emin_2Efun_28A_27b_2Ctyop_2Eoption_2Eoption_28A_27c_29_29_20mono_2EA_27c,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Ecardinal_2Ecardeq_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27b_2Ctyop_2Eoption_2Eoption_28A_27c_29_29_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Ecardinal_2ESING__set__exp,axiom,(
    ! [A_27a: d,A_27b: d,V1B_2E0: u,V0x_2E0: u,V3b_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5034_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1B_2E0 ) @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ A_27a @ V3b_2E0 ) ) )
...
thf(def1_2Ethm_2Ecardinal_2ESING__set__exp,axiom,(
    ! [A_27b: d,V5b_2E0: u,V0x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5034_3_2E2 @ ( s @ A_27b @ V5b_2E0 ) @ ( s @ A_27b @ V0x_2E0 ) ) ) )
    <=> ( ( s @ A_27b @ V5b_2E0 )
        = ( s @ A_27b @ V0x_2E0 ) ) ) )).

thf(def2_2Ethm_2Ecardinal_2ESING__set__exp,axiom,(
    ! [A_27b: d,A_27c: d,V0x_2E0: u,V4a_2E0: u,V5b_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( f5034_2_2E3 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ A_27c @ V4a_2E0 ) @ ( s @ A_27b @ V5b_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5034_3_2E2 @ ( s @ A_27b @ V5b_2E0 ) @ ( s @ A_27b @ V0x_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27c @ V4a_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) )).

thf(def3_2Ethm_2Ecardinal_2ESING__set__exp,axiom,(
    ! [A_27b: d,A_27c: d,V0x_2E0: u,V2A_2E0: u,V4a_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ ( f5034_1_2E3 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V2A_2E0 ) @ ( s @ A_27c @ V4a_2E0 ) ) )
...
thf(thm_2Epred__set_2EINJ__BIJ__SUBSET,axiom,(
    ! [A_27a: d,A_27b: d,V0t_2E0: u,V1s0_2E0: u,V2s_2E0: u,V3f_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2ESUBSET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EINJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V0t_2E0 ) ) ) ) )
...
thf(thm_2Ecardinal_2ESING__set__exp__CARD,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0x_2E0: u,V1B_2E0: u,V2A_2E0: u] :
