...
thf(conj_thm_2ETemporal__Logic_2EWATCH__SIGNAL,conjecture,(
    ! [V0q: $i] :
      ( ( mem @ V0q @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
                ...
                & ! [V5d: tp__ty_2Enum_2Enum] :
                   ...
                   => ( ! [V7t: tp__ty_2Enum_2Enum] :
                      ...
                      & ! [V8t: tp__ty_2Enum_2Enum] :
                          ( p @ ( ap @ V0q @ ( ap @ c_2Enum_2ESUC @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V8t ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V5d ) ) @ ( inj__ty_2Enum_2Enum @ V2t0 ) ) ) ) ) ) ) ) ) ) ) ) )).
