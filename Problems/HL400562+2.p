...
fof(conj_thm_2Epair_2ECURRY__ONE__ONE__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                  ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27c))
                 => ! [V1g] :
                      ( mem(V1g,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27c))
                     => ( ap(c_2Epair_2ECURRY(A_27a,A_27a,A_27a),V0f) = ap(c_2Epair_2ECURRY(A_27a,A_27a,A_27a),V1g)
                      <=> V0f = V1g ) ) ) ) ) ) )).
