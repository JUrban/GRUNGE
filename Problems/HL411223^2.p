...
thf(conj_thm_2Ereal__topology_2EBILINEAR__CONTINUOUS__COMPOSE,lemma,(
    ! [A_27a: del,V0net: $i] :
                   ...
                   => ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ V3h @ ( ap @ V1f @ V4x ) ) @ ( ap @ V2g @ V4x ) ) ) )
                        @ V0net ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBILINEAR__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
