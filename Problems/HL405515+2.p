...
fof(conj_thm_2Einteger_2EINT__LE__MONO,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ! [V2z] :
             ...
             => ( p(ap(ap(c_2Einteger_2Eint__lt,ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)),V0x))
               => ( p(ap(ap(c_2Einteger_2Eint__le,ap(ap(c_2Einteger_2Eint__mul,V0x),V1y)),ap(ap(c_2Einteger_2Eint__mul,V0x),V2z)))
