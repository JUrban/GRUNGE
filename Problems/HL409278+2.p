    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V4x] :
             ...
             => ap(f3215(V0f,V1g),V4x) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V4x)),ap(V1g,V4x)) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRAL__ADD,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a] :
             ...
             => ! [V3b] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V2a),V3b))
                   ...
                   => ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),f3215(V0f,V1g)) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V0f)),ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V1g)) ) ) ) ) ) )).
