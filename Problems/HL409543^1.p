...
thf(f11271_0_2E0,type,(
    f11271_0_2E0: u )).

thf(f11271_0_2E1,type,(
    f11271_0_2E1: du > u )).

thf(f11271_0_2E2,type,(
...
thf(mono_2Ef11271_0,type,(
    mono_2Ef11271_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Eutil__prob_2Eminimal__def,axiom,(
    ! [V0p: mono_2Etyop_2Enum_2Enum > $o,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef11271_0 @ V0p @ V1n )
    <=> ( ( V0p @ V1n )
...
thf(thm_2Eutil__prob_2Eminimal__def,axiom,(
    ! [V0p: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Eutil__prob_2Eminimal @ V0p )
      = ( mono_2Ec_2Emin_2E_40_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef11271_0 @ V0p ) ) ) )).
...
thf(thm_2Eutil__prob_2EMINIMAL__EXISTS,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ? [V1n: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V1n )
