...
thf(thm_2Efloat_2EFLOAT__SUB__RELATIVE,conjecture,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( ( c_2Eieee_2EFinite @ V0a )
        ...
        & ( c_2Efloat_2Enormalizes @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) )
     => ( ( c_2Eieee_2EFinite @ ( c_2Eieee_2Efloat__sub @ V0a @ V1b ) )
        & ? [V2e: tyop_2Erealax_2Ereal] :
            ...
            & ( ( c_2Eieee_2EVal @ ( c_2Eieee_2Efloat__sub @ V0a @ V1b ) )
              = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2e ) ) ) ) ) ) )).
