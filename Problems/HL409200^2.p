...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0P ) )
       => ! [V1f_27: $i] :
...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__CROSS__SYM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
                        ...
                        @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27b @ ty_2Erealax_2Ereal )
                          @ ( lam @ A_27a
                            @ ^ [V3x: $i] :
                                ( lam @ A_27b
                                @ ^ [V4y: $i] :
                                    ( ap @ V0f @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V3x ) @ V4y ) ) ) ) ) )
                        ...
                        @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27b @ A_27a @ ty_2Erealax_2Ereal )
                          @ ( lam @ A_27b
                            @ ^ [V5y: $i] :
                                ( lam @ A_27a
                                @ ^ [V6x: $i] :
                                    ( ap @ V0f @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V6x ) @ V5y ) ) ) ) ) )
