...
fof(conj_thm_2Eiterate_2ESUM__CONST__NUMSEG,lemma,(
    ! [V0c] :
...
fof(conj_thm_2Eiterate_2ESUM__TRIV__NUMSEG,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESUM__GP__MULTIPLIED,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESUM__GP,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
