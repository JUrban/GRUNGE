...
fof(conj_thm_2EpatternMatches_2EPMATCH__EXTEND__BASE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0v__old] :
                 ...
                 => ! [V1v__new] :
                      ( mem(V1v__new,A_27b)
                     => ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V0v__old),c_2Elist_2ENIL(arr(A_27a,ty_2Eoption_2Eoption(A_27c)))) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V1v__new),c_2Elist_2ENIL(arr(A_27b,ty_2Eoption_2Eoption(A_27c)))) ) ) ) ) ) )).
