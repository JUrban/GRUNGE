...
thf(conj_thm_2Efinite__map_2EFUPDATE__LIST__APPLY__NOT__MEM,lemma,(
...
thf(conj_thm_2Erich__list_2ECONS__APPEND,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V0x ) @ V1l )
            = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V0x ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) @ V1l ) ) ) ) )).
...
thf(conj_thm_2Efinite__map_2EFUPDATE__LIST__APPLY__MEM,conjecture,(
    ! [A_27a: del,A_27b: del,V0kvl: $i] :
      ( ( mem @ V0kvl @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
