...
fof(conj_thm_2Equotient__list_2ELIST__REL__REL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Equotient__list_2ELIST__QUOTIENT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0R] :
             ...
             => ! [V1abs] :
                 ...
                 => ! [V2rep] :
                      ( mem(V2rep,arr(A_27b,A_27a))
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => p(ap(ap(ap(c_2Equotient_2EQUOTIENT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R)),ap(c_2Elist_2EMAP(A_27a,A_27a),V1abs)),ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep))) ) ) ) ) ) ) )).
