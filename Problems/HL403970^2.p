...
thf(tp_c_2Earithmetic_2EMODEQ,type,(
    c_2Earithmetic_2EMODEQ: $i )).

thf(mem_c_2Earithmetic_2EMODEQ,axiom,(
    mem @ c_2Earithmetic_2EMODEQ @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) ) )).

thf(stp_fo_c_2Earithmetic_2EMODEQ,type,(
    fo__c_2Earithmetic_2EMODEQ: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum > $o )).

thf(stp_eq_fo_c_2Earithmetic_2EMODEQ,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__ty_2Enum_2Enum,X2: tp__ty_2Enum_2Enum] :
      ( ( inj__o @ ( fo__c_2Earithmetic_2EMODEQ @ X0 @ X1 @ X2 ) )
      = ( ap @ ( ap @ ( ap @ c_2Earithmetic_2EMODEQ @ ( inj__ty_2Enum_2Enum @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) @ ( inj__ty_2Enum_2Enum @ X2 ) ) ) )).
...
thf(tp_c_2Ellist_2ELREPEAT,type,(
    c_2Ellist_2ELREPEAT: del > $i )).

thf(mem_c_2Ellist_2ELREPEAT,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Earithmetic_2EMODEQ__INTRO__CONG,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1e0: tp__ty_2Enum_2Enum,V2e1: tp__ty_2Enum_2Enum] :
     ...
     => ( ( p @ ( ap @ ( ap @ ( ap @ c_2Earithmetic_2EMODEQ @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1e0 ) ) @ ( inj__ty_2Enum_2Enum @ V2e1 ) ) )
       => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1e0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V2e1 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )).

thf(conj_thm_2Earithmetic_2EMODEQ__PLUS__CONG,lemma,(
...
thf(conj_thm_2Earithmetic_2EMODEQ__REFL,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ ( ap @ c_2Earithmetic_2EMODEQ @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) )).

thf(conj_thm_2Earithmetic_2EMODEQ__0,lemma,(
...
thf(conj_thm_2Ellist_2ELAPPEND__EQ__LNIL,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0l1 ) @ V1l2 )
              = ( c_2Ellist_2ELNIL @ A_27a ) )
          <=> ( ( V0l1
                = ( c_2Ellist_2ELNIL @ A_27a ) )
              & ( V1l2
...
thf(ax_thm_2Ellist_2ELREPEAT__def,axiom,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l )
        = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l ) ) @ ( c_2Ellist_2ELNIL @ A_27a ) )
          @ ( ap
            @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V1n: $i] :
                    ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ V1n ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) ) @ V0l ) ) )
            @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) ) ) ) )).

thf(conj_thm_2Ellist_2ELGENLIST__CHUNK__GENLIST,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V0f ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) )
          = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EGENLIST @ A_27a ) @ V0f ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ A_27a @ ty_2Enum_2Enum ) @ V0f ) @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELREPEAT__thm,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l )
        = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ V0l ) ) @ ( ap @ ( c_2Ellist_2ELREPEAT @ A_27a ) @ V0l ) ) ) ) )).
