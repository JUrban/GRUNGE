...
thf(thm_2EOmega__Automata_2ENEXT__AS__CO__BUECHI,conjecture,(
    ...
    <=> ? [V2p: tyop_2Enum_2Enum > $o,V3q: tyop_2Enum_2Enum > $o] :
          ( ( (~) @ ( V2p @ V0t0 ) )
          & ( (~) @ ( V3q @ V0t0 ) )
          & ! [V4t: tyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V2p @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( (~) @ ( V3q @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( V2p @ ( c_2Earithmetic_2E_2B @ V4t @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V0t0 ) ) )
