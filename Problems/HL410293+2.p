...
fof(conj_thm_2Epred__set_2ESUBSET__INTER1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EGSPEC__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0y] :
          ( mem(V0y,arr(A_27a,bool))
     ...
     => ! [V1b] :
         ...
         => ! [V2m] :
             ...
             => ! [V7i] :
                 ...
                 => ap(f3609(A_27a,V6a,V1b,V2m),V7i) = ap(ap(c_2Emeasure_2Emeasure(A_27a),V2m),ap(ap(c_2Epred__set_2EINTER(A_27a),V6a),ap(V1b,V7i))) ) ) ) ) )).

fof(conj_thm_2Emeasure_2Emeasure__split,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
                      ...
                      & ! [V3i] :
                         ...
                         => ! [V4j] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3i),V0r))
                                  ...
                                  & V3i != V4j )
                               => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V1b,V3i)),ap(V1b,V4j))) ) ) )
                      & ! [V5i] :
                          ( mem(V5i,ty_2Enum_2Enum)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5i),V0r))
                           => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(V1b,V5i)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V2m))) ) ) )
                   => ! [V6a] :
                        ( mem(V6a,arr(A_27a,bool))
                       => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V6a),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V2m)))
                         => ap(ap(c_2Emeasure_2Emeasure(A_27a),V2m),V6a) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Enum_2Enum),f3609(A_27a,V6a,V1b,V2m)),V0r) ) ) ) ) ) ) ) )).
