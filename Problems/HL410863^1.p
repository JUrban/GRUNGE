...
thf(f13214_0_2E0,type,(
    f13214_0_2E0: u )).

thf(f13214_0_2E1,type,(
    f13214_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef13214_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13214_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f13214_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EEVENTUALLY__TRUE,axiom,(
    ! [A_27a: d,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f13214_0_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).

thf(thm_2Ereal__topology_2EEVENTUALLY__TRUE,conjecture,(
    ! [A_27a: d,V0net_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Eeventually_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f13214_0_2E0 ) @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V0net_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).
