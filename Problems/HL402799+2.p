...
fof(conj_thm_2Erich__list_2ELENGTH__LASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Erich__list_2ELASTN__BUTLASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V1m),V2l)) = ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V1m),ap(ap(c_2Erich__list_2ELASTN(A_27a),ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)),V2l)) ) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2ETAKE__BUTLASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Elist_2ETAKE(A_27a),V0n),V1l) = ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n)),V1l) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2ESEG__LASTN__BUTLASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
