...
fof(conj_thm_2Ecardinal_2ECARD__LE__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVAL__UNIV,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( p(ap(ap(c_2Erealax_2Ereal__lt,V0a),V1b))
           => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b))),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECARD__EQ__INTERVAL,conjecture,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
           => ( ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
             => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) ) ) )
    & ! [V2a] :
       ...
       => ! [V3b] :
           ...
           => ( ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
             => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b))),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) ) ) ) )).
