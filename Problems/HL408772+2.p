...
fof(conj_thm_2EHolSmt_2Er151,conjecture,(
    ! [V0a] :
                 ...
                 => ! [V4y] :
                     ...
                     => ! [V5w] :
                         ...
                         => ! [V6z] :
                             ...
                             => ( ap(c_2Erealax_2Ereal__neg,V0a) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1u)),V2x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V3v)),V4y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V5w)),V6z)))
                              <=> ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V1u),V2x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V3v),V4y)),ap(ap(c_2Erealax_2Ereal__mul,V5w),V6z))) = V0a ) ) ) ) ) ) ) ) )).
