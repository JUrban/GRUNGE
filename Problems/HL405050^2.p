...
thf(conj_thm_2ETemporal__Logic_2EWHEN__SIGNAL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESWHEN__SIGNAL,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EWHEN__FIX,lemma,(
    ! [V0y: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( V0y
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V3t: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ V1b @ V3t ) ) @ ( ap @ V2a @ V3t ) ) @ ( ap @ V0y @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3t ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
              <=> ( ( V0y
...
thf(conj_thm_2EOmega__Automata_2ETEMP__OPS__DEFS__TO__OMEGA,conjecture,(
    ! [V0l: $i] :
