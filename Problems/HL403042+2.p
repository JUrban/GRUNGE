...
fof(conj_thm_2Elist_2ESNOC__CASES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
...
fof(conj_thm_2EindexedLists_2ELIST__RELi__strongind,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2EindexedLists_2ELIST__RELi__EL__EQN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
