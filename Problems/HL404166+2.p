...
fof(conj_thm_2Epath_2Enumeral__drop,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0n] :
               ...
               => ! [V1p] :
                   ...
                   => ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V0n))),V1p) = ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V0n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Epath_2Etail(A_27a,A_27a),V1p)) ) )
            & ! [V2n] :
                ( mem(V2n,ty_2Enum_2Enum)
               => ! [V3p] :
                    ( mem(V3p,ty_2Epath_2Epath(A_27a,A_27a))
                   => ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V2n))),V3p) = ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V2n))),ap(c_2Epath_2Etail(A_27a,A_27a),V3p)) ) ) ) ) ) )).
