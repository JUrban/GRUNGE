...
tff(lmtp_f3248,type,(
    f3248: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3248,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3248(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3248,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3248(V0c),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0c)),inj__ty_2Erealax_2Ereal(V1x))) )).

tff(lmtp_f3249,type,(
    f3249: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3249,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3249(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3249,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3249(V0c),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V0c))) )).

tff(conj_thm_2Eutil__prob_2EPREIMAGE__REAL__COMPL2,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : ap(c_2Epred__set_2ECOMPL(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3248(V0c))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3249(V0c)) )).
