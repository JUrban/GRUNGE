...
tff(lameq_f436,axiom,(
    ! [A_27b: del,A_27a: del,V3x: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V4y: $i] :
              ( mem(V4y,A_27a)
             => ap(f436(A_27b,A_27a,V3x,V1f),V4y) = ap(ap(V1f,V3x),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4y),V4y)) ) ) ) )).

tff(lmtp_f435,type,(
    f435: ( del * del * $i ) > $i )).

tff(lamtp_f435,axiom,(
    ! [A_27a: del,A_27b: del,V1f: $i] :
      ( mem(V1f,arr(A_27b,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b)))
     => mem(f435(A_27a,A_27b,V1f),arr(A_27b,arr(A_27a,A_27b))) ) )).
...
tff(lameq_f435,axiom,(
    ! [A_27a: del,A_27b: del,V1f: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27b)
         => ap(f435(A_27a,A_27b,V1f),V3x) = f436(A_27b,A_27a,V3x,V1f) ) ) )).

tff(conj_thm_2Elist_2EFOLDL__ZIP__SAME,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2e: $i] :
              ( mem(V2e,A_27b)
             => ap(ap(ap(c_2Elist_2EFOLDL(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),V1f),V2e),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ls),V0ls))) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f435(A_27a,A_27b,V1f)),V2e),V0ls) ) ) ) )).
