...
tff(conj_thm_2Ereal__topology_2ELIM__UNIQUE,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPLETE__UNIV,lemma,(
    p(ap(c_2Ereal__topology_2Ecomplete,c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).

tff(conj_thm_2Ereal__topology_2ECOMPLETE__EQ__CLOSED,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecomplete,V0s))
      <=> p(ap(c_2Ereal__topology_2EClosed,V0s)) ) ) )).
