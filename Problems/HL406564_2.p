...
tff(conj_thm_2Esptree_2Elookup__inter__alt,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: tp__ty_2Enum_2Enum,V1t1: $i] :
      ( mem(V1t1,ty_2Esptree_2Espt(A_27a))
     => ! [V2t2: $i] :
          ( mem(V2t2,ty_2Esptree_2Espt(A_27b))
         => ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V0x)),ap(ap(c_2Esptree_2Einter(A_27a,A_27a),V1t1),V2t2)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0x)),ap(c_2Esptree_2Edomain(A_27b),V2t2))),ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V0x)),V1t1)),c_2Eoption_2ENONE(A_27a)) ) ) )).
