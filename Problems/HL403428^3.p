...
thf(c_2Ebag_2Ebag__size,type,(
    c_2Ebag_2Ebag__size: 
      !>[A_27a: $tType] :
        ( ( A_27a > tyop_2Enum_2Enum ) > ( A_27a > tyop_2Enum_2Enum ) > tyop_2Enum_2Enum ) )).
...
thf(thm_2Ebag_2Ebag__size__def,axiom,(
    ! [A_27a: $tType,V0eltsize: A_27a > tyop_2Enum_2Enum,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2Ebag__size @ A_27a @ V0eltsize @ V1b )
      = ( c_2Ebag_2EITBAG @ A_27a @ tyop_2Enum_2Enum
        @ ^ [V2e: A_27a,V3acc: tyop_2Enum_2Enum] :
            ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( V0eltsize @ V2e ) ) @ V3acc )
        @ V1b
        @ c_2Enum_2E0 ) ) )).
...
thf(thm_2Ebag_2EBAG__SIZE__INSERT,conjecture,(
    ! [A_27a: $tType,V0eltsize: A_27a > tyop_2Enum_2Enum,V1e: A_27a,V2b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V2b )
     => ( ( c_2Ebag_2Ebag__size @ A_27a @ V0eltsize @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V1e @ V2b ) )
        = ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( V0eltsize @ V1e ) ) @ ( c_2Ebag_2Ebag__size @ A_27a @ V0eltsize @ V2b ) ) ) ) )).
