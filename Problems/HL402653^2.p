...
thf(conj_thm_2Erich__list_2EFOLDR__FILTER,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2P: $i] :
             ...
             => ! [V3l: $i] :
                  ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27a ) )
                 => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27b ) @ V0f ) @ V1e ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V2P ) @ V3l ) )
                    = ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27b )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( lam @ A_27b
                                @ ^ [V5y: $i] :
                                    ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27b ) @ ( ap @ V2P @ V4x ) ) @ ( ap @ ( ap @ V0f @ V4x ) @ V5y ) ) @ V5y ) ) ) )
                        @ V1e )
                      @ V3l ) ) ) ) ) ) )).
