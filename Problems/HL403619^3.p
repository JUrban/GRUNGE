...
thf(thm_2Efcp_2EFCP__ETA,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0g: tyop_2Efcp_2Ecart @ A_27a @ A_27b] :
      ( ( c_2Efcp_2EFCP @ A_27a @ A_27b
        @ ^ [V1i: tyop_2Enum_2Enum] :
            ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V0g @ V1i ) )
      = V0g ) )).

thf(thm_2Efcp_2EFCP__UPDATE__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0a: tyop_2Enum_2Enum,V1b: A_27a] :
      ( ( c_2Efcp_2E_3A_2B @ A_27a @ A_27b @ V0a @ V1b )
      = ( ^ [V2m: tyop_2Efcp_2Ecart @ A_27a @ A_27b] :
            ( c_2Efcp_2EFCP @ A_27a @ A_27b
            @ ^ [V3c: tyop_2Enum_2Enum] :
                ( c_2Ebool_2ECOND @ A_27a @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V0a @ V3c ) @ V1b @ ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V2m @ V3c ) ) ) ) ) )).

thf(thm_2Efcp_2EAPPLY__FCP__UPDATE__ID,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0m: tyop_2Efcp_2Ecart @ A_27a @ A_27b,V1a: tyop_2Enum_2Enum] :
      ( ( c_2Efcp_2E_3A_2B @ A_27a @ A_27b @ V1a @ ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V0m @ V1a ) @ V0m )
      = V0m ) )).
