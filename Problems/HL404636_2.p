...
tff(conj_thm_2Efinite__map_2EFCARD__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del] : surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a))) = fo__c_2Enum_2E0 )).

tff(conj_thm_2Efinite__map_2EFCARD__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ! [V2b: $i] :
              ( mem(V2b,A_27b)
             => surj__ty_2Enum_2Enum(ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b)))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V1a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm))),ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0fm)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(c_2Efinite__map_2EFCARD(A_27a,A_27a),V0fm)))) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFCARD__0__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
