...
fof(conj_thm_2Efinite__map_2EFUPD__SAME__KEY__UNWIND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFMEQ__ENUMERATE__CASES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFMEQ__SINGLE__SIMPLE__ELIM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
