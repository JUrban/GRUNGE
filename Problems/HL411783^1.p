...
thf(c_2Ereal__topology_2Einfsum_2E0,type,(
    c_2Ereal__topology_2Einfsum_2E0: u )).

thf(c_2Ereal__topology_2Einfsum_2E2,type,(
    c_2Ereal__topology_2Einfsum_2E2: du > du > u )).
...
thf(mono_2Ec_2Ereal__topology_2Einfsum,type,(
    mono_2Ec_2Ereal__topology_2Einfsum: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eiterate_2ENUMSEG__ADD__SPLIT,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0m @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
     => ( ( mono_2Ec_2Eiterate_2E_2E_2E @ V0m @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ V2p ) )
        = ( mono_2Ec_2Epred__set_2EUNION_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V0m @ V1n ) @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ V2p ) ) ) ) ) )).

thf(thm_2Eiterate_2ESUM__UNION,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1s_2E0: u,V2t_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EUNION_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESUMS__INFSUM,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Esums @ V0f @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V1s @ V0f ) @ V1s )
      = ( mono_2Ec_2Ereal__topology_2Esummable @ V1s @ V0f ) ) )).
...
thf(thm_2Ereal__topology_2EPARTIAL__SUMS__COMPONENT__LE__INFSUM,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( ! [V3i: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3i @ V1s )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( V0f @ V3i ) ) )
        & ( mono_2Ec_2Ereal__topology_2Esummable @ V1s @ V0f ) )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V1s @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V2n ) ) @ V0f ) @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V1s @ V0f ) ) ) )).
