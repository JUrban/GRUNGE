...
tff(conj_thm_2Esorting_2EPERM__SYM,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Esorting_2EALL__DISTINCT__PERM__LIST__TO__SET__TO__LIST,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
tff(lamtp_f2107,axiom,(
    ! [A_27b: del,A_27a: del,V0al: $i] :
      ( mem(V0al,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => mem(f2107(A_27b,A_27a,V0al),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f2107,axiom,(
    ! [A_27b: del,A_27a: del,V0al: $i] :
     ...
     => ! [V1k: $i] :
          ( mem(V1k,A_27a)
         => ap(f2107(A_27b,A_27a,V0al),V1k) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),ap(c_2Eoption_2ETHE(A_27b),ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0al),V1k))) ) ) )).

tff(conj_thm_2Ealist_2Ealist__to__fmap__to__alist,lemma,(
    ! [A_27a: del,A_27b: del,V0al: $i] :
      ( mem(V0al,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0al)) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),f2107(A_27b,A_27a,V0al)),ap(c_2Elist_2ESET__TO__LIST(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0al)))) ) )).

tff(conj_thm_2Ealist_2Ealist__to__fmap__to__alist__PERM,conjecture,(
    ! [A_27a: del,A_27b: del,V0al: $i] :
      ( mem(V0al,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ( p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0al)))
       => p(ap(ap(c_2Esorting_2EPERM(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0al))),V0al)) ) ) )).
