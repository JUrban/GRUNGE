...
thf(conj_thm_2Ereal_2EREAL__LT__TOTAL,lemma,(
...
thf(conj_thm_2Ereal_2EREAL__LE__NEGTOTAL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EREAL__LE__NEGL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Etransc_2ETAN__NEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Etan @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ c_2Etransc_2Etan @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) )).
...
thf(conj_thm_2Etransc_2ETAN__TOTAL__POS,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
     ...
     => ? [V1x: tp__ty_2Erealax_2Ereal] :
          ...
          & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Etan @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
            = V0y ) ) ) )).

thf(conj_thm_2Etransc_2ETAN__TOTAL,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap @ ( c_2Ebool_2E_3F_21 @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V1x: $i] :
              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Etransc_2Epi ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) @ V1x ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V1x ) @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Etransc_2Epi ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Etransc_2Etan @ V1x ) ) @ ( inj__ty_2Erealax_2Ereal @ V0y ) ) ) ) ) ) ) )).
