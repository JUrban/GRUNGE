...
tff(f2875_0_2E0,type,(
    f2875_0_2E0: 
      !>[A_27a: $tType] : tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Eone_2Eone,A_27a)) )).

tff(f2875_0_2E1,type,(
    f2875_0_2E1: 
      !>[A_27a: $tType] :
        ( A_27a > tyop_2Emin_2Efun(tyop_2Eone_2Eone,A_27a) ) )).

tff(f2875_0_2E2,type,(
    f2875_0_2E2: 
      !>[A_27a: $tType] :
        ( ( A_27a * tyop_2Eone_2Eone ) > A_27a ) )).

tff(f2875_1_2E0,type,(
    f2875_1_2E0: 
      !>[A_27a: $tType,A_27b: $tType] : tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))) )).

tff(f2875_1_2E2,type,(
    f2875_1_2E2: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( tyop_2Emin_2Efun(A_27a,A_27b) * tyop_2Emin_2Efun(A_27a,A_27b) ) > tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool) ) )).

tff(f2875_1_2E3,type,(
    f2875_1_2E3: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( tyop_2Emin_2Efun(A_27a,A_27b) * tyop_2Emin_2Efun(A_27a,A_27b) * A_27a ) > tyop_2Emin_2Ebool ) )).
...
tff(arityeq1_2Ef2875_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: $tType,X0_2E0: A_27a] : f2875_0_2E1(A_27a,X0_2E0) = app_2E2(A_27a,tyop_2Emin_2Efun(tyop_2Eone_2Eone,A_27a),f2875_0_2E0(A_27a),X0_2E0) )).

tff(arityeq2_2Ef2875_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: $tType,X0_2E0: A_27a,X1_2E0: tyop_2Eone_2Eone] : f2875_0_2E2(A_27a,X0_2E0,X1_2E0) = app_2E2(tyop_2Eone_2Eone,A_27a,app_2E2(A_27a,tyop_2Emin_2Efun(tyop_2Eone_2Eone,A_27a),f2875_0_2E0(A_27a),X0_2E0),X1_2E0) )).

tff(arityeq2_2Ef2875_1_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: $tType,A_27b: $tType,X0_2E0: tyop_2Emin_2Efun(A_27a,A_27b),X1_2E0: tyop_2Emin_2Efun(A_27a,A_27b)] : f2875_1_2E2(A_27a,A_27b,X0_2E0,X1_2E0) = app_2E2(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2875_1_2E0(A_27a,A_27b),X0_2E0),X1_2E0) )).

tff(arityeq3_2Ef2875_1_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: $tType,A_27b: $tType,X0_2E0: tyop_2Emin_2Efun(A_27a,A_27b),X1_2E0: tyop_2Emin_2Efun(A_27a,A_27b),X2_2E0: A_27a] : f2875_1_2E3(A_27a,A_27b,X0_2E0,X1_2E0,X2_2E0) = app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27b),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2875_1_2E0(A_27a,A_27b),X0_2E0),X1_2E0),X2_2E0) )).
...
tff(def0_2Ethm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__POINT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V1P_2E0: tyop_2Emin_2Efun(A_27a,A_27b),V2Q_2E0: tyop_2Emin_2Efun(A_27a,A_27b),V4x_2E0: A_27a] :
      ( p(f2875_1_2E3(A_27a,A_27b,V1P_2E0,V2Q_2E0,V4x_2E0))
    <=> app_2E2(A_27a,A_27b,V1P_2E0,V4x_2E0) = app_2E2(A_27a,A_27b,V2Q_2E0,V4x_2E0) ) )).

tff(def1_2Ethm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__POINT,axiom,(
    ! [A_27a: $tType,V0i_2E0: A_27a,V3xxx_2E0: tyop_2Eone_2Eone] : f2875_0_2E2(A_27a,V0i_2E0,V3xxx_2E0) = V0i_2E0 )).

tff(thm_2EquantHeuristics_2EGUESS__RULES__EQUATION__EXISTS__POINT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0i_2E0: A_27a,V1P_2E0: tyop_2Emin_2Efun(A_27a,A_27b),V2Q_2E0: tyop_2Emin_2Efun(A_27a,A_27b)] :
      ( app_2E2(A_27a,A_27b,V1P_2E0,V0i_2E0) = app_2E2(A_27a,A_27b,V2Q_2E0,V0i_2E0)
     => p(c_2EquantHeuristics_2EGUESS__EXISTS__POINT_2E2(tyop_2Eone_2Eone,A_27a,f2875_0_2E1(A_27a,V0i_2E0),f2875_1_2E2(A_27a,A_27b,V1P_2E0,V2Q_2E0))) ) )).
