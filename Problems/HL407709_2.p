...
tff(conj_thm_2Elist_2Elist__CASES,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(mem_c_2Eordinal_2Eis__polyform,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Eordinal_2Eis__polyform(A_27a,A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),bool))) )).
...
tff(conj_thm_2Eordinal_2Eordle__TRANS,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eordinal_2Eordlte__TRANS,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Eordlt__ZERO,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eordinal_2Eord__induction,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Eordinal_2EfromNat__ordlt,lemma,(
...
tff(conj_thm_2Eordinal_2Elt__omega,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EfromNat__lt__omega,lemma,(
...
tff(conj_thm_2Eordinal_2Eordle__CANCEL__ADDR,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EordMULT__1L,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Ex__le__ordEXP__x,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1x: $i] :
...
tff(conj_thm_2Eordinal_2Eepsilon0__least__fixpoint,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2EfromNat__lt__epsilon0,lemma,(
...
tff(conj_thm_2Eordinal_2Eeval__poly__def,lemma,(
    ! [A_27a: del] :
      ( ! [V0a: $i] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Eis__polyform__def,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0a: $i] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
         => ( p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V0a),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))))
          <=> $true ) )
      & ! [V1e: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ! [V3a: $i] :
                  ( mem(V3a,ty_2Eordinal_2Eordinal(A_27a))
                 => ( p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V3a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V2c),V1e)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))))))
      ...
      & ! [V4t: $i] :
          ( mem(V4t,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))))
         => ! [V5e2: $i] :
                 ...
                 => ! [V7c2: $i] :
                     ...
                     => ! [V8c1: $i] :
                         ...
                         => ! [V9a: $i] :
                             ...
                             => ( p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V9a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V8c1),V6e1)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V7c2),V5e2)),V4t))))
                              <=> ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V8c1))
                                  ...
                                  & p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V9a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V7c2),V5e2)),V4t))) ) ) ) ) ) ) ) ) ) )).
...
tff(conj_thm_2Eordinal_2Epolyform__0,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V0a))
...
tff(conj_thm_2Eordinal_2Epolyform__EQ__NIL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Eis__polyform__CONS__E,lemma,(
             ...
             => ! [V3t: $i] :
                 ...
                 => ( p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V0a),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V1c),V2e)),V3t)))
                   => ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V1c))
                      ...
                      & p(ap(ap(c_2Eordinal_2Eis__polyform(A_27a,A_27a),V0a),V3t)) ) ) ) ) ) ) )).

tff(conj_thm_2Eordinal_2Eis__polyform__head__dominates__tail,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1c: $i] :
          ( mem(V1c,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Ecx__lt__x,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1c: $i] :
          ( mem(V1c,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Epolyform__eval__poly,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
...
tff(conj_thm_2EordNotationSemantics_2Enotation__exists,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ( p(ap(ap(c_2Eordinal_2Eordlt(A_27a),V0a),c_2Eordinal_2Eepsilon0(A_27a)))
