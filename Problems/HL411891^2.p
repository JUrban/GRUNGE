...
thf(conj_thm_2Ereal__topology_2ESETDIST__TRANSLATION,lemma,(
     ...
     => ! [V2t: $i] :
         ...
         => ( ( surj__ty_2Erealax_2Ereal
              @ ( ap @ c_2Ereal__topology_2Esetdist
                @ ( ap
                  @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                    @ ( ap
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V4x: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V4x ) ) )
                    @ V2t ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EHAUSDIST__TRANSLATION,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V2t: $i] :
          ( ( mem @ V2t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( surj__ty_2Erealax_2Ereal
              @ ( ap @ c_2Ereal__topology_2Ehausdist
                @ ( ap
                  @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                    @ ( ap
                      @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
