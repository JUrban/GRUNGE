...
fof(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(lamtp_f4073,axiom,(
    ! [V2b] :
     ...
     => ! [V1t] :
         ...
         => ! [V3y] :
              ( mem(V3y,ty_2Erealax_2Ereal)
             => mem(f4073(V2b,V1t,V3y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f4073,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V3y] :
             ...
             => ! [V4z] :
                 ...
                 => ap(f4073(V2b,V1t,V3y),V4z) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V3y),V4z)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V1t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4z),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2b))))) ) ) ) ) )).

fof(lamtp_f4072,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => mem(f4072(V2b,V1t),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).

fof(lameq_f4072,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V3y] :
              ( mem(V3y,ty_2Erealax_2Ereal)
             => ap(f4072(V2b,V1t),V3y) = f4073(V2b,V1t,V3y) ) ) ) )).

fof(lamtp_f4075,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5y] :
             ...
             => mem(f4075(V2b,V0s,V5y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f4075,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5y] :
             ...
             => ! [V6z] :
                 ...
                 => ap(f4075(V2b,V0s,V5y),V6z) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V5y),V6z)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V0s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6z),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2b))))) ) ) ) ) )).

fof(lamtp_f4074,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f4074(V2b,V0s),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) )).

fof(lameq_f4074,axiom,(
    ! [V2b] :
      ( mem(V2b,ty_2Erealax_2Ereal)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5y] :
              ( mem(V5y,ty_2Erealax_2Ereal)
             => ap(f4074(V2b,V0s),V5y) = f4075(V2b,V0s,V5y) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE__SUMS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2b] :
             ...
             => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                  & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                  & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4072(V2b,V1t)))))
                  & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1t),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4074(V2b,V0s))))) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),V2b)) ) ) ) ) )).
