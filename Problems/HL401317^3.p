...
thf(thm_2Ebit_2EADD__BITS__SUC,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBITS @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Earithmetic_2E_2B @ V1a @ V2b ) )
      = ( c_2Earithmetic_2EMOD @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBITS @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Enum_2ESUC @ V0n ) @ V1a ) @ ( c_2Ebit_2EBITS @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Enum_2ESUC @ V0n ) @ V2b ) ) @ ( c_2Ebit_2EBITS @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V1a ) @ ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V2b ) ) ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) )).
...
thf(thm_2Ebit_2EADD__BIT__SUC,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Earithmetic_2E_2B @ V1a @ V2b ) )
      = ( c_2Ebool_2ECOND @ $o @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V1a ) @ ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V2b ) ) ) @ ( c_2Emin_2E_3D @ $o @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ V1a ) @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ V2b ) ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ $o @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ V1a ) @ ( c_2Ebit_2EBIT @ ( c_2Enum_2ESUC @ V0n ) @ V2b ) ) ) ) ) )).
