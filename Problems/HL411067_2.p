...
tff(conj_thm_2Ereal__topology_2ECOMPACT__IMP__HEINE__BOREL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => ! [V1f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHEINE__BOREL__IMP__BOLZANO__WEIERSTRASS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1f: $i] :
            ( mem(V1f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
       ...
       => ! [V4t: $i] :
           ...
           => ( ( ~ p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V4t))
                & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V4t),V0s)) )
             => ? [V5x: tp__ty_2Erealax_2Ereal] :
                  ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V0s))
                  & p(ap(ap(c_2Ereal__topology_2Elimit__point__of,inj__ty_2Erealax_2Ereal(V5x)),V4t)) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1t: $i] :
           ...
           => ( ( ~ p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V1t))
             ...
             => ? [V2x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Elimit__point__of,inj__ty_2Erealax_2Ereal(V2x)),V1t)) ) )
       => p(ap(c_2Ereal__topology_2Ebounded__def,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1t: $i] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
      <=> ! [V1f: $i] :
