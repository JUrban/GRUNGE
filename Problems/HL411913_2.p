...
tff(conj_thm_2Eiterate_2EREAL__INF__UNIQUE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__EXISTS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f4080,type,(
    f4080: ( tp__ty_2Erealax_2Ereal * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4080,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : mem(f4080(V2e,V1t,V3x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f4080,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] : ap(f4080(V2e,V1t,V3x),inj__ty_2Erealax_2Ereal(V4y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Erealax_2Ereal(V4y))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V1t)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V4y))),inj__ty_2Erealax_2Ereal(V2e)))) ) )).

tff(lmtp_f4079,type,(
    f4079: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4079,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4079(V2e,V1t),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).

tff(lameq_f4079,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f4079(V2e,V1t),inj__ty_2Erealax_2Ereal(V3x)) = f4080(V2e,V1t,V3x) ) )).

tff(lmtp_f4082,type,(
    f4082: ( tp__ty_2Erealax_2Ereal * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4082,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : mem(f4082(V2e,V0s,V5x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f4082,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5x: tp__ty_2Erealax_2Ereal,V6y: tp__ty_2Erealax_2Ereal] : ap(f4082(V2e,V0s,V5x),inj__ty_2Erealax_2Ereal(V6y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V5x)),inj__ty_2Erealax_2Ereal(V6y))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V0s)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V6y))),inj__ty_2Erealax_2Ereal(V2e)))) ) )).

tff(lmtp_f4081,type,(
    f4081: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4081,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4081(V2e,V0s),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).

tff(lameq_f4081,axiom,(
    ! [V2e: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f4081(V2e,V0s),inj__ty_2Erealax_2Ereal(V5x)) = f4082(V2e,V0s,V5x) ) )).

tff(lmtp_f4078,type,(
    f4078: ( $i * $i ) > $i )).

tff(lamtp_f4078,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => mem(f4078(V0s,V1t),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f4078,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2e: tp__ty_2Erealax_2Ereal] : ap(f4078(V0s,V1t),inj__ty_2Erealax_2Ereal(V2e)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2e)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2e))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4079(V2e,V1t))))),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1t),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4081(V2e,V0s))))))) ) ) )).

tff(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__NONTRIVIAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
              ...
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))) = surj__ty_2Erealax_2Ereal(ap(c_2Eiterate_2Einf,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4078(V0s,V1t)))) ) ) ) )).
