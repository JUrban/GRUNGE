...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V1f_27] :
                   ...
                   => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V1f_27),V0s),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0s)))
                     => ! [V2f] :
                         ...
                         => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0s)) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2f),V1f_27)),V0s) ) ) ) ) ) ) ) )).
