...
tff(thm_2Ebool_2Eitself__TY__DEF,axiom,(
    ! [A_27a: d] :
    ? [V0rep_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2ETYPE__DEFINITION_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Emin_2E_3D_2E1(s(A_27a,c_2Ebool_2EARB_2E0))),s(tyop_2Emin_2Efun(tyop_2Ebool_2Eitself(A_27a),A_27a),V0rep_2E0))))) )).

tff(thm_2Ebool_2EITSELF__UNIQUE,conjecture,(
    ! [A_27a: d,V0i_2E0: u] : s(tyop_2Ebool_2Eitself(A_27a),V0i_2E0) = s(tyop_2Ebool_2Eitself(A_27a),c_2Ebool_2Ethe__value_2E0) )).
