...
tff(thm_2Ebool_2EMONO__COND,conjecture,(
    ! [V0z_2E0: mono_2Etyop_2Emin_2Ebool,V1y_2E0: mono_2Etyop_2Emin_2Ebool,V2x_2E0: mono_2Etyop_2Emin_2Ebool,V3w_2E0: mono_2Etyop_2Emin_2Ebool,V4b_2E0: mono_2Etyop_2Emin_2Ebool] :
      ( ( p(V2x_2E0)
       => p(V1y_2E0) )
     => ( ( p(V0z_2E0)
         => p(V3w_2E0) )
       => ( p(mono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Emin_2Ebool(V4b_2E0,V2x_2E0,V0z_2E0))
         => p(mono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Emin_2Ebool(V4b_2E0,V1y_2E0,V3w_2E0)) ) ) ) )).
