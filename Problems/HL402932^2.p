...
thf(conj_thm_2EpatternMatches_2Esome__var__bool__F,conjecture,
    ( ( surj__c_ty_2Eoption_2Eoption_o
      @ ( ap @ ( c_2Eoption_2Esome @ bool )
        @ ( lam @ bool
          @ ^ [V0x: $i] :
              ( ap @ c_2Ebool_2E_7E @ V0x ) ) ) )
    = ( surj__c_ty_2Eoption_2Eoption_o @ ( ap @ ( c_2Eoption_2ESOME @ bool ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) )).
