...
tff(conj_thm_2Ewellorder_2EFLATTEN__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0g: $i] :
      ( mem(V0g,arr(A_27b,A_27a))
     => ! [V1f: $i] :
...
tff(conj_thm_2Ewellorder_2EINJECTIVE__LEFT__INVERSE__NONEMPTY,conjecture,(
               ...
               => ( ! [V4x: $i] :
                     ...
                     => ! [V5y: $i] :
                         ...
                         => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),V1s))
                           ...
                           => V4x = V5y ) ) )
                <=> ? [V6g: $i] :
                      ( mem(V6g,arr(A_27b,A_27a))
                      & ! [V7y: $i] :
                          ( mem(V7y,A_27b)
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V7y),V2t))
                           => p(ap(ap(c_2Ebool_2EIN(A_27a),ap(V6g,V7y)),V1s)) ) )
                      & ! [V8x: $i] :
                          ( mem(V8x,A_27a)
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V8x),V1s))
                           => ap(V6g,ap(V0f,V8x)) = V8x ) ) ) ) ) ) ) ) )).
