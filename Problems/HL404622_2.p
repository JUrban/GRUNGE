...
tff(tp_c_2Efinite__map_2Efmap__ABS,type,(
    c_2Efinite__map_2Efmap__ABS: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2Efmap__ABS,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2Efmap__ABS(A_27a,A_27a),arr(arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)),ty_2Efinite__map_2Efmap(A_27a,A_27a))) )).

tff(tp_c_2Efinite__map_2Efmap__REP,type,(
    c_2Efinite__map_2Efmap__REP: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2Efmap__REP,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2Efmap__REP(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))) )).
...
tff(ax_thm_2Efinite__map_2Efmap__ISO__DEF,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0a: $i] :
...
tff(lmtp_f1905,type,(
    f1905: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1905,axiom,(
...
tff(ax_thm_2Efinite__map_2EFUPDATE__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Efinite__map_2EFUPDATE__COMMUTES,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
