...
thf(tp_c_2Erelation_2Eapprox,type,(
    c_2Erelation_2Eapprox: del > del > $i )).

thf(mem_c_2Erelation_2Eapprox,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( mem @ ( c_2Erelation_2Eapprox @ A_27a @ A_27b ) @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) @ ( arr @ ( arr @ ( arr @ A_27a @ A_27b ) @ ( arr @ A_27a @ A_27b ) ) @ ( arr @ A_27a @ ( arr @ ( arr @ A_27a @ A_27b ) @ bool ) ) ) ) ) )).
...
thf(tp_c_2Erelation_2Ethe__fun,type,(
    c_2Erelation_2Ethe__fun: del > del > $i )).

thf(mem_c_2Erelation_2Ethe__fun,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( mem @ ( c_2Erelation_2Ethe__fun @ A_27a @ A_27b ) @ ( arr @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) @ ( arr @ ( arr @ ( arr @ A_27a @ A_27b ) @ ( arr @ A_27a @ A_27b ) ) @ ( arr @ A_27a @ ( arr @ A_27a @ A_27b ) ) ) ) ) )).
...
thf(conj_thm_2Erelation_2EWF__TC,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
...
thf(ax_thm_2Erelation_2Eapprox__def,axiom,(
     ...
     => ! [V1M: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3f: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2Eapprox @ A_27a @ A_27b ) @ V0R ) @ V1M ) @ V2x ) @ V3f ) )
                  <=> ( V3f
                      = ( ap
                        @ ( ap
                          @ ( ap @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b )
                            @ ( lam @ A_27a
                              @ ^ [V4y: $i] :
                                  ( ap @ ( ap @ V1M @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b ) @ V3f ) @ V0R ) @ V4y ) ) @ V4y ) ) )
                          @ V0R )
                        @ V2x ) ) ) ) ) ) ) )).

thf(ax_thm_2Erelation_2Ethe__fun__def,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1M: $i] :
          ( ( mem @ V1M @ ( arr @ ( arr @ A_27a @ A_27b ) @ ( arr @ A_27a @ A_27b ) ) )
         => ! [V2x: $i] :
              ( ( mem @ V2x @ A_27a )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Erelation_2Ethe__fun @ A_27a @ A_27b ) @ V0R ) @ V1M ) @ V2x )
                = ( ap @ ( c_2Emin_2E_40 @ ( arr @ A_27a @ A_27b ) )
                  @ ( lam @ ( arr @ A_27a @ A_27b )
                    @ ^ [V3f: $i] :
                        ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2Eapprox @ A_27a @ A_27b ) @ V0R ) @ V1M ) @ V2x ) @ V3f ) ) ) ) ) ) ) )).

thf(ax_thm_2Erelation_2EWFREC__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1M: $i] :
          ( ( mem @ V1M @ ( arr @ ( arr @ A_27a @ A_27b ) @ ( arr @ A_27a @ A_27b ) ) )
         => ( ( ap @ ( ap @ ( c_2Erelation_2EWFREC @ A_27a @ A_27b ) @ V0R ) @ V1M )
            = ( lam @ A_27a
              @ ^ [V2x: $i] :
                  ( ap
                  @ ( ap @ V1M
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b )
                          @ ( ap
                            @ ( ap @ ( ap @ ( c_2Erelation_2Ethe__fun @ A_27a @ A_27b ) @ ( ap @ ( c_2Erelation_2ETC @ A_27a ) @ V0R ) )
                              @ ( lam @ ( arr @ A_27a @ A_27b )
                                @ ^ [V3f: $i] :
                                    ( lam @ A_27a
                                    @ ^ [V4v: $i] :
                                        ( ap @ ( ap @ V1M @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b ) @ V3f ) @ V0R ) @ V4v ) ) @ V4v ) ) ) )
                            @ V2x ) )
                        @ V0R )
                      @ V2x ) )
                  @ V2x ) ) ) ) ) )).
...
thf(conj_thm_2Erelation_2EWFREC__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1M: $i] :
          ( ( mem @ V1M @ ( arr @ ( arr @ A_27a @ A_27b ) @ ( arr @ A_27a @ A_27b ) ) )
