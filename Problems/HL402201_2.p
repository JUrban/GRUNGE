...
tff(lamtp_f418,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f418(A_27a,V0P),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f418,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f418(A_27a,V0P),V2x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(V0P,V2x)) ) ) )).

tff(conj_thm_2Elist_2ELIST__TO__SET__FILTER,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
