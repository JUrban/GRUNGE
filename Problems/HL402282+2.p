...
fof(conj_thm_2Elist_2ELIST__TO__SET__FLAT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
          ( mem(V0ls,ty_2Elist_2Elist(ty_2Elist_2Elist(A_27a)))
         => ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(c_2Elist_2EFLAT(A_27a),V0ls)) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(c_2Elist_2ELIST__TO__SET(arr(A_27a,bool)),ap(ap(c_2Elist_2EMAP(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),c_2Elist_2ELIST__TO__SET(A_27a)),V0ls))) ) ) )).
