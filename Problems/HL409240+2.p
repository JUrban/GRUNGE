...
fof(conj_thm_2Eintegral_2ELT,lemma,
    ( ! [V0m] :
        ( mem(V0m,ty_2Enum_2Enum)
...
fof(conj_thm_2Eintegral_2EDIVISION__DSIZE__GE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2d] :
             ...
             => ! [V3n] :
                 ...
                 => ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),V2d))
                   ...
                   => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Enum_2ESUC,V3n)),ap(c_2Etransc_2Edsize,V2d))) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EDIVISION__DSIZE__EQ__ALT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
