...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__OPEN,lemma,(
    ! [V0f: $i] :
...
thf(ax_thm_2Ereal__topology_2Elocally,axiom,(
    ! [V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__OPEN__MAP__IMAGE,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ! [V1Q: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V2f ) @ V3s ) )
                      & ! [V4t: $i] :
                          ( ( mem @ V4t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                         => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V3s ) ) @ V4t ) )
                           => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V2f ) @ V3s ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V2f ) @ V4t ) ) ) ) )
                      & ! [V5t: $i] :
                          ( ( mem @ V5t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                         => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V5t ) @ V3s ) )
                              & ( p @ ( ap @ V0P @ V5t ) ) )
                           => ( p @ ( ap @ V1Q @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V2f ) @ V5t ) ) ) ) )
                      & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ V0P ) @ V3s ) ) )
                   => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ V1Q ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V2f ) @ V3s ) ) ) ) ) ) ) ) )).
