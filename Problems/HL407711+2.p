...
fof(lamtp_f2839,axiom,(
    mem(f2839,arr(ty_2EordinalNotation_2Eosyntax,ty_2Epair_2Eprod(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax))) )).

fof(lameq_f2839,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2EordinalNotation_2Eosyntax)
     => ap(f2839,V0n) = ap(ap(c_2Epair_2E_2C(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),V0n),ap(c_2EordinalNotation_2Eis__ord,V0n)) ) )).

fof(lamtp_f2840,axiom,(
    ! [A_27a,A_27a] : mem(f2840(A_27a,A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) )).

fof(lameq_f2840,axiom,(
    ! [A_27a,A_27a,V1a] :
      ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
     => ap(f2840(A_27a,A_27a),V1a) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V1a),ap(ap(c_2Eordinal_2Eordlt(A_27a),V1a),c_2Eordinal_2Eepsilon0(A_27a))) ) )).

fof(conj_thm_2EordNotationSemantics_2EordModel__BIJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),c_2EordNotationSemantics_2EordModel(A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2EordinalNotation_2Eosyntax,ty_2EordinalNotation_2Eosyntax),f2839)),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2840(A_27a,A_27a)))) ) )).
