...
tff(conj_thm_2EHolSmt_2Er238,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1z: $i] :
          ( mem(V1z,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2y: $i] :
              ( mem(V2y,ty_2Efcp_2Ecart(bool,bool))
             => ( ap(ap(c_2Ewords_2Eword__add(A_27a),V0x),V1z) = ap(ap(c_2Ewords_2Eword__add(A_27a),V2y),V0x)
              <=> V2y = V1z ) ) ) ) )).
