...
thf(conj_thm_2Ecardinal_2EHAS__SIZE__NUMSEG__LE,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p
      @ ( ap
        @ ( ap @ ( c_2Ecardinal_2EHAS__SIZE @ ty_2Enum_2Enum )
