...
thf(conj_thm_2Ereal__topology_2ESUMS__SYM,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__SUMS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                ...
                @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V4x: $i] :
                        ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5y: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ V4x ) @ V5y ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V4x ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5y ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1t ) ) ) ) ) ) ) ) ) ) ) ) )).
