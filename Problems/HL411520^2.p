...
thf(ax_thm_2Ereal__topology_2Eopen__def,axiom,(
    ! [V0s: $i] :
...
thf(ax_thm_2Ereal__topology_2Einterior,axiom,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Einterior @ V0s )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x )
                @ ( ap @ ( c_2Ebool_2E_3F @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                  @ ( lam @ ( arr @ ty_2Erealax_2Ereal @ bool )
                    @ ^ [V2t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ereal__topology_2EOpen @ V2t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V1x ) @ V2t ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V2t ) @ V0s ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__MAXIMAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__CLOSED__INTERVAL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2ECLOSED__interval @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ ( c_2Elist_2ENIL @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) ) ) )
