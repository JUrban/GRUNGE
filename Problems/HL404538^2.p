...
thf(conj_thm_2Ecardinal_2ECARD__LE__IMAGE__GEN,lemma,(
...
thf(ax_thm_2Ecardinal_2Eadd__c,axiom,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b ) @ V0s ) @ V1t )
            = ( ap
              @ ( ap @ ( c_2Epred__set_2EUNION @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) @ bool ) @ ( ap @ ( c_2Esum_2EINL @ A_27a @ A_27b ) @ V2x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ V0s ) ) ) ) )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) @ A_27b )
                @ ( lam @ A_27b
                  @ ^ [V3y: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) @ bool ) @ ( ap @ ( c_2Esum_2EINR @ A_27a @ A_27b ) @ V3y ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3y ) @ V1t ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ecardinal_2EUNION__LE__ADD__C,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
