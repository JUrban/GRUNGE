...
thf(f11781_0_2E0,type,(
    f11781_0_2E0: u )).

thf(f11781_0_2E2,type,(
    f11781_0_2E2: du > du > u )).

thf(f11781_0_2E3,type,(
    f11781_0_2E3: du > du > du > u )).

thf(f11782_0_2E0,type,(
    f11782_0_2E0: u )).

thf(f11782_0_2E2,type,(
    f11782_0_2E2: du > du > u )).

thf(f11782_0_2E3,type,(
...
thf(mono_2Ef11781_0,type,(
    mono_2Ef11781_0: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11782_0,type,(
    mono_2Ef11782_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__LMUL,axiom,(
    ! [V1c: mono_2Etyop_2Erealax_2Ereal,V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11781_0 @ V1c @ V0p @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ ( V0p @ V2x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__LMUL,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11781_0 @ V1c @ V0p ) ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__RMUL,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11782_0 @ V0p @ V1c @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0p @ V2x ) @ V1c ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__RMUL,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11782_0 @ V0p @ V1c ) ) ) )).
