...
thf(thm_2Elebesgue_2Efn__seq__def,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( c_2Elebesgue_2Efn__seq @ A_27a @ V0m @ V1f )
      = ( ^ [V2n: tyop_2Enum_2Enum,V3x: A_27a] :
            ( c_2Eextreal_2Eextreal__add
            @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ tyop_2Enum_2Enum
              @ ^ [V4k: tyop_2Enum_2Enum] :
                  ( c_2Eextreal_2Eextreal__mul @ ( c_2Eextreal_2Eextreal__div @ ( c_2Eextreal_2Eextreal__of__num @ V4k ) @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) )
                  @ ( c_2Emeasure_2Eindicator__fn @ A_27a
                    @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                      @ ^ [V5x: A_27a] :
                          ( c_2Epair_2E_2C @ A_27a @ $o @ V5x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V5x @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__div @ ( c_2Eextreal_2Eextreal__of__num @ V4k ) @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) ) @ ( V1f @ V5x ) ) @ ( c_2Eextreal_2Eextreal__lt @ ( V1f @ V5x ) @ ( c_2Eextreal_2Eextreal__div @ ( c_2Eextreal_2Eextreal__add @ ( c_2Eextreal_2Eextreal__of__num @ V4k ) @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) ) ) ) ) ) )
                    @ V3x ) )
              @ ( c_2Epred__set_2Ecount @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) ) )
            @ ( c_2Eextreal_2Eextreal__mul @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V2n )
              @ ( c_2Emeasure_2Eindicator__fn @ A_27a
                @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                  @ ^ [V6x: A_27a] :
                      ( c_2Epair_2E_2C @ A_27a @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V6x @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) ) @ ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__pow @ ( c_2Eextreal_2Eextreal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) @ ( V1f @ V6x ) ) ) ) )
                @ V3x ) ) ) ) ) )).
