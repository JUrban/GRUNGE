...
fof(conj_thm_2Epred__set_2EPREIMAGE__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                  ( mem(V1s,arr(A_27a,bool))
                 => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1s),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))) ) ) ) ) )).
