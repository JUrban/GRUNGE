...
fof(conj_thm_2Elist_2EUNIQUE__LENGTH__FILTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Erich__list_2EUNIQUE__LIST__ELEM__COUNT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
         => ! [V1L] :
              ( mem(V1L,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Elist_2EUNIQUE(A_27a),V0e),V1L))
              <=> ap(ap(c_2Erich__list_2ELIST__ELEM__COUNT(A_27a),V0e),V1L) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) ) ) ) ) )).
