         ...
         => ( c_2Ereal__topology_2EOpen
            @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V3x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V3x @ ( V1Q @ V2a @ V3x ) ) ) ) )
     => ( c_2Ereal__topology_2EOpen
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V4x: tyop_2Erealax_2Ereal] :
              ...
              @ ( c_2Ebool_2E_3F @ A_27a
                @ ^ [V5a: A_27a] :
                    ( c_2Ebool_2E_2F_5C @ ( V0P @ V5a ) @ ( V1Q @ V5a @ V4x ) ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2EOPEN__EXISTS,conjecture,(
    ! [A_27a: $tType,V0Q: A_27a > tyop_2Erealax_2Ereal > $o] :
      ( ! [V1a: A_27a] :
          ( c_2Ereal__topology_2EOpen
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2x: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( V0Q @ V1a @ V2x ) ) ) )
     => ( c_2Ereal__topology_2EOpen
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V3x: tyop_2Erealax_2Ereal] :
