...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__CMUL,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => ( p
                @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V0s )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3n: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ V1x @ V3n ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESUMMABLE__EQ,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__FROM__ELSEWHERE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__PARTIAL__SUMS,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( ( p
            @ ( ap @ c_2Ereal__topology_2Ebounded__def
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1k ) ) @ V2n ) ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V2n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )
         => ( p
            @ ( ap @ c_2Ereal__topology_2Ebounded__def
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
                @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3m: $i] :
                        ( lam @ ty_2Enum_2Enum
                        @ ^ [V4n: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ V3m ) @ V4n ) ) @ V0f ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V3m ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V4n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESUMMABLE__BILINEAR__PARTIAL__PRE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET__BILINEAR,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                    ...
                    & ( p
                      @ ( ap @ c_2Ereal__topology_2Ebounded__def
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum )
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V7n: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ V7n ) ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V7n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )
                    & ( p
                      @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V5p ) ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V8n: $i] :
                              ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V1g @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V8n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ V1g @ V8n ) ) ) ) ) )
                    & ( p
                      @ ( ap
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V9n: $i] :
                                  ( ap @ ( ap @ V2h @ ( ap @ V1g @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ V9n ) ) @ V0f ) ) ) )
                          @ ( inj__ty_2Erealax_2Ereal @ V6l ) )
                        @ c_2Ereal__topology_2Esequentially ) ) )
                 => ( p
                    @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V3k ) ) )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V10n: $i] :
                            ( ap @ ( ap @ V2h @ ( ap @ V1g @ V10n ) ) @ ( ap @ V0f @ V10n ) ) ) ) ) ) ) ) ) )).
