...
thf(f9471_0_2E0,type,(
    f9471_0_2E0: u )).

thf(f9471_0_2E1,type,(
    f9471_0_2E1: du > u )).

thf(f9471_0_2E2,type,(
    f9471_0_2E2: du > du > u )).
...
thf(mono_2Ef9471_0,type,(
    mono_2Ef9471_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eseq_2EGP__FINITE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9471_0 @ V0x @ V2n )
      = ( mono_2Ec_2Ereal_2Epow @ V0x @ V2n ) ) )).

thf(thm_2Eseq_2EGP__FINITE,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0x
          = ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
     => ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ V1n ) @ ( mono_2Ef9471_0 @ V0x ) )
          = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).
