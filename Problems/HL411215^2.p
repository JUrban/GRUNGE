...
thf(conj_thm_2Ereal__topology_2ELIM__NULL,lemma,(
    ! [A_27a: del,V0net: $i] :
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V1f @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) ) )
                    @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                  @ V0net ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELIM__AT__ZERO,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
              ...
              @ ( ap
                @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V3x: $i] :
                        ( ap @ V0f @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ V3x ) ) ) )
                @ ( inj__ty_2Erealax_2Ereal @ V1l ) )
              @ ( ap @ c_2Ereal__topology_2Eat @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELINEAR__LIM__0,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
...
thf(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__AT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
