...
tff(conj_thm_2Equotient__pair_2EPAIR__REL__REFL,lemma,(
     ...
     => ! [V1R2: $i] :
         ...
         => ( ( ! [V2x: $i] :
           ...
           => ! [V6x: $i] :
               ...
               => p(ap(ap(ap(ap(c_2Equotient__pair_2E_23_23_23(A_27a,A_27a,A_27a,A_27a),V0R1),V1R2),V6x),V6x)) ) ) ) ) )).

tff(conj_thm_2Equotient__pair_2EPAIR__EQUIV,conjecture,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1R2: $i] :
          ( mem(V1R2,arr(A_27b,arr(A_27b,bool)))
         => ( p(ap(c_2Equotient_2EEQUIV(A_27a),V0R1))
           => ( p(ap(c_2Equotient_2EEQUIV(A_27b),V1R2))
             => p(ap(c_2Equotient_2EEQUIV(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Equotient__pair_2E_23_23_23(A_27a,A_27a,A_27a,A_27a),V0R1),V1R2))) ) ) ) ) )).
