    ...
    <=> ( ( ! [V3t: tyop_2Enum_2Enum] :
        ...
        & ! [V5d: tyop_2Enum_2Enum] :
            ( ( ! [V6t: tyop_2Enum_2Enum] :
                  ( ( c_2Eprim__rec_2E_3C @ V6t @ V5d )
                 => ( (~) @ ( V1b @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) ) )
              & ( V1b @ ( c_2Earithmetic_2E_2B @ V5d @ V0t0 ) ) )
           => ! [V7t: tyop_2Enum_2Enum] :
                ( ( c_2Eprim__rec_2E_3C @ V7t @ V5d )
               => ( V2a @ ( c_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) ) ) ) )).
...
thf(thm_2EPast__Temporal__Logic_2EDISJUNCTIVE__NORMAL__FORM,conjecture,(
    ! [V0c: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V3t ) @ ( V1b @ V3t ) ) )
        = ( ^ [V4t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V2a @ V4t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1b @ V4t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EEVENTUAL
          @ ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V5t ) @ ( V1b @ V5t ) ) )
        = ( ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EEVENTUAL @ V2a @ V6t ) @ ( c_2ETemporal__Logic_2EEVENTUAL @ V1b @ V6t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EWHEN
          @ ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V7t ) @ ( V1b @ V7t ) )
          @ V0c )
        = ( ^ [V8t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EWHEN @ V2a @ V0c @ V8t ) @ ( c_2ETemporal__Logic_2EWHEN @ V1b @ V0c @ V8t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ESWHEN
          @ ^ [V9t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V9t ) @ ( V1b @ V9t ) )
          @ V0c )
        = ( ^ [V10t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ESWHEN @ V2a @ V0c @ V10t ) @ ( c_2ETemporal__Logic_2ESWHEN @ V1b @ V0c @ V10t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EUNTIL @ V2a
          @ ^ [V11t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V11t ) @ ( V0c @ V11t ) ) )
        = ( ^ [V12t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EUNTIL @ V2a @ V1b @ V12t ) @ ( c_2ETemporal__Logic_2EUNTIL @ V2a @ V0c @ V12t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ESUNTIL @ V2a
          @ ^ [V13t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V13t ) @ ( V0c @ V13t ) ) )
        = ( ^ [V14t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ESUNTIL @ V2a @ V1b @ V14t ) @ ( c_2ETemporal__Logic_2ESUNTIL @ V2a @ V0c @ V14t ) ) ) )
      & ( ( c_2ETemporal__Logic_2EBEFORE
          @ ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V15t ) @ ( V1b @ V15t ) )
          @ V0c )
        = ( ^ [V16t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2EBEFORE @ V2a @ V0c @ V16t ) @ ( c_2ETemporal__Logic_2EBEFORE @ V1b @ V0c @ V16t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ESBEFORE
          @ ^ [V17t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V17t ) @ ( V1b @ V17t ) )
          @ V0c )
        = ( ^ [V18t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ESBEFORE @ V2a @ V0c @ V18t ) @ ( c_2ETemporal__Logic_2ESBEFORE @ V1b @ V0c @ V18t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT
          @ ^ [V19t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V19t ) @ ( V1b @ V19t ) ) )
        = ( ^ [V20t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a @ V20t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1b @ V20t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPEVENTUAL
          @ ^ [V21t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V21t ) @ ( V1b @ V21t ) ) )
        = ( ^ [V22t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V2a @ V22t ) @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V1b @ V22t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPWHEN
          @ ^ [V23t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V23t ) @ ( V1b @ V23t ) )
          @ V0c )
        = ( ^ [V24t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V2a @ V0c @ V24t ) @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V1b @ V0c @ V24t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSWHEN
          @ ^ [V25t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V25t ) @ ( V1b @ V25t ) )
          @ V0c )
        = ( ^ [V26t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V2a @ V0c @ V26t ) @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V1b @ V0c @ V26t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a
          @ ^ [V27t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V27t ) @ ( V0c @ V27t ) ) )
        = ( ^ [V28t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V1b @ V28t ) @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V0c @ V28t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a
          @ ^ [V29t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V29t ) @ ( V0c @ V29t ) ) )
        = ( ^ [V30t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V1b @ V30t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V0c @ V30t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPBEFORE
          @ ^ [V31t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V31t ) @ ( V1b @ V31t ) )
          @ V0c )
        = ( ^ [V32t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V2a @ V0c @ V32t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1b @ V0c @ V32t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSBEFORE
          @ ^ [V33t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V33t ) @ ( V1b @ V33t ) )
          @ V0c )
        = ( ^ [V34t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V2a @ V0c @ V34t ) @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V1b @ V0c @ V34t ) ) ) ) ) )).
