...
tff(conj_thm_2Epred__set_2ESURJ__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1s: $i] :
            ( mem(V1s,arr(A_27b,bool))
           => ( p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V0f),c_2Epred__set_2EEMPTY(A_27a)),V1s))
            <=> V1s = c_2Epred__set_2EEMPTY(A_27b) ) )
        & ! [V2s: $i] :
            ( mem(V2s,arr(A_27a,bool))
           => ( p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V0f),V2s),c_2Epred__set_2EEMPTY(A_27b)))
            <=> V2s = c_2Epred__set_2EEMPTY(A_27a) ) ) ) ) )).
...
tff(conj_thm_2Epred__set_2EBIJ__EMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1s: $i] :
            ( mem(V1s,arr(A_27b,bool))
