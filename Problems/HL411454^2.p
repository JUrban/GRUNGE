...
thf(conj_thm_2Ereal__topology_2ELIM__BILINEAR,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2ELIM__MUL,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5x: $i] :
                                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V3c @ V5x ) ) @ ( ap @ V1f @ V5x ) ) ) )
                        @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) )
                      @ V0net ) ) ) ) ) ) )).
