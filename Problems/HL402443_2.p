...
tff(conj_thm_2EerrorStateMonad_2EMMAP__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),ap(c_2EerrorStateMonad_2EMMAP(A_27c,A_27c,A_27c),V0f)),c_2EerrorStateMonad_2EUNIT(A_27c,A_27c)) = ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2EerrorStateMonad_2EUNIT(A_27c,A_27c)),V0f) ) )).
