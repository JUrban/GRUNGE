...
fof(conj_thm_2Ebinary__ieee_2Efloat__round__non__zero,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3s] :
                         ...
                         => ! [V4e] :
                             ...
                             => ! [V5f] :
                                 ...
                                 => ( ( ap(ap(c_2Ebinary__ieee_2Eround(A_27b,A_27b),V0mode),V2r) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V3s)),ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27b,A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V4e)),ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(A_27b,A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V5f)),c_2Ebool_2EARB(ty_2Ebinary__ieee_2Efloat(A_27b,A_27b)))))
                                      & ( V4e != ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)
                                        | V5f != ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0) ) )
                                   => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27b,A_27b),V0mode),V1toneg),V2r) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V3s)),ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(A_27b,A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V4e)),ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(A_27b,A_27b,A_27b),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V5f)),c_2Ebool_2EARB(ty_2Ebinary__ieee_2Efloat(A_27b,A_27b))))) ) ) ) ) ) ) ) ) ) )).
