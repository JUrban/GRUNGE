...
fof(lameq_f898,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f898(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f889(V0a)),V1b),V2t0))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f881(V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__AS__UNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
