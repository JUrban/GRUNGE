...
fof(conj_thm_2Epred__set_2EPROD__IMAGE__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
         => ( ap(ap(c_2Epred__set_2EPROD__IMAGE(A_27a),V0f),c_2Epred__set_2EEMPTY(A_27a)) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))
            & ! [V1e] :
                ( mem(V1e,A_27a)
               => ! [V2s] :
                    ( mem(V2s,arr(A_27a,bool))
                   => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                     => ap(ap(c_2Epred__set_2EPROD__IMAGE(A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1e),V2s)) = ap(ap(c_2Earithmetic_2E_2A,ap(V0f,V1e)),ap(ap(c_2Epred__set_2EPROD__IMAGE(A_27a),V0f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V2s),V1e))) ) ) ) ) ) ) )).

fof(ax_thm_2Epred__set_2EPROD__SET__DEF,axiom,(
    c_2Epred__set_2EPROD__SET = ap(c_2Epred__set_2EPROD__IMAGE(ty_2Enum_2Enum),c_2Ecombin_2EI(ty_2Enum_2Enum)) )).

fof(conj_thm_2Epred__set_2EPROD__SET__THM,conjecture,
