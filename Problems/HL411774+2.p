...
fof(conj_thm_2Eiterate_2ESUM__ABS__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(lameq_f3764,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V3b] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3764(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1f,V4x))),V3b) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__ABS__UBOUND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ESUMS__OFFSET,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2m] :
             ...
             => ! [V3n] :
                  ( mem(V3n,ty_2Enum_2Enum)
                 => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),ap(c_2Ereal__topology_2Efrom,V2m)))
                      & p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V3n))
                      & p(ap(ap(c_2Earithmetic_2E_3C_3D,V2m),V3n)) )
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Ereal_2Ereal__sub,V1l),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),ap(ap(c_2Earithmetic_2E_2D,V3n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0f))),ap(c_2Ereal__topology_2Efrom,V3n))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__DROP__POS,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
         ...
         => ! [V2a] :
             ...
             => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V2a),V1s))
                  & ! [V3x] :
                      ( mem(V3x,ty_2Enum_2Enum)
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3x),V1s))
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(V0f,V3x))) ) ) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2a)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__BOUND,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ! [V2s] :
             ...
             => ! [V3a] :
                 ...
                 => ! [V4b] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V3a),V2s))
                          & p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),V4b),V2s))
                          & ! [V5i] :
                              ( mem(V5i,ty_2Enum_2Enum)
                             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5i),V2s))
                               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,V5i))),ap(V1g,V5i))) ) ) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V3a)),V4b)) ) ) ) ) ) ) )).
