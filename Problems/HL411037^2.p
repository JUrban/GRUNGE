...
thf(conj_thm_2Ecardinal_2ELT,lemma,
...
thf(conj_thm_2Ecardinal_2ELT__LE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
    <=> ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        & ( V0m != V1n ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EMONOTONE__SUBSEQUENCE,conjecture,(
    ! [V0s: $i] :
     ...
     => ? [V1r: $i] :
          ...
          & ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
             ...
             => ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) )
          & ( ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
                ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) )
               => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0s @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V4m ) ) ) ) @ ( ap @ V0s @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) ) )
            | ! [V6m: tp__ty_2Enum_2Enum,V7n: tp__ty_2Enum_2Enum] :
               ...
               => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0s @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) ) @ ( ap @ V0s @ ( ap @ V1r @ ( inj__ty_2Enum_2Enum @ V6m ) ) ) ) ) ) ) ) ) )).
