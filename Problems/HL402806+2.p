...
fof(conj_thm_2Erich__list_2EMEM__REPLICATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0n))
           => ! [V1x] :
                ( mem(V1x,A_27a)
               => p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V0n),V1x)))) ) ) ) ) )).
