...
thf(arityeq5_2Emono_2Ec_2Edft_2EDFT_2E5_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u,X4_2E0: u] :
      ( ( s @ A_27b @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X3_2E0 ) @ ( s @ A_27b @ X4_2E0 ) ) )
...
thf(thm_2Edft_2EDFT__def,axiom,(
    ! [A_27a: d,A_27b: d,V0visit__now_2E0: u,V1visit__later_2E0: u,V2seen_2E0: u,V3f_2E0: u,V4acc_2E0: u,V5G_2E0: u] :
     ...
     => ( ( ( s @ A_27b @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V5G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ A_27b @ V4acc_2E0 ) ) )
          = ( s @ A_27b @ V4acc_2E0 ) )
        & ( ( s @ A_27b @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V5G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0visit__now_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1visit__later_2E0 ) ) ) @ ( s @ A_27b @ V4acc_2E0 ) ) )
          = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0visit__now_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) ) ) ) ) @ ( s @ A_27b @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V5G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1visit__later_2E0 ) @ ( s @ A_27b @ V4acc_2E0 ) ) ) @ ( s @ A_27b @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V5G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0visit__now_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V5G_2E0 ) @ ( s @ A_27a @ V0visit__now_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1visit__later_2E0 ) ) ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V3f_2E0 ) @ ( s @ A_27a @ V0visit__now_2E0 ) ) ) @ ( s @ A_27b @ V4acc_2E0 ) ) ) ) ) ) ) ) ) ) )).
    ...
    ! [A_27a: d,A_27b: d,V0P_2E0: u] :
      ( ! [V1G_2E0: u,V2f_2E0: u,V3seen_2E0: u,V4visit__now_2E0: u,V5visit__later_2E0: u,V6acc_2E0: u] :
          ...
          & ( ( ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EParents_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1G_2E0 ) ) ) ) ) )
                  & ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V4visit__now_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3seen_2E0 ) ) ) ) ) ) ) )
...
thf(thm_2Edft_2EDFT__CONS,conjecture,(
    ! [A_27a: d,V0G_2E0: u,V1f_2E0: u,V2seen_2E0: u,V3to__visit_2E0: u,V4acc_2E0: u,V5a_2E0: u,V6b_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3to__visit_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4acc_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Edft_2EDFT_2E5 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V0G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2seen_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3to__visit_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5a_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V6b_2E0 ) ) ) ) ) )).
