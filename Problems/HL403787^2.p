...
thf(conj_thm_2Ellist_2Elrep__ok__rules,conjecture,(
    ! [A_27a: del] :
      ( ( p
        @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27a )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V0n: $i] :
                ( c_2Eoption_2ENONE @ A_27a ) ) ) )
      & ! [V1h: $i] :
             ...
             => ( ( p @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27a ) @ V2t ) )
               => ( p
                  @ ( ap @ ( c_2Ellist_2Elrep__ok @ A_27a )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3n: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V3n ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V1h ) ) @ ( ap @ V2t @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V3n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) ) ) )).
