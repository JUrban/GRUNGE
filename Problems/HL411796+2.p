     ...
     => ! [V1x] :
         ...
         => ! [V0s] :
             ...
             => ! [V3n] :
                 ...
                 => ap(f4036(V2e,V1x,V0s),V3n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3n),V0s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(V1x,V3n))),V2e)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__GOESTOZERO,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ! [V1x] :
          ( mem(V1x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
