...
tff(tp_c_2EordinalNotation_2Erank,type,(
    c_2EordinalNotation_2Erank: $i )).

tff(mem_c_2EordinalNotation_2Erank,axiom,(
    mem(c_2EordinalNotation_2Erank,arr(ty_2EordinalNotation_2Eosyntax,ty_2Enum_2Enum)) )).

tff(stp_fo_c_2EordinalNotation_2Erank,type,(
    fo__c_2EordinalNotation_2Erank: tp__ty_2EordinalNotation_2Eosyntax > tp__ty_2Enum_2Enum )).

tff(stp_eq_fo_c_2EordinalNotation_2Erank,axiom,(
    ! [X0: tp__ty_2EordinalNotation_2Eosyntax] : inj__ty_2Enum_2Enum(fo__c_2EordinalNotation_2Erank(X0)) = ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(X0)) )).

tff(conj_thm_2EordinalNotation_2Eoless__imp__rank__leq,lemma,(
    ! [V0x: tp__ty_2EordinalNotation_2Eosyntax,V1y: tp__ty_2EordinalNotation_2Eosyntax] :
     ...
     => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V0x))),ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V1y)))) ) )).

tff(conj_thm_2EordinalNotation_2Elemma,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1P: $i] :
      ( mem(V1P,arr(ty_2EordinalNotation_2Eosyntax,bool))
     => ( ? [V2x: tp__ty_2EordinalNotation_2Eosyntax] :
            ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V2x)))
            & p(ap(V1P,inj__ty_2EordinalNotation_2Eosyntax(V2x)))
            & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V2x))),inj__ty_2Enum_2Enum(V0n))) )
       => ? [V3m: tp__ty_2EordinalNotation_2Eosyntax] :
            ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V3m)))
            & p(ap(V1P,inj__ty_2EordinalNotation_2Eosyntax(V3m)))
            & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V3m))),inj__ty_2Enum_2Enum(V0n)))
            & ! [V4y: tp__ty_2EordinalNotation_2Eosyntax] :
                ( ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V4y)))
                  & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V4y))),inj__ty_2Enum_2Enum(V0n)))
                  & p(ap(ap(c_2EordinalNotation_2Eoless,inj__ty_2EordinalNotation_2Eosyntax(V4y)),inj__ty_2EordinalNotation_2Eosyntax(V3m))) )
               => ~ p(ap(V1P,inj__ty_2EordinalNotation_2Eosyntax(V4y))) ) ) ) ) )).

tff(conj_thm_2EordinalNotation_2Emain__lemma,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2EordinalNotation_2Eosyntax,bool))
     => ( ? [V1x: tp__ty_2EordinalNotation_2Eosyntax] :
            ( p(ap(V0P,inj__ty_2EordinalNotation_2Eosyntax(V1x)))
            & p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V1x))) )
       => ? [V2x: tp__ty_2EordinalNotation_2Eosyntax] :
            ( p(ap(V0P,inj__ty_2EordinalNotation_2Eosyntax(V2x)))
            & p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V2x)))
            & ! [V3y: tp__ty_2EordinalNotation_2Eosyntax] :
                ( ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V3y)))
                  & p(ap(ap(c_2EordinalNotation_2Eoless,inj__ty_2EordinalNotation_2Eosyntax(V3y)),inj__ty_2EordinalNotation_2Eosyntax(V2x))) )
               => ~ p(ap(V0P,inj__ty_2EordinalNotation_2Eosyntax(V3y))) ) ) ) ) )).
