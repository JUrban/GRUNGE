...
fof(lamtp_f1836,axiom,(
    ! [V2r] :
      ( mem(V2r,ty_2Enum_2Enum)
     => mem(f1836(V2r),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

fof(lameq_f1836,axiom,(
    ! [V2r] :
      ( mem(V2r,ty_2Enum_2Enum)
     => ! [V3s0] :
          ( mem(V3s0,ty_2Elist_2Elist(ty_2Estring_2Echar))
         => ap(f1836(V2r),V3s0) = ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(c_2Estring_2ECHR,ap(ap(c_2Earithmetic_2E_2D,V2r),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V3s0) ) ) )).

fof(lamtp_f1835,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f1835(V0n),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).
...
fof(lameq_f1835,axiom,(
    ! [V0n] :
     ...
     => ! [V2r] :
          ( mem(V2r,ty_2Enum_2Enum)
         => ap(f1835(V0n),V2r) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),f1836(V2r)),ap(c_2Estring__num_2En2s,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),V2r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))))) ) ) )).

fof(lamtp_f1834,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f1834(V0n),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

fof(lameq_f1834,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1r0] :
          ( mem(V1r0,ty_2Enum_2Enum)
         => ap(f1834(V0n),V1r0) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1835(V0n)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1r0),c_2Enum_2E0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))),V1r0)) ) ) )).

fof(conj_thm_2Estring__num_2En2s__def,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Estring__num_2En2s,V0n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0n),c_2Enum_2E0)),c_2Elist_2ENIL(ty_2Estring_2Echar)),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1834(V0n)),ap(ap(c_2Earithmetic_2EMOD,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))))) ) )).
