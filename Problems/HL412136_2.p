...
tff(tp_c_2Eprobability_2Econditional__distribution,type,(
    c_2Eprobability_2Econditional__distribution: ( del * del * del ) > $i )).

tff(mem_c_2Eprobability_2Econditional__distribution,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,A_27b),arr(arr(A_27a,A_27c),arr(arr(A_27b,bool),arr(arr(A_27c,bool),ty_2Erealax_2Ereal)))))) )).
...
tff(ax_thm_2Eprobability_2Econditional__distribution__def,axiom,(
         ...
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V1X),V2Y),V3a),V4b)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b))),ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V4b))) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Emarginal__joint__zero,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          ...
                          & ( surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V3s)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
                            | surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V4t)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )
                       => surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3s),V4t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Ejoint__distribution__le2,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b))),ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V4b))) ) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Edistribution__pos,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
     ...
     => ! [V1X: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                  & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V2a))) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Econditional__distribution__le__1,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ! [V4b: $i] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                          & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V1X),V2Y),V3a),V4b)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) ) ) ) ) )).
