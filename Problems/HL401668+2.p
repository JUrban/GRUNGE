...
fof(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
         ...
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
          <=> ? [V1c] :
                ...
                & ? [V2n] :
                    ...
                    & p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Enum_2Enum,ty_2Enum_2Enum),V1c),ap(c_2Epred__set_2Ecount,V2n)),V0s)) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ? [V1f] :
                ...
                & ? [V2b] :
                    ...
                    & p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),ap(c_2Epred__set_2Ecount,V2b)),V0s)) ) ) ) ) ) )).
