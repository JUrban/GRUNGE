...
tff(conj_thm_2Earithmetic_2ENOT__GREATER,lemma,(
...
tff(mem_c_2Ewords_2Eword__hi,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__hi(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),bool))) )).
...
tff(lamtp_f2205,axiom,(
    ! [V3z: tp__o] : mem(f2205(V3z),arr(bool,arr(bool,bool))) )).

tff(lameq_f2205,axiom,(
    ! [V3z: tp__o,V4c: tp__o] : ap(f2205(V3z),inj__o(V4c)) = k(bool,ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,inj__o(V4c))),inj__o(V3z))) )).

tff(lmtp_f2204,type,(
    f2204: $i )).

tff(lamtp_f2204,axiom,(
    mem(f2204,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

tff(lameq_f2204,axiom,(
    ! [V3z: tp__o] : ap(f2204,inj__o(V3z)) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2205(V3z)) )).
...
tff(lamtp_f2207,axiom,(
    ! [V3z: tp__o] : mem(f2207(V3z),arr(bool,arr(bool,bool))) )).

tff(lameq_f2207,axiom,(
    ! [V3z: tp__o,V4c: tp__o] : ap(f2207(V3z),inj__o(V4c)) = k(bool,ap(ap(c_2Ebool_2E_2F_5C,inj__o(V4c)),ap(c_2Ebool_2E_7E,inj__o(V3z)))) )).

tff(lmtp_f2206,type,(
    f2206: $i )).

tff(lamtp_f2206,axiom,(
    mem(f2206,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

tff(lameq_f2206,axiom,(
    ! [V3z: tp__o] : ap(f2206,inj__o(V3z)) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2207(V3z)) )).
    ...
    ! [A_27a: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( p(ap(ap(c_2Ewords_2Eword__hi(A_27a),V0a),V1b))
          <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2206)))),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) )).
...
tff(conj_thm_2Ewords_2EWORD__HI,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
