...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__NEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
           => ! [V1f] :
                ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
               => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3175(A_27a,V1f)),V0P) = ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0P)) ) ) ) ) )).
