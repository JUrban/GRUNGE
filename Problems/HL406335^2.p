...
thf(ax_thm_2Erelation_2EWeakLinearOrder,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Etoto_2ETotOrd__TO__of__Weak,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWeakLinearOrder @ A_27a ) @ V0r ) )
       => ( p @ ( ap @ ( c_2Etoto_2ETotOrd @ A_27a ) @ ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ A_27a ) @ V0r ) ) ) ) ) )).

thf(conj_thm_2Etoto_2EWeak__toto__thm,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWeakLinearOrder @ A_27a ) @ V0r ) )
       => ( ( ap @ ( c_2Etoto_2EWeakLinearOrder__of__TO @ A_27a ) @ ( ap @ ( c_2Etoto_2Eapto @ A_27a ) @ ( ap @ ( c_2Etoto_2Etoto__of__LinearOrder @ A_27a ) @ V0r ) ) )
          = V0r ) ) ) )).
