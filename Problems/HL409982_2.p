...
tff(tp_c_2Eextreal_2Eextreal__inf,type,(
    c_2Eextreal_2Eextreal__inf: $i )).

tff(mem_c_2Eextreal_2Eextreal__inf,axiom,(
...
tff(lamtp_f3472,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => mem(f3472(V0f),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f3472,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f3472(V0f),inj__ty_2Enum_2Enum(V3n)) = ap(V0f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n))) ) )).

tff(conj_thm_2Eextreal_2Ele__inf,lemma,(
    ! [V0p: $i] :
...
tff(conj_thm_2Eextreal_2Einf__le,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1x: tp__ty_2Eextreal_2Eextreal] :
...
tff(conj_thm_2Eextreal_2Einf__eq,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1x: tp__ty_2Eextreal_2Eextreal] :
          ( surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__inf,V0p)) = V1x
        <=> ( ! [V2y: tp__ty_2Eextreal_2Eextreal] :
                ( p(ap(V0p,inj__ty_2Eextreal_2Eextreal(V2y)))
               => p(ap(ap(c_2Eextreal_2Eextreal__le,inj__ty_2Eextreal_2Eextreal(V1x)),inj__ty_2Eextreal_2Eextreal(V2y))) )
...
tff(conj_thm_2Eextreal_2Einf__suc,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
       ...
       => surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__inf,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f3472(V0f)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__inf,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) )).
