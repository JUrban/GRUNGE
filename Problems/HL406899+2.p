...
fof(lamtp_f1907,axiom,(
    ! [A_27a] : mem(f1907(A_27a),arr(A_27a,ty_2Eoption_2Eoption(A_27a))) )).
     ...
     => ! [V0m1] :
         ...
         => ! [V1m2] :
             ...
             => ! [V2k] :
                 ...
                 => ap(ap(c_2Esptree_2Elookup(A_27a),V2k),ap(ap(c_2Esptree_2Eunion(A_27a),V0m1),V1m2)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),ap(ap(c_2Esptree_2Elookup(A_27a),V2k),V0m1)),ap(ap(c_2Esptree_2Elookup(A_27a),V2k),V1m2)),f1907(A_27a)) ) ) ) ) )).
...
fof(conj_thm_2Efmsp_2EFMSP__FUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
