...
tff(lamtp_f3809,axiom,(
    ! [A_27a: del,A_27a: del,V1g: $i] :
...
tff(lmtp_f3810,type,(
    f3810: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3810,axiom,(
    ! [A_27a: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__SUMS__IMAGE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(lmtp_f3811,type,(
    f3811: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3811,axiom,(
...
tff(lmtp_f3812,type,(
    f3812: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3812,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V2s: $i] :
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__SUMS__IMAGES,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
