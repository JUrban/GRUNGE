...
fof(conj_thm_2Ebit_2EEXISTS__BIT__LT,lemma,(
    ! [V0b] :
...
fof(lameq_f2240,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2240(A_27a,V0w),V1i) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),V1i) ) ) )).

fof(conj_thm_2Ewords_2ELEAST__BIT__LT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
