...
fof(mem_c_2Elist_2EOPT__MMAP,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Elist_2EOPT__MMAP(A_27a,A_27a),arr(arr(A_27b,ty_2Eoption_2Eoption(A_27a)),arr(ty_2Elist_2Elist(A_27b),ty_2Eoption_2Eoption(ty_2Elist_2Elist(A_27a))))) ) ) )).
...
fof(lamtp_f461,axiom,(
    ! [A_27a,A_27b,A_27a,V1f] :
...
fof(conj_thm_2Elist_2EOPT__MMAP__cong,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
