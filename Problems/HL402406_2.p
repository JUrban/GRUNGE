...
tff(conj_thm_2Estate__transformer_2EEXT__o__UNIT,lemma,(
...
tff(conj_thm_2Estate__transformer_2EMMAP__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27c))
     => ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),ap(c_2Estate__transformer_2EMMAP(A_27a,A_27a,A_27a),V0f)),c_2Estate__transformer_2EUNIT(A_27a,A_27a)) = ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Estate__transformer_2EUNIT(A_27a,A_27a)),V0f) ) )).
