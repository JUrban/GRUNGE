...
thf(conj_thm_2Erich__list_2ELUPDATE__APPEND2,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ! [V2n: tp__ty_2Enum_2Enum,V3x: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l1 ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
               => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2ELUPDATE @ A_27a ) @ V3x ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ V1l2 ) )
                  = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2ELUPDATE @ A_27a ) @ V3x ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l1 ) ) ) @ V1l2 ) ) ) ) ) ) ) )).
