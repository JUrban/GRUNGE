...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__INDICATOR,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1A: A_27a > $o,V2f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1A @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) )
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) )
           => ( ( V2f @ V3x )
              = ( c_2Emeasure_2Eindicator__fn @ A_27a @ V1A @ V3x ) ) ) )
...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__CMUL__INDICATOR,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1z: tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2s @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal )
        @ ^ [V3x: A_27a] :
            ( c_2Eextreal_2Eextreal__mul @ ( c_2Eextreal_2ENormal @ V1z ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V2s @ V3x ) )
