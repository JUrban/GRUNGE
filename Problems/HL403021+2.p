...
fof(conj_thm_2EindexedLists_2EMAPi__APPEND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ! [V2f] :
                     ...
                     => ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V2f),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2)) = ap(ap(c_2Elist_2EAPPEND(A_27b),ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),V2f),V0l1)),ap(ap(c_2EindexedLists_2EMAPi(A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),V0l1)))),V1l2)) ) ) ) ) ) )).
