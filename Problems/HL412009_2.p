...
tff(conj_thm_2Earithmetic_2EEVEN__OR__ODD,lemma,(
...
tff(conj_thm_2Earithmetic_2EODD__EXISTS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(c_2Earithmetic_2EODD,inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Ereal_2EREAL__LT__RDIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__POW__MONO__LT,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__DIV__DENOM__CANCEL2,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1z: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V0y)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1z)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V0y)),inj__ty_2Erealax_2Ereal(V1z))) )).
...
tff(conj_thm_2Eextreal_2Eext__mono__increasing__suc,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Elebesgue_2Elemma__fn__1,lemma,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2n: tp__ty_2Enum_2Enum,V3x: $i] :
             ...
             => ! [V4k: tp__ty_2Enum_2Enum] :
                 ...
                 => surj__ty_2Eextreal_2Eextreal(ap(ap(ap(ap(c_2Elebesgue_2Efn__seq(A_27a),V0m),V1f),inj__ty_2Enum_2Enum(V2n)),V3x)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__div,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(V4k))),ap(ap(c_2Eextreal_2Eextreal__pow,ap(c_2Eextreal_2Eextreal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V2n)))) ) ) ) ) )).

tff(conj_thm_2Elebesgue_2Elemma__fn__2,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2n: tp__ty_2Enum_2Enum,V3x: $i] :
             ...
             => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Em__space(A_27a),V0m)))
               ...
               => surj__ty_2Eextreal_2Eextreal(ap(ap(ap(ap(c_2Elebesgue_2Efn__seq(A_27a),V0m),V1f),inj__ty_2Enum_2Enum(V2n)),V3x)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__pow,ap(c_2Eextreal_2Eextreal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V2n))) ) ) ) ) )).

tff(conj_thm_2Elebesgue_2Elemma__fn__3,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Elemma__fn__4,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V2n: tp__ty_2Enum_2Enum,V3x: $i] :
              ( mem(V3x,A_27a)
             => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Em__space(A_27a),V0m)))
               => surj__ty_2Eextreal_2Eextreal(ap(ap(ap(ap(c_2Elebesgue_2Efn__seq(A_27a),V0m),V1f),inj__ty_2Enum_2Enum(V2n)),V3x)) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Elemma__fn__mono__increasing,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
