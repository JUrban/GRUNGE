...
fof(conj_thm_2Efinite__map_2EFUPD11__SAME__BASE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1k1] :
                 ...
                 => ! [V2v1] :
                     ...
                     => ! [V3k2] :
                         ...
                         => ! [V4v2] :
                              ( mem(V4v2,A_27b)
                             => ( ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k1),V2v1)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k2),V4v2))
                              <=> ( ( V1k1 = V3k2
                                    & V2v1 = V4v2 )
                                  | ( V1k1 != V3k2
                                    & p(ap(ap(c_2Ebool_2EIN(A_27a),V1k1),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)))
                                    & p(ap(ap(c_2Ebool_2EIN(A_27a),V3k2),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)))
                                    & ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k1),V2v1)) = V0f
                                    & ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k2),V4v2)) = V0f ) ) ) ) ) ) ) ) ) ) )).
