...
tff(conj_thm_2Ereal__topology_2ECOMPACT__INTER,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__INTER,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
