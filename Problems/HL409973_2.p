...
tff(conj_thm_2Eextreal_2Esup__le__mono,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1z: tp__ty_2Eextreal_2Eextreal] :
          ( ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0f,inj__ty_2Enum_2Enum(V2n))),ap(V0f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n)))))
            & p(ap(ap(c_2Eextreal_2Eextreal__lt,inj__ty_2Eextreal_2Eextreal(V1z)),ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) )
