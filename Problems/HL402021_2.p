...
tff(conj_thm_2Eset__relation_2Epartial__order__reln__to__rel__conv,lemma,(
    ! [A_27a: del,V0r: $i] :
...
tff(conj_thm_2Eset__relation_2Epartial__order__reln__to__rel__conv__UNIV,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
