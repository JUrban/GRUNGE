...
thf(conj_thm_2Ecombin_2EFAIL__THM,lemma,(
...
thf(conj_thm_2Erich__list_2ELASTN__DROP,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
          = ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1l ) ) ) ) )).

thf(conj_thm_2Erich__list_2ELASTN__compute,conjecture,(
    ! [A_27a: del,V0longer_20than_20list: $o,V1n: tp__ty_2Enum_2Enum,V2l: $i] :
      ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2l )
        = ( ap
          @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ( ty_2Elist_2Elist @ A_27a ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V3m: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V3m ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V3m ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V2l ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ecombin_2EFAIL @ ( arr @ ty_2Enum_2Enum @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ bool ) @ ( c_2Erich__list_2ELASTN @ A_27a ) ) @ ( inj__o @ V0longer_20than_20list ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2l ) ) ) )
          @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V2l ) ) ) ) )).
