...
tff(conj_thm_2Ereal_2EREAL__LE__LDIV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1y)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2z)),inj__ty_2Erealax_2Ereal(V0x)))) )
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1y)),inj__ty_2Erealax_2Ereal(V0x))),inj__ty_2Erealax_2Ereal(V2z))) ) )).
...
tff(conj_thm_2Elim_2ECONT__ATTAINS__ALL,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Eintegral_2EINTEGRAL__LE,lemma,(
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__CONTINUOUS,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ! [V3x: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eintegral_2EINTEGRAL__CONST,lemma,(
...
tff(conj_thm_2Eintegral_2EINTEGRAL__MVT1,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b)))
         ...
         => ? [V4x: tp__ty_2Erealax_2Ereal] :
              ...
              & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V1a)))) ) ) ) )).
