...
thf(ax_thm_2Ehreal_2Ehreal__sup,axiom,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Ehreal_2Ehreal @ bool ) )
     => ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Ehreal_2Ehreal__sup @ V0P ) )
            ...
            @ ( lam @ ty_2Ehrat_2Ehrat
              @ ^ [V1w: $i] :
                  ...
                  @ ( lam @ ty_2Ehreal_2Ehreal
                    @ ^ [V2X: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V2X ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ V2X ) @ V1w ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ehreal_2EHREAL__SUP__ISACUT,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Ehreal_2Ehreal @ bool ) )
...
thf(conj_thm_2Ehreal_2EHREAL__SUP,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Ehreal_2Ehreal @ bool ) )
     => ( ( ? [V1X: tp__ty_2Ehreal_2Ehreal] :
              ( p @ ( ap @ V0P @ ( inj__ty_2Ehreal_2Ehreal @ V1X ) ) )
