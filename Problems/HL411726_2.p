...
tff(conj_thm_2Ereal__topology_2EREAL__EQ__AFFINITY,conjecture,(
    ! [V0m: tp__ty_2Erealax_2Ereal,V1c: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
     ...
     => ( V3y = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0m)),inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V1c)))
      <=> surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0m))),inj__ty_2Erealax_2Ereal(V3y))),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V1c)),inj__ty_2Erealax_2Ereal(V0m))))) = V2x ) ) )).
