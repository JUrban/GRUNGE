...
tff(conj_thm_2Ereal__topology_2ECOMPACT__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2Eclosure,V0s)))
      <=> p(ap(c_2Ereal__topology_2Ebounded__def,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__IMP__CONTINUOUS,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__EXTENDS__TO__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                ...
                & ! [V4h: $i] :
                   ...
                   => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V4h),ap(c_2Ereal__topology_2Eclosure,V1s)))
                        & ! [V5x: tp__ty_2Erealax_2Ereal] :
                           ...
                           => surj__ty_2Erealax_2Ereal(ap(V4h,inj__ty_2Erealax_2Ereal(V5x))) = surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V5x))) ) )
                     => ! [V6x: tp__ty_2Erealax_2Ereal] :
                         ...
                         => surj__ty_2Erealax_2Ereal(ap(V4h,inj__ty_2Erealax_2Ereal(V6x))) = surj__ty_2Erealax_2Ereal(ap(V2g,inj__ty_2Erealax_2Ereal(V6x))) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__UNIFORMLY__CONTINUOUS__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V1s))
           ...
           => p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s))) ) ) ) )).
