...
fof(thm_2Eordinal_2Epredimage__sup__thm,axiom,(
    ! [A_27a,V0f_2E0,V1a_2E0,V2b_2E0] :
    ...
    <=> ? [V3d_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V3d_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V1a_2E0))))
          & p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V2b_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a)),V0f_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V3d_2E0)))))) ) ) )).
...
fof(thm_2Eordinal_2Esup__preds__omax__NONE,axiom,(
    ! [A_27a,V0a_2E0] :
...
fof(thm_2Eordinal_2Elt__suppreds,axiom,(
    ! [A_27a,V0a_2E0,V1b_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V1b_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Esup_2E1(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Eordinal_2Epreds_2E1(s(tyop_2Eordinal_2Eordinal(A_27a),V0a_2E0))))))))
    <=> ? [V2d_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V2d_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V0a_2E0))))
          & p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V1b_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V2d_2E0)))) ) ) )).
...
fof(thm_2Eordinal_2EordADD__MONO,conjecture,(
