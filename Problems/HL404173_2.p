...
tff(conj_thm_2Epath_2Etail__drop,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0i)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
       => ap(c_2Epath_2Etail(A_27a,A_27a),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),V1p)) = ap(ap(c_2Epath_2Edrop(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0i)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V1p) ) ) )).
