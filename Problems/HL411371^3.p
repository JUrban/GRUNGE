    ...
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2y: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2y
            @ ( c_2Ebool_2E_3F @ ( tyop_2Erealax_2Ereal > $o )
              @ ^ [V3t: tyop_2Erealax_2Ereal > $o] :
                  ( c_2Ebool_2E_2F_5C @ ( c_2Ereal__topology_2Econnected @ V3t ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V3t @ V0s ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V3t ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V3t ) ) ) ) ) ) ) ) )).
      ...
      = ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal
        @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o )
          @ ^ [V2t: tyop_2Erealax_2Ereal > $o] :
              ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ $o @ V2t @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal__topology_2Econnected @ V2t ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V2t ) @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2t @ V0s ) ) ) ) ) ) ) )).
