...
thf(conj_thm_2Ereal__topology_2EINTERIOR__UNIV,lemma,
    ( ( ap @ c_2Ereal__topology_2Einterior @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__FINITE__BIGINTER,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) )
       => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V0s ) )
          = ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ c_2Ereal__topology_2Einterior ) @ V0s ) ) ) ) ) )).
