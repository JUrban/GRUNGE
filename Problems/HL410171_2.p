...
tff(ax_thm_2Emeasure_2Eclosed__cdi__def,axiom,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Emeasure_2ESPACE__SMALLEST__CLOSED__CDI,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ap(c_2Emeasure_2Espace(A_27a),ap(c_2Emeasure_2Esmallest__closed__cdi(A_27a),V0a)) = ap(c_2Emeasure_2Espace(A_27a),V0a) ) )).

tff(conj_thm_2Emeasure_2ESMALLEST__CLOSED__CDI,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
...
tff(conj_thm_2Emeasure_2ECLOSED__CDI__DUNION,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),c_2Epred__set_2EEMPTY(A_27a)),ap(c_2Emeasure_2Esubsets(A_27a),V0p)))
                  & p(ap(c_2Emeasure_2Eclosed__cdi(A_27a),V0p))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Esubsets(A_27a),V0p)))
                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2t),ap(c_2Emeasure_2Esubsets(A_27a),V0p)))
                  & p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),V1s),V2t)) )
               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),V2t)),ap(c_2Emeasure_2Esubsets(A_27a),V0p))) ) ) ) ) )).

tff(conj_thm_2Emeasure_2ECLOSED__CDI__COMPL,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Emeasure_2ECLOSED__CDI__DISJOINT,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ( ( p(ap(c_2Emeasure_2Eclosed__cdi(A_27a),V0p))
              & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V1f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Emeasure_2Esubsets(A_27a),V0p))))
           ...
           => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),ap(c_2Emeasure_2Esubsets(A_27a),V0p))) ) ) ) )).

tff(conj_thm_2Emeasure_2ECLOSED__CDI__INCREASING,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ( ( p(ap(c_2Emeasure_2Eclosed__cdi(A_27a),V0p))
              & p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V1f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Emeasure_2Esubsets(A_27a),V0p))))
              & ap(V1f,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) = c_2Epred__set_2EEMPTY(A_27a)
              & ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(V1f,inj__ty_2Enum_2Enum(V2n))),ap(V1f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n))))) )
           => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),ap(c_2Emeasure_2Esubsets(A_27a),V0p))) ) ) ) )).

tff(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA1,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Ealgebra(A_27a),V0a))
       => ! [V1s: $i] :
