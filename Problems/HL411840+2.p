...
fof(conj_thm_2Ereal__topology_2EREAL__LE__SETDIST,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
                  ...
                  & ! [V3x] :
                     ...
                     => ! [V4y] :
                         ...
                         => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V0s))
                           ...
                           => p(ap(ap(c_2Ereal_2Ereal__lte,V2d),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),V4y)))) ) ) ) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,V2d),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)))) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESETDIST__TRIANGLE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
         ...
         => ! [V2t] :
             ...
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V2t))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))))),ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V2t))))) ) ) ) )).
