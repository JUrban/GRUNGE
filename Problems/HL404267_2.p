...
tff(conj_thm_2EDecode_2Edec2enc__decode__prod,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,arr(A_27a,bool))
     => ! [V1p2: $i] :
          ( mem(V1p2,arr(A_27b,bool))
             ...
             => ! [V3d2: $i] :
                 ...
                 => ! [V4x: $i] :
                     ...
                     => ( ( p(ap(ap(c_2EDecode_2Ewf__decoder(A_27a),V0p1),V2d1))
                       ...
                       => surj__c_ty_2Elist_2Elist_o(ap(ap(c_2EDecode_2Edec2enc(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(ap(c_2EDecode_2Edecode__prod(A_27a,A_27a),ap(ap(c_2EEncode_2Elift__prod(A_27a,A_27a),V0p1),V1p2)),V2d1),V3d2)),V4x)) = surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2EEncode_2Eencode__prod(A_27a,A_27a),ap(c_2EDecode_2Edec2enc(A_27a),V2d1)),ap(c_2EDecode_2Edec2enc(A_27b),V3d2)),V4x)) ) ) ) ) ) ) )).
