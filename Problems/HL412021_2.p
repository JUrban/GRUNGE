...
tff(conj_thm_2Emeasure_2EFN__PLUS__POS__ID,lemma,(
    ! [A_27a: del,V0g: $i] :
...
tff(conj_thm_2Emeasure_2EFN__MINUS__POS__ZERO,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ( ! [V1x: $i] :
            ( mem(V1x,A_27a)
           => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V0g,V1x))) )
       => ap(c_2Emeasure_2Efn__minus(A_27a),V0g) = k(A_27a,ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).
...
tff(conj_thm_2Elebesgue_2Eintegral__pos__fn,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
