...
thf(thm_2Ereal__topology_2ESETDIST__LINEAR__IMAGE,axiom,(
...
thf(thm_2Ereal__topology_2EHAUSDIST__LINEAR__IMAGE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ereal_2Eabs @ ( V0f @ V3x ) )
            = ( c_2Ereal_2Eabs @ V3x ) ) )
     => ( ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2t ) ) )
        = ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ V2t ) ) ) ) )).
