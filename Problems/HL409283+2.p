...
fof(mem_c_2Ebinary__ieee_2Efloat__less__equal,axiom,(
    ! [A_27t] :
     ...
     => ! [A_27w] :
          ( ne(A_27w)
         => mem(c_2Ebinary__ieee_2Efloat__less__equal(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),arr(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t),bool))) ) ) )).
         ...
         => ! [V0x] :
             ...
             => ! [V1y] :
                 ...
                 => ( p(ap(ap(c_2Ebinary__ieee_2Efloat__less__equal(A_27t,A_27t),V0x),V1y))
                  <=> p(ap(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__compare__CASE(bool),ap(ap(c_2Ebinary__ieee_2Efloat__compare(A_27t,A_27t),V0x),V1y)),c_2Ebool_2ET),c_2Ebool_2ET),c_2Ebool_2EF),c_2Ebool_2EF)) ) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Efloat__le,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
