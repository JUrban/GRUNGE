...
tff(tp_c_2Erelation_2ERRESTRICT,type,(
    c_2Erelation_2ERRESTRICT: ( del * del ) > $i )).

tff(mem_c_2Erelation_2ERRESTRICT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erelation_2ERRESTRICT(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,bool)),arr(arr(A_27a,bool),arr(A_27a,arr(A_27b,bool))))) )).
...
tff(ax_thm_2Erelation_2ERRESTRICT__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ( p(ap(ap(ap(ap(c_2Erelation_2ERRESTRICT(A_27a,A_27a),V0R),V1s),V2x),V3y))
                  <=> ( p(ap(ap(V0R,V2x),V3y))
                      & p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)) ) ) ) ) ) ) )).

tff(conj_thm_2Erelation_2EIN__RDOM__RRESTRICT,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1R: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Erelation_2ERDOM(A_27a,A_27a),ap(ap(c_2Erelation_2ERRESTRICT(A_27a,A_27a),V1R),V2s))))
