...
fof(conj_thm_2EerrorStateMonad_2EMMAP__COMP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [A_27d] :
                 ...
                 => ! [V0f] :
                     ...
                     => ! [V1g] :
                          ( mem(V1g,arr(A_27c,A_27a))
                         => ap(c_2EerrorStateMonad_2EMMAP(A_27d,A_27d,A_27d),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0f),V1g)) = ap(ap(c_2Ecombin_2Eo(arr(A_27d,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27c,A_27c))),arr(A_27d,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27c,A_27c))),arr(A_27d,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27c,A_27c)))),ap(c_2EerrorStateMonad_2EMMAP(A_27d,A_27d,A_27d),V0f)),ap(c_2EerrorStateMonad_2EMMAP(A_27d,A_27d,A_27d),V1g)) ) ) ) ) ) ) )).
