      ...
      = ( ap @ ( c_2Ewords_2Eword__reduce @ A_27a )
        @ ( lam @ bool
          @ ^ [V0a: $i] :
              ( lam @ bool
              @ ^ [V1b: $i] :
                  ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ V0a ) @ V1b ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Efoldl__reduce__nor,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
          ...
          @ ( ap
            @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
              @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
                @ ^ [V1l: $i] :
                    ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( c_2Ewords_2Eword__nor @ ty_2Eone_2Eone ) ) @ ( ap @ ( c_2Elist_2EHD @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ V1l ) ) @ ( ap @ ( c_2Elist_2ETL @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ V1l ) ) ) )
            @ ( ap
