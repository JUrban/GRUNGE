    ...
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( (~)
        ...
        & ? [V1b: tyop_2Erealax_2Ereal] :
          ! [V2x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ V1b @ V2x ) ) )
     => ( ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2Einf @ V0s ) @ V3x ) )
        & ! [V4b: tyop_2Erealax_2Ereal] :
            ( ! [V5x: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x @ V0s )
               => ( c_2Ereal_2Ereal__lte @ V4b @ V5x ) )
           => ( c_2Ereal_2Ereal__lte @ V4b @ ( c_2Eiterate_2Einf @ V0s ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EIS__INTERVAL__CASES,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Eis__interval @ V0s )
    <=> ( ( V0s
          = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
        ...
        | ? [V1a: tyop_2Erealax_2Ereal] :
            ...
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V2x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Erealax_2Ereal__lt @ V1a @ V2x ) ) ) )
        | ? [V3a: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V4x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V4x @ ( c_2Ereal_2Ereal__lte @ V3a @ V4x ) ) ) )
        | ? [V5b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V6x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V6x @ ( c_2Ereal_2Ereal__lte @ V6x @ V5b ) ) ) )
        | ? [V7b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V8x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V8x @ ( c_2Erealax_2Ereal__lt @ V8x @ V7b ) ) ) )
        | ? [V9a: tyop_2Erealax_2Ereal,V10b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V11x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V11x @ ( c_2Ebool_2E_2F_5C @ ( c_2Erealax_2Ereal__lt @ V9a @ V11x ) @ ( c_2Erealax_2Ereal__lt @ V11x @ V10b ) ) ) ) )
        | ? [V12a: tyop_2Erealax_2Ereal,V13b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V14x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V14x @ ( c_2Ebool_2E_2F_5C @ ( c_2Erealax_2Ereal__lt @ V12a @ V14x ) @ ( c_2Ereal_2Ereal__lte @ V14x @ V13b ) ) ) ) )
        | ? [V15a: tyop_2Erealax_2Ereal,V16b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V17x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V17x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal_2Ereal__lte @ V15a @ V17x ) @ ( c_2Erealax_2Ereal__lt @ V17x @ V16b ) ) ) ) )
        | ? [V18a: tyop_2Erealax_2Ereal,V19b: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
              @ ^ [V20x: tyop_2Erealax_2Ereal] :
                  ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V20x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal_2Ereal__lte @ V18a @ V20x ) @ ( c_2Ereal_2Ereal__lte @ V20x @ V19b ) ) ) ) ) ) ) )).
