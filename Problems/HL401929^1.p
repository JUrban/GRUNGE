...
thf(f2571_0_2E0,type,(
    f2571_0_2E0: u )).

thf(f2571_0_2E1,type,(
    f2571_0_2E1: du > u )).

thf(f2571_0_2E2,type,(
    f2571_0_2E2: du > du > u )).
...
thf(c_2Ebit_2ELOWEST__SET__BIT_2E0,type,(
    c_2Ebit_2ELOWEST__SET__BIT_2E0: u )).

thf(c_2Ebit_2ELOWEST__SET__BIT_2E1,type,(
...
thf(mono_2Ef2571_0,type,(
    mono_2Ef2571_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(mono_2Ec_2Ebit_2ELOWEST__SET__BIT,type,(
    mono_2Ec_2Ebit_2ELOWEST__SET__BIT: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(def0_2Ethm_2Ebit_2ELOWEST__SET__BIT__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2571_0 @ V0n @ V1i )
      = ( mono_2Ec_2Ebit_2EBIT @ V1i @ V0n ) ) )).

thf(thm_2Ebit_2ELOWEST__SET__BIT__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ebit_2ELOWEST__SET__BIT @ V0n )
      = ( mono_2Ec_2Ewhile_2ELEAST @ ( mono_2Ef2571_0 @ V0n ) ) ) )).
...
thf(thm_2Enumeral__bit_2ELOWEST__SET__BIT,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( (~) @ ( V0n = mono_2Ec_2Enum_2E0 ) )
     => ( ( mono_2Ec_2Ebit_2ELOWEST__SET__BIT @ V0n )
        = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2EODD @ V0n ) @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( mono_2Ec_2Ebit_2ELOWEST__SET__BIT @ ( mono_2Ec_2Earithmetic_2EDIV2 @ V0n ) ) ) ) ) ) )).
