...
thf(thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,axiom,(
...
thf(thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT,conjecture,(
                ...
                & ! [V4y: mono_2Etyop_2Erealax_2Ereal] :
                    ( ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V4y @ V1s )
                      & ( (~)
                        @ ( ( V0f @ V4y )
                          = ( V0f @ V2x ) ) ) )
                   => ( mono_2Ec_2Ereal_2Ereal__lte @ V3e @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ V4y ) @ ( V0f @ V2x ) ) ) ) ) ) ) )
     => ? [V5a: mono_2Etyop_2Erealax_2Ereal] :
        ! [V6x: mono_2Etyop_2Erealax_2Ereal] :
