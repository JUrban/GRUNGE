...
fof(conj_thm_2Erich__list_2ESEG__LENGTH__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ! [V1x] :
              ( mem(V1x,A_27a)
             => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2Elist_2ELENGTH(A_27a),V0l)),ap(ap(c_2Elist_2ESNOC(A_27a),V1x),V0l)) = ap(ap(c_2Elist_2ECONS(A_27a),V1x),c_2Elist_2ENIL(A_27a)) ) ) ) )).

fof(conj_thm_2Erich__list_2ESEG__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ! [V3x] :
                        ( mem(V3x,A_27a)
                       => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1m),ap(ap(c_2Elist_2ESNOC(A_27a),V3x),V2l)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1m),V2l) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EELL__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2EELL(A_27a),V0n),V1l) = ap(c_2Elist_2EHD(A_27a),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2Eprim__rec_2EPRE,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n))),V1l)) ) ) ) ) )).
