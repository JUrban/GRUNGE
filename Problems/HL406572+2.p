...
fof(conj_thm_2Esptree_2Edomain__delete,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0k] :
         ...
         => ! [V1t] :
             ...
             => ap(c_2Esptree_2Edomain(A_27a),ap(ap(c_2Esptree_2Edelete(A_27a),V0k),V1t)) = ap(ap(c_2Epred__set_2EDELETE(ty_2Enum_2Enum),ap(c_2Esptree_2Edomain(A_27a),V1t)),V0k) ) ) ) )).
