...
thf(thm_2Ecardinal_2Ecardeq__def,axiom,(
    ! [A_27a: d,A_27b: d,V0s1_2E0: u,V1s2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ecardinal_2Ecardeq_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1s2_2E0 ) ) ) )
    <=> ? [V2f_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EBIJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1s2_2E0 ) ) ) ) ) )).
...
thf(thm_2Eone_2EFORALL__ONE,axiom,(
    ! [V0P: mono_2Etyop_2Eone_2Eone > $o] :
      ( ! [V1x: mono_2Etyop_2Eone_2Eone] :
          ( V0P @ V1x )
    <=> ( V0P @ mono_2Ec_2Eone_2Eone ) ) )).
...
thf(thm_2Esum_2EFORALL__SUM,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u] :
      ( ! [V1s_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V1s_2E0 ) ) ) )
    <=> ( ! [V2x_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) ) ) )
        & ! [V3y_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V3y_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Esum_2Esum__distinct,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1y_2E0: u] :
      ( (~)
      @ ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V1y_2E0 ) ) ) ) ) )).
...
thf(thm_2Eordinal_2Eunitinf__univnum,conjecture,(
