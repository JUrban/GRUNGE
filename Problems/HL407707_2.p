...
tff(conj_thm_2Eordinal_2EfromNat__eq__omega,lemma,(
...
tff(conj_thm_2Eordinal_2EordEXP__EQ__0,lemma,(
    ! [A_27a: del,V0y: $i] :
...
tff(conj_thm_2EordNotationSemantics_2Ekexp__lt,conjecture,(
    ! [A_27a: del,V0e1: $i] :
