...
fof(ax_thm_2EEncode_2Eencode__bool__def,axiom,(
    ! [V0x] :
      ( mem(V0x,bool)
     => ap(c_2EEncode_2Eencode__bool,V0x) = ap(ap(c_2Elist_2ECONS(bool),V0x),c_2Elist_2ENIL(bool)) ) )).
...
fof(conj_thm_2EEncodeVar_2Efixed__width__bool,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(bool,bool))
