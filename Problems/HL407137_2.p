...
tff(conj_thm_2Ebasis__emit_2EfromNum__ind,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))
     => ( ! [V1n: tp__ty_2Enum_2Enum] : p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),c_2Ebool_2Ethe__value(A_27a))))
       => ! [V2v: tp__ty_2Enum_2Enum,V3v1: $i] :
            ( mem(V3v1,ty_2Ebool_2Eitself(A_27a))
           => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2v)),V3v1))) ) ) ) )).
