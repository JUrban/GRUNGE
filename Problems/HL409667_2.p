...
tff(conj_thm_2Eiterate_2ESUPPORT__SUBSET,lemma,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(ap(c_2Eiterate_2Esupport(A_27b,A_27b),V0op),V1f),V2s)),V2s)) ) ) ) )).

tff(conj_thm_2Eiterate_2EFINITE__SUPPORT,conjecture,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,A_27a))
