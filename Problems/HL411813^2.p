...
thf(conj_thm_2Ereal__topology_2EPERMUTES__IMAGE,lemma,(
    ! [A_27a: del,V0p: $i] :
...
thf(conj_thm_2Ereal__topology_2EPERMUTES__INJECTIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ A_27a ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE,lemma,(
    ! [V0x: $i] :
                  ...
                  ( ( ( p
                    ...
                    & ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                        ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V5m ) ) @ V1s ) )
                          ...
                          & ( ( surj__ty_2Enum_2Enum @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V5m ) ) )
                            = ( surj__ty_2Enum_2Enum @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) )
                       => ( V5m = V6n ) ) )
                 => ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) @ V0x ) @ V2f ) ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ V1s ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__REARRANGE__EQ,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2p: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p
                      @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V1s )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V4n: $i] :
                              ( ap @ c_2Ereal_2Eabs @ ( ap @ V0x @ V4n ) ) ) ) )
                    & ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Epermutes @ ty_2Enum_2Enum ) @ V2p ) @ V1s ) ) )
                 => ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) @ V0x ) @ V2p ) ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ V1s ) )
