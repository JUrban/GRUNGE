...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__PRODUCT,lemma,(
...
tff(lameq_f3950,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V3i: $i] :
          ( mem(V3i,A_27a)
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3950(A_27a,V0f,V3i),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(V0f,inj__ty_2Erealax_2Ereal(V4x)),V3i) ) ) )).

tff(lmtp_f3951,type,(
    f3951: ( del * $i * $i ) > $i )).

tff(lamtp_f3951,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V2t: $i] :
...
tff(lameq_f3951,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V2t: $i] :
          ( mem(V2t,arr(A_27a,bool))
         => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3951(A_27a,V0f,V2t),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Eproduct_2Eproduct(A_27a),V2t),ap(V0f,inj__ty_2Erealax_2Ereal(V5x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__PRODUCT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
