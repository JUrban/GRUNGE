...
tff(conj_thm_2Elift__ieee_2Efloat__div,lemma,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
              ...
              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2E_2F,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)))),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) )
           => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),V0a),V1b))))
              & surj__ty_2Erealax_2Ereal(ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),V0a),V1b)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2E_2F,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b))),ap(ap(c_2Elift__ieee_2Eerror(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),ap(ap(c_2Ereal_2E_2F,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b))))) ) ) ) ) )).

tff(conj_thm_2Elift__ieee_2Efloat__div__finite,conjecture,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
      ( mem(V0a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
