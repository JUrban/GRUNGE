...
thf(thm_2Enumpair_2Einvtri__lower,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Enumpair_2Etri @ ( c_2Enumpair_2Einvtri @ V0n ) ) @ V0n ) )).

thf(thm_2Enumpair_2Einvtri__upper,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ V0n @ ( c_2Enumpair_2Etri @ ( c_2Earithmetic_2E_2B @ ( c_2Enumpair_2Einvtri @ V0n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
...
thf(thm_2Enumpair_2Einvtri__linverse,conjecture,(
    ! [V0n: tyop_2Enum_2Enum] :
