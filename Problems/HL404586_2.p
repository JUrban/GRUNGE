...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE__SUBSET,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0s))
       => ? [V1f: $i] :
            ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
            & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V0s),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) ) )).
