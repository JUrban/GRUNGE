...
fof(conj_thm_2Ebit_2EBIT__DIV2,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1i] :
...
fof(conj_thm_2Erich__list_2EAPPEND__SNOC1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
...
fof(lamtp_f2241,axiom,(
    ! [V1f] :
      ( mem(V1f,arr(bool,arr(bool,bool)))
     => mem(f2241(V1f),arr(ty_2Elist_2Elist(bool),bool)) ) )).
...
fof(lameq_f2241,axiom,(
    ! [V1f] :
     ...
     => ! [V2l] :
          ( mem(V2l,ty_2Elist_2Elist(bool))
         => ap(f2241(V1f),V2l) = ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),V1f),ap(c_2Elist_2EHD(bool),V2l)),ap(c_2Elist_2ETL(bool),V2l)) ) ) )).

fof(conj_thm_2Ewords_2Eword__reduce__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1f] :
              ( mem(V1f,arr(bool,arr(bool,bool)))
             => ap(ap(c_2Ewords_2Eword__reduce(A_27a),V1f),ap(c_2Ewords_2En2w(A_27a),V0n)) = ap(c_2Efcp_2EFCP(bool,bool),ap(c_2Ecombin_2EK(bool,bool),ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2241(V1f)),ap(ap(ap(c_2Enumposrep_2EBOOLIFY,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V0n),c_2Elist_2ENIL(bool))))) ) ) ) )).
