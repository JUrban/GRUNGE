...
thf(conj_thm_2Ewellorder_2EWF__IND,lemma,(
...
thf(conj_thm_2Ewellorder_2EWF__UREC__WF,conjecture,(
    ! [A_27a: del,V0_3C_3C: $i] :
      ( ( mem @ V0_3C_3C @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ! [V1H: $i] :
            ( ( mem @ V1H @ ( arr @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) )
           => ( ! [V2f: $i] :
