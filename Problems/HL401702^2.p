          ...
          @ ( lam @ A_27a
            @ ^ [V1x: $i] :
                ...
                @ ( ap @ ( c_2Ebool_2E_3F @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V2s: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2s ) @ V0P ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V1x ) @ V2s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EDIFF__BIGINTER1,conjecture,(
    ! [A_27a: del,V0sp: $i] :
            ...
            = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
              @ ( ap
                @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V2u: $i] :
                        ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V0sp ) @ V2u ) ) )
                @ V1s ) ) ) ) ) )).
