...
fof(lamtp_f3736,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l] :
          ( mem(V2l,ty_2Erealax_2Ereal)
         => mem(f3736(A_27a,V1f,V2l),arr(A_27a,bool)) ) ) )).

fof(lameq_f3736,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l] :
          ( mem(V2l,ty_2Erealax_2Ereal)
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3736(A_27a,V1f,V2l),V3x) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V3x)),V2l) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__EVENTUALLY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
