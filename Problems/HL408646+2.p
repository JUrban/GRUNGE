...
fof(conj_thm_2EHolSmt_2Er025,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,bool)
         => ! [V1x] :
             ...
             => ! [V2q] :
                 ...
                 => ! [V3y] :
                      ( mem(V3y,A_27a)
                     => ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),V1x),ap(ap(ap(c_2Ebool_2ECOND(A_27a),V2q),V1x),V3y)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Ebool_2E_5C_2F,V2q),V0p)),V1x),V3y) ) ) ) ) ) )).
