...
tff(tp_c_2Eieee_2Eccode__CASE,type,(
    c_2Eieee_2Eccode__CASE: del > $i )).

tff(mem_c_2Eieee_2Eccode__CASE,axiom,(
...
tff(ax_thm_2Eieee_2Eccode__CASE,axiom,(
    ! [A_27a: del,V0x: tp__ty_2Eieee_2Eccode,V1v0: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V3v2: $i] :
             ...
             => ! [V4v3: $i] :
                  ( mem(V4v3,A_27a)
                 => ap(ap(ap(ap(ap(c_2Eieee_2Eccode__CASE(A_27a),inj__ty_2Eieee_2Eccode(V0x)),V1v0),V2v1),V3v2),V4v3) = ap(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(V0x))) ) ) ) ) )).

tff(conj_thm_2Eieee_2Eccode__case__def,conjecture,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( mem(V0v0,A_27a)
         => ! [V1v1: $i] :
             ...
             => ! [V2v2: $i] :
                 ...
                 => ! [V3v3: $i] :
                      ( mem(V3v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eccode__CASE(A_27a),inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EGt)),V0v0),V1v1),V2v2),V3v3) = V0v0 ) ) ) )
      & ! [V4v0: $i] :
          ( mem(V4v0,A_27a)
         => ! [V5v1: $i] :
              ( mem(V5v1,A_27a)
             => ! [V6v2: $i] :
                 ...
                 => ! [V7v3: $i] :
                      ( mem(V7v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eccode__CASE(A_27a),inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2ELt)),V4v0),V5v1),V6v2),V7v3) = V5v1 ) ) ) )
      & ! [V8v0: $i] :
          ( mem(V8v0,A_27a)
         => ! [V9v1: $i] :
              ( mem(V9v1,A_27a)
             => ! [V10v2: $i] :
                 ...
                 => ! [V11v3: $i] :
                      ( mem(V11v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eccode__CASE(A_27a),inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EEq)),V8v0),V9v1),V10v2),V11v3) = V10v2 ) ) ) )
      & ! [V12v0: $i] :
          ( mem(V12v0,A_27a)
         => ! [V13v1: $i] :
              ( mem(V13v1,A_27a)
             => ! [V14v2: $i] :
                 ...
                 => ! [V15v3: $i] :
                      ( mem(V15v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eccode__CASE(A_27a),inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EUn)),V12v0),V13v1),V14v2),V15v3) = V15v3 ) ) ) ) ) )).
