...
tff(conj_thm_2Eprobability_2EEVENTS__ALGEBRA,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Eprobability_2EPROB__SPACE__POSITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
...
tff(conj_thm_2Eprobability_2EPROB__SPACE__ADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
