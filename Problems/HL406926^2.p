...
thf(conj_thm_2Efmapal_2Elist__rplacv__cn__ind,conjecture,(
                                     ...
                                     => ( p
                                        @ ( ap @ ( ap @ ( ap @ V0P @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V4x ) @ V5y ) ) @ V8l )
                                          @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                                            @ ^ [V10m: $i] :
                                                ( ap @ V9cn @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V6w ) @ V7z ) ) @ V10m ) ) ) ) ) )
