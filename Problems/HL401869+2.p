...
fof(conj_thm_2Epred__set_2EPREIMAGE__UNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2t] :
                     ...
                     => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EUNION(A_27b),V1s),V2t)) = ap(ap(c_2Epred__set_2EUNION(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V2t)) ) ) ) ) ) )).
