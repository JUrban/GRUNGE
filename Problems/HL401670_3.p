...
tff(thm_2Epred__set_2EFINITE__WEAK__ENUMERATE,conjecture,(
    ! [A_27a: $tType,V0s_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] :
      ( p(c_2Epred__set_2EFINITE_2E1(A_27a,V0s_2E0))
    <=> ? [V1f_2E0: tyop_2Emin_2Efun(tyop_2Enum_2Enum,A_27a),V2b_2E0: tyop_2Enum_2Enum] :
        ! [V3e_2E0: A_27a] :
          ( p(c_2Ebool_2EIN_2E2(A_27a,V3e_2E0,V0s_2E0))
        <=> ? [V4n_2E0: tyop_2Enum_2Enum] :
              ( p(c_2Eprim__rec_2E_3C_2E2(V4n_2E0,V2b_2E0))
              & V3e_2E0 = app_2E2(tyop_2Enum_2Enum,A_27a,V1f_2E0,V4n_2E0) ) ) ) )).
