          ...
          @ ( lam @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) )
            @ ^ [V0R: $i] :
                ...
                @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V1n: $i] :
                        ( ap @ ( ap @ V0R @ ( ap @ c_2Enum_2ESUC @ V1n ) ) @ ( ap @ c_2Enum_2ESUC @ ( ap @ c_2Enum_2ESUC @ V1n ) ) ) ) ) ) ) ) )
            ...
            @ ^ [V3a: $i] :
                ...
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4v: $i] :
                      ...
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V5n: $i] :
                            ( ap @ ( c_2Ecombin_2EI @ ty_2Erat_2Erat ) @ ( ap @ ( ap @ c_2Erat_2Erat__add @ ( ap @ V2rat__of__num @ ( ap @ c_2Enum_2ESUC @ V5n ) ) ) @ ( inj__ty_2Erat_2Erat @ fo__c_2Erat_2Erat__1 ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Erat_2Erat__1,conjecture,
