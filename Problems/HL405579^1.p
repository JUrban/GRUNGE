...
thf(f6522_0_2E0,type,(
    f6522_0_2E0: u )).

thf(f6522_0_2E1,type,(
    f6522_0_2E1: du > u )).

thf(f6522_0_2E2,type,(
    f6522_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef6522_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f6522_0_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f6522_0_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef6522_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6522_0_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f6522_0_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eordinal_2EordSUC__def,axiom,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6522_0_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1b_2E0 ) ) ) )
...
thf(thm_2Eordinal_2EordSUC__def,axiom,(
    ! [A_27a: d,V0a_2E0: u] :
      ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) )
      = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2Eoleast_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f6522_0_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordSUC__ZERO,conjecture,(
    ! [A_27a: d,V0a_2E0: u] :
      ( (~)
      @ ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) )
