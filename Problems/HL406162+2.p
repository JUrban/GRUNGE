...
fof(conj_thm_2Ebit_2ESLICE__ZERO__THM,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1h] :
...
fof(conj_thm_2Ebit_2ESLICE__COMP__THM,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__SLICE__THM,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Esum__num_2EGSUM__FUN__EQUAL,lemma,(
    ! [V0p] :
...
fof(mem_c_2Ewords_2Esaturate__add,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Esaturate__add(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(lameq_f2162,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2162(A_27a,V0w),V1i) = ap(ap(c_2Ebit_2ESBIT,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),V1i)),V1i) ) ) )).
...
fof(ax_thm_2Ewords_2Ew2n__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ew2n(A_27a),V0w) = ap(ap(c_2Esum__num_2ESUM,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),f2162(A_27a,V0w)) ) ) )).
...
fof(conj_thm_2Ewords_2EWORD__LS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2Esaturate__add,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
