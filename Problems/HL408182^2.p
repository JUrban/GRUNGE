...
thf(conj_thm_2Epoly_2EPOLY__ZERO,lemma,(
        ...
        @ ( ap
          @ ( ap @ ( c_2Elist_2EEVERY @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V1c: $i] :
                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V1c ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
          @ ( inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal @ V0p ) ) ) ) )).

thf(conj_thm_2Epoly_2EPOLY__DIFF__AUX__ISZERO,lemma,(
      ...
      ( ( p
        @ ( ap
          @ ( ap @ ( c_2Elist_2EEVERY @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2c: $i] :
                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V2c ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
    ...
    <=> ( p
        @ ( ap
          @ ( ap @ ( c_2Elist_2EEVERY @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V3c: $i] :
                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V3c ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
          @ ( inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal @ V0p ) ) ) ) )).
...
thf(conj_thm_2Epoly_2EPOLY__DIFF__ISZERO,conjecture,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal] :
