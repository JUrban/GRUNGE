...
thf(conj_thm_2Ealignment_2Ealigned__0,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0p: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0p ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
      & ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) )
         => ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27b ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V1w ) ) ) ) )).

thf(conj_thm_2Ealignment_2Ealigned__add__sub__prod,lemma,(
...
thf(conj_thm_2Ewords_2Eword__1__lsl,lemma,(
...
thf(conj_thm_2Ealignment_2Ealigned__add__sub__123,conjecture,(
    ! [A_27a: del] :
      ( ! [V0w: $i] :
          ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ! [V1x: $i] :
