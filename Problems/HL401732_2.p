...
tff(conj_thm_2Epred__set_2EABSORPTION,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
...
tff(conj_thm_2Epred__set_2EINSERT__COMM,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Epred__set_2ENOT__EMPTY__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EDELETE__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Epred__set_2EINSERT__DELETE,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ECHOICE__INSERT__REST,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EITSET__INSERT,lemma,(
     ...
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1f: $i] :
           ...
           => ! [V2x: $i] :
               ...
               => ! [V3b: $i] :
                    ( mem(V3b,A_27b)
                   => ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V1f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),V0s)),V3b) = ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V1f),ap(c_2Epred__set_2EREST(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),V0s))),ap(ap(V1f,ap(c_2Epred__set_2ECHOICE(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),V0s))),V3b)) ) ) ) ) ) )).

tff(conj_thm_2Epred__set_2ECOMMUTING__ITSET__INSERT,conjecture,(
     ...
     => ! [V1s: $i] :
         ...
         => ( ( ! [V2x: $i] :
           ...
           => ! [V5x: $i] :
               ...
               => ! [V6b: $i] :
                    ( mem(V6b,A_27b)
                   => ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V5x),V1s)),V6b) = ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V1s),V5x)),ap(ap(V0f,V5x),V6b)) ) ) ) ) ) )).
