...
tff(conj_thm_2Equotient__pred__set_2EDIFF__RSP,conjecture,(
                       ...
                       => ! [V5t1: $i] :
                           ...
                           => ! [V6t2: $i] :
                               ...
                               => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),V3s1),V4s2))
                                 ...
                                 => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),ap(ap(c_2Epred__set_2EDIFF(A_27a),V3s1),V5t1)),ap(ap(c_2Epred__set_2EDIFF(A_27a),V4s2),V6t2))) ) ) ) ) ) ) ) ) ) )).
