...
fof(thm_2EpatternMatches_2EPMATCH__ROW__COND__EX__FULL__DEF,conjecture,(
    ! [A_27a,A_27b,V0p_2E0,V1i_2E0,V2g_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__COND__EX_2E3(s(A_27a,V1i_2E0),s(tyop_2Emin_2Efun(A_27b,A_27a),V0p_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2g_2E0))))
    <=> ? [V3x_2E0] :
          ( s(A_27a,V1i_2E0) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V0p_2E0),s(A_27b,V3x_2E0)))
          & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2g_2E0),s(A_27b,V3x_2E0)))) ) ) )).
