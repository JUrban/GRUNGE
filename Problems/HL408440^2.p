...
thf(conj_thm_2Etransc_2EDIFF__COMPOSITE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Etransc_2EDIFF__COMPOSITE__EXP,conjecture,(
    ! [V0g: $i] :
            ...
            @ ( ap
              @ ( ap
                @ ( ap @ c_2Elim_2Ediffl
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V3x: $i] :
                        ( ap @ c_2Etransc_2Eexp @ ( ap @ V0g @ V3x ) ) ) )
                @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Etransc_2Eexp @ ( ap @ V0g @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1m ) ) )
              @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) )).
