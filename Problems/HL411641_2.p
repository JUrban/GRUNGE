...
tff(conj_thm_2Ecardinal_2EINJECTIVE__ON__LEFT__INVERSE,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE__CLOSED__MAP,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__CLOSED__MAP,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
