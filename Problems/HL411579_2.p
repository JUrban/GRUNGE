...
tff(conj_thm_2Ereal__topology_2EIS__INTERVAL__INTER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Eis__interval,V0s))
              & p(ap(c_2Ereal__topology_2Eis__interval,V1t)) )
           => p(ap(c_2Ereal__topology_2Eis__interval,ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V0s),V1t))) ) ) ) )).
