...
tff(lmtp_f3542,type,(
    f3542: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3542,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: tp__ty_2Erealax_2Ereal] : mem(f3542(A_27a,V0m,V1c),arr(arr(A_27a,bool),ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3542,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2a: $i] :
          ( mem(V2a,arr(A_27a,bool))
         => ap(f3542(A_27a,V0m,V1c),V2a) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1c)),ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V2a)) ) ) )).

tff(conj_thm_2Emeasure_2EMEASURE__SPACE__CMUL,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
         ...
         => p(ap(c_2Emeasure_2Emeasure__space(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)),f3542(A_27a,V0m,V1c))))) ) ) )).
