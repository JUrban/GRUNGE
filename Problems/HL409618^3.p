      ...
      = ( c_2Emin_2E_40 @ tyop_2Erealax_2Ereal
        @ ^ [V1a: tyop_2Erealax_2Ereal] :
            ...
            @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
              @ ^ [V2x: tyop_2Erealax_2Ereal] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s ) @ ( c_2Ereal_2Ereal__lte @ V1a @ V2x ) ) )
            @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
              @ ^ [V3b: tyop_2Erealax_2Ereal] :
                  ( c_2Emin_2E_3D_3D_3E
                  @ ( c_2Ebool_2E_21 @ tyop_2Erealax_2Ereal
                    @ ^ [V4x: tyop_2Erealax_2Ereal] :
                        ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s ) @ ( c_2Ereal_2Ereal__lte @ V3b @ V4x ) ) )
                  @ ( c_2Ereal_2Ereal__lte @ V3b @ V1a ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EINF,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
