...
fof(conj_thm_2Ereal__topology_2EFORALL__IN__CLOSURE,lemma,(
    ! [V0f] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2EClosed,V2t))
                  ...
                  & ! [V3x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V1s))
                       => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V3x)),V2t)) ) ) )
               => ! [V4x] :
                    ( mem(V4x,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),ap(c_2Ereal__topology_2Eclosure,V1s)))
                     => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V4x)),V2t)) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__LE__ON__CLOSURE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2a] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
               ...
               => ! [V4x] :
                    ( mem(V4x,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),ap(c_2Ereal__topology_2Eclosure,V1s)))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V4x)),V2a)) ) ) ) ) ) ) )).
