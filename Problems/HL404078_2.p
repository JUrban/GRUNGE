...
tff(lameq_f1327,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V9t: tp__ty_2Enum_2Enum] : ap(f1327(V0a,V1b),inj__ty_2Enum_2Enum(V9t)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V0a,inj__ty_2Enum_2Enum(V9t))),ap(V1b,inj__ty_2Enum_2Enum(V9t))) ) ) )).
...
tff(lameq_f1333,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V15t: tp__ty_2Enum_2Enum] : ap(f1333(V1b),inj__ty_2Enum_2Enum(V15t)) = ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V15t))) ) )).

tff(lmtp_f1334,type,(
    f1334: ( $i * $i ) > $i )).

tff(lamtp_f1334,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1334,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V16t: tp__ty_2Enum_2Enum] : ap(f1334(V0a,V1b),inj__ty_2Enum_2Enum(V16t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,inj__ty_2Enum_2Enum(V16t))),ap(V1b,inj__ty_2Enum_2Enum(V16t))) ) ) )).
...
tff(lamtp_f1382,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1382(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1382,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1382(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),f882(V0a)),inj__ty_2Enum_2Enum(V2t)) ) )).

tff(lmtp_f1383,type,(
    f1383: $i > $i )).

tff(lamtp_f1383,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1383(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1383,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1383(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,k(ty_2Enum_2Enum,c_2Ebool_2EF)),V0a),inj__ty_2Enum_2Enum(V5t))) ) )).

tff(lmtp_f1384,type,(
    f1384: ( $i * $i ) > $i )).

tff(lamtp_f1384,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1384(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1384,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1384(V0a,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1296(V1b)),f1327(V0a,V1b)),inj__ty_2Enum_2Enum(V7t))) ) ) )).

tff(lmtp_f1385,type,(
    f1385: ( $i * $i ) > $i )).

tff(lamtp_f1385,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1385(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1385,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V10t: tp__ty_2Enum_2Enum] : ap(f1385(V1b,V0a),inj__ty_2Enum_2Enum(V10t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V1b),f1329(V0a,V1b)),inj__ty_2Enum_2Enum(V10t)) ) ) )).

tff(lmtp_f1386,type,(
    f1386: ( $i * $i ) > $i )).

tff(lamtp_f1386,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1386(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1386,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V12t: tp__ty_2Enum_2Enum] : ap(f1386(V0a,V1b),inj__ty_2Enum_2Enum(V12t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1331(V0a)),V1b),inj__ty_2Enum_2Enum(V12t))) ) ) )).

tff(lmtp_f1387,type,(
    f1387: ( $i * $i ) > $i )).

tff(lamtp_f1387,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1387(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1387,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V14t: tp__ty_2Enum_2Enum] : ap(f1387(V1b,V0a),inj__ty_2Enum_2Enum(V14t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1333(V1b)),f1334(V0a,V1b)),inj__ty_2Enum_2Enum(V14t)) ) ) )).

tff(lmtp_f1388,type,(
    f1388: ( $i * $i ) > $i )).

tff(lamtp_f1388,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1388(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1388,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V17t: tp__ty_2Enum_2Enum] : ap(f1388(V0a,V1b),inj__ty_2Enum_2Enum(V17t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V1b),f1336(V0a,V1b)),inj__ty_2Enum_2Enum(V17t))) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EPWHEN__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ( ap(c_2EPast__Temporal__Logic_2EPALWAYS,V0a) = f1382(V0a)
            & ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,V0a) = f1383(V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V1b) = f1384(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),V1b) = f1385(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V0a),V1b) = f1386(V0a,V1b)
            & ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V0a),V1b) = f1387(V1b,V0a)
            & ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),V1b) = f1388(V0a,V1b) ) ) ) )).
