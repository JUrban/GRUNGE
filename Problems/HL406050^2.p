...
thf(conj_thm_2Ewords_2EWORD__ADD__LSL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V2b: $i] :
          ( ( mem @ V2b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V1a ) @ V2b ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) )
            = ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V1a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V2b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2EEXTRACT__JOIN__ADD__LSL,conjecture,(
    ! [A_27a: del,A_27b: del,V0h: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2m_27: tp__ty_2Enum_2Enum,V3l: tp__ty_2Enum_2Enum,V4s: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum,V6w: $i] :
     ...
     => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V3l ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) )
       ...
       => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27b ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27b ) @ ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__extract @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( inj__ty_2Enum_2Enum @ V2m_27 ) ) @ V6w ) ) @ ( inj__ty_2Enum_2Enum @ V4s ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27b ) @ ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__extract @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V3l ) ) @ V6w ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) )
