...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__CONST,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__CONST__EQ__1__EQ__INV__CARD,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0P ) )
       => ! [V1f: $i] :
