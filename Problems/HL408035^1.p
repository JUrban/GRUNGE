...
thf(c_2Eseq_2Emono__increasing_2E0,type,(
    c_2Eseq_2Emono__increasing_2E0: u )).

thf(c_2Eseq_2Emono__increasing_2E1,type,(
    c_2Eseq_2Emono__increasing_2E1: du > u )).
...
thf(mono_2Ec_2Eseq_2Emono__increasing,type,(
    mono_2Ec_2Eseq_2Emono__increasing: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > $o )).
...
thf(thm_2Ereal_2ESUP__EPSILON,axiom,(
...
thf(thm_2Eseq_2ESEQ__MONO__LE,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V3n ) @ ( V0f @ ( mono_2Ec_2Earithmetic_2E_2B @ V3n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
        & ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ V1x ) )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V2n ) @ V1x ) ) )).

thf(thm_2Eseq_2Emono__increasing__def,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Emono__increasing @ V0f )
...
thf(thm_2Eseq_2Emono__increasing__converges__to__sup,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1r: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Eseq_2Emono__increasing @ V0f )
        & ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ V1r ) )
     => ( V1r
        = ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal @ V0f @ mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Enum_2Enum ) ) ) ) )).
