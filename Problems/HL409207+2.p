...
fof(conj_thm_2Eintegral_2EDIVISION__BOUNDS,lemma,(
    ! [V0d] :
         ...
         => ! [V2b] :
             ...
             => ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0d))
               => ! [V3n] :
                   ...
                   => ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),ap(V0d,V3n)))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,V3n)),V2b)) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2ETDIV__BOUNDS,conjecture,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1p] :
