...
tff(conj_thm_2Equotient__pair_2ECURRY__PRS,conjecture,(
                                 ...
                                 => ! [V7abs3: $i] :
                                     ...
                                     => ! [V8rep3: $i] :
                                         ...
                                         => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27c,A_27c),V6R3),V7abs3),V8rep3))
                                           => ! [V9f: $i] :
                                                ( mem(V9f,arr(ty_2Epair_2Eprod(A_27d,A_27d),A_27f))
                                               => ! [V10a: $i] :
                                                    ( mem(V10a,A_27d)
                                                   => ! [V11b: $i] :
                                                        ( mem(V11b,A_27e)
                                                       => ap(ap(ap(c_2Epair_2ECURRY(A_27d,A_27d,A_27d),V9f),V10a),V11b) = ap(V7abs3,ap(ap(ap(c_2Epair_2ECURRY(A_27a,A_27a,A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_23_23(A_27a,A_27a,A_27a,A_27a),V1abs1),V4abs2)),V8rep3),V9f)),ap(V2rep1,V10a)),ap(V5rep2,V11b))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
