...
fof(conj_thm_2Eiterate_2EREAL__SUP__UNIQUE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EDIAMETER__SING,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ap(c_2Ereal__topology_2Ediameter,ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) )).
