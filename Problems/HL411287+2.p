...
fof(conj_thm_2Ereal__topology_2ELIM__AT,lemma,(
    ! [V0f] :
...
fof(lamtp_f3891,axiom,(
    ! [V2f] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3a] :
          ( mem(V3a,ty_2Erealax_2Ereal)
         => mem(f3891(V2f,V3a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3891,axiom,(
    ! [V2f] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3a] :
          ( mem(V3a,ty_2Erealax_2Ereal)
         => ! [V4y] :
             ...
             => ap(f3891(V2f,V3a),V4y) = ap(ap(c_2Erealax_2Ereal__mul,V3a),ap(V2f,V4y)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__LIFT__DOT,lemma,(
    ! [V0l] :
      ( mem(V0l,ty_2Erealax_2Ereal)
     => ! [V1net] :
          ( mem(V1net,ty_2Ereal__topology_2Enet(ty_2Erealax_2Ereal))
         => ! [V2f] :
              ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => ! [V3a] :
                  ( mem(V3a,ty_2Erealax_2Ereal)
                 => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V2f),V0l),V1net))
                   => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3891(V2f,V3a)),ap(ap(c_2Erealax_2Ereal__mul,V3a),V0l)),V1net)) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__LIFT__DOT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3892(V0a)),ap(c_2Ereal__topology_2Eat,V1x))) ) ) )).
