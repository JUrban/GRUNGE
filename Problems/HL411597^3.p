...
thf(thm_2Ereal__topology_2EIMAGE__CLOSURE__SUBSET,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) ) @ V2t ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__COMPONENT__LE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2x: tyop_2Erealax_2Ereal,V3b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
        & ! [V4y: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V1s )
           => ( c_2Ereal_2Ereal__lte @ ( V0f @ V4y ) @ V3b ) )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Ereal__topology_2Eclosure @ V1s ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( V0f @ V2x ) @ V3b ) ) )).
