...
thf(thm_2Elist_2EMAP__EQ__CONS,axiom,(
    ! [A_27a: d,A_27b: d,V0t_2E0: u,V1l_2E0: u,V2h_2E0: u,V3f_2E0: u] :
      ( ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V2h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V0t_2E0 ) ) ) )
    <=> ? [V4x0_2E0: u,V5t0_2E0: u] :
          ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V4x0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5t0_2E0 ) ) ) )
          & ( ( s @ A_27b @ V2h_2E0 )
            = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ A_27a @ V4x0_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V0t_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5t0_2E0 ) ) ) ) ) ) )).
