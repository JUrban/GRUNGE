...
fof(lameq_f1311,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f1311(V0a),V5t) = ap(c_2Ebool_2E_7E,ap(V0a,V5t)) ) ) )).

fof(lamtp_f1323,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1323,axiom,(
    ! [V0a] :
     ...
     => ! [V20t] :
         ...
         => ap(f1323(V0a),V20t) = ap(c_2Ebool_2E_7E,ap(V0a,V20t)) ) ) )).
...
fof(lameq_f1410,axiom,(
    ! [V0a] :
     ...
     => ! [V6t] :
         ...
         => ap(f1410(V0a),V6t) = ap(c_2Ebool_2E_7E,ap(V0a,V6t)) ) ) )).

fof(lamtp_f1411,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1411,axiom,(
    ! [V0a] :
     ...
     => ! [V7t] :
         ...
         => ap(f1411(V0a),V7t) = ap(c_2Ebool_2E_7E,ap(V0a,V7t)) ) ) )).

fof(lamtp_f1412,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1412,axiom,(
    ! [V0a] :
     ...
     => ! [V9t] :
         ...
         => ap(f1412(V0a),V9t) = ap(c_2Ebool_2E_7E,ap(V0a,V9t)) ) ) )).

fof(lamtp_f1413,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1413,axiom,(
    ! [V0a] :
     ...
     => ! [V11t] :
         ...
         => ap(f1413(V0a),V11t) = ap(c_2Ebool_2E_7E,ap(V0a,V11t)) ) ) )).

fof(lamtp_f1414,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1414,axiom,(
    ! [V0a] :
     ...
     => ! [V12t] :
         ...
         => ap(f1414(V0a),V12t) = ap(c_2Ebool_2E_7E,ap(V0a,V12t)) ) ) )).

fof(lamtp_f1415,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1415,axiom,(
    ! [V0a] :
     ...
     => ! [V15t] :
         ...
         => ap(f1415(V0a),V15t) = ap(c_2Ebool_2E_7E,ap(V0a,V15t)) ) ) )).

fof(lamtp_f1416,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1416,axiom,(
    ! [V0a] :
     ...
     => ! [V16t] :
         ...
         => ap(f1416(V0a),V16t) = ap(c_2Ebool_2E_7E,ap(V0a,V16t)) ) ) )).

fof(lamtp_f1417,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1417,axiom,(
    ! [V0a] :
     ...
     => ! [V17t] :
         ...
         => ap(f1417(V0a),V17t) = ap(c_2Ebool_2E_7E,ap(V0a,V17t)) ) ) )).

fof(lamtp_f1418,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1418,axiom,(
    ! [V0a] :
     ...
     => ! [V18t] :
         ...
         => ap(f1418(V0a),V18t) = ap(c_2Ebool_2E_7E,ap(V0a,V18t)) ) ) )).

fof(lamtp_f1419,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1419,axiom,(
    ! [V0a] :
     ...
     => ! [V19t] :
         ...
         => ap(f1419(V0a),V19t) = ap(c_2Ebool_2E_7E,ap(V0a,V19t)) ) ) )).

fof(lamtp_f1420,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1420,axiom,(
    ! [V0a] :
     ...
     => ! [V21t] :
         ...
         => ap(f1420(V0a),V21t) = ap(c_2Ebool_2E_7E,ap(V0a,V21t)) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ENEGATION__NORMAL__FORM,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1t] :
          ( mem(V1t,ty_2Enum_2Enum)
         => ! [V2b] :
             ...
             => ( ( ~ p(ap(ap(c_2ETemporal__Logic_2ENEXT,V0a),V1t))
                <=> p(ap(ap(c_2ETemporal__Logic_2ENEXT,f889(V0a)),V1t)) )
                & ( ~ p(ap(ap(c_2ETemporal__Logic_2EALWAYS,V0a),V1t))
                <=> p(ap(ap(c_2ETemporal__Logic_2EEVENTUAL,f882(V0a)),V1t)) )
                & ( ~ p(ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V0a),V1t))
                <=> p(ap(ap(c_2ETemporal__Logic_2EALWAYS,f1311(V0a)),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f1410(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,f1411(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1350(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f1412(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1363(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1413(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V0a),V1t))
                <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,f1414(V0a)),V1t)) )
                & ( ~ p(ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V0a),V1t))
                <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,f1331(V0a)),V1t)) )
                & ( ~ p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,V0a),V1t))
                <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,f1302(V0a)),V1t)) )
                & ( ~ p(ap(ap(c_2EPast__Temporal__Logic_2EPEVENTUAL,V0a),V1t))
                <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,f1415(V0a)),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1416(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,f1417(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1418(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,f1419(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,f1323(V0a)),V2b),V1t)) )
                & ( ~ p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),V2b),V1t))
                <=> p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1420(V0a)),V2b),V1t)) ) ) ) ) ) )).
