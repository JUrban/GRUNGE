...
fof(lamtp_f3765,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => mem(f3765(A_27a,V1f,V3b),arr(A_27a,bool)) ) ) )).

fof(lameq_f3765,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3765(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,V3b),ap(c_2Ereal_2Eabs,ap(V1f,V4x))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__ABS__LBOUND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
             ...
             => ! [V2l] :
                 ...
                 => ! [V3b] :
                     ...
                     => ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                          ...
                          & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3765(A_27a,V1f,V3b)),V0net)) )
