...
thf(f3161_0_2E0,type,(
    f3161_0_2E0: u )).

thf(f3161_0_2E2,type,(
    f3161_0_2E2: du > du > u )).

thf(f3161_0_2E4,type,(
...
thf(arityeq2_2Emono_2Ef3161_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( f3161_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X1_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef3161_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ A_27a @ ( f3161_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27b @ X3_2E0 ) ) )
...
thf(def0_2Ethm_2Erich__list_2EFOLDL__FILTER,axiom,(
    ! [A_27a: d,A_27b: d,V2P_2E0: u,V0f_2E0: u,V4x_2E0: u,V5y_2E0: u] :
      ( ( s @ A_27a @ ( f3161_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27b @ V5y_2E0 ) ) )
...
thf(thm_2Erich__list_2EFOLDL__FILTER,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2P_2E0: u,V3l_2E0: u] :
      ...
      = ( s @ A_27a @ ( c_2Elist_2EFOLDL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( f3161_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) ) ) @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V3l_2E0 ) ) ) ) )).
