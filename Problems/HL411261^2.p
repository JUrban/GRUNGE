...
thf(conj_thm_2Ereal__topology_2ECLOSED__MAP__FROM__COMPOSITION__SURJECTIVE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
                 ...
                 => ! [V4u: $i] :
                     ...
                     => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ V2s ) )
                          ...
                          & ! [V5k: $i] :
                             ...
                             => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) ) @ V5k ) )
                               => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V4u ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V0f ) ) @ V5k ) ) ) ) ) )
                       => ! [V6k: $i] :
                            ( ( mem @ V6k @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                           => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V3t ) ) @ V6k ) )
                             => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V4u ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V6k ) ) ) ) ) ) ) ) ) ) ) )).
