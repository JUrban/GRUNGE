...
fof(conj_thm_2Epatricia_2EREMOVE__TRANSFORM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1t] :
                 ...
                 => ! [V2k] :
                     ...
                     => ap(ap(c_2Epatricia_2ETRANSFORM(A_27b,A_27b),V0f),ap(ap(c_2Epatricia_2EREMOVE(A_27a),V1t),V2k)) = ap(ap(c_2Epatricia_2EREMOVE(A_27b),ap(ap(c_2Epatricia_2ETRANSFORM(A_27b,A_27b),V0f),V1t)),V2k) ) ) ) ) ) )).
...
fof(conj_thm_2Epatricia_2EPERM__DELETE__PTREE,lemma,(
    ! [V0t] :
...
fof(conj_thm_2Epatricia_2EPERM__REMOVE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
