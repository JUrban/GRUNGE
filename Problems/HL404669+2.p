...
fof(conj_thm_2Efinite__map_2EFMERGE__FEMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0m] :
             ...
             => ! [V1f] :
                 ...
                 => ( ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m),V1f),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)) = V1f
                    & ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1f) = V1f ) ) ) ) ) )).
