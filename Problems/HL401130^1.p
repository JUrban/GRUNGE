...
thf(thm_2Eind__type_2EINJ__INVERSE2,conjecture,(
    ! [A_27A: d,A_27B: d,A_27C: d,V0P_2E0: u] :
      ( ! [V1x1_2E0: u,V2y1_2E0: u,V3x2_2E0: u,V4y2_2E0: u] :
          ( ( ( s @ A_27C @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27A @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) ) @ V0P_2E0 ) @ ( s @ A_27A @ V1x1_2E0 ) ) ) @ ( s @ A_27B @ V2y1_2E0 ) ) )
            = ( s @ A_27C @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27A @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) ) @ V0P_2E0 ) @ ( s @ A_27A @ V3x2_2E0 ) ) ) @ ( s @ A_27B @ V4y2_2E0 ) ) ) )
        <=> ( ( ( s @ A_27A @ V1x1_2E0 )
              = ( s @ A_27A @ V3x2_2E0 ) )
            & ( ( s @ A_27B @ V2y1_2E0 )
              = ( s @ A_27B @ V4y2_2E0 ) ) ) )
     => ? [V5X_2E0: u,V6Y_2E0: u] :
        ! [V7x_2E0: u,V8y_2E0: u] :
          ( ( ( s @ A_27A @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27C @ A_27A ) @ V5X_2E0 ) @ ( s @ A_27C @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27A @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) ) @ V0P_2E0 ) @ ( s @ A_27A @ V7x_2E0 ) ) ) @ ( s @ A_27B @ V8y_2E0 ) ) ) ) )
            = ( s @ A_27A @ V7x_2E0 ) )
          & ( ( s @ A_27B @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27C @ A_27B ) @ V6Y_2E0 ) @ ( s @ A_27C @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27A @ ( tyop_2Emin_2Efun @ A_27B @ A_27C ) ) @ V0P_2E0 ) @ ( s @ A_27A @ V7x_2E0 ) ) ) @ ( s @ A_27B @ V8y_2E0 ) ) ) ) )
            = ( s @ A_27B @ V8y_2E0 ) ) ) ) )).
