...
tff(conj_thm_2Epred__set_2EPREIMAGE__INTER,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINTER(A_27b),V1s),V2t)) = ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V2t)) ) ) ) )).

tff(conj_thm_2Epred__set_2EPREIMAGE__DISJOINT,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
