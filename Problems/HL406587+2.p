...
fof(conj_thm_2Esptree_2Espt__eq__thm,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t1] :
             ...
             => ( ( p(ap(c_2Esptree_2Ewf(A_27a),V0t1))
               ...
               => ( V0t1 = V1t2
                <=> ! [V2n] :
                     ...
                     => ap(ap(c_2Esptree_2Elookup(A_27a),V2n),V0t1) = ap(ap(c_2Esptree_2Elookup(A_27a),V2n),V1t2) ) ) ) ) ) ) )).

fof(conj_thm_2Esptree_2Elookup__fromAList__toAList,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
...
fof(conj_thm_2Esptree_2Ewf__fromAList,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
...
fof(conj_thm_2Esptree_2EfromAList__toAList,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Esptree_2Espt(A_27a))
