...
thf(conj_thm_2Ebag_2EBAG__DIFF__2L,conjecture,(
    ! [A_27a: del,V0X: $i] :
     ...
     => ! [V1Y: $i] :
         ...
         => ! [V2Z: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V0X ) @ V1Y ) ) @ V2Z )
                = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V0X ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1Y ) @ V2Z ) ) ) ) ) ) )).
