...
thf(conj_thm_2Ereal__topology_2ESUMS__0,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__DROP__LE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__DROP__POS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
