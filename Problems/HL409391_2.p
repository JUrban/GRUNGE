...
tff(lamtp_f2165,axiom,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2165(A_27a,V0v,V1w),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2165,axiom,(
    ! [A_27a: del,V0v: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2165(A_27a,V0v,V1w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),inj__ty_2Enum_2Enum(V2i))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i))) ) ) )).
...
tff(ax_thm_2Ewords_2Eword__or__def,axiom,(
    ! [A_27a: del,V0v: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Ewords_2Eword__or(A_27a),V0v),V1w) = ap(c_2Efcp_2EFCP(bool,bool),f2165(A_27a,V0v,V1w)) ) ) )).

tff(lmtp_f2210,type,(
    f2210: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2210,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2210(A_27a,V1n,V0w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2210,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2210(A_27a,V1n,V0w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2i))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V1n))))) ) )).

tff(ax_thm_2Ewords_2Eword__lsl__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__lsl(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Efcp_2EFCP(bool,bool),f2210(A_27a,V1n,V0w)) ) )).
...
tff(conj_thm_2Emachine__ieee_2Efloat__to__fp64__11,conjecture,(
    ! [V0x: tp__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone,V1y: tp__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone] :
      ( surj__c_ty_2Efcp_2Ecart_o_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(ap(c_2Emachine__ieee_2Efloat__to__fp64,inj__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(V0x))) = surj__c_ty_2Efcp_2Ecart_o_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(ap(c_2Emachine__ieee_2Efloat__to__fp64,inj__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(V1y)))
    <=> V0x = V1y ) )).
