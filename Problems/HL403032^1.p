...
thf(f3419_0_2E0,type,(
    f3419_0_2E0: u )).

thf(f3419_0_2E1,type,(
    f3419_0_2E1: du > u )).
...
thf(c_2EindexedLists_2EdelN_2E0,type,(
    c_2EindexedLists_2EdelN_2E0: u )).

thf(c_2EindexedLists_2EdelN_2E2,type,(
    c_2EindexedLists_2EdelN_2E2: du > du > u )).
...
thf(mono_2Ef3419_0,type,(
    mono_2Ef3419_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq2_2Emono_2Ec_2EindexedLists_2EdelN_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EdelN_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2EindexedLists_2EdelN_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2EindexedLists_2EdelN__def,axiom,(
    ! [V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3419_0 @ V1i )
    <=> ( V1i = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2EindexedLists_2EdelN__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0i: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EdelN_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V1i: mono_2Etyop_2Enum_2Enum,V2h_2E0: u,V3t_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EdelN_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef3419_0 @ V1i ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3t_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EdelN_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V1i @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3t_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2EindexedLists_2EEL__delN__BEFORE,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1i: mono_2Etyop_2Enum_2Enum,V2j: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1i @ V2j )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ V2j @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) )
     => ( ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EdelN_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2j ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) )
        = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) )).
