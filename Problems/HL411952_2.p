...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__COMPACTNESS,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__LOCALLY,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__LOCAL__COMPACTNESS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
