...
thf(conj_thm_2Eiterate_2EDISJOINT__NUMSEG,lemma,(
...
thf(conj_thm_2Eproduct_2EPRODUCT__UNION,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V1s ) @ V2t ) ) @ V0f ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V1s ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2t ) @ V0f ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eproduct_2EPRODUCT__ADD__SPLIT,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] :
         ...
         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) ) @ V0f ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) ) @ V0f ) ) ) ) ) ) )).
