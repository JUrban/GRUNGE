    ...
    ! [V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V1g: $i] :
             ...
             => ! [V5k: $i] :
                  ( mem(V5k,arr(ty_2Erealax_2Ereal,bool))
                 => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3887(V2s,V0f,V1g,V5k),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1g),V0f),inj__ty_2Erealax_2Ereal(V6x))),V5k))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EPROPER__MAP__FROM__COMPOSITION__LEFT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
