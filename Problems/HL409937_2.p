...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__NEG__INF,lemma,(
    ! [A_27a: del,V0f: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
              & ! [V2x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                   => surj__ty_2Eextreal_2Eextreal(ap(V0f,V2x)) != fo__c_2Eextreal_2ENegInf ) ) )
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s)) != fo__c_2Eextreal_2ENegInf ) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__POS__INF,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
              & ! [V2x: $i] :
                  ( mem(V2x,A_27a)
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                   => surj__ty_2Eextreal_2Eextreal(ap(V0f,V2x)) != fo__c_2Eextreal_2EPosInf ) ) )
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s)) != fo__c_2Eextreal_2EPosInf ) ) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__INFTY,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
            ...
            & ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                & ! [V3x: $i] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                     => surj__ty_2Eextreal_2Eextreal(ap(V0f,V3x)) != fo__c_2Eextreal_2EPosInf ) ) )
             => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s)) != fo__c_2Eextreal_2EPosInf ) ) ) ) )).
