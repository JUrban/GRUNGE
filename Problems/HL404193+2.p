...
fof(mem_c_2Epath_2Epgenerate,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Epath_2Epgenerate(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,A_27a),arr(arr(ty_2Enum_2Enum,A_27b),ty_2Epath_2Epath(A_27a,A_27a)))) ) ) )).
...
fof(conj_thm_2Epath_2Epgenerate__infinite,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epath_2Epgenerate__not__stopped,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
