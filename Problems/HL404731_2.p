...
tff(conj_thm_2Efinite__map_2Efmap__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(conj_thm_2Efinite__map_2EDOMSUB__FAPPLY__THM,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1k1: $i] :
          ( mem(V1k1,A_27a)
...
tff(conj_thm_2Efinite__map_2EDOMSUB__COMMUTES,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1k1: $i] :
          ( mem(V1k1,A_27a)
         => ! [V2k2: $i] :
              ( mem(V2k2,A_27a)
             => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V1k1)),V2k2) = ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V2k2)),V1k1) ) ) ) )).
