...
fof(conj_thm_2Efinite__map_2EDRESTRICT__IS__FEMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
              ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),c_2Epred__set_2EEMPTY(A_27a)) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) ) ) )).
