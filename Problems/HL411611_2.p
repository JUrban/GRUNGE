...
tff(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LE,lemma,(
    ! [V0R: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONVERGENT__BOUNDED__MONOTONE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b: tp__ty_2Erealax_2Ereal] :
          ( ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0s,inj__ty_2Enum_2Enum(V2n)))),inj__ty_2Erealax_2Ereal(V1b)))
            & ( ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,inj__ty_2Enum_2Enum(V3m))),ap(V0s,inj__ty_2Enum_2Enum(V4n)))) )
              | ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,inj__ty_2Enum_2Enum(V6n))),ap(V0s,inj__ty_2Enum_2Enum(V5m)))) ) ) )
         => ? [V7l: tp__ty_2Erealax_2Ereal] :
            ! [V8e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V9N: tp__ty_2Enum_2Enum] :
                ! [V10n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V9N)),inj__ty_2Enum_2Enum(V10n)))
                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0s,inj__ty_2Enum_2Enum(V10n))),inj__ty_2Erealax_2Ereal(V7l)))),inj__ty_2Erealax_2Ereal(V8e))) ) ) ) ) )).

tff(lmtp_f3997,type,(
    f3997: $i > $i )).

tff(lamtp_f3997,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3997(V0s),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3997,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f3997(V0s),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0s,inj__ty_2Enum_2Enum(V1n))),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__INCREASING__CONVERGENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3997(V0s))))
          & ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,inj__ty_2Enum_2Enum(V2n))),ap(V0s,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n))))) )
       => ? [V3l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0s),inj__ty_2Erealax_2Ereal(V3l)),c_2Ereal__topology_2Esequentially)) ) ) )).
