    ...
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Erealax_2Ereal,V2b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ! [V3x: A_27a] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( V1f @ V3x ) @ V2b ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ A_27a @ V0s @ V1f ) @ ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__of__num @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) @ V2b ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__BOUND__GEN,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Erealax_2Ereal,V2b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        ...
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ ( V1f @ V3x ) @ ( c_2Ereal_2E_2F @ V2b @ ( c_2Ereal_2Ereal__of__num @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ A_27a @ V0s @ V1f ) @ V2b ) ) )).
