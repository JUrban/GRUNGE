...
fof(conj_thm_2Eextreal_2Emax__le,lemma,(
    ! [V0z] :
      ( mem(V0z,ty_2Eextreal_2Eextreal)
     => ! [V1x] :
          ( mem(V1x,ty_2Eextreal_2Eextreal)
...
fof(conj_thm_2Eextreal_2Emax__le2__imp,conjecture,(
    ! [V0x1] :
         ...
         => ! [V2y1] :
             ...
             => ! [V3y2] :
                 ...
                 => ( ( p(ap(ap(c_2Eextreal_2Eextreal__le,V0x1),V2y1))
                   ...
                   => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(c_2Eextreal_2Eextreal__max,V0x1),V1x2)),ap(ap(c_2Eextreal_2Eextreal__max,V2y1),V3y2))) ) ) ) ) ) )).
