...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__PRODUCT,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__PRODUCT,conjecture,(
    ! [A_27a: del,V0f: $i] :
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ c_2Ereal__topology_2Econtinuous__on
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V5x: $i] :
                            ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2t ) @ ( ap @ V0f @ V5x ) ) ) )
                    @ V1s ) ) ) ) ) ) )).
