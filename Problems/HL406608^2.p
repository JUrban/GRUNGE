...
thf(tp_c_2ECoder_2Edecoder,type,(
    c_2ECoder_2Edecoder: del > $i )).

thf(mem_c_2ECoder_2Edecoder,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2ECoder_2Edecoder @ A_27a ) @ ( arr @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ A_27a ) ) ) )).
...
thf(conj_thm_2ECoder_2Ewf__coder,lemma,(
    ! [A_27a: del,V0c: $i] :
      ( ( mem @ V0c @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) ) ) )
     => ( ( p @ ( ap @ ( c_2ECoder_2Ewf__coder @ A_27a ) @ V0c ) )
       => ! [V1x: $i] :
            ( ( mem @ V1x @ A_27a )
           => ( ( p @ ( ap @ ( ap @ ( c_2ECoder_2Edomain @ A_27a ) @ V0c ) @ V1x ) )
             => ( ( ap @ ( ap @ ( c_2ECoder_2Edecoder @ A_27a ) @ V0c ) @ ( ap @ ( ap @ ( c_2ECoder_2Eencoder @ A_27a ) @ V0c ) @ V1x ) )
                = V1x ) ) ) ) ) )).

thf(conj_thm_2ECoder_2Ewf__coder__closed,lemma,(
    ! [A_27a: del,V0c: $i] :
      ( ( mem @ V0c @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) ) ) )
     => ( ( p @ ( ap @ ( c_2ECoder_2Ewf__coder @ A_27a ) @ V0c ) )
       => ! [V1l: tp__c_ty_2Elist_2Elist_o] :
            ( p @ ( ap @ ( ap @ ( c_2ECoder_2Edomain @ A_27a ) @ V0c ) @ ( ap @ ( ap @ ( c_2ECoder_2Edecoder @ A_27a ) @ V0c ) @ ( inj__c_ty_2Elist_2Elist_o @ V1l ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebool_2ERES__EXISTS__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2EEncodeVar_2Efixed__width__exists,conjecture,(
    ! [A_27a: del,V0phi: $i] :
              ...
              <=> ( p
                  @ ( ap @ ( ap @ ( c_2Ebool_2ERES__EXISTS @ ( ty_2Elist_2Elist @ bool ) ) @ ( ap @ ( c_2EEncodeVar_2Eof__length @ bool ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                    @ ( lam @ ( ty_2Elist_2Elist @ bool )
                      @ ^ [V4w: $i] :
                          ( ap @ V0phi @ ( ap @ ( ap @ ( c_2ECoder_2Edecoder @ A_27a ) @ V1c ) @ V4w ) ) ) ) ) ) ) ) ) )).
