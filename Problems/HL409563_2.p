...
tff(conj_thm_2Elift__ieee_2Efloat__mul__relative,lemma,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
              ...
              & p(ap(ap(c_2Elift__ieee_2Enormalizes(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)))) )
           => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__mul(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),V0a),V1b))))
...
tff(tp_c_2Emachine__ieee_2Efp32__mul,type,(
    c_2Emachine__ieee_2Efp32__mul: $i )).

tff(mem_c_2Emachine__ieee_2Efp32__mul,axiom,(
    mem(c_2Emachine__ieee_2Efp32__mul,arr(ty_2Ebinary__ieee_2Erounding,arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))))) )).
...
tff(ax_thm_2Emachine__ieee_2Efp32__mul__def,axiom,(
...
tff(conj_thm_2Elift__machine__ieee_2Efp32__float__mul__relative,conjecture,(
