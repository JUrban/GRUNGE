...
thf(thm_2EHolSmt_2Er066,conjecture,(
    ...
    <=> ( ( mono_2Ec_2Einteger_2Eint__add @ V2x @ ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ V0z ) )
        = V1y ) ) )).
