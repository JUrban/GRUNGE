...
tff(conj_thm_2Elist_2EMAP__EQ__SING,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1l: $i] :
...
tff(conj_thm_2Elist_2EREVERSE__EQ__SING,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
...
tff(conj_thm_2Elist_2EMAP__TAKE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1n: tp__ty_2Enum_2Enum,V2l: $i] :
          ( mem(V2l,ty_2Elist_2Elist(A_27a))
         => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),ap(ap(c_2Elist_2ETAKE(A_27a),inj__ty_2Enum_2Enum(V1n)),V2l)) = ap(ap(c_2Elist_2ETAKE(A_27b),inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2l)) ) ) )).
...
tff(conj_thm_2Enumposrep_2ELENGTH__l2n,lemma,(
...
tff(conj_thm_2Enumposrep_2En2l__l2n,lemma,(
    ! [V0b: tp__ty_2Enum_2Enum,V1l: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum] :
      ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0b)))
        & p(ap(ap(c_2Elist_2EEVERY(ty_2Enum_2Enum),ap(c_2Earithmetic_2E_3E,inj__ty_2Enum_2Enum(V0b))),inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(V1l))) )
...
tff(conj_thm_2EASCIInumbers_2En2s__s2n,conjecture,(
    ! [V0c2n: $i] :
     ...
     => ! [V1n2c: $i] :
         ...
         => ! [V2b: tp__ty_2Enum_2Enum,V3s: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] :
              ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V2b)))
                & p(ap(ap(c_2Elist_2EEVERY(ty_2Estring_2Echar),ap(ap(c_2Ecombin_2Eo(ty_2Estring_2Echar,ty_2Estring_2Echar,ty_2Estring_2Echar),ap(c_2Earithmetic_2E_3E,inj__ty_2Enum_2Enum(V2b))),V0c2n)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s))) )
             => surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(ap(ap(ap(c_2EASCIInumbers_2En2s,inj__ty_2Enum_2Enum(V2b)),V1n2c),ap(ap(ap(c_2EASCIInumbers_2Es2n,inj__ty_2Enum_2Enum(V2b)),V0c2n),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s)))) = surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(ap(ap(c_2EASCIInumbers_2Es2n,inj__ty_2Enum_2Enum(V2b)),V0c2n),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(V1n2c,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Elist_2ENIL(ty_2Estring_2Echar))),ap(ap(c_2Elist_2EMAP(ty_2Estring_2Echar,ty_2Estring_2Echar),ap(ap(c_2Ecombin_2Eo(ty_2Estring_2Echar,ty_2Estring_2Echar,ty_2Estring_2Echar),V1n2c),V0c2n)),ap(ap(c_2Erich__list_2ELASTN(ty_2Estring_2Echar),ap(c_2Enum_2ESUC,ap(ap(c_2Elogroot_2ELOG,inj__ty_2Enum_2Enum(V2b)),ap(ap(ap(c_2EASCIInumbers_2Es2n,inj__ty_2Enum_2Enum(V2b)),V0c2n),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s))))),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s))))) ) ) ) )).
