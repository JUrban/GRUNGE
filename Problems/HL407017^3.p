...
thf(thm_2Einteger__word_2Ei2w__INT__MIN,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Einteger__word_2Ei2w @ A_27a @ ( c_2Einteger__word_2EINT__MIN @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
      = ( c_2Ewords_2Eword__L @ A_27a ) ) )).

thf(thm_2Einteger__word_2Ei2w__INT__MAX,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Einteger__word_2Ei2w @ A_27a @ ( c_2Einteger__word_2EINT__MAX @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
...
thf(thm_2Ewords_2EWORD__H__WORD__L,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Ewords_2Eword__H @ A_27a )
      = ( c_2Ewords_2Eword__sub @ A_27a @ ( c_2Ewords_2Eword__L @ A_27a ) @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).

thf(thm_2Ewords_2EWORD__NOT__LOWER__EQUAL,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1b: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( (~) @ ( c_2Ewords_2Eword__ls @ A_27a @ V0a @ V1b ) )
    <=> ( c_2Ewords_2Eword__lo @ A_27a @ V1b @ V0a ) ) )).
...
thf(thm_2Ewords_2Eword__ls__n2w,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__ls @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V0a ) @ ( c_2Ewords_2En2w @ A_27a @ V1b ) )
      = ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EMOD @ V0a @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( c_2Earithmetic_2EMOD @ V1b @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) )).

thf(thm_2Einteger__word_2Esigned__saturate__add,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1b: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Einteger__word_2Esigned__saturate__add @ A_27a @ V0a @ V1b )
      = ( c_2Ebool_2ELET @ $o @ ( tyop_2Efcp_2Ecart @ $o @ A_27a )
        @ ( c_2Ebool_2ELET @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( $o > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) )
          @ ^ [V2sum: tyop_2Efcp_2Ecart @ $o @ A_27a,V3msba: $o] :
              ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ $o @ V3msba @ ( c_2Ewords_2Eword__msb @ A_27a @ V1b ) ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ $o @ V3msba @ ( c_2Ewords_2Eword__msb @ A_27a @ V2sum ) ) ) ) @ ( c_2Ebool_2ECOND @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ V3msba @ ( c_2Ewords_2Eword__L @ A_27a ) @ ( c_2Ewords_2Eword__H @ A_27a ) ) @ V2sum )
