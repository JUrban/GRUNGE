...
thf(thm_2EPast__Temporal__Logic_2ENEXT__INWARDS__NORMAL__FORM,conjecture,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V2t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V1a @ V2t ) ) )
        = ( ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V3t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V4t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V1a @ V4t ) @ ( V0b @ V4t ) ) )
        = ( ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V5t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V5t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1a @ V6t ) @ ( V0b @ V6t ) ) )
        = ( ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V7t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V7t ) ) ) )
      ...
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPALWAYS @ V1a ) )
        = ( ^ [V8t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPALWAYS @ V1a @ V8t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V8t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V1a ) )
        = ( ^ [V9t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V1a @ V9t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V9t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1a @ V0b ) )
        = ( ^ [V10t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V10t ) @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V10t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1a @ V0b @ V10t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V1a @ V0b ) )
        = ( ^ [V11t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2ECOND @ $o @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V11t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V11t ) @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ V1a @ V0b @ V11t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V1a @ V0b ) )
        = ( ^ [V12t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V12t ) ) @ ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V12t ) @ ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V1a @ V0b @ V12t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V1a @ V0b ) )
        = ( ^ [V13t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V13t ) @ ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V13t ) @ ( c_2EPast__Temporal__Logic_2EPUNTIL @ V1a @ V0b @ V13t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V1a @ V0b ) )
        = ( ^ [V14t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2ECOND @ $o @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V14t ) @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V14t ) @ ( c_2EPast__Temporal__Logic_2EPWHEN @ V1a @ V0b @ V14t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1a @ V0b ) )
        = ( ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2ETemporal__Logic_2ENEXT @ V0b @ V15t ) ) @ ( c_2Ebool_2E_5C_2F @ ( c_2ETemporal__Logic_2ENEXT @ V1a @ V15t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1a @ V0b @ V15t ) ) ) ) ) ) )).
