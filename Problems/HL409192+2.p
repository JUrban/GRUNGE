...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(lameq_f3182,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V3x] :
         ...
         => ! [V4n] :
              ( mem(V4n,ty_2Enum_2Enum)
             => ap(f3182(A_27a,V1f,V3x),V4n) = ap(ap(V1f,V4n),V3x) ) ) ) )).

fof(lamtp_f3183,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V0s] :
    ...
    ! [A_27a,V1f] :
     ...
     => ! [V0s] :
         ...
         => ! [V5n] :
             ...
             => ap(f3183(A_27a,V1f,V0s),V5n) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),ap(V1f,V5n)),V0s) ) ) ) )).

fof(conj_thm_2Ereal__sigma_2ESEQ__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
