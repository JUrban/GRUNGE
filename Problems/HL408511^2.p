...
thf(conj_thm_2Ebinary__ieee_2Efloat__to__real__eq,lemma,(
         ...
         => ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w ) @ V0x ) )
          ...
          <=> ( ( V0x = V1y )
              | ( ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__zero @ A_27t @ A_27w ) @ V0x ) )
                & ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__zero @ A_27t @ A_27w ) @ V1y ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebinary__ieee_2Ediff__lt__ulp__eq0,conjecture,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( ~ ( p @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Eexponent__boundary @ A_27t @ A_27w ) @ V1b ) @ V0a ) )
                & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w ) @ V0a ) ) ) ) @ ( ap @ ( c_2Ebinary__ieee_2EULP @ A_27t @ A_27w ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Efcp_2Ecart @ bool @ A_27w ) @ ( ty_2Ebool_2Eitself @ A_27t ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Exponent @ A_27t @ A_27w ) @ V0a ) ) @ ( c_2Ebool_2Ethe__value @ A_27t ) ) ) ) )
                & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w ) @ V1b ) ) ) ) @ ( ap @ ( c_2Ebinary__ieee_2EULP @ A_27t @ A_27w ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Efcp_2Ecart @ bool @ A_27w ) @ ( ty_2Ebool_2Eitself @ A_27t ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Exponent @ A_27t @ A_27w ) @ V0a ) ) @ ( c_2Ebool_2Ethe__value @ A_27t ) ) ) ) )
                & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w ) @ V0a ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) )
                & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w ) @ V1b ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) )
                & ~ ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__zero @ A_27t @ A_27w ) @ V0a ) ) )
             => ( V1b = V0a ) ) ) ) )).
