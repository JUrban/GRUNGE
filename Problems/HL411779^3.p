...
thf(thm_2Ereal__topology_2ESERIES__CMUL,axiom,(
    ! [V0x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1x0: tyop_2Erealax_2Ereal,V2c: tyop_2Erealax_2Ereal,V3s: tyop_2Enum_2Enum > $o] :
      ( ( c_2Ereal__topology_2Esums @ V0x @ V1x0 @ V3s )
     => ( c_2Ereal__topology_2Esums
        @ ^ [V4n: tyop_2Enum_2Enum] :
            ( c_2Erealax_2Ereal__mul @ V2c @ ( V0x @ V4n ) )
        @ ( c_2Erealax_2Ereal__mul @ V2c @ V1x0 )
        @ V3s ) ) )).

thf(thm_2Ereal__topology_2EINFSUM__CMUL,conjecture,(
    ! [V0s: tyop_2Enum_2Enum > $o,V1x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2c: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Ereal__topology_2Einfsum @ V0s
          @ ^ [V3n: tyop_2Enum_2Enum] :
              ( c_2Erealax_2Ereal__mul @ V2c @ ( V1x @ V3n ) ) )
        = ( c_2Erealax_2Ereal__mul @ V2c @ ( c_2Ereal__topology_2Einfsum @ V0s @ V1x ) ) ) ) )).
