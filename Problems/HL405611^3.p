...
thf(thm_2Eordinal_2Epreds__surj,axiom,(
    ! [A_27a: $tType,V0x: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( ( c_2Eordinal_2Edownward__closed @ A_27a @ V0x )
        & ( (~)
          @ ( V0x
            = ( c_2Epred__set_2EUNIV @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) ) )
     => ? [V1y: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( c_2Eordinal_2Epreds @ A_27a @ V1y )
          = V0x ) ) )).
...
thf(thm_2Eordinal_2Esup__preds__SUC,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Esup @ A_27a @ ( c_2Eordinal_2Epreds @ A_27a @ ( c_2Eordinal_2EordSUC @ A_27a @ V0a ) ) )
      = V0a ) )).
...
thf(thm_2Eordinal_2Epreds__sup__thm,conjecture,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( ( c_2Eordinal_2Edownward__closed @ A_27a @ V0s )
        & ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EUNIV @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) ) )
     => ! [V1b: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( c_2Eordinal_2Eordlt @ A_27a @ V1b @ ( c_2Eordinal_2Esup @ A_27a @ V0s ) )
        <=> ? [V2d: tyop_2Eordinal_2Eordinal @ A_27a] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2d @ V0s )
              & ( c_2Eordinal_2Eordlt @ A_27a @ V1b @ V2d ) ) ) ) )).
