...
fof(conj_thm_2Elift__ieee_2Eclosest__is__everything,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2x] :
                     ...
                     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V1s))
                       => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
                         => ( p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),V2x),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),V2x)))
                            & ( ? [V3b] :
                                  ( mem(V3b,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
                                  & p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),V2x),V3b))
                                  & p(ap(V0p,V3b)) )
                             => p(ap(V0p,ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),V2x))) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Eclosest__in__set,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1s] :
                 ...
                 => ! [V2x] :
                     ...
                     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V1s))
                       => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
                         => p(ap(ap(c_2Ebool_2EIN(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),V2x)),V1s)) ) ) ) ) ) ) ) )).
