...
fof(conj_thm_2EindexedLists_2EEL__delN__BEFORE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
         ...
         => ! [V1i] :
             ...
             => ! [V2j] :
                 ...
                 => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V1i),V2j))
                      & p(ap(ap(c_2Eprim__rec_2E_3C,V2j),ap(c_2Elist_2ELENGTH(A_27a),V0l))) )
                   => ap(ap(c_2Elist_2EEL(A_27a),V1i),ap(ap(c_2EindexedLists_2EdelN(A_27a),V2j),V0l)) = ap(ap(c_2Elist_2EEL(A_27a),V1i),V0l) ) ) ) ) ) )).
