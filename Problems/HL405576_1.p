...
tff(thm_2Eordinal_2Epreds__surj,conjecture,(
    ! [A_27a: d,V0x_2E0: u] :
      ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Eordinal_2Edownward__closed_2E1(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0x_2E0)))))
        & s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0x_2E0) != s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EUNIV_2E0) )
     => ? [V1y_2E0: u] : s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Eordinal_2Epreds_2E1(s(tyop_2Eordinal_2Eordinal(A_27a),V1y_2E0))) = s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0x_2E0) ) )).
