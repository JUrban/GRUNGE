...
tff(lamtp_f3785,axiom,(
    ! [A_27a: del,A_27a: del,V1a: $i] :
      ( mem(V1a,A_27a)
     => ! [V0net: $i] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => mem(f3785(A_27a,A_27a,V1a,V0net),arr(A_27a,bool)) ) ) )).

tff(lameq_f3785,axiom,(
    ! [A_27a: del,A_27a: del,V1a: $i] :
      ( mem(V1a,A_27a)
     => ! [V0net: $i] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3785(A_27a,A_27a,V1a,V0net),V2x) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2Ereal__topology_2Enetord(A_27a),V0net),V2x),V1a)) ) ) ) )).

tff(lmtp_f3784,type,(
    f3784: ( del * del * $i ) > $i )).

tff(lamtp_f3784,axiom,(
    ! [A_27a: del,A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => mem(f3784(A_27a,A_27a,V0net),arr(A_27a,bool)) ) )).

tff(lameq_f3784,axiom,(
    ! [A_27a: del,A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
         => ap(f3784(A_27a,A_27a,V0net),V1a) = ap(c_2Ebool_2E_21(A_27a),f3785(A_27a,A_27a,V1a,V0net)) ) ) )).

tff(ax_thm_2Ereal__topology_2Enetlimit,axiom,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ap(c_2Ereal__topology_2Enetlimit(A_27a),V0net) = ap(c_2Emin_2E_40(A_27a),f3784(A_27a,A_27a,V0net)) ) )).

tff(conj_thm_2Ereal__topology_2ENETLIMIT__WITHIN,conjecture,(
