...
fof(conj_thm_2Ebag_2EBAG__IMAGE__EQ__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ebag_2EBAG__EVERY__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f975,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27a))
     => mem(f975(A_27a,V0f),arr(A_27a,bool)) ) )).
...
fof(lameq_f975,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V2e] :
          ( mem(V2e,A_27a)
         => ap(f975(A_27a,V0f),V2e) = ap(ap(c_2Emin_2E_3D(A_27a),ap(V0f,V2e)),V2e) ) ) )).

fof(conj_thm_2Ebag_2EBAG__IMAGE__FINITE__RESTRICTED__I,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,A_27a))
         => ! [V1b] :
              ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
             => ( ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V1b))
                  & p(ap(ap(c_2Ebag_2EBAG__EVERY(A_27a),f975(A_27a,V0f)),V1b)) )
