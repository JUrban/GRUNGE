...
fof(lamtp_f3637,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3637(V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3637,axiom,(
    ! [V0f] :
     ...
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3637(V0f),V1x) = ap(c_2Erealax_2Ereal__neg,ap(V0f,V1x)) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__NEG,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
       => p(ap(c_2Ereal__topology_2Elinear,f3637(V0f))) ) ) )).
