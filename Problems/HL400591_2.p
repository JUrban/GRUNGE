...
tff(conj_thm_2Epair_2Epair__case__cong,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f_27: $i] :
      ( mem(V0f_27,arr(A_27b,arr(A_27c,A_27a)))
     => ! [V1M: $i] :
          ( mem(V1M,ty_2Epair_2Eprod(A_27b,A_27b))
         => ! [V2M_27: $i] :
              ( mem(V2M_27,ty_2Epair_2Eprod(A_27b,A_27b))
             => ! [V3f: $i] :
                 ...
                 => ( ( V1M = V2M_27
                      & ! [V4x: $i] :
                         ...
                         => ! [V5y: $i] :
                              ( mem(V5y,A_27c)
                             => ( V2M_27 = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V4x),V5y)
                               => ap(ap(V3f,V4x),V5y) = ap(ap(V0f_27,V4x),V5y) ) ) ) )
                   => ap(ap(c_2Epair_2Epair__CASE(A_27a,A_27a,A_27a),V1M),V3f) = ap(ap(c_2Epair_2Epair__CASE(A_27a,A_27a,A_27a),V2M_27),V0f_27) ) ) ) ) ) )).
