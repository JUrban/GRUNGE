...
tff(conj_thm_2Efinite__map_2EFUPD11__SAME__UPDATE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ! [V3v: $i] :
                  ( mem(V3v,A_27b)
                 => ( ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f1),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2k),V3v)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1f2),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2k),V3v))
                  <=> ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f1),ap(c_2Epred__set_2ECOMPL(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2k),c_2Epred__set_2EEMPTY(A_27a)))) = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V1f2),ap(c_2Epred__set_2ECOMPL(A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2k),c_2Epred__set_2EEMPTY(A_27a)))) ) ) ) ) ) )).
