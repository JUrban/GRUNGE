...
thf(conj_thm_2Ereal_2EREAL__POS__INFLATE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Ereal_2Epos @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).
