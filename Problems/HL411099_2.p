...
tff(conj_thm_2Ereal__topology_2ECOMPACT__FRONTIER__BOUNDED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2Efrontier,V0s))) ) ) )).

tff(conj_thm_2Ereal__topology_2EBOUNDED__FRONTIER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Ereal__topology_2Efrontier,V0s))) ) ) )).
