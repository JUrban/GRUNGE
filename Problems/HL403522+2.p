...
fof(conj_thm_2Ewellorder_2EelsOf__fromNatWO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ap(c_2Ewellorder_2EelsOf(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Ewellorder_2EfromNatWO(A_27a),V0n)) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epred__set_2Ecount,V0n)) ) ) )).
