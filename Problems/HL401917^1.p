...
thf(f2550_0_2E0,type,(
    f2550_0_2E0: u )).

thf(f2550_0_2E1,type,(
    f2550_0_2E1: du > u )).
...
thf(mono_2Ef2550_0,type,(
    mono_2Ef2550_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Enumeral__bit_2ESFUNPOW__def,axiom,(
    ! [V4x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef2550_0 @ V4x )
    <=> ( V4x = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Enumeral__bit_2ESFUNPOW__def,axiom,
    ( ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral__bit_2ESFUNPOW @ V0f @ mono_2Ec_2Enum_2E0 @ V1x )
        = V1x )
    & ! [V2f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum,V4x: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumeral__bit_2ESFUNPOW @ V2f @ ( mono_2Ec_2Enum_2ESUC @ V3n ) @ V4x )
        = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef2550_0 @ V4x ) @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Enumeral__bit_2ESFUNPOW @ V2f @ V3n @ ( V2f @ V4x ) ) ) ) )).

thf(thm_2Enumeral__bit_2ENUMERAL__DIV__2EXP,conjecture,
    ( ! [V0n: mono_2Etyop_2Enum_2Enum] :
