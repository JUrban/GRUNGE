...
thf(thm_2Esptree_2Elookup__inter__alt,conjecture,(
    ! [A_27a: d,A_27b: d,V0x: mono_2Etyop_2Enum_2Enum,V1t2_2E0: u,V2t1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einter_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V1t2_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V0x @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27b ) @ V1t2_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2t1_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) )).
