...
tff(conj_thm_2Epred__set_2EINJ__CARD,lemma,(
...
tff(conj_thm_2Ecardinal_2Ecardleq__lteq,lemma,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( mem(V0s1,arr(A_27a,bool))
     => ! [V1s2: $i] :
          ( mem(V1s2,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARDEQ__CARD__EQN,lemma,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( mem(V0s1,arr(A_27a,bool))
     => ! [V1s2: $i] :
          ( mem(V1s2,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARDLEQ__CARD,conjecture,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( mem(V0s1,arr(A_27a,bool))
     => ! [V1s2: $i] :
          ( mem(V1s2,arr(A_27b,bool))
