...
tff(conj_thm_2Elist_2EUNZIP__ZIP,conjecture,(
    ! [A_27a: del,A_27b: del,V0l1: $i] :
     ...
     => ! [V1l2: $i] :
         ...
         => ( surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V0l1)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),V1l2))
           => ap(c_2Elist_2EUNZIP(A_27a,A_27a),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2))) = ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2) ) ) ) )).
