...
thf(thm_2EindexedLists_2EfupdLast__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( A_27a > A_27a ) > ( tyop_2Elist_2Elist @ A_27a ) > $o] :
      ( ( ! [V1f: A_27a > A_27a] :
            ( V0P @ V1f @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V2f: A_27a > A_27a,V3h: A_27a] :
            ( V0P @ V2f @ ( c_2Elist_2ECONS @ A_27a @ V3h @ ( c_2Elist_2ENIL @ A_27a ) ) )
     ...
     => ! [V8v: A_27a > A_27a,V9v1: tyop_2Elist_2Elist @ A_27a] :
          ( V0P @ V8v @ V9v1 ) ) )).
