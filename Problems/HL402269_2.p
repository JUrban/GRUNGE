...
tff(lamtp_f188,axiom,(
    ! [V0x: tp__ty_2Enum_2Enum] : mem(f188(V0x),arr(ty_2Enum_2Enum,bool)) )).
...
tff(lamtp_f189,axiom,(
    ! [V0x: tp__ty_2Enum_2Enum] : mem(f189(V0x),arr(ty_2Enum_2Enum,bool)) )).
...
tff(conj_thm_2Ewhile_2EOLEAST__EQNS,lemma,(
...
tff(conj_thm_2Ewhile_2EOLEAST__EQ__NONE,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ewhile_2EOLEAST__EQ__SOME,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
...
tff(mem_c_2Elist_2EsplitAtPki,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Elist_2EsplitAtPki(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,arr(A_27b,bool)),arr(arr(ty_2Elist_2Elist(A_27b),arr(ty_2Elist_2Elist(A_27b),A_27a)),arr(ty_2Elist_2Elist(A_27b),A_27a)))) )).
...
tff(conj_thm_2Elist_2ETAKE__nil,lemma,(
...
tff(conj_thm_2Elist_2ETAKE__cons,lemma,(
...
tff(conj_thm_2Elist_2ETAKE__0,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(lmtp_f439,type,(
    f439: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f439,axiom,(
...
tff(lmtp_f438,type,(
    f438: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f438,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V3k: $i] :
      ( mem(V3k,arr(ty_2Elist_2Elist(A_27b),arr(ty_2Elist_2Elist(A_27b),A_27a)))
     => ! [V4h: $i] :
          ( mem(V4h,A_27b)
...
tff(conj_thm_2Elist_2EsplitAtPki__EQN,conjecture,(
