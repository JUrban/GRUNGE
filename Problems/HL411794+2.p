...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__EQ__COFINITE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__FROM__ELSEWHERE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Ereal__topology_2Esummable,ap(c_2Ereal__topology_2Efrom,V1m)),V0f))
               => p(ap(ap(c_2Ereal__topology_2Esummable,ap(c_2Ereal__topology_2Efrom,V2n)),V0f)) ) ) ) ) )).
