...
tff(conj_thm_2Equotient_2EC__PRS,conjecture,(
                                         ...
                                         => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27c,A_27c),V6R3),V7abs3),V8rep3))
                                           => ! [V9f: $i] :
                                               ...
                                               => ! [V10x: $i] :
                                                   ...
                                                   => ! [V11y: $i] :
                                                        ( mem(V11y,A_27d)
                                                       => ap(ap(ap(c_2Ecombin_2EC(A_27d,A_27d,A_27d),V9f),V10x),V11y) = ap(V7abs3,ap(ap(ap(c_2Ecombin_2EC(A_27a,A_27a,A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),ap(ap(c_2Equotient_2E_2D_2D_3E(A_27b,A_27b,A_27b,A_27b),V4abs2),V8rep3)),V9f)),ap(V5rep2,V10x)),ap(V2rep1,V11y))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
