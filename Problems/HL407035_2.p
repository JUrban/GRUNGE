...
tff(conj_thm_2Eint__bitwise_2Ebits__bitwise__ind,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27b,arr(A_27c,A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),bool))))
     => ( ( ! [V1f: $i] :
             ...
             => ! [V2r1: $i] :
                 ...
                 => ! [V3r2: $i] :
                      ( mem(V3r2,A_27c)
                     => p(ap(ap(ap(V0P,V1f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),c_2Elist_2ENIL(A_27b)),V2r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),c_2Elist_2ENIL(A_27c)),V3r2))) ) ) )
          & ! [V4f: $i] :
             ...
             => ! [V5r1: $i] :
                 ...
                 => ! [V6b2: $i] :
                     ...
                     => ! [V7bs2: $i] :
                         ...
                         => ! [V8r2: $i] :
                              ( mem(V8r2,A_27c)
                             => ( p(ap(ap(ap(V0P,V4f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),c_2Elist_2ENIL(A_27b)),V5r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),V7bs2),V8r2)))
                               => p(ap(ap(ap(V0P,V4f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),c_2Elist_2ENIL(A_27b)),V5r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),ap(ap(c_2Elist_2ECONS(A_27c),V6b2),V7bs2)),V8r2))) ) ) ) ) ) )
          & ! [V9f: $i] :
             ...
             => ! [V10b1: $i] :
                 ...
                 => ! [V11bs1: $i] :
                     ...
                     => ! [V12r1: $i] :
                         ...
                         => ! [V13r2: $i] :
                              ( mem(V13r2,A_27c)
                             => ( p(ap(ap(ap(V0P,V9f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),V11bs1),V12r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),c_2Elist_2ENIL(A_27c)),V13r2)))
                               => p(ap(ap(ap(V0P,V9f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),ap(ap(c_2Elist_2ECONS(A_27b),V10b1),V11bs1)),V12r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),c_2Elist_2ENIL(A_27c)),V13r2))) ) ) ) ) ) )
          & ! [V14f: $i] :
                     ...
                     => ! [V17r1: $i] :
                         ...
                         => ! [V18b2: $i] :
                             ...
                             => ! [V19bs2: $i] :
                                 ...
                                 => ! [V20r2: $i] :
                                      ( mem(V20r2,A_27c)
                                     => ( p(ap(ap(ap(V0P,V14f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),V16bs1),V17r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),V19bs2),V20r2)))
                                       => p(ap(ap(ap(V0P,V14f),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),ap(ap(c_2Elist_2ECONS(A_27b),V15b1),V16bs1)),V17r1)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),ap(ap(c_2Elist_2ECONS(A_27c),V18b2),V19bs2)),V20r2))) ) ) ) ) ) ) ) ) )
       => ! [V21v: $i] :
           ...
           => ! [V22v1: $i] :
               ...
               => ! [V23v2: $i] :
                   ...
                   => ! [V24v3: $i] :
                       ...
                       => ! [V25v4: $i] :
                            ( mem(V25v4,A_27c)
                           => p(ap(ap(ap(V0P,V21v),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),V22v1),V23v2)),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27c),ty_2Elist_2Elist(A_27c)),V24v3),V25v4))) ) ) ) ) ) ) ) )).
