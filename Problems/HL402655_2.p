...
tff(mem_c_2Ecombin_2ELEFT__ID,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ecombin_2ELEFT__ID(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,A_27b)),arr(A_27a,bool))) )).

tff(conj_thm_2Ecombin_2EFCOMM__ASSOC,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Erich__list_2EFCOMM__FOLDR__APPEND,lemma,(
    ! [A_27a: del,A_27b: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,A_27a)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,arr(A_27a,A_27a)))
         => ( p(ap(ap(c_2Ecombin_2EFCOMM(A_27a,A_27a,A_27a),V0g),V1f))
           => ! [V2e: $i] :
                ( mem(V2e,A_27a)
               => ( p(ap(ap(c_2Ecombin_2ELEFT__ID(A_27a,A_27a),V0g),V2e))
                 => ! [V3l1: $i] :
                     ...
                     => ! [V4l2: $i] :
                         ...
                         => ap(ap(ap(c_2Elist_2EFOLDR(A_27b,A_27b),V1f),V2e),ap(ap(c_2Elist_2EAPPEND(A_27b),V3l1),V4l2)) = ap(ap(V0g,ap(ap(ap(c_2Elist_2EFOLDR(A_27b,A_27b),V1f),V2e),V3l1)),ap(ap(ap(c_2Elist_2EFOLDR(A_27b,A_27b),V1f),V2e),V4l2)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Erich__list_2EASSOC__FOLDR__FLAT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27a,A_27a)))
     => ( p(ap(c_2Ecombin_2EASSOC(A_27a),V0f))
       => ! [V1e: $i] :
           ...
           => ( p(ap(ap(c_2Ecombin_2ELEFT__ID(A_27a,A_27a),V0f),V1e))
             => ! [V2l: $i] :
                 ...
                 => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e),ap(c_2Elist_2EFLAT(A_27a),V2l)) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e),ap(ap(c_2Elist_2EMAP(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e)),V2l)) ) ) ) ) ) )).
