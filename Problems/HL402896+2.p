...
fof(conj_thm_2Erich__list_2Etake__drop__partition,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1m),V0n))
                   => ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2ETAKE(A_27a),V1m),V2l)),ap(ap(c_2Elist_2ETAKE(A_27a),ap(ap(c_2Earithmetic_2E_2D,V0n),V1m)),ap(ap(c_2Elist_2EDROP(A_27a),V1m),V2l))) = ap(ap(c_2Elist_2ETAKE(A_27a),V0n),V2l) ) ) ) ) ) )).
