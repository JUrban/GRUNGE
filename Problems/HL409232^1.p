...
thf(thm_2Ebool_2EMONO__ALL,axiom,(
    ! [A_27a: d,V0Q_2E0: u,V1P_2E0: u] :
     ...
     => ( ! [V3x_2E0: u] :
       ...
       => ! [V4x_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0Q_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eintegral_2EDINT__WRONG,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1b @ V0a )
     => ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ V2f @ V3i ) ) )).
...
thf(thm_2Etransc_2EDIVISION__LBOUND,axiom,(
    ! [V0D: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ! [V3r: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ ( V0D @ V3r ) ) ) )).

thf(thm_2Etransc_2EDIVISION__UBOUND,axiom,(
    ! [V0D: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Etransc_2Edivision @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1a @ V2b ) @ V0D )
     => ! [V3r: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0D @ V3r ) @ V2b ) ) )).

thf(thm_2Eintegral_2EINTEGRAL__EQ,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2a: mono_2Etyop_2Erealax_2Ereal,V3b: mono_2Etyop_2Erealax_2Ereal,V4i: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V2a @ V3b ) @ V0f @ V4i )
        & ! [V5x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V2a @ V5x )
              & ( mono_2Ec_2Ereal_2Ereal__lte @ V5x @ V3b ) )
           => ( ( V0f @ V5x )
              = ( V1g @ V5x ) ) ) )
     => ( mono_2Ec_2Etransc_2EDint @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V2a @ V3b ) @ V1g @ V4i ) ) )).
