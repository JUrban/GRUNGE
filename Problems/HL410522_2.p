...
tff(lamtp_f3360,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3360(A_27a,V0f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3360,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f3360(A_27a,V0f),V2x) = ap(c_2Erealax_2Ereal__neg,ap(V0f,V2x)) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__NEG,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3360(A_27a,V0f))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Eiterate_2ESum(A_27a),V1s),V0f))) ) ) )).
...
tff(conj_thm_2Eiterate_2ESUM__DELETE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lamtp_f3667,axiom,(
    ! [V3u: $i] :
      ( mem(V3u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3667(V3u),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3667,axiom,(
    ! [V3u: $i] :
      ( mem(V3u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V4v: tp__ty_2Erealax_2Ereal] : ap(f3667(V3u),inj__ty_2Erealax_2Ereal(V4v)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V3u,inj__ty_2Erealax_2Ereal(V4v))),inj__ty_2Erealax_2Ereal(V4v)) ) )).

tff(lmtp_f3666,type,(
    f3666: ( $i * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3666,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1y: tp__ty_2Erealax_2Ereal,V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3666(V0p,V1y,V2s),arr(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),bool)) ) ) )).
...
tff(lameq_f3666,axiom,(
    ! [V0p: $i] :
     ...
     => ! [V1y: tp__ty_2Erealax_2Ereal,V2s: $i] :
         ...
         => ! [V3u: $i] :
              ( mem(V3u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             => ap(f3666(V0p,V1y,V2s),V3u) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V2s)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2s),V0p)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Erealax_2Ereal),V2s),f3667(V3u))),inj__ty_2Erealax_2Ereal(V1y)))) ) ) ) )).

tff(lmtp_f3665,type,(
    f3665: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3665,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal,V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3665(V1y,V0p),arr(arr(ty_2Erealax_2Ereal,bool),bool)) ) )).
...
tff(lameq_f3665,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal,V0p: $i] :
     ...
     => ! [V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3665(V1y,V0p),V2s) = ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),f3666(V0p,V1y,V2s)) ) ) )).

tff(lmtp_f3664,type,(
    f3664: $i > $i )).

tff(lamtp_f3664,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3664(V0p),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3664,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1y: tp__ty_2Erealax_2Ereal] : ap(f3664(V0p),inj__ty_2Erealax_2Ereal(V1y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1y)),ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3665(V1y,V0p))) ) )).

tff(conj_thm_2Ereal__topology_2ESPAN__EXPLICIT,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Ereal__topology_2Espan,V0p) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3664(V0p)) ) )).

tff(lmtp_f3668,type,(
    f3668: $i > $i )).

tff(lamtp_f3668,axiom,(
    ! [V2u: $i] :
      ( mem(V2u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3668(V2u),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3668,axiom,(
    ! [V2u: $i] :
      ( mem(V2u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V4v: tp__ty_2Erealax_2Ereal] : ap(f3668(V2u),inj__ty_2Erealax_2Ereal(V4v)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2u,inj__ty_2Erealax_2Ereal(V4v))),inj__ty_2Erealax_2Ereal(V4v)) ) )).

tff(conj_thm_2Ereal__topology_2EDEPENDENT__EXPLICIT,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Edependent,V0p))
      <=> ? [V1s: $i] :
            ...
            & ? [V2u: $i] :
                ...
                & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Erealax_2Ereal),V1s),f3668(V2u))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) )).
