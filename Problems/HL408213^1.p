...
thf(f9695_0_2E0,type,(
    f9695_0_2E0: u )).

thf(f9695_0_2E3,type,(
    f9695_0_2E3: du > du > du > u )).

thf(f9695_0_2E4,type,(
    f9695_0_2E4: du > du > du > du > u )).

thf(f9695_1_2E0,type,(
    f9695_1_2E0: u )).

thf(f9695_1_2E3,type,(
    f9695_1_2E3: du > du > du > u )).

thf(f9695_1_2E4,type,(
    f9695_1_2E4: du > du > du > du > u )).
...
thf(mono_2Ef9695_0,type,(
    mono_2Ef9695_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9695_1,type,(
    mono_2Ef9695_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Epowser_2EPOWDIFF__LEMMA,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal,V0n: mono_2Etyop_2Enum_2Enum,V3p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9695_0 @ V1x @ V2y @ V0n @ V3p )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Epow @ V1x @ V3p ) @ ( mono_2Ec_2Ereal_2Epow @ V2y @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ V3p ) ) ) ) )).

thf(def1_2Ethm_2Epowser_2EPOWDIFF__LEMMA,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal,V0n: mono_2Etyop_2Enum_2Enum,V4p: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9695_1 @ V1x @ V2y @ V0n @ V4p )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Epow @ V1x @ V4p ) @ ( mono_2Ec_2Ereal_2Epow @ V2y @ ( mono_2Ec_2Earithmetic_2E_2D @ V0n @ V4p ) ) ) ) )).

thf(thm_2Epowser_2EPOWDIFF__LEMMA,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) @ ( mono_2Ef9695_0 @ V1x @ V2y @ V0n ) )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V2y @ ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Enum_2ESUC @ V0n ) ) @ ( mono_2Ef9695_1 @ V1x @ V2y @ V0n ) ) ) ) )).
