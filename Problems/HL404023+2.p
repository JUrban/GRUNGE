...
fof(conj_thm_2Equotient_2ECOND__PRS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => ! [V3a] :
                           ...
                           => ! [V4b] :
                               ...
                               => ! [V5c] :
                                    ( mem(V5c,A_27b)
                                   => ap(ap(ap(c_2Ebool_2ECOND(A_27b),V3a),V4b),V5c) = ap(V1abs,ap(ap(ap(c_2Ebool_2ECOND(A_27a),V3a),ap(V2rep,V4b)),ap(V2rep,V5c))) ) ) ) ) ) ) ) ) ) )).
