...
thf(thm_2Ebool_2ESWAP__FORALL__THM,axiom,(
    ...
    <=> ! [V3y_2E0: u,V4x_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0P_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) @ ( s @ A_27b @ V3y_2E0 ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESPAN__INDUCT__ALT,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1h: mono_2Etyop_2Erealax_2Ereal > $o] :
