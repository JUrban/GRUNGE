...
thf(thm_2Elogroot_2ELOG__MULT,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Elogroot_2ELOG @ V0b @ ( mono_2Ec_2Earithmetic_2E_2A @ V0b @ V1x ) )
        = ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Elogroot_2ELOG @ V0b @ V1x ) ) ) ) )).
