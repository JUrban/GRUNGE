...
tff(conj_thm_2Efcp_2EFCP__UPDATE__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
     ...
     => ! [V1a: tp__ty_2Enum_2Enum,V2b: $i] :
         ...
         => ! [V3c: $i] :
              ( mem(V3c,A_27a)
             => ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),V3c),ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),V2b),V0m)) = ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),inj__ty_2Enum_2Enum(V1a)),V3c),V0m) ) ) ) )).
