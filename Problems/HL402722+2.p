...
fof(conj_thm_2Erich__list_2EFCOMM__FOLDL__FLAT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                   ...
                   => ! [V2e] :
                       ...
                       => ( p(ap(ap(c_2Ecombin_2ERIGHT__ID(A_27a,A_27a),V1g),V2e))
                         => ! [V3l] :
                             ...
                             => ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V2e),ap(c_2Elist_2EFLAT(A_27b),V3l)) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),V1g),V2e),ap(ap(c_2Elist_2EMAP(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)),ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V2e)),V3l)) ) ) ) ) ) ) ) ) )).
