...
thf(thm_2Eiterate_2EITERATE__EXPAND__CASES,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27a > A_27a > A_27a,V1f: A_27b > A_27a,V2s: A_27b > $o] :
      ...
      = ( c_2Ebool_2ECOND @ A_27a @ ( c_2Epred__set_2EFINITE @ A_27b @ ( c_2Eiterate_2Esupport @ A_27b @ A_27a @ V0op @ V1f @ V2s ) ) @ ( c_2Eiterate_2Eiterate @ A_27b @ A_27a @ V0op @ ( c_2Eiterate_2Esupport @ A_27b @ A_27a @ V0op @ V1f @ V2s ) @ V1f ) @ ( c_2Eiterate_2Eneutral @ A_27a @ V0op ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__CLOSED,conjecture,(
