...
fof(conj_thm_2Elist_2ELIST__REL__CONS1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1h] :
                 ...
                 => ! [V2t] :
                     ...
                     => ! [V3xs] :
                         ...
                         => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2ECONS(A_27a),V1h),V2t)),V3xs))
                          <=> ? [V4h_27] :
                                ( mem(V4h_27,A_27b)
                                & ? [V5t_27] :
                                    ...
                                    & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V2t),V5t_27)) ) ) ) ) ) ) ) ) ) )).
...
fof(mem_c_2Efinite__map_2Efmap__rel,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),arr(arr(A_27a,arr(A_27b,bool)),arr(ty_2Efinite__map_2Efmap(A_27c,A_27c),arr(ty_2Efinite__map_2Efmap(A_27c,A_27c),bool)))) ) ) ) )).
...
fof(conj_thm_2Efinite__map_2Efmap__rel__FUPDATE__same,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0R] :
                  ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
                 => ! [V1f1] :
                      ( mem(V1f1,ty_2Efinite__map_2Efmap(A_27c,A_27c))
                     => ! [V2f2] :
                          ( mem(V2f2,ty_2Efinite__map_2Efmap(A_27c,A_27c))
                         => ! [V3v1] :
                              ( mem(V3v1,A_27a)
                             => ! [V4v2] :
                                  ( mem(V4v2,A_27b)
                                 => ! [V5k] :
                                      ( mem(V5k,A_27c)
                                     => ( ( p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),V1f1),V2f2))
                                          & p(ap(ap(V0R,V3v1),V4v2)) )
                                       => p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),ap(ap(c_2Efinite__map_2EFUPDATE(A_27c,A_27c),V1f1),ap(ap(c_2Epair_2E_2C(A_27c,A_27c),V5k),V3v1))),ap(ap(c_2Efinite__map_2EFUPDATE(A_27c,A_27c),V2f2),ap(ap(c_2Epair_2E_2C(A_27c,A_27c),V5k),V4v2)))) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Efinite__map_2Efmap__rel__FUPDATE__LIST__same,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0R] :
                  ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
                 => ! [V1ls1] :
                      ( mem(V1ls1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27c,A_27c)))
                     => ! [V2ls2] :
                          ( mem(V2ls2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27c,A_27c)))
                         => ! [V3f1] :
                              ( mem(V3f1,ty_2Efinite__map_2Efmap(A_27c,A_27c))
                             => ! [V4f2] :
                                  ( mem(V4f2,ty_2Efinite__map_2Efmap(A_27c,A_27c))
                                 => ( ( p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),V3f1),V4f2))
                                      & ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c)),c_2Epair_2EFST(A_27c,A_27c)),V1ls1) = ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c)),c_2Epair_2EFST(A_27c,A_27c)),V2ls2)
                                      & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c)),c_2Epair_2ESND(A_27c,A_27c)),V1ls1)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c)),c_2Epair_2ESND(A_27c,A_27c)),V2ls2))) )
                                   => p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27c,A_27c),V3f1),V1ls1)),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27c,A_27c),V4f2),V2ls2))) ) ) ) ) ) ) ) ) ) )).
