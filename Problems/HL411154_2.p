...
tff(conj_thm_2Ereal__topology_2ECONTRACTION__IMP__CONTINUOUS__ON,conjecture,(
    ! [V0s: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ! [V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V1f,inj__ty_2Erealax_2Ereal(V2x))),ap(V1f,inj__ty_2Erealax_2Ereal(V3y))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V3y))))) )
