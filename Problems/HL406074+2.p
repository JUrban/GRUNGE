...
fof(conj_thm_2Earithmetic_2ENOT__GREATER,lemma,(
    ! [V0m] :
...
fof(lamtp_f2207,axiom,(
    ! [V3z] :
      ( mem(V3z,bool)
     => mem(f2207(V3z),arr(bool,arr(bool,bool))) ) )).
...
fof(lameq_f2207,axiom,(
    ! [V3z] :
     ...
     => ! [V4c] :
          ( mem(V4c,bool)
         => ap(f2207(V3z),V4c) = k(bool,ap(ap(c_2Ebool_2E_2F_5C,V4c),ap(c_2Ebool_2E_7E,V3z))) ) ) )).

fof(lamtp_f2206,axiom,(
    mem(f2206,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2206,axiom,(
    ! [V3z] :
      ( mem(V3z,bool)
     => ap(f2206,V3z) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2207(V3z)) ) )).
...
fof(conj_thm_2Ewords_2EWORD__HI,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
