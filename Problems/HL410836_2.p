...
tff(lmtp_f3723,type,(
    f3723: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f3723,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum] : mem(f3723(V0m),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f3723,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] : ap(f3723(V0m),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)) )).

tff(lmtp_f3722,type,(
    f3722: $i )).

tff(lamtp_f3722,axiom,(
    mem(f3722,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool))) )).

tff(lameq_f3722,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum] : ap(f3722,inj__ty_2Enum_2Enum(V0m)) = f3723(V0m) )).

tff(ax_thm_2Ereal__topology_2Esequentially,axiom,(
    surj__c_ty_2Ereal__topology_2Enet_ty_2Enum_2Enum(c_2Ereal__topology_2Esequentially) = surj__c_ty_2Ereal__topology_2Enet_ty_2Enum_2Enum(ap(c_2Ereal__topology_2Emk__net(ty_2Enum_2Enum),f3722)) )).

tff(conj_thm_2Ereal__topology_2ESEQUENTIALLY,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
