...
thf(conj_thm_2Eordinal_2Eordlt__trichotomy,lemma,(
    ! [A_27a: del,V0w2: $i] :
...
thf(conj_thm_2Eordinal_2EfromNat__eq__omega,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Eordinal_2EleqLEFT__CANCEL,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2EordADD__continuous,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1s: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardleq @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ V1s ) @ ( c_2Epred__set_2EUNIV @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) ) )
              & ( V1s
               != ( c_2Epred__set_2EEMPTY @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) )
           => ( ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ V1s ) )
              = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) ) @ V1s ) ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2EordADD__ASSOC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
         ...
         => ! [V2c: $i] :
              ( ( mem @ V2c @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V1b ) @ V2c ) )
                = ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ V1b ) ) @ V2c ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EordMULT__0L,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0a )
        = ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EordMULT__LDISTRIB,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ! [V2c: $i] :
              ( ( mem @ V2c @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V2c ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ V1b ) )
                = ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V2c ) @ V0a ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V2c ) @ V1b ) ) ) ) ) ) )).
...
thf(conj_thm_2EordNotationSemantics_2EaddL__disappears,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V1a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0e ) ) )
           => ( ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V1a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0e ) )
              = ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0e ) ) ) ) ) )).
