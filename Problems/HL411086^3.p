...
thf(thm_2Ereal__topology_2EBOUNDED__BIGINTER,axiom,(
    ! [V0f: ( tyop_2Erealax_2Ereal > $o ) > $o] :
     ...
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ V0f ) ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPACT__BIGINTER,conjecture,(
    ! [V0f: ( tyop_2Erealax_2Ereal > $o ) > $o] :
     ...
     => ( c_2Ereal__topology_2Ecompact @ ( c_2Epred__set_2EBIGINTER @ tyop_2Erealax_2Ereal @ V0f ) ) ) )).
