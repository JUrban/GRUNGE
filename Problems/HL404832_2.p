...
tff(conj_thm_2Efinite__map_2EFLOOKUP__UPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
     ...
     => ! [V1k1: $i] :
         ...
         => ! [V2v: $i] :
             ...
             => ! [V3k2: $i] :
                  ( mem(V3k2,A_27b)
                 => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE(A_27b,A_27b),V0fm),ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V1k1),V2v))),V3k2) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(A_27b),V1k1),V3k2)),ap(c_2Eoption_2ESOME(A_27a),V2v)),ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),V0fm),V3k2)) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFRANGE__FLOOKUP,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),V1f)))
          <=> ? [V2k: $i] :
                ( mem(V2k,A_27b)
                & ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),V1f),V2k) = ap(c_2Eoption_2ESOME(A_27a),V0v) ) ) ) ) )).
...
tff(conj_thm_2Efinite__map_2EFRANGE__FUPDATE__LIST__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
     ...
     => ! [V1fm: $i] :
         ...
         => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V1fm),V0ls))),ap(ap(c_2Epred__set_2EUNION(A_27b),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V1fm)),ap(c_2Elist_2ELIST__TO__SET(A_27b),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2ESND(A_27a,A_27a)),V0ls))))) ) ) )).
