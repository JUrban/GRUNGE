...
tff(lamtp_f208,axiom,(
    ! [A_27a: del,V0m: tp__ty_2Enum_2Enum] : mem(f208(A_27a,V0m),arr(ty_2Enum_2Enum,arr(A_27a,bool))) )).
...
tff(conj_thm_2Eind__type_2EINJN__INJ,conjecture,(
