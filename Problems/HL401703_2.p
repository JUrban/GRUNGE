...
tff(conj_thm_2Epred__set_2EDIFF__DIFF__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Epred__set_2EBIGINTER__SUBSET,lemma,(
    ! [A_27a: del,V0sp: $i] :
...
tff(conj_thm_2Epred__set_2EDIFF__BIGINTER1,lemma,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Epred__set_2EDIFF__BIGINTER,conjecture,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(arr(A_27a,bool),bool))
