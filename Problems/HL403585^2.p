...
thf(conj_thm_2Ewellorder_2EZL__SUBSETS,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ewellorder_2EZL__SUBSETS__BIGUNION__NONEMPTY,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ( ( ? [V1x: $i] :
          ...
          & ! [V2c: $i] :
             ...
             => ( ( ? [V3x: $i] :
                      ( ( mem @ V3x @ ( arr @ A_27a @ bool ) )
                      & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V3x ) @ V2c ) ) )
                  & ! [V4x: $i] :
                      ( ( mem @ V4x @ ( arr @ A_27a @ bool ) )
                     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V4x ) @ V2c ) )
                       => ( p @ ( ap @ V0P @ V4x ) ) ) )
                  & ! [V5x: $i] :
                      ( ( mem @ V5x @ ( arr @ A_27a @ bool ) )
                     => ! [V6y: $i] :
                          ( ( mem @ V6y @ ( arr @ A_27a @ bool ) )
                         => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V5x ) @ V2c ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V6y ) @ V2c ) ) )
                           => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V5x ) @ V6y ) )
                              | ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V6y ) @ V5x ) ) ) ) ) ) )
               => ( p @ ( ap @ V0P @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ V2c ) ) ) ) ) )
       => ? [V7a: $i] :
            ( ( mem @ V7a @ ( arr @ A_27a @ bool ) )
            & ( p @ ( ap @ V0P @ V7a ) )
            & ! [V8x: $i] :
