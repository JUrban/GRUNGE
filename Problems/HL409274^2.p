...
thf(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__LEFT,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__RIGHT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) )
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
