...
thf(thm_2Ebit_2EBIT__MODIFY__def,axiom,
    ( ! [V0f: tyop_2Enum_2Enum > $o > $o,V1x: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBIT__MODIFY @ c_2Enum_2E0 @ V0f @ V1x )
        = c_2Enum_2E0 )
    & ! [V2n: tyop_2Enum_2Enum,V3f: tyop_2Enum_2Enum > $o > $o,V4x: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBIT__MODIFY @ ( c_2Enum_2ESUC @ V2n ) @ V3f @ V4x )
        = ( c_2Earithmetic_2E_2B @ ( c_2Ebit_2EBIT__MODIFY @ V2n @ V3f @ V4x ) @ ( c_2Ebit_2ESBIT @ ( V3f @ V2n @ ( c_2Ebit_2EBIT @ V2n @ V4x ) ) @ V2n ) ) ) )).
...
thf(thm_2Ebit_2EBIT__MODIFY__THM,conjecture,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2f: tyop_2Enum_2Enum > $o > $o,V3a: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0x @ V1n )
     => ( ( c_2Ebit_2EBIT @ V0x @ ( c_2Ebit_2EBIT__MODIFY @ V1n @ V2f @ V3a ) )
        = ( V2f @ V0x @ ( c_2Ebit_2EBIT @ V0x @ V3a ) ) ) ) )).
