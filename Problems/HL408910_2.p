...
tff(conj_thm_2Ewords_2EWORD__ADD__BIT0,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
         => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
          <=> ~ ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
              <=> p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) )).

tff(conj_thm_2EHolSmt_2Et034,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
         => ( ap(ap(c_2Ewords_2Eword__add(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V0x) = V1y
           => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0x),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
             => ~ p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1y),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) )).
