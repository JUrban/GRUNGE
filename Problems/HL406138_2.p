...
tff(conj_thm_2Ewords_2EWORD__LOWER__OR__EQ,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Ewords_2EWORD__LOWER__EQ__REFL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__LESS__NEG__LEFT,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__ADD__LEFT__LO2,conjecture,(
    ! [A_27a: del,V0c: $i] :
