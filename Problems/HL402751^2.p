...
thf(conj_thm_2Elist_2EFLAT__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
thf(conj_thm_2Erich__list_2EFLAT__FLAT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
     => ( ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ ( ap @ ( c_2Elist_2EFLAT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0l ) )
        = ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2EFLAT @ A_27a ) ) @ V0l ) ) ) ) )).
