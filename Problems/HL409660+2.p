...
fof(lamtp_f3284,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f3284(V0n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).
...
fof(lameq_f3284,axiom,(
    ! [V0n] :
     ...
     => ! [V1x] :
         ...
         => ap(f3284(V0n),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1x),ap(ap(c_2Eprim__rec_2E_3C,V1x),V0n)) ) ) )).

fof(conj_thm_2Eiterate_2ENUMSEG__LT,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3284(V0n)) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Enum_2Enum,bool)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0n),c_2Enum_2E0)),c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) )).
