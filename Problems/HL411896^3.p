...
thf(thm_2Eiterate_2EREAL__LE__SUP,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2b: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3y @ V0s )
        & ( c_2Ereal_2Ereal__lte @ V1a @ V3y )
        & ! [V4x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ V4x @ V2b ) ) )
     => ( c_2Ereal_2Ereal__lte @ V1a @ ( c_2Ereal_2Esup @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EREAL__LE__HAUSDIST,conjecture,(
