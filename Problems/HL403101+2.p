...
fof(lameq_f907,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f907(V0a,V1b),V2t0) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),f897(V0a,V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESWHEN__AS__BEFORE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
