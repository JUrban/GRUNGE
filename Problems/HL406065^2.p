...
thf(conj_thm_2Ebit_2EBITS__ZERO2,lemma,(
    ! [V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( inj__ty_2Enum_2Enum @ V1l ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      = fo__c_2Enum_2E0 ) )).
                            ...
                            @ ^ [V3z: $i] :
                                ...
                                @ ( lam @ bool
                                  @ ^ [V4c: $i] :
                                      ( lam @ bool
                                      @ ^ [V5v: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ V3z ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ V2n ) @ V5v ) ) ) ) ) ) ) ) ) )
                @ ( ap @ ( ap @ ( c_2Ewords_2Enzcv @ A_27a ) @ V0a ) @ V1b ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2EWORD__EQ__SUB__RADD,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( ( mem @ V0v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EWORD__NEG__SUB,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1v: $i] :
...
thf(conj_thm_2Ewords_2ETWO__COMP__POS__NEG,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( ( V0a
           != ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
...
thf(conj_thm_2Ewords_2EWORD__0__POS,lemma,(
    ! [A_27a: del] :
      ~ ( p @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__GREATER,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
