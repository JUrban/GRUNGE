...
thf(conj_thm_2Ecombin_2Eo__ABS__L,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27c ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27b @ A_27a ) )
         => ( ( ap
              @ ( ap @ ( c_2Ecombin_2Eo @ A_27b @ A_27c @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V2x: $i] :
                      ( ap @ V0f @ V2x ) ) )
              @ V1g )
...
thf(conj_thm_2Ellist_2Ellist__rep__LCONS,lemma,(
    ! [A_27a: del,V0h: $i] :
      ( ( mem @ V0h @ A_27a )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ap @ ( c_2Ellist_2Ellist__rep @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V0h ) @ V1t ) )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V2n: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V2n ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V0h ) ) @ ( ap @ ( ap @ ( c_2Ellist_2Ellist__rep @ A_27a ) @ V1t ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V2n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ellist_2Ellist__rep__LNIL,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Ellist_2Ellist__rep @ A_27a ) @ ( c_2Ellist_2ELNIL @ A_27a ) )
      = ( lam @ ty_2Enum_2Enum
        @ ^ [V0n: $i] :
...
thf(conj_thm_2Ellist_2ELTL__HD__TL,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V0ll )
        = ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Epair_2EFST @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V0ll ) ) ) ) )).

thf(conj_thm_2Ellist_2ELTL__HD__11,lemma,(
    ! [A_27a: del,V0ll1: $i] :
      ( ( mem @ V0ll1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1ll2: $i] :
          ( ( mem @ V1ll2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V0ll1 )
              = ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V1ll2 ) )
           => ( V0ll1 = V1ll2 ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELTL__HD__LUNFOLD,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(ax_thm_2Ellist_2ELGENLIST__def,axiom,(
    ! [A_27a: del] :
      ( ! [V0f: $i] :
          ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V0f ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) )
            = ( ap
              @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V1n: $i] :
                      ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V1n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ V0f @ V1n ) ) ) ) )
              @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
      & ! [V2f: $i] :
          ( ( mem @ V2f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
         => ! [V3lim: tp__ty_2Enum_2Enum] :
              ( ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V2f ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V3lim ) ) )
              = ( ap
                @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4n: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V4n ) @ ( inj__ty_2Enum_2Enum @ V3lim ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V4n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ V2f @ V4n ) ) ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) ) ) )
                @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )).

thf(conj_thm_2Ellist_2ELTL__HD__LTL__LHD,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2ELTL__HD @ A_27a ) @ V0l )
        = ( ap @ ( ap @ ( c_2Eoption_2EOPTION__BIND @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ A_27a ) @ ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ V0l ) )
          @ ( lam @ A_27a
            @ ^ [V1h: $i] :
                ( ap @ ( ap @ ( c_2Eoption_2EOPTION__BIND @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V0l ) )
                @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
                  @ ^ [V2t: $i] :
                      ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27a ) @ V2t ) @ V1h ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELNTH__LGENLIST,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ! [V2lim: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V1f ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V2lim ) ) )
          = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ty_2Enum_2Enum @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V2lim ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V3lim0: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V3lim0 ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ ( c_2Eoption_2ENONE @ A_27a ) ) ) ) ) ) )).
