...
thf(conj_thm_2Eseq_2ESEQ__SUBLE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ c_2Eseq_2Esubseq @ V0f ) )
       => ! [V1n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) )).

thf(conj_thm_2Eseq_2ESEQ__DIRECT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ c_2Eseq_2Esubseq @ V0f ) )
