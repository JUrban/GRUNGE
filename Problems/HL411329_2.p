...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CONSTANT__ON__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),ap(c_2Ereal__topology_2Eclosure,V1s)))
                & ! [V3x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V3x))) = V2a ) )
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AGREE__ON__CLOSURE,conjecture,(
    ! [V0s: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1g),ap(c_2Ereal__topology_2Eclosure,V0s)))
                  ...
                  & ! [V3x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) = surj__ty_2Erealax_2Ereal(ap(V2h,inj__ty_2Erealax_2Ereal(V3x))) ) )
               => ! [V4x: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(c_2Ereal__topology_2Eclosure,V0s)))
                   => surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V4x))) = surj__ty_2Erealax_2Ereal(ap(V2h,inj__ty_2Erealax_2Ereal(V4x))) ) ) ) ) ) )).
