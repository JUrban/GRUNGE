...
tff(conj_thm_2Eprobability_2EADDITIVE__PROB,lemma,(
    ! [A_27a: del,V0p: $i] :
      ...
      <=> ! [V1s: $i] :
           ...
           => ! [V2t: $i] :
               ...
               => ( ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                 ...
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),V2t))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t))) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__SPACE__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => p(ap(c_2Emeasure_2Eadditive(A_27a),V0p)) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__ADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
