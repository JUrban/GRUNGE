...
thf(thm_2Ereal_2EREAL__LE__SQUARE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0x @ V0x ) ) )).
...
thf(thm_2Etransc_2EROOT__POW__POS,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Etransc_2Eroot @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ V1x ) @ ( mono_2Ec_2Enum_2ESUC @ V0n ) )
        = V1x ) ) )).

thf(thm_2Etransc_2EROOT__POS,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V1x )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Etransc_2Eroot @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ V1x ) ) ) )).

thf(thm_2Etransc_2ESQRT__0,axiom,
    ( ( mono_2Ec_2Etransc_2Esqrt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
    = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Etransc_2ESQRT__EQ,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( ( mono_2Ec_2Ereal_2Epow @ V0x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
          = V1y )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x ) )
     => ( V0x
        = ( mono_2Ec_2Etransc_2Esqrt @ V1y ) ) ) )).
