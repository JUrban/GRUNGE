...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__EVENTUALLY,lemma,(
    ! [A_27a: del,V0net: $i] :
                  ...
                  ( ( ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V4x ) ) @ ( ap @ V2g @ V4x ) ) ) )
                        @ V0net ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__CASES__FINITE__SEQUENTIALLY,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1f: $i] :
