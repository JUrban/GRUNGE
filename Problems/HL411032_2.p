...
tff(conj_thm_2Ereal_2EREAL__MIN__LT,lemma,(
...
tff(conj_thm_2Ereal__topology_2EBOUNDED__HAS__INF,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EINF__INSERT,conjecture,(
