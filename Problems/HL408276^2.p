...
thf(conj_thm_2Etransc_2EROOT__LT__LEMMA,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ c_2Etransc_2Eexp @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
        = V1x ) ) )).
...
thf(conj_thm_2Etransc_2EROOT__POW__POS,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
