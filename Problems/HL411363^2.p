...
thf(conj_thm_2Ereal__topology_2EOPEN__SUMS,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOWER__HEMICONTINUOUS,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Etopology_2EOPEN__IN__BIGINTER,lemma,(
    ! [A_27a: del,V0top: $i] :
...
thf(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS__EXPLICIT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
