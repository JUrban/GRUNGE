...
tff(conj_thm_2Ereal__topology_2ESERIES__CAUCHY__UNIFORM,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESERIES__COMPARISON__UNIFORM,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2P: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ? [V4l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),inj__ty_2Erealax_2Ereal(V4l)),V3s))
                      & ? [V5N: tp__ty_2Enum_2Enum] :
                        ! [V6n: tp__ty_2Enum_2Enum,V7x: $i] :
                          ( mem(V7x,A_27a)
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V5N)),inj__ty_2Enum_2Enum(V6n)))
                              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V6n)),V3s))
                              & p(ap(V2P,V7x)) )
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(V0f,V7x),inj__ty_2Enum_2Enum(V6n)))),ap(V1g,inj__ty_2Enum_2Enum(V6n)))) ) ) )
                   => ? [V8l: $i] :
                        ...
                        & ! [V9e: tp__ty_2Erealax_2Ereal] :
                           ...
                           => ? [V10N: tp__ty_2Enum_2Enum] :
                              ! [V11n: tp__ty_2Enum_2Enum,V12x: $i] :
                                ( mem(V12x,A_27a)
                               => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V10N)),inj__ty_2Enum_2Enum(V11n)))
                                    & p(ap(V2P,V12x)) )
                                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V3s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V11n)))),ap(V0f,V12x))),ap(V8l,V12x)))),inj__ty_2Erealax_2Ereal(V9e))) ) ) ) ) ) ) ) ) ) )).
