...
fof(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__LEFT,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__RIGHT,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
