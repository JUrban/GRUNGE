...
tff(conj_thm_2Earithmetic_2ELT__MULT__LCANCEL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ewords_2EZERO__LT__INT__MIN,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__H__WORD__L,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__NOT__LOWER__EQUAL,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Ewords_2Eword__msb__neg,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2Eword__ls__n2w,lemma,(
...
tff(mem_c_2Einteger__word_2Esaturate__i2sw,axiom,(
    ! [A_27a: del] : mem(c_2Einteger__word_2Esaturate__i2sw(A_27a),arr(ty_2Einteger_2Eint,ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(mem_c_2Einteger__word_2Esigned__saturate__add,axiom,(
    ! [A_27a: del] : mem(c_2Einteger__word_2Esigned__saturate__add(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(ax_thm_2Einteger__word_2Esaturate__i2sw__def,axiom,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] : ap(c_2Einteger__word_2Esaturate__i2sw(A_27a),inj__ty_2Einteger_2Eint(V0i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger__word_2EINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))),inj__ty_2Einteger_2Eint(V0i))),c_2Ewords_2Eword__H(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,inj__ty_2Einteger_2Eint(V0i)),ap(c_2Einteger__word_2EINT__MIN(A_27a),c_2Ebool_2Ethe__value(A_27a)))),c_2Ewords_2Eword__L(A_27a)),ap(c_2Einteger__word_2Ei2w(A_27a),inj__ty_2Einteger_2Eint(V0i)))) )).
...
tff(conj_thm_2Einteger__word_2Ew2i__i2w,lemma,(
...
tff(conj_thm_2Einteger__word_2Eranged__int__word__nchotomy,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Einteger__word_2Eword__i2w__add,lemma,(
...
tff(conj_thm_2Einteger__word_2Eword__0__w2i,lemma,(
...
tff(conj_thm_2Einteger__word_2EINT__MIN,lemma,(
...
tff(conj_thm_2Einteger__word_2Ei2w__INT__MIN,lemma,(
    ! [A_27a: del] : ap(c_2Einteger__word_2Ei2w(A_27a),ap(c_2Einteger__word_2EINT__MIN(A_27a),c_2Ebool_2Ethe__value(A_27a))) = c_2Ewords_2Eword__L(A_27a) )).

tff(conj_thm_2Einteger__word_2Ei2w__INT__MAX,lemma,(
    ! [A_27a: del] : ap(c_2Einteger__word_2Ei2w(A_27a),ap(c_2Einteger__word_2EINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))) = c_2Ewords_2Eword__H(A_27a) )).

tff(lmtp_f2675,type,(
    f2675: ( del * $i * $i ) > $i )).

tff(lamtp_f2675,axiom,(
    ! [A_27a: del,V1b: $i] :
      ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2sum: $i] :
          ( mem(V2sum,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2675(A_27a,V1b,V2sum),arr(bool,ty_2Efcp_2Ecart(bool,bool))) ) ) )).
...
tff(lameq_f2675,axiom,(
    ! [A_27a: del,V1b: $i] :
     ...
     => ! [V2sum: $i] :
          ( mem(V2sum,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3msba: tp__o] : ap(f2675(A_27a,V1b,V2sum),inj__o(V3msba)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(bool),inj__o(V3msba)),ap(c_2Ewords_2Eword__msb(A_27a),V1b))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),inj__o(V3msba)),ap(c_2Ewords_2Eword__msb(A_27a),V2sum))))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),inj__o(V3msba)),c_2Ewords_2Eword__L(A_27a)),c_2Ewords_2Eword__H(A_27a))),V2sum) ) ) )).

tff(lmtp_f2674,type,(
    f2674: ( del * $i ) > $i )).

tff(lamtp_f2674,axiom,(
    ! [A_27a: del,V1b: $i] :
      ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2674(A_27a,V1b),arr(ty_2Efcp_2Ecart(bool,bool),arr(bool,ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
tff(lameq_f2674,axiom,(
    ! [A_27a: del,V1b: $i] :
     ...
     => ! [V2sum: $i] :
          ( mem(V2sum,ty_2Efcp_2Ecart(bool,bool))
         => ap(f2674(A_27a,V1b),V2sum) = f2675(A_27a,V1b,V2sum) ) ) )).

tff(conj_thm_2Einteger__word_2Esigned__saturate__add,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Einteger__word_2Esigned__saturate__add(A_27a),V0a),V1b) = ap(ap(c_2Ebool_2ELET(bool,bool),ap(ap(c_2Ebool_2ELET(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),f2674(A_27a,V1b)),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b))),ap(c_2Ewords_2Eword__msb(A_27a),V0a)) ) ) )).
