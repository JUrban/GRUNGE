...
fof(lamtp_f3216,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3c] :
          ( mem(V3c,ty_2Erealax_2Ereal)
         => mem(f3216(V0f,V3c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V3c] :
         ...
         => ! [V4x] :
             ...
             => ap(f3216(V0f,V3c),V4x) = ap(ap(c_2Erealax_2Ereal__mul,V3c),ap(V0f,V4x)) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__CMUL,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3c] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V2b))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f)) )
                   => p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),f3216(V0f,V3c))) ) ) ) ) ) )).
