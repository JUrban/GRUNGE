...
tff(lamtp_f3175,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3175(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f3175,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f3175(A_27a,V1f),V2x) = ap(c_2Erealax_2Ereal__neg,ap(V1f,V2x)) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__NEG,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
       => ! [V1f: $i] :
            ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3175(A_27a,V1f)),V0P)) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0P))) ) ) ) )).
