...
tff(conj_thm_2Epoly_2EPOLY__DIFF__CLAUSES,lemma,(
...
tff(lmtp_f2923,type,(
    f2923: ( tp__ty_2Enum_2Enum * tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2923,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0l: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal] : mem(f2923(V1n,V0l),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f2923,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0l: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f2923(V1n,V0l),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V3x)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))),ap(ap(c_2Epoly_2Epoly,inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0l)),inj__ty_2Erealax_2Ereal(V3x))) )).

tff(conj_thm_2Epoly_2EPOLY__DIFF__LEMMA,lemma,(
    ! [V0l: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum,V2x: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Elim_2Ediffl,f2923(V1n,V0l)),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Enum_2Enum(V1n))),ap(ap(c_2Epoly_2Epoly,ap(ap(c_2Epoly_2Epoly__diff__aux,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))),inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0l))),inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V2x))) )).
...
tff(conj_thm_2Epoly_2EPOLY__DIFF,conjecture,(
