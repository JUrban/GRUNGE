...
thf(arityeq1_2Emono_2Ef653_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f653_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f653_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eoption_2Esome__F,axiom,(
    ! [A_27a: d,V0x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f653_0_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2Eoption_2Esome__F,axiom,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Esome_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f653_0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )).

thf(thm_2Eoption_2Eoption__case__eq,axiom,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1sc_2E0: u,V2opt_2E0: u,V3nc_2E0: u] :
      ( ( ( s @ A_27b @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V2opt_2E0 ) @ ( s @ A_27b @ V3nc_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1sc_2E0 ) ) )
        = ( s @ A_27b @ V0v_2E0 ) )
    <=> ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V2opt_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
          & ( ( s @ A_27b @ V3nc_2E0 )
            = ( s @ A_27b @ V0v_2E0 ) ) )
        | ? [V4x_2E0: u] :
            ...
            & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1sc_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) )
              = ( s @ A_27b @ V0v_2E0 ) ) ) ) ) )).
