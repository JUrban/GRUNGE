...
fof(conj_thm_2Einteger__word_2Ew2i__sw2sw__bounds,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Einteger__word_2Ew2i__i2w__id,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0i] :
             ...
             => ( ( p(ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger__word_2EINT__MIN(A_27a),c_2Ebool_2Ethe__value(A_27a))),V0i))
               ...
               => ( V0i = ap(c_2Einteger__word_2Ew2i(A_27b),ap(c_2Einteger__word_2Ei2w(A_27b),V0i))
                <=> ap(c_2Einteger__word_2Ei2w(A_27a),V0i) = ap(c_2Ewords_2Esw2sw(A_27b,A_27b),ap(c_2Einteger__word_2Ei2w(A_27b),V0i)) ) ) ) ) ) )).
