...
fof(arityeq1_2Ef2975_0_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2975_0_2E1(s(A_27a,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2975_0_2E0),s(A_27a,X0_2E0))) )).

fof(arityeq2_2Ef2975_0_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f2975_0_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f2975_0_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0))) )).
...
fof(arityeq2_2Ec_2Erich__list_2ELIST__ELEM__COUNT_2E2_2EA_27a,axiom,(
...
fof(arityeq2_2Ec_2Erich__list_2ELIST__ELEM__COUNT_2E2_2EA_27b,axiom,(
    ! [A_27b,X0_2E0,X1_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27b,X0_2E0),s(tyop_2Elist_2Elist(A_27b),X1_2E0))) = s(tyop_2Enum_2Enum,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27b),tyop_2Enum_2Enum),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27b),tyop_2Enum_2Enum)),c_2Erich__list_2ELIST__ELEM__COUNT_2E0),s(A_27b,X0_2E0))),s(tyop_2Elist_2Elist(A_27b),X1_2E0))) )).

fof(arityeq2_2Ec_2Erich__list_2ELIST__ELEM__COUNT_2E2_2EA_27c,axiom,(
    ! [A_27c,X0_2E0,X1_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27c,X0_2E0),s(tyop_2Elist_2Elist(A_27c),X1_2E0))) = s(tyop_2Enum_2Enum,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27c),tyop_2Enum_2Enum),app_2E2(s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27c),tyop_2Enum_2Enum)),c_2Erich__list_2ELIST__ELEM__COUNT_2E0),s(A_27c,X0_2E0))),s(tyop_2Elist_2Elist(A_27c),X1_2E0))) )).

fof(arityeq2_2Ec_2Erich__list_2ELIST__ELEM__COUNT_2E2_2EA_27d,axiom,(
    ! [A_27d,X0_2E0,X1_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27d,X0_2E0),s(tyop_2Elist_2Elist(A_27d),X1_2E0))) = s(tyop_2Enum_2Enum,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Enum_2Enum),app_2E2(s(tyop_2Emin_2Efun(A_27d,tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27d),tyop_2Enum_2Enum)),c_2Erich__list_2ELIST__ELEM__COUNT_2E0),s(A_27d,X0_2E0))),s(tyop_2Elist_2Elist(A_27d),X1_2E0))) )).
...
fof(def0_2Ethm_2Erich__list_2ELIST__ELEM__COUNT__DEF,axiom,(
    ! [A_27a,V0e_2E0,V2x_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f2975_0_2E2(s(A_27a,V0e_2E0),s(A_27a,V2x_2E0))))
    <=> s(A_27a,V2x_2E0) = s(A_27a,V0e_2E0) ) )).

fof(thm_2Erich__list_2ELIST__ELEM__COUNT__DEF,axiom,(
    ! [A_27a,V0e_2E0,V1l_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27a,V0e_2E0),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))) = s(tyop_2Enum_2Enum,c_2Elist_2ELENGTH_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFILTER_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f2975_0_2E1(s(A_27a,V0e_2E0))),s(tyop_2Elist_2Elist(A_27a),V1l_2E0))))) )).

fof(thm_2Erich__list_2ELIST__ELEM__COUNT__THM,conjecture,(
    ! [A_27a,A_27b,A_27c,A_27d] :
      ( ! [V0e_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27a,V0e_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))) = s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0)
      & ! [V1e_2E0,V2l1_2E0,V3l2_2E0] : s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27b,V1e_2E0),s(tyop_2Elist_2Elist(A_27b),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27b),V2l1_2E0),s(tyop_2Elist_2Elist(A_27b),V3l2_2E0))))) = s(tyop_2Enum_2Enum,c_2Earithmetic_2E_2B_2E2(s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27b,V1e_2E0),s(tyop_2Elist_2Elist(A_27b),V2l1_2E0))),s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27b,V1e_2E0),s(tyop_2Elist_2Elist(A_27b),V3l2_2E0)))))
      & ! [V4e_2E0,V5h_2E0,V6l_2E0] :
          ( s(A_27c,V5h_2E0) = s(A_27c,V4e_2E0)
         => s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27c,V4e_2E0),s(tyop_2Elist_2Elist(A_27c),c_2Elist_2ECONS_2E2(s(A_27c,V5h_2E0),s(tyop_2Elist_2Elist(A_27c),V6l_2E0))))) = s(tyop_2Enum_2Enum,c_2Enum_2ESUC_2E1(s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27c,V4e_2E0),s(tyop_2Elist_2Elist(A_27c),V6l_2E0))))) )
      & ! [V7e_2E0,V8h_2E0,V9l_2E0] :
          ( s(A_27d,V8h_2E0) != s(A_27d,V7e_2E0)
         => s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27d,V7e_2E0),s(tyop_2Elist_2Elist(A_27d),c_2Elist_2ECONS_2E2(s(A_27d,V8h_2E0),s(tyop_2Elist_2Elist(A_27d),V9l_2E0))))) = s(tyop_2Enum_2Enum,c_2Erich__list_2ELIST__ELEM__COUNT_2E2(s(A_27d,V7e_2E0),s(tyop_2Elist_2Elist(A_27d),V9l_2E0))) ) ) )).
