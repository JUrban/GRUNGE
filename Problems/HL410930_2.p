...
tff(lamtp_f3756,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3756(A_27a,V1f,V2g),arr(A_27a,bool)) ) ) )).

tff(lameq_f3756,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3n: $i] :
              ( mem(V3n,A_27a)
             => ap(f3756(A_27a,V1f,V2g),V3n) = ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1f,V3n))),ap(c_2Ereal_2Eabs,ap(V2g,V3n))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__BOUND,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
              ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
             => ( ( p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3756(A_27a,V1f,V2g)),V0net))
