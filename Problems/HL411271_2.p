...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUBSET,lemma,(
    ! [V0f: $i] :
...
tff(lameq_f3848,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V3t: $i] :
              ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
             => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3848(V1s,V0f,V3t),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),V3t))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__MAP__IMP__QUOTIENT__MAP,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
              & ! [V2t: $i] :
                 ...
                 => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V2t))
                   => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2t))) ) ) )
           => ! [V3t: $i] :
                ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f3861,type,(
    f3861: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3861,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V5y: tp__ty_2Erealax_2Ereal] : mem(f3861(V1s,V0f,V5y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f3861,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V5y: tp__ty_2Erealax_2Ereal,V6x: tp__ty_2Erealax_2Ereal] : ap(f3861(V1s,V0f,V5y),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),inj__ty_2Erealax_2Ereal(V5y)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__MONOTONE__QUOTIENT__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
                  ...
                  & ! [V5y: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5y)),V2t))
...
tff(lameq_f3864,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V3t_27: $i] :
              ( mem(V3t_27,arr(ty_2Erealax_2Ereal,bool))
             => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f3864(V1s,V0f,V3t_27),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),V3t_27))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__MAP__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3t_27: $i] :
                 ...
                 => ( ( ! [V4u: $i] :
                         ...
                         => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V4u))
                           => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2t)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V4u))) ) )
                      & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3t_27),V2t)) )
                   => ! [V5u: $i] :
                        ( mem(V5u,arr(ty_2Erealax_2Ereal,bool))
                       => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3864(V1s,V0f,V3t_27)))),V5u))
                         => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V3t_27)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V5u))) ) ) ) ) ) ) ) )).

tff(lmtp_f3879,type,(
    f3879: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3879,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4y: tp__ty_2Erealax_2Ereal] : mem(f3879(V1s,V0f,V4y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f3879,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4y: tp__ty_2Erealax_2Ereal,V5x: tp__ty_2Erealax_2Ereal] : ap(f3879(V1s,V0f,V4y),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V5x))),inj__ty_2Erealax_2Ereal(V4y)))) ) ) )).

tff(lmtp_f3880,type,(
    f3880: ( $i * $i * $i ) > $i )).

tff(lamtp_f3880,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lameq_f3880,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V6c: $i] :
              ( mem(V6c,arr(ty_2Erealax_2Ereal,bool))
             => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f3880(V1s,V0f,V6c),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),V6c))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__MONOTONE__PREIMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
                  ...
                  & ! [V3c: $i] :
                     ...
                     => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V3c))
                       => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2t)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V3c))) ) )
                  & ! [V4y: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4y)),V2t))
