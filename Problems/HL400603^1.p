...
thf(thm_2Epair_2EFST__EQ__EQUIV,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1p_2E0: u] :
      ( ( ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_2E0 ) ) )
        = ( s @ A_27a @ V0x_2E0 ) )
    <=> ? [V2y_2E0: u] :
          ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1p_2E0 )
          = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V2y_2E0 ) ) ) ) ) )).
