...
tff(conj_thm_2Epred__set_2EENUMERATE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ? [V1f: $i] :
            ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
...
tff(conj_thm_2Epred__set_2ECOUNTABLE__ALT__BIJ,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0s))
      <=> ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
