...
tff(conj_thm_2Ellist_2ELTAKE__EQ__NONE__LNTH,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ( ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))
       => ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = c_2Eoption_2ENONE(A_27a) ) ) )).
...
tff(conj_thm_2Ellist_2ELTAKE__LAPPEND1,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( mem(V1l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l2: $i] :
          ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
         => ( p(ap(c_2Eoption_2EIS__SOME(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l1)))
           => ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Ellist_2ELAPPEND(A_27a),V1l1),V2l2)) = ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l1) ) ) ) )).
...
tff(conj_thm_2Ellist_2ELFINITE__LLENGTH,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ( p(ap(c_2Ellist_2ELFINITE(A_27a),V0ll))
      <=> ? [V1n: tp__ty_2Enum_2Enum] : surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),V0ll)) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n))) ) ) )).
...
tff(conj_thm_2Ellist_2ELTAKE__LNTH__EL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V2m: tp__ty_2Enum_2Enum,V3l: $i] :
          ( mem(V3l,ty_2Elist_2Elist(A_27a))
         => ( ( ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),V3l)
              & p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V0n))) )
           => ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V2m)),V1ll) = ap(c_2Eoption_2ESOME(A_27a),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V2m)),V3l)) ) ) ) )).

tff(conj_thm_2Ellist_2ELFINITE__LNTH__NONE,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ( p(ap(c_2Ellist_2ELFINITE(A_27a),V0ll))
      <=> ? [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V1n)),V0ll) = c_2Eoption_2ENONE(A_27a) ) ) )).

tff(lmtp_f1214,type,(
    f1214: ( del * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f1214,axiom,(
    ! [A_27a: del,V1l1: $i] :
      ( mem(V1l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V0n: tp__ty_2Enum_2Enum,V2l2: $i] :
          ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
         => mem(f1214(A_27a,V1l1,V0n,V2l2),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))) ) ) )).

tff(lameq_f1214,axiom,(
    ! [A_27a: del,V1l1: $i] :
      ( mem(V1l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V0n: tp__ty_2Enum_2Enum,V2l2: $i] :
          ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
         => ! [V3m: tp__ty_2Enum_2Enum] : ap(f1214(A_27a,V1l1,V0n,V2l2),inj__ty_2Enum_2Enum(V3m)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V3m))),ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l1)),ap(ap(c_2Ellist_2ELNTH(A_27a),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V3m))),V2l2)) ) ) )).

tff(conj_thm_2Ellist_2ELNTH__LAPPEND,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( mem(V1l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l2: $i] :
          ( mem(V2l2,ty_2Ellist_2Ellist(A_27a))
         => ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Ellist_2ELAPPEND(A_27a),V1l1),V2l2)) = ap(ap(ap(c_2Eoption_2Eoption__CASE(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Ellist_2ELLENGTH(A_27a),V1l1)),ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l1)),f1214(A_27a,V1l1,V0n,V2l2)) ) ) )).
