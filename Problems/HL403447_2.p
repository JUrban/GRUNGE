...
tff(conj_thm_2EEncode_2Eencode__prod__alt,lemma,(
    ! [A_27a: del,A_27b: del,V0xb: $i] :
     ...
     => ! [V1yb: $i] :
         ...
         => ! [V2p: $i] :
             ...
             => surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2EEncode_2Eencode__prod(A_27a,A_27a),V0xb),V1yb),V2p)) = surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Elist_2EAPPEND(bool),ap(V0xb,ap(c_2Epair_2EFST(A_27a,A_27a),V2p))),ap(V1yb,ap(c_2Epair_2ESND(A_27a,A_27a),V2p)))) ) ) ) )).

tff(conj_thm_2EEncode_2Ewf__encode__prod,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,arr(A_27a,bool))
     => ! [V1p2: $i] :
          ( mem(V1p2,arr(A_27b,bool))
