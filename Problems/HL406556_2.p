...
tff(conj_thm_2Ewords_2Eword__1__lsl,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__0,lemma,(
    ! [A_27a: del,A_27b: del] :
...
tff(conj_thm_2Ealignment_2Ealigned__add__sub__prod,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__add__sub__123,conjecture,(
    ! [A_27a: del] :
      ( ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1x: $i] :
