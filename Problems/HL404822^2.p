...
thf(conj_thm_2Efinite__map_2EFOLDL2__FUPDATE__LIST__paired,conjecture,(
                                        ...
                                        @ ^ [V6b: $i] :
                                            ...
                                            @ ( lam @ A_27b
                                              @ ^ [V7c: $i] :
                                                  ( lam @ A_27c
                                                  @ ^ [V8d: $i] :
                                                      ( ap @ ( ap @ ( c_2Efinite__map_2EFUPDATE @ A_27d @ A_27e ) @ V5fm ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27d @ A_27e ) @ ( ap @ ( ap @ ( ap @ V0f1 @ V6b ) @ V7c ) @ V8d ) ) @ ( ap @ ( ap @ ( ap @ V1f2 @ V6b ) @ V7c ) @ V8d ) ) ) ) ) ) ) ) )
                                @ V4a )
                              @ V2bs )
                            @ V3cs )
                                  ...
                                  @ ( ap
                                    @ ( ap
                                      @ ( ap @ ( c_2Elist_2EMAP2 @ A_27d @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) )
                                        @ ( lam @ A_27a
                                          @ ^ [V9b: $i] :
                                              ( ap @ ( c_2Epair_2EUNCURRY @ A_27b @ A_27c @ A_27d ) @ ( ap @ V0f1 @ V9b ) ) ) )
                                      @ V2bs )
                                    @ V3cs ) )
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ ( c_2Elist_2EMAP2 @ A_27e @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) )
                                      @ ( lam @ A_27a
                                        @ ^ [V10b: $i] :
                                            ( ap @ ( c_2Epair_2EUNCURRY @ A_27b @ A_27c @ A_27e ) @ ( ap @ V1f2 @ V10b ) ) ) )
                                    @ V2bs )
                                  @ V3cs ) ) ) ) ) ) ) ) ) ) ) )).
