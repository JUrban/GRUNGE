...
thf(f4430_0_2E0,type,(
    f4430_0_2E0: u )).

thf(f4430_0_2E1,type,(
    f4430_0_2E1: du > u )).
...
thf(c_2EreaderMonad_2EFMAP_2E0,type,(
    c_2EreaderMonad_2EFMAP_2E0: u )).

thf(c_2EreaderMonad_2EFMAP_2E2,type,(
    c_2EreaderMonad_2EFMAP_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4430_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( f4430_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ f4430_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EFMAP_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27s,axiom,(
    ! [A_27a: d,A_27b: d,A_27s: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) @ ( c_2EreaderMonad_2EFMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) ) ) @ c_2EreaderMonad_2EFMAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2EreaderMonad_2EFMAP_2E2_2Emono_2EA_27b_20mono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EFMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ec_2Ecombin_2Eo_2E2_2Emono_2EA_27s_20mono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,A_27s: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ X1_2E0 ) ) )
...
thf(thm_2EreaderMonad_2EFMAP__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27s: d,V0f_2E0: u,V1M1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) @ ( c_2EreaderMonad_2EFMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ V1M1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27b ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27s @ A_27a ) @ V1M1_2E0 ) ) ) ) )).

thf(def0_2Ethm_2EreaderMonad_2EFMAP__ID,axiom,(
    ! [A_27b: d,V1x_2E0: u] :
      ( ( s @ A_27b @ ( f4430_0_2E1 @ ( s @ A_27b @ V1x_2E0 ) ) )
      = ( s @ A_27b @ V1x_2E0 ) ) )).

thf(thm_2EreaderMonad_2EFMAP__ID,conjecture,(
    ! [A_27a: d,A_27b: d,V0M_2E0: u] :
      ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EFMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ f4430_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0M_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0M_2E0 ) )
      & ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2EreaderMonad_2EFMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ c_2Ecombin_2EI_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0M_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0M_2E0 ) ) ) )).
