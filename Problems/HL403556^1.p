...
thf(thm_2Ewellorder_2Eorderiso__unique,conjecture,(
    ! [A_27a: d,A_27b: d,V0w2_2E0: u,V1w1_2E0: u,V2f2_2E0: u,V3f1_2E0: u] :
     ...
     => ! [V8x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V8x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2EelsOf_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w1_2E0 ) ) ) ) ) )
         => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f1_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) )
            = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f2_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) ) ) )).
