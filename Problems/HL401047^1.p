...
thf(f1251_0_2E0,type,(
    f1251_0_2E0: u )).

thf(f1251_0_2E1,type,(
    f1251_0_2E1: du > u )).

thf(f1251_0_2E2,type,(
    f1251_0_2E2: du > du > u )).

thf(f1251_1_2E0,type,(
    f1251_1_2E0: u )).

thf(f1251_1_2E1,type,(
    f1251_1_2E1: du > u )).

thf(f1251_1_2E2,type,(
    f1251_1_2E2: du > du > u )).
...
thf(mono_2Ef1251_0,type,(
    mono_2Ef1251_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef1251_1,type,(
    mono_2Ef1251_1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ewhile_2ELEAST__EQ,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1251_1 @ V0x @ V2n )
    <=> ( V0x = V2n ) ) )).

thf(def1_2Ethm_2Ewhile_2ELEAST__EQ,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1251_0 @ V0x @ V1n )
    <=> ( V1n = V0x ) ) )).

thf(thm_2Ewhile_2ELEAST__EQ,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Ewhile_2ELEAST @ ( mono_2Ef1251_0 @ V0x ) )
        = V0x )
      & ( ( mono_2Ec_2Ewhile_2ELEAST @ ( mono_2Ef1251_1 @ V0x ) )
        = V0x ) ) )).
