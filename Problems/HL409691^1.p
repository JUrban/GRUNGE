...
thf(f11529_0_2E0,type,(
    f11529_0_2E0: u )).

thf(f11529_0_2E3,type,(
    f11529_0_2E3: du > du > du > u )).

thf(f11529_0_2E4,type,(
...
thf(arityeq3_2Emono_2Ef11529_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11529_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef11529_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11529_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
...
thf(def0_2Ethm_2Eiterate_2EITERATE__EQ__GENERAL,axiom,(
    ! [A_27a: d,A_27b: d,V1s_2E0: u,V5h_2E0: u,V6y_2E0: u,V7x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11529_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27b @ V6y_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
        & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) ) )
          = ( s @ A_27b @ V6y_2E0 ) ) ) ) )).
...
thf(thm_2Eiterate_2EITERATE__EQ__GENERAL,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0op_2E0: u] :
     ...
     => ! [V1s_2E0: u,V2t_2E0: u,V3f_2E0: u,V4g_2E0: u,V5h_2E0: u] :
          ( ( ! [V6y_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V6y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) )
               => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11529_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V5h_2E0 ) @ ( s @ A_27b @ V6y_2E0 ) ) ) ) ) ) )
            & ! [V8x_2E0: u] :
...
thf(thm_2Eiterate_2EITERATE__EQ__GENERAL__INVERSES,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0op_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eiterate_2Emonoidal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27c @ A_27c ) ) @ V0op_2E0 ) ) ) )
