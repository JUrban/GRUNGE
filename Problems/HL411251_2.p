...
tff(conj_thm_2Ereal__topology_2EQUOTIENT__MAP__IMP__CONTINUOUS__OPEN,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3857,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V4u: $i] :
              ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
             => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3857(V1s,V0f,V4u),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V5x))),V4u))) ) ) ) )).

tff(lmtp_f3858,type,(
    f3858: ( $i * $i * $i ) > $i )).

tff(lamtp_f3858,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lameq_f3858,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V3c: $i] :
              ( mem(V3c,arr(ty_2Erealax_2Ereal,bool))
             => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f3858(V1s,V0f,V3c),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),V3c))) ) ) ) )).

tff(lmtp_f3860,type,(
    f3860: ( $i * $i * $i ) > $i )).

tff(lamtp_f3860,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
    ...
    ! [V6u: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V3c: $i] :
             ...
             => ! [V1s: $i] :
                  ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                 => ! [V8x: tp__ty_2Erealax_2Ereal] : ap(f3859(V6u,V0f,V3c,V1s),inj__ty_2Erealax_2Ereal(V8x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3860(V1s,V0f,V3c)))),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V8x))),V6u))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EQUOTIENT__MAP__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lmtp_f3862,type,(
    f3862: ( $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3862,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V6y: tp__ty_2Erealax_2Ereal] : mem(f3862(V1s,V0f,V6y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

tff(lameq_f3862,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V6y: tp__ty_2Erealax_2Ereal,V7x: tp__ty_2Erealax_2Ereal] : ap(f3862(V1s,V0f,V6y),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),inj__ty_2Erealax_2Ereal(V6y)))) ) ) )).

tff(lmtp_f3863,type,(
    f3863: ( $i * $i * $i ) > $i )).

tff(lamtp_f3863,axiom,(
    ! [V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lameq_f3863,axiom,(
    ! [V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V3c: $i] :
              ( mem(V3c,arr(ty_2Erealax_2Ereal,bool))
             => ! [V8x: tp__ty_2Erealax_2Ereal] : ap(f3863(V1s,V0f,V3c),inj__ty_2Erealax_2Ereal(V8x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),V1s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V8x))),V3c))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__MONOTONE__QUOTIENT__PREIMAGE__GEN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
             ...
             => ! [V3c: $i] :
                 ...
                 => ( ( ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s) = V2t
                      ...
                      & ! [V6y: tp__ty_2Erealax_2Ereal] :
                          ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6y)),V2t))
