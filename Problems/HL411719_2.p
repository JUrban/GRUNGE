...
tff(conj_thm_2Epred__set_2EGSPEC__EQ,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
...
tff(conj_thm_2Ecardinal_2EHAS__SIZE__0,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ESPAN__EMPTY,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__EMPTY,lemma,(
    p(ap(c_2Ereal__topology_2Eindependent,c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) )).

tff(conj_thm_2Ereal__topology_2EINDEPENDENT__SING,lemma,(
...
tff(lmtp_f3663,type,(
    f3663: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3663,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3663(V1n,V0v),arr(arr(ty_2Erealax_2Ereal,bool),bool)) ) )).
...
tff(lameq_f3663,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0v: $i] :
     ...
     => ! [V2b: $i] :
         ...
         => ap(f3663(V1n,V0v),V2b) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2b),V0v)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2Eindependent,V2b)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0v),ap(c_2Ereal__topology_2Espan,V2b))),ap(ap(c_2Ecardinal_2EHAS__SIZE(ty_2Erealax_2Ereal),V2b),inj__ty_2Enum_2Enum(V1n))))) ) ) )).

tff(lmtp_f3662,type,(
    f3662: $i > $i )).

tff(lamtp_f3662,axiom,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3662(V0v),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f3662,axiom,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f3662(V0v),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3663(V1n,V0v)) ) )).

tff(ax_thm_2Ereal__topology_2Edim,axiom,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => surj__ty_2Enum_2Enum(ap(c_2Ereal__topology_2Edim,V0v)) = surj__ty_2Enum_2Enum(ap(c_2Emin_2E_40(ty_2Enum_2Enum),f3662(V0v))) ) )).

tff(lmtp_f4003,type,(
    f4003: $i )).

tff(lamtp_f4003,axiom,(
    mem(f4003,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f4003,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f4003,inj__ty_2Erealax_2Ereal(V0x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) )).

tff(conj_thm_2Ereal__topology_2EDIM__SUBSTANDARD,conjecture,(
    surj__ty_2Enum_2Enum(ap(c_2Ereal__topology_2Edim,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4003))) = fo__c_2Enum_2E0 )).
