...
fof(conj_thm_2Ewords_2EWORD__ADD__BIT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1a] :
             ...
             => ! [V2b] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                   => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),V1a),V2b)),V0n))
                    <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0n),c_2Enum_2E0)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),c_2Enum_2E0)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),c_2Enum_2E0)))),ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__add(A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),V1a)),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),V2b))),V0n)),ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),V0n)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),V0n))),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),V0n)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),V0n)))))) ) ) ) ) ) ) )).
