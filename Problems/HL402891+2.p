...
fof(conj_thm_2Erich__list_2Emap__replicate,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1n] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27a)
                     => ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),ap(ap(c_2Erich__list_2EREPLICATE(A_27a),V1n),V2x)) = ap(ap(c_2Erich__list_2EREPLICATE(A_27b),V1n),ap(V0f,V2x)) ) ) ) ) ) )).
