...
thf(conj_thm_2EHolSmt_2Er018,conjecture,(
    ! [A_27a: del,V0p: $o,V1x: $i] :
      ( ( mem @ V1x @ A_27a )
     => ! [V2y: $i] :
          ( ( mem @ V2y @ A_27a )
         => ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ c_2Ebool_2E_7E @ ( inj__o @ V0p ) ) ) @ V1x ) @ V2y )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( inj__o @ V0p ) ) @ V2y ) @ V1x ) ) ) ) )).
