...
thf(conj_thm_2Epred__set_2ECARD__SING,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__FINITE,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V0s ) )
           ...
           => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V0s ) @ V1t ) )
            <=> ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Epred__set_2ECARD @ ty_2Erealax_2Ereal ) @ V0s ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Epred__set_2ECARD @ ty_2Erealax_2Ereal ) @ V1t ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SING,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
