...
tff(conj_thm_2Ereal__topology_2EREAL__LT__RNEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(lamtp_f3707,axiom,(
    mem(f3707,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3707,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3707,inj__ty_2Erealax_2Ereal(V0x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x))) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__POSITIVE__ORTHANT,conjecture,(
    p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3707))) )).
