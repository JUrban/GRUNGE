...
thf(tp_c_2Erich__list_2ETL__T,type,(
    c_2Erich__list_2ETL__T: del > $i )).

thf(mem_c_2Erich__list_2ETL__T,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Earithmetic_2EFUNPOW__ADD,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
              ( ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ A_27a ) @ V0f ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V1x )
              = ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ A_27a ) @ V0f ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ A_27a ) @ V0f ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ V1x ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2EDROP__FUNPOW__TL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
        = ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Erich__list_2ETL__T @ A_27a ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) ) ) )).

thf(conj_thm_2Erich__list_2EDROP__DROP__T,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2l: $i] :
      ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V2l ) )
        = ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ V2l ) ) ) )).
