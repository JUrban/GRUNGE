...
thf(thm_2Ereal__topology_2ELINEAR__OPEN__MAPPING,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
     ...
     => ! [V2s: tyop_2Erealax_2Ereal > $o] :
         ...
         => ( c_2Ereal__topology_2EOpen @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) ) ) ) )).
