                    ...
                    @ ( ap @ c_2Ebool_2E_2F_5C
                      @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
                        @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) )
                          @ ^ [V1lol: $i] :
                              ( ap @ ( ap @ V0R @ V1lol ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ V1lol ) ) ) ) )
                    @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Elist_2Elist @ A_27a ) )
                      @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                        @ ^ [V2m: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) )
                              @ ^ [V3lol: $i] :
                                  ( ap @ ( ap @ V0R @ V3lol ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2m ) ) @ V3lol ) ) ) ) ) ) ) ) ) ) )
                  ...
                  @ ( lam @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) )
                    @ ^ [V6v: $i] :
                        ...
                        @ ^ [V7lol: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                              @ ^ [V8m: $i] :
                                  ( ap @ ( c_2Ecombin_2EI @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V8m ) ) @ ( ap @ V4lol__set @ V7lol ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eenumeral_2Elol__set,conjecture,(
    ! [A_27a: del] :
