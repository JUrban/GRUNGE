...
thf(thm_2Ebag_2EBAG__INN__LESS,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1e: A_27a,V2n: tyop_2Enum_2Enum,V3m: tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V2n @ V0b )
        & ( c_2Eprim__rec_2E_3C @ V3m @ V2n ) )
     => ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V3m @ V0b ) ) )).

thf(thm_2Ebag_2EBAG__INN__BAG__INSERT,axiom,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1b: A_27a > tyop_2Enum_2Enum,V2e1: A_27a,V3e2: A_27a] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ V0n @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V3e2 @ V1b ) )
    <=> ( ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ ( c_2Earithmetic_2E_2D @ V0n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1b )
          & ( V2e1 = V3e2 ) )
        | ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ V0n @ V1b ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INN__BAG__INSERT__STRONG,conjecture,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2e1: A_27a,V3e2: A_27a] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ V1n @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V3e2 @ V0b ) )
    <=> ( ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ ( c_2Earithmetic_2E_2D @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0b )
          & ( V2e1 = V3e2 ) )
        | ( ( c_2Ebag_2EBAG__INN @ A_27a @ V2e1 @ V1n @ V0b )
          & ( (~) @ ( V2e1 = V3e2 ) ) ) ) ) )).
