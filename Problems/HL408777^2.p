...
thf(conj_thm_2EHolSmt_2Er156,conjecture,(
    ...
    <=> ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0u ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V2v ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V4w ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) ) )
        = V6a ) ) )).
