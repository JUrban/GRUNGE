...
tff(conj_thm_2Edft_2EDFT__ALL__DISTINCT,conjecture,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1seen: $i] :
         ...
         => ! [V2to__visit: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2EdirGraph_2EParents(A_27a,A_27a),V0G)))
               => p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(ap(ap(ap(c_2Edft_2EDFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),c_2Elist_2ECONS(A_27a)),V1seen),V2to__visit),c_2Elist_2ENIL(A_27a)))) ) ) ) ) )).
