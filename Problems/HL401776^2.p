...
thf(conj_thm_2Epred__set_2EPOW__EQNS,lemma,(
    ! [A_27a: del] :
                ...
                = ( ap
                  @ ( ap @ ( c_2Ebool_2ELET @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
                    @ ( lam @ ( arr @ ( arr @ A_27a @ bool ) @ bool )
                      @ ^ [V2ps: $i] :
                          ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V0e ) ) @ V2ps ) ) @ V2ps ) ) )
...
thf(conj_thm_2Epred__set_2EFINITE__POW,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
