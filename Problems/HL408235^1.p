...
thf(f9713_0_2E0,type,(
    f9713_0_2E0: u )).

thf(f9713_0_2E2,type,(
    f9713_0_2E2: du > du > u )).

thf(f9713_0_2E3,type,(
    f9713_0_2E3: du > du > du > u )).

thf(f9713_1_2E0,type,(
    f9713_1_2E0: u )).

thf(f9713_1_2E2,type,(
    f9713_1_2E2: du > du > u )).

thf(f9713_1_2E3,type,(
    f9713_1_2E3: du > du > du > u )).

thf(f9713_2_2E0,type,(
    f9713_2_2E0: u )).

thf(f9713_2_2E2,type,(
    f9713_2_2E2: du > du > u )).

thf(f9713_2_2E3,type,(
    f9713_2_2E3: du > du > du > u )).

thf(f9713_3_2E0,type,(
    f9713_3_2E0: u )).

thf(f9713_3_2E1,type,(
    f9713_3_2E1: du > u )).

thf(f9713_3_2E2,type,(
    f9713_3_2E2: du > du > u )).

thf(f9713_4_2E0,type,(
    f9713_4_2E0: u )).

thf(f9713_4_2E2,type,(
    f9713_4_2E2: du > du > u )).

thf(f9713_4_2E3,type,(
    f9713_4_2E3: du > du > du > u )).

thf(f9713_5_2E0,type,(
    f9713_5_2E0: u )).

thf(f9713_5_2E2,type,(
    f9713_5_2E2: du > du > u )).

thf(f9713_5_2E3,type,(
    f9713_5_2E3: du > du > du > u )).

thf(f9847_0_2E0,type,(
    f9847_0_2E0: u )).

thf(f9847_0_2E1,type,(
    f9847_0_2E1: du > u )).

thf(f9847_0_2E2,type,(
    f9847_0_2E2: du > du > u )).

thf(f9848_0_2E0,type,(
    f9848_0_2E0: u )).

thf(f9848_0_2E1,type,(
    f9848_0_2E1: du > u )).

thf(f9848_0_2E2,type,(
    f9848_0_2E2: du > du > u )).

thf(f9849_0_2E0,type,(
    f9849_0_2E0: u )).

thf(f9849_0_2E1,type,(
    f9849_0_2E1: du > u )).
...
thf(c_2Epowser_2Ediffs_2E1,type,(
...
thf(mono_2Ef9713_0,type,(
    mono_2Ef9713_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9713_1,type,(
    mono_2Ef9713_1: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9713_2,type,(
    mono_2Ef9713_2: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9713_3,type,(
    mono_2Ef9713_3: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9713_4,type,(
    mono_2Ef9713_4: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9713_5,type,(
    mono_2Ef9713_5: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9847_0,type,(
    mono_2Ef9847_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9848_0,type,(
    mono_2Ef9848_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9849_0,type,(
    mono_2Ef9849_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V6x: mono_2Etyop_2Erealax_2Ereal,V7n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9713_5 @ V0c @ V6x @ V7n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0c @ V7n ) @ ( mono_2Ec_2Ereal_2Epow @ V6x @ V7n ) ) ) )).

thf(def1_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V6x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9713_3 @ V0c @ V6x )
      = ( mono_2Ec_2Eseq_2Esuminf @ ( mono_2Ef9713_5 @ V0c @ V6x ) ) ) )).

thf(def2_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1k_27: mono_2Etyop_2Erealax_2Ereal,V5n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9713_2 @ V0c @ V1k_27 @ V5n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Epowser_2Ediffs @ ( mono_2Ec_2Epowser_2Ediffs @ V0c ) @ V5n ) @ ( mono_2Ec_2Ereal_2Epow @ V1k_27 @ V5n ) ) ) )).

thf(def3_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal,V8n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9713_4 @ V0c @ V2x @ V8n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Epowser_2Ediffs @ V0c @ V8n ) @ ( mono_2Ec_2Ereal_2Epow @ V2x @ V8n ) ) ) )).

thf(def4_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1k_27: mono_2Etyop_2Erealax_2Ereal,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9713_1 @ V0c @ V1k_27 @ V4n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Epowser_2Ediffs @ V0c @ V4n ) @ ( mono_2Ec_2Ereal_2Epow @ V1k_27 @ V4n ) ) ) )).

thf(def5_2Ethm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1k_27: mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9713_0 @ V0c @ V1k_27 @ V3n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0c @ V3n ) @ ( mono_2Ec_2Ereal_2Epow @ V1k_27 @ V3n ) ) ) )).

thf(thm_2Epowser_2ETERMDIFF,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1k_27: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Eseq_2Esummable @ ( mono_2Ef9713_0 @ V0c @ V1k_27 ) )
        & ( mono_2Ec_2Eseq_2Esummable @ ( mono_2Ef9713_1 @ V0c @ V1k_27 ) )
        & ( mono_2Ec_2Eseq_2Esummable @ ( mono_2Ef9713_2 @ V0c @ V1k_27 ) )
        & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ V2x ) @ ( mono_2Ec_2Ereal_2Eabs @ V1k_27 ) ) )
     => ( mono_2Ec_2Elim_2Ediffl @ ( mono_2Ef9713_3 @ V0c ) @ ( mono_2Ec_2Eseq_2Esuminf @ ( mono_2Ef9713_4 @ V0c @ V2x ) ) @ V2x ) ) )).
...
thf(thm_2Ereal_2EABS__LE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal_2Ereal__lte @ V0x @ ( mono_2Ec_2Ereal_2Eabs @ V0x ) ) )).
...
thf(def0_2Ethm_2Etransc_2Eexp,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9848_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) ) ) )).

thf(thm_2Etransc_2Eexp,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Etransc_2Eexp @ V0x )
      = ( mono_2Ec_2Eseq_2Esuminf @ ( mono_2Ef9848_0 @ V0x ) ) ) )).

thf(def0_2Ethm_2Etransc_2EEXP__CONVERGES,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9847_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) ) ) )).

thf(thm_2Etransc_2EEXP__CONVERGES,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9847_0 @ V0x ) @ ( mono_2Ec_2Etransc_2Eexp @ V0x ) ) )).

thf(def0_2Ethm_2Etransc_2EEXP__FDIFF,axiom,(
    ! [V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9849_0 @ V1n )
      = ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) ) )).

thf(thm_2Etransc_2EEXP__FDIFF,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Epowser_2Ediffs @ mono_2Ef9849_0 @ V0x )
      = ( mono_2Ec_2Erealax_2Einv @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V0x ) ) ) ) )).

thf(thm_2Etransc_2EDIFF__EXP,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
