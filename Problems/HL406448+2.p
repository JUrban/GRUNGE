     ...
     => ! [V0c] :
         ...
         => ! [V1n] :
             ...
             => ! [V2s] :
                 ...
                 => ap(ap(ap(c_2Elist_2EPAD__RIGHT(A_27a),V0c),V1n),V2s) = ap(ap(c_2Elist_2EAPPEND(A_27a),V2s),ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V0c)),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V2s)))) ) ) ) ) )).

fof(conj_thm_2Ebitstring_2Elength__pad__right,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
