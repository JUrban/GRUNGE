...
tff(ax_thm_2Efinite__map_2EFEMPTY__DEF,axiom,(
    ! [A_27a: del,A_27b: del] : c_2Efinite__map_2EFEMPTY(A_27a,A_27a) = ap(c_2Efinite__map_2Efmap__ABS(A_27a,A_27a),k(A_27a,ap(c_2Esum_2EINR(A_27b,A_27b),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone)))) )).

tff(ax_thm_2Efinite__map_2EFDOM__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( p(ap(ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f),V1x))
          <=> p(ap(c_2Esum_2EISL(A_27b,A_27b),ap(ap(c_2Efinite__map_2Efmap__REP(A_27a,A_27a),V0f),V1x))) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFDOM__FEMPTY,conjecture,(
