...
thf(thm_2Epoly_2EPOLY__MUL__ASSOC,axiom,(
    ! [V0p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V1q: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V2r: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( c_2Epoly_2Epoly @ ( c_2Epoly_2Epoly__mul @ V0p @ ( c_2Epoly_2Epoly__mul @ V1q @ V2r ) ) )
      = ( c_2Epoly_2Epoly @ ( c_2Epoly_2Epoly__mul @ ( c_2Epoly_2Epoly__mul @ V0p @ V1q ) @ V2r ) ) ) )).

thf(thm_2Epoly_2EPOLY__LINEAR__DIVIDES,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epoly_2Epoly @ V1p @ V0a )
        = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
    <=> ( ( V1p
          = ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) )
        | ? [V2q: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
            ( V1p
            = ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V0a ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) @ V2q ) ) ) ) )).

thf(thm_2Epoly_2EPOLY__LENGTH__MUL,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1q: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( c_2Elist_2ELENGTH @ tyop_2Erealax_2Ereal @ ( c_2Epoly_2Epoly__mul @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V0a ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) @ V1q ) )
      = ( c_2Enum_2ESUC @ ( c_2Elist_2ELENGTH @ tyop_2Erealax_2Ereal @ V1q ) ) ) )).
...
thf(thm_2Epoly_2EPOLY__ORDER__EXISTS,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1d: tyop_2Enum_2Enum,V2p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( ( ( c_2Elist_2ELENGTH @ tyop_2Erealax_2Ereal @ V2p )
          = V1d )
        & ( (~)
          @ ( ( c_2Epoly_2Epoly @ V2p )
            = ( c_2Epoly_2Epoly @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) ) )
     => ? [V3n: tyop_2Enum_2Enum] :
          ( ( c_2Epoly_2Epoly__divides @ ( c_2Epoly_2Epoly__exp @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V0a ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) @ V3n ) @ V2p )
          & ( (~) @ ( c_2Epoly_2Epoly__divides @ ( c_2Epoly_2Epoly__exp @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V0a ) @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) @ ( c_2Enum_2ESUC @ V3n ) ) @ V2p ) ) ) ) )).
