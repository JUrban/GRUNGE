...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELDROP_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) ) @ c_2Ellist_2ELDROP_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Ellist_2ELDROP_2E2_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) ) ) @ c_2Ellist_2ELDROP_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ellist_2ELFINITE_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ tyop_2Emin_2Ebool ) @ c_2Ellist_2ELFINITE_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELFINITE__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2ET )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELDROP__THM,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d] :
      ( ! [V0ll_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V2n: mono_2Etyop_2Enum_2Enum,V3h_2E0: u,V4t_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V2n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27c @ V3h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V4t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V4t_2E0 ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELFINITE__DROP,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1ll_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) ) )
        & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0n @ ( mono_2Ec_2Eoption_2ETHE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) ) ) ) ) )
     => ? [V2y_2E0: u] :
          ...
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2y_2E0 ) ) ) ) ) )).
