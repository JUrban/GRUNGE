...
thf(conj_thm_2Ecardinal_2Ecardeq__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1s: $i] :
...
thf(conj_thm_2Eordinal_2Epreds__lt__PSUBSET,lemma,(
    ! [A_27a: del,V0w1: $i] :
...
thf(conj_thm_2Eordinal_2Epreds__surj,lemma,(
    ! [A_27a: del,V0x: $i] :
     ...
     => ( ( ( p @ ( ap @ ( c_2Eordinal_2Edownward__closed @ A_27a ) @ V0x ) )
       ...
       => ? [V1y: $i] :
            ...
            & ( ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1y )
              = V0x ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Eno__maximal__ordinal,conjecture,(
    ! [A_27a: del,V0a: $i] :
