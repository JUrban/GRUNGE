...
tff(thm_2Eset__relation_2Efinite__acyclic__has__maximal,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
     ...
     => ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
       => ! [V1r_2E0: u] :
           ...
           => ? [V2x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V2x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Eset__relation_2Emaximal__elements_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0),s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),V1r_2E0))))))) ) ) ) )).
...
tff(thm_2Eset__relation_2Efinite__strict__linear__order__has__maximal,conjecture,(
