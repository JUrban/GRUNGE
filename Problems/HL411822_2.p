...
tff(conj_thm_2Ereal__topology_2ECLOSEST__POINT__SELF,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V0s))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V1x))) = V1x ) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSEST__POINT__REFL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
