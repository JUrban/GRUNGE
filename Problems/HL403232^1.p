...
thf(thm_2Ebag_2EBAG__DELETE__EMPTY,conjecture,(
    ! [A_27a: d,V0e_2E0: u,V1b_2E0: u] :
      ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__DELETE_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1b_2E0 ) ) ) ) ) )).
