...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__0,lemma,(
...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__LT,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rs1: $i] :
...
thf(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__GE,lemma,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rs1: $i] :
          ( ( mem @ V1rs1 @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
...
thf(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__SNOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( ( mem @ V0v @ A_27a )
     => ! [V1rows: $i] :
          ( ( mem @ V1rows @ ( ty_2Elist_2Elist @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ A_27b ) ) ) )
         => ! [V2c: $o,V3infos: tp__c_ty_2Elist_2Elist_o,V4r: $i] :
