...
thf(conj_thm_2Ereal__topology_2ECONDENSATION__POINT__INFINITE__BALL__CBALL,lemma,
    ( ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONDENSATION__POINT__INFINITE__CBALL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econdensation__point__of @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ V0s ) )
