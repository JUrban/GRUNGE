...
thf(conj_thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__G,conjecture,(
    ! [V0a: $i] :
         ...
         => ( ( ~ ! [V3t: tp__ty_2Enum_2Enum] :
            ...
            & ( ( ! [V5t: tp__ty_2Enum_2Enum] :
                ...
                & ! [V6t: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V2b @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V6t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
            ...
            & ( ( ! [V8t: tp__ty_2Enum_2Enum] :
                ...
                | ! [V9t: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V2b @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
            <=> ? [V10p: $i] :
