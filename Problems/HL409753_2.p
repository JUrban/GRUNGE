...
tff(conj_thm_2Eiterate_2ENSUM__BIJECTION,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: $i] :
               ...
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V0f)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V0f),V1p))) ) ) ) ) )).
