...
thf(ax_thm_2Etopology_2Etopspace,axiom,(
    ! [A_27a: del,V0top: $i] :
     ...
     => ( ( ap @ ( c_2Etopology_2Etopspace @ A_27a ) @ V0top )
        = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
            @ ( lam @ ( arr @ A_27a @ bool )
              @ ^ [V1s: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V1s ) @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ A_27a ) @ V0top ) @ V1s ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ETOPSPACE__EUCLIDEAN,conjecture,
