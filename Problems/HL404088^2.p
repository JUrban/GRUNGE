...
thf(conj_thm_2ETemporal__Logic_2EWHEN__SIMP,lemma,(
    ! [V0b: $i] :
...
thf(conj_thm_2ETemporal__Logic_2EUNTIL__SIMP,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EBEFORE__SIMP,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESWHEN__SIMP,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESUNTIL__SIMP,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESBEFORE__SIMP,lemma,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EPast__Temporal__Logic_2ESIMPLIFY,conjecture,(
    ! [V0b: $i] :
      ( ( mem @ V0b @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ( ap @ c_2ETemporal__Logic_2ENEXT
            ...
            & ( ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V63t: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V63t ) ) ) )
            ...
            & ( ( ap
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V101t: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ V0b @ V101t ) ) ) )
            ...
            & ( ( ap
              ...
              = ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V107t: $i] :
                      ( ap @ c_2Ebool_2E_7E @ ( ap @ V0b @ V107t ) ) ) ) )
            & ( ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V108t: $i] :
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V109t: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ V0b @ V109t ) ) ) )
            ...
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1a ) @ V1a )
              = ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V114t: $i] :
                      ( ap @ c_2Ebool_2E_7E @ ( ap @ V1a @ V114t ) ) ) ) ) ) ) ) )).
