...
thf(f11783_0_2E0,type,(
    f11783_0_2E0: u )).

thf(f11783_0_2E1,type,(
    f11783_0_2E1: du > u )).

thf(f11783_0_2E2,type,(
    f11783_0_2E2: du > du > u )).

thf(f11784_0_2E0,type,(
    f11784_0_2E0: u )).

thf(f11784_0_2E2,type,(
    f11784_0_2E2: du > du > u )).

thf(f11784_0_2E3,type,(
    f11784_0_2E3: du > du > du > u )).
...
thf(mono_2Ef11783_0,type,(
    mono_2Ef11783_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef11784_0,type,(
    mono_2Ef11784_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__ADD,axiom,(
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__NEG,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11783_0 @ V0p @ V1x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0p @ V1x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__NEG,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11783_0 @ V0p ) )
      = ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p ) ) )).
...
thf(def0_2Ethm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUB,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11784_0 @ V0p @ V1q @ V2x )
      = ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0p @ V2x ) @ ( V1q @ V2x ) ) ) )).

thf(thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUB,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1q: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Eiterate_2Epolynomial__function @ V0p )
        & ( mono_2Ec_2Eiterate_2Epolynomial__function @ V1q ) )
     => ( mono_2Ec_2Eiterate_2Epolynomial__function @ ( mono_2Ef11784_0 @ V0p @ V1q ) ) ) )).
