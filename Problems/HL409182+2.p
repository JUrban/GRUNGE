...
fof(lamtp_f3176,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f3176(A_27a,A_27a,V0P),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3176,axiom,(
    ! [A_27a,A_27a,V0P] :
     ...
     => ! [V1x] :
          ( mem(V1x,A_27a)
         => ap(f3176(A_27a,A_27a,V0P),V1x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V1x),V0P)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) )).

fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__EQ__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
           => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3176(A_27a,A_27a,V0P)),V0P) = ap(c_2Ereal_2Ereal__of__num,ap(c_2Epred__set_2ECARD(A_27a),V0P)) ) ) ) )).

fof(lamtp_f3177,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f3177(A_27a,A_27a,V0P),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3177,axiom,(
    ! [A_27a,A_27a,V0P] :
     ...
     => ! [V1s] :
          ( mem(V1s,A_27a)
         => ap(f3177(A_27a,A_27a,V0P),V1s) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V1s),V0P)),ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Epred__set_2ECARD(A_27a),V0P)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) )).

fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__INV__CARD__EQ__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ( ( V0P != c_2Epred__set_2EEMPTY(A_27a)
              & p(ap(c_2Epred__set_2EFINITE(A_27a),V0P)) )
           => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3177(A_27a,A_27a,V0P)),V0P) = ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) ) ) ) )).
