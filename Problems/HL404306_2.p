...
tff(conj_thm_2Ebool_2ELET__CONG,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
         ...
         => ! [V2M: $i] :
             ...
             => ! [V3N: $i] :
                 ...
                 => ( ( V2M = V3N
                   ...
                   => ap(ap(c_2Ebool_2ELET(A_27a,A_27a),V0f),V2M) = ap(ap(c_2Ebool_2ELET(A_27a,A_27a),V1g),V3N) ) ) ) ) ) )).
...
tff(conj_thm_2Earithmetic_2ELESS__EQ__LESS__TRANS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
      ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Earithmetic_2ESUB__LESS__EQ,lemma,(
...
tff(conj_thm_2Earithmetic_2EDIV__LE__MONOTONE,lemma,(
...
tff(lmtp_f1828,type,(
    f1828: ( tp__ty_2Enum_2Enum * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1828,axiom,(
    ! [V2r0: tp__ty_2Enum_2Enum,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n: tp__ty_2Enum_2Enum] : mem(f1828(V2r0,V0R,V1n),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1828,axiom,(
    ! [V2r0: tp__ty_2Enum_2Enum,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n: tp__ty_2Enum_2Enum,V3r: tp__ty_2Enum_2Enum] : ap(f1828(V2r0,V0R,V1n),inj__ty_2Enum_2Enum(V3r)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2r0)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3r)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2r0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))),inj__ty_2Enum_2Enum(V2r0)))))),ap(ap(V0R,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V3r))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))))))),inj__ty_2Enum_2Enum(V1n))) ) )).

tff(lmtp_f1827,type,(
    f1827: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f1827,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => mem(f1827(V1n,V0R),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1827,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V2r0: tp__ty_2Enum_2Enum] : ap(f1827(V1n,V0R),inj__ty_2Enum_2Enum(V2r0)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1828(V2r0,V0R,V1n)) ) )).

tff(lmtp_f1826,type,(
    f1826: $i > $i )).

tff(lamtp_f1826,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => mem(f1826(V0R),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1826,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f1826(V0R),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1827(V1n,V0R)) ) )).

tff(lmtp_f1825,type,(
    f1825: $i )).

tff(lamtp_f1825,axiom,(
    mem(f1825,arr(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)),bool)) )).

tff(lameq_f1825,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ap(f1825,V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(ty_2Enum_2Enum),V0R)),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1826(V0R))) ) )).

tff(lmtp_f1833,type,(
    f1833: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1833,axiom,(
    ! [V7r: tp__ty_2Enum_2Enum] : mem(f1833(V7r),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar))) )).

tff(lameq_f1833,axiom,(
    ! [V7r: tp__ty_2Enum_2Enum,V8s0: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : ap(f1833(V7r),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V8s0)) = ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(c_2Estring_2ECHR,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V7r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V8s0)) )).

tff(lmtp_f1832,type,(
    f1832: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1832,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a: tp__ty_2Enum_2Enum] : mem(f1832(V4n2s,V5a),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

tff(lameq_f1832,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a: tp__ty_2Enum_2Enum,V7r: tp__ty_2Enum_2Enum] : ap(f1832(V4n2s,V5a),inj__ty_2Enum_2Enum(V7r)) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),f1833(V7r)),ap(V4n2s,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V5a)),inj__ty_2Enum_2Enum(V7r))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))))) ) )).

tff(lmtp_f1831,type,(
    f1831: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1831,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a: tp__ty_2Enum_2Enum] : mem(f1831(V4n2s,V5a),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

tff(lameq_f1831,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a: tp__ty_2Enum_2Enum,V6r0: tp__ty_2Enum_2Enum] : ap(f1831(V4n2s,V5a),inj__ty_2Enum_2Enum(V6r0)) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1832(V4n2s,V5a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V6r0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))),inj__ty_2Enum_2Enum(V6r0))) ) )).

tff(lmtp_f1830,type,(
    f1830: $i > $i )).

tff(lamtp_f1830,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => mem(f1830(V4n2s),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

tff(lameq_f1830,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a: tp__ty_2Enum_2Enum] : ap(f1830(V4n2s),inj__ty_2Enum_2Enum(V5a)) = ap(c_2Ecombin_2EI(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5a)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Elist_2ENIL(ty_2Estring_2Echar)),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1831(V4n2s,V5a)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V5a)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))))))))) ) )).

tff(lmtp_f1829,type,(
    f1829: $i )).

tff(lamtp_f1829,axiom,(
    mem(f1829,arr(arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))) )).

tff(lameq_f1829,axiom,(
    ! [V4n2s: $i] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ap(f1829,V4n2s) = f1830(V4n2s) ) )).

tff(ax_thm_2Estring__num_2En2s__primitive__def,axiom,(
    c_2Estring__num_2En2s = ap(ap(c_2Erelation_2EWFREC(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emin_2E_40(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool))),f1825)),f1829) )).

tff(lmtp_f1836,type,(
    f1836: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1836,axiom,(
    ! [V2r: tp__ty_2Enum_2Enum] : mem(f1836(V2r),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar))) )).

tff(lameq_f1836,axiom,(
    ! [V2r: tp__ty_2Enum_2Enum,V3s0: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : ap(f1836(V2r),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s0)) = ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(c_2Estring_2ECHR,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V3s0)) )).

tff(lmtp_f1835,type,(
    f1835: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1835,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f1835(V0n),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) )).

tff(lameq_f1835,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V2r: tp__ty_2Enum_2Enum] : ap(f1835(V0n),inj__ty_2Enum_2Enum(V2r)) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),f1836(V2r)),ap(c_2Estring__num_2En2s,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V2r))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))))) )).

tff(lmtp_f1834,type,(
    f1834: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1834,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f1834(V0n),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) )).

tff(lameq_f1834,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1r0: tp__ty_2Enum_2Enum] : ap(f1834(V0n),inj__ty_2Enum_2Enum(V1r0)) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1835(V0n)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1r0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))))))),inj__ty_2Enum_2Enum(V1r0))) )).

tff(conj_thm_2Estring__num_2En2s__def,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(ap(c_2Estring__num_2En2s,inj__ty_2Enum_2Enum(V0n))) = surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Elist_2ENIL(ty_2Estring_2Echar)),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1834(V0n)),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))))))))) )).
