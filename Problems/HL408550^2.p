...
thf(conj_thm_2Ebinary__ieee_2Efloat__add__finite,conjecture,(
    ! [A_27a: del,A_27b: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
      ( ( mem @ V1x @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
     => ! [V2y: $i] :
          ( ( mem @ V2y @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
         => ! [V3r1: tp__ty_2Erealax_2Ereal,V4r2: tp__ty_2Erealax_2Ereal] :
              ( ( ( ( surj__ty_2Ebinary__ieee_2Efloat__value @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value @ A_27a @ A_27b ) @ V1x ) )
                  = ( surj__ty_2Ebinary__ieee_2Efloat__value @ ( ap @ c_2Ebinary__ieee_2EFloat @ ( inj__ty_2Erealax_2Ereal @ V3r1 ) ) ) )
                & ( ( surj__ty_2Ebinary__ieee_2Efloat__value @ ( ap @ ( c_2Ebinary__ieee_2Efloat__value @ A_27a @ A_27b ) @ V2y ) )
                  = ( surj__ty_2Ebinary__ieee_2Efloat__value @ ( ap @ c_2Ebinary__ieee_2EFloat @ ( inj__ty_2Erealax_2Ereal @ V4r2 ) ) ) ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__add @ A_27a @ A_27b ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ V1x ) @ V2y )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Efloat__round__with__flags @ A_27a @ A_27b ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3r1 ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4r2 ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27a @ A_27b ) @ V1x ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27a @ A_27b ) @ V2y ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27a @ A_27b ) @ V1x ) ) @ ( ap @ ( c_2Ewords_2En2w @ ty_2Eone_2Eone ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Ebinary__ieee_2Erounding ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ V0mode ) ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ fo__c_2Ebinary__ieee_2EroundTowardNegative ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V3r1 ) ) @ ( inj__ty_2Erealax_2Ereal @ V4r2 ) ) ) ) ) ) ) )).
