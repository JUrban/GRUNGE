...
thf(thm_2Efinite__map_2EIN__FRANGE__o__f__suff,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0fm_2E0: u,V1f_2E0: u,V2P_2E0: u] :
      ( ! [V3v_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFRANGE_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V0fm_2E0 ) ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ A_27a @ V3v_2E0 ) ) ) ) ) ) )
     => ! [V4v_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27c @ V4v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFRANGE_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27c ) @ ( c_2Efinite__map_2Eo__f_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V0fm_2E0 ) ) ) ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) @ ( s @ A_27c @ V4v_2E0 ) ) ) ) ) ) )).
