...
thf(arityeq1_2Emono_2Ec_2Epath_2Elast_2E1_2Emono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27c: d,A_27d: d,X0_2E0: u] :
      ( ( s @ A_27c @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X0_2E0 ) ) )
      = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ A_27c ) @ c_2Epath_2Elast_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Epath_2Elast__thm,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0x_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) ) )
          = ( s @ A_27a @ V0x_2E0 ) )
      & ! [V1x_2E0: u,V2r_2E0: u,V3p_2E0: u] :
          ( ( s @ A_27a @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27b @ V2r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) )
          = ( s @ A_27a @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) ) )).
...
thf(thm_2Epath_2Elast__pmap,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0g_2E0: u,V1f_2E0: u,V2p_2E0: u] :
     ...
     => ( ( s @ A_27c @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ ( c_2Epath_2Epmap_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V0g_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) )
        = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ A_27a @ ( c_2Epath_2Elast_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) ) ) ) )).
