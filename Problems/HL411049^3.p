      ...
      = ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V0s
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V1x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V1x @ ( c_2Ereal__topology_2Elimit__point__of @ V1x @ V0s ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2Ecomplete,axiom,(
    ...
    <=> ! [V1f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
          ( ( ! [V2n: tyop_2Enum_2Enum] :
            ...
            & ( c_2Ereal__topology_2Ecauchy @ V1f ) )
         => ? [V3l: tyop_2Erealax_2Ereal] :
...
thf(thm_2Ereal__topology_2ECOMPLETE__UNIV,conjecture,(
    c_2Ereal__topology_2Ecomplete @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) )).
