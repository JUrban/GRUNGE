...
tff(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__IMP__SUMS__BOUNDED,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ereal__topology_2Esummable,ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V1k))),V0f))
