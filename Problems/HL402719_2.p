...
tff(lamtp_f806,axiom,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
     => ! [V2l_27: tp__o] : mem(f806(A_27a,V0y,V2l_27),arr(A_27a,bool)) ) )).
...
tff(lameq_f806,axiom,(
    ! [A_27a: del,V0y: $i] :
     ...
     => ! [V2l_27: tp__o,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f806(A_27a,V0y,V2l_27),V3x) = ap(ap(c_2Ebool_2E_5C_2F,inj__o(V2l_27)),ap(ap(c_2Emin_2E_3D(A_27a),V0y),V3x)) ) ) )).

tff(lmtp_f805,type,(
    f805: ( del * $i ) > $i )).

tff(lamtp_f805,axiom,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
...
tff(lameq_f805,axiom,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
     => ! [V2l_27: tp__o] : ap(f805(A_27a,V0y),inj__o(V2l_27)) = f806(A_27a,V0y,V2l_27) ) )).

tff(conj_thm_2Erich__list_2EMEM__FOLDL,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0y),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l)))
          <=> p(ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f805(A_27a,V0y)),inj__o(fo__c_2Ebool_2EF)),V1l)) ) ) ) )).

tff(conj_thm_2Erich__list_2EMEM__FOLDL__MAP,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l)))
          <=> p(ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),c_2Ebool_2E_5C_2F),inj__o(fo__c_2Ebool_2EF)),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),ap(c_2Emin_2E_3D(A_27a),V0x)),V1l))) ) ) ) )).
