...
thf(conj_thm_2EOmega__Automata_2ENEG__DET__AUTOMATA,conjecture,(
                          ...
                          & ( p
                            @ ( ap @ V4Accept
                              @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ A_27input ) @ ( arr @ ty_2Enum_2Enum @ A_27state ) ) @ V3i )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V7t: $i] :
                                      ( ap @ V5q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V7t ) @ ( inj__ty_2Enum_2Enum @ V0t0 ) ) ) ) ) ) ) )
                  <=> ? [V8q: $i] :
                        ...
                        & ~ ( p
                            @ ( ap @ V4Accept
                              @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ A_27input ) @ ( arr @ ty_2Enum_2Enum @ A_27state ) ) @ V3i )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V10t: $i] :
                                      ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t ) @ ( inj__ty_2Enum_2Enum @ V0t0 ) ) ) ) ) ) ) ) ) ) ) ) ) )).
