...
tff(conj_thm_2Equotient__sum_2EISL__PRS,conjecture,(
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6a: $i] :
                                 ...
                                 => ( p(ap(c_2Esum_2EISL(A_27c,A_27c),V6a))
                                  <=> p(ap(c_2Esum_2EISL(A_27a,A_27a),ap(ap(ap(c_2Esum_2E_2B_2B(A_27c,A_27c,A_27c,A_27c),V2rep1),V5rep2),V6a))) ) ) ) ) ) ) ) ) ) ) )).
