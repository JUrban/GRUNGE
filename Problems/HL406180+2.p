...
fof(conj_thm_2Efcp_2ENOT__FINITE__IMP__dimindex__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2Ew2w__w2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0w] :
                  ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
                 => ap(c_2Ewords_2Ew2w(A_27b,A_27b),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),V0w)) ) ) ) ) )).
...
fof(conj_thm_2Ewords_2Ew2w__eq__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ! [V1y] :
                 ...
                 => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
                   ...
                   => ( ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0x) = ap(c_2Ewords_2En2w(A_27b),V1y)
                    <=> V0x = ap(c_2Ewords_2En2w(A_27a),V1y) ) ) ) ) ) ) )).

fof(conj_thm_2Ewords_2Eword__concat__0,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0x] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
                   ...
                   => ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),ap(c_2Ewords_2En2w(A_27b),V0x)) = ap(c_2Ewords_2En2w(A_27c),V0x) ) ) ) ) ) )).
