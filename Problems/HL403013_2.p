...
tff(conj_thm_2EindexedLists_2EMAPi__ACC__MAPi,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
tff(conj_thm_2EindexedLists_2EMAPi__compute,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(A_27b,A_27a)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27b))
         => ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),V0f),V1l) = ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),c_2Elist_2ENIL(A_27a)),V1l) ) ) )).
