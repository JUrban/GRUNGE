...
thf(thm_2Ecardinal_2EINFINITE__IMAGE__INJ,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
     ...
     => ! [V3s_2E0: u] :
         ...
         => ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3s_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ewellorder_2EWF__REC,axiom,(
    ! [A_27a: d,A_27b: d,V0_3C_3C_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EWF_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0_3C_3C_2E0 ) ) ) )
     => ! [V1H_2E0: u] :
          ( ! [V2f_2E0: u,V3g_2E0: u,V4x_2E0: u] :
              ( ! [V5z_2E0: u] :
                  ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0_3C_3C_2E0 ) @ ( s @ A_27a @ V5z_2E0 ) ) ) @ ( s @ A_27a @ V4x_2E0 ) ) ) )
                 => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f_2E0 ) @ ( s @ A_27a @ V5z_2E0 ) ) )
                    = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3g_2E0 ) @ ( s @ A_27a @ V5z_2E0 ) ) ) ) )
             => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V1H_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V2f_2E0 ) ) ) @ ( s @ A_27a @ V4x_2E0 ) ) )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V1H_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3g_2E0 ) ) ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) )
         => ? [V6f_2E0: u] :
            ! [V7x_2E0: u] :
              ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V6f_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) ) )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V1H_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V6f_2E0 ) ) ) @ ( s @ A_27a @ V7x_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2EWF__num,axiom,(
    mono_2Ec_2Erelation_2EWF_2Emono_2Etyop_2Enum_2Enum @ mono_2Ec_2Eprim__rec_2E_3C )).

thf(thm_2Ecardinal_2EINFINITE__CARD__LE,conjecture,(
    ! [A_27a: d,V0A_2E0: u] :
