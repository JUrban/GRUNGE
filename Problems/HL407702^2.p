...
thf(tp_c_2EordinalNotation_2Efinp,type,(
    c_2EordinalNotation_2Efinp: $i )).

thf(mem_c_2EordinalNotation_2Efinp,axiom,(
    mem @ c_2EordinalNotation_2Efinp @ ( arr @ ty_2EordinalNotation_2Eosyntax @ bool ) )).

thf(stp_fo_c_2EordinalNotation_2Efinp,type,(
    fo__c_2EordinalNotation_2Efinp: tp__ty_2EordinalNotation_2Eosyntax > $o )).

thf(stp_eq_fo_c_2EordinalNotation_2Efinp,axiom,(
    ! [X0: tp__ty_2EordinalNotation_2Eosyntax] :
      ( ( inj__o @ ( fo__c_2EordinalNotation_2Efinp @ X0 ) )
      = ( ap @ c_2EordinalNotation_2Efinp @ ( inj__ty_2EordinalNotation_2Eosyntax @ X0 ) ) ) )).
...
thf(conj_thm_2EordNotationSemantics_2Eord__less__models__ordlt,lemma,(
    ! [A_27a: del,V0x: tp__ty_2EordinalNotation_2Eosyntax] :
      ( ( p @ ( ap @ c_2EordinalNotation_2Eis__ord @ ( inj__ty_2EordinalNotation_2Eosyntax @ V0x ) ) )
     => ( ! [V1y: tp__ty_2EordinalNotation_2Eosyntax] :
        ...
        & ( ~ ( p @ ( ap @ c_2EordinalNotation_2Efinp @ ( inj__ty_2EordinalNotation_2Eosyntax @ V0x ) ) )
         => ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2EordNotationSemantics_2EordModel @ A_27a ) @ ( ap @ c_2EordinalNotation_2Etail @ ( inj__ty_2EordinalNotation_2Eosyntax @ V0x ) ) ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ ( ap @ ( c_2EordNotationSemantics_2EordModel @ A_27a ) @ ( ap @ c_2EordinalNotation_2Eexpt @ ( inj__ty_2EordinalNotation_2Eosyntax @ V0x ) ) ) ) ) ) ) ) ) )).
...
thf(ax_thm_2EordinalNotation_2Efinp__def,axiom,
    ( ! [V0v0: tp__ty_2Enum_2Enum] :
        ( ( p @ ( ap @ c_2EordinalNotation_2Efinp @ ( ap @ c_2EordinalNotation_2EEnd @ ( inj__ty_2Enum_2Enum @ V0v0 ) ) ) )
      <=> $true )
    & ! [V1v1: tp__ty_2EordinalNotation_2Eosyntax,V2v2: tp__ty_2Enum_2Enum,V3v3: tp__ty_2EordinalNotation_2Eosyntax] :
        ( ( p @ ( ap @ c_2EordinalNotation_2Efinp @ ( ap @ ( ap @ ( ap @ c_2EordinalNotation_2EPlus @ ( inj__ty_2EordinalNotation_2Eosyntax @ V1v1 ) ) @ ( inj__ty_2Enum_2Enum @ V2v2 ) ) @ ( inj__ty_2EordinalNotation_2Eosyntax @ V3v3 ) ) ) )
      <=> $false ) )).

thf(ax_thm_2EordinalNotation_2Etail__def,axiom,(
    ! [V0e: tp__ty_2EordinalNotation_2Eosyntax,V1k: tp__ty_2Enum_2Enum,V2t: tp__ty_2EordinalNotation_2Eosyntax] :
      ( ( surj__ty_2EordinalNotation_2Eosyntax @ ( ap @ c_2EordinalNotation_2Etail @ ( ap @ ( ap @ ( ap @ c_2EordinalNotation_2EPlus @ ( inj__ty_2EordinalNotation_2Eosyntax @ V0e ) ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) @ ( inj__ty_2EordinalNotation_2Eosyntax @ V2t ) ) ) )
      = V2t ) )).
...
thf(conj_thm_2EordNotationSemantics_2Etail__dominated,conjecture,(
