...
thf(conj_thm_2Eordinal_2Estrict__continuity__preserves__islimit,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ( ( ! [V2s: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardleq @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ V2s ) @ ( c_2Epred__set_2EUNIV @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) ) )
                      & ( V2s
                       != ( c_2Epred__set_2EEMPTY @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) )
                   => ( ( ap @ V0f @ ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ V2s ) )
                      = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0f ) @ V2s ) ) ) ) )
              & ! [V3x: $i] :
              ...
              & ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V1a ) )
                = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
              & ( V1a
               != ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
           => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ V0f @ V1a ) ) )
              = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2Eadd__omega__islimit,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V0a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) ) )
        = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) )).
