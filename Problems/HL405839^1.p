...
thf(thm_2Ebit_2EBITWISE__THM,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2op: $o > $o > $o,V3a: mono_2Etyop_2Enum_2Enum,V4b: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0x @ V1n )
     => ( ( mono_2Ec_2Ebit_2EBIT @ V0x @ ( mono_2Ec_2Ebit_2EBITWISE @ V1n @ V2op @ V3a @ V4b ) )
        = ( V2op @ ( mono_2Ec_2Ebit_2EBIT @ V0x @ V3a ) @ ( mono_2Ec_2Ebit_2EBIT @ V0x @ V4b ) ) ) ) )).
...
thf(thm_2Esum__num_2ESUM__FUN__EQUAL,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V2g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
      ( ! [V3x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3x @ V0n )
         => ( ( V1f @ V3x )
            = ( V2g @ V3x ) ) )
     => ( ( mono_2Ec_2Esum__num_2ESUM @ V0n @ V1f )
        = ( mono_2Ec_2Esum__num_2ESUM @ V0n @ V2g ) ) ) )).
...
thf(thm_2Ewords_2EWORD__ADD__OR,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u] :
      ( ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__and_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) )
     ...
     => ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__add_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__or_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) ) ) ) )).
