...
fof(conj_thm_2Ebit_2EBITS__COMP__THM,lemma,(
    ! [V0h1] :
...
fof(lamtp_f251,axiom,(
    mem(f251,arr(bool,arr(bool,bool))) )).

fof(lameq_f251,axiom,(
    ! [V3x] :
      ( mem(V3x,bool)
     => ap(f251,V3x) = k(bool,ap(c_2Ebool_2E_7E,V3x)) ) )).

fof(conj_thm_2Ebit_2EBITWISE__ONE__COMP__LEM,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1a] :
          ( mem(V1a,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__msb__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2ETWO__COMP__NEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
         => ( p(ap(c_2Ewords_2Eword__msb(A_27a),V0a))
           => p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V0a),c_2Ewords_2Eword__L(A_27a)))),ap(c_2Ewords_2Eword__msb(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a))),ap(c_2Ebool_2E_7E,ap(c_2Ewords_2Eword__msb(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a))))) ) ) ) )).
