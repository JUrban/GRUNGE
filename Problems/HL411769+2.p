...
fof(conj_thm_2Earithmetic_2ESUB__LESS,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ereal__topology_2ESUMS__FINITE__DIFF,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESUMS__OFFSET,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
