...
thf(f8857_0_2E0,type,(
    f8857_0_2E0: u )).

thf(f8857_0_2E1,type,(
    f8857_0_2E1: du > u )).

thf(f8857_0_2E2,type,(
    f8857_0_2E2: du > du > u )).
...
thf(mono_2Ef8857_0,type,(
    mono_2Ef8857_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(thm_2Ereal_2Einf__def,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o] :
      ...
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ef8857_0 @ V0p ) ) ) ) )).
...
thf(thm_2Ereal_2EREAL__IMP__INF__LE,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o,V1r: mono_2Etyop_2Erealax_2Ereal] :
