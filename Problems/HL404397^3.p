...
thf(thm_2Epred__set_2Ecountable__image__nats,axiom,(
    ! [A_27a: $tType,V0f: tyop_2Enum_2Enum > A_27a] :
      ( c_2Epred__set_2Ecountable @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ A_27a @ V0f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) )).
...
thf(thm_2Ecardinal_2Edisjoint__countable__decomposition,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( (~) @ ( c_2Epred__set_2EFINITE @ A_27a @ V0s ) )
     => ? [V1A: ( A_27a > $o ) > $o] :
