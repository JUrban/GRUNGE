...
thf(thm_2Elift__ieee_2Eis__closest__exits,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0x: tyop_2Erealax_2Ereal,V1s: ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) > $o] :
      ( ( c_2Epred__set_2EFINITE @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1s )
     => ( ( (~)
          @ ( V1s
            = ( c_2Epred__set_2EEMPTY @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) ) )
       => ? [V2a: tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b] :
            ( c_2Ebinary__ieee_2Eis__closest @ A_27a @ A_27b @ V1s @ V0x @ V2a ) ) ) )).
...
thf(thm_2Elift__ieee_2Eclosest__is__everything,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0p: ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) > $o,V1s: ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) > $o,V2x: tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2EFINITE @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1s )
     => ( ( (~)
          @ ( V1s
            = ( c_2Epred__set_2EEMPTY @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) ) )
       => ( ( c_2Ebinary__ieee_2Eis__closest @ A_27a @ A_27b @ V1s @ V2x @ ( c_2Ebinary__ieee_2Eclosest__such @ A_27a @ A_27b @ V0p @ V1s @ V2x ) )
          & ( ? [V3b: tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b] :
                ( ( c_2Ebinary__ieee_2Eis__closest @ A_27a @ A_27b @ V1s @ V2x @ V3b )
                & ( V0p @ V3b ) )
           => ( V0p @ ( c_2Ebinary__ieee_2Eclosest__such @ A_27a @ A_27b @ V0p @ V1s @ V2x ) ) ) ) ) ) )).
