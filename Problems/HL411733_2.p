...
tff(conj_thm_2Ereal__topology_2ESERIES__UNIQUE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2l_27: tp__ty_2Erealax_2Ereal,V3s: $i] :
          ( mem(V3s,arr(ty_2Enum_2Enum,bool))
         => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1l)),V3s))
              & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V2l_27)),V3s)) )
           => V1l = V2l_27 ) ) ) )).
