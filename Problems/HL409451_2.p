...
tff(conj_thm_2Efloat_2ECLOSEST__IS__EVERYTHING,lemma,(
    ! [V0v: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2s: $i] :
              ( mem(V2s,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))
             => ! [V3x: tp__ty_2Erealax_2Ereal] :
                  ( p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V2s))
                 => ( V2s != c_2Epred__set_2EEMPTY(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
                   => ( p(ap(ap(ap(ap(c_2Eieee_2Eis__closest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V2s),inj__ty_2Erealax_2Ereal(V3x)),ap(ap(ap(ap(c_2Eieee_2Eclosest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V1p),V2s),inj__ty_2Erealax_2Ereal(V3x))))
                      & ( ? [V4b: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
                            ( p(ap(ap(ap(ap(c_2Eieee_2Eis__closest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V2s),inj__ty_2Erealax_2Ereal(V3x)),inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V4b)))
                            & p(ap(V1p,inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(V4b))) )
                       => p(ap(V1p,ap(ap(ap(ap(c_2Eieee_2Eclosest(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),V0v),V1p),V2s),inj__ty_2Erealax_2Ereal(V3x)))) ) ) ) ) ) ) ) )).

tff(conj_thm_2Efloat_2ECLOSEST__IS__CLOSEST,conjecture,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
          ( mem(V1p,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))
