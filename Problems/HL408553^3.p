        ...
        @ ^ [V3v: tyop_2Ebinary__ieee_2Efloat__value,V4v1: tyop_2Ebinary__ieee_2Efloat__value] :
            ...
            @ ^ [V5r1: tyop_2Erealax_2Ereal] :
                ...
                @ ^ [V6r2: tyop_2Erealax_2Ereal] :
                    ( c_2Ebinary__ieee_2Efloat__round__with__flags @ A_27t @ A_27w @ V0mode @ ( c_2Ebool_2ECOND @ $o @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V5r1 @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V6r2 @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) @ ( c_2Emin_2E_3D @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27t @ A_27w @ V1x ) @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27t @ A_27w @ V2y ) ) ) ) @ ( c_2Emin_2E_3D @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ ( c_2Ebinary__ieee_2Efloat__Sign @ A_27t @ A_27w @ V1x ) @ ( c_2Ewords_2En2w @ tyop_2Eone_2Eone @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Emin_2E_3D @ tyop_2Ebinary__ieee_2Erounding @ V0mode @ c_2Ebinary__ieee_2EroundTowardNegative ) ) @ ( c_2Erealax_2Ereal__add @ V5r1 @ V6r2 ) )
