...
thf(tp_c_2Ebit_2EBIT__MODIFY,type,(
    c_2Ebit_2EBIT__MODIFY: $i )).

thf(mem_c_2Ebit_2EBIT__MODIFY,axiom,(
...
thf(ax_thm_2Ebit_2EBIT__MODIFY__def,axiom,
    ( ! [V0f: $i] :
        ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ( arr @ bool @ bool ) ) )
       => ! [V1x: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBIT__MODIFY @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0f ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) )
            = fo__c_2Enum_2E0 ) )
    & ! [V2n: tp__ty_2Enum_2Enum,V3f: $i] :
        ( ( mem @ V3f @ ( arr @ ty_2Enum_2Enum @ ( arr @ bool @ bool ) ) )
       => ! [V4x: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBIT__MODIFY @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V3f ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBIT__MODIFY @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3f ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) @ ( ap @ ( ap @ c_2Ebit_2ESBIT @ ( ap @ ( ap @ V3f @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ ( ap @ c_2Ebit_2EBIT @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) )).
...
thf(conj_thm_2Enumeral__bit_2EBIT__MODIFY__EVAL,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ( arr @ bool @ bool ) ) )
     => ! [V2n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBIT__MODIFY @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V1f ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EBIT__MODF @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V1f ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )).
