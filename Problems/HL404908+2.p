    ...
    ! [A_27a,V1t] :
     ...
     => ! [V0x] :
         ...
         => ! [V2n] :
             ...
             => ap(f2013(A_27a,V1t,V0x),V2n) = ap(ap(ap(c_2Elbtree_2Edepth(A_27a),V0x),V1t),V2n) ) ) ) )).
...
fof(ax_thm_2Elbtree_2Emindepth__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0x] :
         ...
         => ! [V1t] :
              ( mem(V1t,ty_2Elbtree_2Elbtree(A_27a))
             => ap(ap(c_2Elbtree_2Emindepth(A_27a),V0x),V1t) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(ty_2Enum_2Enum)),ap(ap(c_2Elbtree_2Emem(A_27a),V0x),V1t)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(c_2Ewhile_2ELEAST,f2013(A_27a,V1t,V0x)))),c_2Eoption_2ENONE(ty_2Enum_2Enum)) ) ) ) )).

fof(conj_thm_2Elbtree_2Emem__mindepth,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
