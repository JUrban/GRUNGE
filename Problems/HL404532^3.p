...
thf(thm_2Ecardinal_2ECARD__LE__ADD,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,V0s: A_27a > $o,V1s_27: A_27b > $o,V2t: A_27c > $o,V3t_27: A_27d > $o] :
     ...
     => ( c_2Ecardinal_2Ecardleq @ ( tyop_2Esum_2Esum @ A_27a @ A_27c ) @ ( tyop_2Esum_2Esum @ A_27b @ A_27d ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27c @ V0s @ V2t ) @ ( c_2Ecardinal_2E_2B__c @ A_27b @ A_27d @ V1s_27 @ V3t_27 ) ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD__CONG,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,V0s: A_27a > $o,V1s_27: A_27b > $o,V2t: A_27c > $o,V3t_27: A_27d > $o] :
