...
tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__SING,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__zero,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Elebesgue_2Epsfis__zero,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
