...
thf(f12745_0_2E0,type,(
    f12745_0_2E0: u )).

thf(f12745_0_2E1,type,(
    f12745_0_2E1: du > u )).

thf(f12745_1_2E0,type,(
    f12745_1_2E0: u )).

thf(f12745_1_2E1,type,(
    f12745_1_2E1: du > u )).
...
thf(mono_2Ef12745_0,type,(
    mono_2Ef12745_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12745_1,type,(
    mono_2Ef12745_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EINTERIOR__NEGATIONS,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12745_1 @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ V2x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EINTERIOR__NEGATIONS,axiom,(
...
thf(thm_2Ereal__topology_2EINTERIOR__NEGATIONS,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Einterior @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef12745_0 @ V0s ) )
      = ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef12745_1 @ ( mono_2Ec_2Ereal__topology_2Einterior @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2ESYMMETRIC__INTERIOR,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__neg @ V1x ) @ V0s ) )
     => ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V2x @ ( mono_2Ec_2Ereal__topology_2Einterior @ V0s ) )
         => ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__neg @ V2x ) @ ( mono_2Ec_2Ereal__topology_2Einterior @ V0s ) ) ) ) )).
