...
tff(conj_thm_2Ecomparison_2Elist__cmp__good,lemma,(
    ! [A_27a: del,V0cmp: $i] :
...
tff(conj_thm_2Ecomparison_2Echar__cmp__good,lemma,(
    p(ap(c_2Ecomparison_2Egood__cmp(ty_2Estring_2Echar),c_2EternaryComparisons_2Echar__compare)) )).

tff(conj_thm_2Ecomparison_2Estring__cmp__good,conjecture,(
