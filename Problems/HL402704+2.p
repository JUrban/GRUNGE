...
fof(conj_thm_2Erich__list_2ESEG__LENGTH__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Elist_2ELENGTH(A_27a),V0l)),c_2Enum_2E0),V0l) = V0l ) ) )).
...
fof(conj_thm_2Erich__list_2ELASTN__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2ELASTN(A_27a),V0n),V1l) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V1l)),V0n)),V1l) ) ) ) ) )).
