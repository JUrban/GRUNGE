...
fof(conj_thm_2Ereal__topology_2ESPAN__EMPTY,lemma,(
...
fof(conj_thm_2Ereal__topology_2ESPAN__SUB,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EINDEPENDENT__INSERT,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ESPAN__BREAKDOWN__EQ,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1a] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND__LEMMA,conjecture,(
    ! [V0f] :
