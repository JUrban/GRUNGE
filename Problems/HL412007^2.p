...
thf(ax_thm_2Elebesgue_2Efn__seq__def,axiom,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Elebesgue_2Efn__seq @ A_27a ) @ V0m ) @ V1f )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V2n: $i] :
                  ( lam @ A_27a
                  @ ^ [V3x: $i] :
                      ( ap
                      @ ( ap @ c_2Eextreal_2Eextreal__add
                        @ ( ap
                          @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ ty_2Enum_2Enum )
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V4k: $i] :
                                  ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__div @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V4k ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__pow @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) ) )
                                  @ ( ap
                                    @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a )
                                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                        @ ( lam @ A_27a
                                          @ ^ [V5x: $i] :
                                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__div @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V4k ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__pow @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) ) ) @ ( ap @ V1f @ V5x ) ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ V1f @ V5x ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__div @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V4k ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__pow @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) ) ) ) ) ) ) ) )
                                    @ V3x ) ) ) )
                          @ ( ap @ c_2Epred__set_2Ecount @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) ) ) )
                      @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__pow @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) )
                        @ ( ap
                          @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                              @ ( lam @ A_27a
                                @ ^ [V6x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V6x ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__pow @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2n ) ) @ ( ap @ V1f @ V6x ) ) ) ) ) ) )
                          @ V3x ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EFINITE__COUNT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Enum_2Enum ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Elemma__fn__4,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
