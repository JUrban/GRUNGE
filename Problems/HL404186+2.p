...
fof(conj_thm_2Epath_2Efinite__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1i] :
                 ...
                 => ! [V2j] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1i),V2j))
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2j),ap(c_2Epath_2EPL(A_27a,A_27a),V0p))) )
                       => p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V1i),V2j),V0p))) ) ) ) ) ) ) )).
