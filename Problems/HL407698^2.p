...
thf(ax_thm_2Efrac_2Efrac__mul__def,axiom,(
    ! [V0f1: tp__ty_2Efrac_2Efrac,V1f2: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__mul @ ( inj__ty_2Efrac_2Efrac @ V0f1 ) ) @ ( inj__ty_2Efrac_2Efrac @ V1f2 ) ) )
...
thf(conj_thm_2Efrac_2EFRAC__MUL__SAVE,conjecture,(
    ! [V0a1: tp__ty_2Einteger_2Eint,V1b1: tp__ty_2Enum_2Enum,V2a2: tp__ty_2Einteger_2Eint,V3b2: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__mul @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ V0a1 ) ) @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ V2a2 ) ) @ ( inj__ty_2Enum_2Enum @ V3b2 ) ) ) )
      = ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0a1 ) ) @ ( inj__ty_2Einteger_2Eint @ V2a2 ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) @ ( inj__ty_2Enum_2Enum @ V3b2 ) ) ) @ ( inj__ty_2Enum_2Enum @ V1b1 ) ) ) @ ( inj__ty_2Enum_2Enum @ V3b2 ) ) ) ) ) )).
