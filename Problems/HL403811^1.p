...
thf(thm_2Ellist_2ELHDTL__EQ__SOME,conjecture,(
    ! [A_27a: d,V0h_2E0: u,V1t_2E0: u,V2ll_2E0: u] :
      ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 )
        = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) )
    <=> ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0h_2E0 ) ) ) )
        & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
