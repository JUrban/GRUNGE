...
tff(conj_thm_2Eset__relation_2Etransitive__tc,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ( p(ap(c_2Eset__relation_2Etransitive(A_27a),V0r))
       => ap(c_2Eset__relation_2Etc(A_27a),V0r) = V0r ) ) )).

tff(conj_thm_2Eset__relation_2Estrict__partial__order,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
...
tff(conj_thm_2Eset__relation_2Estrict__partial__order__acyclic,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
