...
thf(conj_thm_2Ereal_2ESUM__SUBST,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
              ( ! [V4p: tp__ty_2Enum_2Enum] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4p ) ) )
                    = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4p ) ) ) ) )
...
thf(conj_thm_2Epowser_2ETERMDIFF__LEMMA1,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1z: tp__ty_2Erealax_2Ereal,V2h: tp__ty_2Erealax_2Ereal] :
      ...
      = ( surj__ty_2Erealax_2Ereal
        @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V4p: $i] :
                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) @ V4p ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) @ ( inj__ty_2Erealax_2Ereal @ V2h ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V4p ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V1z ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V4p ) ) ) ) ) ) ) ) )).
