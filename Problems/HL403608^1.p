...
thf(f4053_0_2E0,type,(
    f4053_0_2E0: u )).

thf(f4053_0_2E1,type,(
    f4053_0_2E1: du > u )).

thf(f4053_0_2E2,type,(
    f4053_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4053_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( f4053_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ f4053_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4053_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4053_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X1_2E0 ) ) ) )
...
thf(arityeq1_2Emono_2Ec_2Emin_2E_40_2E1_2Emono_2Etyop_2Efcp_2Ecart_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) ) @ c_2Emin_2E_40_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Efcp_2EFCP,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4053_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0x_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V1f_2E0 ) ) ) )
    <=> ! [V2i: mono_2Etyop_2Enum_2Enum] :
         ...
         => ( ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) ) )
            = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0x_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) ) ) ) ) ) )).

thf(thm_2Efcp_2EFCP,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0x_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( f4053_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0x_2E0 ) ) ) ) ) ) )).
