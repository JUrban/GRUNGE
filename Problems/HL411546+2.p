...
fof(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__BALL,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__INTERVAL__OPEN__INTERVAL,conjecture,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ( p(ap(c_2Ereal__topology_2EOpen,V0s))
        <=> ! [V1x] :
             ...
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
               => ? [V2a] :
                    ...
                    & ? [V3b] :
                        ...
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b))))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))),V0s)) ) ) ) ) ) )
    & ! [V4s] :
        ( mem(V4s,arr(ty_2Erealax_2Ereal,bool))
       => ( p(ap(c_2Ereal__topology_2EOpen,V4s))
        <=> ! [V5x] :
              ( mem(V5x,ty_2Erealax_2Ereal)
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V4s))
               => ? [V6a] :
                    ( mem(V6a,ty_2Erealax_2Ereal)
                    & ? [V7b] :
                        ( mem(V7b,ty_2Erealax_2Ereal)
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V6a),V7b))))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V6a),V7b))),V4s)) ) ) ) ) ) ) )).
