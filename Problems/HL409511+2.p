...
fof(ax_thm_2Epred__set_2EUNIV__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Epred__set_2EUNIV(A_27a) = k(A_27a,c_2Ebool_2ET) ) )).
...
fof(lamtp_f3246,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3246(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f3246,axiom,(
    ! [V0c] :
     ...
     => ! [V1x] :
         ...
         => ap(f3246(V0c),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Erealax_2Ereal__lt,V0c),V1x)) ) ) )).

fof(lamtp_f3247,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3247(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f3247,axiom,(
    ! [V0c] :
     ...
     => ! [V2x] :
         ...
         => ap(f3247(V0c),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(ap(c_2Ereal_2Ereal__lte,V2x),V0c)) ) ) )).

fof(conj_thm_2Eutil__prob_2EPREIMAGE__REAL__COMPL1,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => ap(c_2Epred__set_2ECOMPL(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3246(V0c))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3247(V0c)) ) )).
