...
tff(conj_thm_2Ereal__topology_2ESEPARATE__POINT__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
         ...
         => ? [V2d: tp__ty_2Erealax_2Ereal] :
              ...
              & ! [V3x: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2d)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V3x))))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESEPARATE__COMPACT__CLOSED,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
