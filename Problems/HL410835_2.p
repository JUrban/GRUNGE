...
tff(lmtp_f3721,type,(
    f3721: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3721,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f3721(V0x),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3721,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : ap(f3721(V0x),inj__ty_2Erealax_2Ereal(V1y)) = ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)) )).

tff(lmtp_f3720,type,(
    f3720: $i )).

tff(lamtp_f3720,axiom,(
    mem(f3720,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

tff(lameq_f3720,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3720,inj__ty_2Erealax_2Ereal(V0x)) = f3721(V0x) )).

tff(ax_thm_2Ereal__topology_2Eat__neginfinity,axiom,(
    surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(c_2Ereal__topology_2Eat__neginfinity) = surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Emk__net(ty_2Erealax_2Ereal),f3720)) )).

tff(conj_thm_2Ereal__topology_2EAT__NEGINFINITY,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
