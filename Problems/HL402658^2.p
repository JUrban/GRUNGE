...
thf(conj_thm_2Erich__list_2EFILTER__FLAT,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ A_27a ) ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ V1l ) )
            = ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) ) @ V1l ) ) ) ) ) )).
