...
thf(f12762_0_2E0,type,(
    f12762_0_2E0: u )).

thf(f12762_0_2E1,type,(
    f12762_0_2E1: du > u )).

thf(f12762_0_2E2,type,(
    f12762_0_2E2: du > du > u )).

thf(f12762_1_2E0,type,(
    f12762_1_2E0: u )).

thf(f12762_1_2E2,type,(
...
thf(mono_2Ef12762_0,type,(
    mono_2Ef12762_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef12762_1,type,(
    mono_2Ef12762_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2Einterior,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal,V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef12762_1 @ V1x @ V0s )
...
thf(def1_2Ethm_2Ereal__topology_2Einterior,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12762_0 @ V0s @ V1x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1x @ ( mono_2Ef12762_1 @ V1x @ V0s ) ) ) )).

thf(thm_2Ereal__topology_2Einterior,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Einterior @ V0s )
      = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12762_0 @ V0s ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__AT,axiom,(
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__INTERIOR,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ V0f @ V1s )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V2x @ ( mono_2Ec_2Ereal__topology_2Einterior @ V1s ) ) )
     => ( mono_2Ec_2Ereal__topology_2Econtinuous_2Emono_2Etyop_2Erealax_2Ereal @ V0f @ ( mono_2Ec_2Ereal__topology_2Eat @ V2x ) ) ) )).
