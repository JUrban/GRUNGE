...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__NO__LIMPT,lemma,(
    ! [V0f] :
     ...
     => ! [V1s] :
         ...
         => ( ~ ? [V2x] :
                  ...
                  & p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V2x),V1s)) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__FINITE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
