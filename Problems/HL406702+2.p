...
fof(conj_thm_2Einteger_2EINT__LE__01,lemma,(
...
fof(conj_thm_2Einteger_2EINT__LE__SUB__LADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__MOD__UNIQUE,lemma,(
    ! [V0i] :
     ...
     => ! [V1j] :
         ...
         => ! [V2m] :
             ...
             => ( ? [V3q] :
               ...
               => ap(ap(c_2Einteger_2Eint__mod,V0i),V1j) = V2m ) ) ) ) )).

fof(conj_thm_2Einteger_2EINT__MOD__COMMON__FACTOR,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Einteger_2Eint)
     => ( V0p != ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
       => ! [V1q] :
...
fof(conj_thm_2Eint__arith_2Emove__sub,lemma,(
    ! [V0c] :
...
fof(conj_thm_2Eint__arith_2ENOT__INT__DIVIDES,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Einteger_2Eint)
     => ! [V1d] :
