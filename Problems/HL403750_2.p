...
tff(tp_c_2Estring_2ETOCHAR,type,(
    c_2Estring_2ETOCHAR: $i )).

tff(mem_c_2Estring_2ETOCHAR,axiom,(
    mem(c_2Estring_2ETOCHAR,arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Estring_2Echar)) )).

tff(stp_fo_c_2Estring_2ETOCHAR,type,(
    fo__c_2Estring_2ETOCHAR: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar > tp__ty_2Estring_2Echar )).

tff(stp_eq_fo_c_2Estring_2ETOCHAR,axiom,(
    ! [X0: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : inj__ty_2Estring_2Echar(fo__c_2Estring_2ETOCHAR(X0)) = ap(c_2Estring_2ETOCHAR,inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(X0)) )).

tff(lmtp_f1127,type,(
    f1127: $i )).

tff(lamtp_f1127,axiom,(
    mem(f1127,arr(arr(ty_2Elist_2Elist(ty_2Estring_2Echar),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),bool)),bool)) )).

tff(lameq_f1127,axiom,(
    ! [V0R: $i] :
...
tff(lmtp_f1130,type,(
    f1130: tp__ty_2Estring_2Echar > $i )).

tff(lamtp_f1130,axiom,(
    ! [V3c: tp__ty_2Estring_2Echar] : mem(f1130(V3c),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Estring_2Echar)) )).

tff(lameq_f1130,axiom,(
    ! [V3c: tp__ty_2Estring_2Echar,V4v1: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : ap(f1130(V3c),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V4v1)) = ap(ap(ap(c_2Elist_2Elist__CASE(ty_2Estring_2Echar,ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V4v1)),ap(c_2Ecombin_2EI(ty_2Estring_2Echar),inj__ty_2Estring_2Echar(V3c))),k(ty_2Estring_2Echar,k(ty_2Elist_2Elist(ty_2Estring_2Echar),c_2Ebool_2EARB(ty_2Estring_2Echar)))) )).

tff(lmtp_f1129,type,(
    f1129: $i )).

tff(lamtp_f1129,axiom,(
    mem(f1129,arr(ty_2Estring_2Echar,arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Estring_2Echar))) )).

tff(lameq_f1129,axiom,(
    ! [V3c: tp__ty_2Estring_2Echar] : ap(f1129,inj__ty_2Estring_2Echar(V3c)) = f1130(V3c) )).

tff(lmtp_f1128,type,(
    f1128: $i )).

tff(lamtp_f1128,axiom,(
    mem(f1128,arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Estring_2Echar)) )).

tff(lameq_f1128,axiom,(
    ! [V2a: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] : ap(f1128,inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V2a)) = ap(ap(ap(c_2Elist_2Elist__CASE(ty_2Estring_2Echar,ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V2a)),c_2Ebool_2EARB(ty_2Estring_2Echar)),f1129) )).

tff(ax_thm_2Estring_2ETOCHAR__primitive__def,axiom,(
...
tff(conj_thm_2Estring_2ETOCHAR__def,conjecture,(
    ! [V0c: tp__ty_2Estring_2Echar] : surj__ty_2Estring_2Echar(ap(c_2Estring_2ETOCHAR,ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),inj__ty_2Estring_2Echar(V0c)),c_2Elist_2ENIL(ty_2Estring_2Echar)))) = V0c )).
