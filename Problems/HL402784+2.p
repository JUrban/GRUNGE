...
fof(conj_thm_2Erich__list_2ESEG1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
         ...
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0n),V1l) = ap(ap(c_2Elist_2ECONS(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V0n),V1l)),c_2Elist_2ENIL(A_27a)) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EEL__SEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Elist_2EEL(A_27a),V0n),V1l) = ap(c_2Elist_2EHD(A_27a),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0n),V1l)) ) ) ) ) )).
