...
fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__INDICATOR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                      ...
                      & ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Espace(A_27a),V0a)))
                           => ap(V2f,V3x) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1A),V3x) ) ) )
...
fof(lamtp_f3588,axiom,(
    ! [A_27a,V2s] :
      ( mem(V2s,arr(A_27a,bool))
     => ! [V1z] :
          ( mem(V1z,ty_2Erealax_2Ereal)
         => mem(f3588(A_27a,V2s,V1z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3588,axiom,(
    ! [A_27a,V2s] :
     ...
     => ! [V1z] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3588(A_27a,V2s,V1z),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1z)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V2s),V3x)) ) ) ) )).

fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__CMUL__INDICATOR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
