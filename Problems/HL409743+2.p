...
fof(lameq_f3318,axiom,(
    ! [A_27a,V2f] :
     ...
     => ! [V0P] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3318(A_27a,V2f,V0P),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(V0P,V4x)),ap(V2f,V4x)),c_2Enum_2E0) ) ) ) )).

fof(conj_thm_2Eiterate_2ENSUM__RESTRICT__SET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1s] :
             ...
             => ! [V2f] :
                  ( mem(V2f,arr(A_27a,ty_2Enum_2Enum))
                 => ap(ap(c_2Eiterate_2Ensum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3317(A_27a,V0P,V1s))),V2f) = ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3318(A_27a,V2f,V0P)) ) ) ) ) )).
...
fof(conj_thm_2Eiterate_2ENSUM__NSUM__RESTRICT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
