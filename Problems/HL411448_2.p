...
tff(conj_thm_2Ereal__topology_2EBOUNDED__HAS__SUP,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
      <=> ! [V1x: tp__ty_2Erealax_2Ereal] :
            ( ! [V2e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V3x_27: tp__ty_2Erealax_2Ereal] :
                    ...
                    & V3x_27 != V1x
                    & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V3x_27)),inj__ty_2Erealax_2Ereal(V1x)))),inj__ty_2Erealax_2Ereal(V2e))) ) )
           => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V0s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__ATTAINS__SUP,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
          & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
       => ? [V1x: tp__ty_2Erealax_2Ereal] :
            ...
            & ! [V2y: tp__ty_2Erealax_2Ereal] :
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V1x))) ) ) ) ) )).
