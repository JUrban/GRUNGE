...
fof(conj_thm_2Earithmetic_2EEXP__BASE__LT__MONO,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Einteger_2EINT__SUB__LNEG,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ap(ap(c_2Einteger_2Eint__sub,ap(c_2Einteger_2Eint__neg,V0x)),V1y) = ap(c_2Einteger_2Eint__neg,ap(ap(c_2Einteger_2Eint__add,V0x),V1y)) ) ) )).
...
fof(conj_thm_2Einteger__word_2Ew2i__ge,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
