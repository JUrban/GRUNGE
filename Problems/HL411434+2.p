...
fof(conj_thm_2Ereal__topology_2ECOMPONENTS__INTERMEDIATE__SUBSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2ECLOPEN__BIGUNION__COMPONENTS,lemma,(
    ! [V0u] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2ECLOPEN__IN__COMPONENTS,conjecture,(
    ! [V0u] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
