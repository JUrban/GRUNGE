...
fof(conj_thm_2Efinite__map_2EFUPD11__SAME__KEY__AND__BASE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1k] :
                 ...
                 => ! [V2v1] :
                     ...
                     => ! [V3v2] :
                          ( mem(V3v2,A_27b)
                         => ( ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V2v1)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V3v2))
                          <=> V2v1 = V3v2 ) ) ) ) ) ) ) )).
