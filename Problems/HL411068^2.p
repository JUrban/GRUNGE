...
thf(conj_thm_2Ereal__topology_2EHEINE__BOREL__IMP__BOLZANO__WEIERSTRASS,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ! [V1f: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ! [V1t: $i] :
            ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__EQ__BOLZANO__WEIERSTRASS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) )
      <=> ! [V1t: $i] :
