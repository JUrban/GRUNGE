...
thf(arityeq2_2Emono_2Ec_2Elist_2ECONS_2E2_2Emono_2Etyop_2Elist_2Elist_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ c_2Elist_2ECONS_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Elist_2EFLAT_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
...
thf(arityeq3_2Emono_2Ec_2Elist_2EPAD__RIGHT_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u] :
...
thf(thm_2Elist_2EFLAT,axiom,(
    ! [A_27a: d] :
      ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFLAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Elist_2ENIL_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFLAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFLAT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Elist_2EPAD__RIGHT,axiom,(
    ! [A_27a: d,V0c_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2s_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EPAD__RIGHT_2E3 @ ( s @ A_27a @ V0c_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2s_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2s_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( c_2Ecombin_2EK_2E1 @ ( s @ A_27a @ V0c_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2s_2E0 ) ) ) ) ) ) ) ) ) ) ) ) )).
