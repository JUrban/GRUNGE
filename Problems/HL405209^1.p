...
thf(thm_2Ealist_2EALOOKUP__IN__FRANGE,conjecture,(
    ! [A_27a: d,A_27b: d,V0ls_2E0: u,V1k_2E0: u,V2v_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V2v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFRANGE_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0ls_2E0 ) ) ) ) ) ) ) ) ) )).
