...
thf(thm_2Emeasure_2EADDITIVE__SUM,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1f: tyop_2Enum_2Enum > A_27a > $o,V2n: tyop_2Enum_2Enum] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        ...
        & ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
            ( ( (~) @ ( V3m = V4n ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V1f @ V3m ) @ ( V1f @ V4n ) ) ) )
     => ( ( c_2Ereal_2Esum @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ V2n ) @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m ) @ V1f ) )
        = ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1f @ ( c_2Epred__set_2Ecount @ V2n ) ) ) ) ) ) )).
...
thf(thm_2Eseq_2EPOS__SUMMABLE,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( ! [V1n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V1n ) )
        & ? [V2x: tyop_2Erealax_2Ereal] :
          ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Esum @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ V3n ) @ V0f ) @ V2x ) )
