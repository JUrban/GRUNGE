...
tff(lmtp_f1879,type,(
    f1879: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1879,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V2R: $i] :
...
tff(lmtp_f1880,type,(
    f1880: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f1880,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V2R: $i] :
      ( mem(V2R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V7y: $i] :
          ( mem(V7y,A_27b)
         => ! [V0s: $i] :
