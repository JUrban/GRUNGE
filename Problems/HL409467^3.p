...
thf(thm_2Efloat_2EVAL__THRESHOLD,axiom,(
    ! [V0a: tyop_2Eieee_2Efloat] :
      ( ( c_2Eieee_2EFinite @ V0a )
     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Eieee_2EVal @ V0a ) ) @ ( c_2Eieee_2Ethreshold @ c_2Eieee_2Efloat__format ) ) ) )).
...
thf(thm_2Efloat_2EERROR__IS__ZERO,conjecture,(
    ! [V0a: tyop_2Eieee_2Efloat,V1x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Eieee_2EFinite @ V0a )
        & ( ( c_2Eieee_2EVal @ V0a )
          = V1x ) )
     => ( ( c_2Efloat_2Eerror @ V1x )
        = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).
