...
thf(thm_2Eiterate_2ECARD__NUMSEG,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Epred__set_2ECARD @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V0m @ V1n ) )
...
thf(thm_2Eiterate_2ESUM__CONST,axiom,(
    ! [A_27a: $tType,V0c: tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
     ...
     => ( ( c_2Eiterate_2ESum @ A_27a @ V1s
          @ ^ [V2n: A_27a] : V0c )
        = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__of__num @ ( c_2Epred__set_2ECARD @ A_27a @ V1s ) ) @ V0c ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__CONST__NUMSEG,conjecture,(
    ! [V0c: tyop_2Erealax_2Ereal,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n )
        @ ^ [V3n: tyop_2Enum_2Enum] : V0c )
      = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2B @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1m ) ) @ V0c ) ) )).
