...
tff(conj_thm_2Epred__set_2EPOW__EQNS,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Epred__set_2EFINITE__POW,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),ap(c_2Epred__set_2EPOW(A_27a),V0s))) ) ) )).

tff(conj_thm_2Epred__set_2ECARD__POW,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
