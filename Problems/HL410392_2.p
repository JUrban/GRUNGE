...
tff(conj_thm_2Ereal__topology_2ELINEAR__SUM__MUL,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ! [V3v: $i] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
                   ...
                   => surj__ty_2Erealax_2Ereal(ap(V0f,ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3644(A_27a,V2c,V3v)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3645(A_27a,V0f,V3v,V2c))) ) ) ) ) ) )).
