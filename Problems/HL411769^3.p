...
thf(thm_2Earithmetic_2ESUB__LESS,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V1n )
        & ( c_2Earithmetic_2E_3C_3D @ V1n @ V0m ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2E_2D @ V0m @ V1n ) @ V0m ) ) )).
...
thf(thm_2Ereal__topology_2ESUMS__FINITE__DIFF,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1t: tyop_2Enum_2Enum > $o,V2s: tyop_2Enum_2Enum > $o,V3l: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Enum_2Enum @ V1t @ V2s )
        & ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V1t )
        & ( c_2Ereal__topology_2Esums @ V0f @ V3l @ V2s ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Ereal_2Ereal__sub @ V3l @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ V1t @ V0f ) ) @ ( c_2Epred__set_2EDIFF @ tyop_2Enum_2Enum @ V2s @ V1t ) ) ) )).
...
thf(thm_2Ereal__topology_2ESUMS__OFFSET,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( ( c_2Ereal__topology_2Esums @ V0f @ V1l @ ( c_2Ereal__topology_2Efrom @ V2m ) )
        & ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V3n )
        & ( c_2Earithmetic_2E_3C_3D @ V2m @ V3n ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Ereal_2Ereal__sub @ V1l @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2m @ ( c_2Earithmetic_2E_2D @ V3n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0f ) ) @ ( c_2Ereal__topology_2Efrom @ V3n ) ) ) )).
