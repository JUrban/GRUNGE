...
thf(conj_thm_2Epred__set_2EEMPTY__DIFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EINSERT__DIFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2ECARD__INTER__LESS__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ! [V1t: $i] :
...
thf(conj_thm_2Epred__set_2ECARD__DIFF__EQN,conjecture,(
    ! [A_27a: del,V0t: $i] :
