...
fof(mem_c_2Eextreal_2Eext__mono__decreasing,axiom,(
...
fof(ax_thm_2Eextreal_2Eext__mono__decreasing__def,axiom,(
    ! [V0f] :
...
fof(conj_thm_2Eextreal_2Eext__mono__decreasing__suc,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( p(ap(c_2Eextreal_2Eext__mono__decreasing,V0f))
      <=> ! [V1n] :
            ( mem(V1n,ty_2Enum_2Enum)
           => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0f,ap(c_2Enum_2ESUC,V1n))),ap(V0f,V1n))) ) ) ) )).
