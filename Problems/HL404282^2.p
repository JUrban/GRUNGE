...
thf(tp_c_2EEncode_2Eencode__num,type,(
    c_2EEncode_2Eencode__num: $i )).

thf(mem_c_2EEncode_2Eencode__num,axiom,(
...
thf(conj_thm_2EEncode_2Ewf__encode__num,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EDecode_2Edec2enc__decode__num,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Enum_2Enum @ bool ) )
