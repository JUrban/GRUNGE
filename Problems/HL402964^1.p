...
thf(f3520_0_2E0,type,(
    f3520_0_2E0: u )).

thf(f3520_0_2E1,type,(
    f3520_0_2E1: du > u )).

thf(f3520_1_2E0,type,(
    f3520_1_2E0: u )).

thf(f3520_1_2E1,type,(
    f3520_1_2E1: du > u )).

thf(f3520_2_2E0,type,(
    f3520_2_2E0: u )).

thf(f3520_2_2E1,type,(
    f3520_2_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef3520_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( f3520_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ f3520_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef3520_1_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3520_1_2E1 @ ( s @ A_27b @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ f3520_1_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef3520_2_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27a @ ( f3520_2_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ f3520_2_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27b,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Elist_2ESNOC_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27b_2Ctyop_2Eoption_2Eoption_28A_27a_29_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__INTRO__CATCHALL,axiom,(
    ! [A_27b: d,V3__0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3520_1_2E1 @ ( s @ A_27b @ V3__0_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2EpatternMatches_2EPMATCH__INTRO__CATCHALL,axiom,(
    ! [A_27b: d,V2__0_2E0: u] :
      ( ( s @ A_27b @ ( f3520_0_2E1 @ ( s @ A_27b @ V2__0_2E0 ) ) )
      = ( s @ A_27b @ V2__0_2E0 ) ) )).

thf(def2_2Ethm_2EpatternMatches_2EPMATCH__INTRO__CATCHALL,axiom,(
    ! [A_27a: d,A_27b: d,V4__0_2E0: u] :
      ( ( s @ A_27a @ ( f3520_2_2E1 @ ( s @ A_27b @ V4__0_2E0 ) ) )
