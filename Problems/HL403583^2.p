...
thf(conj_thm_2Ewellorder_2EZL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
...
thf(conj_thm_2Ewellorder_2EPOSET__RESTRICTED__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ewellorder_2EFL__RESTRICTED__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
...
thf(conj_thm_2Ewellorder_2EZL__SUBSETS,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ( ! [V1c: $i] :
