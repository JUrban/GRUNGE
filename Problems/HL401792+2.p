...
fof(conj_thm_2Epred__set_2EBIGUNION__partition,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(conj_thm_2Epred__set_2Epartition__elements__disjoint,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Epred__set_2EFINITE__partition,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Epred__set_2Epartition__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(ap(c_2Epred__set_2Eequiv__on(A_27a),V0R),V1s))
                  & p(ap(c_2Epred__set_2EFINITE(A_27a),V1s)) )
               => ap(c_2Epred__set_2ECARD(A_27a),V1s) = ap(ap(c_2Epred__set_2ESUM__IMAGE(arr(A_27a,bool)),c_2Epred__set_2ECARD(A_27a)),ap(ap(c_2Epred__set_2Epartition(A_27a),V0R),V1s)) ) ) ) ) )).
