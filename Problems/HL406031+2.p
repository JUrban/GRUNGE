...
fof(conj_thm_2Ewords_2Eword__asr,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),V1n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),ap(ap(c_2Ewords_2Eword__or(A_27a),ap(ap(ap(c_2Ewords_2Eword__slice(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),V1n)),c_2Ewords_2Eword__T(A_27a))),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V0w),V1n))),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V0w),V1n)) ) ) ) )).
