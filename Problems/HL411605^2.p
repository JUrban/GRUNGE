...
thf(conj_thm_2Ebool_2ELEFT__EXISTS__IMP__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4a: tp__ty_2Erealax_2Ereal] :
                      ( ( ( p
                          @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V5t: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5t ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5t ) @ V3s ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V2h @ V5t ) ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) ) ) ) ) )
                        & ( p
                          @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V1g )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V6t: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6t ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6t ) @ V3s ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( ap @ V2h @ V6t ) ) ) ) ) ) ) )
                        ...
                        & ! [V7t: tp__ty_2Erealax_2Ereal] :
                            ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V7t ) ) @ V3s ) )
                              & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2h @ ( inj__ty_2Erealax_2Ereal @ V7t ) ) )
                                = V4a ) )
                           => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V7t ) ) )
                              = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V7t ) ) ) ) ) )
                     => ( p
                        @ ( ap
                          @ ( ap @ c_2Ereal__topology_2Econtinuous__on
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V8t: $i] :
                                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V2h @ V8t ) ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) @ ( ap @ V0f @ V8t ) ) @ ( ap @ V1g @ V8t ) ) ) )
                          @ V3s ) ) ) ) ) ) ) )).
