...
thf(f12788_0_2E0,type,(
    f12788_0_2E0: u )).

thf(f12788_0_2E2,type,(
    f12788_0_2E2: du > du > u )).

thf(f12788_0_2E3,type,(
    f12788_0_2E3: du > du > du > u )).

thf(f12788_1_2E0,type,(
    f12788_1_2E0: u )).

thf(f12788_1_2E3,type,(
    f12788_1_2E3: du > du > du > u )).
...
thf(c_2Ereal__topology_2Esphere_2E0,type,(
    c_2Ereal__topology_2Esphere_2E0: u )).

thf(c_2Ereal__topology_2Esphere_2E1,type,(
    c_2Ereal__topology_2Esphere_2E1: du > u )).
...
thf(mono_2Ef12788_0,type,(
    mono_2Ef12788_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef12788_1,type,(
    mono_2Ef12788_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(mono_2Ec_2Ereal__topology_2Esphere,type,(
    mono_2Ec_2Ereal__topology_2Esphere: mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2Esphere,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal,V1e: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12788_1 @ V0x @ V2y @ V1e )
...
thf(def1_2Ethm_2Ereal__topology_2Esphere,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1e: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12788_0 @ V0x @ V1e @ V2y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V2y @ ( mono_2Ef12788_1 @ V0x @ V2y @ V1e ) ) ) )).

thf(thm_2Ereal__topology_2Esphere,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1e: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Esphere @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0x @ V1e ) )
      = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12788_0 @ V0x @ V1e ) ) ) )).

thf(thm_2Ereal__topology_2EFRONTIER__CBALL,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1e: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Efrontier @ ( mono_2Ec_2Ereal__topology_2Ecball @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1e ) ) )
      = ( mono_2Ec_2Ereal__topology_2Esphere @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1e ) ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSED__INTER__COMPACT,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Erealax_2Ereal @ V0s @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2ECOMPACT__CBALL,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1e: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Ereal__topology_2Ecball @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0x @ V1e ) ) ) )).

thf(thm_2Ereal__topology_2ECOMPACT__FRONTIER,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ecompact @ V0s )
     => ( mono_2Ec_2Ereal__topology_2Ecompact @ ( mono_2Ec_2Ereal__topology_2Efrontier @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EINJECTIVE__IMP__ISOMETRIC,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ? [V3e: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
             ...
             => ( mono_2Ec_2Ereal_2Ereal__ge @ ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V4x ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V3e @ ( mono_2Ec_2Ereal_2Eabs @ V4x ) ) ) ) ) ) )).
