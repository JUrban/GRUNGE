...
thf(thm_2Ellist_2ELTAKE__DROP,conjecture,(
    ! [A_27a: d] :
      ( ! [V0n: mono_2Etyop_2Enum_2Enum,V1ll_2E0: u] :
          ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) ) ) )
         => ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2EfromList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) ) ) ) ) )
            = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) )
      & ! [V2n: mono_2Etyop_2Enum_2Enum,V3ll_2E0: u] :
          ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll_2E0 ) ) ) )
            & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2n @ ( mono_2Ec_2Eoption_2ETHE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Eoption_2Eoption_28tyop_2Enum_2Enum_29 @ ( s @ ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) @ ( c_2Ellist_2ELLENGTH_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll_2E0 ) ) ) ) ) ) )
         => ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2EfromList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELDROP_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll_2E0 ) ) ) ) ) ) )
            = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V3ll_2E0 ) ) ) ) )).
