...
fof(thm_2EquantHeuristics_2EINL__NEQ__ELIM,conjecture,(
    ! [A_27a,A_27b,V0x_2E0] :
      ( ( ! [V1l_2E0] : s(tyop_2Esum_2Esum(A_27a,A_27b),V0x_2E0) != s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Esum_2EINL_2E1(s(A_27a,V1l_2E0)))
      <=> p(s(tyop_2Emin_2Ebool,c_2Esum_2EISR_2E1(s(tyop_2Esum_2Esum(A_27a,A_27b),V0x_2E0)))) )
      & ( ! [V2l_2E0] : s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Esum_2EINL_2E1(s(A_27a,V2l_2E0))) != s(tyop_2Esum_2Esum(A_27a,A_27b),V0x_2E0)
      <=> p(s(tyop_2Emin_2Ebool,c_2Esum_2EISR_2E1(s(tyop_2Esum_2Esum(A_27a,A_27b),V0x_2E0)))) ) ) )).
