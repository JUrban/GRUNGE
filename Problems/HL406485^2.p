...
thf(ax_thm_2Ebitstring_2Eshiftl__def,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1m: tp__ty_2Enum_2Enum] :
      ...
      = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2EPAD__RIGHT @ bool ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Elist_2ELENGTH @ bool ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Eshiftl__replicate__F,conjecture,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1n: tp__ty_2Enum_2Enum] :
      ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ c_2Ebitstring_2Eshiftl @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
      = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ bool ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) @ ( ap @ ( ap @ c_2Ebitstring_2Ereplicate @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( c_2Elist_2ENIL @ bool ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
