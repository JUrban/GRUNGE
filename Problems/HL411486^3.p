...
thf(thm_2Ereal__topology_2EDIAMETER__LE,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1d: tyop_2Erealax_2Ereal] :
      ( ( ( ( (~)
            @ ( V0s
              = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
        ...
        & ! [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V2x @ V3y ) ) @ V1d ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Ediameter @ V0s ) @ V1d ) ) )).
...
thf(thm_2Ereal__topology_2EDIAMETER__CBALL,conjecture,(
