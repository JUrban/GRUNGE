...
tff(f4181_0_2E0,type,(
    f4181_0_2E0: u )).

tff(f4181_0_2E1,type,(
    f4181_0_2E1: du > u )).
...
tff(arityeq1_2Ef4181_0_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4181_0_2E1(s(tyop_2Ellist_2Ellist(A_27a),X0_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool),f4181_0_2E0),s(tyop_2Ellist_2Ellist(A_27a),X0_2E0)))) )).
...
tff(def0_2Ethm_2Ellist_2ELHD__LAPPEND,axiom,(
    ! [A_27a: d,V1l1_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4181_0_2E1(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0)))))
    <=> s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0) = s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELNIL_2E0) ) )).

tff(thm_2Ellist_2ELHD__LAPPEND,conjecture,(
    ! [A_27a: d,V0l2_2E0: u,V1l1_2E0: u] : s(tyop_2Eoption_2Eoption(A_27a),c_2Ellist_2ELHD_2E1(s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELAPPEND_2E2(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0l2_2E0))))) = s(tyop_2Eoption_2Eoption(A_27a),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f4181_0_2E1(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0))),s(tyop_2Eoption_2Eoption(A_27a),c_2Ellist_2ELHD_2E1(s(tyop_2Ellist_2Ellist(A_27a),V0l2_2E0))),s(tyop_2Eoption_2Eoption(A_27a),c_2Ellist_2ELHD_2E1(s(tyop_2Ellist_2Ellist(A_27a),V1l1_2E0))))) )).
