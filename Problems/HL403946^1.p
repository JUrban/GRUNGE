...
thf(thm_2Elist_2ETAKE__APPEND1,axiom,(
    ! [A_27a: d,V0l2_2E0: u,V1l1_2E0: u,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l2_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELPREFIX__TRANS,conjecture,(
    ! [A_27a: d,V0l3_2E0: u,V1l2_2E0: u,V2l1_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELPREFIX_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l2_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELPREFIX_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1l2_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l3_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELPREFIX_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2l1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l3_2E0 ) ) ) ) ) )).
