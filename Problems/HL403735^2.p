...
thf(conj_thm_2Esorting_2Eless__sorted__eq,lemma,(
...
thf(conj_thm_2Esorting_2ESORTED__GENLIST__PLUS,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1k: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ ( c_2Esorting_2ESORTED @ ty_2Enum_2Enum ) @ c_2Eprim__rec_2E_3C ) @ ( ap @ ( ap @ ( c_2Elist_2EGENLIST @ ty_2Enum_2Enum ) @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
