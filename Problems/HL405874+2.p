...
fof(conj_thm_2Ewords_2EWORD__MODIFY__BIT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,arr(bool,bool)))
         => ! [V1w] :
             ...
             => ! [V2i] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2i),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                   => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__modify(A_27a),V0f),V1w)),V2i))
                    <=> p(ap(ap(V0f,V2i),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),V2i))) ) ) ) ) ) ) )).
