...
thf(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUB,lemma,(
    ! [V0f: $i] :
           ...
           => ( p
              @ ( ap @ c_2Ereal__topology_2Elinear
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V2x ) ) @ ( ap @ V1g @ V2x ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELINEAR__EQ__0,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1b: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__EQ,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
