...
thf(thm_2Ebag_2EBIG__BAG__UNION__DELETE,conjecture,(
    ! [A_27a: $tType,V0sob: ( A_27a > tyop_2Enum_2Enum ) > $o,V1b: A_27a > tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ ( c_2Epred__set_2EDELETE @ ( A_27a > tyop_2Enum_2Enum ) @ V0sob @ V1b ) )
        = ( c_2Ebool_2ECOND @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebool_2EIN @ ( A_27a > tyop_2Enum_2Enum ) @ V1b @ V0sob ) @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V0sob ) @ V1b ) @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a @ V0sob ) ) ) ) )).
