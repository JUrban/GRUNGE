...
thf(f4164_0_2E0,type,(
    f4164_0_2E0: u )).

thf(f4164_0_2E2,type,(
    f4164_0_2E2: du > du > u )).

thf(f4164_0_2E3,type,(
    f4164_0_2E3: du > du > du > u )).

thf(f4164_1_2E0,type,(
    f4164_1_2E0: u )).

thf(f4164_1_2E1,type,(
    f4164_1_2E1: du > u )).

thf(f4164_1_2E2,type,(
    f4164_1_2E2: du > du > u )).
...
thf(c_2Epath_2Efirst_2E0,type,(
    c_2Epath_2Efirst_2E0: u )).

thf(c_2Epath_2Efirst_2E1,type,(
    c_2Epath_2Efirst_2E1: du > u )).

thf(c_2Epath_2Efirst__label_2E0,type,(
    c_2Epath_2Efirst__label_2E0: u )).

thf(c_2Epath_2Efirst__label_2E1,type,(
    c_2Epath_2Efirst__label_2E1: du > u )).

thf(c_2Epath_2Elabels_2E0,type,(
    c_2Epath_2Elabels_2E0: u )).

thf(c_2Epath_2Elabels_2E1,type,(
    c_2Epath_2Elabels_2E1: du > u )).
...
thf(c_2Epath_2Etake_2E0,type,(
    c_2Epath_2Etake_2E0: u )).

thf(c_2Epath_2Etake_2E2,type,(
...
thf(arityeq2_2Emono_2Ef4164_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( f4164_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ f4164_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef4164_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( f4164_0_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ f4164_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef4164_1_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( f4164_1_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ f4164_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4164_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( f4164_1_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ f4164_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Elist_2ECONS_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Elist_2ECONS_2E1_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Elist_2ECONS_2E1 @ ( s @ A_27c @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) ) @ c_2Elist_2ECONS_2E0 ) @ ( s @ A_27c @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELCONS_2E2_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27c @ X0_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Ellist_2Ellist @ A_27c ) ) ) @ c_2Ellist_2ELCONS_2E0 ) @ ( s @ A_27c @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ellist_2ELHD_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ c_2Ellist_2ELHD_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ellist_2ELTAKE_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) ) @ c_2Ellist_2ELTAKE_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Ellist_2ELTAKE_2E2_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) ) ) @ c_2Ellist_2ELTAKE_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ellist_2ELTL_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ c_2Ellist_2ELTL_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Eoption_2EOPTION__MAP_2E2_2Emono_2Etyop_2Elist_2Elist_28A_27b_29_20mono_2Etyop_2Elist_2Elist_28A_27b_29,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) ) @ c_2Eoption_2EOPTION__MAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Eoption_2EOPTION__MAP_2E2_2Emono_2Etyop_2Elist_2Elist_28A_27c_29_20mono_2Etyop_2Elist_2Elist_28A_27c_29,axiom,(
    ! [A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) ) ) @ c_2Eoption_2EOPTION__MAP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Eoption_2ESOME_2E1_2Emono_2Etyop_2Elist_2Elist_28A_27b_29,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ c_2Eoption_2ESOME_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Eoption_2ESOME_2E1_2Emono_2Etyop_2Ellist_2Ellist_28A_27b_29,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) ) @ c_2Eoption_2ESOME_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Eoption_2ETHE_2E1_2Emono_2Etyop_2Ellist_2Ellist_28A_27a_29,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ c_2Eoption_2ETHE_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Epath_2Efirst_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27a @ ( c_2Epath_2Efirst_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ A_27a ) @ c_2Epath_2Efirst_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Epath_2Efirst__label_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( c_2Epath_2Efirst__label_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ A_27b ) @ c_2Epath_2Efirst__label_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Epath_2Elabels_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ c_2Epath_2Elabels_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Eoption_2Eoption__CASE_2E3_2Emono_2EA_27a_20mono_2Etyop_2Eoption_2Eoption_28tyop_2Elist_2Elist_28A_27a_29_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ c_2Eoption_2Eoption__CASE_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ X2_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Eoption_2Eoption__CASE_2E3_2Emono_2Etyop_2Elist_2Elist_28A_27a_29_20mono_2Etyop_2Eoption_2Eoption_28tyop_2Elist_2Elist_28A_27a_29_29,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ec_2Ellist_2EtoList_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ c_2Ellist_2EtoList_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Ellist_2ELHD__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V0h_2E0 ) ) ) ) ) )).

thf(thm_2Ellist_2ELTL__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) ) )).

thf(def0_2Ethm_2Ellist_2ELTAKE,axiom,(
    ! [A_27a: d,V3hd_2E0: u,V4tl_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( f4164_1_2E2 @ ( s @ A_27a @ V3hd_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4tl_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3hd_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4tl_2E0 ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ellist_2ELTAKE,axiom,(
    ! [A_27a: d,V1n: mono_2Etyop_2Enum_2Enum,V2ll_2E0: u,V3hd_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( f4164_0_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) @ ( s @ A_27a @ V3hd_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Ellist_2Ellist @ A_27a ) ) @ ( c_2Ellist_2ELTL_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( f4164_1_2E1 @ ( s @ A_27a @ V3hd_2E0 ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELTAKE,axiom,(
    ! [A_27a: d] :
      ( ! [V0ll_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2ll_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELHD_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( f4164_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Ellist_2ELTAKE__THM,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d] :
      ( ! [V0l_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0l_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ c_2Eoption_2ENONE_2E0 ) )
      & ! [V2n: mono_2Etyop_2Enum_2Enum,V3h_2E0: u,V4t_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V2n ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27c @ V3h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V4t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27c ) @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Elist_2ECONS_2E1 @ ( s @ A_27c @ V3h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27c ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27c ) @ V4t_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Ellist_2EtoList__THM,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Eoption_2EOPTION__MAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Elist_2ECONS_2E1 @ ( s @ A_27b @ V0h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ V1t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Epath_2Epath__cases,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u] :
      ( ? [V1x_2E0: u] :
          ...
          = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) )
      | ? [V2x_2E0: u,V3r_2E0: u,V4q_2E0: u] :
          ( ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 )
          = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27b @ V3r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V4q_2E0 ) ) ) ) ) )).
...
thf(thm_2Epath_2Efirst__label__def,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1r_2E0: u,V2p_2E0: u] :
      ( ( s @ A_27b @ ( c_2Epath_2Efirst__label_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V1r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) )
      = ( s @ A_27b @ V1r_2E0 ) ) )).
...
thf(thm_2Epath_2EPL__0,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u] :
      ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Epath_2EPL_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) ) ) )).

thf(thm_2Epath_2Etake__def,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0p_2E0: u] :
          ( ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etake_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
          = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ ( c_2Epath_2Efirst_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0p_2E0 ) ) ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2p_2E0: u] :
          ( ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etake_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) )
          = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ ( c_2Epath_2Efirst_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) @ ( s @ A_27b @ ( c_2Epath_2Efirst__label_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etake_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etail_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V2p_2E0 ) ) ) ) ) ) ) ) ) )).

thf(thm_2Epath_2Elabels__def,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0x_2E0: u] :
          ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ c_2Ellist_2ELNIL_2E0 ) )
      & ! [V1x_2E0: u,V2r_2E0: u,V3p_2E0: u] :
          ( ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27b @ V2r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27b @ V2r_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Epath_2ELTAKE__labels,conjecture,(
    ! [A_27a: d,A_27b: d,V0n: mono_2Etyop_2Enum_2Enum,V1p_2E0: u,V2l_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2ELTAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) )
    <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V0n @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Epath_2EPL_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) ) )
        & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Ellist_2EtoList_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27b ) @ ( c_2Epath_2Elabels_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Etake_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) ) ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) ) ) )).
