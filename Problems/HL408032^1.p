...
thf(thm_2Eseq_2ESEQ__LE__MONO,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ ( mono_2Ec_2Earithmetic_2E_2B @ V3n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( V0f @ V3n ) )
        & ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ V1x ) )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ V1x @ ( V0f @ V2n ) ) ) )).
