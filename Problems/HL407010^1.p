...
thf(c_2Einteger__word_2EUINT__MAX_2E0,type,(
    c_2Einteger__word_2EUINT__MAX_2E0: u )).

thf(c_2Einteger__word_2EUINT__MAX_2E1,type,(
...
thf(c_2Einteger__word_2Esaturate__i2w_2E0,type,(
    c_2Einteger__word_2Esaturate__i2w_2E0: u )).

thf(c_2Einteger__word_2Esaturate__i2w_2E1,type,(
    c_2Einteger__word_2Esaturate__i2w_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Einteger__word_2EUINT__MAX_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Einteger_2Eint @ ( s @ tyop_2Einteger_2Eint @ ( c_2Einteger__word_2EUINT__MAX_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Einteger_2Eint @ ( s @ tyop_2Einteger_2Eint @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebool_2Eitself @ A_27a ) @ tyop_2Einteger_2Eint ) @ c_2Einteger__word_2EUINT__MAX_2E0 ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ X0_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Einteger__word_2Esaturate__i2w_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Einteger_2Eint] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Esaturate__i2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ X0 ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Einteger_2Eint @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) @ c_2Einteger__word_2Esaturate__i2w_2E0 ) @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ X0 ) ) ) ) ) )).
...
thf(thm_2Einteger__word_2Esaturate__i2w__def,axiom,(
    ! [A_27a: d,V0i: mono_2Etyop_2Einteger_2Eint] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Esaturate__i2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ V0i ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Einteger_2Eint__le @ ( j_mono_2Etyop_2Einteger_2Eint @ ( s @ tyop_2Einteger_2Eint @ ( c_2Einteger__word_2EUINT__MAX_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) @ V0i ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ c_2Ewords_2Eword__T_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Einteger_2Eint__lt @ V0i @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Einteger_2ENum @ V0i ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2Einteger__word_2EUINT__MAX,axiom,(
    ! [A_27a: d] :
      ( ( j_mono_2Etyop_2Einteger_2Eint @ ( s @ tyop_2Einteger_2Eint @ ( c_2Einteger__word_2EUINT__MAX_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) )
      = ( mono_2Ec_2Einteger_2Eint__of__num @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2EUINT__MAX_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ewords_2EZERO__LT__UINT__MAX,axiom,(
    ! [A_27a: d] :
      ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2EUINT__MAX_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) ) )).
...
thf(thm_2Einteger__word_2Esaturate__i2w__0,conjecture,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Einteger__word_2Esaturate__i2w_2E1 @ ( s @ tyop_2Einteger_2Eint @ ( i_mono_2Etyop_2Einteger_2Eint @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) )
