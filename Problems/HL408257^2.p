...
thf(conj_thm_2Ereal_2EREAL__INV__LT1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Etransc_2EEXP__TOTAL__LEMMA,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
     ...
     => ? [V1x: tp__ty_2Erealax_2Ereal] :
          ...
          & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
            = V0y ) ) ) )).

thf(conj_thm_2Etransc_2EEXP__TOTAL,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
