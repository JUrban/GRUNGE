...
thf(conj_thm_2Ereal__topology_2ESERIES__CMUL,lemma,(
    ! [V0x: $i] :
              ...
              @ ( ap
                @ ( ap
                  @ ( ap @ c_2Ereal__topology_2Esums
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V4n: $i] :
                          ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ V0x @ V4n ) ) ) )
                  @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x0 ) ) )
                @ V3s ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINFSUM__CMUL,conjecture,(
    ! [V0s: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => ( ( surj__ty_2Erealax_2Ereal
                  @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V0s )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3n: $i] :
                          ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ V1x @ V3n ) ) ) ) )
                = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V0s ) @ V1x ) ) ) ) ) ) ) )).
