...
thf(conj_thm_2Ellist_2ELTL__LUNFOLD,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27b )
         => ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) @ V1x ) )
            = ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ ( ty_2Ellist_2Ellist @ A_27a ) @ A_27b ) @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V0f ) ) @ ( c_2Epair_2EFST @ A_27b @ A_27a ) ) ) @ ( ap @ V0f @ V1x ) ) ) ) ) )).
