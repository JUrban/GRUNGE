...
thf(thm_2Ereal__topology_2ESERIES__BOUND,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2s: tyop_2Enum_2Enum > $o,V3a: tyop_2Erealax_2Ereal,V4b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Esums @ V0f @ V3a @ V2s )
        & ( c_2Ereal__topology_2Esums @ V1g @ V4b @ V2s )
        & ! [V5i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V5i @ V2s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0f @ V5i ) ) @ ( V1g @ V5i ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V3a ) @ V4b ) ) )).
...
thf(thm_2Ereal__topology_2ESERIES__COMPARISON__BOUND,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2s: tyop_2Enum_2Enum > $o,V3a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Esums @ V1g @ V3a @ V2s )
        & ! [V4i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4i @ V2s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0f @ V4i ) ) @ ( V1g @ V4i ) ) ) )
     => ? [V5l: tyop_2Erealax_2Ereal] :
          ( ( c_2Ereal__topology_2Esums @ V0f @ V5l @ V2s )
          & ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V5l ) @ V3a ) ) ) )).
