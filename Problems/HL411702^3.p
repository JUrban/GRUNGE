...
thf(thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
     ...
     => ! [V3s: tyop_2Erealax_2Ereal > $o] :
         ...
         => ( c_2Ereal__topology_2EClosed @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V3s ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSURE__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( ( c_2Ereal__topology_2Eclosure @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) )
        = ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eclosure @ V1s ) ) ) ) )).
