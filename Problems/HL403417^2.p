...
thf(conj_thm_2Ebag_2EBAG__DIFF__INSERT__SUB__BAG,conjecture,(
    ! [A_27a: del,V0c: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2e: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2ESUB__BAG @ A_27a ) @ V0c ) @ V1b ) )
               => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e ) @ V1b ) ) @ V0c )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b ) @ V0c ) ) ) ) ) ) ) )).
