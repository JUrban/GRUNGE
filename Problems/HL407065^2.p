...
thf(conj_thm_2Erealax_2EHREAL__LT__ADDR,conjecture,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal] :
      ~ ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) ) )).
