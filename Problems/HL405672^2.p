...
thf(conj_thm_2Eordinal_2Eordlt__EXISTS__ADD,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
...
thf(conj_thm_2Eordinal_2EordDIV__UNIQUE,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
         => ! [V2q: $i] :
             ...
             => ! [V3r: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V1b ) )
                      & ( V0a
                        = ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ V1b ) @ V2q ) ) @ V3r ) )
                      & ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ V3r ) @ V1b ) ) )
                   => ( ( ap @ ( ap @ ( c_2Eordinal_2EordDIV @ A_27a ) @ V0a ) @ V1b )
                      = V2q ) ) ) ) ) ) )).
