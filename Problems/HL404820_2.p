...
tff(ax_thm_2Efinite__map_2ESUBMAP__DEF,axiom,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__EQ__DRESTRICT,lemma,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__EQ__DRESTRICT__SAME,conjecture,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1s: $i] :
         ...
         => ! [V2f2: $i] :
             ...
             => ( ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f1),V1s) = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V2f2),V1s)
              <=> ( ap(ap(c_2Epred__set_2EINTER(A_27a),V1s),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)) = ap(ap(c_2Epred__set_2EINTER(A_27a),V1s),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2f2))
                  & ! [V3x: $i] :
                      ( mem(V3x,A_27a)
                     => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)))
                          & p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s)) )
                       => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0f1),V3x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2f2),V3x) ) ) ) ) ) ) ) )).
