...
thf(f4093_0_2E0,type,(
    f4093_0_2E0: u )).

thf(f4093_0_2E1,type,(
    f4093_0_2E1: du > u )).

thf(f4093_0_2E2,type,(
    f4093_0_2E2: du > du > u )).

thf(f4093_1_2E0,type,(
    f4093_1_2E0: u )).

thf(f4093_1_2E2,type,(
    f4093_1_2E2: du > du > u )).

thf(f4093_1_2E3,type,(
    f4093_1_2E3: du > du > du > u )).

thf(f4093_2_2E0,type,(
    f4093_2_2E0: u )).

thf(f4093_2_2E1,type,(
    f4093_2_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef4093_0_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( f4093_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ f4093_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4093_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( f4093_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ f4093_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4093_1_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( f4093_1_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef4093_1_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( f4093_1_2E3 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef4093_2_2E1_2Emono_2EA_27d,axiom,(
    ! [A_27d: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4093_2_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ tyop_2Emin_2Ebool ) @ f4093_2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Einftree_2Eis__tree__strongind,axiom,(
    ! [A_27d: d,V6p_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f4093_2_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 )
        = ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ c_2Elist_2ENIL_2E0 ) ) ) )).

thf(def1_2Ethm_2Einftree_2Eis__tree__strongind,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,V4b_2E0: u,V3f_2E0: u,V6p_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( f4093_1_2E3 @ ( s @ A_27b @ V4b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f4093_2_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V4b_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ V3f_2E0 ) @ ( s @ A_27d @ ( c_2Elist_2EHD_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V6p_2E0 ) ) ) ) ) ) ) ) )).

thf(def2_2Ethm_2Einftree_2Eis__tree__strongind,axiom,(
    ! [A_27a: d,A_27b: d,A_27d: d,V1a_2E0: u,V2p_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( f4093_0_2E2 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27d ) @ V2p_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V1a_2E0 ) ) ) ) )).

thf(thm_2Einftree_2Eis__tree__strongind,conjecture,(
    ! [A_27a: d,A_27b: d,A_27d: d,V0is__tree_27_2E0: u] :
      ( ( ! [V1a_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ V0is__tree_27_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( f4093_0_2E1 @ ( s @ A_27a @ V1a_2E0 ) ) ) ) ) )
        & ! [V3f_2E0: u,V4b_2E0: u] :
            ( ! [V5d_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Einftree_2Eis__tree_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) ) ) @ V3f_2E0 ) @ ( s @ A_27d @ V5d_2E0 ) ) ) ) ) )
