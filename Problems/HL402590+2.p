...
fof(conj_thm_2Erich__list_2EFILTER__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(lamtp_f773,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27a))
         => mem(f773(A_27a,A_27a,V0P,V2l_27),arr(A_27a,ty_2Elist_2Elist(A_27a))) ) ) )).

fof(lameq_f773,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27a))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f773(A_27a,A_27a,V0P,V2l_27),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(A_27a)),ap(V0P,V3x)),ap(ap(c_2Elist_2ESNOC(A_27a),V3x),V2l_27)),V2l_27) ) ) ) )).

fof(lamtp_f772,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f772(A_27a,A_27a,V0P),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,ty_2Elist_2Elist(A_27a)))) ) )).

fof(lameq_f772,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V2l_27] :
          ( mem(V2l_27,ty_2Elist_2Elist(A_27a))
         => ap(f772(A_27a,A_27a,V0P),V2l_27) = f773(A_27a,A_27a,V0P,V2l_27) ) ) )).

fof(conj_thm_2Erich__list_2EFILTER__FOLDL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ap(ap(c_2Elist_2EFILTER(A_27a),V0P),V1l) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f772(A_27a,A_27a,V0P)),c_2Elist_2ENIL(A_27a)),V1l) ) ) ) )).
