...
thf(thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,axiom,(
...
thf(thm_2Ereal__topology_2EIN__COMPONENTS__BIGUNION__COMPLEMENT,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1c: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( ( c_2Epred__set_2EDIFF @ tyop_2Erealax_2Ereal @ V0s @ V1c )
        = ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EDELETE @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2Ecomponents @ V0s ) @ V1c ) ) ) ) )).
