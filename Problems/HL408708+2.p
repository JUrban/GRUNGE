...
fof(conj_thm_2EHolSmt_2Er087,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
         => ! [V2z] :
             ...
             => ! [V3u] :
                 ...
                 => ap(ap(c_2Einteger_2Eint__add,V0x),ap(ap(c_2Einteger_2Eint__add,V1y),ap(ap(c_2Einteger_2Eint__add,V2z),V3u))) = ap(ap(c_2Einteger_2Eint__add,V1y),ap(ap(c_2Einteger_2Eint__add,V2z),ap(ap(c_2Einteger_2Eint__add,V3u),V0x))) ) ) ) ) )).
