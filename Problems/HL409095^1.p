...
thf(thm_2Etransc_2EPOW__2__SQRT,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Etransc_2Esqrt @ ( mono_2Ec_2Ereal_2Epow @ V0x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        = V0x ) ) )).

thf(thm_2Ecomplex_2EMODU__REAL,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ecomplex_2Emodu @ ( mono_2Ec_2Ecomplex_2Ecomplex__of__real @ V0x ) )
