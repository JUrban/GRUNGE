...
tff(conj_thm_2Ebag_2EBAG__INN__BAG__INSERT,lemma,(
...
tff(conj_thm_2Ebag_2EBAG__CARD__BAG__INN,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
       => ! [V1n: tp__ty_2Enum_2Enum,V2e: $i] :
            ( mem(V2e,A_27a)
           => ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V2e),inj__ty_2Enum_2Enum(V1n)),V0b))
             => p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1n)),ap(c_2Ebag_2EBAG__CARD(A_27a),V0b))) ) ) ) ) )).
