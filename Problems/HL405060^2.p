...
thf(conj_thm_2Earithmetic_2ELESS__EQ__MONO__ADD__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2EOmega__Automata_2ECO__BUECHI__SWHEN__CLOSURE,conjecture,(
                                                ...
                                                @ ( ap
                                                  @ ( ap @ c_2Ebool_2E_2F_5C
                                                    @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                                                      @ ( lam @ ty_2Enum_2Enum
                                                        @ ^ [V9t: $i] :
                                                            ( ap @ V1Phi__R @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V2i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t ) @ V7t0 ) ) ) @ ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t ) @ V7t0 ) ) ) ) ) ) )
                                                  @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                                    @ ( lam @ ty_2Enum_2Enum
                                                      @ ^ [V10t1: $i] :
                                                          ...
                                                          @ ( lam @ ty_2Enum_2Enum
                                                            @ ^ [V11t2: $i] :
                                                                ( ap @ V3Psi @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V2i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V11t2 ) @ V7t0 ) ) ) ) @ ( ap @ V8q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V11t2 ) @ V7t0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                                  @ V4phi )
