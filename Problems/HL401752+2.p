...
fof(conj_thm_2Epred__set_2ESUM__SET__DELETE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0s))
       => ! [V1e] :
            ( mem(V1e,ty_2Enum_2Enum)
           => ap(c_2Epred__set_2ESUM__SET,ap(ap(c_2Epred__set_2EDELETE(ty_2Enum_2Enum),V0s),V1e)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1e),V0s)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Epred__set_2ESUM__SET,V0s)),V1e)),ap(c_2Epred__set_2ESUM__SET,V0s)) ) ) ) )).
