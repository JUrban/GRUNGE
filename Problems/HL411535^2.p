...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SUBSET__CLOSED__INTERVAL__SYMMETRIC,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SUBSET__CLOSED__INTERVAL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
