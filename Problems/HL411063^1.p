...
thf(f13993_0_2E0,type,(
    f13993_0_2E0: u )).

thf(f13993_0_2E1,type,(
    f13993_0_2E1: du > u )).

thf(f13993_0_2E2,type,(
    f13993_0_2E2: du > du > u )).

thf(f13993_1_2E0,type,(
    f13993_1_2E0: u )).

thf(f13993_1_2E2,type,(
    f13993_1_2E2: du > du > u )).
...
thf(mono_2Ef13993_0,type,(
    mono_2Ef13993_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13993_1,type,(
    mono_2Ef13993_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > $o )).
...
thf(thm_2Ereal__topology_2EINF__FINITE,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Eiterate_2Einf @ V0s ) @ V0s )
        & ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1x @ V0s )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Eiterate_2Einf @ V0s ) @ V1x ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESEQUENCE__INFINITE__LEMMA,axiom,(
    ! [V3y: mono_2Etyop_2Erealax_2Ereal,V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13993_1 @ V3y @ V0f )
    <=> ? [V4n: mono_2Etyop_2Enum_2Enum] :
          ( V3y
          = ( V0f @ V4n ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESEQUENCE__INFINITE__LEMMA,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13993_0 @ V0f @ V3y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V3y @ ( mono_2Ef13993_1 @ V3y @ V0f ) ) ) )).

thf(thm_2Ereal__topology_2ESEQUENCE__INFINITE__LEMMA,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( (~) @ ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13993_0 @ V0f ) ) ) ) ) )).
