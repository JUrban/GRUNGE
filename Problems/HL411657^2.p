...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ADD,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANSLATION,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( p
          @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V0s )
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ V2x ) ) )
              @ V0s ) ) ) ) )).
