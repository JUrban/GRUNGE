...
thf(thm_2Eiterate_2ENSUM__CLAUSES,axiom,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ! [V0f: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Eiterate_2Ensum @ A_27a @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V0f )
          = c_2Enum_2E0 )
      & ! [V1x: A_27b,V2f: A_27b > tyop_2Enum_2Enum,V3s: A_27b > $o] :
          ( ( c_2Epred__set_2EFINITE @ A_27b @ V3s )
         => ( ( c_2Eiterate_2Ensum @ A_27b @ ( c_2Epred__set_2EINSERT @ A_27b @ V1x @ V3s ) @ V2f )
            = ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebool_2EIN @ A_27b @ V1x @ V3s ) @ ( c_2Eiterate_2Ensum @ A_27b @ V3s @ V2f ) @ ( c_2Earithmetic_2E_2B @ ( V2f @ V1x ) @ ( c_2Eiterate_2Ensum @ A_27b @ V3s @ V2f ) ) ) ) ) ) )).

thf(thm_2Eiterate_2ENSUM__UNION__NONZERO,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1s: A_27a > $o,V2t: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
        ...
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Epred__set_2EINTER @ A_27a @ V1s @ V2t ) )
           => ( ( V0f @ V3x )
              = c_2Enum_2E0 ) ) )
     => ( ( c_2Eiterate_2Ensum @ A_27a @ ( c_2Epred__set_2EUNION @ A_27a @ V1s @ V2t ) @ V0f )
        = ( c_2Earithmetic_2E_2B @ ( c_2Eiterate_2Ensum @ A_27a @ V1s @ V0f ) @ ( c_2Eiterate_2Ensum @ A_27a @ V2t @ V0f ) ) ) ) )).
...
thf(thm_2Eiterate_2ENSUM__BIGUNION__NONZERO,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1s: ( A_27a > $o ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ ( A_27a > $o ) @ V1s )
        & ! [V2t: A_27a > $o] :
            ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ V1s )
           => ( c_2Epred__set_2EFINITE @ A_27a @ V2t ) )
        & ! [V3t1: A_27a > $o,V4t2: A_27a > $o,V5x: A_27a] :
            ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V3t1 @ V1s )
              & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V4t2 @ V1s )
              & ( (~) @ ( V3t1 = V4t2 ) )
              & ( c_2Ebool_2EIN @ A_27a @ V5x @ V3t1 )
              & ( c_2Ebool_2EIN @ A_27a @ V5x @ V4t2 ) )
           => ( ( V0f @ V5x )
              = c_2Enum_2E0 ) ) )
     => ( ( c_2Eiterate_2Ensum @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V1s ) @ V0f )
        = ( c_2Eiterate_2Ensum @ ( A_27a > $o ) @ V1s
          @ ^ [V6t: A_27a > $o] :
              ( c_2Eiterate_2Ensum @ A_27a @ V6t @ V0f ) ) ) ) )).
