...
thf(conj_thm_2Ellist_2ELLIST__BISIMULATION0,lemma,(
    ! [A_27a: del,V0ll1: $i] :
...
thf(conj_thm_2Ellist_2ELMAP__APPEND,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1ll1: $i] :
         ...
         => ! [V2ll2: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Ellist_2ELMAP @ A_27a @ A_27b ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V1ll1 ) @ V2ll2 ) )
                = ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27b ) @ ( ap @ ( ap @ ( c_2Ellist_2ELMAP @ A_27a @ A_27b ) @ V0f ) @ V1ll1 ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELMAP @ A_27a @ A_27b ) @ V0f ) @ V2ll2 ) ) ) ) ) ) )).
