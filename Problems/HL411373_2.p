...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EMPTY,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT__SET,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ! [V1x: tp__ty_2Erealax_2Ereal] :
           ...
           => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = V0s ) ) ) )).
