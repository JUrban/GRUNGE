...
thf(conj_thm_2Ereal__topology_2EOPEN__POSITIVE__MULTIPLES,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
       => ( p
              ...
              @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V1c: $i] :
                      ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V2x: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ V1c ) @ V2x ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V1c ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2x ) @ V0s ) ) ) ) ) ) ) ) ) ) ) )).
