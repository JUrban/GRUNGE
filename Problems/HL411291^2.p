...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSED__INTERVAL__LEFT,lemma,(
    ! [V0b: tp__ty_2Erealax_2Ereal] :
      ...
      @ ( ap @ c_2Ereal__topology_2EClosed
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V1x ) @ ( inj__ty_2Erealax_2Ereal @ V0b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__LE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ...
      @ ( ap @ c_2Ereal__topology_2EClosed
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V2x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) ) ) ) )).
