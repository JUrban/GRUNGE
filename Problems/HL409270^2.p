...
thf(conj_thm_2Eintegral_2EINTEGRABLE__LIMIT,lemma,(
    ! [V0f: $i] :
          ...
          ( ! [V3e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V4g: $i] :
                  ...
                  & ! [V5x: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) ) @ ( ap @ V4g @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) )
                  & ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V4g ) ) ) )
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__CONST,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V3x: $i] :
              ( inj__ty_2Erealax_2Ereal @ V2c ) ) ) ) )).

thf(conj_thm_2Eintegral_2EINTEGRABLE__COMBINE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
            ...
            & ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V0f ) )
            & ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) ) @ V0f ) ) )
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__POINT__SPIKE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4c: tp__ty_2Erealax_2Ereal] :
              ( ( ! [V5x: tp__ty_2Erealax_2Ereal] :
                    ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) )
                      & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) )
                      & ( V5x != V4c ) )
                   => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) )
                      = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) ) ) )
...
thf(conj_thm_2Eintegral_2EBOLZANO__LEMMA__ALT,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ( ( ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
                & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) )
                & ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
                & ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) ) )
             => ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) ) )
          & ! [V4x: tp__ty_2Erealax_2Ereal] :
            ? [V5d: tp__ty_2Erealax_2Ereal] :
              ...
              & ! [V6a: tp__ty_2Erealax_2Ereal,V7b: tp__ty_2Erealax_2Ereal] :
                 ...
                 => ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V6a ) ) @ ( inj__ty_2Erealax_2Ereal @ V7b ) ) ) ) ) )
       => ! [V8a: tp__ty_2Erealax_2Ereal,V9b: tp__ty_2Erealax_2Ereal] :
           ...
           => ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V8a ) ) @ ( inj__ty_2Erealax_2Ereal @ V9b ) ) ) ) ) ) )).

thf(conj_thm_2Eintegral_2ECONT__UNIFORM,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
         ...
         => ! [V4e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V5d: tp__ty_2Erealax_2Ereal] :
                  ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5d ) ) )
                  & ! [V6x: tp__ty_2Erealax_2Ereal,V7y: tp__ty_2Erealax_2Ereal] :
                      ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) )
                        ...
                        & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V7y ) ) )
                        & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V7y ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
                        & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) @ ( inj__ty_2Erealax_2Ereal @ V7y ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5d ) ) ) )
                     => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V7y ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4e ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__LE__SUB__CANCEL2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) )).
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__CONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ! [V3x: tp__ty_2Erealax_2Ereal] :
