...
fof(conj_thm_2Eiterate_2ENUMSEG__SING,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(lamtp_f3631,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3631(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3631,axiom,(
    ! [A_27a,V1f] :
     ...
     => ! [V3a] :
          ( mem(V3a,A_27a)
         => ap(f3631(A_27a,V1f),V3a) = ap(c_2Ereal_2Eabs,ap(V1f,V3a)) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUM__ABS__TRIANGLE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1f] :
             ...
             => ! [V2b] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Eiterate_2ESum(A_27a),V0s),f3631(A_27a,V1f))),V2b)) )
...
fof(conj_thm_2Ereal__topology_2EOPEN__SURJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1y] :
