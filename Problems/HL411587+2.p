...
fof(conj_thm_2Ereal__topology_2ELIM__IN__CLOSED__SET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__GE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3901(V0a)))) ) )).

fof(lamtp_f3987,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => mem(f3987(A_27a,V1f,V3b),arr(A_27a,bool)) ) ) )).

fof(lameq_f3987,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3987(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,V3b),ap(V1f,V4x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__COMPONENT__LBOUND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
             ...
             => ! [V2l] :
                 ...
                 => ! [V3b] :
                     ...
                     => ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                       ...
                       => p(ap(ap(c_2Ereal_2Ereal__lte,V3b),V2l)) ) ) ) ) ) ) )).
