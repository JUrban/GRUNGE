...
fof(conj_thm_2EindexedLists_2EMAP2ia__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( ( ! [V1f] :
                         ...
                         => ! [V2i] :
                             ...
                             => ! [V3v0] :
                                 ...
                                 => p(ap(ap(ap(ap(V0P,V1f),V2i),c_2Elist_2ENIL(A_27b)),V3v0)) ) ) )
                      & ! [V4f] :
                         ...
                         => ! [V5i] :
                             ...
                             => ! [V6v7] :
                                 ...
                                 => ! [V7v8] :
                                     ...
                                     => p(ap(ap(ap(ap(V0P,V4f),V5i),ap(ap(c_2Elist_2ECONS(A_27b),V6v7),V7v8)),c_2Elist_2ENIL(A_27c))) ) ) ) )
                      & ! [V8f] :
                                 ...
                                 => ! [V11t1] :
                                     ...
                                     => ! [V12h2] :
                                         ...
                                         => ! [V13t2] :
                                             ...
                                             => ( p(ap(ap(ap(ap(V0P,V8f),ap(ap(c_2Earithmetic_2E_2B,V9i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V11t1),V13t2))
                                               => p(ap(ap(ap(ap(V0P,V8f),V9i),ap(ap(c_2Elist_2ECONS(A_27b),V10h1),V11t1)),ap(ap(c_2Elist_2ECONS(A_27c),V12h2),V13t2))) ) ) ) ) ) ) ) )
                   => ! [V14v] :
                        ( mem(V14v,arr(ty_2Enum_2Enum,arr(A_27b,arr(A_27c,A_27a))))
                       => ! [V15v1] :
                            ( mem(V15v1,ty_2Enum_2Enum)
                           => ! [V16v2] :
