...
thf(f7480_0_2E0,type,(
    f7480_0_2E0: u )).

thf(f7480_0_2E1,type,(
    f7480_0_2E1: du > u )).

thf(f7480_1_2E0,type,(
    f7480_1_2E0: u )).

thf(f7480_1_2E2,type,(
    f7480_1_2E2: du > du > u )).

thf(f7480_2_2E0,type,(
    f7480_2_2E0: u )).

thf(f7480_2_2E2,type,(
    f7480_2_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef7480_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f7480_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ef7480_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( f7480_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef7480_2_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( f7480_2_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebool_2Eitself @ A_27a ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ebool_2Eitself @ A_27a ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) ) @ f7480_2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a: d,V0R_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f7480_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) ) ) )
...
thf(def1_2Ethm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a: d,V3v: mono_2Etyop_2Enum_2Enum,V4v1_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( f7480_2_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3v ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ V4v1_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ecombin_2EI_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3v ) ) ) ) ) ) ) )).

thf(def2_2Ethm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a: d,V1n2w__itself_2E0: u,V2a_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( f7480_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) @ V1n2w__itself_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ V2a_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Epair_2Epair__CASE_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ V2a_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Ebool_2Eitself @ A_27a ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) ) @ f7480_2_2E0 ) ) ) ) )).

thf(thm_2Ewords_2En2w__itself__primitive__def,axiom,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) ) @ c_2Ewords_2En2w__itself_2E0 )
...
thf(thm_2Ewords_2En2w__itself__def,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w__itself_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
