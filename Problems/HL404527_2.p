...
tff(conj_thm_2Ecardinal_2ECARD__LE__IMAGE,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__LE__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),V2t),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))
               => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V2t),V1s)) ) ) ) ) )).
