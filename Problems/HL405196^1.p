...
thf(f5974_0_2E0,type,(
    f5974_0_2E0: u )).

thf(f5974_0_2E1,type,(
    f5974_0_2E1: du > u )).

thf(f5974_0_2E2,type,(
    f5974_0_2E2: du > du > u )).
...
thf(c_2Ealist_2Ealist__to__fmap_2E0,type,(
    c_2Ealist_2Ealist__to__fmap_2E0: u )).

thf(c_2Ealist_2Ealist__to__fmap_2E1,type,(
...
thf(arityeq1_2Emono_2Ef5974_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( f5974_0_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ f5974_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef5974_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( f5974_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ec_2Elist_2ELIST__TO__SET_2E1_2Emono_2Etyop_2Epair_2Eprod_28A_27b_2CA_27a_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ c_2Elist_2ELIST__TO__SET_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Eoption_2ETHE_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Ealist_2Ealist__to__fmap_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ c_2Ealist_2Ealist__to__fmap_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Ealist_2EALOOKUP__FAILS,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1l_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V1l_2E0 ) @ ( s @ A_27b @ V0x_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
    <=> ! [V2k_2E0: u,V3v_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27b @ V2k_2E0 ) @ ( s @ A_27a @ V3v_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V1l_2E0 ) ) ) ) ) )
         => ( (~)
            @ ( ( s @ A_27b @ V2k_2E0 )
              = ( s @ A_27b @ V0x_2E0 ) ) ) ) ) )).

thf(thm_2Ealist_2EALOOKUP__SOME__FAPPLY__alist__to__fmap,axiom,(
    ! [A_27a: d,A_27b: d,V0al_2E0: u,V1k_2E0: u,V2v_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V2v_2E0 ) ) ) )
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) ) ) @ ( s @ A_27a @ V1k_2E0 ) ) )
        = ( s @ A_27b @ V2v_2E0 ) ) ) )).

thf(thm_2Ealist_2EFDOM__alist__to__fmap,axiom,(
    ! [A_27a: d,A_27b: d,V0al_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Elist_2EFINITE__LIST__TO__SET,axiom,(
    ! [A_27a: d,V0l_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ealist_2Ealist__to__fmap__to__alist,axiom,(
    ! [A_27a: d,A_27b: d,V0al_2E0: u,V1k_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( f5974_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1k_2E0 ) @ ( s @ A_27b @ ( c_2Eoption_2ETHE_2E1 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Ealist_2Ealist__to__fmap__to__alist,conjecture,(
    ! [A_27a: d,A_27b: d,V0al_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Ealist_2Efmap__to__alist_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Ealist_2Ealist__to__fmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) ) ) ) )
