...
thf(conj_thm_2Ecardinal_2ECOUNTABLE__EMPTY,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) )).

thf(conj_thm_2Ereal__topology_2EUNCOUNTABLE__INTERVAL,lemma,
...
thf(conj_thm_2Ereal__topology_2ECOUNTABLE__OPEN__INTERVAL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
