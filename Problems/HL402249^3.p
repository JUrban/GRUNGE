...
thf(c_2Epred__set_2EITSET,type,(
    c_2Epred__set_2EITSET: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( A_27a > A_27b > A_27b ) > ( A_27a > $o ) > A_27b > A_27b ) )).
...
thf(thm_2Elist_2ESUM__MAP__FOLDL,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1ls: tyop_2Elist_2Elist @ A_27a] :
      ...
      = ( c_2Elist_2EFOLDL @ A_27a @ tyop_2Enum_2Enum
        @ ^ [V2a: tyop_2Enum_2Enum,V3e: A_27a] :
            ( c_2Earithmetic_2E_2B @ V2a @ ( V0f @ V3e ) )
        @ c_2Enum_2E0
        @ V1ls ) ) )).
...
thf(thm_2Epred__set_2ESUM__IMAGE__DEF,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1s: A_27a > $o] :
      ...
      = ( c_2Epred__set_2EITSET @ A_27a @ tyop_2Enum_2Enum
        @ ^ [V2e: A_27a,V3acc: tyop_2Enum_2Enum] :
            ( c_2Earithmetic_2E_2B @ ( V0f @ V2e ) @ V3acc )
        @ V1s
        @ c_2Enum_2E0 ) ) )).
