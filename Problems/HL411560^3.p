    ...
    ! [V0x: tyop_2Erealax_2Ereal,V1e: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2y: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2y @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0x @ V2y ) ) @ V1e ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESPHERE,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1r: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Ebool_2ECOND @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Erealax_2Ereal__lt @ V1r @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ ( c_2Ereal_2Ereal__sub @ V0a @ V1r ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__add @ V0a @ V1r ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) ) )).
