...
tff(lamtp_f310,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
     => mem(f310(A_27a,V0f),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).
...
tff(lameq_f310,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,bool))
         => ap(f310(A_27a,V0f),V1X) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1X),ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(V0f,V1X)),V1X)) ) ) )).
...
tff(conj_thm_2EfixedPoint_2Elfp__least__closed,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),V0f))
