...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__integral__add,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                                                        ...
                                                        @ ( ap
                                                          @ ( ap
                                                            @ ( ap @ ( ap @ ( c_2Emeasure_2Epos__simple__fn @ A_27a ) @ V0m )
                                                              @ ( lam @ A_27a
                                                                @ ^ [V12x: $i] :
                                                                    ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ V1f @ V12x ) ) @ ( ap @ V5g @ V12x ) ) ) )
                                                            @ V9s_27_27 )
                                                          @ V10c )
                                                        @ V11z ) )
...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__integral__sum__alt,conjecture,(
                                          ...
                                          = ( surj__ty_2Eextreal_2Eextreal
                                            @ ( ap
                                              @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27b )
                                                @ ( lam @ A_27b
                                                  @ ^ [V12i: $i] :
                                                      ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__simple__fn__integral @ A_27a ) @ V0m ) @ ( ap @ V2s @ V12i ) ) @ ( ap @ V3a @ V12i ) ) @ ( ap @ V4x @ V12i ) ) ) )
                                              @ V5P ) ) ) ) ) ) ) ) ) ) ) ) ) )).
