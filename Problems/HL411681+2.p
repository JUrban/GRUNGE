...
fof(conj_thm_2Ereal__topology_2ECBALL__TRIVIAL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EBALL__EQ__EMPTY,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__CBALL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECBALL__EMPTY,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EEMPTY__INTERIOR__FINITE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EFINITE__CBALL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1r))))
          <=> p(ap(ap(c_2Ereal_2Ereal__lte,V1r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) ) )).
