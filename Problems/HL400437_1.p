...
tff(c_2Erelation_2EINVOL_2E0,type,(
    c_2Erelation_2EINVOL_2E0: u )).

tff(c_2Erelation_2EINVOL_2E1,type,(
...
tff(arityeq1_2Ec_2Erelation_2EINVOL_2E1,axiom,(
    ! [A_27z: d,X0_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2EINVOL_2E1(s(tyop_2Emin_2Efun(A_27z,A_27z),X0_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27z,A_27z),tyop_2Emin_2Ebool),c_2Erelation_2EINVOL_2E0),s(tyop_2Emin_2Efun(A_27z,A_27z),X0_2E0)))) )).
...
tff(thm_2Erelation_2EINVOL,axiom,(
    ! [A_27z: d,V0f_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2EINVOL_2E1(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0)))))
    <=> ! [V1x_2E0: u] : s(A_27z,app_2E2(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0),s(A_27z,app_2E2(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0),s(A_27z,V1x_2E0))))) = s(A_27z,V1x_2E0) ) )).
...
tff(thm_2Erelation_2EINVOL__ONE__ONE,conjecture,(
    ! [A_27z: d,V0f_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2EINVOL_2E1(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0)))))
     => ! [V1a_2E0: u,V2b_2E0: u] :
          ( s(A_27z,app_2E2(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0),s(A_27z,V1a_2E0))) = s(A_27z,app_2E2(s(tyop_2Emin_2Efun(A_27z,A_27z),V0f_2E0),s(A_27z,V2b_2E0)))
        <=> s(A_27z,V1a_2E0) = s(A_27z,V2b_2E0) ) ) )).
