...
fof(conj_thm_2Ereal__topology_2EABS__TRIANGLE__LE,conjecture,(
    ! [V0e] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Eabs,V1x)),ap(c_2Ereal_2Eabs,V2y))),V0e))
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__add,V1x),V2y))),V0e)) ) ) ) ) )).
