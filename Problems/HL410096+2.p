...
fof(lameq_f3519,axiom,(
    ! [A_27a,A_27a,V0b] :
     ...
     => ! [V2a] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3519(A_27a,A_27a,V0b,V2a),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2a)),V0b),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) ) )).

fof(conj_thm_2Eproduct_2EPRODUCT__DELTA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,ty_2Erealax_2Ereal)
         => ! [V1s] :
             ...
             => ! [V2a] :
                  ( mem(V2a,A_27a)
                 => ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3519(A_27a,A_27a,V0b,V2a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V2a),V1s)),V0b),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) ) ) )).
