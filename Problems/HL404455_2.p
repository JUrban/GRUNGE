...
tff(conj_thm_2Ecardinal_2EHAS__SIZE__NUMSEG__LE,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ecardinal_2EHAS__SIZE(ty_2Enum_2Enum),ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1876(V0n))),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )).
