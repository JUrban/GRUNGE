...
thf(thm_2Erelation_2ERC__lifts__monotonicities,conjecture,(
    ! [A_27a: d,V0f_2E0: u,V1R_2E0: u] :
     ...
     => ! [V4x_2E0: u,V5y_2E0: u] :
         ...
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2ERC_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1R_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V0f_2E0 ) @ ( s @ A_27a @ V5y_2E0 ) ) ) ) ) ) ) ) )).
