...
fof(lamtp_f190,axiom,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => mem(f190(V0P),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f190,axiom,(
    ! [V0P] :
     ...
     => ! [V1n] :
         ...
         => ap(f190(V0P),V1n) = ap(V0P,V1n) ) ) )).

fof(lamtp_f191,axiom,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => mem(f191(V0P),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(conj_thm_2Ewhile_2EOLEAST__INTRO,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ! [V1Q] :
