...
tff(conj_thm_2Epred__set_2EBIJ__DELETE,lemma,(
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V2f),V0s),V1t))
               => ! [V3e: $i] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3e),V0s))
                     => p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V2f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V0s),V3e)),ap(ap(c_2Epred__set_2EDELETE(A_27b),V1t),ap(V2f,V3e)))) ) ) ) ) ) ) )).
...
tff(conj_thm_2Epred__set_2ECARD__DELETE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1x: $i] :
...
tff(conj_thm_2Epred__set_2EFINITE__BIJ__CARD__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0S: $i] :
      ( mem(V0S,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0S))
       => ! [V1t: $i] :
