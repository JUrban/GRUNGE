...
fof(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__INTERVAL,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECARD__EQ__INTERVAL,lemma,
    ( ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ECARD__EQ__OPEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2EOpen,V0s))
