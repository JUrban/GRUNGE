...
tff(conj_thm_2EHolSmt_2Er154,conjecture,(
    ! [V0u: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal,V2v: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal,V4a: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0u))),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V2v))),inj__ty_2Erealax_2Ereal(V3y)))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V4a)))
    <=> surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0u)),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2v)),inj__ty_2Erealax_2Ereal(V3y)))) = V4a ) )).
