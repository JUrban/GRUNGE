...
thf(conj_thm_2Epred__set_2EBIJ__FINITE__SUBSET,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Epred__set_2ECROSS__SUBSET,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1Q: $i] :
          ( ( mem @ V1Q @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Eseq_2ENUM__2D__BIJ__SMALL__SQUARE,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1k: tp__ty_2Enum_2Enum] :
         ...
         => ? [V2N: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) @ V0f ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V2N ) ) ) ) ) ) ) )).
