...
thf(conj_thm_2Ebit_2EBITS__ZEROL,lemma,(
    ! [V0h: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) )
        = V1a ) ) )).
...
thf(conj_thm_2Ebit_2EBIT__B__NEQ,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
      ( ( V0a != V1b )
...
thf(conj_thm_2Ebit_2EBITWISE__ONE__COMP__LEM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum
        @ ( ap
          @ ( ap
            @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
              @ ( lam @ bool
                @ ^ [V3x: $i] :
                    ( lam @ bool
                    @ ^ [V4y: $i] :
                        ( ap @ c_2Ebool_2E_7E @ V3x ) ) ) )
            @ ( inj__ty_2Enum_2Enum @ V1a ) )
          @ ( inj__ty_2Enum_2Enum @ V2b ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) ) )).
...
thf(conj_thm_2Ebit_2EBIT__COMPLEMENT,conjecture,(
