...
fof(conj_thm_2Epath_2Efirst__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0i),V1j))
                       ...
                       => ap(c_2Epath_2Efirst(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V0i),V1j),V2p)) = ap(ap(c_2Epath_2Eel(A_27a,A_27a),V0i),V2p) ) ) ) ) ) ) )).
