...
thf(thm_2Epred__set_2EMIN__SET__DEF,axiom,(
    mono_2Ec_2Epred__set_2EMIN__SET = mono_2Ec_2Ewhile_2ELEAST )).
...
thf(thm_2Epred__set_2EMIN__SET__LEQ__MAX__SET,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( (~) @ ( V0s = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Enum_2Enum ) )
        & ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Enum_2Enum @ V0s ) )
     => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Epred__set_2EMIN__SET @ V0s ) @ ( mono_2Ec_2Epred__set_2EMAX__SET @ V0s ) ) ) )).
