...
tff(conj_thm_2Ellist_2ELMAP__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27c,A_27a))
         => ! [V2ll: $i] :
             ...
             => ap(ap(c_2Ellist_2ELMAP(A_27a,A_27a),V0f),ap(ap(c_2Ellist_2ELMAP(A_27c,A_27c),V1g),V2ll)) = ap(ap(c_2Ellist_2ELMAP(A_27c,A_27c),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0f),V1g)),V2ll) ) ) ) )).
