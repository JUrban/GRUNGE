...
thf(thm_2Eiterate_2ENUMSEG__RREC,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V0m @ V1n )
     => ( ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ V1n @ ( c_2Eiterate_2E_2E_2E @ V0m @ ( c_2Earithmetic_2E_2D @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
        = ( c_2Eiterate_2E_2E_2E @ V0m @ V1n ) ) ) )).

thf(thm_2Eiterate_2EIN__NUMSEG,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Enum_2Enum] :
      ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V2p @ ( c_2Eiterate_2E_2E_2E @ V0m @ V1n ) )
    <=> ( ( c_2Earithmetic_2E_3C_3D @ V0m @ V2p )
        & ( c_2Earithmetic_2E_3C_3D @ V2p @ V1n ) ) ) )).
    ...
    ! [V0h: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
     ...
     => ? [V1B: tyop_2Erealax_2Ereal] :
          ...
          & ! [V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
              ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0h @ V2x @ V3y ) ) @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__mul @ V1B @ ( c_2Ereal_2Eabs @ V2x ) ) @ ( c_2Ereal_2Eabs @ V3y ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__POS,axiom,(
    ...
    <=> ? [V1b: tyop_2Erealax_2Ereal] :
          ...
          & ! [V2x: tyop_2Erealax_2Ereal] :
             ...
             => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V2x ) @ V1b ) ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__CMUL,axiom,(
    ! [V0s: tyop_2Enum_2Enum > $o,V1x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2c: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Esummable @ V0s @ V1x )
     => ( c_2Ereal__topology_2Esummable @ V0s
        @ ^ [V3n: tyop_2Enum_2Enum] :
            ( c_2Erealax_2Ereal__mul @ V2c @ ( V1x @ V3n ) ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__EQ,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2k: tyop_2Enum_2Enum > $o] :
      ( ( ! [V3x: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3x @ V2k )
           => ( ( V0f @ V3x )
              = ( V1g @ V3x ) ) )
        & ( c_2Ereal__topology_2Esummable @ V2k @ V0f ) )
     => ( c_2Ereal__topology_2Esummable @ V2k @ V1g ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__FROM__ELSEWHERE,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Ereal__topology_2Esummable @ ( c_2Ereal__topology_2Efrom @ V1m ) @ V0f )
     => ( c_2Ereal__topology_2Esummable @ ( c_2Ereal__topology_2Efrom @ V2n ) @ V0f ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__COMPARISON,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2s: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2Ereal__topology_2Esummable @ V2s @ V1g )
        & ? [V3N: tyop_2Enum_2Enum] :
          ! [V4n: tyop_2Enum_2Enum] :
            ( ( ( c_2Earithmetic_2E_3E_3D @ V4n @ V3N )
              & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4n @ V2s ) )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0f @ V4n ) ) @ ( V1g @ V4n ) ) ) )
     => ( c_2Ereal__topology_2Esummable @ V2s @ V0f ) ) )).

thf(thm_2Ereal__topology_2EBOUNDED__PARTIAL__SUMS,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1k: tyop_2Enum_2Enum] :
      ( ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum
          @ ^ [V2n: tyop_2Enum_2Enum] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1k @ V2n ) @ V0f ) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V2n @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )
     => ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )
          @ ( c_2Epair_2EUNCURRY @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
            @ ^ [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V3m @ V4n ) @ V0f ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3m @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4n @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__BILINEAR__PARTIAL__PRE,axiom,(
...
thf(thm_2Ereal__topology_2ESERIES__DIRICHLET__BILINEAR,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2h: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3k: tyop_2Enum_2Enum,V4m: tyop_2Enum_2Enum,V5p: tyop_2Enum_2Enum,V6l: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Ebilinear @ V2h )
        & ( c_2Ereal__topology_2Ebounded__def
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum
            @ ^ [V7n: tyop_2Enum_2Enum] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V4m @ V7n ) @ V0f ) @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V7n @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )
        & ( c_2Ereal__topology_2Esummable @ ( c_2Ereal__topology_2Efrom @ V5p )
          @ ^ [V8n: tyop_2Enum_2Enum] :
              ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V1g @ ( c_2Earithmetic_2E_2B @ V8n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( V1g @ V8n ) ) ) )
        & ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum
          @ ^ [V9n: tyop_2Enum_2Enum] :
              ( V2h @ ( V1g @ ( c_2Earithmetic_2E_2B @ V9n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V9n ) @ V0f ) )
          @ V6l
          @ c_2Ereal__topology_2Esequentially ) )
     => ( c_2Ereal__topology_2Esummable @ ( c_2Ereal__topology_2Efrom @ V3k )
        @ ^ [V10n: tyop_2Enum_2Enum] :
            ( V2h @ ( V1g @ V10n ) @ ( V0f @ V10n ) ) ) ) )).
