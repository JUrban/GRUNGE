...
tff(lamtp_f3540,axiom,(
    ! [A_27a: del,A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => mem(f3540(A_27a,A_27a,V0m),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f3540,axiom,(
    ! [A_27a: del,A_27a: del,V0m: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3540(A_27a,A_27a,V0m),V3x) = ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),ap(ap(c_2Epred__set_2EINSERT(A_27a),V3x),c_2Epred__set_2EEMPTY(A_27a))) ) ) )).

tff(conj_thm_2Emeasure_2EMEASURE__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
              ...
              & ! [V2x: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                   => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),c_2Epred__set_2EEMPTY(A_27a))),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) ) )
              & p(ap(c_2Epred__set_2EFINITE(A_27a),V1s)) )
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3540(A_27a,A_27a,V0m)),V1s)) ) ) ) )).
