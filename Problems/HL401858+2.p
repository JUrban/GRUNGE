...
fof(conj_thm_2Epred__set_2Ecount__add,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ap(c_2Epred__set_2Ecount,ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)) = ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),ap(c_2Epred__set_2Ecount,V0n)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Earithmetic_2E_2B,V0n)),ap(c_2Epred__set_2Ecount,V1m))) ) ) )).
