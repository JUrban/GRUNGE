...
thf(f9801_0_2E0,type,(
    f9801_0_2E0: u )).

thf(f9801_0_2E1,type,(
    f9801_0_2E1: du > u )).

thf(f9801_0_2E2,type,(
    f9801_0_2E2: du > du > u )).

thf(f9802_0_2E0,type,(
    f9802_0_2E0: u )).

thf(f9802_0_2E1,type,(
    f9802_0_2E1: du > u )).

thf(f9802_0_2E2,type,(
    f9802_0_2E2: du > du > u )).
...
thf(mono_2Ef9801_0,type,(
    mono_2Ef9801_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9802_0,type,(
    mono_2Ef9802_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Etransc_2Ecos,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9801_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Earithmetic_2EEVEN @ V1n ) @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Earithmetic_2EDIV @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) ) ) )).

thf(thm_2Etransc_2Ecos,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Etransc_2Ecos @ V0x )
      = ( mono_2Ec_2Eseq_2Esuminf @ ( mono_2Ef9801_0 @ V0x ) ) ) )).
...
thf(def0_2Ethm_2Etransc_2ECOS__CONVERGES,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9802_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Earithmetic_2EEVEN @ V1n ) @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Earithmetic_2EDIV @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ V1n ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ V1n ) ) ) )).

thf(thm_2Etransc_2ECOS__CONVERGES,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9802_0 @ V0x ) @ ( mono_2Ec_2Etransc_2Ecos @ V0x ) ) )).
