...
tff(conj_thm_2Eextreal_2Eadd__infty,lemma,
    ( ! [V0x: tp__ty_2Eextreal_2Eextreal] :
        ( surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf))) = fo__c_2Eextreal_2EPosInf
        & surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf)),inj__ty_2Eextreal_2Eextreal(V0x))) = fo__c_2Eextreal_2EPosInf )
    & ! [V1x: tp__ty_2Eextreal_2Eextreal] :
        ( V1x != fo__c_2Eextreal_2EPosInf
       => ( surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(V1x)),inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2ENegInf))) = fo__c_2Eextreal_2ENegInf
          & surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2ENegInf)),inj__ty_2Eextreal_2Eextreal(V1x))) = fo__c_2Eextreal_2ENegInf ) ) )).
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__pos,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__split,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(lamtp_f4190,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => mem(f4190(A_27a,V1s),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4190,axiom,(
    ! [A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f4190(A_27a,V1s),V2x) = ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s),V2x)) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__infty,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
              & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))) )
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4190(A_27a,V1s))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(fo__c_2Eextreal_2EPosInf)),ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)))) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__infty,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
