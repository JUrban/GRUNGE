...
tff(conj_thm_2Eprim__rec_2Emeasure__thm,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Earithmetic_2ENOT__ZERO__LT__ZERO,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( V0n != fo__c_2Enum_2E0
    <=> p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n))) ) )).

tff(conj_thm_2Earithmetic_2ELESS__ADD__NONZERO,lemma,(
...
tff(conj_thm_2Earithmetic_2ELESS__LESS__EQ__TRANS,lemma,(
...
tff(conj_thm_2Earithmetic_2Efindq__eq__0,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
      ( surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0a)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))))) = fo__c_2Enum_2E0
    <=> V0a = fo__c_2Enum_2E0 ) )).

tff(lmtp_f184,type,(
    f184: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f184,axiom,(
    ! [V1a: tp__ty_2Enum_2Enum,V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => mem(f184(V1a,V2m,V3n,V0f),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).

tff(lameq_f184,axiom,(
    ! [V1a: tp__ty_2Enum_2Enum,V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V4q: tp__ty_2Enum_2Enum] : ap(f184(V1a,V2m,V3n,V0f),inj__ty_2Enum_2Enum(V4q)) = ap(V0f,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1a)),inj__ty_2Enum_2Enum(V4q))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2m)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V4q)))),inj__ty_2Enum_2Enum(V3n)))) ) )).

tff(lmtp_f183,type,(
    f183: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f183,axiom,(
    ! [V2m: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => mem(f183(V2m,V1a,V0f),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).

tff(lameq_f183,axiom,(
    ! [V2m: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f183(V2m,V1a,V0f),inj__ty_2Enum_2Enum(V3n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1a)),inj__ty_2Enum_2Enum(V2m))),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f184(V1a,V2m,V3n,V0f)),ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))))))) ) )).

tff(lmtp_f182,type,(
    f182: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f182,axiom,(
    ! [V1a: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => mem(f182(V1a,V0f),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).

tff(lameq_f182,axiom,(
    ! [V1a: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V2m: tp__ty_2Enum_2Enum] : ap(f182(V1a,V0f),inj__ty_2Enum_2Enum(V2m)) = f183(V2m,V1a,V0f) ) )).

tff(lmtp_f181,type,(
    f181: $i > $i )).

tff(lamtp_f181,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => mem(f181(V0f),arr(ty_2Enum_2Enum,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).

tff(lameq_f181,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum] : ap(f181(V0f),inj__ty_2Enum_2Enum(V1a)) = ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f182(V1a,V0f)) ) )).

tff(lmtp_f180,type,(
    f180: $i )).

tff(lamtp_f180,axiom,(
    mem(f180,arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).

tff(lameq_f180,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ap(f180,V0f) = ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f181(V0f)) ) )).

tff(ax_thm_2Earithmetic_2EDIVMOD__DEF,axiom,(
    c_2Earithmetic_2EDIVMOD = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Eprim__rec_2Emeasure(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Ecombin_2Eo(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epair_2EFST(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum)))),f180) )).

tff(lmtp_f185,type,(
    f185: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f185,axiom,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : mem(f185(V0a,V1m,V2n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f185,axiom,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum,V3q: tp__ty_2Enum_2Enum] : ap(f185(V0a,V1m,V2n),inj__ty_2Enum_2Enum(V3q)) = ap(c_2Earithmetic_2EDIVMOD,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0a)),inj__ty_2Enum_2Enum(V3q))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1m)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V3q)))),inj__ty_2Enum_2Enum(V2n)))) )).

tff(conj_thm_2Earithmetic_2EDIVMOD__THM,conjecture,(
    ! [V0a: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : surj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(ap(c_2Earithmetic_2EDIVMOD,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0a)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))))) = surj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0a)),inj__ty_2Enum_2Enum(V1m))),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f185(V0a,V1m,V2n)),ap(c_2Earithmetic_2Efindq,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2n)))))))) )).
