    ...
    ! [A_27a: del,V2v1: $i] :
     ...
     => ! [V3v2: $i] :
         ...
         => ! [V4v3: $i] :
             ...
             => ! [V1v0: $i] :
                  ( mem(V1v0,A_27a)
                 => mem(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),arr(ty_2Enum_2Enum,A_27a)) ) ) ) ) )).
    ...
    ! [A_27a: del,V2v1: $i] :
     ...
     => ! [V3v2: $i] :
         ...
         => ! [V4v3: $i] :
             ...
             => ! [V1v0: $i] :
                  ( mem(V1v0,A_27a)
                 => ! [V5m: tp__ty_2Enum_2Enum] : ap(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),inj__ty_2Enum_2Enum(V5m)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V5m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V1v0),ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V5m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V2v1),ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V3v2),V4v3))) ) ) ) ) )).
...
tff(tp_c_2Eieee_2Eroundmode__CASE,type,(
    c_2Eieee_2Eroundmode__CASE: del > $i )).

tff(mem_c_2Eieee_2Eroundmode__CASE,axiom,(
    ! [A_27a: del] : mem(c_2Eieee_2Eroundmode__CASE(A_27a),arr(ty_2Eieee_2Eroundmode,arr(A_27a,arr(A_27a,arr(A_27a,arr(A_27a,A_27a)))))) )).

tff(conj_thm_2Eieee_2Eroundmode2num__thm,lemma,
    ( surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__nearest))) = fo__c_2Enum_2E0
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2Efloat__To__zero))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__pinfinity))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__ninfinity))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).

tff(ax_thm_2Eieee_2Eroundmode__CASE,axiom,(
    ! [A_27a: del,V0x: tp__ty_2Eieee_2Eroundmode,V1v0: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V3v2: $i] :
             ...
             => ! [V4v3: $i] :
                  ( mem(V4v3,A_27a)
                 => ap(ap(ap(ap(ap(c_2Eieee_2Eroundmode__CASE(A_27a),inj__ty_2Eieee_2Eroundmode(V0x)),V1v0),V2v1),V3v2),V4v3) = ap(f3039(A_27a,V2v1,V3v2,V4v3,V1v0),ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(V0x))) ) ) ) ) )).

tff(conj_thm_2Eieee_2Eroundmode__case__def,conjecture,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( mem(V0v0,A_27a)
         => ! [V1v1: $i] :
             ...
             => ! [V2v2: $i] :
                 ...
                 => ! [V3v3: $i] :
                      ( mem(V3v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eroundmode__CASE(A_27a),inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__nearest)),V0v0),V1v1),V2v2),V3v3) = V0v0 ) ) ) )
      & ! [V4v0: $i] :
          ( mem(V4v0,A_27a)
         => ! [V5v1: $i] :
              ( mem(V5v1,A_27a)
             => ! [V6v2: $i] :
                 ...
                 => ! [V7v3: $i] :
                      ( mem(V7v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eroundmode__CASE(A_27a),inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2Efloat__To__zero)),V4v0),V5v1),V6v2),V7v3) = V5v1 ) ) ) )
      & ! [V8v0: $i] :
          ( mem(V8v0,A_27a)
         => ! [V9v1: $i] :
              ( mem(V9v1,A_27a)
             => ! [V10v2: $i] :
                 ...
                 => ! [V11v3: $i] :
                      ( mem(V11v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eroundmode__CASE(A_27a),inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__pinfinity)),V8v0),V9v1),V10v2),V11v3) = V10v2 ) ) ) )
      & ! [V12v0: $i] :
          ( mem(V12v0,A_27a)
         => ! [V13v1: $i] :
              ( mem(V13v1,A_27a)
             => ! [V14v2: $i] :
                 ...
                 => ! [V15v3: $i] :
                      ( mem(V15v3,A_27a)
                     => ap(ap(ap(ap(ap(c_2Eieee_2Eroundmode__CASE(A_27a),inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__ninfinity)),V12v0),V13v1),V14v2),V15v3) = V15v3 ) ) ) ) ) )).
