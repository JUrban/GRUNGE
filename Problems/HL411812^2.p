...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE__STRONG,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
