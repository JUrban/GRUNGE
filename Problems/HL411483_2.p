...
tff(conj_thm_2Ereal__topology_2EDIAMETER__SUBSET__CBALL__NONEMPTY,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
          & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
       => ? [V1z: tp__ty_2Erealax_2Ereal] :
            ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1z)),V0s))
            & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1z)),ap(c_2Ereal__topology_2Ediameter,V0s))))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EDIAMETER__SUBSET__CBALL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => ? [V1z: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1z)),ap(c_2Ereal__topology_2Ediameter,V0s))))) ) ) )).
