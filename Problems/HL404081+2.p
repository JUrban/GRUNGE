...
fof(lameq_f1403,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1403(V0a),V2t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,f889(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V2t)) ) ) )).

fof(lamtp_f1404,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1404,axiom,(
    ! [V0a] :
     ...
     => ! [V5t] :
          ( mem(V5t,ty_2Enum_2Enum)
         => ap(f1404(V0a),V5t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V0a),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V5t) ) ) )).

fof(lamtp_f1405,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V7t] :
             ...
             => ap(f1405(V1b,V0a),V7t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1361(V0a,V1b)),V7t) ) ) ) )).

fof(lamtp_f1406,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V9t] :
             ...
             => ap(f1406(V0a,V1b),V9t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,f1363(V0a)),V1b),V9t)) ) ) ) )).

fof(lamtp_f1407,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V11t] :
             ...
             => ap(f1407(V1b,V0a),V11t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1300(V0a,V1b)),V11t) ) ) ) )).

fof(lamtp_f1408,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V13t] :
             ...
             => ap(f1408(V0a,V1b),V13t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1355(V0a,V1b)),V13t)) ) ) ) )).

fof(lamtp_f1409,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V15t] :
             ...
             => ap(f1409(V0a,V1b),V15t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSBEFORE,V1b),f1367(V0a,V1b)),V15t)) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
