...
fof(mem_c_2EEncode_2Eencode__tree,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EEncode_2Eencode__tree(A_27a),arr(arr(A_27a,ty_2Elist_2Elist(bool)),arr(ty_2EEncode_2Etree(A_27a),ty_2Elist_2Elist(bool)))) ) )).

fof(mem_c_2EEncode_2Elift__tree,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EEncode_2Elift__tree(A_27a),arr(arr(A_27a,bool),arr(ty_2EEncode_2Etree(A_27a),bool))) ) )).
...
fof(conj_thm_2EEncode_2Ewf__encode__tree,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
...
fof(mem_c_2EDecode_2Edecode__tree,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EDecode_2Edecode__tree(A_27a),arr(arr(ty_2EEncode_2Etree(A_27a),bool),arr(arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))),arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2EEncode_2Etree(A_27a),ty_2EEncode_2Etree(A_27a))))))) ) )).
...
fof(conj_thm_2EDecode_2Ewf__decode__tree,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
