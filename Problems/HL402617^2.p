...
thf(conj_thm_2Erich__list_2ENOT__NULL__SNOC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(ax_thm_2Erich__list_2EIS__SUFFIX,axiom,(
    ! [A_27a: del] :
      ( ! [V0l: $i] :
          ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Erich__list_2EIS__SUFFIX__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Erich__list_2EIS__SUFFIX @ A_27a ) @ V0l1 ) @ V1l2 ) )
          <=> ? [V2l: $i] :
                ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
                & ( V0l1
                  = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l ) @ V1l2 ) ) ) ) ) ) )).
