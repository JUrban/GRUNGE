...
thf(conj_thm_2Ereal__topology_2ESUBSET__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27b ) @ V1s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V2t ) ) )
              <=> ? [V3u: $i] :
                    ...
                    & ( V1s
                      = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V3u ) ) ) ) ) ) ) )).
...
thf(ax_thm_2Etopology_2Eistopology,axiom,(
    ! [A_27a: del,V0L: $i] :
...
thf(conj_thm_2Ereal__topology_2EISTOPLOGY__SUBTOPOLOGY,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1u: $i] :
         ...
         => ( p
            @ ( ap @ ( c_2Etopology_2Eistopology @ A_27a )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                @ ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2s: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V2s ) @ V1u ) ) @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ A_27a ) @ V0top ) @ V2s ) ) ) ) ) ) ) ) )).
