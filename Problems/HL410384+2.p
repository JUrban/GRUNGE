...
fof(lamtp_f3638,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3638(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V2x] :
             ...
             => ap(f3638(V0f,V1g),V2x) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,V2x)),ap(V1g,V2x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__ADD,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(lameq_f3642,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V3x] :
         ...
         => ! [V4a] :
              ( mem(V4a,A_27a)
             => ap(f3642(A_27a,V0f,V3x),V4a) = ap(ap(V0f,V4a),V3x) ) ) ) )).

fof(lamtp_f3641,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1s] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f3641(A_27a,V0f,V1s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3641,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1s] :
         ...
         => ! [V3x] :
              ( mem(V3x,ty_2Erealax_2Ereal)
             => ap(f3641(A_27a,V0f,V1s),V3x) = ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3642(A_27a,V0f,V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               ...
               => p(ap(c_2Ereal__topology_2Elinear,f3641(A_27a,V0f,V1s))) ) ) ) ) )).
