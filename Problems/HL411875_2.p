...
tff(conj_thm_2Ereal__topology_2ESEPARATION__NORMAL__LOCAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
             ...
             => ( ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2u)),V0s))
               ...
               => ? [V3s_27: $i] :
                    ...
                    & ? [V4t_27: $i] :
                        ...
                        & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V3s_27),V4t_27) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) ) ) ) )).
