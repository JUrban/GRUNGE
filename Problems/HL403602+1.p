...
fof(thm_2Einftree_2Einftree__nchotomy,conjecture,(
    ! [A_27a,A_27b,A_27c,V0t_2E0] :
      ( ? [V1a_2E0] : s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),V0t_2E0) = s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiLf_2E1(s(A_27a,V1a_2E0)))
      | ? [V2b_2E0,V3d_2E0] : s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),V0t_2E0) = s(tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c),c_2Einftree_2EiNd_2E2(s(A_27b,V2b_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Einftree_2Einftree(A_27a,A_27b,A_27c)),V3d_2E0))) ) )).
