...
fof(conj_thm_2Ereal__topology_2ESEPARATION__T1,lemma,(
    ! [V0x] :
         ...
         => ( V0x != V1y
          <=> ? [V2u] :
                ...
                & ? [V3v] :
                    ...
                    & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1y),V2u))
                    & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V0x),V3v))
                    & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1y),V3v)) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEPARATION__T0,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
