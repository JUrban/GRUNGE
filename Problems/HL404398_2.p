...
tff(conj_thm_2Epred__set_2EINJ__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1s: $i] :
...
tff(conj_thm_2Epred__set_2EINJ__INSERT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Epred__set_2EFINITE__DIFF__down,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ECARD__COUNT,lemma,(
...
tff(conj_thm_2Epred__set_2EINFINITE__INHAB,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0P))
       => ? [V1x: $i] :
...
tff(conj_thm_2Ecardinal_2ECARDLEQ__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( mem(V0s1,arr(A_27a,bool))
     => ! [V1s2: $i] :
          ( mem(V1s2,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2Ecount__cardle,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1A: $i] :
      ( mem(V1A,arr(A_27a,bool))
     => ( p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V0n))),V1A))
