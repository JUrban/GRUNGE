...
fof(conj_thm_2Ebinary__ieee_2Efloat__div__finite__plus__infinity,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
             ...
             => ! [V1x] :
                 ...
                 => ! [V2r] :
                     ...
                     => ( ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V1x) = ap(c_2Ebinary__ieee_2EFloat,V2r)
                       => ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),V0mode),V1x),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))) = ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),c_2Ebinary__ieee_2Eclear__flags),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),c_2Enum_2E0))),ap(c_2Ebinary__ieee_2Efloat__plus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Efloat__minus__zero(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) ) ) ) ) ) ) )).
