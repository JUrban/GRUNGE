...
thf(c_2EEncodeVar_2Eof__length,type,(
    c_2EEncodeVar_2Eof__length: 
      !>[A_27a: $tType] :
        ( tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ A_27a ) > $o ) )).
...
thf(thm_2ECoder_2Ewf__coder__closed,axiom,(
    ! [A_27a: $tType,V0c: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( A_27a > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ) ) )] :
      ( ( c_2ECoder_2Ewf__coder @ A_27a @ V0c )
     => ! [V1l: tyop_2Elist_2Elist @ $o] :
          ( c_2ECoder_2Edomain @ A_27a @ V0c @ ( c_2ECoder_2Edecoder @ A_27a @ V0c @ V1l ) ) ) )).
...
thf(thm_2EEncodeVar_2Efixed__width__exists,conjecture,(
    ! [A_27a: $tType,V0phi: A_27a > $o,V1c: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( A_27a > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) ) ) ),V2n: tyop_2Enum_2Enum] :
     ...
     => ( ? [V3x: A_27a] :
      ...
      <=> ( c_2Ebool_2ERES__EXISTS @ ( tyop_2Elist_2Elist @ $o ) @ ( c_2EEncodeVar_2Eof__length @ $o @ V2n )
          @ ^ [V4w: tyop_2Elist_2Elist @ $o] :
              ( V0phi @ ( c_2ECoder_2Edecoder @ A_27a @ V1c @ V4w ) ) ) ) ) )).
