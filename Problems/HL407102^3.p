...
thf(thm_2Erealax_2Ereal__bijections,axiom,
    ...
    & ! [V1r: ( tyop_2Epair_2Eprod @ tyop_2Ehreal_2Ehreal @ tyop_2Ehreal_2Ehreal ) > $o] :
        ( ( ^ [V2c: ( tyop_2Epair_2Eprod @ tyop_2Ehreal_2Ehreal @ tyop_2Ehreal_2Ehreal ) > $o] :
              ...
              @ ^ [V3r: tyop_2Epair_2Eprod @ tyop_2Ehreal_2Ehreal @ tyop_2Ehreal_2Ehreal] :
                  ( c_2Ebool_2E_2F_5C @ ( c_2Erealax_2Etreal__eq @ V3r @ V3r ) @ ( c_2Emin_2E_3D @ ( ( tyop_2Epair_2Eprod @ tyop_2Ehreal_2Ehreal @ tyop_2Ehreal_2Ehreal ) > $o ) @ V2c @ ( c_2Erealax_2Etreal__eq @ V3r ) ) ) )
          @ V1r )
