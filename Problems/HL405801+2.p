...
fof(conj_thm_2Ewords_2EFCP__T__F,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ap(c_2Efcp_2EFCP(bool,bool),ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2ET)) = c_2Ewords_2Eword__T(A_27a)
            & ap(c_2Efcp_2EFCP(bool,bool),ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2EF)) = ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0) ) ) ) )).
