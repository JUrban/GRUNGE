...
thf(conj_thm_2Ecardinal_2ECARDEQ__CARD__EQN,lemma,(
    ! [A_27a: del,A_27b: del,V0s1: $i] :
      ( ( mem @ V0s1 @ ( arr @ A_27a @ bool ) )
     => ! [V1s2: $i] :
          ( ( mem @ V1s2 @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ESING__set__exp,lemma,(
...
thf(conj_thm_2Epred__set_2EGSPECIFICATION__applied,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ ( ty_2Epair_2Eprod @ A_27a @ bool ) ) )
     => ! [V1v: $i] :
          ( ( mem @ V1v @ A_27a )
...
thf(conj_thm_2Epred__set_2EIMAGE__applied,lemma,(
    ! [A_27a: del,A_27b: del,V0y: $i] :
      ( ( mem @ V0y @ A_27b )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EINJ__BIJ__SUBSET,lemma,(
...
thf(conj_thm_2Ecardinal_2ESING__set__exp__CARD,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: $i] :
      ( ( mem @ V0x @ A_27b )
     => ! [V1B: $i] :
          ( ( mem @ V1B @ ( arr @ A_27a @ bool ) )
