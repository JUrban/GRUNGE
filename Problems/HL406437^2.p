...
thf(conj_thm_2Ebitstring_2Eextend__def__compute,conjecture,
    ( ! [V0v0: $o,V1l: tp__c_ty_2Elist_2Elist_o] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V0v0 ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V1l ) ) )
        = V1l )
    & ! [V2c: $o,V3n: tp__ty_2Enum_2Enum,V4l: tp__c_ty_2Elist_2Elist_o] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V2c ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V4l ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V2c ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V2c ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V4l ) ) ) ) )
    & ! [V5c: $o,V6n: tp__ty_2Enum_2Enum,V7l: tp__c_ty_2Elist_2Elist_o] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V5c ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V7l ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V5c ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V5c ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V7l ) ) ) ) ) )).
