...
thf(ax_thm_2Erich__list_2ETL__T__def,axiom,(
    ! [A_27a: del] :
      ( ( ( ap @ ( c_2Erich__list_2ETL__T @ A_27a ) @ ( c_2Elist_2ENIL @ A_27a ) )
        = ( c_2Elist_2ENIL @ A_27a ) )
      & ! [V0h: $i] :
          ( ( mem @ V0h @ A_27a )
         => ! [V1t: $i] :
              ( ( mem @ V1t @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( c_2Erich__list_2ETL__T @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V0h ) @ V1t ) )
                = V1t ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2EDROP__FUNPOW__TL,conjecture,(
