...
tff(conj_thm_2Epred__set_2ESUBSET__BIGINTER,lemma,(
    ! [A_27a: del,V0X: $i] :
...
tff(conj_thm_2Ecardinal_2ENUM__COUNTABLE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EREAL__LT__INV2,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__EQ,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__AS__GDELTA,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
       => p(ap(c_2Ereal__topology_2Egdelta,V0s)) ) ) )).
