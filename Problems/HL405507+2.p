...
fof(conj_thm_2Einteger_2EINT__EXP__ADD__EXPONENTS,lemma,(
    ! [V0n] :
...
fof(conj_thm_2Einteger_2EINT__EXP__MULTIPLY__EXPONENTS,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ! [V2p] :
              ( mem(V2p,ty_2Einteger_2Eint)
             => ap(ap(c_2Einteger_2Eint__exp,ap(ap(c_2Einteger_2Eint__exp,V2p),V1n)),V0m) = ap(ap(c_2Einteger_2Eint__exp,V2p),ap(ap(c_2Earithmetic_2E_2A,V1n),V0m)) ) ) ) )).
