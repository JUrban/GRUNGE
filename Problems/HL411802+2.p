...
fof(conj_thm_2Ereal__topology_2ESERIES__COMPARISON,lemma,(
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V2s] :
             ...
             => ( ( ? [V3l] :
                      ...
                      & p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),V3l),V2s)) )
                  & ? [V4N] :
                      ( mem(V4N,ty_2Enum_2Enum)
                      & ! [V5n] :
                          ( mem(V5n,ty_2Enum_2Enum)
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V5n),V4N))
                              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V5n),V2s)) )
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,V5n))),ap(V1g,V5n))) ) ) ) )
               => ? [V6l] :
                    ( mem(V6l,ty_2Erealax_2Ereal)
                    & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V6l),V2s)) ) ) ) ) ) )).

fof(lamtp_f4038,axiom,(
    ! [V0x] :
...
fof(lameq_f4038,axiom,(
    ! [V0x] :
     ...
     => ! [V2n] :
         ...
         => ap(f4038(V0x),V2n) = ap(c_2Ereal_2Eabs,ap(V0x,V2n)) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__ABSCONV__IMP__CONV,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k] :
