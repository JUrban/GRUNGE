      ...
      = ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a )
        @ ( c_2Epred__set_2EBIGINTER @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
            @ ^ [V1t: A_27a > $o] :
                ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) @ V1t ) @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1t @ V0s ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELOCALLY__COMPACT__UNIV,axiom,(
    c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) )).
...
thf(thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION__CLOSED,conjecture,(
    ! [V0g: ( tyop_2Erealax_2Ereal > $o ) > $o] :
      ( ( ( c_2Epred__set_2Ecountable @ ( tyop_2Erealax_2Ereal > $o ) @ V0g )
        & ! [V1s: tyop_2Erealax_2Ereal > $o] :
            ( ( c_2Ebool_2EIN @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ V0g )
           => ( ( c_2Ereal__topology_2EClosed @ V1s )
              & ( ( c_2Ereal__topology_2Einterior @ V1s )
                = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) )
     => ( ( c_2Ereal__topology_2Einterior @ ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal @ V0g ) )
        = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )).
