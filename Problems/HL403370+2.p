...
fof(conj_thm_2Ebag_2EBAG__cases,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
...
fof(conj_thm_2Ebag_2EBAG__INSERT__commutes,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__INSERT__EQUAL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,A_27a)
...
fof(conj_thm_2Ebag_2EIN__SET__OF__BAG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Ebag_2EBAG__CARD__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ebag_2ESET__OF__BAG__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
