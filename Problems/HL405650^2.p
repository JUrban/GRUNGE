...
thf(conj_thm_2Eordinal_2Eislimit__0,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Eordinal_2Eordinal__IVT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
     => ! [V1a1: $i] :
             ...
             => ! [V3c: $i] :
                 ...
                 => ( ( ! [V4a: $i] :
                         ...
                         => ( ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V4a ) )
                              & ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V4a ) )
                                = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) )
                           => ( ( ap @ V0f @ V4a )
                              = ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0f ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V4a ) ) ) ) ) )
                      & ! [V5x: $i] :
