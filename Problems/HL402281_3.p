...
tff(thm_2Elist_2EALL__DISTINCT__DROP,conjecture,(
    ! [A_27a: $tType,V0ls_2E0: tyop_2Elist_2Elist(A_27a),V1n_2E0: tyop_2Enum_2Enum] :
      ( p(c_2Elist_2EALL__DISTINCT_2E1(A_27a,V0ls_2E0))
     => p(c_2Elist_2EALL__DISTINCT_2E1(A_27a,c_2Elist_2EDROP_2E2(A_27a,V1n_2E0,V0ls_2E0))) ) )).
