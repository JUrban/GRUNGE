...
thf(c_2Esorting_2EPART_2E0,type,(
    c_2Esorting_2EPART_2E0: u )).

thf(c_2Esorting_2EPART_2E4,type,(
    c_2Esorting_2EPART_2E4: du > du > du > du > u )).
...
thf(arityeq3_2Emono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Epair_2Eprod_28tyop_2Elist_2Elist_28A_27a_29_2Ctyop_2Elist_2Elist_28A_27a_29_29,axiom,(
    ! [A_27a: d,X0: $o,X1_2E0: u,X2_2E0: u] :
...
thf(arityeq4_2Emono_2Ec_2Esorting_2EPART_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Esorting_2EPART_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X3_2E0 ) ) )
...
thf(thm_2Esorting_2EPART__DEF,axiom,(
    ! [A_27a: d] :
      ( ! [V0P_2E0: u,V1l1_2E0: u,V2l2_2E0: u] :
          ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Esorting_2EPART_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) )
          = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) ) )
      & ! [V3P_2E0: u,V4h_2E0: u,V5rst_2E0: u,V6l1_2E0: u,V7l2_2E0: u] :
          ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Esorting_2EPART_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V4h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5rst_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V6l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V7l2_2E0 ) ) )
...
thf(thm_2Esorting_2EPART__LENGTH,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1L_2E0: u,V2l1_2E0: u,V3l2_2E0: u,V4p_2E0: u,V5q_2E0: u] :
      ( ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4p_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5q_2E0 ) ) )
        = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2Esorting_2EPART_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l2_2E0 ) ) ) )
     => ( ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2B @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l1_2E0 ) ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l2_2E0 ) ) ) ) )
        = ( mono_2Ec_2Earithmetic_2E_2B @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V4p_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5q_2E0 ) ) ) ) ) ) ) )).
