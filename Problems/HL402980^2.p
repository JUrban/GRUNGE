...
thf(conj_thm_2Elist_2EMAP2,lemma,(
...
thf(conj_thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__CONJ__REWRITE,conjecture,(
    ! [V0i1: $o,V1is1: tp__c_ty_2Elist_2Elist_o,V2i2: $o,V3is2: tp__c_ty_2Elist_2Elist_o] :
      ...
      & ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ c_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__CONJ @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V0i1 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V1is1 ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V2i2 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V3is2 ) ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( inj__o @ V0i1 ) ) @ ( inj__o @ V2i2 ) ) ) @ ( ap @ ( ap @ c_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__CONJ @ ( inj__c_ty_2Elist_2Elist_o @ V1is1 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V3is2 ) ) ) ) ) ) )).
