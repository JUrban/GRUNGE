...
thf(stp_inj_mem_c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone,axiom,(
    ! [X: tp__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] :
      ( mem @ ( inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone @ X ) @ ( ty_2Elist_2Elist @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) ) )).
...
thf(conj_thm_2Elist_2EMAP__TL,lemma,(
...
thf(conj_thm_2Elist_2EMAP__GENLIST,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Elist_2EHD__GENLIST__COR,lemma,(
...
thf(conj_thm_2Elist_2EGENLIST__FUN__EQ,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ! [V2g: $i] :
...
thf(conj_thm_2Elist_2ENULL__GENLIST,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ bool ) @ bool )
                      @ ( lam @ ( ty_2Elist_2Elist @ bool )
                        @ ^ [V2l: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ bool @ bool ) @ V0f ) @ ( ap @ ( c_2Elist_2EHD @ bool ) @ V2l ) ) @ ( ap @ ( c_2Elist_2ETL @ bool ) @ V2l ) ) ) )
                    @ ( ap
                      @ ( ap @ ( c_2Elist_2EGENLIST @ bool )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V3i: $i] :
                              ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V3i ) ) ) )
      ...
      = ( ap @ ( c_2Ewords_2Eword__reduce @ A_27a )
        @ ( lam @ bool
          @ ^ [V0a: $i] :
              ( lam @ bool
              @ ^ [V1b: $i] :
                  ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ V0a ) @ V1b ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Efoldl__reduce__nand,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
          ...
          @ ( ap
            @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
              @ ( lam @ ( ty_2Elist_2Elist @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
                @ ^ [V1l: $i] :
                    ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ ( c_2Ewords_2Eword__nand @ ty_2Eone_2Eone ) ) @ ( ap @ ( c_2Elist_2EHD @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ V1l ) ) @ ( ap @ ( c_2Elist_2ETL @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) ) @ V1l ) ) ) )
            @ ( ap
                ...
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2i: $i] :
                      ...
                      @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V3n: $i] :
                              ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__extract @ A_27a @ ty_2Eone_2Eone ) @ V3n ) @ V3n ) @ V0w ) ) )
