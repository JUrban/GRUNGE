...
fof(ax_thm_2Epred__set_2Eschroeder__close__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
             ...
             => ! [V2x] :
                 ...
                 => ( p(ap(ap(ap(c_2Epred__set_2Eschroeder__close(A_27a),V0f),V1s),V2x))
                  <=> ? [V3n] :
                        ...
                        & p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(ap(ap(c_2Earithmetic_2EFUNPOW(arr(A_27a,bool)),ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f)),V3n),V1s))) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
