...
tff(conj_thm_2Efinite__map_2ESUBMAP__DRESTRICT,lemma,(
...
tff(conj_thm_2Efinite__map_2ESUBMAP__FUNION__ABSORPTION,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V1g))
          <=> ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g) = V1g ) ) ) )).

tff(conj_thm_2Efinite__map_2EDRESTRICT__FUNION__SAME,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0fm),V1s)),V0fm) = V0fm ) ) )).
