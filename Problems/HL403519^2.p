...
thf(conj_thm_2Epred__set_2EIMAGE__UNION,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ewellorder_2EINJ__preserves__linear__order,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Eset__relation_2Elinear__order @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a ) @ V0r ) ) @ ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27a ) @ V0r ) ) ) )
               ...
               => ( p @ ( ap @ ( ap @ ( c_2Eset__relation_2Elinear__order @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27a @ A_27a @ A_27b @ A_27b ) @ V1f ) @ V1f ) ) @ V0r ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V1f ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a ) @ V0r ) ) @ ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27a ) @ V0r ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Edomain__IMAGE__ff,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27c @ A_27a ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27d @ A_27b ) )
         => ! [V2r: $i] :
              ( ( mem @ V2r @ ( arr @ ( ty_2Epair_2Eprod @ A_27c @ A_27d ) @ bool ) )
             => ( ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27c @ A_27d ) @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27c @ A_27d @ A_27a @ A_27b ) @ V0f ) @ V1g ) ) @ V2r ) )
                = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27c @ A_27a ) @ V0f ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27c @ A_27d ) @ V2r ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Erange__IMAGE__ff,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2r: $i] :
              ( ( mem @ V2r @ ( arr @ ( ty_2Epair_2Eprod @ A_27c @ A_27d ) @ bool ) )
             => ( ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27c @ A_27d ) @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27c @ A_27d @ A_27b @ A_27a ) @ V0f ) @ V1g ) ) @ V2r ) )
                = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27d @ A_27a ) @ V1g ) @ ( ap @ ( c_2Eset__relation_2Erange @ A_27d @ A_27c ) @ V2r ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2EINJ__preserves__wellorder,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ A_27b ) )
