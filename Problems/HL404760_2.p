...
tff(lmtp_f1923,type,(
    f1923: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f1923,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
         => mem(f1923(A_27c,A_27b,A_27a,V1m,V0f),arr(A_27a,A_27b)) ) ) )).

tff(lameq_f1923,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f1923(A_27c,A_27b,A_27a,V1m,V0f),V2x) = ap(V0f,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1m),V2x))) ) ) ) )).

tff(ax_thm_2Efinite__map_2EFMAP__MAP2__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),V1m) = ap(ap(c_2Efinite__map_2EFUN__FMAP(A_27a,A_27a),f1923(A_27c,A_27b,A_27a,V1m,V0f)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1m)) ) ) )).

tff(conj_thm_2Efinite__map_2EFMAP__MAP2__THM,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
