...
fof(conj_thm_2Eoption_2Esome__F,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(c_2Eoption_2Esome(A_27a),k(A_27a,c_2Ebool_2EF)) = c_2Eoption_2ENONE(A_27a) ) )).

fof(conj_thm_2Eoption_2Eoption__case__eq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0opt] :
             ...
             => ! [V1nc] :
                 ...
                 => ! [V2sc] :
                     ...
                     => ! [V3v] :
                          ( mem(V3v,A_27b)
                         => ( ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V0opt),V1nc),V2sc) = V3v
...
fof(conj_thm_2Ecardinal_2Eset__exp__cardle__cong,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
