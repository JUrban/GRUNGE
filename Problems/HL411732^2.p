...
thf(ax_thm_2Eiterate_2Enumseg,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ...
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V2x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V2x ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V2x ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) )).
...
thf(ax_thm_2Ereal__topology_2Efrom,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V0n ) )
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V1m: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ bool ) @ V1m ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1m ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESERIES__FROM,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2k: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) )
        <=> ( p
            @ ( ap
              @ ( ap
                @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3n: $i] :
                        ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2k ) ) @ V3n ) ) @ V0f ) ) )
                @ ( inj__ty_2Erealax_2Ereal @ V1l ) )
              @ c_2Ereal__topology_2Esequentially ) ) ) ) )).
