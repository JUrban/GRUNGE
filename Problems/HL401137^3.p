...
thf(thm_2Eind__type_2EINJP,axiom,(
    ! [A_27a: $tType,V0f1: tyop_2Enum_2Enum > A_27a > $o,V1f2: tyop_2Enum_2Enum > A_27a > $o] :
      ...
      = ( ^ [V2n: tyop_2Enum_2Enum,V3a: A_27a] :
            ( c_2Ebool_2ECOND @ $o @ ( c_2Eind__type_2ENUMLEFT @ V2n ) @ ( V0f1 @ ( c_2Eind__type_2ENUMRIGHT @ V2n ) @ V3a ) @ ( V1f2 @ ( c_2Eind__type_2ENUMRIGHT @ V2n ) @ V3a ) ) ) ) )).
