...
thf(conj_thm_2EquantHeuristics_2EGUESS__RULES__FORALL______NEW__FV__1,lemma,(
...
thf(conj_thm_2EquantHeuristics_2EGUESS__RULES__EXISTS______NEW__FV__1,conjecture,(
    ! [A_27a: del,A_27c: del,V0i: $i] :
      ( ( mem @ V0i @ ( arr @ A_27a @ A_27c ) )
     => ! [V1P: $i] :
          ( ( mem @ V1P @ ( arr @ A_27c @ ( arr @ A_27a @ bool ) ) )
