...
fof(mem_c_2Eposet_2Ebottom,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Eposet_2Ebottom(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(A_27a,bool))) ) )).
...
fof(conj_thm_2Eposet_2Ecomplete__bottom,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Eposet_2Eknaster__tarski__gfp,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
