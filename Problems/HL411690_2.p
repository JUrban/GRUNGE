...
tff(lmtp_f3999,type,(
    f3999: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3999,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal] : mem(f3999(V1b,V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3999,axiom,(
    ! [V1b: tp__ty_2Erealax_2Ereal,V0a: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f3999(V1b,V0a),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V4x))),inj__ty_2Erealax_2Ereal(V1b))) )).

tff(lmtp_f4000,type,(
    f4000: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4000,axiom,(
    ! [V3d: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] : mem(f4000(V3d,V2c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f4000,axiom,(
    ! [V3d: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal,V5x: tp__ty_2Erealax_2Ereal] : ap(f4000(V3d,V2c),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),inj__ty_2Erealax_2Ereal(V5x))),inj__ty_2Erealax_2Ereal(V3d))) )).

tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__HYPERPLANES,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal,V3d: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3999(V1b,V0a))),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4000(V3d,V2c)))) ) )).
