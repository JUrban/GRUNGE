...
thf(conj_thm_2Ereal__topology_2EIN__INTERIOR,lemma,(
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__STRADDLE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__COMPLEMENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Efrontier @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V0s ) )
        = ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) ) )).

thf(conj_thm_2Ereal__topology_2EFRONTIER__INTER__SUBSET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__UNION__SUBSET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__INTERIORS,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Efrontier @ V0s )
        = ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V0s ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EUNION__FRONTIER,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V1t ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) ) @ ( ap @ c_2Ereal__topology_2Efrontier @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V1t ) ) ) ) ) ) )).
