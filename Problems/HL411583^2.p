...
thf(conj_thm_2Ecardinal_2ERIGHT__IMP__FORALL__THM,lemma,(
    ! [A_27a: del,V0P: $o,V1Q: $i] :
      ( ( mem @ V1Q @ ( arr @ A_27a @ bool ) )
     => ( ( ( p @ ( inj__o @ V0P ) )
         => ! [V2x: $i] :
...
thf(ax_thm_2Ereal__topology_2Eis__interval,axiom,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__EMPTY,lemma,(
    p @ ( ap @ c_2Ereal__topology_2Eis__interval @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )).

thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__SING,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ c_2Ereal__topology_2Eis__interval @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__SCALING,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ c_2Ereal__topology_2Eis__interval @ V0s ) )
         => ( p
            @ ( ap @ c_2Ereal__topology_2Eis__interval
              @ ( ap
                @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) @ V2x ) ) )
                @ V0s ) ) ) ) ) )).
