...
thf(thm_2Emeasure_2ESIGMA__SUBSET,conjecture,(
    ! [A_27a: $tType,V0a: ( A_27a > $o ) > $o,V1b: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V1b )
        & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ V0a @ ( c_2Emeasure_2Esubsets @ A_27a @ V1b ) ) )
     => ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esigma @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V1b ) @ V0a ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V1b ) ) ) )).
