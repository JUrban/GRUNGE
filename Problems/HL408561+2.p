...
fof(conj_thm_2Ebinary__ieee_2Efloat__mul__finite__plus__infinity,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
