...
tff(conj_thm_2ECoder_2Ewf__coder,lemma,(
    ! [A_27a: del,V0c: $i] :
...
tff(conj_thm_2ECoder_2Ewf__coder__closed,lemma,(
    ! [A_27a: del,V0c: $i] :
      ( mem(V0c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V0c))
...
tff(lameq_f2442,axiom,(
    ! [A_27a: del,V1c: $i] :
     ...
     => ! [V0phi: $i] :
          ( mem(V0phi,arr(A_27a,bool))
         => ! [V4w: tp__c_ty_2Elist_2Elist_o] : ap(f2442(A_27a,V1c,V0phi),inj__c_ty_2Elist_2Elist_o(V4w)) = ap(V0phi,ap(ap(c_2ECoder_2Edecoder(A_27a),V1c),inj__c_ty_2Elist_2Elist_o(V4w))) ) ) )).

tff(conj_thm_2EEncodeVar_2Efixed__width__exists,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(A_27a,bool))
     => ! [V1c: $i] :
          ( mem(V1c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2n: tp__ty_2Enum_2Enum] :
             ...
             => ( ? [V3x: $i] :
                    ...
                    & p(ap(V0phi,V3x)) )
              <=> p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(bool)),ap(c_2EEncodeVar_2Eof__length(bool),inj__ty_2Enum_2Enum(V2n))),f2442(A_27a,V1c,V0phi))) ) ) ) ) )).
