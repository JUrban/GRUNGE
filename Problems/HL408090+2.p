...
fof(conj_thm_2Elim_2ELIM__SUB,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
             ...
             => ! [V3m] :
                 ...
                 => ! [V4x] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Elim_2Etends__real__real,V0f),V2l),V4x))
                       ...
                       => p(ap(ap(ap(c_2Elim_2Etends__real__real,f2900(V0f,V1g)),ap(ap(c_2Ereal_2Ereal__sub,V2l),V3m)),V4x)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Elim_2ECONT__SUB,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
