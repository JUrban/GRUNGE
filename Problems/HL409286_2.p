...
tff(conj_thm_2Elift__ieee_2Eis__closest__exits,lemma,(
     ...
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V1s))
       => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
         => ? [V2a: $i] :
              ...
              & p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),inj__ty_2Erealax_2Ereal(V0x)),V2a)) ) ) ) ) )).

tff(conj_thm_2Elift__ieee_2Eclosest__is__everything,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool))
