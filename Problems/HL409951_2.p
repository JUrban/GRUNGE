...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__INTER__ELIM,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1f: $i] :
           ...
           => ! [V2s_27: $i] :
               ...
               => ( ! [V3x: $i] :
                     ...
                     => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s_27))
                       => surj__ty_2Eextreal_2Eextreal(ap(V1f,V3x)) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )
                 => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),ap(ap(c_2Epred__set_2EINTER(A_27a),V0s),V2s_27))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)) ) ) ) ) ) )).
