...
fof(mem_c_2Ewords_2Eword__from__oct__string,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__from__oct__string(A_27a),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Efcp_2Ecart(bool,bool))) ) )).

fof(mem_c_2Ewords_2Eword__to__oct__string,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__to__oct__string(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).
...
fof(conj_thm_2Ewords_2Eword__oct__string,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__from__oct__string(A_27a)),c_2Ewords_2Eword__to__oct__string(A_27a)) = c_2Ecombin_2EI(ty_2Efcp_2Ecart(bool,bool)) ) )).
