...
tff(conj_thm_2ETemporal__Logic_2ESOME__EVENT,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1t0: tp__ty_2Enum_2Enum] :
...
tff(lameq_f959,axiom,(
    ! [V2a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V0y: $i] :
              ( mem(V0y,arr(ty_2Enum_2Enum,bool))
             => ! [V3t: tp__ty_2Enum_2Enum] : ap(f959(V2a,V1b,V0y),inj__ty_2Enum_2Enum(V3t)) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(V1b,inj__ty_2Enum_2Enum(V3t))),ap(V2a,inj__ty_2Enum_2Enum(V3t))),ap(V0y,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EWHEN__FIX,lemma,(
    ! [V0y: $i] :
      ( mem(V0y,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2EOmega__Automata_2EBUECHI__TRANSLATION,conjecture,(
    ! [V0Phi: $i] :
