...
thf(f9735_0_2E0,type,(
    f9735_0_2E0: u )).

thf(f9735_0_2E1,type,(
    f9735_0_2E1: du > u )).

thf(f9735_0_2E2,type,(
    f9735_0_2E2: du > du > u )).
...
thf(c_2Etransc_2Eatn_2E0,type,(
    c_2Etransc_2Eatn_2E0: u )).

thf(c_2Etransc_2Eatn_2E1,type,(
...
thf(c_2Etransc_2Etan_2E0,type,(
    c_2Etransc_2Etan_2E0: u )).

thf(c_2Etransc_2Etan_2E1,type,(
...
thf(mono_2Ef9735_0,type,(
    mono_2Ef9735_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(mono_2Ec_2Etransc_2Eatn,type,(
    mono_2Ec_2Etransc_2Eatn: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Etransc_2Etan,type,(
    mono_2Ec_2Etransc_2Etan: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Etransc_2ETAN__TOTAL,axiom,(
    ! [V0y: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9735_0 @ V0y @ V1x )
    <=> ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ V1x )
        & ( mono_2Ec_2Erealax_2Ereal__lt @ V1x @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
        & ( ( mono_2Ec_2Etransc_2Etan @ V1x )
          = V0y ) ) ) )).

thf(thm_2Etransc_2ETAN__TOTAL,axiom,(
    ! [V0y: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ebool_2E_3F_21_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9735_0 @ V0y ) ) )).

thf(thm_2Etransc_2EATN,axiom,(
    ! [V0y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( mono_2Ec_2Etransc_2Eatn @ V0y ) )
      & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Etransc_2Eatn @ V0y ) @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
      & ( ( mono_2Ec_2Etransc_2Etan @ ( mono_2Ec_2Etransc_2Eatn @ V0y ) )
        = V0y ) ) )).

thf(thm_2Etransc_2ETAN__ATN,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ V0x )
        & ( mono_2Ec_2Erealax_2Ereal__lt @ V0x @ ( mono_2Ec_2Ereal_2E_2F @ mono_2Ec_2Etransc_2Epi @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )
     => ( ( mono_2Ec_2Etransc_2Eatn @ ( mono_2Ec_2Etransc_2Etan @ V0x ) )
        = V0x ) ) )).
