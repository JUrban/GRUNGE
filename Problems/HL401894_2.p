...
tff(conj_thm_2EfixedPoint_2Eempty__monotone,conjecture,(
    ! [A_27a: del,A_27b: del] : p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),c_2EfixedPoint_2Eempty(arr(A_27a,bool),arr(A_27a,bool)))) )).
