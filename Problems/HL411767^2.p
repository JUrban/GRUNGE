...
thf(conj_thm_2Ereal__topology_2ESERIES__FINITE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__SUB,lemma,(
    ! [V0x: $i] :
                  ...
                  @ ( ap
                    @ ( ap
                      @ ( ap @ c_2Ereal__topology_2Esums
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V5n: $i] :
                              ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0x @ V5n ) ) @ ( ap @ V2y @ V5n ) ) ) )
                      @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V1x0 ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y0 ) ) )
                    @ V4s ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESERIES__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1k: $i] :
                ...
                @ ( ap
                  @ ( ap
                    @ ( ap @ c_2Ereal__topology_2Esums
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3n: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V3n ) @ V1k ) ) @ ( ap @ V0f @ V3n ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ESUMS__FINITE__DIFF,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1t: $i] :
