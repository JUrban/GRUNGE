...
tff(conj_thm_2Esorting_2ECONS__PERM,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1L: $i] :
...
tff(lamtp_f1103,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => mem(f1103(A_27a,V0P,V1Q),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f1103,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1Q: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f1103(A_27a,V0P,V1Q),V3x) = ap(ap(c_2Emin_2E_3D(bool),ap(V0P,V3x)),ap(c_2Ebool_2E_7E,ap(V1Q,V3x))) ) ) ) )).

tff(conj_thm_2Esorting_2EPERM__SPLIT__IF,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => ! [V2l: $i] :
             ...
             => ( p(ap(ap(c_2Elist_2EEVERY(A_27a),f1103(A_27a,V0P,V1Q)),V2l))
