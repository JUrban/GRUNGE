...
fof(conj_thm_2Eintegral_2EDINT__POINT__SPIKE,lemma,(
    ! [V0f] :
                 ...
                 => ! [V4c] :
                     ...
                     => ! [V5i] :
                         ...
                         => ( ( ! [V6x] :
                              ...
                              & p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V0f),V5i)) )
                           => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)),V1g),V5i)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__POINT__SPIKE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
