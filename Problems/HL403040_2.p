...
tff(conj_thm_2EindexedLists_2ELIST__RELi__cases,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(A_27a,arr(A_27b,bool))))
     => ! [V1a0: $i] :
          ( mem(V1a0,ty_2Elist_2Elist(A_27a))
         => ! [V2a1: $i] :
              ( mem(V2a1,ty_2Elist_2Elist(A_27b))
             => ( p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),V1a0),V2a1))
                      ...
                      & ? [V4h2: $i] :
                          ...
                          & ? [V5l1: $i] :
                              ...
                              & ? [V6l2: $i] :
                                  ...
                                  & p(ap(ap(ap(c_2EindexedLists_2ELIST__RELi(A_27a,A_27a),V0R),V5l1),V6l2)) ) ) ) ) ) ) ) ) ) )).
