...
thf(thm_2Eiterate_2ECHOOSE__SUBSET__STRONG,axiom,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
       => ( c_2Earithmetic_2E_3C_3D @ V0n @ ( c_2Epred__set_2ECARD @ A_27a @ V1s ) ) )
     => ? [V2t: A_27a > $o] :
          ( ( c_2Epred__set_2ESUBSET @ A_27a @ V2t @ V1s )
          & ( c_2Ecardinal_2EHAS__SIZE @ A_27a @ V2t @ V0n ) ) ) )).
...
thf(thm_2Ereal__topology_2ECARD__FRONTIER__INTERVAL,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Eis__interval @ V0s )
     => ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ V0s ) )
        & ( c_2Earithmetic_2E_3C_3D @ ( c_2Epred__set_2ECARD @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ V0s ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
