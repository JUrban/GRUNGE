...
thf(thm_2Eordinal_2Eoleast__def,axiom,(
    ! [A_27a: $tType,V0P: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
      ( ( c_2Eordinal_2Eoleast @ A_27a @ V0P )
      = ( c_2Emin_2E_40 @ ( tyop_2Eordinal_2Eordinal @ A_27a )
        @ ^ [V1x: tyop_2Eordinal_2Eordinal @ A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( V0P @ V1x )
            @ ( c_2Ebool_2E_21 @ ( tyop_2Eordinal_2Eordinal @ A_27a )
              @ ^ [V2y: tyop_2Eordinal_2Eordinal @ A_27a] :
                  ( c_2Emin_2E_3D_3D_3E @ ( c_2Eordinal_2Eordlt @ A_27a @ V2y @ V1x ) @ ( c_2Ebool_2E_7E @ ( V0P @ V2y ) ) ) ) ) ) ) )).
