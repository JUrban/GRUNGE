...
thf(conj_thm_2Erich__list_2ESNOC__EQ__LENGTH__EQ,conjecture,(
    ! [A_27a: del,V0x1: $i] :
      ( ( mem @ V0x1 @ A_27a )
     => ! [V1l1: $i] :
         ...
         => ! [V2x2: $i] :
             ...
             => ! [V3l2: $i] :
                 ...
                 => ( ( ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V0x1 ) @ V1l1 )
                      = ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V2x2 ) @ V3l2 ) )
                   => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l1 ) )
                      = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V3l2 ) ) ) ) ) ) ) ) )).
