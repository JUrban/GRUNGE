...
tff(conj_thm_2Efinite__map_2EFLOOKUP__DRESTRICT,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2k: $i] :
              ( mem(V2k,A_27a)
             => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0fm),V1s)),V2k) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27b)),ap(ap(c_2Ebool_2EIN(A_27a),V2k),V1s)),ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V0fm),V2k)),c_2Eoption_2ENONE(A_27b)) ) ) ) )).

tff(conj_thm_2Efinite__map_2Edisjoint__drestrict,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),V0s),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1m)))
           => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V1m),ap(c_2Epred__set_2ECOMPL(A_27a),V0s)) = V1m ) ) ) )).
