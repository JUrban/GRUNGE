...
fof(conj_thm_2Earithmetic_2ESUC__SUB,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Erich__list_2EEL__APPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ! [V2l2] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l1)))
                   => ap(ap(c_2Elist_2EEL(A_27a),V0n),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V2l2)) = ap(ap(c_2Elist_2EEL(A_27a),V0n),V1l1) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EEL__APPEND2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l1)),V1n))
               => ! [V2l2] :
                    ( mem(V2l2,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Elist_2EEL(A_27a),V1n),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V2l2)) = ap(ap(c_2Elist_2EEL(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l1))),V2l2) ) ) ) ) ) )).
...
fof(lamtp_f2243,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2243(A_27a,V0w),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(conj_thm_2Ewords_2Eword__ror,lemma,(
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__ror(A_27a),V0w),V1n) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2243(A_27a,V0w)),ap(ap(c_2Earithmetic_2EMOD,V1n),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).
...
fof(lamtp_f2294,axiom,(
    ! [V2l] :
      ( mem(V2l,ty_2Enum_2Enum)
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
         => mem(f2294(V2l,V0v),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))) ) ) )).
    ...
    ! [V2l] :
     ...
     => ! [V0v] :
         ...
         => ! [V3x] :
             ...
             => ap(f2294(V2l,V0v),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(bool)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2l),c_2Enum_2E0)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V3x),c_2Enum_2E0))),V0v),ap(ap(c_2Elist_2EAPPEND(bool),ap(ap(ap(c_2Ebitstring_2Efield,ap(ap(c_2Earithmetic_2E_2D,V3x),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),V0v)),ap(ap(ap(c_2Ebitstring_2Efield,ap(ap(c_2Earithmetic_2E_2D,V2l),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3x),V0v))) ) ) ) )).

fof(lamtp_f2293,axiom,(
    ! [V0v] :
      ( mem(V0v,ty_2Elist_2Elist(bool))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => mem(f2293(V0v,V1m),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(bool))) ) ) )).
...
fof(lameq_f2293,axiom,(
    ! [V0v] :
     ...
     => ! [V1m] :
         ...
         => ! [V2l] :
              ( mem(V2l,ty_2Enum_2Enum)
             => ap(f2293(V0v,V1m),V2l) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2294(V2l,V0v)),ap(ap(c_2Earithmetic_2EMOD,V1m),V2l)) ) ) ) )).
...
fof(ax_thm_2Ebitstring_2Erotate__def,axiom,(
    ! [V0v] :
     ...
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ap(ap(c_2Ebitstring_2Erotate,V0v),V1m) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2293(V0v,V1m)),ap(c_2Elist_2ELENGTH(bool),V0v)) ) ) )).
...
fof(conj_thm_2Ebitstring_2Elength__field,lemma,(
    ! [V0h] :
      ( mem(V0h,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebitstring_2Eel__fixwidth,lemma,(
    ! [V0i] :
...
fof(conj_thm_2Ebitstring_2Eel__field,lemma,(
    ! [V0v] :
      ( mem(V0v,ty_2Elist_2Elist(bool))
     => ! [V1h] :
...
fof(conj_thm_2Ebitstring_2Etestbit,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1v] :
          ( mem(V1v,ty_2Elist_2Elist(bool))
...
fof(conj_thm_2Ebitstring_2Eword__ror__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
