...
tff(conj_thm_2Epred__set_2ESUBSET__FINITE__I,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EIMAGE__11__INFINITE,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINFINITE__FROM,lemma,(
...
tff(conj_thm_2Ereal__topology_2EINFINITE__SUPERSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ELIMPT__INFINITE__OPEN__BALL__CBALL,conjecture,
    ( ! [V0s: $i] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1x: tp__ty_2Erealax_2Ereal] :
