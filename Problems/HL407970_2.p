...
tff(conj_thm_2Enets_2EDORDER__NGE,lemma,(
...
tff(ax_thm_2Eseq_2Etends__num__real,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V1x0: tp__ty_2Erealax_2Ereal] :
        ...
        <=> p(ap(ap(ap(c_2Enets_2Etends(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),inj__ty_2Erealax_2Ereal(V1x0)),ap(ap(c_2Epair_2E_2C(ty_2Etopology_2Etopology(ty_2Erealax_2Ereal),ty_2Etopology_2Etopology(ty_2Erealax_2Ereal)),ap(c_2Emetric_2Emtop(ty_2Erealax_2Ereal),c_2Emetric_2Emr1)),c_2Earithmetic_2E_3E_3D))) ) ) )).

tff(lmtp_f2867,type,(
    f2867: ( $i * $i ) > $i )).

tff(lamtp_f2867,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: $i] :
...
tff(lameq_f2867,axiom,(
    ! [V0x: $i] :
     ...
     => ! [V2y: $i] :
          ( mem(V2y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f2867(V0x,V2y),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0x,inj__ty_2Enum_2Enum(V4n))),ap(V2y,inj__ty_2Enum_2Enum(V4n))) ) ) )).

tff(conj_thm_2Eseq_2ESEQ__MUL,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2y: $i] :
         ...
         => ! [V3y0: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f2867(V0x,V2y)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1x0)),inj__ty_2Erealax_2Ereal(V3y0)))) ) ) ) )).
