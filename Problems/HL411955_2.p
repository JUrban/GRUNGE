...
tff(conj_thm_2Ereal__topology_2ECLOSED__INTER,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECBALL__MIN__INTER,lemma,(
...
tff(conj_thm_2Ereal__topology_2EOPEN__IN__CONTAINS__CBALL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EREAL__LT__MIN,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER__CBALL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__UNION,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
