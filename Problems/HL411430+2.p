...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__INTERMEDIATE__SUBSET,lemma,(
    ! [V0t] :
...
fof(conj_thm_2Ereal__topology_2ECOMPONENTS__INTERMEDIATE__SUBSET,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
