...
tff(tp_c_2Ereal_2ENUM__CEILING,type,(
    c_2Ereal_2ENUM__CEILING: $i )).

tff(mem_c_2Ereal_2ENUM__CEILING,axiom,(
    mem(c_2Ereal_2ENUM__CEILING,arr(ty_2Erealax_2Ereal,ty_2Enum_2Enum)) )).

tff(stp_fo_c_2Ereal_2ENUM__CEILING,type,(
    fo__c_2Ereal_2ENUM__CEILING: tp__ty_2Erealax_2Ereal > tp__ty_2Enum_2Enum )).

tff(stp_eq_fo_c_2Ereal_2ENUM__CEILING,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] : inj__ty_2Enum_2Enum(fo__c_2Ereal_2ENUM__CEILING(X0)) = ap(c_2Ereal_2ENUM__CEILING,inj__ty_2Erealax_2Ereal(X0)) )).
...
tff(lamtp_f2749,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2749(V0x),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2749,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2749(V0x),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1n))) )).

tff(ax_thm_2Ereal_2ENUM__CEILING__def,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Enum_2Enum(ap(c_2Ereal_2ENUM__CEILING,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Enum_2Enum(ap(c_2Ewhile_2ELEAST,f2749(V0x))) )).

tff(conj_thm_2Ereal_2ENUM__CEILING__LE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1n))))
     => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Ereal_2ENUM__CEILING,inj__ty_2Erealax_2Ereal(V0x))),inj__ty_2Enum_2Enum(V1n))) ) )).
