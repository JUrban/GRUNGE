...
fof(conj_thm_2EOmega_2Ershadow__row__ind,conjecture,(
    ! [V0P] :
     ...
     => ( ( ! [V1upperc] :
             ...
             => ! [V2uppery] :
                 ...
                 => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1upperc),V2uppery)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )
          & ! [V3upperc] :
             ...
             => ! [V4uppery] :
                 ...
                 => ! [V5lowerc] :
                     ...
                     => ! [V6lowery] :
                         ...
                         => ! [V7rs] :
                              ( mem(V7rs,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                             => ( p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3upperc),V4uppery)),V7rs))
                               => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3upperc),V4uppery)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V5lowerc),V6lowery)),V7rs))) ) ) ) ) ) ) )
       => ! [V8v] :
            ( mem(V8v,ty_2Enum_2Enum)
           => ! [V9v1] :
                ( mem(V9v1,ty_2Einteger_2Eint)
               => ! [V10v2] :
                    ( mem(V10v2,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                   => p(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V8v),V9v1)),V10v2)) ) ) ) ) ) )).
