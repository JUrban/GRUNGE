...
fof(conj_thm_2Eprobability_2EPROB__DISCRETE__EVENTS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
    ...
    ! [A_27a,V1X] :
     ...
     => ! [V0p] :
         ...
         => ! [V3x] :
             ...
             => ap(f4239(A_27a,V1X,V0p),V3x) = ap(ap(ap(c_2Eprobability_2Edistribution(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal),V0p),V1X),ap(ap(c_2Epred__set_2EINSERT(ty_2Eextreal_2Eextreal),V3x),c_2Epred__set_2EEMPTY(ty_2Eextreal_2Eextreal))) ) ) ) )).

fof(conj_thm_2Eprobability_2Edistribution__partition,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1X] :
             ...
             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
               ...
               => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Eextreal_2Eextreal),f4239(A_27a,V1X,V0p)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))) = ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) ) ) ) ) )).
