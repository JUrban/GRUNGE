...
tff(thm_2Ecardinal_2ESURJECTIVE__ON__RIGHT__INVERSE,axiom,(
    ...
    <=> ? [V5g_2E0: u] :
        ! [V6y_2E0: u] :
         ...
         => ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V5g_2E0),s(A_27b,V6y_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0)))))
...
tff(thm_2Ecardinal_2ESURJECTIVE__RIGHT__INVERSE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ! [V1y_2E0: u] :
        ? [V2x_2E0: u] : s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V0f_2E0),s(A_27b,V2x_2E0))) = s(A_27a,V1y_2E0)
    <=> ? [V3g_2E0: u] :
        ! [V4y_2E0: u] : s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V0f_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V3g_2E0),s(A_27a,V4y_2E0))))) = s(A_27a,V4y_2E0) ) )).
