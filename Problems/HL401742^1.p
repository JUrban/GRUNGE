...
thf(f2005_0_2E0,type,(
    f2005_0_2E0: u )).

thf(f2005_0_2E2,type,(
    f2005_0_2E2: du > du > u )).

thf(f2005_0_2E3,type,(
    f2005_0_2E3: du > du > du > u )).
...
thf(arityeq2_2Emono_2Ef2005_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f2005_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) ) @ f2005_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef2005_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f2005_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(thm_2Earithmetic_2EABS__DIFF__SUMS,axiom,(
    ! [V0n1: mono_2Etyop_2Enum_2Enum,V1n2: mono_2Etyop_2Enum_2Enum,V2m1: mono_2Etyop_2Enum_2Enum,V3m2: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EABS__DIFF @ ( mono_2Ec_2Earithmetic_2E_2B @ V0n1 @ V1n2 ) @ ( mono_2Ec_2Earithmetic_2E_2B @ V2m1 @ V3m2 ) ) @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2EABS__DIFF @ V0n1 @ V2m1 ) @ ( mono_2Ec_2Earithmetic_2EABS__DIFF @ V1n2 @ V3m2 ) ) ) )).
...
thf(def0_2Ethm_2Epred__set_2EABS__DIFF__SUM__IMAGE,axiom,(
    ! [A_27a: d,V1f_2E0: u,V0g_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f2005_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
      = ( mono_2Ec_2Earithmetic_2EABS__DIFF @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).

thf(thm_2Epred__set_2EABS__DIFF__SUM__IMAGE,conjecture,(
    ! [A_27a: d,V0g_2E0: u,V1f_2E0: u,V2s_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) )
     => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EABS__DIFF @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ESUM__IMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f2005_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0g_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) ) ) ) )).
