...
tff(conj_thm_2Epred__set_2EDELETE__SUBSET,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2ESUBSET__INSERT__RIGHT,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1s1: $i] :
...
tff(conj_thm_2Epred__set_2ESUBSET__DELETE__BOTH,lemma,(
    ! [A_27a: del,V0s1: $i] :
...
tff(conj_thm_2Epred__set_2EPOW__INSERT,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
