...
thf(conj_thm_2Eiterate_2EREAL__INF__UNIQUE,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__NONTRIVIAL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                ...
                @ ( ap @ c_2Eiterate_2Einf
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V2e: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2e )
                          @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V2e ) )
                            @ ( ap
                                    ...
                                    @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                                      @ ( lam @ ty_2Erealax_2Ereal
                                        @ ^ [V3x: $i] :
                                            ( lam @ ty_2Erealax_2Ereal
                                            @ ^ [V4y: $i] :
                                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ V3x ) @ V4y ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V3x ) @ V1t ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ V4y ) ) @ V2e ) ) ) ) ) ) ) ) )
                              @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V1t )
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                                  @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                                    @ ( lam @ ty_2Erealax_2Ereal
                                      @ ^ [V5x: $i] :
                                          ( lam @ ty_2Erealax_2Ereal
                                          @ ^ [V6y: $i] :
                                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ V5x ) @ V6y ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V0s ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ V6y ) ) @ V2e ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
