...
tff(conj_thm_2Epred__set_2EIMAGE__UNION,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__LE__IMAGE__GEN,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2EUNION__LE__ADD__C,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
         => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),ap(ap(c_2Epred__set_2EUNION(A_27a),V0s),V1t)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) )).
