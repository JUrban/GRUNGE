...
thf(tp_c_2Elogroot_2EROOT,type,(
    c_2Elogroot_2EROOT: $i )).

thf(mem_c_2Elogroot_2EROOT,axiom,(
    mem @ c_2Elogroot_2EROOT @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) )).

thf(stp_fo_c_2Elogroot_2EROOT,type,(
    fo__c_2Elogroot_2EROOT: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Elogroot_2EROOT,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Elogroot_2EROOT @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) ) )).
...
thf(conj_thm_2Elogroot_2ELE__EXP__ISO,lemma,(
...
thf(conj_thm_2Elogroot_2EEXP__LT__ISO,lemma,(
...
thf(ax_thm_2Elogroot_2EROOT,axiom,(
...
thf(conj_thm_2Elogroot_2ELOG__UNIQUE,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2ELOG @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        = V2p ) ) )).

thf(conj_thm_2Elogroot_2EEXP__MUL,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum,V2c: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V1b ) ) ) @ ( inj__ty_2Enum_2Enum @ V2c ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V1b ) ) @ ( inj__ty_2Enum_2Enum @ V2c ) ) ) ) ) )).
...
thf(conj_thm_2Elogroot_2ELOG__ROOT,conjecture,(
    ! [V0a: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2r: tp__ty_2Enum_2Enum] :
      ( ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) )
        ...
        & ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V2r ) ) ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Elogroot_2ELOG @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( ap @ ( ap @ c_2Elogroot_2EROOT @ ( inj__ty_2Enum_2Enum @ V2r ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ ( ap @ ( ap @ c_2Elogroot_2ELOG @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) @ ( inj__ty_2Enum_2Enum @ V2r ) ) ) ) ) )).
