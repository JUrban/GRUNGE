...
tff(conj_thm_2Eprobability_2ECOUNTABLY__ADDITIVE__PROB,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Eprobability_2EEVENTS__SIGMA__ALGEBRA,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Eprobability_2EPROB__SPACE__COUNTABLY__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => p(ap(c_2Emeasure_2Ecountably__additive(A_27a),V0p)) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__COUNTABLY__ADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
