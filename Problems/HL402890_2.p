...
tff(conj_thm_2Erich__list_2ELENGTH__COUNT__LIST,lemma,(
...
tff(conj_thm_2Erich__list_2EEL__COUNT__LIST,lemma,(
...
tff(lameq_f817,axiom,(
    ! [A_27a: del,V1l1: $i] :
      ( mem(V1l1,ty_2Elist_2Elist(A_27a))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f817(A_27a,V1l1),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V2n)),V1l1)),inj__ty_2Enum_2Enum(V2n)) ) )).

tff(conj_thm_2Erich__list_2EZIP__COUNT__LIST,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l1: $i] :
      ( mem(V1l1,ty_2Elist_2Elist(A_27a))
     => ( V0n = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),V1l1))
       => ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V1l1),ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V0n)))) = ap(ap(c_2Elist_2EGENLIST(ty_2Epair_2Eprod(A_27a,A_27a)),f817(A_27a,V1l1)),ap(c_2Elist_2ELENGTH(A_27a),V1l1)) ) ) )).
