...
fof(conj_thm_2Ecardinal_2Ecardeq__SYM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f2159,axiom,(
    ! [A_27a] : mem(f2159(A_27a),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) )).

fof(lameq_f2159,axiom,(
    ! [A_27a,V0i] :
      ( mem(V0i,ty_2Enum_2Enum)
     => ap(f2159(A_27a),V0i) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(c_2Eordinal_2EfromNat(A_27a),V0i)),c_2Ebool_2ET) ) )).

fof(ax_thm_2Eordinal_2Eomega__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Eordinal_2Eomega(A_27a) = ap(c_2Eordinal_2Esup(A_27a),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2159(A_27a))) ) )).
...
fof(conj_thm_2Eordinal_2EfromNat__eq__omega,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eordinal_2EordMULT__le__MONO__L,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(conj_thm_2Eordinal_2EordMULT__fromNat,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eordinal_2EordEXP__1R,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(conj_thm_2EordNotationSemantics_2Enat__times__omega,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
         ...
         => ! [V1m] :
             ...
             => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V1m))
                  & p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),c_2Enum_2E0)),V0e)) )
               => ap(ap(c_2Eordinal_2EordMULT(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),V1m)),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0e)) = ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V0e) ) ) ) ) )).
