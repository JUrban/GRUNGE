...
tff(conj_thm_2EreaderMonad_2EMCOMPOSE__LEFT__ID,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27b,A_27c)))
     => ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),c_2EreaderMonad_2EUNIT(A_27a,A_27a)),V0g) = V0g ) )).
