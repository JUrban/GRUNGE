...
tff(thm_2Eset__relation_2Efinite__acyclic__has__minimal,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
     ...
     => ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0s_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
       => ! [V1r_2E0: u] :
            ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Eset__relation_2Eacyclic_2E1(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),V1r_2E0)))))
...
tff(thm_2Eset__relation_2Estrict__linear__order__acyclic,axiom,(
...
tff(thm_2Eset__relation_2Efinite__strict__linear__order__has__minimal,conjecture,(
