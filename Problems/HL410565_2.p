...
tff(lamtp_f2016,axiom,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => mem(f2016(A_27a,V0top),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).

tff(lameq_f2016,axiom,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ap(f2016(A_27a,V0top),V1s) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1s),ap(ap(c_2Etopology_2Eopen__in(A_27a),V0top),V1s)) ) ) )).

tff(ax_thm_2Etopology_2Etopspace,axiom,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ap(c_2Etopology_2Etopspace(A_27a),V0top) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f2016(A_27a,V0top))) ) )).
...
tff(conj_thm_2Ereal__topology_2EOPEN__UNIV,lemma,(
...
tff(conj_thm_2Ereal__topology_2ETOPSPACE__EUCLIDEAN,conjecture,(
