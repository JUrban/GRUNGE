...
thf(thm_2Enumeral_2Enumeral__funpow,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2f_2E0: u] :
      ( ( ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ A_27a @ V0x_2E0 ) )
      & ( ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2EPRE @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ A_27a @ V0x_2E0 ) ) ) ) ) )
      & ( ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V1n ) ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V2f_2E0 ) @ ( s @ A_27a @ V0x_2E0 ) ) ) ) ) ) ) )).
