...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__NOT__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__EXISTS,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__NOT__EMPTY,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
