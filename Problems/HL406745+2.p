...
fof(mem_c_2Epatricia_2EADD__LIST,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Epatricia_2EADD__LIST(A_27a),arr(ty_2Epatricia_2Eptree(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epatricia_2Eptree(A_27a)))) ) )).
...
fof(ax_thm_2Epatricia_2EADD__LIST__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Epatricia_2EADD__LIST(A_27a) = ap(c_2Elist_2EFOLDL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epatricia_2EADD(A_27a)) ) )).
...
fof(conj_thm_2Epatricia_2EADD__LIST__IS__PTREE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
             => ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
