...
thf(f8899_0_2E0,type,(
    f8899_0_2E0: u )).

thf(f8899_0_2E1,type,(
    f8899_0_2E1: du > u )).

thf(f8899_1_2E0,type,(
    f8899_1_2E0: u )).

thf(f8899_1_2E3,type,(
    f8899_1_2E3: du > du > du > u )).

thf(f8899_2_2E0,type,(
    f8899_2_2E0: u )).

thf(f8899_2_2E3,type,(
...
thf(mono_2Ef8899_0,type,(
    mono_2Ef8899_0: mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef8899_1,type,(
    mono_2Ef8899_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef8899_2,type,(
    mono_2Ef8899_2: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(thm_2Ereal_2Eeq__ratl,axiom,(
...
thf(def0_2Ethm_2Ereal_2Eeq__ratr,axiom,(
    ! [V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8899_0 @ V1y )
    <=> ( V1y
        = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(def1_2Ethm_2Ereal_2Eeq__ratr,axiom,(
    ! [V1y: mono_2Etyop_2Erealax_2Ereal,V0z: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8899_2 @ V1y @ V0z @ V2x )
    <=> ( ( mono_2Ec_2Erealax_2Ereal__mul @ V1y @ V0z )
        = V2x ) ) )).

thf(def2_2Ethm_2Ereal_2Eeq__ratr,axiom,(
    ! [V0z: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8899_1 @ V0z @ V2x @ V1y )
    <=> ( V0z
        = ( mono_2Ec_2Emarker_2Eunint_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2E_2F @ V2x @ V1y ) ) ) ) )).

thf(thm_2Ereal_2Eeq__ratr,conjecture,(
    ! [V0z: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( V0z
        = ( mono_2Ec_2Ereal_2E_2F @ V2x @ V1y ) )
    <=> ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ef8899_0 @ V1y ) @ ( mono_2Ef8899_1 @ V0z @ V2x @ V1y ) @ ( mono_2Ef8899_2 @ V1y @ V0z @ V2x ) ) ) )).
