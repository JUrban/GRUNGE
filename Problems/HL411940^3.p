    ...
    <=> ! [V1x: tyop_2Erealax_2Ereal] :
         ...
         => ? [V2e: tyop_2Erealax_2Ereal] :
              ...
              & ! [V3d: tyop_2Erealax_2Ereal] :
                  ( ( c_2Ereal_2Ereal__lte @ V3d @ V2e )
                 => ( c_2Ereal__topology_2EClosed @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Ecball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1x @ V3d ) ) @ V0s ) ) ) ) ) ) )).
