...
thf(conj_thm_2Ewords_2EWORD__GT,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(conj_thm_2Ewords_2Eword__gt__n2w,conjecture,(
              ...
              @ ( ap @ ( c_2Ebool_2ELET @ bool @ ( arr @ bool @ bool ) )
                @ ( lam @ bool
                  @ ^ [V2sa: $i] :
                      ( lam @ bool
                      @ ^ [V3sb: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ bool ) @ V2sa ) @ V3sb ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3E @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( ap @ ( c_2Ewords_2Edimword @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1b ) ) @ ( ap @ ( c_2Ewords_2Edimword @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ V2sa ) ) @ V3sb ) ) ) ) )
