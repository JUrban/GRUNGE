...
fof(lamtp_f2183,axiom,(
    ! [A_27a,V2w] :
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
              ( mem(V1l,ty_2Enum_2Enum)
             => mem(f2183(A_27a,V2w,V0h,V1l),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
    ...
    ! [A_27a,V2w] :
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
             ...
             => ! [V3i] :
                  ( mem(V3i,ty_2Enum_2Enum)
                 => ap(f2183(A_27a,V2w,V0h,V1l),V3i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V1l),ap(ap(c_2Earithmetic_2EMIN,V0h),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2w),ap(ap(c_2Earithmetic_2EMIN,ap(ap(c_2Earithmetic_2E_2B,V3i),V1l)),ap(ap(c_2Earithmetic_2EMIN,V0h),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))) ) ) ) ) )).

fof(lamtp_f2182,axiom,(
    ! [A_27a,A_27a,V1l] :
      ( mem(V1l,ty_2Enum_2Enum)
     => ! [V0h] :
          ( mem(V0h,ty_2Enum_2Enum)
         => mem(f2182(A_27a,A_27a,V1l,V0h),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__signed__bits__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0h] :
         ...
         => ! [V1l] :
              ( mem(V1l,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__signed__bits(A_27a),V0h),V1l) = f2182(A_27a,A_27a,V1l,V0h) ) ) ) )).

fof(conj_thm_2Ewords_2Eword__signed__bits__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0h] :
          ( mem(V0h,ty_2Enum_2Enum)
