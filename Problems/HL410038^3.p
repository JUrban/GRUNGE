...
thf(thm_2Eproduct_2ENPRODUCT__MUL__GEN,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1g: A_27a > tyop_2Enum_2Enum,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V3x: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V3x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3x @ V2s ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( V0f @ V3x ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
        & ( c_2Epred__set_2EFINITE @ A_27a
          @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
            @ ^ [V4x: A_27a] :
                ( c_2Epair_2E_2C @ A_27a @ $o @ V4x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V4x @ V2s ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( V1g @ V4x ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )
     => ( ( c_2Eproduct_2Enproduct @ A_27a @ V2s
          @ ^ [V5x: A_27a] :
              ( c_2Earithmetic_2E_2A @ ( V0f @ V5x ) @ ( V1g @ V5x ) ) )
