...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__MIN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V3x] :
             ...
             => ap(f3832(V0f,V1g),V3x) = ap(ap(c_2Ereal_2Emin,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__MIN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
