...
tff(lmtp_f360,type,(
    f360: ( del * $i * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f360,axiom,(
    ! [A_27a: del,V9y: $i] :
      ( mem(V9y,A_27a)
     => ! [V0f: $i] :
         ...
         => ! [V8x: $i] :
              ( mem(V8x,A_27a)
             => ! [V10m: tp__ty_2Enum_2Enum] : mem(f360(A_27a,V9y,V0f,V8x,V10m),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f359,axiom,(
    ! [A_27a: del,V8x: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V9y: $i] :
              ( mem(V9y,A_27a)
             => ! [V10m: tp__ty_2Enum_2Enum] : ap(f359(A_27a,V8x,V0f,V9y),inj__ty_2Enum_2Enum(V10m)) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f360(A_27a,V9y,V0f,V8x,V10m)) ) ) ) )).

tff(lmtp_f358,type,(
    f358: ( del * $i * $i ) > $i )).

tff(lamtp_f358,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
     => ! [V8x: $i] :
          ( mem(V8x,A_27a)
...
tff(lmtp_f364,type,(
    f364: ( del * $i * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f364,axiom,(
    ! [A_27a: del,V13y: $i] :
      ( mem(V13y,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => ! [V12x: $i] :
              ( mem(V12x,A_27a)
             => ! [V14m: tp__ty_2Enum_2Enum] : mem(f364(A_27a,V13y,V0f,V12x,V14m),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f364,axiom,(
    ! [A_27a: del,V13y: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V12x: $i] :
              ( mem(V12x,A_27a)
             => ! [V14m: tp__ty_2Enum_2Enum,V15n: tp__ty_2Enum_2Enum] : ap(f364(A_27a,V13y,V0f,V12x,V14m),inj__ty_2Enum_2Enum(V15n)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V14m)),inj__ty_2Enum_2Enum(V15n))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(A_27a)),ap(V0f,inj__ty_2Enum_2Enum(V14m))),ap(c_2Eoption_2ESOME(A_27a),V12x))),ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(A_27a)),ap(V0f,inj__ty_2Enum_2Enum(V15n))),ap(c_2Eoption_2ESOME(A_27a),V13y)))) ) ) ) )).

tff(lmtp_f363,type,(
    f363: ( del * $i * $i * $i ) > $i )).

tff(lamtp_f363,axiom,(
    ! [A_27a: del,V12x: $i] :
      ( mem(V12x,A_27a)
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
...
tff(lameq_f363,axiom,(
    ! [A_27a: del,V12x: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V13y: $i] :
              ( mem(V13y,A_27a)
             => ! [V14m: tp__ty_2Enum_2Enum] : ap(f363(A_27a,V12x,V0f,V13y),inj__ty_2Enum_2Enum(V14m)) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f364(A_27a,V13y,V0f,V12x,V14m)) ) ) ) )).

tff(lmtp_f362,type,(
    f362: ( del * $i * $i ) > $i )).

tff(lamtp_f362,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
     => ! [V12x: $i] :
          ( mem(V12x,A_27a)
...
tff(conj_thm_2Eset__relation_2Enat__order__iso__thm,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
