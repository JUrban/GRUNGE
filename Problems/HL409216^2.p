...
thf(conj_thm_2Eintegral_2EDSIZE__EQ,lemma,(
       ...
       => ( ( surj__ty_2Erealax_2Ereal
            @ ( ap
              @ ( ap @ c_2Ereal_2Ereal__sub
                @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Etransc_2Edsize @ V2D ) ) )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3n: $i] :
                        ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V2D @ ( ap @ c_2Enum_2ESUC @ V3n ) ) ) @ ( ap @ V2D @ V3n ) ) ) ) )
              @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) )
...
thf(conj_thm_2Eintegral_2EDINT__CONST,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ...
      @ ( ap
        ...
        @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) )).
