...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__0,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => p(ap(ap(c_2Ereal__topology_2Esummable,V0s),k(ty_2Enum_2Enum,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))) ) )).
