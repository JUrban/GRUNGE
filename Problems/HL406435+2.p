...
fof(conj_thm_2Ecomparison_2Echar__cmp__antisym,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ecomparison_2Elist__cmp__antisym,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0cmp] :
...
fof(conj_thm_2Ecomparison_2Estring__cmp__antisym,conjecture,(
    ! [V0x] :
