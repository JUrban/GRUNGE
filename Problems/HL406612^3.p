...
thf(thm_2ECoder_2Ebool__coder__def,axiom,(
    ! [V0p: $o > $o] :
      ( ( c_2ECoder_2Ebool__coder @ V0p )
      = ( c_2Epair_2E_2C @ ( $o > $o ) @ ( tyop_2Epair_2Eprod @ ( $o > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ $o @ ( tyop_2Elist_2Elist @ $o ) ) ) ) ) @ V0p @ ( c_2Epair_2E_2C @ ( $o > ( tyop_2Elist_2Elist @ $o ) ) @ ( ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ $o @ ( tyop_2Elist_2Elist @ $o ) ) ) ) @ c_2EEncode_2Eencode__bool @ ( c_2EDecode_2Edecode__bool @ V0p ) ) ) ) )).
...
thf(thm_2EEncodeVar_2Efixed__width__bool,conjecture,(
    ! [V0p: $o > $o] :
      ( c_2EEncodeVar_2Efixed__width @ $o @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2ECoder_2Ebool__coder @ V0p ) ) )).
