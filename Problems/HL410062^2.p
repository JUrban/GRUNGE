...
thf(conj_thm_2Eproduct_2EPRODUCT__IMAGE,lemma,(
...
thf(conj_thm_2Eproduct_2EPRODUCT__OFFSET,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V2m: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) ) @ V1f ) )
          = ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4i: $i] :
