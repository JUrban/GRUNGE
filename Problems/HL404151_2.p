...
tff(conj_thm_2Epath_2Efinite__pmap,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2p: $i] :
             ...
             => ( p(ap(c_2Epath_2Efinite(A_27c,A_27c),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V2p)))
              <=> p(ap(c_2Epath_2Efinite(A_27a,A_27a),V2p)) ) ) ) ) )).

tff(conj_thm_2Epath_2Elength__pmap,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2p: $i] :
              ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
             => surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Epath_2Elength(A_27b,A_27b),ap(ap(ap(c_2Epath_2Epmap(A_27a,A_27a,A_27a,A_27a),V0f),V1g),V2p))) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Epath_2Elength(A_27a,A_27a),V2p)) ) ) ) )).
...
tff(conj_thm_2Epath_2EPL__pmap,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27d,A_27b))
         => ! [V2p: $i] :
              ( mem(V2p,ty_2Epath_2Epath(A_27c,A_27c))
             => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(ap(c_2Epath_2Epmap(A_27c,A_27c,A_27c,A_27c),V0f),V1g),V2p)) = ap(c_2Epath_2EPL(A_27c,A_27c),V2p) ) ) ) )).
