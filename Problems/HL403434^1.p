...
thf(thm_2Erelation_2ERTC__INDUCT__RIGHT1,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1P_2E0: u] :
      ( ( ! [V2x_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1P_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
        & ! [V3x_2E0: u,V4y_2E0: u,V5z_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1P_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) @ ( s @ A_27a @ V4y_2E0 ) ) ) )
           ...
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1P_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) @ ( s @ A_27a @ V5z_2E0 ) ) ) ) ) )
     => ! [V6x_2E0: u,V7y_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2ERTC_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) @ ( s @ A_27a @ V7y_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1P_2E0 ) @ ( s @ A_27a @ V6x_2E0 ) ) ) @ ( s @ A_27a @ V7y_2E0 ) ) ) ) ) ) )).
...
thf(thm_2EdirGraph_2EREACH__LEM1,conjecture,(
    ! [A_27a: d,V0p_2E0: u,V1G_2E0: u,V2seen_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2seen_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2EdirGraph_2EEXCLUDE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2seen_2E0 ) ) ) @ ( s @ A_27a @ V0p_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27a @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2EdirGraph_2EREACH__LIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( c_2EdirGraph_2EEXCLUDE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27a @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2seen_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ V1G_2E0 ) @ ( s @ A_27a @ V0p_2E0 ) ) ) ) ) ) ) ) ) )).
