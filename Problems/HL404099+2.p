    ...
    ! [V1b] :
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V5t] :
                  ( mem(V5t,ty_2Enum_2Enum)
                 => ap(f1649(V1b,V2c,V0a),V5t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V1b),V5t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V2c),V5t)) ) ) ) ) )).

fof(lamtp_f1650,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V2c] :
         ...
         => ! [V6t] :
             ...
             => ap(f1650(V1b,V2c),V6t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V6t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V6t)) ) ) ) )).

fof(lamtp_f1652,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V8t] :
                 ...
                 => ap(f1652(V1b,V2c,V0a),V8t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V8t)),ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,V8t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),V8t))) ) ) ) ) )).

fof(lamtp_f1651,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V1b] :
             ...
             => ! [V7t] :
                 ...
                 => ap(f1651(V0a,V2c,V1b),V7t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V7t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V7t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),f1652(V1b,V2c,V0a)),V7t)) ) ) ) ) )).

fof(lamtp_f1653,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
     ...
     => ! [V3d] :
         ...
         => ! [V1b] :
             ...
             => ! [V9t] :
                 ...
                 => ap(f1653(V2c,V3d,V1b),V9t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V9t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V2c),V3d),V9t)) ) ) ) ) )).

fof(lamtp_f1655,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V2c] :
         ...
         => ! [V11t] :
             ...
             => ap(f1655(V0a,V2c),V11t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V11t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V11t)) ) ) ) )).

fof(lamtp_f1657,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V2c] :
         ...
         => ! [V13t] :
             ...
             => ap(f1657(V0a,V2c),V13t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V13t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V13t)) ) ) ) )).

fof(lamtp_f1656,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V3d] :
                 ...
                 => ! [V12t] :
                     ...
                     => ap(f1656(V0a,V2c,V1b,V3d),V12t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V3d,V12t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1657(V0a,V2c)),V1b),V12t)) ) ) ) ) ) )).

fof(lamtp_f1654,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V3d] :
                 ...
                 => ! [V10t] :
                     ...
                     => ap(f1654(V0a,V2c,V1b,V3d),V10t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V2c),V3d),V10t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1655(V0a,V2c)),V1b),V10t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),f1656(V0a,V2c,V1b,V3d)),V10t)) ) ) ) ) ) )).

fof(lamtp_f1658,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V3d] :
         ...
         => ! [V1b] :
             ...
             => ! [V14t] :
                 ...
                 => ap(f1658(V2c,V3d,V1b),V14t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V14t)),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V2c),V3d),V14t)) ) ) ) ) )).

fof(lamtp_f1660,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V16t] :
             ...
             => ap(f1660(V0a,V3d),V16t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V16t)),ap(c_2Ebool_2E_7E,ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V3d),V16t))) ) ) ) )).

fof(lamtp_f1662,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V18t] :
             ...
             => ap(f1662(V0a,V3d),V18t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V18t)),ap(c_2Ebool_2E_7E,ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V3d),V18t))) ) ) ) )).

fof(lamtp_f1661,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V17t] :
                     ...
                     => ap(f1661(V3d,V1b,V0a,V2c),V17t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,V17t)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V3d,V17t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1662(V0a,V3d)),V1b),V17t))) ) ) ) ) ) )).

fof(lamtp_f1659,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V15t] :
                     ...
                     => ap(f1659(V0a,V3d,V1b,V2c),V15t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V2c),V3d),V15t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1660(V0a,V3d)),V1b),V15t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),f1661(V3d,V1b,V0a,V2c)),V15t)) ) ) ) ) ) )).

fof(lamtp_f1663,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V1b] :
             ...
             => ! [V20t] :
                 ...
                 => ap(f1663(V0a,V2c,V1b),V20t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V0a),V2c),V20t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V1b),V2c),V20t)) ) ) ) ) )).

fof(lamtp_f1664,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V21t] :
             ...
             => ap(f1664(V0a,V1b),V21t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V21t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V21t)) ) ) ) )).

fof(lamtp_f1666,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V23t] :
             ...
             => ap(f1666(V1b,V0a),V23t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,V23t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V0a),V23t)) ) ) ) )).

fof(lamtp_f1665,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V1b] :
         ...
         => ! [V2c] :
             ...
             => ! [V22t] :
                 ...
                 => ap(f1665(V0a,V1b,V2c),V22t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,V22t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V22t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V22t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1666(V1b,V0a)),ap(c_2EPast__Temporal__Logic_2EPSNEXT,V2c)),V22t))) ) ) ) ) )).

fof(lamtp_f1667,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V24t] :
                 ...
                 => ap(f1667(V1b,V2c,V0a),V24t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V24t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V1b),V2c),V24t)) ) ) ) ) )).

fof(lamtp_f1669,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V2c] :
         ...
         => ! [V26t] :
             ...
             => ap(f1669(V3d,V2c),V26t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V26t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V26t)) ) ) ) )).

fof(lamtp_f1670,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V27t] :
             ...
             => ap(f1670(V0a,V3d),V27t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V27t))),ap(c_2Ebool_2E_7E,ap(V3d,V27t))) ) ) ) )).

fof(lamtp_f1672,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V2c] :
         ...
         => ! [V29t] :
             ...
             => ap(f1672(V3d,V2c),V29t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V29t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V29t)) ) ) ) )).

fof(lamtp_f1673,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V30t] :
             ...
             => ap(f1673(V0a,V3d),V30t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V30t))),ap(c_2Ebool_2E_7E,ap(V3d,V30t))) ) ) ) )).

fof(lamtp_f1671,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ! [V28t] :
                     ...
                     => ap(f1671(V2c,V3d,V0a,V1b),V28t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,V28t)),ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,V28t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,f1672(V3d,V2c)),f1673(V0a,V3d)),V28t))) ) ) ) ) ) )).

fof(lamtp_f1668,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V25t] :
                     ...
                     => ap(f1668(V3d,V1b,V0a,V2c),V25t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V1b),V2c),V25t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,f1669(V3d,V2c)),f1670(V0a,V3d)),V25t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1671(V2c,V3d,V0a,V1b)),V3d),V25t)) ) ) ) ) ) )).

fof(lamtp_f1674,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V31t] :
                 ...
                 => ap(f1674(V1b,V2c,V0a),V31t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V31t)),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),V2c),V31t)) ) ) ) ) )).

fof(lamtp_f1676,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V1b] :
         ...
         => ! [V33t] :
             ...
             => ap(f1676(V3d,V1b),V33t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V33t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),V33t)) ) ) ) )).

fof(lamtp_f1677,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V34t] :
             ...
             => ap(f1677(V0a,V3d),V34t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V34t))),ap(c_2Ebool_2E_7E,ap(V3d,V34t))) ) ) ) )).

fof(lamtp_f1679,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V1b] :
         ...
         => ! [V36t] :
             ...
             => ap(f1679(V3d,V1b),V36t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V36t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),V36t)) ) ) ) )).

fof(lamtp_f1680,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V37t] :
             ...
             => ap(f1680(V0a,V3d),V37t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V37t))),ap(c_2Ebool_2E_7E,ap(V3d,V37t))) ) ) ) )).

fof(lamtp_f1678,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V3d] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V35t] :
                     ...
                     => ap(f1678(V1b,V0a,V3d,V2c),V35t) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(V2c,V35t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,f1679(V3d,V1b)),f1680(V0a,V3d)),V35t)) ) ) ) ) ) )).

fof(lamtp_f1675,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ! [V32t] :
                     ...
                     => ap(f1675(V3d,V2c,V0a,V1b),V32t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V1b),V2c),V32t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,f1676(V3d,V1b)),f1677(V0a,V3d)),V32t))),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,f1678(V1b,V0a,V3d,V2c)),V3d),V32t)) ) ) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__PSUNTIL__THM,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
