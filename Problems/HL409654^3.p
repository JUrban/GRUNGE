...
thf(thm_2Eiterate_2EFINITE__INDEX__NUMSEG,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
    <=> ? [V1f: tyop_2Enum_2Enum > A_27a] :
          ( ! [V2i: tyop_2Enum_2Enum,V3j: tyop_2Enum_2Enum] :
              ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V2i @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) )
                & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3j @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) )
                & ( ( V1f @ V2i )
                  = ( V1f @ V3j ) ) )
             => ( V2i = V3j ) )
          & ( V0s
            = ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ A_27a @ V1f @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EFINITE__INDEX__NUMBERS,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
    <=> ? [V1k: tyop_2Enum_2Enum > $o,V2f: tyop_2Enum_2Enum > A_27a] :
          ( ! [V3i: tyop_2Enum_2Enum,V4j: tyop_2Enum_2Enum] :
              ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V1k )
                & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4j @ V1k )
                & ( ( V2f @ V3i )
                  = ( V2f @ V4j ) ) )
             => ( V3i = V4j ) )
          & ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V1k )
          & ( V0s
            = ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ A_27a @ V2f @ V1k ) ) ) ) )).
