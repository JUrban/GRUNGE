...
thf(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING__N__EXISTS,lemma,
    ( ! [V0s: $i] :
    ...
    & ! [V1s: $i] :
       ...
       => ( ? [V2a: $i] :
              ...
              & ( ( ap @ c_2Ereal__topology_2Ecomponents @ V1s )
                = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2a ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) ) ) )
        <=> ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V1s ) )
            & ( V1s
             != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( ap @ c_2Ereal__topology_2Ecomponents @ V0s )
          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) ) )
