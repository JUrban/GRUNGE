...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__INTER__NONZERO,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ! [V1f: $i] :
           ...
           => ( ( surj__ty_2Eextreal_2Eextreal
                @ ( ap @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27a ) @ V1f )
                  @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V0s )
                    @ ( lam @ A_27a
                      @ ^ [V2p: $i] :
                          ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Eextreal_2Eextreal ) @ ( ap @ V1f @ V2p ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )
