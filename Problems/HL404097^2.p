...
thf(conj_thm_2ETemporal__Logic_2ESUNTIL__LINORD,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2ESUNTIL__AS__BEFORE,lemma,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__BEFORE__THM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ! [V3d: $i] :
                 ...
                 => ( ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V4t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V4t ) ) @ ( ap @ V2c @ V4t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V5t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a ) @ V1b ) @ V5t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a ) @ V2c ) @ V5t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V6t: $i] :
                      ...
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V7t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a ) @ V2c ) @ V7t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V1b ) @ V2c ) @ V7t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V8t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V8t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V2c ) @ V8t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V9t: $i] :
                            ...
                            @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V9t ) )
                              @ ( ap
                                @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) )
                                  @ ( lam @ ty_2Enum_2Enum
                                    @ ^ [V10t: $i] :
                                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2c @ V10t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V10t ) ) ) )
                                @ V9t ) ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V11t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V11t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V2c ) @ V11t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V12t: $i] :
                            ...
                            @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V12t ) )
                              @ ( ap
                                @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) )
                                  @ ( lam @ ty_2Enum_2Enum
                                    @ ^ [V13t: $i] :
                                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V2c @ V13t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V13t ) ) ) )
                                @ V12t ) ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V14t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V14t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V2c ) @ V3d ) @ V14t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V15t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V17t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V17t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V17t ) ) ) ) )
                                    @ V1b )
                                  @ V15t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                                      ...
                                      @ ( ap
                                        @ ( ap
                                          @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V19t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V19t ) ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V19t ) ) ) )
                                          @ V1b )
                                        @ V18t ) ) ) )
                              @ V15t ) ) ) )
                    & ( ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V20t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V20t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V2c ) @ V3d ) @ V20t ) ) ) )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V21t: $i] :
                            ( ap
                            @ ( ap @ c_2Ebool_2E_2F_5C
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V23t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V23t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V3d ) @ V23t ) ) ) )
                                    @ V1b )
                                  @ V21t ) ) )
                            @ ( ap
                              @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V0a )
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V25t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V25t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V3d ) @ V25t ) ) ) ) )
                                            @ V1b )
                                          @ V24t ) ) ) ) )
                              @ V21t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V26t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V26t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) @ V26t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V27t: $i] :
                              ...
                              @ ( ap
                                @ ( ap
                                  @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V28t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V28t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V28t ) ) ) )
                    ...
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V29t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V29t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V1b ) @ V29t ) ) ) )
                        @ V2c )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V30t: $i] :
                              ...
                              @ ( ap
                                @ ( ap
                                  @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V31t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V31t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0a ) @ V31t ) ) ) )
                                  @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) )
                                @ V30t ) ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V32t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V32t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V1b ) @ V2c ) @ V32t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V33t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V34t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V34t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V34t ) ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V35t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V35t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V35t ) ) ) ) )
                                  @ V33t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                          ...
                                          @ ( ap
                                            @ ( ap
                                              @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                                @ ( lam @ ty_2Enum_2Enum
                                                  @ ^ [V37t: $i] :
                                                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V37t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V2c ) @ V37t ) ) ) ) )
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V38t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V38t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V38t ) ) ) ) )
                                            @ V36t ) ) ) ) )
                                @ V3d )
                              @ V33t ) ) ) )
                    & ( ( ap
                        @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V39t: $i] :
                                ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V39t ) ) @ ( ap @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b ) @ V2c ) @ V39t ) ) ) )
                        @ V3d )
                      = ( lam @ ty_2Enum_2Enum
                        @ ^ [V40t: $i] :
                            ( ap
                                ...
                                @ ( ap
                                  @ ( ap
                                    @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                      @ ( lam @ ty_2Enum_2Enum
                                        @ ^ [V41t: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V41t ) ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V41t ) ) ) )
                                    @ ( lam @ ty_2Enum_2Enum
                                      @ ^ [V42t: $i] :
                                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V42t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V42t ) ) ) ) )
                                  @ V40t ) ) )
                            @ ( ap
                              @ ( ap
                                @ ( ap @ c_2ETemporal__Logic_2EBEFORE
                                        ...
                                        @ ( ap
                                          @ ( ap
                                            @ ( ap @ c_2ETemporal__Logic_2ESUNTIL
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V44t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V44t ) ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V44t ) ) ) )
                                            @ ( lam @ ty_2Enum_2Enum
                                              @ ^ [V45t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V45t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V3d @ V45t ) ) ) ) )
                                          @ V43t ) ) ) )
                                @ V3d )
                              @ V40t ) ) ) ) ) ) ) ) ) )).
