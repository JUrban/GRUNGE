...
fof(conj_thm_2Ealist_2Efmap__to__alist__FEMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)) = c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a)) ) ) )).
