...
thf(thm_2Eiterate_2ENUMSEG__LREC,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
     ...
     => ( ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ V0m @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V0m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1n ) )
...
thf(thm_2Eproduct_2ENPRODUCT__CLAUSES__LEFT,conjecture,(
