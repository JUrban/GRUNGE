...
thf(conj_thm_2Erich__list_2EAPPEND__SNOC1,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2l2: $i] :
              ( ( mem @ V2l2 @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V1x ) @ V0l1 ) ) @ V2l2 )
                = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V1x ) @ V2l2 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Eword__reduce__n2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
            ...
            @ ( ap @ ( c_2Ecombin_2EK @ bool @ ty_2Enum_2Enum )
              @ ( ap
                @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ bool ) @ bool )
                  @ ( lam @ ( ty_2Elist_2Elist @ bool )
                    @ ^ [V2l: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ bool @ bool ) @ V1f ) @ ( ap @ ( c_2Elist_2EHD @ bool ) @ V2l ) ) @ ( ap @ ( c_2Elist_2ETL @ bool ) @ V2l ) ) ) )
