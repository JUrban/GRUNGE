...
thf(thm_2Eiterate_2ESUM__POS__EQ__0__NUMSEG,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( ! [V3p: tyop_2Enum_2Enum] :
            ( ( ( c_2Earithmetic_2E_3C_3D @ V1m @ V3p )
              & ( c_2Earithmetic_2E_3C_3D @ V3p @ V2n ) )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V3p ) ) )
        & ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ V2n ) @ V0f )
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ! [V4p: tyop_2Enum_2Enum] :
          ( ( ( c_2Earithmetic_2E_3C_3D @ V1m @ V4p )
            & ( c_2Earithmetic_2E_3C_3D @ V4p @ V2n ) )
         => ( ( V0f @ V4p )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )).
