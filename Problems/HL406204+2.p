...
fof(lamtp_f2250,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
              ( mem(V2sa,bool)
             => mem(f2250(A_27a,V0a,V1b,V2sa),arr(bool,bool)) ) ) ) )).
    ...
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
             ...
             => ! [V3sb] :
                  ( mem(V3sb,bool)
                 => ap(f2250(A_27a,V0a,V1b,V2sa),V3sb) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(bool),V2sa),V3sb)),ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2EMOD,V0a),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Earithmetic_2EMOD,V1b),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))))),ap(ap(c_2Ebool_2E_2F_5C,V2sa),ap(c_2Ebool_2E_7E,V3sb))) ) ) ) ) )).

fof(lamtp_f2249,axiom,(
    ! [A_27a,V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
         => mem(f2249(A_27a,V0a,V1b),arr(bool,arr(bool,bool))) ) ) )).
...
fof(lameq_f2249,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
              ( mem(V2sa,bool)
             => ap(f2249(A_27a,V0a,V1b),V2sa) = f2250(A_27a,V0a,V1b,V2sa) ) ) ) )).

fof(conj_thm_2Ewords_2Eword__lt__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Enum_2Enum)
...
fof(lamtp_f2254,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
              ( mem(V2sa,bool)
             => mem(f2254(A_27a,V0a,V1b,V2sa),arr(bool,bool)) ) ) ) )).
    ...
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
             ...
             => ! [V3sb] :
                  ( mem(V3sb,bool)
                 => ap(f2254(A_27a,V0a,V1b,V2sa),V3sb) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(bool),V2sa),V3sb)),ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2EMOD,V0a),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Earithmetic_2EMOD,V1b),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a)))))),ap(ap(c_2Ebool_2E_2F_5C,V2sa),ap(c_2Ebool_2E_7E,V3sb))) ) ) ) ) )).

fof(lamtp_f2253,axiom,(
    ! [A_27a,V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
         => mem(f2253(A_27a,V0a,V1b),arr(bool,arr(bool,bool))) ) ) )).
...
fof(lameq_f2253,axiom,(
    ! [A_27a,V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2sa] :
              ( mem(V2sa,bool)
             => ap(f2253(A_27a,V0a,V1b),V2sa) = f2254(A_27a,V0a,V1b,V2sa) ) ) ) )).

fof(conj_thm_2Ewords_2Eword__le__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__LT__EQ__LO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
