...
fof(lamtp_f487,axiom,(
    ! [A_27a,V1Q] :
      ( mem(V1Q,arr(A_27a,bool))
     => ! [V2R] :
          ( mem(V2R,arr(A_27a,bool))
         => mem(f487(A_27a,V1Q,V2R),arr(A_27a,bool)) ) ) )).
...
fof(lameq_f487,axiom,(
    ! [A_27a,V1Q] :
     ...
     => ! [V2R] :
         ...
         => ! [V3i] :
              ( mem(V3i,A_27a)
             => ap(f487(A_27a,V1Q,V2R),V3i) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1Q,V3i)),ap(V2R,V3i)) ) ) ) )).

fof(conj_thm_2Eres__quan_2ERES__EXISTS__DISJ__DIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
