...
fof(conj_thm_2Esum_2Econd__sum__expand,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                 ...
                                 => ! [V0P] :
                                     ...
                                     => ( ! [V1x] :
                                           ...
                                           => ! [V2y] :
                                               ...
                                               => ! [V3z] :
                                                    ( mem(V3z,A_27a)
                                                   => ( ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27b,A_27b)),V0P),ap(c_2Esum_2EINR(A_27b,A_27b),V1x)),ap(c_2Esum_2EINL(A_27b,A_27b),V2y)) = ap(c_2Esum_2EINR(A_27b,A_27b),V3z)
                                                    <=> ( p(V0P)
                                                        & V3z = V1x ) ) ) ) )
                                        & ! [V4x] :
                                            ( mem(V4x,A_27c)
                                           => ! [V5y] :
                                               ...
                                               => ! [V6z] :
                                                    ( mem(V6z,A_27d)
                                                   => ( ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27d,A_27d)),V0P),ap(c_2Esum_2EINR(A_27d,A_27d),V4x)),ap(c_2Esum_2EINL(A_27d,A_27d),V5y)) = ap(c_2Esum_2EINL(A_27d,A_27d),V6z)
                                                    <=> ( ~ p(V0P)
                                                        & V6z = V5y ) ) ) ) )
                                        & ! [V7x] :
                                            ( mem(V7x,A_27e)
                                           => ! [V8y] :
                                               ...
                                               => ! [V9z] :
                                                    ( mem(V9z,A_27e)
                                                   => ( ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27e,A_27e)),V0P),ap(c_2Esum_2EINL(A_27e,A_27e),V7x)),ap(c_2Esum_2EINR(A_27e,A_27e),V8y)) = ap(c_2Esum_2EINL(A_27e,A_27e),V9z)
                                                    <=> ( p(V0P)
                                                        & V9z = V7x ) ) ) ) )
                                        & ! [V10x] :
                                            ( mem(V10x,A_27g)
                                           => ! [V11y] :
                                               ...
                                               => ! [V12z] :
                                                    ( mem(V12z,A_27h)
                                                   => ( ap(ap(ap(c_2Ebool_2ECOND(ty_2Esum_2Esum(A_27g,A_27g)),V0P),ap(c_2Esum_2EINL(A_27g,A_27g),V10x)),ap(c_2Esum_2EINR(A_27g,A_27g),V11y)) = ap(c_2Esum_2EINR(A_27g,A_27g),V12z)
                                                    <=> ( ~ p(V0P)
                                                        & V12z = V11y ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ecardinal_2ECARD__DISJOINT__UNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1t] :
             ...
             => ( ap(ap(c_2Epred__set_2EINTER(A_27a),V0s),V1t) = c_2Epred__set_2EEMPTY(A_27a)
               => p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),ap(ap(c_2Epred__set_2EUNION(A_27a),V0s),V1t)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) ) ) )).
