...
thf(thm_2Ecardinal_2ECARD__LT__CARD,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1t ) )
     => ( ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27b @ A_27a @ V1t @ V0s ) )
      <=> ( c_2Eprim__rec_2E_3C @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) @ ( c_2Epred__set_2ECARD @ A_27b @ V1t ) ) ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD__C,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1t ) )
     => ( ( c_2Epred__set_2ECARD @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) )
        = ( c_2Earithmetic_2E_2B @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) @ ( c_2Epred__set_2ECARD @ A_27b @ V1t ) ) ) ) )).

thf(thm_2Ecardinal_2ECARD__LE__ADDR,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( c_2Ecardinal_2Ecardleq @ A_27a @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0s @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) ) )).

thf(thm_2Ecardinal_2ECARD__LE__ADDL,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( c_2Ecardinal_2Ecardleq @ A_27b @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V1t @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD__FINITE,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1t ) )
     => ( c_2Epred__set_2EFINITE @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD__FINITE__EQ,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o] :
      ( ( c_2Epred__set_2EFINITE @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) )
    <=> ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Epred__set_2EFINITE @ A_27b @ V1t ) ) ) )).

thf(thm_2Ecardinal_2ECARD__ADD2__ABSORB__LT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0s: A_27a > $o,V1t: A_27b > $o,V2u: A_27c > $o] :
      ( ( ( (~) @ ( c_2Epred__set_2EFINITE @ A_27c @ V2u ) )
        & ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27c @ A_27a @ V2u @ V0s ) )
        & ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27c @ A_27b @ V2u @ V1t ) ) )
     => ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27c @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V2u @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27b @ V0s @ V1t ) ) ) ) )).
...
thf(thm_2Ecardinal_2ECARD__LT__ADD,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,V0s: A_27a > $o,V1s_27: A_27b > $o,V2t: A_27c > $o,V3t_27: A_27d > $o] :
      ( ( ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27b @ A_27a @ V1s_27 @ V0s ) )
        & ( (~) @ ( c_2Ecardinal_2Ecardleq @ A_27d @ A_27c @ V3t_27 @ V2t ) ) )
     => ( (~) @ ( c_2Ecardinal_2Ecardleq @ ( tyop_2Esum_2Esum @ A_27b @ A_27d ) @ ( tyop_2Esum_2Esum @ A_27a @ A_27c ) @ ( c_2Ecardinal_2E_2B__c @ A_27b @ A_27d @ V1s_27 @ V3t_27 ) @ ( c_2Ecardinal_2E_2B__c @ A_27a @ A_27c @ V0s @ V2t ) ) ) ) )).
