...
tff(lmtp_f2697,type,(
    f2697: ( tp__c_ty_2Elist_2Elist_o * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2697,axiom,(
    ! [V2bs: tp__c_ty_2Elist_2Elist_o,V0n: tp__ty_2Enum_2Enum] : mem(f2697(V2bs,V0n),arr(bool,ty_2Einteger_2Eint)) )).

tff(lameq_f2697,axiom,(
    ! [V2bs: tp__c_ty_2Elist_2Elist_o,V0n: tp__ty_2Enum_2Enum,V3r: tp__o] : ap(f2697(V2bs,V0n),inj__o(V3r)) = ap(c_2Eint__bitwise_2Eint__of__bits,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ap(ap(c_2Elist_2EDROP(bool),inj__ty_2Enum_2Enum(V0n)),inj__c_ty_2Elist_2Elist_o(V2bs))),inj__o(V3r))) )).

tff(lmtp_f2696,type,(
    f2696: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f2696,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f2696(V0n),arr(ty_2Elist_2Elist(bool),arr(bool,ty_2Einteger_2Eint))) )).

tff(lameq_f2696,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V2bs: tp__c_ty_2Elist_2Elist_o] : ap(f2696(V0n),inj__c_ty_2Elist_2Elist_o(V2bs)) = f2697(V2bs,V0n) )).

tff(ax_thm_2Eint__bitwise_2Eint__shift__right__def,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Einteger_2Eint] : surj__ty_2Einteger_2Eint(ap(ap(c_2Eint__bitwise_2Eint__shift__right,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Einteger_2Eint(V1i))) = surj__ty_2Einteger_2Eint(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),ty_2Epair_2Eprod(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool))),ap(c_2Epair_2EUNCURRY(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),f2696(V0n))),ap(c_2Eint__bitwise_2Ebits__of__int,inj__ty_2Einteger_2Eint(V1i)))) )).
...
tff(conj_thm_2Eint__bitwise_2Eint__bit__shift__right,conjecture,(
