...
tff(conj_thm_2Ecardinal_2ECARD__EQ__COUNTABLE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNCOUNTABLE__REAL,lemma,(
    ~ p(ap(c_2Epred__set_2Ecountable(ty_2Erealax_2Ereal),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).

tff(conj_thm_2Ereal__topology_2ECARD__EQ__REAL__IMP__UNCOUNTABLE,conjecture,(
    ! [V0s: $i] :
