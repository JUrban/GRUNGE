...
thf(thm_2Ebag_2EBAG__DIFF__2R,conjecture,(
    ! [A_27a: $tType,V0A: A_27a > tyop_2Enum_2Enum,V1B: A_27a > tyop_2Enum_2Enum,V2C: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESUB__BAG @ A_27a @ V2C @ V1B )
     => ( ( c_2Ebag_2EBAG__DIFF @ A_27a @ V0A @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V1B @ V2C ) )
        = ( c_2Ebag_2EBAG__DIFF @ A_27a @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V0A @ V2C ) @ V1B ) ) ) )).
