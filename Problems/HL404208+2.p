...
fof(conj_thm_2Epath_2Efirst__take,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epath_2Eokpath__take,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1p] :
                 ...
                 => ! [V2i] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V2i),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                       ...
                       => p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V0R),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V2i),V1p))) ) ) ) ) ) ) )).
