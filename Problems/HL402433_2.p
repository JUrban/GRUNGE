...
tff(mem_c_2EerrorStateMonad_2EFOREACH,axiom,(
    ! [A_27a: del,A_27state: del] : mem(c_2EerrorStateMonad_2EFOREACH(A_27a,A_27a),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(A_27state,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))) )).
...
tff(lmtp_f553,type,(
    f553: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f553,axiom,(
...
tff(lmtp_f552,type,(
    f552: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f552,axiom,(
...
tff(lmtp_f551,type,(
    f551: ( del * del * del * $i ) > $i )).

tff(lamtp_f551,axiom,(
...
tff(lmtp_f550,type,(
    f550: ( del * del * del * del ) > $i )).

tff(lamtp_f550,axiom,(
    ! [A_27state: del,A_27a: del,A_27state: del,A_27a: del] : mem(f550(A_27state,A_27a,A_27state,A_27a),arr(arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),arr(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),bool)),bool)) )).
...
tff(lmtp_f559,type,(
    f559: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f559,axiom,(
...
tff(lmtp_f558,type,(
    f558: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f558,axiom,(
...
tff(lmtp_f557,type,(
    f557: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f557,axiom,(
...
tff(conj_thm_2EerrorStateMonad_2EFOREACH__def,conjecture,(
    ! [A_27a: del,A_27state: del] :
      ( ! [V0a: $i] :
         ...
         => ap(c_2EerrorStateMonad_2EFOREACH(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),c_2Elist_2ENIL(A_27a)),V0a)) = ap(c_2EerrorStateMonad_2EUNIT(A_27state,A_27state),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone)) )
      & ! [V1t: $i] :
