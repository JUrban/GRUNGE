...
thf(thm_2Ereal__topology_2ECONTINUOUS__WITHIN__AVOID,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o,V3a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econtinuous_2Emono_2Etyop_2Erealax_2Ereal @ V0f @ ( mono_2Ec_2Ereal__topology_2Ewithin_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Eat @ V1x ) @ V2s ) )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1x @ V2s )
        & ( (~)
          @ ( ( V0f @ V1x )
            = V3a ) ) )
     => ? [V4e: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V5y: mono_2Etyop_2Erealax_2Ereal] :
              ( ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V5y @ V2s )
                & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1x @ V5y ) ) @ V4e ) )
             => ( (~)
                @ ( ( V0f @ V5y )
                  = V3a ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__AT__AVOID,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2a: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ? [V3e: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ! [V4y: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1x @ V4y ) ) @ V3e )
             => ( (~)
                @ ( ( V0f @ V4y )
                  = V2a ) ) ) ) ) )).
