...
thf(f13350_0_2E0,type,(
    f13350_0_2E0: u )).

thf(f13350_0_2E1,type,(
    f13350_0_2E1: du > u )).

thf(f13350_0_2E2,type,(
    f13350_0_2E2: du > du > u )).

thf(f13350_1_2E0,type,(
    f13350_1_2E0: u )).

thf(f13350_1_2E2,type,(
    f13350_1_2E2: du > du > u )).

thf(f13350_1_2E3,type,(
    f13350_1_2E3: du > du > du > u )).
...
thf(mono_2Ef13350_0,type,(
    mono_2Ef13350_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13350_1,type,(
    mono_2Ef13350_1: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__ON__POW,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13350_0 @ V0f @ V3x )
      = ( V0f @ V3x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECONTINUOUS__ON__POW,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum,V4x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13350_1 @ V0f @ V2n @ V4x )
      = ( mono_2Ec_2Ereal_2Epow @ ( V0f @ V4x ) @ V2n ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__POW,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ ( mono_2Ef13350_0 @ V0f ) @ V1s )
     => ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ ( mono_2Ef13350_1 @ V0f @ V2n ) @ V1s ) ) )).
