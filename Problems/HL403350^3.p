...
thf(thm_2Ebag_2ESUB__BAG__UNION__MONO,conjecture,(
    ! [A_27a: $tType] :
      ( ! [V0x: A_27a > tyop_2Enum_2Enum,V1y: A_27a > tyop_2Enum_2Enum] :
          ( c_2Ebag_2ESUB__BAG @ A_27a @ V0x @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V0x @ V1y ) )
      & ! [V2x: A_27a > tyop_2Enum_2Enum,V3y: A_27a > tyop_2Enum_2Enum] :
          ( c_2Ebag_2ESUB__BAG @ A_27a @ V2x @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V3y @ V2x ) ) ) )).
