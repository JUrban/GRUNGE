...
fof(conj_thm_2Earithmetic_2ELESS__EQ__MONO__ADD__EQ,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2ETemporal__Logic_2EALWAYS__SIGNAL,lemma,(
    ! [V0a] :
...
fof(lameq_f893,axiom,(
    ! [V1b] :
     ...
     => ! [V3t] :
          ( mem(V3t,ty_2Enum_2Enum)
         => ap(f893(V1b),V3t) = ap(c_2Ebool_2E_7E,ap(V1b,V3t)) ) ) )).

fof(lamtp_f916,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f916,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
              ( mem(V2t,ty_2Enum_2Enum)
             => ap(f916(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V0a),V1b),V2t)),ap(ap(c_2ETemporal__Logic_2EALWAYS,f893(V1b)),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EWHEN__AS__SWHEN,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V2i] :
             ...
             => ! [V1Phi__R] :
                 ...
                 => ! [V9t] :
                     ...
                     => ap(f2039(A_27b,A_27a,V8q,V7t0,V2i,V1Phi__R),V9t) = ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V9t),V7t0))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V9t),V7t0)))) ) ) ) ) ) )).

fof(lamtp_f2041,axiom,(
    ! [A_27b,A_27a,V8q] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0] :
          ( mem(V7t0,ty_2Enum_2Enum)
             ...
             => ! [V2i] :
                 ...
                 => ! [V3Psi] :
                     ...
                     => ! [V11t2] :
                         ...
                         => ap(f2041(A_27b,A_27a,V8q,V7t0,V10t1,V2i,V3Psi),V11t2) = ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V10t1),ap(ap(c_2Earithmetic_2E_2B,V11t2),V7t0)))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,V10t1),ap(ap(c_2Earithmetic_2E_2B,V11t2),V7t0))))) ) ) ) ) ) ) )).

fof(lamtp_f2040,axiom,(
    ! [A_27b,A_27a,V3Psi] :
      ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V2i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
     ...
     => ! [V2i] :
         ...
         => ! [V7t0] :
             ...
             => ! [V8q] :
                 ...
                 => ! [V10t1] :
                      ( mem(V10t1,ty_2Enum_2Enum)
                     => ap(f2040(A_27b,A_27a,V3Psi,V2i,V7t0,V8q),V10t1) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2041(A_27b,A_27a,V8q,V7t0,V10t1,V2i,V3Psi)) ) ) ) ) ) )).

fof(lamtp_f2038,axiom,(
    ! [A_27a,A_27b,V3Psi] :
      ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V2i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1Phi__R] :
             ...
             => ! [V0Phi__I] :
                 ...
                 => ! [V7t0] :
                      ( mem(V7t0,ty_2Enum_2Enum)
                     => mem(f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) ) )).
         ...
         => ! [V1Phi__R] :
             ...
             => ! [V0Phi__I] :
                 ...
                 => ! [V7t0] :
                     ...
                     => ! [V8q] :
                          ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
                         => ap(f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0),V8q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0Phi__I,ap(V8q,V7t0))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2039(A_27b,A_27a,V8q,V7t0,V2i,V1Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2040(A_27b,A_27a,V3Psi,V2i,V7t0,V8q)))) ) ) ) ) ) ) )).

fof(lamtp_f2037,axiom,(
     ...
     => ! [V1Phi__R] :
         ...
         => ! [V2i] :
             ...
             => ! [V3Psi] :
                 ...
                 => ! [V7t0] :
                      ( mem(V7t0,ty_2Enum_2Enum)
                     => ap(f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),V7t0) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0)) ) ) ) ) ) )).

fof(conj_thm_2EOmega__Automata_2ECO__BUECHI__WHEN__CLOSURE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3Psi] :
                         ...
                         => ! [V4phi] :
                             ...
                             => ! [V5t0] :
                                 ...
                                 => ! [V6c] :
                                      ( mem(V6c,A_27b)
                                     => ( p(ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),V4phi),V5t0))
                                      <=> ? [V12p1] :
                                                    ...
                                                    & ! [V15t] :
                                                       ...
                                                       => ( ( ~ p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0)))
                                                          ...
                                                          | ( p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0)))
                                                            ...
                                                            & p(ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0))),ap(V14q,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0)))))
                                                            & p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,V15t),ap(ap(c_2Earithmetic_2E_2B,V5t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))
                                                            & p(ap(V13p2,ap(ap(c_2Earithmetic_2E_2B,V15t),ap(ap(c_2Earithmetic_2E_2B,V5t0),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) )
                                                          | ( p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0)))
                                                            & p(ap(V13p2,ap(ap(c_2Earithmetic_2E_2B,V15t),V5t0)))
                                                    ...
                                                    & ? [V16t1] :
                                                        ...
                                                        & ! [V17t2] :
                                                           ...
                                                           => ( ~ p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,V16t1),ap(ap(c_2Earithmetic_2E_2B,V17t2),V5t0))))
                                                              | p(ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,V16t1),ap(ap(c_2Earithmetic_2E_2B,V17t2),V5t0)))),ap(V14q,ap(ap(c_2Earithmetic_2E_2B,V16t1),ap(ap(c_2Earithmetic_2E_2B,V17t2),V5t0)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
