...
fof(mem_c_2Emeasure_2Elambda__system,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Emeasure_2Elambda__system(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(arr(A_27a,bool),ty_2Erealax_2Ereal),arr(arr(A_27a,bool),bool)))) ) )).
...
fof(mem_c_2Emeasure_2Eouter__measure__space,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Emeasure_2Eouter__measure__space(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool)) ) )).
...
fof(ax_thm_2Emeasure_2Eouter__measure__space__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ALGEBRA,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
...
fof(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__DISJOINT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__POSITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1lam] :
              ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
             => ( p(ap(c_2Emeasure_2Epositive(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0g0)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27a),V0g0)),V1lam))))
               => p(ap(c_2Emeasure_2Epositive(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0g0)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(ap(c_2Emeasure_2Elambda__system(A_27a),V0g0),V1lam)),V1lam)))) ) ) ) ) )).
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__CARATHEODORY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0gsig] :
          ( mem(V0gsig,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1lam] :
              ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0gsig))
                  & p(ap(c_2Emeasure_2Eouter__measure__space(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0gsig)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27a),V0gsig)),V1lam)))) )
               => ! [V2f] :
                    ( mem(V2f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
                   => ( ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V2f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(ap(c_2Emeasure_2Elambda__system(A_27a),V0gsig),V1lam))))
                        & ! [V3m] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),ap(ap(c_2Emeasure_2Elambda__system(A_27a),V0gsig),V1lam)))
                        & p(ap(ap(c_2Eseq_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V1lam),V2f)),ap(V1lam,ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Emeasure_2ECARATHEODORY__LEMMA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0gsig] :
          ( mem(V0gsig,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1lam] :
             ...
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0gsig))
                  & p(ap(c_2Emeasure_2Eouter__measure__space(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0gsig)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27a),V0gsig)),V1lam)))) )
               => p(ap(c_2Emeasure_2Emeasure__space(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Espace(A_27a),V0gsig)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),bool)),ap(ap(c_2Emeasure_2Elambda__system(A_27a),V0gsig),V1lam)),V1lam)))) ) ) ) ) )).
