...
thf(conj_thm_2Eproduct_2ENPRODUCT__SING,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) @ V0f ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ V1x ) ) ) ) ) )).

thf(conj_thm_2Eproduct_2ENPRODUCT__SING__NUMSEG,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V0f ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
