...
fof(conj_thm_2Elebesgue_2Epos__simple__fn__integral__indicator,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__pos__simple__fn,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__indicator,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)) ) ) ) ) )).
