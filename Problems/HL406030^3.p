...
thf(thm_2Ewords_2Eword__ror,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__ror @ A_27a @ V0w @ V1n )
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ ( tyop_2Efcp_2Ecart @ $o @ A_27a )
        @ ^ [V2x: tyop_2Enum_2Enum] :
            ( c_2Ewords_2Eword__or @ A_27a @ ( c_2Ewords_2Eword__bits @ A_27a @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2x @ V0w ) @ ( c_2Ewords_2Eword__lsl @ A_27a @ ( c_2Ewords_2Eword__bits @ A_27a @ ( c_2Earithmetic_2E_2D @ V2x @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ c_2Enum_2E0 @ V0w ) @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ V2x ) ) )
        @ ( c_2Earithmetic_2EMOD @ V1n @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) )).
