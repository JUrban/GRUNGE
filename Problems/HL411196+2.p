...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__OPEN,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2u] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V1x)),V2u)))
              <=> ! [V3t] :
                    ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
                   => ( ( p(ap(c_2Ereal__topology_2EOpen,V3t))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V1x)),V3t)) )
                     => ? [V4s] :
                          ( mem(V4s,arr(ty_2Erealax_2Ereal,bool))
                          & p(ap(c_2Ereal__topology_2EOpen,V4s))
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V4s))
                          & ! [V5x_27] :
                              ( mem(V5x_27,ty_2Erealax_2Ereal)
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x_27),V4s))
                                  & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x_27),V2u)) )
                               => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V5x_27)),V3t)) ) ) ) ) ) ) ) ) ) )).
