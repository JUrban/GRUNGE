...
thf(f12972_0_2E0,type,(
    f12972_0_2E0: u )).

thf(f12972_0_2E1,type,(
    f12972_0_2E1: du > u )).

thf(f12972_0_2E2,type,(
    f12972_0_2E2: du > du > u )).
...
thf(c_2Ereal__topology_2Eis__interval_2E0,type,(
    c_2Ereal__topology_2Eis__interval_2E0: u )).

thf(c_2Ereal__topology_2Eis__interval_2E1,type,(
...
thf(mono_2Ef12972_0,type,(
    mono_2Ef12972_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Ereal__topology_2Eis__interval,type,(
    mono_2Ec_2Ereal__topology_2Eis__interval: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Ereal__topology_2Eis__interval,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Eis__interval @ V0s )
    <=> ! [V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ( ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V3x )
              ...
              | ( ( mono_2Ec_2Ereal_2Ereal__lte @ V2b @ V3x )
                & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V1a ) ) )
           => ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3x @ V0s ) ) ) ) )).

thf(thm_2Ereal__topology_2EIS__INTERVAL__EMPTY,axiom,(
    mono_2Ec_2Ereal__topology_2Eis__interval @ mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal )).

thf(thm_2Ereal__topology_2EIS__INTERVAL__SING,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2Eis__interval @ ( mono_2Ec_2Epred__set_2EINSERT_2Emono_2Etyop_2Erealax_2Ereal @ V0a @ mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EIS__INTERVAL__SCALING,axiom,(
    ! [V1c: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12972_0 @ V1c @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ V2x ) ) )).

thf(thm_2Ereal__topology_2EIS__INTERVAL__SCALING,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Eis__interval @ V0s )
     => ( mono_2Ec_2Ereal__topology_2Eis__interval @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12972_0 @ V1c ) @ V0s ) ) ) )).
