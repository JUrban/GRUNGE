...
fof(conj_thm_2Ebag_2EBAG__INSERT__CHOICE__REST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
...
fof(conj_thm_2Ebag_2ESUB__BAG__REST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Econtainer_2EBAG__TO__LIST__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0bag] :
...
fof(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
...
fof(conj_thm_2Econtainer_2EBAG__TO__LIST__INV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
