...
thf(conj_thm_2Ereal__topology_2ECLOSURE__INTERIOR,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Eclosure @ V0s )
        = ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V0s ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__INTERIORS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Efrontier @ V0s )
