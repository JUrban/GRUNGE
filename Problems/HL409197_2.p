...
tff(lmtp_f3189,type,(
    f3189: ( del * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3189,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V2z: tp__ty_2Erealax_2Ereal] : mem(f3189(A_27a,V1f,V0s,V2z),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3189,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V2z: tp__ty_2Erealax_2Ereal,V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3189(A_27a,V1f,V0s,V2z),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s)),ap(V1f,V3x)),inj__ty_2Erealax_2Ereal(V2z)) ) ) ) )).

tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IN__IF__ALT,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2z: tp__ty_2Erealax_2Ereal] :
              ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
             => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V1f),V0s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3189(A_27a,V1f,V0s,V2z)),V0s)) ) ) ) )).
