...
fof(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__UNTIL,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1309,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1309(V0a),V2t) = ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0a),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V2t) ) ) )).
...
fof(lameq_f1310,axiom,(
    ! [V0a] :
     ...
     => ! [V4t] :
          ( mem(V4t,ty_2Enum_2Enum)
         => ap(f1310(V0a),V4t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1311(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V4t)) ) ) )).

fof(lamtp_f1312,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V7t] :
             ...
             => ap(f1312(V0a,V1b),V7t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1296(V1b)),f1297(V0a,V1b)),V7t)) ) ) ) )).

fof(lamtp_f1314,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1314,axiom,(
    ! [V1b] :
     ...
     => ! [V11t] :
         ...
         => ap(f1314(V1b),V11t) = ap(c_2Ebool_2E_7E,ap(V1b,V11t)) ) ) )).
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V10t] :
             ...
             => ap(f1313(V1b,V0a),V10t) = ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1314(V1b)),f1315(V0a,V1b)),V10t) ) ) ) )).

fof(lamtp_f1317,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V14t] :
             ...
             => ap(f1317(V0a,V1b),V14t) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(V0a,V14t))),ap(c_2Ebool_2E_7E,ap(V1b,V14t))) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V13t] :
             ...
             => ap(f1316(V0a,V1b),V13t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1317(V0a,V1b)),f1318(V0a,V1b)),V13t)) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V18t] :
             ...
             => ap(f1321(V0a,V1b),V18t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V18t)),ap(c_2Ebool_2E_7E,ap(V1b,V18t))) ) ) ) )).

fof(lamtp_f1319,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V16t] :
             ...
             => ap(f1319(V1b,V0a),V16t) = ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1320(V1b)),f1321(V0a,V1b)),V16t) ) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V19t] :
             ...
             => ap(f1322(V0a,V1b),V19t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f1323(V0a)),V1b),V19t)) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
