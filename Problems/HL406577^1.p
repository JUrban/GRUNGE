...
thf(c_2Esptree_2EtoList_2E0,type,(
    c_2Esptree_2EtoList_2E0: u )).

thf(c_2Esptree_2EtoList_2E1,type,(
    c_2Esptree_2EtoList_2E1: du > u )).

thf(c_2Esptree_2EtoListA_2E0,type,(
    c_2Esptree_2EtoListA_2E0: u )).

thf(c_2Esptree_2EtoListA_2E2,type,(
    c_2Esptree_2EtoListA_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ec_2Esptree_2EtoList_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoList_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Esptree_2EtoList_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Esptree_2EtoListA_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoListA_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ c_2Esptree_2EtoListA_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Esptree_2EisEmpty__toListA,axiom,(
    ! [A_27a: d,V0t_2E0: u,V1acc_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Ewf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) )
     => ( ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 )
          = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ c_2Esptree_2ELN_2E0 ) )
      <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoListA_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1acc_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1acc_2E0 ) ) ) ) )).

thf(thm_2Esptree_2EtoList__def,axiom,(
    ! [A_27a: d,V0m_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoList_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0m_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoListA_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0m_2E0 ) ) ) ) )).

thf(thm_2Esptree_2EisEmpty__toList,conjecture,(
    ! [A_27a: d,V0t_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Ewf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) )
     => ( ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 )
          = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ c_2Esptree_2ELN_2E0 ) )
      <=> ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esptree_2EtoList_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) )
