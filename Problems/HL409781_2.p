...
tff(lamtp_f3286,axiom,(
    ! [A_27a: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => mem(f3286(A_27a,V0op,V1x),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f3286,axiom,(
    ! [A_27a: del,V0op: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2y: $i] :
              ( mem(V2y,A_27a)
             => ap(f3286(A_27a,V0op,V1x),V2y) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(V0op,V1x),V2y)),V2y)),ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(V0op,V2y),V1x)),V2y)) ) ) ) )).

tff(lmtp_f3285,type,(
    f3285: ( del * del * $i ) > $i )).

tff(lamtp_f3285,axiom,(
    ! [A_27a: del,A_27a: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => mem(f3285(A_27a,A_27a,V0op),arr(A_27a,bool)) ) )).
...
tff(lameq_f3285,axiom,(
    ! [A_27a: del,A_27a: del,V0op: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(f3285(A_27a,A_27a,V0op),V1x) = ap(c_2Ebool_2E_21(A_27a),f3286(A_27a,V0op,V1x)) ) ) )).

tff(ax_thm_2Eiterate_2Eneutral,axiom,(
    ! [A_27a: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ap(c_2Eiterate_2Eneutral(A_27a),V0op) = ap(c_2Emin_2E_40(A_27a),f3285(A_27a,A_27a,V0op)) ) )).

tff(conj_thm_2Eiterate_2ENEUTRAL__REAL__ADD,conjecture,(
