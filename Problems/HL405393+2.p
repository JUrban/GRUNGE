...
fof(conj_thm_2Einteger_2ETINT__ADD__SYM,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Einteger_2ETINT__LT__MUL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1y] :
          ( mem(V1y,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
...
fof(conj_thm_2Einteger_2EINT__LET__TRANS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__SUB__LT,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LTE__ADD,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LT__MUL2,conjecture,(
    ! [V0x1] :
