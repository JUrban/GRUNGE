...
fof(conj_thm_2Elebesgue_2EEXTREAL__SUP__SEQ,lemma,(
    ! [V0P] :
     ...
     => ( ( ? [V1x] :
          ...
          & ? [V2z] :
              ...
              & ! [V3x] :
                 ...
                 => ( p(ap(V0P,V3x))
                   => p(ap(ap(c_2Eextreal_2Eextreal__le,V3x),V2z)) ) ) ) )
       => ? [V4x] :
            ( mem(V4x,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
            & ! [V5n] :
                ( mem(V5n,ty_2Enum_2Enum)
               => p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),ap(V4x,V5n)),V0P)) )
            & ! [V6n] :
                ( mem(V6n,ty_2Enum_2Enum)
               => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V4x,V6n)),ap(V4x,ap(c_2Enum_2ESUC,V6n)))) )
            & ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V4x),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) = ap(c_2Eextreal_2Eextreal__sup,V0P) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(ty_2Eextreal_2Eextreal,bool))
