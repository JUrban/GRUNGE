...
fof(lamtp_f2965,axiom,(
    mem(f2965,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

fof(lameq_f2965,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(f2965,V0n) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V0n))) ) )).

fof(lamtp_f2966,axiom,(
    mem(f2966,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

fof(lameq_f2966,axiom,(
    ! [V1n] :
      ( mem(V1n,ty_2Enum_2Enum)
     => ap(f2966,V1n) = ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V1n))) ) )).

fof(conj_thm_2Etransc_2EEXP__FDIFF,lemma,(
    ap(c_2Epowser_2Ediffs,f2965) = f2966 )).

fof(conj_thm_2Etransc_2EDIFF__EXP,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
