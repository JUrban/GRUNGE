...
thf(arityeq1_2Emono_2Ef133_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f133_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f133_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef133_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f133_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f133_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ebool_2EEXISTS__UNIQUE__REFL,axiom,(
    ! [A_27a: d,V0a_2E0: u,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f133_0_2E2 @ ( s @ A_27a @ V0a_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V1x_2E0 )
        = ( s @ A_27a @ V0a_2E0 ) ) ) )).

thf(thm_2Ebool_2EEXISTS__UNIQUE__REFL,axiom,(
    ! [A_27a: d,V0a_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_3F_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f133_0_2E1 @ ( s @ A_27a @ V0a_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECARD__EQ__EUCLIDEAN,conjecture,(
    mono_2Ec_2Ecardinal_2Ecardeq_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Epred__set_2EUNIV_2Emono_2Etyop_2Erealax_2Ereal )).
