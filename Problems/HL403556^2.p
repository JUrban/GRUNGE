...
thf(conj_thm_2Ewellorder_2Eorderiso__unique,conjecture,(
     ...
     => ! [V1w1: $i] :
         ...
         => ! [V2w2: $i] :
             ...
             => ! [V3f2: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EBIJ @ A_27a @ A_27b ) @ V0f1 ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27a ) @ V1w1 ) ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27b ) @ V2w2 ) ) )
                      & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EBIJ @ A_27a @ A_27b ) @ V3f2 ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27a ) @ V1w1 ) ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27b ) @ V2w2 ) ) )
                      & ! [V4x: $i] :
                          ( ( mem @ V4x @ A_27a )
                         => ! [V5y: $i] :
                              ( ( mem @ V5y @ A_27a )
