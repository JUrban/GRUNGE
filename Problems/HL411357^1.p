...
thf(f13459_0_2E0,type,(
    f13459_0_2E0: u )).

thf(f13459_0_2E1,type,(
    f13459_0_2E1: du > u )).

thf(f13459_0_2E2,type,(
    f13459_0_2E2: du > du > u )).

thf(f13459_1_2E0,type,(
    f13459_1_2E0: u )).

thf(f13459_1_2E1,type,(
    f13459_1_2E1: du > u )).

thf(f13459_1_2E2,type,(
    f13459_1_2E2: du > du > u )).

thf(f13460_0_2E0,type,(
    f13460_0_2E0: u )).

thf(f13460_0_2E1,type,(
    f13460_0_2E1: du > u )).

thf(f13460_0_2E2,type,(
    f13460_0_2E2: du > du > u )).
...
thf(mono_2Ef13459_0,type,(
    mono_2Ef13459_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13459_1,type,(
    mono_2Ef13459_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13460_0,type,(
    mono_2Ef13460_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ecardinal_2ESURJECTIVE__IMAGE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ! [V1t_2E0: u] :
        ? [V2s_2E0: u] :
          ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) )
          = ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) )
    <=> ! [V3y_2E0: u] :
        ? [V4x_2E0: u] :
...
thf(def0_2Ethm_2Ereal__topology_2EOPEN__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13460_0 @ V0a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V2x ) ) )).

thf(thm_2Ereal__topology_2EOPEN__TRANSLATION__EQ,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2EOpen @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13460_0 @ V0a ) @ V1s ) )
...
thf(def0_2Ethm_2Ereal__topology_2EINTERIOR__TRANSLATION,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13459_1 @ V0a @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V3x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EINTERIOR__TRANSLATION,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13459_0 @ V0a @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V2x ) ) )).

thf(thm_2Ereal__topology_2EINTERIOR__TRANSLATION,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Einterior @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13459_0 @ V0a ) @ V1s ) )
      = ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13459_1 @ V0a ) @ ( mono_2Ec_2Ereal__topology_2Einterior @ V1s ) ) ) )).
