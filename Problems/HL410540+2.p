...
fof(conj_thm_2Ereal__topology_2EDIM__UNIV,lemma,(
...
fof(conj_thm_2Ereal__topology_2EDIM__SUBSET,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EDIM__SUBSET__UNIV,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
