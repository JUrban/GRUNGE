...
thf(conj_thm_2Ereal_2EREAL__NEG__EQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Etransc_2EACS__BOUNDS__LT,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Etransc_2ECOS__ACS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eacs @ ( ap @ c_2Etransc_2Ecos @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
        = V0x ) ) )).

thf(conj_thm_2Etransc_2ESIN__ACS__NZ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Esin @ ( ap @ c_2Etransc_2Eacs @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
       != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )).

thf(conj_thm_2Etransc_2EDIFF__ACS__LEMMA,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
        & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
