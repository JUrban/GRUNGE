...
tff(conj_thm_2Ereal__topology_2ELIM__WITHIN__OPEN,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
          <=> ! [V2x: tp__ty_2Erealax_2Ereal] :
               ...
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),V0f),ap(V0f,inj__ty_2Erealax_2Ereal(V2x))),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V2x))),V1s))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__AT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
