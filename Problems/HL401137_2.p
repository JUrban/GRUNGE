...
tff(lmtp_f212,type,(
    f212: ( del * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f212,axiom,(
    ! [A_27a: del,V0f1: $i] :
...
tff(lameq_f212,axiom,(
    ! [A_27a: del,V0f1: $i] :
     ...
     => ! [V2n: tp__ty_2Enum_2Enum,V1f2: $i] :
         ...
         => ! [V3a: $i] :
              ( mem(V3a,A_27a)
             => ap(f212(A_27a,V0f1,V2n,V1f2),V3a) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(c_2Eind__type_2ENUMLEFT,inj__ty_2Enum_2Enum(V2n))),ap(ap(V0f1,ap(c_2Eind__type_2ENUMRIGHT,inj__ty_2Enum_2Enum(V2n))),V3a)),ap(ap(V1f2,ap(c_2Eind__type_2ENUMRIGHT,inj__ty_2Enum_2Enum(V2n))),V3a)) ) ) ) )).

tff(lmtp_f211,type,(
    f211: ( del * $i * $i ) > $i )).

tff(lamtp_f211,axiom,(
    ! [A_27a: del,V0f1: $i] :
      ( mem(V0f1,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V1f2: $i] :
          ( mem(V1f2,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
...
tff(lameq_f211,axiom,(
    ! [A_27a: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
          ( mem(V1f2,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f211(A_27a,V0f1,V1f2),inj__ty_2Enum_2Enum(V2n)) = f212(A_27a,V0f1,V2n,V1f2) ) ) )).
...
tff(conj_thm_2Eind__type_2EINJP__INJ,conjecture,(
    ! [A_27a: del,V0f1: $i] :
      ( mem(V0f1,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V1f1_27: $i] :
