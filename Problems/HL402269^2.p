                            ...
                            @ ( ap @ ( ap @ ( c_2Elist_2EsplitAtPki @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ( arr @ A_27b @ bool ) @ ty_2Enum_2Enum ) @ V2P ) @ c_2Enum_2ESUC ) )
                              @ ( lam @ ( ty_2Elist_2Elist @ A_27b )
                                @ ^ [V6p: $i] :
                                    ( lam @ ( ty_2Elist_2Elist @ A_27b )
                                    @ ^ [V7s: $i] :
                                        ( ap @ ( ap @ V3k @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V4h ) @ V6p ) ) @ V7s ) ) ) )
                            @ V5t ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewhile_2EOLEAST__EQNS,lemma,(
...
thf(conj_thm_2Ewhile_2EOLEAST__EQ__NONE,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Ewhile_2EOLEAST__EQ__SOME,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ c_2Ewhile_2EOLEAST @ V0P ) )
...
thf(conj_thm_2Elist_2EsplitAtPki__EQN,conjecture,(
