...
fof(conj_thm_2EordinalNotation_2Eoless__antisym,lemma,(
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ( ( p(ap(c_2EordinalNotation_2Eis__ord,V0x))
           ...
           => ~ p(ap(ap(c_2EordinalNotation_2Eoless,V1y),V0x)) ) ) ) )).
...
fof(conj_thm_2EordinalNotation_2Eoless__imp__rank__leq,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2EordinalNotation_2Eosyntax)
     => ! [V1y] :
          ( mem(V1y,ty_2EordinalNotation_2Eosyntax)
         => ( ( p(ap(c_2EordinalNotation_2Eis__ord,V0x))
              & p(ap(c_2EordinalNotation_2Eis__ord,V1y))
              & p(ap(ap(c_2EordinalNotation_2Eoless,V0x),V1y)) )
           => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2EordinalNotation_2Erank,V0x)),ap(c_2EordinalNotation_2Erank,V1y))) ) ) ) )).
