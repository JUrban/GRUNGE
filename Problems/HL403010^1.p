...
thf(f3573_0_2E0,type,(
    f3573_0_2E0: u )).

thf(f3573_0_2E2,type,(
    f3573_0_2E2: du > du > u )).

thf(f3573_0_2E3,type,(
    f3573_0_2E3: du > du > du > u )).
...
thf(arityeq2_2Emono_2Ef3573_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f3573_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) ) @ f3573_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3573_0_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( f3573_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) ) @ f3573_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ X1_2E0 ) ) ) @ ( s @ A_27c @ X2_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E3_2Emono_2EA_27a_20mono_2EA_27c_20mono_2EA_27d,axiom,(
...
thf(arityeq3_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW_2E3_2Emono_2EA_27b_20mono_2EA_27c_20mono_2EA_27d,axiom,(
...
thf(arityeq2_2Emono_2Ec_2EpatternMatches_2EPMATCH__ROW__LIFT_2E2_2Emono_2EA_27d_20mono_2EA_27b_20mono_2EA_27a,axiom,(
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__ROW__LIFT__THM,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V3r_2E0: u,V4x_2E0: u] :
      ( ( s @ A_27b @ ( f3573_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V3r_2E0 ) @ ( s @ A_27c @ V4x_2E0 ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__ROW__LIFT__THM,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0f_2E0: u,V1p_2E0: u,V2g_2E0: u,V3r_2E0: u] :
      ...
      = ( s @ ( tyop_2Emin_2Efun @ A_27d @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( c_2EpatternMatches_2EPMATCH__ROW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ V1p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) @ V2g_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f3573_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V3r_2E0 ) ) ) ) ) ) )).
