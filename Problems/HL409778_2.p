...
tff(conj_thm_2Earithmetic_2EMOD__PLUS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Earithmetic_2EADD__MOD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)))
     => ( surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1a)),inj__ty_2Enum_2Enum(V3p))),inj__ty_2Enum_2Enum(V0n))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2b)),inj__ty_2Enum_2Enum(V3p))),inj__ty_2Enum_2Enum(V0n)))
      <=> surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1a)),inj__ty_2Enum_2Enum(V0n))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V2b)),inj__ty_2Enum_2Enum(V0n))) ) ) )).
...
tff(conj_thm_2Eiterate_2ENSUM__CLAUSES,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
...
tff(lmtp_f3351,type,(
    f3351: ( del * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3351,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1n: tp__ty_2Enum_2Enum] : mem(f3351(A_27a,V0f,V1n),arr(A_27a,ty_2Enum_2Enum)) ) )).

tff(lameq_f3351,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1n: tp__ty_2Enum_2Enum,V3i: $i] :
          ( mem(V3i,A_27a)
         => ap(f3351(A_27a,V0f,V1n),V3i) = ap(ap(c_2Earithmetic_2EMOD,ap(V0f,V3i)),inj__ty_2Enum_2Enum(V1n)) ) ) )).

tff(conj_thm_2Eiterate_2EMOD__NSUM__MOD,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1n: tp__ty_2Enum_2Enum,V2s: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
              & V1n != fo__c_2Enum_2E0 )
           => surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V0f)),inj__ty_2Enum_2Enum(V1n))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),f3351(A_27a,V0f,V1n))),inj__ty_2Enum_2Enum(V1n))) ) ) ) )).
