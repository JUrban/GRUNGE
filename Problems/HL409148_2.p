...
tff(tp_c_2Eieee_2Enum2roundmode,type,(
    c_2Eieee_2Enum2roundmode: $i )).

tff(mem_c_2Eieee_2Enum2roundmode,axiom,(
    mem(c_2Eieee_2Enum2roundmode,arr(ty_2Enum_2Enum,ty_2Eieee_2Eroundmode)) )).

tff(stp_fo_c_2Eieee_2Enum2roundmode,type,(
    fo__c_2Eieee_2Enum2roundmode: tp__ty_2Enum_2Enum > tp__ty_2Eieee_2Eroundmode )).

tff(stp_eq_fo_c_2Eieee_2Enum2roundmode,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] : inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2Enum2roundmode(X0)) = ap(c_2Eieee_2Enum2roundmode,inj__ty_2Enum_2Enum(X0)) )).
...
tff(ax_thm_2Eieee_2Eroundmode__BIJ,axiom,
    ( ! [V0a: tp__ty_2Eieee_2Eroundmode] : surj__ty_2Eieee_2Eroundmode(ap(c_2Eieee_2Enum2roundmode,ap(c_2Eieee_2Eroundmode2num,inj__ty_2Eieee_2Eroundmode(V0a)))) = V0a
    & ! [V1r: tp__ty_2Enum_2Enum] :
        ( p(ap(f3038,inj__ty_2Enum_2Enum(V1r)))
      <=> surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eroundmode2num,ap(c_2Eieee_2Enum2roundmode,inj__ty_2Enum_2Enum(V1r)))) = V1r ) )).

tff(conj_thm_2Eieee_2Enum2roundmode__11,conjecture,(
    ! [V0r: tp__ty_2Enum_2Enum,V1r_27: tp__ty_2Enum_2Enum] :
     ...
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1r_27)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
       => ( surj__ty_2Eieee_2Eroundmode(ap(c_2Eieee_2Enum2roundmode,inj__ty_2Enum_2Enum(V0r))) = surj__ty_2Eieee_2Eroundmode(ap(c_2Eieee_2Enum2roundmode,inj__ty_2Enum_2Enum(V1r_27)))
        <=> V0r = V1r_27 ) ) ) )).
