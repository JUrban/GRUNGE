...
fof(conj_thm_2Epred__set_2EUNION__IDEMPOT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Eiterate_2ESUP__SING,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ESETDIST__SINGS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0x),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1y),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1y)) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__SINGS,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0x),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1y),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1y)) ) ) )).
