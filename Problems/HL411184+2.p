...
fof(conj_thm_2Ereal__topology_2ELINEAR__UNIFORMLY__CONTINUOUS__ON,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
...
fof(lamtp_f3836,axiom,(
    ! [V1c] :
      ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2v] :
          ( mem(V2v,ty_2Erealax_2Ereal)
         => mem(f3836(V1c,V2v),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3836,axiom,(
    ! [V1c] :
      ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2v] :
          ( mem(V2v,ty_2Erealax_2Ereal)
         => ! [V3x] :
             ...
             => ap(f3836(V1c,V2v),V3x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,V3x)),V2v) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__VMUL,conjecture,(
    ! [V0s] :
     ...
     => ! [V1c] :
         ...
         => ! [V2v] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V1c),V0s))
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f3836(V1c,V2v)),V0s)) ) ) ) ) )).
