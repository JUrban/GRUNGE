...
tff(lamtp_f747,axiom,(
    ! [A_27c: del,A_27a: del,V4x: $i] :
      ( mem(V4x,A_27c)
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27c,arr(A_27a,bool)))
         => mem(f747(A_27c,A_27a,V4x,V1P),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f747,axiom,(
    ! [A_27c: del,A_27a: del,V4x: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V5y: $i] :
              ( mem(V5y,A_27a)
             => ap(f747(A_27c,A_27a,V4x,V1P),V5y) = ap(ap(V1P,V4x),V5y) ) ) ) )).

tff(lmtp_f746,type,(
    f746: ( del * del * $i ) > $i )).

tff(lamtp_f746,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
      ( mem(V1P,arr(A_27c,arr(A_27a,bool)))
     => mem(f746(A_27a,A_27c,V1P),arr(A_27c,bool)) ) )).
...
tff(lameq_f746,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
     ...
     => ! [V4x: $i] :
          ( mem(V4x,A_27c)
         => ap(f746(A_27a,A_27c,V1P),V4x) = ap(c_2Ebool_2E_3F_21(A_27a),f747(A_27c,A_27a,V4x,V1P)) ) ) )).

tff(lmtp_f748,type,(
    f748: ( del * del * $i * $i ) > $i )).

tff(lamtp_f748,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
      ( mem(V1P,arr(A_27c,arr(A_27a,bool)))
     => ! [V6y: $i] :
          ( mem(V6y,A_27a)
         => mem(f748(A_27a,A_27c,V1P,V6y),arr(A_27c,bool)) ) ) )).
...
tff(lameq_f748,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
     ...
     => ! [V6y: $i] :
         ...
         => ! [V7x: $i] :
              ( mem(V7x,A_27c)
             => ap(f748(A_27a,A_27c,V1P,V6y),V7x) = ap(ap(V1P,V7x),V6y) ) ) ) )).

tff(lmtp_f750,type,(
    f750: ( del * del * $i * $i ) > $i )).

tff(lamtp_f750,axiom,(
    ! [A_27c: del,A_27a: del,V8x: $i] :
      ( mem(V8x,A_27c)
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27c,arr(A_27a,bool)))
         => mem(f750(A_27c,A_27a,V8x,V1P),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f750,axiom,(
    ! [A_27c: del,A_27a: del,V8x: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V9y: $i] :
              ( mem(V9y,A_27a)
             => ap(f750(A_27c,A_27a,V8x,V1P),V9y) = ap(ap(V1P,V8x),V9y) ) ) ) )).

tff(lmtp_f749,type,(
    f749: ( del * del * $i ) > $i )).

tff(lamtp_f749,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
      ( mem(V1P,arr(A_27c,arr(A_27a,bool)))
     => mem(f749(A_27a,A_27c,V1P),arr(A_27c,bool)) ) )).
...
tff(lameq_f749,axiom,(
    ! [A_27a: del,A_27c: del,V1P: $i] :
     ...
     => ! [V8x: $i] :
          ( mem(V8x,A_27c)
         => ap(f749(A_27a,A_27c,V1P),V8x) = ap(c_2Ebool_2E_3F_21(A_27a),f750(A_27c,A_27a,V8x,V1P)) ) ) )).

tff(conj_thm_2EquantHeuristics_2EGUESS__RULES__EXISTS__UNIQUE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0i: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ( ( ! [V2y: $i] :
                  ( mem(V2y,A_27a)
                 => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27b,A_27b),V0i),f702(A_27a,A_27c,V1P,V2y))) )
             => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__POINT(A_27b,A_27b),V0i),f746(A_27a,A_27c,V1P))) )
            & ( ! [V6y: $i] :
                  ( mem(V6y,A_27a)
                 => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27b,A_27b),V0i),f748(A_27a,A_27c,V1P,V6y))) )
             => p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS__GAP(A_27b,A_27b),V0i),f749(A_27a,A_27c,V1P))) ) ) ) ) )).
