...
thf(conj_thm_2Ereal__topology_2ESERIES__TERMS__TOZERO,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
