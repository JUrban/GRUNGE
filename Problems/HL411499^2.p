...
thf(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__DIFFERENCES,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ESEPARATE__POINT__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESEPARATE__COMPACT__CLOSED,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
