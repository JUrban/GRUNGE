...
thf(tp_c_2Erealax_2Etreal__neg,type,(
    c_2Erealax_2Etreal__neg: $i )).

thf(mem_c_2Erealax_2Etreal__neg,axiom,(
...
thf(ax_thm_2Erealax_2Etreal__neg,axiom,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Etreal__neg @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Ehreal_2Ehreal @ ty_2Ehreal_2Ehreal ) @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) ) )
      = ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Ehreal_2Ehreal @ ty_2Ehreal_2Ehreal ) @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) ) ) )).
...
thf(conj_thm_2Erealax_2ETREAL__ADD__LINV,conjecture,(
    ! [V0x: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Etreal__eq @ ( ap @ ( ap @ c_2Erealax_2Etreal__add @ ( ap @ c_2Erealax_2Etreal__neg @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) ) @ c_2Erealax_2Etreal__0 ) ) )).
