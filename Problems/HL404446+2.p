...
fof(conj_thm_2Epred__set_2ECARD__UNION__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2EFINITE__FINITE__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(lamtp_f1875,axiom,(
    ! [A_27a,A_27b,A_27a,V1t] :
...
fof(conj_thm_2Ecardinal_2ECARD__BIGUNION__LE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2m] :
                     ...
                     => ! [V3n] :
                         ...
                         => ( ( p(ap(ap(c_2Ecardinal_2EHAS__SIZE(A_27a),V0s),V2m))
                           ...
                           => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Epred__set_2ECARD(A_27b),ap(c_2Epred__set_2EBIGUNION(A_27b),ap(c_2Epred__set_2EGSPEC(arr(A_27b,bool),arr(A_27b,bool)),f1875(A_27a,A_27b,A_27a,V1t,V0s))))),ap(ap(c_2Earithmetic_2E_2A,V2m),V3n))) ) ) ) ) ) ) ) )).
