...
thf(conj_thm_2Erich__list_2EELL__APPEND2,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l2: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l2 ) ) )
       => ! [V2l1: $i] :
           ...
           => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l1 ) @ V1l2 ) )
              = ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l2 ) ) ) ) ) )).
