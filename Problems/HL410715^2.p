...
thf(conj_thm_2Ereal__topology_2ELIMPT__OF__LIMPTS,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p
          @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V2y: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2y ) @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ V2y ) @ V1s ) ) ) ) ) )
       => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V1s ) ) ) ) )).
