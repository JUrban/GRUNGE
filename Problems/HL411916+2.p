...
fof(conj_thm_2Ereal__topology_2EISOMETRY__IMP__OPEN__MAP,conjecture,(
    ! [V0f] :
                      ...
                      & ! [V4x] :
                         ...
                         => ! [V5y] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V1s))
                               ...
                               => ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V4x)),ap(V0f,V5y))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x),V5y)) ) ) )
