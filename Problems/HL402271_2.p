...
tff(conj_thm_2Elist_2ETAKE__splitAtPki,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( mem(V1l,ty_2Elist_2Elist(A_27a))
     => ap(ap(c_2Elist_2ETAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l) = ap(ap(ap(c_2Elist_2EsplitAtPki(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ecombin_2EK(bool,bool)),ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)))),c_2Ecombin_2EK(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))),V1l) ) )).
