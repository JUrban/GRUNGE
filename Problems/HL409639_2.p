...
tff(lmtp_f3281,type,(
    f3281: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3281,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0m: tp__ty_2Enum_2Enum] : mem(f3281(V1n,V0m),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f3281,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0m: tp__ty_2Enum_2Enum,V2x: tp__ty_2Enum_2Enum] : ap(f3281(V1n,V0m),inj__ty_2Enum_2Enum(V2x)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V2x))),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2x)),inj__ty_2Enum_2Enum(V1n)))) )).

tff(ax_thm_2Eiterate_2Enumseg,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3281(V1n,V0m)) )).

tff(conj_thm_2Eiterate_2ENUMSEG__COMBINE__L,conjecture,(
