...
tff(conj_thm_2Ereal__topology_2ELINEAR__UNIFORMLY__CONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__VMUL,conjecture,(
    ! [V0s: $i] :
