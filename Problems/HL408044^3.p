...
thf(thm_2Ereal_2ESUM__POS,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
     ...
     => ! [V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
          ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Esum @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ V2m @ V3n ) @ V0f ) ) ) )).
...
thf(thm_2Eseq_2EPOS__SUMMABLE,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( ! [V1n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V1n ) )
