...
fof(lamtp_f3963,axiom,(
    mem(f3963,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

fof(lameq_f3963,axiom,(
    ! [V5x] :
      ( mem(V5x,ty_2Erealax_2Ereal)
     => ap(f3963,V5x) = ap(c_2Erealax_2Ereal__neg,V5x) ) )).

fof(conj_thm_2Ereal__topology_2EREFLECT__INTERVAL,conjecture,
    ( ! [V0a] :
    ...
    & ! [V3a] :
       ...
       => ! [V4b] :
           ...
           => ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3963),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3a),V4b))) = ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Erealax_2Ereal__neg,V4b)),ap(c_2Erealax_2Ereal__neg,V3a))) ) ) )).
