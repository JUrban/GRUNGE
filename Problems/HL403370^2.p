...
thf(conj_thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Ebag_2ESET__OF__BAG__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27b @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27b @ ty_2Enum_2Enum ) )
         => ( ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IMAGE @ A_27a @ A_27b ) @ V0f ) @ V1b ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27b @ A_27a ) @ V0f ) @ ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27b ) @ V1b ) ) ) ) ) )).
