...
tff(conj_thm_2Eseq_2ESEQ__LE__IMP__LIM__LE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ( ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(V2f,inj__ty_2Enum_2Enum(V3n))),inj__ty_2Erealax_2Ereal(V0x)))
