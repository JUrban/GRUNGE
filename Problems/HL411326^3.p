...
thf(thm_2Ereal__topology_2EFORALL__IN__CLOSURE,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
     ...
     => ! [V4x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
         => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V4x ) @ V2t ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__LE__ON__CLOSURE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2a: tyop_2Erealax_2Ereal] :
     ...
     => ! [V4x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
         => ( c_2Ereal_2Ereal__lte @ ( V0f @ V4x ) @ V2a ) ) ) )).
