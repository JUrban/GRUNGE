...
thf(conj_thm_2EOmega__Automata_2EBUECHI__PERIODIC__MODEL,conjecture,(
                ...
                <=> ? [V11x0: tp__ty_2Enum_2Enum,V12l: tp__ty_2Enum_2Enum,V13j: $i] :
                      ...
                      & ? [V14p: $i] :
                          ...
                          & ! [V18t1: tp__ty_2Enum_2Enum] :
                            ? [V19t2: tp__ty_2Enum_2Enum] :
                              ( p @ ( ap @ V2Accept @ ( ap @ V14p @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V18t1 ) ) @ ( inj__ty_2Enum_2Enum @ V19t2 ) ) ) ) ) ) ) ) ) ) ) ) )).
