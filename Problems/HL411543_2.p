...
tff(lmtp_f3969,type,(
    f3969: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3969,axiom,(
    ! [V5x: tp__ty_2Erealax_2Ereal,V2m: $i] :
      ( mem(V2m,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3969(V5x,V2m),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f3969,axiom,(
    ! [V5x: tp__ty_2Erealax_2Ereal,V2m: $i] :
      ( mem(V2m,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V6f: tp__ty_2Erealax_2Ereal] : ap(f3969(V5x,V2m),inj__ty_2Erealax_2Ereal(V6f)) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6f)),ap(ap(c_2Erealax_2Ereal__mul,ap(V2m,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V5x))) ) )).

tff(lmtp_f3968,type,(
    f3968: $i > $i )).

tff(lamtp_f3968,axiom,(
    ! [V2m: $i] :
      ( mem(V2m,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3968(V2m),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3968,axiom,(
    ! [V2m: $i] :
      ( mem(V2m,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3968(V2m),inj__ty_2Erealax_2Ereal(V5x)) = ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f3969(V5x,V2m)) ) )).

tff(conj_thm_2Ereal__topology_2EINTERVAL__IMAGE__STRETCH__INTERVAL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2m: $i] :
      ( mem(V2m,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ? [V3u: tp__ty_2Erealax_2Ereal,V4v: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3968(V2m)),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))) = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3u)),inj__ty_2Erealax_2Ereal(V4v))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).
