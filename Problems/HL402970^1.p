...
thf(f3527_0_2E0,type,(
    f3527_0_2E0: u )).

thf(f3527_0_2E1,type,(
    f3527_0_2E1: du > u )).

thf(f3527_0_2E2,type,(
    f3527_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef3527_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( f3527_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) ) @ f3527_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef3527_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3527_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X1_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Elist_2EAPPEND_2E2_2Emono_2Etyop_2Emin_2Efun_28A_27a_2Ctyop_2Eoption_2Eoption_28A_27b_29_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
...
thf(thm_2EquantHeuristics_2EIS__SOME__EQ__NOT__NONE,axiom,(
    ! [A_27a: d,V0x_2E0: u] :
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__GE,axiom,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V4r_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3527_0_2E2 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ V4r_2E0 ) ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__APPEND__GE,conjecture,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1rs1_2E0: u,V2rs2_2E0: u,V3i: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V1rs1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V2rs2_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3i ) ) ) ) )
      <=> ( ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EEVERY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ tyop_2Emin_2Ebool ) @ ( f3527_0_2E1 @ ( s @ A_27a @ V0v_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ V1rs1_2E0 ) ) ) ) )
