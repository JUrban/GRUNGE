...
tff(conj_thm_2Eiterate_2ESUM__CASES,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
         => ! [V2f: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V0s),f3382(A_27a,V2f,V1P,V3g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eiterate_2ESum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3342(A_27a,V1P,V0s))),V2f)),ap(ap(c_2Eiterate_2ESum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3343(A_27a,V1P,V0s))),V3g))) ) ) ) ) ) )).

tff(lmtp_f3383,type,(
    f3383: ( del * tp__ty_2Erealax_2Ereal * $i * $i ) > $i )).

tff(lamtp_f3383,axiom,(
    ! [A_27a: del,V0y: tp__ty_2Erealax_2Ereal,V3a: $i] :
      ( mem(V3a,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3383(A_27a,V0y,V3a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3383,axiom,(
    ! [A_27a: del,V0y: tp__ty_2Erealax_2Ereal,V3a: $i] :
      ( mem(V3a,A_27a)
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3383(A_27a,V0y,V3a,V1f),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(A_27a),V4x),V3a)),inj__ty_2Erealax_2Ereal(V0y)),ap(V1f,V4x)) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__CASES__1,conjecture,(
     ...
     => ! [V2s: $i] :
         ...
         => ! [V3a: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
               ...
               => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3383(A_27a,V0y,V3a,V1f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1f)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0y)),ap(V1f,V3a)))) ) ) ) ) )).
