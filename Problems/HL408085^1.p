...
thf(f9517_0_2E0,type,(
    f9517_0_2E0: u )).

thf(f9517_0_2E1,type,(
    f9517_0_2E1: du > u )).

thf(f9517_0_2E2,type,(
    f9517_0_2E2: du > du > u )).

thf(f9535_0_2E0,type,(
    f9535_0_2E0: u )).

thf(f9535_0_2E1,type,(
    f9535_0_2E1: du > u )).

thf(f9535_0_2E2,type,(
    f9535_0_2E2: du > du > u )).
...
thf(mono_2Ef9517_0,type,(
    mono_2Ef9517_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9535_0,type,(
    mono_2Ef9535_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Elim_2ELIM__CONST,axiom,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9517_0 @ V0k @ V2x )
      = V0k ) )).

thf(thm_2Elim_2ELIM__CONST,axiom,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Etends__real__real @ ( mono_2Ef9517_0 @ V0k ) @ V0k @ V1x ) )).
...
thf(def0_2Ethm_2Elim_2ECONT__CONST,axiom,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9535_0 @ V0k @ V2x )
      = V0k ) )).

thf(thm_2Elim_2ECONT__CONST,conjecture,(
    ! [V0k: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Econtl @ ( mono_2Ef9535_0 @ V0k ) @ V1x ) )).
