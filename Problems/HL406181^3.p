...
thf(thm_2Ewords_2Eword__concat__0,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0x: tyop_2Enum_2Enum] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) )
        & ( c_2Eprim__rec_2E_3C @ V0x @ ( c_2Ewords_2Edimword @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) )
     => ( ( c_2Ewords_2Eword__concat @ A_27a @ A_27b @ A_27c @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ ( c_2Ewords_2En2w @ A_27b @ V0x ) )
        = ( c_2Ewords_2En2w @ A_27c @ V0x ) ) ) )).

thf(thm_2Ewords_2Eword__concat__0__eq,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27b,V1y: tyop_2Enum_2Enum] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ ( c_2Epred__set_2EUNIV @ A_27a ) )
        ...
        & ( c_2Eprim__rec_2E_3C @ V1y @ ( c_2Ewords_2Edimword @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) )
     => ( ( ( c_2Ewords_2Eword__concat @ A_27a @ A_27b @ A_27c @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V0x )
          = ( c_2Ewords_2En2w @ A_27c @ V1y ) )
      <=> ( V0x
          = ( c_2Ewords_2En2w @ A_27b @ V1y ) ) ) ) )).
