...
thf(f2341_0_2E0,type,(
    f2341_0_2E0: u )).

thf(f2341_0_2E1,type,(
    f2341_0_2E1: du > u )).
...
thf(mono_2Ef2341_0,type,(
    mono_2Ef2341_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Elist_2ETAKE__def,axiom,(
...
thf(thm_2Elist_2ETAKE__def,axiom,(
    ! [A_27a: d] :
      ...
      & ! [V1n: mono_2Etyop_2Enum_2Enum,V2x_2E0: u,V3xs_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2341_0 @ V1n ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3xs_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2Erich__list_2Etake__drop__partition,conjecture,(
