...
thf(f9886_0_2E0,type,(
    f9886_0_2E0: u )).

thf(f9886_0_2E2,type,(
    f9886_0_2E2: du > du > u )).

thf(f9886_0_2E3,type,(
    f9886_0_2E3: du > du > du > u )).

thf(f9886_1_2E0,type,(
    f9886_1_2E0: u )).

thf(f9886_1_2E1,type,(
    f9886_1_2E1: du > u )).

thf(f9888_0_2E0,type,(
    f9888_0_2E0: u )).

thf(f9888_0_2E2,type,(
    f9888_0_2E2: du > du > u )).

thf(f9888_0_2E3,type,(
    f9888_0_2E3: du > du > du > u )).

thf(f9888_1_2E0,type,(
    f9888_1_2E0: u )).

thf(f9888_1_2E1,type,(
    f9888_1_2E1: du > u )).

thf(f9889_0_2E0,type,(
    f9889_0_2E0: u )).

thf(f9889_0_2E2,type,(
    f9889_0_2E2: du > du > u )).

thf(f9889_0_2E3,type,(
    f9889_0_2E3: du > du > du > u )).

thf(f9889_1_2E0,type,(
    f9889_1_2E0: u )).

thf(f9889_1_2E1,type,(
    f9889_1_2E1: du > u )).
...
thf(mono_2Ef9886_0,type,(
    mono_2Ef9886_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9886_1,type,(
    mono_2Ef9886_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef9888_0,type,(
    mono_2Ef9888_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9888_1,type,(
    mono_2Ef9888_1: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef9889_0,type,(
    mono_2Ef9889_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9889_1,type,(
    mono_2Ef9889_1: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Etransc_2EDIVISION__0,axiom,(
    ! [V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9886_1 @ V2n )
    <=> ( V2n = mono_2Ec_2Enum_2E0 ) ) )).

thf(def1_2Ethm_2Etransc_2EDIVISION__0,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9886_0 @ V0a @ V1b @ V2n )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9886_1 @ V2n ) @ V0a @ V1b ) ) )).

thf(thm_2Etransc_2EDIVISION__0,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( V0a = V1b )
     => ( ( mono_2Ec_2Etransc_2Edsize @ ( mono_2Ef9886_0 @ V0a @ V1b ) )
        = mono_2Ec_2Enum_2E0 ) ) )).

thf(def0_2Ethm_2Etransc_2EDIVISION__1,axiom,(
    ! [V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9888_1 @ V2n )
    <=> ( V2n = mono_2Ec_2Enum_2E0 ) ) )).

thf(def1_2Ethm_2Etransc_2EDIVISION__1,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9888_0 @ V0a @ V1b @ V2n )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9888_1 @ V2n ) @ V0a @ V1b ) ) )).

thf(thm_2Etransc_2EDIVISION__1,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Erealax_2Ereal__lt @ V0a @ V1b )
     => ( ( mono_2Ec_2Etransc_2Edsize @ ( mono_2Ef9888_0 @ V0a @ V1b ) )
        = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )).

thf(def0_2Ethm_2Etransc_2EDIVISION__SINGLE,axiom,(
    ! [V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9889_1 @ V2n )
    <=> ( V2n = mono_2Ec_2Enum_2E0 ) ) )).

thf(def1_2Ethm_2Etransc_2EDIVISION__SINGLE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9889_0 @ V0a @ V1b @ V2n )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef9889_1 @ V2n ) @ V0a @ V1b ) ) )).

thf(thm_2Etransc_2EDIVISION__SINGLE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ V0a @ V1b )
     => ( mono_2Ec_2Etransc_2Edivision @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef9889_0 @ V0a @ V1b ) ) ) )).

thf(thm_2Etransc_2EDIVISION__APPEND,axiom,(
    ! [V0g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal,V3c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ? [V4D1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V5p1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
        ...
        & ? [V6D2: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V7p2: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
