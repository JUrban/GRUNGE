...
thf(conj_thm_2Ereal__topology_2ESPAN__EMPTY,lemma,
...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__EMPTY,lemma,(
    p @ ( ap @ c_2Ereal__topology_2Eindependent @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )).

thf(conj_thm_2Ereal__topology_2EINDEPENDENT__SING,lemma,(
...
thf(ax_thm_2Ereal__topology_2Edim,axiom,(
    ! [V0v: $i] :
      ( ( mem @ V0v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal__topology_2Edim @ V0v ) )
...
thf(conj_thm_2Ereal__topology_2EDIM__SUBSTANDARD,conjecture,
    ( ( surj__ty_2Enum_2Enum
      @ ( ap @ c_2Ereal__topology_2Edim
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V0x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V0x ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V0x ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )
    = fo__c_2Enum_2E0 )).
