...
thf(conj_thm_2ETemporal__Logic_2ESWHEN__AS__WHEN,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( ap @ ( ap @ c_2ETemporal__Logic_2ESWHEN @ V0a ) @ V1b )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V2t0: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EWHEN @ V0a ) @ V1b ) @ V2t0 ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2EEVENTUAL @ V1b ) @ V2t0 ) ) ) ) ) ) )).
