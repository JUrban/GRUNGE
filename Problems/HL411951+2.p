...
fof(conj_thm_2Ereal__topology_2EOPEN__IN__DELETE,lemma,(
    ! [V0u] :
...
fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__IN,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__DELETE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
           => p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),ap(ap(c_2Epred__set_2EDELETE(ty_2Erealax_2Ereal),V0s),V1a))) ) ) ) )).
