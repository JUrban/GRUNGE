...
tff(lmtp_f2846,type,(
    f2846: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2846,axiom,(
    ! [A_27a: del,V2x: $i] :
      ( mem(V2x,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1k: tp__ty_2Erealax_2Ereal] : mem(f2846(A_27a,V2x,V1k),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2846,axiom,(
    ! [A_27a: del,V2x: $i] :
      ( mem(V2x,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1k: tp__ty_2Erealax_2Ereal,V3n: $i] :
          ( mem(V3n,A_27a)
         => ap(f2846(A_27a,V2x,V1k),V3n) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1k)),ap(V2x,V3n)) ) ) )).

tff(conj_thm_2Enets_2ENET__NULL__CMUL,conjecture,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,arr(A_27a,bool)))
     => ! [V1k: tp__ty_2Erealax_2Ereal,V2x: $i] :
          ( mem(V2x,arr(A_27a,ty_2Erealax_2Ereal))
         => ( p(ap(ap(ap(c_2Enets_2Etends(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Epair_2E_2C(ty_2Etopology_2Etopology(ty_2Erealax_2Ereal),ty_2Etopology_2Etopology(ty_2Erealax_2Ereal)),ap(c_2Emetric_2Emtop(ty_2Erealax_2Ereal),c_2Emetric_2Emr1)),V0g)))
           => p(ap(ap(ap(c_2Enets_2Etends(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f2846(A_27a,V2x,V1k)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Epair_2E_2C(ty_2Etopology_2Etopology(ty_2Erealax_2Ereal),ty_2Etopology_2Etopology(ty_2Erealax_2Ereal)),ap(c_2Emetric_2Emtop(ty_2Erealax_2Ereal),c_2Emetric_2Emr1)),V0g))) ) ) ) )).
