    ...
    ! [A_27a: del,V0w: $i] :
     ...
     => ( ( ap @ ( c_2Ewords_2Eword__1comp @ A_27a ) @ V0w )
        = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1i: $i] :
                ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ V1i ) ) ) ) ) ) )).
    ...
    ! [A_27a: del,V0w: $i] :
     ...
     => ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w )
        = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1i: $i] :
                ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V1i ) ) ) ) ) ) )).
    ...
    ! [A_27a: del,V0w: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ...
          = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V2i: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2i ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2i ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V2i ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) ) ) )).
    ...
    ! [A_27a: del,V0w: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ...
          = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V2i: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2i ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0w ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2i ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2EWORD__NEG__1__T,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0i ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )
...
thf(conj_thm_2Ewords_2Eword__reverse__thm,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1v: $i] :
          ( ( mem @ V1v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ! [V2n: tp__ty_2Enum_2Enum] :
              ( ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) )
                = V0w )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsl @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27a ) @ V0w ) @ V1v ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V1v ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27a ) @ V0w ) @ V1v ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V1v ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__xor @ A_27a ) @ V0w ) @ V1v ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__xor @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V1v ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__1comp @ A_27a ) @ V0w ) )
                = ( ap @ ( c_2Ewords_2Eword__1comp @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ V0w ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                = ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
              & ( ( ap @ ( c_2Ewords_2Eword__reverse @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
