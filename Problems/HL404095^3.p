...
thf(thm_2EPast__Temporal__Logic_2ESEPARATE__NEXT__THM,conjecture,(
    ! [V0c: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V3t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1b @ V3t ) ) )
        = ( ^ [V4t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V1b @ V4t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2a @ V4t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V5t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V1b @ V5t ) ) )
        = ( ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V1b @ V6t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2a @ V6t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V7t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b @ V0c @ V7t ) ) )
        = ( ^ [V8t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2ETemporal__Logic_2ENEXT
                @ ^ [V9t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V2a @ V9t ) @ ( V0c @ V9t ) )
                @ V8t )
              @ ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b @ V0c @ V8t )
                @ ( c_2ETemporal__Logic_2ENEXT
                  @ ^ [V10t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2a @ V10t ) @ ( V1b @ V10t ) )
                  @ V8t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V11t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V2a @ V11t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1b @ V0c @ V11t ) ) )
        = ( ^ [V12t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2ETemporal__Logic_2ENEXT
                @ ^ [V13t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_2F_5C @ ( V2a @ V13t ) @ ( c_2Ebool_2E_2F_5C @ ( V1b @ V13t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V13t ) ) ) )
                @ V12t )
              @ ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1b @ V0c @ V12t )
                @ ( c_2ETemporal__Logic_2ENEXT
                  @ ^ [V14t: tyop_2Enum_2Enum] :
                      ( c_2Ebool_2E_2F_5C @ ( V2a @ V14t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V14t ) ) )
                  @ V12t ) ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V15t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V15t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1b @ V15t ) ) )
        = ( ^ [V16t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V16t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2a @ V16t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V17t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V17t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V1b @ V17t ) ) )
        = ( ^ [V18t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1b @ V18t ) @ ( c_2ETemporal__Logic_2ENEXT @ V2a @ V18t ) ) ) )
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V19t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V19t ) @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V1b @ V0c @ V19t ) ) )
        = ( ^ [V20t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F
              @ ( c_2ETemporal__Logic_2ENEXT
                @ ^ [V21t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( V2a @ V21t ) @ ( V0c @ V21t ) )
                @ V20t )
      ...
      & ( ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V22t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V2a @ V22t ) @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ V1b @ V0c @ V22t ) ) )
        = ( ^ [V23t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C
              @ ( c_2ETemporal__Logic_2ENEXT
                @ ^ [V24t: tyop_2Enum_2Enum] :
                    ( c_2Ebool_2E_5C_2F @ ( V2a @ V24t ) @ ( c_2Ebool_2E_7E @ ( V0c @ V24t ) ) )
                @ V23t )
