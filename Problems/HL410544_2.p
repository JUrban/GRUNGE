...
tff(lamtp_f3669,axiom,(
    ! [A_27a: del,V1u: $i] :
      ( mem(V1u,arr(A_27a,bool))
     => ! [V0top: $i] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
         => mem(f3669(A_27a,V1u,V0top),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).
    ...
    ! [A_27a: del,V1u: $i] :
     ...
     => ! [V0top: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ap(f3669(A_27a,V1u,V0top),V2s) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EINTER(A_27a),V2s),V1u)),ap(ap(c_2Etopology_2Eopen__in(A_27a),V0top),V2s)) ) ) ) )).
...
tff(ax_thm_2Ereal__topology_2Esubtopology,axiom,(
    ! [A_27a: del,V0top: $i] :
     ...
     => ! [V1u: $i] :
          ( mem(V1u,arr(A_27a,bool))
         => ap(ap(c_2Ereal__topology_2Esubtopology(A_27a),V0top),V1u) = ap(c_2Etopology_2Etopology(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f3669(A_27a,V1u,V0top))) ) ) )).

tff(conj_thm_2Ereal__topology_2EISTOPLOGY__SUBTOPOLOGY,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ! [V1u: $i] :
          ( mem(V1u,arr(A_27a,bool))
         => p(ap(c_2Etopology_2Eistopology(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f3669(A_27a,V1u,V0top)))) ) ) )).

tff(conj_thm_2Ereal__topology_2EOPEN__IN__SUBTOPOLOGY,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ! [V1u: $i] :
          ( mem(V1u,arr(A_27a,bool))
