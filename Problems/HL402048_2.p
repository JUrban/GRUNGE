...
tff(conj_thm_2Epred__set_2EPAIR__IN__GSPEC__1,lemma,(
...
tff(lamtp_f355,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => mem(f355(A_27a,A_27a,V1s,V2x),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) )).
...
tff(lameq_f355,axiom,(
    ! [A_27a: del,A_27a: del,V1s: $i] :
     ...
     => ! [V2x: $i] :
         ...
         => ! [V3y: $i] :
              ( mem(V3y,A_27a)
             => ap(f355(A_27a,A_27a,V1s,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3y),V2x)),ap(ap(c_2Ebool_2EIN(A_27a),V3y),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),c_2Epred__set_2EEMPTY(A_27a))))) ) ) ) )).

tff(conj_thm_2Eset__relation_2Eextend__linear__order,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2x: $i] :
             ...
             => ( ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                  & p(ap(ap(c_2Eset__relation_2Elinear__order(A_27a),V0r),V1s)) )
               => p(ap(ap(c_2Eset__relation_2Elinear__order(A_27a),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),V0r),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),f355(A_27a,A_27a,V1s,V2x)))),ap(ap(c_2Epred__set_2EUNION(A_27a),V1s),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),c_2Epred__set_2EEMPTY(A_27a))))) ) ) ) ) )).
