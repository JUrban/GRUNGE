...
tff(conj_thm_2Epred__set_2EDELETE__COMM,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Epred__set_2ESING__DELETE,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
...
tff(mem_c_2Eiterate_2EFINREC,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Eiterate_2EFINREC(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,A_27b)),arr(A_27b,arr(arr(A_27a,bool),arr(A_27b,arr(ty_2Enum_2Enum,bool)))))) )).
      ...
      ( ! [V0f: $i] :
         ...
         => ! [V1b: $i] :
             ...
             => ! [V2s: $i] :
                 ...
                 => ! [V3a: $i] :
                      ( mem(V3a,A_27b)
                     => ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V2s),V3a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
             ...
             => ! [V6s: $i] :
                 ...
                 => ! [V7a: $i] :
                     ...
                     => ! [V8n: tp__ty_2Enum_2Enum] :
                          ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V4f),V5b),V6s),V7a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V8n))))
                        <=> ? [V9x: $i] :
                              ( mem(V9x,A_27a)
                              & ? [V10c: $i] :
                                  ( mem(V10c,A_27b)
                                  & p(ap(ap(c_2Ebool_2EIN(A_27a),V9x),V6s))
                                  & p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V4f),V5b),ap(ap(c_2Epred__set_2EDELETE(A_27a),V6s),V9x)),V10c),inj__ty_2Enum_2Enum(V8n)))
                                  & V7a = ap(ap(V4f,V9x),V10c) ) ) ) ) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EFINREC__1__LEMMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3a: $i] :
                  ( mem(V3a,A_27b)
                 => ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V2s),V3a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))
                  <=> ? [V4x: $i] :
                        ( mem(V4x,A_27a)
                        & V2s = ap(ap(c_2Epred__set_2EINSERT(A_27a),V4x),c_2Epred__set_2EEMPTY(A_27a))
                        & V3a = ap(ap(V0f,V4x),V1b) ) ) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EFINREC__SUC__LEMMA,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
     => ! [V1b: $i] :
          ( mem(V1b,A_27b)
         => ( ! [V2x: $i] :
           ...
           => ! [V5n: tp__ty_2Enum_2Enum,V6s: $i] :
               ...
               => ! [V7z: $i] :
                    ( mem(V7z,A_27b)
                   => ( p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),V6s),V7z),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V5n))))
                     => ! [V8x: $i] :
                          ( mem(V8x,A_27a)
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V8x),V6s))
                           => ? [V9w: $i] :
                                ( mem(V9w,A_27b)
                                & p(ap(ap(ap(ap(ap(c_2Eiterate_2EFINREC(A_27a,A_27a),V0f),V1b),ap(ap(c_2Epred__set_2EDELETE(A_27a),V6s),V8x)),V9w),inj__ty_2Enum_2Enum(V5n)))
