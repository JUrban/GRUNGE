...
fof(conj_thm_2Epred__set_2EUNIV__FUNSET__UNIV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(A_27b)) = c_2Epred__set_2EUNIV(arr(A_27a,A_27b)) ) ) )).
