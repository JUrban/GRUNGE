...
fof(conj_thm_2Epred__set_2EINTER__ASSOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECBALL__MIN__INTER,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1d] :
...
fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER__CBALL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
      ...
      <=> ! [V1x] :
           ...
           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
             => ? [V2e] :
                  ...
                  & p(ap(c_2Ereal__topology_2EClosed,ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),V2e))),V0s))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__INTER__CBALLS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
      <=> ! [V1x] :
           ...
           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
             => ? [V2e] :
                  ...
                  & ! [V3d] :
                     ...
                     => ( p(ap(ap(c_2Ereal_2Ereal__lte,V3d),V2e))
                       => p(ap(c_2Ereal__topology_2EClosed,ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),V3d))),V0s))) ) ) ) ) ) ) ) )).
