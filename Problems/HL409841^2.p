...
thf(conj_thm_2Eiterate_2EITERATE__BIJECTION,lemma,(
                           ...
                           => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5y ) @ V3s ) )
                             => ( p
                                @ ( ap @ ( c_2Ebool_2E_3F_21 @ A_27a )
                                  @ ( lam @ A_27a
                                    @ ^ [V6x: $i] :
                                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V6x ) @ V3s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ V2p @ V6x ) ) @ V5y ) ) ) ) ) ) ) )
...
thf(conj_thm_2Eiterate_2ESUM__BIJECTION,conjecture,(
    ! [A_27a: del,V0f: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4y ) @ V2s ) )
                       => ( p
                          @ ( ap @ ( c_2Ebool_2E_3F_21 @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V5x: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ V1p @ V5x ) ) @ V4y ) ) ) ) ) ) ) )
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V2s ) @ V0f ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V2s ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ ty_2Erealax_2Ereal @ A_27a ) @ V0f ) @ V1p ) ) ) ) ) ) ) ) )).
