...
tff(conj_thm_2Efcp_2ELENGTH__V2L,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Efcp_2EV2L(A_27a,A_27a),V0v))) = surj__ty_2Enum_2Enum(ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))) ) )).
