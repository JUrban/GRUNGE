...
tff(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] : p(ap(c_2Ereal__topology_2EClosed,ap(V0s,inj__ty_2Enum_2Enum(V1n))))
          & ! [V2n: tp__ty_2Enum_2Enum] : ap(V0s,inj__ty_2Enum_2Enum(V2n)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
       ...
       => ? [V9a: tp__ty_2Erealax_2Ereal] :
          ! [V10n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9a)),ap(V0s,inj__ty_2Enum_2Enum(V10n)))) ) ) )).

tff(lmtp_f3819,type,(
    f3819: ( $i * $i ) > $i )).

tff(lamtp_f3819,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V10t: $i] :
          ( mem(V10t,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3819(V0s,V10t),arr(ty_2Enum_2Enum,bool)) ) ) )).

tff(lameq_f3819,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V10t: $i] :
          ( mem(V10t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V11n: tp__ty_2Enum_2Enum] : ap(f3819(V0s,V10t),inj__ty_2Enum_2Enum(V11n)) = ap(ap(c_2Emin_2E_3D(arr(ty_2Erealax_2Ereal,bool)),V10t),ap(V0s,inj__ty_2Enum_2Enum(V11n))) ) ) )).

tff(lmtp_f3818,type,(
    f3818: $i > $i )).

tff(lamtp_f3818,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => mem(f3818(V0s),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

tff(lameq_f3818,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V10t: $i] :
          ( mem(V10t,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3818(V0s),V10t) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V10t),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f3819(V0s,V10t))) ) ) )).

tff(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST__SING,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] : p(ap(c_2Ereal__topology_2EClosed,ap(V0s,inj__ty_2Enum_2Enum(V1n))))
          & ! [V2n: tp__ty_2Enum_2Enum] : ap(V0s,inj__ty_2Enum_2Enum(V2n)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
             ...
             => ? [V6n: tp__ty_2Enum_2Enum] :
                ! [V7x: tp__ty_2Erealax_2Ereal,V8y: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(V0s,inj__ty_2Enum_2Enum(V6n))))
                    & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8y)),ap(V0s,inj__ty_2Enum_2Enum(V6n)))) )
                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),inj__ty_2Erealax_2Ereal(V8y)))),inj__ty_2Erealax_2Ereal(V5e))) ) ) )
       => ? [V9a: tp__ty_2Erealax_2Ereal] : ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3818(V0s))) = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V9a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) )).
