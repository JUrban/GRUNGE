...
thf(thm_2Ereal__topology_2ESERIES__SUBSET,axiom,(
...
thf(thm_2Ereal__topology_2ESUMMABLE__SUBSET,conjecture,(
    ! [V0x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2t: tyop_2Enum_2Enum > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ tyop_2Enum_2Enum @ V1s @ V2t )
        & ( c_2Ereal__topology_2Esummable @ V2t
          @ ^ [V3i: tyop_2Enum_2Enum] :
              ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V1s ) @ ( V0x @ V3i ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( c_2Ereal__topology_2Esummable @ V1s @ V0x ) ) )).
