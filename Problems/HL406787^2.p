...
thf(conj_thm_2Epatricia_2EPERM__NOT__REMOVE,lemma,(
    ! [A_27a: del,V0t: $i] :
      ( ( mem @ V0t @ ( ty_2Epatricia_2Eptree @ A_27a ) )
...
thf(conj_thm_2Epatricia_2EFILTER__NONE,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
...
thf(conj_thm_2Epatricia_2EPERM__REMOVE,lemma,(
    ! [A_27a: del,V0t: $i] :
      ( ( mem @ V0t @ ( ty_2Epatricia_2Eptree @ A_27a ) )
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( ( ( p @ ( ap @ ( c_2Epatricia_2EIS__PTREE @ A_27a ) @ V0t ) )
...
thf(conj_thm_2Epatricia_2ESIZE__REMOVE,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( ( mem @ V0t @ ( ty_2Epatricia_2Eptree @ A_27a ) )
     => ! [V1k: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( c_2Epatricia_2EIS__PTREE @ A_27a ) @ V0t ) )
