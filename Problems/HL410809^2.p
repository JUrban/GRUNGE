...
thf(conj_thm_2Ereal__topology_2ECLOSURE__SUBSET__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__SUBSET__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__SUBSET__EQ,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) @ V0s ) )
      <=> ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) ) ) ) )).
