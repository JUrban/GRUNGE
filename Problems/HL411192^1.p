...
thf(f13907_0_2E0,type,(
    f13907_0_2E0: u )).

thf(f13907_0_2E1,type,(
    f13907_0_2E1: du > u )).
...
thf(mono_2Ef13907_0,type,(
    mono_2Ef13907_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ID,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13907_0 @ V1x )
      = V1x ) )).

thf(thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ID,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( mono_2Ec_2Ereal__topology_2Euniformly__continuous__on @ mono_2Ef13907_0 @ V0s ) )).
