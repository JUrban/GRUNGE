...
thf(f12742_0_2E0,type,(
    f12742_0_2E0: u )).

thf(f12742_0_2E1,type,(
    f12742_0_2E1: du > u )).

thf(f12742_1_2E0,type,(
    f12742_1_2E0: u )).

thf(f12742_1_2E1,type,(
    f12742_1_2E1: du > u )).
...
thf(mono_2Ef12742_0,type,(
    mono_2Ef12742_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12742_1,type,(
    mono_2Ef12742_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ereal__topology_2ECLOSURE__INJECTIVE__LINEAR__IMAGE,axiom,(
      ...
      ( ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
        & ! [V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0f @ V2x )
              = ( V0f @ V3y ) )
           => ( V2x = V3y ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Eclosure @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V1s ) )
        = ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ ( mono_2Ec_2Ereal__topology_2Eclosure @ V1s ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSURE__NEGATIONS,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12742_1 @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ V2x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECLOSURE__NEGATIONS,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12742_0 @ V1x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ V1x ) ) )).

thf(thm_2Ereal__topology_2ECLOSURE__NEGATIONS,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Eclosure @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef12742_0 @ V0s ) )
      = ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef12742_1 @ ( mono_2Ec_2Ereal__topology_2Eclosure @ V0s ) ) ) )).
