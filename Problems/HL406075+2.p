...
fof(conj_thm_2Earithmetic_2ENOT__GREATER__EQ,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(lamtp_f2209,axiom,(
    mem(f2209,arr(bool,arr(bool,bool))) )).

fof(lameq_f2209,axiom,(
    ! [V4c] :
      ( mem(V4c,bool)
     => ap(f2209,V4c) = k(bool,V4c) ) )).
     ...
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ( p(ap(ap(c_2Ewords_2Eword__hs(A_27a),V0a),V1b))
              <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2209)))))),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) ) )).
...
fof(conj_thm_2Ewords_2EWORD__HS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
