...
thf(conj_thm_2EindexedLists_2ELIST__RELi__strongind,lemma,(
...
thf(conj_thm_2Elist_2ESNOC__CASES,lemma,(
    ! [A_27a: del,V0ll: $i] :
...
thf(conj_thm_2EindexedLists_2ELIST__RELi__EL__EQN,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ( arr @ A_27b @ bool ) ) ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
