...
thf(thm_2Epoly_2EPOLY__ROOTS__INDEX__LEMMA,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( ( (~)
          @ ( ( c_2Epoly_2Epoly @ V1p )
            = ( c_2Epoly_2Epoly @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) )
        & ( ( c_2Elist_2ELENGTH @ tyop_2Erealax_2Ereal @ V1p )
          = V0n ) )
     => ? [V2i: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
        ! [V3x: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Epoly_2Epoly @ V1p @ V3x )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
         => ? [V4m: tyop_2Enum_2Enum] :
              ( ( c_2Earithmetic_2E_3C_3D @ V4m @ V0n )
              & ( V3x
                = ( V2i @ V4m ) ) ) ) ) )).
