...
tff(mem_c_2Ecardinal_2E_2B__c,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Ecardinal_2E_2B__c(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27b,bool),arr(ty_2Esum_2Esum(A_27a,A_27a),bool)))) )).

tff(lmtp_f1883,type,(
    f1883: ( del * del * del * $i ) > $i )).

tff(lamtp_f1883,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => mem(f1883(A_27a,A_27b,A_27a,V0s),arr(A_27a,ty_2Epair_2Eprod(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)))) ) )).

tff(lameq_f1883,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f1883(A_27a,A_27b,A_27a,V0s),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Esum_2EINL(A_27a,A_27a),V2x)),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V0s)) ) ) )).

tff(lmtp_f1884,type,(
    f1884: ( del * del * del * $i ) > $i )).

tff(lamtp_f1884,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V1t: $i] :
      ( mem(V1t,arr(A_27b,bool))
     => mem(f1884(A_27b,A_27a,A_27b,V1t),arr(A_27b,ty_2Epair_2Eprod(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)))) ) )).

tff(lameq_f1884,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V1t: $i] :
      ( mem(V1t,arr(A_27b,bool))
     => ! [V3y: $i] :
          ( mem(V3y,A_27b)
         => ap(f1884(A_27b,A_27a,A_27b,V1t),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Esum_2EINR(A_27a,A_27a),V3y)),ap(ap(c_2Ebool_2EIN(A_27b),V3y),V1t)) ) ) )).

tff(ax_thm_2Ecardinal_2Eadd__c,axiom,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t) = ap(ap(c_2Epred__set_2EUNION(ty_2Esum_2Esum(A_27a,A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),f1883(A_27a,A_27b,A_27a,V0s))),ap(c_2Epred__set_2EGSPEC(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),f1884(A_27b,A_27a,A_27b,V1t))) ) ) )).

tff(conj_thm_2Ecardinal_2ECARD__ADD__FINITE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
