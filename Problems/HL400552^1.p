...
thf(c_2Epair_2EABS__prod_2E0,type,(
    c_2Epair_2EABS__prod_2E0: u )).

thf(c_2Epair_2EABS__prod_2E1,type,(
    c_2Epair_2EABS__prod_2E1: du > u )).

thf(c_2Ebool_2EF_2E0,type,(
    c_2Ebool_2EF_2E0: u )).

thf(c_2Epair_2EREP__prod_2E0,type,(
    c_2Epair_2EREP__prod_2E0: u )).

thf(c_2Epair_2EREP__prod_2E1,type,(
    c_2Epair_2EREP__prod_2E1: du > u )).
...
thf(arityeq2_2Emono_2Ef665_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( f665_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) ) @ f665_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef665_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f665_0_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) @ ( s @ A_27b @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) ) @ f665_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) @ ( s @ A_27b @ X3_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Epair_2EABS__prod_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2EABS__prod_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ c_2Epair_2EABS__prod_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Epair_2EREP__prod_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EREP__prod_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ c_2Epair_2EREP__prod_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Epair_2EABS__REP__prod,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0a_2E0: u] :
          ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2EABS__prod_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EREP__prod_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0a_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0a_2E0 ) )
      & ! [V1r_2E0: u] :
          ( ? [V2x_2E0: u,V3y_2E0: u] :
            ! [V4x_27_2E0: u,V5x_27_27_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V1r_2E0 ) @ ( s @ A_27a @ V4x_27_2E0 ) ) ) @ ( s @ A_27b @ V5x_27_27_2E0 ) ) ) )
            <=> ( ( ( s @ A_27a @ V4x_27_2E0 )
                  = ( s @ A_27a @ V2x_2E0 ) )
                & ( ( s @ A_27b @ V5x_27_27_2E0 )
                  = ( s @ A_27b @ V3y_2E0 ) ) ) )
        <=> ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( c_2Epair_2EREP__prod_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2EABS__prod_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V1r_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V1r_2E0 ) ) ) ) )).

thf(def0_2Ethm_2Epair_2ECOMMA__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1y_2E0: u,V2a_2E0: u,V3b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f665_0_2E4 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V1y_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27b @ V3b_2E0 ) ) ) )
    <=> ( ( ( s @ A_27a @ V2a_2E0 )
          = ( s @ A_27a @ V0x_2E0 ) )
        & ( ( s @ A_27b @ V3b_2E0 )
          = ( s @ A_27b @ V1y_2E0 ) ) ) ) )).
...
thf(thm_2Epair_2ECOMMA__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1y_2E0: u] :
      ...
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2EABS__prod_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( f665_0_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27b @ V1y_2E0 ) ) ) ) ) ) )).

thf(thm_2Epair_2EABS__PAIR__THM,conjecture,(
