...
thf(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__SEQUENTIAL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
        ...
        <=> ? [V2x: $i] :
              ...
              & ! [V3n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V2x @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V0s ) )
