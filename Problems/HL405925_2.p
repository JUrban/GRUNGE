...
tff(mem_c_2Ewords_2Ereduce__nor,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Ereduce__nor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).
...
tff(lamtp_f2177,axiom,(
    ! [V0a: tp__o] : mem(f2177(V0a),arr(bool,bool)) )).

tff(lameq_f2177,axiom,(
    ! [V0a: tp__o,V1b: tp__o] : ap(f2177(V0a),inj__o(V1b)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,inj__o(V0a)),inj__o(V1b))) )).

tff(lmtp_f2176,type,(
    f2176: $i )).

tff(lamtp_f2176,axiom,(
    mem(f2176,arr(bool,arr(bool,bool))) )).

tff(lameq_f2176,axiom,(
    ! [V0a: tp__o] : ap(f2176,inj__o(V0a)) = f2177(V0a) )).

tff(ax_thm_2Ewords_2Ereduce__nor__def,axiom,(
    ! [A_27a: del] : c_2Ewords_2Ereduce__nor(A_27a) = ap(c_2Ewords_2Eword__reduce(A_27a),f2176) )).
...
tff(lamtp_f2238,axiom,(
    mem(f2238,arr(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2238,axiom,(
    ! [V1l: tp__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] : ap(f2238,inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l)) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__nor(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l))),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),inj__c_ty_2Elist_2Elist_c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V1l))) )).

tff(conj_thm_2Ewords_2Efoldl__reduce__nor,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(c_2Ewords_2Ereduce__nor(A_27a),V0w)) = surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2238),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))) ) )).
