...
thf(thm_2Ebag_2EBAG__INN__LESS,axiom,(
    ! [A_27a: d,V0b_2E0: u,V1e_2E0: u,V2n: mono_2Etyop_2Enum_2Enum,V3m: mono_2Etyop_2Enum_2Enum] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ V3m @ V2n ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V1e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3m ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INN__BAG__DELETE,conjecture,(
    ! [A_27a: d,V0b_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2e_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__INN_2E3 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) )
        & ( mono_2Ec_2Earithmetic_2E_3E @ V1n @ mono_2Ec_2Enum_2E0 ) )
     => ? [V3b_27_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EBAG__DELETE_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V3b_27_2E0 ) ) ) ) ) )).
