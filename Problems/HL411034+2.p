...
fof(lamtp_f3696,axiom,(
    ! [V1e] :
      ( mem(V1e,ty_2Erealax_2Ereal)
     => ! [V0x] :
          ( mem(V0x,ty_2Erealax_2Ereal)
         => mem(f3696(V1e,V0x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
    ...
    ! [V1e] :
     ...
     => ! [V0x] :
         ...
         => ! [V2y] :
             ...
             => ap(f3696(V1e,V0x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2y),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V2y))),V1e)) ) ) ) )).
...
fof(ax_thm_2Ereal__topology_2Eball,axiom,(
    ! [V0x] :
     ...
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
         => ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1e)) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3696(V1e,V0x)) ) ) )).

fof(lamtp_f3697,axiom,(
    ! [V1e] :
      ( mem(V1e,ty_2Erealax_2Ereal)
     => ! [V0x] :
          ( mem(V0x,ty_2Erealax_2Ereal)
         => mem(f3697(V1e,V0x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).
...
fof(lameq_f3697,axiom,(
    ! [V1e] :
     ...
     => ! [V0x] :
         ...
         => ! [V2y] :
              ( mem(V2y,ty_2Erealax_2Ereal)
             => ap(f3697(V1e,V0x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2y),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V2y))),V1e)) ) ) ) )).
...
fof(ax_thm_2Ereal__topology_2Ecball,axiom,(
    ! [V0x] :
     ...
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
         => ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1e)) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3697(V1e,V0x)) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EIN__CBALL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EINTER__BALLS__EQ__EMPTY,conjecture,
    ( ! [V0a] :
       ...
       => ! [V1b] :
           ...
           => ! [V2r] :
               ...
               => ! [V3s] :
                    ( mem(V3s,ty_2Erealax_2Ereal)
                   => ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V2r))),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1b),V3s))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                    <=> ( p(ap(ap(c_2Ereal_2Ereal__lte,V2r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Ereal_2Ereal__lte,V3s),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,V2r),V3s)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)))) ) ) ) ) ) )
    & ! [V4a] :
       ...
       => ! [V5b] :
           ...
           => ! [V6r] :
               ...
               => ! [V7s] :
                    ( mem(V7s,ty_2Erealax_2Ereal)
                   => ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V6r))),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5b),V7s))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                    <=> ( p(ap(ap(c_2Ereal_2Ereal__lte,V6r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Erealax_2Ereal__lt,V7s),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,V6r),V7s)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4a),V5b)))) ) ) ) ) ) )
    & ! [V8a] :
       ...
       => ! [V9b] :
           ...
           => ! [V10r] :
               ...
               => ! [V11s] :
                    ( mem(V11s,ty_2Erealax_2Ereal)
                   => ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V8a),V10r))),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V9b),V11s))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                    <=> ( p(ap(ap(c_2Erealax_2Ereal__lt,V10r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Ereal_2Ereal__lte,V11s),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,V10r),V11s)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V8a),V9b)))) ) ) ) ) ) )
    & ! [V12a] :
       ...
       => ! [V13b] :
           ...
           => ! [V14r] :
               ...
               => ! [V15s] :
                    ( mem(V15s,ty_2Erealax_2Ereal)
                   => ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V12a),V14r))),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V13b),V15s))) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                    <=> ( p(ap(ap(c_2Erealax_2Ereal__lt,V14r),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Erealax_2Ereal__lt,V15s),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                        | p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,V14r),V15s)),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V12a),V13b)))) ) ) ) ) ) ) )).
