...
tff(conj_thm_2Emeasure_2ECARATHEODORY__LEMMA,lemma,(
    ! [A_27a: del,V0gsig: $i] :
...
tff(conj_thm_2Emeasure_2EINF__MEASURE__AGREES,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Emeasure_2EMEASURE__DOWN,lemma,(
    ! [A_27a: del,V0m0: $i] :
...
tff(conj_thm_2Emeasure_2EINF__MEASURE__OUTER,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
          & p(ap(c_2Emeasure_2Epositive(A_27a),V0m))
...
tff(conj_thm_2Emeasure_2ESIGMA__SUBSET,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,arr(arr(A_27a,bool),bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2EALGEBRA__SUBSET__LAMBDA__SYSTEM,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))))
          & p(ap(c_2Emeasure_2Epositive(A_27a),V0m))
          & p(ap(c_2Emeasure_2Eincreasing(A_27a),V0m))
          & p(ap(c_2Emeasure_2Eadditive(A_27a),V0m)) )
       => p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,bool)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)),ap(ap(c_2Emeasure_2Elambda__system(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m)))),ap(c_2Emeasure_2Einf__measure(A_27a),V0m)))) ) ) )).

tff(conj_thm_2Emeasure_2ECARATHEODORY,conjecture,(
    ! [A_27a: del,V0m0: $i] :
      ( mem(V0m0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( ( p(ap(c_2Emeasure_2Ealgebra(A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m0)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m0))))
       ...
       => ? [V1m: $i] :
            ...
            & ! [V2s: $i] :
               ...
               => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m0)))
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V1m),V2s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m0),V2s)) ) )
            & ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V1m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V1m)) = ap(ap(c_2Emeasure_2Esigma(A_27a),ap(c_2Emeasure_2Em__space(A_27a),V0m0)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m0))
