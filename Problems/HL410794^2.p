...
thf(conj_thm_2Ereal__topology_2EINTERIOR__UNION__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
           ...
           => ( ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) )
                = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
            <=> ( ( ( ap @ c_2Ereal__topology_2Einterior @ V0s )
                  = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                & ( ( ap @ c_2Ereal__topology_2Einterior @ V1t )
                  = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__UNION,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1t ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__UNION,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) )
              = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
          <=> ( ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) )
                = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
              & ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V1t ) )
                = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) ) )).
