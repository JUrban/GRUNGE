...
thf(thm_2EHolSmt_2Er066,conjecture,(
    ! [V0z: tyop_2Einteger_2Eint,V1y: tyop_2Einteger_2Eint,V2x: tyop_2Einteger_2Eint] :
      ( ( V2x
        = ( c_2Einteger_2Eint__add @ V1y @ V0z ) )
    <=> ( ( c_2Einteger_2Eint__add @ V2x @ ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0z ) )
        = V1y ) ) )).
