...
fof(conj_thm_2Equotient__list_2EREVERSE__PRS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2rep] :
                     ...
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => ! [V3l] :
                           ...
                           => ap(c_2Elist_2EREVERSE(A_27b),V3l) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1abs),ap(c_2Elist_2EREVERSE(A_27a),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V3l))) ) ) ) ) ) ) ) )).
