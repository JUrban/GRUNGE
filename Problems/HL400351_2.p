...
tff(conj_thm_2Erelation_2ERTC__INDUCT__RIGHT1,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Erelation_2ERTC__RULES__RIGHT1,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( ! [V1x: $i] :
            ( mem(V1x,A_27a)
...
tff(conj_thm_2Erelation_2ERTC__STRONG__INDUCT__RIGHT1,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,arr(A_27a,bool)))
