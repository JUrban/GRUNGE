...
fof(conj_thm_2Eprobability_2Eprob__x__eq__1__imp__prob__y__eq__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Eprobability_2Edistribution__x__eq__1__imp__distribution__y__eq__0,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0X] :
             ...
             => ! [V1p] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27b)
                     => ( ( p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0X),ap(c_2Eprobability_2Ep__space(A_27a),V1p))),ap(c_2Epred__set_2EPOW(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0X),ap(c_2Eprobability_2Ep__space(A_27a),V1p))))))
                          & ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),ap(ap(c_2Epred__set_2EINSERT(A_27b),V2x),c_2Epred__set_2EEMPTY(A_27b))) = ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) )
                       => ! [V3y] :
                            ( mem(V3y,A_27b)
                           => ( V3y != V2x
                             => ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),ap(ap(c_2Epred__set_2EINSERT(A_27b),V3y),c_2Epred__set_2EEMPTY(A_27b))) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) ) ) ) )).
