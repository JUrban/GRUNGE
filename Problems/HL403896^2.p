...
thf(conj_thm_2Ellist_2ELDROP__ADD,conjecture,(
    ! [A_27a: del,V0k1: tp__ty_2Enum_2Enum,V1k2: tp__ty_2Enum_2Enum,V2x: $i] :
      ( ( mem @ V2x @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0k1 ) ) @ ( inj__ty_2Enum_2Enum @ V1k2 ) ) ) @ V2x )
        = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ( ty_2Ellist_2Ellist @ A_27a ) @ ( ty_2Eoption_2Eoption @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0k1 ) ) @ V2x ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Ellist_2Ellist @ A_27a ) ) )
          @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
            @ ^ [V3ll: $i] :
                ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1k2 ) ) @ V3ll ) ) ) ) ) )).
