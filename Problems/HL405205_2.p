...
tff(conj_thm_2Ealist_2EALOOKUP__ALL__DISTINCT__EL,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1n)),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),V0ls)))
         ...
         => ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0ls),ap(c_2Epair_2EFST(A_27a,A_27a),ap(ap(c_2Elist_2EEL(ty_2Epair_2Eprod(A_27a,A_27a)),inj__ty_2Enum_2Enum(V1n)),V0ls))) = ap(c_2Eoption_2ESOME(A_27b),ap(c_2Epair_2ESND(A_27a,A_27a),ap(ap(c_2Elist_2EEL(ty_2Epair_2Eprod(A_27a,A_27a)),inj__ty_2Enum_2Enum(V1n)),V0ls))) ) ) )).
