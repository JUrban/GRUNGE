...
fof(conj_thm_2Ecardinal_2Eexp__count__cardeq,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
...
fof(conj_thm_2Ecardinal_2EINFINITE__Unum,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2EINFINITE__cardleq__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2Elist__BIGUNION__EXP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
...
fof(conj_thm_2Ecardinal_2EINFINITE__A__list__BIJ__A,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0A] :
          ( mem(V0A,arr(A_27a,bool))
