...
thf(conj_thm_2Elist_2EisPREFIX__NILR,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Ellist_2ELPREFIX__LCONS,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0ll: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2ELPREFIX @ A_27a ) @ V0ll ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V1h ) @ V2t ) ) )
                  <=> ( ( V0ll
                      ...
                      | ? [V3l: $i] :
                          ...
                          & ( V0ll
                            = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V1h ) @ V3l ) )
             ...
             => ! [V6ll: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2ELPREFIX @ A_27b ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27b ) @ V4h ) @ V5t ) ) @ V6ll ) )
                  <=> ? [V7l: $i] :
                        ...
                        & ( V6ll
                          = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27b ) @ V4h ) @ V7l ) )
