...
thf(conj_thm_2Elist_2ELENGTH__FRONT__CONS,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1xs: $i] :
...
thf(conj_thm_2Erich__list_2EEL__FRONT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V0l ) )
