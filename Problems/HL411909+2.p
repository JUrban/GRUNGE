...
fof(conj_thm_2Ereal__topology_2ECLOSURE__EQ__EMPTY,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__POS__LE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)))) ) ) )).

fof(conj_thm_2Ereal__topology_2EHAUSDIST__SYM,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__CLOSURE,lemma,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1t] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
           => ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Eclosure,V0s)),V1t)) = ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) ) )
    & ! [V2s] :
        ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V3t] :
            ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
           => ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),ap(c_2Ereal__topology_2Eclosure,V3t))) = ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),V3t)) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2b] :
             ...
             => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
               ...
               => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),V2b))
                <=> ( ! [V3x] :
                        ( mem(V3x,ty_2Erealax_2Ereal)
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V0s))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V3x),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V1t))),V2b)) ) )
                    & ! [V4y] :
                        ( mem(V4y,ty_2Erealax_2Ereal)
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1t))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V4y),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V0s))),V2b)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__EXISTS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
           ...
           => ! [V2x] :
               ...
               => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s))
                 => ? [V3y] :
                      ( mem(V3y,ty_2Erealax_2Ereal)
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V1t))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),V3y))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EHAUSDIST__TRIANGLE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2u] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
                  ...
                  & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V2u))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1t),V2u))))) ) ) ) ) )).
