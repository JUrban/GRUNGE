...
tff(tp_c_2ECoder_2Enum__coder,type,(
    c_2ECoder_2Enum__coder: $i )).

tff(mem_c_2ECoder_2Enum__coder,axiom,(
...
tff(ax_thm_2ECoder_2Enum__coder__def,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2ECoder_2Ewf__coder__num,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
