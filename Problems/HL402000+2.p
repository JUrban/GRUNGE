...
fof(conj_thm_2Epred__set_2EIN__APP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Eset__relation_2Ereln__to__rel__IS__CURRY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Eset__relation_2Ereln__to__rel(A_27a,A_27a) = c_2Epair_2ECURRY(A_27a,A_27a,A_27a) ) ) )).
