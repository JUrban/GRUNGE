...
thf(conj_thm_2Elist_2EFOLDL__CONG,lemma,(
...
thf(ax_thm_2Elogroot_2ELOG,axiom,(
...
thf(ax_thm_2Erich__list_2ECOUNT__LIST__def,axiom,
    ( ( ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      = ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( c_2Elist_2ENIL @ ty_2Enum_2Enum ) ) )
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
        = ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ c_2Enum_2ESUC ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EMEM__COUNT__LIST,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Erich__list_2ECOUNT__LIST__SNOC,lemma,
    ( ( ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
      = ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( c_2Elist_2ENIL @ ty_2Enum_2Enum ) ) )
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
        = ( surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Edimindex__lt__dimword,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ewords_2Ew2w__id,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EEXTRACT__JOIN__ADD,lemma,(
...
thf(conj_thm_2Ewords_2EASR__LIMIT,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__asr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1n ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0w ) ) @ ( c_2Ewords_2Eword__T @ A_27a ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Eword__lo__n2w,lemma,(
...
thf(conj_thm_2Eblast_2Eword__asr__bv__expand,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1m: $i] :
