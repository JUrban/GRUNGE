...
tff(conj_thm_2Emeasure_2EMEASURABLE__BIGUNION__PROPERTY,conjecture,(
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
               ...
               => ! [V4c: $i] :
                    ( mem(V4c,arr(arr(A_27b,bool),bool))
                   => ( p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27b,bool)),V4c),ap(c_2Emeasure_2Esubsets(A_27b),V1b)))
                     => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f),ap(c_2Epred__set_2EBIGUNION(A_27b),V4c)) = ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V2f)),V4c)) ) ) ) ) ) ) )).
