...
thf(conj_thm_2Eseq_2ENEST__LEMMA,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
         => ( ( ! [V2n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ ( ap @ V0f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
              & ! [V3n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V1g @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) )
           ...
           => ? [V5l: tp__ty_2Erealax_2Ereal,V6m: tp__ty_2Erealax_2Ereal] :
                ...
                & ! [V7n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5l ) ) )
                & ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V5l ) ) )
                & ! [V8n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V6m ) ) @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V8n ) ) ) )
                & ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V1g ) @ ( inj__ty_2Erealax_2Ereal @ V6m ) ) ) ) ) ) ) )).

thf(conj_thm_2Eseq_2ENEST__LEMMA__UNIQ,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
              ...
              & ( p
                @ ( ap
                  @ ( ap @ c_2Eseq_2E_2D_2D_3E
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V5n: $i] :
                          ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V5n ) ) @ ( ap @ V1g @ V5n ) ) ) )
                  @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
           => ? [V6l: tp__ty_2Erealax_2Ereal] :
                ( ! [V7n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V6l ) ) )
                & ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V6l ) ) )
                & ! [V8n: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V6l ) ) @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V8n ) ) ) )
