...
thf(tp_c_2Emergesort_2Esort3,type,(
    c_2Emergesort_2Esort3: del > $i )).

thf(mem_c_2Emergesort_2Esort3,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Emergesort_2Esort3__def,axiom,(
    ! [A_27a: del,V0R: $i] :
...
thf(conj_thm_2Esorting_2ESORTED__DEF,lemma,(
    ! [A_27a: del] :
      ( ! [V0R: $i] :
          ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Emergesort_2Esort3__sorted,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
