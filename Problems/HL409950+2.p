...
fof(lamtp_f3454,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f3454(A_27a,V1f),arr(A_27a,bool)) ) )).

fof(lameq_f3454,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2p] :
          ( mem(V2p,A_27a)
         => ap(f3454(A_27a,V1f),V2p) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V2p)),ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0))) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__INTER__NONZERO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ! [V1f] :
                ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
               => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),ap(ap(c_2Epred__set_2EINTER(A_27a),V0s),f3454(A_27a,V1f))) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s) ) ) ) ) )).
