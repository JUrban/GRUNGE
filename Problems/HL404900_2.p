...
tff(conj_thm_2Elist_2EEXISTS__APPEND,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Ellist_2Eexists__ind,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1exists_27: $i] :
...
tff(conj_thm_2Elbtree_2Emem__thm,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,A_27a)
     => ! [V1b: $i] :
          ( mem(V1b,A_27a)
...
tff(conj_thm_2Elbtree_2Ebf__flatten__eq__lnil,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(conj_thm_2Elbtree_2Ebf__flatten__append,lemma,(
    ! [A_27a: del,V0l2: $i] :
...
tff(conj_thm_2Elbtree_2EEXISTS__FIRST,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
           ...
           => ? [V2l1: $i] :
                ...
                & ? [V3x: $i] :
                    ...
                    & ? [V4l2: $i] :
                        ...
                        & p(ap(ap(c_2Elist_2EEVERY(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Ebool_2E_7E),V0P)),V2l1))
                        & p(ap(V0P,V3x)) ) ) ) ) ) ) )).

tff(conj_thm_2Elbtree_2Eexists__bf__flatten,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1tlist: $i] :
