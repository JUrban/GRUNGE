...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__SUB,conjecture,(
    ! [A_27a: del,V0s: $i] :
       ...
       => ! [V1f: $i] :
           ...
           => ! [V2f_27: $i] :
               ...
               => ( ( ! [V3x: $i] :
                 ...
                 => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3456(A_27a,V1f,V2f_27)),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__sub,ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f_27),V0s))) ) ) ) ) ) )).
