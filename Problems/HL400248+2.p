...
fof(conj_thm_2Ecombin_2EUPD11__SAME__BASE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1a] :
                 ...
                 => ! [V2b] :
                     ...
                     => ! [V3c] :
                         ...
                         => ! [V4d] :
                              ( mem(V4d,A_27b)
                             => ( ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V1a),V3c),V0f) = ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V2b),V4d),V0f)
                              <=> ( ( V1a = V2b
                                    & V3c = V4d )
                                  | ( V1a != V2b
                                    & ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V1a),V3c),V0f) = V0f
                                    & ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V2b),V4d),V0f) = V0f ) ) ) ) ) ) ) ) ) ) )).
