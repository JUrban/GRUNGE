...
thf(conj_thm_2Ereal_2ELE__NUM__CEILING,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Ereal_2ENUM__CEILING @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) )).
