...
fof(conj_thm_2Erealax_2EREAL__MUL__ASSOC,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ebinary__ieee_2Eulp__lt__largest,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ebinary__ieee_2Eulp(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) ) ) )).
