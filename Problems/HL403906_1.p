...
tff(thm_2Ellist_2Eexists__cases,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1a0_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V1a0_2E0)))))
    <=> ( ? [V2h_2E0: u,V3t_2E0: u] :
            ( s(tyop_2Ellist_2Ellist(A_27a),V1a0_2E0) = s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELCONS_2E2(s(A_27a,V2h_2E0),s(tyop_2Ellist_2Ellist(A_27a),V3t_2E0)))
        ...
        | ? [V4h_2E0: u,V5t_2E0: u] :
            ( s(tyop_2Ellist_2Ellist(A_27a),V1a0_2E0) = s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELCONS_2E2(s(A_27a,V4h_2E0),s(tyop_2Ellist_2Ellist(A_27a),V5t_2E0)))
