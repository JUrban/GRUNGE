...
tff(lmtp_f3891,type,(
    f3891: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3891,axiom,(
    ! [V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3a: tp__ty_2Erealax_2Ereal] : mem(f3891(V2f,V3a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3891,axiom,(
    ! [V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3a: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] : ap(f3891(V2f,V3a),inj__ty_2Erealax_2Ereal(V4y)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3a)),ap(V2f,inj__ty_2Erealax_2Ereal(V4y))) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__LIFT__DOT,lemma,(
    ! [V0l: tp__ty_2Erealax_2Ereal,V1net: tp__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal,V2f: $i] :
     ...
     => ! [V3a: tp__ty_2Erealax_2Ereal] :
         ...
         => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3891(V2f,V3a)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V0l))),inj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal(V1net))) ) ) )).

tff(lmtp_f3892,type,(
    f3892: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3892,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3892(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3892,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : ap(f3892(V0a),inj__ty_2Erealax_2Ereal(V2y)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V2y)) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__LIFT__DOT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3892(V0a)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x)))) )).
