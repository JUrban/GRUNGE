...
fof(lamtp_f1948,axiom,(
    ! [A_27b,A_27a,A_27b,A_27a] : mem(f1948(A_27b,A_27a,A_27b,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).

fof(lameq_f1948,axiom,(
    ! [A_27b,A_27a,A_27b,A_27a,V2env] :
      ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ap(f1948(A_27b,A_27a,A_27b,A_27a),V2env) = ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1949(A_27b,A_27a,V2env)) ) )).

fof(conj_thm_2Efinite__map_2Efupdate__list__foldl,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
