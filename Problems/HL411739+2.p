...
fof(conj_thm_2Ereal__topology_2EFINITE__INTER__NUMSEG,lemma,(
    ! [V0s] :
     ...
     => ! [V1m] :
         ...
         => ! [V2n] :
             ...
             => p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V0s),ap(ap(c_2Eiterate_2E_2E_2E,V1m),V2n)))) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ESERIES__ADD,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0] :
