...
tff(conj_thm_2Eiterate_2ENSUM__MULTICOUNT__GEN,lemma,(
...
tff(conj_thm_2Eiterate_2ENSUM__MULTICOUNT,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3k: tp__ty_2Enum_2Enum] :
                 ...
                 => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3326(A_27b,A_27a,V2t,V0R))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3k)),ap(c_2Epred__set_2ECARD(A_27b),V2t))) ) ) ) ) )).
