...
fof(thm_2Epair_2Epair__case__eq,conjecture,(
    ! [A_27a,A_27b,A_27c,V0v_2E0,V1p_2E0,V2f_2E0] :
      ( s(A_27a,c_2Epair_2Epair__CASE_2E2(s(tyop_2Epair_2Eprod(A_27b,A_27c),V1p_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V2f_2E0))) = s(A_27a,V0v_2E0)
    <=> ? [V3x_2E0,V4y_2E0] :
          ( s(tyop_2Epair_2Eprod(A_27b,A_27c),V1p_2E0) = s(tyop_2Epair_2Eprod(A_27b,A_27c),c_2Epair_2E_2C_2E2(s(A_27b,V3x_2E0),s(A_27c,V4y_2E0)))
          & s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27c,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27c,A_27a)),V2f_2E0),s(A_27b,V3x_2E0))),s(A_27c,V4y_2E0))) = s(A_27a,V0v_2E0) ) ) )).
