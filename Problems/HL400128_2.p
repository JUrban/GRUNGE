...
tff(lamtp_f58,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
         => mem(f58(A_27a,V0P,V1Q),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f58,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V1Q: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f58(A_27a,V0P,V1Q),V2x) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0P,V2x)),ap(V1Q,V2x)) ) ) ) )).
...
tff(lamtp_f59,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f59(A_27a,V0P),arr(A_27a,bool)) ) )).
...
tff(lameq_f59,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f59(A_27a,V0P),V3x) = ap(V0P,V3x) ) ) )).
...
tff(lamtp_f60,axiom,(
    ! [A_27a: del,V1Q: $i] :
      ( mem(V1Q,arr(A_27a,bool))
     => mem(f60(A_27a,V1Q),arr(A_27a,bool)) ) )).
...
tff(lameq_f60,axiom,(
    ! [A_27a: del,V1Q: $i] :
     ...
     => ! [V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f60(A_27a,V1Q),V4x) = ap(V1Q,V4x) ) ) )).

tff(conj_thm_2Ebool_2EUEXISTS__OR__THM,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
