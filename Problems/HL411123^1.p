...
thf(thm_2Ereal__topology_2EUNIFORMLY__CAUCHY__IMP__UNIFORMLY__CONVERGENT,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1s_2E0: u,V2l_2E0: u] :
      ( ( ! [V3e: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V3e )
           => ? [V4N: mono_2Etyop_2Enum_2Enum] :
              ! [V5m: mono_2Etyop_2Enum_2Enum,V6n: mono_2Etyop_2Enum_2Enum,V7x_2E0: u] :
                ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4N @ V5m )
                  & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4N @ V6n )
               ...
               => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5m ) ) ) ) @ ( s @ A_27a @ V7x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V6n ) ) ) ) @ ( s @ A_27a @ V7x_2E0 ) ) ) ) ) ) @ V3e ) ) )
        & ! [V8x_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) )
           => ! [V9e: mono_2Etyop_2Erealax_2Ereal] :
               ...
               => ? [V10N: mono_2Etyop_2Enum_2Enum] :
                  ! [V11n: mono_2Etyop_2Enum_2Enum] :
                   ...
                   => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V11n ) ) ) ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2l_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) ) ) @ V9e ) ) ) ) )
     => ! [V12e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V13N: mono_2Etyop_2Enum_2Enum] :
            ! [V14n: mono_2Etyop_2Enum_2Enum,V15x_2E0: u] :
              ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V13N @ V14n )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V15x_2E0 ) ) ) ) )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ V1s_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V14n ) ) ) ) @ ( s @ A_27a @ V15x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V2l_2E0 ) @ ( s @ A_27a @ V15x_2E0 ) ) ) ) ) ) @ V12e ) ) ) ) )).
