...
thf(thm_2Ereal__topology_2ESERIES__RATIO,conjecture,(
    ! [V0c: tyop_2Erealax_2Ereal,V1a: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2s: tyop_2Enum_2Enum > $o,V3N: tyop_2Enum_2Enum] :
      ( ( ( c_2Erealax_2Ereal__lt @ V0c @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
        & ! [V4n: tyop_2Enum_2Enum] :
            ( ( c_2Earithmetic_2E_3E_3D @ V4n @ V3N )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V1a @ ( c_2Enum_2ESUC @ V4n ) ) ) @ ( c_2Erealax_2Ereal__mul @ V0c @ ( c_2Ereal_2Eabs @ ( V1a @ V4n ) ) ) ) ) )
     => ? [V5l: tyop_2Erealax_2Ereal] :
          ( c_2Ereal__topology_2Esums @ V1a @ V5l @ V2s ) ) )).
