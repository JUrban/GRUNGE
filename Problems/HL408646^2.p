...
thf(conj_thm_2EHolSmt_2Er025,conjecture,(
    ! [A_27a: del,V0p: $o,V1x: $i] :
      ( ( mem @ V1x @ A_27a )
     => ! [V2q: $o,V3y: $i] :
          ( ( mem @ V3y @ A_27a )
         => ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( inj__o @ V0p ) ) @ V1x ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( inj__o @ V2q ) ) @ V1x ) @ V3y ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( inj__o @ V2q ) ) @ ( inj__o @ V0p ) ) ) @ V1x ) @ V3y ) ) ) ) )).
