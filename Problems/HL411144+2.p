...
fof(conj_thm_2Ereal__topology_2ELIM__WITHIN__SUBSET,lemma,(
    ! [V0t] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__SUBSET,conjecture,(
    ! [V0f] :
     ...
     => ! [V1s] :
         ...
         => ! [V2t] :
             ...
             => ! [V3x] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V3x)),V1s)))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2t),V1s)) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V3x)),V2t))) ) ) ) ) ) )).
