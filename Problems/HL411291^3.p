...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSED,axiom,(
    ...
    <=> ! [V2t: tyop_2Erealax_2Ereal > $o] :
          ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V1s ) ) @ V2t )
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__LIFT__DOT,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ...
      @ ^ [V2y: tyop_2Erealax_2Ereal] :
          ( c_2Erealax_2Ereal__mul @ V0a @ V2y )
      @ V1s ) )).
    ...
    ! [V0b: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V1x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V1x @ ( c_2Ereal_2Ereal__lte @ V1x @ V0b ) ) ) ) )).
    ...
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Ereal_2Ereal__lte @ ( c_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) ) )).
