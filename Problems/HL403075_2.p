...
tff(lamtp_f881,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => mem(f881(V1b),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f881,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V4t: tp__ty_2Enum_2Enum] : ap(f881(V1b),inj__ty_2Enum_2Enum(V4t)) = ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V4t))) ) )).

tff(conj_thm_2ETemporal__Logic_2EUNTIL__LINORD,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t0: tp__ty_2Enum_2Enum] :
            ...
            <=> ! [V3t1: tp__ty_2Enum_2Enum] :
                  ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2t0)),inj__ty_2Enum_2Enum(V3t1)))
                    ...
                    & p(ap(c_2ETemporal__Logic_2EUPTO,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2t0)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3t1)),f881(V1b))))) )
