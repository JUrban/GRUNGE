...
thf(thm_2Emeasure_2EIMAGE__SING,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1x: A_27a] :
      ( ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ ( c_2Epred__set_2EINSERT @ A_27a @ V1x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
      = ( c_2Epred__set_2EINSERT @ A_27b @ ( V0f @ V1x ) @ ( c_2Epred__set_2EEMPTY @ A_27b ) ) ) )).
