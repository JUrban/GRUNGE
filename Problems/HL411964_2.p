...
tff(conj_thm_2Epred__set_2EBIGINTER__EMPTY,lemma,(
...
tff(conj_thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Etopology_2EOPEN__IN__INTER,lemma,(
    ! [A_27a: del,V0top: $i] :
...
tff(conj_thm_2Ereal__topology_2EDEPENDENT__CHOICE,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__NONEMPTY__OPEN__INTER,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(lameq_f3820,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V4n: tp__ty_2Enum_2Enum] : ap(f3820(V0s),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(V0s,inj__ty_2Enum_2Enum(V4n))),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4n)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__NEST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ( p(ap(c_2Ereal__topology_2Ecompact,ap(V0s,inj__ty_2Enum_2Enum(V1n))))
              & ap(V0s,inj__ty_2Enum_2Enum(V1n)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
          & ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
             ...
             => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0s,inj__ty_2Enum_2Enum(V3n))),ap(V0s,inj__ty_2Enum_2Enum(V2m)))) ) )
...
tff(ax_thm_2Ereal__topology_2Elocally,axiom,(
    ! [V0P: $i] :
          ...
          <=> ! [V2w: $i] :
               ...
               => ! [V3x: tp__ty_2Erealax_2Ereal] :
                    ( ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V2w))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V2w)) )
                   => ? [V4u: $i] :
                        ...
                        & ? [V5v: $i] :
                            ...
                            & p(ap(V0P,V5v))
                            & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V4u))
                            & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V4u),V5v))
                            & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V5v),V2w)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBAIRE,conjecture,(
    ! [V0g: $i] :
