...
fof(ax_thm_2Erelation_2ERC__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(ax_thm_2Erelation_2ESC__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Esorting_2EPERM__REFL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0L] :
...
fof(conj_thm_2Esorting_2EPERM__SINGLE__SWAP__SYM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
