...
fof(conj_thm_2EquantHeuristics_2EFST__PAIR__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0p] :
             ...
             => ! [V1p2] :
                  ( mem(V1p2,A_27b)
                 => ( ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(c_2Epair_2EFST(A_27a,A_27a),V0p)),V1p2) = V0p
                  <=> V1p2 = ap(c_2Epair_2ESND(A_27a,A_27a),V0p) ) ) ) ) ) )).
