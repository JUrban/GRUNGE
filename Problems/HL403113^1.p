...
thf(f3694_0_2E0,type,(
    f3694_0_2E0: u )).

thf(f3694_0_2E1,type,(
    f3694_0_2E1: du > u )).

thf(f3694_0_2E2,type,(
    f3694_0_2E2: du > du > u )).

thf(f3694_1_2E0,type,(
    f3694_1_2E0: u )).

thf(f3694_1_2E2,type,(
    f3694_1_2E2: du > du > u )).

thf(f3694_1_2E3,type,(
...
thf(mono_2Ef3694_0,type,(
    mono_2Ef3694_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3694_1,type,(
    mono_2Ef3694_1: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESBEFORE__AS__SWHEN,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3694_0 @ V0b @ V2t )
    <=> ( (~) @ ( V0b @ V2t ) ) ) )).

thf(def1_2Ethm_2ETemporal__Logic_2ESBEFORE__AS__SWHEN,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3694_1 @ V1a @ V0b @ V3t )
    <=> ( ( V1a @ V3t )
        | ( V0b @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2ESBEFORE__AS__SWHEN,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ V1a @ V0b )
      = ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ ( mono_2Ef3694_0 @ V0b ) @ ( mono_2Ef3694_1 @ V1a @ V0b ) ) ) )).
