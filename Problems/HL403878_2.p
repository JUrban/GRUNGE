...
tff(conj_thm_2Ellist_2ELLENGTH__fromList,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),ap(c_2Ellist_2EfromList(A_27a),V0l))) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(c_2Elist_2ELENGTH(A_27a),V0l))) ) )).
