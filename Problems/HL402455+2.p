...
fof(conj_thm_2EerrorStateMonad_2EBIND__FAIL__L,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
              ( ne(A_27c)
             => ! [V0fM] :
                  ( mem(V0fM,arr(A_27c,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b)))))
                 => ap(ap(c_2EerrorStateMonad_2EBIND(A_27a,A_27a,A_27a),c_2EerrorStateMonad_2EES__FAIL(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c))),V0fM) = c_2EerrorStateMonad_2EES__FAIL(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)) ) ) ) ) )).
