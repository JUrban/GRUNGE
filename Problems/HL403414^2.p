...
thf(tp_c_2Ebag_2EBAG__INTER,type,(
    c_2Ebag_2EBAG__INTER: del > $i )).

thf(mem_c_2Ebag_2EBAG__INTER,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Ebag_2EBAG__INTER,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__INTER @ A_27a ) @ V0b1 ) @ V1b2 )
            = ( lam @ A_27a
              @ ^ [V2x: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ V0b1 @ V2x ) ) @ ( ap @ V1b2 @ V2x ) ) ) @ ( ap @ V0b1 @ V2x ) ) @ ( ap @ V1b2 @ V2x ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__INTER__SUB__BAG,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
