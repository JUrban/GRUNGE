...
thf(thm_2Eiterate_2ENSUM__LMUL,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1c: tyop_2Enum_2Enum,V2s: A_27a > $o] :
      ( ( c_2Eiterate_2Ensum @ A_27a @ V2s
        @ ^ [V3x: A_27a] :
            ( c_2Earithmetic_2E_2A @ V1c @ ( V0f @ V3x ) ) )
      = ( c_2Earithmetic_2E_2A @ V1c @ ( c_2Eiterate_2Ensum @ A_27a @ V2s @ V0f ) ) ) )).
