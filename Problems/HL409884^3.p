...
thf(thm_2Eiterate_2ESUM__EQ,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1g: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o] :
     ...
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2s @ V0f )
        = ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1g ) ) ) )).

thf(thm_2Eiterate_2ESUM__SUM__PRODUCT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27a > A_27b > $o,V2x: A_27a > A_27b > tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Eiterate_2ESum @ A_27a @ V0s
          @ ^ [V4i: A_27a] :
              ( c_2Eiterate_2ESum @ A_27b @ ( V1t @ V4i ) @ ( V2x @ V4i ) ) )
        = ( c_2Eiterate_2ESum @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )
...
thf(thm_2Eiterate_2ESUM__EQ__GENERAL__INVERSES,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o,V2f: A_27a > tyop_2Erealax_2Ereal,V3g: A_27b > tyop_2Erealax_2Ereal,V4h: A_27a > A_27b,V5k: A_27b > A_27a] :
      ( ( ! [V6y: A_27b] :
            ( ( c_2Ebool_2EIN @ A_27b @ V6y @ V1t )
           => ( ( c_2Ebool_2EIN @ A_27a @ ( V5k @ V6y ) @ V0s )
              & ( ( V4h @ ( V5k @ V6y ) )
                = V6y ) ) )
        & ! [V7x: A_27a] :
           ...
           => ( ( c_2Ebool_2EIN @ A_27b @ ( V4h @ V7x ) @ V1t )
              ...
              & ( ( V3g @ ( V4h @ V7x ) )
                = ( V2f @ V7x ) ) ) ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V0s @ V2f )
        = ( c_2Eiterate_2ESum @ A_27b @ V1t @ V3g ) ) ) )).
    ...
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2m @ V3n )
        @ ^ [V4i: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__sub @ ( V0f @ V4i ) @ ( V1g @ V4i ) ) )
      = ( c_2Ereal_2Ereal__sub @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V0f ) @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2m @ V3n ) @ V1g ) ) ) )).
...
thf(thm_2Eiterate_2EREAL__SUB__POW,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V2n )
     => ( ( c_2Ereal_2Ereal__sub @ ( c_2Ereal_2Epow @ V0x @ V2n ) @ ( c_2Ereal_2Epow @ V1y @ V2n ) )
        = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ V0x @ V1y )
          @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ ( c_2Earithmetic_2E_2D @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
            @ ^ [V3i: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Epow @ V0x @ V3i ) @ ( c_2Ereal_2Epow @ V1y @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3i ) ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EREAL__SUB__POLYFUN,conjecture,(
    ! [V0a: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal,V3n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V3n )
     => ( ( c_2Ereal_2Ereal__sub
          @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V3n )
            @ ^ [V4i: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__mul @ ( V0a @ V4i ) @ ( c_2Ereal_2Epow @ V1x @ V4i ) ) )
          @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V3n )
            @ ^ [V5i: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__mul @ ( V0a @ V5i ) @ ( c_2Ereal_2Epow @ V2y @ V5i ) ) ) )
        = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ V1x @ V2y )
          @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ ( c_2Earithmetic_2E_2D @ V3n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
            @ ^ [V6j: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__mul
                @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V6j @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3n )
                  @ ^ [V7i: tyop_2Enum_2Enum] :
                      ( c_2Erealax_2Ereal__mul @ ( V0a @ V7i ) @ ( c_2Ereal_2Epow @ V2y @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ V7i @ V6j ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
                @ ( c_2Ereal_2Epow @ V1x @ V6j ) ) ) ) ) ) )).
