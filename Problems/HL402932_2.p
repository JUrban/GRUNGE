...
tff(lamtp_f823,axiom,(
    mem(f823,arr(bool,bool)) )).

tff(lameq_f823,axiom,(
    ! [V0x: tp__o] : ap(f823,inj__o(V0x)) = ap(c_2Ebool_2E_7E,inj__o(V0x)) )).

tff(conj_thm_2EpatternMatches_2Esome__var__bool__F,conjecture,(
    surj__c_ty_2Eoption_2Eoption_o(ap(c_2Eoption_2Esome(bool),f823)) = surj__c_ty_2Eoption_2Eoption_o(ap(c_2Eoption_2ESOME(bool),inj__o(fo__c_2Ebool_2EF))) )).
