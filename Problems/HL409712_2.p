...
tff(lameq_f3307,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3307(A_27a,V0f,V2s),V3x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(V0f,V3x)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) ) ) ) )).

tff(lmtp_f3308,type,(
    f3308: ( del * $i * $i ) > $i )).

tff(lamtp_f3308,axiom,(
    ! [A_27a: del,V1g: $i] :
...
tff(lameq_f3308,axiom,(
    ! [A_27a: del,V1g: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3308(A_27a,V1g,V2s),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V4x),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(V1g,V4x)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) ) ) ) )).

tff(lmtp_f3309,type,(
    f3309: ( del * $i * $i ) > $i )).

tff(lamtp_f3309,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Eiterate_2ENSUM__ADD__GEN,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3307(A_27a,V0f,V2s))))
               ...
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),f3309(A_27a,V0f,V1g))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V0f)),ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V1g))) ) ) ) ) )).
