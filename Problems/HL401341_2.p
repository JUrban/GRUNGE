...
tff(conj_thm_2Ebit_2ENOT__MOD2__LEM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2EDIV__MULT__THM2,lemma,(
...
tff(conj_thm_2Ebit_2EBITWISE__COR,lemma,(
    ! [V0x: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2op: $i] :
      ( mem(V2op,arr(bool,arr(bool,bool)))
     => ! [V3a: tp__ty_2Enum_2Enum,V4b: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0x)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Ebit_2ESBIT__MULT,lemma,(
...
tff(conj_thm_2Ebit_2EBITWISE__EVAL,conjecture,(
