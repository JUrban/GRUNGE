...
fof(lamtp_f1937,axiom,(
    ! [A_27a,A_27c,A_27e,A_27d,A_27b,A_27d,A_27e,V0f1] :
      ( mem(V0f1,arr(A_27a,arr(A_27b,arr(A_27c,A_27d))))
     => ! [V1f2] :
          ( mem(V1f2,arr(A_27a,arr(A_27b,arr(A_27c,A_27e))))
...
fof(conj_thm_2Efinite__map_2EFOLDL2__FUPDATE__LIST__paired,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V2bs] :
                                 ...
                                 => ! [V3cs] :
                                     ...
                                     => ! [V4a] :
                                         ...
                                         => ( ap(c_2Elist_2ELENGTH(A_27a),V2bs) = ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27b,A_27b)),V3cs)
