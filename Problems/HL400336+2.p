...
fof(conj_thm_2Erelation_2ETC__INDUCT__RIGHT1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2ETC__INDUCT__ALT__RIGHT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,A_27a)
         => ! [V1R] :
             ...
             => ! [V2Q] :
                 ...
                 => ( ( ! [V3y] :
                   ...
                   => ! [V6b] :
                        ( mem(V6b,A_27a)
                       => ( p(ap(ap(ap(c_2Erelation_2ETC(A_27a),V1R),V0a),V6b))
                         => p(ap(V2Q,V6b)) ) ) ) ) ) ) ) )).
