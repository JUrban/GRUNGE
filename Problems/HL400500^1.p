...
thf(thm_2Esum_2EINR__neq__INL,axiom,(
    ! [A_27a: d,A_27b: d,V0v1_2E0: u,V1v2_2E0: u] :
      ( (~)
      @ ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V1v2_2E0 ) ) )
        = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V0v1_2E0 ) ) ) ) ) )).

thf(thm_2Eoption_2ENOT__SOME__NONE,conjecture,(
    ! [A_27a: d,V0x_2E0: u] :
      ( (~)
      @ ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) ) )).
