...
thf(thm_2Esptree_2EfromAList__def,conjecture,(
    ! [A_27a: d] :
      ( ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2EfromAList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ c_2Elist_2ENIL_2E0 ) ) )
        = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ c_2Esptree_2ELN_2E0 ) )
      & ! [V0y_2E0: u,V1xs_2E0: u,V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2EfromAList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ A_27a @ V0y_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ V1xs_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2EfromAList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ V1xs_2E0 ) ) ) ) ) ) ) )).
