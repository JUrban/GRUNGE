...
thf(f3492_0_2E0,type,(
    f3492_0_2E0: u )).

thf(f3492_0_2E3,type,(
    f3492_0_2E3: du > du > du > u )).

thf(f3492_0_2E4,type,(
    f3492_0_2E4: du > du > du > du > u )).
...
thf(arityeq3_2Emono_2Ef3492_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f3492_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef3492_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3492_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
...
thf(def0_2Ethm_2EpatternMatches_2EPMATCH__COND__SELECT__UNIQUE,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1g_2E0: u,V2i_2E0: u,V6y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f3492_0_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1g_2E0 ) @ ( s @ A_27b @ V2i_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) )
...
thf(thm_2EpatternMatches_2EPMATCH__COND__SELECT__UNIQUE,conjecture,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1g_2E0: u,V2i_2E0: u] :
     ...
     => ! [V5x_2E0: u] :
         ...
         => ( ( s @ A_27a @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f3492_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1g_2E0 ) @ ( s @ A_27b @ V2i_2E0 ) ) ) ) )
            = ( s @ A_27a @ V5x_2E0 ) ) ) ) )).
