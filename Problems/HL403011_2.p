...
tff(conj_thm_2Eoption_2EIS__SOME__MAP,lemma,(
...
tff(conj_thm_2Elist_2EEXISTS__MAP,lemma,(
...
tff(conj_thm_2EpatternMatches_2EPMATCH__IS__EXHAUSTIVE__LIFT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1v: $i] :
          ( mem(V1v,A_27c)
