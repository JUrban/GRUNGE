...
fof(conj_thm_2Erich__list_2EELL__APPEND1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l2] :
         ...
         => ! [V1n] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l2)),V1n))
               => ! [V2l1] :
                   ...
                   => ap(ap(c_2Erich__list_2EELL(A_27a),V1n),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l1),V0l2)) = ap(ap(c_2Erich__list_2EELL(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l2))),V2l1) ) ) ) ) ) )).
