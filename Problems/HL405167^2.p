...
thf(conj_thm_2Econtainer_2ELIST__TO__BAG__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
                                ...
                                @ ^ [V5list: $i] :
                                    ...
                                    @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2l2 ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3h ) @ V4t ) ) )
                                      @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                                        @ ( lam @ A_27a
                                          @ ^ [V6e: $i] :
                                              ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V6e ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V5list ) ) ) @ ( ap @ ( ap @ V0R @ V6e ) @ V3h ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Econtainer_2EWF__mlt__list,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2EWF @ A_27a ) @ V0R ) )
