...
thf(thm_2Eiterate_2ESUP__INSERT__FINITE,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ V1s )
     => ( ( c_2Ereal_2Esup @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V0x @ V1s ) )
        = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0x @ ( c_2Ereal_2Emax @ V0x @ ( c_2Ereal_2Esup @ V1s ) ) ) ) ) )).

thf(thm_2Eiterate_2EINF__INSERT__FINITE,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Epred__set_2EFINITE @ tyop_2Erealax_2Ereal @ V1s )
     => ( ( c_2Eiterate_2Einf @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V0x @ V1s ) )
        = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ V1s @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ V0x @ ( c_2Ereal_2Emin @ V0x @ ( c_2Eiterate_2Einf @ V1s ) ) ) ) ) )).
...
thf(thm_2Eiterate_2EREAL__SUP__EQ__INF,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( (~)
          @ ( V0s
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
     ...
     => ( ( ( c_2Ereal_2Esup @ V0s )
      ...
      <=> ? [V3a: tyop_2Erealax_2Ereal] :
            ( V0s
            = ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V3a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) ) )).
