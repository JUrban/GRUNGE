...
thf(conj_thm_2Eseq_2ESER__OFFSET,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Eseq_2Esummable @ V0f ) )
       => ! [V1k: tp__ty_2Enum_2Enum] :
            ...
            @ ( ap
              @ ( ap @ c_2Eseq_2Esums
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V2n: $i] :
                      ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2n ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) ) )
              @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ c_2Eseq_2Esuminf @ V0f ) ) @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) @ V0f ) ) ) ) ) ) )).
