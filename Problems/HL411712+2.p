...
fof(conj_thm_2Ereal__topology_2ELIMPT__INJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1f] :
                  ...
                  & ! [V3x] :
                     ...
                     => ! [V4y] :
                         ...
                         => ( ap(V1f,V3x) = ap(V1f,V4y)
                           => V3x = V4y ) ) ) )
               => ( p(ap(ap(c_2Ereal__topology_2Elimit__point__of,ap(V1f,V0x)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1f),V2s)))
                <=> p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V0x),V2s)) ) ) ) ) ) )).
