...
thf(thm_2Ewords_2ELSR__LIMIT,axiom,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ V1n )
     => ( ( c_2Ewords_2Eword__lsr @ A_27a @ V0w @ V1n )
        = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) ) )).

thf(thm_2Ewords_2EWORD__DIV__LSR,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Efcp_2Ecart @ $o @ A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V1n @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ( ( c_2Ewords_2Eword__lsr @ A_27a @ V0m @ V1n )
        = ( c_2Ewords_2Eword__div @ A_27a @ V0m @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) ) ) ) ) )).

thf(thm_2Ewords_2En2w__DIV,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0a @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ( ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2EDIV @ V0a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1n ) ) )
        = ( c_2Ewords_2Eword__lsr @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ V0a ) @ V1n ) ) ) )).
