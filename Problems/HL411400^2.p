...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__REFL,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__INTERMEDIATE__SUBSET,conjecture,(
    ! [V0t: $i] :
      ( ( mem @ V0t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1u: $i] :
          ( ( mem @ V1u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V1u ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) @ V0t ) )
                & ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0t ) @ V1u ) ) )
             => ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0t ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) )
                = ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V1u ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) ) ) ) )).
