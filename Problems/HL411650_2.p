...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
                  ...
                  & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),V0s))
                        ...
                        & surj__ty_2Erealax_2Ereal(ap(V1f,inj__ty_2Erealax_2Ereal(V3x))) = surj__ty_2Erealax_2Ereal(ap(V1f,inj__ty_2Erealax_2Ereal(V4y))) )
                     => V3x = V4y ) )
               => ? [V5g: $i] :
                    ( mem(V5g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                    & p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V2t)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V1f),V5g))) ) ) ) ) ) )).
