...
fof(conj_thm_2Eprim__rec_2ELESS__SUC,lemma,(
    ! [V0m] :
...
fof(conj_thm_2Eprim__rec_2ELESS__SUC__IMP,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elist_2EALL__DISTINCT__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Elist_2EALL__DISTINCT__GENLIST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
