...
thf(ax_thm_2Eordinal_2EfromNat__def,axiom,(
    ! [A_27a: del] :
      ...
      & ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
          = ( ap @ ( c_2Eordinal_2EordSUC @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).

thf(conj_thm_2Eordinal_2EfromNat__SUC,conjecture,(
