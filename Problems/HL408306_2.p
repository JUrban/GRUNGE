...
tff(conj_thm_2Elim_2EDIFF__ISCONST__ALL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Etransc_2ESIN__0,lemma,(
    surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esin,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
...
tff(conj_thm_2Etransc_2ESIN__COS__ADD,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Epow,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Etransc_2Esin,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V1y)))),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V1y)))))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(ap(c_2Ereal_2Epow,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Etransc_2Ecos,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))),ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V1y)))),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V1y)))))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
