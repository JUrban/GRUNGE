...
thf(thm_2Ecombin_2EW__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1x_27_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ecombin_2EW_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V0x_2E0 ) @ ( s @ A_27a @ V1x_27_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ V0x_2E0 ) @ ( s @ A_27a @ V1x_27_2E0 ) ) ) @ ( s @ A_27a @ V1x_27_2E0 ) ) ) ) )).

thf(thm_2Ecombin_2EW__THM,conjecture,(
