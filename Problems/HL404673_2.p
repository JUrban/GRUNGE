...
tff(conj_thm_2Efinite__map_2EFMERGE__NO__CHANGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
     ...
     => ! [V1f1: $i] :
         ...
         => ! [V2f2: $i] :
             ...
             => ( ( ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m),V1f1),V2f2) = V1f1
                <=> ! [V3x: $i] :
                      ( mem(V3x,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2f2)))
                       => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f1)))
                          & ap(ap(V0m,ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1f1),V3x)),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2f2),V3x)) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1f1),V3x) ) ) ) )
                & ( ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m),V1f1),V2f2) = V2f2
                <=> ! [V4x: $i] :
                      ( mem(V4x,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f1)))
                       => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2f2)))
                          & ap(ap(V0m,ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1f1),V4x)),ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2f2),V4x)) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2f2),V4x) ) ) ) ) ) ) ) ) )).
