...
fof(conj_thm_2Ecardinal_2ENUM__COUNTABLE,lemma,(
...
fof(conj_thm_2Ecardinal_2EFORALL__COUNTABLE__AS__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
         ...
         => ( ! [V1d] :
          ...
          <=> ( p(ap(V0P,c_2Epred__set_2EEMPTY(A_27a)))
              & ! [V2f] :
                 ...
                 => p(ap(V0P,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) ) ) ) )).
