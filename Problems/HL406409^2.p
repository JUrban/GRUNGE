...
thf(conj_thm_2Ehrat_2ETRAT__SUCINT,lemma,
    ( ( p @ ( ap @ ( ap @ c_2Ehrat_2Etrat__eq @ ( ap @ c_2Ehrat_2Etrat__sucint @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ c_2Ehrat_2Etrat__1 ) )
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ( p @ ( ap @ ( ap @ c_2Ehrat_2Etrat__eq @ ( ap @ c_2Ehrat_2Etrat__sucint @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ ( ap @ ( ap @ c_2Ehrat_2Etrat__add @ ( ap @ c_2Ehrat_2Etrat__sucint @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ c_2Ehrat_2Etrat__1 ) ) ) )).
...
thf(conj_thm_2Ehrat_2EHRAT__SUCINT,conjecture,
