...
fof(conj_thm_2Epred__set_2ECROSS__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Epred__set_2EUNIV(ty_2Epair_2Eprod(A_27a,A_27a)) = ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(A_27b)) ) ) )).

fof(conj_thm_2Epred__set_2EINFINITE__PAIR__UNIV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( p(ap(c_2Epred__set_2EFINITE(ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epred__set_2EUNIV(ty_2Epair_2Eprod(A_27a,A_27a))))
