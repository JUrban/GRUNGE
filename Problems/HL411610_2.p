...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
            ...
            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V3a)))
            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3a)),inj__ty_2Erealax_2Ereal(V2y))) )
         => ? [V4z: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4z)),V0s))
              & V4z = V3a ) ) ) )).

tff(conj_thm_2Ereal__topology_2EMAPPING__CONNECTED__ONTO__SEGMENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
            & ~ ? [V3a: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3a)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) )
         => ? [V4f: $i] :
              ( mem(V4f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
              & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V4f),V0s))
              & ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4f),V0s) = ap(c_2Ereal__topology_2Eclosed__segment,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) ) ) )).
