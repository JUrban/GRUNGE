     ...
     => ( ( ap @ ( ap @ ( c_2Efcp_2E_3A_2B @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ V1b )
        = ( lam @ ( ty_2Efcp_2Ecart @ A_27a @ A_27b )
          @ ^ [V2m: $i] :
              ...
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3c: $i] :
                    ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ V3c ) ) @ V1b ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ A_27a @ A_27b ) @ V2m ) @ V3c ) ) ) ) ) ) ) )).
     ...
     => ! [V1w: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__modify @ A_27a ) @ V0f ) @ V1w )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ ( ap @ V0f @ V2i ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ V2i ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2EBIT__UPDATE,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: $o] :
      ( ( ap @ ( ap @ ( c_2Efcp_2E_3A_2B @ bool @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__o @ V1x ) )
      = ( ap @ ( c_2Ewords_2Eword__modify @ A_27a )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V2i: $i] :
              ( lam @ bool
              @ ^ [V3b: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V2i ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__o @ V1x ) ) @ V3b ) ) ) ) ) )).
