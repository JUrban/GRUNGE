...
fof(conj_thm_2Eiterate_2ESUM__INJECTION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
                      ...
                      & ! [V4x] :
                         ...
                         => ! [V5y] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),V2s))
                               ...
                               => V4x = V5y ) ) ) )
                   => ap(ap(c_2Eiterate_2ESum(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V0f),V1p)) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V0f) ) ) ) ) ) )).
