...
fof(mem_c_2Estate__transformer_2EFOR,axiom,(
    ! [A_27state] :
      ( ne(A_27state)
     => mem(c_2Estate__transformer_2EFOR(A_27state),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))) ) )).

fof(lamtp_f501,axiom,(
    ! [A_27state,V1a] :
     ...
     => ! [V0R] :
         ...
         => ! [V2j] :
             ...
             => mem(f501(A_27state,V1a,V0R,V2j),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
fof(lameq_f500,axiom,(
    ! [A_27state,V0R] :
     ...
     => ! [V1a] :
         ...
         => ! [V2j] :
              ( mem(V2j,ty_2Enum_2Enum)
             => ap(f500(A_27state,V0R,V1a),V2j) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f501(A_27state,V1a,V0R,V2j)) ) ) ) )).

fof(lamtp_f499,axiom,(
    ! [A_27state,V0R] :
      ( mem(V0R,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool)))
...
fof(lamtp_f498,axiom,(
    ! [A_27state,A_27state] : mem(f498(A_27state,A_27state),arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool)),bool)) )).
...
fof(lameq_f506,axiom,(
    ! [A_27state,V6i] :
     ...
     => ! [V4FOR] :
         ...
         => ! [V8j] :
              ( mem(V8j,ty_2Enum_2Enum)
             => ap(f506(A_27state,V6i,V4FOR),V8j) = f507(A_27state,V6i,V8j,V4FOR) ) ) ) )).

fof(lamtp_f505,axiom,(
    ! [A_27state,A_27state,V4FOR] :
      ( mem(V4FOR,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
     => ! [V6i] :
          ( mem(V6i,ty_2Enum_2Enum)
         => mem(f505(A_27state,A_27state,V4FOR,V6i),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))) ) ) )).
...
fof(lameq_f504,axiom,(
    ! [A_27state,A_27state,V4FOR] :
     ...
     => ! [V6i] :
          ( mem(V6i,ty_2Enum_2Enum)
         => ap(f504(A_27state,A_27state,V4FOR),V6i) = f505(A_27state,A_27state,V4FOR,V6i) ) ) )).

fof(lamtp_f503,axiom,(
    ! [A_27state,V4FOR] :
      ( mem(V4FOR,arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
...
fof(lamtp_f502,axiom,(
    ! [A_27state,A_27state] : mem(f502(A_27state,A_27state),arr(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))) )).
...
fof(ax_thm_2Estate__transformer_2EFOR__primitive__def,axiom,(
    ! [A_27state] :
      ( ne(A_27state)
     => c_2Estate__transformer_2EFOR(A_27state) = ap(ap(c_2Erelation_2EWFREC(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Emin_2E_40(arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),bool))),f498(A_27state,A_27state))),f502(A_27state,A_27state)) ) )).

fof(conj_thm_2Estate__transformer_2EFOR__def,conjecture,(
    ! [A_27state] :
      ( ne(A_27state)
     => ! [V0j] :
         ...
         => ! [V1i] :
             ...
             => ! [V2a] :
                 ...
                 => ap(c_2Estate__transformer_2EFOR(A_27state),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1i),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0j),V2a))) = ap(ap(ap(c_2Ebool_2ECOND(arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1i),V0j)),ap(V2a,V1i)),ap(ap(c_2Estate__transformer_2EBIND(A_27state,A_27state,A_27state),ap(V2a,V1i)),k(ty_2Eone_2Eone,ap(c_2Estate__transformer_2EFOR(A_27state),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V1i),V0j)),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Earithmetic_2E_2D,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0j),V2a)))))) ) ) ) ) )).
