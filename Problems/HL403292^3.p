...
thf(thm_2Ebag_2EBAG__OF__SET,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o] :
      ( ( c_2Ebag_2EBAG__OF__SET @ A_27a @ V0P )
      = ( ^ [V1x: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebool_2EIN @ A_27a @ V1x @ V0P ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ c_2Enum_2E0 ) ) ) )).
...
thf(thm_2Ebag_2ESET__OF__EMPTY,conjecture,(
    ! [A_27a: $tType] :
      ( ( c_2Ebag_2EBAG__OF__SET @ A_27a @ ( c_2Epred__set_2EEMPTY @ A_27a ) )
      = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )).
