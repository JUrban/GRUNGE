...
fof(conj_thm_2Eind__type_2ENUMPAIR__INJ,lemma,(
    ! [V0x1] :
...
fof(conj_thm_2Epred__set_2EBIJ__INJ__SURJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eutil__prob_2ENUM__2D__BIJ__NZ__ALT2,conjecture,(
    ? [V0f] :
