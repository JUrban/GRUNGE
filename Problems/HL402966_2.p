...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__NIL,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1i: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),c_2Elist_2ENIL(arr(A_27a,ty_2Eoption_2Eoption(A_27b)))),inj__ty_2Enum_2Enum(V1i)))
        <=> $false ) ) )).
