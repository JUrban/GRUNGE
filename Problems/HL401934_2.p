...
tff(conj_thm_2Edivides_2EDIVIDES__ANTISYM,lemma,(
...
tff(conj_thm_2Egcdset_2Egcdset__divides,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Egcdset_2Egcdset__greatest,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Egcdset_2Egcdset__INSERT,conjecture,(
