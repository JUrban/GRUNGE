...
fof(mem_c_2Erelation_2EEQC,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(mem_c_2Erelation_2ESC,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(mem_c_2Erelation_2Eequivalence,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(mem_c_2Erelation_2Esymmetric,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(ax_thm_2Erelation_2Eequivalence__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(ax_thm_2Erelation_2EEQC__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2ESC__SYMMETRIC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2ETC__TRANSITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2Esymmetric__RC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2ETC__RC__EQNS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2Esymmetric__TC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2EEQC__EQUIVALENCE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
