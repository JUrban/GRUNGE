...
fof(lameq_f2883,axiom,(
    ! [V0f] :
     ...
     => ! [V1s] :
          ( mem(V1s,ty_2Erealax_2Ereal)
         => ap(f2883(V0f),V1s) = ap(ap(c_2Eseq_2Esums,V0f),V1s) ) ) )).

fof(ax_thm_2Eseq_2Esuminf,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ap(c_2Eseq_2Esuminf,V0f) = ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2883(V0f)) ) )).

fof(conj_thm_2Eseq_2ESUMMABLE__SUM,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Esummable,V0f))
