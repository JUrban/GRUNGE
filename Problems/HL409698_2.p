...
tff(lmtp_f3300,type,(
    f3300: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3300,axiom,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,A_27a))
         => ! [V2g: $i] :
             ...
             => mem(f3300(A_27a,A_27b,V0op,V1f,V2g),arr(A_27b,A_27a)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,V0op: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2g: $i] :
             ...
             => ! [V4x: $i] :
                  ( mem(V4x,A_27b)
                 => ap(f3300(A_27a,A_27b,V0op,V1f,V2g),V4x) = ap(ap(V0op,ap(V1f,V4x)),ap(V2g,V4x)) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EITERATE__OP,lemma,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27a,arr(A_27a,A_27a)))
     => ( p(ap(c_2Eiterate_2Emonoidal(A_27a),V0op))
       => ! [V1f: $i] :
           ...
           => ! [V2g: $i] :
               ...
               => ! [V3s: $i] :
                   ...
                   => ( p(ap(c_2Epred__set_2EFINITE(A_27b),V3s))
                     => ap(ap(ap(c_2Eiterate_2Eiterate(A_27b,A_27b),V0op),V3s),f3300(A_27a,A_27b,V0op,V1f,V2g)) = ap(ap(V0op,ap(ap(ap(c_2Eiterate_2Eiterate(A_27b,A_27b),V0op),V3s),V1f)),ap(ap(ap(c_2Eiterate_2Eiterate(A_27b,A_27b),V0op),V3s),V2g)) ) ) ) ) ) ) )).

tff(conj_thm_2Eiterate_2EITERATE__SUPERSET,lemma,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27b,arr(A_27b,A_27b)))
           ...
           => ! [V2u: $i] :
               ...
               => ! [V3v: $i] :
                   ...
                   => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V2u),V3v))
                     ...
                     => ap(ap(ap(c_2Eiterate_2Eiterate(A_27a,A_27a),V0op),V3v),V1f) = ap(ap(ap(c_2Eiterate_2Eiterate(A_27a,A_27a),V0op),V2u),V1f) ) ) ) ) ) ) )).
...
tff(conj_thm_2Eiterate_2EITERATE__OP__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
      ( mem(V0op,arr(A_27b,arr(A_27b,A_27b)))
     => ( p(ap(c_2Eiterate_2Emonoidal(A_27b),V0op))
       => ! [V1f: $i] :
