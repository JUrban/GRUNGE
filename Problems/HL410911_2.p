...
tff(conj_thm_2Ereal__topology_2ELINEAR__SUB,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ELINEAR__BOUNDED__POS,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Ereal__topology_2Elinear,V0f))
...
tff(lamtp_f3741,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1h: $i] :
          ( mem(V1h,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3741(A_27a,V2f,V1h),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3741,axiom,(
    ! [A_27a: del,V2f: $i] :
      ( mem(V2f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1h: $i] :
          ( mem(V1h,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3741(A_27a,V2f,V1h),V4x) = ap(V1h,ap(V2f,V4x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__LINEAR,conjecture,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1h: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3741(A_27a,V2f,V1h)),ap(V1h,inj__ty_2Erealax_2Ereal(V3l))),V0net)) ) ) ) ) )).
