...
thf(thm_2Ebag_2EBAG__DELETE__INSERT,conjecture,(
    ! [A_27a: $tType,V0x: A_27a,V1y: A_27a,V2b1: A_27a > tyop_2Enum_2Enum,V3b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__DELETE @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V2b1 ) @ V1y @ V3b2 )
     => ( ( ( V0x = V1y )
          & ( V2b1 = V3b2 ) )
        | ( ? [V4b3: A_27a > tyop_2Enum_2Enum] :
              ( c_2Ebag_2EBAG__DELETE @ A_27a @ V2b1 @ V1y @ V4b3 )
          & ( (~) @ ( V0x = V1y ) ) ) ) ) )).
