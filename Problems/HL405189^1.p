...
thf(thm_2Ealist_2EALOOKUP__ind,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u] :
      ( ( ! [V1q_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ c_2Elist_2ENIL_2E0 ) ) ) @ ( s @ A_27b @ V1q_2E0 ) ) ) )
        & ! [V2x_2E0: u,V3y_2E0: u,V4t_2E0: u,V5q_2E0: u] :
            ( ( ( (~)
                @ ( ( s @ A_27b @ V2x_2E0 )
                  = ( s @ A_27b @ V5q_2E0 ) ) )
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V4t_2E0 ) ) ) @ ( s @ A_27b @ V5q_2E0 ) ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27b @ V2x_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V4t_2E0 ) ) ) ) ) @ ( s @ A_27b @ V5q_2E0 ) ) ) ) ) )
     => ! [V6v_2E0: u,V7v1_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ V6v_2E0 ) ) ) @ ( s @ A_27b @ V7v1_2E0 ) ) ) ) ) )).
...
thf(thm_2Ealist_2EALOOKUP__prefix,conjecture,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1ls_2E0: u,V2k_2E0: u,V3ls2_2E0: u] :
      ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1ls_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V0v_2E0 ) ) ) )
       => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1ls_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V3ls2_2E0 ) ) ) @ ( s @ A_27a @ V2k_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V0v_2E0 ) ) ) ) )
      & ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1ls_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ c_2Eoption_2ENONE_2E0 ) )
       => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1ls_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V3ls2_2E0 ) ) ) @ ( s @ A_27a @ V2k_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V3ls2_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) ) ) ) ) )).
