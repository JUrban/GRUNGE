...
thf(c_2Esptree_2Emk__wf_2E0,type,(
    c_2Esptree_2Emk__wf_2E0: u )).

thf(c_2Esptree_2Emk__wf_2E1,type,(
    c_2Esptree_2Emk__wf_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ec_2Esptree_2Emk__wf_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Emk__wf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Esptree_2Espt @ A_27a ) ) @ c_2Esptree_2Emk__wf_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Esptree_2Ewf__mk__wf,axiom,(
    ! [A_27a: d,V0t_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Ewf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Emk__wf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) ) ) )).

thf(thm_2Esptree_2Elookup__mk__wf,axiom,(
    ! [A_27a: d,V0x: mono_2Etyop_2Enum_2Enum,V1t_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Emk__wf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1t_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1t_2E0 ) ) ) ) )).

thf(thm_2Esptree_2Emk__wf__eq,conjecture,(
    ! [A_27a: d,V0t1_2E0: u,V1t2_2E0: u] :
      ( ( ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Emk__wf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t1_2E0 ) ) )
        = ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2Emk__wf_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1t2_2E0 ) ) ) )
