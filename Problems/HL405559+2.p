...
fof(conj_thm_2Equotient_2EEXISTS__PRS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Equotient_2ERES__EXISTS__RSP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Equotient_2EEQUIV__RES__EXISTS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0E] :
          ( mem(V0E,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Equotient_2ERIGHT__RES__FORALL__REGULAR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Eordinal_2Epreds__11,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w1] :
...
fof(conj_thm_2Eordinal_2Epreds__downward__closed,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
...
fof(conj_thm_2Eordinal_2Epreds__bij,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),c_2Eordinal_2Epreds(A_27a)),c_2Epred__set_2EUNIV(ty_2Eordinal_2Eordinal(A_27a))),ap(ap(c_2Epred__set_2EDELETE(arr(ty_2Eordinal_2Eordinal(A_27a),bool)),c_2Eordinal_2Edownward__closed(A_27a)),c_2Epred__set_2EUNIV(ty_2Eordinal_2Eordinal(A_27a))))) ) )).
