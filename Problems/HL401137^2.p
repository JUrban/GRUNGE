...
thf(stp_fo_c_2Eind__type_2ENUMSUM,type,(
    fo__c_2Eind__type_2ENUMSUM: $o > tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Eind__type_2ENUMSUM,axiom,(
    ! [X0: $o,X1: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Eind__type_2ENUMSUM @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Eind__type_2ENUMSUM @ ( inj__o @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) ) )).
...
thf(stp_fo_c_2Eind__type_2ENUMLEFT,type,(
    fo__c_2Eind__type_2ENUMLEFT: tp__ty_2Enum_2Enum > $o )).

thf(stp_eq_fo_c_2Eind__type_2ENUMLEFT,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] :
      ( ( inj__o @ ( fo__c_2Eind__type_2ENUMLEFT @ X0 ) )
      = ( ap @ c_2Eind__type_2ENUMLEFT @ ( inj__ty_2Enum_2Enum @ X0 ) ) ) )).
...
thf(ax_thm_2Eind__type_2ENUMSUM__DEST,axiom,(
    ! [V0x: $o,V1y: tp__ty_2Enum_2Enum] :
      ( ( ( p @ ( ap @ c_2Eind__type_2ENUMLEFT @ ( ap @ ( ap @ c_2Eind__type_2ENUMSUM @ ( inj__o @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) ) )
      <=> ( p @ ( inj__o @ V0x ) ) )
      & ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Eind__type_2ENUMRIGHT @ ( ap @ ( ap @ c_2Eind__type_2ENUMSUM @ ( inj__o @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) ) )
        = V1y ) ) )).
         ...
         => ( ( ap @ ( ap @ ( c_2Eind__type_2EINJP @ A_27a ) @ V0f1 ) @ V1f2 )
            = ( lam @ ty_2Enum_2Enum
              @ ^ [V2n: $i] :
                  ( lam @ A_27a
                  @ ^ [V3a: $i] :
                      ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ c_2Eind__type_2ENUMLEFT @ V2n ) ) @ ( ap @ ( ap @ V0f1 @ ( ap @ c_2Eind__type_2ENUMRIGHT @ V2n ) ) @ V3a ) ) @ ( ap @ ( ap @ V1f2 @ ( ap @ c_2Eind__type_2ENUMRIGHT @ V2n ) ) @ V3a ) ) ) ) ) ) ) )).

thf(conj_thm_2Eind__type_2EINJP__INJ,conjecture,(
    ! [A_27a: del,V0f1: $i] :
      ( ( mem @ V0f1 @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ bool ) ) )
     => ! [V1f1_27: $i] :
