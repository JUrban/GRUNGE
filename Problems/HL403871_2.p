...
tff(conj_thm_2Ellist_2ELLENGTH__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
         => surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27b),ap(ap(c_2Ellist_2ELMAP(A_27a,A_27a),V1f),V0ll))) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),V0ll)) ) ) )).
