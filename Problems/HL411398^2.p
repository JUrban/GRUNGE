...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__OVERLAP,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EBIGUNION__DIFF,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ V0s ) ) @ V1t )
            = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                @ ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V2x ) @ V1t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2x ) @ V0s ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EOPEN__IN__CONNECTED__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p
            @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ty_2Erealax_2Ereal )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ V2x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2x ) @ V0s ) ) ) ) ) )
         => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V0s ) ) @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) ) )).
