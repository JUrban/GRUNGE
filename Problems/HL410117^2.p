...
thf(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__MONO,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Emeasure_2Esigma__algebra @ A_27a ) @ V0a ) )
      <=> ( ( p @ ( ap @ ( c_2Emeasure_2Ealgebra @ A_27a ) @ V0a ) )
...
thf(conj_thm_2Eseq_2ETRANSFORM__2D__NUM,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Emeasure_2ESIGMA__ALGEBRA__ALT__DISJOINT,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Emeasure_2Esigma__algebra @ A_27a ) @ V0a ) )
      <=> ( ( p @ ( ap @ ( c_2Emeasure_2Ealgebra @ A_27a ) @ V0a ) )
