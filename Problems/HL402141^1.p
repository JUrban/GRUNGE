...
thf(f2379_0_2E0,type,(
    f2379_0_2E0: u )).

thf(f2379_0_2E2,type,(
    f2379_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef2379_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2379_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f2379_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elist_2EWF__LIST__PRED,axiom,(
    ! [A_27a: d,V0L1_2E0: u,V1L2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2379_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L2_2E0 ) ) ) )
    <=> ? [V2h_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L2_2E0 )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L1_2E0 ) ) ) ) ) )).

thf(thm_2Elist_2EWF__LIST__PRED,conjecture,(
    ! [A_27a: d] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EWF_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ f2379_0_2E0 ) ) ) ) )).
