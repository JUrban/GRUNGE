...
tff(conj_thm_2Earithmetic_2EMODEQ__THM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m1: tp__ty_2Enum_2Enum,V2m2: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(ap(c_2Earithmetic_2EMODEQ,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m1)),inj__ty_2Enum_2Enum(V2m2)))
    <=> ( ( V0n = fo__c_2Enum_2E0
          & V1m1 = V2m2 )
        | ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)))
          & surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1m1)),inj__ty_2Enum_2Enum(V0n))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V2m2)),inj__ty_2Enum_2Enum(V0n))) ) ) ) )).

tff(conj_thm_2Earithmetic_2EMODEQ__EXP__CONG,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum,V3e: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(ap(c_2Earithmetic_2EMODEQ,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V2y)))
     => p(ap(ap(ap(c_2Earithmetic_2EMODEQ,inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Earithmetic_2EEXP,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V3e))),ap(ap(c_2Earithmetic_2EEXP,inj__ty_2Enum_2Enum(V2y)),inj__ty_2Enum_2Enum(V3e)))) ) )).

tff(conj_thm_2Earithmetic_2EEXP__MOD,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2e: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)))
     => surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2EEXP,ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V2e))),inj__ty_2Enum_2Enum(V0n))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2EMOD,ap(ap(c_2Earithmetic_2EEXP,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V2e))),inj__ty_2Enum_2Enum(V0n))) ) )).
