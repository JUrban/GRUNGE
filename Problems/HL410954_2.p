...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__AT,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELIM__WITHIN,lemma,(
    ! [V0f: $i] :
...
tff(lamtp_f3788,axiom,(
    ! [V3s: $i] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V4t: $i] :
          ( mem(V4t,arr(ty_2Erealax_2Ereal,bool))
         => mem(f3788(V3s,V4t),arr(ty_2Erealax_2Ereal,bool)) ) ) )).

tff(lameq_f3788,axiom,(
    ! [V3s: $i] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V4t: $i] :
          ( mem(V4t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3788(V3s,V4t),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V3s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V4t)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN__SET,conjecture,(
    ! [V0l: tp__ty_2Erealax_2Ereal,V1f: $i] :
     ...
     => ! [V2a: tp__ty_2Erealax_2Ereal,V3s: $i] :
         ...
         => ! [V4t: $i] :
              ( mem(V4t,arr(ty_2Erealax_2Ereal,bool))
             => ( p(ap(ap(c_2Ereal__topology_2Eeventually(ty_2Erealax_2Ereal),f3788(V3s,V4t)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V2a))))
