...
fof(conj_thm_2Efinite__map_2Eis__fmap__rules,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),k(A_27a,ap(c_2Esum_2EINR(A_27b,A_27b),c_2Eone_2Eone))))
            & ! [V1f] :
                ( mem(V1f,arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))
               => ! [V2a] :
                    ( mem(V2a,A_27a)
