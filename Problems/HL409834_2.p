...
tff(conj_thm_2Eiterate_2ESUM__MULTICOUNT__GEN,lemma,(
...
tff(conj_thm_2Eiterate_2ESUM__MULTICOUNT,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
             ...
             => ! [V3k: tp__ty_2Enum_2Enum] :
                  ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                    ...
                    & ! [V4j: $i] :
                        ( mem(V4j,A_27b)
                       => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V4j),V2t))
                         => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3325(A_27b,A_27a,V1s,V0R,V4j)))) = V3k ) ) )
                 => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3373(A_27b,A_27a,V0R,V2t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3k)),ap(c_2Epred__set_2ECARD(A_27b),V2t)))) ) ) ) ) )).
