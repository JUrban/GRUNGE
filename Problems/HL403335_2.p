...
tff(conj_thm_2Ebag_2EBAG__INN__BAG__UNION,lemma,(
         ...
         => ! [V3b2: $i] :
             ...
             => ( p(ap(ap(ap(c_2Ebag_2EBAG__INN(A_27a),V1e),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Ebag_2EBAG__UNION(A_27a),V2b1),V3b2)))
              <=> ? [V4m1: tp__ty_2Enum_2Enum,V5m2: tp__ty_2Enum_2Enum] :
                    ( V0n = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4m1)),inj__ty_2Enum_2Enum(V5m2)))
...
tff(conj_thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
