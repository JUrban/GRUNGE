...
tff(mem_c_2Erich__list_2ESCANL,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erich__list_2ESCANL(A_27a,A_27a),arr(arr(A_27b,arr(A_27a,A_27b)),arr(A_27b,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27b))))) )).
...
tff(conj_thm_2Erich__list_2ELENGTH__SCANL,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(ap(ap(c_2Erich__list_2ESCANL(A_27b,A_27b),V0f),V1e),V2l))) = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,ap(c_2Elist_2ELENGTH(A_27b),V2l))) ) ) ) )).
