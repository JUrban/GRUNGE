...
tff(conj_thm_2Ellist_2ELLIST__EQ,lemma,(
...
tff(conj_thm_2Epath_2Elabels__plink,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1p2: $i] :
          ( mem(V1p2,ty_2Epath_2Epath(A_27a,A_27a))
         => ap(c_2Epath_2Elabels(A_27a,A_27a),ap(ap(c_2Epath_2Eplink(A_27a,A_27a),V0p1),V1p2)) = ap(ap(c_2Ellist_2ELAPPEND(A_27b),ap(c_2Epath_2Elabels(A_27a,A_27a),V0p1)),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p2)) ) ) )).
