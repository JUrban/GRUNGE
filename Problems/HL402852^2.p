...
thf(conj_thm_2Erich__list_2ESPLITP__EVERY,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
         ...
         => ( ( p
              @ ( ap
                ...
                @ V1l ) )
           => ( ( ap @ ( ap @ ( c_2Erich__list_2ESPLITP @ A_27a ) @ V0P ) @ V1l )
              = ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) @ V1l ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) ) )).
