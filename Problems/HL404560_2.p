...
tff(conj_thm_2Ecardinal_2ECARD__LT__CARD,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__ADD__C,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
              & p(ap(c_2Epred__set_2EFINITE(A_27b),V1t)) )
           => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epred__set_2ECARD(A_27a),V0s)),ap(c_2Epred__set_2ECARD(A_27b),V1t))) ) ) ) )).

tff(conj_thm_2Ecardinal_2ECARD__LE__ADDR,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__ADD__FINITE__EQ,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__ADD2__ABSORB__LT,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__LT__ADD,conjecture,(
