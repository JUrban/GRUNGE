...
tff(conj_thm_2Eseq_2ESER__LE2,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( ( ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V2n)))),ap(V1g,inj__ty_2Enum_2Enum(V2n))))
              & p(ap(c_2Eseq_2Esummable,V1g)) )
           => ( p(ap(c_2Eseq_2Esummable,V0f))
              & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Eseq_2Esuminf,V0f)),ap(c_2Eseq_2Esuminf,V1g))) ) ) ) ) )).
