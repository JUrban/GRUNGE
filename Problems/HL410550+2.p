...
fof(conj_thm_2Etopology_2ECLOSED__IN__TOPSPACE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__SUBTOPOLOGY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__SUBTOPOLOGY__REFL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0top] :
          ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
