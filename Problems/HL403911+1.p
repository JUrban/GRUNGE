...
fof(arityeq2_2Ec_2Ellist_2Eexists_2E2_2EA_27a,axiom,(
...
fof(thm_2Ellist_2Eexists__thm,axiom,(
    ! [A_27a,V0t_2E0,V1h_2E0,V2P_2E0] :
      ( s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2P_2E0),s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELNIL_2E0))) = s(tyop_2Emin_2Ebool,c_2Ebool_2EF_2E0)
      & ( p(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2P_2E0),s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELCONS_2E2(s(A_27a,V1h_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0t_2E0))))))
      <=> ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2P_2E0),s(A_27a,V1h_2E0))))
          | p(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0t_2E0)))) ) ) ) )).

fof(thm_2Ellist_2Eexists__strong__ind,axiom,(
    ! [A_27a,V0P_2E0,V1Q_2E0] :
      ( ( ! [V2h_2E0,V3t_2E0] :
        ...
        & ! [V4h_2E0,V5t_2E0] :
            ( ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool),V1Q_2E0),s(tyop_2Ellist_2Ellist(A_27a),V5t_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V5t_2E0)))) )
     ...
     => ! [V6a0_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V6a0_2E0))))
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27a),tyop_2Emin_2Ebool),V1Q_2E0),s(tyop_2Ellist_2Ellist(A_27a),V6a0_2E0)))) ) ) )).
...
fof(thm_2Ellist_2Eexists__LDROP,conjecture,(
    ! [A_27a,V0ll_2E0,V1P_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ellist_2Eexists_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0))))
    <=> ? [V2n_2E0,V3a_2E0,V4t_2E0] :
          ( s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,V2n_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELCONS_2E2(s(A_27a,V3a_2E0),s(tyop_2Ellist_2Ellist(A_27a),V4t_2E0)))))
          & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V3a_2E0)))) ) ) )).
