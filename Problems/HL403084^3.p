...
thf(thm_2ETemporal__Logic_2ESWHEN__AS__WHEN,conjecture,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ( ( c_2ETemporal__Logic_2ESWHEN @ V1a @ V0b )
      = ( ^ [V2t0: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_2F_5C @ ( c_2ETemporal__Logic_2EWHEN @ V1a @ V0b @ V2t0 ) @ ( c_2ETemporal__Logic_2EEVENTUAL @ V0b @ V2t0 ) ) ) ) )).
