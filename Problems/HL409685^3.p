...
thf(thm_2Eiterate_2EITERATE__SING,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27b > A_27b > A_27b] :
      ( ( c_2Eiterate_2Emonoidal @ A_27b @ V0op )
     => ! [V1f: A_27a > A_27b,V2x: A_27a] :
          ( ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ ( c_2Epred__set_2EINSERT @ A_27a @ V2x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V1f )
          = ( V1f @ V2x ) ) ) )).

thf(thm_2Eiterate_2EITERATE__DELTA,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27a > A_27a > A_27a] :
      ( ( c_2Eiterate_2Emonoidal @ A_27a @ V0op )
