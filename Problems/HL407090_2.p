...
tff(conj_thm_2Ehreal_2EHREAL__SUB__ADD,lemma,(
...
tff(lmtp_f2707,type,(
    f2707: ( tp__ty_2Ehreal_2Ehreal * tp__ty_2Ehreal_2Ehreal ) > $i )).

tff(lamtp_f2707,axiom,(
    ! [V1y: tp__ty_2Ehreal_2Ehreal,V0x: tp__ty_2Ehreal_2Ehreal] : mem(f2707(V1y,V0x),arr(ty_2Ehreal_2Ehreal,bool)) )).

tff(lameq_f2707,axiom,(
    ! [V1y: tp__ty_2Ehreal_2Ehreal,V0x: tp__ty_2Ehreal_2Ehreal,V2d: tp__ty_2Ehreal_2Ehreal] : ap(f2707(V1y,V0x),inj__ty_2Ehreal_2Ehreal(V2d)) = ap(ap(c_2Emin_2E_3D(ty_2Ehreal_2Ehreal),inj__ty_2Ehreal_2Ehreal(V0x)),ap(ap(c_2Ehreal_2Ehreal__add,inj__ty_2Ehreal_2Ehreal(V1y)),inj__ty_2Ehreal_2Ehreal(V2d))) )).

tff(ax_thm_2Erealax_2Ehreal__of__treal,axiom,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal] : surj__ty_2Ehreal_2Ehreal(ap(c_2Erealax_2Ehreal__of__treal,ap(ap(c_2Epair_2E_2C(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal),inj__ty_2Ehreal_2Ehreal(V0x)),inj__ty_2Ehreal_2Ehreal(V1y)))) = surj__ty_2Ehreal_2Ehreal(ap(c_2Emin_2E_40(ty_2Ehreal_2Ehreal),f2707(V1y,V0x))) )).

tff(conj_thm_2Erealax_2ETREAL__BIJ,conjecture,
