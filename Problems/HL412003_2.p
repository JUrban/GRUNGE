...
tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__indicator,lemma,(
    ! [A_27a: del,V0m: $i] :
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__pos__simple__fn,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__indicator,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
