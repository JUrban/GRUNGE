...
thf(thm_2Eseq_2EINCREASING__SEQ,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal] :
      ( ( ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( V0f @ V2n ) @ ( V0f @ ( c_2Enum_2ESUC @ V2n ) ) )
        & ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( V0f @ V3n ) @ V1l )
        & ! [V4e: tyop_2Erealax_2Ereal] :
            ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V4e )
           => ? [V5n: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__lt @ V1l @ ( c_2Erealax_2Ereal__add @ ( V0f @ V5n ) @ V4e ) ) ) )
