...
thf(conj_thm_2Ecardinal_2EIMP__CONJ__ALT,lemma,(
    ! [V0r: $o,V1p: $o,V2q: $o] :
      ( ( ( ( p @ ( inj__o @ V1p ) )
          & ( p @ ( inj__o @ V2q ) ) )
       => ( p @ ( inj__o @ V0r ) ) )
...
thf(conj_thm_2Ereal_2EREAL__ADD__SUB__ALT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
      = V0x ) )).

thf(conj_thm_2Ereal__topology_2EREAL__BOUNDS__LT,lemma,(
...
thf(conj_thm_2Ereal__topology_2ENETLIMIT__AT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( c_2Ereal__topology_2Enetlimit @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) )
      = V0a ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__IMP__CONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__CONST,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ADD,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2net: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a ) @ V0f ) @ V2net ) )
                  & ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a ) @ V1g ) @ V2net ) ) )
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) )
                    @ V2net ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__SUB,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) )
                    @ V2net ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__ID,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap
        @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] : V1x ) )
        @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__HALFSPACE__COMPONENT__GE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap @ c_2Ereal__topology_2EClosed
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ V1x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__ABS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ c_2Ereal_2Eabs ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__MUL,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a ) @ V2c ) @ V0net ) )
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2c @ V3x ) ) @ ( ap @ V1f @ V3x ) ) ) )
                    @ V0net ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__INV,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a ) @ V1f ) @ V0net ) )
              & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( ap @ ( c_2Ereal__topology_2Enetlimit @ A_27a ) @ V0net ) ) )
               != ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
           => ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ A_27a ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ c_2Erealax_2Einv ) @ V1f ) ) @ V0net ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES,lemma,(
    ! [V0P: $i] :
         ...
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4t: $i] :
                     ...
                     => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V3s ) )
                          & ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V4t ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANS,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ! [V2u: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V0s ) @ V1t ) )
                  & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V1t ) @ V2u ) ) )
               => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ V0s ) @ V2u ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__MINIMAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
          ...
          <=> ? [V2f: $i] :
                ...
                & ? [V3g: $i] :
                    ...
                    & ! [V4x: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V2f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) @ V1t ) )
                    ...
                    & ! [V5y: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V3g @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) ) @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVALS,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal,V3d: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
        & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) )
     => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ ( ap @ c_2Ereal__topology_2EOPEN__interval @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) @ ( ap @ c_2Ereal__topology_2EOPEN__interval @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVAL__UNIV,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
     => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Ehomeomorphic @ ( ap @ c_2Ereal__topology_2EOPEN__interval @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) ) ) )).
