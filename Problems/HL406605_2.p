...
tff(conj_thm_2EEncodeVar_2Efixed__width__univ,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(A_27a,bool))
     => ! [V1c: $i] :
          ( mem(V1c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2n: tp__ty_2Enum_2Enum] :
             ...
             => ( ! [V3x: $i] :
                   ...
                   => ( p(ap(ap(c_2ECoder_2Edomain(A_27a),V1c),V3x))
                     => p(ap(V0phi,V3x)) ) )
              <=> p(ap(ap(c_2Ebool_2ERES__FORALL(ty_2Elist_2Elist(bool)),ap(c_2EEncodeVar_2Eof__length(bool),inj__ty_2Enum_2Enum(V2n))),f2442(A_27a,V1c,V0phi))) ) ) ) ) )).
