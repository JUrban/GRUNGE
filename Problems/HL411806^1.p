...
thf(f12636_0_2E0,type,(
    f12636_0_2E0: u )).

thf(f12636_0_2E1,type,(
    f12636_0_2E1: du > u )).

thf(f12636_0_2E2,type,(
    f12636_0_2E2: du > du > u )).

thf(f12636_1_2E0,type,(
    f12636_1_2E0: u )).

thf(f12636_1_2E1,type,(
    f12636_1_2E1: du > u )).
...
thf(mono_2Ef12636_0,type,(
    mono_2Ef12636_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12636_1,type,(
    mono_2Ef12636_1: mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUM__GP,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12636_1 @ V0x )
    <=> ( V0x
        = ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESUM__GP,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12636_0 @ V0x @ V3i )
...
thf(thm_2Ereal__topology_2ESERIES__RATIO,conjecture,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o,V3N: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V0c @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        & ! [V4n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Earithmetic_2E_3E_3D @ V4n @ V3N )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( V1a @ ( mono_2Ec_2Enum_2ESUC @ V4n ) ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0c @ ( mono_2Ec_2Ereal_2Eabs @ ( V1a @ V4n ) ) ) ) ) )
     => ? [V5l: mono_2Etyop_2Erealax_2Ereal] :
          ( mono_2Ec_2Ereal__topology_2Esums @ V1a @ V5l @ V2s ) ) )).
