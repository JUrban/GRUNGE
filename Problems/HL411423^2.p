...
thf(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( ap @ c_2Ereal__topology_2Ecomponents @ V0s )
          = ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
      <=> ( V0s
          = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPONENTS__EMPTY,lemma,
    ( ( ap @ c_2Ereal__topology_2Ecomponents @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
    = ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( ap @ c_2Ereal__topology_2Ecomponents @ V0s )
          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__EQ__COMPONENTS__SUBSET__SING,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
      <=> ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) ) ) ) ) ) )).
