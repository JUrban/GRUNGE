...
tff(conj_thm_2Eprobability_2EPROB__INDEP,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ! [V3u: $i] :
                 ...
                 => ( ( p(ap(ap(ap(c_2Eprobability_2Eindep(A_27a),V0p),V1s),V2t))
                      & V3u = ap(ap(c_2Epred__set_2EINTER(A_27a),V1s),V2t) )
                   => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V3u)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t))) ) ) ) ) ) )).
