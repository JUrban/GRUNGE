...
tff(conj_thm_2Einteger_2EINT__REM0,lemma,(
...
tff(mem_c_2Ewords_2Eword__rem,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__rem(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(conj_thm_2Einteger__word_2Eword__rem,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
