...
thf(c_2Esum_2EISR_2E0,type,(
    c_2Esum_2EISR_2E0: u )).

thf(c_2Esum_2EISR_2E1,type,(
...
thf(arityeq1_2Emono_2Ec_2Esum_2EISR_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISR_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ c_2Esum_2EISR_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Esum_2EISR,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0x_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISR_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V0x_2E0 ) ) ) ) ) )
      & ! [V1y_2E0: u] :
          ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISR_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V1y_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Esum_2ENOT__ISR__ISL,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISR_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0x_2E0 ) ) ) ) )
    <=> ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esum_2EISL_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ V0x_2E0 ) ) ) ) ) )).
