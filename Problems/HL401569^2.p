         ...
         => ( ( ap @ ( ap @ ( c_2Epred__set_2EDFUNSET @ A_27a @ A_27b ) @ V0P ) @ V1Q )
            = ( lam @ ( arr @ A_27a @ A_27b )
              @ ^ [V2f: $i] :
                  ...
                  @ ( lam @ A_27a
                    @ ^ [V3x: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V0P ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ ( ap @ V2f @ V3x ) ) @ ( ap @ V1Q @ V3x ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Epred__set_2EIN__DFUNSET,conjecture,(
