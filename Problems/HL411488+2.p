...
fof(conj_thm_2Ereal__topology_2EDIAMETER__BOUNDED__BOUND,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V1x),V2y))),ap(c_2Ereal__topology_2Ediameter,V0s))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDIAMETER__EMPTY,lemma,(
    ap(c_2Ereal__topology_2Ediameter,c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) )).

fof(conj_thm_2Ereal__topology_2EDIAMETER__POS__LE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),ap(c_2Ereal__topology_2Ediameter,V0s))) ) ) )).

fof(conj_thm_2Ereal__topology_2EDIAMETER__LE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1d] :
              ...
              & ! [V2x] :
                 ...
                 => ! [V3y] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s))
                       ...
                       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V2x),V3y))),V1d)) ) ) ) )
           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ediameter,V0s)),V1d)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDIAMETER__SUMS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
           ...
           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2Ediameter,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3627(V1t,V0s))))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal__topology_2Ediameter,V0s)),ap(c_2Ereal__topology_2Ediameter,V1t)))) ) ) ) )).
