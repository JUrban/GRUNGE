...
tff(lamtp_f3182,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => mem(f3182(A_27a,V1f,V3x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3182,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ! [V4n: tp__ty_2Enum_2Enum] : ap(f3182(A_27a,V1f,V3x),inj__ty_2Enum_2Enum(V4n)) = ap(ap(V1f,inj__ty_2Enum_2Enum(V4n)),V3x) ) ) )).

tff(lmtp_f3183,type,(
    f3183: ( del * $i * $i ) > $i )).

tff(lamtp_f3183,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => mem(f3183(A_27a,V1f,V0s),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
tff(lameq_f3183,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V5n: tp__ty_2Enum_2Enum] : ap(f3183(A_27a,V1f,V0s),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),ap(V1f,inj__ty_2Enum_2Enum(V5n))),V0s) ) ) )).

tff(conj_thm_2Ereal__sigma_2ESEQ__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
           ...
           => ! [V2f_27: $i] :
               ...
               => ( ! [V3x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s))
                       => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f3182(A_27a,V1f,V3x)),ap(V2f_27,V3x))) ) )
                 => p(ap(ap(c_2Eseq_2E_2D_2D_3E,f3183(A_27a,V1f,V0s)),ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),V2f_27),V0s))) ) ) ) ) ) )).
