...
fof(conj_thm_2Erich__list_2EBUTLASTN__LASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1n] :
             ...
             => ! [V2l] :
                 ...
                 => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),V1n))
                      & p(ap(ap(c_2Earithmetic_2E_3C_3D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V2l))) )
                   => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0m),ap(ap(c_2Erich__list_2ELASTN(A_27a),V1n),V2l)) = ap(ap(c_2Erich__list_2ELASTN(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1n),V0m)),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0m),V2l)) ) ) ) ) ) )).
