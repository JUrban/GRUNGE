...
fof(conj_thm_2Etransc_2EEXP__POS__LT,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Etransc_2EEXP__TOTAL,lemma,(
    ! [V0y] :
...
fof(conj_thm_2Etransc_2ELN__EXP,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Etransc_2Eln,ap(c_2Etransc_2Eexp,V0x)) = V0x ) )).

fof(conj_thm_2Etransc_2EEXP__LN,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
