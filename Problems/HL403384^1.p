...
thf(thm_2Ebag_2EBAG__UNION__EQ__LEFT,conjecture,(
    ! [A_27a: d,V0b_2E0: u,V1c_2E0: u,V2d_2E0: u] :
      ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__UNION_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1c_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__UNION_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2d_2E0 ) ) ) )
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1c_2E0 )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2d_2E0 ) ) ) )).
