...
tff(lmtp_f3894,type,(
    f3894: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3894,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3894(V0a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3894,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3894(V0a),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1x))) )).

tff(conj_thm_2Ereal__topology_2ECLOSED__INTERVAL__RIGHT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EClosed,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3894(V0a)))) )).
