...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__EQ,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ( ( ! [V3x: tp__ty_2Enum_2Enum] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3x ) ) )
                        = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V3x ) ) ) ) )
