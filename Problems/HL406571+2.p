...
fof(lamtp_f2350,axiom,(
    ! [A_27a,A_27a,V2t] :
      ( mem(V2t,ty_2Esptree_2Espt(A_27a))
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => mem(f2350(A_27a,A_27a,V2t,V1i),arr(A_27a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) ) )).

fof(lameq_f2350,axiom,(
    ! [A_27a,A_27a,V2t] :
      ( mem(V2t,ty_2Esptree_2Espt(A_27a))
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ! [V3a] :
              ( mem(V3a,A_27a)
             => ap(f2350(A_27a,A_27a,V2t,V1i),V3a) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(ap(c_2Esptree_2Einsert(A_27a),V1i),V3a),V2t)) ) ) ) )).

fof(lamtp_f2349,axiom,(
    ! [A_27a,A_27a,V1i] :
      ( mem(V1i,ty_2Enum_2Enum)
     => mem(f2349(A_27a,A_27a,V1i),arr(ty_2Esptree_2Espt(A_27a),arr(A_27a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).

fof(lameq_f2349,axiom,(
    ! [A_27a,A_27a,V1i] :
      ( mem(V1i,ty_2Enum_2Enum)
     => ! [V2t] :
          ( mem(V2t,ty_2Esptree_2Espt(A_27a))
...
fof(lamtp_f2348,axiom,(
    ! [A_27a,A_27a] : mem(f2348(A_27a,A_27a),arr(ty_2Enum_2Enum,arr(ty_2Esptree_2Espt(A_27a),arr(A_27a,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))) )).

fof(lameq_f2348,axiom,(
    ! [A_27a,A_27a,V1i] :
      ( mem(V1i,ty_2Enum_2Enum)
     => ap(f2348(A_27a,A_27a),V1i) = f2349(A_27a,A_27a,V1i) ) )).

fof(ax_thm_2Esptree_2EfromList__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ap(c_2Esptree_2EfromList(A_27a),V0l) = ap(c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f2348(A_27a,A_27a))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),c_2Esptree_2ELN(A_27a))),V0l)) ) ) )).
...
fof(conj_thm_2Esptree_2Edomain__fromList,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
