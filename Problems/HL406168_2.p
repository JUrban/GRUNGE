...
tff(lamtp_f250,axiom,(
    ! [V0l: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum,V1h: tp__ty_2Enum_2Enum] : mem(f250(V0l,V2n,V1h),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).
...
tff(ax_thm_2Ewords_2Esw2sw__def,axiom,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
     ...
     => ap(c_2Ewords_2Esw2sw(A_27a,A_27a),V0w) = ap(c_2Ewords_2En2w(A_27b),ap(ap(ap(c_2Ebit_2ESIGN__EXTEND,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Ewords_2Ew2n(A_27a),V0w))) ) )).
...
tff(conj_thm_2Ewords_2Esw2sw__0,conjecture,(
    ! [A_27a: del,A_27b: del] : ap(c_2Ewords_2Esw2sw(A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) )).
