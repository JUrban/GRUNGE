...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__AVOID,lemma,(
    ! [V0f] :
         ...
         => ! [V2s] :
             ...
             => ! [V3a] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V1x)),V2s)))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V2s))
                      & ap(V0f,V1x) != V3a )
                   => ? [V4e] :
                        ...
                        & ! [V5y] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V2s))
                                & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),V5y))),V4e)) )
                             => ap(V0f,V5y) != V3a ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__AVOID,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V1x)))
               ...
               => ? [V3e] :
                    ...
                    & ! [V4y] :
                       ...
                       => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),V4y))),V3e))
                         => ap(V0f,V4y) != V2a ) ) ) ) ) ) ) )).
