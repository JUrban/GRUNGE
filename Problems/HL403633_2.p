...
tff(conj_thm_2Efcp_2Eindex__comp,conjecture,(
    ! [A_27a: del,A_27b: del,V0FCP_20out_20of_20bounds: tp__o,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(c_2Efcp_2EFCP(A_27a,A_27a),V1f)),inj__ty_2Enum_2Enum(V2n)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2n)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(V1f,inj__ty_2Enum_2Enum(V2n))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a)),arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a))),c_2Efcp_2Efcp__index(A_27a,A_27a)),inj__o(V0FCP_20out_20of_20bounds)),ap(c_2Efcp_2EFCP(A_27a,A_27a),V1f)),inj__ty_2Enum_2Enum(V2n))) ) )).
