...
tff(conj_thm_2EquantHeuristics_2ESND__PAIR__EQ__SYM,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(A_27a,A_27a))
     => ! [V1p1: $i] :
          ( mem(V1p1,A_27a)
         => ( V0p = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1p1),ap(c_2Epair_2ESND(A_27a,A_27a),V0p))
          <=> ap(c_2Epair_2EFST(A_27a,A_27a),V0p) = V1p1 ) ) ) )).
