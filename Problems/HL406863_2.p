...
tff(conj_thm_2Ehreal_2EHRAT__LT__MUL2,lemma,(
...
tff(conj_thm_2Ehreal_2EHREAL__MUL__ISACUT,conjecture,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] : p(ap(c_2Ehreal_2Eisacut,f2577(V1Y,V0X))) )).
