...
fof(conj_thm_2Ereal__topology_2EAPPROACHABLE__LT__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN__LE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
