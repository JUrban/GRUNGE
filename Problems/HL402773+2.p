...
fof(mem_c_2Erich__list_2EUNZIP__FST,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Erich__list_2EUNZIP__FST(A_27a,A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(A_27a))) ) ) )).

fof(ax_thm_2Erich__list_2EUNZIP__FST__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l] :
             ...
             => ap(c_2Erich__list_2EUNZIP__FST(A_27a,A_27a),V0l) = ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EUNZIP(A_27a,A_27a),V0l)) ) ) ) )).

fof(conj_thm_2Erich__list_2ELENGTH__UNZIP__FST,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l] :
              ( mem(V0l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
             => ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Erich__list_2EUNZIP__FST(A_27a,A_27a),V0l)) = ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),V0l) ) ) ) )).
