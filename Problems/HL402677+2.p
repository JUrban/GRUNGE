...
fof(conj_thm_2Erich__list_2EBUTLASTN__BUTLASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1n] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V1n),V0m)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V1n),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0m),V2l)) = ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),ap(ap(c_2Earithmetic_2E_2B,V1n),V0m)),V2l) ) ) ) ) ) )).
