...
thf(thm_2Ereal__topology_2ESUMS__OFFSET__REV,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1l: tyop_2Erealax_2Ereal,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( ( c_2Ereal__topology_2Esums @ V0f @ V1l @ ( c_2Ereal__topology_2Efrom @ V2m ) )
        ...
        & ( c_2Earithmetic_2E_3C_3D @ V3n @ V2m ) )
     => ( c_2Ereal__topology_2Esums @ V0f @ ( c_2Erealax_2Ereal__add @ V1l @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V3n @ ( c_2Earithmetic_2E_2D @ V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0f ) ) @ ( c_2Ereal__topology_2Efrom @ V3n ) ) ) )).
