...
thf(tp_c_2Ebasis__emit_2EfromNum,type,(
    c_2Ebasis__emit_2EfromNum: del > $i )).

thf(mem_c_2Ebasis__emit_2EfromNum,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Ebasis__emit_2EfromNum @ A_27a ) @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) ) )).
...
thf(ax_thm_2Ebasis__emit_2EfromNum__primitive__def,axiom,(
    ! [A_27a: del] :
      ( ( c_2Ebasis__emit_2EfromNum @ A_27a )
      = ( ap
        @ ( ap @ ( c_2Erelation_2EWFREC @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
          @ ( ap @ ( c_2Emin_2E_40 @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ bool ) ) )
            @ ( lam @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ bool ) )
              @ ^ [V0R: $i] :
                  ( ap @ ( c_2Erelation_2EWF @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) ) @ V0R ) ) ) )
        @ ( lam @ ( arr @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
          @ ^ [V1fromNum: $i] :
              ( lam @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) )
              @ ^ [V2a: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2Epair__CASE @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ V2a )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3v: $i] :
                        ( lam @ ( ty_2Ebool_2Eitself @ A_27a )
                        @ ^ [V4v1: $i] :
                            ( ap @ ( c_2Ecombin_2EI @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( c_2Ewords_2En2w__itself @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ V3v ) @ ( ap @ ( c_2Ewords_2Edimword @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebasis__emit_2EfromNum__def,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Ebasis__emit_2EfromNum @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
      = ( ap @ ( c_2Ewords_2En2w__itself @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Ebool_2Eitself @ A_27a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Ewords_2Edimword @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )).
