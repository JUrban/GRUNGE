...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__CMUL,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1c: tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__BALLS__CBALL__SPHERE,conjecture,
    ( ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal,V2d: tyop_2Erealax_2Ereal,V3e: tyop_2Erealax_2Ereal] :
       ...
       => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V2d ) ) @ ( c_2Ereal__topology_2Eball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1b @ V3e ) ) ) )
    & ! [V4a: tyop_2Erealax_2Ereal,V5b: tyop_2Erealax_2Ereal,V6d: tyop_2Erealax_2Ereal,V7e: tyop_2Erealax_2Ereal] :
       ...
       => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Ereal__topology_2Ecball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V4a @ V6d ) ) @ ( c_2Ereal__topology_2Ecball @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V5b @ V7e ) ) ) )
    & ! [V8a: tyop_2Erealax_2Ereal,V9b: tyop_2Erealax_2Ereal,V10d: tyop_2Erealax_2Ereal,V11e: tyop_2Erealax_2Ereal] :
        ( ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V10d )
          & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V11e ) )
       => ( c_2Ereal__topology_2Ehomeomorphic @ ( c_2Ereal__topology_2Esphere @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V8a @ V10d ) ) @ ( c_2Ereal__topology_2Esphere @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V9b @ V11e ) ) ) ) )).
