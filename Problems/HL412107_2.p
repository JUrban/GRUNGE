...
tff(conj_thm_2Eprobability_2EPROB__EQUIPROBABLE__FINITE__UNIONS,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
              ...
              & ! [V3x: $i] :
                 ...
                 => ! [V4y: $i] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                       ...
                       => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINSERT(A_27a),V3x),c_2Epred__set_2EEMPTY(A_27a)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINSERT(A_27a),V4y),c_2Epred__set_2EEMPTY(A_27a)))) ) ) ) )
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Epred__set_2ECARD(A_27a),V1s))),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINSERT(A_27a),ap(c_2Epred__set_2ECHOICE(A_27a),V1s)),c_2Epred__set_2EEMPTY(A_27a))))) ) ) ) )).
