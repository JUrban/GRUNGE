...
fof(thm_2Ellist_2ELAPPEND__fromList,conjecture,(
    ! [A_27a,V0l1_2E0,V1l2_2E0] : s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELAPPEND_2E2(s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2EfromList_2E1(s(tyop_2Elist_2Elist(A_27a),V0l1_2E0))),s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2EfromList_2E1(s(tyop_2Elist_2Elist(A_27a),V1l2_2E0))))) = s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2EfromList_2E1(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),V0l1_2E0),s(tyop_2Elist_2Elist(A_27a),V1l2_2E0))))) )).
