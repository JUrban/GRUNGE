...
fof(conj_thm_2EEncodeVar_2Eof__length__exists__suc,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0phi] :
          ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),ap(c_2Enum_2ESUC,V1n))),f2443(A_27a,V0phi)))
              <=> ? [V3x] :
                    ( mem(V3x,A_27a)
                    & p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),V1n)),f2444(A_27a,V3x,V0phi))) ) ) ) ) ) )).
