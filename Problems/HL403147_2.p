...
tff(lameq_f953,axiom,(
    ! [V1P: $i] :
     ...
     => ! [V0Q: $i] :
          ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: tp__ty_2Enum_2Enum] : ap(f953(V1P,V0Q),inj__ty_2Enum_2Enum(V2t)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1P,inj__ty_2Enum_2Enum(V2t))),ap(V0Q,inj__ty_2Enum_2Enum(V2t))) ) ) )).

tff(lmtp_f954,type,(
    f954: ( $i * $i ) > $i )).

tff(lamtp_f954,axiom,(
    ! [V1P: $i] :
      ( mem(V1P,arr(ty_2Enum_2Enum,bool))
     => ! [V0Q: $i] :
          ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
         => mem(f954(V1P,V0Q),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f954,axiom,(
    ! [V1P: $i] :
     ...
     => ! [V0Q: $i] :
          ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
         => ! [V3t: tp__ty_2Enum_2Enum] : ap(f954(V1P,V0Q),inj__ty_2Enum_2Enum(V3t)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2ETemporal__Logic_2ENEXT,V1P),inj__ty_2Enum_2Enum(V3t))),ap(ap(c_2ETemporal__Logic_2ENEXT,V0Q),inj__ty_2Enum_2Enum(V3t))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EIMP__NEXT,conjecture,(
    ! [V0Q: $i] :
      ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
     => ! [V1P: $i] :
          ( mem(V1P,arr(ty_2Enum_2Enum,bool))
