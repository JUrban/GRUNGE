...
tff(conj_thm_2Ereal__topology_2ESPHERE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1r: tp__ty_2Erealax_2Ereal] : ap(c_2Ereal__topology_2Esphere,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1r)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r))),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) )).

tff(conj_thm_2Ereal__topology_2EFINITE__SPHERE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1r: tp__ty_2Erealax_2Ereal] : p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Esphere,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r))))) )).
