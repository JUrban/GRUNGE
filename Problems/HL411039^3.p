...
thf(thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,axiom,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ( ( ! [V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
           ...
           => ( c_2Ereal_2Ereal__lte @ ( V0s @ V2m ) @ ( V0s @ V3n ) ) )
        & ! [V4n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( V0s @ V4n ) ) @ V1b ) )
        ...
        ! [V6e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V7N: tyop_2Enum_2Enum] :
            ! [V8n: tyop_2Enum_2Enum] :
              ( ( c_2Earithmetic_2E_3C_3D @ V7N @ V8n )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V0s @ V8n ) @ V5l ) ) @ V6e ) ) ) ) )).
    ...
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ( ( ! [V2n: tyop_2Enum_2Enum] :
        ...
        & ( ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
             ...
             => ( c_2Ereal_2Ereal__lte @ ( V0s @ V3m ) @ ( V0s @ V4n ) ) )
          | ! [V5m: tyop_2Enum_2Enum,V6n: tyop_2Enum_2Enum] :
              ( ( c_2Earithmetic_2E_3C_3D @ V5m @ V6n )
             => ( c_2Ereal_2Ereal__lte @ ( V0s @ V6n ) @ ( V0s @ V5m ) ) ) ) )
     => ? [V7l: tyop_2Erealax_2Ereal] :
        ! [V8e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V9N: tyop_2Enum_2Enum] :
            ! [V10n: tyop_2Enum_2Enum] :
              ( ( c_2Earithmetic_2E_3C_3D @ V9N @ V10n )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( V0s @ V10n ) @ V7l ) ) @ V8e ) ) ) ) )).
