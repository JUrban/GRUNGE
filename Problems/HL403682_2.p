...
tff(conj_thm_2Erelation_2Etransitive__TC__identity,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R))
       => ap(c_2Erelation_2ETC(A_27a),V0R) = V0R ) ) )).

tff(conj_thm_2Erelation_2ETC__MONOTONE,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1Q: $i] :
...
tff(conj_thm_2Esorting_2EPERM__CONS__EQ__APPEND,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Esorting_2EPERM__SINGLE__SWAP__APPEND,lemma,(
    ! [A_27a: del,V0x2: $i] :
...
tff(conj_thm_2Esorting_2EPERM__SINGLE__SWAP__REFL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => p(ap(ap(c_2Esorting_2EPERM__SINGLE__SWAP(A_27a),V0l),V0l)) ) )).

tff(conj_thm_2Esorting_2EPERM__SINGLE__SWAP__TC__CONS,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1M: $i] :
...
tff(conj_thm_2Esorting_2EPERM__TC,conjecture,(
