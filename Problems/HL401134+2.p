...
fof(lamtp_f208,axiom,(
    ! [A_27a,V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => mem(f208(A_27a,V0m),arr(ty_2Enum_2Enum,arr(A_27a,bool))) ) )).
...
fof(lameq_f208,axiom,(
    ! [A_27a,V0m] :
     ...
     => ! [V1n] :
         ...
         => ap(f208(A_27a,V0m),V1n) = k(A_27a,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1n),V0m)) ) ) )).
...
fof(conj_thm_2Eind__type_2EINJN__INJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n1] :
