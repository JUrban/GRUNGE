...
tff(conj_thm_2Ewords_2EWORD__BITS__COMP__THM,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__EXTRACT__BITS__COMP,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: $i] :
      ( mem(V0n,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1l: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum,V3j: tp__ty_2Enum_2Enum,V4h: tp__ty_2Enum_2Enum] : ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V3j)),inj__ty_2Enum_2Enum(V2k)),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),inj__ty_2Enum_2Enum(V4h)),inj__ty_2Enum_2Enum(V1l)),V0n)) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),ap(ap(c_2Earithmetic_2EMIN,inj__ty_2Enum_2Enum(V4h)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3j)),inj__ty_2Enum_2Enum(V1l)))),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2k)),inj__ty_2Enum_2Enum(V1l))),V0n) ) )).
