...
fof(conj_thm_2Ereal__topology_2Econtinuous__at,lemma,(
    ! [V0f] :
               ...
               => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2e))
                 => ? [V3d] :
                      ...
                      & ! [V4x_27] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x_27),V1x))),V3d))
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V4x_27)),ap(V0f,V1x)))),V2e)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDIST__CLOSEST__POINT__LIPSCHITZ,lemma,(
    ! [V0s] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1x)))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2y),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V2y)))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),V2y)))) ) ) ) ) )).

fof(lamtp_f4059,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4059(V0s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

fof(lameq_f4059,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => ap(f4059(V0s),V2x) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V2x))) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f4059(V0s)),ap(c_2Ereal__topology_2Eat,V1x))) ) ) ) )).
