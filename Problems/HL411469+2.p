...
fof(conj_thm_2Ereal__topology_2ECONNECTED__SCALING,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
           => p(ap(c_2Ereal__topology_2Econnected,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3922(V1c)),V0s))) ) ) ) )).
