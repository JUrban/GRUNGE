...
thf(f12703_0_2E0,type,(
    f12703_0_2E0: u )).

thf(f12703_0_2E2,type,(
    f12703_0_2E2: du > du > u )).

thf(f12703_0_2E3,type,(
    f12703_0_2E3: du > du > du > u )).

thf(f12703_1_2E0,type,(
    f12703_1_2E0: u )).

thf(f12703_1_2E1,type,(
    f12703_1_2E1: du > u )).

thf(f12703_1_2E2,type,(
...
thf(mono_2Ef12703_0,type,(
    mono_2Ef12703_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12703_1,type,(
    mono_2Ef12703_1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Ereal__topology_2ESUMS__REINDEX,axiom,(
...
thf(def0_2Ethm_2Ereal__topology_2ESUMS__REINDEX__GEN,axiom,(
    ! [V0k: mono_2Etyop_2Enum_2Enum,V5i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12703_1 @ V0k @ V5i )
      = ( mono_2Ec_2Earithmetic_2E_2B @ V5i @ V0k ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESUMS__REINDEX__GEN,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V0k: mono_2Etyop_2Enum_2Enum,V4x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12703_0 @ V1a @ V0k @ V4x )
      = ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4x @ V0k ) ) ) )).

thf(thm_2Ereal__topology_2ESUMS__REINDEX__GEN,conjecture,(
    ! [V0k: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Esums @ ( mono_2Ef12703_0 @ V1a @ V0k ) @ V2l @ V3s )
      = ( mono_2Ec_2Ereal__topology_2Esums @ V1a @ V2l @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef12703_1 @ V0k ) @ V3s ) ) ) )).
