...
thf(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__ADD,lemma,(
    ! [V0f: $i] :
           ...
           => ( p
              @ ( ap @ c_2Ereal__topology_2Elinear
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V0f @ V2x ) ) @ ( ap @ V1g @ V2x ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELINEAR__ZERO,lemma,
    ( p
    @ ( ap @ c_2Ereal__topology_2Elinear
      @ ( lam @ ty_2Erealax_2Ereal
        @ ^ [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUM,conjecture,(
    ! [A_27a: del,V0f: $i] :
