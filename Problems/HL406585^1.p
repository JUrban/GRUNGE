...
thf(thm_2Esptree_2Elookup__fromAList__toAList,conjecture,(
    ! [A_27a: d,V0t_2E0: u,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( c_2Esptree_2EfromAList_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ ( c_2Esptree_2EtoAList_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) )).
