...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3939(V0a)),ap(c_2Ereal__topology_2Eat,V1x))) ) ) )).
