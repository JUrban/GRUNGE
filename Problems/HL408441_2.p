...
tff(conj_thm_2Etransc_2EDIFF__LN,lemma,(
...
tff(conj_thm_2Etransc_2ERPOW__DIV__BASE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1t: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1t))),inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1t)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) )).
...
tff(conj_thm_2Etransc_2EDIFF__COMPOSITE__EXP,lemma,(
    ! [V0g: $i] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lmtp_f3005,type,(
    f3005: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3005,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal] : mem(f3005(V1y),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3005,axiom,(
    ! [V1y: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3005(V1y),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V2x)),inj__ty_2Erealax_2Ereal(V1y)) )).

tff(conj_thm_2Etransc_2EDIFF__RPOW,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     => p(ap(ap(ap(c_2Elim_2Ediffl,f3005(V1y)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1y)),ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0x)),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1y)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))),inj__ty_2Erealax_2Ereal(V0x))) ) )).
