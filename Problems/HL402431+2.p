...
fof(conj_thm_2EerrorStateMonad_2EFOR__def,conjecture,(
    ! [A_27state] :
      ( ne(A_27state)
     => ! [V0j] :
         ...
         => ! [V1i] :
             ...
             => ! [V2a] :
                 ...
                 => ap(c_2EerrorStateMonad_2EFOR(A_27state),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1i),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0j),V2a))) = ap(ap(ap(c_2Ebool_2ECOND(arr(A_27state,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone)))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1i),V0j)),ap(V2a,V1i)),ap(ap(c_2EerrorStateMonad_2EBIND(A_27state,A_27state,A_27state),ap(V2a,V1i)),k(ty_2Eone_2Eone,ap(c_2EerrorStateMonad_2EFOR(A_27state),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V1i),V0j)),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Earithmetic_2E_2D,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0j),V2a)))))) ) ) ) ) )).
