...
thf(conj_thm_2Erich__list_2EELL__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ! [V2f: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
           => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27b ) @ V2f ) @ V1l ) )
              = ( ap @ V2f @ ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) ) ) ) ) ) )).
