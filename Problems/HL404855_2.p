...
tff(lamtp_f1950,axiom,(
    ! [A_27a: del,A_27b: del,V3k: $i] :
      ( mem(V3k,A_27a)
     => ! [V2env: $i] :
          ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => mem(f1950(A_27a,A_27b,V3k,V2env),arr(A_27b,ty_2Efinite__map_2Efmap(A_27a,A_27a))) ) ) )).

tff(lameq_f1950,axiom,(
    ! [A_27a: del,A_27b: del,V3k: $i] :
      ( mem(V3k,A_27a)
     => ! [V2env: $i] :
          ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V4v: $i] :
              ( mem(V4v,A_27b)
             => ap(f1950(A_27a,A_27b,V3k,V2env),V4v) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2env),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k),V4v)) ) ) ) )).

tff(lmtp_f1949,type,(
    f1949: ( del * del * $i ) > $i )).

tff(lamtp_f1949,axiom,(
    ! [A_27b: del,A_27a: del,V2env: $i] :
      ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => mem(f1949(A_27b,A_27a,V2env),arr(A_27a,arr(A_27b,ty_2Efinite__map_2Efmap(A_27a,A_27a)))) ) )).

tff(lameq_f1949,axiom,(
    ! [A_27b: del,A_27a: del,V2env: $i] :
      ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V3k: $i] :
          ( mem(V3k,A_27a)
         => ap(f1949(A_27b,A_27a,V2env),V3k) = f1950(A_27a,A_27b,V3k,V2env) ) ) )).

tff(lmtp_f1948,type,(
    f1948: ( del * del * del * del ) > $i )).

tff(lamtp_f1948,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,A_27a: del] : mem(f1948(A_27b,A_27a,A_27b,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).

tff(lameq_f1948,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,A_27a: del,V2env: $i] :
      ( mem(V2env,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ap(f1948(A_27b,A_27a,A_27b,A_27a),V2env) = ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f1949(A_27b,A_27a,V2env)) ) )).

tff(conj_thm_2Efinite__map_2Efupdate__list__foldl,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
         => ap(ap(ap(c_2Elist_2EFOLDL(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),f1948(A_27b,A_27a,A_27b,A_27a)),V0m),V1l) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V0m),V1l) ) ) )).
