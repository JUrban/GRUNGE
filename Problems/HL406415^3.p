...
thf(thm_2Eucord_2Eomega1__not__countable,conjecture,(
    ! [A_27a: $tType] :
      ( (~) @ ( c_2Epred__set_2Ecountable @ ( tyop_2Eordinal_2Eordinal @ ( tyop_2Esum_2Esum @ A_27a @ ( tyop_2Enum_2Enum > $o ) ) ) @ ( c_2Eordinal_2Epreds @ ( tyop_2Esum_2Esum @ A_27a @ ( tyop_2Enum_2Enum > $o ) ) @ ( c_2Eucord_2Eomega1 @ A_27a ) ) ) ) )).
