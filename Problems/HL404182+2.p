...
fof(conj_thm_2Epath_2Enth__label__take,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1p] :
                 ...
                 => ! [V2i] :
                     ...
                     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V2i),V0n))
                       ...
                       => ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V2i),ap(ap(c_2Epath_2Etake(A_27a,A_27a),V0n),V1p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V2i),V1p) ) ) ) ) ) ) )).
