...
fof(conj_thm_2Erich__list_2ECOUNT__LIST__COUNT,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),ap(c_2Erich__list_2ECOUNT__LIST,V0n)) = ap(c_2Epred__set_2Ecount,V0n) ) )).
