...
fof(conj_thm_2Ereal_2EREAL__DIV__DENOM__CANCEL2,lemma,(
    ! [V0y] :
...
fof(conj_thm_2Eextreal_2Eext__mono__increasing__suc,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( p(ap(c_2Eextreal_2Eext__mono__increasing,V0f))
      <=> ! [V1n] :
            ( mem(V1n,ty_2Enum_2Enum)
           => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0f,V1n)),ap(V0f,ap(c_2Enum_2ESUC,V1n)))) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Elemma__fn__4,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ! [V2n] :
                 ...
                 => ! [V3x] :
                      ( mem(V3x,A_27a)
                     => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Emeasure_2Em__space(A_27a),V0m)))
                       => ap(ap(ap(ap(c_2Elebesgue_2Efn__seq(A_27a),V0m),V1f),V2n),V3x) = ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0) ) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Elemma__fn__mono__increasing,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
