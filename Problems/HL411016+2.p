...
fof(conj_thm_2Ereal__topology_2EBOUNDED__SCALING,lemma,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__NEGATIONS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3701),V0s))) ) ) )).
