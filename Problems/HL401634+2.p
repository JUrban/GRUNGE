...
fof(lamtp_f272,axiom,(
    ! [A_27a,A_27b,A_27a,V3y] :
      ( mem(V3y,A_27b)
     => ! [V0f] :
...
fof(conj_thm_2Epred__set_2EBIJ__ALT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2EBIJ__FINITE__SUBSET,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
         ...
         => ! [V1s] :
             ...
             => ! [V2t] :
                  ( mem(V2t,arr(A_27a,bool))
                 => ( ( p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),V1s))
                   ...
                   => ? [V3N] :
                        ...
                        & ! [V4n] :
                           ...
                           => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3N),V4n))
                             => ~ p(ap(ap(c_2Ebool_2EIN(A_27a),ap(V0f,V4n)),V2t)) ) ) ) ) ) ) ) ) )).
