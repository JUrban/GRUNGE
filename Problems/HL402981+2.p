...
fof(conj_thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__CONJ__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V5infos_27] :
                                 ...
                                 => ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),V2c),V3infos))
                                   => ( ap(c_2Elist_2ELENGTH(bool),V5infos_27) = ap(c_2Elist_2ELENGTH(bool),V3infos)
                                     => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),ap(ap(c_2Ebool_2E_5C_2F,V2c),V4c_27)),ap(ap(c_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__CONJ,V3infos),V5infos_27))) ) ) ) ) ) ) ) ) ) ) )).
