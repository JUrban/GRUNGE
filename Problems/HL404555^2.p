...
thf(conj_thm_2Ecardinal_2ECARD__LE__TRANS,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__LE__ADD,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__ADD__LE__MUL__INFINITE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__SQUARE__INFINITE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
...
thf(conj_thm_2Ecardinal_2ECARD__ADD__ABSORB__LE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
