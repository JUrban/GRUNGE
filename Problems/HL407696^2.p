...
thf(tp_c_2Efrac_2Efrac__save,type,(
    c_2Efrac_2Efrac__save: $i )).

thf(mem_c_2Efrac_2Efrac__save,axiom,(
    mem @ c_2Efrac_2Efrac__save @ ( arr @ ty_2Einteger_2Eint @ ( arr @ ty_2Enum_2Enum @ ty_2Efrac_2Efrac ) ) )).

thf(stp_fo_c_2Efrac_2Efrac__save,type,(
    fo__c_2Efrac_2Efrac__save: tp__ty_2Einteger_2Eint > tp__ty_2Enum_2Enum > tp__ty_2Efrac_2Efrac )).

thf(stp_eq_fo_c_2Efrac_2Efrac__save,axiom,(
    ! [X0: tp__ty_2Einteger_2Eint,X1: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Efrac_2Efrac @ ( fo__c_2Efrac_2Efrac__save @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) ) )).
...
thf(ax_thm_2Efrac_2Efrac__minv__def,axiom,(
    ! [V0f1: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__minv @ ( inj__ty_2Efrac_2Efrac @ V0f1 ) ) )
...
thf(ax_thm_2Efrac_2Efrac__save__def,axiom,(
    ! [V0nmr: tp__ty_2Einteger_2Eint,V1dnm: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__save @ ( inj__ty_2Einteger_2Eint @ V0nmr ) ) @ ( inj__ty_2Enum_2Enum @ V1dnm ) ) )
