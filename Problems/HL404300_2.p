...
tff(conj_thm_2Emergesort_2Emergesort__perm,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1l: $i] :
...
tff(conj_thm_2Emergesort_2Emergesort__sorted,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Emergesort_2Emergesort__stable,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Emergesort_2Emergesort__STABLE__SORT,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R))
          & p(ap(c_2Erelation_2Etotal(A_27a),V0R)) )
