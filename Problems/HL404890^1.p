...
thf(c_2Elbtree_2Emap_2E0,type,(
    c_2Elbtree_2Emap_2E0: u )).

thf(c_2Elbtree_2Emap_2E2,type,(
    c_2Elbtree_2Emap_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ec_2Elbtree_2Emap_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Elbtree_2Elbtree @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Elbtree_2Elbtree @ A_27b ) ) ) @ c_2Elbtree_2Emap_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Elbtree_2Emap_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( tyop_2Elbtree_2Elbtree @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( tyop_2Elbtree_2Elbtree @ A_27a ) ) ) @ c_2Elbtree_2Emap_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Elbtree_2Emap__def,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ c_2Elbtree_2ELf_2E0 ) ) )
        = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ c_2Elbtree_2ELf_2E0 ) )
      & ! [V1a_2E0: u,V2t1_2E0: u,V3t2_2E0: u] :
          ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V1a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V3t2_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2t1_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V3t2_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Elbtree_2Emap__eq__Nd,conjecture,(
    ! [A_27a: d,A_27b: d,V0t2_2E0: u,V1t1_2E0: u,V2t_2E0: u,V3f_2E0: u,V4a_2E0: u] :
      ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V2t_2E0 ) ) )
        = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V4a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V0t2_2E0 ) ) ) )
    <=> ? [V5a_27_2E0: u,V6t1_27_2E0: u,V7t2_27_2E0: u] :
          ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V2t_2E0 )
            = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27b @ V5a_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V6t1_27_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V7t2_27_2E0 ) ) ) )
          & ( ( s @ A_27a @ V4a_2E0 )
            = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V3f_2E0 ) @ ( s @ A_27b @ V5a_27_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1t1_2E0 )
            = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V6t1_27_2E0 ) ) ) )
          & ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V0t2_2E0 )
            = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2Emap_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V3f_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27b ) @ V7t2_27_2E0 ) ) ) ) ) ) )).
