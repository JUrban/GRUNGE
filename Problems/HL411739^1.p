...
thf(f11509_0_2E0,type,(
    f11509_0_2E0: u )).

thf(f11509_0_2E2,type,(
    f11509_0_2E2: du > du > u )).

thf(f11509_0_2E3,type,(
    f11509_0_2E3: du > du > du > u )).
...
thf(f12676_0_2E0,type,(
    f12676_0_2E0: u )).

thf(f12676_0_2E2,type,(
    f12676_0_2E2: du > du > u )).

thf(f12676_0_2E3,type,(
    f12676_0_2E3: du > du > du > u )).
...
thf(mono_2Ef12676_0,type,(
    mono_2Ef12676_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(arityeq2_2Emono_2Ef11509_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f11509_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) ) ) @ f11509_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef11509_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f11509_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(def0_2Ethm_2Eiterate_2ESUM__ADD,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1g_2E0: u,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f11509_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) ) )).

thf(thm_2Eiterate_2ESUM__ADD,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1g_2E0: u,V2s_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ ( f11509_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) ) ) ) ) )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1g_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EFINITE__INTER__NUMSEG,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V0s @ ( mono_2Ec_2Eiterate_2E_2E_2E @ V1m @ V2n ) ) ) )).

thf(def0_2Ethm_2Ereal__topology_2ESERIES__ADD,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V5n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12676_0 @ V0x @ V2y @ V5n )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V0x @ V5n ) @ ( V2y @ V5n ) ) ) )).

thf(thm_2Ereal__topology_2ESERIES__ADD,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y0: mono_2Etyop_2Erealax_2Ereal,V4s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esums @ V0x @ V1x0 @ V4s )
        & ( mono_2Ec_2Ereal__topology_2Esums @ V2y @ V3y0 @ V4s ) )
     => ( mono_2Ec_2Ereal__topology_2Esums @ ( mono_2Ef12676_0 @ V0x @ V2y ) @ ( mono_2Ec_2Erealax_2Ereal__add @ V1x0 @ V3y0 ) @ V4s ) ) )).
