...
thf(c_2Ereal__topology_2Ecauchy_2E0,type,(
    c_2Ereal__topology_2Ecauchy_2E0: u )).

thf(c_2Ereal__topology_2Ecauchy_2E1,type,(
    c_2Ereal__topology_2Ecauchy_2E1: du > u )).

thf(c_2Ereal__topology_2Ecomplete_2E0,type,(
    c_2Ereal__topology_2Ecomplete_2E0: u )).

thf(c_2Ereal__topology_2Ecomplete_2E1,type,(
    c_2Ereal__topology_2Ecomplete_2E1: du > u )).
...
thf(mono_2Ec_2Ereal__topology_2Ecauchy,type,(
    mono_2Ec_2Ereal__topology_2Ecauchy: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > $o )).

thf(mono_2Ec_2Ereal__topology_2Ecomplete,type,(
    mono_2Ec_2Ereal__topology_2Ecomplete: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Ereal__topology_2Ecomplete,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ecomplete @ V0s )
    <=> ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
          ( ( ! [V2n: mono_2Etyop_2Enum_2Enum] :
                ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V1f @ V2n ) @ V0s )
            & ( mono_2Ec_2Ereal__topology_2Ecauchy @ V1f ) )
         => ? [V3l: mono_2Etyop_2Erealax_2Ereal] :
              ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3l @ V0s )
              & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ V1f @ V3l @ mono_2Ec_2Ereal__topology_2Esequentially ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__AT__SEQUENTIALLY,axiom,(
...
thf(thm_2Ereal__topology_2ELINEAR__CONTINUOUS__AT,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
     => ( mono_2Ec_2Ereal__topology_2Econtinuous_2Emono_2Etyop_2Erealax_2Ereal @ V0f @ ( mono_2Ec_2Ereal__topology_2Eat @ V1a ) ) ) )).

thf(thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2e: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V2e )
        ...
        & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
           ...
           => ( mono_2Ec_2Ereal_2Ereal__ge @ ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V4x ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2e @ ( mono_2Ec_2Ereal_2Eabs @ V4x ) ) ) )
        & ! [V5n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V3x @ V5n ) @ V1s )
        & ( mono_2Ec_2Ereal__topology_2Ecauchy @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V3x ) ) )
     => ( mono_2Ec_2Ereal__topology_2Ecauchy @ V3x ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2e: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V2e )
        & ( mono_2Ec_2Ereal__topology_2Esubspace @ V1s )
        & ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3x @ V1s )
           => ( mono_2Ec_2Ereal_2Ereal__ge @ ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V3x ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2e @ ( mono_2Ec_2Ereal_2Eabs @ V3x ) ) ) )
        & ( mono_2Ec_2Ereal__topology_2Ecomplete @ V1s ) )
     => ( mono_2Ec_2Ereal__topology_2Ecomplete @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0f @ V1s ) ) ) )).
