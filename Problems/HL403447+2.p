...
fof(conj_thm_2Erich__list_2EIS__PREFIX__APPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Erich__list_2EIS__PREFIX__APPEND2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2EEncode_2Ewf__encode__prod,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
