...
thf(conj_thm_2EOmega__Automata_2ECO__BUECHI__NEXT__CLOSURE,conjecture,(
                                          ...
                                          @ ( ap
                                            @ ( ap @ c_2Ebool_2E_2F_5C
                                              @ ( ap @ ( c_2Ebool_2E_21 @ ty_2Enum_2Enum )
                                                @ ( lam @ ty_2Enum_2Enum
                                                  @ ^ [V8t: $i] :
                                                      ( ap @ V1Phi__R @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V2i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V8t ) @ V6t0 ) ) ) @ ( ap @ V7q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V8t ) @ V6t0 ) ) ) ) ) ) )
                                            @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                                              @ ( lam @ ty_2Enum_2Enum
                                                @ ^ [V9t1: $i] :
                                                    ...
                                                    @ ( lam @ ty_2Enum_2Enum
                                                      @ ^ [V10t2: $i] :
                                                          ( ap @ V3Psi @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ V2i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t2 ) @ V6t0 ) ) ) ) @ ( ap @ V7q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V9t1 ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V10t2 ) @ V6t0 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
