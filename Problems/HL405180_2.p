...
tff(conj_thm_2Ealist_2ELENGTH__fmap__to__alist,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( mem(V0fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Ealist_2Efmap__to__alist(A_27a,A_27a),V0fm))) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm))) ) )).
