...
thf(conj_thm_2Ereal__topology_2ESERIES__CAUCHY__UNIFORM,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__COMPARISON__UNIFORM,conjecture,(
    ! [A_27a: del,V0f: $i] :
         ...
         => ! [V2P: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ? [V4l: tp__ty_2Erealax_2Ereal] :
                          ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V1g ) @ ( inj__ty_2Erealax_2Ereal @ V4l ) ) @ V3s ) )
                      & ? [V5N: tp__ty_2Enum_2Enum] :
                        ! [V6n: tp__ty_2Enum_2Enum,V7x: $i] :
                          ( ( mem @ V7x @ A_27a )
                         => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V5N ) ) @ ( inj__ty_2Enum_2Enum @ V6n ) ) )
