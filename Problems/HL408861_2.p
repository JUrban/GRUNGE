...
tff(conj_thm_2EHolSmt_2Er240,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0x)),ap(c_2Ewords_2Edimword(A_27a),c_2Ebool_2Ethe__value(A_27a))))
     => ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0x))) = ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(V0x)) ) )).
