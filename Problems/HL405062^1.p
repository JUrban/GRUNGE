...
thf(thm_2EOmega__Automata_2ENEXT__AS__CO__BUECHI,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2ENEXT @ V1a @ V0t0 )
    <=> ? [V2p: mono_2Etyop_2Enum_2Enum > $o,V3q: mono_2Etyop_2Enum_2Enum > $o] :
          ( ( (~) @ ( V2p @ V0t0 ) )
          & ( (~) @ ( V3q @ V0t0 ) )
          & ! [V4t: mono_2Etyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V2p @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( (~) @ ( V3q @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) )
                & ( V2p @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0t0 ) ) )
