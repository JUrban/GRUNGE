...
thf(conj_thm_2Ewords_2EWORD__LESS__OR__EQ,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(conj_thm_2Ewords_2EWORD__L__LESS__EQ,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__le @ A_27a ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) @ V0a ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__LESS__EQ__H,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__le @ A_27a ) @ V0a ) @ ( c_2Ewords_2Eword__H @ A_27a ) ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__L__LESS__H,conjecture,(
    ! [A_27a: del] :
