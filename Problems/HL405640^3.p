...
thf(thm_2Eordinal_2EordADD__CANCEL1,axiom,(
    ! [A_27a: $tType] :
      ( ! [V0c: tyop_2Eordinal_2Eordinal @ A_27a,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( V1a
            = ( c_2Eordinal_2EordADD @ A_27a @ V1a @ V0c ) )
        <=> ( V0c
            = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) ) )
      & ! [V2c: tyop_2Eordinal_2Eordinal @ A_27a,V3a: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( ( c_2Eordinal_2EordADD @ A_27a @ V3a @ V2c )
            = V3a )
        <=> ( V2c
            = ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) ) ) ) )).
