...
fof(conj_thm_2Ereal__topology_2EDIST__MUL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lamtp_f3700,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3700(V0c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3700,axiom,(
    ! [V0c] :
     ...
     => ! [V3x] :
         ...
         => ap(f3700(V0c),V3x) = ap(ap(c_2Erealax_2Ereal__mul,V0c),V3x) ) ) )).

fof(conj_thm_2Ereal__topology_2ECBALL__SCALING,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
