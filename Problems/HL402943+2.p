...
fof(conj_thm_2EpatternMatches_2EPMATCH__EXTEND__BOTH,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V4r__old] :
                                 ...
                                 => ! [V5r__new] :
                                     ...
                                     => ( ap(V4r__old,V0v__old) = ap(V5r__new,V1v__new)
                                       => ( ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V0v__old),V2rows__old) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V1v__new),V3rows__new)
                                         => ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V0v__old),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27c))),V4r__old),V2rows__old)) = ap(ap(c_2EpatternMatches_2EPMATCH(A_27c,A_27c),V1v__new),ap(ap(c_2Elist_2ECONS(arr(A_27b,ty_2Eoption_2Eoption(A_27c))),V5r__new),V3rows__new)) ) ) ) ) ) ) ) ) ) ) ) )).
