...
thf(c_2Ebag_2Edominates,type,(
    c_2Ebag_2Edominates: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( A_27a > A_27b > $o ) > ( A_27a > $o ) > ( A_27b > $o ) > $o ) )).
...
thf(thm_2Ebag_2EBAG__INN,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1n: tyop_2Enum_2Enum,V2b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V0e @ V1n @ V2b )
      = ( c_2Earithmetic_2E_3E_3D @ ( V2b @ V0e ) @ V1n ) ) )).
...
thf(thm_2Ebag_2EBAG__IN,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1b: A_27a > tyop_2Enum_2Enum] :
      ...
      = ( c_2Ebag_2EBAG__INN @ A_27a @ V0e @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V1b ) ) )).
...
thf(thm_2Ebag_2EBAG__INSERT__NOT__EMPTY,axiom,(
    ! [A_27a: $tType,V0x: A_27a,V1b: A_27a > tyop_2Enum_2Enum] :
      ( (~)
      @ ( ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V1b )
        = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) )).
...
thf(thm_2Ebag_2EBAG__UNION__RIGHT__CANCEL,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__UNION @ A_27a @ V1b1 @ V0b )
        = ( c_2Ebag_2EBAG__UNION @ A_27a @ V2b2 @ V0b ) )
    <=> ( V1b1 = V2b2 ) ) )).

thf(thm_2Ebag_2EBAG__UNION__DIFF__eliminate,axiom,(
    ! [A_27a: $tType,V0c: A_27a > tyop_2Enum_2Enum,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EBAG__DIFF @ A_27a @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V1b @ V0c ) @ V0c )
        = V1b )
      & ( ( c_2Ebag_2EBAG__DIFF @ A_27a @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V0c @ V1b ) @ V0c )
        = V1b ) ) )).
...
thf(thm_2Ebag_2EBAG__IN__DIFF__E,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1b2: A_27a > tyop_2Enum_2Enum,V2b1: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V2b1 @ V1b2 ) )
     => ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ V2b1 ) ) )).

thf(thm_2Ebag_2ESUB__BAG__BAG__IN,axiom,(
    ! [A_27a: $tType,V0x: A_27a,V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESUB__BAG @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V1b1 ) @ V2b2 )
     => ( c_2Ebag_2EBAG__IN @ A_27a @ V0x @ V2b2 ) ) )).
...
thf(thm_2Ebag_2ESUB__BAG__DIFF__EQ,axiom,(
    ! [A_27a: $tType,V0b1: A_27a > tyop_2Enum_2Enum,V1b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESUB__BAG @ A_27a @ V0b1 @ V1b2 )
     => ( V1b2
        = ( c_2Ebag_2EBAG__UNION @ A_27a @ V0b1 @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V1b2 @ V0b1 ) ) ) ) )).

thf(thm_2Ebag_2EBAG__FILTER__DEF,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__FILTER @ A_27a @ V0P @ V1b )
      = ( ^ [V2e: A_27a] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( V0P @ V2e ) @ ( V1b @ V2e ) @ c_2Enum_2E0 ) ) ) )).
...
thf(thm_2Ebag_2EBAG__IN__BAG__FILTER,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1b: A_27a > tyop_2Enum_2Enum,V2P: A_27a > $o] :
      ( ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ ( c_2Ebag_2EBAG__FILTER @ A_27a @ V2P @ V1b ) )
    <=> ( ( V2P @ V0e )
        & ( c_2Ebag_2EBAG__IN @ A_27a @ V0e @ V1b ) ) ) )).
...
thf(thm_2Ebag_2Edominates__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0R: A_27a > A_27b > $o,V1s1: A_27a > $o,V2s2: A_27b > $o] :
      ( ( c_2Ebag_2Edominates @ A_27a @ A_27b @ V0R @ V1s1 @ V2s2 )
    <=> ! [V3x: A_27a] :
          ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V1s1 )
         => ? [V4y: A_27b] :
              ( ( c_2Ebool_2EIN @ A_27b @ V4y @ V2s2 )
              & ( V0R @ V3x @ V4y ) ) ) ) )).
...
thf(thm_2Ebag_2Emlt__dominates__thm1,conjecture,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ( ( c_2Erelation_2Etransitive @ A_27a @ V0R )
     => ! [V1b1: A_27a > tyop_2Enum_2Enum,V2b2: A_27a > tyop_2Enum_2Enum] :
          ( ( c_2Erelation_2ETC @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ A_27a @ V0R ) @ V1b1 @ V2b2 )
        <=> ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V1b1 )
            & ( c_2Ebag_2EFINITE__BAG @ A_27a @ V2b2 )
            & ? [V3x: A_27a > tyop_2Enum_2Enum,V4y: A_27a > tyop_2Enum_2Enum] :
                ( ( (~)
                  @ ( V3x
                    = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )
                & ( c_2Ebag_2ESUB__BAG @ A_27a @ V3x @ V2b2 )
                & ( V1b1
                  = ( c_2Ebag_2EBAG__UNION @ A_27a @ ( c_2Ebag_2EBAG__DIFF @ A_27a @ V2b2 @ V3x ) @ V4y ) )
                & ( c_2Ebag_2Edominates @ A_27a @ A_27a @ V0R @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V4y ) @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V3x ) ) ) ) ) ) )).
