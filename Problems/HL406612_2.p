...
tff(tp_c_2ECoder_2Ebool__coder,type,(
    c_2ECoder_2Ebool__coder: $i )).

tff(mem_c_2ECoder_2Ebool__coder,axiom,(
...
tff(ax_thm_2ECoder_2Ebool__coder__def,axiom,(
    ! [V0p: $i] :
...
tff(conj_thm_2EEncodeVar_2Efixed__width__bool,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(bool,bool))
