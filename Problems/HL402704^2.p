...
thf(conj_thm_2Erich__list_2ELASTN,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0l: $i] :
          ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0l )
            = ( c_2Elist_2ENIL @ A_27a ) ) )
      & ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
          ( ( mem @ V2x @ A_27b )
         => ! [V3l: $i] :
              ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27b ) )
             => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27b ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27b ) @ V2x ) @ V3l ) )
                = ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27b ) @ V2x ) @ ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V3l ) ) ) ) ) ) )).

thf(ax_thm_2Erich__list_2ESEG,axiom,(
    ! [A_27a: del] :
      ( ! [V0k: tp__ty_2Enum_2Enum,V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0k ) ) @ V1l )
            = ( c_2Elist_2ENIL @ A_27a ) ) )
      & ! [V2m: tp__ty_2Enum_2Enum,V3x: $i] :
          ( ( mem @ V3x @ A_27a )
         => ! [V4l: $i] :
              ( ( mem @ V4l @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3x ) @ V4l ) )
                = ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3x ) @ ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V4l ) ) ) ) )
      & ! [V5m: tp__ty_2Enum_2Enum,V6k: tp__ty_2Enum_2Enum,V7x: $i] :
          ( ( mem @ V7x @ A_27a )
         => ! [V8l: $i] :
              ( ( mem @ V8l @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V5m ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V6k ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V7x ) @ V8l ) )
                = ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V5m ) ) ) @ ( inj__ty_2Enum_2Enum @ V6k ) ) @ V8l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2ESEG__LENGTH__ID,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0l )
        = V0l ) ) )).

thf(conj_thm_2Erich__list_2ELASTN__CONS,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ! [V2x: $i] :
            ( ( mem @ V2x @ A_27a )
           => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V1l ) )
              = ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2ELASTN__LENGTH__ID,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) @ V0l )
        = V0l ) ) )).
...
thf(conj_thm_2Erich__list_2ELASTN__SEG,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
          = ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1l ) ) ) ) )).
