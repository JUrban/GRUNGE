...
fof(conj_thm_2Epatricia_2EPERM__ADD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
...
fof(conj_thm_2Epatricia_2EPERM__NOT__ADD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
         => ! [V1k] :
             ...
             => ! [V2d] :
                 ...
                 => ( ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1k),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),ap(c_2Epatricia_2ETRAVERSE(A_27a),V0t)))) )
                   => ap(c_2Epatricia_2ETRAVERSE(A_27a),ap(ap(c_2Epatricia_2EADD(A_27a),V0t),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1k),V2d))) = ap(c_2Epatricia_2ETRAVERSE(A_27a),V0t) ) ) ) ) ) )).

fof(conj_thm_2Epatricia_2ESIZE__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0t] :
          ( mem(V0t,ty_2Epatricia_2Eptree(A_27a))
         => ! [V1k] :
             ...
             => ! [V2d] :
                  ( mem(V2d,A_27a)
                 => ( p(ap(c_2Epatricia_2EIS__PTREE(A_27a),V0t))
                   => ap(c_2Epatricia_2ESIZE(A_27a),ap(ap(c_2Epatricia_2EADD(A_27a),V0t),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1k),V2d))) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1k),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),ap(c_2Epatricia_2ETRAVERSE(A_27a),V0t)))),ap(c_2Epatricia_2ESIZE(A_27a),V0t)),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epatricia_2ESIZE(A_27a),V0t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) ) ) ) ) ) )).
