...
thf(conj_thm_2Ebag_2ESUB__BAG__INSERT__I,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1c: $i] :
...
thf(conj_thm_2Ebag_2EBAG__DIFF__INSERT__SUB__BAG,lemma,(
    ! [A_27a: del,V0c: $i] :
...
thf(conj_thm_2Ebag_2Emlt__INSERT__CANCEL,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27a )
