...
thf(f5340_0_2E0,type,(
    f5340_0_2E0: u )).

thf(f5340_0_2E2,type,(
    f5340_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef5340_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5340_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f5340_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EDOMSUB__FLOOKUP,axiom,(
    ! [A_27a: d,A_27b: d,V0fm_2E0: u,V1k_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2Efdomsub_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) @ ( s @ A_27a @ V1k_2E0 ) ) )
...
thf(def0_2Ethm_2Efinite__map_2EDOMSUB__FLOOKUP__THM,axiom,(
    ! [A_27a: d,V1k1_2E0: u,V2k2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5340_0_2E2 @ ( s @ A_27a @ V1k1_2E0 ) @ ( s @ A_27a @ V2k2_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V1k1_2E0 )
        = ( s @ A_27a @ V2k2_2E0 ) ) ) )).
...
thf(thm_2Efinite__map_2EDOMSUB__FLOOKUP__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0fm_2E0: u,V1k1_2E0: u,V2k2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2Efdomsub_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) @ ( s @ A_27a @ V1k1_2E0 ) ) ) @ ( s @ A_27a @ V2k2_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5340_0_2E2 @ ( s @ A_27a @ V1k1_2E0 ) @ ( s @ A_27a @ V2k2_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ c_2Eoption_2ENONE_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0fm_2E0 ) @ ( s @ A_27a @ V2k2_2E0 ) ) ) ) ) ) )).
