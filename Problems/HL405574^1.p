...
thf(f6520_0_2E0,type,(
    f6520_0_2E0: u )).

thf(f6520_0_2E1,type,(
    f6520_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef6520_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6520_0_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ f6520_0_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eordinal_2EfromNat__def,axiom,(
    ! [A_27a: d,V0a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6520_0_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V0a_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2ET ) )).
...
thf(thm_2Eordinal_2EfromNat__def,axiom,(
    ! [A_27a: d] :
      ( ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) )
        = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2Eoleast_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ f6520_0_2E0 ) ) ) )
      & ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) ) )
          = ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EordSUC_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) ) ) ) )).

thf(thm_2Eordinal_2EfromNat__SUC,conjecture,(
