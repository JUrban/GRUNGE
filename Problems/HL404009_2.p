...
tff(lamtp_f1261,axiom,(
    ! [A_27b: del,A_27a: del,V6f1: $i] :
      ( mem(V6f1,arr(A_27a,A_27b))
     => mem(f1261(A_27b,A_27a,V6f1),arr(A_27a,A_27b)) ) )).
...
tff(lameq_f1261,axiom,(
    ! [A_27b: del,A_27a: del,V6f1: $i] :
     ...
     => ! [V8x: $i] :
          ( mem(V8x,A_27a)
         => ap(f1261(A_27b,A_27a,V6f1),V8x) = ap(V6f1,V8x) ) ) )).

tff(lmtp_f1262,type,(
    f1262: ( del * del * $i ) > $i )).

tff(lamtp_f1262,axiom,(
    ! [A_27b: del,A_27a: del,V7f2: $i] :
      ( mem(V7f2,arr(A_27a,A_27b))
     => mem(f1262(A_27b,A_27a,V7f2),arr(A_27a,A_27b)) ) )).
...
tff(lameq_f1262,axiom,(
    ! [A_27b: del,A_27a: del,V7f2: $i] :
     ...
     => ! [V9y: $i] :
          ( mem(V9y,A_27a)
         => ap(f1262(A_27b,A_27a,V7f2),V9y) = ap(V7f2,V9y) ) ) )).

tff(conj_thm_2Equotient_2ELAMBDA__RSP,conjecture,(
                             ...
                             => ! [V6f1: $i] :
                                 ...
                                 => ! [V7f2: $i] :
                                     ...
                                     => ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),V3R2),V6f1),V7f2))
                                       => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),V3R2),f1261(A_27b,A_27a,V6f1)),f1262(A_27b,A_27a,V7f2))) ) ) ) ) ) ) ) ) ) ) ) )).
