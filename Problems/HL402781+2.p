...
fof(conj_thm_2Erich__list_2Eis__prefix__el,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l1] :
             ...
             => ! [V2l2] :
                 ...
                 => ( ( p(ap(ap(c_2Elist_2EisPREFIX(A_27a),V1l1),V2l2))
                      ...
                      & p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V2l2))) )
                   => ap(ap(c_2Elist_2EEL(A_27a),V0n),V1l1) = ap(ap(c_2Elist_2EEL(A_27a),V0n),V2l2) ) ) ) ) ) )).
