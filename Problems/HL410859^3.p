...
thf(thm_2Ereal__topology_2ENET__DILEMMA,axiom,(
    ! [A_27a: $tType,V0Q: A_27a > $o,V1P: A_27a > $o,V2net: tyop_2Ereal__topology_2Enet @ A_27a] :
      ( ( ? [V3a: A_27a] :
            ( ? [V4x: A_27a] :
                ( c_2Ereal__topology_2Enetord @ A_27a @ V2net @ V4x @ V3a )
            & ! [V5x: A_27a] :
                ( ( c_2Ereal__topology_2Enetord @ A_27a @ V2net @ V5x @ V3a )
               => ( V1P @ V5x ) ) )
        & ? [V6b: A_27a] :
            ( ? [V7x: A_27a] :
                ( c_2Ereal__topology_2Enetord @ A_27a @ V2net @ V7x @ V6b )
            & ! [V8x: A_27a] :
                ( ( c_2Ereal__topology_2Enetord @ A_27a @ V2net @ V8x @ V6b )
               => ( V0Q @ V8x ) ) ) )
     => ? [V9c: A_27a] :
          ( ? [V10x: A_27a] :
              ( c_2Ereal__topology_2Enetord @ A_27a @ V2net @ V10x @ V9c )
          & ! [V11x: A_27a] :
...
thf(thm_2Ereal__topology_2EEVENTUALLY__AND,conjecture,(
