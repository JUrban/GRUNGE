...
tff(conj_thm_2Ellist_2ELTAKE__CONS__EQ__NONE,conjecture,(
    ! [A_27a: del,V0m: tp__ty_2Enum_2Enum,V1h: $i] :
      ( mem(V1h,A_27a)
     => ! [V2t: $i] :
          ( mem(V2t,ty_2Ellist_2Ellist(A_27a))
         => ( ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0m)),ap(ap(c_2Ellist_2ELCONS(A_27a),V1h),V2t)) = c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a))
          <=> ? [V3n: tp__ty_2Enum_2Enum] :
                ( V0m = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))
                & ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V3n)),V2t) = c_2Eoption_2ENONE(ty_2Elist_2Elist(A_27a)) ) ) ) ) )).
