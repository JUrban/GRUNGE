                 ...
                 => ! [V4l] :
                     ...
                     => ! [V5m] :
                         ...
                         => ! [V1P] :
                             ...
                             => ! [V14n] :
                                  ( mem(V14n,A_27b)
                                 => ap(f3771(A_27a,A_27b,V12e,V2f,V3g,V13x,V4l,V5m,V1P),V14n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1P,V14n)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__add,ap(ap(V2f,V14n),V13x)),ap(ap(V3g,V14n),V13x))),ap(ap(c_2Erealax_2Ereal__add,ap(V4l,V14n)),ap(V5m,V14n))))),V12e)) ) ) ) ) ) ) ) ) )).

fof(lamtp_f3770,axiom,(
    ! [A_27b,A_27a,V1P] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
         => ! [V4l] :
             ...
             => ! [V3g] :
                 ...
                 => ! [V2f] :
                     ...
                     => ! [V12e] :
                          ( mem(V12e,ty_2Erealax_2Ereal)
                         => mem(f3770(A_27b,A_27a,V1P,V5m,V4l,V3g,V2f,V12e),arr(A_27a,bool)) ) ) ) ) ) ) )).

fof(lameq_f3770,axiom,(
    ! [A_27b,A_27a,V1P] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2EUNIFORM__LIM__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
