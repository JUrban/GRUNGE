...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__ADD2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1b] :
                 ...
                 => ! [V2h] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V2h),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                       => ap(ap(ap(c_2Ewords_2Eword__extract(A_27b,A_27b),V2h),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__add(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V0a)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),V1b))) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V2h),c_2Enum_2E0),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),V1b)) ) ) ) ) ) ) )).
