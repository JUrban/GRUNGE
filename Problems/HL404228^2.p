...
thf(conj_thm_2Elist_2EEL__LENGTH__SNOC,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Ellist_2ELTAKE__SNOC__LNTH,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1ll )
        = ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) )
          @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
            @ ^ [V2l: $i] :
                ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ A_27a @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) )
                @ ( lam @ A_27a
                  @ ^ [V3e: $i] :
                      ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3e ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epath_2Enth__label__LNTH,lemma,(
...
thf(conj_thm_2Epath_2Enth__label__LTAKE,conjecture,(
