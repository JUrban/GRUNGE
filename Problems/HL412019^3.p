    ...
    ( ( c_2Eextreal_2Eextreal__sup
      @ ^ [V0x: tyop_2Eextreal_2Eextreal] :
          ...
          @ ^ [V1n: tyop_2Enum_2Enum] :
              ( c_2Emin_2E_3D @ tyop_2Eextreal_2Eextreal @ V0x @ ( c_2Eextreal_2Eextreal__of__num @ V1n ) ) ) )
    = c_2Eextreal_2EPosInf )).
    ...
    ! [A_27a: $tType,V0f: A_27a > tyop_2Eextreal_2Eextreal,V1c: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Eextreal_2Eextreal__sup
          @ ( c_2Epred__set_2EIMAGE @ A_27a @ tyop_2Eextreal_2Eextreal
            @ ^ [V2n: A_27a] :
                ( c_2Eextreal_2Eextreal__mul @ ( c_2Eextreal_2ENormal @ V1c ) @ ( V0f @ V2n ) )
...
thf(thm_2Elebesgue_2Epos__fn__integral__cmul__indicator,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o,V2c: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
          @ ^ [V3x: A_27a] :
              ( c_2Eextreal_2Eextreal__mul @ ( c_2Eextreal_2ENormal @ V2c ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V1s @ V3x ) ) )
        = ( c_2Eextreal_2ENormal @ ( c_2Erealax_2Ereal__mul @ V2c @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s ) ) ) ) ) )).

thf(thm_2Elebesgue_2Elebesgue__monotone__convergence__subset,axiom,(
...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__CONST,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1k: tyop_2Eextreal_2Eextreal,V2f: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) )
           => ( ( V2f @ V3x )
              = V1k ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V2f @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ V0a @ c_2Emeasure_2EBorel ) ) ) )).
...
thf(thm_2Elebesgue_2Epos__fn__integral__cmul__infty,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V0m )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
     => ( ( c_2Elebesgue_2Epos__fn__integral @ A_27a @ V0m
          @ ^ [V2x: A_27a] :
              ( c_2Eextreal_2Eextreal__mul @ c_2Eextreal_2EPosInf @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V1s @ V2x ) ) )
        = ( c_2Eextreal_2Eextreal__mul @ c_2Eextreal_2EPosInf @ ( c_2Eextreal_2ENormal @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m @ V1s ) ) ) ) ) )).
