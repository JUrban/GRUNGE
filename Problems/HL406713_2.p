...
tff(conj_thm_2EOmega_2Esumc__thm,lemma,(
...
tff(lmtp_f2515,type,(
    f2515: tp__ty_2Einteger_2Eint > $i )).

tff(lamtp_f2515,axiom,(
    ! [V2f: tp__ty_2Einteger_2Eint] : mem(f2515(V2f),arr(ty_2Einteger_2Eint,ty_2Einteger_2Eint)) )).

tff(lameq_f2515,axiom,(
    ! [V2f: tp__ty_2Einteger_2Eint,V3x: tp__ty_2Einteger_2Eint] : ap(f2515(V2f),inj__ty_2Einteger_2Eint(V3x)) = ap(ap(c_2Einteger_2Eint__mul,inj__ty_2Einteger_2Eint(V2f)),inj__ty_2Einteger_2Eint(V3x)) )).

tff(conj_thm_2EOmega_2Esumc__MULT,conjecture,(
    ! [V0cs: tp__c_ty_2Elist_2Elist_ty_2Einteger_2Eint,V1vs: tp__c_ty_2Elist_2Elist_ty_2Einteger_2Eint,V2f: tp__ty_2Einteger_2Eint] : surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__mul,inj__ty_2Einteger_2Eint(V2f)),ap(ap(c_2EOmega_2Esumc,inj__c_ty_2Elist_2Elist_ty_2Einteger_2Eint(V0cs)),inj__c_ty_2Elist_2Elist_ty_2Einteger_2Eint(V1vs)))) = surj__ty_2Einteger_2Eint(ap(ap(c_2EOmega_2Esumc,ap(ap(c_2Elist_2EMAP(ty_2Einteger_2Eint,ty_2Einteger_2Eint),f2515(V2f)),inj__c_ty_2Elist_2Elist_ty_2Einteger_2Eint(V0cs))),inj__c_ty_2Elist_2Elist_ty_2Einteger_2Eint(V1vs))) )).
