...
thf(f4986_0_2E0,type,(
    f4986_0_2E0: u )).

thf(f4986_0_2E2,type,(
    f4986_0_2E2: du > du > u )).

thf(f4986_0_2E3,type,(
    f4986_0_2E3: du > du > du > u )).

thf(f4986_1_2E0,type,(
    f4986_1_2E0: u )).

thf(f4986_1_2E1,type,(
    f4986_1_2E1: du > u )).

thf(f4986_1_2E2,type,(
    f4986_1_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef4986_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4986_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef4986_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4986_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef4986_1_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( f4986_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ f4986_1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4986_1_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) @ ( f4986_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
...
thf(def0_2Ethm_2Ecardinal_2ESURJECTIVE__IMAGE__THM,axiom,(
    ! [A_27a: d,A_27b: d,V3P_2E0: u,V0f_2E0: u,V4x_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4986_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) )
...
thf(def1_2Ethm_2Ecardinal_2ESURJECTIVE__IMAGE__THM,axiom,(
    ! [A_27b: d,V3P_2E0: u,V5x_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) @ ( f4986_1_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ A_27b @ V5x_2E0 ) ) )
    ...
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ! [V1y_2E0: u] :
        ? [V2x_2E0: u] :
          ...
          = ( s @ A_27b @ V1y_2E0 ) )
    <=> ! [V3P_2E0: u] :
          ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4986_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) ) ) ) )
          = ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( f4986_1_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) ) ) ) ) ) ) )).
