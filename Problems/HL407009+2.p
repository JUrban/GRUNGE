...
fof(conj_thm_2Einteger_2EINT__LE__NEG,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__REM0,lemma,(
    ! [V0q] :
      ( mem(V0q,ty_2Einteger_2Eint)
     => ( V0q != ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)
       => ap(ap(c_2Einteger_2Eint__rem,ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)),V0q) = ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0) ) ) )).
...
fof(mem_c_2Ewords_2Eword__rem,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__rem(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
    ...
    ! [A_27a] :
     ...
     => ! [V0a] :
         ...
         => ! [V1b] :
             ...
             => ap(ap(c_2Ewords_2Eword__rem(A_27a),V0a),V1b) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V0a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V1b)),ap(c_2Ewords_2Eword__2comp(A_27a),ap(ap(c_2Ewords_2Eword__mod(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a)),ap(c_2Ewords_2Eword__2comp(A_27a),V1b)))),ap(c_2Ewords_2Eword__2comp(A_27a),ap(ap(c_2Ewords_2Eword__mod(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a)),V1b)))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2Eword__msb(A_27a),V1b)),ap(ap(c_2Ewords_2Eword__mod(A_27a),V0a),ap(c_2Ewords_2Eword__2comp(A_27a),V1b))),ap(ap(c_2Ewords_2Eword__mod(A_27a),V0a),V1b))) ) ) ) )).
...
fof(conj_thm_2Einteger__word_2Ew2i__i2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger__word_2Eranged__int__word__nchotomy,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Einteger__word_2EMULT__MINUS__ONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger__word_2EINT__MAX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2EINT__ZERO__LT__INT__MIN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ei2w__pos,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger__word_2Eword__rem,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
