...
tff(lamtp_f1872,axiom,(
    ! [A_27b: del,A_27a: del,V3P: $i] :
      ( mem(V3P,arr(A_27b,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => mem(f1872(A_27b,A_27a,V3P,V0f),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f1872,axiom,(
    ! [A_27b: del,A_27a: del,V3P: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f1872(A_27b,A_27a,V3P,V0f),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(V3P,ap(V0f,V4x))) ) ) ) )).

tff(lmtp_f1873,type,(
    f1873: ( del * $i ) > $i )).

tff(lamtp_f1873,axiom,(
    ! [A_27b: del,V3P: $i] :
      ( mem(V3P,arr(A_27b,bool))
     => mem(f1873(A_27b,V3P),arr(A_27b,ty_2Epair_2Eprod(A_27b,A_27b))) ) )).
...
tff(lameq_f1873,axiom,(
    ! [A_27b: del,V3P: $i] :
     ...
     => ! [V5x: $i] :
          ( mem(V5x,A_27b)
         => ap(f1873(A_27b,V3P),V5x) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V5x),ap(V3P,V5x)) ) ) )).

tff(conj_thm_2Ecardinal_2ESURJECTIVE__IMAGE__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ( ! [V1y: $i] :
            ( mem(V1y,A_27b)
      ...
      <=> ! [V3P: $i] :
            ( mem(V3P,arr(A_27b,bool))
           => ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f1872(A_27b,A_27a,V3P,V0f))) = ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f1873(A_27b,V3P)) ) ) ) )).
