...
fof(conj_thm_2Eextreal_2Esup__le__mono,conjecture,(
    ! [V0f] :
     ...
     => ! [V1z] :
         ...
         => ( ( ! [V2n] :
              ...
              & p(ap(ap(c_2Eextreal_2Eextreal__lt,V1z),ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))))) )
           => ? [V3n] :
