...
tff(conj_thm_2Ereal_2EREAL__DIV__INNER__CANCEL2,lemma,(
...
tff(conj_thm_2Eintegral_2EGAUGE__MIN__FINITE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,conjecture,(
    ! [V0f: $i] :
