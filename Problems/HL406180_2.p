...
tff(conj_thm_2Efcp_2ENOT__FINITE__IMP__dimindex__1,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Ewords_2Ew2w__w2w,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ap(c_2Ewords_2Ew2w(A_27b,A_27b),ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0w)) = ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0w)) ) )).
...
tff(conj_thm_2Ewords_2Eword__join__0,lemma,(
...
tff(conj_thm_2Ewords_2Ew2w__eq__n2w,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1y: tp__ty_2Enum_2Enum] :
         ...
         => ( ap(c_2Ewords_2Ew2w(A_27a,A_27a),V0x) = ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(V1y))
          <=> V0x = ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V1y)) ) ) ) )).

tff(conj_thm_2Ewords_2Eword__concat__0,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: tp__ty_2Enum_2Enum] :
     ...
     => ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(V0x))) = ap(c_2Ewords_2En2w(A_27c),inj__ty_2Enum_2Enum(V0x)) ) )).
