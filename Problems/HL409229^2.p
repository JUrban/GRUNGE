...
thf(conj_thm_2Eintegral_2EINTEGRAL__LE,lemma,(
...
thf(conj_thm_2Eintegral_2EDINT__LE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
              ...
              ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) )
                ...
                & ! [V6x: tp__ty_2Erealax_2Ereal] :
                    ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) )
                      & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) @ ( inj__ty_2Erealax_2Ereal @ V3b ) ) ) )
                   => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) ) ) ) )
             => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V4i ) ) @ ( inj__ty_2Erealax_2Ereal @ V5j ) ) ) ) ) ) )).
