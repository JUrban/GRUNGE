...
tff(thm_2Enets_2EDORDER__LEMMA,axiom,(
    ! [A_27a: $tType,V0g_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))] :
     ...
     => ! [V1P_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2Q_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] :
          ( ( ? [V3n_2E0: A_27a] :
                ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V3n_2E0),V3n_2E0))
                & ! [V4m_2E0: A_27a] :
                    ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V4m_2E0),V3n_2E0))
                   => p(app_2E2(A_27a,tyop_2Emin_2Ebool,V1P_2E0,V4m_2E0)) ) )
            & ? [V5n_2E0: A_27a] :
                ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V5n_2E0),V5n_2E0))
                & ! [V6m_2E0: A_27a] :
                    ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V6m_2E0),V5n_2E0))
                   => p(app_2E2(A_27a,tyop_2Emin_2Ebool,V2Q_2E0,V6m_2E0)) ) ) )
         => ? [V7n_2E0: A_27a] :
              ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V7n_2E0),V7n_2E0))
              & ! [V8m_2E0: A_27a] :
                  ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V8m_2E0),V7n_2E0))
                 => ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,V1P_2E0,V8m_2E0))
                    & p(app_2E2(A_27a,tyop_2Emin_2Ebool,V2Q_2E0,V8m_2E0)) ) ) ) ) ) )).
     ...
     => ! [V1x_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V2x0_2E0: tyop_2Erealax_2Ereal,V3y_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V4y0_2E0: tyop_2Erealax_2Ereal] :
          ( ( p(c_2Enets_2Etends_2E3(tyop_2Erealax_2Ereal,A_27a,V1x_2E0,V2x0_2E0,c_2Epair_2E_2C_2E2(tyop_2Etopology_2Etopology(tyop_2Erealax_2Ereal),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),c_2Emetric_2Emtop_2E1(tyop_2Erealax_2Ereal,c_2Emetric_2Emr1_2E0),V0g_2E0)))
            ...
            & ? [V5N_2E0: A_27a] :
                ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V5N_2E0),V5N_2E0))
                & ! [V6n_2E0: A_27a] :
                    ( p(app_2E2(A_27a,tyop_2Emin_2Ebool,app_2E2(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0g_2E0,V6n_2E0),V5N_2E0))
                   => p(c_2Ereal_2Ereal__lte_2E2(app_2E2(A_27a,tyop_2Erealax_2Ereal,V1x_2E0,V6n_2E0),app_2E2(A_27a,tyop_2Erealax_2Ereal,V3y_2E0,V6n_2E0))) ) ) )
         => p(c_2Ereal_2Ereal__lte_2E2(V2x0_2E0,V4y0_2E0)) ) ) )).
