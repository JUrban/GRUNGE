...
fof(conj_thm_2Eiterate_2ESUM__UNION__NONZERO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Eiterate_2ESUM__BIGUNION__NONZERO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),V1s))
               ...
               => ap(ap(c_2Eiterate_2ESum(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V1s)),V0f) = ap(ap(c_2Eiterate_2ESum(arr(A_27a,bool)),V1s),f3381(A_27a,A_27a,V0f)) ) ) ) ) )).
