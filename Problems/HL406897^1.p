...
thf(f8146_0_2E0,type,(
    f8146_0_2E0: u )).

thf(f8146_0_2E1,type,(
    f8146_0_2E1: du > u )).

thf(f8146_1_2E0,type,(
    f8146_1_2E0: u )).

thf(f8146_1_2E1,type,(
    f8146_1_2E1: du > u )).

thf(f8146_1_2E3,type,(
    f8146_1_2E3: du > du > du > u )).
...
thf(c_2Efinite__map_2EFAPPLY_2E0,type,(
    c_2Efinite__map_2EFAPPLY_2E0: u )).

thf(c_2Efinite__map_2EFAPPLY_2E2,type,(
    c_2Efinite__map_2EFAPPLY_2E2: du > du > u )).

thf(c_2Efinite__map_2EFDOM_2E0,type,(
    c_2Efinite__map_2EFDOM_2E0: u )).

thf(c_2Efinite__map_2EFDOM_2E1,type,(
    c_2Efinite__map_2EFDOM_2E1: du > u )).

thf(c_2Efinite__map_2EFEMPTY_2E0,type,(
    c_2Efinite__map_2EFEMPTY_2E0: u )).
...
thf(c_2Efinite__map_2EFLOOKUP_2E0,type,(
    c_2Efinite__map_2EFLOOKUP_2E0: u )).

thf(c_2Efinite__map_2EFLOOKUP_2E2,type,(
    c_2Efinite__map_2EFLOOKUP_2E2: du > du > u )).

thf(c_2Efmsp_2EFMSP_2E0,type,(
    c_2Efmsp_2EFMSP_2E0: u )).

thf(c_2Efmsp_2EFMSP_2E2,type,(
    c_2Efmsp_2EFMSP_2E2: du > du > u )).

thf(c_2Efmsp_2EFMSP_2E4,type,(
    c_2Efmsp_2EFMSP_2E4: du > du > du > du > u )).

thf(c_2Efinite__map_2EFUN__FMAP_2E0,type,(
    c_2Efinite__map_2EFUN__FMAP_2E0: u )).

thf(c_2Efinite__map_2EFUN__FMAP_2E2,type,(
    c_2Efinite__map_2EFUN__FMAP_2E2: du > du > u )).
...
thf(c_2Epred__set_2ELINV_2E0,type,(
    c_2Epred__set_2ELINV_2E0: u )).

thf(c_2Epred__set_2ELINV_2E3,type,(
    c_2Epred__set_2ELINV_2E3: du > du > du > u )).
...
thf(c_2Etransfer_2EPAIR__REL_2E2,type,(
    c_2Etransfer_2EPAIR__REL_2E2: du > du > u )).
...
thf(c_2Esptree_2Edomain_2E0,type,(
    c_2Esptree_2Edomain_2E0: u )).

thf(c_2Esptree_2Edomain_2E1,type,(
...
thf(c_2Esptree_2Elookup_2E0,type,(
    c_2Esptree_2Elookup_2E0: u )).

thf(c_2Esptree_2Elookup_2E2,type,(
...
thf(arityeq1_2Emono_2Ef8146_0_2E1_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( f8146_0_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ f8146_0_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef8146_1_2E1_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( f8146_1_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) ) @ f8146_1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef8146_1_2E3_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( f8146_1_2E3 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) @ ( s @ A_27c @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) ) @ f8146_1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) @ ( s @ A_27c @ X2_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Epair_2E_2C_2E2_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Epair_2E_2C_2E2_2Emono_2EA_27b_20mono_2EA_27d,axiom,(
...
thf(arityeq3_2Emono_2Ec_2Ebool_2ECOND_2E3_2Emono_2Etyop_2Eoption_2Eoption_28A_27b_29,axiom,(
    ! [A_27b: d,X0: $o,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) ) @ c_2Ebool_2ECOND_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X0 ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X2_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFAPPLY_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ c_2Efinite__map_2EFAPPLY_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Efinite__map_2EFDOM_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ c_2Efinite__map_2EFDOM_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFLOOKUP_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) ) @ c_2Efinite__map_2EFLOOKUP_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Efmsp_2EFMSP_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Efmsp_2EFMSP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Efmsp_2EFMSP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ec_2Efmsp_2EFMSP_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efmsp_2EFMSP_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X2_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Efmsp_2EFMSP_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X3_2E0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFUN__FMAP_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUN__FMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ec_2Etransfer_2EFUN__REL_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c_20mono_2EA_27d,axiom,(
...
thf(arityeq4_2Emono_2Ec_2Etransfer_2EFUN__REL_2E4_2Emono_2Etyop_2Efinite__map_2Efmap_28A_27a_2CA_27b_29_20mono_2Etyop_2Esptree_2Espt_28A_27c_29_20mono_2Etyop_2Emin_2Efun_28tyop_2Epair_2Eprod_28A_27a_2CA_27b_29_2Ctyop_2Efinite__map_2Efmap_28A_27a_2CA_27b_29_29_20mono_2Etyop_2Emin_2Efun_28tyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2CA_27c_29_2Ctyop_2Esptree_2Espt_28A_27c_29_29,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2EFUN__REL_2E4 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ X2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Etransfer_2EFUN__REL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ X3_2E0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Etransfer_2EFUN__REL_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2CA_27b_29_20mono_2Etyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2CA_27c_29_20mono_2Etyop_2Efinite__map_2Efmap_28A_27a_2CA_27b_29_20mono_2Etyop_2Esptree_2Espt_28A_27c_29,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Etransfer_2EFUN__REL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Etransfer_2EFUN__REL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFUPDATE_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ec_2Epred__set_2ELINV_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27a @ ( c_2Epred__set_2ELINV_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) ) @ c_2Epred__set_2ELINV_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) @ ( s @ A_27b @ X2_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Eoption_2EOPTREL_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTREL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ tyop_2Emin_2Ebool ) ) ) @ c_2Eoption_2EOPTREL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X2_2E0 ) ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Eoption_2EOPTREL_2E3_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTREL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X1_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ X2_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27c ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Eoption_2Eoption @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) @ c_2Eoption_2EOPTREL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ X2_2E0 ) ) ) ) ) )).

thf(arityeq4_2Emono_2Ec_2Etransfer_2EPAIR__REL_2E4_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
...
thf(arityeq2_2Emono_2Ec_2Etransfer_2EPAIR__REL_2E2_2Emono_2EA_27a_20mono_2Etyop_2Enum_2Enum_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Etransfer_2EPAIR__REL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) ) ) @ c_2Etransfer_2EPAIR__REL_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Epair_2EUNCURRY_2E1_2Emono_2Etyop_2Enum_2Enum_20mono_2EA_27c_20mono_2Etyop_2Esptree_2Espt_28A_27c_29,axiom,(
    ! [A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ c_2Epair_2EUNCURRY_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebi__unique_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebi__unique_2E1_2Emono_2EA_27a_20mono_2Etyop_2Enum_2Enum,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebi__unique_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ tyop_2Emin_2Ebool ) @ c_2Etransfer_2Ebi__unique_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebitotal_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebitotal_2E1_2Emono_2EA_27a_20mono_2Etyop_2Enum_2Enum,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ tyop_2Emin_2Ebool ) @ c_2Etransfer_2Ebitotal_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebitotal_2E1_2Emono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ tyop_2Emin_2Ebool ) @ c_2Etransfer_2Ebitotal_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Ebitotal_2E1_2Emono_2Etyop_2Efinite__map_2Efmap_28A_27a_2CA_27b_29_20mono_2Etyop_2Esptree_2Espt_28A_27c_29,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ tyop_2Emin_2Ebool ) @ c_2Etransfer_2Ebitotal_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Esptree_2Edomain_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ c_2Esptree_2Edomain_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X0_2E0 ) ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Esptree_2Einsert_2E3_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ A_27c @ X1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) ) @ c_2Esptree_2Einsert_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X2_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Eleft__unique_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq2_2Emono_2Ec_2Esptree_2Elookup_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27a ) @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ c_2Esptree_2Elookup_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ X1_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Esptree_2Elookup_2E2_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Eoption_2Eoption @ A_27c ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Eoption_2Eoption @ A_27c ) ) ) @ c_2Esptree_2Elookup_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ X1_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Etransfer_2Eright__unique_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Etransfer_2Esurj_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Etransfer_2Etotal_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(thm_2Efinite__map_2Efmap__INDUCT,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 ) ) ) )
        & ! [V1f_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) ) ) )
           => ! [V2x_2E0: u,V3y_2E0: u] :
                ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) ) ) ) ) ) )
               => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27b @ V3y_2E0 ) ) ) ) ) ) ) ) ) ) )
     => ! [V4f_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V4f_2E0 ) ) ) ) ) )).

thf(thm_2Efinite__map_2EFLOOKUP__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1x_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ c_2Eoption_2ENONE_2E0 ) ) ) ) )).

thf(thm_2Efinite__map_2EFUN__FMAP__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EFINITE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) )
     => ( ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUN__FMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) )
        & ! [V2x_2E0: u] :
            ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) )
           => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUN__FMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) @ ( s @ A_27a @ V2x_2E0 ) ) )
              = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFDOM__FMAP,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1s_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUN__FMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )).

thf(thm_2Efmsp_2EFMSP__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0AN_2E0: u,V1BC_2E0: u,V2fm_2E0: u,V3sp_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efmsp_2EFMSP_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V0AN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V1BC_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2fm_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V3sp_2E0 ) ) ) )
    <=> ! [V4a_2E0: u,V5n: mono_2Etyop_2Enum_2Enum] :
          ( ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V0AN_2E0 ) @ ( s @ A_27a @ V4a_2E0 ) ) ) @ V5n )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTREL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V1BC_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2fm_2E0 ) @ ( s @ A_27a @ V4a_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27c ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5n ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V3sp_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Efmsp_2EFMSP__FEMPTY,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0BC_2E0: u,V1AN_2E0: u] :
...
thf(def0_2Ethm_2Efmsp_2EFMSP__FUPDATE,axiom,(
    ! [A_27c: d,V2sp_2E0: u,V3n: mono_2Etyop_2Enum_2Enum,V4v_2E0: u] :
      ( ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( f8146_1_2E3 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V2sp_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ A_27c @ V4v_2E0 ) ) )
      = ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( c_2Esptree_2Einsert_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ A_27c @ V4v_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V2sp_2E0 ) ) ) ) )).

thf(def1_2Ethm_2Efmsp_2EFMSP__FUPDATE,axiom,(
    ! [A_27c: d,V2sp_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( f8146_0_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V2sp_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ ( f8146_1_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27c ) @ V2sp_2E0 ) ) ) ) ) ) )).

thf(thm_2Efmsp_2EFMSP__FUPDATE,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0BC_2E0: u,V1AN_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebi__unique_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2EFUN__REL_2E4 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Efmsp_2EFMSP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V0BC_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Etransfer_2EFUN__REL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Etransfer_2EPAIR__REL_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V0BC_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Efmsp_2EFMSP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V0BC_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) ) @ c_2Efinite__map_2EFUPDATE_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27c ) @ ( tyop_2Esptree_2Espt @ A_27c ) ) ) @ f8146_0_2E0 ) ) ) ) ) )).
...
thf(thm_2Eoption_2EOPTREL__def,axiom,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eoption_2EOPTREL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V2y_2E0 ) ) ) )
    <=> ( ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
          & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V2y_2E0 )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ c_2Eoption_2ENONE_2E0 ) ) )
        | ? [V3x0_2E0: u,V4y0_2E0: u] :
            ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ V1x_2E0 )
              = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3x0_2E0 ) ) ) )
            & ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ V2y_2E0 )
              = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V4y0_2E0 ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ A_27a @ V3x0_2E0 ) ) ) @ ( s @ A_27b @ V4y0_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Epred__set_2ELINV__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1s_2E0: u,V2t_2E0: u] :
     ...
     => ! [V3x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) )
         => ( ( s @ A_27a @ ( c_2Epred__set_2ELINV_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) )
            = ( s @ A_27a @ V3x_2E0 ) ) ) ) )).
...
thf(thm_2Epred__set_2EBIJ__LINV__INV,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1s_2E0: u,V2t_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2EBIJ_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) )
     => ! [V3x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) )
         => ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ ( c_2Epred__set_2ELINV_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) ) ) ) )
            = ( s @ A_27b @ V3x_2E0 ) ) ) ) )).
...
thf(thm_2Esptree_2EFINITE__domain,axiom,(
    ! [A_27a: d,V0t_2E0: u] :
      ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Enum_2Enum @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) ) )).

thf(thm_2Esptree_2Elookup__NONE__domain,axiom,(
    ! [A_27a: d,V0t_2E0: u,V1k: mono_2Etyop_2Enum_2Enum] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Esptree_2Elookup_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
    <=> ( (~) @ ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V1k @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Esptree_2Edomain_2E1 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0t_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Etransfer_2Etotal__def,axiom,(
    ...
    <=> ! [V1x_2E0: u] :
        ? [V2y_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) @ ( s @ A_27b @ V2y_2E0 ) ) ) ) ) )).
...
thf(thm_2Etransfer_2Esurj__def,axiom,(
    ...
    <=> ! [V1y_2E0: u] :
        ? [V2x_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ A_27b @ V1y_2E0 ) ) ) ) ) )).
...
thf(thm_2Efmsp_2EFMSP__bitotal,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0BC_2E0: u,V1AN_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V0BC_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebi__unique_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Etransfer_2Ebitotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Esptree_2Espt @ A_27c ) @ tyop_2Emin_2Ebool ) ) @ ( c_2Efmsp_2EFMSP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ V1AN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Emin_2Ebool ) ) @ V0BC_2E0 ) ) ) ) ) ) ) )).
