      ...
      <=> ( ! [V1x: tp__ty_2Erealax_2Ereal] :
              ...
              @ ( ap @ c_2Ereal__topology_2Elinear
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2y: $i] :
                      ( ap @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ V2y ) ) ) )
          & ! [V3y: tp__ty_2Erealax_2Ereal] :
              ( p
              @ ( ap @ c_2Ereal__topology_2Elinear
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V4x: $i] :
                      ( ap @ ( ap @ V0f @ V4x ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBILINEAR__SUM__PARTIAL__SUC,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
             ...
             => ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
                 ...
                 => ( ( surj__ty_2Erealax_2Ereal
                      @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V5k: $i] :
                              ( ap @ ( ap @ V2h @ ( ap @ V0f @ V5k ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V1g @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V5k ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ V1g @ V5k ) ) ) ) ) )
                    = ( surj__ty_2Erealax_2Ereal
                      @ ( ap
