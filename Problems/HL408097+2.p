...
fof(conj_thm_2Elim_2ELIM__ADD,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Elim_2ELIM__MUL,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2l] :
             ...
             => ! [V3m] :
                 ...
                 => ! [V4x] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Elim_2Etends__real__real,V0f),V2l),V4x))
                          & p(ap(ap(ap(c_2Elim_2Etends__real__real,V1g),V3m),V4x)) )
                       => p(ap(ap(ap(c_2Elim_2Etends__real__real,f2897(V0f,V1g)),ap(ap(c_2Erealax_2Ereal__mul,V2l),V3m)),V4x)) ) ) ) ) ) ) )).
    ...
    ! [V1x] :
     ...
     => ! [V0f] :
         ...
         => ! [V2h] :
             ...
             => ap(f2905(V1x,V0f),V2h) = ap(V0f,ap(ap(c_2Erealax_2Ereal__add,V1x),V2h)) ) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V1x] :
         ...
         => ( p(ap(ap(c_2Elim_2Econtl,V0f),V1x))
          <=> p(ap(ap(ap(c_2Elim_2Etends__real__real,f2905(V1x,V0f)),ap(V0f,V1x)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) ) )).
...
fof(conj_thm_2Elim_2EDIFF__MUL,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
