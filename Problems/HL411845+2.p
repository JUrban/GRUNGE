...
fof(conj_thm_2Ereal__topology_2ESETDIST__LIPSCHITZ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SETDIST,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
