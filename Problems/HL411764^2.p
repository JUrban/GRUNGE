...
thf(conj_thm_2Ereal__topology_2ESERIES__SUBSET,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Enum_2Enum ) @ V1s ) @ V2t ) )
                  & ( p
                    @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2t )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3i: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V3i ) @ V1s ) ) @ ( ap @ V0x @ V3i ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )
