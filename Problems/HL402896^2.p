...
thf(conj_thm_2Erich__list_2Etake__drop__partition,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2l: $i] :
      ( ( mem @ V2l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V2l ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V2l ) ) )
          = ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V2l ) ) ) ) )).
