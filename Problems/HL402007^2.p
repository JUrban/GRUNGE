...
thf(conj_thm_2Erelation_2EIN__RRANGE,lemma,(
    ! [A_27a: del,A_27b: del,V0y: $i] :
      ( ( mem @ V0y @ A_27a )
     => ! [V1R: $i] :
          ( ( mem @ V1R @ ( arr @ A_27b @ ( arr @ A_27a @ bool ) ) )
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V0y ) @ ( ap @ ( c_2Erelation_2ERRANGE @ A_27b @ A_27a ) @ V1R ) ) )
          <=> ? [V2x: $i] :
                ( ( mem @ V2x @ A_27b )
                & ( p @ ( ap @ ( ap @ V1R @ V2x ) @ V0y ) ) ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Erange__to__rel__conv,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27b ) @ V0r )
