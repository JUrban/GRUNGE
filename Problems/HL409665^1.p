...
thf(thm_2Eiterate_2ESUPPORT__EMPTY,conjecture,(
    ! [A_27a: d,A_27b: d,V0op_2E0: u,V1f_2E0: u,V2s_2E0: u] :
      ( ! [V3x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) ) ) )
         => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V1f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) ) )
            = ( s @ A_27a @ ( c_2Eiterate_2Eneutral_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V0op_2E0 ) ) ) ) )
