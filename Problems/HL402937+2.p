...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__EQ__SOME,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1g] :
                     ...
                     => ! [V2r] :
                         ...
                         => ! [V3i] :
                             ...
                             => ! [V4y] :
                                  ( mem(V4y,A_27a)
                                 => ( ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27a,A_27a,A_27a),V0p),V1g),V2r),V3i) = ap(c_2Eoption_2ESOME(A_27a),V4y)
                                   => ? [V5x] :
                                        ( mem(V5x,A_27b)
                                        & p(ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND(A_27b,A_27b),V0p),V1g),V3i),V5x))
                                        & V4y = ap(V2r,V5x) ) ) ) ) ) ) ) ) ) ) )).
