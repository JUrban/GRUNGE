...
tff(conj_thm_2Erich__list_2ELASTN__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
       => ! [V2f: $i] :
           ...
           => ap(ap(c_2Erich__list_2ELASTN(A_27b),inj__ty_2Enum_2Enum(V0n)),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V2f),V1l)) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V2f),ap(ap(c_2Erich__list_2ELASTN(A_27a),inj__ty_2Enum_2Enum(V0n)),V1l)) ) ) ) )).
