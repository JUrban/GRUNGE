...
thf(thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__F,conjecture,(
    ! [V0t0: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( (~)
          @ ? [V3t: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V3t @ V0t0 ) ) )
      <=> ! [V4t: tyop_2Enum_2Enum] :
            ( (~) @ ( V2a @ ( c_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
      & ( ( ? [V5t: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V5t @ V0t0 ) )
          | ? [V6t: tyop_2Enum_2Enum] :
              ( V1b @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) )
      <=> ? [V7t: tyop_2Enum_2Enum] :
            ( ( V2a @ ( c_2Earithmetic_2E_2B @ V7t @ V0t0 ) )
            | ( V1b @ ( c_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) )
      & ( ( ? [V8t: tyop_2Enum_2Enum] :
              ( V2a @ ( c_2Earithmetic_2E_2B @ V8t @ V0t0 ) )
          & ? [V9t: tyop_2Enum_2Enum] :
              ( V1b @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) )
      <=> ? [V10p: tyop_2Enum_2Enum > $o,V11q: tyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V10p @ V0t0 ) )
            & ( (~) @ ( V11q @ V0t0 ) )
            & ! [V12t: tyop_2Enum_2Enum] :
                ( ( ( V10p @ ( c_2Earithmetic_2E_2B @ V12t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                <=> ( ( V10p @ ( c_2Earithmetic_2E_2B @ V12t @ V0t0 ) )
                    | ( V2a @ ( c_2Earithmetic_2E_2B @ V12t @ V0t0 ) ) ) )
                & ( ( V11q @ ( c_2Earithmetic_2E_2B @ V12t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                <=> ( ( V11q @ ( c_2Earithmetic_2E_2B @ V12t @ V0t0 ) )
                    | ( V1b @ ( c_2Earithmetic_2E_2B @ V12t @ V0t0 ) ) ) ) )
            & ? [V13t: tyop_2Enum_2Enum] :
                ( ( V10p @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) )
                & ( V11q @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) ) ) ) ) )).
