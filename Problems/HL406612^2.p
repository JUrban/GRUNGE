...
thf(ax_thm_2EEncode_2Eencode__bool__def,axiom,(
    ! [V0x: $o] :
      ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ c_2EEncode_2Eencode__bool @ ( inj__o @ V0x ) ) )
      = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V0x ) ) @ ( c_2Elist_2ENIL @ bool ) ) ) ) )).
...
thf(conj_thm_2EEncodeVar_2Efixed__width__bool,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ bool @ bool ) )
