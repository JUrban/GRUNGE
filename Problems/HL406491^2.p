...
thf(conj_thm_2Ebitstring_2Eboolify__reverse__map,lemma,(
            ...
            @ ( ap @ ( c_2Elist_2EREVERSE @ bool )
              @ ( ap
                @ ( ap @ ( c_2Elist_2EMAP @ ty_2Enum_2Enum @ bool )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V2n: $i] :
                        ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V2n ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
...
thf(conj_thm_2Ebitstring_2Ev2n__n2v,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
