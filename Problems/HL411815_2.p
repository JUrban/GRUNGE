...
tff(lamtp_f4038,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f4038(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4038,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f4038(V0x),inj__ty_2Enum_2Enum(V2n)) = ap(c_2Ereal_2Eabs,ap(V0x,inj__ty_2Enum_2Enum(V2n))) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__ABSCONV__IMP__CONV,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: $i] :
          ( mem(V1k,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Esummable,V1k),f4038(V0x)))
           => p(ap(ap(c_2Ereal__topology_2Esummable,V1k),V0x)) ) ) ) )).

tff(lmtp_f4039,type,(
    f4039: $i > $i )).

tff(lamtp_f4039,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lameq_f4039,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f4039(V0x),inj__ty_2Enum_2Enum(V3n)) = ap(c_2Ereal_2Eabs,ap(V0x,inj__ty_2Enum_2Enum(V3n))) ) )).

tff(lmtp_f4040,type,(
    f4040: $i > $i )).

tff(lamtp_f4040,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lameq_f4040,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V4n: tp__ty_2Enum_2Enum] : ap(f4040(V0x),inj__ty_2Enum_2Enum(V4n)) = ap(c_2Ereal_2Eabs,ap(V0x,inj__ty_2Enum_2Enum(V4n))) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__REARRANGE,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2p: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V1s),f4040(V0x)))
                    ...
                    & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V3l)),V1s)) )
                 => p(ap(ap(ap(c_2Ereal__topology_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0x),V2p)),inj__ty_2Erealax_2Ereal(V3l)),V1s)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__REARRANGE,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2p: $i] :
              ( mem(V2p,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V1s),f4039(V0x)))
                  & p(ap(ap(c_2Ereal__topology_2Epermutes(ty_2Enum_2Enum),V2p),V1s)) )
               => p(ap(ap(c_2Ereal__topology_2Esummable,V1s),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0x),V2p))) ) ) ) ) )).
