...
tff(conj_thm_2Ecardinal_2ECARD__LT__CONG,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1s_27: $i] :
          ( mem(V1s_27,arr(A_27b,bool))
         => ! [V2t: $i] :
             ...
             => ! [V3t_27: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),V1s_27))
                      & p(ap(ap(c_2Ecardinal_2Ecardeq(A_27c,A_27c),V2t),V3t_27)) )
                   => ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2t),V0s))
                    <=> ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27d,A_27d),V3t_27),V1s_27)) ) ) ) ) ) ) )).
