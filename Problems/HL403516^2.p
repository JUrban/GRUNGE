...
thf(conj_thm_2Ewellorder_2EINJ__preserves__transitive,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Eset__relation_2Etransitive @ A_27a ) @ V0r ) )
               ...
               => ( p @ ( ap @ ( c_2Eset__relation_2Etransitive @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27a @ A_27a @ A_27b @ A_27b ) @ V1f ) @ V1f ) ) @ V0r ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2EINJ__preserves__antisym,lemma,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ A_27b ) )
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Eset__relation_2Eantisym @ A_27a ) @ V0r ) )
                  & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EINJ @ A_27a @ A_27b ) @ V1f ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a ) @ V0r ) ) @ ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27a ) @ V0r ) ) ) @ V2t ) ) )
               => ( p @ ( ap @ ( c_2Eset__relation_2Eantisym @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27a @ A_27a @ A_27b @ A_27b ) @ V1f ) @ V1f ) ) @ V0r ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2EINJ__preserves__linear__order,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ A_27b ) )
