...
thf(thm_2Estate__transformer_2EBIND__LEFT__UNIT,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0k_2E0: u,V1x_2E0: u] :
      ...
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ V0k_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) )).
