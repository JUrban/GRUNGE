...
thf(conj_thm_2Epred__set_2ECOUNTABLE__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(ax_thm_2Ereal__topology_2Econdensation__point__of,axiom,(
...
thf(conj_thm_2Ereal__topology_2ECONDENSATION__POINT__INFINITE__BALL__CBALL,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ! [V1x: tp__ty_2Erealax_2Ereal] :
