...
thf(conj_thm_2Ereal__topology_2EEXISTS__IN__GSPEC,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,A_27g: del,V0Q: $i] :
      ( ( mem @ V0Q @ ( arr @ A_27b @ bool ) )
     => ( ! [V1P: $i] :
            ( ( mem @ V1P @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EWLOG__LE,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
       ...
       => ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V5m ) ) @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN__GEN,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__NEST__GEN,conjecture,(
    ! [V0s: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
          ...
          & ? [V2n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
          & ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
              ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V3m ) ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
             => ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) ) )
       => ( p
          @ ( ap @ c_2Ereal__topology_2Econnected
            @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V5n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ V0s @ V5n ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V5n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) ) ) ) ) )).
