...
tff(conj_thm_2EDecode_2Edec2enc__decode__blist,conjecture,(
    ! [A_27a: del,V0m: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,arr(A_27a,bool))
     => ! [V2d: $i] :
          ( mem(V2d,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
         => ! [V3l: $i] :
             ...
             => ( ( p(ap(ap(c_2EDecode_2Ewf__decoder(A_27a),V1p),V2d))
               ...
               => surj__c_ty_2Elist_2Elist_o(ap(ap(c_2EDecode_2Edec2enc(ty_2Elist_2Elist(A_27a)),ap(ap(ap(c_2EDecode_2Edecode__blist(A_27a),ap(ap(c_2EEncode_2Elift__blist(A_27a),inj__ty_2Enum_2Enum(V0m)),V1p)),inj__ty_2Enum_2Enum(V0m)),V2d)),V3l)) = surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2EEncode_2Eencode__blist(bool,bool),inj__ty_2Enum_2Enum(V0m)),ap(c_2EDecode_2Edec2enc(A_27a),V2d)),V3l)) ) ) ) ) )).
