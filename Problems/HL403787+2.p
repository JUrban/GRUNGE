    ...
    ! [A_27a,V1h] :
     ...
     => ! [V2t] :
         ...
         => ! [V3n] :
             ...
             => ap(f1160(A_27a,V1h,V2t),V3n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V3n),c_2Enum_2E0)),ap(c_2Eoption_2ESOME(A_27a),V1h)),ap(V2t,ap(ap(c_2Earithmetic_2E_2D,V3n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) )).

fof(conj_thm_2Ellist_2Elrep__ok__rules,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
