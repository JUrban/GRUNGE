...
thf(thm_2Ellist_2ELNTH__rep,axiom,(
    ! [A_27a: d,V0i: mono_2Etyop_2Enum_2Enum,V1ll_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2ELNTH_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ellist_2Ellist__rep_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0i ) ) ) ) ) )).
...
thf(thm_2Ellist_2ELNTH__EQ,conjecture,(
