...
tff(lamtp_f2883,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2883(V0f),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f2883,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: tp__ty_2Erealax_2Ereal] : ap(f2883(V0f),inj__ty_2Erealax_2Ereal(V1s)) = ap(ap(c_2Eseq_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1s)) ) )).

tff(ax_thm_2Eseq_2Esuminf,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => surj__ty_2Erealax_2Ereal(ap(c_2Eseq_2Esuminf,V0f)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2883(V0f))) ) )).

tff(conj_thm_2Eseq_2ESUMMABLE__SUM,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Esummable,V0f))
