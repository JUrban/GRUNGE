    ...
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,A_27d: $tType,A_27e: $tType,A_27f: $tType,V0R1: A_27a > A_27a > $o,V1abs1: A_27a > A_27d,V2rep1: A_27d > A_27a] :
     ...
     => ! [V3R2: A_27b > A_27b > $o,V4abs2: A_27b > A_27e,V5rep2: A_27e > A_27b] :
         ...
         => ! [V6R3: A_27c > A_27c > $o,V7abs3: A_27c > A_27f,V8rep3: A_27f > A_27c] :
             ...
             => ! [V9f: A_27d > A_27e > A_27f,V10x: A_27e,V11y: A_27d] :
                  ( ( c_2Ecombin_2EC @ A_27d @ A_27e @ A_27f @ V9f @ V10x @ V11y )
                  = ( V7abs3 @ ( c_2Ecombin_2EC @ A_27a @ A_27b @ A_27c @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ ( A_27e > A_27f ) @ A_27d @ ( A_27b > A_27c ) @ V1abs1 @ ( c_2Equotient_2E_2D_2D_3E @ A_27b @ A_27f @ A_27e @ A_27c @ V4abs2 @ V8rep3 ) @ V9f ) @ ( V5rep2 @ V10x ) @ ( V2rep1 @ V11y ) ) ) ) ) ) ) )).
