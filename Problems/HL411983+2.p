...
fof(lamtp_f4116,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z] :
          ( mem(V5z,ty_2Erealax_2Ereal)
         => mem(f4116(A_27a,V1f,V5z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f4116,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z] :
          ( mem(V5z,ty_2Erealax_2Ereal)
         => ! [V6t] :
              ( mem(V6t,A_27a)
             => ap(f4116(A_27a,V1f,V5z),V6t) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V5z)),ap(V1f,V6t)) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Epos__simple__fn__cmul__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(lamtp_f4130,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z] :
          ( mem(V5z,ty_2Erealax_2Ereal)
         => mem(f4130(A_27a,V1f,V5z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f4130,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z] :
          ( mem(V5z,ty_2Erealax_2Ereal)
         => ! [V9t] :
              ( mem(V9t,A_27a)
             => ap(f4130(A_27a,V1f,V5z),V9t) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V5z)),ap(V1f,V9t)) ) ) ) )).

fof(conj_thm_2Elebesgue_2Epos__simple__fn__integral__cmul__alt,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
