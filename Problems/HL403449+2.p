...
fof(ax_thm_2EEncode_2Eencode__option__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0xb] :
            ( mem(V0xb,arr(A_27a,ty_2Elist_2Elist(bool)))
           => ap(ap(c_2EEncode_2Eencode__option(A_27a),V0xb),c_2Eoption_2ENONE(A_27a)) = ap(ap(c_2Elist_2ECONS(bool),c_2Ebool_2EF),c_2Elist_2ENIL(bool)) )
        & ! [V1xb] :
            ( mem(V1xb,arr(A_27a,ty_2Elist_2Elist(bool)))
           => ! [V2x] :
                ( mem(V2x,A_27a)
               => ap(ap(c_2EEncode_2Eencode__option(A_27a),V1xb),ap(c_2Eoption_2ESOME(A_27a),V2x)) = ap(ap(c_2Elist_2ECONS(bool),c_2Ebool_2ET),ap(V1xb,V2x)) ) ) ) ) )).

fof(lamtp_f989,axiom,(
    ! [A_27a,V0p] :
      ( mem(V0p,arr(A_27a,bool))
     => mem(f989(A_27a,V0p),arr(A_27a,bool)) ) )).

fof(lameq_f989,axiom,(
    ! [A_27a,V0p] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V2y] :
          ( mem(V2y,A_27a)
...
fof(ax_thm_2EEncode_2Elift__option__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
         => ! [V1x] :
             ...
             => ( p(ap(ap(c_2EEncode_2Elift__option(A_27a),V0p),V1x))
              <=> p(ap(ap(ap(c_2Eoption_2Eoption__CASE(A_27a,A_27a),V1x),c_2Ebool_2ET),f989(A_27a,V0p))) ) ) ) ) )).

fof(conj_thm_2EEncode_2Ewf__encode__option,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
