...
thf(thm_2Elbtree_2Edepth__cases,conjecture,(
    ! [A_27a: d,V0a0_2E0: u,V1a1_2E0: u,V2a2: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2a2 ) ) ) ) )
    <=> ( ? [V3t1_2E0: u,V4t2_2E0: u] :
            ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
              = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V3t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V4t2_2E0 ) ) ) )
            & ( V2a2 = mono_2Ec_2Enum_2E0 ) )
        | ? [V5m: mono_2Etyop_2Enum_2Enum,V6a_2E0: u,V7t1_2E0: u,V8t2_2E0: u] :
            ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
              = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V6a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V7t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V8t2_2E0 ) ) ) )
            & ( V2a2
              = ( mono_2Ec_2Enum_2ESUC @ V5m ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V7t1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5m ) ) ) ) ) )
        | ? [V9m: mono_2Etyop_2Enum_2Enum,V10a_2E0: u,V11t1_2E0: u,V12t2_2E0: u] :
            ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
              = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V10a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V11t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V12t2_2E0 ) ) ) )
            & ( V2a2
              = ( mono_2Ec_2Enum_2ESUC @ V9m ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V12t2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9m ) ) ) ) ) ) ) ) )).
