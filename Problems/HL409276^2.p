...
thf(conj_thm_2Eintegral_2EDINT__CONST,lemma,(
...
thf(conj_thm_2Eintegral_2EINTEGRAL__CONST,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
     => ( ( surj__ty_2Erealax_2Ereal
          @ ( ap @ ( ap @ c_2Eintegral_2Eintegral @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V3x: $i] :
                  ( inj__ty_2Erealax_2Ereal @ V2c ) ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) )).
