...
thf(mem_c_2EindexedLists_2EMAPi__ACC,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( mem @ ( c_2EindexedLists_2EMAPi__ACC @ A_27a @ A_27b ) @ ( arr @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27b @ A_27a ) ) @ ( arr @ ty_2Enum_2Enum @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ ( arr @ ( ty_2Elist_2Elist @ A_27b ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) ) )).
...
thf(conj_thm_2EindexedLists_2EMAPi__ACC__MAPi,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
...
thf(conj_thm_2EindexedLists_2EMAPi__compute,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27b @ A_27a ) ) )
     => ! [V1l: $i] :
