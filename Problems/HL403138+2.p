    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
             ...
             => ap(f941(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V2t)),ap(c_2Ebool_2E_7E,ap(V1b,V2t))) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESUNTIL__EVENT,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
