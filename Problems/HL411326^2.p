...
thf(conj_thm_2Ereal__topology_2EFORALL__IN__CLOSURE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__LE__ON__CLOSURE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1s ) ) )
                & ! [V3x: tp__ty_2Erealax_2Ereal] :
                    ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) @ V1s ) )
                   => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) ) )
             => ! [V4x: tp__ty_2Erealax_2Ereal] :
                  ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1s ) ) )
                 => ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) ) ) ) ) ) )).
