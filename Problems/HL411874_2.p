...
tff(conj_thm_2Ereal__topology_2ESEPARATION__CLOSURES,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
         ...
         => ( ( ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V0s),ap(c_2Ereal__topology_2Eclosure,V1t)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V1t),ap(c_2Ereal__topology_2Eclosure,V0s)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => ? [V2u: $i] :
                ( mem(V2u,arr(ty_2Erealax_2Ereal,bool))
                & ? [V3v: $i] :
                    ( mem(V3v,arr(ty_2Erealax_2Ereal,bool))
                    & p(ap(ap(c_2Epred__set_2EDISJOINT(ty_2Erealax_2Ereal),V2u),V3v))
...
tff(conj_thm_2Ereal__topology_2ESEPARATION__NORMAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
