...
thf(conj_thm_2Ellist_2ELTAKE__LNTH__EL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
     ...
     => ! [V2m: tp__ty_2Enum_2Enum,V3l: $i] :
         ...
         => ( ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll )
           ...
           => ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ V1ll )
              = ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ V3l ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELFINITE__LNTH__NONE,conjecture,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll ) )
      <=> ? [V1n: tp__ty_2Enum_2Enum] :
            ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0ll )
            = ( c_2Eoption_2ENONE @ A_27a ) ) ) ) )).
