...
fof(conj_thm_2Ereal__topology_2EALWAYS__EVENTUALLY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2ELIM__CONST__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__SEQUENTIALLY,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECAUCHY__CONTINUOUS__UNIQUENESS__LEMMA,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ! [V2x] :
               ...
               => ( ( p(ap(c_2Ereal__topology_2Ecauchy,V2x))
                    & ! [V3n] :
                        ( mem(V3n,ty_2Enum_2Enum)
                       => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V2x,V3n)),V1s)) ) )
                 => p(ap(c_2Ereal__topology_2Ecauchy,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V2x))) ) )
           => ! [V4a] :
               ...
               => ! [V5x] :
                   ...
                   => ( ( ! [V6n] :
                           ...
                           => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V5x,V6n)),V1s)) )
                        & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V5x),V4a),c_2Ereal__topology_2Esequentially)) )
                     => ? [V7l] :
                          ( mem(V7l,ty_2Erealax_2Ereal)
                          & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V5x)),V7l),c_2Ereal__topology_2Esequentially))
                          & ! [V8y] :
                              ( mem(V8y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                             => ( ( ! [V9n] :
                                      ( mem(V9n,ty_2Enum_2Enum)
                                     => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V8y,V9n)),V1s)) )
                                  & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V8y),V4a),c_2Ereal__topology_2Esequentially)) )
                               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V8y)),V7l),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECAUCHY__CONTINUOUS__EXTENDS__TO__CLOSURE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ! [V2x] :
           ...
           => ? [V4g] :
                ...
                & ! [V5x] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V1s))
