...
tff(lamtp_f2221,axiom,(
    ! [V2x: tp__o] : mem(f2221(V2x),arr(bool,bool)) )).

tff(lameq_f2221,axiom,(
    ! [V2x: tp__o,V3y: tp__o] : ap(f2221(V2x),inj__o(V3y)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,inj__o(V2x)),inj__o(V3y))) )).

tff(lmtp_f2220,type,(
    f2220: $i )).

tff(lamtp_f2220,axiom,(
    mem(f2220,arr(bool,arr(bool,bool))) )).

tff(lameq_f2220,axiom,(
    ! [V2x: tp__o] : ap(f2220,inj__o(V2x)) = f2221(V2x) )).

tff(conj_thm_2Ewords_2Eword__nand__n2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__nand(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V1m))) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),f2220),inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m))) )).
