...
thf(thm_2EASCIInumbers_2EtoNum__toString,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2EASCIInumbers_2Enum__from__dec__string @ ( c_2EASCIInumbers_2Enum__to__dec__string @ V0n ) )
      = V0n ) )).
...
thf(thm_2EASCIInumbers_2EtoString__inj,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
      ( ( ( c_2EASCIInumbers_2Enum__to__dec__string @ V0n )
        = ( c_2EASCIInumbers_2Enum__to__dec__string @ V1m ) )
    <=> ( V0n = V1m ) ) )).
