...
tff(conj_thm_2Eblast_2EBCARRY__LEM,lemma,(
...
tff(conj_thm_2Eblast_2EBITWISE__LO,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
         => ( p(ap(ap(c_2Ewords_2Eword__lo(A_27a),V0x),V1y))
          <=> ~ p(ap(ap(ap(ap(c_2Eblast_2EBCARRY,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),ap(c_2Efcp_2Efcp__index(bool,bool),V1y))),inj__o(fo__c_2Ebool_2ET))) ) ) ) )).
