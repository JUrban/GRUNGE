...
tff(mem_c_2Esum_2EISR,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Esum_2EISR(A_27a,A_27a),arr(ty_2Esum_2Esum(A_27a,A_27a),bool)) )).
...
tff(conj_thm_2Esum_2EISL__OR__ISR,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Esum_2Esum(A_27a,A_27a))
     => ( p(ap(c_2Esum_2EISL(A_27a,A_27a),V0x))
        | p(ap(c_2Esum_2EISR(A_27a,A_27a),V0x)) ) ) )).

tff(conj_thm_2Esum_2EINL,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Esum_2Esum(A_27a,A_27a))
     => ( p(ap(c_2Esum_2EISL(A_27a,A_27a),V0x))
       => ap(c_2Esum_2EINL(A_27a,A_27a),ap(c_2Esum_2EOUTL(A_27a,A_27a),V0x)) = V0x ) ) )).

tff(conj_thm_2Esum_2EINR,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Esum_2Esum(A_27a,A_27a))
     => ( p(ap(c_2Esum_2EISR(A_27a,A_27a),V0x))
       => ap(c_2Esum_2EINR(A_27a,A_27a),ap(c_2Esum_2EOUTR(A_27a,A_27a),V0x)) = V0x ) ) )).

tff(conj_thm_2Esum_2ENOT__ISL__ISR,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Esum_2Esum(A_27a,A_27a))
     => ( ~ p(ap(c_2Esum_2EISL(A_27a,A_27a),V0x))
      <=> p(ap(c_2Esum_2EISR(A_27a,A_27a),V0x)) ) ) )).

tff(conj_thm_2Esum_2ENOT__ISR__ISL,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,ty_2Esum_2Esum(A_27a,A_27a))
     => ( ~ p(ap(c_2Esum_2EISR(A_27a,A_27a),V0x))
      <=> p(ap(c_2Esum_2EISL(A_27a,A_27a),V0x)) ) ) )).
...
tff(conj_thm_2Epred__set_2ECARD__UNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1t: $i] :
...
tff(conj_thm_2Epred__set_2EFINITE__BIJ__CARD__EQ,lemma,(
...
tff(conj_thm_2Efcp_2Eindex__sum,conjecture,(
