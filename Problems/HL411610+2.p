...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EMAPPING__CONNECTED__ONTO__SEGMENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
         ...
         => ! [V2b] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Econnected,V0s))
                  & ~ ? [V3a] :
                        ( mem(V3a,ty_2Erealax_2Ereal)
                        & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0s),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V3a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) ) )
               => ? [V4f] :
