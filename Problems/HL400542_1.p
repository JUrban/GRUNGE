...
tff(arityeq1_2Ef654_0_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f654_0_2E1(s(A_27a,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f654_0_2E0),s(A_27a,X0_2E0))) )).

tff(arityeq2_2Ef654_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f654_0_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f654_0_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0)))) )).

tff(arityeq1_2Ef654_1_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f654_1_2E1(s(A_27a,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f654_1_2E0),s(A_27a,X0_2E0))) )).

tff(arityeq2_2Ef654_1_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f654_1_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f654_1_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0)))) )).
...
tff(def0_2Ethm_2Eoption_2Esome__EQ,axiom,(
    ! [A_27a: d,V0y_2E0: u,V2x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f654_1_2E2(s(A_27a,V0y_2E0),s(A_27a,V2x_2E0)))))
    <=> s(A_27a,V0y_2E0) = s(A_27a,V2x_2E0) ) )).

tff(def1_2Ethm_2Eoption_2Esome__EQ,axiom,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f654_0_2E2(s(A_27a,V0y_2E0),s(A_27a,V1x_2E0)))))
    <=> s(A_27a,V1x_2E0) = s(A_27a,V0y_2E0) ) )).

tff(thm_2Eoption_2Esome__EQ,conjecture,(
    ! [A_27a: d,V0y_2E0: u] :
