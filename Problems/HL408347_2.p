...
tff(conj_thm_2Etransc_2ESIN__NPI,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esin,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V0n))),inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Etransc_2ESIN__ZERO__LEMMA,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
     => ? [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V1n)))
          & V0x = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V1n))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) ) )).

tff(conj_thm_2Etransc_2ESIN__ZERO,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
    <=> ( ? [V1n: tp__ty_2Enum_2Enum] :
            ( p(ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V1n)))
        ...
        | ? [V2n: tp__ty_2Enum_2Enum] :
            ( p(ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V2n)))
            & V0x = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(V2n))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))) ) ) ) )).
