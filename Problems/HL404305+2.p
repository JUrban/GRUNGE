...
fof(conj_thm_2Earithmetic_2EDIV__LE__MONOTONE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1x] :
...
fof(lamtp_f1828,axiom,(
    ! [V2r0] :
     ...
     => ! [V0R] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => mem(f1828(V2r0,V0R,V1n),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
     ...
     => ! [V0R] :
         ...
         => ! [V1n] :
             ...
             => ! [V3r] :
                 ...
                 => ap(f1828(V2r0,V0R,V1n),V3r) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V1n),c_2Enum_2E0))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2r0),ap(ap(c_2Earithmetic_2EMOD,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))))),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V3r),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2r0),c_2Enum_2E0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))),V2r0))))),ap(ap(V0R,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V1n),V3r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))))))),V1n)) ) ) ) ) )).

fof(lamtp_f1827,axiom,(
    ! [V1n] :
      ( mem(V1n,ty_2Enum_2Enum)
     => ! [V0R] :
          ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
...
fof(lameq_f1827,axiom,(
    ! [V1n] :
     ...
     => ! [V0R] :
         ...
         => ! [V2r0] :
              ( mem(V2r0,ty_2Enum_2Enum)
             => ap(f1827(V1n,V0R),V2r0) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1828(V2r0,V0R,V1n)) ) ) ) )).

fof(lamtp_f1826,axiom,(
    ! [V0R] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
...
fof(lameq_f1826,axiom,(
    ! [V0R] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f1826(V0R),V1n) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f1827(V1n,V0R)) ) ) )).

fof(lamtp_f1825,axiom,(
...
fof(lamtp_f1833,axiom,(
    ! [V7r] :
      ( mem(V7r,ty_2Enum_2Enum)
     => mem(f1833(V7r),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar))) ) )).

fof(lameq_f1833,axiom,(
    ! [V7r] :
      ( mem(V7r,ty_2Enum_2Enum)
     => ! [V8s0] :
          ( mem(V8s0,ty_2Elist_2Elist(ty_2Estring_2Echar))
         => ap(f1833(V7r),V8s0) = ap(ap(c_2Elist_2ECONS(ty_2Estring_2Echar),ap(c_2Estring_2ECHR,ap(ap(c_2Earithmetic_2E_2D,V7r),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V8s0) ) ) )).

fof(lamtp_f1832,axiom,(
    ! [V4n2s] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a] :
          ( mem(V5a,ty_2Enum_2Enum)
         => mem(f1832(V4n2s,V5a),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) ) )).
...
fof(lameq_f1832,axiom,(
    ! [V4n2s] :
     ...
     => ! [V5a] :
         ...
         => ! [V7r] :
              ( mem(V7r,ty_2Enum_2Enum)
             => ap(f1832(V4n2s,V5a),V7r) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),f1833(V7r)),ap(V4n2s,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V5a),V7r)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))))) ) ) ) )).

fof(lamtp_f1831,axiom,(
    ! [V4n2s] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
     => ! [V5a] :
          ( mem(V5a,ty_2Enum_2Enum)
         => mem(f1831(V4n2s,V5a),arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar))) ) ) )).
...
fof(lameq_f1831,axiom,(
    ! [V4n2s] :
     ...
     => ! [V5a] :
          ( mem(V5a,ty_2Enum_2Enum)
         => ! [V6r0] :
              ( mem(V6r0,ty_2Enum_2Enum)
             => ap(f1831(V4n2s,V5a),V6r0) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1832(V4n2s,V5a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V6r0),c_2Enum_2E0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))))),V6r0)) ) ) ) )).

fof(lamtp_f1830,axiom,(
    ! [V4n2s] :
      ( mem(V4n2s,arr(ty_2Enum_2Enum,ty_2Elist_2Elist(ty_2Estring_2Echar)))
...
fof(lameq_f1830,axiom,(
    ! [V4n2s] :
     ...
     => ! [V5a] :
          ( mem(V5a,ty_2Enum_2Enum)
         => ap(f1830(V4n2s),V5a) = ap(c_2Ecombin_2EI(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Elist_2Elist(ty_2Estring_2Echar)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V5a),c_2Enum_2E0)),c_2Elist_2ENIL(ty_2Estring_2Echar)),ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f1831(V4n2s,V5a)),ap(ap(c_2Earithmetic_2EMOD,V5a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))))))))) ) ) )).

fof(lamtp_f1829,axiom,(
...
fof(conj_thm_2Estring__num_2En2s__ind,conjecture,(
    ! [V0P] :
