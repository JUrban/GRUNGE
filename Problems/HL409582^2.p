...
thf(conj_thm_2Eiterate_2EFINREC__1__LEMMA,lemma,(
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2EFINREC @ A_27a @ A_27b ) @ V0f ) @ V1b ) @ V2s ) @ V3a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
                  <=> ? [V4x: $i] :
                        ( ( mem @ V4x @ A_27a )
                        & ( V2s
                          = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V4x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
                        & ( V3a
                          = ( ap @ ( ap @ V0f @ V4x ) @ V1b ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EDELETE__COMM,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ A_27a )
...
thf(conj_thm_2Eiterate_2EFINREC__SUC__LEMMA,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ A_27b )
