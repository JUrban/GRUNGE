...
tff(conj_thm_2Elist_2EAPPEND__eq__NIL,lemma,(
    ! [A_27a: del] :
      ( ! [V0l1: $i] :
...
tff(conj_thm_2Estring_2ESTRCAT__EQ__EMPTY,conjecture,(
    ! [V0l1: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar,V1l2: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] :
      ( surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(ap(ap(c_2Elist_2EAPPEND(ty_2Estring_2Echar),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V0l1)),inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(V1l2))) = surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(c_2Elist_2ENIL(ty_2Estring_2Echar))
    <=> ( V0l1 = surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(c_2Elist_2ENIL(ty_2Estring_2Echar))
        & V1l2 = surj__c_ty_2Elist_2Elist_ty_2Estring_2Echar(c_2Elist_2ENIL(ty_2Estring_2Echar)) ) ) )).
