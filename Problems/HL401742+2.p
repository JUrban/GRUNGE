...
fof(lamtp_f286,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => mem(f286(A_27a,V0f,V1g),arr(A_27a,ty_2Enum_2Enum)) ) ) )).

fof(lameq_f286,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f286(A_27a,V0f,V1g),V3x) = ap(ap(c_2Earithmetic_2EABS__DIFF,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

fof(conj_thm_2Epred__set_2EABS__DIFF__SUM__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
