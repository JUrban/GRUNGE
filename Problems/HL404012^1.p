...
thf(thm_2Equotient_2ELET__RES__ABSTRACT,conjecture,(
    ! [A_27a: d,A_27b: d,V0r_2E0: u,V1lam_2E0: u,V2v_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0r_2E0 ) ) ) )
     => ( ( s @ A_27b @ ( c_2Ebool_2ELET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Ebool_2ERES__ABSTRACT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0r_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1lam_2E0 ) ) ) @ ( s @ A_27a @ V2v_2E0 ) ) )
        = ( s @ A_27b @ ( c_2Ebool_2ELET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1lam_2E0 ) @ ( s @ A_27a @ V2v_2E0 ) ) ) ) ) )).
