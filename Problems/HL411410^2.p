...
thf(conj_thm_2Ereal__topology_2ECLOSED__CONNECTED__COMPONENT,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSED__COMPONENTS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
           ...
           => ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V1c ) ) ) ) ) )).
