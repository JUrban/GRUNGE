...
tff(lamtp_f921,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f921(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f921,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1t: tp__ty_2Enum_2Enum] : ap(f921(V0a),inj__ty_2Enum_2Enum(V1t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f889(V0a)),inj__ty_2Enum_2Enum(V1t))) ) )).

tff(conj_thm_2ETemporal__Logic_2EALWAYS__AS__SUNTIL,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ap(c_2ETemporal__Logic_2EALWAYS,V0a) = f921(V0a) ) )).

tff(conj_thm_2ETemporal__Logic_2EEVENTUAL__AS__SUNTIL,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lamtp_f1293,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1293(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1293,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1293(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f882(V0a)),inj__ty_2Enum_2Enum(V2t))) ) )).

tff(lmtp_f1294,type,(
    f1294: $i > $i )).

tff(lamtp_f1294,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => mem(f1294(V0a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1294,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1294(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a),inj__ty_2Enum_2Enum(V5t)) ) )).
...
tff(lamtp_f1295,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1295(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1295,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1295(V0a,V1b),inj__ty_2Enum_2Enum(V7t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1296(V1b)),f1297(V0a,V1b)),inj__ty_2Enum_2Enum(V7t))) ) ) )).
...
tff(lamtp_f1298,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1298(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1298,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V10t: tp__ty_2Enum_2Enum] : ap(f1298(V0a,V1b),inj__ty_2Enum_2Enum(V10t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1299(V0a,V1b)),f1300(V0a,V1b)),inj__ty_2Enum_2Enum(V10t))) ) ) )).
...
tff(lamtp_f1301,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f1301(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1301,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V13t: tp__ty_2Enum_2Enum] : ap(f1301(V0a,V1b),inj__ty_2Enum_2Enum(V13t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1302(V0a)),V1b),inj__ty_2Enum_2Enum(V13t))) ) ) )).
...
tff(lamtp_f1303,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1303(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1303,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V15t: tp__ty_2Enum_2Enum] : ap(f1303(V1b,V0a),inj__ty_2Enum_2Enum(V15t)) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1304(V1b)),f1305(V0a,V1b)),inj__ty_2Enum_2Enum(V15t)) ) ) )).
...
tff(lamtp_f1306,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => mem(f1306(V1b,V0a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f1306,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V18t: tp__ty_2Enum_2Enum] : ap(f1306(V1b,V0a),inj__ty_2Enum_2Enum(V18t)) = ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1307(V1b)),f1308(V0a,V1b)),inj__ty_2Enum_2Enum(V18t)) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2ESUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ( ap(c_2ETemporal__Logic_2EALWAYS,V0a) = f1293(V0a)
            & ap(c_2ETemporal__Logic_2EEVENTUAL,V0a) = f1294(V0a)
            & ap(ap(c_2ETemporal__Logic_2EUNTIL,V0a),V1b) = f1295(V0a,V1b)
            & ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V1b) = f1298(V0a,V1b)
            & ap(ap(c_2ETemporal__Logic_2EBEFORE,V0a),V1b) = f1301(V0a,V1b)
