...
thf(f2975_0_2E0,type,(
    f2975_0_2E0: u )).

thf(f2975_0_2E1,type,(
    f2975_0_2E1: du > u )).

thf(f2975_0_2E2,type,(
    f2975_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef2975_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2975_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2975_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef2975_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2975_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f2975_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Erich__list_2ELIST__ELEM__COUNT_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(def0_2Ethm_2Erich__list_2ELIST__ELEM__COUNT__DEF,axiom,(
    ! [A_27a: d,V0e_2E0: u,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2975_0_2E2 @ ( s @ A_27a @ V0e_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V2x_2E0 )
        = ( s @ A_27a @ V0e_2E0 ) ) ) )).
...
thf(thm_2Erich__list_2ELIST__ELEM__COUNT__DEF,axiom,(
    ! [A_27a: d,V0e_2E0: u,V1l_2E0: u] :
      ...
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFILTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f2975_0_2E1 @ ( s @ A_27a @ V0e_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Erich__list_2ELIST__ELEM__COUNT__MEM,conjecture,(
    ! [A_27a: d,V0e_2E0: u,V1l_2E0: u] :
