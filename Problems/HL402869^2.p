...
thf(conj_thm_2Erich__list_2EMAP__FST__funs,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0funs: $i] :
      ( ( mem @ V0funs @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) ) )
     => ( ( ap
          @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ A_27a )
            @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a )
              @ ( lam @ A_27a
                @ ^ [V1x: $i] :
                    ( ap @ ( c_2Epair_2EUNCURRY @ A_27b @ A_27c @ A_27a )
                    @ ( lam @ A_27b
                      @ ^ [V2y: $i] :
                          ( lam @ A_27c
                          @ ^ [V3z: $i] : V1x ) ) ) ) ) )
          @ V0funs )
        = ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ A_27a ) @ ( c_2Epair_2EFST @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) ) @ V0funs ) ) ) )).
