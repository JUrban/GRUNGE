...
fof(mem_c_2Ewords_2Eword__rrx,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__rrx(A_27a),arr(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool))) ) )).

fof(lamtp_f2214,axiom,(
    ! [A_27a,V0c] :
      ( mem(V0c,bool)
     => ! [V1w] :
...
fof(lameq_f2214,axiom,(
    ! [A_27a,V0c] :
     ...
     => ! [V1w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2214(A_27a,V0c,V1w),V2i) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2i),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0c),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__lsr(A_27a),V1w),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2i)) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__rrx__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0c] :
         ...
         => ! [V1w] :
              ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
             => ap(c_2Ewords_2Eword__rrx(A_27a),ap(ap(c_2Epair_2E_2C(bool,bool),V0c),V1w)) = ap(ap(c_2Epair_2E_2C(bool,bool),ap(c_2Ewords_2Eword__lsb(A_27a),V1w)),ap(c_2Efcp_2EFCP(bool,bool),f2214(A_27a,V0c,V1w))) ) ) ) )).
...
fof(conj_thm_2Ewords_2Eword__lsb__word__T,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2Elsr__1__word__T,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2Eword__rrx__word__T,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ap(c_2Ewords_2Eword__rrx(A_27a),ap(ap(c_2Epair_2E_2C(bool,bool),c_2Ebool_2EF),ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) = ap(ap(c_2Epair_2E_2C(bool,bool),c_2Ebool_2ET),c_2Ewords_2Eword__H(A_27a))
            & ap(c_2Ewords_2Eword__rrx(A_27b),ap(ap(c_2Epair_2E_2C(bool,bool),c_2Ebool_2ET),ap(c_2Ewords_2Eword__2comp(A_27b),ap(c_2Ewords_2En2w(A_27b),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) = ap(ap(c_2Epair_2E_2C(bool,bool),c_2Ebool_2ET),ap(c_2Ewords_2Eword__2comp(A_27b),ap(c_2Ewords_2En2w(A_27b),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) )).
