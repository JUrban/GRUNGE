...
thf(thm_2Eiterate_2EITERATE__RELATED,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0op: A_27b > A_27b > A_27b] :
     ...
     => ! [V1R: A_27b > A_27b > $o] :
          ( ( ( V1R @ ( c_2Eiterate_2Eneutral @ A_27b @ V0op ) @ ( c_2Eiterate_2Eneutral @ A_27b @ V0op ) )
            & ! [V2x1: A_27b,V3y1: A_27b,V4x2: A_27b,V5y2: A_27b] :
                ( ( ( V1R @ V2x1 @ V4x2 )
                  & ( V1R @ V3y1 @ V5y2 ) )
               => ( V1R @ ( V0op @ V2x1 @ V3y1 ) @ ( V0op @ V4x2 @ V5y2 ) ) ) )
         => ! [V6f: A_27a > A_27b,V7g: A_27a > A_27b,V8s: A_27a > $o] :
              ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V8s )
                & ! [V9x: A_27a] :
                    ( ( c_2Ebool_2EIN @ A_27a @ V9x @ V8s )
                   => ( V1R @ ( V6f @ V9x ) @ ( V7g @ V9x ) ) ) )
             => ( V1R @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ V8s @ V6f ) @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b @ V0op @ V8s @ V7g ) ) ) ) ) )).
