...
thf(conj_thm_2Eint__arith_2EINT__NUM__UEXISTS,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( p
          @ ( ap @ ( c_2Ebool_2E_3F_21 @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1n: $i] :
                  ( ap @ V0P @ ( ap @ c_2Einteger_2Eint__of__num @ V1n ) ) ) ) )
      <=> ( p
          @ ( ap @ ( c_2Ebool_2E_3F_21 @ ty_2Einteger_2Eint )
            @ ( lam @ ty_2Einteger_2Eint
              @ ^ [V2x: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V2x ) ) @ ( ap @ V0P @ V2x ) ) ) ) ) ) ) )).
