...
tff(conj_thm_2Emeasure_2EMEASURE__PRESERVING__LIFT,lemma,(
...
tff(conj_thm_2Emeasure_2EMEASURE__PRESERVING__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0m1: $i] :
      ( mem(V0m1,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1m2: $i] :
          ( mem(V1m2,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
         => ! [V2a: $i] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m1))
                  & p(ap(c_2Emeasure_2Emeasure__space(A_27b),V1m2))
                  & ap(c_2Emeasure_2Emeasurable__sets(A_27b),V1m2) = ap(c_2Emeasure_2Esubsets(A_27b),ap(ap(c_2Emeasure_2Esigma(A_27b),ap(c_2Emeasure_2Em__space(A_27b),V1m2)),V2a)) )
               => p(ap(ap(c_2Epred__set_2ESUBSET(arr(A_27a,A_27b)),ap(ap(c_2Emeasure_2Emeasure__preserving(A_27a,A_27a),V0m1),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Em__space(A_27b),V1m2)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),V2a),ap(c_2Emeasure_2Emeasure(A_27b),V1m2))))),ap(ap(c_2Emeasure_2Emeasure__preserving(A_27a,A_27a),V0m1),V1m2))) ) ) ) ) )).
