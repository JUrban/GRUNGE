...
thf(conj_thm_2Epowser_2ETERMDIFF__LEMMA2,lemma,(
              ...
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3p: $i] :
                    ...
                    @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V3p ) ) )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V4q: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0z ) ) @ ( inj__ty_2Erealax_2Ereal @ V1h ) ) ) @ V4q ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0z ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V3p ) ) @ V4q ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EPOW__LE,lemma,(
...
thf(conj_thm_2Ereal_2EABS__SUM,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal_2ESUM__BOUND,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Epowser_2ETERMDIFF__LEMMA3,conjecture,(
