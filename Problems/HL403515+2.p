...
fof(conj_thm_2Ewellorder_2EINJ__preserves__antisym,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1f] :
                 ...
                 => ! [V2t] :
                     ...
                     => ( ( p(ap(c_2Eset__relation_2Eantisym(A_27a),V0r))
                       ...
                       => p(ap(c_2Eset__relation_2Eantisym(A_27b),ap(ap(c_2Epred__set_2EIMAGE(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_23_23(A_27a,A_27a,A_27a,A_27a),V1f),V1f)),V0r))) ) ) ) ) ) ) )).
