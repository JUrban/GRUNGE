...
tff(conj_thm_2Efinite__map_2EDRESTRICT__FDOM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)) = V0f ) )).
