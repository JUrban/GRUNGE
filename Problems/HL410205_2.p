...
tff(conj_thm_2Emeasure_2ESIGMA__SUBSET__SUBSETS,lemma,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1a: $i] :
...
tff(conj_thm_2Emeasure_2ESIGMA__REDUCE,lemma,(
    ! [A_27a: del,V0sp: $i] :
      ( mem(V0sp,arr(A_27a,bool))
     => ! [V1a: $i] :
          ( mem(V1a,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Emeasure_2EMEASURE__PRESERVING__UP__LIFT,lemma,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
...
tff(conj_thm_2Emeasure_2EMEASURE__PRESERVING__UP__SIGMA,conjecture,(
    ! [A_27a: del,A_27b: del,V0m1: $i] :
      ( mem(V0m1,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1m2: $i] :
          ( mem(V1m2,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
