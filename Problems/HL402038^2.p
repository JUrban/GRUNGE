...
thf(tp_c_2Epair_2ESWAP,type,(
    c_2Epair_2ESWAP: del > del > $i )).

thf(mem_c_2Epair_2ESWAP,axiom,(
    ! [A_27a: del,A_27b: del] :
...
thf(ax_thm_2Epair_2ESWAP__def,axiom,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) )
     => ( ( ap @ ( c_2Epair_2ESWAP @ A_27a @ A_27b ) @ V0a )
        = ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ ( ap @ ( c_2Epair_2ESND @ A_27b @ A_27a ) @ V0a ) ) @ ( ap @ ( c_2Epair_2EFST @ A_27b @ A_27a ) @ V0a ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Erextension,lemma,(
...
thf(conj_thm_2Eset__relation_2Etc__SWAP,lemma,(
    ! [A_27a: del,V0r: $i] :
...
thf(conj_thm_2Eset__relation_2Eacyclic__SWAP,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
...
thf(conj_thm_2Eset__relation_2Eminimal__elements__SWAP,lemma,(
    ! [A_27a: del,V0xs: $i] :
      ( ( mem @ V0xs @ ( arr @ A_27a @ bool ) )
     => ! [V1r: $i] :
          ( ( mem @ V1r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Eset__relation_2Eminimal__elements @ A_27a ) @ V0xs ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( c_2Epair_2ESWAP @ A_27a @ A_27a ) ) @ V1r ) )
            = ( ap @ ( ap @ ( c_2Eset__relation_2Emaximal__elements @ A_27a ) @ V0xs ) @ V1r ) ) ) ) )).

thf(conj_thm_2Eset__relation_2Efinite__acyclic__has__minimal__path,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Eset__relation_2Efinite__acyclic__has__maximal__path,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1r: $i] :
          ( ( mem @ V1r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
