...
thf(conj_thm_2Ereal__topology_2EOPEN__IN__REFL,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSED__IN__REFL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__CLOSED__SUPERSET__PREIMAGE,lemma,(
    ! [V0f: $i] :
                              ...
                              @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                  @ ( lam @ ty_2Erealax_2Ereal
                                    @ ^ [V6x: $i] :
                                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V4w ) ) ) ) ) )
                              @ V3u ) ) )
                       => ? [V7v: $i] :
                              ...
                              @ ( ap
                                @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                    @ ( lam @ ty_2Erealax_2Ereal
                                      @ ^ [V8x: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V8x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V8x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V8x ) ) @ V7v ) ) ) ) ) )
                                @ V3u ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Etopology_2ECLOSED__IN__DIFF,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__CLOSED__SUPERSET__PREIMAGE__EQ,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                                ...
                                @ ( ap
                                  @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                      @ ( lam @ ty_2Erealax_2Ereal
                                        @ ^ [V6x: $i] :
                                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V5w ) ) ) ) ) )
                                  @ V4u ) ) )
                           => ? [V7v: $i] :
                                ( ( mem @ V7v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                                & ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2t ) ) @ V7v ) )
