         ...
         => ! [V3v2: $i] :
             ...
             => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2EternaryComparisons_2Eordering__CASE @ A_27a ) @ ( inj__ty_2EternaryComparisons_2Eordering @ V0x ) ) @ V1v0 ) @ V2v1 ) @ V3v2 )
                = ( ap
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4m: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V4m ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V1v0 ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V4m ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V2v1 ) @ V3v2 ) ) )
                  @ ( ap @ c_2EternaryComparisons_2Eordering2num @ ( inj__ty_2EternaryComparisons_2Eordering @ V0x ) ) ) ) ) ) ) )).

thf(conj_thm_2EternaryComparisons_2Eordering__case__def,conjecture,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( ( mem @ V0v0 @ A_27a )
         => ! [V1v1: $i] :
