...
fof(conj_thm_2Earithmetic_2ELESS__EQ__LESS__EQ__MONO,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2EOmega__Automata_2EBUECHI__PERIODIC__REDUCTION__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27state] :
          ( ne(A_27state)
         => ! [V0InitState] :
             ...
             => ! [V1TransRel] :
                  ( mem(V1TransRel,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => ! [V2Accept] :
                       ...
                       => ( ? [V6i] :
                              ...
                              & ? [V7q] :
                                  ...
                                  & ! [V8t] :
                                     ...
                                     => p(ap(V1TransRel,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V6i,V8t)),ap(ap(c_2Epair_2E_2C(A_27state,A_27state),ap(V7q,V8t)),ap(V7q,ap(ap(c_2Earithmetic_2E_2B,V8t),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))) )
                                  & ! [V9t1] :
                                      ...
                                      & ? [V14p] :
                                          ...
                                          & ! [V17t] :
                                             ...
                                             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V17t),ap(ap(c_2Earithmetic_2E_2B,V11x0),V12l)))
                                               => p(ap(V1TransRel,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V13j,V17t)),ap(ap(c_2Epair_2E_2C(A_27state,A_27state),ap(V14p,V17t)),ap(V14p,ap(ap(c_2Earithmetic_2E_2B,V17t),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))))) ) )
                                          & ? [V18t] :
