...
fof(conj_thm_2Ereal__topology_2ECLOSED__IN__COMPACT,lemma,(
    ! [V0s] :
    ...
    ! [V2s] :
     ...
     => ! [V1f] :
         ...
         => ! [V3k] :
             ...
             => ! [V4x] :
                  ( mem(V4x,ty_2Erealax_2Ereal)
                 => ap(f3883(V2s,V1f,V3k),V4x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V2s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V1f,V4x)),V3k))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EPROPER__MAP__FROM__COMPACT,conjecture,(
    ! [V0t] :
