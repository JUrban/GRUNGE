...
thf(f3687_0_2E0,type,(
    f3687_0_2E0: u )).

thf(f3687_0_2E1,type,(
    f3687_0_2E1: du > u )).
...
thf(mono_2Ef3687_0,type,(
    mono_2Ef3687_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EEVENTUAL__AS__SWHEN,axiom,(
    ! [V1t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3687_0 @ V1t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(thm_2ETemporal__Logic_2EEVENTUAL__AS__SWHEN,conjecture,(
    ! [V0a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V0a )
      = ( mono_2Ec_2ETemporal__Logic_2ESWHEN @ mono_2Ef3687_0 @ V0a ) ) )).
