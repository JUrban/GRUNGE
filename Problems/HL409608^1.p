...
thf(f11605_0_2E0,type,(
    f11605_0_2E0: u )).

thf(f11605_0_2E1,type,(
    f11605_0_2E1: du > u )).

thf(f11605_0_2E2,type,(
...
thf(mono_2Ef11605_0,type,(
    mono_2Ef11605_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Eiterate_2Esup__alt,axiom,(
    ...
    <=> ( ! [V2x: mono_2Etyop_2Erealax_2Ereal] :
        ...
        & ! [V3b: mono_2Etyop_2Erealax_2Ereal] :
           ...
           => ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V3b ) ) ) ) )).

thf(thm_2Eiterate_2Esup__alt,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal_2Esup @ V0s )
      = ( mono_2Ec_2Emin_2E_40_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef11605_0 @ V0s ) ) ) )).
...
thf(thm_2Eiterate_2EREAL__SUP__UNIQUE,conjecture,(
