...
thf(ax_thm_2Enumeral__bit_2EiDIV2,axiom,(
    c_2Enumeral__bit_2EiDIV2 = c_2Earithmetic_2EDIV2 )).

thf(ax_thm_2Enumeral__bit_2ESFUNPOW__def,axiom,
    ( ! [V0f: $i] :
        ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
       => ! [V1x: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2ESFUNPOW @ V0f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) )
            = V1x ) )
    & ! [V2f: $i] :
        ( ( mem @ V2f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
       => ! [V3n: tp__ty_2Enum_2Enum,V4x: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2ESFUNPOW @ V2f ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V4x ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2ESFUNPOW @ V2f ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) ) ) ) ) )).

thf(ax_thm_2Enumeral__bit_2EFDUB__def,axiom,
    ( ! [V0f: $i] :
        ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
       => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Enumeral__bit_2EFDUB @ V0f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          = fo__c_2Enum_2E0 ) )
    & ! [V1f: $i] :
        ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
       => ! [V2n: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Enumeral__bit_2EFDUB @ V1f ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ V1f @ ( ap @ V1f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Enumeral__bit_2ENUMERAL__SFUNPOW__iDIV2,conjecture,
    ( ! [V0x: tp__ty_2Enum_2Enum] :
