...
thf(conj_thm_2Ereal__topology_2EOPEN__IN__INTER__OPEN,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__MONO,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ! [V1Q: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__CLOSED,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
