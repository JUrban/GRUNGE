...
fof(arityeq1_2Ef133_0_2E1_2EA_27a,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f133_0_2E1(s(A_27a,X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f133_0_2E0),s(A_27a,X0_2E0))) )).

fof(arityeq2_2Ef133_0_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f133_0_2E2(s(A_27a,X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),f133_0_2E0),s(A_27a,X0_2E0))),s(A_27a,X1_2E0))) )).
...
fof(def0_2Ethm_2Ebool_2EEXISTS__UNIQUE__REFL,axiom,(
    ! [A_27a,V0a_2E0,V1x_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f133_0_2E2(s(A_27a,V0a_2E0),s(A_27a,V1x_2E0))))
    <=> s(A_27a,V1x_2E0) = s(A_27a,V0a_2E0) ) )).

fof(thm_2Ebool_2EEXISTS__UNIQUE__REFL,conjecture,(
    ! [A_27a,V0a_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ebool_2E_3F_21_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f133_0_2E1(s(A_27a,V0a_2E0)))))) )).
