    ...
    ! [A_27a: $tType,V0b: A_27a,V1a: A_27a,V2P: A_27a > $o] :
      ( ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V1a @ V0b )
        @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ A_27a
          @ ^ [V3x: A_27a] :
              ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V3x @ V3x ) @ ( V2P @ V3x ) ) ) )
    <=> ( ( V2P @ V1a )
        & ( V1a = V0b ) ) ) )).
    ...
    ! [A_27a: $tType,V0r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V1s: A_27a > $o] :
     ...
     => ( c_2Eset__relation_2Elinear__order @ A_27a
        @ ( c_2Epred__set_2EUNION @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ V0r
          @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ A_27a
            @ ^ [V2x: A_27a] :
                ( c_2Epair_2E_2C @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ $o @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V2x @ V2x ) @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1s ) ) ) )
        @ V1s ) ) )).
