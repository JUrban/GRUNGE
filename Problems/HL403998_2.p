...
tff(conj_thm_2Equotient_2EQUOTIENT__REP__ABS,lemma,(
...
tff(conj_thm_2Equotient_2ERESPECTS__MP,lemma,(
...
tff(conj_thm_2Equotient_2ERESPECTS__REP__ABS,conjecture,(
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R1),V1abs1),V2rep1))
               => ! [V3R2: $i] :
                   ...
                   => ! [V4f: $i] :
                       ...
                       => ! [V5x: $i] :
                            ( mem(V5x,A_27a)
                           => ( ( p(ap(ap(c_2Equotient_2Erespects(arr(A_27a,A_27b),arr(A_27a,A_27b)),ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),V3R2)),V4f))
