...
tff(conj_thm_2Elist_2ETAKE__LENGTH__ID,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(conj_thm_2Ellist_2ELTAKE__TAKE__LESS,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V2l: $i] :
          ( mem(V2l,ty_2Elist_2Elist(A_27a))
         => ! [V3m: tp__ty_2Enum_2Enum] :
              ( ( ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),V2l)
                & p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V0n))) )
             => ap(ap(c_2Ellist_2ELTAKE(A_27a),inj__ty_2Enum_2Enum(V3m)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27a)),ap(ap(c_2Elist_2ETAKE(A_27a),inj__ty_2Enum_2Enum(V3m)),V2l)) ) ) ) )).
