...
thf(conj_thm_2Ecardinal_2EFINITE__IMP__COUNTABLE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ A_27a ) @ V0s ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EUNCOUNTABLE__OPEN,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EFINITE__IMP__NOT__OPEN,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
