...
thf(f7621_0_2E0,type,(
    f7621_0_2E0: u )).

thf(f7621_0_2E2,type,(
    f7621_0_2E2: du > du > u )).
...
thf(mono_2Ef7621_0,type,(
    mono_2Ef7621_0: $o > $o > $o )).
...
thf(def0_2Ethm_2Ebitstring_2Ebxor__def,axiom,(
    ! [V0x: $o,V1y: $o] :
      ( ( mono_2Ef7621_0 @ V0x @ V1y )
    <=> ( (~) @ ( V0x = V1y ) ) ) )).

thf(thm_2Ebitstring_2Ebxor__def,axiom,
    ( mono_2Ec_2Ebitstring_2Ebxor
    = ( mono_2Ec_2Ebitstring_2Ebitwise @ mono_2Ef7621_0 ) )).
...
thf(thm_2Ebitstring_2Eword__xor__v2w,conjecture,(
