...
thf(f11399_0_2E0,type,(
    f11399_0_2E0: u )).

thf(f11399_0_2E1,type,(
    f11399_0_2E1: du > u )).

thf(f11399_0_2E2,type,(
    f11399_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef11399_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Eextreal_2Eextreal] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( f11399_0_2E1 @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ X0 ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eextreal_2Eextreal @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) ) @ f11399_0_2E0 ) @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ X0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef11399_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Eextreal_2Eextreal,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f11399_0_2E2 @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eextreal_2Eextreal @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) ) @ f11399_0_2E0 ) @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
    ...
    <=> ( ! [V2y: mono_2Etyop_2Eextreal_2Eextreal] :
        ...
        & ! [V3y: mono_2Etyop_2Eextreal_2Eextreal] :
            ( ! [V4z: mono_2Etyop_2Eextreal_2Eextreal] :
                ( ( V0p @ V4z )
               => ( mono_2Ec_2Eextreal_2Eextreal__le @ V3y @ V4z ) )
           => ( mono_2Ec_2Eextreal_2Eextreal__le @ V3y @ V1x ) ) ) ) )).
...
thf(def0_2Ethm_2Eextreal_2Einf__const__over__set,axiom,(
    ! [A_27a: d,V1k: mono_2Etyop_2Eextreal_2Eextreal,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f11399_0_2E2 @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ V1k ) ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
      = V1k ) )).

thf(thm_2Eextreal_2Einf__const__over__set,conjecture,(
    ! [A_27a: d,V0s_2E0: u,V1k: mono_2Etyop_2Eextreal_2Eextreal] :
      ( ( (~)
        @ ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 )
          = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) ) )
     => ( ( mono_2Ec_2Eextreal_2Eextreal__inf @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Eextreal_2Eextreal_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eextreal_2Eextreal @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EIMAGE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( f11399_0_2E1 @ ( s @ tyop_2Eextreal_2Eextreal @ ( i_mono_2Etyop_2Eextreal_2Eextreal @ V1k ) ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) ) )
        = V1k ) ) )).
