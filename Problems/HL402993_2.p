...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__COND__EX__IMP__REWRITE,conjecture,(
                         ...
                         => ( ! [V6x: $i] :
                               ...
                               => ( p(ap(V2g,V6x))
                                 => ( ? [V7x_27: $i] :
                                        ...
                                        & p(ap(V4g_27,V7x_27)) )
                                  <=> p(inj__o(V5RES)) ) ) )
                           => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND__EX(A_27a,A_27a),V0v),V3p_27),V4g_27))
                            <=> p(inj__o(V5RES)) ) ) ) ) ) ) ) ) )).
