...
fof(conj_thm_2ETemporal__Logic_2EBEFORE__LINORD,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             ...
             => ( p(ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,V0a),V1b),V2t0))
              <=> ! [V3t1] :
                   ...
                   => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2t0),V3t1))
                        & p(ap(c_2ETemporal__Logic_2EUPTO,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2t0),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3t1),f882(V0a))))) )
                     => ~ p(ap(V1b,V3t1)) ) ) ) ) ) ) )).
