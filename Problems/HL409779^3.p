...
thf(thm_2Eiterate_2EMOD__NSUM__MOD,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ( (~) @ ( V1n = c_2Enum_2E0 ) ) )
     => ( ( c_2Earithmetic_2EMOD @ ( c_2Eiterate_2Ensum @ A_27a @ V2s @ V0f ) @ V1n )
        = ( c_2Earithmetic_2EMOD
          @ ( c_2Eiterate_2Ensum @ A_27a @ V2s
            @ ^ [V3i: A_27a] :
                ( c_2Earithmetic_2EMOD @ ( V0f @ V3i ) @ V1n ) )
          @ V1n ) ) ) )).
...
thf(thm_2Eiterate_2EMOD__NSUM__MOD__NUMSEG,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( (~) @ ( V3n = c_2Enum_2E0 ) )
     => ( ( c_2Earithmetic_2EMOD @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1a @ V2b ) @ V0f ) @ V3n )
        = ( c_2Earithmetic_2EMOD
          @ ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1a @ V2b )
            @ ^ [V4i: tyop_2Enum_2Enum] :
                ( c_2Earithmetic_2EMOD @ ( V0f @ V4i ) @ V3n ) )
          @ V3n ) ) ) )).
