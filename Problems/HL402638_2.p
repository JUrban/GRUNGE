...
tff(lamtp_f780,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f780(A_27a,A_27a),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,ty_2Elist_2Elist(A_27a)))) )).
...
tff(conj_thm_2Erich__list_2EFOLDL__SNOC__NIL,conjecture,(
    ! [A_27a: del,V0l: $i] :
