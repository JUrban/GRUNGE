...
tff(ax_thm_2Erich__list_2ELIST__ELEM__COUNT__DEF,axiom,(
    ! [A_27a: del,V0e: $i] :
     ...
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => surj__ty_2Enum_2Enum(ap(ap(c_2Erich__list_2ELIST__ELEM__COUNT(A_27a),V0e),V1l)) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(ap(c_2Elist_2EFILTER(A_27a),f763(A_27a,A_27a,V0e)),V1l))) ) ) )).

tff(conj_thm_2Erich__list_2ELIST__ELEM__COUNT__THM,conjecture,(
