...
thf(conj_thm_2Ereal__topology_2ESPAN__SUM,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Ereal__topology_2EDEPENDENT__EXPLICIT,lemma,(
    ! [V0p: $i] :
...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__INJECTIVE__IMAGE__GEN,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
