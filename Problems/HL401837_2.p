...
tff(conj_thm_2Epred__set_2EFINITE__REST__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EREST(A_27a),V0s)))
      <=> p(ap(c_2Epred__set_2EFINITE(A_27a),V0s)) ) ) )).

tff(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__MONO,lemma,(
...
tff(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__NOT__EMPTY,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2EINFINITE__EXPLICIT__ENUMERATE,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
