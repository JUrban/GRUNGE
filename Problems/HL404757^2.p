...
thf(conj_thm_2Efinite__map_2EFUPD__SAME__KEY__UNWIND,lemma,(
...
thf(conj_thm_2Efinite__map_2EFMEQ__ENUMERATE__CASES,lemma,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( ( mem @ V0f1 @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1kvl: $i] :
...
thf(conj_thm_2Efinite__map_2EFMEQ__SINGLE__SIMPLE__ELIM,conjecture,(
