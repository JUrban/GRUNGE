...
tff(conj_thm_2Earithmetic_2ESUB__PLUS,lemma,(
...
tff(conj_thm_2Earithmetic_2ENOT__SUC__LESS__EQ,lemma,(
...
tff(conj_thm_2Earithmetic_2EADD__MODULUS,lemma,
...
tff(conj_thm_2Ebit_2EBITS__COMP__THM,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__SLICE__THM2,lemma,(
    ! [V0b: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Ebit_2EBIT,inj__ty_2Enum_2Enum(V0b)),inj__ty_2Enum_2Enum(V1n)))
...
tff(lamtp_f251,axiom,(
    mem(f251,arr(bool,arr(bool,bool))) )).

tff(lameq_f251,axiom,(
    ! [V3x: tp__o] : ap(f251,inj__o(V3x)) = k(bool,ap(c_2Ebool_2E_7E,inj__o(V3x))) )).

tff(conj_thm_2Ebit_2EBITWISE__ONE__COMP__LEM,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__NEG__L,lemma,(
    ! [A_27a: del] : ap(c_2Ewords_2Eword__2comp(A_27a),c_2Ewords_2Eword__L(A_27a)) = c_2Ewords_2Eword__L(A_27a) )).

tff(conj_thm_2Ewords_2ETWO__COMP__NEG,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ( p(ap(c_2Ewords_2Eword__msb(A_27a),V0a))
       => p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V0a),c_2Ewords_2Eword__L(A_27a)))),ap(c_2Ewords_2Eword__msb(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a))),ap(c_2Ebool_2E_7E,ap(c_2Ewords_2Eword__msb(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),V0a))))) ) ) )).
