...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EMPTY,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))) ) )).
...
tff(conj_thm_2Ereal__topology_2EEXTENSION__FROM__CLOPEN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ! [V3u: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1s)),V2t))
                      ...
                      & ( V3u = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                       => V1s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) )
                   => ? [V4g: $i] :
                        ( mem(V4g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                        & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V4g),V1s))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V4g),V1s)),V3u))
                        & ! [V5x: tp__ty_2Erealax_2Ereal] :
                            ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V2t))
                           => surj__ty_2Erealax_2Ereal(ap(V4g,inj__ty_2Erealax_2Ereal(V5x))) = surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V5x))) ) ) ) ) ) ) ) )).
