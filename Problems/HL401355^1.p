...
thf(thm_2Ebit_2ETWOEXP__LE__IMP__LE__LOG2,axiom,
    ( ! [V0x: mono_2Etyop_2Enum_2Enum,V1y: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0x ) @ V1y )
       => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0x @ ( mono_2Ec_2Ebit_2ELOG2 @ V1y ) ) )
    & ! [V2y: mono_2Etyop_2Enum_2Enum,V3x: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V3x )
       => ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V3x @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V2y ) )
         => ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Ebit_2ELOG2 @ V3x ) @ V2y ) ) ) )).
...
thf(thm_2Ebit_2EEXISTS__BIT__IN__RANGE,conjecture,(
