    ...
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ...
      = ( surj__ty_2Einteger_2Eint
        @ ( ap @ c_2Einteger_2ELEAST__INT
          @ ( lam @ ty_2Einteger_2Eint
            @ ^ [V1i: $i] :
                ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Eintreal_2Ereal__of__int @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ V1i ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eintreal_2EINT__FLOOR__BOUNDS,lemma,(
...
thf(conj_thm_2Eintreal_2EINT__FLOOR,conjecture,(
