...
fof(conj_thm_2Ecardinal_2Ele__c,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2Elt__c,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(lamtp_f1885,axiom,(
    ! [A_27a,A_27a,V0s] :
      ( mem(V0s,arr(A_27a,bool))
     => mem(f1885(A_27a,A_27a,V0s),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).
...
fof(lameq_f1885,axiom,(
    ! [A_27a,A_27a,V0s] :
     ...
     => ! [V1t] :
          ( mem(V1t,arr(A_27a,bool))
         => ap(f1885(A_27a,A_27a,V0s),V1t) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V1t),ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1t),V0s)) ) ) )).

fof(conj_thm_2Ecardinal_2ECANTOR__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f1885(A_27a,A_27a,V0s))),V0s)) ) ) )).
