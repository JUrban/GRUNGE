                          ...
                          @ ( lam @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal )
                            @ ^ [V3g: $i] :
                                ...
                                @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                                  @ ( lam @ A_27a
                                    @ ^ [V4x: $i] :
                                        ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ V3g @ V4x ) ) @ ( ap @ V1f @ V4x ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elebesgue_2Epos__fn__integral__mono__mspace,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
...
thf(conj_thm_2Elebesgue_2Elebesgue__monotone__convergence__lemma,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
         => ! [V2fi: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ! [V4r_27: tp__ty_2Eextreal_2Eextreal] :
                        ...
                        & ! [V8x: $i] :
                           ...
                           => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V8x ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) )
                             => ( ( surj__ty_2Eextreal_2Eextreal
                                ...
                                = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ V1f @ V8x ) ) ) ) )
                     ...
                     => ( p
                        @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V4r_27 ) )
                          @ ( ap @ c_2Eextreal_2Eextreal__sup
                            @ ( ap
                              @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal )
                                @ ( lam @ ty_2Enum_2Enum
...
thf(conj_thm_2Elebesgue_2Elebesgue__monotone__convergence,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
