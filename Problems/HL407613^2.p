...
thf(conj_thm_2EordinalNotation_2Eis__ord__cases,conjecture,(
    ...
    <=> ( ? [V1k: tp__ty_2Enum_2Enum] :
            ( V0a0
            = ( surj__ty_2EordinalNotation_2Eosyntax @ ( ap @ c_2EordinalNotation_2EEnd @ ( inj__ty_2Enum_2Enum @ V1k ) ) ) )
        | ? [V2e: tp__ty_2EordinalNotation_2Eosyntax,V3k: tp__ty_2Enum_2Enum,V4t: tp__ty_2EordinalNotation_2Eosyntax] :
            ( ( V0a0
              = ( surj__ty_2EordinalNotation_2Eosyntax @ ( ap @ ( ap @ ( ap @ c_2EordinalNotation_2EPlus @ ( inj__ty_2EordinalNotation_2Eosyntax @ V2e ) ) @ ( inj__ty_2Enum_2Enum @ V3k ) ) @ ( inj__ty_2EordinalNotation_2Eosyntax @ V4t ) ) ) )
