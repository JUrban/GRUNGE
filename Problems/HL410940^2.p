...
thf(conj_thm_2Ereal__topology_2EUNIFORM__LIM__ADD,conjecture,(
                                      ...
                                      @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                                        @ ( lam @ A_27a
                                          @ ^ [V7x: $i] :
                                              ...
                                              @ ( lam @ A_27b
                                                @ ^ [V8n: $i] :
                                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V8n ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ V2f @ V8n ) @ V7x ) ) @ ( ap @ V4l @ V8n ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V6e ) ) ) ) ) ) )
                                      @ V0net ) ) )
                                      ...
                                      @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                                        @ ( lam @ A_27a
                                          @ ^ [V10x: $i] :
                                              ...
                                              @ ( lam @ A_27b
                                                @ ^ [V11n: $i] :
                                                    ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V11n ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ V3g @ V11n ) @ V10x ) ) @ ( ap @ V5m @ V11n ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V9e ) ) ) ) ) ) )
                                      @ V0net ) ) ) )
                                    ...
                                    @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                                      @ ( lam @ A_27a
                                        @ ^ [V13x: $i] :
                                            ...
                                            @ ( lam @ A_27b
                                              @ ^ [V14n: $i] :
                                                  ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V1P @ V14n ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ V2f @ V14n ) @ V13x ) ) @ ( ap @ ( ap @ V3g @ V14n ) @ V13x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V4l @ V14n ) ) @ ( ap @ V5m @ V14n ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V12e ) ) ) ) ) ) )
                                    @ V0net ) ) ) ) ) ) ) ) ) ) )).
