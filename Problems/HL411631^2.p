...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__RIGHT__INVERSE__IMP__QUOTIENT__MAP,lemma,(
    ! [V0f: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V0f ) @ V2s ) )
                      ...
                      & ! [V4y: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) )
                            = V4y ) ) )
                   => ! [V5u: $i] :
                              ...
                              @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                  @ ( lam @ ty_2Erealax_2Ereal
                                    @ ^ [V6x: $i] :
                                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V5u ) ) ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__IMP__QUOTIENT__MAP,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                         ...
                         => ( ( p
                              @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                  @ ( lam @ ty_2Erealax_2Ereal
                                    @ ^ [V5x: $i] :
                                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V5x ) ) @ V4u ) ) ) ) ) ) )
