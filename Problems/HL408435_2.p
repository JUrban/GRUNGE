...
tff(conj_thm_2Etransc_2EEXP__MONO__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eexp,inj__ty_2Erealax_2Ereal(V1y))))
    <=> p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) ) )).

tff(conj_thm_2Etransc_2ELN__MONO__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     ...
     => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V1y))))
      <=> p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) ) ) )).
...
tff(conj_thm_2Etransc_2EBASE__RPOW__LE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0a)))
        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2c)))
     ...
     => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),ap(ap(c_2Etransc_2Erpow,inj__ty_2Erealax_2Ereal(V2c)),inj__ty_2Erealax_2Ereal(V1b))))
      <=> p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V2c))) ) ) )).
