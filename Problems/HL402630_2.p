...
tff(mem_c_2Erich__list_2ESCANR,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erich__list_2ESCANR(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,A_27b)),arr(A_27b,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27b))))) )).
...
tff(ax_thm_2Erich__list_2ESCANR,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
         ...
         => ! [V1e: $i] :
              ( mem(V1e,A_27b)
             => ap(ap(ap(c_2Erich__list_2ESCANR(A_27a,A_27a),V0f),V1e),c_2Elist_2ENIL(A_27a)) = ap(ap(c_2Elist_2ECONS(A_27b),V1e),c_2Elist_2ENIL(A_27b)) ) )
      & ! [V2f: $i] :
         ...
         => ! [V3e: $i] :
             ...
             => ! [V4x: $i] :
                 ...
                 => ! [V5l: $i] :
                     ...
                     => ap(ap(ap(c_2Erich__list_2ESCANR(A_27a,A_27a),V2f),V3e),ap(ap(c_2Elist_2ECONS(A_27a),V4x),V5l)) = ap(ap(c_2Elist_2ECONS(A_27b),ap(ap(V2f,V4x),ap(c_2Elist_2EHD(A_27b),ap(ap(ap(c_2Erich__list_2ESCANR(A_27a,A_27a),V2f),V3e),V5l)))),ap(ap(ap(c_2Erich__list_2ESCANR(A_27a,A_27a),V2f),V3e),V5l)) ) ) ) ) ) )).

tff(conj_thm_2Erich__list_2ELENGTH__SCANR,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),ap(ap(ap(c_2Erich__list_2ESCANR(A_27a,A_27a),V0f),V1e),V2l))) = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,ap(c_2Elist_2ELENGTH(A_27a),V2l))) ) ) ) )).
