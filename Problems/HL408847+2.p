...
fof(conj_thm_2EHolSmt_2Er226,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1u] :
         ...
         => ! [V2y] :
             ...
             => ap(ap(c_2Ereal_2Ereal__sub,V0x),ap(ap(c_2Erealax_2Ereal__mul,V1u),V2y)) = ap(ap(c_2Erealax_2Ereal__add,V0x),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1u)),V2y)) ) ) ) )).
