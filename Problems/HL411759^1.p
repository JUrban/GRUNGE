...
thf(f12670_0_2E0,type,(
    f12670_0_2E0: u )).

thf(f12670_0_2E1,type,(
    f12670_0_2E1: du > u )).

thf(f12670_0_2E2,type,(
    f12670_0_2E2: du > du > u )).

thf(f12698_0_2E0,type,(
    f12698_0_2E0: u )).

thf(f12698_0_2E1,type,(
    f12698_0_2E1: du > u )).

thf(f12698_0_2E2,type,(
...
thf(mono_2Ef12670_0,type,(
    mono_2Ef12670_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12698_0,type,(
    mono_2Ef12698_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ESERIES__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12670_0 @ V0x @ V3n )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0x @ V3n ) ) ) )).

thf(thm_2Ereal__topology_2ESERIES__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Esums @ V0x @ V1x0 @ V2s )
     => ( mono_2Ec_2Ereal__topology_2Esums @ ( mono_2Ef12670_0 @ V0x ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ V1x0 ) @ V2s ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ESUMMABLE__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12698_0 @ V0x @ V2n )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0x @ V2n ) ) ) )).

thf(thm_2Ereal__topology_2ESUMMABLE__NEG,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Esummable @ V1s @ V0x )
     => ( mono_2Ec_2Ereal__topology_2Esummable @ V1s @ ( mono_2Ef12698_0 @ V0x ) ) ) )).
