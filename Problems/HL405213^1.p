...
thf(f5991_0_2E0,type,(
    f5991_0_2E0: u )).

thf(f5991_0_2E1,type,(
    f5991_0_2E1: du > u )).

thf(f5991_0_2E3,type,(
...
thf(arityeq1_2Emono_2Ef5991_0_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ ( f5991_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) ) @ f5991_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef5991_0_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ ( f5991_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ec_2Ealist_2Efmap__to__alist_2E1_2Emono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ) @ ( c_2Ealist_2Efmap__to__alist_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27a ) @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ) ) @ c_2Ealist_2Efmap__to__alist_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27a ) @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ec_2Ealist_2Efmap__to__alist_2E1_2Emono_2EA_27c_20mono_2EA_27b,axiom,(
    ! [A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Ealist_2Efmap__to__alist_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27b ) @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ c_2Ealist_2Efmap__to__alist_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ealist_2EMAP__values__fmap__to__alist,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V2k_2E0: u,V3v_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) @ ( f5991_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27c @ V2k_2E0 ) @ ( s @ A_27a @ V3v_2E0 ) ) )
...
thf(thm_2Ealist_2EMAP__values__fmap__to__alist,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1fm_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) ) @ ( f5991_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ) @ ( c_2Ealist_2Efmap__to__alist_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27a ) @ V1fm_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( c_2Ealist_2Efmap__to__alist_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27b ) @ ( c_2Efinite__map_2Eo__f_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27c @ A_27a ) @ V1fm_2E0 ) ) ) ) ) ) )).
