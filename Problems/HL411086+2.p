...
fof(conj_thm_2Ereal__topology_2ECLOSED__BIGINTER,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__BIGINTER,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ? [V1s] :
            ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
       ...
       => p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),V0f))) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__BIGINTER,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( ! [V1s] :
              ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
