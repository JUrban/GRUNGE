...
thf(thm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__GT,axiom,(
      ...
      ( ( c_2Ereal__topology_2Eclosure
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V1x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V1x @ ( c_2Ereal_2Ereal__gt @ V1x @ V0a ) ) ) )
      = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Ereal_2Ereal__ge @ V2x @ V0a ) ) ) ) )).

thf(thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GE,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal] :
      ( (~)
...
thf(thm_2Ereal__topology_2EUNBOUNDED__HALFSPACE__COMPONENT__GT,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal] :
      ( (~)
      @ ( c_2Ereal__topology_2Ebounded__def
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
