...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__SUBSET__ABSCONV,conjecture,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V1s),f4039(V0x)))
               ...
               => p(ap(ap(c_2Ereal__topology_2Esummable,V2t),f4040(V0x))) ) ) ) ) )).
