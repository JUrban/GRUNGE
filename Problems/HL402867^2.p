...
thf(conj_thm_2Elist_2EMEM__EL,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Elist_2ELIST__TO__SET__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Erich__list_2EMEM__SING__APPEND,conjecture,(
    ! [A_27a: del,V0d: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ! [V2a: $i] :
               ...
               => ! [V3c: $i] :
                   ...
                   => ( V0d
                     != ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2a ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V1b ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) @ V3c ) ) ) )
