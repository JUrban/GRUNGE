...
tff(lameq_f431,axiom,(
    ! [A_27b: del,A_27a: del,V0f: $i] :
     ...
     => ! [V3s: $i] :
         ...
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f431(A_27b,A_27a,V0f,V3s),V4x) = ap(ap(c_2Epred__set_2EUNION(A_27b),V3s),ap(V0f,V4x)) ) ) ) )).

tff(lmtp_f430,type,(
    f430: ( del * del * $i ) > $i )).

tff(lamtp_f430,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,bool)))
     => mem(f430(A_27a,A_27b,V0f),arr(arr(A_27b,bool),arr(A_27a,arr(A_27b,bool)))) ) )).
...
tff(lameq_f430,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V3s: $i] :
          ( mem(V3s,arr(A_27b,bool))
         => ap(f430(A_27a,A_27b,V0f),V3s) = f431(A_27b,A_27a,V0f,V3s) ) ) )).

tff(conj_thm_2Elist_2EFOLDL__UNION__BIGUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,bool)))
     => ! [V1ls: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f430(A_27a,A_27b,V0f)),V2s),V1ls) = ap(ap(c_2Epred__set_2EUNION(A_27b),V2s),ap(c_2Epred__set_2EBIGUNION(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1ls)))) ) ) ) )).
