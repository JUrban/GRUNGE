...
thf(mem_c_2Esptree_2Edifference,axiom,(
    ! [A_27a: del,A_27b: del] :
      ( mem @ ( c_2Esptree_2Edifference @ A_27a @ A_27b ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27a ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27b ) @ ( ty_2Esptree_2Espt @ A_27a ) ) ) ) )).
...
thf(conj_thm_2Esptree_2Elookup__difference,lemma,(
...
thf(conj_thm_2Esptree_2Edomain__difference,lemma,(
...
thf(conj_thm_2Esptree_2EIMP__size__LESS__size,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Esptree_2Esize__diff__less,conjecture,(
