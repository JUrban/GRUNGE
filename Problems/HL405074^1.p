...
thf(thm_2EOmega__Automata_2EFORALL__EXISTS__THM,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V1t1: mono_2Etyop_2Enum_2Enum] :
        ? [V2t2: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ ( mono_2Ec_2Earithmetic_2E_2B @ V1t1 @ V2t2 ) )
    <=> ! [V3t1: mono_2Etyop_2Enum_2Enum] :
        ? [V4t2: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3t1 @ V4t2 )
          & ( V0P @ V4t2 ) ) ) )).
