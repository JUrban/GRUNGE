...
fof(conj_thm_2Ereal__topology_2EFRONTIER__CBALL,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__FRONTIER,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
...
fof(conj_thm_2Ereal__topology_2EINJECTIVE__IMP__ISOMETRIC,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
