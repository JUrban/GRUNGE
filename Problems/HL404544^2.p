...
thf(conj_thm_2Ecardinal_2ECARD__EQ__TRANS,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__ADD__CONG,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__MUL__SYM,lemma,(
...
thf(conj_thm_2Ecardinal_2ECARD__LDISTRIB,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__RDISTRIB,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
