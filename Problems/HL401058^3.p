...
thf(c_2Ewhile_2EOWHILE,type,(
    c_2Ewhile_2EOWHILE: 
      !>[A_27a: $tType] :
        ( ( A_27a > $o ) > ( A_27a > A_27a ) > A_27a > ( tyop_2Eoption_2Eoption @ A_27a ) ) )).
      ...
      = ( c_2Ebool_2ECOND @ ( tyop_2Eoption_2Eoption @ A_27a )
        @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
          @ ^ [V3n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_7E @ ( V0G @ ( c_2Earithmetic_2EFUNPOW @ A_27a @ V1f @ V3n @ V2s ) ) ) )
        @ ( c_2Eoption_2ESOME @ A_27a
          @ ( c_2Earithmetic_2EFUNPOW @ A_27a @ V1f
            @ ( c_2Ewhile_2ELEAST
              @ ^ [V4n: tyop_2Enum_2Enum] :
                  ( c_2Ebool_2E_7E @ ( V0G @ ( c_2Earithmetic_2EFUNPOW @ A_27a @ V1f @ V4n @ V2s ) ) ) )
            @ V2s ) )
        @ ( c_2Eoption_2ENONE @ A_27a ) ) ) )).

thf(thm_2Ewhile_2EOWHILE__IND,conjecture,(
