...
thf(arityeq1_2Emono_2Ec_2Enets_2Edorder_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Enets_2Edorder_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ tyop_2Emin_2Ebool ) @ c_2Enets_2Edorder_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Emetric_2EMETRIC__SYM,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) ) ) )
      = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2y_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Emetric_2EMETRIC__TRIANGLE,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1x_2E0: u,V2y_2E0: u,V3z_2E0: u] :
      ( mono_2Ec_2Ereal_2Ereal__lte @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V3z_2E0 ) ) ) ) ) ) @ ( mono_2Ec_2Erealax_2Ereal__add @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2y_2E0 ) @ ( s @ A_27a @ V3z_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Emetric_2EMETRIC__NZ,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( (~)
        @ ( ( s @ A_27a @ V1x_2E0 )
          = ( s @ A_27a @ V2y_2E0 ) ) )
     => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emetric_2Edist_2E2 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V0m_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Enets_2EDORDER__LEMMA,axiom,(
    ! [A_27a: d,V0g_2E0: u] :
     ...
     => ! [V1P_2E0: u,V2Q_2E0: u] :
          ( ( ? [V3n_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V3n_2E0 ) ) ) @ ( s @ A_27a @ V3n_2E0 ) ) ) )
                & ! [V4m_2E0: u] :
                    ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V4m_2E0 ) ) ) @ ( s @ A_27a @ V3n_2E0 ) ) ) )
                   => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V4m_2E0 ) ) ) ) ) )
            & ? [V5n_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V5n_2E0 ) ) ) @ ( s @ A_27a @ V5n_2E0 ) ) ) )
                & ! [V6m_2E0: u] :
                    ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V6m_2E0 ) ) ) @ ( s @ A_27a @ V5n_2E0 ) ) ) )
                   => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2Q_2E0 ) @ ( s @ A_27a @ V6m_2E0 ) ) ) ) ) ) )
         => ? [V7n_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V7n_2E0 ) ) ) @ ( s @ A_27a @ V7n_2E0 ) ) ) )
              & ! [V8m_2E0: u] :
                  ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0g_2E0 ) @ ( s @ A_27a @ V8m_2E0 ) ) ) @ ( s @ A_27a @ V7n_2E0 ) ) ) )
                 => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V8m_2E0 ) ) ) )
                    & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2Q_2E0 ) @ ( s @ A_27a @ V8m_2E0 ) ) ) ) ) ) ) ) ) )).
...
thf(thm_2Enets_2EMTOP__TENDS__UNIQ,conjecture,(
    ! [A_27a: d,A_27b: d,V0x1_2E0: u,V1x0_2E0: u,V2x_2E0: u,V3g_2E0: u,V4d_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Enets_2Edorder_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3g_2E0 ) ) ) )
     => ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Enets_2Etends_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2x_2E0 ) @ ( s @ A_27a @ V1x0_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( c_2Emetric_2Emtop_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V4d_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3g_2E0 ) ) ) ) ) )
          & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Enets_2Etends_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ V2x_2E0 ) @ ( s @ A_27a @ V0x1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Etopology_2Etopology @ A_27a ) @ ( c_2Emetric_2Emtop_2E1 @ ( s @ ( tyop_2Emetric_2Emetric @ A_27a ) @ V4d_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3g_2E0 ) ) ) ) ) ) )
       => ( ( s @ A_27a @ V1x0_2E0 )
          = ( s @ A_27a @ V0x1_2E0 ) ) ) ) )).
