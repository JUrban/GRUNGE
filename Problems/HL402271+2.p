...
fof(conj_thm_2Ewhile_2EOLEAST__INTRO,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Elist_2EsplitAtPki__EQN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Elist_2ETAKE__LENGTH__TOO__LONG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
...
fof(conj_thm_2Elist_2ETAKE__splitAtPki,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ap(ap(c_2Elist_2ETAKE(A_27a),V0n),V1l) = ap(ap(ap(c_2Elist_2EsplitAtPki(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ecombin_2EK(bool,bool)),ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0n))),c_2Ecombin_2EK(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))),V1l) ) ) ) )).
