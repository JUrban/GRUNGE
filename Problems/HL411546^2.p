...
thf(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__BALL,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__CBALL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
      <=> ! [V1x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__CONTAINS__INTERVAL__OPEN__INTERVAL,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
        <=> ! [V1x: tp__ty_2Erealax_2Ereal] :
