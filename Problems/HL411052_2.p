...
tff(conj_thm_2Ereal__topology_2ECONVERGENT__EQ__CAUCHY,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ? [V1l: tp__ty_2Erealax_2Ereal] : p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V0s),inj__ty_2Erealax_2Ereal(V1l)),c_2Ereal__topology_2Esequentially))
      <=> p(ap(c_2Ereal__topology_2Ecauchy,V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__BOUNDED,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
         ...
         => p(ap(c_2Ereal__topology_2Ebounded__def,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0s),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) ) ) )).
