...
fof(conj_thm_2Epred__set_2EGSPEC__IMAGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
              ( mem(V0f,arr(A_27b,ty_2Epair_2Eprod(A_27a,A_27a)))
             => ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),V0f) = ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Epair_2EFST(A_27a,A_27a)),V0f)),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Epair_2ESND(A_27a,A_27a)),V0f)) ) ) ) )).
