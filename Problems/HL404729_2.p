...
tff(conj_thm_2Efinite__map_2Eo__f__DOMSUB,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0g: $i] :
     ...
     => ! [V1fm: $i] :
         ...
         => ! [V2k: $i] :
              ( mem(V2k,A_27a)
             => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2Eo__f(A_27a,A_27a,A_27a),V0g),V1fm)),V2k) = ap(ap(c_2Efinite__map_2Eo__f(A_27a,A_27a,A_27a),V0g),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V1fm),V2k)) ) ) ) )).
