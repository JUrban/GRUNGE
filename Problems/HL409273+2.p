...
fof(conj_thm_2Ereal_2EREAL__EQ__IMP__LE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Etransc_2EDIVISION__EXISTS,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(lamtp_f3213,axiom,(
    ! [V1a] :
      ( mem(V1a,ty_2Erealax_2Ereal)
     => ! [V2b] :
          ( mem(V2b,ty_2Erealax_2Ereal)
         => mem(f3213(V1a,V2b),arr(ty_2Erealax_2Ereal,bool)) ) ) )).
    ...
    ! [V1a] :
     ...
     => ! [V2b] :
         ...
         => ! [V5x] :
             ...
             => ap(f3213(V1a,V2b),V5x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,V1a),V5x)),ap(ap(c_2Ereal_2Ereal__lte,V5x),V2b)) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,lemma,(
    ! [V0f] :
                             ...
                             => ! [V7p1] :
                                 ...
                                 => ! [V8d2] :
                                     ...
                                     => ! [V9p2] :
                                         ...
                                         => ( ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V6d1),V7p1)))
                                              ...
                                              & p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d2),V9p2)))
                                           ...
                                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V6d1),V7p1)),V0f)),ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d2),V9p2)),V0f)))),V3e)) ) ) ) ) ) ) ) ) ) ) ) ) )).

fof(lamtp_f3217,axiom,(
    ! [V1a] :
      ( mem(V1a,ty_2Erealax_2Ereal)
     => ! [V2b] :
          ( mem(V2b,ty_2Erealax_2Ereal)
         => mem(f3217(V1a,V2b),arr(ty_2Erealax_2Ereal,bool)) ) ) )).
    ...
    ! [V1a] :
     ...
     => ! [V2b] :
         ...
         => ! [V7x] :
             ...
             => ap(f3217(V1a,V2b),V7x) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,V1a),V7x)),ap(ap(c_2Ereal_2Ereal__lte,V7x),V2b)) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__SPLIT__SIDES,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3c] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V3c))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,V3c),V2b))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f)) )
                   => ? [V4i] :
                                     ...
                                     => ! [V9p1] :
                                         ...
                                         => ! [V10d2] :
                                             ...
                                             => ! [V11p2] :
                                                 ...
                                                 => ( ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V3c)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d1),V9p1)))
                                                      ...
                                                      & p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3c),V2b)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V10d2),V11p2)))
                                                   ...
                                                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V8d1),V9p1)),V0f)),ap(ap(c_2Etransc_2Ersum,ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V10d2),V11p2)),V0f))),V4i))),V5e)) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__RIGHT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3c] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V3c))
                      & p(ap(ap(c_2Ereal_2Ereal__lte,V3c),V2b))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f)) )
                   => p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3c),V2b)),V0f)) ) ) ) ) ) )).
