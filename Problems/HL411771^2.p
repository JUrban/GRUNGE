...
thf(conj_thm_2Ereal__topology_2ESUMS__REINDEX,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__REINDEX,conjecture,(
    ! [V0k: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V2n: tp__ty_2Enum_2Enum] :
          ( ( p
            @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V2n ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V3x: $i] :
                    ( ap @ V1a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3x ) @ ( inj__ty_2Enum_2Enum @ V0k ) ) ) ) ) )
