...
fof(conj_thm_2Ealist_2EALOOKUP__MEM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2EALOOKUP__SOME__FAPPLY__alist__to__fmap,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0al] :
             ...
             => ! [V1k] :
                 ...
                 => ! [V2v] :
                      ( mem(V2v,A_27b)
                     => ( ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0al),V1k) = ap(c_2Eoption_2ESOME(A_27b),V2v)
                       => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0al)),V1k) = V2v ) ) ) ) ) ) )).
...
fof(conj_thm_2Ealist_2EFUPDATE__LIST__EQ__APPEND__REVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2EFLOOKUP__FUPDATE__LIST__ALOOKUP__SOME,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ls] :
              ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b)))
             => ! [V1k] :
                  ( mem(V1k,A_27b)
                 => ! [V2v] :
                      ( mem(V2v,A_27a)
                     => ! [V3fm] :
                         ...
                         => ( ap(ap(c_2Ealist_2EALOOKUP(A_27a,A_27a),V0ls),V1k) = ap(c_2Eoption_2ESOME(A_27a),V2v)
                           => ap(ap(c_2Efinite__map_2EFLOOKUP(A_27b,A_27b),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27b,A_27b),V3fm),ap(c_2Elist_2EREVERSE(ty_2Epair_2Eprod(A_27b,A_27b)),V0ls))),V1k) = ap(c_2Eoption_2ESOME(A_27a),V2v) ) ) ) ) ) ) ) )).
