...
thf(f6331_0_2E0,type,(
    f6331_0_2E0: u )).

thf(f6331_0_2E2,type,(
    f6331_0_2E2: du > du > u )).

thf(f6331_1_2E0,type,(
    f6331_1_2E0: u )).

thf(f6331_1_2E2,type,(
    f6331_1_2E2: du > du > u )).
...
thf(mono_2Ef6331_0,type,(
    mono_2Ef6331_0: mono_2Etyop_2Einteger_2Eint > mono_2Etyop_2Einteger_2Eint > $o )).

thf(mono_2Ef6331_1,type,(
    mono_2Ef6331_1: mono_2Etyop_2Einteger_2Eint > mono_2Etyop_2Einteger_2Eint > $o )).
...
thf(def0_2Ethm_2Einteger_2EINT__MOD__UNIQUE,axiom,(
    ! [V1j: mono_2Etyop_2Einteger_2Eint,V2m: mono_2Etyop_2Einteger_2Eint] :
      ( ( mono_2Ef6331_0 @ V1j @ V2m )
    <=> ( ( mono_2Ec_2Einteger_2Eint__lt @ V1j @ V2m )
        & ( mono_2Ec_2Einteger_2Eint__le @ V2m @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) )).

thf(def1_2Ethm_2Einteger_2EINT__MOD__UNIQUE,axiom,(
    ! [V2m: mono_2Etyop_2Einteger_2Eint,V1j: mono_2Etyop_2Einteger_2Eint] :
      ( ( mono_2Ef6331_1 @ V2m @ V1j )
    <=> ( ( mono_2Ec_2Einteger_2Eint__le @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) @ V2m )
        & ( mono_2Ec_2Einteger_2Eint__lt @ V2m @ V1j ) ) ) )).

thf(thm_2Einteger_2EINT__MOD__UNIQUE,conjecture,(
    ! [V0i: mono_2Etyop_2Einteger_2Eint,V1j: mono_2Etyop_2Einteger_2Eint,V2m: mono_2Etyop_2Einteger_2Eint] :
      ( ? [V3q: mono_2Etyop_2Einteger_2Eint] :
          ( ( V0i
            = ( mono_2Ec_2Einteger_2Eint__add @ ( mono_2Ec_2Einteger_2Eint__mul @ V3q @ V1j ) @ V2m ) )
          & ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Einteger_2Eint__lt @ V1j @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) @ ( mono_2Ef6331_0 @ V1j @ V2m ) @ ( mono_2Ef6331_1 @ V2m @ V1j ) ) )
     => ( ( mono_2Ec_2Einteger_2Eint__mod @ V0i @ V1j )
        = V2m ) ) )).
