...
thf(thm_2Epair_2EUNCURRY__CONG,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_27_2E0: u,V1f_2E0: u,V2M_27_2E0: u,V3M_2E0: u] :
      ( ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V3M_2E0 )
          = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V2M_27_2E0 ) )
        & ! [V4x_2E0: u,V5y_2E0: u] :
            ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V2M_27_2E0 )
              = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27b @ V5y_2E0 ) ) ) )
           => ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) @ ( s @ A_27b @ V5y_2E0 ) ) )
              = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V0f_27_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) @ ( s @ A_27b @ V5y_2E0 ) ) ) ) ) )
     => ( ( s @ A_27c @ ( c_2Epair_2EUNCURRY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V3M_2E0 ) ) )
        = ( s @ A_27c @ ( c_2Epair_2EUNCURRY_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V0f_27_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V2M_27_2E0 ) ) ) ) ) )).
