...
thf(thm_2Eiterate_2ESUM__DIFF,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1s_2E0: u,V2t_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EDIFF_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) )
        = ( mono_2Ec_2Ereal_2Ereal__sub @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2t_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V0f_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESUM__DIFF__LEMMA,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1k: mono_2Etyop_2Enum_2Enum > $o,V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2m @ V3n )
     => ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V1k @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V3n ) ) @ V0f ) @ ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V1k @ ( mono_2Ec_2Eiterate_2E_2E_2E @ mono_2Ec_2Enum_2E0 @ V2m ) ) @ V0f ) )
        = ( mono_2Ec_2Eiterate_2ESum_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Epred__set_2EINTER_2Emono_2Etyop_2Enum_2Enum @ V1k @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2E_2B @ V2m @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V3n ) ) @ V0f ) ) ) )).
