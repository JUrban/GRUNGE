...
fof(conj_thm_2Eiterate_2EDISJOINT__NUMSEG,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eiterate_2ENUMSEG__ADD__SPLIT,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Eproduct_2ENPRODUCT__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Eproduct_2ENPRODUCT__ADD__SPLIT,conjecture,(
    ! [V0f] :
