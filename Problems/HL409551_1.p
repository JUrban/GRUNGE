...
tff(thm_2Eutil__prob_2Edisjoint__def,axiom,(
    ! [A_27a: d,V0A_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Eutil__prob_2Edisjoint_2E1(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0A_2E0)))))
    <=> ! [V1a_2E0: u,V2b_2E0: u] :
          ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1a_2E0),s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0A_2E0)))))
            & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2b_2E0),s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0A_2E0)))))
            & s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1a_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2b_2E0) )
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2EDISJOINT_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1a_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2b_2E0))))) ) ) )).

tff(thm_2Eutil__prob_2Edisjoint__empty,conjecture,(
    ! [A_27a: d] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Eutil__prob_2Edisjoint_2E1(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0))))) )).
