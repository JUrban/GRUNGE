...
thf(arityeq1_2Emono_2Ec_2Ebag_2EFINITE__BAG_2E1_2Emono_2EA_27c,axiom,(
    ! [A_27c: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EFINITE__BAG_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ c_2Ebag_2EFINITE__BAG_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EDOMSUB__NOT__IN__DOM,axiom,(
    ! [A_27a: d,A_27b: d,V0k_2E0: u,V1fm_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0k_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFDOM_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1fm_2E0 ) ) ) ) ) ) )
     => ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2Efdomsub_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1fm_2E0 ) @ ( s @ A_27a @ V0k_2E0 ) ) )
        = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1fm_2E0 ) ) ) )).

thf(thm_2Econtainer_2EFINITE__BAG__OF__FMAP,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1b_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EFINITE__BAG_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ tyop_2Enum_2Enum ) @ ( c_2Econtainer_2EBAG__OF__FMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1b_2E0 ) ) ) ) ) ) )).
