...
fof(conj_thm_2Ereal__topology_2ECLOSED__MAP__FROM__COMPOSITION__INJECTIVE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
                     ...
                     => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s)),V3t))
                          ...
                          & ! [V5x] :
                             ...
                             => ! [V6y] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V3t))
                                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6y),V3t))
                                      & ap(V1g,V5x) = ap(V1g,V6y) )
                                   => V5x = V6y ) ) )
                          & ! [V7k] :
