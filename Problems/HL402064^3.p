...
thf(thm_2Eset__relation_2Eper__delete,conjecture,(
    ! [A_27a: $tType,V0xs: A_27a > $o,V1xss: ( A_27a > $o ) > $o,V2e: A_27a] :
      ( ( c_2Eset__relation_2Eper @ A_27a @ V0xs @ V1xss )
     => ( c_2Eset__relation_2Eper @ A_27a @ ( c_2Epred__set_2EDELETE @ A_27a @ V0xs @ V2e )
        @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
          @ ^ [V3es: A_27a > $o] :
              ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ V3es
              @ ( c_2Ebool_2E_2F_5C
                @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V3es
                  @ ( c_2Epred__set_2EIMAGE @ ( A_27a > $o ) @ ( A_27a > $o )
                    @ ^ [V4es: A_27a > $o] :
                        ( c_2Epred__set_2EDELETE @ A_27a @ V4es @ V2e )
                    @ V1xss ) )
                @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ ( A_27a > $o ) @ V3es @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) ) ) ) )).
