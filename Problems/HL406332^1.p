...
thf(thm_2Etoto_2EStrong__Strong__of__TO,conjecture,(
    ! [A_27a: d,V0c_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2EStrongLinearOrder_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( c_2Etoto_2EStrongLinearOrder__of__TO_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2EternaryComparisons_2Eordering ) ) @ V0c_2E0 ) ) ) ) ) ) ) )).
