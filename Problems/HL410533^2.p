...
thf(conj_thm_2Ereal__topology_2ESPAN__INC,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Espan @ V0s ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBASIS__CARD__EQ__DIM,lemma,(
    ! [V0v: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V1b ) @ V0v ) )
           ...
           => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V1b ) )
              & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Epred__set_2ECARD @ ty_2Erealax_2Ereal ) @ V1b ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal__topology_2Edim @ V0v ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBASIS__HAS__SIZE__DIM,conjecture,(
    ! [V0v: $i] :
      ( ( mem @ V0v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Eindependent @ V1b ) )
              & ( ( ap @ c_2Ereal__topology_2Espan @ V1b )
                = V0v ) )
