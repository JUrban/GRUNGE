...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__ID,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ealignment_2Ealign__w2n,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
...
fof(conj_thm_2Ealignment_2Ealign__sub,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
         => ! [V1w] :
              ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
             => ap(ap(c_2Ealignment_2Ealign(A_27a),V0p),V1w) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0p),c_2Enum_2E0)),V1w),ap(ap(c_2Ewords_2Eword__sub(A_27a),V1w),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,V0p),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),c_2Enum_2E0),V1w))) ) ) ) )).
...
fof(conj_thm_2Ealignment_2Ealign__add__aligned,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Enum_2Enum)
