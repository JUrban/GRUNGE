...
fof(thm_2Etopology_2EOPEN__IN__SUBOPEN,axiom,(
    ...
    <=> ! [V2x_2E0] :
         ...
         => ? [V3t_2E0] :
              ...
              & p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V2x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V3t_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V3t_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0)))) ) ) ) )).

fof(thm_2Ereal__topology_2ECONNECTED__INDUCTION,conjecture,(
