...
thf(f6877_0_2E0,type,(
    f6877_0_2E0: u )).

thf(f6877_0_2E2,type,(
    f6877_0_2E2: du > du > u )).

thf(f7054_0_2E0,type,(
    f7054_0_2E0: u )).

thf(f7054_0_2E2,type,(
    f7054_0_2E2: du > du > u )).
...
thf(mono_2Ef6877_0,type,(
    mono_2Ef6877_0: $o > $o > $o )).

thf(mono_2Ef7054_0,type,(
    mono_2Ef7054_0: $o > $o > $o )).
...
thf(thm_2Ebit_2ENOT__BIT__GT__LOG2,axiom,(
    ! [V0i: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Ebit_2ELOG2 @ V1n ) @ V0i )
     => ( (~) @ ( mono_2Ec_2Ebit_2EBIT @ V0i @ V1n ) ) ) )).

thf(thm_2Ebit_2ENOT__BIT__GT__BITWISE,axiom,(
    ! [V0i: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2op: $o > $o > $o,V3a: mono_2Etyop_2Enum_2Enum,V4b: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1n @ V0i )
     => ( (~) @ ( mono_2Ec_2Ebit_2EBIT @ V0i @ ( mono_2Ec_2Ebit_2EBITWISE @ V1n @ V2op @ V3a @ V4b ) ) ) ) )).
...
thf(def0_2Ethm_2Ewords_2Eword__xor__n2w,axiom,(
    ! [V2x: $o,V3y: $o] :
      ( ( mono_2Ef6877_0 @ V2x @ V3y )
    <=> ( (~) @ ( V2x = V3y ) ) ) )).

thf(thm_2Ewords_2Eword__xor__n2w,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__xor_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1m ) ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) @ mono_2Ef6877_0 @ V0n @ V1m ) ) ) ) ) ) )).

thf(thm_2Ewords_2Eword__bit__n2w,axiom,(
    ! [A_27a: d,V0b: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewords_2Eword__bit_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0b ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) ) ) )
    <=> ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0b @ ( mono_2Ec_2Earithmetic_2E_2D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
        & ( mono_2Ec_2Ebit_2EBIT @ V0b @ V1n ) ) ) )).

thf(thm_2Ewords_2EWORD__EQ,axiom,(
    ! [A_27a: d,V0v_2E0: u,V1w_2E0: u] :
      ( ! [V2x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2x @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
         => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewords_2Eword__bit_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0v_2E0 ) ) ) )
            = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewords_2Eword__bit_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1w_2E0 ) ) ) ) ) )
    <=> ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0v_2E0 )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1w_2E0 ) ) ) )).

thf(def0_2Ethm_2Ewords_2EWORD__LITERAL__XOR,axiom,(
    ! [V2x: $o,V3y: $o] :
      ( ( mono_2Ef7054_0 @ V2x @ V3y )
    <=> ( (~) @ ( V2x = V3y ) ) ) )).

thf(thm_2Ewords_2EWORD__LITERAL__XOR,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__xor_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1m ) ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ebit_2EBITWISE @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2EMAX @ ( mono_2Ec_2Ebit_2ELOG2 @ V0n ) @ ( mono_2Ec_2Ebit_2ELOG2 @ V1m ) ) ) @ mono_2Ef7054_0 @ V0n @ V1m ) ) ) ) ) ) )).
