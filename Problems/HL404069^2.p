...
thf(conj_thm_2ETemporal__Logic_2EALWAYS__FIX,lemma,(
    ! [V0y: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ( ( V0y
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V2t: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V2t ) ) @ ( ap @ V0y @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V2t ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
          <=> ( ( V0y
...
thf(conj_thm_2ETemporal__Logic_2EEVENTUAL__FIX,lemma,(
    ! [V0y: $i] :
      ( ( mem @ V0y @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EUNTIL__FIX,lemma,(
    ! [V0y: $i] :
      ( ( mem @ V0y @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
...
thf(conj_thm_2ETemporal__Logic_2EBEFORE__FIX,lemma,(
    ! [V0b: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ! [V2y: $i] :
             ...
             => ( ( V2y
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V3t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0b @ V3t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V3t ) ) @ ( ap @ V2y @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3t ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )
              <=> ( ( V2y
...
thf(conj_thm_2EPast__Temporal__Logic_2EFIXPOINTS,conjecture,(
    ! [V0y: $i] :
      ( ( mem @ V0y @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2b: $i] :
             ...
             => ( ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V3t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0y ) @ V3t ) ) ) )
                <=> ( ( V0y
                      = ( ap @ c_2ETemporal__Logic_2EALWAYS @ V1a ) )
                    | ( V0y
                      = ( lam @ ty_2Enum_2Enum
                ...
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V5t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V5t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0y ) @ V5t ) ) ) )
                <=> ( ( V0y
                      = ( ap @ c_2ETemporal__Logic_2EEVENTUAL @ V1a ) )
                    | ( V0y
                      = ( lam @ ty_2Enum_2Enum
                ...
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V7t: $i] :
                          ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V7t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V7t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0y ) @ V7t ) ) ) ) )
                <=> ( ( V0y
                ...
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V8t: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ bool ) @ ( ap @ V2b @ V8t ) ) @ ( ap @ V1a @ V8t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0y ) @ V8t ) ) ) )
                <=> ( ( V0y
                ...
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V9t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V9t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V9t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V0y ) @ V9t ) ) ) ) )
                <=> ( ( V0y
                ...
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V10t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V10t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0y ) @ V10t ) ) ) )
                <=> ( V0y
                    = ( ap @ c_2EPast__Temporal__Logic_2EPALWAYS @ V1a ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V11t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V11t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0y ) @ V11t ) ) ) )
                <=> ( V0y
                    = ( ap @ c_2EPast__Temporal__Logic_2EPEVENTUAL @ V1a ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V12t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V2b @ V12t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V12t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0y ) @ V12t ) ) ) ) )
                <=> ( V0y
                    = ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V1a ) @ V2b ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V13t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V13t ) ) @ ( ap @ V2b @ V13t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V13t ) ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0y ) @ V13t ) ) ) ) )
                <=> ( V0y
                    = ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V1a ) @ V2b ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V14t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V14t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V14t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSNEXT @ V0y ) @ V14t ) ) ) ) )
                <=> ( V0y
                    = ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V1a ) @ V2b ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V15t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V2b @ V15t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V15t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0y ) @ V15t ) ) ) ) )
                <=> ( V0y
                    = ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL @ V1a ) @ V2b ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V16t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1a @ V16t ) ) @ ( ap @ V2b @ V16t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V16t ) ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0y ) @ V16t ) ) ) ) )
                <=> ( V0y
                    = ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN @ V1a ) @ V2b ) ) )
                & ( ( V0y
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V17t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2b @ V17t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1a @ V17t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0y ) @ V17t ) ) ) ) )
                <=> ( V0y
