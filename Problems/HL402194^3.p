...
thf(thm_2Elist_2ESUM__IMAGE__LIST__TO__SET__upper__bound,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1ls: tyop_2Elist_2Elist @ A_27a] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a @ V0f @ ( c_2Elist_2ELIST__TO__SET @ A_27a @ V1ls ) ) @ ( c_2Elist_2ESUM @ ( c_2Elist_2EMAP @ A_27a @ tyop_2Enum_2Enum @ V0f @ V1ls ) ) ) )).
