...
fof(lamtp_f4033,axiom,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4033(V0x,V1y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ! [V3i] :
             ...
             => ap(f4033(V0x,V1y),V3i) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0x,V3i)),ap(V1y,V3i)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EINFSUM__SUB,conjecture,(
    ! [V0x] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1y] :
          ( mem(V1y,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2s] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Esummable,V2s),V0x))
               ...
               => ap(ap(c_2Ereal__topology_2Einfsum,V2s),f4033(V0x,V1y)) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal__topology_2Einfsum,V2s),V0x)),ap(ap(c_2Ereal__topology_2Einfsum,V2s),V1y)) ) ) ) ) )).
