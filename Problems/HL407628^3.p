...
thf(thm_2Emetric_2Eismet,axiom,(
    ...
    <=> ( ! [V1x: A_27a,V2y: A_27a] :
        ...
        & ! [V3x: A_27a,V4y: A_27a,V5z: A_27a] :
            ( c_2Ereal_2Ereal__lte @ ( V0m @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V4y @ V5z ) ) @ ( c_2Erealax_2Ereal__add @ ( V0m @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V3x @ V4y ) ) @ ( V0m @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V3x @ V5z ) ) ) ) ) ) )).

thf(thm_2Emetric_2EMETRIC__ISMET,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Emetric_2Emetric @ A_27a] :
      ( c_2Emetric_2Eismet @ A_27a @ ( c_2Emetric_2Edist @ A_27a @ V0m ) ) )).
...
thf(thm_2Emetric_2EMETRIC__POS,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Emetric_2Emetric @ A_27a,V1x: A_27a,V2y: A_27a] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Emetric_2Edist @ A_27a @ V0m @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V1x @ V2y ) ) ) )).
