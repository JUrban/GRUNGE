...
tff(conj_thm_2Elist_2ELIST__REL__MAP1,conjecture,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l1: $i] :
             ...
             => ! [V3l2: $i] :
                 ...
                 => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EMAP(A_27c,A_27c),V1f),V2l1)),V3l2))
                  <=> p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27c,A_27c),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0R),V1f)),V2l1),V3l2)) ) ) ) ) ) )).
