...
thf(conj_thm_2Ellist_2ELTL__LGENLIST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
     => ! [V1limopt: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
          ( ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ V0f ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V1limopt ) ) )
          = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V1limopt ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Ellist_2Ellist @ A_27a ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELGENLIST @ A_27a ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ A_27a @ ty_2Enum_2Enum ) @ V0f ) @ c_2Enum_2ESUC ) ) @ ( ap @ ( ap @ ( c_2Eoption_2EOPTION__MAP @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ c_2Eprim__rec_2EPRE ) @ ( inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ V1limopt ) ) ) ) ) ) ) )).
