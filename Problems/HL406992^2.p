...
thf(conj_thm_2Ewords_2EZERO__LE__INT__MAX,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ ( c_2Ewords_2EINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )).

thf(conj_thm_2Einteger__word_2EINT__ZERO__LE__INT__MAX,conjecture,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Einteger__word_2EINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )).
