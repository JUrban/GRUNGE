...
thf(conj_thm_2Ewords_2Eword__H,lemma,(
...
thf(conj_thm_2Ewords_2Eword__lsb__word__T,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( c_2Ewords_2Eword__lsb @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Elsr__1__word__T,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) )
      = ( c_2Ewords_2Eword__H @ A_27a ) ) )).

thf(conj_thm_2Ewords_2Eword__rrx__word__T,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ( ( ap @ ( c_2Ewords_2Eword__rrx @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
        = ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( c_2Ewords_2Eword__H @ A_27a ) ) )
      & ( ( ap @ ( c_2Ewords_2Eword__rrx @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
        = ( ap @ ( ap @ ( c_2Epair_2E_2C @ bool @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
