    ...
    ! [A_27a: d,V0f_2E0: u] :
      ( ( ! [V1a_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) )
              & ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ ( c_2Eordinal_2Eomax_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eordinal_2Epreds_2E1 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) ) ) )
                = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ c_2Eoption_2ENONE_2E0 ) ) )
           => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V1a_2E0 ) ) )
        ...
        & ! [V2x_2E0: u,V3y_2E0: u] :
            ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eordinal_2Eordlt_2E2 @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V3y_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2x_2E0 ) ) ) ) )
     ...
     => ! [V4s_2E0: u] :
          ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ecardinal_2Ecardleq_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ V4s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ tyop_2Enum_2Enum @ A_27a ) @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EUNIV_2E0 ) ) ) )
            & ( (~)
              @ ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ V4s_2E0 )
                = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) ) ) )
         => ( ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) @ V0f_2E0 ) @ ( s @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2Esup_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ tyop_2Emin_2Ebool ) @ V4s_2E0 ) ) ) ) )
...
thf(thm_2Eordinal_2EordEXP__continuous,conjecture,(
