...
tff(conj_thm_2Eordinal_2EordMULT__fromNat,lemma,(
...
tff(conj_thm_2Eordinal_2EordMULT__ASSOC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2EordNotationSemantics_2Ekexp__sum__times__nat,conjecture,(
    ! [A_27a: del,V0c2: tp__ty_2Enum_2Enum,V1c: tp__ty_2Enum_2Enum,V2t: $i] :
     ...
     => ! [V3e: $i] :
         ...
         => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0c2)))
           ...
           => ap(ap(c_2Eordinal_2EordMULT(A_27a),ap(ap(c_2Eordinal_2EordADD(A_27a),ap(ap(c_2Eordinal_2EordMULT(A_27a),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V3e)),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(V1c)))),V2t)),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(V0c2))) = ap(ap(c_2Eordinal_2EordADD(A_27a),ap(ap(c_2Eordinal_2EordMULT(A_27a),ap(ap(c_2Eordinal_2EordEXP(A_27a),c_2Eordinal_2Eomega(A_27a)),V3e)),ap(c_2Eordinal_2EfromNat(A_27a),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V1c)),inj__ty_2Enum_2Enum(V0c2))))),V2t) ) ) ) )).
