...
fof(lamtp_f3483,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3483(V0f,V1c),arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f3483,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ! [V4n] :
             ...
             => ap(f3483(V0f,V1c),V4n) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(V0f,V4n)) ) ) ) )).

fof(conj_thm_2Eextreal_2Eext__suminf__cmul__alt,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V1c))
              & ( ! [V2n] :
                   ...
                   => ap(V0f,V2n) != c_2Eextreal_2ENegInf )
                | ! [V3n] :
                    ( mem(V3n,ty_2Enum_2Enum)
                   => ap(V0f,V3n) != c_2Eextreal_2EPosInf ) ) )
           => ap(c_2Eextreal_2Eext__suminf,f3483(V0f,V1c)) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(c_2Eextreal_2Eext__suminf,V0f)) ) ) ) )).
