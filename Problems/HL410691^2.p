...
thf(conj_thm_2Etopology_2EBIGUNION__2,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Etopology_2EBIGINTER__2,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ A_27a @ bool ) ) @ V0s ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ A_27a @ bool ) ) @ V1t ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ A_27a @ bool ) ) ) ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V0s ) @ V1t ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__UNION,conjecture,(
    ! [V0s: $i] :
