...
thf(thm_2EHolSmt_2Et004,conjecture,(
    ! [A_27a: d,A_27b: d,V0z_2E0: u,V1y_2E0: u,V2x_2E0: u,V3f_2E0: u] :
      ( ( ( s @ A_27a @ V2x_2E0 )
        = ( s @ A_27a @ V1y_2E0 ) )
      | ( ( s @ A_27b @ ( c_2Ecombin_2EUPDATE_2E4 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27b @ V0z_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) )
        = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V3f_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) ) ) ) )).
