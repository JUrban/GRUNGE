...
thf(f13318_0_2E0,type,(
    f13318_0_2E0: u )).

thf(f13318_0_2E1,type,(
    f13318_0_2E1: du > u )).

thf(f13318_0_2E2,type,(
    f13318_0_2E2: du > du > u )).

thf(f13318_1_2E0,type,(
    f13318_1_2E0: u )).

thf(f13318_1_2E1,type,(
    f13318_1_2E1: du > u )).

thf(f13318_1_2E2,type,(
...
thf(mono_2Ef13318_0,type,(
    mono_2Ef13318_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13318_1,type,(
    mono_2Ef13318_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ETRANSLATION__DIFF,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V4x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13318_1 @ V0a @ V4x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V4x ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ETRANSLATION__DIFF,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13318_0 @ V0a @ V3x )
      = ( mono_2Ec_2Erealax_2Ereal__add @ V0a @ V3x ) ) )).

thf(thm_2Ereal__topology_2ETRANSLATION__DIFF,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13318_0 @ V0a ) @ ( mono_2Ec_2Epred__set_2EDIFF_2Emono_2Etyop_2Erealax_2Ereal @ V1s @ V2t ) )
      = ( mono_2Ec_2Epred__set_2EDIFF_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13318_1 @ V0a ) @ V1s ) @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13318_1 @ V0a ) @ V2t ) ) ) )).
