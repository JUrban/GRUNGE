...
fof(conj_thm_2Epred__set_2ESET__EQ__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s1] :
...
fof(conj_thm_2Ereal__topology_2EIN__INTERIOR,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__STRADDLE,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__COMPLEMENT,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__INTER__SUBSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__UNION__SUBSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EFRONTIER__INTERIORS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EUNION__FRONTIER,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
