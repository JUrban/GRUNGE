...
tff(lmtp_f3283,type,(
    f3283: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f3283,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum] : mem(f3283(V0n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f3283,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum] : ap(f3283(V0n),inj__ty_2Enum_2Enum(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V0n))) )).

tff(conj_thm_2Eiterate_2ENUMSEG__LE,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] : ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3283(V0n)) = ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)) )).
