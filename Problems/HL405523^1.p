...
thf(thm_2Einteger_2EINT__DIV__CALCULATE,conjecture,
    ...
    & ! [V2p: mono_2Etyop_2Einteger_2Eint,V3q: mono_2Etyop_2Einteger_2Eint] :
        ( ( (~)
          @ ( V3q
            = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
       => ( ( mono_2Ec_2Einteger_2Eint__div @ V2p @ ( mono_2Ec_2Einteger_2Eint__neg @ V3q ) )
          = ( mono_2Ec_2Einteger_2Eint__div @ ( mono_2Ec_2Einteger_2Eint__neg @ V2p ) @ V3q ) ) )
    & ! [V4m: mono_2Etyop_2Enum_2Enum,V5n: mono_2Etyop_2Enum_2Enum] :
        ( ( ( mono_2Ec_2Einteger_2Eint__of__num @ V4m )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ V5n ) )
      <=> ( V4m = V5n ) )
    & ! [V6x: mono_2Etyop_2Einteger_2Eint] :
        ( ( ( mono_2Ec_2Einteger_2Eint__neg @ V6x )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) )
      <=> ( V6x
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
    & ! [V7x: mono_2Etyop_2Einteger_2Eint] :
        ( ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__neg @ V7x ) )
        = V7x ) )).
