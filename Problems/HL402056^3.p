...
thf(thm_2Eset__relation_2Estrict__linear__order,axiom,(
    ! [A_27a: $tType,V0r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V1s: A_27a > $o] :
      ( ( c_2Eset__relation_2Elinear__order @ A_27a @ V0r @ V1s )
     => ( c_2Eset__relation_2Estrict__linear__order @ A_27a @ ( c_2Eset__relation_2Estrict @ A_27a @ V0r ) @ V1s ) ) )).

thf(thm_2Eset__relation_2Efinite__strict__linear__order__has__minimal,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( c_2Eset__relation_2Estrict__linear__order @ A_27a @ V1r @ V0s )
        & ( (~)
          @ ( V0s
...
thf(thm_2Eset__relation_2Efinite__linear__order__has__minimal,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
