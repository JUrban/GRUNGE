...
fof(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS__EXPLICIT,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
                       ...
                       => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V8x),V2s))
                         ...
                         => ? [V10d] :
                              ...
                              & ! [V11x_27] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V11x_27),V2s))
                                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V8x),V11x_27))),V10d)) )
                                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(V0f,V8x)),ap(V0f,V11x_27)))),V9e)) ) ) ) ) ) ) ) ) ) ) )).
