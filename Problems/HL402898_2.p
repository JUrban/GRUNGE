...
tff(conj_thm_2Erich__list_2Elist__rel__lastn,conjecture,(
     ...
     => ! [V1l1: $i] :
         ...
         => ! [V2l2: $i] :
             ...
             => ! [V3n: tp__ty_2Enum_2Enum] :
                 ...
                 => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0f),ap(ap(c_2Erich__list_2ELASTN(A_27a),inj__ty_2Enum_2Enum(V3n)),V1l1)),ap(ap(c_2Erich__list_2ELASTN(A_27b),inj__ty_2Enum_2Enum(V3n)),V2l2))) ) ) ) ) )).
