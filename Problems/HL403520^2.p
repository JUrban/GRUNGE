...
thf(stp_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,type,(
    tp__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o: $tType )).

thf(stp_inj_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,type,(
...
thf(stp_surj_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,type,(
...
thf(stp_inj_surj_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,axiom,(
    ! [X: tp__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o] :
      ( ( surj__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o @ ( inj__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o @ X ) )
      = X ) )).

thf(stp_inj_mem_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,axiom,(
    ! [X: tp__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o] :
      ( mem @ ( inj__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o @ X ) @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool ) ) )).

thf(stp_iso_mem_c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o,axiom,(
    ! [X: $i] :
      ( ( mem @ X @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool ) )
     => ( X
        = ( inj__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o @ ( surj__c_ty_2Epair_2Eprod_c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum_o @ X ) ) ) ) )).
...
thf(conj_thm_2Ewellorder_2Ewellorder__fromNat,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p
      @ ( ap @ ( c_2Ewellorder_2Ewellorder @ ty_2Enum_2Enum )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
          @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1i: $i] :
                  ( lam @ ty_2Enum_2Enum
                  @ ^ [V2j: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ V1i ) @ V2j ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V1i ) @ V2j ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2j ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2EINJ__preserves__wellorder,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Ewellorder_2Ewellorder @ A_27a ) @ V0r ) )
                  & ( p @ ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EINJ @ A_27a @ A_27b ) @ V1f ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ ( ap @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a ) @ V0r ) ) @ ( ap @ ( c_2Eset__relation_2Erange @ A_27a @ A_27a ) @ V0r ) ) ) @ V2t ) ) )
               => ( p @ ( ap @ ( c_2Ewellorder_2Ewellorder @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ ( ty_2Epair_2Eprod @ A_27b @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_23_23 @ A_27a @ A_27a @ A_27b @ A_27b ) @ V1f ) @ V1f ) ) @ V0r ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Ewellorder__fromNat__SUM,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( p
      @ ( ap @ ( c_2Ewellorder_2Ewellorder @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )
          @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Enum_2Enum @ ty_2Enum_2Enum @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ bool ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1i: $i] :
                  ( lam @ ty_2Enum_2Enum
                  @ ^ [V2j: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) @ ( ty_2Esum_2Esum @ ty_2Enum_2Enum @ A_27a ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ A_27a ) @ V1i ) ) @ ( ap @ ( c_2Esum_2EINL @ ty_2Enum_2Enum @ A_27a ) @ V2j ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V1i ) @ V2j ) ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2j ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) ) ) ) )).
