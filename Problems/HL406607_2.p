...
tff(conj_thm_2Ebool_2ERES__FORALL__THM,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(lamtp_f2445,axiom,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => mem(f2445(A_27a,V0phi),arr(ty_2Elist_2Elist(A_27a),bool)) ) )).

tff(lameq_f2445,axiom,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Elist_2Elist(A_27a))
         => ap(f2445(A_27a,V0phi),V1w) = ap(V0phi,V1w) ) ) )).

tff(conj_thm_2EEncodeVar_2Eof__length__univ__zero,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ( p(ap(ap(c_2Ebool_2ERES__FORALL(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),f2445(A_27a,V0phi)))
