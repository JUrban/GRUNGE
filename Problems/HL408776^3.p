...
thf(thm_2EHolSmt_2Er155,conjecture,(
    ! [V0z: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2x: tyop_2Erealax_2Ereal,V3w: tyop_2Erealax_2Ereal,V4v: tyop_2Erealax_2Ereal,V5a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V2x ) @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ V4v ) @ V1y ) @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ V3w ) @ V0z ) ) )
        = ( c_2Erealax_2Ereal__neg @ V5a ) )
    <=> ( ( c_2Erealax_2Ereal__add @ V2x @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V4v @ V1y ) @ ( c_2Erealax_2Ereal__mul @ V3w @ V0z ) ) )
        = V5a ) ) )).
