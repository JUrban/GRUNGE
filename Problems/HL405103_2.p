...
tff(conj_thm_2Equotient_2EQUOTIENT__SYM,lemma,(
...
tff(conj_thm_2Equotient_2EQUOTIENT__TRANS,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
...
tff(conj_thm_2Equotient__pred__set_2EIN__GSPECR,lemma,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
...
tff(conj_thm_2Equotient__pred__set_2EGSPECR__RSP,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs1: $i] :
                   ...
                   => ! [V4abs2: $i] :
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6f1: $i] :
                                  ( mem(V6f1,arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))
                                 => ! [V7f2: $i] :
                                      ( mem(V7f2,arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))
                                     => ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),ap(ap(c_2Equotient__pair_2E_23_23_23(A_27b,A_27b,A_27b,A_27b),V3R2),c_2Emin_2E_3D(bool))),V6f1),V7f2))
                                       => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27b,A_27b),V3R2),c_2Emin_2E_3D(bool)),ap(ap(ap(c_2Equotient__pred__set_2EGSPECR(A_27a,A_27a),V0R1),V3R2),V6f1)),ap(ap(ap(c_2Equotient__pred__set_2EGSPECR(A_27a,A_27a),V0R1),V3R2),V7f2))) ) ) ) ) ) ) ) ) ) ) ) )).
