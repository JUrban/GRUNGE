...
tff(lamtp_f2015,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => mem(f2015(A_27a,V0f,V2e),arr(ty_2Enum_2Enum,bool)) ) ) )).

tff(lameq_f2015,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ! [V3n: tp__ty_2Enum_2Enum] : ap(f2015(A_27a,V0f,V2e),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(ty_2Enum_2Enum)),ap(V0f,V2e)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3n))) ) ) )).

tff(lmtp_f2014,type,(
    f2014: ( del * $i ) > $i )).

tff(lamtp_f2014,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
     => mem(f2014(A_27a,V0f),arr(A_27a,bool)) ) )).

tff(lameq_f2014,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ap(f2014(A_27a,V0f),V2e) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2015(A_27a,V0f,V2e)) ) ) )).

tff(conj_thm_2Elbtree_2Emmindex__EXISTS,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),f2014(A_27a,V0f)),V1l))
