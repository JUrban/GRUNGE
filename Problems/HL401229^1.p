...
thf(c_2Enumpair_2Ensnd_2E0,type,(
    c_2Enumpair_2Ensnd_2E0: u )).

thf(c_2Enumpair_2Ensnd_2E1,type,(
...
thf(mono_2Ec_2Enumpair_2Ensnd,type,(
    mono_2Ec_2Enumpair_2Ensnd: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Enumpair_2Ensnd__npair,axiom,(
    ! [V0y: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Ensnd @ ( mono_2Ec_2Enumpair_2Enpair @ V1x @ V0y ) )
      = V0y ) )).
...
thf(thm_2Enumpair_2Enpair__cases,axiom,(
    ...
    ? [V1x: mono_2Etyop_2Enum_2Enum,V2y: mono_2Etyop_2Enum_2Enum] :
      ( V0n
      = ( mono_2Ec_2Enumpair_2Enpair @ V1x @ V2y ) ) )).

thf(thm_2Enumpair_2Enpair,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Enpair @ ( mono_2Ec_2Enumpair_2Enfst @ V0n ) @ ( mono_2Ec_2Enumpair_2Ensnd @ V0n ) )
      = V0n ) )).
