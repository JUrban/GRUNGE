...
fof(conj_thm_2Erich__list_2ECOUNT__LIST__AUX__def__compute,conjecture,
    ( ! [V0l] :
        ( mem(V0l,ty_2Elist_2Elist(ty_2Enum_2Enum))
       => ap(ap(c_2Erich__list_2ECOUNT__LIST__AUX,c_2Enum_2E0),V0l) = V0l )
    & ! [V1n] :
       ...
       => ! [V2l] :
            ( mem(V2l,ty_2Elist_2Elist(ty_2Enum_2Enum))
           => ap(ap(c_2Erich__list_2ECOUNT__LIST__AUX,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),V2l) = ap(ap(c_2Erich__list_2ECOUNT__LIST__AUX,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V2l)) ) )
    & ! [V3n] :
        ( mem(V3n,ty_2Enum_2Enum)
       => ! [V4l] :
            ( mem(V4l,ty_2Elist_2Elist(ty_2Enum_2Enum))
           => ap(ap(c_2Erich__list_2ECOUNT__LIST__AUX,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V3n))),V4l) = ap(ap(c_2Erich__list_2ECOUNT__LIST__AUX,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V3n))),ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V3n))),V4l)) ) ) )).
