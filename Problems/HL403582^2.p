...
thf(ax_thm_2Ewellorder_2Efl,axiom,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Ewellorder_2EFL__RESTRICTED__SUBSET,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ( ( ap @ ( c_2Ewellorder_2Efl @ ( arr @ A_27a @ bool ) )
          @ ( ap @ ( c_2Epair_2EUNCURRY @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) @ bool )
            @ ( lam @ ( arr @ A_27a @ bool )
              @ ^ [V1x: $i] :
                  ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2y: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V1x ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V2y ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V1x ) @ V2y ) ) ) ) ) ) )
        = V0P ) ) )).
