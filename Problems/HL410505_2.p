...
tff(conj_thm_2Epred__set_2ESUBSET__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Ereal__topology_2ESPANNING__SUBSET__INDEPENDENT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EIN__SPAN__DELETE,lemma,(
...
tff(conj_thm_2Ereal__topology_2ESPAN__TRANS,lemma,(
...
tff(conj_thm_2Ereal__topology_2EEXCHANGE__LEMMA,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
