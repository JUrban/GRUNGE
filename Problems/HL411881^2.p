...
thf(conj_thm_2Ereal__topology_2ESUBSET__BIGUNION,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__BIGINTER,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESEPARATION__NORMAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ( ( ! [V1s: $i] :
              ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
