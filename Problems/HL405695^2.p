...
thf(conj_thm_2Eordinal_2EordEXP__ADD,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1y: $i] :
         ...
         => ! [V2z: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Eordinal_2Eordlt @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0x ) )
               => ( ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ V0x ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V1y ) @ V2z ) )
                  = ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ V0x ) @ V1y ) ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordEXP @ A_27a ) @ V0x ) @ V2z ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2EordEXP__MUL,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
