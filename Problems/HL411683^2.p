...
thf(conj_thm_2Ebool_2ENOT__AND,lemma,(
    ! [V0t: $o] :
      ~ ( ( p @ ( inj__o @ V0t ) )
        & ~ ( p @ ( inj__o @ V0t ) ) ) )).
...
thf(conj_thm_2Epred__set_2EEXISTS__IN__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27b @ A_27a ) )
...
thf(conj_thm_2Epred__set_2ESUBSET__FINITE__I,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EFUN__IN__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__CLOSED,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECENTRE__IN__CBALL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
      <=> ~ ? [V1e1: $i] :
              ...
              & ? [V2e2: $i] :
                  ...
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V1e1 ) @ V2e2 ) ) @ V0s )
                    = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V1e1 ) @ V0s )
                   != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V2e2 ) @ V0s )
                   != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__IN__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
      <=> ~ ? [V1e1: $i] :
              ...
              & ? [V2e2: $i] :
                  ...
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V1e1 ) @ V2e2 )
                    = V0s )
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V1e1 ) @ V2e2 )
                    = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                  & ( V1e1
                   != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                  & ( V2e2
...
thf(conj_thm_2Ereal__topology_2EREAL__INF__LE__FINITE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__LT__INF__FINITE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CONST,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CONTINUOUS__IMAGE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__MAXIMAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p @ ( ap @ c_2Ereal__topology_2Econnected @ ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V0s ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LOCAL,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__DISCRETE__FINITE__RANGE__CONSTANT__EQ,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ( ( p @ ( ap @ c_2Ereal__topology_2Econnected @ V0s ) )
        <=> ! [V1f: $i] :
             ...
             => ! [V2t: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V1f ) @ V0s ) )
                      ...
                      & ! [V3y: tp__ty_2Erealax_2Ereal] :
                         ...
                         => ( ( ap @ ( ap @ c_2Ereal__topology_2Econnected__component @ V2t ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) )
                            = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V7f ) @ V6s ) )
                     ...
                     => ? [V9e: tp__ty_2Erealax_2Ereal] :
                          ...
                          & ! [V10y: tp__ty_2Erealax_2Ereal] :
                              ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V10y ) ) @ V6s ) )
                                & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V7f @ ( inj__ty_2Erealax_2Ereal @ V10y ) ) )
                                 != ( surj__ty_2Erealax_2Ereal @ ( ap @ V7f @ ( inj__ty_2Erealax_2Ereal @ V8x ) ) ) ) )
               ...
               => ? [V11a: tp__ty_2Erealax_2Ereal] :
                  ! [V12x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V7f @ ( inj__ty_2Erealax_2Ereal @ V12x ) ) )
                      = V11a ) ) ) ) ) )
    & ! [V13s: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V14f ) @ V13s ) )
               ...
               => ? [V15a: tp__ty_2Erealax_2Ereal] :
                  ! [V16x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V14f @ ( inj__ty_2Erealax_2Ereal @ V16x ) ) )
                      = V15a ) ) ) ) ) ) )).
