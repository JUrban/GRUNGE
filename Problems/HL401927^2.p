...
thf(ax_thm_2Ebit_2EMOD__2EXP__EQ__def,axiom,(
    ...
    <=> ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebit_2EMOD__2EXP @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Ebit_2EMOD__2EXP @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V2b ) ) ) ) ) )).
...
thf(conj_thm_2Enumeral__bit_2EMOD__2EXP__EQ,conjecture,
