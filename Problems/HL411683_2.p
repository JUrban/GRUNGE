...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__IN__EQ,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ~ ? [V1e1: $i] :
...
tff(conj_thm_2Ereal__topology_2EREAL__INF__LE__FINITE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EREAL__LT__INF__FINITE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V0s))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__DISCRETE__FINITE__RANGE__CONSTANT__EQ,conjecture,
    ( ! [V0s: $i] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
        <=> ! [V1f: $i] :
