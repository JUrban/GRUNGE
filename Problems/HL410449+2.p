...
fof(conj_thm_2Ereal__topology_2ESUBSPACE__SPAN,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(c_2Ereal__topology_2Esubspace,ap(c_2Ereal__topology_2Espan,V0s))) ) )).

fof(conj_thm_2Ereal__topology_2ESPAN__SUBSPACE,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Ereal__topology_2ESPAN__EQ__SELF,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
