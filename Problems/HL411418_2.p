...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EQ__CONNECTED__COMPONENT__EQ,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EQ__CONNECTED__COMPONENTS__EQ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ! [V1c: $i] :
