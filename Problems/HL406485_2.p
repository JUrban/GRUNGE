...
tff(ax_thm_2Ebitstring_2Ereplicate__def,axiom,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o,V1n: tp__ty_2Enum_2Enum] : surj__c_ty_2Elist_2Elist_o(ap(ap(c_2Ebitstring_2Ereplicate,inj__c_ty_2Elist_2Elist_o(V0v)),inj__ty_2Enum_2Enum(V1n))) = surj__c_ty_2Elist_2Elist_o(ap(c_2Elist_2EFLAT(bool),ap(ap(c_2Elist_2EGENLIST(ty_2Elist_2Elist(bool)),ap(c_2Ecombin_2EK(ty_2Elist_2Elist(bool),ty_2Elist_2Elist(bool)),inj__c_ty_2Elist_2Elist_o(V0v))),inj__ty_2Enum_2Enum(V1n)))) )).

tff(conj_thm_2Ebitstring_2Eshiftl__replicate__F,conjecture,(
