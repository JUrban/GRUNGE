...
thf(tp_c_2EEncode_2Ecollision__free,type,(
    c_2EEncode_2Ecollision__free: $i )).

thf(mem_c_2EEncode_2Ecollision__free,axiom,(
...
thf(ax_thm_2EEncode_2Ecollision__free__def,axiom,(
     ...
     => ( ( p @ ( ap @ ( ap @ c_2EEncode_2Ecollision__free @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V1p ) )
      <=> ! [V2x: tp__ty_2Enum_2Enum,V3y: tp__ty_2Enum_2Enum] :
            ( ( ( p @ ( ap @ V1p @ ( inj__ty_2Enum_2Enum @ V2x ) ) )
              ...
              & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V2x ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V3y ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) ) ) )
           => ( V2x = V3y ) ) ) ) )).
...
thf(conj_thm_2EEncode_2Ewf__pred__bnum,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1p: $i] :
      ( ( mem @ V1p @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ( ( p @ ( ap @ ( ap @ c_2EEncode_2Ewf__pred__bnum @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V1p ) )
       => ( p @ ( ap @ ( ap @ c_2EEncode_2Ecollision__free @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V1p ) ) ) ) )).
