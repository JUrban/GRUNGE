...
thf(thm_2Ecardinal_2ECARD__HAS__SIZE__CONG,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0s: A_27a > $o,V1t: A_27b > $o,V2n: tyop_2Enum_2Enum] :
      ( ( ( c_2Ecardinal_2EHAS__SIZE @ A_27a @ V0s @ V2n )
        & ( c_2Ecardinal_2Ecardeq @ A_27a @ A_27b @ V0s @ V1t ) )
     => ( c_2Ecardinal_2EHAS__SIZE @ A_27b @ V1t @ V2n ) ) )).
