...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__OPEN,conjecture,(
    ...
    <=> ! [V2t: tyop_2Erealax_2Ereal > $o] :
          ( ( ( c_2Ereal__topology_2EOpen @ V2t )
            & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V1x ) @ V2t ) )
         => ? [V3s: tyop_2Erealax_2Ereal > $o] :
              ( ( c_2Ereal__topology_2EOpen @ V3s )
              & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V3s )
              & ! [V4x_27: tyop_2Erealax_2Ereal] :
                  ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x_27 @ V3s )
                 => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V4x_27 ) @ V2t ) ) ) ) ) )).
