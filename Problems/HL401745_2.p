...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__INJ__o,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27b,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27b),V0s))
       => ! [V1g: $i] :
            ( mem(V1g,arr(A_27b,A_27a))
           => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27b,A_27b),V1g),V0s),c_2Epred__set_2EUNIV(A_27a)))
             => ! [V2f: $i] :
                  ( mem(V2f,arr(A_27a,ty_2Enum_2Enum))
                 => surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V1g),V0s))) = surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V2f),V1g)),V0s)) ) ) ) ) ) )).
