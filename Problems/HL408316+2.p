...
fof(conj_thm_2Earithmetic_2EEVEN__DOUBLE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Earithmetic_2EODD__DOUBLE,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(lamtp_f2985,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2985(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
