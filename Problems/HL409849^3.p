...
thf(thm_2Eiterate_2ESUM__DELETE,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o,V2a: A_27a] :
     ...
     => ( ( c_2Eiterate_2ESum @ A_27a @ ( c_2Epred__set_2EDELETE @ A_27a @ V1s @ V2a ) @ V0f )
        = ( c_2Ereal_2Ereal__sub @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) @ ( V0f @ V2a ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__CASES,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1P: A_27a > $o,V2f: A_27a > tyop_2Erealax_2Ereal,V3g: A_27a > tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V0s
          @ ^ [V4x: A_27a] :
              ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( V1P @ V4x ) @ ( V2f @ V4x ) @ ( V3g @ V4x ) ) )
        = ( c_2Erealax_2Ereal__add
          @ ( c_2Eiterate_2ESum @ A_27a
            @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
              @ ^ [V5x: A_27a] :
                  ( c_2Epair_2E_2C @ A_27a @ $o @ V5x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V5x @ V0s ) @ ( V1P @ V5x ) ) ) )
            @ V2f )
          @ ( c_2Eiterate_2ESum @ A_27a
            @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
              @ ^ [V6x: A_27a] :
                  ( c_2Epair_2E_2C @ A_27a @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V6x @ V0s ) @ ( c_2Ebool_2E_7E @ ( V1P @ V6x ) ) ) ) )
            @ V3g ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__CASES__1,conjecture,(
    ! [A_27a: $tType,V0y: tyop_2Erealax_2Ereal,V1f: A_27a > tyop_2Erealax_2Ereal,V2s: A_27a > $o,V3a: A_27a] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        & ( c_2Ebool_2EIN @ A_27a @ V3a @ V2s ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ V2s
          @ ^ [V4x: A_27a] :
              ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ A_27a @ V4x @ V3a ) @ V0y @ ( V1f @ V4x ) ) )
        = ( c_2Erealax_2Ereal__add @ ( c_2Eiterate_2ESum @ A_27a @ V2s @ V1f ) @ ( c_2Ereal_2Ereal__sub @ V0y @ ( V1f @ V3a ) ) ) ) ) )).
