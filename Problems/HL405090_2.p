...
tff(conj_thm_2Efmaptree_2Erelrec__rules,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0h: $i] :
     ...
     => ! [V1i: $i] :
         ...
         => ! [V2fm: $i] :
             ...
             => ! [V3rfm: $i] :
                  ( mem(V3rfm,ty_2Efinite__map_2Efmap(A_27b,A_27b))
                 => ( ( ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V3rfm) = ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V2fm)
                      & ! [V4d: $i] :
                          ( mem(V4d,A_27b)
                         => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V4d),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V2fm)))
                           => p(ap(ap(ap(c_2Efmaptree_2Erelrec(A_27a,A_27a,A_27a),V0h),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V2fm),V4d)),ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V3rfm),V4d))) ) ) )
                   => p(ap(ap(ap(c_2Efmaptree_2Erelrec(A_27a,A_27a,A_27a),V0h),ap(ap(c_2Efmaptree_2EFTNode(A_27b,A_27b),V1i),V2fm)),ap(ap(ap(V0h,V1i),V3rfm),V2fm))) ) ) ) ) ) )).
