...
fof(conj_thm_2Ereal__topology_2ECONNECTED__SING,lemma,(
    ! [V0a] :
    ...
    ! [V0s] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => mem(f3930(V0s,V1x,V2y),arr(arr(ty_2Erealax_2Ereal,bool),bool)) ) ) ) )).

fof(lameq_f3930,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ! [V3t] :
                 ...
                 => ap(f3930(V0s,V1x,V2y),V3t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2Econnected,V3t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3t),V0s)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V3t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V3t)))) ) ) ) ) )).

fof(lamtp_f3929,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => mem(f3929(V0s,V1x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) )).

fof(lameq_f3929,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
              ( mem(V2y,ty_2Erealax_2Ereal)
             => ap(f3929(V0s,V1x),V2y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2y),ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3930(V0s,V1x,V2y))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__SET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3929(V0s,V1x)) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EIN__COMPONENTS,lemma,(
    ! [V0u] :
     ...
     => ! [V1s] :
         ...
         => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1s),ap(c_2Ereal__topology_2Ecomponents,V0u)))
          <=> ? [V2x] :
                ...
                & V1s = ap(ap(c_2Ereal__topology_2Econnected__component,V0u),V2x) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBIGUNION__COMPONENTS,conjecture,(
    ! [V0u] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
