...
fof(mem_c_2EreaderMonad_2EFMAP,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27s] :
              ( ne(A_27s)
             => mem(c_2EreaderMonad_2EFMAP(A_27a,A_27a,A_27a),arr(arr(A_27a,A_27b),arr(arr(A_27s,A_27a),arr(A_27s,A_27b)))) ) ) ) )).
...
fof(mem_c_2EreaderMonad_2EUNIT,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EreaderMonad_2EUNIT(A_27a,A_27a),arr(A_27a,arr(A_27b,A_27a))) ) ) )).
...
fof(conj_thm_2EreaderMonad_2EFMAP__BIND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                 ...
                 => ! [V1M] :
                     ...
                     => ap(ap(c_2EreaderMonad_2EFMAP(A_27c,A_27c,A_27c),V0f),V1M) = ap(ap(c_2EreaderMonad_2EBIND(A_27c,A_27c,A_27c),V1M),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),c_2EreaderMonad_2EUNIT(A_27b,A_27b)),V0f)) ) ) ) ) ) )).
