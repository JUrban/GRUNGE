...
fof(conj_thm_2Elist_2EFRONT__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Erich__list_2EBUTLASTN__SUC__FRONT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),ap(c_2Enum_2ESUC,V0n)),V1l) = ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),ap(c_2Elist_2EFRONT(A_27a),V1l)) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EBUTLASTN__FRONT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),ap(c_2Elist_2EFRONT(A_27a),V1l)) = ap(c_2Elist_2EFRONT(A_27a),ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),V0n),V1l)) ) ) ) ) )).
