...
thf(conj_thm_2Ealignment_2Ealigned__add__sub,lemma,(
...
thf(conj_thm_2Ealignment_2Ealigned__mul__shift__1,lemma,(
...
thf(conj_thm_2Ealignment_2Ealigned__add__sub__prod,conjecture,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( ( mem @ V1w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V2x: $i] :
