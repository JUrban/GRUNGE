...
thf(thm_2Elist_2ELENGTH__EQ__CONS,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ! [V2l_2E0: u] :
          ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) )
            = ( mono_2Ec_2Enum_2ESUC @ V1n ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) )
    <=> ! [V3l_2E0: u] :
          ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l_2E0 ) ) ) )
            = V1n )
         => ! [V4x_2E0: u] :
              ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l_2E0 ) ) ) ) ) ) ) ) )).
