...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__FINITE__RANGE__CONSTANT,conjecture,(
    ! [V0f: $i] :
