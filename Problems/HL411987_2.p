...
tff(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__0,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Emeasure_2EIMAGE__SING,lemma,(
...
tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__unique,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Epos__simple__fn__integral__zero,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
