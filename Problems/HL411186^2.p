...
thf(conj_thm_2Ereal__topology_2ELIM__ADD,lemma,(
    ! [A_27a: del,V0net: $i] :
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5x: $i] :
                                ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V1f @ V5x ) ) @ ( ap @ V2g @ V5x ) ) ) )
                        @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ ( inj__ty_2Erealax_2Ereal @ V4m ) ) )
                      @ V0net ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
               ...
               => ! [V3y: $i] :
                   ...
                   => ( ( ! [V4n: tp__ty_2Enum_2Enum] :
                        ...
                        & ! [V5n: tp__ty_2Enum_2Enum] :
                            ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V3y @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) @ V1s ) )
                        & ( p
                          @ ( ap
                            @ ( ap
                              @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                                @ ( lam @ ty_2Enum_2Enum
                                  @ ^ [V6n: $i] :
                                      ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V2x @ V6n ) ) @ ( ap @ V3y @ V6n ) ) ) )
                        ...
                        @ ( ap
                          @ ( ap
                            @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V7n: $i] :
                                    ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( ap @ V2x @ V7n ) ) ) @ ( ap @ V0f @ ( ap @ V3y @ V7n ) ) ) ) )
                            @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                          @ c_2Ereal__topology_2Esequentially ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ADD,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
