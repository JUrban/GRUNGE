...
tff(conj_thm_2Epath_2Eokpath__take,lemma,(
...
tff(conj_thm_2Epath_2Eokpath__drop,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,arr(A_27a,bool))))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
...
tff(conj_thm_2Epath_2Eokpath__seg,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,arr(A_27a,bool))))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
         => ! [V2i: tp__ty_2Enum_2Enum,V3j: tp__ty_2Enum_2Enum] :
              ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V3j)))
                & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3j)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
                & p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V0R),V1p)) )
             => p(ap(ap(c_2Epath_2Eokpath(A_27a,A_27a),V0R),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V3j)),V1p))) ) ) ) )).
