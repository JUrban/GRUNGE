...
thf(c_2Eind__type_2EINJF_2E2,type,(
    c_2Eind__type_2EINJF_2E2: du > du > u )).

thf(c_2Eind__type_2ENUMFST_2E0,type,(
    c_2Eind__type_2ENUMFST_2E0: u )).

thf(c_2Eind__type_2ENUMFST_2E1,type,(
    c_2Eind__type_2ENUMFST_2E1: du > u )).
...
thf(c_2Eind__type_2ENUMSND_2E0,type,(
    c_2Eind__type_2ENUMSND_2E0: u )).

thf(c_2Eind__type_2ENUMSND_2E1,type,(
    c_2Eind__type_2ENUMSND_2E1: du > u )).
...
thf(mono_2Ec_2Eind__type_2ENUMFST,type,(
    mono_2Ec_2Eind__type_2ENUMFST: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(mono_2Ec_2Eind__type_2ENUMSND,type,(
    mono_2Ec_2Eind__type_2ENUMSND: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq2_2Emono_2Ec_2Eind__type_2EINJF_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Eind__type_2EINJF_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ c_2Eind__type_2EINJF_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).
...
thf(thm_2Eind__type_2ENUMPAIR__DEST,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum,V1y: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eind__type_2ENUMFST @ ( mono_2Ec_2Eind__type_2ENUMPAIR @ V0x @ V1y ) )
        = V0x )
      & ( ( mono_2Ec_2Eind__type_2ENUMSND @ ( mono_2Ec_2Eind__type_2ENUMPAIR @ V0x @ V1y ) )
        = V1y ) ) )).

thf(thm_2Eind__type_2EINJF,axiom,(
    ! [A_27a: d,V0f_2E0: u,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Eind__type_2EINJF_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eind__type_2ENUMFST @ V1x ) ) ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eind__type_2ENUMSND @ V1x ) ) ) ) ) ) )).
