...
thf(conj_thm_2Ebag_2EITBAG__INSERT,lemma,(
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ! [V3acc: $i] :
                  ( ( mem @ V3acc @ A_27b )
                 => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ A_27b ) @ V2f ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1x ) @ V0b ) ) @ V3acc )
                      = ( ap @ ( ap @ ( ap @ ( c_2Ebag_2EITBAG @ A_27a @ A_27b ) @ V2f ) @ ( ap @ ( c_2Ebag_2EBAG__REST @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1x ) @ V0b ) ) ) @ ( ap @ ( ap @ V2f @ ( ap @ ( c_2Ebag_2EBAG__CHOICE @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1x ) @ V0b ) ) ) @ V3acc ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2ECOMMUTING__ITBAG__INSERT,conjecture,(
