...
tff(conj_thm_2Ereal__topology_2EFRONTIER__CBALL,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__FRONTIER,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2Efrontier,V0s))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__SPHERE,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1r: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2Esphere,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1r))))) )).
