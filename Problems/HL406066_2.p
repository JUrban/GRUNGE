...
tff(conj_thm_2Ebit_2EBITSLT__THM,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__SLICE__THM3,lemma,(
    ! [V0b: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ~ p(ap(ap(c_2Ebit_2EBIT,inj__ty_2Enum_2Enum(V0b)),inj__ty_2Enum_2Enum(V1n)))
...
tff(mem_c_2Ewords_2Eword__ge,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__ge(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),bool))) )).
...
tff(lamtp_f2203,axiom,(
    ! [V2n: tp__o] : mem(f2203(V2n),arr(bool,bool)) )).

tff(lameq_f2203,axiom,(
    ! [V2n: tp__o,V5v: tp__o] : ap(f2203(V2n),inj__o(V5v)) = ap(ap(c_2Emin_2E_3D(bool),inj__o(V2n)),inj__o(V5v)) )).

tff(lmtp_f2202,type,(
    f2202: $i )).

tff(lamtp_f2202,axiom,(
    mem(f2202,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

tff(lameq_f2202,axiom,(
    ! [V2n: tp__o] : ap(f2202,inj__o(V2n)) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2203(V2n))))) )).
    ...
    ! [A_27a: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( p(ap(ap(c_2Ewords_2Eword__ge(A_27a),V0a),V1b))
          <=> p(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(bool,bool),ty_2Epair_2Eprod(bool,bool)),ap(c_2Epair_2EUNCURRY(bool,bool,bool),f2202)),ap(ap(c_2Ewords_2Enzcv(A_27a),V0a),V1b))) ) ) ) )).
...
tff(conj_thm_2Ewords_2EWORD__EQ__SUB__RADD,lemma,(
    ! [A_27a: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__NEG__SUB,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1v: $i] :
...
tff(conj_thm_2Ewords_2ETWO__COMP__POS__NEG,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__GREATER__EQ,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
