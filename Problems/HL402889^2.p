...
thf(conj_thm_2Erich__list_2Eel__map__count,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1f: $i] :
     ...
     => ! [V2m: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ty_2Enum_2Enum @ A_27a ) @ V1f ) @ ( ap @ c_2Erich__list_2ECOUNT__LIST @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) )
