...
thf(conj_thm_2Ereal__topology_2ELIM__CMUL__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
                  ...
                  @ ( ap
                    @ ( ap
                      @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V4x: $i] :
                              ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) @ ( ap @ V1f @ V4x ) ) ) )
                      @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) )
                    @ V0net ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__EQ,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
