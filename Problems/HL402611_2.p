...
tff(conj_thm_2Erich__list_2EALL__EL__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( p(ap(ap(c_2Elist_2EEVERY(A_27a),V0P),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l)))
              <=> p(ap(ap(c_2Elist_2EEVERY(A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V0P),V1f)),V2l)) ) ) ) ) )).
