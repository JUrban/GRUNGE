...
fof(conj_thm_2Elist_2ELENGTH__UNZIP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0pl] :
              ( mem(V0pl,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
             => ( ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EUNZIP(A_27a,A_27a),V0pl))) = ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),V0pl)
                & ap(c_2Elist_2ELENGTH(A_27b),ap(c_2Epair_2ESND(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),ap(c_2Elist_2EUNZIP(A_27a,A_27a),V0pl))) = ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),V0pl) ) ) ) ) )).
