...
thf(tp_c_2Ebag_2EPSUB__BAG,type,(
    c_2Ebag_2EPSUB__BAG: del > $i )).

thf(mem_c_2Ebag_2EPSUB__BAG,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ebag_2EPSUB__BAG__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
...
thf(conj_thm_2Ebag_2EPSUB__BAG__CARD,lemma,(
    ! [A_27a: del,V0b1: $i] :
...
thf(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,conjecture,(
    ! [A_27a: del,V0P: $i] :
