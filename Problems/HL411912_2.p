...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__EMPTY,lemma,
    ( ! [V0t: $i] :
        ( mem(V0t,arr(ty_2Erealax_2Ereal,bool))
       => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)),V0t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
    & ! [V1s: $i] :
        ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
       => surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V1s),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
...
tff(conj_thm_2Ereal__topology_2EHAUSDIST__EQ__0,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
              & p(ap(c_2Ereal__topology_2Ebounded__def,V1t)) )
           => ( surj__ty_2Erealax_2Ereal(ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
            <=> ( V0s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                | V1t = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                | ap(c_2Ereal__topology_2Eclosure,V0s) = ap(c_2Ereal__topology_2Eclosure,V1t) ) ) ) ) ) )).
