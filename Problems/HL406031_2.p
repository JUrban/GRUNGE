...
tff(conj_thm_2Ewords_2Eword__T,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum] :
     ...
     => p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),c_2Ewords_2Eword__T(A_27a)),inj__ty_2Enum_2Enum(V0i))) ) )).

tff(conj_thm_2Ewords_2Eword__asr,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
