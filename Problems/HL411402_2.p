...
tff(conj_thm_2Ereal__topology_2ECONNECTED__SING,lemma,(
...
tff(lmtp_f3930,type,(
    f3930: ( $i * tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3930,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : mem(f3930(V0s,V1x,V2y),arr(arr(ty_2Erealax_2Ereal,bool),bool)) ) )).

tff(lameq_f3930,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3t: $i] :
          ( mem(V3t,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3930(V0s,V1x,V2y),V3t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2Econnected,V3t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3t),V0s)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V3t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),V3t)))) ) ) )).

tff(lmtp_f3929,type,(
    f3929: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3929,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : mem(f3929(V0s,V1x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3929,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : ap(f3929(V0s,V1x),inj__ty_2Erealax_2Ereal(V2y)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3930(V0s,V1x,V2y))) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__SET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3929(V0s,V1x)) ) )).
...
tff(conj_thm_2Ereal__topology_2EIN__COMPONENTS,lemma,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1s),ap(c_2Ereal__topology_2Ecomponents,V0u)))
          <=> ? [V2x: tp__ty_2Erealax_2Ereal] :
                ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0u))
                & V1s = ap(ap(c_2Ereal__topology_2Econnected__component,V0u),inj__ty_2Erealax_2Ereal(V2x)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBIGUNION__COMPONENTS,conjecture,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
