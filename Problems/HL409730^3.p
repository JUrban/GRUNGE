      ...
      ( ! [V3x: A_27a,V4y: A_27a] :
          ( ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V2s )
            ...
            & ( ( V0f @ V3x )
              = ( V0f @ V4y ) ) )
         => ( V3x = V4y ) )
     => ( ( c_2Eiterate_2Ensum @ A_27b @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ V2s ) @ V1g )
        = ( c_2Eiterate_2Ensum @ A_27a @ V2s @ ( c_2Ecombin_2Eo @ A_27a @ tyop_2Enum_2Enum @ A_27b @ V1g @ V0f ) ) ) ) )).
