...
thf(thm_2Eordinal_2Eomax__EMPTY,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Eordinal_2Eomax @ A_27a @ ( c_2Epred__set_2EEMPTY @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) )
      = ( c_2Eoption_2ENONE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) )).

thf(thm_2Eordinal_2Epreds__0,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Eordinal_2Epreds @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) )
...
thf(thm_2Eordinal_2Eadd__omega__islimit,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eomax @ A_27a @ ( c_2Eordinal_2Epreds @ A_27a @ ( c_2Eordinal_2EordADD @ A_27a @ V0a @ ( c_2Eordinal_2Eomega @ A_27a ) ) ) )
      = ( c_2Eoption_2ENONE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) )).
...
thf(thm_2Eordinal_2Emul__omega__islimit,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eomax @ A_27a @ ( c_2Eordinal_2Epreds @ A_27a @ ( c_2Eordinal_2EordMULT @ A_27a @ ( c_2Eordinal_2Eomega @ A_27a ) @ V0a ) ) )
      = ( c_2Eoption_2ENONE @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) )).
