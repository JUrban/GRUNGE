...
tff(conj_thm_2Eextreal_2Eadd__not__infty,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
      ( ( ( V0x != fo__c_2Eextreal_2ENegInf
          & V1y != fo__c_2Eextreal_2ENegInf )
       => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(V1y))) != fo__c_2Eextreal_2ENegInf )
      & ( ( V0x != fo__c_2Eextreal_2EPosInf
          & V1y != fo__c_2Eextreal_2EPosInf )
       => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(V1y))) != fo__c_2Eextreal_2EPosInf ) ) )).
...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__POS__INF,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
