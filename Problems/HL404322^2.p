...
thf(conj_thm_2Ering_2Eplus__assoc,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( ty_2Ering_2Ering @ A_27a ) )
     => ( ( p @ ( ap @ ( c_2Ering_2Eis__ring @ A_27a ) @ V0r ) )
       => ! [V1n: $i] :
           ...
           => ! [V2m: $i] :
               ...
               => ! [V3p: $i] :
                    ( ( mem @ V3p @ A_27a )
                   => ( ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V0r ) @ V1n ) @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V0r ) @ V2m ) @ V3p ) )
                      = ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V0r ) @ ( ap @ ( ap @ ( ap @ ( c_2Ering_2Ering__RP @ A_27a ) @ V0r ) @ V1n ) @ V2m ) ) @ V3p ) ) ) ) ) ) ) )).
