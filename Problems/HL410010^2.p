...
thf(stp_fo_c_2Eextreal_2EQ__set,type,(
    fo__c_2Eextreal_2EQ__set: tp__ty_2Eextreal_2Eextreal > $o )).

thf(stp_eq_fo_c_2Eextreal_2EQ__set,axiom,(
    ! [X0: tp__ty_2Eextreal_2Eextreal] :
      ( ( inj__o @ ( fo__c_2Eextreal_2EQ__set @ X0 ) )
      = ( ap @ c_2Eextreal_2EQ__set @ ( inj__ty_2Eextreal_2Eextreal @ X0 ) ) ) )).
...
thf(ax_thm_2Eextreal_2EQ__set__def,axiom,
    ( c_2Eextreal_2EQ__set
    = ( ap
      @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Eextreal_2Eextreal )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Eextreal_2Eextreal @ ty_2Eextreal_2Eextreal )
          @ ( lam @ ty_2Eextreal_2Eextreal
            @ ^ [V0x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Eextreal_2Eextreal @ bool ) @ V0x )
                @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V1a: $i] :
                        ...
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V2b: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Eextreal_2Eextreal ) @ V0x ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__div @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V1a ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V2b ) ) ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V2b ) ) ) ) ) ) ) ) ) ) )
      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Eextreal_2Eextreal @ ty_2Eextreal_2Eextreal )
        @ ( lam @ ty_2Eextreal_2Eextreal
          @ ^ [V3x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Eextreal_2Eextreal @ bool ) @ V3x )
              @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4a: $i] :
                      ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
...
thf(conj_thm_2Ereal_2EREAL__NEG__EQ0,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EREAL__INV__EQ__0,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EREAL__LT__NZ,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Eextreal_2EINV__IN__Q,conjecture,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
      ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) @ c_2Eextreal_2EQ__set ) )
        & ( V0x
         != ( surj__ty_2Eextreal_2Eextreal @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
     => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__div @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) ) @ c_2Eextreal_2EQ__set ) ) ) )).
