...
fof(thm_2Equotient_2ERIGHT__RES__EXISTS__REGULAR,conjecture,(
    ! [A_27a,V0P_2E0,V1R_2E0,V2Q_2E0] :
     ...
     => ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2E_3F_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0))))
       => p(s(tyop_2Emin_2Ebool,c_2Ebool_2ERES__EXISTS_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1R_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2Q_2E0)))) ) ) )).
