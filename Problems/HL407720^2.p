...
thf(conj_thm_2Emetric_2EMETRIC__SYM,lemma,(
    ! [A_27a: del,V0m: $i] :
...
thf(conj_thm_2Emetric_2EMTOP__OPEN,lemma,(
    ! [A_27a: del,V0S_27: $i] :
    ...
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2e: tp__ty_2Erealax_2Ereal] :
              ...
              = ( lam @ A_27a
                @ ^ [V3y: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ ( ap @ ( c_2Emetric_2Edist @ A_27a ) @ V0m ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V1x ) @ V3y ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) ) ) ) ) )).

thf(conj_thm_2Emetric_2EBALL__NEIGH,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Emetric_2Emetric @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(ax_thm_2Etopology_2Eneigh,axiom,(
    ! [A_27a: del,V0top: $i] :
...
thf(conj_thm_2Enets_2EMTOP__TENDS,conjecture,(
