...
thf(conj_thm_2Epred__set_2EINJ__IMAGE__BIJ,lemma,(
...
thf(conj_thm_2Epred__set_2EBIJ__SYM__IMP,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Epred__set_2EBIJ__TRANS,lemma,(
...
thf(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN__AUTO,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
