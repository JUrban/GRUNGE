...
fof(lameq_f891,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V3t] :
              ( mem(V3t,ty_2Enum_2Enum)
             => ap(f891(V0a,V1b),V3t) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V0a,V3t)),ap(V1b,V3t)) ) ) ) )).

fof(lamtp_f890,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f890,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
              ( mem(V2t,ty_2Enum_2Enum)
             => ap(f890(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V1b),f891(V0a,V1b)),V2t)),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESUNTIL__AS__WHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
