...
fof(conj_thm_2Ereal__topology_2ESERIES__BOUND,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
...
fof(conj_thm_2Ereal__topology_2ESUMMABLE__COMPARISON,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
                  ...
                  & ? [V3N] :
                      ...
                      & ! [V4n] :
                         ...
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V4n),V3N))
                              & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4n),V2s)) )
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,V4n))),ap(V1g,V4n))) ) ) ) )
               => p(ap(ap(c_2Ereal__topology_2Esummable,V2s),V0f)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__COMPARISON__BOUND,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2s] :
             ...
             => ! [V3a] :
                  ( mem(V3a,ty_2Erealax_2Ereal)
                 => ( ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V1g),V3a),V2s))
                      & ! [V4i] :
                          ( mem(V4i,ty_2Enum_2Enum)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4i),V2s))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,V4i))),ap(V1g,V4i))) ) ) )
                   => ? [V5l] :
                        ( mem(V5l,ty_2Erealax_2Ereal)
                        & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V5l),V2s))
                        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V5l)),V3a)) ) ) ) ) ) ) )).
