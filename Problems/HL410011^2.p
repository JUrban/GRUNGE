...
thf(conj_thm_2Eextreal_2EQ__COUNTABLE,lemma,(
    p @ ( ap @ ( c_2Epred__set_2Ecountable @ ty_2Eextreal_2Eextreal ) @ c_2Eextreal_2EQ__set ) )).

thf(conj_thm_2Eextreal_2ENUM__IN__Q,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ c_2Eextreal_2EQ__set ) )
      & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ ( ap @ c_2Eextreal_2Eextreal__ainv @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ c_2Eextreal_2EQ__set ) ) ) )).

thf(conj_thm_2Eextreal_2EQ__INFINITE,lemma,(
    ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Eextreal_2Eextreal ) @ c_2Eextreal_2EQ__set ) ) )).
...
thf(conj_thm_2Epred__set_2EINSERT__SING__UNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Epred__set_2EBIJ__INV,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EINFINITE__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2Ecountable__EMPTY,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) )).

thf(conj_thm_2Epred__set_2ECOUNTABLE__ALT__BIJ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eextreal_2ECOUNTABLE__ENUM__Q,conjecture,(
    ! [A_27a: del,V0c: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ A_27a ) @ V0c ) )
      <=> ( ( V0c
          ...
          | ? [V1f: $i] :
              ( ( mem @ V1f @ ( arr @ ty_2Eextreal_2Eextreal @ A_27a ) )
              & ( V0c
                = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Eextreal_2Eextreal @ A_27a ) @ V1f ) @ c_2Eextreal_2EQ__set ) ) ) ) ) ) )).
