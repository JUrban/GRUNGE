...
fof(conj_thm_2Ebitstring_2Efixwidth__id__imp,lemma,(
    ! [V0n] :
...
fof(conj_thm_2Ebitstring_2Efield__fixwidth,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ebitstring_2Efield__id__imp,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1v] :
          ( mem(V1v,ty_2Elist_2Elist(bool))
