...
thf(thm_2Estring_2EisPREFIX__IND,conjecture,(
    ! [V0P: ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > $o] :
      ( ! [V1s1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V2s2: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
          ( ! [V3c: tyop_2Estring_2Echar,V4t1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V5t2: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
              ( ( ( ( c_2Estring_2EDEST__STRING @ V1s1 )
                  = ( c_2Eoption_2ESOME @ ( tyop_2Epair_2Eprod @ tyop_2Estring_2Echar @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) ) @ ( c_2Epair_2E_2C @ tyop_2Estring_2Echar @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ V3c @ V4t1 ) ) )
                & ( ( c_2Estring_2EDEST__STRING @ V2s2 )
                  = ( c_2Eoption_2ESOME @ ( tyop_2Epair_2Eprod @ tyop_2Estring_2Echar @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) ) @ ( c_2Epair_2E_2C @ tyop_2Estring_2Echar @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ V3c @ V5t2 ) ) ) )
             => ( V0P @ V4t1 @ V5t2 ) )
         => ( V0P @ V1s1 @ V2s2 ) )
     => ! [V6v: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V7v1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
          ( V0P @ V6v @ V7v1 ) ) )).
