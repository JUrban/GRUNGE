...
fof(lamtp_f2911,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f2911(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V3x] :
             ...
             => ap(f2911(V0f,V1g),V3x) = ap(ap(c_2Ereal_2E_2F,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).

fof(conj_thm_2Elim_2ECONT__DIV,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x] :
             ...
             => ( ( p(ap(ap(c_2Elim_2Econtl,V0f),V2x))
               ...
               => p(ap(ap(c_2Elim_2Econtl,f2911(V0f,V1g)),V2x)) ) ) ) ) )).
