...
tff(conj_thm_2Ewellorder_2Etransitive__rrestrict,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Eset__relation_2Etransitive(A_27a),V0r))
           => p(ap(c_2Eset__relation_2Etransitive(A_27a),ap(ap(c_2Eset__relation_2Errestrict(A_27a),V0r),V1s))) ) ) ) )).

tff(conj_thm_2Ewellorder_2Eantisym__rrestrict,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Eset__relation_2Eantisym(A_27a),V0r))
           => p(ap(c_2Eset__relation_2Eantisym(A_27a),ap(ap(c_2Eset__relation_2Errestrict(A_27a),V0r),V1s))) ) ) ) )).

tff(conj_thm_2Ewellorder_2Elinear__order__rrestrict,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
