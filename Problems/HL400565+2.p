...
fof(conj_thm_2Epair_2EUNCURRY__CONG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f_27] :
                 ...
                 => ! [V1f] :
                     ...
                     => ! [V2M_27] :
                          ( mem(V2M_27,ty_2Epair_2Eprod(A_27a,A_27a))
                         => ! [V3M] :
                              ( mem(V3M,ty_2Epair_2Eprod(A_27a,A_27a))
                             => ( ( V3M = V2M_27
                                  & ! [V4x] :
                                      ( mem(V4x,A_27a)
                                     => ! [V5y] :
                                          ( mem(V5y,A_27b)
                                         => ( V2M_27 = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),V5y)
                                           => ap(ap(V1f,V4x),V5y) = ap(ap(V0f_27,V4x),V5y) ) ) ) )
                               => ap(ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),V1f),V3M) = ap(ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),V0f_27),V2M_27) ) ) ) ) ) ) ) ) )).
