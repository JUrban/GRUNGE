...
thf(f9420_0_2E0,type,(
    f9420_0_2E0: u )).

thf(f9420_0_2E1,type,(
    f9420_0_2E1: du > u )).

thf(f9420_0_2E2,type,(
    f9420_0_2E2: du > du > u )).
...
thf(mono_2Ef9420_0,type,(
    mono_2Ef9420_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eseq_2ESEQ__NEG__CONV,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9420_0 @ V0f @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0f @ V1n ) ) ) )).

thf(thm_2Eseq_2ESEQ__NEG__CONV,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Econvergent @ V0f )
      = ( mono_2Ec_2Eseq_2Econvergent @ ( mono_2Ef9420_0 @ V0f ) ) ) )).
