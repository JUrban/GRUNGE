...
tff(conj_thm_2Equotient_2ELET__RES__ABSTRACT,conjecture,(
    ! [A_27a: del,A_27b: del,V0r: $i] :
      ( mem(V0r,arr(A_27a,bool))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(A_27a,A_27b))
         => ! [V2v: $i] :
              ( mem(V2v,A_27a)
             => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2v),V0r))
               => ap(ap(c_2Ebool_2ELET(A_27a,A_27a),ap(ap(c_2Ebool_2ERES__ABSTRACT(A_27a,A_27a),V0r),V1lam)),V2v) = ap(ap(c_2Ebool_2ELET(A_27a,A_27a),V1lam),V2v) ) ) ) ) )).
