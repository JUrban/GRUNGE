...
tff(conj_thm_2Eprobability_2Edistribution__lebesgue__thm2,conjecture,(
    ! [A_27a: del,A_27b: del,V0X: $i] :
      ( mem(V0X,arr(A_27a,A_27b))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2s: $i] :
             ...
             => ! [V3A: $i] :
                 ...
                 => ( ( p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),V2s))
                   ...
                   => surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2ENormal,ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),V3A))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27b),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Espace(A_27b),V2s)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27b),V2s)),ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X)))),ap(c_2Emeasure_2Eindicator__fn(A_27b),V3A))) ) ) ) ) ) )).
