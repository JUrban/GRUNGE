...
fof(conj_thm_2Ereal__topology_2EDIAMETER__SUMS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__COMPACT__SUMS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DIAMETER,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
           ...
           => ? [V2d] :
                ...
                & ! [V3t] :
                   ...
                   => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V3t))
                        ...
                        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V3t))),V2d)) )
                     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal__topology_2Ediameter,V0s)),ap(c_2Ereal__topology_2Ediameter,V3t)))),V1e)) ) ) ) ) ) ) )).
