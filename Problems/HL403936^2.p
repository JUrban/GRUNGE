...
thf(conj_thm_2Ellist_2ELAPPEND__NIL__2ND,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0ll ) @ ( c_2Ellist_2ELNIL @ A_27a ) )
        = V0ll ) ) )).
...
thf(conj_thm_2Ellist_2ELFINITE__APPEND,lemma,(
    ! [A_27a: del,V0ll1: $i] :
...
thf(conj_thm_2Ellist_2ELLENGTH__APPEND,lemma,(
    ! [A_27a: del,V0ll1: $i] :
      ( ( mem @ V0ll1 @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1ll2: $i] :
          ( ( mem @ V1ll2 @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0ll1 ) @ V1ll2 ) ) )
            = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll1 ) ) @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V1ll2 ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( c_2Eoption_2ETHE @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0ll1 ) ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V1ll2 ) ) ) ) ) @ ( c_2Eoption_2ENONE @ ty_2Enum_2Enum ) ) ) ) ) ) )).

thf(ax_thm_2Ellist_2EtoList,axiom,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ap @ ( c_2Ellist_2EtoList @ A_27a ) @ V0ll )
        = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ( ty_2Elist_2Elist @ A_27a ) ) ) @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0ll ) ) ) @ V0ll ) ) @ ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELTAKE__LAPPEND2,lemma,(
...
thf(conj_thm_2Ellist_2ELTAKE__LENGTH,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2l ) )
           => ( V0n
              = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V2l ) ) ) ) ) ) )).

thf(conj_thm_2Ellist_2ELTAKE__LLENGTH__NONE,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2m: tp__ty_2Enum_2Enum] :
          ( ( ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0ll ) )
              = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
            & ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ V0ll )
            = ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2EtoList__LAPPEND__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
     ...
     => ! [V1l2: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ( ( ( ap @ ( c_2Ellist_2EtoList @ A_27a ) @ ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ V0l1 ) @ V1l2 ) )
                  = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2x ) )
               => ( V2x
                  = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2EtoList @ A_27a ) @ V0l1 ) ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2EtoList @ A_27a ) @ V1l2 ) ) ) ) ) ) ) ) )).
