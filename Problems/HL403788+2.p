    ...
    ! [A_27a,V3h] :
     ...
     => ! [V4t] :
         ...
         => ! [V5n] :
             ...
             => ap(f1161(A_27a,V3h,V4t),V5n) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V5n),c_2Enum_2E0)),ap(c_2Eoption_2ESOME(A_27a),V3h)),ap(V4t,ap(ap(c_2Earithmetic_2E_2D,V5n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) )).

fof(conj_thm_2Ellist_2Elrep__ok__coind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0lrep__ok_27] :
