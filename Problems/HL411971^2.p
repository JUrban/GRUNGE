...
thf(conj_thm_2Eextreal_2Ele__mul,lemma,(
...
thf(conj_thm_2Eextreal_2Emul__assoc,lemma,(
...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__cmul,conjecture,(
    ! [A_27a: del,V0s: $i] :
                                          ...
                                          @ ( ap
                                            @ ( ap
                                              @ ( ap @ ( ap @ ( c_2Emeasure_2Epos__simple__fn @ A_27a ) @ V3m )
                                                @ ( lam @ A_27a
                                                  @ ^ [V9t: $i] :
                                                      ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) @ ( ap @ V4f @ V9t ) ) ) )
                                              @ V6s_27 )
                                            @ V7a_27 )
                                          @ V8x_27 ) ) ) ) ) ) ) ) ) ) ) )).
