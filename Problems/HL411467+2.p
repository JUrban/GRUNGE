...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__WITHIN__INV,lemma,(
    ! [V0f] :
     ...
     => ! [V1s] :
         ...
         => ! [V2a] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2a)),V1s)))
                  & ap(V0f,V2a) != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) )
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),c_2Erealax_2Einv),V0f)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2a)),V1s))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__INV,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V1a)))
              & ap(V0f,V1a) != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),c_2Erealax_2Einv),V0f)),ap(c_2Ereal__topology_2Eat,V1a))) ) ) ) )).
