...
tff(conj_thm_2Ereal_2EREAL__LE__SUP,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ? [V2y: tp__ty_2Erealax_2Ereal] : p(ap(V0p,inj__ty_2Erealax_2Ereal(V2y)))
            & ? [V3y: tp__ty_2Erealax_2Ereal] :
              ! [V4z: tp__ty_2Erealax_2Ereal] :
                ( p(ap(V0p,inj__ty_2Erealax_2Ereal(V4z)))
               => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V4z)),inj__ty_2Erealax_2Ereal(V3y))) ) )
         => ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),ap(c_2Ereal_2Esup,V0p)))
          <=> ! [V5y: tp__ty_2Erealax_2Ereal] :
                ( ! [V6z: tp__ty_2Erealax_2Ereal] :
                    ( p(ap(V0p,inj__ty_2Erealax_2Ereal(V6z)))
                   => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V6z)),inj__ty_2Erealax_2Ereal(V5y))) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V5y))) ) ) ) ) )).
