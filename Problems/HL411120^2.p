...
thf(conj_thm_2Ereal__topology_2ECOMPACT__CHAIN,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__NEST,conjecture,(
    ! [V0s: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ...
              & ( ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V1n ) )
               != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )
       ...
       => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ty_2Enum_2Enum )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4n: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ V0s @ V4n ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ V4n ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) )
         != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
