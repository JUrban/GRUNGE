...
thf(c_2Epath_2Epgenerate,type,(
    c_2Epath_2Epgenerate: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( tyop_2Enum_2Enum > A_27a ) > ( tyop_2Enum_2Enum > A_27b ) > ( tyop_2Epath_2Epath @ A_27a @ A_27b ) ) )).
...
thf(thm_2Epath_2Epgenerate__infinite,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0f: tyop_2Enum_2Enum > A_27a,V1g: tyop_2Enum_2Enum > A_27b] :
      ( (~) @ ( c_2Epath_2Efinite @ A_27a @ A_27b @ ( c_2Epath_2Epgenerate @ A_27a @ A_27b @ V0f @ V1g ) ) ) )).
    ...
    <=> ( (~)
        @ ? [V1f: tyop_2Enum_2Enum > A_27a] :
          ! [V2n: tyop_2Enum_2Enum] :
            ( V0R @ ( V1f @ ( c_2Enum_2ESUC @ V2n ) ) @ ( V1f @ V2n ) ) ) ) )).
...
thf(thm_2Epath_2Efinite__paths__SN,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0R: A_27a > A_27b > A_27a > $o] :
