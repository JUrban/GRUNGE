...
thf(conj_thm_2Erealax_2ETREAL__EQ__AP,lemma,(
    ! [V0p: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V1q: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( ( V0p = V1q )
     => ( p @ ( ap @ ( ap @ c_2Erealax_2Etreal__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0p ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V1q ) ) ) ) )).

thf(conj_thm_2Erealax_2ETREAL__LDISTRIB,lemma,(
    ! [V0x: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V1y: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V2z: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Erealax_2Etreal__mul @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) @ ( ap @ ( ap @ c_2Erealax_2Etreal__add @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V1y ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V2z ) ) ) )
      = ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Erealax_2Etreal__add @ ( ap @ ( ap @ c_2Erealax_2Etreal__mul @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V1y ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Etreal__mul @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V2z ) ) ) ) ) )).

thf(conj_thm_2Erealax_2ETREAL__ADD__WELLDEF,lemma,(
...
thf(conj_thm_2Erealax_2ETREAL__MUL__WELLDEF,lemma,(
    ! [V0x1: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V1x2: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V2y1: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal,V3y2: tp__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Etreal__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V0x1 ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V1x2 ) ) )
        & ( p @ ( ap @ ( ap @ c_2Erealax_2Etreal__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V2y1 ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ V3y2 ) ) ) )
...
thf(ax_thm_2Erealax_2Ereal__add,axiom,(
    ! [V0T1: tp__ty_2Erealax_2Ereal,V1T2: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) @ ( inj__ty_2Erealax_2Ereal @ V1T2 ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__ABS @ ( ap @ ( ap @ c_2Erealax_2Etreal__add @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) ) @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V1T2 ) ) ) ) ) ) )).

thf(ax_thm_2Erealax_2Ereal__mul,axiom,(
    ! [V0T1: tp__ty_2Erealax_2Ereal,V1T2: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) @ ( inj__ty_2Erealax_2Ereal @ V1T2 ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__ABS @ ( ap @ ( ap @ c_2Erealax_2Etreal__mul @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) ) @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V1T2 ) ) ) ) ) ) )).

thf(conj_thm_2Erealax_2EREAL__LDISTRIB,conjecture,(
