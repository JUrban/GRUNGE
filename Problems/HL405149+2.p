...
fof(conj_thm_2Ebag_2EPSUB__BAG__REST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
...
fof(conj_thm_2Ebag_2EPSUB__BAG__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
...
fof(lamtp_f2085,axiom,(
    ! [A_27a,A_27a] : mem(f2085(A_27a,A_27a),arr(arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool)),bool)) )).
...
fof(lamtp_f2088,axiom,(
    ! [A_27a,A_27a,V2BAG__TO__LIST] :
...
fof(lamtp_f2087,axiom,(
    ! [A_27a,A_27a,A_27a] : mem(f2087(A_27a,A_27a,A_27a),arr(arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)),arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))) )).

fof(lameq_f2087,axiom,(
    ! [A_27a,A_27a,A_27a,V2BAG__TO__LIST] :
      ( mem(V2BAG__TO__LIST,arr(arr(A_27a,ty_2Enum_2Enum),ty_2Elist_2Elist(A_27a)))
...
fof(ax_thm_2Econtainer_2EBAG__TO__LIST__primitive__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Econtainer_2EBAG__TO__LIST(A_27a) = ap(ap(c_2Erelation_2EWFREC(arr(A_27a,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)),ap(c_2Emin_2E_40(arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),bool))),f2085(A_27a,A_27a))),f2087(A_27a,A_27a,A_27a)) ) )).

fof(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
