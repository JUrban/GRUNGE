...
thf(f4899_0_2E0,type,(
    f4899_0_2E0: u )).

thf(f4899_0_2E1,type,(
    f4899_0_2E1: du > u )).

thf(f4899_0_2E2,type,(
    f4899_0_2E2: du > du > u )).

thf(f4899_1_2E0,type,(
    f4899_1_2E0: u )).

thf(f4899_1_2E1,type,(
    f4899_1_2E1: du > u )).

thf(f4899_1_2E2,type,(
    f4899_1_2E2: du > du > u )).
...
thf(mono_2Ef4899_0,type,(
    mono_2Ef4899_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef4899_1,type,(
    mono_2Ef4899_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2EPast__Temporal__Logic_2ENO__PAST__EVENT,axiom,(
    ! [V2a: mono_2Etyop_2Enum_2Enum > $o,V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4899_1 @ V2a @ V4t )
    <=> ( (~) @ ( V2a @ V4t ) ) ) )).

thf(def1_2Ethm_2EPast__Temporal__Logic_2ENO__PAST__EVENT,axiom,(
    ! [V1b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4899_0 @ V1b @ V3t )
    <=> ( (~) @ ( V1b @ V3t ) ) ) )).

thf(thm_2EPast__Temporal__Logic_2ENO__PAST__EVENT,conjecture,(
    ! [V0t: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum > $o,V2a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2EPast__Temporal__Logic_2EPALWAYS @ ( mono_2Ef4899_0 @ V1b ) @ V0t )
     => ( ( ( mono_2Ec_2EPast__Temporal__Logic_2EPWHEN @ V2a @ V1b @ V0t )
          = mono_2Ec_2Ebool_2ET )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V1b @ V0t )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPALWAYS @ V2a @ V0t ) )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPBEFORE @ V2a @ V1b @ V0t )
          = mono_2Ec_2Ebool_2ET )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPBEFORE @ V1b @ V2a @ V0t )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPALWAYS @ ( mono_2Ef4899_1 @ V2a ) @ V0t ) )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSWHEN @ V2a @ V1b @ V0t )
          = mono_2Ec_2Ebool_2EF )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V1b @ V0t )
          = mono_2Ec_2Ebool_2EF )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V2a @ V1b @ V0t )
          = ( mono_2Ec_2EPast__Temporal__Logic_2EPEVENTUAL @ V2a @ V0t ) )
        & ( ( mono_2Ec_2EPast__Temporal__Logic_2EPSBEFORE @ V1b @ V2a @ V0t )
          = mono_2Ec_2Ebool_2EF ) ) ) )).
