...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__CONSTANT__ON__CLOSURE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AGREE__ON__CLOSURE,conjecture,(
    ! [V0s] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1g),ap(c_2Ereal__topology_2Eclosure,V0s)))
                  ...
                  & ! [V3x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V0s))
                       => ap(V1g,V3x) = ap(V2h,V3x) ) ) )
               => ! [V4x] :
                    ( mem(V4x,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),ap(c_2Ereal__topology_2Eclosure,V0s)))
                     => ap(V1g,V4x) = ap(V2h,V4x) ) ) ) ) ) ) )).
