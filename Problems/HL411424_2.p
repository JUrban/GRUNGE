...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING__EXISTS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ? [V1a: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__EQ__COMPONENTS__SUBSET__SING__EXISTS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ? [V1a: $i] :
