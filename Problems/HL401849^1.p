...
thf(thm_2Epred__set_2EIN__INSERT__EXPAND,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u,V2P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EINSERT_2E2 @ ( s @ A_27a @ V1y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2P_2E0 ) ) ) ) ) )
    <=> ( ( ( s @ A_27a @ V0x_2E0 )
          = ( s @ A_27a @ V1y_2E0 ) )
        | ( ( (~)
            @ ( ( s @ A_27a @ V0x_2E0 )
