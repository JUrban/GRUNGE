...
tff(conj_thm_2EordinalNotation_2Edecompose__plus,lemma,(
    ! [V0e: tp__ty_2EordinalNotation_2Eosyntax,V1k: tp__ty_2Enum_2Enum,V2t: tp__ty_2EordinalNotation_2Eosyntax] :
      ( p(ap(c_2EordinalNotation_2Eis__ord,ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V0e)),inj__ty_2Enum_2Enum(V1k)),inj__ty_2EordinalNotation_2Eosyntax(V2t))))
     => ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V0e)))
        & V0e != surj__ty_2EordinalNotation_2Eosyntax(ap(c_2EordinalNotation_2EEnd,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
        ...
        & p(ap(ap(c_2EordinalNotation_2Eoless,ap(c_2EordinalNotation_2Eexpt,inj__ty_2EordinalNotation_2Eosyntax(V2t))),inj__ty_2EordinalNotation_2Eosyntax(V0e))) ) ) )).

tff(conj_thm_2EordinalNotation_2Eis__ord__equations,conjecture,(
