...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__INTERMEDIATE__SUBSET,lemma,(
    ! [V0t: $i] :
     ...
     => ! [V1u: $i] :
         ...
         => ! [V2a: tp__ty_2Erealax_2Ereal] :
             ...
             => ap(ap(c_2Ereal__topology_2Econnected__component,V0t),inj__ty_2Erealax_2Ereal(V2a)) = ap(ap(c_2Ereal__topology_2Econnected__component,V1u),inj__ty_2Erealax_2Ereal(V2a)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__INTERMEDIATE__SUBSET,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
