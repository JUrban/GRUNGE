...
fof(conj_thm_2Epred__set_2ESUBSET__SUBSET__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EBIGUNION__applied,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(lamtp_f2017,axiom,(
    ! [A_27a,A_27a,V0S_27] :
      ( mem(V0S_27,arr(A_27a,bool))
     => ! [V1top] :
          ( mem(V1top,ty_2Etopology_2Etopology(A_27a))
         => mem(f2017(A_27a,A_27a,V0S_27,V1top),arr(arr(A_27a,bool),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) ) )).
    ...
    ! [A_27a,A_27a,V0S_27] :
     ...
     => ! [V1top] :
         ...
         => ! [V2P] :
             ...
             => ap(f2017(A_27a,A_27a,V0S_27,V1top),V2P) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V2P),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Etopology_2Eopen__in(A_27a),V1top),V2P)),ap(ap(c_2Epred__set_2ESUBSET(A_27a),V2P),V0S_27))) ) ) ) )).

fof(conj_thm_2Etopology_2EOPEN__UNOPEN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0S_27] :
          ( mem(V0S_27,arr(A_27a,bool))
         => ! [V1top] :
             ...
             => ( p(ap(ap(c_2Etopology_2Eopen__in(A_27a),V1top),V0S_27))
              <=> ap(c_2Epred__set_2EBIGUNION(A_27a),ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f2017(A_27a,A_27a,V0S_27,V1top))) = V0S_27 ) ) ) ) )).
