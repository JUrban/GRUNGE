...
fof(conj_thm_2Ereal__topology_2ECONNECTED__BIGUNION,lemma,(
    ! [V0P] :
    ...
    ! [V1x] :
     ...
     => ! [V0s] :
         ...
         => ! [V2t] :
             ...
             => ap(f3931(V1x,V0s),V2t) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2t),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2Econnected,V2t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V2t)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2t),V0s)))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__BIGUNION,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3931(V1x,V0s))) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
