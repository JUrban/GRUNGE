...
thf(thm_2Ereal__topology_2ESUMS__REINDEX__GEN,conjecture,(
    ! [V0k: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2l: tyop_2Erealax_2Ereal,V3s: tyop_2Enum_2Enum > $o] :
      ( ( c_2Ereal__topology_2Esums
        @ ^ [V4x: tyop_2Enum_2Enum] :
            ( V1a @ ( c_2Earithmetic_2E_2B @ V4x @ V0k ) )
        @ V2l
        @ V3s )
      = ( c_2Ereal__topology_2Esums @ V1a @ V2l
        @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
          @ ^ [V5i: tyop_2Enum_2Enum] :
              ( c_2Earithmetic_2E_2B @ V5i @ V0k )
          @ V3s ) ) ) )).
