...
thf(f13847_0_2E0,type,(
    f13847_0_2E0: u )).

thf(f13847_0_2E1,type,(
    f13847_0_2E1: du > u )).

thf(f13847_0_2E2,type,(
...
thf(mono_2Ef13847_0,type,(
    mono_2Ef13847_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ELINEAR__COMPOSE__NEG,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13847_0 @ V0f @ V1x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0f @ V1x ) ) ) )).

thf(thm_2Ereal__topology_2ELINEAR__COMPOSE__NEG,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Elinear @ V0f )
     => ( mono_2Ec_2Ereal__topology_2Elinear @ ( mono_2Ef13847_0 @ V0f ) ) ) )).
