...
tff(thm_2Ereal__topology_2EOLDNET,conjecture,(
    ! [A_27a: d,V0n_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V1x_2E0),s(A_27a,V1x_2E0)))))
        & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V2y_2E0),s(A_27a,V2y_2E0))))) )
     => ? [V3z_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V3z_2E0),s(A_27a,V3z_2E0)))))
          & ! [V4w_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V4w_2E0),s(A_27a,V3z_2E0)))))
             => ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V4w_2E0),s(A_27a,V1x_2E0)))))
                & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Enetord_2E3(s(tyop_2Ereal__topology_2Enet(A_27a),V0n_2E0),s(A_27a,V4w_2E0),s(A_27a,V2y_2E0))))) ) ) ) ) )).
