...
fof(conj_thm_2EfixedPoint_2Elfp__least__closed,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2EfixedPoint_2Elfp__induction,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2EfixedPoint_2Efnsum__monotone,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f1] :
             ...
             => ! [V1f2] :
                 ...
                 => ( ( p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),V0f1))
                   ...
                   => p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),ap(ap(c_2EfixedPoint_2Efnsum(A_27b,A_27b),V0f1),V1f2))) ) ) ) ) ) )).

fof(conj_thm_2EfixedPoint_2Efnsum__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2X] :
                      ( mem(V2X,A_27a)
                     => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(V0f,V2X)),ap(ap(ap(c_2EfixedPoint_2Efnsum(A_27b,A_27b),V0f),V1g),V2X)))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(V1g,V2X)),ap(ap(ap(c_2EfixedPoint_2Efnsum(A_27b,A_27b),V0f),V1g),V2X))) ) ) ) ) ) ) )).

fof(conj_thm_2EfixedPoint_2Elfp__fnsum,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f1] :
         ...
         => ! [V1f2] :
             ...
             => ( ( p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),V0f1))
                  & p(ap(c_2EfixedPoint_2Emonotone(A_27a,A_27a),V1f2)) )
               => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2EfixedPoint_2Elfp(A_27a),V0f1)),ap(c_2EfixedPoint_2Elfp(A_27a),ap(ap(c_2EfixedPoint_2Efnsum(A_27a,A_27a),V0f1),V1f2))))
                  & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2EfixedPoint_2Elfp(A_27a),V1f2)),ap(c_2EfixedPoint_2Elfp(A_27a),ap(ap(c_2EfixedPoint_2Efnsum(A_27a,A_27a),V0f1),V1f2)))) ) ) ) ) ) )).
