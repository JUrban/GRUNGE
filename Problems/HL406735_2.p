...
tff(conj_thm_2Eveblen_2Emono__natI,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Eveblen_2Esup__mem__INTER,lemma,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(ty_2Enum_2Enum,arr(ty_2Eordinal_2Eordinal(A_27a),bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Eordinal_2Eordinal(A_27a)))
...
tff(conj_thm_2Eveblen_2Eoleast__leq,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(lameq_f2522,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(ty_2Enum_2Enum,arr(ty_2Eordinal_2Eordinal(A_27a),bool)))
     => ! [V3n: tp__ty_2Enum_2Enum] : ap(f2522(A_27a,V0A),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Epair_2E_2C(arr(ty_2Eordinal_2Eordinal(A_27a),bool),arr(ty_2Eordinal_2Eordinal(A_27a),bool)),ap(V0A,inj__ty_2Enum_2Enum(V3n))),inj__o(fo__c_2Ebool_2ET)) ) )).

tff(conj_thm_2Eveblen_2Eclub__INTER,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(ty_2Enum_2Enum,arr(ty_2Eordinal_2Eordinal(A_27a),bool)))
