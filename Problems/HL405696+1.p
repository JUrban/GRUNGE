...
fof(thm_2Eordinal_2Esup__eq__sup,axiom,(
    ! [A_27a,V0s2_2E0,V1s1_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2Ecardinal_2Ecardleq_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V1s1_2E0),s(tyop_2Emin_2Efun(tyop_2Esum_2Esum(tyop_2Enum_2Enum,A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EUNIV_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2Ecardinal_2Ecardleq_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s2_2E0),s(tyop_2Emin_2Efun(tyop_2Esum_2Esum(tyop_2Enum_2Enum,A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EUNIV_2E0))))
        & ! [V2a_2E0] :
            ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V2a_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V1s1_2E0))))
           => ? [V3b_2E0] :
                ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V3b_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s2_2E0))))
        ...
        & ! [V4b_2E0] :
            ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V4b_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s2_2E0))))
           => ? [V5a_2E0] :
                ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V5a_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V1s1_2E0))))
                & ~ p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V5a_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V4b_2E0)))) ) ) )
...
fof(thm_2Eordinal_2Efixpoints__exist,conjecture,(
    ! [A_27a,V0f_2E0] :
      ( ( ! [V1s_2E0] :
        ...
        & ! [V2x_2E0] : ~ p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a)),V0f_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V2x_2E0))),s(tyop_2Eordinal_2Eordinal(A_27a),V2x_2E0)))) )
     => ! [V3a_2E0] :
        ? [V4b_2E0] :
          ...
          & s(tyop_2Eordinal_2Eordinal(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Eordinal_2Eordinal(A_27a)),V0f_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V4b_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),V4b_2E0) ) ) )).
