...
fof(conj_thm_2EHolSmt_2Er019,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,bool)
         => ! [V1q] :
             ...
             => ! [V2x] :
                 ...
                 => ! [V3y] :
                      ( mem(V3y,A_27a)
                     => ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),ap(ap(ap(c_2Ebool_2ECOND(A_27a),V1q),V2x),V3y)),V2x) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Ebool_2E_2F_5C,V0p),ap(c_2Ebool_2E_7E,V1q))),V3y),V2x) ) ) ) ) ) )).
