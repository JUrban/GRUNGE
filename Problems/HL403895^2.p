...
thf(conj_thm_2Ellist_2ELDROP__THM,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del] :
      ( ! [V0ll: $i] :
          ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0ll )
            = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V0ll ) ) )
      & ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27b ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( c_2Ellist_2ELNIL @ A_27b ) )
          = ( c_2Eoption_2ENONE @ ( ty_2Ellist_2Ellist @ A_27b ) ) )
      & ! [V2n: tp__ty_2Enum_2Enum,V3h: $i] :
          ( ( mem @ V3h @ A_27c )
         => ! [V4t: $i] :
              ( ( mem @ V4t @ ( ty_2Ellist_2Ellist @ A_27c ) )
             => ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27c ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27c ) @ V3h ) @ V4t ) )
                = ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27c ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V4t ) ) ) ) ) )).

thf(conj_thm_2Ellist_2ENOT__LFINITE__TAKE,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ~ ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll ) )
       => ! [V1n: tp__ty_2Enum_2Enum] :
          ? [V2y: $i] :
            ...
            & ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V0ll )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2y ) ) ) ) ) )).

thf(conj_thm_2Ellist_2ELFINITE__TAKE,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V1ll ) )
          & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V1ll ) ) ) ) )
       => ? [V2y: $i] :
            ( ( mem @ V2y @ ( ty_2Elist_2Elist @ A_27a ) )
            & ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2y ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELTAKE__DROP,conjecture,(
    ! [A_27a: del] :
      ( ! [V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
          ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ~ ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V1ll ) )
           => ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll ) ) ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1ll ) ) )
              = V1ll ) ) )
      & ! [V2n: tp__ty_2Enum_2Enum,V3ll: $i] :
          ( ( mem @ V3ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ( p @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V3ll ) )
              & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V3ll ) ) ) ) )
           => ( ( ap @ ( ap @ ( c_2Ellist_2ELAPPEND @ A_27a ) @ ( ap @ ( c_2Ellist_2EfromList @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3ll ) ) ) ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3ll ) ) )
              = V3ll ) ) ) ) )).
