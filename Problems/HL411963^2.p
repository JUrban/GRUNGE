...
thf(conj_thm_2Ereal__topology_2ECLOSED__IMP__LOCALLY__COMPACT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__INTER__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact ) @ V0s ) )
       => ? [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__CLOSED__INTER__OPEN,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact ) @ V0s ) )
      <=> ? [V1t: $i] :
            ...
            & ? [V2u: $i] :
                ...
                & ( V0s
                  = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V1t ) @ V2u ) ) ) ) ) ) )).
