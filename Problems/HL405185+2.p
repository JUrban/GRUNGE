...
fof(lamtp_f2103,axiom,(
    ! [A_27b,A_27c,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2x] :
          ( mem(V2x,A_27c)
         => mem(f2103(A_27b,A_27c,A_27a,V0f,V2x),arr(A_27a,ty_2Epair_2Eprod(A_27c,A_27c))) ) ) )).
...
fof(lameq_f2103,axiom,(
    ! [A_27b,A_27c,A_27a,V0f] :
     ...
     => ! [V2x] :
         ...
         => ! [V3y] :
              ( mem(V3y,A_27a)
             => ap(f2103(A_27b,A_27c,A_27a,V0f,V2x),V3y) = ap(ap(c_2Epair_2E_2C(A_27c,A_27c),V2x),ap(V0f,V3y)) ) ) ) )).

fof(lamtp_f2102,axiom,(
    ! [A_27a,A_27b,A_27c,V0f] :
      ( mem(V0f,arr(A_27a,A_27b))
     => mem(f2102(A_27a,A_27b,A_27c,V0f),arr(A_27c,arr(A_27a,ty_2Epair_2Eprod(A_27c,A_27c)))) ) )).
...
fof(lameq_f2102,axiom,(
    ! [A_27a,A_27b,A_27c,V0f] :
     ...
     => ! [V2x] :
          ( mem(V2x,A_27c)
         => ap(f2102(A_27a,A_27b,A_27c,V0f),V2x) = f2103(A_27b,A_27c,A_27a,V0f,V2x) ) ) )).

fof(conj_thm_2Ealist_2EALOOKUP__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                 ...
                 => ! [V1al] :
                     ...
                     => ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27c,A_27c),ty_2Epair_2Eprod(A_27c,A_27c)),ap(c_2Epair_2EUNCURRY(A_27c,A_27c,A_27c),f2102(A_27a,A_27b,A_27c,V0f))),V1al)) = ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V0f)),ap(c_2Ealist_2EALOOKUP(A_27a,A_27a),V1al)) ) ) ) ) ) )).
