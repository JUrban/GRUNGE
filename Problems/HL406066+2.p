...
fof(lamtp_f2203,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => mem(f2203(V2n),arr(bool,bool)) ) )).
...
fof(lameq_f2203,axiom,(
    ! [V2n] :
     ...
     => ! [V5v] :
          ( mem(V5v,bool)
         => ap(f2203(V2n),V5v) = ap(ap(c_2Emin_2E_3D(bool),V2n),V5v) ) ) )).

fof(lamtp_f2202,axiom,(
    mem(f2202,arr(bool,arr(ty_2Epair_2Eprod(bool,bool),bool))) )).

fof(lameq_f2202,axiom,(
    ! [V2n] :
      ( mem(V2n,bool)
     => ap(f2202,V2n) = ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,ap(c_2Epair_2EUNCURRY(bool,bool,bool),k(bool,f2203(V2n))))) ) )).
...
fof(conj_thm_2Ewords_2EWORD__GREATER__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
