...
fof(conj_thm_2Ereal__topology_2ECLOSURE__COMPLEMENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__CLOSURE__INTER__OPEN,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2ECLOSURE__INTERIOR__UNION__CLOSED,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
