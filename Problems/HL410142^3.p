...
thf(thm_2Emeasure_2EUNIV__SIGMA__ALGEBRA,conjecture,(
    ! [A_27a: $tType] :
      ( c_2Emeasure_2Esigma__algebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Epred__set_2EUNIV @ A_27a ) @ ( c_2Epred__set_2EUNIV @ ( A_27a > $o ) ) ) ) )).
