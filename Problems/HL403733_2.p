...
tff(ax_thm_2Erelation_2Eantisymmetric__def,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Esorting_2ESORTED__PERM__EQ,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R))
          & p(ap(c_2Erelation_2Eantisymmetric(A_27a),V0R)) )
...
tff(conj_thm_2Esorting_2Esorted__count__list,lemma,(
...
tff(conj_thm_2Esorting_2Esorted__map,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R))
               => ( p(ap(ap(c_2Esorting_2ESORTED(A_27a),V0R),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l)))
                <=> p(ap(ap(c_2Esorting_2ESORTED(A_27b),ap(ap(c_2Erelation_2Einv__image(A_27b,A_27b),V0R),V1f)),V2l)) ) ) ) ) ) )).

tff(conj_thm_2Esorting_2Esorted__perm__count__list,conjecture,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ! [V3n: tp__ty_2Enum_2Enum] :
                  ( ( p(ap(ap(c_2Esorting_2ESORTED(A_27b),ap(ap(c_2Erelation_2Einv__image(A_27b,A_27b),c_2Earithmetic_2E_3C_3D),V1f)),V2l))
                    & p(ap(ap(c_2Esorting_2EPERM(ty_2Enum_2Enum),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l)),ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V3n)))) )
                 => surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V1f),V2l)) = surj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V3n))) ) ) ) ) )).
