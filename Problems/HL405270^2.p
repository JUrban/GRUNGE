...
thf(conj_thm_2Einteger_2Etint__of__num__eq,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Einteger_2ENUM__POSTINT__EX,conjecture,(
    ! [V0t: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
     ...
     => ? [V1n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Einteger_2Etint__eq @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0t ) ) @ ( ap @ c_2Einteger_2Etint__of__num @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
