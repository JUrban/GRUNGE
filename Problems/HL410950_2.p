...
tff(lmtp_f3736,type,(
    f3736: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3736,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l: tp__ty_2Erealax_2Ereal] : mem(f3736(A_27a,V1f,V2l),arr(A_27a,bool)) ) )).

tff(lameq_f3736,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2l: tp__ty_2Erealax_2Ereal,V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3736(A_27a,V1f,V2l),V3x) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V3x)),inj__ty_2Erealax_2Ereal(V2l)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__EVENTUALLY,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3736(A_27a,V1f,V2l)),V0net))
             => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net)) ) ) ) )).

tff(lmtp_f3786,type,(
    f3786: ( del * $i * $i ) > $i )).

tff(lamtp_f3786,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3786(A_27a,V1f,V2g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3786,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f3786(A_27a,V1f,V2g),V4x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V1f,V4x)),ap(V2g,V4x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3786(A_27a,V1f,V2g)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net))
...
tff(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__EVENTUALLY,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
