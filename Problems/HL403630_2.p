...
tff(conj_thm_2Epred__set_2ECARD__SING,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
...
tff(lamtp_f1074,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f1074(A_27a,A_27a),arr(A_27a,bool)) )).
...
tff(conj_thm_2Efcp_2ENULL__V2L,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,ty_2Efcp_2Ecart(A_27a,A_27a))
     => ~ p(ap(c_2Elist_2ENULL(A_27a),ap(c_2Efcp_2EV2L(A_27a,A_27a),V0v))) ) )).
