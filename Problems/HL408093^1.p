...
thf(f9532_0_2E0,type,(
    f9532_0_2E0: u )).

thf(f9532_0_2E2,type,(
    f9532_0_2E2: du > du > u )).

thf(f9532_0_2E3,type,(
...
thf(mono_2Ef9532_0,type,(
    mono_2Ef9532_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Elim_2ELIM,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1y0: mono_2Etyop_2Erealax_2Ereal,V2x0: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Elim_2Etends__real__real @ V0f @ V1y0 @ V2x0 )
    <=> ! [V3e: mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V4d: mono_2Etyop_2Erealax_2Ereal] :
              ...
              & ! [V5x: mono_2Etyop_2Erealax_2Ereal] :
                  ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V5x @ V2x0 ) ) )
                    & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ V5x @ V2x0 ) ) @ V4d ) )
                 => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ V5x ) @ V1y0 ) ) @ V3e ) ) ) ) ) )).

thf(def0_2Ethm_2Elim_2Econtl,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2h: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9532_0 @ V0f @ V1x @ V2h )
      = ( V0f @ ( mono_2Ec_2Erealax_2Ereal__add @ V1x @ V2h ) ) ) )).

thf(thm_2Elim_2Econtl,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Elim_2Econtl @ V0f @ V1x )
      = ( mono_2Ec_2Elim_2Etends__real__real @ ( mono_2Ef9532_0 @ V0f @ V1x ) @ ( V0f @ V1x ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).
...
thf(thm_2Elim_2EIVT,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V2b )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V1a ) @ V3y )
        & ( mono_2Ec_2Ereal_2Ereal__lte @ V3y @ ( V0f @ V2b ) )
        & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
