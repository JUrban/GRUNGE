...
tff(conj_thm_2Epath_2Enth__label__def__compute,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0p: $i] :
          ( mem(V0p,ty_2Epath_2Epath(A_27b,A_27b))
         => ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0p) = ap(c_2Epath_2Efirst__label(A_27b,A_27b),V0p) )
      & ! [V1n: tp__ty_2Enum_2Enum,V2p: $i] :
          ( mem(V2p,ty_2Epath_2Epath(A_27b,A_27b))
         => ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V1n)))),V2p) = ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V1n)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Epath_2Etail(A_27b,A_27b),V2p)) )
      & ! [V3n: tp__ty_2Enum_2Enum,V4p: $i] :
          ( mem(V4p,ty_2Epath_2Epath(A_27b,A_27b))
         => ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(V3n)))),V4p) = ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(V3n)))),ap(c_2Epath_2Etail(A_27b,A_27b),V4p)) ) ) )).
