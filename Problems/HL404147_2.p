...
tff(lameq_f1686,axiom,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f1686(A_27a,A_27b,V0p),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1i)),ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Epath_2Efinite(A_27a,A_27a),V0p)),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1i)),ap(c_2Eoption_2ETHE(ty_2Enum_2Enum),ap(c_2Epath_2Elength(A_27a,A_27a),V0p))))) ) )).
...
tff(conj_thm_2Epath_2EPL__stopped__at,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
