...
fof(lamtp_f3711,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => mem(f3711(V0s,V1x),arr(arr(ty_2Erealax_2Ereal,bool),bool)) ) ) )).

fof(lameq_f3711,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2t] :
             ...
             => ap(f3711(V0s,V1x),V2t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2EOpen,V2t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V2t)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2t),V0s))) ) ) ) )).

fof(lamtp_f3710,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3710(V0s),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

fof(lameq_f3710,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3710(V0s),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3711(V0s,V1x))) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__MAXIMAL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EINTERIOR__CLOSED__INTERVAL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ap(c_2Ereal__topology_2Einterior,ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))) = ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)) ) ) )).
