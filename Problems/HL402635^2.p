...
thf(conj_thm_2Erich__list_2EFOLDL__SINGLE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2x: $i] :
              ( ( mem @ V2x @ A_27b )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ A_27b @ A_27a ) @ V0f ) @ V1e ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27b ) @ V2x ) @ ( c_2Elist_2ENIL @ A_27b ) ) )
                = ( ap @ ( ap @ V0f @ V1e ) @ V2x ) ) ) ) ) )).
