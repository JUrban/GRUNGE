...
thf(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__PNEXT__THM,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2c: $i] :
             ...
             => ( ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V3t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V3t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V4t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ c_2EPast__Temporal__Logic_2EInitPoint @ V4t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V4t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V4t ) ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V5t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V5t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V1b ) @ V2c ) @ V5t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V6t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V7t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V7t ) ) @ ( ap @ V2c @ V7t ) ) ) )
                            @ V6t ) )
                ...
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V9t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V9t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V1b ) @ V2c ) @ V9t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V10t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V11t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V11t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1b @ V11t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V11t ) ) ) ) ) )
                            @ V10t ) )
                        @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V1b ) @ V2c ) @ V10t ) )
                          @ ( ap
                            @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V12t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V12t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V12t ) ) ) ) )
                            @ V10t ) ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V13t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V13t ) ) @ ( ap @ ( ap @ c_2ETemporal__Logic_2ENEXT @ V1b ) @ V13t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V14t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V1b @ V14t ) ) @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT @ V0a ) @ V14t ) ) ) )
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V15t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V15t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2ESUNTIL @ V1b ) @ V2c ) @ V15t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V16t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_5C_2F
                          @ ( ap
                            @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V17t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V17t ) ) @ ( ap @ V2c @ V17t ) ) ) )
                            @ V16t ) )
                ...
                & ( ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V18t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V18t ) ) @ ( ap @ ( ap @ ( ap @ c_2ETemporal__Logic_2EBEFORE @ V1b ) @ V2c ) @ V18t ) ) ) )
                  = ( lam @ ty_2Enum_2Enum
                    @ ^ [V19t: $i] :
                        ( ap
                        @ ( ap @ c_2Ebool_2E_2F_5C
                          @ ( ap
                            @ ( ap @ c_2EPast__Temporal__Logic_2EPNEXT
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V20t: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V20t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2c @ V20t ) ) ) ) )
                            @ V19t ) )
