...
thf(thm_2Epatricia_2EADD__LIST__TO__EMPTY__IS__PTREE,conjecture,(
    ! [A_27a: d,V0l_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epatricia_2EIS__PTREE_2E1 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ ( c_2Epatricia_2EADD__LIST_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ c_2Epatricia_2EEmpty_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) ) @ V0l_2E0 ) ) ) ) ) ) )).
