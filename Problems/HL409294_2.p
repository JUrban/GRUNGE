...
tff(mem_c_2Elift__ieee_2Eerror,axiom,(
    ! [A_27t: del,A_27w: del] : mem(c_2Elift__ieee_2Eerror(A_27t,A_27t),arr(ty_2Ebool_2Eitself(ty_2Epair_2Eprod(A_27t,A_27t)),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(ax_thm_2Elift__ieee_2Eerror__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Elift__ieee_2Eerror(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),ap(ap(c_2Ebinary__ieee_2Eround(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTiesToEven)),inj__ty_2Erealax_2Ereal(V0x)))),inj__ty_2Erealax_2Ereal(V0x))) )).

tff(conj_thm_2Elift__ieee_2Eclosest__is__closest,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( p(ap(c_2Epred__set_2EFINITE(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V1s))
             => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
               => p(ap(ap(ap(c_2Ebinary__ieee_2Eis__closest(A_27a,A_27a),V1s),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),inj__ty_2Erealax_2Ereal(V2x)))) ) ) ) ) )).

tff(lmtp_f3222,type,(
    f3222: ( del * del ) > $i )).

tff(lamtp_f3222,axiom,(
    ! [A_27a: del,A_27b: del] : mem(f3222(A_27a,A_27b),arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)))) )).
...
tff(conj_thm_2Elift__ieee_2Eis__finite__finite,lemma,(
    ! [A_27a: del,A_27b: del] : p(ap(c_2Epred__set_2EFINITE(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3222(A_27a,A_27b)))) )).

tff(conj_thm_2Elift__ieee_2Eis__finite__nonempty,lemma,(
    ! [A_27a: del,A_27b: del] : ap(c_2Epred__set_2EGSPEC(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3222(A_27a,A_27b)) != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)) )).

tff(conj_thm_2Elift__ieee_2Eerror__at__worst__lemma,conjecture,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
      ( mem(V0a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1x))),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
            & p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a)) )
         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Elift__ieee_2Eerror(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),inj__ty_2Erealax_2Ereal(V1x)))),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),inj__ty_2Erealax_2Ereal(V1x))))) ) ) )).
