...
fof(mem_c_2Elebesgue_2Emeasure__absolutely__continuous,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Elebesgue_2Emeasure__absolutely__continuous(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),bool))) ) )).
...
fof(lamtp_f4200,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f4200(A_27a,V1f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f4200,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V3x] :
          ( mem(V3x,A_27a)
         => ap(f4200(A_27a,V1f),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V3x)),c_2Eextreal_2EPosInf)),ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V1f,V3x)) ) ) )).

fof(lamtp_f4201,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => mem(f4201(A_27a,V1f),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

fof(lameq_f4201,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V4x] :
          ( mem(V4x,A_27a)
         => ap(f4201(A_27a,V1f),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eextreal_2Eextreal),ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),ap(V1f,V4x)),c_2Eextreal_2EPosInf)),ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V1f,V4x)) ) ) )).

fof(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ( p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4200(A_27a,V1f)))
                  & ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),V1f) = ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4201(A_27a,V1f)) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2ERadon__Nikodym,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1v] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ? [V2f] :
                    ...
                    & ! [V3x] :
                        ( mem(V3x,A_27a)
                       => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V2f,V3x))) )
                    & ! [V4A] :
                        ( mem(V4A,arr(A_27a,bool))
                       => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V4A),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                         => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4218(A_27a,V2f,V4A)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V1v),V4A)) ) ) ) ) ) ) ) )).

fof(lamtp_f4223,axiom,(
    ! [A_27a,V2f] :
      ( mem(V2f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5A] :
...
fof(conj_thm_2Elebesgue_2ERadon__Nikodym2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1v] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ? [V2f] :
                    ...
                    & ! [V4x] :
                        ( mem(V4x,A_27a)
                       => ap(V2f,V4x) != c_2Eextreal_2EPosInf )
                    & ! [V5A] :
                        ( mem(V5A,arr(A_27a,bool))
                       => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V5A),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m)))
                         => ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4223(A_27a,V2f,V5A)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V1v),V5A)) ) ) ) ) ) ) ) )).
