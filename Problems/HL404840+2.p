...
fof(conj_thm_2Efinite__map_2EIN__FRANGE__o__f__suff,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1P] :
                     ...
                     => ! [V2f] :
                         ...
                         => ( ! [V3v] :
                           ...
                           => ! [V4v] :
                                ( mem(V4v,A_27c)
                               => ( p(ap(ap(c_2Ebool_2EIN(A_27c),V4v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2Eo__f(A_27b,A_27b,A_27b),V2f),V0fm))))
                                 => p(ap(V1P,V4v)) ) ) ) ) ) ) ) ) ) )).
