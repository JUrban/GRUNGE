...
fof(lameq_f2169,axiom,(
    ! [A_27a,V0v] :
     ...
     => ! [V1w] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2169(A_27a,V0v,V1w),V2i) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),V2i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),V2i)) ) ) ) )).
...
fof(conj_thm_2Ewords_2Eword__xnor__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
