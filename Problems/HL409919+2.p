...
fof(conj_thm_2Ereal_2EREAL__SUP__UBOUND__LE,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal_2ESUP__EPSILON,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1e] :
...
fof(conj_thm_2Eseq_2ESEQ__MONO__LE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Eextreal_2Emono__increasing__converges__to__sup,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1r] :
         ...
         => ( ( p(ap(c_2Eextreal_2Emono__increasing,V0f))
           ...
           => V1r = ap(c_2Ereal_2Esup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) ) ) )).
