...
tff(thm_2Equotient_2EEQUALS__EQUIV__IMPLIES,conjecture,(
    ! [A_27a: d,V0b2_2E0: u,V1b1_2E0: u,V2a2_2E0: u,V3a1_2E0: u,V4R_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Equotient_2EEQUIV_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V4R_2E0)))))
     => ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V4R_2E0),s(A_27a,V3a1_2E0))),s(A_27a,V2a2_2E0)))))
          & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V4R_2E0),s(A_27a,V1b1_2E0))),s(A_27a,V0b2_2E0))))) )
       => ( s(A_27a,V3a1_2E0) = s(A_27a,V1b1_2E0)
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V4R_2E0),s(A_27a,V2a2_2E0))),s(A_27a,V0b2_2E0))))) ) ) ) )).
