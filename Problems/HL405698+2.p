...
fof(conj_thm_2Eordinal_2Efixpoints__exist,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Eordinal_2Ex__le__ordEXP__x,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
fof(lamtp_f2161,axiom,(
    ! [A_27a] : mem(f2161(A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) )).
...
fof(ax_thm_2Eordinal_2Eepsilon0__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Eordinal_2Eepsilon0(A_27a) = ap(c_2Eordinal_2Eoleast(A_27a),f2161(A_27a)) ) )).

fof(conj_thm_2Eordinal_2Eepsilon0__fixpoint,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
