...
thf(conj_thm_2Ereal__topology_2ESIMPLE__IMAGE__GEN,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ( ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27a )
              @ ( lam @ A_27a
                @ ^ [V2x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ ( ap @ V0f @ V2x ) ) @ ( ap @ V1P @ V2x ) ) ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V3x: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V3x ) @ ( ap @ V1P @ V3x ) ) ) ) ) ) ) ) )).
