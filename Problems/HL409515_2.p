...
tff(lamtp_f3255,axiom,(
    ! [A_27b: del,A_27c: del,V3s: $i] :
      ( mem(V3s,A_27b)
     => ! [V1p: $i] :
          ( mem(V1p,arr(A_27b,arr(A_27c,bool)))
         => mem(f3255(A_27b,A_27c,V3s,V1p),arr(A_27c,bool)) ) ) )).
...
tff(lameq_f3255,axiom,(
    ! [A_27b: del,A_27c: del,V3s: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V4n: $i] :
              ( mem(V4n,A_27c)
             => ap(f3255(A_27b,A_27c,V3s,V1p),V4n) = ap(ap(V1p,V3s),V4n) ) ) ) )).

tff(lmtp_f3254,type,(
    f3254: ( del * del * $i ) > $i )).

tff(lamtp_f3254,axiom,(
    ! [A_27c: del,A_27b: del,V1p: $i] :
      ( mem(V1p,arr(A_27b,arr(A_27c,bool)))
     => mem(f3254(A_27c,A_27b,V1p),arr(A_27b,ty_2Epair_2Eprod(A_27b,A_27b))) ) )).
...
tff(lameq_f3254,axiom,(
    ! [A_27c: del,A_27b: del,V1p: $i] :
     ...
     => ! [V3s: $i] :
          ( mem(V3s,A_27b)
         => ap(f3254(A_27c,A_27b,V1p),V3s) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V3s),ap(c_2Ebool_2E_3F(A_27c),f3255(A_27b,A_27c,V3s,V1p))) ) ) )).

tff(lmtp_f3257,type,(
    f3257: ( del * del * $i * $i ) > $i )).

tff(lamtp_f3257,axiom,(
    ! [A_27c: del,A_27b: del,V5n: $i] :
      ( mem(V5n,A_27c)
     => ! [V1p: $i] :
          ( mem(V1p,arr(A_27b,arr(A_27c,bool)))
         => mem(f3257(A_27c,A_27b,V5n,V1p),arr(A_27b,ty_2Epair_2Eprod(A_27b,A_27b))) ) ) )).
...
tff(lameq_f3257,axiom,(
    ! [A_27c: del,A_27b: del,V5n: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V6s: $i] :
              ( mem(V6s,A_27b)
             => ap(f3257(A_27c,A_27b,V5n,V1p),V6s) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V6s),ap(ap(V1p,V6s),V5n)) ) ) ) )).

tff(lmtp_f3256,type,(
    f3256: ( del * del * $i ) > $i )).

tff(lamtp_f3256,axiom,(
    ! [A_27b: del,A_27c: del,V1p: $i] :
      ( mem(V1p,arr(A_27b,arr(A_27c,bool)))
     => mem(f3256(A_27b,A_27c,V1p),arr(A_27c,arr(A_27b,bool))) ) )).
...
tff(lameq_f3256,axiom,(
    ! [A_27b: del,A_27c: del,V1p: $i] :
     ...
     => ! [V5n: $i] :
          ( mem(V5n,A_27c)
         => ap(f3256(A_27b,A_27c,V1p),V5n) = ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f3257(A_27c,A_27b,V5n,V1p)) ) ) )).

tff(conj_thm_2Eutil__prob_2EGBIGUNION__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0s: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2n: $i] :
              ( mem(V2n,A_27d)
             => ap(c_2Epred__set_2EGSPEC(A_27b,A_27b),f3254(A_27c,A_27b,V1p)) = ap(c_2Epred__set_2EBIGUNION(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27c,A_27c),f3256(A_27b,A_27c,V1p)),c_2Epred__set_2EUNIV(A_27c))) ) ) ) )).
