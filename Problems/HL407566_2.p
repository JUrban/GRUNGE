...
tff(lmtp_f2752,type,(
    f2752: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2752,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2752(V0x),arr(ty_2Einteger_2Eint,bool)) )).

tff(lameq_f2752,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1i: tp__ty_2Einteger_2Eint] : ap(f2752(V0x),inj__ty_2Einteger_2Eint(V1i)) = ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Eintreal_2Ereal__of__int,inj__ty_2Einteger_2Eint(V1i))) )).

tff(ax_thm_2Eintreal_2EINT__CEILING__def,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Einteger_2Eint(ap(c_2Eintreal_2EINT__CEILING,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2ELEAST__INT,f2752(V0x))) )).

tff(conj_thm_2Eintreal_2Ereal__of__int__monotonic,lemma,(
...
tff(conj_thm_2Eintreal_2EINT__FLOOR__BOUNDS,lemma,(
...
tff(lmtp_f2753,type,(
    f2753: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2753,axiom,(
    ! [V0r: tp__ty_2Erealax_2Ereal] : mem(f2753(V0r),arr(ty_2Einteger_2Eint,ty_2Einteger_2Eint)) )).

tff(lameq_f2753,axiom,(
    ! [V0r: tp__ty_2Erealax_2Ereal,V1i: tp__ty_2Einteger_2Eint] : ap(f2753(V0r),inj__ty_2Einteger_2Eint(V1i)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Einteger_2Eint),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Eintreal_2Ereal__of__int,inj__ty_2Einteger_2Eint(V1i))),inj__ty_2Erealax_2Ereal(V0r))),inj__ty_2Einteger_2Eint(V1i)),ap(ap(c_2Einteger_2Eint__add,inj__ty_2Einteger_2Eint(V1i)),ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )).

tff(conj_thm_2Eintreal_2EINT__CEILING__INT__FLOOR,conjecture,(
    ! [V0r: tp__ty_2Erealax_2Ereal] : surj__ty_2Einteger_2Eint(ap(c_2Eintreal_2EINT__CEILING,inj__ty_2Erealax_2Ereal(V0r))) = surj__ty_2Einteger_2Eint(ap(ap(c_2Ebool_2ELET(ty_2Einteger_2Eint,ty_2Einteger_2Eint),f2753(V0r)),ap(c_2Eintreal_2EINT__FLOOR,inj__ty_2Erealax_2Ereal(V0r)))) )).
