...
tff(thm_2Elist_2EMONO__EXISTS,conjecture,(
    ! [A_27a: $tType,V0l_2E0: tyop_2Elist_2Elist(A_27a),V1Q_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2P_2E0: tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)] :
      ( ! [V3x_2E0: A_27a] :
     ...
     => ( p(c_2Elist_2EEXISTS_2E2(A_27a,V2P_2E0,V0l_2E0))
       => p(c_2Elist_2EEXISTS_2E2(A_27a,V1Q_2E0,V0l_2E0)) ) ) )).
