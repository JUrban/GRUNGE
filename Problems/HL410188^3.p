    ...
    ! [A_27a: $tType,A_27b: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1b: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o ),V2f: A_27a > A_27b] :
     ...
     => ! [V4c: ( A_27a > $o ) > $o] :
          ( ( ( c_2Epred__set_2Ecountable @ ( A_27a > $o ) @ V4c )
            & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ V4c @ ( c_2Epred__set_2EIMAGE @ ( A_27b > $o ) @ ( A_27a > $o ) @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V2f ) @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) ) ) )
         => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V4c ) @ ( c_2Epred__set_2EIMAGE @ ( A_27b > $o ) @ ( A_27a > $o ) @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V2f ) @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) ) ) ) ) )).
    ...
    ! [A_27a: $tType,A_27b: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1b: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o ),V2f: A_27a > A_27b] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        ...
        & ! [V3s: A_27b > $o] :
            ( ( c_2Ebool_2EIN @ ( A_27b > $o ) @ V3s @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V2f @ V3s ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) ) ) )
     => ( c_2Emeasure_2Esigma__algebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ ( c_2Epred__set_2EIMAGE @ ( A_27b > $o ) @ ( A_27a > $o ) @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V2f ) @ ( c_2Emeasure_2Esubsets @ A_27b @ V1b ) ) ) ) ) )).
