...
fof(conj_thm_2Earithmetic_2ESTRICTLY__INCREASING__ONE__ONE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Earithmetic_2EONE__ONE__UNBOUNDED,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebool_2EONE__ONE(ty_2Enum_2Enum,ty_2Enum_2Enum),V0f))
       => ! [V1b] :
...
fof(conj_thm_2Earithmetic_2ESTRICTLY__INCREASING__UNBOUNDED,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( ! [V1n] :
            ( mem(V1n,ty_2Enum_2Enum)
