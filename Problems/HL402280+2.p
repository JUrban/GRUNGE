...
fof(conj_thm_2Epred__set_2ECARD__UNION__EQN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Elist_2EALL__DISTINCT__CARD__LIST__TO__SET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
...
fof(conj_thm_2Elist_2Eall__distinct__nub,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(lamtp_f450,axiom,(
    ! [A_27a,A_27a,V0l1] :
      ( mem(V0l1,ty_2Elist_2Elist(A_27a))
     => mem(f450(A_27a,A_27a,V0l1),arr(A_27a,bool)) ) )).
...
fof(lameq_f450,axiom,(
    ! [A_27a,A_27a,V0l1] :
     ...
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ap(f450(A_27a,A_27a,V0l1),V2x) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Elist_2ELIST__TO__SET(A_27a),V0l1))) ) ) )).

fof(conj_thm_2Elist_2Elist__to__set__diff,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
         => ! [V1l2] :
              ( mem(V1l2,ty_2Elist_2Elist(A_27a))
             => ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l2)),ap(c_2Elist_2ELIST__TO__SET(A_27a),V0l1)) = ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EFILTER(A_27a),f450(A_27a,A_27a,V0l1)),V1l2)) ) ) ) )).

fof(conj_thm_2Elist_2Elength__nub__append,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
         => ! [V1l2] :
              ( mem(V1l2,ty_2Elist_2Elist(A_27a))
             => ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2))) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),V0l1))),ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Elist_2Enub(A_27a),ap(ap(c_2Elist_2EFILTER(A_27a),f450(A_27a,A_27a,V0l1)),V1l2)))) ) ) ) )).
