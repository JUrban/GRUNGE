...
tff(conj_thm_2Epred__set_2ESUBSET__UNION__ABSORPTION,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Etc_2EsubTC__FDOM,conjecture,(
    ! [A_27a: del,V0g: $i] :
     ...
     => ! [V1R: $i] :
         ...
         => ( ap(ap(c_2Etc_2EsubTC(A_27a),V1R),ap(c_2Erelation_2ERDOM(A_27a,A_27a),V1R)) = ap(c_2Etc_2EFMAP__TO__RELN(A_27a),V0g)
           => ap(ap(c_2Etc_2EsubTC(A_27a),V1R),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0g)) = ap(ap(c_2Etc_2EsubTC(A_27a),V1R),ap(c_2Erelation_2ERDOM(A_27a,A_27a),V1R)) ) ) ) )).
