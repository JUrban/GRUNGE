    ...
    ! [V1b] :
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V5t] :
                  ( mem(V5t,ty_2Enum_2Enum)
                 => ap(f1553(V1b,V2c,V0a),V5t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V1b),V5t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V2c),V5t)) ) ) ) ) )).

fof(lamtp_f1554,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V2c] :
         ...
         => ! [V6t] :
             ...
             => ap(f1554(V1b,V2c),V6t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V6t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V6t)) ) ) ) )).

fof(lamtp_f1556,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V8t] :
                 ...
                 => ap(f1556(V1b,V2c,V0a),V8t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V8t)),ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,V8t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V8t))) ) ) ) ) )).

fof(lamtp_f1555,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V1b] :
             ...
             => ! [V7t] :
                 ...
                 => ap(f1555(V0a,V2c,V1b),V7t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V7t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V2c),V7t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1556(V1b,V2c,V0a)),V7t)) ) ) ) ) )).

fof(lamtp_f1557,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V2c] :
         ...
         => ! [V9t] :
             ...
             => ap(f1557(V1b,V2c),V9t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V9t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V2c),V9t)) ) ) ) )).

fof(lamtp_f1559,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V11t] :
                 ...
                 => ap(f1559(V1b,V2c,V0a),V11t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V11t)),ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,V11t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V11t))) ) ) ) ) )).

fof(lamtp_f1558,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V1b] :
             ...
             => ! [V10t] :
                 ...
                 => ap(f1558(V0a,V2c,V1b),V10t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V10t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V2c),V10t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1559(V1b,V2c,V0a)),V10t)) ) ) ) ) )).

fof(lamtp_f1560,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
     ...
     => ! [V3d] :
         ...
         => ! [V1b] :
             ...
             => ! [V12t] :
                 ...
                 => ap(f1560(V2c,V3d,V1b),V12t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V12t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V2c),V3d),V12t)) ) ) ) ) )).

fof(lamtp_f1562,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V2c] :
         ...
         => ! [V14t] :
             ...
             => ap(f1562(V0a,V2c),V14t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V14t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V14t)) ) ) ) )).

fof(lamtp_f1564,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V2c] :
         ...
         => ! [V16t] :
             ...
             => ap(f1564(V0a,V2c),V16t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V16t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V16t)) ) ) ) )).

fof(lamtp_f1563,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V3d] :
                 ...
                 => ! [V15t] :
                     ...
                     => ap(f1563(V0a,V2c,V1b,V3d),V15t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V3d,V15t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1564(V0a,V2c)),V1b),V15t)) ) ) ) ) ) )).

fof(lamtp_f1561,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V3d] :
                 ...
                 => ! [V13t] :
                     ...
                     => ap(f1561(V0a,V2c,V1b,V3d),V13t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V2c),V3d),V13t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1562(V0a,V2c)),V1b),V13t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1563(V0a,V2c,V1b,V3d)),V13t)) ) ) ) ) ) )).

fof(lamtp_f1565,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V3d] :
         ...
         => ! [V1b] :
             ...
             => ! [V17t] :
                 ...
                 => ap(f1565(V2c,V3d,V1b),V17t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1b,V17t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V2c),V3d),V17t)) ) ) ) ) )).

fof(lamtp_f1567,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V19t] :
             ...
             => ap(f1567(V0a,V3d),V19t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V19t)),ap(c_2Ebool_2E_7E,ap(ap(c_2ETemporal__Logic_2ENEXT,V3d),V19t))) ) ) ) )).

fof(lamtp_f1569,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V21t] :
             ...
             => ap(f1569(V0a,V3d),V21t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V21t)),ap(c_2Ebool_2E_7E,ap(ap(c_2ETemporal__Logic_2ENEXT,V3d),V21t))) ) ) ) )).

fof(lamtp_f1568,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V20t] :
                     ...
                     => ap(f1568(V3d,V1b,V0a,V2c),V20t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V2c,V20t)),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V3d,V20t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1569(V0a,V3d)),V1b),V20t))) ) ) ) ) ) )).

fof(lamtp_f1566,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V1b] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V18t] :
                     ...
                     => ap(f1566(V0a,V3d,V1b,V2c),V18t) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V2c),V3d),V18t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1567(V0a,V3d)),V1b),V18t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),f1568(V3d,V1b,V0a,V2c)),V18t)) ) ) ) ) ) )).

fof(lamtp_f1570,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V22t] :
             ...
             => ap(f1570(V0a,V1b),V22t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V22t)),ap(V1b,V22t)) ) ) ) )).

fof(lamtp_f1571,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V1b] :
             ...
             => ! [V23t] :
                 ...
                 => ap(f1571(V0a,V2c,V1b),V23t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V0a),V2c),V23t)),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,V1b),V2c),V23t)) ) ) ) ) )).

fof(lamtp_f1572,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V24t] :
             ...
             => ap(f1572(V0a,V1b),V24t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V24t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V1b),V24t)) ) ) ) )).

fof(lamtp_f1574,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V26t] :
             ...
             => ap(f1574(V1b,V0a),V26t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,V26t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V0a),V26t)) ) ) ) )).

fof(lamtp_f1573,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V1b] :
         ...
         => ! [V2c] :
             ...
             => ! [V25t] :
                 ...
                 => ap(f1573(V0a,V1b,V2c),V25t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,V25t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V25t)),ap(ap(c_2EPast__Temporal__Logic_2EPNEXT,V1b),V25t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1574(V1b,V0a)),ap(c_2ETemporal__Logic_2ENEXT,V2c)),V25t))) ) ) ) ) )).

fof(lamtp_f1575,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V27t] :
             ...
             => ap(f1575(V0a,V1b),V27t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V27t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),V27t)) ) ) ) )).

fof(lamtp_f1577,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V29t] :
             ...
             => ap(f1577(V1b,V0a),V29t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,V29t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V0a),V29t)) ) ) ) )).

fof(lamtp_f1576,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V1b] :
         ...
         => ! [V2c] :
             ...
             => ! [V28t] :
                 ...
                 => ap(f1576(V0a,V1b,V2c),V28t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,V28t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V28t)),ap(ap(c_2EPast__Temporal__Logic_2EPSNEXT,V1b),V28t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1577(V1b,V0a)),ap(c_2ETemporal__Logic_2ENEXT,V2c)),V28t))) ) ) ) ) )).

fof(lamtp_f1578,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V30t] :
                 ...
                 => ap(f1578(V1b,V2c,V0a),V30t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V30t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V1b),V2c),V30t)) ) ) ) ) )).

fof(lamtp_f1580,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V2c] :
         ...
         => ! [V32t] :
             ...
             => ap(f1580(V3d,V2c),V32t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V32t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V32t)) ) ) ) )).

fof(lamtp_f1581,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V33t] :
             ...
             => ap(f1581(V0a,V3d),V33t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V33t))),ap(c_2Ebool_2E_7E,ap(V3d,V33t))) ) ) ) )).

fof(lamtp_f1583,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V2c] :
         ...
         => ! [V35t] :
             ...
             => ap(f1583(V3d,V2c),V35t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V35t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V2c),V35t)) ) ) ) )).

fof(lamtp_f1584,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V36t] :
             ...
             => ap(f1584(V0a,V3d),V36t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V36t))),ap(c_2Ebool_2E_7E,ap(V3d,V36t))) ) ) ) )).

fof(lamtp_f1582,axiom,(
    ! [V2c] :
      ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ! [V34t] :
                     ...
                     => ap(f1582(V2c,V3d,V0a,V1b),V34t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V1b,V34t)),ap(ap(c_2Ebool_2E_5C_2F,ap(V2c,V34t)),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1583(V3d,V2c)),f1584(V0a,V3d)),V34t))) ) ) ) ) ) )).

fof(lamtp_f1579,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V31t] :
                     ...
                     => ap(f1579(V3d,V1b,V0a,V2c),V31t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSUNTIL,V1b),V2c),V31t)),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1580(V3d,V2c)),f1581(V0a,V3d)),V31t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1582(V2c,V3d,V0a,V1b)),V3d),V31t)) ) ) ) ) ) )).

fof(lamtp_f1585,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
     ...
     => ! [V2c] :
         ...
         => ! [V0a] :
             ...
             => ! [V37t] :
                 ...
                 => ap(f1585(V1b,V2c,V0a),V37t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V37t)),ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V1b),V2c),V37t)) ) ) ) ) )).

fof(lamtp_f1587,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V1b] :
         ...
         => ! [V39t] :
             ...
             => ap(f1587(V3d,V1b),V39t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V39t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V39t)) ) ) ) )).

fof(lamtp_f1588,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V40t] :
             ...
             => ap(f1588(V0a,V3d),V40t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V40t))),ap(c_2Ebool_2E_7E,ap(V3d,V40t))) ) ) ) )).

fof(lamtp_f1590,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V3d] :
     ...
     => ! [V1b] :
         ...
         => ! [V42t] :
             ...
             => ap(f1590(V3d,V1b),V42t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V3d,V42t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V1b),V42t)) ) ) ) )).

fof(lamtp_f1591,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V3d] :
          ( mem(V3d,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V3d] :
         ...
         => ! [V43t] :
             ...
             => ap(f1591(V0a,V3d),V43t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V43t))),ap(c_2Ebool_2E_7E,ap(V3d,V43t))) ) ) ) )).

fof(lamtp_f1589,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V3d] :
             ...
             => ! [V2c] :
                 ...
                 => ! [V41t] :
                     ...
                     => ap(f1589(V1b,V0a,V3d,V2c),V41t) = ap(ap(c_2Ebool_2E_5C_2F,ap(c_2Ebool_2E_7E,ap(V2c,V41t))),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1590(V3d,V1b)),f1591(V0a,V3d)),V41t)) ) ) ) ) ) )).

fof(lamtp_f1586,axiom,(
    ! [V3d] :
      ( mem(V3d,arr(ty_2Enum_2Enum,bool))
     => ! [V2c] :
          ( mem(V2c,arr(ty_2Enum_2Enum,bool))
         ...
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ! [V38t] :
                     ...
                     => ap(f1586(V3d,V2c,V0a,V1b),V38t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2EPast__Temporal__Logic_2EPBEFORE,V1b),V2c),V38t)),ap(ap(ap(c_2ETemporal__Logic_2EBEFORE,f1587(V3d,V1b)),f1588(V0a,V3d)),V38t))),ap(ap(ap(c_2ETemporal__Logic_2ESUNTIL,f1589(V1b,V0a,V3d,V2c)),V3d),V38t)) ) ) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ESEPARATE__SUNTIL__THM,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
