...
thf(conj_thm_2Equotient_2ECONJ__IMPLIES,lemma,(
...
thf(conj_thm_2Equotient_2ERES__EXISTS__UNIQUE__REGULAR__SAME,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1P: $i] :
         ...
         => ! [V2Q: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Equotient_2E_3D_3D_3D_3E @ A_27a @ bool ) @ V0R ) @ ( c_2Emin_2E_3D @ bool ) ) @ V1P ) @ V2Q ) )
