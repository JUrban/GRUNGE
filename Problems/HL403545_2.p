...
tff(ax_thm_2Ewellorder_2Eorderiso__def,axiom,(
     ...
     => ! [V1w2: $i] :
         ...
         => ( p(ap(ap(c_2Ewellorder_2Eorderiso(A_27a,A_27a),V0w1),V1w2))
          <=> ? [V2f: $i] :
                ...
                & ! [V3x: $i] :
                    ( mem(V3x,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Ewellorder_2EelsOf(A_27a),V0w1)))
                     => p(ap(ap(c_2Ebool_2EIN(A_27b),ap(V2f,V3x)),ap(c_2Ewellorder_2EelsOf(A_27b),V1w2))) ) )
                & ! [V4x1: $i] :
                    ( mem(V4x1,A_27a)
                   => ! [V5x2: $i] :
                        ( mem(V5x2,A_27a)
                       => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x1),ap(c_2Ewellorder_2EelsOf(A_27a),V0w1)))
                            & p(ap(ap(c_2Ebool_2EIN(A_27a),V5x2),ap(c_2Ewellorder_2EelsOf(A_27a),V0w1))) )
                         => ( ap(V2f,V4x1) = ap(V2f,V5x2)
                          <=> V4x1 = V5x2 ) ) ) )
                & ! [V6y: $i] :
                    ( mem(V6y,A_27b)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V6y),ap(c_2Ewellorder_2EelsOf(A_27b),V1w2)))
                     => ? [V7x: $i] :
                          ( mem(V7x,A_27a)
                          & p(ap(ap(c_2Ebool_2EIN(A_27a),V7x),ap(c_2Ewellorder_2EelsOf(A_27a),V0w1)))
                          & ap(V2f,V7x) = V6y ) ) )
                & ! [V8x: $i] :
                    ( mem(V8x,A_27a)
                   => ! [V9y: $i] :
                        ( mem(V9y,A_27a)
                       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V8x),V9y)),ap(c_2Eset__relation_2Estrict(A_27a),ap(c_2Ewellorder_2Ewellorder__REP(A_27a),V0w1))))
                         => p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epair_2E_2C(A_27b,A_27b),ap(V2f,V8x)),ap(V2f,V9y))),ap(c_2Eset__relation_2Estrict(A_27b),ap(c_2Ewellorder_2Ewellorder__REP(A_27b),V1w2)))) ) ) ) ) ) ) ) )).
...
tff(conj_thm_2Ewellorder_2Ewo2wo__IN__w2,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( mem(V0w1,ty_2Ewellorder_2Ewellorder(A_27a))
     => ! [V1w2: $i] :
          ( mem(V1w2,ty_2Ewellorder_2Ewellorder(A_27b))
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ( ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27a,A_27a),V0w1),V1w2),V2x) = ap(c_2Eoption_2ESOME(A_27b),V3y)
                   => p(ap(ap(c_2Ebool_2EIN(A_27b),V3y),ap(c_2Ewellorder_2EelsOf(A_27b),V1w2))) ) ) ) ) ) )).

tff(conj_thm_2Ewellorder_2Ewo2wo__11,lemma,(
             ...
             => ! [V3w2: $i] :
                 ...
                 => ! [V4y: $i] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x1),ap(c_2Ewellorder_2EelsOf(A_27a),V1w1)))
                          ...
                          & ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27a,A_27a),V1w1),V3w2),V0x1) = ap(c_2Eoption_2ESOME(A_27b),V4y)
                          & ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27a,A_27a),V1w1),V3w2),V2x2) = ap(c_2Eoption_2ESOME(A_27b),V4y) )
                       => V0x1 = V2x2 ) ) ) ) ) ) )).

tff(conj_thm_2Ewellorder_2Ewo2wo__mono,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
         ...
         => ! [V2x0: $i] :
             ...
             => ! [V3y0: $i] :
                 ...
                 => ! [V4x: $i] :
                     ...
                     => ! [V5y: $i] :
                          ( mem(V5y,A_27a)
                         => ( ( ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27b,A_27b),V0w1),V1w2),V2x0) = ap(c_2Eoption_2ESOME(A_27a),V3y0)
                              & ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27b,A_27b),V0w1),V1w2),V4x) = ap(c_2Eoption_2ESOME(A_27a),V5y)
...
tff(conj_thm_2Ewellorder_2Ewo2wo__ONTO,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1w1: $i] :
          ( mem(V1w1,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2w2: $i] :
             ...
             => ! [V3y: $i] :
                 ...
                 => ! [V4y0: $i] :
                      ( mem(V4y0,A_27b)
                     => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Ewellorder_2EelsOf(A_27a),V1w1)))
                          & ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27a,A_27a),V1w1),V2w2),V0x) = ap(c_2Eoption_2ESOME(A_27b),V3y)
                          & p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epair_2E_2C(A_27b,A_27b),V4y0),V3y)),ap(c_2Eset__relation_2Estrict(A_27b),ap(c_2Ewellorder_2Ewellorder__REP(A_27b),V2w2)))) )
                       => ? [V5x0: $i] :
                            ( mem(V5x0,A_27a)
                            & p(ap(ap(c_2Ebool_2EIN(A_27a),V5x0),ap(c_2Ewellorder_2EelsOf(A_27a),V1w1)))
                            & ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27a,A_27a),V1w1),V2w2),V5x0) = ap(c_2Eoption_2ESOME(A_27b),V4y0) ) ) ) ) ) ) ) )).

tff(conj_thm_2Ewellorder_2Ewo2wo__EQ__NONE__woseg,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( mem(V0w1,ty_2Ewellorder_2Ewellorder(A_27b))
     => ! [V1w2: $i] :
          ( mem(V1w2,ty_2Ewellorder_2Ewellorder(A_27a))
         => ! [V2x: $i] :
              ( mem(V2x,A_27b)
             => ( ap(ap(ap(c_2Ewellorder_2Ewo2wo(A_27b,A_27b),V0w1),V1w2),V2x) = c_2Eoption_2ENONE(A_27a)
               => ap(c_2Ewellorder_2EelsOf(A_27a),V1w2) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Eoption_2Eoption(A_27a),ty_2Eoption_2Eoption(A_27a)),c_2Eoption_2ETHE(A_27a)),ap(ap(c_2Epred__set_2EDELETE(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),ap(ap(c_2Ewellorder_2Ewo2wo(A_27b,A_27b),V0w1),V1w2)),ap(ap(c_2Ewellorder_2Eiseg(A_27b),V0w1),V2x))),c_2Eoption_2ENONE(A_27a))) ) ) ) ) )).

tff(conj_thm_2Ewellorder_2Eorderlt__trichotomy,conjecture,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( mem(V0w1,ty_2Ewellorder_2Ewellorder(A_27a))
     => ! [V1w2: $i] :
          ( mem(V1w2,ty_2Ewellorder_2Ewellorder(A_27b))
