...
thf(thm_2Emeasure_2EMEASURE__SPACE__SUBSET,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1s_27: A_27a > $o,V2m: ( A_27a > $o ) > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2ESUBSET @ A_27a @ V1s_27 @ V0s )
        & ( c_2Emeasure_2Emeasure__space @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ V0s @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ V0s ) @ V2m ) ) ) )
     => ( c_2Emeasure_2Emeasure__space @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ V1s_27 @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ V1s_27 ) @ V2m ) ) ) ) )).
