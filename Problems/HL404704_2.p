...
tff(conj_thm_2Efinite__map_2EFRANGE__FUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm1: $i] :
      ( mem(V0fm1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1fm2: $i] :
          ( mem(V1fm2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0fm1)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm2)))
           => ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0fm1),V1fm2)) = ap(ap(c_2Epred__set_2EUNION(A_27b),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V0fm1)),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),V1fm2)) ) ) ) )).
