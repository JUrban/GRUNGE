...
fof(conj_thm_2Esptree_2Elookup__mapi,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Esptree_2Ewf__mapi,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1pt] :
                 ...
                 => p(ap(c_2Esptree_2Ewf(A_27a),ap(ap(c_2Esptree_2Emapi(A_27a,A_27a),V0f),V1pt))) ) ) ) ) )).

fof(lamtp_f2441,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(A_27b,A_27a)))
     => mem(f2441(A_27a,A_27b,V0f),arr(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).

fof(lameq_f2441,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(A_27b,A_27a)))
     => ! [V2kv] :
          ( mem(V2kv,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
         => ap(f2441(A_27a,A_27b,V0f),V2kv) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Epair_2EFST(ty_2Enum_2Enum,ty_2Enum_2Enum),V2kv)),ap(ap(V0f,ap(c_2Epair_2EFST(ty_2Enum_2Enum,ty_2Enum_2Enum),V2kv)),ap(c_2Epair_2ESND(ty_2Enum_2Enum,ty_2Enum_2Enum),V2kv))) ) ) )).

fof(conj_thm_2Esptree_2Emapi__Alist,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1pt] :
                  ( mem(V1pt,ty_2Esptree_2Espt(A_27b))
                 => ap(ap(c_2Esptree_2Emapi(A_27a,A_27a),V0f),V1pt) = ap(c_2Esptree_2EfromAList(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),f2441(A_27a,A_27b,V0f)),ap(c_2Esptree_2EtoAList(A_27b),V1pt))) ) ) ) ) )).
