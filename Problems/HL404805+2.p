...
fof(mem_c_2Efinite__map_2Efmap__EQ__UPTO,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(arr(A_27a,bool),bool)))) ) ) )).
...
fof(conj_thm_2Efinite__map_2Efmap__EQ__UPTO______FUPDATE__SING,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3k] :
                         ...
                         => ! [V4v] :
                             ...
                             => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),V0f1),V1f2),V2ks))
                               => p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f1),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k),V4v))),V1f2),ap(ap(c_2Epred__set_2EINSERT(A_27a),V3k),V2ks))) ) ) ) ) ) ) ) ) )).
