...
tff(tp_c_2Ebag_2EBAG__CARD__RELn,type,(
    c_2Ebag_2EBAG__CARD__RELn: del > $i )).

tff(mem_c_2Ebag_2EBAG__CARD__RELn,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__CARD__RELn(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(ty_2Enum_2Enum,bool))) )).
...
tff(conj_thm_2Ebag_2EFINITE__EMPTY__BAG,lemma,(
    ! [A_27a: del] : p(ap(c_2Ebag_2EFINITE__BAG(A_27a),c_2Ebag_2EEMPTY__BAG(A_27a))) )).
...
tff(ax_thm_2Ebag_2EBAG__CARD__RELn,axiom,(
    ! [A_27a: del,V0b: $i] :
...
tff(ax_thm_2Ebag_2EBAG__CARD,axiom,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
       => p(ap(ap(c_2Ebag_2EBAG__CARD__RELn(A_27a),V0b),ap(c_2Ebag_2EBAG__CARD(A_27a),V0b))) ) ) )).

tff(conj_thm_2Ebag_2EBCARD__0,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
       => ( surj__ty_2Enum_2Enum(ap(c_2Ebag_2EBAG__CARD(A_27a),V0b)) = fo__c_2Enum_2E0
