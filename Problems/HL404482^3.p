    ...
    <=> ? [V2R: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o] :
          ...
          & ! [V5x: A_27a] :
             ...
             => ( c_2Ebool_2E_3F_21 @ A_27b
                @ ^ [V6y: A_27b] :
                    ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27b @ V6y @ V1t ) @ ( V2R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ V5x @ V6y ) ) ) ) )
          & ! [V7y: A_27b] :
              ( ( c_2Ebool_2EIN @ A_27b @ V7y @ V1t )
             => ( c_2Ebool_2E_3F_21 @ A_27a
                @ ^ [V8x: A_27a] :
                    ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V8x @ V0s ) @ ( V2R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ V8x @ V7y ) ) ) ) ) ) ) )).
