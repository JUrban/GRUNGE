...
fof(conj_thm_2Esum_2EISL__OR__ISR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epred__set_2EINJECTIVE__IMAGE__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efcp_2Efinite__sum,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( p(ap(c_2Epred__set_2EFINITE(ty_2Esum_2Esum(A_27a,A_27a)),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(A_27a,A_27a))))
