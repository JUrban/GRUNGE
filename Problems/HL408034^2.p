...
thf(ax_thm_2Eseq_2Emono__decreasing__def,axiom,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eseq_2Emono__decreasing__suc,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Eseq_2Emono__decreasing @ V0f ) )
      <=> ! [V1n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) )).
