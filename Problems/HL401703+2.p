...
fof(conj_thm_2Epred__set_2EDIFF__DIFF__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Epred__set_2EDIFF__BIGINTER1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0sp] :
          ( mem(V0sp,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EDIFF__BIGINTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0sp] :
          ( mem(V0sp,arr(A_27a,bool))
