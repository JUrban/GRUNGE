...
thf(conj_thm_2Egcd_2EIS__GCD__0R,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ ( ap @ c_2Egcd_2Eis__gcd @ ( inj__ty_2Enum_2Enum @ V0a ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0a ) ) ) )).
...
thf(conj_thm_2Egcd_2EGCD__0R,conjecture,(
    ! [V0a: tp__ty_2Enum_2Enum] :
