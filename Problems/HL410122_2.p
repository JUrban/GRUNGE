...
tff(conj_thm_2Eseq_2EPOS__SUMMABLE,lemma,(
    ! [V0f: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(V0f,inj__ty_2Enum_2Enum(V1n))))
          & ? [V2x: tp__ty_2Erealax_2Ereal] :
            ! [V3n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),V0f)),inj__ty_2Erealax_2Ereal(V2x))) )
...
tff(conj_thm_2Emeasure_2EADDITIVE__SUM,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
...
tff(conj_thm_2Emeasure_2EINCREASING__ADDITIVE__SUMMABLE,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
