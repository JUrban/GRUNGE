...
fof(conj_thm_2Eiterate_2ESUM__EQ__GENERAL__INVERSES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V4i] :
             ...
             => ap(f3385(V0f,V1g),V4i) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V4i)),ap(V1g,V4i)) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__SUB__NUMSEG,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),f3385(V0f,V1g)) = ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),V0f)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n)),V1g)) ) ) ) ) )).
...
fof(lamtp_f3405,axiom,(
    ! [V1y] :
     ...
     => ! [V2n] :
         ...
         => ! [V0x] :
              ( mem(V0x,ty_2Erealax_2Ereal)
             => mem(f3405(V1y,V2n,V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) )).
     ...
     => ! [V2n] :
         ...
         => ! [V0x] :
             ...
             => ! [V3i] :
                 ...
                 => ap(f3405(V1y,V2n,V0x),V3i) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,V0x),V3i)),ap(ap(c_2Ereal_2Epow,V1y),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,V2n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3i))) ) ) ) ) )).

fof(conj_thm_2Eiterate_2EREAL__SUB__POW,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lameq_f3413,axiom,(
    ! [V0a] :
     ...
     => ! [V1x] :
         ...
         => ! [V4i] :
              ( mem(V4i,ty_2Enum_2Enum)
             => ap(f3413(V0a,V1x),V4i) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,V4i)),ap(ap(c_2Ereal_2Epow,V1x),V4i)) ) ) ) )).

fof(lamtp_f3414,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y] :
          ( mem(V2y,ty_2Erealax_2Ereal)
         => mem(f3414(V0a,V2y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V0a] :
     ...
     => ! [V2y] :
         ...
         => ! [V5i] :
             ...
             => ap(f3414(V0a,V2y),V5i) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,V5i)),ap(ap(c_2Ereal_2Epow,V2y),V5i)) ) ) ) )).

fof(lamtp_f3416,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Erealax_2Ereal)
     => ! [V6j] :
     ...
     => ! [V6j] :
         ...
         => ! [V0a] :
             ...
             => ! [V7i] :
                 ...
                 => ap(f3416(V2y,V6j,V0a),V7i) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,V7i)),ap(ap(c_2Ereal_2Epow,V2y),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,V7i),V6j)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) ) )).

fof(lamtp_f3415,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y] :
          ( mem(V2y,ty_2Erealax_2Ereal)
         => ! [V3n] :
             ...
             => ! [V1x] :
                  ( mem(V1x,ty_2Erealax_2Ereal)
                 => mem(f3415(V0a,V2y,V3n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) ) ) )).
     ...
     => ! [V2y] :
         ...
         => ! [V3n] :
             ...
             => ! [V1x] :
                 ...
                 => ! [V6j] :
                      ( mem(V6j,ty_2Enum_2Enum)
                     => ap(f3415(V0a,V2y,V3n,V1x),V6j) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,V6j),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3n)),f3416(V2y,V6j,V0a))),ap(ap(c_2Ereal_2Epow,V1x),V6j)) ) ) ) ) ) )).

fof(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ! [V3n] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V3n))
                   => ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V3n)),f3413(V0a,V1x))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V3n)),f3414(V0a,V2y))) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,V1x),V2y)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2D,V3n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),f3415(V0a,V2y,V3n,V1x))) ) ) ) ) ) )).
