...
tff(conj_thm_2Eordinal_2Eordle__ANTISYM,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Esup__SING,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Eomax__NONE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
tff(conj_thm_2Eordinal_2Eomax__sup,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Epreds__omax__SOME__SUC,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1b: $i] :
...
tff(lamtp_f2158,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
         => mem(f2158(A_27a,V0s,V1x),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) ) ) )).
    ...
    ! [A_27a: del,V0s: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2y: $i] :
             ...
             => ap(f2158(A_27a,V0s,V1x),V2y) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Eordinal_2Eordinal(A_27a)),V2y),V0s)),ap(ap(c_2Eordinal_2Eordlt(A_27a),V1x),V2y)) ) ) ) )).

tff(lmtp_f2157,type,(
    f2157: ( del * del * $i ) > $i )).

tff(lamtp_f2157,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => mem(f2157(A_27a,A_27a,V0s),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) ) )).
...
tff(lameq_f2157,axiom,(
    ! [A_27a: del,A_27a: del,V0s: $i] :
     ...
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
         => ap(f2157(A_27a,A_27a,V0s),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V1x),ap(c_2Ebool_2E_3F(ty_2Eordinal_2Eordinal(A_27a)),f2158(A_27a,V0s,V1x))) ) ) )).

tff(ax_thm_2Eordinal_2Edclose__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ap(c_2Eordinal_2Edclose(A_27a),V0s) = ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2157(A_27a,A_27a,V0s)) ) )).

tff(conj_thm_2Eordinal_2Epreds__sup,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ( p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V0s),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))))
       => ap(c_2Eordinal_2Epreds(A_27a),ap(c_2Eordinal_2Esup(A_27a),V0s)) = ap(c_2Eordinal_2Edclose(A_27a),V0s) ) ) )).

tff(conj_thm_2Eordinal_2Edclose__cardleq__univinf,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ( p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V0s),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum))))
       => p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(c_2Eordinal_2Edclose(A_27a),V0s)),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) ) )).

tff(conj_thm_2Eordinal_2Esup__eq__max,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Esup__eq__SUC,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ! [V1a: $i] :
          ( mem(V1a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2Eordinal_2Egeneric__continuity,conjecture,(
    ! [A_27a: del,V0f: $i] :
