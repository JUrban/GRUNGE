...
thf(thm_2Ereal__topology_2ELIMPT__INJECTIVE__LINEAR__IMAGE__EQ,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Elinear @ V1f )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal,V4y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V1f @ V3x )
              = ( V1f @ V4y ) )
           => ( V3x = V4y ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Elimit__point__of @ ( V1f @ V0x ) @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1f @ V2s ) )
        = ( mono_2Ec_2Ereal__topology_2Elimit__point__of @ V0x @ V2s ) ) ) )).
