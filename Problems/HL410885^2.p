...
thf(conj_thm_2Ereal__topology_2ELIM__COMPOSE__WITHIN,lemma,(
    ! [A_27a: del,V0net: $i] :
                        ...
                        & ( p
                          @ ( ap
                            @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                              @ ( lam @ A_27a
                                @ ^ [V6w: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V6w ) ) @ V3s ) ) @ ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V6w ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5z ) ) ) ) ) )
                            @ V0net ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__COMPOSE__AT,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
                    ...
                    & ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V5w: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V5w ) ) @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V3y ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4z ) ) ) ) )
                        @ V0net ) )
