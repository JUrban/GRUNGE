...
tff(conj_thm_2Elift__ieee_2Eclosest__in__set,lemma,(
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => ( V1s != c_2Epred__set_2EEMPTY(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
               => p(ap(ap(c_2Ebool_2EIN(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),V1s),inj__ty_2Erealax_2Ereal(V2x))),V1s)) ) ) ) ) )).
...
tff(lamtp_f3223,axiom,(
    ! [A_27a: del,A_27b: del] : mem(f3223(A_27a,A_27b),arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)))) )).

tff(lameq_f3223,axiom,(
    ! [A_27a: del,A_27b: del,V2a: $i] :
      ( mem(V2a,ty_2Ebinary__ieee_2Efloat(A_27a,A_27a))
     => ap(f3223(A_27a,A_27b),V2a) = ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),V2a),ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),V2a)) ) )).

tff(conj_thm_2Elift__ieee_2Eis__finite__closest,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,arr(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27a,A_27a),ap(ap(ap(c_2Ebinary__ieee_2Eclosest__such(A_27a,A_27a),V0p),ap(c_2Epred__set_2EGSPEC(ty_2Ebinary__ieee_2Efloat(A_27a,A_27a),ty_2Ebinary__ieee_2Efloat(A_27a,A_27a)),f3223(A_27a,A_27b))),inj__ty_2Erealax_2Ereal(V1x)))) ) )).
