...
tff(conj_thm_2Ebinary__ieee_2EULP__ind,conjecture,(
    ! [A_27t: del,A_27w: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),bool))
     => ( ! [V1e: $i] :
            ( mem(V1e,ty_2Efcp_2Ecart(bool,bool))
           => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V1e),c_2Ebool_2Ethe__value(A_27t)))) )
       => ! [V2v: $i] :
            ( mem(V2v,ty_2Efcp_2Ecart(bool,bool))
           => ! [V3v1: $i] :
                ( mem(V3v1,ty_2Ebool_2Eitself(A_27t))
               => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),V2v),V3v1))) ) ) ) ) )).
