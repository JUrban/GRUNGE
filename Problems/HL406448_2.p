...
tff(ax_thm_2Elist_2EPAD__RIGHT,axiom,(
    ! [A_27a: del,V0c: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum,V2s: $i] :
         ...
         => ap(ap(ap(c_2Elist_2EPAD__RIGHT(A_27a),V0c),inj__ty_2Enum_2Enum(V1n)),V2s) = ap(ap(c_2Elist_2EAPPEND(A_27a),V2s),ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V0c)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1n)),ap(c_2Elist_2ELENGTH(A_27a),V2s)))) ) ) )).

tff(conj_thm_2Ebitstring_2Elength__pad__right,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
