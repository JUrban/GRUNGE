...
thf(f11397_0_2E0,type,(
    f11397_0_2E0: u )).

thf(f11397_0_2E1,type,(
    f11397_0_2E1: du > u )).

thf(f11397_0_2E2,type,(
    f11397_0_2E2: du > du > u )).
...
thf(mono_2Ef11397_0,type,(
    mono_2Ef11397_0: mono_2Etyop_2Eextreal_2Eextreal > mono_2Etyop_2Eextreal_2Eextreal > $o )).
...
thf(def0_2Ethm_2Eextreal_2Einf__const,axiom,(
    ! [V0x: mono_2Etyop_2Eextreal_2Eextreal,V1y: mono_2Etyop_2Eextreal_2Eextreal] :
      ( ( mono_2Ef11397_0 @ V0x @ V1y )
    <=> ( V1y = V0x ) ) )).

thf(thm_2Eextreal_2Einf__const,conjecture,(
    ! [V0x: mono_2Etyop_2Eextreal_2Eextreal] :
      ( ( mono_2Ec_2Eextreal_2Eextreal__inf @ ( mono_2Ef11397_0 @ V0x ) )
      = V0x ) )).
