...
fof(conj_thm_2Erich__list_2EMEM__TAKE__IMP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
         ...
         => ! [V1m] :
             ...
             => ! [V2x] :
                  ( mem(V2x,A_27a)
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2ETAKE(A_27a),V1m),V0l))))
