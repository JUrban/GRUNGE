...
tff(conj_thm_2Ebinary__ieee_2Ediff__lt__ulp__even4,conjecture,(
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( ~ p(ap(ap(c_2Ebinary__ieee_2Eexponent__boundary(A_27t,A_27t),V1b),V0a))
                & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),inj__ty_2Erealax_2Ereal(V2x))))),ap(c_2Ebinary__ieee_2EULP(A_27t,A_27t),ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27t),V0a)),c_2Ebool_2Ethe__value(A_27t)))))
                & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)),inj__ty_2Erealax_2Ereal(V2x))))),ap(c_2Ebinary__ieee_2EULP(A_27t,A_27t),ap(ap(c_2Epair_2E_2C(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27t),V0a)),c_2Ebool_2Ethe__value(A_27t)))))
