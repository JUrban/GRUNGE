...
thf(conj_thm_2Erich__list_2EELL__LENGTH__APPEND,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ~ ( p @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l1 ) )
           => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l2 ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ V1l2 ) )
              = ( ap @ ( c_2Elist_2ELAST @ A_27a ) @ V0l1 ) ) ) ) ) )).
