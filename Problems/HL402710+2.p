...
fof(conj_thm_2Erich__list_2ESEG__APPEND1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1m] :
             ...
             => ! [V2l1] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V0n),V1m)),ap(c_2Elist_2ELENGTH(A_27a),V2l1)))
                   => ! [V3l2] :
                        ( mem(V3l2,ty_2Elist_2Elist(A_27a))
                       => ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1m),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l1),V3l2)) = ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1m),V2l1) ) ) ) ) ) ) )).
