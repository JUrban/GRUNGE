...
fof(arityeq1_2Ef6305_0_2E1,axiom,(
    ! [X0_2E0] : s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),f6305_0_2E1(s(tyop_2Einteger_2Eint,X0_2E0))) = s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Einteger_2Eint,tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool)),f6305_0_2E0),s(tyop_2Einteger_2Eint,X0_2E0))) )).

fof(arityeq2_2Ef6305_0_2E2,axiom,(
    ! [X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f6305_0_2E2(s(tyop_2Einteger_2Eint,X0_2E0),s(tyop_2Enum_2Enum,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Einteger_2Eint,tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool)),f6305_0_2E0),s(tyop_2Einteger_2Eint,X0_2E0))),s(tyop_2Enum_2Enum,X1_2E0))) )).

fof(arityeq1_2Ef6313_0_2E1,axiom,(
    ! [X0_2E0] : s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),f6313_0_2E1(s(tyop_2Einteger_2Eint,X0_2E0))) = s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Einteger_2Eint,tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool)),f6313_0_2E0),s(tyop_2Einteger_2Eint,X0_2E0))) )).

fof(arityeq2_2Ef6313_0_2E2,axiom,(
    ! [X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,f6313_0_2E2(s(tyop_2Einteger_2Eint,X0_2E0),s(tyop_2Enum_2Enum,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Einteger_2Eint,tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool)),f6313_0_2E0),s(tyop_2Einteger_2Eint,X0_2E0))),s(tyop_2Enum_2Enum,X1_2E0))) )).
...
fof(def0_2Ethm_2Einteger_2ENUM__POSINT,axiom,(
    ! [V0i_2E0,V1n_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f6305_0_2E2(s(tyop_2Einteger_2Eint,V0i_2E0),s(tyop_2Enum_2Enum,V1n_2E0))))
    <=> s(tyop_2Einteger_2Eint,V0i_2E0) = s(tyop_2Einteger_2Eint,c_2Einteger_2Eint__of__num_2E1(s(tyop_2Enum_2Enum,V1n_2E0))) ) )).

fof(thm_2Einteger_2ENUM__POSINT,axiom,(
    ! [V0i_2E0] :
     ...
     => p(s(tyop_2Emin_2Ebool,c_2Ebool_2E_3F_21_2E1(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),f6305_0_2E1(s(tyop_2Einteger_2Eint,V0i_2E0)))))) ) )).

fof(def0_2Ethm_2Einteger_2ENum,axiom,(
    ! [V0i_2E0,V1n_2E0] :
      ( p(s(tyop_2Emin_2Ebool,f6313_0_2E2(s(tyop_2Einteger_2Eint,V0i_2E0),s(tyop_2Enum_2Enum,V1n_2E0))))
    <=> s(tyop_2Einteger_2Eint,V0i_2E0) = s(tyop_2Einteger_2Eint,c_2Einteger_2Eint__of__num_2E1(s(tyop_2Enum_2Enum,V1n_2E0))) ) )).

fof(thm_2Einteger_2ENum,axiom,(
    ! [V0i_2E0] : s(tyop_2Enum_2Enum,c_2Einteger_2ENum_2E1(s(tyop_2Einteger_2Eint,V0i_2E0))) = s(tyop_2Enum_2Enum,c_2Emin_2E_40_2E1(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),f6313_0_2E1(s(tyop_2Einteger_2Eint,V0i_2E0))))) )).

fof(thm_2Einteger_2EINT__OF__NUM,conjecture,(
    ! [V0i_2E0] :
