...
fof(lameq_f2015,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V2e] :
         ...
         => ! [V3n] :
              ( mem(V3n,ty_2Enum_2Enum)
             => ap(f2015(A_27a,V0f,V2e),V3n) = ap(ap(c_2Emin_2E_3D(ty_2Eoption_2Eoption(ty_2Enum_2Enum)),ap(V0f,V2e)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),V3n)) ) ) ) )).

fof(lamtp_f2014,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
...
fof(conj_thm_2Elbtree_2Emmindex__EXISTS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Enum_2Enum)))
