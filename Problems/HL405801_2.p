...
tff(conj_thm_2Ewords_2EFCP__T__F,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ap(c_2Efcp_2EFCP(bool,bool),ap(c_2Ecombin_2EK(bool,bool),inj__o(fo__c_2Ebool_2ET))) = c_2Ewords_2Eword__T(A_27a)
      & ap(c_2Efcp_2EFCP(bool,bool),ap(c_2Ecombin_2EK(bool,bool),inj__o(fo__c_2Ebool_2EF))) = ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) )).
