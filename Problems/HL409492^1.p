...
thf(thm_2Etransc_2ELN__MUL,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Etransc_2Eln @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0x @ V1y ) )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Etransc_2Eln @ V0x ) @ ( mono_2Ec_2Etransc_2Eln @ V1y ) ) ) ) )).
...
thf(thm_2Eutil__prob_2Elogr__mul,conjecture,(
    ! [V0b: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V1x )
        & ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V2y ) )
     => ( ( mono_2Ec_2Eutil__prob_2Elogr @ V0b @ ( mono_2Ec_2Erealax_2Ereal__mul @ V1x @ V2y ) )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Eutil__prob_2Elogr @ V0b @ V1x ) @ ( mono_2Ec_2Eutil__prob_2Elogr @ V0b @ V2y ) ) ) ) )).
