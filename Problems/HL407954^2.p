...
thf(tp_c_2Efrac_2Efrac__0,type,(
    c_2Efrac_2Efrac__0: $i )).

thf(mem_c_2Efrac_2Efrac__0,axiom,(
    mem @ c_2Efrac_2Efrac__0 @ ty_2Efrac_2Efrac )).

thf(stp_fo_c_2Efrac_2Efrac__0,type,(
    fo__c_2Efrac_2Efrac__0: tp__ty_2Efrac_2Efrac )).

thf(stp_eq_fo_c_2Efrac_2Efrac__0,axiom,
    ( ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__0 )
    = c_2Efrac_2Efrac__0 )).

thf(tp_c_2Efrac_2Efrac__1,type,(
    c_2Efrac_2Efrac__1: $i )).

thf(mem_c_2Efrac_2Efrac__1,axiom,(
    mem @ c_2Efrac_2Efrac__1 @ ty_2Efrac_2Efrac )).

thf(stp_fo_c_2Efrac_2Efrac__1,type,(
    fo__c_2Efrac_2Efrac__1: tp__ty_2Efrac_2Efrac )).

thf(stp_eq_fo_c_2Efrac_2Efrac__1,axiom,
    ( ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__1 )
    = c_2Efrac_2Efrac__1 )).
...
thf(conj_thm_2Earithmetic_2EEQ__MULT__LCANCEL,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
      ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2p ) ) ) )
    <=> ( ( V0m = fo__c_2Enum_2E0 )
        | ( V1n = V2p ) ) ) )).
...
thf(ax_thm_2Efrac_2Efrac__1__def,axiom,
...
thf(conj_thm_2Efrac_2EFRAC__MUL__RID,lemma,(
    ! [V0a: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__mul @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) @ ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__1 ) ) )
      = V0a ) )).

thf(conj_thm_2Efrac_2EFRAC__AINV__0,lemma,
    ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__ainv @ ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__0 ) ) )
    = fo__c_2Efrac_2Efrac__0 )).

thf(conj_thm_2Efrac_2EFRAC__AINV__AINV,lemma,(
    ! [V0f1: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__ainv @ ( ap @ c_2Efrac_2Efrac__ainv @ ( inj__ty_2Efrac_2Efrac @ V0f1 ) ) ) )
      = V0f1 ) )).

thf(conj_thm_2Efrac_2EFRAC__MINV__1,lemma,
    ( ( surj__ty_2Efrac_2Efrac @ ( ap @ c_2Efrac_2Efrac__minv @ ( inj__ty_2Efrac_2Efrac @ fo__c_2Efrac_2Efrac__1 ) ) )
    = fo__c_2Efrac_2Efrac__1 )).
...
thf(conj_thm_2Einteger_2EINT__LT__01,lemma,(
...
thf(conj_thm_2Einteger_2EINT__NEG__EQ0,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__ABS__NUM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Einteger_2EINT__NEG__SAME__EQ,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
      ( ( V0p
...
thf(conj_thm_2Einteger_2EINT__ABS__NEG,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__ABS__EQ__ABS,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Erat_2Erat__def,lemma,(
...
thf(conj_thm_2Erat_2Erat__0,lemma,
...
thf(conj_thm_2Erat_2Erat__1,lemma,
...
thf(conj_thm_2Erat_2ERAT__MINV__CALCULATE,lemma,(
    ! [V0f1: tp__ty_2Efrac_2Efrac] :
      ( ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
...
thf(conj_thm_2Erat_2ERAT__LES__CALCULATE,lemma,(
...
thf(conj_thm_2Erat_2ERAT__LEQ__CALCULATE,lemma,(
    ! [V0f1: tp__ty_2Efrac_2Efrac,V1f2: tp__ty_2Efrac_2Efrac] :
...
thf(conj_thm_2Erat_2ERAT__OF__NUM__LES,lemma,(
...
thf(conj_thm_2Erat_2ERAT__ADD__COMM,lemma,(
...
thf(conj_thm_2Erat_2ERAT__AINV__0,lemma,
...
thf(conj_thm_2Erat_2ERAT__AINV__ADD,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERAT__AINV__EQ,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( ( ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__ainv @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) )
        = V1r2 )
    <=> ( V0r1
...
thf(conj_thm_2Erat_2ERAT__EQ__AINV,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( ( ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__ainv @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) )
        = ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__ainv @ ( inj__ty_2Erat_2Erat @ V1r2 ) ) ) )
    <=> ( V0r1 = V1r2 ) ) )).

thf(conj_thm_2Erat_2ERAT__LES__REF,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat] :
      ~ ( p @ ( ap @ ( ap @ c_2Erat_2Erat__les @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) ) )).

thf(conj_thm_2Erat_2ERAT__LES__ANTISYM,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( ( p @ ( ap @ ( ap @ c_2Erat_2Erat__les @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) @ ( inj__ty_2Erat_2Erat @ V1r2 ) ) )
     => ~ ( p @ ( ap @ ( ap @ c_2Erat_2Erat__les @ ( inj__ty_2Erat_2Erat @ V1r2 ) ) @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) ) ) )).

thf(conj_thm_2Erat_2ERAT__LES__TRANS,lemma,(
...
thf(conj_thm_2Erat_2ERAT__LES__TOTAL,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( ( p @ ( ap @ ( ap @ c_2Erat_2Erat__les @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) @ ( inj__ty_2Erat_2Erat @ V1r2 ) ) )
      | ( V0r1 = V1r2 )
      | ( p @ ( ap @ ( ap @ c_2Erat_2Erat__les @ ( inj__ty_2Erat_2Erat @ V1r2 ) ) @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) ) ) )).

thf(conj_thm_2Erat_2ERAT__LEQ__REF,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat] :
      ( p @ ( ap @ ( ap @ c_2Erat_2Erat__leq @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) @ ( inj__ty_2Erat_2Erat @ V0r1 ) ) ) )).

thf(conj_thm_2Erat_2ERAT__LES__01,lemma,(
...
thf(conj_thm_2Erat_2ERAT__LES__LEQ__TRANS,lemma,(
...
thf(conj_thm_2Erat_2ERAT__LEQ__LES__TRANS,lemma,(
    ! [V0a: tp__ty_2Erat_2Erat,V1b: tp__ty_2Erat_2Erat,V2c: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERAT__0LES__0LEQ__ADD,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERAT__RDIV__EQ,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat,V2r3: tp__ty_2Erat_2Erat] :
      ( ( V2r3
       != ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
     => ( ( V0r1
...
thf(conj_thm_2Erat_2ERAT__LES__AINV,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERAT__AINV__LES,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERAT__MUL__SIGN__CASES,lemma,(
...
thf(conj_thm_2Erat_2ERAT__NO__ZERODIV,lemma,(
    ! [V0r1: tp__ty_2Erat_2Erat,V1r2: tp__ty_2Erat_2Erat] :
      ( ( ( V0r1
          = ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
        | ( V1r2
...
thf(conj_thm_2Erat_2ERAT__OF__NUM,lemma,(
    ! [A_27a: del,V0n: $i] :
      ( ( mem @ V0n @ A_27a )
     => ( ( ( surj__ty_2Erat_2Erat @ ( ap @ c_2Erat_2Erat__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
...
thf(conj_thm_2Erat_2ERAT__EQ__NUM__CALCULATE,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Erat_2Erat__of__int__11,lemma,(
...
thf(conj_thm_2Erat_2Erat__of__int__of__num,lemma,(
...
thf(conj_thm_2Erat_2Erat__of__int__MUL,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Erat_2Erat__of__int__ainv,lemma,(
    ! [V0i: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Erat_2ERATN__LEAST,lemma,(
...
thf(conj_thm_2Erat_2ERATN__RATD__MULT,lemma,(
    ! [V0r: tp__ty_2Erat_2Erat] :
...
thf(conj_thm_2Erat_2ERATD__NEG,conjecture,(
    ! [V0r: tp__ty_2Erat_2Erat] :
