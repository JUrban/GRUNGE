...
thf(conj_thm_2Einteger_2EINT__POS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).

thf(conj_thm_2Einteger_2ENUM__POSINT,lemma,(
    ! [V0i: tp__ty_2Einteger_2Eint] :
     ...
     => ( p
        @ ( ap @ ( c_2Ebool_2E_3F_21 @ ty_2Enum_2Enum )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1n: $i] :
                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Einteger_2Eint ) @ ( inj__ty_2Einteger_2Eint @ V0i ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ V1n ) ) ) ) ) ) )).
...
thf(conj_thm_2Einteger_2EINT__OF__NUM,conjecture,(
    ! [V0i: tp__ty_2Einteger_2Eint] :
