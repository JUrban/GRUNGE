...
fof(conj_thm_2EordinalNotation_2Emain__lemma,lemma,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2EordinalNotation_2Eosyntax,bool))
     => ( ? [V1x] :
            ( mem(V1x,ty_2EordinalNotation_2Eosyntax)
            & p(ap(V0P,V1x))
            & p(ap(c_2EordinalNotation_2Eis__ord,V1x)) )
       => ? [V2x] :
            ( mem(V2x,ty_2EordinalNotation_2Eosyntax)
            & p(ap(V0P,V2x))
            & p(ap(c_2EordinalNotation_2Eis__ord,V2x))
            & ! [V3y] :
                ( mem(V3y,ty_2EordinalNotation_2Eosyntax)
               => ( ( p(ap(c_2EordinalNotation_2Eis__ord,V3y))
                    & p(ap(ap(c_2EordinalNotation_2Eoless,V3y),V2x)) )
                 => ~ p(ap(V0P,V3y)) ) ) ) ) ) )).
...
fof(conj_thm_2EordinalNotation_2EWF__ord__less,conjecture,(
