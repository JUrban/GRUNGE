...
fof(conj_thm_2Elist_2EBIGUNION__IMAGE__set__SUBSET,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1ls] :
                 ...
                 => ! [V2s] :
                      ( mem(V2s,arr(A_27a,bool))
                     => ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(A_27b,A_27b),V0f),ap(c_2Elist_2ELIST__TO__SET(A_27b),V1ls)))),V2s))
                      <=> ! [V3x] :
                            ( mem(V3x,A_27b)
