...
thf(thm_2Einteger_2EINT__EXP,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
      ( ( c_2Einteger_2Eint__exp @ ( c_2Einteger_2Eint__of__num @ V0n ) @ V1m )
      = ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2EEXP @ V0n @ V1m ) ) ) )).
...
thf(thm_2Einteger_2EINT__EXP__CALCULATE,conjecture,(
    ! [V0p: tyop_2Einteger_2Eint,V1n: tyop_2Enum_2Enum,V2m: tyop_2Enum_2Enum] :
      ( ( ( c_2Einteger_2Eint__exp @ V0p @ c_2Enum_2E0 )
        = ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
      & ( ( c_2Einteger_2Eint__exp @ ( c_2Einteger_2Eint__of__num @ V1n ) @ V2m )
        = ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2EEXP @ V1n @ V2m ) ) )
      & ( ( c_2Einteger_2Eint__exp @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ V1n ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ V2m ) ) )
        = ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EEXP @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ V2m ) ) ) ) ) ) )
      & ( ( c_2Einteger_2Eint__exp @ ( c_2Einteger_2Eint__neg @ ( c_2Einteger_2Eint__of__num @ V1n ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ V2m ) ) )
        = ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EEXP @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ V2m ) ) ) ) ) ) ) )).
