...
fof(conj_thm_2EHolSmt_2Er209,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1v] :
             ...
             => ! [V3w] :
                 ...
                 => ! [V4z] :
                     ...
                     => ! [V5a] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1v)),V2y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V3w)),V4z)))),V5a))
                          <=> ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,V0x),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V1v),V2y)),ap(ap(c_2Erealax_2Ereal__mul,V3w),V4z)))),ap(c_2Erealax_2Ereal__neg,V5a))) ) ) ) ) ) ) ) )).
