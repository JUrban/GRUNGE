...
tff(lmtp_f529,type,(
    f529: ( del * del * del * $i ) > $i )).

tff(lamtp_f529,axiom,(
...
tff(lmtp_f528,type,(
    f528: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f528,axiom,(
...
tff(lmtp_f527,type,(
    f527: ( del * del * del * del ) > $i )).

tff(lamtp_f527,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,A_27a: del] : mem(f527(A_27b,A_27a,A_27b,A_27a),arr(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(arr(A_27a,ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b))),arr(A_27a,ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)))))) )).
...
tff(ax_thm_2Estate__transformer_2Esequence__def,axiom,(
    ! [A_27a: del,A_27b: del] : c_2Estate__transformer_2Esequence(A_27a,A_27a) = ap(ap(c_2Elist_2EFOLDR(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))),f527(A_27b,A_27a,A_27b,A_27a)),ap(c_2Estate__transformer_2EUNIT(A_27a,A_27a),c_2Elist_2ENIL(A_27b))) )).

tff(conj_thm_2Estate__transformer_2Esequence__nil,conjecture,(
