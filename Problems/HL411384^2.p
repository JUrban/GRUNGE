...
thf(conj_thm_2Ereal__topology_2ECLOSED__EMPTY,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSED__CONNECTED__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
