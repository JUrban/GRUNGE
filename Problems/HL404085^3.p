...
thf(thm_2EPast__Temporal__Logic_2EPRENEX__NEXT__NORMAL__FORM,conjecture,(
    ! [V0t: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ...
      <=> ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V4t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a @ V4t ) @ ( V1b @ V4t ) )
          @ V0t ) )
      & ( ( ( V2a @ V0t )
          | ( c_2ETemporal__Logic_2ENEXT @ V1b @ V0t ) )
      <=> ( c_2ETemporal__Logic_2ENEXT
          @ ^ [V5t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a @ V5t ) @ ( V1b @ V5t ) )
          @ V0t ) )
      ...
      & ( ( c_2EPast__Temporal__Logic_2EPNEXT @ ( c_2ETemporal__Logic_2ENEXT @ V2a ) )
        = ( ^ [V6t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V6t ) @ ( V2a @ V6t ) ) ) )
      & ( ( c_2EPast__Temporal__Logic_2EPSNEXT @ ( c_2ETemporal__Logic_2ENEXT @ V2a ) )
        = ( ^ [V7t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V7t ) ) @ ( V2a @ V7t ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPALWAYS
            @ ^ [V8t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V8t ) @ ( V2a @ V8t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPEVENTUAL
            @ ^ [V9t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V9t ) ) @ ( V2a @ V9t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPSUNTIL @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a )
            @ ^ [V10t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V10t ) ) @ ( V1b @ V10t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPSWHEN @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a )
            @ ^ [V11t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V11t ) ) @ ( V1b @ V11t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPWHEN @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a )
            @ ^ [V12t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V12t ) ) @ ( V1b @ V12t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPBEFORE @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V2a )
            @ ^ [V13t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V13t ) ) @ ( V1b @ V13t ) ) ) ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPSBEFORE
            @ ^ [V14t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V14t ) ) @ ( V2a @ V14t ) )
        ...
        = ( c_2ETemporal__Logic_2ENEXT
          @ ( c_2EPast__Temporal__Logic_2EPUNTIL
            @ ^ [V15t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( c_2EPast__Temporal__Logic_2EInitPoint @ V15t ) @ ( V2a @ V15t ) )
            @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V1b ) ) ) )
