...
thf(thm_2Ereal__topology_2ECONTINUOUS__WITHIN__SUBSET,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o,V3x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V3x ) @ V1s ) )
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2t @ V1s ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V3x ) @ V2t ) ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__WITHIN__COMPOSE,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2x: tyop_2Erealax_2Ereal,V3s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V2x ) @ V3s ) )
        & ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V1g @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ ( V0f @ V2x ) ) @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V3s ) ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1g @ V0f ) @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V2x ) @ V3s ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE,conjecture,(
