...
thf(conj_thm_2Ewellorder_2Ewo2wo__IN__w2,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
     ...
     => ! [V1w2: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( ( mem @ V3y @ A_27b )
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V0w1 ) @ V1w2 ) @ V2x )
                      = ( ap @ ( c_2Eoption_2ESOME @ A_27b ) @ V3y ) )
                   => ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3y ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27b ) @ V1w2 ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2EIMAGE__wo2wo__SUBSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
