...
tff(conj_thm_2Ereal__topology_2EINFSUM__0,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,bool))
     => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V0s),k(ty_2Enum_2Enum,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
