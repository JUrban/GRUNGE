...
tff(conj_thm_2Ereal__topology_2EFRONTIER__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(c_2Ereal__topology_2EClosed,ap(c_2Ereal__topology_2Efrontier,V0s))) ) )).

tff(conj_thm_2Ereal__topology_2EINTERIOR__FRONTIER__EMPTY,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EFRONTIER__FRONTIER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2EOpen,V0s))
          | p(ap(c_2Ereal__topology_2EClosed,V0s)) )
