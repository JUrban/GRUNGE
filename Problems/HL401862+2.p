...
fof(conj_thm_2Epred__set_2EMAX__SET__THM,lemma,
    ...
    & ! [V0e] :
       ...
       => ! [V1s] :
           ...
           => ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V1s))
             => ap(c_2Epred__set_2EMAX__SET,ap(ap(c_2Epred__set_2EINSERT(ty_2Enum_2Enum),V0e),V1s)) = ap(ap(c_2Earithmetic_2EMAX,V0e),ap(c_2Epred__set_2EMAX__SET,V1s)) ) ) ) )).

fof(conj_thm_2Epred__set_2Ein__max__set,conjecture,(
    ! [V0s] :
     ...
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0s))
       => ! [V1x] :
           ...
           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1x),V0s))
             => p(ap(ap(c_2Earithmetic_2E_3C_3D,V1x),ap(c_2Epred__set_2EMAX__SET,V0s))) ) ) ) ) )).
