...
thf(thm_2Ellist_2ELAPPEND__ASSOC,conjecture,(
    ! [A_27a: d,V0ll1_2E0: u,V1ll2_2E0: u,V2ll3_2E0: u] :
      ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) ) ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll3_2E0 ) ) )
      = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll1_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELAPPEND_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1ll2_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2ll3_2E0 ) ) ) ) ) ) )).
