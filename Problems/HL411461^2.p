...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__MUL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ c_2Ereal__topology_2Econtinuous__on
                      @ ( lam @ ty_2Erealax_2Ereal
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1c @ V3x ) ) @ ( ap @ V2f @ V3x ) ) ) )
                    @ V0s ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__POW,conjecture,(
    ! [V0f: $i] :
             ...
             => ( p
                @ ( ap
                  @ ( ap @ c_2Ereal__topology_2Econtinuous__on
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V4x: $i] :
                          ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ V0f @ V4x ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
                  @ V1s ) ) ) ) ) )).
