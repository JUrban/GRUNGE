...
thf(c_2Efloat_2Eerror,type,(
    c_2Efloat_2Eerror: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal )).
...
thf(c_2Eieee_2Efloat__sub,type,(
    c_2Eieee_2Efloat__sub: tyop_2Eieee_2Efloat > tyop_2Eieee_2Efloat > tyop_2Eieee_2Efloat )).

thf(c_2Eieee_2Efsub,type,(
    c_2Eieee_2Efsub: ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) > tyop_2Eieee_2Eroundmode > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) )).
...
thf(c_2Eieee_2Eminus,type,(
    c_2Eieee_2Eminus: ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) )).
...
thf(thm_2Efloat_2Eerror__def,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Efloat_2Eerror @ V0x )
      = ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ ( c_2Eieee_2Efloat @ ( c_2Eieee_2Eround @ c_2Eieee_2Efloat__format @ c_2Eieee_2ETo__nearest @ V0x ) ) ) @ V0x ) ) )).
...
thf(thm_2Eieee_2Efsub,axiom,(
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum,V1m: tyop_2Eieee_2Eroundmode,V2a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ),V3b: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( c_2Eieee_2Efsub @ V0X @ V1m @ V2a @ V3b )
      = ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Eieee_2Eis__nan @ V0X @ V2a ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Eieee_2Eis__nan @ V0X @ V3b ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__infinity @ V0X @ V2a ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__infinity @ V0X @ V3b ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Eieee_2Esign @ V2a ) @ ( c_2Eieee_2Esign @ V3b ) ) ) ) ) ) @ ( c_2Eieee_2Esome__nan @ V0X ) @ ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Eieee_2Eis__infinity @ V0X @ V2a ) @ V2a @ ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Eieee_2Eis__infinity @ V0X @ V3b ) @ ( c_2Eieee_2Eminus @ V0X @ V3b ) @ ( c_2Eieee_2Ezerosign @ V0X @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__zero @ V0X @ V2a ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__zero @ V0X @ V3b ) @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Eieee_2Esign @ V2a ) @ ( c_2Eieee_2Esign @ V3b ) ) ) ) ) @ ( c_2Eieee_2Esign @ V2a ) @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ tyop_2Eieee_2Eroundmode @ V1m @ c_2Eieee_2ETo__ninfinity ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ c_2Enum_2E0 ) ) @ ( c_2Eieee_2Eround @ V0X @ V1m @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2Evalof @ V0X @ V2a ) @ ( c_2Eieee_2Evalof @ V0X @ V3b ) ) ) ) ) ) ) ) )).
...
thf(thm_2Eieee_2Efloat__sub,axiom,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( c_2Eieee_2Efloat__sub @ V0a @ V1b )
      = ( c_2Eieee_2Efloat @ ( c_2Eieee_2Efsub @ c_2Eieee_2Efloat__format @ c_2Eieee_2ETo__nearest @ ( c_2Eieee_2Edefloat @ V0a ) @ ( c_2Eieee_2Edefloat @ V1b ) ) ) ) )).
...
thf(thm_2Efloat_2EFLOAT__SUB,conjecture,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( ( c_2Eieee_2EFinite @ V0a )
        & ( c_2Eieee_2EFinite @ V1b )
        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) @ ( c_2Eieee_2Ethreshold @ c_2Eieee_2Efloat__format ) ) )
     => ( ( c_2Eieee_2EFinite @ ( c_2Eieee_2Efloat__sub @ V0a @ V1b ) )
        & ( ( c_2Eieee_2EVal @ ( c_2Eieee_2Efloat__sub @ V0a @ V1b ) )
          = ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) @ ( c_2Efloat_2Eerror @ ( c_2Ereal_2Ereal__sub @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) ) ) ) ) )).
