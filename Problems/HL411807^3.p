    ...
    ! [V0n: tyop_2Enum_2Enum] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
        @ ^ [V1m: tyop_2Enum_2Enum] :
            ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ $o @ V1m @ ( c_2Eprim__rec_2E_3C @ V1m @ V0n ) ) ) ) )).
    ...
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Epred__set_2EGSPEC @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
        @ ^ [V1x: tyop_2Enum_2Enum] :
            ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ $o @ V1x @ ( c_2Eprim__rec_2E_3C @ V1x @ V0n ) ) )
      = ( c_2Ebool_2ECOND @ ( tyop_2Enum_2Enum > $o ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V0n @ c_2Enum_2E0 ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Enum_2Enum ) @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ ( c_2Earithmetic_2E_2D @ V0n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(thm_2Eiterate_2ESUM__ABS,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V1s )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) )
        @ ( c_2Eiterate_2ESum @ A_27a @ V1s
          @ ^ [V2x: A_27a] :
              ( c_2Ereal_2Eabs @ ( V0f @ V2x ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ESUM__SUBSET,axiom,(
    ! [A_27a: $tType,V0u: A_27a > $o,V1v: A_27a > $o,V2f: A_27a > tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0u )
        & ( c_2Epred__set_2EFINITE @ A_27a @ V1v )
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Epred__set_2EDIFF @ A_27a @ V0u @ V1v ) )
           => ( c_2Ereal_2Ereal__lte @ ( V2f @ V3x ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
        & ! [V4x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V4x @ ( c_2Epred__set_2EDIFF @ A_27a @ V1v @ V0u ) )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V2f @ V4x ) ) ) )
...
thf(thm_2Eiterate_2ESUM__COMBINE__L,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum,V3p: tyop_2Enum_2Enum] :
      ( ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V2n )
        & ( c_2Earithmetic_2E_3C_3D @ V1m @ V2n )
        & ( c_2Earithmetic_2E_3C_3D @ V2n @ ( c_2Earithmetic_2E_2B @ V3p @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
     => ( ( c_2Erealax_2Ereal__add @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1m @ ( c_2Earithmetic_2E_2D @ V2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ V0f ) @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2n @ V3p ) @ V0f ) )
