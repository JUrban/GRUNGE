...
thf(thm_2EASCIInumbers_2En2s__s2n,conjecture,(
    ! [V0c2n: tyop_2Estring_2Echar > tyop_2Enum_2Enum,V1n2c: tyop_2Enum_2Enum > tyop_2Estring_2Echar,V2b: tyop_2Enum_2Enum,V3s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
      ( ( ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V2b )
        & ( c_2Elist_2EEVERY @ tyop_2Estring_2Echar @ ( c_2Ecombin_2Eo @ tyop_2Estring_2Echar @ $o @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2E_3E @ V2b ) @ V0c2n ) @ V3s ) )
     => ( ( c_2EASCIInumbers_2En2s @ V2b @ V1n2c @ ( c_2EASCIInumbers_2Es2n @ V2b @ V0c2n @ V3s ) )
        = ( c_2Ebool_2ECOND @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2EASCIInumbers_2Es2n @ V2b @ V0c2n @ V3s ) @ c_2Enum_2E0 ) @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ ( V1n2c @ c_2Enum_2E0 ) @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) ) @ ( c_2Elist_2EMAP @ tyop_2Estring_2Echar @ tyop_2Estring_2Echar @ ( c_2Ecombin_2Eo @ tyop_2Estring_2Echar @ tyop_2Estring_2Echar @ tyop_2Enum_2Enum @ V1n2c @ V0c2n ) @ ( c_2Erich__list_2ELASTN @ tyop_2Estring_2Echar @ ( c_2Enum_2ESUC @ ( c_2Elogroot_2ELOG @ V2b @ ( c_2EASCIInumbers_2Es2n @ V2b @ V0c2n @ V3s ) ) ) @ V3s ) ) ) ) ) )).
