...
thf(conj_thm_2Efinite__map_2EFRANGE__FUPDATE__DOMSUB,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( ( mem @ V0fm @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ A_27a )
...
thf(conj_thm_2Efinite__map_2EIN__FRANGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1v: $i] :
          ( ( mem @ V1v @ A_27b )
...
thf(conj_thm_2Ealist_2EALOOKUP__IN__FRANGE,conjecture,(
