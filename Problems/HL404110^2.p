...
thf(conj_thm_2Ebft_2EBFT__def,lemma,(
                 ...
                 => ! [V4h: $i] :
                     ...
                     => ! [V5t: $i] :
                         ...
                         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2EdirGraph_2EParents @ A_27a @ A_27a ) @ V0G ) ) )
                           => ( ( ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ A_27b @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ V3acc )
                                = V3acc )
                              & ( ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ A_27b @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V4h ) @ V5t ) ) @ V3acc )
                                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27b ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4h ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V2seen ) ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ A_27b @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ V5t ) @ V3acc ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ A_27b @ A_27a ) @ V0G ) @ V1f ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V4h ) @ V2seen ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V5t ) @ ( ap @ V0G @ V4h ) ) ) @ ( ap @ ( ap @ V1f @ V4h ) @ V3acc ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebft_2EBFT__ind,lemma,(
...
thf(conj_thm_2Ebft_2EBFT__CONS,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( ( mem @ V0G @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ! [V1f: $i] :
                     ...
                     => ! [V5a: $i] :
                         ...
                         => ! [V6b: $i] :
                             ...
                             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2EdirGraph_2EParents @ A_27a @ A_27a ) @ V0G ) ) )
                               ...
                               => ( ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ ( ty_2Elist_2Elist @ A_27a ) @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ V3fringe ) @ V4acc )
                                  = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ ( ty_2Elist_2Elist @ A_27a ) @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ V3fringe ) @ V5a ) ) @ V6b ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebft_2EBFT__FOLD,conjecture,(
    ! [A_27a: del,A_27b: del,V0G: $i] :
      ( ( mem @ V0G @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ( arr @ A_27b @ A_27b ) ) )
         => ! [V2seen: $i] :
             ...
             => ! [V3fringe: $i] :
                 ...
                 => ! [V4acc: $i] :
                      ( ( mem @ V4acc @ A_27b )
                     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2EdirGraph_2EParents @ A_27a @ A_27a ) @ V0G ) ) )
                       => ( ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ A_27b @ A_27a ) @ V0G ) @ V1f ) @ V2seen ) @ V3fringe ) @ V4acc )
                          = ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ A_27a @ A_27b ) @ V1f ) @ V4acc ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Ebft_2EBFT @ ( ty_2Elist_2Elist @ A_27a ) @ A_27a ) @ V0G ) @ ( c_2Elist_2ECONS @ A_27a ) ) @ V2seen ) @ V3fringe ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) ) ) ) ) ) )).
