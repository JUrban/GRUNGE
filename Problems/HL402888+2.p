...
fof(conj_thm_2Erich__list_2Ecount__list__sub1,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ( V0n != c_2Enum_2E0
       => ap(c_2Erich__list_2ECOUNT__LIST,V0n) = ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),c_2Enum_2E0),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2ESUC),ap(c_2Erich__list_2ECOUNT__LIST,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) ) ) )).
