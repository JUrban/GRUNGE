...
thf(c_2EerrorStateMonad_2EES__APPLY,type,(
    c_2EerrorStateMonad_2EES__APPLY: 
      !>[A_27a: $tType,A_27b: $tType,A_27c: $tType] :
        ( ( A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( A_27c > A_27b ) @ A_27a ) ) ) > ( A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ) ) > A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )).
...
thf(thm_2EerrorStateMonad_2EES__APPLY__DEF,axiom,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0fM: A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ ( A_27c > A_27b ) @ A_27a ) ),V1xM: A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) )] :
      ( ( c_2EerrorStateMonad_2EES__APPLY @ A_27a @ A_27b @ A_27c @ V0fM @ V1xM )
      = ( c_2EerrorStateMonad_2EBIND @ A_27a @ ( A_27c > A_27b ) @ A_27b @ V0fM
        @ ^ [V2f: A_27c > A_27b] :
            ( c_2EerrorStateMonad_2EBIND @ A_27a @ A_27c @ A_27b @ V1xM
            @ ^ [V3x: A_27c] :
                ( c_2EerrorStateMonad_2EUNIT @ A_27a @ A_27b @ ( V2f @ V3x ) ) ) ) ) )).
...
thf(thm_2EerrorStateMonad_2EAPPLY__UNIT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0xM: A_27a > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27c @ A_27a ) ),V1f: A_27c > A_27b] :
      ( ( c_2EerrorStateMonad_2EES__APPLY @ A_27a @ A_27b @ A_27c @ ( c_2EerrorStateMonad_2EUNIT @ A_27a @ ( A_27c > A_27b ) @ V1f ) @ V0xM )
      = ( c_2EerrorStateMonad_2EMMAP @ A_27a @ A_27b @ A_27c @ V1f @ V0xM ) ) )).
