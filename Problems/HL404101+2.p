...
fof(conj_thm_2Edivides_2EDIVIDES__ONE,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Edivides_2Eprime__divides__only__self,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Egcd_2EP__EUCLIDES,lemma,(
    ! [V0p] :
...
fof(conj_thm_2Ebag_2EBAG__GEN__PROD__POSITIVE,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ( ! [V1x] :
...
fof(conj_thm_2EprimeFactor_2EUNIQUE__PRIME__FACTORS,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1b1] :
