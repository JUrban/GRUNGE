...
tff(conj_thm_2Eintegral_2EDIVISION__MONO__LE,lemma,(
    ! [V0d: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
             ...
             => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,inj__ty_2Enum_2Enum(V3m))),ap(V0d,inj__ty_2Enum_2Enum(V4n)))) ) ) ) )).

tff(conj_thm_2Eintegral_2EDIVISION__MONO__LE__SUC,conjecture,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0d))
