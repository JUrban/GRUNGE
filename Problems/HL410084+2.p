...
fof(conj_thm_2Eproduct_2EPRODUCT__INV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V1s] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
               => ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3515(A_27a,V0f)) = ap(c_2Erealax_2Einv,ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),V0f)) ) ) ) ) )).
...
fof(conj_thm_2Eproduct_2EPRODUCT__DIV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
