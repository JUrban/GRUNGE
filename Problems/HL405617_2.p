...
tff(lamtp_f2159,axiom,(
    ! [A_27a: del] : mem(f2159(A_27a),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) )).

tff(lameq_f2159,axiom,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum] : ap(f2159(A_27a),inj__ty_2Enum_2Enum(V0i)) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),ap(c_2Eordinal_2EfromNat(A_27a),inj__ty_2Enum_2Enum(V0i))),inj__o(fo__c_2Ebool_2ET)) )).

tff(ax_thm_2Eordinal_2Eomega__def,axiom,(
    ! [A_27a: del] : c_2Eordinal_2Eomega(A_27a) = ap(c_2Eordinal_2Esup(A_27a),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2159(A_27a))) )).

tff(conj_thm_2Eordinal_2Elt__omega,conjecture,(
    ! [A_27a: del,V0a: $i] :
