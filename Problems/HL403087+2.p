...
fof(lameq_f892,axiom,(
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f892(V1b,V0a),V2t0) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f893(V1b)),f894(V0a,V1b)),V2t0)),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V0a),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESBEFORE__AS__WHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
