...
fof(conj_thm_2Efloat_2EFLOAT__DIV,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ! [V1b] :
          ( mem(V1b,ty_2Eieee_2Efloat)
         => ( ( p(ap(c_2Eieee_2EFinite,V0a))
              ...
              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2E_2F,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b)))),ap(c_2Eieee_2Ethreshold,c_2Eieee_2Efloat__format))) )
           => ( p(ap(c_2Eieee_2EFinite,ap(ap(c_2Eieee_2Efloat__div,V0a),V1b)))
              & ap(c_2Eieee_2EVal,ap(ap(c_2Eieee_2Efloat__div,V0a),V1b)) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2E_2F,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b))),ap(c_2Efloat_2Eerror,ap(ap(c_2Ereal_2E_2F,ap(c_2Eieee_2EVal,V0a)),ap(c_2Eieee_2EVal,V1b)))) ) ) ) ) )).
