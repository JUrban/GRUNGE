...
thf(conj_thm_2Erich__list_2ESUM__FOLDR,conjecture,(
    ! [V0l: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum] :
      ...
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDR @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ c_2Earithmetic_2E_2B ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ V0l ) ) ) ) )).
