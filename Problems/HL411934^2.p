...
thf(conj_thm_2Ereal__topology_2EBIGINTER__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(ax_thm_2Ereal__topology_2Efsigma,axiom,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Efsigma @ V0s ) )
      <=> ? [V1g: $i] :
            ...
            & ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V1g )
              = V0s ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EGDELTA__COMPLEMENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
