...
thf(conj_thm_2Esum_2Econd__sum__expand,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,A_27g: del,A_27h: del,V0P: $o] :
      ( ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2y: $i] :
              ( ( mem @ V2y @ A_27b )
             => ! [V3z: $i] :
                  ( ( mem @ V3z @ A_27a )
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27b @ A_27a ) ) @ ( inj__o @ V0P ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27b @ A_27a ) @ V1x ) ) @ ( ap @ ( c_2Esum_2EINL @ A_27b @ A_27a ) @ V2y ) )
                      = ( ap @ ( c_2Esum_2EINR @ A_27b @ A_27a ) @ V3z ) )
                  <=> ( ( p @ ( inj__o @ V0P ) )
                      & ( V3z = V1x ) ) ) ) ) )
      & ! [V4x: $i] :
          ( ( mem @ V4x @ A_27c )
         => ! [V5y: $i] :
             ...
             => ! [V6z: $i] :
                  ( ( mem @ V6z @ A_27d )
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27d @ A_27c ) ) @ ( inj__o @ V0P ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27d @ A_27c ) @ V4x ) ) @ ( ap @ ( c_2Esum_2EINL @ A_27d @ A_27c ) @ V5y ) )
                      = ( ap @ ( c_2Esum_2EINL @ A_27d @ A_27c ) @ V6z ) )
                  <=> ( ~ ( p @ ( inj__o @ V0P ) )
                      & ( V6z = V5y ) ) ) ) ) )
      & ! [V7x: $i] :
          ( ( mem @ V7x @ A_27e )
         => ! [V8y: $i] :
             ...
             => ! [V9z: $i] :
                  ( ( mem @ V9z @ A_27e )
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27e @ A_27f ) ) @ ( inj__o @ V0P ) ) @ ( ap @ ( c_2Esum_2EINL @ A_27e @ A_27f ) @ V7x ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27e @ A_27f ) @ V8y ) )
                      = ( ap @ ( c_2Esum_2EINL @ A_27e @ A_27f ) @ V9z ) )
                  <=> ( ( p @ ( inj__o @ V0P ) )
                      & ( V9z = V7x ) ) ) ) ) )
      & ! [V10x: $i] :
          ( ( mem @ V10x @ A_27g )
         => ! [V11y: $i] :
             ...
             => ! [V12z: $i] :
                  ( ( mem @ V12z @ A_27h )
                 => ( ( ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27g @ A_27h ) ) @ ( inj__o @ V0P ) ) @ ( ap @ ( c_2Esum_2EINL @ A_27g @ A_27h ) @ V10x ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27g @ A_27h ) @ V11y ) )
                      = ( ap @ ( c_2Esum_2EINR @ A_27g @ A_27h ) @ V12z ) )
                  <=> ( ~ ( p @ ( inj__o @ V0P ) )
                      & ( V12z = V11y ) ) ) ) ) ) ) )).
