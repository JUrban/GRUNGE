...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__SUBSET__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__upper__bound,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ebag_2EBAG__IN__BIG__BAG__UNION,conjecture,(
    ! [A_27a: del,V0P: $i] :
