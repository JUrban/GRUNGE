...
fof(conj_thm_2EdefCNF_2EDEF__SNOC,conjecture,(
    ! [V0n] :
     ...
     => ! [V1x] :
         ...
         => ! [V2l] :
             ...
             => ! [V3v] :
                 ...
                 => ( p(ap(ap(ap(c_2EdefCNF_2EDEF,V3v),V0n),ap(ap(c_2Elist_2ESNOC(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool)))),V1x),V2l)))
                  <=> ( p(ap(ap(ap(c_2EdefCNF_2EDEF,V3v),V0n),V2l))
                      & p(ap(ap(ap(c_2EdefCNF_2EUNIQUE,V3v),ap(ap(c_2Earithmetic_2E_2B,V0n),ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool)))),V2l))),V1x)) ) ) ) ) ) ) )).
