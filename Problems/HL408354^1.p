...
thf(thm_2Etransc_2ETAN__ADD,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( (~)
        ...
        & ( (~)
          @ ( ( mono_2Ec_2Etransc_2Ecos @ V1y )
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
        & ( (~)
          @ ( ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Erealax_2Ereal__add @ V0x @ V1y ) )
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )
     => ( ( mono_2Ec_2Etransc_2Etan @ ( mono_2Ec_2Erealax_2Ereal__add @ V0x @ V1y ) )
        = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Etransc_2Etan @ V0x ) @ ( mono_2Ec_2Etransc_2Etan @ V1y ) ) @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Etransc_2Etan @ V0x ) @ ( mono_2Ec_2Etransc_2Etan @ V1y ) ) ) ) ) ) )).

thf(thm_2Etransc_2ETAN__DOUBLE,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( (~)
          @ ( ( mono_2Ec_2Etransc_2Ecos @ V0x )
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
