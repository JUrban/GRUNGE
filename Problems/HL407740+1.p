...
fof(thm_2Enets_2EDORDER__LEMMA,axiom,(
    ! [A_27a,V0g_2E0] :
     ...
     => ! [V1P_2E0,V2Q_2E0] :
          ( ( ? [V3n_2E0] :
                ...
                & ! [V4m_2E0] :
                    ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V4m_2E0))),s(A_27a,V3n_2E0))))
                   => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V4m_2E0)))) ) )
            & ? [V5n_2E0] :
                ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V5n_2E0))),s(A_27a,V5n_2E0))))
                & ! [V6m_2E0] :
                    ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V6m_2E0))),s(A_27a,V5n_2E0))))
                   => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2Q_2E0),s(A_27a,V6m_2E0)))) ) ) )
         => ? [V7n_2E0] :
              ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V7n_2E0))),s(A_27a,V7n_2E0))))
              & ! [V8m_2E0] :
                  ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V8m_2E0))),s(A_27a,V7n_2E0))))
                 => ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V8m_2E0))))
                    & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2Q_2E0),s(A_27a,V8m_2E0)))) ) ) ) ) ) )).
...
fof(thm_2Enets_2ENET__LE,conjecture,(
    ! [A_27a,V0g_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Enets_2Edorder_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0))))
     => ! [V1x_2E0,V2x0_2E0,V3y_2E0,V4y0_2E0] :
          ( ( p(s(tyop_2Emin_2Ebool,c_2Enets_2Etends_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1x_2E0),s(tyop_2Erealax_2Ereal,V2x0_2E0),s(tyop_2Epair_2Eprod(tyop_2Etopology_2Etopology(tyop_2Erealax_2Ereal),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),c_2Epair_2E_2C_2E2(s(tyop_2Etopology_2Etopology(tyop_2Erealax_2Ereal),c_2Emetric_2Emtop_2E1(s(tyop_2Emetric_2Emetric(tyop_2Erealax_2Ereal),c_2Emetric_2Emr1_2E0))),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0))))))
            ...
            & ? [V5N_2E0] :
                ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V5N_2E0))),s(A_27a,V5N_2E0))))
                & ! [V6n_2E0] :
                    ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0g_2E0),s(A_27a,V6n_2E0))),s(A_27a,V5N_2E0))))
                   => p(s(tyop_2Emin_2Ebool,c_2Ereal_2Ereal__lte_2E2(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1x_2E0),s(A_27a,V6n_2E0))),s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V3y_2E0),s(A_27a,V6n_2E0)))))) ) ) )
         => p(s(tyop_2Emin_2Ebool,c_2Ereal_2Ereal__lte_2E2(s(tyop_2Erealax_2Ereal,V2x0_2E0),s(tyop_2Erealax_2Ereal,V4y0_2E0)))) ) ) )).
