...
fof(conj_thm_2ECoder_2Ewf__coder,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
...
fof(conj_thm_2ECoder_2Ewf__coder__closed,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
          ( mem(V0c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(lamtp_f2442,axiom,(
    ! [A_27a,V1c] :
      ( mem(V1c,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V0phi] :
          ( mem(V0phi,arr(A_27a,bool))
         => mem(f2442(A_27a,V1c,V0phi),arr(ty_2Elist_2Elist(bool),bool)) ) ) )).
...
fof(lameq_f2442,axiom,(
    ! [A_27a,V1c] :
     ...
     => ! [V0phi] :
          ( mem(V0phi,arr(A_27a,bool))
         => ! [V4w] :
              ( mem(V4w,ty_2Elist_2Elist(bool))
             => ap(f2442(A_27a,V1c,V0phi),V4w) = ap(V0phi,ap(ap(c_2ECoder_2Edecoder(A_27a),V1c),V4w)) ) ) ) )).

fof(conj_thm_2EEncodeVar_2Efixed__width__exists,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0phi] :
          ( mem(V0phi,arr(A_27a,bool))
             ...
             => ! [V2n] :
                 ...
                 => ( ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V1c))
                   ...
                   => ( ? [V3x] :
                          ...
                          & p(ap(V0phi,V3x)) )
                    <=> p(ap(ap(c_2Ebool_2ERES__EXISTS(ty_2Elist_2Elist(bool)),ap(c_2EEncodeVar_2Eof__length(bool),V2n)),f2442(A_27a,V1c,V0phi))) ) ) ) ) ) ) )).
