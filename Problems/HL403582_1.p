...
tff(f4760_0_2E0,type,(
    f4760_0_2E0: u )).

tff(f4760_0_2E1,type,(
    f4760_0_2E1: du > u )).

tff(f4760_0_2E3,type,(
    f4760_0_2E3: ( du * du * du ) > u )).
...
tff(c_2Ewellorder_2Efl_2E0,type,(
    c_2Ewellorder_2Efl_2E0: u )).

tff(c_2Ewellorder_2Efl_2E1,type,(
    c_2Ewellorder_2Efl_2E1: du > u )).

tff(c_2Ewellorder_2Efl_2E2,type,(
    c_2Ewellorder_2Efl_2E2: ( du * du ) > u )).
...
tff(arityeq1_2Ef4760_0_2E1,axiom,(
...
tff(arityeq2_2Ec_2Ewellorder_2Efl_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ewellorder_2Efl_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),X0_2E0),s(A_27a,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),c_2Ewellorder_2Efl_2E0),s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),X0_2E0))),s(A_27a,X1_2E0)))) )).

tff(arityeq1_2Ec_2Ewellorder_2Efl_2E1,axiom,(
...
tff(thm_2Ewellorder_2Efl,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ewellorder_2Efl_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),V0l_2E0),s(A_27a,V1x_2E0)))))
    <=> ? [V2y_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),V0l_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V1x_2E0),s(A_27a,V2y_2E0)))))))
          | p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Epair_2Eprod(A_27a,A_27a),tyop_2Emin_2Ebool),V0l_2E0),s(tyop_2Epair_2Eprod(A_27a,A_27a),c_2Epair_2E_2C_2E2(s(A_27a,V2y_2E0),s(A_27a,V1x_2E0))))))) ) ) )).

tff(def0_2Ethm_2Ewellorder_2EFL__RESTRICTED__SUBSET,axiom,(
    ! [A_27a: d,V0P_2E0: u,V1x_2E0: u,V2y_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f4760_0_2E3(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V2y_2E0)))))
