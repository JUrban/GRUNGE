...
tff(conj_thm_2Elebesgue_2Eintegral__pos__fn,lemma,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),V1f)) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
           ...
           => ( p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4200(A_27a,V1f)))
              & surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4201(A_27a,V1f))) ) ) ) ) )).

tff(conj_thm_2Elebesgue_2Eintegrable__not__infty__alt2,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
