...
tff(conj_thm_2Ewords_2EWORD__EXTRACT__OVER__MUL,conjecture,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2h: tp__ty_2Enum_2Enum] :
             ...
             => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Ewords_2Eword__mul(A_27a),V0a),V1b)) = ap(ap(c_2Ewords_2Eword__mul(A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0a)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),inj__ty_2Enum_2Enum(V2h)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V1b)) ) ) ) )).
