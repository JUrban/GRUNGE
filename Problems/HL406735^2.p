...
thf(conj_thm_2Eveblen_2Emono__natI,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eveblen_2Esup__mem__INTER,lemma,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ ty_2Enum_2Enum @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
         => ( ( ! [V2n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( c_2Eveblen_2Eclub @ A_27a ) @ ( ap @ V0A @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
              & ! [V3n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ V0A @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) @ ( ap @ V0A @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) )
              & ! [V4n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ V0A @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) )
              ...
              @ ( ap
                @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
                  @ ( ap @ ( c_2Eordinal_2Esup @ A_27a )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ty_2Enum_2Enum )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V7n: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ ( ap @ V1f @ V7n ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) ) ) )
                @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ ty_2Enum_2Enum )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V8n: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ bool ) @ ( ap @ V0A @ V8n ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eveblen_2Eoleast__leq,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Eveblen_2Eclub__INTER,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( ( mem @ V0A @ ( arr @ ty_2Enum_2Enum @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) ) )
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( c_2Eveblen_2Eclub @ A_27a ) @ ( ap @ V0A @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
          & ! [V2n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ V0A @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ V0A @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) )
       => ( p
          @ ( ap @ ( c_2Eveblen_2Eclub @ A_27a )
            @ ( ap @ ( c_2Epred__set_2EBIGINTER @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3n: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ bool ) @ ( ap @ V0A @ V3n ) ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) ) ) ) ) ) ) )).
