...
fof(conj_thm_2Ereal__topology_2EMONOTONE__BIGGER,lemma,(
    ! [V0r] :
     ...
     => ( ! [V1m] :
           ...
           => ! [V2n] :
               ...
               => ( p(ap(ap(c_2Eprim__rec_2E_3C,V1m),V2n))
                 => p(ap(ap(c_2Eprim__rec_2E_3C,ap(V0r,V1m)),ap(V0r,V2n))) ) ) )
       => ! [V3n] :
            ( mem(V3n,ty_2Enum_2Enum)
           => p(ap(ap(c_2Earithmetic_2E_3C_3D,V3n),ap(V0r,V3n))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__SUBSEQUENCE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1r] :
