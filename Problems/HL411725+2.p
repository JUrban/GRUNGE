...
fof(conj_thm_2Ereal__topology_2EREAL__AFFINITY__EQ,conjecture,(
    ! [V0m] :
         ...
         => ! [V2x] :
             ...
             => ! [V3y] :
                 ...
                 => ( V0m != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                   => ( ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V2x)),V1c) = V3y
                    <=> V2x = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V3y)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,V1c),V0m))) ) ) ) ) ) ) )).
