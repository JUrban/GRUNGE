...
tff(conj_thm_2Ellist_2ELDROP__SOME__LLENGTH,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1ll: $i] :
     ...
     => ! [V2l: $i] :
         ...
         => ! [V3m: tp__ty_2Enum_2Enum] :
              ( ( ap(ap(c_2Ellist_2ELDROP(A_27a),inj__ty_2Enum_2Enum(V0n)),V1ll) = ap(c_2Eoption_2ESOME(ty_2Ellist_2Ellist(A_27a)),V2l)
                & surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),V1ll)) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3m))) )
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V3m)))
                & surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),V2l)) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V0n)))) ) ) ) ) )).
