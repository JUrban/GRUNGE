...
fof(ax_thm_2Eieee_2Eplus__infinity,axiom,(
    ! [V0X] :
      ( mem(V0X,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(c_2Eieee_2Eplus__infinity,V0X) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eieee_2Eemax,V0X)),c_2Enum_2E0)) ) )).

fof(ax_thm_2Eieee_2Eminus__infinity,axiom,(
    ! [V0X] :
      ( mem(V0X,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(c_2Eieee_2Eminus__infinity,V0X) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eieee_2Eemax,V0X)),c_2Enum_2E0)) ) )).
...
fof(conj_thm_2Efloat_2EFLOAT__INFINITIES__SIGNED,conjecture,
    ( ap(c_2Eieee_2Esign,ap(c_2Eieee_2Edefloat,c_2Eieee_2EPlus__infinity)) = c_2Enum_2E0
    & ap(c_2Eieee_2Esign,ap(c_2Eieee_2Edefloat,c_2Eieee_2EMinus__infinity)) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) )).
