...
tff(lmtp_f334,type,(
    f334: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f334,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V0f: $i] :
     ...
     => ! [V5x: $i] :
         ...
         => ! [V1r: $i] :
             ...
             => mem(f334(A_27a,A_27b,A_27a,V0f,V5x,V1r),arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)))) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,A_27a: del,V0f: $i] :
     ...
     => ! [V5x: $i] :
         ...
         => ! [V1r: $i] :
             ...
             => ! [V6y: $i] :
                  ( mem(V6y,A_27a)
                 => ap(f334(A_27a,A_27b,A_27a,V0f,V5x,V1r),V6y) = ap(ap(c_2Epair_2E_2C(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epair_2E_2C(A_27b,A_27b),ap(V0f,V5x)),ap(V0f,V6y))),ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V5x),V6y)),V1r)) ) ) ) ) )).

tff(lmtp_f333,type,(
    f333: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f333,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1r: $i] :
          ( mem(V1r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
         => mem(f333(A_27a,A_27b,A_27a,A_27a,V0f,V1r),arr(A_27a,arr(A_27a,ty_2Epair_2Eprod(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b))))) ) ) )).
...
tff(lameq_f333,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,A_27a: del,V0f: $i] :
     ...
     => ! [V1r: $i] :
         ...
         => ! [V5x: $i] :
              ( mem(V5x,A_27a)
             => ap(f333(A_27a,A_27b,A_27a,A_27a,V0f,V1r),V5x) = f334(A_27a,A_27b,A_27a,V0f,V5x,V1r) ) ) ) )).

tff(conj_thm_2Eset__relation_2Efinite__prefixes__inj__image,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1r: $i] :
          ( mem(V1r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: $i] :
               ...
               => p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27b,A_27b),ap(c_2Epred__set_2EGSPEC(ty_2Epair_2Eprod(A_27b,A_27b),ty_2Epair_2Eprod(A_27b,A_27b)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f333(A_27a,A_27b,A_27a,A_27a,V0f,V1r)))),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s))) ) ) ) ) )).
