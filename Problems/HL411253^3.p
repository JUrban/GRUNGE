...
thf(thm_2Ereal__topology_2EOPEN__MAP__INTERIORS,conjecture,(
    ...
    <=> ! [V2s: tyop_2Erealax_2Ereal > $o] :
          ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Einterior @ V2s ) ) @ ( c_2Ereal__topology_2Einterior @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) ) ) ) )).
