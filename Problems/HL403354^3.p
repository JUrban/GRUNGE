...
thf(thm_2Ebag_2EBAG__CHOICE__DEF,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( (~)
        @ ( V0b
          = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )
     => ( c_2Ebag_2EBAG__IN @ A_27a @ ( c_2Ebag_2EBAG__CHOICE @ A_27a @ V0b ) @ V0b ) ) )).
...
thf(thm_2Ebag_2EITBAG__INSERT,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0x: A_27a,V1b: A_27a > tyop_2Enum_2Enum,V2f: A_27a > A_27b > A_27b,V3acc: A_27b] :
      ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V1b )
     => ( ( c_2Ebag_2EITBAG @ A_27a @ A_27b @ V2f @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V1b ) @ V3acc )
        = ( c_2Ebag_2EITBAG @ A_27a @ A_27b @ V2f @ ( c_2Ebag_2EBAG__REST @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V1b ) ) @ ( V2f @ ( c_2Ebag_2EBAG__CHOICE @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0x @ V1b ) ) @ V3acc ) ) ) ) )).
...
thf(thm_2Ebag_2ECOMMUTING__ITBAG__INSERT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b > A_27b,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( ! [V2x: A_27a,V3y: A_27a,V4z: A_27b] :
            ( ( V0f @ V2x @ ( V0f @ V3y @ V4z ) )
            = ( V0f @ V3y @ ( V0f @ V2x @ V4z ) ) )
        & ( c_2Ebag_2EFINITE__BAG @ A_27a @ V1b ) )
     => ! [V5x: A_27a,V6a: A_27b] :
          ( ( c_2Ebag_2EITBAG @ A_27a @ A_27b @ V0f @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V5x @ V1b ) @ V6a )
          = ( c_2Ebag_2EITBAG @ A_27a @ A_27b @ V0f @ V1b @ ( V0f @ V5x @ V6a ) ) ) ) )).
