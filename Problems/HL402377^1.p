...
thf(f2574_0_2E0,type,(
    f2574_0_2E0: u )).

thf(f2574_0_2E1,type,(
    f2574_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2574_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2574_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f2574_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eres__quan_2ERES__SELECT__EMPTY,axiom,(
    ! [A_27a: d,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2574_0_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2Eres__quan_2ERES__SELECT__EMPTY,conjecture,(
    ! [A_27a: d,V0p_2E0: u] :
      ( ( s @ A_27a @ ( c_2Ebool_2ERES__SELECT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EEMPTY_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0p_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ f2574_0_2E0 ) ) ) ) )).
