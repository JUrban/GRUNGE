...
fof(conj_thm_2Efinite__map_2EFRANGE__DOMSUB__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0fm] :
             ...
             => ! [V1k] :
                  ( mem(V1k,A_27b)
                 => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2Efdomsub(A_27b,A_27b),V0fm),V1k))),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),V0fm))) ) ) ) ) )).

fof(conj_thm_2Efinite__map_2EIN__FRANGE__DOMSUB__suff,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1P] :
                 ...
                 => ! [V2k] :
                     ...
                     => ( ! [V3v] :
                       ...
                       => ! [V4v] :
                            ( mem(V4v,A_27a)
                           => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4v),ap(c_2Efinite__map_2EFRANGE(A_27b,A_27b),ap(ap(c_2Efinite__map_2Efdomsub(A_27b,A_27b),V0fm),V2k))))
                             => p(ap(V1P,V4v)) ) ) ) ) ) ) ) ) )).
