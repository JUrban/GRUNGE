...
thf(thm_2Eiterate_2ESUM__UNION__EQ,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o,V2t: A_27a > $o,V3u: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V3u )
        & ( ( c_2Epred__set_2EINTER @ A_27a @ V1s @ V2t )
          = ( c_2Epred__set_2EEMPTY @ A_27a ) )
        & ( ( c_2Epred__set_2EUNION @ A_27a @ V1s @ V2t )
          = V3u ) )
     => ( ( c_2Erealax_2Ereal__add @ ( c_2Eiterate_2ESum @ A_27a @ V1s @ V0f ) @ ( c_2Eiterate_2ESum @ A_27a @ V2t @ V0f ) )
        = ( c_2Eiterate_2ESum @ A_27a @ V3u @ V0f ) ) ) )).
