...
thf(thm_2Emeasure_2ECARATHEODORY__LEMMA,axiom,(
    ! [A_27a: $tType,V0gsig: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1lam: ( A_27a > $o ) > tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Emeasure_2Emeasure__space @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Espace @ A_27a @ V0gsig ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ V0gsig @ V1lam ) @ V1lam ) ) ) ) )).
...
thf(thm_2Emeasure_2EALGEBRA__SUBSET__LAMBDA__SYSTEM,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        ...
        & ( c_2Emeasure_2Eincreasing @ A_27a @ V0m )
        & ( c_2Emeasure_2Eadditive @ A_27a @ V0m ) )
     => ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) @ ( c_2Emeasure_2Elambda__system @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Epred__set_2EPOW @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) ) ) @ ( c_2Emeasure_2Einf__measure @ A_27a @ V0m ) ) ) ) )).
...
thf(thm_2Emeasure_2ECARATHEODORY,conjecture,(
    ! [A_27a: $tType,V0m0: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m0 ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m0 ) ) )
        & ( c_2Emeasure_2Epositive @ A_27a @ V0m0 )
        & ( c_2Emeasure_2Ecountably__additive @ A_27a @ V0m0 ) )
     => ? [V1m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
          ( ! [V2s: A_27a > $o] :
              ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2s @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m0 ) )
             => ( ( c_2Emeasure_2Emeasure @ A_27a @ V1m @ V2s )
                = ( c_2Emeasure_2Emeasure @ A_27a @ V0m0 @ V2s ) ) )
          & ( ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) )
            = ( c_2Emeasure_2Esigma @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m0 ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m0 ) ) )
