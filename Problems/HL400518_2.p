...
tff(conj_thm_2Eoption_2EOPTION__MAP2__SOME,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
     ...
     => ! [V1o1: $i] :
         ...
         => ! [V2o2: $i] :
             ...
             => ! [V3v: $i] :
                  ( mem(V3v,A_27c)
                 => ( ap(ap(ap(c_2Eoption_2EOPTION__MAP2(A_27c,A_27c,A_27c),V0f),V1o1),V2o2) = ap(c_2Eoption_2ESOME(A_27c),V3v)
                  <=> ? [V4x1: $i] :
                        ( mem(V4x1,A_27a)
                        & ? [V5x2: $i] :
                            ( mem(V5x2,A_27b)
