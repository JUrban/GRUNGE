...
thf(f11979_0_2E0,type,(
    f11979_0_2E0: u )).

thf(f11979_0_2E2,type,(
    f11979_0_2E2: du > du > u )).

thf(f11979_0_2E3,type,(
    f11979_0_2E3: du > du > du > u )).

thf(f9457_0_2E0,type,(
    f9457_0_2E0: u )).

thf(f9457_0_2E2,type,(
    f9457_0_2E2: du > du > u )).

thf(f9457_0_2E3,type,(
...
thf(mono_2Ef9457_0,type,(
    mono_2Ef9457_0: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eseq_2ESER__CMUL,axiom,(
    ! [V2c: mono_2Etyop_2Erealax_2Ereal,V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9457_0 @ V2c @ V0x @ V3n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V2c @ ( V0x @ V3n ) ) ) )).

thf(thm_2Eseq_2ESER__CMUL,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Esums @ V0x @ V1x0 )
     => ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9457_0 @ V2c @ V0x ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V2c @ V1x0 ) ) ) )).

thf(def0_2Ethm_2Emeasure_2EMEASURE__SPACE__CMUL,axiom,(
    ! [A_27a: d,V1c: mono_2Etyop_2Erealax_2Ereal,V0m_2E0: u,V2a_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( f11979_0_2E3 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V1c ) ) @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2a_2E0 ) ) ) )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Emeasure_2Emeasure_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2a_2E0 ) ) ) ) ) ) )).

thf(thm_2Emeasure_2EMEASURE__SPACE__CMUL,conjecture,(
