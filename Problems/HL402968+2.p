...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__REDUNDANT__SUC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1r] :
                 ...
                 => ! [V2rs] :
                     ...
                     => ! [V3i] :
                         ...
                         => ( p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),ap(ap(c_2Elist_2ECONS(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1r),V2rs)),ap(c_2Enum_2ESUC,V3i)))
                          <=> ( ( ap(V1r,V0v) != c_2Eoption_2ENONE(A_27b)
                              ...
                              | p(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__REDUNDANT(A_27a,A_27a),V0v),V2rs),V3i)) ) ) ) ) ) ) ) ) )).
