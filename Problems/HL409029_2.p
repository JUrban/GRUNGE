...
tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(ap(c_2Ecomplex_2Ecomplex__mul,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V1y)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) )).

tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__INV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__inv,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x)))) )).

tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__DIV,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(ap(c_2Ecomplex_2Ecomplex__div,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V1y)))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) )).
