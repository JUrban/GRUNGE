...
tff(conj_thm_2Epred__set_2EIMAGE__SUBSET__gen,conjecture,(
         ...
         => ! [V2u: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V1s),V2u))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2u)),V3t)) )
                   => p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)),V3t)) ) ) ) ) ) )).
