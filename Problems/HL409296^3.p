...
thf(thm_2Elift__ieee_2Eerror__def,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Elift__ieee_2Eerror @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ V0x )
      = ( c_2Ereal_2Ereal__sub @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ ( c_2Ebinary__ieee_2Eround @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0x ) ) @ V0x ) ) )).
...
thf(thm_2Elift__ieee_2Eerror__at__worst__lemma,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0a: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ ( c_2Elift__ieee_2Eerror @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ V1x ) ) @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a ) @ V1x ) ) ) ) )).

thf(thm_2Elift__ieee_2Eerror__is__zero,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0a: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w,V1x: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w @ V0a )
        & ( ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a )
          = V1x ) )
     => ( ( c_2Elift__ieee_2Eerror @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ V1x )
        = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).
...
thf(thm_2Ereal_2EREAL__DIV__OUTER__CANCEL,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal,V2z: tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0x
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2E_2F @ V0x @ V1y ) @ ( c_2Ereal_2E_2F @ V2z @ V0x ) )
        = ( c_2Ereal_2E_2F @ V2z @ V1y ) ) ) )).
...
thf(thm_2Ewords_2EZERO__LT__INT__MIN,axiom,(
    ! [A_27a: $tType] :
      ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ ( c_2Ewords_2EINT__MIN @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )).
...
thf(thm_2Ewords_2EZERO__LT__UINT__MAX,axiom,(
    ! [A_27a: $tType] :
      ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ ( c_2Ewords_2EUINT__MAX @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )).
...
thf(thm_2Ewords_2EINT__MAX__LT__DIMWORD,axiom,(
    ! [A_27a: $tType] :
      ( c_2Eprim__rec_2E_3C @ ( c_2Ewords_2EINT__MAX @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Ewords_2Edimword @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) )).
...
thf(thm_2Ewords_2Eword__T__not__zero,axiom,(
    ! [A_27a: $tType] :
      ( (~)
      @ ( ( c_2Ewords_2Eword__2comp @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
        = ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) ) ) )).

thf(thm_2Elift__ieee_2Erelative__error,conjecture,(
    ! [A_27t: $tType,A_27w: $tType,V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Elift__ieee_2Enormalizes @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ V0x )
     => ? [V1e: tyop_2Erealax_2Ereal] :
          ...
          & ( ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ ( c_2Ebinary__ieee_2Eround @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0x ) )
