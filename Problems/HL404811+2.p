...
fof(conj_thm_2Efinite__map_2EFUPDATE__EQ__FUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0fm] :
             ...
             => ! [V1kv] :
                 ...
                 => ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0fm),V1kv) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1kv)),V0fm) ) ) ) ) )).
