...
fof(mem_c_2Ewords_2Eword__from__bin__list,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__from__bin__list(A_27a),arr(ty_2Elist_2Elist(ty_2Enum_2Enum),ty_2Efcp_2Ecart(bool,bool))) ) )).

fof(mem_c_2Ewords_2Eword__to__bin__list,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__to__bin__list(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Elist_2Elist(ty_2Enum_2Enum))) ) )).
...
fof(conj_thm_2Ewords_2Eword__bin__list,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__from__bin__list(A_27a)),c_2Ewords_2Eword__to__bin__list(A_27a)) = c_2Ecombin_2EI(ty_2Efcp_2Ecart(bool,bool)) ) )).
