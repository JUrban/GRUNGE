...
thf(conj_thm_2Ecomparison_2Egood__cmp__trans,conjecture,(
                    ...
                    @ ^ [V2v: $i] :
                        ...
                        @ ( lam @ A_27a
                          @ ^ [V3k_27: $i] :
                              ( lam @ A_27b
                              @ ^ [V4v_27: $i] :
                                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2EternaryComparisons_2Eordering ) @ ( ap @ ( ap @ V0cmp @ V1k ) @ V3k_27 ) ) @ ( inj__ty_2EternaryComparisons_2Eordering @ fo__c_2EternaryComparisons_2ELESS ) ) ) ) ) ) ) ) ) ) ) ) )).
