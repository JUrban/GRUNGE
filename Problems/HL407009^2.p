...
thf(conj_thm_2Einteger_2EINT__REM,lemma,(
...
thf(conj_thm_2Einteger_2EINT__REM__NEG,lemma,(
...
thf(conj_thm_2Einteger_2EINT__REM0,lemma,(
...
thf(conj_thm_2Einteger__word_2EINT__ZERO__LT__INT__MIN,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ ( ap @ ( c_2Einteger__word_2EINT__MIN @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).
...
thf(conj_thm_2Einteger__word_2Eword__msb__i2w__lt__0,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] :
      ( ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ ( c_2Einteger__word_2EINT__MIN @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( inj__ty_2Einteger_2Eint @ V0i ) ) )
        & ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V0i ) ) @ ( ap @ ( c_2Einteger__word_2EINT__MAX @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )
     => ( ( p @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( inj__ty_2Einteger_2Eint @ V0i ) ) ) )
      <=> ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ ( inj__ty_2Einteger_2Eint @ V0i ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).

thf(conj_thm_2Einteger__word_2Ei2w__pos,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
...
thf(conj_thm_2Einteger__word_2Eword__rem,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( V1b
             != ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
           => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__rem @ A_27a ) @ V0a ) @ V1b )
              = ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ ( ap @ c_2Einteger_2Eint__rem @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ V0a ) ) @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ V1b ) ) ) ) ) ) ) )).
