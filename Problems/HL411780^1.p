...
thf(f12669_0_2E0,type,(
    f12669_0_2E0: u )).

thf(f12669_0_2E1,type,(
    f12669_0_2E1: du > u )).

thf(f12669_0_2E2,type,(
...
thf(mono_2Ef12669_0,type,(
    mono_2Ef12669_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2EINFSUM__NEG,axiom,(
    ! [V1x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12669_0 @ V1x @ V2n )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V1x @ V2n ) ) ) )).

thf(thm_2Ereal__topology_2EINFSUM__NEG,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V1x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V0s @ ( mono_2Ef12669_0 @ V1x ) )
        = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V0s @ V1x ) ) ) ) )).
