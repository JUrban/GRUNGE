...
fof(conj_thm_2Ewellorder_2EelsOf__cardeq__iso,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1wo] :
                  ( mem(V1wo,ty_2Ewellorder_2Ewellorder(A_27b))
                 => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27b,A_27b),V0f),ap(c_2Ewellorder_2EelsOf(A_27b),V1wo)),c_2Epred__set_2EUNIV(A_27a)))
                   => ? [V2wo_27] :
                        ( mem(V2wo_27,ty_2Ewellorder_2Ewellorder(A_27a))
                        & p(ap(ap(c_2Ewellorder_2Eorderiso(A_27b,A_27b),V1wo),V2wo_27)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eordinal_2EelsOf__allOrds,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Eordinal_2Ewellorder__ordinal__isomorphism,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
...
fof(conj_thm_2Eordinal_2Euniv__ord__greater__cardinal,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),c_2Epred__set_2EUNIV(ty_2Eordinal_2Eordinal(A_27a))),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )).
