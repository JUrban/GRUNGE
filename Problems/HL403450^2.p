...
thf(tp_c_2EEncode_2Eencode__list,type,(
    c_2EEncode_2Eencode__list: del > $i )).

thf(mem_c_2EEncode_2Eencode__list,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2EEncode_2Eencode__list__def,axiom,(
    ! [A_27a: del] :
      ( ! [V0xb: $i] :
          ( ( mem @ V0xb @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
         => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__list @ A_27a ) @ V0xb ) @ ( c_2Elist_2ENIL @ A_27a ) ) )
      ...
      & ! [V1xb: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3xs: $i] :
                 ...
                 => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__list @ A_27a ) @ V1xb ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V3xs ) ) )
                    = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ bool ) @ ( ap @ V1xb @ V2x ) ) @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__list @ A_27a ) @ V1xb ) @ V3xs ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2EEncode_2Eencode__list__cong,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
                 ...
                 => ( ( ( V0l1 = V1l2 )
                      & ! [V4x: $i] :
                         ...
                         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4x ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ V1l2 ) ) )
                           => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V2f1 @ V4x ) )
                              = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V3f2 @ V4x ) ) ) ) ) )
                   => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__list @ A_27a ) @ V2f1 ) @ V0l1 ) )
                      = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__list @ A_27a ) @ V3f2 ) @ V1l2 ) ) ) ) ) ) ) ) )).
