...
tff(conj_thm_2Elist_2ELIST__REL__strongind,lemma,(
         ...
         => ( ( p(ap(ap(V1LIST__REL_27,c_2Elist_2ENIL(A_27a)),c_2Elist_2ENIL(A_27b)))
                     ...
                     => ! [V4t1: $i] :
                         ...
                         => ! [V5t2: $i] :
                             ...
                             => ( ( p(ap(ap(V0R,V2h1),V3h2))
                                  & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V4t1),V5t2))
           ...
           => ! [V6a0: $i] :
               ...
               => ! [V7a1: $i] :
                   ...
                   => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V6a0),V7a1))
                     => p(ap(ap(V1LIST__REL_27,V6a0),V7a1)) ) ) ) ) ) ) )).

tff(conj_thm_2Elist_2ELIST__REL__LENGTH,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1x: $i] :
