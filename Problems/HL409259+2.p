...
fof(conj_thm_2Etransc_2EDIVISION__LE,lemma,(
    ! [V0D] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Etransc_2EDIVISION__UBOUND,lemma,(
    ! [V0D] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EDIVISION__LE__SUC,lemma,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
...
fof(lamtp_f3214,axiom,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3214(V0d),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3214,axiom,(
    ! [V0d] :
     ...
     => ! [V3i] :
         ...
         => ap(f3214(V0d),V3i) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0d,ap(c_2Enum_2ESUC,V3i))),ap(V0d,V3i)) ) ) )).

fof(conj_thm_2Eintegral_2ESUM__DIFFS,lemma,(
    ! [V0d] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1m),V2n)),f3214(V0d)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0d,ap(ap(c_2Earithmetic_2E_2B,V1m),V2n))),ap(V0d,V1m)) ) ) ) )).

fof(conj_thm_2Eintegral_2ERSUM__BOUND,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
