...
thf(f11590_0_2E0,type,(
    f11590_0_2E0: u )).

thf(f11590_0_2E1,type,(
    f11590_0_2E1: du > u )).

thf(f11590_0_2E2,type,(
...
thf(arityeq1_2Emono_2Ef11590_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11590_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f11590_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef11590_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11590_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
...
thf(def0_2Ethm_2Eiterate_2Eneutral,axiom,(
    ! [A_27a: d,V0op_2E0: u,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f11590_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V0op_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) )
    <=> ! [V2y_2E0: u] :
...
thf(thm_2Eiterate_2Eneutral,axiom,(
    ! [A_27a: d,V0op_2E0: u] :
      ( ( s @ A_27a @ ( c_2Eiterate_2Eneutral_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V0op_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Emin_2E_40_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( f11590_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) ) @ V0op_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ENEUTRAL__REAL__ADD,conjecture,
