...
fof(conj_thm_2Etopology_2EHULL__MINIMAL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
...
fof(conj_thm_2Etopology_2EHULL__IMAGE__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
...
fof(conj_thm_2Etopology_2EHULL__IMAGE__GALOIS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(arr(A_27a,bool),bool))
