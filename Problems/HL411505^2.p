...
thf(conj_thm_2Ereal__topology_2EREFLECT__INTERVAL,conjecture,
    ...
    & ! [V3a: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] :
        ( ( ap
          @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V5x: $i] :
                  ( ap @ c_2Erealax_2Ereal__neg @ V5x ) ) )
          @ ( ap @ c_2Ereal__topology_2EOPEN__interval @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) @ ( inj__ty_2Erealax_2Ereal @ V4b ) ) ) )
        = ( ap @ c_2Ereal__topology_2EOPEN__interval @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V4b ) ) ) @ ( ap @ c_2Erealax_2Ereal__neg @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) ) ) ) )).
