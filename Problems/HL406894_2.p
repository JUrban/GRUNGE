...
tff(conj_thm_2Efinite__map_2Eflookup__thm,lemma,(
...
tff(conj_thm_2Efmsp_2EFMSP__FDOM,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0AN: $i] :
      ( mem(V0AN,arr(A_27a,arr(ty_2Enum_2Enum,bool)))
     => ! [V1BC: $i] :
          ( mem(V1BC,arr(A_27b,arr(A_27c,bool)))
         => p(ap(ap(ap(ap(c_2Etransfer_2EFUN__REL(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)),ap(ap(c_2Efmsp_2EFMSP(A_27a,A_27a,A_27a),V0AN),V1BC)),ap(ap(c_2Etransfer_2EFUN__REL(A_27a,A_27a,A_27a,A_27a),V0AN),c_2Emin_2E_3D(bool))),c_2Efinite__map_2EFDOM(A_27a,A_27a)),c_2Esptree_2Edomain(A_27c))) ) ) )).
