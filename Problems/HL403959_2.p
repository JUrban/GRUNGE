...
tff(conj_thm_2Ellist_2ELGENLIST__EQ__LNIL,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1n: tp__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum] :
          ( ( ap(ap(c_2Ellist_2ELGENLIST(A_27a),V0f),inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(V1n)) = c_2Ellist_2ELNIL(A_27a)
          <=> V1n = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
          & ( c_2Ellist_2ELNIL(A_27a) = ap(ap(c_2Ellist_2ELGENLIST(A_27a),V0f),inj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(V1n))
          <=> V1n = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).
