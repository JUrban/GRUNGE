...
thf(c_2Eset__relation_2Eper,type,(
    c_2Eset__relation_2Eper: 
      !>[A_27a: $tType] :
        ( ( A_27a > $o ) > ( ( A_27a > $o ) > $o ) > $o ) )).

thf(c_2Eset__relation_2Eper__restrict,type,(
    c_2Eset__relation_2Eper__restrict: 
      !>[A_27a: $tType] :
        ( ( ( A_27a > $o ) > $o ) > ( A_27a > $o ) > ( A_27a > $o ) > $o ) )).
...
thf(thm_2Eset__relation_2Eper__def,axiom,(
    ! [A_27a: $tType,V0xs: A_27a > $o,V1xss: ( A_27a > $o ) > $o] :
      ( ( c_2Eset__relation_2Eper @ A_27a @ V0xs @ V1xss )
    <=> ( ( c_2Epred__set_2ESUBSET @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V1xss ) @ V0xs )
        & ( (~) @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V1xss ) )
        & ! [V2xs1: A_27a > $o,V3xs2: A_27a > $o] :
            ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2xs1 @ V1xss )
              & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V3xs2 @ V1xss )
              & ( (~) @ ( V2xs1 = V3xs2 ) ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ V2xs1 @ V3xs2 ) ) ) ) )).

thf(thm_2Eset__relation_2Eper__restrict__def,axiom,(
    ! [A_27a: $tType,V0xss: ( A_27a > $o ) > $o,V1xs: A_27a > $o] :
      ( ( c_2Eset__relation_2Eper__restrict @ A_27a @ V0xss @ V1xs )
      = ( c_2Epred__set_2EDELETE @ ( A_27a > $o )
        @ ( c_2Epred__set_2EGSPEC @ ( A_27a > $o ) @ ( A_27a > $o )
          @ ^ [V2xs_27: A_27a > $o] :
              ( c_2Epair_2E_2C @ ( A_27a > $o ) @ $o @ ( c_2Epred__set_2EINTER @ A_27a @ V2xs_27 @ V1xs ) @ ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2xs_27 @ V0xss ) ) )
        @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) )).

thf(thm_2Eset__relation_2Eper__restrict__per,conjecture,(
    ! [A_27a: $tType,V0r: ( A_27a > $o ) > $o,V1s: A_27a > $o,V2s_27: A_27a > $o] :
      ( ( c_2Eset__relation_2Eper @ A_27a @ V1s @ V0r )
     => ( c_2Eset__relation_2Eper @ A_27a @ V2s_27 @ ( c_2Eset__relation_2Eper__restrict @ A_27a @ V0r @ V2s_27 ) ) ) )).
