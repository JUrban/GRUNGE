...
tff(conj_thm_2Earithmetic_2EFACT__LESS,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__ADD__LID__UNIQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) = V1y
    <=> V0x = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__INVINV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( V0x != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
     => surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x)))) = V0x ) )).
...
tff(conj_thm_2Ereal_2EREAL__MUL,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__EQ__SUB__LADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal_2EREAL__EQ__SUB__RADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) = V2z
    <=> V0x = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V2z)),inj__ty_2Erealax_2Ereal(V1y))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__FACT__NZ,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,inj__ty_2Enum_2Enum(V0n)))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
...
tff(conj_thm_2Ereal_2EPOW__0,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
...
tff(conj_thm_2Ereal_2ESUM__1,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V0f)) = surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V1n))) ) )).

tff(lmtp_f2738,type,(
    f2738: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2738,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2738(V2k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2738,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3m: tp__ty_2Enum_2Enum] : ap(f2738(V2k,V0f),inj__ty_2Enum_2Enum(V3m)) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V2k))) ) )).

tff(conj_thm_2Ereal_2ESUM__OFFSET,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1n: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V1n))),f2738(V2k,V0f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2k)))),V0f)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2k))),V0f))) ) )).

tff(conj_thm_2Ereal_2ESUM__0,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n))),k(ty_2Enum_2Enum,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
...
tff(conj_thm_2Elim_2EDIFF__CONST,lemma,(
...
tff(lmtp_f2917,type,(
    f2917: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2917,axiom,(
...
tff(lameq_f2917,axiom,(
    ! [V5r: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V6x: tp__ty_2Erealax_2Ereal] : ap(f2917(V5r,V0f),inj__ty_2Erealax_2Ereal(V6x)) = ap(ap(V0f,inj__ty_2Enum_2Enum(V5r)),inj__ty_2Erealax_2Ereal(V6x)) ) )).

tff(lmtp_f2919,type,(
    f2919: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2919,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V7x: tp__ty_2Erealax_2Ereal] : mem(f2919(V0f,V7x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2919,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V7x: tp__ty_2Erealax_2Ereal,V8n: tp__ty_2Enum_2Enum] : ap(f2919(V0f,V7x),inj__ty_2Enum_2Enum(V8n)) = ap(ap(V0f,inj__ty_2Enum_2Enum(V8n)),inj__ty_2Erealax_2Ereal(V7x)) ) )).

tff(lmtp_f2918,type,(
    f2918: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2918,axiom,(
...
tff(lameq_f2918,axiom,(
    ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f2918(V2m,V3n,V0f),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f2919(V0f,V7x)) ) )).

tff(lmtp_f2920,type,(
    f2920: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2920,axiom,(
    ! [V1f_27: $i] :
      ( mem(V1f_27,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal] : mem(f2920(V1f_27,V4x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2920,axiom,(
    ! [V1f_27: $i] :
      ( mem(V1f_27,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal,V9r: tp__ty_2Enum_2Enum] : ap(f2920(V1f_27,V4x),inj__ty_2Enum_2Enum(V9r)) = ap(ap(V1f_27,inj__ty_2Enum_2Enum(V9r)),inj__ty_2Erealax_2Ereal(V4x)) ) )).

tff(conj_thm_2Elim_2EDIFF__SUM,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1f_27: $i] :
          ( mem(V1f_27,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum,V4x: tp__ty_2Erealax_2Ereal] :
              ( ! [V5r: tp__ty_2Enum_2Enum] :
                 ...
                 => p(ap(ap(ap(c_2Elim_2Ediffl,f2917(V5r,V0f)),ap(ap(V1f_27,inj__ty_2Enum_2Enum(V5r)),inj__ty_2Erealax_2Ereal(V4x))),inj__ty_2Erealax_2Ereal(V4x))) )
             => p(ap(ap(ap(c_2Elim_2Ediffl,f2918(V2m,V3n,V0f)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n))),f2920(V1f_27,V4x))),inj__ty_2Erealax_2Ereal(V4x))) ) ) ) )).

tff(conj_thm_2Elim_2EROLLE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Etransc_2EMCLAURIN,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1diff: $i] :
          ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
