...
thf(conj_thm_2Ehreal_2EHRAT__MUL__RINV,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat] :
      ( ( surj__ty_2Ehrat_2Ehrat @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ ( inj__ty_2Ehrat_2Ehrat @ V0x ) ) @ ( ap @ c_2Ehrat_2Ehrat__inv @ ( inj__ty_2Ehrat_2Ehrat @ V0x ) ) ) )
...
thf(conj_thm_2Ehreal_2EHRAT__INV__MUL,conjecture,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
      ( ( surj__ty_2Ehrat_2Ehrat @ ( ap @ c_2Ehrat_2Ehrat__inv @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ ( inj__ty_2Ehrat_2Ehrat @ V0x ) ) @ ( inj__ty_2Ehrat_2Ehrat @ V1y ) ) ) )
      = ( surj__ty_2Ehrat_2Ehrat @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ ( ap @ c_2Ehrat_2Ehrat__inv @ ( inj__ty_2Ehrat_2Ehrat @ V0x ) ) ) @ ( ap @ c_2Ehrat_2Ehrat__inv @ ( inj__ty_2Ehrat_2Ehrat @ V1y ) ) ) ) ) )).
