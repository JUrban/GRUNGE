...
thf(conj_thm_2Efcp_2ENOT__FINITE__IMP__dimindex__1,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ewords_2Ew2w__w2w,lemma,(
...
thf(conj_thm_2Ewords_2Ew2w__eq__n2w,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1y: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ( ap @ ( c_2Ewords_2Ew2w @ A_27a @ A_27b ) @ V0x )
              = ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) )
          <=> ( V0x
              = ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Eword__concat__0,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0x: tp__ty_2Enum_2Enum] :
     ...
     => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__concat @ A_27a @ A_27b @ A_27c ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) )
        = ( ap @ ( c_2Ewords_2En2w @ A_27c ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) ) ) )).
