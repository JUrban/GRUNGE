...
thf(conj_thm_2Ebit_2EBIT__BITS__THM,lemma,(
    ...
    <=> ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITS @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( inj__ty_2Enum_2Enum @ V1l ) ) @ ( inj__ty_2Enum_2Enum @ V2a ) ) )
...
thf(conj_thm_2Ewords_2Edimindex__dimword__lt__iso,lemma,(
    ! [A_27a: del,A_27b: del] :
...
thf(conj_thm_2Ewords_2Esaturate__w2w__n2w,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Ewords_2Esaturate__w2w @ A_27a @ A_27b ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
      = ( ap
        @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) )
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1m: $i] :
                ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27b ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27b ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Ewords_2Edimword @ A_27b ) @ ( c_2Ebool_2Ethe__value @ A_27b ) ) ) @ V1m ) ) ) @ ( c_2Ewords_2Eword__T @ A_27b ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ V1m ) ) ) )
        @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Ewords_2Edimword @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) ) )).
