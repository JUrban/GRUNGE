...
thf(conj_thm_2Eset__relation_2Enth__min__ind,conjecture,(
    ! [A_27a: del,V0P: $i] :
                 ...
                 => ! [V6r: $i] :
                     ...
                     => ! [V7n: tp__ty_2Enum_2Enum] :
                          ( ! [V8min: $i] :
                             ...
                             => ( ( ( V8min
                                    = ( ap @ ( ap @ ( c_2Eset__relation_2Eget__min @ A_27a ) @ V4r_27 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) ) @ V5s ) @ V6r ) ) )
                                  & ( V8min
       ...
       => ! [V9v: $i] :
           ...
           => ! [V10v1: $i] :
               ...
               => ! [V11v2: $i] :
                   ...
                   => ! [V12v3: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( ap @ V0P @ V9v ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) ) @ V10v1 ) @ V11v2 ) ) @ ( inj__ty_2Enum_2Enum @ V12v3 ) ) ) ) ) ) ) ) )).
