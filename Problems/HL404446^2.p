...
thf(conj_thm_2Ecardinal_2EFINITE__FINITE__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Epred__set_2ECARD__UNION__LE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECARD__BIGUNION__LE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
