...
tff(conj_thm_2Ereal_2EREAL__LE__POW2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )).
...
tff(conj_thm_2Ereal_2EREAL__ABS__POS,lemma,(
...
tff(conj_thm_2Etransc_2ESQRT__MUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V1y))) )
     => surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Esqrt,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Esqrt,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Etransc_2Esqrt,inj__ty_2Erealax_2Ereal(V1y)))) ) )).
...
tff(conj_thm_2Ecomplex_2EMODU__SCALAR__LMUL,conjecture,(
    ! [V0k: tp__ty_2Erealax_2Ereal,V1z: tp__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Emodu,ap(ap(c_2Ecomplex_2Ecomplex__scalar__lmul,inj__ty_2Erealax_2Ereal(V0k)),inj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(V1z)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0k))),ap(c_2Ecomplex_2Emodu,inj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(V1z)))) )).
