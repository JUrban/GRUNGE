...
tff(conj_thm_2Epred__set_2ESUBSET__applied,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Epred__set_2ECOMPL__applied,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
...
tff(tp_c_2Etopology_2Eclosed,type,(
    c_2Etopology_2Eclosed: del > $i )).

tff(mem_c_2Etopology_2Eclosed,axiom,(
    ! [A_27a: del] : mem(c_2Etopology_2Eclosed(A_27a),arr(ty_2Etopology_2Etopology(A_27a),bool)) )).
...
tff(conj_thm_2Etopology_2EOPEN__NEIGH,lemma,(
    ! [A_27a: del,V0S_27: $i] :
          ...
          <=> ! [V2x: $i] :
               ...
               => ( p(ap(V0S_27,V2x))
                 => ? [V3N: $i] :
                      ...
                      & p(ap(ap(c_2Etopology_2Eneigh(A_27a),V1top),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),V3N),V2x)))
...
tff(conj_thm_2Etopology_2ECLOSED__LIMPT,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ( p(ap(c_2Etopology_2Eclosed(A_27a),V0top))
       => ! [V1S_27: $i] :
