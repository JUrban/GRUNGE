...
tff(lamtp_f2889,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2889(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2889,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V4k: tp__ty_2Enum_2Enum] : ap(f2889(V0f),inj__ty_2Enum_2Enum(V4k)) = ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V4k))) ) )).

tff(conj_thm_2Eseq_2ESER__COMPARA,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( ( ? [V2N: tp__ty_2Enum_2Enum] :
                ! [V3n: tp__ty_2Enum_2Enum] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V3n)))),ap(V1g,inj__ty_2Enum_2Enum(V3n)))) )
              & p(ap(c_2Eseq_2Esummable,V1g)) )
           => p(ap(c_2Eseq_2Esummable,f2889(V0f))) ) ) ) )).
