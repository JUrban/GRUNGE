...
thf(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__GT,lemma,(
     ...
     => ( ( ap @ c_2Ereal__topology_2Eclosure
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2x: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__gt @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) ) )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V3x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__HALFSPACE__COMPONENT__GT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( ( ap @ c_2Ereal__topology_2Eclosure
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__gt @ V1x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) )
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V2x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ V2x ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) )).
