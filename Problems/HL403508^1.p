...
thf(f4677_0_2E0,type,(
    f4677_0_2E0: u )).

thf(f4677_0_2E2,type,(
    f4677_0_2E2: du > du > u )).

thf(f4677_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef4677_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4677_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef4677_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4677_0_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(def0_2Ethm_2Ewellorder_2Eiseg__def,axiom,(
    ! [A_27a: d,V1x_2E0: u,V0w_2E0: u,V2y_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) @ ( f4677_0_2E3 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) )
...
thf(thm_2Ewellorder_2Eiseg__def,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1x_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Eiseg_2E2 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27a @ tyop_2Emin_2Ebool ) ) @ ( f4677_0_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Ewellorder__rrestrict,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1s_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewellorder_2Ewellorder_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Eset__relation_2Errestrict_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ewellorder_2Ewellorder__REP_2E1 @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V0w_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Ewobound__def,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1w_2E0: u] :
      ( ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ ( c_2Ewellorder_2Ewobound_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Ewellorder_2Ewellorder @ A_27a ) @ V1w_2E0 ) ) )
