...
fof(conj_thm_2Ecardinal_2ECARD__LTE__TRANS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1t] :
                     ...
                     => ! [V2u] :
                         ...
                         => ( ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V1t),V0s))
                           ...
                           => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2u),V0s)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__LT__IMP__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__LE__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__LT__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__ADD__C,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                      & p(ap(c_2Epred__set_2EFINITE(A_27b),V1t)) )
                   => ap(c_2Epred__set_2ECARD(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t)) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epred__set_2ECARD(A_27a),V0s)),ap(c_2Epred__set_2ECARD(A_27b),V1t)) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__LE__ADDR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                  ( mem(V1t,arr(A_27b,bool))
                 => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0s),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__LE__ADDL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                  ( mem(V1t,arr(A_27b,bool))
                 => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V1t),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__ADD__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                      & p(ap(c_2Epred__set_2EFINITE(A_27b),V1t)) )
                   => p(ap(c_2Epred__set_2EFINITE(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__ADD__FINITE__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2ECARD__ADD2__ABSORB__LT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1t] :
                     ...
                     => ! [V2u] :
                         ...
                         => ( ( ~ p(ap(c_2Epred__set_2EFINITE(A_27c),V2u))
                              & ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2u),V0s))
                              & ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2u),V1t)) )
                           => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2u),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t))) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2ECARD__LT__ADD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V1s_27] :
                         ...
                         => ! [V2t] :
                             ...
                             => ! [V3t_27] :
                                 ...
                                 => ( ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V1s_27),V0s))
                                      & ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27d,A_27d),V3t_27),V2t)) )
                                   => ~ p(ap(ap(c_2Ecardinal_2Ecardleq(ty_2Esum_2Esum(A_27b,A_27b),ty_2Esum_2Esum(A_27b,A_27b)),ap(ap(c_2Ecardinal_2E_2B__c(A_27b,A_27b),V1s_27),V3t_27)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V2t))) ) ) ) ) ) ) ) ) ) )).
