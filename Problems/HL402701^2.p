...
thf(conj_thm_2Erich__list_2EDROP__APPEND2,conjecture,(
    ! [A_27a: del,V0l1: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => ! [V2l2: $i] :
              ( ( mem @ V2l2 @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ V2l2 ) )
                = ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l1 ) ) ) @ V2l2 ) ) ) ) ) )).
