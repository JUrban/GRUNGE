...
thf(conj_thm_2Eiterate_2ENUMSEG__LE,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V1x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V1x ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
      = ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )).
