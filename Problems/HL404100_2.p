...
tff(conj_thm_2Earithmetic_2EMULT__EQ__ID,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Edivides_2ENOT__PRIME__1,lemma,(
...
tff(conj_thm_2Edivides_2EPRIME__FACTOR,lemma,(
...
tff(tp_c_2Ebag_2EBAG__GEN__PROD,type,(
    c_2Ebag_2EBAG__GEN__PROD: $i )).

tff(mem_c_2Ebag_2EBAG__GEN__PROD,axiom,(
...
tff(conj_thm_2Ebag_2EBAG__GEN__PROD__EMPTY,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,c_2Ebag_2EEMPTY__BAG(ty_2Enum_2Enum)),inj__ty_2Enum_2Enum(V0n))) = V0n )).

tff(conj_thm_2Ebag_2EBAG__GEN__PROD__TAILREC,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,ap(ap(c_2Ebag_2EBAG__INSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),V0b)),inj__ty_2Enum_2Enum(V2a))) = surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0b),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V1x)),inj__ty_2Enum_2Enum(V2a)))) ) ) )).

tff(conj_thm_2Ebag_2EBAG__GEN__PROD__REC,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ! [V1x: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,ap(ap(c_2Ebag_2EBAG__INSERT(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),V0b)),inj__ty_2Enum_2Enum(V2a))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V1x)),ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0b),inj__ty_2Enum_2Enum(V2a)))) ) ) )).

tff(conj_thm_2EprimeFactor_2EPRIME__FACTORS__EXIST,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
