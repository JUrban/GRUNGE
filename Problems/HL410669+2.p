...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__DIST__BETWEEN,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2EBETWEEN__IN__SEGMENT,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ereal__topology_2ECOLLINEAR__DIST__IN__CLOSED__SEGMENT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
