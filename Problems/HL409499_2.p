...
tff(conj_thm_2Etransc_2ELN__MONO__LT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Etransc_2ELN__POS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V0x)))) ) )).
...
tff(conj_thm_2Eutil__prob_2Elg__pow,conjecture,(
