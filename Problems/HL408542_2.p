...
tff(lmtp_f3149,type,(
    f3149: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone > $i )).

tff(lamtp_f3149,axiom,(
    ! [V0s: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone] : mem(f3149(V0s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3149,axiom,(
    ! [V0s: tp__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone,V3r: tp__ty_2Erealax_2Ereal] : ap(f3149(V0s),inj__ty_2Erealax_2Ereal(V3r)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),inj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone(V0s)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V3r))),inj__ty_2Erealax_2Ereal(V3r)) )).

tff(conj_thm_2Ebinary__ieee_2Efloat__to__real,conjecture,(
