...
fof(lameq_f2743,axiom,(
    ! [V0p] :
     ...
     => ! [V1r] :
         ...
         => ap(f2743(V0p),V1r) = ap(V0p,ap(c_2Erealax_2Ereal__neg,V1r)) ) ) )).

fof(ax_thm_2Ereal_2Einf__def,axiom,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ap(c_2Ereal_2Einf,V0p) = ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Esup,f2743(V0p))) ) )).

fof(conj_thm_2Ereal_2EREAL__LE__SUP,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
         ...
         => ( ( ? [V2y] :
              ...
              & ? [V3y] :
                  ...
                  & ! [V4z] :
                     ...
                     => ( p(ap(V0p,V4z))
                       => p(ap(ap(c_2Ereal_2Ereal__lte,V4z),V3y)) ) ) ) )
           => ( p(ap(ap(c_2Ereal_2Ereal__lte,V1x),ap(c_2Ereal_2Esup,V0p)))
            <=> ! [V5y] :
                 ...
                 => ( ! [V6z] :
                       ...
                       => ( p(ap(V0p,V6z))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,V6z),V5y)) ) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,V1x),V5y)) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal_2EREAL__INF__LE,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ( ? [V2y] :
              ...
              & ? [V3y] :
                  ...
                  & ! [V4z] :
                      ( mem(V4z,ty_2Erealax_2Ereal)
                     => ( p(ap(V0p,V4z))
                       => p(ap(ap(c_2Ereal_2Ereal__lte,V3y),V4z)) ) ) ) )
           => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Einf,V0p)),V1x))
            <=> ! [V5y] :
                  ( mem(V5y,ty_2Erealax_2Ereal)
                 => ( ! [V6z] :
                        ( mem(V6z,ty_2Erealax_2Ereal)
                       => ( p(ap(V0p,V6z))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,V5y),V6z)) ) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,V5y),V1x)) ) ) ) ) ) ) )).
