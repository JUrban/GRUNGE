...
tff(mem_c_2Epatricia__casts_2ESOME__PTREE,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epatricia__casts_2ESOME__PTREE(A_27a,A_27a),arr(ty_2Epatricia_2Eptree(A_27b),ty_2Epatricia__casts_2Eword__ptree(A_27a,A_27a))) )).
...
tff(mem_c_2Epatricia__casts_2ETHE__PTREE,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epatricia__casts_2ETHE__PTREE(A_27a,A_27a),arr(ty_2Epatricia__casts_2Eword__ptree(A_27b,A_27b),ty_2Epatricia_2Eptree(A_27a))) )).
...
tff(mem_c_2Epatricia__casts_2EWord__ptree,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Epatricia__casts_2EWord__ptree(A_27a,A_27a),arr(arr(A_27a,ty_2Eone_2Eone),arr(ty_2Epatricia_2Eptree(A_27b),ty_2Epatricia__casts_2Eword__ptree(A_27a,A_27a)))) )).
...
tff(ax_thm_2Epatricia__casts_2ESOME__PTREE__def,axiom,(
    ! [A_27a: del,A_27b: del,V0t: $i] :
     ...
     => ap(c_2Epatricia__casts_2ESOME__PTREE(A_27a,A_27a),V0t) = ap(ap(c_2Epatricia__casts_2EWord__ptree(A_27a,A_27a),ap(c_2Ecombin_2EK(ty_2Eone_2Eone,ty_2Eone_2Eone),inj__ty_2Eone_2Eone(fo__c_2Eone_2Eone))),V0t) ) )).

tff(conj_thm_2Epatricia__casts_2ETHE__PTREE__SOME__PTREE,conjecture,(
    ! [A_27a: del,A_27b: del,V0t: $i] :
