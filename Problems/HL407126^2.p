...
thf(ax_thm_2Erealax_2Ereal__inv,axiom,(
    ! [V0T1: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) )
      = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Ereal__ABS @ ( ap @ c_2Erealax_2Etreal__inv @ ( ap @ c_2Erealax_2Ereal__REP @ ( inj__ty_2Erealax_2Ereal @ V0T1 ) ) ) ) ) ) )).

thf(conj_thm_2Erealax_2EREAL__INV__0,conjecture,
    ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Erealax_2Einv @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Erealax_2Ereal__0 ) ) )
    = fo__c_2Erealax_2Ereal__0 )).
