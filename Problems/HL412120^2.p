    ...
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
              ...
              & ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ ty_2Eextreal_2Eextreal ) @ V1f ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) ) ) )
...
thf(conj_thm_2Eprobability_2Efinite__expectation2,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1X: $i] :
