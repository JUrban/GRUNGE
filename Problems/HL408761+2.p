...
fof(conj_thm_2EHolSmt_2Er140,conjecture,(
    ! [V0a] :
         ...
         => ! [V2y] :
             ...
             => ! [V3v] :
                 ...
                 => ! [V4z] :
                     ...
                     => ( V0a = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V1u)),V2y)),ap(ap(c_2Erealax_2Ereal__mul,V3v),V4z))
                      <=> ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V1u),V2y)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V3v)),V4z)),V0a)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) ) ) )).
