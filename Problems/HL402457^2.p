...
thf(conj_thm_2EerrorStateMonad_2EIGNORE__BIND__ESGUARD,conjecture,(
    ! [A_27a: del,A_27b: del,V0xM: $i] :
      ( ( mem @ V0xM @ ( arr @ A_27a @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) ) ) )
     => ( ( ( ap @ ( ap @ ( c_2EerrorStateMonad_2EIGNORE__BIND @ ty_2Eone_2Eone @ A_27a @ A_27b ) @ ( ap @ ( c_2EerrorStateMonad_2EES__GUARD @ A_27a ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) ) @ V0xM )
          = ( c_2EerrorStateMonad_2EES__FAIL @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ A_27a ) )
        & ( ( ap @ ( ap @ ( c_2EerrorStateMonad_2EIGNORE__BIND @ ty_2Eone_2Eone @ A_27a @ A_27b ) @ ( ap @ ( c_2EerrorStateMonad_2EES__GUARD @ A_27a ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) ) @ V0xM )
          = V0xM ) ) ) )).
