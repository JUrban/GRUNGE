                  ...
                  @ ^ [V2x: $i] :
                      ...
                      @ ^ [V3y: $i] :
                          ...
                          @ ( ap @ ( c_2Ebool_2E_3F @ A_27c )
                            @ ( lam @ A_27c
                              @ ^ [V4z: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27c ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27c ) @ V2x ) @ V4z ) ) @ V0r1 ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27c @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27c @ A_27b ) @ V4z ) @ V3y ) ) @ V1r2 ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eset__relation_2Efinite__prefixes__comp,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0r1: $i] :
                              ...
                              @ ( lam @ A_27b
                                @ ^ [V4x: $i] :
                                    ...
                                    @ ( ap @ ( c_2Ebool_2E_3F @ A_27c )
                                      @ ( lam @ A_27c
                                        @ ^ [V5y: $i] :
                                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27c ) @ V5y ) @ V3s2 ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ A_27c ) @ V4x ) @ V5y ) ) @ V1r2 ) ) ) ) ) ) ) )
                          @ V2s1 ) ) )
