...
fof(conj_thm_2ETemporal__Logic_2EWHEN__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f936,axiom,(
    ! [V0b] :
     ...
     => ! [V3t] :
          ( mem(V3t,ty_2Enum_2Enum)
         => ap(f936(V0b),V3t) = ap(V0b,V3t) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EUNTIL__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2ETemporal__Logic_2EBEFORE__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2ETemporal__Logic_2ESWHEN__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2ETemporal__Logic_2ESUNTIL__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2ETemporal__Logic_2ESBEFORE__SIMP,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1513,axiom,(
    ! [V0b] :
     ...
     => ! [V33t] :
         ...
         => ap(f1513(V0b),V33t) = ap(c_2Ebool_2E_7E,ap(V0b,V33t)) ) ) )).

fof(lamtp_f1514,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1514,axiom,(
    ! [V0b] :
     ...
     => ! [V43t] :
         ...
         => ap(f1514(V0b),V43t) = ap(c_2Ebool_2E_7E,ap(V0b,V43t)) ) ) )).

fof(lamtp_f1515,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1515,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V49t] :
          ( mem(V49t,ty_2Enum_2Enum)
         => ap(f1515(V0b),V49t) = ap(c_2Ebool_2E_7E,ap(V0b,V49t)) ) ) )).

fof(lamtp_f1516,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1516,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V51t] :
          ( mem(V51t,ty_2Enum_2Enum)
         => ap(f1516(V0b),V51t) = ap(c_2Ebool_2E_7E,ap(V0b,V51t)) ) ) )).

fof(lamtp_f1517,axiom,(
    ! [V1a] :
      ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1517,axiom,(
    ! [V1a] :
      ( mem(V1a,arr(ty_2Enum_2Enum,bool))
     => ! [V56t] :
          ( mem(V56t,ty_2Enum_2Enum)
         => ap(f1517(V1a),V56t) = ap(c_2Ebool_2E_7E,ap(V1a,V56t)) ) ) )).

fof(lamtp_f1518,axiom,(
    mem(f1518,arr(ty_2Enum_2Enum,bool)) )).

fof(lameq_f1518,axiom,(
    ! [V63t] :
      ( mem(V63t,ty_2Enum_2Enum)
     => ap(f1518,V63t) = ap(c_2Ebool_2E_7E,ap(c_2EPast__Temporal__Logic_2EInitPoint,V63t)) ) )).

fof(lamtp_f1519,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1519,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V91t] :
          ( mem(V91t,ty_2Enum_2Enum)
         => ap(f1519(V0b),V91t) = ap(c_2Ebool_2E_7E,ap(V0b,V91t)) ) ) )).

fof(lamtp_f1520,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1520,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V101t] :
          ( mem(V101t,ty_2Enum_2Enum)
         => ap(f1520(V0b),V101t) = ap(c_2Ebool_2E_7E,ap(V0b,V101t)) ) ) )).

fof(lamtp_f1521,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1521,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V107t] :
          ( mem(V107t,ty_2Enum_2Enum)
         => ap(f1521(V0b),V107t) = ap(c_2Ebool_2E_7E,ap(V0b,V107t)) ) ) )).

fof(lamtp_f1522,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1522,axiom,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V109t] :
          ( mem(V109t,ty_2Enum_2Enum)
         => ap(f1522(V0b),V109t) = ap(c_2Ebool_2E_7E,ap(V0b,V109t)) ) ) )).

fof(lamtp_f1523,axiom,(
    ! [V1a] :
      ( mem(V1a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1523,axiom,(
    ! [V1a] :
      ( mem(V1a,arr(ty_2Enum_2Enum,bool))
     => ! [V114t] :
          ( mem(V114t,ty_2Enum_2Enum)
         => ap(f1523(V1a),V114t) = ap(c_2Ebool_2E_7E,ap(V1a,V114t)) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2ESIMPLIFY,conjecture,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1a] :
          ( mem(V1a,arr(ty_2Enum_2Enum,bool))
