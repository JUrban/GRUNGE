    ...
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
             ...
             => ! [A_27s] :
                  ( ne(A_27s)
                 => mem(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),arr(arr(A_27a,arr(A_27s,A_27b)),arr(arr(A_27b,arr(A_27s,A_27c)),arr(A_27a,arr(A_27s,A_27c))))) ) ) ) ) )).
...
fof(conj_thm_2EreaderMonad_2EMCOMPOSE__ASSOC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V0f] :
                         ...
                         => ! [V1g] :
                             ...
                             => ! [V2h] :
                                 ...
                                 => ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),V0f),ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27d,A_27d,A_27d,A_27d),V1g),V2h)) = ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),V0f),V1g)),V2h) ) ) ) ) ) ) ) ) )).
