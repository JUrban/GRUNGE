...
fof(conj_thm_2Ewhile_2EFULL__LEAST__INTRO,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Epred__set_2EMIN__SET__LEM,conjecture,(
    ! [V0s] :
     ...
     => ( V0s != c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)
       => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Epred__set_2EMIN__SET,V0s)),V0s))
          & ! [V1x] :
              ( mem(V1x,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1x),V0s))
               => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Epred__set_2EMIN__SET,V0s)),V1x)) ) ) ) ) ) )).
