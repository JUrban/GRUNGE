...
thf(thm_2Einteger_2EINT__EXP__ADD__EXPONENTS,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2p: tyop_2Einteger_2Eint] :
      ( ( c_2Einteger_2Eint__mul @ ( c_2Einteger_2Eint__exp @ V2p @ V0n ) @ ( c_2Einteger_2Eint__exp @ V2p @ V1m ) )
      = ( c_2Einteger_2Eint__exp @ V2p @ ( c_2Earithmetic_2E_2B @ V0n @ V1m ) ) ) )).
...
thf(thm_2Einteger_2EINT__EXP__MULTIPLY__EXPONENTS,conjecture,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Einteger_2Eint] :
      ( ( c_2Einteger_2Eint__exp @ ( c_2Einteger_2Eint__exp @ V2p @ V1n ) @ V0m )
      = ( c_2Einteger_2Eint__exp @ V2p @ ( c_2Earithmetic_2E_2A @ V1n @ V0m ) ) ) )).
