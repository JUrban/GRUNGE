...
thf(f2589_0_2E0,type,(
    f2589_0_2E0: u )).

thf(f2589_0_2E1,type,(
    f2589_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef2589_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2589_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ f2589_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Eres__quan_2ERES__EXISTS__UNIQUE__F,axiom,(
    ! [A_27b: d,V3x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f2589_0_2E1 @ ( s @ A_27b @ V3x_2E0 ) ) ) )
      = mono_2Ec_2Ebool_2EF ) )).

thf(thm_2Eres__quan_2ERES__EXISTS__UNIQUE__F,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0P_2E0: u,V1s_2E0: u,V2x_2E0: u] :
      ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2ERES__EXISTS__UNIQUE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ f2589_0_2E0 ) ) ) ) ) )).
