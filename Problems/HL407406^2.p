...
thf(conj_thm_2Ereal_2EREAL__SUP__EXISTS,lemma,(
    ! [V0P: $i] :
...
thf(ax_thm_2Ereal_2Esup,axiom,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Esup @ V0P ) )
            ...
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V1s: $i] :
                  ...
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V2y: $i] :
                        ( ap
                        @ ( ap @ ( c_2Emin_2E_3D @ bool )
                          @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Erealax_2Ereal )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V3x: $i] :
                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V3x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V2y ) @ V3x ) ) ) ) )
                        @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V2y ) @ V1s ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2EREAL__SUP,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ? [V1x: tp__ty_2Erealax_2Ereal] :
              ( p @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
