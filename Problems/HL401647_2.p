...
tff(conj_thm_2Epred__set_2EINJ__CARD__IMAGE__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),V1s),V2t))
               => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                 => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s))) = surj__ty_2Enum_2Enum(ap(c_2Epred__set_2ECARD(A_27a),V1s)) ) ) ) ) ) )).
