...
thf(thm_2Estate__transformer_2EFOREACH__ind,conjecture,(
    ! [A_27a: $tType,A_27state: $tType,V0P: ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state ) ) ) > $o] :
      ( ( ! [V1a: A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state )] :
            ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ A_27a ) @ ( A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state ) ) @ ( c_2Elist_2ENIL @ A_27a ) @ V1a ) )
        & ! [V2h: A_27a,V3t: tyop_2Elist_2Elist @ A_27a,V4a: A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state )] :
            ( ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ A_27a ) @ ( A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state ) ) @ V3t @ V4a ) )
           => ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ A_27a ) @ ( A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state ) ) @ ( c_2Elist_2ECONS @ A_27a @ V2h @ V3t ) @ V4a ) ) ) )
     => ! [V5v: tyop_2Elist_2Elist @ A_27a,V6v1: A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state )] :
          ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ A_27a ) @ ( A_27a > A_27state > ( tyop_2Epair_2Eprod @ tyop_2Eone_2Eone @ A_27state ) ) @ V5v @ V6v1 ) ) ) )).
