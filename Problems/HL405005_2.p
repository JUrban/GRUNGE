...
tff(conj_thm_2Equotient__option_2ENONE__PRS,conjecture,(
     ...
     => ! [V1abs: $i] :
         ...
         => ! [V2rep: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => c_2Eoption_2ENONE(A_27b) = ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V1abs),c_2Eoption_2ENONE(A_27a)) ) ) ) ) )).
