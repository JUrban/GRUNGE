...
tff(conj_thm_2Elist_2ETAKE__APPEND1,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(conj_thm_2Erich__list_2EIS__PREFIX__TRANS,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Erich__list_2EIS__PREFIX__LENGTH,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Elist_2Elist(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Ellist_2ELTAKE__TAKE__LESS,lemma,(
...
tff(conj_thm_2Ellist_2ELPREFIX__TRANS,conjecture,(
    ! [A_27a: del,V0l1: $i] :
      ( mem(V0l1,ty_2Ellist_2Ellist(A_27a))
     => ! [V1l2: $i] :
          ( mem(V1l2,ty_2Ellist_2Ellist(A_27a))
