...
tff(conj_thm_2EDecode_2Edec2enc__decode__sum,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
      ( mem(V0p1,arr(A_27a,bool))
     => ! [V1p2: $i] :
          ( mem(V1p2,arr(A_27b,bool))
         => ! [V2d1: $i] :
             ...
             => ! [V3d2: $i] :
                 ...
                 => ! [V4x: $i] :
                      ( mem(V4x,ty_2Esum_2Esum(A_27a,A_27a))
                     => ( ( p(ap(ap(c_2EDecode_2Ewf__decoder(A_27a),V0p1),V2d1))
                          & p(ap(ap(c_2EDecode_2Ewf__decoder(A_27b),V1p2),V3d2))
                          & p(ap(ap(ap(c_2EEncode_2Elift__sum(A_27a,A_27a),V0p1),V1p2),V4x)) )
                       => surj__c_ty_2Elist_2Elist_o(ap(ap(c_2EDecode_2Edec2enc(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(ap(c_2EDecode_2Edecode__sum(A_27a,A_27a),ap(ap(c_2EEncode_2Elift__sum(A_27a,A_27a),V0p1),V1p2)),V2d1),V3d2)),V4x)) = surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2EEncode_2Eencode__sum(A_27a,A_27a),ap(c_2EDecode_2Edec2enc(A_27a),V2d1)),ap(c_2EDecode_2Edec2enc(A_27b),V3d2)),V4x)) ) ) ) ) ) ) )).
