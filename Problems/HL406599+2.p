...
fof(mem_c_2Esptree_2EfromList,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Esptree_2EfromList(A_27a),arr(ty_2Elist_2Elist(A_27a),ty_2Esptree_2Espt(A_27a))) ) )).
...
fof(conj_thm_2Esptree_2Elookup__fromList,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ap(ap(c_2Esptree_2Elookup(A_27a),V0n),ap(c_2Esptree_2EfromList(A_27a),V1l)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Eprim__rec_2E_3C,V0n),ap(c_2Elist_2ELENGTH(A_27a),V1l))),ap(c_2Eoption_2ESOME(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V0n),V1l))),c_2Eoption_2ENONE(A_27a)) ) ) ) )).

fof(conj_thm_2Esptree_2Elookup__fromList__outside,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0args] :
         ...
         => ! [V1k] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0args)),V1k))
               => ap(ap(c_2Esptree_2Elookup(A_27a),V1k),ap(c_2Esptree_2EfromList(A_27a),V0args)) = c_2Eoption_2ENONE(A_27a) ) ) ) ) )).
