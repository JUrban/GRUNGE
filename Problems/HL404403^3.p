...
thf(thm_2Ecardinal_2EPOW__TWO__set__exp,axiom,(
    ! [A_27a: $tType,V0A: A_27a > $o] :
      ( c_2Ecardinal_2Ecardeq @ ( A_27a > $o ) @ ( A_27a > ( tyop_2Eoption_2Eoption @ tyop_2Enum_2Enum ) ) @ ( c_2Epred__set_2EPOW @ A_27a @ V0A ) @ ( c_2Ecardinal_2Eset__exp @ A_27a @ tyop_2Enum_2Enum @ ( c_2Epred__set_2Ecount @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ V0A ) ) )).
