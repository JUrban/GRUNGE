...
fof(conj_thm_2Equotient__pair_2EPAIR__MAP__I,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(ap(c_2Epair_2E_23_23(A_27a,A_27a,A_27a,A_27a),c_2Ecombin_2EI(A_27a)),c_2Ecombin_2EI(A_27b)) = c_2Ecombin_2EI(ty_2Epair_2Eprod(A_27a,A_27a)) ) ) )).
