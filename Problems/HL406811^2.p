...
thf(tp_c_2Etc_2ETC__MOD,type,(
    c_2Etc_2ETC__MOD: del > $i )).

thf(mem_c_2Etc_2ETC__MOD,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Etc_2ETC__MOD,axiom,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1rx: $i] :
         ...
         => ! [V2ra: $i] :
             ...
             => ( ( ap @ ( ap @ ( ap @ ( c_2Etc_2ETC__MOD @ A_27a ) @ V0x ) @ V1rx ) @ V2ra )
                = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( arr @ A_27a @ bool ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V0x ) @ V2ra ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ A_27a ) @ V2ra ) @ V1rx ) ) @ V2ra ) ) ) ) ) )).

thf(conj_thm_2Etc_2ETC__MOD__EMPTY__ID,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1ra: $i] :
          ( ( mem @ V1ra @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Etc_2ETC__MOD @ A_27a ) @ V0x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) )
