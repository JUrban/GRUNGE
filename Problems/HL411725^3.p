...
thf(thm_2Ereal__topology_2EREAL__AFFINITY__EQ,conjecture,(
    ! [V0m: tyop_2Erealax_2Ereal,V1c: tyop_2Erealax_2Ereal,V2x: tyop_2Erealax_2Ereal,V3y: tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0m
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( ( ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V0m @ V2x ) @ V1c )
          = V3y )
      <=> ( V2x
          = ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Einv @ V0m ) @ V3y ) @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2E_2F @ V1c @ V0m ) ) ) ) ) ) )).
