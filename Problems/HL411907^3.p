...
thf(thm_2Ereal__topology_2EHAUSDIST__UNION__LE,axiom,(
...
thf(thm_2Ereal__topology_2EHAUSDIST__INSERT__LE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        & ( c_2Ereal__topology_2Ebounded__def @ V1t )
        & ( (~)
          @ ( V0s
        ...
        & ( (~)
          @ ( V1t
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V2a @ V0s ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V2a @ V1t ) ) ) @ ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) ) ) )).
