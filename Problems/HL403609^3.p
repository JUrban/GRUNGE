...
thf(thm_2Efcp_2EFCP__UNIQUE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0f: tyop_2Efcp_2Ecart @ A_27a @ A_27b,V1g: tyop_2Enum_2Enum > A_27a] :
      ( ! [V2i: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ V2i @ ( c_2Efcp_2Edimindex @ A_27b @ ( c_2Ebool_2Ethe__value @ A_27b ) ) )
         => ( ( c_2Efcp_2Efcp__index @ A_27a @ A_27b @ V0f @ V2i )
            = ( V1g @ V2i ) ) )
    <=> ( ( c_2Efcp_2EFCP @ A_27a @ A_27b @ V1g )
        = V0f ) ) )).
