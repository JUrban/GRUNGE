...
fof(conj_thm_2Erich__list_2ELASTN__LASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ! [V1n] :
             ...
             => ! [V2m] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2m),ap(c_2Elist_2ELENGTH(A_27a),V0l)))
                   => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1n),V2m))
                     => ap(ap(c_2Erich__list_2ELASTN(A_27a),V1n),ap(ap(c_2Erich__list_2ELASTN(A_27a),V2m),V0l)) = ap(ap(c_2Erich__list_2ELASTN(A_27a),V1n),V0l) ) ) ) ) ) ) )).
