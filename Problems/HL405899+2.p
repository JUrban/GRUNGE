...
fof(conj_thm_2Earithmetic_2ESUB__RIGHT__EQ,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2ECONCAT__EXTRACT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V2l] :
                             ...
                             => ! [V3w] :
                                 ...
                                 => ( ( ap(ap(c_2Earithmetic_2E_2D,V0h),V1m) = ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))
                                      ...
                                      & ap(c_2Efcp_2Edimindex(ty_2Esum_2Esum(A_27b,A_27b)),c_2Ebool_2Ethe__value(ty_2Esum_2Esum(A_27b,A_27b))) != ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) )
                                   => ap(ap(c_2Ewords_2Eword__concat(A_27b,A_27b,A_27b),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),ap(ap(c_2Earithmetic_2E_2B,V1m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3w)),ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V1m),V2l),V3w)) = ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V2l),V3w) ) ) ) ) ) ) ) ) ) )).
