...
tff(conj_thm_2Earithmetic_2EOR__LESS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ereal_2EREAL__LET__TOTAL,lemma,(
...
tff(conj_thm_2Ereal_2ESUM__ZERO,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1N: tp__ty_2Enum_2Enum] :
          ( ! [V2n: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1N)))
             => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V2n))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
         => ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
             ...
             => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V4n))),V0f)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) )).
...
tff(ax_thm_2Eseq_2Esummable,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Esummable,V0f))
      <=> ? [V1s: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Eseq_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1s))) ) ) )).

tff(lmtp_f2887,type,(
    f2887: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2887,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f2887(V0x,V2c),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2887,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum] : ap(f2887(V0x,V2c),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),ap(V0x,inj__ty_2Enum_2Enum(V3n))) ) )).

tff(conj_thm_2Eseq_2ESER__CMUL,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Eseq_2Esums,V0x),inj__ty_2Erealax_2Ereal(V1x0)))
         => p(ap(ap(c_2Eseq_2Esums,f2887(V0x,V2c)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),inj__ty_2Erealax_2Ereal(V1x0)))) ) ) )).
...
tff(conj_thm_2Eseq_2ESER__COMPAR,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(lmtp_f2891,type,(
    f2891: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2891,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2891(V0x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2891,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1n: tp__ty_2Enum_2Enum] : ap(f2891(V0x),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Enum_2Enum(V1n)) )).

tff(conj_thm_2Eseq_2EGP,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
     => p(ap(ap(c_2Eseq_2Esums,f2891(V0x)),ap(c_2Erealax_2Einv,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V0x))))) ) )).

tff(conj_thm_2Eseq_2EABS__NEG__LEMMA,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0c)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V2y)))))
         => V1x = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Eseq_2ESER__RATIO,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2N: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1c)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))
            & ! [V3n: tp__ty_2Enum_2Enum] :
                ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V2N)))
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0f,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n))))),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1c)),ap(c_2Ereal_2Eabs,ap(V0f,inj__ty_2Enum_2Enum(V3n)))))) ) )
         => p(ap(c_2Eseq_2Esummable,V0f)) ) ) )).
