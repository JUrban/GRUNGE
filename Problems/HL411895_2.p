...
tff(lmtp_f4073,type,(
    f4073: ( tp__ty_2Erealax_2Ereal * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4073,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3y: tp__ty_2Erealax_2Ereal] : mem(f4073(V2b,V1t,V3y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f4073,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3y: tp__ty_2Erealax_2Ereal,V4z: tp__ty_2Erealax_2Ereal] : ap(f4073(V2b,V1t,V3y),inj__ty_2Erealax_2Ereal(V4z)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V3y)),inj__ty_2Erealax_2Ereal(V4z))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),V1t)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4z)),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2b)))))) ) )).

tff(lmtp_f4072,type,(
    f4072: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4072,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4072(V2b,V1t),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).

tff(lameq_f4072,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V1t: $i] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V3y: tp__ty_2Erealax_2Ereal] : ap(f4072(V2b,V1t),inj__ty_2Erealax_2Ereal(V3y)) = f4073(V2b,V1t,V3y) ) )).

tff(lmtp_f4075,type,(
    f4075: ( tp__ty_2Erealax_2Ereal * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4075,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5y: tp__ty_2Erealax_2Ereal] : mem(f4075(V2b,V0s,V5y),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f4075,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5y: tp__ty_2Erealax_2Ereal,V6z: tp__ty_2Erealax_2Ereal] : ap(f4075(V2b,V0s,V5y),inj__ty_2Erealax_2Ereal(V6z)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V5y)),inj__ty_2Erealax_2Ereal(V6z))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5y)),V0s)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6z)),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2b)))))) ) )).

tff(lmtp_f4074,type,(
    f4074: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f4074,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4074(V2b,V0s),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).

tff(lameq_f4074,axiom,(
    ! [V2b: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5y: tp__ty_2Erealax_2Ereal] : ap(f4074(V2b,V0s),inj__ty_2Erealax_2Ereal(V5y)) = f4075(V2b,V0s,V5y) ) )).

tff(conj_thm_2Ereal__topology_2EREAL__HAUSDIST__LE__SUMS,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
