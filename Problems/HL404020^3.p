...
thf(thm_2Equotient_2ERES__EXISTS__PRS,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0R: A_27a > A_27a > $o,V1abs: A_27a > A_27b,V2rep: A_27b > A_27a] :
     ...
     => ! [V3P: A_27b > $o,V4f: A_27b > $o] :
          ( ( c_2Ebool_2ERES__EXISTS @ A_27b @ V3P @ V4f )
          = ( c_2Ebool_2ERES__EXISTS @ A_27a @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ $o @ A_27b @ $o @ V1abs @ ( c_2Ecombin_2EI @ $o ) @ V3P ) @ ( c_2Equotient_2E_2D_2D_3E @ A_27a @ $o @ A_27b @ $o @ V1abs @ ( c_2Ecombin_2EI @ $o ) @ V4f ) ) ) ) )).
