...
fof(conj_thm_2Einteger_2EINT__LTE__TRANS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2EDeepSyntax_2Eneginf__ok,lemma,(
    ! [V0f] :
...
fof(conj_thm_2EDeepSyntax_2Eadd__d__neginf,lemma,(
    ! [V0f] :
      ( mem(V0f,ty_2EDeepSyntax_2Edeep__form)
     => ! [V1x] :
...
fof(conj_thm_2EDeepSyntax_2Eneginf__disj1__implies__exoriginal,conjecture,(
    ! [V0f] :
      ( mem(V0f,ty_2EDeepSyntax_2Edeep__form)
     => ! [V1d] :
