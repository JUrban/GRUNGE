...
thf(thm_2Elbtree_2Edepth__strongind,conjecture,(
    ! [A_27a: d,V0depth_27_2E0: u] :
      ( ( ! [V1x_2E0: u,V2t1_2E0: u,V3t2_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) ) @ V0depth_27_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V3t2_2E0 ) ) ) ) ) @ mono_2Ec_2Enum_2E0 )
        & ! [V4m: mono_2Etyop_2Enum_2Enum,V5x_2E0: u,V6a_2E0: u,V7t1_2E0: u,V8t2_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V7t1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4m ) ) ) ) )
              & ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) ) @ V0depth_27_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V7t1_2E0 ) ) ) @ V4m ) )
           => ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) ) @ V0depth_27_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V6a_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V7t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V8t2_2E0 ) ) ) ) ) @ ( mono_2Ec_2Enum_2ESUC @ V4m ) ) )
        & ! [V9m: mono_2Etyop_2Enum_2Enum,V10x_2E0: u,V11a_2E0: u,V12t1_2E0: u,V13t2_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V10x_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V13t2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V9m ) ) ) ) )
     ...
     => ! [V14a0_2E0: u,V15a1_2E0: u,V16a2: mono_2Etyop_2Enum_2Enum] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Edepth_2E3 @ ( s @ A_27a @ V14a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V15a1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V16a2 ) ) ) ) )
