...
thf(f5911_0_2E0,type,(
    f5911_0_2E0: u )).

thf(f5911_0_2E3,type,(
    f5911_0_2E3: du > du > du > u )).
...
thf(mono_2Ef5911_0,type,(
    mono_2Ef5911_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2EOmega__Automata_2EBOOLEAN__CLOSURE__FG,axiom,(
    ! [V2a: mono_2Etyop_2Enum_2Enum > $o,V18t: mono_2Etyop_2Enum_2Enum,V0t0: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef5911_0 @ V2a @ V18t @ V0t0 )
    <=> ( (~) @ ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) ) ) )).

thf(thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__FG,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum > $o,V2a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( (~)
          @ ? [V3t1: mono_2Etyop_2Enum_2Enum] :
            ! [V4t2: mono_2Etyop_2Enum_2Enum] :
              ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V3t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t2 @ V0t0 ) ) ) )
      <=> ! [V5t1: mono_2Etyop_2Enum_2Enum] :
          ? [V6t2: mono_2Etyop_2Enum_2Enum] :
            ( (~) @ ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V5t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V6t2 @ V0t0 ) ) ) ) )
      & ( ( ? [V7t1: mono_2Etyop_2Enum_2Enum] :
            ! [V8t2: mono_2Etyop_2Enum_2Enum] :
              ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t2 @ V0t0 ) ) )
          & ? [V9t1: mono_2Etyop_2Enum_2Enum] :
            ! [V10t2: mono_2Etyop_2Enum_2Enum] :
              ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V9t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V10t2 @ V0t0 ) ) ) )
      <=> ? [V11t1: mono_2Etyop_2Enum_2Enum] :
          ! [V12t2: mono_2Etyop_2Enum_2Enum] :
            ( ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t2 @ V0t0 ) ) )
            & ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V11t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t2 @ V0t0 ) ) ) ) )
      & ( ( ? [V13t1: mono_2Etyop_2Enum_2Enum] :
            ! [V14t2: mono_2Etyop_2Enum_2Enum] :
              ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V13t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V14t2 @ V0t0 ) ) )
          | ? [V15t1: mono_2Etyop_2Enum_2Enum] :
            ! [V16t2: mono_2Etyop_2Enum_2Enum] :
              ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V15t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V16t2 @ V0t0 ) ) ) )
      <=> ? [V17q: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V17q @ V0t0 ) )
            & ! [V18t: mono_2Etyop_2Enum_2Enum] :
                ( ( V17q @ ( mono_2Ec_2Earithmetic_2E_2B @ V18t @ ( mono_2Ec_2Earithmetic_2E_2B @ V0t0 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
                = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( V17q @ ( mono_2Ec_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) @ ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V18t @ V0t0 ) ) @ ( mono_2Ef5911_0 @ V2a @ V18t @ V0t0 ) ) )
            & ? [V19t1: mono_2Etyop_2Enum_2Enum] :
              ! [V20t2: mono_2Etyop_2Enum_2Enum] :
                ( ( (~) @ ( V17q @ ( mono_2Ec_2Earithmetic_2E_2B @ V19t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V20t2 @ V0t0 ) ) ) )
                | ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V19t1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V20t2 @ V0t0 ) ) ) ) ) ) ) )).
