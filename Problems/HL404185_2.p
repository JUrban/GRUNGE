...
tff(lmtp_f1689,type,(
    f1689: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f1689,axiom,(
    ! [V1i: tp__ty_2Enum_2Enum] : mem(f1689(V1i),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f1689,axiom,(
    ! [V1i: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] : ap(f1689(V1i),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1i))) )).

tff(conj_thm_2Epath_2EPL__take,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
     ...
     => ! [V1i: tp__ty_2Enum_2Enum] :
         ...
         => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),inj__ty_2Enum_2Enum(V1i)),V0p)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1689(V1i)) ) ) )).
...
tff(lmtp_f1690,type,(
    f1690: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1690,axiom,(
    ! [V1j: tp__ty_2Enum_2Enum,V0i: tp__ty_2Enum_2Enum] : mem(f1690(V1j,V0i),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f1690,axiom,(
    ! [V1j: tp__ty_2Enum_2Enum,V0i: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : ap(f1690(V1j,V0i),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3n)),ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3n)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1j)),inj__ty_2Enum_2Enum(V0i)))) )).

tff(conj_thm_2Epath_2EPL__seg,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1j: tp__ty_2Enum_2Enum,V2p: $i] :
      ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j)))
       ...
       => ap(c_2Epath_2EPL(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j)),V2p)) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f1690(V1j,V0i)) ) ) )).
