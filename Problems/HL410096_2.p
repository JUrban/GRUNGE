...
tff(lmtp_f3292,type,(
    f3292: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3292,axiom,(
...
tff(conj_thm_2Eiterate_2EITERATE__DELTA,lemma,(
...
tff(lmtp_f3519,type,(
    f3519: ( del * del * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3519,axiom,(
    ! [A_27a: del,A_27a: del,V0b: tp__ty_2Erealax_2Ereal,V2a: $i] :
      ( mem(V2a,A_27a)
     => mem(f3519(A_27a,A_27a,V0b,V2a),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f3519,axiom,(
    ! [A_27a: del,A_27a: del,V0b: tp__ty_2Erealax_2Ereal,V2a: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3519(A_27a,A_27a,V0b,V2a),V3x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(A_27a),V3x),V2a)),inj__ty_2Erealax_2Ereal(V0b)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) )).

tff(conj_thm_2Eproduct_2EPRODUCT__DELTA,conjecture,(
    ! [A_27a: del,V0b: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(A_27a,bool))
     => ! [V2a: $i] :
          ( mem(V2a,A_27a)
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3519(A_27a,A_27a,V0b,V2a))) = surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(A_27a),V2a),V1s)),inj__ty_2Erealax_2Ereal(V0b)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).
