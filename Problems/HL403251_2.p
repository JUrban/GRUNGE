...
tff(tp_c_2Ebag_2ESING__BAG,type,(
    c_2Ebag_2ESING__BAG: del > $i )).

tff(mem_c_2Ebag_2ESING__BAG,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2ESING__BAG(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),bool)) )).
...
tff(ax_thm_2Ebag_2ESING__BAG,axiom,(
    ! [A_27a: del,V0b: $i] :
...
tff(conj_thm_2Ebag_2EBAG__DELETE__SING,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
