...
thf(tp_c_2Ebag_2EBAG__CARD__RELn,type,(
    c_2Ebag_2EBAG__CARD__RELn: del > $i )).

thf(mem_c_2Ebag_2EBAG__CARD__RELn,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ebag_2EBAG__INSERT__commutes,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1e1: $i] :
          ( ( mem @ V1e1 @ A_27a )
         => ! [V2e2: $i] :
              ( ( mem @ V2e2 @ A_27a )
             => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1e1 ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e2 ) @ V0b ) )
                = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e2 ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V1e1 ) @ V0b ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__IN__BAG__DELETE,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ A_27a )
...
thf(conj_thm_2Ebag_2EBAG__INSERT__EQUAL,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ A_27a )
     => ! [V1M: $i] :
         ...
         => ! [V2b: $i] :
             ...
             => ! [V3N: $i] :
                 ...
                 => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0a ) @ V1M )
                      = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2b ) @ V3N ) )
                  <=> ( ( ( V1M = V3N )
                        & ( V0a = V2b ) )
                      | ? [V4k: $i] :
                          ( ( mem @ V4k @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
                          & ( V1M
                            = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2b ) @ V4k ) )
                          & ( V3N
                            = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0a ) @ V4k ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ebag_2EFINITE__EMPTY__BAG,lemma,(
    ! [A_27a: del] :
      ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) )).

thf(conj_thm_2Ebag_2EFINITE__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(ax_thm_2Ebag_2EBAG__CARD__RELn,axiom,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__CARD__RELn @ A_27a ) @ V0b ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
        <=> ! [V2P: $i] :
              ( ( mem @ V2P @ ( arr @ ( arr @ A_27a @ ty_2Enum_2Enum ) @ ( arr @ ty_2Enum_2Enum @ bool ) ) )
             => ( ( ( p @ ( ap @ ( ap @ V2P @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                  & ! [V3b: $i] :
                      ( ( mem @ V3b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
                     => ! [V4n: tp__ty_2Enum_2Enum] :
                          ( ( p @ ( ap @ ( ap @ V2P @ V3b ) @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
                         => ! [V5e: $i] :
                              ( ( mem @ V5e @ A_27a )
                             => ( p @ ( ap @ ( ap @ V2P @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V5e ) @ V3b ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) ) ) ) )
               => ( p @ ( ap @ ( ap @ V2P @ V0b ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) ) )).

thf(ax_thm_2Ebag_2EBAG__CARD,axiom,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
...
thf(conj_thm_2Ebag_2EBAG__CARD__THM,conjecture,(
    ! [A_27a: del] :
