...
tff(lamtp_f1906,axiom,(
    ! [A_27b: del,A_27b: del] : mem(f1906(A_27b,A_27b),arr(A_27b,arr(A_27b,A_27b))) )).

tff(lameq_f1906,axiom,(
    ! [A_27b: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27b)
     => ap(f1906(A_27b,A_27b),V0x) = k(A_27b,V0x) ) )).

tff(conj_thm_2Efinite__map_2EFMERGE__FUNION,conjecture,(
    ! [A_27a: del,A_27b: del] : c_2Efinite__map_2EFUNION(A_27a,A_27a) = ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),f1906(A_27b,A_27b)) )).
