...
fof(conj_thm_2Ereal__topology_2ECONTRACTION__IMP__CONTINUOUS__ON,lemma,(
    ! [V0s] :
         ...
         => ( ! [V2x] :
               ...
               => ! [V3y] :
                   ...
                   => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s))
                     ...
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V1f,V2x)),ap(V1f,V3y)))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),V3y)))) ) ) )
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1f),V0s)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EISOMETRY__ON__IMP__CONTINUOUS__ON,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
