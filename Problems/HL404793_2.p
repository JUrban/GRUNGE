...
tff(conj_thm_2Efinite__map_2Efmap__rel__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => p(ap(ap(ap(c_2Efinite__map_2Efmap__rel(A_27a,A_27a,A_27a),V0R),c_2Efinite__map_2EFEMPTY(A_27c,A_27c)),c_2Efinite__map_2EFEMPTY(A_27c,A_27c))) ) )).
