...
thf(conj_thm_2Ebag_2EBAG__DIFF__UNION__eliminate,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( ( mem @ V0b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b2: $i] :
          ( ( mem @ V1b2 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ! [V2b3: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V1b2 ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V2b3 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b2 ) @ V2b3 ) )
                & ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V1b2 ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2b3 ) @ V0b1 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b2 ) @ V2b3 ) )
                & ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1b2 ) @ V0b1 ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b1 ) @ V2b3 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b2 ) @ V2b3 ) )
                & ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1b2 ) @ V0b1 ) ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V2b3 ) @ V0b1 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b2 ) @ V2b3 ) ) ) ) ) ) )).
