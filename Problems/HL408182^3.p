    ...
    ! [V0p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Elist_2EEVERY @ tyop_2Erealax_2Ereal
        @ ^ [V2c: tyop_2Erealax_2Ereal] :
            ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V2c @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
        @ ( c_2Epoly_2Epoly__diff__aux @ ( c_2Enum_2ESUC @ V1n ) @ V0p ) )
      = ( c_2Elist_2EEVERY @ tyop_2Erealax_2Ereal
        @ ^ [V3c: tyop_2Erealax_2Ereal] :
            ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V3c @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
        @ V0p ) ) )).
...
thf(thm_2Epoly_2EPOLY__DIFF__ISZERO,conjecture,(
    ! [V0p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( ( c_2Epoly_2Epoly @ ( c_2Epoly_2Ediff @ V0p ) )
        = ( c_2Epoly_2Epoly @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) )
     => ? [V1h: tyop_2Erealax_2Ereal] :
          ( ( c_2Epoly_2Epoly @ V0p )
          = ( c_2Epoly_2Epoly @ ( c_2Elist_2ECONS @ tyop_2Erealax_2Ereal @ V1h @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) ) ) )).
