...
fof(conj_thm_2Epred__set_2EUNIQUE__MEMBER__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Eset__relation_2Epartial__order__linear__order,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
...
fof(conj_thm_2Eset__relation_2Efinite__prefix__po__has__minimal__path,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
fof(conj_thm_2Eset__relation_2Eminimal__linear__order__unique,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
...
fof(conj_thm_2Eset__relation_2Efinite__prefix__linear__order__has__unique__minimal,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
