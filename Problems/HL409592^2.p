...
thf(conj_thm_2Ecardinal_2EFINITE__IMAGE__INJ__EQ,lemma,(
...
thf(conj_thm_2Ecardinal_2Enum__INFINITE,lemma,(
...
thf(conj_thm_2Epred__set_2EGSPEC__EQ2,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( ( mem @ V0y @ A_27a )
     => ( ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
          @ ( lam @ A_27a
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V1x ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V0y ) @ V1x ) ) ) )
...
thf(conj_thm_2Ereal_2EREAL__EQ__LADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
...
thf(conj_thm_2Ereal_2EREAL__EQ__LMUL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
...
thf(conj_thm_2Ereal_2EREAL__INV__INJ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Eiterate_2EFINITE__REAL__INTERVAL,conjecture,
          ...
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V1x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V1x ) ) ) ) ) )
        ...
        ~ ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V3x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V2a ) ) @ V3x ) ) ) ) ) )
        ...
        ~ ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V5x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V5x ) @ ( inj__ty_2Erealax_2Ereal @ V4b ) ) ) ) ) ) )
    & ! [V6b: tp__ty_2Erealax_2Ereal] :
        ~ ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V7x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V7x ) @ ( inj__ty_2Erealax_2Ereal @ V6b ) ) ) ) ) ) )
        ...
        ( ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V10x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V10x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V8a ) ) @ V10x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V10x ) @ ( inj__ty_2Erealax_2Ereal @ V9b ) ) ) ) ) ) ) )
        ...
        ( ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V13x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V13x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V11a ) ) @ V13x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V13x ) @ ( inj__ty_2Erealax_2Ereal @ V12b ) ) ) ) ) ) ) )
        ...
        ( ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V16x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V16x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V14a ) ) @ V16x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V16x ) @ ( inj__ty_2Erealax_2Ereal @ V15b ) ) ) ) ) ) ) )
        ...
        ( ( p
          @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V19x: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V19x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V17a ) ) @ V19x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V19x ) @ ( inj__ty_2Erealax_2Ereal @ V18b ) ) ) ) ) ) ) )
