...
fof(conj_thm_2Earithmetic_2ESUB__PLUS,lemma,(
    ! [V0a] :
...
fof(mem_c_2Ewords_2Eword__reverse,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__reverse(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(lamtp_f2184,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2184(A_27a,V0w),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2184,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2184(A_27a,V0w),V1i) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1i)) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__reverse__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Eword__reverse(A_27a),V0w) = ap(c_2Efcp_2EFCP(bool,bool),f2184(A_27a,V0w)) ) ) )).
...
fof(conj_thm_2Ewords_2EWORD__NEG__1__T,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0i] :
          ( mem(V0i,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__reverse__thm,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
