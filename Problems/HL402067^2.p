...
thf(ax_thm_2Eset__relation_2Eall__choices__def,axiom,(
    ! [A_27a: del,V0xss: $i] :
      ( ( mem @ V0xss @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ( ( ap @ ( c_2Eset__relation_2Eall__choices @ A_27a ) @ V0xss )
        = ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ A_27a ) )
          @ ( lam @ ( arr @ ( arr @ A_27a @ bool ) @ A_27a )
            @ ^ [V1choice: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ A_27a ) @ V1choice ) @ V0xss ) )
                @ ( ap @ ( c_2Ebool_2E_21 @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V2xs: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2xs ) @ V0xss ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ ( ap @ V1choice @ V2xs ) ) @ V2xs ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eset__relation_2Eall__choices__thm,conjecture,(
    ! [A_27a: del,V0x: $i] :
