...
fof(conj_thm_2Ereal__topology_2ELIM__NULL__COMPARISON,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V1f] :
             ...
             => ! [V2g] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3753(A_27a,V1f,V2g)),V0net))
                      & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3754(A_27a,V2g)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net)) )
