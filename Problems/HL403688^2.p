...
thf(conj_thm_2Esorting_2EPERM__APPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Esorting_2EPERM__APPEND__IFF,lemma,(
    ! [A_27a: del] :
      ( ! [V0l: $i] :
...
thf(conj_thm_2Esorting_2EPERM__lifts__transitive__relations,lemma,(
...
thf(conj_thm_2Esorting_2EPERM__lifts__monotonicities,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
