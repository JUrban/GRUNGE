...
tff(conj_thm_2Efcp_2EEL__V2L,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1v: $i] :
     ...
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
       => ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2EV2L(A_27a,A_27a),V1v)) = ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1v),inj__ty_2Enum_2Enum(V0i)) ) ) )).
