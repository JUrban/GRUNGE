...
thf(thm_2Ereal__topology_2EFRONTIER__INTER__SUBSET,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V0s @ V1t ) ) @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ V0s ) @ ( c_2Ereal__topology_2Efrontier @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2EFRONTIER__UNION__SUBSET,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V0s @ V1t ) ) @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ V0s ) @ ( c_2Ereal__topology_2Efrontier @ V1t ) ) ) )).
