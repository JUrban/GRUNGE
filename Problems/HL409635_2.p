...
tff(conj_thm_2Ereal_2EABS__BOUNDS,lemma,(
...
tff(conj_thm_2Eiterate_2ESUP__INSERT__FINITE,lemma,(
...
tff(conj_thm_2Eiterate_2EINF__INSERT__FINITE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V1s))
...
tff(conj_thm_2Eiterate_2EREAL__SUP__EQ__INF,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
          & ? [V1B: tp__ty_2Erealax_2Ereal] :
