...
thf(conj_thm_2Ereal__topology_2ELIM__WITHIN__OPEN,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__EQ__CONTINUOUS__AT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
