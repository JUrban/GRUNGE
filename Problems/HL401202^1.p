...
thf(f1374_0_2E0,type,(
    f1374_0_2E0: u )).

thf(f1374_0_2E2,type,(
    f1374_0_2E2: du > du > u )).
...
thf(c_2Egcd_2Egcd_2E0,type,(
    c_2Egcd_2Egcd_2E0: u )).

thf(c_2Egcd_2Egcd_2E2,type,(
...
thf(mono_2Ef1374_0,type,(
    mono_2Ef1374_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(mono_2Ec_2Egcd_2Egcd,type,(
    mono_2Ec_2Egcd_2Egcd: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Egcd_2EGCD__0R,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Egcd_2Egcd @ V0a @ mono_2Ec_2Enum_2E0 )
      = V0a ) )).

thf(thm_2Egcd_2EGCD__0L,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Egcd_2Egcd @ mono_2Ec_2Enum_2E0 @ V0a )
      = V0a ) )).

thf(thm_2Egcd_2EL__EUCLIDES,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum,V2c: mono_2Etyop_2Enum_2Enum] :
      ( ( ( ( mono_2Ec_2Egcd_2Egcd @ V0a @ V1b )
          = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
        & ( mono_2Ec_2Edivides_2Edivides @ V1b @ ( mono_2Ec_2Earithmetic_2E_2A @ V0a @ V2c ) ) )
     => ( mono_2Ec_2Edivides_2Edivides @ V1b @ V2c ) ) )).

thf(thm_2Egcd_2EFACTOR__OUT__GCD,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( ( (~) @ ( V0n = mono_2Ec_2Enum_2E0 ) )
        & ( (~) @ ( V1m = mono_2Ec_2Enum_2E0 ) ) )
     => ? [V2p: mono_2Etyop_2Enum_2Enum,V3q: mono_2Etyop_2Enum_2Enum] :
          ( ( V0n
            = ( mono_2Ec_2Earithmetic_2E_2A @ V2p @ ( mono_2Ec_2Egcd_2Egcd @ V0n @ V1m ) ) )
          & ( V1m
            = ( mono_2Ec_2Earithmetic_2E_2A @ V3q @ ( mono_2Ec_2Egcd_2Egcd @ V0n @ V1m ) ) )
          & ( ( mono_2Ec_2Egcd_2Egcd @ V2p @ V3q )
            = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )).

thf(def0_2Ethm_2Egcd_2Elcm__def,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1374_0 @ V0m @ V1n )
    <=> ( ( V0m = mono_2Ec_2Enum_2E0 )
        | ( V1n = mono_2Ec_2Enum_2E0 ) ) ) )).

thf(thm_2Egcd_2Elcm__def,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Egcd_2Elcm @ V0m @ V1n )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef1374_0 @ V0m @ V1n ) @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2EDIV @ ( mono_2Ec_2Earithmetic_2E_2A @ V0m @ V1n ) @ ( mono_2Ec_2Egcd_2Egcd @ V0m @ V1n ) ) ) ) )).
...
thf(thm_2Egcd_2ELCM__IS__LEAST__COMMON__MULTIPLE,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
