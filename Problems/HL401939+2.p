...
fof(conj_thm_2Eset__relation_2Edomain__mono,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0r] :
             ...
             => ! [V1r_27] :
                 ...
                 => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Epair_2Eprod(A_27a,A_27a)),V0r),V1r_27))
                   => p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),ap(c_2Eset__relation_2Edomain(A_27a,A_27a),V0r)),ap(c_2Eset__relation_2Edomain(A_27a,A_27a),V1r_27))) ) ) ) ) ) )).
