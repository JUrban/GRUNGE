...
fof(conj_thm_2EHolSmt_2Er242,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V1x] :
                     ...
                     => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27c),c_2Ebool_2Ethe__value(A_27c))))
                       => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0y),ap(c_2Ewords_2Edimword(A_27b),c_2Ebool_2Ethe__value(A_27b))))
                         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
                           => ( ap(ap(c_2Ewords_2Eword__concat(A_27a,A_27a,A_27a),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)),V1x) = ap(c_2Ewords_2En2w(A_27c),V0y)
