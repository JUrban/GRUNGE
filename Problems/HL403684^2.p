...
thf(ax_thm_2Erelation_2ESC__DEF,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ! [V2y: $i] :
              ( ( mem @ V2y @ A_27a )
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Erelation_2ESC @ A_27a ) @ V0R ) @ V1x ) @ V2y ) )
              <=> ( ( p @ ( ap @ ( ap @ V0R @ V1x ) @ V2y ) )
                  | ( p @ ( ap @ ( ap @ V0R @ V2y ) @ V1x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Esorting_2EPERM__REFL,lemma,(
    ! [A_27a: del,V0L: $i] :
      ( ( mem @ V0L @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( p @ ( ap @ ( ap @ ( c_2Esorting_2EPERM @ A_27a ) @ V0L ) @ V0L ) ) ) )).

thf(conj_thm_2Esorting_2EPERM__SINGLE__SWAP__SYM,lemma,(
    ! [A_27a: del,V0l1: $i] :
