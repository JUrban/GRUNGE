...
fof(thm_2Eordinal_2Esup__EMPTY,axiom,(
    ! [A_27a] : s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Esup_2E1(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,c_2Enum_2E0_2E0))) )).
...
fof(thm_2Eordinal_2Egeneric__continuity,axiom,(
    ! [A_27a,V0f_2E0] :
      ( ( ! [V1a_2E0] :
     ...
     => ! [V4s_2E0] :
          ( ( p(s(tyop_2Emin_2Ebool,c_2Ecardinal_2Ecardleq_2E2(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V4s_2E0),s(tyop_2Emin_2Efun(tyop_2Esum_2Esum(tyop_2Enum_2Enum,A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EUNIV_2E0))))
...
fof(thm_2Eordinal_2EordMULT__continuous,conjecture,(
