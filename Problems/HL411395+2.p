...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__DISJOINT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
         ...
         => ! [V2b] :
             ...
             => ( p(ap(ap(c_2Epred__set_2EDISJOINT(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1a)),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V2b)))
              <=> ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1a),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V2b))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2y] :
             ...
             => ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) = ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V2y)
              <=> ( ( ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
                    & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V0s)) )
                  | ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
                    & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V0s))
                    & p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x),V2y)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EBIGUNION__CONNECTED__COMPONENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(lamtp_f3933,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3933(V0s),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

fof(lameq_f3933,axiom,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2y] :
          ( mem(V2y,ty_2Erealax_2Ereal)
         => ap(f3933(V0s),V2y) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V2y)),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2y),V0s)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),V0s),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x)) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EDELETE(arr(ty_2Erealax_2Ereal,bool)),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3933(V0s))),ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x))) ) ) )).
