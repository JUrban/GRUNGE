...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__INV,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1a))))
            & surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V1a))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
         => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),c_2Erealax_2Einv),V0f)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1a)))) ) ) )).
