...
fof(lamtp_f392,axiom,(
    ! [A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f392(A_27a,V0P),arr(A_27a,bool)) ) )).
...
fof(lameq_f392,axiom,(
    ! [A_27a,V0P] :
     ...
     => ! [V2x] :
          ( mem(V2x,A_27a)
         => ap(f392(A_27a,V0P),V2x) = ap(c_2Ebool_2E_7E,ap(V0P,V2x)) ) ) )).
...
fof(conj_thm_2Erich__list_2ESPLITP__EVERY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
