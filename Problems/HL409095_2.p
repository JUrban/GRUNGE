...
tff(conj_thm_2Ecomplex_2EMODU__REAL,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Emodu,ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V0x))) )).
