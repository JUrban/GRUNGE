...
fof(conj_thm_2Ebasis__emit_2Ei2w__itself__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
         ...
         => ( ! [V1i] :
               ...
               => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Einteger_2Eint,ty_2Einteger_2Eint),V1i),c_2Ebool_2Ethe__value(A_27a)))) )
           => ! [V2v] :
                ( mem(V2v,ty_2Einteger_2Eint)
               => ! [V3v1] :
                    ( mem(V3v1,ty_2Ebool_2Eitself(A_27a))
                   => p(ap(V0P,ap(ap(c_2Epair_2E_2C(ty_2Einteger_2Eint,ty_2Einteger_2Eint),V2v),V3v1))) ) ) ) ) ) )).
