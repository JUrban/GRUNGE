...
thf(ax_thm_2Ebitstring_2Eextend__def,axiom,
    ( ! [V0v0: $o,V1l: tp__c_ty_2Elist_2Elist_o] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V0v0 ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V1l ) ) )
        = V1l )
    & ! [V2c: $o,V3n: tp__ty_2Enum_2Enum,V4l: tp__c_ty_2Elist_2Elist_o] :
        ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V2c ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V4l ) ) )
        = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V2c ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V2c ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V4l ) ) ) ) ) )).

thf(conj_thm_2Ebitstring_2Eextend__cons,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $o,V2l: tp__c_ty_2Elist_2Elist_o] :
      ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V1c ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V2l ) ) )
      = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( inj__o @ V1c ) ) @ ( ap @ ( ap @ ( ap @ c_2Ebitstring_2Eextend @ ( inj__o @ V1c ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V2l ) ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Epad__left__extend,conjecture,(
