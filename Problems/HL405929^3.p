...
thf(thm_2Ebit_2EEXISTS__BIT__LT,axiom,(
    ! [V0b: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( ( (~) @ ( V1n = c_2Enum_2E0 ) )
        & ( c_2Eprim__rec_2E_3C @ V1n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0b ) ) )
     => ? [V2i: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ V2i @ V0b )
          & ( c_2Ebit_2EBIT @ V2i @ V1n ) ) ) )).
