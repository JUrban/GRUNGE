...
thf(thm_2Ellist_2Ellength__rel__rules,conjecture,(
    ! [A_27a: d] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Ellength__rel_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) )
      & ! [V0h_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2t_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Ellength__rel_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Ellength__rel_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V2t_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) ) ) ) ) ) )).
