...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE,lemma,(
    ! [V0f: $i] :
...
tff(lameq_f3920,axiom,(
    ! [V2g: $i] :
      ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3920(V2g,V1f),inj__ty_2Erealax_2Ereal(V5x)) = ap(V1f,ap(V2g,inj__ty_2Erealax_2Ereal(V5x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE__EQ,conjecture,(
     ...
     => ! [V2g: $i] :
         ...
         => ! [V3h: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V2g),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0x))))
                  ...
                  & ! [V4y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(V2g,ap(V3h,inj__ty_2Erealax_2Ereal(V4y)))) = V4y
                  & surj__ty_2Erealax_2Ereal(ap(V3h,ap(V2g,inj__ty_2Erealax_2Ereal(V0x)))) = V0x )
               => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V1f),ap(c_2Ereal__topology_2Eat,ap(V2g,inj__ty_2Erealax_2Ereal(V0x)))))
                <=> p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3920(V2g,V1f)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0x)))) ) ) ) ) ) )).
