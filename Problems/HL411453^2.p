...
thf(conj_thm_2Ereal_2EABS__SUB__ABS,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__RANGE,lemma,(
    ! [V0f: $i] :
                   ...
                   => ? [V4d: tp__ty_2Erealax_2Ereal] :
                        ...
                        & ! [V5x_27: tp__ty_2Erealax_2Ereal] :
                            ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ V1s ) )
                              & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) ) )
                           => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__INF,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EDISTANCE__ATTAINS__INF,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
