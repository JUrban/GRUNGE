...
thf(conj_thm_2Eproduct_2ENPRODUCT__EQ__0,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eproduct_2ENPRODUCT__EQ__0__NUMSEG,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
        ...
        <=> ? [V3x: tp__ty_2Enum_2Enum] :
              ...
              & ( ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3x ) ) )
                = fo__c_2Enum_2E0 ) ) ) ) )).
