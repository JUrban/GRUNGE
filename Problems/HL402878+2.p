...
fof(conj_thm_2Erich__list_2EEVERY2__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V4l4] :
                             ...
                             => ( ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V1l1),V2l2))
                              ...
                              <=> ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V3l3)),ap(ap(c_2Elist_2EAPPEND(A_27b),V2l2),V4l4)))
                                  ...
                                  & ap(c_2Elist_2ELENGTH(A_27a),V3l3) = ap(c_2Elist_2ELENGTH(A_27b),V4l4) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EEVERY2__APPEND__suff,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
