...
tff(conj_thm_2Epred__set_2ECOUNT__11,lemma,(
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__CONG,lemma,(
    ! [A_27a: del,V0s1: $i] :
...
tff(conj_thm_2Epred__set_2ESUM__IMAGE__ZERO,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
...
tff(lmtp_f1109,type,(
    f1109: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f1109,axiom,(
...
tff(lameq_f1109,axiom,(
    ! [V3k: tp__ty_2Enum_2Enum,V4m: tp__ty_2Enum_2Enum,V2f: $i] :
      ( mem(V2f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V5x: tp__ty_2Enum_2Enum] : ap(f1109(V3k,V4m,V2f),inj__ty_2Enum_2Enum(V5x)) = ap(V2f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V5x)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V3k)),inj__ty_2Enum_2Enum(V4m)))) ) )).

tff(conj_thm_2Esorting_2ESUM__IMAGE__count__MULT,lemma,(
     ...
     => ! [V2f: $i] :
         ...
         => ! [V3k: tp__ty_2Enum_2Enum] :
              ( ! [V4m: tp__ty_2Enum_2Enum] :
                 ...
                 => surj__ty_2Enum_2Enum(ap(V1g,inj__ty_2Enum_2Enum(V4m))) = surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(ty_2Enum_2Enum),f1109(V3k,V4m,V2f)),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V3k)))) )
...
tff(lmtp_f1110,type,(
    f1110: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1110,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum] : mem(f1110(V0f,V1a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f1110,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum] : ap(f1110(V0f,V1a),inj__ty_2Enum_2Enum(V3m)) = ap(ap(c_2Epred__set_2ESUM__IMAGE(ty_2Enum_2Enum),ap(V0f,inj__ty_2Enum_2Enum(V3m))),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V1a))) ) )).

tff(lmtp_f1111,type,(
    f1111: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1111,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum] : mem(f1111(V0f,V1a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f1111,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum,V4m: tp__ty_2Enum_2Enum] : ap(f1111(V0f,V1a),inj__ty_2Enum_2Enum(V4m)) = ap(ap(V0f,ap(ap(c_2Earithmetic_2EDIV,inj__ty_2Enum_2Enum(V4m)),inj__ty_2Enum_2Enum(V1a))),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V4m)),inj__ty_2Enum_2Enum(V1a))) ) )).

tff(conj_thm_2Esorting_2Esum__of__sums,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)))
     => ! [V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(ty_2Enum_2Enum),f1110(V0f,V1a)),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V2b)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(ty_2Enum_2Enum),f1111(V0f,V1a)),ap(c_2Epred__set_2Ecount,ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V1a)),inj__ty_2Enum_2Enum(V2b))))) ) )).
