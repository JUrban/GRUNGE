...
thf(f12546_0_2E0,type,(
    f12546_0_2E0: u )).

thf(f12546_0_2E2,type,(
    f12546_0_2E2: du > du > u )).

thf(f12546_1_2E0,type,(
    f12546_1_2E0: u )).

thf(f12546_1_2E2,type,(
    f12546_1_2E2: du > du > u )).

thf(f12546_1_2E4,type,(
    f12546_1_2E4: du > du > du > du > u )).

thf(f12546_2_2E0,type,(
    f12546_2_2E0: u )).

thf(f12546_2_2E4,type,(
    f12546_2_2E4: du > du > du > du > u )).
...
thf(mono_2Ef12546_0,type,(
    mono_2Ef12546_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).

thf(mono_2Ef12546_1,type,(
    mono_2Ef12546_1: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef12546_2,type,(
    mono_2Ef12546_2: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Eiterate_2EREAL__LE__INF__SUBSET,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( (~) @ ( V1t = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) )
        ...
        & ? [V2b: mono_2Etyop_2Erealax_2Ereal] :
          ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3x @ V0s )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ V2b @ V3x ) ) )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Eiterate_2Einf @ V0s ) @ ( mono_2Ec_2Eiterate_2Einf @ V1t ) ) ) )).
...
thf(thm_2Ereal__topology_2EDIST__POS__LE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0x @ V1y ) ) ) )).

thf(def0_2Ethm_2Ereal__topology_2Esetdist,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef12546_0 @ V0s @ V1t )
    <=> ( ( V0s = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal )
        | ( V1t = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2Esetdist,axiom,(
...
thf(def2_2Ethm_2Ereal__topology_2Esetdist,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12546_1 @ V0s @ V1t @ V2x @ V3y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V2x @ V3y ) ) @ ( mono_2Ef12546_2 @ V2x @ V0s @ V3y @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2Esetdist,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ...
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12546_0 @ V0s @ V1t ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Eiterate_2Einf @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 @ ( mono_2Ec_2Epair_2EUNCURRY_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ef12546_1 @ V0s @ V1t ) ) ) ) ) ) )).
