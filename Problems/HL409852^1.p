...
thf(thm_2Eiterate_2ESUM__CLOSED,conjecture,(
    ! [A_27a: d,V0P: mono_2Etyop_2Erealax_2Ereal > $o,V1f_2E0: u,V2s_2E0: u] :
      ( ( ( V0P @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal,V4y: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( V0P @ V3x )
              & ( V0P @ V4y ) )
           => ( V0P @ ( mono_2Ec_2Erealax_2Ereal__add @ V3x @ V4y ) ) )
        & ! [V5a_2E0: u] :
     ...
     => ( V0P @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Erealax_2Ereal ) @ V1f_2E0 ) ) ) ) ) ) )).
