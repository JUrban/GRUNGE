...
tff(conj_thm_2EquantHeuristics_2EGUESS__RULES__CONSTANT__EXISTS,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: $i] :
      ( mem(V0i,arr(A_27a,A_27b))
     => ! [V1p: tp__o] :
          ( p(ap(ap(c_2EquantHeuristics_2EGUESS__EXISTS(A_27a,A_27a),V0i),k(A_27b,inj__o(V1p))))
        <=> $true ) ) )).
