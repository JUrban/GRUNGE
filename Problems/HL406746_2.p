...
tff(mem_c_2Epatricia_2EADD__LIST,axiom,(
    ! [A_27a: del] : mem(c_2Epatricia_2EADD__LIST(A_27a),arr(ty_2Epatricia_2Eptree(A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ty_2Epatricia_2Eptree(A_27a)))) )).
...
tff(conj_thm_2Epatricia_2EADD__LIST__IS__PTREE,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Epatricia_2EADD__LIST__TO__EMPTY__IS__PTREE,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
