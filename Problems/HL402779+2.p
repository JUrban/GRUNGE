...
fof(conj_thm_2Elist_2EEL__LUPDATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ys] :
...
fof(conj_thm_2Elist_2ELENGTH__LUPDATE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Erich__list_2ELUPDATE__APPEND2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
          ( mem(V0l1,ty_2Elist_2Elist(A_27a))
         => ! [V1l2] :
             ...
             => ! [V2n] :
                 ...
                 => ! [V3x] :
                      ( mem(V3x,A_27a)
                     => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l1)),V2n))
                       => ap(ap(ap(c_2Elist_2ELUPDATE(A_27a),V3x),V2n),ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),ap(ap(ap(c_2Elist_2ELUPDATE(A_27a),V3x),ap(ap(c_2Earithmetic_2E_2D,V2n),ap(c_2Elist_2ELENGTH(A_27a),V0l1))),V1l2)) ) ) ) ) ) ) )).
