...
thf(c_2Estate__transformer_2EUNIT_2E2,type,(
...
thf(arityeq1_2Emono_2Ec_2Ecombin_2EK_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( c_2Ecombin_2EK_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ c_2Ecombin_2EK_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Estate__transformer_2EUNIT_2E1_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Estate__transformer_2EUNIT_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ c_2Estate__transformer_2EUNIT_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ec_2Estate__transformer_2EUNIT_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Estate__transformer_2EUNIT_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) ) @ c_2Estate__transformer_2EUNIT_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ecombin_2Eo_2E2_2Emono_2EA_27b_20mono_2EA_27a_20mono_2Etyop_2Epair_2Eprod_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) ) @ c_2Ecombin_2Eo_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Estate__transformer_2EUNIT__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1x_27_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Estate__transformer_2EUNIT_2E2 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ A_27a @ V1x_27_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27b @ V0x_2E0 ) @ ( s @ A_27a @ V1x_27_2E0 ) ) ) ) )).

thf(thm_2Estate__transformer_2EFST__o__UNIT,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Estate__transformer_2EUNIT_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( c_2Ecombin_2EK_2E1 @ ( s @ A_27a @ V0x_2E0 ) ) ) ) )).
