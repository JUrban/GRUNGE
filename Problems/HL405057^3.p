...
thf(thm_2EOmega__Automata_2ECO__BUECHI__UNTIL__CLOSURE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0t0: tyop_2Enum_2Enum,V1phi: tyop_2Enum_2Enum > $o,V2i: tyop_2Enum_2Enum > A_27a,V3c: A_27b,V4Psi: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V5Phi__R: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V6Phi__I: A_27b > $o] :
      ( ( c_2ETemporal__Logic_2EUNTIL @ V1phi
        ...
        @ V0t0 )
    <=> ? [V12p: tyop_2Enum_2Enum > $o,V13q: tyop_2Enum_2Enum > A_27b] :
          ( ( c_2Ebool_2ECOND @ $o @ ( V12p @ V0t0 ) @ ( V6Phi__I @ ( V13q @ V0t0 ) ) @ ( c_2Emin_2E_3D @ A_27b @ ( V13q @ V0t0 ) @ V3c ) )
          & ! [V14t: tyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) ) )
                & ( ( V13q @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) )
                  = V3c )
                & ( V1phi @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) )
                & ( (~) @ ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
                & ( ( V13q @ ( c_2Earithmetic_2E_2B @ V14t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                  = V3c ) )
              | ( ( (~) @ ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) ) )
                & ( ( V13q @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) )
                  = V3c )
                & ( V1phi @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) )
                & ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                & ( V6Phi__I @ ( V13q @ ( c_2Earithmetic_2E_2B @ V14t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
              | ( ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) )
                & ( V5Phi__R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) ) @ ( V13q @ ( c_2Earithmetic_2E_2B @ V14t @ V0t0 ) ) ) )
                & ( V12p @ ( c_2Earithmetic_2E_2B @ V14t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
          & ? [V15t1: tyop_2Enum_2Enum] :
            ! [V16t2: tyop_2Enum_2Enum] :
              ( ( (~) @ ( V12p @ ( c_2Earithmetic_2E_2B @ V15t1 @ ( c_2Earithmetic_2E_2B @ V16t2 @ V0t0 ) ) ) )
              | ( V4Psi @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V2i @ ( c_2Earithmetic_2E_2B @ V15t1 @ ( c_2Earithmetic_2E_2B @ V16t2 @ V0t0 ) ) ) @ ( V13q @ ( c_2Earithmetic_2E_2B @ V15t1 @ ( c_2Earithmetic_2E_2B @ V16t2 @ V0t0 ) ) ) ) ) ) ) ) )).
