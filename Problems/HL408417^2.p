...
thf(conj_thm_2Etransc_2EDIFF__LN__COMPOSITE,conjecture,(
    ! [V0g: $i] :
     ...
     => ! [V1m: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ ( ap @ c_2Elim_2Ediffl @ V0g ) @ ( inj__ty_2Erealax_2Ereal @ V1m ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) )
            & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ V0g @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) )
         => ( p
            @ ( ap
              @ ( ap
                @ ( ap @ c_2Elim_2Ediffl
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V3x: $i] :
                        ( ap @ c_2Etransc_2Eln @ ( ap @ V0g @ V3x ) ) ) )
                @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Erealax_2Einv @ ( ap @ V0g @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1m ) ) )
