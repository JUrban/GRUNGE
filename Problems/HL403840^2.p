...
thf(conj_thm_2Ellist_2ELTAKE__EQ__SOME__CONS,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( ( mem @ V1l @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V2x: $i] :
          ( ( mem @ V2x @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
              = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2x ) )
           => ! [V3h: $i] :
                ( ( mem @ V3h @ A_27a )
               => ? [V4y: $i] :
                    ( ( mem @ V4y @ ( ty_2Elist_2Elist @ A_27a ) )
                    & ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V3h ) @ V1l ) )
                      = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Elist_2Elist @ A_27a ) ) @ V4y ) ) ) ) ) ) ) )).
