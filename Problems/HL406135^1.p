...
thf(f6839_0_2E0,type,(
    f6839_0_2E0: u )).

thf(f6839_0_2E1,type,(
    f6839_0_2E1: du > u )).

thf(f6839_0_2E2,type,(
    f6839_0_2E2: du > du > u )).
...
thf(mono_2Ef6839_0,type,(
    mono_2Ef6839_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(thm_2Ebit_2EBIT__BITS__THM,axiom,(
    ! [V0h: mono_2Etyop_2Enum_2Enum,V1l: mono_2Etyop_2Enum_2Enum,V2a: mono_2Etyop_2Enum_2Enum,V3b: mono_2Etyop_2Enum_2Enum] :
      ( ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1l @ V4x )
            & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4x @ V0h ) )
         => ( ( mono_2Ec_2Ebit_2EBIT @ V4x @ V2a )
            = ( mono_2Ec_2Ebit_2EBIT @ V4x @ V3b ) ) )
    <=> ( ( mono_2Ec_2Ebit_2EBITS @ V0h @ V1l @ V2a )
        = ( mono_2Ec_2Ebit_2EBITS @ V0h @ V1l @ V3b ) ) ) )).

thf(thm_2Ebit_2ENOT__BIT__GT__TWOEXP,axiom,(
    ! [V0i: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0i ) )
     => ( (~) @ ( mono_2Ec_2Ebit_2EBIT @ V0i @ V1n ) ) ) )).
...
thf(def0_2Ethm_2Ewords_2En2w__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef6839_0 @ V0n @ V1i )
      = ( mono_2Ec_2Ebit_2EBIT @ V1i @ V0n ) ) )).
...
thf(thm_2Ewords_2En2w__def,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum] :
      ...
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ef6839_0 @ V0n ) ) ) ) ) ) )).
...
thf(thm_2Ewords_2Eword__0__n2w,axiom,(
    ! [A_27a: d] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ew2n_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) ) )
      = mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Ewords_2EWORD__NEG__NEG,axiom,(
    ! [A_27a: d,V0w_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__2comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__2comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) )).

thf(thm_2Ewords_2EWORD__NEG__EQ__0,axiom,(
    ! [A_27a: d,V0v_2E0: u] :
      ( ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__2comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0v_2E0 ) ) )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) )
    <=> ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0v_2E0 )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) ) )).

thf(thm_2Ewords_2EWORD__LESS__NEG__RIGHT,conjecture,(
    ! [A_27a: d,V0a_2E0: u,V1b_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewords_2Eword__lo_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__2comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) ) ) ) )
    <=> ( ( (~)
          @ ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 )
            = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) ) )
        & ( ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 )
            = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2En2w_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) ) ) )
          | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ewords_2Eword__lo_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__2comp_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) ) ) ) ) ) ) ) ) )).
