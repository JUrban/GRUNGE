...
fof(conj_thm_2Ereal__topology_2ESPAN__INDUCT__ALT,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ESPAN__SUPERSET,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ESPAN__MUL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1c] :
...
fof(conj_thm_2Ereal__topology_2ESPAN__SUM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f3667,axiom,(
    ! [V3u] :
     ...
     => ! [V4v] :
         ...
         => ap(f3667(V3u),V4v) = ap(ap(c_2Erealax_2Ereal__mul,ap(V3u,V4v)),V4v) ) ) )).

fof(lamtp_f3666,axiom,(
    ! [V0p] :
    ...
    ! [V0p] :
     ...
     => ! [V1y] :
         ...
         => ! [V2s] :
             ...
             => ! [V3u] :
                  ( mem(V3u,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                 => ap(f3666(V0p,V1y,V2s),V3u) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V2s)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2s),V0p)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Erealax_2Ereal),V2s),f3667(V3u))),V1y))) ) ) ) ) )).

fof(lamtp_f3665,axiom,(
    ! [V1y] :
      ( mem(V1y,ty_2Erealax_2Ereal)
     => ! [V0p] :
          ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f3664,axiom,(
    ! [V0p] :
     ...
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(f3664(V0p),V1y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1y),ap(c_2Ebool_2E_3F(arr(ty_2Erealax_2Ereal,bool)),f3665(V1y,V0p))) ) ) )).

fof(conj_thm_2Ereal__topology_2ESPAN__EXPLICIT,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
