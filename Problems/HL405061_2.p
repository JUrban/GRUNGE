...
tff(conj_thm_2Earithmetic_2ELESS__EQ__MONO__ADD__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2ETemporal__Logic_2EALWAYS__SIGNAL,lemma,(
    ! [V0a: $i] :
...
tff(lamtp_f893,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => mem(f893(V1b),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f893,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V3t: tp__ty_2Enum_2Enum] : ap(f893(V1b),inj__ty_2Enum_2Enum(V3t)) = ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V3t))) ) )).

tff(lmtp_f916,type,(
    f916: ( $i * $i ) > $i )).

tff(lamtp_f916,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f916(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f916,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t: tp__ty_2Enum_2Enum] : ap(f916(V0a,V1b),inj__ty_2Enum_2Enum(V2t)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,V0a),V1b),inj__ty_2Enum_2Enum(V2t))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f893(V1b)),inj__ty_2Enum_2Enum(V2t))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EWHEN__AS__SWHEN,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V1b) = f916(V0a,V1b) ) ) )).

tff(lmtp_f2039,type,(
    f2039: ( del * del * $i * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2039,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0: tp__ty_2Enum_2Enum,V2i: $i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V1Phi__R: $i] :
              ( mem(V1Phi__R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => mem(f2039(A_27b,A_27a,V8q,V7t0,V2i,V1Phi__R),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2039,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
     ...
     => ! [V7t0: tp__ty_2Enum_2Enum,V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
              ( mem(V1Phi__R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ! [V9t: tp__ty_2Enum_2Enum] : ap(f2039(A_27b,A_27a,V8q,V7t0,V2i,V1Phi__R),inj__ty_2Enum_2Enum(V9t)) = ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V9t)),inj__ty_2Enum_2Enum(V7t0)))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V9t)),inj__ty_2Enum_2Enum(V7t0))))) ) ) ) )).

tff(lmtp_f2041,type,(
    f2041: ( del * del * $i * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2041,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0: tp__ty_2Enum_2Enum,V10t1: tp__ty_2Enum_2Enum,V2i: $i] :
          ( mem(V2i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V3Psi: $i] :
              ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => mem(f2041(A_27b,A_27a,V8q,V7t0,V10t1,V2i,V3Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2041,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
     ...
     => ! [V7t0: tp__ty_2Enum_2Enum,V10t1: tp__ty_2Enum_2Enum,V2i: $i] :
         ...
         => ! [V3Psi: $i] :
              ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ! [V11t2: tp__ty_2Enum_2Enum] : ap(f2041(A_27b,A_27a,V8q,V7t0,V10t1,V2i,V3Psi),inj__ty_2Enum_2Enum(V11t2)) = ap(V3Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V10t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V11t2)),inj__ty_2Enum_2Enum(V7t0))))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V10t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V11t2)),inj__ty_2Enum_2Enum(V7t0)))))) ) ) ) )).

tff(lmtp_f2040,type,(
    f2040: ( del * del * $i * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2040,axiom,(
    ! [A_27b: del,A_27a: del,V3Psi: $i] :
     ...
     => ! [V2i: $i] :
         ...
         => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
              ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
             => mem(f2040(A_27b,A_27a,V3Psi,V2i,V7t0,V8q),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2040,axiom,(
    ! [A_27b: del,A_27a: del,V3Psi: $i] :
     ...
     => ! [V2i: $i] :
         ...
         => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
              ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
             => ! [V10t1: tp__ty_2Enum_2Enum] : ap(f2040(A_27b,A_27a,V3Psi,V2i,V7t0,V8q),inj__ty_2Enum_2Enum(V10t1)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2041(A_27b,A_27a,V8q,V7t0,V10t1,V2i,V3Psi)) ) ) ) )).

tff(lmtp_f2038,type,(
    f2038: ( del * del * $i * $i * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2038,axiom,(
     ...
     => ! [V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
             ...
             => ! [V0Phi__I: $i] :
                 ...
                 => ! [V7t0: tp__ty_2Enum_2Enum] : mem(f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) )).
     ...
     => ! [V2i: $i] :
         ...
         => ! [V1Phi__R: $i] :
             ...
             => ! [V0Phi__I: $i] :
                 ...
                 => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
                      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
                     => ap(f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0),V8q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0Phi__I,ap(V8q,inj__ty_2Enum_2Enum(V7t0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2039(A_27b,A_27a,V8q,V7t0,V2i,V1Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2040(A_27b,A_27a,V3Psi,V2i,V7t0,V8q)))) ) ) ) ) ) )).

tff(lmtp_f2037,type,(
    f2037: ( del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f2037,axiom,(
    ! [A_27b: del,A_27a: del,V0Phi__I: $i] :
     ...
     => ! [V1Phi__R: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3Psi: $i] :
                  ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => mem(f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V0Phi__I: $i] :
     ...
     => ! [V1Phi__R: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ! [V3Psi: $i] :
                  ( mem(V3Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => ! [V7t0: tp__ty_2Enum_2Enum] : ap(f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi),inj__ty_2Enum_2Enum(V7t0)) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2038(A_27a,A_27b,V3Psi,V2i,V1Phi__R,V0Phi__I,V7t0)) ) ) ) ) )).

tff(conj_thm_2EOmega__Automata_2ECO__BUECHI__WHEN__CLOSURE,conjecture,(
             ...
             => ! [V3Psi: $i] :
                 ...
                 => ! [V4phi: $i] :
                     ...
                     => ! [V5t0: tp__ty_2Enum_2Enum,V6c: $i] :
                          ( mem(V6c,A_27b)
                         => ( p(ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f2037(A_27b,A_27a,V0Phi__I,V1Phi__R,V2i,V3Psi)),V4phi),inj__ty_2Enum_2Enum(V5t0)))
                          <=> ? [V12p1: $i] :
                                    ...
                                    & ? [V14q: $i] :
                                        ...
                                        & ! [V15t: tp__ty_2Enum_2Enum] :
                                            ...
                                            | ( p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V5t0))))
                                              ...
                                              & p(ap(V1Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V5t0)))),ap(V14q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V5t0))))))
                                              & p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V5t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))
                                              & p(ap(V13p2,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V5t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) )
                                            | ( p(ap(V12p1,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V5t0))))
                                              & p(ap(V13p2,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V15t)),inj__ty_2Enum_2Enum(V5t0))))
