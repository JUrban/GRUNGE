...
tff(conj_thm_2Eprobability_2Emarginal__joint__zero3,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
                     ...
                     => ! [V5t: $i] :
                         ...
                         => ! [V6u: $i] :
                             ...
                             => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                  ...
                                  & ( surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V4s)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
                                    | surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V5t)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
                                    | surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27d,A_27d),V0p),V3Z),V6u)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )
                               => surj__ty_2Erealax_2Ereal(ap(ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution3(A_27b,A_27b,A_27b,A_27b),V0p),V1X),V2Y),V3Z),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V4s),ap(ap(c_2Epred__set_2ECROSS(A_27c,A_27c),V5t),V6u)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) ) ) ) ) )).
