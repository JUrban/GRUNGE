...
thf(thm_2EOmega__Automata_2EBOOLEAN__CLOSURE__G,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum > $o,V2a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( (~)
          @ ! [V3t: mono_2Etyop_2Enum_2Enum] :
              ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V3t @ V0t0 ) ) )
      ...
      <=> ! [V7t: mono_2Etyop_2Enum_2Enum] :
            ...
            & ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) )
      & ( ( ! [V8t: mono_2Etyop_2Enum_2Enum] :
              ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t @ V0t0 ) )
          | ! [V9t: mono_2Etyop_2Enum_2Enum] :
              ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) )
      <=> ? [V10p: mono_2Etyop_2Enum_2Enum > $o,V11q: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( (~) @ ( V10p @ V0t0 ) )
            & ( (~) @ ( V11q @ V0t0 ) )
            & ! [V12t: mono_2Etyop_2Enum_2Enum] :
                ( ( ( V10p @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ ( mono_2Ec_2Earithmetic_2E_2B @ V0t0 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
                <=> ( ( V10p @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ V0t0 ) )
                    | ( (~) @ ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ V0t0 ) ) ) ) )
                & ( ( V11q @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ ( mono_2Ec_2Earithmetic_2E_2B @ V0t0 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
                <=> ( ( V11q @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ V0t0 ) )
                    | ( (~) @ ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V12t @ V0t0 ) ) ) ) ) )
            & ! [V13t: mono_2Etyop_2Enum_2Enum] :
                ( ( (~) @ ( V10p @ ( mono_2Ec_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) )
                | ( (~) @ ( V11q @ ( mono_2Ec_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) ) ) ) ) ) )).
