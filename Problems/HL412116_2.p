...
tff(conj_thm_2Eprobability_2EPROB__REAL__SUM__IMAGE__SPACE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Eprobability_2EPROB__DISCRETE__EVENTS,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
          & p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))
...
tff(conj_thm_2Eprobability_2Edistribution__prob__space,lemma,(
...
tff(lamtp_f4239,axiom,(
    ! [A_27a: del,V1X: $i] :
      ( mem(V1X,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0p: $i] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f4239(A_27a,V1X,V0p),arr(ty_2Eextreal_2Eextreal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f4239,axiom,(
    ! [A_27a: del,V1X: $i] :
      ( mem(V1X,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0p: $i] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V3x: tp__ty_2Eextreal_2Eextreal] : ap(f4239(A_27a,V1X,V0p),inj__ty_2Eextreal_2Eextreal(V3x)) = ap(ap(ap(c_2Eprobability_2Edistribution(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal),V0p),V1X),ap(ap(c_2Epred__set_2EINSERT(ty_2Eextreal_2Eextreal),inj__ty_2Eextreal_2Eextreal(V3x)),c_2Epred__set_2EEMPTY(ty_2Eextreal_2Eextreal))) ) ) )).

tff(conj_thm_2Eprobability_2Edistribution__partition,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              ...
              & p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))
              & p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V1X),V0p),c_2Emeasure_2EBorel)) )
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(ty_2Eextreal_2Eextreal),f4239(A_27a,V1X,V0p)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) ) )).
