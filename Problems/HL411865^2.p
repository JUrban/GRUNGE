...
thf(conj_thm_2Ereal__topology_2EBOUNDED__SING,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESETDIST__EQ__0__SING,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
