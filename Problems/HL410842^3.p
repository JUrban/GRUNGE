...
thf(thm_2Ereal__topology_2ELIMPT__UNIV,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( c_2Ereal__topology_2Elimit__point__of @ V0x @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) ) )).
...
thf(thm_2Ereal__topology_2ETRIVIAL__LIMIT__AT,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal] :
      ( (~) @ ( c_2Ereal__topology_2Etrivial__limit @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V0a ) ) ) )).
