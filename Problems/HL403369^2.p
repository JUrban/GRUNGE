...
thf(tp_c_2Ebag_2EBAG__EVERY,type,(
    c_2Ebag_2EBAG__EVERY: del > $i )).

thf(mem_c_2Ebag_2EBAG__EVERY,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ebag_2EBAG__INN__EMPTY__BAG,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
...
thf(ax_thm_2Ebag_2EBAG__EVERY,axiom,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Ebag_2EBAG__FILTER__EQ__EMPTY,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
