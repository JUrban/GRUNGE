...
thf(thm_2EHolSmt_2Et034,conjecture,(
    ! [A_27a: $tType,V0y: tyop_2Efcp_2Ecart @ $o @ A_27a,V1x: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__add @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V1x )
        = V0y )
     => ( ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V1x @ c_2Enum_2E0 )
       => ( (~) @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V0y @ c_2Enum_2E0 ) ) ) ) )).
