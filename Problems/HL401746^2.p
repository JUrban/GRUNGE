...
thf(conj_thm_2Epred__set_2EINJ__SUBSET,lemma,(
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__INJ__o,lemma,(
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__PERMUTES,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
