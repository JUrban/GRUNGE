...
thf(mono_2Ef779_0,type,(
    mono_2Ef779_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Earithmetic_2Enum__case__compute,axiom,(
    ! [V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef779_0 @ V2n )
    <=> ( V2n = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Earithmetic_2Enum__case__compute,conjecture,(
    ! [A_27a: d,V0g_2E0: u,V1f_2E0: u,V2n: mono_2Etyop_2Enum_2Enum] :
      ...
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef779_0 @ V2n ) ) ) @ ( s @ A_27a @ V1f_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V0g_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2EPRE @ V2n ) ) ) ) ) ) ) ) )).
