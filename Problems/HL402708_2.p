...
tff(conj_thm_2Erich__list_2EDROP,lemma,(
    ! [A_27a: del] :
      ( ! [V0l: $i] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Erich__list_2EBUTLASTN__CONS,lemma,(
