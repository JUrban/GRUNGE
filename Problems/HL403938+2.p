...
fof(conj_thm_2Ellist_2ELFINITE__LNTH__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
          ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELTAKE__LLENGTH__SOME,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
          ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELNTH__LLENGTH__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
...
fof(conj_thm_2Ellist_2ELNTH__NONE__MONO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
