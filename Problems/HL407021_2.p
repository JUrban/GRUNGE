...
tff(conj_thm_2Einteger_2EINT__NEG__LE0,lemma,(
...
tff(conj_thm_2Einteger_2EINT__LE__ADD,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
      ( ( p(ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Einteger_2Eint(V0x)))
...
tff(conj_thm_2Einteger_2EINT__SUB__REFL,lemma,(
...
tff(conj_thm_2Einteger_2EINT__LE__DOUBLE,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
tff(conj_thm_2Einteger_2EINT__SUB,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Einteger_2EINT__MOD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
      ( V1m != fo__c_2Enum_2E0
...
tff(conj_thm_2Einteger_2EINT__MOD0,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
      ( V0p != surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
...
tff(conj_thm_2Einteger_2EINT__MOD__NEG__NUMERATOR,lemma,(
...
tff(conj_thm_2Einteger_2EINT__LESS__MOD,lemma,(
...
tff(conj_thm_2Einteger_2EINT__ADD__CALCULATE,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint,V1n: tp__ty_2Enum_2Enum,V2m: tp__ty_2Enum_2Enum] :
      ...
      & surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__add,ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V1n)))),ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V2m))))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V2m))))) ) )).
...
tff(conj_thm_2Ewords_2EINT__MAX__LT__DIMWORD,lemma,(
...
tff(conj_thm_2Ewords_2En2w__dimword,lemma,(
...
tff(conj_thm_2Ewords_2Eword__msb__n2w__numeric,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__NEG__0,lemma,(
...
tff(conj_thm_2Einteger__word_2Eword__msb__i2w,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] :
...
tff(conj_thm_2Einteger__word_2Ei2w__0,lemma,(
...
tff(conj_thm_2Einteger__word_2Edifferent__sign__then__no__overflow,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Einteger__word_2Ew2i__i2w__pos,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Ewords_2EINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))))
     => surj__ty_2Einteger_2Eint(ap(c_2Einteger__word_2Ew2i(A_27a),ap(c_2Einteger__word_2Ei2w(A_27a),ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V0n))))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V0n))) ) )).

tff(conj_thm_2Einteger__word_2Ew2i__i2w__neg,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0n)),ap(c_2Ewords_2EINT__MIN(A_27a),c_2Ebool_2Ethe__value(A_27a))))
     => surj__ty_2Einteger_2Eint(ap(c_2Einteger__word_2Ew2i(A_27a),ap(c_2Einteger__word_2Ei2w(A_27a),ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V0n)))))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V0n)))) ) )).

tff(conj_thm_2Einteger__word_2Eoverflow,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
