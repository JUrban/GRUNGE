...
fof(lamtp_f2747,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2747(V0x),arr(ty_2Erealax_2Ereal,bool)) ) )).
...
fof(lameq_f2747,axiom,(
    ! [V0x] :
     ...
     => ! [V1r] :
         ...
         => ap(f2747(V0x),V1r) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V1r),V0x) ) ) )).

fof(conj_thm_2Ereal_2EREAL__SUP__CONST,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Ereal_2Esup,f2747(V0x)) = V0x ) )).
