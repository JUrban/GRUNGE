...
thf(conj_thm_2Ewords_2En2w__sub__eq__0,lemma,(
    ! [A_27a: del,V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ewords_2Esaturate__sub,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ewords_2Esaturate__sub @ A_27a ) @ V0a ) @ V1b )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__ls @ A_27a ) @ V0a ) @ V1b ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ V0a ) @ V1b ) ) ) ) ) )).
