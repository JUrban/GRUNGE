...
fof(conj_thm_2EEncode_2Ewf__encoder__total,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
         => ! [V1e] :
              ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
             => ( p(ap(ap(c_2EEncode_2Ewf__encoder(A_27a),ap(c_2Ecombin_2EK(bool,bool),c_2Ebool_2ET)),V1e))
               => p(ap(ap(c_2EEncode_2Ewf__encoder(A_27a),V0p),V1e)) ) ) ) ) )).
...
fof(conj_thm_2EEncode_2Ewf__encode__num,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
