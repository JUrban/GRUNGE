...
tff(lamtp_f289,axiom,(
    ! [A_27a: del,A_27a: del,V0set: $i] :
...
tff(conj_thm_2Ecardinal_2EPOW__TWO__set__exp,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Epred__set_2EPOW(A_27a),V0A)),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),ap(c_2Epred__set_2Ecount,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V0A))) ) )).
