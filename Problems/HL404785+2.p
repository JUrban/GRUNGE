...
fof(conj_thm_2Efinite__map_2EMAP__KEYS__witness,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EMAP__KEYS__using__LINV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0f] :
                 ...
                 => ! [V1fm] :
                      ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                     => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm)),c_2Epred__set_2EUNIV(A_27b)))
                       => ap(ap(c_2Efinite__map_2EMAP__KEYS(A_27a,A_27a,A_27a),V0f),V1fm) = ap(ap(c_2Efinite__map_2Ef__o__f(A_27b,A_27b,A_27b),V1fm),ap(ap(c_2Efinite__map_2EFUN__FMAP(A_27b,A_27b),ap(ap(c_2Epred__set_2ELINV(A_27a,A_27a),V0f),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm))),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm)))) ) ) ) ) ) ) )).
