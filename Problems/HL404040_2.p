...
tff(conj_thm_2Equotient_2EW__RSP,conjecture,(
                   ...
                   => ! [V4abs2: $i] :
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6f1: $i] :
                                  ( mem(V6f1,arr(A_27a,arr(A_27a,A_27b)))
                                 => ! [V7f2: $i] :
                                      ( mem(V7f2,arr(A_27a,arr(A_27a,A_27b)))
                                     => ! [V8x1: $i] :
                                          ( mem(V8x1,A_27a)
                                         => ! [V9x2: $i] :
                                              ( mem(V9x2,A_27a)
                                             => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),V3R2)),V6f1),V7f2))
                                                  & p(ap(ap(V0R1,V8x1),V9x2)) )
                                               => p(ap(ap(V3R2,ap(ap(c_2Ecombin_2EW(A_27a,A_27a),V6f1),V8x1)),ap(ap(c_2Ecombin_2EW(A_27a,A_27a),V7f2),V9x2))) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
