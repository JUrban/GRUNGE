...
fof(conj_thm_2Ereal__topology_2ECONNECTED__EQ__CONNECTED__COMPONENTS__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ! [V1c] :
...
fof(conj_thm_2Ereal__topology_2ECOMPONENTS__EQ__SING__N__EXISTS,conjecture,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
