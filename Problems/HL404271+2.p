...
fof(conj_thm_2EDecode_2Edec2enc__decode__sum,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3d2] :
                         ...
                         => ! [V4x] :
                             ...
                             => ( ( p(ap(ap(c_2EDecode_2Ewf__decoder(A_27a),V0p1),V2d1))
                               ...
                               => ap(ap(c_2EDecode_2Edec2enc(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(ap(c_2EDecode_2Edecode__sum(A_27a,A_27a),ap(ap(c_2EEncode_2Elift__sum(A_27a,A_27a),V0p1),V1p2)),V2d1),V3d2)),V4x) = ap(ap(ap(c_2EEncode_2Eencode__sum(A_27a,A_27a),ap(c_2EDecode_2Edec2enc(A_27a),V2d1)),ap(c_2EDecode_2Edec2enc(A_27b),V3d2)),V4x) ) ) ) ) ) ) ) ) )).
