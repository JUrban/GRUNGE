...
tff(conj_thm_2Ereal__topology_2EWLOG__LE,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CHAIN__GEN,lemma,(
    ! [V0f: $i] :
...
tff(lamtp_f4063,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => mem(f4063(V0s),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

tff(lameq_f4063,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V5n: tp__ty_2Enum_2Enum] : ap(f4063(V0s),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(V0s,inj__ty_2Enum_2Enum(V5n))),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5n)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__NEST__GEN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,bool)))
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ( p(ap(c_2Ereal__topology_2EClosed,ap(V0s,inj__ty_2Enum_2Enum(V1n))))
              & p(ap(c_2Ereal__topology_2Econnected,ap(V0s,inj__ty_2Enum_2Enum(V1n)))) )
          & ? [V2n: tp__ty_2Enum_2Enum] : p(ap(c_2Ereal__topology_2Ecompact,ap(V0s,inj__ty_2Enum_2Enum(V2n))))
          & ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3m)),inj__ty_2Enum_2Enum(V4n)))
             => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0s,inj__ty_2Enum_2Enum(V4n))),ap(V0s,inj__ty_2Enum_2Enum(V3m)))) ) )
       => p(ap(c_2Ereal__topology_2Econnected,ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f4063(V0s))))) ) ) )).
