...
tff(tp_c_2Erelation_2ELinearOrder,type,(
    c_2Erelation_2ELinearOrder: del > $i )).

tff(mem_c_2Erelation_2ELinearOrder,axiom,(
    ! [A_27a: del] : mem(c_2Erelation_2ELinearOrder(A_27a),arr(arr(A_27a,arr(A_27a,bool)),bool)) )).
...
tff(conj_thm_2Erelation_2EStrongOrd__Ord,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2EStrongOrder(A_27a),V0R))
       => p(ap(c_2Erelation_2EOrder(A_27a),V0R)) ) ) )).

tff(ax_thm_2Erelation_2ELinearOrder,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
tff(conj_thm_2Etoto_2ETotOrd__TO__of__LO,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2ELinearOrder(A_27a),V0r))
       => p(ap(c_2Etoto_2ETotOrd(A_27a),ap(c_2Etoto_2ETO__of__LinearOrder(A_27a),V0r))) ) ) )).

tff(conj_thm_2Etoto_2ETotOrd__TO__of__Strong,conjecture,(
    ! [A_27a: del,V0r: $i] :
      ( mem(V0r,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2EStrongLinearOrder(A_27a),V0r))
       => p(ap(c_2Etoto_2ETotOrd(A_27a),ap(c_2Etoto_2ETO__of__LinearOrder(A_27a),V0r))) ) ) )).
