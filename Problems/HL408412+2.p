...
fof(conj_thm_2Ereal_2EREAL__LT__TOTAL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(lameq_f2999,axiom,(
    ! [V1diff] :
     ...
     => ! [V2h] :
         ...
         => ! [V7m] :
              ( mem(V7m,ty_2Enum_2Enum)
             => ap(f2999(V1diff,V2h),V7m) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V1diff,V7m),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V7m)))),ap(ap(c_2Ereal_2Epow,V2h),V7m)) ) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN,lemma,(
    ! [V0f] :
             ...
             => ! [V3n] :
                 ...
                 => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2h))
                   ...
                   => ? [V6t] :
                        ...
                        & ap(V0f,V2h) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V3n)),f2999(V1diff,V2h))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V1diff,V3n),V6t)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V3n)))),ap(ap(c_2Ereal_2Epow,V2h),V3n))) ) ) ) ) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN__NEG,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1diff] :
          ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
...
fof(lamtp_f3000,axiom,(
    ! [V1diff] :
      ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => mem(f3000(V1diff,V4x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3000,axiom,(
    ! [V1diff] :
     ...
     => ! [V4x] :
         ...
         => ! [V7m] :
              ( mem(V7m,ty_2Enum_2Enum)
             => ap(f3000(V1diff,V4x),V7m) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V1diff,V7m),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V7m)))),ap(ap(c_2Ereal_2Epow,V4x),V7m)) ) ) ) )).

fof(conj_thm_2Etransc_2EMCLAURIN__ALL__LT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1diff] :
          ( mem(V1diff,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
               ...
               => ! [V5n] :
                   ...
                   => ( ( V4x != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                     ...
                     => ? [V6t] :
                          ...
                          & ap(V0f,V4x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Enum_2E0),V5n)),f3000(V1diff,V4x))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(V1diff,V5n),V6t)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2EFACT,V5n)))),ap(ap(c_2Ereal_2Epow,V4x),V5n))) ) ) ) ) ) ) ) )).
