...
tff(lamtp_f3640,axiom,(
    mem(f3640,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3640,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f3640,inj__ty_2Erealax_2Ereal(V0x)) = ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__NEGATION,conjecture,(
    p(ap(c_2Ereal__topology_2Elinear,f3640)) )).
