...
thf(conj_thm_2Eseq_2EMAX__LE__X,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2EMAX @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) )
    <=> ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) )
        & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) ) ) )).

thf(conj_thm_2Eseq_2ESEQ__SANDWICH,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2h: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) )
                    & ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V2h ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) )
                    & ! [V4n: tp__ty_2Enum_2Enum] :
                        ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) )
                        & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) @ ( ap @ V2h @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) ) )
                 => ( p @ ( ap @ ( ap @ c_2Eseq_2E_2D_2D_3E @ V1g ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) ) ) ) ) ) )).
