...
thf(thm_2Ereal__topology_2ECONTINUOUS__RIGHT__INVERSE__IMP__QUOTIENT__MAP,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V2s )
        ...
        & ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1g @ V3t ) @ V2s )
        & ! [V4y: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V3t )
           => ( ( V0f @ ( V1g @ V4y ) )
              = V4y ) ) )
     => ! [V5u: tyop_2Erealax_2Ereal > $o] :
          ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V5u @ V3t )
         => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2s )
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V6x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V6x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V2s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V6x ) @ V5u ) ) ) ) )
            = ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3t ) @ V5u ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__LEFT__INVERSE__IMP__QUOTIENT__MAP,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Econtinuous__on @ V0f @ V2s )
        & ( c_2Ereal__topology_2Econtinuous__on @ V1g @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) )
        & ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V2s )
           => ( ( V1g @ ( V0f @ V3x ) )
              = V3x ) ) )
     => ! [V4u: tyop_2Erealax_2Ereal > $o] :
          ( ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V4u @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) )
         => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2s )
              @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
                @ ^ [V5x: tyop_2Erealax_2Ereal] :
                    ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V5x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x @ V2s ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V5x ) @ V4u ) ) ) ) )
            = ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V2s ) ) @ V4u ) ) ) ) )).
