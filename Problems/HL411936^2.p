...
thf(conj_thm_2Ecardinal_2ENUM__COUNTABLE,lemma,(
...
thf(conj_thm_2Epred__set_2ESUBSET__BIGINTER,lemma,(
    ! [A_27a: del,V0X: $i] :
...
thf(conj_thm_2Ereal__topology_2EBIGUNION__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
              ...
              @ ( lam @ A_27b
                @ ^ [V2y: $i] :
                    ...
                    @ ( ap @ ( c_2Ebool_2E_3F @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V2y ) @ ( ap @ V0f @ V3x ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSURE__EQ,lemma,(
    ! [V0s: $i] :
...
thf(ax_thm_2Ereal__topology_2Egdelta,axiom,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Egdelta @ V0s ) )
      <=> ? [V1g: $i] :
            ...
            & ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V1g )
              = V0s ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__AS__GDELTA,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
       => ( p @ ( ap @ c_2Ereal__topology_2Egdelta @ V0s ) ) ) ) )).
