...
fof(conj_thm_2Ereal__topology_2ESEGMENT__TO__CLOSEST__POINT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
           => ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eopen__segment,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1a)))),V0s) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEGMENT__TO__POINT__EXISTS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
           ...
           => ? [V2b] :
                ...
                & ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eopen__segment,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b))),V0s) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) ) )).
