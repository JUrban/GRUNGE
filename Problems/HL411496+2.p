...
fof(lamtp_f3701,axiom,(
    mem(f3701,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

fof(lameq_f3701,axiom,(
    ! [V1x] :
      ( mem(V1x,ty_2Erealax_2Ereal)
     => ap(f3701,V1x) = ap(c_2Erealax_2Ereal__neg,V1x) ) )).
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__NEGATIONS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
       => p(ap(c_2Ereal__topology_2Ecompact,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3701),V0s))) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSED__COMPACT__SUMS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSED__COMPACT__DIFFERENCES,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
