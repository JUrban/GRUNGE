...
thf(f4055_0_2E0,type,(
    f4055_0_2E0: u )).

thf(f4055_0_2E1,type,(
    f4055_0_2E1: du > u )).

thf(f4055_0_2E2,type,(
    f4055_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4055_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4055_0_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4055_0_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4055_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4055_0_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ f4055_0_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efcp_2EFCP__ETA,axiom,(
    ! [A_27a: d,A_27b: d,V0g_2E0: u,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4055_0_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0g_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) ) )
      = ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0g_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) ) ) ) )).

thf(thm_2Efcp_2EFCP__ETA,axiom,(
    ! [A_27a: d,A_27b: d,V0g_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4055_0_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0g_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0g_2E0 ) ) )).
...
thf(thm_2Efcp_2EAPPLY__FCP__UPDATE__ID,conjecture,(
    ! [A_27a: d,A_27b: d,V0m_2E0: u,V1a: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2E_3A_2B_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a ) ) @ ( s @ A_27a @ ( c_2Efcp_2Efcp__index_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0m_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0m_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0m_2E0 ) ) )).
