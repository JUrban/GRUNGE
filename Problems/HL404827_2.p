...
tff(conj_thm_2Efinite__map_2EFUPDATE__SAME__APPLY,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1kv: $i] :
          ( mem(V1kv,ty_2Epair_2Eprod(A_27a,A_27a))
         => ! [V2fm1: $i] :
              ( mem(V2fm1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ! [V3fm2: $i] :
                  ( mem(V3fm2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                 => ( ( V0x = ap(c_2Epair_2EFST(A_27a,A_27a),V1kv)
                      | ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V2fm1),V0x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V3fm2),V0x) )
                   => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2fm1),V1kv)),V0x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V3fm2),V1kv)),V0x) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFUPDATE__SAME__LIST__APPLY,conjecture,(
    ! [A_27a: del,A_27b: del,V0kvl: $i] :
      ( mem(V0kvl,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ! [V1fm1: $i] :
          ( mem(V1fm1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2fm2: $i] :
              ( mem(V2fm2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ! [V3x: $i] :
                  ( mem(V3x,A_27a)
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0kvl))))
                   => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V1fm1),V0kvl)),V3x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V2fm2),V0kvl)),V3x) ) ) ) ) ) )).
