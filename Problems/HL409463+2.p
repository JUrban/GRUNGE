...
fof(conj_thm_2Ereal_2EREAL__LE__ADDL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Efloat_2EVALOF,lemma,(
    ! [V0X] :
      ( mem(V0X,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1a] :
...
fof(conj_thm_2Efloat_2EVAL__FINITE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ( p(ap(c_2Eieee_2EFinite,V0a))
       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(c_2Eieee_2EVal,V0a))),ap(c_2Eieee_2Elargest,c_2Eieee_2Efloat__format))) ) ) )).
