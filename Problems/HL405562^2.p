...
thf(conj_thm_2Eordinal_2Epreds__wobound,lemma,(
    ! [A_27a: del,V0ord: $i] :
      ( ( mem @ V0ord @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0ord )
        = ( ap @ ( c_2Ewellorder_2EelsOf @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewobound @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ V0ord ) @ ( c_2Eordinal_2EallOrds @ A_27a ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Epreds__inj__univ,conjecture,(
    ! [A_27a: del,V0ord: $i] :
      ( ( mem @ V0ord @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
