    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V9t] :
             ...
             => ap(f1525(V0a,V1b),V9t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V9t)),ap(c_2Ebool_2E_7E,ap(V1b,V9t))) ) ) ) )).

fof(lamtp_f1526,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V10t] :
             ...
             => ap(f1526(V0a,V1b),V10t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V10t)),ap(c_2Ebool_2E_7E,ap(V1b,V10t))) ) ) ) )).

fof(lamtp_f1527,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V12t] :
             ...
             => ap(f1527(V0a,V1b),V12t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V12t)),ap(c_2Ebool_2E_7E,ap(V1b,V12t))) ) ) ) )).

fof(lamtp_f1528,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V13t] :
             ...
             => ap(f1528(V0a,V1b),V13t) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0a,V13t)),ap(c_2Ebool_2E_7E,ap(V1b,V13t))) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EMORE__EVENT,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
