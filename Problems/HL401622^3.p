...
thf(thm_2Epred__set_2ECARD__INTER__LESS__EQ,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
     => ! [V1t: A_27a > $o] :
          ( c_2Earithmetic_2E_3C_3D @ ( c_2Epred__set_2ECARD @ A_27a @ ( c_2Epred__set_2EINTER @ A_27a @ V0s @ V1t ) ) @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) ) )).
