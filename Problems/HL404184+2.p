...
fof(conj_thm_2Epath_2Efirst__label__drop,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Epath_2Erecursive__seg,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1j] :
                 ...
                 => ! [V2p] :
                     ...
                     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V0i),V1j))
                       ...
                       => ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),V0i),V1j),V2p) = ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),ap(ap(c_2Epath_2Eel(A_27a,A_27a),V0i),V2p)),ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),V0i),V2p)),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2B,V0i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1j),V2p)) ) ) ) ) ) ) )).
