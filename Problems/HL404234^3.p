...
thf(c_2Eupdate_2EFIND,type,(
    c_2Eupdate_2EFIND: 
      !>[A_27a: $tType] :
        ( ( A_27a > $o ) > ( tyop_2Elist_2Elist @ A_27a ) > ( tyop_2Eoption_2Eoption @ A_27a ) ) )).
...
thf(thm_2Ecombin_2EUPDATE__def,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0a: A_27a,V1b: A_27b] :
      ...
      = ( ^ [V2f: A_27a > A_27b,V3c: A_27a] :
            ( c_2Ebool_2ECOND @ A_27b @ ( c_2Emin_2E_3D @ A_27a @ V0a @ V3c ) @ V1b @ ( V2f @ V3c ) ) ) ) )).
...
thf(thm_2Erich__list_2ELENGTH__FILTER__LEQ,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1l: tyop_2Elist_2Elist @ A_27a] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Elist_2ELENGTH @ A_27a @ ( c_2Elist_2EFILTER @ A_27a @ V0P @ V1l ) ) @ ( c_2Elist_2ELENGTH @ A_27a @ V1l ) ) )).
...
thf(thm_2Erich__list_2EFILTER__FILTER,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1Q: A_27a > $o,V2l: tyop_2Elist_2Elist @ A_27a] :
      ...
      = ( c_2Elist_2EFILTER @ A_27a
        @ ^ [V3x: A_27a] :
            ( c_2Ebool_2E_2F_5C @ ( V0P @ V3x ) @ ( V1Q @ V3x ) )
        @ V2l ) ) )).
                ...
                @ ^ [V1t: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )] :
                    ...
                    @ ^ [V2x: tyop_2Epair_2Eprod @ A_27a @ A_27b] :
                        ...
                        @ ( c_2Elist_2EFILTER @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )
                          @ ^ [V3y: tyop_2Epair_2Eprod @ A_27a @ A_27b] :
                              ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ A_27a @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V2x ) @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V3y ) ) )
                          @ V1t )
        ...
        @ ^ [V4OVERRIDE: ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) > ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ),V5a: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )] :
            ...
            @ ^ [V6x: tyop_2Epair_2Eprod @ A_27a @ A_27b,V7t: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )] :
                ...
                @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V6x
                  @ ( V4OVERRIDE
                    @ ( c_2Elist_2EFILTER @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )
                      @ ^ [V8y: tyop_2Epair_2Eprod @ A_27a @ A_27b] :
                          ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ A_27a @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V6x ) @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V8y ) ) )
                      @ V7t ) ) ) ) ) ) ) )).
    ...
    ! [A_27a: $tType,A_27b: $tType,V0l: tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ),V1f: A_27a > A_27b,V2i: A_27a] :
      ...
      = ( c_2Eoption_2Eoption__CASE @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27b
        @ ( c_2Eupdate_2EFIND @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b )
          @ ^ [V3x: tyop_2Epair_2Eprod @ A_27a @ A_27b] :
              ( c_2Emin_2E_3D @ A_27a @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V3x ) @ V2i )
          @ V0l )
        @ ( V1f @ V2i )
