...
thf(ax_thm_2Eutil__prob_2Eprod__sets__def,axiom,(
    ! [A_27a: del,A_27b: del,V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) )
         => ( ( ap @ ( ap @ ( c_2Eutil__prob_2Eprod__sets @ A_27a @ A_27b ) @ V0a ) @ V1b )
            = ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ A_27b @ bool ) ) )
              @ ( ap @ ( c_2Epair_2EUNCURRY @ ( arr @ A_27a @ bool ) @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ bool ) )
                @ ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2s: $i] :
                      ( lam @ ( arr @ A_27b @ bool )
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ A_27b ) @ V2s ) @ V3t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2s ) @ V0a ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27b @ bool ) ) @ V3t ) @ V1b ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elebesgue_2Efinite__prod__measure__space__POW,conjecture,(
         ...
         => ! [V2u: $i] :
             ...
             => ! [V3v: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s1 ) )
                   ...
                   => ( ( ap @ ( ap @ ( c_2Elebesgue_2Eprod__measure__space @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0s1 ) ) @ V2u ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V1s2 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27b ) @ V1s2 ) ) @ V3v ) ) )
                      = ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ bool ) @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ A_27b ) @ V0s1 ) @ V1s2 ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ bool ) @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ A_27b ) @ V0s1 ) @ V1s2 ) ) ) @ ( ap @ ( ap @ ( c_2Elebesgue_2Eprod__measure @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0s1 ) ) @ V2u ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V1s2 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27b ) @ V1s2 ) ) @ V3v ) ) ) ) ) ) ) ) ) ) ) )).
