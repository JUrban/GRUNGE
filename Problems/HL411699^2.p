...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__UNIV,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__IMAGE__SUBSPACE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSED__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
          & ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
