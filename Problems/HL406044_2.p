...
tff(conj_thm_2Ewords_2ELSL__LIMIT,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2Ew2w__LSL,conjecture,(
    ! [A_27a: del,A_27b: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(c_2Ewords_2Eword__lsl(A_27a),V0w),inj__ty_2Enum_2Enum(V1n))) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Ewords_2Eword__lsl(A_27b),ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1n))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V0w))),inj__ty_2Enum_2Enum(V1n))),ap(c_2Ewords_2En2w(A_27b),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
