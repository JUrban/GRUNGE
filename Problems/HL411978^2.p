                      ...
                      @ ( ap @ c_2Eextreal_2ENormal
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ ty_2Enum_2Enum )
                            @ ( lam @ ty_2Enum_2Enum
                              @ ^ [V4i: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V3x @ V4i ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27a ) @ V0m ) @ ( ap @ V2a @ V4i ) ) ) ) )
                          @ V1s ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__thm1,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
...
thf(conj_thm_2Emeasure_2EMEASURE__SPACE__POSITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
       => ( p @ ( ap @ ( c_2Emeasure_2Epositive @ A_27a ) @ V0m ) ) ) ) )).
...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__MONO,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Elebesgue_2Epos__simple__fn__integral__mono,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
