...
fof(lamtp_f3729,axiom,(
    ! [A_27a,V1p] :
      ( mem(V1p,arr(A_27a,bool))
     => ! [V2q] :
          ( mem(V2q,arr(A_27a,bool))
         => mem(f3729(A_27a,V1p,V2q),arr(A_27a,bool)) ) ) )).

fof(lameq_f3729,axiom,(
    ! [A_27a,V1p] :
      ( mem(V1p,arr(A_27a,bool))
     => ! [V2q] :
          ( mem(V2q,arr(A_27a,bool))
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3729(A_27a,V1p,V2q),V3x) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1p,V3x)),ap(V2q,V3x)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EEVENTUALLY__MP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V1p] :
             ...
             => ! [V2q] :
                  ( mem(V2q,arr(A_27a,bool))
                 => ( ( p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3729(A_27a,V1p,V2q)),V0net))
                      & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),V1p),V0net)) )
                   => p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),V2q),V0net)) ) ) ) ) ) )).
