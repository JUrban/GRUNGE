...
tff(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__ADD,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ELINEAR__ZERO,lemma,(
    p(ap(c_2Ereal__topology_2Elinear,k(ty_2Erealax_2Ereal,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))))) )).

tff(lmtp_f3642,type,(
    f3642: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3642,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : mem(f3642(A_27a,V0f,V3x),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f3642,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V3x: tp__ty_2Erealax_2Ereal,V4a: $i] :
          ( mem(V4a,A_27a)
         => ap(f3642(A_27a,V0f,V3x),V4a) = ap(ap(V0f,V4a),inj__ty_2Erealax_2Ereal(V3x)) ) ) )).

tff(lmtp_f3641,type,(
    f3641: ( del * $i * $i ) > $i )).

tff(lamtp_f3641,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lameq_f3641,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3641(A_27a,V0f,V1s),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Eiterate_2ESum(A_27a),V1s),f3642(A_27a,V0f,V3x)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE__SUM,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
