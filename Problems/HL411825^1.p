...
thf(f12576_0_2E0,type,(
    f12576_0_2E0: u )).

thf(f12576_0_2E1,type,(
    f12576_0_2E1: du > u )).

thf(f12576_0_2E2,type,(
    f12576_0_2E2: du > du > u )).

thf(f12577_0_2E0,type,(
    f12577_0_2E0: u )).

thf(f12577_0_2E1,type,(
    f12577_0_2E1: du > u )).

thf(f12577_0_2E2,type,(
...
thf(mono_2Ef12576_0,type,(
    mono_2Ef12576_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12577_0,type,(
    mono_2Ef12577_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12577_0 @ V0s @ V2x )
...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1x: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Econtinuous_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12577_0 @ V0s ) @ ( mono_2Ec_2Ereal__topology_2Eat @ V1x ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECONTINUOUS__ON__DIST__CLOSEST__POINT,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12576_0 @ V0s @ V2x )
      = ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V2x @ ( mono_2Ec_2Ereal__topology_2Eclosest__point @ V0s @ V2x ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
        & ( (~) @ ( V0s = mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )
     => ( mono_2Ec_2Ereal__topology_2Econtinuous__on @ ( mono_2Ef12576_0 @ V0s ) @ V1t ) ) )).
