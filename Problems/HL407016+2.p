...
fof(conj_thm_2Enumeral__bit_2EiBITWISE,lemma,
    ( ! [V0opr] :
...
fof(conj_thm_2Enumeral__bit_2ENUMERAL__BITWISE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0x] :
            ( mem(V0x,ty_2Enum_2Enum)
...
fof(conj_thm_2Enumeral__bit_2Enumeral__ilog2,lemma,
...
fof(conj_thm_2Enumeral__bit_2Enumeral__log2,lemma,
    ( ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Einteger_2EINT__LE__NEGR,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
...
fof(conj_thm_2Einteger_2EINT__LE__MONO,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ! [V1y] :
          ( mem(V1y,ty_2Einteger_2Eint)
...
fof(conj_thm_2Ewords_2Edimindex__1__cases,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Ewords_2EWORD__AND__CLAUSES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Ewords_2EWORD__LITERAL__AND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0n] :
            ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__H__WORD__L,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(mem_c_2Einteger__word_2Esaturate__i2sw,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Einteger__word_2Esaturate__i2sw(A_27a),arr(ty_2Einteger_2Eint,ty_2Efcp_2Ecart(bool,bool))) ) )).

fof(mem_c_2Einteger__word_2Esigned__saturate__add,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Einteger__word_2Esigned__saturate__add(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).

fof(mem_c_2Einteger__word_2Esigned__saturate__sub,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Einteger__word_2Esigned__saturate__sub(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(ax_thm_2Einteger__word_2Esaturate__i2sw__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0i] :
          ( mem(V0i,ty_2Einteger_2Eint)
         => ap(c_2Einteger__word_2Esaturate__i2sw(A_27a),V0i) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger__word_2EINT__MAX(A_27a),c_2Ebool_2Ethe__value(A_27a))),V0i)),c_2Ewords_2Eword__H(A_27a)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Einteger_2Eint__le,V0i),ap(c_2Einteger__word_2EINT__MIN(A_27a),c_2Ebool_2Ethe__value(A_27a)))),c_2Ewords_2Eword__L(A_27a)),ap(c_2Einteger__word_2Ei2w(A_27a),V0i))) ) ) )).
...
fof(conj_thm_2Einteger__word_2EWORD__LEi,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
fof(conj_thm_2Einteger__word_2Ew2i__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ei2w__minus__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Ei2w__INT__MIN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Esaturate__i2sw__0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Einteger__word_2Esigned__saturate__sub,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
