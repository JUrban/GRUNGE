...
thf(conj_thm_2Eiterate_2ENSUM__DEGENERATE,conjecture,(
    ! [A_27a: del,V0f: $i] :
         ...
         => ( ~ ( p
                @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a )
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                    @ ( lam @ A_27a
                      @ ^ [V2x: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ V1s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( ap @ V0f @ V2x ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) ) )
