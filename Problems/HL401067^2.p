...
thf(conj_thm_2Enumeral_2Ebit__initiality,conjecture,(
    ! [A_27a: del,V0zf: $i] :
      ( ( mem @ V0zf @ A_27a )
     => ! [V1b1f: $i] :
         ...
         => ! [V2b2f: $i] :
             ...
             => ? [V3f: $i] :
                  ...
                  & ( ( ap @ V3f @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) )
                    = V0zf )
                  & ! [V4n: tp__ty_2Enum_2Enum] :
                      ( ( ap @ V3f @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V4n ) ) )
                      = ( ap @ ( ap @ V1b1f @ ( inj__ty_2Enum_2Enum @ V4n ) ) @ ( ap @ V3f @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) )
                  & ! [V5n: tp__ty_2Enum_2Enum] :
                      ( ( ap @ V3f @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V5n ) ) )
                      = ( ap @ ( ap @ V2b2f @ ( inj__ty_2Enum_2Enum @ V5n ) ) @ ( ap @ V3f @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) ) ) ) ) )).
