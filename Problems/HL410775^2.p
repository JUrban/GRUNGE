...
thf(conj_thm_2Ereal__topology_2ECLOSURE__BIGUNION,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0f ) )
       => ( ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V0f ) )
          = ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
              @ ( lam @ ( arr @ ty_2Erealax_2Ereal @ bool )
                @ ^ [V1s: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1s ) @ V0f ) ) ) ) ) ) ) ) )).
