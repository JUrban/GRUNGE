...
thf(thm_2Ereal__topology_2EUNIFORMLY__CONVERGENT__EQ__CAUCHY,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1s: tyop_2Enum_2Enum > A_27a > tyop_2Erealax_2Ereal] :
      ( ? [V2l: A_27a > tyop_2Erealax_2Ereal] :
        ! [V3e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V3e )
         => ? [V4N: tyop_2Enum_2Enum] :
            ! [V5n: tyop_2Enum_2Enum,V6x: A_27a] :
              ( ( ( c_2Earithmetic_2E_3C_3D @ V4N @ V5n )
                & ( V0P @ V6x ) )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V1s @ V5n @ V6x ) @ ( V2l @ V6x ) ) ) @ V3e ) ) )
    <=> ! [V7e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V7e )
         => ? [V8N: tyop_2Enum_2Enum] :
            ! [V9m: tyop_2Enum_2Enum,V10n: tyop_2Enum_2Enum,V11x: A_27a] :
              ( ( ( c_2Earithmetic_2E_3C_3D @ V8N @ V9m )
                & ( c_2Earithmetic_2E_3C_3D @ V8N @ V10n )
                & ( V0P @ V11x ) )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V1s @ V9m @ V11x ) @ ( V1s @ V10n @ V11x ) ) ) @ V7e ) ) ) ) )).

thf(thm_2Ereal__topology_2ESEQUENCE__CAUCHY__WLOG,axiom,(
    ! [V0e: tyop_2Erealax_2Ereal,V1P: tyop_2Enum_2Enum > $o,V2s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
          ( ( ( V1P @ V3m )
            & ( V1P @ V4n ) )
         => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V2s @ V3m ) @ ( V2s @ V4n ) ) ) @ V0e ) )
    <=> ! [V5m: tyop_2Enum_2Enum,V6n: tyop_2Enum_2Enum] :
          ( ( ( V1P @ V5m )
            & ( V1P @ V6n )
            & ( c_2Earithmetic_2E_3C_3D @ V5m @ V6n ) )
         => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V2s @ V5m ) @ ( V2s @ V6n ) ) ) @ V0e ) ) ) )).

thf(thm_2Ereal__topology_2ESUM__DIFF__LEMMA,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1k: tyop_2Enum_2Enum > $o,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V2m @ V3n )
     => ( ( c_2Ereal_2Ereal__sub @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1k @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V3n ) ) @ V0f ) @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1k @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V2m ) ) @ V0f ) )
        = ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1k @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V2m @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3n ) ) @ V0f ) ) ) )).

thf(thm_2Ereal__topology_2EABS__SUM__TRIVIAL__LEMMA,axiom,(
    ! [V0s: tyop_2Enum_2Enum > $o,V1n: tyop_2Enum_2Enum,V2m: tyop_2Enum_2Enum,V3f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V4P: $o,V5e: tyop_2Erealax_2Ereal] :
      ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V5e )
     => ( ( V4P
         => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V0s @ ( c_2Eiterate_2E_2E_2E @ V2m @ V1n ) ) @ V3f ) ) @ V5e ) )
      <=> ( V4P
         => ( ( c_2Eprim__rec_2E_3C @ V1n @ V2m )
            | ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V0s @ ( c_2Eiterate_2E_2E_2E @ V2m @ V1n ) ) @ V3f ) ) @ V5e ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ESERIES__CAUCHY__UNIFORM,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1f: A_27a > tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2k: tyop_2Enum_2Enum > $o] :
      ( ? [V3l: A_27a > tyop_2Erealax_2Ereal] :
        ! [V4e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V4e )
         => ? [V5N: tyop_2Enum_2Enum] :
            ! [V6n: tyop_2Enum_2Enum,V7x: A_27a] :
              ( ( ( c_2Earithmetic_2E_3C_3D @ V5N @ V6n )
                & ( V0P @ V7x ) )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V2k @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V6n ) ) @ ( V1f @ V7x ) ) @ ( V3l @ V7x ) ) ) @ V4e ) ) )
    <=> ! [V8e: tyop_2Erealax_2Ereal] :
          ( ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V8e )
         => ? [V9N: tyop_2Enum_2Enum] :
            ! [V10m: tyop_2Enum_2Enum,V11n: tyop_2Enum_2Enum,V12x: A_27a] :
              ( ( ( c_2Earithmetic_2E_3C_3D @ V9N @ V10m )
                & ( V0P @ V12x ) )
             => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V2k @ ( c_2Eiterate_2E_2E_2E @ V10m @ V11n ) ) @ ( V1f @ V12x ) ) ) @ V8e ) ) ) ) )).
