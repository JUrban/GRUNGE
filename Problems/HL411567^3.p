...
thf(thm_2Ereal__topology_2ECLOSED__DIFF__OPEN__INTERVAL,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Ebool_2ECOND @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Emin_2E_3D @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2ECLOSED__interval @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V0a @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1b @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) ) )).
