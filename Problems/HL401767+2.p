...
fof(conj_thm_2Earithmetic_2EMAX__COMM,lemma,(
    ! [V0m] :
...
fof(conj_thm_2Earithmetic_2EMAX__ASSOC,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Epred__set_2EMAX__SET__UNION,conjecture,(
    ! [V0A] :
     ...
     => ! [V1B] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0A))
           ...
           => ap(c_2Epred__set_2EMAX__SET,ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),V0A),V1B)) = ap(ap(c_2Earithmetic_2EMAX,ap(c_2Epred__set_2EMAX__SET,V0A)),ap(c_2Epred__set_2EMAX__SET,V1B)) ) ) ) )).
