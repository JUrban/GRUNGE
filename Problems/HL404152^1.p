...
thf(arityeq2_2Emono_2Ec_2Epath_2Eel_2E2_2Emono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27c: d,A_27d: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ A_27c @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X1_2E0 ) ) )
      = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ A_27c ) ) @ c_2Epath_2Eel_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Epath_2Eel__pmap,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0g_2E0: u,V1f_2E0: u,V2i: mono_2Etyop_2Enum_2Enum,V3p_2E0: u] :
      ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V2i @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( c_2Epath_2EPL_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) )
     => ( ( s @ A_27c @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27c @ A_27d ) @ ( c_2Epath_2Epmap_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V0g_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) )
        = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1f_2E0 ) @ ( s @ A_27a @ ( c_2Epath_2Eel_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V3p_2E0 ) ) ) ) ) ) ) )).
