...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__SEQUENTIALLY,lemma,(
    ! [V0f] :
     ...
     => ! [V1a] :
         ...
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V1a)))
          <=> ! [V2x] :
               ...
               => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V2x),V1a),c_2Ereal__topology_2Esequentially))
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),V2x)),ap(V0f,V1a)),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECAUCHY__ISOMETRIC,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
                 ...
                 => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2e))
                      ...
                      & ! [V4x] :
                         ...
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V1s))
                           => p(ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,ap(V0f,V4x))),ap(ap(c_2Erealax_2Ereal__mul,V2e),ap(c_2Ereal_2Eabs,V4x)))) ) )
                      & ! [V5n] :
                          ( mem(V5n,ty_2Enum_2Enum)
                         => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V3x,V5n)),V1s)) )
...
fof(conj_thm_2Ereal__topology_2ECOMPLETE__ISOMETRIC__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
