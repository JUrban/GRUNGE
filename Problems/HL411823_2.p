...
tff(conj_thm_2Ereal__topology_2EDIST__CLOSEST__POINT__LIPSCHITZ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
            & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V1x))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2y)),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V2y))))))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y))))) ) ) )).
