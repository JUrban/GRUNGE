...
thf(thm_2Ebag_2ENOT__mlt__EMPTY,conjecture,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1R: A_27a > A_27a > $o] :
      ( (~) @ ( c_2Erelation_2ETC @ ( A_27a > tyop_2Enum_2Enum ) @ ( c_2Ebag_2Emlt1 @ A_27a @ V1R ) @ V0b @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) )).
