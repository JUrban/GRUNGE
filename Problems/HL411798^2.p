...
thf(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__BOUNDED,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
         ...
         => ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ V0s ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESUMMABLE__IMP__TOZERO,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__IMP__BOUNDED,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V1k ) @ V0f ) )
           => ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ V0f ) @ V1k ) ) ) ) ) ) )).
