...
tff(thm_2Ebool_2EONTO__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EONTO_2E1(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0)))))
    <=> ! [V1y_2E0: u] :
        ? [V2x_2E0: u] : s(A_27b,V1y_2E0) = s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V0f_2E0),s(A_27a,V2x_2E0))) ) )).
