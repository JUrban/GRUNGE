...
thf(conj_thm_2Ereal__topology_2ETOPSPACE__SUBTOPOLOGY,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1u: $i] :
          ( ( mem @ V1u @ ( arr @ A_27a @ bool ) )
         => ( ( ap @ ( c_2Etopology_2Etopspace @ A_27a ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ A_27a ) @ V0top ) @ V1u ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ ( ap @ ( c_2Etopology_2Etopspace @ A_27a ) @ V0top ) ) @ V1u ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__IN__IMP__SUBSET,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
