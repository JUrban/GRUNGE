...
fof(ax_thm_2Epred__set_2Ecount__def,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Epred__set_2Ecount,V0n) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f275(V0n)) ) )).

fof(conj_thm_2Epred__set_2EIN__COUNT,conjecture,(
    ! [V0m] :
