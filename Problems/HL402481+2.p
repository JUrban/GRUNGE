...
fof(lamtp_f596,axiom,(
    ! [A_27a,A_27a,V0y] :
      ( mem(V0y,A_27a)
     => mem(f596(A_27a,A_27a,V0y),arr(A_27a,bool)) ) )).
...
fof(lameq_f596,axiom,(
    ! [A_27a,A_27a,V0y] :
     ...
     => ! [V4x] :
          ( mem(V4x,A_27a)
         => ap(f596(A_27a,A_27a,V0y),V4x) = ap(ap(c_2Emin_2E_3D(A_27a),V4x),V0y) ) ) )).

fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__TWO__CASES,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( ! [V2x] :
                       ...
                       => ( V2x = V0y
                          | ? [V3fv] :
                              ( mem(V3fv,A_27b)
                              & V2x = ap(V1Q,V3fv) ) ) )
                   => p(ap(ap(c_2EquantHeuristics_2EGUESS__FORALL__GAP(A_27b,A_27b),V1Q),f596(A_27a,A_27a,V0y))) ) ) ) ) ) )).
