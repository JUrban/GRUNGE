...
fof(conj_thm_2EordNotationSemantics_2EordModel__lt__epsilon0,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2EordinalNotation_2Eosyntax)
         => p(ap(ap(c_2Eordinal_2Eordlt(A_27a),ap(c_2EordNotationSemantics_2EordModel(A_27a),V0a)),c_2Eordinal_2Eepsilon0(A_27a))) ) ) )).

fof(conj_thm_2EordNotationSemantics_2Enotation__exists,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2EordNotationSemantics_2Emodel__expt,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2EordinalNotation_2Eosyntax)
