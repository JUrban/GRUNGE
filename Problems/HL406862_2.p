...
tff(conj_thm_2Ehreal_2EHRAT__LT__NE,lemma,(
...
tff(conj_thm_2Ehreal_2EHRAT__LT__ADD2,lemma,(
...
tff(conj_thm_2Ehreal_2EHRAT__LT__LMUL1,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
      ( p(ap(ap(c_2Ehreal_2Ehrat__lt,ap(ap(c_2Ehrat_2Ehrat__mul,inj__ty_2Ehrat_2Ehrat(V0x)),inj__ty_2Ehrat_2Ehrat(V1y))),inj__ty_2Ehrat_2Ehrat(V1y)))
    <=> p(ap(ap(c_2Ehreal_2Ehrat__lt,inj__ty_2Ehrat_2Ehrat(V0x)),inj__ty_2Ehrat_2Ehrat(fo__c_2Ehrat_2Ehrat__1))) ) )).

tff(conj_thm_2Ehreal_2EHRAT__LT__R1,lemma,(
    ! [V0x: tp__ty_2Ehrat_2Ehrat,V1y: tp__ty_2Ehrat_2Ehrat] :
      ( p(ap(ap(c_2Ehreal_2Ehrat__lt,ap(ap(c_2Ehrat_2Ehrat__mul,inj__ty_2Ehrat_2Ehrat(V0x)),ap(c_2Ehrat_2Ehrat__inv,inj__ty_2Ehrat_2Ehrat(V1y)))),inj__ty_2Ehrat_2Ehrat(fo__c_2Ehrat_2Ehrat__1)))
    <=> p(ap(ap(c_2Ehreal_2Ehrat__lt,inj__ty_2Ehrat_2Ehrat(V0x)),inj__ty_2Ehrat_2Ehrat(V1y))) ) )).
...
tff(conj_thm_2Ehreal_2EHREAL__ADD__ISACUT,conjecture,(
