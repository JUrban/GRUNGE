...
fof(lamtp_f149,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => mem(f149(V0m),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f149,axiom,(
    ! [V0m] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f149(V0m),V1n) = ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V0m),ap(c_2Enum_2ESUC,V1n)) ) ) )).
...
fof(conj_thm_2Eprim__rec_2EPRE,conjecture,
