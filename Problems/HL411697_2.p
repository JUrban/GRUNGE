...
tff(conj_thm_2Ereal__topology_2ESUM__ABS__TRIANGLE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2b: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                & p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Eiterate_2ESum(A_27a),V0s),f3631(A_27a,V1f))),inj__ty_2Erealax_2Ereal(V2b))) )
...
tff(conj_thm_2Ereal__topology_2EOPEN__SURJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
