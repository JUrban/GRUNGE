...
tff(conj_thm_2Ereal_2EABS__SIGN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))),inj__ty_2Erealax_2Ereal(V1y)))
...
tff(conj_thm_2Etransc_2EDIVISION__THM,lemma,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
        ...
        <=> ( surj__ty_2Erealax_2Ereal(ap(V0D,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = V1a
            ...
            & ! [V4n: tp__ty_2Enum_2Enum] :
               ...
               => surj__ty_2Erealax_2Ereal(ap(V0D,inj__ty_2Enum_2Enum(V4n))) = V2b ) ) ) ) )).
...
tff(conj_thm_2Etransc_2EDIVISION__EXISTS,lemma,(
...
tff(lameq_f2997,axiom,(
    ! [V1g1: $i] :
     ...
     => ! [V2g2: $i] :
          ( mem(V2g2,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2997(V1g1,V2g2),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__lt,ap(V1g1,inj__ty_2Erealax_2Ereal(V3x))),ap(V2g2,inj__ty_2Erealax_2Ereal(V3x)))),ap(V1g1,inj__ty_2Erealax_2Ereal(V3x))),ap(V2g2,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(conj_thm_2Etransc_2EGAUGE__MIN,lemma,(
    ! [V0E: $i] :
     ...
     => ! [V1g1: $i] :
         ...
         => ! [V2g2: $i] :
             ...
             => ( ( p(ap(ap(c_2Etransc_2Egauge,V0E),V1g1))
               ...
               => p(ap(ap(c_2Etransc_2Egauge,V0E),f2997(V1g1,V2g2))) ) ) ) ) )).

tff(lmtp_f2998,type,(
    f2998: ( $i * $i ) > $i )).

tff(lamtp_f2998,axiom,(
    ! [V0g1: $i] :
...
tff(lameq_f2998,axiom,(
    ! [V0g1: $i] :
     ...
     => ! [V1g2: $i] :
          ( mem(V1g2,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f2998(V0g1,V1g2),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__lt,ap(V0g1,inj__ty_2Erealax_2Ereal(V4x))),ap(V1g2,inj__ty_2Erealax_2Ereal(V4x)))),ap(V0g1,inj__ty_2Erealax_2Ereal(V4x))),ap(V1g2,inj__ty_2Erealax_2Ereal(V4x))) ) ) )).

tff(conj_thm_2Etransc_2EFINE__MIN,lemma,(
    ! [V0g1: $i] :
      ( mem(V0g1,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g2: $i] :
          ( mem(V1g2,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(tp_c_2Eintegral_2Eintegral,type,(
    c_2Eintegral_2Eintegral: $i )).

tff(mem_c_2Eintegral_2Eintegral,axiom,(
...
tff(conj_thm_2Eintegral_2EINTEGRABLE__DINT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f))
         => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f),ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b))),V0f))) ) ) )).

tff(conj_thm_2Eintegral_2ETDIV__BOUNDS,lemma,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1p: $i] :
          ( mem(V1p,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Etransc_2Etdiv,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V0d),V1p)))
             => ! [V4n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),ap(V0d,inj__ty_2Enum_2Enum(V4n))))
                  & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,inj__ty_2Enum_2Enum(V4n))),inj__ty_2Erealax_2Ereal(V3b)))
                  & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),ap(V1p,inj__ty_2Enum_2Enum(V4n))))
                  & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V1p,inj__ty_2Enum_2Enum(V4n))),inj__ty_2Erealax_2Ereal(V3b))) ) ) ) ) )).

tff(conj_thm_2Eintegral_2EREAL__LE__RMUL1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V2z))) )
...
tff(conj_thm_2Eintegral_2EINTEGRAL__LE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4i: $i] :
              ( mem(V4i,A_27a)
             => ! [V5j: $i] :
                  ( mem(V5j,A_27b)
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b)))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V0f))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V1g))
                      & ! [V6x: tp__ty_2Erealax_2Ereal] :
                          ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V6x)))
                            & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V6x)),inj__ty_2Erealax_2Ereal(V3b))) )
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,inj__ty_2Erealax_2Ereal(V6x))),ap(V1g,inj__ty_2Erealax_2Ereal(V6x)))) ) )
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V0f)),ap(ap(c_2Eintegral_2Eintegral,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V1g))) ) ) ) ) ) )).
