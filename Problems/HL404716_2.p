...
tff(conj_thm_2Efinite__map_2EFAPPLY__f__o,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,A_27b))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f1914(A_27b,A_27c,A_27a,V0f,V1g))))
           => ! [V3x: $i] :
                ( mem(V3x,A_27a)
               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(ap(c_2Efinite__map_2Ef__o(A_27a,A_27a,A_27a),V0f),V1g))))
                 => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),ap(ap(c_2Efinite__map_2Ef__o(A_27a,A_27a,A_27a),V0f),V1g)),V3x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27b,A_27b),V0f),ap(V1g,V3x)) ) ) ) ) ) )).

tff(lmtp_f1919,type,(
    f1919: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f1919,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V3f: $i] :
      ( mem(V3f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V0g: $i] :
          ( mem(V0g,arr(A_27a,A_27b))
         => mem(f1919(A_27b,A_27c,A_27a,V3f,V0g),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).

tff(lameq_f1919,axiom,(
    ! [A_27b: del,A_27c: del,A_27a: del,V3f: $i] :
      ( mem(V3f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
     => ! [V0g: $i] :
          ( mem(V0g,arr(A_27a,A_27b))
         => ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ap(f1919(A_27b,A_27c,A_27a,V3f,V0g),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(ap(c_2Ebool_2EIN(A_27b),ap(V0g,V4x)),ap(c_2Efinite__map_2EFDOM(A_27b,A_27b),V3f))) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFINITE__PRED__11,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0g: $i] :
     ...
     => ( ! [V1x: $i] :
       ...
       => ! [V3f: $i] :
            ( mem(V3f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
           => p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f1919(A_27b,A_27c,A_27a,V3f,V0g)))) ) ) ) )).

tff(conj_thm_2Efinite__map_2Ef__o__ASSOC,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,V0g: $i] :
      ( mem(V0g,arr(A_27a,A_27b))
     => ! [V1h: $i] :
          ( mem(V1h,arr(A_27c,A_27a))
         => ! [V2f: $i] :
              ( mem(V2f,ty_2Efinite__map_2Efmap(A_27b,A_27b))
             => ( ( ! [V3x: $i] :
                      ( mem(V3x,A_27a)
                     => ! [V4y: $i] :
                          ( mem(V4y,A_27a)
                  ...
                  & ! [V5x: $i] :
                     ...
                     => ! [V6y: $i] :
                         ...
                         => ( ap(V1h,V5x) = ap(V1h,V6y)
                          <=> V5x = V6y ) ) ) )
               => ap(ap(c_2Efinite__map_2Ef__o(A_27c,A_27c,A_27c),ap(ap(c_2Efinite__map_2Ef__o(A_27a,A_27a,A_27a),V2f),V0g)),V1h) = ap(ap(c_2Efinite__map_2Ef__o(A_27c,A_27c,A_27c),V2f),ap(ap(c_2Ecombin_2Eo(A_27c,A_27c,A_27c),V0g),V1h)) ) ) ) ) )).
