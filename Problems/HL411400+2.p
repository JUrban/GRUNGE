...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__REFL,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EMPTY,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
          <=> ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s)) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIQUE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V1c))
                  ...
                  & ! [V3c_27] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V3c_27))
               ...
               => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V2x) = V1c ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__INTERMEDIATE__SUBSET,conjecture,(
    ! [V0t] :
     ...
     => ! [V1u] :
         ...
         => ! [V2a] :
             ...
             => ( ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Econnected__component,V1u),V2a)),V0t))
                  & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V0t),V1u)) )
               => ap(ap(c_2Ereal__topology_2Econnected__component,V0t),V2a) = ap(ap(c_2Ereal__topology_2Econnected__component,V1u),V2a) ) ) ) ) )).
