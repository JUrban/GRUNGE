...
fof(conj_thm_2Erealax_2ETREAL__EQ__AP,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
     => ! [V1q] :
          ( mem(V1q,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
...
fof(conj_thm_2Erealax_2ETREAL__LDISTRIB,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Erealax_2ETREAL__ADD__WELLDEF,lemma,(
    ! [V0x1] :
...
fof(conj_thm_2Erealax_2ETREAL__MUL__WELLDEF,lemma,(
    ! [V0x1] :
      ( mem(V0x1,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
     => ! [V1x2] :
          ( mem(V1x2,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
...
fof(conj_thm_2Erealax_2EREAL__LDISTRIB,conjecture,(
    ! [V0x] :
