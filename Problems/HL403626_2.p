...
tff(mem_c_2Efcp_2EFCP__EVERY,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efcp_2EFCP__EVERY(A_27a,A_27a),arr(arr(A_27b,bool),arr(ty_2Efcp_2Ecart(A_27b,A_27b),bool))) )).
...
tff(ax_thm_2Efcp_2EFCP__EVERY__def,axiom,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1v: $i] :
         ...
         => ( p(ap(ap(c_2Efcp_2EFCP__EVERY(A_27a,A_27a),V0P),V1v))
          <=> ! [V2i: tp__ty_2Enum_2Enum] :
                ...
                | p(ap(V0P,ap(ap(c_2Efcp_2Efcp__index(A_27b,A_27b),V1v),inj__ty_2Enum_2Enum(V2i)))) ) ) ) ) )).
...
tff(conj_thm_2Efcp_2EFCP__EVERY,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1v: $i] :
          ( mem(V1v,ty_2Efcp_2Ecart(A_27a,A_27a))
         => ( p(ap(ap(c_2Efcp_2EFCP__EVERY(A_27b,A_27b),V0P),V1v))
          <=> p(ap(ap(c_2Elist_2EEVERY(A_27a),V0P),ap(c_2Efcp_2EV2L(A_27a,A_27a),V1v))) ) ) ) )).
