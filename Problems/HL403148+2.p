    ...
    ! [V1P] :
     ...
     => ! [V0Q] :
         ...
         => ! [V2t] :
             ...
             => ap(f955(V1P,V0Q),V2t) = ap(ap(c_2Emin_2E_3D(bool),ap(V1P,V2t)),ap(V0Q,V2t)) ) ) ) )).

fof(lamtp_f956,axiom,(
    ! [V1P] :
      ( mem(V1P,arr(ty_2Enum_2Enum,bool))
     => ! [V0Q] :
          ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1P] :
     ...
     => ! [V0Q] :
         ...
         => ! [V3t] :
             ...
             => ap(f956(V1P,V0Q),V3t) = ap(ap(c_2Emin_2E_3D(bool),ap(ap(c_2ETemporal__Logic_2ENEXT,V1P),V3t)),ap(ap(c_2ETemporal__Logic_2ENEXT,V0Q),V3t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EEQUIV__NEXT,conjecture,(
    ! [V0Q] :
      ( mem(V0Q,arr(ty_2Enum_2Enum,bool))
     => ! [V1P] :
          ( mem(V1P,arr(ty_2Enum_2Enum,bool))
