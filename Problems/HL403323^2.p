...
thf(conj_thm_2Ebag_2EBAG__cases,lemma,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ( ( V0b
        ...
        | ? [V1b0: $i] :
            ...
            & ? [V2e: $i] :
                ( ( mem @ V2e @ A_27a )
                & ( V0b
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V2e ) @ V1b0 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBCARD__SUC,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( p @ ( ap @ ( c_2Ebag_2EFINITE__BAG @ A_27a ) @ V0b ) )
       => ! [V1n: tp__ty_2Enum_2Enum] :
          ...
          <=> ? [V2b0: $i] :
                ...
                & ? [V3e: $i] :
                    ( ( mem @ V3e @ A_27a )
                    & ( V0b
                      = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V3e ) @ V2b0 ) )
                    & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Ebag_2EBAG__CARD @ A_27a ) @ V2b0 ) )
                      = V1n ) ) ) ) ) ) )).
