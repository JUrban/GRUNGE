...
thf(conj_thm_2EerrorStateMonad_2EBIND__ASSOC,lemma,(
     ...
     => ! [V1m: $i] :
         ...
         => ! [V2n: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27a @ A_27b @ A_27d ) @ V0k )
                  @ ( lam @ A_27b
                    @ ^ [V3a: $i] :
                        ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27a @ A_27c @ A_27d ) @ ( ap @ V1m @ V3a ) ) @ V2n ) ) )
...
thf(conj_thm_2EerrorStateMonad_2EJOIN__MMAP__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del] :
