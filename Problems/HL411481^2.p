...
thf(conj_thm_2Ereal__topology_2EDIAMETER__BOUNDED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EDIAMETER__POS__LE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
...
thf(conj_thm_2Ereal__topology_2EDIAMETER__CLOSURE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
