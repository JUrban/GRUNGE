...
fof(conj_thm_2Epoly_2EPOLY__EXP__ADD,lemma,(
    ! [V0d] :
...
fof(conj_thm_2Epoly_2EPOLY__ENTIRE,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1q] :
...
fof(conj_thm_2Epoly_2EPOLY__PRIMES,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1p] :
          ( mem(V1p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
...
fof(conj_thm_2Epoly_2EORDER,lemma,(
    ! [V0p] :
      ( mem(V0p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
     => ! [V1a] :
...
fof(conj_thm_2Epoly_2EORDER__MUL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1p] :
          ( mem(V1p,ty_2Elist_2Elist(ty_2Erealax_2Ereal))
