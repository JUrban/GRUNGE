...
tff(tp_c_2Etopology_2Ehull,type,(
    c_2Etopology_2Ehull: del > $i )).

tff(mem_c_2Etopology_2Ehull,axiom,(
    ! [A_27a: del] : mem(c_2Etopology_2Ehull(A_27a),arr(arr(arr(A_27a,bool),bool),arr(arr(A_27a,bool),arr(A_27a,bool)))) )).

tff(conj_thm_2Etopology_2EP__HULL,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Etopology_2EHULL__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Etopology_2ESUBSET__HULL,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Etopology_2EHULL__UNIQUE,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(arr(A_27a,bool),bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lamtp_f2020,axiom,(
    ! [A_27a: del,V1P: $i] :
      ( mem(V1P,arr(arr(A_27a,bool),bool))
     => ! [V2Q: $i] :
          ( mem(V2Q,arr(arr(A_27a,bool),bool))
         => mem(f2020(A_27a,V1P,V2Q),arr(arr(A_27a,bool),bool)) ) ) )).
    ...
    ! [A_27a: del,V1P: $i] :
     ...
     => ! [V2Q: $i] :
         ...
         => ! [V8x: $i] :
             ...
             => ap(f2020(A_27a,V1P,V2Q),V8x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V8x)),ap(V2Q,V8x)) ) ) ) )).

tff(conj_thm_2Etopology_2EHULL__P__AND__Q,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1P: $i] :
          ( mem(V1P,arr(arr(A_27a,bool),bool))
         => ! [V2Q: $i] :
             ...
             => ( ( ! [V3f: $i] :
               ...
               => ap(ap(c_2Etopology_2Ehull(A_27a),f2020(A_27a,V1P,V2Q)),V0s) = ap(ap(c_2Etopology_2Ehull(A_27a),V1P),ap(ap(c_2Etopology_2Ehull(A_27a),V2Q),V0s)) ) ) ) ) )).
