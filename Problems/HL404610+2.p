...
fof(conj_thm_2EASCIInumbers_2EBIT__num__from__bin__string,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1s] :
          ( mem(V1s,ty_2Elist_2Elist(ty_2Estring_2Echar))
         => ( ( p(ap(ap(c_2Elist_2EEVERY(ty_2Estring_2Echar),ap(ap(c_2Ecombin_2Eo(ty_2Estring_2Echar,ty_2Estring_2Echar,ty_2Estring_2Echar),ap(c_2Earithmetic_2E_3E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),c_2EASCIInumbers_2EUNHEX)),V1s))
           ...
           => ( p(ap(ap(c_2Ebit_2EBIT,V0x),ap(c_2EASCIInumbers_2Enum__from__bin__string,V1s)))
            <=> ap(c_2EASCIInumbers_2EUNHEX,ap(c_2Estring_2ESUB,ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Elist_2Elist(ty_2Estring_2Echar)),V1s),ap(c_2Eprim__rec_2EPRE,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(ty_2Estring_2Echar),V1s)),V0x))))) = ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)) ) ) ) ) )).
