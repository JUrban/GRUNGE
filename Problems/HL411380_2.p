...
tff(conj_thm_2Ereal__topology_2ECONNECTED__BIGUNION,lemma,(
    ! [V0P: $i] :
...
tff(lmtp_f3931,type,(
    f3931: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3931,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f3931(V1x,V0s),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

tff(lameq_f3931,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal,V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3931(V1x,V0s),V2t) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2t),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ereal__topology_2Econnected,V2t)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V2t)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2t),V0s)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__BIGUNION,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3931(V1x,V0s))) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
