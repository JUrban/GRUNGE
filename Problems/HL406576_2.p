...
tff(conj_thm_2Esptree_2EMEM__toAList,lemma,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Esptree_2Espt(A_27a))
     => ! [V1k: tp__ty_2Enum_2Enum,V2v: $i] :
          ( mem(V2v,A_27a)
         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1k)),V2v)),ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esptree_2EtoAList(A_27a),V0t))))
          <=> ap(ap(c_2Esptree_2Elookup(A_27a),inj__ty_2Enum_2Enum(V1k)),V0t) = ap(c_2Eoption_2ESOME(A_27a),V2v) ) ) ) )).

tff(conj_thm_2Esptree_2EALOOKUP__toAList,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Esptree_2Espt(A_27a))
