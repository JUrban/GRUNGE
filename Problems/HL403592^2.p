...
thf(conj_thm_2Einftree_2Eis__tree__cases,conjecture,(
          ...
          | ? [V3f: $i] :
              ...
              & ? [V4b: $i] :
                  ...
                  & ( V0a0
                    = ( lam @ ( ty_2Elist_2Elist @ A_27d )
                      @ ^ [V5p: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ A_27d ) ) @ V5p ) @ ( c_2Elist_2ENIL @ A_27d ) ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27a @ A_27b ) @ V4b ) ) @ ( ap @ ( ap @ V3f @ ( ap @ ( c_2Elist_2EHD @ A_27d ) @ V5p ) ) @ ( ap @ ( c_2Elist_2ETL @ A_27d ) @ V5p ) ) ) ) )
                  & ! [V6d: $i] :
                      ( ( mem @ V6d @ A_27d )
