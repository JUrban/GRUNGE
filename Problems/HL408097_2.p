...
tff(lmtp_f2905,type,(
    f2905: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f2905,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f2905(V1x,V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2905,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2h: tp__ty_2Erealax_2Ereal] : ap(f2905(V1x,V0f),inj__ty_2Erealax_2Ereal(V2h)) = ap(V0f,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2h))) ) )).
...
tff(ax_thm_2Elim_2Econtl,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
        ...
        <=> p(ap(ap(ap(c_2Elim_2Etends__real__real,f2905(V1x,V0f)),ap(V0f,inj__ty_2Erealax_2Ereal(V1x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) ) )).
...
tff(conj_thm_2Elim_2EDIFF__MUL,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
