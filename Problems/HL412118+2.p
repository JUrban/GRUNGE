...
fof(conj_thm_2Elebesgue_2Eintegral__indicator,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
         ...
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
               ...
               => ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),ap(c_2Emeasure_2Eindicator__fn(A_27a),V1s)) = ap(c_2Eextreal_2ENormal,ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m),V1s)) ) ) ) ) )).
...
fof(conj_thm_2Eprobability_2Edistribution__lebesgue__thm2,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V3A] :
                         ...
                         => ( ( p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),V2s))
                           ...
                           => ap(c_2Eextreal_2ENormal,ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),V3A)) = ap(ap(c_2Elebesgue_2Eintegral(A_27b),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(c_2Emeasure_2Espace(A_27b),V2s)),ap(ap(c_2Epair_2E_2C(arr(arr(A_27b,bool),bool),arr(arr(A_27b,bool),bool)),ap(c_2Emeasure_2Esubsets(A_27b),V2s)),ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X)))),ap(c_2Emeasure_2Eindicator__fn(A_27b),V3A)) ) ) ) ) ) ) ) )).
