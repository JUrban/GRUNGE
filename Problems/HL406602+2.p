...
fof(mem_c_2Esptree_2Elist__to__num__set,axiom,(
...
fof(ax_thm_2Esptree_2Elist__to__num__set__def,axiom,
    ( ap(c_2Esptree_2Elist__to__num__set,c_2Elist_2ENIL(ty_2Enum_2Enum)) = c_2Esptree_2ELN(ty_2Eone_2Eone)
    & ! [V0n] :
        ( mem(V0n,ty_2Enum_2Enum)
       => ! [V1ns] :
            ( mem(V1ns,ty_2Elist_2Elist(ty_2Enum_2Enum))
           => ap(c_2Esptree_2Elist__to__num__set,ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),V0n),V1ns)) = ap(ap(ap(c_2Esptree_2Einsert(ty_2Eone_2Eone),V0n),c_2Eone_2Eone),ap(c_2Esptree_2Elist__to__num__set,V1ns)) ) ) )).

fof(conj_thm_2Esptree_2Edomain__list__to__num__set,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1xs] :
          ( mem(V1xs,ty_2Elist_2Elist(ty_2Enum_2Enum))
         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0x),ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),ap(c_2Esptree_2Elist__to__num__set,V1xs))))
          <=> p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0x),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),V1xs))) ) ) ) )).
