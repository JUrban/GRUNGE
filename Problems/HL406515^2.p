...
thf(conj_thm_2Ebitstring_2Eword__reduce__v2w,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
          ...
          = ( surj__c_ty_2Efcp_2Ecart_o_ty_2Eone_2Eone
            @ ( ap
              @ ( ap @ ( c_2Ebool_2ELET @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Efcp_2Ecart @ bool @ ty_2Eone_2Eone ) )
                @ ( lam @ ( ty_2Elist_2Elist @ bool )
                  @ ^ [V2l: $i] :
                      ( ap @ ( c_2Ebitstring_2Ev2w @ ty_2Eone_2Eone ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ bool ) @ ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ bool @ bool ) @ V0f ) @ ( ap @ ( c_2Elist_2EHD @ bool ) @ V2l ) ) @ ( ap @ ( c_2Elist_2ETL @ bool ) @ V2l ) ) ) @ ( c_2Elist_2ENIL @ bool ) ) ) ) )
