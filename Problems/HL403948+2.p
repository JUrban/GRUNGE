...
fof(conj_thm_2Elist_2ETAKE__DROP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
...
fof(conj_thm_2Erich__list_2Eprefixes__is__prefix__total,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
...
fof(conj_thm_2Ellist_2Eprefixes__lprefix__total,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
