...
fof(conj_thm_2Estate__transformer_2EFOREACH__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27state] :
          ( ne(A_27state)
         => ! [V0P] :
             ...
             => ( ( ! [V1a] :
                      ( mem(V1a,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
                  ...
                  & ! [V2h] :
                     ...
                     => ! [V3t] :
                         ...
                         => ! [V4a] :
                              ( mem(V4a,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
               ...
               => ! [V5v] :
                   ...
                   => ! [V6v1] :
                        ( mem(V6v1,arr(A_27a,arr(A_27state,ty_2Epair_2Eprod(ty_2Eone_2Eone,ty_2Eone_2Eone))))
