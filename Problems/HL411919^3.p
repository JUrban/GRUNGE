...
thf(thm_2Ereal__topology_2ECLOSED__IN__SING,axiom,(
    ! [V0u: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
      ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V0u ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
      = ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0u ) ) )).
...
thf(thm_2Ereal__topology_2EURYSOHN__LOCAL__STRONG,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2u: tyop_2Erealax_2Ereal > $o,V3a: tyop_2Erealax_2Ereal,V4b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Etopology_2Eclosed__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V2u ) @ V0s )
        ...
        & ( ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V0s @ V1t )
          = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) )
        & ( (~) @ ( V3a = V4b ) ) )
     => ? [V5f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ( c_2Ereal__topology_2Econtinuous__on @ V5f @ V2u )
          & ! [V6x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V2u )
             => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V5f @ V6x ) @ ( c_2Ereal__topology_2Eclosed__segment @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V3a @ V4b ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) ) )
          & ! [V7x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V2u )
             => ( ( ( V5f @ V7x )
                  = V3a )
              <=> ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V0s ) ) )
          & ! [V8x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ V2u )
             => ( ( ( V5f @ V8x )
                  = V4b )
              <=> ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ V1t ) ) ) ) ) )).
