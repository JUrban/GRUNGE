...
tff(lmtp_f1102,type,(
    f1102: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f1102,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V2x: tp__ty_2Enum_2Enum] : mem(f1102(V1f,V2x),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f1102,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V2x: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : ap(f1102(V1f,V2x),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Earithmetic_2E_2B,ap(V1f,inj__ty_2Enum_2Enum(V3n))),inj__ty_2Enum_2Enum(V2x)) ) )).

tff(lmtp_f1101,type,(
    f1101: $i > $i )).

tff(lamtp_f1101,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
...
tff(lameq_f1101,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V2x: tp__ty_2Enum_2Enum] : ap(f1101(V1f),inj__ty_2Enum_2Enum(V2x)) = f1102(V1f,V2x) ) )).

tff(conj_thm_2Esum__num_2ESUM__FOLDL,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => surj__ty_2Enum_2Enum(ap(ap(c_2Esum__num_2ESUM,inj__ty_2Enum_2Enum(V0n)),V1f)) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f1101(V1f)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Erich__list_2ECOUNT__LIST,inj__ty_2Enum_2Enum(V0n)))) ) )).
