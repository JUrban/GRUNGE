...
fof(conj_thm_2Ereal_2EREAL__MUL__SUB2__CANCEL,conjecture,(
    ! [V0z] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V1x),V2y)),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,V0z),V1x)),V2y)) = ap(ap(c_2Erealax_2Ereal__mul,V0z),V2y) ) ) ) )).
