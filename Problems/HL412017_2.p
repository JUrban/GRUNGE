...
tff(conj_thm_2Epred__set_2EDISJOINT__BIGUNION,lemma,(
    ! [A_27a: del] :
      ( ! [V0s: $i] :
...
tff(lmtp_f4185,type,(
    f4185: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4185,axiom,(
...
tff(lmtp_f4187,type,(
    f4187: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4187,axiom,(
    ! [A_27b: del,A_27a: del,V9i: $i] :
      ( mem(V9i,A_27b)
     => ! [V3a: $i] :
          ( mem(V3a,arr(A_27b,arr(A_27a,bool)))
         => ! [V1f: $i] :
...
tff(lmtp_f4186,type,(
    f4186: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4186,axiom,(
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__disjoint__sets__sum,conjecture,(
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27b),V2s))
                      ...
                      & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V1f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(c_2Emeasure_2Em__space(A_27a),V0m)),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m))),c_2Emeasure_2EBorel))) )
                   => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Elebesgue_2Epos__fn__integral(A_27a),V0m),f4185(A_27b,A_27a,V3a,V2s,V1f))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f4186(A_27a,A_27b,V1f,V3a,V0m)),V2s)) ) ) ) ) ) )).
