...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__OF__SUBSETS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4s_27: $i] :
                      ( mem(V4s_27,arr(ty_2Erealax_2Ereal,bool))
                     => ! [V5t_27: $i] :
                          ( mem(V5t_27,arr(ty_2Erealax_2Ereal,bool))
                         => ( ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),V3t)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V0f),V1g)))
                              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V4s_27),V2s))
                              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V5t_27),V3t))
                              & ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V4s_27) = V5t_27 )
                           => p(ap(ap(c_2Ereal__topology_2Ehomeomorphism,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V4s_27),V5t_27)),ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),V0f),V1g))) ) ) ) ) ) ) ) )).
