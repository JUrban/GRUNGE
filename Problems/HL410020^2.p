...
thf(conj_thm_2Eproduct_2ENPRODUCT__SUPPORT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2Esupport @ A_27a @ ty_2Enum_2Enum ) @ c_2Earithmetic_2E_2A ) @ V0f ) @ V1s ) ) @ V0f ) )
            = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V1s ) @ V0f ) ) ) ) ) )).
