...
tff(lamtp_f4059,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => mem(f4059(V0s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4059,axiom,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f4059(V0s),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),inj__ty_2Erealax_2Ereal(V2x)))) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__DIST__CLOSEST__POINT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
            & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
         => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f4059(V0s)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x)))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST__CLOSEST__POINT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
