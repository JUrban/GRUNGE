...
tff(conj_thm_2Ebool_2ECOND__EXPAND__IMP,lemma,(
...
tff(tp_c_2Ebag_2EBAG__MERGE,type,(
    c_2Ebag_2EBAG__MERGE: del > $i )).

tff(mem_c_2Ebag_2EBAG__MERGE,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__MERGE(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)))) )).

tff(lmtp_f966,type,(
    f966: ( del * $i * $i ) > $i )).

tff(lamtp_f966,axiom,(
    ! [A_27a: del,V1b2: $i] :
...
tff(ax_thm_2Ebag_2EBAG__MERGE,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__ALL__DISTINCT__BAG__MERGE,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
