...
thf(thm_2Eordinal_2Eordlt__fromNat,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1x: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ V1x @ ( c_2Eordinal_2EfromNat @ A_27a @ V0n ) )
    <=> ? [V2m: tyop_2Enum_2Enum] :
          ( ( V1x
            = ( c_2Eordinal_2EfromNat @ A_27a @ V2m ) )
