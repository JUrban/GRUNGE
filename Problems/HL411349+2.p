...
fof(conj_thm_2Ereal__topology_2ECONNECTED__CLOPEN,lemma,(
    ! [V0s] :
    ...
    ! [V1s] :
     ...
     => ! [V0f] :
         ...
         => ! [V2a] :
             ...
             => mem(f3918(V1s,V0f,V2a),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f3918,axiom,(
    ! [V1s] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a] :
             ...
             => ! [V3x] :
                 ...
                 => ap(f3918(V1s,V0f,V2a),V3x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V1s)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,V3x)),V2a))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__IN__PREIMAGE__CONSTANT,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__LEVELSET__OPEN__IN__CASES,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
