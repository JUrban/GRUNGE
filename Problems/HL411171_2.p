...
tff(lamtp_f2908,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f2908(V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2908,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f2908(V0f),inj__ty_2Erealax_2Ereal(V2x)) = ap(c_2Erealax_2Ereal__neg,ap(V0f,inj__ty_2Erealax_2Ereal(V2x))) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__NEG,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1net: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__NEG,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f2908(V0f)),V1s)) ) ) ) )).
