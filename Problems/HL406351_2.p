...
tff(conj_thm_2Etoto_2Etrichotomous__ALT,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2Etrichotomous(A_27a),V0R))
      <=> ! [V1x: $i] :
...
tff(conj_thm_2Etoto_2ESPLIT__PAIRS,lemma,(
...
tff(conj_thm_2Etoto_2ELEX__ALT,lemma,(
...
tff(conj_thm_2Etoto_2ESLO__LEX,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1V: $i] :
