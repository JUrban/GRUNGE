...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V2s))
                  & p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V1g),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s))) )
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1g),V0f)),V2s)) ) ) ) ) )).
