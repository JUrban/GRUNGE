...
thf(conj_thm_2Ebitstring_2Ebitify__ind,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( ty_2Elist_2Elist @ ty_2Enum_2Enum ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ bool ) ) )
     => ( ( ! [V1a: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ V1a ) ) @ ( c_2Elist_2ENIL @ bool ) ) )
       ...
       => ! [V6v: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum,V7v1: tp__c_ty_2Elist_2Elist_o] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum @ V6v ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V7v1 ) ) ) ) ) )).
