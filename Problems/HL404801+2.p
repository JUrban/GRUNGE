...
fof(conj_thm_2Efinite__map_2Efmap__EQ__UPTO______EMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f1] :
             ...
             => ! [V1f2] :
                  ( mem(V1f2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                 => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),V0f1),V1f2),c_2Epred__set_2EEMPTY(A_27a)))
                  <=> V0f1 = V1f2 ) ) ) ) ) )).
