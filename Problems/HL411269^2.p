...
thf(conj_thm_2Ereal__topology_2ECLOSED__MAP__OPEN__SUPERSET__PREIMAGE__EQ,lemma,(
    ! [V0f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) ) @ V2t ) )
               => ( ! [V3k: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V1s ) ) @ V3k ) )
                       => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2t ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V3k ) ) ) ) )
                <=> ! [V4u: $i] :
...
thf(conj_thm_2Ereal__topology_2ECLOSED__MAP__OPEN__SUPERSET__PREIMAGE__POINT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                              ...
                              @ ( ap
                                @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                    @ ( lam @ ty_2Erealax_2Ereal
                                      @ ^ [V6x: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) ) ) ) ) )
                                @ V4u ) ) )
                         => ? [V7v: $i] :
                              ( ( mem @ V7v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2t ) ) @ V7v ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5y ) ) @ V7v ) )
                              & ( p
                                @ ( ap
                                  @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal )
                                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
