...
thf(conj_thm_2Eordinal_2Eomega__MUL__fromNat,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
     => ( ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( c_2Eordinal_2Eomega @ A_27a ) )
        = ( c_2Eordinal_2Eomega @ A_27a ) ) ) )).
