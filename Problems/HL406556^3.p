...
thf(thm_2Ealignment_2Ealigned__0,axiom,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ! [V0p: tyop_2Enum_2Enum] :
          ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) )
      & ! [V1w: tyop_2Efcp_2Ecart @ $o @ A_27b] :
          ( c_2Ealignment_2Ealigned @ A_27b @ c_2Enum_2E0 @ V1w ) ) )).
...
thf(thm_2Ewords_2Eword__1__lsl,axiom,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum] :
      ( ( c_2Ewords_2Eword__lsl @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0n )
      = ( c_2Ewords_2En2w @ A_27a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) ) )).

thf(thm_2Ealignment_2Ealigned__add__sub__123,conjecture,(
    ! [A_27a: $tType] :
