...
fof(conj_thm_2Ereal_2EREAL__LT__MIN,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EREAL__LE__LMUL1,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EBILINEAR__LSUB,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ereal__topology_2EBILINEAR__RSUB,lemma,(
    ! [V0h] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EBILINEAR__BOUNDED__POS,lemma,(
    ! [V0h] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ( p(ap(c_2Ereal__topology_2Ebilinear,V0h))
       => ? [V1B] :
...
fof(ax_thm_2Ereal__topology_2Euniformly__continuous__on,axiom,(
    ! [V0f] :
                      ...
                      & ! [V4x] :
                         ...
                         => ! [V5x_27] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V1s))
                                  ...
                                  & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V5x_27),V4x))),V3d)) )
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V5x_27)),ap(V0f,V4x)))),V2e)) ) ) ) ) ) ) ) ) ) )).

fof(lamtp_f3835,axiom,(
    ! [V2h] :
    ...
    ! [V2h] :
     ...
     => ! [V0f] :
         ...
         => ! [V1g] :
             ...
             => ! [V4x] :
                  ( mem(V4x,ty_2Erealax_2Ereal)
                 => ap(f3835(V2h,V0f,V1g),V4x) = ap(ap(V2h,ap(V0f,V4x)),ap(V1g,V4x)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBILINEAR__UNIFORMLY__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
