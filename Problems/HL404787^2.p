...
thf(conj_thm_2Efinite__map_2EFLOOKUP__MAP__KEYS,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1m: $i] :
                  ...
                  = ( ap
                    @ ( ap @ ( c_2Eoption_2EOPTION__BIND @ A_27c @ A_27a )
                      @ ( ap @ ( c_2Eoption_2Esome @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ V2k ) @ ( ap @ V0f @ V3x ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ A_27c ) @ V1m ) ) ) ) ) )
