...
thf(conj_thm_2Efinite__map_2EDRESTRICT__FEMPTY,lemma,(
...
thf(conj_thm_2Efinite__map_2EDRESTRICT__FUPDATE,lemma,(
...
thf(conj_thm_2Efinite__map_2EDRESTRICT__DRESTRICT,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1P: $i] :
