...
tff(conj_thm_2Epred__set_2EEMPTY__FUNSET,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27b,bool))
     => ap(ap(c_2Epred__set_2EFUNSET(A_27a,A_27a),c_2Epred__set_2EEMPTY(A_27a)),V0s) = c_2Epred__set_2EUNIV(arr(A_27a,A_27b)) ) )).
