...
tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__REAL__EQ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V0x))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__real,inj__ty_2Erealax_2Ereal(V1y)))
    <=> V0x = V1y ) )).

tff(conj_thm_2Ecomplex_2ECOMPLEX__OF__NUM__EQ,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__num,inj__ty_2Enum_2Enum(V0m))) = surj__c_ty_2Epair_2Eprod_ty_2Erealax_2Ereal_ty_2Erealax_2Ereal(ap(c_2Ecomplex_2Ecomplex__of__num,inj__ty_2Enum_2Enum(V1n)))
    <=> V0m = V1n ) )).
