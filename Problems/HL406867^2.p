...
thf(ax_thm_2Ehreal_2Ehreal__mul,axiom,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__mul @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) )
      = ( surj__ty_2Ehreal_2Ehreal
        @ ( ap @ c_2Ehreal_2Ehreal
            ...
            @ ^ [V2w: $i] :
                ...
                @ ( lam @ ty_2Ehrat_2Ehrat
                  @ ^ [V3x: $i] :
                      ...
                      @ ( lam @ ty_2Ehrat_2Ehrat
                        @ ^ [V4y: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Ehrat_2Ehrat ) @ V2w ) @ ( ap @ ( ap @ c_2Ehrat_2Ehrat__mul @ V3x ) @ V4y ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ V3x ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) @ V4y ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ehreal_2EHREAL__MUL__ISACUT,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( p
...
thf(conj_thm_2Ehreal_2EHREAL__MUL__ASSOC,conjecture,(
