...
fof(conj_thm_2Earithmetic_2EMULT__EQ__ID,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Edivides_2EPRIME__FACTOR,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebag_2EBAG__GEN__PROD__EMPTY,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(ap(c_2Ebag_2EBAG__GEN__PROD,c_2Ebag_2EEMPTY__BAG(ty_2Enum_2Enum)),V0n) = V0n ) )).

fof(conj_thm_2Ebag_2EBAG__GEN__PROD__TAILREC,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Ebag_2EBAG__GEN__PROD__REC,lemma,(
    ! [V0b] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ! [V1x] :
...
fof(conj_thm_2EprimeFactor_2EPRIME__FACTORS__EXIST,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
