...
tff(conj_thm_2Ereal__topology_2EPASTING__LEMMA__CLOSED,conjecture,(
    ! [A_27a: del,V0f: $i] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V4k))
                          ...
                          & ! [V6i: $i] :
                             ...
                             => ! [V7j: $i] :
                                 ...
                                 => ! [V8x: tp__ty_2Erealax_2Ereal] :
                                     ...
                                     => surj__ty_2Erealax_2Ereal(ap(ap(V0f,V6i),inj__ty_2Erealax_2Ereal(V8x))) = surj__ty_2Erealax_2Ereal(ap(ap(V0f,V7j),inj__ty_2Erealax_2Ereal(V8x))) ) ) )
                          & ! [V9x: tp__ty_2Erealax_2Ereal] :
                             ...
                             => ? [V10j: $i] :
                                  ...
                                  & surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V9x))) = surj__ty_2Erealax_2Ereal(ap(ap(V0f,V10j),inj__ty_2Erealax_2Ereal(V9x))) ) ) )
