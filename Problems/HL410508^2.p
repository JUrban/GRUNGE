...
thf(conj_thm_2Ereal__topology_2ECARD__STDBASIS,lemma,
    ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Epred__set_2ECARD @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) )
    = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINDEPENDENT__SPAN__BOUND,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(ax_thm_2Etopology_2Ehull,axiom,(
    ! [A_27a: del,V0P: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V1s )
            = ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27a )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                @ ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2t: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V2t ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V2t ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V1s ) @ V2t ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINDEPENDENT__BOUND,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Eindependent @ V0s ) )
       => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V0s ) )
