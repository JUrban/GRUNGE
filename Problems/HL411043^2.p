...
thf(conj_thm_2Ereal__topology_2EDIST__TRIANGLE__HALF__L,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECAUCHY,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Ecauchy @ V0s ) )
      <=> ! [V1e: tp__ty_2Erealax_2Ereal] :
           ...
           => ? [V2N: tp__ty_2Enum_2Enum] :
              ! [V3n: tp__ty_2Enum_2Enum] :
               ...
               => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2N ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1e ) ) ) ) ) ) ) )).
