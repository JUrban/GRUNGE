...
thf(conj_thm_2Ebag_2EBAG__UNION__LEFT__CANCEL,lemma,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ! [V1b1: $i] :
         ...
         => ! [V2b2: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b ) @ V1b1 )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V0b ) @ V2b2 ) )
              <=> ( V1b1 = V2b2 ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EBAG__UNION__RIGHT__CANCEL,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
