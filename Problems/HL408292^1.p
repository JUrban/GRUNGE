...
thf(thm_2Etransc_2EROOT__MUL,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Etransc_2Eroot @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V1x @ V2y ) )
        = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Etransc_2Eroot @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ V1x ) @ ( mono_2Ec_2Etransc_2Eroot @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ V2y ) ) ) ) )).

thf(thm_2Etransc_2ESQRT__MUL,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( mono_2Ec_2Etransc_2Esqrt @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0x @ V1y ) )
        = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Etransc_2Esqrt @ V0x ) @ ( mono_2Ec_2Etransc_2Esqrt @ V1y ) ) ) ) )).
