...
fof(mem_c_2EordinalNotation_2Erank,axiom,(
    mem(c_2EordinalNotation_2Erank,arr(ty_2EordinalNotation_2Eosyntax,ty_2Enum_2Enum)) )).

fof(ax_thm_2EordinalNotation_2Erank__def,axiom,
    ( ! [V0v0] :
        ( mem(V0v0,ty_2Enum_2Enum)
       => ap(c_2EordinalNotation_2Erank,ap(c_2EordinalNotation_2EEnd,V0v0)) = c_2Enum_2E0 )
    & ! [V1e] :
       ...
       => ! [V2k] :
           ...
           => ! [V3t] :
               ...
               => ap(c_2EordinalNotation_2Erank,ap(ap(ap(c_2EordinalNotation_2EPlus,V1e),V2k),V3t)) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(c_2EordinalNotation_2Erank,V1e)) ) ) ) )).

fof(conj_thm_2EordinalNotation_2Eis__ord__downclosed,lemma,(
    ! [V0w] :
      ( mem(V0w,ty_2EordinalNotation_2Eosyntax)
     => ! [V1k] :
          ( mem(V1k,ty_2Enum_2Enum)
         => ! [V2t] :
              ( mem(V2t,ty_2EordinalNotation_2Eosyntax)
             => ( p(ap(c_2EordinalNotation_2Eis__ord,ap(ap(ap(c_2EordinalNotation_2EPlus,V0w),V1k),V2t)))
               => ( p(ap(c_2EordinalNotation_2Eis__ord,V0w))
                  & p(ap(c_2EordinalNotation_2Eis__ord,V2t)) ) ) ) ) ) )).

fof(conj_thm_2EordinalNotation_2Erank__less__imp__oless,lemma,(
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ( ( p(ap(c_2EordinalNotation_2Eis__ord,V0x))
              ...
              & p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2EordinalNotation_2Erank,V0x)),ap(c_2EordinalNotation_2Erank,V1y))) )
           => p(ap(ap(c_2EordinalNotation_2Eoless,V0x),V1y)) ) ) ) )).

fof(conj_thm_2EordinalNotation_2Eoless__expt,conjecture,(
    ! [V0e] :
     ...
     => ! [V1k] :
         ...
         => ! [V2t] :
             ...
             => ( p(ap(c_2EordinalNotation_2Eis__ord,ap(ap(ap(c_2EordinalNotation_2EPlus,V0e),V1k),V2t)))
               => p(ap(ap(c_2EordinalNotation_2Eoless,V0e),ap(ap(ap(c_2EordinalNotation_2EPlus,V0e),V1k),V2t))) ) ) ) ) )).
