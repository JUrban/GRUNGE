...
fof(conj_thm_2Efcp_2Eindex__comp,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0FCP_20out_20of_20bounds] :
             ...
             => ! [V1f] :
                 ...
                 => ! [V2n] :
                     ...
                     => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(c_2Efcp_2EFCP(A_27a,A_27a),V1f)),V2n) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,V2n),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(V1f,V2n)),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a)),arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a))),c_2Efcp_2Efcp__index(A_27a,A_27a)),V0FCP_20out_20of_20bounds),ap(c_2Efcp_2EFCP(A_27a,A_27a),V1f)),V2n)) ) ) ) ) ) )).
