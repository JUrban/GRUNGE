...
fof(conj_thm_2Eextreal_2Esub__rneg,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ap(ap(c_2Eextreal_2Eextreal__sub,V0x),ap(c_2Eextreal_2Eextreal__ainv,V1y)) = ap(ap(c_2Eextreal_2Eextreal__add,V0x),V1y) ) ) )).
...
fof(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__PLUS__MINUS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
