...
fof(conj_thm_2Epred__set_2ECROSS__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1Q] :
                 ...
                 => ! [V2P0] :
                     ...
                     => ! [V3Q0] :
                         ...
                         => ( p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V2P0),V3Q0)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0P),V1Q)))
...
fof(conj_thm_2Epred__set_2EPREIMAGE__CROSS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0f] :
                 ...
                 => ! [V1a] :
                     ...
                     => ! [V2b] :
                         ...
                         => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V1a),V2b)) = ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Epair_2EFST(A_27b,A_27b)),V0f)),V1a)),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Epair_2ESND(A_27b,A_27b)),V0f)),V2b)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Eutil__prob_2EIN__PROD__SETS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1a] :
                 ...
                 => ! [V2b] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Epair_2Eprod(A_27a,A_27a),bool)),V0s),ap(ap(c_2Eutil__prob_2Eprod__sets(A_27a,A_27a),V1a),V2b)))
                      <=> ? [V3t] :
                            ( mem(V3t,arr(A_27a,bool))
                            & ? [V4u] :
                                ( mem(V4u,arr(A_27b,bool))
                                & V0s = ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V3t),V4u)
...
fof(conj_thm_2Emeasure_2EMEASURABLE__PROD__SIGMA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0a] :
                  ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
                 => ! [V1a1] :
                      ( mem(V1a1,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))
                     => ! [V2a2] :
                          ( mem(V2a2,ty_2Epair_2Eprod(arr(A_27c,bool),arr(A_27c,bool)))
                         => ! [V3f] :
                              ( mem(V3f,arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b)))
                             => ( ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
                                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27b)),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Epair_2EFST(A_27b,A_27b)),V3f)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),V1a1)))
                                  & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,A_27c)),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Epair_2ESND(A_27b,A_27b)),V3f)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),V2a2))) )
                               => p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))),V3f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),ap(ap(c_2Emeasure_2Esigma(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(c_2Emeasure_2Espace(A_27b),V1a1)),ap(c_2Emeasure_2Espace(A_27c),V2a2))),ap(ap(c_2Eutil__prob_2Eprod__sets(A_27b,A_27b),ap(c_2Emeasure_2Esubsets(A_27b),V1a1)),ap(c_2Emeasure_2Esubsets(A_27c),V2a2)))))) ) ) ) ) ) ) ) ) )).
