...
tff(lmtp_f3738,type,(
    f3738: ( del * tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal * $i * $i * $i ) > $i )).

tff(lamtp_f3738,axiom,(
         ...
         => ! [V2g: $i] :
             ...
             => ! [V3s: $i] :
                 ...
                 => ! [V4y: tp__ty_2Erealax_2Ereal,V5z: tp__ty_2Erealax_2Ereal] :
                     ...
                     => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2g),V1f)),inj__ty_2Erealax_2Ereal(V5z)),V0net)) ) ) ) ) ) )).
