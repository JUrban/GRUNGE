...
tff(conj_thm_2Epred__set_2EBIGINTER__INSERT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1B: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__IMP__FIP,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
              ...
              & ! [V4f_27: $i] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),V4f_27))
                   ...
                   => ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),V4f_27)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )
           => ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),V0s),ap(c_2Epred__set_2EBIGINTER(ty_2Erealax_2Ereal),V1f)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) )).
