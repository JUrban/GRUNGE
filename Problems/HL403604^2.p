      ...
      & ! [V1r: $i] :
         ...
         => ( ( p
              @ ( ap
                @ ( lam @ A_27a
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V2x ) @ ( c_2Ebool_2EARB @ A_27a ) ) ) @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) ) )
                @ V1r ) )
...
thf(conj_thm_2Efcp_2EDIMINDEX__GE__1,conjecture,(
    ! [A_27a: del] :
