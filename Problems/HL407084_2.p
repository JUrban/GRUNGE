...
tff(conj_thm_2Ehreal_2EHREAL__MUL__LID,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal] : surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__mul,inj__ty_2Ehreal_2Ehreal(fo__c_2Ehreal_2Ehreal__1)),inj__ty_2Ehreal_2Ehreal(V0X))) = V0X )).

tff(conj_thm_2Ehreal_2EHREAL__MUL__LINV,lemma,(
...
tff(conj_thm_2Erealax_2EHREAL__LT__GT,lemma,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal] :
      ( p(ap(ap(c_2Ehreal_2Ehreal__lt,inj__ty_2Ehreal_2Ehreal(V0x)),inj__ty_2Ehreal_2Ehreal(V1y)))
     => ~ p(ap(ap(c_2Ehreal_2Ehreal__lt,inj__ty_2Ehreal_2Ehreal(V1y)),inj__ty_2Ehreal_2Ehreal(V0x))) ) )).
...
tff(conj_thm_2Erealax_2ETREAL__MUL__LINV,conjecture,(
