...
tff(conj_thm_2Earithmetic_2EMOD__MOD,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n)))
...
tff(conj_thm_2Einteger_2EINT__SUB__RZERO,lemma,(
...
tff(conj_thm_2Einteger_2EINT__MOD__ADD__MULTIPLES,lemma,(
...
tff(conj_thm_2Einteger_2EINT__MOD__SUB,lemma,(
...
tff(conj_thm_2Einteger_2EINT__MOD__CALCULATE,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
        ( V1m != fo__c_2Enum_2E0
    ...
    & ! [V2p: tp__ty_2Einteger_2Eint,V3q: tp__ty_2Einteger_2Eint] :
       ...
       => surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__mod,inj__ty_2Einteger_2Eint(V2p)),ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V3q)))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,ap(ap(c_2Einteger_2Eint__mod,ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V2p))),inj__ty_2Einteger_2Eint(V3q)))) )
    & ! [V4x: tp__ty_2Einteger_2Eint] : surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V4x)))) = V4x
    & ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
        ( surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V5m))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V6n)))
      <=> V5m = V6n )
    & ! [V7x: tp__ty_2Einteger_2Eint] :
        ( surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V7x))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
      <=> V7x = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
...
tff(conj_thm_2Eint__arith_2EINT__SUB__SUB3,lemma,(
...
tff(conj_thm_2Einteger__word_2Ew2i__n2w__neg,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Einteger__word_2Ew2i__n2w__mod,conjecture,(
