...
thf(ax_thm_2Elebesgue_2Eseq__sup__def,axiom,
    ( ! [V0P: $i] :
        ( ( mem @ V0P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
       => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V0P ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          = ( surj__ty_2Eextreal_2Eextreal
            @ ( ap @ ( c_2Emin_2E_40 @ ty_2Eextreal_2Eextreal )
              @ ( lam @ ty_2Eextreal_2Eextreal
                @ ^ [V1r: $i] :
                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ V1r ) @ V0P ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ c_2Eextreal_2Eextreal__sup @ V0P ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ V1r ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) )
    & ! [V2P: $i] :
        ( ( mem @ V2P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
       => ! [V3n: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V2P ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) )
            = ( surj__ty_2Eextreal_2Eextreal
              @ ( ap @ ( c_2Emin_2E_40 @ ty_2Eextreal_2Eextreal )
                @ ( lam @ ty_2Eextreal_2Eextreal
                  @ ^ [V4r: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ V4r ) @ V2P ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ c_2Eextreal_2Eextreal__sup @ V2P ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ V4r ) @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V2P ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V4r ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ V4r ) @ ( ap @ c_2Eextreal_2Eextreal__sup @ V2P ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elebesgue_2Eseq__sup__def__compute,conjecture,
    ( ! [V0P: $i] :
        ( ( mem @ V0P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
       => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V0P ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          = ( surj__ty_2Eextreal_2Eextreal
    ...
    & ! [V2P: $i] :
        ( ( mem @ V2P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
       => ! [V3n: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V2P ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) )
            = ( surj__ty_2Eextreal_2Eextreal
              @ ( ap @ ( c_2Emin_2E_40 @ ty_2Eextreal_2Eextreal )
                @ ( lam @ ty_2Eextreal_2Eextreal
                  @ ^ [V4r: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ V4r ) @ V2P ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ c_2Eextreal_2Eextreal__sup @ V2P ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ V4r ) @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V2P ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ V4r ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ V4r ) @ ( ap @ c_2Eextreal_2Eextreal__sup @ V2P ) ) ) ) ) ) ) ) ) )
    & ! [V5P: $i] :
        ( ( mem @ V5P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
       => ! [V6n: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V5P ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) )
            = ( surj__ty_2Eextreal_2Eextreal
              @ ( ap @ ( c_2Emin_2E_40 @ ty_2Eextreal_2Eextreal )
                @ ( lam @ ty_2Eextreal_2Eextreal
                  @ ^ [V7r: $i] :
                      ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Eextreal_2Eextreal ) @ V7r ) @ V5P ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ c_2Eextreal_2Eextreal__sup @ V5P ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ V7r ) @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) ) ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ ( ap @ c_2Elebesgue_2Eseq__sup @ V5P ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) ) @ V7r ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ V7r ) @ ( ap @ c_2Eextreal_2Eextreal__sup @ V5P ) ) ) ) ) ) ) ) ) ) )).
