...
fof(conj_thm_2Epred__set_2ESUBSET__DELETE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Epred__set_2ESUBSET__EQ__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           => ! [V1t] :
               ...
               => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1t))
                    & ap(c_2Epred__set_2ECARD(A_27a),V0s) = ap(c_2Epred__set_2ECARD(A_27a),V1t)
                    & p(ap(ap(c_2Epred__set_2ESUBSET(A_27a),V0s),V1t)) )
                 => V0s = V1t ) ) ) ) ) )).
