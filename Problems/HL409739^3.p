...
thf(thm_2Eiterate_2ENSUM__LT__ALL,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1g: A_27a > tyop_2Enum_2Enum,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2s )
        ...
        & ! [V3x: A_27a] :
           ...
           => ( c_2Eprim__rec_2E_3C @ ( V0f @ V3x ) @ ( V1g @ V3x ) ) ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Eiterate_2Ensum @ A_27a @ V2s @ V0f ) @ ( c_2Eiterate_2Ensum @ A_27a @ V2s @ V1g ) ) ) )).

thf(thm_2Eiterate_2ENSUM__BOUND__GEN,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        ...
        & ! [V3x: A_27a] :
           ...
           => ( c_2Earithmetic_2E_3C_3D @ ( V1f @ V3x ) @ ( c_2Earithmetic_2EDIV @ V2b @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) ) ) )
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Eiterate_2Ensum @ A_27a @ V0s @ V1f ) @ V2b ) ) )).
...
thf(thm_2Eiterate_2ENSUM__BOUND__LT__GEN,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1f: A_27a > tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V0s )
        & ( (~)
          @ ( V0s
        ...
        & ! [V3x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V0s )
           => ( c_2Eprim__rec_2E_3C @ ( V1f @ V3x ) @ ( c_2Earithmetic_2EDIV @ V2b @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) ) ) ) )
     => ( c_2Eprim__rec_2E_3C @ ( c_2Eiterate_2Ensum @ A_27a @ V0s @ V1f ) @ V2b ) ) )).
