...
thf(f9622_0_2E0,type,(
    f9622_0_2E0: u )).

thf(f9622_0_2E1,type,(
    f9622_0_2E1: du > u )).

thf(f9622_0_2E2,type,(
    f9622_0_2E2: du > du > u )).

thf(f9623_0_2E0,type,(
    f9623_0_2E0: u )).

thf(f9623_0_2E1,type,(
    f9623_0_2E1: du > u )).

thf(f9623_0_2E2,type,(
    f9623_0_2E2: du > du > u )).

thf(f9624_0_2E0,type,(
    f9624_0_2E0: u )).

thf(f9624_0_2E1,type,(
    f9624_0_2E1: du > u )).

thf(f9624_0_2E2,type,(
    f9624_0_2E2: du > du > u )).
...
thf(c_2Elim_2Edifferentiable_2E0,type,(
    c_2Elim_2Edifferentiable_2E0: u )).

thf(c_2Elim_2Edifferentiable_2E2,type,(
    c_2Elim_2Edifferentiable_2E2: du > du > u )).
...
thf(mono_2Ef9622_0,type,(
    mono_2Ef9622_0: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29 > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9623_0,type,(
    mono_2Ef9623_0: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29 > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9624_0,type,(
    mono_2Ef9624_0: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29 > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Elim_2Edifferentiable,type,(
    mono_2Ec_2Elim_2Edifferentiable: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(thm_2Elim_2EDIFF__UNIQ,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal,V2m: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Elim_2Ediffl @ V0f @ V1l @ V3x )
        & ( mono_2Ec_2Elim_2Ediffl @ V0f @ V2m @ V3x ) )
     => ( V1l = V2m ) ) )).
...
thf(thm_2Elim_2EMVT,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V2b )
        ...
        & ! [V4x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V4x )
              & ( mono_2Ec_2Erealax_2Ereal__lt @ V4x @ V2b ) )
           => ( mono_2Ec_2Elim_2Edifferentiable @ V0f @ V4x ) ) )
     => ? [V5l: mono_2Etyop_2Erealax_2Ereal,V6z: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V6z )
          & ( mono_2Ec_2Erealax_2Ereal__lt @ V6z @ V2b )
          & ( mono_2Ec_2Elim_2Ediffl @ V0f @ V5l @ V6z )
          & ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0f @ V2b ) @ ( V0f @ V1a ) )
            = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__sub @ V2b @ V1a ) @ V5l ) ) ) ) )).

thf(def0_2Ethm_2Epoly_2EPOLY__DIFF,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9622_0 @ V0l @ V2x )
      = ( mono_2Ec_2Epoly_2Epoly @ V0l @ V2x ) ) )).

thf(thm_2Epoly_2EPOLY__DIFF,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Ediffl @ ( mono_2Ef9622_0 @ V0l ) @ ( mono_2Ec_2Epoly_2Epoly @ ( mono_2Ec_2Epoly_2Ediff @ V0l ) @ V1x ) @ V1x ) )).

thf(def0_2Ethm_2Epoly_2EPOLY__DIFFERENTIABLE,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9623_0 @ V0l @ V2x )
      = ( mono_2Ec_2Epoly_2Epoly @ V0l @ V2x ) ) )).

thf(thm_2Epoly_2EPOLY__DIFFERENTIABLE,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Edifferentiable @ ( mono_2Ef9623_0 @ V0l ) @ V1x ) )).

thf(def0_2Ethm_2Epoly_2EPOLY__CONT,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef9624_0 @ V0l @ V2x )
      = ( mono_2Ec_2Epoly_2Epoly @ V0l @ V2x ) ) )).

thf(thm_2Epoly_2EPOLY__CONT,axiom,(
    ! [V0l: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Elim_2Econtl @ ( mono_2Ef9624_0 @ V0l ) @ V1x ) )).

thf(thm_2Epoly_2EPOLY__MVT,conjecture,(
    ! [V0p: mono_2Etyop_2Elist_2Elist_28tyop_2Erealax_2Ereal_29,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V2b )
     => ? [V3x: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ V1a @ V3x )
          & ( mono_2Ec_2Erealax_2Ereal__lt @ V3x @ V2b )
          & ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Epoly_2Epoly @ V0p @ V2b ) @ ( mono_2Ec_2Epoly_2Epoly @ V0p @ V1a ) )
            = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__sub @ V2b @ V1a ) @ ( mono_2Ec_2Epoly_2Epoly @ ( mono_2Ec_2Epoly_2Ediff @ V0p ) @ V3x ) ) ) ) ) )).
