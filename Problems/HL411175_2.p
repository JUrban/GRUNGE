...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MAX,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(lamtp_f3831,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f3831(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3831,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3831(V0f,V1g),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Ereal_2Emax,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__MAX,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3831(V0f,V1g)),V2s)) ) ) ) ) )).
