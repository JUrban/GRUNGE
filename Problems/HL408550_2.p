...
tff(lmtp_f3123,type,(
    f3123: ( del * del * tp__ty_2Ebinary__ieee_2Erounding * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3123,axiom,(
...
tff(lameq_f3122,axiom,(
    ! [A_27w: del,A_27t: del,V4v1: tp__ty_2Ebinary__ieee_2Efloat__value,V1x: $i] :
      ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V0mode: tp__ty_2Ebinary__ieee_2Erounding,V2y: $i] :
          ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V5r1: tp__ty_2Erealax_2Ereal] : ap(f3122(A_27w,A_27t,V4v1,V1x,V0mode,V2y),inj__ty_2Erealax_2Ereal(V5r1)) = ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),inj__ty_2Ebinary__ieee_2Efloat__value(V4v1)),f3123(A_27w,A_27t,V0mode,V1x,V2y,V5r1)),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Eclear__flags)),V2y)),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(c_2Ebinary__ieee_2Echeck__for__signalling(A_27t,A_27t),ap(ap(c_2Elist_2ECONS(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),V2y),c_2Elist_2ENIL(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))))),ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27t),ap(ap(ap(c_2Ebinary__ieee_2EFP__Add(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y)))) ) ) )).

tff(lmtp_f3121,type,(
    f3121: ( del * del * tp__ty_2Ebinary__ieee_2Efloat__value * tp__ty_2Ebinary__ieee_2Erounding * $i * $i ) > $i )).

tff(lamtp_f3121,axiom,(
...
tff(lameq_f3120,axiom,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
      ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V2y: $i] :
          ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V3v: tp__ty_2Ebinary__ieee_2Efloat__value] : ap(f3120(A_27t,A_27w,V0mode,V1x,V2y),inj__ty_2Ebinary__ieee_2Efloat__value(V3v)) = f3121(A_27w,A_27t,V3v,V0mode,V1x,V2y) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
     ...
     => ! [V2y: $i] :
         ...
         => ! [V3r1: tp__ty_2Erealax_2Ereal,V4r2: tp__ty_2Erealax_2Ereal] :
             ...
             => ap(ap(ap(c_2Ebinary__ieee_2Efloat__add(A_27a,A_27a),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__round__with__flags(A_27a,A_27a),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3r1)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4r2)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27a,A_27a),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27a,A_27a),V2y))))),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27a,A_27a),V1x)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(ap(c_2Emin_2E_3D(ty_2Ebinary__ieee_2Erounding),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),inj__ty_2Ebinary__ieee_2Erounding(fo__c_2Ebinary__ieee_2EroundTowardNegative)))),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V3r1)),inj__ty_2Erealax_2Ereal(V4r2))) ) ) ) )).
