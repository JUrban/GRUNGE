...
fof(lamtp_f3717,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f3717(V0x),arr(ty_2Erealax_2Ereal,bool)) ) )).

fof(lameq_f3717,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ap(f3717(V0x),V1y) = ap(ap(c_2Ereal_2Ereal__ge,ap(c_2Ereal_2Eabs,V0x)),ap(c_2Ereal_2Eabs,V1y)) ) ) )).

fof(lamtp_f3716,axiom,(
    mem(f3716,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool))) )).

fof(lameq_f3716,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(f3716,V0x) = f3717(V0x) ) )).

fof(ax_thm_2Ereal__topology_2Eat__infinity,axiom,(
    c_2Ereal__topology_2Eat__infinity = ap(c_2Ereal__topology_2Emk__net(ty_2Erealax_2Ereal),f3716) )).

fof(conj_thm_2Ereal__topology_2EAT__INFINITY,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
