...
fof(mem_c_2Esptree_2Elist__insert,axiom,(
...
fof(ax_thm_2Esptree_2Elist__insert__def,axiom,
    ( ! [V0t] :
        ( mem(V0t,ty_2Esptree_2Espt(ty_2Eone_2Eone))
       => ap(ap(c_2Esptree_2Elist__insert,c_2Elist_2ENIL(ty_2Enum_2Enum)),V0t) = V0t )
    & ! [V1n] :
        ( mem(V1n,ty_2Enum_2Enum)
       => ! [V2ns] :
            ( mem(V2ns,ty_2Elist_2Elist(ty_2Enum_2Enum))
           => ! [V3t] :
                ( mem(V3t,ty_2Esptree_2Espt(ty_2Eone_2Eone))
               => ap(ap(c_2Esptree_2Elist__insert,ap(ap(c_2Elist_2ECONS(ty_2Enum_2Enum),V1n),V2ns)),V3t) = ap(ap(c_2Esptree_2Elist__insert,V2ns),ap(ap(ap(c_2Esptree_2Einsert(ty_2Eone_2Eone),V1n),c_2Eone_2Eone),V3t)) ) ) ) )).

fof(conj_thm_2Esptree_2Edomain__list__insert,conjecture,(
    ! [V0xs] :
      ( mem(V0xs,ty_2Elist_2Elist(ty_2Enum_2Enum))
     => ! [V1x] :
          ( mem(V1x,ty_2Enum_2Enum)
         => ! [V2t] :
              ( mem(V2t,ty_2Esptree_2Espt(ty_2Eone_2Eone))
             => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1x),ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),ap(ap(c_2Esptree_2Elist__insert,V0xs),V2t))))
              <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1x),ap(c_2Elist_2ELIST__TO__SET(ty_2Enum_2Enum),V0xs)))
                  | p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1x),ap(c_2Esptree_2Edomain(ty_2Eone_2Eone),V2t))) ) ) ) ) ) )).
