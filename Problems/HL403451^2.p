...
thf(conj_thm_2EEncode_2Eencode__blist__def__compute,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0e: $i] :
          ( ( mem @ V0e @ ( arr @ A_27b @ ( ty_2Elist_2Elist @ A_27a ) ) )
         => ! [V1l: $i] :
      ...
      & ! [V2m: tp__ty_2Enum_2Enum,V3e: $i] :
         ...
         => ! [V4l: $i] :
              ( ( mem @ V4l @ ( ty_2Elist_2Elist @ A_27b ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__blist @ A_27a @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) ) @ V3e ) @ V4l )
                = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ V3e @ ( ap @ ( c_2Elist_2EHD @ A_27b ) @ V4l ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__blist @ A_27a @ A_27b ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V2m ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V3e ) @ ( ap @ ( c_2Elist_2ETL @ A_27b ) @ V4l ) ) ) ) ) )
      & ! [V5m: tp__ty_2Enum_2Enum,V6e: $i] :
          ( ( mem @ V6e @ ( arr @ A_27b @ ( ty_2Elist_2Elist @ A_27a ) ) )
         => ! [V7l: $i] :
              ( ( mem @ V7l @ ( ty_2Elist_2Elist @ A_27b ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__blist @ A_27a @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V5m ) ) ) ) @ V6e ) @ V7l )
                = ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ ( ap @ V6e @ ( ap @ ( c_2Elist_2EHD @ A_27b ) @ V7l ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2EEncode_2Eencode__blist @ A_27a @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V5m ) ) ) ) @ V6e ) @ ( ap @ ( c_2Elist_2ETL @ A_27b ) @ V7l ) ) ) ) ) ) ) )).
