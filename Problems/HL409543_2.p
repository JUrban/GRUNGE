...
tff(lameq_f3260,axiom,(
    ! [V1n: tp__ty_2Enum_2Enum,V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
     => ! [V2m: tp__ty_2Enum_2Enum] : ap(f3260(V1n,V0p),inj__ty_2Enum_2Enum(V2m)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V1n))),ap(c_2Ebool_2E_7E,ap(V0p,inj__ty_2Enum_2Enum(V2m)))) ) )).

tff(lmtp_f3259,type,(
    f3259: $i > $i )).

tff(lamtp_f3259,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f3259,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f3259(V0p),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0p,inj__ty_2Enum_2Enum(V1n))),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f3260(V1n,V0p))) ) )).

tff(ax_thm_2Eutil__prob_2Eminimal__def,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Enum_2Enum,bool))
     => surj__ty_2Enum_2Enum(ap(c_2Eutil__prob_2Eminimal,V0p)) = surj__ty_2Enum_2Enum(ap(c_2Emin_2E_40(ty_2Enum_2Enum),f3259(V0p))) ) )).

tff(conj_thm_2Eutil__prob_2EMINIMAL__EXISTS0,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Eutil__prob_2EMINIMAL__EXISTS,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ( ? [V1n: tp__ty_2Enum_2Enum] : p(ap(V0P,inj__ty_2Enum_2Enum(V1n)))
