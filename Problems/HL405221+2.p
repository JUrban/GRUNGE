...
fof(conj_thm_2Ealist_2EALOOKUP__ALL__DISTINCT__MEM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2EALOOKUP__ALL__DISTINCT__PERM__same,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l1] :
             ...
             => ! [V1l2] :
                 ...
                 => ( ( p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l1)))
                      & p(ap(ap(c_2Esorting_2EPERM(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l1)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1l2)))
                      & ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),V0l1) = ap(c_2Elist_2ELIST__TO__SET(ty_2Epair_2Eprod(A_27a,A_27a)),V1l2) )
