...
thf(conj_thm_2Einteger_2EINT__DIVIDES__0,conjecture,
    ( ! [V0x: tp__ty_2Einteger_2Eint] :
        ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__divides @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
