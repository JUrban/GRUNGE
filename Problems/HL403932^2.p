...
thf(conj_thm_2Ellist_2ELTAKE__NIL__EQ__SOME,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1m: tp__ty_2Enum_2Enum] :
          ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( c_2Ellist_2ELNIL @ A_27a ) )
...
thf(conj_thm_2Ellist_2ELTAKE__LENGTH,conjecture,(
