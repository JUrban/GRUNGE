...
thf(thm_2EASCIInumbers_2ESUB__num__to__bin__string,conjecture,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0x @ ( c_2Elist_2ELENGTH @ tyop_2Estring_2Echar @ ( c_2EASCIInumbers_2Enum__to__bin__string @ V1n ) ) )
     => ( ( c_2Estring_2ESUB @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ tyop_2Enum_2Enum @ ( c_2EASCIInumbers_2Enum__to__bin__string @ V1n ) @ V0x ) )
        = ( c_2EASCIInumbers_2EHEX @ ( c_2Ebit_2EBITV @ V1n @ ( c_2Eprim__rec_2EPRE @ ( c_2Earithmetic_2E_2D @ ( c_2Elist_2ELENGTH @ tyop_2Estring_2Echar @ ( c_2EASCIInumbers_2Enum__to__bin__string @ V1n ) ) @ V0x ) ) ) ) ) ) )).
