...
fof(conj_thm_2EHolSmt_2Er027,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,bool)
         => ! [V1x] :
             ...
             => ! [V2y] :
                 ...
                 => ! [V3z] :
                      ( mem(V3z,A_27a)
                     => ( p(ap(ap(ap(c_2Ebool_2ECOND(bool),V0p),ap(ap(c_2Emin_2E_3D(A_27a),V1x),V2y)),ap(ap(c_2Emin_2E_3D(A_27a),V2y),V3z)))
                      <=> V2y = ap(ap(ap(c_2Ebool_2ECOND(A_27a),V0p),V1x),V3z) ) ) ) ) ) ) )).
