...
thf(f13320_0_2E0,type,(
    f13320_0_2E0: u )).

thf(f13320_0_2E2,type,(
    f13320_0_2E2: du > du > u )).

thf(f13320_0_2E4,type,(
    f13320_0_2E4: du > du > du > du > u )).

thf(f13320_1_2E0,type,(
    f13320_1_2E0: u )).

thf(f13320_1_2E4,type,(
    f13320_1_2E4: du > du > du > du > u )).

thf(f13322_0_2E0,type,(
    f13322_0_2E0: u )).

thf(f13322_0_2E2,type,(
    f13322_0_2E2: du > du > u )).

thf(f13322_0_2E4,type,(
    f13322_0_2E4: du > du > du > du > u )).

thf(f13322_1_2E0,type,(
    f13322_1_2E0: u )).

thf(f13322_1_2E4,type,(
...
thf(mono_2Ef13320_0,type,(
    mono_2Ef13320_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13320_1,type,(
    mono_2Ef13320_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).

thf(mono_2Ef13322_0,type,(
    mono_2Ef13322_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13322_1,type,(
    mono_2Ef13322_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ECOMPACT__CLOSED__SUMS,axiom,(
...
thf(def1_2Ethm_2Ereal__topology_2ECOMPACT__CLOSED__SUMS,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13322_0 @ V0s @ V1t @ V2x @ V3y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Erealax_2Ereal__add @ V2x @ V3y ) @ ( mono_2Ef13322_1 @ V2x @ V0s @ V3y @ V1t ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__COMPACT__SUMS,axiom,(
    ! [V2x: mono_2Etyop_2Erealax_2Ereal,V0s: mono_2Etyop_2Erealax_2Ereal > $o,V3y: mono_2Etyop_2Erealax_2Ereal,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef13320_1 @ V2x @ V0s @ V3y @ V1t )
    <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V2x @ V0s )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3y @ V1t ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECLOSED__COMPACT__SUMS,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o,V2x: mono_2Etyop_2Erealax_2Ereal,V3y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13320_0 @ V0s @ V1t @ V2x @ V3y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Erealax_2Ereal__add @ V2x @ V3y ) @ ( mono_2Ef13320_1 @ V2x @ V0s @ V3y @ V1t ) ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__COMPACT__SUMS,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1t: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
        & ( mono_2Ec_2Ereal__topology_2Ecompact @ V1t ) )
     => ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 @ ( mono_2Ec_2Epair_2EUNCURRY_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ef13320_0 @ V0s @ V1t ) ) ) ) ) )).
