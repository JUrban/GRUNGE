...
thf(thm_2Ereal__topology_2ESUMS__SYM,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ...
      = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
        @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
          @ ^ [V4y: tyop_2Erealax_2Ereal,V5x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__add @ V4y @ V5x ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V1t ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x @ V0s ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__ADD,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal,V2g: A_27a > tyop_2Erealax_2Ereal,V3l: tyop_2Erealax_2Ereal,V4m: tyop_2Erealax_2Ereal] :
     ...
     => ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a
        @ ^ [V5x: A_27a] :
            ( c_2Erealax_2Ereal__add @ ( V1f @ V5x ) @ ( V2g @ V5x ) )
...
thf(thm_2Ereal__topology_2ECLOSURE__SEQUENTIAL,axiom,(
    ...
    <=> ? [V2x: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
          ( ! [V3n: tyop_2Enum_2Enum] :
              ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V2x @ V3n ) @ V0s )
...
thf(thm_2Ereal__topology_2ELIM__SUBSEQUENCE,axiom,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1r: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V2l: tyop_2Erealax_2Ereal] :
      ( ( ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
            ( ( c_2Eprim__rec_2E_3C @ V3m @ V4n )
           => ( c_2Eprim__rec_2E_3C @ ( V1r @ V3m ) @ ( V1r @ V4n ) ) )
        & ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ V0s @ V2l @ c_2Ereal__topology_2Esequentially ) )
     => ( c_2Ereal__topology_2E_2D_2D_3E @ tyop_2Enum_2Enum @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ tyop_2Enum_2Enum @ V0s @ V1r ) @ V2l @ c_2Ereal__topology_2Esequentially ) ) )).
...
thf(thm_2Ereal__topology_2ECLOSURE__SUMS,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        ...
        = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
          @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
            @ ^ [V4x: tyop_2Erealax_2Ereal,V5y: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__add @ V4x @ V5y ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ ( c_2Ereal__topology_2Eclosure @ V0s ) ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5y @ ( c_2Ereal__topology_2Eclosure @ V1t ) ) ) ) ) ) ) ) )).
