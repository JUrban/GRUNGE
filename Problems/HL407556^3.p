...
thf(thm_2Ereal_2ENUM__FLOOR__EQNS,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum] :
      ( ( ( c_2Ereal_2ENUM__FLOOR @ ( c_2Ereal_2Ereal__of__num @ V0n ) )
        = V0n )
      & ( ( c_2Ereal_2ENUM__FLOOR @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2Ereal__of__num @ V0n ) ) )
        = c_2Enum_2E0 )
      & ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V1m )
       => ( ( c_2Ereal_2ENUM__FLOOR @ ( c_2Ereal_2E_2F @ ( c_2Ereal_2Ereal__of__num @ V0n ) @ ( c_2Ereal_2Ereal__of__num @ V1m ) ) )
          = ( c_2Earithmetic_2EDIV @ V0n @ V1m ) ) )
      & ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V1m )
       => ( ( c_2Ereal_2ENUM__FLOOR @ ( c_2Ereal_2E_2F @ ( c_2Erealax_2Ereal__neg @ ( c_2Ereal_2Ereal__of__num @ V0n ) ) @ ( c_2Ereal_2Ereal__of__num @ V1m ) ) )
          = c_2Enum_2E0 ) ) ) )).
