...
fof(lameq_f2295,axiom,(
    ! [V0v] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2295(V0v),V1i) = ap(ap(c_2Ebitstring_2Etestbit,V1i),V0v) ) ) )).
...
fof(ax_thm_2Ebitstring_2Ev2w__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
         => ap(c_2Ebitstring_2Ev2w(A_27a),V0v) = ap(c_2Efcp_2EFCP(bool,bool),f2295(V0v)) ) ) )).

fof(conj_thm_2Ebitstring_2Ebit__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
