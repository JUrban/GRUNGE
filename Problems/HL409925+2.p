...
fof(conj_thm_2Eextreal_2Einv__one,lemma,(
    ap(c_2Eextreal_2Eextreal__inv,ap(c_2Eextreal_2Eextreal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))) = ap(c_2Eextreal_2Eextreal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))) )).

fof(conj_thm_2Eextreal_2Ediv__one,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
