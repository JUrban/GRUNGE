...
fof(conj_thm_2Erelation_2Einv__O,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0R] :
                  ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
                 => ! [V1R_27] :
                      ( mem(V1R_27,arr(A_27c,arr(A_27a,bool)))
                     => ap(c_2Erelation_2Einv(A_27c,A_27c),ap(ap(c_2Erelation_2EO(A_27c,A_27c,A_27c),V0R),V1R_27)) = ap(ap(c_2Erelation_2EO(A_27b,A_27b,A_27b),ap(c_2Erelation_2Einv(A_27c,A_27c),V1R_27)),ap(c_2Erelation_2Einv(A_27a,A_27a),V0R)) ) ) ) ) ) )).
