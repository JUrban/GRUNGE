...
tff(lmtp_f836,type,(
    f836: ( del * del * del * del * $i ) > $i )).

tff(lamtp_f836,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,A_27b: del,V5v: $i] :
      ( mem(V5v,A_27a)
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__SUBSUMED,lemma,(
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROWS__DROP__SUBSUMED__PMATCH__ROWS,conjecture,(
