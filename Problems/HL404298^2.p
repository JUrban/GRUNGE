...
thf(tp_c_2Emergesort_2Emerge,type,(
    c_2Emergesort_2Emerge: del > $i )).

thf(mem_c_2Emergesort_2Emerge,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Emergesort_2Efilter__merge,lemma,(
    ! [A_27a: del,V0P: $i] :
         ...
         => ! [V2l1: $i] :
             ...
             => ! [V3l2: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V1R ) )
                   ...
                   => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2Emerge @ A_27a ) @ V1R ) @ V2l1 ) @ V3l2 ) )
                      = ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l1 ) @ V3l2 ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Emergesort_2Emerge__stable,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
