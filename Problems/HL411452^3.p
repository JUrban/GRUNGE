...
thf(thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__SUP,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o] :
     ...
     => ? [V2x: tyop_2Erealax_2Ereal] :
          ...
          & ! [V3y: tyop_2Erealax_2Ereal] :
             ...
             => ( c_2Ereal_2Ereal__lte @ ( V0f @ V3y ) @ ( V0f @ V2x ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EDISTANCE__ATTAINS__SUP,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal] :
     ...
     => ? [V2x: tyop_2Erealax_2Ereal] :
          ...
          & ! [V3y: tyop_2Erealax_2Ereal] :
             ...
             => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ V3y ) ) @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1a @ V2x ) ) ) ) ) ) )).
