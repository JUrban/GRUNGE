...
thf(conj_thm_2Ereal__topology_2ECONNECTED__SING,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ c_2Ereal__topology_2Econnected @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__SET,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ...
          = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2y: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2y )
                  @ ( ap @ ( c_2Ebool_2E_3F @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                    @ ( lam @ ( arr @ ty_2Erealax_2Ereal @ bool )
                      @ ^ [V3t: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ereal__topology_2Econnected @ V3t ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V3t ) @ V0s ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ V3t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2y ) @ V3t ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBIGUNION__COMPONENTS,conjecture,(
    ! [V0u: $i] :
      ( ( mem @ V0u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( V0u
