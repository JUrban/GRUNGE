...
tff(lamtp_f312,axiom,(
    ! [V6b: tp__ty_2Enum_2Enum,V4opr: $i] :
      ( mem(V4opr,arr(bool,arr(bool,bool)))
     => ! [V5a: tp__ty_2Enum_2Enum] : mem(f312(V6b,V4opr,V5a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
tff(lamtp_f313,axiom,(
    ! [V11b: tp__ty_2Enum_2Enum,V9opr: $i] :
      ( mem(V9opr,arr(bool,arr(bool,bool)))
     => ! [V10a: tp__ty_2Enum_2Enum] : mem(f313(V11b,V9opr,V10a),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).
...
tff(conj_thm_2Enumeral__bit_2EiBITWISE,lemma,
    ( ! [V0opr: $i] :
...
tff(conj_thm_2Enumeral__bit_2ENUMERAL__BITWISE,lemma,(
    ! [A_27a: del] :
...
tff(conj_thm_2Enumeral__bit_2Enumeral__ilog2,lemma,
...
tff(conj_thm_2Enumeral__bit_2Enumeral__log2,lemma,
...
tff(conj_thm_2Einteger_2EINT__LE__NEGR,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
tff(conj_thm_2Ewords_2Edimindex__1__cases,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Ewords_2EWORD__AND__CLAUSES,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
...
tff(conj_thm_2Ewords_2EWORD__LITERAL__AND,lemma,(
    ! [A_27a: del] :
...
tff(mem_c_2Einteger__word_2Esigned__saturate__sub,axiom,(
    ! [A_27a: del] : mem(c_2Einteger__word_2Esigned__saturate__sub(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(conj_thm_2Einteger__word_2EMULT__MINUS__ONE,lemma,(
...
tff(conj_thm_2Einteger__word_2Ew2i__1,lemma,(
...
tff(conj_thm_2Einteger__word_2Ei2w__minus__1,lemma,(
    ! [A_27a: del] : ap(c_2Einteger__word_2Ei2w(A_27a),ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) = ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).
...
tff(conj_thm_2Einteger__word_2Esaturate__i2sw__0,lemma,(
    ! [A_27a: del] : ap(c_2Einteger__word_2Esaturate__i2sw(A_27a),ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) )).

tff(conj_thm_2Einteger__word_2Esigned__saturate__sub,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1b: $i] :
          ( mem(V1b,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Einteger__word_2Esigned__saturate__sub(A_27a),V0a),V1b) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),V1b),c_2Ewords_2Eword__L(A_27a))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Ewords_2Eword__le(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0a)),c_2Ewords_2Eword__H(A_27a)),ap(ap(c_2Ewords_2Eword__add(A_27a),V0a),c_2Ewords_2Eword__L(A_27a)))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(ap(c_2Ewords_2Eword__and(A_27a),V0a),ap(c_2Ewords_2Eword__1comp(A_27a),V1b))),ap(ap(c_2Einteger__word_2Esigned__saturate__add(A_27a),V0a),ap(c_2Ewords_2Eword__2comp(A_27a),V1b)))) ) ) )).
