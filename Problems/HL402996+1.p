...
fof(thm_2EpatternMatches_2EPMATCH__ROW__NEQ__NONE,conjecture,(
    ...
    <=> p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__COND__EX_2E3(s(A_27c,V2i_2E0),s(tyop_2Emin_2Efun(A_27b,A_27c),V1p_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V3g_2E0)))) ) )).
