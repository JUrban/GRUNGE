...
tff(tp_c_2Efinite__map_2Efmap__EQ__UPTO,type,(
    c_2Efinite__map_2Efmap__EQ__UPTO: ( del * del ) > $i )).

tff(mem_c_2Efinite__map_2Efmap__EQ__UPTO,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),arr(arr(A_27a,bool),bool)))) )).
...
tff(ax_thm_2Efinite__map_2Efmap__EQ__UPTO__def,axiom,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2vs: $i] :
             ...
             => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),V0f1),V1f2),V2vs))
              <=> ( ap(ap(c_2Epred__set_2EINTER(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)),ap(c_2Epred__set_2ECOMPL(A_27a),V2vs)) = ap(ap(c_2Epred__set_2EINTER(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f2)),ap(c_2Epred__set_2ECOMPL(A_27a),V2vs))
                  & ! [V3x: $i] :
                      ( mem(V3x,A_27a)
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)),ap(c_2Epred__set_2ECOMPL(A_27a),V2vs))))
                       => ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0f1),V3x) = ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1f2),V3x) ) ) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2Efmap__EQ__UPTO______FUPDATE__BOTH______NO__DELETE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f1: $i] :
      ( mem(V0f1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1f2: $i] :
          ( mem(V1f2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2ks: $i] :
             ...
             => ! [V3k: $i] :
                 ...
                 => ! [V4v: $i] :
                      ( mem(V4v,A_27b)
                     => ( p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),V0f1),V1f2),V2ks))
                       => p(ap(ap(ap(c_2Efinite__map_2Efmap__EQ__UPTO(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f1),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k),V4v))),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1f2),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k),V4v))),V2ks)) ) ) ) ) ) ) )).
