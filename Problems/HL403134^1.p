...
thf(f3715_0_2E0,type,(
    f3715_0_2E0: u )).

thf(f3715_0_2E2,type,(
    f3715_0_2E2: du > du > u )).

thf(f3715_0_2E3,type,(
...
thf(mono_2Ef3715_0,type,(
    mono_2Ef3715_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EWHEN__EVENT,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3715_0 @ V1a @ V0b @ V2t )
    <=> ( ( V1a @ V2t )
        & ( V0b @ V2t ) ) ) )).

thf(thm_2ETemporal__Logic_2EWHEN__EVENT,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ V0b )
      = ( mono_2Ec_2ETemporal__Logic_2EWHEN @ ( mono_2Ef3715_0 @ V1a @ V0b ) @ V0b ) ) )).
