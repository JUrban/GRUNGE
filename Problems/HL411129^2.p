...
thf(conj_thm_2Ereal__topology_2ELIM__TRANSFORM__WITHIN,lemma,(
             ...
             => ! [V5d: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5d ) ) )
                    & ! [V6x_27: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1f @ ( inj__ty_2Erealax_2Ereal @ V6x_27 ) ) )
                          = ( surj__ty_2Erealax_2Ereal @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V6x_27 ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN,conjecture,(
    ! [V0f: $i] :
             ...
             => ! [V3x: tp__ty_2Erealax_2Ereal,V4d: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) )
                    ...
                    & ! [V5x_27: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) )
                          = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) ) ) )
                    & ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) @ V2s ) ) ) )
                 => ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal ) @ V1g ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) @ V2s ) ) ) ) ) ) ) )).
