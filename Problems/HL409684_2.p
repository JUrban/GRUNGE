...
tff(conj_thm_2Eiterate_2EITERATE__DELETE,conjecture,(
    ! [A_27a: del,A_27b: del,V0op: $i] :
           ...
           => ! [V2s: $i] :
               ...
               => ! [V3a: $i] :
                   ...
                   => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                     ...
                     => ap(ap(V0op,ap(V1f,V3a)),ap(ap(ap(c_2Eiterate_2Eiterate(A_27a,A_27a),V0op),ap(ap(c_2Epred__set_2EDELETE(A_27a),V2s),V3a)),V1f)) = ap(ap(ap(c_2Eiterate_2Eiterate(A_27a,A_27a),V0op),V2s),V1f) ) ) ) ) ) ) )).
