...
fof(mem_c_2Erich__list_2EUNZIP__SND,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Erich__list_2EUNZIP__SND(A_27a,A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27b,A_27b)),ty_2Elist_2Elist(A_27a))) ) ) )).

fof(ax_thm_2Erich__list_2EUNZIP__SND__DEF,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Erich__list_2ELENGTH__UNZIP__SND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0l] :
             ...
             => ap(c_2Elist_2ELENGTH(A_27b),ap(c_2Erich__list_2EUNZIP__SND(A_27b,A_27b),V0l)) = ap(c_2Elist_2ELENGTH(ty_2Epair_2Eprod(A_27a,A_27a)),V0l) ) ) ) )).
