...
fof(conj_thm_2EOmega_2Eevallower__ind,conjecture,(
    ! [V0P] :
     ...
     => ( ( ! [V1x] :
             ...
             => p(ap(ap(V0P,V1x),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )
          & ! [V2x] :
             ...
             => ! [V3c] :
                 ...
                 => ! [V4y] :
                     ...
                     => ! [V5cs] :
                          ( mem(V5cs,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                         => ( p(ap(ap(V0P,V2x),V5cs))
                           => p(ap(ap(V0P,V2x),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V3c),V4y)),V5cs))) ) ) ) ) ) )
       => ! [V6v] :
