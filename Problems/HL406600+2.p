...
fof(conj_thm_2Esptree_2EIN__domain,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1x] :
                 ...
                 => ! [V2t1] :
                     ...
                     => ! [V3t2] :
                         ...
                         => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0n),ap(c_2Esptree_2Edomain(A_27b),c_2Esptree_2ELN(A_27b))))
                            <=> $false )
                            & ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0n),ap(c_2Esptree_2Edomain(A_27a),ap(c_2Esptree_2ELS(A_27a),V1x))))
                            <=> V0n = c_2Enum_2E0 )
                            & ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0n),ap(c_2Esptree_2Edomain(A_27a),ap(ap(c_2Esptree_2EBN(A_27a),V2t1),V3t2))))
                            <=> ( V0n != c_2Enum_2E0
                                & p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(c_2Earithmetic_2EEVEN,V0n)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Esptree_2Edomain(A_27a),V2t1))),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Esptree_2Edomain(A_27a),V3t2)))) ) )
                            & ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V0n),ap(c_2Esptree_2Edomain(A_27a),ap(ap(ap(c_2Esptree_2EBS(A_27a),V2t1),V1x),V3t2))))
                            <=> ( V0n = c_2Enum_2E0
                                | p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(c_2Earithmetic_2EEVEN,V0n)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Esptree_2Edomain(A_27a),V2t1))),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,V0n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Esptree_2Edomain(A_27a),V3t2)))) ) ) ) ) ) ) ) ) ) )).
