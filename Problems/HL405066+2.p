...
fof(lameq_f933,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f933(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,V0a),V1b),V2t0)),ap(ap(c_2ETemporal__Logic_2EALWAYS,f893(V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__AS__SBEFORE,lemma,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(conj_thm_2EOmega__Automata_2EBEFORE__AS__CO__BUECHI,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
