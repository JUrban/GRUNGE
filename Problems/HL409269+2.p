...
fof(conj_thm_2Eintegral_2ESUP__INTERVAL,lemma,(
    ! [V0P] :
         ...
         => ! [V2b] :
             ...
             => ( ? [V3x] :
               ...
               => ? [V4s] :
                    ...
                    & p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V4s))
                    & p(ap(ap(c_2Ereal_2Ereal__lte,V4s),V2b))
                    & ! [V5y] :
...
fof(conj_thm_2Eintegral_2ECONT__UNIFORM,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
