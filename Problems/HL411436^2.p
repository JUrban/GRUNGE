...
thf(ax_thm_2Ereal__topology_2Econtinuous__on,axiom,(
    ! [V0f: $i] :
...
thf(ax_thm_2Ereal__topology_2Euniformly__continuous__on,axiom,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on @ V0f ) @ V1s ) )
          <=> ! [V2e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V3d: tp__ty_2Erealax_2Ereal] :
                    ...
                    & ! [V4x: tp__ty_2Erealax_2Ereal,V5x_27: tp__ty_2Erealax_2Ereal] :
                        ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) @ V1s ) )
                          & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ V1s ) )
                          & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) )
                       => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x_27 ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPACT__UNIFORMLY__EQUICONTINUOUS,lemma,(
    ! [V0fs: $i] :
      ( ( mem @ V0fs @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ! [V2x: tp__ty_2Erealax_2Ereal,V3e: tp__ty_2Erealax_2Ereal] :
                  ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ V1s ) )
                    & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) )
                 => ? [V4d: tp__ty_2Erealax_2Ereal] :
                      ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) )
                      & ! [V5f: $i] :
                         ...
                         => ! [V6x_27: tp__ty_2Erealax_2Ereal] :
                              ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ V5f ) @ V0fs ) )
                                & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V6x_27 ) ) @ V1s ) )
                                & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V6x_27 ) ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V4d ) ) ) )
                             => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V5f @ ( inj__ty_2Erealax_2Ereal @ V6x_27 ) ) ) @ ( ap @ V5f @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3e ) ) ) ) ) ) )
           ...
           => ! [V7e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V8d: tp__ty_2Erealax_2Ereal] :
                    ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V8d ) ) )
                    & ! [V9f: $i] :
                        ( ( mem @ V9f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                       => ! [V10x: tp__ty_2Erealax_2Ereal,V11x_27: tp__ty_2Erealax_2Ereal] :
                            ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) ) @ V9f ) @ V0fs ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) @ V1s ) )
                              & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V11x_27 ) ) @ V1s ) )
                              & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V11x_27 ) ) @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V8d ) ) ) )
                           => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ V9f @ ( inj__ty_2Erealax_2Ereal @ V11x_27 ) ) ) @ ( ap @ V9f @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V7e ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__UNIFORMLY__CONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
