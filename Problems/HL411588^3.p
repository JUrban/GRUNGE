...
thf(thm_2Ereal__topology_2ELIM__COMPONENT__UBOUND,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal,V2l: tyop_2Erealax_2Ereal,V3b: tyop_2Erealax_2Ereal,V4k: A_27b] :
      ( ( ( (~) @ ( c_2Ereal__topology_2Etrivial__limit @ A_27a @ V0net ) )
        & ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a @ V1f @ V2l @ V0net )
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V5x: A_27a] :
              ( c_2Ereal_2Ereal__lte @ ( V1f @ V5x ) @ V3b )
          @ V0net ) )
     => ( c_2Ereal_2Ereal__lte @ V2l @ V3b ) ) )).

thf(thm_2Ereal__topology_2ELIM__COMPONENT__LBOUND,axiom,(
    ! [A_27a: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal,V2l: tyop_2Erealax_2Ereal,V3b: tyop_2Erealax_2Ereal] :
      ( ( ( (~) @ ( c_2Ereal__topology_2Etrivial__limit @ A_27a @ V0net ) )
        ...
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V4x: A_27a] :
              ( c_2Ereal_2Ereal__lte @ V3b @ ( V1f @ V4x ) )
          @ V0net ) )
     => ( c_2Ereal_2Ereal__lte @ V3b @ V2l ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__COMPONENT__EQ,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0net: tyop_2Ereal__topology_2Enet @ A_27a,V1f: A_27a > tyop_2Erealax_2Ereal,V2i: A_27b,V3l: tyop_2Erealax_2Ereal,V4b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a @ V1f @ V3l @ V0net )
        & ( (~) @ ( c_2Ereal__topology_2Etrivial__limit @ A_27a @ V0net ) )
        & ( c_2Ereal__topology_2Eeventually @ A_27a
          @ ^ [V5x: A_27a] :
              ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( V1f @ V5x ) @ V4b )
          @ V0net ) )
     => ( V3l = V4b ) ) )).
