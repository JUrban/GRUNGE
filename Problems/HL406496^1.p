...
thf(f7576_0_2E0,type,(
    f7576_0_2E0: u )).

thf(f7576_0_2E3,type,(
    f7576_0_2E3: du > du > du > u )).

thf(f7582_0_2E0,type,(
    f7582_0_2E0: u )).

thf(f7582_0_2E2,type,(
    f7582_0_2E2: du > du > u )).

thf(f7582_0_2E3,type,(
    f7582_0_2E3: du > du > du > u )).

thf(f7587_0_2E0,type,(
    f7587_0_2E0: u )).

thf(f7587_0_2E1,type,(
    f7587_0_2E1: du > u )).

thf(f7587_0_2E2,type,(
    f7587_0_2E2: du > du > u )).

thf(f7616_0_2E0,type,(
    f7616_0_2E0: u )).

thf(f7616_0_2E3,type,(
    f7616_0_2E3: du > du > du > u )).

thf(f7616_0_2E4,type,(
...
thf(mono_2Ef7576_0,type,(
    mono_2Ef7576_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef7582_0,type,(
    mono_2Ef7582_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef7587_0,type,(
    mono_2Ef7587_0: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef7616_0,type,(
    mono_2Ef7616_0: ( $o > $o > $o ) > mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 > mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2EEL_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) @ c_2Elist_2EEL_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Ebitstring_2Ev2w__def,axiom,(
    ! [A_27a: d,V0v: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
      ...
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( mono_2Ef7587_0 @ V0v ) ) ) ) ) ) )).

thf(def0_2Ethm_2Ebitstring_2Ebitwise__def,axiom,(
    ! [V0f: $o > $o > $o,V1v1: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V2v2: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V3m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7616_0 @ V0f @ V1v1 @ V2v2 @ V3m )
...
thf(thm_2Ebitstring_2Ebitwise__def,axiom,(
    ! [V0f: $o > $o > $o,V1v1: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V2v2: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
      ...
      = ( mono_2Ec_2Ebool_2ELET_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29 @ ( mono_2Ef7616_0 @ V0f @ V1v1 @ V2v2 ) @ ( mono_2Ec_2Earithmetic_2EMAX @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Emin_2Ebool @ V1v1 ) @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Emin_2Ebool @ V2v2 ) ) ) ) )).
...
thf(thm_2Ebitstring_2Eel__fixwidth,axiom,(
    ! [V0i: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2w: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
     ...
     => ( ( mono_2Ec_2Elist_2EEL_2Emono_2Etyop_2Emin_2Ebool @ V0i @ ( mono_2Ec_2Ebitstring_2Efixwidth @ V1n @ V2w ) )
        = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Emin_2Ebool @ V2w ) @ V1n ) @ ( mono_2Ef7576_0 @ V1n @ V2w @ V0i ) @ ( mono_2Ec_2Elist_2EEL_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Earithmetic_2E_2B @ V0i @ ( mono_2Ec_2Earithmetic_2E_2D @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Emin_2Ebool @ V2w ) @ V1n ) ) @ V2w ) ) ) ) )).

thf(def0_2Ethm_2Ebitstring_2Etestbit,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum,V1v: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7582_0 @ V0b @ V1v @ V2n )
...
thf(thm_2Ebitstring_2Etestbit,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum,V1v: mono_2Etyop_2Elist_2Elist_28tyop_2Emin_2Ebool_29] :
      ...
      = ( mono_2Ec_2Ebool_2ELET_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef7582_0 @ V0b @ V1v ) @ ( mono_2Ec_2Elist_2ELENGTH_2Emono_2Etyop_2Emin_2Ebool @ V1v ) ) ) )).
...
thf(thm_2Elist_2EEL__ZIP,axiom,(
    ! [A_27a: d,A_27b: d,V0l1_2E0: u,V1l2_2E0: u,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) )
          = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V1l2_2E0 ) ) ) ) )
     ...
     => ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EZIP_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Elist_2Elist @ A_27b ) ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V1l2_2E0 ) ) ) ) ) ) )
        = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) @ ( s @ A_27b @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V1l2_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Ebitstring_2Eword__or__v2w,conjecture,(
