...
tff(conj_thm_2Emeasure_2EMEASURABLE__RANGE__REDUCE,lemma,(
...
tff(conj_thm_2Emeasure_2EMEASURABLE__POW__TO__POW,lemma,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
...
tff(conj_thm_2Emeasure_2EMEASURABLE__POW__TO__POW__IMAGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
