...
fof(conj_thm_2EOmega_2Edark__shadow__row__ind,conjecture,(
    ! [V0P] :
     ...
     => ( ( ! [V1c] :
             ...
             => ! [V2L] :
                 ...
                 => p(ap(ap(ap(V0P,V1c),V2L),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))) ) )
          & ! [V3c] :
                     ...
                     => ! [V6R] :
                         ...
                         => ! [V7rs] :
                             ...
                             => ( p(ap(ap(ap(V0P,V3c),V4L),V7rs))
                               => p(ap(ap(ap(V0P,V3c),V4L),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V5d),V6R)),V7rs))) ) ) ) ) ) ) )
       => ! [V8v] :
