...
thf(f3709_0_2E0,type,(
    f3709_0_2E0: u )).

thf(f3709_0_2E1,type,(
    f3709_0_2E1: du > u )).

thf(f3709_1_2E0,type,(
    f3709_1_2E0: u )).

thf(f3709_1_2E1,type,(
    f3709_1_2E1: du > u )).

thf(f3709_1_2E2,type,(
    f3709_1_2E2: du > du > u )).

thf(f3709_2_2E0,type,(
    f3709_2_2E0: u )).

thf(f3709_2_2E1,type,(
    f3709_2_2E1: du > u )).

thf(f3709_3_2E0,type,(
    f3709_3_2E0: u )).

thf(f3709_3_2E1,type,(
    f3709_3_2E1: du > u )).

thf(f3709_4_2E0,type,(
    f3709_4_2E0: u )).

thf(f3709_4_2E1,type,(
    f3709_4_2E1: du > u )).
...
thf(mono_2Ef3709_0,type,(
    mono_2Ef3709_0: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3709_1,type,(
    mono_2Ef3709_1: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3709_2,type,(
    mono_2Ef3709_2: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3709_3,type,(
    mono_2Ef3709_3: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3709_4,type,(
    mono_2Ef3709_4: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
    ! [V9t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3709_4 @ V9t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
    ! [V5t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3709_2 @ V5t )
      = mono_2Ec_2Ebool_2ET ) )).

thf(def2_2Ethm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
    ! [V7t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3709_3 @ V7t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def3_2Ethm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
    ! [V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3709_0 @ V2t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def4_2Ethm_2ETemporal__Logic_2EWHEN__SIMP,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3709_1 @ V0b @ V3t )
    <=> ( (~) @ ( V0b @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2EWHEN__SIMP,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ mono_2Ef3709_0 @ V0b )
        = ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ ( mono_2Ef3709_1 @ V0b ) ) )
      & ! [V4x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ mono_2Ef3709_2 @ V0b @ V4x )
          = mono_2Ec_2Ebool_2ET )
      & ! [V6x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ mono_2Ef3709_3 @ V6x )
          = mono_2Ec_2Ebool_2ET )
      & ! [V8x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ mono_2Ef3709_4 @ V8x )
          = ( V1a @ V8x ) )
      & ! [V10x: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V1a @ V1a @ V10x )
          = mono_2Ec_2Ebool_2ET ) ) )).
