...
thf(conj_thm_2Eproduct_2EPRODUCT__DIV,lemma,(
    ! [A_27a: del,V0f: $i] :
             ...
             => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V2s ) )
               => ( ( surj__ty_2Erealax_2Ereal
                    @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2s )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2s ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ A_27a ) @ V2s ) @ V1g ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eproduct_2EPRODUCT__DIV__NUMSEG,conjecture,(
    ! [V0f: $i] :
         ...
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
              ( ( surj__ty_2Erealax_2Ereal
                @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4x: $i] :
                        ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ V0f @ V4x ) ) @ ( ap @ V1g @ V4x ) ) ) ) )
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eproduct_2Eproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V1g ) ) ) ) ) ) )).
