...
tff(conj_thm_2Epred__set_2ECROSS__SUBSET,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27b,bool))
...
tff(conj_thm_2Epred__set_2EPREIMAGE__CROSS,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
...
tff(conj_thm_2Eutil__prob_2EIN__PROD__SETS,lemma,(
...
tff(conj_thm_2Emeasure_2EMEASURABLE__SIGMA,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1a: $i] :
...
tff(conj_thm_2Emeasure_2EMEASURABLE__PROD__SIGMA,conjecture,(
