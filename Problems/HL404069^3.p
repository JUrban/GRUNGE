...
thf(thm_2ETemporal__Logic_2EALWAYS__FIX,axiom,(
    ! [V0y: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ( ( V0y
        = ( ^ [V2t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( V1a @ V2t ) @ ( V0y @ ( c_2Earithmetic_2E_2B @ V2t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
    <=> ( ( V0y
          = ( c_2ETemporal__Logic_2EALWAYS @ V1a ) )
        | ( V0y
          = ( ^ [V3t: tyop_2Enum_2Enum] : c_2Ebool_2EF ) ) ) ) )).

thf(thm_2ETemporal__Logic_2EEVENTUAL__FIX,axiom,(
    ! [V0y: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o] :
      ( ( V0y
        = ( ^ [V2t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_5C_2F @ ( V1a @ V2t ) @ ( V0y @ ( c_2Earithmetic_2E_2B @ V2t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
    <=> ( ( V0y
...
thf(thm_2ETemporal__Logic_2EUNTIL__FIX,axiom,(
    ! [V0y: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( V0y
        = ( ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2E_7E @ ( V1b @ V3t ) ) @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V3t ) @ ( V0y @ ( c_2Earithmetic_2E_2B @ V3t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
    <=> ( ( V0y
          = ( c_2ETemporal__Logic_2EUNTIL @ V2a @ V1b ) )
        | ( V0y
          = ( c_2ETemporal__Logic_2ESUNTIL @ V2a @ V1b ) ) ) ) )).

thf(thm_2ETemporal__Logic_2EBEFORE__FIX,axiom,(
    ! [V0b: tyop_2Enum_2Enum > $o,V1a: tyop_2Enum_2Enum > $o,V2y: tyop_2Enum_2Enum > $o] :
      ( ( V2y
        = ( ^ [V3t: tyop_2Enum_2Enum] :
              ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V0b @ V3t ) ) @ ( c_2Ebool_2E_5C_2F @ ( V1a @ V3t ) @ ( V2y @ ( c_2Earithmetic_2E_2B @ V3t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
    <=> ( ( V2y
...
thf(thm_2EPast__Temporal__Logic_2EFIXPOINTS,conjecture,(
    ! [V0y: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > $o,V2a: tyop_2Enum_2Enum > $o] :
      ( ( ( V0y
          = ( ^ [V3t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( V2a @ V3t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0y @ V3t ) ) ) )
      <=> ( ( V0y
      ...
      & ( ( V0y
          = ( ^ [V5t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( V2a @ V5t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0y @ V5t ) ) ) )
      <=> ( ( V0y
      ...
      & ( ( V0y
          = ( ^ [V7t: tyop_2Enum_2Enum] :
                ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2E_7E @ ( V1b @ V7t ) ) @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V7t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0y @ V7t ) ) ) ) )
      <=> ( ( V0y
            = ( c_2ETemporal__Logic_2EUNTIL @ V2a @ V1b ) )
          | ( V0y
            = ( c_2ETemporal__Logic_2ESUNTIL @ V2a @ V1b ) ) ) )
      & ( ( V0y
          = ( ^ [V8t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2ECOND @ $o @ ( V1b @ V8t ) @ ( V2a @ V8t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0y @ V8t ) ) ) )
      <=> ( ( V0y
            = ( c_2ETemporal__Logic_2EWHEN @ V2a @ V1b ) )
          | ( V0y
            = ( c_2ETemporal__Logic_2ESWHEN @ V2a @ V1b ) ) ) )
      & ( ( V0y
          = ( ^ [V9t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1b @ V9t ) ) @ ( c_2Ebool_2E_5C_2F @ ( V2a @ V9t ) @ ( c_2ETemporal__Logic_2ENEXT @ V0y @ V9t ) ) ) ) )
      <=> ( ( V0y
      ...
      & ( ( V0y
          = ( ^ [V10t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( V2a @ V10t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0y @ V10t ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPALWAYS @ V2a ) ) )
      & ( ( V0y
          = ( ^ [V11t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( V2a @ V11t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V0y @ V11t ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPEVENTUAL @ V2a ) ) )
      & ( ( V0y
          = ( ^ [V12t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( V1b @ V12t ) @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V12t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V0y @ V12t ) ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPSUNTIL @ V2a @ V1b ) ) )
      & ( ( V0y
          = ( ^ [V13t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V13t ) @ ( V1b @ V13t ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1b @ V13t ) ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V0y @ V13t ) ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPSWHEN @ V2a @ V1b ) ) )
      & ( ( V0y
          = ( ^ [V14t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1b @ V14t ) ) @ ( c_2Ebool_2E_5C_2F @ ( V2a @ V14t ) @ ( c_2EPast__Temporal__Logic_2EPSNEXT @ V0y @ V14t ) ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPSBEFORE @ V2a @ V1b ) ) )
      & ( ( V0y
          = ( ^ [V15t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( V1b @ V15t ) @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V15t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0y @ V15t ) ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPUNTIL @ V2a @ V1b ) ) )
      & ( ( V0y
          = ( ^ [V16t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( V2a @ V16t ) @ ( V1b @ V16t ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1b @ V16t ) ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0y @ V16t ) ) ) ) )
      <=> ( V0y
          = ( c_2EPast__Temporal__Logic_2EPWHEN @ V2a @ V1b ) ) )
      & ( ( V0y
          = ( ^ [V17t: tyop_2Enum_2Enum] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2E_7E @ ( V1b @ V17t ) ) @ ( c_2Ebool_2E_5C_2F @ ( V2a @ V17t ) @ ( c_2EPast__Temporal__Logic_2EPNEXT @ V0y @ V17t ) ) ) ) )
      <=> ( V0y
