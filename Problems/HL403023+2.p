...
fof(conj_thm_2EindexedLists_2EGENLIST__CONG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1f1] :
             ...
             => ! [V2f2] :
                 ...
                 => ( ! [V3m] :
                       ...
                       => ( p(ap(ap(c_2Eprim__rec_2E_3C,V3m),V0n))
                         => ap(V1f1,V3m) = ap(V2f2,V3m) ) )
                   => ap(ap(c_2Elist_2EGENLIST(A_27a),V1f1),V0n) = ap(ap(c_2Elist_2EGENLIST(A_27a),V2f2),V0n) ) ) ) ) ) )).
