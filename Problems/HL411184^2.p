...
thf(conj_thm_2Ereal__topology_2ELINEAR__UNIFORMLY__CONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
...
thf(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__VMUL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ! [V2v: tp__ty_2Erealax_2Ereal] :
              ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on @ V1c ) @ V0s ) )
             => ( p
                @ ( ap
                  @ ( ap @ c_2Ereal__topology_2Euniformly__continuous__on
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1c @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V2v ) ) ) )
                  @ V0s ) ) ) ) ) )).
