...
fof(lamtp_f210,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,arr(A_27a,bool))))
     => mem(f210(A_27a,V0f),arr(ty_2Enum_2Enum,arr(A_27a,bool))) ) )).
...
fof(lameq_f210,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1n] :
         ...
         => ap(f210(A_27a,V0f),V1n) = ap(ap(V0f,ap(c_2Eind__type_2ENUMFST,V1n)),ap(c_2Eind__type_2ENUMSND,V1n)) ) ) )).
...
fof(conj_thm_2Eind__type_2EINJF__INJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f1] :
