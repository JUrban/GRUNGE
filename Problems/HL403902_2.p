...
tff(conj_thm_2Ellist_2Elnth__some__down__closed,conjecture,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2n1: tp__ty_2Enum_2Enum,V3n2: tp__ty_2Enum_2Enum] :
              ( ( ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V2n1)),V0ll) = ap(c_2Eoption_2ESOME(A_27a),V1x)
                & p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3n2)),inj__ty_2Enum_2Enum(V2n1))) )
             => ? [V4y: $i] :
                  ( mem(V4y,A_27a)
                  & ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V3n2)),V0ll) = ap(c_2Eoption_2ESOME(A_27a),V4y) ) ) ) ) )).
