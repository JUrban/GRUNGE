...
thf(f8136_0_2E0,type,(
    f8136_0_2E0: u )).

thf(f8136_0_2E2,type,(
    f8136_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef8136_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f8136_0_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f8136_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efmapal_2EFAPPLY__fmap__CONS,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f8136_0_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V0x_2E0 )
        = ( s @ A_27a @ V1y_2E0 ) ) ) )).

thf(thm_2Efmapal_2EFAPPLY__fmap__CONS,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1y_2E0: u,V2z_2E0: u,V3l_2E0: u] :
      ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efmapal_2Efmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1y_2E0 ) @ ( s @ A_27b @ V2z_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V3l_2E0 ) ) ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
      = ( s @ A_27b @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f8136_0_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ A_27a @ V1y_2E0 ) ) ) @ ( s @ A_27b @ V2z_2E0 ) @ ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efmapal_2Efmap_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V3l_2E0 ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) ) ) ) ) )).
