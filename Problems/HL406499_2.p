...
tff(lamtp_f2301,axiom,(
    ! [V0x: tp__o] : mem(f2301(V0x),arr(bool,bool)) )).

tff(lameq_f2301,axiom,(
    ! [V0x: tp__o,V1y: tp__o] : ap(f2301(V0x),inj__o(V1y)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,inj__o(V0x)),inj__o(V1y))) )).

tff(lmtp_f2300,type,(
    f2300: $i )).

tff(lamtp_f2300,axiom,(
    mem(f2300,arr(bool,arr(bool,bool))) )).

tff(lameq_f2300,axiom,(
    ! [V0x: tp__o] : ap(f2300,inj__o(V0x)) = f2301(V0x) )).
...
tff(conj_thm_2Ebitstring_2Eword__nor__v2w,conjecture,(
