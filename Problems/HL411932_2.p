...
tff(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__LEFT__INVERSE,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ELINEAR__CONTINUOUS__ON,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__LOCALLY,lemma,(
    ! [V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__INJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(arr(ty_2Erealax_2Ereal,bool),bool))
               ...
               => ! [V3s: $i] :
                   ...
                   => ( ( p(ap(c_2Ereal__topology_2Elinear,V2f))
                        & ! [V4x: tp__ty_2Erealax_2Ereal,V5y: tp__ty_2Erealax_2Ereal] :
                            ( surj__ty_2Erealax_2Ereal(ap(V2f,inj__ty_2Erealax_2Ereal(V4x))) = surj__ty_2Erealax_2Ereal(ap(V2f,inj__ty_2Erealax_2Ereal(V5y)))
                           => V4x = V5y ) )
               ...
               => ! [V7s: $i] :
                   ...
                   => ( ( p(ap(c_2Ereal__topology_2Elinear,V6f))
                        & ! [V8x: tp__ty_2Erealax_2Ereal,V9y: tp__ty_2Erealax_2Ereal] :
                            ( surj__ty_2Erealax_2Ereal(ap(V6f,inj__ty_2Erealax_2Ereal(V8x))) = surj__ty_2Erealax_2Ereal(ap(V6f,inj__ty_2Erealax_2Ereal(V9y)))
                           => V8x = V9y ) )
