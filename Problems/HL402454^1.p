...
thf(f2829_0_2E0,type,(
    f2829_0_2E0: u )).

thf(f2829_0_2E1,type,(
    f2829_0_2E1: du > u )).
...
thf(c_2EerrorStateMonad_2EES__CHOICE_2E0,type,(
    c_2EerrorStateMonad_2EES__CHOICE_2E0: u )).

thf(c_2EerrorStateMonad_2EES__CHOICE_2E2,type,(
    c_2EerrorStateMonad_2EES__CHOICE_2E2: du > du > u )).

thf(c_2EerrorStateMonad_2EES__CHOICE_2E3,type,(
...
thf(arityeq1_2Emono_2Ef2829_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f2829_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f2829_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2EerrorStateMonad_2EES__CHOICE_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( c_2EerrorStateMonad_2EES__CHOICE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ec_2EerrorStateMonad_2EES__CHOICE_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2EerrorStateMonad_2EES__CHOICE_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X1_2E0 ) @ ( s @ A_27b @ X2_2E0 ) ) )
...
thf(def0_2Ethm_2EerrorStateMonad_2EES__CHOICE__DEF,axiom,(
    ! [A_27a: d,V3v1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f2829_0_2E1 @ ( s @ A_27a @ V3v1_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V3v1_2E0 ) ) ) ) )).

thf(thm_2EerrorStateMonad_2EES__CHOICE__DEF,axiom,(
    ! [A_27a: d,A_27b: d,V0xM_2E0: u,V1yM_2E0: u,V2s_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2EerrorStateMonad_2EES__CHOICE_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0xM_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V1yM_2E0 ) @ ( s @ A_27b @ V2s_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0xM_2E0 ) @ ( s @ A_27b @ V2s_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V1yM_2E0 ) @ ( s @ A_27b @ V2s_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f2829_0_2E0 ) ) ) ) )).
...
thf(thm_2EerrorStateMonad_2EES__CHOICE__FAIL__RID,conjecture,(
    ! [A_27a: d,A_27b: d,V0xM_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ ( c_2EerrorStateMonad_2EES__CHOICE_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ V0xM_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ c_2EerrorStateMonad_2EES__FAIL_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ V0xM_2E0 ) ) )).
