...
fof(conj_thm_2Epred__set_2EPREIMAGE__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2EPROB__ADDITIVE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             ...
             => ! [V2t] :
                 ...
                 => ! [V3u] :
                     ...
                     => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                       ...
                       => ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V3u) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2t)) ) ) ) ) ) ) )).

fof(lamtp_f4243,axiom,(
    ! [A_27c,A_27b,A_27a,V1X] :
      ( mem(V1X,arr(A_27a,A_27b))
     => ! [V2Y] :
          ( mem(V2Y,arr(A_27a,A_27c))
         => mem(f4243(A_27c,A_27b,A_27a,V1X,V2Y),arr(A_27a,ty_2Epair_2Eprod(A_27b,A_27b))) ) ) )).

fof(lameq_f4243,axiom,(
    ! [A_27c,A_27b,A_27a,V1X] :
      ( mem(V1X,arr(A_27a,A_27b))
     => ! [V2Y] :
          ( mem(V2Y,arr(A_27a,A_27c))
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f4243(A_27c,A_27b,A_27a,V1X,V2Y),V4x) = ap(ap(c_2Epair_2E_2C(A_27b,A_27b),ap(V1X,V4x)),ap(V2Y,V4x)) ) ) ) )).

fof(lamtp_f4242,axiom,(
    ! [A_27a,A_27c,A_27b,V2Y] :
      ( mem(V2Y,arr(A_27a,A_27c))
     => ! [V1X] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V0p] :
              ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
             => mem(f4242(A_27a,A_27c,A_27b,V2Y,V1X,V0p),arr(arr(ty_2Epair_2Eprod(A_27b,A_27b),bool),ty_2Erealax_2Ereal)) ) ) ) )).

fof(lameq_f4242,axiom,(
    ! [A_27a,A_27c,A_27b,V2Y] :
      ( mem(V2Y,arr(A_27a,A_27c))
     => ! [V1X] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V0p] :
             ...
             => ! [V3a] :
                 ...
                 => ap(f4242(A_27a,A_27c,A_27b,V2Y,V1X,V0p),V3a) = ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINTER(A_27a),ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),f4243(A_27c,A_27b,A_27a,V1X,V2Y)),V3a)),ap(c_2Eprobability_2Ep__space(A_27a),V0p))) ) ) ) ) )).

fof(conj_thm_2Eprobability_2Efinite__marginal__product__space__POW,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [A_27c] :
             ...
             => ! [V0p] :
                 ...
                 => ! [V1X] :
                     ...
                     => ! [V2Y] :
                          ( mem(V2Y,arr(A_27a,A_27c))
                         => ( ( ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) = ap(c_2Eprobability_2Eevents(A_27a),V0p)
                              & p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V1X),V0p),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))),ap(c_2Epred__set_2EPOW(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))))))
                              & p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V2Y),V0p),ap(ap(c_2Epair_2E_2C(arr(A_27c,bool),arr(A_27c,bool)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2Y),ap(c_2Eprobability_2Ep__space(A_27a),V0p))),ap(c_2Epred__set_2EPOW(A_27c),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2Y),ap(c_2Eprobability_2Ep__space(A_27a),V0p))))))
                              & p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p))) )
                           => p(ap(c_2Emeasure_2Emeasure__space(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epair_2E_2C(arr(ty_2Epair_2Eprod(A_27b,A_27b),bool),arr(ty_2Epair_2Eprod(A_27b,A_27b),bool)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2Y),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))),ap(ap(c_2Epair_2E_2C(arr(arr(ty_2Epair_2Eprod(A_27b,A_27b),bool),bool),arr(arr(ty_2Epair_2Eprod(A_27b,A_27b),bool),bool)),ap(c_2Epred__set_2EPOW(ty_2Epair_2Eprod(A_27b,A_27b)),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p))),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2Y),ap(c_2Eprobability_2Ep__space(A_27a),V0p))))),f4242(A_27a,A_27c,A_27b,V2Y,V1X,V0p))))) ) ) ) ) ) ) ) )).
