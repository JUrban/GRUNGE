...
thf(c_2Ecardinal_2E_2B__c_2E0,type,(
    c_2Ecardinal_2E_2B__c_2E0: u )).

thf(c_2Ecardinal_2E_2B__c_2E2,type,(
    c_2Ecardinal_2E_2B__c_2E2: du > du > u )).
...
thf(c_2Esum_2EOUTR_2E0,type,(
    c_2Esum_2EOUTR_2E0: u )).

thf(c_2Esum_2EOUTR_2E1,type,(
...
thf(arityeq2_2Emono_2Ec_2Ecardinal_2E_2B__c_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2E_2B__c_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ec_2Epred__set_2ECROSS_2E2_2Emono_2EA_27a_20mono_2Etyop_2Esum_2Esum_28A_27b_2CA_27c_29,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2ECROSS_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) ) @ tyop_2Emin_2Ebool ) ) ) @ c_2Epred__set_2ECROSS_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ebool_2EIN_2E2_2Emono_2Etyop_2Esum_2Esum_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(arityeq1_2Emono_2Ec_2Esum_2EOUTR_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ A_27b @ ( c_2Esum_2EOUTR_2E1 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ A_27b ) @ c_2Esum_2EOUTR_2E0 ) @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Ecardinal_2Ecardeq_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2Ctyop_2Esum_2Esum_28A_27b_2CA_27c_29_29_20mono_2Etyop_2Esum_2Esum_28tyop_2Epair_2Eprod_28A_27a_2CA_27b_29_2Ctyop_2Epair_2Eprod_28A_27a_2CA_27c_29_29,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ecardinal_2Ecardeq_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) ) @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(thm_2Ecardinal_2EIN__CARD__ADD,axiom,(
    ! [A_27a: d,A_27b: d,V0t_2E0: u,V1s_2E0: u] :
      ( ! [V2x_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2E_2B__c_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V0t_2E0 ) ) ) ) ) )
      ...
      & ! [V3y_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V3y_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2E_2B__c_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V0t_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27b @ V3y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V0t_2E0 ) ) ) ) ) ) )).

thf(thm_2Ecardinal_2EIN__CARD__MUL,axiom,(
...
thf(thm_2Epair_2Epair__Axiom,axiom,(
    ...
    ? [V1fn_2E0: u] :
    ! [V2x_2E0: u,V3y_2E0: u] :
      ( ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27c ) @ V1fn_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27b @ V3y_2E0 ) ) ) ) )
      = ( s @ A_27c @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27c ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ A_27b @ V3y_2E0 ) ) ) ) )).
...
thf(thm_2Esum_2EINL__11,axiom,(
    ! [A_27a: d,A_27b: d,V0y_2E0: u,V1x_2E0: u] :
...
thf(thm_2Esum_2EINR__11,axiom,(
    ! [A_27a: d,A_27b: d,V0y_2E0: u,V1x_2E0: u] :
      ( ( ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V1x_2E0 ) ) )
        = ( s @ ( tyop_2Esum_2Esum @ A_27a @ A_27b ) @ ( c_2Esum_2EINR_2E1 @ ( s @ A_27b @ V0y_2E0 ) ) ) )
    <=> ( ( s @ A_27b @ V1x_2E0 )
        = ( s @ A_27b @ V0y_2E0 ) ) ) )).
