...
tff(lamtp_f3841,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3841(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3841,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3841(A_27a,V1f),V3x) = ap(V1f,V3x) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__COMPONENT__COMPOSE,lemma,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2i: $i] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V1f),V0net))
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3841(A_27a,V1f)),V0net)) ) ) ) ) )).

tff(lmtp_f3842,type,(
    f3842: $i > $i )).

tff(lamtp_f3842,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3842(V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3842,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3842(V0f),inj__ty_2Erealax_2Ereal(V2x)) = ap(V0f,inj__ty_2Erealax_2Ereal(V2x)) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPONENT__COMPOSE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3842(V0f)),V1s)) ) ) ) )).
