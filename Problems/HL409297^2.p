...
thf(conj_thm_2Elift__ieee_2Eis__finite__closest,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p
          @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27a @ A_27b )
            @ ( ap
              @ ( ap @ ( ap @ ( c_2Ebinary__ieee_2Eclosest__such @ A_27a @ A_27b ) @ V0p )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) )
                  @ ( lam @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b )
                    @ ^ [V2a: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ bool ) @ V2a ) @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27a @ A_27b ) @ V2a ) ) ) ) )
              @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) ) )).
...
thf(conj_thm_2Elift__ieee_2Efloat__round__finite,conjecture,(
    ! [A_27t: del,A_27w: del,V0b: $o,V1x: tp__ty_2Erealax_2Ereal] :
