...
thf(c_2Eseq_2Emono__decreasing_2E0,type,(
    c_2Eseq_2Emono__decreasing_2E0: u )).

thf(c_2Eseq_2Emono__decreasing_2E1,type,(
    c_2Eseq_2Emono__decreasing_2E1: du > u )).
...
thf(mono_2Ec_2Eseq_2Emono__decreasing,type,(
    mono_2Ec_2Eseq_2Emono__decreasing: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > $o )).
...
thf(thm_2Eseq_2Emono__decreasing__def,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Emono__decreasing @ V0f )
    <=> ! [V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V1m @ V2n )
         => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V2n ) @ ( V0f @ V1m ) ) ) ) )).

thf(thm_2Eseq_2Emono__decreasing__suc,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Emono__decreasing @ V0f )
    <=> ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) @ ( V0f @ V1n ) ) ) )).
