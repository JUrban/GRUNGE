...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__ALL__MEASURE,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Eextreal_2Eextreal,V1m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V0f @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) ) @ c_2Emeasure_2EBorel ) )
     => ( ! [V2c: tyop_2Eextreal_2Eextreal] :
            ( c_2Ebool_2EIN @ ( A_27a > $o )
            @ ( c_2Epred__set_2EINTER @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V3x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V3x @ ( c_2Eextreal_2Eextreal__lt @ ( V0f @ V3x ) @ V2c ) ) )
              @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) )
            @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) )
        & ! [V4c: tyop_2Eextreal_2Eextreal] :
            ( c_2Ebool_2EIN @ ( A_27a > $o )
            @ ( c_2Epred__set_2EINTER @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
        ...
        & ! [V22c: tyop_2Eextreal_2Eextreal] :
            ...
            @ ( c_2Epred__set_2EINTER @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V23x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V23x @ ( c_2Emin_2E_3D @ tyop_2Eextreal_2Eextreal @ ( V0f @ V23x ) @ V22c ) ) )
              @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) )
            @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) )
        & ! [V24c: tyop_2Eextreal_2Eextreal] :
            ( c_2Ebool_2EIN @ ( A_27a > $o )
            @ ( c_2Epred__set_2EINTER @ A_27a
              @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
                @ ^ [V25x: A_27a] :
                    ( c_2Epair_2E_2C @ A_27a @ $o @ V25x @ ( c_2Ebool_2E_7E @ ( c_2Emin_2E_3D @ tyop_2Eextreal_2Eextreal @ ( V0f @ V25x ) @ V24c ) ) ) )
              @ ( c_2Emeasure_2Em__space @ A_27a @ V1m ) )
            @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V1m ) ) ) ) )).
