...
tff(conj_thm_2Eintegral_2ELT__LE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
    <=> ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
        & V0m != V1n ) ) )).

tff(conj_thm_2Eintegral_2Enum__MAX,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ? [V1x: tp__ty_2Enum_2Enum] : p(ap(V0P,inj__ty_2Enum_2Enum(V1x)))
          & ? [V2M: tp__ty_2Enum_2Enum] :
            ! [V3x: tp__ty_2Enum_2Enum] :
             ...
             => p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3x)),inj__ty_2Enum_2Enum(V2M))) ) )
      <=> ? [V4m: tp__ty_2Enum_2Enum] :
            ( p(ap(V0P,inj__ty_2Enum_2Enum(V4m)))
            & ! [V5x: tp__ty_2Enum_2Enum] :
                ( p(ap(V0P,inj__ty_2Enum_2Enum(V5x)))
               => p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V5x)),inj__ty_2Enum_2Enum(V4m))) ) ) ) ) )).

tff(conj_thm_2Eintegral_2EDIVISION__INTERMEDIATE,conjecture,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
         ...
         => ? [V4n: tp__ty_2Enum_2Enum] :
              ...
              & p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0d,inj__ty_2Enum_2Enum(V4n))),inj__ty_2Erealax_2Ereal(V3c)))
              & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3c)),ap(V0d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V4n))))) ) ) ) )).
