...
thf(conj_thm_2Ewellorder_2Ewo2wo__mono,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
...
thf(conj_thm_2Ewellorder_2Ewo2wo__ONTO,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1w1: $i] :
          ( ( mem @ V1w1 @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
             ...
             => ! [V3y: $i] :
                 ...
                 => ! [V4y0: $i] :
                     ...
                     => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V0x ) @ ( ap @ ( c_2Ewellorder_2EelsOf @ A_27a ) @ V1w1 ) ) )
                          & ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V1w1 ) @ V2w2 ) @ V0x )
                            = ( ap @ ( c_2Eoption_2ESOME @ A_27b ) @ V3y ) )
                       ...
                       => ? [V5x0: $i] :
                            ...
                            & ( ( ap @ ( ap @ ( ap @ ( c_2Ewellorder_2Ewo2wo @ A_27a @ A_27b ) @ V1w1 ) @ V2w2 ) @ V5x0 )
                              = ( ap @ ( c_2Eoption_2ESOME @ A_27b ) @ V4y0 ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Ewo2wo__EQ__NONE__woseg,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( ( mem @ V0w1 @ ( ty_2Ewellorder_2Ewellorder @ A_27b ) )
     => ! [V1w2: $i] :
          ( ( mem @ V1w2 @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
...
thf(conj_thm_2Ewellorder_2Eorderlt__trichotomy,conjecture,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( ( mem @ V0w1 @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
     => ! [V1w2: $i] :
          ( ( mem @ V1w2 @ ( ty_2Ewellorder_2Ewellorder @ A_27b ) )
