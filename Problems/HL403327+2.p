...
fof(conj_thm_2Ebag_2EBAG__DECOMPOSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Ebag_2ESUB__BAG__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Ebag_2ENOT__IN__SUB__BAG__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EFINITE__BAG__DIFF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EFINITE__SUB__BAG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2ESUB__BAG__CARD,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b1] :
          ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Ebag_2EBAG__CARD__DIFF,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
