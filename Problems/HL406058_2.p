...
tff(mem_c_2Ewords_2Eword__L2,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__L2(A_27a),ty_2Efcp_2Ecart(bool,bool)) )).
...
tff(conj_thm_2Ewords_2Eword__L__MULT,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__mul(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))),c_2Ewords_2Eword__L(A_27a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V0n))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ewords_2Eword__L(A_27a)) )).

tff(conj_thm_2Ewords_2Eword__L__MULT__NEG,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__mul(A_27a),ap(c_2Ewords_2Eword__2comp(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n)))),c_2Ewords_2Eword__L(A_27a)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V0n))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ewords_2Eword__L(A_27a)) )).

tff(conj_thm_2Ewords_2Eword__L2__MULT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] :
      ...
      & ! [V0n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__mul(A_27c),ap(c_2Ewords_2En2w(A_27c),inj__ty_2Enum_2Enum(V0n))),c_2Ewords_2Eword__L2(A_27c)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V0n))),ap(c_2Ewords_2En2w(A_27c),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ewords_2Eword__L2(A_27c))
      & ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__mul(A_27d),ap(c_2Ewords_2Eword__2comp(A_27d),ap(c_2Ewords_2En2w(A_27d),inj__ty_2Enum_2Enum(V1n)))),c_2Ewords_2Eword__L2(A_27d)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Earithmetic_2EEVEN,inj__ty_2Enum_2Enum(V1n))),ap(c_2Ewords_2En2w(A_27d),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ewords_2Eword__L2(A_27d)) ) )).
