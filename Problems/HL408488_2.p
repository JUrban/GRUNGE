...
tff(lamtp_f3021,axiom,(
    mem(f3021,arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f3021,axiom,(
    ! [V1r: tp__ty_2Erealax_2Ereal] : ap(f3021,inj__ty_2Erealax_2Ereal(V1r)) = ap(c_2Ebinary__ieee_2Eis__integral,inj__ty_2Erealax_2Ereal(V1r)) )).

tff(ax_thm_2Ebinary__ieee_2Efloat__is__integral__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__integral(A_27t,A_27t),V0x))
      <=> p(ap(ap(ap(ap(c_2Ebinary__ieee_2Efloat__value__CASE(bool),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V0x)),f3021),inj__o(fo__c_2Ebool_2EF)),inj__o(fo__c_2Ebool_2EF))) ) ) )).
...
tff(conj_thm_2Ebinary__ieee_2Einfinity__properties,conjecture,(
    ! [A_27t: del,A_27w: del] :
