...
fof(conj_thm_2Ecardinal_2EHAS__SIZE__SUC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Eiterate_2ENUMSEG__CLAUSES,lemma,
    ( ! [V0m] :
        ( mem(V0m,ty_2Enum_2Enum)
...
fof(conj_thm_2Eiterate_2ETOPOLOGICAL__SORT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0_3C_3C] :
               ...
               => ! [V7s] :
                   ...
                   => ( p(ap(ap(c_2Ecardinal_2EHAS__SIZE(A_27a),V7s),V6n))
                     => ? [V8f] :
                          ...
                          & V7s = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V8f),ap(ap(c_2Eiterate_2E_2E_2E,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V6n))
                          & ! [V9j] :
