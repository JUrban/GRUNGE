...
thf(thm_2Einteger_2ELEAST__INT__DEF,axiom,(
    ! [V0P: tyop_2Einteger_2Eint > $o] :
      ( ( c_2Einteger_2ELEAST__INT @ V0P )
      = ( c_2Emin_2E_40 @ tyop_2Einteger_2Eint
        @ ^ [V1i: tyop_2Einteger_2Eint] :
            ( c_2Ebool_2E_2F_5C @ ( V0P @ V1i )
            @ ( c_2Ebool_2E_21 @ tyop_2Einteger_2Eint
              @ ^ [V2j: tyop_2Einteger_2Eint] :
...
thf(thm_2Eintreal_2EINT__CEILING__def,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ...
      = ( c_2Einteger_2ELEAST__INT
        @ ^ [V1i: tyop_2Einteger_2Eint] :
            ( c_2Ereal_2Ereal__lte @ V0x @ ( c_2Eintreal_2Ereal__of__int @ V1i ) ) ) ) )).
...
thf(thm_2Eintreal_2EINT__CEILING__INT__FLOOR,conjecture,(
    ! [V0r: tyop_2Erealax_2Ereal] :
      ( ( c_2Eintreal_2EINT__CEILING @ V0r )
      = ( c_2Ebool_2ELET @ tyop_2Einteger_2Eint @ tyop_2Einteger_2Eint
        @ ^ [V1i: tyop_2Einteger_2Eint] :
            ( c_2Ebool_2ECOND @ tyop_2Einteger_2Eint @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( c_2Eintreal_2Ereal__of__int @ V1i ) @ V0r ) @ V1i @ ( c_2Einteger_2Eint__add @ V1i @ ( c_2Einteger_2Eint__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
