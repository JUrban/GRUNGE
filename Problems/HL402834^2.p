...
thf(conj_thm_2Erich__list_2EIS__PREFIX__LENGTH,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Erich__list_2Elongest__prefix__SING,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
        = V0s ) ) )).
