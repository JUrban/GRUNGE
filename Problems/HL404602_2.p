...
tff(tp_c_2Estring_2EisDigit,type,(
    c_2Estring_2EisDigit: $i )).

tff(mem_c_2Estring_2EisDigit,axiom,(
    mem(c_2Estring_2EisDigit,arr(ty_2Estring_2Echar,bool)) )).

tff(stp_fo_c_2Estring_2EisDigit,type,(
    fo__c_2Estring_2EisDigit: tp__ty_2Estring_2Echar > tp__o )).

tff(stp_eq_fo_c_2Estring_2EisDigit,axiom,(
    ! [X0: tp__ty_2Estring_2Echar] : inj__o(fo__c_2Estring_2EisDigit(X0)) = ap(c_2Estring_2EisDigit,inj__ty_2Estring_2Echar(X0)) )).
...
tff(ax_thm_2Estring_2EisDigit__def,axiom,(
    ! [V0c: tp__ty_2Estring_2Echar] :
...
tff(conj_thm_2EASCIInumbers_2EHEX__def,lemma,
...
tff(conj_thm_2EASCIInumbers_2EUNHEX__def,lemma,
...
tff(conj_thm_2EASCIInumbers_2EDEC__UNDEC,conjecture,(
    ! [V0c: tp__ty_2Estring_2Echar] :
      ( p(ap(c_2Estring_2EisDigit,inj__ty_2Estring_2Echar(V0c)))
