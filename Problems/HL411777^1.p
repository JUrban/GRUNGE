...
thf(f12675_0_2E0,type,(
    f12675_0_2E0: u )).

thf(f12675_0_2E2,type,(
    f12675_0_2E2: du > du > u )).

thf(f12675_0_2E3,type,(
...
thf(mono_2Ef12675_0,type,(
    mono_2Ef12675_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ereal__topology_2ESERIES__ADD,axiom,(
...
thf(def0_2Ethm_2Ereal__topology_2EINFSUM__ADD,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12675_0 @ V0x @ V1y @ V3i )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V0x @ V3i ) @ ( V1y @ V3i ) ) ) )).

thf(thm_2Ereal__topology_2EINFSUM__ADD,conjecture,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esummable @ V2s @ V0x )
        & ( mono_2Ec_2Ereal__topology_2Esummable @ V2s @ V1y ) )
     => ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ ( mono_2Ef12675_0 @ V0x @ V1y ) )
        = ( mono_2Ec_2Erealax_2Ereal__add @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ V0x ) @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ V1y ) ) ) ) )).
