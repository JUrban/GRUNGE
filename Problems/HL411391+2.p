...
fof(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__IDEMP,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(ap(c_2Ereal__topology_2Econnected__component,ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x)),V1x) = ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x) ) ) )).
