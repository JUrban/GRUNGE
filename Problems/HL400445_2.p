...
tff(conj_thm_2Erelation_2ERUNION__ASSOC,conjecture,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27b,bool)))
     => ! [V1R2: $i] :
          ( mem(V1R2,arr(A_27a,arr(A_27b,bool)))
         => ! [V2R3: $i] :
              ( mem(V2R3,arr(A_27a,arr(A_27b,bool)))
             => ap(ap(c_2Erelation_2ERUNION(A_27a,A_27a),V0R1),ap(ap(c_2Erelation_2ERUNION(A_27a,A_27a),V1R2),V2R3)) = ap(ap(c_2Erelation_2ERUNION(A_27a,A_27a),ap(ap(c_2Erelation_2ERUNION(A_27a,A_27a),V0R1),V1R2)),V2R3) ) ) ) )).
