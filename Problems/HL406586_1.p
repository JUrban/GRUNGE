...
tff(thm_2Esptree_2Ewf__def,axiom,(
    ! [A_27a: d] :
      ( j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELN_2E0)))) = mono_2Ec_2Ebool_2ET_2E0
      & ! [V0a_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELS_2E1(s(A_27a,V0a_2E0)))))) = mono_2Ec_2Ebool_2ET_2E0
      & ! [V1t1_2E0: u,V2t2_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2EBN_2E2(s(tyop_2Esptree_2Espt(A_27a),V1t1_2E0),s(tyop_2Esptree_2Espt(A_27a),V2t2_2E0)))))))
        <=> ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),V1t1_2E0)))))
            & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),V2t2_2E0)))))
            & ~ ( s(tyop_2Esptree_2Espt(A_27a),V1t1_2E0) = s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELN_2E0)
                & s(tyop_2Esptree_2Espt(A_27a),V2t2_2E0) = s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELN_2E0) ) ) )
      & ! [V3t1_2E0: u,V4a_2E0: u,V5t2_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2EBS_2E3(s(tyop_2Esptree_2Espt(A_27a),V3t1_2E0),s(A_27a,V4a_2E0),s(tyop_2Esptree_2Espt(A_27a),V5t2_2E0)))))))
        <=> ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),V3t1_2E0)))))
            & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),V5t2_2E0)))))
            & ~ ( s(tyop_2Esptree_2Espt(A_27a),V3t1_2E0) = s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELN_2E0)
                & s(tyop_2Esptree_2Espt(A_27a),V5t2_2E0) = s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2ELN_2E0) ) ) ) ) )).

tff(thm_2Esptree_2Ewf__insert,axiom,(
    ! [A_27a: d,V0k_2E0: mono_2Etyop_2Enum_2Enum,V1a_2E0: u,V2t_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),V2t_2E0)))))
     => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2Einsert_2E3(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0k_2E0)),s(A_27a,V1a_2E0),s(tyop_2Esptree_2Espt(A_27a),V2t_2E0))))))) ) )).
...
tff(thm_2Esptree_2Ewf__fromAList,conjecture,(
    ! [A_27a: d,V0ls_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Esptree_2Ewf_2E1(s(tyop_2Esptree_2Espt(A_27a),c_2Esptree_2EfromAList_2E1(s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(tyop_2Enum_2Enum,A_27a)),V0ls_2E0))))))) )).
