...
thf(conj_thm_2Eintegral_2ESUM__SPLIT,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V2n: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V1f ) ) @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) @ V1f ) ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V3p ) ) ) ) @ V1f ) ) ) ) )).
...
thf(conj_thm_2Eintegral_2EDIVISION__MONO__LE__SUC,lemma,(
    ! [V0d: $i] :
     ...
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
         ...
         => ! [V3n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ V0d @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ V0d @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) ) )).

thf(conj_thm_2Eintegral_2ESUM__EQ__0,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2f: $i] :
     ...
     => ( ! [V3r: tp__ty_2Enum_2Enum] :
           ...
           => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V3r ) ) )
              = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V2f ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal_2Esum,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum,V1f: $i] :
        ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V1f ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
    & ! [V2n: tp__ty_2Enum_2Enum,V3m: tp__ty_2Enum_2Enum,V4f: $i] :
        ( ( mem @ V4f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) @ V4f ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) @ V4f ) ) @ ( ap @ V4f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V3m ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2ESUM__1,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V0f ) )
          = ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(ax_thm_2Etransc_2Etdiv,axiom,(
...
thf(ax_thm_2Etransc_2Egauge,axiom,(
    ! [V0E: $i] :
...
thf(ax_thm_2Etransc_2Efine,axiom,(
    ! [V0g: $i] :
...
thf(ax_thm_2Etransc_2Ersum,axiom,(
    ! [V0D: $i] :
      ( ( mem @ V0D @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1p: $i] :
         ...
         => ! [V2f: $i] :
              ( ( mem @ V2f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Etransc_2Ersum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) ) @ V0D ) @ V1p ) ) @ V2f ) )
                = ( surj__ty_2Erealax_2Ereal
                  @ ( ap @ ( ap @ c_2Ereal_2Esum @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Etransc_2Edsize @ V0D ) ) )
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V3n: $i] :
                          ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2f @ ( ap @ V1p @ V3n ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0D @ ( ap @ c_2Enum_2ESUC @ V3n ) ) ) @ ( ap @ V0D @ V3n ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Etransc_2EDIVISION__LT__GEN,lemma,(
    ! [V0D: $i] :
      ( ( mem @ V0D @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Eintegral_2EDINT__DELTA__RIGHT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap
        @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V2x: $i] :
                ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V2x ) @ ( inj__ty_2Erealax_2Ereal @ V1b ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
