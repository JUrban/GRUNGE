...
thf(conj_thm_2Ereal__topology_2ELIM__CONST__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CLOSURE__SEQUENTIALLY,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECAUCHY__CONTINUOUS__UNIQUENESS__LEMMA,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ! [V2x: $i] :
           ...
           => ! [V4a: tp__ty_2Erealax_2Ereal,V5x: $i] :
               ...
               => ( ( ! [V6n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V5x @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) @ V1s ) )
                 ...
                 => ? [V7l: tp__ty_2Erealax_2Ereal] :
                      ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V5x ) ) @ ( inj__ty_2Erealax_2Ereal @ V7l ) ) @ c_2Ereal__topology_2Esequentially ) )
                      & ! [V8y: $i] :
                          ( ( mem @ V8y @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
                         => ( ( ! [V9n: tp__ty_2Enum_2Enum] :
                                  ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V8y @ ( inj__ty_2Enum_2Enum @ V9n ) ) ) @ V1s ) )
                           ...
                           => ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V8y ) ) @ ( inj__ty_2Erealax_2Ereal @ V7l ) ) @ c_2Ereal__topology_2Esequentially ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECAUCHY__CONTINUOUS__EXTENDS__TO__CLOSURE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
