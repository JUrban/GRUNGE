...
thf(tp_c_2EordinalNotation_2Erank,type,(
    c_2EordinalNotation_2Erank: $i )).

thf(mem_c_2EordinalNotation_2Erank,axiom,(
    mem @ c_2EordinalNotation_2Erank @ ( arr @ ty_2EordinalNotation_2Eosyntax @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2EordinalNotation_2Erank,type,(
    fo__c_2EordinalNotation_2Erank: tp__ty_2EordinalNotation_2Eosyntax > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2EordinalNotation_2Erank,axiom,(
    ! [X0: tp__ty_2EordinalNotation_2Eosyntax] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2EordinalNotation_2Erank @ X0 ) )
      = ( ap @ c_2EordinalNotation_2Erank @ ( inj__ty_2EordinalNotation_2Eosyntax @ X0 ) ) ) )).
...
thf(conj_thm_2EordinalNotation_2Eoless__imp__rank__leq,lemma,(
...
thf(conj_thm_2EordinalNotation_2Elemma,lemma,(
...
thf(conj_thm_2EordinalNotation_2Emain__lemma,conjecture,(
    ! [V0P: $i] :
