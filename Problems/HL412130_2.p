...
tff(conj_thm_2Eprobability_2Ejoint__distribution__le__1,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
         ...
         => ! [V2Y: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                   ...
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),V3a)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) ) ) ) )).
