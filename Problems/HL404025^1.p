...
thf(arityeq2_2Emono_2Ec_2Ebool_2ELET_2E2_2Emono_2EA_27c_20mono_2EA_27d,axiom,(
    ! [A_27c: d,A_27d: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27d @ ( c_2Ebool_2ELET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) ) )
      = ( s @ A_27d @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) ) @ c_2Ebool_2ELET_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) ) )).
...
thf(thm_2Equotient_2ELET__PRS,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6f_2E0: u,V7x_2E0: u] :
              ( ( s @ A_27d @ ( c_2Ebool_2ELET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ V6f_2E0 ) @ ( s @ A_27c @ V7x_2E0 ) ) )
              = ( s @ A_27d @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27d ) @ V4abs2_2E0 ) @ ( s @ A_27b @ ( c_2Ebool_2ELET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( c_2Equotient_2E_2D_2D_3E_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27c ) @ V1abs1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27d @ A_27b ) @ V5rep2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27d ) @ V6f_2E0 ) ) ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ V2rep1_2E0 ) @ ( s @ A_27c @ V7x_2E0 ) ) ) ) ) ) ) ) ) ) )).
