...
fof(mem_c_2Erich__list_2ESPLITP__AUX,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Erich__list_2ESPLITP__AUX(A_27a),arr(ty_2Elist_2Elist(A_27a),arr(arr(A_27a,bool),arr(ty_2Elist_2Elist(A_27a),ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)))))) ) )).
...
fof(ax_thm_2Erich__list_2ESPLITP__AUX__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0acc] :
...
fof(conj_thm_2Erich__list_2ESPLITP__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Erich__list_2ESPLITP(A_27a) = ap(c_2Erich__list_2ESPLITP__AUX(A_27a),c_2Elist_2ENIL(A_27a)) ) )).
