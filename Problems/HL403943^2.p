...
thf(conj_thm_2Ellist_2ELUNFOLD__THM,lemma,(
...
thf(conj_thm_2Ellist_2ELPREFIX__LNIL,lemma,(
    ! [A_27a: del,V0ll: $i] :
...
thf(conj_thm_2Ellist_2ELPREFIX__LCONS,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0ll: $i] :
          ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ! [V1h: $i] :
...
thf(conj_thm_2Ellist_2ELPREFIX__LUNFOLD,conjecture,(
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2n: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2ELPREFIX @ A_27a ) @ V0ll ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V1f ) @ V2n ) ) )
              <=> ( p
                  @ ( ap @ ( ap @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ( ty_2Epair_2Eprod @ A_27b @ A_27a ) @ bool ) @ ( ap @ V1f @ V2n ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V0ll ) @ ( c_2Ellist_2ELNIL @ A_27a ) ) )
                    @ ( lam @ ( ty_2Epair_2Eprod @ A_27b @ A_27a )
                      @ ^ [V3v: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2Epair__CASE @ bool @ A_27b @ A_27a ) @ V3v )
                          @ ( lam @ A_27b
                            @ ^ [V4n: $i] :
                                ( lam @ A_27a
                                @ ^ [V5x: $i] :
                                    ...
                                    @ ( lam @ A_27a
                                      @ ^ [V6h: $i] :
                                          ...
                                          @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
                                            @ ^ [V7t: $i] :
                                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V0ll ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V6h ) @ V7t ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V6h ) @ V5x ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELPREFIX @ A_27a ) @ V7t ) @ ( ap @ ( ap @ ( c_2Ellist_2ELUNFOLD @ A_27a @ A_27b ) @ V1f ) @ V4n ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
