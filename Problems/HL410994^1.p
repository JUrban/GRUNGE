      ...
      ( ( ( mono_2Ec_2Ereal__topology_2Econnected @ V0s )
        & ( (~)
          @ ? [V2a: mono_2Etyop_2Erealax_2Ereal] :
              ( V0s
              = ( mono_2Ec_2Epred__set_2EINSERT_2Emono_2Etyop_2Erealax_2Ereal @ V2a @ mono_2Ec_2Epred__set_2EEMPTY_2Emono_2Etyop_2Erealax_2Ereal ) ) )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V1x @ V0s ) )
     => ( mono_2Ec_2Ereal__topology_2Elimit__point__of @ V1x @ V0s ) ) )).
...
thf(thm_2Ereal__topology_2ECONNECTED__IMP__PERFECT__CLOSED,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( mono_2Ec_2Ereal__topology_2Econnected @ V0s )
        & ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
        & ( (~)
