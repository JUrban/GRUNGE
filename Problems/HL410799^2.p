...
thf(conj_thm_2Ereal__topology_2ECLOSURE__INTERIOR__UNION__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
         ...
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
           ...
           => ( ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) )
              = ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ c_2Ereal__topology_2Einterior @ V1t ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EREGULAR__CLOSED__UNION,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
