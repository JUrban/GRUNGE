...
fof(conj_thm_2Ereal_2EREAL__SUP__LE,lemma,(
    ! [V0P] :
...
fof(lamtp_f2746,axiom,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V5y] :
          ( mem(V5y,ty_2Erealax_2Ereal)
         => mem(f2746(V0p,V5y),arr(ty_2Erealax_2Ereal,bool)) ) ) )).
    ...
    ! [V0p] :
     ...
     => ! [V5y] :
         ...
         => ! [V6x] :
             ...
             => ap(f2746(V0p,V5y),V6x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0p,V6x)),ap(ap(c_2Erealax_2Ereal__lt,V5y),V6x)) ) ) ) )).

fof(lamtp_f2745,axiom,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V4s] :
          ( mem(V4s,ty_2Erealax_2Ereal)
         => mem(f2745(V0p,V4s),arr(ty_2Erealax_2Ereal,bool)) ) ) )).
...
fof(lameq_f2745,axiom,(
    ! [V0p] :
     ...
     => ! [V4s] :
         ...
         => ! [V5y] :
              ( mem(V5y,ty_2Erealax_2Ereal)
             => ap(f2745(V0p,V4s),V5y) = ap(ap(c_2Emin_2E_3D(bool),ap(c_2Ebool_2E_3F(ty_2Erealax_2Ereal),f2746(V0p,V5y))),ap(ap(c_2Erealax_2Ereal__lt,V5y),V4s)) ) ) ) )).

fof(lamtp_f2744,axiom,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f2744,axiom,(
    ! [V0p] :
     ...
     => ! [V4s] :
          ( mem(V4s,ty_2Erealax_2Ereal)
         => ap(f2744(V0p),V4s) = ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f2745(V0p,V4s)) ) ) )).

fof(conj_thm_2Ereal_2EREAL__SUP__EXISTS__UNIQUE,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ( ( ? [V1x] :
              ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal_2EREAL__SUP__MAX,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1z] :
