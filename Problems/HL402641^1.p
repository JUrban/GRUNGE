...
thf(f3151_0_2E0,type,(
    f3151_0_2E0: u )).

thf(f3151_0_2E1,type,(
    f3151_0_2E1: du > u )).

thf(f3151_0_2E3,type,(
    f3151_0_2E3: du > du > du > u )).

thf(f3153_0_2E0,type,(
    f3153_0_2E0: u )).

thf(f3153_0_2E1,type,(
    f3153_0_2E1: du > u )).

thf(f3153_0_2E3,type,(
...
thf(arityeq1_2Emono_2Ef3151_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( f3151_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ f3151_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3151_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( f3151_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(arityeq1_2Emono_2Ef3153_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( f3153_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ f3153_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3153_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( f3153_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
...
thf(def0_2Ethm_2Erich__list_2EFOLDR__FOLDL__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V3x_2E0: u,V4y_2E0: u] :
      ( ( s @ A_27b @ ( f3151_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) )
...
thf(thm_2Erich__list_2EFOLDR__FOLDL__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2l_2E0: u] :
      ...
      = ( s @ A_27b @ ( c_2Elist_2EFOLDL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( f3151_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) ) ) @ ( s @ A_27b @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) ) )).

thf(def0_2Ethm_2Erich__list_2EFOLDR__REVERSE,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V3x_2E0: u,V4y_2E0: u] :
      ( ( s @ A_27b @ ( f3153_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) ) @ ( s @ A_27b @ V3x_2E0 ) ) ) ) )).

thf(thm_2Erich__list_2EFOLDR__REVERSE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2l_2E0: u] :
      ...
      = ( s @ A_27b @ ( c_2Elist_2EFOLDL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( f3153_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ A_27b ) ) @ V0f_2E0 ) ) ) @ ( s @ A_27b @ V1e_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) )).
