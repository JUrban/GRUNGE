...
thf(conj_thm_2Earithmetic_2EOR__LESS,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ereal_2EREAL__LET__TOTAL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
thf(ax_thm_2Eseq_2Esummable,axiom,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Eseq_2ESER__CAUCHY,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ( ( p @ ( ap @ c_2Eseq_2Esummable @ V0f ) )
    ...
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( p
        @ ( ap
          ...
          @ ( ap @ c_2Erealax_2Einv @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) ) )).

thf(conj_thm_2Eseq_2EABS__NEG__LEMMA,lemma,(
...
thf(conj_thm_2Eseq_2ESER__RATIO,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
