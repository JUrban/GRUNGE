...
thf(thm_2Elist_2ENOT__EQ__LIST,conjecture,(
    ! [A_27a: d,V0h1_2E0: u,V1h2_2E0: u] :
     ...
     => ! [V2l1_2E0: u,V3l2_2E0: u] :
          ( (~)
          @ ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V0h1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l1_2E0 ) ) )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V1h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l2_2E0 ) ) ) ) ) ) )).
