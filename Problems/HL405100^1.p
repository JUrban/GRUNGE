...
thf(thm_2Equotient__pred__set_2EIN__RSP,conjecture,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1abs_2E0: u,V2rep_2E0: u] :
     ...
     => ! [V3x1_2E0: u,V4x2_2E0: u,V5s1_2E0: u,V6s2_2E0: u] :
         ...
         => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3x1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V5s1_2E0 ) ) ) )
            = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V4x2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V6s2_2E0 ) ) ) ) ) ) ) )).
