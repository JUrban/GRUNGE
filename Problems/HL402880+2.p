...
fof(conj_thm_2Erich__list_2EEVERY2__TAKE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2ys] :
                     ...
                     => ! [V3n] :
                         ...
                         => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),V1xs),V2ys))
                           => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Elist_2ETAKE(A_27a),V3n),V1xs)),ap(ap(c_2Elist_2ETAKE(A_27b),V3n),V2ys))) ) ) ) ) ) ) ) )).
