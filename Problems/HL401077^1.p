...
thf(thm_2Enumeral_2Enumeral__MIN,conjecture,(
    ! [V0y: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Earithmetic_2EMIN @ mono_2Ec_2Enum_2E0 @ V1x )
        = mono_2Ec_2Enum_2E0 )
      & ( ( mono_2Ec_2Earithmetic_2EMIN @ V1x @ mono_2Ec_2Enum_2E0 )
        = mono_2Ec_2Enum_2E0 )
      & ( ( mono_2Ec_2Earithmetic_2EMIN @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V1x ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ V0y ) )
        = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2E_3C @ V1x @ V0y ) @ V1x @ V0y ) ) ) ) )).
