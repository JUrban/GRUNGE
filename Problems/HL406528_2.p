...
tff(conj_thm_2Ewords_2Eword__1comp__n2w,lemma,(
...
tff(conj_thm_2Ewords_2EWORD__NEG,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
...
tff(lmtp_f2311,type,(
    f2311: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f2311,axiom,(
    ! [V1x: tp__ty_2Enum_2Enum] : mem(f2311(V1x),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2311,axiom,(
    ! [V1x: tp__ty_2Enum_2Enum,V4i: tp__ty_2Enum_2Enum] : ap(f2311(V1x),inj__ty_2Enum_2Enum(V4i)) = ap(ap(c_2Ebit_2EBIT,inj__ty_2Enum_2Enum(V4i)),inj__ty_2Enum_2Enum(V1x)) )).

tff(lmtp_f2312,type,(
    f2312: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f2312,axiom,(
    ! [V2y: tp__ty_2Enum_2Enum] : mem(f2312(V2y),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2312,axiom,(
    ! [V2y: tp__ty_2Enum_2Enum,V5i: tp__ty_2Enum_2Enum] : ap(f2312(V2y),inj__ty_2Enum_2Enum(V5i)) = ap(ap(c_2Ebit_2EBIT,inj__ty_2Enum_2Enum(V5i)),inj__ty_2Enum_2Enum(V2y)) )).

tff(conj_thm_2Eblast_2EBSUM__EQ,lemma,(
...
tff(conj_thm_2Eblast_2EBSUM__LEM,lemma,(
    ! [V0i: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum,V3c: tp__o] :
      ( p(ap(ap(ap(ap(c_2Eblast_2EBSUM,inj__ty_2Enum_2Enum(V0i)),f2311(V1x)),f2312(V2y)),inj__o(V3c)))
...
tff(lamtp_f2314,axiom,(
    ! [A_27a: del,V1y: $i] :
      ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2314(A_27a,V1y,V0x),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2314,axiom,(
    ! [A_27a: del,V1y: $i] :
     ...
     => ! [V0x: $i] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2314(A_27a,V1y,V0x),inj__ty_2Enum_2Enum(V2i)) = ap(ap(ap(ap(c_2Eblast_2EBSUM,inj__ty_2Enum_2Enum(V2i)),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),ap(c_2Efcp_2Efcp__index(bool,bool),V1y))),inj__o(fo__c_2Ebool_2ET)) ) ) )).

tff(conj_thm_2Eblast_2EBITWISE__SUB,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Ewords_2Eword__sub(A_27a),V0x),V1y) = ap(c_2Efcp_2EFCP(bool,bool),f2314(A_27a,V1y,V0x)) ) ) )).
