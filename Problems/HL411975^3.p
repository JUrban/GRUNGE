...
thf(thm_2Elebesgue_2Epos__simple__fn__indicator__alt,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o] :
     ...
     => ( c_2Emeasure_2Epos__simple__fn @ A_27a @ V0m @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V1s ) @ ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ c_2Enum_2E0 @ ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Epred__set_2EEMPTY @ tyop_2Enum_2Enum ) ) )
        @ ^ [V2i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ ( A_27a > $o ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V2i @ c_2Enum_2E0 ) @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ V1s ) @ V1s )
        @ ^ [V3i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ V3i @ c_2Enum_2E0 ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )).
