...
thf(c_2Estring_2ESUB,type,(
    c_2Estring_2ESUB: ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ tyop_2Enum_2Enum ) > tyop_2Estring_2Echar )).
...
thf(thm_2Estring_2ESUB__def,axiom,(
    ! [V0s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Estring_2ESUB @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ tyop_2Enum_2Enum @ V0s @ V1n ) )
      = ( c_2Elist_2EEL @ tyop_2Estring_2Echar @ V1n @ V0s ) ) )).

thf(thm_2EASCIInumbers_2EBIT__num__from__bin__string,conjecture,(
    ! [V0x: tyop_2Enum_2Enum,V1s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
      ( ( ( c_2Elist_2EEVERY @ tyop_2Estring_2Echar @ ( c_2Ecombin_2Eo @ tyop_2Estring_2Echar @ $o @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2E_3E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ c_2EASCIInumbers_2EUNHEX ) @ V1s )
        & ( c_2Eprim__rec_2E_3C @ V0x @ ( c_2Elist_2ELENGTH @ tyop_2Estring_2Echar @ V1s ) ) )
     => ( ( c_2Ebit_2EBIT @ V0x @ ( c_2EASCIInumbers_2Enum__from__bin__string @ V1s ) )
      <=> ( ( c_2EASCIInumbers_2EUNHEX @ ( c_2Estring_2ESUB @ ( c_2Epair_2E_2C @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ tyop_2Enum_2Enum @ V1s @ ( c_2Eprim__rec_2EPRE @ ( c_2Earithmetic_2E_2D @ ( c_2Elist_2ELENGTH @ tyop_2Estring_2Echar @ V1s ) @ V0x ) ) ) ) )
          = ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
