...
tff(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__ELIM,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(lamtp_f494,axiom,(
    ! [A_27b: del,A_27b: del,V1s: $i] :
...
tff(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__T,conjecture,(
