...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__COMPOSE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ! [V2x] :
             ...
             => ! [V3s] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),V3s)))
                      & p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V1g),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,ap(V0f,V2x))),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V3s)))) )
                   => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),ap(ap(c_2Ecombin_2Eo(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1g),V0f)),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,V2x)),V3s))) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
