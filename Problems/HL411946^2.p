...
thf(conj_thm_2Ereal__topology_2EINTERVAL__CONTAINS__COMPACT__NEIGHBOURHOOD,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__IMP__LOCALLY__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Eis__interval @ V0s ) )
       => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact ) @ V0s ) ) ) ) )).
