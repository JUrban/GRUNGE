...
fof(conj_thm_2Ereal__topology_2EDIAMETER__BOUNDED,lemma,(
    ! [V0s] :
     ...
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
       => ( ! [V1x] :
          ...
          & ! [V3d] :
             ...
             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V3d))
                  & p(ap(ap(c_2Erealax_2Ereal__lt,V3d),ap(c_2Ereal__topology_2Ediameter,V0s))) )
               => ? [V4x] :
                    ( mem(V4x,ty_2Erealax_2Ereal)
                    & ? [V5y] :
                        ( mem(V5y,ty_2Erealax_2Ereal)
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V0s))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5y),V0s))
                        & p(ap(ap(c_2Ereal_2Ereal__gt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V4x),V5y))),V3d)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDIAMETER__BOUNDED__BOUND,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
