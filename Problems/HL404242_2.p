...
tff(conj_thm_2Ecombin_2EUPDATE__APPLY__IMP__ID,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ! [V2a: $i] :
              ( mem(V2a,A_27a)
             => ( ap(V0f,V2a) = V1b
               => ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V2a),V1b),V0f) = V0f ) ) ) ) )).

tff(conj_thm_2Eupdate_2EUPDATE__APPLY__IMP__ID,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1b: $i] :
          ( mem(V1b,A_27b)
