...
fof(conj_thm_2Ereal__topology_2EOPEN__IN__DELETE,conjecture,(
    ! [V0u] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s] :
         ...
         => ! [V2a] :
             ...
             => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0u)),V1s))
               => p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0u)),ap(ap(c_2Epred__set_2EDELETE(ty_2Erealax_2Ereal),V1s),V2a))) ) ) ) ) )).
