...
tff(conj_thm_2Ealignment_2Ealigned__add__sub,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__mul__shift__1,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__add__sub__prod,conjecture,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2x: $i] :
