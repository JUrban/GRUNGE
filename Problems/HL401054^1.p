...
thf(thm_2Ewhile_2EOWHILE__EQ__NONE,conjecture,(
    ! [A_27a: d,V0s_2E0: u,V1f_2E0: u,V2G_2E0: u] :
      ( ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ewhile_2EOWHILE_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2G_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V1f_2E0 ) @ ( s @ A_27a @ V0s_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
    <=> ! [V3n: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V2G_2E0 ) @ ( s @ A_27a @ ( c_2Earithmetic_2EFUNPOW_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27a ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ A_27a @ V0s_2E0 ) ) ) ) ) ) ) )).
