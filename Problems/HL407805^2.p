...
thf(conj_thm_2Efrac_2EFRAC__ADD__ASSOC,lemma,(
    ! [V0a: tp__ty_2Efrac_2Efrac,V1b: tp__ty_2Efrac_2Efrac,V2c: tp__ty_2Efrac_2Efrac] :
      ( ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V1b ) ) @ ( inj__ty_2Efrac_2Efrac @ V2c ) ) ) )
      = ( surj__ty_2Efrac_2Efrac @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( ap @ ( ap @ c_2Efrac_2Efrac__add @ ( inj__ty_2Efrac_2Efrac @ V0a ) ) @ ( inj__ty_2Efrac_2Efrac @ V1b ) ) ) @ ( inj__ty_2Efrac_2Efrac @ V2c ) ) ) ) )).
...
thf(conj_thm_2Erat_2ERAT__ADD__ASSOC,conjecture,(
