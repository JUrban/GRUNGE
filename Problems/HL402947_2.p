...
tff(lmtp_f831,type,(
    f831: ( del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f831,axiom,(
...
tff(lmtp_f832,type,(
    f832: ( del * del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f832,axiom,(
...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__EXTEND__INPUT,conjecture,(
