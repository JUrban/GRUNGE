...
tff(conj_thm_2Ereal__topology_2EBILINEAR__LMUL,lemma,(
    ! [V0h: $i] :
...
tff(conj_thm_2Ereal__topology_2EBILINEAR__RMUL,lemma,(
    ! [V0h: $i] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Ereal__topology_2Ebilinear,V0h))
...
tff(lmtp_f3651,type,(
    f3651: ( del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f3651,axiom,(
...
tff(lmtp_f3650,type,(
    f3650: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3650,axiom,(
...
tff(conj_thm_2Ereal__topology_2EBILINEAR__SUM,lemma,(
             ...
             => ! [V3g: $i] :
                 ...
                 => ! [V4h: $i] :
                     ...
                     => ( ( p(ap(c_2Ereal__topology_2Ebilinear,V4h))
                       ...
                       => surj__ty_2Erealax_2Ereal(ap(ap(V4h,ap(ap(c_2Eiterate_2ESum(A_27a),V0s),V2f)),ap(ap(c_2Eiterate_2ESum(A_27b),V1t),V3g))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0s),V1t)),ap(c_2Epair_2EUNCURRY(A_27a,A_27a,A_27a),f3650(A_27b,A_27a,V4h,V2f,V3g)))) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EBILINEAR__BOUNDED,conjecture,(
    ! [V0h: $i] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ( p(ap(c_2Ereal__topology_2Ebilinear,V0h))
