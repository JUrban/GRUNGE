...
fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__SELF,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V1x),V0s))
           => ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1x) = V1x ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__REFL,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
