...
tff(conj_thm_2Efinite__map_2EFUNION__EQ__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,V0h1: $i] :
      ( mem(V0h1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1h2: $i] :
          ( mem(V1h2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ( ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0h1),V1h2) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a)
          <=> ( V0h1 = c_2Efinite__map_2EFEMPTY(A_27a,A_27a)
              & V1h2 = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) ) ) ) )).
