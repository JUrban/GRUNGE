...
thf(stp_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,type,(
    tp__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum: $tType )).

thf(stp_inj_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,type,(
    inj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum: tp__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum > $i )).

thf(stp_surj_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,type,(
    surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum: $i > tp__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum )).

thf(stp_inj_surj_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,axiom,(
    ! [X: tp__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum] :
      ( ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ ( inj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ X ) )
      = X ) )).

thf(stp_inj_mem_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,axiom,(
    ! [X: tp__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum] :
      ( mem @ ( inj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ X ) @ ( ty_2Etoto_2Etoto @ ty_2Enum_2Enum ) ) )).

thf(stp_iso_mem_c_ty_2Etoto_2Etoto_ty_2Enum_2Enum,axiom,(
    ! [X: $i] :
      ( ( mem @ X @ ( ty_2Etoto_2Etoto @ ty_2Enum_2Enum ) )
     => ( X
        = ( inj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ X ) ) ) ) )).

thf(tp_c_2Etoto_2Enumto,type,(
    c_2Etoto_2Enumto: $i )).

thf(mem_c_2Etoto_2Enumto,axiom,(
...
thf(ax_thm_2Etoto_2Enumto,axiom,
    ( ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ c_2Etoto_2Enumto )
    = ( surj__c_ty_2Etoto_2Etoto_ty_2Enum_2Enum @ ( ap @ ( c_2Etoto_2ETO @ ty_2Enum_2Enum ) @ c_2Etoto_2EnumOrd ) ) )).

thf(conj_thm_2Etoto_2Eapnumto__thm,conjecture,
    ( ( ap @ ( c_2Etoto_2Eapto @ ty_2Enum_2Enum ) @ c_2Etoto_2Enumto )
    = c_2Etoto_2EnumOrd )).
