...
tff(conj_thm_2Epred__set_2EPROD__SET__IMAGE__REDUCTION,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))
               ...
               => surj__ty_2Enum_2Enum(ap(c_2Epred__set_2EPROD__SET,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V2x),V1s)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,ap(V0f,V2x)),ap(c_2Epred__set_2EPROD__SET,ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)))) ) ) ) ) )).
