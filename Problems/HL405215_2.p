...
tff(conj_thm_2Ealist_2Ealist__to__fmap__MAP__matchable,lemma,(
...
tff(conj_thm_2Ealist_2EMAP__KEYS__I,lemma,(
...
tff(conj_thm_2Ealist_2Ealist__to__fmap__MAP__values,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1al: $i] :
