...
thf(thm_2Ebag_2EBAG__INN__BAG__UNION,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1e: A_27a,V2b1: A_27a > tyop_2Enum_2Enum,V3b2: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V2b1 @ V3b2 ) )
    <=> ? [V4m1: tyop_2Enum_2Enum,V5m2: tyop_2Enum_2Enum] :
          ( ( V0n
            = ( c_2Earithmetic_2E_2B @ V4m1 @ V5m2 ) )
          & ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V4m1 @ V2b1 )
          & ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V5m2 @ V3b2 ) ) ) )).
