...
tff(lamtp_f3701,axiom,(
    mem(f3701,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3701,axiom,(
    ! [V1x: tp__ty_2Erealax_2Ereal] : ap(f3701,inj__ty_2Erealax_2Ereal(V1x)) = ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V1x)) )).
...
tff(conj_thm_2Ereal__topology_2ECLOSED__NEGATIONS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
       => p(ap(c_2Ereal__topology_2EClosed,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3701),V0s))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__SUMS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__CLOSED__DIFFERENCES,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
