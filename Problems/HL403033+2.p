...
fof(conj_thm_2EindexedLists_2EEL__delN__AFTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
         ...
         => ! [V1i] :
             ...
             => ! [V2j] :
                 ...
                 => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2j),V1i))
                      & p(ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Elist_2ELENGTH(A_27a),V0l))) )
                   => ap(ap(c_2Elist_2EEL(A_27a),V1i),ap(ap(c_2EindexedLists_2EdelN(A_27a),V2j),V0l)) = ap(ap(c_2Elist_2EEL(A_27a),ap(ap(c_2Earithmetic_2E_2B,V1i),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V0l) ) ) ) ) ) )).
