...
thf(conj_thm_2Einteger_2EINT__ABS__POS,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Einteger_2EABS @ ( inj__ty_2Einteger_2Eint @ V0p ) ) ) ) )).
...
thf(conj_thm_2Einteger_2EINT__ABS__EQ0,lemma,(
    ! [V0p: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__QUOT__UNIQUE,lemma,(
...
thf(conj_thm_2Einteger_2EINT__REM__EQ0,lemma,(
...
thf(conj_thm_2Einteger_2EINT__MUL__QUOT,conjecture,(
    ! [V0p: tp__ty_2Einteger_2Eint,V1q: tp__ty_2Einteger_2Eint,V2k: tp__ty_2Einteger_2Eint] :
      ( ( ( V1q
         != ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
