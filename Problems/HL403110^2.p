...
thf(conj_thm_2ETemporal__Logic_2EBEFORE__AS__SWHEN,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ c_2ETemporal__Logic_2ESWHEN
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V3t: $i] :
                                ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V3t ) ) ) )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V4t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ V0a @ V4t ) ) @ ( ap @ V1b @ V4t ) ) ) )
                      @ V2t0 ) )
                  @ ( ap
                    @ ( ap @ c_2ETemporal__Logic_2EALWAYS
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V5t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V5t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V5t ) ) ) ) )
                    @ V2t0 ) ) ) ) ) ) )).
