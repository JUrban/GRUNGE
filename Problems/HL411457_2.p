...
tff(lamtp_f3943,axiom,(
    ! [A_27a: del,V2c: $i] :
      ( mem(V2c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3943(A_27a,V2c,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3943,axiom,(
    ! [A_27a: del,V2c: $i] :
      ( mem(V2c,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3943(A_27a,V2c,V1f),V3x) = ap(ap(c_2Erealax_2Ereal__mul,ap(V2c,V3x)),ap(V1f,V3x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MUL,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2c: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V2c),V0net))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3943(A_27a,V2c,V1f)),V0net)) ) ) ) ) )).
