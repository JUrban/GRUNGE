...
fof(thm_2Estring_2EisPREFIX__STRCAT,conjecture,(
    ! [V0s1_2E0,V1s2_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Elist_2EisPREFIX_2E2(s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),V0s1_2E0),s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),V1s2_2E0))))
    <=> ? [V2s3_2E0] : s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),V1s2_2E0) = s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),V0s1_2E0),s(tyop_2Elist_2Elist(tyop_2Estring_2Echar),V2s3_2E0))) ) )).
