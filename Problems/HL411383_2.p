...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__SYM,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
         ...
         => p(ap(ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V1x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__TRANS,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] :
