...
tff(thm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__THM,conjecture,(
    ! [A_27a: d,V0i_2E0: u,V1P_2E0: u] :
     ...
     => ( ! [V3v_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1P_2E0),s(A_27a,V3v_2E0)))))
