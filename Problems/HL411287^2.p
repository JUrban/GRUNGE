...
thf(conj_thm_2Ereal__topology_2ELIM__AT,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ELIM__LIFT__DOT,lemma,(
    ! [V0l: tp__ty_2Erealax_2Ereal,V1net: tp__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal,V2f: $i] :
      ( ( mem @ V2f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V3a: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal ) @ V2f ) @ ( inj__ty_2Erealax_2Ereal @ V0l ) ) @ ( inj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal @ V1net ) ) )
         => ( p
            @ ( ap
              @ ( ap
                @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V4y: $i] :
                        ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) @ ( ap @ V2f @ V4y ) ) ) )
                @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V3a ) ) @ ( inj__ty_2Erealax_2Ereal @ V0l ) ) )
              @ ( inj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal @ V1net ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__LIFT__DOT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] :
      ...
      @ ( ap
        @ ( ap @ ( c_2Ereal__topology_2Econtinuous @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V2y: $i] :
                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V2y ) ) )
        @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) ) )).
