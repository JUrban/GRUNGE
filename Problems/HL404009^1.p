...
thf(f4364_0_2E0,type,(
    f4364_0_2E0: u )).

thf(f4364_0_2E1,type,(
    f4364_0_2E1: du > u )).

thf(f4364_0_2E2,type,(
    f4364_0_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef4364_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f4364_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ f4364_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4364_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ A_27b @ ( f4364_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ f4364_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Equotient_2ELAMBDA__RSP,axiom,(
    ! [A_27a: d,A_27b: d,V6f1_2E0: u,V8x_2E0: u] :
      ( ( s @ A_27b @ ( f4364_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V6f1_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V6f1_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) )).

thf(thm_2Equotient_2ELAMBDA__RSP,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0R1_2E0: u,V1abs1_2E0: u,V2rep1_2E0: u] :
     ...
     => ! [V3R2_2E0: u,V4abs2_2E0: u,V5rep2_2E0: u] :
         ...
         => ! [V6f1_2E0: u,V7f2_2E0: u] :
             ...
             => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Equotient_2E_3D_3D_3D_3E_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ V3R2_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f4364_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V6f1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f4364_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V7f2_2E0 ) ) ) ) ) ) ) ) ) )).
