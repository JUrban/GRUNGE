     ...
     => ! [V3d] :
         ...
         => ! [V4f] :
             ...
             => ! [V5i] :
                 ...
                 => ap(f3387(V2c,V3d,V4f),V5i) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2c),V3d)),ap(V4f,V5i)) ) ) ) ) )).

fof(lamtp_f3389,axiom,(
    ! [V4f] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V6j] :
          ( mem(V6j,ty_2Enum_2Enum)
         => mem(f3389(V4f,V6j),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f3389,axiom,(
    ! [V4f] :
      ( mem(V4f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V6j] :
          ( mem(V6j,ty_2Enum_2Enum)
         => ! [V7i] :
             ...
             => ap(f3389(V4f,V6j),V7i) = ap(ap(V4f,V7i),V6j) ) ) ) )).

fof(lamtp_f3388,axiom,(
    ! [V0a] :
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V4f] :
             ...
             => ! [V6j] :
                  ( mem(V6j,ty_2Enum_2Enum)
                 => ap(f3388(V0a,V1b,V4f),V6j) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V0a),V1b)),f3389(V4f,V6j)) ) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__SWAP__NUMSEG,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Enum_2Enum)
     => ! [V1b] :
          ( mem(V1b,ty_2Enum_2Enum)
         => ! [V2c] :
             ...
             => ! [V3d] :
                 ...
                 => ! [V4f] :
                      ( mem(V4f,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
                     => ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V0a),V1b)),f3387(V2c,V3d,V4f)) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2c),V3d)),f3388(V0a,V1b,V4f)) ) ) ) ) ) )).
