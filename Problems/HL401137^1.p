...
thf(c_2Eind__type_2EINJP_2E4,type,(
    c_2Eind__type_2EINJP_2E4: du > du > du > du > u )).

thf(c_2Eind__type_2ENUMLEFT_2E0,type,(
    c_2Eind__type_2ENUMLEFT_2E0: u )).

thf(c_2Eind__type_2ENUMLEFT_2E1,type,(
    c_2Eind__type_2ENUMLEFT_2E1: du > u )).

thf(c_2Eind__type_2ENUMRIGHT_2E0,type,(
    c_2Eind__type_2ENUMRIGHT_2E0: u )).

thf(c_2Eind__type_2ENUMRIGHT_2E1,type,(
    c_2Eind__type_2ENUMRIGHT_2E1: du > u )).

thf(c_2Eind__type_2ENUMSUM_2E0,type,(
    c_2Eind__type_2ENUMSUM_2E0: u )).

thf(c_2Eind__type_2ENUMSUM_2E2,type,(
...
thf(mono_2Ec_2Eind__type_2ENUMLEFT,type,(
    mono_2Ec_2Eind__type_2ENUMLEFT: mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ec_2Eind__type_2ENUMRIGHT,type,(
    mono_2Ec_2Eind__type_2ENUMRIGHT: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Eind__type_2ENUMSUM,type,(
    mono_2Ec_2Eind__type_2ENUMSUM: $o > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq4_2Emono_2Ec_2Eind__type_2EINJP_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2: mono_2Etyop_2Enum_2Enum,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eind__type_2EINJP_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ X1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X2 ) ) @ ( s @ A_27a @ X3_2E0 ) ) ) )
...
thf(thm_2Eind__type_2ENUMSUM__DEST,axiom,(
    ! [V0x: $o,V1y: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eind__type_2ENUMLEFT @ ( mono_2Ec_2Eind__type_2ENUMSUM @ V0x @ V1y ) )
        = V0x )
      & ( ( mono_2Ec_2Eind__type_2ENUMRIGHT @ ( mono_2Ec_2Eind__type_2ENUMSUM @ V0x @ V1y ) )
        = V1y ) ) )).

thf(thm_2Eind__type_2EINJP,axiom,(
    ! [A_27a: d,V0f1_2E0: u,V1f2_2E0: u,V2x: mono_2Etyop_2Enum_2Enum,V3x_27_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Eind__type_2EINJP_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0f1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2x ) ) @ ( s @ A_27a @ V3x_27_2E0 ) ) ) )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Eind__type_2ENUMLEFT @ V2x ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eind__type_2ENUMRIGHT @ V2x ) ) ) ) ) @ ( s @ A_27a @ V3x_27_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V1f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eind__type_2ENUMRIGHT @ V2x ) ) ) ) ) @ ( s @ A_27a @ V3x_27_2E0 ) ) ) ) ) ) )).

thf(thm_2Eind__type_2EINJP__INJ,conjecture,(
