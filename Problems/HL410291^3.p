...
thf(thm_2Emeasure_2Eindicator__fn__split,conjecture,(
    ! [A_27a: $tType,V0r: tyop_2Enum_2Enum > $o,V1s: A_27a > $o,V2b: tyop_2Enum_2Enum > A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V0r )
        & ( ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V2b @ V0r ) )
          = V1s )
        & ! [V3i: tyop_2Enum_2Enum,V4j: tyop_2Enum_2Enum] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V0r )
              & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4j @ V0r )
              & ( (~) @ ( V3i = V4j ) ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V2b @ V3i ) @ ( V2b @ V4j ) ) ) )
     => ! [V5a: A_27a > $o] :
          ( ( c_2Epred__set_2ESUBSET @ A_27a @ V5a @ V1s )
         => ( ( c_2Emeasure_2Eindicator__fn @ A_27a @ V5a )
            = ( ^ [V6x: A_27a] :
                  ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ tyop_2Enum_2Enum
                  @ ^ [V7i: tyop_2Enum_2Enum] :
                      ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EINTER @ A_27a @ V5a @ ( V2b @ V7i ) ) @ V6x )
                  @ V0r ) ) ) ) ) )).
