...
thf(conj_thm_2Eutil__prob_2EGBIGUNION__IMAGE,conjecture,(
     ...
     => ! [V1p: $i] :
         ...
         => ! [V2n: $i] :
             ...
             => ( ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b )
                  @ ( lam @ A_27b
                    @ ^ [V3s: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ V3s )
                ...
                = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27b )
                  @ ( ap
                    @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27c @ ( arr @ A_27b @ bool ) )
                      @ ( lam @ A_27c
                        @ ^ [V5n: $i] :
                            ( ap @ ( c_2Epred__set_2EGSPEC @ A_27b @ A_27b )
                            @ ( lam @ A_27b
                              @ ^ [V6s: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27b @ bool ) @ V6s ) @ ( ap @ ( ap @ V1p @ V6s ) @ V5n ) ) ) ) ) )
