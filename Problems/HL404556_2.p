...
tff(conj_thm_2Ecardinal_2ECARD__LE__ADD,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__ADD__ABSORB__LE,lemma,(
...
tff(conj_thm_2Ecardinal_2ECARD__ADD2__ABSORB__LE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
