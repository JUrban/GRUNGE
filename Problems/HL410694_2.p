...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__SET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
       => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__FROM__CLOSED__UNION__AND__INTER,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
