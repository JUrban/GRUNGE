...
thf(f7897_0_2E0,type,(
    f7897_0_2E0: u )).

thf(f7897_0_2E2,type,(
    f7897_0_2E2: du > du > u )).

thf(f7917_0_2E0,type,(
    f7917_0_2E0: u )).

thf(f7917_0_2E2,type,(
    f7917_0_2E2: du > du > u )).
...
thf(mono_2Ef7897_0,type,(
    mono_2Ef7897_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef7917_0,type,(
    mono_2Ef7917_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Epatricia_2EPEEK__ADD,axiom,(
    ! [V1k: mono_2Etyop_2Enum_2Enum,V3j: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7897_0 @ V1k @ V3j )
    <=> ( V1k = V3j ) ) )).

thf(thm_2Epatricia_2EPEEK__ADD,axiom,(
    ! [A_27a: d,V0t_2E0: u,V1k: mono_2Etyop_2Enum_2Enum,V2d_2E0: u,V3j: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Epatricia_2EPEEK_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ ( c_2Epatricia_2EADD_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ V0t_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1k ) ) @ ( s @ A_27a @ V2d_2E0 ) ) ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3j ) ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef7897_0 @ V1k @ V3j ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V2d_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Epatricia_2EPEEK_2E2 @ ( s @ ( tyop_2Epatricia_2Eptree @ A_27a ) @ V0t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3j ) ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Epatricia_2EPEEK__INSERT__PTREE,axiom,(
    ! [V1k: mono_2Etyop_2Enum_2Enum,V2j: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7917_0 @ V1k @ V2j )
    <=> ( V1k = V2j ) ) )).
...
thf(thm_2Epatricia_2EPEEK__INSERT__PTREE,conjecture,(
    ! [V0t: mono_2Etyop_2Epatricia_2Eptree_28tyop_2Eone_2Eone_29,V1k: mono_2Etyop_2Enum_2Enum,V2j: mono_2Etyop_2Enum_2Enum] :
     ...
     => ( ( mono_2Ec_2Epatricia_2EPEEK_2Emono_2Etyop_2Eone_2Eone @ ( mono_2Ec_2Epatricia_2EINSERT__PTREE @ V1k @ V0t ) @ V2j )
        = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Eoption_2Eoption_28tyop_2Eone_2Eone_29 @ ( mono_2Ef7917_0 @ V1k @ V2j ) @ ( mono_2Ec_2Eoption_2ESOME_2Emono_2Etyop_2Eone_2Eone @ mono_2Ec_2Eone_2Eone ) @ ( mono_2Ec_2Epatricia_2EPEEK_2Emono_2Etyop_2Eone_2Eone @ V0t @ V2j ) ) ) ) )).
