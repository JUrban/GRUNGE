...
tff(conj_thm_2Epair_2Etransitive__LEX,conjecture,(
    ! [A_27a: del,A_27b: del,V0R1: $i] :
      ( mem(V0R1,arr(A_27a,arr(A_27a,bool)))
     => ! [V1R2: $i] :
          ( mem(V1R2,arr(A_27b,arr(A_27b,bool)))
         => ( ( p(ap(c_2Erelation_2Etransitive(A_27a),V0R1))
           ...
           => p(ap(c_2Erelation_2Etransitive(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2ELEX(A_27a,A_27a),V0R1),V1R2))) ) ) ) )).
