...
tff(conj_thm_2Elim_2ECONT__NEG,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Elim_2Econtl,V0f),inj__ty_2Erealax_2Ereal(V1x)))
         => p(ap(ap(c_2Elim_2Econtl,f2908(V0f)),inj__ty_2Erealax_2Ereal(V1x))) ) ) )).

tff(conj_thm_2Elim_2ECONT__INJ__LEMMA,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Elim_2ECONT__INJ__LEMMA2,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
