...
thf(c_2EASCIInumbers_2Enum__from__hex__string,type,(
    c_2EASCIInumbers_2Enum__from__hex__string: ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > tyop_2Enum_2Enum )).

thf(c_2EASCIInumbers_2Enum__to__hex__string,type,(
    c_2EASCIInumbers_2Enum__to__hex__string: tyop_2Enum_2Enum > ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) )).
...
thf(thm_2EASCIInumbers_2Enum__from__hex__string__def,axiom,
    ...
    = ( c_2EASCIInumbers_2Es2n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ c_2EASCIInumbers_2EUNHEX ) )).

thf(thm_2EASCIInumbers_2Enum__to__hex__string__def,axiom,
    ( c_2EASCIInumbers_2Enum__to__hex__string
    = ( c_2EASCIInumbers_2En2s @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) @ c_2EASCIInumbers_2EHEX ) )).

thf(thm_2EASCIInumbers_2EUNHEX__HEX,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
     => ( ( c_2EASCIInumbers_2EUNHEX @ ( c_2EASCIInumbers_2EHEX @ V0n ) )
        = V0n ) ) )).
...
thf(thm_2EASCIInumbers_2Enum__hex__string,conjecture,
    ( ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum @ ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) @ c_2EASCIInumbers_2Enum__from__hex__string @ c_2EASCIInumbers_2Enum__to__hex__string )
