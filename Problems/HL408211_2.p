...
tff(conj_thm_2Epoly_2EPOLY__ROOTS__FINITE,lemma,(
...
tff(lmtp_f2930,type,(
    f2930: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2930,axiom,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal] : mem(f2930(V0p),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f2930,axiom,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f2930(V0p),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Epoly_2Epoly,inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0p)),inj__ty_2Erealax_2Ereal(V1x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) )).

tff(conj_thm_2Epoly_2EPOLY__ROOTS__FINITE__SET,conjecture,(
    ! [V0p: tp__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal] :
      ( ap(c_2Epoly_2Epoly,inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal(V0p)) != ap(c_2Epoly_2Epoly,c_2Elist_2ENIL(ty_2Erealax_2Ereal))
     => p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f2930(V0p)))) ) )).
