...
tff(conj_thm_2Elebesgue_2EEXTREAL__SUP__SEQ,lemma,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Eextreal_2Eextreal,bool))
     => ( ( ? [V1x: tp__ty_2Eextreal_2Eextreal] : p(ap(V0P,inj__ty_2Eextreal_2Eextreal(V1x)))
       ...
       => ? [V4x: $i] :
            ...
            & ! [V5n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ebool_2EIN(ty_2Eextreal_2Eextreal),ap(V4x,inj__ty_2Enum_2Enum(V5n))),V0P))
            & ! [V6n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V4x,inj__ty_2Enum_2Enum(V6n))),ap(V4x,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V6n)))))
            & surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V4x),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))) = surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,V0P)) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__IMAGE,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1P_27: $i] :
