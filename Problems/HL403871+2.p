...
fof(conj_thm_2Ellist_2ELLENGTH__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ll] :
             ...
             => ! [V1f] :
                  ( mem(V1f,arr(A_27a,A_27b))
                 => ap(c_2Ellist_2ELLENGTH(A_27b),ap(ap(c_2Ellist_2ELMAP(A_27a,A_27a),V1f),V0ll)) = ap(c_2Ellist_2ELLENGTH(A_27a),V0ll) ) ) ) ) )).
