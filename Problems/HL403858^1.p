...
thf(thm_2Ellist_2Ellength__rel__cases,conjecture,(
    ! [A_27a: d,V0a0_2E0: u,V1a1: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Ellength__rel_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1a1 ) ) ) ) )
    <=> ( ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0a0_2E0 )
            = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) )
          & ( V1a1 = mono_2Ec_2Enum_2E0 ) )
        | ? [V2h_2E0: u,V3n: mono_2Etyop_2Enum_2Enum,V4t_2E0: u] :
            ( ( ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0a0_2E0 )
              = ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V2h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V4t_2E0 ) ) ) )
            & ( V1a1
              = ( mono_2Ec_2Enum_2ESUC @ V3n ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Ellength__rel_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V4t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) ) ) ) ) ) )).
