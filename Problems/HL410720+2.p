...
fof(conj_thm_2Ereal__topology_2ELIMPT__OF__UNIV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V0x),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) ) )).

fof(conj_thm_2Ereal__topology_2ELIMPT__OF__OPEN__IN,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2ELIMPT__OF__OPEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
