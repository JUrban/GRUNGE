...
fof(conj_thm_2EreaderMonad_2EFMAP__o,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [A_27d] :
                 ...
                 => ! [V0f] :
                     ...
                     => ! [V1g] :
                         ...
                         => ap(c_2EreaderMonad_2EFMAP(A_27b,A_27b,A_27b),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V0f),V1g)) = ap(ap(c_2Ecombin_2Eo(arr(A_27a,A_27b),arr(A_27a,A_27b),arr(A_27a,A_27b)),ap(c_2EreaderMonad_2EFMAP(A_27d,A_27d,A_27d),V0f)),ap(c_2EreaderMonad_2EFMAP(A_27b,A_27b,A_27b),V1g)) ) ) ) ) ) ) )).
