...
fof(conj_thm_2Efinite__map_2Eis__fmap__cases,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0a0] :
              ( mem(V0a0,arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))
             => ( p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),V0a0))
              <=> ( V0a0 = k(A_27a,ap(c_2Esum_2EINR(A_27b,A_27b),c_2Eone_2Eone))
                  | ? [V2f] :
                      ( mem(V2f,arr(A_27a,ty_2Esum_2Esum(A_27b,A_27b)))
                      & ? [V3a] :
                          ( mem(V3a,A_27a)
                          & ? [V4b] :
                              ( mem(V4b,A_27b)
                              & V0a0 = f1904(A_27b,A_27a,V4b,V3a,V2f)
                              & p(ap(c_2Efinite__map_2Eis__fmap(A_27a,A_27a),V2f)) ) ) ) ) ) ) ) ) )).
