...
thf(thm_2EConseqConv_2EIMP__CONG__cond__simple,conjecture,(
    ! [V0c: $o,V1x: $o,V2x_27: $o,V3y: $o,V4y_27: $o] :
      ( ( ( V2x_27
         => V1x )
        & ( V4y_27
         => V3y ) )
     => ( ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V0c @ V2x_27 @ V4y_27 )
       => ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ V0c @ V1x @ V3y ) ) ) )).
