...
thf(thm_2Ebasis__emit_2EFCPi__ind,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0P: ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Ebool_2Eitself @ A_27b ) ) > $o] :
      ( ! [V1f: tyop_2Enum_2Enum > A_27a] :
          ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Ebool_2Eitself @ A_27b ) @ V1f @ ( c_2Ebool_2Ethe__value @ A_27b ) ) )
     => ! [V2v: tyop_2Enum_2Enum > A_27a,V3v1: tyop_2Ebool_2Eitself @ A_27b] :
          ( V0P @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27a ) @ ( tyop_2Ebool_2Eitself @ A_27b ) @ V2v @ V3v1 ) ) ) )).
