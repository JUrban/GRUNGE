...
tff(conj_thm_2Elist_2EMEM__APPEND,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1l1: $i] :
...
tff(conj_thm_2Erich__list_2EEVERY2__APPEND,conjecture,(
             ...
             => ! [V3l3: $i] :
                 ...
                 => ! [V4l4: $i] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V1l1),V2l2))
                          & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V3l3),V4l4)) )
                      <=> ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),V3l3)),ap(ap(c_2Elist_2EAPPEND(A_27b),V2l2),V4l4)))
