    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
             ...
             => ap(f895(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f893(V1b)),V0a),V2t)),ap(ap(ap(c_2ETemporal__Logic_2EWHEN,f881(V1b)),V0a),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__AS__WHEN__UNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
