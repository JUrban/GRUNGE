...
tff(conj_thm_2Eiterate_2ESUM__CLAUSES__NUMSEG,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lmtp_f3413,type,(
    f3413: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3413,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : mem(f3413(V0a,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3413,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V4i: tp__ty_2Enum_2Enum] : ap(f3413(V0a,V1x),inj__ty_2Enum_2Enum(V4i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,inj__ty_2Enum_2Enum(V4i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Enum_2Enum(V4i))) ) )).

tff(lmtp_f3414,type,(
    f3414: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3414,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal] : mem(f3414(V0a,V2y),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3414,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal,V5i: tp__ty_2Enum_2Enum] : ap(f3414(V0a,V2y),inj__ty_2Enum_2Enum(V5i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,inj__ty_2Enum_2Enum(V5i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Enum_2Enum(V5i))) ) )).

tff(lmtp_f3416,type,(
    f3416: ( tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3416,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V6j: tp__ty_2Enum_2Enum,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3416(V2y,V6j,V0a),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3416,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V6j: tp__ty_2Enum_2Enum,V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V7i: tp__ty_2Enum_2Enum] : ap(f3416(V2y,V6j,V0a),inj__ty_2Enum_2Enum(V7i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V0a,inj__ty_2Enum_2Enum(V7i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2y)),ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V7i)),inj__ty_2Enum_2Enum(V6j))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) )).

tff(lmtp_f3415,type,(
    f3415: ( $i * tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3415,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] : mem(f3415(V0a,V2y,V3n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3415,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2y: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal,V6j: tp__ty_2Enum_2Enum] : ap(f3415(V0a,V2y,V3n,V1x),inj__ty_2Enum_2Enum(V6j)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6j)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V3n))),f3416(V2y,V6j,V0a))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Enum_2Enum(V6j))) ) )).

tff(conj_thm_2Eiterate_2EREAL__SUB__POLYFUN,lemma,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal,V3n: tp__ty_2Enum_2Enum] :
         ...
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),f3413(V0a,V1x))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n))),f3414(V0a,V2y)))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V2y))),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),f3415(V0a,V2y,V3n,V1x)))) ) ) )).

tff(lmtp_f3420,type,(
    f3420: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3420,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : mem(f3420(V1c,V3x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3420,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal,V4i: tp__ty_2Enum_2Enum] : ap(f3420(V1c,V3x),inj__ty_2Enum_2Enum(V4i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,inj__ty_2Enum_2Enum(V4i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V3x)),inj__ty_2Enum_2Enum(V4i))) ) )).

tff(lmtp_f3419,type,(
    f3419: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3419,axiom,(
...
tff(lameq_f3419,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3419(V0n,V1c),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n))),f3420(V1c,V3x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) )).

tff(lmtp_f3422,type,(
    f3422: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3422,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : mem(f3422(V1c,V5x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3422,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5x: tp__ty_2Erealax_2Ereal,V6i: tp__ty_2Enum_2Enum] : ap(f3422(V1c,V5x),inj__ty_2Enum_2Enum(V6i)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,inj__ty_2Enum_2Enum(V6i))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V5x)),inj__ty_2Enum_2Enum(V6i))) ) )).

tff(lmtp_f3421,type,(
    f3421: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3421,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f3421(V0n,V1c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3421,axiom,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3421(V0n,V1c),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n))),f3422(V1c,V5x))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))) ) )).

tff(conj_thm_2Eiterate_2EREAL__POLYFUN__ROOTBOUND,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ~ ! [V2i: tp__ty_2Enum_2Enum] :
       ...
       => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3419(V0n,V1c))))
          & p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Epred__set_2ECARD(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3421(V0n,V1c)))),inj__ty_2Enum_2Enum(V0n))) ) ) ) )).
