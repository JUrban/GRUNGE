...
fof(conj_thm_2Erich__list_2EEXISTS__LASTN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
         ...
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ! [V2P] :
                   ...
                   => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),V2P),ap(ap(c_2Erich__list_2ELASTN(A_27a),V0m),V1l)))
                     => p(ap(ap(c_2Elist_2EEXISTS(A_27a),V2P),V1l)) ) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EMEM__LASTN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => ! [V1l] :
             ...
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),ap(c_2Elist_2ELENGTH(A_27a),V1l)))
               => ! [V2x] :
                    ( mem(V2x,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Erich__list_2ELASTN(A_27a),V0m),V1l))))
