...
thf(arityeq3_2Emono_2Ec_2Ebinary__ieee_2Efloat__round_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0: mono_2Etyop_2Ebinary__ieee_2Erounding,X1: $o,X2: mono_2Etyop_2Erealax_2Ereal] :
      ( ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( c_2Ebinary__ieee_2Efloat__round_2E3 @ ( s @ tyop_2Ebinary__ieee_2Erounding @ ( i_mono_2Etyop_2Ebinary__ieee_2Erounding @ X0 ) ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X1 ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X2 ) ) ) )
      = ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Ebinary__ieee_2Erounding @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) ) ) @ c_2Ebinary__ieee_2Efloat__round_2E0 ) @ ( s @ tyop_2Ebinary__ieee_2Erounding @ ( i_mono_2Etyop_2Ebinary__ieee_2Erounding @ X0 ) ) ) ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ X1 ) ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X2 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Ebinary__ieee_2Eulp_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Ebinary__ieee_2Eulp_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebool_2Eitself @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ tyop_2Erealax_2Ereal ) @ c_2Ebinary__ieee_2Eulp_2E0 ) @ ( s @ ( tyop_2Ebool_2Eitself @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Elift__ieee_2Enon__representable__float__is__zero,conjecture,(
    ! [A_27a: d,A_27b: d,V0ff: mono_2Etyop_2Erealax_2Ereal,V1P: $o] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ ( mono_2Ec_2Ereal_2Eabs @ V0ff ) ) @ ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Ebinary__ieee_2Eulp_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
     => ( ( j_mono_2Etyop_2Erealax_2Ereal @ ( s @ tyop_2Erealax_2Ereal @ ( c_2Ebinary__ieee_2Efloat__to__real_2E1 @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( c_2Ebinary__ieee_2Efloat__round_2E3 @ ( s @ tyop_2Ebinary__ieee_2Erounding @ ( i_mono_2Etyop_2Ebinary__ieee_2Erounding @ mono_2Ec_2Ebinary__ieee_2EroundTiesToEven ) ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V1P ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V0ff ) ) ) ) ) ) )
        = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).
