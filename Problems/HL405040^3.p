...
thf(thm_2EOmega__Automata_2ENEG__DET__AUTOMATA,conjecture,(
    ! [A_27input: $tType,A_27state: $tType,V0t0: tyop_2Enum_2Enum,V1i: tyop_2Enum_2Enum > A_27input,V2TransRel: ( tyop_2Epair_2Eprod @ A_27input @ A_27state ) > A_27state,V3InitVal: A_27state,V4Accept: ( tyop_2Epair_2Eprod @ ( tyop_2Enum_2Enum > A_27input ) @ ( tyop_2Enum_2Enum > A_27state ) ) > $o] :
      ( ( (~)
        @ ? [V5q: tyop_2Enum_2Enum > A_27state] :
            ( ( ( V5q @ V0t0 )
              = V3InitVal )
            & ! [V6t: tyop_2Enum_2Enum] :
                ( ( V5q @ ( c_2Earithmetic_2E_2B @ V6t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                = ( V2TransRel @ ( c_2Epair_2E_2C @ A_27input @ A_27state @ ( V1i @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) @ ( V5q @ ( c_2Earithmetic_2E_2B @ V6t @ V0t0 ) ) ) ) )
            & ( V4Accept
              @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27input ) @ ( tyop_2Enum_2Enum > A_27state ) @ V1i
                @ ^ [V7t: tyop_2Enum_2Enum] :
                    ( V5q @ ( c_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) ) ) )
    <=> ? [V8q: tyop_2Enum_2Enum > A_27state] :
          ( ( ( V8q @ V0t0 )
            = V3InitVal )
          & ! [V9t: tyop_2Enum_2Enum] :
              ( ( V8q @ ( c_2Earithmetic_2E_2B @ V9t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
              = ( V2TransRel @ ( c_2Epair_2E_2C @ A_27input @ A_27state @ ( V1i @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) @ ( V8q @ ( c_2Earithmetic_2E_2B @ V9t @ V0t0 ) ) ) ) )
          & ( (~)
            @ ( V4Accept
              @ ( c_2Epair_2E_2C @ ( tyop_2Enum_2Enum > A_27input ) @ ( tyop_2Enum_2Enum > A_27state ) @ V1i
                @ ^ [V10t: tyop_2Enum_2Enum] :
                    ( V8q @ ( c_2Earithmetic_2E_2B @ V10t @ V0t0 ) ) ) ) ) ) ) )).
