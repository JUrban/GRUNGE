...
tff(conj_thm_2Ereal__topology_2EOPEN__INTERVAL__LEMMA,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
     ...
     => ? [V3d: tp__ty_2Erealax_2Ereal] :
          ...
          & ! [V4x_27: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V4x_27)),inj__ty_2Erealax_2Ereal(V2x)))),inj__ty_2Erealax_2Ereal(V3d)))
             => ( p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V4x_27)))
                & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V4x_27)),inj__ty_2Erealax_2Ereal(V1b))) ) ) ) ) )).
