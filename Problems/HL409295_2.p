...
tff(conj_thm_2Elift__ieee_2Efloat__to__real__threshold,lemma,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
     ...
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0x))
       => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0x))),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) ) ) )).

tff(conj_thm_2Elift__ieee_2Eerror__at__worst__lemma,lemma,(
...
tff(conj_thm_2Elift__ieee_2Eerror__is__zero,conjecture,(
    ! [A_27t: del,A_27w: del,V0a: $i] :
      ( mem(V0a,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
            & surj__ty_2Erealax_2Ereal(ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)) = V1x )
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Elift__ieee_2Eerror(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),inj__ty_2Erealax_2Ereal(V1x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).
