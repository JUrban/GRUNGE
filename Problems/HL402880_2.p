...
tff(conj_thm_2Elist_2ETAKE__DROP,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2ELENGTH__DROP,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
      ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EEVERY2__LENGTH,lemma,(
...
tff(conj_thm_2Elist_2ETAKE__LENGTH__TOO__LONG,lemma,(
    ! [A_27a: del,V0l: $i] :
...
tff(conj_thm_2Erich__list_2EEVERY2__APPEND,lemma,(
...
tff(conj_thm_2Erich__list_2EEVERY2__TAKE,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,arr(A_27b,bool)))
     => ! [V1xs: $i] :
         ...
         => ! [V2ys: $i] :
             ...
             => ! [V3n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),V1xs),V2ys))
                 => p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Elist_2ETAKE(A_27a),inj__ty_2Enum_2Enum(V3n)),V1xs)),ap(ap(c_2Elist_2ETAKE(A_27b),inj__ty_2Enum_2Enum(V3n)),V2ys))) ) ) ) ) )).
