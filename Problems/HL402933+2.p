...
fof(conj_thm_2EpatternMatches_2EPMATCH__ROW__CONG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                     ...
                                     => ! [V6v] :
                                         ...
                                         => ! [V7v_27] :
                                             ...
                                             => ( ( V0p = V1p_27
                                               ...
                                               => ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27c,A_27c,A_27c),V0p),V2g),V4r),V6v) = ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27c,A_27c,A_27c),V1p_27),V3g_27),V5r_27),V7v_27) ) ) ) ) ) ) ) ) ) ) ) ) )).
