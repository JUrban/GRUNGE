...
thf(thm_2Eordinal_2EordSUC__ZERO,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( (~)
      @ ( ( c_2Eordinal_2EordSUC @ A_27a @ V0a )
...
thf(thm_2Eordinal_2EADD1R,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2EordADD @ A_27a @ V0a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
      = ( c_2Eordinal_2EordSUC @ A_27a @ V0a ) ) )).
    ...
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o] :
     ...
     => ( ( ( c_2Eordinal_2Esup @ A_27a @ V0s )
      ...
      <=> ( ( V0s
            = ( c_2Epred__set_2EEMPTY @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) )
          | ( V0s
            = ( c_2Epred__set_2EINSERT @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ ( c_2Epred__set_2EEMPTY @ ( tyop_2Eordinal_2Eordinal @ A_27a ) ) ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordADD__EQ__0,conjecture,(
