...
thf(thm_2Ereal__topology_2EMONOTONE__SUBSEQUENCE,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
    ? [V1r: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
      ( ! [V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2m @ V3n )
         => ( mono_2Ec_2Eprim__rec_2E_3C @ ( V1r @ V2m ) @ ( V1r @ V3n ) ) )
      & ( ! [V4m: mono_2Etyop_2Enum_2Enum,V5n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4m @ V5n )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0s @ ( V1r @ V4m ) ) @ ( V0s @ ( V1r @ V5n ) ) ) )
        | ! [V6m: mono_2Etyop_2Enum_2Enum,V7n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V6m @ V7n )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0s @ ( V1r @ V7n ) ) @ ( V0s @ ( V1r @ V6m ) ) ) ) ) ) )).

thf(thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,axiom,(
...
thf(thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ! [V2n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( V0s @ V2n ) ) @ V1b )
          ...
          & ! [V7e: mono_2Etyop_2Erealax_2Ereal] :
             ...
             => ? [V8N: mono_2Etyop_2Enum_2Enum] :
                ! [V9n: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V8N @ V9n )
                 => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0s @ ( V4r @ V9n ) ) @ V3l ) ) @ V7e ) ) ) ) ) )).
