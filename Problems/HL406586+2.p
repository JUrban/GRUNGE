...
fof(ax_thm_2Esptree_2Ewf__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Esptree_2Ewf__insert,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0k] :
         ...
         => ! [V1a] :
             ...
             => ! [V2t] :
                 ...
                 => ( p(ap(c_2Esptree_2Ewf(A_27a),V2t))
                   => p(ap(c_2Esptree_2Ewf(A_27a),ap(ap(ap(c_2Esptree_2Einsert(A_27a),V0k),V1a),V2t))) ) ) ) ) ) )).
...
fof(conj_thm_2Esptree_2Ewf__fromAList,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
