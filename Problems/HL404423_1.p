...
tff(thm_2Ecardinal_2ESURJECTIVE__ON__IMAGE,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1u_2E0: u,V2v_2E0: u] :
      ( ! [V3t_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V3t_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2v_2E0)))))
         => ? [V4s_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Epred__set_2ESUBSET_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V4s_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1u_2E0)))))
    ...
    <=> ! [V5y_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27b,V5y_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2v_2E0)))))
         => ? [V6x_2E0: u] :
              ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V6x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1u_2E0)))))
