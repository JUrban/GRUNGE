...
tff(lmtp_f3227,type,(
    f3227: ( tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f3227,axiom,(
    ! [V2f: tp__ty_2Enum_2Enum,V3s: tp__ty_2Enum_2Enum] : mem(f3227(V2f,V3s),arr(ty_2Enum_2Enum,ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))) )).

tff(lameq_f3227,axiom,(
    ! [V2f: tp__ty_2Enum_2Enum,V3s: tp__ty_2Enum_2Enum,V4e: tp__ty_2Enum_2Enum] : ap(f3227(V2f,V3s),inj__ty_2Enum_2Enum(V4e)) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),ap(ap(c_2Earithmetic_2EMOD,inj__ty_2Enum_2Enum(V3s)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))),ap(ap(c_2Ebinary__ieee_2Efloat__Exponent__fupd(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),inj__ty_2Enum_2Enum(V4e)))),ap(ap(c_2Ebinary__ieee_2Efloat__Significand__fupd(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),inj__ty_2Enum_2Enum(V2f)))),c_2Ebool_2EARB(ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))))) )).

tff(lmtp_f3226,type,(
    f3226: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f3226,axiom,(
    ! [V2f: tp__ty_2Enum_2Enum] : mem(f3226(V2f),arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))))) )).

tff(lameq_f3226,axiom,(
    ! [V2f: tp__ty_2Enum_2Enum,V3s: tp__ty_2Enum_2Enum] : ap(f3226(V2f),inj__ty_2Enum_2Enum(V3s)) = f3227(V2f,V3s) )).

tff(lmtp_f3225,type,(
    f3225: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f3225,axiom,(
    ! [V1q: tp__ty_2Enum_2Enum] : mem(f3225(V1q),arr(ty_2Enum_2Enum,ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))),ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))) )).

tff(lameq_f3225,axiom,(
    ! [V1q: tp__ty_2Enum_2Enum,V2f: tp__ty_2Enum_2Enum] : ap(f3225(V1q),inj__ty_2Enum_2Enum(V2f)) = ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f3226(V2f))),ap(ap(c_2Ebit_2EDIVMOD__2EXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1q))) )).

tff(lmtp_f3224,type,(
    f3224: $i )).

tff(lamtp_f3224,axiom,(
...
tff(lameq_f3224,axiom,(
    ! [V1q: tp__ty_2Enum_2Enum] : ap(f3224,inj__ty_2Enum_2Enum(V1q)) = f3225(V1q) )).

tff(conj_thm_2Emachine__ieee_2Efp16__to__float__n2w,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] : surj__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(ap(c_2Emachine__ieee_2Efp16__to__float,ap(c_2Ewords_2En2w(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),inj__ty_2Enum_2Enum(V0n)))) = surj__c_ty_2Ebinary__ieee_2Efloat_c_ty_2Efcp_2Ebit0_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone_c_ty_2Efcp_2Ebit1_c_ty_2Efcp_2Ebit0_ty_2Eone_2Eone(ap(ap(c_2Ebool_2ELET(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Epair_2EUNCURRY(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),f3224)),ap(ap(c_2Ebit_2EDIVMOD__2EXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Enum_2Enum(V0n)))) )).
