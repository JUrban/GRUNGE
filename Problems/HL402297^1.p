...
thf(arityeq1_2Emono_2Ec_2Elist_2EALL__DISTINCT_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ tyop_2Emin_2Ebool ) @ c_2Elist_2EALL__DISTINCT_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2Elist_2EALL__DISTINCT__MAP__INJ,conjecture,(
    ! [A_27a: d,A_27b: d,V0ls_2E0: u,V1f_2E0: u] :
      ( ( ! [V2x_2E0: u,V3y_2E0: u] :
            ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) ) )
              & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V3y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) ) )
              & ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
                = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V3y_2E0 ) ) ) ) )
           => ( ( s @ A_27a @ V2x_2E0 )
              = ( s @ A_27a @ V3y_2E0 ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0ls_2E0 ) ) ) ) ) ) ) )).
