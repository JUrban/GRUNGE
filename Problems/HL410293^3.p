...
thf(thm_2Emeasure_2Emeasure__split,conjecture,(
    ! [A_27a: $tType,V0r: tyop_2Enum_2Enum > $o,V1b: tyop_2Enum_2Enum > A_27a > $o,V2m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Emeasure__space @ A_27a @ V2m )
        & ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ V0r )
        & ( ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1b @ V0r ) )
          = ( c_2Emeasure_2Em__space @ A_27a @ V2m ) )
        & ! [V3i: tyop_2Enum_2Enum,V4j: tyop_2Enum_2Enum] :
            ( ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V0r )
              & ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V4j @ V0r )
              & ( (~) @ ( V3i = V4j ) ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V1b @ V3i ) @ ( V1b @ V4j ) ) )
        & ! [V5i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V5i @ V0r )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( V1b @ V5i ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V2m ) ) ) )
     => ! [V6a: A_27a > $o] :
          ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V6a @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V2m ) )
         => ( ( c_2Emeasure_2Emeasure @ A_27a @ V2m @ V6a )
            = ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ tyop_2Enum_2Enum
              @ ^ [V7i: tyop_2Enum_2Enum] :
                  ( c_2Emeasure_2Emeasure @ A_27a @ V2m @ ( c_2Epred__set_2EINTER @ A_27a @ V6a @ ( V1b @ V7i ) ) )
              @ V0r ) ) ) ) )).
