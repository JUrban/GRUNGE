...
fof(conj_thm_2Equotient__pair_2EPAIR__REL__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ap(ap(c_2Equotient__pair_2E_23_23_23(A_27a,A_27a,A_27a,A_27a),c_2Emin_2E_3D(A_27a)),c_2Emin_2E_3D(A_27b)) = c_2Emin_2E_3D(ty_2Epair_2Eprod(A_27a,A_27a)) ) ) )).
