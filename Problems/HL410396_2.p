...
tff(lmtp_f3649,type,(
    f3649: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3649,axiom,(
    ! [V0op: $i] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : mem(f3649(V0op,V1x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3649,axiom,(
    ! [V0op: $i] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : ap(f3649(V0op,V1x),inj__ty_2Erealax_2Ereal(V2y)) = ap(ap(V0op,inj__ty_2Erealax_2Ereal(V2y)),inj__ty_2Erealax_2Ereal(V1x)) ) )).

tff(lmtp_f3648,type,(
    f3648: $i > $i )).

tff(lamtp_f3648,axiom,(
    ! [V0op: $i] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => mem(f3648(V0op),arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3648,axiom,(
    ! [V0op: $i] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : ap(f3648(V0op),inj__ty_2Erealax_2Ereal(V1x)) = f3649(V0op,V1x) ) )).

tff(conj_thm_2Ereal__topology_2EBILINEAR__SWAP,conjecture,(
    ! [V0op: $i] :
      ( mem(V0op,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ( p(ap(c_2Ereal__topology_2Ebilinear,f3648(V0op)))
