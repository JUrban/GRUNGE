...
thf(thm_2Eiterate_2ECARD__UNION__EQ,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1t: A_27a > $o,V2u: A_27a > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ A_27a @ V2u )
     ...
     => ( ( c_2Earithmetic_2E_2B @ ( c_2Epred__set_2ECARD @ A_27a @ V0s ) @ ( c_2Epred__set_2ECARD @ A_27a @ V1t ) )
        = ( c_2Epred__set_2ECARD @ A_27a @ V2u ) ) ) )).
    ...
    ! [A_27a: $tType,V0s: ( A_27a > $o ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ ( A_27a > $o ) @ V0s )
        & ! [V1t: A_27a > $o] :
           ...
           => ( c_2Epred__set_2EFINITE @ A_27a @ V1t ) )
        & ! [V2t: A_27a > $o,V3u: A_27a > $o] :
            ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ V0s )
              & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V3u @ V0s )
              & ( (~) @ ( V2t = V3u ) ) )
           => ( ( c_2Epred__set_2EINTER @ A_27a @ V2t @ V3u )
              = ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) )
     => ( ( c_2Epred__set_2ECARD @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V0s ) )
        = ( c_2Eiterate_2Ensum @ ( A_27a > $o ) @ V0s @ ( c_2Epred__set_2ECARD @ A_27a ) ) ) ) )).
