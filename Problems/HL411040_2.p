...
tff(conj_thm_2Ereal__topology_2EMONOTONE__SUBSEQUENCE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b: tp__ty_2Erealax_2Ereal] :
          ( ( ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
                ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n)))
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,inj__ty_2Enum_2Enum(V2m))),ap(V0s,inj__ty_2Enum_2Enum(V3n)))) )
            & ! [V4n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0s,inj__ty_2Enum_2Enum(V4n)))),inj__ty_2Erealax_2Ereal(V1b))) )
            ...
            ! [V6e: tp__ty_2Erealax_2Ereal] :
             ...
             => ? [V7N: tp__ty_2Enum_2Enum] :
                ! [V8n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V7N)),inj__ty_2Enum_2Enum(V8n)))
                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0s,inj__ty_2Enum_2Enum(V8n))),inj__ty_2Erealax_2Ereal(V5l)))),inj__ty_2Erealax_2Ereal(V6e))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECOMPACT__REAL__LEMMA,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b: tp__ty_2Erealax_2Ereal] :
