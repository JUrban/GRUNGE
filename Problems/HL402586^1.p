...
thf(f3095_0_2E0,type,(
    f3095_0_2E0: u )).

thf(f3095_0_2E1,type,(
    f3095_0_2E1: du > u )).

thf(f3095_0_2E3,type,(
...
thf(arityeq1_2Emono_2Ef3095_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ ( f3095_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) ) ) @ f3095_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3095_0_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( f3095_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X2_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ec_2Elist_2EFOLDR_2E3_2Emono_2EA_27a_20mono_2Etyop_2Elist_2Elist_28A_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
...
thf(def0_2Ethm_2Erich__list_2EMAP__FOLDR,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V2x_2E0: u,V3l_27_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( f3095_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V3l_27_2E0 ) ) )
...
thf(thm_2Erich__list_2EMAP__FOLDR,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1l_2E0: u] :
      ...
      = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EFOLDR_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27b ) ) ) @ ( f3095_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) ) ) )).
