...
thf(conj_thm_2EPast__Temporal__Logic_2EPSBEFORE__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
              ...
              = ( lam @ ty_2Enum_2Enum
                @ ^ [V7t: $i] :
                    ...
                    @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V1b )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V8t: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V0a @ V8t ) ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V8t ) ) ) ) )
                    @ V7t ) ) )
                ...
                @ ^ [V15t: $i] :
                    ...
                    @ ( ap
                      @ ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V1b )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V16t: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V16t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V16t ) ) ) ) )
                      @ V15t ) ) ) ) ) ) ) )).
