...
thf(conj_thm_2Ecardinal_2ECONJ__ACI,lemma,(
    ! [V0r: $o,V1p: $o,V2q: $o] :
      ( ( ( ( p @ ( inj__o @ V1p ) )
          & ( p @ ( inj__o @ V2q ) ) )
      <=> ( ( p @ ( inj__o @ V2q ) )
...
thf(conj_thm_2Ecardinal_2ECARD__LT__IMP__LE,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27b @ bool ) )
    ...
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ! [V2b: $i] :
              ( ( mem @ V2b @ A_27b )
             => ( ( p
                  @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V1a ) @ V2b ) )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) )
                      @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27b @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( lam @ A_27b
                              @ ^ [V4y: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V3x ) @ V4y ) ) @ ( ap @ ( ap @ V0P @ V3x ) @ V4y ) ) ) ) ) ) ) )
              <=> ( p @ ( ap @ ( ap @ V0P @ V1a ) @ V2b ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ESUBSET__NUMSEG,lemma,(
...
thf(conj_thm_2Eiterate_2ESUM__EQ__NUMSEG,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eiterate_2ESUM__CLAUSES__RIGHT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Eiterate_2ESUM__COMBINE__R,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Ereal_2EREAL__LT__RMUL__IMP,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__WLOG__LT,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Erealax_2Ereal @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ( ( ! [V1x: tp__ty_2Erealax_2Ereal] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
       ...
       => ! [V6x: tp__ty_2Erealax_2Ereal,V7y: tp__ty_2Erealax_2Ereal] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Erealax_2Ereal @ V6x ) ) @ ( inj__ty_2Erealax_2Ereal @ V7y ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELE__1,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( V0n != fo__c_2Enum_2E0 )
...
thf(conj_thm_2Ereal__topology_2ECARD__EQ__REAL,conjecture,(
    p @ ( ap @ ( ap @ ( c_2Ecardinal_2Ecardeq @ ty_2Erealax_2Ereal @ ( arr @ ty_2Enum_2Enum @ bool ) ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ ( c_2Epred__set_2EUNIV @ ( arr @ ty_2Enum_2Enum @ bool ) ) ) )).
