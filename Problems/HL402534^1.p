...
thf(f2936_0_2E0,type,(
    f2936_0_2E0: u )).

thf(f2936_0_2E2,type,(
    f2936_0_2E2: du > du > u )).
...
thf(mono_2Ef2936_0,type,(
    mono_2Ef2936_0: $o > $o > $o )).
...
thf(def0_2Ethm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__IMP__2,axiom,(
    ! [V2P1: $o,V3P2: $o] :
      ( ( mono_2Ef2936_0 @ V2P1 @ V3P2 )
    <=> ( V2P1
       => V3P2 ) ) )).

thf(thm_2EquantHeuristics_2ESIMPLE__GUESS__FORALL__IMP__2,conjecture,(
    ! [A_27a: d,V0v_2E0: u,V1i_2E0: u,V2P1: $o,V3P2: $o] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V3P2 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2ESIMPLE__GUESS__FORALL_2E3 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ A_27a @ V1i_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef2936_0 @ V2P1 @ V3P2 ) ) ) ) ) ) ) )).
