...
thf(thm_2Emeasure_2EINF__MEASURE__LE,axiom,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s: A_27a > $o,V2x: tyop_2Erealax_2Ereal] :
            ...
            @ ^ [V3r: tyop_2Erealax_2Ereal] :
                ...
                @ ( c_2Ebool_2E_3F @ ( tyop_2Enum_2Enum > A_27a > $o )
                  @ ^ [V4f: tyop_2Enum_2Enum > A_27a > $o] :
                      ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ ( tyop_2Enum_2Enum > A_27a > $o ) @ V4f @ ( c_2Epred__set_2EFUNSET @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2ESUBSET @ A_27a @ V1s @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V4f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) @ ( c_2Eseq_2Esums @ ( c_2Ecombin_2Eo @ tyop_2Enum_2Enum @ tyop_2Erealax_2Ereal @ ( A_27a > $o ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0m ) @ V4f ) @ V3r ) ) ) ) ) ) ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Emeasure_2Einf__measure @ A_27a @ V0m @ V1s ) @ V2x ) ) )).

thf(thm_2Emeasure_2EINF__MEASURE__CLOSE,axiom,(
    ...
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Eseq_2Esummable
          @ ^ [V2n: tyop_2Enum_2Enum] :
              ( c_2Erealax_2Ereal__add @ ( V0f @ V2n ) @ ( V1g @ V2n ) ) )
        & ( ( c_2Erealax_2Ereal__add @ ( c_2Eseq_2Esuminf @ V0f ) @ ( c_2Eseq_2Esuminf @ V1g ) )
          = ( c_2Eseq_2Esuminf
            @ ^ [V3n: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__add @ ( V0f @ V3n ) @ ( V1g @ V3n ) ) ) ) ) ) )).
...
thf(thm_2Eseq_2ESUMINF__2D,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1g: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2h: tyop_2Enum_2Enum > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( ! [V3m: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
            ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V3m @ V4n ) )
        & ! [V5n: tyop_2Enum_2Enum] :
            ( c_2Eseq_2Esums @ ( V0f @ V5n ) @ ( V1g @ V5n ) )
        & ( c_2Eseq_2Esummable @ V1g )
...
thf(thm_2Eseq_2EPOW__HALF__SER,axiom,
    ...
    @ ^ [V0n: tyop_2Enum_2Enum] :
        ( c_2Ereal_2Epow @ ( c_2Ereal_2E_2F @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Earithmetic_2E_2B @ V0n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
...
thf(thm_2Emeasure_2EINF__MEASURE__COUNTABLY__SUBADDITIVE,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) )] :
      ( ( ( c_2Emeasure_2Ealgebra @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0m ) ) )
        & ( c_2Emeasure_2Epositive @ A_27a @ V0m )
        & ( c_2Emeasure_2Eincreasing @ A_27a @ V0m ) )
     => ( c_2Emeasure_2Ecountably__subadditive @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ ( c_2Emeasure_2Em__space @ A_27a @ V0m ) ) @ ( c_2Emeasure_2Einf__measure @ A_27a @ V0m ) ) ) ) ) )).
