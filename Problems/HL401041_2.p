...
tff(ax_thm_2Ewhile_2ELEAST__DEF,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => surj__ty_2Enum_2Enum(ap(c_2Ewhile_2ELEAST,V0P)) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ewhile_2EWHILE(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),V0P)),c_2Enum_2ESUC),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).

tff(conj_thm_2Ewhile_2ELEAST__INTRO,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
