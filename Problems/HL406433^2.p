...
thf(conj_thm_2Ecomparison_2Egood__cmp__Less__trans,lemma,(
    ! [A_27a: del,V0cmp: $i] :
...
thf(conj_thm_2Ecomparison_2Egood__cmp__Less__irrefl__trans,conjecture,(
    ! [A_27a: del,V0cmp: $i] :
      ( ( mem @ V0cmp @ ( arr @ A_27a @ ( arr @ A_27a @ ty_2EternaryComparisons_2Eordering ) ) )
     => ( ( p @ ( ap @ ( c_2Ecomparison_2Egood__cmp @ A_27a ) @ V0cmp ) )
       => ( ( p
            ...
            @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a )
              @ ( lam @ A_27a
                @ ^ [V3k: $i] :
                    ( lam @ A_27a
                    @ ^ [V4k_27: $i] :
                        ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2EternaryComparisons_2Eordering ) @ ( ap @ ( ap @ V0cmp @ V3k ) @ V4k_27 ) ) @ ( inj__ty_2EternaryComparisons_2Eordering @ fo__c_2EternaryComparisons_2ELESS ) ) ) ) ) ) ) ) ) )).
