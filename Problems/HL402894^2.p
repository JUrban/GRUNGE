...
thf(conj_thm_2Erich__list_2ELENGTH__REPLICATE,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: $i] :
      ( ( mem @ V1x @ A_27a )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1x ) ) )
        = V0n ) ) )).
...
thf(conj_thm_2Erich__list_2EEL__REPLICATE,lemma,(
    ! [A_27a: del,V0n1: tp__ty_2Enum_2Enum,V1n2: tp__ty_2Enum_2Enum,V2x: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n1 ) ) @ ( inj__ty_2Enum_2Enum @ V1n2 ) ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n1 ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n2 ) ) @ V2x ) )
          = V2x ) ) ) )).

thf(conj_thm_2Erich__list_2EDROP__REPLICATE,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2a: $i] :
      ( ( mem @ V2a @ A_27a )
     => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V2a ) )
        = ( ap @ ( ap @ ( c_2Erich__list_2EREPLICATE @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V2a ) ) ) )).
