...
fof(lamtp_f764,axiom,(
    mem(f764,arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) )).

fof(lameq_f764,axiom,(
    ! [V2l_27] :
      ( mem(V2l_27,ty_2Enum_2Enum)
     => ap(f764,V2l_27) = ap(c_2Enum_2ESUC,V2l_27) ) )).

fof(conj_thm_2Erich__list_2ELENGTH__FOLDR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ap(c_2Elist_2ELENGTH(A_27a),V0l) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),k(A_27a,f764)),c_2Enum_2E0),V0l) ) ) )).
