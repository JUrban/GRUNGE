...
fof(conj_thm_2Eres__quan_2ERES__FORALL__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2Eres__quan_2ERES__EXISTS__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
...
fof(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__UNIV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0p] :
          ( mem(V0p,arr(A_27a,bool))
