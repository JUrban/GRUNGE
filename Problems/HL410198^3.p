...
thf(thm_2Emeasure_2EMEASURABLE__COMP__STRONG,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0f: A_27a > A_27b,V1g: A_27b > A_27c,V2a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V3b: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o ),V4c: tyop_2Epair_2Eprod @ ( A_27c > $o ) @ ( ( A_27c > $o ) > $o )] :
      ( ( ( c_2Ebool_2EIN @ ( A_27a > A_27b ) @ V0f @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V2a @ V3b ) )
        ...
        & ! [V5x: A_27c > $o] :
            ( ( c_2Ebool_2EIN @ ( A_27c > $o ) @ V5x @ ( c_2Emeasure_2Esubsets @ A_27c @ V4c ) )
           => ( c_2Ebool_2EIN @ ( A_27b > $o ) @ ( c_2Epred__set_2EINTER @ A_27b @ ( c_2Epred__set_2EPREIMAGE @ A_27b @ A_27c @ V1g @ V5x ) @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ ( c_2Emeasure_2Espace @ A_27a @ V2a ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27b @ V3b ) ) ) )
