...
tff(conj_thm_2Ebit_2EEXISTS__BIT__LT,lemma,(
...
tff(lamtp_f2240,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2240(A_27a,V0w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2240,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1i: tp__ty_2Enum_2Enum] : ap(f2240(A_27a,V0w),inj__ty_2Enum_2Enum(V1i)) = ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),inj__ty_2Enum_2Enum(V1i)) ) )).

tff(conj_thm_2Ewords_2ELEAST__BIT__LT,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ( V0w != ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))
       => p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Ewhile_2ELEAST,f2240(A_27a,V0w))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).
