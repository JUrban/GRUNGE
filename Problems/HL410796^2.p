...
thf(conj_thm_2Ereal__topology_2EOPEN__INTER,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__INTERIOR,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( p @ ( ap @ c_2Ereal__topology_2EOpen @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESUBSET__INTERIOR,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__INTER,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V1t ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__INTER__CLOSURE__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
           => ( ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V1t ) )
                = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
            <=> ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t )
                = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EINTERIOR__COMPLEMENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V0s ) )
        = ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__CLOSURE__INTER__OPEN,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V0s ) )
              & ( p @ ( ap @ c_2Ereal__topology_2EOpen @ V1t ) ) )
           => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V0s ) @ V1t ) ) )
              = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ c_2Ereal__topology_2Eclosure @ V1t ) ) ) ) ) ) ) )).
