...
fof(thm_2EordinalNotation_2Eoless__cases,conjecture,(
    ! [V0a0_2E0,V1a1_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eoless_2E2(s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0),s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0))))
    <=> ( ? [V2k1_2E0,V3k2_2E0] :
            ( s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,V2k1_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,V3k2_2E0)))
            & p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V2k1_2E0),s(tyop_2Enum_2Enum,V3k2_2E0)))) )
        | ? [V4k1_2E0,V5e2_2E0,V6k2_2E0,V7t2_2E0] :
            ( s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EEnd_2E1(s(tyop_2Enum_2Enum,V4k1_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V5e2_2E0),s(tyop_2Enum_2Enum,V6k2_2E0),s(tyop_2EordinalNotation_2Eosyntax,V7t2_2E0))) )
        | ? [V8e1_2E0,V9k1_2E0,V10t1_2E0,V11e2_2E0,V12k2_2E0,V13t2_2E0] :
            ( s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V8e1_2E0),s(tyop_2Enum_2Enum,V9k1_2E0),s(tyop_2EordinalNotation_2Eosyntax,V10t1_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V11e2_2E0),s(tyop_2Enum_2Enum,V12k2_2E0),s(tyop_2EordinalNotation_2Eosyntax,V13t2_2E0)))
            & p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eoless_2E2(s(tyop_2EordinalNotation_2Eosyntax,V8e1_2E0),s(tyop_2EordinalNotation_2Eosyntax,V11e2_2E0)))) )
        | ? [V14e1_2E0,V15k1_2E0,V16t1_2E0,V17e2_2E0,V18k2_2E0,V19t2_2E0] :
            ( s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V14e1_2E0),s(tyop_2Enum_2Enum,V15k1_2E0),s(tyop_2EordinalNotation_2Eosyntax,V16t1_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V17e2_2E0),s(tyop_2Enum_2Enum,V18k2_2E0),s(tyop_2EordinalNotation_2Eosyntax,V19t2_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V14e1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,V17e2_2E0)
            & p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V15k1_2E0),s(tyop_2Enum_2Enum,V18k2_2E0)))) )
        | ? [V20e1_2E0,V21k1_2E0,V22t1_2E0,V23e2_2E0,V24k2_2E0,V25t2_2E0] :
            ( s(tyop_2EordinalNotation_2Eosyntax,V0a0_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V20e1_2E0),s(tyop_2Enum_2Enum,V21k1_2E0),s(tyop_2EordinalNotation_2Eosyntax,V22t1_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V1a1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,c_2EordinalNotation_2EPlus_2E3(s(tyop_2EordinalNotation_2Eosyntax,V23e2_2E0),s(tyop_2Enum_2Enum,V24k2_2E0),s(tyop_2EordinalNotation_2Eosyntax,V25t2_2E0)))
            & s(tyop_2EordinalNotation_2Eosyntax,V20e1_2E0) = s(tyop_2EordinalNotation_2Eosyntax,V23e2_2E0)
            & s(tyop_2Enum_2Enum,V21k1_2E0) = s(tyop_2Enum_2Enum,V24k2_2E0)
            & p(s(tyop_2Emin_2Ebool,c_2EordinalNotation_2Eoless_2E2(s(tyop_2EordinalNotation_2Eosyntax,V22t1_2E0),s(tyop_2EordinalNotation_2Eosyntax,V25t2_2E0)))) ) ) ) )).
