...
tff(conj_thm_2Epath_2Elast__plink,conjecture,(
    ! [A_27a: del,A_27b: del,V0p1: $i] :
     ...
     => ! [V1p2: $i] :
         ...
         => ( ( p(ap(c_2Epath_2Efinite(A_27a,A_27a),V0p1))
           ...
           => ap(c_2Epath_2Elast(A_27a,A_27a),ap(ap(c_2Epath_2Eplink(A_27a,A_27a),V0p1),V1p2)) = ap(c_2Epath_2Elast(A_27a,A_27a),V1p2) ) ) ) )).
