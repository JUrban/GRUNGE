...
thf(f7568_0_2E0,type,(
    f7568_0_2E0: u )).

thf(f7568_0_2E1,type,(
    f7568_0_2E1: du > u )).

thf(f7568_0_2E2,type,(
    f7568_0_2E2: du > du > u )).
...
thf(mono_2Ef7568_0,type,(
    mono_2Ef7568_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(def0_2Ethm_2Ebitstring_2Erev__count__list__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef7568_0 @ V0n @ V1i )
...
thf(thm_2Ebitstring_2Erev__count__list__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ...
      = ( mono_2Ec_2Elist_2EGENLIST_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ef7568_0 @ V0n ) @ V0n ) ) )).
...
thf(thm_2Ebitstring_2Eel__rev__count__list,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1i: mono_2Etyop_2Enum_2Enum] :
