...
thf(ax_thm_2Ewellorder_2Eremove__def,axiom,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ewellorder_2Eremove @ A_27a ) @ V0e ) @ V1w )
                ...
                @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27a @ ( ty_2Epair_2Eprod @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( lam @ A_27a
                        @ ^ [V3y: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V2x ) @ V3y ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V2x ) @ V0e ) ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V3y ) @ V0e ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V2x ) @ V3y ) ) @ ( ap @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a ) @ V1w ) ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewellorder_2Ewellorder__remove,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1w: $i] :
          ( ( mem @ V1w @ ( ty_2Ewellorder_2Ewellorder @ A_27a ) )
...
thf(conj_thm_2Ewellorder_2EWIN__remove,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1y: $i] :
          ( ( mem @ V1y @ A_27a )
         => ! [V2e: $i] :
             ...
             => ! [V3w: $i] :
                 ...
                 => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27a ) @ V0x ) @ V1y ) ) @ ( ap @ ( c_2Eset__relation_2Estrict @ A_27a ) @ ( ap @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewellorder_2Eremove @ A_27a ) @ V2e ) @ V3w ) ) ) ) )
                  <=> ( ( V0x != V2e )
                      & ( V1y != V2e )
