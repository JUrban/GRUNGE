...
thf(conj_thm_2EfixedPoint_2Elfp__fixedpoint,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2EfixedPoint_2Elfp__induction,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2EfixedPoint_2Emonotone @ A_27a @ A_27a ) @ V0f ) )
       => ! [V1X: $i] :
...
thf(conj_thm_2EfixedPoint_2Elfp__strong__induction,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2EfixedPoint_2Emonotone @ A_27a @ A_27a ) @ V0f ) )
       => ! [V1X: $i] :
