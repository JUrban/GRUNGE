...
tff(lamtp_f1161,axiom,(
    ! [A_27a: del,V3h: $i] :
      ( mem(V3h,A_27a)
     => ! [V4t: $i] :
          ( mem(V4t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => mem(f1161(A_27a,V3h,V4t),arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a))) ) ) )).

tff(lameq_f1161,axiom,(
    ! [A_27a: del,V3h: $i] :
      ( mem(V3h,A_27a)
     => ! [V4t: $i] :
          ( mem(V4t,arr(ty_2Enum_2Enum,ty_2Eoption_2Eoption(A_27a)))
         => ! [V5n: tp__ty_2Enum_2Enum] : ap(f1161(A_27a,V3h,V4t),inj__ty_2Enum_2Enum(V5n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27a)),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Eoption_2ESOME(A_27a),V3h)),ap(V4t,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V5n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) ) )).

tff(conj_thm_2Ellist_2Elrep__ok__coind,conjecture,(
