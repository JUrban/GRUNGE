...
thf(thm_2Eextreal_2Eabs__pos,axiom,(
    ! [V0x: tyop_2Eextreal_2Eextreal] :
      ( c_2Eextreal_2Eextreal__le @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) @ ( c_2Eextreal_2Eextreal__abs @ V0x ) ) )).
...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__ABS,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1f: A_27a > tyop_2Eextreal_2Eextreal,V2g: A_27a > tyop_2Eextreal_2Eextreal] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        ...
        & ! [V3x: A_27a] :
           ...
           => ( ( V2g @ V3x )
              = ( c_2Eextreal_2Eextreal__abs @ ( V1f @ V3x ) ) ) ) )
