...
fof(lamtp_f635,axiom,(
    ! [A_27b,V1P] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V4q] :
          ( mem(V4q,bool)
         => mem(f635(A_27b,V1P,V4q),arr(A_27b,bool)) ) ) )).
...
fof(lameq_f635,axiom,(
    ! [A_27b,V1P] :
     ...
     => ! [V4q] :
         ...
         => ! [V23x] :
              ( mem(V23x,A_27b)
             => ap(f635(A_27b,V1P,V4q),V23x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1P,V23x)),V4q) ) ) ) )).

fof(lamtp_f636,axiom,(
    ! [A_27b,V2Q] :
      ( mem(V2Q,arr(A_27b,bool))
     => ! [V5p] :
          ( mem(V5p,bool)
         => mem(f636(A_27b,V2Q,V5p),arr(A_27b,bool)) ) ) )).
...
fof(lameq_f636,axiom,(
    ! [A_27b,V2Q] :
     ...
     => ! [V5p] :
         ...
         => ! [V25x] :
              ( mem(V25x,A_27b)
             => ap(f636(A_27b,V2Q,V5p),V25x) = ap(ap(c_2Ebool_2E_2F_5C,V5p),ap(V2Q,V25x)) ) ) ) )).

fof(lamtp_f637,axiom,(
    ! [A_27b,V1P] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V2Q] :
          ( mem(V2Q,arr(A_27b,bool))
...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__CONJ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
