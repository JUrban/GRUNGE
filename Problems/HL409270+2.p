...
fof(conj_thm_2Eintegral_2EINTEGRABLE__LIMIT,lemma,(
    ! [V0f] :
                     ...
                     => ? [V4g] :
                          ...
                          & ! [V5x] :
                             ...
                             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V5x))
                               ...
                               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V5x)),ap(V4g,V5x)))),V3e)) ) )
                          & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V4g)) ) ) )
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__COMBINE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2b] :
             ...
             => ! [V3c] :
                 ...
                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V2b))
                      ...
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2b)),V0f))
                      & p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2b),V3c)),V0f)) )
                   => p(ap(ap(c_2Eintegral_2Eintegrable,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V3c)),V0f)) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__POINT__SPIKE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ! [V2a] :
             ...
             => ! [V3b] :
                 ...
                 => ! [V4c] :
                     ...
                     => ( ( ! [V5x] :
                              ( mem(V5x,ty_2Erealax_2Ereal)
                             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V2a),V5x))
                                  & p(ap(ap(c_2Ereal_2Ereal__lte,V5x),V3b))
                                  & V5x != V4c )
...
fof(conj_thm_2Eintegral_2EBOLZANO__LEMMA__ALT,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Eintegral_2ECONT__UNIFORM,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
                          ...
                          & ! [V6x] :
                             ...
                             => ! [V7y] :
                                 ...
                                 => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V6x))
                                      ...
                                      & p(ap(ap(c_2Ereal_2Ereal__lte,V1a),V7y))
                                      & p(ap(ap(c_2Ereal_2Ereal__lte,V7y),V2b))
                                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V6x),V7y))),V5d)) )
                                   => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V6x)),ap(V0f,V7y)))),V4e)) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Eintegral_2EINTEGRABLE__CONTINUOUS,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
