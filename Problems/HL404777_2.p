...
tff(conj_thm_2Efinite__map_2EDRESTRICT__EQ__FUNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0h: $i] :
      ( mem(V0h,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1h1: $i] :
          ( mem(V1h1,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2h2: $i] :
              ( mem(V2h2,ty_2Efinite__map_2Efmap(A_27a,A_27a))
             => ( ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1h1)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2h2)))
                  & ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V1h1),V2h2) = V0h )
               => V2h2 = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0h),ap(c_2Epred__set_2ECOMPL(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1h1))) ) ) ) ) )).
