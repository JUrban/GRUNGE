...
fof(conj_thm_2Eoption_2EOPTION__MAP__EQ__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1x] :
                 ...
                 => ( ap(ap(c_2Eoption_2EOPTION__MAP(A_27a,A_27a),V0f),V1x) = c_2Eoption_2ENONE(A_27b)
                  <=> V1x = c_2Eoption_2ENONE(A_27a) ) ) ) ) ) )).

fof(conj_thm_2Eoption_2EOPTION__MAP__EQ__NONE__both__ways,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
