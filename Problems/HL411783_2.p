...
tff(conj_thm_2Epred__set_2EUNION__OVER__INTER,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Eiterate_2ENUMSEG__ADD__SPLIT,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Eiterate_2ESUM__UNION,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2EPARTIAL__SUMS__COMPONENT__LE__INFSUM,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
