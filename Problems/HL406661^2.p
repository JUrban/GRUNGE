...
thf(conj_thm_2Eint__arith_2Eeq__justify__multiplication,conjecture,(
    ! [V0n: tp__ty_2Einteger_2Eint,V1x: tp__ty_2Einteger_2Eint,V2y: tp__ty_2Einteger_2Eint] :
     ...
     => ( ( V1x = V2y )
      <=> ( ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0n ) ) @ ( inj__ty_2Einteger_2Eint @ V1x ) ) )
          = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0n ) ) @ ( inj__ty_2Einteger_2Eint @ V2y ) ) ) ) ) ) )).
