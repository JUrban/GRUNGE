...
tff(lmtp_f4247,type,(
    f4247: ( del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f4247,axiom,(
...
tff(lmtp_f4246,type,(
    f4246: ( del * del * del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4246,axiom,(
    ! [A_27c: del,A_27a: del,A_27c: del,A_27b: del,A_27b: del,V2Y: $i] :
      ( mem(V2Y,arr(A_27a,A_27c))
     => ! [V0p: $i] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1X: $i] :
...
tff(conj_thm_2Eprobability_2Ejoint__distribution__sums__1,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
