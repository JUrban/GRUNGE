...
tff(conj_thm_2EordinalNotation_2Eoless__cases,conjecture,(
    ...
    <=> ( ? [V2k1: tp__ty_2Enum_2Enum,V3k2: tp__ty_2Enum_2Enum] :
            ( V0a0 = surj__ty_2EordinalNotation_2Eosyntax(ap(c_2EordinalNotation_2EEnd,inj__ty_2Enum_2Enum(V2k1)))
            & V1a1 = surj__ty_2EordinalNotation_2Eosyntax(ap(c_2EordinalNotation_2EEnd,inj__ty_2Enum_2Enum(V3k2)))
        ...
        | ? [V4k1: tp__ty_2Enum_2Enum,V5e2: tp__ty_2EordinalNotation_2Eosyntax,V6k2: tp__ty_2Enum_2Enum,V7t2: tp__ty_2EordinalNotation_2Eosyntax] :
            ( V0a0 = surj__ty_2EordinalNotation_2Eosyntax(ap(c_2EordinalNotation_2EEnd,inj__ty_2Enum_2Enum(V4k1)))
            & V1a1 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V5e2)),inj__ty_2Enum_2Enum(V6k2)),inj__ty_2EordinalNotation_2Eosyntax(V7t2))) )
        | ? [V8e1: tp__ty_2EordinalNotation_2Eosyntax,V9k1: tp__ty_2Enum_2Enum,V10t1: tp__ty_2EordinalNotation_2Eosyntax,V11e2: tp__ty_2EordinalNotation_2Eosyntax,V12k2: tp__ty_2Enum_2Enum,V13t2: tp__ty_2EordinalNotation_2Eosyntax] :
            ( V0a0 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V8e1)),inj__ty_2Enum_2Enum(V9k1)),inj__ty_2EordinalNotation_2Eosyntax(V10t1)))
            & V1a1 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V11e2)),inj__ty_2Enum_2Enum(V12k2)),inj__ty_2EordinalNotation_2Eosyntax(V13t2)))
        ...
        | ? [V14e1: tp__ty_2EordinalNotation_2Eosyntax,V15k1: tp__ty_2Enum_2Enum,V16t1: tp__ty_2EordinalNotation_2Eosyntax,V17e2: tp__ty_2EordinalNotation_2Eosyntax,V18k2: tp__ty_2Enum_2Enum,V19t2: tp__ty_2EordinalNotation_2Eosyntax] :
            ( V0a0 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V14e1)),inj__ty_2Enum_2Enum(V15k1)),inj__ty_2EordinalNotation_2Eosyntax(V16t1)))
            & V1a1 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V17e2)),inj__ty_2Enum_2Enum(V18k2)),inj__ty_2EordinalNotation_2Eosyntax(V19t2)))
            & V14e1 = V17e2
        ...
        | ? [V20e1: tp__ty_2EordinalNotation_2Eosyntax,V21k1: tp__ty_2Enum_2Enum,V22t1: tp__ty_2EordinalNotation_2Eosyntax,V23e2: tp__ty_2EordinalNotation_2Eosyntax,V24k2: tp__ty_2Enum_2Enum,V25t2: tp__ty_2EordinalNotation_2Eosyntax] :
            ( V0a0 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V20e1)),inj__ty_2Enum_2Enum(V21k1)),inj__ty_2EordinalNotation_2Eosyntax(V22t1)))
            & V1a1 = surj__ty_2EordinalNotation_2Eosyntax(ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V23e2)),inj__ty_2Enum_2Enum(V24k2)),inj__ty_2EordinalNotation_2Eosyntax(V25t2)))
            & V20e1 = V23e2
            & V21k1 = V24k2
