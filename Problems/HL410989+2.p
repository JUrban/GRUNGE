...
fof(conj_thm_2Ereal__topology_2EIN__SPHERE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ESPHERE__EMPTY,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ereal__topology_2ESPHERE__SING,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
...
fof(conj_thm_2Ereal__topology_2ESPHERE__EQ__SING,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
