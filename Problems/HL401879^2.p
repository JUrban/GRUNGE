...
thf(conj_thm_2Epred__set_2EDIFF__INTER,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Epred__set_2EPREIMAGE__UNIV,lemma,(
...
thf(conj_thm_2Epred__set_2EPREIMAGE__COMPL__INTER,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1t: $i] :
