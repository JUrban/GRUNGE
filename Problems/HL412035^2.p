...
thf(conj_thm_2Elebesgue_2Eintegrable__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Elebesgue_2Eintegrable__sub,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f1: $i] :
          ( ( mem @ V1f1 @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
             ...
             => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
               ...
               => ( p
                  @ ( ap @ ( ap @ ( c_2Elebesgue_2Eintegrable @ A_27a ) @ V0m )
                    @ ( lam @ A_27a
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__sub @ ( ap @ V1f1 @ V3x ) ) @ ( ap @ V2f2 @ V3x ) ) ) ) ) ) ) ) ) )).
