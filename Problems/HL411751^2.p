...
thf(conj_thm_2Ereal__topology_2ESERIES__FINITE__SUPPORT,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__SUM,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
         ...
         => ! [V3s: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Enum_2Enum ) @ V3s ) )
                  ...
                  & ! [V4x: tp__ty_2Enum_2Enum] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4x ) ) )
                        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )
                  & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ V3s ) @ V0f ) )
                    = V1l ) )
