...
thf(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LE,lemma,(
    ! [V0R: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL__SUBTOPOLOGY,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ELIM__DROP__LE,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
...
thf(conj_thm_2Ereal__topology_2EDINI,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V2s ) )
                  & ! [V3n: tp__ty_2Enum_2Enum] :
                      ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V2s ) )
                  & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V1g ) @ V2s ) )
                        ...
                        @ ( ap
                          @ ( ap
                            @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V5n: $i] :
                                    ( ap @ ( ap @ V0f @ V5n ) @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) ) )
                            @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V4x ) ) )
               ...
               => ! [V8e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ereal__topology_2Eeventually @ ty_2Enum_2Enum )
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V9n: $i] :
                                ( ap @ ( c_2Ebool_2E_21 @ ty_2Erealax_2Ereal )
                                @ ( lam @ ty_2Erealax_2Ereal
                                  @ ^ [V10x: $i] :
                                      ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V10x ) @ V2s ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ V0f @ V9n ) @ V10x ) ) @ ( ap @ V1g @ V10x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V8e ) ) ) ) ) ) )
                        @ c_2Ereal__topology_2Esequentially ) ) ) ) ) ) ) )).
