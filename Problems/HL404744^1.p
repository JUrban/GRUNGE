...
thf(thm_2Efinite__map_2EFUPDATE__LIST__APPLY__NOT__MEM,axiom,(
    ! [A_27a: d,A_27b: d,V0kvl_2E0: u,V1f_2E0: u,V2k_2E0: u] :
      ( ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2k_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) ) ) ) ) )
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) @ ( s @ A_27a @ V2k_2E0 ) ) )
        = ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFUPDATE__LIST__APPLY__MEM,conjecture,(
    ! [A_27a: d,A_27b: d,V0kvl_2E0: u,V1f_2E0: u,V2k_2E0: u,V3v_2E0: u,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V4n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) )
        & ( ( s @ A_27a @ V2k_2E0 )
          = ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) ) )
        & ( ( s @ A_27b @ V3v_2E0 )
          = ( s @ A_27b @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27b ) @ c_2Epair_2ESND_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) ) )
        & ! [V5m: mono_2Etyop_2Enum_2Enum] :
            ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V4n @ V5m )
              & ( mono_2Ec_2Eprim__rec_2E_3C @ V5m @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) ) )
           => ( (~)
              @ ( ( s @ A_27a @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5m ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) ) )
                = ( s @ A_27a @ V2k_2E0 ) ) ) ) )
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) @ ( s @ A_27a @ V2k_2E0 ) ) )
        = ( s @ A_27b @ V3v_2E0 ) ) ) )).
