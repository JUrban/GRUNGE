...
thf(conj_thm_2Ellist_2Elrep__ok__cases,conjecture,(
    ! [A_27a: del,V0a0: $i] :
          ...
          | ? [V2h: $i] :
              ...
              & ? [V3t: $i] :
                  ...
                  & ( V0a0
                    = ( lam @ ty_2Enum_2Enum
                      @ ^ [V4n: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ V4n ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V2h ) ) @ ( ap @ V3t @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ V4n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
