...
fof(conj_thm_2Elist_2EALL__DISTINCT__MAP__INJ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0ls] :
             ...
             => ! [V1f] :
                 ...
                 => ( ( ! [V2x] :
                   ...
                   => p(ap(c_2Elist_2EALL__DISTINCT(A_27b),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1f),V0ls))) ) ) ) ) ) )).
...
fof(conj_thm_2Erich__list_2Eall__distinct__count__list,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => p(ap(c_2Elist_2EALL__DISTINCT(ty_2Enum_2Enum),ap(c_2Erich__list_2ECOUNT__LIST,V0n))) ) )).
