...
fof(conj_thm_2Epred__set_2Eis__measure__maximal__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,arr(A_27a,ty_2Enum_2Enum))
...
fof(conj_thm_2Epred__set_2Eis__measure__maximal__INSERT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Elist_2EisPREFIX__CONSR,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
...
fof(conj_thm_2Erich__list_2Ecommon__prefixes__NIL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Elist_2Elist(A_27a),bool))
...
fof(conj_thm_2Erich__list_2Elongest__prefix__NIL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Elist_2Elist(A_27a),bool))
...
fof(conj_thm_2Erich__list_2Elongest__prefix__PAIR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ys] :
