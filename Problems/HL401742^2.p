...
thf(conj_thm_2Earithmetic_2EABS__DIFF__SUMS,lemma,(
...
thf(conj_thm_2Epred__set_2EABS__DIFF__SUM__IMAGE,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1g: $i] :
                  ...
                  @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( ap @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a ) @ V0f ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a ) @ V1g ) @ V2s ) ) )
                    @ ( ap
                      @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V3x: $i] :
                              ( ap @ ( ap @ c_2Earithmetic_2EABS__DIFF @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) )
                      @ V2s ) ) ) ) ) ) ) )).
