...
thf(thm_2Ereal__topology_2EINTERIOR__NEGATIONS,axiom,(
      ...
      ( ( c_2Ereal__topology_2Einterior
        @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V1x: tyop_2Erealax_2Ereal] :
              ( c_2Erealax_2Ereal__neg @ V1x )
          @ V0s ) )
      = ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Erealax_2Ereal__neg @ V2x )
...
thf(thm_2Ereal__topology_2ESYMMETRIC__INTERIOR,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ! [V1x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s )
         => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V1x ) @ V0s ) )
     => ! [V2x: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ ( c_2Ereal__topology_2Einterior @ V0s ) )
         => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__neg @ V2x ) @ ( c_2Ereal__topology_2Einterior @ V0s ) ) ) ) )).
