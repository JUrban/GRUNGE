...
thf(thm_2Ereal__topology_2EDIST__TRIANGLE__ADD,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1x_27: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Erealax_2Ereal,V3y_27: mono_2Etyop_2Erealax_2Ereal] :
...
thf(thm_2Ereal__topology_2ENET__DILEMMA,axiom,(
    ! [A_27a: d,V0Q_2E0: u,V1P_2E0: u,V2net_2E0: u] :
      ( ( ? [V3a_2E0: u] :
            ( ? [V4x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V3a_2E0 ) ) ) )
            & ! [V5x_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V3a_2E0 ) ) ) )
        ...
        & ? [V6b_2E0: u] :
            ( ? [V7x_2E0: u] :
                ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V7x_2E0 ) @ ( s @ A_27a @ V6b_2E0 ) ) ) )
            & ! [V8x_2E0: u] :
                ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) @ ( s @ A_27a @ V6b_2E0 ) ) ) )
               => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0Q_2E0 ) @ ( s @ A_27a @ V8x_2E0 ) ) ) ) ) ) )
     => ? [V9c_2E0: u] :
          ( ? [V10x_2E0: u] :
              ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V10x_2E0 ) @ ( s @ A_27a @ V9c_2E0 ) ) ) )
          & ! [V11x_2E0: u] :
              ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ereal__topology_2Enetord_2E3 @ ( s @ ( tyop_2Ereal__topology_2Enet @ A_27a ) @ V2net_2E0 ) @ ( s @ A_27a @ V11x_2E0 ) @ ( s @ A_27a @ V9c_2E0 ) ) ) )
             => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27a @ V11x_2E0 ) ) ) )
                & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0Q_2E0 ) @ ( s @ A_27a @ V11x_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ELIM__ADD,conjecture,(
