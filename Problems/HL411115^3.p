...
thf(thm_2Ereal__topology_2EMONOTONE__BIGGER,axiom,(
    ! [V0r: tyop_2Enum_2Enum > tyop_2Enum_2Enum] :
      ( ! [V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ V1m @ V2n )
         => ( c_2Eprim__rec_2E_3C @ ( V0r @ V1m ) @ ( V0r @ V2n ) ) )
     => ! [V3n: tyop_2Enum_2Enum] :
          ( c_2Earithmetic_2E_3C_3D @ V3n @ ( V0r @ V3n ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__CLOSED__NEST,conjecture,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal > $o] :
      ( ( ! [V1n: tyop_2Enum_2Enum] :
        ...
        & ( c_2Ereal__topology_2Ebounded__def @ ( V0s @ c_2Enum_2E0 ) ) )
     => ? [V5a: tyop_2Erealax_2Ereal] :
        ! [V6n: tyop_2Enum_2Enum] :
          ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5a @ ( V0s @ V6n ) ) ) )).
