...
tff(conj_thm_2Ereal_2EREAL__IMP__SUP__LE,lemma,(
    ! [V0p: $i] :
...
tff(conj_thm_2Ereal_2EREAL__IMP__LE__SUP,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ? [V2r: tp__ty_2Erealax_2Ereal] : p(ap(V0p,inj__ty_2Erealax_2Ereal(V2r)))
...
tff(lmtp_f2747,type,(
    f2747: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2747,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2747(V0x),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2747,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1r: tp__ty_2Erealax_2Ereal] : ap(f2747(V0x),inj__ty_2Erealax_2Ereal(V1r)) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1r)),inj__ty_2Erealax_2Ereal(V0x)) )).

tff(conj_thm_2Ereal_2EREAL__SUP__CONST,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Esup,f2747(V0x))) = V0x )).
