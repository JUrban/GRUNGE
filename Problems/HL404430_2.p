...
tff(conj_thm_2Ecardinal_2ECARD__LE__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
           ...
           => ? [V2f: $i] :
                ( mem(V2f,arr(A_27a,A_27b))
                & p(ap(ap(c_2Epred__set_2ESUBSET(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V2f),V0s)),V1t))
                & ! [V3x: $i] :
                    ( mem(V3x,A_27a)
                   => ! [V4y: $i] :
                        ( mem(V4y,A_27a)
...
tff(conj_thm_2Ecardinal_2ESURJECTIVE__IFF__INJECTIVE__GEN,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Ecardinal_2ECARD__EQ__BIJECTION,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
