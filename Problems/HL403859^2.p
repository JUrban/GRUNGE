...
thf(ax_thm_2Ellist_2ELLENGTH,axiom,(
    ! [A_27a: del,V0ll: $i] :
     ...
     => ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0ll ) )
        = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum
          @ ( ap
            @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ ty_2Enum_2Enum ) ) @ ( ap @ ( c_2Ellist_2ELFINITE @ A_27a ) @ V0ll ) )
              @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum )
                @ ( ap @ ( c_2Emin_2E_40 @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V1n: $i] :
                        ( ap @ ( ap @ ( c_2Ellist_2Ellength__rel @ A_27a ) @ V0ll ) @ V1n ) ) ) ) )
...
thf(conj_thm_2Ellist_2ELLENGTH__THM,conjecture,(
    ! [A_27a: del,A_27b: del] :
