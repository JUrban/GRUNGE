...
thf(conj_thm_2Eind__type_2ENUMSUM__INJ,conjecture,(
    ! [V0b1: $o,V1x1: tp__ty_2Enum_2Enum,V2b2: $o,V3x2: tp__ty_2Enum_2Enum] :
      ( ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Eind__type_2ENUMSUM @ ( inj__o @ V0b1 ) ) @ ( inj__ty_2Enum_2Enum @ V1x1 ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Eind__type_2ENUMSUM @ ( inj__o @ V2b2 ) ) @ ( inj__ty_2Enum_2Enum @ V3x2 ) ) ) )
    <=> ( ( ( p @ ( inj__o @ V0b1 ) )
        <=> ( p @ ( inj__o @ V2b2 ) ) )
        & ( V1x1 = V3x2 ) ) ) )).
