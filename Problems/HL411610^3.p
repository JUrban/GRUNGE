...
thf(thm_2Ereal__topology_2ECONNECTED__IVT__COMPONENT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal,V3a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econnected @ V0s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s )
        & ( c_2Ereal_2Ereal__lte @ V1x @ V3a )
        & ( c_2Ereal_2Ereal__lte @ V3a @ V2y ) )
     => ? [V4z: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4z @ V0s )
          & ( V4z = V3a ) ) ) )).
...
thf(thm_2Ereal__topology_2EMAPPING__CONNECTED__ONTO__SEGMENT,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econnected @ V0s )
        & ( (~)
          @ ? [V3a: tyop_2Erealax_2Ereal] :
              ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V3a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) )
     => ? [V4f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ( c_2Ereal__topology_2Econtinuous__on @ V4f @ V0s )
          & ( ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V4f @ V0s )
