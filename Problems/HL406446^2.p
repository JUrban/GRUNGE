...
thf(conj_thm_2Ebitstring_2Ebitify__reverse__map,lemma,(
            ...
            @ ( ap @ ( c_2Elist_2EREVERSE @ ty_2Enum_2Enum )
              @ ( ap
                @ ( ap @ ( c_2Elist_2EMAP @ bool @ ty_2Enum_2Enum )
                  @ ( lam @ bool
                    @ ^ [V2b: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ V2b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
...
thf(conj_thm_2Elist_2EEVERY__EL,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1P: $i] :
...
thf(conj_thm_2Ebitstring_2Eevery__bit__bitify,conjecture,(
    ! [V0v: tp__c_ty_2Elist_2Elist_o] :
      ( p @ ( ap @ ( ap @ ( c_2Elist_2EEVERY @ ty_2Enum_2Enum ) @ ( ap @ c_2Earithmetic_2E_3E @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ c_2Ebitstring_2Ebitify @ ( c_2Elist_2ENIL @ ty_2Enum_2Enum ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) ) )).
