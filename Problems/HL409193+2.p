...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
               ...
               => ! [V1f_27] :
                   ...
                   => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V1f_27),V0P),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0P)))
                     => ! [V2f] :
                         ...
                         => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),V2f),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f_27),V0P)) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V2f),V1f_27)),V0P) ) ) ) ) ) ) ) )).
...
fof(lamtp_f3184,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V2s_27] :
          ( mem(V2s_27,arr(A_27b,bool))
         => mem(f3184(A_27b,A_27a,V0f,V2s_27),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3184,axiom,(
    ! [A_27b,A_27a,V0f] :
     ...
     => ! [V2s_27] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3184(A_27b,A_27a,V0f,V2s_27),V3x) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),ap(V0f,V3x)),V2s_27) ) ) ) )).

fof(lamtp_f3186,axiom,(
    ! [A_27b,A_27a,V0f] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,A_27b)
         => mem(f3186(A_27b,A_27a,V0f,V4x),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3186,axiom,(
    ! [A_27b,A_27a,V0f] :
     ...
     => ! [V4x] :
         ...
         => ! [V5y] :
              ( mem(V5y,A_27a)
             => ap(f3186(A_27b,A_27a,V0f,V4x),V5y) = ap(ap(V0f,V5y),V4x) ) ) ) )).

fof(lamtp_f3185,axiom,(
    ! [A_27a,A_27b,V0f] :
      ( mem(V0f,arr(A_27a,arr(A_27b,ty_2Erealax_2Ereal)))
     => ! [V1s] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f3185(A_27a,A_27b,V0f,V1s),arr(A_27b,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f3185,axiom,(
    ! [A_27a,A_27b,V0f] :
     ...
     => ! [V1s] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27b)
             => ap(f3185(A_27a,A_27b,V0f,V1s),V4x) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3186(A_27b,A_27a,V0f,V4x)),V1s) ) ) ) )).

fof(conj_thm_2Ereal__sigma_2ENESTED__REAL__SUM__IMAGE__REVERSE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1s] :
                 ...
                 => ! [V2s_27] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                       ...
                       => ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f3184(A_27b,A_27a,V0f,V2s_27)),V1s) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f3185(A_27a,A_27b,V0f,V1s)),V2s_27) ) ) ) ) ) ) )).
