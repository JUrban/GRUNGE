...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CAUCHY__IMP__UNIFORMLY__CONVERGENT,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Erealax_2Ereal)))
         => ! [V2l: $i] :
             ...
             => ( ( ! [V3e: tp__ty_2Erealax_2Ereal] :
                      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V3e)))
                     => ? [V4N: tp__ty_2Enum_2Enum] :
                        ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum,V7x: $i] :
                          ( mem(V7x,A_27a)
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V4N)),inj__ty_2Enum_2Enum(V5m)))
                              & p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V4N)),inj__ty_2Enum_2Enum(V6n)))
                              & p(ap(V0P,V7x)) )
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(V1s,inj__ty_2Enum_2Enum(V5m)),V7x)),ap(ap(V1s,inj__ty_2Enum_2Enum(V6n)),V7x)))),inj__ty_2Erealax_2Ereal(V3e))) ) ) )
                  & ! [V8x: $i] :
                      ( mem(V8x,A_27a)
                     => ( p(ap(V0P,V8x))
                       => ! [V9e: tp__ty_2Erealax_2Ereal] :
                           ...
                           => ? [V10N: tp__ty_2Enum_2Enum] :
                              ! [V11n: tp__ty_2Enum_2Enum] :
                                ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V10N)),inj__ty_2Enum_2Enum(V11n)))
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(V1s,inj__ty_2Enum_2Enum(V11n)),V8x)),ap(V2l,V8x)))),inj__ty_2Erealax_2Ereal(V9e))) ) ) ) ) )
               => ! [V12e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ? [V13N: tp__ty_2Enum_2Enum] :
                      ! [V14n: tp__ty_2Enum_2Enum,V15x: $i] :
                        ( mem(V15x,A_27a)
                       => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V13N)),inj__ty_2Enum_2Enum(V14n)))
                            & p(ap(V0P,V15x)) )
                         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(V1s,inj__ty_2Enum_2Enum(V14n)),V15x)),ap(V2l,V15x)))),inj__ty_2Erealax_2Ereal(V12e))) ) ) ) ) ) ) ) )).
