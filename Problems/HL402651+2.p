...
fof(conj_thm_2Erich__list_2EEXISTS__FOLDR__MAP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),V0P),V1l))
              <=> p(ap(ap(ap(c_2Elist_2EFOLDR(bool,bool),c_2Ebool_2E_5C_2F),c_2Ebool_2EF),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0P),V1l))) ) ) ) ) )).
