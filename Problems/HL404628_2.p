...
tff(conj_thm_2Efinite__map_2EFDOM__EQ__FDOM__FUPDATE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)))
           => ! [V2y: $i] :
                ( mem(V2y,A_27b)
               => ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y))) = ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f) ) ) ) ) )).
