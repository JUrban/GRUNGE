...
thf(conj_thm_2Ecardinal_2ESURJECTIVE__IMAGE,lemma,(
...
thf(conj_thm_2Epred__set_2EIMAGE__SUBSET,lemma,(
...
thf(conj_thm_2Ereal__topology_2EOPEN__SURJECTIVE__LINEAR__IMAGE,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__BIJECTIVE__LINEAR__IMAGE__EQ,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2EINTERIOR__BIJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ c_2Ereal__topology_2Elinear @ V0f ) )
              ...
              & ! [V4y: tp__ty_2Erealax_2Ereal] :
                ? [V5x: tp__ty_2Erealax_2Ereal] :
                  ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) )
                  = V4y ) )
           => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V1s ) )
              = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ c_2Ereal__topology_2Einterior @ V1s ) ) ) ) ) ) )).
