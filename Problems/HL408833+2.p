...
fof(conj_thm_2EHolSmt_2Er212,conjecture,(
    ! [V0u] :
             ...
             => ! [V3y] :
                 ...
                 => ! [V4z] :
                     ...
                     => ! [V5a] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2v),V3y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V4z)))),ap(c_2Erealax_2Ereal__neg,V5a)))
                          <=> ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V2v)),V3y)),V4z))),V5a)) ) ) ) ) ) ) ) )).
