...
fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__LE,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ! [V2x] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
               ...
               => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),ap(ap(c_2Ereal__topology_2Eclosest__point,V0s),V1a)))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2x)))) ) ) ) ) )).
