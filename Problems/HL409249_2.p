...
tff(conj_thm_2Eintegral_2EINTEGRAL__EQ,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Eintegral_2EDINT__POINT__SPIKE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2EDINT__FINITE__SPIKE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2a: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4s: $i] :
              ( mem(V4s,arr(ty_2Erealax_2Ereal,bool))
             => ! [V5i: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V4s))
                    & ! [V6x: tp__ty_2Erealax_2Ereal] :
                        ( ( p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V6x)))
                          & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V6x)),inj__ty_2Erealax_2Ereal(V3b)))
                          & ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6x)),V4s)) )
                       => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V6x))) = surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Erealax_2Ereal(V6x))) )
                    & p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V0f),inj__ty_2Erealax_2Ereal(V5i))) )
                 => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2a)),inj__ty_2Erealax_2Ereal(V3b))),V1g),inj__ty_2Erealax_2Ereal(V5i))) ) ) ) ) )).
