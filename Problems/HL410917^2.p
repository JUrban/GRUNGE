...
thf(conj_thm_2Ereal__topology_2EDIST__TRIANGLE__ADD,lemma,(
...
thf(conj_thm_2Ereal__topology_2ENET__DILEMMA,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1Q: $i] :
          ( ( mem @ V1Q @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ELIM__ADD,conjecture,(
    ! [A_27a: del,V0net: $i] :
