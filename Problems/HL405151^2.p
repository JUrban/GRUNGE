...
thf(conj_thm_2Ebag_2EBAG__INSERT__CHOICE__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( V0b
         != ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
       => ( V0b
          = ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ ( ap @ ( c_2Ebag_2EBAG__CHOICE @ A_27a ) @ V0b ) ) @ ( ap @ ( c_2Ebag_2EBAG__REST @ A_27a ) @ V0b ) ) ) ) ) )).

thf(conj_thm_2Ebag_2ESUB__BAG__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Econtainer_2EBAG__TO__LIST__THM,lemma,(
    ! [A_27a: del,V0bag: $i] :
...
thf(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Econtainer_2EBAG__IN__MEM,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
