...
thf(conj_thm_2Ereal__topology_2EREAL__SETDIST__LT__EXISTS,lemma,(
    ! [V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ! [V2b: tp__ty_2Erealax_2Ereal] :
              ( ( ( V0s
                ...
                & ( V1t
                 != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2Esetdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ V1t ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) )
             => ? [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EREAL__LT__HAUSDIST__POINT__EXISTS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ! [V2x: tp__ty_2Erealax_2Ereal,V3d: tp__ty_2Erealax_2Ereal] :
              ( ( ( p @ ( ap @ c_2Ereal__topology_2Ebounded__def @ V0s ) )
                ...
                & ( V1t
                 != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
                & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2Ehausdist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0s ) @ V1t ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) )
                & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ V0s ) ) )
             => ? [V4y: tp__ty_2Erealax_2Ereal] :
                  ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) @ V1t ) )
                  & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V3d ) ) ) ) ) ) ) )).
