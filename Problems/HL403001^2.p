               ...
               => ! [V5g_27: $i] :
                   ...
                   => ! [V6r_27: $i] :
                       ...
                       => ( ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2EPMATCH__FLATTEN__FUN @ A_27d @ A_27a @ A_27b ) @ V0p ) @ V3g )
                            @ ( lam @ A_27a
                              @ ^ [V7x: $i] :
                                  ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2EPMATCH__ROW @ A_27d @ A_27c @ A_27a ) @ V4p_27 ) @ ( ap @ V5g_27 @ V7x ) ) @ ( ap @ V6r_27 @ V7x ) ) ) )
                          = ( ap
                            @ ( ap
                              @ ( ap @ ( c_2EpatternMatches_2EPMATCH__ROW @ A_27d @ A_27c @ A_27b )
                                @ ( lam @ A_27c
                                  @ ^ [V8x: $i] :
                                      ( ap @ V0p @ ( ap @ V4p_27 @ V8x ) ) ) )
                              @ ( lam @ A_27c
                                @ ^ [V9x: $i] :
                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V3g @ ( ap @ V4p_27 @ V9x ) ) ) @ ( ap @ ( ap @ V5g_27 @ ( ap @ V4p_27 @ V9x ) ) @ V9x ) ) ) )
                            @ ( lam @ A_27c
                              @ ^ [V10x: $i] :
                                  ( ap @ ( ap @ V6r_27 @ ( ap @ V4p_27 @ V10x ) ) @ V10x ) ) ) ) ) ) ) ) ) ) )).
