...
thf(conj_thm_2Erich__list_2EBUTLASTN__1,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( ( V0l
         != ( c_2Elist_2ENIL @ A_27a ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ V0l )
          = ( ap @ ( c_2Elist_2EFRONT @ A_27a ) @ V0l ) ) ) ) )).
