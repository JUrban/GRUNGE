...
tff(thm_2Ewhile_2EOWHILE__IND,conjecture,(
    ! [A_27a: d,V0P_2E0: u,V1G_2E0: u,V2f_2E0: u] :
      ( ( ! [V3s_2E0: u] :
            ( ~ p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1G_2E0),s(A_27a,V3s_2E0)))))
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0P_2E0),s(A_27a,V3s_2E0))),s(A_27a,V3s_2E0))))) )
        & ! [V4s1_2E0: u,V5s2_2E0: u] :
            ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1G_2E0),s(A_27a,V4s1_2E0)))))
              & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0P_2E0),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(A_27a,V4s1_2E0))))),s(A_27a,V5s2_2E0))))) )
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0P_2E0),s(A_27a,V4s1_2E0))),s(A_27a,V5s2_2E0))))) ) )
     => ! [V6s1_2E0: u,V7s2_2E0: u] :
          ( s(tyop_2Eoption_2Eoption(A_27a),c_2Ewhile_2EOWHILE_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1G_2E0),s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(A_27a,V6s1_2E0))) = s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ESOME_2E1(s(A_27a,V7s2_2E0)))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0P_2E0),s(A_27a,V6s1_2E0))),s(A_27a,V7s2_2E0))))) ) ) )).
