...
thf(conj_thm_2Elist_2EEVERY__NOT__EXISTS,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
          ...
          <=> ~ ( p
                @ ( ap
                  @ ( ap @ ( c_2Elist_2EEXISTS @ A_27a )
                    @ ( lam @ A_27a
                      @ ^ [V2x: $i] :
                          ( ap @ c_2Ebool_2E_7E @ ( ap @ V0P @ V2x ) ) ) )
                  @ V1l ) ) ) ) ) )).

thf(conj_thm_2Elist_2EFILTER__EQ__NIL,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Elist_2EFILTER__NEQ__NIL,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
