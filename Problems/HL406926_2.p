...
tff(lamtp_f2652,axiom,(
    ! [A_27b: del,A_27a: del,V7z: $i] :
      ( mem(V7z,A_27b)
     => ! [V6w: $i] :
          ( mem(V6w,A_27a)
         => ! [V9cn: $i] :
              ( mem(V9cn,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))))
             => mem(f2652(A_27b,A_27a,V7z,V6w,V9cn),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V7z: $i] :
     ...
     => ! [V6w: $i] :
         ...
         => ! [V9cn: $i] :
              ( mem(V9cn,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))))
             => ! [V10m: $i] :
                  ( mem(V10m,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                 => ap(f2652(A_27b,A_27a,V7z,V6w,V9cn),V10m) = ap(V9cn,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6w),V7z)),V10m)) ) ) ) ) )).

tff(conj_thm_2Efmapal_2Elist__rplacv__cn__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Epair_2Eprod(A_27a,A_27a),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))),bool))))
     => ( ( ! [V1x: $i] :
              ( mem(V1x,A_27a)
             => ! [V2y: $i] :
                  ( mem(V2y,A_27b)
                 => ! [V3cn: $i] :
                      ( mem(V3cn,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))))
                     => p(ap(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y)),c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))),V3cn)) ) ) )
          & ! [V4x: $i] :
              ( mem(V4x,A_27a)
             => ! [V5y: $i] :
                  ( mem(V5y,A_27b)
                 => ! [V6w: $i] :
                     ...
                     => ! [V7z: $i] :
                          ( mem(V7z,A_27b)
                         => ! [V8l: $i] :
                              ( mem(V8l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                             => ! [V9cn: $i] :
                                  ( mem(V9cn,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))))
                                 => ( ( V4x != V6w
                                     => p(ap(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),V5y)),V8l),f2652(A_27b,A_27a,V7z,V6w,V9cn))) )
                                   => p(ap(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),V5y)),ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V6w),V7z)),V8l)),V9cn)) ) ) ) ) ) ) ) )
       => ! [V11v: $i] :
            ( mem(V11v,A_27a)
           => ! [V12v1: $i] :
                ( mem(V12v1,A_27b)
               => ! [V13v2: $i] :
                    ( mem(V13v2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                   => ! [V14v3: $i] :
                        ( mem(V14v3,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a))))
                       => p(ap(ap(ap(V0P,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V11v),V12v1)),V13v2),V14v3)) ) ) ) ) ) ) )).
