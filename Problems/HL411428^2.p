...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__MAXIMAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPONENTS__UNIQUE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1k: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPONENTS__UNIQUE__EQ,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1k: $i] :
          ( ( mem @ V1k @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
