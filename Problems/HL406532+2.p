...
fof(conj_thm_2Ebit_2EBITS__LT__LOW,lemma,(
    ! [V0h] :
...
fof(mem_c_2Ewords_2Eword__lsr__bv,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__lsr__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(lamtp_f2211,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => mem(f2211(A_27a,V0w,V1n),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f2211,axiom,(
    ! [A_27a,V0w] :
     ...
     => ! [V1n] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2211(A_27a,V0w,V1n),V2i) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,ap(ap(c_2Earithmetic_2E_2B,V2i),V1n)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2B,V2i),V1n))) ) ) ) )).
...
fof(ax_thm_2Ewords_2Eword__lsr__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0w] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__lsr(A_27a),V0w),V1n) = ap(c_2Efcp_2EFCP(bool,bool),f2211(A_27a,V0w,V1n)) ) ) ) )).
...
fof(conj_thm_2Ewords_2Edimindex__lt__dimword,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Ewords_2EWORD__EXTRACT__ZERO,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1l] :
                 ...
                 => ! [V2w] :
                     ...
                     => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0h),V1l))
                       => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),V2w) = ap(c_2Ewords_2En2w(A_27b),c_2Enum_2E0) ) ) ) ) ) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2k] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => mem(f2323(A_27a,V1m,V0w,V2k,V3a),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
...
fof(lamtp_f2322,axiom,(
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2k] :
              ( mem(V2k,ty_2Enum_2Enum)
             => mem(f2322(A_27a,V1m,V0w,V2k),arr(bool,arr(ty_2Enum_2Enum,bool))) ) ) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2k] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => ap(f2322(A_27a,V1m,V0w,V2k),V3a) = f2323(A_27a,V1m,V0w,V2k,V3a) ) ) ) ) )).

fof(lamtp_f2321,axiom,(
    ! [A_27a,V0w] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
