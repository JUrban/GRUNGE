...
thf(f12907_0_2E0,type,(
    f12907_0_2E0: u )).

thf(f12907_0_2E1,type,(
    f12907_0_2E1: du > u )).

thf(f12907_0_2E2,type,(
...
thf(mono_2Ef12907_0,type,(
    mono_2Ef12907_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ELINEAR__SCALING,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12907_0 @ V0c @ V1x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V0c @ V1x ) ) )).

thf(thm_2Ereal__topology_2ELINEAR__SCALING,conjecture,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Ereal__topology_2Elinear @ ( mono_2Ef12907_0 @ V0c ) ) )).
