...
tff(conj_thm_2Epred__set_2ECOMPL__EMPTY,lemma,(
...
tff(conj_thm_2Efinite__map_2EDRESTRICT__UNIV,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),c_2Epred__set_2EUNIV(A_27a)) = V0f ) )).

tff(lmtp_f1933,type,(
    f1933: ( del * del * del * $i ) > $i )).

tff(lamtp_f1933,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => mem(f1933(A_27a,A_27b,A_27a,V2k),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a))) ) )).

tff(lameq_f1933,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => ! [V3m: $i] :
          ( mem(V3m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ap(f1933(A_27a,A_27b,A_27a,V2k),V3m) = ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V3m),V2k) ) ) )).

tff(lmtp_f1932,type,(
    f1932: ( del * del * del ) > $i )).

tff(lamtp_f1932,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del] : mem(f1932(A_27b,A_27a,A_27a),arr(A_27a,arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) )).

tff(lameq_f1932,axiom,(
    ! [A_27b: del,A_27a: del,A_27a: del,V2k: $i] :
      ( mem(V2k,A_27a)
     => ap(f1932(A_27b,A_27a,A_27a),V2k) = f1933(A_27a,A_27b,A_27a,V2k) ) )).

tff(conj_thm_2Efinite__map_2EDRESTRICT__DOMSUB,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2k: $i] :
              ( mem(V2k,A_27a)
             => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),V1s)),V2k) = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V1s),V2k)) ) ) ) )).

tff(conj_thm_2Efinite__map_2Edrestrict__iter__list,conjecture,(
    ! [A_27a: del,A_27b: del,V0m: $i] :
      ( mem(V0m,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),f1932(A_27b,A_27a,A_27a)),V0m),V1l) = ap(ap(c_2Efinite__map_2EDRESTRICT(A_27a,A_27a),V0m),ap(c_2Epred__set_2ECOMPL(A_27a),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l))) ) ) )).
