...
thf(arityeq4_2Emono_2Ec_2Earithmetic_2ENRC_2E4_2Emono_2EA_27a,axiom,(
...
thf(thm_2Earithmetic_2ERTC__eq__NRC,axiom,(
    ...
    <=> ? [V3n: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Earithmetic_2ENRC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) ) ) )).
...
thf(thm_2Earithmetic_2ETC__eq__NRC,conjecture,(
    ! [A_27a: d,V0R_2E0: u,V1x_2E0: u,V2y_2E0: u] :
    ...
    <=> ? [V3n: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Earithmetic_2ENRC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enum_2ESUC @ V3n ) ) ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) ) ) )).
