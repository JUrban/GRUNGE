...
fof(conj_thm_2Eextreal_2Eadd__ldistrib,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ! [V2z] :
             ...
             => ( ( ( p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),V1y))
               ...
               => ap(ap(c_2Eextreal_2Eextreal__mul,V0x),ap(ap(c_2Eextreal_2Eextreal__add,V1y),V2z)) = ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V1y)),ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V2z)) ) ) ) ) )).

fof(conj_thm_2Eextreal_2Eadd__rdistrib,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
