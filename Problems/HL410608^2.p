...
thf(conj_thm_2Ereal__topology_2EDIST__MUL,lemma,(
...
thf(conj_thm_2Ereal__topology_2EBALL__SCALING,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
     ...
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2r: tp__ty_2Erealax_2Ereal] :
          ( ( ap @ c_2Ereal__topology_2Eball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ ( inj__ty_2Erealax_2Ereal @ V2r ) ) ) )
          = ( ap
            @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V3x: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ V3x ) ) )
            @ ( ap @ c_2Ereal__topology_2Eball @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( inj__ty_2Erealax_2Ereal @ V2r ) ) ) ) ) ) )).
