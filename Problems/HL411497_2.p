...
tff(lmtp_f3924,type,(
    f3924: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3924,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3924(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3924,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3924(V0a),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V3x)) )).

tff(lmtp_f3956,type,(
    f3956: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3956,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3956(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3956,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V4x: tp__ty_2Erealax_2Ereal] : ap(f3956(V0a),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V4x)) )).

tff(lmtp_f3957,type,(
    f3957: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3957,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : mem(f3957(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3957,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V5x: tp__ty_2Erealax_2Ereal] : ap(f3957(V0a),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V5x)) )).

tff(conj_thm_2Ereal__topology_2ETRANSLATION__DIFF,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2t: $i] :
          ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
         => ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3924(V0a)),ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),V1s),V2t)) = ap(ap(c_2Epred__set_2EDIFF(ty_2Erealax_2Ereal),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3956(V0a)),V1s)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3957(V0a)),V2t)) ) ) )).
