...
tff(conj_thm_2Ehreal_2EHREAL__MUL__SYM,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] : surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__mul,inj__ty_2Ehreal_2Ehreal(V0X)),inj__ty_2Ehreal_2Ehreal(V1Y))) = surj__ty_2Ehreal_2Ehreal(ap(ap(c_2Ehreal_2Ehreal__mul,inj__ty_2Ehreal_2Ehreal(V1Y)),inj__ty_2Ehreal_2Ehreal(V0X))) )).
...
tff(conj_thm_2Erealax_2EHREAL__RDISTRIB,conjecture,(
