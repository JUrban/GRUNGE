...
tff(ax_thm_2EordinalNotation_2Erank__def,axiom,
    ( ! [V0v0: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(c_2EordinalNotation_2Erank,ap(c_2EordinalNotation_2EEnd,inj__ty_2Enum_2Enum(V0v0)))) = fo__c_2Enum_2E0
    & ! [V1e: tp__ty_2EordinalNotation_2Eosyntax,V2k: tp__ty_2Enum_2Enum,V3t: tp__ty_2EordinalNotation_2Eosyntax] : surj__ty_2Enum_2Enum(ap(c_2EordinalNotation_2Erank,ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V1e)),inj__ty_2Enum_2Enum(V2k)),inj__ty_2EordinalNotation_2Eosyntax(V3t)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V1e)))) )).

tff(conj_thm_2EordinalNotation_2Eis__ord__downclosed,lemma,(
    ! [V0w: tp__ty_2EordinalNotation_2Eosyntax,V1k: tp__ty_2Enum_2Enum,V2t: tp__ty_2EordinalNotation_2Eosyntax] :
      ( p(ap(c_2EordinalNotation_2Eis__ord,ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V0w)),inj__ty_2Enum_2Enum(V1k)),inj__ty_2EordinalNotation_2Eosyntax(V2t))))
     => ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V0w)))
        & p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V2t))) ) ) )).

tff(conj_thm_2EordinalNotation_2Erank__less__imp__oless,lemma,(
    ! [V0x: tp__ty_2EordinalNotation_2Eosyntax,V1y: tp__ty_2EordinalNotation_2Eosyntax] :
      ( ( p(ap(c_2EordinalNotation_2Eis__ord,inj__ty_2EordinalNotation_2Eosyntax(V0x)))
        ...
        & p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V0x))),ap(c_2EordinalNotation_2Erank,inj__ty_2EordinalNotation_2Eosyntax(V1y)))) )
     => p(ap(ap(c_2EordinalNotation_2Eoless,inj__ty_2EordinalNotation_2Eosyntax(V0x)),inj__ty_2EordinalNotation_2Eosyntax(V1y))) ) )).

tff(conj_thm_2EordinalNotation_2Eoless__expt,conjecture,(
    ! [V0e: tp__ty_2EordinalNotation_2Eosyntax,V1k: tp__ty_2Enum_2Enum,V2t: tp__ty_2EordinalNotation_2Eosyntax] :
     ...
     => p(ap(ap(c_2EordinalNotation_2Eoless,inj__ty_2EordinalNotation_2Eosyntax(V0e)),ap(ap(ap(c_2EordinalNotation_2EPlus,inj__ty_2EordinalNotation_2Eosyntax(V0e)),inj__ty_2Enum_2Enum(V1k)),inj__ty_2EordinalNotation_2Eosyntax(V2t)))) ) )).
