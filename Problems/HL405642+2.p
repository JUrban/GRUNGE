...
fof(conj_thm_2Ecardinal_2ECARD__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eordinal_2Epreds__sup,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(conj_thm_2Eordinal_2Edclose__BIGUNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(lamtp_f2160,axiom,(
    ! [A_27a] : mem(f2160(A_27a),arr(ty_2Eordinal_2Eordinal(A_27a),ty_2Epair_2Eprod(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)))) )).

fof(lameq_f2160,axiom,(
    ! [A_27a,V0a] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
     => ap(f2160(A_27a),V0a) = ap(ap(c_2Epair_2E_2C(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),V0a),ap(c_2Epred__set_2Ecountable(ty_2Eordinal_2Eordinal(A_27a)),ap(c_2Eordinal_2Epreds(A_27a),V0a))) ) )).

fof(conj_thm_2Eordinal_2EcountableOrds__uncountable,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ~ p(ap(c_2Epred__set_2Ecountable(ty_2Eordinal_2Eordinal(A_27a)),ap(c_2Epred__set_2EGSPEC(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),f2160(A_27a)))) ) )).
