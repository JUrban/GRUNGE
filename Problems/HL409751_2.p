...
tff(conj_thm_2Eiterate_2ENSUM__SUPPORT,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Eiterate_2ENSUM__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Eiterate_2ENSUM__SUBSET,lemma,(
    ! [A_27a: del,V0u: $i] :
...
tff(conj_thm_2Eiterate_2ENSUM__LE__GEN,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
