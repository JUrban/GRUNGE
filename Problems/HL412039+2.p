...
fof(conj_thm_2Eextreal_2Eeq__neg,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ( ap(c_2Eextreal_2Eextreal__ainv,V0x) = ap(c_2Eextreal_2Eextreal__ainv,V1y)
          <=> V0x = V1y ) ) ) )).

fof(conj_thm_2Eextreal_2Eneg__sub,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ( ( ( V0x != c_2Eextreal_2ENegInf
           ...
           => ap(c_2Eextreal_2Eextreal__ainv,ap(ap(c_2Eextreal_2Eextreal__sub,V0x),V1y)) = ap(ap(c_2Eextreal_2Eextreal__sub,V1y),V0x) ) ) ) )).

fof(conj_thm_2Eextreal_2Emul__lneg,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2Eextreal__ainv,V0x)),V1y) = ap(c_2Eextreal_2Eextreal__ainv,ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V1y)) ) ) )).

fof(conj_thm_2Eextreal_2Emul__rneg,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ap(ap(c_2Eextreal_2Eextreal__mul,V0x),ap(c_2Eextreal_2Eextreal__ainv,V1y)) = ap(c_2Eextreal_2Eextreal__ainv,ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V1y)) ) ) )).

fof(conj_thm_2Eextreal_2Esub__ldistrib,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ! [V2z] :
             ...
             => ( ( V0x != c_2Eextreal_2ENegInf
               ...
               => ap(ap(c_2Eextreal_2Eextreal__mul,V0x),ap(ap(c_2Eextreal_2Eextreal__sub,V1y),V2z)) = ap(ap(c_2Eextreal_2Eextreal__sub,ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V1y)),ap(ap(c_2Eextreal_2Eextreal__mul,V0x),V2z)) ) ) ) ) )).
...
fof(lamtp_f3597,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3597(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3597,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V2x] :
              ( mem(V2x,A_27a)
             => ap(f3597(A_27a,V0f,V1c),V2x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(V0f,V2x)) ) ) ) )).

fof(lamtp_f3598,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3598(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3598,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3598(A_27a,V0f,V1c),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(ap(c_2Emeasure_2Efn__plus(A_27a),V0f),V3x)) ) ) ) )).

fof(lamtp_f3599,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3599(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3599,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3599(A_27a,V0f,V1c),V4x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(V0f,V4x)) ) ) ) )).

fof(lamtp_f3600,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3600(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3600,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f3600(A_27a,V0f,V1c),V5x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2Eextreal__ainv,ap(c_2Eextreal_2ENormal,V1c))),ap(ap(c_2Emeasure_2Efn__minus(A_27a),V0f),V5x)) ) ) ) )).

fof(conj_thm_2Emeasure_2EFN__PLUS__CMUL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V1c] :
             ...
             => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V1c))
                ...
                & ( p(ap(ap(c_2Ereal_2Ereal__lte,V1c),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                 => ap(c_2Emeasure_2Efn__plus(A_27a),f3599(A_27a,V0f,V1c)) = f3600(A_27a,V0f,V1c) ) ) ) ) ) )).

fof(lamtp_f3601,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3601(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3601,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f3601(A_27a,V0f,V1c),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V1c)),ap(ap(c_2Emeasure_2Efn__minus(A_27a),V0f),V3x)) ) ) ) )).

fof(lamtp_f3602,axiom,(
    ! [A_27a,V0f] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => mem(f3602(A_27a,V0f,V1c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
fof(lameq_f3602,axiom,(
    ! [A_27a,V0f] :
     ...
     => ! [V1c] :
         ...
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f3602(A_27a,V0f,V1c),V5x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2Eextreal__ainv,ap(c_2Eextreal_2ENormal,V1c))),ap(ap(c_2Emeasure_2Efn__plus(A_27a),V0f),V5x)) ) ) ) )).

fof(conj_thm_2Emeasure_2EFN__MINUS__CMUL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
fof(mem_c_2Elebesgue_2Eintegrable,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Elebesgue_2Eintegrable(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,ty_2Eextreal_2Eextreal),bool))) ) )).
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__pos,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Elebesgue_2Epos__fn__integral__cmul,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(lamtp_f4198,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2c] :
          ( mem(V2c,ty_2Erealax_2Ereal)
         => mem(f4198(A_27a,V1f,V2c),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f4198,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2c] :
          ( mem(V2c,ty_2Erealax_2Ereal)
         => ! [V3x] :
              ( mem(V3x,A_27a)
             => ap(f4198(A_27a,V1f,V2c),V3x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V2c)),ap(V1f,V3x)) ) ) ) )).

fof(conj_thm_2Elebesgue_2Eintegral__cmul,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ! [V2c] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                      & p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),V1f)) )
                   => ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),f4198(A_27a,V1f,V2c)) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,V2c)),ap(ap(c_2Elebesgue_2Eintegral(A_27a),V0m),V1f)) ) ) ) ) ) )).
