     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Ewords_2Ebit__count__upto @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1w ) )
        = ( surj__ty_2Enum_2Enum
          @ ( ap @ ( ap @ c_2Esum__num_2ESUM @ ( inj__ty_2Enum_2Enum @ V0n ) )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V2i: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ V2i ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Ebit__count__upto__SUC,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Ewords_2Ebit__count__upto @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ V0w ) )
