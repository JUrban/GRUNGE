...
fof(conj_thm_2Ereal__topology_2ECARD__EQ__REAL__IMP__UNCOUNTABLE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECARD__EQ__OPEN,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2EUNCOUNTABLE__OPEN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ( p(ap(c_2Ereal__topology_2EOpen,V0s))
          & V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
