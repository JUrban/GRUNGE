...
tff(conj_thm_2Eprobability_2ECOUNTABLY__ADDITIVE__PROB,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Ecountably__additive(A_27a),V0p))
      <=> ! [V1f: $i] :
            ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
           => ( ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Enum_2Enum,arr(A_27a,bool))),V1f),ap(ap(c_2Epred__set_2EFUNSET(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)),ap(c_2Eprobability_2Eevents(A_27a),V0p))))
                & ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
                    ( V2m != V3n
                   => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V1f,inj__ty_2Enum_2Enum(V2m))),ap(V1f,inj__ty_2Enum_2Enum(V3n)))) )
                & p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))),ap(c_2Eprobability_2Eevents(A_27a),V0p))) )
             => p(ap(ap(c_2Eseq_2Esums,ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Eprobability_2Eprob(A_27a),V0p)),V1f)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(c_2Epred__set_2EBIGUNION(A_27a),ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Epred__set_2EUNIV(ty_2Enum_2Enum)))))) ) ) ) ) )).
