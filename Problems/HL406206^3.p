...
thf(thm_2Ewords_2EWORD__LESS__TRANS,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1b: tyop_2Efcp_2Ecart @ $o @ A_27a,V2c: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__lt @ A_27a @ V0a @ V1b )
        & ( c_2Ewords_2Eword__lt @ A_27a @ V1b @ V2c ) )
     => ( c_2Ewords_2Eword__lt @ A_27a @ V0a @ V2c ) ) )).

thf(thm_2Ewords_2EWORD__LESS__EQ__TRANS,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a,V1b: tyop_2Efcp_2Ecart @ $o @ A_27a,V2c: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__le @ A_27a @ V0a @ V1b )
        & ( c_2Ewords_2Eword__le @ A_27a @ V1b @ V2c ) )
     => ( c_2Ewords_2Eword__le @ A_27a @ V0a @ V2c ) ) )).
...
thf(thm_2Ewords_2Eword__sub__w2n,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1y: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ewords_2Eword__ls @ A_27a @ V1y @ V0x )
     => ( ( c_2Ewords_2Ew2n @ A_27a @ ( c_2Ewords_2Eword__sub @ A_27a @ V0x @ V1y ) )
        = ( c_2Earithmetic_2E_2D @ ( c_2Ewords_2Ew2n @ A_27a @ V0x ) @ ( c_2Ewords_2Ew2n @ A_27a @ V1y ) ) ) ) )).

thf(thm_2Ewords_2EWORD__LE__EQ__LS,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1y: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__le @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V0x )
        & ( c_2Ewords_2Eword__le @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V1y ) )
     => ( ( c_2Ewords_2Eword__le @ A_27a @ V0x @ V1y )
        = ( c_2Ewords_2Eword__ls @ A_27a @ V0x @ V1y ) ) ) )).

thf(thm_2Ewords_2EWORD__LT__EQ__LO,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1y: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__le @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V0x )
        & ( c_2Ewords_2Eword__le @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V1y ) )
     => ( ( c_2Ewords_2Eword__lt @ A_27a @ V0x @ V1y )
...
thf(thm_2Ewords_2EWORD__LT__SUB__UPPER,conjecture,(
    ! [A_27a: $tType,V0x: tyop_2Efcp_2Ecart @ $o @ A_27a,V1y: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( ( c_2Ewords_2Eword__lt @ A_27a @ ( c_2Ewords_2En2w @ A_27a @ c_2Enum_2E0 ) @ V1y )
        & ( c_2Ewords_2Eword__lt @ A_27a @ V1y @ V0x ) )
     => ( c_2Ewords_2Eword__lt @ A_27a @ ( c_2Ewords_2Eword__sub @ A_27a @ V0x @ V1y ) @ V0x ) ) )).
