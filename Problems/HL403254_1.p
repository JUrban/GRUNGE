...
tff(thm_2Ebag_2EMEMBER__NOT__EMPTY,conjecture,(
    ! [A_27a: d,V0b_2E0: u] :
      ( ? [V1x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebag_2EBAG__IN_2E2(s(A_27a,V1x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b_2E0)))))
    <=> s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b_2E0) != s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),c_2Ebag_2EEMPTY__BAG_2E0) ) )).
