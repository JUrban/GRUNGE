...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__COMPOSE__EQ,lemma,(
...
tff(lmtp_f3921,type,(
    f3921: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3921,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3921(V0a,V2f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3921,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3921(V0a,V2f),inj__ty_2Erealax_2Ereal(V3x)) = ap(V2f,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__TRANSLATION,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1z: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V2f),ap(c_2Ereal__topology_2Eat,ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1z)))))
      <=> p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),f3921(V0a,V2f)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1z)))) ) ) )).
