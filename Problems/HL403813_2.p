...
tff(conj_thm_2Ellist_2ELNTH__rep,conjecture,(
    ! [A_27a: del,V0i: tp__ty_2Enum_2Enum,V1ll: $i] :
      ( mem(V1ll,ty_2Ellist_2Ellist(A_27a))
     => ap(ap(c_2Ellist_2ELNTH(A_27a),inj__ty_2Enum_2Enum(V0i)),V1ll) = ap(ap(c_2Ellist_2Ellist__rep(A_27a),V1ll),inj__ty_2Enum_2Enum(V0i)) ) )).
