...
tff(conj_thm_2Epath_2Efinite__seg,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epath_2Epath(A_27a,A_27a))
     => ! [V1i: tp__ty_2Enum_2Enum,V2j: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1i)),inj__ty_2Enum_2Enum(V2j)))
            & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2j)),ap(c_2Epath_2EPL(A_27a,A_27a),V0p))) )
         => p(ap(c_2Epath_2Efinite(A_27a,A_27a),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),inj__ty_2Enum_2Enum(V1i)),inj__ty_2Enum_2Enum(V2j)),V0p))) ) ) )).
