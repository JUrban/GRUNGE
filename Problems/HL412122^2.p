...
thf(mem_c_2Eprobability_2Eexpectation,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Eprobability_2Eexpectation @ A_27a ) @ ( arr @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ ( arr @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ ty_2Eextreal_2Eextreal ) ) ) )).
...
thf(mem_c_2Eprobability_2Ereal__random__variable,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Eprobability_2Ereal__random__variable @ A_27a ) @ ( arr @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ ( arr @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ bool ) ) ) )).
...
thf(conj_thm_2Eprobability_2Efinite__expectation2,lemma,(
    ! [A_27a: del,V0p: $i] :
...
thf(conj_thm_2Eprobability_2Efinite__support__expectation,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1X: $i] :
          ( ( mem @ V1X @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
              ...
              = ( surj__ty_2Eextreal_2Eextreal
                @ ( ap
                  @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ ty_2Eextreal_2Eextreal )
                    @ ( lam @ ty_2Eextreal_2Eextreal
                      @ ^ [V2r: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ V2r ) @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ ( ap @ ( c_2Eprobability_2Edistribution @ ty_2Eextreal_2Eextreal @ A_27a ) @ V0p ) @ V1X ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Eextreal_2Eextreal ) @ V2r ) @ ( c_2Epred__set_2EEMPTY @ ty_2Eextreal_2Eextreal ) ) ) ) ) ) )
                  @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ ty_2Eextreal_2Eextreal ) @ V1X ) @ ( ap @ ( c_2Eprobability_2Ep__space @ A_27a ) @ V0p ) ) ) ) ) ) ) ) )).
