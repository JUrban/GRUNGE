...
thf(thm_2Elist_2EAPPEND__LENGTH__EQ,axiom,(
    ! [A_27a: d,V0l1_2E0: u,V1l1_27_2E0: u] :
      ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) )
        = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_27_2E0 ) ) ) ) )
     => ! [V2l2_2E0: u,V3l2_27_2E0: u] :
          ( ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) ) )
            = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l2_27_2E0 ) ) ) ) )
         => ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) )
              = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_27_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l2_27_2E0 ) ) ) )
          <=> ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 )
                = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_27_2E0 ) )
...
thf(thm_2Elist_2EAPPEND__11__LENGTH,conjecture,(
    ! [A_27a: d] :
