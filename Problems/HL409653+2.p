...
fof(lamtp_f1874,axiom,(
    ! [A_27a,V4x] :
     ...
     => ! [V2f] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => mem(f1874(A_27a,V4x,V2f,V1n),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
     ...
     => ! [V2f] :
         ...
         => ! [V1n] :
             ...
             => ! [V5m] :
                 ...
                 => ap(f1874(A_27a,V4x,V2f,V1n),V5m) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Eprim__rec_2E_3C,V5m),V1n)),ap(ap(c_2Emin_2E_3D(A_27a),ap(V2f,V5m)),V4x)) ) ) ) ) )).

fof(conj_thm_2Ecardinal_2EHAS__SIZE__INDEX,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Eiterate_2EFINITE__INDEX__NUMSEG,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
