...
thf(conj_thm_2Eextreal_2Ele__antisym,lemma,(
...
thf(conj_thm_2Eextreal_2Ele__sup__imp,lemma,(
    ! [V0p: $i] :
...
thf(conj_thm_2Eextreal_2Esup__le__sup__imp,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
     => ! [V1q: $i] :
...
thf(conj_thm_2Eextreal_2Ele__max2,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
      ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__max @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) ) ) )).

thf(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__IMAGE,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
     => ! [V1P_27: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( ( ? [V3x: tp__ty_2Eextreal_2Eextreal] :
                  ...
                  & ? [V4z: tp__ty_2Eextreal_2Eextreal] :
                      ( ( V4z != fo__c_2Eextreal_2EPosInf )
                      & ! [V5x: tp__ty_2Eextreal_2Eextreal] :
                          ( ( p @ ( ap @ V0P @ ( inj__ty_2Eextreal_2Eextreal @ V5x ) ) )
                         => ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V5x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V4z ) ) ) ) )
                  & ( V0P
                    = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ ty_2Eextreal_2Eextreal ) @ V2f ) @ V1P_27 ) ) )
               => ? [V6g: $i] :
                    ( ( mem @ V6g @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) )
                    & ! [V7n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ V6g @ ( inj__ty_2Enum_2Enum @ V7n ) ) ) @ V1P_27 ) )
...
thf(ax_thm_2Elebesgue_2Emax__fn__seq__def,axiom,(
    ! [A_27a: del] :
      ( ! [V0g: $i] :
          ( ( mem @ V0g @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) )
         => ! [V1x: $i] :
              ( ( mem @ V1x @ A_27a )
             => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Emax__fn__seq @ A_27a ) @ V0g ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V1x ) )
                = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ V0g @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V1x ) ) ) ) )
      & ! [V2g: $i] :
          ( ( mem @ V2g @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) )
         => ! [V3n: tp__ty_2Enum_2Enum,V4x: $i] :
              ( ( mem @ V4x @ A_27a )
             => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Emax__fn__seq @ A_27a ) @ V2g ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V4x ) )
                = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__max @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Emax__fn__seq @ A_27a ) @ V2g ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ V4x ) ) @ ( ap @ ( ap @ V2g @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V4x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2EEXTREAL__SUP__FUN__SEQ__MONO__IMAGE,conjecture,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1P: $i] :
         ...
         => ! [V2P_27: $i] :
             ...
             => ( ( ? [V3x: tp__ty_2Eextreal_2Eextreal] :
                      ( p @ ( ap @ V1P @ ( inj__ty_2Eextreal_2Eextreal @ V3x ) ) )
                  & ? [V4z: tp__ty_2Eextreal_2Eextreal] :
                      ( ( V4z != fo__c_2Eextreal_2EPosInf )
                      & ! [V5x: tp__ty_2Eextreal_2Eextreal] :
                          ( ( p @ ( ap @ V1P @ ( inj__ty_2Eextreal_2Eextreal @ V5x ) ) )
                         => ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V5x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V4z ) ) ) ) )
                  & ( V1P
                    = ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ ty_2Eextreal_2Eextreal ) @ V0f ) @ V2P_27 ) )
                  & ! [V6g1: $i] :
                           ...
                           => ( p
                              @ ( ap
                                @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                                  @ ( lam @ A_27a
                                    @ ^ [V11x: $i] :
                                        ( ap @ ( ap @ c_2Eextreal_2Eextreal__max @ ( ap @ V9g1 @ V11x ) ) @ ( ap @ V10g2 @ V11x ) ) ) )
                                @ V2P_27 ) ) ) ) ) )
               => ? [V12g: $i] :
                    ( ( mem @ V12g @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) )
                    & ! [V13n: tp__ty_2Enum_2Enum] :
                        ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ ( ap @ V12g @ ( inj__ty_2Enum_2Enum @ V13n ) ) ) @ V2P_27 ) )
                    & ! [V14x: $i] :
                        ( ( mem @ V14x @ A_27a )
                       => ! [V15n: tp__ty_2Enum_2Enum] :
                            ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ ( ap @ V12g @ ( inj__ty_2Enum_2Enum @ V15n ) ) @ V14x ) ) @ ( ap @ ( ap @ V12g @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V15n ) ) ) @ V14x ) ) ) )
                    & ( ( surj__ty_2Eextreal_2Eextreal
                        @ ( ap @ c_2Eextreal_2Eextreal__sup
                          @ ( ap
                            @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V16n: $i] :
                                    ( ap @ V0f @ ( ap @ V12g @ V16n ) ) ) )
                            @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) )
                      = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ c_2Eextreal_2Eextreal__sup @ V1P ) ) ) ) ) ) ) ) )).
