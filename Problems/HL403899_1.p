...
tff(thm_2Ellist_2Einfinite__lnth__some,conjecture,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( ~ p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ellist_2ELFINITE_2E1(s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0)))))
    <=> ! [V1n_2E0: mono_2Etyop_2Enum_2Enum] :
        ? [V2x_2E0: u] : s(tyop_2Eoption_2Eoption(A_27a),c_2Ellist_2ELNTH_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1n_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0))) = s(tyop_2Eoption_2Eoption(A_27a),c_2Eoption_2ESOME_2E1(s(A_27a,V2x_2E0))) ) )).
