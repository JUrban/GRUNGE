...
tff(lmtp_f2739,type,(
    f2739: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2739,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2739(V2k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2739,axiom,(
    ! [V2k: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V4r: tp__ty_2Enum_2Enum] : ap(f2739(V2k,V0f),inj__ty_2Enum_2Enum(V4r)) = ap(V0f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4r)),inj__ty_2Enum_2Enum(V2k))) ) )).

tff(conj_thm_2Ereal_2ESUM__REINDEX,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1m: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V2k))),inj__ty_2Enum_2Enum(V3n))),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1m)),inj__ty_2Enum_2Enum(V3n))),f2739(V2k,V0f))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__ABS__TRIANGLE,lemma,(
...
tff(conj_thm_2Etransc_2EDINT__UNIQ,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2ELE__0,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] : p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V0n))) )).

tff(conj_thm_2Eintegral_2EREAL__LT__MIN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Eintegral_2EDIVISION__DSIZE__LE,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2d: $i] :
      ( mem(V2d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2d))
            & surj__ty_2Erealax_2Ereal(ap(V2d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))) = surj__ty_2Erealax_2Ereal(ap(V2d,inj__ty_2Enum_2Enum(V3n))) )
         => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Etransc_2Edsize,V2d)),inj__ty_2Enum_2Enum(V3n))) ) ) )).

tff(conj_thm_2Eintegral_2EDIVISION__DSIZE__EQ,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2d: $i] :
      ( mem(V2d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2d))
            & p(ap(ap(c_2Erealax_2Ereal__lt,ap(V2d,inj__ty_2Enum_2Enum(V3n))),ap(V2d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))))
            & surj__ty_2Erealax_2Ereal(ap(V2d,ap(c_2Enum_2ESUC,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n))))) = surj__ty_2Erealax_2Ereal(ap(V2d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n)))) )
         => surj__ty_2Enum_2Enum(ap(c_2Etransc_2Edsize,V2d)) = surj__ty_2Enum_2Enum(ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V3n))) ) ) )).

tff(conj_thm_2Eintegral_2EDIVISION__DSIZE__EQ__ALT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2d: $i] :
      ( mem(V2d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V3n: tp__ty_2Enum_2Enum] :
          ( ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2d))
            ...
            & ! [V4i: tp__ty_2Enum_2Enum] :
                ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4i)),inj__ty_2Enum_2Enum(V3n)))
               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(V2d,inj__ty_2Enum_2Enum(V4i))),ap(V2d,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V4i))))) ) )
         => surj__ty_2Enum_2Enum(ap(c_2Etransc_2Edsize,V2d)) = V3n ) ) )).

tff(conj_thm_2Eintegral_2EDIVISION__INTERMEDIATE,lemma,(
    ! [V0d: $i] :
      ( mem(V0d,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Eintegral_2EDINT__COMBINE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
