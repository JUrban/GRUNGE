...
fof(conj_thm_2Earithmetic_2ELE__ADD__LCANCEL,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elogroot_2EEXP__LE__ISO,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Elogroot_2EROOT__UNIQUE,lemma,(
    ! [V0r] :
      ( mem(V0r,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Elogroot_2EROOT__DIV,lemma,(
    ! [V0r] :
      ( mem(V0r,ty_2Enum_2Enum)
     => ! [V1x] :
...
fof(lamtp_f228,axiom,(
    ! [V1n] :
      ( mem(V1n,ty_2Enum_2Enum)
     => ! [V0r] :
          ( mem(V0r,ty_2Enum_2Enum)
         => mem(f228(V1n,V0r),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) ) )).
    ...
    ! [V1n] :
     ...
     => ! [V0r] :
         ...
         => ! [V2x] :
             ...
             => ap(f228(V1n,V0r),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,V1n),ap(ap(c_2Earithmetic_2EEXP,ap(c_2Enum_2ESUC,V2x)),V0r))),V2x),ap(c_2Enum_2ESUC,V2x)) ) ) ) )).

fof(conj_thm_2Elogroot_2EROOT__COMPUTE,conjecture,(
    ! [V0r] :
      ( mem(V0r,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
