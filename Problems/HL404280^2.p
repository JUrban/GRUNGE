...
thf(conj_thm_2EDecode_2Eenc2dec__dec2enc,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1d: $i] :
          ( ( mem @ V1d @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) )
...
thf(conj_thm_2EDecode_2Eencode__then__decode__blist,lemma,(
...
thf(conj_thm_2EDecode_2Edecode__blist,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1d: $i] :
          ( ( mem @ V1d @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) )
                                          ...
                                          @ ^ [V8v: $i] :
                                              ...
                                              @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                                                @ ^ [V9xs: $i] :
                                                    ( lam @ ( ty_2Elist_2Elist @ bool )
                                                    @ ^ [V10t_27: $i] :
                                                        ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Epair_2Eprod @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ bool ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ bool ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V6x ) @ V9xs ) ) @ V10t_27 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
