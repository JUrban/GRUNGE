...
thf(f13996_0_2E0,type,(
    f13996_0_2E0: u )).

thf(f13996_0_2E1,type,(
    f13996_0_2E1: du > u )).

thf(f13996_0_2E2,type,(
    f13996_0_2E2: du > du > u )).

thf(f13996_1_2E0,type,(
    f13996_1_2E0: u )).

thf(f13996_1_2E2,type,(
    f13996_1_2E2: du > du > u )).
...
thf(mono_2Ef13996_0,type,(
    mono_2Ef13996_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13996_1,type,(
    mono_2Ef13996_1: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,axiom,(
    ! [V1y: mono_2Etyop_2Erealax_2Ereal,V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13996_1 @ V1y @ V0s )
    <=> ? [V2n: mono_2Etyop_2Enum_2Enum] :
          ( V1y
          = ( V0s @ V2n ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1y: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13996_0 @ V0s @ V1y )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V1y @ ( mono_2Ef13996_1 @ V1y @ V0s ) ) ) )).

thf(thm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Ecauchy @ V0s )
     => ( mono_2Ec_2Ereal__topology_2Ebounded__def @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13996_0 @ V0s ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONVERGENT__IMP__BOUNDED,conjecture,(
