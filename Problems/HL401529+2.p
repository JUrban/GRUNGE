...
fof(conj_thm_2Epred__set_2EIMAGE__DELETE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1x] :
                 ...
                 => ! [V2s] :
                     ...
                     => ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),V2s))
                       => ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EDELETE(A_27a),V2s),V1x)) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s) ) ) ) ) ) ) )).
