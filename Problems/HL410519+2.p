...
fof(conj_thm_2Ereal__topology_2EIMAGE__SING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2ELINEAR__COMPOSE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
...
fof(conj_thm_2Ereal__topology_2EINDEPENDENT__SING,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1b] :
...
fof(conj_thm_2Ereal__topology_2ELINEAR__EQ__STDBASIS,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ELINEAR__INJECTIVE__LEFT__INVERSE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
          & ! [V1x] :
