...
tff(lameq_f285,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2e: $i] :
          ( mem(V2e,A_27a)
         => ! [V3acc: tp__ty_2Enum_2Enum] : ap(f285(A_27a,V0f,V2e),inj__ty_2Enum_2Enum(V3acc)) = ap(ap(c_2Earithmetic_2E_2B,ap(V0f,V2e)),inj__ty_2Enum_2Enum(V3acc)) ) ) )).

tff(lmtp_f284,type,(
    f284: ( del * $i ) > $i )).

tff(lamtp_f284,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
...
tff(ax_thm_2Epred__set_2ESUM__IMAGE__DEF,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => surj__ty_2Enum_2Enum(ap(ap(c_2Epred__set_2ESUM__IMAGE(A_27a),V0f),V1s)) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Epred__set_2EITSET(A_27a,A_27a),f284(A_27a,V0f)),V1s),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).
...
tff(conj_thm_2Elist_2EITSET__eq__FOLDL__SET__TO__LIST,lemma,(
...
tff(conj_thm_2Elist_2ESUM__MAP__FOLDL,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1ls: $i] :
...
tff(conj_thm_2Elist_2ESUM__IMAGE__eq__SUM__MAP__SET__TO__LIST,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1f: $i] :
