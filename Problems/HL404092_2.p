...
tff(lamtp_f1529,axiom,(
    ! [V2a: $i] :
      ( mem(V2a,arr(ty_2Enum_2Enum,bool))
     => mem(f1529(V2a),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1529,axiom,(
    ! [V2a: $i] :
      ( mem(V2a,arr(ty_2Enum_2Enum,bool))
     => ! [V4t: tp__ty_2Enum_2Enum] : ap(f1529(V2a),inj__ty_2Enum_2Enum(V4t)) = ap(c_2Ebool_2E_7E,ap(V2a,inj__ty_2Enum_2Enum(V4t))) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2ENO__PAST__EVENT,conjecture,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,bool))
     => ! [V1t: tp__ty_2Enum_2Enum,V2a: $i] :
          ( mem(V2a,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,f934(V0b)),inj__ty_2Enum_2Enum(V1t)))
           => ( ( p(ap(ap(ap(c_2EPast__Temporal__Logic_2EPWHEN,V2a),V0b),inj__ty_2Enum_2Enum(V1t)))
              ...
              <=> p(ap(ap(c_2EPast__Temporal__Logic_2EPALWAYS,f1529(V2a)),inj__ty_2Enum_2Enum(V1t))) )
