...
thf(conj_thm_2Ecardinal_2EHAS__SIZE__CLAUSES,lemma,(
...
thf(conj_thm_2Eiterate_2ECHOOSE__SUBSET__STRONG,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EFRONTIER__CLOSURES,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ c_2Ereal__topology_2Efrontier @ V0s )
        = ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eclosure @ V0s ) ) @ ( ap @ c_2Ereal__topology_2Eclosure @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ ( c_2Epred__set_2EUNIV @ ty_2Erealax_2Ereal ) ) @ V0s ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECARD__FRONTIER__INTERVAL,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ c_2Ereal__topology_2Eis__interval @ V0s ) )
       => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) )
          & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Epred__set_2ECARD @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Efrontier @ V0s ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
