...
fof(conj_thm_2Elist_2EMEM__FLAT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Elist_2EMEM__REVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
...
fof(conj_thm_2Elist_2EALL__DISTINCT__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
...
fof(conj_thm_2Elist_2EALL__DISTINCT__FLAT__REVERSE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0xs] :
