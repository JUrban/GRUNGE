...
thf(thm_2EDecode_2Ewf__decode__blist,conjecture,(
    ! [A_27a: $tType,V0m: tyop_2Enum_2Enum,V1p: A_27a > $o,V2d: ( tyop_2Elist_2Elist @ $o ) > ( tyop_2Eoption_2Eoption @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Elist_2Elist @ $o ) ) )] :
      ( ( c_2EDecode_2Ewf__decoder @ A_27a @ V1p @ V2d )
     => ( c_2EDecode_2Ewf__decoder @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EEncode_2Elift__blist @ A_27a @ V0m @ V1p ) @ ( c_2EDecode_2Edecode__blist @ A_27a @ ( c_2EEncode_2Elift__blist @ A_27a @ V0m @ V1p ) @ V0m @ V2d ) ) ) )).
