...
tff(conj_thm_2Equotient__list_2EAPPEND__PRS,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1abs: $i] :
          ( mem(V1abs,arr(A_27a,A_27b))
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => ! [V3l: $i] :
                   ...
                   => ! [V4m: $i] :
                       ...
                       => ap(ap(c_2Elist_2EAPPEND(A_27b),V3l),V4m) = ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1abs),ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V3l)),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V2rep),V4m))) ) ) ) ) ) ) )).
