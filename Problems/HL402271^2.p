...
thf(conj_thm_2Elist_2EsplitAtPki__EQN,lemma,(
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Eoption_2Eoption__CASE @ ty_2Enum_2Enum @ A_27a )
                      @ ( ap @ c_2Ewhile_2EOLEAST
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V3i: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V3i ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27b ) @ V2l ) ) ) @ ( ap @ ( ap @ V0P @ V3i ) @ ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27b ) @ V3i ) @ V2l ) ) ) ) ) )
                    @ ( ap @ ( ap @ V1k @ V2l ) @ ( c_2Elist_2ENIL @ A_27b ) ) )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V4i: $i] :
                        ( ap @ ( ap @ V1k @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27b ) @ V4i ) @ V2l ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27b ) @ V4i ) @ V2l ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Elist_2ETAKE__LENGTH__TOO__LONG,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Ewhile_2EOLEAST__INTRO,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Elist_2ETAKE__splitAtPki,conjecture,(
