...
thf(tp_c_2Earithmetic_2Enum__CASE,type,(
    c_2Earithmetic_2Enum__CASE: del > $i )).

thf(mem_c_2Earithmetic_2Enum__CASE,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Earithmetic_2Enum__case__def,axiom,(
    ! [A_27a: del] :
      ( ! [V0v: $i] :
          ( ( mem @ V0v @ A_27a )
         => ! [V1f: $i] :
              ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2Enum__CASE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0v ) @ V1f )
                = V0v ) ) )
      & ! [V2n: tp__ty_2Enum_2Enum,V3v: $i] :
          ( ( mem @ V3v @ A_27a )
         => ! [V4f: $i] :
              ( ( mem @ V4f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
             => ( ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2Enum__CASE @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V3v ) @ V4f )
                = ( ap @ V4f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2ECLOSED__CDI__DUNION,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Emeasure_2ECLOSED__CDI__INCREASING,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA1,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Emeasure_2Ealgebra @ A_27a ) @ V0a ) )
       => ! [V1s: $i] :
...
thf(conj_thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA2,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Emeasure_2Ealgebra @ A_27a ) @ V0a ) )
       => ! [V1s: $i] :
