...
tff(conj_thm_2Estate__transformer_2EBIND__LEFT__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0k: $i] :
      ( mem(V0k,arr(A_27a,arr(A_27b,ty_2Epair_2Eprod(A_27c,A_27c))))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ap(ap(c_2Estate__transformer_2EBIND(A_27b,A_27b,A_27b),ap(c_2Estate__transformer_2EUNIT(A_27b,A_27b),V1x)),V0k) = ap(V0k,V1x) ) ) )).
