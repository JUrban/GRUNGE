...
tff(conj_thm_2Erich__list_2EREPLICATE__GENLIST,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1x: $i] :
      ( mem(V1x,A_27a)
     => ap(ap(c_2Erich__list_2EREPLICATE(A_27a),inj__ty_2Enum_2Enum(V0n)),V1x) = ap(ap(c_2Elist_2EGENLIST(A_27a),ap(c_2Ecombin_2EK(A_27a,A_27a),V1x)),inj__ty_2Enum_2Enum(V0n)) ) )).
