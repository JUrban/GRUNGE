...
tff(conj_thm_2Elim_2ECONT__CONST,lemma,(
...
tff(conj_thm_2Elim_2ECONT__MUL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Elim_2ECONT__SUB,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Elim_2Econtl,V0f),inj__ty_2Erealax_2Ereal(V2x)))
                & p(ap(ap(c_2Elim_2Econtl,V1g),inj__ty_2Erealax_2Ereal(V2x))) )
             => p(ap(ap(c_2Elim_2Econtl,f2910(V0f,V1g)),inj__ty_2Erealax_2Ereal(V2x))) ) ) ) )).
...
tff(lmtp_f2921,type,(
    f2921: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f2921,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f2921(V1a,V2b,V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2921,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2921(V1a,V2b,V0f),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V2b))),ap(V0f,inj__ty_2Erealax_2Ereal(V1a)))),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V1a)))),inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(lmtp_f2922,type,(
    f2922: ( tp__ty_2Erealax_2Ereal * tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f2922,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f2922(V1a,V2b,V0f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f2922,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f2922(V1a,V2b,V0f),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V4x))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V2b))),ap(V0f,inj__ty_2Erealax_2Ereal(V1a)))),ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V2b)),inj__ty_2Erealax_2Ereal(V1a)))),inj__ty_2Erealax_2Ereal(V4x))) ) )).

tff(conj_thm_2Elim_2EMVT__LEMMA,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(f2921(V1a,V2b,V0f),inj__ty_2Erealax_2Ereal(V1a))) = surj__ty_2Erealax_2Ereal(ap(f2922(V1a,V2b,V0f),inj__ty_2Erealax_2Ereal(V2b))) ) )).

tff(conj_thm_2Elim_2EMVT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1a)),inj__ty_2Erealax_2Ereal(V2b)))
