...
tff(conj_thm_2Earithmetic_2EFUNPOW__1,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Ewellorder_2EWIN__WLE,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Ewellorder_2EWLE__WIN,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1y: $i] :
          ( mem(V1y,A_27a)
...
tff(conj_thm_2Ewellorder_2Eorderlt__REFL,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Ewellorder_2Ewellorder(A_27a))
