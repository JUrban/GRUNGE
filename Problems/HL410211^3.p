...
thf(thm_2Emeasure_2ESTRONG__MEASURE__SPACE__SUBSET,conjecture,(
    ! [A_27a: $tType,V0s: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ),V1s_27: A_27a > $o] :
      ( ( ( c_2Epred__set_2ESUBSET @ A_27a @ V1s_27 @ ( c_2Emeasure_2Em__space @ A_27a @ V0s ) )
        & ( c_2Emeasure_2Emeasure__space @ A_27a @ V0s )
        & ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Epred__set_2EPOW @ A_27a @ V1s_27 ) @ ( c_2Emeasure_2Emeasurable__sets @ A_27a @ V0s ) ) )
     => ( c_2Emeasure_2Emeasure__space @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( tyop_2Epair_2Eprod @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) ) @ V1s_27 @ ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > tyop_2Erealax_2Ereal ) @ ( c_2Epred__set_2EPOW @ A_27a @ V1s_27 ) @ ( c_2Emeasure_2Emeasure @ A_27a @ V0s ) ) ) ) ) )).
