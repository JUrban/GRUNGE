...
thf(conj_thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__BIGUNION__COMPLEMENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1c ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) )
           => ( ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ ty_2Erealax_2Ereal ) @ V0s ) @ V1c )
              = ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ c_2Ereal__topology_2Ecomponents @ V0s ) ) @ V1c ) ) ) ) ) ) )).
