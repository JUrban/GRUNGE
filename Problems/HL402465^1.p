...
thf(thm_2EquantHeuristics_2EGUESS__FORALL__POINT__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0i_2E0: u,V1P_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2E_21_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) ) ) )
        = mono_2Ec_2Ebool_2EF ) ) )).
