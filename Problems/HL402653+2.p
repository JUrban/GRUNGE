...
fof(lamtp_f799,axiom,(
    ! [A_27a,A_27b,V2P] :
     ...
     => ! [V4x] :
         ...
         => ! [V0f] :
              ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
             => mem(f799(A_27a,A_27b,V2P,V4x,V0f),arr(A_27b,A_27b)) ) ) ) )).

fof(lameq_f799,axiom,(
    ! [A_27a,A_27b,V2P] :
      ( mem(V2P,arr(A_27a,bool))
     => ! [V4x] :
          ( mem(V4x,A_27a)
         => ! [V0f] :
             ...
             => ! [V5y] :
                  ( mem(V5y,A_27b)
                 => ap(f799(A_27a,A_27b,V2P,V4x,V0f),V5y) = ap(ap(ap(c_2Ebool_2ECOND(A_27b),ap(V2P,V4x)),ap(ap(V0f,V4x),V5y)),V5y) ) ) ) ) )).

fof(lamtp_f798,axiom,(
    ! [A_27b,A_27a,V2P] :
      ( mem(V2P,arr(A_27a,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
         => mem(f798(A_27b,A_27a,V2P,V0f),arr(A_27a,arr(A_27b,A_27b))) ) ) )).

fof(lameq_f798,axiom,(
    ! [A_27b,A_27a,V2P] :
      ( mem(V2P,arr(A_27a,bool))
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,arr(A_27b,A_27b)))
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f798(A_27b,A_27a,V2P,V0f),V4x) = f799(A_27a,A_27b,V2P,V4x,V0f) ) ) ) )).

fof(conj_thm_2Erich__list_2EFOLDR__FILTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1e] :
                 ...
                 => ! [V2P] :
                     ...
                     => ! [V3l] :
                          ( mem(V3l,ty_2Elist_2Elist(A_27a))
                         => ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V0f),V1e),ap(ap(c_2Elist_2EFILTER(A_27a),V2P),V3l)) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),f798(A_27b,A_27a,V2P,V0f)),V1e),V3l) ) ) ) ) ) ) )).
