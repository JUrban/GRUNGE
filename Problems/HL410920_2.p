...
tff(conj_thm_2Ereal_2EREAL__SUB__ADD,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))),inj__ty_2Erealax_2Ereal(V1y))) = V0x )).
...
tff(lmtp_f3742,type,(
    f3742: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3742,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3c: tp__ty_2Erealax_2Ereal] : mem(f3742(A_27a,V1f,V3c),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3742,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3c: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3742(A_27a,V1f,V3c),V4x) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3c)),ap(V1f,V4x)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__CMUL,lemma,(
    ! [A_27a: del,V0net: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3742(A_27a,V1f,V3c)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V3c)),inj__ty_2Erealax_2Ereal(V2l))),V0net)) ) ) ) )).
...
tff(lamtp_f3745,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3745(A_27a,V1f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3745,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f3745(A_27a,V1f),V3x) = ap(c_2Ereal_2Eabs,ap(V1f,V3x)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__ABS,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal] :
              ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net))
             => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3745(A_27a,V1f)),ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V2l))),V0net)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ELIM__MAX,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
