...
thf(thm_2Epair_2EPAIR__FST__SND__EQ,axiom,(
    ! [A_27a: d,A_27b: d,V0p_2E0: u,V1q_2E0: u] :
      ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0p_2E0 )
        = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1q_2E0 ) )
    <=> ( ( ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
          = ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1q_2E0 ) ) ) )
        & ( ( s @ A_27b @ ( c_2Epair_2ESND_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V0p_2E0 ) ) )
          = ( s @ A_27b @ ( c_2Epair_2ESND_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1q_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Epath_2EfromPath__11,axiom,(
    ! [A_27a: d,A_27b: d,V0a_2E0: u,V1a_27_2E0: u] :
      ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) ) @ ( c_2Epath_2EfromPath_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0a_2E0 ) ) )
        = ( s @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Ellist_2Ellist @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) ) ) @ ( c_2Epath_2EfromPath_2E1 @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1a_27_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V0a_2E0 )
        = ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1a_27_2E0 ) ) ) )).
