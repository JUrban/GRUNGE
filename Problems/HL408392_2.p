...
tff(conj_thm_2Earithmetic_2ELESS__EQ__SUC__REFL,lemma,(
...
tff(ax_thm_2Etransc_2Edivision,axiom,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2D: $i] :
     ...
     => ( p(ap(ap(c_2Etransc_2Edivision,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),V2D))
      <=> ( surj__ty_2Erealax_2Ereal(ap(V2D,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) = V0a
          & ? [V3N: tp__ty_2Enum_2Enum] :
              ( ! [V4n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4n)),inj__ty_2Enum_2Enum(V3N)))
                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(V2D,inj__ty_2Enum_2Enum(V4n))),ap(V2D,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V4n))))) )
              & ! [V5n: tp__ty_2Enum_2Enum] :
                  ( p(ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V5n)),inj__ty_2Enum_2Enum(V3N)))
                 => surj__ty_2Erealax_2Ereal(ap(V2D,inj__ty_2Enum_2Enum(V5n))) = V1b ) ) ) ) ) )).

tff(lmtp_f2991,type,(
    f2991: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2991,axiom,(
    ! [V1N: tp__ty_2Enum_2Enum,V0D: $i] :
...
tff(lameq_f2991,axiom,(
    ! [V1N: tp__ty_2Enum_2Enum,V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2991(V1N,V0D),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V2n)),inj__ty_2Enum_2Enum(V1N))),ap(ap(c_2Erealax_2Ereal__lt,ap(V0D,inj__ty_2Enum_2Enum(V2n))),ap(V0D,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n))))) ) )).

tff(lmtp_f2992,type,(
    f2992: ( $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2992,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1N: tp__ty_2Enum_2Enum] : mem(f2992(V0D,V1N),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2992,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1N: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] : ap(f2992(V0D,V1N),inj__ty_2Enum_2Enum(V3n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Earithmetic_2E_3E_3D,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V1N))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0D,inj__ty_2Enum_2Enum(V3n))),ap(V0D,inj__ty_2Enum_2Enum(V1N)))) ) )).

tff(lmtp_f2990,type,(
    f2990: $i > $i )).

tff(lamtp_f2990,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lameq_f2990,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1N: tp__ty_2Enum_2Enum] : ap(f2990(V0D),inj__ty_2Enum_2Enum(V1N)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2991(V1N,V0D))),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2992(V0D,V1N))) ) )).

tff(ax_thm_2Etransc_2Edsize,axiom,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => surj__ty_2Enum_2Enum(ap(c_2Etransc_2Edsize,V0D)) = surj__ty_2Enum_2Enum(ap(c_2Emin_2E_40(ty_2Enum_2Enum),f2990(V0D))) ) )).

tff(conj_thm_2Etransc_2EDIVISION__THM,conjecture,(
    ! [V0D: $i] :
      ( mem(V0D,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
