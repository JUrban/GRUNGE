...
thf(conj_thm_2Ealignment_2Ealigned__add__sub__123,lemma,(
    ! [A_27a: del] :
      ( ! [V0w: $i] :
...
thf(conj_thm_2Ealignment_2Ealigned__numeric,conjecture,(
    ! [A_27a: del,A_27a0: del,A_27a1: del,A_27a10: del,A_27a11: del,A_27a12: del,A_27a13: del,A_27a14: del,A_27a15: del,A_27a16: del,A_27a17: del,A_27a18: del,A_27a19: del,A_27a2: del,A_27a20: del,A_27a21: del,A_27a22: del,A_27a23: del,A_27a24: del,A_27a25: del,A_27a26: del,A_27a27: del,A_27a3: del,A_27a4: del,A_27a5: del,A_27a6: del,A_27a7: del,A_27a8: del,A_27a9: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,A_27g: del,A_27h: del,A_27i: del,A_27j: del,A_27k: del,A_27l: del,A_27m: del,A_27n: del,A_27o: del,A_27p: del,A_27q: del,A_27r: del,A_27s: del,A_27t: del,A_27u: del,A_27v: del,A_27w: del,A_27x: del,A_27y: del,A_27z: del] :
      ...
      & ! [V1x: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27b ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) ) ) ) )
      & ! [V2x: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27c ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27c ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V2x ) ) ) ) ) )
      ...
      & ! [V4x: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27e ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27e ) @ ( ap @ ( c_2Ewords_2En2w @ A_27e ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V4x ) ) ) ) ) ) ) )
      & ! [V5x: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ ( c_2Ealignment_2Ealigned @ A_27f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27f ) @ ( ap @ ( c_2Ewords_2En2w @ A_27f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V5x ) ) ) ) ) ) )
      & ! [V6x: $i] :
          ( ( mem @ V6x @ A_27g )
         => ! [V7y: $i] :
