...
tff(arityeq2_2Ec_2Ellist_2ELDROP_2E2_002,axiom,(
    ! [A_27b: d,X0_2E0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] : s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)),s(tyop_2Ellist_2Ellist(A_27b),X1_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27b),tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27b),tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b)))),c_2Ellist_2ELDROP_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)))),s(tyop_2Ellist_2Ellist(A_27b),X1_2E0))) )).

tff(arityeq2_2Ec_2Ellist_2ELDROP_2E2_003,axiom,(
    ! [A_27c: d,X0_2E0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] : s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)),s(tyop_2Ellist_2Ellist(A_27c),X1_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27c),tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c))),app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Efun(tyop_2Ellist_2Ellist(A_27c),tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c)))),c_2Ellist_2ELDROP_2E0),s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(X0_2E0)))),s(tyop_2Ellist_2Ellist(A_27c),X1_2E0))) )).
...
tff(thm_2Ellist_2ELTAKE__NIL__EQ__SOME,axiom,(
    ! [A_27a: d,V0l_2E0: u,V1m_2E0: mono_2Etyop_2Enum_2Enum] :
      ( s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Ellist_2ELTAKE_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V1m_2E0)),s(tyop_2Ellist_2Ellist(A_27a),c_2Ellist_2ELNIL_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0)))
...
tff(thm_2Ellist_2ELDROP__THM,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d] :
      ...
      & ! [V1n_2E0: mono_2Etyop_2Enum_2Enum] : s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2ESUC_2E1(V1n_2E0))),s(tyop_2Ellist_2Ellist(A_27b),c_2Ellist_2ELNIL_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27b)),c_2Eoption_2ENONE_2E0)
      & ! [V2n_2E0: mono_2Etyop_2Enum_2Enum,V3h_2E0: u,V4t_2E0: u] : s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2ESUC_2E1(V2n_2E0))),s(tyop_2Ellist_2Ellist(A_27c),c_2Ellist_2ELCONS_2E2(s(A_27c,V3h_2E0),s(tyop_2Ellist_2Ellist(A_27c),V4t_2E0))))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27c)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V2n_2E0)),s(tyop_2Ellist_2Ellist(A_27c),V4t_2E0))) ) )).
...
tff(thm_2Ellist_2ELTAKE__IMP__LDROP,conjecture,(
    ! [A_27a: d,V0n_2E0: mono_2Etyop_2Enum_2Enum,V1ll_2E0: u,V2l1_2E0: u] :
      ( s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Ellist_2ELTAKE_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Elist_2Elist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Elist_2Elist(A_27a),V2l1_2E0)))
     => ? [V3l2_2E0: u] :
          ( s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Ellist_2ELDROP_2E2(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(V0n_2E0)),s(tyop_2Ellist_2Ellist(A_27a),V1ll_2E0))) = s(tyop_2Eoption_2Eoption(tyop_2Ellist_2Ellist(A_27a)),c_2Eoption_2ESOME_2E1(s(tyop_2Ellist_2Ellist(A_27a),V3l2_2E0)))
