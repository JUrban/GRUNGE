...
thf(thm_2ETemporal__Logic_2ESBEFORE__INVARIANT,conjecture,(
    ...
    <=> ( ? [V3J1: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( V3J1 @ V0t0 )
            & ! [V4t: mono_2Etyop_2Enum_2Enum] :
                ( ( ( V3J1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) )
                  & ( (~) @ ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
               => ( V3J1 @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V0t0 ) ) ) )
            & ! [V5d: mono_2Etyop_2Enum_2Enum] :
                ( ( V3J1 @ ( mono_2Ec_2Earithmetic_2E_2B @ V5d @ V0t0 ) )
               => ( (~) @ ( V1b @ ( mono_2Ec_2Earithmetic_2E_2B @ V5d @ V0t0 ) ) ) ) )
        & ? [V6J2: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ ( V6J2 @ V0t0 ) )
            & ! [V7t: mono_2Etyop_2Enum_2Enum] :
                ( ( mono_2Ec_2Eprim__rec_2E_3C @ ( V6J2 @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) ) @ ( V6J2 @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) )
                | ( ( V6J2 @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V7t @ V0t0 ) ) )
                  = mono_2Ec_2Enum_2E0 ) )
            & ! [V8t: mono_2Etyop_2Enum_2Enum] :
                ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ ( V6J2 @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t @ V0t0 ) ) )
                  & ( ( V6J2 @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t @ V0t0 ) ) )
                    = mono_2Ec_2Enum_2E0 ) )
               => ( V2a @ ( mono_2Ec_2Earithmetic_2E_2B @ V8t @ V0t0 ) ) ) ) ) ) )).
