...
thf(thm_2Emeasure_2EMEASURABLE__SIGMA,axiom,(
    ! [A_27a: $tType,A_27b: $tType,V0f: A_27a > A_27b,V1a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V2b: ( A_27b > $o ) > $o,V3sp: A_27b > $o] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V1a )
        & ( c_2Emeasure_2Esubset__class @ A_27b @ V3sp @ V2b )
        & ( c_2Ebool_2EIN @ ( A_27a > A_27b ) @ V0f @ ( c_2Epred__set_2EFUNSET @ A_27a @ A_27b @ ( c_2Emeasure_2Espace @ A_27a @ V1a ) @ V3sp ) )
        & ! [V4s: A_27b > $o] :
            ( ( c_2Ebool_2EIN @ ( A_27b > $o ) @ V4s @ V2b )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EINTER @ A_27a @ ( c_2Epred__set_2EPREIMAGE @ A_27a @ A_27b @ V0f @ V4s ) @ ( c_2Emeasure_2Espace @ A_27a @ V1a ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V1a ) ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > A_27b ) @ V0f @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V1a @ ( c_2Emeasure_2Esigma @ A_27b @ V3sp @ V2b ) ) ) ) )).
...
thf(thm_2Emeasure_2EMEASURABLE__PROD__SIGMA,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,A_27c: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1a1: tyop_2Epair_2Eprod @ ( A_27b > $o ) @ ( ( A_27b > $o ) > $o ),V2a2: tyop_2Epair_2Eprod @ ( A_27c > $o ) @ ( ( A_27c > $o ) > $o ),V3f: A_27a > ( tyop_2Epair_2Eprod @ A_27b @ A_27c )] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V0a )
        & ( c_2Ebool_2EIN @ ( A_27a > A_27b ) @ ( c_2Ecombin_2Eo @ A_27a @ A_27b @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ ( c_2Epair_2EFST @ A_27b @ A_27c ) @ V3f ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27b @ V0a @ V1a1 ) )
        & ( c_2Ebool_2EIN @ ( A_27a > A_27c ) @ ( c_2Ecombin_2Eo @ A_27a @ A_27c @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ ( c_2Epair_2ESND @ A_27b @ A_27c ) @ V3f ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ A_27c @ V0a @ V2a2 ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) @ V3f @ ( c_2Emeasure_2Emeasurable @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ V0a @ ( c_2Emeasure_2Esigma @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c @ ( c_2Emeasure_2Espace @ A_27b @ V1a1 ) @ ( c_2Emeasure_2Espace @ A_27c @ V2a2 ) ) @ ( c_2Eutil__prob_2Eprod__sets @ A_27b @ A_27c @ ( c_2Emeasure_2Esubsets @ A_27b @ V1a1 ) @ ( c_2Emeasure_2Esubsets @ A_27c @ V2a2 ) ) ) ) ) ) )).
