...
tff(f3425_0_2E0,type,(
    f3425_0_2E0: u )).

tff(f3425_0_2E1,type,(
    f3425_0_2E1: du > u )).
...
tff(c_2EindexedLists_2EfupdLast_2E0,type,(
    c_2EindexedLists_2EfupdLast_2E0: u )).

tff(c_2EindexedLists_2EfupdLast_2E2,type,(
...
tff(arityeq1_2Ef3425_0_2E1,axiom,(
    ! [A_27a: d,X0_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),X0_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Emin_2Ebool),f3425_0_2E0),s(tyop_2Elist_2Elist(A_27a),X0_2E0)))) )).
...
tff(arityeq2_2Ec_2EindexedLists_2EfupdLast_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) = s(tyop_2Elist_2Elist(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27a),tyop_2Emin_2Efun(tyop_2Elist_2Elist(A_27a),tyop_2Elist_2Elist(A_27a))),c_2EindexedLists_2EfupdLast_2E0),s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0))),s(tyop_2Elist_2Elist(A_27a),X1_2E0))) )).
...
tff(thm_2EindexedLists_2EfupdLast__def,axiom,(
    ! [A_27a: d] :
      ( ! [V0f_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)
      & ! [V1h_2E0: u,V2f_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V1h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V2f_2E0),s(A_27a,V1h_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0)))
      & ! [V3v5_2E0: u,V4v4_2E0: u,V5h_2E0: u,V6f_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V6f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V5h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V4v4_2E0),s(tyop_2Elist_2Elist(A_27a),V3v5_2E0))))))) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V5h_2E0),s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V6f_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,V4v4_2E0),s(tyop_2Elist_2Elist(A_27a),V3v5_2E0))))))) ) )).
...
tff(def0_2Ethm_2EindexedLists_2EfupdLast__FRONT__LAST,axiom,(
    ! [A_27a: d,V0l_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0)))))
    <=> s(tyop_2Elist_2Elist(A_27a),V0l_2E0) = s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0) ) )).

tff(thm_2EindexedLists_2EfupdLast__FRONT__LAST,conjecture,(
    ! [A_27a: d,V0l_2E0: u,V1f_2E0: u] : s(tyop_2Elist_2Elist(A_27a),c_2EindexedLists_2EfupdLast_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V1f_2E0),s(tyop_2Elist_2Elist(A_27a),V0l_2E0))) = s(tyop_2Elist_2Elist(A_27a),c_2Ebool_2ECOND_2E3(s(tyop_2Emin_2Ebool,f3425_0_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EAPPEND_2E2(s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFRONT_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ECONS_2E2(s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V1f_2E0),s(A_27a,c_2Elist_2ELAST_2E1(s(tyop_2Elist_2Elist(A_27a),V0l_2E0))))),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ENIL_2E0))))))) )).
