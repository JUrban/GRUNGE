...
thf(thm_2EpatternMatches_2EPMATCH__ROWS__DROP__SUBSUMED,conjecture,(
      ...
      ( ( ! [V6x: A_27b] :
        ...
        & ( ( c_2Eoption_2EIS__SOME @ A_27b @ ( V0r1 @ V5v ) )
         => ( c_2Elist_2EEVERY @ ( A_27a > ( tyop_2Eoption_2Eoption @ A_27b ) )
            @ ^ [V7row: A_27a > ( tyop_2Eoption_2Eoption @ A_27b )] :
                ( c_2Emin_2E_3D @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( V7row @ V5v ) @ ( c_2Eoption_2ENONE @ A_27b ) )
            @ V3rows2 ) ) )
