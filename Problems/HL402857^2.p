...
thf(conj_thm_2Elist_2EDROP__0,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Erich__list_2EDROP__CONS__EL,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
          = ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) ) @ ( ap @ ( ap @ ( c_2Elist_2EDROP @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ V1l ) ) ) ) ) )).
