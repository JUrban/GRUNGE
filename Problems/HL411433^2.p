...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__SUBSET,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EIN__COMPONENTS__CONNECTED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1c: $i] :
          ( ( mem @ V1c @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__SUBSET__CLOPEN,lemma,(
    ! [V0u: $i] :
      ( ( mem @ V0u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1s: $i] :
         ...
         => ! [V2c: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V0u ) ) @ V1s ) )
                  ...
                  & ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ V2c ) @ V1s )
...
thf(conj_thm_2Ereal__topology_2ECLOPEN__BIGUNION__COMPONENTS,conjecture,(
    ! [V0u: $i] :
      ( ( mem @ V0u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
