...
tff(conj_thm_2Ebag_2ESUB__BAG__CARD,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2EBAG__CARD__DIFF,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(A_27a),V0b))
       => ! [V1c: $i] :
           ...
           => ( p(ap(ap(c_2Ebag_2ESUB__BAG(A_27a),V1c),V0b))
             => surj__ty_2Enum_2Enum(ap(c_2Ebag_2EBAG__CARD(A_27a),ap(ap(c_2Ebag_2EBAG__DIFF(A_27a),V0b),V1c))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2D,ap(c_2Ebag_2EBAG__CARD(A_27a),V0b)),ap(c_2Ebag_2EBAG__CARD(A_27a),V1c))) ) ) ) ) )).
