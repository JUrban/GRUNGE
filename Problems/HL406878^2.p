...
thf(ax_thm_2Ehreal_2Ehreal__lt,axiom,(
...
thf(conj_thm_2Ehreal_2EHREAL__SUP__ISACUT,conjecture,(
    ! [V0P: $i] :
       ...
       => ( p
          @ ( ap @ c_2Ehreal_2Eisacut
            @ ( lam @ ty_2Ehrat_2Ehrat
              @ ^ [V4w: $i] :
                  ( ap @ ( c_2Ebool_2E_3F @ ty_2Ehreal_2Ehreal )
                  @ ( lam @ ty_2Ehreal_2Ehreal
                    @ ^ [V5X: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0P @ V5X ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ecut @ V5X ) @ V4w ) ) ) ) ) ) ) ) ) )).
