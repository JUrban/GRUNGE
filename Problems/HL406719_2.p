...
tff(conj_thm_2EOmega_2Edark__shadow__row__ind,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Enum_2Enum,arr(ty_2Einteger_2Eint,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool))))
     => ( ( ! [V1c: tp__ty_2Enum_2Enum,V2L: tp__ty_2Einteger_2Eint] : p(ap(ap(ap(V0P,inj__ty_2Enum_2Enum(V1c)),inj__ty_2Einteger_2Eint(V2L)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
