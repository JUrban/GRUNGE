...
tff(conj_thm_2Ecardinal_2ESET__SUM__CARDEQ__SET,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ( p(ap(ap(c_2Ecardinal_2Ecardeq(A_27a,A_27a),V0s),ap(ap(c_2Epred__set_2ECROSS(bool,bool),ap(ap(c_2Epred__set_2EINSERT(bool),inj__o(fo__c_2Ebool_2ET)),ap(ap(c_2Epred__set_2EINSERT(bool),inj__o(fo__c_2Ebool_2EF)),c_2Epred__set_2EEMPTY(bool)))),V0s)))
          & ! [V1A: $i] :
...
tff(conj_thm_2Ecardinal_2EPOW__EQ__X__EXP__X,lemma,(
    ! [A_27a: del,V0A: $i] :
...
tff(conj_thm_2Ecardinal_2Ecardeq__bijns__cong,lemma,(
    ! [A_27a: del,A_27b: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1B: $i] :
...
tff(conj_thm_2Ecardinal_2Ebijections__cardeq,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
