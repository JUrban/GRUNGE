...
tff(lameq_f1389,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V2t: tp__ty_2Enum_2Enum] : ap(f1389(V0a),inj__ty_2Enum_2Enum(V2t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),f882(V0a)),inj__ty_2Enum_2Enum(V2t))) ) )).

tff(lmtp_f1390,type,(
    f1390: $i > $i )).

tff(lamtp_f1390,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1390,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V5t: tp__ty_2Enum_2Enum] : ap(f1390(V0a),inj__ty_2Enum_2Enum(V5t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,k(ty_2Enum_2Enum,c_2Ebool_2ET)),V0a),inj__ty_2Enum_2Enum(V5t)) ) )).

tff(lmtp_f1391,type,(
    f1391: ( $i * $i ) > $i )).

tff(lamtp_f1391,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1391,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V7t: tp__ty_2Enum_2Enum] : ap(f1391(V1b,V0a),inj__ty_2Enum_2Enum(V7t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V1b),f1340(V0a,V1b)),inj__ty_2Enum_2Enum(V7t)) ) ) )).

tff(lmtp_f1392,type,(
    f1392: ( $i * $i ) > $i )).

tff(lamtp_f1392,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1392,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V9t: tp__ty_2Enum_2Enum] : ap(f1392(V0a,V1b),inj__ty_2Enum_2Enum(V9t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1342(V1b)),f1329(V0a,V1b)),inj__ty_2Enum_2Enum(V9t))) ) ) )).

tff(lmtp_f1393,type,(
    f1393: ( $i * $i ) > $i )).

tff(lamtp_f1393,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1393,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V12t: tp__ty_2Enum_2Enum] : ap(f1393(V0a,V1b),inj__ty_2Enum_2Enum(V12t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1331(V0a)),V1b),inj__ty_2Enum_2Enum(V12t))) ) ) )).

tff(lmtp_f1394,type,(
    f1394: ( $i * $i ) > $i )).

tff(lamtp_f1394,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1394,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V14t: tp__ty_2Enum_2Enum] : ap(f1394(V0a,V1b),inj__ty_2Enum_2Enum(V14t)) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,V1b),f1345(V0a,V1b)),inj__ty_2Enum_2Enum(V14t))) ) ) )).

tff(lmtp_f1395,type,(
    f1395: ( $i * $i ) > $i )).

tff(lamtp_f1395,axiom,(
    ! [V1b: $i] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f1395,axiom,(
    ! [V1b: $i] :
     ...
     => ! [V0a: $i] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
         => ! [V16t: tp__ty_2Enum_2Enum] : ap(f1395(V1b,V0a),inj__ty_2Enum_2Enum(V16t)) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPSWHEN,f1320(V1b)),f1336(V0a,V1b)),inj__ty_2Enum_2Enum(V16t)) ) ) )).

tff(conj_thm_2EPast__Temporal__Logic_2EPSWHEN__EXPRESSIVE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
