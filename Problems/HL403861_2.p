...
tff(lamtp_f1211,axiom,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => mem(f1211(A_27a,V0ll),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f1211,axiom,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f1211(A_27a,V0ll),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Ellist_2Ellength__rel(A_27a),V0ll),inj__ty_2Enum_2Enum(V1n)) ) )).

tff(ax_thm_2Ellist_2ELLENGTH,axiom,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
     => surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(c_2Ellist_2ELLENGTH(A_27a),V0ll)) = surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum(ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(ty_2Enum_2Enum)),ap(c_2Ellist_2ELFINITE(A_27a),V0ll)),ap(c_2Eoption_2ESOME(ty_2Enum_2Enum),ap(c_2Emin_2E_40(ty_2Enum_2Enum),f1211(A_27a,V0ll)))),c_2Eoption_2ENONE(ty_2Enum_2Enum))) ) )).

tff(conj_thm_2Ellist_2ELFINITE__HAS__LENGTH,conjecture,(
    ! [A_27a: del,V0ll: $i] :
      ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
