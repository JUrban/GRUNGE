...
fof(lamtp_f477,axiom,(
    ! [A_27b,A_27a,V2R] :
      ( mem(V2R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1Q] :
          ( mem(V1Q,arr(A_27b,bool))
         => mem(f477(A_27b,A_27a,V2R,V1Q),arr(A_27a,bool)) ) ) )).
...
fof(lameq_f477,axiom,(
    ! [A_27b,A_27a,V2R] :
     ...
     => ! [V1Q] :
         ...
         => ! [V3i] :
              ( mem(V3i,A_27a)
             => ap(f477(A_27b,A_27a,V2R,V1Q),V3i) = ap(ap(c_2Ebool_2ERES__FORALL(A_27b),V1Q),f478(A_27a,A_27b,V3i,V2R)) ) ) ) )).
...
fof(lamtp_f479,axiom,(
    ! [A_27a,A_27b,V2R] :
      ( mem(V2R,arr(A_27a,arr(A_27b,bool)))
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => mem(f479(A_27a,A_27b,V2R,V0P),arr(A_27b,bool)) ) ) )).
...
fof(lameq_f479,axiom,(
    ! [A_27a,A_27b,V2R] :
     ...
     => ! [V0P] :
         ...
         => ! [V5j] :
              ( mem(V5j,A_27b)
             => ap(f479(A_27a,A_27b,V2R,V0P),V5j) = ap(ap(c_2Ebool_2ERES__FORALL(A_27a),V0P),f480(A_27b,A_27a,V2R,V5j)) ) ) ) )).

fof(conj_thm_2Eres__quan_2ERES__FORALL__REORDER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1Q] :
                 ...
                 => ! [V2R] :
                      ( mem(V2R,arr(A_27a,arr(A_27b,bool)))
                     => ( p(ap(ap(c_2Ebool_2ERES__FORALL(A_27a),V0P),f477(A_27b,A_27a,V2R,V1Q)))
                      <=> p(ap(ap(c_2Ebool_2ERES__FORALL(A_27b),V1Q),f479(A_27a,A_27b,V2R,V0P))) ) ) ) ) ) ) )).
