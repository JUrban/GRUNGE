...
tff(conj_thm_2Ealist_2EALOOKUP__FAILS,lemma,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
...
tff(conj_thm_2Ealist_2EALOOKUP__NONE,conjecture,(
    ! [A_27a: del,A_27b: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0l),V1x) = c_2Eoption_2ENONE(A_27b)
          <=> ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0l)))) ) ) ) )).
