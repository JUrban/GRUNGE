...
fof(conj_thm_2Eprim__rec_2Enum__Axiom,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
          ( mem(V0e,A_27a)
...
fof(conj_thm_2Ereal__topology_2ESUBSET__ANTISYM__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__topology_2ECLOSURE__CLOSED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2EClosed,V0s))
       => ap(c_2Ereal__topology_2Eclosure,V0s) = V0s ) ) )).

fof(conj_thm_2Ereal__topology_2ELT__EXISTS,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(ax_thm_2Ereal__topology_2Ecauchy,axiom,(
    ! [V0s] :
                  ...
                  & ! [V3m] :
                     ...
                     => ! [V4n] :
                         ...
                         => ( ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V3m),V2N))
                           ...
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0s,V3m)),ap(V0s,V4n)))),V1e)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONVERGENT__IMP__CAUCHY,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
...
fof(conj_thm_2Ereal__topology_2EISOMETRY__ON__IMP__CONTINUOUS__ON,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f] :
         ...
         => ( ! [V2x] :
               ...
               => ! [V3y] :
                   ...
                   => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s))
                     ...
                     => ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V1f,V2x)),ap(V1f,V3y))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),V3y)) ) ) )
...
fof(conj_thm_2Ereal__topology_2ESETDIST__EQ__0__SING,lemma,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1x] :
            ( mem(V1x,ty_2Erealax_2Ereal)
           => ( ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V1x),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V0s)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
    ...
    & ! [V2s] :
       ...
       => ! [V3x] :
           ...
           => ( ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V2s),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V3x),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)))) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
            <=> ( V2s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                | p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),ap(c_2Ereal__topology_2Eclosure,V2s))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EISOMETRY__IMP__EMBEDDING,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
                  ...
                  & ! [V3x] :
                     ...
                     => ! [V4y] :
                         ...
                         => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3x),V1s))
                           ...
                           => ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V3x)),ap(V0f,V4y))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),V4y)) ) ) ) )
               => ? [V5g] :
...
fof(conj_thm_2Ereal__topology_2EISOMETRY__IMP__HOMEOMORPHISM__COMPACT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
              ...
              & ! [V2x] :
                 ...
                 => ! [V3y] :
                     ...
                     => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V1s))
                       ...
                       => ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V0f,V2x)),ap(V0f,V3y))) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),V3y)) ) ) ) )
           => ? [V4g] :
