...
fof(conj_thm_2Eintegral_2EDINT__WRONG,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2ESUM__EQ__0,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ! [V2f] :
             ...
             => ( ! [V3r] :
                   ...
                   => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V0m),V3r))
                        & p(ap(ap(c_2Eprim__rec_2E_3C,V3r),ap(ap(c_2Earithmetic_2E_2B,V0m),V1n))) )
                     => ap(V2f,V3r) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) )
               => ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V0m),V1n)),V2f) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) ) )).

fof(lamtp_f3210,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => mem(f3210(V0a),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3210,axiom,(
    ! [V0a] :
     ...
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => ap(f3210(V0a),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),V2x),V0a)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)) ) ) )).

fof(conj_thm_2Eintegral_2EDINT__DELTA__LEFT,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),f3210(V0a)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) )).
