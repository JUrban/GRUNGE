...
fof(conj_thm_2Ereal__topology_2ELIM__CONTINUOUS__FUNCTION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1net] :
             ...
             => ! [V2g] :
                 ...
                 => ! [V3l] :
                     ...
                     => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,V3l)))
                          & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V2g),V3l),V1net)) )
                       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3824(A_27a,V2g,V0f)),ap(V0f,V3l)),V1net)) ) ) ) ) ) ) )).
