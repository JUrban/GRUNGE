...
thf(thm_2Ebit_2EMOD__2EXP__LT,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1k: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2EMOD @ V1k @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) )).
...
thf(thm_2Ebit_2EBITS__ZEROL,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V1a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V0h ) ) )
     => ( ( c_2Ebit_2EBITS @ V0h @ c_2Enum_2E0 @ V1a )
        = V1a ) ) )).

thf(thm_2Ebit_2EBIT__B,axiom,(
    ! [V0b: tyop_2Enum_2Enum] :
      ( c_2Ebit_2EBIT @ V0b @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0b ) ) )).

thf(thm_2Ebit_2EBIT__B__NEQ,axiom,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
      ( ( (~) @ ( V0a = V1b ) )
     => ( (~) @ ( c_2Ebit_2EBIT @ V0a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1b ) ) ) ) )).
...
thf(thm_2Ebit_2ENOT__BIT__GT__TWOEXP,axiom,(
    ! [V0i: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V1n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0i ) )
...
thf(thm_2Ebit_2EBITWISE__ONE__COMP__LEM,axiom,(
    ! [V0n: tyop_2Enum_2Enum,V1a: tyop_2Enum_2Enum,V2b: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBITWISE @ ( c_2Enum_2ESUC @ V0n )
        @ ^ [V3x: $o,V4y: $o] :
            ( c_2Ebool_2E_7E @ V3x )
        @ V1a
        @ V2b )
      = ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V0n ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ebit_2EBITS @ V0n @ c_2Enum_2E0 @ V1a ) ) ) )).
...
thf(thm_2Ebit_2EBIT__COMPLEMENT,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1i: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBIT @ V1i @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) @ ( c_2Earithmetic_2EMOD @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) ) )
    <=> ( ( ( ( c_2Earithmetic_2EMOD @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) )
            = c_2Enum_2E0 )
          & ( V1i = V0n ) )
        | ( ( (~)
            @ ( ( c_2Earithmetic_2EMOD @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) )
          ...
          & ( (~) @ ( c_2Ebit_2EBIT @ V1i @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EMOD @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0n ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
