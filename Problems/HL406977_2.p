...
tff(conj_thm_2Earithmetic_2ELESS__EQUAL__ADD,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Earithmetic_2EADD__DIV__RWT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Earithmetic_2EONE__LT__EXP,lemma,(
...
tff(conj_thm_2Ebit_2ETWOEXP__MONO,lemma,(
...
tff(conj_thm_2Ebit_2ETWOEXP__MONO2,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2EBIT__B,lemma,(
...
tff(conj_thm_2Ebit_2EBITS__SUM,lemma,(
...
tff(conj_thm_2Ebit_2ENOT__BIT__GT__TWOEXP,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__COMPLEMENT,lemma,(
...
tff(conj_thm_2Ebit_2EBIT__SHIFT__THM4,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2EDIV__LT,lemma,(
...
tff(conj_thm_2Ebit_2EMOD__ZERO__GT,lemma,(
...
tff(conj_thm_2Ebit_2EDIV__GT0,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2EDIV__SUB1,lemma,(
    ! [V0a: tp__ty_2Enum_2Enum,V1b: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ebit_2EBIT__SHIFT__THM5,lemma,(
...
tff(conj_thm_2Einteger_2EINT__MUL__ASSOC,lemma,(
...
tff(conj_thm_2Einteger_2EINT__LDISTRIB,lemma,(
...
tff(conj_thm_2Einteger_2EINT__NEG__SUB,lemma,(
...
tff(conj_thm_2Einteger_2EINT,lemma,(
...
tff(conj_thm_2Einteger_2EINT__SUB__SUB,lemma,(
...
tff(conj_thm_2Einteger_2EINT__EXP,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__exp,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V1m))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,ap(ap(c_2Earithmetic_2EEXP,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m)))) )).
...
tff(conj_thm_2Einteger_2EINT__DIV__CALCULATE,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
        ( V1m != fo__c_2Enum_2E0
    ...
    & ! [V2p: tp__ty_2Einteger_2Eint,V3q: tp__ty_2Einteger_2Eint] :
        ( V3q != surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
       => surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__div,inj__ty_2Einteger_2Eint(V2p)),ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V3q)))) = surj__ty_2Einteger_2Eint(ap(ap(c_2Einteger_2Eint__div,ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V2p))),inj__ty_2Einteger_2Eint(V3q))) )
    & ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
        ( surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V4m))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V5n)))
      <=> V4m = V5n )
    & ! [V6x: tp__ty_2Einteger_2Eint] :
        ( surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V6x))) = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
      <=> V6x = surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
    & ! [V7x: tp__ty_2Einteger_2Eint] : surj__ty_2Einteger_2Eint(ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__neg,inj__ty_2Einteger_2Eint(V7x)))) = V7x )).
...
tff(lmtp_f2212,type,(
    f2212: ( del * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2212,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => mem(f2212(A_27a,V1n,V0w),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2212,axiom,(
    ! [A_27a: del,V1n: tp__ty_2Enum_2Enum,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2212(A_27a,V1n,V0w),inj__ty_2Enum_2Enum(V2i)) = ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V1n)))),ap(c_2Ewords_2Eword__msb(A_27a),V0w)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0w),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2i)),inj__ty_2Enum_2Enum(V1n)))) ) )).

tff(ax_thm_2Ewords_2Eword__asr__def,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),inj__ty_2Enum_2Enum(V1n)) = ap(c_2Efcp_2EFCP(bool,bool),f2212(A_27a,V1n,V0w)) ) )).
...
tff(conj_thm_2Ewords_2EINT__MIN__LT__DIMWORD,lemma,(
...
tff(conj_thm_2Ewords_2Eword__index,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1i: tp__ty_2Enum_2Enum] :
     ...
     => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V1i)))
...
tff(conj_thm_2Einteger__word_2Ei2w__DIV,conjecture,(
