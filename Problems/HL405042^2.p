...
thf(conj_thm_2EOmega__Automata_2EOMEGA__DISJ__CLOSURE,conjecture,(
                             ...
                             => ( ( ? [V8q1: $i] :
                                  ...
                                  | ? [V10q2: $i] :
                                      ...
                                      & ! [V11t: tp__ty_2Enum_2Enum] :
                                          ( p @ ( ap @ V6Phi__R2 @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b2 ) @ ( ap @ V3i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V11t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) @ ( ap @ V10q2 @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V11t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
