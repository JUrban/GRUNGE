...
tff(conj_thm_2Eieee_2Eccode2num__thm,lemma,
    ( surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EGt))) = fo__c_2Enum_2E0
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2ELt))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EEq))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
    & surj__ty_2Enum_2Enum(ap(c_2Eieee_2Eccode2num,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EUn))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )).

tff(conj_thm_2Eieee_2Eccode__Axiom,conjecture,(
    ! [A_27a: del,V0x0: $i] :
      ( mem(V0x0,A_27a)
     => ! [V1x1: $i] :
          ( mem(V1x1,A_27a)
         => ! [V2x2: $i] :
             ...
             => ! [V3x3: $i] :
                 ...
                 => ? [V4f: $i] :
                      ...
                      & ap(V4f,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EGt)) = V0x0
                      & ap(V4f,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2ELt)) = V1x1
                      & ap(V4f,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EEq)) = V2x2
                      & ap(V4f,inj__ty_2Eieee_2Eccode(fo__c_2Eieee_2EUn)) = V3x3 ) ) ) ) ) )).
