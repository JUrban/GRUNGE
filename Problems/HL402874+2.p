...
fof(conj_thm_2Erich__list_2ELASTN__APPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l2] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(A_27a),V0l2)),V1n))
               => ! [V2l1] :
                    ( mem(V2l1,ty_2Elist_2Elist(A_27a))
                   => ap(ap(c_2Erich__list_2ELASTN(A_27a),V1n),ap(ap(c_2Elist_2EAPPEND(A_27a),V2l1),V0l2)) = ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Erich__list_2ELASTN(A_27a),ap(ap(c_2Earithmetic_2E_2D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l2))),V2l1)),V0l2) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EDROP__APPEND1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Erich__list_2EDROP__LENGTH__NIL__rwt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ! [V1m] :
             ...
             => ( V1m = ap(c_2Elist_2ELENGTH(A_27a),V0l)
               => ap(ap(c_2Elist_2EDROP(A_27a),V1m),V0l) = c_2Elist_2ENIL(A_27a) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EREVERSE__DROP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
         ...
         => ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0ls)))
               => ap(c_2Elist_2EREVERSE(A_27a),ap(ap(c_2Elist_2EDROP(A_27a),V1n),V0ls)) = ap(c_2Elist_2EREVERSE(A_27a),ap(ap(c_2Erich__list_2ELASTN(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Elist_2ELENGTH(A_27a),V0ls)),V1n)),V0ls)) ) ) ) ) )).
