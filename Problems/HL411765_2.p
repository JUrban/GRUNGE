...
tff(conj_thm_2Ereal__topology_2ESERIES__TRIVIAL,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__TRIVIAL,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => p(ap(ap(c_2Ereal__topology_2Esummable,c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)),V0f)) ) )).
