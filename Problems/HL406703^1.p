...
thf(thm_2Eint__arith_2ENOT__INT__DIVIDES,axiom,(
    ! [V0c: mono_2Etyop_2Einteger_2Eint,V1d: mono_2Etyop_2Einteger_2Eint] :
      ( ( (~)
        @ ( V0c
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ( ( (~) @ ( mono_2Ec_2Einteger_2Eint__divides @ V0c @ V1d ) )
      <=> ? [V2i: mono_2Etyop_2Einteger_2Eint] :
            ( ( mono_2Ec_2Einteger_2Eint__le @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V2i )
            & ( mono_2Ec_2Einteger_2Eint__le @ V2i @ ( mono_2Ec_2Einteger_2Eint__sub @ ( mono_2Ec_2Einteger_2EABS @ V0c ) @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
            & ( mono_2Ec_2Einteger_2Eint__divides @ V0c @ ( mono_2Ec_2Einteger_2Eint__add @ V1d @ V2i ) ) ) ) ) )).
...
thf(thm_2Eint__arith_2ENOT__INT__DIVIDES__POS,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1d: mono_2Etyop_2Einteger_2Eint] :
      ( ( (~) @ ( V0n = mono_2Ec_2Enum_2E0 ) )
     => ( ( (~) @ ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) @ V1d ) )
      <=> ? [V2i: mono_2Etyop_2Einteger_2Eint] :
            ( ( mono_2Ec_2Einteger_2Eint__le @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V2i )
            & ( mono_2Ec_2Einteger_2Eint__le @ V2i @ ( mono_2Ec_2Einteger_2Eint__sub @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
            & ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) @ ( mono_2Ec_2Einteger_2Eint__add @ V1d @ V2i ) ) ) ) ) )).
