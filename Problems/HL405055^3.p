...
thf(thm_2EOmega__Automata_2ECO__BUECHI__NEXT__CLOSURE,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0t0: tyop_2Enum_2Enum,V1i: tyop_2Enum_2Enum > A_27a,V2c: A_27b,V3Psi: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V4Phi__R: ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) > $o,V5Phi__I: A_27b > $o] :
      ( ( c_2ETemporal__Logic_2ENEXT
        @ ^ [V6t0: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_3F @ ( tyop_2Enum_2Enum > A_27b )
            @ ^ [V7q: tyop_2Enum_2Enum > A_27b] :
                ( c_2Ebool_2E_2F_5C @ ( V5Phi__I @ ( V7q @ V6t0 ) )
                @ ( c_2Ebool_2E_2F_5C
                  @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                    @ ^ [V8t: tyop_2Enum_2Enum] :
                        ( V4Phi__R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V1i @ ( c_2Earithmetic_2E_2B @ V8t @ V6t0 ) ) @ ( V7q @ ( c_2Earithmetic_2E_2B @ V8t @ V6t0 ) ) ) ) )
                  @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                    @ ^ [V9t1: tyop_2Enum_2Enum] :
                        ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                        @ ^ [V10t2: tyop_2Enum_2Enum] :
                            ( V3Psi @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V1i @ ( c_2Earithmetic_2E_2B @ V9t1 @ ( c_2Earithmetic_2E_2B @ V10t2 @ V6t0 ) ) ) @ ( V7q @ ( c_2Earithmetic_2E_2B @ V9t1 @ ( c_2Earithmetic_2E_2B @ V10t2 @ V6t0 ) ) ) ) ) ) ) ) ) )
        @ V0t0 )
    <=> ? [V11p: tyop_2Enum_2Enum > $o,V12q: tyop_2Enum_2Enum > A_27b] :
          ( ( ( V11p @ V0t0 )
            = c_2Ebool_2EF )
          & ( ( V12q @ V0t0 )
            = V2c )
          & ! [V13t: tyop_2Enum_2Enum] :
              ( ( ( (~) @ ( V11p @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) )
                & ( ( V12q @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) )
                  = V2c )
                & ( V11p @ ( c_2Earithmetic_2E_2B @ V13t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )
                & ( V5Phi__I @ ( V12q @ ( c_2Earithmetic_2E_2B @ V13t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
              | ( ( V11p @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) )
                & ( V4Phi__R @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V1i @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) @ ( V12q @ ( c_2Earithmetic_2E_2B @ V13t @ V0t0 ) ) ) )
                & ( V11p @ ( c_2Earithmetic_2E_2B @ V13t @ ( c_2Earithmetic_2E_2B @ V0t0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
          & ? [V14t1: tyop_2Enum_2Enum] :
            ! [V15t2: tyop_2Enum_2Enum] :
              ( V3Psi @ ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( V1i @ ( c_2Earithmetic_2E_2B @ V14t1 @ ( c_2Earithmetic_2E_2B @ V15t2 @ V0t0 ) ) ) @ ( V12q @ ( c_2Earithmetic_2E_2B @ V14t1 @ ( c_2Earithmetic_2E_2B @ V15t2 @ V0t0 ) ) ) ) ) ) ) )).
