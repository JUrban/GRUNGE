...
fof(ax_thm_2Efinite__map_2EFEMPTY__DEF,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2Efinite__map_2EFEMPTY(A_27a,A_27a) = ap(c_2Efinite__map_2Efmap__ABS(A_27a,A_27a),k(A_27a,ap(c_2Esum_2EINR(A_27b,A_27b),c_2Eone_2Eone))) ) ) )).

fof(conj_thm_2Efinite__map_2Efmap__SIMPLE__INDUCT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
