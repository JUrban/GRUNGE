...
tff(conj_thm_2Ewellorder_2EWF,lemma,(
...
tff(conj_thm_2Ewellorder_2EWF__DCHAIN,conjecture,(
    ! [A_27a: del,V0_3C_3C: $i] :
      ( mem(V0_3C_3C,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2EWF(A_27a),V0_3C_3C))
      <=> ~ ? [V1s: $i] :
              ( mem(V1s,arr(ty_2Enum_2Enum,A_27a))
              & ! [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(V0_3C_3C,ap(V1s,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V2n)))),ap(V1s,inj__ty_2Enum_2Enum(V2n)))) ) ) ) )).
