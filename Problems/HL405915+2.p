...
fof(conj_thm_2Earithmetic_2EMAX__LT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2ENOT__BIT__GT__LOG2,lemma,(
    ! [V0i] :
...
fof(conj_thm_2Ebit_2ENOT__BIT__GT__BITWISE,lemma,(
    ! [V0i] :
      ( mem(V0i,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__and__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2Eword__or__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ewords_2EWORD__DE__MORGAN__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Ewords_2EWORD__EQ,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
...
fof(lamtp_f2228,axiom,(
    ! [V4a] :
      ( mem(V4a,bool)
     => mem(f2228(V4a),arr(bool,bool)) ) )).
...
fof(lameq_f2228,axiom,(
    ! [V4a] :
     ...
     => ! [V5b] :
          ( mem(V5b,bool)
         => ap(f2228(V4a),V5b) = ap(ap(c_2Ebool_2E_2F_5C,V4a),ap(c_2Ebool_2E_7E,V5b)) ) ) )).

fof(lamtp_f2227,axiom,(
    mem(f2227,arr(bool,arr(bool,bool))) )).

fof(lameq_f2227,axiom,(
    ! [V4a] :
      ( mem(V4a,bool)
     => ap(f2227,V4a) = f2228(V4a) ) )).

fof(lamtp_f2230,axiom,(
    ! [V8a] :
      ( mem(V8a,bool)
     => mem(f2230(V8a),arr(bool,bool)) ) )).
...
fof(lameq_f2230,axiom,(
    ! [V8a] :
     ...
     => ! [V9b] :
          ( mem(V9b,bool)
         => ap(f2230(V8a),V9b) = ap(ap(c_2Ebool_2E_2F_5C,V8a),ap(c_2Ebool_2E_7E,V9b)) ) ) )).

fof(lamtp_f2229,axiom,(
    mem(f2229,arr(bool,arr(bool,bool))) )).

fof(lameq_f2229,axiom,(
    ! [V8a] :
      ( mem(V8a,bool)
     => ap(f2229,V8a) = f2230(V8a) ) )).

fof(conj_thm_2Ewords_2EWORD__LITERAL__AND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0n] :
            ( mem(V0n,ty_2Enum_2Enum)
        ...
        & ! [V2n] :
           ...
           => ! [V3m] :
                ( mem(V3m,ty_2Enum_2Enum)
               => ap(ap(c_2Ewords_2Eword__and(A_27a),ap(c_2Ewords_2En2w(A_27a),V2n)),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),V3m))) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,V2n))),f2227),V2n),V3m)) ) )
        & ! [V6n] :
            ( mem(V6n,ty_2Enum_2Enum)
           => ! [V7m] :
                ( mem(V7m,ty_2Enum_2Enum)
               => ap(ap(c_2Ewords_2Eword__and(A_27a),ap(c_2Ewords_2Eword__1comp(A_27a),ap(c_2Ewords_2En2w(A_27a),V7m))),ap(c_2Ewords_2En2w(A_27a),V6n)) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Enum_2ESUC,ap(c_2Ebit_2ELOG2,V6n))),f2229),V6n),V7m)) ) )
        & ! [V10n] :
            ( mem(V10n,ty_2Enum_2Enum)
           => ! [V11m] :
                ( mem(V11m,ty_2Enum_2Enum)
