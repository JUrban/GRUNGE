...
tff(conj_thm_2Eordinal_2EWIN__allOrds,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Eordinal_2Eordlt__mkOrdinal,lemma,(
    ! [A_27a: del,V0o1: $i] :
...
tff(conj_thm_2Eordinal_2Eorderlt__iso__REFL,lemma,(
    ! [A_27a: del,A_27b: del,V0w1: $i] :
      ( mem(V0w1,ty_2Ewellorder_2Ewellorder(A_27a))
     => ! [V1w2: $i] :
          ( mem(V1w2,ty_2Ewellorder_2Ewellorder(A_27b))
...
tff(conj_thm_2Eordinal_2Eorderiso__wobound2,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Ewellorder_2Ewellorder(A_27a))
...
tff(conj_thm_2Eordinal_2Ewellorder__ordinal__isomorphism,conjecture,(
    ! [A_27a: del,V0w: $i] :
