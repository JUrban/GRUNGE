...
tff(conj_thm_2Ebit_2EBIT__SIGN__EXTEND,lemma,(
...
tff(lmtp_f2183,type,(
    f2183: ( del * $i * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2183,axiom,(
    ! [A_27a: del,V2w: $i] :
      ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] : mem(f2183(A_27a,V2w,V0h,V1l),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2183,axiom,(
    ! [A_27a: del,V2w: $i] :
      ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum,V3i: tp__ty_2Enum_2Enum] : ap(f2183(A_27a,V2w,V0h,V1l),inj__ty_2Enum_2Enum(V3i)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V1l)),ap(ap(c_2Earithmetic_2EMIN,inj__ty_2Enum_2Enum(V0h)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2w),ap(ap(c_2Earithmetic_2EMIN,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3i)),inj__ty_2Enum_2Enum(V1l))),ap(ap(c_2Earithmetic_2EMIN,inj__ty_2Enum_2Enum(V0h)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))) ) )).

tff(lmtp_f2182,type,(
    f2182: ( del * del * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2182,axiom,(
    ! [A_27a: del,A_27a: del,V1l: tp__ty_2Enum_2Enum,V0h: tp__ty_2Enum_2Enum] : mem(f2182(A_27a,A_27a,V1l,V0h),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) )).

tff(lameq_f2182,axiom,(
    ! [A_27a: del,A_27a: del,V1l: tp__ty_2Enum_2Enum,V0h: tp__ty_2Enum_2Enum,V2w: $i] :
      ( mem(V2w,ty_2Efcp_2Ecart(bool,bool))
     => ap(f2182(A_27a,A_27a,V1l,V0h),V2w) = ap(c_2Efcp_2EFCP(bool,bool),f2183(A_27a,V2w,V0h,V1l)) ) )).

tff(ax_thm_2Ewords_2Eword__signed__bits__def,axiom,(
    ! [A_27a: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__signed__bits(A_27a),inj__ty_2Enum_2Enum(V0h)),inj__ty_2Enum_2Enum(V1l)) = f2182(A_27a,A_27a,V1l,V0h) )).

tff(conj_thm_2Ewords_2Eword__signed__bits__n2w,conjecture,(
