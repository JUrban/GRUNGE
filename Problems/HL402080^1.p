...
thf(thm_2Elist_2ELIST__NOT__EQ,conjecture,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u] :
      ( ( (~)
        @ ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) ) )
     => ! [V2h1_2E0: u,V3h2_2E0: u] :
          ( (~)
          @ ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V2h1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) ) ) ) ) ) )).
