...
tff(lmtp_f3986,type,(
    f3986: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3986,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3986(A_27a,V1f,V3b),arr(A_27a,bool)) ) )).

tff(lameq_f3986,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V5x: $i] :
          ( mem(V5x,A_27a)
         => ap(f3986(A_27a,V1f,V3b),V5x) = ap(ap(c_2Ereal_2Ereal__lte,ap(V1f,V5x)),inj__ty_2Erealax_2Ereal(V3b)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__COMPONENT__UBOUND,lemma,(
    ! [A_27a: del,A_27b: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal,V4k: $i] :
              ( mem(V4k,A_27b)
             => ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                  ...
                  & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3986(A_27a,V1f,V3b)),V0net)) )
               => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V2l)),inj__ty_2Erealax_2Ereal(V3b))) ) ) ) ) )).

tff(lmtp_f3987,type,(
    f3987: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3987,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal] : mem(f3987(A_27a,V1f,V3b),arr(A_27a,bool)) ) )).

tff(lameq_f3987,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b: tp__ty_2Erealax_2Ereal,V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3987(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3b)),ap(V1f,V4x)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__COMPONENT__LBOUND,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3b: tp__ty_2Erealax_2Ereal] :
              ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net))
                & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3987(A_27a,V1f,V3b)),V0net)) )
             => p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V3b)),inj__ty_2Erealax_2Ereal(V2l))) ) ) ) )).

tff(lmtp_f3988,type,(
    f3988: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3988,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4b: tp__ty_2Erealax_2Ereal] : mem(f3988(A_27a,V1f,V4b),arr(A_27a,bool)) ) )).

tff(lameq_f3988,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4b: tp__ty_2Erealax_2Ereal,V5x: $i] :
          ( mem(V5x,A_27a)
         => ap(f3988(A_27a,V1f,V4b),V5x) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V1f,V5x)),inj__ty_2Erealax_2Ereal(V4b)) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__COMPONENT__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2i: $i] :
              ( mem(V2i,A_27b)
             => ! [V3l: tp__ty_2Erealax_2Ereal,V4b: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V3l)),V0net))
                    & ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                    & p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3988(A_27a,V1f,V4b)),V0net)) )
                 => V3l = V4b ) ) ) ) )).
