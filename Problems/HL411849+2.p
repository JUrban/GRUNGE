...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__GE__ON__CLOSURE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ABS__COMPOSE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ESETDIST__CLOSURE,conjecture,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ! [V1t] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
