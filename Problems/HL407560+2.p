...
fof(lamtp_f2749,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2749(V0x),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2749,axiom,(
    ! [V0x] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f2749(V0x),V1n) = ap(ap(c_2Ereal_2Ereal__lte,V0x),ap(c_2Ereal_2Ereal__of__num,V1n)) ) ) )).

fof(ax_thm_2Ereal_2ENUM__CEILING__def,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Ereal_2ENUM__CEILING,V0x) = ap(c_2Ewhile_2ELEAST,f2749(V0x)) ) )).

fof(conj_thm_2Ereal_2ELE__NUM__CEILING,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => p(ap(ap(c_2Ereal_2Ereal__lte,V0x),ap(c_2Ereal_2Ereal__of__num,ap(c_2Ereal_2ENUM__CEILING,V0x)))) ) )).
