...
thf(thm_2Ereal__topology_2ESUMMABLE__IFF__COFINITE,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2t: tyop_2Enum_2Enum > $o] :
      ( ( c_2Epred__set_2EFINITE @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EUNION @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EDIFF @ tyop_2Enum_2Enum @ V1s @ V2t ) @ ( c_2Epred__set_2EDIFF @ tyop_2Enum_2Enum @ V2t @ V1s ) ) )
     => ( ( c_2Ereal__topology_2Esummable @ V1s @ V0f )
        = ( c_2Ereal__topology_2Esummable @ V2t @ V0f ) ) ) )).
