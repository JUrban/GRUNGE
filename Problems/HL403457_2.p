...
tff(lmtp_f995,type,(
    f995: tp__ty_2Enum_2Enum > $i )).

tff(lamtp_f995,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum] : mem(f995(V0m),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f995,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1x: tp__ty_2Enum_2Enum] : ap(f995(V0m),inj__ty_2Enum_2Enum(V1x)) = ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1x)),ap(ap(c_2Earithmetic_2EEXP,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0m))) )).

tff(conj_thm_2EEncode_2Ewf__pred__bnum__total,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum] : p(ap(ap(c_2EEncode_2Ewf__pred__bnum,inj__ty_2Enum_2Enum(V0m)),f995(V0m))) )).
