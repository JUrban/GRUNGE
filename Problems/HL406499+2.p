...
fof(lamtp_f2301,axiom,(
    ! [V0x] :
      ( mem(V0x,bool)
     => mem(f2301(V0x),arr(bool,bool)) ) )).
...
fof(lameq_f2301,axiom,(
    ! [V0x] :
     ...
     => ! [V1y] :
          ( mem(V1y,bool)
         => ap(f2301(V0x),V1y) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,V0x),V1y)) ) ) )).

fof(lamtp_f2300,axiom,(
    mem(f2300,arr(bool,arr(bool,bool))) )).

fof(lameq_f2300,axiom,(
    ! [V0x] :
      ( mem(V0x,bool)
     => ap(f2300,V0x) = f2301(V0x) ) )).

fof(ax_thm_2Ebitstring_2Ebnor__def,axiom,(
    c_2Ebitstring_2Ebnor = ap(c_2Ebitstring_2Ebitwise,f2300) )).
...
fof(conj_thm_2Ebitstring_2Eword__nor__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
