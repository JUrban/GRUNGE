...
tff(conj_thm_2Esorting_2EPERM__CONS__IFF,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l2: $i] :
...
tff(conj_thm_2Esorting_2EPERM__SING,lemma,(
    ! [A_27a: del,V0L: $i] :
      ( mem(V0L,ty_2Elist_2Elist(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Esorting_2EPERM__EQUIVALENCE__ALT__DEF,lemma,(
    ! [A_27a: del,V0x: $i] :
...
tff(conj_thm_2Esorting_2EPERM__FUN__CONS__11__SWAP__AT__FRONT,lemma,(
    ! [A_27a: del,V0y: $i] :
      ( mem(V0y,A_27a)
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EPERM__FUN__CONS__APPEND__2,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EPERM__FUN__CONS__IFF,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Esorting_2EPERM__CONG__APPEND__IFF,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Emergesort_2Esort3__perm,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
