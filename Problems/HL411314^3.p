     ...
     => ( ( c_2Ereal__topology_2Einterior
        ...
        = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V3x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V3x @ ( c_2Erealax_2Ereal__lt @ ( c_2Erealax_2Ereal__mul @ V0a @ V3x ) @ V1b ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EINTERIOR__HALFSPACE__GE,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Ereal__topology_2Einterior
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2x: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Ereal_2Ereal__ge @ ( c_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) )
        = ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V3x: tyop_2Erealax_2Ereal] :
              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V3x @ ( c_2Ereal_2Ereal__gt @ ( c_2Erealax_2Ereal__mul @ V0a @ V3x ) @ V1b ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EINTERIOR__HYPERPLANE,conjecture,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( V0a
          = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) )
     => ( ( c_2Ereal__topology_2Einterior
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2x: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ ( c_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) )
