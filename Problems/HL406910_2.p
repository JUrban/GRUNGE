...
tff(conj_thm_2Efmapal_2Eassocv__ind,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)),arr(A_27a,bool)))
     => ( ( ! [V1a: $i] :
              ( mem(V1a,A_27a)
             => p(ap(ap(V0P,c_2Elist_2ENIL(ty_2Epair_2Eprod(A_27a,A_27a))),V1a)) )
          & ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ! [V4l: $i] :
                      ( mem(V4l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
                     => ! [V5a: $i] :
                          ( mem(V5a,A_27a)
                         => ( ( V5a != V2x
                             => p(ap(ap(V0P,V4l),V5a)) )
                           => p(ap(ap(V0P,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)),V4l)),V5a)) ) ) ) ) ) )
       => ! [V6v: $i] :
            ( mem(V6v,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
           => ! [V7v1: $i] :
                ( mem(V7v1,A_27a)
