...
thf(f13509_0_2E0,type,(
    f13509_0_2E0: u )).

thf(f13509_0_2E2,type,(
    f13509_0_2E2: du > du > u )).

thf(f13509_0_2E3,type,(
    f13509_0_2E3: du > du > du > u )).

thf(f13509_1_2E0,type,(
    f13509_1_2E0: u )).

thf(f13509_1_2E2,type,(
    f13509_1_2E2: du > du > u )).

thf(f13509_1_2E3,type,(
    f13509_1_2E3: du > du > du > u )).

thf(f13509_2_2E0,type,(
    f13509_2_2E0: u )).

thf(f13509_2_2E3,type,(
...
thf(mono_2Ef13509_0,type,(
    mono_2Ef13509_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13509_1,type,(
    mono_2Ef13509_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13509_2,type,(
    mono_2Ef13509_2: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2EFRONTIER__HALFSPACE__GE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13509_0 @ V0a @ V1b @ V2x )
...
thf(def1_2Ethm_2Ereal__topology_2EFRONTIER__HALFSPACE__GE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13509_2 @ V0a @ V3x @ V1b )
    <=> ( ( mono_2Ec_2Erealax_2Ereal__mul @ V0a @ V3x )
        = V1b ) ) )).

thf(def2_2Ethm_2Ereal__topology_2EFRONTIER__HALFSPACE__GE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13509_1 @ V0a @ V1b @ V3x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V3x @ ( mono_2Ef13509_2 @ V0a @ V3x @ V1b ) ) ) )).

thf(thm_2Ereal__topology_2EFRONTIER__HALFSPACE__GE,conjecture,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( ( V0a
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
          & ( V1b
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Efrontier @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13509_0 @ V0a @ V1b ) ) )
        = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13509_1 @ V0a @ V1b ) ) ) ) )).
