...
thf(c_2Eset__relation_2Eget__min,type,(
    c_2Eset__relation_2Eget__min: 
      !>[A_27a: $tType] :
        ( ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) > ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) ) > ( tyop_2Eoption_2Eoption @ A_27a ) ) )).
...
thf(thm_2Eset__relation_2Enth__min__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) > ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) ) > tyop_2Enum_2Enum > $o] :
      ( ( ! [V1r_27: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V2s: A_27a > $o,V3r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o] :
            ( V0P @ V1r_27 @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) @ V2s @ V3r ) @ c_2Enum_2E0 )
        & ! [V4r_27: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V5s: A_27a > $o,V6r: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V7n: tyop_2Enum_2Enum] :
            ( ! [V8min: tyop_2Eoption_2Eoption @ A_27a] :
                ( ( ( V8min
                    = ( c_2Eset__relation_2Eget__min @ A_27a @ V4r_27 @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) @ V5s @ V6r ) ) )
                  & ( (~)
                    @ ( V8min
                      = ( c_2Eoption_2ENONE @ A_27a ) ) ) )
               => ( V0P @ V4r_27 @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) @ ( c_2Epred__set_2EDELETE @ A_27a @ V5s @ ( c_2Eoption_2ETHE @ A_27a @ V8min ) ) @ V6r ) @ V7n ) )
           => ( V0P @ V4r_27 @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) @ V5s @ V6r ) @ ( c_2Enum_2ESUC @ V7n ) ) ) )
     => ! [V9v: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V10v1: A_27a > $o,V11v2: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V12v3: tyop_2Enum_2Enum] :
          ( V0P @ V9v @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o ) @ V10v1 @ V11v2 ) @ V12v3 ) ) )).
