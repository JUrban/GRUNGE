...
tff(f13226_0_2E0,type,(
    f13226_0_2E0: u )).

tff(f13226_0_2E2,type,(
    f13226_0_2E2: ( du * du ) > u )).

tff(f13226_0_2E3,type,(
...
tff(arityeq2_2Ef13226_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: mono_2Etyop_2Erealax_2Ereal] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f13226_0_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),X0_2E0),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(X1_2E0)))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),f13226_0_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),X0_2E0))),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(X1_2E0)))) )).

tff(arityeq3_2Ef13226_0_2E3,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: mono_2Etyop_2Erealax_2Ereal,X2_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13226_0_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),X0_2E0),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(X1_2E0)),s(A_27a,X2_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),tyop_2Emin_2Efun(tyop_2Erealax_2Ereal,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),f13226_0_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),X0_2E0))),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(X1_2E0)))),s(A_27a,X2_2E0)))) )).
...
tff(def0_2Ethm_2Ereal__topology_2ELIM__EVENTUALLY,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2l_2E0: mono_2Etyop_2Erealax_2Ereal,V3x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13226_0_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(V2l_2E0)),s(A_27a,V3x_2E0)))))
    <=> j_mono_2Etyop_2Erealax_2Ereal(s(tyop_2Erealax_2Ereal,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0),s(A_27a,V3x_2E0)))) = V2l_2E0 ) )).

tff(thm_2Ereal__topology_2ELIM__EVENTUALLY,conjecture,(
    ! [A_27a: d,V0net_2E0: u,V1f_2E0: u,V2l_2E0: mono_2Etyop_2Erealax_2Ereal] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Eeventually_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f13226_0_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Erealax_2Ereal),V1f_2E0),s(tyop_2Erealax_2Ereal,i_mono_2Etyop_2Erealax_2Ereal(V2l_2E0)))),s(tyop_2Ereal__topology_2Enet(A_27a),V0net_2E0)))))
