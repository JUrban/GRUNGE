...
fof(conj_thm_2Ereal__topology_2ELIM__NULL__SUB,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
         => ! [V1f] :
             ...
             => ! [V2g] :
                 ...
                 => ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net))
                   ...
                   => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3752(A_27a,V1f,V2g)),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0net)) ) ) ) ) ) )).
