...
thf(arityeq2_2Emono_2Ec_2Esorting_2EQSORT_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
...
thf(thm_2Esorting_2EPERM__TRANS,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u,V2z_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1y_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1y_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2z_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2z_2E0 ) ) ) ) ) )).
...
thf(thm_2Esorting_2EPERM__SYM,axiom,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u] :
      ...
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) ) ) ) )).

thf(thm_2Esorting_2EQSORT__PERM,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1L_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esorting_2EQSORT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Esorting_2EQSORT__SORTED,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1L_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2ESORTED_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esorting_2EQSORT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Esorting_2EQSORT__eq__if__PERM,conjecture,(
    ! [A_27a: d,V0R_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2Etotal_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2Etransitive_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Erelation_2Eantisymmetric_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) ) ) ) )
     => ! [V1l1_2E0: u,V2l2_2E0: u] :
          ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esorting_2EQSORT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) ) )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Esorting_2EQSORT_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) ) )
        <=> ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l2_2E0 ) ) ) ) ) ) )).
