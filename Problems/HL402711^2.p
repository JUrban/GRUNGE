...
thf(conj_thm_2Erich__list_2ESEG__APPEND2,conjecture,(
    ! [A_27a: del,V0l1: $i] :
     ...
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum,V3l2: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l1 ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) )
           ...
           => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V0l1 ) @ V3l2 ) )
              = ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l1 ) ) ) @ V3l2 ) ) ) ) ) )).
