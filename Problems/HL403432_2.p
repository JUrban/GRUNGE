...
tff(conj_thm_2EdirGraph_2EEXCLUDE__LEM,conjecture,(
    ! [A_27a: del,A_27b: del,V0G: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ap(ap(c_2EdirGraph_2EEXCLUDE(A_27b,A_27b),V0G),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1x),V2l)) = ap(ap(c_2EdirGraph_2EEXCLUDE(A_27b,A_27b),ap(ap(c_2EdirGraph_2EEXCLUDE(A_27b,A_27b),V0G),V2l)),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1x),c_2Epred__set_2EEMPTY(A_27a))) ) ) ) )).
