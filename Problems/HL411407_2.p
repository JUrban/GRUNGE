...
tff(conj_thm_2Ereal__topology_2ECONNECTED__UNION,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__REFL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2Econnected,ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)))) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EMPTY,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V1x)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
        <=> ~ p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V0s)) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__UNIQUE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
          ( mem(V1c,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V1c))
                & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1c),V0s))
                & p(ap(c_2Ereal__topology_2Econnected,V1c))
                & ! [V3c_27: $i] :
                    ( mem(V3c_27,arr(ty_2Erealax_2Ereal,bool))
                   => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V3c_27))
                        & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3c_27),V0s))
                        & p(ap(c_2Ereal__topology_2Econnected,V3c_27)) )
                     => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V3c_27),V1c)) ) ) )
             => ap(ap(c_2Ereal__topology_2Econnected__component,V0s),inj__ty_2Erealax_2Ereal(V2x)) = V1c ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EIN__COMPONENTS__MAXIMAL,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
          ( mem(V1c,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1c),ap(c_2Ereal__topology_2Ecomponents,V0s)))
          <=> ( V1c != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
              & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1c),V0s))
              & p(ap(c_2Ereal__topology_2Econnected,V1c))
              & ! [V2c_27: $i] :
                  ( mem(V2c_27,arr(ty_2Erealax_2Ereal,bool))
                 => ( ( V2c_27 != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                      & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V1c),V2c_27))
                      & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),V2c_27),V0s))
                      & p(ap(c_2Ereal__topology_2Econnected,V2c_27)) )
                   => V2c_27 = V1c ) ) ) ) ) ) )).
