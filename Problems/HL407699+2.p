...
fof(conj_thm_2EordNotationSemantics_2Eoless__total,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2EordinalNotation_2Eosyntax)
     => ! [V1n] :
          ( mem(V1n,ty_2EordinalNotation_2Eosyntax)
         => ( p(ap(ap(c_2EordinalNotation_2Eoless,V0m),V1n))
            | p(ap(ap(c_2EordinalNotation_2Eoless,V1n),V0m))
            | V0m = V1n ) ) ) )).

fof(conj_thm_2EordNotationSemantics_2Eord__less__modelled,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2EordinalNotation_2Eosyntax)
