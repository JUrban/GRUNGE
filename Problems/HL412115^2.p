...
thf(mem_c_2Eprobability_2Euniform__distribution,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] :
      ( mem @ ( c_2Eprobability_2Euniform__distribution @ A_27a @ A_27b @ A_27c @ A_27d ) @ ( arr @ A_27b @ ( arr @ A_27c @ ( arr @ ( ty_2Epair_2Eprod @ ( arr @ A_27d @ bool ) @ ( arr @ ( arr @ A_27d @ bool ) @ bool ) ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2ECARD__UNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ! [V1t: $i] :
     ...
     => ! [V1X: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ap @ ( ap @ ( ap @ ( c_2Eprobability_2Euniform__distribution @ A_27a @ A_27b @ A_27c @ A_27d ) @ V0p ) @ V1X ) @ V2s )
                = ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V3a: $i] :
                      ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ ( c_2Epred__set_2ECARD @ A_27a ) @ V3a ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ ( c_2Epred__set_2ECARD @ A_27d ) @ ( ap @ ( c_2Emeasure_2Espace @ A_27d ) @ V2s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eprobability_2Euniform__distribution__prob__space,conjecture,(
    ! [A_27a: del,A_27b: del,V0X: $i] :
      ( ( mem @ V0X @ ( arr @ A_27a @ A_27b ) )
     => ! [V1p: $i] :
          ( ( mem @ V1p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
