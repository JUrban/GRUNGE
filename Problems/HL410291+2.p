...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IN__IF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__DISJOINT__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1s_27] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
               ...
               => ! [V2f] :
                   ...
                   => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f),ap(ap(c_2Epred__set_2EUNION(A_27a),V0s),V1s_27)) = ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f),V0s)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f),V1s_27)) ) ) ) ) ) )).
     ...
     => ! [V5a] :
         ...
         => ! [V6x] :
             ...
             => ! [V7i] :
                 ...
                 => ap(f3607(A_27a,V2b,V5a,V6x),V7i) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),V5a),ap(V2b,V7i))),V6x) ) ) ) ) )).

fof(lamtp_f3606,axiom,(
    ! [A_27a,V2b] :
      ( mem(V2b,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V5a] :
          ( mem(V5a,arr(A_27a,bool))
...
fof(conj_thm_2Emeasure_2Eindicator__fn__split,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0r] :
          ( mem(V0r,arr(ty_2Enum_2Enum,bool))
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V0r))
                      ...
                      & ! [V3i] :
                         ...
                         => ! [V4j] :
                             ...
                             => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V3i),V0r))
                                  & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4j),V0r))
                                  & V3i != V4j )
                               => p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(V2b,V3i)),ap(V2b,V4j))) ) ) ) )
                   => ! [V5a] :
                        ( mem(V5a,arr(A_27a,bool))
