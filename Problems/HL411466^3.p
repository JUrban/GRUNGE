...
thf(thm_2Ereal__topology_2ELIM,axiom,(
    ...
    <=> ( ( c_2Ereal__topology_2Etrivial__limit @ A_27a @ V0net )
        | ! [V3e: tyop_2Erealax_2Ereal] :
           ...
           => ? [V4y: A_27a] :
                ( ? [V5x: A_27a] :
                    ( c_2Ereal__topology_2Enetord @ A_27a @ V0net @ V5x @ V4y )
                & ! [V6x: A_27a] :
...
thf(thm_2Ereal__topology_2Econtinuous,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1net: tyop_2Ereal__topology_2Enet @ A_27a] :
      ( ( c_2Ereal__topology_2Econtinuous @ A_27a @ V0f @ V1net )
      = ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a @ V0f @ ( V0f @ ( c_2Ereal__topology_2Enetlimit @ A_27a @ V1net ) ) @ V1net ) ) )).
...
thf(thm_2Ereal__topology_2ECONTINUOUS__AT__WITHIN__INV,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V2a ) @ V1s ) )
        & ( (~)
          @ ( ( V0f @ V2a )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ ( c_2Ecombin_2Eo @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ c_2Erealax_2Einv @ V0f ) @ ( c_2Ereal__topology_2Ewithin @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Eat @ V2a ) @ V1s ) ) ) )).
