...
thf(c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E0,type,(
    c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E0: u )).

thf(c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E1,type,(
...
thf(arityeq1_2Emono_2Ec_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(thm_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN__def,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) )
    <=> ! [V1v_2E0: u] :
        ? [V2x_2E0: u] :
          ( ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
          = ( s @ A_27b @ V1v_2E0 ) ) ) )).
...
thf(thm_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN______EXISTS__THM,conjecture,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1P_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EquantHeuristics_2EIS__REMOVABLE__QUANT__FUN_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) ) ) )
     => ( ? [V2x_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) ) ) )
      <=> ? [V3x_27_2E0: u] :
            ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ V1P_2E0 ) @ ( s @ A_27b @ V3x_27_2E0 ) ) ) ) ) ) )).
