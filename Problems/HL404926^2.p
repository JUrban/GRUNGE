...
thf(conj_thm_2Epred__set_2ESUBSET__SUBSET__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EBIGUNION__applied,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1sos: $i] :
...
thf(conj_thm_2Etopology_2EOPEN__UNOPEN,conjecture,(
    ! [A_27a: del,V0S_27: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ A_27a ) @ V1top ) @ V0S_27 ) )
          <=> ( ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                  @ ( lam @ ( arr @ A_27a @ bool )
                    @ ^ [V2P: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V2P ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ A_27a ) @ V1top ) @ V2P ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V2P ) @ V0S_27 ) ) ) ) ) )
              = V0S_27 ) ) ) ) )).
