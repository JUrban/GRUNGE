...
fof(conj_thm_2Ereal__topology_2EOPEN__INTER__CLOSURE__EQ__EMPTY,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECLOSURE__OPEN__INTERVAL,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EINTER__INTERVAL__MIXED__EQ__EMPTY,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2c] :
             ...
             => ! [V3d] :
                 ...
                 => ( ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2c),V3d)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
