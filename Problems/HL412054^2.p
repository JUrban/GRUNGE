...
thf(conj_thm_2Eextreal_2Ele__max,lemma,(
...
thf(conj_thm_2Elebesgue_2Epos__fn__integral__add,lemma,(
    ! [A_27a: del,V0m: $i] :
...
thf(ax_thm_2Elebesgue_2ERADON__F__def,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1v: $i] :
          ( ( mem @ V1v @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
         => ( ( ap @ ( ap @ ( c_2Elebesgue_2ERADON__F @ A_27a ) @ V0m ) @ V1v )
            = ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
              @ ( lam @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal )
                @ ^ [V2f: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) @ bool ) @ V2f )
                    @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ V2f ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) @ ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V0m ) ) @ ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V0m ) ) ) @ c_2Emeasure_2EBorel ) ) )
                      @ ( ap
                        @ ( ap @ c_2Ebool_2E_2F_5C
                          @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V3x: $i] :
                                  ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ V2f @ V3x ) ) ) ) )
                        @ ( ap @ ( c_2Ebool_2E_21 @ ( arr @ A_27a @ bool ) )
                          @ ( lam @ ( arr @ A_27a @ bool )
                            @ ^ [V4A: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V4A ) @ ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V0m ) ) )
                                @ ( ap
                                  ...
                                  @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27a ) @ V1v ) @ V4A ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EMEASURE__SPACE__INTER,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Emeasure_2EMEASURE__SPACE__SUBSET__MSPACE,lemma,(
    ! [A_27a: del,V0A: $i] :
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LT,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2a: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ V0f ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V2a ) @ c_2Emeasure_2EBorel ) ) )
                  & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) ) @ V1g ) @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V2a ) @ c_2Emeasure_2EBorel ) ) ) )
               => ( p
                  @ ( ap
                      ...
                      @ ( ap
                        @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a )
                          @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V3x: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__lt @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) ) ) )
                        @ ( ap @ ( c_2Emeasure_2Espace @ A_27a ) @ V2a ) ) )
                    @ ( ap @ ( c_2Emeasure_2Esubsets @ A_27a ) @ V2a ) ) ) ) ) ) ) )).

thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                      ...
                      @ ( ap
                        @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a )
                          @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V3x: $i] :
                                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) ) ) )
                        @ ( ap @ ( c_2Emeasure_2Espace @ A_27a ) @ V2a ) ) )
                    @ ( ap @ ( c_2Emeasure_2Esubsets @ A_27a ) @ V2a ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MAX,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
               ...
               => ( p
                  @ ( ap
                    @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Eextreal_2Eextreal__max @ ( ap @ V1f @ V3x ) ) @ ( ap @ V2g @ V3x ) ) ) )
                    @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasurable @ A_27a @ ty_2Eextreal_2Eextreal ) @ V0a ) @ c_2Emeasure_2EBorel ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Elemma__radon__max__in__F,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
         => ! [V2m: $i] :
             ...
             => ! [V3v: $i] :
                  ( ( mem @ V3v @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
                 => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V2m ) )
                      & ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V3v ) )
                      & ( ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V3v )
                        = ( ap @ ( c_2Emeasure_2Em__space @ A_27a ) @ V2m ) )
                      & ( ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V3v )
                        = ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V2m ) )
                   ...
                   => ( p
                      @ ( ap
                        @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ c_2Eextreal_2Eextreal__max @ ( ap @ V0f @ V4x ) ) @ ( ap @ V1g @ V4x ) ) ) )
                        @ ( ap @ ( ap @ ( c_2Elebesgue_2ERADON__F @ A_27a ) @ V2m ) @ V3v ) ) ) ) ) ) ) ) )).
