...
thf(thm_2Epair_2Epair__case__eq,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u,V1p_2E0: u,V2f_2E0: u] :
      ( ( ( s @ A_27a @ ( c_2Epair_2Epair__CASE_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ V1p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ V2f_2E0 ) ) )
        = ( s @ A_27a @ V0v_2E0 ) )
    <=> ? [V3x_2E0: u,V4y_2E0: u] :
          ( ( ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ V1p_2E0 )
            = ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27b @ V3x_2E0 ) @ ( s @ A_27c @ V4y_2E0 ) ) ) )
          & ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ V2f_2E0 ) @ ( s @ A_27b @ V3x_2E0 ) ) ) @ ( s @ A_27c @ V4y_2E0 ) ) )
            = ( s @ A_27a @ V0v_2E0 ) ) ) ) )).
