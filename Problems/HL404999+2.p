...
fof(conj_thm_2Equotient__list_2EFOLDR__RSP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                                     ...
                                                     => ! [V8f1] :
                                                         ...
                                                         => ! [V9f2] :
                                                             ...
                                                             => ! [V10e1] :
                                                                 ...
                                                                 => ! [V11e2] :
                                                                      ( mem(V11e2,A_27b)
                                                                     => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R1),ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27b,A_27b),V3R2),V3R2)),V8f1),V9f2))
                                                                          & p(ap(ap(V3R2,V10e1),V11e2))
                                                                          & p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R1),V6l1),V7l2)) )
                                                                       => p(ap(ap(V3R2,ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V8f1),V10e1),V6l1)),ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V9f2),V11e2),V7l2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
