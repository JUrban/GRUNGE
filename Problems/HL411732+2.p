...
fof(lamtp_f3281,axiom,(
    ! [V1n] :
      ( mem(V1n,ty_2Enum_2Enum)
     => ! [V0m] :
          ( mem(V0m,ty_2Enum_2Enum)
         => mem(f3281(V1n,V0m),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) ) )).
    ...
    ! [V1n] :
     ...
     => ! [V0m] :
         ...
         => ! [V2x] :
             ...
             => ap(f3281(V1n,V0m),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Earithmetic_2E_3C_3D,V0m),V2x)),ap(ap(c_2Earithmetic_2E_3C_3D,V2x),V1n))) ) ) ) )).
...
fof(ax_thm_2Eiterate_2Enumseg,axiom,(
    ! [V0m] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(ap(c_2Eiterate_2E_2E_2E,V0m),V1n) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3281(V1n,V0m)) ) ) )).
...
fof(lamtp_f3740,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => mem(f3740(V0n),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))) ) )).

fof(lameq_f3740,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
         => ap(f3740(V0n),V1m) = ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1m),ap(ap(c_2Earithmetic_2E_3C_3D,V0n),V1m)) ) ) )).

fof(ax_thm_2Ereal__topology_2Efrom,axiom,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Ereal__topology_2Efrom,V0n) = ap(c_2Epred__set_2EGSPEC(ty_2Enum_2Enum,ty_2Enum_2Enum),f3740(V0n)) ) )).
...
fof(lamtp_f4012,axiom,(
    ! [V2k] :
      ( mem(V2k,ty_2Enum_2Enum)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => mem(f4012(V2k,V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).
...
fof(lameq_f4012,axiom,(
    ! [V2k] :
     ...
     => ! [V0f] :
         ...
         => ! [V3n] :
              ( mem(V3n,ty_2Enum_2Enum)
             => ap(f4012(V2k,V0f),V3n) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,V2k),V3n)),V0f) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__FROM,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
          ( mem(V1l,ty_2Erealax_2Ereal)
         => ! [V2k] :
              ( mem(V2k,ty_2Enum_2Enum)
             => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),ap(c_2Ereal__topology_2Efrom,V2k)))
              <=> p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4012(V2k,V0f)),V1l),c_2Ereal__topology_2Esequentially)) ) ) ) ) )).
