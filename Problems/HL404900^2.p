...
thf(conj_thm_2Elbtree_2Ebf__flatten__eq__lnil,lemma,(
    ! [A_27a: del,V0l: $i] :
...
thf(conj_thm_2Elbtree_2Ebf__flatten__append,lemma,(
    ! [A_27a: del,V0l2: $i] :
...
thf(conj_thm_2Elbtree_2EEXISTS__FIRST,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l: $i] :
...
thf(conj_thm_2Elist_2EEXISTS__APPEND,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Ellist_2Eexists__ind,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1exists_27: $i] :
...
thf(conj_thm_2Elbtree_2Eexists__bf__flatten,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1tlist: $i] :
