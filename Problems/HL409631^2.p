...
thf(conj_thm_2Eiterate_2EREAL__LE__SUP__FINITE,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Eiterate_2EREAL__SUP__LE__FINITE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Erealax_2Ereal ) @ V0s ) )
