...
fof(ax_thm_2Ewhile_2ELEAST__DEF,axiom,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ap(c_2Ewhile_2ELEAST,V0P) = ap(ap(ap(c_2Ewhile_2EWHILE(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),V0P)),c_2Enum_2ESUC),c_2Enum_2E0) ) )).

fof(conj_thm_2Ewhile_2ELESS__LEAST,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Enum_2Enum,bool))
     => ! [V1m] :
