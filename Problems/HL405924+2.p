...
fof(mem_c_2Ewords_2Ereduce__nand,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Ereduce__nand(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(lamtp_f2175,axiom,(
    ! [V0a] :
      ( mem(V0a,bool)
     => mem(f2175(V0a),arr(bool,bool)) ) )).
...
fof(lameq_f2175,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
          ( mem(V1b,bool)
         => ap(f2175(V0a),V1b) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_2F_5C,V0a),V1b)) ) ) )).

fof(lamtp_f2174,axiom,(
    mem(f2174,arr(bool,arr(bool,bool))) )).

fof(lameq_f2174,axiom,(
    ! [V0a] :
      ( mem(V0a,bool)
     => ap(f2174,V0a) = f2175(V0a) ) )).

fof(ax_thm_2Ewords_2Ereduce__nand__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ewords_2Ereduce__nand(A_27a) = ap(c_2Ewords_2Eword__reduce(A_27a),f2174) ) )).
...
fof(lameq_f2237,axiom,(
    ! [V1l] :
     ...
     => ap(f2237,V1l) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__nand(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),V1l)),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),V1l)) ) )).

fof(conj_thm_2Ewords_2Efoldl__reduce__nand,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ereduce__nand(A_27a),V0w) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2237),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).
