...
tff(conj_thm_2Etopology_2ECLOSED__IN__BIGUNION,lemma,(
    ! [A_27a: del,V0top: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__TRANS,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__COMPONENT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__COMPONENTS__FINITE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
