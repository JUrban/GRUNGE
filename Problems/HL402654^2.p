...
thf(conj_thm_2Erich__list_2EFOLDL__FILTER,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1e: $i] :
         ...
         => ! [V2P: $i] :
             ...
             => ! [V3l: $i] :
                 ...
                 => ( ( ap @ ( ap @ ( ap @ ( c_2Elist_2EFOLDL @ A_27b @ A_27a ) @ V0f ) @ V1e ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27b ) @ V2P ) @ V3l ) )
                    = ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Elist_2EFOLDL @ A_27b @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( lam @ A_27b
                                @ ^ [V5y: $i] :
                                    ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ V2P @ V5y ) ) @ ( ap @ ( ap @ V0f @ V4x ) @ V5y ) ) @ V4x ) ) ) )
                        @ V1e )
                      @ V3l ) ) ) ) ) ) )).
