...
fof(conj_thm_2Epred__set_2ESING,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
...
fof(conj_thm_2Epred__set_2ESING__FINITE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Epred__set_2ECARD__COUNT,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ap(c_2Epred__set_2ECARD(ty_2Enum_2Enum),ap(c_2Epred__set_2Ecount,V0n)) = V0n ) )).
...
fof(conj_thm_2Ecardinal_2ECARDEQ__CARD__EQN,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EEMPTY__set__exp,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ecardinal_2EEMPTY__set__exp__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0A] :
              ( mem(V0A,arr(A_27b,bool))
             => p(ap(ap(c_2Ecardinal_2Ecardeq(arr(A_27a,ty_2Eoption_2Eoption(A_27b)),arr(A_27a,ty_2Eoption_2Eoption(A_27b))),ap(ap(c_2Ecardinal_2Eset__exp(A_27a,A_27a),V0A),c_2Epred__set_2EEMPTY(A_27a))),ap(c_2Epred__set_2Ecount,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) )).
