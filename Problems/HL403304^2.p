...
thf(conj_thm_2Ebag_2ESET__OF__BAG__INSERT,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ( ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0e ) @ V1b ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V0e ) @ ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ V1b ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2ESET__OF__BAG__EQ__EMPTY,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( ( mem @ V0b @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ( ( ( ( c_2Epred__set_2EEMPTY @ A_27a )
