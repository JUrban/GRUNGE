...
thf(conj_thm_2Erich__list_2EMAP__FLAT,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ ( ty_2Elist_2Elist @ A_27a ) ) )
         => ( ( ap @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27b ) @ V0f ) @ ( ap @ ( c_2Elist_2EFLAT @ A_27a ) @ V1l ) )
            = ( ap @ ( c_2Elist_2EFLAT @ A_27b ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( c_2Elist_2EMAP @ A_27a @ A_27b ) @ V0f ) ) @ V1l ) ) ) ) ) )).
