...
fof(lamtp_f888,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f888(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f888,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f888(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V1b),V2t0)),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESWHEN__AS__WHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2ESWHEN,V0a),V1b) = f888(V0a,V1b) ) ) )).
