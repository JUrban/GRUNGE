...
thf(thm_2Ebit_2EBIT__REVERSE__def,axiom,
    ( ! [V0x: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBIT__REVERSE @ c_2Enum_2E0 @ V0x )
        = c_2Enum_2E0 )
    & ! [V1n: tyop_2Enum_2Enum,V2x: tyop_2Enum_2Enum] :
        ( ( c_2Ebit_2EBIT__REVERSE @ ( c_2Enum_2ESUC @ V1n ) @ V2x )
        = ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ ( c_2Ebit_2EBIT__REVERSE @ V1n @ V2x ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ebit_2ESBIT @ ( c_2Ebit_2EBIT @ V1n @ V2x ) @ c_2Enum_2E0 ) ) ) )).
...
thf(thm_2Ebit_2EBIT__REVERSE__THM,conjecture,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V0x @ V1n )
     => ( ( c_2Ebit_2EBIT @ V0x @ ( c_2Ebit_2EBIT__REVERSE @ V1n @ V2a ) )
        = ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ V1n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V0x ) @ V2a ) ) ) )).
