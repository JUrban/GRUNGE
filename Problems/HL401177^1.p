...
thf(f1410_0_2E0,type,(
    f1410_0_2E0: u )).

thf(f1410_0_2E2,type,(
    f1410_0_2E2: du > du > u )).

thf(f1410_0_2E3,type,(
    f1410_0_2E3: du > du > du > u )).
...
thf(c_2Elogroot_2EROOT_2E0,type,(
    c_2Elogroot_2EROOT_2E0: u )).

thf(c_2Elogroot_2EROOT_2E2,type,(
    c_2Elogroot_2EROOT_2E2: du > du > u )).
...
thf(mono_2Ef1410_0,type,(
    mono_2Ef1410_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(mono_2Ec_2Elogroot_2EROOT,type,(
    mono_2Ec_2Elogroot_2EROOT: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Elogroot_2EEXP__LE__ISO,axiom,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum,V2r: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V2r )
     => ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V0a @ V1b )
        = ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EEXP @ V0a @ V2r ) @ ( mono_2Ec_2Earithmetic_2EEXP @ V1b @ V2r ) ) ) ) )).

thf(thm_2Elogroot_2EROOT,axiom,(
    ! [V0r: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0r )
     => ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Elogroot_2EROOT @ V0r @ V1n ) @ V0r ) @ V1n )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Elogroot_2EROOT @ V0r @ V1n ) ) @ V0r ) ) ) ) )).

thf(thm_2Elogroot_2EROOT__UNIQUE,axiom,(
    ! [V0r: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum,V2p: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Earithmetic_2EEXP @ V2p @ V0r ) @ V1n )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Enum_2ESUC @ V2p ) @ V0r ) ) )
     => ( ( mono_2Ec_2Elogroot_2EROOT @ V0r @ V1n )
        = V2p ) ) )).

thf(thm_2Elogroot_2EROOT__DIV,axiom,(
    ! [V0r: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Enum_2Enum,V2y: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0r )
        & ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V2y ) )
     => ( ( mono_2Ec_2Earithmetic_2EDIV @ ( mono_2Ec_2Elogroot_2EROOT @ V0r @ V1x ) @ V2y )
        = ( mono_2Ec_2Elogroot_2EROOT @ V0r @ ( mono_2Ec_2Earithmetic_2EDIV @ V1x @ ( mono_2Ec_2Earithmetic_2EEXP @ V2y @ V0r ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elogroot_2EROOT__COMPUTE,axiom,(
    ! [V1n: mono_2Etyop_2Enum_2Enum,V0r: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef1410_0 @ V1n @ V0r @ V2x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Enum_2ESUC @ V2x ) @ V0r ) ) @ V2x @ ( mono_2Ec_2Enum_2ESUC @ V2x ) ) ) )).

thf(thm_2Elogroot_2EROOT__COMPUTE,conjecture,(
    ! [V0r: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V0r )
     => ( ( ( mono_2Ec_2Elogroot_2EROOT @ V0r @ mono_2Ec_2Enum_2E0 )
          = mono_2Ec_2Enum_2E0 )
        & ( ( mono_2Ec_2Elogroot_2EROOT @ V0r @ V1n )
          = ( mono_2Ec_2Ebool_2ELET_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ef1410_0 @ V1n @ V0r ) @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( mono_2Ec_2Elogroot_2EROOT @ V0r @ ( mono_2Ec_2Earithmetic_2EDIV @ V1n @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0r ) ) ) ) ) ) ) ) )).
