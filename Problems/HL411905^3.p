...
thf(thm_2Eiterate_2EREAL__SUP__LE__EQ,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1y: tyop_2Erealax_2Ereal] :
      ( ( ( (~)
          @ ( V0s
     ...
     => ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Esup @ V0s ) @ V1y )
      <=> ! [V4x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s )
           => ( c_2Ereal_2Ereal__lte @ V4x @ V1y ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EHAUSDIST__NONTRIVIAL__ALT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        & ( c_2Ereal__topology_2Ebounded__def @ V1t )
        & ( (~)
...
thf(thm_2Ereal__topology_2EREAL__HAUSDIST__LE__EQ,conjecture,(
