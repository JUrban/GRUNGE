...
tff(thm_2EquantHeuristics_2EISR__exists,conjecture,(
    ...
    <=> ? [V1r_2E0: u] : s(tyop_2Esum_2Esum(A_27a,A_27b),V0x_2E0) = s(tyop_2Esum_2Esum(A_27a,A_27b),c_2Esum_2EINR_2E1(s(A_27b,V1r_2E0))) ) )).
