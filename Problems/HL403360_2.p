...
tff(conj_thm_2Ebag_2ECOMMUTING__ITBAG__INSERT,lemma,(
...
tff(ax_thm_2Ebag_2EBAG__GEN__PROD__def,axiom,(
    ! [V0bag: $i] :
      ( mem(V0bag,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1n: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0bag),inj__ty_2Enum_2Enum(V1n))) = surj__ty_2Enum_2Enum(ap(ap(ap(c_2Ebag_2EITBAG(ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Earithmetic_2E_2A),V0bag),inj__ty_2Enum_2Enum(V1n))) ) )).

tff(conj_thm_2Ebag_2EBAG__GEN__PROD__TAILREC,conjecture,(
    ! [V0b: $i] :
