    ...
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2b: tyop_2Erealax_2Ereal] :
      ( ( ( (~)
        ...
        & ( (~)
          @ ( V1t
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) @ V2b ) )
     => ? [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
          ...
          & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V3x @ V4y ) ) @ V2b ) ) ) )).
...
thf(thm_2Ereal__topology_2EREAL__LT__HAUSDIST__POINT__EXISTS,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2x: tyop_2Erealax_2Ereal,V3d: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        & ( c_2Ereal__topology_2Ebounded__def @ V1t )
        & ( (~)
          @ ( V1t
            = ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) ) @ V3d )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2x @ V0s ) )
     => ? [V4y: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4y @ V1t )
          & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2x @ V4y ) ) @ V3d ) ) ) )).
