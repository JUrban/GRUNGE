...
fof(conj_thm_2Ebft_2EBFT__ALL__DISTINCT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0G] :
          ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
         => ! [V1seen] :
             ...
             => ! [V2fringe] :
                 ...
                 => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2EdirGraph_2EParents(A_27a,A_27a),V0G)))
                   => p(ap(c_2Elist_2EALL__DISTINCT(A_27a),ap(ap(ap(ap(ap(c_2Ebft_2EBFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),c_2Elist_2ECONS(A_27a)),V1seen),V2fringe),c_2Elist_2ENIL(A_27a)))) ) ) ) ) ) )).
