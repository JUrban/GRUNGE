...
tff(conj_thm_2Epred__set_2EINSERT__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOLLINEAR__SING,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECOLLINEAR__2,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECOLLINEAR__LEMMA,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
