...
tff(conj_thm_2Ereal__topology_2ELIM__CMUL__EQ,lemma,(
    ! [A_27a: del,V0net: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__EQ,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3174(A_27a,V1f,V2c)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net))
