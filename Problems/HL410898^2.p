...
thf(conj_thm_2Eprim__rec_2Enum__Axiom,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ! [V1f: $i] :
...
thf(conj_thm_2Ereal__topology_2EDIST__POS__LT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( V0x != V1y )
...
thf(conj_thm_2Ereal__topology_2EWLOG__LT,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) )
     => ( ( ! [V1m: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) )
       ...
       => ! [V6m: tp__ty_2Enum_2Enum,V7y: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V6m ) ) @ ( inj__ty_2Enum_2Enum @ V7y ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LT,lemma,(
    ! [V0R: $i] :
     ...
     => ( ( ! [V1x: tp__ty_2Enum_2Enum,V2y: tp__ty_2Enum_2Enum,V3z: tp__ty_2Enum_2Enum] :
          ...
          & ! [V4n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0R @ ( inj__ty_2Enum_2Enum @ V4n ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V4n ) ) ) ) )
...
thf(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL__INJ,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V1s ) )
      <=> ? [V2f: $i] :
