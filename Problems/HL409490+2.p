...
fof(conj_thm_2Etransc_2ELN__INJ,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Etransc_2ELN__1,lemma,(
...
fof(conj_thm_2Eutil__prob_2Elg__1,lemma,(
...
fof(conj_thm_2Eutil__prob_2Elg__nonzero,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ( ( V0x != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
