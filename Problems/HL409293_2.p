...
tff(conj_thm_2Ebinary__ieee_2Elargest__lt__threshold,lemma,(
    ! [A_27t: del,A_27w: del] : p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) )).

tff(conj_thm_2Elift__ieee_2Efloat__to__real__finite,lemma,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
     ...
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0x))
       => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0x))),ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) ) ) )).

tff(conj_thm_2Elift__ieee_2Efloat__to__real__threshold,conjecture,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0x))
