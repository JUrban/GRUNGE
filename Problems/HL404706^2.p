     ...
     => ! [V1r: $i] :
         ...
         => ( ( ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Efinite__map_2ERRESTRICT @ A_27a @ A_27b ) @ V0f ) @ V1r ) )
              = ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ A_27b ) @ V0f ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ A_27b ) @ V0f ) @ V2x ) ) @ V1r ) ) ) ) ) )
            & ! [V3x: $i] :
                ( ( mem @ V3x @ A_27a )
...
thf(conj_thm_2Efinite__map_2ERRESTRICT__FUPDATE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1r: $i] :
          ( ( mem @ V1r @ ( arr @ A_27b @ bool ) )
