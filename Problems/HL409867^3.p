...
thf(thm_2Eiterate_2ENUMSEG__OFFSET__IMAGE,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum,V2p: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V0m @ V2p ) @ ( c_2Earithmetic_2E_2B @ V1n @ V2p ) )
      = ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
        @ ^ [V3i: tyop_2Enum_2Enum] :
            ( c_2Earithmetic_2E_2B @ V3i @ V2p )
      ...
      ( ! [V3x: A_27a,V4y: A_27a] :
          ( ( ( c_2Ebool_2EIN @ A_27a @ V3x @ V2s )
            ...
            & ( ( V0f @ V3x )
              = ( V0f @ V4y ) ) )
         => ( V3x = V4y ) )
     => ( ( c_2Eiterate_2ESum @ A_27b @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b @ V0f @ V2s ) @ V1g )
        = ( c_2Eiterate_2ESum @ A_27a @ V2s @ ( c_2Ecombin_2Eo @ A_27a @ tyop_2Erealax_2Ereal @ A_27b @ V1g @ V0f ) ) ) ) )).

thf(thm_2Eiterate_2ESUM__OFFSET,conjecture,(
    ! [V0p: tyop_2Enum_2Enum,V1f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ ( c_2Earithmetic_2E_2B @ V2m @ V0p ) @ ( c_2Earithmetic_2E_2B @ V3n @ V0p ) ) @ V1f )
      = ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V2m @ V3n )
        @ ^ [V4i: tyop_2Enum_2Enum] :
            ( V1f @ ( c_2Earithmetic_2E_2B @ V4i @ V0p ) ) ) ) )).
