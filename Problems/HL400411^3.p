...
thf(c_2Erelation_2Eapprox,type,(
    c_2Erelation_2Eapprox: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( A_27a > A_27a > $o ) > ( ( A_27a > A_27b ) > A_27a > A_27b ) > A_27a > ( A_27a > A_27b ) > $o ) )).

thf(c_2Erelation_2Ethe__fun,type,(
    c_2Erelation_2Ethe__fun: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( A_27a > A_27a > $o ) > ( ( A_27a > A_27b ) > A_27a > A_27b ) > A_27a > A_27a > A_27b ) )).
...
thf(thm_2Erelation_2ETC__TRANSITIVE,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o] :
      ( c_2Erelation_2Etransitive @ A_27a @ ( c_2Erelation_2ETC @ A_27a @ V0R ) ) )).
...
thf(thm_2Erelation_2Eapprox__def,axiom,(
    ...
    <=> ( V3f
        = ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b
          @ ^ [V4y: A_27a] :
              ( V1M @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b @ V3f @ V0R @ V4y ) @ V4y )
          @ V0R
          @ V2x ) ) ) )).
      ...
      = ( ^ [V2x: A_27a] :
            ...
            @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b
              @ ( c_2Erelation_2Ethe__fun @ A_27a @ A_27b @ ( c_2Erelation_2ETC @ A_27a @ V0R )
                @ ^ [V3f: A_27a > A_27b,V4v: A_27a] :
                    ( V1M @ ( c_2Erelation_2ERESTRICT @ A_27a @ A_27b @ V3f @ V0R @ V4v ) @ V4v )
                @ V2x )
              @ V0R
              @ V2x )
            @ V2x ) ) ) )).
