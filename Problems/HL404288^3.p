...
thf(thm_2Emergesort_2Emerge__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( A_27a > A_27a > $o ) > ( tyop_2Elist_2Elist @ A_27a ) > ( tyop_2Elist_2Elist @ A_27a ) > $o] :
      ( ( ! [V1R: A_27a > A_27a > $o] :
            ( V0P @ V1R @ ( c_2Elist_2ENIL @ A_27a ) @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V2R: A_27a > A_27a > $o,V3v8: A_27a,V4v9: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V2R @ ( c_2Elist_2ECONS @ A_27a @ V3v8 @ V4v9 ) @ ( c_2Elist_2ENIL @ A_27a ) )
        & ! [V5R: A_27a > A_27a > $o,V6v4: A_27a,V7v5: tyop_2Elist_2Elist @ A_27a] :
            ( V0P @ V5R @ ( c_2Elist_2ENIL @ A_27a ) @ ( c_2Elist_2ECONS @ A_27a @ V6v4 @ V7v5 ) )
     ...
     => ! [V13v: A_27a > A_27a > $o,V14v1: tyop_2Elist_2Elist @ A_27a,V15v2: tyop_2Elist_2Elist @ A_27a] :
          ( V0P @ V13v @ V14v1 @ V15v2 ) ) )).
