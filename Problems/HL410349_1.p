...
tff(f13855_0_2E0,type,(
    f13855_0_2E0: u )).

tff(f13855_0_2E2,type,(
    f13855_0_2E2: ( du * du ) > u )).

tff(f13855_0_2E3,type,(
    f13855_0_2E3: ( du * du * du ) > u )).
...
tff(arityeq2_2Ef13855_0_2E2,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f13855_0_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27a),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),f13855_0_2E0),s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0))),s(A_27a,X1_2E0))) )).

tff(arityeq3_2Ef13855_0_2E3,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13855_0_2E3(s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0),s(A_27a,X1_2E0),s(A_27a,X2_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,A_27a),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool))),f13855_0_2E0),s(tyop_2Emin_2Efun(A_27a,A_27a),X0_2E0))),s(A_27a,X1_2E0))),s(A_27a,X2_2E0)))) )).
...
tff(def0_2Ethm_2Ereal__topology_2Epermutes,axiom,(
    ! [A_27a: d,V0p_2E0: u,V3y_2E0: u,V4x_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,f13855_0_2E3(s(tyop_2Emin_2Efun(A_27a,A_27a),V0p_2E0),s(A_27a,V3y_2E0),s(A_27a,V4x_2E0)))))
...
tff(thm_2Ereal__topology_2Epermutes,axiom,(
    ...
    <=> ( ! [V2x_2E0: u] :
        ...
        & ! [V3y_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2E_3F_21_2E1(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),f13855_0_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0p_2E0),s(A_27a,V3y_2E0))))))) ) ) )).
...
tff(thm_2Ereal__topology_2EPERMUTES__INJECTIVE,conjecture,(
    ! [A_27a: d,V0p_2E0: u,V1s_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ereal__topology_2Epermutes_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),V0p_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V1s_2E0)))))
     => ! [V2x_2E0: u,V3y_2E0: u] :
