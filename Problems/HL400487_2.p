...
tff(tp_c_2Erelation_2ERDOM__DELETE,type,(
    c_2Erelation_2ERDOM__DELETE: ( del * del ) > $i )).

tff(mem_c_2Erelation_2ERDOM__DELETE,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2Erelation_2ERDOM__DELETE(A_27a,A_27a),arr(arr(A_27a,arr(A_27b,bool)),arr(A_27a,arr(A_27a,arr(A_27b,bool))))) )).
...
tff(ax_thm_2Erelation_2ERDOM__DELETE__DEF,axiom,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2u: $i] :
             ...
             => ! [V3v: $i] :
                  ( mem(V3v,A_27b)
                 => ( p(ap(ap(ap(ap(c_2Erelation_2ERDOM__DELETE(A_27a,A_27a),V0R),V1x),V2u),V3v))
                  <=> ( p(ap(ap(V0R,V2u),V3v))
                      & V2u != V1x ) ) ) ) ) ) )).

tff(conj_thm_2Erelation_2EIN__RDOM__DELETE,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1R: $i] :
         ...
         => ! [V2k: $i] :
              ( mem(V2k,A_27a)
             => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Erelation_2ERDOM(A_27a,A_27a),ap(ap(c_2Erelation_2ERDOM__DELETE(A_27a,A_27a),V1R),V2k))))
