...
thf(conj_thm_2Elim_2ECONT__CONST,lemma,(
...
thf(conj_thm_2Elim_2ECONT__MUL,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
             ...
             => ( p
                @ ( ap
                  @ ( ap @ c_2Elim_2Econtl
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3x: $i] :
                          ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V3x ) ) @ ( ap @ V1g @ V3x ) ) ) )
                  @ ( inj__ty_2Erealax_2Ereal @ V2x ) ) ) ) ) ) )).

thf(conj_thm_2Elim_2ECONT__SUB,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Elim_2EMVT__LEMMA,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( surj__ty_2Erealax_2Ereal
            @ ( ap
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V3x: $i] :
                    ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V3x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) ) @ V3x ) ) )
              @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) )
          = ( surj__ty_2Erealax_2Ereal
            @ ( ap
              @ ( lam @ ty_2Erealax_2Ereal
                @ ^ [V4x: $i] :
                    ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ V4x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) ) ) @ V4x ) ) )
...
thf(conj_thm_2Elim_2EMVT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
