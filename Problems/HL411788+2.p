...
fof(conj_thm_2Ereal__topology_2ECONVERGENT__EQ__CAUCHY,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( ? [V1l] :
...
fof(conj_thm_2Ereal__topology_2ESEQUENCE__CAUCHY__WLOG,lemma,(
    ! [V0e] :
         ...
         => ! [V2s] :
             ...
             => ( ! [V3m] :
                   ...
                   => ! [V4n] :
                       ...
                       => ( ( p(ap(V1P,V3m))
                            & p(ap(V1P,V4n)) )
                         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V2s,V3m)),ap(V2s,V4n)))),V0e)) ) ) )
              <=> ! [V5m] :
                   ...
                   => ! [V6n] :
                       ...
                       => ( ( p(ap(V1P,V5m))
                         ...
                         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V2s,V5m)),ap(V2s,V6n)))),V0e)) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESUM__DIFF__LEMMA,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k] :
         ...
         => ! [V2m] :
             ...
             => ! [V3n] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V2m),V3n))
                   => ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V3n))),V0f)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,c_2Enum_2E0),V2m))),V0f)) = ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,V2m),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V3n))),V0f) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EABS__SUM__TRIVIAL__LEMMA,lemma,(
    ! [V0P] :
      ( mem(V0P,bool)
     => ! [V1s] :
                 ...
                 => ! [V4f] :
                     ...
                     => ! [V5e] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V5e))
                           => ( ( p(V0P)
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n))),V4f))),V5e)) )
                            <=> ( p(V0P)
                               => ( p(ap(ap(c_2Eprim__rec_2E_3C,V3n),V2m))
                                  | p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,V2m),V3n))),V4f))),V5e)) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__CAUCHY,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
         => ( ? [V2l] :
                ...
                & p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V2l),V1s)) )
          <=> ! [V3e] :
               ...
               => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V3e))
                 => ? [V4N] :
                      ...
                      & ! [V5m] :
                         ...
                         => ! [V6n] :
                              ( mem(V6n,ty_2Enum_2Enum)
                             => ( p(ap(ap(c_2Earithmetic_2E_3E_3D,V5m),V4N))
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,V5m),V6n))),V0f))),V3e)) ) ) ) ) ) ) ) ) ) )).
