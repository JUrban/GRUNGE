...
tff(lmtp_f3136,type,(
    f3136: ( del * del * tp__ty_2Ebinary__ieee_2Erounding * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3136,axiom,(
    ! [A_27w: del,A_27t: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V2y: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V5r1: tp__ty_2Erealax_2Ereal] : mem(f3136(A_27w,A_27t,V0mode,V2y,V1x,V5r1),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags))) ) ) )).

tff(lameq_f3136,axiom,(
    ! [A_27w: del,A_27t: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V2y: $i] :
      ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V1x: $i] :
          ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V5r1: tp__ty_2Erealax_2Ereal,V6r2: tp__ty_2Erealax_2Ereal] : ap(f3136(A_27w,A_27t,V0mode,V2y,V1x,V5r1),inj__ty_2Erealax_2Ereal(V6r2)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V6r2)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5r1)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Einvalidop__flags)),ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27t),ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y)))),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Edividezero__flags)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V2y))),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))),ap(ap(ap(c_2Ebinary__ieee_2Efloat__round__with__flags(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V2y)))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V5r1)),inj__ty_2Erealax_2Ereal(V6r2)))) ) ) )).

tff(lmtp_f3135,type,(
    f3135: ( del * del * tp__ty_2Ebinary__ieee_2Efloat__value * $i * tp__ty_2Ebinary__ieee_2Erounding * $i ) > $i )).

tff(lamtp_f3135,axiom,(
...
tff(lameq_f3133,axiom,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
     ...
     => ! [V2y: $i] :
          ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V3v: tp__ty_2Ebinary__ieee_2Efloat__value] : ap(f3133(A_27t,A_27w,V0mode,V1x,V2y),inj__ty_2Ebinary__ieee_2Efloat__value(V3v)) = f3134(A_27w,A_27t,V3v,V0mode,V1x,V2y) ) ) )).
...
tff(ax_thm_2Ebinary__ieee_2Efloat__div__def,axiom,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
     ...
     => ! [V2y: $i] :
          ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y) = ap(ap(c_2Epair_2Epair__CASE(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Efloat__value,ty_2Ebinary__ieee_2Efloat__value),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V1x)),ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V2y))),f3133(A_27t,A_27w,V0mode,V1x,V2y)) ) ) )).

tff(conj_thm_2Ebinary__ieee_2Efloat__div__finite,conjecture,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
      ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V2y: $i] :
          ( mem(V2y,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
         => ! [V3r1: tp__ty_2Erealax_2Ereal,V4r2: tp__ty_2Erealax_2Ereal] :
              ( ( surj__ty_2Ebinary__ieee_2Efloat__value(ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V1x)) = surj__ty_2Ebinary__ieee_2Efloat__value(ap(c_2Ebinary__ieee_2EFloat,inj__ty_2Erealax_2Ereal(V3r1)))
                & surj__ty_2Ebinary__ieee_2Efloat__value(ap(c_2Ebinary__ieee_2Efloat__value(A_27t,A_27t),V2y)) = surj__ty_2Ebinary__ieee_2Efloat__value(ap(c_2Ebinary__ieee_2EFloat,inj__ty_2Erealax_2Ereal(V4r2))) )
             => ap(ap(ap(c_2Ebinary__ieee_2Efloat__div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V4r2)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(ap(c_2Ebool_2ECOND(ty_2Epair_2Eprod(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3r1)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Einvalidop__flags)),ap(c_2Ebinary__ieee_2Efloat__some__qnan(A_27t,A_27t),ap(ap(ap(c_2Ebinary__ieee_2EFP__Div(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),V2y)))),ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Edividezero__flags)),ap(ap(ap(c_2Ebool_2ECOND(ty_2Ebinary__ieee_2Efloat(A_27t,A_27t)),ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V2y))),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))))),ap(ap(ap(c_2Ebinary__ieee_2Efloat__round__with__flags(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27t,A_27t),V2y)))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(V3r1)),inj__ty_2Erealax_2Ereal(V4r2)))) ) ) ) )).
