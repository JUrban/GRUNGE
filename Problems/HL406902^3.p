...
thf(thm_2EDeepSyntax_2Eneginf__ok,axiom,(
    ...
    ! [V2x: tyop_2Einteger_2Eint] :
      ( ( c_2Einteger_2Eint__lt @ V2x @ V1y )
     => ( ( c_2EDeepSyntax_2Eeval__form @ V0f @ V2x )
        = ( c_2EDeepSyntax_2Eeval__form @ ( c_2EDeepSyntax_2Eneginf @ V0f ) @ V2x ) ) ) )).
...
thf(thm_2EDeepSyntax_2Eadd__d__neginf,axiom,(
    ! [V0f: tyop_2EDeepSyntax_2Edeep__form,V1x: tyop_2Einteger_2Eint,V2y: tyop_2Einteger_2Eint,V3d: tyop_2Einteger_2Eint] :
     ...
     => ( ( c_2EDeepSyntax_2Eeval__form @ ( c_2EDeepSyntax_2Eneginf @ V0f ) @ V1x )
        = ( c_2EDeepSyntax_2Eeval__form @ ( c_2EDeepSyntax_2Eneginf @ V0f ) @ ( c_2Einteger_2Eint__add @ V1x @ ( c_2Einteger_2Eint__mul @ V2y @ V3d ) ) ) ) ) )).
