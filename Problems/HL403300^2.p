...
thf(conj_thm_2Ebag_2ESET__OF__EL__BAG,conjecture,(
    ! [A_27a: del,V0e: $i] :
      ( ( mem @ V0e @ A_27a )
     => ( ( ap @ ( c_2Ebag_2ESET__OF__BAG @ A_27a ) @ ( ap @ ( c_2Ebag_2EEL__BAG @ A_27a ) @ V0e ) )
        = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V0e ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) )).
