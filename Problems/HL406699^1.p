...
thf(thm_2Einteger_2EINT__MOD__ID,axiom,(
    ! [V0i: mono_2Etyop_2Einteger_2Eint] :
      ( ( (~)
        @ ( V0i
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ( ( mono_2Ec_2Einteger_2Eint__mod @ V0i @ V0i )
        = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).
...
thf(thm_2Eint__arith_2Eelim__eq__coeffs,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1x: mono_2Etyop_2Einteger_2Eint,V2y: mono_2Etyop_2Einteger_2Eint] :
      ( ( (~) @ ( V0m = mono_2Ec_2Enum_2E0 ) )
     => ( ( ( mono_2Ec_2Einteger_2Eint__mul @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) @ V1x )
          = V2y )
      <=> ( ( mono_2Ec_2Einteger_2Eint__divides @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) @ V2y )
          & ( V1x
            = ( mono_2Ec_2Einteger_2Eint__div @ V2y @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0m ) ) ) ) ) ) )).
