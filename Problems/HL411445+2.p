...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__RANGE,lemma,(
    ! [V0f] :
               ...
               => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2e))
                 => ? [V3d] :
                      ...
                      & ! [V4x_27] :
                         ...
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V4x_27),V1x))),V3d))
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V4x_27)),ap(V0f,V1x)))),V2e)) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__ABS,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),c_2Ereal_2Eabs),ap(c_2Ereal__topology_2Eat,V0x))) ) )).
