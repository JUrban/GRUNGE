...
thf(thm_2Ereal_2EABS__TRIANGLE__SUB,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal,V1y: tyop_2Erealax_2Ereal] :
      ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V0x ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Eabs @ V1y ) @ ( c_2Ereal_2Eabs @ ( c_2Ereal_2Ereal__sub @ V0x @ V1y ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EGREATER__EQ__REFL,axiom,(
    ! [V0m: tyop_2Enum_2Enum] :
      ( c_2Earithmetic_2E_3E_3D @ V0m @ V0m ) )).

thf(thm_2Ereal__topology_2EUPPER__BOUND__FINITE__SET__REAL,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: A_27a > $o] :
     ...
     => ? [V2a: tyop_2Erealax_2Ereal] :
        ! [V3x: A_27a] :
         ...
         => ( c_2Ereal_2Ereal__lte @ ( V0f @ V3x ) @ V2a ) ) ) )).
...
thf(thm_2Ereal__topology_2ECAUCHY__IMP__BOUNDED,conjecture,(
    ! [V0s: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Ecauchy @ V0s )
        ...
        @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
          @ ^ [V1y: tyop_2Erealax_2Ereal] :
              ...
              @ ( c_2Ebool_2E_3F @ tyop_2Enum_2Enum
                @ ^ [V2n: tyop_2Enum_2Enum] :
                    ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V1y @ ( V0s @ V2n ) ) ) ) ) ) ) )).
