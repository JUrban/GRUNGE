...
thf(thm_2Erich__list_2EPREFIX__FOLDR,axiom,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1l: tyop_2Elist_2Elist @ A_27a] :
      ...
      = ( c_2Elist_2EFOLDR @ A_27a @ ( tyop_2Elist_2Elist @ A_27a )
        @ ^ [V2x: A_27a,V3l_27: tyop_2Elist_2Elist @ A_27a] :
            ( c_2Ebool_2ECOND @ ( tyop_2Elist_2Elist @ A_27a ) @ ( V0P @ V2x ) @ ( c_2Elist_2ECONS @ A_27a @ V2x @ V3l_27 ) @ ( c_2Elist_2ENIL @ A_27a ) )
        @ ( c_2Elist_2ENIL @ A_27a )
        @ V1l ) ) )).

thf(thm_2Erich__list_2EPREFIX,conjecture,(
    ! [A_27a: $tType,A_27b: $tType] :
      ( ! [V0P: A_27a > $o] :
