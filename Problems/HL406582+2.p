...
fof(conj_thm_2Esptree_2EfromAList__ind,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool))
         => ( ( p(ap(V0P,c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))))
              & ! [V1x] :
                 ...
                 => ! [V2y] :
                     ...
                     => ! [V3xs] :
                         ...
                         => ( p(ap(V0P,V3xs))
                           => p(ap(V0P,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V1x),V2y)),V3xs))) ) ) ) ) )
           => ! [V4v] :
                ( mem(V4v,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
               => p(ap(V0P,V4v)) ) ) ) ) )).
