...
thf(conj_thm_2Eordinal_2EIMAGE__EQ__SING,lemma,(
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27b @ A_27a ) @ V0f ) @ V1s )
                  = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V2x ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) )
              <=> ( ? [V3y: $i] :
                      ( ( mem @ V3y @ A_27b )
...
thf(conj_thm_2Eordinal_2EordMULT__EQ__0,conjecture,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ! [V1y: $i] :
