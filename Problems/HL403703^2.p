...
thf(conj_thm_2Epred__set_2ECOUNT__11,lemma,(
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__THM,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__CONG,lemma,(
    ! [A_27a: del,V0s1: $i] :
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__ZERO,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Esorting_2ESUM__IMAGE__count__MULT,lemma,(
                    ...
                    = ( surj__ty_2Enum_2Enum
                      @ ( ap
                        @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ ty_2Enum_2Enum )
                          @ ( lam @ ty_2Enum_2Enum
                            @ ^ [V5x: $i] :
                                ( ap @ V2f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V5x ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V3k ) ) @ ( inj__ty_2Enum_2Enum @ V4m ) ) ) ) ) )
...
thf(conj_thm_2Esorting_2Esum__of__sums,conjecture,(
    ! [V0f: $i] :
          ...
          ( ( surj__ty_2Enum_2Enum
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3m: $i] :
                      ( ap @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ ty_2Enum_2Enum ) @ ( ap @ V0f @ V3m ) ) @ ( ap @ c_2Epred__set_2Ecount @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) )
          ...
          = ( surj__ty_2Enum_2Enum
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ ty_2Enum_2Enum )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V4m: $i] :
                      ( ap @ ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2EDIV @ V4m ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ V4m ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) ) ) )
