...
fof(conj_thm_2Epred__set_2EDIFF__INTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EPREIMAGE__UNIV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),c_2Epred__set_2EUNIV(A_27b)) = c_2Epred__set_2EUNIV(A_27a) ) ) ) )).
...
fof(conj_thm_2Epred__set_2EPREIMAGE__COMPL__INTER,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
