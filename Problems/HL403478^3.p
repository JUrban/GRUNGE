...
thf(thm_2Esemi__ring_2Edistr__right,conjecture,(
    ! [A_27a: $tType,V0r: tyop_2Esemi__ring_2Esemi__ring @ A_27a] :
     ...
     => ! [V1m: A_27a,V2n: A_27a,V3p: A_27a] :
          ( ( c_2Esemi__ring_2Esemi__ring__SRM @ A_27a @ V0r @ V1m @ ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a @ V0r @ V2n @ V3p ) )
          = ( c_2Esemi__ring_2Esemi__ring__SRP @ A_27a @ V0r @ ( c_2Esemi__ring_2Esemi__ring__SRM @ A_27a @ V0r @ V1m @ V2n ) @ ( c_2Esemi__ring_2Esemi__ring__SRM @ A_27a @ V0r @ V1m @ V3p ) ) ) ) )).
