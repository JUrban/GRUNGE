...
thf(thm_2ETemporal__Logic_2ENEXT__LINORD,conjecture,(
    ! [V0t0: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( mono_2Ec_2ETemporal__Logic_2ENEXT @ V1a @ V0t0 )
    <=> ? [V2t1: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0t0 @ V2t1 )
          & ! [V3t3: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0t0 @ V3t3 )
             => ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2t1 @ V3t3 ) )
          & ( V1a @ V2t1 ) ) ) )).
