...
thf(f5315_0_2E0,type,(
    f5315_0_2E0: u )).

thf(f5315_0_2E1,type,(
    f5315_0_2E1: du > u )).

thf(f5315_1_2E0,type,(
    f5315_1_2E0: u )).

thf(f5315_1_2E3,type,(
    f5315_1_2E3: du > du > du > u )).

thf(f5315_1_2E4,type,(
    f5315_1_2E4: du > du > du > du > u )).

thf(f5315_2_2E0,type,(
    f5315_2_2E0: u )).

thf(f5315_2_2E2,type,(
    f5315_2_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef5315_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( f5315_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ f5315_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef5315_1_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ ( f5315_1_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ X2_2E0 ) ) )
...
thf(arityeq4_2Emono_2Ef5315_1_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( f5315_1_2E4 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ X2_2E0 ) @ ( s @ A_27a @ X3_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5315_2_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5315_2_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ f5315_2_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efinite__map_2Eis__fmap__rules,axiom,(
    ! [A_27a: d,A_27b: d,V0a_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( f5315_0_2E1 @ ( s @ A_27a @ V0a_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Esum_2EINR_2E1 @ ( s @ tyop_2Eone_2Eone @ ( i_mono_2Etyop_2Eone_2Eone @ mono_2Ec_2Eone_2Eone ) ) ) ) ) )).

thf(def1_2Ethm_2Efinite__map_2Eis__fmap__rules,axiom,(
    ! [A_27a: d,V4x_2E0: u,V2a_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5315_2_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) ) ) )
    <=> ( ( s @ A_27a @ V4x_2E0 )
        = ( s @ A_27a @ V2a_2E0 ) ) ) )).

thf(def2_2Ethm_2Efinite__map_2Eis__fmap__rules,axiom,(
    ! [A_27a: d,A_27b: d,V2a_2E0: u,V3b_2E0: u,V1f_2E0: u,V4x_2E0: u] :
      ( ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( f5315_1_2E4 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27b @ V3b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) )
      = ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5315_2_2E2 @ ( s @ A_27a @ V4x_2E0 ) @ ( s @ A_27a @ V2a_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( c_2Esum_2EINL_2E1 @ ( s @ A_27b @ V3b_2E0 ) ) ) @ ( s @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V4x_2E0 ) ) ) ) ) ) )).

thf(thm_2Efinite__map_2Eis__fmap__rules,conjecture,(
    ! [A_27a: d,A_27b: d] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efinite__map_2Eis__fmap_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ f5315_0_2E0 ) ) ) )
      & ! [V1f_2E0: u,V2a_2E0: u,V3b_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efinite__map_2Eis__fmap_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V1f_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Efinite__map_2Eis__fmap_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ ( f5315_1_2E3 @ ( s @ A_27a @ V2a_2E0 ) @ ( s @ A_27b @ V3b_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Esum_2Esum @ A_27b @ tyop_2Eone_2Eone ) ) @ V1f_2E0 ) ) ) ) ) ) ) ) )).
