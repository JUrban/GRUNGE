...
thf(conj_thm_2EDecode_2Eenc2dec__some__alt,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
...
thf(conj_thm_2EEncode_2Ebiprefix__refl,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Elist_2Elist @ A_27a ) )
     => ( p @ ( ap @ ( ap @ ( c_2EEncode_2Ebiprefix @ A_27a ) @ V0x ) @ V0x ) ) ) )).

thf(conj_thm_2EEncode_2Ebiprefix__append,lemma,(
    ! [A_27a: del,V0a: $i] :
...
thf(conj_thm_2EEncode_2Ewf__encoder__alt,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
...
thf(conj_thm_2EEncode_2Ewf__encoder__eq,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
         => ! [V2f: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ ( c_2EEncode_2Ewf__encoder @ A_27a ) @ V0p ) @ V1e ) )
                  & ! [V3x: $i] :
                      ( ( mem @ V3x @ A_27a )
                     => ( ( p @ ( ap @ V0p @ V3x ) )
                       => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V1e @ V3x ) )
                          = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V2f @ V3x ) ) ) ) ) )
...
thf(conj_thm_2ECoder_2Ewf__coder__op,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ! [V1e: $i] :
          ( ( mem @ V1e @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) )
         => ! [V2f: $i] :
             ...
             => ( ( ? [V3x: $i] :
                  ...
                  & ! [V4x: $i] :
                      ( ( mem @ V4x @ A_27a )
                     => ( ( p @ ( ap @ V0p @ V4x ) )
                       => ( ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V1e @ V4x ) )
                          = ( surj__c_ty_2Elist_2Elist_o @ ( ap @ V2f @ V4x ) ) ) ) ) )
               => ( p @ ( ap @ ( c_2ECoder_2Ewf__coder @ A_27a ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) ) ) @ V0p ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Elist_2Elist @ bool ) ) ) ) ) @ V1e ) @ ( ap @ ( ap @ ( c_2EDecode_2Eenc2dec @ A_27a ) @ V0p ) @ V2f ) ) ) ) ) ) ) ) ) )).
