...
thf(conj_thm_2Egcd_2Egcd__ind,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) )
     => ( ( ! [V1y: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) )
          & ! [V2x: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ ( ap @ V0P @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2x ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
       ...
       => ! [V5v: tp__ty_2Enum_2Enum,V6v1: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V5v ) ) @ ( inj__ty_2Enum_2Enum @ V6v1 ) ) ) ) ) )).
