...
fof(thm_2Eordinal_2Eubsup__thm,axiom,(
    ! [A_27a,V0s_2E0,V1b_2E0] :
      ( ! [V2a_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V2a_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0))))
     ...
     => ! [V3c_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V3c_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Esup_2E1(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0))))))
        <=> ? [V4d_2E0] :
              ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V4d_2E0),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0))))
              & p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V3c_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V4d_2E0)))) ) ) ) )).
...
fof(thm_2Eordinal_2Eomax__preds__omega,axiom,(
...
fof(thm_2Eordinal_2EordADD__fromNat__omega,conjecture,(
    ! [A_27a,V0n_2E0] : s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordADD_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,V0n_2E0))),s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Eomega_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Eomega_2E0) )).
