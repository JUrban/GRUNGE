...
fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSED,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,A_27a))
...
fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSE__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,A_27a))
...
fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSE__SET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,A_27a))
...
fof(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN__AUTO,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
