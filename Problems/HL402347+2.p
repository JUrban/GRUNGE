...
fof(lamtp_f485,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f485(A_27a,A_27a,V0P),arr(arr(A_27a,bool),bool)) ) )).
...
fof(lameq_f485,axiom,(
    ! [A_27a,A_27a,V0P] :
     ...
     => ! [V3s] :
         ...
         => ap(f485(A_27a,A_27a,V0P),V3s) = ap(ap(c_2Ebool_2ERES__FORALL(A_27a),V3s),f482(A_27a,V0P)) ) ) )).

fof(conj_thm_2Eres__quan_2ERES__FORALL__BIGUNION,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1sos] :
             ...
             => ( p(ap(ap(c_2Ebool_2ERES__FORALL(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V1sos)),f108(A_27a,V0P)))
              <=> p(ap(ap(c_2Ebool_2ERES__FORALL(arr(A_27a,bool)),V1sos),f485(A_27a,A_27a,V0P))) ) ) ) ) )).
