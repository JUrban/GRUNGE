...
thf(thm_2Ebag_2EBAG__INN__BAG__FILTER,axiom,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1e: A_27a,V2b: A_27a > tyop_2Enum_2Enum,V3P: A_27a > $o] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ ( c_2Ebag_2EBAG__FILTER @ A_27a @ V3P @ V2b ) )
    <=> ( ( V0n = c_2Enum_2E0 )
        | ( ( V3P @ V1e )
          & ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ V0n @ V2b ) ) ) ) )).
