...
thf(thm_2Ereal__topology_2EFORALL__IN__CLOSURE__EQ,axiom,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1s: tyop_2Erealax_2Ereal > $o,V2t: tyop_2Erealax_2Ereal > $o] :
     ...
     => ( ! [V3x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ ( c_2Ereal__topology_2Eclosure @ V1s ) )
           => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V3x ) @ V2t ) )
      <=> ! [V4x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V1s )
           => ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V0f @ V4x ) @ V2t ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EHAUSDIST__EQ__0,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
        & ( c_2Ereal__topology_2Ebounded__def @ V1t ) )
     => ( ( ( c_2Ereal__topology_2Ehausdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) )
      ...
      <=> ( ( V0s
          ...
          | ( ( c_2Ereal__topology_2Eclosure @ V0s )
            = ( c_2Ereal__topology_2Eclosure @ V1t ) ) ) ) ) )).
