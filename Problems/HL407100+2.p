...
fof(conj_thm_2Erealax_2ETREAL__LT__WELLDEFR,lemma,(
    ! [V0x1] :
...
fof(conj_thm_2Erealax_2ETREAL__LT__WELLDEFL,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Erealax_2ETREAL__LT__WELLDEF,conjecture,(
    ! [V0x1] :
      ( mem(V0x1,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
     => ! [V1x2] :
          ( mem(V1x2,ty_2Epair_2Eprod(ty_2Ehreal_2Ehreal,ty_2Ehreal_2Ehreal))
