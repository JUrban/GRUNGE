...
fof(mem_c_2EindexedLists_2EMAPi,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EindexedLists_2EMAPi(A_27a,A_27a),arr(arr(ty_2Enum_2Enum,arr(A_27b,A_27a)),arr(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27a)))) ) ) )).

fof(ax_thm_2EindexedLists_2EMAPi__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
            ...
            & ! [V1f] :
               ...
               => ! [V2h] :
                   ...
                   => ! [V3t] :
                       ...
                       => ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),V1f),ap(ap(c_2Elist_2ECONS(A_27b),V2h),V3t)) = ap(ap(c_2Elist_2ECONS(A_27a),ap(ap(V1f,c_2Enum_2E0),V2h)),ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),c_2Enum_2ESUC)),V3t)) ) ) ) ) ) ) )).
...
fof(conj_thm_2EindexedLists_2EMEM__MAPi,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ! [V1f] :
                 ...
                 => ! [V2l] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),V1f),V2l))))
                      <=> ? [V3n] :
                            ( mem(V3n,ty_2Enum_2Enum)
                            & p(ap(ap(c_2Eprim__rec_2E_3C,V3n),ap(c_2Elist_2ELENGTH(A_27b),V2l)))
                            & V0x = ap(ap(V1f,V3n),ap(ap(c_2Elist_2EEL(A_27b),V3n),V2l)) ) ) ) ) ) ) ) )).
