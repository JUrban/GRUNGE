...
thf(thm_2Emergesort_2EmergesortN__perm,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1n: mono_2Etyop_2Enum_2Enum,V2l_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esorting_2EPERM_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETAKE_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Emergesort_2EmergesortN_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) ) @ V0R_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) ) )).
