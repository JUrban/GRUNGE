...
fof(conj_thm_2Erich__list_2ETAKE__SEG__DROP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1i] :
             ...
             => ! [V2l] :
                 ...
                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(ap(c_2Earithmetic_2E_2B,V1i),V0n)),ap(c_2Elist_2ELENGTH(A_27a),V2l)))
                   => ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2ETAKE(A_27a),V1i),V2l)),ap(ap(ap(c_2Erich__list_2ESEG(A_27a),V0n),V1i),V2l))),ap(ap(c_2Elist_2EDROP(A_27a),ap(ap(c_2Earithmetic_2E_2B,V1i),V0n)),V2l)) = V2l ) ) ) ) ) )).
