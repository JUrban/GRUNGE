...
thf(conj_thm_2Eextreal_2Eabs__pos,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
      ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Eextreal_2Eextreal__abs @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) ) ) )).

thf(conj_thm_2Eextreal_2Eabs__bounds__lt,lemma,(
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__ABS,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
     => ! [V1f: $i] :
                  ...
                  & ! [V3x: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ ( ap @ ( c_2Emeasure_2Espace @ A_27a ) @ V0a ) ) )
                       => ( ( surj__ty_2Eextreal_2Eextreal @ ( ap @ V2g @ V3x ) )
                          = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ c_2Eextreal_2Eextreal__abs @ ( ap @ V1f @ V3x ) ) ) ) ) ) )
