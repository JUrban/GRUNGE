...
thf(tp_c_2Ereal_2ENUM__CEILING,type,(
    c_2Ereal_2ENUM__CEILING: $i )).

thf(mem_c_2Ereal_2ENUM__CEILING,axiom,(
    mem @ c_2Ereal_2ENUM__CEILING @ ( arr @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2Ereal_2ENUM__CEILING,type,(
    fo__c_2Ereal_2ENUM__CEILING: tp__ty_2Erealax_2Ereal > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Ereal_2ENUM__CEILING,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Ereal_2ENUM__CEILING @ X0 ) )
      = ( ap @ c_2Ereal_2ENUM__CEILING @ ( inj__ty_2Erealax_2Ereal @ X0 ) ) ) )).
...
thf(tp_c_2Ereal_2ENUM__FLOOR,type,(
    c_2Ereal_2ENUM__FLOOR: $i )).

thf(mem_c_2Ereal_2ENUM__FLOOR,axiom,(
    mem @ c_2Ereal_2ENUM__FLOOR @ ( arr @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2Ereal_2ENUM__FLOOR,type,(
    fo__c_2Ereal_2ENUM__FLOOR: tp__ty_2Erealax_2Ereal > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Ereal_2ENUM__FLOOR,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Ereal_2ENUM__FLOOR @ X0 ) )
      = ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ X0 ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__LET__ANTISYM,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ~ ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
        & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).

thf(conj_thm_2Ereal_2EREAL__LTE__ANTSYM,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ~ ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
        & ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).
...
thf(conj_thm_2Ereal_2EREAL__LT__ADD1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
     => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).
...
thf(ax_thm_2Ereal_2ENUM__FLOOR__def,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
      = ( surj__ty_2Enum_2Enum
        @ ( ap @ c_2Ewhile_2ELEAST
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1n: $i] :
                ( ap @ ( ap @ c_2Ereal_2Ereal__gt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V1n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) ) )).

thf(ax_thm_2Ereal_2ENUM__CEILING__def,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal_2ENUM__CEILING @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
      = ( surj__ty_2Enum_2Enum
        @ ( ap @ c_2Ewhile_2ELEAST
          @ ( lam @ ty_2Enum_2Enum
            @ ^ [V1n: $i] :
                ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ V1n ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2ENUM__FLOOR__LET,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) @ ( inj__ty_2Enum_2Enum @ V1y ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ V1y ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal_2ENUM__FLOOR__DIV__LOWERBOUND,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
     ...
     => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) ) )).

thf(conj_thm_2Ereal_2ENUM__FLOOR__BASE,lemma,(
    ! [V0r: tp__ty_2Erealax_2Ereal] :
      ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) )
        = fo__c_2Enum_2E0 ) ) )).
...
thf(conj_thm_2Ewhile_2ELEAST__ELIM,lemma,(
    ! [V0Q: $i] :
...
thf(conj_thm_2Ereal_2ENUM__CEILING__NUM__FLOOR,conjecture,(
    ! [V0r: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ereal_2ENUM__CEILING @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) )
      = ( surj__ty_2Enum_2Enum
        @ ( ap
          @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V1n: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Ebool_2E_5C_2F @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ V1n ) ) ) ) @ V1n ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V1n ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )
          @ ( ap @ c_2Ereal_2ENUM__FLOOR @ ( inj__ty_2Erealax_2Ereal @ V0r ) ) ) ) ) )).
