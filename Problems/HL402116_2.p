...
tff(lamtp_f394,axiom,(
    ! [A_27a: del,A_27a: del,V4l: $i] :
      ( mem(V4l,ty_2Elist_2Elist(A_27a))
     => ! [V0P: $i] :
          ( mem(V0P,arr(ty_2Elist_2Elist(A_27a),bool))
         => mem(f394(A_27a,A_27a,V4l,V0P),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f394,axiom,(
    ! [A_27a: del,A_27a: del,V4l: $i] :
     ...
     => ! [V0P: $i] :
         ...
         => ! [V5x: $i] :
              ( mem(V5x,A_27a)
             => ap(f394(A_27a,A_27a,V4l,V0P),V5x) = ap(V0P,ap(ap(c_2Elist_2ECONS(A_27a),V5x),V4l)) ) ) ) )).

tff(lmtp_f393,type,(
    f393: ( del * del * $i ) > $i )).

tff(lamtp_f393,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Elist_2Elist(A_27a),bool))
     => mem(f393(A_27a,A_27a,V0P),arr(ty_2Elist_2Elist(A_27a),bool)) ) )).
...
tff(lameq_f393,axiom,(
    ! [A_27a: del,A_27a: del,V0P: $i] :
     ...
     => ! [V4l: $i] :
          ( mem(V4l,ty_2Elist_2Elist(A_27a))
         => ap(f393(A_27a,A_27a,V0P),V4l) = ap(c_2Ebool_2E_21(A_27a),f394(A_27a,A_27a,V4l,V0P)) ) ) )).

tff(conj_thm_2Elist_2ELENGTH__EQ__CONS,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(ty_2Elist_2Elist(A_27a),bool))
