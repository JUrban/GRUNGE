...
thf(ax_thm_2Ebitstring_2Ev2w__def,axiom,(
    ! [A_27a: del,V0v: tp__c_ty_2Elist_2Elist_o] :
      ...
      = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
        @ ( lam @ ty_2Enum_2Enum
          @ ^ [V1i: $i] :
              ( ap @ ( ap @ c_2Ebitstring_2Etestbit @ V1i ) @ ( inj__c_ty_2Elist_2Elist_o @ V0v ) ) ) ) ) )).
          ...
          = ( surj__c_ty_2Elist_2Elist_o
            @ ( ap
              @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ( ty_2Elist_2Elist @ bool ) )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3m: $i] :
                      ( ap @ ( ap @ ( c_2Elist_2EMAP @ ( ty_2Epair_2Eprod @ bool @ bool ) @ bool ) @ ( ap @ ( c_2Epair_2EUNCURRY @ bool @ bool @ bool ) @ V0f ) ) @ ( ap @ ( c_2Elist_2EZIP @ bool @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ bool ) @ ( ty_2Elist_2Elist @ bool ) ) @ ( ap @ ( ap @ c_2Ebitstring_2Efixwidth @ V3m ) @ ( inj__c_ty_2Elist_2Elist_o @ V1v1 ) ) ) @ ( ap @ ( ap @ c_2Ebitstring_2Efixwidth @ V3m ) @ ( inj__c_ty_2Elist_2Elist_o @ V2v2 ) ) ) ) ) ) )
    ...
    = ( ap @ c_2Ebitstring_2Ebitwise
      @ ( lam @ bool
        @ ^ [V0x: $i] :
            ( lam @ bool
            @ ^ [V1y: $i] :
                ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ V0x ) @ V1y ) ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Efixwidth__fixwidth,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] :
     ...
     => ! [V1w: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__nand @ A_27a ) @ V0v ) @ V1w )
            = ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V2i: $i] :
                    ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V0v ) @ V2i ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V1w ) @ V2i ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Eword__nand__v2w,conjecture,(
