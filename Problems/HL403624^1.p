...
thf(arityeq1_2Emono_2Ec_2Efcp_2EFCP__TL_2E1_2Emono_2EA_27a_20mono_2EA_27c_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( c_2Efcp_2EFCP__TL_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) ) @ c_2Efcp_2EFCP__TL_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Efcp_2EL2V_2E1_2Emono_2EA_27a_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( c_2Efcp_2EL2V_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) ) @ c_2Efcp_2EL2V_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Efcp_2EFCP__TL,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0v_2E0: u] :
      ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27b ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
        & ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27c ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) )
          = ( mono_2Ec_2Earithmetic_2E_2D @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27b ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
     => ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( c_2Efcp_2EFCP__TL_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) ) )
        = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27c ) @ ( c_2Efcp_2EL2V_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ETL_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Efcp_2EV2L_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ V0v_2E0 ) ) ) ) ) ) ) ) ) )).
