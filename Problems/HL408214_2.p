...
tff(lmtp_f2931,type,(
    f2931: ( tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2931,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] : mem(f2931(V2y,V0n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2931,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal,V3p: tp__ty_2Enum_2Enum] : ap(f2931(V2y,V0n,V1x),inj__ty_2Enum_2Enum(V3p)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Enum_2Enum(V3p))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2y)),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n))),inj__ty_2Enum_2Enum(V3p)))) )).

tff(lmtp_f2932,type,(
    f2932: ( tp__ty_2Erealax_2Ereal * tp__ty_2Enum_2Enum * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f2932,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] : mem(f2932(V2y,V0n,V1x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) )).

tff(lameq_f2932,axiom,(
    ! [V2y: tp__ty_2Erealax_2Ereal,V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal,V4p: tp__ty_2Enum_2Enum] : ap(f2932(V2y,V0n,V1x),inj__ty_2Enum_2Enum(V4p)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Enum_2Enum(V4p))),ap(ap(c_2Ereal_2Epow,inj__ty_2Erealax_2Ereal(V2y)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V4p)))) )).

tff(conj_thm_2Epowser_2EPOWDIFF__LEMMA,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal,V2y: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n)))),f2931(V2y,V0n,V1x))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2y)),ap(ap(c_2Ereal_2Esum,ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V0n)))),f2932(V2y,V0n,V1x)))) )).
...
tff(conj_thm_2Epowser_2EPOWDIFF,conjecture,(
