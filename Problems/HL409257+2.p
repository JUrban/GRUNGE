...
fof(conj_thm_2Ereal_2EREAL__DIV__INNER__CANCEL2,lemma,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => ! [V1z] :
...
fof(conj_thm_2Eintegral_2EGAUGE__MIN__FINITE,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,conjecture,(
    ! [V0f] :
