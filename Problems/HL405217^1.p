...
thf(f5968_0_2E0,type,(
    f5968_0_2E0: u )).

thf(f5968_0_2E1,type,(
    f5968_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef5968_0_2E1_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5968_0_2E1 @ ( s @ A_27b @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ f5968_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Elist_2ELIST__TO__SET_2E1_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2CA_27b_29,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
...
thf(arityeq3_2Emono_2Ec_2Eoption_2Eoption__CASE_2E3_2Emono_2EA_27b_20mono_2Etyop_2Eoption_2Eoption_28A_27b_29,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ X2_2E0 ) ) )
...
thf(thm_2Ealist_2EALOOKUP__MEM,axiom,(
    ! [A_27a: d,A_27b: d,V0al_2E0: u,V1k_2E0: u,V2v_2E0: u] :
     ...
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1k_2E0 ) @ ( s @ A_27b @ V2v_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0al_2E0 ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2Ealist_2EALOOKUP__APPEND,axiom,(
    ! [A_27b: d,V3v_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( f5968_0_2E1 @ ( s @ A_27b @ V3v_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27b @ V3v_2E0 ) ) ) ) )).

thf(thm_2Ealist_2EALOOKUP__APPEND,axiom,(
    ! [A_27a: d,A_27b: d,V0l1_2E0: u,V1l2_2E0: u,V2k_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1l2_2E0 ) ) ) @ ( s @ A_27a @ V2k_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Eoption_2Eoption__CASE_2E3 @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l1_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1l2_2E0 ) @ ( s @ A_27a @ V2k_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Eoption_2Eoption @ A_27b ) ) @ f5968_0_2E0 ) ) ) ) )).
...
thf(thm_2Ealist_2Ealookup__distinct__reverse,conjecture,(
    ! [A_27a: d,A_27b: d,V0l_2E0: u,V1k_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EALL__DISTINCT_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27a ) @ c_2Epair_2EFST_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l_2E0 ) ) ) ) ) )
     => ( ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l_2E0 ) ) ) @ ( s @ A_27a @ V1k_2E0 ) ) )
        = ( s @ ( tyop_2Eoption_2Eoption @ A_27b ) @ ( c_2Ealist_2EALOOKUP_2E2 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0l_2E0 ) @ ( s @ A_27a @ V1k_2E0 ) ) ) ) ) )).
