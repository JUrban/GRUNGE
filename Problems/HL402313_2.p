...
tff(conj_thm_2Elist_2EdropWhile__APPEND__EVERY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EdropWhile__APPEND__EXISTS,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l1: $i] :
          ( mem(V1l1,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EEL__LENGTH__dropWhile__REVERSE,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
