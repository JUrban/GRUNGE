...
tff(lamtp_f1953,axiom,(
    ! [A_27a: del,V3v2: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V1v0: $i] :
              ( mem(V1v0,A_27a)
             => mem(f1953(A_27a,V3v2,V2v1,V1v0),arr(ty_2Enum_2Enum,A_27a)) ) ) ) )).
...
tff(lameq_f1953,axiom,(
    ! [A_27a: del,V3v2: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V1v0: $i] :
              ( mem(V1v0,A_27a)
             => ! [V4m: tp__ty_2Enum_2Enum] : ap(f1953(A_27a,V3v2,V2v1,V1v0),inj__ty_2Enum_2Enum(V4m)) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V4m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V1v0),ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),V2v1),V3v2)) ) ) ) )).

tff(ax_thm_2EternaryComparisons_2Eordering__CASE,axiom,(
    ! [A_27a: del,V0x: tp__ty_2EternaryComparisons_2Eordering,V1v0: $i] :
     ...
     => ! [V2v1: $i] :
         ...
         => ! [V3v2: $i] :
              ( mem(V3v2,A_27a)
             => ap(ap(ap(ap(c_2EternaryComparisons_2Eordering__CASE(A_27a),inj__ty_2EternaryComparisons_2Eordering(V0x)),V1v0),V2v1),V3v2) = ap(f1953(A_27a,V3v2,V2v1,V1v0),ap(c_2EternaryComparisons_2Eordering2num,inj__ty_2EternaryComparisons_2Eordering(V0x))) ) ) ) )).

tff(conj_thm_2EternaryComparisons_2Eordering__case__def,conjecture,(
    ! [A_27a: del] :
      ( ! [V0v0: $i] :
          ( mem(V0v0,A_27a)
         => ! [V1v1: $i] :
