...
thf(f9400_0_2E0,type,(
    f9400_0_2E0: u )).

thf(f9400_0_2E2,type,(
    f9400_0_2E2: du > du > u )).

thf(f9400_0_2E3,type,(
    f9400_0_2E3: du > du > du > u )).

thf(f9401_0_2E0,type,(
    f9401_0_2E0: u )).

thf(f9401_0_2E1,type,(
    f9401_0_2E1: du > u )).

thf(f9401_0_2E2,type,(
    f9401_0_2E2: du > du > u )).

thf(f9430_0_2E0,type,(
    f9430_0_2E0: u )).

thf(f9430_0_2E1,type,(
    f9430_0_2E1: du > u )).

thf(f9430_0_2E2,type,(
    f9430_0_2E2: du > du > u )).

thf(f9433_0_2E0,type,(
    f9433_0_2E0: u )).

thf(f9433_0_2E1,type,(
    f9433_0_2E1: du > u )).

thf(f9433_0_2E2,type,(
    f9433_0_2E2: du > du > u )).

thf(f9436_0_2E0,type,(
    f9436_0_2E0: u )).

thf(f9436_0_2E2,type,(
    f9436_0_2E2: du > du > u )).

thf(f9436_0_2E3,type,(
    f9436_0_2E3: du > du > du > u )).
...
thf(mono_2Ef9400_0,type,(
    mono_2Ef9400_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9401_0,type,(
    mono_2Ef9401_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9430_0,type,(
    mono_2Ef9430_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9433_0,type,(
    mono_2Ef9433_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9436_0,type,(
    mono_2Ef9436_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eseq_2ESEQ__MUL,axiom,(
...
thf(thm_2Eseq_2ESEQ__MUL,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal,V2y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3y0: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9400_0 @ V0x @ V2y ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V1x0 @ V3y0 ) ) ) )).

thf(def0_2Ethm_2Eseq_2ESEQ__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9401_0 @ V0x @ V2n )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( V0x @ V2n ) ) ) )).

thf(thm_2Eseq_2ESEQ__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0x @ V1x0 )
      = ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9401_0 @ V0x ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ V1x0 ) ) ) )).

thf(def0_2Ethm_2Eseq_2ESEQ__ABS,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9430_0 @ V0f @ V1n )
      = ( mono_2Ec_2Ereal_2Eabs @ ( V0f @ V1n ) ) ) )).

thf(thm_2Eseq_2ESEQ__ABS,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9430_0 @ V0f ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
      = ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(def0_2Ethm_2Eseq_2ESEQ__POWER__ABS,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9433_0 @ V0c @ V1n )
      = ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Ereal_2Eabs @ V0c ) @ V1n ) ) )).
...
thf(thm_2Eseq_2ESEQ__POWER__ABS,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9433_0 @ V0c ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(def0_2Ethm_2Eseq_2ENEST__LEMMA__UNIQ,axiom,(
...
thf(thm_2Eseq_2ENEST__LEMMA__UNIQ,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__ge @ ( V0f @ ( mono_2Ec_2Enum_2ESUC @ V2n ) ) @ ( V0f @ V2n ) )
        & ! [V3n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( V1g @ ( mono_2Ec_2Enum_2ESUC @ V3n ) ) @ ( V1g @ V3n ) )
        & ! [V4n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V4n ) @ ( V1g @ V4n ) )
        & ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9436_0 @ V0f @ V1g ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
     => ? [V6l: mono_2Etyop_2Erealax_2Ereal] :
          ( ! [V7n: mono_2Etyop_2Enum_2Enum] :
              ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V7n ) @ V6l )
          & ( mono_2Ec_2Eseq_2E_2D_2D_3E @ V0f @ V6l )
          & ! [V8n: mono_2Etyop_2Enum_2Enum] :
              ( mono_2Ec_2Ereal_2Ereal__lte @ V6l @ ( V1g @ V8n ) )
