...
thf(conj_thm_2Epred__set_2ECHOICE__NOT__IN__REST,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EFINITE__REST__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ ( ap @ ( c_2Epred__set_2EREST @ A_27a ) @ V0s ) ) )
      <=> ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) ) ) ) )).

thf(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__MONO,lemma,(
...
thf(conj_thm_2Epred__set_2EEXPLICIT__ENUMERATE__NOT__EMPTY,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1s: $i] :
      ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2EINFINITE__EXPLICIT__ENUMERATE,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
       => ( p
          @ ( ap
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EINJ @ ty_2Enum_2Enum @ A_27a )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V1n: $i] :
                      ( ap @ ( c_2Epred__set_2ECHOICE @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Earithmetic_2EFUNPOW @ ( arr @ A_27a @ bool ) ) @ ( c_2Epred__set_2EREST @ A_27a ) ) @ V1n ) @ V0s ) ) ) )
