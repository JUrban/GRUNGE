...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__CLOSED__PREIMAGE__CONSTANT,conjecture,(
           ...
           => ( p
              @ ( ap @ c_2Ereal__topology_2EClosed
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                  @ ( lam @ ty_2Erealax_2Ereal
                    @ ^ [V3x: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V3x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V3x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) ) ) ) ) ) ) ) ) )).
