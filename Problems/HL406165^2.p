...
thf(conj_thm_2Ewords_2EWORD__DIVISION,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( V0w
       ...
       => ! [V1v: $i] :
           ...
           => ( ( V1v
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__mul @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__div @ A_27a ) @ V1v ) @ V0w ) ) @ V0w ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__mod @ A_27a ) @ V1v ) @ V0w ) ) )
