...
fof(lamtp_f1260,axiom,(
    ! [A_27b,A_27c,A_27d,A_27a,V6f] :
      ( mem(V6f,arr(A_27c,A_27d))
     => ! [V1abs1] :
          ( mem(V1abs1,arr(A_27a,A_27c))
         => ! [V5rep2] :
              ( mem(V5rep2,arr(A_27d,A_27b))
             => mem(f1260(A_27b,A_27c,A_27d,A_27a,V6f,V1abs1,V5rep2),arr(A_27a,A_27b)) ) ) ) )).

fof(lameq_f1260,axiom,(
    ! [A_27b,A_27c,A_27d,A_27a,V6f] :
      ( mem(V6f,arr(A_27c,A_27d))
     => ! [V1abs1] :
          ( mem(V1abs1,arr(A_27a,A_27c))
         => ! [V5rep2] :
             ...
             => ! [V8x] :
                  ( mem(V8x,A_27a)
                 => ap(f1260(A_27b,A_27c,A_27d,A_27a,V6f,V1abs1,V5rep2),V8x) = ap(ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs1),V5rep2),V6f),V8x) ) ) ) ) )).

fof(conj_thm_2Equotient_2ELAMBDA__PRS1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                                   ...
                                   => ! [V4abs2] :
                                       ...
                                       => ! [V5rep2] :
                                           ...
                                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                                             => ! [V6f] :
                                                  ( mem(V6f,arr(A_27c,A_27d))
                                                 => f1258(A_27d,A_27c,V6f) = ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27c,A_27c,A_27c,A_27c),V2rep1),V4abs2),f1260(A_27b,A_27c,A_27d,A_27a,V6f,V1abs1,V5rep2)) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
