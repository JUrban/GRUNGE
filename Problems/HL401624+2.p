...
fof(conj_thm_2Earithmetic_2EADD__EQ__SUB,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
...
fof(conj_thm_2Epred__set_2ECARD__UNION__EQN,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
         => ! [V1t] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
                  & p(ap(c_2Epred__set_2EFINITE(A_27a),V1t)) )
               => ap(c_2Epred__set_2ECARD(A_27a),ap(ap(c_2Epred__set_2EUNION(A_27a),V0s),V1t)) = ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Epred__set_2ECARD(A_27a),V0s)),ap(c_2Epred__set_2ECARD(A_27a),V1t))),ap(c_2Epred__set_2ECARD(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),V0s),V1t))) ) ) ) ) )).
