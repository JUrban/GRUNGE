...
tff(lamtp_f846,axiom,(
    ! [V2i1: tp__o] : mem(f846(V2i1),arr(bool,bool)) )).

tff(lameq_f846,axiom,(
    ! [V2i1: tp__o,V3i2: tp__o] : ap(f846(V2i1),inj__o(V3i2)) = ap(ap(c_2Ebool_2E_5C_2F,inj__o(V2i1)),inj__o(V3i2)) )).

tff(lmtp_f845,type,(
    f845: $i )).

tff(lamtp_f845,axiom,(
    mem(f845,arr(bool,arr(bool,bool))) )).

tff(lameq_f845,axiom,(
    ! [V2i1: tp__o] : ap(f845,inj__o(V2i1)) = f846(V2i1) )).

tff(ax_thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__def,axiom,(
    ! [V0ip1: tp__c_ty_2Elist_2Elist_o,V1ip2: tp__c_ty_2Elist_2Elist_o] : surj__c_ty_2Elist_2Elist_o(ap(ap(c_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ,inj__c_ty_2Elist_2Elist_o(V0ip1)),inj__c_ty_2Elist_2Elist_o(V1ip2))) = surj__c_ty_2Elist_2Elist_o(ap(ap(ap(c_2Elist_2EMAP2(bool,bool,bool),f845),inj__c_ty_2Elist_2Elist_o(V0ip1)),inj__c_ty_2Elist_2Elist_o(V1ip2))) )).

tff(conj_thm_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
      ( mem(V0v,A_27a)
     => ! [V1rows: $i] :
          ( mem(V1rows,ty_2Elist_2Elist(arr(A_27a,ty_2Eoption_2Eoption(A_27b))))
         => ! [V2c: tp__o,V3infos: tp__c_ty_2Elist_2Elist_o,V4c_27: tp__o,V5infos_27: tp__c_ty_2Elist_2Elist_o] :
              ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),inj__o(V2c)),inj__c_ty_2Elist_2Elist_o(V3infos)))
             => ( p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),inj__o(V4c_27)),inj__c_ty_2Elist_2Elist_o(V5infos_27)))
               => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),V1rows),ap(ap(c_2Ebool_2E_2F_5C,inj__o(V2c)),inj__o(V4c_27))),ap(ap(c_2EpatternMatches_2EREDUNDANT__ROWS__INFOS__DISJ,inj__c_ty_2Elist_2Elist_o(V3infos)),inj__c_ty_2Elist_2Elist_o(V5infos_27)))) ) ) ) ) )).
