...
thf(conj_thm_2Eextreal_2Eext__mono__decreasing__suc,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal ) )
     => ( ( p @ ( ap @ c_2Eextreal_2Eext__mono__decreasing @ V0f ) )
      <=> ! [V1n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( ap @ V0f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) ) )).
