    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2v] :
             ...
             => mem(f3976(V0a,V1b,V2v),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f3976,axiom,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2v] :
             ...
             => ! [V3x] :
                 ...
                 => ap(f3976(V0a,V1b,V2v),V3x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V3x),V2v)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,V0a),V3x)),ap(ap(c_2Ereal_2Ereal__lte,V3x),V1b))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ereal_2Ereal__lte,V1b),V3x)),ap(ap(c_2Ereal_2Ereal__lte,V3x),V0a)))) ) ) ) ) )).

fof(lamtp_f3977,axiom,(
    ! [V4a] :
      ( mem(V4a,ty_2Erealax_2Ereal)
     => ! [V5b] :
          ( mem(V5b,ty_2Erealax_2Ereal)
         => ! [V6v] :
              ( mem(V6v,ty_2Erealax_2Ereal)
             => mem(f3977(V4a,V5b,V6v),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

fof(lameq_f3977,axiom,(
    ! [V4a] :
      ( mem(V4a,ty_2Erealax_2Ereal)
     => ! [V5b] :
          ( mem(V5b,ty_2Erealax_2Ereal)
         => ! [V6v] :
             ...
             => ! [V7x] :
                 ...
                 => ap(f3977(V4a,V5b,V6v),V7x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V7x),V6v)),ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Erealax_2Ereal__lt,V4a),V7x)),ap(ap(c_2Erealax_2Ereal__lt,V7x),V5b))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Erealax_2Ereal__lt,V5b),V7x)),ap(ap(c_2Erealax_2Ereal__lt,V7x),V4a)))) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,conjecture,
    ( ! [V0a] :
        ( mem(V0a,ty_2Erealax_2Ereal)
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
           => ! [V2v] :
                ( mem(V2v,ty_2Erealax_2Ereal)
               => ap(c_2Ereal__topology_2Eclosed__segment,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V0a),V2v)),ap(ap(c_2Erealax_2Ereal__mul,V1b),V2v))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3976(V0a,V1b,V2v)) ) ) )
    & ! [V4a] :
        ( mem(V4a,ty_2Erealax_2Ereal)
       => ! [V5b] :
            ( mem(V5b,ty_2Erealax_2Ereal)
           => ! [V6v] :
                ( mem(V6v,ty_2Erealax_2Ereal)
               => ( V6v != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                 => ap(c_2Ereal__topology_2Eopen__segment,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,V4a),V6v)),ap(ap(c_2Erealax_2Ereal__mul,V5b),V6v))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3977(V4a,V5b,V6v)) ) ) ) ) )).
