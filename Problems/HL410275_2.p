...
tff(lamtp_f3590,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V0a: $i] :
          ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => mem(f3590(A_27a,V1f,V0a),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
tff(lameq_f3590,axiom,(
    ! [A_27a: del,V1f: $i] :
     ...
     => ! [V0a: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3590(A_27a,V1f,V0a),V2x) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(V1f,V2x)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(c_2Emeasure_2Espace(A_27a),V0a)),V2x)) ) ) ) )).

tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__MUL__INDICATOR__EQ,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ( p(ap(c_2Emeasure_2Esigma__algebra(A_27a),V0a))
           => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),V1f),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),c_2Emeasure_2EBorel)))
            <=> p(ap(ap(c_2Ebool_2EIN(arr(A_27a,ty_2Eextreal_2Eextreal)),f3590(A_27a,V1f,V0a)),ap(ap(c_2Emeasure_2Emeasurable(A_27a,A_27a),V0a),c_2Emeasure_2EBorel))) ) ) ) ) )).
