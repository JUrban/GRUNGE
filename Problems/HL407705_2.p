...
tff(conj_thm_2Eordinal_2EordEXP__lt__IFF,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V1y: $i] :
          ( mem(V1y,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2EordNotationSemantics_2Eadd__nat1__disappears,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
...
tff(conj_thm_2EordNotationSemantics_2Eadd__nat1__disappears__kexp,conjecture,(
    ! [A_27a: del,V0e: $i] :
