...
thf(thm_2EHolSmt_2Er142,conjecture,(
    ! [V0y: tyop_2Erealax_2Ereal,V1x: tyop_2Erealax_2Ereal,V2v: tyop_2Erealax_2Ereal,V3u: tyop_2Erealax_2Ereal,V4a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Erealax_2Ereal__neg @ V4a )
        = ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ V3u ) @ V1x ) @ ( c_2Erealax_2Ereal__mul @ V2v @ V0y ) ) )
    <=> ( ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ V3u @ V1x ) @ ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__neg @ V2v ) @ V0y ) )
        = V4a ) ) )).
