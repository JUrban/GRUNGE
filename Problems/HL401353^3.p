...
thf(thm_2Ebit_2ESIGN__EXTEND__def,axiom,(
    ! [V0l: tyop_2Enum_2Enum,V1h: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2ESIGN__EXTEND @ V0l @ V1h @ V2n )
      = ( c_2Ebool_2ELET @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
        @ ^ [V3m: tyop_2Enum_2Enum] :
            ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2D @ V0l @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1h ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0l ) ) @ V3m ) @ V3m )
        @ ( c_2Earithmetic_2EMOD @ V2n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0l ) ) ) ) )).
...
thf(thm_2Ebit_2ETWOEXP__MONO,axiom,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
     ...
     => ( c_2Eprim__rec_2E_3C @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0a ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1b ) ) ) )).

thf(thm_2Ebit_2ETWOEXP__MONO2,axiom,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V0a @ V1b )
     => ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0a ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1b ) ) ) )).
...
thf(thm_2Ebit_2EBITS__ZERO4,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V1l @ V0h )
     => ( ( c_2Ebit_2EBITS @ V0h @ V1l @ ( c_2Earithmetic_2E_2A @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1l ) ) )
        = ( c_2Ebit_2EBITS @ ( c_2Earithmetic_2E_2D @ V0h @ V1l ) @ c_2Enum_2E0 @ V2a ) ) ) )).
...
thf(thm_2Ebit_2EBITS__COMP__THM2,axiom,(
    ! [V0h1: tyop_2Enum_2Enum,V1l1: tyop_2Enum_2Enum,V2h2: tyop_2Enum_2Enum,V3l2: tyop_2Enum_2Enum,V4n: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBITS @ V2h2 @ V3l2 @ ( c_2Ebit_2EBITS @ V0h1 @ V1l1 @ V4n ) )
      = ( c_2Ebit_2EBITS @ ( c_2Earithmetic_2EMIN @ V0h1 @ ( c_2Earithmetic_2E_2B @ V2h2 @ V1l1 ) ) @ ( c_2Earithmetic_2E_2B @ V3l2 @ V1l1 ) @ V4n ) ) )).

thf(thm_2Ebit_2EDIV__MULT__THM,axiom,(
    ! [V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_2A @ ( c_2Earithmetic_2EDIV @ V1n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0x ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0x ) )
      = ( c_2Earithmetic_2E_2D @ V1n @ ( c_2Earithmetic_2EMOD @ V1n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0x ) ) ) ) )).

thf(thm_2Ebit_2EBITS__SUM,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum,V3b: tyop_2Enum_2Enum] :
      ( ( c_2Eprim__rec_2E_3C @ V3b @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1l ) )
     => ( ( c_2Ebit_2EBITS @ V0h @ V1l @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1l ) ) @ V3b ) )
        = ( c_2Ebit_2EBITS @ V0h @ V1l @ ( c_2Earithmetic_2E_2A @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1l ) ) ) ) ) )).

thf(thm_2Ebit_2EBITS__SUM2,axiom,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum,V3b: tyop_2Enum_2Enum] :
      ( ( c_2Ebit_2EBITS @ V0h @ V1l @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2A @ V2a @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V0h ) ) ) @ V3b ) )
      = ( c_2Ebit_2EBITS @ V0h @ V1l @ V3b ) ) )).
...
thf(thm_2Ebit_2EBIT__SIGN__EXTEND,conjecture,(
    ! [V0l: tyop_2Enum_2Enum,V1h: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum,V3i: tyop_2Enum_2Enum] :
      ( ( (~) @ ( V0l = c_2Enum_2E0 ) )
     => ( ( c_2Ebit_2EBIT @ V3i @ ( c_2Ebit_2ESIGN__EXTEND @ V0l @ V1h @ V2n ) )
        = ( c_2Ebool_2ECOND @ $o @ ( c_2Emin_2E_3D_3D_3E @ ( c_2Earithmetic_2E_3C_3D @ V0l @ V1h ) @ ( c_2Eprim__rec_2E_3C @ V3i @ V0l ) ) @ ( c_2Ebit_2EBIT @ V3i @ ( c_2Earithmetic_2EMOD @ V2n @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0l ) ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eprim__rec_2E_3C @ V3i @ V1h ) @ ( c_2Ebit_2EBIT @ ( c_2Earithmetic_2E_2D @ V0l @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V2n ) ) ) ) ) )).
