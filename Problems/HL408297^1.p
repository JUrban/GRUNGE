...
thf(thm_2Etransc_2ESQRT__POS__LE,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x )
     => ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Etransc_2Esqrt @ V0x ) ) ) )).

thf(thm_2Etransc_2ESQRT__POW__2,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x )
     => ( ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Etransc_2Esqrt @ V0x ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
        = V0x ) ) )).
...
thf(thm_2Etransc_2EREAL__DIV__SQRT,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V0x )
     => ( ( mono_2Ec_2Ereal_2E_2F @ V0x @ ( mono_2Ec_2Etransc_2Esqrt @ V0x ) )
        = ( mono_2Ec_2Etransc_2Esqrt @ V0x ) ) ) )).
