...
tff(conj_thm_2Efinite__map_2Eflookup__thm,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2v: $i] :
             ...
             => ( ( ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V0f),V1x) = c_2Eoption_2ENONE(A_27b)
                ...
                & ( ap(ap(c_2Efinite__map_2EFLOOKUP(A_27a,A_27a),V0f),V1x) = ap(c_2Eoption_2ESOME(A_27b),V2v)
                <=> ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)))
                    & ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V0f),V1x) = V2v ) ) ) ) ) ) )).
