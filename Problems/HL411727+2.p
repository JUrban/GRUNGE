...
fof(conj_thm_2Ereal__topology_2EINTERVAL__SING,lemma,(
    ! [V0a] :
     ...
     => ( ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V0a)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) = ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))
        & ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V0a)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__AFFINITY__LE,lemma,(
    ! [V0m] :
     ...
     => ! [V1c] :
         ...
         => ! [V2x] :
             ...
             => ! [V3y] :
                 ...
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0m))
                   => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V2x)),V1c)),V3y))
                    <=> p(ap(ap(c_2Ereal_2Ereal__lte,V2x),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V3y)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,V1c),V0m))))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__LE__AFFINITY,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Erealax_2Ereal)
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ! [V2x] :
             ...
             => ! [V3y] :
                  ( mem(V3y,ty_2Erealax_2Ereal)
                 => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0m))
                   => ( p(ap(ap(c_2Ereal_2Ereal__lte,V3y),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V2x)),V1c)))
                    <=> p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V3y)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,V1c),V0m)))),V2x)) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EREAL__EQ__AFFINITY,lemma,(
    ! [V0m] :
      ( mem(V0m,ty_2Erealax_2Ereal)
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ! [V2x] :
             ...
             => ! [V3y] :
                  ( mem(V3y,ty_2Erealax_2Ereal)
                 => ( V0m != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
                   => ( V3y = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0m),V2x)),V1c)
                    <=> ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,V0m)),V3y)),ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,V1c),V0m))) = V2x ) ) ) ) ) ) )).

fof(lamtp_f4008,axiom,(
    ! [V2m] :
      ( mem(V2m,ty_2Erealax_2Ereal)
     => ! [V3c] :
          ( mem(V3c,ty_2Erealax_2Ereal)
         => mem(f4008(V2m,V3c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).
    ...
    ! [V2m] :
     ...
     => ! [V3c] :
         ...
         => ! [V4x] :
             ...
             => ap(f4008(V2m,V3c),V4x) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2m),V4x)),V3c) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EIMAGE__AFFINITY__INTERVAL,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
         ...
         => ! [V2m] :
             ...
             => ! [V3c] :
                  ( mem(V3c,ty_2Erealax_2Ereal)
                 => ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4008(V2m,V3c)),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Emin_2E_3D(arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)),ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V2m)),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2m),V0a)),V3c)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2m),V1b)),V3c))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2m),V1b)),V3c)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2m),V0a)),V3c))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))))) ) ) ) ) )).
