...
thf(thm_2Ebag_2EBAG__IMAGE__FINITE__RESTRICTED__I,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > A_27a,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( ( c_2Ebag_2EFINITE__BAG @ A_27a @ V1b )
        & ( c_2Ebag_2EBAG__EVERY @ A_27a
          @ ^ [V2e: A_27a] :
              ( c_2Emin_2E_3D @ A_27a @ ( V0f @ V2e ) @ V2e )
          @ V1b ) )
     => ( ( c_2Ebag_2EBAG__IMAGE @ A_27a @ A_27a @ V0f @ V1b )
        = V1b ) ) )).
