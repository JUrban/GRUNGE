...
fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,A_27a)
         => ! [V1f] :
             ...
             => ! [V2s] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(ap(c_2Epred__set_2Eschroeder__close(A_27a),V1f),V2s)))
                  <=> ? [V3n] :
                        ( mem(V3n,ty_2Enum_2Enum)
                        & p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(ap(ap(c_2Earithmetic_2EFUNPOW(arr(A_27a,bool)),ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1f)),V3n),V2s))) ) ) ) ) ) ) )).

fof(conj_thm_2Epred__set_2ESCHROEDER__CLOSE__SET,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(A_27a,A_27a))
