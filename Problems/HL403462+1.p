...
fof(arityeq1_2Ec_2Elist_2ELIST__TO__SET_2E1_2Etyop_2EEncode_2Etree_28A_27a_29,axiom,(
    ! [A_27a,X0_2E0] : s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),X0_2E0))) = s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool)),c_2Elist_2ELIST__TO__SET_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),X0_2E0))) )).

fof(arityeq2_2Ec_2EEncode_2ENode_2E2_2EA_27a,axiom,(
    ! [A_27a,X0_2E0,X1_2E0] : s(tyop_2EEncode_2Etree(A_27a),c_2EEncode_2ENode_2E2(s(A_27a,X0_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),X1_2E0))) = s(tyop_2EEncode_2Etree(A_27a),app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2EEncode_2Etree(A_27a)),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2EEncode_2Etree(A_27a))),c_2EEncode_2ENode_2E0),s(A_27a,X0_2E0))),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),X1_2E0))) )).

fof(thm_2EEncode_2Etree__induction,axiom,(
    ! [A_27a,V0P0_2E0,V1P1_2E0] :
      ( ( ! [V2l_2E0] :
            ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Ebool),V1P1_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V2l_2E0))))
           => ! [V3a_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0P0_2E0),s(tyop_2EEncode_2Etree(A_27a),c_2EEncode_2ENode_2E2(s(A_27a,V3a_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V2l_2E0)))))) )
        & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Ebool),V1P1_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),c_2Elist_2ENIL_2E0))))
        & ! [V4t_2E0,V5l_2E0] :
            ( ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0P0_2E0),s(tyop_2EEncode_2Etree(A_27a),V4t_2E0))))
              & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Ebool),V1P1_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V5l_2E0)))) )
           => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Ebool),V1P1_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),c_2Elist_2ECONS_2E2(s(tyop_2EEncode_2Etree(A_27a),V4t_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V5l_2E0)))))) ) )
     => ( ! [V6t_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0P0_2E0),s(tyop_2EEncode_2Etree(A_27a),V6t_2E0))))
        & ! [V7l_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),tyop_2Emin_2Ebool),V1P1_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V7l_2E0)))) ) ) )).
...
fof(thm_2EEncode_2Etree__ind,conjecture,(
    ! [A_27a,V0p_2E0] :
      ( ! [V1a_2E0,V2ts_2E0] :
          ( ! [V3t_2E0] :
              ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(tyop_2EEncode_2Etree(A_27a),V3t_2E0),s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V2ts_2E0))))))
             => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0p_2E0),s(tyop_2EEncode_2Etree(A_27a),V3t_2E0)))) )
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0p_2E0),s(tyop_2EEncode_2Etree(A_27a),c_2EEncode_2ENode_2E2(s(A_27a,V1a_2E0),s(tyop_2Elist_2Elist(tyop_2EEncode_2Etree(A_27a)),V2ts_2E0)))))) )
     => ! [V4t_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2EEncode_2Etree(A_27a),tyop_2Emin_2Ebool),V0p_2E0),s(tyop_2EEncode_2Etree(A_27a),V4t_2E0)))) ) )).
