...
thf(conj_thm_2Ehreal_2EHREAL__SUB__ADD,lemma,(
    ! [V0X: tp__ty_2Ehreal_2Ehreal,V1Y: tp__ty_2Ehreal_2Ehreal] :
      ( ( p @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__lt @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) )
     => ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__sub @ ( inj__ty_2Ehreal_2Ehreal @ V1Y ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V0X ) ) )
        = V1Y ) ) )).
...
thf(conj_thm_2Erealax_2EHREAL__EQ__LADD,lemma,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal,V2z: tp__ty_2Ehreal_2Ehreal] :
      ( ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) )
        = ( surj__ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V2z ) ) ) )
    <=> ( V1y = V2z ) ) )).
...
thf(ax_thm_2Erealax_2Etreal__of__hreal,axiom,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Etreal__of__hreal @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) )
      = ( surj__c_ty_2Epair_2Eprod_ty_2Ehreal_2Ehreal_ty_2Ehreal_2Ehreal @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Ehreal_2Ehreal @ ty_2Ehreal_2Ehreal ) @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ fo__c_2Ehreal_2Ehreal__1 ) ) ) @ ( inj__ty_2Ehreal_2Ehreal @ fo__c_2Ehreal_2Ehreal__1 ) ) ) ) )).

thf(ax_thm_2Erealax_2Ehreal__of__treal,axiom,(
    ! [V0x: tp__ty_2Ehreal_2Ehreal,V1y: tp__ty_2Ehreal_2Ehreal] :
      ( ( surj__ty_2Ehreal_2Ehreal @ ( ap @ c_2Erealax_2Ehreal__of__treal @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Ehreal_2Ehreal @ ty_2Ehreal_2Ehreal ) @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) ) )
      = ( surj__ty_2Ehreal_2Ehreal
        @ ( ap @ ( c_2Emin_2E_40 @ ty_2Ehreal_2Ehreal )
          @ ( lam @ ty_2Ehreal_2Ehreal
            @ ^ [V2d: $i] :
                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Ehreal_2Ehreal ) @ ( inj__ty_2Ehreal_2Ehreal @ V0x ) ) @ ( ap @ ( ap @ c_2Ehreal_2Ehreal__add @ ( inj__ty_2Ehreal_2Ehreal @ V1y ) ) @ V2d ) ) ) ) ) ) )).

thf(conj_thm_2Erealax_2ETREAL__BIJ,conjecture,
