...
tff(conj_thm_2Ebag_2EBAG__IMAGE__EQ__EMPTY,lemma,(
    ! [A_27a: del,A_27b: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,A_27b))
...
tff(conj_thm_2Ebag_2EBAG__IMAGE__FINITE__RESTRICTED__I,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27a))
     => ! [V1b: $i] :
          ( mem(V1b,arr(A_27a,ty_2Enum_2Enum))
