...
thf(tp_c_2Enumeral__bit_2EiBITWISE,type,(
    c_2Enumeral__bit_2EiBITWISE: $i )).

thf(mem_c_2Enumeral__bit_2EiBITWISE,axiom,(
...
thf(tp_c_2Enumeral__bit_2EiLOG2,type,(
    c_2Enumeral__bit_2EiLOG2: $i )).

thf(mem_c_2Enumeral__bit_2EiLOG2,axiom,(
    mem @ c_2Enumeral__bit_2EiLOG2 @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2Enumeral__bit_2EiLOG2,type,(
    fo__c_2Enumeral__bit_2EiLOG2: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Enumeral__bit_2EiLOG2,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Enumeral__bit_2EiLOG2 @ X0 ) )
      = ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( inj__ty_2Enum_2Enum @ X0 ) ) ) )).
...
thf(tp_c_2Earithmetic_2EMAX,type,(
    c_2Earithmetic_2EMAX: $i )).

thf(mem_c_2Earithmetic_2EMAX,axiom,(
    mem @ c_2Earithmetic_2EMAX @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) ) )).

thf(stp_fo_c_2Earithmetic_2EMAX,type,(
    fo__c_2Earithmetic_2EMAX: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Earithmetic_2EMAX,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Earithmetic_2EMAX @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Earithmetic_2EMAX @ ( inj__ty_2Enum_2Enum @ X0 ) ) @ ( inj__ty_2Enum_2Enum @ X1 ) ) ) )).
...
thf(tp_c_2Ebit_2ELOG2,type,(
    c_2Ebit_2ELOG2: $i )).

thf(mem_c_2Ebit_2ELOG2,axiom,(
    mem @ c_2Ebit_2ELOG2 @ ( arr @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) )).

thf(stp_fo_c_2Ebit_2ELOG2,type,(
    fo__c_2Ebit_2ELOG2: tp__ty_2Enum_2Enum > tp__ty_2Enum_2Enum )).

thf(stp_eq_fo_c_2Ebit_2ELOG2,axiom,(
    ! [X0: tp__ty_2Enum_2Enum] :
      ( ( inj__ty_2Enum_2Enum @ ( fo__c_2Ebit_2ELOG2 @ X0 ) )
      = ( ap @ c_2Ebit_2ELOG2 @ ( inj__ty_2Enum_2Enum @ X0 ) ) ) )).
...
thf(tp_c_2Ebit_2EBITWISE,type,(
    c_2Ebit_2EBITWISE: $i )).

thf(mem_c_2Ebit_2EBITWISE,axiom,(
...
thf(conj_thm_2Eint__arith_2Ele__move__right__left,lemma,(
...
thf(conj_thm_2Eint__arith_2Ele__move__all__right,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Eint__arith_2EINT__NUM__SUB,lemma,(
...
thf(conj_thm_2Eint__arith_2Ele__context__rwt2,lemma,(
...
thf(conj_thm_2Eint__arith_2Ele__context__rwt5,lemma,(
    ! [V0c: tp__ty_2Einteger_2Eint,V1x: tp__ty_2Einteger_2Eint] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( ap @ c_2Einteger_2Eint__neg @ ( inj__ty_2Einteger_2Eint @ V0c ) ) ) @ ( ap @ c_2Einteger_2Eint__neg @ ( inj__ty_2Einteger_2Eint @ V1x ) ) ) ) )
      <=> ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
          = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( inj__ty_2Einteger_2Eint @ V0c ) ) @ ( inj__ty_2Einteger_2Eint @ V1x ) ) ) ) ) ) )).

thf(conj_thm_2Eint__arith_2Eeq__context__rwt2,lemma,(
    ! [V0c: tp__ty_2Einteger_2Eint,V1x: tp__ty_2Einteger_2Eint,V2y: tp__ty_2Einteger_2Eint] :
      ( ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
        = ( surj__ty_2Einteger_2Eint @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( inj__ty_2Einteger_2Eint @ V0c ) ) @ ( inj__ty_2Einteger_2Eint @ V1x ) ) ) )
     => ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__add @ ( ap @ c_2Einteger_2Eint__neg @ ( inj__ty_2Einteger_2Eint @ V0c ) ) ) @ ( inj__ty_2Einteger_2Eint @ V2y ) ) ) )
...
thf(conj_thm_2Einteger_2EINT__NOT__LE,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
      ( ~ ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V1y ) ) )
    <=> ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__lt @ ( inj__ty_2Einteger_2Eint @ V1y ) ) @ ( inj__ty_2Einteger_2Eint @ V0x ) ) ) ) )).

thf(conj_thm_2Einteger_2EINT__LE__TRANS,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
      ( ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V1y ) ) )
...
thf(conj_thm_2Einteger_2EINT__LE__ANTISYM,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
      ( ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V1y ) ) )
        & ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V1y ) ) @ ( inj__ty_2Einteger_2Eint @ V0x ) ) ) )
    <=> ( V0x = V1y ) ) )).

thf(conj_thm_2Einteger_2EINT__NEG__GE0,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__LE__NEGR,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__LE__ADDL,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__LE__NEG,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__SUB__RNEG,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__SUB__NEG2,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger_2EINT__EQ__NEG,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint] :
      ( ( ( surj__ty_2Einteger_2Eint @ ( ap @ c_2Einteger_2Eint__neg @ ( inj__ty_2Einteger_2Eint @ V0x ) ) )
...
thf(conj_thm_2Einteger_2EINT__LE__MONO,lemma,(
    ! [V0x: tp__ty_2Einteger_2Eint,V1y: tp__ty_2Einteger_2Eint,V2z: tp__ty_2Einteger_2Eint] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V1y ) ) ) @ ( ap @ ( ap @ c_2Einteger_2Eint__mul @ ( inj__ty_2Einteger_2Eint @ V0x ) ) @ ( inj__ty_2Einteger_2Eint @ V2z ) ) ) )
      <=> ( p @ ( ap @ ( ap @ c_2Einteger_2Eint__le @ ( inj__ty_2Einteger_2Eint @ V1y ) ) @ ( inj__ty_2Einteger_2Eint @ V2z ) ) ) ) ) )).
...
thf(conj_thm_2Einteger__word_2Ew2i__11,lemma,(
    ! [A_27a: del,V0v: $i] :
...
thf(conj_thm_2Einteger__word_2Eranged__int__word__nchotomy,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Einteger__word_2EWORD__LEi,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Einteger__word_2Eword__i2w__add,lemma,(
...
thf(conj_thm_2Einteger__word_2EMULT__MINUS__ONE,lemma,(
    ! [A_27a: del,V0i: tp__ty_2Einteger_2Eint] :
...
thf(conj_thm_2Einteger__word_2EINT__MAX,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Einteger__word_2Ew2i__1,lemma,(
    ! [A_27a: del] :
...
thf(conj_thm_2Einteger__word_2Ew2i__INT__MINw,lemma,(
    ! [A_27a: del] :
      ( ( surj__ty_2Einteger_2Eint @ ( ap @ ( c_2Einteger__word_2Ew2i @ A_27a ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) )
      = ( surj__ty_2Einteger_2Eint @ ( ap @ ( c_2Einteger__word_2EINT__MIN @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) )).

thf(conj_thm_2Einteger__word_2Ew2i__neg,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( V0w
...
thf(conj_thm_2Einteger__word_2Ei2w__minus__1,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ c_2Einteger_2Eint__neg @ ( ap @ c_2Einteger_2Eint__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) )
...
thf(conj_thm_2Einteger__word_2Ei2w__INT__MIN,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Einteger__word_2Ei2w @ A_27a ) @ ( ap @ ( c_2Einteger__word_2EINT__MIN @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
      = ( c_2Ewords_2Eword__L @ A_27a ) ) )).

thf(conj_thm_2Einteger__word_2Esaturate__i2sw__0,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Einteger__word_2Esaturate__i2sw @ A_27a ) @ ( ap @ c_2Einteger_2Eint__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
...
thf(conj_thm_2Enumeral__bit_2EiBITWISE,lemma,
    ( ! [V0opr: $i] :
        ( ( mem @ V0opr @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
       => ! [V1a: tp__ty_2Enum_2Enum,V2b: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0opr ) @ ( inj__ty_2Enum_2Enum @ V1a ) ) @ ( inj__ty_2Enum_2Enum @ V2b ) ) )
            = fo__c_2Earithmetic_2EZERO ) )
    & ! [V3x: tp__ty_2Enum_2Enum,V4opr: $i] :
        ( ( mem @ V4opr @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
       => ! [V5a: tp__ty_2Enum_2Enum,V6b: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3x ) ) ) ) @ V4opr ) @ ( inj__ty_2Enum_2Enum @ V5a ) ) @ ( inj__ty_2Enum_2Enum @ V6b ) ) )
            = ( surj__ty_2Enum_2Enum
              @ ( ap
                @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V7w: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ V4opr @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V5a ) ) ) @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V6b ) ) ) ) @ ( ap @ c_2Earithmetic_2EBIT1 @ V7w ) ) @ ( ap @ c_2Enumeral_2EiDUB @ V7w ) ) ) )
                @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V3x ) ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ V4opr ) @ ( ap @ c_2Earithmetic_2EDIV2 @ ( inj__ty_2Enum_2Enum @ V5a ) ) ) @ ( ap @ c_2Earithmetic_2EDIV2 @ ( inj__ty_2Enum_2Enum @ V6b ) ) ) ) ) ) )
    & ! [V8x: tp__ty_2Enum_2Enum,V9opr: $i] :
        ( ( mem @ V9opr @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
       => ! [V10a: tp__ty_2Enum_2Enum,V11b: tp__ty_2Enum_2Enum] :
            ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V8x ) ) ) ) @ V9opr ) @ ( inj__ty_2Enum_2Enum @ V10a ) ) @ ( inj__ty_2Enum_2Enum @ V11b ) ) )
            = ( surj__ty_2Enum_2Enum
              @ ( ap
                @ ( ap @ ( c_2Ebool_2ELET @ ty_2Enum_2Enum @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V12w: $i] :
                        ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ V9opr @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V10a ) ) ) @ ( ap @ c_2Earithmetic_2EODD @ ( inj__ty_2Enum_2Enum @ V11b ) ) ) ) @ ( ap @ c_2Earithmetic_2EBIT1 @ V12w ) ) @ ( ap @ c_2Enumeral_2EiDUB @ V12w ) ) ) )
                @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V8x ) ) ) ) @ V9opr ) @ ( ap @ c_2Earithmetic_2EDIV2 @ ( inj__ty_2Enum_2Enum @ V10a ) ) ) @ ( ap @ c_2Earithmetic_2EDIV2 @ ( inj__ty_2Enum_2Enum @ V11b ) ) ) ) ) ) ) )).

thf(conj_thm_2Enumeral__bit_2ENUMERAL__BITWISE,lemma,(
    ! [A_27a: del] :
      ( ! [V0x: tp__ty_2Enum_2Enum,V1f: $i] :
          ( ( mem @ V1f @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
         => ! [V2a: $i] :
              ( ( mem @ V2a @ A_27a )
             => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ V1f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ V1f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )
      & ! [V3x: tp__ty_2Enum_2Enum,V4f: $i] :
          ( ( mem @ V4f @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
         => ! [V5a: tp__ty_2Enum_2Enum] :
              ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( inj__ty_2Enum_2Enum @ V3x ) ) @ V4f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V5a ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
              = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( inj__ty_2Enum_2Enum @ V3x ) ) @ V4f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V5a ) ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) )
      & ! [V6x: tp__ty_2Enum_2Enum,V7f: $i] :
          ( ( mem @ V7f @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
         => ! [V8b: tp__ty_2Enum_2Enum] :
              ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( inj__ty_2Enum_2Enum @ V6x ) ) @ V7f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V8b ) ) ) )
              = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( inj__ty_2Enum_2Enum @ V6x ) ) @ V7f ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V8b ) ) ) ) ) ) )
      & ! [V9x: tp__ty_2Enum_2Enum,V10f: $i] :
          ( ( mem @ V10f @ ( arr @ bool @ ( arr @ bool @ bool ) ) )
         => ! [V11a: tp__ty_2Enum_2Enum,V12b: tp__ty_2Enum_2Enum] :
              ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( inj__ty_2Enum_2Enum @ V9x ) ) @ V10f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V11a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V12b ) ) ) )
              = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ ( ap @ ( ap @ ( ap @ c_2Enumeral__bit_2EiBITWISE @ ( inj__ty_2Enum_2Enum @ V9x ) ) @ V10f ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V11a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( inj__ty_2Enum_2Enum @ V12b ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Enumeral__bit_2Enumeral__ilog2,lemma,
    ( ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) )
      = fo__c_2Enum_2E0 )
    & ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
    & ! [V1n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).

thf(conj_thm_2Enumeral__bit_2Enumeral__log2,lemma,
    ( ! [V0n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ebit_2ELOG2 @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( ap @ c_2Enumeral_2EiDUB @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
    & ! [V1n: tp__ty_2Enum_2Enum] :
        ( ( surj__ty_2Enum_2Enum @ ( ap @ c_2Ebit_2ELOG2 @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enumeral__bit_2EiLOG2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Edimindex__1__cases,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EWORD__AND__CLAUSES,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
...
thf(conj_thm_2Ewords_2EWORD__LITERAL__AND,lemma,(
    ! [A_27a: del] :
      ( ! [V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] :
                ...
                @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( ap @ c_2Enum_2ESUC @ ( ap @ c_2Ebit_2ELOG2 @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
                  @ ( lam @ bool
                    @ ^ [V4a: $i] :
                        ( lam @ bool
                        @ ^ [V5b: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ V4a ) @ ( ap @ c_2Ebool_2E_7E @ V5b ) ) ) ) )
                ...
                @ ( ap @ ( ap @ c_2Ebit_2EBITWISE @ ( ap @ c_2Enum_2ESUC @ ( ap @ c_2Ebit_2ELOG2 @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) )
                  @ ( lam @ bool
                    @ ^ [V8a: $i] :
                        ( lam @ bool
                        @ ^ [V9b: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ V8a ) @ ( ap @ c_2Ebool_2E_7E @ V9b ) ) ) ) )
...
thf(conj_thm_2Ewords_2EWORD__H__WORD__L,lemma,(
    ! [A_27a: del] :
      ( ( c_2Ewords_2Eword__H @ A_27a )
      = ( ap @ ( ap @ ( c_2Ewords_2Eword__sub @ A_27a ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(conj_thm_2Ewords_2EWORD__NEG__L,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ ( c_2Ewords_2Eword__L @ A_27a ) )
      = ( c_2Ewords_2Eword__L @ A_27a ) ) )).

thf(conj_thm_2Einteger__word_2Esigned__saturate__sub,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Einteger__word_2Esigned__saturate__sub @ A_27a ) @ V0a ) @ V1b )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ V1b ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__le @ A_27a ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V0a ) ) @ ( c_2Ewords_2Eword__H @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__add @ A_27a ) @ V0a ) @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27a ) @ V0a ) @ ( ap @ ( c_2Ewords_2Eword__1comp @ A_27a ) @ V1b ) ) ) @ ( ap @ ( ap @ ( c_2Einteger__word_2Esigned__saturate__add @ A_27a ) @ V0a ) @ ( ap @ ( c_2Ewords_2Eword__2comp @ A_27a ) @ V1b ) ) ) ) ) ) ) )).
