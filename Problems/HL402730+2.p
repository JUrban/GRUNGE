...
fof(conj_thm_2Erich__list_2EELL__SNOC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0n))
           => ! [V1x] :
               ...
               => ! [V2l] :
                   ...
                   => ap(ap(c_2Erich__list_2EELL(A_27a),V0n),ap(ap(c_2Elist_2ESNOC(A_27a),V1x),V2l)) = ap(ap(c_2Erich__list_2EELL(A_27a),ap(c_2Eprim__rec_2EPRE,V0n)),V2l) ) ) ) ) ) )).

fof(conj_thm_2Erich__list_2EELL__SUC__SNOC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
