...
tff(lamtp_f454,axiom,(
    ! [A_27a: del,A_27b: del,V1ls: $i] :
      ( mem(V1ls,ty_2Elist_2Elist(A_27a))
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => mem(f454(A_27a,A_27b,V1ls,V0f),arr(ty_2Enum_2Enum,A_27b)) ) ) )).
...
tff(conj_thm_2Elist_2EIMAGE__EL__count__LENGTH,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
         => ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),f454(A_27a,A_27b,V1ls,V0f)),ap(c_2Epred__set_2Ecount,ap(c_2Elist_2ELENGTH(A_27a),V1ls))) = ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1ls)) ) ) )).
