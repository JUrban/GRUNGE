...
tff(conj_thm_2Efinite__map_2Eo__f__FEMPTY,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
...
tff(conj_thm_2Efinite__map_2Eo__f__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,A_27b))
     => ! [V1fm: $i] :
...
tff(mem_c_2Efmapal_2EAP__SND,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del] : mem(c_2Efmapal_2EAP__SND(A_27a,A_27a,A_27a),arr(arr(A_27b,A_27c),arr(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)))) )).
...
tff(ax_thm_2Efmapal_2EAP__SND,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
     ...
     => ! [V1a: $i] :
         ...
         => ! [V2b: $i] :
              ( mem(V2b,A_27b)
             => ap(ap(c_2Efmapal_2EAP__SND(A_27a,A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),V2b)) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1a),ap(V0f,V2b)) ) ) ) )).

tff(conj_thm_2Efmapal_2Eo__f__fmap,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,A_27c))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
         => ap(ap(c_2Efinite__map_2Eo__f(A_27a,A_27a,A_27a),V0f),ap(c_2Efmapal_2Efmap(A_27a,A_27a),V1l)) = ap(c_2Efmapal_2Efmap(A_27a,A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),ap(c_2Efmapal_2EAP__SND(A_27a,A_27a,A_27a),V0f)),V1l)) ) ) )).
