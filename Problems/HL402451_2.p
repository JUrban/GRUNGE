...
tff(lamtp_f577,axiom,(
    ! [A_27a: del,A_27b: del,V3y: $i] :
      ( mem(V3y,A_27b)
     => mem(f577(A_27a,A_27b,V3y),arr(ty_2Elist_2Elist(A_27b),arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)))))) ) )).
...
tff(lameq_f577,axiom,(
    ! [A_27a: del,A_27b: del,V3y: $i] :
     ...
     => ! [V4ys: $i] :
         ...
         => ap(f577(A_27a,A_27b,V3y),V4ys) = ap(c_2EerrorStateMonad_2EUNIT(A_27a,A_27a),ap(ap(c_2Elist_2ECONS(A_27b),V3y),V4ys)) ) ) )).

tff(lmtp_f576,type,(
    f576: ( del * del * del * del * $i * $i ) > $i )).

tff(lamtp_f576,axiom,(
    ! [A_27b: del,A_27a: del,A_27c: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b)))))
     => ! [V2xs: $i] :
          ( mem(V2xs,ty_2Elist_2Elist(A_27c))
         => mem(f576(A_27b,A_27a,A_27c,A_27b,V0f,V2xs),arr(A_27b,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Elist_2Elist(A_27b),ty_2Elist_2Elist(A_27b)))))) ) ) )).
...
tff(lameq_f576,axiom,(
    ! [A_27b: del,A_27a: del,A_27c: del,A_27b: del,V0f: $i] :
     ...
     => ! [V2xs: $i] :
         ...
         => ! [V3y: $i] :
              ( mem(V3y,A_27b)
             => ap(f576(A_27b,A_27a,A_27c,A_27b,V0f,V2xs),V3y) = ap(ap(c_2EerrorStateMonad_2EBIND(A_27a,A_27a,A_27a),ap(ap(c_2EerrorStateMonad_2EmapM(A_27c,A_27c,A_27c),V0f),V2xs)),f577(A_27a,A_27b,V3y)) ) ) ) )).

tff(conj_thm_2EerrorStateMonad_2EmapM__cons,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27c,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b)))))
     => ! [V1x: $i] :
          ( mem(V1x,A_27c)
         => ! [V2xs: $i] :
              ( mem(V2xs,ty_2Elist_2Elist(A_27c))
             => ap(ap(c_2EerrorStateMonad_2EmapM(A_27c,A_27c,A_27c),V0f),ap(ap(c_2Elist_2ECONS(A_27c),V1x),V2xs)) = ap(ap(c_2EerrorStateMonad_2EBIND(A_27a,A_27a,A_27a),ap(V0f,V1x)),f576(A_27b,A_27a,A_27c,A_27b,V0f,V2xs)) ) ) ) )).
