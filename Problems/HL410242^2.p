...
thf(conj_thm_2Eextreal_2Elet__add2,lemma,(
...
thf(conj_thm_2Eextreal_2ESIMP__EXTREAL__ARCH,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] :
      ( ( V0x != fo__c_2Eextreal_2EPosInf )
     => ? [V1n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V0x ) ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__NEGINF,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
                  ...
                  @ ( ap
                    @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a )
                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V2x: $i] :
                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V2x ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Eextreal_2Eextreal ) @ ( ap @ V0f @ V2x ) ) @ ( inj__ty_2Eextreal_2Eextreal @ fo__c_2Eextreal_2ENegInf ) ) ) ) ) )
                    @ ( ap @ ( c_2Emeasure_2Espace @ A_27a ) @ V1a ) ) )
                @ ( ap @ ( c_2Emeasure_2Esubsets @ A_27a ) @ V1a ) ) ) ) ) ) )).
...
thf(conj_thm_2Eseq_2ESEQ__POWER,lemma,(
...
thf(conj_thm_2Eseq_2ELE__SEQ__IMP__LE__LIM,lemma,(
...
thf(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__ALT2,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) ) )
