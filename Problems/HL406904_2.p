...
tff(tp_c_2EDeepSyntax_2Eneginf,type,(
    c_2EDeepSyntax_2Eneginf: $i )).

tff(mem_c_2EDeepSyntax_2Eneginf,axiom,(
    mem(c_2EDeepSyntax_2Eneginf,arr(ty_2EDeepSyntax_2Edeep__form,ty_2EDeepSyntax_2Edeep__form)) )).

tff(stp_fo_c_2EDeepSyntax_2Eneginf,type,(
    fo__c_2EDeepSyntax_2Eneginf: tp__ty_2EDeepSyntax_2Edeep__form > tp__ty_2EDeepSyntax_2Edeep__form )).

tff(stp_eq_fo_c_2EDeepSyntax_2Eneginf,axiom,(
    ! [X0: tp__ty_2EDeepSyntax_2Edeep__form] : inj__ty_2EDeepSyntax_2Edeep__form(fo__c_2EDeepSyntax_2Eneginf(X0)) = ap(c_2EDeepSyntax_2Eneginf,inj__ty_2EDeepSyntax_2Edeep__form(X0)) )).

tff(conj_thm_2EDeepSyntax_2Eneginf__disj1__implies__exoriginal,lemma,(
...
tff(conj_thm_2EDeepSyntax_2Eneginf__exoriginal__implies__rhs,lemma,(
...
tff(conj_thm_2EDeepSyntax_2Eneginf__exoriginal__eq__rhs,conjecture,(
