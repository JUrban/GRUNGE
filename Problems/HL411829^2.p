...
thf(conj_thm_2Ereal__topology_2EIN__INTERIOR__CBALL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECLOSEST__POINT__LE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2ECLOSEST__POINT__IN__INTERIOR,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V0s ) )
