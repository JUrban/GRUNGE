...
thf(ax_thm_2Ellist_2Eexists__def,axiom,(
    ! [A_27a: del] :
                                      ...
                                      @ ( ap @ ( c_2Ebool_2E_3F @ A_27a )
                                        @ ( lam @ A_27a
                                          @ ^ [V4h: $i] :
                                              ...
                                              @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
                                                @ ^ [V5t: $i] :
                                                    ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V3a0 ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V4h ) @ V5t ) ) ) @ ( ap @ V0P @ V4h ) ) ) ) ) ) )
                                    @ ( ap @ ( c_2Ebool_2E_3F @ A_27a )
                                      @ ( lam @ A_27a
                                        @ ^ [V6h: $i] :
                                            ( ap @ ( c_2Ebool_2E_3F @ ( ty_2Ellist_2Ellist @ A_27a ) )
                                            @ ( lam @ ( ty_2Ellist_2Ellist @ A_27a )
                                              @ ^ [V7t: $i] :
                                                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ V3a0 ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V6h ) @ V7t ) ) ) @ ( ap @ V2exists_27 @ V7t ) ) ) ) ) ) ) )
                                @ ( ap @ V2exists_27 @ V3a0 ) ) ) ) )
                      @ ( ap @ V2exists_27 @ V1a0 ) ) ) ) ) ) ) )).

thf(conj_thm_2Ellist_2Eexists__cases,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1a0: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2Eexists @ A_27a ) @ V0P ) @ V1a0 ) )
          <=> ( ? [V2h: $i] :
                  ...
                  & ? [V3t: $i] :
                      ...
                      & ( V1a0
                        = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V2h ) @ V3t ) )
                      & ( p @ ( ap @ V0P @ V2h ) ) ) )
              | ? [V4h: $i] :
                  ( ( mem @ V4h @ A_27a )
                  & ? [V5t: $i] :
                      ...
                      & ( V1a0
                        = ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V4h ) @ V5t ) )
