...
fof(conj_thm_2Ecardinal_2Ecardlt__cardle,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0B] :
             ...
             => ! [V1A] :
                 ...
                 => ( ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V0B),V1A))
                   => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V1A),V0B)) ) ) ) ) ) )).
