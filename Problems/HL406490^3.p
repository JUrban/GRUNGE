      ...
      = ( c_2Elist_2EAPPEND @ tyop_2Enum_2Enum
        @ ( c_2Elist_2EREVERSE @ tyop_2Enum_2Enum
          @ ( c_2Elist_2EMAP @ $o @ tyop_2Enum_2Enum
            @ ^ [V2b: $o] :
                ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ V2b @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ c_2Enum_2E0 )
            @ V0v ) )
        @ V1a ) ) )).

thf(thm_2Ebitstring_2Eevery__bit__bitify,axiom,(
    ! [V0v: tyop_2Elist_2Elist @ $o] :
      ( c_2Elist_2EEVERY @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2E_3E @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ebitstring_2Ebitify @ ( c_2Elist_2ENIL @ tyop_2Enum_2Enum ) @ V0v ) ) )).
