...
tff(conj_thm_2Estate__transformer_2EFST__o__UNIT,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Epair_2EFST(A_27a,A_27a)),ap(c_2Estate__transformer_2EUNIT(A_27b,A_27b),V0x)) = ap(c_2Ecombin_2EK(A_27a,A_27a),V0x) ) )).
