...
fof(conj_thm_2Esorting_2EALL__DISTINCT__PERM__LIST__TO__SET__TO__LIST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
...
fof(conj_thm_2Ealist_2Ealist__to__fmap__to__alist,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ealist_2Ealist__to__fmap__to__alist__PERM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
