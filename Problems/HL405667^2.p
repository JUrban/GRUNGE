...
thf(conj_thm_2Eordinal_2Esup__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Eordinal_2Esup @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) )
...
thf(conj_thm_2Eordinal_2EordMULT__continuous,conjecture,(
    ! [A_27a: del,V0a: $i] :
