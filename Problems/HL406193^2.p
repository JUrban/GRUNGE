...
thf(conj_thm_2Ewords_2Ebit__count__upto__0,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Ewords_2Ebit__count__upto @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0w ) )
        = fo__c_2Enum_2E0 ) ) )).
