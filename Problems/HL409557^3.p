...
thf(c_2Emachine__ieee_2Efp16__mul__add,type,(
    c_2Emachine__ieee_2Efp16__mul__add: tyop_2Ebinary__ieee_2Erounding > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) > ( tyop_2Efcp_2Ecart @ $o @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ ( tyop_2Efcp_2Ebit0 @ tyop_2Eone_2Eone ) ) ) ) ) )).
...
thf(thm_2Elift__ieee_2Efloat__mul__add__relative,axiom,(
    ! [A_27t: $tType,A_27w: $tType,V0a: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w,V1b: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w,V2c: tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w] :
      ( ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w @ V0a )
        ...
        & ( c_2Elift__ieee_2Enormalizes @ A_27t @ A_27w @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27t @ A_27w ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V1b ) ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V2c ) ) ) )
     => ( ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w @ ( c_2Epair_2ESND @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) @ ( c_2Ebinary__ieee_2Efloat__mul__add @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b @ V2c ) ) )
        & ? [V3e: tyop_2Erealax_2Ereal] :
            ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V3e ) @ ( c_2Ereal_2E_2F @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ereal_2Epow @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Earithmetic_2E_2B @ ( c_2Efcp_2Edimindex @ A_27t @ ( c_2Ebool_2Ethe__value @ A_27t ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )
            & ( ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ ( c_2Epair_2ESND @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) @ ( c_2Ebinary__ieee_2Efloat__mul__add @ A_27t @ A_27w @ c_2Ebinary__ieee_2EroundTiesToEven @ V0a @ V1b @ V2c ) ) )
              = ( c_2Erealax_2Ereal__mul @ ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V0a ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V1b ) ) @ ( c_2Ebinary__ieee_2Efloat__to__real @ A_27t @ A_27w @ V2c ) ) @ ( c_2Erealax_2Ereal__add @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3e ) ) ) ) ) ) )).
