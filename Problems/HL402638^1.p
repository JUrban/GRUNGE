...
thf(f3150_0_2E0,type,(
    f3150_0_2E0: u )).

thf(f3150_0_2E2,type,(
    f3150_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef3150_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f3150_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ f3150_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Erich__list_2EFOLDL__SNOC__NIL,axiom,(
    ! [A_27a: d,V1xs_2E0: u,V2x_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( f3150_0_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1xs_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1xs_2E0 ) ) ) ) )).

thf(thm_2Erich__list_2EFOLDL__SNOC__NIL,conjecture,(
    ! [A_27a: d,V0l_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFOLDL_2E3 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ f3150_0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l_2E0 ) ) )
