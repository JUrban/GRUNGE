...
tff(thm_2Ebool_2EITSELF__UNIQUE,axiom,(
    ! [A_27a: d,V0i_2E0: u] : s(tyop_2Ebool_2Eitself(A_27a),V0i_2E0) = s(tyop_2Ebool_2Eitself(A_27a),c_2Ebool_2Ethe__value_2E0) )).

tff(thm_2Ebool_2EEXISTS__itself,conjecture,(
    ! [A_27a: d,V0P_2E0: u] :
      ( ? [V1x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Ebool_2Eitself(A_27a),tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Ebool_2Eitself(A_27a),V1x_2E0)))))
