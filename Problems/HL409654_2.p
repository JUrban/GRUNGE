...
tff(conj_thm_2Eiterate_2EFINITE__INDEX__NUMSEG,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
      <=> ? [V1f: $i] :
...
tff(conj_thm_2Eiterate_2EFINITE__INDEX__NUMBERS,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
      <=> ? [V1k: $i] :
            ...
            & ? [V2f: $i] :
                ...
                & V0s = ap(ap(c_2Epred__set_2EIMAGE(ty_2Enum_2Enum,ty_2Enum_2Enum),V2f),V1k) ) ) ) ) )).
