...
thf(thm_2Erich__list_2EIS__PREFIX__REFL,axiom,(
    ! [A_27a: d,V0x_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elist_2EisPREFIX_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0x_2E0 ) ) ) ) )).

thf(thm_2Ellist_2ELPREFIX__REFL,conjecture,(
    ! [A_27a: d,V0ll_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELPREFIX_2E2 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V0ll_2E0 ) ) ) ) )).
