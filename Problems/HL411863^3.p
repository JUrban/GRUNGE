...
thf(thm_2Ereal__topology_2ESETDIST__FRONTIER,axiom,
    ( ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
        ( ( c_2Epred__set_2EDISJOINT @ tyop_2Erealax_2Ereal @ V0s @ V1t )
       => ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2Efrontier @ V0s ) @ V1t ) )
    ...
    & ! [V2s: tyop_2Erealax_2Ereal > $o,V3t: tyop_2Erealax_2Ereal > $o] :
        ( ( c_2Epred__set_2EDISJOINT @ tyop_2Erealax_2Ereal @ V2s @ V3t )
       => ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V2s @ ( c_2Ereal__topology_2Efrontier @ V3t ) ) )
...
thf(thm_2Ereal__topology_2ESETDIST__SING__FRONTIER,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
     ...
     => ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1x @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) @ ( c_2Ereal__topology_2Efrontier @ V0s ) ) )
