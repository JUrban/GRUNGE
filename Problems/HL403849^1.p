...
thf(thm_2Ellist_2ELFINITE__rules,conjecture,(
    ! [A_27a: d] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ c_2Ellist_2ELNIL_2E0 ) ) ) )
      & ! [V0h_2E0: u,V1t_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2ELFINITE_2E1 @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ ( c_2Ellist_2ELCONS_2E2 @ ( s @ A_27a @ V0h_2E0 ) @ ( s @ ( tyop_2Ellist_2Ellist @ A_27a ) @ V1t_2E0 ) ) ) ) ) ) ) ) )).
