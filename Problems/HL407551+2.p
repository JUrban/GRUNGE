...
fof(conj_thm_2Ereal_2ENUM__FLOOR__LE2,conjecture,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Enum_2Enum)
         => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0y))
           => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V1x),ap(c_2Ereal_2ENUM__FLOOR,V0y)))
            <=> p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,V1x)),V0y)) ) ) ) ) )).
