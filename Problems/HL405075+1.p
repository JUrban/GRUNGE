...
fof(thm_2EOmega__Automata_2EEXISTS__FORALL__THM,conjecture,(
    ! [V0P_2E0] :
      ( ? [V1t1_2E0] :
        ! [V2t2_2E0] : p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Enum_2Enum,c_2Earithmetic_2E_2B_2E2(s(tyop_2Enum_2Enum,V1t1_2E0),s(tyop_2Enum_2Enum,V2t2_2E0))))))
    <=> ? [V3t1_2E0] :
        ! [V4t2_2E0] :
          ( p(s(tyop_2Emin_2Ebool,c_2Eprim__rec_2E_3C_2E2(s(tyop_2Enum_2Enum,V3t1_2E0),s(tyop_2Enum_2Enum,V4t2_2E0))))
         => p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Enum_2Enum,tyop_2Emin_2Ebool),V0P_2E0),s(tyop_2Enum_2Enum,V4t2_2E0)))) ) ) )).
