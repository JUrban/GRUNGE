...
fof(conj_thm_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO__NIL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0v] :
              ( mem(V0v,A_27a)
             => p(ap(ap(ap(ap(c_2EpatternMatches_2EIS__REDUNDANT__ROWS__INFO(A_27a,A_27a),V0v),c_2Elist_2ENIL(arr(A_27a,ty_2Eoption_2Eoption(A_27b)))),c_2Ebool_2ET),c_2Elist_2ENIL(bool))) ) ) ) )).
