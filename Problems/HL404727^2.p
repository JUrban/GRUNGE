...
thf(conj_thm_2Efinite__map_2EDOMSUB__FLOOKUP,lemma,(
...
thf(conj_thm_2Efinite__map_2EDOMSUB__FLOOKUP__NEQ,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( ( mem @ V0fm @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1k1: $i] :
          ( ( mem @ V1k1 @ A_27a )
...
thf(conj_thm_2Efinite__map_2EDOMSUB__FLOOKUP__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( ( mem @ V0fm @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
     => ! [V1k1: $i] :
          ( ( mem @ V1k1 @ A_27a )
