...
fof(lamtp_f3723,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => mem(f3723(V0m),arr(ty_2Enum_2Enum,bool)) ) )).

fof(lameq_f3723,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f3723(V0m),V1n) = ap(ap(c_2Earithmetic_2E_3E_3D,V0m),V1n) ) ) )).

fof(lamtp_f3722,axiom,(
    mem(f3722,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool))) )).

fof(lameq_f3722,axiom,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ap(f3722,V0m) = f3723(V0m) ) )).

fof(ax_thm_2Ereal__topology_2Esequentially,axiom,(
    c_2Ereal__topology_2Esequentially = ap(c_2Ereal__topology_2Emk__net(ty_2Enum_2Enum),f3722) )).

fof(conj_thm_2Ereal__topology_2ESEQUENTIALLY,conjecture,(
    ! [V0m] :
      ( mem(V0m,ty_2Enum_2Enum)
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
