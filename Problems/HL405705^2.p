...
thf(conj_thm_2Eordinal_2Emul__omega__islimit,conjecture,(
    ! [A_27a: del,V0a: $i] :
      ( ( mem @ V0a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
     => ( ( ap @ ( c_2Eordinal_2Eomax @ A_27a ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ ( ap @ ( ap @ ( c_2Eordinal_2EordMULT @ A_27a ) @ ( c_2Eordinal_2Eomega @ A_27a ) ) @ V0a ) ) )
        = ( c_2Eoption_2ENONE @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) ) ) )).
