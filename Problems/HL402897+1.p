...
fof(arityeq1_2Ec_2Elist_2EALL__DISTINCT_2E1_2EA_27b,axiom,(
...
fof(thm_2Elist_2EALL__DISTINCT__MAP__INJ,axiom,(
    ! [A_27a,A_27b,V0ls_2E0,V1f_2E0] :
      ( ( ! [V2x_2E0,V3y_2E0] :
            ( ( p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V2x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(A_27a),V0ls_2E0))))))
              & p(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V3y_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Elist_2ELIST__TO__SET_2E1(s(tyop_2Elist_2Elist(A_27a),V0ls_2E0))))))
     ...
     => p(s(tyop_2Emin_2Ebool,c_2Elist_2EALL__DISTINCT_2E1(s(tyop_2Elist_2Elist(A_27b),c_2Elist_2EMAP_2E2(s(tyop_2Emin_2Efun(A_27a,A_27b),V1f_2E0),s(tyop_2Elist_2Elist(A_27a),V0ls_2E0)))))) ) )).
...
fof(thm_2Erich__list_2Eall__distinct__count__list,conjecture,(
    ! [V0n_2E0] : p(s(tyop_2Emin_2Ebool,c_2Elist_2EALL__DISTINCT_2E1(s(tyop_2Elist_2Elist(tyop_2Enum_2Enum),c_2Erich__list_2ECOUNT__LIST_2E1(s(tyop_2Enum_2Enum,V0n_2E0)))))) )).
