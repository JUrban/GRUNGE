...
fof(mem_c_2EindexedLists_2Efindi,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2EindexedLists_2Efindi(A_27a),arr(A_27a,arr(ty_2Elist_2Elist(A_27a),ty_2Enum_2Enum))) ) )).

fof(ax_thm_2EindexedLists_2Efindi__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0x] :
            ( mem(V0x,A_27a)
           => ap(ap(c_2EindexedLists_2Efindi(A_27a),V0x),c_2Elist_2ENIL(A_27a)) = c_2Enum_2E0 )
        & ! [V1x] :
            ( mem(V1x,A_27a)
           => ! [V2h] :
                ( mem(V2h,A_27a)
               => ! [V3t] :
                   ...
                   => ap(ap(c_2EindexedLists_2Efindi(A_27a),V1x),ap(ap(c_2Elist_2ECONS(A_27a),V2h),V3t)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(A_27a),V1x),V2h)),c_2Enum_2E0),ap(ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),ap(ap(c_2EindexedLists_2Efindi(A_27a),V1x),V3t))) ) ) ) ) ) )).

fof(conj_thm_2EindexedLists_2Efindi__EL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ! [V1n] :
             ...
             => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,V1n),ap(c_2Elist_2ELENGTH(A_27a),V0l)))
               ...
               => ap(ap(c_2EindexedLists_2Efindi(A_27a),ap(ap(c_2Elist_2EEL(A_27a),V1n),V0l)),V0l) = V1n ) ) ) ) )).
