...
tff(lamtp_f209,axiom,(
    ! [A_27a: del,A_27a: del,V0a: $i] :
      ( mem(V0a,A_27a)
     => mem(f209(A_27a,A_27a,V0a),arr(A_27a,bool)) ) )).
...
tff(lameq_f209,axiom,(
    ! [A_27a: del,A_27a: del,V0a: $i] :
     ...
     => ! [V2b: $i] :
          ( mem(V2b,A_27a)
         => ap(f209(A_27a,A_27a,V0a),V2b) = ap(ap(c_2Emin_2E_3D(A_27a),V2b),V0a) ) ) )).

tff(ax_thm_2Eind__type_2EINJA,axiom,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,A_27a)
     => ap(c_2Eind__type_2EINJA(A_27a),V0a) = k(ty_2Enum_2Enum,f209(A_27a,A_27a,V0a)) ) )).

tff(conj_thm_2Eind__type_2EINJA__INJ,conjecture,(
    ! [A_27a: del,V0a1: $i] :
      ( mem(V0a1,A_27a)
     => ! [V1a2: $i] :
          ( mem(V1a2,A_27a)
