...
tff(lmtp_f4016,type,(
    f4016: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4016,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal] : mem(f4016(V0x,V2c),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f4016,axiom,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V2c: tp__ty_2Erealax_2Ereal,V4n: tp__ty_2Enum_2Enum] : ap(f4016(V0x,V2c),inj__ty_2Enum_2Enum(V4n)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),ap(V0x,inj__ty_2Enum_2Enum(V4n))) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__CMUL,lemma,(
    ! [V0x: $i] :
      ( mem(V0x,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1x0: tp__ty_2Erealax_2Ereal,V2c: tp__ty_2Erealax_2Ereal,V3s: $i] :
          ( mem(V3s,arr(ty_2Enum_2Enum,bool))
         => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0x),inj__ty_2Erealax_2Ereal(V1x0)),V3s))
           => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4016(V0x,V2c)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),inj__ty_2Erealax_2Ereal(V1x0))),V3s)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EINFSUM__CMUL,conjecture,(
    ! [V0s: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__topology_2Einfsum,V0s),f4026(V1x,V2c))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V2c)),ap(ap(c_2Ereal__topology_2Einfsum,V0s),V1x))) ) ) ) )).
