...
thf(thm_2Ewords_2ETWO__COMP__NEG,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Efcp_2Ecart @ $o @ A_27a] :
     ...
     => ( c_2Ebool_2ECOND @ $o @ ( c_2Ebool_2E_5C_2F @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ c_2Enum_2E0 ) @ ( c_2Emin_2E_3D @ ( tyop_2Efcp_2Ecart @ $o @ A_27a ) @ V0a @ ( c_2Ewords_2Eword__L @ A_27a ) ) ) @ ( c_2Ewords_2Eword__msb @ A_27a @ ( c_2Ewords_2Eword__2comp @ A_27a @ V0a ) ) @ ( c_2Ebool_2E_7E @ ( c_2Ewords_2Eword__msb @ A_27a @ ( c_2Ewords_2Eword__2comp @ A_27a @ V0a ) ) ) ) ) )).
...
thf(thm_2Ewords_2Eword__abs__neg,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ewords_2Eword__abs @ A_27a @ ( c_2Ewords_2Eword__2comp @ A_27a @ V0w ) )
      = ( c_2Ewords_2Eword__abs @ A_27a @ V0w ) ) )).
