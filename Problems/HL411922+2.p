...
fof(conj_thm_2Ereal__topology_2EURYSOHN__LOCAL,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EURYSOHN,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
             ...
             => ! [V3b] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2EClosed,V0s))
                   ...
                   => ? [V4f] :
                        ...
                        & ! [V7x] :
                            ( mem(V7x,ty_2Erealax_2Ereal)
                           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),V1t))
                             => ap(V4f,V7x) = V3b ) ) ) ) ) ) ) ) )).
