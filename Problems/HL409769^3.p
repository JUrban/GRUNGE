...
thf(thm_2Eiterate_2ENSUM__SING,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Enum_2Enum,V1x: A_27a] :
      ( ( c_2Eiterate_2Ensum @ A_27a @ ( c_2Epred__set_2EINSERT @ A_27a @ V1x @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) @ V0f )
      = ( V0f @ V1x ) ) )).

thf(thm_2Eiterate_2ENSUM__SING__NUMSEG,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eiterate_2Ensum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V1n @ V1n ) @ V0f )
      = ( V0f @ V1n ) ) )).
