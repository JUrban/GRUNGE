...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__DIST,conjecture,(
        ...
        @ ( ap
          @ ( ap @ c_2Ereal__topology_2Econtinuous__on
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2x: $i] :
                  ( ap @ c_2Ereal__topology_2EDist @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) @ V2x ) ) ) )
          @ V1s ) ) ) )).
