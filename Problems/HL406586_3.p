...
tff(thm_2Esptree_2Ewf__def,axiom,(
    ! [A_27a: $tType] :
      ( c_2Esptree_2Ewf_2E1(A_27a,c_2Esptree_2ELN_2E0(A_27a)) = c_2Ebool_2ET_2E0
      & ! [V0a_2E0: A_27a] : c_2Esptree_2Ewf_2E1(A_27a,c_2Esptree_2ELS_2E1(A_27a,V0a_2E0)) = c_2Ebool_2ET_2E0
      & ! [V1t1_2E0: tyop_2Esptree_2Espt(A_27a),V2t2_2E0: tyop_2Esptree_2Espt(A_27a)] :
          ( p(c_2Esptree_2Ewf_2E1(A_27a,c_2Esptree_2EBN_2E2(A_27a,V1t1_2E0,V2t2_2E0)))
        <=> ( p(c_2Esptree_2Ewf_2E1(A_27a,V1t1_2E0))
            & p(c_2Esptree_2Ewf_2E1(A_27a,V2t2_2E0))
            & ~ ( V1t1_2E0 = c_2Esptree_2ELN_2E0(A_27a)
                & V2t2_2E0 = c_2Esptree_2ELN_2E0(A_27a) ) ) )
      & ! [V3t1_2E0: tyop_2Esptree_2Espt(A_27a),V4a_2E0: A_27a,V5t2_2E0: tyop_2Esptree_2Espt(A_27a)] :
          ( p(c_2Esptree_2Ewf_2E1(A_27a,c_2Esptree_2EBS_2E3(A_27a,V3t1_2E0,V4a_2E0,V5t2_2E0)))
        <=> ( p(c_2Esptree_2Ewf_2E1(A_27a,V3t1_2E0))
            & p(c_2Esptree_2Ewf_2E1(A_27a,V5t2_2E0))
            & ~ ( V3t1_2E0 = c_2Esptree_2ELN_2E0(A_27a)
                & V5t2_2E0 = c_2Esptree_2ELN_2E0(A_27a) ) ) ) ) )).

tff(thm_2Esptree_2Ewf__insert,axiom,(
    ! [A_27a: $tType,V0k_2E0: tyop_2Enum_2Enum,V1a_2E0: A_27a,V2t_2E0: tyop_2Esptree_2Espt(A_27a)] :
      ( p(c_2Esptree_2Ewf_2E1(A_27a,V2t_2E0))
     => p(c_2Esptree_2Ewf_2E1(A_27a,c_2Esptree_2Einsert_2E3(A_27a,V0k_2E0,V1a_2E0,V2t_2E0))) ) )).
