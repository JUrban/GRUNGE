...
fof(conj_thm_2Ebit_2EBITS__ZERO5,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1m] :
          ( mem(V1m,ty_2Enum_2Enum)
...
fof(conj_thm_2Ebit_2EBIT__IMP__GE__TWOEXP,lemma,(
    ! [V0i] :
...
fof(conj_thm_2Ewords_2ELOG2__w2n,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ( V0w != ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)
           => ap(c_2Ebit_2ELOG2,ap(c_2Ewords_2Ew2n(A_27a),V0w)) = ap(ap(c_2Earithmetic_2E_2D,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Ewhile_2ELEAST,f2184(A_27a,V0w))) ) ) ) )).
