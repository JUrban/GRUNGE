...
fof(lameq_f3003,axiom,(
    ! [V0g] :
     ...
     => ! [V3x] :
         ...
         => ap(f3003(V0g),V3x) = ap(c_2Etransc_2Eln,ap(V0g,V3x)) ) ) )).

fof(conj_thm_2Etransc_2EDIFF__LN__COMPOSITE,conjecture,(
    ! [V0g] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1m] :
         ...
         => ! [V2x] :
             ...
             => ( ( p(ap(ap(ap(c_2Elim_2Ediffl,V0g),V1m),V2x))
               ...
               => p(ap(ap(ap(c_2Elim_2Ediffl,f3003(V0g)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,ap(V0g,V2x))),V1m)),V2x)) ) ) ) ) )).
