...
thf(thm_2EquantHeuristics_2EFST__PAIR__EQ,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0p: tyop_2Epair_2Eprod @ A_27a @ A_27b,V1p2: A_27b] :
      ( ( ( c_2Epair_2E_2C @ A_27a @ A_27b @ ( c_2Epair_2EFST @ A_27a @ A_27b @ V0p ) @ V1p2 )
        = V0p )
    <=> ( V1p2
