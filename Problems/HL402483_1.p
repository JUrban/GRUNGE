...
tff(thm_2EquantHeuristics_2EGUESS__RULES__ONE__CASE______EXISTS__GAP,conjecture,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1Q_2E0: u] :
     ...
     => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2EquantHeuristics_2EGUESS__EXISTS__GAP_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V1Q_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V0P_2E0))))) ) )).
