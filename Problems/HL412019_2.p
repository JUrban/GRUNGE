...
tff(lmtp_f3471,type,(
    f3471: tp__ty_2Eextreal_2Eextreal > $i )).

tff(lamtp_f3471,axiom,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] : mem(f3471(V0x),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f3471,axiom,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1n: tp__ty_2Enum_2Enum] : ap(f3471(V0x),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),inj__ty_2Eextreal_2Eextreal(V0x)),ap(c_2Eextreal_2Eextreal__of__num,inj__ty_2Enum_2Enum(V1n))) )).

tff(lmtp_f3470,type,(
    f3470: $i )).

tff(lamtp_f3470,axiom,(
    mem(f3470,arr(ty_2Eextreal_2Eextreal,bool)) )).

tff(lameq_f3470,axiom,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal] : ap(f3470,inj__ty_2Eextreal_2Eextreal(V0x)) = ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f3471(V0x)) )).

tff(conj_thm_2Eextreal_2Esup__num,lemma,(
    surj__ty_2Eextreal_2Eextreal(ap(c_2Eextreal_2Eextreal__sup,f3470)) = fo__c_2Eextreal_2EPosInf )).
...
tff(conj_thm_2Elebesgue_2Elebesgue__monotone__convergence__subset,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__infty,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
