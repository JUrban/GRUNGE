...
tff(thm_2Eordinal_2EordSUC__ZERO,axiom,(
    ! [A_27a: d,V0a_2E0: u] : s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordSUC_2E1(s(tyop_2Eordinal_2Eordinal(A_27a),V0a_2E0))) != s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)))) )).
...
tff(thm_2Eordinal_2Esup__EQ__0,axiom,(
    ! [A_27a: d,V0s_2E0: u] :
     ...
     => ( s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Esup_2E1(s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0))))
      <=> ( s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0) = s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
          | s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),V0s_2E0) = s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EINSERT_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)))),s(tyop_2Emin_2Efun(tyop_2Eordinal_2Eordinal(A_27a),tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0))) ) ) ) )).

tff(thm_2Eordinal_2EordADD__EQ__0,axiom,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u] :
      ( s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordADD_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V1x_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V0y_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0))))
    <=> ( s(tyop_2Eordinal_2Eordinal(A_27a),V1x_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0))))
        & s(tyop_2Eordinal_2Eordinal(A_27a),V0y_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)))) ) ) )).

tff(thm_2Eordinal_2EIMAGE__EQ__SING,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1s_2E0: u,V2f_2E0: u] :
      ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EIMAGE_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V2f_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EINSERT_2E2(s(A_27a,V0x_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)))
    <=> ( ? [V3y_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27b,V3y_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0)))))
        & ! [V4y_2E0: u] :
            ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27b,V4y_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0)))))
           => s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V2f_2E0),s(A_27b,V4y_2E0))) = s(A_27a,V0x_2E0) ) ) ) )).
...
tff(thm_2Eordinal_2EordMULT__EQ__0,conjecture,(
    ! [A_27a: d,V0x_2E0: u,V1y_2E0: u] :
      ( s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordMULT_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V0x_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V1y_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0))))
    <=> ( s(tyop_2Eordinal_2Eordinal(A_27a),V0x_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0))))
        | s(tyop_2Eordinal_2Eordinal(A_27a),V1y_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,i_mono_2Etyop_2Enum_2Enum(mono_2Ec_2Enum_2E0_2E0)))) ) ) )).
