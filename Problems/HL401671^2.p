...
thf(conj_thm_2Earithmetic_2Etransitive__monotone,lemma,(
    ! [A_27a: del,V0R: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) )
              & ! [V2n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ V0R @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( ap @ V1f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) )
    ...
    ! [A_27a: del,V0R: $i] :
     ...
     => ( ( p @ ( ap @ ( c_2Eprim__rec_2Ewellfounded @ A_27a ) @ V0R ) )
      <=> ~ ? [V1f: $i] :
              ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ A_27a ) )
              & ! [V2n: tp__ty_2Enum_2Enum] :
                  ( p @ ( ap @ ( ap @ V0R @ ( ap @ V1f @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( ap @ V1f @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) ) )).

thf(conj_thm_2Eprim__rec_2EWF__IFF__WELLFOUNDED,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Erelation_2EWF__noloops,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Erelation_2Etransitive__inv,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ ( ap @ ( c_2Erelation_2Einv @ A_27a @ A_27a ) @ V0R ) ) )
      <=> ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V0R ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EFINITE__WF__noloops,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
