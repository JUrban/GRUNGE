...
thf(conj_thm_2Etransc_2EFTC1,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1f_27: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRATION__BY__PARTS,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
          ( ( mem @ V1g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ! [V2f_27: $i] :
             ...
             => ! [V3g_27: $i] :
                 ...
                 => ! [V4a: tp__ty_2Erealax_2Ereal,V5b: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( p
                        @ ( ap
                          @ ( ap @ ( ap @ c_2Etransc_2EDint @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) )
                            @ ( lam @ ty_2Erealax_2Ereal
                              @ ^ [V8x: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V2f_27 @ V8x ) ) @ ( ap @ V1g @ V8x ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V8x ) ) @ ( ap @ V3g_27 @ V8x ) ) ) ) )
                          @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V5b ) ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V4a ) ) ) ) ) ) ) ) ) ) ) )).
