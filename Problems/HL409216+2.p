...
fof(conj_thm_2Eintegral_2EDSIZE__EQ,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Eintegral_2EDINT__CONST,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ! [V2c] :
             ...
             => p(ap(ap(ap(c_2Etransc_2EDint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),k(ty_2Erealax_2Ereal,V2c)),ap(ap(c_2Erealax_2Ereal__mul,V2c),ap(ap(c_2Ereal_2Ereal__sub,V1b),V0a)))) ) ) ) )).
