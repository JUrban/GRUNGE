...
thf(conj_thm_2Erich__list_2EBUTLASTN__APPEND1,conjecture,(
    ! [A_27a: del,V0l2: $i] :
     ...
     => ! [V1n: tp__ty_2Enum_2Enum] :
         ...
         => ! [V2l1: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l1 ) @ V0l2 ) )
                = ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l2 ) ) ) @ V2l1 ) ) ) ) ) )).
