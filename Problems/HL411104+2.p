...
fof(conj_thm_2Ereal__topology_2ECLOSED__BIGUNION,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__BIGUNION,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__BIGUNION,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),V0s))
          & ! [V1t] :
