...
tff(conj_thm_2Ellist_2ELTL__LAPPEND,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
tff(lamtp_f1249,axiom,(
    ! [A_27a: del,A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => mem(f1249(A_27a,A_27a,V0l),arr(ty_2Ellist_2Ellist(A_27a),ty_2Ellist_2Ellist(A_27a))) ) )).
...
tff(lameq_f1249,axiom,(
    ! [A_27a: del,A_27a: del,V0l: $i] :
     ...
     => ! [V1t: $i] :
          ( mem(V1t,ty_2Ellist_2Ellist(A_27a))
         => ap(f1249(A_27a,A_27a,V0l),V1t) = ap(ap(c_2Ellist_2ELAPPEND(A_27a),V1t),ap(c_2Ellist_2ELREPEAT(A_27a),V0l)) ) ) )).

tff(conj_thm_2Ellist_2ELTL__LREPEAT,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ap(c_2Ellist_2ELTL(A_27a),ap(c_2Ellist_2ELREPEAT(A_27a),V0l)) = ap(ap(c_2Eoption_2EOPTION__MAP(ty_2Ellist_2Ellist(A_27a),ty_2Ellist_2Ellist(A_27a)),f1249(A_27a,A_27a,V0l)),ap(c_2Ellist_2ELTL(A_27a),ap(c_2Ellist_2EfromList(A_27a),V0l))) ) )).
