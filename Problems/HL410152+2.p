...
fof(conj_thm_2Emeasure_2ECARATHEODORY__LEMMA,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0gsig] :
...
fof(conj_thm_2Emeasure_2EINF__MEASURE__AGREES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EINF__MEASURE__OUTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ESIGMA__SUBSET,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Emeasure_2EALGEBRA__SUBSET__LAMBDA__SYSTEM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ECARATHEODORY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m0] :
          ( mem(V0m0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
           ...
           => ? [V1m] :
                ...
                & ! [V2s] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2s),ap(c_2Emeasure_2Emeasurable__sets(A_27a),V0m0)))
                     => ap(ap(c_2Emeasure_2Emeasure(A_27a),V1m),V2s) = ap(ap(c_2Emeasure_2Emeasure(A_27a),V0m0),V2s) ) )
