...
fof(mem_c_2ECoder_2Ebool__coder,axiom,(
    mem(c_2ECoder_2Ebool__coder,arr(arr(bool,bool),ty_2Epair_2Eprod(arr(bool,bool),arr(bool,bool)))) )).
...
fof(ax_thm_2ECoder_2Ebool__coder__def,axiom,(
    ! [V0p] :
      ( mem(V0p,arr(bool,bool))
     => ap(c_2ECoder_2Ebool__coder,V0p) = ap(ap(c_2Epair_2E_2C(arr(bool,bool),arr(bool,bool)),V0p),ap(ap(c_2Epair_2E_2C(arr(bool,ty_2Elist_2Elist(bool)),arr(bool,ty_2Elist_2Elist(bool))),c_2EEncode_2Eencode__bool),ap(c_2EDecode_2Edecode__bool,V0p))) ) )).

fof(conj_thm_2ECoder_2Ewf__coder__bool,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(bool,bool))
