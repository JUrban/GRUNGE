...
fof(conj_thm_2Ereal__topology_2ECOMPACT__TRANSLATION,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
         => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
           => p(ap(c_2Ereal__topology_2Ecompact,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3657(V1a)),V0s))) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECOMPACT__TRANSLATION__EQ,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1s] :
