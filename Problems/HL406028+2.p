...
fof(lamtp_f2242,axiom,(
    ! [A_27a,V1a] :
      ( mem(V1a,ty_2Enum_2Enum)
     => mem(f2242(A_27a,V1a),arr(ty_2Enum_2Enum,ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(conj_thm_2Ewords_2Eword__ror__n2w,conjecture,(
    ! [A_27a] :
     ...
     => ! [V0n] :
         ...
         => ! [V1a] :
              ( mem(V1a,ty_2Enum_2Enum)
             => ap(ap(c_2Ewords_2Eword__ror(A_27a),ap(c_2Ewords_2En2w(A_27a),V1a)),V0n) = ap(ap(c_2Ebool_2ELET(ty_2Enum_2Enum,ty_2Enum_2Enum),f2242(A_27a,V1a)),ap(ap(c_2Earithmetic_2EMOD,V0n),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) ) )).
