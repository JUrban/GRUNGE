...
tff(conj_thm_2EEncode_2Ewf__encode__option,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(mem_c_2EDecode_2Edecode__option,axiom,(
    ! [A_27a: del] : mem(c_2EDecode_2Edecode__option(A_27a),arr(arr(ty_2Eoption_2Eoption(A_27a),bool),arr(arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))),arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(ty_2Eoption_2Eoption(A_27a),ty_2Eoption_2Eoption(A_27a))))))) )).
...
tff(conj_thm_2EDecode_2Ewf__decode__option,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1d: $i] :
          ( mem(V1d,arr(ty_2Elist_2Elist(bool),ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27a,A_27a))))
