...
tff(f9993_0_2E0,type,(
    f9993_0_2E0: tyop_2Emin_2Efun(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool) )).

tff(f9993_0_2E1,type,(
    f9993_0_2E1: tyop_2Emin_2Ebool > tyop_2Emin_2Ebool )).
...
tff(arityeq1_2Ef9993_0_2E1,axiom,(
    ! [X0_2E0: tyop_2Emin_2Ebool] : f9993_0_2E1(X0_2E0) = app_2E2(tyop_2Emin_2Ebool,tyop_2Emin_2Ebool,f9993_0_2E0,X0_2E0) )).
...
tff(def0_2Ethm_2EHolSmt_2Ed025,axiom,(
    ! [V1q_2E0: tyop_2Emin_2Ebool] :
      ( p(f9993_0_2E1(V1q_2E0))
    <=> ~ p(V1q_2E0) ) )).

tff(thm_2EHolSmt_2Ed025,conjecture,(
    ! [V0r_2E0: tyop_2Emin_2Ebool,V1q_2E0: tyop_2Emin_2Ebool,V2p_2E0: tyop_2Emin_2Ebool] :
      ( p(c_2Ebool_2ECOND_2E3(tyop_2Emin_2Ebool,V2p_2E0,f9993_0_2E1(V1q_2E0),V0r_2E0))
      | ~ p(V2p_2E0)
      | p(V1q_2E0) ) )).
