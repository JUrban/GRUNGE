...
fof(conj_thm_2EindexedLists_2EMAPi__ACC__MAPi,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2EindexedLists_2EMAPi__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1l] :
                 ...
                 => ap(ap(c_2EindexedLists_2EMAPi(A_27a,A_27a),V0f),V1l) = ap(ap(ap(ap(c_2EindexedLists_2EMAPi__ACC(A_27a,A_27a),V0f),c_2Enum_2E0),c_2Elist_2ENIL(A_27a)),V1l) ) ) ) ) )).
