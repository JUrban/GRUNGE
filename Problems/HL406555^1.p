...
thf(f7522_0_2E0,type,(
    f7522_0_2E0: u )).

thf(f7522_0_2E1,type,(
    f7522_0_2E1: du > u )).
...
thf(mono_2Ef7522_0,type,(
    mono_2Ef7522_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq2_2Emono_2Ec_2Ealignment_2Ealign_2E2_2Emono_2EA_27a,axiom,(
...
thf(arityeq2_2Emono_2Ec_2Ealignment_2Ealigned_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
...
thf(arityeq3_2Emono_2Ec_2Ewords_2Eword__extract_2E3_2Emono_2EA_27b_20mono_2EA_27b,axiom,(
    ! [A_27b: d,X0: mono_2Etyop_2Enum_2Enum,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) ) ) ) @ c_2Ewords_2Eword__extract_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ X2_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ealignment_2Ealign__sub,axiom,(
...
thf(thm_2Ewords_2EWORD__EXTRACT__OVER__ADD2,axiom,(
    ! [A_27a: d,A_27b: d,V0a_2E0: u,V1b_2E0: u,V2h: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2h @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Efcp_2Edimindex_2E1 @ ( s @ ( tyop_2Ebool_2Eitself @ A_27a ) @ c_2Ebool_2Ethe__value_2E0 ) ) ) ) )
     => ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2h ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__add_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2h ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2h ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) ) ) ) ) )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27b ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2h ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__add_2E2 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0a_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V1b_2E0 ) ) ) ) ) ) ) )).

thf(thm_2Ewords_2EWORD__EXTRACT__ID,axiom,(
    ! [A_27a: d,V0w_2E0: u,V1h: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Ewords_2Ew2n_2E1 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) ) @ ( mono_2Ec_2Earithmetic_2EEXP @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ ( mono_2Ec_2Enum_2ESUC @ V1h ) ) )
     => ( ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ ( c_2Ewords_2Eword__extract_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1h ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) )
        = ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ A_27a ) @ V0w_2E0 ) ) ) )).
...
thf(thm_2Ealignment_2Ealign__add__aligned,conjecture,(
