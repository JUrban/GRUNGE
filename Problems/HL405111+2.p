...
fof(conj_thm_2Equotient__pred__set_2ESET__REL__MP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                       ...
                       => ! [V3s] :
                           ...
                           => ! [V4t] :
                               ...
                               => ! [V5x] :
                                   ...
                                   => ! [V6y] :
                                        ( mem(V6y,A_27a)
                                       => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),V3s),V4t))
                                            & p(ap(ap(V0R,V5x),V6y)) )
                                         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V5x),V3s))
                                          <=> p(ap(ap(c_2Ebool_2EIN(A_27a),V6y),V4t)) ) ) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Equotient__pred__set_2EINTER__RSP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                               ...
                               => ! [V5t1] :
                                   ...
                                   => ! [V6t2] :
                                       ...
                                       => ( ( p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),V3s1),V4s2))
                                         ...
                                         => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),ap(ap(c_2Epred__set_2EINTER(A_27a),V3s1),V5t1)),ap(ap(c_2Epred__set_2EINTER(A_27a),V4s2),V6t2))) ) ) ) ) ) ) ) ) ) ) ) )).
