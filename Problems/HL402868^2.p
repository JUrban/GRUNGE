...
thf(conj_thm_2Erich__list_2EEL__LENGTH__APPEND,lemma,(
    ! [A_27a: del,V0l2: $i] :
      ( ( mem @ V0l2 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ~ ( p @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l2 ) )
           => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l1 ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V1l1 ) @ V0l2 ) )
              = ( ap @ ( c_2Elist_2EHD @ A_27a ) @ V0l2 ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2EEL__LENGTH__APPEND__rwt,conjecture,(
    ! [A_27a: del,V0l2: $i] :
      ( ( mem @ V0l2 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum,V2l1: $i] :
         ...
         => ( ( ~ ( p @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l2 ) )
           ...
           => ( ( ap @ ( ap @ ( c_2Elist_2EEL @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l1 ) @ V0l2 ) )
              = ( ap @ ( c_2Elist_2EHD @ A_27a ) @ V0l2 ) ) ) ) ) )).
