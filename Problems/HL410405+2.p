...
fof(conj_thm_2Ereal__topology_2EBILINEAR__LADD,lemma,(
    ! [V0h] :
...
fof(conj_thm_2Ereal__topology_2EBILINEAR__LNEG,lemma,(
    ! [V0h] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EBILINEAR__LSUB,conjecture,(
    ! [V0h] :
      ( mem(V0h,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
