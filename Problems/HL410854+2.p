...
fof(conj_thm_2Ereal__topology_2EREAL__CHOOSE__SIZE,lemma,(
    ! [V0c] :
...
fof(conj_thm_2Ereal__topology_2EAT__INFINITY,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ETRIVIAL__LIMIT__AT__INFINITY,lemma,(
...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__AT__INFINITY,conjecture,(
    ! [V0p] :
