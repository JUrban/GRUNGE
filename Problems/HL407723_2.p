...
tff(conj_thm_2Emetric_2EMETRIC__NZ,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Emetric_2Emetric(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(ax_thm_2Enets_2Etendsto,axiom,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Emetric_2Emetric(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ! [V2y: $i] :
             ...
             => ! [V3z: $i] :
                  ( mem(V3z,A_27a)
                 => ( p(ap(ap(ap(c_2Enets_2Etendsto(A_27a),ap(ap(c_2Epair_2E_2C(ty_2Emetric_2Emetric(A_27a),ty_2Emetric_2Emetric(A_27a)),V0m),V1x)),V2y),V3z))
                  <=> ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Emetric_2Edist(A_27a),V0m),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y))))
...
tff(conj_thm_2Enets_2ELIM__TENDS,conjecture,(
