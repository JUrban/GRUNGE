...
thf(conj_thm_2EPast__Temporal__Logic_2EMORE__EVENT,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Enum_2Enum @ bool ) )
            ...
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPWHEN
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V8t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V8t ) ) @ ( ap @ V1b @ V8t ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPUNTIL
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V9t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V9t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V9t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPBEFORE
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V10t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V10t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V10t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPSWHEN
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V11t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V11t ) ) @ ( ap @ V1b @ V11t ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPSUNTIL
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V12t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V12t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V12t ) ) ) ) )
                @ V1b ) )
            & ( ( ap @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE @ V0a ) @ V1b )
              = ( ap
                @ ( ap @ c_2EPast__Temporal__Logic_2EPSBEFORE
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V13t: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V0a @ V13t ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1b @ V13t ) ) ) ) )
                @ V1b ) ) ) ) ) )).
