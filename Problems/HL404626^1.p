...
thf(thm_2Efinite__map_2ENOT__EQ__FAPPLY,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1a_2E0: u,V2x_2E0: u,V3y_2E0: u] :
      ( ( (~)
        @ ( ( s @ A_27a @ V1a_2E0 )
          = ( s @ A_27a @ V2x_2E0 ) ) )
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27b @ V3y_2E0 ) ) ) ) ) @ ( s @ A_27a @ V1a_2E0 ) ) )
        = ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f_2E0 ) @ ( s @ A_27a @ V1a_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFAPPLY__FUPDATE__THM,conjecture,(
