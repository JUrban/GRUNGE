...
fof(conj_thm_2Ereal__topology_2ESPAN__SUBSET__SUBSPACE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ESUBSPACE__SUMS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(lamtp_f3659,axiom,(
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => mem(f3659(V1t,V0s,V2x),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).
    ...
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
             ...
             => ! [V3y] :
                  ( mem(V3y,ty_2Erealax_2Ereal)
                 => ap(f3659(V1t,V0s,V2x),V3y) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,V2x),V3y)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),ap(c_2Ereal__topology_2Espan,V0s))),ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),ap(c_2Ereal__topology_2Espan,V1t)))) ) ) ) ) )).

fof(lamtp_f3658,axiom,(
    ! [V1t] :
      ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(lameq_f3658,axiom,(
    ! [V1t] :
     ...
     => ! [V0s] :
         ...
         => ! [V2x] :
              ( mem(V2x,ty_2Erealax_2Ereal)
             => ap(f3658(V1t,V0s),V2x) = f3659(V1t,V0s,V2x) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ESPAN__UNION,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
