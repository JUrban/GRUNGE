...
fof(lameq_f929,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V3t] :
              ( mem(V3t,ty_2Enum_2Enum)
             => ap(f929(V0a,V1b),V3t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V3t))),ap(V1b,V3t)) ) ) ) )).

fof(lamtp_f928,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f928,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f928(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,V1b),f929(V0a,V1b)),V2t0)),ap(ap(c_2ETemporal__Logic_2EALWAYS,f881(V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EWHEN__AS__SBEFORE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
