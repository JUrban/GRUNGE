...
tff(lmtp_f2140,type,(
    f2140: tp__ty_2Einteger_2Eint > $i )).

tff(lamtp_f2140,axiom,(
    ! [V0i: tp__ty_2Einteger_2Eint] : mem(f2140(V0i),arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f2140,axiom,(
    ! [V0i: tp__ty_2Einteger_2Eint,V1n: tp__ty_2Enum_2Enum] : ap(f2140(V0i),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Emin_2E_3D(ty_2Einteger_2Eint),inj__ty_2Einteger_2Eint(V0i)),ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(V1n))) )).

tff(conj_thm_2Einteger_2ENUM__POSINT,lemma,(
    ! [V0i: tp__ty_2Einteger_2Eint] :
     ...
     => p(ap(c_2Ebool_2E_3F_21(ty_2Enum_2Enum),f2140(V0i))) ) )).

tff(conj_thm_2Einteger_2ENUM__POSINT__EXISTS,conjecture,(
    ! [V0i: tp__ty_2Einteger_2Eint] :
      ( p(ap(ap(c_2Einteger_2Eint__le,ap(c_2Einteger_2Eint__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Einteger_2Eint(V0i)))
