...
thf(thm_2Einteger_2EINT__LT__NZ,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( (~)
        @ ( ( mono_2Ec_2Einteger_2Eint__of__num @ V0n )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
    <=> ( mono_2Ec_2Einteger_2Eint__lt @ ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) ) ) )).
