...
thf(thm_2Ewellorder_2Eorderiso__def,axiom,(
    ...
    <=> ? [V2f: A_27a > A_27b] :
          ( ! [V3x: A_27a] :
              ( ( c_2Ebool_2EIN @ A_27a @ V3x @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w1 ) )
             => ( c_2Ebool_2EIN @ A_27b @ ( V2f @ V3x ) @ ( c_2Ewellorder_2EelsOf @ A_27b @ V1w2 ) ) )
          & ! [V4x1: A_27a,V5x2: A_27a] :
              ( ( ( c_2Ebool_2EIN @ A_27a @ V4x1 @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w1 ) )
                & ( c_2Ebool_2EIN @ A_27a @ V5x2 @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w1 ) ) )
             => ( ( ( V2f @ V4x1 )
                  = ( V2f @ V5x2 ) )
              <=> ( V4x1 = V5x2 ) ) )
          & ! [V6y: A_27b] :
              ( ( c_2Ebool_2EIN @ A_27b @ V6y @ ( c_2Ewellorder_2EelsOf @ A_27b @ V1w2 ) )
             => ? [V7x: A_27a] :
                  ( ( c_2Ebool_2EIN @ A_27a @ V7x @ ( c_2Ewellorder_2EelsOf @ A_27a @ V0w1 ) )
                  & ( ( V2f @ V7x )
                    = V6y ) ) )
          & ! [V8x: A_27a,V9y: A_27a] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V8x @ V9y ) @ ( c_2Eset__relation_2Estrict @ A_27a @ ( c_2Ewellorder_2Ewellorder__REP @ A_27a @ V0w1 ) ) )
             => ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27b @ A_27b ) @ ( c_2Epair_2E_2C @ A_27b @ A_27b @ ( V2f @ V8x ) @ ( V2f @ V9y ) ) @ ( c_2Eset__relation_2Estrict @ A_27b @ ( c_2Ewellorder_2Ewellorder__REP @ A_27b @ V1w2 ) ) ) ) ) ) )).

thf(thm_2Ewellorder_2Eorderiso__TRANS,conjecture,(
