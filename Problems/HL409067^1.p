...
thf(thm_2Ecomplex_2ECONJ__REAL__REFL,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ecomplex_2Econj @ ( mono_2Ec_2Ecomplex_2Ecomplex__of__real @ V0x ) )
      = ( mono_2Ec_2Ecomplex_2Ecomplex__of__real @ V0x ) ) )).

thf(thm_2Ecomplex_2ECONJ__NUM__REFL,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ecomplex_2Econj @ ( mono_2Ec_2Ecomplex_2Ecomplex__of__num @ V0n ) )
      = ( mono_2Ec_2Ecomplex_2Ecomplex__of__num @ V0n ) ) )).
