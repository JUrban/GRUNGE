...
fof(conj_thm_2EordNotationSemantics_2Eadd__nat1__disappears,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Eordinal_2Eordinal(A_27a))
         => ! [V1n] :
             ...
             => ( ~ p(ap(ap(c_2Eordinal_2Eordlt(A_27a),V0a),c_2Eordinal_2Eomega(A_27a)))
               => ap(ap(c_2Eordinal_2EordADD(A_27a),ap(c_2Eordinal_2EfromNat(A_27a),V1n)),V0a) = V0a ) ) ) ) )).

fof(conj_thm_2EordNotationSemantics_2Eadd__nat1__disappears__kexp,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0e] :
