...
thf(conj_thm_2Eextreal_2Esup__num,lemma,
      ...
      @ ( ap @ c_2Eextreal_2Eextreal__sup
        @ ( lam @ ty_2Eextreal_2Eextreal
          @ ^ [V0x: $i] :
              ...
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V1n: $i] :
                    ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Eextreal_2Eextreal ) @ V0x ) @ ( ap @ c_2Eextreal_2Eextreal__of__num @ V1n ) ) ) ) ) ) )
    = fo__c_2Eextreal_2EPosInf )).
...
thf(conj_thm_2Elebesgue_2Elebesgue__monotone__convergence__subset,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
                      ...
                      & ! [V10x: $i] :
                         ...
                         => ( p
                            @ ( ap @ c_2Eextreal_2Eext__mono__increasing
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V11i: $i] :
                                    ( ap @ ( ap @ V2fi @ V11i ) @ V10x ) ) ) ) )
                      & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V3A ) @ ( ap @ ( c_2Emeasure_2Emeasurable__sets @ A_27a ) @ V0m ) ) ) )
                   => ( ( surj__ty_2Eextreal_2Eextreal
                        @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m )
                          @ ( lam @ A_27a
                            @ ^ [V12x: $i] :
                                ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ V1f @ V12x ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ V3A ) @ V12x ) ) ) ) )
                      = ( surj__ty_2Eextreal_2Eextreal
                        @ ( ap @ c_2Eextreal_2Eextreal__sup
                          @ ( ap
                            @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal )
                              @ ( lam @ ty_2Enum_2Enum
                                @ ^ [V13i: $i] :
                                    ...
                                    @ ( lam @ A_27a
                                      @ ^ [V14x: $i] :
                                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ ( ap @ V2fi @ V13i ) @ V14x ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ V3A ) @ V14x ) ) ) ) ) )
                            @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Epos__fn__integral__cmul__infty,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ( ( ( p @ ( ap @ ( c_2Emeasure_2Emeasure__space @ A_27a ) @ V0m ) )
           ...
           => ( ( surj__ty_2Eextreal_2Eextreal
                @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( inj__ty_2Eextreal_2Eextreal @ fo__c_2Eextreal_2EPosInf ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ V1s ) @ V2x ) ) ) ) )
              = ( surj__ty_2Eextreal_2Eextreal @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( inj__ty_2Eextreal_2Eextreal @ fo__c_2Eextreal_2EPosInf ) ) @ ( ap @ c_2Eextreal_2ENormal @ ( ap @ ( ap @ ( c_2Emeasure_2Emeasure @ A_27a ) @ V0m ) @ V1s ) ) ) ) ) ) ) ) )).
