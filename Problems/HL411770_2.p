...
tff(conj_thm_2Ereal__topology_2ESUMS__FINITE__UNION,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUMS__OFFSET__REV,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
         ...
         => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V1l)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V3n)),ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V2m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),V0f))),ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V3n)))) ) ) )).
