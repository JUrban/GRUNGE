...
thf(f3667_0_2E0,type,(
    f3667_0_2E0: u )).

thf(f3667_0_2E2,type,(
    f3667_0_2E2: du > du > u )).

thf(f3667_0_2E3,type,(
...
thf(mono_2Ef3667_0,type,(
    mono_2Ef3667_0: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESUNTIL__AS__WHEN,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3667_0 @ V1a @ V0b @ V3t )
    <=> ( ( V1a @ V3t )
       => ( V0b @ V3t ) ) ) )).

thf(thm_2ETemporal__Logic_2ESUNTIL__AS__WHEN,conjecture,(
    ...
    <=> ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ V0b @ ( mono_2Ef3667_0 @ V1a @ V0b ) @ V2x )
