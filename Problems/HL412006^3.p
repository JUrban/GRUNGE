...
thf(thm_2Ereal_2ENUM__FLOOR__LE,axiom,(
    ! [V0x: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V0x )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ ( c_2Ereal_2ENUM__FLOOR @ V0x ) ) @ V0x ) ) )).
...
thf(thm_2Elebesgue_2Elemma__fn__3,conjecture,(
