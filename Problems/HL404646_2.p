...
tff(conj_thm_2Efinite__map_2ESUBMAP__REFL,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),V0f),V0f)) ) )).

tff(conj_thm_2Efinite__map_2ESUBMAP__ANTISYM,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
