...
tff(conj_thm_2Elogroot_2ELOG__EXP,lemma,(
...
tff(conj_thm_2Ebit_2ELT__TWOEXP,lemma,(
...
tff(conj_thm_2Ewords_2Elsl__lsr,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
