...
thf(f13283_0_2E0,type,(
    f13283_0_2E0: u )).

thf(f13283_0_2E1,type,(
    f13283_0_2E1: du > u )).

thf(f13283_0_2E2,type,(
    f13283_0_2E2: du > du > u )).

thf(f13284_0_2E0,type,(
    f13284_0_2E0: u )).

thf(f13284_0_2E2,type,(
    f13284_0_2E2: du > du > u )).

thf(f13284_0_2E3,type,(
...
thf(mono_2Ef13283_0,type,(
    mono_2Ef13283_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13284_0,type,(
    mono_2Ef13284_0: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ELINEAR__COMPOSE__CMUL,axiom,(
...
thf(thm_2Ereal__topology_2ELINEAR__COMPOSE__CMUL,axiom,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1c: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Ereal__topology_2Elinear @ ( mono_2Ef13284_0 @ V1c @ V0f ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EBOUNDED__SCALING,axiom,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13283_0 @ V0c @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V0c @ V2x ) ) )).

thf(thm_2Ereal__topology_2EBOUNDED__SCALING,conjecture,(
    ! [V0c: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2Ebounded__def @ V1s )
     => ( mono_2Ec_2Ereal__topology_2Ebounded__def @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13283_0 @ V0c ) @ V1s ) ) ) )).
