...
thf(conj_thm_2Ellist_2ELTAKE__CONS__EQ__NONE,lemma,(
     ...
     => ! [V2t: $i] :
         ...
         => ( ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V1h ) @ V2t ) )
          ...
          <=> ? [V3n: tp__ty_2Enum_2Enum] :
                ( ( V0m
                  = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) )
                & ( ( ap @ ( ap @ ( c_2Ellist_2ELTAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ V2t )
                  = ( c_2Eoption_2ENONE @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELFINITE__LLENGTH,lemma,(
    ! [A_27a: del,V0ll: $i] :
...
thf(conj_thm_2Ellist_2ELTAKE__LLENGTH__NONE,conjecture,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
