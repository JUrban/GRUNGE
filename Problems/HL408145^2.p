...
thf(conj_thm_2Epoly_2EPOLY__DIFF__CLAUSES,lemma,(
...
thf(conj_thm_2Epoly_2EPOLY__DIFF__LEMMA,lemma,(
      ...
      @ ( ap
        @ ( ap
          @ ( ap @ c_2Elim_2Ediffl
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V3x: $i] :
                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ ( ap @ c_2Ereal_2Epow @ V3x ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ ( ap @ c_2Epoly_2Epoly @ ( inj__c_ty_2Elist_2Elist_ty_2Erealax_2Ereal @ V0l ) ) @ V3x ) ) ) )
...
thf(conj_thm_2Epoly_2EPOLY__DIFF,conjecture,(
