...
tff(conj_thm_2Ebag_2EBAG__INSERT__CHOICE__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ESUB__BAG__REST,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Econtainer_2EBAG__TO__LIST__THM,lemma,(
    ! [A_27a: del,V0bag: $i] :
...
tff(conj_thm_2Econtainer_2EBAG__TO__LIST__IND,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Econtainer_2EBAG__IN__MEM,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
