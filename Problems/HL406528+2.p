...
fof(conj_thm_2Eblast_2EBSUM__EQ,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1c] :
          ( mem(V1c,bool)
...
fof(conj_thm_2Eblast_2EBSUM__LEM,lemma,(
    ! [V0i] :
     ...
     => ! [V1x] :
         ...
         => ! [V2y] :
             ...
             => ! [V3c] :
                  ( mem(V3c,bool)
                 => ( p(ap(ap(ap(ap(c_2Eblast_2EBSUM,V0i),f2311(V1x)),f2312(V2y)),V3c))
...
fof(lameq_f2314,axiom,(
    ! [A_27a,V1y] :
     ...
     => ! [V0x] :
         ...
         => ! [V2i] :
              ( mem(V2i,ty_2Enum_2Enum)
             => ap(f2314(A_27a,V1y,V0x),V2i) = ap(ap(ap(ap(c_2Eblast_2EBSUM,V2i),ap(c_2Efcp_2Efcp__index(bool,bool),V0x)),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Ebool_2E_7E),ap(c_2Efcp_2Efcp__index(bool,bool),V1y))),c_2Ebool_2ET) ) ) ) )).

fof(conj_thm_2Eblast_2EBITWISE__SUB,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
          ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
