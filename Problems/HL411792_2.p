...
tff(lameq_f4030,axiom,(
    ! [V0f: $i] :
     ...
     => ! [V1k: $i] :
          ( mem(V1k,arr(ty_2Enum_2Enum,bool))
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f4030(V0f,V1k),inj__ty_2Enum_2Enum(V2n)) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V2n)),V1k)),ap(V0f,inj__ty_2Enum_2Enum(V2n))),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUMMABLE__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1k: $i] :
          ( mem(V1k,arr(ty_2Enum_2Enum,bool))
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__IFF__EVENTUALLY,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__IFF__COFINITE,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EUNION(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),V1s),V2t)),ap(ap(c_2Epred__set_2EDIFF(ty_2Enum_2Enum),V2t),V1s))))
               => ( p(ap(ap(c_2Ereal__topology_2Esummable,V1s),V0f))
                <=> p(ap(ap(c_2Ereal__topology_2Esummable,V2t),V0f)) ) ) ) ) ) )).
