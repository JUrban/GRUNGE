...
thf(thm_2Eset__relation_2Eacyclic__def,axiom,(
    ...
    <=> ! [V1x: A_27a] :
          ( (~) @ ( c_2Ebool_2EIN @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ ( c_2Epair_2E_2C @ A_27a @ A_27a @ V1x @ V1x ) @ ( c_2Eset__relation_2Etc @ A_27a @ V0r ) ) ) ) )).
...
thf(thm_2Eset__relation_2Estrict__linear__order__union__acyclic,conjecture,(
    ! [A_27a: $tType,V0r1: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V1r2: ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) > $o,V2s: A_27a > $o] :
      ( ( ( c_2Eset__relation_2Estrict__linear__order @ A_27a @ V0r1 @ V2s )
        & ( c_2Epred__set_2ESUBSET @ A_27a @ ( c_2Epred__set_2EUNION @ A_27a @ ( c_2Eset__relation_2Edomain @ A_27a @ A_27a @ V1r2 ) @ ( c_2Eset__relation_2Erange @ A_27a @ A_27a @ V1r2 ) ) @ V2s ) )
     => ( ( c_2Eset__relation_2Eacyclic @ A_27a @ ( c_2Epred__set_2EUNION @ ( tyop_2Epair_2Eprod @ A_27a @ A_27a ) @ V0r1 @ V1r2 ) )
