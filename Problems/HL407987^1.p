...
thf(f9423_0_2E0,type,(
    f9423_0_2E0: u )).

thf(f9423_0_2E2,type,(
    f9423_0_2E2: du > du > u )).

thf(f9423_0_2E3,type,(
...
thf(mono_2Ef9423_0,type,(
    mono_2Ef9423_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eseq_2ESUBSEQ__SUC,axiom,(
    ...
    <=> ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Eprim__rec_2E_3C @ ( V0f @ V1n ) @ ( V0f @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) ) ) )).

thf(thm_2Eseq_2EMONO__SUC,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Emono @ V0f )
    <=> ( ! [V1n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__ge @ ( V0f @ ( mono_2Ec_2Enum_2ESUC @ V1n ) ) @ ( V0f @ V1n ) )
        | ! [V2n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ ( mono_2Ec_2Enum_2ESUC @ V2n ) ) @ ( V0f @ V2n ) ) ) ) )).

thf(def0_2Ethm_2Eseq_2ESEQ__MONOSUB,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9423_0 @ V0s @ V1f @ V2n )
      = ( V0s @ ( V1f @ V2n ) ) ) )).

thf(thm_2Eseq_2ESEQ__MONOSUB,conjecture,(
    ...
    ? [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
      ...
      & ( mono_2Ec_2Eseq_2Emono @ ( mono_2Ef9423_0 @ V0s @ V1f ) ) ) )).
