...
tff(conj_thm_2Erich__list_2EEXISTS__FOLDL__MAP,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
         => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),V0P),V1l))
          <=> p(ap(ap(ap(c_2Elist_2EFOLDL(bool,bool),c_2Ebool_2E_5C_2F),inj__o(fo__c_2Ebool_2EF)),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0P),V1l))) ) ) ) )).
