...
tff(conj_thm_2EpatternMatches_2EPMATCH__ROW__EQ__AUX,conjecture,(
                 ...
                 => ! [V4r: $i] :
                     ...
                     => ! [V5r_27: $i] :
                         ...
                         => ( ( ! [V6i: $i] :
                                 ...
                                 => ( ? [V7x: $i] :
                                        ( mem(V7x,A_27b)
                                        & p(ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND(A_27b,A_27b),V0p),V1g),V6i),V7x)) )
                                  <=> ? [V8x_27: $i] :
                                        ( mem(V8x_27,A_27c)
                                        & p(ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW__COND(A_27c,A_27c),V2p_27),V3g_27),V6i),V8x_27)) ) ) )
                              & ! [V9x: $i] :
                                  ( mem(V9x,A_27b)
                                 => ! [V10x_27: $i] :
                                      ( mem(V10x_27,A_27c)
                           ...
                           => ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27d,A_27d,A_27d),V0p),V1g),V4r) = ap(ap(ap(c_2EpatternMatches_2EPMATCH__ROW(A_27d,A_27d,A_27d),V2p_27),V3g_27),V5r_27) ) ) ) ) ) ) ) )).
