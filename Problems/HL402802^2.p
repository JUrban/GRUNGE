...
thf(conj_thm_2Elist_2ESNOC__11,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1y: $i] :
...
thf(conj_thm_2Erich__list_2ELASTN__REVERSE,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ V1l ) )
          = ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) ) ) ) ) )).
