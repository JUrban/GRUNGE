...
thf(conj_thm_2Eordinal_2EordADD__CANCEL1,lemma,(
    ! [A_27a: del] :
      ( ! [V0c: $i] :
         ...
         => ! [V1a: $i] :
              ( ( mem @ V1a @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
             => ( ( V1a
                  = ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V1a ) @ V0c ) )
              <=> ( V0c
      ...
      & ! [V2c: $i] :
         ...
         => ! [V3a: $i] :
             ...
             => ( ( ( ap @ ( ap @ ( c_2Eordinal_2EordADD @ A_27a ) @ V3a ) @ V2c )
                  = V3a )
              <=> ( V2c
                  = ( ap @ ( c_2Eordinal_2EfromNat @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eordinal_2Eordle__CANCEL__ADDR,conjecture,(
    ! [A_27a: del,V0x: $i] :
