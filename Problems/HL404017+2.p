...
fof(conj_thm_2Equotient_2ERES__FORALL__PRS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2rep] :
                     ...
                     => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
                       => ! [V3P] :
                           ...
                           => ! [V4f] :
                                ( mem(V4f,arr(A_27b,bool))
                               => ( p(ap(ap(c_2Ebool_2ERES__FORALL(A_27b),V3P),V4f))
                                <=> p(ap(ap(c_2Ebool_2ERES__FORALL(A_27a),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V3P)),ap(ap(ap(c_2Equotient_2E_2D_2D_3E(A_27a,A_27a,A_27a,A_27a),V1abs),c_2Ecombin_2EI(bool)),V4f))) ) ) ) ) ) ) ) ) ) )).
