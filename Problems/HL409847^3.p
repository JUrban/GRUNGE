...
thf(thm_2Eiterate_2ESUM__BIGUNION__NONZERO,conjecture,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal,V1s: ( A_27a > $o ) > $o] :
      ( ( ( c_2Epred__set_2EFINITE @ ( A_27a > $o ) @ V1s )
        ...
        & ! [V3t1: A_27a > $o,V4t2: A_27a > $o,V5x: A_27a] :
           ...
           => ( ( V0f @ V5x )
              = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )
     => ( ( c_2Eiterate_2ESum @ A_27a @ ( c_2Epred__set_2EBIGUNION @ A_27a @ V1s ) @ V0f )
        = ( c_2Eiterate_2ESum @ ( A_27a > $o ) @ V1s
          @ ^ [V6t: A_27a > $o] :
              ( c_2Eiterate_2ESum @ A_27a @ V6t @ V0f ) ) ) ) )).
