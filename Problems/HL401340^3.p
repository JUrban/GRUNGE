...
thf(thm_2Ebit_2ESBIT__MULT,conjecture,(
    ! [V0b: $o,V1m: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_2A @ ( c_2Ebit_2ESBIT @ V0b @ V2n ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V1m ) )
      = ( c_2Ebit_2ESBIT @ V0b @ ( c_2Earithmetic_2E_2B @ V2n @ V1m ) ) ) )).
