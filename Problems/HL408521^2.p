...
thf(conj_thm_2Ebinary__ieee_2Ethreshold__is__positive,lemma,(
    ! [A_27t: del,A_27w: del] :
...
thf(conj_thm_2Ebinary__ieee_2Eround__roundTiesToEven__plus__infinity,conjecture,(
    ! [A_27t: del,A_27w: del,V0y: $i] :
      ( ( mem @ V0y @ ( ty_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ ( c_2Ebinary__ieee_2Ethreshold @ A_27t @ A_27w ) @ ( c_2Ebool_2Ethe__value @ ( ty_2Epair_2Eprod @ A_27t @ A_27w ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
         => ( ( ap @ ( ap @ ( c_2Ebinary__ieee_2Eround @ A_27t @ A_27w ) @ ( inj__ty_2Ebinary__ieee_2Erounding @ fo__c_2Ebinary__ieee_2EroundTiesToEven ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) )
