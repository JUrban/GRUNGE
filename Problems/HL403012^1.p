...
thf(thm_2EindexedLists_2EMAPi__ACC__def,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0f_2E0: u,V1i: mono_2Etyop_2Enum_2Enum,V2a_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V0f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2a_2E0 ) ) ) )
      & ! [V3f_2E0: u,V4i: mono_2Etyop_2Enum_2Enum,V5a_2E0: u,V6h_2E0: u,V7t_2E0: u] :
          ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4i ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V6h_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V7t_2E0 ) ) ) ) )
          = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2B @ V4i @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V3f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4i ) ) ) ) @ ( s @ A_27b @ V6h_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5a_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V7t_2E0 ) ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMAPi__ACC__MAPi,conjecture,(
