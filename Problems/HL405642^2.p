...
thf(conj_thm_2Eordinal_2EcountableOrds__uncountable,conjecture,(
    ! [A_27a: del] :
      ~ ( p
        @ ( ap @ ( c_2Epred__set_2Ecountable @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ ( ty_2Eordinal_2Eordinal @ A_27a ) )
            @ ( lam @ ( ty_2Eordinal_2Eordinal @ A_27a )
              @ ^ [V0a: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Eordinal_2Eordinal @ A_27a ) @ bool ) @ V0a ) @ ( ap @ ( c_2Epred__set_2Ecountable @ ( ty_2Eordinal_2Eordinal @ A_27a ) ) @ ( ap @ ( c_2Eordinal_2Epreds @ A_27a ) @ V0a ) ) ) ) ) ) ) )).
