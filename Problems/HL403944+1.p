...
fof(thm_2Ellist_2ELPREFIX__REFL,conjecture,(
    ! [A_27a,V0ll_2E0] : p(s(tyop_2Emin_2Ebool,c_2Ellist_2ELPREFIX_2E2(s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0),s(tyop_2Ellist_2Ellist(A_27a),V0ll_2E0)))) )).
