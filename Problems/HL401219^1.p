...
thf(c_2Enumpair_2Einvtri_2E0,type,(
    c_2Enumpair_2Einvtri_2E0: u )).

thf(c_2Enumpair_2Einvtri_2E1,type,(
    c_2Enumpair_2Einvtri_2E1: du > u )).

thf(c_2Enumpair_2Einvtri0_2E0,type,(
    c_2Enumpair_2Einvtri0_2E0: u )).

thf(c_2Enumpair_2Einvtri0_2E2,type,(
    c_2Enumpair_2Einvtri0_2E2: du > du > u )).

thf(c_2Enumpair_2Etri_2E0,type,(
    c_2Enumpair_2Etri_2E0: u )).

thf(c_2Enumpair_2Etri_2E1,type,(
    c_2Enumpair_2Etri_2E1: du > u )).
...
thf(mono_2Ec_2Enumpair_2Einvtri,type,(
    mono_2Ec_2Enumpair_2Einvtri: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).

thf(mono_2Ec_2Enumpair_2Einvtri0,type,(
    mono_2Ec_2Enumpair_2Einvtri0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Epair_2Eprod_28tyop_2Enum_2Enum_2Ctyop_2Enum_2Enum_29 )).

thf(mono_2Ec_2Enumpair_2Etri,type,(
    mono_2Ec_2Enumpair_2Etri: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(thm_2Enumpair_2Etri__def,axiom,
    ( ( ( mono_2Ec_2Enumpair_2Etri @ mono_2Ec_2Enum_2E0 )
      = mono_2Ec_2Enum_2E0 )
    & ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Enumpair_2Etri @ ( mono_2Ec_2Enum_2ESUC @ V0n ) )
        = ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Enum_2ESUC @ V0n ) @ ( mono_2Ec_2Enumpair_2Etri @ V0n ) ) ) )).

thf(thm_2Enumpair_2Einvtri__def,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Enumpair_2Einvtri @ V0n )
      = ( mono_2Ec_2Epair_2ESND_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enumpair_2Einvtri0 @ V0n @ mono_2Ec_2Enum_2E0 ) ) ) )).

thf(thm_2Enumpair_2Einvtri0__thm,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1a: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Enumpair_2Etri @ ( mono_2Ec_2Epair_2ESND_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enumpair_2Einvtri0 @ V0n @ V1a ) ) ) @ ( mono_2Ec_2Epair_2EFST_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Enumpair_2Einvtri0 @ V0n @ V1a ) ) )
      = ( mono_2Ec_2Earithmetic_2E_2B @ V0n @ ( mono_2Ec_2Enumpair_2Etri @ V1a ) ) ) )).

thf(thm_2Enumpair_2Einvtri__lower,conjecture,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Earithmetic_2E_3C_3D @ ( mono_2Ec_2Enumpair_2Etri @ ( mono_2Ec_2Enumpair_2Einvtri @ V0n ) ) @ V0n ) )).
