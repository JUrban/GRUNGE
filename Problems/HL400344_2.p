...
tff(ax_thm_2Erelation_2ERC__DEF,axiom,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Erelation_2ERTC__INDUCT,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
...
tff(conj_thm_2Erelation_2ERTC__STRONG__INDUCT,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,arr(A_27a,bool)))
              ...
              & ! [V3x: $i] :
                 ...
                 => ! [V4y: $i] :
                     ...
                     => ! [V5z: $i] :
                          ( mem(V5z,A_27a)
                         => ( ( p(ap(ap(V0R,V3x),V4y))
                              & p(ap(ap(ap(c_2Erelation_2ERTC(A_27a),V0R),V4y),V5z))
                              & p(ap(ap(V1P,V4y),V5z)) )
                           => p(ap(ap(V1P,V3x),V5z)) ) ) ) ) )
           => ! [V6x: $i] :
                ( mem(V6x,A_27a)
...
tff(conj_thm_2Erelation_2ERC__RTC,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Erelation_2ETC__RTC,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Erelation_2ETC__RC__EQNS,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
