...
tff(conj_thm_2EdefCNF_2EOK__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1n: tp__ty_2Enum_2Enum,V2conn: $i] :
             ...
             => ! [V3i: tp__ty_2Enum_2Enum,V4j: tp__ty_2Enum_2Enum] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V1n)),ap(ap(c_2Epair_2E_2C(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))),V2conn),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3i))),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4j)))))) )
          & ! [V5n: tp__ty_2Enum_2Enum,V6conn: $i] :
              ( mem(V6conn,arr(bool,arr(bool,bool)))
             => ! [V7i: tp__ty_2Enum_2Enum,V8b: tp__o] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V5n)),ap(ap(c_2Epair_2E_2C(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))),V6conn),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V7i))),ap(c_2Esum_2EINR(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__o(V8b)))))) )
          & ! [V9n: tp__ty_2Enum_2Enum,V10conn: $i] :
              ( mem(V10conn,arr(bool,arr(bool,bool)))
             => ! [V11a: tp__o,V12j: tp__ty_2Enum_2Enum] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V9n)),ap(ap(c_2Epair_2E_2C(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))),V10conn),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esum_2EINR(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__o(V11a))),ap(c_2Esum_2EINL(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V12j)))))) )
          & ! [V13n: tp__ty_2Enum_2Enum,V14conn: $i] :
              ( mem(V14conn,arr(bool,arr(bool,bool)))
             => ! [V15a: tp__o,V16b: tp__o] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V13n)),ap(ap(c_2Epair_2E_2C(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))),V14conn),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(c_2Esum_2EINR(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__o(V15a))),ap(c_2Esum_2EINR(ty_2Enum_2Enum,ty_2Enum_2Enum),inj__o(V16b)))))) ) )
       => ! [V17v: tp__ty_2Enum_2Enum,V18v1: $i] :
            ( mem(V18v1,arr(bool,arr(bool,bool)))
           => ! [V19v2: tp__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o,V20v3: tp__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o] : p(ap(ap(V0P,inj__ty_2Enum_2Enum(V17v)),ap(ap(c_2Epair_2E_2C(arr(bool,arr(bool,bool)),arr(bool,arr(bool,bool))),V18v1),ap(ap(c_2Epair_2E_2C(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum),ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),inj__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o(V19v2)),inj__c_ty_2Esum_2Esum_ty_2Enum_2Enum_o(V20v3))))) ) ) ) )).
