...
tff(lamtp_f3798,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3798(V1f),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3798,axiom,(
    ! [V1f: $i] :
      ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3798(V1f),inj__ty_2Erealax_2Ereal(V5x)) = ap(V1f,inj__ty_2Erealax_2Ereal(V5x)) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__CONG__AT,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1f: $i] :
     ...
     => ! [V2g: $i] :
         ...
         => ! [V3l: tp__ty_2Erealax_2Ereal] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Erealax_2Ereal),f3798(V1f)),inj__ty_2Erealax_2Ereal(V3l)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0a))))
