...
thf(thm_2Ereal__topology_2ESEQUENCE__CAUCHY__WLOG,conjecture,(
    ! [V0e: mono_2Etyop_2Erealax_2Ereal,V1P: mono_2Etyop_2Enum_2Enum > $o,V2s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ! [V3m: mono_2Etyop_2Enum_2Enum,V4n: mono_2Etyop_2Enum_2Enum] :
          ( ( ( V1P @ V3m )
            & ( V1P @ V4n ) )
         => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( V2s @ V3m ) @ ( V2s @ V4n ) ) ) @ V0e ) )
    <=> ! [V5m: mono_2Etyop_2Enum_2Enum,V6n: mono_2Etyop_2Enum_2Enum] :
          ( ( ( V1P @ V5m )
            & ( V1P @ V6n )
            & ( mono_2Ec_2Earithmetic_2E_3C_3D @ V5m @ V6n ) )
         => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal__topology_2EDist @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( V2s @ V5m ) @ ( V2s @ V6n ) ) ) @ V0e ) ) ) )).
