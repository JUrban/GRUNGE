...
tff(conj_thm_2Efinite__map_2EFUPDATE__FUPDATE__LIST__MEM,lemma,(
         ...
         => ! [V2fm: $i] :
             ...
             => ! [V3v: $i] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0k),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V1kvl))))
                   => ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V2fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V0k),V3v))),V1kvl) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V2fm),V1kvl) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2EFUPDATE__LIST__CANCEL,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls1: $i] :
      ( mem(V0ls1,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ! [V1fm: $i] :
          ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2ls2: $i] :
              ( mem(V2ls2,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
             => ( ! [V3k: $i] :
                    ( mem(V3k,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3k),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0ls1))))
                     => p(ap(ap(c_2Ebool_2EIN(A_27a),V3k),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V2ls2)))) ) )
               => ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V1fm),V0ls1)),V2ls2) = ap(ap(c_2Efinite__map_2EFUPDATE__LIST(A_27a,A_27a),V1fm),V2ls2) ) ) ) ) )).
