...
tff(conj_thm_2Ereal__topology_2EDIST__MIDPOINT,lemma,(
...
tff(conj_thm_2Ereal__topology_2EMIDPOINT__EQ__ENDPOINT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Ereal__topology_2ESEGMENT__SYM,lemma,
...
tff(conj_thm_2Ereal__topology_2EMIDPOINT__IN__SEGMENT,lemma,
...
tff(conj_thm_2Ereal__topology_2EURYSOHN__LOCAL__STRONG,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
