...
thf(thm_2Ebag_2EBAG__EVERY__UNION,conjecture,(
    ! [A_27a: $tType,V0b2: A_27a > tyop_2Enum_2Enum,V1b1: A_27a > tyop_2Enum_2Enum,V2P: A_27a > $o] :
      ( ( c_2Ebag_2EBAG__EVERY @ A_27a @ V2P @ ( c_2Ebag_2EBAG__UNION @ A_27a @ V1b1 @ V0b2 ) )
    <=> ( ( c_2Ebag_2EBAG__EVERY @ A_27a @ V2P @ V1b1 )
        & ( c_2Ebag_2EBAG__EVERY @ A_27a @ V2P @ V0b2 ) ) ) )).
