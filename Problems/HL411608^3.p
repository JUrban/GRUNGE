    ...
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Erealax_2Ereal__lt @ ( c_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EOPEN__HALFSPACE__GT,axiom,(
    ! [V0a: tyop_2Erealax_2Ereal,V1b: tyop_2Erealax_2Ereal] :
      ...
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V2x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2x @ ( c_2Ereal_2Ereal__gt @ ( c_2Erealax_2Ereal__mul @ V0a @ V2x ) @ V1b ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONNECTED__IVT__HYPERPLANE,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal,V3a: tyop_2Erealax_2Ereal,V4b: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econnected @ V0s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s )
        & ( c_2Ereal_2Ereal__lte @ ( c_2Erealax_2Ereal__mul @ V3a @ V1x ) @ V4b )
        & ( c_2Ereal_2Ereal__lte @ V4b @ ( c_2Erealax_2Ereal__mul @ V3a @ V2y ) ) )
     => ? [V5z: tyop_2Erealax_2Ereal] :
          ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5z @ V0s )
          & ( ( c_2Erealax_2Ereal__mul @ V3a @ V5z )
            = V4b ) ) ) )).
