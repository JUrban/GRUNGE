...
fof(conj_thm_2Ereal__topology_2EINTERVAL__EQ__EMPTY,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1b] :
          ( mem(V1b,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Erealax_2Ereal__lt,V1b),V0a))
...
fof(conj_thm_2Ereal__topology_2EBALL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
         => ( ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1r)) = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2Ereal__sub,V0x),V1r)),ap(ap(c_2Erealax_2Ereal__add,V0x),V1r))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))
            & ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0x),V1r)) = ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Ereal_2Ereal__sub,V0x),V1r)),ap(ap(c_2Erealax_2Ereal__add,V0x),V1r))) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EINTERVAL,conjecture,
    ( ! [V0a] :
       ...
       => ! [V1b] :
            ( mem(V1b,ty_2Erealax_2Ereal)
           => ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b)),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Ereal_2Ereal__lte,V0a),V1b)),ap(c_2Ereal__topology_2Ecball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Emidpoint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b))),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1b))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))))))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) )
    & ! [V2a] :
        ( mem(V2a,ty_2Erealax_2Ereal)
       => ! [V3b] :
            ( mem(V3b,ty_2Erealax_2Ereal)
           => ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b)) = ap(ap(ap(c_2Ebool_2ECOND(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Erealax_2Ereal__lt,V2a),V3b)),ap(c_2Ereal__topology_2Eball,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Emidpoint,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b))),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2a),V3b))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO))))))),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)) ) ) )).
