...
fof(lamtp_f765,axiom,(
    ! [A_27a] : mem(f765(A_27a),arr(ty_2Enum_2Enum,arr(A_27a,ty_2Enum_2Enum))) )).

fof(lameq_f765,axiom,(
    ! [A_27a,V1l_27] :
      ( mem(V1l_27,ty_2Enum_2Enum)
     => ap(f765(A_27a),V1l_27) = k(A_27a,ap(c_2Enum_2ESUC,V1l_27)) ) )).

fof(conj_thm_2Erich__list_2ELENGTH__FOLDL,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ap(c_2Elist_2ELENGTH(A_27a),V0l) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f765(A_27a)),c_2Enum_2E0),V0l) ) ) )).
