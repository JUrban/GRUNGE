...
thf(thm_2ETemporal__Logic_2EUNTIL__INVARIANT,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1a: mono_2Etyop_2Enum_2Enum > $o,V2t0: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2ETemporal__Logic_2EUNTIL @ V1a @ V0b @ V2t0 )
    <=> ? [V3J: mono_2Etyop_2Enum_2Enum > $o] :
          ( ( V3J @ V2t0 )
          & ! [V4t: mono_2Etyop_2Enum_2Enum] :
              ( ( ( V3J @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V2t0 ) )
                & ( (~) @ ( V0b @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V2t0 ) ) ) )
             => ( ( V1a @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V2t0 ) )
                & ( V3J @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2B @ V4t @ V2t0 ) ) ) ) ) ) ) )).
