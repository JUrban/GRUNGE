...
thf(f4089_0_2E0,type,(
    f4089_0_2E0: u )).

thf(f4089_0_2E3,type,(
    f4089_0_2E3: du > du > du > u )).

thf(f4089_0_2E4,type,(
    f4089_0_2E4: du > du > du > du > u )).

thf(f4089_1_2E0,type,(
    f4089_1_2E0: u )).

thf(f4089_1_2E2,type,(
    f4089_1_2E2: du > du > u )).
...
thf(mono_2Ef4089_1,type,(
    mono_2Ef4089_1: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq3_2Emono_2Ef4089_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u,X2_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4089_0_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X2_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) ) ) @ f4089_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X2_2E0 ) ) ) ) )).

thf(arityeq4_2Emono_2Ef4089_0_2E4_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u,X2_2E0: u,X3: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4089_0_2E4 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X3 ) ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) ) ) ) @ f4089_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ X2_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X3 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efcp_2Efcp__subst__comp,axiom,(
    ! [V1x: mono_2Etyop_2Enum_2Enum,V5c: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4089_1 @ V1x @ V5c )
    <=> ( V1x = V5c ) ) )).

thf(def1_2Ethm_2Efcp_2Efcp__subst__comp,axiom,(
    ! [A_27a: d,V1x: mono_2Etyop_2Enum_2Enum,V0y_2E0: u,V4f_2E0: u,V5c: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ A_27a @ ( f4089_0_2E4 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V4f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5c ) ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4089_1 @ V1x @ V5c ) ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V4f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V5c ) ) ) ) ) ) ) )).

thf(thm_2Efcp_2Efcp__subst__comp,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,A_27d: d,V0y_2E0: u,V1x: mono_2Etyop_2Enum_2Enum,V2a_2E0: u,V3b_2E0: u,V4f_2E0: u] :
      ( ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2E_3A_2B_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V4f_2E0 ) ) ) ) )
      = ( s @ ( tyop_2Efcp_2Ecart @ A_27a @ A_27b ) @ ( c_2Efcp_2EFCP_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ ( f4089_0_2E3 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V4f_2E0 ) ) ) ) ) ) )).
