...
tff(conj_thm_2Ereal__topology_2EOPEN__DELETE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Ereal__topology_2EOpen,V0s))
         => p(ap(c_2Ereal__topology_2EOpen,ap(ap(c_2Epred__set_2EDELETE(ty_2Erealax_2Ereal),V0s),inj__ty_2Erealax_2Ereal(V1x)))) ) ) )).
