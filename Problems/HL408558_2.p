...
tff(conj_thm_2Ebinary__ieee_2Efloat__negate__negate,lemma,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
...
tff(conj_thm_2Ebinary__ieee_2Efloat__sub__finite__minus__infinity,conjecture,(
    ! [A_27t: del,A_27w: del,V0mode: tp__ty_2Ebinary__ieee_2Erounding,V1x: $i] :
      ( mem(V1x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ! [V2r: tp__ty_2Erealax_2Ereal] :
         ...
         => ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(A_27t,A_27t),inj__ty_2Ebinary__ieee_2Erounding(V0mode)),V1x),ap(c_2Ebinary__ieee_2Efloat__minus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))) = ap(ap(c_2Epair_2E_2C(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),inj__ty_2Ebinary__ieee_2Eflags(fo__c_2Ebinary__ieee_2Eclear__flags)),ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))) ) ) )).
