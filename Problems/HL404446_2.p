...
tff(conj_thm_2Epred__set_2ECARD__UNION__LE,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,bool))
...
tff(conj_thm_2Ecardinal_2EFINITE__FINITE__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(lmtp_f1875,type,(
    f1875: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f1875,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V1t: $i] :
      ( mem(V1t,arr(A_27a,arr(A_27b,bool)))
     => ! [V0s: $i] :
          ( mem(V0s,arr(A_27a,bool))
         => mem(f1875(A_27a,A_27b,A_27a,V1t,V0s),arr(A_27a,ty_2Epair_2Eprod(arr(A_27b,bool),arr(A_27b,bool)))) ) ) )).
...
tff(lameq_f1875,axiom,(
    ! [A_27a: del,A_27b: del,A_27a: del,V1t: $i] :
     ...
     => ! [V0s: $i] :
         ...
         => ! [V5x: $i] :
              ( mem(V5x,A_27a)
             => ap(f1875(A_27a,A_27b,A_27a,V1t,V0s),V5x) = ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(V1t,V5x)),ap(ap(c_2Ebool_2EIN(A_27a),V5x),V0s)) ) ) ) )).

tff(conj_thm_2Ecardinal_2ECARD__BIGUNION__LE,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27a,arr(A_27b,bool)))
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
             ...
             => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Epred__set_2ECARD(A_27b),ap(c_2Epred__set_2EBIGUNION(A_27b),ap(c_2Epred__set_2EGSPEC(arr(A_27b,bool),arr(A_27b,bool)),f1875(A_27a,A_27b,A_27a,V1t,V0s))))),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n)))) ) ) ) )).
