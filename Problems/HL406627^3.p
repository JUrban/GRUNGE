...
thf(thm_2Eenumeral_2EOU,axiom,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1t: A_27a > $o,V2u: A_27a > $o] :
      ( ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ V1t @ V2u )
      = ( c_2Epred__set_2EUNION @ A_27a
        @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
          @ ^ [V3x: A_27a] :
              ( c_2Epair_2E_2C @ A_27a @ $o @ V3x
              @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3x @ V1t )
                @ ( c_2Ebool_2E_21 @ A_27a
                  @ ^ [V4z: A_27a] :
                      ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ A_27a @ V4z @ V2u ) @ ( c_2Emin_2E_3D @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto @ A_27a @ V0cmp @ V3x @ V4z ) @ c_2EternaryComparisons_2ELESS ) ) ) ) ) )
        @ V2u ) ) )).
...
thf(thm_2Eenumeral_2EEMPTY__OU,conjecture,(
    ! [A_27a: $tType,V0cmp: tyop_2Etoto_2Etoto @ A_27a,V1sl: A_27a > $o] :
      ( ( c_2Eenumeral_2EOU @ A_27a @ V0cmp @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ V1sl )
      = V1sl ) )).
