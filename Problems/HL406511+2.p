...
fof(conj_thm_2Ewords_2Eword__join__index,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1a] :
                 ...
                 => ! [V2b] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
                          ...
                          & p(ap(ap(c_2Eprim__rec_2E_3C,V0i),ap(c_2Efcp_2Edimindex(ty_2Esum_2Esum(A_27a,A_27a)),c_2Ebool_2Ethe__value(ty_2Esum_2Esum(A_27a,A_27a))))) )
                       => ( p(ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__join(A_27a,A_27a),V1a),V2b)),V0i))
                        <=> p(ap(ap(ap(c_2Ebool_2ECOND(bool),ap(ap(c_2Eprim__rec_2E_3C,V0i),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V2b),V0i)),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1a),ap(ap(c_2Earithmetic_2E_2D,V0i),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))))) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ebitstring_2Eword__join__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0v1] :
             ...
             => ! [V1v2] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),c_2Epred__set_2EUNIV(A_27a)))
                      & p(ap(c_2Epred__set_2EFINITE(A_27b),c_2Epred__set_2EUNIV(A_27b))) )
                   => ap(ap(c_2Ewords_2Eword__join(A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),V0v1)),ap(c_2Ebitstring_2Ev2w(A_27b),V1v2)) = ap(c_2Ebitstring_2Ev2w(ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Elist_2EAPPEND(bool),V0v1),ap(ap(c_2Ebitstring_2Efixwidth,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),V1v2))) ) ) ) ) ) )).
