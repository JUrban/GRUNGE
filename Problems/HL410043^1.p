...
thf(f12159_0_2E0,type,(
    f12159_0_2E0: u )).

thf(f12159_0_2E1,type,(
    f12159_0_2E1: du > u )).

thf(f12159_0_2E2,type,(
    f12159_0_2E2: du > du > u )).

thf(f12161_0_2E0,type,(
    f12161_0_2E0: u )).

thf(f12161_0_2E1,type,(
    f12161_0_2E1: du > u )).

thf(f12161_0_2E2,type,(
    f12161_0_2E2: du > du > u )).
...
thf(mono_2Ef12161_0,type,(
    mono_2Ef12161_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum )).
...
thf(arityeq1_2Emono_2Ef12159_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f12159_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) @ f12159_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef12159_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12159_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) ) @ f12159_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) ) )).
...
thf(thm_2Eiterate_2ECARD__NUMSEG__1,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Epred__set_2ECARD_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V0n ) )
      = V0n ) )).

thf(def0_2Ethm_2Eproduct_2ENPRODUCT__CONST,axiom,(
    ! [A_27a: d,V0c: mono_2Etyop_2Enum_2Enum,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( f12159_0_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0c ) ) @ ( s @ A_27a @ V2x_2E0 ) ) ) )
      = V0c ) )).
...
thf(thm_2Eproduct_2ENPRODUCT__CONST,axiom,(
    ! [A_27a: d,V0c: mono_2Etyop_2Enum_2Enum,V1s_2E0: u] :
     ...
     => ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Eproduct_2Enproduct_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( f12159_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0c ) ) ) ) ) ) )
        = ( mono_2Ec_2Earithmetic_2EEXP @ V0c @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Epred__set_2ECARD_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1s_2E0 ) ) ) ) ) ) ) )).

thf(def0_2Ethm_2Eproduct_2ENPRODUCT__CONST__NUMSEG__1,axiom,(
    ! [V0c: mono_2Etyop_2Enum_2Enum,V2x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12161_0 @ V0c @ V2x )
      = V0c ) )).

thf(thm_2Eproduct_2ENPRODUCT__CONST__NUMSEG__1,conjecture,(
    ! [V0c: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eproduct_2Enproduct_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Eiterate_2E_2E_2E @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) @ ( mono_2Ef12161_0 @ V0c ) )
      = ( mono_2Ec_2Earithmetic_2EEXP @ V0c @ V1n ) ) )).
