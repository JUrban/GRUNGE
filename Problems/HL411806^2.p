...
thf(conj_thm_2Eiterate_2EFINITE__NUMSEG,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ESUM__POS__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Eiterate_2ESUM__SUBSET,lemma,(
    ! [A_27a: del,V0u: $i] :
...
thf(conj_thm_2Eiterate_2ESUM__TRIV__NUMSEG,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) )
         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ V0f ) )
            = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ESUM__OFFSET,lemma,(
    ! [V0p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( ( mem @ V1f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V0p ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ ( inj__ty_2Enum_2Enum @ V0p ) ) ) ) @ V1f ) )
          = ( surj__ty_2Erealax_2Ereal
            @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) )
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4i: $i] :
                    ( ap @ V1f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V4i ) @ ( inj__ty_2Enum_2Enum @ V0p ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELE__ADD,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ereal__topology_2EADD__SUB2,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
thf(conj_thm_2Ereal__topology_2EREAL__POW__1__LE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EREAL__POW__LE__1,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2EREAL__INV__1__LE,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
...
thf(conj_thm_2Ereal__topology_2EREAL__ARCH__POW__INV,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) )
     ...
     => ? [V2n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EFINITE__INTER__NUMSEG,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ V0s ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESERIES__0,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ( p
        @ ( ap
...
thf(conj_thm_2Ereal__topology_2ESERIES__CAUCHY,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ( ? [V2l: tp__ty_2Erealax_2Ereal] :
                ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V2l ) ) @ V1s ) )
...
thf(conj_thm_2Ereal__topology_2ESERIES__COMPARISON,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ? [V3l: tp__ty_2Erealax_2Ereal] :
                      ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V1g ) @ ( inj__ty_2Erealax_2Ereal @ V3l ) ) @ V2s ) )
                  & ? [V4N: tp__ty_2Enum_2Enum] :
                    ! [V5n: tp__ty_2Enum_2Enum] :
               ...
               => ? [V6l: tp__ty_2Erealax_2Ereal] :
                    ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V6l ) ) @ V2s ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESERIES__RATIO,conjecture,(
     ...
     => ! [V2s: $i] :
         ...
         => ! [V3N: tp__ty_2Enum_2Enum] :
             ...
             => ? [V5l: tp__ty_2Erealax_2Ereal] :
                  ( p @ ( ap @ ( ap @ ( ap @ c_2Ereal__topology_2Esums @ V1a ) @ ( inj__ty_2Erealax_2Ereal @ V5l ) ) @ V2s ) ) ) ) ) )).
