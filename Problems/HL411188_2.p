...
tff(conj_thm_2Epred__set_2EFORALL__IN__INSERT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(lmtp_f3834,type,(
    f3834: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3834,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal] : mem(f3834(A_27a,V1f,V4x),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3834,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x: tp__ty_2Erealax_2Ereal,V5a: $i] :
          ( mem(V5a,A_27a)
         => ap(f3834(A_27a,V1f,V4x),V5a) = ap(ap(V1f,V5a),inj__ty_2Erealax_2Ereal(V4x)) ) ) )).

tff(lmtp_f3833,type,(
    f3833: ( del * $i * $i ) > $i )).

tff(lamtp_f3833,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => mem(f3833(A_27a,V1f,V2s),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3833,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V4x: tp__ty_2Erealax_2Ereal] : ap(f3833(A_27a,V1f,V2s),inj__ty_2Erealax_2Ereal(V4x)) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3834(A_27a,V1f,V4x)) ) ) )).

tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__CONST,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ADD,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V2s))
               ...
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f2906(V0f,V1g)),V2s)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__SUM,conjecture,(
    ! [A_27a: del,V0t: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                  & ! [V3a: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3a),V2s))
                       => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,ap(V1f,V3a)),V0t)) ) ) )
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f3833(A_27a,V1f,V2s)),V0t)) ) ) ) ) )).
