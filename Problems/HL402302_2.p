...
tff(conj_thm_2Elist_2EMEM__ZIP__MEM__MAP,conjecture,(
    ! [A_27a: del,A_27b: del,V0ps: $i] :
     ...
     => ! [V1p: $i] :
         ...
         => ( ( surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27a),ap(c_2Epair_2EFST(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps))) = surj__ty_2Enum_2Enum(ap(c_2Elist_2ELENGTH(A_27b),ap(c_2Epair_2ESND(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0ps)))
