...
tff(conj_thm_2Ereal__topology_2ECLOSURE__NEGATIONS,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ESYMMETRIC__CLOSURE,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1x: tp__ty_2Erealax_2Ereal] :
       ...
       => ! [V2x: tp__ty_2Erealax_2Ereal] :
            ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Ereal__topology_2Eclosure,V0s)))
           => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V2x))),ap(c_2Ereal__topology_2Eclosure,V0s))) ) ) ) )).
