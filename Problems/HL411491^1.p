...
thf(f13321_0_2E0,type,(
    f13321_0_2E0: u )).

thf(f13321_0_2E1,type,(
    f13321_0_2E1: du > u )).

thf(f13326_0_2E0,type,(
    f13326_0_2E0: u )).

thf(f13326_0_2E1,type,(
    f13326_0_2E1: du > u )).

thf(f13326_0_2E2,type,(
...
thf(mono_2Ef13321_0,type,(
    mono_2Ef13321_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef13326_0,type,(
    mono_2Ef13326_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__SCALING,axiom,(
    ! [V1c: mono_2Etyop_2Erealax_2Ereal,V2x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13326_0 @ V1c @ V2x )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ V1c @ V2x ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__SCALING,axiom,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o,V1c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
     => ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13326_0 @ V1c ) @ V0s ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2ECLOSED__NEGATIONS,axiom,(
    ! [V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13321_0 @ V1x )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ V1x ) ) )).

thf(thm_2Ereal__topology_2ECLOSED__NEGATIONS,conjecture,(
    ! [V0s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal__topology_2EClosed @ V0s )
     => ( mono_2Ec_2Ereal__topology_2EClosed @ ( mono_2Ec_2Epred__set_2EIMAGE_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ mono_2Ef13321_0 @ V0s ) ) ) )).
