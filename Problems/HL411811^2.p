...
thf(ax_thm_2Earithmetic_2EMAX__DEF,axiom,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMAX @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) )
      = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) ) ) )).
...
thf(conj_thm_2Ecardinal_2EINJECTIVE__ON__LEFT__INVERSE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Eiterate_2ESUM__DIFF,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V1s ) @ V2t ) ) @ V0f ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s ) @ V0f ) ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V2t ) @ V0f ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ESUM__ABS,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
           => ( p
              @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s ) @ V0f ) ) )
                @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V1s )
                  @ ( lam @ A_27a
                    @ ^ [V2x: $i] :
                        ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V2x ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ESUM__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1g: $i] :
                   ...
                   => ! [V4y: $i] :
                       ...
                       => ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2s ) )
                            ...
                            & ( ( ap @ V0f @ V3x )
                              = ( ap @ V0f @ V4y ) ) )
                         => ( V3x = V4y ) ) ) )
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27b ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ A_27a @ A_27b ) @ V0f ) @ V2s ) ) @ V1g ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V2s ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ A_27a @ ty_2Erealax_2Ereal @ A_27b ) @ V1g ) @ V0f ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Eiterate_2ESUM__SUBSET__SIMPLE,lemma,(
    ! [A_27a: del,V0u: $i] :
...
thf(conj_thm_2Epred__set_2EFINITE__INTER,lemma,(
    ! [A_27a: del,V0s1: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__CAUCHY,lemma,(
    ! [V0f: $i] :
          ...
          <=> ! [V2e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V3N: tp__ty_2Enum_2Enum] :
                  ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
                    ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3E_3D @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ ( inj__ty_2Enum_2Enum @ V3N ) ) )
                   => ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ V1s ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) @ V0f ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V2e ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ESERIES__INJECTIVE__IMAGE__STRONG,conjecture,(
    ! [V0x: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2f: $i] :
             ...
             => ( ( ( p
                    @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ V2f ) @ V1s ) )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V3n: $i] :
                            ( ap @ c_2Ereal_2Eabs @ ( ap @ V0x @ V3n ) ) ) ) )
                  & ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
                      ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V4m ) ) @ V1s ) )
                        & ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V5n ) ) @ V1s ) )
                        & ( ( surj__ty_2Enum_2Enum @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V4m ) ) )
                          = ( surj__ty_2Enum_2Enum @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) ) )
                     => ( V4m = V5n ) ) )
               => ( p
                  @ ( ap
                    @ ( ap
                      @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V6n: $i] :
                              ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Enum_2Enum ) @ V2f ) @ V1s ) ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V6n ) ) ) @ V0x ) ) @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Enum_2Enum ) @ V1s ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V6n ) ) ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) @ V0x ) @ V2f ) ) ) ) )
