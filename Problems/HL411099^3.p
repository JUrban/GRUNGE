...
thf(thm_2Ereal__topology_2ECOMPACT__FRONTIER__BOUNDED,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
     => ( c_2Ereal__topology_2Ecompact @ ( c_2Ereal__topology_2Efrontier @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__FRONTIER,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Ebounded__def @ V0s )
     => ( c_2Ereal__topology_2Ebounded__def @ ( c_2Ereal__topology_2Efrontier @ V0s ) ) ) )).
