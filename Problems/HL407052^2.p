...
thf(conj_thm_2Epatricia__casts_2El2n__11,lemma,(
...
thf(conj_thm_2Epatricia__casts_2EEVERY__MAP__ORD,lemma,(
    ! [V0l: tp__c_ty_2Elist_2Elist_ty_2Estring_2Echar] :
      ( p @ ( ap @ ( ap @ ( c_2Elist_2EEVERY @ ty_2Enum_2Enum ) @ ( ap @ c_2Earithmetic_2E_3E @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2EMAP @ ty_2Estring_2Echar @ ty_2Enum_2Enum ) @ c_2Estring_2EORD ) @ ( inj__c_ty_2Elist_2Elist_ty_2Estring_2Echar @ V0l ) ) ) ) )).

thf(conj_thm_2Epatricia__casts_2EMAP__11,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ! [V1l1: $i] :
          ( ( mem @ V1l1 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Epatricia__casts_2EREVERSE__11,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
thf(conj_thm_2Epatricia__casts_2Estring__to__num__11,conjecture,(
