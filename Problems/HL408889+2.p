...
fof(conj_thm_2EHolSmt_2Et013,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Einteger_2Eint)
     => ( ~ p(ap(ap(c_2Einteger_2Eint__ge,V0x),ap(c_2Einteger_2Eint__of__num,c_2Enum_2E0)))
        | p(ap(ap(c_2Einteger_2Eint__ge,V0x),ap(c_2Einteger_2Eint__neg,ap(c_2Einteger_2Eint__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))) ) ) )).
