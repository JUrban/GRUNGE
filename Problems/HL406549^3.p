...
thf(c_2Ewords_2Ebit__count__upto,type,(
    c_2Ewords_2Ebit__count__upto: 
      !>[A_27a: $tType] :
        ( tyop_2Enum_2Enum > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > tyop_2Enum_2Enum ) )).
...
thf(thm_2Ewords_2Ebit__count__upto__is__zero,axiom,(
    ...
    <=> ! [V2i: tyop_2Enum_2Enum] :
         ...
         => ( (~) @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V1w @ V2i ) ) ) ) )).

thf(thm_2Ealignment_2Ealigned__bit__count__upto,conjecture,(
    ! [A_27a: $tType,V0p: tyop_2Enum_2Enum,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ( ( c_2Ealignment_2Ealigned @ A_27a @ V0p @ V1w )
    <=> ( ( c_2Ewords_2Ebit__count__upto @ A_27a @ ( c_2Earithmetic_2EMIN @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ V0p ) @ V1w )
        = c_2Enum_2E0 ) ) )).
