...
fof(conj_thm_2Epred__set_2ECARD__BIGUNION__SAME__SIZED__SETS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
         ...
         => ! [V1s] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(arr(A_27a,bool)),V1s))
                  & ! [V2e] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2e),V1s))
                       => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2e))
                          & ap(c_2Epred__set_2ECARD(A_27a),V2e) = V0n ) ) )
                  & ! [V3e1] :
               ...
               => ap(c_2Epred__set_2ECARD(A_27a),ap(c_2Epred__set_2EBIGUNION(A_27a),V1s)) = ap(ap(c_2Earithmetic_2E_2A,ap(c_2Epred__set_2ECARD(arr(A_27a,bool)),V1s)),V0n) ) ) ) ) )).
