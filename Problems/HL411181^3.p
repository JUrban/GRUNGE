...
thf(thm_2Ereal__topology_2Euniformly__continuous__on,axiom,(
    ...
    <=> ! [V2e: tyop_2Erealax_2Ereal] :
         ...
         => ? [V3d: tyop_2Erealax_2Ereal] :
              ...
              & ! [V4x: tyop_2Erealax_2Ereal,V5x_27: tyop_2Erealax_2Ereal] :
                  ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V1s )
                    & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x_27 @ V1s )
                    & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V5x_27 @ V4x ) ) @ V3d ) )
                 => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V5x_27 ) @ ( V0f @ V4x ) ) ) @ V2e ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EBILINEAR__UNIFORMLY__CONTINUOUS__ON__COMPOSE,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2h: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V3s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Ereal__topology_2Euniformly__continuous__on @ V0f @ V3s )
        & ( c_2Ereal__topology_2Euniformly__continuous__on @ V1g @ V3s )
        & ( c_2Ereal__topology_2Ebilinear @ V2h )
        & ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V0f @ V3s ) )
        & ( c_2Ereal__topology_2Ebounded__def @ ( c_2Epred__set_2EIMAGE @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V1g @ V3s ) ) )
     => ( c_2Ereal__topology_2Euniformly__continuous__on
