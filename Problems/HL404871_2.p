...
tff(conj_thm_2EternaryComparisons_2Eordering__Axiom,conjecture,(
    ! [A_27a: del,V0x0: $i] :
      ( mem(V0x0,A_27a)
     => ! [V1x1: $i] :
          ( mem(V1x1,A_27a)
         => ! [V2x2: $i] :
             ...
             => ? [V3f: $i] :
                  ...
                  & ap(V3f,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS)) = V0x0
                  & ap(V3f,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2EEQUAL)) = V1x1
                  & ap(V3f,inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2EGREATER)) = V2x2 ) ) ) ) )).
