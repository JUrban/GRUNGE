...
tff(conj_thm_2Ereal_2ENUM__FLOOR__LE,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,ap(c_2Ereal_2ENUM__FLOOR,inj__ty_2Erealax_2Ereal(V0x)))),inj__ty_2Erealax_2Ereal(V0x))) ) )).
