...
thf(thm_2Equotient__pred__set_2EDELETER__def,axiom,(
    ! [A_27a: $tType,V0R: A_27a > A_27a > $o,V1s: A_27a > $o,V2x: A_27a] :
      ...
      = ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
        @ ^ [V3y: A_27a] :
            ( c_2Epair_2E_2C @ A_27a @ $o @ V3y @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V3y @ V1s ) @ ( c_2Ebool_2E_7E @ ( V0R @ V2x @ V3y ) ) ) ) ) ) )).

thf(thm_2Equotient__pred__set_2EIN__DELETER,conjecture,(
