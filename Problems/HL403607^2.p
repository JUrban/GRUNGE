          ...
          @ ^ [V0f: $i] :
              ...
              @ ( lam @ A_27a
                @ ^ [V1x: $i] :
                    ...
                    @ ( lam @ ty_2Enum_2Enum
                      @ ^ [V2n: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ V2n ) @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ ( ap @ V0f @ V2n ) ) @ V1x ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Efcp_2ECART__EQ,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Efcp_2Ecart @ A_27a @ A_27b ) )
     => ! [V1y: $i] :
