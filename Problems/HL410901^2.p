...
thf(conj_thm_2Epred__set_2EIMAGE__11__INFINITE,lemma,(
...
thf(ax_thm_2Ereal__topology_2Elimit__point__of,axiom,(
...
thf(conj_thm_2Ereal__topology_2EINFINITE__FROM,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ~ ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ty_2Enum_2Enum ) @ ( ap @ c_2Ereal__topology_2Efrom @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EINFINITE__SUPERSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ELIMPT__INFINITE__OPEN__BALL__CBALL,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ! [V1x: tp__ty_2Erealax_2Ereal] :
