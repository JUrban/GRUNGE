...
tff(lmtp_f3250,type,(
    f3250: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3250,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3250(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3250,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3250(V0c),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V0c))) )).

tff(lmtp_f3251,type,(
    f3251: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3251,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3251(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f3251,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal] : ap(f3251(V0c),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V0c)),inj__ty_2Erealax_2Ereal(V2x))) )).

tff(conj_thm_2Eutil__prob_2EPREIMAGE__REAL__COMPL3,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : ap(c_2Epred__set_2ECOMPL(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3250(V0c))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3251(V0c)) )).
