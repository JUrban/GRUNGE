...
thf(conj_thm_2Ereal__topology_2ECLOSED__IN__SUBTOPOLOGY,lemma,(
    ! [A_27a: del,V0top: $i] :
...
thf(conj_thm_2Etopology_2ECLOSED__IN__SUBSET,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Etopology_2ECLOSED__IN__TOPSPACE,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ A_27a ) @ V0top ) @ ( ap @ ( c_2Etopology_2Etopspace @ A_27a ) @ V0top ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSED__IN__SUBTOPOLOGY__REFL,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1u: $i] :
          ( ( mem @ V1u @ ( arr @ A_27a @ bool ) )
