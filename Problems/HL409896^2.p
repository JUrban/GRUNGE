...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__NEG,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ( ( p
          @ ( ap @ c_2Eiterate_2Epolynomial__function
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V1x: $i] :
                  ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ V0p @ V1x ) ) ) ) )
      <=> ( p @ ( ap @ c_2Eiterate_2Epolynomial__function @ V0p ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUB,conjecture,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1q: $i] :
          ( ( mem @ V1q @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
         => ( ( ( p @ ( ap @ c_2Eiterate_2Epolynomial__function @ V0p ) )
           ...
           => ( p
              @ ( ap @ c_2Eiterate_2Epolynomial__function
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ V0p @ V2x ) ) @ ( ap @ V1q @ V2x ) ) ) ) ) ) ) ) )).
