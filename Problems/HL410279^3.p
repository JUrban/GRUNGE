...
thf(thm_2Emeasure_2EIN__MEASURABLE__BOREL__MONO__SUP,conjecture,(
    ! [A_27a: $tType,V0fn: tyop_2Enum_2Enum > A_27a > tyop_2Eextreal_2Eextreal,V1f: A_27a > tyop_2Eextreal_2Eextreal,V2a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( ( c_2Emeasure_2Esigma__algebra @ A_27a @ V2a )
        & ! [V3n: tyop_2Enum_2Enum] :
            ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ ( V0fn @ V3n ) @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ V2a @ c_2Emeasure_2EBorel ) )
        & ! [V4n: tyop_2Enum_2Enum,V5x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V5x @ ( c_2Emeasure_2Espace @ A_27a @ V2a ) )
           => ( c_2Eextreal_2Eextreal__le @ ( V0fn @ V4n @ V5x ) @ ( V0fn @ ( c_2Enum_2ESUC @ V4n ) @ V5x ) ) )
        & ! [V6x: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V6x @ ( c_2Emeasure_2Espace @ A_27a @ V2a ) )
           => ( ( V1f @ V6x )
     ...
     => ( c_2Ebool_2EIN @ ( A_27a > tyop_2Eextreal_2Eextreal ) @ V1f @ ( c_2Emeasure_2Emeasurable @ A_27a @ tyop_2Eextreal_2Eextreal @ V2a @ c_2Emeasure_2EBorel ) ) ) )).
