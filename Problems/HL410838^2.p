            ...
            @ ( lam @ ty_2Erealax_2Ereal
              @ ^ [V2b: $i] :
                  ...
                  @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Erealax_2Ereal )
                    @ ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3c: $i] :
                          ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ V3c ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ V2b ) @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ V3c ) @ ( inj__ty_2Erealax_2Ereal @ V1v ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EIN__DIRECTION,conjecture,(
