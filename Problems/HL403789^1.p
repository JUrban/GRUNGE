...
thf(f4113_0_2E0,type,(
    f4113_0_2E0: u )).

thf(f4113_0_2E1,type,(
    f4113_0_2E1: du > u )).
...
thf(mono_2Ef4113_0,type,(
    mono_2Ef4113_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ellist_2Elrep__ok__cases,axiom,(
...
thf(thm_2Ellist_2Elrep__ok__cases,conjecture,(
    ! [A_27a: d,V0a0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0a0_2E0 ) ) ) )
    <=> ( ! [V1x: mono_2Etyop_2Enum_2Enum] :
            ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V1x ) ) ) )
            = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) )
        | ? [V2h_2E0: u,V3t_2E0: u] :
            ( ! [V4x: mono_2Etyop_2Enum_2Enum] :
                ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V0a0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4x ) ) ) )
                = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4113_0 @ V4x ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V2h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V3t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V4x @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V3t_2E0 ) ) ) ) ) ) ) )).
