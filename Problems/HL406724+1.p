...
fof(thm_2EOmega_2Eeval__step__extra2,conjecture,(
    ! [V0x_2E0,V1ups_2E0,V2lows_2E0,V3ex_27_2E0,V4ex_2E0] :
      ( ( p(s(tyop_2Emin_2Ebool,c_2EOmega_2Eevalupper_2E2(s(tyop_2Einteger_2Eint,V0x_2E0),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(tyop_2Enum_2Enum,tyop_2Einteger_2Eint)),V1ups_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2EOmega_2Eevallower_2E2(s(tyop_2Einteger_2Eint,V0x_2E0),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(tyop_2Enum_2Enum,tyop_2Einteger_2Eint)),V2lows_2E0))))
        & p(s(tyop_2Emin_2Ebool,V4ex_2E0))
        & p(s(tyop_2Emin_2Ebool,V3ex_27_2E0)) )
    <=> ( p(s(tyop_2Emin_2Ebool,c_2EOmega_2Eevalupper_2E2(s(tyop_2Einteger_2Eint,V0x_2E0),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(tyop_2Enum_2Enum,tyop_2Einteger_2Eint)),V1ups_2E0))))
        & p(s(tyop_2Emin_2Ebool,c_2EOmega_2Eevallower_2E2(s(tyop_2Einteger_2Eint,V0x_2E0),s(tyop_2Elist_2Elist(tyop_2Epair_2Eprod(tyop_2Enum_2Enum,tyop_2Einteger_2Eint)),V2lows_2E0))))
        & p(s(tyop_2Emin_2Ebool,V4ex_2E0))
        & p(s(tyop_2Emin_2Ebool,V3ex_27_2E0)) ) ) )).
