...
thf(c_2Ewords_2Ereduce__nand,type,(
    c_2Ewords_2Ereduce__nand: 
      !>[A_27a: $tType] :
        ( ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) ) )).
...
thf(c_2Ewords_2Eword__reduce,type,(
    c_2Ewords_2Eword__reduce: 
      !>[A_27a: $tType] :
        ( ( $o > $o > $o ) > ( tyop_2Efcp_2Ecart @ $o @ A_27a ) > ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) ) )).
...
thf(thm_2Ewords_2Eword__nand__def,axiom,(
    ! [A_27a: $tType,V0v: tyop_2Efcp_2Ecart @ $o @ A_27a,V1w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ...
      = ( c_2Efcp_2EFCP @ $o @ A_27a
        @ ^ [V2i: tyop_2Enum_2Enum] :
            ( c_2Ebool_2E_7E @ ( c_2Ebool_2E_2F_5C @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V0v @ V2i ) @ ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V1w @ V2i ) ) ) ) ) )).
      ...
      = ( c_2Efcp_2EFCP @ $o @ tyop_2Eone_2Eone
        @ ( c_2Ecombin_2EK @ $o @ tyop_2Enum_2Enum
          @ ( c_2Ebool_2ELET @ ( tyop_2Elist_2Elist @ $o ) @ $o
            @ ^ [V2l: tyop_2Elist_2Elist @ $o] :
                ( c_2Elist_2EFOLDL @ $o @ $o @ V0f @ ( c_2Elist_2EHD @ $o @ V2l ) @ ( c_2Elist_2ETL @ $o @ V2l ) )
            @ ( c_2Elist_2EGENLIST @ $o
              @ ^ [V3i: tyop_2Enum_2Enum] :
                  ( c_2Efcp_2Efcp__index @ $o @ A_27a @ V1w @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ ( c_2Efcp_2Edimindex @ A_27a @ ( c_2Ebool_2Ethe__value @ A_27a ) ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ V3i ) )
...
thf(thm_2Ewords_2Ereduce__nand__def,axiom,(
    ! [A_27a: $tType] :
      ...
      = ( c_2Ewords_2Eword__reduce @ A_27a
        @ ^ [V0a: $o,V1b: $o] :
            ( c_2Ebool_2E_7E @ ( c_2Ebool_2E_2F_5C @ V0a @ V1b ) ) ) ) )).
...
thf(thm_2Ewords_2Efoldl__reduce__nand,conjecture,(
    ! [A_27a: $tType,V0w: tyop_2Efcp_2Ecart @ $o @ A_27a] :
      ...
      = ( c_2Ebool_2ELET @ ( tyop_2Elist_2Elist @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) ) @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone )
        @ ^ [V1l: tyop_2Elist_2Elist @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone )] :
            ( c_2Elist_2EFOLDL @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ ( c_2Ewords_2Eword__nand @ tyop_2Eone_2Eone ) @ ( c_2Elist_2EHD @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ V1l ) @ ( c_2Elist_2ETL @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone ) @ V1l ) )
        @ ( c_2Elist_2EGENLIST @ ( tyop_2Efcp_2Ecart @ $o @ tyop_2Eone_2Eone )
          @ ^ [V2i: tyop_2Enum_2Enum] :
              ...
              @ ^ [V3n: tyop_2Enum_2Enum] :
                  ( c_2Ewords_2Eword__extract @ A_27a @ tyop_2Eone_2Eone @ V3n @ V3n @ V0w )
