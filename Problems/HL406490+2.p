...
fof(conj_thm_2Enumposrep_2EBIT__num__from__bin__list,lemma,(
    ! [V0x] :
...
fof(conj_thm_2Ebitstring_2Eevery__bit__bitify,lemma,(
    ! [V0v] :
      ( mem(V0v,ty_2Elist_2Elist(bool))
...
fof(conj_thm_2Ebitstring_2En2w__v2n,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
