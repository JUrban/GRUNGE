...
fof(conj_thm_2Ereal__topology_2ESERIES__FINITE__SUPPORT,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESERIES__SUM,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l] :
             ...
             => ! [V3s] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V3s))
                      ...
                      & ! [V4x] :
                         ...
                         => ( ~ p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V4x),V3s))
                           => ap(V0f,V4x) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) )
                      & ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),V3s),V0f) = V1l )
                   => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V1l),V2k)) ) ) ) ) ) )).
