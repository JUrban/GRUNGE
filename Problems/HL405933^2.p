...
thf(tp_c_2Erich__list_2EAND__EL,type,(
    c_2Erich__list_2EAND__EL: $i )).

thf(mem_c_2Erich__list_2EAND__EL,axiom,(
    mem @ c_2Erich__list_2EAND__EL @ ( arr @ ( ty_2Elist_2Elist @ bool ) @ bool ) )).

thf(stp_fo_c_2Erich__list_2EAND__EL,type,(
    fo__c_2Erich__list_2EAND__EL: tp__c_ty_2Elist_2Elist_o > $o )).

thf(stp_eq_fo_c_2Erich__list_2EAND__EL,axiom,(
    ! [X0: tp__c_ty_2Elist_2Elist_o] :
      ( ( inj__o @ ( fo__c_2Erich__list_2EAND__EL @ X0 ) )
      = ( ap @ c_2Erich__list_2EAND__EL @ ( inj__c_ty_2Elist_2Elist_o @ X0 ) ) ) )).
...
thf(ax_thm_2Erich__list_2EAND__EL__DEF,axiom,
    ( c_2Erich__list_2EAND__EL
    = ( ap @ ( c_2Elist_2EEVERY @ bool ) @ ( c_2Ecombin_2EI @ bool ) ) )).

thf(conj_thm_2Erich__list_2EAND__EL__FOLDL,lemma,(
...
thf(conj_thm_2Ewords_2ENOT__UINTMAXw,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Ewords_2Ereduce__and,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
