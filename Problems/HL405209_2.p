...
tff(conj_thm_2Efinite__map_2EIN__FRANGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1v: $i] :
          ( mem(V1v,A_27b)
...
tff(conj_thm_2Ealist_2EALOOKUP__IN__FRANGE,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
     ...
     => ! [V1k: $i] :
         ...
         => ! [V2v: $i] :
              ( mem(V2v,A_27b)
             => ( ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0ls),V1k) = ap(c_2Eoption_2ESOME(A_27b),V2v)
               => p(ap(ap(c_2Ebool_2EIN(A_27b),V2v),ap(c_2Efinite__map_2EFRANGE(A_27a,A_27a),ap(c_2Ealist_2Ealist__to__fmap(A_27a,A_27a),V0ls)))) ) ) ) ) )).
