...
thf(tp_c_2Emergesort_2Emergesort__tail,type,(
    c_2Emergesort_2Emergesort__tail: del > $i )).

thf(mem_c_2Emergesort_2Emergesort__tail,axiom,(
    ! [A_27a: del] :
...
thf(tp_c_2Emergesort_2EmergesortN__tail,type,(
    c_2Emergesort_2EmergesortN__tail: del > $i )).

thf(mem_c_2Emergesort_2EmergesortN__tail,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Emergesort_2Emergesort__tail__def,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Emergesort_2Emergesort__tail @ A_27a ) @ V0R ) @ V1l )
            = ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2EmergesortN__tail @ A_27a ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ V0R ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) @ V1l ) ) ) ) )).

thf(conj_thm_2Emergesort_2EmergesortN__correct,lemma,(
    ! [A_27a: del,V0negate: $o,V1R: $i] :
      ( ( mem @ V1R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V2n: tp__ty_2Enum_2Enum,V3l: $i] :
          ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ( p @ ( ap @ ( c_2Erelation_2Etotal @ A_27a ) @ V1R ) )
              & ( p @ ( ap @ ( c_2Erelation_2Etransitive @ A_27a ) @ V1R ) ) )
           => ( ( ap @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2EmergesortN__tail @ A_27a ) @ ( inj__o @ V0negate ) ) @ V1R ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3l )
              = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( inj__o @ V0negate ) ) @ ( ap @ ( c_2Elist_2EREVERSE @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2EmergesortN @ A_27a ) @ V1R ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3l ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Emergesort_2EmergesortN @ A_27a ) @ V1R ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V3l ) ) ) ) ) ) )).

thf(conj_thm_2Emergesort_2Emergesort__tail__correct,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1l: $i] :
          ( ( mem @ V1l @ ( ty_2Elist_2Elist @ A_27a ) )
