...
thf(c_2EindexedLists_2EMAPi__ACC_2E0,type,(
    c_2EindexedLists_2EMAPi__ACC_2E0: u )).

thf(c_2EindexedLists_2EMAPi__ACC_2E4,type,(
...
thf(arityeq4_2Emono_2Ec_2EindexedLists_2EMAPi__ACC_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1: mono_2Etyop_2Enum_2Enum,X2_2E0: u,X3_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X3_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27b ) @ ( tyop_2Elist_2Elist @ A_27a ) ) ) ) ) @ c_2EindexedLists_2EMAPi__ACC_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ X0_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X1 ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ X3_2E0 ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMAPi__ACC__MAPi,axiom,(
    ! [A_27a: d,A_27b: d,V0n: mono_2Etyop_2Enum_2Enum,V1l_2E0: u,V2f_2E0: u,V3a_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V2f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3a_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V1l_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EREVERSE_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3a_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V2f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Enum_2Enum_29 @ ( mono_2Ec_2Earithmetic_2E_2B @ V0n ) ) ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V1l_2E0 ) ) ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMAPi__compute,conjecture,(
    ! [A_27a: d,A_27b: d,V0l_2E0: u,V1f_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V0l_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi__ACC_2E4 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V0l_2E0 ) ) ) ) )).
