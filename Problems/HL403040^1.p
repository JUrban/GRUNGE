...
thf(thm_2EindexedLists_2ELIST__RELi__cases,conjecture,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1a0_2E0: u,V2a1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EindexedLists_2ELIST__RELi_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2a1_2E0 ) ) ) )
    <=> ( ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a0_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) )
          & ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2a1_2E0 )
            = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 ) ) )
        | ? [V3h1_2E0: u,V4h2_2E0: u,V5l1_2E0: u,V6l2_2E0: u] :
            ( ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1a0_2E0 )
              = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ V3h1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) ) ) ) ) )
            & ( ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2a1_2E0 )
              = ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V6l2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27b @ V4h2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ c_2Elist_2ENIL_2E0 ) ) ) ) ) )
            ...
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2EindexedLists_2ELIST__RELi_2E3 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) ) @ V0R_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V5l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V6l2_2E0 ) ) ) ) ) ) ) )).
