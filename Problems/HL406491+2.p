...
fof(lamtp_f2305,axiom,(
    mem(f2305,arr(ty_2Enum_2Enum,bool)) )).

fof(lameq_f2305,axiom,(
    ! [V2n] :
      ( mem(V2n,ty_2Enum_2Enum)
     => ap(f2305,V2n) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2n),c_2Enum_2E0)) ) )).

fof(conj_thm_2Ebitstring_2Eboolify__reverse__map,lemma,(
    ! [V0v] :
      ( mem(V0v,ty_2Elist_2Elist(ty_2Enum_2Enum))
     => ! [V1a] :
          ( mem(V1a,ty_2Elist_2Elist(bool))
         => ap(ap(c_2Ebitstring_2Eboolify,V1a),V0v) = ap(ap(c_2Elist_2EAPPEND(bool),ap(c_2Elist_2EREVERSE(bool),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),f2305),V0v))),V1a) ) ) )).
...
fof(conj_thm_2Ebitstring_2Ev2n__n2v,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
