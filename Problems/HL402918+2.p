...
fof(conj_thm_2Enumposrep_2El2n__eq__0,conjecture,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V0b))
       => ! [V1l] :
           ...
           => ( ap(ap(c_2Enumposrep_2El2n,V0b),V1l) = c_2Enum_2E0
            <=> p(ap(ap(c_2Elist_2EEVERY(ty_2Enum_2Enum),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emin_2E_3D(ty_2Enum_2Enum),c_2Enum_2E0)),ap(ap(c_2Ecombin_2EC(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),c_2Earithmetic_2EMOD),V0b))),V1l)) ) ) ) ) )).
