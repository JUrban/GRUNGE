...
thf(f8865_0_2E0,type,(
    f8865_0_2E0: u )).

thf(f8865_0_2E1,type,(
    f8865_0_2E1: du > u )).

thf(f8865_0_2E2,type,(
    f8865_0_2E2: du > du > u )).
...
thf(mono_2Ef8865_0,type,(
    mono_2Ef8865_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal_2EREAL__SUP__CONST,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1r: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef8865_0 @ V0x @ V1r )
    <=> ( V1r = V0x ) ) )).

thf(thm_2Ereal_2EREAL__SUP__CONST,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ef8865_0 @ V0x ) )
      = V0x ) )).
