...
thf(thm_2Ereal__topology_2ELOCALLY__SING,conjecture,(
    ! [V0P: ( tyop_2Erealax_2Ereal > $o ) > $o,V1a: tyop_2Erealax_2Ereal] :
      ( ( c_2Ereal__topology_2Elocally @ V0P @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) )
      = ( V0P @ ( c_2Epred__set_2EINSERT @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Epred__set_2EEMPTY @ tyop_2Erealax_2Ereal ) ) ) ) )).
