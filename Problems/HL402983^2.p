...
thf(conj_thm_2EpatternMatches_2ELENGTH__STRONGEST__REDUNDANT__ROWS__INFO__AUX,conjecture,(
    ! [A_27a: del,A_27b: del,V0v: $i] :
     ...
     => ! [V1rows: $i] :
         ...
         => ! [V2p: $o,V3infos: tp__c_ty_2Elist_2Elist_o] :
              ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ bool ) @ ( ap @ ( c_2Epair_2ESND @ bool @ ( ty_2Elist_2Elist @ bool ) ) @ ( ap @ ( ap @ ( ap @ ( ap @ ( c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX @ A_27a @ A_27b ) @ V0v ) @ V1rows ) @ ( inj__o @ V2p ) ) @ ( inj__c_ty_2Elist_2Elist_o @ V3infos ) ) ) ) )
