...
tff(conj_thm_2Elist_2ESUM__MAP__PLUS,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2ls: $i] :
             ...
             => surj__ty_2Enum_2Enum(ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),f453(A_27a,V0f,V1g)),V2ls))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V0f),V2ls))),ap(c_2Elist_2ESUM,ap(ap(c_2Elist_2EMAP(A_27a,A_27a),V1g),V2ls)))) ) ) ) )).
