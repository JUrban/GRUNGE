...
tff(conj_thm_2Epred__set_2EBIJ__INSERT,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1e: $i] :
          ( mem(V1e,A_27a)
             ...
             => ! [V3t: $i] :
                 ...
                 => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),ap(ap(c_2Epred__set_2EINSERT(A_27a),V1e),V2s)),V3t))
                  <=> ( ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V1e),V2s))
                        ...
                        & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),V2s),ap(ap(c_2Epred__set_2EDELETE(A_27b),V3t),ap(V0f,V1e)))) )
                      | ( p(ap(ap(c_2Ebool_2EIN(A_27a),V1e),V2s))
...
tff(conj_thm_2Epred__set_2EBIJ__FINITE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
