...
tff(conj_thm_2Ereal__topology_2ESUBTOPOLOGY__UNIV,lemma,(
    ! [A_27a: del,V0top: $i] :
...
tff(conj_thm_2Ereal__topology_2EINTERIOR__COMPLEMENT,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__UNIV,lemma,(
    p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),c_2Epred__set_2EUNIV(ty_2Erealax_2Ereal))) )).
...
tff(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION__CLOSED,conjecture,(
    ! [V0g: $i] :
      ( mem(V0g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V0g))
          & ! [V1s: $i] :
              ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
             => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1s),V0g))
               => ( p(ap(c_2Ereal__topology_2EClosed,V1s))
                  & ap(c_2Ereal__topology_2Einterior,V1s) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) ) )
       => ap(c_2Ereal__topology_2Einterior,ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0g)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )).
