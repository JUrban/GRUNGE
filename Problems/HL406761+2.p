...
fof(conj_thm_2Epatricia_2EPTREE__OF__NUMSET__IS__PTREE__EMPTY,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Epatricia_2EIN__PTREE__EMPTY,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ~ p(ap(ap(c_2Epatricia_2EIN__PTREE,V0n),c_2Epatricia_2EEmpty(ty_2Eone_2Eone))) ) )).

fof(conj_thm_2Epatricia_2EPTREE__EXTENSION,lemma,(
    ! [V0t1] :
...
fof(conj_thm_2Epatricia_2EPTREE__OF__NUMSET__NUMSET__OF__PTREE,conjecture,(
    ! [V0t] :
      ( mem(V0t,ty_2Epatricia_2Eptree(ty_2Eone_2Eone))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Enum_2Enum,bool))
