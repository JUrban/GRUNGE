...
fof(conj_thm_2Edft_2EDFT__REACH__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0G] :
          ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
...
fof(conj_thm_2Edft_2EDFT__REACH__2,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0G] :
          ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
...
fof(conj_thm_2Edft_2EDFT__REACH__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0G] :
          ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
             ...
             => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2EdirGraph_2EParents(A_27a,A_27a),V0G)))
               => ! [V2x] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(ap(c_2EdirGraph_2EREACH__LIST(A_27a),V0G),V1to__visit)))
                    <=> p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(ap(ap(ap(c_2Edft_2EDFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),c_2Elist_2ECONS(A_27a)),c_2Elist_2ENIL(A_27a)),V1to__visit),c_2Elist_2ENIL(A_27a))))) ) ) ) ) ) ) )).
