...
fof(conj_thm_2Ereal__topology_2ELINEAR__IMAGE__SUBSET__INTERIOR,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EIN__INTERIOR__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
         ...
         => ! [V2s] :
             ...
             => ! [V3x] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
                   ...
                   => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(V0f,V3x)),ap(c_2Ereal__topology_2Einterior,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2s)))) ) ) ) ) ) )).
