...
thf(thm_2EdefCNF_2EBIGSTEP,conjecture,(
    ! [V0P: ( mono_2Etyop_2Enum_2Enum > $o ) > $o,V1Q: $o,V2R: ( mono_2Etyop_2Enum_2Enum > $o ) > $o] :
      ( ! [V3v: mono_2Etyop_2Enum_2Enum > $o] :
          ( ( V0P @ V3v )
         => ( V1Q
            = ( V2R @ V3v ) ) )
     => ( ( ? [V4v: mono_2Etyop_2Enum_2Enum > $o] :
              ( V0P @ V4v )
          & V1Q )
      <=> ? [V5v: mono_2Etyop_2Enum_2Enum > $o] :
            ( ( V0P @ V5v )
            & ( V2R @ V5v ) ) ) ) )).
