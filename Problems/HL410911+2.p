...
fof(conj_thm_2Ereal__topology_2ELIM__LINEAR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
             ...
             => ! [V2f] :
                 ...
                 => ! [V3l] :
                     ...
                     => ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V2f),V3l),V0net))
                       ...
                       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3741(A_27a,V2f,V1h)),ap(V1h,V3l)),V0net)) ) ) ) ) ) ) )).
