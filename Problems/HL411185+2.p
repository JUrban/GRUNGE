...
fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__CMUL,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c] :
          ( mem(V1c,ty_2Erealax_2Ereal)
         => ! [V2s] :
             ...
             => ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V2s))
               => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f3829(V0f,V1c)),V2s)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__NEG,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,V0f),V1s))
           => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,f2908(V0f)),V1s)) ) ) ) )).
