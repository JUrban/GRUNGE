...
thf(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EDECREASING__CLOSED__NEST__SING,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) )
     => ( ( ! [V1n: tp__ty_2Enum_2Enum] :
              ( p @ ( ap @ c_2Ereal__topology_2EClosed @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
            ...
            ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                @ ( lam @ ( arr @ ty_2Erealax_2Ereal @ bool )
                  @ ^ [V10t: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ V10t )
                      @ ( ap @ ( c_2Ebool_2E_3F @ ty_2Enum_2Enum )
                        @ ( lam @ ty_2Enum_2Enum
                          @ ^ [V11n: $i] :
                              ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V10t ) @ ( ap @ V0s @ V11n ) ) ) ) ) ) ) )
            = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V9a ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).
