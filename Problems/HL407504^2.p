...
thf(conj_thm_2Ereal_2EREAL__IMP__LE__SUP,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( ? [V2r: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EREAL__SUP__CONST,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal
        @ ( ap @ c_2Ereal_2Esup
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1r: $i] :
                ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ V1r ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )
      = V0x ) )).
