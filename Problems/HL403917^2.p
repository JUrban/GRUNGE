...
thf(tp_c_2Ellist_2Eexists,type,(
    c_2Ellist_2Eexists: del > $i )).

thf(mem_c_2Ellist_2Eexists,axiom,(
    ! [A_27a: del] :
...
thf(conj_thm_2Ellist_2Eexists__thm,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1h: $i] :
          ( ( mem @ V1h @ A_27a )
...
thf(ax_thm_2Ellist_2ELFILTER,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ll: $i] :
          ( ( mem @ V1ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ V1ll )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Ellist_2Eexists @ A_27a ) @ V0P ) @ V1ll ) ) ) @ ( c_2Ellist_2ELNIL @ A_27a ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ V0P @ ( ap @ ( c_2Eoption_2ETHE @ A_27a ) @ ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ V1ll ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ ( ap @ ( c_2Eoption_2ETHE @ A_27a ) @ ( ap @ ( c_2Ellist_2ELHD @ A_27a ) @ V1ll ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V1ll ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELFILTER @ A_27a ) @ V0P ) @ ( ap @ ( c_2Eoption_2ETHE @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( c_2Ellist_2ELTL @ A_27a ) @ V1ll ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELFILTER__THM,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0P: $i] :
          ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
