...
tff(lameq_f919,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V5t: tp__ty_2Enum_2Enum] : ap(f919(V0a,V1b),inj__ty_2Enum_2Enum(V5t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V5t)))),ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V5t)))) ) ) )).

tff(lmtp_f918,type,(
    f918: ( $i * $i ) > $i )).

tff(lamtp_f918,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
...
tff(lameq_f918,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t0: tp__ty_2Enum_2Enum] : ap(f918(V0a,V1b),inj__ty_2Enum_2Enum(V2t0)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f893(V1b)),f894(V0a,V1b)),inj__ty_2Enum_2Enum(V2t0))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f919(V0a,V1b)),inj__ty_2Enum_2Enum(V2t0))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EBEFORE__AS__SWHEN,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
