...
thf(f12664_0_2E0,type,(
    f12664_0_2E0: u )).

thf(f12664_0_2E2,type,(
    f12664_0_2E2: du > du > u )).

thf(f12664_0_2E3,type,(
    f12664_0_2E3: du > du > du > u )).
...
thf(mono_2Ef12664_0,type,(
    mono_2Ef12664_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2Einfsum,axiom,(
    ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V0s: mono_2Etyop_2Enum_2Enum > $o,V2l: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12664_0 @ V1f @ V0s @ V2l )
      = ( mono_2Ec_2Ereal__topology_2Esums @ V1f @ V2l @ V0s ) ) )).

thf(thm_2Ereal__topology_2Einfsum,axiom,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > $o,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V0s @ V1f )
      = ( mono_2Ec_2Emin_2E_40_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12664_0 @ V1f @ V0s ) ) ) )).
...
thf(thm_2Ereal__topology_2ESUMS__EQ,axiom,(
    ! [V0l: mono_2Etyop_2Erealax_2Ereal,V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3k: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ! [V4x: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V4x @ V3k )
           => ( ( V1f @ V4x )
              = ( V2g @ V4x ) ) )
        & ( mono_2Ec_2Ereal__topology_2Esums @ V1f @ V0l @ V3k ) )
     => ( mono_2Ec_2Ereal__topology_2Esums @ V2g @ V0l @ V3k ) ) )).
...
thf(thm_2Ereal__topology_2EINFSUM__EQ,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1g: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2k: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esummable @ V2k @ V0f )
        & ( mono_2Ec_2Ereal__topology_2Esummable @ V2k @ V1g )
        & ! [V3x: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Enum_2Enum @ V3x @ V2k )
           => ( ( V0f @ V3x )
              = ( V1g @ V3x ) ) ) )
     => ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V2k @ V0f )
        = ( mono_2Ec_2Ereal__topology_2Einfsum @ V2k @ V1g ) ) ) )).
