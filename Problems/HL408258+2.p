...
fof(conj_thm_2Etransc_2EEXP__INJ,lemma,(
    ! [V0x] :
...
fof(lamtp_f2982,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2982(V0x),arr(ty_2Erealax_2Ereal,bool)) ) )).
...
fof(lameq_f2982,axiom,(
    ! [V0x] :
     ...
     => ! [V1u] :
         ...
         => ap(f2982(V0x),V1u) = ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Etransc_2Eexp,V1u)),V0x) ) ) )).

fof(ax_thm_2Etransc_2Eln,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Etransc_2Eln,V0x) = ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2982(V0x)) ) )).

fof(conj_thm_2Etransc_2ELN__EXP,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
