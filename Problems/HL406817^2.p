...
thf(conj_thm_2Etc_2ESUBSET__FDOM__LEM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Etc_2EsubTC__FDOM__RDOM,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( ty_2Efinite__map_2Efmap @ A_27a @ ( arr @ A_27a @ bool ) ) )
         => ( ( ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27a @ ( arr @ A_27a @ bool ) ) @ V1f ) )
              = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ V1f ) )
           => ( ( ap @ ( ap @ ( c_2Etc_2EsubTC @ A_27a ) @ V0R ) @ ( ap @ ( c_2Erelation_2ERDOM @ A_27a @ A_27a ) @ V0R ) )
              = ( ap @ ( c_2Etc_2EFMAP__TO__RELN @ A_27a ) @ V1f ) ) ) ) ) )).
