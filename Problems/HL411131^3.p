...
thf(thm_2Ereal__topology_2ECONTINUOUS__TRANSFORM__WITHIN__OPEN,conjecture,(
    ! [V0f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o,V3a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2EOpen @ V2s )
        & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3a @ V2s )
        & ! [V4x: tyop_2Erealax_2Ereal] :
           ...
           => ( ( V0f @ V4x )
              = ( V1g @ V4x ) ) )
        & ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V0f @ ( c_2Ereal__topology_2Eat @ V3a ) ) )
     => ( c_2Ereal__topology_2Econtinuous @ tyop_2Erealax_2Ereal @ V1g @ ( c_2Ereal__topology_2Eat @ V3a ) ) ) )).
