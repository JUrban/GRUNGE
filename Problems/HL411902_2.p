...
tff(lameq_f3928,axiom,(
    ! [V2s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V6u: $i] :
              ( mem(V6u,arr(ty_2Erealax_2Ereal,bool))
             => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f3928(V2s,V0f,V6u),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V2s)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),V6u))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS__EXPLICIT,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ( ! [V3x: tp__ty_2Erealax_2Ereal] :
               ...
               => ! [V8x: tp__ty_2Erealax_2Ereal,V9e: tp__ty_2Erealax_2Ereal] :
                    ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),V2s))
                      ...
                      & p(ap(c_2Ereal__topology_2Ebounded__def,ap(V0f,inj__ty_2Erealax_2Ereal(V8x))))
                      & ap(V0f,inj__ty_2Erealax_2Ereal(V8x)) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) )
                   => ? [V10d: tp__ty_2Erealax_2Ereal] :
                        ...
                        & ! [V11x_27: tp__ty_2Erealax_2Ereal] :
                            ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V11x_27)),V2s))
                              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),inj__ty_2Erealax_2Ereal(V11x_27)))),inj__ty_2Erealax_2Ereal(V10d))) )
                           => ( ! [V12y: tp__ty_2Erealax_2Ereal] :
                                  ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V12y)),ap(V0f,inj__ty_2Erealax_2Ereal(V8x))))
                                 => ? [V13y_27: tp__ty_2Erealax_2Ereal] :
                                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V13y_27)),ap(V0f,inj__ty_2Erealax_2Ereal(V11x_27))))
                                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V12y)),inj__ty_2Erealax_2Ereal(V13y_27)))),inj__ty_2Erealax_2Ereal(V9e))) ) )
                              & ! [V14y_27: tp__ty_2Erealax_2Ereal] :
                                  ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V14y_27)),ap(V0f,inj__ty_2Erealax_2Ereal(V11x_27))))
                                 => ? [V15y: tp__ty_2Erealax_2Ereal] :
                                      ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V15y)),ap(V0f,inj__ty_2Erealax_2Ereal(V8x))))
                                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V14y_27)),inj__ty_2Erealax_2Ereal(V15y)))),inj__ty_2Erealax_2Ereal(V9e))) ) ) ) ) ) ) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2EUPPER__LOWER__HEMICONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
               ...
               => ! [V8x: tp__ty_2Erealax_2Ereal,V9e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ? [V10d: tp__ty_2Erealax_2Ereal] :
                        ...
                        & ! [V11x_27: tp__ty_2Erealax_2Ereal] :
                            ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V11x_27)),V2s))
                              & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V8x)),inj__ty_2Erealax_2Ereal(V11x_27)))),inj__ty_2Erealax_2Ereal(V10d))) )
                           => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(V0f,inj__ty_2Erealax_2Ereal(V8x))),ap(V0f,inj__ty_2Erealax_2Ereal(V11x_27))))),inj__ty_2Erealax_2Ereal(V9e))) ) ) ) ) ) ) ) )).
