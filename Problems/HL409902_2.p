...
tff(conj_thm_2Eiterate_2EREAL__POLYFUN__FINITE__ROOTS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1c: $i] :
      ( mem(V1c,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lameq_f3430,axiom,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3430(V0p,V1q),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),ap(V1q,inj__ty_2Erealax_2Ereal(V2x))) ) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUB,lemma,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1q: $i] :
          ( mem(V1q,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(lmtp_f3437,type,(
    f3437: ( tp__ty_2Erealax_2Ereal * $i ) > $i )).

tff(lamtp_f3437,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => mem(f3437(V1a,V0p),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f3437,axiom,(
    ! [V1a: tp__ty_2Erealax_2Ereal,V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2x: tp__ty_2Erealax_2Ereal] : ap(f3437(V1a,V0p),inj__ty_2Erealax_2Ereal(V2x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0p,inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V1a))) ) )).

tff(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__FINITE__ROOTS,conjecture,(
    ! [V0p: $i] :
      ( mem(V0p,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1a: tp__ty_2Erealax_2Ereal] :
          ( p(ap(c_2Eiterate_2Epolynomial__function,V0p))
         => ( p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3437(V1a,V0p))))
