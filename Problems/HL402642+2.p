...
fof(conj_thm_2Erich__list_2EFOLDL__REVERSE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1e] :
                 ...
                 => ! [V2l] :
                      ( mem(V2l,ty_2Elist_2Elist(A_27b))
                     => ap(ap(ap(c_2Elist_2EFOLDL(A_27b,A_27b),V0f),V1e),ap(c_2Elist_2EREVERSE(A_27b),V2l)) = ap(ap(ap(c_2Elist_2EFOLDR(A_27b,A_27b),f784(A_27a,A_27b,V0f)),V1e),V2l) ) ) ) ) ) )).
