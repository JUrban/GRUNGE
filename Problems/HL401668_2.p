...
tff(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
      <=> ? [V1c: $i] :
            ( mem(V1c,arr(ty_2Enum_2Enum,A_27a))
            & ? [V2n: tp__ty_2Enum_2Enum] : p(ap(ap(ap(c_2Epred__set_2EBIJ(ty_2Enum_2Enum,ty_2Enum_2Enum),V1c),ap(c_2Epred__set_2Ecount,inj__ty_2Enum_2Enum(V2n))),V0s)) ) ) ) )).

tff(conj_thm_2Epred__set_2EFINITE__BIJ__COUNT,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ? [V1f: $i] :
