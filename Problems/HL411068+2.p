...
fof(conj_thm_2Ereal__topology_2EHEINE__BOREL__IMP__BOLZANO__WEIERSTRASS,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1f] :
       ...
       => ! [V4t] :
           ...
           => ( ( ~ p(ap(c_2Epred__set_2EFINITE(ty_2Erealax_2Ereal),V4t))
             ...
             => ? [V5x] :
                  ...
                  & p(ap(ap(c_2Ereal__topology_2Elimit__point__of,V5x),V4t)) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__BOUNDED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1t] :
...
fof(conj_thm_2Ereal__topology_2EBOLZANO__WEIERSTRASS__IMP__CLOSED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( ! [V1t] :
            ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__EQ__BOLZANO__WEIERSTRASS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ecompact,V0s))
      <=> ! [V1t] :
