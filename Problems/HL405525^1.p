...
thf(thm_2Einteger_2EINT__QUOT__CALCULATE,conjecture,
    ...
    & ! [V2p: mono_2Etyop_2Einteger_2Eint,V3q: mono_2Etyop_2Einteger_2Eint] :
        ( ( (~)
          @ ( V3q
            = ( mono_2Ec_2Einteger_2Eint__of__num @ mono_2Ec_2Enum_2E0 ) ) )
       => ( ( ( mono_2Ec_2Einteger_2Eint__quot @ ( mono_2Ec_2Einteger_2Eint__neg @ V2p ) @ V3q )
            = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__quot @ V2p @ V3q ) ) )
          & ( ( mono_2Ec_2Einteger_2Eint__quot @ V2p @ ( mono_2Ec_2Einteger_2Eint__neg @ V3q ) )
            = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__quot @ V2p @ V3q ) ) ) ) )
