...
fof(lameq_f454,axiom,(
    ! [A_27a,A_27b,V1ls] :
     ...
     => ! [V0f] :
         ...
         => ! [V2n] :
              ( mem(V2n,ty_2Enum_2Enum)
             => ap(f454(A_27a,A_27b,V1ls,V0f),V2n) = ap(V0f,ap(ap(c_2Elist_2EEL(A_27a),V2n),V1ls)) ) ) ) )).

fof(conj_thm_2Elist_2EIMAGE__EL__count__LENGTH,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
