...
tff(ax_thm_2Ebag_2EBAG__ALL__DISTINCT,axiom,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EBAG__ALL__DISTINCT(A_27a),V0b))
      <=> ! [V1e: $i] :
            ( mem(V1e,A_27a)
           => p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(V0b,V1e)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__ALL__DISTINCT__DELETE,conjecture,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EBAG__ALL__DISTINCT(A_27a),V0b))
      <=> ! [V1e: $i] :
