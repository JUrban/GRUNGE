...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__OPEN__INTER__CLOSURE,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__CLOSED__IN__OPEN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(ap(c_2Ereal__topology_2Elocally,c_2Ereal__topology_2Ecompact),V0s))
       => ? [V1t: $i] :
