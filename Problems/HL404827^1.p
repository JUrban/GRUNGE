...
thf(thm_2Efinite__map_2EFUPDATE__SAME__APPLY,axiom,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1kv_2E0: u,V2fm2_2E0: u,V3fm1_2E0: u] :
      ( ( ( ( s @ A_27a @ V0x_2E0 )
          = ( s @ A_27a @ ( c_2Epair_2EFST_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1kv_2E0 ) ) ) )
        | ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V3fm1_2E0 ) @ ( s @ A_27a @ V0x_2E0 ) ) )
          = ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2fm2_2E0 ) @ ( s @ A_27a @ V0x_2E0 ) ) ) ) )
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V3fm1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1kv_2E0 ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) )
        = ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2fm2_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V1kv_2E0 ) ) ) @ ( s @ A_27a @ V0x_2E0 ) ) ) ) ) )).
...
thf(thm_2Elist_2EMEM__SNOC,axiom,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u,V2l_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ESNOC_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) ) ) )
    <=> ( ( ( s @ A_27a @ V0y_2E0 )
          = ( s @ A_27a @ V1x_2E0 ) )
        | ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFUPDATE__SAME__LIST__APPLY,conjecture,(
    ! [A_27a: d,A_27b: d,V0kvl_2E0: u,V1fm1_2E0: u,V2fm2_2E0: u,V3x_2E0: u] :
     ...
     => ( ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1fm1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) @ ( s @ A_27a @ V3x_2E0 ) ) )
        = ( s @ A_27b @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V2fm2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V0kvl_2E0 ) ) ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) ) )).
