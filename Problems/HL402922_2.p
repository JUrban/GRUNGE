...
tff(conj_thm_2Elist_2ELAST__REVERSE,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
tff(conj_thm_2Elist_2EdropWhile__eq__nil,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
...
tff(conj_thm_2Elist_2EMEM__dropWhile__IMP,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Elist_2EHD__dropWhile,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1ls: $i] :
          ( mem(V1ls,ty_2Elist_2Elist(A_27a))
         => ( p(ap(ap(c_2Elist_2EEXISTS(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Ebool_2E_7E),V0P)),V1ls))
...
tff(conj_thm_2Enumposrep_2ELOG__l2n,lemma,(
...
tff(conj_thm_2Enumposrep_2El2n__dropWhile__0,lemma,(
...
tff(lamtp_f820,axiom,(
    mem(f820,arr(ty_2Enum_2Enum,bool)) )).

tff(lameq_f820,axiom,(
    ! [V2y: tp__ty_2Enum_2Enum] : ap(f820,inj__ty_2Enum_2Enum(V2y)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2y))) )).

tff(conj_thm_2Enumposrep_2ELOG__l2n__dropWhile,conjecture,(
    ! [V0b: tp__ty_2Enum_2Enum,V1l: tp__c_ty_2Elist_2Elist_ty_2Enum_2Enum] :
      ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),inj__ty_2Enum_2Enum(V0b)))
        & p(ap(ap(c_2Elist_2EEXISTS(ty_2Enum_2Enum),f820),inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(V1l)))
        & p(ap(ap(c_2Elist_2EEVERY(ty_2Enum_2Enum),ap(c_2Earithmetic_2E_3E,inj__ty_2Enum_2Enum(V0b))),inj__c_ty_2Elist_2Elist_ty_2Enum_2Enum(V1l))) )
