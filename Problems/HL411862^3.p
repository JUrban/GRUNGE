...
thf(thm_2Ereal__topology_2EFRONTIER__INTERIOR__SUBSET,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o] :
      ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Efrontier @ ( c_2Ereal__topology_2Einterior @ V0s ) ) @ ( c_2Ereal__topology_2Efrontier @ V0s ) ) )).
...
thf(thm_2Ereal__topology_2ESETDIST__FRONTIERS,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o] :
      ( ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ V0s @ V1t ) )
      = ( c_2Ebool_2ECOND @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EDISJOINT @ tyop_2Erealax_2Ereal @ V0s @ V1t ) @ ( c_2Ereal__topology_2Esetdist @ ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ ( tyop_2Erealax_2Ereal > $o ) @ ( c_2Ereal__topology_2Efrontier @ V0s ) @ ( c_2Ereal__topology_2Efrontier @ V1t ) ) ) @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).
