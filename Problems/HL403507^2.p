...
thf(conj_thm_2Ewellorder_2Errestrict__SUBSET,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ewellorder_2Ewellfounded__subset,lemma,(
    ! [A_27a: del,V0r0: $i] :
...
thf(conj_thm_2Ewellorder_2Estrict__subset,lemma,(
    ! [A_27a: del,V0r1: $i] :
...
thf(conj_thm_2Ewellorder_2Elinear__order__rrestrict,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ewellorder_2Ereflexive__rrestrict,lemma,(
    ! [A_27a: del,V0r: $i] :
      ( ( mem @ V0r @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27a ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ewellorder_2Ewellorder__rrestrict,conjecture,(
    ! [A_27a: del,V0w: $i] :
