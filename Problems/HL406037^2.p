...
thf(conj_thm_2Ewords_2EWORD__MOD__POW2,conjecture,(
    ! [A_27a: del,V0m: $i] :
     ...
     => ! [V1v: tp__ty_2Enum_2Enum] :
         ...
         => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__mod @ A_27a ) @ V0m ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2EEXP @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT2 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1v ) ) ) ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__bits @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1v ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0m ) ) ) ) )).
