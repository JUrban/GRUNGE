...
thf(conj_thm_2Ealist_2EMEM__fmap__to__alist__FLOOKUP,lemma,(
...
thf(conj_thm_2Ealist_2EALOOKUP__MEM,lemma,(
...
thf(conj_thm_2Ealist_2EALL__DISTINCT__fmap__to__alist__keys,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
      ( ( mem @ V0fm @ ( ty_2Efinite__map_2Efmap @ A_27a @ A_27b ) )
...
thf(conj_thm_2Ealist_2Efmap__to__alist__inj,lemma,(
...
thf(conj_thm_2Ealist_2Efmap__to__alist__preserves__FDOM,lemma,(
...
thf(conj_thm_2Elist_2EEL__ALL__DISTINCT__EL__EQ,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Elist_2EINJ__MAP__EQ,lemma,(
...
thf(conj_thm_2Esorting_2EPERM__LENGTH,lemma,(
    ! [A_27a: del,V0l1: $i] :
...
thf(conj_thm_2Esorting_2EPERM__LIST__TO__SET,lemma,(
    ! [A_27a: del,V0l1: $i] :
      ( ( mem @ V0l1 @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1l2: $i] :
          ( ( mem @ V1l2 @ ( ty_2Elist_2Elist @ A_27a ) )
...
thf(conj_thm_2Ealist_2EPERM__fmap__to__alist,conjecture,(
