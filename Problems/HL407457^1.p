...
thf(f8814_0_2E0,type,(
    f8814_0_2E0: u )).

thf(f8814_0_2E2,type,(
    f8814_0_2E2: du > du > u )).
...
thf(mono_2Ef8814_0,type,(
    mono_2Ef8814_0: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2Ereal_2EREAL__SUB,axiom,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef8814_0 @ V0m @ V1n )
    <=> ( ( mono_2Ec_2Earithmetic_2E_2D @ V0m @ V1n )
        = mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Ereal_2EREAL__SUB,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ereal_2Ereal__sub @ ( mono_2Ec_2Ereal_2Ereal__of__num @ V0m ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ V1n ) )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef8814_0 @ V0m @ V1n ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2E_2D @ V1n @ V0m ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2E_2D @ V0m @ V1n ) ) ) ) )).
