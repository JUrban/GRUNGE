...
tff(ax_thm_2Ereal__topology_2Euniformly__continuous__on,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__UNIFORMLY__EQUICONTINUOUS,lemma,(
    ! [V0fs: $i] :
...
tff(conj_thm_2Ereal__topology_2ECOMPACT__UNIFORMLY__CONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
