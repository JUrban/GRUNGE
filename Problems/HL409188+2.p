...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__FINITE__CONST,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__CONST__EQ__1__EQ__INV__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
