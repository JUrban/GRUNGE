...
thf(conj_thm_2Ebinary__ieee_2Elargest__lt__threshold,lemma,(
    ! [A_27t: del,A_27w: del] :
...
thf(conj_thm_2Elift__ieee_2Efloat__to__real__finite,lemma,(
...
thf(conj_thm_2Elift__ieee_2Efloat__to__real__threshold,conjecture,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Ebinary__ieee_2Efloat @ A_27t @ A_27w ) )
     => ( ( p @ ( ap @ ( c_2Ebinary__ieee_2Efloat__is__finite @ A_27t @ A_27w ) @ V0x ) )
