...
tff(conj_thm_2Eproduct_2ENPRODUCT__IMAGE,lemma,(
             ...
             => ( ! [V3x: $i] :
                   ...
                   => ! [V4y: $i] :
                       ...
                       => ( ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V2s))
                         ...
                         => V3x = V4y ) ) )
               => surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s)),V1g)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(A_27a),V2s),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V1g),V0f))) ) ) ) ) )).

tff(lmtp_f3498,type,(
    f3498: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f3498,axiom,(
    ! [V3p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f3498(V3p,V1f),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f3498,axiom,(
    ! [V3p: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V4i: tp__ty_2Enum_2Enum] : ap(f3498(V3p,V1f),inj__ty_2Enum_2Enum(V4i)) = ap(V1f,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V4i)),inj__ty_2Enum_2Enum(V3p))) ) )).

tff(conj_thm_2Eproduct_2ENPRODUCT__OFFSET,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum,V1f: $i] :
      ( mem(V1f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V2m: tp__ty_2Enum_2Enum,V3p: tp__ty_2Enum_2Enum] : surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3p))),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V3p)))),V1f)) = surj__ty_2Enum_2Enum(ap(ap(c_2Eproduct_2Enproduct(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V0n))),f3498(V3p,V1f))) ) )).
