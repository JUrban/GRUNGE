...
thf(conj_thm_2Erich__list_2EFILTER__COMM,conjecture,(
    ! [A_27a: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2l: $i] :
             ...
             => ( ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f1 ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V1f2 ) @ V2l ) )
                = ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V1f2 ) @ ( ap @ ( ap @ ( c_2Elist_2EFILTER @ A_27a ) @ V0f1 ) @ V2l ) ) ) ) ) ) )).
