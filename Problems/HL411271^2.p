...
thf(conj_thm_2Ereal__topology_2ECLOSED__MAP__RESTRICT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
             ...
             => ! [V3t_27: $i] :
                 ...
                 => ( ( ! [V4u: $i] :
                   ...
                   => ! [V5u: $i] :
                       ...
                       => ( ( p
                            @ ( ap
                              @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__MONOTONE__PREIMAGE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
