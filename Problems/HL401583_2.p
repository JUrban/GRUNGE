...
tff(conj_thm_2Epred__set_2ESURJ__IMP__INJ,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
     ...
     => ! [V1t: $i] :
         ...
         => ( ? [V2f: $i] :
                ...
                & p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V2f),V0s),V1t)) )
           => ? [V3g: $i] :
                ( mem(V3g,arr(A_27b,A_27a))
                & p(ap(ap(ap(c_2Epred__set_2EINJ(A_27b,A_27b),V3g),V1t),V0s)) ) ) ) ) )).

tff(conj_thm_2Epred__set_2ESCHROEDER__BERNSTEIN,lemma,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
...
tff(conj_thm_2Epred__set_2EBIJ__INJ__SURJ,conjecture,(
    ! [A_27a: del,A_27b: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(A_27b,bool))
