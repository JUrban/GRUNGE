...
thf(conj_thm_2Etopology_2EP__HULL,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Etopology_2EHULL__SUBSET,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Etopology_2EHULL__P__AND__Q,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ! [V1P: $i] :
         ...
         => ! [V2Q: $i] :
             ...
             => ( ( ! [V3f: $i] :
               ...
               => ( ( ap
                    @ ( ap @ ( c_2Etopology_2Ehull @ A_27a )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V8x: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ V1P @ V8x ) ) @ ( ap @ V2Q @ V8x ) ) ) )
                    @ V0s )
                  = ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V1P ) @ ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V2Q ) @ V0s ) ) ) ) ) ) ) )).
