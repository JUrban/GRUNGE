...
thf(thm_2Ereal__topology_2EPARTIAL__SUMS__COMPONENT__LE__INFSUM,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2n: tyop_2Enum_2Enum] :
      ( ( ! [V3i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V1s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V3i ) ) )
        & ( c_2Ereal__topology_2Esummable @ V1s @ V0f ) )
     => ( c_2Ereal_2Ereal__lte @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum @ V1s @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ V2n ) ) @ V0f ) @ ( c_2Ereal__topology_2Einfsum @ V1s @ V0f ) ) ) )).

thf(thm_2Ereal__topology_2EPARTIAL__SUMS__DROP__LE__INFSUM,conjecture,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2n: tyop_2Enum_2Enum] :
      ( ( ! [V3i: tyop_2Enum_2Enum] :
            ( ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3i @ V1s )
           => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ ( V0f @ V3i ) ) )
