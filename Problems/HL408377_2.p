...
tff(tp_c_2Etransc_2Eatn,type,(
    c_2Etransc_2Eatn: $i )).

tff(mem_c_2Etransc_2Eatn,axiom,(
    mem(c_2Etransc_2Eatn,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(stp_fo_c_2Etransc_2Eatn,type,(
    fo__c_2Etransc_2Eatn: tp__ty_2Erealax_2Ereal > tp__ty_2Erealax_2Ereal )).

tff(stp_eq_fo_c_2Etransc_2Eatn,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] : inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Eatn(X0)) = ap(c_2Etransc_2Eatn,inj__ty_2Erealax_2Ereal(X0)) )).
...
tff(conj_thm_2Etransc_2EATN__BOUNDS,lemma,(
...
tff(conj_thm_2Etransc_2ECOS__ATN__NZ,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,ap(c_2Etransc_2Eatn,inj__ty_2Erealax_2Ereal(V0x)))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).
