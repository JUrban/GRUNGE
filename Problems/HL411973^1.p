...
thf(f12181_0_2E0,type,(
    f12181_0_2E0: u )).

thf(f12181_0_2E2,type,(
    f12181_0_2E2: du > du > u )).

thf(f12181_0_2E3,type,(
    f12181_0_2E3: du > du > du > u )).

thf(f12181_1_2E0,type,(
    f12181_1_2E0: u )).

thf(f12181_1_2E2,type,(
    f12181_1_2E2: du > du > u )).

thf(f12181_1_2E3,type,(
...
thf(mono_2Ef12181_1,type,(
    mono_2Ef12181_1: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(arityeq2_2Emono_2Ef12181_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ ( f12181_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef12181_0_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12181_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) ) )
...
thf(def0_2Ethm_2Elebesgue_2Epos__simple__fn__add__alt,axiom,(
    ! [V5x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V6y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V8i: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12181_1 @ V5x @ V6y @ V8i )
      = ( mono_2Ec_2Erealax_2Ereal__add @ ( V5x @ V8i ) @ ( V6y @ V8i ) ) ) )).

thf(def1_2Ethm_2Elebesgue_2Epos__simple__fn__add__alt,axiom,(
    ! [A_27a: d,V1f_2E0: u,V2g_2E0: u,V7t_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12181_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V2g_2E0 ) @ ( s @ A_27a @ V7t_2E0 ) ) ) )
      = ( mono_2Ec_2Eextreal_2Eextreal__add @ ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V1f_2E0 ) @ ( s @ A_27a @ V7t_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ V2g_2E0 ) @ ( s @ A_27a @ V7t_2E0 ) ) ) ) ) ) )).

thf(thm_2Elebesgue_2Epos__simple__fn__add__alt,conjecture,(
    ! [A_27a: d,V0m_2E0: u,V1f_2E0: u,V2g_2E0: u,V3s: mono_2Etyop_2Enum_2Enum > $o,V4a_2E0: u,V5x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V6y: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Emeasure_2Emeasure__space_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) ) ) )
