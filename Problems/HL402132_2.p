...
tff(lamtp_f397,axiom,(
    ! [A_27a: del,V1P2: $i] :
      ( mem(V1P2,arr(A_27a,bool))
     => ! [V0P1: $i] :
          ( mem(V0P1,arr(A_27a,bool))
         => mem(f397(A_27a,V1P2,V0P1),arr(A_27a,bool)) ) ) )).
...
tff(lameq_f397,axiom,(
    ! [A_27a: del,V1P2: $i] :
     ...
     => ! [V0P1: $i] :
         ...
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f397(A_27a,V1P2,V0P1),V3x) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1P2,V3x)),ap(V0P1,V3x)) ) ) ) )).

tff(conj_thm_2Elist_2EEVERY__FILTER,conjecture,(
    ! [A_27a: del,V0P1: $i] :
      ( mem(V0P1,arr(A_27a,bool))
     => ! [V1P2: $i] :
          ( mem(V1P2,arr(A_27a,bool))
