...
tff(lamtp_f929,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f929(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f929,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V3t: tp__ty_2Enum_2Enum] : ap(f929(V0a,V1b),inj__ty_2Enum_2Enum(V3t)) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,inj__ty_2Enum_2Enum(V3t)))),ap(V1b,inj__ty_2Enum_2Enum(V3t))) ) ) )).

tff(lmtp_f928,type,(
    f928: ( $i * $i ) > $i )).

tff(lamtp_f928,axiom,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f928(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f928,axiom,(
    ! [V0a: $i] :
     ...
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ! [V2t0: tp__ty_2Enum_2Enum] : ap(f928(V0a,V1b),inj__ty_2Enum_2Enum(V2t0)) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESBEFORE,V1b),f929(V0a,V1b)),inj__ty_2Enum_2Enum(V2t0))),ap(ap(c_2ETemporal__Logic_2EALWAYS,f881(V1b)),inj__ty_2Enum_2Enum(V2t0))) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EWHEN__AS__SBEFORE,conjecture,(
    ! [V0a: $i] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2EWHEN,V0a),V1b) = f928(V0a,V1b) ) ) )).
