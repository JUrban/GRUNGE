...
thf(thm_2EOmega__Automata_2EBUECHI__PERIODIC__MODEL,conjecture,(
    ! [A_27a: $tType,A_27state: $tType,V0TransRel: ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) ) > $o,V1InitState: A_27state > $o,V2Accept: A_27state > $o] :
      ( ! [V3s: tyop_2Enum_2Enum > A_27state] :
        ? [V4x0: tyop_2Enum_2Enum,V5l: tyop_2Enum_2Enum] :
          ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V5l )
          & ( ( V3s @ V4x0 )
            = ( V3s @ ( c_2Earithmetic_2E_2B @ V4x0 @ V5l ) ) ) )
     => ( ? [V6i: tyop_2Enum_2Enum > A_27a,V7q: tyop_2Enum_2Enum > A_27state] :
            ( ( V1InitState @ ( V7q @ c_2Enum_2E0 ) )
            & ! [V8t: tyop_2Enum_2Enum] :
                ( V0TransRel @ ( c_2Epair_2E_2C @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) @ ( V6i @ V8t ) @ ( c_2Epair_2E_2C @ A_27state @ A_27state @ ( V7q @ V8t ) @ ( V7q @ ( c_2Earithmetic_2E_2B @ V8t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
            & ! [V9t1: tyop_2Enum_2Enum] :
              ? [V10t2: tyop_2Enum_2Enum] :
                ( V2Accept @ ( V7q @ ( c_2Earithmetic_2E_2B @ V9t1 @ V10t2 ) ) ) )
      <=> ? [V11x0: tyop_2Enum_2Enum,V12l: tyop_2Enum_2Enum,V13j: tyop_2Enum_2Enum > A_27a,V14p: tyop_2Enum_2Enum > A_27state] :
            ( ( c_2Eprim__rec_2E_3C @ c_2Enum_2E0 @ V12l )
            & ! [V15t2: tyop_2Enum_2Enum] :
                ( ( V13j @ ( c_2Earithmetic_2E_2B @ V11x0 @ V15t2 ) )
                = ( V13j @ ( c_2Earithmetic_2E_2B @ V11x0 @ ( c_2Earithmetic_2EMOD @ V15t2 @ V12l ) ) ) )
            & ! [V16t2: tyop_2Enum_2Enum] :
                ( ( V14p @ ( c_2Earithmetic_2E_2B @ V11x0 @ V16t2 ) )
                = ( V14p @ ( c_2Earithmetic_2E_2B @ V11x0 @ ( c_2Earithmetic_2EMOD @ V16t2 @ V12l ) ) ) )
            & ( V1InitState @ ( V14p @ c_2Enum_2E0 ) )
            & ! [V17t: tyop_2Enum_2Enum] :
                ( V0TransRel @ ( c_2Epair_2E_2C @ A_27a @ ( tyop_2Epair_2Eprod @ A_27state @ A_27state ) @ ( V13j @ V17t ) @ ( c_2Epair_2E_2C @ A_27state @ A_27state @ ( V14p @ V17t ) @ ( V14p @ ( c_2Earithmetic_2E_2B @ V17t @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) )
            & ! [V18t1: tyop_2Enum_2Enum] :
              ? [V19t2: tyop_2Enum_2Enum] :
                ( V2Accept @ ( V14p @ ( c_2Earithmetic_2E_2B @ V18t1 @ V19t2 ) ) ) ) ) ) )).
