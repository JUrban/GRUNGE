...
fof(lamtp_f2151,axiom,(
    ! [A_27a,V1x] :
      ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
     => ! [V0P] :
          ( mem(V0P,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
         => mem(f2151(A_27a,V1x,V0P),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) ) ) )).
    ...
    ! [A_27a,V1x] :
     ...
     => ! [V0P] :
         ...
         => ! [V2y] :
             ...
             => ap(f2151(A_27a,V1x,V0P),V2y) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Eordinal_2Eordlt(A_27a),V2y),V1x)),ap(c_2Ebool_2E_7E,ap(V0P,V2y))) ) ) ) )).

fof(lamtp_f2150,axiom,(
    ! [A_27a,A_27a,V0P] :
      ( mem(V0P,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => mem(f2150(A_27a,A_27a,V0P),arr(ty_2Eordinal_2Eordinal(A_27a),bool)) ) )).
...
fof(lameq_f2150,axiom,(
    ! [A_27a,A_27a,V0P] :
     ...
     => ! [V1x] :
          ( mem(V1x,ty_2Eordinal_2Eordinal(A_27a))
         => ap(f2150(A_27a,A_27a,V0P),V1x) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,V1x)),ap(c_2Ebool_2E_21(ty_2Eordinal_2Eordinal(A_27a)),f2151(A_27a,V1x,V0P))) ) ) )).
...
fof(ax_thm_2Eordinal_2Eoleast__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0P] :
          ( mem(V0P,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
         => ap(c_2Eordinal_2Eoleast(A_27a),V0P) = ap(c_2Emin_2E_40(ty_2Eordinal_2Eordinal(A_27a)),f2150(A_27a,A_27a,V0P)) ) ) )).

fof(conj_thm_2Eordinal_2Eoleast__intro,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0Q] :
