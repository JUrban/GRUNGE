...
tff(tp_c_2Erelation_2EWFP,type,(
    c_2Erelation_2EWFP: del > $i )).

tff(mem_c_2Erelation_2EWFP,axiom,(
    ! [A_27a: del] : mem(c_2Erelation_2EWFP(A_27a),arr(arr(A_27a,arr(A_27a,bool)),arr(A_27a,bool))) )).

tff(conj_thm_2Erelation_2EINDUCTION__WF__THM,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Erelation_2EWF__EQ__INDUCTION__THM,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2EWF(A_27a),V0R))
      <=> ! [V1P: $i] :
...
tff(conj_thm_2Erelation_2EWFP__RULES,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
         => ( ! [V2y: $i] :
                ( mem(V2y,A_27a)
               => ( p(ap(ap(V0R,V2y),V1x))
                 => p(ap(ap(c_2Erelation_2EWFP(A_27a),V0R),V2y)) ) )
           => p(ap(ap(c_2Erelation_2EWFP(A_27a),V0R),V1x)) ) ) ) )).

tff(conj_thm_2Erelation_2EWFP__STRONG__INDUCT,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1R: $i] :
         ...
         => ( ! [V2x: $i] :
                ( mem(V2x,A_27a)
               => ( ( p(ap(ap(c_2Erelation_2EWFP(A_27a),V1R),V2x))
                    & ! [V3y: $i] :
                        ( mem(V3y,A_27a)
                       => ( p(ap(ap(V1R,V3y),V2x))
                         => p(ap(V0P,V3y)) ) ) )
           ...
           => ! [V4x: $i] :
                ( mem(V4x,A_27a)
               => ( p(ap(ap(c_2Erelation_2EWFP(A_27a),V1R),V4x))
                 => p(ap(V0P,V4x)) ) ) ) ) ) )).

tff(conj_thm_2Erelation_2EWF__EQ__WFP,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( p(ap(c_2Erelation_2EWF(A_27a),V0R))
      <=> ! [V1x: $i] :
