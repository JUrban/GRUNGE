...
thf(conj_thm_2Ereal__topology_2EINFSUM__EQ,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2k: $i] :
             ...
             => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V2k ) @ V0f ) )
               ...
               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2k ) @ V0f ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Ereal__topology_2Einfsum @ V2k ) @ V1g ) ) ) ) ) ) ) )).
