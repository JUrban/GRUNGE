...
thf(conj_thm_2Epred__set_2EUNIV__BOOL,conjecture,
    ( ( c_2Epred__set_2EUNIV @ bool )
    = ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ bool ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ bool ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) @ ( c_2Epred__set_2EEMPTY @ bool ) ) ) )).
