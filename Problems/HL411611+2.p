...
fof(conj_thm_2Ereal__topology_2ECONVERGENT__BOUNDED__MONOTONE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1b] :
         ...
         => ( ( ! [V2n] :
                 ...
                 => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V0s,V2n))),V1b)) )
              & ( ! [V3m] :
                    ( mem(V3m,ty_2Enum_2Enum)
                   => ! [V4n] :
                        ( mem(V4n,ty_2Enum_2Enum)
                       => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3m),V4n))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,V3m)),ap(V0s,V4n))) ) ) )
                | ! [V5m] :
                    ( mem(V5m,ty_2Enum_2Enum)
                   => ! [V6n] :
                        ( mem(V6n,ty_2Enum_2Enum)
                       => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V5m),V6n))
                         => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0s,V6n)),ap(V0s,V5m))) ) ) ) ) )
           => ? [V7l] :
                   ...
                   => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V8e))
                     => ? [V9N] :
                          ...
                          & ! [V10n] :
                             ...
                             => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V9N),V10n))
                               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0s,V10n)),V7l))),V8e)) ) ) ) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EBOUNDED__INCREASING__CONVERGENT,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
