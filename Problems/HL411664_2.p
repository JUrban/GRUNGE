...
tff(lameq_f2906,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2906(V0f,V1g),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__add,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(lmtp_f2910,type,(
    f2910: ( $i * $i ) > $i )).

tff(lamtp_f2910,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => mem(f2910(V0f,V1g),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f2910,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2910(V0f,V1g),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CONST,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous__on,k(ty_2Erealax_2Ereal,inj__ty_2Erealax_2Ereal(V1c))),V0s)) ) )).

tff(lmtp_f3829,type,(
    f3829: ( $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3829,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal] : mem(f3829(V0f,V1c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3829,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3829(V0f,V1c),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V1c)),ap(V0f,inj__ty_2Erealax_2Ereal(V3x))) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CMUL,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f3829(V0f,V1c)),V2s)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ADD,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUB,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V2s))
                  & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1g),V2s)) )
               => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,f2910(V0f,V1g)),V2s)) ) ) ) ) )).
...
tff(lameq_f3944,axiom,(
    ! [V1c: $i] :
      ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V2f: $i] :
          ( mem(V2f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f3944(V1c,V2f),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1c,inj__ty_2Erealax_2Ereal(V3x))),ap(V2f,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__MUL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1c: $i] :
          ( mem(V1c,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SYM,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__TRANS,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__MINIMAL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__OPEN__INTERVALS,conjecture,(
