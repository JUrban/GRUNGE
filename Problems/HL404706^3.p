...
thf(c_2Efinite__map_2ERRESTRICT,type,(
    c_2Efinite__map_2ERRESTRICT: 
      !>[A_27a: $tType,A_27b: $tType] :
        ( ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) > ( A_27b > $o ) > ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) ) )).
    ...
    ! [A_27a: $tType,A_27b: $tType,V0f: tyop_2Efinite__map_2Efmap @ A_27a @ A_27b,V1r: A_27b > $o] :
      ( ( ( c_2Efinite__map_2EFDOM @ A_27a @ A_27b @ ( c_2Efinite__map_2ERRESTRICT @ A_27a @ A_27b @ V0f @ V1r ) )
        = ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
          @ ^ [V2x: A_27a] :
              ( c_2Epair_2E_2C @ A_27a @ $o @ V2x @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ A_27a @ V2x @ ( c_2Efinite__map_2EFDOM @ A_27a @ A_27b @ V0f ) ) @ ( c_2Ebool_2EIN @ A_27b @ ( c_2Efinite__map_2EFAPPLY @ A_27a @ A_27b @ V0f @ V2x ) @ V1r ) ) ) ) )
      & ! [V3x: A_27a] :
