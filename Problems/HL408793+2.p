...
fof(conj_thm_2EHolSmt_2Er172,conjecture,(
    ! [V0u] :
             ...
             => ! [V3y] :
                 ...
                 => ! [V4w] :
                     ...
                     => ! [V5z] :
                         ...
                         => ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2v),V3y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V4w)),V5z)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                          <=> p(ap(ap(c_2Ereal_2Ereal__ge,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V2v)),V3y)),ap(ap(c_2Erealax_2Ereal__mul,V4w),V5z)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) ) ) ) ) ) )).
