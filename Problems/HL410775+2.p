...
fof(conj_thm_2Ereal__topology_2ECLOSURE__UNION,lemma,(
    ! [V0s] :
...
fof(lamtp_f3713,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => mem(f3713(V0f),arr(arr(ty_2Erealax_2Ereal,bool),ty_2Epair_2Eprod(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)))) ) )).

fof(lameq_f3713,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ap(f3713(V0f),V1s) = ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(c_2Ereal__topology_2Eclosure,V1s)),ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1s),V0f)) ) ) )).

fof(conj_thm_2Ereal__topology_2ECLOSURE__BIGUNION,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( p(ap(c_2Epred__set_2EFINITE(arr(ty_2Erealax_2Ereal,bool)),V0f))
       => ap(c_2Ereal__topology_2Eclosure,ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0f)) = ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),f3713(V0f))) ) ) )).
