...
thf(thm_2Eiterate_2EREAL__INF__UNIQUE,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1b: tyop_2Erealax_2Ereal] :
      ( ( ! [V2x: tyop_2Erealax_2Ereal] :
        ...
        & ! [V3b_27: tyop_2Erealax_2Ereal] :
            ( ( c_2Erealax_2Ereal__lt @ V1b @ V3b_27 )
           => ? [V4x: tyop_2Erealax_2Ereal] :
                ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V4x @ V0s )
                & ( c_2Erealax_2Ereal__lt @ V4x @ V3b_27 ) ) ) )
        ...
        = ( c_2Eiterate_2Einf
          @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
            @ ^ [V2e: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V2e
                @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V2e )
                  @ ( c_2Ebool_2E_2F_5C
                      ...
                      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
                        @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
                          @ ^ [V3x: tyop_2Erealax_2Ereal,V4y: tyop_2Erealax_2Ereal] :
                              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__add @ V3x @ V4y ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V3x @ V1t ) @ ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V4y ) @ V2e ) ) ) ) ) )
                    @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V1t
                      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal )
                        @ ( c_2Epair_2EUNCURRY @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ $o )
                          @ ^ [V5x: tyop_2Erealax_2Ereal,V6y: tyop_2Erealax_2Ereal] :
                              ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ ( c_2Erealax_2Ereal__add @ V5x @ V6y ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x @ V0s ) @ ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Eabs @ V6y ) @ V2e ) ) ) ) ) ) ) ) ) ) ) ) ) )).
