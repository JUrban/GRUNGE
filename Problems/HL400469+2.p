...
fof(conj_thm_2Erelation_2ESC__IDEM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
...
fof(conj_thm_2Erelation_2EIDEM__SC,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => p(ap(c_2Erelation_2EIDEM(arr(A_27a,arr(A_27a,bool))),c_2Erelation_2ESC(A_27a))) ) )).
