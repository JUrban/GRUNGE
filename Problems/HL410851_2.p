...
tff(conj_thm_2Ereal__topology_2EAPPROACHABLE__LT__LE,lemma,(
    ! [A_27a: del,V0P: $i] :
...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN__LE,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EEVENTUALLY__WITHIN,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2p: $i] :
          ( mem(V2p,arr(ty_2Erealax_2Ereal,bool))
