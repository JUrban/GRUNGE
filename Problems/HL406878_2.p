...
tff(ax_thm_2Ehreal_2Ehreal__lt,axiom,(
...
tff(lmtp_f2590,type,(
    f2590: ( $i * tp__ty_2Ehrat_2Ehrat ) > $i )).

tff(lamtp_f2590,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V4w: tp__ty_2Ehrat_2Ehrat] : mem(f2590(V0P,V4w),arr(ty_2Ehreal_2Ehreal,bool)) ) )).

tff(lameq_f2590,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V4w: tp__ty_2Ehrat_2Ehrat,V5X: tp__ty_2Ehreal_2Ehreal] : ap(f2590(V0P,V4w),inj__ty_2Ehreal_2Ehreal(V5X)) = ap(ap(c_2Ebool_2E_2F_5C,ap(V0P,inj__ty_2Ehreal_2Ehreal(V5X))),ap(ap(c_2Ehreal_2Ecut,inj__ty_2Ehreal_2Ehreal(V5X)),inj__ty_2Ehrat_2Ehrat(V4w))) ) )).

tff(lmtp_f2589,type,(
    f2589: $i > $i )).

tff(lamtp_f2589,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
...
tff(lameq_f2589,axiom,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
     => ! [V4w: tp__ty_2Ehrat_2Ehrat] : ap(f2589(V0P),inj__ty_2Ehrat_2Ehrat(V4w)) = ap(c_2Ebool_2E_3F(ty_2Ehreal_2Ehreal),f2590(V0P,V4w)) ) )).

tff(conj_thm_2Ehreal_2EHREAL__SUP__ISACUT,conjecture,(
    ! [V0P: $i] :
      ( mem(V0P,arr(ty_2Ehreal_2Ehreal,bool))
