...
tff(conj_thm_2Earithmetic_2ELESS__CASES,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
...
tff(conj_thm_2Earithmetic_2ELESS__LESS__CASES,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
      ( V0m = V1n
      | p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0m)),inj__ty_2Enum_2Enum(V1n)))
      | p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(V0m))) ) )).
...
tff(lmtp_f2034,type,(
    f2034: ( del * del * $i * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2034,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0: tp__ty_2Enum_2Enum,V3i: $i] :
          ( mem(V3i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V2Phi__R: $i] :
              ( mem(V2Phi__R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => mem(f2034(A_27b,A_27a,V8q,V7t0,V3i,V2Phi__R),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2034,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
     ...
     => ! [V7t0: tp__ty_2Enum_2Enum,V3i: $i] :
         ...
         => ! [V2Phi__R: $i] :
              ( mem(V2Phi__R,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ! [V9t: tp__ty_2Enum_2Enum] : ap(f2034(A_27b,A_27a,V8q,V7t0,V3i,V2Phi__R),inj__ty_2Enum_2Enum(V9t)) = ap(V2Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V9t)),inj__ty_2Enum_2Enum(V7t0)))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V9t)),inj__ty_2Enum_2Enum(V7t0))))) ) ) ) )).

tff(lmtp_f2036,type,(
    f2036: ( del * del * $i * tp__ty_2Enum_2Enum * tp__ty_2Enum_2Enum * $i * $i ) > $i )).

tff(lamtp_f2036,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
     => ! [V7t0: tp__ty_2Enum_2Enum,V10t1: tp__ty_2Enum_2Enum,V3i: $i] :
          ( mem(V3i,arr(ty_2Enum_2Enum,A_27a))
         => ! [V4Psi: $i] :
              ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => mem(f2036(A_27b,A_27a,V8q,V7t0,V10t1,V3i,V4Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2036,axiom,(
    ! [A_27b: del,A_27a: del,V8q: $i] :
     ...
     => ! [V7t0: tp__ty_2Enum_2Enum,V10t1: tp__ty_2Enum_2Enum,V3i: $i] :
         ...
         => ! [V4Psi: $i] :
              ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
             => ! [V11t2: tp__ty_2Enum_2Enum] : ap(f2036(A_27b,A_27a,V8q,V7t0,V10t1,V3i,V4Psi),inj__ty_2Enum_2Enum(V11t2)) = ap(V4Psi,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V10t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V11t2)),inj__ty_2Enum_2Enum(V7t0))))),ap(V8q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V10t1)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V11t2)),inj__ty_2Enum_2Enum(V7t0)))))) ) ) ) )).

tff(lmtp_f2035,type,(
    f2035: ( del * del * $i * $i * tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f2035,axiom,(
    ! [A_27b: del,A_27a: del,V4Psi: $i] :
     ...
     => ! [V3i: $i] :
         ...
         => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
              ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
             => mem(f2035(A_27b,A_27a,V4Psi,V3i,V7t0,V8q),arr(ty_2Enum_2Enum,bool)) ) ) ) )).
...
tff(lameq_f2035,axiom,(
    ! [A_27b: del,A_27a: del,V4Psi: $i] :
     ...
     => ! [V3i: $i] :
         ...
         => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
              ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
             => ! [V10t1: tp__ty_2Enum_2Enum] : ap(f2035(A_27b,A_27a,V4Psi,V3i,V7t0,V8q),inj__ty_2Enum_2Enum(V10t1)) = ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2036(A_27b,A_27a,V8q,V7t0,V10t1,V3i,V4Psi)) ) ) ) )).

tff(lmtp_f2033,type,(
    f2033: ( del * del * $i * $i * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2033,axiom,(
     ...
     => ! [V3i: $i] :
         ...
         => ! [V2Phi__R: $i] :
             ...
             => ! [V1Phi__I: $i] :
                 ...
                 => ! [V7t0: tp__ty_2Enum_2Enum] : mem(f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0),arr(arr(ty_2Enum_2Enum,A_27b),bool)) ) ) ) ) )).
     ...
     => ! [V3i: $i] :
         ...
         => ! [V2Phi__R: $i] :
             ...
             => ! [V1Phi__I: $i] :
                 ...
                 => ! [V7t0: tp__ty_2Enum_2Enum,V8q: $i] :
                      ( mem(V8q,arr(ty_2Enum_2Enum,A_27b))
                     => ap(f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0),V8q) = ap(ap(c_2Ebool_2E_2F_5C,ap(V1Phi__I,ap(V8q,inj__ty_2Enum_2Enum(V7t0)))),ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2034(A_27b,A_27a,V8q,V7t0,V3i,V2Phi__R))),ap(c_2Ebool_2E_3F(ty_2Enum_2Enum),f2035(A_27b,A_27a,V4Psi,V3i,V7t0,V8q)))) ) ) ) ) ) )).

tff(lmtp_f2032,type,(
    f2032: ( del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f2032,axiom,(
    ! [A_27b: del,A_27a: del,V1Phi__I: $i] :
     ...
     => ! [V2Phi__R: $i] :
         ...
         => ! [V3i: $i] :
             ...
             => ! [V4Psi: $i] :
                  ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => mem(f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
    ...
    ! [A_27b: del,A_27a: del,V1Phi__I: $i] :
     ...
     => ! [V2Phi__R: $i] :
         ...
         => ! [V3i: $i] :
             ...
             => ! [V4Psi: $i] :
                  ( mem(V4Psi,arr(ty_2Epair_2Eprod(A_27a,A_27a),bool))
                 => ! [V7t0: tp__ty_2Enum_2Enum] : ap(f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi),inj__ty_2Enum_2Enum(V7t0)) = ap(c_2Ebool_2E_3F(arr(ty_2Enum_2Enum,A_27b)),f2033(A_27a,A_27b,V4Psi,V3i,V2Phi__R,V1Phi__I,V7t0)) ) ) ) ) )).

tff(conj_thm_2EOmega__Automata_2ECO__BUECHI__UNTIL__CLOSURE,conjecture,(
             ...
             => ! [V3i: $i] :
                 ...
                 => ! [V4Psi: $i] :
                     ...
                     => ! [V5t0: tp__ty_2Enum_2Enum,V6c: $i] :
                          ( mem(V6c,A_27b)
                         => ( p(ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,V0phi),f2032(A_27b,A_27a,V1Phi__I,V2Phi__R,V3i,V4Psi)),inj__ty_2Enum_2Enum(V5t0)))
                          <=> ? [V12p: $i] :
                                ...
                                & ? [V13q: $i] :
                                    ...
                                    & ! [V14t: tp__ty_2Enum_2Enum] :
                                        ...
                                        | ( p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t)),inj__ty_2Enum_2Enum(V5t0))))
                                          & p(ap(V2Phi__R,ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V3i,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t)),inj__ty_2Enum_2Enum(V5t0)))),ap(V13q,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t)),inj__ty_2Enum_2Enum(V5t0))))))
                                          & p(ap(V12p,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V14t)),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V5t0)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) )
