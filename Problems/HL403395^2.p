...
thf(tp_c_2Ebag_2EBIG__BAG__UNION,type,(
    c_2Ebag_2EBIG__BAG__UNION: del > $i )).

thf(mem_c_2Ebag_2EBIG__BAG__UNION,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Ebag_2EBIG__BAG__UNION__def,axiom,(
    ! [A_27a: del,V0sob: $i] :
      ( ( mem @ V0sob @ ( arr @ ( arr @ A_27a @ ty_2Enum_2Enum ) @ bool ) )
     => ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V0sob )
        = ( lam @ A_27a
          @ ^ [V1x: $i] :
              ( ap
              @ ( ap @ ( c_2Epred__set_2ESUM__IMAGE @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
...
thf(conj_thm_2Epred__set_2ESUM__IMAGE__UNION,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ebag_2EBIG__BAG__UNION__UNION,conjecture,(
    ! [A_27a: del,V0s1: $i] :
     ...
     => ! [V1s2: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0s1 ) )
           ...
           => ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EUNION @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0s1 ) @ V1s2 ) )
              = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V0s1 ) ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V1s2 ) ) ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0s1 ) @ V1s2 ) ) ) ) ) ) ) )).
