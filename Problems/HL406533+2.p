...
fof(mem_c_2Ewords_2Eword__asr__bv,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Eword__asr__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) ) )).
...
fof(conj_thm_2Ewords_2Eword__lo__n2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
          ( mem(V0a,ty_2Enum_2Enum)
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2k] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => mem(f2326(A_27a,V1m,V0w,V2k,V3a),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).
         ...
         => ! [V2k] :
             ...
             => ! [V3a] :
                 ...
                 => ! [V4j] :
                     ...
                     => ap(f2326(A_27a,V1m,V0w,V2k,V3a),V4j) = ap(ap(c_2Ebool_2E_5C_2F,V3a),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(c_2Ebit_2ELOG2,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),c_2Enum_2E0),V1m)),ap(c_2Ewords_2En2w(A_27a),V4j))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),V4j)),V2k))) ) ) ) ) ) )).

fof(lamtp_f2325,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k] :
              ( mem(V2k,ty_2Enum_2Enum)
             => mem(f2325(A_27a,V1m,V0w,V2k),arr(bool,arr(ty_2Enum_2Enum,bool))) ) ) ) )).
    ...
    ! [A_27a,V1m] :
     ...
     => ! [V0w] :
         ...
         => ! [V2k] :
             ...
             => ! [V3a] :
                  ( mem(V3a,bool)
                 => ap(f2325(A_27a,V1m,V0w,V2k),V3a) = f2326(A_27a,V1m,V0w,V2k,V3a) ) ) ) ) )).

fof(lamtp_f2324,axiom,(
    ! [A_27a,V1m] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
