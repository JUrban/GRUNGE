...
thf(f9431_0_2E0,type,(
    f9431_0_2E0: u )).

thf(f9431_0_2E1,type,(
    f9431_0_2E1: du > u )).

thf(f9431_0_2E2,type,(
    f9431_0_2E2: du > du > u )).
...
thf(mono_2Ef9431_0,type,(
    mono_2Ef9431_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Eseq_2ESEQ__ABS__IMP,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( mono_2Ec_2Eseq_2E_2D_2D_3E @ ( mono_2Ef9431_0 @ V0f ) @ ( mono_2Ec_2Ereal_2Eabs @ V1l ) ) ) )).
