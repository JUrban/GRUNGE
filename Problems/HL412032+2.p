...
fof(lamtp_f4126,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2g] :
          ( mem(V2g,arr(A_27a,ty_2Eextreal_2Eextreal))
         => mem(f4126(A_27a,V1f,V2g),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f4126,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2g] :
          ( mem(V2g,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f4126(A_27a,V1f,V2g),V5x) = ap(ap(c_2Eextreal_2Eextreal__add,ap(V1f,V5x)),ap(V2g,V5x)) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Eintegrable__add__pos,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1f] :
             ...
             => ! [V2g] :
                 ...
                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                      ...
                      & ! [V4x] :
                          ( mem(V4x,A_27a)
                         => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V2g,V4x))) ) )
                   => p(ap(ap(c_2Elebesgue_2Eintegrable(A_27a),V0m),f4126(A_27a,V1f,V2g))) ) ) ) ) ) )).
...
fof(conj_thm_2Elebesgue_2Eintegrable__add__lemma,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
