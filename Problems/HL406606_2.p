...
tff(conj_thm_2EEncodeVar_2Eof__length__univ__suc,conjecture,(
    ! [A_27a: del,V0phi: $i] :
      ( mem(V0phi,arr(ty_2Elist_2Elist(A_27a),bool))
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( p(ap(ap(c_2Ebool_2ERES__FORALL(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n)))),f2443(A_27a,V0phi)))
        <=> ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => p(ap(ap(c_2Ebool_2ERES__FORALL(ty_2Elist_2Elist(A_27a)),ap(c_2EEncodeVar_2Eof__length(A_27a),inj__ty_2Enum_2Enum(V1n))),f2444(A_27a,V3x,V0phi))) ) ) ) )).
