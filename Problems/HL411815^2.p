...
thf(conj_thm_2Ereal__topology_2ESERIES__ABSCONV__IMP__CONV,lemma,(
    ! [V0x: $i] :
...
thf(conj_thm_2Ereal__topology_2ESERIES__REARRANGE,lemma,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUMMABLE__REARRANGE,conjecture,(
    ! [V0x: $i] :
      ( ( mem @ V0x @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Enum_2Enum @ bool ) )
         => ! [V2p: $i] :
             ...
             => ( ( ( p
                  ...
                  & ( p @ ( ap @ ( ap @ ( c_2Ereal__topology_2Epermutes @ ty_2Enum_2Enum ) @ V2p ) @ V1s ) ) )
               => ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Esummable @ V1s ) @ ( ap @ ( ap @ ( c_2Ecombin_2Eo @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) @ V0x ) @ V2p ) ) ) ) ) ) ) )).
