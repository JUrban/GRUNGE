...
thf(ax_thm_2Ereal__topology_2Eat__infinity,axiom,
    ( ( surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal @ c_2Ereal__topology_2Eat__infinity )
    = ( surj__c_ty_2Ereal__topology_2Enet_ty_2Erealax_2Ereal
      @ ( ap @ ( c_2Ereal__topology_2Emk__net @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V0x: $i] :
              ( lam @ ty_2Erealax_2Ereal
              @ ^ [V1y: $i] :
                  ( ap @ ( ap @ c_2Ereal_2Ereal__ge @ ( ap @ c_2Ereal_2Eabs @ V0x ) ) @ ( ap @ c_2Ereal_2Eabs @ V1y ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EAT__INFINITY,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
