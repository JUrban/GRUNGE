...
thf(thm_2Elift__ieee_2Enon__representable__float__is__zero,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0ff: tyop_2Erealax_2Ereal,V1P: $o] :
      ( ( c_2Ereal_2Ereal__lte @ ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__of__num @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Ereal_2Eabs @ V0ff ) ) @ ( c_2Ebinary__ieee_2Eulp @ A_27a @ A_27b @ ( c_2Ebool_2Ethe__value @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) ) )
     => ( ( c_2Ebinary__ieee_2Efloat__to__real @ A_27a @ A_27b @ ( c_2Ebinary__ieee_2Efloat__round @ A_27a @ A_27b @ c_2Ebinary__ieee_2EroundTiesToEven @ V1P @ V0ff ) )
        = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) )).
