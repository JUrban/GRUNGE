...
tff(conj_thm_2Eextreal_2Emul__assoc,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] : surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V0x)),ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V1y)),inj__ty_2Eextreal_2Eextreal(V2z)))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V0x)),inj__ty_2Eextreal_2Eextreal(V1y))),inj__ty_2Eextreal_2Eextreal(V2z))) )).
...
tff(lmtp_f4115,type,(
    f4115: ( del * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f4115,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z: tp__ty_2Erealax_2Ereal] : mem(f4115(A_27a,V4f,V5z),arr(A_27a,ty_2Eextreal_2Eextreal)) ) )).

tff(lameq_f4115,axiom,(
    ! [A_27a: del,V4f: $i] :
      ( mem(V4f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V5z: tp__ty_2Erealax_2Ereal,V9t: $i] :
          ( mem(V9t,A_27a)
         => ap(f4115(A_27a,V4f,V5z),V9t) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(c_2Eextreal_2ENormal,inj__ty_2Erealax_2Ereal(V5z))),ap(V4f,V9t)) ) ) )).

tff(conj_thm_2Elebesgue_2Epos__simple__fn__cmul,conjecture,(
    ! [A_27a: del,V0s: $i] :
