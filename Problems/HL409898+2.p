    ...
    ! [A_27a,V1p] :
     ...
     => ! [V2i] :
         ...
         => ! [V3x] :
             ...
             => ap(f3432(A_27a,V1p,V2i),V3x) = ap(ap(V1p,V3x),V2i) ) ) ) )).

fof(lamtp_f3433,axiom,(
    ! [A_27a,V1p] :
      ( mem(V1p,arr(ty_2Erealax_2Ereal,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V0s] :
    ...
    ! [A_27a,V1p] :
     ...
     => ! [V0s] :
         ...
         => ! [V4x] :
             ...
             => ap(f3433(A_27a,V1p,V0s),V4x) = ap(ap(c_2Eiterate_2ESum(A_27a),V0s),ap(V1p,V4x)) ) ) ) )).

fof(conj_thm_2Eiterate_2EPOLYNOMIAL__FUNCTION__SUM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
