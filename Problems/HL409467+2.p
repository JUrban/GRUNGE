...
fof(conj_thm_2Efloat_2EVAL__THRESHOLD,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ( p(ap(c_2Eieee_2EFinite,V0a))
       => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(c_2Eieee_2EVal,V0a))),ap(c_2Eieee_2Ethreshold,c_2Eieee_2Efloat__format))) ) ) )).
...
fof(conj_thm_2Efloat_2EERROR__IS__ZERO,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Eieee_2Efloat)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ( p(ap(c_2Eieee_2EFinite,V0a))
              & ap(c_2Eieee_2EVal,V0a) = V1x )
           => ap(c_2Efloat_2Eerror,V1x) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) )).
