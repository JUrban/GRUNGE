...
thf(thm_2Edivides_2EONE__DIVIDES__ALL,axiom,(
    ! [V0a: tyop_2Enum_2Enum] :
      ( c_2Edivides_2Edivides @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) @ V0a ) )).
          ...
          @ ( c_2Epred__set_2EINTER @ tyop_2Enum_2Enum
            @ ( c_2Epred__set_2EGSPEC @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
              @ ^ [V1n: tyop_2Enum_2Enum] :
                  ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ $o @ V1n @ ( c_2Earithmetic_2E_3C_3D @ V1n @ ( c_2Epred__set_2EMIN__SET @ ( c_2Epred__set_2EDELETE @ tyop_2Enum_2Enum @ V0s @ c_2Enum_2E0 ) ) ) ) )
            @ ( c_2Epred__set_2EGSPEC @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum
              @ ^ [V2d: tyop_2Enum_2Enum] :
                  ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ $o @ V2d
                  @ ( c_2Ebool_2E_21 @ tyop_2Enum_2Enum
                    @ ^ [V3e: tyop_2Enum_2Enum] :
                        ( c_2Emin_2E_3D_3D_3E @ ( c_2Ebool_2EIN @ tyop_2Enum_2Enum @ V3e @ V0s ) @ ( c_2Edivides_2Edivides @ V2d @ V3e ) ) ) ) ) ) ) ) ) )).
