...
fof(conj_thm_2EHolSmt_2Er136,conjecture,(
    ! [V0u] :
      ( mem(V0u,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ( ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) = ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)
          <=> ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0) ) ) ) )).
