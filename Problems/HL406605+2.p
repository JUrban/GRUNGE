...
fof(conj_thm_2EEncodeVar_2Efixed__width__univ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0phi] :
          ( mem(V0phi,arr(A_27a,bool))
                 ...
                 => ( ( p(ap(c_2ECoder_2Ewf__coder(A_27a),V1c))
                   ...
                   => ( ! [V3x] :
                         ...
                         => ( p(ap(ap(c_2ECoder_2Edomain(A_27a),V1c),V3x))
                           => p(ap(V0phi,V3x)) ) )
                    <=> p(ap(ap(c_2Ebool_2ERES__FORALL(ty_2Elist_2Elist(bool)),ap(c_2EEncodeVar_2Eof__length(bool),V2n)),f2442(A_27a,V1c,V0phi))) ) ) ) ) ) ) )).
