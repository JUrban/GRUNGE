...
tff(conj_thm_2Efinite__map_2EFMAP__MAP2__FEMPTY,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b))
     => ap(ap(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),V0f),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)) = c_2Efinite__map_2EFEMPTY(A_27a,A_27a) ) )).
