...
tff(conj_thm_2Epred__set_2EBIJ__FINITE__SUBSET,lemma,(
    ! [A_27a: del,V0f: $i] :
...
tff(conj_thm_2Eseq_2ENUM__2D__BIJ__SMALL__SQUARE,conjecture,(
    ! [V0f: $i] :
