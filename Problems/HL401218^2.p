...
thf(conj_thm_2Enumpair_2Einvtri0__ind,conjecture,(
    ! [V0P: $i] :
     ...
     => ( ! [V1n: tp__ty_2Enum_2Enum,V2a: tp__ty_2Enum_2Enum] :
       ...
       => ! [V3v: tp__ty_2Enum_2Enum,V4v1: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ V0P @ ( inj__ty_2Enum_2Enum @ V3v ) ) @ ( inj__ty_2Enum_2Enum @ V4v1 ) ) ) ) ) )).
