...
tff(lamtp_f3604,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1B: $i] :
          ( mem(V1B,arr(A_27a,bool))
         => mem(f3604(A_27a,V0A,V1B),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
tff(lameq_f3604,axiom,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1B: $i] :
         ...
         => ! [V2t: $i] :
              ( mem(V2t,A_27a)
             => ap(f3604(A_27a,V0A,V1B),V2t) = ap(ap(c_2Eextreal_2Eextreal__mul,ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V0A),V2t)),ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),V1B),V2t)) ) ) ) )).

tff(lmtp_f3605,type,(
    f3605: ( del * $i * $i ) > $i )).

tff(lamtp_f3605,axiom,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1B: $i] :
          ( mem(V1B,arr(A_27a,bool))
         => mem(f3605(A_27a,V0A,V1B),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).
...
tff(lameq_f3605,axiom,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1B: $i] :
         ...
         => ! [V3t: $i] :
              ( mem(V3t,A_27a)
             => ap(f3605(A_27a,V0A,V1B),V3t) = ap(ap(c_2Emeasure_2Eindicator__fn(A_27a),ap(ap(c_2Epred__set_2EINTER(A_27a),V0A),V1B)),V3t) ) ) ) )).

tff(conj_thm_2Emeasure_2EINDICATOR__FN__MUL__INTER,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ! [V1B: $i] :
          ( mem(V1B,arr(A_27a,bool))
         => f3604(A_27a,V0A,V1B) = f3605(A_27a,V0A,V1B) ) ) )).
