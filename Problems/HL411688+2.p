...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT__EQ,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCRETE__RANGE__CONSTANT,conjecture,(
    ! [V0f] :
                   ...
                   => ? [V3e] :
                        ...
                        & ! [V4y] :
                           ...
                           => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1s))
                                & ap(V0f,V4y) != ap(V0f,V2x) )
                             => p(ap(ap(c_2Ereal_2Ereal__lte,V3e),ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V4y)),ap(V0f,V2x))))) ) ) ) ) ) )
           => ? [V5a] :
                ( mem(V5a,ty_2Erealax_2Ereal)
                & ! [V6x] :
                    ( mem(V6x,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V6x),V1s))
                     => ap(V0f,V6x) = V5a ) ) ) ) ) ) )).
