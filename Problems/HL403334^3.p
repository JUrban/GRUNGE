...
thf(thm_2Ebag_2EBAG__INN__0,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1e: A_27a] :
      ( c_2Ebag_2EBAG__INN @ A_27a @ V1e @ c_2Enum_2E0 @ V0b ) )).
...
thf(thm_2Ebag_2EBAG__FILTER__SUB__BAG,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1b: A_27a > tyop_2Enum_2Enum] :
      ( c_2Ebag_2ESUB__BAG @ A_27a @ ( c_2Ebag_2EBAG__FILTER @ A_27a @ V0P @ V1b ) @ V1b ) )).
