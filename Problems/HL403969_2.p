...
tff(conj_thm_2Elist_2EGENLIST__CONS,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(ap(c_2Elist_2EGENLIST(A_27a),V0f),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))) = ap(ap(c_2Elist_2ECONS(A_27a),ap(V0f,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Elist_2EGENLIST(A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),c_2Enum_2ESUC)),inj__ty_2Enum_2Enum(V1n))) ) )).
...
tff(conj_thm_2Ellist_2ELGENLIST__EQ__CONS,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
     => ! [V1h: $i] :
          ( mem(V1h,A_27a)
         => ! [V2t: $i] :
             ...
             => ( ap(ap(c_2Ellist_2ELGENLIST(A_27a),V0f),c_2Eoption_2ENONE(ty_2Enum_2Enum)) = ap(ap(c_2Ellist_2ELCONS(A_27a),V1h),V2t)
              <=> ( V1h = ap(V0f,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))
                  & V2t = ap(ap(c_2Ellist_2ELGENLIST(A_27a),ap(ap(c_2Ecombin_2Eo(ty_2Enum_2Enum,ty_2Enum_2Enum,ty_2Enum_2Enum),V0f),ap(c_2Earithmetic_2E_2B,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),c_2Eoption_2ENONE(ty_2Enum_2Enum)) ) ) ) ) ) )).

tff(conj_thm_2Ellist_2ELGENLIST__CHUNK__GENLIST,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
