...
fof(conj_thm_2Ecardinal_2ECARD__ADD__SYM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0s] :
             ...
             => ! [V1t] :
                  ( mem(V1t,arr(A_27b,bool))
                 => p(ap(ap(c_2Ecardinal_2Ecardeq(ty_2Esum_2Esum(A_27a,A_27a),ty_2Esum_2Esum(A_27a,A_27a)),ap(ap(c_2Ecardinal_2E_2B__c(A_27a,A_27a),V0s),V1t)),ap(ap(c_2Ecardinal_2E_2B__c(A_27b,A_27b),V1t),V0s))) ) ) ) ) )).
