...
thf(conj_thm_2Einftree_2Eis__tree__rules,conjecture,(
    ! [A_27a: del,A_27b: del,A_27d: del] :
      ( ! [V0a: $i] :
          ( ( mem @ V0a @ A_27a )
         => ( p
             ...
             => ( ! [V4d: $i] :
               ...
               => ( p
                  @ ( ap @ ( c_2Einftree_2Eis__tree @ A_27a @ A_27b @ A_27d )
                    @ ( lam @ ( ty_2Elist_2Elist @ A_27d )
                      @ ^ [V5p: $i] :
                          ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Esum_2Esum @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( ty_2Elist_2Elist @ A_27d ) ) @ V5p ) @ ( c_2Elist_2ENIL @ A_27d ) ) ) @ ( ap @ ( c_2Esum_2EINR @ A_27a @ A_27b ) @ V3b ) ) @ ( ap @ ( ap @ V2f @ ( ap @ ( c_2Elist_2EHD @ A_27d ) @ V5p ) ) @ ( ap @ ( c_2Elist_2ETL @ A_27d ) @ V5p ) ) ) ) ) ) ) ) ) ) )).
