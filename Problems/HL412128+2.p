...
fof(conj_thm_2Eprobability_2Ejoint__distribution__sym,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V3a] :
                             ...
                             => ! [V4b] :
                                 ...
                                 => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                   => ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b)) = ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27c,A_27c,A_27c),V0p),V2Y),V1X),ap(ap(c_2Epred__set_2ECROSS(A_27c,A_27c),V4b),V3a)) ) ) ) ) ) ) ) ) ) )).
