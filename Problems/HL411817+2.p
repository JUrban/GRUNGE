    ...
    ! [V0f] :
     ...
     => ! [V1g] :
         ...
         => ! [V3x] :
             ...
             => ap(f2910(V0f,V1g),V3x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EEXISTS__FINITE__SUBSET__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2EIN__BALL__0,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
...
fof(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL__SUBTOPOLOGY,lemma,(
    ! [V0s] :
      ...
      <=> ! [V1f] :
           ...
           => ( ( ! [V2t] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V2t),V1f))
                     => p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V0s)),V2t)) ) )
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUB,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__IN__PREIMAGE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ELIM__DROP__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
...
fof(lamtp_f4054,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => mem(f4054(V0f,V4x),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f4054,axiom,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V4x] :
          ( mem(V4x,ty_2Erealax_2Ereal)
         => ! [V5n] :
              ( mem(V5n,ty_2Enum_2Enum)
             => ap(f4054(V0f,V4x),V5n) = ap(ap(V0f,V5n),V4x) ) ) ) )).

fof(lamtp_f4056,axiom,(
    ! [V8e] :
     ...
     => ! [V9n] :
         ...
         => ! [V0f] :
             ...
             => ! [V1g] :
                 ...
                 => ! [V2s] :
                      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
                     => mem(f4056(V8e,V9n,V0f,V1g,V2s),arr(ty_2Erealax_2Ereal,bool)) ) ) ) ) ) )).

fof(lameq_f4056,axiom,(
    ! [V8e] :
      ( mem(V8e,ty_2Erealax_2Ereal)
     => ! [V9n] :
          ( mem(V9n,ty_2Enum_2Enum)
             ...
             => ! [V1g] :
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V10x] :
                         ...
                         => ap(f4056(V8e,V9n,V0f,V1g,V2s),V10x) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V10x),V2s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V0f,V9n),V10x)),ap(V1g,V10x)))),V8e)) ) ) ) ) ) ) )).

fof(lamtp_f4055,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0f] :
             ...
             => ! [V8e] :
                  ( mem(V8e,ty_2Erealax_2Ereal)
                 => mem(f4055(V2s,V1g,V0f,V8e),arr(ty_2Enum_2Enum,bool)) ) ) ) ) )).

fof(lameq_f4055,axiom,(
    ! [V2s] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V0f] :
             ...
             => ! [V8e] :
                 ...
                 => ! [V9n] :
                      ( mem(V9n,ty_2Enum_2Enum)
                     => ap(f4055(V2s,V1g,V0f,V8e),V9n) = ap(c_2Ebool_2E_21(ty_2Erealax_2Ereal),f4056(V8e,V9n,V0f,V1g,V2s)) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDINI,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))
     => ! [V1g] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2s] :
              ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
             => ( ( p(ap(c_2Ereal__topology_2Ecompact,V2s))
                  & ! [V3n] :
                      ( mem(V3n,ty_2Enum_2Enum)
                     => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,ap(V0f,V3n)),V2s)) )
                  & p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V1g),V2s))
                  & ! [V4x] :
                      ( mem(V4x,ty_2Erealax_2Ereal)
                     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4x),V2s))
                       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),f4054(V0f,V4x)),ap(V1g,V4x)),c_2Ereal__topology_2Esequentially)) ) )
                  & ! [V6n] :
                      ( mem(V6n,ty_2Enum_2Enum)
                     => ! [V7x] :
                          ( mem(V7x,ty_2Erealax_2Ereal)
                         => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),V2s))
                           => p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(V0f,V6n),V7x)),ap(ap(V0f,ap(ap(c_2Earithmetic_2E_2B,V6n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V7x))) ) ) ) )
               => ! [V8e] :
                    ( mem(V8e,ty_2Erealax_2Ereal)
                   => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V8e))
                     => p(ap(ap(c_2Ereal__topology_2Eeventually(ty_2Enum_2Enum),f4055(V2s,V1g,V0f,V8e)),c_2Ereal__topology_2Esequentially)) ) ) ) ) ) ) )).
