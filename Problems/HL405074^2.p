...
thf(conj_thm_2EOmega__Automata_2EFORALL__EXISTS__THM,conjecture,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ( ! [V1t1: tp__ty_2Enum_2Enum] :
          ? [V2t2: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ V0P @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1t1 ) ) @ ( inj__ty_2Enum_2Enum @ V2t2 ) ) ) )
