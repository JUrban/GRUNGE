...
thf(stp_fo_c_2Ebitstring_2Etestbit,type,(
    fo__c_2Ebitstring_2Etestbit: tp__ty_2Enum_2Enum > tp__c_ty_2Elist_2Elist_o > $o )).

thf(stp_eq_fo_c_2Ebitstring_2Etestbit,axiom,(
    ! [X0: tp__ty_2Enum_2Enum,X1: tp__c_ty_2Elist_2Elist_o] :
      ( ( inj__o @ ( fo__c_2Ebitstring_2Etestbit @ X0 @ X1 ) )
      = ( ap @ ( ap @ c_2Ebitstring_2Etestbit @ ( inj__ty_2Enum_2Enum @ X0 ) ) @ ( inj__c_ty_2Elist_2Elist_o @ X1 ) ) ) )).
...
thf(conj_thm_2Ebitstring_2Elength__fixwidth,lemma,(
...
thf(conj_thm_2Ebitstring_2Elength__shiftr,lemma,(
...
thf(conj_thm_2Ebitstring_2Eel__fixwidth,lemma,(
...
thf(conj_thm_2Ebitstring_2Eel__shiftr,lemma,(
...
thf(conj_thm_2Ebitstring_2Etestbit,lemma,(
...
thf(conj_thm_2Ebitstring_2Eword__msb__v2w,lemma,(
...
thf(conj_thm_2Ebitstring_2Eword__lsr__v2w,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] :
    ...
    ! [A_27a: del,V0h: tp__ty_2Enum_2Enum,V1l: tp__ty_2Enum_2Enum] :
      ...
      = ( lam @ ( ty_2Efcp_2Ecart @ bool @ A_27a )
        @ ^ [V2w: $i] :
            ...
            @ ( lam @ ty_2Enum_2Enum
              @ ^ [V3i: $i] :
                  ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1l ) ) @ V3i ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ V3i ) @ ( ap @ ( ap @ c_2Earithmetic_2EMIN @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Efcp_2Efcp__index @ bool @ A_27a ) @ V2w ) @ V3i ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ewords_2Eword__bit,lemma,(
    ! [A_27a: del,V0w: $i] :
...
thf(conj_thm_2Ewords_2Eword__asr,lemma,(
    ! [A_27a: del,V0w: $i] :
      ( ( mem @ V0w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ap @ ( ap @ ( c_2Ewords_2Eword__asr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1n ) )
          = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) ) @ ( ap @ ( c_2Ewords_2Eword__msb @ A_27a ) @ V0w ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27a ) @ ( ap @ ( ap @ ( ap @ ( c_2Ewords_2Eword__slice @ A_27a ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2D @ ( ap @ ( c_2Efcp_2Edimindex @ A_27a ) @ ( c_2Ebool_2Ethe__value @ A_27a ) ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( c_2Ewords_2Eword__T @ A_27a ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V0w ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) ) ) )).

thf(conj_thm_2Ewords_2Eword__bit__0,lemma,(
    ! [A_27a: del,V0h: tp__ty_2Enum_2Enum] :
      ~ ( p @ ( ap @ ( ap @ ( c_2Ewords_2Eword__bit @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0h ) ) @ ( ap @ ( c_2Ewords_2En2w @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) )).

thf(conj_thm_2Ebitstring_2Eword__asr__v2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1v: tp__c_ty_2Elist_2Elist_o] :
