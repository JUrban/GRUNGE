...
fof(lamtp_f373,axiom,(
    ! [A_27a,V0xss] :
      ( mem(V0xss,arr(arr(A_27a,bool),bool))
     => ! [V1choice] :
          ( mem(V1choice,arr(arr(A_27a,bool),A_27a))
         => mem(f373(A_27a,V0xss,V1choice),arr(arr(A_27a,bool),bool)) ) ) )).
    ...
    ! [A_27a,V0xss] :
     ...
     => ! [V1choice] :
         ...
         => ! [V2xs] :
             ...
             => ap(f373(A_27a,V0xss,V1choice),V2xs) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V2xs),V0xss)),ap(ap(c_2Ebool_2EIN(A_27a),ap(V1choice,V2xs)),V2xs)) ) ) ) )).

fof(lamtp_f372,axiom,(
    ! [A_27a,A_27a,V0xss] :
      ( mem(V0xss,arr(arr(A_27a,bool),bool))
     => mem(f372(A_27a,A_27a,V0xss),arr(arr(arr(A_27a,bool),A_27a),ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))) ) )).
...
fof(lameq_f372,axiom,(
    ! [A_27a,A_27a,V0xss] :
     ...
     => ! [V1choice] :
          ( mem(V1choice,arr(arr(A_27a,bool),A_27a))
         => ap(f372(A_27a,A_27a,V0xss),V1choice) = ap(ap(c_2Epair_2E_2C(arr(A_27a,bool),arr(A_27a,bool)),ap(ap(c_2Epred__set_2EIMAGE(arr(A_27a,bool),arr(A_27a,bool)),V1choice),V0xss)),ap(c_2Ebool_2E_21(arr(A_27a,bool)),f373(A_27a,V0xss,V1choice))) ) ) )).
...
fof(ax_thm_2Eset__relation_2Eall__choices__def,axiom,(
    ! [A_27a] :
     ...
     => ! [V0xss] :
          ( mem(V0xss,arr(arr(A_27a,bool),bool))
         => ap(c_2Eset__relation_2Eall__choices(A_27a),V0xss) = ap(c_2Epred__set_2EGSPEC(arr(A_27a,bool),arr(A_27a,bool)),f372(A_27a,A_27a,V0xss)) ) ) )).

fof(conj_thm_2Eset__relation_2Eall__choices__thm,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0x] :
