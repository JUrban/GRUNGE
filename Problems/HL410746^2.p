...
thf(conj_thm_2Ereal__topology_2EINTERIOR__UNIONS__OPEN__SUBSETS,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
            @ ( lam @ ( arr @ ty_2Erealax_2Ereal @ bool )
              @ ^ [V1t: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) @ V1t ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ereal__topology_2EOpen @ V1t ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V1t ) @ V0s ) ) ) ) ) )
        = ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) ) )).
