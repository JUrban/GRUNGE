...
tff(lmtp_f2836,type,(
    f2836: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2836,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : mem(f2836(V0x),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f2836,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] : ap(f2836(V0x),inj__ty_2Erealax_2Ereal(V1y)) = ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,inj__ty_2Erealax_2Ereal(V1y)),inj__ty_2Erealax_2Ereal(V0x))) )).

tff(lmtp_f2835,type,(
    f2835: $i )).

tff(lamtp_f2835,axiom,(
    mem(f2835,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) )).

tff(lameq_f2835,axiom,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : ap(f2835,inj__ty_2Erealax_2Ereal(V0x)) = f2836(V0x) )).

tff(conj_thm_2Emetric_2EISMET__R1,lemma,(
...
tff(ax_thm_2Emetric_2Emr1,axiom,(
    surj__c_ty_2Emetric_2Emetric_ty_2Erealax_2Ereal(c_2Emetric_2Emr1) = surj__c_ty_2Emetric_2Emetric_ty_2Erealax_2Ereal(ap(c_2Emetric_2Emetric(ty_2Erealax_2Ereal),ap(c_2Epair_2EUNCURRY(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f2835))) )).

tff(conj_thm_2Emetric_2EMR1__DEF,conjecture,(
