...
thf(conj_thm_2Efinite__map_2EFOLDL__FUPDATE__LIST,lemma,(
...
thf(conj_thm_2Efinite__map_2EFUPDATE__LIST__SNOC,lemma,(
...
thf(conj_thm_2Efinite__map_2Efupdate__list__map,conjecture,(
                                ...
                                @ ( ap @ ( c_2Epair_2EUNCURRY @ A_27a @ A_27b @ ( ty_2Epair_2Eprod @ A_27a @ A_27c ) )
                                  @ ( lam @ A_27a
                                    @ ^ [V4a: $i] :
                                        ( lam @ A_27b
                                        @ ^ [V5b: $i] :
                                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27c ) @ V4a ) @ ( ap @ V1f @ V5b ) ) ) ) ) )
                              @ V0l ) ) )
                        @ V2x )
