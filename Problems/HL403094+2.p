...
fof(lamtp_f899,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f899(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f899,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t] :
              ( mem(V2t,ty_2Enum_2Enum)
             => ap(f899(V0a,V1b),V2t) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(ap(c_2ETemporal__Logic_2EUNTIL,f893(V1b)),f900(V0a,V1b)),V2t)),ap(ap(c_2ETemporal__Logic_2EEVENTUAL,V1b),V2t)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2ESWHEN__AS__UNTIL,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => ap(ap(c_2ETemporal__Logic_2ESWHEN,V0a),V1b) = f899(V0a,V1b) ) ) )).
