...
tff(conj_thm_2Equotient_2EK__PRS,conjecture,(
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6x: $i] :
                                 ...
                                 => ! [V7y: $i] :
                                      ( mem(V7y,A_27d)
                                     => ap(ap(c_2Ecombin_2EK(A_27c,A_27c),V6x),V7y) = ap(V1abs1,ap(ap(c_2Ecombin_2EK(A_27a,A_27a),ap(V2rep1,V6x)),ap(V5rep2,V7y))) ) ) ) ) ) ) ) ) ) ) )).
