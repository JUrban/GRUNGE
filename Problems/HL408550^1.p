...
thf(f10436_0_2E0,type,(
    f10436_0_2E0: u )).

thf(f10436_0_2E4,type,(
    f10436_0_2E4: du > du > du > du > u )).

thf(f10436_1_2E0,type,(
    f10436_1_2E0: u )).

thf(f10436_1_2E1,type,(
    f10436_1_2E1: du > u )).

thf(f10436_2_2E0,type,(
    f10436_2_2E0: u )).

thf(f10436_2_2E1,type,(
    f10436_2_2E1: du > u )).
...
thf(mono_2Ef10436_2,type,(
    mono_2Ef10436_2: mono_2Etyop_2Ebinary__ieee_2Erounding > $o )).
...
thf(arityeq4_2Emono_2Ef10436_0_2E4_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0: mono_2Etyop_2Erealax_2Ereal,X1: mono_2Etyop_2Erealax_2Ereal,X2_2E0: u,X3_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_0_2E4 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X1 ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X2_2E0 ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X3_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Emin_2Efun @ tyop_2Erealax_2Ereal @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) ) ) @ f10436_0_2E0 ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X0 ) ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ X1 ) ) ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X2_2E0 ) ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X3_2E0 ) ) ) ) ) )).

thf(arityeq1_2Emono_2Ef10436_1_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_1_2E1 @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ f10436_1_2E0 ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Ebinary__ieee_2Efloat__add_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
...
thf(def0_2Ethm_2Ebinary__ieee_2Efloat__add__finite,axiom,(
    ! [V0mode: mono_2Etyop_2Ebinary__ieee_2Erounding] :
      ( ( mono_2Ef10436_2 @ V0mode )
    <=> ( V0mode = mono_2Ec_2Ebinary__ieee_2EroundTowardNegative ) ) )).

thf(def1_2Ethm_2Ebinary__ieee_2Efloat__add__finite,axiom,(
    ! [A_27a: d,A_27b: d,V3r1: mono_2Etyop_2Erealax_2Ereal,V4r2: mono_2Etyop_2Erealax_2Ereal,V1x_2E0: u,V2y_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_0_2E4 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V3r1 ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V4r2 ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V2y_2E0 ) ) ) )
    <=> ( ( V3r1
          = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
        & ( V4r2
          = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )
...
thf(def2_2Ethm_2Ebinary__ieee_2Efloat__add__finite,axiom,(
    ! [A_27a: d,A_27b: d,V1x_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_1_2E1 @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) ) ) )
    <=> ( ( j_mono_2Etyop_2Efcp_2Ecart_28tyop_2Emin_2Ebool_2Ctyop_2Eone_2Eone_29 @ ( s @ ( tyop_2Efcp_2Ecart @ tyop_2Emin_2Ebool @ tyop_2Eone_2Eone ) @ ( c_2Ebinary__ieee_2Efloat__Sign_2E1 @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) ) ) )
        = ( mono_2Ec_2Ewords_2En2w_2Emono_2Etyop_2Eone_2Eone @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) )).

thf(thm_2Ebinary__ieee_2Efloat__add__finite,conjecture,(
    ! [A_27a: d,A_27b: d,V0mode: mono_2Etyop_2Ebinary__ieee_2Erounding,V1x_2E0: u,V2y_2E0: u,V3r1: mono_2Etyop_2Erealax_2Ereal,V4r2: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ( ( s @ ( tyop_2Epair_2Eprod @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) @ ( c_2Ebinary__ieee_2Efloat__add_2E3 @ ( s @ tyop_2Ebinary__ieee_2Erounding @ ( i_mono_2Etyop_2Ebinary__ieee_2Erounding @ V0mode ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V2y_2E0 ) ) )
        = ( s @ ( tyop_2Epair_2Eprod @ tyop_2Ebinary__ieee_2Eflags @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) ) @ ( c_2Ebinary__ieee_2Efloat__round__with__flags_2E3 @ ( s @ tyop_2Ebinary__ieee_2Erounding @ ( i_mono_2Etyop_2Ebinary__ieee_2Erounding @ V0mode ) ) @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_0_2E4 @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V3r1 ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ V4r2 ) ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V2y_2E0 ) ) ) ) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f10436_1_2E1 @ ( s @ ( tyop_2Ebinary__ieee_2Efloat @ A_27a @ A_27b ) @ V1x_2E0 ) ) ) ) @ ( mono_2Ef10436_2 @ V0mode ) ) ) ) @ ( s @ tyop_2Erealax_2Ereal @ ( i_mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__add @ V3r1 @ V4r2 ) ) ) ) ) ) ) )).
