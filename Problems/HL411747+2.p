...
fof(lameq_f4018,axiom,(
    ! [V0f] :
     ...
     => ! [V3i] :
         ...
         => ap(f4018(V0f),V3i) = ap(V0f,V3i) ) ) )).

fof(conj_thm_2Ereal__topology_2ESERIES__COMPONENT,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1s] :
         ...
         => ! [V2l] :
             ...
             => ( p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),V2l),V1s))
               => p(ap(ap(ap(c_2Ereal__topology_2Esums,f4018(V0f)),V2l),V1s)) ) ) ) ) )).
