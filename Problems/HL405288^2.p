...
thf(conj_thm_2Einteger_2ETINT__ADD__LINV,lemma,(
    ! [V0x: tp__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Einteger_2Etint__eq @ ( ap @ ( ap @ c_2Einteger_2Etint__add @ ( ap @ c_2Einteger_2Etint__neg @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0x ) ) ) @ ( inj__c_ty_2Epair_2Eprod_ty_2Enum_2Enum_ty_2Enum_2Enum @ V0x ) ) ) @ c_2Einteger_2Etint__0 ) ) )).

thf(conj_thm_2Einteger_2ETINT__NEG__WELLDEF,lemma,(
...
thf(conj_thm_2Einteger_2EINT__ADD__LINV,conjecture,(
