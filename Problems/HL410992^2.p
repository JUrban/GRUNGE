...
thf(conj_thm_2Ereal__topology_2ELIMPT__SUBSET,lemma,(
...
thf(conj_thm_2Ereal__topology_2ETRIVIAL__LIMIT__WITHIN,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ENETLIMIT__WITHIN,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1s: $i] :
     ...
     => ( ~ ( p @ ( ap @ ( c_2Ereal__topology_2Etrivial__limit @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) @ V1s ) ) )
       => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( c_2Ereal__topology_2Enetlimit @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V0a ) ) ) @ V1s ) ) )
          = V0a ) ) ) )).

thf(conj_thm_2Ereal__topology_2ELIMPT__BALL,lemma,(
...
thf(conj_thm_2Ereal__topology_2ENETLIMIT__WITHIN__INTERIOR,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ V0s ) ) )
         => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( c_2Ereal__topology_2Enetlimit @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Ewithin @ ty_2Erealax_2Ereal ) @ ( ap @ c_2Ereal__topology_2Eat @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ V0s ) ) )
            = V1x ) ) ) )).
