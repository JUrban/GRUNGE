...
fof(conj_thm_2Ereal__topology_2EFORALL__IN__CLOSURE__EQ,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EHAUSDIST__EQ__0,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
              & p(ap(c_2Ereal__topology_2Ebounded__def,V1t)) )
           => ( ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t)) = ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
            <=> ( V0s = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                | V1t = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
