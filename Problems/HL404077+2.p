...
fof(lameq_f1375,axiom,(
    ! [V0a] :
     ...
     => ! [V2t] :
          ( mem(V2t,ty_2Enum_2Enum)
         => ap(f1375(V0a),V2t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,V0a),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V2t) ) ) )).

fof(lamtp_f1376,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
...
fof(lameq_f1376,axiom,(
    ! [V0a] :
     ...
     => ! [V4t] :
          ( mem(V4t,ty_2Enum_2Enum)
         => ap(f1376(V0a),V4t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1311(V0a)),k(ty_2Enum_2Enum,c_2Ebool_2EF)),V4t)) ) ) )).

fof(lamtp_f1377,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V7t] :
             ...
             => ap(f1377(V0a,V1b),V7t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1296(V1b)),f1297(V0a,V1b)),V7t)) ) ) ) )).

fof(lamtp_f1378,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V10t] :
             ...
             => ap(f1378(V1b,V0a),V10t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1314(V1b)),f1315(V0a,V1b)),V10t) ) ) ) )).

fof(lamtp_f1379,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V13t] :
             ...
             => ap(f1379(V0a,V1b),V13t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1317(V0a,V1b)),f1318(V0a,V1b)),V13t)) ) ) ) )).

fof(lamtp_f1380,axiom,(
    ! [V1b] :
      ( mem(V1b,arr(ty_2Enum_2Enum,bool))
     => ! [V0a] :
          ( mem(V0a,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V1b] :
     ...
     => ! [V0a] :
         ...
         => ! [V16t] :
             ...
             => ap(f1380(V1b,V0a),V16t) = ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1320(V1b)),f1321(V0a,V1b)),V16t) ) ) ) )).

fof(lamtp_f1381,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
    ...
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V19t] :
             ...
             => ap(f1381(V0a,V1b),V19t) = ap(c_2Ebool_2E_7E,ap(ap(ap(c_2EPast__Temporal__Logic_2EPUNTIL,f1323(V0a)),V1b),V19t)) ) ) ) )).

fof(conj_thm_2EPast__Temporal__Logic_2EPUNTIL__EXPRESSIVE,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
