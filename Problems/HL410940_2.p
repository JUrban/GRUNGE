...
tff(lmtp_f3767,type,(
    f3767: ( del * del * tp__ty_2Erealax_2Ereal * $i * $i * $i * $i ) > $i )).

tff(lamtp_f3767,axiom,(
     ...
     => ! [V7x: $i] :
         ...
         => ! [V4l: $i] :
             ...
             => ! [V1P: $i] :
                 ...
                 => ! [V8n: $i] :
                      ( mem(V8n,A_27b)
                     => ap(f3767(A_27a,A_27b,V6e,V2f,V7x,V4l,V1P),V8n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1P,V8n)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V2f,V8n),V7x)),ap(V4l,V8n)))),inj__ty_2Erealax_2Ereal(V6e))) ) ) ) ) ) )).

tff(lmtp_f3766,type,(
    f3766: ( del * del * $i * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3766,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
     ...
     => ! [V4l: $i] :
         ...
         => ! [V2f: $i] :
              ( mem(V2f,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
             => ! [V6e: tp__ty_2Erealax_2Ereal] : mem(f3766(A_27b,A_27a,V1P,V4l,V2f,V6e),arr(A_27a,bool)) ) ) ) )).

tff(lameq_f3766,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V4l: $i] :
          ( mem(V4l,arr(A_27b,ty_2Erealax_2Ereal))
     ...
     => ! [V10x: $i] :
         ...
         => ! [V5m: $i] :
             ...
             => ! [V1P: $i] :
                 ...
                 => ! [V11n: $i] :
                      ( mem(V11n,A_27b)
                     => ap(f3769(A_27a,A_27b,V9e,V3g,V10x,V5m,V1P),V11n) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(V1P,V11n)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V3g,V11n),V10x)),ap(V5m,V11n)))),inj__ty_2Erealax_2Ereal(V9e))) ) ) ) ) ) )).

tff(lmtp_f3768,type,(
    f3768: ( del * del * $i * $i * $i * tp__ty_2Erealax_2Ereal ) > $i )).

tff(lamtp_f3768,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m: $i] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
         => ! [V3g: $i] :
              ( mem(V3g,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
             => ! [V9e: tp__ty_2Erealax_2Ereal] : mem(f3768(A_27b,A_27a,V1P,V5m,V3g,V9e),arr(A_27a,bool)) ) ) ) )).

tff(lameq_f3768,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m: $i] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
         => ! [V3g: $i] :
              ( mem(V3g,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
             => ! [V9e: tp__ty_2Erealax_2Ereal,V10x: $i] :
                  ( mem(V10x,A_27a)
                 => ap(f3768(A_27b,A_27a,V1P,V5m,V3g,V9e),V10x) = ap(c_2Ebool_2E_21(A_27b),f3769(A_27a,A_27b,V9e,V3g,V10x,V5m,V1P)) ) ) ) ) )).

tff(lmtp_f3771,type,(
    f3771: ( del * del * tp__ty_2Erealax_2Ereal * $i * $i * $i * $i * $i * $i ) > $i )).

tff(lamtp_f3771,axiom,(
         ...
         => ! [V13x: $i] :
             ...
             => ! [V4l: $i] :
                 ...
                 => ! [V5m: $i] :
                     ...
                     => ! [V1P: $i] :
                          ( mem(V1P,arr(A_27b,bool))
                         => mem(f3771(A_27a,A_27b,V12e,V2f,V3g,V13x,V4l,V5m,V1P),arr(A_27b,bool)) ) ) ) ) ) ) )).

tff(lameq_f3771,axiom,(
    ! [A_27a: del,A_27b: del,V12e: tp__ty_2Erealax_2Ereal,V2f: $i] :
      ( mem(V2f,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
     => ! [V3g: $i] :
          ( mem(V3g,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
     ...
     => ! [V5m: $i] :
         ...
         => ! [V4l: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ! [V2f: $i] :
                      ( mem(V2f,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
                     => ! [V12e: tp__ty_2Erealax_2Ereal] : mem(f3770(A_27b,A_27a,V1P,V5m,V4l,V3g,V2f,V12e),arr(A_27a,bool)) ) ) ) ) ) )).

tff(lameq_f3770,axiom,(
    ! [A_27b: del,A_27a: del,V1P: $i] :
      ( mem(V1P,arr(A_27b,bool))
     => ! [V5m: $i] :
          ( mem(V5m,arr(A_27b,ty_2Erealax_2Ereal))
         => ! [V4l: $i] :
             ...
             => ! [V3g: $i] :
                 ...
                 => ! [V2f: $i] :
                      ( mem(V2f,arr(A_27b,arr(A_27a,ty_2Erealax_2Ereal)))
                     => ! [V12e: tp__ty_2Erealax_2Ereal,V13x: $i] :
                          ( mem(V13x,A_27a)
                         => ap(f3770(A_27b,A_27a,V1P,V5m,V4l,V3g,V2f,V12e),V13x) = ap(c_2Ebool_2E_21(A_27b),f3771(A_27a,A_27b,V12e,V2f,V3g,V13x,V4l,V5m,V1P)) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EUNIFORM__LIM__ADD,conjecture,(
                     ...
                     => ! [V5m: $i] :
                         ...
                         => ( ( ! [V6e: tp__ty_2Erealax_2Ereal] :
                           ...
                           => ! [V12e: tp__ty_2Erealax_2Ereal] :
                               ...
                               => p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3770(A_27b,A_27a,V1P,V5m,V4l,V3g,V2f,V12e)),V0net)) ) ) ) ) ) ) ) ) )).
