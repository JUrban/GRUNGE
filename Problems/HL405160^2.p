...
thf(conj_thm_2Ebag_2EBAG__ALL__DISTINCT__THM,lemma,(
    ! [A_27a: del,A_27b: del] :
...
thf(conj_thm_2Econtainer_2EIN__LIST__TO__BAG,lemma,(
    ! [A_27a: del,V0h: $i] :
      ( ( mem @ V0h @ A_27a )
     => ! [V1l: $i] :
...
thf(conj_thm_2Econtainer_2ELIST__TO__BAG__DISTINCT,conjecture,(
    ! [A_27a: del,V0b: $i] :
