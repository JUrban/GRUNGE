...
tff(conj_thm_2Efinite__map_2EFUNION__FMERGE,conjecture,(
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2m: $i] :
             ...
             => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f2)))
               => ap(ap(ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V2m),V0f1),V1f2) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f1),V1f2) ) ) ) ) )).
