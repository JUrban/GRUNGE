...
tff(conj_thm_2Epair_2EUNCURRY__ONE__ONE__THM,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27c)))
     => ! [V1g: $i] :
...
tff(conj_thm_2Elbtree_2Elbtree__cases,lemma,(
    ! [A_27a: del,V0t: $i] :
...
tff(conj_thm_2Elbtree_2Elbtree__ue__Axiom,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eoption_2Eoption(ty_2Epair_2Eprod(A_27b,A_27b))))
     => p(ap(c_2Ebool_2E_3F_21(arr(A_27a,ty_2Elbtree_2Elbtree(A_27b))),f1961(A_27b,A_27a,A_27b,A_27a,V0f))) ) )).

tff(conj_thm_2Elbtree_2Elbtree__case__thm,lemma,(
...
tff(conj_thm_2Elbtree_2Elbtree__bisimulation,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( mem(V0t,ty_2Elbtree_2Elbtree(A_27a))
     => ! [V1u: $i] :
