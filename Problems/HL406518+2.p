...
fof(conj_thm_2Ebitstring_2Efixwidth__eq,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1v] :
          ( mem(V1v,ty_2Elist_2Elist(bool))
...
fof(conj_thm_2Ebitstring_2Ev2w__11,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0v] :
          ( mem(V0v,ty_2Elist_2Elist(bool))
...
fof(conj_thm_2Ebitstring_2Ew2w__v2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0v] :
              ( mem(V0v,ty_2Elist_2Elist(bool))
             => ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(c_2Ebitstring_2Ev2w(A_27a),V0v)) = ap(c_2Ebitstring_2Ev2w(A_27b),ap(ap(c_2Ebitstring_2Efixwidth,ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))),V0v)) ) ) ) )).
...
fof(conj_thm_2Ebitstring_2Eword__extract__v2w,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0h] :
             ...
             => ! [V1l] :
                 ...
                 => ! [V2v] :
                      ( mem(V2v,ty_2Elist_2Elist(bool))
                     => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),ap(c_2Ebitstring_2Ev2w(A_27a),V2v)) = ap(c_2Ewords_2Ew2w(A_27a,A_27a),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),V0h),V1l),ap(c_2Ebitstring_2Ev2w(A_27a),V2v))) ) ) ) ) ) )).

fof(conj_thm_2Ebitstring_2Eextract__v2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1l] :
                 ...
                 => ! [V2v] :
                     ...
                     => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,ap(c_2Elist_2ELENGTH(bool),V2v)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))))
                       ...
                       => ap(ap(ap(c_2Ewords_2Eword__extract(A_27a,A_27a),V0h),V1l),ap(c_2Ebitstring_2Ev2w(A_27a),V2v)) = ap(c_2Ebitstring_2Ev2w(A_27b),ap(ap(ap(c_2Ebitstring_2Efield,V0h),V1l),V2v)) ) ) ) ) ) ) )).
