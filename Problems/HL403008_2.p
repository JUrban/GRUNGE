...
tff(conj_thm_2EpatternMatches_2EPMATCH__EXPAND__PRED__THM__GEN,lemma,(
...
tff(conj_thm_2EpatternMatches_2EPMATCH__EXPAND__PRED__THM,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1v: $i] :
          ( mem(V1v,A_27b)
         => ! [V2rows: $i] :
             ...
             => ( p(ap(V0P,ap(ap(c_2EpatternMatches_2EPMATCH(A_27a,A_27a),V1v),V2rows)))
              <=> p(ap(ap(ap(ap(c_2EpatternMatches_2EPMATCH__EXPAND__PRED(A_27a,A_27a),V0P),V1v),c_2Elist_2ENIL(arr(A_27b,ty_2Eoption_2Eoption(A_27a)))),V2rows)) ) ) ) ) )).
