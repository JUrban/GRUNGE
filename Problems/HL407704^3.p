...
thf(thm_2Eordinal_2Eordle__EXISTS__ADD,axiom,(
    ...
    <=> ? [V2c: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( V1b
          = ( c_2Eordinal_2EordADD @ A_27a @ V0a @ V2c ) ) ) )).
...
thf(thm_2EordNotationSemantics_2Eadd__nat1__disappears,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ V1a @ ( c_2Eordinal_2Eomega @ A_27a ) ) )
     => ( ( c_2Eordinal_2EordADD @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ V0n ) @ V1a )
        = V1a ) ) )).
