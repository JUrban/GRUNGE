...
tff(conj_thm_2Epath_2Efirst__label__drop,lemma,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0i)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
       => ap(c_2Epath_2Efirst__label(A_27a,A_27a),ap(ap(c_2Epath_2Edrop(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),V1p)) = ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V0i)),V1p) ) ) )).

tff(conj_thm_2Epath_2Etail__drop,lemma,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1p: $i] :
      ( mem(V1p,ty_2Epath_2Epath(A_27a,A_27a))
...
tff(conj_thm_2Epath_2Erecursive__seg,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1j: tp__ty_2Enum_2Enum,V2p: $i] :
      ( mem(V2p,ty_2Epath_2Epath(A_27a,A_27a))
     => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j)))
       ...
       => ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),inj__ty_2Enum_2Enum(V1j)),V2p) = ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),ap(ap(c_2Epath_2Eel(A_27a,A_27a),inj__ty_2Enum_2Enum(V0i)),V2p)),ap(ap(c_2Epath_2Enth__label(A_27b,A_27b),inj__ty_2Enum_2Enum(V0i)),V2p)),ap(ap(ap(c_2Epath_2Eseg(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V0i)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1j)),V2p)) ) ) )).
