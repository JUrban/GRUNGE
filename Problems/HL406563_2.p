...
tff(lamtp_f2398,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => mem(f2398(V0R),arr(ty_2Enum_2Enum,bool)) ) )).

tff(lameq_f2398,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ! [V1n: tp__ty_2Enum_2Enum] : ap(f2398(V0R),inj__ty_2Enum_2Enum(V1n)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1n)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(V0R,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V1n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V1n))) ) )).

tff(lmtp_f2397,type,(
    f2397: $i )).

tff(lamtp_f2397,axiom,(
    mem(f2397,arr(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)),bool)) )).

tff(lameq_f2397,axiom,(
    ! [V0R: $i] :
      ( mem(V0R,arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool)))
     => ap(f2397,V0R) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Erelation_2EWF(ty_2Enum_2Enum),V0R)),ap(c_2Ebool_2E_21(ty_2Enum_2Enum),f2398(V0R))) ) )).

tff(lmtp_f2400,type,(
    f2400: $i > $i )).

tff(lamtp_f2400,axiom,(
    ! [V2lrnext: $i] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f2400(V2lrnext),arr(ty_2Enum_2Enum,ty_2Enum_2Enum)) ) )).

tff(lameq_f2400,axiom,(
    ! [V2lrnext: $i] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V3a: tp__ty_2Enum_2Enum] : ap(f2400(V2lrnext),inj__ty_2Enum_2Enum(V3a)) = ap(c_2Ecombin_2EI(ty_2Enum_2Enum),ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V3a)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(ap(c_2Earithmetic_2E_2A,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))),ap(V2lrnext,ap(ap(c_2Earithmetic_2EDIV,ap(ap(c_2Earithmetic_2E_2D,inj__ty_2Enum_2Enum(V3a)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))) ) )).

tff(lmtp_f2399,type,(
    f2399: $i )).

tff(lamtp_f2399,axiom,(
    mem(f2399,arr(arr(ty_2Enum_2Enum,ty_2Enum_2Enum),arr(ty_2Enum_2Enum,ty_2Enum_2Enum))) )).

tff(lameq_f2399,axiom,(
    ! [V2lrnext: $i] :
      ( mem(V2lrnext,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ap(f2399,V2lrnext) = f2400(V2lrnext) ) )).

tff(ax_thm_2Esptree_2Elrnext__primitive__def,axiom,(
    c_2Esptree_2Elrnext = ap(ap(c_2Erelation_2EWFREC(ty_2Enum_2Enum,ty_2Enum_2Enum),ap(c_2Emin_2E_40(arr(ty_2Enum_2Enum,arr(ty_2Enum_2Enum,bool))),f2397)),f2399) )).

tff(conj_thm_2Esptree_2Elrnext__thm,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0a: $i] :
          ( mem(V0a,A_27a)
