...
thf(thm_2Ereal__topology_2ECONVERGENT__BOUNDED__INCREASING,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ! [V2m: mono_2Etyop_2Enum_2Enum,V3n: mono_2Etyop_2Enum_2Enum] :
            ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V2m @ V3n )
           => ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0s @ V2m ) @ ( V0s @ V3n ) ) )
        & ! [V4n: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Ereal_2Ereal__lte @ ( mono_2Ec_2Ereal_2Eabs @ ( V0s @ V4n ) ) @ V1b ) )
     => ? [V5l: mono_2Etyop_2Erealax_2Ereal] :
        ! [V6e: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ V6e )
         => ? [V7N: mono_2Etyop_2Enum_2Enum] :
            ! [V8n: mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V7N @ V8n )
             => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Eabs @ ( mono_2Ec_2Ereal_2Ereal__sub @ ( V0s @ V8n ) @ V5l ) ) @ V6e ) ) ) ) )).
