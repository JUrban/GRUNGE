...
fof(conj_thm_2Earithmetic_2EEXP__BASE__LE__MONO,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Ebit_2EBIT__B__NEQ,lemma,(
    ! [V0a] :
...
fof(conj_thm_2Ebit_2EBIT__OF__BITS__THM,lemma,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1h] :
...
fof(mem_c_2Ewords_2Es2w,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Es2w(A_27a),arr(ty_2Enum_2Enum,arr(arr(ty_2Estring_2Echar,ty_2Enum_2Enum),arr(ty_2Elist_2Elist(ty_2Estring_2Echar),ty_2Efcp_2Ecart(bool,bool))))) ) )).
...
fof(mem_c_2Ewords_2Ew2s,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Ew2s(A_27a),arr(ty_2Enum_2Enum,arr(arr(ty_2Enum_2Enum,ty_2Estring_2Echar),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Elist_2Elist(ty_2Estring_2Echar))))) ) )).
...
fof(conj_thm_2Ewords_2Es2w__w2s,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c2n] :
          ( mem(V0c2n,arr(ty_2Estring_2Echar,ty_2Enum_2Enum))
