...
thf(conj_thm_2Erich__list_2EZIP__TAKE__LEQ,lemma,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
     ...
     => ! [V2b: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1a ) ) )
           ...
           => ( ( ap @ ( c_2Elist_2EZIP @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V2b ) ) )
              = ( ap @ ( ap @ ( c_2Elist_2ETAKE @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2EZIP @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ V1a ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27b ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1a ) ) @ V2b ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EZIP__TAKE,conjecture,(
    ! [A_27a: del,A_27b: del,V0n: tp__ty_2Enum_2Enum,V1a: $i] :
      ( ( mem @ V1a @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V2b: $i] :
          ( ( mem @ V2b @ ( ty_2Elist_2Elist @ A_27b ) )
         => ( ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1a ) ) )
              & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1a ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27b ) @ V2b ) ) ) )
           => ( ( ap @ ( c_2Elist_2EZIP @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V2b ) ) )
              = ( ap @ ( ap @ ( c_2Elist_2ETAKE @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2EZIP @ A_27a @ A_27b ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27b ) ) @ V1a ) @ V2b ) ) ) ) ) ) ) )).
