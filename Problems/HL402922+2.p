...
fof(conj_thm_2Elist_2ELAST__REVERSE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
...
fof(conj_thm_2Elist_2EMEM__dropWhile__IMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Elist_2EHD__dropWhile,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Enumposrep_2ELOG__l2n,lemma,(
    ! [V0b] :
...
fof(conj_thm_2Enumposrep_2El2n__dropWhile__0,lemma,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1ls] :
...
fof(lamtp_f820,axiom,(
    mem(f820,arr(ty_2Enum_2Enum,bool)) )).

fof(lameq_f820,axiom,(
    ! [V2y] :
      ( mem(V2y,ty_2Enum_2Enum)
     => ap(f820,V2y) = ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),c_2Enum_2E0),V2y)) ) )).

fof(conj_thm_2Enumposrep_2ELOG__l2n__dropWhile,conjecture,(
    ! [V0b] :
      ( mem(V0b,ty_2Enum_2Enum)
     => ! [V1l] :
          ( mem(V1l,ty_2Elist_2Elist(ty_2Enum_2Enum))
         => ( ( p(ap(ap(c_2Eprim__rec_2E_3C,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0b))
              & p(ap(ap(c_2Elist_2EEXISTS(ty_2Enum_2Enum),f820),V1l))
              & p(ap(ap(c_2Elist_2EEVERY(ty_2Enum_2Enum),ap(c_2Earithmetic_2E_3E,V0b)),V1l)) )
