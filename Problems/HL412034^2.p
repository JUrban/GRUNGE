...
thf(conj_thm_2Eextreal_2Emul__not__infty,lemma,
...
thf(conj_thm_2Elebesgue_2Epos__fn__integral__cmul,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
         => ! [V2c: tp__ty_2Erealax_2Ereal] :
             ...
             => ( ( surj__ty_2Eextreal_2Eextreal
                  @ ( ap @ ( ap @ ( c_2Elebesgue_2Epos__fn__integral @ A_27a ) @ V0m )
                    @ ( lam @ A_27a
                      @ ^ [V4x: $i] :
                          ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V2c ) ) ) @ ( ap @ V1f @ V4x ) ) ) ) )
...
thf(conj_thm_2Elebesgue_2Eintegrable__zero,lemma,(
...
thf(conj_thm_2Emeasure_2EFN__PLUS__CMUL,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) )
           => ( ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ V0f @ V2x ) ) ) )
              = ( lam @ A_27a
                @ ^ [V3x: $i] :
                    ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a ) @ V0f ) @ V3x ) ) ) ) )
          & ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
           => ( ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V4x: $i] :
                      ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ V0f @ V4x ) ) ) )
              = ( lam @ A_27a
                @ ^ [V5x: $i] :
                    ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2Eextreal__ainv @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a ) @ V0f ) @ V5x ) ) ) ) ) ) ) )).

thf(conj_thm_2Emeasure_2EFN__MINUS__CMUL,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) )
           => ( ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V2x: $i] :
                      ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ V0f @ V2x ) ) ) )
              = ( lam @ A_27a
                @ ^ [V3x: $i] :
                    ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a ) @ V0f ) @ V3x ) ) ) ) )
          & ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
           => ( ( ap @ ( c_2Emeasure_2Efn__minus @ A_27a )
                @ ( lam @ A_27a
                  @ ^ [V4x: $i] :
              ...
              = ( lam @ A_27a
                @ ^ [V5x: $i] :
                    ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ c_2Eextreal_2Eextreal__ainv @ ( ap @ c_2Eextreal_2ENormal @ ( inj__ty_2Erealax_2Ereal @ V1c ) ) ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Efn__plus @ A_27a ) @ V0f ) @ V5x ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elebesgue_2Eintegrable__cmul,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
