...
thf(conj_thm_2Ecardinal_2ECOUNTABLE__IMAGE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EDIFF__BIGINTER,lemma,(
    ! [A_27a: del,V0u: $i] :
         ...
         => ( ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V0u ) @ ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27a ) @ V1s ) )
            = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
              @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                @ ( lam @ ( arr @ A_27a @ bool )
                  @ ^ [V2t: $i] :
                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ V0u ) @ V2t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2t ) @ V1s ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2EBIGUNION__MONO__IMAGE,lemma,(
...
thf(conj_thm_2Ereal__topology_2EINTER__BIGUNION,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0s: $i] :
          ( ( mem @ V0s @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
         => ! [V1t: $i] :
              ( ( mem @ V1t @ ( arr @ A_27a @ bool ) )
             => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a ) @ V0s ) ) @ V1t )
                = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                    @ ( lam @ ( arr @ A_27a @ bool )
                      @ ^ [V2x: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V2x ) @ V1t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V2x ) @ V0s ) ) ) ) ) ) ) )
      & ! [V3s: $i] :
          ( ( mem @ V3s @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) )
         => ! [V4t: $i] :
              ( ( mem @ V4t @ ( arr @ A_27b @ bool ) )
             => ( ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27b ) @ V4t ) @ ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27b ) @ V3s ) )
                = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27b )
                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27b @ bool ) @ ( arr @ A_27b @ bool ) )
                    @ ( lam @ ( arr @ A_27b @ bool )
                      @ ^ [V5x: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27b ) @ V4t ) @ V5x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27b @ bool ) ) @ V5x ) @ V3s ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EBAIRE,lemma,(
    ! [V0g: $i] :
...
thf(conj_thm_2Ereal__topology_2EBAIRE__ALT,conjecture,(
    ! [V0g: $i] :
      ( ( mem @ V0g @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
         => ( ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elocally @ c_2Ereal__topology_2Ecompact ) @ V1s ) )
              & ( V1s
               != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) )
              & ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0g ) )
              & ( ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V0g )
                = V1s ) )
           => ? [V2t: $i] :
                ( ( mem @ V2t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                & ? [V3u: $i] :
