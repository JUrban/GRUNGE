...
thf(conj_thm_2Epred__set_2EFINITELY__INJECTIVE__IMAGE__FINITE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
           ...
           => ( p
              @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a )
                @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                  @ ( lam @ A_27a
                    @ ^ [V2y: $i] :
                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V2y ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ V1x ) @ ( ap @ V0f @ V2y ) ) ) ) ) ) ) )
       => ! [V3s: $i] :
...
thf(conj_thm_2Epred__set_2EINJECTIVE__IMAGE__FINITE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ A_27b ) )
     => ( ! [V1x: $i] :
            ( ( mem @ V1x @ A_27a )
