...
fof(conj_thm_2Ereal_2EABS__SUB__ABS,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__RANGE,lemma,(
    ! [V0f] :
                       ...
                       => ? [V4d] :
                            ...
                            & ! [V5x_27] :
                               ...
                               => ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x_27),V1s))
                                    & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,V5x_27),V2x))),V4d)) )
                                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V5x_27)),ap(V0f,V2x)))),V3e)) ) ) ) ) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__SUP,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
           ...
           => ? [V2x] :
                ...
                & ! [V3y] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V1s))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V0f,V3y)),ap(V0f,V2x))) ) ) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EDISTANCE__ATTAINS__SUP,conjecture,(
    ! [V0s] :
           ...
           => ? [V2x] :
                ...
                & ! [V3y] :
                   ...
                   => ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V3y),V0s))
                     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V3y))),ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1a),V2x)))) ) ) ) ) ) ) )).
