...
fof(mem_c_2EfixedPoint_2Eempty,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2EfixedPoint_2Eempty(A_27a,A_27a),arr(A_27a,arr(A_27b,bool))) ) ) )).
...
fof(ax_thm_2EfixedPoint_2Eempty__def,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => c_2EfixedPoint_2Eempty(A_27a,A_27a) = k(A_27a,c_2Epred__set_2EEMPTY(A_27b)) ) ) )).

fof(conj_thm_2EfixedPoint_2Efnsum__empty,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
