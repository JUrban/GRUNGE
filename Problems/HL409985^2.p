...
thf(conj_thm_2Eextreal_2Ele__radd__imp,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] :
      ( ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V2z ) ) )
...
thf(conj_thm_2Eextreal_2Ele__ladd__imp,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] :
      ( ( p @ ( ap @ ( ap @ c_2Eextreal_2Eextreal__le @ ( inj__ty_2Eextreal_2Eextreal @ V1y ) ) @ ( inj__ty_2Eextreal_2Eextreal @ V2z ) ) )
...
thf(conj_thm_2Eextreal_2Eadd__not__infty,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal] :
      ( ( ( ( V0x != fo__c_2Eextreal_2ENegInf )
...
thf(conj_thm_2Eextreal_2Ele__sub__eq2,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__NOT__INFTY,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__MONO__SET,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ A_27a @ ty_2Eextreal_2Eextreal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eextreal_2Ele__sup,lemma,(
    ! [V0p: $i] :
      ( ( mem @ V0p @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
     => ! [V1x: tp__ty_2Eextreal_2Eextreal] :
...
thf(conj_thm_2Eextreal_2Esup__lt,lemma,(
    ! [V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ty_2Eextreal_2Eextreal @ bool ) )
          ...
          @ ( ap @ c_2Eextreal_2Eextreal__sup
            @ ( ap
              @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal )
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V1n: $i] :
                      ( ap @ ( ap @ ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ ty_2Enum_2Enum ) @ V0f ) @ ( ap @ c_2Epred__set_2Ecount @ V1n ) ) ) )
...
thf(conj_thm_2Eextreal_2Eext__suminf__add,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Eextreal_2Eextreal ) )
     => ! [V1g: $i] :
         ...
         => ( ! [V2n: tp__ty_2Enum_2Enum] :
           ...
           => ( ( surj__ty_2Eextreal_2Eextreal
                @ ( ap @ c_2Eextreal_2Eext__suminf
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3n: $i] :
                        ( ap @ ( ap @ c_2Eextreal_2Eextreal__add @ ( ap @ V0f @ V3n ) ) @ ( ap @ V1g @ V3n ) ) ) ) )
