...
tff(conj_thm_2Ereal__topology_2EINDEPENDENT__BOUND,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2EMAXIMAL__INDEPENDENT__SUBSET,lemma,(
    ! [V0v: $i] :
...
tff(conj_thm_2Ereal__topology_2EBASIS__EXISTS,conjecture,(
    ! [V0v: $i] :
      ( mem(V0v,arr(ty_2Erealax_2Ereal,bool))
     => ? [V1b: $i] :
          ( mem(V1b,arr(ty_2Erealax_2Ereal,bool))
