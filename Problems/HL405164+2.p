...
fof(conj_thm_2Econtainer_2EBAG__TO__LIST__INV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
...
fof(conj_thm_2Econtainer_2ECARD__LIST__TO__BAG,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ls] :
...
fof(conj_thm_2Econtainer_2EBAG__TO__LIST__CARD,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0b] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
