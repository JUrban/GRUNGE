...
fof(conj_thm_2Ereal__topology_2ECOMPACT__SPHERE,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
         => p(ap(c_2Ereal__topology_2Ecompact,ap(c_2Ereal__topology_2Esphere,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1r)))) ) ) )).

fof(conj_thm_2Ereal__topology_2EBOUNDED__SPHERE,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Erealax_2Ereal)
     => ! [V1r] :
          ( mem(V1r,ty_2Erealax_2Ereal)
         => p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Ereal__topology_2Esphere,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),V1r)))) ) ) )).
