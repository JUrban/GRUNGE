...
fof(mem_c_2Erelation_2ESN,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(mem_c_2Erelation_2EWCR,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
...
fof(conj_thm_2Erelation_2Einv__MOVES__OUT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(ax_thm_2Erelation_2EWCR__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(ax_thm_2Erelation_2ESN__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
...
fof(conj_thm_2Erelation_2ENewmans__lemma,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0R] :
          ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
