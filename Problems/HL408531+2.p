...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTowardPositive__plus__infinity,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Efloat__round__roundTowardPositive__plus__infinity,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0b] :
             ...
             => ! [V1y] :
                 ...
                 => ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ebinary__ieee_2Elargest(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))),V2x))
                       => ap(ap(ap(c_2Ebinary__ieee_2Efloat__round(A_27t,A_27t),c_2Ebinary__ieee_2EroundTowardPositive),V0b),V2x) = ap(c_2Ebinary__ieee_2Efloat__plus__infinity(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))) ) ) ) ) ) ) )).
