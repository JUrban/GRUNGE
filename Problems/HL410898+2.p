...
fof(conj_thm_2Ereal__topology_2EWLOG__LT,lemma,(
    ! [V0P] :
...
fof(conj_thm_2Ereal__topology_2ETRANSITIVE__STEPWISE__LT,lemma,(
    ! [V0R] :
...
fof(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL__INJ,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
