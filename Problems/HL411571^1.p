...
thf(f12987_0_2E0,type,(
    f12987_0_2E0: u )).

thf(f12987_0_2E3,type,(
    f12987_0_2E3: du > du > du > u )).

thf(f12987_0_2E4,type,(
    f12987_0_2E4: du > du > du > du > u )).

thf(f12987_1_2E0,type,(
    f12987_1_2E0: u )).

thf(f12987_1_2E3,type,(
    f12987_1_2E3: du > du > du > u )).

thf(f12987_1_2E4,type,(
    f12987_1_2E4: du > du > du > du > u )).

thf(f12987_2_2E0,type,(
    f12987_2_2E0: u )).

thf(f12987_2_2E3,type,(
    f12987_2_2E3: du > du > du > u )).

thf(f12987_3_2E0,type,(
    f12987_3_2E0: u )).

thf(f12987_3_2E3,type,(
...
thf(mono_2Ef12987_0,type,(
    mono_2Ef12987_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef12987_1,type,(
    mono_2Ef12987_1: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef12987_2,type,(
    mono_2Ef12987_2: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).

thf(mono_2Ef12987_3,type,(
    mono_2Ef12987_3: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12987_3 @ V0a @ V3x @ V1b )
    <=> ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V0a @ V3x )
          & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V1b ) )
        | ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1b @ V3x )
          & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V0a ) ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,axiom,(
    ! [V2v: mono_2Etyop_2Erealax_2Ereal,V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12987_0 @ V2v @ V0a @ V1b @ V3x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Erealax_2Ereal__mul @ V3x @ V2v ) @ ( mono_2Ef12987_3 @ V0a @ V3x @ V1b ) ) ) )).

thf(def2_2Ethm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,axiom,(
    ! [V4a: mono_2Etyop_2Erealax_2Ereal,V7x: mono_2Etyop_2Erealax_2Ereal,V5b: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12987_2 @ V4a @ V7x @ V5b )
    <=> ( ( ( mono_2Ec_2Erealax_2Ereal__lt @ V4a @ V7x )
          & ( mono_2Ec_2Erealax_2Ereal__lt @ V7x @ V5b ) )
        | ( ( mono_2Ec_2Erealax_2Ereal__lt @ V5b @ V7x )
          & ( mono_2Ec_2Erealax_2Ereal__lt @ V7x @ V4a ) ) ) ) )).

thf(def3_2Ethm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,axiom,(
    ! [V6v: mono_2Etyop_2Erealax_2Ereal,V4a: mono_2Etyop_2Erealax_2Ereal,V5b: mono_2Etyop_2Erealax_2Ereal,V7x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef12987_1 @ V6v @ V4a @ V5b @ V7x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Erealax_2Ereal__mul @ V7x @ V6v ) @ ( mono_2Ef12987_2 @ V4a @ V7x @ V5b ) ) ) )).

thf(thm_2Ereal__topology_2ESEGMENT__SCALAR__MULTIPLE,conjecture,
    ( ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2v: mono_2Etyop_2Erealax_2Ereal] :
        ( ( mono_2Ec_2Ereal__topology_2Eclosed__segment @ ( mono_2Ec_2Elist_2ECONS_2Emono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__mul @ V0a @ V2v ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V1b @ V2v ) ) @ mono_2Ec_2Elist_2ENIL_2Emono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Erealax_2Ereal_29 ) )
        = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12987_0 @ V2v @ V0a @ V1b ) ) )
    & ! [V4a: mono_2Etyop_2Erealax_2Ereal,V5b: mono_2Etyop_2Erealax_2Ereal,V6v: mono_2Etyop_2Erealax_2Ereal] :
        ( ( (~)
          @ ( V6v
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
       => ( ( mono_2Ec_2Ereal__topology_2Eopen__segment @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__mul @ V4a @ V6v ) @ ( mono_2Ec_2Erealax_2Ereal__mul @ V5b @ V6v ) ) )
          = ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef12987_1 @ V6v @ V4a @ V5b ) ) ) ) )).
