...
fof(conj_thm_2Eprobability_2Ejoint__distribution__sym,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2Ejoint__distribution__le,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eprobability_2Ejoint__conditional,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V2Y] :
                         ...
                         => ! [V3a] :
                             ...
                             => ! [V4b] :
                                 ...
                                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                                      & ap(c_2Eprobability_2Eevents(A_27a),V0p) = ap(c_2Epred__set_2EPOW(A_27a),ap(c_2Eprobability_2Ep__space(A_27a),V0p)) )
                                   => ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),V3a),V4b)) = ap(ap(c_2Erealax_2Ereal__mul,ap(ap(ap(ap(ap(c_2Eprobability_2Econditional__distribution(A_27a,A_27a,A_27a),V0p),V2Y),V1X),V4b),V3a)),ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V0p),V1X),V3a)) ) ) ) ) ) ) ) ) ) )).
