...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__INVERSE__CLOSED__MAP,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EHOMEOMORPHISM__INJECTIVE__CLOSED__MAP,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
