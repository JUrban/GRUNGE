...
tff(conj_thm_2Eieee_2Eroundmode__Axiom,conjecture,(
    ! [A_27a: del,V0x0: $i] :
      ( mem(V0x0,A_27a)
     => ! [V1x1: $i] :
          ( mem(V1x1,A_27a)
         => ! [V2x2: $i] :
             ...
             => ! [V3x3: $i] :
                 ...
                 => ? [V4f: $i] :
                      ...
                      & ap(V4f,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__nearest)) = V0x0
                      & ap(V4f,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2Efloat__To__zero)) = V1x1
                      & ap(V4f,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__pinfinity)) = V2x2
                      & ap(V4f,inj__ty_2Eieee_2Eroundmode(fo__c_2Eieee_2ETo__ninfinity)) = V3x3 ) ) ) ) ) )).
