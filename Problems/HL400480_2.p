...
tff(tp_c_2Erelation_2Ediag,type,(
    c_2Erelation_2Ediag: del > $i )).

tff(mem_c_2Erelation_2Ediag,axiom,(
    ! [A_27a: del] : mem(c_2Erelation_2Ediag(A_27a),arr(arr(A_27a,bool),arr(A_27a,arr(A_27a,bool)))) )).
...
tff(ax_thm_2Erelation_2Ediag__def,axiom,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1x: $i] :
         ...
         => ! [V2y: $i] :
              ( mem(V2y,A_27a)
             => ( p(ap(ap(ap(c_2Erelation_2Ediag(A_27a),V0A),V1x),V2y))
              <=> ( V1x = V2y
                  & p(ap(ap(c_2Ebool_2EIN(A_27a),V1x),V0A)) ) ) ) ) ) )).

tff(conj_thm_2Erelation_2Einv__diag,conjecture,(
    ! [A_27a: del,V0A: $i] :
      ( mem(V0A,arr(A_27a,bool))
     => ap(c_2Erelation_2Einv(A_27a,A_27a),ap(c_2Erelation_2Ediag(A_27a),V0A)) = ap(c_2Erelation_2Ediag(A_27a),V0A) ) )).
