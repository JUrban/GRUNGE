...
thf(conj_thm_2Eutil__prob_2EPREIMAGE__REAL__COMPL4,conjecture,(
      ...
      ( ( ap @ ( c_2Epred__set_2ECOMPL @ ty_2Erealax_2Ereal )
        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
          @ ( lam @ ty_2Erealax_2Ereal
            @ ^ [V1x: $i] :
                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V1x ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ V1x ) @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) ) ) ) )
      = ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
        @ ( lam @ ty_2Erealax_2Ereal
          @ ^ [V2x: $i] :
              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V2x ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V0c ) ) @ V2x ) ) ) ) ) )).
