...
thf(f3662_0_2E0,type,(
    f3662_0_2E0: u )).

thf(f3662_0_2E1,type,(
    f3662_0_2E1: du > u )).
...
thf(mono_2Ef3662_0,type,(
    mono_2Ef3662_0: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EEVENTUAL__AS__WHEN,axiom,(
    ! [V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3662_0 @ V2t )
      = mono_2Ec_2Ebool_2EF ) )).
...
thf(thm_2ETemporal__Logic_2EEVENTUAL__AS__WHEN,conjecture,(
    ...
    <=> ( (~) @ ( mono_2Ec_2ETemporal__Logic_2EWHEN @ mono_2Ef3662_0 @ V0a @ V1x ) ) ) )).
