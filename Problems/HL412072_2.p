...
tff(conj_thm_2Eprobability_2EINCREASING__PROB,lemma,(
    ! [A_27a: del,V0p: $i] :
...
tff(conj_thm_2Eprobability_2EPROB__SPACE__INCREASING,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
       => p(ap(c_2Emeasure_2Eincreasing(A_27a),V0p)) ) ) )).

tff(conj_thm_2Eprobability_2EPROB__INCREASING,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
