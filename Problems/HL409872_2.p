...
tff(conj_thm_2Eiterate_2EREAL__OF__NUM__SUM,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
...
tff(lamtp_f3393,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => mem(f3393(V0f),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3393,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V3i: tp__ty_2Enum_2Enum] : ap(f3393(V0f),inj__ty_2Enum_2Enum(V3i)) = ap(c_2Ereal_2Ereal__of__num,ap(V0f,inj__ty_2Enum_2Enum(V3i))) ) )).

tff(conj_thm_2Eiterate_2EREAL__OF__NUM__SUM__NUMSEG,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
