                              ...
                              @ ^ [V8h: $i] :
                                  ...
                                  @ ^ [V9t: $i] :
                                      ...
                                      @ ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27state @ ty_2Eone_2Eone @ ty_2Eone_2Eone ) @ ( ap @ V7a @ V8h ) )
                                        @ ( lam @ ty_2Eone_2Eone
                                          @ ^ [V10u: $i] :
                                              ( ap @ V4FOREACH @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( arr @ A_27a @ ( arr @ A_27state @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ ty_2Eone_2Eone @ A_27state ) ) ) ) ) @ V9t ) @ V7a ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2EerrorStateMonad_2EFOREACH__def,conjecture,(
    ! [A_27a: del,A_27state: del] :
      ( ! [V0a: $i] :
             ...
             => ! [V3a: $i] :
                 ...
                 => ( ( ap @ ( c_2EerrorStateMonad_2EFOREACH @ A_27a @ A_27state ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( arr @ A_27a @ ( arr @ A_27state @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ ty_2Eone_2Eone @ A_27state ) ) ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2h ) @ V1t ) ) @ V3a ) )
                    = ( ap @ ( ap @ ( c_2EerrorStateMonad_2EBIND @ A_27state @ ty_2Eone_2Eone @ ty_2Eone_2Eone ) @ ( ap @ V3a @ V2h ) )
                      @ ( lam @ ty_2Eone_2Eone
                        @ ^ [V4u: $i] :
                            ( ap @ ( c_2EerrorStateMonad_2EFOREACH @ A_27a @ A_27state ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ ( arr @ A_27a @ ( arr @ A_27state @ ( ty_2Eoption_2Eoption @ ( ty_2Epair_2Eprod @ ty_2Eone_2Eone @ A_27state ) ) ) ) ) @ V1t ) @ V3a ) ) ) ) ) ) ) ) ) )).
