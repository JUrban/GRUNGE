...
thf(f4110_0_2E0,type,(
    f4110_0_2E0: u )).

thf(f4110_0_2E1,type,(
    f4110_0_2E1: du > u )).

thf(f4110_1_2E0,type,(
    f4110_1_2E0: u )).

thf(f4110_1_2E2,type,(
    f4110_1_2E2: du > du > u )).

thf(f4110_1_2E3,type,(
    f4110_1_2E3: du > du > du > u )).

thf(f4110_2_2E0,type,(
    f4110_2_2E0: u )).

thf(f4110_2_2E1,type,(
    f4110_2_2E1: du > u )).
...
thf(mono_2Ef4110_2,type,(
    mono_2Ef4110_2: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(arityeq1_2Emono_2Ef4110_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4110_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f4110_0_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X0 ) ) ) ) ) )).

thf(arityeq2_2Emono_2Ef4110_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( f4110_1_2E2 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X1_2E0 ) ) )
...
thf(arityeq3_2Emono_2Ef4110_1_2E3_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u,X2: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4110_1_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X2 ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) ) ) @ f4110_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ X1_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X2 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Ellist_2Elrep__ok__rules,axiom,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4110_0_2E1 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ c_2Eoption_2ENONE_2E0 ) ) )).

thf(def1_2Ethm_2Ellist_2Elrep__ok__rules,axiom,(
    ! [V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef4110_2 @ V3n )
    <=> ( V3n = mono_2Ec_2Enum_2E0 ) ) )).

thf(def2_2Ethm_2Ellist_2Elrep__ok__rules,axiom,(
    ! [A_27a: d,V1h_2E0: u,V2t_2E0: u,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( f4110_1_2E3 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef4110_2 @ V3n ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V1h_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2t_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V3n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2Ellist_2Elrep__ok__rules,conjecture,(
    ! [A_27a: d] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ f4110_0_2E0 ) ) ) )
      & ! [V1h_2E0: u,V2t_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2t_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ellist_2Elrep__ok_2E1 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ ( f4110_1_2E2 @ ( s @ A_27a @ V1h_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Eoption_2Eoption @ A_27a ) ) @ V2t_2E0 ) ) ) ) ) ) ) ) )).
