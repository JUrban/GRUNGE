...
fof(conj_thm_2Ealist_2EALOOKUP__ZIP__MAP__SND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                         ...
                         => ! [V2k] :
                             ...
                             => ! [V3f] :
                                 ...
                                 => ( ap(c_2Elist_2ELENGTH(A_27a),V0l1) = ap(c_2Elist_2ELENGTH(A_27b),V1l2)
                                   => ap(c_2Ealist_2EALOOKUP(A_27d,A_27d),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),ap(ap(c_2Elist_2EMAP(A_27b,A_27b),V3f),V1l2)))) = ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),ap(c_2Eoption_2EOPTION__MAP(A_27b,A_27b),V3f)),ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(c_2Elist_2EZIP(A_27a,A_27a),ap(ap(c_2Epair_2E_2C(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0l1),V1l2)))) ) ) ) ) ) ) ) ) ) )).
