...
tff(conj_thm_2Efinite__map_2EFDOM__FOLDR__DOMSUB,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(A_27a))
     => ! [V1fm: $i] :
          ( mem(V1fm,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),f1932(A_27b,A_27a,A_27a)),V1fm),V0ls)) = ap(ap(c_2Epred__set_2EDIFF(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1fm)),ap(c_2Elist_2ELIST__TO__SET(A_27a),V0ls)) ) ) )).
