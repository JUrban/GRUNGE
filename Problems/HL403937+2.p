...
fof(conj_thm_2Ellist_2ELTAKE__EQ__NONE__LNTH,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
...
fof(conj_thm_2Ellist_2ELTAKE__LLENGTH__NONE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0ll] :
          ( mem(V0ll,ty_2Ellist_2Ellist(A_27a))
...
fof(conj_thm_2Ellist_2ELNTH__LLENGTH__NONE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
