...
fof(conj_thm_2Efinite__map_2EFUPD11__SAME__NEW__KEY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1f2] :
                 ...
                 => ! [V2k] :
                     ...
                     => ! [V3v1] :
                         ...
                         => ! [V4v2] :
                              ( mem(V4v2,A_27b)
                             => ( ( ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V2k),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f1)))
                                  & ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V2k),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1f2))) )
