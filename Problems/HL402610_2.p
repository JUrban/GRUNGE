...
tff(lamtp_f777,axiom,(
    ! [A_27a: del,A_27a: del,V1l_27: $i] :
      ( mem(V1l_27,ty_2Elist_2Elist(A_27a))
     => mem(f777(A_27a,A_27a,V1l_27),arr(A_27a,ty_2Elist_2Elist(A_27a))) ) )).
...
tff(lameq_f777,axiom,(
    ! [A_27a: del,A_27a: del,V1l_27: $i] :
     ...
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f777(A_27a,A_27a,V1l_27),V2x) = ap(ap(c_2Elist_2ECONS(A_27a),V2x),V1l_27) ) ) )).

tff(lmtp_f776,type,(
    f776: ( del * del ) > $i )).

tff(lamtp_f776,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f776(A_27a,A_27a),arr(ty_2Elist_2Elist(A_27a),arr(A_27a,ty_2Elist_2Elist(A_27a)))) )).

tff(lameq_f776,axiom,(
    ! [A_27a: del,A_27a: del,V1l_27: $i] :
      ( mem(V1l_27,ty_2Elist_2Elist(A_27a))
     => ap(f776(A_27a,A_27a),V1l_27) = f777(A_27a,A_27a,V1l_27) ) )).

tff(conj_thm_2Erich__list_2EREVERSE__FOLDL,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ap(c_2Elist_2EREVERSE(A_27a),V0l) = ap(ap(ap(c_2Elist_2EFOLDL(A_27a,A_27a),f776(A_27a,A_27a)),c_2Elist_2ENIL(A_27a)),V0l) ) )).
