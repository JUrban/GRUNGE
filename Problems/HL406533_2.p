...
tff(mem_c_2Ewords_2Eword__asr__bv,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__asr__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(conj_thm_2Ewords_2Eword__lo__n2w,lemma,(
...
tff(lmtp_f2326,type,(
    f2326: ( del * $i * $i * tp__ty_2Enum_2Enum * tp__o ) > $i )).

tff(lamtp_f2326,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum,V3a: tp__o] : mem(f2326(A_27a,V1m,V0w,V2k,V3a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2326,axiom,(
    ! [A_27a: del,V1m: $i] :
     ...
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum,V3a: tp__o,V4j: tp__ty_2Enum_2Enum] : ap(f2326(A_27a,V1m,V0w,V2k,V3a),inj__ty_2Enum_2Enum(V4j)) = ap(ap(c_2Ebool_2E_5C_2F,inj__o(V3a)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(ap(ap(c_2Ewords_2Eword__bits(A_27a),ap(c_2Ebit_2ELOG2,ap(ap(c_2Earithmetic_2E_2D,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),V1m)),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V4j)))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),ap(ap(c_2Ewords_2Eword__asr(A_27a),V0w),inj__ty_2Enum_2Enum(V4j))),inj__ty_2Enum_2Enum(V2k)))) ) ) )).

tff(lmtp_f2325,type,(
    f2325: ( del * $i * $i * tp__ty_2Enum_2Enum ) > $i )).

tff(lamtp_f2325,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum] : mem(f2325(A_27a,V1m,V0w,V2k),arr(bool,arr(ty_2Enum_2Enum,bool))) ) ) )).
...
tff(lameq_f2325,axiom,(
    ! [A_27a: del,V1m: $i] :
     ...
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum,V3a: tp__o] : ap(f2325(A_27a,V1m,V0w,V2k),inj__o(V3a)) = f2326(A_27a,V1m,V0w,V2k,V3a) ) ) )).

tff(lmtp_f2324,type,(
    f2324: ( del * $i * $i ) > $i )).

tff(lamtp_f2324,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2324(A_27a,V1m,V0w),arr(ty_2Enum_2Enum,bool)) ) ) )).
