...
thf(conj_thm_2Erich__list_2ETAKE,lemma,(
    ! [A_27a: del] :
      ( ! [V0l: $i] :
      ...
      & ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
         ...
         => ! [V3l: $i] :
              ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V3l ) )
                = ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V3l ) ) ) ) ) ) )).
...
thf(conj_thm_2Erich__list_2ETAKE__SEG,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Elist_2ETAKE @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l )
          = ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V1l ) ) ) ) )).

thf(conj_thm_2Erich__list_2ESEG__TAKE__DROP,conjecture,(
