...
thf(thm_2Ereal__topology_2Ecompact,axiom,(
    ...
    <=> ! [V1f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
         ...
         => ? [V3l: mono_2Etyop_2Erealax_2Ereal,V4r: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
              ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3l @ V0s )
              & ! [V5m: mono_2Etyop_2Enum_2Enum,V6n: mono_2Etyop_2Enum_2Enum] :
                  ( ( mono_2Ec_2Eprim__rec_2E_3C @ V5m @ V6n )
                 => ( mono_2Ec_2Eprim__rec_2E_3C @ ( V4r @ V5m ) @ ( V4r @ V6n ) ) )
              & ( mono_2Ec_2Ereal__topology_2E_2D_2D_3E_2Emono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Ecombin_2Eo_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Enum_2Enum @ V1f @ V4r ) @ V3l @ mono_2Ec_2Ereal__topology_2Esequentially ) ) ) ) )).

thf(thm_2Ereal__topology_2EMONOTONE__BIGGER,axiom,(
    ! [V0r: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum] :
      ( ! [V1m: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1m @ V2n )
         => ( mono_2Ec_2Eprim__rec_2E_3C @ ( V0r @ V1m ) @ ( V0r @ V2n ) ) )
     => ! [V3n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Earithmetic_2E_3C_3D @ V3n @ ( V0r @ V3n ) ) ) )).
...
thf(thm_2Ereal__topology_2EBOUNDED__CLOSED__NEST,conjecture,(
    ! [V0s: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( ! [V1n: mono_2Etyop_2Enum_2Enum] :
        ...
        & ( mono_2Ec_2Ereal__topology_2Ebounded__def @ ( V0s @ mono_2Ec_2Enum_2E0 ) ) )
     => ? [V5a: mono_2Etyop_2Erealax_2Ereal] :
        ! [V6n: mono_2Etyop_2Enum_2Enum] :
          ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V5a @ ( V0s @ V6n ) ) ) )).
