...
tff(conj_thm_2Ebft_2EBFT__CONS,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1f: $i] :
...
tff(conj_thm_2Ebft_2EBFT__FOLD,conjecture,(
    ! [A_27a: del,A_27b: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(A_27b,A_27b)))
         => ! [V2seen: $i] :
             ...
             => ! [V3fringe: $i] :
                 ...
                 => ! [V4acc: $i] :
                      ( mem(V4acc,A_27b)
                     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2EdirGraph_2EParents(A_27a,A_27a),V0G)))
                       => ap(ap(ap(ap(ap(c_2Ebft_2EBFT(A_27b,A_27b),V0G),V1f),V2seen),V3fringe),V4acc) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),V1f),V4acc),ap(ap(ap(ap(ap(c_2Ebft_2EBFT(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),V0G),c_2Elist_2ECONS(A_27a)),V2seen),V3fringe),c_2Elist_2ENIL(A_27a))) ) ) ) ) ) ) )).
