...
fof(conj_thm_2Erich__list_2EBUTLASTN__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l] :
          ( mem(V0l,ty_2Elist_2Elist(A_27a))
         => ( V0l != c_2Elist_2ENIL(A_27a)
           => ap(ap(c_2Erich__list_2EBUTLASTN(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))),V0l) = ap(c_2Elist_2EFRONT(A_27a),V0l) ) ) ) )).
