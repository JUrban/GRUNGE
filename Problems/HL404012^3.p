...
thf(thm_2Equotient_2ELET__RES__ABSTRACT,conjecture,(
    ! [A_27a: $tType,A_27b: $tType,V0r: A_27a > $o,V1lam: A_27a > A_27b,V2v: A_27a] :
      ( ( c_2Ebool_2EIN @ A_27a @ V2v @ V0r )
     => ( ( c_2Ebool_2ELET @ A_27a @ A_27b @ ( c_2Ebool_2ERES__ABSTRACT @ A_27a @ A_27b @ V0r @ V1lam ) @ V2v )
        = ( c_2Ebool_2ELET @ A_27a @ A_27b @ V1lam @ V2v ) ) ) )).
