...
tff(thm_2Erich__list_2EFOLDR__SNOC,axiom,(
    ! [A_27a: d,A_27b: d,V0f_2E0: u,V1e_2E0: u,V2x_2E0: u,V3l_2E0: u] : s(A_27b,c_2Elist_2EFOLDR_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),V0f_2E0),s(A_27b,V1e_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2ESNOC_2E2(s(A_27a,V2x_2E0),s(tyop_2Elist_2Elist(A_27a),V3l_2E0))))) = s(A_27b,c_2Elist_2EFOLDR_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),V0f_2E0),s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27b),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),V0f_2E0),s(A_27a,V2x_2E0))),s(A_27b,V1e_2E0))),s(tyop_2Elist_2Elist(A_27a),V3l_2E0))) )).
...
tff(thm_2Erich__list_2EFOLDR__FILTER__REVERSE,conjecture,(
    ! [A_27a: d,V0f_2E0: u] :
      ( ! [V1a_2E0: u,V2b_2E0: u,V3c_2E0: u] : s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V1a_2E0))),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V2b_2E0))),s(A_27a,V3c_2E0))))) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V2b_2E0))),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V1a_2E0))),s(A_27a,V3c_2E0)))))
     => ! [V4e_2E0: u,V5P_2E0: u,V6l_2E0: u] : s(A_27a,c_2Elist_2EFOLDR_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V4e_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFILTER_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V5P_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EREVERSE_2E1(s(tyop_2Elist_2Elist(A_27a),V6l_2E0))))))) = s(A_27a,c_2Elist_2EFOLDR_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,A_27a)),V0f_2E0),s(A_27a,V4e_2E0),s(tyop_2Elist_2Elist(A_27a),c_2Elist_2EFILTER_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),V5P_2E0),s(tyop_2Elist_2Elist(A_27a),V6l_2E0))))) ) )).
