...
tff(mem_c_2Ewords_2Eword__nor,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__nor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(lamtp_f2168,axiom,(
    ! [A_27a: del,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V0v: $i] :
          ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
         => mem(f2168(A_27a,V1w,V0v),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2168,axiom,(
    ! [A_27a: del,V1w: $i] :
     ...
     => ! [V0v: $i] :
          ( mem(V0v,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2i: tp__ty_2Enum_2Enum] : ap(f2168(A_27a,V1w,V0v),inj__ty_2Enum_2Enum(V2i)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Efcp_2Efcp__index(bool,bool),V0v),inj__ty_2Enum_2Enum(V2i))),ap(ap(c_2Efcp_2Efcp__index(bool,bool),V1w),inj__ty_2Enum_2Enum(V2i)))) ) ) )).
...
tff(ax_thm_2Ewords_2Eword__nor__def,axiom,(
    ! [A_27a: del,V0v: $i] :
     ...
     => ! [V1w: $i] :
          ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
         => ap(ap(c_2Ewords_2Eword__nor(A_27a),V0v),V1w) = ap(c_2Efcp_2EFCP(bool,bool),f2168(A_27a,V1w,V0v)) ) ) )).

tff(lmtp_f2223,type,(
    f2223: tp__o > $i )).

tff(lamtp_f2223,axiom,(
    ! [V2x: tp__o] : mem(f2223(V2x),arr(bool,bool)) )).

tff(lameq_f2223,axiom,(
    ! [V2x: tp__o,V3y: tp__o] : ap(f2223(V2x),inj__o(V3y)) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,inj__o(V2x)),inj__o(V3y))) )).

tff(lmtp_f2222,type,(
    f2222: $i )).

tff(lamtp_f2222,axiom,(
    mem(f2222,arr(bool,arr(bool,bool))) )).

tff(lameq_f2222,axiom,(
    ! [V2x: tp__o] : ap(f2222,inj__o(V2x)) = f2223(V2x) )).

tff(conj_thm_2Ewords_2Eword__nor__n2w,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum] : ap(ap(c_2Ewords_2Eword__nor(A_27a),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V0n))),ap(c_2Ewords_2En2w(A_27a),inj__ty_2Enum_2Enum(V1m))) = ap(c_2Ewords_2En2w(A_27a),ap(ap(ap(ap(c_2Ebit_2EBITWISE,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a))),f2222),inj__ty_2Enum_2Enum(V0n)),inj__ty_2Enum_2Enum(V1m))) )).
