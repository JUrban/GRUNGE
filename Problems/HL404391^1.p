...
thf(f5046_0_2E0,type,(
    f5046_0_2E0: u )).

thf(f5046_0_2E1,type,(
    f5046_0_2E1: du > u )).

thf(f5046_0_2E2,type,(
    f5046_0_2E2: du > du > u )).

thf(f5046_1_2E0,type,(
    f5046_1_2E0: u )).

thf(f5046_1_2E2,type,(
    f5046_1_2E2: du > du > u )).
...
thf(c_2Ecardinal_2Elist_2E0,type,(
    c_2Ecardinal_2Elist_2E0: u )).

thf(c_2Ecardinal_2Elist_2E1,type,(
...
thf(arityeq1_2Emono_2Ef5046_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( f5046_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5046_0_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f5046_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef5046_1_2E2_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5046_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X1_2E0 ) ) ) )
...
thf(arityeq1_2Emono_2Ec_2Ecardinal_2Elist_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2Elist_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ c_2Ecardinal_2Elist_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ecardinal_2Elist__def,axiom,(
    ! [A_27a: d,V1l_2E0: u,V0A_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5046_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) ) ) )
    <=> ! [V2e_2E0: u] :
         ...
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V2e_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) ) ) ) ) ) )).

thf(def1_2Ethm_2Ecardinal_2Elist__def,axiom,(
    ! [A_27a: d,V0A_2E0: u,V1l_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f5046_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f5046_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) ) ) ) ) ) )).

thf(thm_2Ecardinal_2Elist__def,axiom,(
    ! [A_27a: d,V0A_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2Elist_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EGSPEC_2E1 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( f5046_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0A_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Ecardinal_2EUNIV__list,conjecture,(
    ! [A_27a: d] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EUNIV_2E0 )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Ecardinal_2Elist_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ c_2Epred__set_2EUNIV_2E0 ) ) ) ) )).
