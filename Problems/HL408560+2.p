...
fof(conj_thm_2Ebinary__ieee_2Efloat__mul__finite,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3r1] :
                         ...
                         => ! [V4r2] :
                             ...
                             => ( ( ap(c_2Ebinary__ieee_2Efloat__value(A_27a,A_27a),V1x) = ap(c_2Ebinary__ieee_2EFloat,V3r1)
                               ...
                               => ap(ap(ap(c_2Ebinary__ieee_2Efloat__mul(A_27a,A_27a),V0mode),V1x),V2y) = ap(ap(ap(c_2Ebinary__ieee_2Efloat__round__with__flags(A_27a,A_27a),V0mode),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27a,A_27a),V1x)),ap(c_2Ebinary__ieee_2Efloat__Sign(A_27a,A_27a),V2y)))),ap(ap(c_2Erealax_2Ereal__mul,V3r1),V4r2)) ) ) ) ) ) ) ) ) )).
