...
fof(conj_thm_2Eiterate_2ESUM__DELETE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
...
fof(conj_thm_2Eiterate_2ESUM__CASES,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
    ...
    ! [A_27a,V0y] :
     ...
     => ! [V3a] :
         ...
         => ! [V1f] :
             ...
             => ! [V4x] :
                  ( mem(V4x,A_27a)
                 => ap(f3383(A_27a,V0y,V3a,V1f),V4x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(ap(c_2Emin_2E_3D(A_27a),V4x),V3a)),V0y),ap(V1f,V4x)) ) ) ) ) )).

fof(conj_thm_2Eiterate_2ESUM__CASES__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0y] :
          ( mem(V0y,ty_2Erealax_2Ereal)
             ...
             => ! [V2s] :
                 ...
                 => ! [V3a] :
                     ...
                     => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                       ...
                       => ap(ap(c_2Eiterate_2ESum(A_27a),V2s),f3383(A_27a,V0y,V3a,V1f)) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1f)),ap(ap(c_2Ereal_2Ereal__sub,V0y),ap(V1f,V3a))) ) ) ) ) ) ) )).
