...
fof(ax_thm_2Emachine__ieee_2Efp32__sqrt__def,axiom,(
    ! [V0mode] :
     ...
     => ap(c_2Emachine__ieee_2Efp32__sqrt,V0mode) = ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Emachine__ieee_2Efloat__to__fp32),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags)),ap(ap(c_2Ecombin_2Eo(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ebinary__ieee_2Efloat__sqrt(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))),V0mode)),c_2Emachine__ieee_2Efp32__to__float))) ) )).
...
fof(conj_thm_2Elift__machine__ieee_2Efp32__float__sqrt__relative,conjecture,(
    ! [V0a] :
      ( mem(V0a,ty_2Efcp_2Ecart(bool,bool))
     => ( ( p(ap(c_2Emachine__ieee_2Efp32__isFinite,V0a))
          & ~ p(ap(c_2Ewords_2Eword__msb(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))))),V0a))
       ...
       => ( p(ap(c_2Emachine__ieee_2Efp32__isFinite,ap(ap(c_2Emachine__ieee_2Efp32__sqrt,c_2Ebinary__ieee_2EroundTiesToEven),V0a)))
          & ? [V1e] :
              ( mem(V1e,ty_2Erealax_2Ereal)
              & p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,V1e)),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(ap(c_2Ereal_2Epow,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT2,c_2Earithmetic_2EZERO)))))))))
              & ap(c_2Emachine__ieee_2Efp32__to__real,ap(ap(c_2Emachine__ieee_2Efp32__sqrt,c_2Ebinary__ieee_2EroundTiesToEven),V0a)) = ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Etransc_2Esqrt,ap(c_2Emachine__ieee_2Efp32__to__real,V0a))),ap(ap(c_2Erealax_2Ereal__add,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),V1e)) ) ) ) ) )).
