...
thf(conj_thm_2Ereal__topology_2EBIGUNION__BIGINTER,lemma,(
    ! [A_27a: del,V0s: $i] :
        ...
        = ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ ( c_2Epred__set_2EUNIV @ A_27a ) )
          @ ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27a )
            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
              @ ( lam @ ( arr @ A_27a @ bool )
                @ ^ [V1t: $i] :
                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDIFF @ A_27a ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) @ V1t ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V1t ) @ V0s ) ) ) ) ) ) ) ) )).
...
thf(ax_thm_2Ereal__topology_2Eclosed__def,axiom,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ELOCALLY__COMPACT__UNIV,lemma,(
...
thf(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION__CLOSED,conjecture,(
    ! [V0g: $i] :
      ( ( mem @ V0g @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ( ( ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V0g ) )
          & ! [V1s: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V1s ) @ V0g ) )
               => ( ( p @ ( ap @ c_2Ereal__topology_2EClosed @ V1s ) )
                  & ( ( ap @ c_2Ereal__topology_2Einterior @ V1s )
                    = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )
       => ( ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( c_2Epred__set_2EBIGUNION @ ty_2Erealax_2Ereal ) @ V0g ) )
          = ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
