...
thf(c_2Epath_2Eevery_2E0,type,(
    c_2Epath_2Eevery_2E0: u )).

thf(c_2Epath_2Eevery_2E2,type,(
    c_2Epath_2Eevery_2E2: du > du > u )).

thf(c_2Epath_2Eexists_2E0,type,(
    c_2Epath_2Eexists_2E0: u )).

thf(c_2Epath_2Eexists_2E2,type,(
    c_2Epath_2Eexists_2E2: du > du > u )).

thf(c_2Epath_2EfirstP__at_2E0,type,(
    c_2Epath_2EfirstP__at_2E0: u )).

thf(c_2Epath_2EfirstP__at_2E3,type,(
    c_2Epath_2EfirstP__at_2E3: du > du > du > u )).
...
thf(arityeq2_2Emono_2Ec_2Epath_2Eevery_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eevery_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) )
...
thf(arityeq2_2Emono_2Ec_2Epath_2Eexists_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ c_2Epath_2Eexists_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) ) ) )).

thf(arityeq3_2Emono_2Ec_2Epath_2EfirstP__at_2E3_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u,X2: mono_2Etyop_2Enum_2Enum] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2EfirstP__at_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ X2 ) ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Enum_2Enum_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ tyop_2Emin_2Ebool ) ) ) @ c_2Epath_2EfirstP__at_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ X1_2E0 ) ) ) @ X2 ) ) )).
...
thf(thm_2Epath_2EfirstP__at__thm,axiom,(
    ! [A_27a: d,A_27b: d] :
      ( ! [V0P_2E0: u,V1x_2E0: u,V2n: mono_2Etyop_2Enum_2Enum] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2EfirstP__at_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Estopped__at_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2n ) ) ) ) )
        <=> ( ( V2n = mono_2Ec_2Enum_2E0 )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) ) )
      & ! [V3P_2E0: u,V4n: mono_2Etyop_2Enum_2Enum,V5x_2E0: u,V6r_2E0: u,V7p_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2EfirstP__at_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ ( c_2Epath_2Epcons_2E3 @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27b @ V6r_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V7p_2E0 ) ) ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V4n ) ) ) ) )
        <=> ( ( ( V4n = mono_2Ec_2Enum_2E0 )
              & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) )
            | ( ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ V4n )
              & ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) ) ) ) )
              & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2EfirstP__at_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V3P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V7p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2D @ V4n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2Epath_2Eexists__def,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1p_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) )
    <=> ? [V2i: mono_2Etyop_2Enum_2Enum] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2EfirstP__at_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V2i ) ) ) ) ) ) )).

thf(thm_2Epath_2Eevery__def,axiom,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1p_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eevery_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) )
    <=> ( (~) @ ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eexists_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Ecombin_2Eo_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Emin_2Ebool @ tyop_2Emin_2Ebool ) @ ( i_mono_2Etyop_2Emin_2Efun_28tyop_2Emin_2Ebool_2Ctyop_2Emin_2Ebool_29 @ mono_2Ec_2Ebool_2E_7E ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) ) ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V1p_2E0 ) ) ) ) ) ) )).
...
thf(thm_2Epath_2Eevery__coinduction,conjecture,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1Q_2E0: u] :
     ...
     => ! [V6p_2E0: u] :
          ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V6p_2E0 ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epath_2Eevery_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1Q_2E0 ) @ ( s @ ( tyop_2Epath_2Epath @ A_27a @ A_27b ) @ V6p_2E0 ) ) ) ) ) ) )).
