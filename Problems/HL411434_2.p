...
tff(conj_thm_2Ereal__topology_2ECOMPONENTS__INTERMEDIATE__SUBSET,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOPEN__BIGUNION__COMPONENTS,lemma,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: $i] :
...
tff(conj_thm_2Ereal__topology_2ECLOPEN__IN__COMPONENTS,conjecture,(
    ! [V0u: $i] :
      ( mem(V0u,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
