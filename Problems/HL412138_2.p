...
tff(lamtp_f309,axiom,(
    ! [A_27b: del,A_27a: del,V1s: $i] :
      ( mem(V1s,arr(A_27b,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(A_27a,A_27b))
         => mem(f309(A_27b,A_27a,V1s,V0f),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f309,axiom,(
    ! [A_27b: del,A_27a: del,V1s: $i] :
     ...
     => ! [V0f: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f309(A_27b,A_27a,V1s,V0f),V2x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Ebool_2EIN(A_27b),ap(V0f,V2x)),V1s)) ) ) ) )).
...
tff(ax_thm_2Epred__set_2EPREIMAGE__def,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27b,bool))
         => ap(ap(c_2Epred__set_2EPREIMAGE(A_27a,A_27a),V0f),V1s) = ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f309(A_27b,A_27a,V1s,V0f)) ) ) )).
...
tff(lmtp_f4226,type,(
    f4226: ( del * del * del * $i * $i * $i ) > $i )).

tff(lamtp_f4226,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,V2Y: $i] :
      ( mem(V2Y,arr(A_27c,A_27b))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27c,A_27a))
         => ! [V0p: $i] :
...
tff(ax_thm_2Eprobability_2Ejoint__distribution__def,axiom,(
...
tff(conj_thm_2Eprobability_2EPROB__REAL__SUM__IMAGE__FN,lemma,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27b,arr(A_27a,bool)))
...
tff(lmtp_f4245,type,(
    f4245: ( del * del * del * del * $i * $i * $i * $i ) > $i )).

tff(lamtp_f4245,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,A_27b: del,V2Y: $i] :
     ...
     => ! [V0p: $i] :
         ...
         => ! [V1X: $i] :
             ...
             => ! [V3b: $i] :
                 ...
                 => mem(f4245(A_27c,A_27b,A_27a,A_27b,V2Y,V0p,V1X,V3b),arr(A_27b,ty_2Erealax_2Ereal)) ) ) ) ) )).

tff(lameq_f4245,axiom,(
    ! [A_27c: del,A_27b: del,A_27a: del,A_27b: del,V2Y: $i] :
      ( mem(V2Y,arr(A_27a,A_27c))
     => ! [V0p: $i] :
          ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V1X: $i] :
             ...
             => ! [V3b: $i] :
                 ...
                 => ! [V4x: $i] :
                      ( mem(V4x,A_27b)
                     => ap(f4245(A_27c,A_27b,A_27a,A_27b,V2Y,V0p,V1X,V3b),V4x) = ap(ap(ap(ap(c_2Eprobability_2Ejoint__distribution(A_27b,A_27b,A_27b),V0p),V1X),V2Y),ap(ap(c_2Epred__set_2ECROSS(A_27b,A_27b),ap(ap(c_2Epred__set_2EINSERT(A_27b),V4x),c_2Epred__set_2EEMPTY(A_27b))),V3b)) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2Emarginal__distribution2,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1X: $i] :
          ( mem(V1X,arr(A_27a,A_27b))
         => ! [V2Y: $i] :
             ...
             => ! [V3b: $i] :
                 ...
                 => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
                   ...
                   => surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27c,A_27c),V0p),V2Y),V3b)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4245(A_27c,A_27b,A_27a,A_27b,V2Y,V0p,V1X,V3b)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V1X),ap(c_2Eprobability_2Ep__space(A_27a),V0p)))) ) ) ) ) ) )).
