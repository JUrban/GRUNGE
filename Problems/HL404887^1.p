...
thf(thm_2Elbtree_2Emem__cases,conjecture,(
    ! [A_27a: d,V0a0_2E0: u,V1a1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Emem_2E2 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 ) ) ) )
    <=> ( ? [V2t1_2E0: u,V3t2_2E0: u] :
            ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
            = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V2t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V3t2_2E0 ) ) ) )
        | ? [V4b_2E0: u,V5t1_2E0: u,V6t2_2E0: u] :
            ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
              = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V4b_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V5t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V6t2_2E0 ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Emem_2E2 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V5t1_2E0 ) ) ) ) )
        | ? [V7b_2E0: u,V8t1_2E0: u,V9t2_2E0: u] :
            ( ( ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V1a1_2E0 )
              = ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ ( c_2Elbtree_2ENd_2E3 @ ( s @ A_27a @ V7b_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V8t1_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V9t2_2E0 ) ) ) )
            & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Elbtree_2Emem_2E2 @ ( s @ A_27a @ V0a0_2E0 ) @ ( s @ ( tyop_2Elbtree_2Elbtree @ A_27a ) @ V9t2_2E0 ) ) ) ) ) ) ) )).
