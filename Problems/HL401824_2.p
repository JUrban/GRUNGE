...
tff(lmtp_f283,type,(
    f283: ( del * del * del * $i * $i ) > $i )).

tff(lamtp_f283,axiom,(
    ! [A_27b: del,A_27a: del,A_27b: del,V1Q: $i] :
...
tff(conj_thm_2Epred__set_2Epair__to__num__inv,lemma,
...
tff(conj_thm_2Epred__set_2Einj__countable,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2Ebigunion__countable,conjecture,(
    ! [A_27a: del,V0s: $i] :
