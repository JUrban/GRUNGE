...
thf(c_2Emeasure_2Eclosed__cdi,type,(
    c_2Emeasure_2Eclosed__cdi: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) ) > $o ) )).
...
thf(c_2Emeasure_2Esmallest__closed__cdi,type,(
    c_2Emeasure_2Esmallest__closed__cdi: 
      !>[A_27a: $tType] :
        ( ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) ) > ( tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) ) ) )).
...
thf(thm_2Emeasure_2Eclosed__cdi__def,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( c_2Emeasure_2Eclosed__cdi @ A_27a @ V0p )
    <=> ( ( c_2Emeasure_2Esubset__class @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V0p ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) )
        ...
        & ! [V2f: tyop_2Enum_2Enum > A_27a > $o] :
            ( ( ( c_2Ebool_2EIN @ ( tyop_2Enum_2Enum > A_27a > $o ) @ V2f @ ( c_2Epred__set_2EFUNSET @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) )
              & ( ( V2f @ c_2Enum_2E0 )
                = ( c_2Epred__set_2EEMPTY @ A_27a ) )
              & ! [V3n: tyop_2Enum_2Enum] :
                  ( c_2Epred__set_2ESUBSET @ A_27a @ ( V2f @ V3n ) @ ( V2f @ ( c_2Enum_2ESUC @ V3n ) ) ) )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V2f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) )
        & ! [V4f: tyop_2Enum_2Enum > A_27a > $o] :
            ( ( ( c_2Ebool_2EIN @ ( tyop_2Enum_2Enum > A_27a > $o ) @ V4f @ ( c_2Epred__set_2EFUNSET @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) )
              & ! [V5m: tyop_2Enum_2Enum,V6n: tyop_2Enum_2Enum] :
                  ( ( (~) @ ( V5m = V6n ) )
                 => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V4f @ V5m ) @ ( V4f @ V6n ) ) ) )
           => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V4f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) ) ) ) )).

thf(thm_2Emeasure_2Esmallest__closed__cdi__def,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a )
      = ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Espace @ A_27a @ V0a )
        @ ( c_2Epred__set_2EBIGINTER @ ( A_27a > $o )
          @ ( c_2Epred__set_2EGSPEC @ ( ( A_27a > $o ) > $o ) @ ( ( A_27a > $o ) > $o )
            @ ^ [V1b: ( A_27a > $o ) > $o] :
                ( c_2Epair_2E_2C @ ( ( A_27a > $o ) > $o ) @ $o @ V1b @ ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) @ V1b ) @ ( c_2Emeasure_2Eclosed__cdi @ A_27a @ ( c_2Epair_2E_2C @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ) @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ V1b ) ) ) ) ) ) ) ) )).
...
thf(thm_2Emeasure_2ESPACE__SMALLEST__CLOSED__CDI,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( c_2Emeasure_2Espace @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) )
      = ( c_2Emeasure_2Espace @ A_27a @ V0a ) ) )).

thf(thm_2Emeasure_2ESMALLEST__CLOSED__CDI,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( c_2Emeasure_2Ealgebra @ A_27a @ V0a )
     => ( ( c_2Epred__set_2ESUBSET @ ( A_27a > $o ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) )
        & ( c_2Emeasure_2Eclosed__cdi @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) )
        & ( c_2Emeasure_2Esubset__class @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V0a ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) ) ) ) )).

thf(thm_2Emeasure_2ECLOSED__CDI__DUNION,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1s: A_27a > $o,V2t: A_27a > $o] :
      ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) )
        & ( c_2Emeasure_2Eclosed__cdi @ A_27a @ V0p )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) )
        & ( c_2Epred__set_2EDISJOINT @ A_27a @ V1s @ V2t ) )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNION @ A_27a @ V1s @ V2t ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) ) )).

thf(thm_2Emeasure_2ECLOSED__CDI__COMPL,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1s: A_27a > $o] :
      ( ( ( c_2Emeasure_2Eclosed__cdi @ A_27a @ V0p )
        & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EDIFF @ A_27a @ ( c_2Emeasure_2Espace @ A_27a @ V0p ) @ V1s ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) ) )).

thf(thm_2Emeasure_2ECLOSED__CDI__DISJOINT,axiom,(
    ! [A_27a: $tType,V0p: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1f: tyop_2Enum_2Enum > A_27a > $o] :
      ( ( ( c_2Emeasure_2Eclosed__cdi @ A_27a @ V0p )
        & ( c_2Ebool_2EIN @ ( tyop_2Enum_2Enum > A_27a > $o ) @ V1f @ ( c_2Epred__set_2EFUNSET @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) )
        & ! [V2m: tyop_2Enum_2Enum,V3n: tyop_2Enum_2Enum] :
            ( ( (~) @ ( V2m = V3n ) )
           => ( c_2Epred__set_2EDISJOINT @ A_27a @ ( V1f @ V2m ) @ ( V1f @ V3n ) ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) ) )).
    ...
    ! [A_27a: $tType,V0p: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o ),V1f: tyop_2Enum_2Enum > A_27a > $o] :
      ( ( ( c_2Emeasure_2Eclosed__cdi @ A_27a @ V0p )
        ...
        & ! [V2n: tyop_2Enum_2Enum] :
            ( c_2Epred__set_2ESUBSET @ A_27a @ ( V1f @ V2n ) @ ( V1f @ ( c_2Enum_2ESUC @ V2n ) ) ) )
     => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EBIGUNION @ A_27a @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ ( A_27a > $o ) @ V1f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) @ ( c_2Emeasure_2Esubsets @ A_27a @ V0p ) ) ) )).
...
thf(thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA1,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
     ...
     => ! [V1s: A_27a > $o,V2t: A_27a > $o] :
          ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Esubsets @ A_27a @ V0a ) )
            & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) ) )
         => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EINTER @ A_27a @ V1s @ V2t ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) ) ) ) )).
...
thf(thm_2Epred__set_2EUNION__DEF,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1t: A_27a > $o] :
      ...
      = ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
        @ ^ [V2x: A_27a] :
            ( c_2Epair_2E_2C @ A_27a @ $o @ V2x @ ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V0s ) @ ( c_2Ebool_2EIN @ A_27a @ V2x @ V1t ) ) ) ) ) )).
...
thf(thm_2Emeasure_2ESIGMA__PROPERTY__DISJOINT__LEMMA2,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Epair_2Eprod @ ( A_27a > $o ) @ ( ( A_27a > $o ) > $o )] :
      ( ( c_2Emeasure_2Ealgebra @ A_27a @ V0a )
     => ! [V1s: A_27a > $o,V2t: A_27a > $o] :
          ( ( ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V1s @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) )
            & ( c_2Ebool_2EIN @ ( A_27a > $o ) @ V2t @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) ) )
         => ( c_2Ebool_2EIN @ ( A_27a > $o ) @ ( c_2Epred__set_2EINTER @ A_27a @ V1s @ V2t ) @ ( c_2Emeasure_2Esubsets @ A_27a @ ( c_2Emeasure_2Esmallest__closed__cdi @ A_27a @ V0a ) ) ) ) ) )).
