...
thf(thm_2Ereal__topology_2ESERIES__DROP__POS,axiom,(
    ! [V0f: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal,V1s: tyop_2Enum_2Enum > $o,V2a: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Esums @ V0f @ V2a @ V1s )
     ...
     => ( c_2Ereal_2Ereal__lte @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) @ V2a ) ) )).
