...
tff(conj_thm_2Eproduct_2EPRODUCT__CLAUSES,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__MUL,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__PRODUCT,conjecture,(
