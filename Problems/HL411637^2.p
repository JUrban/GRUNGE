...
thf(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1h: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4u: $i] :
                     ...
                     => ( ( ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V2s )
                            = V3t )
                          & ! [V5v: $i] :
                              ( ( mem @ V5v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                             => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V5v ) @ V3t ) )
                               => ( ( p
                                    @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                        @ ( lam @ ty_2Erealax_2Ereal
                                          @ ^ [V6x: $i] :
                                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V6x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V6x ) ) @ V5v ) ) ) ) ) ) )
                          ...
                          & ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1h ) @ V2s )
                            = V4u )
                          & ! [V7x: tp__ty_2Erealax_2Ereal,V8y: tp__ty_2Erealax_2Ereal] :
                              ( ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) @ V2s ) )
                                ...
                                & ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) )
                                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V8y ) ) ) ) )
                             => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1h @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) )
                                = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1h @ ( inj__ty_2Erealax_2Ereal @ V8y ) ) ) ) ) )
                       => ? [V9g: $i] :
                            ( ( mem @ V9g @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                            & ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ V9g ) @ V3t ) )
                            & ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V9g ) @ V3t )
                              = V4u )
                            & ! [V10x: tp__ty_2Erealax_2Ereal] :
                                ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) @ V2s ) )
                               => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1h @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) )
                                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ V9g @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V10x ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(ax_thm_2Ereal__topology_2Ehomeomorphic,axiom,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ELIFT__TO__QUOTIENT__SPACE__UNIQUE,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ! [V4u: $i] :
                     ...
                     => ( ( ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V2s )
                            = V3t )
                          & ( ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V1g ) @ V2s )
                            = V4u )
                          & ! [V5v: $i] :
                              ( ( mem @ V5v @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
                             => ( ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ V5v ) @ V3t ) )
                               ...
                               => ( ( p
                                    @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                                      @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                                        @ ( lam @ ty_2Erealax_2Ereal
                                          @ ^ [V8x: $i] :
                                              ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V8x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V8x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V1g @ V8x ) ) @ V7v ) ) ) ) ) ) )
                          ...
                          & ! [V9x: tp__ty_2Erealax_2Ereal,V10y: tp__ty_2Erealax_2Ereal] :
                             ...
                             => ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V9x ) ) )
                                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ V0f @ ( inj__ty_2Erealax_2Ereal @ V10y ) ) ) )
                              <=> ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V9x ) ) )
                                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ V1g @ ( inj__ty_2Erealax_2Ereal @ V10y ) ) ) ) ) ) )
