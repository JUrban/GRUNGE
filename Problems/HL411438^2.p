...
thf(conj_thm_2Ereal__topology_2EEVENTUALLY__HAPPENS,lemma,(
    ! [A_27a: del,V0net: $i] :
...
thf(conj_thm_2Ereal__topology_2EABS__TRIANGLE__LE,lemma,(
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__UNIFORM__LIMIT,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( ( mem @ V0net @ ( ty_2Ereal__topology_2Enet @ A_27a ) )
     => ! [V1f: $i] :
                      ...
                      & ( p
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__topology_2Eeventually @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V4n: $i] :
                                  ( ap @ ( ap @ c_2Ereal__topology_2Econtinuous__on @ ( ap @ V1f @ V4n ) ) @ V3s ) ) )
                          @ V0net ) )
                                ...
                                @ ( lam @ A_27a
                                  @ ^ [V6n: $i] :
                                      ...
                                      @ ( lam @ ty_2Erealax_2Ereal
                                        @ ^ [V7x: $i] :
                                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V7x ) @ V3s ) ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Ereal__sub @ ( ap @ ( ap @ V1f @ V6n ) @ V7x ) ) @ ( ap @ V2g @ V7x ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V5e ) ) ) ) ) ) )
                              @ V0net ) ) ) )
