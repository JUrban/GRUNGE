...
thf(thm_2EASCIInumbers_2ESTRCAT__toString__inj,conjecture,(
    ! [V0n: tyop_2Enum_2Enum,V1m: tyop_2Enum_2Enum,V2s: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
      ( ( ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ V2s @ ( c_2EASCIInumbers_2Enum__to__dec__string @ V0n ) )
        = ( c_2Elist_2EAPPEND @ tyop_2Estring_2Echar @ V2s @ ( c_2EASCIInumbers_2Enum__to__dec__string @ V1m ) ) )
    <=> ( V0n = V1m ) ) )).
