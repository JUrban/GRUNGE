...
tff(lamtp_f3316,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f3316(A_27a,V0f,V1s),arr(A_27a,ty_2Enum_2Enum)) ) ) )).
...
tff(lameq_f3316,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3316(A_27a,V0f,V1s),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)),ap(V0f,V2x)),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)) ) ) ) )).

tff(conj_thm_2Eiterate_2ENSUM__RESTRICT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
           => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),f3316(A_27a,V0f,V1s))) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V1s),V0f)) ) ) ) )).
