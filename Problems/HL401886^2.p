     ...
     => ( ( ap @ ( c_2EfixedPoint_2Egfp @ A_27a ) @ V0f )
        = ( ap @ ( c_2Epred__set_2EBIGUNION @ A_27a )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
            @ ( lam @ ( arr @ A_27a @ bool )
              @ ^ [V1X: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V1X ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ A_27a ) @ V1X ) @ ( ap @ V0f @ V1X ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2EfixedPoint_2Egfp__greatest__dense,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) ) )
