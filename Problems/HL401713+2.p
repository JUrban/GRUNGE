...
fof(conj_thm_2Epred__set_2EINSERT__SING__UNION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
...
fof(conj_thm_2Epred__set_2ECROSS__INSERT__RIGHT,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0P] :
             ...
             => ! [V1Q] :
                 ...
                 => ! [V2x] :
                      ( mem(V2x,A_27b)
                     => ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0P),ap(ap(c_2Epred__set_2EINSERT(A_27b),V2x),V1Q)) = ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0P),ap(ap(c_2Epred__set_2EINSERT(A_27b),V2x),c_2Epred__set_2EEMPTY(A_27b)))),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),V0P),V1Q)) ) ) ) ) ) )).
...
fof(conj_thm_2Epred__set_2ECARD__SING__CROSS,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0x] :
             ...
             => ! [V1P] :
                 ...
                 => ( p(ap(c_2Epred__set_2EFINITE(A_27b),V1P))
                   => ap(c_2Epred__set_2ECARD(ty_2Epair_2Eprod(A_27a,A_27a)),ap(ap(c_2Epred__set_2ECROSS(A_27a,A_27a),ap(ap(c_2Epred__set_2EINSERT(A_27a),V0x),c_2Epred__set_2EEMPTY(A_27a))),V1P)) = ap(c_2Epred__set_2ECARD(A_27b),V1P) ) ) ) ) ) )).
