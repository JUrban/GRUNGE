...
thf(conj_thm_2Eintegral_2EINTEGRABLE__CAUCHY,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__SPLIT__SIDES,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
                  ...
                  & ( p
                    @ ( ap
                      @ ( ap @ c_2Etransc_2Egauge
                        @ ( lam @ ty_2Erealax_2Ereal
                          @ ^ [V7x: $i] :
                              ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ V7x ) ) @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ V7x ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) ) )
                      @ V6g ) )
                  & ! [V8d1: $i] :
...
thf(conj_thm_2Eintegral_2EINTEGRABLE__SUBINTERVAL__RIGHT,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1a: tp__ty_2Erealax_2Ereal,V2b: tp__ty_2Erealax_2Ereal,V3c: tp__ty_2Erealax_2Ereal] :
          ( ( ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) )
            & ( p @ ( ap @ ( ap @ c_2Ereal_2Ereal__lte @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) )
            & ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1a ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V0f ) ) )
         => ( p @ ( ap @ ( ap @ c_2Eintegral_2Eintegrable @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V3c ) ) @ ( inj__ty_2Erealax_2Ereal @ V2b ) ) ) @ V0f ) ) ) ) )).
