...
thf(conj_thm_2Eutil__prob_2EMINIMAL__EXISTS,lemma,(
    ! [V0P: $i] :
...
thf(conj_thm_2Eutil__prob_2EMINIMAL__EQ__IMP,conjecture,(
    ! [V0m: tp__ty_2Enum_2Enum,V1p: $i] :
     ...
     => ( ( ( p @ ( ap @ V1p @ ( inj__ty_2Enum_2Enum @ V0m ) ) )
       ...
       => ( V0m
          = ( surj__ty_2Enum_2Enum @ ( ap @ c_2Eutil__prob_2Eminimal @ V1p ) ) ) ) ) )).
