...
tff(conj_thm_2Ecombin_2EAPPLY__UPDATE__THM,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1a: $i] :
          ( mem(V1a,A_27a)
...
tff(conj_thm_2Epred__set_2EINJ__EXTEND,conjecture,(
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ! [V3x: $i] :
                 ...
                 => ! [V4y: $i] :
                      ( mem(V4y,A_27b)
                     => ( ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0b),V1s),V2t))
                          & ~ p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                          & ~ p(ap(ap(c_2Ebool_2EIN(A_27b),V4y),V2t)) )
                       => p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),ap(ap(ap(c_2Ecombin_2EUPDATE(A_27a,A_27a),V3x),V4y),V0b)),ap(ap(c_2Epred__set_2EINSERT(A_27a),V3x),V1s)),ap(ap(c_2Epred__set_2EINSERT(A_27b),V4y),V2t))) ) ) ) ) ) ) )).
