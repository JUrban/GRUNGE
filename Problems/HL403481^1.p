...
thf(thm_2Esemi__ring_2Emult__rotate,conjecture,(
    ! [A_27a: d,V0r_2E0: u] :
     ...
     => ! [V1m_2E0: u,V2n_2E0: u,V3p_2E0: u] :
          ...
          = ( s @ A_27a @ ( c_2Esemi__ring_2Esemi__ring__SRM_2E3 @ ( s @ ( tyop_2Esemi__ring_2Esemi__ring @ A_27a ) @ V0r_2E0 ) @ ( s @ A_27a @ ( c_2Esemi__ring_2Esemi__ring__SRM_2E3 @ ( s @ ( tyop_2Esemi__ring_2Esemi__ring @ A_27a ) @ V0r_2E0 ) @ ( s @ A_27a @ V2n_2E0 ) @ ( s @ A_27a @ V3p_2E0 ) ) ) @ ( s @ A_27a @ V1m_2E0 ) ) ) ) ) )).
