...
thf(conj_thm_2Ereal_2EREAL__LT__1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal_2EABS__CASES,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( V0x
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) )
      | ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Ereal_2Eabs @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) ) )).
...
thf(conj_thm_2Eseq_2ESEQ__BOUNDED,lemma,(
    ! [V0s: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ ( c_2Enets_2Ebounded @ ty_2Erealax_2Ereal @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Emetric_2Emetric @ ty_2Erealax_2Ereal ) @ ( arr @ ty_2Enum_2Enum @ ( arr @ ty_2Enum_2Enum @ bool ) ) ) @ c_2Emetric_2Emr1 ) @ c_2Earithmetic_2E_3E_3D ) ) @ V0s ) )
      <=> ? [V1k: tp__ty_2Erealax_2Ereal] :
          ! [V2n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0s @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1k ) ) ) ) ) )).
...
thf(conj_thm_2Epowser_2EPOWSER__INSIDEA,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2z: tp__ty_2Erealax_2Ereal] :
          ( ( ( p
              @ ( ap @ c_2Eseq_2Esummable
                @ ( lam @ ty_2Enum_2Enum
                  @ ^ [V3n: $i] :
                      ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V0f @ V3n ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) @ V3n ) ) ) ) )
         ...
         => ( p
            @ ( ap @ c_2Eseq_2Esummable
              @ ( lam @ ty_2Enum_2Enum
                @ ^ [V4n: $i] :
                    ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ c_2Ereal_2Eabs @ ( ap @ V0f @ V4n ) ) ) @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V2z ) ) @ V4n ) ) ) ) ) ) ) )).
