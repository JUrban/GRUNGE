...
thf(conj_thm_2Eproduct_2ENPRODUCT__EQ,lemma,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ! [V3x: $i] :
               ...
               => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V2s ) @ V0f ) )
                  = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ A_27a ) @ V2s ) @ V1g ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eproduct_2ENPRODUCT__EQ__NUMSEG,conjecture,(
    ! [V0f: $i] :
     ...
     => ! [V1g: $i] :
         ...
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
              ( ! [V4i: tp__ty_2Enum_2Enum] :
                 ...
                 => ( ( surj__ty_2Enum_2Enum @ ( ap @ V0f @ ( inj__ty_2Enum_2Enum @ V4i ) ) )
                    = ( surj__ty_2Enum_2Enum @ ( ap @ V1g @ ( inj__ty_2Enum_2Enum @ V4i ) ) ) ) )
             => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V0f ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ ( c_2Eproduct_2Enproduct @ ty_2Enum_2Enum ) @ ( ap @ ( ap @ c_2Eiterate_2E_2E_2E @ ( inj__ty_2Enum_2Enum @ V2m ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ V1g ) ) ) ) ) ) )).
