...
thf(conj_thm_2Ebag_2ENOT__IN__BAG__DIFF,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1b1: $i] :
          ( ( mem @ V1b1 @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
         => ! [V2b2: $i] :
             ...
             => ( ~ ( p @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__IN @ A_27a ) @ V0x ) @ V1b1 ) )
               => ( ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b1 ) @ ( ap @ ( ap @ ( c_2Ebag_2EBAG__INSERT @ A_27a ) @ V0x ) @ V2b2 ) )
                  = ( ap @ ( ap @ ( c_2Ebag_2EBAG__DIFF @ A_27a ) @ V1b1 ) @ V2b2 ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebag_2EFINITE__BAG__DIFF__dual,conjecture,(
    ! [A_27a: del,V0b1: $i] :
