...
thf(conj_thm_2Emeasure_2EINDICATOR__FN__MUL__INTER,conjecture,(
    ! [A_27a: del,V0A: $i] :
     ...
     => ! [V1B: $i] :
         ...
         => ( ( lam @ A_27a
              @ ^ [V2t: $i] :
                  ( ap @ ( ap @ c_2Eextreal_2Eextreal__mul @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ V0A ) @ V2t ) ) @ ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ V1B ) @ V2t ) ) )
            = ( lam @ A_27a
              @ ^ [V3t: $i] :
                  ( ap @ ( ap @ ( c_2Emeasure_2Eindicator__fn @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V0A ) @ V1B ) ) @ V3t ) ) ) ) ) )).
