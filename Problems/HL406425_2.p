...
tff(tp_c_2EternaryComparisons_2Epair__compare,type,(
    c_2EternaryComparisons_2Epair__compare: ( del * del * del * del ) > $i )).

tff(mem_c_2EternaryComparisons_2Epair__compare,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del] : mem(c_2EternaryComparisons_2Epair__compare(A_27a,A_27a,A_27a,A_27a),arr(arr(A_27a,arr(A_27b,ty_2EternaryComparisons_2Eordering)),arr(arr(A_27c,arr(A_27d,ty_2EternaryComparisons_2Eordering)),arr(ty_2Epair_2Eprod(A_27a,A_27a),arr(ty_2Epair_2Eprod(A_27b,A_27b),ty_2EternaryComparisons_2Eordering))))) )).
...
tff(conj_thm_2Ecomparison_2Epair__cmp__def,lemma,(
     ...
     => ! [V1c2: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                 ...
                 => surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(ap(c_2EternaryComparisons_2Epair__compare(A_27a,A_27a,A_27a,A_27a),V0c1),V1c2),V2x),V3y)) = surj__ty_2EternaryComparisons_2Eordering(ap(ap(ap(ap(c_2EternaryComparisons_2Eordering__CASE(ty_2EternaryComparisons_2Eordering),ap(ap(V0c1,ap(c_2Epair_2EFST(A_27a,A_27a),V2x)),ap(c_2Epair_2EFST(A_27b,A_27b),V3y))),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2ELESS)),ap(ap(V1c2,ap(c_2Epair_2ESND(A_27a,A_27a),V2x)),ap(c_2Epair_2ESND(A_27b,A_27b),V3y))),inj__ty_2EternaryComparisons_2Eordering(fo__c_2EternaryComparisons_2EGREATER))) ) ) ) ) )).

tff(conj_thm_2Ecomparison_2Epair__cmp__lexTO,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,ty_2EternaryComparisons_2Eordering)))
     => ! [V1V: $i] :
          ( mem(V1V,arr(A_27b,arr(A_27b,ty_2EternaryComparisons_2Eordering)))
         => ( ( p(ap(c_2Etoto_2ETotOrd(A_27a),V0R))
              & p(ap(c_2Etoto_2ETotOrd(A_27b),V1V)) )
           => ap(ap(c_2EternaryComparisons_2Epair__compare(A_27a,A_27a,A_27a,A_27a),V0R),V1V) = ap(ap(c_2Etoto_2ElexTO(A_27a,A_27a),V0R),V1V) ) ) ) )).
