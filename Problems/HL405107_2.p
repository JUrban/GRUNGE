...
tff(conj_thm_2Equotient__pred__set_2EUNIV__RSP,conjecture,(
     ...
     => ! [V1abs: $i] :
         ...
         => ! [V2rep: $i] :
             ...
             => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27a,A_27a),V0R),V1abs),V2rep))
               => p(ap(ap(ap(ap(c_2Equotient_2E_3D_3D_3D_3E(A_27a,A_27a),V0R),c_2Emin_2E_3D(bool)),c_2Epred__set_2EUNIV(A_27a)),c_2Epred__set_2EUNIV(A_27a))) ) ) ) ) )).
