...
tff(conj_thm_2Etopology_2EOPEN__IN__CLOSED__IN__EQ,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Eiterate_2ESUBSET__RESTRICT,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1P: $i] :
          ( mem(V1P,arr(A_27a,bool))
...
tff(lamtp_f3925,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
         => ! [V4u: $i] :
              ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
             => mem(f3925(V2s,V0f,V4u),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

tff(lameq_f3925,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
         => ! [V4u: $i] :
              ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
             => ! [V5x: tp__ty_2Erealax_2Ereal] : ap(f3925(V2s,V0f,V4u),inj__ty_2Erealax_2Ereal(V5x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5x)),V2s)),ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V5x))),V4u))) ) ) ) )).

tff(lmtp_f3926,type,(
    f3926: ( $i * $i * $i ) > $i )).

tff(lamtp_f3926,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V6u: $i] :
         ...
         => ! [V0f: $i] :
              ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
             => mem(f3926(V2s,V6u,V0f),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) ) ) )).

tff(lameq_f3926,axiom,(
    ! [V2s: $i] :
      ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V6u: $i] :
          ( mem(V6u,arr(ty_2Erealax_2Ereal,bool))
         => ! [V0f: $i] :
              ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
             => ! [V7x: tp__ty_2Erealax_2Ereal] : ap(f3926(V2s,V6u,V0f),inj__ty_2Erealax_2Ereal(V7x)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V7x)),V2s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINTER(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V7x))),V6u)),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EUPPER__HEMICONTINUOUS,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,arr(ty_2Erealax_2Ereal,bool)))
     => ! [V1t: $i] :
         ...
         => ! [V2s: $i] :
             ...
             => ( ! [V3x: tp__ty_2Erealax_2Ereal] :
                   ...
                   => p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Erealax_2Ereal),ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),V1t)) )
               => ( ! [V4u: $i] :
                      ( mem(V4u,arr(ty_2Erealax_2Ereal,bool))
                     => ( p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1t)),V4u))
                       => p(ap(ap(c_2Etopology_2Eopen__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3925(V2s,V0f,V4u)))) ) )
                <=> ! [V6u: $i] :
                      ( mem(V6u,arr(ty_2Erealax_2Ereal,bool))
                     => ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V1t)),V6u))
                       => p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),V2s)),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3926(V2s,V6u,V0f)))) ) ) ) ) ) ) ) )).
