...
tff(conj_thm_2Erelation_2EWF__NOT__REFL,lemma,(
    ! [A_27a: del,V0R: $i] :
...
tff(conj_thm_2Earithmetic_2ESUB__RIGHT__GREATER__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2p: tp__ty_2Enum_2Enum] :
...
tff(tp_c_2Ebag_2EBAG__INTER,type,(
    c_2Ebag_2EBAG__INTER: del > $i )).

tff(mem_c_2Ebag_2EBAG__INTER,axiom,(
    ! [A_27a: del] : mem(c_2Ebag_2EBAG__INTER(A_27a),arr(arr(A_27a,ty_2Enum_2Enum),arr(arr(A_27a,ty_2Enum_2Enum),arr(A_27a,ty_2Enum_2Enum)))) )).
...
tff(lamtp_f965,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
         => mem(f965(A_27a,V0b1,V1b2),arr(A_27a,ty_2Enum_2Enum)) ) ) )).

tff(lameq_f965,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f965(A_27a,V0b1,V1b2),V2x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Enum_2Enum),ap(ap(c_2Eprim__rec_2E_3C,ap(V0b1,V2x)),ap(V1b2,V2x))),ap(V0b1,V2x)),ap(V1b2,V2x)) ) ) ) )).

tff(ax_thm_2Ebag_2EBAG__INTER,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
         => ap(ap(c_2Ebag_2EBAG__INTER(A_27a),V0b1),V1b2) = f965(A_27a,V0b1,V1b2) ) ) )).
...
tff(conj_thm_2Ebag_2ESUB__BAG__ANTISYM,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ESUB__BAG__SET,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ESET__OF__BAG__EQ__EMPTY,lemma,(
    ! [A_27a: del,V0b: $i] :
      ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
tff(ax_thm_2Ebag_2EBAG__DISJOINT,axiom,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2Ebdominates__BAG__DIFF,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ! [V1x: $i] :
...
tff(conj_thm_2Ebag_2EBAG__INTER__FINITE,lemma,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2Emlt__dominates__thm2,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27a,bool)))
     => ( ( p(ap(c_2Erelation_2EWF(A_27a),V0R))
          & p(ap(c_2Erelation_2Etransitive(A_27a),V0R)) )
