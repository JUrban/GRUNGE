...
thf(conj_thm_2Elist_2EisPREFIX__CONSR,lemma,(
    ! [A_27a: del,V0x: $i] :
...
thf(conj_thm_2Epred__set_2EFINITE__BIGINTER,lemma,(
    ! [A_27a: del,V0P: $i] :
...
thf(conj_thm_2Epred__set_2EFINITE__is__measure__maximal,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Epred__set_2Eis__measure__maximal__SING,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( ( mem @ V0m @ ( arr @ A_27a @ ty_2Enum_2Enum ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
...
thf(conj_thm_2Epred__set_2Eis__measure__maximal__INSERT,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ A_27a )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Erich__list_2EIS__PREFIX__LENGTH__ANTI,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( ( mem @ V0x @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1y: $i] :
         ...
         => ( ( ( p @ ( ap @ ( ap @ ( c_2Elist_2EisPREFIX @ A_27a ) @ V0x ) @ V1y ) )
              & ( ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0x ) )
                = ( surj__ty_2Enum_2Enum @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1y ) ) ) )
          <=> ( V0x = V1y ) ) ) ) )).

thf(ax_thm_2Erich__list_2Ecommon__prefixes__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27a ) @ V0s )
          ...
          @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
            @ ^ [V1p: $i] :
                ...
                @ ( ap @ ( c_2Ebool_2E_21 @ ( ty_2Elist_2Elist @ A_27a ) )
                  @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                    @ ^ [V2m: $i] :
                        ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Elist_2Elist @ A_27a ) ) @ V2m ) @ V0s ) ) @ ( ap @ ( ap @ ( c_2Elist_2EisPREFIX @ A_27a ) @ V1p ) @ V2m ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2Ecommon__prefixes__BIGINTER,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27a ) @ V0s )
        = ( ap @ ( c_2Epred__set_2EBIGINTER @ ( ty_2Elist_2Elist @ A_27a ) )
          @ ( ap
            @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( ty_2Elist_2Elist @ A_27a ) @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
              @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                @ ^ [V1l: $i] :
                    ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) )
                    @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                      @ ^ [V2p: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) @ V2p ) @ ( ap @ ( ap @ ( c_2Elist_2EisPREFIX @ A_27a ) @ V2p ) @ V1l ) ) ) ) ) )
            @ V0s ) ) ) ) )).

thf(conj_thm_2Erich__list_2EFINITE__prefix,lemma,(
    ! [A_27a: del,V0b: $i] :
     ...
     => ( p
        @ ( ap @ ( c_2Epred__set_2EFINITE @ ( ty_2Elist_2Elist @ A_27a ) )
          @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) )
            @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
              @ ^ [V1a: $i] :
                  ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) @ V1a ) @ ( ap @ ( ap @ ( c_2Elist_2EisPREFIX @ A_27a ) @ V1a ) @ V0b ) ) ) ) ) ) ) )).

thf(ax_thm_2Erich__list_2Elongest__prefix__def,axiom,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
     => ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ V0s )
        = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) ) @ V0s ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) @ ( c_2Elist_2ENIL @ A_27a ) )
          @ ( ap @ ( c_2Emin_2E_40 @ ( ty_2Elist_2Elist @ A_27a ) )
            @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
              @ ^ [V1x: $i] :
                  ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2Eis__measure__maximal @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ELENGTH @ A_27a ) ) @ ( ap @ ( c_2Erich__list_2Ecommon__prefixes @ A_27a ) @ V0s ) ) @ V1x ) ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2Etwo__common__prefixes,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
     => ! [V1p1: $i] :
         ...
         => ! [V2p2: $i] :
             ...
             => ( ( ( V0s
                   != ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) )
...
thf(conj_thm_2Erich__list_2Ecommon__prefixes__NIL,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
...
thf(conj_thm_2Erich__list_2Elongest__prefix__NIL,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ bool ) )
     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ V0s ) )
       => ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ V0s )
...
thf(conj_thm_2Erich__list_2Elongest__prefix__PAIR,conjecture,(
    ! [A_27a: del,V0ys: $i] :
     ...
     => ! [V1xs: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( ( mem @ V3y @ A_27a )
                 => ( ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0ys ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) )
                      = ( c_2Elist_2ENIL @ A_27a ) )
                    & ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V1xs ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) )
                      = ( c_2Elist_2ENIL @ A_27a ) )
                    & ( ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ V1xs ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3y ) @ V0ys ) ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) )
                      = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Elist_2Elist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27a ) @ V2x ) @ V3y ) ) @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V2x ) @ ( ap @ ( c_2Erich__list_2Elongest__prefix @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V1xs ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( ty_2Elist_2Elist @ A_27a ) ) @ V0ys ) @ ( c_2Epred__set_2EEMPTY @ ( ty_2Elist_2Elist @ A_27a ) ) ) ) ) ) ) @ ( c_2Elist_2ENIL @ A_27a ) ) ) ) ) ) ) ) )).
