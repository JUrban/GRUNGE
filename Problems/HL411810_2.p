...
tff(lmtp_f3757,type,(
    f3757: ( del * tp__ty_2Erealax_2Ereal * $i * $i ) > $i )).

tff(lamtp_f3757,axiom,(
...
tff(lameq_f3757,axiom,(
    ! [A_27a: del,V3B: tp__ty_2Erealax_2Ereal,V1f: $i] :
     ...
     => ! [V2g: $i] :
         ...
         => ! [V4a: $i] :
              ( mem(V4a,A_27a)
             => ap(f3757(A_27a,V3B,V1f,V2g),V4a) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V2g,V4a)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1f,V4a))),inj__ty_2Erealax_2Ereal(V3B))) ) ) ) )).

tff(lmtp_f3758,type,(
    f3758: ( del * $i * $i ) > $i )).

tff(lamtp_f3758,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Ereal__topology_2ELIM__NULL__CMUL__BOUNDED,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ! [V3B: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3758(A_27a,V1f,V2g)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net)) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ESUMMABLE__EQ__EVENTUALLY,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
             ...
             => ( ( ? [V3N: tp__ty_2Enum_2Enum] :
                    ! [V4n: tp__ty_2Enum_2Enum] :
                      ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V3N)),inj__ty_2Enum_2Enum(V4n)))
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4n)),V2k)) )
                     => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V4n))) = surj__ty_2Erealax_2Ereal(ap(V1g,inj__ty_2Enum_2Enum(V4n))) )
...
tff(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET__BILINEAR,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lmtp_f4050,type,(
    f4050: ( tp__ty_2Enum_2Enum * $i ) > $i )).

tff(lamtp_f4050,axiom,(
    ! [V4m: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f4050(V4m,V0f),arr(ty_2Enum_2Enum,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).

tff(lameq_f4050,axiom,(
    ! [V4m: tp__ty_2Enum_2Enum,V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V5n: tp__ty_2Enum_2Enum] : ap(f4050(V4m,V0f),inj__ty_2Enum_2Enum(V5n)) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V4m)),inj__ty_2Enum_2Enum(V5n))),V0f)),ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V5n)),c_2Epred__set_2EUNIV(ty_2Enum_2Enum))) ) )).

tff(lmtp_f4051,type,(
    f4051: ( $i * $i ) > $i )).

tff(lamtp_f4051,axiom,(
    ! [V1g: $i] :
      ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(lameq_f4051,axiom,(
    ! [V1g: $i] :
      ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V0f: $i] :
          ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V7n: tp__ty_2Enum_2Enum] : ap(f4051(V1g,V0f),inj__ty_2Enum_2Enum(V7n)) = ap(ap(c_2Erealax_2Ereal__mul,ap(V1g,inj__ty_2Enum_2Enum(V7n))),ap(V0f,inj__ty_2Enum_2Enum(V7n))) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__DIRICHLET,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ! [V2N: tp__ty_2Enum_2Enum,V3k: tp__ty_2Enum_2Enum,V4m: tp__ty_2Enum_2Enum] :
              ( ( p(ap(c_2Ereal__topology_2Ebounded__def,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f4050(V4m,V0f))))
                & ! [V6n: tp__ty_2Enum_2Enum] :
                    ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V2N)),inj__ty_2Enum_2Enum(V6n)))
                   => p(ap(ap(c_2Ereal_2Ereal__lte,ap(V1g,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V6n)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(V1g,inj__ty_2Enum_2Enum(V6n)))) )
                & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(ty_2Enum_2Enum),V1g),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),c_2Ereal__topology_2Esequentially)) )
             => p(ap(ap(c_2Ereal__topology_2Esummable,ap(c_2Ereal__topology_2Efrom,inj__ty_2Enum_2Enum(V3k))),f4051(V1g,V0f))) ) ) ) )).
