...
tff(conj_thm_2Erich__list_2ELIST__REL__APPEND__SING,lemma,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( mem(V0R,arr(A_27a,arr(A_27b,bool)))
     => ! [V1l1: $i] :
         ...
         => ! [V2x1: $i] :
             ...
             => ! [V3l2: $i] :
                 ...
                 => ! [V4x2: $i] :
                      ( mem(V4x2,A_27b)
                     => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),ap(ap(c_2Elist_2EAPPEND(A_27a),V1l1),ap(ap(c_2Elist_2ECONS(A_27a),V2x1),c_2Elist_2ENIL(A_27a)))),ap(ap(c_2Elist_2EAPPEND(A_27b),V3l2),ap(ap(c_2Elist_2ECONS(A_27b),V4x2),c_2Elist_2ENIL(A_27b)))))
                      <=> ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0R),V1l1),V3l2))
                          & p(ap(ap(V0R,V2x1),V4x2)) ) ) ) ) ) ) ) )).

tff(conj_thm_2Erich__list_2ELIST__REL__GENLIST,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
     ...
     => ! [V1f: $i] :
         ...
         => ! [V2l: tp__ty_2Enum_2Enum,V3g: $i] :
             ...
             => ( p(ap(ap(ap(c_2Elist_2ELIST__REL(A_27a,A_27a),V0P),ap(ap(c_2Elist_2EGENLIST(A_27a),V1f),inj__ty_2Enum_2Enum(V2l))),ap(ap(c_2Elist_2EGENLIST(A_27b),V3g),inj__ty_2Enum_2Enum(V2l))))
