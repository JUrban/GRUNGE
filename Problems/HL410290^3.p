...
thf(thm_2Emeasure_2EINDICATOR__FN__MUL__INTER,conjecture,(
    ! [A_27a: $tType,V0A: A_27a > $o,V1B: A_27a > $o] :
      ( ( ^ [V2t: A_27a] :
            ( c_2Eextreal_2Eextreal__mul @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V0A @ V2t ) @ ( c_2Emeasure_2Eindicator__fn @ A_27a @ V1B @ V2t ) ) )
      = ( ^ [V3t: A_27a] :
            ( c_2Emeasure_2Eindicator__fn @ A_27a @ ( c_2Epred__set_2EINTER @ A_27a @ V0A @ V1B ) @ V3t ) ) ) )).
