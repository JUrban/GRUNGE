...
tff(mem_c_2Eposet_2Ebottom,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Ebottom(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(A_27a,bool))) )).
...
tff(mem_c_2Eposet_2Egfp,axiom,(
    ! [A_27a: del] : mem(c_2Eposet_2Egfp(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,A_27a),arr(A_27a,bool)))) )).
...
tff(conj_thm_2Eposet_2Ecomplete__bottom,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Eposet_2Eknaster__tarski__gfp,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
