...
fof(conj_thm_2EpatternMatches_2ELENGTH__STRONGEST__REDUNDANT__ROWS__INFO__AUX,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1rows] :
                 ...
                 => ! [V2p] :
                     ...
                     => ! [V3infos] :
                         ...
                         => ap(c_2Elist_2ELENGTH(bool),ap(c_2Epair_2ESND(bool,bool),ap(ap(ap(ap(c_2EpatternMatches_2ESTRONGEST__REDUNDANT__ROWS__INFO__AUX(A_27a,A_27a),V0v),V1rows),V2p),V3infos))) = ap(ap(c_2Earithmetic_2E_2B,ap(c_2Elist_2ELENGTH(arr(A_27a,ty_2Eoption_2Eoption(A_27b))),V1rows)),ap(c_2Elist_2ELENGTH(bool),V3infos)) ) ) ) ) ) ) )).
