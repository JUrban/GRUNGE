...
thf(conj_thm_2Eprobability_2ECOUNTABLY__ADDITIVE__PROB,lemma,(
    ! [A_27a: del,V0p: $i] :
...
thf(conj_thm_2Eprobability_2EPROB__SPACE__COUNTABLY__ADDITIVE,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ( ( p @ ( ap @ ( c_2Eprobability_2Eprob__space @ A_27a ) @ V0p ) )
       => ( p @ ( ap @ ( c_2Emeasure_2Ecountably__additive @ A_27a ) @ V0p ) ) ) ) )).
...
thf(conj_thm_2Eprobability_2EPROB__COUNTABLY__ADDITIVE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( ty_2Epair_2Eprod @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) )
     => ! [V1s: $i] :
