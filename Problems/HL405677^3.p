...
thf(thm_2Eordinal_2EordEXP__fromNat,conjecture,(
    ! [A_27a: $tType,V0x: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Eordinal_2EordEXP @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ V0x ) @ ( c_2Eordinal_2EfromNat @ A_27a @ V1n ) )
      = ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2EEXP @ V0x @ V1n ) ) ) )).
