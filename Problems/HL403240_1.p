...
tff(thm_2Ebag_2EBAG__DELETE__BAG__IN,conjecture,(
    ! [A_27a: d,V0b0_2E0: u,V1b_2E0: u,V2e_2E0: u] :
     ...
     => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebag_2EBAG__IN_2E2(s(A_27a,V2e_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Enum_2Enum),V0b0_2E0))))) ) )).
