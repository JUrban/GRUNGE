...
thf(thm_2Einteger_2EINT__EXP,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__of__num @ V0n ) @ V1m )
      = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2EEXP @ V0n @ V1m ) ) ) )).

thf(thm_2Einteger_2EINT__EXP__NEG,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum,V1m: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Earithmetic_2EEVEN @ V0n )
       => ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1m ) ) @ V0n )
          = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2EEXP @ V1m @ V0n ) ) ) )
      & ( ( mono_2Ec_2Earithmetic_2EODD @ V0n )
       => ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1m ) ) @ V0n )
          = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2EEXP @ V1m @ V0n ) ) ) ) ) ) )).

thf(thm_2Einteger_2EINT__EXP__CALCULATE,conjecture,(
    ! [V0p: mono_2Etyop_2Einteger_2Eint,V1n: mono_2Etyop_2Enum_2Enum,V2m: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Einteger_2Eint__exp @ V0p @ mono_2Ec_2Enum_2E0 )
        = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
      & ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1n ) @ V2m )
        = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2EEXP @ V1n @ V2m ) ) )
      & ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1n ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2m ) ) )
        = ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EEXP @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V2m ) ) ) ) ) ) )
      & ( ( mono_2Ec_2Einteger_2Eint__exp @ ( mono_2Ec_2Einteger_2Eint__neg @ ( mono_2Ec_2Einteger_2Eint__of__num @ V1n ) ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V2m ) ) )
        = ( mono_2Ec_2Einteger_2Eint__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EEXP @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V2m ) ) ) ) ) ) ) )).
