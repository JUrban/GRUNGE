...
thf(f12199_0_2E0,type,(
    f12199_0_2E0: u )).

thf(f12199_0_2E1,type,(
    f12199_0_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef12199_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12199_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ f12199_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Elebesgue_2Epsfis__zero,axiom,(
    ! [A_27a: d,V2x_2E0: u] :
      ( ( j_mono_2Etyop_2Eextreal_2Eextreal @ ( s @ tyop_2Eextreal_2Eextreal @ ( f12199_0_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) )
      = ( mono_2Ec_2Eextreal_2Eextreal__of__num @ mono_2Ec_2Enum_2E0 ) ) )).

thf(thm_2Elebesgue_2Epsfis__zero,axiom,(
    ! [A_27a: d,V0m_2E0: u,V1a: mono_2Etyop_2Eextreal_2Eextreal] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Emeasure_2Emeasure__space_2E1 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) ) ) )
     => ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Eextreal_2Eextreal @ V1a @ ( j_mono_2Etyop_2Emin_2Efun_28tyop_2Eextreal_2Eextreal_2Ctyop_2Emin_2Ebool_29 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Eextreal_2Eextreal @ tyop_2Emin_2Ebool ) @ ( c_2Elebesgue_2Epsfis_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Emin_2Ebool ) @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ tyop_2Erealax_2Ereal ) ) ) @ V0m_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Eextreal_2Eextreal ) @ f12199_0_2E0 ) ) ) ) )
      <=> ( V1a
          = ( mono_2Ec_2Eextreal_2Eextreal__of__num @ mono_2Ec_2Enum_2E0 ) ) ) ) )).
...
thf(thm_2Elebesgue_2Epsfis__sum,conjecture,(
