...
thf(f6005_0_2E0,type,(
    f6005_0_2E0: u )).

thf(f6005_0_2E1,type,(
    f6005_0_2E1: du > u )).
...
thf(c_2Econtainer_2EBAG__TO__LIST_2E0,type,(
    c_2Econtainer_2EBAG__TO__LIST_2E0: u )).

thf(c_2Econtainer_2EBAG__TO__LIST_2E1,type,(
    c_2Econtainer_2EBAG__TO__LIST_2E1: du > u )).
...
thf(arityeq1_2Emono_2Ef6005_0_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6005_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ f6005_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) ) ) )).
...
thf(arityeq1_2Emono_2Ec_2Econtainer_2EBAG__TO__LIST_2E1_2Emono_2EA_27a,axiom,(
    ! [A_27a: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Econtainer_2EBAG__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( tyop_2Elist_2Elist @ A_27a ) ) @ c_2Econtainer_2EBAG__TO__LIST_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ X0_2E0 ) ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INSERT__CHOICE__REST,axiom,(
    ! [A_27a: d,V0b_2E0: u] :
     ...
     => ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__INSERT_2E2 @ ( s @ A_27a @ ( c_2Ebag_2EBAG__CHOICE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__REST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) ) ) ) ) )).
...
thf(def0_2Ethm_2Econtainer_2EBAG__TO__LIST__THM,axiom,(
    ! [A_27a: d,V0bag_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6005_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) ) )
    <=> ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 )
        = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) ) ) )).

thf(thm_2Econtainer_2EBAG__TO__LIST__THM,axiom,(
    ! [A_27a: d,V0bag_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EFINITE__BAG_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) ) )
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Econtainer_2EBAG__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f6005_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ c_2Elist_2ENIL_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2ECONS_2E2 @ ( s @ A_27a @ ( c_2Ebag_2EBAG__CHOICE_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Econtainer_2EBAG__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__REST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0bag_2E0 ) ) ) ) ) ) ) ) ) ) ) )).

thf(thm_2Econtainer_2EBAG__TO__LIST__IND,axiom,(
    ! [A_27a: d,V0P_2E0: u] :
      ( ! [V1bag_2E0: u] :
          ( ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebag_2EFINITE__BAG_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1bag_2E0 ) ) ) )
              & ( (~)
                @ ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1bag_2E0 )
                  = ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ c_2Ebag_2EEMPTY__BAG_2E0 ) ) ) )
           => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ ( c_2Ebag_2EBAG__REST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1bag_2E0 ) ) ) ) ) ) )
         => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V1bag_2E0 ) ) ) ) )
     => ! [V2v_2E0: u] :
          ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ tyop_2Emin_2Ebool ) @ V0P_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V2v_2E0 ) ) ) ) ) )).
...
thf(thm_2Econtainer_2EBAG__IN__MEM,conjecture,(
    ! [A_27a: d,V0b_2E0: u] :
     ...
     => ! [V1x_2E0: u] :
          ...
          = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Econtainer_2EBAG__TO__LIST_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Enum_2Enum ) @ V0b_2E0 ) ) ) ) ) ) ) ) ) ) )).
