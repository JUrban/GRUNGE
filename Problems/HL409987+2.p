...
fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__POS__MEM__LE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
                  & ! [V2x] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s))
                       => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V0f,V2x))) ) ) )
               => ! [V3x] :
                    ( mem(V3x,A_27a)
                   => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V1s))
                     => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(V0f,V3x)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V0f),V1s))) ) ) ) ) ) ) )).

fof(conj_thm_2Eextreal_2Esup__lt__infty,lemma,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ( p(ap(ap(c_2Eextreal_2Eextreal__lt,ap(c_2Eextreal_2Eextreal__sup,V0p)),c_2Eextreal_2EPosInf))
       => ! [V1x] :
            ( mem(V1x,ty_2Eextreal_2Eextreal)
           => ( p(ap(V0p,V1x))
             => p(ap(ap(c_2Eextreal_2Eextreal__lt,V1x),c_2Eextreal_2EPosInf)) ) ) ) ) )).
...
fof(conj_thm_2Eextreal_2Eext__suminf__lt__infty,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Eextreal_2Eextreal))
     => ( ( ! [V1n] :
              ( mem(V1n,ty_2Enum_2Enum)
             => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(c_2Eextreal_2Eextreal__of__num,c_2Enum_2E0)),ap(V0f,V1n))) )
          & ap(c_2Eextreal_2Eext__suminf,V0f) != c_2Eextreal_2EPosInf )
       => ! [V2n] :
            ( mem(V2n,ty_2Enum_2Enum)
           => p(ap(ap(c_2Eextreal_2Eextreal__lt,ap(V0f,V2n)),c_2Eextreal_2EPosInf)) ) ) ) )).
