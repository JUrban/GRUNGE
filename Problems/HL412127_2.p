...
tff(conj_thm_2Eprobability_2EEVENTS,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Eprobability_2EPROB,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,arr(A_27a,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(arr(A_27a,bool),bool))
...
tff(conj_thm_2Eprobability_2Eprob__x__eq__1__imp__prob__y__eq__0,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Eprobability_2Edistribution__x__eq__1__imp__distribution__y__eq__0,conjecture,(
    ! [A_27a: del,A_27b: del,V0X: $i] :
      ( mem(V0X,arr(A_27a,A_27b))
     => ! [V1p: $i] :
          ( mem(V1p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
         => ! [V2x: $i] :
             ...
             => ( ( p(ap(ap(ap(c_2Eprobability_2Erandom__variable(A_27a,A_27a),V0X),V1p),ap(ap(c_2Epair_2E_2C(arr(A_27b,bool),arr(A_27b,bool)),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0X),ap(c_2Eprobability_2Ep__space(A_27a),V1p))),ap(c_2Epred__set_2EPOW(A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0X),ap(c_2Eprobability_2Ep__space(A_27a),V1p))))))
                  & surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),ap(ap(c_2Epred__set_2EINSERT(A_27b),V2x),c_2Epred__set_2EEMPTY(A_27b)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) )
               => ! [V3y: $i] :
                    ( mem(V3y,A_27b)
                   => ( V3y != V2x
                     => surj__ty_2Erealax_2Ereal(ap(ap(ap(c_2Eprobability_2Edistribution(A_27b,A_27b),V1p),V0X),ap(ap(c_2Epred__set_2EINSERT(A_27b),V3y),c_2Epred__set_2EEMPTY(A_27b)))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) ) ) ) ) ) )).
