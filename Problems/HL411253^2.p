...
thf(conj_thm_2Ereal__topology_2ESUBSET__INTERIOR__EQ,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EOPEN__MAP__INTERIORS,conjecture,(
    ! [V0f: $i] :
     ...
     => ( ! [V1s: $i] :
      ...
      <=> ! [V2s: $i] :
           ...
           => ( p @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ ( ap @ c_2Ereal__topology_2Einterior @ V2s ) ) ) @ ( ap @ c_2Ereal__topology_2Einterior @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) @ V0f ) @ V2s ) ) ) ) ) ) ) )).
