...
thf(thm_2Ebag_2EBAG__GEN__PROD__EMPTY,axiom,(
    ! [V0n: tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__GEN__PROD @ ( c_2Ebag_2EEMPTY__BAG @ tyop_2Enum_2Enum ) @ V0n )
      = V0n ) )).
...
thf(thm_2Ebag_2EBAG__GEN__PROD__UNION__LEM,conjecture,(
    ! [V0b1: tyop_2Enum_2Enum > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EFINITE__BAG @ tyop_2Enum_2Enum @ V0b1 )
     => ! [V1b2: tyop_2Enum_2Enum > tyop_2Enum_2Enum,V2a: tyop_2Enum_2Enum,V3b: tyop_2Enum_2Enum] :
          ( ( c_2Ebag_2EFINITE__BAG @ tyop_2Enum_2Enum @ V1b2 )
         => ( ( c_2Ebag_2EBAG__GEN__PROD @ ( c_2Ebag_2EBAG__UNION @ tyop_2Enum_2Enum @ V0b1 @ V1b2 ) @ ( c_2Earithmetic_2E_2A @ V2a @ V3b ) )
            = ( c_2Earithmetic_2E_2A @ ( c_2Ebag_2EBAG__GEN__PROD @ V0b1 @ V2a ) @ ( c_2Ebag_2EBAG__GEN__PROD @ V1b2 @ V3b ) ) ) ) ) )).
