...
thf(thm_2Ebinary__ieee_2Edatatype__flags,conjecture,(
    ! [V0record: mono_2Etyop_2Ebinary__ieee_2Eflags > $o > $o > $o > $o > $o > $o > $o,V1flags: mono_2Etyop_2Ebinary__ieee_2Eflags,V2Underflow__BeforeRounding: $o,V3Underflow__AfterRounding: $o,V4Precision: $o,V5Overflow: $o,V6InvalidOp: $o,V7DivideByZero: $o] :
      ( mono_2Ec_2Ebool_2EDATATYPE_2Emono_2Etyop_2Emin_2Ebool @ ( V0record @ V1flags @ V7DivideByZero @ V6InvalidOp @ V5Overflow @ V4Precision @ V2Underflow__BeforeRounding @ V3Underflow__AfterRounding ) ) )).
