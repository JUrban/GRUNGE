...
tff(conj_thm_2Ereal_2EREAL__INV__EQ__0,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
    <=> V0x = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__OF__NUM__EQ,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Ereal__topology_2EREAL__ARCH__INV,lemma,(
...
tff(conj_thm_2Ereal__topology_2ECLOSURE__MINIMAL,lemma,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIM__SEQUENTIALLY,lemma,(
    ! [V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL,lemma,(
...
tff(lamtp_f3744,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3744(A_27a,V1f,V2g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3744,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V5x: $i] :
              ( mem(V5x,A_27a)
             => ap(f3744(A_27a,V1f,V2g),V5x) = ap(ap(c_2Erealax_2Ereal__add,ap(V1f,V5x)),ap(V2g,V5x)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__ADD,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
             ...
             => ! [V3l: tp__ty_2Erealax_2Ereal,V4m: tp__ty_2Erealax_2Ereal] :
                 ...
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3744(A_27a,V1f,V2g)),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V3l)),inj__ty_2Erealax_2Ereal(V4m))),V0net)) ) ) ) ) )).

tff(lmtp_f3940,type,(
    f3940: ( del * $i * $i ) > $i )).

tff(lamtp_f3940,axiom,(
    ! [A_27a: del,V3c: $i] :
...
tff(conj_thm_2Ereal__topology_2ELIM__MUL,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2l: tp__ty_2Erealax_2Ereal,V3c: $i] :
              ( mem(V3c,arr(A_27a,ty_2Erealax_2Ereal))
             => ! [V4d: tp__ty_2Erealax_2Ereal] :
                  ( ( p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V3c),inj__ty_2Erealax_2Ereal(V4d)),V0net))
                    & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),V1f),inj__ty_2Erealax_2Ereal(V2l)),V0net)) )
                 => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3940(A_27a,V3c,V1f)),ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V4d)),inj__ty_2Erealax_2Ereal(V2l))),V0net)) ) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECLOSED__INTERVAL,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2EClosed,ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))))) )).

tff(conj_thm_2Ereal__topology_2EOPEN__INTERVAL__MIDPOINT,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
     ...
     => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Einv,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))),ap(ap(c_2Erealax_2Ereal__add,inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b)))),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))))) ) )).

tff(conj_thm_2Ereal__topology_2EOPEN__CLOSED__INTERVAL__CONVEX,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal,V2x: tp__ty_2Erealax_2Ereal,V3y: tp__ty_2Erealax_2Ereal,V4e: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b)))))
        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V3y)),ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))))))
        ...
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V4e)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) )
     => p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V4e)),inj__ty_2Erealax_2Ereal(V2x))),ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V4e))),inj__ty_2Erealax_2Ereal(V3y)))),ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))))) ) )).

tff(conj_thm_2Ereal__topology_2EREAL__LE__INV2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
        & p(ap(ap(c_2Ereal_2Ereal__lte,inj__ty_2Erealax_2Ereal(V0x)),inj__ty_2Erealax_2Ereal(V1y))) )
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V1y))),ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x)))) ) )).

tff(conj_thm_2Ereal__topology_2EREAL__INV__LE__1,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Erealax_2Ereal(V0x)))
     => p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x))),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) ) )).

tff(conj_thm_2Ereal__topology_2ECLOSURE__OPEN__INTERVAL,conjecture,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
      ( ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))) != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
     => ap(c_2Ereal__topology_2Eclosure,ap(c_2Ereal__topology_2EOPEN__interval,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b)))) = ap(c_2Ereal__topology_2ECLOSED__interval,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)),ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V0a)),inj__ty_2Erealax_2Ereal(V1b))),c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)))) ) )).
