...
thf(conj_thm_2Ereal__topology_2EMONOTONE__BIGGER,lemma,(
    ! [V0r: $i] :
     ...
     => ( ! [V1m: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
       ...
       => ! [V3n: tp__ty_2Enum_2Enum] :
            ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V3n ) ) @ ( ap @ V0r @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELIM__SUBSEQUENCE,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1r: $i] :
