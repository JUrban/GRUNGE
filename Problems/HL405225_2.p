...
tff(conj_thm_2EEncode_2Ebiprefix__refl,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,ty_2Elist_2Elist(A_27a))
     => p(ap(ap(c_2EEncode_2Ebiprefix(A_27a),V0x),V0x)) ) )).

tff(conj_thm_2EEncode_2Ebiprefix__append,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2EEncode_2Ewf__encoder__alt,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
...
tff(conj_thm_2EEncode_2Ewf__encoder__eq,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
...
tff(conj_thm_2EDecode_2Eenc2dec__some__alt,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
...
tff(conj_thm_2ECoder_2Ewf__coder__op,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,arr(A_27a,bool))
     => ! [V1e: $i] :
          ( mem(V1e,arr(A_27a,ty_2Elist_2Elist(bool)))
