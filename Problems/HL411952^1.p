...
thf(thm_2Ereal__topology_2EHOMEOMORPHIC__LOCALLY,axiom,(
    ! [V0P: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o,V1Q: ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o] :
      ( ! [V2s: mono_2Etyop_2Erealax_2Ereal > $o,V3t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V2s @ V3t )
         => ( ( V0P @ V2s )
            = ( V1Q @ V3t ) ) )
     => ! [V4s: mono_2Etyop_2Erealax_2Ereal > $o,V5t: mono_2Etyop_2Erealax_2Ereal > $o] :
          ( ( mono_2Ec_2Ereal__topology_2Ehomeomorphic @ V4s @ V5t )
         => ( ( mono_2Ec_2Ereal__topology_2Elocally @ V0P @ V4s )
            = ( mono_2Ec_2Ereal__topology_2Elocally @ V1Q @ V5t ) ) ) ) )).
