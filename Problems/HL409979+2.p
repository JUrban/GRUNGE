...
fof(lamtp_f3469,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => mem(f3469(V0x),arr(ty_2Eextreal_2Eextreal,bool)) ) )).

fof(lameq_f3469,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ! [V1y] :
          ( mem(V1y,ty_2Eextreal_2Eextreal)
         => ap(f3469(V0x),V1y) = ap(ap(c_2Emin_2E_3D(ty_2Eextreal_2Eextreal),V1y),V0x) ) ) )).
...
fof(conj_thm_2Eextreal_2Einf__const,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Eextreal_2Eextreal)
     => ap(c_2Eextreal_2Eextreal__inf,f3469(V0x)) = V0x ) )).
