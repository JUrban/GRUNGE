...
thf(thm_2Eordinal_2EordSUC__NUMERAL,axiom,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eordinal_2EordSUC @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ V0n ) ) )
      = ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2ENUMERAL @ V0n ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) )).
...
thf(thm_2Eordinal_2EordMULT__2R,conjecture,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2EordMULT @ A_27a @ V0a @ ( c_2Eordinal_2EfromNat @ A_27a @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) )
      = ( c_2Eordinal_2EordADD @ A_27a @ V0a @ V0a ) ) )).
