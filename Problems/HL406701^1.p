...
thf(c_2Eint__arith_2Ebmarker_2E0,type,(
    c_2Eint__arith_2Ebmarker_2E0: u )).

thf(c_2Eint__arith_2Ebmarker_2E1,type,(
...
thf(mono_2Ec_2Eint__arith_2Ebmarker,type,(
    mono_2Ec_2Eint__arith_2Ebmarker: $o > $o )).
...
thf(thm_2Eint__arith_2Ebmarker__def,axiom,(
    ! [V0b: $o] :
      ( ( mono_2Ec_2Eint__arith_2Ebmarker @ V0b )
      = V0b ) )).
...
thf(thm_2Eint__arith_2Ebmarker__rewrites,conjecture,(
    ! [V0p: $o,V1q: $o,V2r: $o] :
      ( ( ( V1q
          & ( mono_2Ec_2Eint__arith_2Ebmarker @ V0p ) )
      <=> ( ( mono_2Ec_2Eint__arith_2Ebmarker @ V0p )
          & V1q ) )
      & ( ( V1q
          & ( mono_2Ec_2Eint__arith_2Ebmarker @ V0p )
