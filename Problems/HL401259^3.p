...
thf(thm_2Ebit_2EEXP__SUB__LESS__EQ,axiom,(
    ! [V0a: tyop_2Enum_2Enum,V1b: tyop_2Enum_2Enum] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Earithmetic_2E_2D @ V0a @ V1b ) ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ V0a ) ) )).
...
thf(thm_2Ebit_2EBITSLT__THM2,conjecture,(
    ! [V0h: tyop_2Enum_2Enum,V1l: tyop_2Enum_2Enum,V2n: tyop_2Enum_2Enum] :
      ( c_2Eprim__rec_2E_3C @ ( c_2Ebit_2EBITS @ V0h @ V1l @ V2n ) @ ( c_2Earithmetic_2EEXP @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) @ ( c_2Enum_2ESUC @ V0h ) ) ) )).
