...
fof(conj_thm_2Ecardinal_2ESURJECTIVE__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ( ! [V1t] :
                   ...
                   => ? [V2s] :
                        ...
                        & ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V2s) = V1t ) )
              <=> ! [V3y] :
                    ( mem(V3y,A_27b)
                   => ? [V4x] :
                        ( mem(V4x,A_27a)
...
fof(conj_thm_2Ereal__topology_2EOPEN__SURJECTIVE__LINEAR__IMAGE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2EOPEN__BIJECTIVE__LINEAR__IMAGE__EQ,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
              ...
              & ! [V4y] :
                 ...
                 => ? [V5x] :
                      ...
                      & ap(V0f,V5x) = V4y ) ) )
           => ( p(ap(c_2Ereal__topology_2EOpen,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)))
            <=> p(ap(c_2Ereal__topology_2EOpen,V1s)) ) ) ) ) )).

fof(conj_thm_2Ereal__topology_2EINTERIOR__BIJECTIVE__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
              ...
              & ! [V4y] :
                 ...
                 => ? [V5x] :
                      ( mem(V5x,ty_2Erealax_2Ereal)
                      & ap(V0f,V5x) = V4y ) ) )
           => ap(c_2Ereal__topology_2Einterior,ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V1s)) = ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Einterior,V1s)) ) ) ) )).
