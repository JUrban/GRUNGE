...
fof(conj_thm_2Ereal__topology_2EEVENTUALLY__HAPPENS,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
...
fof(conj_thm_2Ereal__topology_2EABS__TRIANGLE__LE,lemma,(
    ! [V0e] :
             ...
             => ! [V2g] :
                 ...
                 => ! [V3s] :
                     ...
                     => ! [V7x] :
                         ...
                         => ap(f3938(A_27a,V5e,V6n,V1f,V2g,V3s),V7x) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V7x),V3s)),ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(ap(V1f,V6n),V7x)),ap(V2g,V7x)))),V5e)) ) ) ) ) ) ) )).

fof(lamtp_f3937,axiom,(
    ! [A_27a,V3s] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2g] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V1f] :
             ...
             => ! [V5e] :
                  ( mem(V5e,ty_2Erealax_2Ereal)
                 => mem(f3937(A_27a,V3s,V2g,V1f,V5e),arr(A_27a,bool)) ) ) ) ) )).

fof(lameq_f3937,axiom,(
    ! [A_27a,V3s] :
      ( mem(V3s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V2g] :
          ( mem(V2g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__UNIFORM__LIMIT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
