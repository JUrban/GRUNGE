...
tff(lamtp_f2872,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => mem(f2872(V0f),arr(ty_2Erealax_2Ereal,bool)) ) )).

tff(lameq_f2872,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal] : ap(f2872(V0f),inj__ty_2Erealax_2Ereal(V1l)) = ap(ap(c_2Eseq_2E_2D_2D_3E,V0f),inj__ty_2Erealax_2Ereal(V1l)) ) )).

tff(ax_thm_2Eseq_2Elim,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => surj__ty_2Erealax_2Ereal(ap(c_2Eseq_2Elim,V0f)) = surj__ty_2Erealax_2Ereal(ap(c_2Emin_2E_40(ty_2Erealax_2Ereal),f2872(V0f))) ) )).

tff(conj_thm_2Eseq_2ESEQ__LIM,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ( p(ap(c_2Eseq_2Econvergent,V0f))
