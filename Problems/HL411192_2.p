...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONTINUOUS__ON__ID,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => p(ap(ap(c_2Ereal__topology_2Euniformly__continuous__on,i(ty_2Erealax_2Ereal)),V0s)) ) )).
