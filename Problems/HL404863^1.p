...
thf(thm_2EternaryComparisons_2Eordering__BIJ,axiom,
    ( ! [V0a: mono_2Etyop_2EternaryComparisons_2Eordering] :
        ( ( mono_2Ec_2EternaryComparisons_2Enum2ordering @ ( mono_2Ec_2EternaryComparisons_2Eordering2num @ V0a ) )
        = V0a )
    & ! [V1r: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1r @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
      <=> ( ( mono_2Ec_2EternaryComparisons_2Eordering2num @ ( mono_2Ec_2EternaryComparisons_2Enum2ordering @ V1r ) )
          = V1r ) ) )).

thf(thm_2EternaryComparisons_2Enum2ordering__11,conjecture,(
    ! [V0r: mono_2Etyop_2Enum_2Enum,V1r_27: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0r @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
     => ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1r_27 @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
       => ( ( ( mono_2Ec_2EternaryComparisons_2Enum2ordering @ V0r )
            = ( mono_2Ec_2EternaryComparisons_2Enum2ordering @ V1r_27 ) )
        <=> ( V0r = V1r_27 ) ) ) ) )).
