...
tff(conj_thm_2Eextreal_2Eadd__rdistrib,lemma,(
    ! [V0x: tp__ty_2Eextreal_2Eextreal,V1y: tp__ty_2Eextreal_2Eextreal,V2z: tp__ty_2Eextreal_2Eextreal] :
     ...
     => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__mul,ap(ap(c_2Eextreal_2Eextreal__add,inj__ty_2Eextreal_2Eextreal(V1y)),inj__ty_2Eextreal_2Eextreal(V2z))),inj__ty_2Eextreal_2Eextreal(V0x))) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V1y)),inj__ty_2Eextreal_2Eextreal(V0x))),ap(ap(c_2Eextreal_2Eextreal__mul,inj__ty_2Eextreal_2Eextreal(V2z)),inj__ty_2Eextreal_2Eextreal(V0x)))) ) )).

tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__EQ,lemma,(
    ! [A_27a: del,V0s: $i] :
           ...
           => ! [V2f_27: $i] :
               ...
               => ( ! [V3x: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s))
                       => surj__ty_2Eextreal_2Eextreal(ap(V1f,V3x)) = surj__ty_2Eextreal_2Eextreal(ap(V2f_27,V3x)) ) )
                 => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f_27),V0s)) ) ) ) ) ) )).

tff(lmtp_f3455,type,(
    f3455: ( del * $i * $i ) > $i )).

tff(lamtp_f3455,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2f_27: $i] :
          ( mem(V2f_27,arr(A_27a,ty_2Eextreal_2Eextreal))
...
tff(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__ADD,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
       => ! [V1f: $i] :
           ...
           => ! [V2f_27: $i] :
                ( mem(V2f_27,arr(A_27a,ty_2Eextreal_2Eextreal))
               => surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3455(A_27a,V1f,V2f_27)),V0s)) = surj__ty_2Eextreal_2Eextreal(ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f_27),V0s))) ) ) ) ) )).
...
tff(conj_thm_2Elebesgue_2Epos__simple__fn__add__alt,conjecture,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
