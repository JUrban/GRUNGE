                        ...
                        @ ^ [V3x: $i] :
                            ...
                            @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ A_27a @ bool ) ) @ V2t )
                              @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                @ ( lam @ A_27a
                                  @ ^ [V4y: $i] :
                                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V4y ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V4y ) @ V1s ) ) @ ( ap @ ( ap @ V0R @ V3x ) @ V4y ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2Epartition__elements__disjoint,conjecture,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
