...
tff(ax_thm_2Ebinary__ieee_2Efloat__abs__def,axiom,(
    ! [A_27t: del,A_27w: del,V0x: $i] :
      ( mem(V0x,ty_2Ebinary__ieee_2Efloat(A_27t,A_27t))
     => ap(c_2Ebinary__ieee_2Efloat__abs(A_27t,A_27t),V0x) = ap(ap(c_2Ebinary__ieee_2Efloat__Sign__fupd(A_27t,A_27t),ap(c_2Ecombin_2EK(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),ap(c_2Ewords_2En2w(ty_2Eone_2Eone),inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))),V0x) ) )).
...
tff(conj_thm_2Ebinary__ieee_2Efloat__infinity__negate__abs,conjecture,(
    ! [A_27t: del,A_27w: del] :
