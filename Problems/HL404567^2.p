...
thf(conj_thm_2Ecardinal_2ECARD__LE__LT,lemma,(
...
thf(conj_thm_2Ecardinal_2ECOUNTABLE__ALT__cardleq,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ecardinal_2ECOUNTABLE__CASES,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2Ecountable @ A_27a ) @ V0s ) )
      <=> ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
