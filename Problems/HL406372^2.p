...
thf(conj_thm_2Etoto_2EStrongLinearOrder__of__TO__TO__of__LinearOrder,lemma,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Erelation_2Eirreflexive @ A_27a ) @ V0R ) )
       => ( ( ap @ ( c_2Etoto_2EStrongLinearOrder__of__TO @ A_27a ) @ ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ A_27a ) @ V0R ) )
          = V0R ) ) ) )).

thf(conj_thm_2Etoto_2ETO__of__LinearOrder__LEX,conjecture,(
    ! [A_27a: del,A_27b: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1V: $i] :
         ...
         => ( ( ( p @ ( ap @ ( c_2Erelation_2Eirreflexive @ A_27a ) @ V0R ) )
           ...
           => ( ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2ELEX @ A_27a @ A_27b ) @ V0R ) @ V1V ) )
              = ( ap @ ( ap @ ( c_2Etoto_2ElexTO @ A_27a @ A_27b ) @ ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ A_27a ) @ V0R ) ) @ ( ap @ ( c_2Etoto_2ETO__of__LinearOrder @ A_27b ) @ V1V ) ) ) ) ) ) )).
