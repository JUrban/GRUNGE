...
tff(conj_thm_2Estring_2EORD__ONTO,lemma,(
    ...
    <=> ? [V1a: tp__ty_2Estring_2Echar] : V0r = surj__ty_2Enum_2Enum(ap(c_2Estring_2EORD,inj__ty_2Estring_2Echar(V1a))) ) )).

tff(conj_thm_2Estring_2EORD__BOUND,conjecture,(
