...
thf(conj_thm_2Enets_2ENET__CONV__BOUNDED,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ ( arr @ A_27a @ ty_2Erealax_2Ereal ) )
...
thf(conj_thm_2Enets_2ENET__NULL__MUL,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Enets_2Edorder @ A_27a ) @ V0g ) )
       => ! [V1x: $i] :
                    ...
                    @ ( ap
                      @ ( ap
                        @ ( ap @ ( c_2Enets_2Etends @ ty_2Erealax_2Ereal @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V3n: $i] :
                                ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1x @ V3n ) ) @ ( ap @ V2y @ V3n ) ) ) )
                        @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                      @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Etopology_2Etopology @ ty_2Erealax_2Ereal ) @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) ) @ ( ap @ ( c_2Emetric_2Emtop @ ty_2Erealax_2Ereal ) @ c_2Emetric_2Emr1 ) ) @ V0g ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Enets_2ENET__NULL__CMUL,lemma,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
...
thf(conj_thm_2Enets_2ENET__MUL,conjecture,(
    ! [A_27a: del,V0g: $i] :
      ( ( mem @ V0g @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ( ( p @ ( ap @ ( c_2Enets_2Edorder @ A_27a ) @ V0g ) )
       => ! [V1x: $i] :
                      ...
                      @ ( ap
                        @ ( ap
                          @ ( ap @ ( c_2Enets_2Etends @ ty_2Erealax_2Ereal @ A_27a )
                            @ ( lam @ A_27a
                              @ ^ [V5n: $i] :
                                  ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( ap @ V1x @ V5n ) ) @ ( ap @ V2y @ V5n ) ) ) )
