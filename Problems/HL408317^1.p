...
thf(f9459_0_2E0,type,(
    f9459_0_2E0: u )).

thf(f9459_0_2E1,type,(
    f9459_0_2E1: du > u )).

thf(f9459_0_2E2,type,(
    f9459_0_2E2: du > du > u )).

thf(f9800_0_2E0,type,(
    f9800_0_2E0: u )).

thf(f9800_0_2E1,type,(
    f9800_0_2E1: du > u )).

thf(f9800_0_2E2,type,(
    f9800_0_2E2: du > du > u )).
...
thf(c_2Etransc_2Ecos_2E0,type,(
    c_2Etransc_2Ecos_2E0: u )).

thf(c_2Etransc_2Ecos_2E1,type,(
...
thf(mono_2Ef9459_0,type,(
    mono_2Ef9459_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9800_0,type,(
    mono_2Ef9800_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(mono_2Ec_2Etransc_2Ecos,type,(
    mono_2Ec_2Etransc_2Ecos: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Earithmetic_2EFACT__LESS,axiom,(
    ! [V0n: mono_2Etyop_2Enum_2Enum] :
      ( mono_2Ec_2Eprim__rec_2E_3C @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2EFACT @ V0n ) ) )).
...
thf(thm_2Enumeral_2Enumeral__fact,axiom,
    ( ( ( mono_2Ec_2Earithmetic_2EFACT @ mono_2Ec_2Enum_2E0 )
      = ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) )
    & ! [V0n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) ) )
        = ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) ) @ ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Eprim__rec_2EPRE @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V0n ) ) ) ) ) )
    & ! [V1n: mono_2Etyop_2Enum_2Enum] :
        ( ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V1n ) ) )
        = ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ V1n ) ) @ ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ V1n ) ) ) ) ) )).
    ...
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eseq_2Esummable @ V0f )
        & ! [V2d: mono_2Etyop_2Enum_2Enum] :
            ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( mono_2Ec_2Erealax_2Ereal__add @ ( V0f @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V2d ) ) ) @ ( V0f @ ( mono_2Ec_2Earithmetic_2E_2B @ V1n @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V2d ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) )
     => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ mono_2Ec_2Enum_2E0 @ V1n ) @ V0f ) @ ( mono_2Ec_2Eseq_2Esuminf @ V0f ) ) ) )).

thf(def0_2Ethm_2Eseq_2ESER__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V2n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9459_0 @ V0x @ V2n )
...
thf(thm_2Eseq_2ESER__NEG,axiom,(
    ! [V0x: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1x0: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Esums @ V0x @ V1x0 )
     => ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9459_0 @ V0x ) @ ( mono_2Ec_2Erealax_2Ereal__neg @ V1x0 ) ) ) )).

thf(def0_2Ethm_2Etransc_2ECOS__PAIRED,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9800_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ V1n ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) ) ) ) )).

thf(thm_2Etransc_2ECOS__PAIRED,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9800_0 @ V0x ) @ ( mono_2Ec_2Etransc_2Ecos @ V0x ) ) )).

thf(thm_2Etransc_2ECOS__2,conjecture,(
    mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Etransc_2Ecos @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )).
