...
thf(thm_2Esorting_2EPERM__alt,axiom,(
    ...
    <=> ! [V2x_2E0: u] :
          ( ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFILTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Emin_2E_3D_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0L1_2E0 ) ) ) ) ) )
          = ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EFILTER_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Emin_2E_3D_2E1 @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1L2_2E0 ) ) ) ) ) ) ) ) )).
...
thf(thm_2Esorting_2EPERM__FUN__APPEND__APPEND__1,conjecture,(
    ! [A_27a: d,V0l1_2E0: u,V1l2_2E0: u,V2l3_2E0: u,V3l4_2E0: u] :
      ( ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Esorting_2EPERM_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Esorting_2EPERM_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l3_2E0 ) ) ) ) ) )
     => ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Esorting_2EPERM_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V0l1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l4_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Esorting_2EPERM_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1l2_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EAPPEND_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V2l3_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V3l4_2E0 ) ) ) ) ) ) ) ) ) )).
