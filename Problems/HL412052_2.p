...
tff(conj_thm_2Elebesgue_2Emax__fn__seq__mono,conjecture,(
    ! [A_27a: del,V0g: $i] :
      ( mem(V0g,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Eextreal_2Eextreal)))
     => ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
          ( mem(V2x,A_27a)
         => p(ap(ap(c_2Eextreal_2Eextreal__le,ap(ap(ap(c_2Elebesgue_2Emax__fn__seq(A_27a),V0g),inj__ty_2Enum_2Enum(V1n)),V2x)),ap(ap(ap(c_2Elebesgue_2Emax__fn__seq(A_27a),V0g),ap(c_2Enum_2ESUC,inj__ty_2Enum_2Enum(V1n))),V2x))) ) ) )).
