...
thf(conj_thm_2Ereal__topology_2ECONNECTED__BIGUNION,lemma,(
    ! [V0P: $i] :
     ...
     => ( ( ! [V1s: $i] :
          ...
          & ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V0P )
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__COMPONENT__BIGUNION,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1x: tp__ty_2Erealax_2Ereal] :
