...
fof(conj_thm_2Ereal__topology_2ECLOSEST__POINT__EXISTS,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ESETDIST__CLOSEST__POINT,conjecture,(
    ! [V0a] :
     ...
     => ! [V1s] :
         ...
         => ( ( p(ap(c_2Ereal__topology_2EClosed,V1s))
           ...
           => ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),ap(ap(c_2Epred__set_2EINSERT(ty_2Erealax_2Ereal),V0a),c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal))),V1s)) = ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0a),ap(ap(c_2Ereal__topology_2Eclosest__point,V1s),V0a))) ) ) ) )).
