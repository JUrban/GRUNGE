...
thf(thm_2Eiterate_2ENUMSEG__REC,axiom,(
    ! [V0m: tyop_2Enum_2Enum,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Earithmetic_2E_3C_3D @ V0m @ ( c_2Enum_2ESUC @ V1n ) )
     => ( ( c_2Eiterate_2E_2E_2E @ V0m @ ( c_2Enum_2ESUC @ V1n ) )
        = ( c_2Epred__set_2EINSERT @ tyop_2Enum_2Enum @ ( c_2Enum_2ESUC @ V1n ) @ ( c_2Eiterate_2E_2E_2E @ V0m @ V1n ) ) ) ) )).
...
thf(thm_2Eiterate_2ECARD__NUMSEG__LEMMA,conjecture,(
    ! [V0m: tyop_2Enum_2Enum,V1d: tyop_2Enum_2Enum] :
      ( ( c_2Epred__set_2ECARD @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ V0m @ ( c_2Earithmetic_2E_2B @ V0m @ V1d ) ) )
      = ( c_2Earithmetic_2E_2B @ V1d @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) )).
