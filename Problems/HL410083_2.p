...
tff(lamtp_f3515,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3515(A_27a,V0f),arr(A_27a,ty_2Erealax_2Ereal)) ) )).
...
tff(lameq_f3515,axiom,(
    ! [A_27a: del,V0f: $i] :
     ...
     => ! [V2x: $i] :
          ( mem(V2x,A_27a)
         => ap(f3515(A_27a,V0f),V2x) = ap(c_2Erealax_2Einv,ap(V0f,V2x)) ) ) )).

tff(conj_thm_2Eproduct_2EPRODUCT__INV,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( p(ap(c_2Epred__set_2EFINITE(A_27a),V1s))
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),f3515(A_27a,V0f))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Einv,ap(ap(c_2Eproduct_2Eproduct(A_27a),V1s),V0f))) ) ) ) )).
