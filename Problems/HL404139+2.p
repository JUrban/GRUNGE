...
fof(conj_thm_2Epath_2Enth__label__def__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0p] :
            ...
            & ! [V1n] :
               ...
               => ! [V2p] :
                    ( mem(V2p,ty_2Epath_2Epath(A_27b,A_27b))
                   => ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),V2p) = ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Epath_2Etail(A_27b,A_27b),V2p)) ) )
            & ! [V3n] :
                ( mem(V3n,ty_2Enum_2Enum)
               => ! [V4p] :
                    ( mem(V4p,ty_2Epath_2Epath(A_27b,A_27b))
                   => ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V3n))),V4p) = ap(ap(c_2Epath_2Enth__label(A_27a,A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V3n))),ap(c_2Epath_2Etail(A_27b,A_27b),V4p)) ) ) ) ) ) )).
