...
tff(conj_thm_2Etransc_2ESIN__BOUNDS,lemma,(
...
tff(conj_thm_2Etransc_2ESIN__ASN,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
     ...
     => surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Easn,ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x)))) = V0x ) )).
