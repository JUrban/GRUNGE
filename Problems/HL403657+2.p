...
fof(conj_thm_2Elist_2EEVERY__SIMP,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
          ( mem(V0c,bool)
...
fof(conj_thm_2Esorting_2EPERM__SPLIT__IF,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
...
fof(conj_thm_2Esorting_2EPERM__SPLIT,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
          ( mem(V0P,arr(A_27a,bool))
         => ! [V1l] :
              ( mem(V1l,ty_2Elist_2Elist(A_27a))
             => p(ap(ap(c_2Esorting_2EPERM(A_27a),V1l),ap(ap(c_2Elist_2EAPPEND(A_27a),ap(ap(c_2Elist_2EFILTER(A_27a),V0P),V1l)),ap(ap(c_2Elist_2EFILTER(A_27a),ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),c_2Ebool_2E_7E),V0P)),V1l)))) ) ) ) )).
