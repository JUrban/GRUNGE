...
fof(conj_thm_2Eintegral_2EGAUGE__MIN__FINITE,conjecture,(
    ! [V0s] :
     ...
     => ! [V1gs] :
         ...
         => ! [V2n] :
             ...
             => ( ! [V3m] :
                   ...
                   => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V3m),V2n))
                     => p(ap(ap(c_2Etransc_2Egauge,V0s),ap(V1gs,V3m))) ) )
               => ? [V4g] :
                       ...
                       => ! [V6p] :
                           ...
                           => ( p(ap(ap(c_2Etransc_2Efine,V4g),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V5d),V6p)))
                             => ! [V7m] :
                                 ...
                                 => ( p(ap(ap(c_2Earithmetic_2E_3C_3D,V7m),V2n))
                                   => p(ap(ap(c_2Etransc_2Efine,ap(V1gs,V7m)),ap(ap(c_2Epair_2E_2C(arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal),arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)),V5d),V6p))) ) ) ) ) ) ) ) ) ) ) )).
