...
thf(conj_thm_2Epred__set_2EUNIV__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( ( mem @ V0s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EINDEPENDENT__BOUND,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EMAXIMAL__INDEPENDENT__SUBSET__EXTEND,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1v: $i] :
...
thf(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND__LEMMA,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1b: $i] :
           ...
           => ( ( p @ ( ap @ c_2Ereal__topology_2Eindependent @ V1b ) )
             => ? [V2g: $i] :
                  ...
                  & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2g @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) )
                        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V3x ) ) ) @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V4y ) ) ) ) ) )
                  & ! [V5x: tp__ty_2Erealax_2Ereal,V6c: tp__ty_2Erealax_2Ereal] :
                     ...
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2g @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V6c ) ) @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) ) )
                        = ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ V6c ) ) @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V5x ) ) ) ) ) )
                  & ! [V7x: tp__ty_2Erealax_2Ereal] :
                      ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) @ V1b ) )
                     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2g @ ( inj__ty_2Erealax_2Ereal @ V7x ) ) )
...
thf(conj_thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND,conjecture,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1b: $i] :
          ( ( mem @ V1b @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
