...
tff(mem_c_2Ewords_2Eword__rol__bv,axiom,(
    ! [A_27a: del] : mem(c_2Ewords_2Eword__rol__bv(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)))) )).
...
tff(lmtp_f2332,type,(
    f2332: ( del * $i * tp__ty_2Enum_2Enum * $i * tp__o ) > $i )).

tff(lamtp_f2332,axiom,(
    ! [A_27a: del,V1m: $i] :
      ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3a: tp__o] : mem(f2332(A_27a,V1m,V2k,V0w,V3a),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
tff(lameq_f2331,axiom,(
    ! [A_27a: del,V1m: $i] :
     ...
     => ! [V2k: tp__ty_2Enum_2Enum,V0w: $i] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ! [V3a: tp__o] : ap(f2331(A_27a,V1m,V2k,V0w),inj__o(V3a)) = f2332(A_27a,V1m,V2k,V0w,V3a) ) ) )).

tff(lmtp_f2330,type,(
    f2330: ( del * $i * $i ) > $i )).

tff(lamtp_f2330,axiom,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
...
tff(lameq_f2330,axiom,(
    ! [A_27a: del,V0w: $i] :
     ...
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
         => ! [V2k: tp__ty_2Enum_2Enum] : ap(f2330(A_27a,V0w,V1m),inj__ty_2Enum_2Enum(V2k)) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Enum_2Enum,ty_2Enum_2Enum),f2331(A_27a,V1m,V2k,V0w)),inj__o(fo__c_2Ebool_2EF)),ap(c_2Erich__list_2ECOUNT__LIST,ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).

tff(conj_thm_2Eblast_2Eword__rol__bv__expand,conjecture,(
    ! [A_27a: del,V0w: $i] :
      ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
     => ! [V1m: $i] :
          ( mem(V1m,ty_2Efcp_2Ecart(bool,bool))
