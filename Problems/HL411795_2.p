...
tff(conj_thm_2Ereal__topology_2EDIST__SYM,lemma,(
...
tff(conj_thm_2Ereal__topology_2EUNIFORMLY__CONVERGENT__EQ__CAUCHY,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Enum_2Enum,arr(A_27a,ty_2Erealax_2Ereal)))
         => ( ? [V2l: $i] :
                ...
                & ! [V3e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ? [V4N: tp__ty_2Enum_2Enum] :
                      ! [V5n: tp__ty_2Enum_2Enum,V6x: $i] :
                        ( mem(V6x,A_27a)
                       => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V4N)),inj__ty_2Enum_2Enum(V5n)))
                            & p(ap(V0P,V6x)) )
                         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(V1s,inj__ty_2Enum_2Enum(V5n)),V6x)),ap(V2l,V6x)))),inj__ty_2Erealax_2Ereal(V3e))) ) ) ) )
          <=> ! [V7e: tp__ty_2Erealax_2Ereal] :
               ...
               => ? [V8N: tp__ty_2Enum_2Enum] :
                  ! [V9m: tp__ty_2Enum_2Enum,V10n: tp__ty_2Enum_2Enum,V11x: $i] :
                    ( mem(V11x,A_27a)
                   => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V8N)),inj__ty_2Enum_2Enum(V9m)))
                        & p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V8N)),inj__ty_2Enum_2Enum(V10n)))
                        & p(ap(V0P,V11x)) )
                     => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(V1s,inj__ty_2Enum_2Enum(V9m)),V11x)),ap(ap(V1s,inj__ty_2Enum_2Enum(V10n)),V11x)))),inj__ty_2Erealax_2Ereal(V7e))) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESEQUENCE__CAUCHY__WLOG,lemma,(
    ! [V0e: tp__ty_2Erealax_2Ereal,V1P: $i] :
      ( mem(V1P,arr(ty_2Enum_2Enum,bool))
     => ! [V2s: $i] :
          ( mem(V2s,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
         => ( ! [V3m: tp__ty_2Enum_2Enum,V4n: tp__ty_2Enum_2Enum] :
                ( ( p(ap(V1P,inj__ty_2Enum_2Enum(V3m)))
                  & p(ap(V1P,inj__ty_2Enum_2Enum(V4n))) )
               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V2s,inj__ty_2Enum_2Enum(V3m))),ap(V2s,inj__ty_2Enum_2Enum(V4n))))),inj__ty_2Erealax_2Ereal(V0e))) )
          <=> ! [V5m: tp__ty_2Enum_2Enum,V6n: tp__ty_2Enum_2Enum] :
                ( ( p(ap(V1P,inj__ty_2Enum_2Enum(V5m)))
                  & p(ap(V1P,inj__ty_2Enum_2Enum(V6n)))
                  & p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V5m)),inj__ty_2Enum_2Enum(V6n))) )
               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(V2s,inj__ty_2Enum_2Enum(V5m))),ap(V2s,inj__ty_2Enum_2Enum(V6n))))),inj__ty_2Erealax_2Ereal(V0e))) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESUM__DIFF__LEMMA,lemma,(
    ! [V0f: $i] :
     ...
     => ! [V1k: $i] :
         ...
         => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum] :
             ...
             => surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal_2Ereal__sub,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V3n)))),V0f)),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V2m)))),V0f))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1k),ap(ap(c_2Eiterate_2E_2E_2E,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V2m)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),inj__ty_2Enum_2Enum(V3n)))),V0f)) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EABS__SUM__TRIVIAL__LEMMA,lemma,(
    ! [V0P: tp__o,V1s: $i] :
      ( mem(V1s,arr(ty_2Enum_2Enum,bool))
     => ! [V2m: tp__ty_2Enum_2Enum,V3n: tp__ty_2Enum_2Enum,V4f: $i] :
         ...
         => ! [V5e: tp__ty_2Erealax_2Ereal] :
             ...
             => ( ( p(inj__o(V0P))
                 => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n)))),V4f))),inj__ty_2Erealax_2Ereal(V5e))) )
              <=> ( p(inj__o(V0P))
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V3n)),inj__ty_2Enum_2Enum(V2m)))
                    | p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V1s),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V2m)),inj__ty_2Enum_2Enum(V3n)))),V4f))),inj__ty_2Erealax_2Ereal(V5e))) ) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ESERIES__CAUCHY__UNIFORM,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
         => ! [V2k: $i] :
              ( mem(V2k,arr(ty_2Enum_2Enum,bool))
             => ( ? [V3l: $i] :
                    ( mem(V3l,arr(A_27a,ty_2Erealax_2Ereal))
                    & ! [V4e: tp__ty_2Erealax_2Ereal] :
                       ...
                       => ? [V5N: tp__ty_2Enum_2Enum] :
                          ! [V6n: tp__ty_2Enum_2Enum,V7x: $i] :
                            ( mem(V7x,A_27a)
                           => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V5N)),inj__ty_2Enum_2Enum(V6n)))
                                & p(ap(V0P,V7x)) )
                             => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V2k),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)),inj__ty_2Enum_2Enum(V6n)))),ap(V1f,V7x))),ap(V3l,V7x)))),inj__ty_2Erealax_2Ereal(V4e))) ) ) ) )
              <=> ! [V8e: tp__ty_2Erealax_2Ereal] :
                   ...
                   => ? [V9N: tp__ty_2Enum_2Enum] :
                      ! [V10m: tp__ty_2Enum_2Enum,V11n: tp__ty_2Enum_2Enum,V12x: $i] :
                        ( mem(V12x,A_27a)
                       => ( ( p(ap(ap(c_2Earithmetic_2E_3C_3D,inj__ty_2Enum_2Enum(V9N)),inj__ty_2Enum_2Enum(V10m)))
                            & p(ap(V0P,V12x)) )
                         => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),ap(ap(c_2Epred__set_2EINTER(ty_2Enum_2Enum),V2k),ap(ap(c_2Eiterate_2E_2E_2E,inj__ty_2Enum_2Enum(V10m)),inj__ty_2Enum_2Enum(V11n)))),ap(V1f,V12x)))),inj__ty_2Erealax_2Ereal(V8e))) ) ) ) ) ) ) ) )).
