...
tff(conj_thm_2Ereal__topology_2ELIM__SUM,lemma,(
...
tff(conj_thm_2Ereal__topology_2ELIM__NULL__SUM,conjecture,(
    ! [A_27a: del,A_27b: del,V0net: $i] :
             ...
             => ( ( p(ap(c_2Epred__set_2EFINITE(A_27b),V2s))
                  & ! [V3a: $i] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V3a),V2s))
                       => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3761(A_27b,A_27a,V1f,V3a)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net)) ) ) )
               => p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3762(A_27b,A_27a,V1f,V2s)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net)) ) ) ) ) )).
