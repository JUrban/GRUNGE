...
fof(conj_thm_2EHolSmt_2Er201,conjecture,(
    ! [V0u] :
      ( mem(V0u,ty_2Erealax_2Ereal)
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ! [V2v] :
              ( mem(V2v,ty_2Erealax_2Ereal)
             => ! [V3y] :
                  ( mem(V3y,ty_2Erealax_2Ereal)
                 => ! [V4w] :
                      ( mem(V4w,ty_2Erealax_2Ereal)
                     => ! [V5z] :
                          ( mem(V5z,ty_2Erealax_2Ereal)
                         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V0u)),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V2v)),V3y)),ap(ap(c_2Erealax_2Ereal__mul,V4w),V5z)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)))
                          <=> ~ p(ap(ap(c_2Ereal_2Ereal__lte,ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V0u),V1x)),ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Erealax_2Ereal__mul,V2v),V3y)),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Erealax_2Ereal__neg,V4w)),V5z)))),ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0))) ) ) ) ) ) ) ) )).
