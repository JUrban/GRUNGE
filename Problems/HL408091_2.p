...
tff(lameq_f2911,axiom,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V3x: tp__ty_2Erealax_2Ereal] : ap(f2911(V0f,V1g),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Ereal_2E_2F,ap(V0f,inj__ty_2Erealax_2Ereal(V3x))),ap(V1g,inj__ty_2Erealax_2Ereal(V3x))) ) ) )).

tff(conj_thm_2Elim_2ECONT__DIV,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
         => ! [V2x: tp__ty_2Erealax_2Ereal] :
             ...
             => p(ap(ap(c_2Elim_2Econtl,f2911(V0f,V1g)),inj__ty_2Erealax_2Ereal(V2x))) ) ) ) )).
