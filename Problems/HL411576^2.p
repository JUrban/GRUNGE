...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ATTAINS__SUP,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__INTERVAL,lemma,(
...
thf(conj_thm_2Ereal__topology_2EEMPTY__AS__INTERVAL,lemma,
    ( ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal )
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__INTERVAL,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal,V1b: tp__ty_2Erealax_2Ereal] :
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__POINTWISE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EIS__INTERVAL__COMPACT,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ( p @ ( ap @ c_2Ereal__topology_2Eis__interval @ V0s ) )
          & ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ V0s ) ) )
