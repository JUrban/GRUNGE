...
fof(thm_2EpatternMatches_2EPMATCH__ROW__COND__EX__IMP__REWRITE,conjecture,(
    ! [A_27a,A_27b,A_27c,V0v_2E0,V1p_2E0,V2g_2E0,V3p_27_2E0,V4g_27_2E0,V5RES_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__COND__EX_2E3(s(A_27a,V0v_2E0),s(tyop_2Emin_2Efun(A_27b,A_27a),V1p_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2g_2E0))))
     => ( ! [V6x_2E0] :
            ( p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V2g_2E0),s(A_27b,V6x_2E0))))
           => ( ? [V7x_27_2E0] :
                  ...
                  & p(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Ebool),V4g_27_2E0),s(A_27c,V7x_27_2E0)))) )
            <=> p(s(tyop_2Emin_2Ebool,V5RES_2E0)) ) )
       => s(tyop_2Emin_2Ebool,c_2EpatternMatches_2EPMATCH__ROW__COND__EX_2E3(s(A_27a,V0v_2E0),s(tyop_2Emin_2Efun(A_27c,A_27a),V3p_27_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Ebool),V4g_27_2E0))) = s(tyop_2Emin_2Ebool,V5RES_2E0) ) ) )).
