...
fof(conj_thm_2Erich__list_2EAPPEND__FOLDR,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0l1] :
         ...
         => ! [V1l2] :
             ...
             => ap(ap(c_2Elist_2EAPPEND(A_27a),V0l1),V1l2) = ap(ap(ap(c_2Elist_2EFOLDR(A_27a,A_27a),c_2Elist_2ECONS(A_27a)),V1l2),V0l1) ) ) ) )).
