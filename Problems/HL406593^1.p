...
thf(thm_2Esptree_2Esubspt__trans,conjecture,(
    ! [A_27a: d,V0sp3_2E0: u,V1sp2_2E0: u,V2sp1_2E0: u] :
      ( ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Esubspt_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2sp1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1sp2_2E0 ) ) ) )
        & ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Esubspt_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V1sp2_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp3_2E0 ) ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Esptree_2Esubspt_2E2 @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V2sp1_2E0 ) @ ( s @ ( tyop_2Esptree_2Espt @ A_27a ) @ V0sp3_2E0 ) ) ) ) ) )).
