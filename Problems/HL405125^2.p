...
thf(tp_c_2Equotient__pred__set_2EDISJOINTR,type,(
    c_2Equotient__pred__set_2EDISJOINTR: del > $i )).

thf(mem_c_2Equotient__pred__set_2EDISJOINTR,axiom,(
    ! [A_27a: del] :
...
thf(ax_thm_2Equotient__pred__set_2EDISJOINTR__def,axiom,(
    ! [A_27a: del,V0R: $i] :
      ( ( mem @ V0R @ ( arr @ A_27a @ ( arr @ A_27a @ bool ) ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
             ...
             => ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Equotient__pred__set_2EDISJOINTR @ A_27a ) @ V0R ) @ V1s ) @ V2t ) )
              <=> ~ ( p
                    @ ( ap @ ( ap @ ( c_2Ebool_2ERES__EXISTS @ A_27a ) @ ( ap @ ( c_2Equotient_2Erespects @ A_27a @ bool ) @ V0R ) )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V2t ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Equotient__pred__set_2EDISJOINTR__RSP,conjecture,(
