...
thf(conj_thm_2Eset__relation_2Eper__delete,conjecture,(
    ! [A_27a: del,V0xs: $i] :
      ( ( mem @ V0xs @ ( arr @ A_27a @ bool ) )
     => ! [V1xss: $i] :
          ( ( mem @ V1xss @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
         => ! [V2e: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Eset__relation_2Eper @ A_27a ) @ V0xs ) @ V1xss ) )
               => ( p
                  @ ( ap @ ( ap @ ( c_2Eset__relation_2Eper @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27a ) @ V0xs ) @ V2e ) )
                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                      @ ( lam @ ( arr @ A_27a @ bool )
                        @ ^ [V3es: $i] :
                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ bool ) @ V3es )
                            @ ( ap
                              @ ( ap @ c_2Ebool_2E_2F_5C
                                @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( arr @ A_27a @ bool ) ) @ V3es )
                                  @ ( ap
                                    @ ( ap @ ( c_2Epred__set_2EIMAGE @ ( arr @ A_27a @ bool ) @ ( arr @ A_27a @ bool ) )
                                      @ ( lam @ ( arr @ A_27a @ bool )
                                        @ ^ [V4es: $i] :
                                            ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ A_27a ) @ V4es ) @ V2e ) ) )
                                    @ V1xss ) ) )
                              @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ A_27a @ bool ) ) @ V3es ) @ ( c_2Epred__set_2EEMPTY @ A_27a ) ) ) ) ) ) ) ) ) ) ) ) ) )).
