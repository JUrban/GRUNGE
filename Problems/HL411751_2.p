...
tff(conj_thm_2Ereal__topology_2ESERIES__FINITE__SUPPORT,lemma,(
    ! [V0f: $i] :
...
tff(conj_thm_2Ereal__topology_2ESERIES__SUM,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
     => ! [V1l: tp__ty_2Erealax_2Ereal,V2k: $i] :
          ( mem(V2k,arr(ty_2Enum_2Enum,bool))
         => ! [V3s: $i] :
              ( mem(V3s,arr(ty_2Enum_2Enum,bool))
             => ( ( p(ap(c_2Epred__set_2EFINITE(ty_2Enum_2Enum),V3s))
                  & p(ap(ap(c_2Epred__set_2ESUBSET(ty_2Enum_2Enum),V3s),V2k))
                  & ! [V4x: tp__ty_2Enum_2Enum] :
                      ( ~ p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V4x)),V3s))
                     => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Enum_2Enum(V4x))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )
                  & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(ty_2Enum_2Enum),V3s),V0f)) = V1l )
               => p(ap(ap(ap(c_2Ereal__topology_2Esums,V0f),inj__ty_2Erealax_2Ereal(V1l)),V2k)) ) ) ) ) )).
