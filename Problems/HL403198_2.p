...
tff(mem_c_2EreaderMonad_2EMCOMPOSE,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27s: del] : mem(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),arr(arr(A_27a,arr(A_27s,A_27b)),arr(arr(A_27b,arr(A_27s,A_27c)),arr(A_27a,arr(A_27s,A_27c))))) )).

tff(tp_c_2EreaderMonad_2EUNIT,type,(
    c_2EreaderMonad_2EUNIT: ( del * del ) > $i )).

tff(mem_c_2EreaderMonad_2EUNIT,axiom,(
    ! [A_27a: del,A_27b: del] : mem(c_2EreaderMonad_2EUNIT(A_27a,A_27a),arr(A_27a,arr(A_27b,A_27a))) )).
...
tff(ax_thm_2EreaderMonad_2EUNIT__def,axiom,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
     ...
     => ! [V1s: $i] :
          ( mem(V1s,A_27b)
         => ap(ap(c_2EreaderMonad_2EUNIT(A_27a,A_27a),V0x),V1s) = V0x ) ) )).
...
tff(ax_thm_2EreaderMonad_2EMCOMPOSE__def,axiom,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27s: del,V0f1: $i] :
     ...
     => ! [V1f2: $i] :
         ...
         => ! [V2a: $i] :
              ( mem(V2a,A_27a)
             => ap(ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),V0f1),V1f2),V2a) = ap(ap(c_2EreaderMonad_2EBIND(A_27b,A_27b,A_27b),ap(V0f1,V2a)),V1f2) ) ) ) )).

tff(conj_thm_2EreaderMonad_2EMCOMPOSE__RIGHT__ID,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,arr(A_27b,A_27c)))
     => ap(ap(c_2EreaderMonad_2EMCOMPOSE(A_27a,A_27a,A_27a,A_27a),V0f),c_2EreaderMonad_2EUNIT(A_27c,A_27c)) = V0f ) )).
