...
thf(thm_2Ebool_2Eitself__induction,axiom,(
    ! [A_27a: $tType,V0P: ( tyop_2Ebool_2Eitself @ A_27a ) > $o] :
     ...
     => ! [V1i: tyop_2Ebool_2Eitself @ A_27a] :
          ( V0P @ V1i ) ) )).
...
thf(thm_2Ebasis__emit_2EfromNum__ind,conjecture,(
    ! [A_27a: $tType,V0P: ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) ) > $o] :
      ( ! [V1n: tyop_2Enum_2Enum] :
          ( V0P @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) @ V1n @ ( c_2Ebool_2Ethe__value @ A_27a ) ) )
     => ! [V2v: tyop_2Enum_2Enum,V3v1: tyop_2Ebool_2Eitself @ A_27a] :
          ( V0P @ ( c_2Epair_2E_2C @ tyop_2Enum_2Enum @ ( tyop_2Ebool_2Eitself @ A_27a ) @ V2v @ V3v1 ) ) ) )).
