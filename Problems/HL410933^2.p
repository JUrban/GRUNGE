...
thf(conj_thm_2Ereal__topology_2ELIM__SUM,lemma,(
             ...
             => ! [V3s: $i] :
                 ...
                 => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V3s ) )
                   ...
                   => ( p
                      @ ( ap
                        @ ( ap
                          @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27b )
                            @ ( lam @ A_27b
                              @ ^ [V5x: $i] :
                                  ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V3s )
                                  @ ( lam @ A_27a
                                    @ ^ [V6i: $i] :
                                        ( ap @ ( ap @ V1f @ V6i ) @ V5x ) ) ) ) )
                          @ ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27a ) @ V3s ) @ V2l ) )
                        @ V0net ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ELIM__NULL__SUM,conjecture,(
    ! [A_27a: del,A_27b: del,V0net: $i] :
                  ...
                  @ ( ap
                    @ ( ap
                      @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ A_27a )
                        @ ( lam @ A_27a
                          @ ^ [V5x: $i] :
                              ( ap @ ( ap @ ( c_2Eiterate_2ESum @ A_27b ) @ V2s ) @ ( ap @ V1f @ V5x ) ) ) )
                      @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) )
                    @ V0net ) ) ) ) ) ) )).
