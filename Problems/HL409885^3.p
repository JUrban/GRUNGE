     ...
     => ( ( c_2Ereal_2Ereal__sub
        ...
        = ( c_2Erealax_2Ereal__mul @ ( c_2Ereal_2Ereal__sub @ V1x @ V2y )
          @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ ( c_2Earithmetic_2E_2D @ V3n @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
            @ ^ [V6j: tyop_2Enum_2Enum] :
                ( c_2Erealax_2Ereal__mul
                @ ( c_2Eiterate_2ESum @ tyop_2Enum_2Enum @ ( c_2Eiterate_2E_2E_2E @ c_2Enum_2E0 @ ( c_2Earithmetic_2E_2D @ ( c_2Earithmetic_2E_2D @ V3n @ V6j ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) )
                  @ ^ [V7k: tyop_2Enum_2Enum] :
                      ( c_2Erealax_2Ereal__mul @ ( V0a @ ( c_2Earithmetic_2E_2B @ ( c_2Earithmetic_2E_2B @ V6j @ V7k ) @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) @ ( c_2Ereal_2Epow @ V2y @ V7k ) ) )
                @ ( c_2Ereal_2Epow @ V1x @ V6j ) ) ) ) ) ) )).
