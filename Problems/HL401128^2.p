...
thf(conj_thm_2Edivides_2EONE__LT__PRIMES,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
...
thf(conj_thm_2Edivides_2EZERO__LT__PRIMES,conjecture,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( ap @ c_2Edivides_2EPRIMES @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )).
