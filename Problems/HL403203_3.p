...
tff(c_2EreaderMonad_2EFMAP_2E2,type,(
    c_2EreaderMonad_2EFMAP_2E2: 
      !>[A_27a: $tType,A_27b: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27a,A_27b) * tyop_2Emin_2Efun(A_27s,A_27a) ) > tyop_2Emin_2Efun(A_27s,A_27b) ) )).
...
tff(c_2EreaderMonad_2EJOIN_2E1,type,(
    c_2EreaderMonad_2EJOIN_2E1: 
      !>[A_27a: $tType,A_27s: $tType] :
        ( tyop_2Emin_2Efun(A_27s,tyop_2Emin_2Efun(A_27s,A_27a)) > tyop_2Emin_2Efun(A_27s,A_27a) ) )).

tff(c_2EreaderMonad_2EJOIN_2E2,type,(
    c_2EreaderMonad_2EJOIN_2E2: 
      !>[A_27a: $tType,A_27s: $tType] :
        ( ( tyop_2Emin_2Efun(A_27s,tyop_2Emin_2Efun(A_27s,A_27a)) * A_27s ) > A_27a ) )).
...
tff(thm_2EreaderMonad_2EBIND__JOIN,conjecture,(
