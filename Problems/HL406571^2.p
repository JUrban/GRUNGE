                  ...
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V1i: $i] :
                        ...
                        @ ^ [V2t: $i] :
                            ( lam @ A_27a
                            @ ^ [V3a: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Esptree_2Espt @ A_27a ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V1i ) @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Esptree_2Einsert @ A_27a ) @ V1i ) @ V3a ) @ V2t ) ) ) ) ) ) )
              @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Enum_2Enum @ ( ty_2Esptree_2Espt @ A_27a ) ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( c_2Esptree_2ELN @ A_27a ) ) )
            @ V0l ) ) ) ) )).

thf(conj_thm_2Esptree_2Elookup__insert,lemma,(
...
thf(conj_thm_2Esptree_2Edomain__fromList,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
