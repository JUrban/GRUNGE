...
fof(conj_thm_2Epred__set_2EEXISTS__IN__IMAGE,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Ereal__topology_2ECENTRE__IN__CBALL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__CLOSED__IN__EQ,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ~ ? [V1e1] :
...
fof(conj_thm_2Ereal__topology_2ECLOSED__CBALL,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1e] :
          ( mem(V1e,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Ereal__topology_2EREAL__INF__LE__FINITE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
...
fof(conj_thm_2Ereal__topology_2EREAL__LT__INF__FINITE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1a] :
          ( mem(V1a,ty_2Erealax_2Ereal)
     ...
     => ! [V0P] :
         ...
         => ! [V2g] :
             ...
             => ! [V6x] :
                 ...
                 => ap(f3890(V1f,V0P,V2g),V6x) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Erealax_2Ereal),ap(V0P,V6x)),ap(V1f,V6x)),ap(V2g,V6x)) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__CONNECTED__COMPONENT,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => p(ap(c_2Ereal__topology_2Econnected,ap(ap(c_2Ereal__topology_2Econnected__component,V0s),V1x))) ) ) )).

fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CASES__LOCAL,lemma,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1f] :
          ( mem(V1f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
                     ...
                     => ( ( p(ap(ap(c_2Etopology_2Eclosed__in(ty_2Erealax_2Ereal),ap(ap(c_2Ereal__topology_2Esubtopology(ty_2Erealax_2Ereal),c_2Ereal__topology_2Eeuclidean),ap(ap(c_2Epred__set_2EUNION(ty_2Erealax_2Ereal),V3s),V4t))),V3s))
                          ...
                          & ! [V5x] :
                             ...
                             => ( ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V3s))
                                    & ~ p(ap(V0P,V5x)) )
                                  | ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V5x),V4t))
                                    & p(ap(V0P,V5x)) ) )
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__DISCONNECTED__DISCRETE__FINITE__RANGE__CONSTANT__EQ,conjecture,
    ( ! [V0s] :
        ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
       => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
        <=> ! [V1f] :
