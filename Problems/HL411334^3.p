             ...
             => ? [V4d: tyop_2Erealax_2Ereal] :
                  ...
                  & ! [V5x_27: tyop_2Erealax_2Ereal] :
                      ( ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V5x_27 @ V1s )
                        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V5x_27 @ V2x ) ) @ V4d ) )
                     => ( c_2Erealax_2Ereal__lt @ ( c_2Ereal__topology_2EDist @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ ( V0f @ V5x_27 ) @ ( V0f @ V2x ) ) ) @ V3e ) ) ) ) ) ) )).
