...
fof(conj_thm_2EOmega_2Edark__shadow__ind,conjecture,(
    ! [V0P] :
      ( mem(V0P,arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),arr(ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),bool)))
     => ( ( ! [V1lowers] :
              ( mem(V1lowers,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
             => p(ap(ap(V0P,c_2Elist_2ENIL(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum))),V1lowers)) )
          & ! [V2c] :
              ( mem(V2c,ty_2Enum_2Enum)
             => ! [V3L] :
                  ( mem(V3L,ty_2Einteger_2Eint)
                 => ! [V4uppers] :
                      ( mem(V4uppers,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                     => ! [V5lowers] :
                          ( mem(V5lowers,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
                         => ( p(ap(ap(V0P,V4uppers),V5lowers))
                           => p(ap(ap(V0P,ap(ap(c_2Elist_2ECONS(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)),ap(ap(c_2Epair_2E_2C(ty_2Enum_2Enum,ty_2Enum_2Enum),V2c),V3L)),V4uppers)),V5lowers)) ) ) ) ) ) )
       => ! [V6v] :
            ( mem(V6v,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
           => ! [V7v1] :
                ( mem(V7v1,ty_2Elist_2Elist(ty_2Epair_2Eprod(ty_2Enum_2Enum,ty_2Enum_2Enum)))
