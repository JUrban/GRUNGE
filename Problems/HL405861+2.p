...
fof(lameq_f2224,axiom,(
    ! [V0f] :
     ...
     => ! [V1i] :
          ( mem(V1i,ty_2Enum_2Enum)
         => ap(f2224(V0f),V1i) = k(bool,ap(V0f,V1i)) ) ) )).

fof(conj_thm_2Ewords_2Efcp__n2w,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,bool))
         => ap(c_2Efcp_2EFCP(bool,bool),V0f) = ap(ap(c_2Ewords_2Eword__modify(A_27a),f2224(V0f)),ap(c_2Ewords_2En2w(A_27a),c_2Enum_2E0)) ) ) )).
