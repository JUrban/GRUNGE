...
fof(conj_thm_2Emachine__ieee_2Efloat__to__fp32__fp32__to__float,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ap(c_2Emachine__ieee_2Efloat__to__fp32,ap(c_2Emachine__ieee_2Efp32__to__float,V0x)) = V0x ) )).

fof(conj_thm_2Emachine__ieee_2Efp32__nchotomy,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Efcp_2Ecart(bool,bool))
     => ? [V1y] :
          ( mem(V1y,ty_2Ebinary__ieee_2Efloat(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone)))),ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit1(ty_2Efcp_2Ebit0(ty_2Eone_2Eone))))))
