...
thf(conj_thm_2Ereal__topology_2ESPAN__MONO,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__SPAN,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( p @ ( ap @ c_2Ereal__topology_2Esubspace @ ( ap @ c_2Ereal__topology_2Espan @ V0s ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ESPAN__SUPERSET,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESPAN__0,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESPAN__ADD,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESPAN__SUBSET__SUBSPACE,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESUBSPACE__SUMS,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESPAN__UNION,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
              ...
              @ ( ap @ ( c_2Epair_2EUNCURRY @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal @ ( ty_2Epair_2Eprod @ ty_2Erealax_2Ereal @ bool ) )
                @ ( lam @ ty_2Erealax_2Ereal
                  @ ^ [V2x: $i] :
                      ( lam @ ty_2Erealax_2Ereal
                      @ ^ [V3y: $i] :
                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ V2x ) @ V3y ) ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V2x ) @ ( ap @ c_2Ereal__topology_2Espan @ V0s ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V3y ) @ ( ap @ c_2Ereal__topology_2Espan @ V1t ) ) ) ) ) ) ) ) ) ) ) )).
