...
tff(conj_thm_2Etopology_2EOPEN__IN__TOPSPACE,lemma,(
    ! [A_27a: del,V0top: $i] :
...
tff(conj_thm_2Etopology_2ECLOSED__IN__TOPSPACE,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
...
tff(conj_thm_2Ereal__topology_2ECLOSED__IN__SUBTOPOLOGY,conjecture,(
    ! [A_27a: del,V0top: $i] :
      ( mem(V0top,ty_2Etopology_2Etopology(A_27a))
     => ! [V1u: $i] :
          ( mem(V1u,arr(A_27a,bool))
