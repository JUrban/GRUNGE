...
thf(conj_thm_2Erich__list_2EELL__LENGTH__SNOC,conjecture,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
     => ! [V1x: $i] :
          ( ( mem @ V1x @ A_27a )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2EELL @ A_27a ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V0l ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27a ) @ V1x ) @ V0l ) )
            = ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( c_2Elist_2ENULL @ A_27a ) @ V0l ) ) @ V1x ) @ ( ap @ ( c_2Elist_2EHD @ A_27a ) @ V0l ) ) ) ) ) )).
