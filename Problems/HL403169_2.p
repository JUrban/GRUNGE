...
tff(lameq_f960,axiom,(
    ! [V0y: $i] :
     ...
     => ! [V2a: $i] :
         ...
         => ! [V1b: $i] :
              ( mem(V1b,arr(ty_2Enum_2Enum,bool))
             => ! [V3t: tp__ty_2Enum_2Enum] : ap(f960(V0y,V2a,V1b),inj__ty_2Enum_2Enum(V3t)) = ap(ap(c_2Emin_2E_3D_3D_3E,ap(c_2Ebool_2E_7E,ap(V1b,inj__ty_2Enum_2Enum(V3t)))),ap(ap(c_2Ebool_2E_2F_5C,ap(V2a,inj__ty_2Enum_2Enum(V3t))),ap(V0y,ap(ap(c_2Earithmetic_2E_2B,inj__ty_2Enum_2Enum(V3t)),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))) ) ) ) )).

tff(conj_thm_2ETemporal__Logic_2EUNTIL__FIX,conjecture,(
    ! [V0y: $i] :
      ( mem(V0y,arr(ty_2Enum_2Enum,bool))
     => ! [V1b: $i] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
