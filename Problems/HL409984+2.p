...
fof(conj_thm_2Eextreal_2Einf__min,conjecture,(
    ! [V0p] :
      ( mem(V0p,arr(ty_2Eextreal_2Eextreal,bool))
     => ! [V1z] :
          ( mem(V1z,ty_2Eextreal_2Eextreal)
         => ( ( p(ap(V0p,V1z))
              & ! [V2x] :
                  ( mem(V2x,ty_2Eextreal_2Eextreal)
                 => ( p(ap(V0p,V2x))
                   => p(ap(ap(c_2Eextreal_2Eextreal__le,V1z),V2x)) ) ) )
           => ap(c_2Eextreal_2Eextreal__inf,V0p) = V1z ) ) ) )).
