...
fof(conj_thm_2Ewhile_2ELEAST__ELIM,lemma,(
    ! [V0Q] :
...
fof(lamtp_f2748,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => mem(f2748(V0x),arr(ty_2Enum_2Enum,bool)) ) )).
...
fof(lameq_f2748,axiom,(
    ! [V0x] :
     ...
     => ! [V1n] :
          ( mem(V1n,ty_2Enum_2Enum)
         => ap(f2748(V0x),V1n) = ap(ap(c_2Ereal_2Ereal__gt,ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Earithmetic_2E_2B,V1n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V0x) ) ) )).

fof(ax_thm_2Ereal_2ENUM__FLOOR__def,axiom,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ap(c_2Ereal_2ENUM__FLOOR,V0x) = ap(c_2Ewhile_2ELEAST,f2748(V0x)) ) )).

fof(conj_thm_2Ereal_2ENUM__FLOOR__DIV__LOWERBOUND,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ( ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
           ...
           => p(ap(ap(c_2Erealax_2Ereal__lt,V0x),ap(ap(c_2Erealax_2Ereal__mul,ap(c_2Ereal_2Ereal__of__num,ap(ap(c_2Earithmetic_2E_2B,ap(c_2Ereal_2ENUM__FLOOR,ap(ap(c_2Ereal_2E_2F,V0x),V1y))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V1y))) ) ) ) )).
