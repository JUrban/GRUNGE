...
tff(conj_thm_2Efinite__map_2EFDOM__FUNION,lemma,(
...
tff(conj_thm_2Efinite__map_2EIN__FDOM__FOLDR__UNION,conjecture,(
    ! [A_27a: del,A_27b: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1hL: $i] :
          ( mem(V1hL,ty_2Elist_2Elist(ty_2Efinite__map_2Efmap(A_27a,A_27a)))
         => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),ap(ap(ap(c_2Elist_2EFOLDR(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)),c_2Efinite__map_2EFUNION(A_27a,A_27a)),c_2Efinite__map_2EFEMPTY(A_27a,A_27a)),V1hL))))
          <=> ? [V2h: $i] :
                ( mem(V2h,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                & p(ap(ap(c_2Ebool_2EIN(ty_2Efinite__map_2Efmap(A_27a,A_27a)),V2h),ap(c_2Elist_2ELIST__TO__SET(ty_2Efinite__map_2Efmap(A_27a,A_27a)),V1hL)))
                & p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V2h))) ) ) ) ) )).
