...
fof(conj_thm_2Efinite__map_2EFMERGE__COMM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0m] :
             ...
             => ( p(ap(c_2Ecombin_2ECOMM(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)),ap(c_2Efinite__map_2EFMERGE(A_27b,A_27b),V0m)))
