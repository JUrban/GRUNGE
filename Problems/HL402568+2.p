...
fof(conj_thm_2Erich__list_2EELL__compute,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ( ! [V0l] :
            ( mem(V0l,ty_2Elist_2Elist(A_27a))
        ...
        & ! [V1n] :
           ...
           => ! [V2l] :
                ( mem(V2l,ty_2Elist_2Elist(A_27a))
               => ap(ap(c_2Erich__list_2EELL(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),V2l) = ap(ap(c_2Erich__list_2EELL(A_27a),ap(ap(c_2Earithmetic_2E_2D,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V1n))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))),ap(c_2Elist_2EFRONT(A_27a),V2l)) ) )
        & ! [V3n] :
            ( mem(V3n,ty_2Enum_2Enum)
           => ! [V4l] :
                ( mem(V4l,ty_2Elist_2Elist(A_27a))
               => ap(ap(c_2Erich__list_2EELL(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,V3n))),V4l) = ap(ap(c_2Erich__list_2EELL(A_27a),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,V3n))),ap(c_2Elist_2EFRONT(A_27a),V4l)) ) ) ) ) )).
