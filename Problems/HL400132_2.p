...
tff(lamtp_f40,axiom,(
    ! [A_27a: del,A_27a: del] : mem(f40(A_27a,A_27a),arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool))) )).
...
tff(ax_thm_2Ebool_2ERES__EXISTS__UNIQUE__DEF,axiom,(
    ! [A_27a: del] : c_2Ebool_2ERES__EXISTS__UNIQUE(A_27a) = f40(A_27a,A_27a) )).
...
tff(conj_thm_2Ebool_2ERES__EXISTS__UNIQUE__THM,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,bool))
