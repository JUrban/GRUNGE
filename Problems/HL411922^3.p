...
thf(thm_2Ereal__topology_2EURYSOHN__LOCAL,axiom,(
...
thf(thm_2Ereal__topology_2EURYSOHN,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1t: tyop_2Erealax_2Ereal > $o,V2a: tyop_2Erealax_2Ereal,V3b: tyop_2Erealax_2Ereal] :
     ...
     => ? [V4f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal] :
          ( ( c_2Ereal__topology_2Econtinuous__on @ V4f @ ( c_2Epred__set_2EUNIV @ tyop_2Erealax_2Ereal ) )
          & ! [V5x: tyop_2Erealax_2Ereal] :
              ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ ( V4f @ V5x ) @ ( c_2Ereal__topology_2Eclosed__segment @ ( c_2Elist_2ECONS @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) @ ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal @ V2a @ V3b ) @ ( c_2Elist_2ENIL @ ( tyop_2Epair_2Eprod @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal ) ) ) ) )
          & ! [V6x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V6x @ V0s )
             => ( ( V4f @ V6x )
                = V2a ) )
          & ! [V7x: tyop_2Erealax_2Ereal] :
              ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V7x @ V1t )
             => ( ( V4f @ V7x )
                = V3b ) ) ) ) )).
