...
tff(lmtp_f3635,type,(
    f3635: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3635,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3635(V0c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3635,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f3635(V0c),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0c)),inj__ty_2Erealax_2Ereal(V1x)) )).

tff(conj_thm_2Ereal__topology_2ELINEAR__SCALING,lemma,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ereal__topology_2Elinear,f3635(V0c))) )).

tff(lmtp_f3700,type,(
    f3700: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f3700,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal] : mem(f3700(V0c),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(lameq_f3700,axiom,(
    ! [V0c: tp__ty_2Erealax_2Ereal,V3x: tp__ty_2Erealax_2Ereal] : ap(f3700(V0c),inj__ty_2Erealax_2Ereal(V3x)) = ap(ap(c_2Erealax_2Ereal__mul,inj__ty_2Erealax_2Ereal(V0c)),inj__ty_2Erealax_2Ereal(V3x)) )).

tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__INJECTIVE__LINEAR__IMAGE__RIGHT__EQ,lemma,(
    ! [V0f: $i] :
         ...
         => ! [V2t: $i] :
             ...
             => ( ( p(ap(c_2Ereal__topology_2Elinear,V0f))
                  & ! [V3x: tp__ty_2Erealax_2Ereal,V4y: tp__ty_2Erealax_2Ereal] :
                     ...
                     => V3x = V4y ) )
               => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V1s),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V0f),V2t)))
                <=> p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V1s),V2t)) ) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EHOMEOMORPHIC__SCALING__RIGHT,conjecture,(
    ! [V0c: tp__ty_2Erealax_2Ereal] :
     ...
     => ! [V1s: $i] :
         ...
         => ! [V2t: $i] :
              ( mem(V2t,arr(ty_2Erealax_2Ereal,bool))
             => ( p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V1s),ap(ap(c_2Epred__set_2EIMAGE(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3700(V0c)),V2t)))
              <=> p(ap(ap(c_2Ereal__topology_2Ehomeomorphic,V1s),V2t)) ) ) ) ) )).
