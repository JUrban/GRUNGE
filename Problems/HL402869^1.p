...
thf(f3296_0_2E0,type,(
    f3296_0_2E0: u )).

thf(f3296_0_2E1,type,(
    f3296_0_2E1: du > u )).

thf(f3296_1_2E0,type,(
    f3296_1_2E0: u )).

thf(f3296_1_2E1,type,(
    f3296_1_2E1: du > u )).

thf(f3296_1_2E3,type,(
...
thf(arityeq1_2Emono_2Ef3296_0_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) @ ( f3296_0_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) ) @ f3296_0_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq1_2Emono_2Ef3296_1_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ ( f3296_1_2E1 @ ( s @ A_27a @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ f3296_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef3296_1_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27a @ ( f3296_1_2E3 @ ( s @ A_27a @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) @ ( s @ A_27c @ X2_2E0 ) ) )
      = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) ) @ f3296_1_2E0 ) @ ( s @ A_27a @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) @ ( s @ A_27c @ X2_2E0 ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Elist_2EMAP_2E2_2Emono_2Etyop_2Epair_2Eprod_28A_27a_2Ctyop_2Epair_2Eprod_28A_27b_2CA_27c_29_29_20mono_2EA_27a,axiom,(
...
thf(arityeq1_2Emono_2Ec_2Epair_2EUNCURRY_2E1_2Emono_2EA_27a_20mono_2Etyop_2Epair_2Eprod_28A_27b_2CA_27c_29_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
...
thf(arityeq1_2Emono_2Ec_2Epair_2EUNCURRY_2E1_2Emono_2EA_27b_20mono_2EA_27c_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
...
thf(def0_2Ethm_2Erich__list_2EMAP__FST__funs,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V1x_2E0: u,V2y_2E0: u,V3z_2E0: u] :
      ( ( s @ A_27a @ ( f3296_1_2E3 @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27b @ V2y_2E0 ) @ ( s @ A_27c @ V3z_2E0 ) ) )
      = ( s @ A_27a @ V1x_2E0 ) ) )).

thf(def1_2Ethm_2Erich__list_2EMAP__FST__funs,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V1x_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) @ ( f3296_0_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27c @ A_27a ) ) @ ( f3296_1_2E1 @ ( s @ A_27a @ V1x_2E0 ) ) ) ) ) ) )).

thf(thm_2Erich__list_2EMAP__FST__funs,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0funs_2E0: u] :
      ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EMAP_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) @ A_27a ) @ ( c_2Epair_2EUNCURRY_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) @ A_27a ) ) @ f3296_0_2E0 ) ) ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ ( tyop_2Epair_2Eprod @ A_27b @ A_27c ) ) ) @ V0funs_2E0 ) ) )
