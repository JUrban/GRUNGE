...
fof(conj_thm_2Ereal__topology_2ECONNECTED__IFF__CONNECTED__COMPONENT,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__EQ__CONNECTED__COMPONENT__EQ,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Econnected,V0s))
      <=> ! [V1x] :
