...
fof(ax_thm_2Emeasure_2Elambda__system__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0gen] :
          ( mem(V0gen,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2EALGEBRA__ALT__INTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0a] :
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__EMPTY,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__COMPL,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__INTER,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ALGEBRA,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0g0] :
          ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
