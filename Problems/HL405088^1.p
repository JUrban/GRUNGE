...
thf(f6045_0_2E0,type,(
    f6045_0_2E0: u )).

thf(f6045_0_2E1,type,(
    f6045_0_2E1: du > u )).

thf(f6045_0_2E2,type,(
    f6045_0_2E2: du > du > u )).

thf(f6045_1_2E0,type,(
    f6045_1_2E0: u )).

thf(f6045_1_2E2,type,(
    f6045_1_2E2: du > du > u )).
...
thf(arityeq1_2Emono_2Ef6045_0_2E1_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( f6045_0_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) ) ) @ f6045_0_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef6045_0_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f6045_0_2E2 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ef6045_1_2E2_2Emono_2EA_27a_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6045_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Elist_2Elist @ A_27a ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) ) @ f6045_1_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ X1_2E0 ) ) ) ) ) )).
...
thf(def0_2Ethm_2Efmaptree_2Eapplicable__paths__FINITE,axiom,(
    ! [A_27a: d,A_27b: d,V1p_2E0: u,V0ft_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f6045_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1p_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) ) ) )
    <=> ? [V2ft_27_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ ( c_2Efmaptree_2Eapply__path_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1p_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V2ft_27_2E0 ) ) ) ) ) )).

thf(def1_2Ethm_2Efmaptree_2Eapplicable__paths__FINITE,axiom,(
    ! [A_27a: d,A_27b: d,V0ft_2E0: u,V1p_2E0: u] :
      ( ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( f6045_0_2E2 @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1p_2E0 ) ) )
      = ( s @ ( tyop_2Epair_2Eprod @ ( tyop_2Elist_2Elist @ A_27a ) @ tyop_2Emin_2Ebool ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1p_2E0 ) @ ( s @ tyop_2Emin_2Ebool @ ( f6045_1_2E2 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ V1p_2E0 ) @ ( s @ ( tyop_2Efmaptree_2Efmaptree @ A_27a @ A_27b ) @ V0ft_2E0 ) ) ) ) ) ) )).

thf(thm_2Efmaptree_2Eapplicable__paths__FINITE,conjecture,(
