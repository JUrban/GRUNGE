...
tff(conj_thm_2Ereal__topology_2EBIGUNION__MONO,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION__CLOSED,lemma,(
    ! [V0g: $i] :
...
tff(conj_thm_2Ereal__topology_2ENOWHERE__DENSE__COUNTABLE__BIGUNION,conjecture,(
    ! [V0g: $i] :
      ( mem(V0g,arr(arr(ty_2Erealax_2Ereal,bool),bool))
     => ( ( p(ap(c_2Epred__set_2Ecountable(arr(ty_2Erealax_2Ereal,bool)),V0g))
          & ! [V1s: $i] :
              ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
             => ( p(ap(ap(c_2Ebool_2EIN(arr(ty_2Erealax_2Ereal,bool)),V1s),V0g))
               => ap(c_2Ereal__topology_2Einterior,ap(c_2Ereal__topology_2Eclosure,V1s)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )
       => ap(c_2Ereal__topology_2Einterior,ap(c_2Epred__set_2EBIGUNION(ty_2Erealax_2Ereal),V0g)) = c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal) ) ) )).
