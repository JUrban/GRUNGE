...
thf(conj_thm_2Etopology_2EOPEN__IN__CLOSED__IN__EQ,lemma,(
    ! [A_27a: del,V0top: $i] :
      ( ( mem @ V0top @ ( ty_2Etopology_2Etopology @ A_27a ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EUPPER__HEMICONTINUOUS,conjecture,(
    ! [V0f: $i] :
                          ...
                          @ ( ap @ ( ap @ ( c_2Etopology_2Eopen__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V5x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V5x ) @ V2s ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ESUBSET @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V5x ) ) @ V4u ) ) ) ) ) ) ) ) )
                <=> ! [V6u: $i] :
                     ...
                     => ( ( p @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V1t ) ) @ V6u ) )
                       => ( p
                          @ ( ap @ ( ap @ ( c_2Etopology_2Eclosed__in @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V2s ) )
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V7x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V7x ) @ V2s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V7x ) ) @ V6u ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
