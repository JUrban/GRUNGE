...
thf(thm_2Eordinal_2Eubsup__thm,axiom,(
    ! [A_27a: $tType,V0s: ( tyop_2Eordinal_2Eordinal @ A_27a ) > $o,V1b: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ! [V2a: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V2a @ V0s )
         => ( c_2Eordinal_2Eordlt @ A_27a @ V2a @ V1b ) )
     => ! [V3c: tyop_2Eordinal_2Eordinal @ A_27a] :
          ( ( c_2Eordinal_2Eordlt @ A_27a @ V3c @ ( c_2Eordinal_2Esup @ A_27a @ V0s ) )
        <=> ? [V4d: tyop_2Eordinal_2Eordinal @ A_27a] :
              ( ( c_2Ebool_2EIN @ ( tyop_2Eordinal_2Eordinal @ A_27a ) @ V4d @ V0s )
              & ( c_2Eordinal_2Eordlt @ A_27a @ V3c @ V4d ) ) ) ) )).
...
thf(thm_2Eordinal_2EordADD__fromNat__omega,conjecture,(
    ! [A_27a: $tType,V0n: tyop_2Enum_2Enum] :
      ( ( c_2Eordinal_2EordADD @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ V0n ) @ ( c_2Eordinal_2Eomega @ A_27a ) )
