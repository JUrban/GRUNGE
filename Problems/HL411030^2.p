...
thf(conj_thm_2Eiterate_2EREAL__SUP__UNIQUE,lemma,(
    ! [V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EBOUNDED__HAS__SUP,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESUP__INSERT,conjecture,(
