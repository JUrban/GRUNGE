...
thf(c_2Eieee_2Efloat__mul,type,(
    c_2Eieee_2Efloat__mul: tyop_2Eieee_2Efloat > tyop_2Eieee_2Efloat > tyop_2Eieee_2Efloat )).

thf(c_2Eieee_2Efmul,type,(
    c_2Eieee_2Efmul: ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) > tyop_2Eieee_2Eroundmode > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) > ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) )).
...
thf(thm_2Eieee_2Efmul,axiom,(
    ! [V0X: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum,V1m: tyop_2Eieee_2Eroundmode,V2a: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ),V3b: tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum )] :
      ( ( c_2Eieee_2Efmul @ V0X @ V1m @ V2a @ V3b )
      = ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Eieee_2Eis__nan @ V0X @ V2a ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Eieee_2Eis__nan @ V0X @ V3b ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__zero @ V0X @ V2a ) @ ( c_2Eieee_2Eis__infinity @ V0X @ V3b ) ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Eieee_2Eis__infinity @ V0X @ V2a ) @ ( c_2Eieee_2Eis__zero @ V0X @ V3b ) ) ) ) ) @ ( c_2Eieee_2Esome__nan @ V0X ) @ ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Ebool_2E_5C_2F @ ( c_2Eieee_2Eis__infinity @ V0X @ V2a ) @ ( c_2Eieee_2Eis__infinity @ V0X @ V3b ) ) @ ( c_2Ebool_2ECOND @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ ( tyop_2Epair_2Eprod @ tyop_2Enum_2Enum @ tyop_2Enum_2Enum ) ) @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Eieee_2Esign @ V2a ) @ ( c_2Eieee_2Esign @ V3b ) ) @ ( c_2Eieee_2Eplus__infinity @ V0X ) @ ( c_2Eieee_2Eminus__infinity @ V0X ) ) @ ( c_2Eieee_2Ezerosign @ V0X @ ( c_2Ebool_2ECOND @ tyop_2Enum_2Enum @ ( c_2Emin_2E_3D @ tyop_2Enum_2Enum @ ( c_2Eieee_2Esign @ V2a ) @ ( c_2Eieee_2Esign @ V3b ) ) @ c_2Enum_2E0 @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) @ ( c_2Eieee_2Eround @ V0X @ V1m @ ( c_2Erealax_2Ereal__mul @ ( c_2Eieee_2Evalof @ V0X @ V2a ) @ ( c_2Eieee_2Evalof @ V0X @ V3b ) ) ) ) ) ) ) )).
...
thf(thm_2Eieee_2Efloat__mul,axiom,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( c_2Eieee_2Efloat__mul @ V0a @ V1b )
      = ( c_2Eieee_2Efloat @ ( c_2Eieee_2Efmul @ c_2Eieee_2Efloat__format @ c_2Eieee_2ETo__nearest @ ( c_2Eieee_2Edefloat @ V0a ) @ ( c_2Eieee_2Edefloat @ V1b ) ) ) ) )).
...
thf(thm_2Efloat_2EFLOAT__MUL,conjecture,(
    ! [V0a: tyop_2Eieee_2Efloat,V1b: tyop_2Eieee_2Efloat] :
      ( ( ( c_2Eieee_2EFinite @ V0a )
        ...
        & ( c_2Erealax_2Ereal__lt @ ( c_2Ereal_2Eabs @ ( c_2Erealax_2Ereal__mul @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) @ ( c_2Eieee_2Ethreshold @ c_2Eieee_2Efloat__format ) ) )
     => ( ( c_2Eieee_2EFinite @ ( c_2Eieee_2Efloat__mul @ V0a @ V1b ) )
        & ( ( c_2Eieee_2EVal @ ( c_2Eieee_2Efloat__mul @ V0a @ V1b ) )
          = ( c_2Erealax_2Ereal__add @ ( c_2Erealax_2Ereal__mul @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) @ ( c_2Efloat_2Eerror @ ( c_2Erealax_2Ereal__mul @ ( c_2Eieee_2EVal @ V0a ) @ ( c_2Eieee_2EVal @ V1b ) ) ) ) ) ) ) )).
