...
tff(conj_thm_2Eprim__rec_2ELESS__MONO__EQ,lemma,(
...
tff(conj_thm_2Earithmetic_2ESUB__LESS__0,lemma,(
...
tff(conj_thm_2Earithmetic_2ESUC__PRE,lemma,(
    ! [V0m: tp__ty_2Enum_2Enum] :
...
tff(conj_thm_2Elist_2EFRONT__SNOC,lemma,(
    ! [A_27a: del,V0x: $i] :
      ( mem(V0x,A_27a)
     => ! [V1l: $i] :
          ( mem(V1l,ty_2Elist_2Elist(A_27a))
...
tff(conj_thm_2Erich__list_2ESEG__LENGTH__SNOC,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( mem(V0l,ty_2Elist_2Elist(A_27a))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Erich__list_2ESEG__SNOC,lemma,(
...
tff(conj_thm_2Erich__list_2EELL__SEG,conjecture,(
