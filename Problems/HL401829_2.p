...
tff(conj_thm_2Epred__set_2ESURJ__COMPOSE,lemma,(
...
tff(conj_thm_2Epred__set_2EPOW__EMPTY,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ap(c_2Epred__set_2EPOW(A_27a),V0s) != c_2Epred__set_2EEMPTY(arr(A_27a,bool)) ) )).

tff(conj_thm_2Epred__set_2Einj__surj,lemma,(
             ...
             => ( p(ap(ap(ap(c_2Epred__set_2EINJ(A_27a,A_27a),V0f),V1s),V2t))
               => ( V1s = c_2Epred__set_2EEMPTY(A_27a)
                  | ? [V3f_27: $i] :
                      ...
                      & p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27b,A_27b),V3f_27),V2t),V1s)) ) ) ) ) ) ) )).
...
tff(conj_thm_2Epred__set_2Ecountable__surj,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
...
tff(conj_thm_2Epred__set_2Epow__no__surj,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ~ ? [V1f: $i] :
            ( mem(V1f,arr(A_27a,arr(A_27a,bool)))
            & p(ap(ap(ap(c_2Epred__set_2ESURJ(A_27a,A_27a),V1f),V0s),ap(c_2Epred__set_2EPOW(A_27a),V0s))) ) ) )).

tff(conj_thm_2Epred__set_2Einfinite__pow__uncountable,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0s))
