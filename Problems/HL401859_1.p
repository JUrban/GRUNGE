...
tff(thm_2Epred__set_2EIMAGE__EQ__SING,conjecture,(
    ! [A_27a: d,A_27b: d,V0z_2E0: u,V1s_2E0: u,V2f_2E0: u] :
      ( s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EIMAGE_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V2f_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EINSERT_2E2(s(A_27a,V0z_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)))
    <=> ( s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0) != s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),c_2Epred__set_2EEMPTY_2E0)
        & ! [V3x_2E0: u] :
            ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27b,V3x_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),V1s_2E0)))))
           => s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),V2f_2E0),s(A_27b,V3x_2E0))) = s(A_27a,V0z_2E0) ) ) ) )).
