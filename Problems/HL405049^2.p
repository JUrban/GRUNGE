...
thf(conj_thm_2EOmega__Automata_2EBOREL__HIERARCHY__FG,conjecture,(
    ! [V0a: $i] :
      ( ( mem @ V0a @ ( arr @ ty_2Enum_2Enum @ bool ) )
     => ! [V1t0: tp__ty_2Enum_2Enum] :
          ( ( ? [V2t1: tp__ty_2Enum_2Enum] :
              ! [V3t2: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ V0a @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V2t1 ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V3t2 ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) )
          <=> ? [V4q: $i] :
                ...
                & ? [V6t: tp__ty_2Enum_2Enum] :
                    ( p @ ( ap @ V4q @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V6t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
