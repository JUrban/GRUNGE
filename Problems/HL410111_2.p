...
tff(conj_thm_2Emeasure_2EALGEBRA__ALT__INTER,lemma,(
    ! [A_27a: del,V0a: $i] :
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__EMPTY,lemma,(
    ! [A_27a: del,V0g0: $i] :
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__COMPL,lemma,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__INTER,lemma,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ALGEBRA,conjecture,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
