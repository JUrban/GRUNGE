...
thf(conj_thm_2Ebool_2EOR__IMP__THM,lemma,(
    ! [V0A: $o,V1B: $o] :
      ( ( ( p @ ( inj__o @ V0A ) )
      <=> ( ( p @ ( inj__o @ V1B ) )
          | ( p @ ( inj__o @ V0A ) ) ) )
...
thf(conj_thm_2Elist_2Elist__Axiom__old,lemma,(
                      ...
                      @ ( lam @ A_27a
                        @ ^ [V3h: $i] :
                            ...
                            @ ( lam @ ( ty_2Elist_2Elist @ A_27a )
                              @ ^ [V4t: $i] :
                                  ( ap @ ( ap @ ( c_2Emin_2E_3D @ A_27b ) @ ( ap @ V2fn1 @ ( ap @ ( ap @ ( c_2Elist_2ECONS @ A_27a ) @ V3h ) @ V4t ) ) ) @ ( ap @ ( ap @ ( ap @ V1f @ ( ap @ V2fn1 @ V4t ) ) @ V3h ) @ V4t ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Elist_2ESNOC__INDUCT,conjecture,(
    ! [A_27a: del,V0P: $i] :
