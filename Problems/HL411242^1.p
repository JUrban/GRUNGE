...
thf(f13872_0_2E0,type,(
    f13872_0_2E0: u )).

thf(f13872_0_2E3,type,(
    f13872_0_2E3: du > du > du > u )).

thf(f13872_0_2E4,type,(
    f13872_0_2E4: du > du > du > du > u )).

thf(f13872_1_2E0,type,(
    f13872_1_2E0: u )).

thf(f13872_1_2E3,type,(
    f13872_1_2E3: du > du > du > u )).

thf(f13872_1_2E4,type,(
    f13872_1_2E4: du > du > du > du > u )).

thf(f13872_2_2E0,type,(
    f13872_2_2E0: u )).

thf(f13872_2_2E4,type,(
    f13872_2_2E4: du > du > du > du > u )).

thf(f13872_3_2E0,type,(
    f13872_3_2E0: u )).

thf(f13872_3_2E4,type,(
    f13872_3_2E4: du > du > du > du > u )).
...
thf(mono_2Ef13872_0,type,(
    mono_2Ef13872_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13872_1,type,(
    mono_2Ef13872_1: ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Epair_2Eprod_28tyop_2Erealax_2Ereal_2Ctyop_2Emin_2Ebool_29 )).

thf(mono_2Ef13872_2,type,(
    mono_2Ef13872_2: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).

thf(mono_2Ef13872_3,type,(
    mono_2Ef13872_3: mono_2Etyop_2Erealax_2Ereal > ( mono_2Etyop_2Erealax_2Ereal > $o ) > ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Erealax_2Ereal > $o ) > $o )).
...
thf(thm_2Epred__set_2EDIFF__SUBSET,axiom,(
    ! [A_27a: d,V0s_2E0: u,V1t_2E0: u] :
      ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Epred__set_2ESUBSET_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Epred__set_2EDIFF_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V1t_2E0 ) ) ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ V0s_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ereal__topology_2EQUOTIENT__MAP__OPEN__CLOSED,axiom,(
    ! [V6x: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V5u: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ef13872_3 @ V6x @ V1s @ V0f @ V5u )
    <=> ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V6x @ V1s )
        & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( V0f @ V6x ) @ V5u ) ) ) )).

thf(def1_2Ethm_2Ereal__topology_2EQUOTIENT__MAP__OPEN__CLOSED,axiom,(
    ! [V1s: mono_2Etyop_2Erealax_2Ereal > $o,V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V5u: mono_2Etyop_2Erealax_2Ereal > $o,V6x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13872_1 @ V1s @ V0f @ V5u @ V6x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V6x @ ( mono_2Ef13872_3 @ V6x @ V1s @ V0f @ V5u ) ) ) )).

thf(def2_2Ethm_2Ereal__topology_2EQUOTIENT__MAP__OPEN__CLOSED,axiom,(
...
thf(def3_2Ethm_2Ereal__topology_2EQUOTIENT__MAP__OPEN__CLOSED,axiom,(
    ! [V1s: mono_2Etyop_2Erealax_2Ereal > $o,V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V3u: mono_2Etyop_2Erealax_2Ereal > $o,V4x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13872_0 @ V1s @ V0f @ V3u @ V4x )
      = ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Emin_2Ebool @ V4x @ ( mono_2Ef13872_2 @ V4x @ V1s @ V0f @ V3u ) ) ) )).

thf(thm_2Ereal__topology_2EQUOTIENT__MAP__OPEN__CLOSED,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o,V2t: mono_2Etyop_2Erealax_2Ereal > $o] :
     ...
     => ( ! [V3u: mono_2Etyop_2Erealax_2Ereal > $o] :
           ...
           => ( ( mono_2Ec_2Etopology_2Eopen__in_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Esubtopology_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eeuclidean @ V1s ) @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13872_0 @ V1s @ V0f @ V3u ) ) )
      ...
      <=> ! [V5u: mono_2Etyop_2Erealax_2Ereal > $o] :
            ( ( mono_2Ec_2Epred__set_2ESUBSET_2Emono_2Etyop_2Erealax_2Ereal @ V5u @ V2t )
           => ( ( mono_2Ec_2Etopology_2Eclosed__in_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Esubtopology_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eeuclidean @ V1s ) @ ( mono_2Ec_2Epred__set_2EGSPEC_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ ( mono_2Ef13872_1 @ V1s @ V0f @ V5u ) ) )
              = ( mono_2Ec_2Etopology_2Eclosed__in_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal__topology_2Esubtopology_2Emono_2Etyop_2Erealax_2Ereal @ mono_2Ec_2Ereal__topology_2Eeuclidean @ V2t ) @ V5u ) ) ) ) ) )).
