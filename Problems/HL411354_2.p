...
tff(lamtp_f3361,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3361(A_27a,V0f,V1g),arr(A_27a,ty_2Erealax_2Ereal)) ) ) )).

tff(lameq_f3361,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3361(A_27a,V0f,V1g),V3x) = ap(ap(c_2Ereal_2Ereal__sub,ap(V0f,V3x)),ap(V1g,V3x)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CONST,lemma,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1c: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),k(A_27a,inj__ty_2Erealax_2Ereal(V1c))),V0net)) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__SUB,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2net: $i] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V0f),V2net))
               ...
               => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3361(A_27a,V0f,V1g)),V2net)) ) ) ) ) )).

tff(conj_thm_2Ereal__topology_2ECONTINUOUS__AT__ID,lemma,(
    ! [V0a: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),i(ty_2Erealax_2Ereal)),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V0a)))) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__PREIMAGE__UNIV,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ( ! [V2x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V2x))))
           ...
           => p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3839(V1s,V0f)))) ) ) ) )).

tff(conj_thm_2Ereal__topology_2EOPEN__TRANSLATION,conjecture,(
    ! [V0s: $i] :
