...
thf(f9452_0_2E0,type,(
    f9452_0_2E0: u )).

thf(f9452_0_2E1,type,(
    f9452_0_2E1: du > u )).

thf(f9452_0_2E2,type,(
    f9452_0_2E2: du > du > u )).

thf(f9803_0_2E0,type,(
    f9803_0_2E0: u )).

thf(f9803_0_2E1,type,(
    f9803_0_2E1: du > u )).

thf(f9803_0_2E2,type,(
    f9803_0_2E2: du > du > u )).
...
thf(mono_2Ef9452_0,type,(
    mono_2Ef9452_0: ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef9803_0,type,(
    mono_2Ef9803_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
    ...
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eseq_2Esummable @ V0f )
        & ! [V2m: mono_2Etyop_2Enum_2Enum] :
           ...
           => ( mono_2Ec_2Erealax_2Ereal__lt @ ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) @ ( V0f @ V2m ) ) ) )
...
thf(def0_2Ethm_2Eseq_2ESER__PAIR,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9452_0 @ V0f @ V1n )
      = ( mono_2Ec_2Ereal_2Esum @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Enum_2Enum_20mono_2Etyop_2Enum_2Enum @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0f ) ) )).

thf(thm_2Eseq_2ESER__PAIR,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eseq_2Esummable @ V0f )
     => ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9452_0 @ V0f ) @ ( mono_2Ec_2Eseq_2Esuminf @ V0f ) ) ) )).

thf(def0_2Ethm_2Etransc_2ESIN__PAIRED,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef9803_0 @ V0x @ V1n )
      = ( mono_2Ec_2Erealax_2Ereal__mul @ ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Ereal_2Epow @ ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) @ V1n ) @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2EFACT @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( mono_2Ec_2Ereal_2Epow @ V0x @ ( mono_2Ec_2Earithmetic_2E_2B @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1n ) @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) )).

thf(thm_2Etransc_2ESIN__PAIRED,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( mono_2Ec_2Eseq_2Esums @ ( mono_2Ef9803_0 @ V0x ) @ ( mono_2Ec_2Etransc_2Esin @ V0x ) ) )).
