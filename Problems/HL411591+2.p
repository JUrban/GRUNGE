...
fof(lamtp_f3986,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => mem(f3986(A_27a,V1f,V3b),arr(A_27a,bool)) ) ) )).

fof(lameq_f3986,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f3986(A_27a,V1f,V3b),V5x) = ap(ap(c_2Ereal_2Ereal__lte,ap(V1f,V5x)),V3b) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__COMPONENT__UBOUND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                     ...
                     => ! [V3b] :
                         ...
                         => ! [V4k] :
                             ...
                             => ( ( ~ p(ap(c_2Ereal__topology_2Etrivial__limit(A_27a),V0net))
                               ...
                               => p(ap(ap(c_2Ereal_2Ereal__lte,V2l),V3b)) ) ) ) ) ) ) ) ) )).

fof(lamtp_f3990,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => mem(f3990(A_27a,V1f,V3b),arr(A_27a,bool)) ) ) )).

fof(lameq_f3990,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V3b] :
          ( mem(V3b,ty_2Erealax_2Ereal)
         => ! [V4x] :
              ( mem(V4x,A_27a)
             => ap(f3990(A_27a,V1f,V3b),V4x) = ap(ap(c_2Ereal_2Ereal__lte,ap(V1f,V4x)),V3b) ) ) ) )).

fof(conj_thm_2Ereal__topology_2ELIM__DROP__UBOUND,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0net] :
          ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
