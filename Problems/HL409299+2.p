...
fof(conj_thm_2Elift__ieee_2Efloat__sub,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0a] :
             ...
             => ! [V1b] :
                 ...
                 => ( ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),V0a))
                      ...
                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)))),ap(c_2Ebinary__ieee_2Ethreshold(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))))) )
                   => ( p(ap(c_2Ebinary__ieee_2Efloat__is__finite(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b))))
                      & ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),ap(c_2Epair_2ESND(ty_2Ebinary__ieee_2Eflags,ty_2Ebinary__ieee_2Eflags),ap(ap(ap(c_2Ebinary__ieee_2Efloat__sub(A_27t,A_27t),c_2Ebinary__ieee_2EroundTiesToEven),V0a),V1b))) = ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b))),ap(ap(c_2Elift__ieee_2Eerror(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t))),ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a)),ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V1b)))) ) ) ) ) ) ) )).

fof(conj_thm_2Elift__ieee_2Efloat__sub__finite,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
