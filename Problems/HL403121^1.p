...
thf(f3702_0_2E0,type,(
    f3702_0_2E0: u )).

thf(f3702_0_2E1,type,(
    f3702_0_2E1: du > u )).

thf(f3702_0_2E2,type,(
    f3702_0_2E2: du > du > u )).

thf(f3702_1_2E0,type,(
    f3702_1_2E0: u )).

thf(f3702_1_2E1,type,(
    f3702_1_2E1: du > u )).
...
thf(mono_2Ef3702_0,type,(
    mono_2Ef3702_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3702_1,type,(
    mono_2Ef3702_1: mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2EALWAYS__AS__SBEFORE,axiom,(
    ! [V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3702_1 @ V3t )
      = mono_2Ec_2Ebool_2EF ) )).

thf(def1_2Ethm_2ETemporal__Logic_2EALWAYS__AS__SBEFORE,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V2t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3702_0 @ V0b @ V2t )
    <=> ( (~) @ ( V0b @ V2t ) ) ) )).

thf(thm_2ETemporal__Logic_2EALWAYS__AS__SBEFORE,conjecture,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2ETemporal__Logic_2EALWAYS @ V0b @ V1x )
    <=> ( (~) @ ( mono_2Ec_2ETemporal__Logic_2ESBEFORE @ ( mono_2Ef3702_0 @ V0b ) @ mono_2Ef3702_1 @ V1x ) ) ) )).
