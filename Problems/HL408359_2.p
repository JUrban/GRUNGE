...
tff(conj_thm_2Ebool_2ECONJ__SYM,lemma,(
    ! [V0t1: tp__o,V1t2: tp__o] :
      ( ( p(inj__o(V0t1))
        & p(inj__o(V1t2)) )
    <=> ( p(inj__o(V1t2))
...
tff(conj_thm_2Ereal_2EREAL__LT__TOTAL,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__LE__NEGTOTAL,lemma,(
...
tff(conj_thm_2Ereal_2EREAL__LE__NEGL,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))),inj__ty_2Erealax_2Ereal(V0x)))
    <=> p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x))) ) )).
...
tff(conj_thm_2Ereal_2EREAL__INV__NZ,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
tff(tp_c_2Etransc_2Etan,type,(
    c_2Etransc_2Etan: $i )).

tff(mem_c_2Etransc_2Etan,axiom,(
    mem(c_2Etransc_2Etan,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) )).

tff(stp_fo_c_2Etransc_2Etan,type,(
    fo__c_2Etransc_2Etan: tp__ty_2Erealax_2Ereal > tp__ty_2Erealax_2Ereal )).

tff(stp_eq_fo_c_2Etransc_2Etan,axiom,(
    ! [X0: tp__ty_2Erealax_2Ereal] : inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Etan(X0)) = ap(c_2Etransc_2Etan,inj__ty_2Erealax_2Ereal(X0)) )).

tff(conj_thm_2Etransc_2EPI2__BOUNDS,lemma,
    ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))
...
tff(conj_thm_2Etransc_2ECOS__POS__PI,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
...
tff(conj_thm_2Etransc_2ETAN__NEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Etan,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(c_2Etransc_2Etan,inj__ty_2Erealax_2Ereal(V0x)))) )).

tff(conj_thm_2Etransc_2EDIFF__TAN,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x))) != surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
...
tff(conj_thm_2Etransc_2ETAN__TOTAL__POS,lemma,(
    ! [V0y: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0y)))
     => ? [V1x: tp__ty_2Erealax_2Ereal] :
          ( p(ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V1x)))
          & p(ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))))
          & surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Etan,inj__ty_2Erealax_2Ereal(V1x))) = V0y ) ) )).

tff(lmtp_f2989,type,(
    f2989: tp__ty_2Erealax_2Ereal > $i )).

tff(lamtp_f2989,axiom,(
    ! [V0y: tp__ty_2Erealax_2Ereal] : mem(f2989(V0y),arr(ty_2Erealax_2Ereal,bool)) )).

tff(lameq_f2989,axiom,(
    ! [V0y: tp__ty_2Erealax_2Ereal,V1x: tp__ty_2Erealax_2Ereal] : ap(f2989(V0y),inj__ty_2Erealax_2Ereal(V1x)) = ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Erealax_2Ereal__neg,ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))),inj__ty_2Erealax_2Ereal(V1x))),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Erealax_2Ereal__lt,inj__ty_2Erealax_2Ereal(V1x)),ap(ap(c_2Ereal_2E_2F,inj__ty_2Erealax_2Ereal(fo__c_2Etransc_2Epi)),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))))),ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(c_2Etransc_2Etan,inj__ty_2Erealax_2Ereal(V1x))),inj__ty_2Erealax_2Ereal(V0y)))) )).

tff(conj_thm_2Etransc_2ETAN__TOTAL,conjecture,(
    ! [V0y: tp__ty_2Erealax_2Ereal] : p(ap(c_2Ebool_2E_3F_21(ty_2Erealax_2Ereal),f2989(V0y))) )).
