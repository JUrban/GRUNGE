...
fof(conj_thm_2Ebinary__ieee_2Eabs__float__value,lemma,
    ( ! [V0b] :
       ...
       => ! [V1c] :
           ...
           => ! [V2d] :
               ...
               => ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(c_2Ewords_2Ew2n(ty_2Eone_2Eone),V0b))),V1c)),V2d)) = ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__mul,V1c),V2d)) ) ) )
    & ! [V3b] :
        ( mem(V3b,ty_2Efcp_2Ecart(bool,bool))
       => ! [V4c] :
            ( mem(V4c,ty_2Erealax_2Ereal)
           => ap(c_2Ereal_2Eabs,ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2Epow,ap(c_2Erealax_2Ereal__neg,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),ap(c_2Ewords_2Ew2n(ty_2Eone_2Eone),V3b))),V4c)) = ap(c_2Ereal_2Eabs,V4c) ) ) )).

fof(conj_thm_2Ebinary__ieee_2Eless__than__ulp,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
         => ! [V0a] :
             ...
             => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,ap(c_2Ebinary__ieee_2Efloat__to__real(A_27t,A_27t),V0a))),ap(c_2Ebinary__ieee_2Eulp(A_27t,A_27t),c_2Ebool_2Ethe__value(ty_2Epair_2Eprod(A_27t,A_27t)))))
              <=> ( ap(c_2Ebinary__ieee_2Efloat__Exponent(A_27t,A_27t),V0a) = ap(c_2Ewords_2En2w(A_27w),c_2Enum_2E0)
                  & ap(c_2Ebinary__ieee_2Efloat__Significand(A_27t,A_27t),V0a) = ap(c_2Ewords_2En2w(A_27t),c_2Enum_2E0) ) ) ) ) ) )).
