...
tff(conj_thm_2EdirGraph_2EREACH__EXCLUDE,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1x: $i] :
          ( mem(V1x,arr(A_27a,bool))
...
tff(conj_thm_2Ebft_2EBFT__REACH__1,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1f: $i] :
...
tff(conj_thm_2Ebft_2EBFT__REACH__2,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,arr(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a))))
...
tff(conj_thm_2Ebft_2EBFT__REACH__THM,conjecture,(
    ! [A_27a: del,V0G: $i] :
      ( mem(V0G,arr(A_27a,ty_2Elist_2Elist(A_27a)))
     => ! [V1fringe: $i] :
