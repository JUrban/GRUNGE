...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__CMUL,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1c: tp__ty_2Erealax_2Ereal,V2net: $i] :
          ( mem(V2net,ty_2Ereal__topology_2Enet(A_27a))
         => ( p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),V0f),V2net))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous(A_27a),f3358(A_27a,V0f,V1c)),V2net)) ) ) ) )).
...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__CMUL,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
