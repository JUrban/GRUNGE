...
thf(f12678_0_2E0,type,(
    f12678_0_2E0: u )).

thf(f12678_0_2E2,type,(
    f12678_0_2E2: du > du > u )).

thf(f12678_0_2E3,type,(
    f12678_0_2E3: du > du > du > u )).

thf(f12679_0_2E0,type,(
    f12679_0_2E0: u )).

thf(f12679_0_2E2,type,(
    f12679_0_2E2: du > du > u )).

thf(f12679_0_2E3,type,(
    f12679_0_2E3: du > du > du > u )).
...
thf(mono_2Ef12678_0,type,(
    mono_2Ef12678_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ef12679_0,type,(
    mono_2Ef12679_0: ( mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal ) > ( mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal ) > mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Ereal__topology_2EINFSUM__UNIQUE,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1l: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o] :
     ...
     => ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ V0f )
        = V1l ) ) )).

thf(def0_2Ethm_2Ereal__topology_2ESERIES__LINEAR,axiom,(
    ! [V1h: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V4n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12679_0 @ V1h @ V0f @ V4n )
      = ( V1h @ ( V0f @ V4n ) ) ) )).

thf(thm_2Ereal__topology_2ESERIES__LINEAR,axiom,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1h: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2l: mono_2Etyop_2Erealax_2Ereal,V3s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esums @ V0f @ V2l @ V3s )
        & ( mono_2Ec_2Ereal__topology_2Elinear @ V1h ) )
     => ( mono_2Ec_2Ereal__topology_2Esums @ ( mono_2Ef12679_0 @ V1h @ V0f ) @ ( V1h @ V2l ) @ V3s ) ) )).

thf(def0_2Ethm_2Ereal__topology_2EINFSUM__LINEAR,axiom,(
    ! [V1h: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V3n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef12678_0 @ V1h @ V0f @ V3n )
      = ( V1h @ ( V0f @ V3n ) ) ) )).

thf(thm_2Ereal__topology_2EINFSUM__LINEAR,conjecture,(
    ! [V0f: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Erealax_2Ereal,V1h: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ( mono_2Ec_2Ereal__topology_2Esummable @ V2s @ V0f )
        & ( mono_2Ec_2Ereal__topology_2Elinear @ V1h ) )
     => ( ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ ( mono_2Ef12678_0 @ V1h @ V0f ) )
        = ( V1h @ ( mono_2Ec_2Ereal__topology_2Einfsum @ V2s @ V0f ) ) ) ) )).
