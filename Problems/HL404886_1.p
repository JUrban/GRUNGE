...
tff(thm_2Elbtree_2Emem__def,axiom,(
    ! [A_27a: d,V0x_2E0: u,V1x_27_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V0x_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V1x_27_2E0)))))
    <=> ! [V2mem_27_2E0: u] :
          ( ! [V3a0_2E0: u,V4a1_2E0: u] :
              ( ( ? [V5t1_2E0: u,V6t2_2E0: u] : s(tyop_2Elbtree_2Elbtree(A_27a),V4a1_2E0) = s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V3a0_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V5t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V6t2_2E0)))
                | ? [V7b_2E0: u,V8t1_2E0: u,V9t2_2E0: u] :
                    ( s(tyop_2Elbtree_2Elbtree(A_27a),V4a1_2E0) = s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V7b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V8t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V9t2_2E0)))
                    & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V2mem_27_2E0),s(A_27a,V3a0_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V8t1_2E0))))) )
                | ? [V10b_2E0: u,V11t1_2E0: u,V12t2_2E0: u] :
                    ( s(tyop_2Elbtree_2Elbtree(A_27a),V4a1_2E0) = s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V10b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V11t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V12t2_2E0)))
                    & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V2mem_27_2E0),s(A_27a,V3a0_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V12t2_2E0))))) ) )
             => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V2mem_27_2E0),s(A_27a,V3a0_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V4a1_2E0))))) )
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V2mem_27_2E0),s(A_27a,V0x_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V1x_27_2E0))))) ) ) )).

tff(thm_2Elbtree_2Emem__strongind,conjecture,(
    ! [A_27a: d,V0mem_27_2E0: u] :
      ( ( ! [V1a_2E0: u,V2t1_2E0: u,V3t2_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V1a_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V1a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V2t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V3t2_2E0)))))))
        & ! [V4a_2E0: u,V5b_2E0: u,V6t1_2E0: u,V7t2_2E0: u] :
            ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V4a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V6t1_2E0)))))
              & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V4a_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V6t1_2E0))))) )
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V4a_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V5b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V6t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V7t2_2E0))))))) )
        & ! [V8a_2E0: u,V9b_2E0: u,V10t1_2E0: u,V11t2_2E0: u] :
            ( ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V8a_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V11t2_2E0)))))
              & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V8a_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V11t2_2E0))))) )
           => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V8a_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),c_2Elbtree_2ENd_2E3(s(A_27a,V9b_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V10t1_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V11t2_2E0))))))) ) )
     => ! [V12a0_2E0: u,V13a1_2E0: u] :
          ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Elbtree_2Emem_2E2(s(A_27a,V12a0_2E0),s(tyop_2Elbtree_2Elbtree(A_27a),V13a1_2E0)))))
         => p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(tyop_2Elbtree_2Elbtree(A_27a),tyop_2Emin_2Ebool)),V0mem_27_2E0),s(A_27a,V12a0_2E0))),s(tyop_2Elbtree_2Elbtree(A_27a),V13a1_2E0))))) ) ) )).
