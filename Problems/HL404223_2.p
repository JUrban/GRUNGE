...
tff(conj_thm_2Epath_2ELTAKE__labels,conjecture,(
     ...
     => ! [V2l: $i] :
         ...
         => ( ap(ap(c_2Ellist_2ELTAKE(A_27b),inj__ty_2Enum_2Enum(V0n)),ap(c_2Epath_2Elabels(A_27a,A_27a),V1p)) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27b)),V2l)
          <=> ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V0n)),ap(c_2Epath_2EPL(A_27a,A_27a),V1p)))
              & ap(c_2Ellist_2EtoList(A_27b),ap(c_2Epath_2Elabels(A_27a,A_27a),ap(ap(c_2Epath_2Etake(A_27a,A_27a),inj__ty_2Enum_2Enum(V0n)),V1p))) = ap(c_2Eoption_2ESOME(ty_2Elist_2Elist(A_27b)),V2l) ) ) ) ) )).
