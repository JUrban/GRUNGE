...
thf(thm_2Eind__type_2ENUMSUM,axiom,(
    ! [V0b: $o,V1x: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Eind__type_2ENUMSUM @ V0b @ V1x )
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Enum_2Enum @ V0b @ ( mono_2Ec_2Enum_2ESUC @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1x ) ) @ ( mono_2Ec_2Earithmetic_2E_2A @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) @ V1x ) ) ) )).
...
thf(thm_2Eind__type_2ENUMSUM__INJ,conjecture,(
    ! [V0b1: $o,V1x1: mono_2Etyop_2Enum_2Enum,V2b2: $o,V3x2: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Eind__type_2ENUMSUM @ V0b1 @ V1x1 )
        = ( mono_2Ec_2Eind__type_2ENUMSUM @ V2b2 @ V3x2 ) )
    <=> ( ( V0b1 = V2b2 )
        & ( V1x1 = V3x2 ) ) ) )).
