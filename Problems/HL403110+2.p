...
fof(lameq_f894,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V4t] :
              ( mem(V4t,ty_2Enum_2Enum)
             => ap(f894(V0a,V1b),V4t) = ap(ap(c_2Ebool_2E_5C_2F,ap(V0a,V4t)),ap(V1b,V4t)) ) ) ) )).

fof(lamtp_f919,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f919(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f919,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V5t] :
              ( mem(V5t,ty_2Enum_2Enum)
             => ap(f919(V0a,V1b),V5t) = ap(ap(c_2Ebool_2E_2F_5C,ap(c_2Ebool_2E_7E,ap(V0a,V5t))),ap(c_2Ebool_2E_7E,ap(V1b,V5t))) ) ) ) )).

fof(lamtp_f918,axiom,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
         => mem(f918(V0a,V1b),arr(ty_2Enum_2Enum,bool)) ) ) )).
...
fof(lameq_f918,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
         ...
         => ! [V2t0] :
              ( mem(V2t0,ty_2Enum_2Enum)
             => ap(f918(V0a,V1b),V2t0) = ap(ap(c_2Ebool_2E_5C_2F,ap(ap(ap(c_2ETemporal__Logic_2ESWHEN,f893(V1b)),f894(V0a,V1b)),V2t0)),ap(ap(c_2ETemporal__Logic_2EALWAYS,f919(V0a,V1b)),V2t0)) ) ) ) )).

fof(conj_thm_2ETemporal__Logic_2EBEFORE__AS__SWHEN,conjecture,(
    ! [V0a] :
      ( mem(V0a,arr(ty_2Enum_2Enum,bool))
     => ! [V1b] :
          ( mem(V1b,arr(ty_2Enum_2Enum,bool))
