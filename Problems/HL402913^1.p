...
thf(thm_2Enumposrep_2En2l__ind,conjecture,(
    ! [V0P: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o] :
      ( ! [V1b: mono_2Etyop_2Enum_2Enum,V2n: mono_2Etyop_2Enum_2Enum] :
          ( ( ( (~)
              @ ( ( mono_2Ec_2Eprim__rec_2E_3C @ V2n @ V1b )
                | ( mono_2Ec_2Eprim__rec_2E_3C @ V1b @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) )
           => ( V0P @ V1b @ ( mono_2Ec_2Earithmetic_2EDIV @ V2n @ V1b ) ) )
         => ( V0P @ V1b @ V2n ) )
