...
thf(thm_2Efinite__map_2EFUPD__SAME__KEY__UNWIND,axiom,(
    ! [A_27a: d,A_27b: d,V0f1_2E0: u,V1f2_2E0: u,V2k_2E0: u,V3v1_2E0: u,V4v2_2E0: u] :
      ( ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2k_2E0 ) @ ( s @ A_27b @ V3v1_2E0 ) ) ) ) )
        = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f2_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2k_2E0 ) @ ( s @ A_27b @ V4v2_2E0 ) ) ) ) ) )
     => ( ( ( s @ A_27b @ V3v1_2E0 )
          = ( s @ A_27b @ V4v2_2E0 ) )
        & ! [V5v_2E0: u] :
            ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2k_2E0 ) @ ( s @ A_27b @ V5v_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V1f2_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2k_2E0 ) @ ( s @ A_27b @ V5v_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Efinite__map_2EFMEQ__ENUMERATE__CASES,axiom,(
    ! [A_27a: d,A_27b: d,V0f1_2E0: u,V1kvl_2E0: u,V2p_2E0: u] :
      ( ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V0f1_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V2p_2E0 ) ) )
        = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE__LIST_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1kvl_2E0 ) ) ) )
     => ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ V2p_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) ) @ V1kvl_2E0 ) ) ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFMEQ__SINGLE__SIMPLE__ELIM,conjecture,(
    ! [A_27a: d,A_27b: d,V0P_2E0: u,V1k_2E0: u,V2v_2E0: u,V3ck_2E0: u,V4cv_2E0: u,V5nv_2E0: u] :
      ( ? [V6fm_2E0: u] :
          ( ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ V6fm_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V1k_2E0 ) @ ( s @ A_27b @ V2v_2E0 ) ) ) ) )
            = ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ c_2Efinite__map_2EFEMPTY_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27b ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V3ck_2E0 ) @ ( s @ A_27b @ V4cv_2E0 ) ) ) ) ) )
