...
tff(conj_thm_2Eiterate_2ENSUM__IMAGE__GEN,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
...
tff(lmtp_f3331,type,(
    f3331: ( del * del * $i * $i * $i ) > $i )).

tff(lamtp_f3331,axiom,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V2s: $i] :
          ( mem(V2s,arr(A_27a,bool))
         => ! [V1g: $i] :
              ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
             => mem(f3331(A_27a,A_27b,V0f,V2s,V1g),arr(A_27b,ty_2Enum_2Enum)) ) ) ) )).
    ...
    ! [A_27a: del,A_27b: del,V0f: $i] :
     ...
     => ! [V2s: $i] :
         ...
         => ! [V1g: $i] :
             ...
             => ! [V4y: $i] :
                  ( mem(V4y,A_27b)
                 => ap(f3331(A_27a,A_27b,V0f,V2s,V1g),V4y) = ap(ap(c_2Eiterate_2Ensum(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3332(A_27b,A_27a,V2s,V0f,V4y))),V1g) ) ) ) ) )).

tff(conj_thm_2Eiterate_2ENSUM__GROUP,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Enum_2Enum))
         => ! [V2s: $i] :
             ...
             => ! [V3t: $i] :
                 ...
                 => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                   ...
                   => surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27b),V3t),f3331(A_27a,A_27b,V0f,V2s,V1g))) = surj__ty_2Enum_2Enum(ap(ap(c_2Eiterate_2Ensum(A_27a),V2s),V1g)) ) ) ) ) ) )).
