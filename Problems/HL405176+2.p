...
fof(lamtp_f2101,axiom,(
    ! [A_27b,A_27a,V2f] :
      ( mem(V2f,arr(A_27a,A_27b))
     => mem(f2101(A_27b,A_27a,V2f),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
fof(lameq_f2101,axiom,(
    ! [A_27b,A_27a,V2f] :
     ...
     => ! [V3k] :
          ( mem(V3k,A_27a)
         => ap(f2101(A_27b,A_27a,V2f),V3k) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3k),ap(V2f,V3k)) ) ) )).

fof(conj_thm_2Ealist_2EALOOKUP__TABULATE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V1l] :
                 ...
                 => ! [V2f] :
                     ...
                     => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V0x),ap(c_2Elist_2ELIST__TO__SET(A_27a),V1l)))
                       => ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),ap(ap(c_2Elist_2EMAP(A_27a,A_27a),f2101(A_27b,A_27a,V2f)),V1l)),V0x) = ap(c_2Eoption_2ESOME(A_27b),ap(V2f,V0x)) ) ) ) ) ) ) )).
