...
tff(conj_thm_2Ecardinal_2EINFINITE__UNIV__INF,lemma,(
    ! [A_27a: del] : ~ p(ap(c_2Epred__set_2EFINITE(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)),c_2Epred__set_2EUNIV(ty_2Esum_2Esum(ty_2Enum_2Enum,ty_2Enum_2Enum)))) )).

tff(conj_thm_2Ecardinal_2EIMAGE__cardleq,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,A_27b))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),ap(ap(c_2Epred__set_2EIMAGE(A_27a,A_27a),V0f),V1s)),V1s)) ) ) )).

tff(conj_thm_2Ecardinal_2ECARD__BIGUNION,lemma,(
    ! [A_27a: del,A_27b: del,V0k: $i] :
      ( mem(V0k,arr(A_27a,bool))
     => ! [V1s1: $i] :
          ( mem(V1s1,arr(arr(A_27b,bool),bool))
         => ( ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),V0k))
              & p(ap(ap(c_2Ecardinal_2Ecardleq(arr(A_27b,bool),arr(A_27b,bool)),V1s1),V0k))
              & ! [V2e: $i] :
                  ( mem(V2e,arr(A_27b,bool))
                 => ( p(ap(ap(c_2Ebool_2EIN(arr(A_27b,bool)),V2e),V1s1))
                   => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),V2e),V0k)) ) ) )
           => p(ap(ap(c_2Ecardinal_2Ecardleq(A_27b,A_27b),ap(c_2Epred__set_2EBIGUNION(A_27b),V1s1)),V0k)) ) ) ) )).
...
tff(conj_thm_2Eordinal_2Edclose__BIGUNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
     => ap(c_2Eordinal_2Edclose(A_27a),V0s) = ap(c_2Epred__set_2EBIGUNION(ty_2Eordinal_2Eordinal(A_27a)),ap(ap(c_2Epred__set_2EIMAGE(ty_2Eordinal_2Eordinal(A_27a),ty_2Eordinal_2Eordinal(A_27a)),c_2Eordinal_2Epreds(A_27a)),V0s)) ) )).

tff(conj_thm_2Eordinal_2Edclose__cardleq__univinf,conjecture,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
