...
thf(conj_thm_2EOmega__Automata_2ECO__BUECHI__CONJ__CLOSURE,conjecture,(
                         ...
                         => ! [V7Psi2: $i] :
                             ...
                             => ( ( ? [V8q1: $i] :
                                      ...
                                      & ! [V9t: tp__ty_2Enum_2Enum] :
                                          ( p @ ( ap @ V2Phi__R1 @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b1 ) @ ( ap @ V3i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) @ ( ap @ V8q1 @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V9t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
                                      & ? [V10t1: tp__ty_2Enum_2Enum] :
                                        ! [V11t2: tp__ty_2Enum_2Enum] :
                                  ...
                                  & ? [V12q2: $i] :
                                      ...
                                      & ! [V13t: tp__ty_2Enum_2Enum] :
                                          ( p @ ( ap @ V6Phi__R2 @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b2 ) @ ( ap @ V3i @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V13t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) @ ( ap @ V12q2 @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V13t ) ) @ ( inj__ty_2Enum_2Enum @ V1t0 ) ) ) ) ) )
