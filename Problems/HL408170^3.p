...
thf(thm_2Epoly_2EPOLY__ROOTS__INDEX__LENGTH,axiom,(
    ! [V0p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( ( c_2Epoly_2Epoly @ V0p )
          = ( c_2Epoly_2Epoly @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) )
     => ? [V1i: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
        ! [V2x: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Epoly_2Epoly @ V0p @ V2x )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
         => ? [V3n: tyop_2Enum_2Enum] :
              ( ( c_2Earithmetic_2E_3C_3D @ V3n @ ( c_2Elist_2ELENGTH @ tyop_2Erealax_2Ereal @ V0p ) )
              & ( V2x
                = ( V1i @ V3n ) ) ) ) ) )).
...
thf(thm_2Epoly_2EPOLY__ROOTS__FINITE__LEMMA,conjecture,(
    ! [V0p: tyop_2Elist_2Elist @ tyop_2Erealax_2Ereal] :
      ( ( (~)
        @ ( ( c_2Epoly_2Epoly @ V0p )
          = ( c_2Epoly_2Epoly @ ( c_2Elist_2ENIL @ tyop_2Erealax_2Ereal ) ) ) )
     => ? [V1N: tyop_2Enum_2Enum,V2i: tyop_2Enum_2Enum > tyop_2Erealax_2Ereal] :
        ! [V3x: tyop_2Erealax_2Ereal] :
          ( ( ( c_2Epoly_2Epoly @ V0p @ V3x )
            = ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) )
         => ? [V4n: tyop_2Enum_2Enum] :
              ( ( c_2Eprim__rec_2E_3C @ V4n @ V1N )
              & ( V3x
                = ( V2i @ V4n ) ) ) ) ) )).
