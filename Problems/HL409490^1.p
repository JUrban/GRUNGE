...
thf(c_2Eutil__prob_2Elg_2E0,type,(
    c_2Eutil__prob_2Elg_2E0: u )).

thf(c_2Eutil__prob_2Elg_2E1,type,(
...
thf(c_2Eutil__prob_2Elogr_2E0,type,(
    c_2Eutil__prob_2Elogr_2E0: u )).

thf(c_2Eutil__prob_2Elogr_2E2,type,(
...
thf(mono_2Ec_2Eutil__prob_2Elg,type,(
    mono_2Ec_2Eutil__prob_2Elg: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ec_2Etransc_2Eln,type,(
    mono_2Ec_2Etransc_2Eln: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).

thf(mono_2Ec_2Eutil__prob_2Elogr,type,(
    mono_2Ec_2Eutil__prob_2Elogr: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(thm_2Etransc_2ELN__1,axiom,
    ( ( mono_2Ec_2Etransc_2Eln @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
    = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Eutil__prob_2Elogr__def,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eutil__prob_2Elogr @ V0a @ V1x )
      = ( mono_2Ec_2Ereal_2E_2F @ ( mono_2Ec_2Etransc_2Eln @ V1x ) @ ( mono_2Ec_2Etransc_2Eln @ V0a ) ) ) )).

thf(thm_2Eutil__prob_2Elg__def,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Eutil__prob_2Elg @ V0x )
      = ( mono_2Ec_2Eutil__prob_2Elogr @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) @ V0x ) ) )).

thf(thm_2Eutil__prob_2Elg__1,axiom,
    ( ( mono_2Ec_2Eutil__prob_2Elg @ ( mono_2Ec_2Ereal_2Ereal__of__num @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) )
    = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) )).

thf(thm_2Eutil__prob_2Elg__nonzero,conjecture,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( ( (~)
          @ ( V0x
            = ( mono_2Ec_2Ereal_2Ereal__of__num @ mono_2Ec_2Enum_2E0 ) ) )
