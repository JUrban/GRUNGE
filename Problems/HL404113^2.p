...
thf(tp_c_2Ebft_2EBFT,type,(
    c_2Ebft_2EBFT: del > del > $i )).

thf(mem_c_2Ebft_2EBFT,axiom,(
    ! [A_27a: del,A_27b: del] :
...
thf(conj_thm_2Ebft_2EBFT__REACH__1,lemma,(
    ! [A_27a: del,V0G: $i] :
...
thf(conj_thm_2Ebft_2EBFT__REACH__2,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( ( mem @ V0G @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27a @ ( arr @ ( ty_2Elist_2Elist @ A_27a ) @ ( ty_2Elist_2Elist @ A_27a ) ) ) )
...
thf(conj_thm_2EdirGraph_2EREACH__EXCLUDE,lemma,(
    ! [A_27a: del,V0G: $i] :
      ( ( mem @ V0G @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ! [V1x: $i] :
            ...
            = ( ap @ ( c_2Erelation_2ERTC @ A_27a )
              @ ( lam @ A_27a
                @ ^ [V2x_27: $i] :
                    ( lam @ A_27a
                    @ ^ [V3y: $i] :
                        ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V2x_27 ) @ V1x ) ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3y ) @ ( ap @ ( c_2Elist_2ELIST__TO__SET @ A_27a ) @ ( ap @ V0G @ V2x_27 ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ebft_2EBFT__REACH__THM,conjecture,(
    ! [A_27a: del,V0G: $i] :
      ( ( mem @ V0G @ ( arr @ A_27a @ ( ty_2Elist_2Elist @ A_27a ) ) )
     => ! [V1fringe: $i] :
