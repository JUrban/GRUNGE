...
tff(conj_thm_2Eseq_2ESUMMABLE__LE,lemma,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__ADDITIVE,lemma,(
...
tff(conj_thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE__SUBADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2ESUBADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
...
tff(conj_thm_2Emeasure_2ECOUNTABLY__SUBADDITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2EINCREASING__ADDITIVE__SUMMABLE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
          ( mem(V1f,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__POSITIVE,lemma,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__INCREASING,lemma,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__STRONG__SUM,lemma,(
    ! [A_27a: del,V0g0: $i] :
      ( mem(V0g0,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1lam: $i] :
          ( mem(V1lam,arr(arr(A_27a,bool),ty_2Erealax_2Ereal))
...
tff(conj_thm_2Emeasure_2EOUTER__MEASURE__SPACE__POSITIVE,lemma,(
    ! [A_27a: del,V0m: $i] :
      ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ( p(ap(c_2Emeasure_2Eouter__measure__space(A_27a),V0m))
       => p(ap(c_2Emeasure_2Epositive(A_27a),V0m)) ) ) )).

tff(conj_thm_2Emeasure_2ELAMBDA__SYSTEM__CARATHEODORY,conjecture,(
    ! [A_27a: del,V0gsig: $i] :
