...
thf(conj_thm_2Ellist_2Eexists__strong__ind,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1Q: $i] :
...
thf(conj_thm_2Ellist_2Eexists__LDROP,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ A_27a @ bool ) )
     => ! [V1ll: $i] :
         ...
         => ( ( p @ ( ap @ ( ap @ ( c_2Ellist_2Eexists @ A_27a ) @ V0P ) @ V1ll ) )
          <=> ? [V2n: tp__ty_2Enum_2Enum,V3a: $i] :
                ...
                & ? [V4t: $i] :
                    ...
                    & ( ( ap @ ( ap @ ( c_2Ellist_2ELDROP @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V1ll )
                      = ( ap @ ( c_2Eoption_2ESOME @ ( ty_2Ellist_2Ellist @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ellist_2ELCONS @ A_27a ) @ V3a ) @ V4t ) ) )
                    & ( p @ ( ap @ V0P @ V3a ) ) ) ) ) ) ) )).
