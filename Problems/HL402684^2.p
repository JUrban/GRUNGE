...
thf(conj_thm_2Erich__list_2EBUTLASTN,lemma,(
    ! [A_27a: del,A_27b: del] :
      ( ! [V0l: $i] :
          ( ( mem @ V0l @ ( ty_2Elist_2Elist @ A_27a ) )
         => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ V0l )
            = V0l ) )
      & ! [V1n: tp__ty_2Enum_2Enum,V2x: $i] :
          ( ( mem @ V2x @ A_27b )
         => ! [V3l: $i] :
              ( ( mem @ V3l @ ( ty_2Elist_2Elist @ A_27b ) )
             => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27b ) @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) @ ( ap @ ( ap @ ( c_2Elist_2ESNOC @ A_27b ) @ V2x ) @ V3l ) )
                = ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V3l ) ) ) ) ) )).

thf(conj_thm_2Erich__list_2EBUTLASTN__LASTN__NIL,lemma,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1l: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V1l ) ) )
       => ( ( ap @ ( ap @ ( c_2Erich__list_2EBUTLASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ ( c_2Erich__list_2ELASTN @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ V1l ) )
          = ( c_2Elist_2ENIL @ A_27a ) ) ) ) )).

thf(conj_thm_2Erich__list_2ELASTN__BUTLASTN,conjecture,(
