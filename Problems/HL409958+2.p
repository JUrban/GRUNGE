...
fof(conj_thm_2Eextreal_2Eadd2__sub2,lemma,(
    ! [V0a] :
         ...
         => ! [V2c] :
             ...
             => ! [V3d] :
                 ...
                 => ( ( ( V1b != c_2Eextreal_2EPosInf
                   ...
                   => ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(c_2Eextreal_2Eextreal__sub,V0a),V1b)),ap(ap(c_2Eextreal_2Eextreal__sub,V2c),V3d)) = ap(ap(c_2Eextreal_2Eextreal__sub,ap(ap(c_2Eextreal_2Eextreal__add,V0a),V2c)),ap(ap(c_2Eextreal_2Eextreal__add,V1b),V3d)) ) ) ) ) ) )).
...
fof(lamtp_f3456,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2f_27] :
          ( mem(V2f_27,arr(A_27a,ty_2Eextreal_2Eextreal))
         => mem(f3456(A_27a,V1f,V2f_27),arr(A_27a,ty_2Eextreal_2Eextreal)) ) ) )).

fof(lameq_f3456,axiom,(
    ! [A_27a,V1f] :
      ( mem(V1f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V2f_27] :
          ( mem(V2f_27,arr(A_27a,ty_2Eextreal_2Eextreal))
         => ! [V5x] :
              ( mem(V5x,A_27a)
             => ap(f3456(A_27a,V1f,V2f_27),V5x) = ap(ap(c_2Eextreal_2Eextreal__sub,ap(V1f,V5x)),ap(V2f_27,V5x)) ) ) ) )).

fof(conj_thm_2Eextreal_2EEXTREAL__SUM__IMAGE__SUB,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
               ...
               => ! [V2f_27] :
                   ...
                   => ( ( ! [V3x] :
                           ...
                           => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V3x),V0s))
                             => ap(V2f_27,V3x) != c_2Eextreal_2ENegInf ) )
                        | ! [V4x] :
                            ( mem(V4x,A_27a)
                           => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),V0s))
                             => ap(V2f_27,V4x) != c_2Eextreal_2EPosInf ) ) )
                     => ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),f3456(A_27a,V1f,V2f_27)),V0s) = ap(ap(c_2Eextreal_2Eextreal__sub,ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V1f),V0s)),ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27a),V2f_27),V0s)) ) ) ) ) ) ) )).
