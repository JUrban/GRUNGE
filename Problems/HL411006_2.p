...
tff(conj_thm_2Ereal__topology_2EBOUNDED__POS__LT,conjecture,(
    ! [V0s: $i] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
      <=> ? [V1b: tp__ty_2Erealax_2Ereal] :
            ...
            & ! [V2x: tp__ty_2Erealax_2Ereal] :
                ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V2x)),V0s))
               => p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Eabs,inj__ty_2Erealax_2Ereal(V2x))),inj__ty_2Erealax_2Ereal(V1b))) ) ) ) ) )).
