...
fof(conj_thm_2Epred__set_2ESUBSET__UNION__ABSORPTION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(A_27a,bool))
...
fof(conj_thm_2Epred__set_2EBIJ__INV,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Eextreal_2EQ__INFINITE,lemma,(
    ~ p(ap(c_2Epred__set_2EFINITE(ty_2Eextreal_2Eextreal),c_2Eextreal_2EQ__set)) )).

fof(conj_thm_2Eextreal_2ECOUNTABLE__ENUM__Q,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0c] :
         ...
         => ( p(ap(c_2Epred__set_2Ecountable(A_27a),V0c))
          <=> ( V0c = c_2Epred__set_2EEMPTY(A_27a)
              | ? [V1f] :
                  ...
                  & V0c = ap(ap(c_2Epred__set_2EIMAGE(ty_2Eextreal_2Eextreal,ty_2Eextreal_2Eextreal),V1f),c_2Eextreal_2EQ__set) ) ) ) ) ) )).
