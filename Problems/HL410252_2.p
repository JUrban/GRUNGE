...
tff(conj_thm_2Eextreal_2Elt__trans,lemma,(
...
tff(conj_thm_2Eextreal_2Erat__not__infty,lemma,(
...
tff(conj_thm_2Eextreal_2EQ__DENSE__IN__R,lemma,(
...
tff(conj_thm_2Emeasure_2EBIGUNION__IMAGE__Q,lemma,(
    ! [A_27a: del,V0a: $i] :
      ( mem(V0a,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1f: $i] :
...
tff(conj_thm_2Emeasure_2EIN__MEASURABLE__BOREL__LT,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Eextreal_2Eextreal))
     => ! [V1g: $i] :
          ( mem(V1g,arr(A_27a,ty_2Eextreal_2Eextreal))
