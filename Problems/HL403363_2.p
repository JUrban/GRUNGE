...
tff(conj_thm_2Ebag_2EBAG__GEN__PROD__EQ__1,lemma,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ! [V1e: tp__ty_2Enum_2Enum] :
            ( surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0b),inj__ty_2Enum_2Enum(V1e))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
           => V1e = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__GEN__PROD__ALL__ONES,conjecture,(
    ! [V0b: $i] :
      ( mem(V0b,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b))
       => ( surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0b),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))
         => ! [V1x: tp__ty_2Enum_2Enum] :
              ( p(ap(ap(c_2Ebag_2EBAG__IN(ty_2Enum_2Enum),inj__ty_2Enum_2Enum(V1x)),V0b))
             => V1x = surj__ty_2Enum_2Enum(ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))) ) ) ) ) )).
