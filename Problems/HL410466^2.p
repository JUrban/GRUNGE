...
thf(conj_thm_2Ereal__topology_2ECOLLINEAR__EMPTY,lemma,(
    p @ ( ap @ c_2Ereal__topology_2Ecollinear @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) )).

thf(conj_thm_2Ereal__topology_2ECOLLINEAR__SING,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ c_2Ereal__topology_2Ecollinear @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOLLINEAR__2,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal,V1y: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ c_2Ereal__topology_2Ecollinear @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1y ) ) @ ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECOLLINEAR__SMALL,conjecture,(
    ! [V0s: $i] :
