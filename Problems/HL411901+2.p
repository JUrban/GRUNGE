...
fof(conj_thm_2Ereal__topology_2EREAL__SETDIST__LT__EXISTS,lemma,(
    ! [V0s] :
     ...
     => ! [V1t] :
         ...
         => ! [V2b] :
             ...
             => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                  ...
                  & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2Esetdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),V2b)) )
               => ? [V3x] :
                    ...
                    & ? [V4y] :
                        ...
                        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V3x),V4y))),V2b)) ) ) ) ) ) ) )).
...
fof(conj_thm_2Ereal__topology_2EREAL__LT__HAUSDIST__POINT__EXISTS,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2x] :
             ...
             => ! [V3d] :
                 ...
                 => ( ( p(ap(c_2Ereal__topology_2Ebounded__def,V0s))
                      & p(ap(c_2Ereal__topology_2Ebounded__def,V1t))
                      & V1t != c_2Epred__set_2EEMPTY(ty_2Erealax_2Ereal)
                      & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2Ehausdist,ap(ap(c_2Epair_2E_2C(arr(ty_2Erealax_2Ereal,bool),arr(ty_2Erealax_2Ereal,bool)),V0s),V1t))),V3d))
                      & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V2x),V0s)) )
                   => ? [V4y] :
                        ( mem(V4y,ty_2Erealax_2Ereal)
                        & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),V4y),V1t))
                        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),V4y))),V3d)) ) ) ) ) ) ) )).
