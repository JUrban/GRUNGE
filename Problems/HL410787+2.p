...
fof(conj_thm_2Ereal__topology_2ECONNECTED__UNION,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__INTERMEDIATE__CLOSURE,lemma,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONNECTED__UNION__STRONG,conjecture,(
    ! [V0s] :
      ( mem(V0s,arr(ty_2Erealax_2Ereal,bool))
     => ! [V1t] :
          ( mem(V1t,arr(ty_2Erealax_2Ereal,bool))
