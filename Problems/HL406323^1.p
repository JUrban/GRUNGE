    ...
    ! [A_27a: d,V0c_2E0: u] :
      ( ! [V1x_2E0: u,V2y_2E0: u] :
        ...
        <=> ( ( s @ A_27a @ V1x_2E0 )
            = ( s @ A_27a @ V2y_2E0 ) ) )
      & ! [V3x_2E0: u,V4y_2E0: u] :
          ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2EGREATER )
        <=> ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V4y_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2ELESS ) )
      & ! [V5x_2E0: u,V6y_2E0: u,V7z_2E0: u] :
          ( ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) ) ) )
              = mono_2Ec_2EternaryComparisons_2ELESS )
            & ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V6y_2E0 ) @ ( s @ A_27a @ V7z_2E0 ) ) ) )
              = mono_2Ec_2EternaryComparisons_2ELESS ) )
         => ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V5x_2E0 ) @ ( s @ A_27a @ V7z_2E0 ) ) ) )
            = mono_2Ec_2EternaryComparisons_2ELESS ) ) ) )).

thf(thm_2Etoto_2EtotoLLtrans,conjecture,(
    ! [A_27a: d,V0c_2E0: u,V1x_2E0: u,V2y_2E0: u,V3z_2E0: u] :
      ( ( ( ( j_mono_2Etyop_2EternaryComparisons_2Eordering @ ( s @ tyop_2EternaryComparisons_2Eordering @ ( c_2Etoto_2Eapto_2E3 @ ( s @ ( tyop_2Etoto_2Etoto @ A_27a ) @ V0c_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V2y_2E0 ) ) ) )
          = mono_2Ec_2EternaryComparisons_2ELESS )
