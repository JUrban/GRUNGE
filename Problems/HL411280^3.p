...
thf(thm_2Ereal__topology_2EPASTING__LEMMA,axiom,(
    ! [A_27a: $tType,V0f: A_27a > tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V1g: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2t: A_27a > tyop_2Erealax_2Ereal > $o,V3s: tyop_2Erealax_2Ereal > $o,V4k: A_27a > $o] :
      ( ( ! [V5i: A_27a] :
            ( ( c_2Ebool_2EIN @ A_27a @ V5i @ V4k )
           => ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ V3s ) @ ( V2t @ V5i ) )
              & ( c_2Ereal__topology_2Econtinuous__on @ ( V0f @ V5i ) @ ( V2t @ V5i ) ) ) )
        & ! [V6i: A_27a,V7j: A_27a,V8x: tyop_2Erealax_2Ereal] :
            ( ( ( c_2Ebool_2EIN @ A_27a @ V6i @ V4k )
              & ( c_2Ebool_2EIN @ A_27a @ V7j @ V4k )
              & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V8x @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ ( c_2Epred__set_2EINTER @ tyop_2Erealax_2Ereal @ V3s @ ( V2t @ V6i ) ) @ ( V2t @ V7j ) ) ) )
           => ( ( V0f @ V6i @ V8x )
              = ( V0f @ V7j @ V8x ) ) )
        & ! [V9x: tyop_2Erealax_2Ereal] :
            ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V9x @ V3s )
           => ? [V10j: A_27a] :
                ( ( c_2Ebool_2EIN @ A_27a @ V10j @ V4k )
                & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V9x @ ( V2t @ V10j ) )
                & ( ( V1g @ V9x )
                  = ( V0f @ V10j @ V9x ) ) ) ) )
     => ( c_2Ereal__topology_2Econtinuous__on @ V1g @ V3s ) ) )).

thf(thm_2Ereal__topology_2ECONTINUOUS__ON__UNION__LOCAL__OPEN,conjecture,(
    ! [V0t: tyop_2Erealax_2Ereal > $o,V1f: tyop_2Erealax_2Ereal > tyop_2Erealax_2Ereal,V2s: tyop_2Erealax_2Ereal > $o] :
      ( ( ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V2s @ V0t ) ) @ V2s )
        & ( c_2Etopology_2Eopen__in @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Esubtopology @ tyop_2Erealax_2Ereal @ c_2Ereal__topology_2Eeuclidean @ ( c_2Epred__set_2EUNION @ tyop_2Erealax_2Ereal @ V2s @ V0t ) ) @ V0t )
