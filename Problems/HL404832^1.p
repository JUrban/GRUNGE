...
thf(f5207_0_2E0,type,(
    f5207_0_2E0: u )).

thf(f5207_0_2E2,type,(
    f5207_0_2E2: du > du > u )).
...
thf(arityeq2_2Emono_2Ef5207_0_2E2_2Emono_2EA_27b,axiom,(
    ! [A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5207_0_2E2 @ ( s @ A_27b @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) ) )
      = ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ ( tyop_2Emin_2Efun @ A_27b @ tyop_2Emin_2Ebool ) ) @ f5207_0_2E0 ) @ ( s @ A_27b @ X0_2E0 ) ) ) @ ( s @ A_27b @ X1_2E0 ) ) ) ) ) )).
...
thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFLOOKUP_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ X0_2E0 ) @ ( s @ A_27b @ X1_2E0 ) ) )
...
thf(arityeq2_2Emono_2Ec_2Efinite__map_2EFUPDATE_2E2_2Emono_2EA_27b_20mono_2EA_27a,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ X0_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ X1_2E0 ) ) )
...
thf(def0_2Ethm_2Efinite__map_2EFLOOKUP__UPDATE,axiom,(
    ! [A_27b: d,V2k1_2E0: u,V1k2_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( f5207_0_2E2 @ ( s @ A_27b @ V2k1_2E0 ) @ ( s @ A_27b @ V1k2_2E0 ) ) ) )
    <=> ( ( s @ A_27b @ V2k1_2E0 )
        = ( s @ A_27b @ V1k2_2E0 ) ) ) )).

thf(thm_2Efinite__map_2EFLOOKUP__UPDATE,axiom,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1k2_2E0: u,V2k1_2E0: u,V3fm_2E0: u] :
      ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ ( c_2Efinite__map_2EFUPDATE_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V3fm_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27b @ A_27a ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27b @ V2k1_2E0 ) @ ( s @ A_27a @ V0v_2E0 ) ) ) ) ) @ ( s @ A_27b @ V1k2_2E0 ) ) )
      = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( f5207_0_2E2 @ ( s @ A_27b @ V2k1_2E0 ) @ ( s @ A_27b @ V1k2_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0v_2E0 ) ) ) @ ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V3fm_2E0 ) @ ( s @ A_27b @ V1k2_2E0 ) ) ) ) ) ) )).

thf(thm_2Efinite__map_2EFRANGE__FLOOKUP,axiom,(
    ! [A_27a: d,A_27b: d,V0v_2E0: u,V1f_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0v_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Efinite__map_2EFRANGE_2E1 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V1f_2E0 ) ) ) ) ) )
    <=> ? [V2k_2E0: u] :
          ( ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Efinite__map_2EFLOOKUP_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27b @ A_27a ) @ V1f_2E0 ) @ ( s @ A_27b @ V2k_2E0 ) ) )
          = ( s @ ( tyop_2Eoption_2Eoption @ A_27a ) @ ( c_2Eoption_2ESOME_2E1 @ ( s @ A_27a @ V0v_2E0 ) ) ) ) ) )).
...
thf(thm_2Efinite__map_2EFRANGE__FUPDATE__LIST__SUBSET,conjecture,(
