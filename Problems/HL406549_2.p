...
tff(conj_thm_2Ewords_2Ebit__count__upto__is__zero,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__extract,lemma,(
...
tff(conj_thm_2Ealignment_2Ealigned__bit__count__upto,conjecture,(
    ! [A_27a: del,V0p: tp__ty_2Enum_2Enum,V1w: $i] :
      ( mem(V1w,ty_2Efcp_2Ecart(bool,bool))
     => ( p(ap(ap(c_2Ealignment_2Ealigned(A_27a),inj__ty_2Enum_2Enum(V0p)),V1w))
