...
fof(conj_thm_2Erich__list_2Eel__map__count,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0n] :
          ( mem(V0n,ty_2Enum_2Enum)
         => ! [V1f] :
             ...
             => ! [V2m] :
                 ...
                 => ( p(ap(ap(c_2Eprim__rec_2E_3C,V0n),V2m))
                   => ap(ap(c_2Elist_2EEL(A_27a),V0n),ap(ap(c_2Elist_2EMAP(ty_2Enum_2Enum,ty_2Enum_2Enum),V1f),ap(c_2Erich__list_2ECOUNT__LIST,V2m))) = ap(V1f,V0n) ) ) ) ) ) )).
