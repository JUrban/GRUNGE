...
thf(thm_2Elist_2ELENGTH__dropWhile__LESS__EQ,conjecture,(
    ! [A_27a: $tType,V0P: A_27a > $o,V1ls: tyop_2Elist_2Elist @ A_27a] :
      ( c_2Earithmetic_2E_3C_3D @ ( c_2Elist_2ELENGTH @ A_27a @ ( c_2Elist_2EdropWhile @ A_27a @ V0P @ V1ls ) ) @ ( c_2Elist_2ELENGTH @ A_27a @ V1ls ) ) )).
