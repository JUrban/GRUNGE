...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__NO__LIMPT,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ( ~ ? [V2x: tp__ty_2Erealax_2Ereal] : p(ap(ap(c_2Ereal__topology_2Elimit__point__of,inj__ty_2Erealax_2Ereal(V2x)),V1s))
           => p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s)) ) ) ) )).
