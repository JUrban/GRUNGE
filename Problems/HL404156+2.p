...
fof(mem_c_2Epath_2EfirstP__at,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
          ( ne(A_27b)
         => mem(c_2Epath_2EfirstP__at(A_27a,A_27a),arr(arr(A_27a,bool),arr(ty_2Epath_2Epath(A_27a,A_27a),arr(ty_2Enum_2Enum,bool)))) ) ) )).
...
fof(conj_thm_2Epath_2EfirstP__at__thm,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ( ! [V0P] :
               ...
               => ! [V1x] :
                   ...
                   => ! [V2n] :
                       ...
                       => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),ap(c_2Epath_2Estopped__at(A_27a,A_27a),V1x)),V2n))
                        <=> ( V2n = c_2Enum_2E0
                            & p(ap(V0P,V1x)) ) ) ) ) )
            & ! [V3P] :
                   ...
                   => ! [V5x] :
                       ...
                       => ! [V6r] :
                           ...
                           => ! [V7p] :
                               ...
                               => ( p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V3P),ap(ap(ap(c_2Epath_2Epcons(A_27a,A_27a),V5x),V6r),V7p)),V4n))
                                <=> ( ( V4n = c_2Enum_2E0
                                      & p(ap(V3P,V5x)) )
                                    | ( p(ap(ap(c_2Eprim__rec_2E_3C,c_2Enum_2E0),V4n))
                                      & ~ p(ap(V3P,V5x))
                                      & p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V3P),V7p),ap(ap(c_2Earithmetic_2E_2D,V4n),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))) ) ) ) ) ) ) ) ) ) ) ) )).
             ...
             => ! [V1p] :
                 ...
                 => ( p(ap(ap(c_2Epath_2Eexists(A_27a,A_27a),V0P),V1p))
                  <=> ? [V2i] :
                        ...
                        & p(ap(ap(ap(c_2Epath_2EfirstP__at(A_27a,A_27a),V0P),V1p),V2i)) ) ) ) ) ) ) )).

fof(conj_thm_2Epath_2Eexists__thm,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
