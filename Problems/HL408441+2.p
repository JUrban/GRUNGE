...
fof(conj_thm_2Etransc_2EDIFF__LN,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
...
fof(conj_thm_2Etransc_2ERPOW__DIV__BASE,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1t] :
...
fof(conj_thm_2Etransc_2EDIFF__COMPOSITE__EXP,lemma,(
    ! [V0g] :
      ( mem(V0g,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1m] :
...
fof(lamtp_f3005,axiom,(
    ! [V1y] :
      ( mem(V1y,ty_2Erealax_2Ereal)
     => mem(f3005(V1y),arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal)) ) )).
...
fof(lameq_f3005,axiom,(
    ! [V1y] :
     ...
     => ! [V2x] :
          ( mem(V2x,ty_2Erealax_2Ereal)
         => ap(f3005(V1y),V2x) = ap(ap(c_2Etransc_2Erpow,V2x),V1y) ) ) )).

fof(conj_thm_2Etransc_2EDIFF__RPOW,conjecture,(
    ! [V0x] :
      ( mem(V0x,ty_2Erealax_2Ereal)
     => ! [V1y] :
          ( mem(V1y,ty_2Erealax_2Ereal)
         => ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)),V0x))
           => p(ap(ap(ap(c_2Elim_2Ediffl,f3005(V1y)),ap(ap(c_2Erealax_2Ereal__mul,V1y),ap(ap(c_2Etransc_2Erpow,V0x),ap(ap(c_2Ereal_2Ereal__sub,V1y),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))))),V0x)) ) ) ) )).
