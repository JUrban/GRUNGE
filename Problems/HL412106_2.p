...
tff(conj_thm_2Epred__set_2EINSERT__SING__UNION,lemma,(
    ! [A_27a: del,V0s: $i] :
      ( mem(V0s,arr(A_27a,bool))
     => ! [V1x: $i] :
          ( mem(V1x,A_27a)
...
tff(conj_thm_2Eprobability_2EPROB__REAL__SUM__IMAGE,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
              ...
              & p(ap(c_2Epred__set_2EFINITE(A_27a),V1s)) )
           => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1s)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27a),f4236(A_27a,A_27a,V0p)),V1s)) ) ) ) )).
