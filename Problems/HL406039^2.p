...
thf(conj_thm_2Ewords_2ELSR__BITWISE,conjecture,(
    ! [A_27a: del] :
      ( ! [V0n: tp__ty_2Enum_2Enum,V1v: $i] :
          ( ( mem @ V1v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ! [V2w: $i] :
              ( ( mem @ V2w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V2w ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V1v ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__and @ A_27a ) @ V2w ) @ V1v ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) )
      & ! [V3n: tp__ty_2Enum_2Enum,V4v: $i] :
          ( ( mem @ V4v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ! [V5w: $i] :
              ( ( mem @ V5w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V5w ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V4v ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__or @ A_27a ) @ V5w ) @ V4v ) ) @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) ) )
      & ! [V6n: tp__ty_2Enum_2Enum,V7v: $i] :
          ( ( mem @ V7v @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
         => ! [V8w: $i] :
              ( ( mem @ V8w @ ( ty_2Efcp_2Ecart @ bool @ A_27a ) )
             => ( ( ap @ ( ap @ ( c_2Ewords_2Eword__xor @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V8w ) @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ V7v ) @ ( inj__ty_2Enum_2Enum @ V6n ) ) )
                = ( ap @ ( ap @ ( c_2Ewords_2Eword__lsr @ A_27a ) @ ( ap @ ( ap @ ( c_2Ewords_2Eword__xor @ A_27a ) @ V8w ) @ V7v ) ) @ ( inj__ty_2Enum_2Enum @ V6n ) ) ) ) ) ) )).
