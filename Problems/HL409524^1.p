...
thf(f11252_0_2E0,type,(
    f11252_0_2E0: u )).

thf(f11252_0_2E1,type,(
    f11252_0_2E1: du > u )).

thf(f11252_0_2E2,type,(
    f11252_0_2E2: du > du > u )).
...
thf(mono_2Ef11252_0,type,(
    mono_2Ef11252_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Eutil__prob_2EINF__DEF__ALT,axiom,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o,V1r: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef11252_0 @ V0p @ V1r )
      = ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Erealax_2Ereal__neg @ V1r ) @ V0p ) ) )).

thf(thm_2Eutil__prob_2EINF__DEF__ALT,conjecture,(
    ! [V0p: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ereal_2Einf @ V0p )
      = ( mono_2Ec_2Erealax_2Ereal__neg @ ( mono_2Ec_2Ereal_2Esup @ ( mono_2Ef11252_0 @ V0p ) ) ) ) )).
