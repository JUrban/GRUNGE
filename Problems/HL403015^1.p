...
thf(thm_2EindexedLists_2ELT__SUC,axiom,(
    ...
    <=> ( ( V0n = mono_2Ec_2Enum_2E0 )
        | ? [V2n0: mono_2Etyop_2Enum_2Enum] :
            ( ( V0n
              = ( mono_2Ec_2Enum_2ESUC @ V2n0 ) )
            & ( mono_2Ec_2Eprim__rec_2E_3C @ V2n0 @ V1m ) ) ) ) )).
...
thf(thm_2EindexedLists_2EMEM__MAPi,conjecture,(
    ! [A_27a: d,A_27b: d,V0x_2E0: u,V1f_2E0: u,V2l_2E0: u] :
      ( ( j_mono_2Etyop_2Emin_2Ebool @ ( s @ tyop_2Emin_2Ebool @ ( c_2Ebool_2EIN_2E2 @ ( s @ A_27a @ V0x_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ tyop_2Emin_2Ebool ) @ ( c_2Elist_2ELIST__TO__SET_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2EindexedLists_2EMAPi_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V1f_2E0 ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) ) ) ) )
    <=> ? [V3n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3n @ ( j_mono_2Etyop_2Enum_2Enum @ ( s @ tyop_2Enum_2Enum @ ( c_2Elist_2ELENGTH_2E1 @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) )
          & ( ( s @ A_27a @ V0x_2E0 )
            = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ ( tyop_2Emin_2Efun @ A_27b @ A_27a ) ) @ V1f_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) ) ) @ ( s @ A_27b @ ( c_2Elist_2EEL_2E2 @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3n ) ) @ ( s @ ( tyop_2Elist_2Elist @ A_27b ) @ V2l_2E0 ) ) ) ) ) ) ) ) )).
