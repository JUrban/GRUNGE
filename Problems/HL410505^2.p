...
thf(conj_thm_2Ereal__topology_2ESPANNING__SUBSET__INDEPENDENT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2EIN__SPAN__DELETE,lemma,(
...
thf(conj_thm_2Ereal__topology_2ESPAN__TRANS,lemma,(
...
thf(conj_thm_2Ereal__topology_2EEXCHANGE__LEMMA,conjecture,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
