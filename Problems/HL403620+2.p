...
fof(conj_thm_2Efcp_2EFCP__APPLY__UPDATE__THM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0index_20out_20of_20range] :
             ...
             => ! [V1m] :
                  ( mem(V1m,ty_2Efcp_2Ecart(A_27a,A_27a))
                 => ! [V2a] :
                     ...
                     => ! [V3w] :
                         ...
                         => ! [V4b] :
                             ...
                             => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),V2a),V3w),V1m)),V4b) = ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Eprim__rec_2E_3C,V4b),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b)))),ap(ap(ap(c_2Ebool_2ECOND(A_27a),ap(ap(c_2Emin_2E_3D(ty_2Enum_2Enum),V2a),V4b)),V3w),ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),V1m),V4b))),ap(ap(ap(ap(c_2Ecombin_2EFAIL(arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a)),arr(ty_2Efcp_2Ecart(A_27a,A_27a),arr(ty_2Enum_2Enum,A_27a))),c_2Efcp_2Efcp__index(A_27a,A_27a)),V0index_20out_20of_20range),ap(ap(ap(c_2Efcp_2E_3A_2B(A_27a,A_27a),V2a),V3w),V1m)),V4b)) ) ) ) ) ) ) ) )).
