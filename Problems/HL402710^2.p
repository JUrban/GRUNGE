...
thf(conj_thm_2Erich__list_2ESEG__APPEND1,conjecture,(
    ! [A_27a: del,V0n: tp__ty_2Enum_2Enum,V1m: tp__ty_2Enum_2Enum,V2l1: $i] :
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) ) @ ( ap @ ( c_2Elist_2ELENGTH @ A_27a ) @ V2l1 ) ) )
       => ! [V3l2: $i] :
           ...
           => ( ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ ( ap @ ( ap @ ( c_2Elist_2EAPPEND @ A_27a ) @ V2l1 ) @ V3l2 ) )
              = ( ap @ ( ap @ ( ap @ ( c_2Erich__list_2ESEG @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1m ) ) @ V2l1 ) ) ) ) ) )).
