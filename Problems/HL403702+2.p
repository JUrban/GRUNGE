...
fof(conj_thm_2Elist_2EGENLIST__APPEND,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
          ( mem(V0f,arr(ty_2Enum_2Enum,A_27a))
...
fof(conj_thm_2Elist_2ESUM__APPEND,lemma,(
    ! [V0l1] :
...
fof(conj_thm_2Esorting_2ESUM__IMAGE__count__SUM__GENLIST,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Esorting_2ESUM__IMAGE__count__MULT,conjecture,(
    ! [V0n] :
      ( mem(V0n,ty_2Enum_2Enum)
     => ! [V1g] :
