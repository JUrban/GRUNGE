...
tff(conj_thm_2Elist_2ELENGTH__o__REVERSE,conjecture,(
    ! [A_27a: del,A_27b: del,A_27c: del,V0f: $i] :
      ( mem(V0f,arr(A_27b,ty_2Elist_2Elist(A_27c)))
     => ( ap(ap(c_2Ecombin_2Eo(ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a),ty_2Elist_2Elist(A_27a)),c_2Elist_2ELENGTH(A_27a)),c_2Elist_2EREVERSE(A_27a)) = c_2Elist_2ELENGTH(A_27a)
        & ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Elist_2ELENGTH(A_27c)),ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Elist_2EREVERSE(A_27c)),V0f)) = ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),c_2Elist_2ELENGTH(A_27c)),V0f) ) ) )).
