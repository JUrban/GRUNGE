...
thf(conj_thm_2Efcp_2Efcp__subst__comp,conjecture,(
             ...
             => ! [V4f: $i] :
                 ...
                 => ( ( ap @ ( ap @ ( ap @ ( c_2Efcp_2E_3A_2B @ A_27a @ A_27b ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ V1y ) @ ( ap @ ( c_2Efcp_2EFCP @ A_27a @ A_27b ) @ V4f ) )
                    = ( ap @ ( c_2Efcp_2EFCP @ A_27a @ A_27b )
                      @ ( lam @ ty_2Enum_2Enum
                        @ ^ [V5c: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27a ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V0x ) ) @ V5c ) ) @ V1y ) @ ( ap @ V4f @ V5c ) ) ) ) ) ) ) ) ) )).
