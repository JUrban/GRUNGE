...
thf(c_2Eordinal_2EordDIV,type,(
    c_2Eordinal_2EordDIV: 
      !>[A_27a: $tType] :
        ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > ( tyop_2Eordinal_2Eordinal @ A_27a ) > ( tyop_2Eordinal_2Eordinal @ A_27a ) ) )).
...
thf(c_2Eordinal_2EordMOD,type,(
    c_2Eordinal_2EordMOD: 
      !>[A_27a: $tType] :
        ( ( tyop_2Eordinal_2Eordinal @ A_27a ) > ( tyop_2Eordinal_2Eordinal @ A_27a ) > ( tyop_2Eordinal_2Eordinal @ A_27a ) ) )).
...
thf(thm_2Eordinal_2Eordlt__trichotomy,axiom,(
    ! [A_27a: $tType,V0w2: tyop_2Eordinal_2Eordinal @ A_27a,V1w1: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ V1w1 @ V0w2 )
      | ( V1w1 = V0w2 )
      | ( c_2Eordinal_2Eordlt @ A_27a @ V0w2 @ V1w1 ) ) )).
...
thf(thm_2Eordinal_2EordADD__0L,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2EordADD @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ V0a )
      = V0a ) )).
...
thf(thm_2Eordinal_2EleqLEFT__CANCEL,axiom,(
    ! [A_27a: $tType,V0x: tyop_2Eordinal_2Eordinal @ A_27a,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( (~) @ ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EordADD @ A_27a @ V1a @ V0x ) @ V0x ) ) )).
...
thf(thm_2Eordinal_2EordDIVISION,axiom,(
    ! [A_27a: $tType,V0a: tyop_2Eordinal_2Eordinal @ A_27a,V1b: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EfromNat @ A_27a @ c_2Enum_2E0 ) @ V1b )
     => ( ( V0a
          = ( c_2Eordinal_2EordADD @ A_27a @ ( c_2Eordinal_2EordMULT @ A_27a @ V1b @ ( c_2Eordinal_2EordDIV @ A_27a @ V0a @ V1b ) ) @ ( c_2Eordinal_2EordMOD @ A_27a @ V0a @ V1b ) ) )
        & ( c_2Eordinal_2Eordlt @ A_27a @ ( c_2Eordinal_2EordMOD @ A_27a @ V0a @ V1b ) @ V1b ) ) ) )).
...
thf(thm_2EordNotationSemantics_2EaddL__disappears,conjecture,(
    ! [A_27a: $tType,V0e: tyop_2Eordinal_2Eordinal @ A_27a,V1a: tyop_2Eordinal_2Eordinal @ A_27a] :
      ( ( c_2Eordinal_2Eordlt @ A_27a @ V1a @ ( c_2Eordinal_2EordEXP @ A_27a @ ( c_2Eordinal_2Eomega @ A_27a ) @ V0e ) )
     => ( ( c_2Eordinal_2EordADD @ A_27a @ V1a @ ( c_2Eordinal_2EordEXP @ A_27a @ ( c_2Eordinal_2Eomega @ A_27a ) @ V0e ) )
        = ( c_2Eordinal_2EordEXP @ A_27a @ ( c_2Eordinal_2Eomega @ A_27a ) @ V0e ) ) ) )).
