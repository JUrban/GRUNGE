...
fof(mem_c_2Ewords_2Ereduce__nor,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => mem(c_2Ewords_2Ereduce__nor(A_27a),arr(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool))) ) )).
...
fof(lamtp_f2177,axiom,(
    ! [V0a] :
      ( mem(V0a,bool)
     => mem(f2177(V0a),arr(bool,bool)) ) )).
...
fof(lameq_f2177,axiom,(
    ! [V0a] :
     ...
     => ! [V1b] :
          ( mem(V1b,bool)
         => ap(f2177(V0a),V1b) = ap(c_2Ebool_2E_7E,ap(ap(c_2Ebool_2E_5C_2F,V0a),V1b)) ) ) )).

fof(lamtp_f2176,axiom,(
    mem(f2176,arr(bool,arr(bool,bool))) )).

fof(lameq_f2176,axiom,(
    ! [V0a] :
      ( mem(V0a,bool)
     => ap(f2176,V0a) = f2177(V0a) ) )).

fof(ax_thm_2Ewords_2Ereduce__nor__def,axiom,(
    ! [A_27a] :
      ( ne(A_27a)
     => c_2Ewords_2Ereduce__nor(A_27a) = ap(c_2Ewords_2Eword__reduce(A_27a),f2176) ) )).
...
fof(lameq_f2238,axiom,(
    ! [V1l] :
     ...
     => ap(f2238,V1l) = ap(ap(ap(c_2Elist_2EFOLDL(ty_2Efcp_2Ecart(bool,bool),ty_2Efcp_2Ecart(bool,bool)),c_2Ewords_2Eword__nor(ty_2Eone_2Eone)),ap(c_2Elist_2EHD(ty_2Efcp_2Ecart(bool,bool)),V1l)),ap(c_2Elist_2ETL(ty_2Efcp_2Ecart(bool,bool)),V1l)) ) )).

fof(conj_thm_2Ewords_2Efoldl__reduce__nor,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0w] :
          ( mem(V0w,ty_2Efcp_2Ecart(bool,bool))
         => ap(c_2Ewords_2Ereduce__nor(A_27a),V0w) = ap(ap(c_2Ebool_2ELET(ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool)),ty_2Elist_2Elist(ty_2Efcp_2Ecart(bool,bool))),f2238),ap(ap(c_2Elist_2EGENLIST(ty_2Efcp_2Ecart(bool,bool)),f2233(A_27a,V0w)),ap(c_2Efcp_2Edimindex(A_27a),c_2Ebool_2Ethe__value(A_27a)))) ) ) )).
