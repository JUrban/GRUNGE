...
tff(c_2Erelation_2ERRANGE_2E0,type,(
    c_2Erelation_2ERRANGE_2E0: u )).

tff(c_2Erelation_2ERRANGE_2E1,type,(
    c_2Erelation_2ERRANGE_2E1: du > u )).

tff(c_2Erelation_2ERRANGE_2E2,type,(
    c_2Erelation_2ERRANGE_2E2: ( du * du ) > u )).
...
tff(arityeq2_2Ec_2Erelation_2ERRANGE_2E2,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u,X1_2E0: u] : j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2ERRANGE_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),X0_2E0),s(A_27b,X1_2E0)))) = j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),c_2Erelation_2ERRANGE_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),X0_2E0))),s(A_27b,X1_2E0)))) )).

tff(arityeq1_2Ec_2Erelation_2ERRANGE_2E1,axiom,(
    ! [A_27a: d,A_27b: d,X0_2E0: u] : s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Erelation_2ERRANGE_2E1(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),X0_2E0))) = s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),c_2Erelation_2ERRANGE_2E0),s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),X0_2E0))) )).
...
tff(thm_2Erelation_2ERRANGE,axiom,(
    ! [A_27a: d,A_27b: d,V0R_2E0: u,V1y_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2ERRANGE_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),V0R_2E0),s(A_27b,V1y_2E0)))))
    <=> ? [V2x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Ebool)),V0R_2E0),s(A_27a,V2x_2E0))),s(A_27b,V1y_2E0))))) ) )).

tff(thm_2Erelation_2EIN__RRANGE,conjecture,(
    ! [A_27a: d,A_27b: d,V0y_2E0: u,V1R_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Ebool_2EIN_2E2(s(A_27a,V0y_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),c_2Erelation_2ERRANGE_2E1(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V1R_2E0)))))))
    <=> ? [V2x_2E0: u] : p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(A_27b,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V1R_2E0),s(A_27b,V2x_2E0))),s(A_27a,V0y_2E0))))) ) )).
