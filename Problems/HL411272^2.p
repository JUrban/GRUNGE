...
thf(conj_thm_2Ebool_2EMONO__NOT__EQ,lemma,(
    ! [V0y: $o,V1x: $o] :
      ( ( ( p @ ( inj__o @ V0y ) )
       => ( p @ ( inj__o @ V1x ) ) )
    <=> ( ~ ( p @ ( inj__o @ V1x ) )
...
thf(conj_thm_2Ecardinal_2ERIGHT__IMP__EXISTS__THM,lemma,(
    ! [A_27a: del,V0P: $o,V1Q: $i] :
      ( ( mem @ V1Q @ ( arr @ A_27a @ bool ) )
     => ( ( ( p @ ( inj__o @ V0P ) )
         => ? [V2x: $i] :
...
thf(conj_thm_2Ecardinal_2ESING__SUBSET,lemma,(
    ! [A_27a: del,V0s: $i] :
...
thf(conj_thm_2Ereal__topology_2EFORALL__FINITE__SUBSET__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1f: $i] :
          ( ( mem @ V1f @ ( arr @ A_27b @ A_27a ) )
...
thf(conj_thm_2Ereal__topology_2EUPPER__BOUND__FINITE__SET,lemma,(
    ! [A_27a: del,V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2EBIGINTER__IMAGE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
              ...
              @ ( lam @ A_27b
                @ ^ [V2y: $i] :
                    ...
                    @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                      @ ( lam @ A_27a
                        @ ^ [V3x: $i] :
                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V3x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V2y ) @ ( ap @ V0f @ V3x ) ) ) ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSED__IN__IMP__SUBSET,lemma,(
    ! [A_27a: del,V0top: $i] :
...
thf(conj_thm_2Ereal__topology_2EOPEN__BIGUNION,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ETOPSPACE__EUCLIDEAN__SUBTOPOLOGY,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ( ( ap @ ( c_2Etopology_2Etopspace @ ty_2Erealax_2Ereal ) @ ( ap @ ( ap @ ( c_2Ereal__topology_2Esubtopology @ ty_2Erealax_2Ereal ) @ c_2Ereal__topology_2Eeuclidean ) @ V0s ) )
        = V0s ) ) )).

thf(conj_thm_2Ereal__topology_2EBIGINTER__GSPEC,lemma,(
    ! [A_27a: del,A_27b: del,A_27c: del,A_27d: del,A_27e: del,A_27f: del,A_27g: del,A_27h: del,A_27i: del] :
      ( ! [V0P: $i] :
         ...
         => ! [V1f: $i] :
             ...
             => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27b )
                  ...
                  @ ( lam @ A_27b
                    @ ^ [V3a: $i] :
                        ...
                        @ ( ap @ ( c_2Ebool_2E_21 @ A_27a )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ V0P @ V4x ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3a ) @ ( ap @ V1f @ V4x ) ) ) ) ) ) ) ) ) ) )
      & ! [V5P: $i] :
          ( ( mem @ V5P @ ( arr @ A_27c @ ( arr @ A_27d @ bool ) ) )
         => ! [V6f: $i] :
              ( ( mem @ V6f @ ( arr @ A_27c @ ( arr @ A_27d @ ( arr @ A_27e @ bool ) ) ) )
             => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27e )
                        ...
                        @ ( ap @ ( c_2Ebool_2E_21 @ A_27c )
                          @ ( lam @ A_27c
                            @ ^ [V10x: $i] :
                                ...
                                @ ( lam @ A_27d
                                  @ ^ [V11y: $i] :
                                      ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ V5P @ V10x ) @ V11y ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27e ) @ V9a ) @ ( ap @ ( ap @ V6f @ V10x ) @ V11y ) ) ) ) ) ) ) ) ) ) ) ) )
      & ! [V12P: $i] :
          ( ( mem @ V12P @ ( arr @ A_27f @ ( arr @ A_27g @ ( arr @ A_27h @ bool ) ) ) )
         => ! [V13f: $i] :
              ( ( mem @ V13f @ ( arr @ A_27f @ ( arr @ A_27g @ ( arr @ A_27h @ ( arr @ A_27i @ bool ) ) ) ) )
             => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ A_27i )
                ...
                = ( ap @ ( c_2Epred__set_2EGSPEC @ A_27i @ A_27i )
                  @ ( lam @ A_27i
                    @ ^ [V17a: $i] :
                        ...
                        @ ( ap @ ( c_2Ebool_2E_21 @ A_27f )
                          @ ( lam @ A_27f
                            @ ^ [V18x: $i] :
                                ( ap @ ( c_2Ebool_2E_21 @ A_27g )
                                @ ( lam @ A_27g
                                  @ ^ [V19y: $i] :
                                      ( ap @ ( c_2Ebool_2E_21 @ A_27h )
                                      @ ( lam @ A_27h
                                        @ ^ [V20z: $i] :
                                            ( ap @ ( ap @ c_2Emin_2E_3D_3D_3E @ ( ap @ ( ap @ ( ap @ V12P @ V18x ) @ V19y ) @ V20z ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27i ) @ V17a ) @ ( ap @ ( ap @ ( ap @ V13f @ V18x ) @ V19y ) @ V20z ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2ECLOSED__IN__CLOSED,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1u: $i] :
          ( ( mem @ V1u @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECLOSED__IN__LIMPT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
...
thf(conj_thm_2Ereal__topology_2ELIMPT__SEQUENTIAL__INJ,lemma,(
     ...
     => ( ( p @ ( ap @ ( ap @ c_2Ereal__topology_2Elimit__point__of @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V1s ) )
      <=> ? [V2f: $i] :
            ...
            & ! [V3n: tp__ty_2Enum_2Enum] :
                ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V3n ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ty_2Erealax_2Ereal ) @ V1s ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) )
            & ! [V4m: tp__ty_2Enum_2Enum,V5n: tp__ty_2Enum_2Enum] :
                ( ( ( surj__ty_2Erealax_2Ereal @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V4m ) ) )
                  = ( surj__ty_2Erealax_2Ereal @ ( ap @ V2f @ ( inj__ty_2Enum_2Enum @ V5n ) ) ) )
              <=> ( V4m = V5n ) )
...
thf(conj_thm_2Ereal__topology_2ESEQ__OFFSET,lemma,(
    ! [V0f: $i] :
            ...
            @ ( ap
              @ ( ap
                @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum )
                  @ ( lam @ ty_2Enum_2Enum
                    @ ^ [V3i: $i] :
                        ( ap @ V0f @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ V3i ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) ) )
                @ ( inj__ty_2Erealax_2Ereal @ V1l ) )
              @ c_2Ereal__topology_2Esequentially ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECOMPACT__EQ__HEINE__BOREL,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__SEQUENCE__WITH__LIMIT,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) )
     => ! [V1l: tp__ty_2Erealax_2Ereal] :
          ( ( p @ ( ap @ ( ap @ ( ap @ ( c_2Ereal__topology_2E_2D_2D_3E @ ty_2Enum_2Enum ) @ V0f ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ c_2Ereal__topology_2Esequentially ) )
         => ( p @ ( ap @ c_2Ereal__topology_2Ecompact @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ty_2Erealax_2Ereal ) @ ( inj__ty_2Erealax_2Ereal @ V1l ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2EIMAGE @ ty_2Enum_2Enum @ ty_2Erealax_2Ereal ) @ V0f ) @ ( c_2Epred__set_2EUNIV @ ty_2Enum_2Enum ) ) ) ) ) ) ) )).

thf(conj_thm_2Ereal__topology_2ECLOSED__INTER__COMPACT,lemma,(
    ! [V0s: $i] :
      ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
     => ! [V1t: $i] :
          ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ECOMPACT__FIP,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ( arr @ ty_2Erealax_2Ereal @ bool ) @ bool ) )
     => ( ( ! [V1t: $i] :
              ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
          ...
          & ! [V2f_27: $i] :
             ...
             => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ ty_2Erealax_2Ereal @ bool ) ) @ V2f_27 ) )
               ...
               => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V2f_27 )
                 != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )
       => ( ( ap @ ( c_2Epred__set_2EBIGINTER @ ty_2Erealax_2Ereal ) @ V0f )
         != ( c_2Epred__set_2EEMPTY @ ty_2Erealax_2Ereal ) ) ) ) )).
...
thf(conj_thm_2Ereal__topology_2EPROPER__MAP,conjecture,(
    ! [V0f: $i] :
                          ...
                          @ ( ap @ c_2Ereal__topology_2Ecompact
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V4x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V4x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V4x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V4x ) ) @ V3k ) ) ) ) ) ) ) ) )
                <=> ( ! [V5k: $i] :
                       ...
                       => ( p
                          @ ( ap @ c_2Ereal__topology_2Ecompact
                            @ ( ap @ ( c_2Epred__set_2EGSPEC @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal )
                              @ ( lam @ ty_2Erealax_2Ereal
                                @ ^ [V7x: $i] :
                                    ( ap @ ( ap @ ( c_2Epair_2E_2C @ ty_2Erealax_2Ereal @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ty_2Erealax_2Ereal ) @ V7x ) @ V1s ) ) @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V0f @ V7x ) ) @ ( inj__ty_2Erealax_2Ereal @ V6a ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )).
