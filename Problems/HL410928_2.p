...
tff(lamtp_f3753,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => mem(f3753(A_27a,V1f,V2g),arr(A_27a,bool)) ) ) )).

tff(lameq_f3753,axiom,(
    ! [A_27a: del,V1f: $i] :
      ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V2g: $i] :
          ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V3x: $i] :
              ( mem(V3x,A_27a)
             => ap(f3753(A_27a,V1f,V2g),V3x) = ap(ap(c_2Ereal_2Ereal__lte,ap(c_2Ereal_2Eabs,ap(V1f,V3x))),ap(V2g,V3x)) ) ) ) )).

tff(lmtp_f3754,type,(
    f3754: ( del * $i ) > $i )).

tff(lamtp_f3754,axiom,(
    ! [A_27a: del,V2g: $i] :
      ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
     => mem(f3754(A_27a,V2g),arr(A_27a,ty_2Erealax_2Ereal)) ) )).

tff(lameq_f3754,axiom,(
    ! [A_27a: del,V2g: $i] :
      ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f3754(A_27a,V2g),V4x) = ap(V2g,V4x) ) ) )).

tff(conj_thm_2Ereal__topology_2ELIM__NULL__COMPARISON,conjecture,(
    ! [A_27a: del,V0net: $i] :
      ( mem(V0net,ty_2Ereal__topology_2Enet(A_27a))
     => ! [V1f: $i] :
          ( mem(V1f,arr(A_27a,ty_2Erealax_2Ereal))
         => ! [V2g: $i] :
              ( mem(V2g,arr(A_27a,ty_2Erealax_2Ereal))
             => ( ( p(ap(ap(c_2Ereal__topology_2Eeventually(A_27a),f3753(A_27a,V1f,V2g)),V0net))
                  & p(ap(ap(ap(c_2Ereal__topology_2E_2D_2D_3E(A_27a),f3754(A_27a,V2g)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),V0net)) )
