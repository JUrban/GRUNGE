...
thf(arityeq1_2Emono_2Ef259_0_2E1_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( f259_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) ) @ f259_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) ) ) ) )).

thf(arityeq2_2Emono_2Ef259_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f259_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27a @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) ) @ f259_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) ) ) @ ( s @ A_27a @ X1_2E0 ) ) ) ) )).
...
thf(arityeq3_2Emono_2Ec_2Ecombin_2EC_2E3_2Emono_2EA_27a_20mono_2EA_27c_20mono_2EA_27b,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ecombin_2EC_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) @ ( s @ A_27c @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( tyop_2Emin_2Efun @ A_27c @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ c_2Ecombin_2EC_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ X0_2E0 ) ) ) @ ( s @ A_27c @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Ecombin_2EC__ABS__L,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V1f_2E0: u,V3x_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( f259_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V3x_2E0 ) ) ) ) )).

thf(thm_2Ecombin_2EC__ABS__L,conjecture,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0y_2E0: u,V1f_2E0: u,V2x_2E0: u] :
      ( ( s @ A_27b @ ( c_2Ecombin_2EC_2E3 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ ( f259_0_2E1 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ V1f_2E0 ) ) ) @ ( s @ A_27c @ V0y_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ ( tyop_2Emin_2Efun @ A_27c @ A_27b ) ) @ V1f_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) @ ( s @ A_27c @ V0y_2E0 ) ) ) ) )).
