...
tff(conj_thm_2Etransc_2ESIN__COS__NEG,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] : surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__add,ap(ap(c_2Ereal_2Epow,ap(ap(c_2Erealax_2Ereal__add,ap(c_2Etransc_2Esin,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)))),ap(c_2Etransc_2Esin,inj__ty_2Erealax_2Ereal(V0x)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))),ap(ap(c_2Ereal_2Epow,ap(ap(c_2Ereal_2Ereal__sub,ap(c_2Etransc_2Ecos,ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x)))),ap(c_2Etransc_2Ecos,inj__ty_2Erealax_2Ereal(V0x)))),ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT2,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO)))))) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))) )).

tff(conj_thm_2Etransc_2ESIN__NEG,conjecture,(
