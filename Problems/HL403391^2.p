...
thf(conj_thm_2Ebag_2EBIG__BAG__UNION__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( c_2Epred__set_2EEMPTY @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) )
      = ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) )).

thf(conj_thm_2Ebag_2EBIG__BAG__UNION__INSERT,lemma,(
    ! [A_27a: del,V0sob: $i] :
     ...
     => ! [V1b: $i] :
         ...
         => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0sob ) )
           => ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V1b ) @ V0sob ) )
              = ( ap @ ( ap @ ( c_2Ebag_2EBAG__UNION @ A_27a ) @ V1b ) @ ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ ( ap @ ( ap @ ( c_2Epred__set_2EDELETE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0sob ) @ V1b ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Epred__set_2EITSET__EMPTY,lemma,(
...
thf(conj_thm_2Ebag_2EBIG__BAG__UNION__ITSET__BAG__UNION,conjecture,(
    ! [A_27a: del,V0sob: $i] :
      ( ( mem @ V0sob @ ( arr @ ( arr @ A_27a @ ty_2Enum_2Enum ) @ bool ) )
     => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ V0sob ) )
       => ( ( ap @ ( c_2Ebag_2EBIG__BAG__UNION @ A_27a ) @ V0sob )
          = ( ap @ ( ap @ ( ap @ ( c_2Epred__set_2EITSET @ ( arr @ A_27a @ ty_2Enum_2Enum ) @ ( arr @ A_27a @ ty_2Enum_2Enum ) ) @ ( c_2Ebag_2EBAG__UNION @ A_27a ) ) @ V0sob ) @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) ) ) ) ) )).
