...
thf(thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE__SUBSET,axiom,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( c_2Epred__set_2Ecountable @ A_27a @ V0s )
     => ? [V1f: tyop_2Enum_2Enum > A_27a] :
          ( c_2Epred__set_2ESUBSET @ A_27a @ V0s @ ( c_2Epred__set_2EIMAGE @ tyop_2Enum_2Enum @ A_27a @ V1f @ ( c_2Epred__set_2EUNIV @ tyop_2Enum_2Enum ) ) ) ) )).
...
thf(thm_2Ecardinal_2ECOUNTABLE__AS__IMAGE,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o] :
      ( ( ( c_2Epred__set_2Ecountable @ A_27a @ V0s )
        & ( (~)
          @ ( V0s
