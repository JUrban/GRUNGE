...
thf(conj_thm_2Earithmetic_2EMOD__MULT,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1r: tp__ty_2Enum_2Enum] :
     ...
     => ! [V2q: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V2q ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__ty_2Enum_2Enum @ V1r ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = V1r ) ) )).

thf(conj_thm_2Earithmetic_2EMOD__PLUS,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( p @ ( ap @ ( ap @ c_2Eprim__rec_2E_3C @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
     => ! [V1j: tp__ty_2Enum_2Enum,V2k: tp__ty_2Enum_2Enum] :
          ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1j ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V2k ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) )
          = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2B @ ( inj__ty_2Enum_2Enum @ V1j ) ) @ ( inj__ty_2Enum_2Enum @ V2k ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) )).

thf(conj_thm_2Earithmetic_2EMOD__COMMON__FACTOR,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1p: tp__ty_2Enum_2Enum,V2q: tp__ty_2Enum_2Enum] :
     ...
     => ( ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( inj__ty_2Enum_2Enum @ V1p ) ) @ ( inj__ty_2Enum_2Enum @ V2q ) ) ) )
        = ( surj__ty_2Enum_2Enum @ ( ap @ ( ap @ c_2Earithmetic_2EMOD @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V1p ) ) ) @ ( ap @ ( ap @ c_2Earithmetic_2E_2A @ ( inj__ty_2Enum_2Enum @ V0n ) ) @ ( inj__ty_2Enum_2Enum @ V2q ) ) ) ) ) ) )).
...
thf(conj_thm_2Earithmetic_2EDOUBLE__LT,lemma,(
...
thf(ax_thm_2Enumeral__bit_2EiMOD__2EXP,axiom,(
...
thf(conj_thm_2Enumeral__bit_2Enumeral__imod__2exp,conjecture,(
    ! [A_27a: del] :
      ( ! [V0n: tp__ty_2Enum_2Enum] :
