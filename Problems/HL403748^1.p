...
thf(thm_2Estring_2ECHR__ONTO,axiom,(
...
thf(thm_2Estring_2ECHAR__INDUCT__THM,conjecture,(
    ! [V0P: mono_2Etyop_2Estring_2Echar > $o] :
      ( ! [V1n: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V1n @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
         => ( V0P @ ( mono_2Ec_2Estring_2ECHR @ V1n ) ) )
     => ! [V2c: mono_2Etyop_2Estring_2Echar] :
          ( V0P @ V2c ) ) )).
