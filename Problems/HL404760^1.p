...
thf(f5269_0_2E0,type,(
    f5269_0_2E0: u )).

thf(f5269_0_2E2,type,(
    f5269_0_2E2: du > du > u )).

thf(f5269_0_2E3,type,(
...
thf(arityeq2_2Emono_2Ef5269_0_2E2_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u] :
      ( ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( f5269_0_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X1_2E0 ) ) )
      = ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ f5269_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X1_2E0 ) ) ) ) )).

thf(arityeq3_2Emono_2Ef5269_0_2E3_2Emono_2EA_27a_20mono_2EA_27b_20mono_2EA_27c,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,X0_2E0: u,X1_2E0: u,X2_2E0: u] :
      ( ( s @ A_27b @ ( f5269_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ X0_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X1_2E0 ) @ ( s @ A_27a @ X2_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ ( tyop_2Emin_2Efun @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ ( tyop_2Emin_2Efun @ A_27a @ A_27b ) ) ) @ f5269_0_2E0 ) @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ X0_2E0 ) ) ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ X1_2E0 ) ) ) @ ( s @ A_27a @ X2_2E0 ) ) ) ) )).
...
thf(def0_2Ethm_2Efinite__map_2EFMAP__MAP2__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1m_2E0: u,V2x_2E0: u] :
      ( ( s @ A_27b @ ( f5269_0_2E3 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ V1m_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) )
      = ( s @ A_27b @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ ( c_2Epair_2E_2C_2E2 @ ( s @ A_27a @ V2x_2E0 ) @ ( s @ A_27c @ ( c_2Efinite__map_2EFAPPLY_2E2 @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ V1m_2E0 ) @ ( s @ A_27a @ V2x_2E0 ) ) ) ) ) ) ) ) )).

thf(thm_2Efinite__map_2EFMAP__MAP2__def,axiom,(
    ! [A_27a: d,A_27b: d,A_27c: d,V0f_2E0: u,V1m_2E0: u] :
      ( ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27b ) @ ( c_2Efinite__map_2EFMAP__MAP2_2E2 @ ( s @ ( tyop_2Emin_2Efun @ ( tyop_2Epair_2Eprod @ A_27a @ A_27c ) @ A_27b ) @ V0f_2E0 ) @ ( s @ ( tyop_2Efinite__map_2Efmap @ A_27a @ A_27c ) @ V1m_2E0 ) ) )
...
thf(thm_2Efinite__map_2EFMAP__MAP2__THM,conjecture,(
