...
thf(f13090_0_2E0,type,(
    f13090_0_2E0: u )).

thf(f13090_0_2E2,type,(
...
thf(mono_2Ef13090_0,type,(
    mono_2Ef13090_0: ( mono_2Etyop_2Erealax_2Ereal > $o ) > mono_2Etyop_2Erealax_2Ereal > $o )).
...
thf(def0_2Ethm_2Ereal__topology_2EINDEPENDENT__INSERT,axiom,(
    ! [V1s: mono_2Etyop_2Erealax_2Ereal > $o,V0a: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef13090_0 @ V1s @ V0a )
...
thf(thm_2Ereal__topology_2EINDEPENDENT__INSERT,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ...
      = ( mono_2Ec_2Ebool_2ECOND_2Emono_2Etyop_2Emin_2Ebool @ ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V0a @ V1s ) @ ( mono_2Ec_2Ereal__topology_2Eindependent @ V1s ) @ ( mono_2Ef13090_0 @ V1s @ V0a ) ) ) )).

thf(thm_2Ereal__topology_2ESPAN__BREAKDOWN__EQ,axiom,(
    ! [V0x: mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2s: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V0x @ ( mono_2Ec_2Ereal__topology_2Espan @ ( mono_2Ec_2Epred__set_2EINSERT_2Emono_2Etyop_2Erealax_2Ereal @ V1a @ V2s ) ) )
    <=> ? [V3k: mono_2Etyop_2Erealax_2Ereal] :
          ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ ( mono_2Ec_2Ereal_2Ereal__sub @ V0x @ ( mono_2Ec_2Erealax_2Ereal__mul @ V3k @ V1a ) ) @ ( mono_2Ec_2Ereal__topology_2Espan @ V2s ) ) ) )).
...
thf(thm_2Ereal__topology_2ELINEAR__INDEPENDENT__EXTEND__LEMMA,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal > $o] :
      ( ( mono_2Ec_2Epred__set_2EFINITE_2Emono_2Etyop_2Erealax_2Ereal @ V1b )
     => ( ( mono_2Ec_2Ereal__topology_2Eindependent @ V1b )
       => ? [V2g: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal] :
            ( ! [V3x: mono_2Etyop_2Erealax_2Ereal,V4y: mono_2Etyop_2Erealax_2Ereal] :
                ( ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V3x @ ( mono_2Ec_2Ereal__topology_2Espan @ V1b ) )
                  & ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V4y @ ( mono_2Ec_2Ereal__topology_2Espan @ V1b ) ) )
               => ( ( V2g @ ( mono_2Ec_2Erealax_2Ereal__add @ V3x @ V4y ) )
                  = ( mono_2Ec_2Erealax_2Ereal__add @ ( V2g @ V3x ) @ ( V2g @ V4y ) ) ) )
            & ! [V5x: mono_2Etyop_2Erealax_2Ereal,V6c: mono_2Etyop_2Erealax_2Ereal] :
                ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V5x @ ( mono_2Ec_2Ereal__topology_2Espan @ V1b ) )
               => ( ( V2g @ ( mono_2Ec_2Erealax_2Ereal__mul @ V6c @ V5x ) )
                  = ( mono_2Ec_2Erealax_2Ereal__mul @ V6c @ ( V2g @ V5x ) ) ) )
            & ! [V7x: mono_2Etyop_2Erealax_2Ereal] :
                ( ( mono_2Ec_2Ebool_2EIN_2Emono_2Etyop_2Erealax_2Ereal @ V7x @ V1b )
               => ( ( V2g @ V7x )
                  = ( V0f @ V7x ) ) ) ) ) ) )).
