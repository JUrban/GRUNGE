...
tff(conj_thm_2Ebag_2ESUB__BAG__EMPTY,lemma,(
    ! [A_27a: del] :
      ( ! [V0b: $i] :
          ( mem(V0b,arr(A_27a,ty_2Enum_2Enum))
...
tff(conj_thm_2Ebag_2ESUB__BAG__INSERT,lemma,(
    ! [A_27a: del,V0e: $i] :
      ( mem(V0e,A_27a)
     => ! [V1b1: $i] :
...
tff(conj_thm_2Ebag_2ENOT__IN__SUB__BAG__INSERT,lemma,(
    ! [A_27a: del,V0b1: $i] :
...
tff(conj_thm_2Ebag_2EFINITE__SUB__BAG,conjecture,(
    ! [A_27a: del,V0b1: $i] :
      ( mem(V0b1,arr(A_27a,ty_2Enum_2Enum))
