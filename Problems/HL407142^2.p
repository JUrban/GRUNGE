...
thf(conj_thm_2Erealax_2EREAL__ADD__LID,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__add @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Erealax_2Ereal__0 ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
      = V0x ) )).

thf(conj_thm_2Ereal_2EREAL__1,conjecture,
