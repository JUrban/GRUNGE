...
thf(thm_2Einteger__word_2EfromString__ind,conjecture,(
    ! [V0P: ( tyop_2Elist_2Elist @ tyop_2Estring_2Echar ) > $o] :
      ( ( ! [V1t: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( V0P @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ ( c_2Estring_2ECHR @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) @ V1t ) )
        & ! [V2t: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( V0P @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ ( c_2Estring_2ECHR @ ( c_2Earithmetic_2ENUMERAL @ ( c_2Earithmetic_2EBIT1 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT2 @ ( c_2Earithmetic_2EBIT1 @ c_2Earithmetic_2EZERO ) ) ) ) ) ) ) @ V2t ) )
        & ( V0P @ ( c_2Elist_2ENIL @ tyop_2Estring_2Echar ) )
        & ! [V3v4: tyop_2Estring_2Echar,V4v1: tyop_2Elist_2Elist @ tyop_2Estring_2Echar] :
            ( V0P @ ( c_2Elist_2ECONS @ tyop_2Estring_2Echar @ V3v4 @ V4v1 ) ) )
