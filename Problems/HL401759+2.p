...
fof(ax_thm_2Epred__set_2EMAX__SET__DEF,axiom,(
    ! [V0s] :
       ...
       => ( ( V0s != c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)
           => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),ap(c_2Epred__set_2EMAX__SET,V0s)),V0s))
              & ! [V1y] :
                 ...
                 => ( p(ap(ap(c_2Ebool_2EIN(ty_2Enum_2Enum),V1y),V0s))
                   => p(ap(ap(c_2Earithmetic_2E_3C_3D,V1y),ap(c_2Epred__set_2EMAX__SET,V0s))) ) ) ) )
          & ( V0s = c_2Epred__set_2EEMPTY(ty_2Enum_2Enum)
           => ap(c_2Epred__set_2EMAX__SET,V0s) = c_2Enum_2E0 ) ) ) ) )).

fof(conj_thm_2Epred__set_2EMAX__SET__ELIM,conjecture,(
    ! [V0P] :
