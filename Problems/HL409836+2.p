...
fof(conj_thm_2Eiterate_2ESUM__GROUP,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2s] :
                     ...
                     => ! [V3t] :
                         ...
                         => ( ( p(ap(c_2Epred__set_2EFINITE(A_27a),V2s))
                           ...
                           => ap(ap(c_2Eiterate_2ESum(A_27b),V3t),f3376(A_27a,A_27b,V0f,V2s,V1g)) = ap(ap(c_2Eiterate_2ESum(A_27a),V2s),V1g) ) ) ) ) ) ) ) )).
