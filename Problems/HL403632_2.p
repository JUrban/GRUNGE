...
tff(conj_thm_2Efcp_2EREAD__L2V,conjecture,(
    ! [A_27a: del,A_27b: del,V0i: tp__ty_2Enum_2Enum,V1a: $i] :
     ...
     => ( p(ap(ap(c_2Eprim__rec_2E_3C,inj__ty_2Enum_2Enum(V0i)),ap(c_2Efcp_2Edimindex(A_27b),c_2Ebool_2Ethe__value(A_27b))))
       => ap(ap(c_2Efcp_2Efcp__index(A_27a,A_27a),ap(c_2Efcp_2EL2V(A_27a,A_27a),V1a)),inj__ty_2Enum_2Enum(V0i)) = ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V0i)),V1a) ) ) )).
