...
thf(conj_thm_2Eres__quan_2ERES__FORALL__UNIV,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
     => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2ERES__FORALL @ A_27a ) @ ( c_2Epred__set_2EUNIV @ A_27a ) ) @ V0p ) )
      <=> ( p @ ( ap @ ( c_2Ebool_2E_21 @ A_27a ) @ V0p ) ) ) ) )).

thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIV,lemma,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
...
thf(conj_thm_2Eres__quan_2ERES__EXISTS__UNIQUE__UNIV,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( ( mem @ V0p @ ( arr @ A_27a @ bool ) )
