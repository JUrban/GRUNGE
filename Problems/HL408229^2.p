...
thf(conj_thm_2Ereal_2EPOW__M1,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Ereal_2Eabs @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( ap @ c_2Erealax_2Ereal__neg @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Earithmetic_2ENUMERAL @ ( ap @ c_2Earithmetic_2EBIT1 @ ( inj__ty_2Enum_2Enum @ fo__c_2Earithmetic_2EZERO ) ) ) ) ) ) @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) )
...
thf(conj_thm_2Etransc_2EEXP__CONVERGES,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap
        @ ( ap @ c_2Eseq_2Esums
            ...
            @ ^ [V1n: $i] :
                ...
                @ ( ap @ c_2Erealax_2Ereal__mul
                  @ ( ap
                    ...
                    @ V1n ) )
                @ ( ap @ ( ap @ c_2Ereal_2Epow @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) @ V1n ) ) ) )
        @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).

thf(conj_thm_2Etransc_2ESIN__CONVERGES,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p
      @ ( ap
        @ ( ap @ c_2Eseq_2Esums
