...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__FORALL______NEW__FV__1,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27c] :
          ( ne(A_27c)
...
fof(conj_thm_2EquantHeuristics_2EGUESS__RULES__EXISTS______NEW__FV__1,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27c] :
          ( ne(A_27c)
