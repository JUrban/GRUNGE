...
tff(conj_thm_2Epred__set_2EINTER__IDEMPOT,lemma,(
    ! [A_27a: del,V0s: $i] :
...
tff(conj_thm_2Eutil__prob_2EREAL__MUL__IDEMPOT,lemma,(
...
tff(tp_c_2Eprobability_2Eindep,type,(
    c_2Eprobability_2Eindep: del > $i )).

tff(mem_c_2Eprobability_2Eindep,axiom,(
    ! [A_27a: del] : mem(c_2Eprobability_2Eindep(A_27a),arr(ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)),arr(arr(A_27a,bool),arr(arr(A_27a,bool),bool)))) )).
...
tff(ax_thm_2Eprobability_2Eindep__def,axiom,(
    ! [A_27a: del,V0p: $i] :
         ...
         => ! [V2b: $i] :
             ...
             => ( p(ap(ap(ap(c_2Eprobability_2Eindep(A_27a),V0p),V1a),V2b))
              <=> ( p(ap(ap(c_2Ebool_2EIN(arr(A_27a,bool)),V1a),ap(c_2Eprobability_2Eevents(A_27a),V0p)))
                  ...
                  & surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),ap(ap(c_2Epred__set_2EINTER(A_27a),V1a),V2b))) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1a)),ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V2b))) ) ) ) ) ) )).

tff(conj_thm_2Eprobability_2EINDEP__REFL,conjecture,(
    ! [A_27a: del,V0p: $i] :
      ( mem(V0p,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
     => ! [V1a: $i] :
          ( mem(V1a,arr(A_27a,bool))
         => ( ( p(ap(c_2Eprobability_2Eprob__space(A_27a),V0p))
           ...
           => ( p(ap(ap(ap(c_2Eprobability_2Eindep(A_27a),V0p),V1a),V1a))
            <=> ( surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1a)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))
                | surj__ty_2Erealax_2Ereal(ap(ap(c_2Eprobability_2Eprob(A_27a),V0p),V1a)) = surj__ty_2Erealax_2Ereal(ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,inj__ty_2Enum_2Enum(fo__c_2Earithmetic_2EZERO))))) ) ) ) ) ) )).
