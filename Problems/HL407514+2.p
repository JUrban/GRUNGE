...
fof(conj_thm_2Ereal_2EREAL__DIV__INNER__CANCEL,lemma,(
    ! [V0x] :
     ...
     => ! [V1y] :
         ...
         => ! [V2z] :
             ...
             => ( V0x != ap(c_2Ereal_2Ereal__of__num,c_2Enum_2E0)
               => ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,V1y),V0x)),ap(ap(c_2Ereal_2E_2F,V0x),V2z)) = ap(ap(c_2Ereal_2E_2F,V1y),V2z) ) ) ) ) )).

fof(conj_thm_2Ereal_2EREAL__DIV__INNER__CANCEL3,conjecture,(
    ! [V0y] :
      ( mem(V0y,ty_2Erealax_2Ereal)
     => ! [V1z] :
          ( mem(V1z,ty_2Erealax_2Ereal)
         => ap(ap(c_2Erealax_2Ereal__mul,ap(ap(c_2Ereal_2E_2F,V0y),ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO)))))),ap(ap(c_2Ereal_2E_2F,ap(c_2Ereal_2Ereal__of__num,ap(c_2Earithmetic_2ENUMERAL,ap(c_2Earithmetic_2EBIT1,ap(c_2Earithmetic_2EBIT1,c_2Earithmetic_2EZERO))))),V1z)) = ap(ap(c_2Ereal_2E_2F,V0y),V1z) ) ) )).
