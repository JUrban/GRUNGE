...
fof(conj_thm_2Eoption_2EFORALL__OPTION,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0P] :
...
fof(conj_thm_2Eoption_2EOPTION__BIND__cong,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2f1] :
                     ...
                     => ! [V3f2] :
                         ...
                         => ( ( V0o1 = V1o2
                           ...
                           => ap(ap(c_2Eoption_2EOPTION__BIND(A_27b,A_27b),V0o1),V2f1) = ap(ap(c_2Eoption_2EOPTION__BIND(A_27b,A_27b),V1o2),V3f2) ) ) ) ) ) ) ) )).
