...
thf(conj_thm_2Ewords_2EFCP__T__F,conjecture,(
    ! [A_27a: del,A_27b: del] :
      ( ( ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27a ) @ ( ap @ ( c_2Ecombin_2EK @ bool @ ty_2Enum_2Enum ) @ ( inj__o @ fo__c_2Ebool_2ET ) ) )
        = ( c_2Ewords_2Eword__T @ A_27a ) )
      & ( ( ap @ ( c_2Efcp_2EFCP @ bool @ A_27b ) @ ( ap @ ( c_2Ecombin_2EK @ bool @ ty_2Enum_2Enum ) @ ( inj__o @ fo__c_2Ebool_2EF ) ) )
