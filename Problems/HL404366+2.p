...
fof(conj_thm_2Ecardinal_2Ecardleq__lt__trans,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
             ...
             => ! [V0r] :
                 ...
                 => ! [V1s] :
                     ...
                     => ! [V2t] :
                         ...
                         => ( ( p(ap(ap(c_2Ecardinal_2Ecardleq(A_27a,A_27a),V0r),V1s))
                              & ~ p(ap(ap(c_2Ecardinal_2Ecardleq(A_27c,A_27c),V2t),V1s)) )
