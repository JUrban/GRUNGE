                ...
                = ( ap @ ( ap @ ( ap @ ( c_2Elist_2Elist__CASE @ A_27b @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ V2kl ) @ ( ap @ ( c_2Eoption_2ESOME @ A_27a ) @ V0a ) )
                  @ ( lam @ A_27b
                    @ ^ [V3h: $i] :
                        ...
                        @ ^ [V4t: $i] :
                            ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ( ty_2Eoption_2Eoption @ A_27a ) ) @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27b ) @ V3h ) @ ( ap @ ( c_2Efinite__map_2EFDOM @ A_27b @ ( arr @ ( ty_2Elist_2Elist @ A_27b ) @ ( ty_2Eoption_2Eoption @ A_27a ) ) ) @ V1kfm ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Efinite__map_2EFAPPLY @ A_27b @ ( arr @ ( ty_2Elist_2Elist @ A_27b ) @ ( ty_2Eoption_2Eoption @ A_27a ) ) ) @ V1kfm ) @ V3h ) @ V4t ) ) @ ( c_2Eoption_2ENONE @ A_27a ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Efmaptree_2Efmaptree__nchotomy,conjecture,(
