...
tff(conj_thm_2Ebag_2EBAG__GEN__PROD__UNION__LEM,lemma,(
    ! [V0b1: $i] :
     ...
     => ( p(ap(c_2Ebag_2EFINITE__BAG(ty_2Enum_2Enum),V0b1))
       => ! [V1b2: $i] :
           ...
           => ! [V2a: tp__ty_2Enum_2Enum,V3b: tp__ty_2Enum_2Enum] :
               ...
               => surj__ty_2Enum_2Enum(ap(ap(c_2Ebag_2EBAG__GEN__PROD,ap(ap(c_2Ebag_2EBAG__UNION(ty_2Enum_2Enum),V0b1),V1b2)),ap(ap(c_2Earithmetic_2E_2A,inj__ty_2Enum_2Enum(V2a)),inj__ty_2Enum_2Enum(V3b)))) = surj__ty_2Enum_2Enum(ap(ap(c_2Earithmetic_2E_2A,ap(ap(c_2Ebag_2EBAG__GEN__PROD,V0b1),inj__ty_2Enum_2Enum(V2a))),ap(ap(c_2Ebag_2EBAG__GEN__PROD,V1b2),inj__ty_2Enum_2Enum(V3b)))) ) ) ) ) )).

tff(conj_thm_2Ebag_2EBAG__GEN__PROD__UNION,conjecture,(
    ! [V0b1: $i] :
      ( mem(V0b1,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
     => ! [V1b2: $i] :
          ( mem(V1b2,arr(ty_2Enum_2Enum,ty_2Enum_2Enum))
