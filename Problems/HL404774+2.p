...
fof(conj_thm_2Efinite__map_2EFUNION__COMM,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1g] :
                  ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
                 => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27a),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V0f)),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1g)))
                   => ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V0f),V1g) = ap(ap(c_2Efinite__map_2EFUNION(A_27a,A_27a),V1g),V0f) ) ) ) ) ) )).
