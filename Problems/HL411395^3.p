...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__DISJOINT,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1a: tyop_2Erealax_2Ereal,V2b: tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2EDISJOINT @ tyop_2Erealax_2Ereal @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V1a ) @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V2b ) )
    <=> ( (~) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1a @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V2b ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECONNECTED__COMPONENT__EQ__EQ,axiom,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal,V2y: tyop_2Erealax_2Ereal] :
      ( ( ( c_2Ereal__topology_2Econnected__component @ V0s @ V1x )
        = ( c_2Ereal__topology_2Econnected__component @ V0s @ V2y ) )
    <=> ( ( ( (~) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s ) )
          & ( (~) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s ) ) )
        | ( ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V1x @ V0s )
          & ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s )
          & ( c_2Ereal__topology_2Econnected__component @ V0s @ V1x @ V2y ) ) ) ) )).
...
thf(thm_2Ereal__topology_2ECOMPLEMENT__CONNECTED__COMPONENT__BIGUNION,conjecture,(
    ! [V0s: tyop_2Erealax_2Ereal > $o,V1x: tyop_2Erealax_2Ereal] :
      ( ( c_2Epred__set_2EDIFF @ tyop_2Erealax_2Ereal @ V0s @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V1x ) )
      = ( c_2Epred__set_2EBIGUNION @ tyop_2Erealax_2Ereal
        @ ( c_2Epred__set_2EDELETE @ ( tyop_2Erealax_2Ereal > $o )
          @ ( c_2Epred__set_2EGSPEC @ ( tyop_2Erealax_2Ereal > $o ) @ tyop_2Erealax_2Ereal
            @ ^ [V2y: tyop_2Erealax_2Ereal] :
                ( c_2Epair_2E_2C @ ( tyop_2Erealax_2Ereal > $o ) @ $o @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V2y ) @ ( c_2Ebool_2EIN @ tyop_2Erealax_2Ereal @ V2y @ V0s ) ) )
          @ ( c_2Ereal__topology_2Econnected__component @ V0s @ V1x ) ) ) ) )).
