...
fof(conj_thm_2Ereal__topology_2EOPEN__INTER,lemma,(
    ! [V0s] :
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__OPEN,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ECONTINUOUS__OPEN__PREIMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V2t] :
             ...
             => ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous__on,V0f),V1s))
                  ...
                  & p(ap(c_2Ereal__topology_2EOpen,V2t)) )
               => p(ap(c_2Ereal__topology_2EOpen,ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3838(V1s,V0f,V2t)))) ) ) ) ) )).
