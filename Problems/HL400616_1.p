...
tff(thm_2Erelation_2EEXTEND__RTC__TC__EQN,axiom,(
    ! [A_27a: d,V0R_2E0: u,V1x_2E0: u,V2z_2E0: u] :
      ( p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2ETC_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(A_27a,V1x_2E0),s(A_27a,V2z_2E0)))))
    <=> ? [V3y_2E0: u] :
          ...
          & p(j_mono_2Etyop_2Emin_2Ebool(s(tyop_2Emin_2Ebool,c_2Erelation_2ERTC_2E3(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),V0R_2E0),s(A_27a,V3y_2E0),s(A_27a,V2z_2E0))))) ) ) )).
...
tff(thm_2Eprim__rec_2ERTC__IM__TC,conjecture,(
