...
tff(lamtp_f297,axiom,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => mem(f297(A_27a,V0P),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f297,axiom,(
    ! [A_27a: del,V0P: $i] :
     ...
     => ! [V3x: $i] :
          ( mem(V3x,A_27a)
         => ap(f297(A_27a,V0P),V3x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V3x),ap(V0P,V3x)) ) ) )).

tff(lmtp_f298,type,(
    f298: ( del * $i ) > $i )).

tff(lamtp_f298,axiom,(
    ! [A_27a: del,V1Q: $i] :
      ( mem(V1Q,arr(A_27a,bool))
     => mem(f298(A_27a,V1Q),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) )).
...
tff(lameq_f298,axiom,(
    ! [A_27a: del,V1Q: $i] :
     ...
     => ! [V4x: $i] :
          ( mem(V4x,A_27a)
         => ap(f298(A_27a,V1Q),V4x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V4x),ap(V1Q,V4x)) ) ) )).

tff(lmtp_f299,type,(
    f299: ( del * $i * $i ) > $i )).

tff(lamtp_f299,axiom,(
    ! [A_27a: del,V1Q: $i] :
      ( mem(V1Q,arr(A_27a,bool))
     => ! [V0P: $i] :
          ( mem(V0P,arr(A_27a,bool))
         => mem(f299(A_27a,V1Q,V0P),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).
...
tff(lameq_f299,axiom,(
    ! [A_27a: del,V1Q: $i] :
     ...
     => ! [V0P: $i] :
         ...
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f299(A_27a,V1Q,V0P),V2x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Ebool_2E_5C_2F,ap(V0P,V2x)),ap(V1Q,V2x))) ) ) ) )).

tff(conj_thm_2Epred__set_2EGSPEC__OR,lemma,(
    ! [A_27a: del,V0P: $i] :
      ( mem(V0P,arr(A_27a,bool))
     => ! [V1Q: $i] :
          ( mem(V1Q,arr(A_27a,bool))
...
tff(conj_thm_2Eset__relation_2Efinite__prefixes__union,conjecture,(
         ...
         => ! [V2s1: $i] :
             ...
             => ! [V3s2: $i] :
                 ...
                 => ( ( p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27a,A_27a),V0r1),V2s1))
                      & p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27a,A_27a),V1r2),V3s2)) )
                   => p(ap(ap(c_2Eset__relation_2Efinite__prefixes(A_27a,A_27a),ap(ap(c_2Epred__set_2EUNION(ty_2Epair_2Eprod(A_27a,A_27a)),V0r1),V1r2)),ap(ap(c_2Epred__set_2EINTER(A_27b),V2s1),V3s2))) ) ) ) ) ) )).
