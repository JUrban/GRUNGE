...
thf(mem_c_2Esptree_2EtoAList,axiom,(
    ! [A_27a: del] :
      ( mem @ ( c_2Esptree_2EtoAList @ A_27a ) @ ( arr @ ( ty_2Esptree_2Espt @ A_27a ) @ ( ty_2Elist_2Elist @ ( ty_2Epair_2Eprod @ ty_2Enum_2Enum @ A_27a ) ) ) ) )).
...
thf(conj_thm_2Esptree_2EALOOKUP__toAList,lemma,(
    ! [A_27a: del,V0t: $i] :
...
thf(conj_thm_2Esptree_2Elookup__fromAList,lemma,(
    ! [A_27a: del,V0ls: $i] :
...
thf(conj_thm_2Esptree_2Elookup__fromAList__toAList,conjecture,(
    ! [A_27a: del,V0t: $i] :
      ( ( mem @ V0t @ ( ty_2Esptree_2Espt @ A_27a ) )
     => ! [V1x: tp__ty_2Enum_2Enum] :
