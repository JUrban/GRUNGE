...
thf(thm_2Etoto_2EcharOrd__gt__lem,conjecture,(
    ! [V0a: mono_2Etyop_2Enum_2Enum,V1b: mono_2Etyop_2Enum_2Enum] :
      ( ( ( mono_2Ec_2Etoto_2EnumOrd @ V0a @ V1b )
        = mono_2Ec_2EternaryComparisons_2EGREATER )
     => ( ( ( mono_2Ec_2Eprim__rec_2E_3C @ V0a @ ( mono_2Ec_2Earithmetic_2ENUMERAL @ ( mono_2Ec_2Earithmetic_2EBIT2 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ ( mono_2Ec_2Earithmetic_2EBIT1 @ mono_2Ec_2Earithmetic_2EZERO ) ) ) ) ) ) ) ) ) )
          = mono_2Ec_2Ebool_2ET )
       => ( ( mono_2Ec_2Etoto_2EcharOrd @ ( mono_2Ec_2Estring_2ECHR @ V0a ) @ ( mono_2Ec_2Estring_2ECHR @ V1b ) )
          = mono_2Ec_2EternaryComparisons_2EGREATER ) ) ) )).
