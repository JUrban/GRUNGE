...
fof(conj_thm_2EintExtension_2EINT__GT__RMUL__EXP,lemma,(
    ! [V0a] :
      ( mem(V0a,ty_2Einteger_2Eint)
     => ! [V1b] :
          ( mem(V1b,ty_2Einteger_2Eint)
...
fof(conj_thm_2Efrac_2EFRAC__SGN__POS,lemma,(
    ! [V0f1] :
      ( mem(V0f1,ty_2Efrac_2Efrac)
...
fof(conj_thm_2Erat_2ERAT__NMRGT0__CONG,lemma,(
    ! [V0f1] :
      ( mem(V0f1,ty_2Efrac_2Efrac)
...
fof(conj_thm_2Erat_2ERAT__SUB__CONG,lemma,
    ( ! [V0x] :
...
fof(conj_thm_2Erat_2ERAT__DENSE__THM,conjecture,(
    ! [V0r1] :
      ( mem(V0r1,ty_2Erat_2Erat)
     => ! [V1r3] :
