...
thf(thm_2EindexedLists_2EGENLIST__CONG,conjecture,(
    ! [A_27a: d,V0n: mono_2Etyop_2Enum_2Enum,V1f2_2E0: u,V2f1_2E0: u] :
      ( ! [V3m: mono_2Etyop_2Enum_2Enum] :
          ( ( mono_2Ec_2Eprim__rec_2E_3C @ V3m @ V0n )
         => ( ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3m ) ) ) )
            = ( s @ A_27a @ ( app_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V3m ) ) ) ) ) )
     => ( ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V2f1_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) )
        = ( s @ ( tyop_2Elist_2Elist @ A_27a ) @ ( c_2Elist_2EGENLIST_2E2 @ ( s @ ( tyop_2Emin_2Efun @ tyop_2Enum_2Enum @ A_27a ) @ V1f2_2E0 ) @ ( s @ tyop_2Enum_2Enum @ ( i_mono_2Etyop_2Enum_2Enum @ V0n ) ) ) ) ) ) )).
