...
thf(conj_thm_2Etransc_2EEXP__POS__LT,lemma,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p @ ( ap @ ( ap @ c_2Erealax_2Ereal__lt @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) @ ( ap @ c_2Etransc_2Eexp @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) ) ) )).
...
thf(conj_thm_2Etransc_2EROOT__LN,lemma,(
    ! [V0n: tp__ty_2Enum_2Enum,V1x: tp__ty_2Erealax_2Ereal] :
     ...
     => ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Etransc_2Eroot @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) )
        = ( surj__ty_2Erealax_2Ereal @ ( ap @ c_2Etransc_2Eexp @ ( ap @ ( ap @ c_2Ereal_2E_2F @ ( ap @ c_2Etransc_2Eln @ ( inj__ty_2Erealax_2Ereal @ V1x ) ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( ap @ c_2Enum_2ESUC @ ( inj__ty_2Enum_2Enum @ V0n ) ) ) ) ) ) ) ) )).

thf(conj_thm_2Etransc_2ESQRT__POS__LT,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
