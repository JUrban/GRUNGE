...
tff(conj_thm_2Equotient__pair_2ECOMMA__PRS,conjecture,(
                       ...
                       => ! [V5rep2: $i] :
                           ...
                           => ( p(ap(ap(ap(c_2Equotient_2EQUOTIENT(A_27b,A_27b),V3R2),V4abs2),V5rep2))
                             => ! [V6a: $i] :
                                 ...
                                 => ! [V7b: $i] :
                                      ( mem(V7b,A_27d)
                                     => ap(ap(c_2Epair_2E_2C(A_27c,A_27c),V6a),V7b) = ap(ap(ap(c_2Epair_2E_23_23(A_27a,A_27a,A_27a,A_27a),V1abs1),V4abs2),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),ap(V2rep1,V6a)),ap(V5rep2,V7b))) ) ) ) ) ) ) ) ) ) ) )).
