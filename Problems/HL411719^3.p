...
thf(thm_2Epred__set_2EGSPEC__EQ,axiom,(
    ! [A_27a: $tType,V0y: A_27a] :
      ( ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a
        @ ^ [V1x: A_27a] :
            ( c_2Epair_2E_2C @ A_27a @ $o @ V1x @ ( c_2Emin_2E_3D @ A_27a @ V1x @ V0y ) ) )
      ...
      = ( c_2Emin_2E_40 @ tyop_2Enum_2Enum
        @ ^ [V1n: tyop_2Enum_2Enum] :
            ...
            @ ^ [V2b: tyop_2Erealax_2Ereal > $o] :
                ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V2b @ V0v ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Ereal__topology_2Eindependent @ V2b ) @ ( c_2Ebool_2E_2F_5C @ ( c_2Epred__set_2ESUBSET @ tyop_2Erealax_2Ereal @ V0v @ ( c_2Ereal__topology_2Espan @ V2b ) ) @ ( c_2Ecardinal_2EHAS__SIZE @ tyop_2Erealax_2Ereal @ V2b @ V1n ) ) ) ) ) ) ) )).
...
thf(thm_2Ereal__topology_2EDIM__SUBSTANDARD,conjecture,
    ( ( c_2Ereal__topology_2Edim
      @ ( c_2Epred__set_2EGSPEC @ tyop_2Erealax_2Ereal @ tyop_2Erealax_2Ereal
        @ ^ [V0x: tyop_2Erealax_2Ereal] :
            ( c_2Epair_2E_2C @ tyop_2Erealax_2Ereal @ $o @ V0x @ ( c_2Emin_2E_3D @ tyop_2Erealax_2Ereal @ V0x @ ( c_2Ereal_2Ereal__of__num @ c_2Enum_2E0 ) ) ) ) )
    = c_2Enum_2E0 )).
