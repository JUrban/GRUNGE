...
thf(thm_2Eextreal_2EEXTREAL__SUM__IMAGE__IF__ELIM,conjecture,(
    ! [A_27a: $tType,V0s: A_27a > $o,V1P: A_27a > $o,V2f: A_27a > tyop_2Eextreal_2Eextreal] :
     ...
     => ( ( c_2Eextreal_2EEXTREAL__SUM__IMAGE @ A_27a
          @ ^ [V4x: A_27a] :
              ( c_2Ebool_2ECOND @ tyop_2Eextreal_2Eextreal @ ( V1P @ V4x ) @ ( V2f @ V4x ) @ ( c_2Eextreal_2Eextreal__of__num @ c_2Enum_2E0 ) )
          @ V0s )
