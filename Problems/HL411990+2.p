...
fof(conj_thm_2Elebesgue_2Epos__simple__fn__add__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(lameq_f4125,axiom,(
    ! [V4x] :
     ...
     => ! [V6y] :
         ...
         => ! [V7i] :
              ( mem(V7i,ty_2Enum_2Enum)
             => ap(f4125(V4x,V6y),V7i) = ap(ap(c_2Erealax_2Ereal__add,ap(V4x,V7i)),ap(V6y,V7i)) ) ) ) )).

fof(conj_thm_2Elebesgue_2Epos__simple__fn__integral__add__alt,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
                         ...
                         => ! [V5g] :
                             ...
                             => ! [V6y] :
                                 ...
                                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                                   ...
                                   => ap(ap(c_2Eextreal_2Eextreal__add,ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),V4x)),ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),V6y)) = ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),f4125(V4x,V6y)) ) ) ) ) ) ) ) ) ) )).

fof(lamtp_f4132,axiom,(
    ! [A_27a,A_27b,V1f] :
...
fof(lamtp_f4134,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V9i] :
          ( mem(V9i,ty_2Enum_2Enum)
         => mem(f4134(A_27b,V4x,V9i),arr(A_27b,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f4134,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V9i] :
          ( mem(V9i,ty_2Enum_2Enum)
         => ! [V10j] :
              ( mem(V10j,A_27b)
             => ap(f4134(A_27b,V4x,V9i),V10j) = ap(ap(V4x,V10j),V9i) ) ) ) )).

fof(lamtp_f4133,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P] :
          ( mem(V5P,arr(A_27b,bool))
...
fof(lameq_f4133,axiom,(
    ! [A_27b,V4x] :
     ...
     => ! [V5P] :
         ...
         => ! [V9i] :
              ( mem(V9i,ty_2Enum_2Enum)
             => ap(f4133(A_27b,V4x,V5P),V9i) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4134(A_27b,V4x,V9i)),V5P) ) ) ) )).

fof(lamtp_f4136,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V11j] :
          ( mem(V11j,ty_2Enum_2Enum)
         => mem(f4136(A_27b,V4x,V11j),arr(A_27b,ty_2Erealax_2Ereal)) ) ) )).

fof(lameq_f4136,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V11j] :
          ( mem(V11j,ty_2Enum_2Enum)
         => ! [V12i] :
              ( mem(V12i,A_27b)
             => ap(f4136(A_27b,V4x,V11j),V12i) = ap(ap(V4x,V12i),V11j) ) ) ) )).

fof(lamtp_f4135,axiom,(
    ! [A_27b,V4x] :
      ( mem(V4x,arr(A_27b,arr(ty_2Enum_2Enum,ty_2Erealax_2Ereal)))
     => ! [V5P] :
          ( mem(V5P,arr(A_27b,bool))
...
fof(lameq_f4135,axiom,(
    ! [A_27b,V4x] :
     ...
     => ! [V5P] :
         ...
         => ! [V11j] :
              ( mem(V11j,ty_2Enum_2Enum)
             => ap(f4135(A_27b,V4x,V5P),V11j) = ap(ap(c_2Ereal__sigma_2EREAL__SUM__IMAGE(A_27b),f4136(A_27b,V4x,V11j)),V5P) ) ) ) )).

fof(lamtp_f4137,axiom,(
    ! [A_27a,A_27b,V3a] :
      ( mem(V3a,arr(ty_2Enum_2Enum,arr(A_27a,bool)))
     => ! [V0m] :
          ( mem(V0m,ty_2Epair_2Eprod(arr(A_27a,bool),arr(A_27a,bool)))
...
fof(conj_thm_2Elebesgue_2Epos__simple__fn__integral__sum,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                             ...
                             => ! [V5P] :
                                 ...
                                 => ( ( p(ap(c_2Emeasure_2Emeasure__space(A_27a),V0m))
                                   ...
                                   => ( p(ap(ap(ap(ap(ap(c_2Emeasure_2Epos__simple__fn(A_27a),V0m),f4131(A_27b,A_27a,V1f,V5P)),V2s),V3a),f4133(A_27b,V4x,V5P)))
                                      & ap(ap(ap(ap(c_2Elebesgue_2Epos__simple__fn__integral(A_27a),V0m),V2s),V3a),f4135(A_27b,V4x,V5P)) = ap(ap(c_2Eextreal_2EEXTREAL__SUM__IMAGE(A_27b),f4137(A_27a,A_27b,V3a,V0m,V2s,V4x)),V5P) ) ) ) ) ) ) ) ) ) ) )).
