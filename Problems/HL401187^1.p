    ...
    ! [V0P: mono_2Etyop_2Enum_2Enum > mono_2Etyop_2Enum_2Enum > $o] :
      ( ( ! [V1y: mono_2Etyop_2Enum_2Enum] :
        ...
        & ! [V2x: mono_2Etyop_2Enum_2Enum] :
            ( V0P @ ( mono_2Ec_2Enum_2ESUC @ V2x ) @ mono_2Ec_2Enum_2E0 )
        & ! [V3x: mono_2Etyop_2Enum_2Enum,V4y: mono_2Etyop_2Enum_2Enum] :
            ( ( ( ( (~) @ ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4y @ V3x ) )
               => ( V0P @ ( mono_2Ec_2Enum_2ESUC @ V3x ) @ ( mono_2Ec_2Earithmetic_2E_2D @ V4y @ V3x ) ) )
              & ( ( mono_2Ec_2Earithmetic_2E_3C_3D @ V4y @ V3x )
               => ( V0P @ ( mono_2Ec_2Earithmetic_2E_2D @ V3x @ V4y ) @ ( mono_2Ec_2Enum_2ESUC @ V4y ) ) ) )
           => ( V0P @ ( mono_2Ec_2Enum_2ESUC @ V3x ) @ ( mono_2Ec_2Enum_2ESUC @ V4y ) ) ) )
     => ! [V5v: mono_2Etyop_2Enum_2Enum,V6v1: mono_2Etyop_2Enum_2Enum] :
          ( V0P @ V5v @ V6v1 ) ) )).
