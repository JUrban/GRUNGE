...
thf(conj_thm_2Ereal__sigma_2EREAL__SUM__IMAGE__INTER__NONZERO,conjecture,(
    ! [A_27a: del,V0P: $i] :
           ...
           => ( ( surj__ty_2Erealax_2Ereal
                @ ( ap @ ( ap @ ( c_2Ereal__sigma_2EREAL__SUM__IMAGE @ A_27a ) @ V1f )
                  @ ( ap @ ( ap @ ( c_2Epred__set_2EINTER @ A_27a ) @ V0P )
                    @ ( lam @ A_27a
                      @ ^ [V2p: $i] :
                          ( ap @ c_2Ebool_2E_7E @ ( ap @ ( ap @ ( c_2Emin_2E_3D @ ty_2Erealax_2Ereal ) @ ( ap @ V1f @ V2p ) ) @ ( ap @ c_2Ereal_2Ereal__of__num @ ( inj__ty_2Enum_2Enum @ fo__c_2Enum_2E0 ) ) ) ) ) ) ) )
