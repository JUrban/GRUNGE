...
fof(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__IMAGE,lemma,(
    ! [V0f] :
...
fof(conj_thm_2Ereal__topology_2ESUBSPACE__LINEAR__PREIMAGE,lemma,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
...
fof(conj_thm_2Ereal__topology_2ESPAN__LINEAR__IMAGE,conjecture,(
    ! [V0f] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1s] :
          ( mem(V1s,arr(ty_2Erealax_2Ereal,bool))
