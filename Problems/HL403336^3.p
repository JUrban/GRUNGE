...
thf(thm_2Ebag_2EBAG__EXTENSION,axiom,(
    ...
    <=> ! [V2n: tyop_2Enum_2Enum,V3e: A_27a] :
          ( ( c_2Ebag_2EBAG__INN @ A_27a @ V3e @ V2n @ V0b1 )
          = ( c_2Ebag_2EBAG__INN @ A_27a @ V3e @ V2n @ V1b2 ) ) ) )).
...
thf(thm_2Ebag_2EBAG__INN__EMPTY__BAG,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1n: tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2EBAG__INN @ A_27a @ V0e @ V1n @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
    <=> ( V1n = c_2Enum_2E0 ) ) )).

thf(thm_2Ebag_2EBAG__OF__EMPTY,axiom,(
    ! [A_27a: $tType] :
      ( ( c_2Ebag_2ESET__OF__BAG @ A_27a @ ( c_2Ebag_2EEMPTY__BAG @ A_27a ) )
      = ( c_2Epred__set_2EEMPTY @ A_27a ) ) )).

thf(thm_2Ebag_2ESET__OF__BAG__INSERT,axiom,(
    ! [A_27a: $tType,V0e: A_27a,V1b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Ebag_2ESET__OF__BAG @ A_27a @ ( c_2Ebag_2EBAG__INSERT @ A_27a @ V0e @ V1b ) )
      = ( c_2Epred__set_2EINSERT @ A_27a @ V0e @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V1b ) ) ) )).

thf(thm_2Ebag_2ESET__OF__BAG__EQ__EMPTY,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( ( ( c_2Epred__set_2EEMPTY @ A_27a )
          = ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V0b ) )
      <=> ( V0b
...
thf(thm_2Ebag_2ESET__OF__BAG__EQ__INSERT,axiom,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum,V1e: A_27a,V2s: A_27a > $o] :
      ( ( ( c_2Epred__set_2EINSERT @ A_27a @ V1e @ V2s )
        = ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V0b ) )
    <=> ? [V3b0: A_27a > tyop_2Enum_2Enum,V4eb: A_27a > tyop_2Enum_2Enum] :
          ( ( V0b
            = ( c_2Ebag_2EBAG__UNION @ A_27a @ V4eb @ V3b0 ) )
          & ( V2s
            = ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V3b0 ) )
          & ! [V5e_27: A_27a] :
              ( ( c_2Ebag_2EBAG__IN @ A_27a @ V5e_27 @ V4eb )
             => ( V5e_27 = V1e ) )
          & ( ( (~) @ ( c_2Ebool_2EIN @ A_27a @ V1e @ V2s ) )
           => ( c_2Ebag_2EBAG__IN @ A_27a @ V1e @ V4eb ) ) ) ) )).
...
thf(thm_2Ebag_2EFINITE__SET__OF__BAG,conjecture,(
    ! [A_27a: $tType,V0b: A_27a > tyop_2Enum_2Enum] :
      ( ( c_2Epred__set_2EFINITE @ A_27a @ ( c_2Ebag_2ESET__OF__BAG @ A_27a @ V0b ) )
