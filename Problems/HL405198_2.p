...
tff(lameq_f2108,axiom,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
     ...
     => ! [V1k: $i] :
          ( mem(V1k,A_27a)
         => ! [V2n: tp__ty_2Enum_2Enum] : ap(f2108(A_27a,A_27b,V0ls,V1k),inj__ty_2Enum_2Enum(V2n)) = ap(ap(c_2Emin_2E_3D(A_27a),ap(ap(c_2Elist_2EEL(A_27a),inj__ty_2Enum_2Enum(V2n)),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0ls))),V1k) ) ) )).

tff(conj_thm_2Ealist_2EALOOKUP__LEAST__EL,conjecture,(
    ! [A_27a: del,A_27b: del,V0ls: $i] :
      ( mem(V0ls,ty_2Elist_2Elist(ty_2Epair_2Eprod(A_27a,A_27a)))
     => ! [V1k: $i] :
          ( mem(V1k,A_27a)
         => ap(ap(c_2Ealist_2EALOOKUP(A_27b,A_27b),V0ls),V1k) = ap(ap(ap(c_2Ebool_2ECOND(ty_2Eoption_2Eoption(A_27b)),ap(ap(c_2Ebool_2EIN(A_27a),V1k),ap(c_2Elist_2ELIST__TO__SET(A_27a),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2EFST(A_27a,A_27a)),V0ls)))),ap(c_2Eoption_2ESOME(A_27b),ap(ap(c_2Elist_2EEL(A_27b),ap(c_2Ewhile_2ELEAST,f2108(A_27a,A_27b,V0ls,V1k))),ap(ap(c_2Elist_2EMAP(ty_2Epair_2Eprod(A_27a,A_27a),ty_2Epair_2Eprod(A_27a,A_27a)),c_2Epair_2ESND(A_27a,A_27a)),V0ls)))),c_2Eoption_2ENONE(A_27b)) ) ) )).
