...
thf(f10013_0_2E0,type,(
    f10013_0_2E0: u )).

thf(f10013_0_2E1,type,(
    f10013_0_2E1: du > u )).
...
thf(def0_2Ethm_2EHolSmt_2Er018,axiom,(
    ! [V2p: $o] :
      ( ( mono_2Ef10013_0 @ V2p )
    <=> ( (~) @ V2p ) ) )).

thf(thm_2EHolSmt_2Er018,conjecture,(
    ! [A_27a: d,V0y_2E0: u,V1x_2E0: u,V2p: $o] :
      ( ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ ( mono_2Ef10013_0 @ V2p ) ) ) @ ( s @ A_27a @ V1x_2E0 ) @ ( s @ A_27a @ V0y_2E0 ) ) )
      = ( s @ A_27a @ ( c_2Ebool_2ECOND_2E3 @ ( s @ tyop_2Emin_2Ebool @ ( i_mono_2Etyop_2Emin_2Ebool @ V2p ) ) @ ( s @ A_27a @ V0y_2E0 ) @ ( s @ A_27a @ V1x_2E0 ) ) ) ) )).
