...
fof(conj_thm_2Efinite__map_2ESUBMAP__FUNION__EQ,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ( ! [V0f1] :
                    ...
                    & ! [V3f1] :
                       ...
                       => ! [V4f2] :
                           ...
                           => ! [V5f3] :
                                ( mem(V5f3,ty_2Efinite__map_2Efmap(A_27c,A_27c))
                               => ( p(ap(ap(c_2Epred__set_2EDISJOINT(A_27c),ap(c_2Efinite__map_2EFDOM(A_27c,A_27c),V3f1)),ap(ap(c_2Epred__set_2EDIFF(A_27c),ap(c_2Efinite__map_2EFDOM(A_27c,A_27c),V5f3)),ap(c_2Efinite__map_2EFDOM(A_27c,A_27c),V4f2))))
                                 => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27c,A_27c),V3f1),ap(ap(c_2Efinite__map_2EFUNION(A_27c,A_27c),V4f2),V5f3)))
                                  <=> p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27c,A_27c),V3f1),V4f2)) ) ) ) ) ) ) ) ) ) ) )).
