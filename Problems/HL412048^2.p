...
thf(conj_thm_2Elebesgue_2Efinite__prod__measure__space__POW3,conjecture,(
                 ...
                 => ! [V4v: $i] :
                     ...
                     => ! [V5w: $i] :
                         ...
                         => ( ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s1 ) )
                           ...
                           => ( ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Eprod__measure__space3 @ A_27a @ A_27b @ A_27c ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0s1 ) ) @ V3u ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V1s2 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27b ) @ V1s2 ) ) @ V4v ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27c @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27c @ bool ) @ bool ) @ ( arr @ ( arr @ A_27c @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V2s3 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27c @ bool ) @ bool ) @ ( arr @ ( arr @ A_27c @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27c ) @ V2s3 ) ) @ V5w ) ) )
                              = ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ bool ) @ bool ) @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c ) @ V1s2 ) @ V2s3 ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ bool ) @ bool ) @ ( arr @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ ( ty_2Epair_2Eprod @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27a @ ( ty_2Epair_2Eprod @ A_27b @ A_27c ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epred__set_2ECROSS @ A_27b @ A_27c ) @ V1s2 ) @ V2s3 ) ) ) ) @ ( ap @ ( ap @ ( ap @ ( c_2Elebesgue_2Eprod__measure3 @ A_27a @ A_27b @ A_27c ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27a @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V0s1 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) @ ( arr @ ( arr @ A_27a @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27a ) @ V0s1 ) ) @ V3u ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27b @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V1s2 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27b @ bool ) @ bool ) @ ( arr @ ( arr @ A_27b @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27b ) @ V1s2 ) ) @ V4v ) ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ A_27c @ bool ) @ ( ty_2Epair_2Eprod @ ( arr @ ( arr @ A_27c @ bool ) @ bool ) @ ( arr @ ( arr @ A_27c @ bool ) @ ty_2Erealax_2Ereal ) ) ) @ V2s3 ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( arr @ ( arr @ A_27c @ bool ) @ bool ) @ ( arr @ ( arr @ A_27c @ bool ) @ ty_2Erealax_2Ereal ) ) @ ( ap @ ( c_2Epred__set_2EPOW @ A_27c ) @ V2s3 ) ) @ V5w ) ) ) ) ) ) ) ) ) ) ) ) ) )).
