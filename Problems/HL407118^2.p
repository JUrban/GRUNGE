...
thf(conj_thm_2Erealax_2ETREAL__MUL__LID,lemma,(
...
thf(conj_thm_2Erealax_2EREAL__MUL__LID,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( ( surj__ty_2Erealax_2Ereal @ ( ap @ ( ap @ c_2Erealax_2Ereal__mul @ ( inj__ty_2Erealax_2Ereal @ fo__c_2Erealax_2Ereal__1 ) ) @ ( inj__ty_2Erealax_2Ereal @ V0x ) ) )
      = V0x ) )).
