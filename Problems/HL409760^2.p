...
thf(conj_thm_2Eiterate_2EITERATE__CASES,lemma,(
               ...
               => ! [V3f: $i] :
                   ...
                   => ! [V4g: $i] :
                       ...
                       => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V1s ) )
                         => ( ( ap @ ( ap @ ( ap @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b ) @ V0op ) @ V1s )
                              @ ( lam @ A_27a
                                @ ^ [V5x: $i] :
                                    ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ A_27b ) @ ( ap @ V2P @ V5x ) ) @ ( ap @ V3f @ V5x ) ) @ ( ap @ V4g @ V5x ) ) ) )
                            = ( ap
                              @ ( ap @ V0op
                                @ ( ap
                                  @ ( ap @ ( ap @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b ) @ V0op )
                                    @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                      @ ( lam @ A_27a
                                        @ ^ [V6x: $i] :
                                            ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V6x ) @ V1s ) ) @ ( ap @ V2P @ V6x ) ) ) ) ) )
                                  @ V3f ) )
                              @ ( ap
                                @ ( ap @ ( ap @ ( c_2Eiterate_2Eiterate @ A_27a @ A_27b ) @ V0op )
                                  @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                    @ ( lam @ A_27a
                                      @ ^ [V7x: $i] :
                                          ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V7x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V7x ) @ V1s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V2P @ V7x ) ) ) ) ) ) )
                                @ V4g ) ) ) ) ) ) ) ) ) ) )).
...
thf(conj_thm_2Eiterate_2ENSUM__CASES,conjecture,(
    ! [A_27a: del,V0s: $i] :
                 ...
                 => ( ( p @ ( ap @ ( c_2Epred__set_2EFINITE @ A_27a ) @ V0s ) )
                   => ( ( surj__ty_2Enum_2Enum
                        @ ( ap @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a ) @ V0s )
                          @ ( lam @ A_27a
                            @ ^ [V4x: $i] :
                                ( ap @ ( ap @ ( ap @ ( c_2Ebool_2ECOND @ ty_2Enum_2Enum ) @ ( ap @ V1P @ V4x ) ) @ ( ap @ V2f @ V4x ) ) @ ( ap @ V3g @ V4x ) ) ) ) )
                      = ( surj__ty_2Enum_2Enum
                        @ ( ap
                            ...
                            @ ( ap
                              @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a )
                                @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                  @ ( lam @ A_27a
                                    @ ^ [V5x: $i] :
                                        ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V5x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V5x ) @ V0s ) ) @ ( ap @ V1P @ V5x ) ) ) ) ) )
                              @ V2f ) )
                          @ ( ap
                            @ ( ap @ ( c_2Eiterate_2Ensum @ A_27a )
                              @ ( ap @ ( c_2Epred__set_2EGSPEC @ A_27a @ A_27a )
                                @ ( lam @ A_27a
                                  @ ^ [V6x: $i] :
                                      ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ bool ) @ V6x ) @ ( ap @ ( ap @ c_2Ebool_2E_2F_5C @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V6x ) @ V0s ) ) @ ( ap @ c_2Ebool_2E_7E @ ( ap @ V1P @ V6x ) ) ) ) ) ) )
                            @ V3g ) ) ) ) ) ) ) ) ) )).
