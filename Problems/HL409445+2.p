...
fof(conj_thm_2Efloat_2EINFINITY__IS__INFINITY,lemma,
    ( p(ap(c_2Eieee_2EInfinity,c_2Eieee_2EPlus__infinity))
    & p(ap(c_2Eieee_2EInfinity,c_2Eieee_2EMinus__infinity)) )).

fof(conj_thm_2Efloat_2EINFINITY__NOT__NAN,conjecture,
    ( ~ p(ap(c_2Eieee_2EIsnan,c_2Eieee_2EPlus__infinity))
    & ~ p(ap(c_2Eieee_2EIsnan,c_2Eieee_2EMinus__infinity)) )).
