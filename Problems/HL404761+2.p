...
fof(mem_c_2Efinite__map_2EFMAP__MAP2,axiom,(
    ! [A_27a] :
     ...
     => ! [A_27b] :
         ...
         => ! [A_27c] :
              ( ne(A_27c)
             => mem(c_2Efinite__map_2EFMAP__MAP2(A_27a,A_27a,A_27a),arr(arr(ty_2Epair_2Eprod(A_27a,A_27a),A_27b),arr(ty_2Efinite__map_2Efmap(A_27a,A_27a),ty_2Efinite__map_2Efmap(A_27a,A_27a)))) ) ) ) )).
...
fof(conj_thm_2Efinite__map_2EFMAP__MAP2__THM,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
...
fof(conj_thm_2Efinite__map_2EFMAP__MAP2__FEMPTY,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
