...
tff(conj_thm_2Ereal_2EREAL__RNEG__UNIQ,lemma,(
    ...
    <=> V1y = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,inj__ty_2Erealax_2Ereal(V0x))) ) )).
...
tff(conj_thm_2Etransc_2ELN__INV,conjecture,(
    ! [V0x: tp__ty_2Erealax_2Ereal] :
      ( p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0))),inj__ty_2Erealax_2Ereal(V0x)))
     => surj__ty_2Erealax_2Ereal(ap(c_2Etransc_2Eln,ap(c_2Erealax_2Einv,inj__ty_2Erealax_2Ereal(V0x)))) = surj__ty_2Erealax_2Ereal(ap(c_2Erealax_2Ereal__neg,ap(c_2Etransc_2Eln,inj__ty_2Erealax_2Ereal(V0x)))) ) )).
