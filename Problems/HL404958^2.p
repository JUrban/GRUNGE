...
thf(conj_thm_2Etopology_2EHULL__REDUNDANT__EQ,conjecture,(
    ! [A_27a: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( arr @ A_27a @ bool ) @ bool ) )
     => ! [V1a: $i] :
          ( ( mem @ V1a @ A_27a )
         => ! [V2s: $i] :
             ...
             => ( ( p @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ A_27a ) @ V1a ) @ ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V2s ) ) )
              <=> ( ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ ( ap @ ( ap @ ( c_2Epred__set_2EINSERT @ A_27a ) @ V1a ) @ V2s ) )
                  = ( ap @ ( ap @ ( c_2Etopology_2Ehull @ A_27a ) @ V0P ) @ V2s ) ) ) ) ) ) )).
