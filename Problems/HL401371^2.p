...
thf(conj_thm_2Epred__set_2EPAIR__IN__GSPEC__2,conjecture,(
                 ...
                 => ( ( p
                      @ ( ap @ ( ap @ ( c_2Ebool_2EIN @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V0a ) @ V1b ) )
                        @ ( ap @ ( c_2Epred__set_2EGSPEC @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ A_27b )
                          @ ( lam @ A_27b
                            @ ^ [V4y: $i] :
                                ( ap @ ( ap @ ( c_2Epair_2E_2C @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) @ ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V2x ) @ V4y ) ) @ ( ap @ V3P @ V4y ) ) ) ) ) )
                  <=> ( ( p @ ( ap @ V3P @ V1b ) )
                      & ( V0a = V2x ) ) ) ) ) ) ) )).
