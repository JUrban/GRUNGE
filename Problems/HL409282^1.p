...
thf(f10798_0_2E0,type,(
    f10798_0_2E0: u )).

thf(f10798_0_2E1,type,(
    f10798_0_2E1: du > u )).

thf(f10798_0_2E2,type,(
...
thf(mono_2Ef10798_0,type,(
    mono_2Ef10798_0: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal )).
...
thf(def0_2Ethm_2Eintegral_2EINTEGRAL__CONST,axiom,(
    ! [V2c: mono_2Etyop_2Erealax_2Ereal,V3x: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ef10798_0 @ V2c @ V3x )
      = V2c ) )).

thf(thm_2Eintegral_2EINTEGRAL__CONST,axiom,(
    ! [V0a: mono_2Etyop_2Erealax_2Ereal,V1b: mono_2Etyop_2Erealax_2Ereal,V2c: mono_2Etyop_2Erealax_2Ereal] :
      ( ( mono_2Ec_2Ereal_2Ereal__lte @ V0a @ V1b )
     => ( ( mono_2Ec_2Eintegral_2Eintegral @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V0a @ V1b ) @ ( mono_2Ef10798_0 @ V2c ) )
        = ( mono_2Ec_2Erealax_2Ereal__mul @ V2c @ ( mono_2Ec_2Ereal_2Ereal__sub @ V1b @ V0a ) ) ) ) )).
      ...
      ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V2b )
        & ! [V3x: mono_2Etyop_2Erealax_2Ereal] :
            ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V3x )
              & ( mono_2Ec_2Ereal_2Ereal__lte @ V3x @ V2b ) )
           => ( mono_2Ec_2Elim_2Econtl @ V0f @ V3x ) ) )
     => ? [V4L: mono_2Etyop_2Erealax_2Ereal,V5M: mono_2Etyop_2Erealax_2Ereal] :
          ( ( mono_2Ec_2Ereal_2Ereal__lte @ V4L @ V5M )
          & ! [V6y: mono_2Etyop_2Erealax_2Ereal] :
              ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V4L @ V6y )
                & ( mono_2Ec_2Ereal_2Ereal__lte @ V6y @ V5M ) )
          ...
          & ! [V8x: mono_2Etyop_2Erealax_2Ereal] :
              ( ( ( mono_2Ec_2Ereal_2Ereal__lte @ V1a @ V8x )
                & ( mono_2Ec_2Ereal_2Ereal__lte @ V8x @ V2b ) )
             => ( ( mono_2Ec_2Ereal_2Ereal__lte @ V4L @ ( V0f @ V8x ) )
                & ( mono_2Ec_2Ereal_2Ereal__lte @ ( V0f @ V8x ) @ V5M ) ) ) ) ) )).
...
thf(thm_2Eintegral_2EINTEGRAL__MVT1,conjecture,(
    ! [V0f: mono_2Etyop_2Erealax_2Ereal > mono_2Etyop_2Erealax_2Ereal,V1a: mono_2Etyop_2Erealax_2Ereal,V2b: mono_2Etyop_2Erealax_2Ereal] :
     ...
     => ? [V4x: mono_2Etyop_2Erealax_2Ereal] :
          ...
          & ( ( mono_2Ec_2Eintegral_2Eintegral @ ( mono_2Ec_2Epair_2E_2C_2Emono_2Etyop_2Erealax_2Ereal_20mono_2Etyop_2Erealax_2Ereal @ V1a @ V2b ) @ V0f )
            = ( mono_2Ec_2Erealax_2Ereal__mul @ ( V0f @ V4x ) @ ( mono_2Ec_2Ereal_2Ereal__sub @ V2b @ V1a ) ) ) ) ) )).
