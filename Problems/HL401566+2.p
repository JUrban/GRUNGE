...
fof(conj_thm_2Epred__set_2EBIJ__INV,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
                 ...
                 => ! [V2t] :
                     ...
                     => ( p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27a,A_27a),V0f),V1s),V2t))
                       => ? [V3g] :
                            ...
                            & p(ap(ap(ap(c_2Epred__set_2EBIJ(A_27b,A_27b),V3g),V2t),V1s))
                            & ! [V4x] :
                                ( mem(V4x,A_27a)
                               => ( p(ap(ap(c_2Ebool_2EIN(A_27a),V4x),V1s))
                                 => ap(ap(ap(c_2Ecombin_2Eo(A_27a,A_27a,A_27a),V3g),V0f),V4x) = V4x ) )
                            & ! [V5x] :
                                ( mem(V5x,A_27b)
                               => ( p(ap(ap(c_2Ebool_2EIN(A_27b),V5x),V2t))
                                 => ap(ap(ap(c_2Ecombin_2Eo(A_27b,A_27b,A_27b),V0f),V3g),V5x) = V5x ) ) ) ) ) ) ) ) ) )).
