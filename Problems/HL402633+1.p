...
fof(arityeq2_2Ec_2Ecombin_2EFCOMM_2E2_2EA_27a_20A_27a_20A_27b,axiom,(
...
fof(arityeq3_2Ec_2Elist_2EFOLDR_2E3_2EA_27b_20A_27a,axiom,(
...
fof(arityeq2_2Ec_2Ecombin_2ELEFT__ID_2E2_2EA_27a_20A_27a,axiom,(
...
fof(arityeq2_2Ec_2Ecombin_2ELEFT__ID_2E2_2EA_27a_20A_27b,axiom,(
    ! [A_27a,A_27b,X0_2E0,X1_2E0] : s(tyop_2Emin_2Ebool,c_2Ecombin_2ELEFT__ID_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),X0_2E0),s(A_27a,X1_2E0))) = s(tyop_2Emin_2Ebool,app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool),app_2E2(s(tyop_2Emin_2Efun(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Ebool)),c_2Ecombin_2ELEFT__ID_2E0),s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),X0_2E0))),s(A_27a,X1_2E0))) )).
...
fof(thm_2Ecombin_2EFCOMM__DEF,axiom,(
    ! [A_27a,A_27b,A_27c,V0f_2E0,V1g_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ecombin_2EFCOMM_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27a)),V0f_2E0),s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Efun(A_27a,A_27a)),V1g_2E0))))
    <=> ! [V2x_2E0,V3y_2E0,V4z_2E0] : s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Efun(A_27a,A_27a)),V1g_2E0),s(A_27c,V2x_2E0))),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27a)),V0f_2E0),s(A_27a,V3y_2E0))),s(A_27b,V4z_2E0))))) = s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27a)),V0f_2E0),s(A_27a,app_2E2(s(tyop_2Emin_2Efun(A_27a,A_27a),app_2E2(s(tyop_2Emin_2Efun(A_27c,tyop_2Emin_2Efun(A_27a,A_27a)),V1g_2E0),s(A_27c,V2x_2E0))),s(A_27a,V3y_2E0))))),s(A_27b,V4z_2E0))) ) )).

fof(thm_2Ecombin_2ELEFT__ID__DEF,axiom,(
    ! [A_27a,A_27b,V0f_2E0,V1e_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Ecombin_2ELEFT__ID_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),V0f_2E0),s(A_27a,V1e_2E0))))
    <=> ! [V2x_2E0] : s(A_27b,app_2E2(s(tyop_2Emin_2Efun(A_27b,A_27b),app_2E2(s(tyop_2Emin_2Efun(A_27a,tyop_2Emin_2Efun(A_27b,A_27b)),V0f_2E0),s(A_27a,V1e_2E0))),s(A_27b,V2x_2E0))) = s(A_27b,V2x_2E0) ) )).
...
fof(thm_2Erich__list_2EFCOMM__FOLDR__APPEND,conjecture,(
