...
thf(conj_thm_2Ellist_2ELTAKE__LLENGTH__SOME,lemma,(
    ! [A_27a: del,V0ll: $i] :
      ( ( mem @ V0ll @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1n: tp__ty_2Enum_2Enum] :
          ( ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0ll ) )
...
thf(conj_thm_2Ellist_2ELNTH__LLENGTH__NONE,lemma,(
    ! [A_27a: del,V0l: $i] :
      ( ( mem @ V0l @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ! [V1x: tp__ty_2Enum_2Enum,V2n: tp__ty_2Enum_2Enum] :
          ( ( ( ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Ellist_2ELLENGTH @ A_27a ) @ V0l ) )
              = ( surj__c_ty_2Eoption_2Eoption_ty_2Enum_2Enum @ ( ap @ ( c_2Eoption_2ESOME @ ty_2Enum_2Enum ) @ ( inj__ty_2Enum_2Enum @ V1x ) ) ) )
            & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V1x ) ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) ) )
         => ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V2n ) ) @ V0l )
            = ( c_2Eoption_2ENONE @ A_27a ) ) ) ) )).
...
thf(conj_thm_2Ellist_2ELNTH__NONE__MONO,conjecture,(
    ! [A_27a: del,V0m: tp__ty_2Enum_2Enum,V1n: tp__ty_2Enum_2Enum,V2l: $i] :
      ( ( mem @ V2l @ ( ty_2Ellist_2Ellist @ A_27a ) )
     => ( ( ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ V2l )
            = ( c_2Eoption_2ENONE @ A_27a ) )
          & ( p @ ( ap @ ( ap @ c_2Earithmetic_2E_3C_3D @ ( inj__ty_2Enum_2Enum @ V0m ) ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) ) )
       => ( ( ap @ ( ap @ ( c_2Ellist_2ELNTH @ A_27a ) @ ( inj__ty_2Enum_2Enum @ V1n ) ) @ V2l )
          = ( c_2Eoption_2ENONE @ A_27a ) ) ) ) )).
