...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__SUB,lemma,(
    ! [V0f: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__GE__ON__CLOSURE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
...
thf(conj_thm_2Ereal__topology_2ECONTINUOUS__ON__ABS__COMPOSE,lemma,(
    ! [V0f: $i] :
      ( ( mem @ V0f @ ( arr @ ty_2Erealax_2Ereal @ ty_2Erealax_2Ereal ) )
     => ! [V1s: $i] :
          ( ( mem @ V1s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
...
thf(conj_thm_2Ereal__topology_2ESETDIST__CLOSURE,conjecture,
    ( ! [V0s: $i] :
        ( ( mem @ V0s @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
       => ! [V1t: $i] :
            ( ( mem @ V1t @ ( arr @ ty_2Erealax_2Ereal @ bool ) )
