...
thf(conj_thm_2Efinite__map_2EFLOOKUP__FUNION,lemma,(
...
thf(conj_thm_2Efinite__map_2EFEVERY__ALL__FLOOKUP,lemma,(
...
thf(conj_thm_2Efinite__map_2Efevery__funion,conjecture,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
      ( ( mem @ V0P @ ( arr @ ( ty_2Epair_2Eprod @ A_27a @ A_27b ) @ bool ) )
     => ! [V1m1: $i] :
