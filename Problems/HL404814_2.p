...
tff(conj_thm_2Efinite__map_2EDOMSUB__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0fm: $i] :
     ...
     => ! [V1k: $i] :
         ...
         => ! [V2v: $i] :
              ( mem(V2v,A_27b)
             => ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0fm),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1k),V2v))),V1k) = ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0fm),V1k) ) ) ) )).

tff(conj_thm_2Efinite__map_2ESUBMAP__FUPDATE,lemma,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
         ...
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))),V1g))
                  <=> ( p(ap(ap(c_2Ebool_2EIN(A_27a),V2x),ap(c_2Efinite__map_2EFDOM(A_27a,A_27a),V1g)))
                      & ap(ap(c_2Efinite__map_2EFAPPLY(A_27a,A_27a),V1g),V2x) = V3y
                      & p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0f),V2x)),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V1g),V2x))) ) ) ) ) ) ) )).

tff(conj_thm_2Efinite__map_2ESUBMAP__mono__FUPDATE,conjecture,(
    ! [A_27a: del,A_27b: del,V0f: $i] :
      ( mem(V0f,ty_2Efinite__map_2Efmap(A_27a,A_27a))
     => ! [V1g: $i] :
          ( mem(V1g,ty_2Efinite__map_2Efmap(A_27a,A_27a))
         => ! [V2x: $i] :
             ...
             => ! [V3y: $i] :
                  ( mem(V3y,A_27b)
                 => ( p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0f),V2x)),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V1g),V2x)))
                   => p(ap(ap(c_2Efinite__map_2ESUBMAP(A_27a,A_27a),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y))),ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V1g),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),V3y)))) ) ) ) ) ) )).
