...
thf(f3668_0_2E0,type,(
    f3668_0_2E0: u )).

thf(f3668_0_2E1,type,(
    f3668_0_2E1: du > u )).

thf(f3668_0_2E2,type,(
    f3668_0_2E2: du > du > u )).

thf(f3668_1_2E0,type,(
    f3668_1_2E0: u )).

thf(f3668_1_2E2,type,(
    f3668_1_2E2: du > du > u )).

thf(f3668_1_2E3,type,(
    f3668_1_2E3: du > du > du > u )).
...
thf(mono_2Ef3668_0,type,(
    mono_2Ef3668_0: ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).

thf(mono_2Ef3668_1,type,(
    mono_2Ef3668_1: ( mono_2Etyop_2Enum_2Enum > $o ) > ( mono_2Etyop_2Enum_2Enum > $o ) > mono_2Etyop_2Enum_2Enum > $o )).
...
thf(def0_2Ethm_2ETemporal__Logic_2ESBEFORE__AS__WHEN,axiom,(
    ! [V0b: mono_2Etyop_2Enum_2Enum > $o,V3t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3668_0 @ V0b @ V3t )
    <=> ( (~) @ ( V0b @ V3t ) ) ) )).

thf(def1_2Ethm_2ETemporal__Logic_2ESBEFORE__AS__WHEN,axiom,(
    ! [V1a: mono_2Etyop_2Enum_2Enum > $o,V0b: mono_2Etyop_2Enum_2Enum > $o,V4t: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ef3668_1 @ V1a @ V0b @ V4t )
    <=> ( ( V1a @ V4t )
        | ( V0b @ V4t ) ) ) )).

thf(thm_2ETemporal__Logic_2ESBEFORE__AS__WHEN,conjecture,(
    ...
    <=> ( ( mono_2Ec_2ETemporal__Logic_2EWHEN @ ( mono_2Ef3668_0 @ V0b ) @ ( mono_2Ef3668_1 @ V1a @ V0b ) @ V2x )
        & ( mono_2Ec_2ETemporal__Logic_2EEVENTUAL @ V1a @ V2x ) ) ) )).
