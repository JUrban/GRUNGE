...
fof(conj_thm_2Eordinal_2Eomax__sup,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(conj_thm_2Eordinal_2Edclose__cardleq__univinf,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(conj_thm_2Eordinal_2Esup__eq__max,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(conj_thm_2Eordinal_2Esup__eq__SUC,lemma,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0s] :
          ( mem(V0s,arr(ty_2Eordinal_2Eordinal(A_27a),bool))
...
fof(conj_thm_2Eordinal_2Egeneric__continuity,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [V0f] :
