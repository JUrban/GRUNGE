...
fof(thm_2EordNotationSemantics_2EaddL__disappears,axiom,(
    ! [A_27a,V0e_2E0,V1a_2E0] :
      ( p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V1a_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordEXP_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Eomega_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V0e_2E0))))))
...
fof(thm_2Eordinal_2Eordle__EXISTS__ADD,axiom,(
    ...
    <=> ? [V2c_2E0] : s(tyop_2Eordinal_2Eordinal(A_27a),V1b_2E0) = s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordADD_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V0a_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),V2c_2E0))) ) )).
...
fof(thm_2EordNotationSemantics_2Eadd__nat1__disappears,conjecture,(
    ! [A_27a,V0n_2E0,V1a_2E0] :
      ( ~ p(s(tyop_2Emin_2Ebool,c_2Eordinal_2Eordlt_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),V1a_2E0),s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2Eomega_2E0))))
     => s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EordADD_2E2(s(tyop_2Eordinal_2Eordinal(A_27a),c_2Eordinal_2EfromNat_2E1(s(tyop_2Enum_2Enum,V0n_2E0))),s(tyop_2Eordinal_2Eordinal(A_27a),V1a_2E0))) = s(tyop_2Eordinal_2Eordinal(A_27a),V1a_2E0) ) )).
