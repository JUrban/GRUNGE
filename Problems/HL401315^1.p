...
thf(thm_2Ebit_2EADD__BIT0,conjecture,(
    ! [V0m: mono_2Etyop_2Enum_2Enum,V1n: mono_2Etyop_2Enum_2Enum] :
      ( ( mono_2Ec_2Ebit_2EBIT @ mono_2Ec_2Enum_2E0 @ ( mono_2Ec_2Earithmetic_2E_2B @ V0m @ V1n ) )
    <=> ( (~)
        @ ( ( mono_2Ec_2Ebit_2EBIT @ mono_2Ec_2Enum_2E0 @ V0m )
          = ( mono_2Ec_2Ebit_2EBIT @ mono_2Ec_2Enum_2E0 @ V1n ) ) ) ) )).
