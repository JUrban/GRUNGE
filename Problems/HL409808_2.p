...
tff(conj_thm_2Eiterate_2ENEUTRAL__REAL__ADD,lemma,(
...
tff(lamtp_f3353,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => mem(f3353(A_27a,V0f,V1s),arr(A_27a,ty_2Epair_2Eprod(A_27a,A_27a))) ) ) )).

tff(lameq_f3353,axiom,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ! [V2x: $i] :
              ( mem(V2x,A_27a)
             => ap(f3353(A_27a,V0f,V1s),V2x) = ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V2x),ap(ap(c_2Ebool_2E_2F_5C,ap(ap(c_2Ebool_2EIN(A_27a),V2x),V1s)),ap(c_2Ebool_2E_7E,ap(ap(c_2Emin_2E_3D(ty_2Erealax_2Ereal),ap(V0f,V2x)),ap(c_2Ereal_2Ereal__of__num,inj__ty_2Enum_2Enum(fo__c_2Enum_2E0)))))) ) ) ) )).

tff(conj_thm_2Eiterate_2ESUM__DEGENERATE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => ( ~ p(ap(c_2Epred__set_2EFINITE(A_27a),ap(c_2Epred__set_2EGSPEC(A_27a,A_27a),f3353(A_27a,V0f,V1s))))
...
tff(conj_thm_2Eiterate_2ESUM__SUPPORT,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
         => surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),ap(ap(ap(c_2Eiterate_2Esupport(A_27a,A_27a),c_2Erealax_2Ereal__add),V0f),V1s)),V0f)) = surj__ty_2Erealax_2Ereal(ap(ap(c_2Eiterate_2ESum(A_27a),V1s),V0f)) ) ) )).
...
tff(conj_thm_2Eiterate_2ESUM__LE,lemma,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1g: $i] :
...
tff(conj_thm_2Eiterate_2ESUM__POS__LE,conjecture,(
    ! [A_27a: del,V0f: $i] :
      ( mem(V0f,arr(A_27a,ty_2Erealax_2Ereal))
     => ! [V1s: $i] :
          ( mem(V1s,arr(A_27a,bool))
