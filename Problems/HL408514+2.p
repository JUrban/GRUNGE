...
fof(conj_thm_2Earithmetic_2ENUMERAL__MULT__EQ__DIV,lemma,(
    ! [V0x] :
      ( mem(V0x,ty_2Enum_2Enum)
     => ! [V1y] :
...
fof(conj_thm_2Ebinary__ieee_2Eneg__ulp,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Eulp__lt__ULP,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Eulp__lt__threshold,lemma,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
...
fof(conj_thm_2Ebinary__ieee_2Eround__roundTiesToEven__is__zero,conjecture,(
    ! [A_27t] :
      ( ne(A_27t)
     => ! [A_27w] :
          ( ne(A_27w)
