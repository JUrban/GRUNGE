...
thf(tp_c_2Epair_2EPROD__ALL,type,(
    c_2Epair_2EPROD__ALL: del > del > $i )).

thf(mem_c_2Epair_2EPROD__ALL,axiom,(
    ! [A_27a: del,A_27b: del] :
...
thf(conj_thm_2Epair_2EPROD__ALL__THM,lemma,(
    ! [A_27a: del,A_27b: del,V0P: $i] :
...
thf(conj_thm_2Epair_2EPROD__ALL__CONG,conjecture,(
    ! [A_27a: del,A_27b: del,V0p: $i] :
                         ...
                         => ( ( ( V0p = V1p_27 )
                              & ! [V6x: $i] :
                                 ...
                                 => ! [V7y: $i] :
                                      ( ( mem @ V7y @ A_27b )
                                     => ( ( V1p_27
                                          = ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V6x ) @ V7y ) )
                                       => ( ( p @ ( ap @ V2P @ V6x ) )
                                        <=> ( p @ ( ap @ V3P_27 @ V6x ) ) ) ) ) )
                              & ! [V8x: $i] :
                                  ( ( mem @ V8x @ A_27a )
                                 => ! [V9y: $i] :
                                      ( ( mem @ V9y @ A_27b )
                                     => ( ( V1p_27
                                          = ( ap @ ( ap @ ( c_2Epair_2E_2C @ A_27a @ A_27b ) @ V8x ) @ V9y ) )
                                       => ( ( p @ ( ap @ V4Q @ V9y ) )
                                        <=> ( p @ ( ap @ V5Q_27 @ V9y ) ) ) ) ) ) )
