...
fof(conj_thm_2Efinite__map_2EFUPDATE__PURGE,conjecture,(
    ! [A_27a] :
      ( ne(A_27a)
     => ! [A_27b] :
          ( ne(A_27b)
         => ! [V0f] :
             ...
             => ! [V1x] :
                 ...
                 => ! [V2y] :
                      ( mem(V2y,A_27b)
                     => ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),V0f),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y)) = ap(ap(c_2Efinite__map_2EFUPDATE(A_27a,A_27a),ap(ap(c_2Efinite__map_2Efdomsub(A_27a,A_27a),V0f),V1x)),ap(ap(c_2Epair_2E_2C(A_27a,A_27a),V1x),V2y)) ) ) ) ) ) )).
