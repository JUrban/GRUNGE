...
tff(conj_thm_2Ereal__topology_2ECONTINUOUS__WITHIN__AVOID,conjecture,(
    ! [V0f: $i] :
      ( mem(V0f,arr(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))
     => ! [V1x: tp__ty_2Erealax_2Ereal,V2s: $i] :
          ( mem(V2s,arr(ty_2Erealax_2Ereal,bool))
         => ! [V3a: tp__ty_2Erealax_2Ereal] :
              ( ( p(ap(ap(c_2Ereal__topology_2Econtinuous(ty_2Erealax_2Ereal),V0f),ap(ap(c_2Ereal__topology_2Ewithin(ty_2Erealax_2Ereal),ap(c_2Ereal__topology_2Eat,inj__ty_2Erealax_2Ereal(V1x))),V2s)))
                & p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),V2s))
                & surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V1x))) != V3a )
             => ? [V4e: tp__ty_2Erealax_2Ereal] :
                  ...
                  & ! [V5y: tp__ty_2Erealax_2Ereal] :
                      ( ( p(ap(ap(c_2Ebool_2EIN(ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V5y)),V2s))
                        & p(ap(ap(c_2Erealax_2Ereal__lt,ap(c_2Ereal__topology_2EDist,ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),inj__ty_2Erealax_2Ereal(V1x)),inj__ty_2Erealax_2Ereal(V5y)))),inj__ty_2Erealax_2Ereal(V4e))) )
                     => surj__ty_2Erealax_2Ereal(ap(V0f,inj__ty_2Erealax_2Ereal(V5y))) != V3a ) ) ) ) ) )).
