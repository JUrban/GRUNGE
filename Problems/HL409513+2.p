...
fof(lamtp_f3250,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3250(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f3250,axiom,(
    ! [V0c] :
     ...
     => ! [V1x] :
          ( mem(V1x,ty_2Erealax_2Ereal)
         => ap(f3250(V0c),V1x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V1x),ap(ap(c_2Ereal_2Ereal__lte,V1x),V0c)) ) ) )).

fof(lamtp_f3251,axiom,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => mem(f3251(V0c),arr(ty_2Erealax_2Ereal,ty_2Epair_2Eprod(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal))) ) )).
...
fof(lameq_f3251,axiom,(
    ! [V0c] :
     ...
     => ! [V2x] :
         ...
         => ap(f3251(V0c),V2x) = ap(ap(c_2Epair_2E_2C(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),V2x),ap(ap(c_2Erealax_2Ereal__lt,V0c),V2x)) ) ) )).

fof(conj_thm_2Eutil__prob_2EPREIMAGE__REAL__COMPL3,conjecture,(
    ! [V0c] :
      ( mem(V0c,ty_2Erealax_2Ereal)
     => ap(c_2Epred__set_2ECOMPL(ty_2Erealax_2Ereal),ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3250(V0c))) = ap(c_2Epred__set_2EGSPEC(ty_2Erealax_2Ereal,ty_2Erealax_2Ereal),f3251(V0c)) ) )).
